...
module.exports = Magix.View.extend({
...
} ; var $g = '', $_temp, $p = '', height = $$.height, content = $$.content, triggers = $$.triggers, len = $$.len, dots = $$.dots, dotPrefix = $$.dotPrefix, dotType = $$.dotType, dotStyles = $$.dotStyles, dotClass = $$.dotClass; var $expr, $art, $line; try {
    $p += '<div class="_zs_gallery_mx-carousel_index_-carousel" style="height: ';
    $line = 1;
    $art = '=height';
    ;
    $p += ($expr = '<%=height%>', $e(height)) + 'px;"><div mxa="_zs_galleryak:_" class="_zs_gallery_mx-carousel_index_-inner">';
    $line = 3;
    $art = '!content';
    ;
    ...
    if (triggers && (len > 1)) {
        ;
        $p += '<i mxs="_zs_galleryak:_" class="_zs_gallery_mx-carousel_index_-triggers _zs_gallery_mx-carousel_index_-triggers-left mc-iconfont" mx-click="' + $viewId + '@{trigger}({offset: -1})">&#xe61e;</i><i mxs="_zs_galleryak:a" class="_zs_gallery_mx-carousel_index_-triggers _zs_gallery_mx-carousel_index_-triggers-right mc-iconfont" mx-click="' + $viewId + '@{trigger}({offset: 1})">&#xe61e;</i>';
        $line = 9;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (dots && (len > 1)) {
        ;
        $p += '<div class="_zs_gallery_mx-carousel_index_-dots _zs_gallery_mx-carousel_index_-type--';
        $line = 13;
        $art = '=dotPrefix';
        ;
    ...
    init: function (extra) {
        ...
        // 轮播点css变量
        var dotVars = extra.dotVars || {};
        var dotStyles = '';
        for (var k in dotVars) {
        ...
        that.updater.set({
            ...
            dotType: extra.dotType || 'dot-in-center',
