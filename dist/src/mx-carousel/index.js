...
module.exports = Magix.View.extend({
    ...
    $art = '=height';
    ;
    $p += ($expr = '<%=height%>', $e(height)) + 'px;"><div mxa="_zs_galleryag:_" class="_zs_gallery_mx-carousel_index_-inner">';
    $line = 3;
    $art = '!content';
    ;
    ...
    if (triggers && (len > 1)) {
        ;
        $p += '<i mxs="_zs_galleryag:_" class="_zs_gallery_mx-carousel_index_-triggers _zs_gallery_mx-carousel_index_-triggers-left mc-iconfont" mx-click="' + $viewId + '@{trigger}({offset: -1})">&#xe61e;</i><i mxs="_zs_galleryag:a" class="_zs_gallery_mx-carousel_index_-triggers _zs_gallery_mx-carousel_index_-triggers-right mc-iconfont" mx-click="' + $viewId + '@{trigger}({offset: 1})">&#xe61e;</i>';
        $line = 9;
        $art = '/if';
        ;
        $expr = '<%}%>';
