...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioypnpnz$art_i = 0, $art_ciqosrguf$art_c = verticals.length; $art_ioypnpnz$art_i < $art_ciqosrguf$art_c; $art_ioypnpnz$art_i++) {    var item = verticals[$art_ioypnpnz$art_i]%>';
    for (var $art_ioypnpnz$art_i = 0, $art_ciqosrguf$art_c = verticals.length; $art_ioypnpnz$art_i < $art_ciqosrguf$art_c; $art_ioypnpnz$art_i++) {
        var item = verticals[$art_ioypnpnz$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilktqx$art_i = 0, $art_cxeuag$art_c = list.length; $art_ilktqx$art_i < $art_cxeuag$art_c; $art_ilktqx$art_i++) {    var item = list[$art_ilktqx$art_i]%>';
    for (var $art_ilktqx$art_i = 0, $art_cxeuag$art_c = list.length; $art_ilktqx$art_i < $art_cxeuag$art_c; $art_ilktqx$art_i++) {
        var item = list[$art_ilktqx$art_i];
