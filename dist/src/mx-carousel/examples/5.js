...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irnxhhqzi$art_i = 0, $art_cxjenqior$art_c = verticals.length; $art_irnxhhqzi$art_i < $art_cxjenqior$art_c; $art_irnxhhqzi$art_i++) {    var item = verticals[$art_irnxhhqzi$art_i]%>';
    for (var $art_irnxhhqzi$art_i = 0, $art_cxjenqior$art_c = verticals.length; $art_irnxhhqzi$art_i < $art_cxjenqior$art_c; $art_irnxhhqzi$art_i++) {
        var item = verticals[$art_irnxhhqzi$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikvqxhgms$art_i = 0, $art_clcykgb$art_c = list.length; $art_ikvqxhgms$art_i < $art_clcykgb$art_c; $art_ikvqxhgms$art_i++) {    var item = list[$art_ikvqxhgms$art_i]%>';
    for (var $art_ikvqxhgms$art_i = 0, $art_clcykgb$art_c = list.length; $art_ikvqxhgms$art_i < $art_clcykgb$art_c; $art_ikvqxhgms$art_i++) {
        var item = list[$art_ikvqxhgms$art_i];
