...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivqsxcjf$art_i = 0, $art_cofnqq$art_c = verticals.length; $art_ivqsxcjf$art_i < $art_cofnqq$art_c; $art_ivqsxcjf$art_i++) {    var item = verticals[$art_ivqsxcjf$art_i]%>';
    for (var $art_ivqsxcjf$art_i = 0, $art_cofnqq$art_c = verticals.length; $art_ivqsxcjf$art_i < $art_cofnqq$art_c; $art_ivqsxcjf$art_i++) {
        var item = verticals[$art_ivqsxcjf$art_i];
    ...
    ;
    $expr = '<%for (var $art_iilubrq$art_i = 0, $art_cjvlwkywhq$art_c = list.length; $art_iilubrq$art_i < $art_cjvlwkywhq$art_c; $art_iilubrq$art_i++) {    var item = list[$art_iilubrq$art_i]%>';
    for (var $art_iilubrq$art_i = 0, $art_cjvlwkywhq$art_c = list.length; $art_iilubrq$art_i < $art_cjvlwkywhq$art_c; $art_iilubrq$art_i++) {
        var item = list[$art_iilubrq$art_i];
