...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itzgvcgl$art_i = 0, $art_cenyytqhsw$art_c = verticals.length; $art_itzgvcgl$art_i < $art_cenyytqhsw$art_c; $art_itzgvcgl$art_i++) {    var item = verticals[$art_itzgvcgl$art_i]%>';
    for (var $art_itzgvcgl$art_i = 0, $art_cenyytqhsw$art_c = verticals.length; $art_itzgvcgl$art_i < $art_cenyytqhsw$art_c; $art_itzgvcgl$art_i++) {
        var item = verticals[$art_itzgvcgl$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikjvbiz$art_i = 0, $art_cbfsxixmcq$art_c = list.length; $art_ikjvbiz$art_i < $art_cbfsxixmcq$art_c; $art_ikjvbiz$art_i++) {    var item = list[$art_ikjvbiz$art_i]%>';
    for (var $art_ikjvbiz$art_i = 0, $art_cbfsxixmcq$art_c = list.length; $art_ikjvbiz$art_i < $art_cbfsxixmcq$art_c; $art_ikjvbiz$art_i++) {
        var item = list[$art_ikjvbiz$art_i];
