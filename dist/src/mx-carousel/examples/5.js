...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikwvyhnqbdk$art_i = 0, $art_cxwsppm$art_c = verticals.length; $art_ikwvyhnqbdk$art_i < $art_cxwsppm$art_c; $art_ikwvyhnqbdk$art_i++) {    var item = verticals[$art_ikwvyhnqbdk$art_i]%>';
    for (var $art_ikwvyhnqbdk$art_i = 0, $art_cxwsppm$art_c = verticals.length; $art_ikwvyhnqbdk$art_i < $art_cxwsppm$art_c; $art_ikwvyhnqbdk$art_i++) {
        var item = verticals[$art_ikwvyhnqbdk$art_i];
    ...
    ;
    $expr = '<%for (var $art_irpbkwyl$art_i = 0, $art_cjtliimgj$art_c = list.length; $art_irpbkwyl$art_i < $art_cjtliimgj$art_c; $art_irpbkwyl$art_i++) {    var item = list[$art_irpbkwyl$art_i]%>';
    for (var $art_irpbkwyl$art_i = 0, $art_cjtliimgj$art_c = list.length; $art_irpbkwyl$art_i < $art_cjtliimgj$art_c; $art_irpbkwyl$art_i++) {
        var item = list[$art_irpbkwyl$art_i];
