...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iijlmrpvj$art_i = 0, $art_cowdbsupd$art_c = verticals.length; $art_iijlmrpvj$art_i < $art_cowdbsupd$art_c; $art_iijlmrpvj$art_i++) {    var item = verticals[$art_iijlmrpvj$art_i]%>';
    for (var $art_iijlmrpvj$art_i = 0, $art_cowdbsupd$art_c = verticals.length; $art_iijlmrpvj$art_i < $art_cowdbsupd$art_c; $art_iijlmrpvj$art_i++) {
        var item = verticals[$art_iijlmrpvj$art_i];
    ...
    ;
    $expr = '<%for (var $art_iudvplemc$art_i = 0, $art_cknwxwcfyrfl$art_c = list.length; $art_iudvplemc$art_i < $art_cknwxwcfyrfl$art_c; $art_iudvplemc$art_i++) {    var item = list[$art_iudvplemc$art_i]%>';
    for (var $art_iudvplemc$art_i = 0, $art_cknwxwcfyrfl$art_c = list.length; $art_iudvplemc$art_i < $art_cknwxwcfyrfl$art_c; $art_iudvplemc$art_i++) {
        var item = list[$art_iudvplemc$art_i];
