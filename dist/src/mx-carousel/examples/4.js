...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_next&dotType=dot-out-center"><div mxs="_zs_galleryaf:a" class="clearfix" data-carousel="true"><div class="_zs_gallery_mx-carousel_examples_4_-bg">1</div><div class="_zs_gallery_mx-carousel_examples_4_-bg">2</div></div><div mxs="_zs_galleryaf:b" class="clearfix" data-carousel="true"><div class="_zs_gallery_mx-carousel_examples_4_-bg">3</div><div class="_zs_gallery_mx-carousel_examples_4_-bg">4</div></div></div><i class="mc-iconfont _zs_gallery_mx-carousel_examples_4_-arrow _zs_gallery_mx-carousel_examples_4_-prev" id="';
    $line = 24;
    $art = '=viewId';
    ;
    ...
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryaf:d" class="mc-iconfont _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 36;
    $art = '=viewId';
    ;
