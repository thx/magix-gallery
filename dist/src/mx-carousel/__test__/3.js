...
var $ = require("$");
Magix.applyStyle("_zs_gallery_mx-carousel___test___2_","._zs_gallery_mx-carousel___test___2_-bg {\n  width: 100%;\n  height: 100%;\n  background-repeat: no-repeat;\n  background-position: center top;\n  line-height: 100px;\n  background-color: var(--color-brand);\n  color: #fff;\n  text-align: center;\n  font-size: 20px;\n  font-weight: bold;\n}\n");
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya_:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerya_:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb20 clearfix"><div class="color-9 fl">以下示例：</div><div class="fl"><div>垂直方向切换</div><div>自动播放</div><div>显示面板指示点</div></div></div><div class="clearfix mb10"><div mx-view="mx-carousel/index?height=100&vertical=true&autoplay=true"><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___2_-bg">1</div></div><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___2_-bg">2</div></div><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___2_-bg">3</div></div></div></div></div><div mxa="_zs_gallerya_:a" class="clearfix"><div mxa="_zs_gallerya_:b" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerya_:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 28;
    $art = '=viewId';
    ;
