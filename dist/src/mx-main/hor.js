...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icgfqtd$art_i = 0, $art_cghfccpmsv$art_c = stepInfos.length; $art_icgfqtd$art_i < $art_cghfccpmsv$art_c; $art_icgfqtd$art_i++) {    var step = stepInfos[$art_icgfqtd$art_i]%>';
    for (var $art_icgfqtd$art_i = 0, $art_cghfccpmsv$art_c = stepInfos.length; $art_icgfqtd$art_i < $art_cghfccpmsv$art_c; $art_icgfqtd$art_i++) {
        var step = stepInfos[$art_icgfqtd$art_i];
