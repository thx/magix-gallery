...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igtfmce$art_i = 0, $art_cauyzmamvzf$art_c = stepInfos.length; $art_igtfmce$art_i < $art_cauyzmamvzf$art_c; $art_igtfmce$art_i++) {    var step = stepInfos[$art_igtfmce$art_i]%>';
    for (var $art_igtfmce$art_i = 0, $art_cauyzmamvzf$art_c = stepInfos.length; $art_igtfmce$art_i < $art_cauyzmamvzf$art_c; $art_igtfmce$art_i++) {
        var step = stepInfos[$art_igtfmce$art_i];
