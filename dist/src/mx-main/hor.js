...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igqhoow$art_i = 0, $art_chtjsjllbec$art_c = stepInfos.length; $art_igqhoow$art_i < $art_chtjsjllbec$art_c; $art_igqhoow$art_i++) {    var step = stepInfos[$art_igqhoow$art_i]%>';
    for (var $art_igqhoow$art_i = 0, $art_chtjsjllbec$art_c = stepInfos.length; $art_igqhoow$art_i < $art_chtjsjllbec$art_c; $art_igqhoow$art_i++) {
        var step = stepInfos[$art_igqhoow$art_i];
