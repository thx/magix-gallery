...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivtblst$art_i = 0, $art_ctnhrowjq$art_c = stepInfos.length; $art_ivtblst$art_i < $art_ctnhrowjq$art_c; $art_ivtblst$art_i++) {    var step = stepInfos[$art_ivtblst$art_i]%>';
    for (var $art_ivtblst$art_i = 0, $art_ctnhrowjq$art_c = stepInfos.length; $art_ivtblst$art_i < $art_ctnhrowjq$art_c; $art_ivtblst$art_i++) {
        var step = stepInfos[$art_ivtblst$art_i];
