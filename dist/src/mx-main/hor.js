...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixrfiiwt$art_i = 0, $art_cqzhjch$art_c = stepInfos.length; $art_ixrfiiwt$art_i < $art_cqzhjch$art_c; $art_ixrfiiwt$art_i++) {    var step = stepInfos[$art_ixrfiiwt$art_i]%>';
    for (var $art_ixrfiiwt$art_i = 0, $art_cqzhjch$art_c = stepInfos.length; $art_ixrfiiwt$art_i < $art_cqzhjch$art_c; $art_ixrfiiwt$art_i++) {
        var step = stepInfos[$art_ixrfiiwt$art_i];
