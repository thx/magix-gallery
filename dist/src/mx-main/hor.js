...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icodqirtmv$art_i = 0, $art_cksqiafw$art_c = stepInfos.length; $art_icodqirtmv$art_i < $art_cksqiafw$art_c; $art_icodqirtmv$art_i++) {    var step = stepInfos[$art_icodqirtmv$art_i]%>';
    for (var $art_icodqirtmv$art_i = 0, $art_cksqiafw$art_c = stepInfos.length; $art_icodqirtmv$art_i < $art_cksqiafw$art_c; $art_icodqirtmv$art_i++) {
        var step = stepInfos[$art_icodqirtmv$art_i];
