...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iooytuhm$art_i = 0, $art_cxyzslyhkc$art_c = stepInfos.length; $art_iooytuhm$art_i < $art_cxyzslyhkc$art_c; $art_iooytuhm$art_i++) {    var step = stepInfos[$art_iooytuhm$art_i]%>';
    for (var $art_iooytuhm$art_i = 0, $art_cxyzslyhkc$art_c = stepInfos.length; $art_iooytuhm$art_i < $art_cxyzslyhkc$art_c; $art_iooytuhm$art_i++) {
        var step = stepInfos[$art_iooytuhm$art_i];
