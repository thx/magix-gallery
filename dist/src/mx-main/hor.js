...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixxzuzh$art_i = 0, $art_clkfiaubvtg$art_c = stepInfos.length; $art_ixxzuzh$art_i < $art_clkfiaubvtg$art_c; $art_ixxzuzh$art_i++) {    var step = stepInfos[$art_ixxzuzh$art_i]%>';
    for (var $art_ixxzuzh$art_i = 0, $art_clkfiaubvtg$art_c = stepInfos.length; $art_ixxzuzh$art_i < $art_clkfiaubvtg$art_c; $art_ixxzuzh$art_i++) {
        var step = stepInfos[$art_ixxzuzh$art_i];
