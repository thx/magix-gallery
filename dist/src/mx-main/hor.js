...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihgifhtal$art_i = 0, $art_clttmgh$art_c = stepInfos.length; $art_ihgifhtal$art_i < $art_clttmgh$art_c; $art_ihgifhtal$art_i++) {    var step = stepInfos[$art_ihgifhtal$art_i]%>';
    for (var $art_ihgifhtal$art_i = 0, $art_clttmgh$art_c = stepInfos.length; $art_ihgifhtal$art_i < $art_clttmgh$art_c; $art_ihgifhtal$art_i++) {
        var step = stepInfos[$art_ihgifhtal$art_i];
