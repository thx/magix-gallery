...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwpiiqt$art_i = 0, $art_cpiauo$art_c = stepInfos.length; $art_iwpiiqt$art_i < $art_cpiauo$art_c; $art_iwpiiqt$art_i++) {    var step = stepInfos[$art_iwpiiqt$art_i]%>';
    for (var $art_iwpiiqt$art_i = 0, $art_cpiauo$art_c = stepInfos.length; $art_iwpiiqt$art_i < $art_cpiauo$art_c; $art_iwpiiqt$art_i++) {
        var step = stepInfos[$art_iwpiiqt$art_i];
