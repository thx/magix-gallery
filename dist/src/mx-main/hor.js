...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isqqw$art_i = 0, $art_cdvoerhns$art_c = stepInfos.length; $art_isqqw$art_i < $art_cdvoerhns$art_c; $art_isqqw$art_i++) {    var step = stepInfos[$art_isqqw$art_i]%>';
    for (var $art_isqqw$art_i = 0, $art_cdvoerhns$art_c = stepInfos.length; $art_isqqw$art_i < $art_cdvoerhns$art_c; $art_isqqw$art_i++) {
        var step = stepInfos[$art_isqqw$art_i];
