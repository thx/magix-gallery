...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ininjriir$art_i = 0, $art_cvyvynli$art_c = stepInfos.length; $art_ininjriir$art_i < $art_cvyvynli$art_c; $art_ininjriir$art_i++) {    var step = stepInfos[$art_ininjriir$art_i]%>';
    for (var $art_ininjriir$art_i = 0, $art_cvyvynli$art_c = stepInfos.length; $art_ininjriir$art_i < $art_cvyvynli$art_c; $art_ininjriir$art_i++) {
        var step = stepInfos[$art_ininjriir$art_i];
