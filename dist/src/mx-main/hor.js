...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icmrqxano$art_i = 0, $art_chyqzosak$art_c = stepInfos.length; $art_icmrqxano$art_i < $art_chyqzosak$art_c; $art_icmrqxano$art_i++) {    var step = stepInfos[$art_icmrqxano$art_i]%>';
    for (var $art_icmrqxano$art_i = 0, $art_chyqzosak$art_c = stepInfos.length; $art_icmrqxano$art_i < $art_chyqzosak$art_c; $art_icmrqxano$art_i++) {
        var step = stepInfos[$art_icmrqxano$art_i];
