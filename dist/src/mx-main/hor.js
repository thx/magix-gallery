...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ietpjbch$art_i = 0, $art_chydamm$art_c = stepInfos.length; $art_ietpjbch$art_i < $art_chydamm$art_c; $art_ietpjbch$art_i++) {    var step = stepInfos[$art_ietpjbch$art_i]%>';
    for (var $art_ietpjbch$art_i = 0, $art_chydamm$art_c = stepInfos.length; $art_ietpjbch$art_i < $art_chydamm$art_c; $art_ietpjbch$art_i++) {
        var step = stepInfos[$art_ietpjbch$art_i];
