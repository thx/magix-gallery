...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idqpyu$art_i = 0, $art_cqgsazzb$art_c = stepInfos.length; $art_idqpyu$art_i < $art_cqgsazzb$art_c; $art_idqpyu$art_i++) {    var step = stepInfos[$art_idqpyu$art_i]%>';
    for (var $art_idqpyu$art_i = 0, $art_cqgsazzb$art_c = stepInfos.length; $art_idqpyu$art_i < $art_cqgsazzb$art_c; $art_idqpyu$art_i++) {
        var step = stepInfos[$art_idqpyu$art_i];
