...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iujmarigmao$art_i = 0, $art_ccwnwkvnl$art_c = stepInfos.length; $art_iujmarigmao$art_i < $art_ccwnwkvnl$art_c; $art_iujmarigmao$art_i++) {    var step = stepInfos[$art_iujmarigmao$art_i]%>';
    for (var $art_iujmarigmao$art_i = 0, $art_ccwnwkvnl$art_c = stepInfos.length; $art_iujmarigmao$art_i < $art_ccwnwkvnl$art_c; $art_iujmarigmao$art_i++) {
        var step = stepInfos[$art_iujmarigmao$art_i];
