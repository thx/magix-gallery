...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibohqen$art_i = 0, $art_cuxltlg$art_c = stepInfos.length; $art_ibohqen$art_i < $art_cuxltlg$art_c; $art_ibohqen$art_i++) {    var step = stepInfos[$art_ibohqen$art_i]%>';
    for (var $art_ibohqen$art_i = 0, $art_cuxltlg$art_c = stepInfos.length; $art_ibohqen$art_i < $art_cuxltlg$art_c; $art_ibohqen$art_i++) {
        var step = stepInfos[$art_ibohqen$art_i];
