...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iibcljld$art_i = 0, $art_cabqnwrzmq$art_c = stepInfos.length; $art_iibcljld$art_i < $art_cabqnwrzmq$art_c; $art_iibcljld$art_i++) {    var step = stepInfos[$art_iibcljld$art_i]%>';
    for (var $art_iibcljld$art_i = 0, $art_cabqnwrzmq$art_c = stepInfos.length; $art_iibcljld$art_i < $art_cabqnwrzmq$art_c; $art_iibcljld$art_i++) {
        var step = stepInfos[$art_iibcljld$art_i];
