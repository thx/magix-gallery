...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iggzqqeq$art_i = 0, $art_cjnhpssm$art_c = stepInfos.length; $art_iggzqqeq$art_i < $art_cjnhpssm$art_c; $art_iggzqqeq$art_i++) {    var step = stepInfos[$art_iggzqqeq$art_i]%>';
    for (var $art_iggzqqeq$art_i = 0, $art_cjnhpssm$art_c = stepInfos.length; $art_iggzqqeq$art_i < $art_cjnhpssm$art_c; $art_iggzqqeq$art_i++) {
        var step = stepInfos[$art_iggzqqeq$art_i];
