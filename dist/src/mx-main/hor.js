...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idkisxrp$art_i = 0, $art_clyxopb$art_c = stepInfos.length; $art_idkisxrp$art_i < $art_clyxopb$art_c; $art_idkisxrp$art_i++) {    var step = stepInfos[$art_idkisxrp$art_i]%>';
    for (var $art_idkisxrp$art_i = 0, $art_clyxopb$art_c = stepInfos.length; $art_idkisxrp$art_i < $art_clyxopb$art_c; $art_idkisxrp$art_i++) {
        var step = stepInfos[$art_idkisxrp$art_i];
