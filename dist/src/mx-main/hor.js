...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifaozqolm$art_i = 0, $art_cajerro$art_c = stepInfos.length; $art_ifaozqolm$art_i < $art_cajerro$art_c; $art_ifaozqolm$art_i++) {    var step = stepInfos[$art_ifaozqolm$art_i]%>';
    for (var $art_ifaozqolm$art_i = 0, $art_cajerro$art_c = stepInfos.length; $art_ifaozqolm$art_i < $art_cajerro$art_c; $art_ifaozqolm$art_i++) {
        var step = stepInfos[$art_ifaozqolm$art_i];
