...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iffbpdg$art_i = 0, $art_cmpbsgtib$art_c = stepInfos.length; $art_iffbpdg$art_i < $art_cmpbsgtib$art_c; $art_iffbpdg$art_i++) {    var step = stepInfos[$art_iffbpdg$art_i]%>';
    for (var $art_iffbpdg$art_i = 0, $art_cmpbsgtib$art_c = stepInfos.length; $art_iffbpdg$art_i < $art_cmpbsgtib$art_c; $art_iffbpdg$art_i++) {
        var step = stepInfos[$art_iffbpdg$art_i];
