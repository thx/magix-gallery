...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuamknb$art_i = 0, $art_cxiynnvfxyg$art_c = stepInfos.length; $art_iuamknb$art_i < $art_cxiynnvfxyg$art_c; $art_iuamknb$art_i++) {    var step = stepInfos[$art_iuamknb$art_i]%>';
    for (var $art_iuamknb$art_i = 0, $art_cxiynnvfxyg$art_c = stepInfos.length; $art_iuamknb$art_i < $art_cxiynnvfxyg$art_c; $art_iuamknb$art_i++) {
        var step = stepInfos[$art_iuamknb$art_i];
