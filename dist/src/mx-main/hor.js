...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iweeyebr$art_i = 0, $art_cbvwyxtgl$art_c = stepInfos.length; $art_iweeyebr$art_i < $art_cbvwyxtgl$art_c; $art_iweeyebr$art_i++) {    var step = stepInfos[$art_iweeyebr$art_i]%>';
    for (var $art_iweeyebr$art_i = 0, $art_cbvwyxtgl$art_c = stepInfos.length; $art_iweeyebr$art_i < $art_cbvwyxtgl$art_c; $art_iweeyebr$art_i++) {
        var step = stepInfos[$art_iweeyebr$art_i];
