...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isnggkd$art_i = 0, $art_cgzbmdk$art_c = stepInfos.length; $art_isnggkd$art_i < $art_cgzbmdk$art_c; $art_isnggkd$art_i++) {    var step = stepInfos[$art_isnggkd$art_i]%>';
    for (var $art_isnggkd$art_i = 0, $art_cgzbmdk$art_c = stepInfos.length; $art_isnggkd$art_i < $art_cgzbmdk$art_c; $art_isnggkd$art_i++) {
        var step = stepInfos[$art_isnggkd$art_i];
