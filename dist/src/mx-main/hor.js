...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqbkamokf$art_i = 0, $art_cqsfiimxt$art_c = stepInfos.length; $art_iqbkamokf$art_i < $art_cqsfiimxt$art_c; $art_iqbkamokf$art_i++) {    var step = stepInfos[$art_iqbkamokf$art_i]%>';
    for (var $art_iqbkamokf$art_i = 0, $art_cqsfiimxt$art_c = stepInfos.length; $art_iqbkamokf$art_i < $art_cqsfiimxt$art_c; $art_iqbkamokf$art_i++) {
        var step = stepInfos[$art_iqbkamokf$art_i];
