...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isjadyaq$art_i = 0, $art_cvrbddmcm$art_c = stepInfos.length; $art_isjadyaq$art_i < $art_cvrbddmcm$art_c; $art_isjadyaq$art_i++) {    var step = stepInfos[$art_isjadyaq$art_i]%>';
    for (var $art_isjadyaq$art_i = 0, $art_cvrbddmcm$art_c = stepInfos.length; $art_isjadyaq$art_i < $art_cvrbddmcm$art_c; $art_isjadyaq$art_i++) {
        var step = stepInfos[$art_isjadyaq$art_i];
