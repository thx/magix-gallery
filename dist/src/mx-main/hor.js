...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iakegkdvsvt$art_i = 0, $art_cgkbkhowh$art_c = stepInfos.length; $art_iakegkdvsvt$art_i < $art_cgkbkhowh$art_c; $art_iakegkdvsvt$art_i++) {    var step = stepInfos[$art_iakegkdvsvt$art_i]%>';
    for (var $art_iakegkdvsvt$art_i = 0, $art_cgkbkhowh$art_c = stepInfos.length; $art_iakegkdvsvt$art_i < $art_cgkbkhowh$art_c; $art_iakegkdvsvt$art_i++) {
        var step = stepInfos[$art_iakegkdvsvt$art_i];
