...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isfnuhmlk$art_i = 0, $art_cziubxvcoz$art_c = stepInfos.length; $art_isfnuhmlk$art_i < $art_cziubxvcoz$art_c; $art_isfnuhmlk$art_i++) {    var step = stepInfos[$art_isfnuhmlk$art_i]%>';
    for (var $art_isfnuhmlk$art_i = 0, $art_cziubxvcoz$art_c = stepInfos.length; $art_isfnuhmlk$art_i < $art_cziubxvcoz$art_c; $art_isfnuhmlk$art_i++) {
        var step = stepInfos[$art_isfnuhmlk$art_i];
