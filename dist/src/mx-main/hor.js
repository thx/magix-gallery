...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idxjgdwbo$art_i = 0, $art_ctqbunbi$art_c = stepInfos.length; $art_idxjgdwbo$art_i < $art_ctqbunbi$art_c; $art_idxjgdwbo$art_i++) {    var step = stepInfos[$art_idxjgdwbo$art_i]%>';
    for (var $art_idxjgdwbo$art_i = 0, $art_ctqbunbi$art_c = stepInfos.length; $art_idxjgdwbo$art_i < $art_ctqbunbi$art_c; $art_idxjgdwbo$art_i++) {
        var step = stepInfos[$art_idxjgdwbo$art_i];
