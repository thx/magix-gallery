...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuzqrgo$art_i = 0, $art_cxhttfskdyc$art_c = stepInfos.length; $art_iuzqrgo$art_i < $art_cxhttfskdyc$art_c; $art_iuzqrgo$art_i++) {    var step = stepInfos[$art_iuzqrgo$art_i]%>';
    for (var $art_iuzqrgo$art_i = 0, $art_cxhttfskdyc$art_c = stepInfos.length; $art_iuzqrgo$art_i < $art_cxhttfskdyc$art_c; $art_iuzqrgo$art_i++) {
        var step = stepInfos[$art_iuzqrgo$art_i];
