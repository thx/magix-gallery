...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibqiapq$art_i = 0, $art_ckbv$art_c = stepInfos.length; $art_ibqiapq$art_i < $art_ckbv$art_c; $art_ibqiapq$art_i++) {    var step = stepInfos[$art_ibqiapq$art_i]%>';
    for (var $art_ibqiapq$art_i = 0, $art_ckbv$art_c = stepInfos.length; $art_ibqiapq$art_i < $art_ckbv$art_c; $art_ibqiapq$art_i++) {
        var step = stepInfos[$art_ibqiapq$art_i];
