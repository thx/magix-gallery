...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iptwq$art_i = 0, $art_ckgjzqm$art_c = stepInfos.length; $art_iptwq$art_i < $art_ckgjzqm$art_c; $art_iptwq$art_i++) {    var step = stepInfos[$art_iptwq$art_i]%>';
    for (var $art_iptwq$art_i = 0, $art_ckgjzqm$art_c = stepInfos.length; $art_iptwq$art_i < $art_ckgjzqm$art_c; $art_iptwq$art_i++) {
        var step = stepInfos[$art_iptwq$art_i];
