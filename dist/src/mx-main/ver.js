...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iirheto$art_i = 0, $art_ciolyni$art_c = stepInfos.length; $art_iirheto$art_i < $art_ciolyni$art_c; $art_iirheto$art_i++) {    var step = stepInfos[$art_iirheto$art_i]%>';
    for (var $art_iirheto$art_i = 0, $art_ciolyni$art_c = stepInfos.length; $art_iirheto$art_i < $art_ciolyni$art_c; $art_iirheto$art_i++) {
        var step = stepInfos[$art_iirheto$art_i];
