...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_gallerydg:_" class="clearfix"><div mx-view="mx-main/examples/ver-demo"></div></div><div mx-view="mx-main/examples/steps" id="';
    $line = 25;
    $art = '=viewId';
    ;
