...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydc:_" class="pl20 pr20 pt20"><div mxs="_zs_gallerydc:_" class="mb40"><span class="color-9">以下示例：</span>标题点击可以快速跳转；未到步骤不可点击；</div><div mxv="stepInfos" mx-view="mx-main/hor?alreadyStep=';
    $line = 6;
    $art = '=alreadyStep';
    ;
