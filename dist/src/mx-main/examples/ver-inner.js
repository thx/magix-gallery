...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerydk:_" class="fontsize-16">第';
    $line = 1;
    $art = '=info.index';
    ;
    ...
    $art = '=info.label';
    ;
    $p += ($expr = '<%=info.label%>', $e(info.label)) + '</div><div mxs="_zs_gallerydk:_" class="_zs_gallery_mx-main_examples_hor-inner_-line" style="width: 200px;"></div><div mxs="_zs_gallerydk:a" class="_zs_gallery_mx-main_examples_hor-inner_-line" style="width: 400px;"></div><div mxs="_zs_gallerydk:a" class="_zs_gallery_mx-main_examples_hor-inner_-line" style="width: 400px;"></div><div mxs="_zs_gallerydk:a" class="_zs_gallery_mx-main_examples_hor-inner_-line" style="width: 400px;"></div>';
}
catch (ex) {
