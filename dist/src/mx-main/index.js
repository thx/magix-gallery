...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cmnikqnqlb$art_c = stepInfos.length; stepIndex < $art_cmnikqnqlb$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cmnikqnqlb$art_c = stepInfos.length; stepIndex < $art_cmnikqnqlb$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_izrujxdcfn$art_i = 0, $art_objscatvcp$art_obj = step.subs, $art_cpdhrqcyge$art_c = $art_objscatvcp$art_obj.length; $art_izrujxdcfn$art_i < $art_cpdhrqcyge$art_c; $art_izrujxdcfn$art_i++) {            var sub = $art_objscatvcp$art_obj[$art_izrujxdcfn$art_i]%>';
            for (var $art_izrujxdcfn$art_i = 0, $art_objscatvcp$art_obj = step.subs, $art_cpdhrqcyge$art_c = $art_objscatvcp$art_obj.length; $art_izrujxdcfn$art_i < $art_cpdhrqcyge$art_c; $art_izrujxdcfn$art_i++) {
                var sub = $art_objscatvcp$art_obj[$art_izrujxdcfn$art_i];
    ...
    ;
    $expr = '<%for (var $art_ieojceru$art_i = 0, $art_objbbgmuay$art_obj = curStepInfo.subs, $art_cksmxwvwrj$art_c = $art_objbbgmuay$art_obj.length; $art_ieojceru$art_i < $art_cksmxwvwrj$art_c; $art_ieojceru$art_i++) {    var sub = $art_objbbgmuay$art_obj[$art_ieojceru$art_i]%>';
    for (var $art_ieojceru$art_i = 0, $art_objbbgmuay$art_obj = curStepInfo.subs, $art_cksmxwvwrj$art_c = $art_objbbgmuay$art_obj.length; $art_ieojceru$art_i < $art_cksmxwvwrj$art_c; $art_ieojceru$art_i++) {
        var sub = $art_objbbgmuay$art_obj[$art_ieojceru$art_i];
