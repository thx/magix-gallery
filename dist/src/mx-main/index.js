...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cgddzakcjfvl$art_c = stepInfos.length; stepIndex < $art_cgddzakcjfvl$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cgddzakcjfvl$art_c = stepInfos.length; stepIndex < $art_cgddzakcjfvl$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_izeoahcnk$art_i = 0, $art_objuasaugfd$art_obj = step.subs, $art_ckxcbgjiwo$art_c = $art_objuasaugfd$art_obj.length; $art_izeoahcnk$art_i < $art_ckxcbgjiwo$art_c; $art_izeoahcnk$art_i++) {            var sub = $art_objuasaugfd$art_obj[$art_izeoahcnk$art_i]%>';
            for (var $art_izeoahcnk$art_i = 0, $art_objuasaugfd$art_obj = step.subs, $art_ckxcbgjiwo$art_c = $art_objuasaugfd$art_obj.length; $art_izeoahcnk$art_i < $art_ckxcbgjiwo$art_c; $art_izeoahcnk$art_i++) {
                var sub = $art_objuasaugfd$art_obj[$art_izeoahcnk$art_i];
    ...
    ;
    $expr = '<%for (var $art_iadwwsmvdh$art_i = 0, $art_objceewe$art_obj = curStepInfo.subs, $art_cbpckdu$art_c = $art_objceewe$art_obj.length; $art_iadwwsmvdh$art_i < $art_cbpckdu$art_c; $art_iadwwsmvdh$art_i++) {    var sub = $art_objceewe$art_obj[$art_iadwwsmvdh$art_i]%>';
    for (var $art_iadwwsmvdh$art_i = 0, $art_objceewe$art_obj = curStepInfo.subs, $art_cbpckdu$art_c = $art_objceewe$art_obj.length; $art_iadwwsmvdh$art_i < $art_cbpckdu$art_c; $art_iadwwsmvdh$art_i++) {
        var sub = $art_objceewe$art_obj[$art_iadwwsmvdh$art_i];
