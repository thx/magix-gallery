...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_crkhpa$art_c = stepInfos.length; stepIndex < $art_crkhpa$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_crkhpa$art_c = stepInfos.length; stepIndex < $art_crkhpa$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_idtpmtqwoh$art_i = 0, $art_objrjrz$art_obj = step.subs, $art_cnjowk$art_c = $art_objrjrz$art_obj.length; $art_idtpmtqwoh$art_i < $art_cnjowk$art_c; $art_idtpmtqwoh$art_i++) {            var sub = $art_objrjrz$art_obj[$art_idtpmtqwoh$art_i]%>';
            for (var $art_idtpmtqwoh$art_i = 0, $art_objrjrz$art_obj = step.subs, $art_cnjowk$art_c = $art_objrjrz$art_obj.length; $art_idtpmtqwoh$art_i < $art_cnjowk$art_c; $art_idtpmtqwoh$art_i++) {
                var sub = $art_objrjrz$art_obj[$art_idtpmtqwoh$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivocsoxmqt$art_i = 0, $art_objnwmamwbwmd$art_obj = curStepInfo.subs, $art_cduifvqwuq$art_c = $art_objnwmamwbwmd$art_obj.length; $art_ivocsoxmqt$art_i < $art_cduifvqwuq$art_c; $art_ivocsoxmqt$art_i++) {    var sub = $art_objnwmamwbwmd$art_obj[$art_ivocsoxmqt$art_i]%>';
    for (var $art_ivocsoxmqt$art_i = 0, $art_objnwmamwbwmd$art_obj = curStepInfo.subs, $art_cduifvqwuq$art_c = $art_objnwmamwbwmd$art_obj.length; $art_ivocsoxmqt$art_i < $art_cduifvqwuq$art_c; $art_ivocsoxmqt$art_i++) {
        var sub = $art_objnwmamwbwmd$art_obj[$art_ivocsoxmqt$art_i];
