...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cuxvhcqkb$art_c = stepInfos.length; stepIndex < $art_cuxvhcqkb$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cuxvhcqkb$art_c = stepInfos.length; stepIndex < $art_cuxvhcqkb$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ibpaysmrpw$art_i = 0, $art_objczkmfye$art_obj = step.subs, $art_casetdf$art_c = $art_objczkmfye$art_obj.length; $art_ibpaysmrpw$art_i < $art_casetdf$art_c; $art_ibpaysmrpw$art_i++) {            var sub = $art_objczkmfye$art_obj[$art_ibpaysmrpw$art_i]%>';
            for (var $art_ibpaysmrpw$art_i = 0, $art_objczkmfye$art_obj = step.subs, $art_casetdf$art_c = $art_objczkmfye$art_obj.length; $art_ibpaysmrpw$art_i < $art_casetdf$art_c; $art_ibpaysmrpw$art_i++) {
                var sub = $art_objczkmfye$art_obj[$art_ibpaysmrpw$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikyefacazdd$art_i = 0, $art_objthpdg$art_obj = curStepInfo.subs, $art_cubwcudllk$art_c = $art_objthpdg$art_obj.length; $art_ikyefacazdd$art_i < $art_cubwcudllk$art_c; $art_ikyefacazdd$art_i++) {    var sub = $art_objthpdg$art_obj[$art_ikyefacazdd$art_i]%>';
    for (var $art_ikyefacazdd$art_i = 0, $art_objthpdg$art_obj = curStepInfo.subs, $art_cubwcudllk$art_c = $art_objthpdg$art_obj.length; $art_ikyefacazdd$art_i < $art_cubwcudllk$art_c; $art_ikyefacazdd$art_i++) {
        var sub = $art_objthpdg$art_obj[$art_ikyefacazdd$art_i];
