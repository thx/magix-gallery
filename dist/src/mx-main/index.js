...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cedfbmgdp$art_c = stepInfos.length; stepIndex < $art_cedfbmgdp$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cedfbmgdp$art_c = stepInfos.length; stepIndex < $art_cedfbmgdp$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ipjfohbx$art_i = 0, $art_objlxpdfao$art_obj = step.subs, $art_ckyojam$art_c = $art_objlxpdfao$art_obj.length; $art_ipjfohbx$art_i < $art_ckyojam$art_c; $art_ipjfohbx$art_i++) {            var sub = $art_objlxpdfao$art_obj[$art_ipjfohbx$art_i]%>';
            for (var $art_ipjfohbx$art_i = 0, $art_objlxpdfao$art_obj = step.subs, $art_ckyojam$art_c = $art_objlxpdfao$art_obj.length; $art_ipjfohbx$art_i < $art_ckyojam$art_c; $art_ipjfohbx$art_i++) {
                var sub = $art_objlxpdfao$art_obj[$art_ipjfohbx$art_i];
    ...
    ;
    $expr = '<%for (var $art_ijdeisu$art_i = 0, $art_objblfguqpfk$art_obj = curStepInfo.subs, $art_cpwaljfi$art_c = $art_objblfguqpfk$art_obj.length; $art_ijdeisu$art_i < $art_cpwaljfi$art_c; $art_ijdeisu$art_i++) {    var sub = $art_objblfguqpfk$art_obj[$art_ijdeisu$art_i]%>';
    for (var $art_ijdeisu$art_i = 0, $art_objblfguqpfk$art_obj = curStepInfo.subs, $art_cpwaljfi$art_c = $art_objblfguqpfk$art_obj.length; $art_ijdeisu$art_i < $art_cpwaljfi$art_c; $art_ijdeisu$art_i++) {
        var sub = $art_objblfguqpfk$art_obj[$art_ijdeisu$art_i];
