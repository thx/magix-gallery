...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cslijxzi$art_c = stepInfos.length; stepIndex < $art_cslijxzi$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cslijxzi$art_c = stepInfos.length; stepIndex < $art_cslijxzi$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ichbbxnari$art_i = 0, $art_objegiesr$art_obj = step.subs, $art_cjwrtnwdn$art_c = $art_objegiesr$art_obj.length; $art_ichbbxnari$art_i < $art_cjwrtnwdn$art_c; $art_ichbbxnari$art_i++) {            var sub = $art_objegiesr$art_obj[$art_ichbbxnari$art_i]%>';
            for (var $art_ichbbxnari$art_i = 0, $art_objegiesr$art_obj = step.subs, $art_cjwrtnwdn$art_c = $art_objegiesr$art_obj.length; $art_ichbbxnari$art_i < $art_cjwrtnwdn$art_c; $art_ichbbxnari$art_i++) {
                var sub = $art_objegiesr$art_obj[$art_ichbbxnari$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixtkfwwot$art_i = 0, $art_objycmcdhej$art_obj = curStepInfo.subs, $art_csvcuxqm$art_c = $art_objycmcdhej$art_obj.length; $art_ixtkfwwot$art_i < $art_csvcuxqm$art_c; $art_ixtkfwwot$art_i++) {    var sub = $art_objycmcdhej$art_obj[$art_ixtkfwwot$art_i]%>';
    for (var $art_ixtkfwwot$art_i = 0, $art_objycmcdhej$art_obj = curStepInfo.subs, $art_csvcuxqm$art_c = $art_objycmcdhej$art_obj.length; $art_ixtkfwwot$art_i < $art_csvcuxqm$art_c; $art_ixtkfwwot$art_i++) {
        var sub = $art_objycmcdhej$art_obj[$art_ixtkfwwot$art_i];
