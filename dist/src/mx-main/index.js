...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_capieolkv$art_c = stepInfos.length; stepIndex < $art_capieolkv$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_capieolkv$art_c = stepInfos.length; stepIndex < $art_capieolkv$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ipbhyu$art_i = 0, $art_objlqzrnwq$art_obj = step.subs, $art_cfryhcgat$art_c = $art_objlqzrnwq$art_obj.length; $art_ipbhyu$art_i < $art_cfryhcgat$art_c; $art_ipbhyu$art_i++) {            var sub = $art_objlqzrnwq$art_obj[$art_ipbhyu$art_i]%>';
            for (var $art_ipbhyu$art_i = 0, $art_objlqzrnwq$art_obj = step.subs, $art_cfryhcgat$art_c = $art_objlqzrnwq$art_obj.length; $art_ipbhyu$art_i < $art_cfryhcgat$art_c; $art_ipbhyu$art_i++) {
                var sub = $art_objlqzrnwq$art_obj[$art_ipbhyu$art_i];
    ...
    ;
    $expr = '<%for (var $art_idhrds$art_i = 0, $art_objaeeocticps$art_obj = curStepInfo.subs, $art_cpzjmkaenk$art_c = $art_objaeeocticps$art_obj.length; $art_idhrds$art_i < $art_cpzjmkaenk$art_c; $art_idhrds$art_i++) {    var sub = $art_objaeeocticps$art_obj[$art_idhrds$art_i]%>';
    for (var $art_idhrds$art_i = 0, $art_objaeeocticps$art_obj = curStepInfo.subs, $art_cpzjmkaenk$art_c = $art_objaeeocticps$art_obj.length; $art_idhrds$art_i < $art_cpzjmkaenk$art_c; $art_idhrds$art_i++) {
        var sub = $art_objaeeocticps$art_obj[$art_idhrds$art_i];
