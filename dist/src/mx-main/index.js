...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cvdabezq$art_c = stepInfos.length; stepIndex < $art_cvdabezq$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cvdabezq$art_c = stepInfos.length; stepIndex < $art_cvdabezq$art_c; stepIndex++) {
        ...
        ;
        $p += ' data-spm-click="gostr=/alimama.feedflow.1;locaid=df0100677"><span mxa="_zs_gallerydf:_" class="_zs_gallery_mx-main_index_-idx">';
        $line = 7;
        $art = '=(stepIndex + 1)';
        ;
        $p += ($expr = '<%=(stepIndex + 1)%>', $e((stepIndex + 1))) + '</span><span mxs="_zs_gallerydf:_" class="_zs_gallery_mx-main_index_-pbg"></span><span mxa="_zs_gallerydf:a" class="_zs_gallery_mx-main_index_-text">';
        $line = 9;
        $art = '=step.label';
        ;
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ifojdgtof$art_i = 0, $art_objkovdeqb$art_obj = step.subs, $art_chrptdmu$art_c = $art_objkovdeqb$art_obj.length; $art_ifojdgtof$art_i < $art_chrptdmu$art_c; $art_ifojdgtof$art_i++) {            var sub = $art_objkovdeqb$art_obj[$art_ifojdgtof$art_i]%>';
            for (var $art_ifojdgtof$art_i = 0, $art_objkovdeqb$art_obj = step.subs, $art_chrptdmu$art_c = $art_objkovdeqb$art_obj.length; $art_ifojdgtof$art_i < $art_chrptdmu$art_c; $art_ifojdgtof$art_i++) {
                var sub = $art_objkovdeqb$art_obj[$art_ifojdgtof$art_i];
                ...
                $art = '=sub.index';
                ;
                $p += ($expr = '<%=sub.index%>', $e(sub.index)) + '})" data-spm-click="gostr=/alimama.feedflow.1;locaid=de313a21d"><span mxs="_zs_gallerydf:_" class="_zs_gallery_mx-main_index_-pbg"></span><span mxa="_zs_gallerydf:b" class="_zs_gallery_mx-main_index_-text">';
                $line = 17;
                $art = '=sub.label';
                ;
        ...
        if (step.locked) {
            ;
            $p += '<i mxs="_zs_gallerydf:a" class="mc-iconfont _zs_gallery_mx-main_index_-locked-icon">&#xe759;</i>';
            $line = 23;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    ;
    $expr = '<%for (var $art_iajpbxrgt$art_i = 0, $art_objxktcoglhgp$art_obj = curStepInfo.subs, $art_ckcxqqy$art_c = $art_objxktcoglhgp$art_obj.length; $art_iajpbxrgt$art_i < $art_ckcxqqy$art_c; $art_iajpbxrgt$art_i++) {    var sub = $art_objxktcoglhgp$art_obj[$art_iajpbxrgt$art_i]%>';
    for (var $art_iajpbxrgt$art_i = 0, $art_objxktcoglhgp$art_obj = curStepInfo.subs, $art_ckcxqqy$art_c = $art_objxktcoglhgp$art_obj.length; $art_iajpbxrgt$art_i < $art_ckcxqqy$art_c; $art_iajpbxrgt$art_i++) {
        var sub = $art_objxktcoglhgp$art_obj[$art_iajpbxrgt$art_i];
        $p += '<div mxv mxa="_zs_gallerydf:c" class="_zs_gallery_mx-main_index_-content-box"><div mxa="_zs_gallerydf:d" class="_zs_gallery_mx-main_index_-box-title clearfix">';
        $line = 31;
        $art = 'if sub.icon';
        ;
        $expr = '<%if (sub.icon) {%>';
        if (sub.icon) {
            ;
            $p += '<span mxa="_zs_gallerydf:e" class="_zs_gallery_mx-main_index_-title-icon">';
            $line = 31;
            $art = '!sub.icon';
            ;
        ...
        ;
        $p += '<span mxa="_zs_gallerydf:f" class="_zs_gallery_mx-main_index_-title-label">';
        $line = 32;
        $art = '=sub.label';
        ;
        ...
        if (sub.tip) {
            ;
            $p += '<span mxa="_zs_gallerydf:g" class="_zs_gallery_mx-main_index_-title-tip">';
            $line = 34;
            $art = '!sub.tip';
            ;
        ...
        $art = '@childInfos';
        ;
        $p += ($expr = '<%@childInfos%>', $i($$ref, childInfos)) + '"><div mxs="_zs_gallerydf:b" class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></div></div>';
        $line = 43;
        $art = '/each';
        ;
        $expr = '<%}%>';
    ...
    if (curStepInfo.sideWrapper) {
        ...
        ;
        $p += ($expr = '<%@curStepInfo.sideData%>', $i($$ref, curStepInfo.sideData)) + '"><div mxs="_zs_gallerydf:b" class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></div>';
        $line = 49;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '<div mxa="_zs_gallerydf:h" class="_zs_gallery_mx-main_index_-content-footer"><div>';
    $line = 53;
    ...
    if (curStepInfo.prevTip) {
        ;
        $p += '<a mxa="_zs_gallerydf:i" href="javascript:;" class="btn min-width-100 mr20" mx-click="' + $viewId + 'prev()">';
        $line = 55;
    ...
    if (curStepInfo.nextTip) {
        ;
        $p += '<a mxa="_zs_gallerydf:j" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
        $line = 60;
