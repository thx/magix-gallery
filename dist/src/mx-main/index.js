...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cyvqlszardi$art_c = stepInfos.length; stepIndex < $art_cyvqlszardi$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cyvqlszardi$art_c = stepInfos.length; stepIndex < $art_cyvqlszardi$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ilechyoy$art_i = 0, $art_objpzqiblq$art_obj = step.subs, $art_cfwswnyux$art_c = $art_objpzqiblq$art_obj.length; $art_ilechyoy$art_i < $art_cfwswnyux$art_c; $art_ilechyoy$art_i++) {            var sub = $art_objpzqiblq$art_obj[$art_ilechyoy$art_i]%>';
            for (var $art_ilechyoy$art_i = 0, $art_objpzqiblq$art_obj = step.subs, $art_cfwswnyux$art_c = $art_objpzqiblq$art_obj.length; $art_ilechyoy$art_i < $art_cfwswnyux$art_c; $art_ilechyoy$art_i++) {
                var sub = $art_objpzqiblq$art_obj[$art_ilechyoy$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipmaarfdaj$art_i = 0, $art_objelblsqawc$art_obj = curStepInfo.subs, $art_cryvvcoft$art_c = $art_objelblsqawc$art_obj.length; $art_ipmaarfdaj$art_i < $art_cryvvcoft$art_c; $art_ipmaarfdaj$art_i++) {    var sub = $art_objelblsqawc$art_obj[$art_ipmaarfdaj$art_i]%>';
    for (var $art_ipmaarfdaj$art_i = 0, $art_objelblsqawc$art_obj = curStepInfo.subs, $art_cryvvcoft$art_c = $art_objelblsqawc$art_obj.length; $art_ipmaarfdaj$art_i < $art_cryvvcoft$art_c; $art_ipmaarfdaj$art_i++) {
        var sub = $art_objelblsqawc$art_obj[$art_ipmaarfdaj$art_i];
