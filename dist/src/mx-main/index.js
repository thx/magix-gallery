...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_clckvs$art_c = stepInfos.length; stepIndex < $art_clckvs$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_clckvs$art_c = stepInfos.length; stepIndex < $art_clckvs$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ivuzwwttmoa$art_i = 0, $art_objnfsdgt$art_obj = step.subs, $art_cyrbvqql$art_c = $art_objnfsdgt$art_obj.length; $art_ivuzwwttmoa$art_i < $art_cyrbvqql$art_c; $art_ivuzwwttmoa$art_i++) {            var sub = $art_objnfsdgt$art_obj[$art_ivuzwwttmoa$art_i]%>';
            for (var $art_ivuzwwttmoa$art_i = 0, $art_objnfsdgt$art_obj = step.subs, $art_cyrbvqql$art_c = $art_objnfsdgt$art_obj.length; $art_ivuzwwttmoa$art_i < $art_cyrbvqql$art_c; $art_ivuzwwttmoa$art_i++) {
                var sub = $art_objnfsdgt$art_obj[$art_ivuzwwttmoa$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwyfzpmil$art_i = 0, $art_objwbbzxsba$art_obj = curStepInfo.subs, $art_clnwlczcr$art_c = $art_objwbbzxsba$art_obj.length; $art_iwyfzpmil$art_i < $art_clnwlczcr$art_c; $art_iwyfzpmil$art_i++) {    var sub = $art_objwbbzxsba$art_obj[$art_iwyfzpmil$art_i]%>';
    for (var $art_iwyfzpmil$art_i = 0, $art_objwbbzxsba$art_obj = curStepInfo.subs, $art_clnwlczcr$art_c = $art_objwbbzxsba$art_obj.length; $art_iwyfzpmil$art_i < $art_clnwlczcr$art_c; $art_iwyfzpmil$art_i++) {
        var sub = $art_objwbbzxsba$art_obj[$art_iwyfzpmil$art_i];
