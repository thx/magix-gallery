...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cirjxjvydg$art_c = stepInfos.length; stepIndex < $art_cirjxjvydg$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cirjxjvydg$art_c = stepInfos.length; stepIndex < $art_cirjxjvydg$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_iyxkhir$art_i = 0, $art_objagxksimdf$art_obj = step.subs, $art_cjysxiqjyrq$art_c = $art_objagxksimdf$art_obj.length; $art_iyxkhir$art_i < $art_cjysxiqjyrq$art_c; $art_iyxkhir$art_i++) {            var sub = $art_objagxksimdf$art_obj[$art_iyxkhir$art_i]%>';
            for (var $art_iyxkhir$art_i = 0, $art_objagxksimdf$art_obj = step.subs, $art_cjysxiqjyrq$art_c = $art_objagxksimdf$art_obj.length; $art_iyxkhir$art_i < $art_cjysxiqjyrq$art_c; $art_iyxkhir$art_i++) {
                var sub = $art_objagxksimdf$art_obj[$art_iyxkhir$art_i];
    ...
    ;
    $expr = '<%for (var $art_izmsioqwfj$art_i = 0, $art_objwtxtxlfvka$art_obj = curStepInfo.subs, $art_cccopvdk$art_c = $art_objwtxtxlfvka$art_obj.length; $art_izmsioqwfj$art_i < $art_cccopvdk$art_c; $art_izmsioqwfj$art_i++) {    var sub = $art_objwtxtxlfvka$art_obj[$art_izmsioqwfj$art_i]%>';
    for (var $art_izmsioqwfj$art_i = 0, $art_objwtxtxlfvka$art_obj = curStepInfo.subs, $art_cccopvdk$art_c = $art_objwtxtxlfvka$art_obj.length; $art_izmsioqwfj$art_i < $art_cccopvdk$art_c; $art_izmsioqwfj$art_i++) {
        var sub = $art_objwtxtxlfvka$art_obj[$art_izmsioqwfj$art_i];
