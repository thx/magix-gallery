...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cuyddpeq$art_c = stepInfos.length; stepIndex < $art_cuyddpeq$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cuyddpeq$art_c = stepInfos.length; stepIndex < $art_cuyddpeq$art_c; stepIndex++) {
        ...
        ;
        $p += ' data-spm-click="gostr=/alimama.feedflow.1;locaid=df0100677"><span mxa="_zs_gallerydb:_" class="_zs_gallery_mx-main_index_-idx">';
        $line = 7;
        $art = '=(stepIndex + 1)';
        ;
        $p += ($expr = '<%=(stepIndex + 1)%>', $e((stepIndex + 1))) + '</span><span mxs="_zs_gallerydb:_" class="_zs_gallery_mx-main_index_-pbg"></span><span mxa="_zs_gallerydb:a" class="_zs_gallery_mx-main_index_-text">';
        $line = 9;
        $art = '=step.label';
        ;
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_inegsp$art_i = 0, $art_objnsamdjbm$art_obj = step.subs, $art_cdtwwxuwir$art_c = $art_objnsamdjbm$art_obj.length; $art_inegsp$art_i < $art_cdtwwxuwir$art_c; $art_inegsp$art_i++) {            var sub = $art_objnsamdjbm$art_obj[$art_inegsp$art_i]%>';
            for (var $art_inegsp$art_i = 0, $art_objnsamdjbm$art_obj = step.subs, $art_cdtwwxuwir$art_c = $art_objnsamdjbm$art_obj.length; $art_inegsp$art_i < $art_cdtwwxuwir$art_c; $art_inegsp$art_i++) {
                var sub = $art_objnsamdjbm$art_obj[$art_inegsp$art_i];
                ...
                $art = '=sub.index';
                ;
                $p += ($expr = '<%=sub.index%>', $e(sub.index)) + '})" data-spm-click="gostr=/alimama.feedflow.1;locaid=de313a21d"><span mxs="_zs_gallerydb:_" class="_zs_gallery_mx-main_index_-pbg"></span><span mxa="_zs_gallerydb:b" class="_zs_gallery_mx-main_index_-text">';
                $line = 17;
                $art = '=sub.label';
                ;
        ...
        if (step.locked) {
            ;
            $p += '<i mxs="_zs_gallerydb:a" class="mc-iconfont _zs_gallery_mx-main_index_-locked-icon">&#xe759;</i>';
            $line = 23;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    ;
    $expr = '<%for (var $art_isugbvoxr$art_i = 0, $art_objwspsjliaei$art_obj = curStepInfo.subs, $art_cionfoca$art_c = $art_objwspsjliaei$art_obj.length; $art_isugbvoxr$art_i < $art_cionfoca$art_c; $art_isugbvoxr$art_i++) {    var sub = $art_objwspsjliaei$art_obj[$art_isugbvoxr$art_i]%>';
    for (var $art_isugbvoxr$art_i = 0, $art_objwspsjliaei$art_obj = curStepInfo.subs, $art_cionfoca$art_c = $art_objwspsjliaei$art_obj.length; $art_isugbvoxr$art_i < $art_cionfoca$art_c; $art_isugbvoxr$art_i++) {
        var sub = $art_objwspsjliaei$art_obj[$art_isugbvoxr$art_i];
        $p += '<div mxv mxa="_zs_gallerydb:c" class="_zs_gallery_mx-main_index_-content-box"><div mxa="_zs_gallerydb:d" class="_zs_gallery_mx-main_index_-box-title clearfix">';
        $line = 31;
        $art = 'if sub.icon';
        ;
        $expr = '<%if (sub.icon) {%>';
        if (sub.icon) {
            ;
            $p += '<span mxa="_zs_gallerydb:e" class="_zs_gallery_mx-main_index_-title-icon">';
            $line = 31;
            $art = '!sub.icon';
            ;
        ...
        ;
        $p += '<span mxa="_zs_gallerydb:f" class="_zs_gallery_mx-main_index_-title-label">';
        $line = 32;
        $art = '=sub.label';
        ;
        ...
        if (sub.tip) {
            ;
            $p += '<span mxa="_zs_gallerydb:g" class="_zs_gallery_mx-main_index_-title-tip">';
            $line = 34;
            $art = '!sub.tip';
            ;
        ...
        $art = '@childInfos';
        ;
        $p += ($expr = '<%@childInfos%>', $i($$ref, childInfos)) + '"><div mxs="_zs_gallerydb:b" class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></div></div>';
        $line = 43;
        $art = '/each';
        ;
        $expr = '<%}%>';
    ...
    if (curStepInfo.sideWrapper) {
        ...
        ;
        $p += ($expr = '<%@curStepInfo.sideData%>', $i($$ref, curStepInfo.sideData)) + '"><div mxs="_zs_gallerydb:b" class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></div>';
        $line = 49;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '<div mxa="_zs_gallerydb:h" class="_zs_gallery_mx-main_index_-content-footer"><div>';
    $line = 53;
    ...
    if (curStepInfo.prevTip) {
        ;
        $p += '<a mxa="_zs_gallerydb:i" href="javascript:;" class="btn min-width-100 mr20" mx-click="' + $viewId + 'prev()">';
        $line = 55;
    ...
    if (curStepInfo.nextTip) {
        ;
        $p += '<a mxa="_zs_gallerydb:j" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
        $line = 60;
