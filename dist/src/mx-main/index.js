...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_czoegji$art_c = stepInfos.length; stepIndex < $art_czoegji$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_czoegji$art_c = stepInfos.length; stepIndex < $art_czoegji$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_instrtxvc$art_i = 0, $art_objabhxjijc$art_obj = step.subs, $art_cxkfhkrh$art_c = $art_objabhxjijc$art_obj.length; $art_instrtxvc$art_i < $art_cxkfhkrh$art_c; $art_instrtxvc$art_i++) {            var sub = $art_objabhxjijc$art_obj[$art_instrtxvc$art_i]%>';
            for (var $art_instrtxvc$art_i = 0, $art_objabhxjijc$art_obj = step.subs, $art_cxkfhkrh$art_c = $art_objabhxjijc$art_obj.length; $art_instrtxvc$art_i < $art_cxkfhkrh$art_c; $art_instrtxvc$art_i++) {
                var sub = $art_objabhxjijc$art_obj[$art_instrtxvc$art_i];
    ...
    ;
    $expr = '<%for (var $art_ithysgpwhq$art_i = 0, $art_objhlhanbyudg$art_obj = curStepInfo.subs, $art_cgzhaexa$art_c = $art_objhlhanbyudg$art_obj.length; $art_ithysgpwhq$art_i < $art_cgzhaexa$art_c; $art_ithysgpwhq$art_i++) {    var sub = $art_objhlhanbyudg$art_obj[$art_ithysgpwhq$art_i]%>';
    for (var $art_ithysgpwhq$art_i = 0, $art_objhlhanbyudg$art_obj = curStepInfo.subs, $art_cgzhaexa$art_c = $art_objhlhanbyudg$art_obj.length; $art_ithysgpwhq$art_i < $art_cgzhaexa$art_c; $art_ithysgpwhq$art_i++) {
        var sub = $art_objhlhanbyudg$art_obj[$art_ithysgpwhq$art_i];
