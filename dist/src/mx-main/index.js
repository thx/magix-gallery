...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cjipaeyuk$art_c = stepInfos.length; stepIndex < $art_cjipaeyuk$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cjipaeyuk$art_c = stepInfos.length; stepIndex < $art_cjipaeyuk$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ibgnzqmjqr$art_i = 0, $art_objhrikgmxiuk$art_obj = step.subs, $art_cmvvvyj$art_c = $art_objhrikgmxiuk$art_obj.length; $art_ibgnzqmjqr$art_i < $art_cmvvvyj$art_c; $art_ibgnzqmjqr$art_i++) {            var sub = $art_objhrikgmxiuk$art_obj[$art_ibgnzqmjqr$art_i]%>';
            for (var $art_ibgnzqmjqr$art_i = 0, $art_objhrikgmxiuk$art_obj = step.subs, $art_cmvvvyj$art_c = $art_objhrikgmxiuk$art_obj.length; $art_ibgnzqmjqr$art_i < $art_cmvvvyj$art_c; $art_ibgnzqmjqr$art_i++) {
                var sub = $art_objhrikgmxiuk$art_obj[$art_ibgnzqmjqr$art_i];
    ...
    ;
    $expr = '<%for (var $art_idggydfv$art_i = 0, $art_objxvkxvwu$art_obj = curStepInfo.subs, $art_clywawhtv$art_c = $art_objxvkxvwu$art_obj.length; $art_idggydfv$art_i < $art_clywawhtv$art_c; $art_idggydfv$art_i++) {    var sub = $art_objxvkxvwu$art_obj[$art_idggydfv$art_i]%>';
    for (var $art_idggydfv$art_i = 0, $art_objxvkxvwu$art_obj = curStepInfo.subs, $art_clywawhtv$art_c = $art_objxvkxvwu$art_obj.length; $art_idggydfv$art_i < $art_clywawhtv$art_c; $art_idggydfv$art_i++) {
        var sub = $art_objxvkxvwu$art_obj[$art_idggydfv$art_i];
