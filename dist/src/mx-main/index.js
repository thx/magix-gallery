...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_ctbntleziwk$art_c = stepInfos.length; stepIndex < $art_ctbntleziwk$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_ctbntleziwk$art_c = stepInfos.length; stepIndex < $art_ctbntleziwk$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_iyhmwkrp$art_i = 0, $art_objprsyytqh$art_obj = step.subs, $art_cnnfrrmpp$art_c = $art_objprsyytqh$art_obj.length; $art_iyhmwkrp$art_i < $art_cnnfrrmpp$art_c; $art_iyhmwkrp$art_i++) {            var sub = $art_objprsyytqh$art_obj[$art_iyhmwkrp$art_i]%>';
            for (var $art_iyhmwkrp$art_i = 0, $art_objprsyytqh$art_obj = step.subs, $art_cnnfrrmpp$art_c = $art_objprsyytqh$art_obj.length; $art_iyhmwkrp$art_i < $art_cnnfrrmpp$art_c; $art_iyhmwkrp$art_i++) {
                var sub = $art_objprsyytqh$art_obj[$art_iyhmwkrp$art_i];
    ...
    ;
    $expr = '<%for (var $art_iseka$art_i = 0, $art_objmamjgqz$art_obj = curStepInfo.subs, $art_cqmxvrafir$art_c = $art_objmamjgqz$art_obj.length; $art_iseka$art_i < $art_cqmxvrafir$art_c; $art_iseka$art_i++) {    var sub = $art_objmamjgqz$art_obj[$art_iseka$art_i]%>';
    for (var $art_iseka$art_i = 0, $art_objmamjgqz$art_obj = curStepInfo.subs, $art_cqmxvrafir$art_c = $art_objmamjgqz$art_obj.length; $art_iseka$art_i < $art_cqmxvrafir$art_c; $art_iseka$art_i++) {
        var sub = $art_objmamjgqz$art_obj[$art_iseka$art_i];
