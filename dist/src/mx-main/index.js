...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cmwiqvsq$art_c = stepInfos.length; stepIndex < $art_cmwiqvsq$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cmwiqvsq$art_c = stepInfos.length; stepIndex < $art_cmwiqvsq$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_ihoahtndm$art_i = 0, $art_objmpmemz$art_obj = step.subs, $art_cvojtspvh$art_c = $art_objmpmemz$art_obj.length; $art_ihoahtndm$art_i < $art_cvojtspvh$art_c; $art_ihoahtndm$art_i++) {            var sub = $art_objmpmemz$art_obj[$art_ihoahtndm$art_i]%>';
            for (var $art_ihoahtndm$art_i = 0, $art_objmpmemz$art_obj = step.subs, $art_cvojtspvh$art_c = $art_objmpmemz$art_obj.length; $art_ihoahtndm$art_i < $art_cvojtspvh$art_c; $art_ihoahtndm$art_i++) {
                var sub = $art_objmpmemz$art_obj[$art_ihoahtndm$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqcvupyoel$art_i = 0, $art_objehcaenste$art_obj = curStepInfo.subs, $art_cozmbojpll$art_c = $art_objehcaenste$art_obj.length; $art_iqcvupyoel$art_i < $art_cozmbojpll$art_c; $art_iqcvupyoel$art_i++) {    var sub = $art_objehcaenste$art_obj[$art_iqcvupyoel$art_i]%>';
    for (var $art_iqcvupyoel$art_i = 0, $art_objehcaenste$art_obj = curStepInfo.subs, $art_cozmbojpll$art_c = $art_objehcaenste$art_obj.length; $art_iqcvupyoel$art_i < $art_cozmbojpll$art_c; $art_iqcvupyoel$art_i++) {
        var sub = $art_objehcaenste$art_obj[$art_iqcvupyoel$art_i];
