...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var stepIndex = 0, $art_cvzildcke$art_c = stepInfos.length; stepIndex < $art_cvzildcke$art_c; stepIndex++) {    var step = stepInfos[stepIndex]%>';
    for (var stepIndex = 0, $art_cvzildcke$art_c = stepInfos.length; stepIndex < $art_cvzildcke$art_c; stepIndex++) {
        ...
        if (!step.locked && (step.subs.length > 1)) {
            ...
            ;
            $expr = '<%for (var $art_izkheaf$art_i = 0, $art_objsiyuvdd$art_obj = step.subs, $art_ckzrnpajopz$art_c = $art_objsiyuvdd$art_obj.length; $art_izkheaf$art_i < $art_ckzrnpajopz$art_c; $art_izkheaf$art_i++) {            var sub = $art_objsiyuvdd$art_obj[$art_izkheaf$art_i]%>';
            for (var $art_izkheaf$art_i = 0, $art_objsiyuvdd$art_obj = step.subs, $art_ckzrnpajopz$art_c = $art_objsiyuvdd$art_obj.length; $art_izkheaf$art_i < $art_ckzrnpajopz$art_c; $art_izkheaf$art_i++) {
                var sub = $art_objsiyuvdd$art_obj[$art_izkheaf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ithkmrjs$art_i = 0, $art_objxixbtkeqqh$art_obj = curStepInfo.subs, $art_cquqbjjt$art_c = $art_objxixbtkeqqh$art_obj.length; $art_ithkmrjs$art_i < $art_cquqbjjt$art_c; $art_ithkmrjs$art_i++) {    var sub = $art_objxixbtkeqqh$art_obj[$art_ithkmrjs$art_i]%>';
    for (var $art_ithkmrjs$art_i = 0, $art_objxixbtkeqqh$art_obj = curStepInfo.subs, $art_cquqbjjt$art_c = $art_objxixbtkeqqh$art_obj.length; $art_ithkmrjs$art_i < $art_cquqbjjt$art_c; $art_ithkmrjs$art_i++) {
        var sub = $art_objxixbtkeqqh$art_obj[$art_ithkmrjs$art_i];
