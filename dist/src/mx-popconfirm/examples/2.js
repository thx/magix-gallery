...
module.exports = Base.extend({
    ...
    if (cur) {
        ;
        $p += '<div mxa="_zs_gallerydb:d" class="_zs_gallery_mx-popconfirm_examples_2_-center-tip">确认操作：';
        $line = 38;
        $art = '=cur';
        ;
