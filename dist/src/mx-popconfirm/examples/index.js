/*
    ...
    loader: cmd_es
 */
define("mx-popconfirm/examples/index",["magix","$","examples/subs","mx-title/second","./2","./4","./6","examples/api","examples/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mx-view="mx-popconfirm/examples/2" id="';
    $line = 24;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div><div mxa="_zs_gallerydf:a" class="clearfix mb20"><div mxa="_zs_gallerydf:b" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popconfirm/examples/4" id="';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_gallerydf:c" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popconfirm/examples/6" id="';
    $line = 30;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-popconfirm/examples/index.html';
    throw msg;
} return $p; },
    render: function () {
        var that = this;
