...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_ilxev$art_i = 0, $art_ccawuvxc$art_c = dots.length; $art_ilxev$art_i < $art_ccawuvxc$art_c; $art_ilxev$art_i++) {    var d = dots[$art_ilxev$art_i]%>';
    for (var $art_ilxev$art_i = 0, $art_ccawuvxc$art_c = dots.length; $art_ilxev$art_i < $art_ccawuvxc$art_c; $art_ilxev$art_i++) {
        var d = dots[$art_ilxev$art_i];
