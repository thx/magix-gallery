...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_inpyrsbcvs$art_i = 0, $art_cqofgdiy$art_c = dots.length; $art_inpyrsbcvs$art_i < $art_cqofgdiy$art_c; $art_inpyrsbcvs$art_i++) {    var d = dots[$art_inpyrsbcvs$art_i]%>';
    for (var $art_inpyrsbcvs$art_i = 0, $art_cqofgdiy$art_c = dots.length; $art_inpyrsbcvs$art_i < $art_cqofgdiy$art_c; $art_inpyrsbcvs$art_i++) {
        var d = dots[$art_inpyrsbcvs$art_i];
