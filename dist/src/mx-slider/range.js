...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_idqcoqbr$art_i = 0, $art_ctkywvvnx$art_c = dots.length; $art_idqcoqbr$art_i < $art_ctkywvvnx$art_c; $art_idqcoqbr$art_i++) {    var d = dots[$art_idqcoqbr$art_i]%>';
    for (var $art_idqcoqbr$art_i = 0, $art_ctkywvvnx$art_c = dots.length; $art_idqcoqbr$art_i < $art_ctkywvvnx$art_c; $art_idqcoqbr$art_i++) {
        var d = dots[$art_idqcoqbr$art_i];
