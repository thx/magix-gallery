...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_iuedftj$art_i = 0, $art_cfqtseypb$art_c = dots.length; $art_iuedftj$art_i < $art_cfqtseypb$art_c; $art_iuedftj$art_i++) {    var d = dots[$art_iuedftj$art_i]%>';
    for (var $art_iuedftj$art_i = 0, $art_cfqtseypb$art_c = dots.length; $art_iuedftj$art_i < $art_cfqtseypb$art_c; $art_iuedftj$art_i++) {
        var d = dots[$art_iuedftj$art_i];
    ...
    ;
    $p += '<span mxs="_zs_galleryej:_" class="_zs_gallery_mx-slider_index_-tracker"></span><span tabindex="0" mx-keydown="' + $viewId + '@{move.by.keyboard}({start:true})" class="_zs_gallery_mx-slider_index_-indicator" mx-mousedown="' + $viewId + '@{drag}({start:true})" id="left_';
    $line = 9;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '"></span><span mxa="_zs_galleryej:_" class="_zs_gallery_mx-slider_index_-scale-start">';
    $line = 14;
    $art = '=min';
    ;
    $p += ($expr = '<%=min%>', $e(min)) + '</span><span mxa="_zs_galleryej:a" class="_zs_gallery_mx-slider_index_-scale-end">';
    $line = 15;
    $art = '=max';
    ;
