...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryd-:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxs="_zs_galleryd-:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div class="mb40"><span class="color-9">以下示例：</span>可显示点自动计算，支持上下左右键</div><div class="pt20 pb20"><div mx-view="mx-slider/range?max=210&min=100&step=20&value=120%2C140&showDot=true"></div></div><div class="pt20 pb20"><div mx-view="mx-slider/range?max=200&min=100&step=20&value=120%2C140&showDot=true"></div></div></div><div mxa="_zs_galleryd-:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryd-:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">显示刻度点</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 24;
    $art = '=viewId';
    ;
