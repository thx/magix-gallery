...
module.exports = Base.extend({
    ...
    $art = '=cur';
    ;
    $p += ($expr = '<%=cur%>', $e(cur)) + '</span></div><div mxa="_zs_galleryd[:c" class="pt20 pb20"><div mx-change="' + $viewId + 'showValue()" mx-view="mx-slider/index?width=160&needInput=true&max=200&min=100&value=';
    $line = 22;
    $art = '=cur';
    ;
