...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryd@:a" class="clearfix mb20"><div mxa="_zs_galleryd@:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-slider/__test__/8" id="';
    $line = 29;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo7"></div></div><div mxa="_zs_galleryd@:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-slider/__test__/6" id="';
    $line = 33;
    $art = '=viewId';
    ;
