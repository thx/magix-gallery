...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_ipbtchyej$art_i = 0, $art_ckbyjirh$art_c = dots.length; $art_ipbtchyej$art_i < $art_ckbyjirh$art_c; $art_ipbtchyej$art_i++) {    var d = dots[$art_ipbtchyej$art_i]%>';
    for (var $art_ipbtchyej$art_i = 0, $art_ckbyjirh$art_c = dots.length; $art_ipbtchyej$art_i < $art_ckbyjirh$art_c; $art_ipbtchyej$art_i++) {
        var d = dots[$art_ipbtchyej$art_i];
