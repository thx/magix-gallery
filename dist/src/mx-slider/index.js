...
exports["default"] = View.extend({
    ...
    $p += '<div mxa="_zs_galleryec:_" class="_zs_gallery_mx-slider_index_-rail-wrapper"><span class="_zs_gallery_mx-slider_index_-rail" mx-contextmenu="' + $viewId + '@{prevent}()" style="';
    $line = 4;
    $art = 'if vertical';
    ;
    $expr = '<%if (vertical) {%>';
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_iappbzyv$art_i = 0, $art_coqdfsig$art_c = dots.length; $art_iappbzyv$art_i < $art_coqdfsig$art_c; $art_iappbzyv$art_i++) {    var d = dots[$art_iappbzyv$art_i]%>';
    for (var $art_iappbzyv$art_i = 0, $art_coqdfsig$art_c = dots.length; $art_iappbzyv$art_i < $art_coqdfsig$art_c; $art_iappbzyv$art_i++) {
        var d = dots[$art_iappbzyv$art_i];
    ...
    ;
    $p += '<span mxs="_zs_galleryec:_" class="_zs_gallery_mx-slider_index_-tracker"></span><span mxs="_zs_galleryec:a" class="_zs_gallery_mx-slider_index_-indicator" mx-mousedown="' + $viewId + '@{drag}()"></span><span mxs="_zs_galleryec:b" class="_zs_gallery_mx-slider_index_-pointer-label"></span><span mxa="_zs_galleryec:a" class="_zs_gallery_mx-slider_index_-scale-start">';
    $line = 13;
    $art = '=min';
    ;
    $p += ($expr = '<%=min%>', $e(min)) + '</span><span mxa="_zs_galleryec:b" class="_zs_gallery_mx-slider_index_-scale-end">';
    $line = 14;
    $art = '=max';
    ;
