...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_iiytegmef$art_i = 0, $art_csrgsoe$art_c = dots.length; $art_iiytegmef$art_i < $art_csrgsoe$art_c; $art_iiytegmef$art_i++) {    var d = dots[$art_iiytegmef$art_i]%>';
    for (var $art_iiytegmef$art_i = 0, $art_csrgsoe$art_c = dots.length; $art_iiytegmef$art_i < $art_csrgsoe$art_c; $art_iiytegmef$art_i++) {
        var d = dots[$art_iiytegmef$art_i];
