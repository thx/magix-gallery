...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_iijsysce$art_i = 0, $art_cdbwlnbr$art_c = dots.length; $art_iijsysce$art_i < $art_cdbwlnbr$art_c; $art_iijsysce$art_i++) {    var d = dots[$art_iijsysce$art_i]%>';
    for (var $art_iijsysce$art_i = 0, $art_cdbwlnbr$art_c = dots.length; $art_iijsysce$art_i < $art_cdbwlnbr$art_c; $art_iijsysce$art_i++) {
        var d = dots[$art_iijsysce$art_i];
