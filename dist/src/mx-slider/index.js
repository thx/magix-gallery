...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_izepjilh$art_i = 0, $art_cggaangyk$art_c = dots.length; $art_izepjilh$art_i < $art_cggaangyk$art_c; $art_izepjilh$art_i++) {    var d = dots[$art_izepjilh$art_i]%>';
    for (var $art_izepjilh$art_i = 0, $art_cggaangyk$art_c = dots.length; $art_izepjilh$art_i < $art_cggaangyk$art_c; $art_izepjilh$art_i++) {
        var d = dots[$art_izepjilh$art_i];
