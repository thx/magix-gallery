...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_ifeko$art_i = 0, $art_cxhzvcuwq$art_c = dots.length; $art_ifeko$art_i < $art_cxhzvcuwq$art_c; $art_ifeko$art_i++) {    var d = dots[$art_ifeko$art_i]%>';
    for (var $art_ifeko$art_i = 0, $art_cxhzvcuwq$art_c = dots.length; $art_ifeko$art_i < $art_cxhzvcuwq$art_c; $art_ifeko$art_i++) {
        var d = dots[$art_ifeko$art_i];
