...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_icktwzjjli$art_i = 0, $art_csznqzerx$art_c = dots.length; $art_icktwzjjli$art_i < $art_csznqzerx$art_c; $art_icktwzjjli$art_i++) {    var d = dots[$art_icktwzjjli$art_i]%>';
    for (var $art_icktwzjjli$art_i = 0, $art_csznqzerx$art_c = dots.length; $art_icktwzjjli$art_i < $art_csznqzerx$art_c; $art_icktwzjjli$art_i++) {
        var d = dots[$art_icktwzjjli$art_i];
    ...
    ;
    $p += '<span mxs="_zs_galleryev:_" class="_zs_gallery_mx-slider_index_-tracker"></span><span mxs="_zs_galleryev:a" class="_zs_gallery_mx-slider_index_-indicator" mx-mousedown="' + $viewId + '@{drag}()"></span><span mxs="_zs_galleryev:b" class="_zs_gallery_mx-slider_index_-pointer-label"></span><span mxa="_zs_galleryev:_" class="_zs_gallery_mx-slider_index_-scale-start">';
    $line = 13;
    $art = '=min';
    ;
    $p += ($expr = '<%=min%>', $e(min)) + '</span><span mxa="_zs_galleryev:a" class="_zs_gallery_mx-slider_index_-scale-end">';
    $line = 14;
    $art = '=max';
    ;
