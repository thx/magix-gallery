...
exports["default"] = View.extend({
    ...
    $art = 'each dots as d';
    ;
    $expr = '<%for (var $art_igttej$art_i = 0, $art_caajnzfe$art_c = dots.length; $art_igttej$art_i < $art_caajnzfe$art_c; $art_igttej$art_i++) {    var d = dots[$art_igttej$art_i]%>';
    for (var $art_igttej$art_i = 0, $art_caajnzfe$art_c = dots.length; $art_igttej$art_i < $art_caajnzfe$art_c; $art_igttej$art_i++) {
        var d = dots[$art_igttej$art_i];
