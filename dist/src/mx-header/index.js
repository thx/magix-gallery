...
module.exports = Magix.View.extend({
    ...
    if (links) {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cvsyuatrms$art_c = list.length; index < $art_cvsyuatrms$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cvsyuatrms$art_c = list.length; index < $art_cvsyuatrms$art_c; index++) {
            var item = list[index];
            ...
            ;
            $expr = '<%for (var $art_iwzxmuxbvvn$art_i = 0, $art_objykaecco$art_obj = item.seconds, $art_cwnsgvi$art_c = $art_objykaecco$art_obj.length; $art_iwzxmuxbvvn$art_i < $art_cwnsgvi$art_c; $art_iwzxmuxbvvn$art_i++) {            var second = $art_objykaecco$art_obj[$art_iwzxmuxbvvn$art_i]%>';
            for (var $art_iwzxmuxbvvn$art_i = 0, $art_objykaecco$art_obj = item.seconds, $art_cwnsgvi$art_c = $art_objykaecco$art_obj.length; $art_iwzxmuxbvvn$art_i < $art_cwnsgvi$art_c; $art_iwzxmuxbvvn$art_i++) {
                var second = $art_objykaecco$art_obj[$art_iwzxmuxbvvn$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_itxefuvtta$art_i = 0, $art_objpxmnya$art_obj = second.thirds, $art_chywwcpm$art_c = $art_objpxmnya$art_obj.length; $art_itxefuvtta$art_i < $art_chywwcpm$art_c; $art_itxefuvtta$art_i++) {                var third = $art_objpxmnya$art_obj[$art_itxefuvtta$art_i]%>';
                for (var $art_itxefuvtta$art_i = 0, $art_objpxmnya$art_obj = second.thirds, $art_chywwcpm$art_c = $art_objpxmnya$art_obj.length; $art_itxefuvtta$art_i < $art_chywwcpm$art_c; $art_itxefuvtta$art_i++) {
                    var third = $art_objpxmnya$art_obj[$art_itxefuvtta$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ingdfscf$art_i = 0, $art_cinclpqpd$art_c = navs.length; $art_ingdfscf$art_i < $art_cinclpqpd$art_c; $art_ingdfscf$art_i++) {        var nav = navs[$art_ingdfscf$art_i]%>';
        for (var $art_ingdfscf$art_i = 0, $art_cinclpqpd$art_c = navs.length; $art_ingdfscf$art_i < $art_cinclpqpd$art_c; $art_ingdfscf$art_i++) {
            var nav = navs[$art_ingdfscf$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_inwgjafa$art_i = 0, $art_objlsfbqtuil$art_obj = nav.subs, $art_ckbccprmtb$art_c = $art_objlsfbqtuil$art_obj.length; $art_inwgjafa$art_i < $art_ckbccprmtb$art_c; $art_inwgjafa$art_i++) {                var sub = $art_objlsfbqtuil$art_obj[$art_inwgjafa$art_i]%>';
                for (var $art_inwgjafa$art_i = 0, $art_objlsfbqtuil$art_obj = nav.subs, $art_ckbccprmtb$art_c = $art_objlsfbqtuil$art_obj.length; $art_inwgjafa$art_i < $art_ckbccprmtb$art_c; $art_inwgjafa$art_i++) {
                    var sub = $art_objlsfbqtuil$art_obj[$art_inwgjafa$art_i];
                    $p += '<a data-nav="';
                    $line = 55;
                    $art = '=sub[valueKey]';
                    ;
