...
module.exports = Magix.View.extend({
    ...
    if (links) {
        ...
        if (login) {
            ...
            if (user) {
                ...
                ;
                $p += '<span mxs="_zs_galleryc2:_" class="_zs_gallery_mx-header_index_-title-text">亲，请</span><a mxs="_zs_galleryc2:e" class="color-brand" href="javascript:;" mx-click="' + $viewId + 'showLogin()">登录</a>';
                $line = 13;
                $art = '/if';
                ;
                $expr = '<%}%>';
        ...
        ;
        $expr = '<%for (var index = 0, $art_cffnsnfapy$art_c = list.length; index < $art_cffnsnfapy$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cffnsnfapy$art_c = list.length; index < $art_cffnsnfapy$art_c; index++) {
            var item = list[index];
            ...
            ;
            $expr = '<%for (var $art_ivptzzkyhi$art_i = 0, $art_objrbepvx$art_obj = item.seconds, $art_cctxfxsv$art_c = $art_objrbepvx$art_obj.length; $art_ivptzzkyhi$art_i < $art_cctxfxsv$art_c; $art_ivptzzkyhi$art_i++) {            var second = $art_objrbepvx$art_obj[$art_ivptzzkyhi$art_i]%>';
            for (var $art_ivptzzkyhi$art_i = 0, $art_objrbepvx$art_obj = item.seconds, $art_cctxfxsv$art_c = $art_objrbepvx$art_obj.length; $art_ivptzzkyhi$art_i < $art_cctxfxsv$art_c; $art_ivptzzkyhi$art_i++) {
                var second = $art_objrbepvx$art_obj[$art_ivptzzkyhi$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_iujauyvps$art_i = 0, $art_objjcprbkrt$art_obj = second.thirds, $art_ceapooaancg$art_c = $art_objjcprbkrt$art_obj.length; $art_iujauyvps$art_i < $art_ceapooaancg$art_c; $art_iujauyvps$art_i++) {                var third = $art_objjcprbkrt$art_obj[$art_iujauyvps$art_i]%>';
                for (var $art_iujauyvps$art_i = 0, $art_objjcprbkrt$art_obj = second.thirds, $art_ceapooaancg$art_c = $art_objjcprbkrt$art_obj.length; $art_iujauyvps$art_i < $art_ceapooaancg$art_c; $art_iujauyvps$art_i++) {
                    var third = $art_objjcprbkrt$art_obj[$art_iujauyvps$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iunwytcca$art_i = 0, $art_cgvummxrunb$art_c = navs.length; $art_iunwytcca$art_i < $art_cgvummxrunb$art_c; $art_iunwytcca$art_i++) {        var nav = navs[$art_iunwytcca$art_i]%>';
        for (var $art_iunwytcca$art_i = 0, $art_cgvummxrunb$art_c = navs.length; $art_iunwytcca$art_i < $art_cgvummxrunb$art_c; $art_iunwytcca$art_i++) {
            var nav = navs[$art_iunwytcca$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_iybcznbo$art_i = 0, $art_objutcavk$art_obj = nav.subs, $art_cwtaljdt$art_c = $art_objutcavk$art_obj.length; $art_iybcznbo$art_i < $art_cwtaljdt$art_c; $art_iybcznbo$art_i++) {                var sub = $art_objutcavk$art_obj[$art_iybcznbo$art_i]%>';
                for (var $art_iybcznbo$art_i = 0, $art_objutcavk$art_obj = nav.subs, $art_cwtaljdt$art_c = $art_objutcavk$art_obj.length; $art_iybcznbo$art_i < $art_cwtaljdt$art_c; $art_iybcznbo$art_i++) {
                    var sub = $art_objutcavk$art_obj[$art_iybcznbo$art_i];
                    $p += '<a data-nav="';
                    $line = 55;
                    $art = '=sub[valueKey]';
                    ;
