...
exports["default"] = View.extend({
...
} ; var $g = '', $_temp, $p = '', dark = $$.dark, height = $$.height, links = $$.links, width = $$.width, login = $$.login, user = $$.user, logoutUrl = $$.logoutUrl, spm = $$.spm, list = $$.list, fixed = $$.fixed, styles = $$.styles, logo = $$.logo, navs = $$.navs, parent = $$.parent, valueKey = $$.valueKey, linkKey = $$.linkKey, textKey = $$.textKey, child = $$.child, rightView = $$.rightView; var $expr, $art, $line; try {
    ...
    if (links) {
        ...
        ;
        $p += '><div mxa="_zs_galleryc6:_" class="_zs_gallery_mx-header_index_-others-inner clearfix">';
        $line = 5;
        $art = 'if login';
        ;
        $expr = '<%if (login) {%>';
        if (login) {
            ;
            $p += '<div mxa="_zs_galleryc6:a" class="_zs_gallery_mx-header_index_-item">';
            $line = 7;
            $art = 'if user';
            ;
            $expr = '<%if (user) {%>';
            if (user) {
                ;
                $p += '<span mxa="_zs_galleryc6:b" class="_zs_gallery_mx-header_index_-title-text">你好，';
                $line = 8;
                $art = '=user';
                ;
                ...
                ;
                $p += '<span mxs="_zs_galleryc6:_" class="_zs_gallery_mx-header_index_-title-text">亲，请</span><a class="color-brand" href="javascript:;" mx-click="' + $viewId + 'showLogin()" ';
                $line = 12;
                $art = 'if spm';
                ;
                $expr = '<%if (spm) {%>';
        ...
        ;
        $p += '<div mxa="_zs_galleryc6:c" class="_zs_gallery_mx-header_index_-item"><a class="_zs_gallery_mx-header_index_-title-link" href="//www.alimama.com" target="_blank" rel="noopener noreferrer" ';
        $line = 17;
        $art = 'if spm';
        ;
        $expr = '<%if (spm) {%>';
        ...
        ;
        $expr = '<%for (var index = 0, $art_cqszfeyd$art_c = list.length; index < $art_cqszfeyd$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cqszfeyd$art_c = list.length; index < $art_cqszfeyd$art_c; index++) {
            var item = list[index];
            $p += '<div mxa="_zs_galleryc6:d" class="_zs_gallery_mx-header_index_-item"><span mxa="_zs_galleryc6:e" class="_zs_gallery_mx-header_index_-title-link">';
            $line = 21;
            $art = '=item.title';
            ;
            $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><i mxs="_zs_galleryc6:a" class="_zs_gallery_mx-header_index_-title-arrow mc-iconfont">&#xe692;</i><div mxa="_zs_galleryc6:f" class="_zs_gallery_mx-popover_index_-popover _zs_gallery_mx-popover_index_-bottom-center mx-shadow _zs_gallery_mx-header_index_-title-subs">';
            $line = 24;
            $art = 'each item.seconds as second';
            ;
            $expr = '<%for (var $art_ixziqjijeb$art_i = 0, $art_objihebonoe$art_obj = item.seconds, $art_cwvqppgok$art_c = $art_objihebonoe$art_obj.length; $art_ixziqjijeb$art_i < $art_cwvqppgok$art_c; $art_ixziqjijeb$art_i++) {            var second = $art_objihebonoe$art_obj[$art_ixziqjijeb$art_i]%>';
            for (var $art_ixziqjijeb$art_i = 0, $art_objihebonoe$art_obj = item.seconds, $art_cwvqppgok$art_c = $art_objihebonoe$art_obj.length; $art_ixziqjijeb$art_i < $art_cwvqppgok$art_c; $art_ixziqjijeb$art_i++) {
                var second = $art_objihebonoe$art_obj[$art_ixziqjijeb$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_ifkhozdrn$art_i = 0, $art_objsnglaud$art_obj = second.thirds, $art_cblbyawt$art_c = $art_objsnglaud$art_obj.length; $art_ifkhozdrn$art_i < $art_cblbyawt$art_c; $art_ifkhozdrn$art_i++) {                var third = $art_objsnglaud$art_obj[$art_ifkhozdrn$art_i]%>';
                for (var $art_ifkhozdrn$art_i = 0, $art_objsnglaud$art_obj = second.thirds, $art_cblbyawt$art_c = $art_objsnglaud$art_obj.length; $art_ifkhozdrn$art_i < $art_cblbyawt$art_c; $art_ifkhozdrn$art_i++) {
                    var third = $art_objsnglaud$art_obj[$art_ifkhozdrn$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    ;
    $p += '><div mxa="_zs_galleryc6:g" class="_zs_gallery_mx-header_index_-front-item _zs_gallery_mx-header_index_-logo"><img src="';
    $line = 43;
    $art = '=logo';
    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ijcsqgwiad$art_i = 0, $art_cdlyxxdudw$art_c = navs.length; $art_ijcsqgwiad$art_i < $art_cdlyxxdudw$art_c; $art_ijcsqgwiad$art_i++) {        var nav = navs[$art_ijcsqgwiad$art_i]%>';
        for (var $art_ijcsqgwiad$art_i = 0, $art_cdlyxxdudw$art_c = navs.length; $art_ijcsqgwiad$art_i < $art_cdlyxxdudw$art_c; $art_ijcsqgwiad$art_i++) {
            var nav = navs[$art_ijcsqgwiad$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ;
                $p += '<i mxs="_zs_galleryc6:b" class="_zs_gallery_mx-header_index_-nav-arrow mc-iconfont">&#xe692;</i><div mxa="_zs_galleryc6:h" class="_zs_gallery_mx-popover_index_-popover _zs_gallery_mx-popover_index_-bottom-center mx-shadow _zs_gallery_mx-header_index_-nav-subs">';
                $line = 55;
                $art = 'each nav.subs as sub';
                ;
                $expr = '<%for (var $art_igszxupgtq$art_i = 0, $art_objdapjterw$art_obj = nav.subs, $art_cjfzaodqdg$art_c = $art_objdapjterw$art_obj.length; $art_igszxupgtq$art_i < $art_cjfzaodqdg$art_c; $art_igszxupgtq$art_i++) {                var sub = $art_objdapjterw$art_obj[$art_igszxupgtq$art_i]%>';
                for (var $art_igszxupgtq$art_i = 0, $art_objdapjterw$art_obj = nav.subs, $art_cjfzaodqdg$art_c = $art_objdapjterw$art_obj.length; $art_igszxupgtq$art_i < $art_cjfzaodqdg$art_c; $art_igszxupgtq$art_i++) {
                    var sub = $art_objdapjterw$art_obj[$art_igszxupgtq$art_i];
                    $p += '<a data-nav="';
                    $line = 56;
                    $art = '=sub[valueKey]';
                    ;
    ...
    if (rightView) {
        ;
        $p += '<div mxa="_zs_galleryc6:i" class="_zs_gallery_mx-header_index_-front-right"><div class="_zs_gallery_mx-header_index_-right-inner" mx-view="';
        $line = 67;
        $art = '=rightView';
        ;
