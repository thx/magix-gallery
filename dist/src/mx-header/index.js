...
exports["default"] = View.extend({
    ...
    if (links) {
        ...
        ;
        $expr = '<%for (var index = 0, $art_crdkvrt$art_c = list.length; index < $art_crdkvrt$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_crdkvrt$art_c = list.length; index < $art_crdkvrt$art_c; index++) {
            var item = list[index];
            ...
            ;
            $expr = '<%for (var $art_irfwpjbn$art_i = 0, $art_objkizdnjrbqhf$art_obj = item.seconds, $art_cybfhoxjamxd$art_c = $art_objkizdnjrbqhf$art_obj.length; $art_irfwpjbn$art_i < $art_cybfhoxjamxd$art_c; $art_irfwpjbn$art_i++) {            var second = $art_objkizdnjrbqhf$art_obj[$art_irfwpjbn$art_i]%>';
            for (var $art_irfwpjbn$art_i = 0, $art_objkizdnjrbqhf$art_obj = item.seconds, $art_cybfhoxjamxd$art_c = $art_objkizdnjrbqhf$art_obj.length; $art_irfwpjbn$art_i < $art_cybfhoxjamxd$art_c; $art_irfwpjbn$art_i++) {
                var second = $art_objkizdnjrbqhf$art_obj[$art_irfwpjbn$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_ijgodfgiitk$art_i = 0, $art_objqeplsofo$art_obj = second.thirds, $art_cvikoqxe$art_c = $art_objqeplsofo$art_obj.length; $art_ijgodfgiitk$art_i < $art_cvikoqxe$art_c; $art_ijgodfgiitk$art_i++) {                var third = $art_objqeplsofo$art_obj[$art_ijgodfgiitk$art_i]%>';
                for (var $art_ijgodfgiitk$art_i = 0, $art_objqeplsofo$art_obj = second.thirds, $art_cvikoqxe$art_c = $art_objqeplsofo$art_obj.length; $art_ijgodfgiitk$art_i < $art_cvikoqxe$art_c; $art_ijgodfgiitk$art_i++) {
                    var third = $art_objqeplsofo$art_obj[$art_ijgodfgiitk$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iaspfwpiadt$art_i = 0, $art_cpbiuogczq$art_c = navs.length; $art_iaspfwpiadt$art_i < $art_cpbiuogczq$art_c; $art_iaspfwpiadt$art_i++) {        var nav = navs[$art_iaspfwpiadt$art_i]%>';
        for (var $art_iaspfwpiadt$art_i = 0, $art_cpbiuogczq$art_c = navs.length; $art_iaspfwpiadt$art_i < $art_cpbiuogczq$art_c; $art_iaspfwpiadt$art_i++) {
            var nav = navs[$art_iaspfwpiadt$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_igeefwmar$art_i = 0, $art_objtuhpmopj$art_obj = nav.subs, $art_cldldynvl$art_c = $art_objtuhpmopj$art_obj.length; $art_igeefwmar$art_i < $art_cldldynvl$art_c; $art_igeefwmar$art_i++) {                var sub = $art_objtuhpmopj$art_obj[$art_igeefwmar$art_i]%>';
                for (var $art_igeefwmar$art_i = 0, $art_objtuhpmopj$art_obj = nav.subs, $art_cldldynvl$art_c = $art_objtuhpmopj$art_obj.length; $art_igeefwmar$art_i < $art_cldldynvl$art_c; $art_igeefwmar$art_i++) {
                    var sub = $art_objtuhpmopj$art_obj[$art_igeefwmar$art_i];
                    $p += '<a data-nav="';
                    $line = 56;
                    $art = '=sub[valueKey]';
                    ;
