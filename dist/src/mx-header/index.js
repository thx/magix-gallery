...
exports["default"] = View.extend({
    ...
    if (links) {
        ...
        ;
        $expr = '<%for (var index = 0, $art_csdswlgfyxc$art_c = list.length; index < $art_csdswlgfyxc$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_csdswlgfyxc$art_c = list.length; index < $art_csdswlgfyxc$art_c; index++) {
            var item = list[index];
            ...
            ;
            $expr = '<%for (var $art_invfkxwtw$art_i = 0, $art_objcnidziawb$art_obj = item.seconds, $art_cehtpphc$art_c = $art_objcnidziawb$art_obj.length; $art_invfkxwtw$art_i < $art_cehtpphc$art_c; $art_invfkxwtw$art_i++) {            var second = $art_objcnidziawb$art_obj[$art_invfkxwtw$art_i]%>';
            for (var $art_invfkxwtw$art_i = 0, $art_objcnidziawb$art_obj = item.seconds, $art_cehtpphc$art_c = $art_objcnidziawb$art_obj.length; $art_invfkxwtw$art_i < $art_cehtpphc$art_c; $art_invfkxwtw$art_i++) {
                var second = $art_objcnidziawb$art_obj[$art_invfkxwtw$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_idsroaajq$art_i = 0, $art_objcidedrbzm$art_obj = second.thirds, $art_caidvzhltt$art_c = $art_objcidedrbzm$art_obj.length; $art_idsroaajq$art_i < $art_caidvzhltt$art_c; $art_idsroaajq$art_i++) {                var third = $art_objcidedrbzm$art_obj[$art_idsroaajq$art_i]%>';
                for (var $art_idsroaajq$art_i = 0, $art_objcidedrbzm$art_obj = second.thirds, $art_caidvzhltt$art_c = $art_objcidedrbzm$art_obj.length; $art_idsroaajq$art_i < $art_caidvzhltt$art_c; $art_idsroaajq$art_i++) {
                    var third = $art_objcidedrbzm$art_obj[$art_idsroaajq$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ixhwhlryp$art_i = 0, $art_cwtkuyfw$art_c = navs.length; $art_ixhwhlryp$art_i < $art_cwtkuyfw$art_c; $art_ixhwhlryp$art_i++) {        var nav = navs[$art_ixhwhlryp$art_i]%>';
        for (var $art_ixhwhlryp$art_i = 0, $art_cwtkuyfw$art_c = navs.length; $art_ixhwhlryp$art_i < $art_cwtkuyfw$art_c; $art_ixhwhlryp$art_i++) {
            var nav = navs[$art_ixhwhlryp$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_ixrtjezme$art_i = 0, $art_objrjwgroec$art_obj = nav.subs, $art_cuukafyum$art_c = $art_objrjwgroec$art_obj.length; $art_ixrtjezme$art_i < $art_cuukafyum$art_c; $art_ixrtjezme$art_i++) {                var sub = $art_objrjwgroec$art_obj[$art_ixrtjezme$art_i]%>';
                for (var $art_ixrtjezme$art_i = 0, $art_objrjwgroec$art_obj = nav.subs, $art_cuukafyum$art_c = $art_objrjwgroec$art_obj.length; $art_ixrtjezme$art_i < $art_cuukafyum$art_c; $art_ixrtjezme$art_i++) {
                    var sub = $art_objrjwgroec$art_obj[$art_ixrtjezme$art_i];
                    $p += '<a data-nav="';
                    $line = 56;
                    $art = '=sub[valueKey]';
                    ;
