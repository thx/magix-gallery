...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cidvwjmaeu$art_c = list.length; index < $art_cidvwjmaeu$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cidvwjmaeu$art_c = list.length; index < $art_cidvwjmaeu$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_immrrjja$art_i = 0, $art_objkwfoggnfw$art_obj = item.seconds, $art_cukqxvn$art_c = $art_objkwfoggnfw$art_obj.length; $art_immrrjja$art_i < $art_cukqxvn$art_c; $art_immrrjja$art_i++) {        var second = $art_objkwfoggnfw$art_obj[$art_immrrjja$art_i]%>';
        for (var $art_immrrjja$art_i = 0, $art_objkwfoggnfw$art_obj = item.seconds, $art_cukqxvn$art_c = $art_objkwfoggnfw$art_obj.length; $art_immrrjja$art_i < $art_cukqxvn$art_c; $art_immrrjja$art_i++) {
            var second = $art_objkwfoggnfw$art_obj[$art_immrrjja$art_i];
            $p += '<dl>';
            $line = 14;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_idfwfsmknc$art_i = 0, $art_objheginga$art_obj = second.thirds, $art_clbszmpuuz$art_c = $art_objheginga$art_obj.length; $art_idfwfsmknc$art_i < $art_clbszmpuuz$art_c; $art_idfwfsmknc$art_i++) {            var third = $art_objheginga$art_obj[$art_idfwfsmknc$art_i]%>';
            for (var $art_idfwfsmknc$art_i = 0, $art_objheginga$art_obj = second.thirds, $art_clbszmpuuz$art_c = $art_objheginga$art_obj.length; $art_idfwfsmknc$art_i < $art_clbszmpuuz$art_c; $art_idfwfsmknc$art_i++) {
                var third = $art_objheginga$art_obj[$art_idfwfsmknc$art_i];
                $p += '<dd><a href="';
                $line = 18;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_idyvmefcxik$art_i = 0, $art_cxipnwold$art_c = navs.length; $art_idyvmefcxik$art_i < $art_cxipnwold$art_c; $art_idyvmefcxik$art_i++) {        var nav = navs[$art_idyvmefcxik$art_i]%>';
        for (var $art_idyvmefcxik$art_i = 0, $art_cxipnwold$art_c = navs.length; $art_idyvmefcxik$art_i < $art_cxipnwold$art_c; $art_idyvmefcxik$art_i++) {
            var nav = navs[$art_idyvmefcxik$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_ihbrhvtvl$art_i = 0, $art_objhyarbjr$art_obj = nav.subs, $art_crbmbbrjy$art_c = $art_objhyarbjr$art_obj.length; $art_ihbrhvtvl$art_i < $art_crbmbbrjy$art_c; $art_ihbrhvtvl$art_i++) {                var sub = $art_objhyarbjr$art_obj[$art_ihbrhvtvl$art_i]%>';
                for (var $art_ihbrhvtvl$art_i = 0, $art_objhyarbjr$art_obj = nav.subs, $art_crbmbbrjy$art_c = $art_objhyarbjr$art_obj.length; $art_ihbrhvtvl$art_i < $art_crbmbbrjy$art_c; $art_ihbrhvtvl$art_i++) {
                    var sub = $art_objhyarbjr$art_obj[$art_ihbrhvtvl$art_i];
                    $p += '<div><a class="';
                    $line = 41;
