...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ctbwlsooh$art_c = list.length; index < $art_ctbwlsooh$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ctbwlsooh$art_c = list.length; index < $art_ctbwlsooh$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iibqiazssd$art_i = 0, $art_objvrilpehlt$art_obj = item.seconds, $art_cwmtwmiwt$art_c = $art_objvrilpehlt$art_obj.length; $art_iibqiazssd$art_i < $art_cwmtwmiwt$art_c; $art_iibqiazssd$art_i++) {        var second = $art_objvrilpehlt$art_obj[$art_iibqiazssd$art_i]%>';
        for (var $art_iibqiazssd$art_i = 0, $art_objvrilpehlt$art_obj = item.seconds, $art_cwmtwmiwt$art_c = $art_objvrilpehlt$art_obj.length; $art_iibqiazssd$art_i < $art_cwmtwmiwt$art_c; $art_iibqiazssd$art_i++) {
            var second = $art_objvrilpehlt$art_obj[$art_iibqiazssd$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iraoeuijieh$art_i = 0, $art_objmcjhgouo$art_obj = second.thirds, $art_cqhhgnbosm$art_c = $art_objmcjhgouo$art_obj.length; $art_iraoeuijieh$art_i < $art_cqhhgnbosm$art_c; $art_iraoeuijieh$art_i++) {            var third = $art_objmcjhgouo$art_obj[$art_iraoeuijieh$art_i]%>';
            for (var $art_iraoeuijieh$art_i = 0, $art_objmcjhgouo$art_obj = second.thirds, $art_cqhhgnbosm$art_c = $art_objmcjhgouo$art_obj.length; $art_iraoeuijieh$art_i < $art_cqhhgnbosm$art_c; $art_iraoeuijieh$art_i++) {
                var third = $art_objmcjhgouo$art_obj[$art_iraoeuijieh$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ijsjhuema$art_i = 0, $art_cwhbmuakhjq$art_c = navs.length; $art_ijsjhuema$art_i < $art_cwhbmuakhjq$art_c; $art_ijsjhuema$art_i++) {        var nav = navs[$art_ijsjhuema$art_i]%>';
        for (var $art_ijsjhuema$art_i = 0, $art_cwhbmuakhjq$art_c = navs.length; $art_ijsjhuema$art_i < $art_cwhbmuakhjq$art_c; $art_ijsjhuema$art_i++) {
            var nav = navs[$art_ijsjhuema$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
