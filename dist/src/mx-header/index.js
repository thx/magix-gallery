...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cjfrzhsfs$art_c = list.length; index < $art_cjfrzhsfs$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cjfrzhsfs$art_c = list.length; index < $art_cjfrzhsfs$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ijclpylhj$art_i = 0, $art_objvnpwidkamvb$art_obj = item.seconds, $art_cldoam$art_c = $art_objvnpwidkamvb$art_obj.length; $art_ijclpylhj$art_i < $art_cldoam$art_c; $art_ijclpylhj$art_i++) {        var second = $art_objvnpwidkamvb$art_obj[$art_ijclpylhj$art_i]%>';
        for (var $art_ijclpylhj$art_i = 0, $art_objvnpwidkamvb$art_obj = item.seconds, $art_cldoam$art_c = $art_objvnpwidkamvb$art_obj.length; $art_ijclpylhj$art_i < $art_cldoam$art_c; $art_ijclpylhj$art_i++) {
            var second = $art_objvnpwidkamvb$art_obj[$art_ijclpylhj$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iiprgfgh$art_i = 0, $art_objkkyixqnao$art_obj = second.thirds, $art_cvcxam$art_c = $art_objkkyixqnao$art_obj.length; $art_iiprgfgh$art_i < $art_cvcxam$art_c; $art_iiprgfgh$art_i++) {            var third = $art_objkkyixqnao$art_obj[$art_iiprgfgh$art_i]%>';
            for (var $art_iiprgfgh$art_i = 0, $art_objkkyixqnao$art_obj = second.thirds, $art_cvcxam$art_c = $art_objkkyixqnao$art_obj.length; $art_iiprgfgh$art_i < $art_cvcxam$art_c; $art_iiprgfgh$art_i++) {
                var third = $art_objkkyixqnao$art_obj[$art_iiprgfgh$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_inhepygsfg$art_i = 0, $art_ccvpcsyaogg$art_c = navs.length; $art_inhepygsfg$art_i < $art_ccvpcsyaogg$art_c; $art_inhepygsfg$art_i++) {        var nav = navs[$art_inhepygsfg$art_i]%>';
        for (var $art_inhepygsfg$art_i = 0, $art_ccvpcsyaogg$art_c = navs.length; $art_inhepygsfg$art_i < $art_ccvpcsyaogg$art_c; $art_inhepygsfg$art_i++) {
            var nav = navs[$art_inhepygsfg$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
