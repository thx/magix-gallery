/*
    ...
    loader: cmd_es
 */
define("mx-header/index",["magix","$","mx-header/data","mx-dialog/index","mx-effects/icon"],(require,exports,module)=>{
/*Magix,$,Data,Dialog*/
...
module.exports = Magix.View.extend({
    ...
    if (links) {
        ...
        if (login) {
            ...
            if (user) {
                ...
                ;
                $p += '<span mxs="_zs_galleryc2:_" class="_zs_gallery_mx-header_index_-title-text">亲，请</span><a mxs="_zs_galleryc2:a" class="color-brand" href="javascript:;" mx-click="' + $viewId + 'showLogin()">登录</a>';
                $line = 13;
                $art = '/if';
                ;
                $expr = '<%}%>';
        ...
        ;
        $p += '<div mxs="_zs_galleryc2:b" class="_zs_gallery_mx-header_index_-item"><a class="_zs_gallery_mx-header_index_-title-link" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
        $line = 19;
        $art = 'each list as item index';
        ;
        $expr = '<%for (var index = 0, $art_clcmmlgygr$art_c = list.length; index < $art_clcmmlgygr$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_clcmmlgygr$art_c = list.length; index < $art_clcmmlgygr$art_c; index++) {
            var item = list[index];
            ...
            ;
            $expr = '<%for (var $art_ivccrdwp$art_i = 0, $art_objzkhmvrxk$art_obj = item.seconds, $art_cjakgvqjid$art_c = $art_objzkhmvrxk$art_obj.length; $art_ivccrdwp$art_i < $art_cjakgvqjid$art_c; $art_ivccrdwp$art_i++) {            var second = $art_objzkhmvrxk$art_obj[$art_ivccrdwp$art_i]%>';
            for (var $art_ivccrdwp$art_i = 0, $art_objzkhmvrxk$art_obj = item.seconds, $art_cjakgvqjid$art_c = $art_objzkhmvrxk$art_obj.length; $art_ivccrdwp$art_i < $art_cjakgvqjid$art_c; $art_ivccrdwp$art_i++) {
                var second = $art_objzkhmvrxk$art_obj[$art_ivccrdwp$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_iievzbsptb$art_i = 0, $art_objqtxljgil$art_obj = second.thirds, $art_cunvfxepm$art_c = $art_objqtxljgil$art_obj.length; $art_iievzbsptb$art_i < $art_cunvfxepm$art_c; $art_iievzbsptb$art_i++) {                var third = $art_objqtxljgil$art_obj[$art_iievzbsptb$art_i]%>';
                for (var $art_iievzbsptb$art_i = 0, $art_objqtxljgil$art_obj = second.thirds, $art_cunvfxepm$art_c = $art_objqtxljgil$art_obj.length; $art_iievzbsptb$art_i < $art_cunvfxepm$art_c; $art_iievzbsptb$art_i++) {
                    var third = $art_objqtxljgil$art_obj[$art_iievzbsptb$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iinzgxmvnfpa$art_i = 0, $art_clqhnzxnnd$art_c = navs.length; $art_iinzgxmvnfpa$art_i < $art_clqhnzxnnd$art_c; $art_iinzgxmvnfpa$art_i++) {        var nav = navs[$art_iinzgxmvnfpa$art_i]%>';
        for (var $art_iinzgxmvnfpa$art_i = 0, $art_clqhnzxnnd$art_c = navs.length; $art_iinzgxmvnfpa$art_i < $art_clqhnzxnnd$art_c; $art_iinzgxmvnfpa$art_i++) {
            var nav = navs[$art_iinzgxmvnfpa$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_ifynyiytqlg$art_i = 0, $art_objwgppdq$art_obj = nav.subs, $art_ckaozdoqt$art_c = $art_objwgppdq$art_obj.length; $art_ifynyiytqlg$art_i < $art_ckaozdoqt$art_c; $art_ifynyiytqlg$art_i++) {                var sub = $art_objwgppdq$art_obj[$art_ifynyiytqlg$art_i]%>';
                for (var $art_ifynyiytqlg$art_i = 0, $art_objwgppdq$art_obj = nav.subs, $art_ckaozdoqt$art_c = $art_objwgppdq$art_obj.length; $art_ifynyiytqlg$art_i < $art_ckaozdoqt$art_c; $art_ifynyiytqlg$art_i++) {
                    var sub = $art_objwgppdq$art_obj[$art_ifynyiytqlg$art_i];
                    $p += '<a data-nav="';
                    $line = 55;
                    $art = '=sub[valueKey]';
                    ;
