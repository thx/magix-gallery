...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cnasgpcpu$art_c = list.length; index < $art_cnasgpcpu$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cnasgpcpu$art_c = list.length; index < $art_cnasgpcpu$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iblowcfzb$art_i = 0, $art_objkwbojyh$art_obj = item.seconds, $art_cxrqaxzm$art_c = $art_objkwbojyh$art_obj.length; $art_iblowcfzb$art_i < $art_cxrqaxzm$art_c; $art_iblowcfzb$art_i++) {        var second = $art_objkwbojyh$art_obj[$art_iblowcfzb$art_i]%>';
        for (var $art_iblowcfzb$art_i = 0, $art_objkwbojyh$art_obj = item.seconds, $art_cxrqaxzm$art_c = $art_objkwbojyh$art_obj.length; $art_iblowcfzb$art_i < $art_cxrqaxzm$art_c; $art_iblowcfzb$art_i++) {
            var second = $art_objkwbojyh$art_obj[$art_iblowcfzb$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ipwhsmh$art_i = 0, $art_objssfhwia$art_obj = second.thirds, $art_ckghhqv$art_c = $art_objssfhwia$art_obj.length; $art_ipwhsmh$art_i < $art_ckghhqv$art_c; $art_ipwhsmh$art_i++) {            var third = $art_objssfhwia$art_obj[$art_ipwhsmh$art_i]%>';
            for (var $art_ipwhsmh$art_i = 0, $art_objssfhwia$art_obj = second.thirds, $art_ckghhqv$art_c = $art_objssfhwia$art_obj.length; $art_ipwhsmh$art_i < $art_ckghhqv$art_c; $art_ipwhsmh$art_i++) {
                var third = $art_objssfhwia$art_obj[$art_ipwhsmh$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iayembcvdm$art_i = 0, $art_cfoeicotx$art_c = navs.length; $art_iayembcvdm$art_i < $art_cfoeicotx$art_c; $art_iayembcvdm$art_i++) {        var nav = navs[$art_iayembcvdm$art_i]%>';
        for (var $art_iayembcvdm$art_i = 0, $art_cfoeicotx$art_c = navs.length; $art_iayembcvdm$art_i < $art_cfoeicotx$art_c; $art_iayembcvdm$art_i++) {
            var nav = navs[$art_iayembcvdm$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
