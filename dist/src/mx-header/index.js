...
exports["default"] = View.extend({
    ...
    if (links) {
        ...
        ;
        $p += '<div mxa="_zs_galleryc2:i" class="_zs_gallery_mx-header_index_-item"><a class="_zs_gallery_mx-header_index_-title-link" href="//www.alimama.com" target="_blank" rel="noopener noreferrer" ';
        $line = 17;
        $art = 'if spm';
        ;
        $expr = '<%if (spm) {%>';
        ...
        ;
        $expr = '<%for (var index = 0, $art_cahuyzmhncu$art_c = list.length; index < $art_cahuyzmhncu$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cahuyzmhncu$art_c = list.length; index < $art_cahuyzmhncu$art_c; index++) {
            var item = list[index];
            $p += '<div mxa="_zs_galleryc2:c" class="_zs_gallery_mx-header_index_-item"><span mxa="_zs_galleryc2:d" class="_zs_gallery_mx-header_index_-title-link">';
            $line = 21;
            $art = '=item.title';
            ;
            $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><i mxs="_zs_galleryc2:c" class="_zs_gallery_mx-header_index_-title-arrow mc-iconfont">&#xe692;</i><div mxa="_zs_galleryc2:e" class="_zs_gallery_mx-popover_index_-popover _zs_gallery_mx-popover_index_-bottom-center mx-shadow _zs_gallery_mx-header_index_-title-subs">';
            $line = 24;
            $art = 'each item.seconds as second';
            ;
            $expr = '<%for (var $art_ilcvppmy$art_i = 0, $art_objgeczm$art_obj = item.seconds, $art_cnfkjzdl$art_c = $art_objgeczm$art_obj.length; $art_ilcvppmy$art_i < $art_cnfkjzdl$art_c; $art_ilcvppmy$art_i++) {            var second = $art_objgeczm$art_obj[$art_ilcvppmy$art_i]%>';
            for (var $art_ilcvppmy$art_i = 0, $art_objgeczm$art_obj = item.seconds, $art_cnfkjzdl$art_c = $art_objgeczm$art_obj.length; $art_ilcvppmy$art_i < $art_cnfkjzdl$art_c; $art_ilcvppmy$art_i++) {
                var second = $art_objgeczm$art_obj[$art_ilcvppmy$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_ifesfyppa$art_i = 0, $art_objhyifgla$art_obj = second.thirds, $art_csxqhuwk$art_c = $art_objhyifgla$art_obj.length; $art_ifesfyppa$art_i < $art_csxqhuwk$art_c; $art_ifesfyppa$art_i++) {                var third = $art_objhyifgla$art_obj[$art_ifesfyppa$art_i]%>';
                for (var $art_ifesfyppa$art_i = 0, $art_objhyifgla$art_obj = second.thirds, $art_csxqhuwk$art_c = $art_objhyifgla$art_obj.length; $art_ifesfyppa$art_i < $art_csxqhuwk$art_c; $art_ifesfyppa$art_i++) {
                    var third = $art_objhyifgla$art_obj[$art_ifesfyppa$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    ;
    $p += '><div mxa="_zs_galleryc2:f" class="_zs_gallery_mx-header_index_-front-item _zs_gallery_mx-header_index_-logo"><img src="';
    $line = 43;
    $art = '=logo';
    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iaqkytvrbxa$art_i = 0, $art_cmyputog$art_c = navs.length; $art_iaqkytvrbxa$art_i < $art_cmyputog$art_c; $art_iaqkytvrbxa$art_i++) {        var nav = navs[$art_iaqkytvrbxa$art_i]%>';
        for (var $art_iaqkytvrbxa$art_i = 0, $art_cmyputog$art_c = navs.length; $art_iaqkytvrbxa$art_i < $art_cmyputog$art_c; $art_iaqkytvrbxa$art_i++) {
            var nav = navs[$art_iaqkytvrbxa$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ;
                $p += '<i mxs="_zs_galleryc2:d" class="_zs_gallery_mx-header_index_-nav-arrow mc-iconfont">&#xe692;</i><div mxa="_zs_galleryc2:g" class="_zs_gallery_mx-popover_index_-popover _zs_gallery_mx-popover_index_-bottom-center mx-shadow _zs_gallery_mx-header_index_-nav-subs">';
                $line = 55;
                $art = 'each nav.subs as sub';
                ;
                $expr = '<%for (var $art_iwfagfv$art_i = 0, $art_objpwmsdx$art_obj = nav.subs, $art_cfznapdrsl$art_c = $art_objpwmsdx$art_obj.length; $art_iwfagfv$art_i < $art_cfznapdrsl$art_c; $art_iwfagfv$art_i++) {                var sub = $art_objpwmsdx$art_obj[$art_iwfagfv$art_i]%>';
                for (var $art_iwfagfv$art_i = 0, $art_objpwmsdx$art_obj = nav.subs, $art_cfznapdrsl$art_c = $art_objpwmsdx$art_obj.length; $art_iwfagfv$art_i < $art_cfznapdrsl$art_c; $art_iwfagfv$art_i++) {
                    var sub = $art_objpwmsdx$art_obj[$art_iwfagfv$art_i];
                    $p += '<a data-nav="';
                    $line = 56;
                    $art = '=sub[valueKey]';
                    ;
    ...
    if (rightView) {
        ;
        $p += '<div mxa="_zs_galleryc2:h" class="_zs_gallery_mx-header_index_-front-right"><div class="_zs_gallery_mx-header_index_-right-inner" mx-view="';
        $line = 67;
        $art = '=rightView';
        ;
