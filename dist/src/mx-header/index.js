...
exports["default"] = View.extend({
    ...
    if (links) {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cyebgnqan$art_c = list.length; index < $art_cyebgnqan$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cyebgnqan$art_c = list.length; index < $art_cyebgnqan$art_c; index++) {
            var item = list[index];
            ...
            ;
            $expr = '<%for (var $art_idtztooc$art_i = 0, $art_objuxpxiknl$art_obj = item.seconds, $art_ceeydpruwb$art_c = $art_objuxpxiknl$art_obj.length; $art_idtztooc$art_i < $art_ceeydpruwb$art_c; $art_idtztooc$art_i++) {            var second = $art_objuxpxiknl$art_obj[$art_idtztooc$art_i]%>';
            for (var $art_idtztooc$art_i = 0, $art_objuxpxiknl$art_obj = item.seconds, $art_ceeydpruwb$art_c = $art_objuxpxiknl$art_obj.length; $art_idtztooc$art_i < $art_ceeydpruwb$art_c; $art_idtztooc$art_i++) {
                var second = $art_objuxpxiknl$art_obj[$art_idtztooc$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_ihzbfhol$art_i = 0, $art_objqgyaglr$art_obj = second.thirds, $art_cmsypvtlp$art_c = $art_objqgyaglr$art_obj.length; $art_ihzbfhol$art_i < $art_cmsypvtlp$art_c; $art_ihzbfhol$art_i++) {                var third = $art_objqgyaglr$art_obj[$art_ihzbfhol$art_i]%>';
                for (var $art_ihzbfhol$art_i = 0, $art_objqgyaglr$art_obj = second.thirds, $art_cmsypvtlp$art_c = $art_objqgyaglr$art_obj.length; $art_ihzbfhol$art_i < $art_cmsypvtlp$art_c; $art_ihzbfhol$art_i++) {
                    var third = $art_objqgyaglr$art_obj[$art_ihzbfhol$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iwexgm$art_i = 0, $art_cdghuph$art_c = navs.length; $art_iwexgm$art_i < $art_cdghuph$art_c; $art_iwexgm$art_i++) {        var nav = navs[$art_iwexgm$art_i]%>';
        for (var $art_iwexgm$art_i = 0, $art_cdghuph$art_c = navs.length; $art_iwexgm$art_i < $art_cdghuph$art_c; $art_iwexgm$art_i++) {
            var nav = navs[$art_iwexgm$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_itxoaptwu$art_i = 0, $art_objokochllsv$art_obj = nav.subs, $art_crkkes$art_c = $art_objokochllsv$art_obj.length; $art_itxoaptwu$art_i < $art_crkkes$art_c; $art_itxoaptwu$art_i++) {                var sub = $art_objokochllsv$art_obj[$art_itxoaptwu$art_i]%>';
                for (var $art_itxoaptwu$art_i = 0, $art_objokochllsv$art_obj = nav.subs, $art_crkkes$art_c = $art_objokochllsv$art_obj.length; $art_itxoaptwu$art_i < $art_crkkes$art_c; $art_itxoaptwu$art_i++) {
                    var sub = $art_objokochllsv$art_obj[$art_itxoaptwu$art_i];
                    $p += '<a data-nav="';
                    $line = 56;
                    $art = '=sub[valueKey]';
                    ;
