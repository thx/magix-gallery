...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cmexdwzy$art_c = list.length; index < $art_cmexdwzy$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cmexdwzy$art_c = list.length; index < $art_cmexdwzy$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iahupocqhc$art_i = 0, $art_objbaeagvbxt$art_obj = item.seconds, $art_cvebixkspii$art_c = $art_objbaeagvbxt$art_obj.length; $art_iahupocqhc$art_i < $art_cvebixkspii$art_c; $art_iahupocqhc$art_i++) {        var second = $art_objbaeagvbxt$art_obj[$art_iahupocqhc$art_i]%>';
        for (var $art_iahupocqhc$art_i = 0, $art_objbaeagvbxt$art_obj = item.seconds, $art_cvebixkspii$art_c = $art_objbaeagvbxt$art_obj.length; $art_iahupocqhc$art_i < $art_cvebixkspii$art_c; $art_iahupocqhc$art_i++) {
            var second = $art_objbaeagvbxt$art_obj[$art_iahupocqhc$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ixlypartci$art_i = 0, $art_objzcdzypba$art_obj = second.thirds, $art_cqgfngkcg$art_c = $art_objzcdzypba$art_obj.length; $art_ixlypartci$art_i < $art_cqgfngkcg$art_c; $art_ixlypartci$art_i++) {            var third = $art_objzcdzypba$art_obj[$art_ixlypartci$art_i]%>';
            for (var $art_ixlypartci$art_i = 0, $art_objzcdzypba$art_obj = second.thirds, $art_cqgfngkcg$art_c = $art_objzcdzypba$art_obj.length; $art_ixlypartci$art_i < $art_cqgfngkcg$art_c; $art_ixlypartci$art_i++) {
                var third = $art_objzcdzypba$art_obj[$art_ixlypartci$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iqejewwdeu$art_i = 0, $art_cofikjqf$art_c = navs.length; $art_iqejewwdeu$art_i < $art_cofikjqf$art_c; $art_iqejewwdeu$art_i++) {        var nav = navs[$art_iqejewwdeu$art_i]%>';
        for (var $art_iqejewwdeu$art_i = 0, $art_cofikjqf$art_c = navs.length; $art_iqejewwdeu$art_i < $art_cofikjqf$art_c; $art_iqejewwdeu$art_i++) {
            var nav = navs[$art_iqejewwdeu$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
