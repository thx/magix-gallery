...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cyrluxkas$art_c = list.length; index < $art_cyrluxkas$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cyrluxkas$art_c = list.length; index < $art_cyrluxkas$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_inulibluewq$art_i = 0, $art_objtlpool$art_obj = item.seconds, $art_ckqltksml$art_c = $art_objtlpool$art_obj.length; $art_inulibluewq$art_i < $art_ckqltksml$art_c; $art_inulibluewq$art_i++) {        var second = $art_objtlpool$art_obj[$art_inulibluewq$art_i]%>';
        for (var $art_inulibluewq$art_i = 0, $art_objtlpool$art_obj = item.seconds, $art_ckqltksml$art_c = $art_objtlpool$art_obj.length; $art_inulibluewq$art_i < $art_ckqltksml$art_c; $art_inulibluewq$art_i++) {
            var second = $art_objtlpool$art_obj[$art_inulibluewq$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqxvscgeo$art_i = 0, $art_objtkyfpe$art_obj = second.thirds, $art_cvqlmklgd$art_c = $art_objtkyfpe$art_obj.length; $art_iqxvscgeo$art_i < $art_cvqlmklgd$art_c; $art_iqxvscgeo$art_i++) {            var third = $art_objtkyfpe$art_obj[$art_iqxvscgeo$art_i]%>';
            for (var $art_iqxvscgeo$art_i = 0, $art_objtkyfpe$art_obj = second.thirds, $art_cvqlmklgd$art_c = $art_objtkyfpe$art_obj.length; $art_iqxvscgeo$art_i < $art_cvqlmklgd$art_c; $art_iqxvscgeo$art_i++) {
                var third = $art_objtkyfpe$art_obj[$art_iqxvscgeo$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_itnrbafrnj$art_i = 0, $art_czxyrgmzt$art_c = navs.length; $art_itnrbafrnj$art_i < $art_czxyrgmzt$art_c; $art_itnrbafrnj$art_i++) {        var nav = navs[$art_itnrbafrnj$art_i]%>';
        for (var $art_itnrbafrnj$art_i = 0, $art_czxyrgmzt$art_c = navs.length; $art_itnrbafrnj$art_i < $art_czxyrgmzt$art_c; $art_itnrbafrnj$art_i++) {
            var nav = navs[$art_itnrbafrnj$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
