...
exports["default"] = View.extend({
    ...
    if (links) {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cxwbhxa$art_c = list.length; index < $art_cxwbhxa$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cxwbhxa$art_c = list.length; index < $art_cxwbhxa$art_c; index++) {
            var item = list[index];
            ...
            ;
            $expr = '<%for (var $art_ippunlqowmb$art_i = 0, $art_objchoemnq$art_obj = item.seconds, $art_cvmsaleyj$art_c = $art_objchoemnq$art_obj.length; $art_ippunlqowmb$art_i < $art_cvmsaleyj$art_c; $art_ippunlqowmb$art_i++) {            var second = $art_objchoemnq$art_obj[$art_ippunlqowmb$art_i]%>';
            for (var $art_ippunlqowmb$art_i = 0, $art_objchoemnq$art_obj = item.seconds, $art_cvmsaleyj$art_c = $art_objchoemnq$art_obj.length; $art_ippunlqowmb$art_i < $art_cvmsaleyj$art_c; $art_ippunlqowmb$art_i++) {
                var second = $art_objchoemnq$art_obj[$art_ippunlqowmb$art_i];
                $p += '<dl>';
                $line = 26;
                $art = 'if second.title';
                ;
                ...
                ;
                $expr = '<%for (var $art_ibxxdjao$art_i = 0, $art_objypljlj$art_obj = second.thirds, $art_catgjuteis$art_c = $art_objypljlj$art_obj.length; $art_ibxxdjao$art_i < $art_catgjuteis$art_c; $art_ibxxdjao$art_i++) {                var third = $art_objypljlj$art_obj[$art_ibxxdjao$art_i]%>';
                for (var $art_ibxxdjao$art_i = 0, $art_objypljlj$art_obj = second.thirds, $art_catgjuteis$art_c = $art_objypljlj$art_obj.length; $art_ibxxdjao$art_i < $art_catgjuteis$art_c; $art_ibxxdjao$art_i++) {
                    var third = $art_objypljlj$art_obj[$art_ibxxdjao$art_i];
                    $p += '<dd><a href="';
                    $line = 30;
                    $art = '=third.link';
                    ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ijgkutoyj$art_i = 0, $art_cmnsfkma$art_c = navs.length; $art_ijgkutoyj$art_i < $art_cmnsfkma$art_c; $art_ijgkutoyj$art_i++) {        var nav = navs[$art_ijgkutoyj$art_i]%>';
        for (var $art_ijgkutoyj$art_i = 0, $art_cmnsfkma$art_c = navs.length; $art_ijgkutoyj$art_i < $art_cmnsfkma$art_c; $art_ijgkutoyj$art_i++) {
            var nav = navs[$art_ijgkutoyj$art_i];
            ...
            if (nav.subs && nav.subs.length) {
                ...
                ;
                $expr = '<%for (var $art_imolahk$art_i = 0, $art_objgyxgzqv$art_obj = nav.subs, $art_cxaaxunq$art_c = $art_objgyxgzqv$art_obj.length; $art_imolahk$art_i < $art_cxaaxunq$art_c; $art_imolahk$art_i++) {                var sub = $art_objgyxgzqv$art_obj[$art_imolahk$art_i]%>';
                for (var $art_imolahk$art_i = 0, $art_objgyxgzqv$art_obj = nav.subs, $art_cxaaxunq$art_c = $art_objgyxgzqv$art_obj.length; $art_imolahk$art_i < $art_cxaaxunq$art_c; $art_imolahk$art_i++) {
                    var sub = $art_objgyxgzqv$art_obj[$art_imolahk$art_i];
                    $p += '<a data-nav="';
                    $line = 56;
                    $art = '=sub[valueKey]';
                    ;
