...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cwktip$art_c = list.length; index < $art_cwktip$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cwktip$art_c = list.length; index < $art_cwktip$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_icodburjbt$art_i = 0, $art_objhjgihcid$art_obj = item.seconds, $art_cyumtjnb$art_c = $art_objhjgihcid$art_obj.length; $art_icodburjbt$art_i < $art_cyumtjnb$art_c; $art_icodburjbt$art_i++) {        var second = $art_objhjgihcid$art_obj[$art_icodburjbt$art_i]%>';
        for (var $art_icodburjbt$art_i = 0, $art_objhjgihcid$art_obj = item.seconds, $art_cyumtjnb$art_c = $art_objhjgihcid$art_obj.length; $art_icodburjbt$art_i < $art_cyumtjnb$art_c; $art_icodburjbt$art_i++) {
            var second = $art_objhjgihcid$art_obj[$art_icodburjbt$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_izyyhlyfa$art_i = 0, $art_objqknasofj$art_obj = second.thirds, $art_ckvxaeehvo$art_c = $art_objqknasofj$art_obj.length; $art_izyyhlyfa$art_i < $art_ckvxaeehvo$art_c; $art_izyyhlyfa$art_i++) {            var third = $art_objqknasofj$art_obj[$art_izyyhlyfa$art_i]%>';
            for (var $art_izyyhlyfa$art_i = 0, $art_objqknasofj$art_obj = second.thirds, $art_ckvxaeehvo$art_c = $art_objqknasofj$art_obj.length; $art_izyyhlyfa$art_i < $art_ckvxaeehvo$art_c; $art_izyyhlyfa$art_i++) {
                var third = $art_objqknasofj$art_obj[$art_izyyhlyfa$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_idgdmuqdio$art_i = 0, $art_cphztlzpbs$art_c = navs.length; $art_idgdmuqdio$art_i < $art_cphztlzpbs$art_c; $art_idgdmuqdio$art_i++) {        var nav = navs[$art_idgdmuqdio$art_i]%>';
        for (var $art_idgdmuqdio$art_i = 0, $art_cphztlzpbs$art_c = navs.length; $art_idgdmuqdio$art_i < $art_cphztlzpbs$art_c; $art_idgdmuqdio$art_i++) {
            var nav = navs[$art_idgdmuqdio$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
