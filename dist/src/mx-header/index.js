...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cfboqnfwh$art_c = list.length; index < $art_cfboqnfwh$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cfboqnfwh$art_c = list.length; index < $art_cfboqnfwh$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iusjlpikta$art_i = 0, $art_objikbvgcewze$art_obj = item.seconds, $art_cmomtalvp$art_c = $art_objikbvgcewze$art_obj.length; $art_iusjlpikta$art_i < $art_cmomtalvp$art_c; $art_iusjlpikta$art_i++) {        var second = $art_objikbvgcewze$art_obj[$art_iusjlpikta$art_i]%>';
        for (var $art_iusjlpikta$art_i = 0, $art_objikbvgcewze$art_obj = item.seconds, $art_cmomtalvp$art_c = $art_objikbvgcewze$art_obj.length; $art_iusjlpikta$art_i < $art_cmomtalvp$art_c; $art_iusjlpikta$art_i++) {
            var second = $art_objikbvgcewze$art_obj[$art_iusjlpikta$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iiasjjfbjp$art_i = 0, $art_objdtmylip$art_obj = second.thirds, $art_cfhqbgbk$art_c = $art_objdtmylip$art_obj.length; $art_iiasjjfbjp$art_i < $art_cfhqbgbk$art_c; $art_iiasjjfbjp$art_i++) {            var third = $art_objdtmylip$art_obj[$art_iiasjjfbjp$art_i]%>';
            for (var $art_iiasjjfbjp$art_i = 0, $art_objdtmylip$art_obj = second.thirds, $art_cfhqbgbk$art_c = $art_objdtmylip$art_obj.length; $art_iiasjjfbjp$art_i < $art_cfhqbgbk$art_c; $art_iiasjjfbjp$art_i++) {
                var third = $art_objdtmylip$art_obj[$art_iiasjjfbjp$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ilnmhwp$art_i = 0, $art_cznztczokfn$art_c = navs.length; $art_ilnmhwp$art_i < $art_cznztczokfn$art_c; $art_ilnmhwp$art_i++) {        var nav = navs[$art_ilnmhwp$art_i]%>';
        for (var $art_ilnmhwp$art_i = 0, $art_cznztczokfn$art_c = navs.length; $art_ilnmhwp$art_i < $art_cznztczokfn$art_c; $art_ilnmhwp$art_i++) {
            var nav = navs[$art_ilnmhwp$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
