...
module.exports = Magix.View.extend({
    ...
    $art = '=cur';
    ;
    $p += ($expr = '<%!$eu(cur)%>', $eu(cur)) + '&logo=%2F%2Fimg.alicdn.com%2Ftfs%2FTB1Z0ggLPTpK1RjSZKPXXa3UpXa-534-98.png"></div><div mxa="_zs_gallerycE:_" class="_zs_gallery_mx-header_examples_index_-content"><div mxa="_zs_gallerycE:a" class="_zs_gallery_mx-header_examples_index_-inner">';
    $line = 8;
    $art = 'if !cur';
    ;
    $expr = '<%if (!cur) {%>';
