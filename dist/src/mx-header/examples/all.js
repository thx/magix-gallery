...
module.exports = Magix.View.extend({
    ...
    $art = '=cur';
    ;
    $p += ($expr = '<%!$eu(cur)%>', $eu(cur)) + '"></div><div mxa="_zs_galleryc3:_" class="_zs_gallery_mx-header_examples_index_-content"><div mxa="_zs_galleryc3:a" class="_zs_gallery_mx-header_examples_index_-inner">';
    $line = 7;
    $art = 'if !cur';
    ;
    $expr = '<%if (!cur) {%>';
