...
module.exports = Base.extend({
...
} ; var $g = '', $_temp, $p = '', viewId = $$.viewId, navs = $$.navs, cur = $$.cur, rightView = $$.rightView, text1 = $$.text1, text2 = $$.text2; var $expr, $art, $line; try {
    ...
    $art = '@navs';
    ;
    $p += ($expr = '<%@navs%>', $i($$ref, navs)) + '&links=true&ceiling=true&login=true&user=%E6%B5%8B%E8%AF%95%E8%B4%A6%E5%8F%B7&logoutUrl=%2Fapi%2Fmember%2Flogout.action&wrapper=';
    $line = 18;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test1"></div></div><div mxs="_zs_galleryc5:d" class="lh28 mb10">b. 未登录（user为空），<a rel="noopener noreferrer" href="#!/header/white?links=true&ceiling=true&login=true&bizCode=adStrategy&logoutUrl=/api/member/logout.action" class="link-brand" target="_blank">新页面查看示例</a></div><div mxv id="';
    $line = 21;
    $art = '=viewId';
    ;
    ...
    $art = '@navs';
    ;
    $p += ($expr = '<%@navs%>', $i($$ref, navs)) + '&links=true&ceiling=true&login=true&bizCode=adStrategy&logoutUrl=%2Fapi%2Fmember%2Flogout.action&wrapper=';
    $line = 30;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test2"></div></div></div><div mxs="_zs_galleryc5:e" class="lh28 mb10">2. 不包含顶部其他产品线信息（links=false），滚动不吸顶（ceiling=false），<a rel="noopener noreferrer" href="#!/header/white?links=false&ceiling=false" class="link-brand" target="_blank">新页面查看示例</a></div><div mxv id="';
    $line = 34;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test3"></div></div><div mxa="_zs_galleryc5:d" class="lh28 mb10">3. 包含顶部其他产品线信息（links=true），滚动吸顶（ceiling=true），不显示用户信息（login=false），右侧自定义view一直显示（right-view=\'@./right\'），<a rel="noopener noreferrer" href="#!/header/white?links=true&ceiling=true&login=false&rightView=';
    $line = 43;
    $art = '=rightView';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test4"></div></div></div></div><div mxa="_zs_galleryc5:f" class="clearfix"><div mxa="_zs_galleryc5:g" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_galleryc5:f" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 73;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryc5:h" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 75;
    $art = '!text1';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-header \n    dark="false"\n    navs="&#123;&#123;@navs&#125;&#125;"\n    cur="&#123;&#123;=cur&#125;&#125;"\n    login="&#123;&#123;=login&#125;&#125;"\n    user="&#123;&#123;=user&#125;&#125;"\n    right-view="&#123;&#123;=rightView&#125;&#125;"\n    right-ceiling-show="&#123;&#123;=rightCeilingShow&#125;&#125;"\n    biz-code="&#123;&#123;=bizCode&#125;&#125;"\n    logout-url="&#123;&#123;=logoutUrl&#125;&#125;"\n    links="&#123;&#123;=links&#125;&#125;"\n    ceiling="&#123;&#123;=ceiling&#125;&#125;"\n    mx-navchange="change()"/&gt;\n            </pre></div><div mxa="_zs_galleryc5:i" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half-right"><div mxs="_zs_galleryc5:h" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">JS Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 96;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryc5:j" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 98;
    $art = '!text2';
    ;
