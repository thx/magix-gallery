...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycN:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_gallerycN:x" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxv mxa="_zs_gallerycN:y" class="pt10 pb10"><div mxs="_zs_gallerycN:E" class="lh28"><span class="color-9">以下示例：</span>全屏使用header，支持二级菜单，支持外链打开</div><div mxs="_zs_gallerycN:F" class="lh28">1. 包含顶部其他产品线信息（links=true），滚动吸顶（ceiling=true），显示用户信息（login=true）</div><div mxv mxa="_zs_gallerycN:z" class="pl15"><div mxs="_zs_gallerycN:L" class="lh28">login=true时必须配置登陆页面（login-view=\'@./login\'），登出接口（logout-url=\'/api/member/logout.action\'），通过user有无来判断是否登陆</div><div mxa="_zs_gallerycN:b" class="lh28 mb10">a. 已登录（user=\'测试账号\'），<a rel="noopener noreferrer" href="#!/header/white?links=true&ceiling=true&login=true&user=测试账号&logoutUrl=/api/member/logout.action&loginView=';
    $line = 8;
    $art = '=loginView';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test1"></div></div><div mxa="_zs_gallerycN:g" class="lh28 mb10">b. 未登录（user为空），<a rel="noopener noreferrer" href="#!/header/white?links=true&ceiling=true&login=true&logoutUrl=/api/member/logout.action&loginView=';
    $line = 21;
    $art = '=loginView';
    ;
    $p += ($expr = '<%!$eu(loginView)%>', $eu(loginView)) + '" class="link-brand" target="_blank">新页面查看示例</a></div><div mxv id="';
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test2"></div></div></div><div mxs="_zs_gallerycN:N" class="lh28 mb10">2. 不包含顶部其他产品线信息（links=false），滚动不吸顶（ceiling=false），<a rel="noopener noreferrer" href="#!/header/white?links=false&ceiling=false" class="link-brand" target="_blank">新页面查看示例</a></div><div mxv id="';
    $line = 35;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test3"></div></div><div mxa="_zs_gallerycN:p" class="lh28 mb10">3. 包含顶部其他产品线信息（links=true），滚动吸顶（ceiling=true），不显示用户信息（login=false），右侧自定义view（right-view=\'@./right\'），<a rel="noopener noreferrer" href="#!/header/white?links=true&ceiling=true&login=false&rightView=';
    $line = 44;
    $art = '=rightView';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test4"></div></div></div></div><div mxa="_zs_gallerycN:o" class="clearfix"><div mxa="_zs_gallerycN:t" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_gallerycN:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 61;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerycN:u" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 63;
    $art = '!text1';
    ;
