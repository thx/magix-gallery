...
module.exports = Magix.View.extend({
...
} ; var $g = '', $_temp, $p = '', navs = $$.navs, cur = $$.cur, login = $$.login, user = $$.user, rightView = $$.rightView, rightCeilingShow = $$.rightCeilingShow, bizCode = $$.bizCode, logoutUrl = $$.logoutUrl, links = $$.links, ceiling = $$.ceiling, map = $$.map; var $expr, $art, $line; try {
    ...
    ;
    $p += ($expr = '<%!$eu(rightCeilingShow)%>', $eu(rightCeilingShow)) + '&bizCode=';
    $line = 9;
    $art = '=bizCode';
    ;
    $p += ($expr = '<%!$eu(bizCode)%>', $eu(bizCode)) + '&logoutUrl=';
    $line = 10;
    $art = '=logoutUrl';
    ;
    ...
    $art = '=ceiling';
    ;
    $p += ($expr = '<%!$eu(ceiling)%>', $eu(ceiling)) + '"></div><div mxa="_zs_galleryc!:_" class="_zs_gallery_mx-header_examples_index_-content"><div mxa="_zs_galleryc!:a" class="_zs_gallery_mx-header_examples_index_-inner"><div mxa="_zs_galleryc!:b" class="fontsize-20 mb40">当前导航：';
    $line = 16;
    $art = '=map[cur]';
    ;
