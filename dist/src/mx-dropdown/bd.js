...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><span mxa="_zs_gallerya9:_" class="mx-trigger-label}">';
    $line = 3;
    $art = '=selectedText';
    ;
    $p += ($expr = '<%=selectedText%>', $e(selectedText)) + '</span><span mxs="_zs_gallerya9:_" class="mc-iconfont mx-trigger-arrow">&#xe692;</span></div>';
}
catch (ex) {
