...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cpuakzrvgkp$art_c = parents.length; parentIndex < $art_cpuakzrvgkp$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cpuakzrvgkp$art_c = parents.length; parentIndex < $art_cpuakzrvgkp$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objsmasxxr$art_obj = parent.list, $art_cupifophgb$art_c = $art_objsmasxxr$art_obj.length; itemIndex < $art_cupifophgb$art_c; itemIndex++) {                var item = $art_objsmasxxr$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objsmasxxr$art_obj = parent.list, $art_cupifophgb$art_c = $art_objsmasxxr$art_obj.length; itemIndex < $art_cupifophgb$art_c; itemIndex++) {
                    var item = $art_objsmasxxr$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
