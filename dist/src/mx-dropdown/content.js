...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_clzmmemtb$art_c = parents.length; parentIndex < $art_clzmmemtb$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_clzmmemtb$art_c = parents.length; parentIndex < $art_clzmmemtb$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objexmzoqls$art_obj = parent.list, $art_cixlzpot$art_c = $art_objexmzoqls$art_obj.length; itemIndex < $art_cixlzpot$art_c; itemIndex++) {                var item = $art_objexmzoqls$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objexmzoqls$art_obj = parent.list, $art_cixlzpot$art_c = $art_objexmzoqls$art_obj.length; itemIndex < $art_cixlzpot$art_c; itemIndex++) {
                    var item = $art_objexmzoqls$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
