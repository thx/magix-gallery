...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_coznvzllucg$art_c = parents.length; parentIndex < $art_coznvzllucg$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_coznvzllucg$art_c = parents.length; parentIndex < $art_coznvzllucg$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objrgtgfrmyg$art_obj = parent.list, $art_cwgcrnwc$art_c = $art_objrgtgfrmyg$art_obj.length; itemIndex < $art_cwgcrnwc$art_c; itemIndex++) {                var item = $art_objrgtgfrmyg$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objrgtgfrmyg$art_obj = parent.list, $art_cwgcrnwc$art_c = $art_objrgtgfrmyg$art_obj.length; itemIndex < $art_cwgcrnwc$art_c; itemIndex++) {
                    var item = $art_objrgtgfrmyg$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
