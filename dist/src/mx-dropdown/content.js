...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_ccvmcoe$art_c = parents.length; parentIndex < $art_ccvmcoe$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_ccvmcoe$art_c = parents.length; parentIndex < $art_ccvmcoe$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objywxzaer$art_obj = parent.list, $art_cjvhlnyv$art_c = $art_objywxzaer$art_obj.length; itemIndex < $art_cjvhlnyv$art_c; itemIndex++) {                var item = $art_objywxzaer$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objywxzaer$art_obj = parent.list, $art_cjvhlnyv$art_c = $art_objywxzaer$art_obj.length; itemIndex < $art_cjvhlnyv$art_c; itemIndex++) {
                    var item = $art_objywxzaer$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
