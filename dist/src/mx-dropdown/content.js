...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cnxaiqueh$art_c = parents.length; parentIndex < $art_cnxaiqueh$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cnxaiqueh$art_c = parents.length; parentIndex < $art_cnxaiqueh$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objayqvtexd$art_obj = parent.list, $art_cqfqksxn$art_c = $art_objayqvtexd$art_obj.length; itemIndex < $art_cqfqksxn$art_c; itemIndex++) {                var item = $art_objayqvtexd$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objayqvtexd$art_obj = parent.list, $art_cqfqksxn$art_c = $art_objayqvtexd$art_obj.length; itemIndex < $art_cqfqksxn$art_c; itemIndex++) {
                    var item = $art_objayqvtexd$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
