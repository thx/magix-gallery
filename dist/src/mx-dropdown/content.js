...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cfixceb$art_c = parents.length; parentIndex < $art_cfixceb$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cfixceb$art_c = parents.length; parentIndex < $art_cfixceb$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objpjwldcnj$art_obj = parent.list, $art_cqbsod$art_c = $art_objpjwldcnj$art_obj.length; itemIndex < $art_cqbsod$art_c; itemIndex++) {                var item = $art_objpjwldcnj$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objpjwldcnj$art_obj = parent.list, $art_cqbsod$art_c = $art_objpjwldcnj$art_obj.length; itemIndex < $art_cqbsod$art_c; itemIndex++) {
                    var item = $art_objpjwldcnj$art_obj[itemIndex];
                    $p += ' ';
                    $line = 31;
                    $art = 'if !item.hide';
                    ;
