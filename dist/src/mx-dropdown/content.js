...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cvaupwoah$art_c = parents.length; parentIndex < $art_cvaupwoah$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cvaupwoah$art_c = parents.length; parentIndex < $art_cvaupwoah$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objvgorvlm$art_obj = parent.list, $art_cxwmiyrpdqo$art_c = $art_objvgorvlm$art_obj.length; itemIndex < $art_cxwmiyrpdqo$art_c; itemIndex++) {                var item = $art_objvgorvlm$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objvgorvlm$art_obj = parent.list, $art_cxwmiyrpdqo$art_c = $art_objvgorvlm$art_obj.length; itemIndex < $art_cxwmiyrpdqo$art_c; itemIndex++) {
                    var item = $art_objvgorvlm$art_obj[itemIndex];
                    $p += ' ';
                    $line = 31;
                    $art = 'if !item.hide';
                    ;
