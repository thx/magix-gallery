...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cozbweivk$art_c = parents.length; parentIndex < $art_cozbweivk$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cozbweivk$art_c = parents.length; parentIndex < $art_cozbweivk$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objokrfkmyvp$art_obj = parent.list, $art_chimuutty$art_c = $art_objokrfkmyvp$art_obj.length; itemIndex < $art_chimuutty$art_c; itemIndex++) {                var item = $art_objokrfkmyvp$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objokrfkmyvp$art_obj = parent.list, $art_chimuutty$art_c = $art_objokrfkmyvp$art_obj.length; itemIndex < $art_chimuutty$art_c; itemIndex++) {
                    var item = $art_objokrfkmyvp$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
