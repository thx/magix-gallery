...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cjqbredc$art_c = groups.length; groupIndex < $art_cjqbredc$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cjqbredc$art_c = groups.length; groupIndex < $art_cjqbredc$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_imbmhm$art_i = 0, $art_objoqrbaclvgjc$art_obj = group.list, $art_ciphevse$art_c = $art_objoqrbaclvgjc$art_obj.length; $art_imbmhm$art_i < $art_ciphevse$art_c; $art_imbmhm$art_i++) {                var item = $art_objoqrbaclvgjc$art_obj[$art_imbmhm$art_i]%>';
                for (var $art_imbmhm$art_i = 0, $art_objoqrbaclvgjc$art_obj = group.list, $art_ciphevse$art_c = $art_objoqrbaclvgjc$art_obj.length; $art_imbmhm$art_i < $art_ciphevse$art_c; $art_imbmhm$art_i++) {
                    var item = $art_objoqrbaclvgjc$art_obj[$art_imbmhm$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
