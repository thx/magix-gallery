...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cvlyvrihvtk$art_c = groups.length; groupIndex < $art_cvlyvrihvtk$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cvlyvrihvtk$art_c = groups.length; groupIndex < $art_cvlyvrihvtk$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iumwvtnjbt$art_i = 0, $art_objggmrjil$art_obj = group.list, $art_cjlmuywrye$art_c = $art_objggmrjil$art_obj.length; $art_iumwvtnjbt$art_i < $art_cjlmuywrye$art_c; $art_iumwvtnjbt$art_i++) {                var item = $art_objggmrjil$art_obj[$art_iumwvtnjbt$art_i]%>';
                for (var $art_iumwvtnjbt$art_i = 0, $art_objggmrjil$art_obj = group.list, $art_cjlmuywrye$art_c = $art_objggmrjil$art_obj.length; $art_iumwvtnjbt$art_i < $art_cjlmuywrye$art_c; $art_iumwvtnjbt$art_i++) {
                    var item = $art_objggmrjil$art_obj[$art_iumwvtnjbt$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
