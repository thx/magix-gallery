...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cybrbiipm$art_c = groups.length; groupIndex < $art_cybrbiipm$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cybrbiipm$art_c = groups.length; groupIndex < $art_cybrbiipm$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_izfvhehnza$art_i = 0, $art_objojqhuto$art_obj = group.list, $art_cshfxkorg$art_c = $art_objojqhuto$art_obj.length; $art_izfvhehnza$art_i < $art_cshfxkorg$art_c; $art_izfvhehnza$art_i++) {                var item = $art_objojqhuto$art_obj[$art_izfvhehnza$art_i]%>';
                for (var $art_izfvhehnza$art_i = 0, $art_objojqhuto$art_obj = group.list, $art_cshfxkorg$art_c = $art_objojqhuto$art_obj.length; $art_izfvhehnza$art_i < $art_cshfxkorg$art_c; $art_izfvhehnza$art_i++) {
                    var item = $art_objojqhuto$art_obj[$art_izfvhehnza$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
