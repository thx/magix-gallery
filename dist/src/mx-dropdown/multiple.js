...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_conesuyzoa$art_c = groups.length; groupIndex < $art_conesuyzoa$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_conesuyzoa$art_c = groups.length; groupIndex < $art_conesuyzoa$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iwvopcmuf$art_i = 0, $art_objjiowhzu$art_obj = group.list, $art_csnemfawuz$art_c = $art_objjiowhzu$art_obj.length; $art_iwvopcmuf$art_i < $art_csnemfawuz$art_c; $art_iwvopcmuf$art_i++) {                var item = $art_objjiowhzu$art_obj[$art_iwvopcmuf$art_i]%>';
                for (var $art_iwvopcmuf$art_i = 0, $art_objjiowhzu$art_obj = group.list, $art_csnemfawuz$art_c = $art_objjiowhzu$art_obj.length; $art_iwvopcmuf$art_i < $art_csnemfawuz$art_c; $art_iwvopcmuf$art_i++) {
                    var item = $art_objjiowhzu$art_obj[$art_iwvopcmuf$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
