...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_csowpjklvkck$art_c = groups.length; groupIndex < $art_csowpjklvkck$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_csowpjklvkck$art_c = groups.length; groupIndex < $art_csowpjklvkck$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ianjcdrmno$art_i = 0, $art_objdqsjflfh$art_obj = group.list, $art_camejccjkx$art_c = $art_objdqsjflfh$art_obj.length; $art_ianjcdrmno$art_i < $art_camejccjkx$art_c; $art_ianjcdrmno$art_i++) {                var item = $art_objdqsjflfh$art_obj[$art_ianjcdrmno$art_i]%>';
                for (var $art_ianjcdrmno$art_i = 0, $art_objdqsjflfh$art_obj = group.list, $art_camejccjkx$art_c = $art_objdqsjflfh$art_obj.length; $art_ianjcdrmno$art_i < $art_camejccjkx$art_c; $art_ianjcdrmno$art_i++) {
                    var item = $art_objdqsjflfh$art_obj[$art_ianjcdrmno$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
