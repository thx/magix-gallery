...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cdlvwdgj$art_c = groups.length; groupIndex < $art_cdlvwdgj$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cdlvwdgj$art_c = groups.length; groupIndex < $art_cdlvwdgj$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_icynzeyn$art_i = 0, $art_objncmawsxx$art_obj = group.list, $art_cmgbaijfogn$art_c = $art_objncmawsxx$art_obj.length; $art_icynzeyn$art_i < $art_cmgbaijfogn$art_c; $art_icynzeyn$art_i++) {                var item = $art_objncmawsxx$art_obj[$art_icynzeyn$art_i]%>';
                for (var $art_icynzeyn$art_i = 0, $art_objncmawsxx$art_obj = group.list, $art_cmgbaijfogn$art_c = $art_objncmawsxx$art_obj.length; $art_icynzeyn$art_i < $art_cmgbaijfogn$art_c; $art_icynzeyn$art_i++) {
                    var item = $art_objncmawsxx$art_obj[$art_icynzeyn$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
