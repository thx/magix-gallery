...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_coghiin$art_c = groups.length; groupIndex < $art_coghiin$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_coghiin$art_c = groups.length; groupIndex < $art_coghiin$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iqjmse$art_i = 0, $art_objloyhmfyh$art_obj = group.list, $art_ckekmiilq$art_c = $art_objloyhmfyh$art_obj.length; $art_iqjmse$art_i < $art_ckekmiilq$art_c; $art_iqjmse$art_i++) {                var item = $art_objloyhmfyh$art_obj[$art_iqjmse$art_i]%>';
                for (var $art_iqjmse$art_i = 0, $art_objloyhmfyh$art_obj = group.list, $art_ckekmiilq$art_c = $art_objloyhmfyh$art_obj.length; $art_iqjmse$art_i < $art_ckekmiilq$art_c; $art_iqjmse$art_i++) {
                    var item = $art_objloyhmfyh$art_obj[$art_iqjmse$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
