...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_crtpwdoao$art_c = groups.length; groupIndex < $art_crtpwdoao$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_crtpwdoao$art_c = groups.length; groupIndex < $art_crtpwdoao$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iadfhbb$art_i = 0, $art_objgkhtsbxmzpt$art_obj = group.list, $art_cnubjc$art_c = $art_objgkhtsbxmzpt$art_obj.length; $art_iadfhbb$art_i < $art_cnubjc$art_c; $art_iadfhbb$art_i++) {                var item = $art_objgkhtsbxmzpt$art_obj[$art_iadfhbb$art_i]%>';
                for (var $art_iadfhbb$art_i = 0, $art_objgkhtsbxmzpt$art_obj = group.list, $art_cnubjc$art_c = $art_objgkhtsbxmzpt$art_obj.length; $art_iadfhbb$art_i < $art_cnubjc$art_c; $art_iadfhbb$art_i++) {
                    var item = $art_objgkhtsbxmzpt$art_obj[$art_iadfhbb$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
