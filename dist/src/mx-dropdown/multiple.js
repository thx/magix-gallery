...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cxvxcsx$art_c = groups.length; groupIndex < $art_cxvxcsx$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cxvxcsx$art_c = groups.length; groupIndex < $art_cxvxcsx$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iosujpfq$art_i = 0, $art_objwqyqyzl$art_obj = group.list, $art_cnfapbozcxc$art_c = $art_objwqyqyzl$art_obj.length; $art_iosujpfq$art_i < $art_cnfapbozcxc$art_c; $art_iosujpfq$art_i++) {                var item = $art_objwqyqyzl$art_obj[$art_iosujpfq$art_i]%>';
                for (var $art_iosujpfq$art_i = 0, $art_objwqyqyzl$art_obj = group.list, $art_cnfapbozcxc$art_c = $art_objwqyqyzl$art_obj.length; $art_iosujpfq$art_i < $art_cnfapbozcxc$art_c; $art_iosujpfq$art_i++) {
                    var item = $art_objwqyqyzl$art_obj[$art_iosujpfq$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
