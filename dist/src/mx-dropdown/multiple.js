...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_ciwxnckugmf$art_c = groups.length; groupIndex < $art_ciwxnckugmf$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_ciwxnckugmf$art_c = groups.length; groupIndex < $art_ciwxnckugmf$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_imlwzbyzs$art_i = 0, $art_objyjkqwqxeebj$art_obj = group.list, $art_cjbkyvtq$art_c = $art_objyjkqwqxeebj$art_obj.length; $art_imlwzbyzs$art_i < $art_cjbkyvtq$art_c; $art_imlwzbyzs$art_i++) {                var item = $art_objyjkqwqxeebj$art_obj[$art_imlwzbyzs$art_i]%>';
                for (var $art_imlwzbyzs$art_i = 0, $art_objyjkqwqxeebj$art_obj = group.list, $art_cjbkyvtq$art_c = $art_objyjkqwqxeebj$art_obj.length; $art_imlwzbyzs$art_i < $art_cjbkyvtq$art_c; $art_imlwzbyzs$art_i++) {
                    var item = $art_objyjkqwqxeebj$art_obj[$art_imlwzbyzs$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
