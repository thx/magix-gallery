...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cattgwjvnm$art_c = groups.length; groupIndex < $art_cattgwjvnm$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cattgwjvnm$art_c = groups.length; groupIndex < $art_cattgwjvnm$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_imcckijp$art_i = 0, $art_objbyjusnbb$art_obj = group.list, $art_cigpirqn$art_c = $art_objbyjusnbb$art_obj.length; $art_imcckijp$art_i < $art_cigpirqn$art_c; $art_imcckijp$art_i++) {                var item = $art_objbyjusnbb$art_obj[$art_imcckijp$art_i]%>';
                for (var $art_imcckijp$art_i = 0, $art_objbyjusnbb$art_obj = group.list, $art_cigpirqn$art_c = $art_objbyjusnbb$art_obj.length; $art_imcckijp$art_i < $art_cigpirqn$art_c; $art_imcckijp$art_i++) {
                    var item = $art_objbyjusnbb$art_obj[$art_imcckijp$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
