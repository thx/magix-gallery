...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cosbyxehk$art_c = groups.length; groupIndex < $art_cosbyxehk$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cosbyxehk$art_c = groups.length; groupIndex < $art_cosbyxehk$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ihfbbkw$art_i = 0, $art_objixudvdd$art_obj = group.list, $art_canqpcpcx$art_c = $art_objixudvdd$art_obj.length; $art_ihfbbkw$art_i < $art_canqpcpcx$art_c; $art_ihfbbkw$art_i++) {                var item = $art_objixudvdd$art_obj[$art_ihfbbkw$art_i]%>';
                for (var $art_ihfbbkw$art_i = 0, $art_objixudvdd$art_obj = group.list, $art_canqpcpcx$art_c = $art_objixudvdd$art_obj.length; $art_ihfbbkw$art_i < $art_canqpcpcx$art_c; $art_ihfbbkw$art_i++) {
                    var item = $art_objixudvdd$art_obj[$art_ihfbbkw$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
