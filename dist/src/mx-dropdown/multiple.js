...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cckgzem$art_c = groups.length; groupIndex < $art_cckgzem$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cckgzem$art_c = groups.length; groupIndex < $art_cckgzem$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilpjnghnkm$art_i = 0, $art_objwxfkauwp$art_obj = group.list, $art_cfcqycfm$art_c = $art_objwxfkauwp$art_obj.length; $art_ilpjnghnkm$art_i < $art_cfcqycfm$art_c; $art_ilpjnghnkm$art_i++) {                var item = $art_objwxfkauwp$art_obj[$art_ilpjnghnkm$art_i]%>';
                for (var $art_ilpjnghnkm$art_i = 0, $art_objwxfkauwp$art_obj = group.list, $art_cfcqycfm$art_c = $art_objwxfkauwp$art_obj.length; $art_ilpjnghnkm$art_i < $art_cfcqycfm$art_c; $art_ilpjnghnkm$art_i++) {
                    var item = $art_objwxfkauwp$art_obj[$art_ilpjnghnkm$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
