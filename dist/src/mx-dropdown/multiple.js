...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cfpzoulsep$art_c = groups.length; groupIndex < $art_cfpzoulsep$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cfpzoulsep$art_c = groups.length; groupIndex < $art_cfpzoulsep$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iablnoyobfg$art_i = 0, $art_objycnlzyym$art_obj = group.list, $art_corypqmnj$art_c = $art_objycnlzyym$art_obj.length; $art_iablnoyobfg$art_i < $art_corypqmnj$art_c; $art_iablnoyobfg$art_i++) {                var item = $art_objycnlzyym$art_obj[$art_iablnoyobfg$art_i]%>';
                for (var $art_iablnoyobfg$art_i = 0, $art_objycnlzyym$art_obj = group.list, $art_corypqmnj$art_c = $art_objycnlzyym$art_obj.length; $art_iablnoyobfg$art_i < $art_corypqmnj$art_c; $art_iablnoyobfg$art_i++) {
                    var item = $art_objycnlzyym$art_obj[$art_iablnoyobfg$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
