...
module.exports = Base.extend({
    ...
    $art = '@[{\n                value:1,\n                text:\'test\',\n                disabled: true,\n                pValue: 1\n            },{\n                value:2,\n                text:\'TestABC\',\n                pValue: 1\n            },{\n                value:3,\n                text:\'Another\',\n                disabled: true,\n                pValue: 2\n            },{\n                value:4,\n                text:\'选项1\',\n                pValue: 1\n            },{\n                value:5,\n                text:\'选项2\',\n                pValue: 2\n            }]';
    ;
    $p += ($expr = '<%@[{            value: 1,            text: \'test\',            disabled: true,            pValue: 1        }, {            value: 2,            text: \'TestABC\',            pValue: 1        }, {            value: 3,            text: \'Another\',            disabled: true,            pValue: 2        }, {            value: 4,            text: \'选项1\',            pValue: 1        }, {            value: 5,            text: \'选项2\',            pValue: 2        }]%>', $i($$ref, [{ value: 1, text: 'test', disabled: true, pValue: 1 }, { value: 2, text: 'TestABC', pValue: 1 }, { value: 3, text: 'Another', disabled: true, pValue: 2 }, { value: 4, text: '选项1', pValue: 1 }, { value: 5, text: '选项2', pValue: 2 }])) + '"></div></div><div mxa="_zs_galleryba:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryba:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 44;
    $art = '=viewId';
    ;
