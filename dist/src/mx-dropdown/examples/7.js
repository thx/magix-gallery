...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_iwvxdfadc$art_i = 0, $art_ckgvdialo$art_c = first.length; $art_iwvxdfadc$art_i < $art_ckgvdialo$art_c; $art_iwvxdfadc$art_i++) {    var i = first[$art_iwvxdfadc$art_i]%>';
    for (var $art_iwvxdfadc$art_i = 0, $art_ckgvdialo$art_c = first.length; $art_iwvxdfadc$art_i < $art_ckgvdialo$art_c; $art_iwvxdfadc$art_i++) {
        var i = first[$art_iwvxdfadc$art_i];
        $p += '<i value="';
        $line = 21;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_ikrgtijvu$art_i = 0, $art_cycbdhyh$art_c = second.length; $art_ikrgtijvu$art_i < $art_cycbdhyh$art_c; $art_ikrgtijvu$art_i++) {    var i = second[$art_ikrgtijvu$art_i]%>';
    for (var $art_ikrgtijvu$art_i = 0, $art_cycbdhyh$art_c = second.length; $art_ikrgtijvu$art_i < $art_cycbdhyh$art_c; $art_ikrgtijvu$art_i++) {
        var i = second[$art_ikrgtijvu$art_i];
        $p += '<i value="';
        $line = 25;
        $art = '=i';
        ;
