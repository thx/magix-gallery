/*
    ...
    loader: cmd_es
 */
define("mx-dropdown/examples/23",["magix","examples/example","$","../bd","mx-copy/index","examples/hl"],(require,exports,module)=>{
/*Magix,Base,$*/
require("../bd");
...
module.exports = Base.extend({
    ...
    msg += $expr + '\r\n\tat file:mx-dropdown/examples/23.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
