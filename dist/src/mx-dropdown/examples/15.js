/*
    ...
    loader: cmd_es
 */
define("mx-dropdown/examples/15",["magix","examples/example","$","../index","mx-copy/index","examples/hl"],(require,exports,module)=>{
/*Magix,Base,$*/
require("../index");
...
module.exports = Base.extend({
    ...
    msg += $expr + '\r\n\tat file:mx-dropdown/examples/15.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
