...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cyypaaztbk$art_c = list.length; index < $art_cyypaaztbk$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cyypaaztbk$art_c = list.length; index < $art_cyypaaztbk$art_c; index++) {
        var item = list[index];
        $p += '<tr><td>';
        $line = 47;
        $art = '=item.fixed1';
    ...
    ;
    $expr = '<%for (var $art_ikndrjys$art_i = 0, $art_conhcgrb$art_c = groups.length; $art_ikndrjys$art_i < $art_conhcgrb$art_c; $art_ikndrjys$art_i++) {    var group = groups[$art_ikndrjys$art_i]%>';
    for (var $art_ikndrjys$art_i = 0, $art_conhcgrb$art_c = groups.length; $art_ikndrjys$art_i < $art_conhcgrb$art_c; $art_ikndrjys$art_i++) {
        var group = groups[$art_ikndrjys$art_i];
    ...
    $art = 'each groups as group';
    ;
    $expr = '<%for (var $art_ibcyrgfw$art_i = 0, $art_cvzfaocj$art_c = groups.length; $art_ibcyrgfw$art_i < $art_cvzfaocj$art_c; $art_ibcyrgfw$art_i++) {    var group = groups[$art_ibcyrgfw$art_i]%>';
    for (var $art_ibcyrgfw$art_i = 0, $art_cvzfaocj$art_c = groups.length; $art_ibcyrgfw$art_i < $art_cvzfaocj$art_c; $art_ibcyrgfw$art_i++) {
        var group = groups[$art_ibcyrgfw$art_i];
        $p += ' ';
        $line = 66;
        $art = 'each group.fields as field';
        ;
        $expr = '<%for (var $art_iqxrjnmi$art_i = 0, $art_objnnffshcvtg$art_obj = group.fields, $art_chqnlmss$art_c = $art_objnnffshcvtg$art_obj.length; $art_iqxrjnmi$art_i < $art_chqnlmss$art_c; $art_iqxrjnmi$art_i++) {        var field = $art_objnnffshcvtg$art_obj[$art_iqxrjnmi$art_i]%>';
        for (var $art_iqxrjnmi$art_i = 0, $art_objnnffshcvtg$art_obj = group.fields, $art_chqnlmss$art_c = $art_objnnffshcvtg$art_obj.length; $art_iqxrjnmi$art_i < $art_chqnlmss$art_c; $art_iqxrjnmi$art_i++) {
            var field = $art_objnnffshcvtg$art_obj[$art_iqxrjnmi$art_i];
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cvbsqm$art_c = list.length; index < $art_cvbsqm$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cvbsqm$art_c = list.length; index < $art_cvbsqm$art_c; index++) {
        var item = list[index];
        $p += '<tr>';
        $line = 82;
        $art = 'each groups as group';
        ;
        $expr = '<%for (var $art_ixjnuthnx$art_i = 0, $art_curbdoaqp$art_c = groups.length; $art_ixjnuthnx$art_i < $art_curbdoaqp$art_c; $art_ixjnuthnx$art_i++) {        var group = groups[$art_ixjnuthnx$art_i]%>';
        for (var $art_ixjnuthnx$art_i = 0, $art_curbdoaqp$art_c = groups.length; $art_ixjnuthnx$art_i < $art_curbdoaqp$art_c; $art_ixjnuthnx$art_i++) {
            var group = groups[$art_ixjnuthnx$art_i];
            $p += ' ';
            $line = 83;
            $art = 'each group.fields as field';
            ;
            $expr = '<%for (var $art_ixslpjxiyg$art_i = 0, $art_objohcfymxskb$art_obj = group.fields, $art_cjabqsjhivc$art_c = $art_objohcfymxskb$art_obj.length; $art_ixslpjxiyg$art_i < $art_cjabqsjhivc$art_c; $art_ixslpjxiyg$art_i++) {            var field = $art_objohcfymxskb$art_obj[$art_ixslpjxiyg$art_i]%>';
            for (var $art_ixslpjxiyg$art_i = 0, $art_objohcfymxskb$art_obj = group.fields, $art_cjabqsjhivc$art_c = $art_objohcfymxskb$art_obj.length; $art_ixslpjxiyg$art_i < $art_cjabqsjhivc$art_c; $art_ixslpjxiyg$art_i++) {
                var field = $art_objohcfymxskb$art_obj[$art_ixslpjxiyg$art_i];
                $p += '<td>';
                $line = 84;
