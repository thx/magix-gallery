...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryeD:_" class="mb20"><div mxs="_zs_galleryeD:_" class="mb10">1. 原始表格：当前4*4的表格，x坐标的取值范围【0-3】，y的取值范围【0-3】</div><div mxa="_zs_galleryeD:a" class="pl15"><table class="table _zs_gallery_mx-table___test___cal_-custom" id="';
    $line = 5;
    $art = '=viewId';
    ;
    ...
    ;
    $expr = '<%for (var $art_ifkstsek$art_i = 0, $art_cztrgvdnubx$art_c = rows.length; $art_ifkstsek$art_i < $art_cztrgvdnubx$art_c; $art_ifkstsek$art_i++) {    var row = rows[$art_ifkstsek$art_i]%>';
    for (var $art_ifkstsek$art_i = 0, $art_cztrgvdnubx$art_c = rows.length; $art_ifkstsek$art_i < $art_cztrgvdnubx$art_c; $art_ifkstsek$art_i++) {
        var row = rows[$art_ifkstsek$art_i];
        $p += ' ';
        $line = 152;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_icyhjvacde$art_i = 0, $art_chpwjvysin$art_c = row.length; $art_icyhjvacde$art_i < $art_chpwjvysin$art_c; $art_icyhjvacde$art_i++) {        var cell = row[$art_icyhjvacde$art_i]%>';
        for (var $art_icyhjvacde$art_i = 0, $art_chpwjvysin$art_c = row.length; $art_icyhjvacde$art_i < $art_chpwjvysin$art_c; $art_icyhjvacde$art_i++) {
            var cell = row[$art_icyhjvacde$art_i];
            $p += '<div mxa="_zs_galleryeD:d" class="clearfix"><div mxa="_zs_galleryeD:e" class="fl _zs_gallery_mx-table___test___cal_-prefix">';
            $line = 154;
            $art = '=cell.content';
            ;
