...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerye#:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxa="_zs_gallerye#:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_gallerye#:_" class="mb20 clearfix lh22"><span class="color-9">以下示例：</span><span>表头吸顶，默认相对于window吸顶</span></div><div mxa="_zs_gallerye#:b" mx-view="mx-table/index?sticky=true" class="mb20"><div><table mxa="_zs_gallerye#:c" class="table"><thead><tr>';
    $line = 11;
    ...
    ;
    $p += '<th mxs="_zs_gallerye#:a">操作</th></tr></thead><tbody>';
    $line = 18;
    ...
    for (var j = 0; j < 3; j++) {
        ...
        ;
        $p += '<td mxs="_zs_gallerye#:b"><div class="operations"><a href="javascript:;" class="btn btn-white btn-small">操作</a></div></td></tr>';
        $line = 29;
        $art = '/for';
        ;
        $expr = '<%}%>';
