...
module.exports = Base.extend({
    ...
    for (var i = 0; i < 25; i++) {
        ;
        $p += '<th mxa="_zs_galleryeR:e" width="200">示例字段';
        $line = 17;
        $art = '=i';
        ;
        $p += ($expr = '<%=i%>', $e(i)) + '</th>';
