...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cffqxud$art_c = list.length; index < $art_cffqxud$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cffqxud$art_c = list.length; index < $art_cffqxud$art_c; index++) {
        var item = list[index];
        $p += '<tr><td>';
        $line = 47;
        $art = '=item.fixed1';
    ...
    ;
    $expr = '<%for (var $art_ilicjqyxi$art_i = 0, $art_ckxjxdmzv$art_c = groups.length; $art_ilicjqyxi$art_i < $art_ckxjxdmzv$art_c; $art_ilicjqyxi$art_i++) {    var group = groups[$art_ilicjqyxi$art_i]%>';
    for (var $art_ilicjqyxi$art_i = 0, $art_ckxjxdmzv$art_c = groups.length; $art_ilicjqyxi$art_i < $art_ckxjxdmzv$art_c; $art_ilicjqyxi$art_i++) {
        var group = groups[$art_ilicjqyxi$art_i];
    ...
    $art = 'each groups as group';
    ;
    $expr = '<%for (var $art_ijoubqiq$art_i = 0, $art_cqolskuh$art_c = groups.length; $art_ijoubqiq$art_i < $art_cqolskuh$art_c; $art_ijoubqiq$art_i++) {    var group = groups[$art_ijoubqiq$art_i]%>';
    for (var $art_ijoubqiq$art_i = 0, $art_cqolskuh$art_c = groups.length; $art_ijoubqiq$art_i < $art_cqolskuh$art_c; $art_ijoubqiq$art_i++) {
        var group = groups[$art_ijoubqiq$art_i];
        $p += ' ';
        $line = 66;
        $art = 'each group.fields as field';
        ;
        $expr = '<%for (var $art_iaptfava$art_i = 0, $art_objrapilzjxa$art_obj = group.fields, $art_cbkebrgu$art_c = $art_objrapilzjxa$art_obj.length; $art_iaptfava$art_i < $art_cbkebrgu$art_c; $art_iaptfava$art_i++) {        var field = $art_objrapilzjxa$art_obj[$art_iaptfava$art_i]%>';
        for (var $art_iaptfava$art_i = 0, $art_objrapilzjxa$art_obj = group.fields, $art_cbkebrgu$art_c = $art_objrapilzjxa$art_obj.length; $art_iaptfava$art_i < $art_cbkebrgu$art_c; $art_iaptfava$art_i++) {
            var field = $art_objrapilzjxa$art_obj[$art_iaptfava$art_i];
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cpnktvkfve$art_c = list.length; index < $art_cpnktvkfve$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cpnktvkfve$art_c = list.length; index < $art_cpnktvkfve$art_c; index++) {
        var item = list[index];
        $p += '<tr>';
        $line = 82;
        $art = 'each groups as group';
        ;
        $expr = '<%for (var $art_ienibrks$art_i = 0, $art_cxinxdgb$art_c = groups.length; $art_ienibrks$art_i < $art_cxinxdgb$art_c; $art_ienibrks$art_i++) {        var group = groups[$art_ienibrks$art_i]%>';
        for (var $art_ienibrks$art_i = 0, $art_cxinxdgb$art_c = groups.length; $art_ienibrks$art_i < $art_cxinxdgb$art_c; $art_ienibrks$art_i++) {
            var group = groups[$art_ienibrks$art_i];
            $p += ' ';
            $line = 83;
            $art = 'each group.fields as field';
            ;
            $expr = '<%for (var $art_ihiqlay$art_i = 0, $art_objncmvdausk$art_obj = group.fields, $art_csqmlsvb$art_c = $art_objncmvdausk$art_obj.length; $art_ihiqlay$art_i < $art_csqmlsvb$art_c; $art_ihiqlay$art_i++) {            var field = $art_objncmvdausk$art_obj[$art_ihiqlay$art_i]%>';
            for (var $art_ihiqlay$art_i = 0, $art_objncmvdausk$art_obj = group.fields, $art_csqmlsvb$art_c = $art_objncmvdausk$art_obj.length; $art_ihiqlay$art_i < $art_csqmlsvb$art_c; $art_ihiqlay$art_i++) {
                var field = $art_objncmvdausk$art_obj[$art_ihiqlay$art_i];
                $p += '<td>';
                $line = 84;
