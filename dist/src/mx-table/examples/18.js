...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cqcbaoxvn$art_c = list.length; index < $art_cqcbaoxvn$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cqcbaoxvn$art_c = list.length; index < $art_cqcbaoxvn$art_c; index++) {
        var item = list[index];
        $p += '<tr><td>';
        $line = 47;
        $art = '=item.fixed1';
    ...
    ;
    $expr = '<%for (var $art_inggxkem$art_i = 0, $art_clwatkxf$art_c = groups.length; $art_inggxkem$art_i < $art_clwatkxf$art_c; $art_inggxkem$art_i++) {    var group = groups[$art_inggxkem$art_i]%>';
    for (var $art_inggxkem$art_i = 0, $art_clwatkxf$art_c = groups.length; $art_inggxkem$art_i < $art_clwatkxf$art_c; $art_inggxkem$art_i++) {
        var group = groups[$art_inggxkem$art_i];
    ...
    $art = 'each groups as group';
    ;
    $expr = '<%for (var $art_iptwyyioni$art_i = 0, $art_cqpplqf$art_c = groups.length; $art_iptwyyioni$art_i < $art_cqpplqf$art_c; $art_iptwyyioni$art_i++) {    var group = groups[$art_iptwyyioni$art_i]%>';
    for (var $art_iptwyyioni$art_i = 0, $art_cqpplqf$art_c = groups.length; $art_iptwyyioni$art_i < $art_cqpplqf$art_c; $art_iptwyyioni$art_i++) {
        var group = groups[$art_iptwyyioni$art_i];
        $p += ' ';
        $line = 66;
        $art = 'each group.fields as field';
        ;
        $expr = '<%for (var $art_iktozw$art_i = 0, $art_objylmnhksva$art_obj = group.fields, $art_cxhllhqw$art_c = $art_objylmnhksva$art_obj.length; $art_iktozw$art_i < $art_cxhllhqw$art_c; $art_iktozw$art_i++) {        var field = $art_objylmnhksva$art_obj[$art_iktozw$art_i]%>';
        for (var $art_iktozw$art_i = 0, $art_objylmnhksva$art_obj = group.fields, $art_cxhllhqw$art_c = $art_objylmnhksva$art_obj.length; $art_iktozw$art_i < $art_cxhllhqw$art_c; $art_iktozw$art_i++) {
            var field = $art_objylmnhksva$art_obj[$art_iktozw$art_i];
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cqetbcpd$art_c = list.length; index < $art_cqetbcpd$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cqetbcpd$art_c = list.length; index < $art_cqetbcpd$art_c; index++) {
        var item = list[index];
        $p += '<tr>';
        $line = 82;
        $art = 'each groups as group';
        ;
        $expr = '<%for (var $art_iywobcbi$art_i = 0, $art_citefar$art_c = groups.length; $art_iywobcbi$art_i < $art_citefar$art_c; $art_iywobcbi$art_i++) {        var group = groups[$art_iywobcbi$art_i]%>';
        for (var $art_iywobcbi$art_i = 0, $art_citefar$art_c = groups.length; $art_iywobcbi$art_i < $art_citefar$art_c; $art_iywobcbi$art_i++) {
            var group = groups[$art_iywobcbi$art_i];
            $p += ' ';
            $line = 83;
            $art = 'each group.fields as field';
            ;
            $expr = '<%for (var $art_ivxkhepadd$art_i = 0, $art_objkomirpir$art_obj = group.fields, $art_caabarqz$art_c = $art_objkomirpir$art_obj.length; $art_ivxkhepadd$art_i < $art_caabarqz$art_c; $art_ivxkhepadd$art_i++) {            var field = $art_objkomirpir$art_obj[$art_ivxkhepadd$art_i]%>';
            for (var $art_ivxkhepadd$art_i = 0, $art_objkomirpir$art_obj = group.fields, $art_caabarqz$art_c = $art_objkomirpir$art_obj.length; $art_ivxkhepadd$art_i < $art_caabarqz$art_c; $art_ivxkhepadd$art_i++) {
                var field = $art_objkomirpir$art_obj[$art_ivxkhepadd$art_i];
                $p += '<td>';
                $line = 84;
