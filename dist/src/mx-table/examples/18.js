...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivgpssmhswj$art_i = 0, $art_cqsktwhrcrj$art_c = groups.length; $art_ivgpssmhswj$art_i < $art_cqsktwhrcrj$art_c; $art_ivgpssmhswj$art_i++) {    var group = groups[$art_ivgpssmhswj$art_i]%>';
    for (var $art_ivgpssmhswj$art_i = 0, $art_cqsktwhrcrj$art_c = groups.length; $art_ivgpssmhswj$art_i < $art_cqsktwhrcrj$art_c; $art_ivgpssmhswj$art_i++) {
        var group = groups[$art_ivgpssmhswj$art_i];
    ...
    $art = 'each groups as group';
    ;
    $expr = '<%for (var $art_iluskjjk$art_i = 0, $art_crmcbutcwim$art_c = groups.length; $art_iluskjjk$art_i < $art_crmcbutcwim$art_c; $art_iluskjjk$art_i++) {    var group = groups[$art_iluskjjk$art_i]%>';
    for (var $art_iluskjjk$art_i = 0, $art_crmcbutcwim$art_c = groups.length; $art_iluskjjk$art_i < $art_crmcbutcwim$art_c; $art_iluskjjk$art_i++) {
        var group = groups[$art_iluskjjk$art_i];
        $p += ' ';
        $line = 66;
        $art = 'each group.fields as field';
        ;
        $expr = '<%for (var $art_iudmglpj$art_i = 0, $art_objnsiaxiv$art_obj = group.fields, $art_cnhkqhu$art_c = $art_objnsiaxiv$art_obj.length; $art_iudmglpj$art_i < $art_cnhkqhu$art_c; $art_iudmglpj$art_i++) {        var field = $art_objnsiaxiv$art_obj[$art_iudmglpj$art_i]%>';
        for (var $art_iudmglpj$art_i = 0, $art_objnsiaxiv$art_obj = group.fields, $art_cnhkqhu$art_c = $art_objnsiaxiv$art_obj.length; $art_iudmglpj$art_i < $art_cnhkqhu$art_c; $art_iudmglpj$art_i++) {
            var field = $art_objnsiaxiv$art_obj[$art_iudmglpj$art_i];
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cilrhobqpwq$art_c = list.length; index < $art_cilrhobqpwq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cilrhobqpwq$art_c = list.length; index < $art_cilrhobqpwq$art_c; index++) {
        var item = list[index];
        $p += '<tr>';
        $line = 82;
        $art = 'each groups as group';
        ;
        $expr = '<%for (var $art_icdfmohg$art_i = 0, $art_clgjuilhk$art_c = groups.length; $art_icdfmohg$art_i < $art_clgjuilhk$art_c; $art_icdfmohg$art_i++) {        var group = groups[$art_icdfmohg$art_i]%>';
        for (var $art_icdfmohg$art_i = 0, $art_clgjuilhk$art_c = groups.length; $art_icdfmohg$art_i < $art_clgjuilhk$art_c; $art_icdfmohg$art_i++) {
            var group = groups[$art_icdfmohg$art_i];
            $p += ' ';
            $line = 83;
            $art = 'each group.fields as field';
            ;
            $expr = '<%for (var $art_ioiqkfzbh$art_i = 0, $art_objoyhfcaiwp$art_obj = group.fields, $art_cabolafzs$art_c = $art_objoyhfcaiwp$art_obj.length; $art_ioiqkfzbh$art_i < $art_cabolafzs$art_c; $art_ioiqkfzbh$art_i++) {            var field = $art_objoyhfcaiwp$art_obj[$art_ioiqkfzbh$art_i]%>';
            for (var $art_ioiqkfzbh$art_i = 0, $art_objoyhfcaiwp$art_obj = group.fields, $art_cabolafzs$art_c = $art_objoyhfcaiwp$art_obj.length; $art_ioiqkfzbh$art_i < $art_cabolafzs$art_c; $art_ioiqkfzbh$art_i++) {
                var field = $art_objoyhfcaiwp$art_obj[$art_ioiqkfzbh$art_i];
                $p += '<td>';
                $line = 84;
    ...
    ;
    $p += '</tbody></table></div></div></div><div mxa="_zs_galleryet:g" class="clearfix"><div mxa="_zs_galleryet:h" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half-left"><div mxs="_zs_galleryet:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 152;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryet:i" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 154;
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryet:c" class="mc-iconfont _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 157;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-table sticky="true" class="mb40"&gt;\n    &lt;table class="table" left="true" width="400"&gt;\n        &lt;thead&gt;\n            &lt;tr&gt;\n                &lt;th&gt;固定1&lt;/th&gt;\n                &lt;th&gt;固定2&lt;/th&gt;\n                &lt;th&gt;固定3&lt;/th&gt;\n            &lt;/tr&gt;\n        &lt;/thead&gt;\n        &lt;tbody&gt;\n            &#123;&#123;each list as item index&#125;&#125;\n                &lt;tr&gt;\n                    &lt;td&gt;&#123;&#123;=item.fixed1&#125;&#125;&lt;/td&gt;\n                    &lt;td&gt;&#123;&#123;=item.fixed2&#125;&#125;&lt;/td&gt;\n                    &lt;td&gt;&#123;&#123;=item.fixed3&#125;&#125;&lt;/td&gt;\n                &lt;/tr&gt;\n            &#123;&#123;/each&#125;&#125;\n        &lt;/tbody&gt;\n    &lt;/table&gt;\n    &lt;table class="table" center="true" width="1200"&gt; \n        &lt;thead&gt;\n            &lt;tr&gt;\n                &#123;&#123;each groups as group&#125;&#125;\n                    &lt;th class="field-group" colspan="&#123;&#123;=group.fields.length&#125;&#125;"&gt;\n                        &lt;div class="group-name"&gt;&#123;&#123;=group.name&#125;&#125;&lt;/div&gt;\n                    &lt;/th&gt;\n                &#123;&#123;/each&#125;&#125;\n            &lt;/tr&gt;\n            &lt;tr&gt;\n                &#123;&#123;each groups as group&#125;&#125;\n                    &#123;&#123;each group.fields as field&#125;&#125;\n                    &lt;th class="field-item"&gt;\n                        指标&#123;&#123;=field&#125;&#125;\n                        &lt;span sort-trigger="&#123;&#123;=field&#125;&#125;"\n                            sort-field="&#123;&#123;=sortField&#125;&#125;"\n                            sort-orderby="&#123;&#123;=sortBy&#125;&#125;"\n                            order-field-key="&#123;&#123;=orderFieldKey&#125;&#125;"\n                            order-by-key="&#123;&#123;=orderByKey&#125;&#125;"&gt;&lt;/span&gt;\n                    &lt;/th&gt;\n                    &#123;&#123;/each&#125;&#125;\n                &#123;&#123;/each&#125;&#125;\n            &lt;/tr&gt;\n        &lt;/thead&gt;\n        &lt;tbody&gt;\n            &#123;&#123;each list as item index&#125;&#125;\n                &lt;tr&gt;\n                    &#123;&#123;each groups as group&#125;&#125;\n                        &#123;&#123;each group.fields as field&#125;&#125;\n                        &lt;td&gt;&#123;&#123;=format(item[field])&#125;&#125;&lt;/td&gt;\n                        &#123;&#123;/each&#125;&#125;\n                    &#123;&#123;/each&#125;&#125;\n                &lt;/tr&gt;\n            &#123;&#123;/each&#125;&#125;\n        &lt;/tbody&gt;\n    &lt;/table&gt;\n&lt;/mx-table&gt;\n            </pre></div><div mxa="_zs_galleryet:j" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_galleryet:d" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">JS Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 218;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryet:k" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 220;
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryet:c" class="mc-iconfont _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 223;
    $art = '=viewId';
    ;
