...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iecobqlbo$art_i = 0, $art_clfmpmngh$art_c = rows.length; $art_iecobqlbo$art_i < $art_clfmpmngh$art_c; $art_iecobqlbo$art_i++) {    var row = rows[$art_iecobqlbo$art_i]%>';
    for (var $art_iecobqlbo$art_i = 0, $art_clfmpmngh$art_c = rows.length; $art_iecobqlbo$art_i < $art_clfmpmngh$art_c; $art_iecobqlbo$art_i++) {
        var row = rows[$art_iecobqlbo$art_i];
        $p += ' ';
        $line = 152;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_iqnvqgblue$art_i = 0, $art_cxhflkbjd$art_c = row.length; $art_iqnvqgblue$art_i < $art_cxhflkbjd$art_c; $art_iqnvqgblue$art_i++) {        var cell = row[$art_iqnvqgblue$art_i]%>';
        for (var $art_iqnvqgblue$art_i = 0, $art_cxhflkbjd$art_c = row.length; $art_iqnvqgblue$art_i < $art_cxhflkbjd$art_c; $art_iqnvqgblue$art_i++) {
            var cell = row[$art_iqnvqgblue$art_i];
