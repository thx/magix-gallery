...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_gallerye*:_" class="clearfix mb20"><div mx-view="mx-table/examples/9"></div><div mx-view="mx-table/examples/10"></div></div><div id="';
    $line = 16;
    $art = '=viewId';
    ;
