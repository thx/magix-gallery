...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeY:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'注意事项\',\n        key: viewId + \'_note\'\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
