/*
    ...
    loader: cmd_es
 */
define("mx-table/examples/index10",["magix","$","examples/subs","mx-title/second","./8","./18","examples/api"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryeX:a" class="mb20 clearfix"><div mx-view="mx-table/examples/8" id="';
    $line = 25;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mx-view="mx-table/examples/18" id="';
    $line = 26;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-table/examples/index10.html';
    throw msg;
} return $p; },
    render: function () {
        var options = [{
