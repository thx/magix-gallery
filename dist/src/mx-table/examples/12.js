...
module.exports = Base.extend({
    ...
    for (var $art_iclqyv$art_i = 0, $art_ckxpskot$art_c = list.length; $art_iclqyv$art_i < $art_ckxpskot$art_c; $art_iclqyv$art_i++) {
        ...
        $art = '=item.test';
        ;
        $p += ($expr = '<%=item.test%>', $e(item.test)) + '</td></tr><tr mxa="_zs_galleryer:e" class="operation-tr"><td mxa="_zs_galleryer:f" colspan="5"><a href="javascript:;" class="btn btn-white btn-small mr10" mx-click="' + $viewId + 'change({id:';
        $line = 40;
        $art = '=item.id';
        ;
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objzsvmaaro$art_obj = item.subs, $art_cnryypa$art_c = $art_objzsvmaaro$art_obj.length; subIndex < $art_cnryypa$art_c; subIndex++) {        var sub = $art_objzsvmaaro$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objzsvmaaro$art_obj = item.subs, $art_cnryypa$art_c = $art_objzsvmaaro$art_obj.length; subIndex < $art_cnryypa$art_c; subIndex++) {
            var sub = $art_objzsvmaaro$art_obj[subIndex];
            ...
            ;
            $p += '"></td><td mxs="_zs_galleryer:b" colspan="4"><a href="javascript:;" class="btn btn-white btn-small mr10">操作</a></td></tr>';
            $line = 62;
            $art = '/each';
            ;
            $expr = '<%}%>';
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryer:d" class="mc-iconfont _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 148;
    $art = '=viewId';
    ;
