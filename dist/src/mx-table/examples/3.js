...
module.exports = Base.extend({
    ...
    ;
    $p += '</tbody></table></div><div><table mxa="_zs_galleryeN:d" class="table" center="true" width="1000"><thead><tr>';
    $line = 37;
