...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerye$:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxa="_zs_gallerye$:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_gallerye$:_" class="mb20"><span class="color-9">该示例：</span>表头吸顶 + 左右分栏 + 默认展开第一行下方操作项 + 选中行展示操作项</div><div mxa="_zs_gallerye$:b" mx-view="mx-table/index?sticky=true" class="mb40"><div><table mxa="_zs_gallerye$:c" class="table" left="true" width="500"><thead><tr>';
    $line = 12;
    ...
    ;
    $p += '</tbody></table></div><div><table mxa="_zs_gallerye$:d" class="table" center="true" width="1000"><thead><tr>';
    $line = 37;
