...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cbcrunifg$art_c = list.length; index < $art_cbcrunifg$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cbcrunifg$art_c = list.length; index < $art_cbcrunifg$art_c; index++) {
        var item = list[index];
