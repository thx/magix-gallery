...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cmavuzlmuo$art_c = list.length; index < $art_cmavuzlmuo$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cmavuzlmuo$art_c = list.length; index < $art_cmavuzlmuo$art_c; index++) {
        var item = list[index];
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryet:h" class="mc-iconfont _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 101;
    $art = '=viewId';
    ;
