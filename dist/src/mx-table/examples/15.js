...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeW:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryeW:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryeW:_" class="mb20"><span class="color-9">以下示例：</span>实时反馈当前选中项</div><div mxa="_zs_galleryeW:b" class="mb20"><a mxs="_zs_galleryeW:a" href="javascript:;" mx-click="' + $viewId + 'clear()" class="btn btn-brand mr20">清空所有选中</a><a mxs="_zs_galleryeW:b" href="javascript:;" mx-click="' + $viewId + 'clearOne()" class="btn btn-brand mr20">清除选择：1_列1</a><span mxs="_zs_galleryeW:c" class="color-9">当前选中：</span>';
    $line = 10;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</div><div mxv mxa="_zs_galleryeW:c" mx-view="mx-table/index?sticky=true"><div mxv><table mxv mxa="_zs_galleryeW:d" class="table"><thead mxv><tr mxv><th mxv mxa="_zs_galleryeW:e" width="50"><input mxs="_zs_galleryeW:d" type="checkbox" class="checkbox" linkage="example" mx-change="' + $viewId + 'get()"/></th><th mxs="_zs_galleryeW:e" width="200">列1</th><th mxs="_zs_galleryeW:f" width="200">列2</th><th mxs="_zs_galleryeW:g" width="200">列3</th></tr></thead><tbody mxv>';
    $line = 25;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cowihzztvc$art_c = list.length; index < $art_cowihzztvc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cowihzztvc$art_c = list.length; index < $art_cowihzztvc$art_c; index++) {
        var item = list[index];
