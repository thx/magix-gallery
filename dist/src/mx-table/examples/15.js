...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeK:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryeK:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryeK:_" class="mb20"><span class="color-9">以下示例：</span>实时反馈当前选中项</div><div mxa="_zs_galleryeK:b" class="mb20"><a mxs="_zs_galleryeK:a" href="javascript:;" mx-click="' + $viewId + 'clear()" class="btn btn-brand mr20">清空所有选中</a><span mxs="_zs_galleryeK:b" class="color-9">当前选中：</span>';
    $line = 9;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</div><div mxv mxa="_zs_galleryeK:c" mx-view="mx-table/index?sticky=true"><div mxv><table mxv mxa="_zs_galleryeK:d" class="table"><thead mxv><tr mxv><th mxv mxa="_zs_galleryeK:e" width="50"><input mxs="_zs_galleryeK:c" type="checkbox" class="checkbox" linkage="example" mx-change="' + $viewId + 'get()"/></th><th mxs="_zs_galleryeK:d" width="200">列1</th><th mxs="_zs_galleryeK:e" width="200">列2</th><th mxs="_zs_galleryeK:f" width="200">列3</th></tr></thead><tbody mxv>';
    $line = 24;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cxvfndtven$art_c = list.length; index < $art_cxvfndtven$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cxvfndtven$art_c = list.length; index < $art_cxvfndtven$art_c; index++) {
        var item = list[index];
    ...
    $art = '=page';
    ;
    $p += ($expr = '<%!$eu(page)%>', $eu(page)) + '"></div></div><div mxa="_zs_galleryeK:f" class="clearfix"><div mxa="_zs_galleryeK:g" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_galleryeK:g" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 48;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryeK:h" class="mc-iconfont _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 101;
    $art = '=viewId';
    ;
