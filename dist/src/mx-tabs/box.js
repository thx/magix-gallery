/*
    ...
    loader: cmd_es
 */
define("mx-tabs/box",["magix","mx-tabs/base","mx-effects/icon","mx-popover/index"],(require,exports,module)=>{
/*Magix,Base*/
...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ctgjxssnsej$art_c = list.length; index < $art_ctgjxssnsej$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ctgjxssnsej$art_c = list.length; index < $art_ctgjxssnsej$art_c; index++) {
        var item = list[index];
        $p += '<a href="javascript:;" ';
        $line = 3;
        $art = 'if !disabled';
