...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_crzdxaso$art_c = list.length; index < $art_crzdxaso$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_crzdxaso$art_c = list.length; index < $art_crzdxaso$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_igslbzi$art_i = 0, $art_czyvbmdor$art_c = list.length; $art_igslbzi$art_i < $art_czyvbmdor$art_c; $art_igslbzi$art_i++) {        var item = list[$art_igslbzi$art_i]%>';
        for (var $art_igslbzi$art_i = 0, $art_czyvbmdor$art_c = list.length; $art_igslbzi$art_i < $art_czyvbmdor$art_c; $art_igslbzi$art_i++) {
            var item = list[$art_igslbzi$art_i];
            $p += '<a href="javascript:;" ';
            $line = 34;
            $art = 'if !disabled';
            ;
