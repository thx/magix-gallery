...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cgfwgcuf$art_c = list.length; index < $art_cgfwgcuf$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cgfwgcuf$art_c = list.length; index < $art_cgfwgcuf$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iypawem$art_i = 0, $art_cylytpoan$art_c = list.length; $art_iypawem$art_i < $art_cylytpoan$art_c; $art_iypawem$art_i++) {        var item = list[$art_iypawem$art_i]%>';
        for (var $art_iypawem$art_i = 0, $art_cylytpoan$art_c = list.length; $art_iypawem$art_i < $art_cylytpoan$art_c; $art_iypawem$art_i++) {
            var item = list[$art_iypawem$art_i];
            $p += '<a href="javascript:;" ';
            $line = 34;
            $art = 'if !disabled';
            ;
