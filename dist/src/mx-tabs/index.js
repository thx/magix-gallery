...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cssppys$art_c = list.length; index < $art_cssppys$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cssppys$art_c = list.length; index < $art_cssppys$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iwlugbew$art_i = 0, $art_czzaukli$art_c = list.length; $art_iwlugbew$art_i < $art_czzaukli$art_c; $art_iwlugbew$art_i++) {        var item = list[$art_iwlugbew$art_i]%>';
        for (var $art_iwlugbew$art_i = 0, $art_czzaukli$art_c = list.length; $art_iwlugbew$art_i < $art_czzaukli$art_c; $art_iwlugbew$art_i++) {
            var item = list[$art_iwlugbew$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
