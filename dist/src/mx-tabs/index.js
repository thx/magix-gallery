...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ceprdhc$art_c = list.length; index < $art_ceprdhc$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ceprdhc$art_c = list.length; index < $art_ceprdhc$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_innzltzjte$art_i = 0, $art_czodwnqm$art_c = list.length; $art_innzltzjte$art_i < $art_czodwnqm$art_c; $art_innzltzjte$art_i++) {        var item = list[$art_innzltzjte$art_i]%>';
        for (var $art_innzltzjte$art_i = 0, $art_czodwnqm$art_c = list.length; $art_innzltzjte$art_i < $art_czodwnqm$art_c; $art_innzltzjte$art_i++) {
            var item = list[$art_innzltzjte$art_i];
            $p += '<a href="javascript:;" ';
            $line = 35;
            $art = 'if !disabled';
            ;
