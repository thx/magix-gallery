...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_czecgv$art_c = list.length; index < $art_czecgv$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_czecgv$art_c = list.length; index < $art_czecgv$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_igcuiqttu$art_i = 0, $art_cupuidfe$art_c = list.length; $art_igcuiqttu$art_i < $art_cupuidfe$art_c; $art_igcuiqttu$art_i++) {        var item = list[$art_igcuiqttu$art_i]%>';
        for (var $art_igcuiqttu$art_i = 0, $art_cupuidfe$art_c = list.length; $art_igcuiqttu$art_i < $art_cupuidfe$art_c; $art_igcuiqttu$art_i++) {
            var item = list[$art_igcuiqttu$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
