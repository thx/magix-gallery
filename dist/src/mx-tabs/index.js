...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_coinnfrua$art_c = list.length; index < $art_coinnfrua$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_coinnfrua$art_c = list.length; index < $art_coinnfrua$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ielfbgdwu$art_i = 0, $art_cuxhhczb$art_c = list.length; $art_ielfbgdwu$art_i < $art_cuxhhczb$art_c; $art_ielfbgdwu$art_i++) {        var item = list[$art_ielfbgdwu$art_i]%>';
        for (var $art_ielfbgdwu$art_i = 0, $art_cuxhhczb$art_c = list.length; $art_ielfbgdwu$art_i < $art_cuxhhczb$art_c; $art_ielfbgdwu$art_i++) {
            var item = list[$art_ielfbgdwu$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
