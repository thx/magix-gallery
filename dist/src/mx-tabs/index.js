...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryff:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
    $line = 2;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_ccqadenap$art_c = list.length; index < $art_ccqadenap$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ccqadenap$art_c = list.length; index < $art_ccqadenap$art_c; index++) {
        var item = list[index];
        ...
        if (item.tagContent) {
            ;
            $p += '<span mxa="_zs_galleryff:a" class="_zs_gallery_mx-tabs_index_-tag-content">';
            $line = 12;
            $art = '!item.tagContent';
            ;
