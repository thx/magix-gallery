...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cgnebbn$art_c = list.length; index < $art_cgnebbn$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cgnebbn$art_c = list.length; index < $art_cgnebbn$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_inojkpk$art_i = 0, $art_ctwszkeu$art_c = list.length; $art_inojkpk$art_i < $art_ctwszkeu$art_c; $art_inojkpk$art_i++) {        var item = list[$art_inojkpk$art_i]%>';
        for (var $art_inojkpk$art_i = 0, $art_ctwszkeu$art_c = list.length; $art_inojkpk$art_i < $art_ctwszkeu$art_c; $art_inojkpk$art_i++) {
            var item = list[$art_inojkpk$art_i];
            $p += '<a href="javascript:;" ';
            $line = 35;
            $art = 'if !disabled';
            ;
