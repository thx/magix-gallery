...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cgcmluydg$art_c = list.length; index < $art_cgcmluydg$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cgcmluydg$art_c = list.length; index < $art_cgcmluydg$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iqdarubk$art_i = 0, $art_cxgqgsqi$art_c = list.length; $art_iqdarubk$art_i < $art_cxgqgsqi$art_c; $art_iqdarubk$art_i++) {        var item = list[$art_iqdarubk$art_i]%>';
        for (var $art_iqdarubk$art_i = 0, $art_cxgqgsqi$art_c = list.length; $art_iqdarubk$art_i < $art_cxgqgsqi$art_c; $art_iqdarubk$art_i++) {
            var item = list[$art_iqdarubk$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
