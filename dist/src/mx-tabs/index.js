...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_codxyhwwr$art_c = list.length; index < $art_codxyhwwr$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_codxyhwwr$art_c = list.length; index < $art_codxyhwwr$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iphdvwi$art_i = 0, $art_cafmvqadz$art_c = list.length; $art_iphdvwi$art_i < $art_cafmvqadz$art_c; $art_iphdvwi$art_i++) {        var item = list[$art_iphdvwi$art_i]%>';
        for (var $art_iphdvwi$art_i = 0, $art_cafmvqadz$art_c = list.length; $art_iphdvwi$art_i < $art_cafmvqadz$art_c; $art_iphdvwi$art_i++) {
            var item = list[$art_iphdvwi$art_i];
            $p += '<a href="javascript:;" ';
            $line = 35;
            $art = 'if !disabled';
            ;
