...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cebfjytq$art_c = list.length; index < $art_cebfjytq$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cebfjytq$art_c = list.length; index < $art_cebfjytq$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_irkpr$art_i = 0, $art_cylrpbcgd$art_c = list.length; $art_irkpr$art_i < $art_cylrpbcgd$art_c; $art_irkpr$art_i++) {        var item = list[$art_irkpr$art_i]%>';
        for (var $art_irkpr$art_i = 0, $art_cylrpbcgd$art_c = list.length; $art_irkpr$art_i < $art_cylrpbcgd$art_c; $art_irkpr$art_i++) {
            var item = list[$art_irkpr$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
