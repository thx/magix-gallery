...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerye5:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'事件处理\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'打标\',\n            key: viewId + \'_demo10\'\n        },{\n            name: \'双向绑定\',\n            key: viewId + \'_demo9\'\n        },{\n            name: \'带提示\',\n            key: viewId + \'_demo5\'\n        },{\n            name: \'禁止操作\',\n            key: viewId + \'_demo6\'\n        },{\n            name: \'空心版\',\n            key: viewId + \'_demo7\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerye5:a" class="clearfix mb20"><div mxa="_zs_gallerye5:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-tabs/examples/3" id="';
    $line = 35;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_gallerye5:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-tabs/examples/10" id="';
    $line = 40;
    $art = '=viewId';
    ;
