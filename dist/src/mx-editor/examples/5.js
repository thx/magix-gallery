...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryby:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryby:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxa="_zs_galleryby:b" class="mb20"><span mxs="_zs_galleryby:_" class="color-9">双向绑定，当前内容：</span><span>';
    $line = 5;
    $art = '=content';
    ;
    $p += ($expr = '<%=content%>', $e(content)) + '（要求必填且不小于200）</span></div><div mxv mxa="_zs_galleryby:c" class="mb20"><div mxv="content" mxe="' + $viewId + '_0" mxc="[';
    $line = 9;
