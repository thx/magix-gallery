...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iegfohtlgv$art_i = 0, $art_cygse$art_c = list.length; $art_iegfohtlgv$art_i < $art_cygse$art_c; $art_iegfohtlgv$art_i++) {            var item = list[$art_iegfohtlgv$art_i]%>';
            for (var $art_iegfohtlgv$art_i = 0, $art_cygse$art_c = list.length; $art_iegfohtlgv$art_i < $art_cygse$art_c; $art_iegfohtlgv$art_i++) {
                var item = list[$art_iegfohtlgv$art_i];
