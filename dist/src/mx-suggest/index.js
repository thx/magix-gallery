...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ixedvetyqb$art_i = 0, $art_cowqcvweil$art_c = list.length; $art_ixedvetyqb$art_i < $art_cowqcvweil$art_c; $art_ixedvetyqb$art_i++) {            var item = list[$art_ixedvetyqb$art_i]%>';
            for (var $art_ixedvetyqb$art_i = 0, $art_cowqcvweil$art_c = list.length; $art_ixedvetyqb$art_i < $art_cowqcvweil$art_c; $art_ixedvetyqb$art_i++) {
                var item = list[$art_ixedvetyqb$art_i];
