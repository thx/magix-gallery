...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ibiezxyxi$art_i = 0, $art_cpaormms$art_c = list.length; $art_ibiezxyxi$art_i < $art_cpaormms$art_c; $art_ibiezxyxi$art_i++) {            var item = list[$art_ibiezxyxi$art_i]%>';
            for (var $art_ibiezxyxi$art_i = 0, $art_cpaormms$art_c = list.length; $art_ibiezxyxi$art_i < $art_cpaormms$art_c; $art_ibiezxyxi$art_i++) {
                var item = list[$art_ibiezxyxi$art_i];
