...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ivzxwxfut$art_i = 0, $art_cjkarznrcf$art_c = list.length; $art_ivzxwxfut$art_i < $art_cjkarznrcf$art_c; $art_ivzxwxfut$art_i++) {            var item = list[$art_ivzxwxfut$art_i]%>';
            for (var $art_ivzxwxfut$art_i = 0, $art_cjkarznrcf$art_c = list.length; $art_ivzxwxfut$art_i < $art_cjkarznrcf$art_c; $art_ivzxwxfut$art_i++) {
                var item = list[$art_ivzxwxfut$art_i];
