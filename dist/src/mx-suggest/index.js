...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_irlwku$art_i = 0, $art_cyyqnmdsbw$art_c = list.length; $art_irlwku$art_i < $art_cyyqnmdsbw$art_c; $art_irlwku$art_i++) {            var item = list[$art_irlwku$art_i]%>';
            for (var $art_irlwku$art_i = 0, $art_cyyqnmdsbw$art_c = list.length; $art_irlwku$art_i < $art_cyyqnmdsbw$art_c; $art_irlwku$art_i++) {
                var item = list[$art_irlwku$art_i];
