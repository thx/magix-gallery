...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iyenfscaz$art_i = 0, $art_cbttifd$art_c = list.length; $art_iyenfscaz$art_i < $art_cbttifd$art_c; $art_iyenfscaz$art_i++) {            var item = list[$art_iyenfscaz$art_i]%>';
            for (var $art_iyenfscaz$art_i = 0, $art_cbttifd$art_c = list.length; $art_iyenfscaz$art_i < $art_cbttifd$art_c; $art_iyenfscaz$art_i++) {
                var item = list[$art_iyenfscaz$art_i];
