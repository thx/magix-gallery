...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ipviyynf$art_i = 0, $art_cadblhck$art_c = list.length; $art_ipviyynf$art_i < $art_cadblhck$art_c; $art_ipviyynf$art_i++) {            var item = list[$art_ipviyynf$art_i]%>';
            for (var $art_ipviyynf$art_i = 0, $art_cadblhck$art_c = list.length; $art_ipviyynf$art_i < $art_cadblhck$art_c; $art_ipviyynf$art_i++) {
                var item = list[$art_ipviyynf$art_i];
