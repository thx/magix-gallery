...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ixtrfvt$art_i = 0, $art_cjokatzi$art_c = list.length; $art_ixtrfvt$art_i < $art_cjokatzi$art_c; $art_ixtrfvt$art_i++) {            var item = list[$art_ixtrfvt$art_i]%>';
            for (var $art_ixtrfvt$art_i = 0, $art_cjokatzi$art_c = list.length; $art_ixtrfvt$art_i < $art_cjokatzi$art_c; $art_ixtrfvt$art_i++) {
                var item = list[$art_ixtrfvt$art_i];
