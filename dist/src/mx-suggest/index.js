...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_imjzzmqavs$art_i = 0, $art_cmnuwasgej$art_c = list.length; $art_imjzzmqavs$art_i < $art_cmnuwasgej$art_c; $art_imjzzmqavs$art_i++) {            var item = list[$art_imjzzmqavs$art_i]%>';
            for (var $art_imjzzmqavs$art_i = 0, $art_cmnuwasgej$art_c = list.length; $art_imjzzmqavs$art_i < $art_cmnuwasgej$art_c; $art_imjzzmqavs$art_i++) {
                var item = list[$art_imjzzmqavs$art_i];
