...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_intdrurxxib$art_i = 0, $art_cmizom$art_c = list.length; $art_intdrurxxib$art_i < $art_cmizom$art_c; $art_intdrurxxib$art_i++) {            var item = list[$art_intdrurxxib$art_i]%>';
            for (var $art_intdrurxxib$art_i = 0, $art_cmizom$art_c = list.length; $art_intdrurxxib$art_i < $art_cmizom$art_c; $art_intdrurxxib$art_i++) {
                var item = list[$art_intdrurxxib$art_i];
