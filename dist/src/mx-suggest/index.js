...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_igdeaaqfgk$art_i = 0, $art_chukkk$art_c = list.length; $art_igdeaaqfgk$art_i < $art_chukkk$art_c; $art_igdeaaqfgk$art_i++) {            var item = list[$art_igdeaaqfgk$art_i]%>';
            for (var $art_igdeaaqfgk$art_i = 0, $art_chukkk$art_c = list.length; $art_igdeaaqfgk$art_i < $art_chukkk$art_c; $art_igdeaaqfgk$art_i++) {
                var item = list[$art_igdeaaqfgk$art_i];
