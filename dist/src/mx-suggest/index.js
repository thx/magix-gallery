...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryey:_" class="search-box"><i mxs="_zs_galleryey:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 4;
    $art = '=placeholder';
    ;
    ...
    if (selectedText) {
        ;
        $p += '<i mxs="_zs_galleryey:a" class="mc-iconfont _zs_gallery_mx-suggest_index_-delete-icon" mx-click="' + $viewId + '@{clear}()">&#xe6f8;</i>';
        $line = 15;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '"><ul mxa="_zs_galleryey:a" class="mx-output-list">';
    $line = 19;
    $art = 'if loading';
    ;
    $expr = '<%if (loading) {%>';
    if (loading) {
        ;
        $p += '<li mxs="_zs_galleryey:b"><div class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></li>';
        $line = 21;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_imqbqeyeem$art_i = 0, $art_cunwztcovm$art_c = list.length; $art_imqbqeyeem$art_i < $art_cunwztcovm$art_c; $art_imqbqeyeem$art_i++) {            var item = list[$art_imqbqeyeem$art_i]%>';
            for (var $art_imqbqeyeem$art_i = 0, $art_cunwztcovm$art_c = list.length; $art_imqbqeyeem$art_i < $art_cunwztcovm$art_c; $art_imqbqeyeem$art_i++) {
                var item = list[$art_imqbqeyeem$art_i];
                $p += '<li mxa="_zs_galleryey:b" class="mx-output-item"><span class="mx-output-link ';
                $line = 25;
            ...
            ;
            $p += '<li mxa="_zs_galleryey:c" class="text-center color-9 pt20 pb20">';
            $line = 33;
            $art = '=emptyText';
            ;
