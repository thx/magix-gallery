...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iupmjqr$art_i = 0, $art_cnopdjtj$art_c = list.length; $art_iupmjqr$art_i < $art_cnopdjtj$art_c; $art_iupmjqr$art_i++) {            var item = list[$art_iupmjqr$art_i]%>';
            for (var $art_iupmjqr$art_i = 0, $art_cnopdjtj$art_c = list.length; $art_iupmjqr$art_i < $art_cnopdjtj$art_c; $art_iupmjqr$art_i++) {
                var item = list[$art_iupmjqr$art_i];
