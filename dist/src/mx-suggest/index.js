...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ipoupkpp$art_i = 0, $art_ciigdhoin$art_c = list.length; $art_ipoupkpp$art_i < $art_ciigdhoin$art_c; $art_ipoupkpp$art_i++) {            var item = list[$art_ipoupkpp$art_i]%>';
            for (var $art_ipoupkpp$art_i = 0, $art_ciigdhoin$art_c = list.length; $art_ipoupkpp$art_i < $art_ciigdhoin$art_c; $art_ipoupkpp$art_i++) {
                var item = list[$art_ipoupkpp$art_i];
