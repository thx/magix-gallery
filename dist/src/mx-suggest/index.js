...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ishnmuo$art_i = 0, $art_cjftfgnfr$art_c = list.length; $art_ishnmuo$art_i < $art_cjftfgnfr$art_c; $art_ishnmuo$art_i++) {            var item = list[$art_ishnmuo$art_i]%>';
            for (var $art_ishnmuo$art_i = 0, $art_cjftfgnfr$art_c = list.length; $art_ishnmuo$art_i < $art_cjftfgnfr$art_c; $art_ishnmuo$art_i++) {
                var item = list[$art_ishnmuo$art_i];
