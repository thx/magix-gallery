...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_itfqjrwk$art_i = 0, $art_ctkbsh$art_c = list.length; $art_itfqjrwk$art_i < $art_ctkbsh$art_c; $art_itfqjrwk$art_i++) {            var item = list[$art_itfqjrwk$art_i]%>';
            for (var $art_itfqjrwk$art_i = 0, $art_ctkbsh$art_c = list.length; $art_itfqjrwk$art_i < $art_ctkbsh$art_c; $art_itfqjrwk$art_i++) {
                var item = list[$art_itfqjrwk$art_i];
