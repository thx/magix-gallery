...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ilhvxtxs$art_i = 0, $art_ctewdalmgh$art_c = list.length; $art_ilhvxtxs$art_i < $art_ctewdalmgh$art_c; $art_ilhvxtxs$art_i++) {            var item = list[$art_ilhvxtxs$art_i]%>';
            for (var $art_ilhvxtxs$art_i = 0, $art_ctewdalmgh$art_c = list.length; $art_ilhvxtxs$art_i < $art_ctewdalmgh$art_c; $art_ilhvxtxs$art_i++) {
                var item = list[$art_ilhvxtxs$art_i];
