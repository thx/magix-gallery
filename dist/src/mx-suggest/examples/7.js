...
module.exports = Base.extend({
    ...
    $art = ':item';
    ;
    $p += ($expr = '<%@item%>', $i($$ref, item)) + '"></div><a mxs="_zs_galleryeD:b" href="javascript:;" class="btn ml10" mx-click="' + $viewId + 'check()">校验选择项</a>';
    $line = 19;
    $art = 'if msg';
    ;
    $expr = '<%if (msg) {%>';
    if (msg) {
        ;
        $p += '<span mxa="_zs_galleryeD:d" class="ml10">';
        $line = 20;
        $art = '!msg';
        ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryeD:i" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 44;
    $art = '!text2';
    ;
