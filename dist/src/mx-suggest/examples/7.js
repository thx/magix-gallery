...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeg:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryeg:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryeg:_" class="mb20 clearfix"><span class="color-9">以下示例：</span>动态更新list，初始化list为空，需要复现历史选中值，传入item = {text: \'\', value: \'\'} 完整对象</div><div mxa="_zs_galleryeg:b" class="mb10"><span mxs="_zs_galleryeg:a" class="color-9">当前选中：</span>';
    $line = 8;
    $art = '=selected';
    ;
    ...
    $art = ':item';
    ;
    $p += ($expr = '<%@item%>', $i($$ref, item)) + '"></div><a mxs="_zs_galleryeg:b" href="javascript:;" class="btn ml10" mx-click="' + $viewId + 'check()">校验选择项</a>';
    $line = 19;
    $art = 'if msg';
    ;
    $expr = '<%if (msg) {%>';
    if (msg) {
        ;
        $p += '<span mxa="_zs_galleryeg:d" class="ml10">';
        $line = 20;
        $art = '!msg';
        ;
    ...
    ;
    $p += '</div></div><div mxa="_zs_galleryeg:e" class="clearfix"><div mxa="_zs_galleryeg:f" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_galleryeg:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryeg:g" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 29;
    $art = '!text1';
    ;
