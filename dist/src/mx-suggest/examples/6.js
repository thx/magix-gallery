...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeT:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryeT:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryeT:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div class="color-brand">支持双向绑定</div><div>输入关键词动态获取提示数据；请求数据有延时，加loading</div><div>回车默认选中第一个</div></div></div><div mxa="_zs_galleryeT:b" class="mb10"><span mxs="_zs_galleryeT:a" class="color-9">当前选中：</span>';
    $line = 12;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</div><div mxv mxa="_zs_galleryeT:c" class="mb20"><div mxv="selected" mxe="' + $viewId + '_0" mxc="[';
    $line = 17;
