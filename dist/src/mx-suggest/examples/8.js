...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeJ:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryeJ:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryeJ:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div>动态更新list，初始化list为空，需要复现历史选中值，传入item = {text: \'\', value: \'\'} 完整对象</div><div>回车直接搜索当前关键词</div></div></div><div mxa="_zs_galleryeJ:b" class="mb10"><span mxs="_zs_galleryeJ:a" class="color-9">当前选中：</span>';
    $line = 11;
    $art = '=selected';
    ;
