...
module.exports = Magix.View.extend({
    ...
    ;
    $p += ($expr = '<%=disabled ? \'_zs_gallery_mx-switch_index_-switch-disabled\' : \'\'%>', $e(disabled ? '_zs_gallery_mx-switch_index_-switch-disabled' : '')) + '" mx-click="' + $viewId + '@{toggle}()"><span mxs="_zs_galleryeD:_" class="_zs_gallery_mx-switch_index_-switch-icon"></span></span>';
    $line = 4;
    $art = 'if (disabled && tip)';
    ;
