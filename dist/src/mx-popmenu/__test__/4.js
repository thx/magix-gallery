...
module.exports = Base.extend({
    ...
    ;
    $p += '</span></div></div><div mxa="_zs_gallerydh:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydh:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
