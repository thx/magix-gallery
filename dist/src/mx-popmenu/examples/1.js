...
module.exports = Base.extend({
    ...
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&triggerType=click&place=lt">左上对齐（lt）</span></div><div mxv mxa="_zs_gallerydi:e" class="mb20"><span mxv="menus" class="btn" mx-change="' + $viewId + 'select({text:\'左中对齐（lc）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 19;
    $art = '@menus';
    ;
    ...
    if (text && selected) {
        ;
        $p += '<div mxa="_zs_gallerydi:h" class="_zs_gallery_mx-popmenu_examples_index_-center-tip">';
        $line = 54;
        $art = '=text';
        ;
    ...
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&triggerType=click&place=br">下右对齐（br）</span></div></div><div mxv mxa="_zs_gallerydi:i" class="fl _zs_gallery_mx-popmenu_examples_index_-right"><div mxv mxa="_zs_gallerydi:j" class="mb20"><span mxv="menus" class="btn" mx-change="' + $viewId + 'select({text:\'右上对齐（rt）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 80;
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&triggerType=click&place=rt">右上对齐（rt）</span></div><div mxv mxa="_zs_gallerydi:k" class="mb20"><span mxv="menus" class="btn" mx-change="' + $viewId + 'select({text:\'右中对齐（rc）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 88;
    $art = '@menus';
    ;
    ...
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&triggerType=click&place=rb">右下对齐（rb）</span></div></div></div><div mxa="_zs_gallerydi:l" class="clearfix"><div mxa="_zs_gallerydi:m" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half-left"><div mxs="_zs_gallerydi:a" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 106;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerydi:n" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 108;
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_gallerydi:b" class="mc-iconfont _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 111;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-popmenu class="btn"\n    menus="&#123;&#123;@[&#123;\n        value: 1,\n        text: \'操作1\'\n    &#125;, &#123;\n        value: 2,\n        text: \'操作2\'\n    &#125;, &#123;\n        value: 3,\n        text: \'操作3\'\n    &#125;]&#125;&#125;"\n    width="100"\n    trigger-type="click"&gt;下中对齐（bc）&lt;/mx-popmenu&gt;\n\n&lt;mx-popmenu class="btn"\n    menus="&#123;&#123;@[&#123;\n        value: 1,\n        text: \'操作1\'\n    &#125;, &#123;\n        value: 2,\n        text: \'操作2\'\n    &#125;, &#123;\n        value: 3,\n        text: \'操作3\'\n    &#125;]&#125;&#125;"\n    width="100"\n    trigger-type="click"\n    place="lc"\n    mx-change="select()"&gt;左中对齐（lc）&lt;/mx-popmenu&gt;\n            </pre></div><div mxa="_zs_gallerydi:o" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_gallerydi:c" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-title">JS Code</div><div class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 145;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_gallerydi:p" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 147;
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_gallerydi:b" class="mc-iconfont _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 150;
    $art = '=viewId';
    ;
