...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydx:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'hover显示菜单\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'点击显示菜单\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'右键显示菜单\',\n            key: viewId + \'_demo4\'\n        },{\n            name: \'任意trigger\',\n            key: viewId + \'_demo3\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxa="_zs_gallerydx:a" class="clearfix mb20"><div mxa="_zs_gallerydx:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popmenu/examples/4" id="';
    $line = 31;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_gallerydx:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popmenu/examples/3" id="';
    $line = 34;
    $art = '=viewId';
    ;
