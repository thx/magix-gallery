...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iftuifswizz$art_i = 0, $art_cnhwqrrhjq$art_c = menus.length; $art_iftuifswizz$art_i < $art_cnhwqrrhjq$art_c; $art_iftuifswizz$art_i++) {    var item = menus[$art_iftuifswizz$art_i]%>';
    for (var $art_iftuifswizz$art_i = 0, $art_cnhwqrrhjq$art_c = menus.length; $art_iftuifswizz$art_i < $art_cnhwqrrhjq$art_c; $art_iftuifswizz$art_i++) {
        var item = menus[$art_iftuifswizz$art_i];
