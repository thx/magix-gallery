...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiwiernyjd$art_i = 0, $art_camgdlejbj$art_c = menus.length; $art_iiwiernyjd$art_i < $art_camgdlejbj$art_c; $art_iiwiernyjd$art_i++) {    var item = menus[$art_iiwiernyjd$art_i]%>';
    for (var $art_iiwiernyjd$art_i = 0, $art_camgdlejbj$art_c = menus.length; $art_iiwiernyjd$art_i < $art_camgdlejbj$art_c; $art_iiwiernyjd$art_i++) {
        var item = menus[$art_iiwiernyjd$art_i];
