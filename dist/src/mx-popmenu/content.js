...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuacjdqyj$art_i = 0, $art_crskjhffftl$art_c = menus.length; $art_iuacjdqyj$art_i < $art_crskjhffftl$art_c; $art_iuacjdqyj$art_i++) {    var item = menus[$art_iuacjdqyj$art_i]%>';
    for (var $art_iuacjdqyj$art_i = 0, $art_crskjhffftl$art_c = menus.length; $art_iuacjdqyj$art_i < $art_crskjhffftl$art_c; $art_iuacjdqyj$art_i++) {
        var item = menus[$art_iuacjdqyj$art_i];
