...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilvavvvn$art_i = 0, $art_cyarfytlo$art_c = menus.length; $art_ilvavvvn$art_i < $art_cyarfytlo$art_c; $art_ilvavvvn$art_i++) {    var item = menus[$art_ilvavvvn$art_i]%>';
    for (var $art_ilvavvvn$art_i = 0, $art_cyarfytlo$art_c = menus.length; $art_ilvavvvn$art_i < $art_cyarfytlo$art_c; $art_ilvavvvn$art_i++) {
        var item = menus[$art_ilvavvvn$art_i];
