...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inkmzpxc$art_i = 0, $art_cjcunudnho$art_c = menus.length; $art_inkmzpxc$art_i < $art_cjcunudnho$art_c; $art_inkmzpxc$art_i++) {    var item = menus[$art_inkmzpxc$art_i]%>';
    for (var $art_inkmzpxc$art_i = 0, $art_cjcunudnho$art_c = menus.length; $art_inkmzpxc$art_i < $art_cjcunudnho$art_c; $art_inkmzpxc$art_i++) {
        var item = menus[$art_inkmzpxc$art_i];
