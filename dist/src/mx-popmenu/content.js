...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imnmkcecwg$art_i = 0, $art_cxedfiid$art_c = menus.length; $art_imnmkcecwg$art_i < $art_cxedfiid$art_c; $art_imnmkcecwg$art_i++) {    var item = menus[$art_imnmkcecwg$art_i]%>';
    for (var $art_imnmkcecwg$art_i = 0, $art_cxedfiid$art_c = menus.length; $art_imnmkcecwg$art_i < $art_cxedfiid$art_c; $art_imnmkcecwg$art_i++) {
        var item = menus[$art_imnmkcecwg$art_i];
