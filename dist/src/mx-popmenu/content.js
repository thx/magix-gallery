...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iffaxfnsn$art_i = 0, $art_culvwkpu$art_c = menus.length; $art_iffaxfnsn$art_i < $art_culvwkpu$art_c; $art_iffaxfnsn$art_i++) {    var item = menus[$art_iffaxfnsn$art_i]%>';
    for (var $art_iffaxfnsn$art_i = 0, $art_culvwkpu$art_c = menus.length; $art_iffaxfnsn$art_i < $art_culvwkpu$art_c; $art_iffaxfnsn$art_i++) {
        var item = menus[$art_iffaxfnsn$art_i];
