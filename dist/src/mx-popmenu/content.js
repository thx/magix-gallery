...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irnsefwohl$art_i = 0, $art_csjgcodtp$art_c = menus.length; $art_irnsefwohl$art_i < $art_csjgcodtp$art_c; $art_irnsefwohl$art_i++) {    var item = menus[$art_irnsefwohl$art_i]%>';
    for (var $art_irnsefwohl$art_i = 0, $art_csjgcodtp$art_c = menus.length; $art_irnsefwohl$art_i < $art_csjgcodtp$art_c; $art_irnsefwohl$art_i++) {
        var item = menus[$art_irnsefwohl$art_i];
