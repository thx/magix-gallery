...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerydD:_" class="_zs_gallery_mx-popmenu_content_-menu">';
    $line = 2;
    $art = 'each menus as item';
    ;
    $expr = '<%for (var $art_iqajfbdptg$art_i = 0, $art_cnuuuridbgh$art_c = menus.length; $art_iqajfbdptg$art_i < $art_cnuuuridbgh$art_c; $art_iqajfbdptg$art_i++) {    var item = menus[$art_iqajfbdptg$art_i]%>';
    for (var $art_iqajfbdptg$art_i = 0, $art_cnuuuridbgh$art_c = menus.length; $art_iqajfbdptg$art_i < $art_cnuuuridbgh$art_c; $art_iqajfbdptg$art_i++) {
        var item = menus[$art_iqajfbdptg$art_i];
        $p += '<div mxa="_zs_gallerydD:a" class="_zs_gallery_mx-popmenu_content_-item"><span class="_zs_gallery_mx-popmenu_content_-item-link ellipsis" mx-click="' + $viewId + 'submit({value:\'';
        $line = 5;
        $art = '=item.value';
        ;
