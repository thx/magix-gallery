...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqkdjzjar$art_i = 0, $art_crkyiwqgo$art_c = menus.length; $art_iqkdjzjar$art_i < $art_crkyiwqgo$art_c; $art_iqkdjzjar$art_i++) {    var item = menus[$art_iqkdjzjar$art_i]%>';
    for (var $art_iqkdjzjar$art_i = 0, $art_crkyiwqgo$art_c = menus.length; $art_iqkdjzjar$art_i < $art_crkyiwqgo$art_c; $art_iqkdjzjar$art_i++) {
        var item = menus[$art_iqkdjzjar$art_i];
