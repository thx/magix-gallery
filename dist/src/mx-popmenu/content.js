...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iojehu$art_i = 0, $art_ccxvqbtmj$art_c = menus.length; $art_iojehu$art_i < $art_ccxvqbtmj$art_c; $art_iojehu$art_i++) {    var item = menus[$art_iojehu$art_i]%>';
    for (var $art_iojehu$art_i = 0, $art_ccxvqbtmj$art_c = menus.length; $art_iojehu$art_i < $art_ccxvqbtmj$art_c; $art_iojehu$art_i++) {
        var item = menus[$art_iojehu$art_i];
