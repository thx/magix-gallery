...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iygwipim$art_i = 0, $art_cjgqqo$art_c = menus.length; $art_iygwipim$art_i < $art_cjgqqo$art_c; $art_iygwipim$art_i++) {    var item = menus[$art_iygwipim$art_i]%>';
    for (var $art_iygwipim$art_i = 0, $art_cjgqqo$art_c = menus.length; $art_iygwipim$art_i < $art_cjgqqo$art_c; $art_iygwipim$art_i++) {
        var item = menus[$art_iygwipim$art_i];
