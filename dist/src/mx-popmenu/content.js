...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifufeeat$art_i = 0, $art_ckavyoh$art_c = menus.length; $art_ifufeeat$art_i < $art_ckavyoh$art_c; $art_ifufeeat$art_i++) {    var item = menus[$art_ifufeeat$art_i]%>';
    for (var $art_ifufeeat$art_i = 0, $art_ckavyoh$art_c = menus.length; $art_ifufeeat$art_i < $art_ckavyoh$art_c; $art_ifufeeat$art_i++) {
        var item = menus[$art_ifufeeat$art_i];
