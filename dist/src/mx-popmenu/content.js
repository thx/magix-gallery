...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiqkej$art_i = 0, $art_cvwggywfza$art_c = menus.length; $art_iiqkej$art_i < $art_cvwggywfza$art_c; $art_iiqkej$art_i++) {    var item = menus[$art_iiqkej$art_i]%>';
    for (var $art_iiqkej$art_i = 0, $art_cvwggywfza$art_c = menus.length; $art_iiqkej$art_i < $art_cvwggywfza$art_c; $art_iiqkej$art_i++) {
        var item = menus[$art_iiqkej$art_i];
