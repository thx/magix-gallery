...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irxlkydtn$art_i = 0, $art_cesbsrcrgyg$art_c = menus.length; $art_irxlkydtn$art_i < $art_cesbsrcrgyg$art_c; $art_irxlkydtn$art_i++) {    var item = menus[$art_irxlkydtn$art_i]%>';
    for (var $art_irxlkydtn$art_i = 0, $art_cesbsrcrgyg$art_c = menus.length; $art_irxlkydtn$art_i < $art_cesbsrcrgyg$art_c; $art_irxlkydtn$art_i++) {
        var item = menus[$art_irxlkydtn$art_i];
