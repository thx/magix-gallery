...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerydK:_" class="_zs_gallery_mx-popmenu_content_-menu">';
    $line = 2;
    $art = 'each menus as item';
    ;
    $expr = '<%for (var $art_illabbtwho$art_i = 0, $art_cjtgkfjvp$art_c = menus.length; $art_illabbtwho$art_i < $art_cjtgkfjvp$art_c; $art_illabbtwho$art_i++) {    var item = menus[$art_illabbtwho$art_i]%>';
    for (var $art_illabbtwho$art_i = 0, $art_cjtgkfjvp$art_c = menus.length; $art_illabbtwho$art_i < $art_cjtgkfjvp$art_c; $art_illabbtwho$art_i++) {
        var item = menus[$art_illabbtwho$art_i];
