...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifzzwwrdpf$art_i = 0, $art_cqlohmijm$art_c = menus.length; $art_ifzzwwrdpf$art_i < $art_cqlohmijm$art_c; $art_ifzzwwrdpf$art_i++) {    var item = menus[$art_ifzzwwrdpf$art_i]%>';
    for (var $art_ifzzwwrdpf$art_i = 0, $art_cqlohmijm$art_c = menus.length; $art_ifzzwwrdpf$art_i < $art_cqlohmijm$art_c; $art_ifzzwwrdpf$art_i++) {
        var item = menus[$art_ifzzwwrdpf$art_i];
