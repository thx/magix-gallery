...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivbtsupmrq$art_i = 0, $art_chdaqdgwrm$art_c = menus.length; $art_ivbtsupmrq$art_i < $art_chdaqdgwrm$art_c; $art_ivbtsupmrq$art_i++) {    var item = menus[$art_ivbtsupmrq$art_i]%>';
    for (var $art_ivbtsupmrq$art_i = 0, $art_chdaqdgwrm$art_c = menus.length; $art_ivbtsupmrq$art_i < $art_chdaqdgwrm$art_c; $art_ivbtsupmrq$art_i++) {
        var item = menus[$art_ivbtsupmrq$art_i];
