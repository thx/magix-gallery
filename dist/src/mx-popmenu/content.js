...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isedxhj$art_i = 0, $art_cxwsdhtogr$art_c = menus.length; $art_isedxhj$art_i < $art_cxwsdhtogr$art_c; $art_isedxhj$art_i++) {    var item = menus[$art_isedxhj$art_i]%>';
    for (var $art_isedxhj$art_i = 0, $art_cxwsdhtogr$art_c = menus.length; $art_isedxhj$art_i < $art_cxwsdhtogr$art_c; $art_isedxhj$art_i++) {
        var item = menus[$art_isedxhj$art_i];
