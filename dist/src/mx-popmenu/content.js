...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipyxnzfhg$art_i = 0, $art_cjltwmua$art_c = menus.length; $art_ipyxnzfhg$art_i < $art_cjltwmua$art_c; $art_ipyxnzfhg$art_i++) {    var item = menus[$art_ipyxnzfhg$art_i]%>';
    for (var $art_ipyxnzfhg$art_i = 0, $art_cjltwmua$art_c = menus.length; $art_ipyxnzfhg$art_i < $art_cjltwmua$art_c; $art_ipyxnzfhg$art_i++) {
        var item = menus[$art_ipyxnzfhg$art_i];
