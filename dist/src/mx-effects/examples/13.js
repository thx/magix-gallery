...
module.exports = Base.extend({
    ...
    ;
    $p += ($expr = '<%!$eu(\'<i class=\\"mc-iconfont\\">&#xe635;</i>\')%>', $eu('<i class=\"mc-iconfont\">&#xe635;</i>')) + '&color=%23ff0000"></div></div><div mxa="_zs_gallerybG:c" class="mb10"><div mx-view="mx-effects/star?num=4&icon=';
    $line = 10;
    $art = '=\'<i class=\\"mc-iconfont\\">&#xe60c;</i>\'';
    ;
