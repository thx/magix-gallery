...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb1:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'实心默认\',\n            key: viewId + \'_demo14\'\n        },{\n            name: \'带提示信息\',\n            key: viewId + \'_demo17\'\n        },{\n            name: \'空心默认\',\n            key: viewId + \'_demo15\'\n        },{\n            name: \'自定义颜色\',\n            key: viewId + \'_demo16\'\n        },{\n            name: \'实际应用\',\n            key: viewId + \'_demo28\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryb1:a" class="clearfix mb20"><div mxa="_zs_galleryb1:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-effects/examples/14" id="';
    $line = 29;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo16"></div></div><div mxa="_zs_galleryb1:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-effects/examples/17" id="';
    $line = 34;
    $art = '=viewId';
    ;
