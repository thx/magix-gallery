...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb@:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryb@:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryb@:_" class="mb10"><span class="color-9">以下示例：</span>支持操作，双向绑定，显示的数值可为0~count任意数值，操作时只能整数</div><div mxa="_zs_galleryb@:b" class="mb10"><span mxs="_zs_galleryb@:a" class="color-9">当前评分：</span>';
    $line = 9;
    $art = '=num';
    ;
    $p += ($expr = '<%=num%>', $e(num)) + '</div><div mxv mxa="_zs_galleryb@:c" class="mb10"><div mxv="num" mxe="' + $viewId + '_0" mxc="[';
    $line = 14;
    ...
    $art = ':num{refresh:true}';
    ;
    $p += ($expr = '<%@num%>', $i($$ref, num)) + '"></div></div><div mxv mxa="_zs_galleryb@:d" class="mb10"><div mxv="num" mxe="' + $viewId + '_1" mxc="[';
    $line = 19;
    $art = ':num{refresh:true}';
    ;
    $p += '{p:\'num\',f:{refresh:true},a:\'num\'}]" mx-view="mx-effects/star?operational=true&num=';
    ...
    ;
    $p += ($expr = '<%!$eu(\'<i class=\\"mc-iconfont\\">&#xe635;</i>\')%>', $eu('<i class=\"mc-iconfont\">&#xe635;</i>')) + '&color=%23ff0000"></div></div><div mxv mxa="_zs_galleryb@:e" class="mb10"><div mxv="num" mxe="' + $viewId + '_2" mxc="[';
    $line = 26;
    $art = ':num{refresh:true}';
    ;
    $p += '{p:\'num\',f:{refresh:true},a:\'num\'}]" mx-view="mx-effects/star?operational=true&num=';
    ...
    $art = '=\'<i class=\\"mc-iconfont\\">&#xe60c;</i>\'';
    ;
    $p += ($expr = '<%!$eu(\'<i class=\\"mc-iconfont\\">&#xe60c;</i>\')%>', $eu('<i class=\"mc-iconfont\">&#xe60c;</i>')) + '&color=rgb%2881%2C%20163%2C%200%29"></div></div></div><div mxa="_zs_galleryb@:f" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryb@:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 33;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryb@:g" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 35;
    $art = '!text1';
    ;
