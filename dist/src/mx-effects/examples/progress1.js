/*
    ...
    loader: cmd_es
 */
define("mx-effects/examples/progress1",["magix","$","examples/subs","mx-title/second","./8","./9","./23","./29","./22","./21","./20","examples/api"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo9"></div><div mx-view="mx-effects/examples/23" id="';
    $line = 36;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo23"></div></div><div mxa="_zs_galleryb):c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-effects/examples/29" id="';
    $line = 39;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo21"></div><div mx-view="mx-effects/examples/20" id="';
    $line = 42;
    $art = '=viewId';
    ;
