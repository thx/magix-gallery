...
exports["default"] = View.extend({
    ...
    if (type == 'line') {
        ...
        if (vs) {
            ...
            $art = '=color';
            ;
            $p += ($expr = '<%=color%>', $e(color)) + ';"></div><div mxa="_zs_gallerybE:a" class="_zs_gallery_mx-effects_progress_-num _zs_gallery_mx-effects_progress_-num--left">';
            $line = 22;
            $art = '=num';
            ;
            $p += ($expr = '<%=num%>', $e(num)) + '</div><div mxa="_zs_gallerybE:b" class="_zs_gallery_mx-effects_progress_-num _zs_gallery_mx-effects_progress_-num--right">';
            $line = 23;
            $art = '=numRemain';
            ;
    ...
    if (type == 'degree') {
        ;
        $p += '<div mxa="_zs_gallerybE:c" class="_zs_gallery_mx-effects_progress_-degree-wrapper"><div mxa="_zs_gallerybE:d" class="_zs_gallery_mx-effects_progress_-degree-bg">';
        $line = 48;
        ...
        ;
        $p += '</div><div mxa="_zs_gallerybE:e" class="_zs_gallery_mx-effects_progress_-degree-on">';
        $line = 53;
    ...
    assign: function (e) {
        ...
        var brandColor = that['@{get.css.var}']('--color-brand', '#4d7fff');
        switch (type) {
            case 'degree':
                // 刻度型，刻度取整
