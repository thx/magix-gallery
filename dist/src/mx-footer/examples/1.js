...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixklehfldg$art_i = 0, $art_crkupugfe$art_c = list.length; $art_ixklehfldg$art_i < $art_crkupugfe$art_c; $art_ixklehfldg$art_i++) {    var item = list[$art_ixklehfldg$art_i]%>';
    for (var $art_ixklehfldg$art_i = 0, $art_crkupugfe$art_c = list.length; $art_ixklehfldg$art_i < $art_crkupugfe$art_c; $art_ixklehfldg$art_i++) {
        var item = list[$art_ixklehfldg$art_i];
