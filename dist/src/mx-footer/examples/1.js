...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iezwes$art_i = 0, $art_culapkmhl$art_c = list.length; $art_iezwes$art_i < $art_culapkmhl$art_c; $art_iezwes$art_i++) {    var item = list[$art_iezwes$art_i]%>';
    for (var $art_iezwes$art_i = 0, $art_culapkmhl$art_c = list.length; $art_iezwes$art_i < $art_culapkmhl$art_c; $art_iezwes$art_i++) {
        var item = list[$art_iezwes$art_i];
