...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iizvsdgikpj$art_i = 0, $art_cdkhahjj$art_c = list.length; $art_iizvsdgikpj$art_i < $art_cdkhahjj$art_c; $art_iizvsdgikpj$art_i++) {    var item = list[$art_iizvsdgikpj$art_i]%>';
    for (var $art_iizvsdgikpj$art_i = 0, $art_cdkhahjj$art_c = list.length; $art_iizvsdgikpj$art_i < $art_cdkhahjj$art_c; $art_iizvsdgikpj$art_i++) {
        var item = list[$art_iizvsdgikpj$art_i];
