...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixprycvor$art_i = 0, $art_cgvtuekvjh$art_c = list.length; $art_ixprycvor$art_i < $art_cgvtuekvjh$art_c; $art_ixprycvor$art_i++) {    var item = list[$art_ixprycvor$art_i]%>';
    for (var $art_ixprycvor$art_i = 0, $art_cgvtuekvjh$art_c = list.length; $art_ixprycvor$art_i < $art_cgvtuekvjh$art_c; $art_ixprycvor$art_i++) {
        var item = list[$art_ixprycvor$art_i];
