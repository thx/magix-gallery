...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irfqkhltrcj$art_i = 0, $art_cyancqhzjf$art_c = list.length; $art_irfqkhltrcj$art_i < $art_cyancqhzjf$art_c; $art_irfqkhltrcj$art_i++) {    var item = list[$art_irfqkhltrcj$art_i]%>';
    for (var $art_irfqkhltrcj$art_i = 0, $art_cyancqhzjf$art_c = list.length; $art_irfqkhltrcj$art_i < $art_cyancqhzjf$art_c; $art_irfqkhltrcj$art_i++) {
        var item = list[$art_irfqkhltrcj$art_i];
