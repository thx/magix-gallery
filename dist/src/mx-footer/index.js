...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iphbfzjj$art_i = 0, $art_cjvraqbtmfrb$art_c = products.length; $art_iphbfzjj$art_i < $art_cjvraqbtmfrb$art_c; $art_iphbfzjj$art_i++) {        var p = products[$art_iphbfzjj$art_i]%>';
        for (var $art_iphbfzjj$art_i = 0, $art_cjvraqbtmfrb$art_c = products.length; $art_iphbfzjj$art_i < $art_cjvraqbtmfrb$art_c; $art_iphbfzjj$art_i++) {
            var p = products[$art_iphbfzjj$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ivdasj$art_i = 0, $art_objqbsddgvbj$art_obj = p.thirds, $art_cyuttnosh$art_c = $art_objqbsddgvbj$art_obj.length; $art_ivdasj$art_i < $art_cyuttnosh$art_c; $art_ivdasj$art_i++) {            var t = $art_objqbsddgvbj$art_obj[$art_ivdasj$art_i]%>';
            for (var $art_ivdasj$art_i = 0, $art_objqbsddgvbj$art_obj = p.thirds, $art_cyuttnosh$art_c = $art_objqbsddgvbj$art_obj.length; $art_ivdasj$art_i < $art_cyuttnosh$art_c; $art_ivdasj$art_i++) {
                var t = $art_objqbsddgvbj$art_obj[$art_ivdasj$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
