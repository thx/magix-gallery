...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_icqjgrccmtkd$art_i = 0, $art_ccxalwwlr$art_c = products.length; $art_icqjgrccmtkd$art_i < $art_ccxalwwlr$art_c; $art_icqjgrccmtkd$art_i++) {        var p = products[$art_icqjgrccmtkd$art_i]%>';
        for (var $art_icqjgrccmtkd$art_i = 0, $art_ccxalwwlr$art_c = products.length; $art_icqjgrccmtkd$art_i < $art_ccxalwwlr$art_c; $art_icqjgrccmtkd$art_i++) {
            var p = products[$art_icqjgrccmtkd$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifbbzriwee$art_i = 0, $art_objafkopx$art_obj = p.thirds, $art_cvcgzba$art_c = $art_objafkopx$art_obj.length; $art_ifbbzriwee$art_i < $art_cvcgzba$art_c; $art_ifbbzriwee$art_i++) {            var t = $art_objafkopx$art_obj[$art_ifbbzriwee$art_i]%>';
            for (var $art_ifbbzriwee$art_i = 0, $art_objafkopx$art_obj = p.thirds, $art_cvcgzba$art_c = $art_objafkopx$art_obj.length; $art_ifbbzriwee$art_i < $art_cvcgzba$art_c; $art_ifbbzriwee$art_i++) {
                var t = $art_objafkopx$art_obj[$art_ifbbzriwee$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
