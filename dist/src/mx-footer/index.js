...
exports["default"] = View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_idqlufwt$art_i = 0, $art_cqpkcozo$art_c = products.length; $art_idqlufwt$art_i < $art_cqpkcozo$art_c; $art_idqlufwt$art_i++) {        var p = products[$art_idqlufwt$art_i]%>';
        for (var $art_idqlufwt$art_i = 0, $art_cqpkcozo$art_c = products.length; $art_idqlufwt$art_i < $art_cqpkcozo$art_c; $art_idqlufwt$art_i++) {
            var p = products[$art_idqlufwt$art_i];
            $p += '<dl style="width: ';
            $line = 11;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_icrpljdot$art_i = 0, $art_objrwmde$art_obj = p.thirds, $art_cklosukbh$art_c = $art_objrwmde$art_obj.length; $art_icrpljdot$art_i < $art_cklosukbh$art_c; $art_icrpljdot$art_i++) {            var t = $art_objrwmde$art_obj[$art_icrpljdot$art_i]%>';
            for (var $art_icrpljdot$art_i = 0, $art_objrwmde$art_obj = p.thirds, $art_cklosukbh$art_c = $art_objrwmde$art_obj.length; $art_icrpljdot$art_i < $art_cklosukbh$art_c; $art_icrpljdot$art_i++) {
                var t = $art_objrwmde$art_obj[$art_icrpljdot$art_i];
                $p += '<dd><a href="';
                $line = 15;
                $art = '=t.link';
                ;
