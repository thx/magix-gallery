...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iijieacplje$art_i = 0, $art_ceqsaxpqa$art_c = products.length; $art_iijieacplje$art_i < $art_ceqsaxpqa$art_c; $art_iijieacplje$art_i++) {        var p = products[$art_iijieacplje$art_i]%>';
        for (var $art_iijieacplje$art_i = 0, $art_ceqsaxpqa$art_c = products.length; $art_iijieacplje$art_i < $art_ceqsaxpqa$art_c; $art_iijieacplje$art_i++) {
            var p = products[$art_iijieacplje$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ibvwhe$art_i = 0, $art_objuhpuud$art_obj = p.thirds, $art_cmqzoncmj$art_c = $art_objuhpuud$art_obj.length; $art_ibvwhe$art_i < $art_cmqzoncmj$art_c; $art_ibvwhe$art_i++) {            var t = $art_objuhpuud$art_obj[$art_ibvwhe$art_i]%>';
            for (var $art_ibvwhe$art_i = 0, $art_objuhpuud$art_obj = p.thirds, $art_cmqzoncmj$art_c = $art_objuhpuud$art_obj.length; $art_ibvwhe$art_i < $art_cmqzoncmj$art_c; $art_ibvwhe$art_i++) {
                var t = $art_objuhpuud$art_obj[$art_ibvwhe$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
