...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_idgswzlhpxh$art_i = 0, $art_ckbvsutbi$art_c = products.length; $art_idgswzlhpxh$art_i < $art_ckbvsutbi$art_c; $art_idgswzlhpxh$art_i++) {        var p = products[$art_idgswzlhpxh$art_i]%>';
        for (var $art_idgswzlhpxh$art_i = 0, $art_ckbvsutbi$art_c = products.length; $art_idgswzlhpxh$art_i < $art_ckbvsutbi$art_c; $art_idgswzlhpxh$art_i++) {
            var p = products[$art_idgswzlhpxh$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ibdlost$art_i = 0, $art_objowxjcvcqrk$art_obj = p.thirds, $art_cyazueb$art_c = $art_objowxjcvcqrk$art_obj.length; $art_ibdlost$art_i < $art_cyazueb$art_c; $art_ibdlost$art_i++) {            var t = $art_objowxjcvcqrk$art_obj[$art_ibdlost$art_i]%>';
            for (var $art_ibdlost$art_i = 0, $art_objowxjcvcqrk$art_obj = p.thirds, $art_cyazueb$art_c = $art_objowxjcvcqrk$art_obj.length; $art_ibdlost$art_i < $art_cyazueb$art_c; $art_ibdlost$art_i++) {
                var t = $art_objowxjcvcqrk$art_obj[$art_ibdlost$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
