...
exports["default"] = View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ipxjzvtcz$art_i = 0, $art_cagcxpia$art_c = products.length; $art_ipxjzvtcz$art_i < $art_cagcxpia$art_c; $art_ipxjzvtcz$art_i++) {        var p = products[$art_ipxjzvtcz$art_i]%>';
        for (var $art_ipxjzvtcz$art_i = 0, $art_cagcxpia$art_c = products.length; $art_ipxjzvtcz$art_i < $art_cagcxpia$art_c; $art_ipxjzvtcz$art_i++) {
            var p = products[$art_ipxjzvtcz$art_i];
            $p += '<dl style="width: ';
            $line = 11;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_idibntjcv$art_i = 0, $art_objlinbdf$art_obj = p.thirds, $art_cmegsdxm$art_c = $art_objlinbdf$art_obj.length; $art_idibntjcv$art_i < $art_cmegsdxm$art_c; $art_idibntjcv$art_i++) {            var t = $art_objlinbdf$art_obj[$art_idibntjcv$art_i]%>';
            for (var $art_idibntjcv$art_i = 0, $art_objlinbdf$art_obj = p.thirds, $art_cmegsdxm$art_c = $art_objlinbdf$art_obj.length; $art_idibntjcv$art_i < $art_cmegsdxm$art_c; $art_idibntjcv$art_i++) {
                var t = $art_objlinbdf$art_obj[$art_idibntjcv$art_i];
                $p += '<dd><a href="';
                $line = 15;
                $art = '=t.link';
                ;
    ...
    $art = '=textAlign';
    ;
    $p += ($expr = '<%=textAlign%>', $e(textAlign)) + ';"><div mxa="_zs_gallerycd:b" class="_zs_gallery_mx-footer_index_-line"><a mxs="_zs_gallerycd:v" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//www.alimama.com">关于阿里妈妈</a><a mxs="_zs_gallerycd:h" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//jubao.alibaba.com">廉正举报</a><a mxs="_zs_gallerycd:c" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//www.alimama.com/home/about-1.htm">联系客服</a><a mxs="_zs_gallerycd:g" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//www.alimama.com/home/about-4.htm">意见反馈</a>';
    $line = 36;
    $art = 'each copyrights as item';
    ;
    $expr = '<%for (var $art_itwsztid$art_i = 0, $art_cydnmpyga$art_c = copyrights.length; $art_itwsztid$art_i < $art_cydnmpyga$art_c; $art_itwsztid$art_i++) {    var item = copyrights[$art_itwsztid$art_i]%>';
    for (var $art_itwsztid$art_i = 0, $art_cydnmpyga$art_c = copyrights.length; $art_itwsztid$art_i < $art_cydnmpyga$art_c; $art_itwsztid$art_i++) {
        var item = copyrights[$art_itwsztid$art_i];
        $p += ' ';
        $line = 37;
        $art = 'if item.link';
        ;
        ...
        if (item.link) {
            ...
            ;
            $p += '<span mxa="_zs_gallerycd:n" class="_zs_gallery_mx-footer_index_-line-text">';
            $line = 40;
            $art = '=item.text';
            ;
