...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iirsolytbm$art_i = 0, $art_cqstyqgqa$art_c = products.length; $art_iirsolytbm$art_i < $art_cqstyqgqa$art_c; $art_iirsolytbm$art_i++) {        var p = products[$art_iirsolytbm$art_i]%>';
        for (var $art_iirsolytbm$art_i = 0, $art_cqstyqgqa$art_c = products.length; $art_iirsolytbm$art_i < $art_cqstyqgqa$art_c; $art_iirsolytbm$art_i++) {
            var p = products[$art_iirsolytbm$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iuenizeey$art_i = 0, $art_objxidrquc$art_obj = p.thirds, $art_cbmjpyia$art_c = $art_objxidrquc$art_obj.length; $art_iuenizeey$art_i < $art_cbmjpyia$art_c; $art_iuenizeey$art_i++) {            var t = $art_objxidrquc$art_obj[$art_iuenizeey$art_i]%>';
            for (var $art_iuenizeey$art_i = 0, $art_objxidrquc$art_obj = p.thirds, $art_cbmjpyia$art_c = $art_objxidrquc$art_obj.length; $art_iuenizeey$art_i < $art_cbmjpyia$art_c; $art_iuenizeey$art_i++) {
                var t = $art_objxidrquc$art_obj[$art_iuenizeey$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
