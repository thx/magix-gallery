...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ixtsujja$art_i = 0, $art_cduuqsyqef$art_c = products.length; $art_ixtsujja$art_i < $art_cduuqsyqef$art_c; $art_ixtsujja$art_i++) {        var p = products[$art_ixtsujja$art_i]%>';
        for (var $art_ixtsujja$art_i = 0, $art_cduuqsyqef$art_c = products.length; $art_ixtsujja$art_i < $art_cduuqsyqef$art_c; $art_ixtsujja$art_i++) {
            var p = products[$art_ixtsujja$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ienfbrgwn$art_i = 0, $art_objswyuyifhc$art_obj = p.thirds, $art_cmydntkwg$art_c = $art_objswyuyifhc$art_obj.length; $art_ienfbrgwn$art_i < $art_cmydntkwg$art_c; $art_ienfbrgwn$art_i++) {            var t = $art_objswyuyifhc$art_obj[$art_ienfbrgwn$art_i]%>';
            for (var $art_ienfbrgwn$art_i = 0, $art_objswyuyifhc$art_obj = p.thirds, $art_cmydntkwg$art_c = $art_objswyuyifhc$art_obj.length; $art_ienfbrgwn$art_i < $art_cmydntkwg$art_c; $art_ienfbrgwn$art_i++) {
                var t = $art_objswyuyifhc$art_obj[$art_ienfbrgwn$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
