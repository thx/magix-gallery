...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iygcjjigh$art_i = 0, $art_cskqwqayux$art_c = products.length; $art_iygcjjigh$art_i < $art_cskqwqayux$art_c; $art_iygcjjigh$art_i++) {        var p = products[$art_iygcjjigh$art_i]%>';
        for (var $art_iygcjjigh$art_i = 0, $art_cskqwqayux$art_c = products.length; $art_iygcjjigh$art_i < $art_cskqwqayux$art_c; $art_iygcjjigh$art_i++) {
            var p = products[$art_iygcjjigh$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iupgojmrcen$art_i = 0, $art_objsfkjjfn$art_obj = p.thirds, $art_ckqvkxcd$art_c = $art_objsfkjjfn$art_obj.length; $art_iupgojmrcen$art_i < $art_ckqvkxcd$art_c; $art_iupgojmrcen$art_i++) {            var t = $art_objsfkjjfn$art_obj[$art_iupgojmrcen$art_i]%>';
            for (var $art_iupgojmrcen$art_i = 0, $art_objsfkjjfn$art_obj = p.thirds, $art_ckqvkxcd$art_c = $art_objsfkjjfn$art_obj.length; $art_iupgojmrcen$art_i < $art_ckqvkxcd$art_c; $art_iupgojmrcen$art_i++) {
                var t = $art_objsfkjjfn$art_obj[$art_iupgojmrcen$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
