...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ifldhpk$art_i = 0, $art_cmtzjsqy$art_c = products.length; $art_ifldhpk$art_i < $art_cmtzjsqy$art_c; $art_ifldhpk$art_i++) {        var p = products[$art_ifldhpk$art_i]%>';
        for (var $art_ifldhpk$art_i = 0, $art_cmtzjsqy$art_c = products.length; $art_ifldhpk$art_i < $art_cmtzjsqy$art_c; $art_ifldhpk$art_i++) {
            var p = products[$art_ifldhpk$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_idqmcndnfeh$art_i = 0, $art_objzcymkw$art_obj = p.thirds, $art_cjubkrqdj$art_c = $art_objzcymkw$art_obj.length; $art_idqmcndnfeh$art_i < $art_cjubkrqdj$art_c; $art_idqmcndnfeh$art_i++) {            var t = $art_objzcymkw$art_obj[$art_idqmcndnfeh$art_i]%>';
            for (var $art_idqmcndnfeh$art_i = 0, $art_objzcymkw$art_obj = p.thirds, $art_cjubkrqdj$art_c = $art_objzcymkw$art_obj.length; $art_idqmcndnfeh$art_i < $art_cjubkrqdj$art_c; $art_idqmcndnfeh$art_i++) {
                var t = $art_objzcymkw$art_obj[$art_idqmcndnfeh$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
