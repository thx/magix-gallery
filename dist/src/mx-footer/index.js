...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ieoathjn$art_i = 0, $art_cwadtxiu$art_c = products.length; $art_ieoathjn$art_i < $art_cwadtxiu$art_c; $art_ieoathjn$art_i++) {        var p = products[$art_ieoathjn$art_i]%>';
        for (var $art_ieoathjn$art_i = 0, $art_cwadtxiu$art_c = products.length; $art_ieoathjn$art_i < $art_cwadtxiu$art_c; $art_ieoathjn$art_i++) {
            var p = products[$art_ieoathjn$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_igkkkrhp$art_i = 0, $art_objziitjjadn$art_obj = p.thirds, $art_cwfmpektlqb$art_c = $art_objziitjjadn$art_obj.length; $art_igkkkrhp$art_i < $art_cwfmpektlqb$art_c; $art_igkkkrhp$art_i++) {            var t = $art_objziitjjadn$art_obj[$art_igkkkrhp$art_i]%>';
            for (var $art_igkkkrhp$art_i = 0, $art_objziitjjadn$art_obj = p.thirds, $art_cwfmpektlqb$art_c = $art_objziitjjadn$art_obj.length; $art_igkkkrhp$art_i < $art_cwfmpektlqb$art_c; $art_igkkkrhp$art_i++) {
                var t = $art_objziitjjadn$art_obj[$art_igkkkrhp$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
