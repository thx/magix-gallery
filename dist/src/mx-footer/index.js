...
exports["default"] = View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ixydbab$art_i = 0, $art_cbwicgnia$art_c = products.length; $art_ixydbab$art_i < $art_cbwicgnia$art_c; $art_ixydbab$art_i++) {        var p = products[$art_ixydbab$art_i]%>';
        for (var $art_ixydbab$art_i = 0, $art_cbwicgnia$art_c = products.length; $art_ixydbab$art_i < $art_cbwicgnia$art_c; $art_ixydbab$art_i++) {
            var p = products[$art_ixydbab$art_i];
            $p += '<dl style="width: ';
            $line = 11;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifxhbxvmj$art_i = 0, $art_objgfifbjfid$art_obj = p.thirds, $art_chqgctev$art_c = $art_objgfifbjfid$art_obj.length; $art_ifxhbxvmj$art_i < $art_chqgctev$art_c; $art_ifxhbxvmj$art_i++) {            var t = $art_objgfifbjfid$art_obj[$art_ifxhbxvmj$art_i]%>';
            for (var $art_ifxhbxvmj$art_i = 0, $art_objgfifbjfid$art_obj = p.thirds, $art_chqgctev$art_c = $art_objgfifbjfid$art_obj.length; $art_ifxhbxvmj$art_i < $art_chqgctev$art_c; $art_ifxhbxvmj$art_i++) {
                var t = $art_objgfifbjfid$art_obj[$art_ifxhbxvmj$art_i];
                $p += '<dd><a href="';
                $line = 15;
                $art = '=t.link';
                ;
