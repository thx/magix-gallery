...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_itsfncstli$art_i = 0, $art_cbxlzxbja$art_c = products.length; $art_itsfncstli$art_i < $art_cbxlzxbja$art_c; $art_itsfncstli$art_i++) {        var p = products[$art_itsfncstli$art_i]%>';
        for (var $art_itsfncstli$art_i = 0, $art_cbxlzxbja$art_c = products.length; $art_itsfncstli$art_i < $art_cbxlzxbja$art_c; $art_itsfncstli$art_i++) {
            var p = products[$art_itsfncstli$art_i];
            $p += '<dl style="width: ';
            $line = 10;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_imsdvzvaud$art_i = 0, $art_objmbqflatgv$art_obj = p.thirds, $art_ckfpoxaf$art_c = $art_objmbqflatgv$art_obj.length; $art_imsdvzvaud$art_i < $art_ckfpoxaf$art_c; $art_imsdvzvaud$art_i++) {            var t = $art_objmbqflatgv$art_obj[$art_imsdvzvaud$art_i]%>';
            for (var $art_imsdvzvaud$art_i = 0, $art_objmbqflatgv$art_obj = p.thirds, $art_ckfpoxaf$art_c = $art_objmbqflatgv$art_obj.length; $art_imsdvzvaud$art_i < $art_ckfpoxaf$art_c; $art_imsdvzvaud$art_i++) {
                var t = $art_objmbqflatgv$art_obj[$art_imsdvzvaud$art_i];
                $p += '<dd><a href="';
                $line = 14;
                $art = '=t.link';
                ;
