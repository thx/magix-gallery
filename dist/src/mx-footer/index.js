...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ieqwaawok$art_i = 0, $art_csnfspemhgt$art_c = products.length; $art_ieqwaawok$art_i < $art_csnfspemhgt$art_c; $art_ieqwaawok$art_i++) {        var p = products[$art_ieqwaawok$art_i]%>';
        for (var $art_ieqwaawok$art_i = 0, $art_csnfspemhgt$art_c = products.length; $art_ieqwaawok$art_i < $art_csnfspemhgt$art_c; $art_ieqwaawok$art_i++) {
            var p = products[$art_ieqwaawok$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_izgdsm$art_i = 0, $art_objgileufpqenr$art_obj = p.thirds, $art_ctvenmcfpn$art_c = $art_objgileufpqenr$art_obj.length; $art_izgdsm$art_i < $art_ctvenmcfpn$art_c; $art_izgdsm$art_i++) {            var t = $art_objgileufpqenr$art_obj[$art_izgdsm$art_i]%>';
            for (var $art_izgdsm$art_i = 0, $art_objgileufpqenr$art_obj = p.thirds, $art_ctvenmcfpn$art_c = $art_objgileufpqenr$art_obj.length; $art_izgdsm$art_i < $art_ctvenmcfpn$art_c; $art_izgdsm$art_i++) {
                var t = $art_objgileufpqenr$art_obj[$art_izgdsm$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
