...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iawowr$art_i = 0, $art_cwyehuhp$art_c = products.length; $art_iawowr$art_i < $art_cwyehuhp$art_c; $art_iawowr$art_i++) {        var p = products[$art_iawowr$art_i]%>';
        for (var $art_iawowr$art_i = 0, $art_cwyehuhp$art_c = products.length; $art_iawowr$art_i < $art_cwyehuhp$art_c; $art_iawowr$art_i++) {
            var p = products[$art_iawowr$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iebnnfrxej$art_i = 0, $art_objoqfqnzfiu$art_obj = p.thirds, $art_czqwxnra$art_c = $art_objoqfqnzfiu$art_obj.length; $art_iebnnfrxej$art_i < $art_czqwxnra$art_c; $art_iebnnfrxej$art_i++) {            var t = $art_objoqfqnzfiu$art_obj[$art_iebnnfrxej$art_i]%>';
            for (var $art_iebnnfrxej$art_i = 0, $art_objoqfqnzfiu$art_obj = p.thirds, $art_czqwxnra$art_c = $art_objoqfqnzfiu$art_obj.length; $art_iebnnfrxej$art_i < $art_czqwxnra$art_c; $art_iebnnfrxej$art_i++) {
                var t = $art_objoqfqnzfiu$art_obj[$art_iebnnfrxej$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
