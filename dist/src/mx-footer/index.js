...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ihwfgnoe$art_i = 0, $art_cxukmdd$art_c = products.length; $art_ihwfgnoe$art_i < $art_cxukmdd$art_c; $art_ihwfgnoe$art_i++) {        var p = products[$art_ihwfgnoe$art_i]%>';
        for (var $art_ihwfgnoe$art_i = 0, $art_cxukmdd$art_c = products.length; $art_ihwfgnoe$art_i < $art_cxukmdd$art_c; $art_ihwfgnoe$art_i++) {
            var p = products[$art_ihwfgnoe$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iinxpvrkl$art_i = 0, $art_objilbmky$art_obj = p.thirds, $art_clbktgm$art_c = $art_objilbmky$art_obj.length; $art_iinxpvrkl$art_i < $art_clbktgm$art_c; $art_iinxpvrkl$art_i++) {            var t = $art_objilbmky$art_obj[$art_iinxpvrkl$art_i]%>';
            for (var $art_iinxpvrkl$art_i = 0, $art_objilbmky$art_obj = p.thirds, $art_clbktgm$art_c = $art_objilbmky$art_obj.length; $art_iinxpvrkl$art_i < $art_clbktgm$art_c; $art_iinxpvrkl$art_i++) {
                var t = $art_objilbmky$art_obj[$art_iinxpvrkl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
