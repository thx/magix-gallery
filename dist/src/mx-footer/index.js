...
exports["default"] = View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ihxtwafnr$art_i = 0, $art_chzvxq$art_c = products.length; $art_ihxtwafnr$art_i < $art_chzvxq$art_c; $art_ihxtwafnr$art_i++) {        var p = products[$art_ihxtwafnr$art_i]%>';
        for (var $art_ihxtwafnr$art_i = 0, $art_chzvxq$art_c = products.length; $art_ihxtwafnr$art_i < $art_chzvxq$art_c; $art_ihxtwafnr$art_i++) {
            var p = products[$art_ihxtwafnr$art_i];
            $p += '<dl style="width: ';
            $line = 11;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ibbaspoi$art_i = 0, $art_objhjnbwsr$art_obj = p.thirds, $art_clkqculpd$art_c = $art_objhjnbwsr$art_obj.length; $art_ibbaspoi$art_i < $art_clkqculpd$art_c; $art_ibbaspoi$art_i++) {            var t = $art_objhjnbwsr$art_obj[$art_ibbaspoi$art_i]%>';
            for (var $art_ibbaspoi$art_i = 0, $art_objhjnbwsr$art_obj = p.thirds, $art_clkqculpd$art_c = $art_objhjnbwsr$art_obj.length; $art_ibbaspoi$art_i < $art_clkqculpd$art_c; $art_ibbaspoi$art_i++) {
                var t = $art_objhjnbwsr$art_obj[$art_ibbaspoi$art_i];
                $p += '<dd><a href="';
                $line = 15;
                $art = '=t.link';
                ;
