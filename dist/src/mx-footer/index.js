...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iclqjslnvl$art_i = 0, $art_celndycz$art_c = products.length; $art_iclqjslnvl$art_i < $art_celndycz$art_c; $art_iclqjslnvl$art_i++) {        var p = products[$art_iclqjslnvl$art_i]%>';
        for (var $art_iclqjslnvl$art_i = 0, $art_celndycz$art_c = products.length; $art_iclqjslnvl$art_i < $art_celndycz$art_c; $art_iclqjslnvl$art_i++) {
            var p = products[$art_iclqjslnvl$art_i];
            $p += '<dl style="width: ';
            $line = 11;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_inrnwok$art_i = 0, $art_objhconamuv$art_obj = p.thirds, $art_chkmoyznnd$art_c = $art_objhconamuv$art_obj.length; $art_inrnwok$art_i < $art_chkmoyznnd$art_c; $art_inrnwok$art_i++) {            var t = $art_objhconamuv$art_obj[$art_inrnwok$art_i]%>';
            for (var $art_inrnwok$art_i = 0, $art_objhconamuv$art_obj = p.thirds, $art_chkmoyznnd$art_c = $art_objhconamuv$art_obj.length; $art_inrnwok$art_i < $art_chkmoyznnd$art_c; $art_inrnwok$art_i++) {
                var t = $art_objhconamuv$art_obj[$art_inrnwok$art_i];
                $p += '<dd><a href="';
                $line = 15;
                $art = '=t.link';
                ;
    ...
    ;
    $p += '<div mxa="_zs_galleryb+:b" class="_zs_gallery_mx-footer_index_-footer"><div mxa="_zs_galleryb+:c" class="_zs_gallery_mx-footer_index_-line"><a mxs="_zs_galleryb+:b" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//www.alimama.com/home/about-1.htm">联系客服</a><a mxs="_zs_galleryb+:c" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//open.taobao.com/">开放平台</a>';
    $line = 33;
    $art = 'if tanx';
    ;
    $expr = '<%if (tanx) {%>';
    ...
    if (taobao) {
        ;
        $p += '<span mxa="_zs_galleryb+:d" class="_zs_gallery_mx-footer_index_-line-text">Taobao.com版权所有 2003-';
        $line = 49;
        $art = '=year';
        ;
    ...
    if (alimama) {
        ;
        $p += '<span mxa="_zs_galleryb+:e" class="_zs_gallery_mx-footer_index_-line-text">阿里妈妈版权所有 2007-';
        $line = 53;
        $art = '=year';
        ;
