...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ibliixuo$art_i = 0, $art_cunrhspgwtp$art_c = products.length; $art_ibliixuo$art_i < $art_cunrhspgwtp$art_c; $art_ibliixuo$art_i++) {        var p = products[$art_ibliixuo$art_i]%>';
        for (var $art_ibliixuo$art_i = 0, $art_cunrhspgwtp$art_c = products.length; $art_ibliixuo$art_i < $art_cunrhspgwtp$art_c; $art_ibliixuo$art_i++) {
            var p = products[$art_ibliixuo$art_i];
            $p += '<dl style="width: ';
            $line = 11;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ienwprnb$art_i = 0, $art_objgkbmapc$art_obj = p.thirds, $art_ctrpgfwtg$art_c = $art_objgkbmapc$art_obj.length; $art_ienwprnb$art_i < $art_ctrpgfwtg$art_c; $art_ienwprnb$art_i++) {            var t = $art_objgkbmapc$art_obj[$art_ienwprnb$art_i]%>';
            for (var $art_ienwprnb$art_i = 0, $art_objgkbmapc$art_obj = p.thirds, $art_ctrpgfwtg$art_c = $art_objgkbmapc$art_obj.length; $art_ienwprnb$art_i < $art_ctrpgfwtg$art_c; $art_ienwprnb$art_i++) {
                var t = $art_objgkbmapc$art_obj[$art_ienwprnb$art_i];
                $p += '<dd><a href="';
                $line = 15;
                $art = '=t.link';
                ;
