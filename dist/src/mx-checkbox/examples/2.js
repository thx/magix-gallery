...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cxmbykjwg$art_c = list.length; groupIndex < $art_cxmbykjwg$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cxmbykjwg$art_c = list.length; groupIndex < $art_cxmbykjwg$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objxrqymzhj$art_obj = group.subs, $art_ckbbcorule$art_c = $art_objxrqymzhj$art_obj.length; subIndex < $art_ckbbcorule$art_c; subIndex++) {        var sub = $art_objxrqymzhj$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objxrqymzhj$art_obj = group.subs, $art_ckbbcorule$art_c = $art_objxrqymzhj$art_obj.length; subIndex < $art_ckbbcorule$art_c; subIndex++) {
            var sub = $art_objxrqymzhj$art_obj[subIndex];
