...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cbplvihqrc$art_c = list.length; groupIndex < $art_cbplvihqrc$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cbplvihqrc$art_c = list.length; groupIndex < $art_cbplvihqrc$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objrwndafzxgm$art_obj = group.subs, $art_cycqbbbc$art_c = $art_objrwndafzxgm$art_obj.length; subIndex < $art_cycqbbbc$art_c; subIndex++) {        var sub = $art_objrwndafzxgm$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objrwndafzxgm$art_obj = group.subs, $art_cycqbbbc$art_c = $art_objrwndafzxgm$art_obj.length; subIndex < $art_cycqbbbc$art_c; subIndex++) {
            var sub = $art_objrwndafzxgm$art_obj[subIndex];
