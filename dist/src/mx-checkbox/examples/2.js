...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaz:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxa="_zs_galleryaz:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content">';
    $line = 3;
    $art = 'each list as group groupIndex';
    ;
    $expr = '<%for (var groupIndex = 0, $art_cwswthejw$art_c = list.length; groupIndex < $art_cwswthejw$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cwswthejw$art_c = list.length; groupIndex < $art_cwswthejw$art_c; groupIndex++) {
        var group = list[groupIndex];
        $p += '<div><label mxa="_zs_galleryaz:b" class="mr20 mb20"><span mx-change="' + $viewId + 'toggle({groupIndex:';
        $line = 9;
        $art = '=groupIndex';
        ;
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objoradjnmi$art_obj = group.subs, $art_clubgcqnpsq$art_c = $art_objoradjnmi$art_obj.length; subIndex < $art_clubgcqnpsq$art_c; subIndex++) {        var sub = $art_objoradjnmi$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objoradjnmi$art_obj = group.subs, $art_clubgcqnpsq$art_c = $art_objoradjnmi$art_obj.length; subIndex < $art_clubgcqnpsq$art_c; subIndex++) {
            var sub = $art_objoradjnmi$art_obj[subIndex];
            $p += '<label mxa="_zs_galleryaz:c" class="mr20 mb20"><span mx-change="' + $viewId + 'toggle({groupIndex:';
            $line = 17;
            $art = '=groupIndex';
            ;
