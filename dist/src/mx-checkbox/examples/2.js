...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cjypwfqqzf$art_c = list.length; groupIndex < $art_cjypwfqqzf$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cjypwfqqzf$art_c = list.length; groupIndex < $art_cjypwfqqzf$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objcrijvc$art_obj = group.subs, $art_ckcowpy$art_c = $art_objcrijvc$art_obj.length; subIndex < $art_ckcowpy$art_c; subIndex++) {        var sub = $art_objcrijvc$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objcrijvc$art_obj = group.subs, $art_ckcowpy$art_c = $art_objcrijvc$art_obj.length; subIndex < $art_ckcowpy$art_c; subIndex++) {
            var sub = $art_objcrijvc$art_obj[subIndex];
