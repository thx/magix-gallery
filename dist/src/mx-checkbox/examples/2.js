...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cfifigac$art_c = list.length; groupIndex < $art_cfifigac$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cfifigac$art_c = list.length; groupIndex < $art_cfifigac$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objdubwobh$art_obj = group.subs, $art_ctpofkwvl$art_c = $art_objdubwobh$art_obj.length; subIndex < $art_ctpofkwvl$art_c; subIndex++) {        var sub = $art_objdubwobh$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objdubwobh$art_obj = group.subs, $art_ctpofkwvl$art_c = $art_objdubwobh$art_obj.length; subIndex < $art_ctpofkwvl$art_c; subIndex++) {
            var sub = $art_objdubwobh$art_obj[subIndex];
