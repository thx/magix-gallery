...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cykraeda$art_c = list.length; groupIndex < $art_cykraeda$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cykraeda$art_c = list.length; groupIndex < $art_cykraeda$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objjghkxugm$art_obj = group.subs, $art_chzgtpc$art_c = $art_objjghkxugm$art_obj.length; subIndex < $art_chzgtpc$art_c; subIndex++) {        var sub = $art_objjghkxugm$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objjghkxugm$art_obj = group.subs, $art_chzgtpc$art_c = $art_objjghkxugm$art_obj.length; subIndex < $art_chzgtpc$art_c; subIndex++) {
            var sub = $art_objjghkxugm$art_obj[subIndex];
