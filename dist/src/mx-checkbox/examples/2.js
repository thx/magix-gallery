...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cmgtyvthq$art_c = list.length; groupIndex < $art_cmgtyvthq$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cmgtyvthq$art_c = list.length; groupIndex < $art_cmgtyvthq$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objxmdgsznwvb$art_obj = group.subs, $art_caachifplr$art_c = $art_objxmdgsznwvb$art_obj.length; subIndex < $art_caachifplr$art_c; subIndex++) {        var sub = $art_objxmdgsznwvb$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objxmdgsznwvb$art_obj = group.subs, $art_caachifplr$art_c = $art_objxmdgsznwvb$art_obj.length; subIndex < $art_caachifplr$art_c; subIndex++) {
            var sub = $art_objxmdgsznwvb$art_obj[subIndex];
