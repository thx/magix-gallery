...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ccokfvgvug$art_c = list.length; groupIndex < $art_ccokfvgvug$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ccokfvgvug$art_c = list.length; groupIndex < $art_ccokfvgvug$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objueeb$art_obj = group.subs, $art_cdlwcvnrk$art_c = $art_objueeb$art_obj.length; subIndex < $art_cdlwcvnrk$art_c; subIndex++) {        var sub = $art_objueeb$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objueeb$art_obj = group.subs, $art_cdlwcvnrk$art_c = $art_objueeb$art_obj.length; subIndex < $art_cdlwcvnrk$art_c; subIndex++) {
            var sub = $art_objueeb$art_obj[subIndex];
