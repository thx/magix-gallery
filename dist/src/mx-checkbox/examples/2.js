...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cnyqxxgc$art_c = list.length; groupIndex < $art_cnyqxxgc$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cnyqxxgc$art_c = list.length; groupIndex < $art_cnyqxxgc$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objpxkxmrpxags$art_obj = group.subs, $art_civeawk$art_c = $art_objpxkxmrpxags$art_obj.length; subIndex < $art_civeawk$art_c; subIndex++) {        var sub = $art_objpxkxmrpxags$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objpxkxmrpxags$art_obj = group.subs, $art_civeawk$art_c = $art_objpxkxmrpxags$art_obj.length; subIndex < $art_civeawk$art_c; subIndex++) {
            var sub = $art_objpxkxmrpxags$art_obj[subIndex];
