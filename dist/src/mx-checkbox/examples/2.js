...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_crwyabbp$art_c = list.length; groupIndex < $art_crwyabbp$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_crwyabbp$art_c = list.length; groupIndex < $art_crwyabbp$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objasmqwrt$art_obj = group.subs, $art_cxwidzqxs$art_c = $art_objasmqwrt$art_obj.length; subIndex < $art_cxwidzqxs$art_c; subIndex++) {        var sub = $art_objasmqwrt$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objasmqwrt$art_obj = group.subs, $art_cxwidzqxs$art_c = $art_objasmqwrt$art_obj.length; subIndex < $art_cxwidzqxs$art_c; subIndex++) {
            var sub = $art_objasmqwrt$art_obj[subIndex];
