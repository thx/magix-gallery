...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ccabis$art_c = list.length; groupIndex < $art_ccabis$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ccabis$art_c = list.length; groupIndex < $art_ccabis$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objcniauej$art_obj = group.subs, $art_cecltzaubif$art_c = $art_objcniauej$art_obj.length; subIndex < $art_cecltzaubif$art_c; subIndex++) {        var sub = $art_objcniauej$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objcniauej$art_obj = group.subs, $art_cecltzaubif$art_c = $art_objcniauej$art_obj.length; subIndex < $art_cecltzaubif$art_c; subIndex++) {
            var sub = $art_objcniauej$art_obj[subIndex];
