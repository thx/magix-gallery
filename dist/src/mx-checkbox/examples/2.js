...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_czijfbmu$art_c = list.length; groupIndex < $art_czijfbmu$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_czijfbmu$art_c = list.length; groupIndex < $art_czijfbmu$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objinkztso$art_obj = group.subs, $art_cmfvwmhrwco$art_c = $art_objinkztso$art_obj.length; subIndex < $art_cmfvwmhrwco$art_c; subIndex++) {        var sub = $art_objinkztso$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objinkztso$art_obj = group.subs, $art_cmfvwmhrwco$art_c = $art_objinkztso$art_obj.length; subIndex < $art_cmfvwmhrwco$art_c; subIndex++) {
            var sub = $art_objinkztso$art_obj[subIndex];
