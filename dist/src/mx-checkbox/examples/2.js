...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ctoqtxixxjg$art_c = list.length; groupIndex < $art_ctoqtxixxjg$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ctoqtxixxjg$art_c = list.length; groupIndex < $art_ctoqtxixxjg$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objvlttudg$art_obj = group.subs, $art_crgkuprhda$art_c = $art_objvlttudg$art_obj.length; subIndex < $art_crgkuprhda$art_c; subIndex++) {        var sub = $art_objvlttudg$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objvlttudg$art_obj = group.subs, $art_crgkuprhda$art_c = $art_objvlttudg$art_obj.length; subIndex < $art_crgkuprhda$art_c; subIndex++) {
            var sub = $art_objvlttudg$art_obj[subIndex];
