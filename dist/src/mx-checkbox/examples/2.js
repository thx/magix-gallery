...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cauezhovbe$art_c = list.length; groupIndex < $art_cauezhovbe$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cauezhovbe$art_c = list.length; groupIndex < $art_cauezhovbe$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objagkkrtqp$art_obj = group.subs, $art_cwsyxbftqq$art_c = $art_objagkkrtqp$art_obj.length; subIndex < $art_cwsyxbftqq$art_c; subIndex++) {        var sub = $art_objagkkrtqp$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objagkkrtqp$art_obj = group.subs, $art_cwsyxbftqq$art_c = $art_objagkkrtqp$art_obj.length; subIndex < $art_cwsyxbftqq$art_c; subIndex++) {
            var sub = $art_objagkkrtqp$art_obj[subIndex];
