...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cnnkqgis$art_c = list.length; groupIndex < $art_cnnkqgis$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cnnkqgis$art_c = list.length; groupIndex < $art_cnnkqgis$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objgugvrlxlzvv$art_obj = group.subs, $art_cbxqvfyjqvwa$art_c = $art_objgugvrlxlzvv$art_obj.length; subIndex < $art_cbxqvfyjqvwa$art_c; subIndex++) {        var sub = $art_objgugvrlxlzvv$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objgugvrlxlzvv$art_obj = group.subs, $art_cbxqvfyjqvwa$art_c = $art_objgugvrlxlzvv$art_obj.length; subIndex < $art_cbxqvfyjqvwa$art_c; subIndex++) {
            var sub = $art_objgugvrlxlzvv$art_obj[subIndex];
