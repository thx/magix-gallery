...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cmgkpjlhpiqk$art_c = list.length; groupIndex < $art_cmgkpjlhpiqk$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cmgkpjlhpiqk$art_c = list.length; groupIndex < $art_cmgkpjlhpiqk$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objiwpnlvclk$art_obj = group.subs, $art_cjegyoef$art_c = $art_objiwpnlvclk$art_obj.length; subIndex < $art_cjegyoef$art_c; subIndex++) {        var sub = $art_objiwpnlvclk$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objiwpnlvclk$art_obj = group.subs, $art_cjegyoef$art_c = $art_objiwpnlvclk$art_obj.length; subIndex < $art_cjegyoef$art_c; subIndex++) {
            var sub = $art_objiwpnlvclk$art_obj[subIndex];
