...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cjtqsejc$art_c = list.length; groupIndex < $art_cjtqsejc$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cjtqsejc$art_c = list.length; groupIndex < $art_cjtqsejc$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objwvbvrgu$art_obj = group.subs, $art_cmuxphn$art_c = $art_objwvbvrgu$art_obj.length; subIndex < $art_cmuxphn$art_c; subIndex++) {        var sub = $art_objwvbvrgu$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objwvbvrgu$art_obj = group.subs, $art_cmuxphn$art_c = $art_objwvbvrgu$art_obj.length; subIndex < $art_cmuxphn$art_c; subIndex++) {
            var sub = $art_objwvbvrgu$art_obj[subIndex];
