...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cihshvxrdj$art_c = list.length; groupIndex < $art_cihshvxrdj$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cihshvxrdj$art_c = list.length; groupIndex < $art_cihshvxrdj$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objfjkkqbyai$art_obj = group.subs, $art_crcjffb$art_c = $art_objfjkkqbyai$art_obj.length; subIndex < $art_crcjffb$art_c; subIndex++) {        var sub = $art_objfjkkqbyai$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objfjkkqbyai$art_obj = group.subs, $art_crcjffb$art_c = $art_objfjkkqbyai$art_obj.length; subIndex < $art_crcjffb$art_c; subIndex++) {
            var sub = $art_objfjkkqbyai$art_obj[subIndex];
