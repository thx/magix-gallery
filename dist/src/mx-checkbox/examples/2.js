...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cfjudbo$art_c = list.length; groupIndex < $art_cfjudbo$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cfjudbo$art_c = list.length; groupIndex < $art_cfjudbo$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objmtuvj$art_obj = group.subs, $art_chonpehpu$art_c = $art_objmtuvj$art_obj.length; subIndex < $art_chonpehpu$art_c; subIndex++) {        var sub = $art_objmtuvj$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objmtuvj$art_obj = group.subs, $art_chonpehpu$art_c = $art_objmtuvj$art_obj.length; subIndex < $art_chonpehpu$art_c; subIndex++) {
            var sub = $art_objmtuvj$art_obj[subIndex];
