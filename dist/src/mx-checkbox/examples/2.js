...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cowjbfivl$art_c = list.length; groupIndex < $art_cowjbfivl$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cowjbfivl$art_c = list.length; groupIndex < $art_cowjbfivl$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objxkofnwqg$art_obj = group.subs, $art_cwqteqcg$art_c = $art_objxkofnwqg$art_obj.length; subIndex < $art_cwqteqcg$art_c; subIndex++) {        var sub = $art_objxkofnwqg$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objxkofnwqg$art_obj = group.subs, $art_cwqteqcg$art_c = $art_objxkofnwqg$art_obj.length; subIndex < $art_cwqteqcg$art_c; subIndex++) {
            var sub = $art_objxkofnwqg$art_obj[subIndex];
