...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ctgooloxj$art_c = list.length; groupIndex < $art_ctgooloxj$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ctgooloxj$art_c = list.length; groupIndex < $art_ctgooloxj$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objwluskodm$art_obj = group.subs, $art_caxxcubhc$art_c = $art_objwluskodm$art_obj.length; subIndex < $art_caxxcubhc$art_c; subIndex++) {        var sub = $art_objwluskodm$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objwluskodm$art_obj = group.subs, $art_caxxcubhc$art_c = $art_objwluskodm$art_obj.length; subIndex < $art_caxxcubhc$art_c; subIndex++) {
            var sub = $art_objwluskodm$art_obj[subIndex];
