...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cntbihpqm$art_c = list.length; groupIndex < $art_cntbihpqm$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cntbihpqm$art_c = list.length; groupIndex < $art_cntbihpqm$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objkrxmfghrb$art_obj = group.subs, $art_cuutrujqs$art_c = $art_objkrxmfghrb$art_obj.length; subIndex < $art_cuutrujqs$art_c; subIndex++) {        var sub = $art_objkrxmfghrb$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objkrxmfghrb$art_obj = group.subs, $art_cuutrujqs$art_c = $art_objkrxmfghrb$art_obj.length; subIndex < $art_cuutrujqs$art_c; subIndex++) {
            var sub = $art_objkrxmfghrb$art_obj[subIndex];
