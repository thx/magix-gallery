...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_coyvdekii$art_c = list.length; groupIndex < $art_coyvdekii$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_coyvdekii$art_c = list.length; groupIndex < $art_coyvdekii$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objyqlkcvvgc$art_obj = group.subs, $art_clsbvwfyisc$art_c = $art_objyqlkcvvgc$art_obj.length; subIndex < $art_clsbvwfyisc$art_c; subIndex++) {        var sub = $art_objyqlkcvvgc$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objyqlkcvvgc$art_obj = group.subs, $art_clsbvwfyisc$art_c = $art_objyqlkcvvgc$art_obj.length; subIndex < $art_clsbvwfyisc$art_c; subIndex++) {
            var sub = $art_objyqlkcvvgc$art_obj[subIndex];
