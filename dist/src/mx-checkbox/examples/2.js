...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ccbgfmmiel$art_c = list.length; groupIndex < $art_ccbgfmmiel$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ccbgfmmiel$art_c = list.length; groupIndex < $art_ccbgfmmiel$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objmruqvui$art_obj = group.subs, $art_ccgteanp$art_c = $art_objmruqvui$art_obj.length; subIndex < $art_ccgteanp$art_c; subIndex++) {        var sub = $art_objmruqvui$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objmruqvui$art_obj = group.subs, $art_ccgteanp$art_c = $art_objmruqvui$art_obj.length; subIndex < $art_ccgteanp$art_c; subIndex++) {
            var sub = $art_objmruqvui$art_obj[subIndex];
