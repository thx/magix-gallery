...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ccybqenf$art_c = list.length; groupIndex < $art_ccybqenf$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ccybqenf$art_c = list.length; groupIndex < $art_ccybqenf$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objvhjlkd$art_obj = group.subs, $art_cdwrqvx$art_c = $art_objvhjlkd$art_obj.length; subIndex < $art_cdwrqvx$art_c; subIndex++) {        var sub = $art_objvhjlkd$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objvhjlkd$art_obj = group.subs, $art_cdwrqvx$art_c = $art_objvhjlkd$art_obj.length; subIndex < $art_cdwrqvx$art_c; subIndex++) {
            var sub = $art_objvhjlkd$art_obj[subIndex];
