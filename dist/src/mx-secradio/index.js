...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqucmql$art_c = list.length; itemIndex < $art_cqucmql$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqucmql$art_c = list.length; itemIndex < $art_cqucmql$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_imnkbdmr$art_i = 0, $art_objishuqkg$art_obj = item.subs, $art_cmabvjfqky$art_c = $art_objishuqkg$art_obj.length; $art_imnkbdmr$art_i < $art_cmabvjfqky$art_c; $art_imnkbdmr$art_i++) {        var sub = $art_objishuqkg$art_obj[$art_imnkbdmr$art_i]%>';
        for (var $art_imnkbdmr$art_i = 0, $art_objishuqkg$art_obj = item.subs, $art_cmabvjfqky$art_c = $art_objishuqkg$art_obj.length; $art_imnkbdmr$art_i < $art_cmabvjfqky$art_c; $art_imnkbdmr$art_i++) {
            var sub = $art_objishuqkg$art_obj[$art_imnkbdmr$art_i];
