...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cxjulqx$art_c = list.length; itemIndex < $art_cxjulqx$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cxjulqx$art_c = list.length; itemIndex < $art_cxjulqx$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iwcajbda$art_i = 0, $art_objktozdbowh$art_obj = item.subs, $art_cpwfnzmi$art_c = $art_objktozdbowh$art_obj.length; $art_iwcajbda$art_i < $art_cpwfnzmi$art_c; $art_iwcajbda$art_i++) {        var sub = $art_objktozdbowh$art_obj[$art_iwcajbda$art_i]%>';
        for (var $art_iwcajbda$art_i = 0, $art_objktozdbowh$art_obj = item.subs, $art_cpwfnzmi$art_c = $art_objktozdbowh$art_obj.length; $art_iwcajbda$art_i < $art_cpwfnzmi$art_c; $art_iwcajbda$art_i++) {
            var sub = $art_objktozdbowh$art_obj[$art_iwcajbda$art_i];
