...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cbcijfvdvw$art_c = list.length; itemIndex < $art_cbcijfvdvw$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cbcijfvdvw$art_c = list.length; itemIndex < $art_cbcijfvdvw$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iwgkmkwm$art_i = 0, $art_objfoytewmht$art_obj = item.subs, $art_cbimuocpzg$art_c = $art_objfoytewmht$art_obj.length; $art_iwgkmkwm$art_i < $art_cbimuocpzg$art_c; $art_iwgkmkwm$art_i++) {        var sub = $art_objfoytewmht$art_obj[$art_iwgkmkwm$art_i]%>';
        for (var $art_iwgkmkwm$art_i = 0, $art_objfoytewmht$art_obj = item.subs, $art_cbimuocpzg$art_c = $art_objfoytewmht$art_obj.length; $art_iwgkmkwm$art_i < $art_cbimuocpzg$art_c; $art_iwgkmkwm$art_i++) {
            var sub = $art_objfoytewmht$art_obj[$art_iwgkmkwm$art_i];
