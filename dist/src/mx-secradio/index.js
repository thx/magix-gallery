...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cuqmloktlt$art_c = list.length; itemIndex < $art_cuqmloktlt$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cuqmloktlt$art_c = list.length; itemIndex < $art_cuqmloktlt$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iorqrxkrocl$art_i = 0, $art_objezfxiieb$art_obj = item.subs, $art_cxdcpxkmb$art_c = $art_objezfxiieb$art_obj.length; $art_iorqrxkrocl$art_i < $art_cxdcpxkmb$art_c; $art_iorqrxkrocl$art_i++) {        var sub = $art_objezfxiieb$art_obj[$art_iorqrxkrocl$art_i]%>';
        for (var $art_iorqrxkrocl$art_i = 0, $art_objezfxiieb$art_obj = item.subs, $art_cxdcpxkmb$art_c = $art_objezfxiieb$art_obj.length; $art_iorqrxkrocl$art_i < $art_cxdcpxkmb$art_c; $art_iorqrxkrocl$art_i++) {
            var sub = $art_objezfxiieb$art_obj[$art_iorqrxkrocl$art_i];
