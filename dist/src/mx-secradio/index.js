...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ctkfoid$art_c = list.length; itemIndex < $art_ctkfoid$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ctkfoid$art_c = list.length; itemIndex < $art_ctkfoid$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iarqstsfgvj$art_i = 0, $art_objzkapgyuzh$art_obj = item.subs, $art_cngycsgo$art_c = $art_objzkapgyuzh$art_obj.length; $art_iarqstsfgvj$art_i < $art_cngycsgo$art_c; $art_iarqstsfgvj$art_i++) {        var sub = $art_objzkapgyuzh$art_obj[$art_iarqstsfgvj$art_i]%>';
        for (var $art_iarqstsfgvj$art_i = 0, $art_objzkapgyuzh$art_obj = item.subs, $art_cngycsgo$art_c = $art_objzkapgyuzh$art_obj.length; $art_iarqstsfgvj$art_i < $art_cngycsgo$art_c; $art_iarqstsfgvj$art_i++) {
            var sub = $art_objzkapgyuzh$art_obj[$art_iarqstsfgvj$art_i];
