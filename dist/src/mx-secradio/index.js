...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cmrzrirbo$art_c = list.length; itemIndex < $art_cmrzrirbo$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cmrzrirbo$art_c = list.length; itemIndex < $art_cmrzrirbo$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_icvomtgtcjb$art_i = 0, $art_objoywjtrj$art_obj = item.subs, $art_cfwkcgdkh$art_c = $art_objoywjtrj$art_obj.length; $art_icvomtgtcjb$art_i < $art_cfwkcgdkh$art_c; $art_icvomtgtcjb$art_i++) {        var sub = $art_objoywjtrj$art_obj[$art_icvomtgtcjb$art_i]%>';
        for (var $art_icvomtgtcjb$art_i = 0, $art_objoywjtrj$art_obj = item.subs, $art_cfwkcgdkh$art_c = $art_objoywjtrj$art_obj.length; $art_icvomtgtcjb$art_i < $art_cfwkcgdkh$art_c; $art_icvomtgtcjb$art_i++) {
            var sub = $art_objoywjtrj$art_obj[$art_icvomtgtcjb$art_i];
