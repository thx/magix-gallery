...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cexqehpann$art_c = list.length; itemIndex < $art_cexqehpann$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cexqehpann$art_c = list.length; itemIndex < $art_cexqehpann$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igsjbvrbf$art_i = 0, $art_objchjoceyxuh$art_obj = item.subs, $art_cdcmsmnnpo$art_c = $art_objchjoceyxuh$art_obj.length; $art_igsjbvrbf$art_i < $art_cdcmsmnnpo$art_c; $art_igsjbvrbf$art_i++) {        var sub = $art_objchjoceyxuh$art_obj[$art_igsjbvrbf$art_i]%>';
        for (var $art_igsjbvrbf$art_i = 0, $art_objchjoceyxuh$art_obj = item.subs, $art_cdcmsmnnpo$art_c = $art_objchjoceyxuh$art_obj.length; $art_igsjbvrbf$art_i < $art_cdcmsmnnpo$art_c; $art_igsjbvrbf$art_i++) {
            var sub = $art_objchjoceyxuh$art_obj[$art_igsjbvrbf$art_i];
