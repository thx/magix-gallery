...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_caqjitpvu$art_c = list.length; itemIndex < $art_caqjitpvu$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_caqjitpvu$art_c = list.length; itemIndex < $art_caqjitpvu$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iibwbqakha$art_i = 0, $art_objqtrvktif$art_obj = item.subs, $art_czxfgq$art_c = $art_objqtrvktif$art_obj.length; $art_iibwbqakha$art_i < $art_czxfgq$art_c; $art_iibwbqakha$art_i++) {        var sub = $art_objqtrvktif$art_obj[$art_iibwbqakha$art_i]%>';
        for (var $art_iibwbqakha$art_i = 0, $art_objqtrvktif$art_obj = item.subs, $art_czxfgq$art_c = $art_objqtrvktif$art_obj.length; $art_iibwbqakha$art_i < $art_czxfgq$art_c; $art_iibwbqakha$art_i++) {
            var sub = $art_objqtrvktif$art_obj[$art_iibwbqakha$art_i];
