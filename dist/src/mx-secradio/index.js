...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_czspcxwpra$art_c = list.length; itemIndex < $art_czspcxwpra$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_czspcxwpra$art_c = list.length; itemIndex < $art_czspcxwpra$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_isgktpso$art_i = 0, $art_objduidszmbjt$art_obj = item.subs, $art_cocsqtjena$art_c = $art_objduidszmbjt$art_obj.length; $art_isgktpso$art_i < $art_cocsqtjena$art_c; $art_isgktpso$art_i++) {        var sub = $art_objduidszmbjt$art_obj[$art_isgktpso$art_i]%>';
        for (var $art_isgktpso$art_i = 0, $art_objduidszmbjt$art_obj = item.subs, $art_cocsqtjena$art_c = $art_objduidszmbjt$art_obj.length; $art_isgktpso$art_i < $art_cocsqtjena$art_c; $art_isgktpso$art_i++) {
            var sub = $art_objduidszmbjt$art_obj[$art_isgktpso$art_i];
