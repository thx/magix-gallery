...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_crvoczdha$art_c = list.length; itemIndex < $art_crvoczdha$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_crvoczdha$art_c = list.length; itemIndex < $art_crvoczdha$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieapynpnhb$art_i = 0, $art_objnwnaxlqi$art_obj = item.subs, $art_cdbqoqh$art_c = $art_objnwnaxlqi$art_obj.length; $art_ieapynpnhb$art_i < $art_cdbqoqh$art_c; $art_ieapynpnhb$art_i++) {        var sub = $art_objnwnaxlqi$art_obj[$art_ieapynpnhb$art_i]%>';
        for (var $art_ieapynpnhb$art_i = 0, $art_objnwnaxlqi$art_obj = item.subs, $art_cdbqoqh$art_c = $art_objnwnaxlqi$art_obj.length; $art_ieapynpnhb$art_i < $art_cdbqoqh$art_c; $art_ieapynpnhb$art_i++) {
            var sub = $art_objnwnaxlqi$art_obj[$art_ieapynpnhb$art_i];
