...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cznbmov$art_c = list.length; itemIndex < $art_cznbmov$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cznbmov$art_c = list.length; itemIndex < $art_cznbmov$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iwjbzthsh$art_i = 0, $art_objenuqjbd$art_obj = item.subs, $art_cfnrvap$art_c = $art_objenuqjbd$art_obj.length; $art_iwjbzthsh$art_i < $art_cfnrvap$art_c; $art_iwjbzthsh$art_i++) {        var sub = $art_objenuqjbd$art_obj[$art_iwjbzthsh$art_i]%>';
        for (var $art_iwjbzthsh$art_i = 0, $art_objenuqjbd$art_obj = item.subs, $art_cfnrvap$art_c = $art_objenuqjbd$art_obj.length; $art_iwjbzthsh$art_i < $art_cfnrvap$art_c; $art_iwjbzthsh$art_i++) {
            var sub = $art_objenuqjbd$art_obj[$art_iwjbzthsh$art_i];
