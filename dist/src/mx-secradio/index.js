...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_carahwvcybc$art_c = list.length; itemIndex < $art_carahwvcybc$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_carahwvcybc$art_c = list.length; itemIndex < $art_carahwvcybc$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibjkbudml$art_i = 0, $art_objijythqgg$art_obj = item.subs, $art_cgysqexjkm$art_c = $art_objijythqgg$art_obj.length; $art_ibjkbudml$art_i < $art_cgysqexjkm$art_c; $art_ibjkbudml$art_i++) {        var sub = $art_objijythqgg$art_obj[$art_ibjkbudml$art_i]%>';
        for (var $art_ibjkbudml$art_i = 0, $art_objijythqgg$art_obj = item.subs, $art_cgysqexjkm$art_c = $art_objijythqgg$art_obj.length; $art_ibjkbudml$art_i < $art_cgysqexjkm$art_c; $art_ibjkbudml$art_i++) {
            var sub = $art_objijythqgg$art_obj[$art_ibjkbudml$art_i];
