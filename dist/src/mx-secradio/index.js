...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_chulcqhpx$art_c = list.length; itemIndex < $art_chulcqhpx$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_chulcqhpx$art_c = list.length; itemIndex < $art_chulcqhpx$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilkxjtce$art_i = 0, $art_objrwxzjtb$art_obj = item.subs, $art_cnmqshwdn$art_c = $art_objrwxzjtb$art_obj.length; $art_ilkxjtce$art_i < $art_cnmqshwdn$art_c; $art_ilkxjtce$art_i++) {        var sub = $art_objrwxzjtb$art_obj[$art_ilkxjtce$art_i]%>';
        for (var $art_ilkxjtce$art_i = 0, $art_objrwxzjtb$art_obj = item.subs, $art_cnmqshwdn$art_c = $art_objrwxzjtb$art_obj.length; $art_ilkxjtce$art_i < $art_cnmqshwdn$art_c; $art_ilkxjtce$art_i++) {
            var sub = $art_objrwxzjtb$art_obj[$art_ilkxjtce$art_i];
