...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cwdhvsca$art_c = list.length; itemIndex < $art_cwdhvsca$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cwdhvsca$art_c = list.length; itemIndex < $art_cwdhvsca$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ievkwpccy$art_i = 0, $art_objqwyfioi$art_obj = item.subs, $art_codjakqqm$art_c = $art_objqwyfioi$art_obj.length; $art_ievkwpccy$art_i < $art_codjakqqm$art_c; $art_ievkwpccy$art_i++) {        var sub = $art_objqwyfioi$art_obj[$art_ievkwpccy$art_i]%>';
        for (var $art_ievkwpccy$art_i = 0, $art_objqwyfioi$art_obj = item.subs, $art_codjakqqm$art_c = $art_objqwyfioi$art_obj.length; $art_ievkwpccy$art_i < $art_codjakqqm$art_c; $art_ievkwpccy$art_i++) {
            var sub = $art_objqwyfioi$art_obj[$art_ievkwpccy$art_i];
