...
module.exports = Magix.View.extend({
    ...
    if (needExpand) {
        ;
        $p += '<div mxa="_zs_galleryd1:_" class="_zs_gallery_mx-secradio_index_-line _zs_gallery_mx-secradio_index_-all" mx-click="' + $viewId + '@{toggleAll}()">';
        $line = 3;
        $art = 'if close';
        ;
        $expr = '<%if (close) {%>';
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cxaggio$art_c = list.length; itemIndex < $art_cxaggio$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cxaggio$art_c = list.length; itemIndex < $art_cxaggio$art_c; itemIndex++) {
        var item = list[itemIndex];
        $p += '<div mxa="_zs_galleryd1:a" class="_zs_gallery_mx-secradio_index_-line"><label mx-click="' + $viewId + '@{toggleOne}({index:';
        $line = 9;
        $art = '=itemIndex';
        ;
        ...
        if (needExpand) {
            ;
            $p += '<i mxa="_zs_galleryd1:b" class="mc-iconfont _zs_gallery_mx-secradio_index_-oper">';
            $line = 12;
            $art = 'if item.close';
            ;
            $expr = '<%if (item.close) {%>';
        ...
        ;
        $expr = '<%for (var $art_ibspumaqmbk$art_i = 0, $art_objzeagrehm$art_obj = item.subs, $art_cyoftvsux$art_c = $art_objzeagrehm$art_obj.length; $art_ibspumaqmbk$art_i < $art_cyoftvsux$art_c; $art_ibspumaqmbk$art_i++) {        var sub = $art_objzeagrehm$art_obj[$art_ibspumaqmbk$art_i]%>';
        for (var $art_ibspumaqmbk$art_i = 0, $art_objzeagrehm$art_obj = item.subs, $art_cyoftvsux$art_c = $art_objzeagrehm$art_obj.length; $art_ibspumaqmbk$art_i < $art_cyoftvsux$art_c; $art_ibspumaqmbk$art_i++) {
            var sub = $art_objzeagrehm$art_obj[$art_ibspumaqmbk$art_i];
