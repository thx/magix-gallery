...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cjxbkz$art_c = list.length; itemIndex < $art_cjxbkz$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cjxbkz$art_c = list.length; itemIndex < $art_cjxbkz$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iyekkcu$art_i = 0, $art_objqqjwwkgpwm$art_obj = item.subs, $art_cckydnhddu$art_c = $art_objqqjwwkgpwm$art_obj.length; $art_iyekkcu$art_i < $art_cckydnhddu$art_c; $art_iyekkcu$art_i++) {        var sub = $art_objqqjwwkgpwm$art_obj[$art_iyekkcu$art_i]%>';
        for (var $art_iyekkcu$art_i = 0, $art_objqqjwwkgpwm$art_obj = item.subs, $art_cckydnhddu$art_c = $art_objqqjwwkgpwm$art_obj.length; $art_iyekkcu$art_i < $art_cckydnhddu$art_c; $art_iyekkcu$art_i++) {
            var sub = $art_objqqjwwkgpwm$art_obj[$art_iyekkcu$art_i];
