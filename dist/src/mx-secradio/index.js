...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ctwgegetyr$art_c = list.length; itemIndex < $art_ctwgegetyr$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ctwgegetyr$art_c = list.length; itemIndex < $art_ctwgegetyr$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivflsszayjc$art_i = 0, $art_objiitvinoa$art_obj = item.subs, $art_cqpuabwoe$art_c = $art_objiitvinoa$art_obj.length; $art_ivflsszayjc$art_i < $art_cqpuabwoe$art_c; $art_ivflsszayjc$art_i++) {        var sub = $art_objiitvinoa$art_obj[$art_ivflsszayjc$art_i]%>';
        for (var $art_ivflsszayjc$art_i = 0, $art_objiitvinoa$art_obj = item.subs, $art_cqpuabwoe$art_c = $art_objiitvinoa$art_obj.length; $art_ivflsszayjc$art_i < $art_cqpuabwoe$art_c; $art_ivflsszayjc$art_i++) {
            var sub = $art_objiitvinoa$art_obj[$art_ivflsszayjc$art_i];
