...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cgajgmj$art_c = list.length; itemIndex < $art_cgajgmj$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cgajgmj$art_c = list.length; itemIndex < $art_cgajgmj$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ineatd$art_i = 0, $art_objyurxumqakg$art_obj = item.subs, $art_ccuphnq$art_c = $art_objyurxumqakg$art_obj.length; $art_ineatd$art_i < $art_ccuphnq$art_c; $art_ineatd$art_i++) {        var sub = $art_objyurxumqakg$art_obj[$art_ineatd$art_i]%>';
        for (var $art_ineatd$art_i = 0, $art_objyurxumqakg$art_obj = item.subs, $art_ccuphnq$art_c = $art_objyurxumqakg$art_obj.length; $art_ineatd$art_i < $art_ccuphnq$art_c; $art_ineatd$art_i++) {
            var sub = $art_objyurxumqakg$art_obj[$art_ineatd$art_i];
