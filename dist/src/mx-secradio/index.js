...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cyrpcamzqyc$art_c = list.length; itemIndex < $art_cyrpcamzqyc$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cyrpcamzqyc$art_c = list.length; itemIndex < $art_cyrpcamzqyc$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ikkltlolu$art_i = 0, $art_objkvjelckn$art_obj = item.subs, $art_crbwstjjt$art_c = $art_objkvjelckn$art_obj.length; $art_ikkltlolu$art_i < $art_crbwstjjt$art_c; $art_ikkltlolu$art_i++) {        var sub = $art_objkvjelckn$art_obj[$art_ikkltlolu$art_i]%>';
        for (var $art_ikkltlolu$art_i = 0, $art_objkvjelckn$art_obj = item.subs, $art_crbwstjjt$art_c = $art_objkvjelckn$art_obj.length; $art_ikkltlolu$art_i < $art_crbwstjjt$art_c; $art_ikkltlolu$art_i++) {
            var sub = $art_objkvjelckn$art_obj[$art_ikkltlolu$art_i];
