...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cstbwpxmtf$art_c = list.length; itemIndex < $art_cstbwpxmtf$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cstbwpxmtf$art_c = list.length; itemIndex < $art_cstbwpxmtf$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_isrtbxmfsbb$art_i = 0, $art_objmyxczv$art_obj = item.subs, $art_cvohokl$art_c = $art_objmyxczv$art_obj.length; $art_isrtbxmfsbb$art_i < $art_cvohokl$art_c; $art_isrtbxmfsbb$art_i++) {        var sub = $art_objmyxczv$art_obj[$art_isrtbxmfsbb$art_i]%>';
        for (var $art_isrtbxmfsbb$art_i = 0, $art_objmyxczv$art_obj = item.subs, $art_cvohokl$art_c = $art_objmyxczv$art_obj.length; $art_isrtbxmfsbb$art_i < $art_cvohokl$art_c; $art_isrtbxmfsbb$art_i++) {
            var sub = $art_objmyxczv$art_obj[$art_isrtbxmfsbb$art_i];
