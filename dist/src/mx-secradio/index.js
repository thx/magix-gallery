...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqfwnuuto$art_c = list.length; itemIndex < $art_cqfwnuuto$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqfwnuuto$art_c = list.length; itemIndex < $art_cqfwnuuto$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idkjsrsn$art_i = 0, $art_objjhorrfkeai$art_obj = item.subs, $art_cqcbecnlg$art_c = $art_objjhorrfkeai$art_obj.length; $art_idkjsrsn$art_i < $art_cqcbecnlg$art_c; $art_idkjsrsn$art_i++) {        var sub = $art_objjhorrfkeai$art_obj[$art_idkjsrsn$art_i]%>';
        for (var $art_idkjsrsn$art_i = 0, $art_objjhorrfkeai$art_obj = item.subs, $art_cqcbecnlg$art_c = $art_objjhorrfkeai$art_obj.length; $art_idkjsrsn$art_i < $art_cqcbecnlg$art_c; $art_idkjsrsn$art_i++) {
            var sub = $art_objjhorrfkeai$art_obj[$art_idkjsrsn$art_i];
