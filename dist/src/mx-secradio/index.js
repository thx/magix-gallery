...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cvblau$art_c = list.length; itemIndex < $art_cvblau$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cvblau$art_c = list.length; itemIndex < $art_cvblau$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieajilkiig$art_i = 0, $art_objeuibep$art_obj = item.subs, $art_ctqtunjmxsmf$art_c = $art_objeuibep$art_obj.length; $art_ieajilkiig$art_i < $art_ctqtunjmxsmf$art_c; $art_ieajilkiig$art_i++) {        var sub = $art_objeuibep$art_obj[$art_ieajilkiig$art_i]%>';
        for (var $art_ieajilkiig$art_i = 0, $art_objeuibep$art_obj = item.subs, $art_ctqtunjmxsmf$art_c = $art_objeuibep$art_obj.length; $art_ieajilkiig$art_i < $art_ctqtunjmxsmf$art_c; $art_ieajilkiig$art_i++) {
            var sub = $art_objeuibep$art_obj[$art_ieajilkiig$art_i];
