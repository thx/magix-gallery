...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cpowsdl$art_c = list.length; itemIndex < $art_cpowsdl$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cpowsdl$art_c = list.length; itemIndex < $art_cpowsdl$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iwjedb$art_i = 0, $art_objjtviht$art_obj = item.subs, $art_cjscdnsqpa$art_c = $art_objjtviht$art_obj.length; $art_iwjedb$art_i < $art_cjscdnsqpa$art_c; $art_iwjedb$art_i++) {        var sub = $art_objjtviht$art_obj[$art_iwjedb$art_i]%>';
        for (var $art_iwjedb$art_i = 0, $art_objjtviht$art_obj = item.subs, $art_cjscdnsqpa$art_c = $art_objjtviht$art_obj.length; $art_iwjedb$art_i < $art_cjscdnsqpa$art_c; $art_iwjedb$art_i++) {
            var sub = $art_objjtviht$art_obj[$art_iwjedb$art_i];
