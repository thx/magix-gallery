...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_czfhmqrou$art_c = list.length; itemIndex < $art_czfhmqrou$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_czfhmqrou$art_c = list.length; itemIndex < $art_czfhmqrou$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipyfrnwz$art_i = 0, $art_objhwqeryc$art_obj = item.subs, $art_cfvnxtlyr$art_c = $art_objhwqeryc$art_obj.length; $art_ipyfrnwz$art_i < $art_cfvnxtlyr$art_c; $art_ipyfrnwz$art_i++) {        var sub = $art_objhwqeryc$art_obj[$art_ipyfrnwz$art_i]%>';
        for (var $art_ipyfrnwz$art_i = 0, $art_objhwqeryc$art_obj = item.subs, $art_cfvnxtlyr$art_c = $art_objhwqeryc$art_obj.length; $art_ipyfrnwz$art_i < $art_cfvnxtlyr$art_c; $art_ipyfrnwz$art_i++) {
            var sub = $art_objhwqeryc$art_obj[$art_ipyfrnwz$art_i];
