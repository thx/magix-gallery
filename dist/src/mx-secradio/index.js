...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ccizkaoq$art_c = list.length; itemIndex < $art_ccizkaoq$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ccizkaoq$art_c = list.length; itemIndex < $art_ccizkaoq$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_imprucwup$art_i = 0, $art_objkebncfx$art_obj = item.subs, $art_cumcdyhvt$art_c = $art_objkebncfx$art_obj.length; $art_imprucwup$art_i < $art_cumcdyhvt$art_c; $art_imprucwup$art_i++) {        var sub = $art_objkebncfx$art_obj[$art_imprucwup$art_i]%>';
        for (var $art_imprucwup$art_i = 0, $art_objkebncfx$art_obj = item.subs, $art_cumcdyhvt$art_c = $art_objkebncfx$art_obj.length; $art_imprucwup$art_i < $art_cumcdyhvt$art_c; $art_imprucwup$art_i++) {
            var sub = $art_objkebncfx$art_obj[$art_imprucwup$art_i];
