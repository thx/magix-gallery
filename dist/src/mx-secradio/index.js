...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cgnzwexerr$art_c = list.length; itemIndex < $art_cgnzwexerr$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cgnzwexerr$art_c = list.length; itemIndex < $art_cgnzwexerr$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iumwzfbka$art_i = 0, $art_objyaihvrt$art_obj = item.subs, $art_cbnjizk$art_c = $art_objyaihvrt$art_obj.length; $art_iumwzfbka$art_i < $art_cbnjizk$art_c; $art_iumwzfbka$art_i++) {        var sub = $art_objyaihvrt$art_obj[$art_iumwzfbka$art_i]%>';
        for (var $art_iumwzfbka$art_i = 0, $art_objyaihvrt$art_obj = item.subs, $art_cbnjizk$art_c = $art_objyaihvrt$art_obj.length; $art_iumwzfbka$art_i < $art_cbnjizk$art_c; $art_iumwzfbka$art_i++) {
            var sub = $art_objyaihvrt$art_obj[$art_iumwzfbka$art_i];
