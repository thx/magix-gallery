...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_chcuqtiiii$art_c = list.length; itemIndex < $art_chcuqtiiii$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_chcuqtiiii$art_c = list.length; itemIndex < $art_chcuqtiiii$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieiscgjv$art_i = 0, $art_objorfrzqgckyn$art_obj = item.subs, $art_culiovcjh$art_c = $art_objorfrzqgckyn$art_obj.length; $art_ieiscgjv$art_i < $art_culiovcjh$art_c; $art_ieiscgjv$art_i++) {        var sub = $art_objorfrzqgckyn$art_obj[$art_ieiscgjv$art_i]%>';
        for (var $art_ieiscgjv$art_i = 0, $art_objorfrzqgckyn$art_obj = item.subs, $art_culiovcjh$art_c = $art_objorfrzqgckyn$art_obj.length; $art_ieiscgjv$art_i < $art_culiovcjh$art_c; $art_ieiscgjv$art_i++) {
            var sub = $art_objorfrzqgckyn$art_obj[$art_ieiscgjv$art_i];
