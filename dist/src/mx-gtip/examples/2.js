...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycN:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxs="_zs_gallerycN:d" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div class="mb20"><span class="color-9">以下示例：</span>gtip(msg [, options])，singleton = false</div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show1()" class="link-brand">error提示，手动关闭</a></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show2()" class="link-brand">warn提示，手动关闭</a></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show3()" class="link-brand">highlight提示，手动关闭</a></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show4()" class="link-brand">pass提示，手动关闭</a></div></div><div mxa="_zs_gallerycN:f" class="clearfix"><div mxa="_zs_gallerycN:g" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_gallerycN:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 23;
    $art = '=viewId';
    ;
