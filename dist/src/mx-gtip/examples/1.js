...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycN:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxs="_zs_gallerycN:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div class="mb20"><div class="mb10"><span class="color-9">以下示例：</span>使用gtip(msg [, options])，<span class="color-brand">只保留一个实例</span></div><pre>\n{\n    msg: \'提示内容\',\n    options: {\n        timeout: \'延时自动关闭，设置的时候timeout后自动关闭，不设置的时候显示关闭按钮手动关闭\', \n        type: \'error：红色错误类型提示；warn：黄色警告类型提示；highlight：品牌色图标强调提示；common：默认黑底透明度提示\',\n        styles: { //驼峰，直接覆盖样式，默认内容如下：\n            position: \'fixed\',\n            top: \'0px\',\n            left: \'0px\',\n            width: \'100%\'  \n        },\n        singleton: 是否为单实例，默认true，singleton=false的可与其他gtip共存，否则当前view只有一个gtip\n    }\n}\n            </pre></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show1()" class="link-brand">默认顶通，手动关闭</a></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show2()" class="link-brand">error顶通（错误提示），手动关闭</a></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show3()" class="link-brand">warn顶通（警告），1s自动关闭</a></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show4()" class="link-brand">highlight顶通（品牌色强调），手动关闭</a></div><div class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'show5()" class="link-brand">pass顶通（绿色提示），手动关闭</a></div></div><div mxa="_zs_gallerycN:a" class="clearfix"><div mxa="_zs_gallerycN:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-third1"><div mxs="_zs_gallerycN:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 41;
    $art = '=viewId';
    ;
