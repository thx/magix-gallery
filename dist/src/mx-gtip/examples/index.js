...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_galleryc1:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'单实例\',\n            key: viewId + \'_demo1\'\n        }, {\n            name: \'多实例\',\n            key: viewId + \'_demo2\'\n        }, {\n            name: \'快捷使用\',\n            key: viewId + \'_demo3\'\n        }]\n    }, {\n        name: \'Methods\',\n        key: viewId + \'_method\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryc1:a" class="clearfix mb20"><div mx-view="mx-gtip/examples/1" id="';
    $line = 21;
    $art = '=viewId';
    ;
