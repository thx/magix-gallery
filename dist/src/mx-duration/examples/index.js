/*
    ...
    loader: cmd_es
 */
define("mx-duration/examples/index",["magix","$","examples/subs","mx-title/second","./1","./2","examples/api"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerybt:a" class="clearfix mb20"><div mx-view="mx-duration/examples/1" id="';
    $line = 18;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mx-view="mx-duration/examples/2" id="';
    $line = 19;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-duration/examples/index.html';
    throw msg;
} return $p; },
    render: function () {
        var options = [{
