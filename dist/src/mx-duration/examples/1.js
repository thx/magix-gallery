...
module.exports = Base.extend({
    ...
    if (ok) {
        ...
        ;
        $p += '<span mxs="_zs_gallerybz:b" class="color-red">请至少选择一个时段</span>';
        $line = 17;
        $art = '/if';
        ;
        $expr = '<%}%>';
