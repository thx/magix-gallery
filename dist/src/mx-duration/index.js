...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibhukbqdlk$art_i = 0, $art_cwpqwuq$art_c = weeks.length; $art_ibhukbqdlk$art_i < $art_cwpqwuq$art_c; $art_ibhukbqdlk$art_i++) {    var week = weeks[$art_ibhukbqdlk$art_i]%>';
    for (var $art_ibhukbqdlk$art_i = 0, $art_cwpqwuq$art_c = weeks.length; $art_ibhukbqdlk$art_i < $art_cwpqwuq$art_c; $art_ibhukbqdlk$art_i++) {
        var week = weeks[$art_ibhukbqdlk$art_i];
    ...
    ;
    $expr = '<%for (var $art_iopqvjwke$art_i = 0, $art_cntcbcmcbn$art_c = ranges.length; $art_iopqvjwke$art_i < $art_cntcbcmcbn$art_c; $art_iopqvjwke$art_i++) {    var range = ranges[$art_iopqvjwke$art_i]%>';
    for (var $art_iopqvjwke$art_i = 0, $art_cntcbcmcbn$art_c = ranges.length; $art_iopqvjwke$art_i < $art_cntcbcmcbn$art_c; $art_iopqvjwke$art_i++) {
        var range = ranges[$art_iopqvjwke$art_i];
    ...
    ;
    $expr = '<%for (var $art_icldmgkr$art_i = 0, $art_cbfktvqmhs$art_c = boxZones.length; $art_icldmgkr$art_i < $art_cbfktvqmhs$art_c; $art_icldmgkr$art_i++) {    var zone = boxZones[$art_icldmgkr$art_i]%>';
    for (var $art_icldmgkr$art_i = 0, $art_cbfktvqmhs$art_c = boxZones.length; $art_icldmgkr$art_i < $art_cbfktvqmhs$art_c; $art_icldmgkr$art_i++) {
        var zone = boxZones[$art_icldmgkr$art_i];
