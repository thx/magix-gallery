...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imofyika$art_i = 0, $art_cqdvyxra$art_c = weeks.length; $art_imofyika$art_i < $art_cqdvyxra$art_c; $art_imofyika$art_i++) {    var week = weeks[$art_imofyika$art_i]%>';
    for (var $art_imofyika$art_i = 0, $art_cqdvyxra$art_c = weeks.length; $art_imofyika$art_i < $art_cqdvyxra$art_c; $art_imofyika$art_i++) {
        var week = weeks[$art_imofyika$art_i];
    ...
    ;
    $expr = '<%for (var $art_iiomyxhpy$art_i = 0, $art_crzzlvsf$art_c = ranges.length; $art_iiomyxhpy$art_i < $art_crzzlvsf$art_c; $art_iiomyxhpy$art_i++) {    var range = ranges[$art_iiomyxhpy$art_i]%>';
    for (var $art_iiomyxhpy$art_i = 0, $art_crzzlvsf$art_c = ranges.length; $art_iiomyxhpy$art_i < $art_crzzlvsf$art_c; $art_iiomyxhpy$art_i++) {
        var range = ranges[$art_iiomyxhpy$art_i];
    ...
    ;
    $expr = '<%for (var $art_izbsmctos$art_i = 0, $art_carfrqfie$art_c = boxZones.length; $art_izbsmctos$art_i < $art_carfrqfie$art_c; $art_izbsmctos$art_i++) {    var zone = boxZones[$art_izbsmctos$art_i]%>';
    for (var $art_izbsmctos$art_i = 0, $art_carfrqfie$art_c = boxZones.length; $art_izbsmctos$art_i < $art_carfrqfie$art_c; $art_izbsmctos$art_i++) {
        var zone = boxZones[$art_izbsmctos$art_i];
