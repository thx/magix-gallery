...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iryovwrlaf$art_i = 0, $art_cuncomytkge$art_c = weeks.length; $art_iryovwrlaf$art_i < $art_cuncomytkge$art_c; $art_iryovwrlaf$art_i++) {    var week = weeks[$art_iryovwrlaf$art_i]%>';
    for (var $art_iryovwrlaf$art_i = 0, $art_cuncomytkge$art_c = weeks.length; $art_iryovwrlaf$art_i < $art_cuncomytkge$art_c; $art_iryovwrlaf$art_i++) {
        var week = weeks[$art_iryovwrlaf$art_i];
    ...
    ;
    $expr = '<%for (var $art_irceblvwnef$art_i = 0, $art_cnsrtlqr$art_c = ranges.length; $art_irceblvwnef$art_i < $art_cnsrtlqr$art_c; $art_irceblvwnef$art_i++) {    var range = ranges[$art_irceblvwnef$art_i]%>';
    for (var $art_irceblvwnef$art_i = 0, $art_cnsrtlqr$art_c = ranges.length; $art_irceblvwnef$art_i < $art_cnsrtlqr$art_c; $art_irceblvwnef$art_i++) {
        var range = ranges[$art_irceblvwnef$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipnrqtvlxfaf$art_i = 0, $art_cygsmsyxv$art_c = boxZones.length; $art_ipnrqtvlxfaf$art_i < $art_cygsmsyxv$art_c; $art_ipnrqtvlxfaf$art_i++) {    var zone = boxZones[$art_ipnrqtvlxfaf$art_i]%>';
    for (var $art_ipnrqtvlxfaf$art_i = 0, $art_cygsmsyxv$art_c = boxZones.length; $art_ipnrqtvlxfaf$art_i < $art_cygsmsyxv$art_c; $art_ipnrqtvlxfaf$art_i++) {
        var zone = boxZones[$art_ipnrqtvlxfaf$art_i];
