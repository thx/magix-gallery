...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_issetjvwcz$art_i = 0, $art_cluxjsob$art_c = weeks.length; $art_issetjvwcz$art_i < $art_cluxjsob$art_c; $art_issetjvwcz$art_i++) {    var week = weeks[$art_issetjvwcz$art_i]%>';
    for (var $art_issetjvwcz$art_i = 0, $art_cluxjsob$art_c = weeks.length; $art_issetjvwcz$art_i < $art_cluxjsob$art_c; $art_issetjvwcz$art_i++) {
        var week = weeks[$art_issetjvwcz$art_i];
    ...
    ;
    $expr = '<%for (var $art_icdyunjwwl$art_i = 0, $art_cbbamifj$art_c = ranges.length; $art_icdyunjwwl$art_i < $art_cbbamifj$art_c; $art_icdyunjwwl$art_i++) {    var range = ranges[$art_icdyunjwwl$art_i]%>';
    for (var $art_icdyunjwwl$art_i = 0, $art_cbbamifj$art_c = ranges.length; $art_icdyunjwwl$art_i < $art_cbbamifj$art_c; $art_icdyunjwwl$art_i++) {
        var range = ranges[$art_icdyunjwwl$art_i];
    ...
    ;
    $expr = '<%for (var $art_iskiavdvb$art_i = 0, $art_cqfvcl$art_c = boxZones.length; $art_iskiavdvb$art_i < $art_cqfvcl$art_c; $art_iskiavdvb$art_i++) {    var zone = boxZones[$art_iskiavdvb$art_i]%>';
    for (var $art_iskiavdvb$art_i = 0, $art_cqfvcl$art_c = boxZones.length; $art_iskiavdvb$art_i < $art_cqfvcl$art_c; $art_iskiavdvb$art_i++) {
        var zone = boxZones[$art_iskiavdvb$art_i];
