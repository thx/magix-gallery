...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikpelwycm$art_i = 0, $art_ctzbcdz$art_c = weeks.length; $art_ikpelwycm$art_i < $art_ctzbcdz$art_c; $art_ikpelwycm$art_i++) {    var week = weeks[$art_ikpelwycm$art_i]%>';
    for (var $art_ikpelwycm$art_i = 0, $art_ctzbcdz$art_c = weeks.length; $art_ikpelwycm$art_i < $art_ctzbcdz$art_c; $art_ikpelwycm$art_i++) {
        var week = weeks[$art_ikpelwycm$art_i];
    ...
    ;
    $expr = '<%for (var $art_idhcfsl$art_i = 0, $art_ccesmyt$art_c = ranges.length; $art_idhcfsl$art_i < $art_ccesmyt$art_c; $art_idhcfsl$art_i++) {    var range = ranges[$art_idhcfsl$art_i]%>';
    for (var $art_idhcfsl$art_i = 0, $art_ccesmyt$art_c = ranges.length; $art_idhcfsl$art_i < $art_ccesmyt$art_c; $art_idhcfsl$art_i++) {
        var range = ranges[$art_idhcfsl$art_i];
    ...
    ;
    $expr = '<%for (var $art_igzafzraxmem$art_i = 0, $art_cuqpbnizosq$art_c = boxZones.length; $art_igzafzraxmem$art_i < $art_cuqpbnizosq$art_c; $art_igzafzraxmem$art_i++) {    var zone = boxZones[$art_igzafzraxmem$art_i]%>';
    for (var $art_igzafzraxmem$art_i = 0, $art_cuqpbnizosq$art_c = boxZones.length; $art_igzafzraxmem$art_i < $art_cuqpbnizosq$art_c; $art_igzafzraxmem$art_i++) {
        var zone = boxZones[$art_igzafzraxmem$art_i];
