...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irytqmh$art_i = 0, $art_cvuxgozj$art_c = weeks.length; $art_irytqmh$art_i < $art_cvuxgozj$art_c; $art_irytqmh$art_i++) {    var week = weeks[$art_irytqmh$art_i]%>';
    for (var $art_irytqmh$art_i = 0, $art_cvuxgozj$art_c = weeks.length; $art_irytqmh$art_i < $art_cvuxgozj$art_c; $art_irytqmh$art_i++) {
        var week = weeks[$art_irytqmh$art_i];
    ...
    ;
    $expr = '<%for (var $art_isiaejura$art_i = 0, $art_cbdscddd$art_c = ranges.length; $art_isiaejura$art_i < $art_cbdscddd$art_c; $art_isiaejura$art_i++) {    var range = ranges[$art_isiaejura$art_i]%>';
    for (var $art_isiaejura$art_i = 0, $art_cbdscddd$art_c = ranges.length; $art_isiaejura$art_i < $art_cbdscddd$art_c; $art_isiaejura$art_i++) {
        var range = ranges[$art_isiaejura$art_i];
    ...
    ;
    $expr = '<%for (var $art_iunxkzitgo$art_i = 0, $art_cnjhqoejeol$art_c = boxZones.length; $art_iunxkzitgo$art_i < $art_cnjhqoejeol$art_c; $art_iunxkzitgo$art_i++) {    var zone = boxZones[$art_iunxkzitgo$art_i]%>';
    for (var $art_iunxkzitgo$art_i = 0, $art_cnjhqoejeol$art_c = boxZones.length; $art_iunxkzitgo$art_i < $art_cnjhqoejeol$art_c; $art_iunxkzitgo$art_i++) {
        var zone = boxZones[$art_iunxkzitgo$art_i];
