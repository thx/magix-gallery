...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igeutpcpp$art_i = 0, $art_cmcdszthc$art_c = weeks.length; $art_igeutpcpp$art_i < $art_cmcdszthc$art_c; $art_igeutpcpp$art_i++) {    var week = weeks[$art_igeutpcpp$art_i]%>';
    for (var $art_igeutpcpp$art_i = 0, $art_cmcdszthc$art_c = weeks.length; $art_igeutpcpp$art_i < $art_cmcdszthc$art_c; $art_igeutpcpp$art_i++) {
        var week = weeks[$art_igeutpcpp$art_i];
    ...
    ;
    $expr = '<%for (var $art_igxpspac$art_i = 0, $art_cvkmauvmp$art_c = ranges.length; $art_igxpspac$art_i < $art_cvkmauvmp$art_c; $art_igxpspac$art_i++) {    var range = ranges[$art_igxpspac$art_i]%>';
    for (var $art_igxpspac$art_i = 0, $art_cvkmauvmp$art_c = ranges.length; $art_igxpspac$art_i < $art_cvkmauvmp$art_c; $art_igxpspac$art_i++) {
        var range = ranges[$art_igxpspac$art_i];
    ...
    ;
    $expr = '<%for (var $art_iksonalowfe$art_i = 0, $art_cgjlwfgsq$art_c = boxZones.length; $art_iksonalowfe$art_i < $art_cgjlwfgsq$art_c; $art_iksonalowfe$art_i++) {    var zone = boxZones[$art_iksonalowfe$art_i]%>';
    for (var $art_iksonalowfe$art_i = 0, $art_cgjlwfgsq$art_c = boxZones.length; $art_iksonalowfe$art_i < $art_cgjlwfgsq$art_c; $art_iksonalowfe$art_i++) {
        var zone = boxZones[$art_iksonalowfe$art_i];
