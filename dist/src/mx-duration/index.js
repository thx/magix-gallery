...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izmhqmpg$art_i = 0, $art_cgmszybrr$art_c = weeks.length; $art_izmhqmpg$art_i < $art_cgmszybrr$art_c; $art_izmhqmpg$art_i++) {    var week = weeks[$art_izmhqmpg$art_i]%>';
    for (var $art_izmhqmpg$art_i = 0, $art_cgmszybrr$art_c = weeks.length; $art_izmhqmpg$art_i < $art_cgmszybrr$art_c; $art_izmhqmpg$art_i++) {
        var week = weeks[$art_izmhqmpg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ioujeewtiq$art_i = 0, $art_cvtifkjng$art_c = ranges.length; $art_ioujeewtiq$art_i < $art_cvtifkjng$art_c; $art_ioujeewtiq$art_i++) {    var range = ranges[$art_ioujeewtiq$art_i]%>';
    for (var $art_ioujeewtiq$art_i = 0, $art_cvtifkjng$art_c = ranges.length; $art_ioujeewtiq$art_i < $art_cvtifkjng$art_c; $art_ioujeewtiq$art_i++) {
        var range = ranges[$art_ioujeewtiq$art_i];
    ...
    ;
    $expr = '<%for (var $art_ioolbtksz$art_i = 0, $art_chcxrwrpt$art_c = boxZones.length; $art_ioolbtksz$art_i < $art_chcxrwrpt$art_c; $art_ioolbtksz$art_i++) {    var zone = boxZones[$art_ioolbtksz$art_i]%>';
    for (var $art_ioolbtksz$art_i = 0, $art_chcxrwrpt$art_c = boxZones.length; $art_ioolbtksz$art_i < $art_chcxrwrpt$art_c; $art_ioolbtksz$art_i++) {
        var zone = boxZones[$art_ioolbtksz$art_i];
