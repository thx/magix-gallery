...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icdkkwkbg$art_i = 0, $art_cbsiizmao$art_c = weeks.length; $art_icdkkwkbg$art_i < $art_cbsiizmao$art_c; $art_icdkkwkbg$art_i++) {    var week = weeks[$art_icdkkwkbg$art_i]%>';
    for (var $art_icdkkwkbg$art_i = 0, $art_cbsiizmao$art_c = weeks.length; $art_icdkkwkbg$art_i < $art_cbsiizmao$art_c; $art_icdkkwkbg$art_i++) {
        var week = weeks[$art_icdkkwkbg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihgwptermw$art_i = 0, $art_cbucgtth$art_c = ranges.length; $art_ihgwptermw$art_i < $art_cbucgtth$art_c; $art_ihgwptermw$art_i++) {    var range = ranges[$art_ihgwptermw$art_i]%>';
    for (var $art_ihgwptermw$art_i = 0, $art_cbucgtth$art_c = ranges.length; $art_ihgwptermw$art_i < $art_cbucgtth$art_c; $art_ihgwptermw$art_i++) {
        var range = ranges[$art_ihgwptermw$art_i];
    ...
    ;
    $expr = '<%for (var $art_iybqvrrkl$art_i = 0, $art_crdgmprfm$art_c = boxZones.length; $art_iybqvrrkl$art_i < $art_crdgmprfm$art_c; $art_iybqvrrkl$art_i++) {    var zone = boxZones[$art_iybqvrrkl$art_i]%>';
    for (var $art_iybqvrrkl$art_i = 0, $art_crdgmprfm$art_c = boxZones.length; $art_iybqvrrkl$art_i < $art_crdgmprfm$art_c; $art_iybqvrrkl$art_i++) {
        var zone = boxZones[$art_iybqvrrkl$art_i];
