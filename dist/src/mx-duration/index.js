...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivdnnhhg$art_i = 0, $art_cvjsawog$art_c = weeks.length; $art_ivdnnhhg$art_i < $art_cvjsawog$art_c; $art_ivdnnhhg$art_i++) {    var week = weeks[$art_ivdnnhhg$art_i]%>';
    for (var $art_ivdnnhhg$art_i = 0, $art_cvjsawog$art_c = weeks.length; $art_ivdnnhhg$art_i < $art_cvjsawog$art_c; $art_ivdnnhhg$art_i++) {
        var week = weeks[$art_ivdnnhhg$art_i];
    ...
    ;
    $expr = '<%for (var $art_izignnmqb$art_i = 0, $art_ckbzofu$art_c = ranges.length; $art_izignnmqb$art_i < $art_ckbzofu$art_c; $art_izignnmqb$art_i++) {    var range = ranges[$art_izignnmqb$art_i]%>';
    for (var $art_izignnmqb$art_i = 0, $art_ckbzofu$art_c = ranges.length; $art_izignnmqb$art_i < $art_ckbzofu$art_c; $art_izignnmqb$art_i++) {
        var range = ranges[$art_izignnmqb$art_i];
    ...
    ;
    $expr = '<%for (var $art_igcivluho$art_i = 0, $art_cebovfuldwx$art_c = boxZones.length; $art_igcivluho$art_i < $art_cebovfuldwx$art_c; $art_igcivluho$art_i++) {    var zone = boxZones[$art_igcivluho$art_i]%>';
    for (var $art_igcivluho$art_i = 0, $art_cebovfuldwx$art_c = boxZones.length; $art_igcivluho$art_i < $art_cebovfuldwx$art_c; $art_igcivluho$art_i++) {
        var zone = boxZones[$art_igcivluho$art_i];
