...
module.exports = Magix.View.extend({
    ...
    if (hoverInfo.show) {
        ...
        $art = '=hoverInfo.left';
        ;
        $p += ($expr = '<%=hoverInfo.left%>', $e(hoverInfo.left)) + 'px;" class="_zs_gallery_mx-duration_index_-discount-hover mx-shadow"><div mxa="_zs_gallerybo:_" class="mb5">';
        $line = 6;
        $art = '=hoverInfo.week';
        ;
        $p += ($expr = '<%=hoverInfo.week%>', $e(hoverInfo.week)) + '</div><div mxa="_zs_gallerybo:a" class="mb5"><strong>';
        $line = 7;
        $art = '=hoverInfo.time';
        ;
    ...
    if (settingInfo.show) {
        ...
        ;
        $p += ($expr = '<%=settingInfo.left%>', $e(settingInfo.left)) + 'px;" class="_zs_gallery_mx-duration_index_-discount-setting mx-shadow"><div mxv mxa="_zs_gallerybo:b" class="_zs_gallery_mx-duration_index_-setting-content"><div mxa="_zs_gallerybo:c" class="mb10"><span>';
        $line = 24;
        $art = '=settingInfo.week';
        ;
        $p += ($expr = '<%=settingInfo.week%>', $e(settingInfo.week)) + '</span>：<strong mxa="_zs_gallerybo:d" class="ml5">';
        $line = 25;
        $art = '=settingInfo.time';
        ;
        $p += ($expr = '<%=settingInfo.time%>', $e(settingInfo.time)) + '</strong></div><div mxv mxa="_zs_gallerybo:e" class="mb5"><label mxv><input type="radio" class="radio" name="settingType" value="1" mx-change="' + $viewId + 'changeSettingType({type:1})" ';
        $line = 31;
        ...
        ;
        $p += '<span mxs="_zs_gallerybo:_" class="ml5">%</span></div><div mxv mxa="_zs_gallerybo:f" class="mb10"><label mxv><input type="radio" name="settingType" class="radio" value="2" mx-change="' + $viewId + 'changeSettingType({type:2})" ';
        $line = 48;
        ...
        ;
        $p += '/>无折扣</label></div><div mxv mxa="_zs_gallerybo:g" class="mb10"><label mxv><input type="radio" name="settingType" class="radio" value="3" mx-change="' + $viewId + 'changeSettingType({type:3})" ';
        $line = 55;
        ...
        ;
        $p += '/>不投放</label></div></div><div mxs="_zs_gallerybo:a" class="_zs_gallery_mx-duration_index_-setting-footer"><a class="btn btn-small btn-brand mr10 w60" href="javascript:;" mx-click="' + $viewId + 'submitSetting()">确定</a><a class="btn btn-small w60" href="javascript:;" mx-click="' + $viewId + 'cancelSetting()">取消</a></div></div>';
        $line = 64;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    ;
    $expr = '<%for (var $art_irtfsjljfxjn$art_i = 0, $art_czxittkhg$art_c = weeks.length; $art_irtfsjljfxjn$art_i < $art_czxittkhg$art_c; $art_irtfsjljfxjn$art_i++) {    var week = weeks[$art_irtfsjljfxjn$art_i]%>';
    for (var $art_irtfsjljfxjn$art_i = 0, $art_czxittkhg$art_c = weeks.length; $art_irtfsjljfxjn$art_i < $art_czxittkhg$art_c; $art_irtfsjljfxjn$art_i++) {
        var week = weeks[$art_irtfsjljfxjn$art_i];
    ...
    $art = '=boxWidth*rowNum';
    ;
    $p += ($expr = '<%=boxWidth * rowNum%>', $e(boxWidth * rowNum)) + 'px;"><ul mxa="_zs_gallerybo:h" class="_zs_gallery_mx-duration_index_-range clearfix">';
    $line = 76;
    $art = 'each ranges as range';
    ;
    $expr = '<%for (var $art_ibrownipjxmf$art_i = 0, $art_cxebwwmye$art_c = ranges.length; $art_ibrownipjxmf$art_i < $art_cxebwwmye$art_c; $art_ibrownipjxmf$art_i++) {    var range = ranges[$art_ibrownipjxmf$art_i]%>';
    for (var $art_ibrownipjxmf$art_i = 0, $art_cxebwwmye$art_c = ranges.length; $art_ibrownipjxmf$art_i < $art_cxebwwmye$art_c; $art_ibrownipjxmf$art_i++) {
        var range = ranges[$art_ibrownipjxmf$art_i];
    ...
    ;
    $p += '</ul><ul mxa="_zs_gallerybo:i" class="_zs_gallery_mx-duration_index_-time clearfix">';
    $line = 81;
    ...
    ;
    $p += '</ul><ul mxa="_zs_gallerybo:j" class="_zs_gallery_mx-duration_index_-boxzone clearfix">';
    $line = 86;
    $art = 'each boxZones as zone';
    ;
    $expr = '<%for (var $art_ivijjjn$art_i = 0, $art_cbjzpyijcu$art_c = boxZones.length; $art_ivijjjn$art_i < $art_cbjzpyijcu$art_c; $art_ivijjjn$art_i++) {    var zone = boxZones[$art_ivijjjn$art_i]%>';
    for (var $art_ivijjjn$art_i = 0, $art_cbjzpyijcu$art_c = boxZones.length; $art_ivijjjn$art_i < $art_cbjzpyijcu$art_c; $art_ivijjjn$art_i++) {
        var zone = boxZones[$art_ivijjjn$art_i];
