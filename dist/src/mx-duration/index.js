...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idowgjc$art_i = 0, $art_cpgdakg$art_c = weeks.length; $art_idowgjc$art_i < $art_cpgdakg$art_c; $art_idowgjc$art_i++) {    var week = weeks[$art_idowgjc$art_i]%>';
    for (var $art_idowgjc$art_i = 0, $art_cpgdakg$art_c = weeks.length; $art_idowgjc$art_i < $art_cpgdakg$art_c; $art_idowgjc$art_i++) {
        var week = weeks[$art_idowgjc$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilyqyyabb$art_i = 0, $art_chfoajyt$art_c = ranges.length; $art_ilyqyyabb$art_i < $art_chfoajyt$art_c; $art_ilyqyyabb$art_i++) {    var range = ranges[$art_ilyqyyabb$art_i]%>';
    for (var $art_ilyqyyabb$art_i = 0, $art_chfoajyt$art_c = ranges.length; $art_ilyqyyabb$art_i < $art_chfoajyt$art_c; $art_ilyqyyabb$art_i++) {
        var range = ranges[$art_ilyqyyabb$art_i];
    ...
    ;
    $expr = '<%for (var $art_iefhnfvzqm$art_i = 0, $art_cakrhxtu$art_c = boxZones.length; $art_iefhnfvzqm$art_i < $art_cakrhxtu$art_c; $art_iefhnfvzqm$art_i++) {    var zone = boxZones[$art_iefhnfvzqm$art_i]%>';
    for (var $art_iefhnfvzqm$art_i = 0, $art_cakrhxtu$art_c = boxZones.length; $art_iefhnfvzqm$art_i < $art_cakrhxtu$art_c; $art_iefhnfvzqm$art_i++) {
        var zone = boxZones[$art_iefhnfvzqm$art_i];
