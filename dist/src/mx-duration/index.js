...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqeewnlbvi$art_i = 0, $art_cbtherk$art_c = weeks.length; $art_iqeewnlbvi$art_i < $art_cbtherk$art_c; $art_iqeewnlbvi$art_i++) {    var week = weeks[$art_iqeewnlbvi$art_i]%>';
    for (var $art_iqeewnlbvi$art_i = 0, $art_cbtherk$art_c = weeks.length; $art_iqeewnlbvi$art_i < $art_cbtherk$art_c; $art_iqeewnlbvi$art_i++) {
        var week = weeks[$art_iqeewnlbvi$art_i];
    ...
    ;
    $expr = '<%for (var $art_imwaixlu$art_i = 0, $art_cfojhicsn$art_c = ranges.length; $art_imwaixlu$art_i < $art_cfojhicsn$art_c; $art_imwaixlu$art_i++) {    var range = ranges[$art_imwaixlu$art_i]%>';
    for (var $art_imwaixlu$art_i = 0, $art_cfojhicsn$art_c = ranges.length; $art_imwaixlu$art_i < $art_cfojhicsn$art_c; $art_imwaixlu$art_i++) {
        var range = ranges[$art_imwaixlu$art_i];
    ...
    ;
    $expr = '<%for (var $art_iedmelww$art_i = 0, $art_cvbnuzvznrx$art_c = boxZones.length; $art_iedmelww$art_i < $art_cvbnuzvznrx$art_c; $art_iedmelww$art_i++) {    var zone = boxZones[$art_iedmelww$art_i]%>';
    for (var $art_iedmelww$art_i = 0, $art_cvbnuzvznrx$art_c = boxZones.length; $art_iedmelww$art_i < $art_cvbnuzvznrx$art_c; $art_iedmelww$art_i++) {
        var zone = boxZones[$art_iedmelww$art_i];
