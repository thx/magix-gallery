...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izymiszjoq$art_i = 0, $art_czdasmyjs$art_c = weeks.length; $art_izymiszjoq$art_i < $art_czdasmyjs$art_c; $art_izymiszjoq$art_i++) {    var week = weeks[$art_izymiszjoq$art_i]%>';
    for (var $art_izymiszjoq$art_i = 0, $art_czdasmyjs$art_c = weeks.length; $art_izymiszjoq$art_i < $art_czdasmyjs$art_c; $art_izymiszjoq$art_i++) {
        var week = weeks[$art_izymiszjoq$art_i];
    ...
    ;
    $expr = '<%for (var $art_iogvulen$art_i = 0, $art_cnasngeo$art_c = ranges.length; $art_iogvulen$art_i < $art_cnasngeo$art_c; $art_iogvulen$art_i++) {    var range = ranges[$art_iogvulen$art_i]%>';
    for (var $art_iogvulen$art_i = 0, $art_cnasngeo$art_c = ranges.length; $art_iogvulen$art_i < $art_cnasngeo$art_c; $art_iogvulen$art_i++) {
        var range = ranges[$art_iogvulen$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibtkseb$art_i = 0, $art_ckjwyats$art_c = boxZones.length; $art_ibtkseb$art_i < $art_ckjwyats$art_c; $art_ibtkseb$art_i++) {    var zone = boxZones[$art_ibtkseb$art_i]%>';
    for (var $art_ibtkseb$art_i = 0, $art_ckjwyats$art_c = boxZones.length; $art_ibtkseb$art_i < $art_ckjwyats$art_c; $art_ibtkseb$art_i++) {
        var zone = boxZones[$art_ibtkseb$art_i];
