...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imubzga$art_i = 0, $art_czoawuwzjxg$art_c = weeks.length; $art_imubzga$art_i < $art_czoawuwzjxg$art_c; $art_imubzga$art_i++) {    var week = weeks[$art_imubzga$art_i]%>';
    for (var $art_imubzga$art_i = 0, $art_czoawuwzjxg$art_c = weeks.length; $art_imubzga$art_i < $art_czoawuwzjxg$art_c; $art_imubzga$art_i++) {
        var week = weeks[$art_imubzga$art_i];
    ...
    ;
    $expr = '<%for (var $art_ijjpefnmi$art_i = 0, $art_cgmbous$art_c = ranges.length; $art_ijjpefnmi$art_i < $art_cgmbous$art_c; $art_ijjpefnmi$art_i++) {    var range = ranges[$art_ijjpefnmi$art_i]%>';
    for (var $art_ijjpefnmi$art_i = 0, $art_cgmbous$art_c = ranges.length; $art_ijjpefnmi$art_i < $art_cgmbous$art_c; $art_ijjpefnmi$art_i++) {
        var range = ranges[$art_ijjpefnmi$art_i];
    ...
    ;
    $expr = '<%for (var $art_iaygmvs$art_i = 0, $art_cvupesmw$art_c = boxZones.length; $art_iaygmvs$art_i < $art_cvupesmw$art_c; $art_iaygmvs$art_i++) {    var zone = boxZones[$art_iaygmvs$art_i]%>';
    for (var $art_iaygmvs$art_i = 0, $art_cvupesmw$art_c = boxZones.length; $art_iaygmvs$art_i < $art_cvupesmw$art_c; $art_iaygmvs$art_i++) {
        var zone = boxZones[$art_iaygmvs$art_i];
