...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwjmgrgkh$art_i = 0, $art_cakjmw$art_c = weeks.length; $art_iwjmgrgkh$art_i < $art_cakjmw$art_c; $art_iwjmgrgkh$art_i++) {    var week = weeks[$art_iwjmgrgkh$art_i]%>';
    for (var $art_iwjmgrgkh$art_i = 0, $art_cakjmw$art_c = weeks.length; $art_iwjmgrgkh$art_i < $art_cakjmw$art_c; $art_iwjmgrgkh$art_i++) {
        var week = weeks[$art_iwjmgrgkh$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixcladqh$art_i = 0, $art_cqncqqfp$art_c = ranges.length; $art_ixcladqh$art_i < $art_cqncqqfp$art_c; $art_ixcladqh$art_i++) {    var range = ranges[$art_ixcladqh$art_i]%>';
    for (var $art_ixcladqh$art_i = 0, $art_cqncqqfp$art_c = ranges.length; $art_ixcladqh$art_i < $art_cqncqqfp$art_c; $art_ixcladqh$art_i++) {
        var range = ranges[$art_ixcladqh$art_i];
    ...
    ;
    $expr = '<%for (var $art_izelmjfpx$art_i = 0, $art_ctqpuxbod$art_c = boxZones.length; $art_izelmjfpx$art_i < $art_ctqpuxbod$art_c; $art_izelmjfpx$art_i++) {    var zone = boxZones[$art_izelmjfpx$art_i]%>';
    for (var $art_izelmjfpx$art_i = 0, $art_ctqpuxbod$art_c = boxZones.length; $art_izelmjfpx$art_i < $art_ctqpuxbod$art_c; $art_izelmjfpx$art_i++) {
        var zone = boxZones[$art_izelmjfpx$art_i];
