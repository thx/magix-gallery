...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivqgmfruvwrr$art_i = 0, $art_cttwwdqbl$art_c = weeks.length; $art_ivqgmfruvwrr$art_i < $art_cttwwdqbl$art_c; $art_ivqgmfruvwrr$art_i++) {    var week = weeks[$art_ivqgmfruvwrr$art_i]%>';
    for (var $art_ivqgmfruvwrr$art_i = 0, $art_cttwwdqbl$art_c = weeks.length; $art_ivqgmfruvwrr$art_i < $art_cttwwdqbl$art_c; $art_ivqgmfruvwrr$art_i++) {
        var week = weeks[$art_ivqgmfruvwrr$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilxnysod$art_i = 0, $art_cdituqcvd$art_c = ranges.length; $art_ilxnysod$art_i < $art_cdituqcvd$art_c; $art_ilxnysod$art_i++) {    var range = ranges[$art_ilxnysod$art_i]%>';
    for (var $art_ilxnysod$art_i = 0, $art_cdituqcvd$art_c = ranges.length; $art_ilxnysod$art_i < $art_cdituqcvd$art_c; $art_ilxnysod$art_i++) {
        var range = ranges[$art_ilxnysod$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuivdkbqbb$art_i = 0, $art_ckqmosr$art_c = boxZones.length; $art_iuivdkbqbb$art_i < $art_ckqmosr$art_c; $art_iuivdkbqbb$art_i++) {    var zone = boxZones[$art_iuivdkbqbb$art_i]%>';
    for (var $art_iuivdkbqbb$art_i = 0, $art_ckqmosr$art_c = boxZones.length; $art_iuivdkbqbb$art_i < $art_ckqmosr$art_c; $art_iuivdkbqbb$art_i++) {
        var zone = boxZones[$art_iuivdkbqbb$art_i];
