...
module.exports = Magix.View.extend({
    ...
    $p += '<a mxs="_zs_galleryc5:_" href="javascript:;" class="mx-trigger _zs_gallery_mx-indics_index_-setting-show-btn" mx-click="' + $viewId + 'show()"><i class="mc-iconfont _zs_gallery_mx-indics_index_-setting-show-icon">&#xe731;</i></a><a mxa="_zs_galleryc5:_" href="javascript:;" class="mx-trigger _zs_gallery_mx-indics_index_-setting-switch-btn" mx-click="' + $viewId + 'toggleDefault()">';
    $line = 5;
    $art = '=data.map[data.type][\'label\']';
    ;
    $p += ($expr = '<%=data.map[data.type][\'label\']%>', $e(data.map[data.type]['label'])) + '<i mxs="_zs_galleryc5:a" class="mc-iconfont mx-trigger-arrow _zs_gallery_mx-indics_index_-setting-switch-icon">&#xe692;</i></a>';
}
catch (ex) {
