...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifmndavn$art_i = 0, $art_cnkissm$art_c = groups.length; $art_ifmndavn$art_i < $art_cnkissm$art_c; $art_ifmndavn$art_i++) {    var group = groups[$art_ifmndavn$art_i]%>';
    for (var $art_ifmndavn$art_i = 0, $art_cnkissm$art_c = groups.length; $art_ifmndavn$art_i < $art_cnkissm$art_c; $art_ifmndavn$art_i++) {
        var group = groups[$art_ifmndavn$art_i];
        ...
        ;
        $expr = '<%for (var $art_ifjtynhm$art_i = 0, $art_objipcodkdp$art_obj = group.fields, $art_cwedzviybd$art_c = $art_objipcodkdp$art_obj.length; $art_ifjtynhm$art_i < $art_cwedzviybd$art_c; $art_ifjtynhm$art_i++) {        var field = $art_objipcodkdp$art_obj[$art_ifjtynhm$art_i]%>';
        for (var $art_ifjtynhm$art_i = 0, $art_objipcodkdp$art_obj = group.fields, $art_cwedzviybd$art_c = $art_objipcodkdp$art_obj.length; $art_ifjtynhm$art_i < $art_cwedzviybd$art_c; $art_ifjtynhm$art_i++) {
            var field = $art_objipcodkdp$art_obj[$art_ifjtynhm$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ibidgvwaq$art_i = 0, $art_cdhsuxzof$art_c = selectedItems.length; $art_ibidgvwaq$art_i < $art_cdhsuxzof$art_c; $art_ibidgvwaq$art_i++) {        var s = selectedItems[$art_ibidgvwaq$art_i]%>';
        for (var $art_ibidgvwaq$art_i = 0, $art_cdhsuxzof$art_c = selectedItems.length; $art_ibidgvwaq$art_i < $art_cdhsuxzof$art_c; $art_ibidgvwaq$art_i++) {
            var s = selectedItems[$art_ibidgvwaq$art_i];
