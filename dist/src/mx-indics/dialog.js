...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iocncqkwk$art_i = 0, $art_cljgljr$art_c = groups.length; $art_iocncqkwk$art_i < $art_cljgljr$art_c; $art_iocncqkwk$art_i++) {    var group = groups[$art_iocncqkwk$art_i]%>';
    for (var $art_iocncqkwk$art_i = 0, $art_cljgljr$art_c = groups.length; $art_iocncqkwk$art_i < $art_cljgljr$art_c; $art_iocncqkwk$art_i++) {
        var group = groups[$art_iocncqkwk$art_i];
        ...
        ;
        $expr = '<%for (var $art_ivzdqwrfhrg$art_i = 0, $art_objuhqmwzn$art_obj = group.fields, $art_cbhclaynu$art_c = $art_objuhqmwzn$art_obj.length; $art_ivzdqwrfhrg$art_i < $art_cbhclaynu$art_c; $art_ivzdqwrfhrg$art_i++) {        var field = $art_objuhqmwzn$art_obj[$art_ivzdqwrfhrg$art_i]%>';
        for (var $art_ivzdqwrfhrg$art_i = 0, $art_objuhqmwzn$art_obj = group.fields, $art_cbhclaynu$art_c = $art_objuhqmwzn$art_obj.length; $art_ivzdqwrfhrg$art_i < $art_cbhclaynu$art_c; $art_ivzdqwrfhrg$art_i++) {
            var field = $art_objuhqmwzn$art_obj[$art_ivzdqwrfhrg$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ipfgircn$art_i = 0, $art_cnmikdye$art_c = selectedItems.length; $art_ipfgircn$art_i < $art_cnmikdye$art_c; $art_ipfgircn$art_i++) {        var s = selectedItems[$art_ipfgircn$art_i]%>';
        for (var $art_ipfgircn$art_i = 0, $art_cnmikdye$art_c = selectedItems.length; $art_ipfgircn$art_i < $art_cnmikdye$art_c; $art_ipfgircn$art_i++) {
            var s = selectedItems[$art_ipfgircn$art_i];
