...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inoyqcvnfs$art_i = 0, $art_cngncybsm$art_c = groups.length; $art_inoyqcvnfs$art_i < $art_cngncybsm$art_c; $art_inoyqcvnfs$art_i++) {    var group = groups[$art_inoyqcvnfs$art_i]%>';
    for (var $art_inoyqcvnfs$art_i = 0, $art_cngncybsm$art_c = groups.length; $art_inoyqcvnfs$art_i < $art_cngncybsm$art_c; $art_inoyqcvnfs$art_i++) {
        var group = groups[$art_inoyqcvnfs$art_i];
        ...
        ;
        $expr = '<%for (var $art_iaifbqlms$art_i = 0, $art_objzdoeuwi$art_obj = group.fields, $art_cxeafyasz$art_c = $art_objzdoeuwi$art_obj.length; $art_iaifbqlms$art_i < $art_cxeafyasz$art_c; $art_iaifbqlms$art_i++) {        var field = $art_objzdoeuwi$art_obj[$art_iaifbqlms$art_i]%>';
        for (var $art_iaifbqlms$art_i = 0, $art_objzdoeuwi$art_obj = group.fields, $art_cxeafyasz$art_c = $art_objzdoeuwi$art_obj.length; $art_iaifbqlms$art_i < $art_cxeafyasz$art_c; $art_iaifbqlms$art_i++) {
            var field = $art_objzdoeuwi$art_obj[$art_iaifbqlms$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_iizwbpcvo$art_i = 0, $art_cmbkrwise$art_c = selectedItems.length; $art_iizwbpcvo$art_i < $art_cmbkrwise$art_c; $art_iizwbpcvo$art_i++) {        var s = selectedItems[$art_iizwbpcvo$art_i]%>';
        for (var $art_iizwbpcvo$art_i = 0, $art_cmbkrwise$art_c = selectedItems.length; $art_iizwbpcvo$art_i < $art_cmbkrwise$art_c; $art_iizwbpcvo$art_i++) {
            var s = selectedItems[$art_iizwbpcvo$art_i];
