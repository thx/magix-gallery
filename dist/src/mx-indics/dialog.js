...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igdzzwhaugt$art_i = 0, $art_cdverkhzl$art_c = groups.length; $art_igdzzwhaugt$art_i < $art_cdverkhzl$art_c; $art_igdzzwhaugt$art_i++) {    var group = groups[$art_igdzzwhaugt$art_i]%>';
    for (var $art_igdzzwhaugt$art_i = 0, $art_cdverkhzl$art_c = groups.length; $art_igdzzwhaugt$art_i < $art_cdverkhzl$art_c; $art_igdzzwhaugt$art_i++) {
        var group = groups[$art_igdzzwhaugt$art_i];
        ...
        ;
        $expr = '<%for (var $art_imtphf$art_i = 0, $art_objzcsdfbgjhp$art_obj = group.fields, $art_cmysaavaps$art_c = $art_objzcsdfbgjhp$art_obj.length; $art_imtphf$art_i < $art_cmysaavaps$art_c; $art_imtphf$art_i++) {        var field = $art_objzcsdfbgjhp$art_obj[$art_imtphf$art_i]%>';
        for (var $art_imtphf$art_i = 0, $art_objzcsdfbgjhp$art_obj = group.fields, $art_cmysaavaps$art_c = $art_objzcsdfbgjhp$art_obj.length; $art_imtphf$art_i < $art_cmysaavaps$art_c; $art_imtphf$art_i++) {
            var field = $art_objzcsdfbgjhp$art_obj[$art_imtphf$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_irzzcserke$art_i = 0, $art_ctqyswqshtl$art_c = selectedItems.length; $art_irzzcserke$art_i < $art_ctqyswqshtl$art_c; $art_irzzcserke$art_i++) {        var s = selectedItems[$art_irzzcserke$art_i]%>';
        for (var $art_irzzcserke$art_i = 0, $art_ctqyswqshtl$art_c = selectedItems.length; $art_irzzcserke$art_i < $art_ctqyswqshtl$art_c; $art_irzzcserke$art_i++) {
            var s = selectedItems[$art_irzzcserke$art_i];
