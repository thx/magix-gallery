...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwbbkkk$art_i = 0, $art_chwhrxhsv$art_c = groups.length; $art_iwbbkkk$art_i < $art_chwhrxhsv$art_c; $art_iwbbkkk$art_i++) {    var group = groups[$art_iwbbkkk$art_i]%>';
    for (var $art_iwbbkkk$art_i = 0, $art_chwhrxhsv$art_c = groups.length; $art_iwbbkkk$art_i < $art_chwhrxhsv$art_c; $art_iwbbkkk$art_i++) {
        var group = groups[$art_iwbbkkk$art_i];
        ...
        ;
        $expr = '<%for (var $art_iyyzskwgy$art_i = 0, $art_objrhttvq$art_obj = group.fields, $art_cjcfsjtb$art_c = $art_objrhttvq$art_obj.length; $art_iyyzskwgy$art_i < $art_cjcfsjtb$art_c; $art_iyyzskwgy$art_i++) {        var field = $art_objrhttvq$art_obj[$art_iyyzskwgy$art_i]%>';
        for (var $art_iyyzskwgy$art_i = 0, $art_objrhttvq$art_obj = group.fields, $art_cjcfsjtb$art_c = $art_objrhttvq$art_obj.length; $art_iyyzskwgy$art_i < $art_cjcfsjtb$art_c; $art_iyyzskwgy$art_i++) {
            var field = $art_objrhttvq$art_obj[$art_iyyzskwgy$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ivnhnvtluze$art_i = 0, $art_cljckbiwk$art_c = selectedItems.length; $art_ivnhnvtluze$art_i < $art_cljckbiwk$art_c; $art_ivnhnvtluze$art_i++) {        var s = selectedItems[$art_ivnhnvtluze$art_i]%>';
        for (var $art_ivnhnvtluze$art_i = 0, $art_cljckbiwk$art_c = selectedItems.length; $art_ivnhnvtluze$art_i < $art_cljckbiwk$art_c; $art_ivnhnvtluze$art_i++) {
            var s = selectedItems[$art_ivnhnvtluze$art_i];
