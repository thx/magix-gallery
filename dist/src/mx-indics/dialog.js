...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><div mxa="_zs_gallerycU:_" class="_zs_gallery_mx-indics_index_-header"><span mxs="_zs_gallerycU:_" class="fontsize-16">选择数据字段</span>';
    $line = 4;
    $art = 'if (limit > 0)';
    ;
    $expr = '<%if (limit > 0) {%>';
    if (limit > 0) {
        ;
        $p += '<span mxa="_zs_gallerycU:a" class="color-9 font-tahoma bold ml10">';
        $line = 5;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_gallerycU:b" class="_zs_gallery_mx-indics_index_-content">';
    $line = 14;
    $art = 'each groups as group';
    ;
    $expr = '<%for (var $art_inkkkttovhk$art_i = 0, $art_ciqeadbssc$art_c = groups.length; $art_inkkkttovhk$art_i < $art_ciqeadbssc$art_c; $art_inkkkttovhk$art_i++) {    var group = groups[$art_inkkkttovhk$art_i]%>';
    for (var $art_inkkkttovhk$art_i = 0, $art_ciqeadbssc$art_c = groups.length; $art_inkkkttovhk$art_i < $art_ciqeadbssc$art_c; $art_inkkkttovhk$art_i++) {
        var group = groups[$art_inkkkttovhk$art_i];
        $p += '<div mxv mxa="_zs_gallerycU:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 16;
        $art = 'if group.text';
        ;
        $expr = '<%if (group.text) {%>';
        if (group.text) {
            ;
            $p += '<div mxa="_zs_gallerycU:d" class="_zs_gallery_mx-indics_index_-name">';
            $line = 17;
            $art = '=group.text';
            ;
        ...
        ;
        $p += '<div mxv mxa="_zs_gallerycU:e" class="clearfix">';
        $line = 20;
        $art = 'each group.fields as field';
        ;
        $expr = '<%for (var $art_irwjivjjhb$art_i = 0, $art_objuwxhsidq$art_obj = group.fields, $art_cdnkcemc$art_c = $art_objuwxhsidq$art_obj.length; $art_irwjivjjhb$art_i < $art_cdnkcemc$art_c; $art_irwjivjjhb$art_i++) {        var field = $art_objuwxhsidq$art_obj[$art_irwjivjjhb$art_i]%>';
        for (var $art_irwjivjjhb$art_i = 0, $art_objuwxhsidq$art_obj = group.fields, $art_cdnkcemc$art_c = $art_objuwxhsidq$art_obj.length; $art_irwjivjjhb$art_i < $art_cdnkcemc$art_c; $art_irwjivjjhb$art_i++) {
            var field = $art_objuwxhsidq$art_obj[$art_irwjivjjhb$art_i];
    ...
    if (sortable) {
        ;
        $p += '<div mxs="_zs_gallerycU:b" class="_zs_gallery_mx-indics_index_-drag-header"><div class="_zs_gallery_mx-indics_index_-drag-title">自定义字段</div><div class="_zs_gallery_mx-indics_index_-drag-oper"><span class="color-9 mr10">可拖动排序</span><a href="javascript:;" class="link-brand" mx-click="' + $viewId + 'clear()"><i class="mc-iconfont displacement-2">&#xe72e;</i>清空</a></div></div><div mxa="_zs_gallerycU:f" class="_zs_gallery_mx-indics_index_-drag-wrapper" mx-view="mx-dragsort/index" mx-dragfinish="' + $viewId + 'drag()">';
        $line = 49;
        $art = 'each selectedItems as s';
        ;
        $expr = '<%for (var $art_iejixjolx$art_i = 0, $art_cvgcdxok$art_c = selectedItems.length; $art_iejixjolx$art_i < $art_cvgcdxok$art_c; $art_iejixjolx$art_i++) {        var s = selectedItems[$art_iejixjolx$art_i]%>';
        for (var $art_iejixjolx$art_i = 0, $art_cvgcdxok$art_c = selectedItems.length; $art_iejixjolx$art_i < $art_cvgcdxok$art_c; $art_iejixjolx$art_i++) {
            var s = selectedItems[$art_iejixjolx$art_i];
