...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iamvlsstd$art_i = 0, $art_ceededws$art_c = groups.length; $art_iamvlsstd$art_i < $art_ceededws$art_c; $art_iamvlsstd$art_i++) {    var group = groups[$art_iamvlsstd$art_i]%>';
    for (var $art_iamvlsstd$art_i = 0, $art_ceededws$art_c = groups.length; $art_iamvlsstd$art_i < $art_ceededws$art_c; $art_iamvlsstd$art_i++) {
        var group = groups[$art_iamvlsstd$art_i];
        ...
        ;
        $expr = '<%for (var $art_iehjfbrpb$art_i = 0, $art_objuunxvszx$art_obj = group.fields, $art_cobhbshcwj$art_c = $art_objuunxvszx$art_obj.length; $art_iehjfbrpb$art_i < $art_cobhbshcwj$art_c; $art_iehjfbrpb$art_i++) {        var field = $art_objuunxvszx$art_obj[$art_iehjfbrpb$art_i]%>';
        for (var $art_iehjfbrpb$art_i = 0, $art_objuunxvszx$art_obj = group.fields, $art_cobhbshcwj$art_c = $art_objuunxvszx$art_obj.length; $art_iehjfbrpb$art_i < $art_cobhbshcwj$art_c; $art_iehjfbrpb$art_i++) {
            var field = $art_objuunxvszx$art_obj[$art_iehjfbrpb$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ingrqmk$art_i = 0, $art_cxknijqua$art_c = selectedItems.length; $art_ingrqmk$art_i < $art_cxknijqua$art_c; $art_ingrqmk$art_i++) {        var s = selectedItems[$art_ingrqmk$art_i]%>';
        for (var $art_ingrqmk$art_i = 0, $art_cxknijqua$art_c = selectedItems.length; $art_ingrqmk$art_i < $art_cxknijqua$art_c; $art_ingrqmk$art_i++) {
            var s = selectedItems[$art_ingrqmk$art_i];
