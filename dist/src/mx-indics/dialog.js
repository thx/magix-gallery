...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iewawjwr$art_i = 0, $art_cqnbdydh$art_c = groups.length; $art_iewawjwr$art_i < $art_cqnbdydh$art_c; $art_iewawjwr$art_i++) {    var group = groups[$art_iewawjwr$art_i]%>';
    for (var $art_iewawjwr$art_i = 0, $art_cqnbdydh$art_c = groups.length; $art_iewawjwr$art_i < $art_cqnbdydh$art_c; $art_iewawjwr$art_i++) {
        var group = groups[$art_iewawjwr$art_i];
        ...
        ;
        $expr = '<%for (var $art_izlgmtjdog$art_i = 0, $art_objgbhsiqa$art_obj = group.fields, $art_ctumbd$art_c = $art_objgbhsiqa$art_obj.length; $art_izlgmtjdog$art_i < $art_ctumbd$art_c; $art_izlgmtjdog$art_i++) {        var field = $art_objgbhsiqa$art_obj[$art_izlgmtjdog$art_i]%>';
        for (var $art_izlgmtjdog$art_i = 0, $art_objgbhsiqa$art_obj = group.fields, $art_ctumbd$art_c = $art_objgbhsiqa$art_obj.length; $art_izlgmtjdog$art_i < $art_ctumbd$art_c; $art_izlgmtjdog$art_i++) {
            var field = $art_objgbhsiqa$art_obj[$art_izlgmtjdog$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ikhzym$art_i = 0, $art_cgsjfgptczb$art_c = selectedItems.length; $art_ikhzym$art_i < $art_cgsjfgptczb$art_c; $art_ikhzym$art_i++) {        var s = selectedItems[$art_ikhzym$art_i]%>';
        for (var $art_ikhzym$art_i = 0, $art_cgsjfgptczb$art_c = selectedItems.length; $art_ikhzym$art_i < $art_cgsjfgptczb$art_c; $art_ikhzym$art_i++) {
            var s = selectedItems[$art_ikhzym$art_i];
