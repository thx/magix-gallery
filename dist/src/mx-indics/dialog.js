...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itaxrxmgj$art_i = 0, $art_ceztjaeyoc$art_c = groups.length; $art_itaxrxmgj$art_i < $art_ceztjaeyoc$art_c; $art_itaxrxmgj$art_i++) {    var group = groups[$art_itaxrxmgj$art_i]%>';
    for (var $art_itaxrxmgj$art_i = 0, $art_ceztjaeyoc$art_c = groups.length; $art_itaxrxmgj$art_i < $art_ceztjaeyoc$art_c; $art_itaxrxmgj$art_i++) {
        var group = groups[$art_itaxrxmgj$art_i];
        ...
        ;
        $expr = '<%for (var $art_icpygbhknq$art_i = 0, $art_objpipgi$art_obj = group.fields, $art_cdbtyox$art_c = $art_objpipgi$art_obj.length; $art_icpygbhknq$art_i < $art_cdbtyox$art_c; $art_icpygbhknq$art_i++) {        var field = $art_objpipgi$art_obj[$art_icpygbhknq$art_i]%>';
        for (var $art_icpygbhknq$art_i = 0, $art_objpipgi$art_obj = group.fields, $art_cdbtyox$art_c = $art_objpipgi$art_obj.length; $art_icpygbhknq$art_i < $art_cdbtyox$art_c; $art_icpygbhknq$art_i++) {
            var field = $art_objpipgi$art_obj[$art_icpygbhknq$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ikpmzjtkbq$art_i = 0, $art_coclixun$art_c = selectedItems.length; $art_ikpmzjtkbq$art_i < $art_coclixun$art_c; $art_ikpmzjtkbq$art_i++) {        var s = selectedItems[$art_ikpmzjtkbq$art_i]%>';
        for (var $art_ikpmzjtkbq$art_i = 0, $art_coclixun$art_c = selectedItems.length; $art_ikpmzjtkbq$art_i < $art_coclixun$art_c; $art_ikpmzjtkbq$art_i++) {
            var s = selectedItems[$art_ikpmzjtkbq$art_i];
