...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icytfx$art_i = 0, $art_cbqcgvg$art_c = groups.length; $art_icytfx$art_i < $art_cbqcgvg$art_c; $art_icytfx$art_i++) {    var group = groups[$art_icytfx$art_i]%>';
    for (var $art_icytfx$art_i = 0, $art_cbqcgvg$art_c = groups.length; $art_icytfx$art_i < $art_cbqcgvg$art_c; $art_icytfx$art_i++) {
        var group = groups[$art_icytfx$art_i];
        ...
        ;
        $expr = '<%for (var $art_isapvxo$art_i = 0, $art_objvjbmjlwkgcd$art_obj = group.fields, $art_cernvstko$art_c = $art_objvjbmjlwkgcd$art_obj.length; $art_isapvxo$art_i < $art_cernvstko$art_c; $art_isapvxo$art_i++) {        var field = $art_objvjbmjlwkgcd$art_obj[$art_isapvxo$art_i]%>';
        for (var $art_isapvxo$art_i = 0, $art_objvjbmjlwkgcd$art_obj = group.fields, $art_cernvstko$art_c = $art_objvjbmjlwkgcd$art_obj.length; $art_isapvxo$art_i < $art_cernvstko$art_c; $art_isapvxo$art_i++) {
            var field = $art_objvjbmjlwkgcd$art_obj[$art_isapvxo$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ipwipyf$art_i = 0, $art_cguljtw$art_c = selectedItems.length; $art_ipwipyf$art_i < $art_cguljtw$art_c; $art_ipwipyf$art_i++) {        var s = selectedItems[$art_ipwipyf$art_i]%>';
        for (var $art_ipwipyf$art_i = 0, $art_cguljtw$art_c = selectedItems.length; $art_ipwipyf$art_i < $art_cguljtw$art_c; $art_ipwipyf$art_i++) {
            var s = selectedItems[$art_ipwipyf$art_i];
