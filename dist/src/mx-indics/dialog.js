...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ispgwhiljak$art_i = 0, $art_cwwefus$art_c = groups.length; $art_ispgwhiljak$art_i < $art_cwwefus$art_c; $art_ispgwhiljak$art_i++) {    var group = groups[$art_ispgwhiljak$art_i]%>';
    for (var $art_ispgwhiljak$art_i = 0, $art_cwwefus$art_c = groups.length; $art_ispgwhiljak$art_i < $art_cwwefus$art_c; $art_ispgwhiljak$art_i++) {
        var group = groups[$art_ispgwhiljak$art_i];
        ...
        ;
        $expr = '<%for (var $art_ialmfw$art_i = 0, $art_objthuxzurx$art_obj = group.fields, $art_chmlgz$art_c = $art_objthuxzurx$art_obj.length; $art_ialmfw$art_i < $art_chmlgz$art_c; $art_ialmfw$art_i++) {        var field = $art_objthuxzurx$art_obj[$art_ialmfw$art_i]%>';
        for (var $art_ialmfw$art_i = 0, $art_objthuxzurx$art_obj = group.fields, $art_chmlgz$art_c = $art_objthuxzurx$art_obj.length; $art_ialmfw$art_i < $art_chmlgz$art_c; $art_ialmfw$art_i++) {
            var field = $art_objthuxzurx$art_obj[$art_ialmfw$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_iywypiascc$art_i = 0, $art_cujaorxcs$art_c = selectedItems.length; $art_iywypiascc$art_i < $art_cujaorxcs$art_c; $art_iywypiascc$art_i++) {        var s = selectedItems[$art_iywypiascc$art_i]%>';
        for (var $art_iywypiascc$art_i = 0, $art_cujaorxcs$art_c = selectedItems.length; $art_iywypiascc$art_i < $art_cujaorxcs$art_c; $art_iywypiascc$art_i++) {
            var s = selectedItems[$art_iywypiascc$art_i];
