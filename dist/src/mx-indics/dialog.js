...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imxonfsm$art_i = 0, $art_cpoxejfnpze$art_c = groups.length; $art_imxonfsm$art_i < $art_cpoxejfnpze$art_c; $art_imxonfsm$art_i++) {    var group = groups[$art_imxonfsm$art_i]%>';
    for (var $art_imxonfsm$art_i = 0, $art_cpoxejfnpze$art_c = groups.length; $art_imxonfsm$art_i < $art_cpoxejfnpze$art_c; $art_imxonfsm$art_i++) {
        var group = groups[$art_imxonfsm$art_i];
        ...
        ;
        $expr = '<%for (var $art_imkqqjuvg$art_i = 0, $art_objahdaihl$art_obj = group.fields, $art_cnzvs$art_c = $art_objahdaihl$art_obj.length; $art_imkqqjuvg$art_i < $art_cnzvs$art_c; $art_imkqqjuvg$art_i++) {        var field = $art_objahdaihl$art_obj[$art_imkqqjuvg$art_i]%>';
        for (var $art_imkqqjuvg$art_i = 0, $art_objahdaihl$art_obj = group.fields, $art_cnzvs$art_c = $art_objahdaihl$art_obj.length; $art_imkqqjuvg$art_i < $art_cnzvs$art_c; $art_imkqqjuvg$art_i++) {
            var field = $art_objahdaihl$art_obj[$art_imkqqjuvg$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_isxivjsgy$art_i = 0, $art_cexuwkkb$art_c = selectedItems.length; $art_isxivjsgy$art_i < $art_cexuwkkb$art_c; $art_isxivjsgy$art_i++) {        var s = selectedItems[$art_isxivjsgy$art_i]%>';
        for (var $art_isxivjsgy$art_i = 0, $art_cexuwkkb$art_c = selectedItems.length; $art_isxivjsgy$art_i < $art_cexuwkkb$art_c; $art_isxivjsgy$art_i++) {
            var s = selectedItems[$art_isxivjsgy$art_i];
