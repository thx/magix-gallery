...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihnstjgzp$art_i = 0, $art_csoohcsya$art_c = groups.length; $art_ihnstjgzp$art_i < $art_csoohcsya$art_c; $art_ihnstjgzp$art_i++) {    var group = groups[$art_ihnstjgzp$art_i]%>';
    for (var $art_ihnstjgzp$art_i = 0, $art_csoohcsya$art_c = groups.length; $art_ihnstjgzp$art_i < $art_csoohcsya$art_c; $art_ihnstjgzp$art_i++) {
        var group = groups[$art_ihnstjgzp$art_i];
        ...
        ;
        $expr = '<%for (var $art_iljuhvdcc$art_i = 0, $art_objdgtlb$art_obj = group.fields, $art_ceujwweswww$art_c = $art_objdgtlb$art_obj.length; $art_iljuhvdcc$art_i < $art_ceujwweswww$art_c; $art_iljuhvdcc$art_i++) {        var field = $art_objdgtlb$art_obj[$art_iljuhvdcc$art_i]%>';
        for (var $art_iljuhvdcc$art_i = 0, $art_objdgtlb$art_obj = group.fields, $art_ceujwweswww$art_c = $art_objdgtlb$art_obj.length; $art_iljuhvdcc$art_i < $art_ceujwweswww$art_c; $art_iljuhvdcc$art_i++) {
            var field = $art_objdgtlb$art_obj[$art_iljuhvdcc$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ikfxoxtkpb$art_i = 0, $art_cwipzbapo$art_c = selectedItems.length; $art_ikfxoxtkpb$art_i < $art_cwipzbapo$art_c; $art_ikfxoxtkpb$art_i++) {        var s = selectedItems[$art_ikfxoxtkpb$art_i]%>';
        for (var $art_ikfxoxtkpb$art_i = 0, $art_cwipzbapo$art_c = selectedItems.length; $art_ikfxoxtkpb$art_i < $art_cwipzbapo$art_c; $art_ikfxoxtkpb$art_i++) {
            var s = selectedItems[$art_ikfxoxtkpb$art_i];
