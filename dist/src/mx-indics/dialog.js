...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iacgiwrl$art_i = 0, $art_czpceqail$art_c = groups.length; $art_iacgiwrl$art_i < $art_czpceqail$art_c; $art_iacgiwrl$art_i++) {    var group = groups[$art_iacgiwrl$art_i]%>';
    for (var $art_iacgiwrl$art_i = 0, $art_czpceqail$art_c = groups.length; $art_iacgiwrl$art_i < $art_czpceqail$art_c; $art_iacgiwrl$art_i++) {
        var group = groups[$art_iacgiwrl$art_i];
        ...
        ;
        $expr = '<%for (var $art_imzeqmujk$art_i = 0, $art_objiupezmo$art_obj = group.fields, $art_cyewibjzcxo$art_c = $art_objiupezmo$art_obj.length; $art_imzeqmujk$art_i < $art_cyewibjzcxo$art_c; $art_imzeqmujk$art_i++) {        var field = $art_objiupezmo$art_obj[$art_imzeqmujk$art_i]%>';
        for (var $art_imzeqmujk$art_i = 0, $art_objiupezmo$art_obj = group.fields, $art_cyewibjzcxo$art_c = $art_objiupezmo$art_obj.length; $art_imzeqmujk$art_i < $art_cyewibjzcxo$art_c; $art_imzeqmujk$art_i++) {
            var field = $art_objiupezmo$art_obj[$art_imzeqmujk$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ibsuqgcdkgs$art_i = 0, $art_ceaipqfzdpj$art_c = selectedItems.length; $art_ibsuqgcdkgs$art_i < $art_ceaipqfzdpj$art_c; $art_ibsuqgcdkgs$art_i++) {        var s = selectedItems[$art_ibsuqgcdkgs$art_i]%>';
        for (var $art_ibsuqgcdkgs$art_i = 0, $art_ceaipqfzdpj$art_c = selectedItems.length; $art_ibsuqgcdkgs$art_i < $art_ceaipqfzdpj$art_c; $art_ibsuqgcdkgs$art_i++) {
            var s = selectedItems[$art_ibsuqgcdkgs$art_i];
