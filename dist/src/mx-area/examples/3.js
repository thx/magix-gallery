...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioucc$art_i = 0, $art_ctizczsduo$art_c = arrs.length; $art_ioucc$art_i < $art_ctizczsduo$art_c; $art_ioucc$art_i++) {    var item = arrs[$art_ioucc$art_i]%>';
    for (var $art_ioucc$art_i = 0, $art_ctizczsduo$art_c = arrs.length; $art_ioucc$art_i < $art_ctizczsduo$art_c; $art_ioucc$art_i++) {
        var item = arrs[$art_ioucc$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
