...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iahgder$art_i = 0, $art_cefrveunle$art_c = arrs.length; $art_iahgder$art_i < $art_cefrveunle$art_c; $art_iahgder$art_i++) {    var item = arrs[$art_iahgder$art_i]%>';
    for (var $art_iahgder$art_i = 0, $art_cefrveunle$art_c = arrs.length; $art_iahgder$art_i < $art_cefrveunle$art_c; $art_iahgder$art_i++) {
        var item = arrs[$art_iahgder$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
