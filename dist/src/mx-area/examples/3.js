...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqacotnim$art_i = 0, $art_cjhiuumyfuo$art_c = arrs.length; $art_iqacotnim$art_i < $art_cjhiuumyfuo$art_c; $art_iqacotnim$art_i++) {    var item = arrs[$art_iqacotnim$art_i]%>';
    for (var $art_iqacotnim$art_i = 0, $art_cjhiuumyfuo$art_c = arrs.length; $art_iqacotnim$art_i < $art_cjhiuumyfuo$art_c; $art_iqacotnim$art_i++) {
        var item = arrs[$art_iqacotnim$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
