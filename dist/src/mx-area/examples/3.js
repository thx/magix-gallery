...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iligdvxk$art_i = 0, $art_cdyaztdy$art_c = arrs.length; $art_iligdvxk$art_i < $art_cdyaztdy$art_c; $art_iligdvxk$art_i++) {    var item = arrs[$art_iligdvxk$art_i]%>';
    for (var $art_iligdvxk$art_i = 0, $art_cdyaztdy$art_c = arrs.length; $art_iligdvxk$art_i < $art_cdyaztdy$art_c; $art_iligdvxk$art_i++) {
        var item = arrs[$art_iligdvxk$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
