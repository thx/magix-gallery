...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivcuexgpfy$art_i = 0, $art_cqunenwlh$art_c = arrs.length; $art_ivcuexgpfy$art_i < $art_cqunenwlh$art_c; $art_ivcuexgpfy$art_i++) {    var item = arrs[$art_ivcuexgpfy$art_i]%>';
    for (var $art_ivcuexgpfy$art_i = 0, $art_cqunenwlh$art_c = arrs.length; $art_ivcuexgpfy$art_i < $art_cqunenwlh$art_c; $art_ivcuexgpfy$art_i++) {
        var item = arrs[$art_ivcuexgpfy$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
