...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihekiyindt$art_i = 0, $art_cuttijm$art_c = arrs.length; $art_ihekiyindt$art_i < $art_cuttijm$art_c; $art_ihekiyindt$art_i++) {    var item = arrs[$art_ihekiyindt$art_i]%>';
    for (var $art_ihekiyindt$art_i = 0, $art_cuttijm$art_c = arrs.length; $art_ihekiyindt$art_i < $art_cuttijm$art_c; $art_ihekiyindt$art_i++) {
        var item = arrs[$art_ihekiyindt$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
