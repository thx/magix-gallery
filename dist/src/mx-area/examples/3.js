...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iijrjidhy$art_i = 0, $art_cphbvwxk$art_c = arrs.length; $art_iijrjidhy$art_i < $art_cphbvwxk$art_c; $art_iijrjidhy$art_i++) {    var item = arrs[$art_iijrjidhy$art_i]%>';
    for (var $art_iijrjidhy$art_i = 0, $art_cphbvwxk$art_c = arrs.length; $art_iijrjidhy$art_i < $art_cphbvwxk$art_c; $art_iijrjidhy$art_i++) {
        var item = arrs[$art_iijrjidhy$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
