...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihrvwjl$art_i = 0, $art_cxltquziy$art_c = arrs.length; $art_ihrvwjl$art_i < $art_cxltquziy$art_c; $art_ihrvwjl$art_i++) {    var item = arrs[$art_ihrvwjl$art_i]%>';
    for (var $art_ihrvwjl$art_i = 0, $art_cxltquziy$art_c = arrs.length; $art_ihrvwjl$art_i < $art_cxltquziy$art_c; $art_ihrvwjl$art_i++) {
        var item = arrs[$art_ihrvwjl$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
