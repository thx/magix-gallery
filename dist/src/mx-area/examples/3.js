...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixfbgflki$art_i = 0, $art_cdhdcebnoj$art_c = arrs.length; $art_ixfbgflki$art_i < $art_cdhdcebnoj$art_c; $art_ixfbgflki$art_i++) {    var item = arrs[$art_ixfbgflki$art_i]%>';
    for (var $art_ixfbgflki$art_i = 0, $art_cdhdcebnoj$art_c = arrs.length; $art_ixfbgflki$art_i < $art_cdhdcebnoj$art_c; $art_ixfbgflki$art_i++) {
        var item = arrs[$art_ixfbgflki$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
