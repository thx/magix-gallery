...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixruptzuq$art_i = 0, $art_cfoocrpk$art_c = arrs.length; $art_ixruptzuq$art_i < $art_cfoocrpk$art_c; $art_ixruptzuq$art_i++) {    var item = arrs[$art_ixruptzuq$art_i]%>';
    for (var $art_ixruptzuq$art_i = 0, $art_cfoocrpk$art_c = arrs.length; $art_ixruptzuq$art_i < $art_cfoocrpk$art_c; $art_ixruptzuq$art_i++) {
        var item = arrs[$art_ixruptzuq$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
