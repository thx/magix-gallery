...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipdzdryx$art_i = 0, $art_cnhlbig$art_c = arrs.length; $art_ipdzdryx$art_i < $art_cnhlbig$art_c; $art_ipdzdryx$art_i++) {    var item = arrs[$art_ipdzdryx$art_i]%>';
    for (var $art_ipdzdryx$art_i = 0, $art_cnhlbig$art_c = arrs.length; $art_ipdzdryx$art_i < $art_cnhlbig$art_c; $art_ipdzdryx$art_i++) {
        var item = arrs[$art_ipdzdryx$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
