...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idohftypwa$art_i = 0, $art_ckcafablk$art_c = arrs.length; $art_idohftypwa$art_i < $art_ckcafablk$art_c; $art_idohftypwa$art_i++) {    var item = arrs[$art_idohftypwa$art_i]%>';
    for (var $art_idohftypwa$art_i = 0, $art_ckcafablk$art_c = arrs.length; $art_idohftypwa$art_i < $art_ckcafablk$art_c; $art_idohftypwa$art_i++) {
        var item = arrs[$art_idohftypwa$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
