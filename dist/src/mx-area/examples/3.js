...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqhmeutpzqg$art_i = 0, $art_cuenwkh$art_c = arrs.length; $art_iqhmeutpzqg$art_i < $art_cuenwkh$art_c; $art_iqhmeutpzqg$art_i++) {    var item = arrs[$art_iqhmeutpzqg$art_i]%>';
    for (var $art_iqhmeutpzqg$art_i = 0, $art_cuenwkh$art_c = arrs.length; $art_iqhmeutpzqg$art_i < $art_cuenwkh$art_c; $art_iqhmeutpzqg$art_i++) {
        var item = arrs[$art_iqhmeutpzqg$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
