...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iujxhuc$art_i = 0, $art_cfysgglyfw$art_c = selected.length; $art_iujxhuc$art_i < $art_cfysgglyfw$art_c; $art_iujxhuc$art_i++) {    var item = selected[$art_iujxhuc$art_i]%>';
    for (var $art_iujxhuc$art_i = 0, $art_cfysgglyfw$art_c = selected.length; $art_iujxhuc$art_i < $art_cfysgglyfw$art_c; $art_iujxhuc$art_i++) {
        var item = selected[$art_iujxhuc$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
