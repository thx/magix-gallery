...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikdefuxypt$art_i = 0, $art_cigkgowolyb$art_c = selected.length; $art_ikdefuxypt$art_i < $art_cigkgowolyb$art_c; $art_ikdefuxypt$art_i++) {    var item = selected[$art_ikdefuxypt$art_i]%>';
    for (var $art_ikdefuxypt$art_i = 0, $art_cigkgowolyb$art_c = selected.length; $art_ikdefuxypt$art_i < $art_cigkgowolyb$art_c; $art_ikdefuxypt$art_i++) {
        var item = selected[$art_ikdefuxypt$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
