...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipjdczrrm$art_i = 0, $art_cowxhtbf$art_c = selected.length; $art_ipjdczrrm$art_i < $art_cowxhtbf$art_c; $art_ipjdczrrm$art_i++) {    var item = selected[$art_ipjdczrrm$art_i]%>';
    for (var $art_ipjdczrrm$art_i = 0, $art_cowxhtbf$art_c = selected.length; $art_ipjdczrrm$art_i < $art_cowxhtbf$art_c; $art_ipjdczrrm$art_i++) {
        var item = selected[$art_ipjdczrrm$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
