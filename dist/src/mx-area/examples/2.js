...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irqjhgkon$art_i = 0, $art_cfbtbmsp$art_c = selected.length; $art_irqjhgkon$art_i < $art_cfbtbmsp$art_c; $art_irqjhgkon$art_i++) {    var item = selected[$art_irqjhgkon$art_i]%>';
    for (var $art_irqjhgkon$art_i = 0, $art_cfbtbmsp$art_c = selected.length; $art_irqjhgkon$art_i < $art_cfbtbmsp$art_c; $art_irqjhgkon$art_i++) {
        var item = selected[$art_irqjhgkon$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
