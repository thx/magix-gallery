...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijivithvub$art_i = 0, $art_cbrbsfdxu$art_c = selected.length; $art_ijivithvub$art_i < $art_cbrbsfdxu$art_c; $art_ijivithvub$art_i++) {    var item = selected[$art_ijivithvub$art_i]%>';
    for (var $art_ijivithvub$art_i = 0, $art_cbrbsfdxu$art_c = selected.length; $art_ijivithvub$art_i < $art_cbrbsfdxu$art_c; $art_ijivithvub$art_i++) {
        var item = selected[$art_ijivithvub$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
