...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imfamhnnvn$art_i = 0, $art_cbuguwzldl$art_c = selected.length; $art_imfamhnnvn$art_i < $art_cbuguwzldl$art_c; $art_imfamhnnvn$art_i++) {    var item = selected[$art_imfamhnnvn$art_i]%>';
    for (var $art_imfamhnnvn$art_i = 0, $art_cbuguwzldl$art_c = selected.length; $art_imfamhnnvn$art_i < $art_cbuguwzldl$art_c; $art_imfamhnnvn$art_i++) {
        var item = selected[$art_imfamhnnvn$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-area id="&#123;&#123;=viewId&#125;&#125;_area"\n    selected="&#123;&#123;@selected&#125;&#125;"/&gt;</pre></div><div mxa="_zs_galleryT:j" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-third2 _zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half-right"><div mxs="_zs_galleryT:e" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">JS Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 42;
    $art = '=viewId';
    ;
