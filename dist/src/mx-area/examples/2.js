...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifnmyhcb$art_i = 0, $art_ccijtlj$art_c = selected.length; $art_ifnmyhcb$art_i < $art_ccijtlj$art_c; $art_ifnmyhcb$art_i++) {    var item = selected[$art_ifnmyhcb$art_i]%>';
    for (var $art_ifnmyhcb$art_i = 0, $art_ccijtlj$art_c = selected.length; $art_ifnmyhcb$art_i < $art_ccijtlj$art_c; $art_ifnmyhcb$art_i++) {
        var item = selected[$art_ifnmyhcb$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
