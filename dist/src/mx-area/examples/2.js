...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igiuswobytr$art_i = 0, $art_ckmokdte$art_c = selected.length; $art_igiuswobytr$art_i < $art_ckmokdte$art_c; $art_igiuswobytr$art_i++) {    var item = selected[$art_igiuswobytr$art_i]%>';
    for (var $art_igiuswobytr$art_i = 0, $art_ckmokdte$art_c = selected.length; $art_igiuswobytr$art_i < $art_ckmokdte$art_c; $art_igiuswobytr$art_i++) {
        var item = selected[$art_igiuswobytr$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
