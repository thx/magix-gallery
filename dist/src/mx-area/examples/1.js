...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_issmvpfk$art_i = 0, $art_corcrgiqzl$art_c = selected.length; $art_issmvpfk$art_i < $art_corcrgiqzl$art_c; $art_issmvpfk$art_i++) {    var item = selected[$art_issmvpfk$art_i]%>';
    for (var $art_issmvpfk$art_i = 0, $art_corcrgiqzl$art_c = selected.length; $art_issmvpfk$art_i < $art_corcrgiqzl$art_c; $art_issmvpfk$art_i++) {
        var item = selected[$art_issmvpfk$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
