...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iiisbci$art_i = 0, $art_cmdkuqpv$art_c = selected.length; $art_iiisbci$art_i < $art_cmdkuqpv$art_c; $art_iiisbci$art_i++) {    var item = selected[$art_iiisbci$art_i]%>';
    for (var $art_iiisbci$art_i = 0, $art_cmdkuqpv$art_c = selected.length; $art_iiisbci$art_i < $art_cmdkuqpv$art_c; $art_iiisbci$art_i++) {
        var item = selected[$art_iiisbci$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
