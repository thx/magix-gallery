...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikcbqvawl$art_i = 0, $art_ckwbphtdeg$art_c = arrs.length; $art_ikcbqvawl$art_i < $art_ckwbphtdeg$art_c; $art_ikcbqvawl$art_i++) {    var item = arrs[$art_ikcbqvawl$art_i]%>';
    for (var $art_ikcbqvawl$art_i = 0, $art_ckwbphtdeg$art_c = arrs.length; $art_ikcbqvawl$art_i < $art_ckwbphtdeg$art_c; $art_ikcbqvawl$art_i++) {
        var item = arrs[$art_ikcbqvawl$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
