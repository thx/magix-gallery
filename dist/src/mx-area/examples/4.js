...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izvtuqett$art_i = 0, $art_cnyxumqfa$art_c = arrs.length; $art_izvtuqett$art_i < $art_cnyxumqfa$art_c; $art_izvtuqett$art_i++) {    var item = arrs[$art_izvtuqett$art_i]%>';
    for (var $art_izvtuqett$art_i = 0, $art_cnyxumqfa$art_c = arrs.length; $art_izvtuqett$art_i < $art_cnyxumqfa$art_c; $art_izvtuqett$art_i++) {
        var item = arrs[$art_izvtuqett$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
