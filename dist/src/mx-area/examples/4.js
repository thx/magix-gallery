...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irotjkymne$art_i = 0, $art_cdnxifem$art_c = arrs.length; $art_irotjkymne$art_i < $art_cdnxifem$art_c; $art_irotjkymne$art_i++) {    var item = arrs[$art_irotjkymne$art_i]%>';
    for (var $art_irotjkymne$art_i = 0, $art_cdnxifem$art_c = arrs.length; $art_irotjkymne$art_i < $art_cdnxifem$art_c; $art_irotjkymne$art_i++) {
        var item = arrs[$art_irotjkymne$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
