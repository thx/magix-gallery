...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icwcllvxh$art_i = 0, $art_cgmrbcitgu$art_c = arrs.length; $art_icwcllvxh$art_i < $art_cgmrbcitgu$art_c; $art_icwcllvxh$art_i++) {    var item = arrs[$art_icwcllvxh$art_i]%>';
    for (var $art_icwcllvxh$art_i = 0, $art_cgmrbcitgu$art_c = arrs.length; $art_icwcllvxh$art_i < $art_cgmrbcitgu$art_c; $art_icwcllvxh$art_i++) {
        var item = arrs[$art_icwcllvxh$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
