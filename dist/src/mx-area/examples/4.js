...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irsqqnh$art_i = 0, $art_coufuvgvqi$art_c = arrs.length; $art_irsqqnh$art_i < $art_coufuvgvqi$art_c; $art_irsqqnh$art_i++) {    var item = arrs[$art_irsqqnh$art_i]%>';
    for (var $art_irsqqnh$art_i = 0, $art_coufuvgvqi$art_c = arrs.length; $art_irsqqnh$art_i < $art_coufuvgvqi$art_c; $art_irsqqnh$art_i++) {
        var item = arrs[$art_irsqqnh$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
