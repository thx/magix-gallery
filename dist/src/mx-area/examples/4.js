...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iizthqgeyms$art_i = 0, $art_cqrylhstc$art_c = arrs.length; $art_iizthqgeyms$art_i < $art_cqrylhstc$art_c; $art_iizthqgeyms$art_i++) {    var item = arrs[$art_iizthqgeyms$art_i]%>';
    for (var $art_iizthqgeyms$art_i = 0, $art_cqrylhstc$art_c = arrs.length; $art_iizthqgeyms$art_i < $art_cqrylhstc$art_c; $art_iizthqgeyms$art_i++) {
        var item = arrs[$art_iizthqgeyms$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
