...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ievaldslao$art_i = 0, $art_cjxsbsoc$art_c = arrs.length; $art_ievaldslao$art_i < $art_cjxsbsoc$art_c; $art_ievaldslao$art_i++) {    var item = arrs[$art_ievaldslao$art_i]%>';
    for (var $art_ievaldslao$art_i = 0, $art_cjxsbsoc$art_c = arrs.length; $art_ievaldslao$art_i < $art_cjxsbsoc$art_c; $art_ievaldslao$art_i++) {
        var item = arrs[$art_ievaldslao$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
