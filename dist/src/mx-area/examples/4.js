...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifsdwwhr$art_i = 0, $art_czvmzkh$art_c = arrs.length; $art_ifsdwwhr$art_i < $art_czvmzkh$art_c; $art_ifsdwwhr$art_i++) {    var item = arrs[$art_ifsdwwhr$art_i]%>';
    for (var $art_ifsdwwhr$art_i = 0, $art_czvmzkh$art_c = arrs.length; $art_ifsdwwhr$art_i < $art_czvmzkh$art_c; $art_ifsdwwhr$art_i++) {
        var item = arrs[$art_ifsdwwhr$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
