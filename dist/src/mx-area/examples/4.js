...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikyowbgj$art_i = 0, $art_cbukiaqu$art_c = arrs.length; $art_ikyowbgj$art_i < $art_cbukiaqu$art_c; $art_ikyowbgj$art_i++) {    var item = arrs[$art_ikyowbgj$art_i]%>';
    for (var $art_ikyowbgj$art_i = 0, $art_cbukiaqu$art_c = arrs.length; $art_ikyowbgj$art_i < $art_cbukiaqu$art_c; $art_ikyowbgj$art_i++) {
        var item = arrs[$art_ikyowbgj$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
