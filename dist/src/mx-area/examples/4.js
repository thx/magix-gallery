...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izhnlnxkr$art_i = 0, $art_cabojtcn$art_c = arrs.length; $art_izhnlnxkr$art_i < $art_cabojtcn$art_c; $art_izhnlnxkr$art_i++) {    var item = arrs[$art_izhnlnxkr$art_i]%>';
    for (var $art_izhnlnxkr$art_i = 0, $art_cabojtcn$art_c = arrs.length; $art_izhnlnxkr$art_i < $art_cabojtcn$art_c; $art_izhnlnxkr$art_i++) {
        var item = arrs[$art_izhnlnxkr$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
