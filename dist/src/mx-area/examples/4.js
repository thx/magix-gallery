...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieyfwximq$art_i = 0, $art_cojanduveyj$art_c = arrs.length; $art_ieyfwximq$art_i < $art_cojanduveyj$art_c; $art_ieyfwximq$art_i++) {    var item = arrs[$art_ieyfwximq$art_i]%>';
    for (var $art_ieyfwximq$art_i = 0, $art_cojanduveyj$art_c = arrs.length; $art_ieyfwximq$art_i < $art_cojanduveyj$art_c; $art_ieyfwximq$art_i++) {
        var item = arrs[$art_ieyfwximq$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
    ...
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_galleryU:g" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryU:c" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryU:h" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 38;
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryU:d" class="mc-iconfont _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 41;
    $art = '=viewId';
    ;
