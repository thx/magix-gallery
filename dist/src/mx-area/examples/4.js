...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqcxdmtpg$art_i = 0, $art_cpwuqgbw$art_c = arrs.length; $art_iqcxdmtpg$art_i < $art_cpwuqgbw$art_c; $art_iqcxdmtpg$art_i++) {    var item = arrs[$art_iqcxdmtpg$art_i]%>';
    for (var $art_iqcxdmtpg$art_i = 0, $art_cpwuqgbw$art_c = arrs.length; $art_iqcxdmtpg$art_i < $art_cpwuqgbw$art_c; $art_iqcxdmtpg$art_i++) {
        var item = arrs[$art_iqcxdmtpg$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
