...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ismvcthgxh$art_i = 0, $art_ccstwvpyeo$art_c = arrs.length; $art_ismvcthgxh$art_i < $art_ccstwvpyeo$art_c; $art_ismvcthgxh$art_i++) {    var item = arrs[$art_ismvcthgxh$art_i]%>';
    for (var $art_ismvcthgxh$art_i = 0, $art_ccstwvpyeo$art_c = arrs.length; $art_ismvcthgxh$art_i < $art_ccstwvpyeo$art_c; $art_ismvcthgxh$art_i++) {
        var item = arrs[$art_ismvcthgxh$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
