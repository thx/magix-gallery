...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iylbrlnrc$art_i = 0, $art_cpitiqbi$art_c = arrs.length; $art_iylbrlnrc$art_i < $art_cpitiqbi$art_c; $art_iylbrlnrc$art_i++) {    var item = arrs[$art_iylbrlnrc$art_i]%>';
    for (var $art_iylbrlnrc$art_i = 0, $art_cpitiqbi$art_c = arrs.length; $art_iylbrlnrc$art_i < $art_cpitiqbi$art_c; $art_iylbrlnrc$art_i++) {
        var item = arrs[$art_iylbrlnrc$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
