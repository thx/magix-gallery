...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilrmfs$art_i = 0, $art_cnhmrlgxvc$art_c = arrs.length; $art_ilrmfs$art_i < $art_cnhmrlgxvc$art_c; $art_ilrmfs$art_i++) {    var item = arrs[$art_ilrmfs$art_i]%>';
    for (var $art_ilrmfs$art_i = 0, $art_cnhmrlgxvc$art_c = arrs.length; $art_ilrmfs$art_i < $art_cnhmrlgxvc$art_c; $art_ilrmfs$art_i++) {
        var item = arrs[$art_ilrmfs$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
