...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikenqcwzm$art_i = 0, $art_cyrimbwh$art_c = arrs.length; $art_ikenqcwzm$art_i < $art_cyrimbwh$art_c; $art_ikenqcwzm$art_i++) {    var item = arrs[$art_ikenqcwzm$art_i]%>';
    for (var $art_ikenqcwzm$art_i = 0, $art_cyrimbwh$art_c = arrs.length; $art_ikenqcwzm$art_i < $art_cyrimbwh$art_c; $art_ikenqcwzm$art_i++) {
        var item = arrs[$art_ikenqcwzm$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
