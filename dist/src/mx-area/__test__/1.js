...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilebdbrb$art_i = 0, $art_czcptcbub$art_c = selected.length; $art_ilebdbrb$art_i < $art_czcptcbub$art_c; $art_ilebdbrb$art_i++) {    var item = selected[$art_ilebdbrb$art_i]%>';
    for (var $art_ilebdbrb$art_i = 0, $art_czcptcbub$art_c = selected.length; $art_ilebdbrb$art_i < $art_czcptcbub$art_c; $art_ilebdbrb$art_i++) {
        var item = selected[$art_ilebdbrb$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
