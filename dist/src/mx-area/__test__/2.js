...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igayjntcsp$art_i = 0, $art_clcudwar$art_c = selected.length; $art_igayjntcsp$art_i < $art_clcudwar$art_c; $art_igayjntcsp$art_i++) {    var item = selected[$art_igayjntcsp$art_i]%>';
    for (var $art_igayjntcsp$art_i = 0, $art_clcudwar$art_c = selected.length; $art_igayjntcsp$art_i < $art_clcudwar$art_c; $art_igayjntcsp$art_i++) {
        var item = selected[$art_igayjntcsp$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
