...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivoahrtcp$art_i = 0, $art_cxgzpunrtld$art_c = arrs.length; $art_ivoahrtcp$art_i < $art_cxgzpunrtld$art_c; $art_ivoahrtcp$art_i++) {    var item = arrs[$art_ivoahrtcp$art_i]%>';
    for (var $art_ivoahrtcp$art_i = 0, $art_cxgzpunrtld$art_c = arrs.length; $art_ivoahrtcp$art_i < $art_cxgzpunrtld$art_c; $art_ivoahrtcp$art_i++) {
        var item = arrs[$art_ivoahrtcp$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
