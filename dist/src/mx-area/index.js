...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cpisbtclj$art_c = types.length; typeIndex < $art_cpisbtclj$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cpisbtclj$art_c = types.length; typeIndex < $art_cpisbtclj$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cqnpwfor$art_c = types.length; typeIndex < $art_cqnpwfor$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cqnpwfor$art_c = types.length; typeIndex < $art_cqnpwfor$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objmqxoowblao$art_obj = type.groups, $art_ckjfdjwbutd$art_c = $art_objmqxoowblao$art_obj.length; groupIndex < $art_ckjfdjwbutd$art_c; groupIndex++) {        var group = $art_objmqxoowblao$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objmqxoowblao$art_obj = type.groups, $art_ckjfdjwbutd$art_c = $art_objmqxoowblao$art_obj.length; groupIndex < $art_ckjfdjwbutd$art_c; groupIndex++) {
            var group = $art_objmqxoowblao$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cgzttmf$art_c = group.length; areaIndex < $art_cgzttmf$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cgzttmf$art_c = group.length; areaIndex < $art_cgzttmf$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ijwonttwb$art_i = 0, $art_objraxkqcbh$art_obj = area.provinces, $art_cmaprddnrl$art_c = $art_objraxkqcbh$art_obj.length; $art_ijwonttwb$art_i < $art_cmaprddnrl$art_c; $art_ijwonttwb$art_i++) {                var province = $art_objraxkqcbh$art_obj[$art_ijwonttwb$art_i]%>';
                for (var $art_ijwonttwb$art_i = 0, $art_objraxkqcbh$art_obj = area.provinces, $art_cmaprddnrl$art_c = $art_objraxkqcbh$art_obj.length; $art_ijwonttwb$art_i < $art_cmaprddnrl$art_c; $art_ijwonttwb$art_i++) {
                    var province = $art_objraxkqcbh$art_obj[$art_ijwonttwb$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_itqtaooifn$art_i = 0, $art_objznlpsmzi$art_obj = province.cities, $art_cygilwgrok$art_c = $art_objznlpsmzi$art_obj.length; $art_itqtaooifn$art_i < $art_cygilwgrok$art_c; $art_itqtaooifn$art_i++) {                    var city = $art_objznlpsmzi$art_obj[$art_itqtaooifn$art_i]%>';
                    for (var $art_itqtaooifn$art_i = 0, $art_objznlpsmzi$art_obj = province.cities, $art_cygilwgrok$art_c = $art_objznlpsmzi$art_obj.length; $art_itqtaooifn$art_i < $art_cygilwgrok$art_c; $art_itqtaooifn$art_i++) {
                        var city = $art_objznlpsmzi$art_obj[$art_itqtaooifn$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
