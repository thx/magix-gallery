...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cwabepoap$art_c = types.length; typeIndex < $art_cwabepoap$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cwabepoap$art_c = types.length; typeIndex < $art_cwabepoap$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cvsuxjtr$art_c = types.length; typeIndex < $art_cvsuxjtr$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cvsuxjtr$art_c = types.length; typeIndex < $art_cvsuxjtr$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objrrjih$art_obj = type.groups, $art_ckeljt$art_c = $art_objrrjih$art_obj.length; groupIndex < $art_ckeljt$art_c; groupIndex++) {        var group = $art_objrrjih$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objrrjih$art_obj = type.groups, $art_ckeljt$art_c = $art_objrrjih$art_obj.length; groupIndex < $art_ckeljt$art_c; groupIndex++) {
            var group = $art_objrrjih$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cfqvknfm$art_c = group.length; areaIndex < $art_cfqvknfm$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cfqvknfm$art_c = group.length; areaIndex < $art_cfqvknfm$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iqxfibcq$art_i = 0, $art_objovcozdfm$art_obj = area.provinces, $art_cgijzwomys$art_c = $art_objovcozdfm$art_obj.length; $art_iqxfibcq$art_i < $art_cgijzwomys$art_c; $art_iqxfibcq$art_i++) {                var province = $art_objovcozdfm$art_obj[$art_iqxfibcq$art_i]%>';
                for (var $art_iqxfibcq$art_i = 0, $art_objovcozdfm$art_obj = area.provinces, $art_cgijzwomys$art_c = $art_objovcozdfm$art_obj.length; $art_iqxfibcq$art_i < $art_cgijzwomys$art_c; $art_iqxfibcq$art_i++) {
                    var province = $art_objovcozdfm$art_obj[$art_iqxfibcq$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_isnbqocki$art_i = 0, $art_objcrywysbg$art_obj = province.cities, $art_cyjxcvu$art_c = $art_objcrywysbg$art_obj.length; $art_isnbqocki$art_i < $art_cyjxcvu$art_c; $art_isnbqocki$art_i++) {                    var city = $art_objcrywysbg$art_obj[$art_isnbqocki$art_i]%>';
                    for (var $art_isnbqocki$art_i = 0, $art_objcrywysbg$art_obj = province.cities, $art_cyjxcvu$art_c = $art_objcrywysbg$art_obj.length; $art_isnbqocki$art_i < $art_cyjxcvu$art_c; $art_isnbqocki$art_i++) {
                        var city = $art_objcrywysbg$art_obj[$art_isnbqocki$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
