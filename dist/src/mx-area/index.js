...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cjjlieukt$art_c = types.length; typeIndex < $art_cjjlieukt$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cjjlieukt$art_c = types.length; typeIndex < $art_cjjlieukt$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cwbbjditjzj$art_c = types.length; typeIndex < $art_cwbbjditjzj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cwbbjditjzj$art_c = types.length; typeIndex < $art_cwbbjditjzj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objsmoosgqp$art_obj = type.groups, $art_cjypekwa$art_c = $art_objsmoosgqp$art_obj.length; groupIndex < $art_cjypekwa$art_c; groupIndex++) {        var group = $art_objsmoosgqp$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objsmoosgqp$art_obj = type.groups, $art_cjypekwa$art_c = $art_objsmoosgqp$art_obj.length; groupIndex < $art_cjypekwa$art_c; groupIndex++) {
            var group = $art_objsmoosgqp$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjxyaamhkffk$art_c = group.length; areaIndex < $art_cjxyaamhkffk$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjxyaamhkffk$art_c = group.length; areaIndex < $art_cjxyaamhkffk$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ialfbcm$art_i = 0, $art_objflvpocavr$art_obj = area.provinces, $art_cieueuxq$art_c = $art_objflvpocavr$art_obj.length; $art_ialfbcm$art_i < $art_cieueuxq$art_c; $art_ialfbcm$art_i++) {                var province = $art_objflvpocavr$art_obj[$art_ialfbcm$art_i]%>';
                for (var $art_ialfbcm$art_i = 0, $art_objflvpocavr$art_obj = area.provinces, $art_cieueuxq$art_c = $art_objflvpocavr$art_obj.length; $art_ialfbcm$art_i < $art_cieueuxq$art_c; $art_ialfbcm$art_i++) {
                    var province = $art_objflvpocavr$art_obj[$art_ialfbcm$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_izxxhwknrl$art_i = 0, $art_objdjfwogh$art_obj = province.cities, $art_coulexpuzdf$art_c = $art_objdjfwogh$art_obj.length; $art_izxxhwknrl$art_i < $art_coulexpuzdf$art_c; $art_izxxhwknrl$art_i++) {                    var city = $art_objdjfwogh$art_obj[$art_izxxhwknrl$art_i]%>';
                    for (var $art_izxxhwknrl$art_i = 0, $art_objdjfwogh$art_obj = province.cities, $art_coulexpuzdf$art_c = $art_objdjfwogh$art_obj.length; $art_izxxhwknrl$art_i < $art_coulexpuzdf$art_c; $art_izxxhwknrl$art_i++) {
                        var city = $art_objdjfwogh$art_obj[$art_izxxhwknrl$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
