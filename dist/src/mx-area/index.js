...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cjsuclitwaz$art_c = types.length; typeIndex < $art_cjsuclitwaz$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cjsuclitwaz$art_c = types.length; typeIndex < $art_cjsuclitwaz$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cizpyfhj$art_c = types.length; typeIndex < $art_cizpyfhj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cizpyfhj$art_c = types.length; typeIndex < $art_cizpyfhj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objqhvewc$art_obj = type.groups, $art_cyiajtod$art_c = $art_objqhvewc$art_obj.length; groupIndex < $art_cyiajtod$art_c; groupIndex++) {        var group = $art_objqhvewc$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objqhvewc$art_obj = type.groups, $art_cyiajtod$art_c = $art_objqhvewc$art_obj.length; groupIndex < $art_cyiajtod$art_c; groupIndex++) {
            var group = $art_objqhvewc$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cwrmwxdf$art_c = group.length; areaIndex < $art_cwrmwxdf$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cwrmwxdf$art_c = group.length; areaIndex < $art_cwrmwxdf$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iumtkerym$art_i = 0, $art_objxmwkedk$art_obj = area.provinces, $art_cnztla$art_c = $art_objxmwkedk$art_obj.length; $art_iumtkerym$art_i < $art_cnztla$art_c; $art_iumtkerym$art_i++) {                var province = $art_objxmwkedk$art_obj[$art_iumtkerym$art_i]%>';
                for (var $art_iumtkerym$art_i = 0, $art_objxmwkedk$art_obj = area.provinces, $art_cnztla$art_c = $art_objxmwkedk$art_obj.length; $art_iumtkerym$art_i < $art_cnztla$art_c; $art_iumtkerym$art_i++) {
                    var province = $art_objxmwkedk$art_obj[$art_iumtkerym$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iaybyqhasjn$art_i = 0, $art_objzthxsgjwc$art_obj = province.cities, $art_csdgtvowmk$art_c = $art_objzthxsgjwc$art_obj.length; $art_iaybyqhasjn$art_i < $art_csdgtvowmk$art_c; $art_iaybyqhasjn$art_i++) {                    var city = $art_objzthxsgjwc$art_obj[$art_iaybyqhasjn$art_i]%>';
                    for (var $art_iaybyqhasjn$art_i = 0, $art_objzthxsgjwc$art_obj = province.cities, $art_csdgtvowmk$art_c = $art_objzthxsgjwc$art_obj.length; $art_iaybyqhasjn$art_i < $art_csdgtvowmk$art_c; $art_iaybyqhasjn$art_i++) {
                        var city = $art_objzthxsgjwc$art_obj[$art_iaybyqhasjn$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
