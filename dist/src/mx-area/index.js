...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_clgmcdio$art_c = types.length; typeIndex < $art_clgmcdio$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_clgmcdio$art_c = types.length; typeIndex < $art_clgmcdio$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cuucfnuup$art_c = types.length; typeIndex < $art_cuucfnuup$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cuucfnuup$art_c = types.length; typeIndex < $art_cuucfnuup$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objrmzrhoq$art_obj = type.groups, $art_cmurkvpwi$art_c = $art_objrmzrhoq$art_obj.length; groupIndex < $art_cmurkvpwi$art_c; groupIndex++) {        var group = $art_objrmzrhoq$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objrmzrhoq$art_obj = type.groups, $art_cmurkvpwi$art_c = $art_objrmzrhoq$art_obj.length; groupIndex < $art_cmurkvpwi$art_c; groupIndex++) {
            var group = $art_objrmzrhoq$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cnendhryw$art_c = group.length; areaIndex < $art_cnendhryw$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cnendhryw$art_c = group.length; areaIndex < $art_cnendhryw$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_idjcaisjw$art_i = 0, $art_objnqpdxopro$art_obj = area.provinces, $art_cobjqqrlj$art_c = $art_objnqpdxopro$art_obj.length; $art_idjcaisjw$art_i < $art_cobjqqrlj$art_c; $art_idjcaisjw$art_i++) {                var province = $art_objnqpdxopro$art_obj[$art_idjcaisjw$art_i]%>';
                for (var $art_idjcaisjw$art_i = 0, $art_objnqpdxopro$art_obj = area.provinces, $art_cobjqqrlj$art_c = $art_objnqpdxopro$art_obj.length; $art_idjcaisjw$art_i < $art_cobjqqrlj$art_c; $art_idjcaisjw$art_i++) {
                    var province = $art_objnqpdxopro$art_obj[$art_idjcaisjw$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imqcxfp$art_i = 0, $art_objmpikui$art_obj = province.cities, $art_cgawhglfb$art_c = $art_objmpikui$art_obj.length; $art_imqcxfp$art_i < $art_cgawhglfb$art_c; $art_imqcxfp$art_i++) {                    var city = $art_objmpikui$art_obj[$art_imqcxfp$art_i]%>';
                    for (var $art_imqcxfp$art_i = 0, $art_objmpikui$art_obj = province.cities, $art_cgawhglfb$art_c = $art_objmpikui$art_obj.length; $art_imqcxfp$art_i < $art_cgawhglfb$art_c; $art_imqcxfp$art_i++) {
                        var city = $art_objmpikui$art_obj[$art_imqcxfp$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
