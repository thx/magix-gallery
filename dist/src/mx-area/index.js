...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cvbjguq$art_c = types.length; typeIndex < $art_cvbjguq$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cvbjguq$art_c = types.length; typeIndex < $art_cvbjguq$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cxjqukc$art_c = types.length; typeIndex < $art_cxjqukc$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cxjqukc$art_c = types.length; typeIndex < $art_cxjqukc$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objjmfpfwel$art_obj = type.groups, $art_cotoidvcftk$art_c = $art_objjmfpfwel$art_obj.length; groupIndex < $art_cotoidvcftk$art_c; groupIndex++) {        var group = $art_objjmfpfwel$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objjmfpfwel$art_obj = type.groups, $art_cotoidvcftk$art_c = $art_objjmfpfwel$art_obj.length; groupIndex < $art_cotoidvcftk$art_c; groupIndex++) {
            var group = $art_objjmfpfwel$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjgfvovyl$art_c = group.length; areaIndex < $art_cjgfvovyl$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjgfvovyl$art_c = group.length; areaIndex < $art_cjgfvovyl$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_itmrsawc$art_i = 0, $art_objqxeawheb$art_obj = area.provinces, $art_cnpehhzjfki$art_c = $art_objqxeawheb$art_obj.length; $art_itmrsawc$art_i < $art_cnpehhzjfki$art_c; $art_itmrsawc$art_i++) {                var province = $art_objqxeawheb$art_obj[$art_itmrsawc$art_i]%>';
                for (var $art_itmrsawc$art_i = 0, $art_objqxeawheb$art_obj = area.provinces, $art_cnpehhzjfki$art_c = $art_objqxeawheb$art_obj.length; $art_itmrsawc$art_i < $art_cnpehhzjfki$art_c; $art_itmrsawc$art_i++) {
                    var province = $art_objqxeawheb$art_obj[$art_itmrsawc$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_izcf$art_i = 0, $art_objfxscrn$art_obj = province.cities, $art_cxiajxikue$art_c = $art_objfxscrn$art_obj.length; $art_izcf$art_i < $art_cxiajxikue$art_c; $art_izcf$art_i++) {                    var city = $art_objfxscrn$art_obj[$art_izcf$art_i]%>';
                    for (var $art_izcf$art_i = 0, $art_objfxscrn$art_obj = province.cities, $art_cxiajxikue$art_c = $art_objfxscrn$art_obj.length; $art_izcf$art_i < $art_cxiajxikue$art_c; $art_izcf$art_i++) {
                        var city = $art_objfxscrn$art_obj[$art_izcf$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
