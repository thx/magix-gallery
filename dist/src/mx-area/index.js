...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cfakazp$art_c = types.length; typeIndex < $art_cfakazp$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cfakazp$art_c = types.length; typeIndex < $art_cfakazp$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_czffttuyi$art_c = types.length; typeIndex < $art_czffttuyi$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_czffttuyi$art_c = types.length; typeIndex < $art_czffttuyi$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objktkbmiq$art_obj = type.groups, $art_cirnmbha$art_c = $art_objktkbmiq$art_obj.length; groupIndex < $art_cirnmbha$art_c; groupIndex++) {        var group = $art_objktkbmiq$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objktkbmiq$art_obj = type.groups, $art_cirnmbha$art_c = $art_objktkbmiq$art_obj.length; groupIndex < $art_cirnmbha$art_c; groupIndex++) {
            var group = $art_objktkbmiq$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cpcpmb$art_c = group.length; areaIndex < $art_cpcpmb$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cpcpmb$art_c = group.length; areaIndex < $art_cpcpmb$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_irodbkl$art_i = 0, $art_objwkipftagi$art_obj = area.provinces, $art_cvwtdluykd$art_c = $art_objwkipftagi$art_obj.length; $art_irodbkl$art_i < $art_cvwtdluykd$art_c; $art_irodbkl$art_i++) {                var province = $art_objwkipftagi$art_obj[$art_irodbkl$art_i]%>';
                for (var $art_irodbkl$art_i = 0, $art_objwkipftagi$art_obj = area.provinces, $art_cvwtdluykd$art_c = $art_objwkipftagi$art_obj.length; $art_irodbkl$art_i < $art_cvwtdluykd$art_c; $art_irodbkl$art_i++) {
                    var province = $art_objwkipftagi$art_obj[$art_irodbkl$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iwjwgujjq$art_i = 0, $art_objhehwozdvs$art_obj = province.cities, $art_czhmox$art_c = $art_objhehwozdvs$art_obj.length; $art_iwjwgujjq$art_i < $art_czhmox$art_c; $art_iwjwgujjq$art_i++) {                    var city = $art_objhehwozdvs$art_obj[$art_iwjwgujjq$art_i]%>';
                    for (var $art_iwjwgujjq$art_i = 0, $art_objhehwozdvs$art_obj = province.cities, $art_czhmox$art_c = $art_objhehwozdvs$art_obj.length; $art_iwjwgujjq$art_i < $art_czhmox$art_c; $art_iwjwgujjq$art_i++) {
                        var city = $art_objhehwozdvs$art_obj[$art_iwjwgujjq$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
