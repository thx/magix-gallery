...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ckvukyakm$art_c = types.length; typeIndex < $art_ckvukyakm$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ckvukyakm$art_c = types.length; typeIndex < $art_ckvukyakm$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cgojcpokkp$art_c = types.length; typeIndex < $art_cgojcpokkp$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cgojcpokkp$art_c = types.length; typeIndex < $art_cgojcpokkp$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objhqrkra$art_obj = type.groups, $art_cgcfrfd$art_c = $art_objhqrkra$art_obj.length; groupIndex < $art_cgcfrfd$art_c; groupIndex++) {        var group = $art_objhqrkra$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objhqrkra$art_obj = type.groups, $art_cgcfrfd$art_c = $art_objhqrkra$art_obj.length; groupIndex < $art_cgcfrfd$art_c; groupIndex++) {
            var group = $art_objhqrkra$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ctktua$art_c = group.length; areaIndex < $art_ctktua$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ctktua$art_c = group.length; areaIndex < $art_ctktua$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iptjfyr$art_i = 0, $art_objntvcl$art_obj = area.provinces, $art_cvsnwsnem$art_c = $art_objntvcl$art_obj.length; $art_iptjfyr$art_i < $art_cvsnwsnem$art_c; $art_iptjfyr$art_i++) {                var province = $art_objntvcl$art_obj[$art_iptjfyr$art_i]%>';
                for (var $art_iptjfyr$art_i = 0, $art_objntvcl$art_obj = area.provinces, $art_cvsnwsnem$art_c = $art_objntvcl$art_obj.length; $art_iptjfyr$art_i < $art_cvsnwsnem$art_c; $art_iptjfyr$art_i++) {
                    var province = $art_objntvcl$art_obj[$art_iptjfyr$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_icqgepnya$art_i = 0, $art_objbjjoajvt$art_obj = province.cities, $art_ccsqsemee$art_c = $art_objbjjoajvt$art_obj.length; $art_icqgepnya$art_i < $art_ccsqsemee$art_c; $art_icqgepnya$art_i++) {                    var city = $art_objbjjoajvt$art_obj[$art_icqgepnya$art_i]%>';
                    for (var $art_icqgepnya$art_i = 0, $art_objbjjoajvt$art_obj = province.cities, $art_ccsqsemee$art_c = $art_objbjjoajvt$art_obj.length; $art_icqgepnya$art_i < $art_ccsqsemee$art_c; $art_icqgepnya$art_i++) {
                        var city = $art_objbjjoajvt$art_obj[$art_icqgepnya$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
