...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cprdcjcpg$art_c = types.length; typeIndex < $art_cprdcjcpg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cprdcjcpg$art_c = types.length; typeIndex < $art_cprdcjcpg$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ccmigbyfz$art_c = types.length; typeIndex < $art_ccmigbyfz$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ccmigbyfz$art_c = types.length; typeIndex < $art_ccmigbyfz$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objynkdcouc$art_obj = type.groups, $art_couwmcq$art_c = $art_objynkdcouc$art_obj.length; groupIndex < $art_couwmcq$art_c; groupIndex++) {        var group = $art_objynkdcouc$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objynkdcouc$art_obj = type.groups, $art_couwmcq$art_c = $art_objynkdcouc$art_obj.length; groupIndex < $art_couwmcq$art_c; groupIndex++) {
            var group = $art_objynkdcouc$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cefeyssdb$art_c = group.length; areaIndex < $art_cefeyssdb$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cefeyssdb$art_c = group.length; areaIndex < $art_cefeyssdb$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_igujyppt$art_i = 0, $art_objkhtjldkxb$art_obj = area.provinces, $art_cmtarjkjgc$art_c = $art_objkhtjldkxb$art_obj.length; $art_igujyppt$art_i < $art_cmtarjkjgc$art_c; $art_igujyppt$art_i++) {                var province = $art_objkhtjldkxb$art_obj[$art_igujyppt$art_i]%>';
                for (var $art_igujyppt$art_i = 0, $art_objkhtjldkxb$art_obj = area.provinces, $art_cmtarjkjgc$art_c = $art_objkhtjldkxb$art_obj.length; $art_igujyppt$art_i < $art_cmtarjkjgc$art_c; $art_igujyppt$art_i++) {
                    var province = $art_objkhtjldkxb$art_obj[$art_igujyppt$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ieuddlue$art_i = 0, $art_objtjegqyenp$art_obj = province.cities, $art_czeenxdwkup$art_c = $art_objtjegqyenp$art_obj.length; $art_ieuddlue$art_i < $art_czeenxdwkup$art_c; $art_ieuddlue$art_i++) {                    var city = $art_objtjegqyenp$art_obj[$art_ieuddlue$art_i]%>';
                    for (var $art_ieuddlue$art_i = 0, $art_objtjegqyenp$art_obj = province.cities, $art_czeenxdwkup$art_c = $art_objtjegqyenp$art_obj.length; $art_ieuddlue$art_i < $art_czeenxdwkup$art_c; $art_ieuddlue$art_i++) {
                        var city = $art_objtjegqyenp$art_obj[$art_ieuddlue$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
