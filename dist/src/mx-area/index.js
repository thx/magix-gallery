...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cxvpbtwkc$art_c = types.length; typeIndex < $art_cxvpbtwkc$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cxvpbtwkc$art_c = types.length; typeIndex < $art_cxvpbtwkc$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ckrqrbqrxxs$art_c = types.length; typeIndex < $art_ckrqrbqrxxs$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ckrqrbqrxxs$art_c = types.length; typeIndex < $art_ckrqrbqrxxs$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objjioqjb$art_obj = type.groups, $art_cymrg$art_c = $art_objjioqjb$art_obj.length; groupIndex < $art_cymrg$art_c; groupIndex++) {        var group = $art_objjioqjb$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objjioqjb$art_obj = type.groups, $art_cymrg$art_c = $art_objjioqjb$art_obj.length; groupIndex < $art_cymrg$art_c; groupIndex++) {
            var group = $art_objjioqjb$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_clwckjmjn$art_c = group.length; areaIndex < $art_clwckjmjn$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_clwckjmjn$art_c = group.length; areaIndex < $art_clwckjmjn$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iyjwcohy$art_i = 0, $art_objiigwzoct$art_obj = area.provinces, $art_crbwzsga$art_c = $art_objiigwzoct$art_obj.length; $art_iyjwcohy$art_i < $art_crbwzsga$art_c; $art_iyjwcohy$art_i++) {                var province = $art_objiigwzoct$art_obj[$art_iyjwcohy$art_i]%>';
                for (var $art_iyjwcohy$art_i = 0, $art_objiigwzoct$art_obj = area.provinces, $art_crbwzsga$art_c = $art_objiigwzoct$art_obj.length; $art_iyjwcohy$art_i < $art_crbwzsga$art_c; $art_iyjwcohy$art_i++) {
                    var province = $art_objiigwzoct$art_obj[$art_iyjwcohy$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ihfhjahqeh$art_i = 0, $art_objayqyklece$art_obj = province.cities, $art_ctcjgpptgh$art_c = $art_objayqyklece$art_obj.length; $art_ihfhjahqeh$art_i < $art_ctcjgpptgh$art_c; $art_ihfhjahqeh$art_i++) {                    var city = $art_objayqyklece$art_obj[$art_ihfhjahqeh$art_i]%>';
                    for (var $art_ihfhjahqeh$art_i = 0, $art_objayqyklece$art_obj = province.cities, $art_ctcjgpptgh$art_c = $art_objayqyklece$art_obj.length; $art_ihfhjahqeh$art_i < $art_ctcjgpptgh$art_c; $art_ihfhjahqeh$art_i++) {
                        var city = $art_objayqyklece$art_obj[$art_ihfhjahqeh$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
