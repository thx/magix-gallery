...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cwcscenv$art_c = types.length; typeIndex < $art_cwcscenv$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cwcscenv$art_c = types.length; typeIndex < $art_cwcscenv$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_casykifb$art_c = types.length; typeIndex < $art_casykifb$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_casykifb$art_c = types.length; typeIndex < $art_casykifb$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objlqkntrclf$art_obj = type.groups, $art_cjkzklsy$art_c = $art_objlqkntrclf$art_obj.length; groupIndex < $art_cjkzklsy$art_c; groupIndex++) {        var group = $art_objlqkntrclf$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objlqkntrclf$art_obj = type.groups, $art_cjkzklsy$art_c = $art_objlqkntrclf$art_obj.length; groupIndex < $art_cjkzklsy$art_c; groupIndex++) {
            var group = $art_objlqkntrclf$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cdfdmbsird$art_c = group.length; areaIndex < $art_cdfdmbsird$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cdfdmbsird$art_c = group.length; areaIndex < $art_cdfdmbsird$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iaepacwhnu$art_i = 0, $art_objjbwrclui$art_obj = area.provinces, $art_cynwnduh$art_c = $art_objjbwrclui$art_obj.length; $art_iaepacwhnu$art_i < $art_cynwnduh$art_c; $art_iaepacwhnu$art_i++) {                var province = $art_objjbwrclui$art_obj[$art_iaepacwhnu$art_i]%>';
                for (var $art_iaepacwhnu$art_i = 0, $art_objjbwrclui$art_obj = area.provinces, $art_cynwnduh$art_c = $art_objjbwrclui$art_obj.length; $art_iaepacwhnu$art_i < $art_cynwnduh$art_c; $art_iaepacwhnu$art_i++) {
                    var province = $art_objjbwrclui$art_obj[$art_iaepacwhnu$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iozvxciefd$art_i = 0, $art_objrfylgrbpkf$art_obj = province.cities, $art_cwbjfmllie$art_c = $art_objrfylgrbpkf$art_obj.length; $art_iozvxciefd$art_i < $art_cwbjfmllie$art_c; $art_iozvxciefd$art_i++) {                    var city = $art_objrfylgrbpkf$art_obj[$art_iozvxciefd$art_i]%>';
                    for (var $art_iozvxciefd$art_i = 0, $art_objrfylgrbpkf$art_obj = province.cities, $art_cwbjfmllie$art_c = $art_objrfylgrbpkf$art_obj.length; $art_iozvxciefd$art_i < $art_cwbjfmllie$art_c; $art_iozvxciefd$art_i++) {
                        var city = $art_objrfylgrbpkf$art_obj[$art_iozvxciefd$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
