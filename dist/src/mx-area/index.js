...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbvtfbezph$art_c = types.length; typeIndex < $art_cbvtfbezph$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbvtfbezph$art_c = types.length; typeIndex < $art_cbvtfbezph$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_clawknptc$art_c = types.length; typeIndex < $art_clawknptc$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_clawknptc$art_c = types.length; typeIndex < $art_clawknptc$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objpxpsfqfjrg$art_obj = type.groups, $art_ccgmfazlnm$art_c = $art_objpxpsfqfjrg$art_obj.length; groupIndex < $art_ccgmfazlnm$art_c; groupIndex++) {        var group = $art_objpxpsfqfjrg$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objpxpsfqfjrg$art_obj = type.groups, $art_ccgmfazlnm$art_c = $art_objpxpsfqfjrg$art_obj.length; groupIndex < $art_ccgmfazlnm$art_c; groupIndex++) {
            var group = $art_objpxpsfqfjrg$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjubkuuyk$art_c = group.length; areaIndex < $art_cjubkuuyk$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjubkuuyk$art_c = group.length; areaIndex < $art_cjubkuuyk$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iyfrsezmv$art_i = 0, $art_objcgtdnnk$art_obj = area.provinces, $art_ckosjjfj$art_c = $art_objcgtdnnk$art_obj.length; $art_iyfrsezmv$art_i < $art_ckosjjfj$art_c; $art_iyfrsezmv$art_i++) {                var province = $art_objcgtdnnk$art_obj[$art_iyfrsezmv$art_i]%>';
                for (var $art_iyfrsezmv$art_i = 0, $art_objcgtdnnk$art_obj = area.provinces, $art_ckosjjfj$art_c = $art_objcgtdnnk$art_obj.length; $art_iyfrsezmv$art_i < $art_ckosjjfj$art_c; $art_iyfrsezmv$art_i++) {
                    var province = $art_objcgtdnnk$art_obj[$art_iyfrsezmv$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_izpkoajj$art_i = 0, $art_objlalwyfq$art_obj = province.cities, $art_cmxetbhdg$art_c = $art_objlalwyfq$art_obj.length; $art_izpkoajj$art_i < $art_cmxetbhdg$art_c; $art_izpkoajj$art_i++) {                    var city = $art_objlalwyfq$art_obj[$art_izpkoajj$art_i]%>';
                    for (var $art_izpkoajj$art_i = 0, $art_objlalwyfq$art_obj = province.cities, $art_cmxetbhdg$art_c = $art_objlalwyfq$art_obj.length; $art_izpkoajj$art_i < $art_cmxetbhdg$art_c; $art_izpkoajj$art_i++) {
                        var city = $art_objlalwyfq$art_obj[$art_izpkoajj$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
