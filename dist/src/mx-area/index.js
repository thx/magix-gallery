...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_conbczez$art_c = types.length; typeIndex < $art_conbczez$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_conbczez$art_c = types.length; typeIndex < $art_conbczez$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cqupssdp$art_c = types.length; typeIndex < $art_cqupssdp$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cqupssdp$art_c = types.length; typeIndex < $art_cqupssdp$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objfacesvb$art_obj = type.groups, $art_cubdpnuifn$art_c = $art_objfacesvb$art_obj.length; groupIndex < $art_cubdpnuifn$art_c; groupIndex++) {        var group = $art_objfacesvb$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objfacesvb$art_obj = type.groups, $art_cubdpnuifn$art_c = $art_objfacesvb$art_obj.length; groupIndex < $art_cubdpnuifn$art_c; groupIndex++) {
            var group = $art_objfacesvb$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cngkwytnq$art_c = group.length; areaIndex < $art_cngkwytnq$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cngkwytnq$art_c = group.length; areaIndex < $art_cngkwytnq$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iwdneyunjf$art_i = 0, $art_objxcucxds$art_obj = area.provinces, $art_cdpsmcwssyl$art_c = $art_objxcucxds$art_obj.length; $art_iwdneyunjf$art_i < $art_cdpsmcwssyl$art_c; $art_iwdneyunjf$art_i++) {                var province = $art_objxcucxds$art_obj[$art_iwdneyunjf$art_i]%>';
                for (var $art_iwdneyunjf$art_i = 0, $art_objxcucxds$art_obj = area.provinces, $art_cdpsmcwssyl$art_c = $art_objxcucxds$art_obj.length; $art_iwdneyunjf$art_i < $art_cdpsmcwssyl$art_c; $art_iwdneyunjf$art_i++) {
                    var province = $art_objxcucxds$art_obj[$art_iwdneyunjf$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iwvdnrc$art_i = 0, $art_objbjqmuxesl$art_obj = province.cities, $art_cjvtlsmgth$art_c = $art_objbjqmuxesl$art_obj.length; $art_iwvdnrc$art_i < $art_cjvtlsmgth$art_c; $art_iwvdnrc$art_i++) {                    var city = $art_objbjqmuxesl$art_obj[$art_iwvdnrc$art_i]%>';
                    for (var $art_iwvdnrc$art_i = 0, $art_objbjqmuxesl$art_obj = province.cities, $art_cjvtlsmgth$art_c = $art_objbjqmuxesl$art_obj.length; $art_iwvdnrc$art_i < $art_cjvtlsmgth$art_c; $art_iwvdnrc$art_i++) {
                        var city = $art_objbjqmuxesl$art_obj[$art_iwvdnrc$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
