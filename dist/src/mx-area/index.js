...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ceryijfdavi$art_c = types.length; typeIndex < $art_ceryijfdavi$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ceryijfdavi$art_c = types.length; typeIndex < $art_ceryijfdavi$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cosrpqqls$art_c = types.length; typeIndex < $art_cosrpqqls$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cosrpqqls$art_c = types.length; typeIndex < $art_cosrpqqls$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objftbfqho$art_obj = type.groups, $art_cbsurzej$art_c = $art_objftbfqho$art_obj.length; groupIndex < $art_cbsurzej$art_c; groupIndex++) {        var group = $art_objftbfqho$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objftbfqho$art_obj = type.groups, $art_cbsurzej$art_c = $art_objftbfqho$art_obj.length; groupIndex < $art_cbsurzej$art_c; groupIndex++) {
            var group = $art_objftbfqho$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cfoukmg$art_c = group.length; areaIndex < $art_cfoukmg$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cfoukmg$art_c = group.length; areaIndex < $art_cfoukmg$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iuesbbmc$art_i = 0, $art_objanymcdvet$art_obj = area.provinces, $art_cvdlrckmbul$art_c = $art_objanymcdvet$art_obj.length; $art_iuesbbmc$art_i < $art_cvdlrckmbul$art_c; $art_iuesbbmc$art_i++) {                var province = $art_objanymcdvet$art_obj[$art_iuesbbmc$art_i]%>';
                for (var $art_iuesbbmc$art_i = 0, $art_objanymcdvet$art_obj = area.provinces, $art_cvdlrckmbul$art_c = $art_objanymcdvet$art_obj.length; $art_iuesbbmc$art_i < $art_cvdlrckmbul$art_c; $art_iuesbbmc$art_i++) {
                    var province = $art_objanymcdvet$art_obj[$art_iuesbbmc$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iixnvqkrhrve$art_i = 0, $art_objfrtppl$art_obj = province.cities, $art_cwpbrgbmun$art_c = $art_objfrtppl$art_obj.length; $art_iixnvqkrhrve$art_i < $art_cwpbrgbmun$art_c; $art_iixnvqkrhrve$art_i++) {                    var city = $art_objfrtppl$art_obj[$art_iixnvqkrhrve$art_i]%>';
                    for (var $art_iixnvqkrhrve$art_i = 0, $art_objfrtppl$art_obj = province.cities, $art_cwpbrgbmun$art_c = $art_objfrtppl$art_obj.length; $art_iixnvqkrhrve$art_i < $art_cwpbrgbmun$art_c; $art_iixnvqkrhrve$art_i++) {
                        var city = $art_objfrtppl$art_obj[$art_iixnvqkrhrve$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
