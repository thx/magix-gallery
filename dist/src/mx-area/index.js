...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cfcxsxyaui$art_c = types.length; typeIndex < $art_cfcxsxyaui$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cfcxsxyaui$art_c = types.length; typeIndex < $art_cfcxsxyaui$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cbxwapbt$art_c = types.length; typeIndex < $art_cbxwapbt$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cbxwapbt$art_c = types.length; typeIndex < $art_cbxwapbt$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objcpzwmrxr$art_obj = type.groups, $art_cophgtxkuw$art_c = $art_objcpzwmrxr$art_obj.length; groupIndex < $art_cophgtxkuw$art_c; groupIndex++) {        var group = $art_objcpzwmrxr$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objcpzwmrxr$art_obj = type.groups, $art_cophgtxkuw$art_c = $art_objcpzwmrxr$art_obj.length; groupIndex < $art_cophgtxkuw$art_c; groupIndex++) {
            var group = $art_objcpzwmrxr$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_chfdivuufw$art_c = group.length; areaIndex < $art_chfdivuufw$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_chfdivuufw$art_c = group.length; areaIndex < $art_chfdivuufw$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iblzalf$art_i = 0, $art_objrhmmh$art_obj = area.provinces, $art_cvrpbav$art_c = $art_objrhmmh$art_obj.length; $art_iblzalf$art_i < $art_cvrpbav$art_c; $art_iblzalf$art_i++) {                var province = $art_objrhmmh$art_obj[$art_iblzalf$art_i]%>';
                for (var $art_iblzalf$art_i = 0, $art_objrhmmh$art_obj = area.provinces, $art_cvrpbav$art_c = $art_objrhmmh$art_obj.length; $art_iblzalf$art_i < $art_cvrpbav$art_c; $art_iblzalf$art_i++) {
                    var province = $art_objrhmmh$art_obj[$art_iblzalf$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imzbdqff$art_i = 0, $art_objrdnquf$art_obj = province.cities, $art_cvuwjuck$art_c = $art_objrdnquf$art_obj.length; $art_imzbdqff$art_i < $art_cvuwjuck$art_c; $art_imzbdqff$art_i++) {                    var city = $art_objrdnquf$art_obj[$art_imzbdqff$art_i]%>';
                    for (var $art_imzbdqff$art_i = 0, $art_objrdnquf$art_obj = province.cities, $art_cvuwjuck$art_c = $art_objrdnquf$art_obj.length; $art_imzbdqff$art_i < $art_cvuwjuck$art_c; $art_imzbdqff$art_i++) {
                        var city = $art_objrdnquf$art_obj[$art_imzbdqff$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
