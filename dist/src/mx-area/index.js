...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ctsftcc$art_c = types.length; typeIndex < $art_ctsftcc$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ctsftcc$art_c = types.length; typeIndex < $art_ctsftcc$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cjxfonqca$art_c = types.length; typeIndex < $art_cjxfonqca$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cjxfonqca$art_c = types.length; typeIndex < $art_cjxfonqca$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objaheacyt$art_obj = type.groups, $art_clmnqtgqkc$art_c = $art_objaheacyt$art_obj.length; groupIndex < $art_clmnqtgqkc$art_c; groupIndex++) {        var group = $art_objaheacyt$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objaheacyt$art_obj = type.groups, $art_clmnqtgqkc$art_c = $art_objaheacyt$art_obj.length; groupIndex < $art_clmnqtgqkc$art_c; groupIndex++) {
            var group = $art_objaheacyt$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cgssbcspyq$art_c = group.length; areaIndex < $art_cgssbcspyq$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cgssbcspyq$art_c = group.length; areaIndex < $art_cgssbcspyq$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ialmavjojo$art_i = 0, $art_objrnxnidd$art_obj = area.provinces, $art_cmbzgrlki$art_c = $art_objrnxnidd$art_obj.length; $art_ialmavjojo$art_i < $art_cmbzgrlki$art_c; $art_ialmavjojo$art_i++) {                var province = $art_objrnxnidd$art_obj[$art_ialmavjojo$art_i]%>';
                for (var $art_ialmavjojo$art_i = 0, $art_objrnxnidd$art_obj = area.provinces, $art_cmbzgrlki$art_c = $art_objrnxnidd$art_obj.length; $art_ialmavjojo$art_i < $art_cmbzgrlki$art_c; $art_ialmavjojo$art_i++) {
                    var province = $art_objrnxnidd$art_obj[$art_ialmavjojo$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ilvtmvxg$art_i = 0, $art_objvhgkgdj$art_obj = province.cities, $art_cgylavrkrd$art_c = $art_objvhgkgdj$art_obj.length; $art_ilvtmvxg$art_i < $art_cgylavrkrd$art_c; $art_ilvtmvxg$art_i++) {                    var city = $art_objvhgkgdj$art_obj[$art_ilvtmvxg$art_i]%>';
                    for (var $art_ilvtmvxg$art_i = 0, $art_objvhgkgdj$art_obj = province.cities, $art_cgylavrkrd$art_c = $art_objvhgkgdj$art_obj.length; $art_ilvtmvxg$art_i < $art_cgylavrkrd$art_c; $art_ilvtmvxg$art_i++) {
                        var city = $art_objvhgkgdj$art_obj[$art_ilvtmvxg$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
