...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_galleryY:_" class="mc-iconfont search-icon">&#xe651;</i><input mx-keyup="' + $viewId + '@{search}()" class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (isTab) {
        ;
        $p += '<div mxv mxa="_zs_galleryY:_" class="_zs_gallery_mx-area_index_-tabs clearfix">';
        $line = 7;
        $art = 'each types as type typeIndex';
        ;
        $expr = '<%for (var typeIndex = 0, $art_csuahglsl$art_c = types.length; typeIndex < $art_csuahglsl$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_csuahglsl$art_c = types.length; typeIndex < $art_csuahglsl$art_c; typeIndex++) {
            ...
            ;
            $p += ' clearfix"><div mxv mxa="_zs_galleryY:a" class="_zs_gallery_mx-area_index_-tab-check"><input type="checkbox" mx-change="' + $viewId + '@{changeAll}({typeIndex:';
            $line = 11;
            $art = '=typeIndex';
            ;
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_comiruncqga$art_c = types.length; typeIndex < $art_comiruncqga$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_comiruncqga$art_c = types.length; typeIndex < $art_comiruncqga$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        if (!isTab) {
            ;
            $p += '<div mxv mxa="_zs_galleryY:b" class="_zs_gallery_mx-area_index_-all"><label mxv for="';
            $line = 25;
            $art = '=viewId';
            ;
            ...
            ;
            $p += '/><span mxa="_zs_galleryY:c" class="ml5">全选 - ';
            $line = 27;
            $art = '=type.name';
            ;
        ...
        ;
        $p += '<div mxv mxa="_zs_galleryY:d" class="clearfix">';
        $line = 32;
        $art = 'each type.groups as group groupIndex';
        ;
        $expr = '<%for (var groupIndex = 0, $art_objrcuqpwmna$art_obj = type.groups, $art_cyjgtejmch$art_c = $art_objrcuqpwmna$art_obj.length; groupIndex < $art_cyjgtejmch$art_c; groupIndex++) {        var group = $art_objrcuqpwmna$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objrcuqpwmna$art_obj = type.groups, $art_cyjgtejmch$art_c = $art_objrcuqpwmna$art_obj.length; groupIndex < $art_cyjgtejmch$art_c; groupIndex++) {
            var group = $art_objrcuqpwmna$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cushqpdejan$art_c = group.length; areaIndex < $art_cushqpdejan$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cushqpdejan$art_c = group.length; areaIndex < $art_cushqpdejan$art_c; areaIndex++) {
                ...
                if (area.name) {
                    ;
                    $p += '<div mxv mxa="_zs_galleryY:e" class="_zs_gallery_mx-area_index_-area"><div mxa="_zs_galleryY:f" class="_zs_gallery_mx-area_index_-area-name">';
                    $line = 37;
                    $art = '=area.name';
                    ;
                ...
                ;
                $p += '<div mxv mxa="_zs_galleryY:g" class="_zs_gallery_mx-area_index_-provinces clearfix">';
                $line = 40;
                $art = 'each area.provinces as province';
                ;
                $expr = '<%for (var $art_inevollcnpi$art_i = 0, $art_objsrvklnwhm$art_obj = area.provinces, $art_cytdzrvuyv$art_c = $art_objsrvklnwhm$art_obj.length; $art_inevollcnpi$art_i < $art_cytdzrvuyv$art_c; $art_inevollcnpi$art_i++) {                var province = $art_objsrvklnwhm$art_obj[$art_inevollcnpi$art_i]%>';
                for (var $art_inevollcnpi$art_i = 0, $art_objsrvklnwhm$art_obj = area.provinces, $art_cytdzrvuyv$art_c = $art_objsrvklnwhm$art_obj.length; $art_inevollcnpi$art_i < $art_cytdzrvuyv$art_c; $art_inevollcnpi$art_i++) {
                    var province = $art_objsrvklnwhm$art_obj[$art_inevollcnpi$art_i];
                    ...
                    if (province.hasCity && (province.count > 0)) {
                        ;
                        $p += '<span mxa="_zs_galleryY:h" class="_zs_gallery_mx-area_index_-province-count">(';
                        $line = 47;
                        $art = '=province.count';
                        ;
                    ...
                    ;
                    $expr = '<%for (var $art_ickpjao$art_i = 0, $art_objoldaosxu$art_obj = province.cities, $art_cstifsegxy$art_c = $art_objoldaosxu$art_obj.length; $art_ickpjao$art_i < $art_cstifsegxy$art_c; $art_ickpjao$art_i++) {                    var city = $art_objoldaosxu$art_obj[$art_ickpjao$art_i]%>';
                    for (var $art_ickpjao$art_i = 0, $art_objoldaosxu$art_obj = province.cities, $art_cstifsegxy$art_c = $art_objoldaosxu$art_obj.length; $art_ickpjao$art_i < $art_cstifsegxy$art_c; $art_ickpjao$art_i++) {
                        var city = $art_objoldaosxu$art_obj[$art_ickpjao$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
