...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cublbefgk$art_c = types.length; typeIndex < $art_cublbefgk$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cublbefgk$art_c = types.length; typeIndex < $art_cublbefgk$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ckjbeq$art_c = types.length; typeIndex < $art_ckjbeq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ckjbeq$art_c = types.length; typeIndex < $art_ckjbeq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objvsdemudge$art_obj = type.groups, $art_creaseucll$art_c = $art_objvsdemudge$art_obj.length; groupIndex < $art_creaseucll$art_c; groupIndex++) {        var group = $art_objvsdemudge$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objvsdemudge$art_obj = type.groups, $art_creaseucll$art_c = $art_objvsdemudge$art_obj.length; groupIndex < $art_creaseucll$art_c; groupIndex++) {
            var group = $art_objvsdemudge$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cactcwnf$art_c = group.length; areaIndex < $art_cactcwnf$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cactcwnf$art_c = group.length; areaIndex < $art_cactcwnf$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ixnwshlurb$art_i = 0, $art_objlrpqgzywj$art_obj = area.provinces, $art_cbieqgztnnko$art_c = $art_objlrpqgzywj$art_obj.length; $art_ixnwshlurb$art_i < $art_cbieqgztnnko$art_c; $art_ixnwshlurb$art_i++) {                var province = $art_objlrpqgzywj$art_obj[$art_ixnwshlurb$art_i]%>';
                for (var $art_ixnwshlurb$art_i = 0, $art_objlrpqgzywj$art_obj = area.provinces, $art_cbieqgztnnko$art_c = $art_objlrpqgzywj$art_obj.length; $art_ixnwshlurb$art_i < $art_cbieqgztnnko$art_c; $art_ixnwshlurb$art_i++) {
                    var province = $art_objlrpqgzywj$art_obj[$art_ixnwshlurb$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ibdqrwvniz$art_i = 0, $art_objtibnr$art_obj = province.cities, $art_cspjmyby$art_c = $art_objtibnr$art_obj.length; $art_ibdqrwvniz$art_i < $art_cspjmyby$art_c; $art_ibdqrwvniz$art_i++) {                    var city = $art_objtibnr$art_obj[$art_ibdqrwvniz$art_i]%>';
                    for (var $art_ibdqrwvniz$art_i = 0, $art_objtibnr$art_obj = province.cities, $art_cspjmyby$art_c = $art_objtibnr$art_obj.length; $art_ibdqrwvniz$art_i < $art_cspjmyby$art_c; $art_ibdqrwvniz$art_i++) {
                        var city = $art_objtibnr$art_obj[$art_ibdqrwvniz$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
