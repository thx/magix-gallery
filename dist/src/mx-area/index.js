...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cygtulmow$art_c = types.length; typeIndex < $art_cygtulmow$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cygtulmow$art_c = types.length; typeIndex < $art_cygtulmow$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_czppgvjbzw$art_c = types.length; typeIndex < $art_czppgvjbzw$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_czppgvjbzw$art_c = types.length; typeIndex < $art_czppgvjbzw$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objtwpxevd$art_obj = type.groups, $art_czbjne$art_c = $art_objtwpxevd$art_obj.length; groupIndex < $art_czbjne$art_c; groupIndex++) {        var group = $art_objtwpxevd$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objtwpxevd$art_obj = type.groups, $art_czbjne$art_c = $art_objtwpxevd$art_obj.length; groupIndex < $art_czbjne$art_c; groupIndex++) {
            var group = $art_objtwpxevd$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cgfmsrcihsu$art_c = group.length; areaIndex < $art_cgfmsrcihsu$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cgfmsrcihsu$art_c = group.length; areaIndex < $art_cgfmsrcihsu$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iizaxmaxsj$art_i = 0, $art_objazwqzwdop$art_obj = area.provinces, $art_cdhueqqy$art_c = $art_objazwqzwdop$art_obj.length; $art_iizaxmaxsj$art_i < $art_cdhueqqy$art_c; $art_iizaxmaxsj$art_i++) {                var province = $art_objazwqzwdop$art_obj[$art_iizaxmaxsj$art_i]%>';
                for (var $art_iizaxmaxsj$art_i = 0, $art_objazwqzwdop$art_obj = area.provinces, $art_cdhueqqy$art_c = $art_objazwqzwdop$art_obj.length; $art_iizaxmaxsj$art_i < $art_cdhueqqy$art_c; $art_iizaxmaxsj$art_i++) {
                    var province = $art_objazwqzwdop$art_obj[$art_iizaxmaxsj$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ivqaxjixna$art_i = 0, $art_objramqpfp$art_obj = province.cities, $art_cbcqbhlea$art_c = $art_objramqpfp$art_obj.length; $art_ivqaxjixna$art_i < $art_cbcqbhlea$art_c; $art_ivqaxjixna$art_i++) {                    var city = $art_objramqpfp$art_obj[$art_ivqaxjixna$art_i]%>';
                    for (var $art_ivqaxjixna$art_i = 0, $art_objramqpfp$art_obj = province.cities, $art_cbcqbhlea$art_c = $art_objramqpfp$art_obj.length; $art_ivqaxjixna$art_i < $art_cbcqbhlea$art_c; $art_ivqaxjixna$art_i++) {
                        var city = $art_objramqpfp$art_obj[$art_ivqaxjixna$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
