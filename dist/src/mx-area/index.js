...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_csuqjxj$art_c = types.length; typeIndex < $art_csuqjxj$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_csuqjxj$art_c = types.length; typeIndex < $art_csuqjxj$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cflvwag$art_c = types.length; typeIndex < $art_cflvwag$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cflvwag$art_c = types.length; typeIndex < $art_cflvwag$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objyaxke$art_obj = type.groups, $art_caiglvmlsi$art_c = $art_objyaxke$art_obj.length; groupIndex < $art_caiglvmlsi$art_c; groupIndex++) {        var group = $art_objyaxke$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objyaxke$art_obj = type.groups, $art_caiglvmlsi$art_c = $art_objyaxke$art_obj.length; groupIndex < $art_caiglvmlsi$art_c; groupIndex++) {
            var group = $art_objyaxke$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cyzqhvnaqmh$art_c = group.length; areaIndex < $art_cyzqhvnaqmh$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cyzqhvnaqmh$art_c = group.length; areaIndex < $art_cyzqhvnaqmh$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iggmlwqbv$art_i = 0, $art_objpaogavxg$art_obj = area.provinces, $art_cbnuthiy$art_c = $art_objpaogavxg$art_obj.length; $art_iggmlwqbv$art_i < $art_cbnuthiy$art_c; $art_iggmlwqbv$art_i++) {                var province = $art_objpaogavxg$art_obj[$art_iggmlwqbv$art_i]%>';
                for (var $art_iggmlwqbv$art_i = 0, $art_objpaogavxg$art_obj = area.provinces, $art_cbnuthiy$art_c = $art_objpaogavxg$art_obj.length; $art_iggmlwqbv$art_i < $art_cbnuthiy$art_c; $art_iggmlwqbv$art_i++) {
                    var province = $art_objpaogavxg$art_obj[$art_iggmlwqbv$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_inarbvrjn$art_i = 0, $art_objczayixuc$art_obj = province.cities, $art_cadvtjqqfef$art_c = $art_objczayixuc$art_obj.length; $art_inarbvrjn$art_i < $art_cadvtjqqfef$art_c; $art_inarbvrjn$art_i++) {                    var city = $art_objczayixuc$art_obj[$art_inarbvrjn$art_i]%>';
                    for (var $art_inarbvrjn$art_i = 0, $art_objczayixuc$art_obj = province.cities, $art_cadvtjqqfef$art_c = $art_objczayixuc$art_obj.length; $art_inarbvrjn$art_i < $art_cadvtjqqfef$art_c; $art_inarbvrjn$art_i++) {
                        var city = $art_objczayixuc$art_obj[$art_inarbvrjn$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
