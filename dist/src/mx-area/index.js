...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_chtbpsvi$art_c = types.length; typeIndex < $art_chtbpsvi$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_chtbpsvi$art_c = types.length; typeIndex < $art_chtbpsvi$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cxcesrntihb$art_c = types.length; typeIndex < $art_cxcesrntihb$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cxcesrntihb$art_c = types.length; typeIndex < $art_cxcesrntihb$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objgpgvy$art_obj = type.groups, $art_cezujch$art_c = $art_objgpgvy$art_obj.length; groupIndex < $art_cezujch$art_c; groupIndex++) {        var group = $art_objgpgvy$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objgpgvy$art_obj = type.groups, $art_cezujch$art_c = $art_objgpgvy$art_obj.length; groupIndex < $art_cezujch$art_c; groupIndex++) {
            var group = $art_objgpgvy$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ccjddmqe$art_c = group.length; areaIndex < $art_ccjddmqe$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ccjddmqe$art_c = group.length; areaIndex < $art_ccjddmqe$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_inhxosq$art_i = 0, $art_objmtvrtuaa$art_obj = area.provinces, $art_czcgfwief$art_c = $art_objmtvrtuaa$art_obj.length; $art_inhxosq$art_i < $art_czcgfwief$art_c; $art_inhxosq$art_i++) {                var province = $art_objmtvrtuaa$art_obj[$art_inhxosq$art_i]%>';
                for (var $art_inhxosq$art_i = 0, $art_objmtvrtuaa$art_obj = area.provinces, $art_czcgfwief$art_c = $art_objmtvrtuaa$art_obj.length; $art_inhxosq$art_i < $art_czcgfwief$art_c; $art_inhxosq$art_i++) {
                    var province = $art_objmtvrtuaa$art_obj[$art_inhxosq$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ifvhwklctb$art_i = 0, $art_objlikwiul$art_obj = province.cities, $art_cuzrweewgs$art_c = $art_objlikwiul$art_obj.length; $art_ifvhwklctb$art_i < $art_cuzrweewgs$art_c; $art_ifvhwklctb$art_i++) {                    var city = $art_objlikwiul$art_obj[$art_ifvhwklctb$art_i]%>';
                    for (var $art_ifvhwklctb$art_i = 0, $art_objlikwiul$art_obj = province.cities, $art_cuzrweewgs$art_c = $art_objlikwiul$art_obj.length; $art_ifvhwklctb$art_i < $art_cuzrweewgs$art_c; $art_ifvhwklctb$art_i++) {
                        var city = $art_objlikwiul$art_obj[$art_ifvhwklctb$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
