...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbogjqnmm$art_c = types.length; typeIndex < $art_cbogjqnmm$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbogjqnmm$art_c = types.length; typeIndex < $art_cbogjqnmm$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cwajjpwih$art_c = types.length; typeIndex < $art_cwajjpwih$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cwajjpwih$art_c = types.length; typeIndex < $art_cwajjpwih$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objntystawykm$art_obj = type.groups, $art_ccygeahjhe$art_c = $art_objntystawykm$art_obj.length; groupIndex < $art_ccygeahjhe$art_c; groupIndex++) {        var group = $art_objntystawykm$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objntystawykm$art_obj = type.groups, $art_ccygeahjhe$art_c = $art_objntystawykm$art_obj.length; groupIndex < $art_ccygeahjhe$art_c; groupIndex++) {
            var group = $art_objntystawykm$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cufomtembb$art_c = group.length; areaIndex < $art_cufomtembb$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cufomtembb$art_c = group.length; areaIndex < $art_cufomtembb$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iumzfdik$art_i = 0, $art_objmugfd$art_obj = area.provinces, $art_cwowbohnbbb$art_c = $art_objmugfd$art_obj.length; $art_iumzfdik$art_i < $art_cwowbohnbbb$art_c; $art_iumzfdik$art_i++) {                var province = $art_objmugfd$art_obj[$art_iumzfdik$art_i]%>';
                for (var $art_iumzfdik$art_i = 0, $art_objmugfd$art_obj = area.provinces, $art_cwowbohnbbb$art_c = $art_objmugfd$art_obj.length; $art_iumzfdik$art_i < $art_cwowbohnbbb$art_c; $art_iumzfdik$art_i++) {
                    var province = $art_objmugfd$art_obj[$art_iumzfdik$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iozdyehyvco$art_i = 0, $art_objupimbuubh$art_obj = province.cities, $art_cnbkusk$art_c = $art_objupimbuubh$art_obj.length; $art_iozdyehyvco$art_i < $art_cnbkusk$art_c; $art_iozdyehyvco$art_i++) {                    var city = $art_objupimbuubh$art_obj[$art_iozdyehyvco$art_i]%>';
                    for (var $art_iozdyehyvco$art_i = 0, $art_objupimbuubh$art_obj = province.cities, $art_cnbkusk$art_c = $art_objupimbuubh$art_obj.length; $art_iozdyehyvco$art_i < $art_cnbkusk$art_c; $art_iozdyehyvco$art_i++) {
                        var city = $art_objupimbuubh$art_obj[$art_iozdyehyvco$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
