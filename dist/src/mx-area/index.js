...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cvzpzvqe$art_c = types.length; typeIndex < $art_cvzpzvqe$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cvzpzvqe$art_c = types.length; typeIndex < $art_cvzpzvqe$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cjmcelsfcbf$art_c = types.length; typeIndex < $art_cjmcelsfcbf$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cjmcelsfcbf$art_c = types.length; typeIndex < $art_cjmcelsfcbf$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objkybvrbpl$art_obj = type.groups, $art_ccxitbnkxd$art_c = $art_objkybvrbpl$art_obj.length; groupIndex < $art_ccxitbnkxd$art_c; groupIndex++) {        var group = $art_objkybvrbpl$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objkybvrbpl$art_obj = type.groups, $art_ccxitbnkxd$art_c = $art_objkybvrbpl$art_obj.length; groupIndex < $art_ccxitbnkxd$art_c; groupIndex++) {
            var group = $art_objkybvrbpl$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cogoklod$art_c = group.length; areaIndex < $art_cogoklod$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cogoklod$art_c = group.length; areaIndex < $art_cogoklod$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iezgfkagbepu$art_i = 0, $art_objvlpigd$art_obj = area.provinces, $art_cokinmh$art_c = $art_objvlpigd$art_obj.length; $art_iezgfkagbepu$art_i < $art_cokinmh$art_c; $art_iezgfkagbepu$art_i++) {                var province = $art_objvlpigd$art_obj[$art_iezgfkagbepu$art_i]%>';
                for (var $art_iezgfkagbepu$art_i = 0, $art_objvlpigd$art_obj = area.provinces, $art_cokinmh$art_c = $art_objvlpigd$art_obj.length; $art_iezgfkagbepu$art_i < $art_cokinmh$art_c; $art_iezgfkagbepu$art_i++) {
                    var province = $art_objvlpigd$art_obj[$art_iezgfkagbepu$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ioljfkmtqvm$art_i = 0, $art_objonhj$art_obj = province.cities, $art_cpmaiwejc$art_c = $art_objonhj$art_obj.length; $art_ioljfkmtqvm$art_i < $art_cpmaiwejc$art_c; $art_ioljfkmtqvm$art_i++) {                    var city = $art_objonhj$art_obj[$art_ioljfkmtqvm$art_i]%>';
                    for (var $art_ioljfkmtqvm$art_i = 0, $art_objonhj$art_obj = province.cities, $art_cpmaiwejc$art_c = $art_objonhj$art_obj.length; $art_ioljfkmtqvm$art_i < $art_cpmaiwejc$art_c; $art_ioljfkmtqvm$art_i++) {
                        var city = $art_objonhj$art_obj[$art_ioljfkmtqvm$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
