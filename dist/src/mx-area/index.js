...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cxshuqtxxq$art_c = types.length; typeIndex < $art_cxshuqtxxq$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cxshuqtxxq$art_c = types.length; typeIndex < $art_cxshuqtxxq$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cocluahuj$art_c = types.length; typeIndex < $art_cocluahuj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cocluahuj$art_c = types.length; typeIndex < $art_cocluahuj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objbsurnxj$art_obj = type.groups, $art_ccdwjhnqm$art_c = $art_objbsurnxj$art_obj.length; groupIndex < $art_ccdwjhnqm$art_c; groupIndex++) {        var group = $art_objbsurnxj$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objbsurnxj$art_obj = type.groups, $art_ccdwjhnqm$art_c = $art_objbsurnxj$art_obj.length; groupIndex < $art_ccdwjhnqm$art_c; groupIndex++) {
            var group = $art_objbsurnxj$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ctbhjyxlzic$art_c = group.length; areaIndex < $art_ctbhjyxlzic$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ctbhjyxlzic$art_c = group.length; areaIndex < $art_ctbhjyxlzic$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_irdhyvwh$art_i = 0, $art_objjmybvtup$art_obj = area.provinces, $art_ckhudbk$art_c = $art_objjmybvtup$art_obj.length; $art_irdhyvwh$art_i < $art_ckhudbk$art_c; $art_irdhyvwh$art_i++) {                var province = $art_objjmybvtup$art_obj[$art_irdhyvwh$art_i]%>';
                for (var $art_irdhyvwh$art_i = 0, $art_objjmybvtup$art_obj = area.provinces, $art_ckhudbk$art_c = $art_objjmybvtup$art_obj.length; $art_irdhyvwh$art_i < $art_ckhudbk$art_c; $art_irdhyvwh$art_i++) {
                    var province = $art_objjmybvtup$art_obj[$art_irdhyvwh$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imslusvokl$art_i = 0, $art_objogqbivgj$art_obj = province.cities, $art_clvncnpihe$art_c = $art_objogqbivgj$art_obj.length; $art_imslusvokl$art_i < $art_clvncnpihe$art_c; $art_imslusvokl$art_i++) {                    var city = $art_objogqbivgj$art_obj[$art_imslusvokl$art_i]%>';
                    for (var $art_imslusvokl$art_i = 0, $art_objogqbivgj$art_obj = province.cities, $art_clvncnpihe$art_c = $art_objogqbivgj$art_obj.length; $art_imslusvokl$art_i < $art_clvncnpihe$art_c; $art_imslusvokl$art_i++) {
                        var city = $art_objogqbivgj$art_obj[$art_imslusvokl$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
