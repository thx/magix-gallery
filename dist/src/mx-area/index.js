...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_clttoycyn$art_c = types.length; typeIndex < $art_clttoycyn$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_clttoycyn$art_c = types.length; typeIndex < $art_clttoycyn$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ccngvdi$art_c = types.length; typeIndex < $art_ccngvdi$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ccngvdi$art_c = types.length; typeIndex < $art_ccngvdi$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objmwxhcy$art_obj = type.groups, $art_ctsztxjzrym$art_c = $art_objmwxhcy$art_obj.length; groupIndex < $art_ctsztxjzrym$art_c; groupIndex++) {        var group = $art_objmwxhcy$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objmwxhcy$art_obj = type.groups, $art_ctsztxjzrym$art_c = $art_objmwxhcy$art_obj.length; groupIndex < $art_ctsztxjzrym$art_c; groupIndex++) {
            var group = $art_objmwxhcy$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cngshtij$art_c = group.length; areaIndex < $art_cngshtij$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cngshtij$art_c = group.length; areaIndex < $art_cngshtij$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ievqlclcm$art_i = 0, $art_objujkhtaurls$art_obj = area.provinces, $art_cqvbymerxg$art_c = $art_objujkhtaurls$art_obj.length; $art_ievqlclcm$art_i < $art_cqvbymerxg$art_c; $art_ievqlclcm$art_i++) {                var province = $art_objujkhtaurls$art_obj[$art_ievqlclcm$art_i]%>';
                for (var $art_ievqlclcm$art_i = 0, $art_objujkhtaurls$art_obj = area.provinces, $art_cqvbymerxg$art_c = $art_objujkhtaurls$art_obj.length; $art_ievqlclcm$art_i < $art_cqvbymerxg$art_c; $art_ievqlclcm$art_i++) {
                    var province = $art_objujkhtaurls$art_obj[$art_ievqlclcm$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_idxycbwjezu$art_i = 0, $art_objbtgfpf$art_obj = province.cities, $art_cvfrximb$art_c = $art_objbtgfpf$art_obj.length; $art_idxycbwjezu$art_i < $art_cvfrximb$art_c; $art_idxycbwjezu$art_i++) {                    var city = $art_objbtgfpf$art_obj[$art_idxycbwjezu$art_i]%>';
                    for (var $art_idxycbwjezu$art_i = 0, $art_objbtgfpf$art_obj = province.cities, $art_cvfrximb$art_c = $art_objbtgfpf$art_obj.length; $art_idxycbwjezu$art_i < $art_cvfrximb$art_c; $art_idxycbwjezu$art_i++) {
                        var city = $art_objbtgfpf$art_obj[$art_idxycbwjezu$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
