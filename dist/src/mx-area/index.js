...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cmjyeq$art_c = types.length; typeIndex < $art_cmjyeq$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cmjyeq$art_c = types.length; typeIndex < $art_cmjyeq$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cdcanlfuq$art_c = types.length; typeIndex < $art_cdcanlfuq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cdcanlfuq$art_c = types.length; typeIndex < $art_cdcanlfuq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objplmfahznl$art_obj = type.groups, $art_cjmxwrs$art_c = $art_objplmfahznl$art_obj.length; groupIndex < $art_cjmxwrs$art_c; groupIndex++) {        var group = $art_objplmfahznl$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objplmfahznl$art_obj = type.groups, $art_cjmxwrs$art_c = $art_objplmfahznl$art_obj.length; groupIndex < $art_cjmxwrs$art_c; groupIndex++) {
            var group = $art_objplmfahznl$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ctznplat$art_c = group.length; areaIndex < $art_ctznplat$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ctznplat$art_c = group.length; areaIndex < $art_ctznplat$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_irgyullap$art_i = 0, $art_objmpzfpiuiwa$art_obj = area.provinces, $art_czflhhlu$art_c = $art_objmpzfpiuiwa$art_obj.length; $art_irgyullap$art_i < $art_czflhhlu$art_c; $art_irgyullap$art_i++) {                var province = $art_objmpzfpiuiwa$art_obj[$art_irgyullap$art_i]%>';
                for (var $art_irgyullap$art_i = 0, $art_objmpzfpiuiwa$art_obj = area.provinces, $art_czflhhlu$art_c = $art_objmpzfpiuiwa$art_obj.length; $art_irgyullap$art_i < $art_czflhhlu$art_c; $art_irgyullap$art_i++) {
                    var province = $art_objmpzfpiuiwa$art_obj[$art_irgyullap$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ikuzarunq$art_i = 0, $art_objydinrar$art_obj = province.cities, $art_colbhpjjkn$art_c = $art_objydinrar$art_obj.length; $art_ikuzarunq$art_i < $art_colbhpjjkn$art_c; $art_ikuzarunq$art_i++) {                    var city = $art_objydinrar$art_obj[$art_ikuzarunq$art_i]%>';
                    for (var $art_ikuzarunq$art_i = 0, $art_objydinrar$art_obj = province.cities, $art_colbhpjjkn$art_c = $art_objydinrar$art_obj.length; $art_ikuzarunq$art_i < $art_colbhpjjkn$art_c; $art_ikuzarunq$art_i++) {
                        var city = $art_objydinrar$art_obj[$art_ikuzarunq$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
