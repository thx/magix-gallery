...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cqzcygkeazg$art_c = types.length; typeIndex < $art_cqzcygkeazg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cqzcygkeazg$art_c = types.length; typeIndex < $art_cqzcygkeazg$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cgjvlrycgkj$art_c = types.length; typeIndex < $art_cgjvlrycgkj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cgjvlrycgkj$art_c = types.length; typeIndex < $art_cgjvlrycgkj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objyhqegeva$art_obj = type.groups, $art_cplfgfaaj$art_c = $art_objyhqegeva$art_obj.length; groupIndex < $art_cplfgfaaj$art_c; groupIndex++) {        var group = $art_objyhqegeva$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objyhqegeva$art_obj = type.groups, $art_cplfgfaaj$art_c = $art_objyhqegeva$art_obj.length; groupIndex < $art_cplfgfaaj$art_c; groupIndex++) {
            var group = $art_objyhqegeva$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjuzxcbu$art_c = group.length; areaIndex < $art_cjuzxcbu$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjuzxcbu$art_c = group.length; areaIndex < $art_cjuzxcbu$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ikhfjkj$art_i = 0, $art_objfjcmu$art_obj = area.provinces, $art_ctadzdukk$art_c = $art_objfjcmu$art_obj.length; $art_ikhfjkj$art_i < $art_ctadzdukk$art_c; $art_ikhfjkj$art_i++) {                var province = $art_objfjcmu$art_obj[$art_ikhfjkj$art_i]%>';
                for (var $art_ikhfjkj$art_i = 0, $art_objfjcmu$art_obj = area.provinces, $art_ctadzdukk$art_c = $art_objfjcmu$art_obj.length; $art_ikhfjkj$art_i < $art_ctadzdukk$art_c; $art_ikhfjkj$art_i++) {
                    var province = $art_objfjcmu$art_obj[$art_ikhfjkj$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imyufvseo$art_i = 0, $art_objvgmtfkpoh$art_obj = province.cities, $art_covoqjt$art_c = $art_objvgmtfkpoh$art_obj.length; $art_imyufvseo$art_i < $art_covoqjt$art_c; $art_imyufvseo$art_i++) {                    var city = $art_objvgmtfkpoh$art_obj[$art_imyufvseo$art_i]%>';
                    for (var $art_imyufvseo$art_i = 0, $art_objvgmtfkpoh$art_obj = province.cities, $art_covoqjt$art_c = $art_objvgmtfkpoh$art_obj.length; $art_imyufvseo$art_i < $art_covoqjt$art_c; $art_imyufvseo$art_i++) {
                        var city = $art_objvgmtfkpoh$art_obj[$art_imyufvseo$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
