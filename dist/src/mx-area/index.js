...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cnvpmupx$art_c = types.length; typeIndex < $art_cnvpmupx$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cnvpmupx$art_c = types.length; typeIndex < $art_cnvpmupx$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cmmatxckk$art_c = types.length; typeIndex < $art_cmmatxckk$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cmmatxckk$art_c = types.length; typeIndex < $art_cmmatxckk$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objhurcw$art_obj = type.groups, $art_chtqmpmvvak$art_c = $art_objhurcw$art_obj.length; groupIndex < $art_chtqmpmvvak$art_c; groupIndex++) {        var group = $art_objhurcw$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objhurcw$art_obj = type.groups, $art_chtqmpmvvak$art_c = $art_objhurcw$art_obj.length; groupIndex < $art_chtqmpmvvak$art_c; groupIndex++) {
            var group = $art_objhurcw$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cszcpkjuj$art_c = group.length; areaIndex < $art_cszcpkjuj$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cszcpkjuj$art_c = group.length; areaIndex < $art_cszcpkjuj$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ionldhzos$art_i = 0, $art_objpxuznlzb$art_obj = area.provinces, $art_ccralpsvxai$art_c = $art_objpxuznlzb$art_obj.length; $art_ionldhzos$art_i < $art_ccralpsvxai$art_c; $art_ionldhzos$art_i++) {                var province = $art_objpxuznlzb$art_obj[$art_ionldhzos$art_i]%>';
                for (var $art_ionldhzos$art_i = 0, $art_objpxuznlzb$art_obj = area.provinces, $art_ccralpsvxai$art_c = $art_objpxuznlzb$art_obj.length; $art_ionldhzos$art_i < $art_ccralpsvxai$art_c; $art_ionldhzos$art_i++) {
                    var province = $art_objpxuznlzb$art_obj[$art_ionldhzos$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_irxfnhcdt$art_i = 0, $art_objvjuklh$art_obj = province.cities, $art_camjafze$art_c = $art_objvjuklh$art_obj.length; $art_irxfnhcdt$art_i < $art_camjafze$art_c; $art_irxfnhcdt$art_i++) {                    var city = $art_objvjuklh$art_obj[$art_irxfnhcdt$art_i]%>';
                    for (var $art_irxfnhcdt$art_i = 0, $art_objvjuklh$art_obj = province.cities, $art_camjafze$art_c = $art_objvjuklh$art_obj.length; $art_irxfnhcdt$art_i < $art_camjafze$art_c; $art_irxfnhcdt$art_i++) {
                        var city = $art_objvjuklh$art_obj[$art_irxfnhcdt$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
