...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cvnkfaidtdjq$art_c = types.length; typeIndex < $art_cvnkfaidtdjq$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cvnkfaidtdjq$art_c = types.length; typeIndex < $art_cvnkfaidtdjq$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cvegsqxfik$art_c = types.length; typeIndex < $art_cvegsqxfik$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cvegsqxfik$art_c = types.length; typeIndex < $art_cvegsqxfik$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objymwyovz$art_obj = type.groups, $art_crskadtvd$art_c = $art_objymwyovz$art_obj.length; groupIndex < $art_crskadtvd$art_c; groupIndex++) {        var group = $art_objymwyovz$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objymwyovz$art_obj = type.groups, $art_crskadtvd$art_c = $art_objymwyovz$art_obj.length; groupIndex < $art_crskadtvd$art_c; groupIndex++) {
            var group = $art_objymwyovz$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ckbwgqoxf$art_c = group.length; areaIndex < $art_ckbwgqoxf$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ckbwgqoxf$art_c = group.length; areaIndex < $art_ckbwgqoxf$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_icbjogfnzh$art_i = 0, $art_objqajiojkng$art_obj = area.provinces, $art_cyzadbfugx$art_c = $art_objqajiojkng$art_obj.length; $art_icbjogfnzh$art_i < $art_cyzadbfugx$art_c; $art_icbjogfnzh$art_i++) {                var province = $art_objqajiojkng$art_obj[$art_icbjogfnzh$art_i]%>';
                for (var $art_icbjogfnzh$art_i = 0, $art_objqajiojkng$art_obj = area.provinces, $art_cyzadbfugx$art_c = $art_objqajiojkng$art_obj.length; $art_icbjogfnzh$art_i < $art_cyzadbfugx$art_c; $art_icbjogfnzh$art_i++) {
                    var province = $art_objqajiojkng$art_obj[$art_icbjogfnzh$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_igqhrrmren$art_i = 0, $art_objvpggiy$art_obj = province.cities, $art_cvwtehuesiog$art_c = $art_objvpggiy$art_obj.length; $art_igqhrrmren$art_i < $art_cvwtehuesiog$art_c; $art_igqhrrmren$art_i++) {                    var city = $art_objvpggiy$art_obj[$art_igqhrrmren$art_i]%>';
                    for (var $art_igqhrrmren$art_i = 0, $art_objvpggiy$art_obj = province.cities, $art_cvwtehuesiog$art_c = $art_objvpggiy$art_obj.length; $art_igqhrrmren$art_i < $art_cvwtehuesiog$art_c; $art_igqhrrmren$art_i++) {
                        var city = $art_objvpggiy$art_obj[$art_igqhrrmren$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
