...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_chwqfsuyzt$art_c = types.length; typeIndex < $art_chwqfsuyzt$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_chwqfsuyzt$art_c = types.length; typeIndex < $art_chwqfsuyzt$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cigprjsizh$art_c = types.length; typeIndex < $art_cigprjsizh$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cigprjsizh$art_c = types.length; typeIndex < $art_cigprjsizh$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objpybffeow$art_obj = type.groups, $art_clwgciier$art_c = $art_objpybffeow$art_obj.length; groupIndex < $art_clwgciier$art_c; groupIndex++) {        var group = $art_objpybffeow$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objpybffeow$art_obj = type.groups, $art_clwgciier$art_c = $art_objpybffeow$art_obj.length; groupIndex < $art_clwgciier$art_c; groupIndex++) {
            var group = $art_objpybffeow$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cfkcxrdlcn$art_c = group.length; areaIndex < $art_cfkcxrdlcn$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cfkcxrdlcn$art_c = group.length; areaIndex < $art_cfkcxrdlcn$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_imkeiqgwqyc$art_i = 0, $art_objfpoujxz$art_obj = area.provinces, $art_cjvsftknx$art_c = $art_objfpoujxz$art_obj.length; $art_imkeiqgwqyc$art_i < $art_cjvsftknx$art_c; $art_imkeiqgwqyc$art_i++) {                var province = $art_objfpoujxz$art_obj[$art_imkeiqgwqyc$art_i]%>';
                for (var $art_imkeiqgwqyc$art_i = 0, $art_objfpoujxz$art_obj = area.provinces, $art_cjvsftknx$art_c = $art_objfpoujxz$art_obj.length; $art_imkeiqgwqyc$art_i < $art_cjvsftknx$art_c; $art_imkeiqgwqyc$art_i++) {
                    var province = $art_objfpoujxz$art_obj[$art_imkeiqgwqyc$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_irkpghdl$art_i = 0, $art_objngupfaowmi$art_obj = province.cities, $art_crpxhevod$art_c = $art_objngupfaowmi$art_obj.length; $art_irkpghdl$art_i < $art_crpxhevod$art_c; $art_irkpghdl$art_i++) {                    var city = $art_objngupfaowmi$art_obj[$art_irkpghdl$art_i]%>';
                    for (var $art_irkpghdl$art_i = 0, $art_objngupfaowmi$art_obj = province.cities, $art_crpxhevod$art_c = $art_objngupfaowmi$art_obj.length; $art_irkpghdl$art_i < $art_crpxhevod$art_c; $art_irkpghdl$art_i++) {
                        var city = $art_objngupfaowmi$art_obj[$art_irkpghdl$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
