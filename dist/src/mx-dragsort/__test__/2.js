...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaqxxhwnr$art_i = 0, $art_crbspqcjy$art_c = items.length; $art_iaqxxhwnr$art_i < $art_crbspqcjy$art_c; $art_iaqxxhwnr$art_i++) {    var item = items[$art_iaqxxhwnr$art_i]%>';
    for (var $art_iaqxxhwnr$art_i = 0, $art_crbspqcjy$art_c = items.length; $art_iaqxxhwnr$art_i < $art_crbspqcjy$art_c; $art_iaqxxhwnr$art_i++) {
        var item = items[$art_iaqxxhwnr$art_i];
