...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iefaebv$art_i = 0, $art_czkrfobvnb$art_c = items.length; $art_iefaebv$art_i < $art_czkrfobvnb$art_c; $art_iefaebv$art_i++) {    var item = items[$art_iefaebv$art_i]%>';
    for (var $art_iefaebv$art_i = 0, $art_czkrfobvnb$art_c = items.length; $art_iefaebv$art_i < $art_czkrfobvnb$art_c; $art_iefaebv$art_i++) {
        var item = items[$art_iefaebv$art_i];
