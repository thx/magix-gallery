...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itegucokxn$art_i = 0, $art_czavqpcxwd$art_c = items.length; $art_itegucokxn$art_i < $art_czavqpcxwd$art_c; $art_itegucokxn$art_i++) {    var item = items[$art_itegucokxn$art_i]%>';
    for (var $art_itegucokxn$art_i = 0, $art_czavqpcxwd$art_c = items.length; $art_itegucokxn$art_i < $art_czavqpcxwd$art_c; $art_itegucokxn$art_i++) {
        var item = items[$art_itegucokxn$art_i];
