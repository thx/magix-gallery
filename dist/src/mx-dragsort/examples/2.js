...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igmyumdmfbj$art_i = 0, $art_cvxkfqkuojt$art_c = items.length; $art_igmyumdmfbj$art_i < $art_cvxkfqkuojt$art_c; $art_igmyumdmfbj$art_i++) {    var item = items[$art_igmyumdmfbj$art_i]%>';
    for (var $art_igmyumdmfbj$art_i = 0, $art_cvxkfqkuojt$art_c = items.length; $art_igmyumdmfbj$art_i < $art_cvxkfqkuojt$art_c; $art_igmyumdmfbj$art_i++) {
        var item = items[$art_igmyumdmfbj$art_i];
