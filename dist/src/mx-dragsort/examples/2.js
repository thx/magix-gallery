...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqpwkpmyuh$art_i = 0, $art_clpyniuk$art_c = items.length; $art_iqpwkpmyuh$art_i < $art_clpyniuk$art_c; $art_iqpwkpmyuh$art_i++) {    var item = items[$art_iqpwkpmyuh$art_i]%>';
    for (var $art_iqpwkpmyuh$art_i = 0, $art_clpyniuk$art_c = items.length; $art_iqpwkpmyuh$art_i < $art_clpyniuk$art_c; $art_iqpwkpmyuh$art_i++) {
        var item = items[$art_iqpwkpmyuh$art_i];
