...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izsidpzaq$art_i = 0, $art_cwqlchym$art_c = items.length; $art_izsidpzaq$art_i < $art_cwqlchym$art_c; $art_izsidpzaq$art_i++) {    var item = items[$art_izsidpzaq$art_i]%>';
    for (var $art_izsidpzaq$art_i = 0, $art_cwqlchym$art_c = items.length; $art_izsidpzaq$art_i < $art_cwqlchym$art_c; $art_izsidpzaq$art_i++) {
        var item = items[$art_izsidpzaq$art_i];
