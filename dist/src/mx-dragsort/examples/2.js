...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iieqipil$art_i = 0, $art_chdkfkpkd$art_c = items.length; $art_iieqipil$art_i < $art_chdkfkpkd$art_c; $art_iieqipil$art_i++) {    var item = items[$art_iieqipil$art_i]%>';
    for (var $art_iieqipil$art_i = 0, $art_chdkfkpkd$art_c = items.length; $art_iieqipil$art_i < $art_chdkfkpkd$art_c; $art_iieqipil$art_i++) {
        var item = items[$art_iieqipil$art_i];
