...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyzlmfsg$art_i = 0, $art_cpvjidxac$art_c = items.length; $art_iyzlmfsg$art_i < $art_cpvjidxac$art_c; $art_iyzlmfsg$art_i++) {    var item = items[$art_iyzlmfsg$art_i]%>';
    for (var $art_iyzlmfsg$art_i = 0, $art_cpvjidxac$art_c = items.length; $art_iyzlmfsg$art_i < $art_cpvjidxac$art_c; $art_iyzlmfsg$art_i++) {
        var item = items[$art_iyzlmfsg$art_i];
