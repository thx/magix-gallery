/*
    ...
    loader: cmd_es
 */
define("mx-dragsort/examples/index",["magix","$","examples/subs","mx-title/second","./1","./2","./3","examples/api","examples/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya9:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'垂直拖动\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'水平拖动\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'自定义拖动节点\',\n            key: viewId + \'_demo3\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerya9:a" class="clearfix mb20"><div mx-view="mx-dragsort/examples/1" id="';
    $line = 24;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mx-view="mx-dragsort/examples/2" id="';
    $line = 25;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div><div mx-view="mx-dragsort/examples/3" id="';
    $line = 26;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-dragsort/examples/index.html';
    throw msg;
} return $p; },
    render: function () {
        var options = [{
