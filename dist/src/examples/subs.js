...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imbhkwf$art_i = 0, $art_cgeidvopn$art_c = list.length; $art_imbhkwf$art_i < $art_cgeidvopn$art_c; $art_imbhkwf$art_i++) {    var item = list[$art_imbhkwf$art_i]%>';
    for (var $art_imbhkwf$art_i = 0, $art_cgeidvopn$art_c = list.length; $art_imbhkwf$art_i < $art_cgeidvopn$art_c; $art_imbhkwf$art_i++) {
        var item = list[$art_imbhkwf$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ioqdtjal$art_i = 0, $art_objrjznhw$art_obj = item.subs, $art_cpxoapk$art_c = $art_objrjznhw$art_obj.length; $art_ioqdtjal$art_i < $art_cpxoapk$art_c; $art_ioqdtjal$art_i++) {            var sub = $art_objrjznhw$art_obj[$art_ioqdtjal$art_i]%>';
            for (var $art_ioqdtjal$art_i = 0, $art_objrjznhw$art_obj = item.subs, $art_cpxoapk$art_c = $art_objrjznhw$art_obj.length; $art_ioqdtjal$art_i < $art_cpxoapk$art_c; $art_ioqdtjal$art_i++) {
                var sub = $art_objrjznhw$art_obj[$art_ioqdtjal$art_i];
