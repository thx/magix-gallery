...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iinwddpife$art_i = 0, $art_cgkhjfucw$art_c = list.length; $art_iinwddpife$art_i < $art_cgkhjfucw$art_c; $art_iinwddpife$art_i++) {    var item = list[$art_iinwddpife$art_i]%>';
    for (var $art_iinwddpife$art_i = 0, $art_cgkhjfucw$art_c = list.length; $art_iinwddpife$art_i < $art_cgkhjfucw$art_c; $art_iinwddpife$art_i++) {
        var item = list[$art_iinwddpife$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_idqqgbut$art_i = 0, $art_objnnmap$art_obj = item.subs, $art_ciaupjjncq$art_c = $art_objnnmap$art_obj.length; $art_idqqgbut$art_i < $art_ciaupjjncq$art_c; $art_idqqgbut$art_i++) {            var sub = $art_objnnmap$art_obj[$art_idqqgbut$art_i]%>';
            for (var $art_idqqgbut$art_i = 0, $art_objnnmap$art_obj = item.subs, $art_ciaupjjncq$art_c = $art_objnnmap$art_obj.length; $art_idqqgbut$art_i < $art_ciaupjjncq$art_c; $art_idqqgbut$art_i++) {
                var sub = $art_objnnmap$art_obj[$art_idqqgbut$art_i];
