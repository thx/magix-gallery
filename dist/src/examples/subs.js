...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilpxfinlg$art_i = 0, $art_cvbqueuya$art_c = list.length; $art_ilpxfinlg$art_i < $art_cvbqueuya$art_c; $art_ilpxfinlg$art_i++) {    var item = list[$art_ilpxfinlg$art_i]%>';
    for (var $art_ilpxfinlg$art_i = 0, $art_cvbqueuya$art_c = list.length; $art_ilpxfinlg$art_i < $art_cvbqueuya$art_c; $art_ilpxfinlg$art_i++) {
        var item = list[$art_ilpxfinlg$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ilomwcq$art_i = 0, $art_objchjwqbhg$art_obj = item.subs, $art_cozwmrpyt$art_c = $art_objchjwqbhg$art_obj.length; $art_ilomwcq$art_i < $art_cozwmrpyt$art_c; $art_ilomwcq$art_i++) {            var sub = $art_objchjwqbhg$art_obj[$art_ilomwcq$art_i]%>';
            for (var $art_ilomwcq$art_i = 0, $art_objchjwqbhg$art_obj = item.subs, $art_cozwmrpyt$art_c = $art_objchjwqbhg$art_obj.length; $art_ilomwcq$art_i < $art_cozwmrpyt$art_c; $art_ilomwcq$art_i++) {
                var sub = $art_objchjwqbhg$art_obj[$art_ilomwcq$art_i];
