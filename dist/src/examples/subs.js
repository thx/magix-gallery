...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikdkpemypbk$art_i = 0, $art_cwwlptdabrrc$art_c = list.length; $art_ikdkpemypbk$art_i < $art_cwwlptdabrrc$art_c; $art_ikdkpemypbk$art_i++) {    var item = list[$art_ikdkpemypbk$art_i]%>';
    for (var $art_ikdkpemypbk$art_i = 0, $art_cwwlptdabrrc$art_c = list.length; $art_ikdkpemypbk$art_i < $art_cwwlptdabrrc$art_c; $art_ikdkpemypbk$art_i++) {
        var item = list[$art_ikdkpemypbk$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_idahkbmh$art_i = 0, $art_objmiqfaawtozi$art_obj = item.subs, $art_cfxpdftm$art_c = $art_objmiqfaawtozi$art_obj.length; $art_idahkbmh$art_i < $art_cfxpdftm$art_c; $art_idahkbmh$art_i++) {            var sub = $art_objmiqfaawtozi$art_obj[$art_idahkbmh$art_i]%>';
            for (var $art_idahkbmh$art_i = 0, $art_objmiqfaawtozi$art_obj = item.subs, $art_cfxpdftm$art_c = $art_objmiqfaawtozi$art_obj.length; $art_idahkbmh$art_i < $art_cfxpdftm$art_c; $art_idahkbmh$art_i++) {
                var sub = $art_objmiqfaawtozi$art_obj[$art_idahkbmh$art_i];
