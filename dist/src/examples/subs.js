...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ieggjash$art_i = 0, $art_cvtjborce$art_c = list.length; $art_ieggjash$art_i < $art_cvtjborce$art_c; $art_ieggjash$art_i++) {    var item = list[$art_ieggjash$art_i]%>';
    for (var $art_ieggjash$art_i = 0, $art_cvtjborce$art_c = list.length; $art_ieggjash$art_i < $art_cvtjborce$art_c; $art_ieggjash$art_i++) {
        var item = list[$art_ieggjash$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ivbwogafkrd$art_i = 0, $art_objmssesisdg$art_obj = item.subs, $art_crqcplxrir$art_c = $art_objmssesisdg$art_obj.length; $art_ivbwogafkrd$art_i < $art_crqcplxrir$art_c; $art_ivbwogafkrd$art_i++) {            var sub = $art_objmssesisdg$art_obj[$art_ivbwogafkrd$art_i]%>';
            for (var $art_ivbwogafkrd$art_i = 0, $art_objmssesisdg$art_obj = item.subs, $art_crqcplxrir$art_c = $art_objmssesisdg$art_obj.length; $art_ivbwogafkrd$art_i < $art_crqcplxrir$art_c; $art_ivbwogafkrd$art_i++) {
                var sub = $art_objmssesisdg$art_obj[$art_ivbwogafkrd$art_i];
    ...
    to: function (key) {
        var node = $('#' + key);
        var cName = '_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-example', hlName = '_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-example-highlight';
        var examples = $('.' + cName);
