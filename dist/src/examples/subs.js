...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itftzqdxwkdc$art_i = 0, $art_cymhgeiewl$art_c = list.length; $art_itftzqdxwkdc$art_i < $art_cymhgeiewl$art_c; $art_itftzqdxwkdc$art_i++) {    var item = list[$art_itftzqdxwkdc$art_i]%>';
    for (var $art_itftzqdxwkdc$art_i = 0, $art_cymhgeiewl$art_c = list.length; $art_itftzqdxwkdc$art_i < $art_cymhgeiewl$art_c; $art_itftzqdxwkdc$art_i++) {
        var item = list[$art_itftzqdxwkdc$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_iszylpduc$art_i = 0, $art_objwkvqg$art_obj = item.subs, $art_ccvowomri$art_c = $art_objwkvqg$art_obj.length; $art_iszylpduc$art_i < $art_ccvowomri$art_c; $art_iszylpduc$art_i++) {            var sub = $art_objwkvqg$art_obj[$art_iszylpduc$art_i]%>';
            for (var $art_iszylpduc$art_i = 0, $art_objwkvqg$art_obj = item.subs, $art_ccvowomri$art_c = $art_objwkvqg$art_obj.length; $art_iszylpduc$art_i < $art_ccvowomri$art_c; $art_iszylpduc$art_i++) {
                var sub = $art_objwkvqg$art_obj[$art_iszylpduc$art_i];
