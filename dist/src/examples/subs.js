...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilhxqytgc$art_i = 0, $art_ceayqjaqo$art_c = list.length; $art_ilhxqytgc$art_i < $art_ceayqjaqo$art_c; $art_ilhxqytgc$art_i++) {    var item = list[$art_ilhxqytgc$art_i]%>';
    for (var $art_ilhxqytgc$art_i = 0, $art_ceayqjaqo$art_c = list.length; $art_ilhxqytgc$art_i < $art_ceayqjaqo$art_c; $art_ilhxqytgc$art_i++) {
        var item = list[$art_ilhxqytgc$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ixogzbtaqi$art_i = 0, $art_objdkjcyh$art_obj = item.subs, $art_cnnthasxaq$art_c = $art_objdkjcyh$art_obj.length; $art_ixogzbtaqi$art_i < $art_cnnthasxaq$art_c; $art_ixogzbtaqi$art_i++) {            var sub = $art_objdkjcyh$art_obj[$art_ixogzbtaqi$art_i]%>';
            for (var $art_ixogzbtaqi$art_i = 0, $art_objdkjcyh$art_obj = item.subs, $art_cnnthasxaq$art_c = $art_objdkjcyh$art_obj.length; $art_ixogzbtaqi$art_i < $art_cnnthasxaq$art_c; $art_ixogzbtaqi$art_i++) {
                var sub = $art_objdkjcyh$art_obj[$art_ixogzbtaqi$art_i];
