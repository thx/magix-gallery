...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itqgmfr$art_i = 0, $art_ccmuifqmn$art_c = list.length; $art_itqgmfr$art_i < $art_ccmuifqmn$art_c; $art_itqgmfr$art_i++) {    var item = list[$art_itqgmfr$art_i]%>';
    for (var $art_itqgmfr$art_i = 0, $art_ccmuifqmn$art_c = list.length; $art_itqgmfr$art_i < $art_ccmuifqmn$art_c; $art_itqgmfr$art_i++) {
        var item = list[$art_itqgmfr$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_inyeve$art_i = 0, $art_objzrmjxrur$art_obj = item.subs, $art_czikvbes$art_c = $art_objzrmjxrur$art_obj.length; $art_inyeve$art_i < $art_czikvbes$art_c; $art_inyeve$art_i++) {            var sub = $art_objzrmjxrur$art_obj[$art_inyeve$art_i]%>';
            for (var $art_inyeve$art_i = 0, $art_objzrmjxrur$art_obj = item.subs, $art_czikvbes$art_c = $art_objzrmjxrur$art_obj.length; $art_inyeve$art_i < $art_czikvbes$art_c; $art_inyeve$art_i++) {
                var sub = $art_objzrmjxrur$art_obj[$art_inyeve$art_i];
