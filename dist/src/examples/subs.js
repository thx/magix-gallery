...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izsrnvemnh$art_i = 0, $art_cgrksqc$art_c = list.length; $art_izsrnvemnh$art_i < $art_cgrksqc$art_c; $art_izsrnvemnh$art_i++) {    var item = list[$art_izsrnvemnh$art_i]%>';
    for (var $art_izsrnvemnh$art_i = 0, $art_cgrksqc$art_c = list.length; $art_izsrnvemnh$art_i < $art_cgrksqc$art_c; $art_izsrnvemnh$art_i++) {
        var item = list[$art_izsrnvemnh$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ivbqmxjf$art_i = 0, $art_objhnznkhfyxe$art_obj = item.subs, $art_cyxpwrsj$art_c = $art_objhnznkhfyxe$art_obj.length; $art_ivbqmxjf$art_i < $art_cyxpwrsj$art_c; $art_ivbqmxjf$art_i++) {            var sub = $art_objhnznkhfyxe$art_obj[$art_ivbqmxjf$art_i]%>';
            for (var $art_ivbqmxjf$art_i = 0, $art_objhnznkhfyxe$art_obj = item.subs, $art_cyxpwrsj$art_c = $art_objhnznkhfyxe$art_obj.length; $art_ivbqmxjf$art_i < $art_cyxpwrsj$art_c; $art_ivbqmxjf$art_i++) {
                var sub = $art_objhnznkhfyxe$art_obj[$art_ivbqmxjf$art_i];
