/*
    ...
    loader: cmd_es
 */
define("examples/pro/init-dir",["magix","$","mx-effects/notice"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    msg += $expr + '\r\n\tat file:examples/pro/init-dir.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest({
