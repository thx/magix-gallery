...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_istaducpzilk$art_i = 0, $art_cmeagndxum$art_c = list.length; $art_istaducpzilk$art_i < $art_cmeagndxum$art_c; $art_istaducpzilk$art_i++) {    var item = list[$art_istaducpzilk$art_i]%>';
    for (var $art_istaducpzilk$art_i = 0, $art_cmeagndxum$art_c = list.length; $art_istaducpzilk$art_i < $art_cmeagndxum$art_c; $art_istaducpzilk$art_i++) {
        var item = list[$art_istaducpzilk$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
