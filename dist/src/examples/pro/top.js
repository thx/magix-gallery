...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iksibdqtnm$art_i = 0, $art_cagdrlnw$art_c = list.length; $art_iksibdqtnm$art_i < $art_cagdrlnw$art_c; $art_iksibdqtnm$art_i++) {    var item = list[$art_iksibdqtnm$art_i]%>';
    for (var $art_iksibdqtnm$art_i = 0, $art_cagdrlnw$art_c = list.length; $art_iksibdqtnm$art_i < $art_cagdrlnw$art_c; $art_iksibdqtnm$art_i++) {
        var item = list[$art_iksibdqtnm$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
