...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ithcnysi$art_i = 0, $art_crlgccrcu$art_c = list.length; $art_ithcnysi$art_i < $art_crlgccrcu$art_c; $art_ithcnysi$art_i++) {    var item = list[$art_ithcnysi$art_i]%>';
    for (var $art_ithcnysi$art_i = 0, $art_crlgccrcu$art_c = list.length; $art_ithcnysi$art_i < $art_crlgccrcu$art_c; $art_ithcnysi$art_i++) {
        var item = list[$art_ithcnysi$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
