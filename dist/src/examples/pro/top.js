...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijejgrggfk$art_i = 0, $art_coepmvqprm$art_c = list.length; $art_ijejgrggfk$art_i < $art_coepmvqprm$art_c; $art_ijejgrggfk$art_i++) {    var item = list[$art_ijejgrggfk$art_i]%>';
    for (var $art_ijejgrggfk$art_i = 0, $art_coepmvqprm$art_c = list.length; $art_ijejgrggfk$art_i < $art_coepmvqprm$art_c; $art_ijejgrggfk$art_i++) {
        var item = list[$art_ijejgrggfk$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
