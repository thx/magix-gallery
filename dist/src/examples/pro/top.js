...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imvqewshvo$art_i = 0, $art_ctxbvnyvkle$art_c = list.length; $art_imvqewshvo$art_i < $art_ctxbvnyvkle$art_c; $art_imvqewshvo$art_i++) {    var item = list[$art_imvqewshvo$art_i]%>';
    for (var $art_imvqewshvo$art_i = 0, $art_ctxbvnyvkle$art_c = list.length; $art_imvqewshvo$art_i < $art_ctxbvnyvkle$art_c; $art_imvqewshvo$art_i++) {
        var item = list[$art_imvqewshvo$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
