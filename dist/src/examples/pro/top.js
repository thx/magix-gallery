...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igiulhlkhq$art_i = 0, $art_coxqngpfgj$art_c = list.length; $art_igiulhlkhq$art_i < $art_coxqngpfgj$art_c; $art_igiulhlkhq$art_i++) {    var item = list[$art_igiulhlkhq$art_i]%>';
    for (var $art_igiulhlkhq$art_i = 0, $art_coxqngpfgj$art_c = list.length; $art_igiulhlkhq$art_i < $art_coxqngpfgj$art_c; $art_igiulhlkhq$art_i++) {
        var item = list[$art_igiulhlkhq$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
