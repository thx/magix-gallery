...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izbtnztwo$art_i = 0, $art_cmegtqtmhc$art_c = list.length; $art_izbtnztwo$art_i < $art_cmegtqtmhc$art_c; $art_izbtnztwo$art_i++) {    var item = list[$art_izbtnztwo$art_i]%>';
    for (var $art_izbtnztwo$art_i = 0, $art_cmegtqtmhc$art_c = list.length; $art_izbtnztwo$art_i < $art_cmegtqtmhc$art_c; $art_izbtnztwo$art_i++) {
        var item = list[$art_izbtnztwo$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
