...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itltoydpq$art_i = 0, $art_cisllsek$art_c = list.length; $art_itltoydpq$art_i < $art_cisllsek$art_c; $art_itltoydpq$art_i++) {    var item = list[$art_itltoydpq$art_i]%>';
    for (var $art_itltoydpq$art_i = 0, $art_cisllsek$art_c = list.length; $art_itltoydpq$art_i < $art_cisllsek$art_c; $art_itltoydpq$art_i++) {
        var item = list[$art_itltoydpq$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
