...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibqmkjgii$art_i = 0, $art_cghkkztybg$art_c = list.length; $art_ibqmkjgii$art_i < $art_cghkkztybg$art_c; $art_ibqmkjgii$art_i++) {    var item = list[$art_ibqmkjgii$art_i]%>';
    for (var $art_ibqmkjgii$art_i = 0, $art_cghkkztybg$art_c = list.length; $art_ibqmkjgii$art_i < $art_cghkkztybg$art_c; $art_ibqmkjgii$art_i++) {
        var item = list[$art_ibqmkjgii$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
