...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryD:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxs="_zs_galleryD:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div class="_zs_gallery_examples_pro_menu_-menu"><div class="_zs_gallery_examples_pro_menu_-header clearfix"><div class="_zs_gallery_examples_pro_menu_-logo">LOGO</div><div class="_zs_gallery_examples_pro_menu_-name">一级标题</div></div><div class="clearfix pr"><div class="_zs_gallery_examples_pro_menu_-navs"><div><a href="javascript:;" class="_zs_gallery_examples_pro_menu_-nav-third _zs_gallery_examples_pro_menu_-third-on"><i class="mc-iconfont mr5">&#xe731;</i>三级1</a></div><div><a href="javascript:;" class="_zs_gallery_examples_pro_menu_-nav-third"><i class="mc-iconfont mr5">&#xe609;</i>三级2</a></div><div><a href="javascript:;" class="_zs_gallery_examples_pro_menu_-nav-third"><i class="mc-iconfont mr5">&#xe698;</i>三级3</a></div></div><div class="_zs_gallery_examples_pro_menu_-inner"><div>view1：</div><div>映射到三级1这个页面</div><div>顶部和侧边导航显示与三级1完全一致</div></div></div></div></div><div mxa="_zs_galleryD:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryD:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">配置CustomPath</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 39;
    $art = '=viewId';
    ;
