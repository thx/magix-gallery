/*
    ...
    loader: cmd_es
 */
define("examples/pro/menu-custom2",["magix","../example","$","mx-copy/index","../hl"],(require,exports,module)=>{
/*Magix,Base,$*/
...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryB:_" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-example"><div mxs="_zs_galleryB:_" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-content"><div class="_zs_gallery_examples_pro_menu_-menu"><div class="_zs_gallery_examples_pro_menu_-header clearfix"><div class="_zs_gallery_examples_pro_menu_-logo">LOGO</div><div class="_zs_gallery_examples_pro_menu_-name">一级标题</div></div><div class="pr h100"><div class="pl30 pt30 pr30 pb30"><div>view3：</div><div>映射到三级1这个页面</div><div>顶部显示与三级1完全一致，无侧边</div></div></div></div></div><div mxa="_zs_galleryB:a" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryB:a" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-title">配置CustomPath</div><div class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 19;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryB:b" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 21;
    $art = '!text1';
    ;
    ...
    msg += $expr + '\r\n\tat file:examples/pro/menu-custom2.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
