/*
    ...
    loader: cmd_es
 */
define("examples/pro/menu-desc",["magix","$"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    msg += $expr + '\r\n\tat file:examples/pro/menu-desc.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest({});
