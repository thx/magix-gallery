/*
    ...
    loader: cmd_es
 */
define("examples/pro/login-demo",["magix","../example","$","./login-view","mx-copy/index","../hl"],(require,exports,module)=>{
/*Magix,Base,$*/
require("./login-view");
