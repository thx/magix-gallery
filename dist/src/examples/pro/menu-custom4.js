/*
    ...
    loader: cmd_es
 */
define("examples/pro/menu-custom4",["magix","../example","$","mx-copy/index","../hl"],(require,exports,module)=>{
/*Magix,Base,$*/
...
module.exports = Base.extend({
    ...
    msg += $expr + '\r\n\tat file:examples/pro/menu-custom4.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
