...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilddruozgyc$art_i = 0, $art_cpxugw$art_c = list.length; $art_ilddruozgyc$art_i < $art_cpxugw$art_c; $art_ilddruozgyc$art_i++) {    var item = list[$art_ilddruozgyc$art_i]%>';
    for (var $art_ilddruozgyc$art_i = 0, $art_cpxugw$art_c = list.length; $art_ilddruozgyc$art_i < $art_cpxugw$art_c; $art_ilddruozgyc$art_i++) {
        var item = list[$art_ilddruozgyc$art_i];
        ...
        ;
        $expr = '<%for (var $art_ioxcbrrsn$art_i = 0, $art_objyyhlf$art_obj = item.subs, $art_cpykylcvghi$art_c = $art_objyyhlf$art_obj.length; $art_ioxcbrrsn$art_i < $art_cpykylcvghi$art_c; $art_ioxcbrrsn$art_i++) {        var s = $art_objyyhlf$art_obj[$art_ioxcbrrsn$art_i]%>';
        for (var $art_ioxcbrrsn$art_i = 0, $art_objyyhlf$art_obj = item.subs, $art_cpykylcvghi$art_c = $art_objyyhlf$art_obj.length; $art_ioxcbrrsn$art_i < $art_cpykylcvghi$art_c; $art_ioxcbrrsn$art_i++) {
            var s = $art_objyyhlf$art_obj[$art_ioxcbrrsn$art_i];
            ...
            ;
            $expr = '<%for (var $art_ijcmzspb$art_i = 0, $art_objrbtnbuwj$art_obj = s.subs, $art_cvdojjeop$art_c = $art_objrbtnbuwj$art_obj.length; $art_ijcmzspb$art_i < $art_cvdojjeop$art_c; $art_ijcmzspb$art_i++) {            var ss = $art_objrbtnbuwj$art_obj[$art_ijcmzspb$art_i]%>';
            for (var $art_ijcmzspb$art_i = 0, $art_objrbtnbuwj$art_obj = s.subs, $art_cvdojjeop$art_c = $art_objrbtnbuwj$art_obj.length; $art_ijcmzspb$art_i < $art_cvdojjeop$art_c; $art_ijcmzspb$art_i++) {
                var ss = $art_objrbtnbuwj$art_obj[$art_ijcmzspb$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ixylmfra$art_i = 0, $art_objmxhniz$art_obj = ss.subs, $art_cmgtikcnvf$art_c = $art_objmxhniz$art_obj.length; $art_ixylmfra$art_i < $art_cmgtikcnvf$art_c; $art_ixylmfra$art_i++) {                    var sss = $art_objmxhniz$art_obj[$art_ixylmfra$art_i]%>';
                    for (var $art_ixylmfra$art_i = 0, $art_objmxhniz$art_obj = ss.subs, $art_cmgtikcnvf$art_c = $art_objmxhniz$art_obj.length; $art_ixylmfra$art_i < $art_cmgtikcnvf$art_c; $art_ixylmfra$art_i++) {
                        var sss = $art_objmxhniz$art_obj[$art_ixylmfra$art_i];
