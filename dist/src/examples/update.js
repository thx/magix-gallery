...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuaaeszjdf$art_i = 0, $art_cmlbwrjod$art_c = list.length; $art_iuaaeszjdf$art_i < $art_cmlbwrjod$art_c; $art_iuaaeszjdf$art_i++) {    var item = list[$art_iuaaeszjdf$art_i]%>';
    for (var $art_iuaaeszjdf$art_i = 0, $art_cmlbwrjod$art_c = list.length; $art_iuaaeszjdf$art_i < $art_cmlbwrjod$art_c; $art_iuaaeszjdf$art_i++) {
        var item = list[$art_iuaaeszjdf$art_i];
        ...
        ;
        $expr = '<%for (var $art_ivmlfny$art_i = 0, $art_objtwpmefl$art_obj = item.subs, $art_cwsvojkiaj$art_c = $art_objtwpmefl$art_obj.length; $art_ivmlfny$art_i < $art_cwsvojkiaj$art_c; $art_ivmlfny$art_i++) {        var s = $art_objtwpmefl$art_obj[$art_ivmlfny$art_i]%>';
        for (var $art_ivmlfny$art_i = 0, $art_objtwpmefl$art_obj = item.subs, $art_cwsvojkiaj$art_c = $art_objtwpmefl$art_obj.length; $art_ivmlfny$art_i < $art_cwsvojkiaj$art_c; $art_ivmlfny$art_i++) {
            var s = $art_objtwpmefl$art_obj[$art_ivmlfny$art_i];
            ...
            ;
            $expr = '<%for (var $art_ifvkhvvgs$art_i = 0, $art_objecnomos$art_obj = s.subs, $art_cdjbujo$art_c = $art_objecnomos$art_obj.length; $art_ifvkhvvgs$art_i < $art_cdjbujo$art_c; $art_ifvkhvvgs$art_i++) {            var ss = $art_objecnomos$art_obj[$art_ifvkhvvgs$art_i]%>';
            for (var $art_ifvkhvvgs$art_i = 0, $art_objecnomos$art_obj = s.subs, $art_cdjbujo$art_c = $art_objecnomos$art_obj.length; $art_ifvkhvvgs$art_i < $art_cdjbujo$art_c; $art_ifvkhvvgs$art_i++) {
                var ss = $art_objecnomos$art_obj[$art_ifvkhvvgs$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iaqrcudtv$art_i = 0, $art_objyfvwylja$art_obj = ss.subs, $art_cyrfregi$art_c = $art_objyfvwylja$art_obj.length; $art_iaqrcudtv$art_i < $art_cyrfregi$art_c; $art_iaqrcudtv$art_i++) {                    var sss = $art_objyfvwylja$art_obj[$art_iaqrcudtv$art_i]%>';
                    for (var $art_iaqrcudtv$art_i = 0, $art_objyfvwylja$art_obj = ss.subs, $art_cyrfregi$art_c = $art_objyfvwylja$art_obj.length; $art_iaqrcudtv$art_i < $art_cyrfregi$art_c; $art_iaqrcudtv$art_i++) {
                        var sss = $art_objyfvwylja$art_obj[$art_iaqrcudtv$art_i];
