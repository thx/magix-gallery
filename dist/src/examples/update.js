...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isccsybn$art_i = 0, $art_clinyrofkd$art_c = list.length; $art_isccsybn$art_i < $art_clinyrofkd$art_c; $art_isccsybn$art_i++) {    var item = list[$art_isccsybn$art_i]%>';
    for (var $art_isccsybn$art_i = 0, $art_clinyrofkd$art_c = list.length; $art_isccsybn$art_i < $art_clinyrofkd$art_c; $art_isccsybn$art_i++) {
        var item = list[$art_isccsybn$art_i];
        ...
        ;
        $expr = '<%for (var $art_icjyyopl$art_i = 0, $art_objkanmhieao$art_obj = item.subs, $art_cqynoraf$art_c = $art_objkanmhieao$art_obj.length; $art_icjyyopl$art_i < $art_cqynoraf$art_c; $art_icjyyopl$art_i++) {        var s = $art_objkanmhieao$art_obj[$art_icjyyopl$art_i]%>';
        for (var $art_icjyyopl$art_i = 0, $art_objkanmhieao$art_obj = item.subs, $art_cqynoraf$art_c = $art_objkanmhieao$art_obj.length; $art_icjyyopl$art_i < $art_cqynoraf$art_c; $art_icjyyopl$art_i++) {
            var s = $art_objkanmhieao$art_obj[$art_icjyyopl$art_i];
            ...
            ;
            $expr = '<%for (var $art_iajig$art_i = 0, $art_objlgbsfn$art_obj = s.subs, $art_cmapclq$art_c = $art_objlgbsfn$art_obj.length; $art_iajig$art_i < $art_cmapclq$art_c; $art_iajig$art_i++) {            var ss = $art_objlgbsfn$art_obj[$art_iajig$art_i]%>';
            for (var $art_iajig$art_i = 0, $art_objlgbsfn$art_obj = s.subs, $art_cmapclq$art_c = $art_objlgbsfn$art_obj.length; $art_iajig$art_i < $art_cmapclq$art_c; $art_iajig$art_i++) {
                var ss = $art_objlgbsfn$art_obj[$art_iajig$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iqjpnufb$art_i = 0, $art_objgcuzmkunm$art_obj = ss.subs, $art_cmdswxrt$art_c = $art_objgcuzmkunm$art_obj.length; $art_iqjpnufb$art_i < $art_cmdswxrt$art_c; $art_iqjpnufb$art_i++) {                    var sss = $art_objgcuzmkunm$art_obj[$art_iqjpnufb$art_i]%>';
                    for (var $art_iqjpnufb$art_i = 0, $art_objgcuzmkunm$art_obj = ss.subs, $art_cmdswxrt$art_c = $art_objgcuzmkunm$art_obj.length; $art_iqjpnufb$art_i < $art_cmdswxrt$art_c; $art_iqjpnufb$art_i++) {
                        var sss = $art_objgcuzmkunm$art_obj[$art_iqjpnufb$art_i];
