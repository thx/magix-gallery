...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibcgbwqxqxa$art_i = 0, $art_cdidqhab$art_c = list.length; $art_ibcgbwqxqxa$art_i < $art_cdidqhab$art_c; $art_ibcgbwqxqxa$art_i++) {    var item = list[$art_ibcgbwqxqxa$art_i]%>';
    for (var $art_ibcgbwqxqxa$art_i = 0, $art_cdidqhab$art_c = list.length; $art_ibcgbwqxqxa$art_i < $art_cdidqhab$art_c; $art_ibcgbwqxqxa$art_i++) {
        var item = list[$art_ibcgbwqxqxa$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixxxcium$art_i = 0, $art_objnemlprcp$art_obj = item.subs, $art_celdzmajkkn$art_c = $art_objnemlprcp$art_obj.length; $art_ixxxcium$art_i < $art_celdzmajkkn$art_c; $art_ixxxcium$art_i++) {        var s = $art_objnemlprcp$art_obj[$art_ixxxcium$art_i]%>';
        for (var $art_ixxxcium$art_i = 0, $art_objnemlprcp$art_obj = item.subs, $art_celdzmajkkn$art_c = $art_objnemlprcp$art_obj.length; $art_ixxxcium$art_i < $art_celdzmajkkn$art_c; $art_ixxxcium$art_i++) {
            var s = $art_objnemlprcp$art_obj[$art_ixxxcium$art_i];
            ...
            ;
            $expr = '<%for (var $art_imdzkgbxs$art_i = 0, $art_objrlkznve$art_obj = s.subs, $art_cevhzpkwdb$art_c = $art_objrlkznve$art_obj.length; $art_imdzkgbxs$art_i < $art_cevhzpkwdb$art_c; $art_imdzkgbxs$art_i++) {            var ss = $art_objrlkznve$art_obj[$art_imdzkgbxs$art_i]%>';
            for (var $art_imdzkgbxs$art_i = 0, $art_objrlkznve$art_obj = s.subs, $art_cevhzpkwdb$art_c = $art_objrlkznve$art_obj.length; $art_imdzkgbxs$art_i < $art_cevhzpkwdb$art_c; $art_imdzkgbxs$art_i++) {
                var ss = $art_objrlkznve$art_obj[$art_imdzkgbxs$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_itoavdgvar$art_i = 0, $art_objrcnikx$art_obj = ss.subs, $art_cymdfhkbcj$art_c = $art_objrcnikx$art_obj.length; $art_itoavdgvar$art_i < $art_cymdfhkbcj$art_c; $art_itoavdgvar$art_i++) {                    var sss = $art_objrcnikx$art_obj[$art_itoavdgvar$art_i]%>';
                    for (var $art_itoavdgvar$art_i = 0, $art_objrcnikx$art_obj = ss.subs, $art_cymdfhkbcj$art_c = $art_objrcnikx$art_obj.length; $art_itoavdgvar$art_i < $art_cymdfhkbcj$art_c; $art_itoavdgvar$art_i++) {
                        var sss = $art_objrcnikx$art_obj[$art_itoavdgvar$art_i];
