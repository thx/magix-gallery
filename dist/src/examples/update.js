...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idraebfhn$art_i = 0, $art_ccnvdwvdt$art_c = list.length; $art_idraebfhn$art_i < $art_ccnvdwvdt$art_c; $art_idraebfhn$art_i++) {    var item = list[$art_idraebfhn$art_i]%>';
    for (var $art_idraebfhn$art_i = 0, $art_ccnvdwvdt$art_c = list.length; $art_idraebfhn$art_i < $art_ccnvdwvdt$art_c; $art_idraebfhn$art_i++) {
        var item = list[$art_idraebfhn$art_i];
        ...
        ;
        $expr = '<%for (var $art_ichoqbkfn$art_i = 0, $art_objykkdbock$art_obj = item.subs, $art_chretyisi$art_c = $art_objykkdbock$art_obj.length; $art_ichoqbkfn$art_i < $art_chretyisi$art_c; $art_ichoqbkfn$art_i++) {        var s = $art_objykkdbock$art_obj[$art_ichoqbkfn$art_i]%>';
        for (var $art_ichoqbkfn$art_i = 0, $art_objykkdbock$art_obj = item.subs, $art_chretyisi$art_c = $art_objykkdbock$art_obj.length; $art_ichoqbkfn$art_i < $art_chretyisi$art_c; $art_ichoqbkfn$art_i++) {
            var s = $art_objykkdbock$art_obj[$art_ichoqbkfn$art_i];
            ...
            ;
            $expr = '<%for (var $art_ilfloetso$art_i = 0, $art_objqwwrmrpbh$art_obj = s.subs, $art_cerzrgbvnc$art_c = $art_objqwwrmrpbh$art_obj.length; $art_ilfloetso$art_i < $art_cerzrgbvnc$art_c; $art_ilfloetso$art_i++) {            var ss = $art_objqwwrmrpbh$art_obj[$art_ilfloetso$art_i]%>';
            for (var $art_ilfloetso$art_i = 0, $art_objqwwrmrpbh$art_obj = s.subs, $art_cerzrgbvnc$art_c = $art_objqwwrmrpbh$art_obj.length; $art_ilfloetso$art_i < $art_cerzrgbvnc$art_c; $art_ilfloetso$art_i++) {
                var ss = $art_objqwwrmrpbh$art_obj[$art_ilfloetso$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iohbalzb$art_i = 0, $art_objcxpaoroc$art_obj = ss.subs, $art_cxcxwmtxtxs$art_c = $art_objcxpaoroc$art_obj.length; $art_iohbalzb$art_i < $art_cxcxwmtxtxs$art_c; $art_iohbalzb$art_i++) {                    var sss = $art_objcxpaoroc$art_obj[$art_iohbalzb$art_i]%>';
                    for (var $art_iohbalzb$art_i = 0, $art_objcxpaoroc$art_obj = ss.subs, $art_cxcxwmtxtxs$art_c = $art_objcxpaoroc$art_obj.length; $art_iohbalzb$art_i < $art_cxcxwmtxtxs$art_c; $art_iohbalzb$art_i++) {
                        var sss = $art_objcxpaoroc$art_obj[$art_iohbalzb$art_i];
