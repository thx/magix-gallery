...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijvdefrzwj$art_i = 0, $art_ckogoqvrvd$art_c = list.length; $art_ijvdefrzwj$art_i < $art_ckogoqvrvd$art_c; $art_ijvdefrzwj$art_i++) {    var item = list[$art_ijvdefrzwj$art_i]%>';
    for (var $art_ijvdefrzwj$art_i = 0, $art_ckogoqvrvd$art_c = list.length; $art_ijvdefrzwj$art_i < $art_ckogoqvrvd$art_c; $art_ijvdefrzwj$art_i++) {
        var item = list[$art_ijvdefrzwj$art_i];
        ...
        ;
        $expr = '<%for (var $art_imtclsiljn$art_i = 0, $art_objkyehw$art_obj = item.subs, $art_cwbxgpxla$art_c = $art_objkyehw$art_obj.length; $art_imtclsiljn$art_i < $art_cwbxgpxla$art_c; $art_imtclsiljn$art_i++) {        var s = $art_objkyehw$art_obj[$art_imtclsiljn$art_i]%>';
        for (var $art_imtclsiljn$art_i = 0, $art_objkyehw$art_obj = item.subs, $art_cwbxgpxla$art_c = $art_objkyehw$art_obj.length; $art_imtclsiljn$art_i < $art_cwbxgpxla$art_c; $art_imtclsiljn$art_i++) {
            var s = $art_objkyehw$art_obj[$art_imtclsiljn$art_i];
            ...
            ;
            $expr = '<%for (var $art_iffsmwgds$art_i = 0, $art_objideqmeqbvo$art_obj = s.subs, $art_cbplpoprru$art_c = $art_objideqmeqbvo$art_obj.length; $art_iffsmwgds$art_i < $art_cbplpoprru$art_c; $art_iffsmwgds$art_i++) {            var ss = $art_objideqmeqbvo$art_obj[$art_iffsmwgds$art_i]%>';
            for (var $art_iffsmwgds$art_i = 0, $art_objideqmeqbvo$art_obj = s.subs, $art_cbplpoprru$art_c = $art_objideqmeqbvo$art_obj.length; $art_iffsmwgds$art_i < $art_cbplpoprru$art_c; $art_iffsmwgds$art_i++) {
                var ss = $art_objideqmeqbvo$art_obj[$art_iffsmwgds$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_injfmggfq$art_i = 0, $art_objoocsvy$art_obj = ss.subs, $art_csdpoci$art_c = $art_objoocsvy$art_obj.length; $art_injfmggfq$art_i < $art_csdpoci$art_c; $art_injfmggfq$art_i++) {                    var sss = $art_objoocsvy$art_obj[$art_injfmggfq$art_i]%>';
                    for (var $art_injfmggfq$art_i = 0, $art_objoocsvy$art_obj = ss.subs, $art_csdpoci$art_c = $art_objoocsvy$art_obj.length; $art_injfmggfq$art_i < $art_csdpoci$art_c; $art_injfmggfq$art_i++) {
                        var sss = $art_objoocsvy$art_obj[$art_injfmggfq$art_i];
