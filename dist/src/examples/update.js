...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwmrpjbwq$art_i = 0, $art_cblthvnewp$art_c = list.length; $art_iwmrpjbwq$art_i < $art_cblthvnewp$art_c; $art_iwmrpjbwq$art_i++) {    var item = list[$art_iwmrpjbwq$art_i]%>';
    for (var $art_iwmrpjbwq$art_i = 0, $art_cblthvnewp$art_c = list.length; $art_iwmrpjbwq$art_i < $art_cblthvnewp$art_c; $art_iwmrpjbwq$art_i++) {
        var item = list[$art_iwmrpjbwq$art_i];
        ...
        ;
        $expr = '<%for (var $art_izsvdoezf$art_i = 0, $art_objvujayalo$art_obj = item.subs, $art_cocgpjyizk$art_c = $art_objvujayalo$art_obj.length; $art_izsvdoezf$art_i < $art_cocgpjyizk$art_c; $art_izsvdoezf$art_i++) {        var s = $art_objvujayalo$art_obj[$art_izsvdoezf$art_i]%>';
        for (var $art_izsvdoezf$art_i = 0, $art_objvujayalo$art_obj = item.subs, $art_cocgpjyizk$art_c = $art_objvujayalo$art_obj.length; $art_izsvdoezf$art_i < $art_cocgpjyizk$art_c; $art_izsvdoezf$art_i++) {
            var s = $art_objvujayalo$art_obj[$art_izsvdoezf$art_i];
            ...
            ;
            $expr = '<%for (var $art_iojxiwmeqc$art_i = 0, $art_objdconnn$art_obj = s.subs, $art_ctawdqw$art_c = $art_objdconnn$art_obj.length; $art_iojxiwmeqc$art_i < $art_ctawdqw$art_c; $art_iojxiwmeqc$art_i++) {            var ss = $art_objdconnn$art_obj[$art_iojxiwmeqc$art_i]%>';
            for (var $art_iojxiwmeqc$art_i = 0, $art_objdconnn$art_obj = s.subs, $art_ctawdqw$art_c = $art_objdconnn$art_obj.length; $art_iojxiwmeqc$art_i < $art_ctawdqw$art_c; $art_iojxiwmeqc$art_i++) {
                var ss = $art_objdconnn$art_obj[$art_iojxiwmeqc$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iqnaynkceqt$art_i = 0, $art_objbteenx$art_obj = ss.subs, $art_crofgv$art_c = $art_objbteenx$art_obj.length; $art_iqnaynkceqt$art_i < $art_crofgv$art_c; $art_iqnaynkceqt$art_i++) {                    var sss = $art_objbteenx$art_obj[$art_iqnaynkceqt$art_i]%>';
                    for (var $art_iqnaynkceqt$art_i = 0, $art_objbteenx$art_obj = ss.subs, $art_crofgv$art_c = $art_objbteenx$art_obj.length; $art_iqnaynkceqt$art_i < $art_crofgv$art_c; $art_iqnaynkceqt$art_i++) {
                        var sss = $art_objbteenx$art_obj[$art_iqnaynkceqt$art_i];
