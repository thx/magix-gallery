...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icjtqqjz$art_i = 0, $art_cjjzeiaq$art_c = list.length; $art_icjtqqjz$art_i < $art_cjjzeiaq$art_c; $art_icjtqqjz$art_i++) {    var item = list[$art_icjtqqjz$art_i]%>';
    for (var $art_icjtqqjz$art_i = 0, $art_cjjzeiaq$art_c = list.length; $art_icjtqqjz$art_i < $art_cjjzeiaq$art_c; $art_icjtqqjz$art_i++) {
        var item = list[$art_icjtqqjz$art_i];
        ...
        ;
        $expr = '<%for (var $art_ibaxiswb$art_i = 0, $art_objykwqnxe$art_obj = item.subs, $art_ctnbuezf$art_c = $art_objykwqnxe$art_obj.length; $art_ibaxiswb$art_i < $art_ctnbuezf$art_c; $art_ibaxiswb$art_i++) {        var s = $art_objykwqnxe$art_obj[$art_ibaxiswb$art_i]%>';
        for (var $art_ibaxiswb$art_i = 0, $art_objykwqnxe$art_obj = item.subs, $art_ctnbuezf$art_c = $art_objykwqnxe$art_obj.length; $art_ibaxiswb$art_i < $art_ctnbuezf$art_c; $art_ibaxiswb$art_i++) {
            var s = $art_objykwqnxe$art_obj[$art_ibaxiswb$art_i];
            ...
            ;
            $expr = '<%for (var $art_ivzvfbhwq$art_i = 0, $art_objxzfeqtka$art_obj = s.subs, $art_ccakdub$art_c = $art_objxzfeqtka$art_obj.length; $art_ivzvfbhwq$art_i < $art_ccakdub$art_c; $art_ivzvfbhwq$art_i++) {            var ss = $art_objxzfeqtka$art_obj[$art_ivzvfbhwq$art_i]%>';
            for (var $art_ivzvfbhwq$art_i = 0, $art_objxzfeqtka$art_obj = s.subs, $art_ccakdub$art_c = $art_objxzfeqtka$art_obj.length; $art_ivzvfbhwq$art_i < $art_ccakdub$art_c; $art_ivzvfbhwq$art_i++) {
                var ss = $art_objxzfeqtka$art_obj[$art_ivzvfbhwq$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ivjxswfodft$art_i = 0, $art_objxlcsgxbo$art_obj = ss.subs, $art_cbuvgowr$art_c = $art_objxlcsgxbo$art_obj.length; $art_ivjxswfodft$art_i < $art_cbuvgowr$art_c; $art_ivjxswfodft$art_i++) {                    var sss = $art_objxlcsgxbo$art_obj[$art_ivjxswfodft$art_i]%>';
                    for (var $art_ivjxswfodft$art_i = 0, $art_objxlcsgxbo$art_obj = ss.subs, $art_cbuvgowr$art_c = $art_objxlcsgxbo$art_obj.length; $art_ivjxswfodft$art_i < $art_cbuvgowr$art_c; $art_ivjxswfodft$art_i++) {
                        var sss = $art_objxlcsgxbo$art_obj[$art_ivjxswfodft$art_i];
