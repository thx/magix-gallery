...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihcfctfvco$art_i = 0, $art_cflnxb$art_c = list.length; $art_ihcfctfvco$art_i < $art_cflnxb$art_c; $art_ihcfctfvco$art_i++) {    var item = list[$art_ihcfctfvco$art_i]%>';
    for (var $art_ihcfctfvco$art_i = 0, $art_cflnxb$art_c = list.length; $art_ihcfctfvco$art_i < $art_cflnxb$art_c; $art_ihcfctfvco$art_i++) {
        var item = list[$art_ihcfctfvco$art_i];
        ...
        ;
        $expr = '<%for (var $art_ibjqfypheko$art_i = 0, $art_objtdkhxsdxk$art_obj = item.subs, $art_ctkcudqyco$art_c = $art_objtdkhxsdxk$art_obj.length; $art_ibjqfypheko$art_i < $art_ctkcudqyco$art_c; $art_ibjqfypheko$art_i++) {        var s = $art_objtdkhxsdxk$art_obj[$art_ibjqfypheko$art_i]%>';
        for (var $art_ibjqfypheko$art_i = 0, $art_objtdkhxsdxk$art_obj = item.subs, $art_ctkcudqyco$art_c = $art_objtdkhxsdxk$art_obj.length; $art_ibjqfypheko$art_i < $art_ctkcudqyco$art_c; $art_ibjqfypheko$art_i++) {
            var s = $art_objtdkhxsdxk$art_obj[$art_ibjqfypheko$art_i];
            ...
            ;
            $expr = '<%for (var $art_icdlegwwrb$art_i = 0, $art_objhebyutmfim$art_obj = s.subs, $art_clhblasaki$art_c = $art_objhebyutmfim$art_obj.length; $art_icdlegwwrb$art_i < $art_clhblasaki$art_c; $art_icdlegwwrb$art_i++) {            var ss = $art_objhebyutmfim$art_obj[$art_icdlegwwrb$art_i]%>';
            for (var $art_icdlegwwrb$art_i = 0, $art_objhebyutmfim$art_obj = s.subs, $art_clhblasaki$art_c = $art_objhebyutmfim$art_obj.length; $art_icdlegwwrb$art_i < $art_clhblasaki$art_c; $art_icdlegwwrb$art_i++) {
                var ss = $art_objhebyutmfim$art_obj[$art_icdlegwwrb$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ilceeefjl$art_i = 0, $art_objttgzve$art_obj = ss.subs, $art_crepsvyai$art_c = $art_objttgzve$art_obj.length; $art_ilceeefjl$art_i < $art_crepsvyai$art_c; $art_ilceeefjl$art_i++) {                    var sss = $art_objttgzve$art_obj[$art_ilceeefjl$art_i]%>';
                    for (var $art_ilceeefjl$art_i = 0, $art_objttgzve$art_obj = ss.subs, $art_crepsvyai$art_c = $art_objttgzve$art_obj.length; $art_ilceeefjl$art_i < $art_crepsvyai$art_c; $art_ilceeefjl$art_i++) {
                        var sss = $art_objttgzve$art_obj[$art_ilceeefjl$art_i];
