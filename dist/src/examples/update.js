...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iudqrbyleeph$art_i = 0, $art_cyufhypfif$art_c = list.length; $art_iudqrbyleeph$art_i < $art_cyufhypfif$art_c; $art_iudqrbyleeph$art_i++) {    var item = list[$art_iudqrbyleeph$art_i]%>';
    for (var $art_iudqrbyleeph$art_i = 0, $art_cyufhypfif$art_c = list.length; $art_iudqrbyleeph$art_i < $art_cyufhypfif$art_c; $art_iudqrbyleeph$art_i++) {
        var item = list[$art_iudqrbyleeph$art_i];
        ...
        ;
        $expr = '<%for (var $art_itiwejoywm$art_i = 0, $art_objiqkwc$art_obj = item.subs, $art_cwuahxmmsdr$art_c = $art_objiqkwc$art_obj.length; $art_itiwejoywm$art_i < $art_cwuahxmmsdr$art_c; $art_itiwejoywm$art_i++) {        var s = $art_objiqkwc$art_obj[$art_itiwejoywm$art_i]%>';
        for (var $art_itiwejoywm$art_i = 0, $art_objiqkwc$art_obj = item.subs, $art_cwuahxmmsdr$art_c = $art_objiqkwc$art_obj.length; $art_itiwejoywm$art_i < $art_cwuahxmmsdr$art_c; $art_itiwejoywm$art_i++) {
            var s = $art_objiqkwc$art_obj[$art_itiwejoywm$art_i];
            ...
            ;
            $expr = '<%for (var $art_itkrafd$art_i = 0, $art_objvzbwgmwqon$art_obj = s.subs, $art_cbpezzolf$art_c = $art_objvzbwgmwqon$art_obj.length; $art_itkrafd$art_i < $art_cbpezzolf$art_c; $art_itkrafd$art_i++) {            var ss = $art_objvzbwgmwqon$art_obj[$art_itkrafd$art_i]%>';
            for (var $art_itkrafd$art_i = 0, $art_objvzbwgmwqon$art_obj = s.subs, $art_cbpezzolf$art_c = $art_objvzbwgmwqon$art_obj.length; $art_itkrafd$art_i < $art_cbpezzolf$art_c; $art_itkrafd$art_i++) {
                var ss = $art_objvzbwgmwqon$art_obj[$art_itkrafd$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iunsrqsmx$art_i = 0, $art_objevvdpcdme$art_obj = ss.subs, $art_cjkair$art_c = $art_objevvdpcdme$art_obj.length; $art_iunsrqsmx$art_i < $art_cjkair$art_c; $art_iunsrqsmx$art_i++) {                    var sss = $art_objevvdpcdme$art_obj[$art_iunsrqsmx$art_i]%>';
                    for (var $art_iunsrqsmx$art_i = 0, $art_objevvdpcdme$art_obj = ss.subs, $art_cjkair$art_c = $art_objevvdpcdme$art_obj.length; $art_iunsrqsmx$art_i < $art_cjkair$art_c; $art_iunsrqsmx$art_i++) {
                        var sss = $art_objevvdpcdme$art_obj[$art_iunsrqsmx$art_i];
