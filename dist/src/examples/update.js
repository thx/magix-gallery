...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixvsxsze$art_i = 0, $art_caiqgaveg$art_c = list.length; $art_ixvsxsze$art_i < $art_caiqgaveg$art_c; $art_ixvsxsze$art_i++) {    var item = list[$art_ixvsxsze$art_i]%>';
    for (var $art_ixvsxsze$art_i = 0, $art_caiqgaveg$art_c = list.length; $art_ixvsxsze$art_i < $art_caiqgaveg$art_c; $art_ixvsxsze$art_i++) {
        var item = list[$art_ixvsxsze$art_i];
        ...
        ;
        $expr = '<%for (var $art_iymujcpvas$art_i = 0, $art_objusutbtf$art_obj = item.subs, $art_cefsjfull$art_c = $art_objusutbtf$art_obj.length; $art_iymujcpvas$art_i < $art_cefsjfull$art_c; $art_iymujcpvas$art_i++) {        var s = $art_objusutbtf$art_obj[$art_iymujcpvas$art_i]%>';
        for (var $art_iymujcpvas$art_i = 0, $art_objusutbtf$art_obj = item.subs, $art_cefsjfull$art_c = $art_objusutbtf$art_obj.length; $art_iymujcpvas$art_i < $art_cefsjfull$art_c; $art_iymujcpvas$art_i++) {
            var s = $art_objusutbtf$art_obj[$art_iymujcpvas$art_i];
            ...
            ;
            $expr = '<%for (var $art_ivskdetnd$art_i = 0, $art_objqsfpspfjo$art_obj = s.subs, $art_cwwjamcj$art_c = $art_objqsfpspfjo$art_obj.length; $art_ivskdetnd$art_i < $art_cwwjamcj$art_c; $art_ivskdetnd$art_i++) {            var ss = $art_objqsfpspfjo$art_obj[$art_ivskdetnd$art_i]%>';
            for (var $art_ivskdetnd$art_i = 0, $art_objqsfpspfjo$art_obj = s.subs, $art_cwwjamcj$art_c = $art_objqsfpspfjo$art_obj.length; $art_ivskdetnd$art_i < $art_cwwjamcj$art_c; $art_ivskdetnd$art_i++) {
                var ss = $art_objqsfpspfjo$art_obj[$art_ivskdetnd$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ijwgulbtio$art_i = 0, $art_objndorgxtggs$art_obj = ss.subs, $art_carqbwhrig$art_c = $art_objndorgxtggs$art_obj.length; $art_ijwgulbtio$art_i < $art_carqbwhrig$art_c; $art_ijwgulbtio$art_i++) {                    var sss = $art_objndorgxtggs$art_obj[$art_ijwgulbtio$art_i]%>';
                    for (var $art_ijwgulbtio$art_i = 0, $art_objndorgxtggs$art_obj = ss.subs, $art_carqbwhrig$art_c = $art_objndorgxtggs$art_obj.length; $art_ijwgulbtio$art_i < $art_carqbwhrig$art_c; $art_ijwgulbtio$art_i++) {
                        var sss = $art_objndorgxtggs$art_obj[$art_ijwgulbtio$art_i];
