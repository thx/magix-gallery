...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixowiplx$art_i = 0, $art_cqfyvbdqato$art_c = checkboxes.length; $art_ixowiplx$art_i < $art_cqfyvbdqato$art_c; $art_ixowiplx$art_i++) {    var c = checkboxes[$art_ixowiplx$art_i]%>';
    for (var $art_ixowiplx$art_i = 0, $art_cqfyvbdqato$art_c = checkboxes.length; $art_ixowiplx$art_i < $art_cqfyvbdqato$art_c; $art_ixowiplx$art_i++) {
        var c = checkboxes[$art_ixowiplx$art_i];
    ...
    ;
    $expr = '<%for (var $art_iyyswhfczb$art_i = 0, $art_czvfxqhzpp$art_c = radioes.length; $art_iyyswhfczb$art_i < $art_czvfxqhzpp$art_c; $art_iyyswhfczb$art_i++) {    var r = radioes[$art_iyyswhfczb$art_i]%>';
    for (var $art_iyyswhfczb$art_i = 0, $art_czvfxqhzpp$art_c = radioes.length; $art_iyyswhfczb$art_i < $art_czvfxqhzpp$art_c; $art_iyyswhfczb$art_i++) {
        var r = radioes[$art_iyyswhfczb$art_i];
