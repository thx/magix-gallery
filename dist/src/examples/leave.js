...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izibzarfp$art_i = 0, $art_chfugykobn$art_c = checkboxes.length; $art_izibzarfp$art_i < $art_chfugykobn$art_c; $art_izibzarfp$art_i++) {    var c = checkboxes[$art_izibzarfp$art_i]%>';
    for (var $art_izibzarfp$art_i = 0, $art_chfugykobn$art_c = checkboxes.length; $art_izibzarfp$art_i < $art_chfugykobn$art_c; $art_izibzarfp$art_i++) {
        var c = checkboxes[$art_izibzarfp$art_i];
    ...
    ;
    $expr = '<%for (var $art_iybsmxhmbo$art_i = 0, $art_cxrtcgqt$art_c = radioes.length; $art_iybsmxhmbo$art_i < $art_cxrtcgqt$art_c; $art_iybsmxhmbo$art_i++) {    var r = radioes[$art_iybsmxhmbo$art_i]%>';
    for (var $art_iybsmxhmbo$art_i = 0, $art_cxrtcgqt$art_c = radioes.length; $art_iybsmxhmbo$art_i < $art_cxrtcgqt$art_c; $art_iybsmxhmbo$art_i++) {
        var r = radioes[$art_iybsmxhmbo$art_i];
