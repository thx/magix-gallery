...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iknmjyun$art_i = 0, $art_ciltouo$art_c = checkboxes.length; $art_iknmjyun$art_i < $art_ciltouo$art_c; $art_iknmjyun$art_i++) {    var c = checkboxes[$art_iknmjyun$art_i]%>';
    for (var $art_iknmjyun$art_i = 0, $art_ciltouo$art_c = checkboxes.length; $art_iknmjyun$art_i < $art_ciltouo$art_c; $art_iknmjyun$art_i++) {
        var c = checkboxes[$art_iknmjyun$art_i];
    ...
    ;
    $expr = '<%for (var $art_ieghmhdxp$art_i = 0, $art_ckpmvclr$art_c = radioes.length; $art_ieghmhdxp$art_i < $art_ckpmvclr$art_c; $art_ieghmhdxp$art_i++) {    var r = radioes[$art_ieghmhdxp$art_i]%>';
    for (var $art_ieghmhdxp$art_i = 0, $art_ckpmvclr$art_c = radioes.length; $art_ieghmhdxp$art_i < $art_ckpmvclr$art_c; $art_ieghmhdxp$art_i++) {
        var r = radioes[$art_ieghmhdxp$art_i];
