...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiro$art_i = 0, $art_cclwgjucbu$art_c = checkboxes.length; $art_iiro$art_i < $art_cclwgjucbu$art_c; $art_iiro$art_i++) {    var c = checkboxes[$art_iiro$art_i]%>';
    for (var $art_iiro$art_i = 0, $art_cclwgjucbu$art_c = checkboxes.length; $art_iiro$art_i < $art_cclwgjucbu$art_c; $art_iiro$art_i++) {
        var c = checkboxes[$art_iiro$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqdwbmogl$art_i = 0, $art_cqetxwd$art_c = radioes.length; $art_iqdwbmogl$art_i < $art_cqetxwd$art_c; $art_iqdwbmogl$art_i++) {    var r = radioes[$art_iqdwbmogl$art_i]%>';
    for (var $art_iqdwbmogl$art_i = 0, $art_cqetxwd$art_c = radioes.length; $art_iqdwbmogl$art_i < $art_cqetxwd$art_c; $art_iqdwbmogl$art_i++) {
        var r = radioes[$art_iqdwbmogl$art_i];
