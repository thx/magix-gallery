...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iedobxzb$art_i = 0, $art_coxbyfupjx$art_c = checkboxes.length; $art_iedobxzb$art_i < $art_coxbyfupjx$art_c; $art_iedobxzb$art_i++) {    var c = checkboxes[$art_iedobxzb$art_i]%>';
    for (var $art_iedobxzb$art_i = 0, $art_coxbyfupjx$art_c = checkboxes.length; $art_iedobxzb$art_i < $art_coxbyfupjx$art_c; $art_iedobxzb$art_i++) {
        var c = checkboxes[$art_iedobxzb$art_i];
    ...
    ;
    $expr = '<%for (var $art_issgpxjcmf$art_i = 0, $art_cmvporzryp$art_c = radioes.length; $art_issgpxjcmf$art_i < $art_cmvporzryp$art_c; $art_issgpxjcmf$art_i++) {    var r = radioes[$art_issgpxjcmf$art_i]%>';
    for (var $art_issgpxjcmf$art_i = 0, $art_cmvporzryp$art_c = radioes.length; $art_issgpxjcmf$art_i < $art_cmvporzryp$art_c; $art_issgpxjcmf$art_i++) {
        var r = radioes[$art_issgpxjcmf$art_i];
