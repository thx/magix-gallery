...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iezoxgcrnm$art_i = 0, $art_ccabpgif$art_c = checkboxes.length; $art_iezoxgcrnm$art_i < $art_ccabpgif$art_c; $art_iezoxgcrnm$art_i++) {    var c = checkboxes[$art_iezoxgcrnm$art_i]%>';
    for (var $art_iezoxgcrnm$art_i = 0, $art_ccabpgif$art_c = checkboxes.length; $art_iezoxgcrnm$art_i < $art_ccabpgif$art_c; $art_iezoxgcrnm$art_i++) {
        var c = checkboxes[$art_iezoxgcrnm$art_i];
    ...
    ;
    $expr = '<%for (var $art_igqsuzm$art_i = 0, $art_cfkcxhvd$art_c = radioes.length; $art_igqsuzm$art_i < $art_cfkcxhvd$art_c; $art_igqsuzm$art_i++) {    var r = radioes[$art_igqsuzm$art_i]%>';
    for (var $art_igqsuzm$art_i = 0, $art_cfkcxhvd$art_c = radioes.length; $art_igqsuzm$art_i < $art_cfkcxhvd$art_c; $art_igqsuzm$art_i++) {
        var r = radioes[$art_igqsuzm$art_i];
