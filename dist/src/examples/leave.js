...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iymbus$art_i = 0, $art_cjgycjgj$art_c = checkboxes.length; $art_iymbus$art_i < $art_cjgycjgj$art_c; $art_iymbus$art_i++) {    var c = checkboxes[$art_iymbus$art_i]%>';
    for (var $art_iymbus$art_i = 0, $art_cjgycjgj$art_c = checkboxes.length; $art_iymbus$art_i < $art_cjgycjgj$art_c; $art_iymbus$art_i++) {
        var c = checkboxes[$art_iymbus$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwmnbctetsg$art_i = 0, $art_cegbhnh$art_c = radioes.length; $art_iwmnbctetsg$art_i < $art_cegbhnh$art_c; $art_iwmnbctetsg$art_i++) {    var r = radioes[$art_iwmnbctetsg$art_i]%>';
    for (var $art_iwmnbctetsg$art_i = 0, $art_cegbhnh$art_c = radioes.length; $art_iwmnbctetsg$art_i < $art_cegbhnh$art_c; $art_iwmnbctetsg$art_i++) {
        var r = radioes[$art_iwmnbctetsg$art_i];
