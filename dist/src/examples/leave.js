...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqolzap$art_i = 0, $art_citldqjse$art_c = checkboxes.length; $art_iqolzap$art_i < $art_citldqjse$art_c; $art_iqolzap$art_i++) {    var c = checkboxes[$art_iqolzap$art_i]%>';
    for (var $art_iqolzap$art_i = 0, $art_citldqjse$art_c = checkboxes.length; $art_iqolzap$art_i < $art_citldqjse$art_c; $art_iqolzap$art_i++) {
        var c = checkboxes[$art_iqolzap$art_i];
    ...
    ;
    $expr = '<%for (var $art_idapkk$art_i = 0, $art_cqti$art_c = radioes.length; $art_idapkk$art_i < $art_cqti$art_c; $art_idapkk$art_i++) {    var r = radioes[$art_idapkk$art_i]%>';
    for (var $art_idapkk$art_i = 0, $art_cqti$art_c = radioes.length; $art_idapkk$art_i < $art_cqti$art_c; $art_idapkk$art_i++) {
        var r = radioes[$art_idapkk$art_i];
