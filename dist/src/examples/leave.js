...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijxpxzsho$art_i = 0, $art_caomov$art_c = checkboxes.length; $art_ijxpxzsho$art_i < $art_caomov$art_c; $art_ijxpxzsho$art_i++) {    var c = checkboxes[$art_ijxpxzsho$art_i]%>';
    for (var $art_ijxpxzsho$art_i = 0, $art_caomov$art_c = checkboxes.length; $art_ijxpxzsho$art_i < $art_caomov$art_c; $art_ijxpxzsho$art_i++) {
        var c = checkboxes[$art_ijxpxzsho$art_i];
    ...
    ;
    $expr = '<%for (var $art_iceghaosjr$art_i = 0, $art_ckmj$art_c = radioes.length; $art_iceghaosjr$art_i < $art_ckmj$art_c; $art_iceghaosjr$art_i++) {    var r = radioes[$art_iceghaosjr$art_i]%>';
    for (var $art_iceghaosjr$art_i = 0, $art_ckmj$art_c = radioes.length; $art_iceghaosjr$art_i < $art_ckmj$art_c; $art_iceghaosjr$art_i++) {
        var r = radioes[$art_iceghaosjr$art_i];
