...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifnfwkjial$art_i = 0, $art_cpsltrkg$art_c = checkboxes.length; $art_ifnfwkjial$art_i < $art_cpsltrkg$art_c; $art_ifnfwkjial$art_i++) {    var c = checkboxes[$art_ifnfwkjial$art_i]%>';
    for (var $art_ifnfwkjial$art_i = 0, $art_cpsltrkg$art_c = checkboxes.length; $art_ifnfwkjial$art_i < $art_cpsltrkg$art_c; $art_ifnfwkjial$art_i++) {
        var c = checkboxes[$art_ifnfwkjial$art_i];
    ...
    ;
    $expr = '<%for (var $art_iyiymmyha$art_i = 0, $art_cliwmigc$art_c = radioes.length; $art_iyiymmyha$art_i < $art_cliwmigc$art_c; $art_iyiymmyha$art_i++) {    var r = radioes[$art_iyiymmyha$art_i]%>';
    for (var $art_iyiymmyha$art_i = 0, $art_cliwmigc$art_c = radioes.length; $art_iyiymmyha$art_i < $art_cliwmigc$art_c; $art_iyiymmyha$art_i++) {
        var r = radioes[$art_iyiymmyha$art_i];
