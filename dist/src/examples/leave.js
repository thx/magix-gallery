...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iduocstyjg$art_i = 0, $art_csethkfr$art_c = checkboxes.length; $art_iduocstyjg$art_i < $art_csethkfr$art_c; $art_iduocstyjg$art_i++) {    var c = checkboxes[$art_iduocstyjg$art_i]%>';
    for (var $art_iduocstyjg$art_i = 0, $art_csethkfr$art_c = checkboxes.length; $art_iduocstyjg$art_i < $art_csethkfr$art_c; $art_iduocstyjg$art_i++) {
        var c = checkboxes[$art_iduocstyjg$art_i];
    ...
    ;
    $expr = '<%for (var $art_inrprtzb$art_i = 0, $art_cekhnggyka$art_c = radioes.length; $art_inrprtzb$art_i < $art_cekhnggyka$art_c; $art_inrprtzb$art_i++) {    var r = radioes[$art_inrprtzb$art_i]%>';
    for (var $art_inrprtzb$art_i = 0, $art_cekhnggyka$art_c = radioes.length; $art_inrprtzb$art_i < $art_cekhnggyka$art_c; $art_inrprtzb$art_i++) {
        var r = radioes[$art_inrprtzb$art_i];
