...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irqoragqwe$art_i = 0, $art_conmdojokm$art_c = checkboxes.length; $art_irqoragqwe$art_i < $art_conmdojokm$art_c; $art_irqoragqwe$art_i++) {    var c = checkboxes[$art_irqoragqwe$art_i]%>';
    for (var $art_irqoragqwe$art_i = 0, $art_conmdojokm$art_c = checkboxes.length; $art_irqoragqwe$art_i < $art_conmdojokm$art_c; $art_irqoragqwe$art_i++) {
        var c = checkboxes[$art_irqoragqwe$art_i];
    ...
    ;
    $expr = '<%for (var $art_ievztqmb$art_i = 0, $art_clywutothqr$art_c = radioes.length; $art_ievztqmb$art_i < $art_clywutothqr$art_c; $art_ievztqmb$art_i++) {    var r = radioes[$art_ievztqmb$art_i]%>';
    for (var $art_ievztqmb$art_i = 0, $art_clywutothqr$art_c = radioes.length; $art_ievztqmb$art_i < $art_clywutothqr$art_c; $art_ievztqmb$art_i++) {
        var r = radioes[$art_ievztqmb$art_i];
