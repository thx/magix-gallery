...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iikttszs$art_i = 0, $art_cgkczwmaci$art_c = checkboxes.length; $art_iikttszs$art_i < $art_cgkczwmaci$art_c; $art_iikttszs$art_i++) {    var c = checkboxes[$art_iikttszs$art_i]%>';
    for (var $art_iikttszs$art_i = 0, $art_cgkczwmaci$art_c = checkboxes.length; $art_iikttszs$art_i < $art_cgkczwmaci$art_c; $art_iikttszs$art_i++) {
        var c = checkboxes[$art_iikttszs$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivqirkhxd$art_i = 0, $art_cdvbkvf$art_c = radioes.length; $art_ivqirkhxd$art_i < $art_cdvbkvf$art_c; $art_ivqirkhxd$art_i++) {    var r = radioes[$art_ivqirkhxd$art_i]%>';
    for (var $art_ivqirkhxd$art_i = 0, $art_cdvbkvf$art_c = radioes.length; $art_ivqirkhxd$art_i < $art_cdvbkvf$art_c; $art_ivqirkhxd$art_i++) {
        var r = radioes[$art_ivqirkhxd$art_i];
