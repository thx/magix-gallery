...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isknzdqtqv$art_i = 0, $art_cbadqgwpp$art_c = checkboxes.length; $art_isknzdqtqv$art_i < $art_cbadqgwpp$art_c; $art_isknzdqtqv$art_i++) {    var c = checkboxes[$art_isknzdqtqv$art_i]%>';
    for (var $art_isknzdqtqv$art_i = 0, $art_cbadqgwpp$art_c = checkboxes.length; $art_isknzdqtqv$art_i < $art_cbadqgwpp$art_c; $art_isknzdqtqv$art_i++) {
        var c = checkboxes[$art_isknzdqtqv$art_i];
    ...
    ;
    $expr = '<%for (var $art_iszugvoda$art_i = 0, $art_cjijxmfo$art_c = radioes.length; $art_iszugvoda$art_i < $art_cjijxmfo$art_c; $art_iszugvoda$art_i++) {    var r = radioes[$art_iszugvoda$art_i]%>';
    for (var $art_iszugvoda$art_i = 0, $art_cjijxmfo$art_c = radioes.length; $art_iszugvoda$art_i < $art_cjijxmfo$art_c; $art_iszugvoda$art_i++) {
        var r = radioes[$art_iszugvoda$art_i];
