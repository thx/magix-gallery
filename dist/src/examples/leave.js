...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibgmyk$art_i = 0, $art_cwnkpjaxm$art_c = checkboxes.length; $art_ibgmyk$art_i < $art_cwnkpjaxm$art_c; $art_ibgmyk$art_i++) {    var c = checkboxes[$art_ibgmyk$art_i]%>';
    for (var $art_ibgmyk$art_i = 0, $art_cwnkpjaxm$art_c = checkboxes.length; $art_ibgmyk$art_i < $art_cwnkpjaxm$art_c; $art_ibgmyk$art_i++) {
        var c = checkboxes[$art_ibgmyk$art_i];
    ...
    ;
    $expr = '<%for (var $art_idheswwmifm$art_i = 0, $art_coovrlyd$art_c = radioes.length; $art_idheswwmifm$art_i < $art_coovrlyd$art_c; $art_idheswwmifm$art_i++) {    var r = radioes[$art_idheswwmifm$art_i]%>';
    for (var $art_idheswwmifm$art_i = 0, $art_coovrlyd$art_c = radioes.length; $art_idheswwmifm$art_i < $art_coovrlyd$art_c; $art_idheswwmifm$art_i++) {
        var r = radioes[$art_idheswwmifm$art_i];
