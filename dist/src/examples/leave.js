...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igsvbcejd$art_i = 0, $art_cwdkrgqj$art_c = checkboxes.length; $art_igsvbcejd$art_i < $art_cwdkrgqj$art_c; $art_igsvbcejd$art_i++) {    var c = checkboxes[$art_igsvbcejd$art_i]%>';
    for (var $art_igsvbcejd$art_i = 0, $art_cwdkrgqj$art_c = checkboxes.length; $art_igsvbcejd$art_i < $art_cwdkrgqj$art_c; $art_igsvbcejd$art_i++) {
        var c = checkboxes[$art_igsvbcejd$art_i];
    ...
    ;
    $expr = '<%for (var $art_iaodzrdluii$art_i = 0, $art_ccisnwnia$art_c = radioes.length; $art_iaodzrdluii$art_i < $art_ccisnwnia$art_c; $art_iaodzrdluii$art_i++) {    var r = radioes[$art_iaodzrdluii$art_i]%>';
    for (var $art_iaodzrdluii$art_i = 0, $art_ccisnwnia$art_c = radioes.length; $art_iaodzrdluii$art_i < $art_ccisnwnia$art_c; $art_iaodzrdluii$art_i++) {
        var r = radioes[$art_iaodzrdluii$art_i];
