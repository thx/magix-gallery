...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iampcfjwx$art_i = 0, $art_cbwddjsfb$art_c = checkboxes.length; $art_iampcfjwx$art_i < $art_cbwddjsfb$art_c; $art_iampcfjwx$art_i++) {    var c = checkboxes[$art_iampcfjwx$art_i]%>';
    for (var $art_iampcfjwx$art_i = 0, $art_cbwddjsfb$art_c = checkboxes.length; $art_iampcfjwx$art_i < $art_cbwddjsfb$art_c; $art_iampcfjwx$art_i++) {
        var c = checkboxes[$art_iampcfjwx$art_i];
    ...
    ;
    $expr = '<%for (var $art_iefshlyj$art_i = 0, $art_cufop$art_c = radioes.length; $art_iefshlyj$art_i < $art_cufop$art_c; $art_iefshlyj$art_i++) {    var r = radioes[$art_iefshlyj$art_i]%>';
    for (var $art_iefshlyj$art_i = 0, $art_cufop$art_c = radioes.length; $art_iefshlyj$art_i < $art_cufop$art_c; $art_iefshlyj$art_i++) {
        var r = radioes[$art_iefshlyj$art_i];
