...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryk:_" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryk:a" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-content clearfix"><form mxv mxa="_zs_galleryk:b" class="form mb20 fl mr20"><div mxv mxa="_zs_galleryk:c" class="form-item"><div mxs="_zs_galleryk:_" class="form-label">checkbox</div><div mxv mxa="_zs_galleryk:d" class="form-content">';
    $line = 7;
    $art = 'each checkboxes as c';
    ;
    $expr = '<%for (var $art_iigwzzbkm$art_i = 0, $art_cglxezszjq$art_c = checkboxes.length; $art_iigwzzbkm$art_i < $art_cglxezszjq$art_c; $art_iigwzzbkm$art_i++) {    var c = checkboxes[$art_iigwzzbkm$art_i]%>';
    for (var $art_iigwzzbkm$art_i = 0, $art_cglxezszjq$art_c = checkboxes.length; $art_iigwzzbkm$art_i < $art_cglxezszjq$art_c; $art_iigwzzbkm$art_i++) {
        var c = checkboxes[$art_iigwzzbkm$art_i];
    ...
    ;
    $expr = '<%for (var $art_iggoqreyv$art_i = 0, $art_clxitvgfia$art_c = radioes.length; $art_iggoqreyv$art_i < $art_clxitvgfia$art_c; $art_iggoqreyv$art_i++) {    var r = radioes[$art_iggoqreyv$art_i]%>';
    for (var $art_iggoqreyv$art_i = 0, $art_clxitvgfia$art_c = radioes.length; $art_iggoqreyv$art_i < $art_clxitvgfia$art_c; $art_iggoqreyv$art_i++) {
        var r = radioes[$art_iggoqreyv$art_i];
    ...
    $art = ':selected.switch{refresh:true}';
    ;
    $p += ($expr = '<%@selected["switch"]%>', $i($$ref, selected["switch"])) + '"></span></div></div><div mxs="_zs_galleryk:e" class="form-item"><a href="javascript:;" class="btn w80 btn-brand mr20" mx-click="' + $viewId + 'save()">保存表单</a></div></form></div><div mxa="_zs_galleryk:o" class="clearfix"><div mxa="_zs_galleryk:p" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half"><div mxs="_zs_galleryk:f" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 64;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryk:q" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 66;
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryk:g" class="mc-iconfont _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 69;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n12312\n            </pre></div><div mxa="_zs_galleryk:r" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-desc _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half-right"><div mxs="_zs_galleryk:h" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-eg-title">JS Code</div><div class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 75;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryk:s" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 77;
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryk:g" class="mc-iconfont _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="examples/hl" id="';
    $line = 80;
    $art = '=viewId';
    ;
    ...
    'done<success>': function (e) {
        ...
        var id = e.params.id;
        var data = {};
        data['text' + id] = '<i class="mc-iconfont _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-tip-icon">&#xe630;</i>复制成功';
