...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igsqhwdbb$art_i = 0, $art_crvuvgzefe$art_c = checkboxes.length; $art_igsqhwdbb$art_i < $art_crvuvgzefe$art_c; $art_igsqhwdbb$art_i++) {    var c = checkboxes[$art_igsqhwdbb$art_i]%>';
    for (var $art_igsqhwdbb$art_i = 0, $art_crvuvgzefe$art_c = checkboxes.length; $art_igsqhwdbb$art_i < $art_crvuvgzefe$art_c; $art_igsqhwdbb$art_i++) {
        var c = checkboxes[$art_igsqhwdbb$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibkkuwmyrv$art_i = 0, $art_cfrqw$art_c = radioes.length; $art_ibkkuwmyrv$art_i < $art_cfrqw$art_c; $art_ibkkuwmyrv$art_i++) {    var r = radioes[$art_ibkkuwmyrv$art_i]%>';
    for (var $art_ibkkuwmyrv$art_i = 0, $art_cfrqw$art_c = radioes.length; $art_ibkkuwmyrv$art_i < $art_cfrqw$art_c; $art_ibkkuwmyrv$art_i++) {
        var r = radioes[$art_ibkkuwmyrv$art_i];
