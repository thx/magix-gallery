...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idghzasxb$art_i = 0, $art_cdpbtfffhc$art_c = headers.length; $art_idghzasxb$art_i < $art_cdpbtfffhc$art_c; $art_idghzasxb$art_i++) {    var h = headers[$art_idghzasxb$art_i]%>';
    for (var $art_idghzasxb$art_i = 0, $art_cdpbtfffhc$art_c = headers.length; $art_idghzasxb$art_i < $art_cdpbtfffhc$art_c; $art_idghzasxb$art_i++) {
        var h = headers[$art_idghzasxb$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_itehxtgwbb$art_i = 0, $art_cedefthz$art_c = list.length; $art_itehxtgwbb$art_i < $art_cedefthz$art_c; $art_itehxtgwbb$art_i++) {    var item = list[$art_itehxtgwbb$art_i]%>';
    for (var $art_itehxtgwbb$art_i = 0, $art_cedefthz$art_c = list.length; $art_itehxtgwbb$art_i < $art_cedefthz$art_c; $art_itehxtgwbb$art_i++) {
        var item = list[$art_itehxtgwbb$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ioijyqupvm$art_i = 0, $art_objvuqoztpiqz$art_obj = item.subs, $art_cgxfmmrn$art_c = $art_objvuqoztpiqz$art_obj.length; $art_ioijyqupvm$art_i < $art_cgxfmmrn$art_c; $art_ioijyqupvm$art_i++) {        var sub = $art_objvuqoztpiqz$art_obj[$art_ioijyqupvm$art_i]%>';
        for (var $art_ioijyqupvm$art_i = 0, $art_objvuqoztpiqz$art_obj = item.subs, $art_cgxfmmrn$art_c = $art_objvuqoztpiqz$art_obj.length; $art_ioijyqupvm$art_i < $art_cgxfmmrn$art_c; $art_ioijyqupvm$art_i++) {
            var sub = $art_objvuqoztpiqz$art_obj[$art_ioijyqupvm$art_i];
