...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifpmtpjnu$art_i = 0, $art_csriejnfns$art_c = headers.length; $art_ifpmtpjnu$art_i < $art_csriejnfns$art_c; $art_ifpmtpjnu$art_i++) {    var h = headers[$art_ifpmtpjnu$art_i]%>';
    for (var $art_ifpmtpjnu$art_i = 0, $art_csriejnfns$art_c = headers.length; $art_ifpmtpjnu$art_i < $art_csriejnfns$art_c; $art_ifpmtpjnu$art_i++) {
        var h = headers[$art_ifpmtpjnu$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ivzyomf$art_i = 0, $art_ciaktmrazl$art_c = list.length; $art_ivzyomf$art_i < $art_ciaktmrazl$art_c; $art_ivzyomf$art_i++) {    var item = list[$art_ivzyomf$art_i]%>';
    for (var $art_ivzyomf$art_i = 0, $art_ciaktmrazl$art_c = list.length; $art_ivzyomf$art_i < $art_ciaktmrazl$art_c; $art_ivzyomf$art_i++) {
        var item = list[$art_ivzyomf$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_izgiij$art_i = 0, $art_objymqvudqatg$art_obj = item.subs, $art_cmlfqs$art_c = $art_objymqvudqatg$art_obj.length; $art_izgiij$art_i < $art_cmlfqs$art_c; $art_izgiij$art_i++) {        var sub = $art_objymqvudqatg$art_obj[$art_izgiij$art_i]%>';
        for (var $art_izgiij$art_i = 0, $art_objymqvudqatg$art_obj = item.subs, $art_cmlfqs$art_c = $art_objymqvudqatg$art_obj.length; $art_izgiij$art_i < $art_cmlfqs$art_c; $art_izgiij$art_i++) {
            var sub = $art_objymqvudqatg$art_obj[$art_izgiij$art_i];
