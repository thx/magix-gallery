...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iebimadv$art_i = 0, $art_cmhaazpsm$art_c = headers.length; $art_iebimadv$art_i < $art_cmhaazpsm$art_c; $art_iebimadv$art_i++) {    var h = headers[$art_iebimadv$art_i]%>';
    for (var $art_iebimadv$art_i = 0, $art_cmhaazpsm$art_c = headers.length; $art_iebimadv$art_i < $art_cmhaazpsm$art_c; $art_iebimadv$art_i++) {
        var h = headers[$art_iebimadv$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_icfpfqdn$art_i = 0, $art_ccqkipuumi$art_c = list.length; $art_icfpfqdn$art_i < $art_ccqkipuumi$art_c; $art_icfpfqdn$art_i++) {    var item = list[$art_icfpfqdn$art_i]%>';
    for (var $art_icfpfqdn$art_i = 0, $art_ccqkipuumi$art_c = list.length; $art_icfpfqdn$art_i < $art_ccqkipuumi$art_c; $art_icfpfqdn$art_i++) {
        var item = list[$art_icfpfqdn$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ifeplrxc$art_i = 0, $art_objhhvsetb$art_obj = item.subs, $art_ctmyogv$art_c = $art_objhhvsetb$art_obj.length; $art_ifeplrxc$art_i < $art_ctmyogv$art_c; $art_ifeplrxc$art_i++) {        var sub = $art_objhhvsetb$art_obj[$art_ifeplrxc$art_i]%>';
        for (var $art_ifeplrxc$art_i = 0, $art_objhhvsetb$art_obj = item.subs, $art_ctmyogv$art_c = $art_objhhvsetb$art_obj.length; $art_ifeplrxc$art_i < $art_ctmyogv$art_c; $art_ifeplrxc$art_i++) {
            var sub = $art_objhhvsetb$art_obj[$art_ifeplrxc$art_i];
