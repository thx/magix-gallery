...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inlq$art_i = 0, $art_camoefwl$art_c = headers.length; $art_inlq$art_i < $art_camoefwl$art_c; $art_inlq$art_i++) {    var h = headers[$art_inlq$art_i]%>';
    for (var $art_inlq$art_i = 0, $art_camoefwl$art_c = headers.length; $art_inlq$art_i < $art_camoefwl$art_c; $art_inlq$art_i++) {
        var h = headers[$art_inlq$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ihemwv$art_i = 0, $art_crsxhzgovai$art_c = list.length; $art_ihemwv$art_i < $art_crsxhzgovai$art_c; $art_ihemwv$art_i++) {    var item = list[$art_ihemwv$art_i]%>';
    for (var $art_ihemwv$art_i = 0, $art_crsxhzgovai$art_c = list.length; $art_ihemwv$art_i < $art_crsxhzgovai$art_c; $art_ihemwv$art_i++) {
        var item = list[$art_ihemwv$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iqqtggzm$art_i = 0, $art_objvijjtwyc$art_obj = item.subs, $art_cdkcygrz$art_c = $art_objvijjtwyc$art_obj.length; $art_iqqtggzm$art_i < $art_cdkcygrz$art_c; $art_iqqtggzm$art_i++) {        var sub = $art_objvijjtwyc$art_obj[$art_iqqtggzm$art_i]%>';
        for (var $art_iqqtggzm$art_i = 0, $art_objvijjtwyc$art_obj = item.subs, $art_cdkcygrz$art_c = $art_objvijjtwyc$art_obj.length; $art_iqqtggzm$art_i < $art_cdkcygrz$art_c; $art_iqqtggzm$art_i++) {
            var sub = $art_objvijjtwyc$art_obj[$art_iqqtggzm$art_i];
