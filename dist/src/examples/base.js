...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iziqpsqghb$art_i = 0, $art_cfigdhkpqd$art_c = headers.length; $art_iziqpsqghb$art_i < $art_cfigdhkpqd$art_c; $art_iziqpsqghb$art_i++) {    var h = headers[$art_iziqpsqghb$art_i]%>';
    for (var $art_iziqpsqghb$art_i = 0, $art_cfigdhkpqd$art_c = headers.length; $art_iziqpsqghb$art_i < $art_cfigdhkpqd$art_c; $art_iziqpsqghb$art_i++) {
        var h = headers[$art_iziqpsqghb$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_igpcwjcuzc$art_i = 0, $art_ctiymye$art_c = list.length; $art_igpcwjcuzc$art_i < $art_ctiymye$art_c; $art_igpcwjcuzc$art_i++) {    var item = list[$art_igpcwjcuzc$art_i]%>';
    for (var $art_igpcwjcuzc$art_i = 0, $art_ctiymye$art_c = list.length; $art_igpcwjcuzc$art_i < $art_ctiymye$art_c; $art_igpcwjcuzc$art_i++) {
        var item = list[$art_igpcwjcuzc$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_inhpcpjet$art_i = 0, $art_objxcizsykb$art_obj = item.subs, $art_cvmxuxuwxlh$art_c = $art_objxcizsykb$art_obj.length; $art_inhpcpjet$art_i < $art_cvmxuxuwxlh$art_c; $art_inhpcpjet$art_i++) {        var sub = $art_objxcizsykb$art_obj[$art_inhpcpjet$art_i]%>';
        for (var $art_inhpcpjet$art_i = 0, $art_objxcizsykb$art_obj = item.subs, $art_cvmxuxuwxlh$art_c = $art_objxcizsykb$art_obj.length; $art_inhpcpjet$art_i < $art_cvmxuxuwxlh$art_c; $art_inhpcpjet$art_i++) {
            var sub = $art_objxcizsykb$art_obj[$art_inhpcpjet$art_i];
