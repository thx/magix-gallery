...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilavclpqyn$art_i = 0, $art_ckbaenefs$art_c = headers.length; $art_ilavclpqyn$art_i < $art_ckbaenefs$art_c; $art_ilavclpqyn$art_i++) {    var h = headers[$art_ilavclpqyn$art_i]%>';
    for (var $art_ilavclpqyn$art_i = 0, $art_ckbaenefs$art_c = headers.length; $art_ilavclpqyn$art_i < $art_ckbaenefs$art_c; $art_ilavclpqyn$art_i++) {
        var h = headers[$art_ilavclpqyn$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iahkpnlww$art_i = 0, $art_cdsobcrc$art_c = list.length; $art_iahkpnlww$art_i < $art_cdsobcrc$art_c; $art_iahkpnlww$art_i++) {    var item = list[$art_iahkpnlww$art_i]%>';
    for (var $art_iahkpnlww$art_i = 0, $art_cdsobcrc$art_c = list.length; $art_iahkpnlww$art_i < $art_cdsobcrc$art_c; $art_iahkpnlww$art_i++) {
        var item = list[$art_iahkpnlww$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ityfmaw$art_i = 0, $art_objvvkzl$art_obj = item.subs, $art_cwoxuydeeia$art_c = $art_objvvkzl$art_obj.length; $art_ityfmaw$art_i < $art_cwoxuydeeia$art_c; $art_ityfmaw$art_i++) {        var sub = $art_objvvkzl$art_obj[$art_ityfmaw$art_i]%>';
        for (var $art_ityfmaw$art_i = 0, $art_objvvkzl$art_obj = item.subs, $art_cwoxuydeeia$art_c = $art_objvvkzl$art_obj.length; $art_ityfmaw$art_i < $art_cwoxuydeeia$art_c; $art_ityfmaw$art_i++) {
            var sub = $art_objvvkzl$art_obj[$art_ityfmaw$art_i];
