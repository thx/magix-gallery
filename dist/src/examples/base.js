...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izyhdkmhtu$art_i = 0, $art_cmmnbcwz$art_c = headers.length; $art_izyhdkmhtu$art_i < $art_cmmnbcwz$art_c; $art_izyhdkmhtu$art_i++) {    var h = headers[$art_izyhdkmhtu$art_i]%>';
    for (var $art_izyhdkmhtu$art_i = 0, $art_cmmnbcwz$art_c = headers.length; $art_izyhdkmhtu$art_i < $art_cmmnbcwz$art_c; $art_izyhdkmhtu$art_i++) {
        var h = headers[$art_izyhdkmhtu$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iqifygxx$art_i = 0, $art_cqcxhiv$art_c = list.length; $art_iqifygxx$art_i < $art_cqcxhiv$art_c; $art_iqifygxx$art_i++) {    var item = list[$art_iqifygxx$art_i]%>';
    for (var $art_iqifygxx$art_i = 0, $art_cqcxhiv$art_c = list.length; $art_iqifygxx$art_i < $art_cqcxhiv$art_c; $art_iqifygxx$art_i++) {
        var item = list[$art_iqifygxx$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iiqbprqx$art_i = 0, $art_objpksslrprp$art_obj = item.subs, $art_cmzapmltq$art_c = $art_objpksslrprp$art_obj.length; $art_iiqbprqx$art_i < $art_cmzapmltq$art_c; $art_iiqbprqx$art_i++) {        var sub = $art_objpksslrprp$art_obj[$art_iiqbprqx$art_i]%>';
        for (var $art_iiqbprqx$art_i = 0, $art_objpksslrprp$art_obj = item.subs, $art_cmzapmltq$art_c = $art_objpksslrprp$art_obj.length; $art_iiqbprqx$art_i < $art_cmzapmltq$art_c; $art_iiqbprqx$art_i++) {
            var sub = $art_objpksslrprp$art_obj[$art_iiqbprqx$art_i];
