...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiffbyape$art_i = 0, $art_ckebawbil$art_c = headers.length; $art_iiffbyape$art_i < $art_ckebawbil$art_c; $art_iiffbyape$art_i++) {    var h = headers[$art_iiffbyape$art_i]%>';
    for (var $art_iiffbyape$art_i = 0, $art_ckebawbil$art_c = headers.length; $art_iiffbyape$art_i < $art_ckebawbil$art_c; $art_iiffbyape$art_i++) {
        var h = headers[$art_iiffbyape$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_imywkinhfq$art_i = 0, $art_cpjnytmdr$art_c = list.length; $art_imywkinhfq$art_i < $art_cpjnytmdr$art_c; $art_imywkinhfq$art_i++) {    var item = list[$art_imywkinhfq$art_i]%>';
    for (var $art_imywkinhfq$art_i = 0, $art_cpjnytmdr$art_c = list.length; $art_imywkinhfq$art_i < $art_cpjnytmdr$art_c; $art_imywkinhfq$art_i++) {
        var item = list[$art_imywkinhfq$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ignmadccjue$art_i = 0, $art_objcevorscdun$art_obj = item.subs, $art_ctqwwzoie$art_c = $art_objcevorscdun$art_obj.length; $art_ignmadccjue$art_i < $art_ctqwwzoie$art_c; $art_ignmadccjue$art_i++) {        var sub = $art_objcevorscdun$art_obj[$art_ignmadccjue$art_i]%>';
        for (var $art_ignmadccjue$art_i = 0, $art_objcevorscdun$art_obj = item.subs, $art_ctqwwzoie$art_c = $art_objcevorscdun$art_obj.length; $art_ignmadccjue$art_i < $art_ctqwwzoie$art_c; $art_ignmadccjue$art_i++) {
            var sub = $art_objcevorscdun$art_obj[$art_ignmadccjue$art_i];
