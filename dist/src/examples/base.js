...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivovuhd$art_i = 0, $art_cyhdise$art_c = headers.length; $art_ivovuhd$art_i < $art_cyhdise$art_c; $art_ivovuhd$art_i++) {    var h = headers[$art_ivovuhd$art_i]%>';
    for (var $art_ivovuhd$art_i = 0, $art_cyhdise$art_c = headers.length; $art_ivovuhd$art_i < $art_cyhdise$art_c; $art_ivovuhd$art_i++) {
        var h = headers[$art_ivovuhd$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ixyiunniaj$art_i = 0, $art_clnpbtxpza$art_c = list.length; $art_ixyiunniaj$art_i < $art_clnpbtxpza$art_c; $art_ixyiunniaj$art_i++) {    var item = list[$art_ixyiunniaj$art_i]%>';
    for (var $art_ixyiunniaj$art_i = 0, $art_clnpbtxpza$art_c = list.length; $art_ixyiunniaj$art_i < $art_clnpbtxpza$art_c; $art_ixyiunniaj$art_i++) {
        var item = list[$art_ixyiunniaj$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ilgphjguf$art_i = 0, $art_objaoalftje$art_obj = item.subs, $art_cakkbnrmtfb$art_c = $art_objaoalftje$art_obj.length; $art_ilgphjguf$art_i < $art_cakkbnrmtfb$art_c; $art_ilgphjguf$art_i++) {        var sub = $art_objaoalftje$art_obj[$art_ilgphjguf$art_i]%>';
        for (var $art_ilgphjguf$art_i = 0, $art_objaoalftje$art_obj = item.subs, $art_cakkbnrmtfb$art_c = $art_objaoalftje$art_obj.length; $art_ilgphjguf$art_i < $art_cakkbnrmtfb$art_c; $art_ilgphjguf$art_i++) {
            var sub = $art_objaoalftje$art_obj[$art_ilgphjguf$art_i];
