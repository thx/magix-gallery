...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqtgndc$art_i = 0, $art_ceqrhdkax$art_c = headers.length; $art_iqtgndc$art_i < $art_ceqrhdkax$art_c; $art_iqtgndc$art_i++) {    var h = headers[$art_iqtgndc$art_i]%>';
    for (var $art_iqtgndc$art_i = 0, $art_ceqrhdkax$art_c = headers.length; $art_iqtgndc$art_i < $art_ceqrhdkax$art_c; $art_iqtgndc$art_i++) {
        var h = headers[$art_iqtgndc$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iwbmoabybwd$art_i = 0, $art_costouphtp$art_c = list.length; $art_iwbmoabybwd$art_i < $art_costouphtp$art_c; $art_iwbmoabybwd$art_i++) {    var item = list[$art_iwbmoabybwd$art_i]%>';
    for (var $art_iwbmoabybwd$art_i = 0, $art_costouphtp$art_c = list.length; $art_iwbmoabybwd$art_i < $art_costouphtp$art_c; $art_iwbmoabybwd$art_i++) {
        var item = list[$art_iwbmoabybwd$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_issorlrfil$art_i = 0, $art_objgzhjwaut$art_obj = item.subs, $art_cnzmwlqkta$art_c = $art_objgzhjwaut$art_obj.length; $art_issorlrfil$art_i < $art_cnzmwlqkta$art_c; $art_issorlrfil$art_i++) {        var sub = $art_objgzhjwaut$art_obj[$art_issorlrfil$art_i]%>';
        for (var $art_issorlrfil$art_i = 0, $art_objgzhjwaut$art_obj = item.subs, $art_cnzmwlqkta$art_c = $art_objgzhjwaut$art_obj.length; $art_issorlrfil$art_i < $art_cnzmwlqkta$art_c; $art_issorlrfil$art_i++) {
            var sub = $art_objgzhjwaut$art_obj[$art_issorlrfil$art_i];
