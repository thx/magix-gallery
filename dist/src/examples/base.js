...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itmspgsolkjj$art_i = 0, $art_ctshviqbion$art_c = headers.length; $art_itmspgsolkjj$art_i < $art_ctshviqbion$art_c; $art_itmspgsolkjj$art_i++) {    var h = headers[$art_itmspgsolkjj$art_i]%>';
    for (var $art_itmspgsolkjj$art_i = 0, $art_ctshviqbion$art_c = headers.length; $art_itmspgsolkjj$art_i < $art_ctshviqbion$art_c; $art_itmspgsolkjj$art_i++) {
        var h = headers[$art_itmspgsolkjj$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ixvvvdkm$art_i = 0, $art_cdnnickmku$art_c = list.length; $art_ixvvvdkm$art_i < $art_cdnnickmku$art_c; $art_ixvvvdkm$art_i++) {    var item = list[$art_ixvvvdkm$art_i]%>';
    for (var $art_ixvvvdkm$art_i = 0, $art_cdnnickmku$art_c = list.length; $art_ixvvvdkm$art_i < $art_cdnnickmku$art_c; $art_ixvvvdkm$art_i++) {
        var item = list[$art_ixvvvdkm$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ioxmabmpmil$art_i = 0, $art_objwymjuns$art_obj = item.subs, $art_crnqcqzss$art_c = $art_objwymjuns$art_obj.length; $art_ioxmabmpmil$art_i < $art_crnqcqzss$art_c; $art_ioxmabmpmil$art_i++) {        var sub = $art_objwymjuns$art_obj[$art_ioxmabmpmil$art_i]%>';
        for (var $art_ioxmabmpmil$art_i = 0, $art_objwymjuns$art_obj = item.subs, $art_crnqcqzss$art_c = $art_objwymjuns$art_obj.length; $art_ioxmabmpmil$art_i < $art_crnqcqzss$art_c; $art_ioxmabmpmil$art_i++) {
            var sub = $art_objwymjuns$art_obj[$art_ioxmabmpmil$art_i];
