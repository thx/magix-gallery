...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iryuyjls$art_i = 0, $art_caxjgdve$art_c = headers.length; $art_iryuyjls$art_i < $art_caxjgdve$art_c; $art_iryuyjls$art_i++) {    var h = headers[$art_iryuyjls$art_i]%>';
    for (var $art_iryuyjls$art_i = 0, $art_caxjgdve$art_c = headers.length; $art_iryuyjls$art_i < $art_caxjgdve$art_c; $art_iryuyjls$art_i++) {
        var h = headers[$art_iryuyjls$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_imkzsy$art_i = 0, $art_cusiiekrjdl$art_c = list.length; $art_imkzsy$art_i < $art_cusiiekrjdl$art_c; $art_imkzsy$art_i++) {    var item = list[$art_imkzsy$art_i]%>';
    for (var $art_imkzsy$art_i = 0, $art_cusiiekrjdl$art_c = list.length; $art_imkzsy$art_i < $art_cusiiekrjdl$art_c; $art_imkzsy$art_i++) {
        var item = list[$art_imkzsy$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iqbnkafo$art_i = 0, $art_objhztkjjtd$art_obj = item.subs, $art_cyyrfhll$art_c = $art_objhztkjjtd$art_obj.length; $art_iqbnkafo$art_i < $art_cyyrfhll$art_c; $art_iqbnkafo$art_i++) {        var sub = $art_objhztkjjtd$art_obj[$art_iqbnkafo$art_i]%>';
        for (var $art_iqbnkafo$art_i = 0, $art_objhztkjjtd$art_obj = item.subs, $art_cyyrfhll$art_c = $art_objhztkjjtd$art_obj.length; $art_iqbnkafo$art_i < $art_cyyrfhll$art_c; $art_iqbnkafo$art_i++) {
            var sub = $art_objhztkjjtd$art_obj[$art_iqbnkafo$art_i];
