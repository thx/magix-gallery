...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imusmytghc$art_i = 0, $art_crkxyhjbqcb$art_c = headers.length; $art_imusmytghc$art_i < $art_crkxyhjbqcb$art_c; $art_imusmytghc$art_i++) {    var h = headers[$art_imusmytghc$art_i]%>';
    for (var $art_imusmytghc$art_i = 0, $art_crkxyhjbqcb$art_c = headers.length; $art_imusmytghc$art_i < $art_crkxyhjbqcb$art_c; $art_imusmytghc$art_i++) {
        var h = headers[$art_imusmytghc$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iebwrbmcxu$art_i = 0, $art_cxewk$art_c = list.length; $art_iebwrbmcxu$art_i < $art_cxewk$art_c; $art_iebwrbmcxu$art_i++) {    var item = list[$art_iebwrbmcxu$art_i]%>';
    for (var $art_iebwrbmcxu$art_i = 0, $art_cxewk$art_c = list.length; $art_iebwrbmcxu$art_i < $art_cxewk$art_c; $art_iebwrbmcxu$art_i++) {
        var item = list[$art_iebwrbmcxu$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iqmedvi$art_i = 0, $art_objpczexe$art_obj = item.subs, $art_cflmw$art_c = $art_objpczexe$art_obj.length; $art_iqmedvi$art_i < $art_cflmw$art_c; $art_iqmedvi$art_i++) {        var sub = $art_objpczexe$art_obj[$art_iqmedvi$art_i]%>';
        for (var $art_iqmedvi$art_i = 0, $art_objpczexe$art_obj = item.subs, $art_cflmw$art_c = $art_objpczexe$art_obj.length; $art_iqmedvi$art_i < $art_cflmw$art_c; $art_iqmedvi$art_i++) {
            var sub = $art_objpczexe$art_obj[$art_iqmedvi$art_i];
