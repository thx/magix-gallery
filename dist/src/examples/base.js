...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijtsvvlpjun$art_i = 0, $art_cdqvmje$art_c = headers.length; $art_ijtsvvlpjun$art_i < $art_cdqvmje$art_c; $art_ijtsvvlpjun$art_i++) {    var h = headers[$art_ijtsvvlpjun$art_i]%>';
    for (var $art_ijtsvvlpjun$art_i = 0, $art_cdqvmje$art_c = headers.length; $art_ijtsvvlpjun$art_i < $art_cdqvmje$art_c; $art_ijtsvvlpjun$art_i++) {
        var h = headers[$art_ijtsvvlpjun$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ijfnehpff$art_i = 0, $art_cwospjo$art_c = list.length; $art_ijfnehpff$art_i < $art_cwospjo$art_c; $art_ijfnehpff$art_i++) {    var item = list[$art_ijfnehpff$art_i]%>';
    for (var $art_ijfnehpff$art_i = 0, $art_cwospjo$art_c = list.length; $art_ijfnehpff$art_i < $art_cwospjo$art_c; $art_ijfnehpff$art_i++) {
        var item = list[$art_ijfnehpff$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ioygeqdlh$art_i = 0, $art_objjkpmewqg$art_obj = item.subs, $art_chduolvruao$art_c = $art_objjkpmewqg$art_obj.length; $art_ioygeqdlh$art_i < $art_chduolvruao$art_c; $art_ioygeqdlh$art_i++) {        var sub = $art_objjkpmewqg$art_obj[$art_ioygeqdlh$art_i]%>';
        for (var $art_ioygeqdlh$art_i = 0, $art_objjkpmewqg$art_obj = item.subs, $art_chduolvruao$art_c = $art_objjkpmewqg$art_obj.length; $art_ioygeqdlh$art_i < $art_chduolvruao$art_c; $art_ioygeqdlh$art_i++) {
            var sub = $art_objjkpmewqg$art_obj[$art_ioygeqdlh$art_i];
