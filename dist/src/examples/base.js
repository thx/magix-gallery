...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inqzvx$art_i = 0, $art_cdegzslgmg$art_c = headers.length; $art_inqzvx$art_i < $art_cdegzslgmg$art_c; $art_inqzvx$art_i++) {    var h = headers[$art_inqzvx$art_i]%>';
    for (var $art_inqzvx$art_i = 0, $art_cdegzslgmg$art_c = headers.length; $art_inqzvx$art_i < $art_cdegzslgmg$art_c; $art_inqzvx$art_i++) {
        var h = headers[$art_inqzvx$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iymcggzs$art_i = 0, $art_cfrfcethmm$art_c = list.length; $art_iymcggzs$art_i < $art_cfrfcethmm$art_c; $art_iymcggzs$art_i++) {    var item = list[$art_iymcggzs$art_i]%>';
    for (var $art_iymcggzs$art_i = 0, $art_cfrfcethmm$art_c = list.length; $art_iymcggzs$art_i < $art_cfrfcethmm$art_c; $art_iymcggzs$art_i++) {
        var item = list[$art_iymcggzs$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ipyosegsg$art_i = 0, $art_objdpjhukna$art_obj = item.subs, $art_cduqxmzag$art_c = $art_objdpjhukna$art_obj.length; $art_ipyosegsg$art_i < $art_cduqxmzag$art_c; $art_ipyosegsg$art_i++) {        var sub = $art_objdpjhukna$art_obj[$art_ipyosegsg$art_i]%>';
        for (var $art_ipyosegsg$art_i = 0, $art_objdpjhukna$art_obj = item.subs, $art_cduqxmzag$art_c = $art_objdpjhukna$art_obj.length; $art_ipyosegsg$art_i < $art_cduqxmzag$art_c; $art_ipyosegsg$art_i++) {
            var sub = $art_objdpjhukna$art_obj[$art_ipyosegsg$art_i];
