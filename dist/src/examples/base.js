...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijxnqnq$art_i = 0, $art_cxygfrbhxb$art_c = headers.length; $art_ijxnqnq$art_i < $art_cxygfrbhxb$art_c; $art_ijxnqnq$art_i++) {    var h = headers[$art_ijxnqnq$art_i]%>';
    for (var $art_ijxnqnq$art_i = 0, $art_cxygfrbhxb$art_c = headers.length; $art_ijxnqnq$art_i < $art_cxygfrbhxb$art_c; $art_ijxnqnq$art_i++) {
        var h = headers[$art_ijxnqnq$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ibkaaavb$art_i = 0, $art_cfhvqphq$art_c = list.length; $art_ibkaaavb$art_i < $art_cfhvqphq$art_c; $art_ibkaaavb$art_i++) {    var item = list[$art_ibkaaavb$art_i]%>';
    for (var $art_ibkaaavb$art_i = 0, $art_cfhvqphq$art_c = list.length; $art_ibkaaavb$art_i < $art_cfhvqphq$art_c; $art_ibkaaavb$art_i++) {
        var item = list[$art_ibkaaavb$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_imrcvlkehf$art_i = 0, $art_objiksdray$art_obj = item.subs, $art_cbtslznn$art_c = $art_objiksdray$art_obj.length; $art_imrcvlkehf$art_i < $art_cbtslznn$art_c; $art_imrcvlkehf$art_i++) {        var sub = $art_objiksdray$art_obj[$art_imrcvlkehf$art_i]%>';
        for (var $art_imrcvlkehf$art_i = 0, $art_objiksdray$art_obj = item.subs, $art_cbtslznn$art_c = $art_objiksdray$art_obj.length; $art_imrcvlkehf$art_i < $art_cbtslznn$art_c; $art_imrcvlkehf$art_i++) {
            var sub = $art_objiksdray$art_obj[$art_imrcvlkehf$art_i];
