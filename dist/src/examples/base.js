...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqoyoquuya$art_i = 0, $art_cyukicrp$art_c = headers.length; $art_iqoyoquuya$art_i < $art_cyukicrp$art_c; $art_iqoyoquuya$art_i++) {    var h = headers[$art_iqoyoquuya$art_i]%>';
    for (var $art_iqoyoquuya$art_i = 0, $art_cyukicrp$art_c = headers.length; $art_iqoyoquuya$art_i < $art_cyukicrp$art_c; $art_iqoyoquuya$art_i++) {
        var h = headers[$art_iqoyoquuya$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ibcuygwk$art_i = 0, $art_ckyiwpux$art_c = list.length; $art_ibcuygwk$art_i < $art_ckyiwpux$art_c; $art_ibcuygwk$art_i++) {    var item = list[$art_ibcuygwk$art_i]%>';
    for (var $art_ibcuygwk$art_i = 0, $art_ckyiwpux$art_c = list.length; $art_ibcuygwk$art_i < $art_ckyiwpux$art_c; $art_ibcuygwk$art_i++) {
        var item = list[$art_ibcuygwk$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iqdqjjntj$art_i = 0, $art_objvtxcfyxroul$art_obj = item.subs, $art_clfaemsc$art_c = $art_objvtxcfyxroul$art_obj.length; $art_iqdqjjntj$art_i < $art_clfaemsc$art_c; $art_iqdqjjntj$art_i++) {        var sub = $art_objvtxcfyxroul$art_obj[$art_iqdqjjntj$art_i]%>';
        for (var $art_iqdqjjntj$art_i = 0, $art_objvtxcfyxroul$art_obj = item.subs, $art_clfaemsc$art_c = $art_objvtxcfyxroul$art_obj.length; $art_iqdqjjntj$art_i < $art_clfaemsc$art_c; $art_iqdqjjntj$art_i++) {
            var sub = $art_objvtxcfyxroul$art_obj[$art_iqdqjjntj$art_i];
