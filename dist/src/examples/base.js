...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ittdpdf$art_i = 0, $art_caqmmpinvu$art_c = headers.length; $art_ittdpdf$art_i < $art_caqmmpinvu$art_c; $art_ittdpdf$art_i++) {    var h = headers[$art_ittdpdf$art_i]%>';
    for (var $art_ittdpdf$art_i = 0, $art_caqmmpinvu$art_c = headers.length; $art_ittdpdf$art_i < $art_caqmmpinvu$art_c; $art_ittdpdf$art_i++) {
        var h = headers[$art_ittdpdf$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iytdgdtf$art_i = 0, $art_cwjrhkbyo$art_c = list.length; $art_iytdgdtf$art_i < $art_cwjrhkbyo$art_c; $art_iytdgdtf$art_i++) {    var item = list[$art_iytdgdtf$art_i]%>';
    for (var $art_iytdgdtf$art_i = 0, $art_cwjrhkbyo$art_c = list.length; $art_iytdgdtf$art_i < $art_cwjrhkbyo$art_c; $art_iytdgdtf$art_i++) {
        var item = list[$art_iytdgdtf$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_isgneqklgaa$art_i = 0, $art_objoirrc$art_obj = item.subs, $art_capeegjswd$art_c = $art_objoirrc$art_obj.length; $art_isgneqklgaa$art_i < $art_capeegjswd$art_c; $art_isgneqklgaa$art_i++) {        var sub = $art_objoirrc$art_obj[$art_isgneqklgaa$art_i]%>';
        for (var $art_isgneqklgaa$art_i = 0, $art_objoirrc$art_obj = item.subs, $art_capeegjswd$art_c = $art_objoirrc$art_obj.length; $art_isgneqklgaa$art_i < $art_capeegjswd$art_c; $art_isgneqklgaa$art_i++) {
            var sub = $art_objoirrc$art_obj[$art_isgneqklgaa$art_i];
