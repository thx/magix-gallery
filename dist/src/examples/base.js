...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iysbklntnc$art_i = 0, $art_cmproeecjy$art_c = headers.length; $art_iysbklntnc$art_i < $art_cmproeecjy$art_c; $art_iysbklntnc$art_i++) {    var h = headers[$art_iysbklntnc$art_i]%>';
    for (var $art_iysbklntnc$art_i = 0, $art_cmproeecjy$art_c = headers.length; $art_iysbklntnc$art_i < $art_cmproeecjy$art_c; $art_iysbklntnc$art_i++) {
        var h = headers[$art_iysbklntnc$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ivouuiigjgb$art_i = 0, $art_cgixpavaqm$art_c = list.length; $art_ivouuiigjgb$art_i < $art_cgixpavaqm$art_c; $art_ivouuiigjgb$art_i++) {    var item = list[$art_ivouuiigjgb$art_i]%>';
    for (var $art_ivouuiigjgb$art_i = 0, $art_cgixpavaqm$art_c = list.length; $art_ivouuiigjgb$art_i < $art_cgixpavaqm$art_c; $art_ivouuiigjgb$art_i++) {
        var item = list[$art_ivouuiigjgb$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ihxmzncecu$art_i = 0, $art_objrjfiiaadj$art_obj = item.subs, $art_czdofkvrf$art_c = $art_objrjfiiaadj$art_obj.length; $art_ihxmzncecu$art_i < $art_czdofkvrf$art_c; $art_ihxmzncecu$art_i++) {        var sub = $art_objrjfiiaadj$art_obj[$art_ihxmzncecu$art_i]%>';
        for (var $art_ihxmzncecu$art_i = 0, $art_objrjfiiaadj$art_obj = item.subs, $art_czdofkvrf$art_c = $art_objrjfiiaadj$art_obj.length; $art_ihxmzncecu$art_i < $art_czdofkvrf$art_c; $art_ihxmzncecu$art_i++) {
            var sub = $art_objrjfiiaadj$art_obj[$art_ihxmzncecu$art_i];
