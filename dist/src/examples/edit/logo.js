...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibuuumvipmk$art_i = 0, $art_cqtokdveq$art_c = themes.length; $art_ibuuumvipmk$art_i < $art_cqtokdveq$art_c; $art_ibuuumvipmk$art_i++) {    var t = themes[$art_ibuuumvipmk$art_i]%>';
    for (var $art_ibuuumvipmk$art_i = 0, $art_cqtokdveq$art_c = themes.length; $art_ibuuumvipmk$art_i < $art_cqtokdveq$art_c; $art_ibuuumvipmk$art_i++) {
        var t = themes[$art_ibuuumvipmk$art_i];
