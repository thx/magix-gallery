...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iprdbafe$art_i = 0, $art_cuzkwfkzeg$art_c = themes.length; $art_iprdbafe$art_i < $art_cuzkwfkzeg$art_c; $art_iprdbafe$art_i++) {    var t = themes[$art_iprdbafe$art_i]%>';
    for (var $art_iprdbafe$art_i = 0, $art_cuzkwfkzeg$art_c = themes.length; $art_iprdbafe$art_i < $art_cuzkwfkzeg$art_c; $art_iprdbafe$art_i++) {
        var t = themes[$art_iprdbafe$art_i];
