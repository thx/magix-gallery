...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwtwgozrwo$art_i = 0, $art_csdtqjldzf$art_c = themes.length; $art_iwtwgozrwo$art_i < $art_csdtqjldzf$art_c; $art_iwtwgozrwo$art_i++) {    var t = themes[$art_iwtwgozrwo$art_i]%>';
    for (var $art_iwtwgozrwo$art_i = 0, $art_csdtqjldzf$art_c = themes.length; $art_iwtwgozrwo$art_i < $art_csdtqjldzf$art_c; $art_iwtwgozrwo$art_i++) {
        var t = themes[$art_iwtwgozrwo$art_i];
