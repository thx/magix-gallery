...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inhdlvqg$art_i = 0, $art_cinupkh$art_c = themes.length; $art_inhdlvqg$art_i < $art_cinupkh$art_c; $art_inhdlvqg$art_i++) {    var t = themes[$art_inhdlvqg$art_i]%>';
    for (var $art_inhdlvqg$art_i = 0, $art_cinupkh$art_c = themes.length; $art_inhdlvqg$art_i < $art_cinupkh$art_c; $art_inhdlvqg$art_i++) {
        var t = themes[$art_inhdlvqg$art_i];
