...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivuevidyim$art_i = 0, $art_cnaxkuja$art_c = themes.length; $art_ivuevidyim$art_i < $art_cnaxkuja$art_c; $art_ivuevidyim$art_i++) {    var t = themes[$art_ivuevidyim$art_i]%>';
    for (var $art_ivuevidyim$art_i = 0, $art_cnaxkuja$art_c = themes.length; $art_ivuevidyim$art_i < $art_cnaxkuja$art_c; $art_ivuevidyim$art_i++) {
        var t = themes[$art_ivuevidyim$art_i];
