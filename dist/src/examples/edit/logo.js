...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iykrdyxntwo$art_i = 0, $art_celdcj$art_c = themes.length; $art_iykrdyxntwo$art_i < $art_celdcj$art_c; $art_iykrdyxntwo$art_i++) {    var t = themes[$art_iykrdyxntwo$art_i]%>';
    for (var $art_iykrdyxntwo$art_i = 0, $art_celdcj$art_c = themes.length; $art_iykrdyxntwo$art_i < $art_celdcj$art_c; $art_iykrdyxntwo$art_i++) {
        var t = themes[$art_iykrdyxntwo$art_i];
