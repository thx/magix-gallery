...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iybeanqg$art_i = 0, $art_cklzeae$art_c = themes.length; $art_iybeanqg$art_i < $art_cklzeae$art_c; $art_iybeanqg$art_i++) {    var t = themes[$art_iybeanqg$art_i]%>';
    for (var $art_iybeanqg$art_i = 0, $art_cklzeae$art_c = themes.length; $art_iybeanqg$art_i < $art_cklzeae$art_c; $art_iybeanqg$art_i++) {
        var t = themes[$art_iybeanqg$art_i];
