...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imrgxzkmi$art_i = 0, $art_cjinxvzss$art_c = themes.length; $art_imrgxzkmi$art_i < $art_cjinxvzss$art_c; $art_imrgxzkmi$art_i++) {    var t = themes[$art_imrgxzkmi$art_i]%>';
    for (var $art_imrgxzkmi$art_i = 0, $art_cjinxvzss$art_c = themes.length; $art_imrgxzkmi$art_i < $art_cjinxvzss$art_c; $art_imrgxzkmi$art_i++) {
        var t = themes[$art_imrgxzkmi$art_i];
