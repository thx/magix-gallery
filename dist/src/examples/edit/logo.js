...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikqqhnmcab$art_i = 0, $art_calxbcja$art_c = themes.length; $art_ikqqhnmcab$art_i < $art_calxbcja$art_c; $art_ikqqhnmcab$art_i++) {    var t = themes[$art_ikqqhnmcab$art_i]%>';
    for (var $art_ikqqhnmcab$art_i = 0, $art_calxbcja$art_c = themes.length; $art_ikqqhnmcab$art_i < $art_calxbcja$art_c; $art_ikqqhnmcab$art_i++) {
        var t = themes[$art_ikqqhnmcab$art_i];
