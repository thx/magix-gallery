...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imhwaaam$art_i = 0, $art_ckmchag$art_c = themes.length; $art_imhwaaam$art_i < $art_ckmchag$art_c; $art_imhwaaam$art_i++) {    var t = themes[$art_imhwaaam$art_i]%>';
    for (var $art_imhwaaam$art_i = 0, $art_ckmchag$art_c = themes.length; $art_imhwaaam$art_i < $art_ckmchag$art_c; $art_imhwaaam$art_i++) {
        var t = themes[$art_imhwaaam$art_i];
