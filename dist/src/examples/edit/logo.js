...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izcnxxn$art_i = 0, $art_cborgxu$art_c = themes.length; $art_izcnxxn$art_i < $art_cborgxu$art_c; $art_izcnxxn$art_i++) {    var t = themes[$art_izcnxxn$art_i]%>';
    for (var $art_izcnxxn$art_i = 0, $art_cborgxu$art_c = themes.length; $art_izcnxxn$art_i < $art_cborgxu$art_c; $art_izcnxxn$art_i++) {
        var t = themes[$art_izcnxxn$art_i];
