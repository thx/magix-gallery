...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itltpdhyq$art_i = 0, $art_cudfcanjmj$art_c = themes.length; $art_itltpdhyq$art_i < $art_cudfcanjmj$art_c; $art_itltpdhyq$art_i++) {    var t = themes[$art_itltpdhyq$art_i]%>';
    for (var $art_itltpdhyq$art_i = 0, $art_cudfcanjmj$art_c = themes.length; $art_itltpdhyq$art_i < $art_cudfcanjmj$art_c; $art_itltpdhyq$art_i++) {
        var t = themes[$art_itltpdhyq$art_i];
