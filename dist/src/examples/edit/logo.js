...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifrqmxqcjll$art_i = 0, $art_cagxthzszc$art_c = themes.length; $art_ifrqmxqcjll$art_i < $art_cagxthzszc$art_c; $art_ifrqmxqcjll$art_i++) {    var t = themes[$art_ifrqmxqcjll$art_i]%>';
    for (var $art_ifrqmxqcjll$art_i = 0, $art_cagxthzszc$art_c = themes.length; $art_ifrqmxqcjll$art_i < $art_cagxthzszc$art_c; $art_ifrqmxqcjll$art_i++) {
        var t = themes[$art_ifrqmxqcjll$art_i];
