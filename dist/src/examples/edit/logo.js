...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikqycmwpgh$art_i = 0, $art_cxmcwmsvqp$art_c = themes.length; $art_ikqycmwpgh$art_i < $art_cxmcwmsvqp$art_c; $art_ikqycmwpgh$art_i++) {    var t = themes[$art_ikqycmwpgh$art_i]%>';
    for (var $art_ikqycmwpgh$art_i = 0, $art_cxmcwmsvqp$art_c = themes.length; $art_ikqycmwpgh$art_i < $art_cxmcwmsvqp$art_c; $art_ikqycmwpgh$art_i++) {
        var t = themes[$art_ikqycmwpgh$art_i];
