...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqhbajua$art_i = 0, $art_cvoatjeerks$art_c = themes.length; $art_iqhbajua$art_i < $art_cvoatjeerks$art_c; $art_iqhbajua$art_i++) {    var t = themes[$art_iqhbajua$art_i]%>';
    for (var $art_iqhbajua$art_i = 0, $art_cvoatjeerks$art_c = themes.length; $art_iqhbajua$art_i < $art_cvoatjeerks$art_c; $art_iqhbajua$art_i++) {
        var t = themes[$art_iqhbajua$art_i];
