...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilhfze$art_i = 0, $art_cxhrjvdb$art_c = themes.length; $art_ilhfze$art_i < $art_cxhrjvdb$art_c; $art_ilhfze$art_i++) {    var t = themes[$art_ilhfze$art_i]%>';
    for (var $art_ilhfze$art_i = 0, $art_cxhrjvdb$art_c = themes.length; $art_ilhfze$art_i < $art_cxhrjvdb$art_c; $art_ilhfze$art_i++) {
        var t = themes[$art_ilhfze$art_i];
