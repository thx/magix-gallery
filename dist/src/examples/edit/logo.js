...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irvmqaqpg$art_i = 0, $art_cnytlxkbe$art_c = themes.length; $art_irvmqaqpg$art_i < $art_cnytlxkbe$art_c; $art_irvmqaqpg$art_i++) {    var t = themes[$art_irvmqaqpg$art_i]%>';
    for (var $art_irvmqaqpg$art_i = 0, $art_cnytlxkbe$art_c = themes.length; $art_irvmqaqpg$art_i < $art_cnytlxkbe$art_c; $art_irvmqaqpg$art_i++) {
        var t = themes[$art_irvmqaqpg$art_i];
