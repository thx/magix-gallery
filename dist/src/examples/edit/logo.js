...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwzlvletnd$art_i = 0, $art_cqbsojeodhf$art_c = themes.length; $art_iwzlvletnd$art_i < $art_cqbsojeodhf$art_c; $art_iwzlvletnd$art_i++) {    var t = themes[$art_iwzlvletnd$art_i]%>';
    for (var $art_iwzlvletnd$art_i = 0, $art_cqbsojeodhf$art_c = themes.length; $art_iwzlvletnd$art_i < $art_cqbsojeodhf$art_c; $art_iwzlvletnd$art_i++) {
        var t = themes[$art_iwzlvletnd$art_i];
