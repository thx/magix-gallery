...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itkduohvu$art_i = 0, $art_cmjgkhqzo$art_c = themes.length; $art_itkduohvu$art_i < $art_cmjgkhqzo$art_c; $art_itkduohvu$art_i++) {    var t = themes[$art_itkduohvu$art_i]%>';
    for (var $art_itkduohvu$art_i = 0, $art_cmjgkhqzo$art_c = themes.length; $art_itkduohvu$art_i < $art_cmjgkhqzo$art_c; $art_itkduohvu$art_i++) {
        var t = themes[$art_itkduohvu$art_i];
