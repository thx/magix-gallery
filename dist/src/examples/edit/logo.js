...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwuaosvc$art_i = 0, $art_ckbdmegq$art_c = themes.length; $art_iwuaosvc$art_i < $art_ckbdmegq$art_c; $art_iwuaosvc$art_i++) {    var t = themes[$art_iwuaosvc$art_i]%>';
    for (var $art_iwuaosvc$art_i = 0, $art_ckbdmegq$art_c = themes.length; $art_iwuaosvc$art_i < $art_ckbdmegq$art_c; $art_iwuaosvc$art_i++) {
        var t = themes[$art_iwuaosvc$art_i];
