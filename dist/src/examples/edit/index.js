...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cgnpjsirln$art_c = themes.length; i < $art_cgnpjsirln$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cgnpjsirln$art_c = themes.length; i < $art_cgnpjsirln$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ivpjtexnbh$art_i = 0, $art_cdcqqceb$art_c = list.length; $art_ivpjtexnbh$art_i < $art_cdcqqceb$art_c; $art_ivpjtexnbh$art_i++) {    var group = list[$art_ivpjtexnbh$art_i]%>';
    for (var $art_ivpjtexnbh$art_i = 0, $art_cdcqqceb$art_c = list.length; $art_ivpjtexnbh$art_i < $art_cdcqqceb$art_c; $art_ivpjtexnbh$art_i++) {
        var group = list[$art_ivpjtexnbh$art_i];
        ...
        ;
        $expr = '<%for (var $art_iegxnaps$art_i = 0, $art_objzvknxuew$art_obj = group.subs, $art_cphmlqqjhe$art_c = $art_objzvknxuew$art_obj.length; $art_iegxnaps$art_i < $art_cphmlqqjhe$art_c; $art_iegxnaps$art_i++) {        var item = $art_objzvknxuew$art_obj[$art_iegxnaps$art_i]%>';
        for (var $art_iegxnaps$art_i = 0, $art_objzvknxuew$art_obj = group.subs, $art_cphmlqqjhe$art_c = $art_objzvknxuew$art_obj.length; $art_iegxnaps$art_i < $art_cphmlqqjhe$art_c; $art_iegxnaps$art_i++) {
            var item = $art_objzvknxuew$art_obj[$art_iegxnaps$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ivpjtexnbh$art_i%>', $e($art_ivpjtexnbh$art_i)) + '_' + ($expr = '<%=$art_iegxnaps$art_i%>', $e($art_iegxnaps$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ivpjtexnbh$art_i%>', $e($art_ivpjtexnbh$art_i)) + '.subs.' + ($expr = '<%=$art_iegxnaps$art_i%>', $e($art_iegxnaps$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ivpjtexnbh$art_i%>', $e($art_ivpjtexnbh$art_i)) + '_' + ($expr = '<%=$art_iegxnaps$art_i%>', $e($art_iegxnaps$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ivpjtexnbh$art_i%>', $e($art_ivpjtexnbh$art_i)) + '.subs.' + ($expr = '<%=$art_iegxnaps$art_i%>', $e($art_iegxnaps$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
