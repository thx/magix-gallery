...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cknmixrwr$art_c = themes.length; i < $art_cknmixrwr$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cknmixrwr$art_c = themes.length; i < $art_cknmixrwr$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iedavnuvwfp$art_i = 0, $art_cehobworwlh$art_c = list.length; $art_iedavnuvwfp$art_i < $art_cehobworwlh$art_c; $art_iedavnuvwfp$art_i++) {    var group = list[$art_iedavnuvwfp$art_i]%>';
    for (var $art_iedavnuvwfp$art_i = 0, $art_cehobworwlh$art_c = list.length; $art_iedavnuvwfp$art_i < $art_cehobworwlh$art_c; $art_iedavnuvwfp$art_i++) {
        var group = list[$art_iedavnuvwfp$art_i];
        ...
        ;
        $expr = '<%for (var $art_indgdqrczi$art_i = 0, $art_objvmvvejd$art_obj = group.subs, $art_cyjjdpvw$art_c = $art_objvmvvejd$art_obj.length; $art_indgdqrczi$art_i < $art_cyjjdpvw$art_c; $art_indgdqrczi$art_i++) {        var item = $art_objvmvvejd$art_obj[$art_indgdqrczi$art_i]%>';
        for (var $art_indgdqrczi$art_i = 0, $art_objvmvvejd$art_obj = group.subs, $art_cyjjdpvw$art_c = $art_objvmvvejd$art_obj.length; $art_indgdqrczi$art_i < $art_cyjjdpvw$art_c; $art_indgdqrczi$art_i++) {
            var item = $art_objvmvvejd$art_obj[$art_indgdqrczi$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iedavnuvwfp$art_i%>', $e($art_iedavnuvwfp$art_i)) + '_' + ($expr = '<%=$art_indgdqrczi$art_i%>', $e($art_indgdqrczi$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iedavnuvwfp$art_i%>', $e($art_iedavnuvwfp$art_i)) + '.subs.' + ($expr = '<%=$art_indgdqrczi$art_i%>', $e($art_indgdqrczi$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iedavnuvwfp$art_i%>', $e($art_iedavnuvwfp$art_i)) + '_' + ($expr = '<%=$art_indgdqrczi$art_i%>', $e($art_indgdqrczi$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iedavnuvwfp$art_i%>', $e($art_iedavnuvwfp$art_i)) + '.subs.' + ($expr = '<%=$art_indgdqrczi$art_i%>', $e($art_indgdqrczi$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
