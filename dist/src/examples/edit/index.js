...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cakrqrrtxzj$art_c = themes.length; i < $art_cakrqrrtxzj$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cakrqrrtxzj$art_c = themes.length; i < $art_cakrqrrtxzj$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iduoskppes$art_i = 0, $art_cuoaqwynai$art_c = list.length; $art_iduoskppes$art_i < $art_cuoaqwynai$art_c; $art_iduoskppes$art_i++) {    var group = list[$art_iduoskppes$art_i]%>';
    for (var $art_iduoskppes$art_i = 0, $art_cuoaqwynai$art_c = list.length; $art_iduoskppes$art_i < $art_cuoaqwynai$art_c; $art_iduoskppes$art_i++) {
        var group = list[$art_iduoskppes$art_i];
        ...
        ;
        $expr = '<%for (var $art_ifpaenxxup$art_i = 0, $art_objxnlyiqlorpj$art_obj = group.subs, $art_clazkhkpy$art_c = $art_objxnlyiqlorpj$art_obj.length; $art_ifpaenxxup$art_i < $art_clazkhkpy$art_c; $art_ifpaenxxup$art_i++) {        var item = $art_objxnlyiqlorpj$art_obj[$art_ifpaenxxup$art_i]%>';
        for (var $art_ifpaenxxup$art_i = 0, $art_objxnlyiqlorpj$art_obj = group.subs, $art_clazkhkpy$art_c = $art_objxnlyiqlorpj$art_obj.length; $art_ifpaenxxup$art_i < $art_clazkhkpy$art_c; $art_ifpaenxxup$art_i++) {
            var item = $art_objxnlyiqlorpj$art_obj[$art_ifpaenxxup$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iduoskppes$art_i%>', $e($art_iduoskppes$art_i)) + '_' + ($expr = '<%=$art_ifpaenxxup$art_i%>', $e($art_ifpaenxxup$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iduoskppes$art_i%>', $e($art_iduoskppes$art_i)) + '.subs.' + ($expr = '<%=$art_ifpaenxxup$art_i%>', $e($art_ifpaenxxup$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iduoskppes$art_i%>', $e($art_iduoskppes$art_i)) + '_' + ($expr = '<%=$art_ifpaenxxup$art_i%>', $e($art_ifpaenxxup$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iduoskppes$art_i%>', $e($art_iduoskppes$art_i)) + '.subs.' + ($expr = '<%=$art_ifpaenxxup$art_i%>', $e($art_ifpaenxxup$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
