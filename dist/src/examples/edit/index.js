...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cvtcxejdtvxf$art_c = themes.length; i < $art_cvtcxejdtvxf$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cvtcxejdtvxf$art_c = themes.length; i < $art_cvtcxejdtvxf$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iepwaaxdki$art_i = 0, $art_claqzjay$art_c = list.length; $art_iepwaaxdki$art_i < $art_claqzjay$art_c; $art_iepwaaxdki$art_i++) {    var group = list[$art_iepwaaxdki$art_i]%>';
    for (var $art_iepwaaxdki$art_i = 0, $art_claqzjay$art_c = list.length; $art_iepwaaxdki$art_i < $art_claqzjay$art_c; $art_iepwaaxdki$art_i++) {
        var group = list[$art_iepwaaxdki$art_i];
        ...
        ;
        $expr = '<%for (var $art_idxpnj$art_i = 0, $art_objibynnfir$art_obj = group.subs, $art_ckdzlddaxma$art_c = $art_objibynnfir$art_obj.length; $art_idxpnj$art_i < $art_ckdzlddaxma$art_c; $art_idxpnj$art_i++) {        var item = $art_objibynnfir$art_obj[$art_idxpnj$art_i]%>';
        for (var $art_idxpnj$art_i = 0, $art_objibynnfir$art_obj = group.subs, $art_ckdzlddaxma$art_c = $art_objibynnfir$art_obj.length; $art_idxpnj$art_i < $art_ckdzlddaxma$art_c; $art_idxpnj$art_i++) {
            var item = $art_objibynnfir$art_obj[$art_idxpnj$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iepwaaxdki$art_i%>', $e($art_iepwaaxdki$art_i)) + '_' + ($expr = '<%=$art_idxpnj$art_i%>', $e($art_idxpnj$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iepwaaxdki$art_i%>', $e($art_iepwaaxdki$art_i)) + '.subs.' + ($expr = '<%=$art_idxpnj$art_i%>', $e($art_idxpnj$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iepwaaxdki$art_i%>', $e($art_iepwaaxdki$art_i)) + '_' + ($expr = '<%=$art_idxpnj$art_i%>', $e($art_idxpnj$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iepwaaxdki$art_i%>', $e($art_iepwaaxdki$art_i)) + '.subs.' + ($expr = '<%=$art_idxpnj$art_i%>', $e($art_idxpnj$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
