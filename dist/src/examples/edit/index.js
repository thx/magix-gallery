...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cmaayqeh$art_c = themes.length; i < $art_cmaayqeh$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cmaayqeh$art_c = themes.length; i < $art_cmaayqeh$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iixkcemgcz$art_i = 0, $art_civmyime$art_c = list.length; $art_iixkcemgcz$art_i < $art_civmyime$art_c; $art_iixkcemgcz$art_i++) {    var group = list[$art_iixkcemgcz$art_i]%>';
    for (var $art_iixkcemgcz$art_i = 0, $art_civmyime$art_c = list.length; $art_iixkcemgcz$art_i < $art_civmyime$art_c; $art_iixkcemgcz$art_i++) {
        var group = list[$art_iixkcemgcz$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixsju$art_i = 0, $art_objfzawg$art_obj = group.subs, $art_cekzoihfhd$art_c = $art_objfzawg$art_obj.length; $art_ixsju$art_i < $art_cekzoihfhd$art_c; $art_ixsju$art_i++) {        var item = $art_objfzawg$art_obj[$art_ixsju$art_i]%>';
        for (var $art_ixsju$art_i = 0, $art_objfzawg$art_obj = group.subs, $art_cekzoihfhd$art_c = $art_objfzawg$art_obj.length; $art_ixsju$art_i < $art_cekzoihfhd$art_c; $art_ixsju$art_i++) {
            var item = $art_objfzawg$art_obj[$art_ixsju$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iixkcemgcz$art_i%>', $e($art_iixkcemgcz$art_i)) + '_' + ($expr = '<%=$art_ixsju$art_i%>', $e($art_ixsju$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iixkcemgcz$art_i%>', $e($art_iixkcemgcz$art_i)) + '.subs.' + ($expr = '<%=$art_ixsju$art_i%>', $e($art_ixsju$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iixkcemgcz$art_i%>', $e($art_iixkcemgcz$art_i)) + '_' + ($expr = '<%=$art_ixsju$art_i%>', $e($art_ixsju$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iixkcemgcz$art_i%>', $e($art_iixkcemgcz$art_i)) + '.subs.' + ($expr = '<%=$art_ixsju$art_i%>', $e($art_ixsju$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
