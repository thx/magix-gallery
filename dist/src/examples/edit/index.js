...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cgcyywq$art_c = themes.length; i < $art_cgcyywq$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cgcyywq$art_c = themes.length; i < $art_cgcyywq$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ixlsdxysne$art_i = 0, $art_cjlegbrpdi$art_c = list.length; $art_ixlsdxysne$art_i < $art_cjlegbrpdi$art_c; $art_ixlsdxysne$art_i++) {    var group = list[$art_ixlsdxysne$art_i]%>';
    for (var $art_ixlsdxysne$art_i = 0, $art_cjlegbrpdi$art_c = list.length; $art_ixlsdxysne$art_i < $art_cjlegbrpdi$art_c; $art_ixlsdxysne$art_i++) {
        var group = list[$art_ixlsdxysne$art_i];
        ...
        ;
        $expr = '<%for (var $art_imqurmibxcm$art_i = 0, $art_objdpycpkgglfl$art_obj = group.subs, $art_cxricohor$art_c = $art_objdpycpkgglfl$art_obj.length; $art_imqurmibxcm$art_i < $art_cxricohor$art_c; $art_imqurmibxcm$art_i++) {        var item = $art_objdpycpkgglfl$art_obj[$art_imqurmibxcm$art_i]%>';
        for (var $art_imqurmibxcm$art_i = 0, $art_objdpycpkgglfl$art_obj = group.subs, $art_cxricohor$art_c = $art_objdpycpkgglfl$art_obj.length; $art_imqurmibxcm$art_i < $art_cxricohor$art_c; $art_imqurmibxcm$art_i++) {
            var item = $art_objdpycpkgglfl$art_obj[$art_imqurmibxcm$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ixlsdxysne$art_i%>', $e($art_ixlsdxysne$art_i)) + '_' + ($expr = '<%=$art_imqurmibxcm$art_i%>', $e($art_imqurmibxcm$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ixlsdxysne$art_i%>', $e($art_ixlsdxysne$art_i)) + '.subs.' + ($expr = '<%=$art_imqurmibxcm$art_i%>', $e($art_imqurmibxcm$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ixlsdxysne$art_i%>', $e($art_ixlsdxysne$art_i)) + '_' + ($expr = '<%=$art_imqurmibxcm$art_i%>', $e($art_imqurmibxcm$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ixlsdxysne$art_i%>', $e($art_ixlsdxysne$art_i)) + '.subs.' + ($expr = '<%=$art_imqurmibxcm$art_i%>', $e($art_imqurmibxcm$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
