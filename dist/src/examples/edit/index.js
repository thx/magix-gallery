...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cfyqdllk$art_c = themes.length; i < $art_cfyqdllk$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cfyqdllk$art_c = themes.length; i < $art_cfyqdllk$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ixdwxfmfqu$art_i = 0, $art_ctsulmdkc$art_c = list.length; $art_ixdwxfmfqu$art_i < $art_ctsulmdkc$art_c; $art_ixdwxfmfqu$art_i++) {    var group = list[$art_ixdwxfmfqu$art_i]%>';
    for (var $art_ixdwxfmfqu$art_i = 0, $art_ctsulmdkc$art_c = list.length; $art_ixdwxfmfqu$art_i < $art_ctsulmdkc$art_c; $art_ixdwxfmfqu$art_i++) {
        var group = list[$art_ixdwxfmfqu$art_i];
        ...
        ;
        $expr = '<%for (var $art_ianylrkiml$art_i = 0, $art_objzxnmpw$art_obj = group.subs, $art_cxeprxe$art_c = $art_objzxnmpw$art_obj.length; $art_ianylrkiml$art_i < $art_cxeprxe$art_c; $art_ianylrkiml$art_i++) {        var item = $art_objzxnmpw$art_obj[$art_ianylrkiml$art_i]%>';
        for (var $art_ianylrkiml$art_i = 0, $art_objzxnmpw$art_obj = group.subs, $art_cxeprxe$art_c = $art_objzxnmpw$art_obj.length; $art_ianylrkiml$art_i < $art_cxeprxe$art_c; $art_ianylrkiml$art_i++) {
            var item = $art_objzxnmpw$art_obj[$art_ianylrkiml$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ixdwxfmfqu$art_i%>', $e($art_ixdwxfmfqu$art_i)) + '_' + ($expr = '<%=$art_ianylrkiml$art_i%>', $e($art_ianylrkiml$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ixdwxfmfqu$art_i%>', $e($art_ixdwxfmfqu$art_i)) + '.subs.' + ($expr = '<%=$art_ianylrkiml$art_i%>', $e($art_ianylrkiml$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ixdwxfmfqu$art_i%>', $e($art_ixdwxfmfqu$art_i)) + '_' + ($expr = '<%=$art_ianylrkiml$art_i%>', $e($art_ianylrkiml$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ixdwxfmfqu$art_i%>', $e($art_ixdwxfmfqu$art_i)) + '.subs.' + ($expr = '<%=$art_ianylrkiml$art_i%>', $e($art_ianylrkiml$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
