...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_chldyyd$art_c = themes.length; i < $art_chldyyd$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_chldyyd$art_c = themes.length; i < $art_chldyyd$art_c; i++) {
        var t = themes[i];
        $p += '<div mxa="_zs_galleryf:a" class="_zs_gallery_examples_edit_theme_-theme"><div><a href="javascript:;" class="_zs_gallery_examples_edit_theme_-dot" style="';
        $line = 21;
        $art = '=t.styles';
        ;
    ...
    ;
    $p += '<div mxa="_zs_galleryf:c" class="_zs_gallery_examples_edit_theme_-theme"><div mx-change="' + $viewId + 'changeColor()" mx-view="mx-color/picker?dot=true&color=';
    $line = 30;
    $art = '=custom';
    ;
    $p += ($expr = '<%!$eu(custom)%>', $eu(custom)) + '"></div><div mxs="_zs_galleryf:a" class="text-center mt10">自定义</div></div><a mxs="_zs_galleryf:b" href="javascript:;" class="fl ml20 btn btn-brand" mx-click="' + $viewId + 'copy()">复制我的定制主题</a></div><div mxv mxa="_zs_galleryf:d" class="_zs_gallery_examples_edit_theme_-edit"><div class="_zs_gallery_examples_edit_theme_-nav" style="left:';
    $line = 39;
    $art = '=(itemWidth*cur)';
    ;
    $p += ($expr = '<%=(itemWidth * cur)%>', $e((itemWidth * cur))) + 'px;"><span mxs="_zs_galleryf:c" class="_zs_gallery_examples_edit_theme_-arrow"></span><span mxs="_zs_galleryf:d" class="_zs_gallery_examples_edit_theme_-white-arrow"></span></div><div mxv mxa="_zs_galleryf:e" class="_zs_gallery_examples_edit_theme_-colors">';
    $line = 44;
    $art = 'each list as group';
    ;
    $expr = '<%for (var $art_ikkvvgetyhpc$art_i = 0, $art_czrxzhjizpd$art_c = list.length; $art_ikkvvgetyhpc$art_i < $art_czrxzhjizpd$art_c; $art_ikkvvgetyhpc$art_i++) {    var group = list[$art_ikkvvgetyhpc$art_i]%>';
    for (var $art_ikkvvgetyhpc$art_i = 0, $art_czrxzhjizpd$art_c = list.length; $art_ikkvvgetyhpc$art_i < $art_czrxzhjizpd$art_c; $art_ikkvvgetyhpc$art_i++) {
        var group = list[$art_ikkvvgetyhpc$art_i];
        ...
        ;
        $expr = '<%for (var $art_ifmmsoli$art_i = 0, $art_objyguzwrl$art_obj = group.subs, $art_cbqewhurzp$art_c = $art_objyguzwrl$art_obj.length; $art_ifmmsoli$art_i < $art_cbqewhurzp$art_c; $art_ifmmsoli$art_i++) {        var item = $art_objyguzwrl$art_obj[$art_ifmmsoli$art_i]%>';
        for (var $art_ifmmsoli$art_i = 0, $art_objyguzwrl$art_obj = group.subs, $art_cbqewhurzp$art_c = $art_objyguzwrl$art_obj.length; $art_ifmmsoli$art_i < $art_cbqewhurzp$art_c; $art_ifmmsoli$art_i++) {
            var item = $art_objyguzwrl$art_obj[$art_ifmmsoli$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ikkvvgetyhpc$art_i%>', $e($art_ikkvvgetyhpc$art_i)) + '_' + ($expr = '<%=$art_ifmmsoli$art_i%>', $e($art_ifmmsoli$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ikkvvgetyhpc$art_i%>', $e($art_ikkvvgetyhpc$art_i)) + '.subs.' + ($expr = '<%=$art_ifmmsoli$art_i%>', $e($art_ifmmsoli$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ikkvvgetyhpc$art_i%>', $e($art_ikkvvgetyhpc$art_i)) + '_' + ($expr = '<%=$art_ifmmsoli$art_i%>', $e($art_ifmmsoli$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ikkvvgetyhpc$art_i%>', $e($art_ikkvvgetyhpc$art_i)) + '.subs.' + ($expr = '<%=$art_ifmmsoli$art_i%>', $e($art_ifmmsoli$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
