...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cszadpu$art_c = themes.length; i < $art_cszadpu$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cszadpu$art_c = themes.length; i < $art_cszadpu$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iudkcblr$art_i = 0, $art_cspxxykdq$art_c = list.length; $art_iudkcblr$art_i < $art_cspxxykdq$art_c; $art_iudkcblr$art_i++) {    var group = list[$art_iudkcblr$art_i]%>';
    for (var $art_iudkcblr$art_i = 0, $art_cspxxykdq$art_c = list.length; $art_iudkcblr$art_i < $art_cspxxykdq$art_c; $art_iudkcblr$art_i++) {
        var group = list[$art_iudkcblr$art_i];
        ...
        ;
        $expr = '<%for (var $art_iasjvpsju$art_i = 0, $art_objlvzetxpy$art_obj = group.subs, $art_cyniocfdlu$art_c = $art_objlvzetxpy$art_obj.length; $art_iasjvpsju$art_i < $art_cyniocfdlu$art_c; $art_iasjvpsju$art_i++) {        var item = $art_objlvzetxpy$art_obj[$art_iasjvpsju$art_i]%>';
        for (var $art_iasjvpsju$art_i = 0, $art_objlvzetxpy$art_obj = group.subs, $art_cyniocfdlu$art_c = $art_objlvzetxpy$art_obj.length; $art_iasjvpsju$art_i < $art_cyniocfdlu$art_c; $art_iasjvpsju$art_i++) {
            var item = $art_objlvzetxpy$art_obj[$art_iasjvpsju$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iudkcblr$art_i%>', $e($art_iudkcblr$art_i)) + '_' + ($expr = '<%=$art_iasjvpsju$art_i%>', $e($art_iasjvpsju$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iudkcblr$art_i%>', $e($art_iudkcblr$art_i)) + '.subs.' + ($expr = '<%=$art_iasjvpsju$art_i%>', $e($art_iasjvpsju$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iudkcblr$art_i%>', $e($art_iudkcblr$art_i)) + '_' + ($expr = '<%=$art_iasjvpsju$art_i%>', $e($art_iasjvpsju$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iudkcblr$art_i%>', $e($art_iudkcblr$art_i)) + '.subs.' + ($expr = '<%=$art_iasjvpsju$art_i%>', $e($art_iasjvpsju$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
