...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_coeevbsbkc$art_c = themes.length; i < $art_coeevbsbkc$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_coeevbsbkc$art_c = themes.length; i < $art_coeevbsbkc$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ictqyqxhrv$art_i = 0, $art_cnplowvmxi$art_c = list.length; $art_ictqyqxhrv$art_i < $art_cnplowvmxi$art_c; $art_ictqyqxhrv$art_i++) {    var group = list[$art_ictqyqxhrv$art_i]%>';
    for (var $art_ictqyqxhrv$art_i = 0, $art_cnplowvmxi$art_c = list.length; $art_ictqyqxhrv$art_i < $art_cnplowvmxi$art_c; $art_ictqyqxhrv$art_i++) {
        var group = list[$art_ictqyqxhrv$art_i];
        ...
        ;
        $expr = '<%for (var $art_isnxjhx$art_i = 0, $art_objplfklsrps$art_obj = group.subs, $art_cpmyleuiyn$art_c = $art_objplfklsrps$art_obj.length; $art_isnxjhx$art_i < $art_cpmyleuiyn$art_c; $art_isnxjhx$art_i++) {        var item = $art_objplfklsrps$art_obj[$art_isnxjhx$art_i]%>';
        for (var $art_isnxjhx$art_i = 0, $art_objplfklsrps$art_obj = group.subs, $art_cpmyleuiyn$art_c = $art_objplfklsrps$art_obj.length; $art_isnxjhx$art_i < $art_cpmyleuiyn$art_c; $art_isnxjhx$art_i++) {
            var item = $art_objplfklsrps$art_obj[$art_isnxjhx$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ictqyqxhrv$art_i%>', $e($art_ictqyqxhrv$art_i)) + '_' + ($expr = '<%=$art_isnxjhx$art_i%>', $e($art_isnxjhx$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ictqyqxhrv$art_i%>', $e($art_ictqyqxhrv$art_i)) + '.subs.' + ($expr = '<%=$art_isnxjhx$art_i%>', $e($art_isnxjhx$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ictqyqxhrv$art_i%>', $e($art_ictqyqxhrv$art_i)) + '_' + ($expr = '<%=$art_isnxjhx$art_i%>', $e($art_isnxjhx$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ictqyqxhrv$art_i%>', $e($art_ictqyqxhrv$art_i)) + '.subs.' + ($expr = '<%=$art_isnxjhx$art_i%>', $e($art_isnxjhx$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
