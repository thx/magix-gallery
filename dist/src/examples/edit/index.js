...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cfmhtlqbwm$art_c = themes.length; i < $art_cfmhtlqbwm$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cfmhtlqbwm$art_c = themes.length; i < $art_cfmhtlqbwm$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_inwwllu$art_i = 0, $art_cgghomncei$art_c = list.length; $art_inwwllu$art_i < $art_cgghomncei$art_c; $art_inwwllu$art_i++) {    var group = list[$art_inwwllu$art_i]%>';
    for (var $art_inwwllu$art_i = 0, $art_cgghomncei$art_c = list.length; $art_inwwllu$art_i < $art_cgghomncei$art_c; $art_inwwllu$art_i++) {
        var group = list[$art_inwwllu$art_i];
        ...
        ;
        $expr = '<%for (var $art_iqytswevrt$art_i = 0, $art_objhpqipyjjf$art_obj = group.subs, $art_cuyswqb$art_c = $art_objhpqipyjjf$art_obj.length; $art_iqytswevrt$art_i < $art_cuyswqb$art_c; $art_iqytswevrt$art_i++) {        var item = $art_objhpqipyjjf$art_obj[$art_iqytswevrt$art_i]%>';
        for (var $art_iqytswevrt$art_i = 0, $art_objhpqipyjjf$art_obj = group.subs, $art_cuyswqb$art_c = $art_objhpqipyjjf$art_obj.length; $art_iqytswevrt$art_i < $art_cuyswqb$art_c; $art_iqytswevrt$art_i++) {
            var item = $art_objhpqipyjjf$art_obj[$art_iqytswevrt$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_inwwllu$art_i%>', $e($art_inwwllu$art_i)) + '_' + ($expr = '<%=$art_iqytswevrt$art_i%>', $e($art_iqytswevrt$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_inwwllu$art_i%>', $e($art_inwwllu$art_i)) + '.subs.' + ($expr = '<%=$art_iqytswevrt$art_i%>', $e($art_iqytswevrt$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_inwwllu$art_i%>', $e($art_inwwllu$art_i)) + '_' + ($expr = '<%=$art_iqytswevrt$art_i%>', $e($art_iqytswevrt$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_inwwllu$art_i%>', $e($art_inwwllu$art_i)) + '.subs.' + ($expr = '<%=$art_iqytswevrt$art_i%>', $e($art_iqytswevrt$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
