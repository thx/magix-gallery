...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cgutdjazpf$art_c = themes.length; i < $art_cgutdjazpf$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cgutdjazpf$art_c = themes.length; i < $art_cgutdjazpf$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ijarpytpub$art_i = 0, $art_csaakmio$art_c = list.length; $art_ijarpytpub$art_i < $art_csaakmio$art_c; $art_ijarpytpub$art_i++) {    var group = list[$art_ijarpytpub$art_i]%>';
    for (var $art_ijarpytpub$art_i = 0, $art_csaakmio$art_c = list.length; $art_ijarpytpub$art_i < $art_csaakmio$art_c; $art_ijarpytpub$art_i++) {
        var group = list[$art_ijarpytpub$art_i];
        ...
        ;
        $expr = '<%for (var $art_ihbolrplq$art_i = 0, $art_objblbltux$art_obj = group.subs, $art_cpkepeylmh$art_c = $art_objblbltux$art_obj.length; $art_ihbolrplq$art_i < $art_cpkepeylmh$art_c; $art_ihbolrplq$art_i++) {        var item = $art_objblbltux$art_obj[$art_ihbolrplq$art_i]%>';
        for (var $art_ihbolrplq$art_i = 0, $art_objblbltux$art_obj = group.subs, $art_cpkepeylmh$art_c = $art_objblbltux$art_obj.length; $art_ihbolrplq$art_i < $art_cpkepeylmh$art_c; $art_ihbolrplq$art_i++) {
            var item = $art_objblbltux$art_obj[$art_ihbolrplq$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ijarpytpub$art_i%>', $e($art_ijarpytpub$art_i)) + '_' + ($expr = '<%=$art_ihbolrplq$art_i%>', $e($art_ihbolrplq$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ijarpytpub$art_i%>', $e($art_ijarpytpub$art_i)) + '.subs.' + ($expr = '<%=$art_ihbolrplq$art_i%>', $e($art_ihbolrplq$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ijarpytpub$art_i%>', $e($art_ijarpytpub$art_i)) + '_' + ($expr = '<%=$art_ihbolrplq$art_i%>', $e($art_ihbolrplq$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ijarpytpub$art_i%>', $e($art_ijarpytpub$art_i)) + '.subs.' + ($expr = '<%=$art_ihbolrplq$art_i%>', $e($art_ihbolrplq$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
