...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cbwkvjklg$art_c = themes.length; i < $art_cbwkvjklg$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cbwkvjklg$art_c = themes.length; i < $art_cbwkvjklg$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ijhkvftmxl$art_i = 0, $art_cwojritibg$art_c = list.length; $art_ijhkvftmxl$art_i < $art_cwojritibg$art_c; $art_ijhkvftmxl$art_i++) {    var group = list[$art_ijhkvftmxl$art_i]%>';
    for (var $art_ijhkvftmxl$art_i = 0, $art_cwojritibg$art_c = list.length; $art_ijhkvftmxl$art_i < $art_cwojritibg$art_c; $art_ijhkvftmxl$art_i++) {
        var group = list[$art_ijhkvftmxl$art_i];
        ...
        ;
        $expr = '<%for (var $art_iukdohfd$art_i = 0, $art_objigriqoxrgo$art_obj = group.subs, $art_csoqacv$art_c = $art_objigriqoxrgo$art_obj.length; $art_iukdohfd$art_i < $art_csoqacv$art_c; $art_iukdohfd$art_i++) {        var item = $art_objigriqoxrgo$art_obj[$art_iukdohfd$art_i]%>';
        for (var $art_iukdohfd$art_i = 0, $art_objigriqoxrgo$art_obj = group.subs, $art_csoqacv$art_c = $art_objigriqoxrgo$art_obj.length; $art_iukdohfd$art_i < $art_csoqacv$art_c; $art_iukdohfd$art_i++) {
            var item = $art_objigriqoxrgo$art_obj[$art_iukdohfd$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ijhkvftmxl$art_i%>', $e($art_ijhkvftmxl$art_i)) + '_' + ($expr = '<%=$art_iukdohfd$art_i%>', $e($art_iukdohfd$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ijhkvftmxl$art_i%>', $e($art_ijhkvftmxl$art_i)) + '.subs.' + ($expr = '<%=$art_iukdohfd$art_i%>', $e($art_iukdohfd$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ijhkvftmxl$art_i%>', $e($art_ijhkvftmxl$art_i)) + '_' + ($expr = '<%=$art_iukdohfd$art_i%>', $e($art_iukdohfd$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ijhkvftmxl$art_i%>', $e($art_ijhkvftmxl$art_i)) + '.subs.' + ($expr = '<%=$art_iukdohfd$art_i%>', $e($art_iukdohfd$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
