...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_ctzlnqeopss$art_c = themes.length; i < $art_ctzlnqeopss$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_ctzlnqeopss$art_c = themes.length; i < $art_ctzlnqeopss$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ikvsafxu$art_i = 0, $art_cktgzwejo$art_c = list.length; $art_ikvsafxu$art_i < $art_cktgzwejo$art_c; $art_ikvsafxu$art_i++) {    var group = list[$art_ikvsafxu$art_i]%>';
    for (var $art_ikvsafxu$art_i = 0, $art_cktgzwejo$art_c = list.length; $art_ikvsafxu$art_i < $art_cktgzwejo$art_c; $art_ikvsafxu$art_i++) {
        var group = list[$art_ikvsafxu$art_i];
        ...
        ;
        $expr = '<%for (var $art_isxgdwnvsn$art_i = 0, $art_objwqrjgdl$art_obj = group.subs, $art_cdbtdco$art_c = $art_objwqrjgdl$art_obj.length; $art_isxgdwnvsn$art_i < $art_cdbtdco$art_c; $art_isxgdwnvsn$art_i++) {        var item = $art_objwqrjgdl$art_obj[$art_isxgdwnvsn$art_i]%>';
        for (var $art_isxgdwnvsn$art_i = 0, $art_objwqrjgdl$art_obj = group.subs, $art_cdbtdco$art_c = $art_objwqrjgdl$art_obj.length; $art_isxgdwnvsn$art_i < $art_cdbtdco$art_c; $art_isxgdwnvsn$art_i++) {
            var item = $art_objwqrjgdl$art_obj[$art_isxgdwnvsn$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ikvsafxu$art_i%>', $e($art_ikvsafxu$art_i)) + '_' + ($expr = '<%=$art_isxgdwnvsn$art_i%>', $e($art_isxgdwnvsn$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ikvsafxu$art_i%>', $e($art_ikvsafxu$art_i)) + '.subs.' + ($expr = '<%=$art_isxgdwnvsn$art_i%>', $e($art_isxgdwnvsn$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ikvsafxu$art_i%>', $e($art_ikvsafxu$art_i)) + '_' + ($expr = '<%=$art_isxgdwnvsn$art_i%>', $e($art_isxgdwnvsn$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ikvsafxu$art_i%>', $e($art_ikvsafxu$art_i)) + '.subs.' + ($expr = '<%=$art_isxgdwnvsn$art_i%>', $e($art_isxgdwnvsn$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
