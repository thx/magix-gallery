...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_crhgbwiph$art_c = themes.length; i < $art_crhgbwiph$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_crhgbwiph$art_c = themes.length; i < $art_crhgbwiph$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ioatntrs$art_i = 0, $art_cifkbddc$art_c = list.length; $art_ioatntrs$art_i < $art_cifkbddc$art_c; $art_ioatntrs$art_i++) {    var group = list[$art_ioatntrs$art_i]%>';
    for (var $art_ioatntrs$art_i = 0, $art_cifkbddc$art_c = list.length; $art_ioatntrs$art_i < $art_cifkbddc$art_c; $art_ioatntrs$art_i++) {
        var group = list[$art_ioatntrs$art_i];
        ...
        ;
        $expr = '<%for (var $art_izgnajycq$art_i = 0, $art_objykqkpnltl$art_obj = group.subs, $art_cynbuug$art_c = $art_objykqkpnltl$art_obj.length; $art_izgnajycq$art_i < $art_cynbuug$art_c; $art_izgnajycq$art_i++) {        var item = $art_objykqkpnltl$art_obj[$art_izgnajycq$art_i]%>';
        for (var $art_izgnajycq$art_i = 0, $art_objykqkpnltl$art_obj = group.subs, $art_cynbuug$art_c = $art_objykqkpnltl$art_obj.length; $art_izgnajycq$art_i < $art_cynbuug$art_c; $art_izgnajycq$art_i++) {
            var item = $art_objykqkpnltl$art_obj[$art_izgnajycq$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ioatntrs$art_i%>', $e($art_ioatntrs$art_i)) + '_' + ($expr = '<%=$art_izgnajycq$art_i%>', $e($art_izgnajycq$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ioatntrs$art_i%>', $e($art_ioatntrs$art_i)) + '.subs.' + ($expr = '<%=$art_izgnajycq$art_i%>', $e($art_izgnajycq$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ioatntrs$art_i%>', $e($art_ioatntrs$art_i)) + '_' + ($expr = '<%=$art_izgnajycq$art_i%>', $e($art_izgnajycq$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ioatntrs$art_i%>', $e($art_ioatntrs$art_i)) + '.subs.' + ($expr = '<%=$art_izgnajycq$art_i%>', $e($art_izgnajycq$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
