...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_ctktdsqt$art_c = themes.length; i < $art_ctktdsqt$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_ctktdsqt$art_c = themes.length; i < $art_ctktdsqt$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ixhftqcsjrj$art_i = 0, $art_cywtqnpcm$art_c = list.length; $art_ixhftqcsjrj$art_i < $art_cywtqnpcm$art_c; $art_ixhftqcsjrj$art_i++) {    var group = list[$art_ixhftqcsjrj$art_i]%>';
    for (var $art_ixhftqcsjrj$art_i = 0, $art_cywtqnpcm$art_c = list.length; $art_ixhftqcsjrj$art_i < $art_cywtqnpcm$art_c; $art_ixhftqcsjrj$art_i++) {
        var group = list[$art_ixhftqcsjrj$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijbwykpvr$art_i = 0, $art_objuypqsfqz$art_obj = group.subs, $art_ckjvhrxa$art_c = $art_objuypqsfqz$art_obj.length; $art_ijbwykpvr$art_i < $art_ckjvhrxa$art_c; $art_ijbwykpvr$art_i++) {        var item = $art_objuypqsfqz$art_obj[$art_ijbwykpvr$art_i]%>';
        for (var $art_ijbwykpvr$art_i = 0, $art_objuypqsfqz$art_obj = group.subs, $art_ckjvhrxa$art_c = $art_objuypqsfqz$art_obj.length; $art_ijbwykpvr$art_i < $art_ckjvhrxa$art_c; $art_ijbwykpvr$art_i++) {
            var item = $art_objuypqsfqz$art_obj[$art_ijbwykpvr$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ixhftqcsjrj$art_i%>', $e($art_ixhftqcsjrj$art_i)) + '_' + ($expr = '<%=$art_ijbwykpvr$art_i%>', $e($art_ijbwykpvr$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ixhftqcsjrj$art_i%>', $e($art_ixhftqcsjrj$art_i)) + '.subs.' + ($expr = '<%=$art_ijbwykpvr$art_i%>', $e($art_ijbwykpvr$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ixhftqcsjrj$art_i%>', $e($art_ixhftqcsjrj$art_i)) + '_' + ($expr = '<%=$art_ijbwykpvr$art_i%>', $e($art_ijbwykpvr$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ixhftqcsjrj$art_i%>', $e($art_ixhftqcsjrj$art_i)) + '.subs.' + ($expr = '<%=$art_ijbwykpvr$art_i%>', $e($art_ijbwykpvr$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
