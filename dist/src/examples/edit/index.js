...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_czwghthxzq$art_c = themes.length; i < $art_czwghthxzq$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_czwghthxzq$art_c = themes.length; i < $art_czwghthxzq$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_isdoaxwhxh$art_i = 0, $art_cfebghvihej$art_c = list.length; $art_isdoaxwhxh$art_i < $art_cfebghvihej$art_c; $art_isdoaxwhxh$art_i++) {    var group = list[$art_isdoaxwhxh$art_i]%>';
    for (var $art_isdoaxwhxh$art_i = 0, $art_cfebghvihej$art_c = list.length; $art_isdoaxwhxh$art_i < $art_cfebghvihej$art_c; $art_isdoaxwhxh$art_i++) {
        var group = list[$art_isdoaxwhxh$art_i];
        ...
        ;
        $expr = '<%for (var $art_idxdxuuc$art_i = 0, $art_objimjpinkd$art_obj = group.subs, $art_clvrjtnhlq$art_c = $art_objimjpinkd$art_obj.length; $art_idxdxuuc$art_i < $art_clvrjtnhlq$art_c; $art_idxdxuuc$art_i++) {        var item = $art_objimjpinkd$art_obj[$art_idxdxuuc$art_i]%>';
        for (var $art_idxdxuuc$art_i = 0, $art_objimjpinkd$art_obj = group.subs, $art_clvrjtnhlq$art_c = $art_objimjpinkd$art_obj.length; $art_idxdxuuc$art_i < $art_clvrjtnhlq$art_c; $art_idxdxuuc$art_i++) {
            var item = $art_objimjpinkd$art_obj[$art_idxdxuuc$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_isdoaxwhxh$art_i%>', $e($art_isdoaxwhxh$art_i)) + '_' + ($expr = '<%=$art_idxdxuuc$art_i%>', $e($art_idxdxuuc$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_isdoaxwhxh$art_i%>', $e($art_isdoaxwhxh$art_i)) + '.subs.' + ($expr = '<%=$art_idxdxuuc$art_i%>', $e($art_idxdxuuc$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_isdoaxwhxh$art_i%>', $e($art_isdoaxwhxh$art_i)) + '_' + ($expr = '<%=$art_idxdxuuc$art_i%>', $e($art_idxdxuuc$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_isdoaxwhxh$art_i%>', $e($art_isdoaxwhxh$art_i)) + '.subs.' + ($expr = '<%=$art_idxdxuuc$art_i%>', $e($art_idxdxuuc$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
