...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cacmmmgjvn$art_c = themes.length; i < $art_cacmmmgjvn$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cacmmmgjvn$art_c = themes.length; i < $art_cacmmmgjvn$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_itvmtcoa$art_i = 0, $art_ckpdbmsxfh$art_c = list.length; $art_itvmtcoa$art_i < $art_ckpdbmsxfh$art_c; $art_itvmtcoa$art_i++) {    var group = list[$art_itvmtcoa$art_i]%>';
    for (var $art_itvmtcoa$art_i = 0, $art_ckpdbmsxfh$art_c = list.length; $art_itvmtcoa$art_i < $art_ckpdbmsxfh$art_c; $art_itvmtcoa$art_i++) {
        var group = list[$art_itvmtcoa$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijmtovn$art_i = 0, $art_objvfxuynm$art_obj = group.subs, $art_cbesgoxlwgs$art_c = $art_objvfxuynm$art_obj.length; $art_ijmtovn$art_i < $art_cbesgoxlwgs$art_c; $art_ijmtovn$art_i++) {        var item = $art_objvfxuynm$art_obj[$art_ijmtovn$art_i]%>';
        for (var $art_ijmtovn$art_i = 0, $art_objvfxuynm$art_obj = group.subs, $art_cbesgoxlwgs$art_c = $art_objvfxuynm$art_obj.length; $art_ijmtovn$art_i < $art_cbesgoxlwgs$art_c; $art_ijmtovn$art_i++) {
            var item = $art_objvfxuynm$art_obj[$art_ijmtovn$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_itvmtcoa$art_i%>', $e($art_itvmtcoa$art_i)) + '_' + ($expr = '<%=$art_ijmtovn$art_i%>', $e($art_ijmtovn$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_itvmtcoa$art_i%>', $e($art_itvmtcoa$art_i)) + '.subs.' + ($expr = '<%=$art_ijmtovn$art_i%>', $e($art_ijmtovn$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_itvmtcoa$art_i%>', $e($art_itvmtcoa$art_i)) + '_' + ($expr = '<%=$art_ijmtovn$art_i%>', $e($art_ijmtovn$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_itvmtcoa$art_i%>', $e($art_itvmtcoa$art_i)) + '.subs.' + ($expr = '<%=$art_ijmtovn$art_i%>', $e($art_ijmtovn$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
