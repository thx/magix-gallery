...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cxtegwdn$art_c = themes.length; i < $art_cxtegwdn$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cxtegwdn$art_c = themes.length; i < $art_cxtegwdn$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_imbqytgof$art_i = 0, $art_cvqpcxmur$art_c = list.length; $art_imbqytgof$art_i < $art_cvqpcxmur$art_c; $art_imbqytgof$art_i++) {    var group = list[$art_imbqytgof$art_i]%>';
    for (var $art_imbqytgof$art_i = 0, $art_cvqpcxmur$art_c = list.length; $art_imbqytgof$art_i < $art_cvqpcxmur$art_c; $art_imbqytgof$art_i++) {
        var group = list[$art_imbqytgof$art_i];
        ...
        ;
        $expr = '<%for (var $art_iexrvjifi$art_i = 0, $art_objdthuqcido$art_obj = group.subs, $art_cdstscvjxq$art_c = $art_objdthuqcido$art_obj.length; $art_iexrvjifi$art_i < $art_cdstscvjxq$art_c; $art_iexrvjifi$art_i++) {        var item = $art_objdthuqcido$art_obj[$art_iexrvjifi$art_i]%>';
        for (var $art_iexrvjifi$art_i = 0, $art_objdthuqcido$art_obj = group.subs, $art_cdstscvjxq$art_c = $art_objdthuqcido$art_obj.length; $art_iexrvjifi$art_i < $art_cdstscvjxq$art_c; $art_iexrvjifi$art_i++) {
            var item = $art_objdthuqcido$art_obj[$art_iexrvjifi$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_imbqytgof$art_i%>', $e($art_imbqytgof$art_i)) + '_' + ($expr = '<%=$art_iexrvjifi$art_i%>', $e($art_iexrvjifi$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imbqytgof$art_i%>', $e($art_imbqytgof$art_i)) + '.subs.' + ($expr = '<%=$art_iexrvjifi$art_i%>', $e($art_iexrvjifi$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_imbqytgof$art_i%>', $e($art_imbqytgof$art_i)) + '_' + ($expr = '<%=$art_iexrvjifi$art_i%>', $e($art_iexrvjifi$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imbqytgof$art_i%>', $e($art_imbqytgof$art_i)) + '.subs.' + ($expr = '<%=$art_iexrvjifi$art_i%>', $e($art_iexrvjifi$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
