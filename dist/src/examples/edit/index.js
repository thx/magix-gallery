...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_crzvelkvh$art_c = themes.length; i < $art_crzvelkvh$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_crzvelkvh$art_c = themes.length; i < $art_crzvelkvh$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iyysnabogk$art_i = 0, $art_csgkfhn$art_c = list.length; $art_iyysnabogk$art_i < $art_csgkfhn$art_c; $art_iyysnabogk$art_i++) {    var group = list[$art_iyysnabogk$art_i]%>';
    for (var $art_iyysnabogk$art_i = 0, $art_csgkfhn$art_c = list.length; $art_iyysnabogk$art_i < $art_csgkfhn$art_c; $art_iyysnabogk$art_i++) {
        var group = list[$art_iyysnabogk$art_i];
        ...
        ;
        $expr = '<%for (var $art_iudkdhdwmus$art_i = 0, $art_objxaunakpumdg$art_obj = group.subs, $art_capdkwmjx$art_c = $art_objxaunakpumdg$art_obj.length; $art_iudkdhdwmus$art_i < $art_capdkwmjx$art_c; $art_iudkdhdwmus$art_i++) {        var item = $art_objxaunakpumdg$art_obj[$art_iudkdhdwmus$art_i]%>';
        for (var $art_iudkdhdwmus$art_i = 0, $art_objxaunakpumdg$art_obj = group.subs, $art_capdkwmjx$art_c = $art_objxaunakpumdg$art_obj.length; $art_iudkdhdwmus$art_i < $art_capdkwmjx$art_c; $art_iudkdhdwmus$art_i++) {
            var item = $art_objxaunakpumdg$art_obj[$art_iudkdhdwmus$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iyysnabogk$art_i%>', $e($art_iyysnabogk$art_i)) + '_' + ($expr = '<%=$art_iudkdhdwmus$art_i%>', $e($art_iudkdhdwmus$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iyysnabogk$art_i%>', $e($art_iyysnabogk$art_i)) + '.subs.' + ($expr = '<%=$art_iudkdhdwmus$art_i%>', $e($art_iudkdhdwmus$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iyysnabogk$art_i%>', $e($art_iyysnabogk$art_i)) + '_' + ($expr = '<%=$art_iudkdhdwmus$art_i%>', $e($art_iudkdhdwmus$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iyysnabogk$art_i%>', $e($art_iyysnabogk$art_i)) + '.subs.' + ($expr = '<%=$art_iudkdhdwmus$art_i%>', $e($art_iudkdhdwmus$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
