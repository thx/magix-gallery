...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cmktbgda$art_c = themes.length; i < $art_cmktbgda$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cmktbgda$art_c = themes.length; i < $art_cmktbgda$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_isdbjhiju$art_i = 0, $art_cwjtgwnnjym$art_c = list.length; $art_isdbjhiju$art_i < $art_cwjtgwnnjym$art_c; $art_isdbjhiju$art_i++) {    var group = list[$art_isdbjhiju$art_i]%>';
    for (var $art_isdbjhiju$art_i = 0, $art_cwjtgwnnjym$art_c = list.length; $art_isdbjhiju$art_i < $art_cwjtgwnnjym$art_c; $art_isdbjhiju$art_i++) {
        var group = list[$art_isdbjhiju$art_i];
        ...
        ;
        $expr = '<%for (var $art_iszamdkrfxp$art_i = 0, $art_objuydoytrojo$art_obj = group.subs, $art_cgbbyba$art_c = $art_objuydoytrojo$art_obj.length; $art_iszamdkrfxp$art_i < $art_cgbbyba$art_c; $art_iszamdkrfxp$art_i++) {        var item = $art_objuydoytrojo$art_obj[$art_iszamdkrfxp$art_i]%>';
        for (var $art_iszamdkrfxp$art_i = 0, $art_objuydoytrojo$art_obj = group.subs, $art_cgbbyba$art_c = $art_objuydoytrojo$art_obj.length; $art_iszamdkrfxp$art_i < $art_cgbbyba$art_c; $art_iszamdkrfxp$art_i++) {
            var item = $art_objuydoytrojo$art_obj[$art_iszamdkrfxp$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_isdbjhiju$art_i%>', $e($art_isdbjhiju$art_i)) + '_' + ($expr = '<%=$art_iszamdkrfxp$art_i%>', $e($art_iszamdkrfxp$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_isdbjhiju$art_i%>', $e($art_isdbjhiju$art_i)) + '.subs.' + ($expr = '<%=$art_iszamdkrfxp$art_i%>', $e($art_iszamdkrfxp$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_isdbjhiju$art_i%>', $e($art_isdbjhiju$art_i)) + '_' + ($expr = '<%=$art_iszamdkrfxp$art_i%>', $e($art_iszamdkrfxp$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_isdbjhiju$art_i%>', $e($art_isdbjhiju$art_i)) + '.subs.' + ($expr = '<%=$art_iszamdkrfxp$art_i%>', $e($art_iszamdkrfxp$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
