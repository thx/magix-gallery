...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_csglmymtzva$art_c = themes.length; i < $art_csglmymtzva$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_csglmymtzva$art_c = themes.length; i < $art_csglmymtzva$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ihgxzjidtk$art_i = 0, $art_cbtkonfrhp$art_c = list.length; $art_ihgxzjidtk$art_i < $art_cbtkonfrhp$art_c; $art_ihgxzjidtk$art_i++) {    var group = list[$art_ihgxzjidtk$art_i]%>';
    for (var $art_ihgxzjidtk$art_i = 0, $art_cbtkonfrhp$art_c = list.length; $art_ihgxzjidtk$art_i < $art_cbtkonfrhp$art_c; $art_ihgxzjidtk$art_i++) {
        var group = list[$art_ihgxzjidtk$art_i];
        ...
        ;
        $expr = '<%for (var $art_idkgcngpgd$art_i = 0, $art_objdfrxmu$art_obj = group.subs, $art_ccdjykre$art_c = $art_objdfrxmu$art_obj.length; $art_idkgcngpgd$art_i < $art_ccdjykre$art_c; $art_idkgcngpgd$art_i++) {        var item = $art_objdfrxmu$art_obj[$art_idkgcngpgd$art_i]%>';
        for (var $art_idkgcngpgd$art_i = 0, $art_objdfrxmu$art_obj = group.subs, $art_ccdjykre$art_c = $art_objdfrxmu$art_obj.length; $art_idkgcngpgd$art_i < $art_ccdjykre$art_c; $art_idkgcngpgd$art_i++) {
            var item = $art_objdfrxmu$art_obj[$art_idkgcngpgd$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ihgxzjidtk$art_i%>', $e($art_ihgxzjidtk$art_i)) + '_' + ($expr = '<%=$art_idkgcngpgd$art_i%>', $e($art_idkgcngpgd$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ihgxzjidtk$art_i%>', $e($art_ihgxzjidtk$art_i)) + '.subs.' + ($expr = '<%=$art_idkgcngpgd$art_i%>', $e($art_idkgcngpgd$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ihgxzjidtk$art_i%>', $e($art_ihgxzjidtk$art_i)) + '_' + ($expr = '<%=$art_idkgcngpgd$art_i%>', $e($art_idkgcngpgd$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ihgxzjidtk$art_i%>', $e($art_ihgxzjidtk$art_i)) + '.subs.' + ($expr = '<%=$art_idkgcngpgd$art_i%>', $e($art_idkgcngpgd$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
