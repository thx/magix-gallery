...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cdjdexbmog$art_c = themes.length; i < $art_cdjdexbmog$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cdjdexbmog$art_c = themes.length; i < $art_cdjdexbmog$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ionlxlnpl$art_i = 0, $art_cuyqzl$art_c = list.length; $art_ionlxlnpl$art_i < $art_cuyqzl$art_c; $art_ionlxlnpl$art_i++) {    var group = list[$art_ionlxlnpl$art_i]%>';
    for (var $art_ionlxlnpl$art_i = 0, $art_cuyqzl$art_c = list.length; $art_ionlxlnpl$art_i < $art_cuyqzl$art_c; $art_ionlxlnpl$art_i++) {
        var group = list[$art_ionlxlnpl$art_i];
        ...
        ;
        $expr = '<%for (var $art_idddtugnp$art_i = 0, $art_objusznqi$art_obj = group.subs, $art_cosjrwyadfe$art_c = $art_objusznqi$art_obj.length; $art_idddtugnp$art_i < $art_cosjrwyadfe$art_c; $art_idddtugnp$art_i++) {        var item = $art_objusznqi$art_obj[$art_idddtugnp$art_i]%>';
        for (var $art_idddtugnp$art_i = 0, $art_objusznqi$art_obj = group.subs, $art_cosjrwyadfe$art_c = $art_objusznqi$art_obj.length; $art_idddtugnp$art_i < $art_cosjrwyadfe$art_c; $art_idddtugnp$art_i++) {
            var item = $art_objusznqi$art_obj[$art_idddtugnp$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ionlxlnpl$art_i%>', $e($art_ionlxlnpl$art_i)) + '_' + ($expr = '<%=$art_idddtugnp$art_i%>', $e($art_idddtugnp$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ionlxlnpl$art_i%>', $e($art_ionlxlnpl$art_i)) + '.subs.' + ($expr = '<%=$art_idddtugnp$art_i%>', $e($art_idddtugnp$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ionlxlnpl$art_i%>', $e($art_ionlxlnpl$art_i)) + '_' + ($expr = '<%=$art_idddtugnp$art_i%>', $e($art_idddtugnp$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ionlxlnpl$art_i%>', $e($art_ionlxlnpl$art_i)) + '.subs.' + ($expr = '<%=$art_idddtugnp$art_i%>', $e($art_idddtugnp$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
