...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_ctypzbtj$art_c = themes.length; i < $art_ctypzbtj$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_ctypzbtj$art_c = themes.length; i < $art_ctypzbtj$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_inzbnsx$art_i = 0, $art_crxhcktsv$art_c = list.length; $art_inzbnsx$art_i < $art_crxhcktsv$art_c; $art_inzbnsx$art_i++) {    var group = list[$art_inzbnsx$art_i]%>';
    for (var $art_inzbnsx$art_i = 0, $art_crxhcktsv$art_c = list.length; $art_inzbnsx$art_i < $art_crxhcktsv$art_c; $art_inzbnsx$art_i++) {
        var group = list[$art_inzbnsx$art_i];
        ...
        ;
        $expr = '<%for (var $art_iicsqtuagf$art_i = 0, $art_objspbcqsb$art_obj = group.subs, $art_czqefep$art_c = $art_objspbcqsb$art_obj.length; $art_iicsqtuagf$art_i < $art_czqefep$art_c; $art_iicsqtuagf$art_i++) {        var item = $art_objspbcqsb$art_obj[$art_iicsqtuagf$art_i]%>';
        for (var $art_iicsqtuagf$art_i = 0, $art_objspbcqsb$art_obj = group.subs, $art_czqefep$art_c = $art_objspbcqsb$art_obj.length; $art_iicsqtuagf$art_i < $art_czqefep$art_c; $art_iicsqtuagf$art_i++) {
            var item = $art_objspbcqsb$art_obj[$art_iicsqtuagf$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_inzbnsx$art_i%>', $e($art_inzbnsx$art_i)) + '_' + ($expr = '<%=$art_iicsqtuagf$art_i%>', $e($art_iicsqtuagf$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_inzbnsx$art_i%>', $e($art_inzbnsx$art_i)) + '.subs.' + ($expr = '<%=$art_iicsqtuagf$art_i%>', $e($art_iicsqtuagf$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_inzbnsx$art_i%>', $e($art_inzbnsx$art_i)) + '_' + ($expr = '<%=$art_iicsqtuagf$art_i%>', $e($art_iicsqtuagf$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_inzbnsx$art_i%>', $e($art_inzbnsx$art_i)) + '.subs.' + ($expr = '<%=$art_iicsqtuagf$art_i%>', $e($art_iicsqtuagf$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
