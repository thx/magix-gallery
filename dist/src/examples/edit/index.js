...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_ckmljzqkrd$art_c = themes.length; i < $art_ckmljzqkrd$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_ckmljzqkrd$art_c = themes.length; i < $art_ckmljzqkrd$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_izfrapxrw$art_i = 0, $art_cshzgafehi$art_c = list.length; $art_izfrapxrw$art_i < $art_cshzgafehi$art_c; $art_izfrapxrw$art_i++) {    var group = list[$art_izfrapxrw$art_i]%>';
    for (var $art_izfrapxrw$art_i = 0, $art_cshzgafehi$art_c = list.length; $art_izfrapxrw$art_i < $art_cshzgafehi$art_c; $art_izfrapxrw$art_i++) {
        var group = list[$art_izfrapxrw$art_i];
        ...
        ;
        $expr = '<%for (var $art_izymbfo$art_i = 0, $art_objehpoedncf$art_obj = group.subs, $art_cwvxdtjpx$art_c = $art_objehpoedncf$art_obj.length; $art_izymbfo$art_i < $art_cwvxdtjpx$art_c; $art_izymbfo$art_i++) {        var item = $art_objehpoedncf$art_obj[$art_izymbfo$art_i]%>';
        for (var $art_izymbfo$art_i = 0, $art_objehpoedncf$art_obj = group.subs, $art_cwvxdtjpx$art_c = $art_objehpoedncf$art_obj.length; $art_izymbfo$art_i < $art_cwvxdtjpx$art_c; $art_izymbfo$art_i++) {
            var item = $art_objehpoedncf$art_obj[$art_izymbfo$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_izfrapxrw$art_i%>', $e($art_izfrapxrw$art_i)) + '_' + ($expr = '<%=$art_izymbfo$art_i%>', $e($art_izymbfo$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_izfrapxrw$art_i%>', $e($art_izfrapxrw$art_i)) + '.subs.' + ($expr = '<%=$art_izymbfo$art_i%>', $e($art_izymbfo$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_izfrapxrw$art_i%>', $e($art_izfrapxrw$art_i)) + '_' + ($expr = '<%=$art_izymbfo$art_i%>', $e($art_izymbfo$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_izfrapxrw$art_i%>', $e($art_izfrapxrw$art_i)) + '.subs.' + ($expr = '<%=$art_izymbfo$art_i%>', $e($art_izymbfo$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
