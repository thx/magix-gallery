...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cvaqkxjme$art_c = themes.length; i < $art_cvaqkxjme$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cvaqkxjme$art_c = themes.length; i < $art_cvaqkxjme$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ilkzfrsgsk$art_i = 0, $art_cnbplz$art_c = list.length; $art_ilkzfrsgsk$art_i < $art_cnbplz$art_c; $art_ilkzfrsgsk$art_i++) {    var group = list[$art_ilkzfrsgsk$art_i]%>';
    for (var $art_ilkzfrsgsk$art_i = 0, $art_cnbplz$art_c = list.length; $art_ilkzfrsgsk$art_i < $art_cnbplz$art_c; $art_ilkzfrsgsk$art_i++) {
        var group = list[$art_ilkzfrsgsk$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixkmymjk$art_i = 0, $art_objaqihwcdfp$art_obj = group.subs, $art_codtwgto$art_c = $art_objaqihwcdfp$art_obj.length; $art_ixkmymjk$art_i < $art_codtwgto$art_c; $art_ixkmymjk$art_i++) {        var item = $art_objaqihwcdfp$art_obj[$art_ixkmymjk$art_i]%>';
        for (var $art_ixkmymjk$art_i = 0, $art_objaqihwcdfp$art_obj = group.subs, $art_codtwgto$art_c = $art_objaqihwcdfp$art_obj.length; $art_ixkmymjk$art_i < $art_codtwgto$art_c; $art_ixkmymjk$art_i++) {
            var item = $art_objaqihwcdfp$art_obj[$art_ixkmymjk$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ilkzfrsgsk$art_i%>', $e($art_ilkzfrsgsk$art_i)) + '_' + ($expr = '<%=$art_ixkmymjk$art_i%>', $e($art_ixkmymjk$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ilkzfrsgsk$art_i%>', $e($art_ilkzfrsgsk$art_i)) + '.subs.' + ($expr = '<%=$art_ixkmymjk$art_i%>', $e($art_ixkmymjk$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ilkzfrsgsk$art_i%>', $e($art_ilkzfrsgsk$art_i)) + '_' + ($expr = '<%=$art_ixkmymjk$art_i%>', $e($art_ixkmymjk$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ilkzfrsgsk$art_i%>', $e($art_ilkzfrsgsk$art_i)) + '.subs.' + ($expr = '<%=$art_ixkmymjk$art_i%>', $e($art_ixkmymjk$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
