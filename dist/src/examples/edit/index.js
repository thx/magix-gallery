...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cynatmipb$art_c = themes.length; i < $art_cynatmipb$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cynatmipb$art_c = themes.length; i < $art_cynatmipb$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iiemqgywwd$art_i = 0, $art_cqlssmedm$art_c = list.length; $art_iiemqgywwd$art_i < $art_cqlssmedm$art_c; $art_iiemqgywwd$art_i++) {    var group = list[$art_iiemqgywwd$art_i]%>';
    for (var $art_iiemqgywwd$art_i = 0, $art_cqlssmedm$art_c = list.length; $art_iiemqgywwd$art_i < $art_cqlssmedm$art_c; $art_iiemqgywwd$art_i++) {
        var group = list[$art_iiemqgywwd$art_i];
        ...
        ;
        $expr = '<%for (var $art_ivqshduk$art_i = 0, $art_objgjctysbj$art_obj = group.subs, $art_cerknarrzm$art_c = $art_objgjctysbj$art_obj.length; $art_ivqshduk$art_i < $art_cerknarrzm$art_c; $art_ivqshduk$art_i++) {        var item = $art_objgjctysbj$art_obj[$art_ivqshduk$art_i]%>';
        for (var $art_ivqshduk$art_i = 0, $art_objgjctysbj$art_obj = group.subs, $art_cerknarrzm$art_c = $art_objgjctysbj$art_obj.length; $art_ivqshduk$art_i < $art_cerknarrzm$art_c; $art_ivqshduk$art_i++) {
            var item = $art_objgjctysbj$art_obj[$art_ivqshduk$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iiemqgywwd$art_i%>', $e($art_iiemqgywwd$art_i)) + '_' + ($expr = '<%=$art_ivqshduk$art_i%>', $e($art_ivqshduk$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iiemqgywwd$art_i%>', $e($art_iiemqgywwd$art_i)) + '.subs.' + ($expr = '<%=$art_ivqshduk$art_i%>', $e($art_ivqshduk$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iiemqgywwd$art_i%>', $e($art_iiemqgywwd$art_i)) + '_' + ($expr = '<%=$art_ivqshduk$art_i%>', $e($art_ivqshduk$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iiemqgywwd$art_i%>', $e($art_iiemqgywwd$art_i)) + '.subs.' + ($expr = '<%=$art_ivqshduk$art_i%>', $e($art_ivqshduk$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
