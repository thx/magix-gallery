...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_ctxtisfuck$art_c = themes.length; i < $art_ctxtisfuck$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_ctxtisfuck$art_c = themes.length; i < $art_ctxtisfuck$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iqxlxdbxj$art_i = 0, $art_ctvpfovde$art_c = list.length; $art_iqxlxdbxj$art_i < $art_ctvpfovde$art_c; $art_iqxlxdbxj$art_i++) {    var group = list[$art_iqxlxdbxj$art_i]%>';
    for (var $art_iqxlxdbxj$art_i = 0, $art_ctvpfovde$art_c = list.length; $art_iqxlxdbxj$art_i < $art_ctvpfovde$art_c; $art_iqxlxdbxj$art_i++) {
        var group = list[$art_iqxlxdbxj$art_i];
        ...
        ;
        $expr = '<%for (var $art_icsgwlskb$art_i = 0, $art_objzfalktfje$art_obj = group.subs, $art_caivoy$art_c = $art_objzfalktfje$art_obj.length; $art_icsgwlskb$art_i < $art_caivoy$art_c; $art_icsgwlskb$art_i++) {        var item = $art_objzfalktfje$art_obj[$art_icsgwlskb$art_i]%>';
        for (var $art_icsgwlskb$art_i = 0, $art_objzfalktfje$art_obj = group.subs, $art_caivoy$art_c = $art_objzfalktfje$art_obj.length; $art_icsgwlskb$art_i < $art_caivoy$art_c; $art_icsgwlskb$art_i++) {
            var item = $art_objzfalktfje$art_obj[$art_icsgwlskb$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iqxlxdbxj$art_i%>', $e($art_iqxlxdbxj$art_i)) + '_' + ($expr = '<%=$art_icsgwlskb$art_i%>', $e($art_icsgwlskb$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iqxlxdbxj$art_i%>', $e($art_iqxlxdbxj$art_i)) + '.subs.' + ($expr = '<%=$art_icsgwlskb$art_i%>', $e($art_icsgwlskb$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iqxlxdbxj$art_i%>', $e($art_iqxlxdbxj$art_i)) + '_' + ($expr = '<%=$art_icsgwlskb$art_i%>', $e($art_icsgwlskb$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iqxlxdbxj$art_i%>', $e($art_iqxlxdbxj$art_i)) + '.subs.' + ($expr = '<%=$art_icsgwlskb$art_i%>', $e($art_icsgwlskb$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
