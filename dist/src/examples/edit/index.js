...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_ctkesdake$art_c = themes.length; i < $art_ctkesdake$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_ctkesdake$art_c = themes.length; i < $art_ctkesdake$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iruomqlamug$art_i = 0, $art_cntpgtldvh$art_c = list.length; $art_iruomqlamug$art_i < $art_cntpgtldvh$art_c; $art_iruomqlamug$art_i++) {    var group = list[$art_iruomqlamug$art_i]%>';
    for (var $art_iruomqlamug$art_i = 0, $art_cntpgtldvh$art_c = list.length; $art_iruomqlamug$art_i < $art_cntpgtldvh$art_c; $art_iruomqlamug$art_i++) {
        var group = list[$art_iruomqlamug$art_i];
        ...
        ;
        $expr = '<%for (var $art_iffdcxtdf$art_i = 0, $art_objuffddjzh$art_obj = group.subs, $art_cpkleykfgj$art_c = $art_objuffddjzh$art_obj.length; $art_iffdcxtdf$art_i < $art_cpkleykfgj$art_c; $art_iffdcxtdf$art_i++) {        var item = $art_objuffddjzh$art_obj[$art_iffdcxtdf$art_i]%>';
        for (var $art_iffdcxtdf$art_i = 0, $art_objuffddjzh$art_obj = group.subs, $art_cpkleykfgj$art_c = $art_objuffddjzh$art_obj.length; $art_iffdcxtdf$art_i < $art_cpkleykfgj$art_c; $art_iffdcxtdf$art_i++) {
            var item = $art_objuffddjzh$art_obj[$art_iffdcxtdf$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iruomqlamug$art_i%>', $e($art_iruomqlamug$art_i)) + '_' + ($expr = '<%=$art_iffdcxtdf$art_i%>', $e($art_iffdcxtdf$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iruomqlamug$art_i%>', $e($art_iruomqlamug$art_i)) + '.subs.' + ($expr = '<%=$art_iffdcxtdf$art_i%>', $e($art_iffdcxtdf$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iruomqlamug$art_i%>', $e($art_iruomqlamug$art_i)) + '_' + ($expr = '<%=$art_iffdcxtdf$art_i%>', $e($art_iffdcxtdf$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iruomqlamug$art_i%>', $e($art_iruomqlamug$art_i)) + '.subs.' + ($expr = '<%=$art_iffdcxtdf$art_i%>', $e($art_iffdcxtdf$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
