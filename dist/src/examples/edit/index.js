...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_chdsluzhcdkb$art_c = themes.length; i < $art_chdsluzhcdkb$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_chdsluzhcdkb$art_c = themes.length; i < $art_chdsluzhcdkb$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_igfbmekqpe$art_i = 0, $art_cthqnbjw$art_c = list.length; $art_igfbmekqpe$art_i < $art_cthqnbjw$art_c; $art_igfbmekqpe$art_i++) {    var group = list[$art_igfbmekqpe$art_i]%>';
    for (var $art_igfbmekqpe$art_i = 0, $art_cthqnbjw$art_c = list.length; $art_igfbmekqpe$art_i < $art_cthqnbjw$art_c; $art_igfbmekqpe$art_i++) {
        var group = list[$art_igfbmekqpe$art_i];
        ...
        ;
        $expr = '<%for (var $art_iimrpwlg$art_i = 0, $art_objbcptdit$art_obj = group.subs, $art_crycazatjjeq$art_c = $art_objbcptdit$art_obj.length; $art_iimrpwlg$art_i < $art_crycazatjjeq$art_c; $art_iimrpwlg$art_i++) {        var item = $art_objbcptdit$art_obj[$art_iimrpwlg$art_i]%>';
        for (var $art_iimrpwlg$art_i = 0, $art_objbcptdit$art_obj = group.subs, $art_crycazatjjeq$art_c = $art_objbcptdit$art_obj.length; $art_iimrpwlg$art_i < $art_crycazatjjeq$art_c; $art_iimrpwlg$art_i++) {
            var item = $art_objbcptdit$art_obj[$art_iimrpwlg$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_igfbmekqpe$art_i%>', $e($art_igfbmekqpe$art_i)) + '_' + ($expr = '<%=$art_iimrpwlg$art_i%>', $e($art_iimrpwlg$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_igfbmekqpe$art_i%>', $e($art_igfbmekqpe$art_i)) + '.subs.' + ($expr = '<%=$art_iimrpwlg$art_i%>', $e($art_iimrpwlg$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_igfbmekqpe$art_i%>', $e($art_igfbmekqpe$art_i)) + '_' + ($expr = '<%=$art_iimrpwlg$art_i%>', $e($art_iimrpwlg$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_igfbmekqpe$art_i%>', $e($art_igfbmekqpe$art_i)) + '.subs.' + ($expr = '<%=$art_iimrpwlg$art_i%>', $e($art_iimrpwlg$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
