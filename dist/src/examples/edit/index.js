...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cxzugmcuawj$art_c = themes.length; i < $art_cxzugmcuawj$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cxzugmcuawj$art_c = themes.length; i < $art_cxzugmcuawj$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_imgullhxihqk$art_i = 0, $art_cepwditjaam$art_c = list.length; $art_imgullhxihqk$art_i < $art_cepwditjaam$art_c; $art_imgullhxihqk$art_i++) {    var group = list[$art_imgullhxihqk$art_i]%>';
    for (var $art_imgullhxihqk$art_i = 0, $art_cepwditjaam$art_c = list.length; $art_imgullhxihqk$art_i < $art_cepwditjaam$art_c; $art_imgullhxihqk$art_i++) {
        var group = list[$art_imgullhxihqk$art_i];
        ...
        ;
        $expr = '<%for (var $art_iekvc$art_i = 0, $art_objfpmik$art_obj = group.subs, $art_cqwpoyddyo$art_c = $art_objfpmik$art_obj.length; $art_iekvc$art_i < $art_cqwpoyddyo$art_c; $art_iekvc$art_i++) {        var item = $art_objfpmik$art_obj[$art_iekvc$art_i]%>';
        for (var $art_iekvc$art_i = 0, $art_objfpmik$art_obj = group.subs, $art_cqwpoyddyo$art_c = $art_objfpmik$art_obj.length; $art_iekvc$art_i < $art_cqwpoyddyo$art_c; $art_iekvc$art_i++) {
            var item = $art_objfpmik$art_obj[$art_iekvc$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_imgullhxihqk$art_i%>', $e($art_imgullhxihqk$art_i)) + '_' + ($expr = '<%=$art_iekvc$art_i%>', $e($art_iekvc$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imgullhxihqk$art_i%>', $e($art_imgullhxihqk$art_i)) + '.subs.' + ($expr = '<%=$art_iekvc$art_i%>', $e($art_iekvc$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_imgullhxihqk$art_i%>', $e($art_imgullhxihqk$art_i)) + '_' + ($expr = '<%=$art_iekvc$art_i%>', $e($art_iekvc$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imgullhxihqk$art_i%>', $e($art_imgullhxihqk$art_i)) + '.subs.' + ($expr = '<%=$art_iekvc$art_i%>', $e($art_iekvc$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
