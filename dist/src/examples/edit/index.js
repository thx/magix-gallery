...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cttiysbbh$art_c = themes.length; i < $art_cttiysbbh$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cttiysbbh$art_c = themes.length; i < $art_cttiysbbh$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ivaoui$art_i = 0, $art_cuffwic$art_c = list.length; $art_ivaoui$art_i < $art_cuffwic$art_c; $art_ivaoui$art_i++) {    var group = list[$art_ivaoui$art_i]%>';
    for (var $art_ivaoui$art_i = 0, $art_cuffwic$art_c = list.length; $art_ivaoui$art_i < $art_cuffwic$art_c; $art_ivaoui$art_i++) {
        var group = list[$art_ivaoui$art_i];
        ...
        ;
        $expr = '<%for (var $art_iqvssxbjc$art_i = 0, $art_objzjptgbjs$art_obj = group.subs, $art_couuiefm$art_c = $art_objzjptgbjs$art_obj.length; $art_iqvssxbjc$art_i < $art_couuiefm$art_c; $art_iqvssxbjc$art_i++) {        var item = $art_objzjptgbjs$art_obj[$art_iqvssxbjc$art_i]%>';
        for (var $art_iqvssxbjc$art_i = 0, $art_objzjptgbjs$art_obj = group.subs, $art_couuiefm$art_c = $art_objzjptgbjs$art_obj.length; $art_iqvssxbjc$art_i < $art_couuiefm$art_c; $art_iqvssxbjc$art_i++) {
            var item = $art_objzjptgbjs$art_obj[$art_iqvssxbjc$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ivaoui$art_i%>', $e($art_ivaoui$art_i)) + '_' + ($expr = '<%=$art_iqvssxbjc$art_i%>', $e($art_iqvssxbjc$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ivaoui$art_i%>', $e($art_ivaoui$art_i)) + '.subs.' + ($expr = '<%=$art_iqvssxbjc$art_i%>', $e($art_iqvssxbjc$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ivaoui$art_i%>', $e($art_ivaoui$art_i)) + '_' + ($expr = '<%=$art_iqvssxbjc$art_i%>', $e($art_iqvssxbjc$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ivaoui$art_i%>', $e($art_ivaoui$art_i)) + '.subs.' + ($expr = '<%=$art_iqvssxbjc$art_i%>', $e($art_iqvssxbjc$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
