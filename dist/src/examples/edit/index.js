...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cezlznv$art_c = themes.length; i < $art_cezlznv$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cezlznv$art_c = themes.length; i < $art_cezlznv$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_imofnxtod$art_i = 0, $art_cbtxkjewh$art_c = list.length; $art_imofnxtod$art_i < $art_cbtxkjewh$art_c; $art_imofnxtod$art_i++) {    var group = list[$art_imofnxtod$art_i]%>';
    for (var $art_imofnxtod$art_i = 0, $art_cbtxkjewh$art_c = list.length; $art_imofnxtod$art_i < $art_cbtxkjewh$art_c; $art_imofnxtod$art_i++) {
        var group = list[$art_imofnxtod$art_i];
        ...
        ;
        $expr = '<%for (var $art_iyxrwzgf$art_i = 0, $art_objorjaij$art_obj = group.subs, $art_cevhktu$art_c = $art_objorjaij$art_obj.length; $art_iyxrwzgf$art_i < $art_cevhktu$art_c; $art_iyxrwzgf$art_i++) {        var item = $art_objorjaij$art_obj[$art_iyxrwzgf$art_i]%>';
        for (var $art_iyxrwzgf$art_i = 0, $art_objorjaij$art_obj = group.subs, $art_cevhktu$art_c = $art_objorjaij$art_obj.length; $art_iyxrwzgf$art_i < $art_cevhktu$art_c; $art_iyxrwzgf$art_i++) {
            var item = $art_objorjaij$art_obj[$art_iyxrwzgf$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_imofnxtod$art_i%>', $e($art_imofnxtod$art_i)) + '_' + ($expr = '<%=$art_iyxrwzgf$art_i%>', $e($art_iyxrwzgf$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imofnxtod$art_i%>', $e($art_imofnxtod$art_i)) + '.subs.' + ($expr = '<%=$art_iyxrwzgf$art_i%>', $e($art_iyxrwzgf$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_imofnxtod$art_i%>', $e($art_imofnxtod$art_i)) + '_' + ($expr = '<%=$art_iyxrwzgf$art_i%>', $e($art_iyxrwzgf$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imofnxtod$art_i%>', $e($art_imofnxtod$art_i)) + '.subs.' + ($expr = '<%=$art_iyxrwzgf$art_i%>', $e($art_iyxrwzgf$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
