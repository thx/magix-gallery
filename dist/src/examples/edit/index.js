...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cniijuzje$art_c = themes.length; i < $art_cniijuzje$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cniijuzje$art_c = themes.length; i < $art_cniijuzje$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iuvmbkxd$art_i = 0, $art_cvgkxbqfjhh$art_c = list.length; $art_iuvmbkxd$art_i < $art_cvgkxbqfjhh$art_c; $art_iuvmbkxd$art_i++) {    var group = list[$art_iuvmbkxd$art_i]%>';
    for (var $art_iuvmbkxd$art_i = 0, $art_cvgkxbqfjhh$art_c = list.length; $art_iuvmbkxd$art_i < $art_cvgkxbqfjhh$art_c; $art_iuvmbkxd$art_i++) {
        var group = list[$art_iuvmbkxd$art_i];
        ...
        ;
        $expr = '<%for (var $art_iusxfrdmb$art_i = 0, $art_objrhguyzc$art_obj = group.subs, $art_cpdiljsq$art_c = $art_objrhguyzc$art_obj.length; $art_iusxfrdmb$art_i < $art_cpdiljsq$art_c; $art_iusxfrdmb$art_i++) {        var item = $art_objrhguyzc$art_obj[$art_iusxfrdmb$art_i]%>';
        for (var $art_iusxfrdmb$art_i = 0, $art_objrhguyzc$art_obj = group.subs, $art_cpdiljsq$art_c = $art_objrhguyzc$art_obj.length; $art_iusxfrdmb$art_i < $art_cpdiljsq$art_c; $art_iusxfrdmb$art_i++) {
            var item = $art_objrhguyzc$art_obj[$art_iusxfrdmb$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iuvmbkxd$art_i%>', $e($art_iuvmbkxd$art_i)) + '_' + ($expr = '<%=$art_iusxfrdmb$art_i%>', $e($art_iusxfrdmb$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iuvmbkxd$art_i%>', $e($art_iuvmbkxd$art_i)) + '.subs.' + ($expr = '<%=$art_iusxfrdmb$art_i%>', $e($art_iusxfrdmb$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iuvmbkxd$art_i%>', $e($art_iuvmbkxd$art_i)) + '_' + ($expr = '<%=$art_iusxfrdmb$art_i%>', $e($art_iusxfrdmb$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iuvmbkxd$art_i%>', $e($art_iuvmbkxd$art_i)) + '.subs.' + ($expr = '<%=$art_iusxfrdmb$art_i%>', $e($art_iusxfrdmb$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
