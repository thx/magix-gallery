...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_ckuioqmkfr$art_c = themes.length; i < $art_ckuioqmkfr$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_ckuioqmkfr$art_c = themes.length; i < $art_ckuioqmkfr$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ioccojmg$art_i = 0, $art_cnoqucj$art_c = list.length; $art_ioccojmg$art_i < $art_cnoqucj$art_c; $art_ioccojmg$art_i++) {    var group = list[$art_ioccojmg$art_i]%>';
    for (var $art_ioccojmg$art_i = 0, $art_cnoqucj$art_c = list.length; $art_ioccojmg$art_i < $art_cnoqucj$art_c; $art_ioccojmg$art_i++) {
        var group = list[$art_ioccojmg$art_i];
        ...
        ;
        $expr = '<%for (var $art_imrenzhnis$art_i = 0, $art_objrlbmnoqu$art_obj = group.subs, $art_czqbfgve$art_c = $art_objrlbmnoqu$art_obj.length; $art_imrenzhnis$art_i < $art_czqbfgve$art_c; $art_imrenzhnis$art_i++) {        var item = $art_objrlbmnoqu$art_obj[$art_imrenzhnis$art_i]%>';
        for (var $art_imrenzhnis$art_i = 0, $art_objrlbmnoqu$art_obj = group.subs, $art_czqbfgve$art_c = $art_objrlbmnoqu$art_obj.length; $art_imrenzhnis$art_i < $art_czqbfgve$art_c; $art_imrenzhnis$art_i++) {
            var item = $art_objrlbmnoqu$art_obj[$art_imrenzhnis$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ioccojmg$art_i%>', $e($art_ioccojmg$art_i)) + '_' + ($expr = '<%=$art_imrenzhnis$art_i%>', $e($art_imrenzhnis$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ioccojmg$art_i%>', $e($art_ioccojmg$art_i)) + '.subs.' + ($expr = '<%=$art_imrenzhnis$art_i%>', $e($art_imrenzhnis$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ioccojmg$art_i%>', $e($art_ioccojmg$art_i)) + '_' + ($expr = '<%=$art_imrenzhnis$art_i%>', $e($art_imrenzhnis$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ioccojmg$art_i%>', $e($art_ioccojmg$art_i)) + '.subs.' + ($expr = '<%=$art_imrenzhnis$art_i%>', $e($art_imrenzhnis$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
