...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cqqjccqmpf$art_c = themes.length; i < $art_cqqjccqmpf$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cqqjccqmpf$art_c = themes.length; i < $art_cqqjccqmpf$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ifrvaknxubs$art_i = 0, $art_cvllbazsz$art_c = list.length; $art_ifrvaknxubs$art_i < $art_cvllbazsz$art_c; $art_ifrvaknxubs$art_i++) {    var group = list[$art_ifrvaknxubs$art_i]%>';
    for (var $art_ifrvaknxubs$art_i = 0, $art_cvllbazsz$art_c = list.length; $art_ifrvaknxubs$art_i < $art_cvllbazsz$art_c; $art_ifrvaknxubs$art_i++) {
        var group = list[$art_ifrvaknxubs$art_i];
        ...
        ;
        $expr = '<%for (var $art_imvmrvuj$art_i = 0, $art_objrjtliczh$art_obj = group.subs, $art_cicwq$art_c = $art_objrjtliczh$art_obj.length; $art_imvmrvuj$art_i < $art_cicwq$art_c; $art_imvmrvuj$art_i++) {        var item = $art_objrjtliczh$art_obj[$art_imvmrvuj$art_i]%>';
        for (var $art_imvmrvuj$art_i = 0, $art_objrjtliczh$art_obj = group.subs, $art_cicwq$art_c = $art_objrjtliczh$art_obj.length; $art_imvmrvuj$art_i < $art_cicwq$art_c; $art_imvmrvuj$art_i++) {
            var item = $art_objrjtliczh$art_obj[$art_imvmrvuj$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ifrvaknxubs$art_i%>', $e($art_ifrvaknxubs$art_i)) + '_' + ($expr = '<%=$art_imvmrvuj$art_i%>', $e($art_imvmrvuj$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ifrvaknxubs$art_i%>', $e($art_ifrvaknxubs$art_i)) + '.subs.' + ($expr = '<%=$art_imvmrvuj$art_i%>', $e($art_imvmrvuj$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ifrvaknxubs$art_i%>', $e($art_ifrvaknxubs$art_i)) + '_' + ($expr = '<%=$art_imvmrvuj$art_i%>', $e($art_imvmrvuj$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ifrvaknxubs$art_i%>', $e($art_ifrvaknxubs$art_i)) + '.subs.' + ($expr = '<%=$art_imvmrvuj$art_i%>', $e($art_imvmrvuj$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
