...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cmykjvp$art_c = themes.length; i < $art_cmykjvp$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cmykjvp$art_c = themes.length; i < $art_cmykjvp$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iyzdhrwub$art_i = 0, $art_cmtkmcbax$art_c = list.length; $art_iyzdhrwub$art_i < $art_cmtkmcbax$art_c; $art_iyzdhrwub$art_i++) {    var group = list[$art_iyzdhrwub$art_i]%>';
    for (var $art_iyzdhrwub$art_i = 0, $art_cmtkmcbax$art_c = list.length; $art_iyzdhrwub$art_i < $art_cmtkmcbax$art_c; $art_iyzdhrwub$art_i++) {
        var group = list[$art_iyzdhrwub$art_i];
        ...
        ;
        $expr = '<%for (var $art_iupmiu$art_i = 0, $art_objwjgliq$art_obj = group.subs, $art_ccbitlwvx$art_c = $art_objwjgliq$art_obj.length; $art_iupmiu$art_i < $art_ccbitlwvx$art_c; $art_iupmiu$art_i++) {        var item = $art_objwjgliq$art_obj[$art_iupmiu$art_i]%>';
        for (var $art_iupmiu$art_i = 0, $art_objwjgliq$art_obj = group.subs, $art_ccbitlwvx$art_c = $art_objwjgliq$art_obj.length; $art_iupmiu$art_i < $art_ccbitlwvx$art_c; $art_iupmiu$art_i++) {
            var item = $art_objwjgliq$art_obj[$art_iupmiu$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iyzdhrwub$art_i%>', $e($art_iyzdhrwub$art_i)) + '_' + ($expr = '<%=$art_iupmiu$art_i%>', $e($art_iupmiu$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iyzdhrwub$art_i%>', $e($art_iyzdhrwub$art_i)) + '.subs.' + ($expr = '<%=$art_iupmiu$art_i%>', $e($art_iupmiu$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iyzdhrwub$art_i%>', $e($art_iyzdhrwub$art_i)) + '_' + ($expr = '<%=$art_iupmiu$art_i%>', $e($art_iupmiu$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iyzdhrwub$art_i%>', $e($art_iyzdhrwub$art_i)) + '.subs.' + ($expr = '<%=$art_iupmiu$art_i%>', $e($art_iupmiu$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
