...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cnykgrafm$art_c = list.length; index < $art_cnykgrafm$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cnykgrafm$art_c = list.length; index < $art_cnykgrafm$art_c; index++) {
        var item = list[index];
        $p += ' ';
        $line = 15;
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_chfoywng$art_c = list.length; index < $art_chfoywng$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_chfoywng$art_c = list.length; index < $art_chfoywng$art_c; index++) {
        var item = list[index];
