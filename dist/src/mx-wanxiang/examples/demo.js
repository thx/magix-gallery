...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cdxeurtne$art_c = list.length; index < $art_cdxeurtne$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cdxeurtne$art_c = list.length; index < $art_cdxeurtne$art_c; index++) {
        var item = list[index];
        $p += ' ';
        $line = 15;
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cjbctuab$art_c = list.length; index < $art_cjbctuab$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cjbctuab$art_c = list.length; index < $art_cjbctuab$art_c; index++) {
        var item = list[index];
