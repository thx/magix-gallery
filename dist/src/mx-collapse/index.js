...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaA:_" class="_zs_gallery_mx-collapse_index_-collapse">';
    $line = 2;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_ctcrbvbmewi$art_c = list.length; index < $art_ctcrbvbmewi$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ctcrbvbmewi$art_c = list.length; index < $art_ctcrbvbmewi$art_c; index++) {
        var item = list[index];
        ...
        ;
        $p += '><span mxa="_zs_galleryaA:a" class="_zs_gallery_mx-collapse_index_-arrow">';
        $line = 5;
        $art = '!item.arrow';
        ;
        $p += ($expr = '<%!item.arrow%>', $n(item.arrow)) + '</span><span mxa="_zs_galleryaA:b" class="_zs_gallery_mx-collapse_index_-text">';
        $line = 6;
        $art = '=item.title';
        ;
