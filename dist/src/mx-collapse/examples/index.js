/*
    ...
    loader: cmd_es
 */
define("mx-collapse/examples/index",["magix","$","examples/subs","mx-title/second","./1","./2","./3","./4","examples/api","examples/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryaI:a" class="clearfix mb20"><div mx-view="mx-collapse/examples/1" id="';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mx-view="mx-collapse/examples/2" id="';
    $line = 28;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div><div mx-view="mx-collapse/examples/3" id="';
    $line = 29;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div><div mx-view="mx-collapse/examples/4" id="';
    $line = 30;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-collapse/examples/index.html';
    throw msg;
} return $p; },
    render: function () {
        var options = [{
