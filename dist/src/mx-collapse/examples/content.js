...
module.exports = Magix.View.extend({
    ...
    $art = '!outer.title';
    ;
    $p += ($expr = '<%!outer.title%>', $n(outer.title)) + '</div><div mxs="_zs_galleryaH:_" class="clearfix"><div class="_zs_gallery_mx-collapse_examples_index_-demo" mx-view="mx-preview/index?format=2&url=%2F%2Fimg.alicdn.com%2Ftfscom%2FTB10l9lbgZC2uNjSZFnXXaxZpXa.png&maxWidth=100&maxHeight=100"></div><div class="_zs_gallery_mx-collapse_examples_index_-demo" mx-view="mx-preview/index?format=2&url=%2F%2Fimg.alicdn.com%2Ftfscom%2FTB10l9lbgZC2uNjSZFnXXaxZpXa.png&maxWidth=100&maxHeight=100"></div></div>';
}
catch (ex) {
