...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwjps$art_i = 0, $art_cygpfi$art_c = checkboxes.length; $art_iwjps$art_i < $art_cygpfi$art_c; $art_iwjps$art_i++) {    var c = checkboxes[$art_iwjps$art_i]%>';
    for (var $art_iwjps$art_i = 0, $art_cygpfi$art_c = checkboxes.length; $art_iwjps$art_i < $art_cygpfi$art_c; $art_iwjps$art_i++) {
        var c = checkboxes[$art_iwjps$art_i];
