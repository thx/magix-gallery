...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyzwapr$art_i = 0, $art_cmibawurcp$art_c = radioes.length; $art_iyzwapr$art_i < $art_cmibawurcp$art_c; $art_iyzwapr$art_i++) {    var r = radioes[$art_iyzwapr$art_i]%>';
    for (var $art_iyzwapr$art_i = 0, $art_cmibawurcp$art_c = radioes.length; $art_iyzwapr$art_i < $art_cmibawurcp$art_c; $art_iyzwapr$art_i++) {
        var r = radioes[$art_iyzwapr$art_i];
