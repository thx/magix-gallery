...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ieoxptas$art_i = 0, $art_cnrjcbnhve$art_c = list.length; $art_ieoxptas$art_i < $art_cnrjcbnhve$art_c; $art_ieoxptas$art_i++) {    var item = list[$art_ieoxptas$art_i]%>';
    for (var $art_ieoxptas$art_i = 0, $art_cnrjcbnhve$art_c = list.length; $art_ieoxptas$art_i < $art_cnrjcbnhve$art_c; $art_ieoxptas$art_i++) {
        var item = list[$art_ieoxptas$art_i];
