...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_impbozfcno$art_i = 0, $art_crypumpokq$art_c = checkboxes.length; $art_impbozfcno$art_i < $art_crypumpokq$art_c; $art_impbozfcno$art_i++) {    var c = checkboxes[$art_impbozfcno$art_i]%>';
    for (var $art_impbozfcno$art_i = 0, $art_crypumpokq$art_c = checkboxes.length; $art_impbozfcno$art_i < $art_crypumpokq$art_c; $art_impbozfcno$art_i++) {
        var c = checkboxes[$art_impbozfcno$art_i];
    ...
    ;
    $expr = '<%for (var $art_iaswsawre$art_i = 0, $art_cpwyyhgcjq$art_c = radioes.length; $art_iaswsawre$art_i < $art_cpwyyhgcjq$art_c; $art_iaswsawre$art_i++) {    var r = radioes[$art_iaswsawre$art_i]%>';
    for (var $art_iaswsawre$art_i = 0, $art_cpwyyhgcjq$art_c = radioes.length; $art_iaswsawre$art_i < $art_cpwyyhgcjq$art_c; $art_iaswsawre$art_i++) {
        var r = radioes[$art_iaswsawre$art_i];
