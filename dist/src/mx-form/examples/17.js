...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwozfhexj$art_i = 0, $art_cesafn$art_c = checkboxes.length; $art_iwozfhexj$art_i < $art_cesafn$art_c; $art_iwozfhexj$art_i++) {    var c = checkboxes[$art_iwozfhexj$art_i]%>';
    for (var $art_iwozfhexj$art_i = 0, $art_cesafn$art_c = checkboxes.length; $art_iwozfhexj$art_i < $art_cesafn$art_c; $art_iwozfhexj$art_i++) {
        var c = checkboxes[$art_iwozfhexj$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwrpkvmnf$art_i = 0, $art_cgxvdnebhh$art_c = radioes.length; $art_iwrpkvmnf$art_i < $art_cgxvdnebhh$art_c; $art_iwrpkvmnf$art_i++) {    var r = radioes[$art_iwrpkvmnf$art_i]%>';
    for (var $art_iwrpkvmnf$art_i = 0, $art_cgxvdnebhh$art_c = radioes.length; $art_iwrpkvmnf$art_i < $art_cgxvdnebhh$art_c; $art_iwrpkvmnf$art_i++) {
        var r = radioes[$art_iwrpkvmnf$art_i];
