...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cyejkfxjyg$art_c = list.length; index < $art_cyejkfxjyg$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cyejkfxjyg$art_c = list.length; index < $art_cyejkfxjyg$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv><td>';
        $line = 36;
        $art = '=item.name';
