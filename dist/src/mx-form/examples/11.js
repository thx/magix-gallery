...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igzytxoeb$art_i = 0, $art_cxhtsyymu$art_c = checkboxes.length; $art_igzytxoeb$art_i < $art_cxhtsyymu$art_c; $art_igzytxoeb$art_i++) {    var c = checkboxes[$art_igzytxoeb$art_i]%>';
    for (var $art_igzytxoeb$art_i = 0, $art_cxhtsyymu$art_c = checkboxes.length; $art_igzytxoeb$art_i < $art_cxhtsyymu$art_c; $art_igzytxoeb$art_i++) {
        var c = checkboxes[$art_igzytxoeb$art_i];
