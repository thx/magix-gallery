...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iodxinc$art_i = 0, $art_cgmmbdip$art_c = checkboxes.length; $art_iodxinc$art_i < $art_cgmmbdip$art_c; $art_iodxinc$art_i++) {    var c = checkboxes[$art_iodxinc$art_i]%>';
    for (var $art_iodxinc$art_i = 0, $art_cgmmbdip$art_c = checkboxes.length; $art_iodxinc$art_i < $art_cgmmbdip$art_c; $art_iodxinc$art_i++) {
        var c = checkboxes[$art_iodxinc$art_i];
