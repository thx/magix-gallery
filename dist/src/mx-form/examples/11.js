...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iylsakfxg$art_i = 0, $art_czfvvcxz$art_c = checkboxes.length; $art_iylsakfxg$art_i < $art_czfvvcxz$art_c; $art_iylsakfxg$art_i++) {    var c = checkboxes[$art_iylsakfxg$art_i]%>';
    for (var $art_iylsakfxg$art_i = 0, $art_czfvvcxz$art_c = checkboxes.length; $art_iylsakfxg$art_i < $art_czfvvcxz$art_c; $art_iylsakfxg$art_i++) {
        var c = checkboxes[$art_iylsakfxg$art_i];
