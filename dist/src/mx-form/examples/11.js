...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijxznqca$art_i = 0, $art_cbfjxlovv$art_c = checkboxes.length; $art_ijxznqca$art_i < $art_cbfjxlovv$art_c; $art_ijxznqca$art_i++) {    var c = checkboxes[$art_ijxznqca$art_i]%>';
    for (var $art_ijxznqca$art_i = 0, $art_cbfjxlovv$art_c = checkboxes.length; $art_ijxznqca$art_i < $art_cbfjxlovv$art_c; $art_ijxznqca$art_i++) {
        var c = checkboxes[$art_ijxznqca$art_i];
