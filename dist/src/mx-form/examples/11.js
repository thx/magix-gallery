...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iymslnsj$art_i = 0, $art_crsbhwipc$art_c = checkboxes.length; $art_iymslnsj$art_i < $art_crsbhwipc$art_c; $art_iymslnsj$art_i++) {    var c = checkboxes[$art_iymslnsj$art_i]%>';
    for (var $art_iymslnsj$art_i = 0, $art_crsbhwipc$art_c = checkboxes.length; $art_iymslnsj$art_i < $art_crsbhwipc$art_c; $art_iymslnsj$art_i++) {
        var c = checkboxes[$art_iymslnsj$art_i];
