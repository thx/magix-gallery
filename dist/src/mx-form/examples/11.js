...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijuyxwau$art_i = 0, $art_crrdatpfjar$art_c = checkboxes.length; $art_ijuyxwau$art_i < $art_crrdatpfjar$art_c; $art_ijuyxwau$art_i++) {    var c = checkboxes[$art_ijuyxwau$art_i]%>';
    for (var $art_ijuyxwau$art_i = 0, $art_crrdatpfjar$art_c = checkboxes.length; $art_ijuyxwau$art_i < $art_crrdatpfjar$art_c; $art_ijuyxwau$art_i++) {
        var c = checkboxes[$art_ijuyxwau$art_i];
