...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igaegik$art_i = 0, $art_czbepwpdyp$art_c = checkboxes.length; $art_igaegik$art_i < $art_czbepwpdyp$art_c; $art_igaegik$art_i++) {    var c = checkboxes[$art_igaegik$art_i]%>';
    for (var $art_igaegik$art_i = 0, $art_czbepwpdyp$art_c = checkboxes.length; $art_igaegik$art_i < $art_czbepwpdyp$art_c; $art_igaegik$art_i++) {
        var c = checkboxes[$art_igaegik$art_i];
