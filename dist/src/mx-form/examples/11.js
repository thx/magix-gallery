...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iowaoezaae$art_i = 0, $art_csqqiozmtm$art_c = checkboxes.length; $art_iowaoezaae$art_i < $art_csqqiozmtm$art_c; $art_iowaoezaae$art_i++) {    var c = checkboxes[$art_iowaoezaae$art_i]%>';
    for (var $art_iowaoezaae$art_i = 0, $art_csqqiozmtm$art_c = checkboxes.length; $art_iowaoezaae$art_i < $art_csqqiozmtm$art_c; $art_iowaoezaae$art_i++) {
        var c = checkboxes[$art_iowaoezaae$art_i];
