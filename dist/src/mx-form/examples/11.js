...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaiuybqat$art_i = 0, $art_cpctqjpjqmb$art_c = checkboxes.length; $art_iaiuybqat$art_i < $art_cpctqjpjqmb$art_c; $art_iaiuybqat$art_i++) {    var c = checkboxes[$art_iaiuybqat$art_i]%>';
    for (var $art_iaiuybqat$art_i = 0, $art_cpctqjpjqmb$art_c = checkboxes.length; $art_iaiuybqat$art_i < $art_cpctqjpjqmb$art_c; $art_iaiuybqat$art_i++) {
        var c = checkboxes[$art_iaiuybqat$art_i];
