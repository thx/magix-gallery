...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iodiehpuk$art_i = 0, $art_cuefvgho$art_c = checkboxes.length; $art_iodiehpuk$art_i < $art_cuefvgho$art_c; $art_iodiehpuk$art_i++) {    var c = checkboxes[$art_iodiehpuk$art_i]%>';
    for (var $art_iodiehpuk$art_i = 0, $art_cuefvgho$art_c = checkboxes.length; $art_iodiehpuk$art_i < $art_cuefvgho$art_c; $art_iodiehpuk$art_i++) {
        var c = checkboxes[$art_iodiehpuk$art_i];
