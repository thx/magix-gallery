...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iimafxibbn$art_i = 0, $art_cjhseyaq$art_c = checkboxes.length; $art_iimafxibbn$art_i < $art_cjhseyaq$art_c; $art_iimafxibbn$art_i++) {    var c = checkboxes[$art_iimafxibbn$art_i]%>';
    for (var $art_iimafxibbn$art_i = 0, $art_cjhseyaq$art_c = checkboxes.length; $art_iimafxibbn$art_i < $art_cjhseyaq$art_c; $art_iimafxibbn$art_i++) {
        var c = checkboxes[$art_iimafxibbn$art_i];
