...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycf:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_gallerycf:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxv mxa="_zs_gallerycf:b" class="mb20"><span mxs="_zs_gallerycf:_" class="color-9 mr20">checkbox至少选择一个：</span>';
    $line = 5;
    $art = 'each checkboxes as c';
    ;
    $expr = '<%for (var $art_iunyneddk$art_i = 0, $art_ctvsdvnhw$art_c = checkboxes.length; $art_iunyneddk$art_i < $art_ctvsdvnhw$art_c; $art_iunyneddk$art_i++) {    var c = checkboxes[$art_iunyneddk$art_i]%>';
    for (var $art_iunyneddk$art_i = 0, $art_ctvsdvnhw$art_c = checkboxes.length; $art_iunyneddk$art_i < $art_ctvsdvnhw$art_c; $art_iunyneddk$art_i++) {
        var c = checkboxes[$art_iunyneddk$art_i];
        $p += '<label mxv mxa="_zs_gallerycf:c" class="mr30"><input mxe="' + $viewId + '_0" mxc="[';
        $line = 8;
