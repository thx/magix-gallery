...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivlcmlok$art_i = 0, $art_chpkkosb$art_c = checkboxes.length; $art_ivlcmlok$art_i < $art_chpkkosb$art_c; $art_ivlcmlok$art_i++) {    var c = checkboxes[$art_ivlcmlok$art_i]%>';
    for (var $art_ivlcmlok$art_i = 0, $art_chpkkosb$art_c = checkboxes.length; $art_ivlcmlok$art_i < $art_chpkkosb$art_c; $art_ivlcmlok$art_i++) {
        var c = checkboxes[$art_ivlcmlok$art_i];
