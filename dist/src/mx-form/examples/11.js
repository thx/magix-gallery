...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imwznad$art_i = 0, $art_cacttzxsf$art_c = checkboxes.length; $art_imwznad$art_i < $art_cacttzxsf$art_c; $art_imwznad$art_i++) {    var c = checkboxes[$art_imwznad$art_i]%>';
    for (var $art_imwznad$art_i = 0, $art_cacttzxsf$art_c = checkboxes.length; $art_imwznad$art_i < $art_cacttzxsf$art_c; $art_imwznad$art_i++) {
        var c = checkboxes[$art_imwznad$art_i];
