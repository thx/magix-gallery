...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikfhpkk$art_i = 0, $art_cyamovbl$art_c = checkboxes.length; $art_ikfhpkk$art_i < $art_cyamovbl$art_c; $art_ikfhpkk$art_i++) {    var c = checkboxes[$art_ikfhpkk$art_i]%>';
    for (var $art_ikfhpkk$art_i = 0, $art_cyamovbl$art_c = checkboxes.length; $art_ikfhpkk$art_i < $art_cyamovbl$art_c; $art_ikfhpkk$art_i++) {
        var c = checkboxes[$art_ikfhpkk$art_i];
