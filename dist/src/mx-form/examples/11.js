...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifntgbrh$art_i = 0, $art_cytzvic$art_c = checkboxes.length; $art_ifntgbrh$art_i < $art_cytzvic$art_c; $art_ifntgbrh$art_i++) {    var c = checkboxes[$art_ifntgbrh$art_i]%>';
    for (var $art_ifntgbrh$art_i = 0, $art_cytzvic$art_c = checkboxes.length; $art_ifntgbrh$art_i < $art_cytzvic$art_c; $art_ifntgbrh$art_i++) {
        var c = checkboxes[$art_ifntgbrh$art_i];
