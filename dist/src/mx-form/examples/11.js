...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuhfldcpd$art_i = 0, $art_cprkthtlh$art_c = checkboxes.length; $art_iuhfldcpd$art_i < $art_cprkthtlh$art_c; $art_iuhfldcpd$art_i++) {    var c = checkboxes[$art_iuhfldcpd$art_i]%>';
    for (var $art_iuhfldcpd$art_i = 0, $art_cprkthtlh$art_c = checkboxes.length; $art_iuhfldcpd$art_i < $art_cprkthtlh$art_c; $art_iuhfldcpd$art_i++) {
        var c = checkboxes[$art_iuhfldcpd$art_i];
