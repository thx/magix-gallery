...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ishjqmtuem$art_i = 0, $art_cjuiygqmzi$art_c = checkboxes.length; $art_ishjqmtuem$art_i < $art_cjuiygqmzi$art_c; $art_ishjqmtuem$art_i++) {    var c = checkboxes[$art_ishjqmtuem$art_i]%>';
    for (var $art_ishjqmtuem$art_i = 0, $art_cjuiygqmzi$art_c = checkboxes.length; $art_ishjqmtuem$art_i < $art_cjuiygqmzi$art_c; $art_ishjqmtuem$art_i++) {
        var c = checkboxes[$art_ishjqmtuem$art_i];
