...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibjxsmuvl$art_i = 0, $art_cuiqaatp$art_c = checkboxes.length; $art_ibjxsmuvl$art_i < $art_cuiqaatp$art_c; $art_ibjxsmuvl$art_i++) {    var c = checkboxes[$art_ibjxsmuvl$art_i]%>';
    for (var $art_ibjxsmuvl$art_i = 0, $art_cuiqaatp$art_c = checkboxes.length; $art_ibjxsmuvl$art_i < $art_cuiqaatp$art_c; $art_ibjxsmuvl$art_i++) {
        var c = checkboxes[$art_ibjxsmuvl$art_i];
