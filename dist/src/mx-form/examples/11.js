...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifhrzow$art_i = 0, $art_cdrjtwxn$art_c = checkboxes.length; $art_ifhrzow$art_i < $art_cdrjtwxn$art_c; $art_ifhrzow$art_i++) {    var c = checkboxes[$art_ifhrzow$art_i]%>';
    for (var $art_ifhrzow$art_i = 0, $art_cdrjtwxn$art_c = checkboxes.length; $art_ifhrzow$art_i < $art_cdrjtwxn$art_c; $art_ifhrzow$art_i++) {
        var c = checkboxes[$art_ifhrzow$art_i];
