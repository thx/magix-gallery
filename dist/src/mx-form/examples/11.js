...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_issntfuaufa$art_i = 0, $art_cdtzwlrgc$art_c = checkboxes.length; $art_issntfuaufa$art_i < $art_cdtzwlrgc$art_c; $art_issntfuaufa$art_i++) {    var c = checkboxes[$art_issntfuaufa$art_i]%>';
    for (var $art_issntfuaufa$art_i = 0, $art_cdtzwlrgc$art_c = checkboxes.length; $art_issntfuaufa$art_i < $art_cdtzwlrgc$art_c; $art_issntfuaufa$art_i++) {
        var c = checkboxes[$art_issntfuaufa$art_i];
