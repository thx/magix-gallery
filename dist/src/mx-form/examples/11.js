...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikedch$art_i = 0, $art_cumrqqugvk$art_c = checkboxes.length; $art_ikedch$art_i < $art_cumrqqugvk$art_c; $art_ikedch$art_i++) {    var c = checkboxes[$art_ikedch$art_i]%>';
    for (var $art_ikedch$art_i = 0, $art_cumrqqugvk$art_c = checkboxes.length; $art_ikedch$art_i < $art_cumrqqugvk$art_c; $art_ikedch$art_i++) {
        var c = checkboxes[$art_ikedch$art_i];
