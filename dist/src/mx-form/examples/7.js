...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycw:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_gallerycw:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxv mxa="_zs_gallerycw:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':number{rangeborder:[4, 8, \'自定义提示：4~8中间的数字，不包含4和8\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerycw:c" class="clearfix"><input mxe="' + $viewId + '_4" mxc="[';
    $line = 10;
    $art = ':number{min:20}';
    ;
    ...
    $art = ':number{minborder:[20, \'自定义提示：大于20\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerycw:d" class="clearfix"><input mxe="' + $viewId + '_8" mxc="[';
    $line = 16;
    $art = ':number{max:30}';
    ;
    ...
    $art = ':number{maxborder:[30, \'自定义提示：小于30\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div></div><div mxa="_zs_gallerycw:e" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_gallerycw:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">数字范围</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 24;
    $art = '=viewId';
    ;
