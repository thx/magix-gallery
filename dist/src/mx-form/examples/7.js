...
module.exports = Base.extend({
    ...
    $art = ':number{rangeborder:[4, 8, \'自定义提示：4~8中间的数字，不包含4和8\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerycB:c" class="clearfix"><input mxe="' + $viewId + '_4" mxc="[';
    $line = 10;
    $art = ':number{min:20}';
    ;
    ...
    $art = ':number{minborder:[20, \'自定义提示：大于20\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerycB:d" class="clearfix"><input mxe="' + $viewId + '_8" mxc="[';
    $line = 16;
    $art = ':number{max:30}';
    ;
