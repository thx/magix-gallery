...
module.exports = Base.extend({
    ...
    $art = ':number{range:[4, 8, \'自定义提示：4~8中间的数字\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerycg:c" class="clearfix"><input mxe="' + $viewId + '_2" mxc="[';
    $line = 8;
    $art = ':number{min:20}';
    ;
    ...
    $art = ':number{min:[20, \'自定义提示：数字不能小于20\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerycg:d" class="clearfix"><input mxe="' + $viewId + '_4" mxc="[';
    $line = 12;
    $art = ':number{max:30}';
    ;
