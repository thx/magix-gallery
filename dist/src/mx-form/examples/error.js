...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryco:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryco:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content clearfix"><div mxs="_zs_galleryco:_" class="mb20 clearfix"><div class="fl color-9">异常情况复现：</div><div class="fl"><div>父子view分别存在校验逻辑</div><div>子view的以父view的id为前缀加下划线进行命名，如果 &#123;&#123;=viewId&#125;&#125;_inner 这种</div><div>子view双向绑定radio或者checkbox，并且挂载在data上数据为对象 info: &#123;age: 1&#125;</div></div></div><div mxs="_zs_galleryco:a" class="mb20 clearfix"><div class="fl color-9">异常原因说明：</div><div class="fl"><div>关于radio和checkbox的双向绑定，组件获取当前view中input[mxe="本viewid开头"]进行处理</div><div>复现情况中的子view id和magix本身处理mxe属性的规则一致，则父view处理时也获取到了子view的节点</div><div>由于子view的数据挂在info对象上，而父view上没有info对象</div></div></div><div mxs="_zs_galleryco:b" class="mb20 clearfix"><div class="fl color-9">解决方案说明：</div><div class="fl">组件已兼容该情况</div></div><form mxv mxa="_zs_galleryco:b" class="form form-4 mb20"><div mxv mxa="_zs_galleryco:c" class="form-item"><div mxs="_zs_galleryco:c" class="form-label">姓名</div><div mxv mxa="_zs_galleryco:d" class="form-content"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 29;
