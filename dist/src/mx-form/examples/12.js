...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerych:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_gallerych:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxv mxa="_zs_gallerych:b" class="mb20"><span mxs="_zs_gallerych:_" class="color-9 mr20">radio：</span>';
    $line = 5;
    $art = 'each radioes as r';
    ;
    $expr = '<%for (var $art_ijsdzcwjaym$art_i = 0, $art_cguxbqh$art_c = radioes.length; $art_ijsdzcwjaym$art_i < $art_cguxbqh$art_c; $art_ijsdzcwjaym$art_i++) {    var r = radioes[$art_ijsdzcwjaym$art_i]%>';
    for (var $art_ijsdzcwjaym$art_i = 0, $art_cguxbqh$art_c = radioes.length; $art_ijsdzcwjaym$art_i < $art_cguxbqh$art_c; $art_ijsdzcwjaym$art_i++) {
        var r = radioes[$art_ijsdzcwjaym$art_i];
