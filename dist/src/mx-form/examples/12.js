...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iclnld$art_i = 0, $art_cekhuxdvpke$art_c = radioes.length; $art_iclnld$art_i < $art_cekhuxdvpke$art_c; $art_iclnld$art_i++) {    var r = radioes[$art_iclnld$art_i]%>';
    for (var $art_iclnld$art_i = 0, $art_cekhuxdvpke$art_c = radioes.length; $art_iclnld$art_i < $art_cekhuxdvpke$art_c; $art_iclnld$art_i++) {
        var r = radioes[$art_iclnld$art_i];
