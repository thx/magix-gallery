...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibtbcvigx$art_i = 0, $art_culqzkenl$art_c = radioes.length; $art_ibtbcvigx$art_i < $art_culqzkenl$art_c; $art_ibtbcvigx$art_i++) {    var r = radioes[$art_ibtbcvigx$art_i]%>';
    for (var $art_ibtbcvigx$art_i = 0, $art_culqzkenl$art_c = radioes.length; $art_ibtbcvigx$art_i < $art_culqzkenl$art_c; $art_ibtbcvigx$art_i++) {
        var r = radioes[$art_ibtbcvigx$art_i];
