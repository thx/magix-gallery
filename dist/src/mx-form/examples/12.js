...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izmptpjtf$art_i = 0, $art_cjcqadbyr$art_c = radioes.length; $art_izmptpjtf$art_i < $art_cjcqadbyr$art_c; $art_izmptpjtf$art_i++) {    var r = radioes[$art_izmptpjtf$art_i]%>';
    for (var $art_izmptpjtf$art_i = 0, $art_cjcqadbyr$art_c = radioes.length; $art_izmptpjtf$art_i < $art_cjcqadbyr$art_c; $art_izmptpjtf$art_i++) {
        var r = radioes[$art_izmptpjtf$art_i];
