...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycn:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_gallerycn:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxv mxa="_zs_gallerycn:b" class="mb20"><span mxs="_zs_gallerycn:_" class="color-9 mr20">radio：</span>';
    $line = 5;
    $art = 'each radioes as r';
    ;
    $expr = '<%for (var $art_ioqugnvbll$art_i = 0, $art_cxhpmusoo$art_c = radioes.length; $art_ioqugnvbll$art_i < $art_cxhpmusoo$art_c; $art_ioqugnvbll$art_i++) {    var r = radioes[$art_ioqugnvbll$art_i]%>';
    for (var $art_ioqugnvbll$art_i = 0, $art_cxhpmusoo$art_c = radioes.length; $art_ioqugnvbll$art_i < $art_cxhpmusoo$art_c; $art_ioqugnvbll$art_i++) {
        var r = radioes[$art_ioqugnvbll$art_i];
