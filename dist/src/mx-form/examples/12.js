...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipnxgocs$art_i = 0, $art_cqdcirnwel$art_c = radioes.length; $art_ipnxgocs$art_i < $art_cqdcirnwel$art_c; $art_ipnxgocs$art_i++) {    var r = radioes[$art_ipnxgocs$art_i]%>';
    for (var $art_ipnxgocs$art_i = 0, $art_cqdcirnwel$art_c = radioes.length; $art_ipnxgocs$art_i < $art_cqdcirnwel$art_c; $art_ipnxgocs$art_i++) {
        var r = radioes[$art_ipnxgocs$art_i];
