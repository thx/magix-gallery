...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_innapim$art_i = 0, $art_czzbqfqbrnc$art_c = radioes.length; $art_innapim$art_i < $art_czzbqfqbrnc$art_c; $art_innapim$art_i++) {    var r = radioes[$art_innapim$art_i]%>';
    for (var $art_innapim$art_i = 0, $art_czzbqfqbrnc$art_c = radioes.length; $art_innapim$art_i < $art_czzbqfqbrnc$art_c; $art_innapim$art_i++) {
        var r = radioes[$art_innapim$art_i];
