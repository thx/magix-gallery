...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iiqgplgydk$art_i = 0, $art_cgwtcybmom$art_c = radioes.length; $art_iiqgplgydk$art_i < $art_cgwtcybmom$art_c; $art_iiqgplgydk$art_i++) {    var r = radioes[$art_iiqgplgydk$art_i]%>';
    for (var $art_iiqgplgydk$art_i = 0, $art_cgwtcybmom$art_c = radioes.length; $art_iiqgplgydk$art_i < $art_cgwtcybmom$art_c; $art_iiqgplgydk$art_i++) {
        var r = radioes[$art_iiqgplgydk$art_i];
