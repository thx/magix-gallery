...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iijugarwtj$art_i = 0, $art_cmavsestidp$art_c = radioes.length; $art_iijugarwtj$art_i < $art_cmavsestidp$art_c; $art_iijugarwtj$art_i++) {    var r = radioes[$art_iijugarwtj$art_i]%>';
    for (var $art_iijugarwtj$art_i = 0, $art_cmavsestidp$art_c = radioes.length; $art_iijugarwtj$art_i < $art_cmavsestidp$art_c; $art_iijugarwtj$art_i++) {
        var r = radioes[$art_iijugarwtj$art_i];
