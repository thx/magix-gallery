...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihisnrsipoig$art_i = 0, $art_cccrhqwjce$art_c = radioes.length; $art_ihisnrsipoig$art_i < $art_cccrhqwjce$art_c; $art_ihisnrsipoig$art_i++) {    var r = radioes[$art_ihisnrsipoig$art_i]%>';
    for (var $art_ihisnrsipoig$art_i = 0, $art_cccrhqwjce$art_c = radioes.length; $art_ihisnrsipoig$art_i < $art_cccrhqwjce$art_c; $art_ihisnrsipoig$art_i++) {
        var r = radioes[$art_ihisnrsipoig$art_i];
