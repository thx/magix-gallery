...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikavfqnsj$art_i = 0, $art_cwbprsawj$art_c = radioes.length; $art_ikavfqnsj$art_i < $art_cwbprsawj$art_c; $art_ikavfqnsj$art_i++) {    var r = radioes[$art_ikavfqnsj$art_i]%>';
    for (var $art_ikavfqnsj$art_i = 0, $art_cwbprsawj$art_c = radioes.length; $art_ikavfqnsj$art_i < $art_cwbprsawj$art_c; $art_ikavfqnsj$art_i++) {
        var r = radioes[$art_ikavfqnsj$art_i];
