...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idzbruenom$art_i = 0, $art_cbnsunhfa$art_c = radioes.length; $art_idzbruenom$art_i < $art_cbnsunhfa$art_c; $art_idzbruenom$art_i++) {    var r = radioes[$art_idzbruenom$art_i]%>';
    for (var $art_idzbruenom$art_i = 0, $art_cbnsunhfa$art_c = radioes.length; $art_idzbruenom$art_i < $art_cbnsunhfa$art_c; $art_idzbruenom$art_i++) {
        var r = radioes[$art_idzbruenom$art_i];
