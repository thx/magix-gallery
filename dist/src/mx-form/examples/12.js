...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izxzkokqp$art_i = 0, $art_cqayfzwwn$art_c = radioes.length; $art_izxzkokqp$art_i < $art_cqayfzwwn$art_c; $art_izxzkokqp$art_i++) {    var r = radioes[$art_izxzkokqp$art_i]%>';
    for (var $art_izxzkokqp$art_i = 0, $art_cqayfzwwn$art_c = radioes.length; $art_izxzkokqp$art_i < $art_cqayfzwwn$art_c; $art_izxzkokqp$art_i++) {
        var r = radioes[$art_izxzkokqp$art_i];
