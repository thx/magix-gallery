...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivaalbqbu$art_i = 0, $art_crivoslm$art_c = radioes.length; $art_ivaalbqbu$art_i < $art_crivoslm$art_c; $art_ivaalbqbu$art_i++) {    var r = radioes[$art_ivaalbqbu$art_i]%>';
    for (var $art_ivaalbqbu$art_i = 0, $art_crivoslm$art_c = radioes.length; $art_ivaalbqbu$art_i < $art_crivoslm$art_c; $art_ivaalbqbu$art_i++) {
        var r = radioes[$art_ivaalbqbu$art_i];
