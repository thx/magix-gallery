...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwwvqar$art_i = 0, $art_cmlkfvxztd$art_c = radioes.length; $art_iwwvqar$art_i < $art_cmlkfvxztd$art_c; $art_iwwvqar$art_i++) {    var r = radioes[$art_iwwvqar$art_i]%>';
    for (var $art_iwwvqar$art_i = 0, $art_cmlkfvxztd$art_c = radioes.length; $art_iwwvqar$art_i < $art_cmlkfvxztd$art_c; $art_iwwvqar$art_i++) {
        var r = radioes[$art_iwwvqar$art_i];
