...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irhyxagys$art_i = 0, $art_cmfhywshd$art_c = radioes.length; $art_irhyxagys$art_i < $art_cmfhywshd$art_c; $art_irhyxagys$art_i++) {    var r = radioes[$art_irhyxagys$art_i]%>';
    for (var $art_irhyxagys$art_i = 0, $art_cmfhywshd$art_c = radioes.length; $art_irhyxagys$art_i < $art_cmfhywshd$art_c; $art_irhyxagys$art_i++) {
        var r = radioes[$art_irhyxagys$art_i];
