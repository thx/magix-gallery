...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuojyotlqa$art_i = 0, $art_cjfyvg$art_c = radioes.length; $art_iuojyotlqa$art_i < $art_cjfyvg$art_c; $art_iuojyotlqa$art_i++) {    var r = radioes[$art_iuojyotlqa$art_i]%>';
    for (var $art_iuojyotlqa$art_i = 0, $art_cjfyvg$art_c = radioes.length; $art_iuojyotlqa$art_i < $art_cjfyvg$art_c; $art_iuojyotlqa$art_i++) {
        var r = radioes[$art_iuojyotlqa$art_i];
