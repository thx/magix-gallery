...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igssov$art_i = 0, $art_cmlpoxc$art_c = radioes.length; $art_igssov$art_i < $art_cmlpoxc$art_c; $art_igssov$art_i++) {    var r = radioes[$art_igssov$art_i]%>';
    for (var $art_igssov$art_i = 0, $art_cmlpoxc$art_c = radioes.length; $art_igssov$art_i < $art_cmlpoxc$art_c; $art_igssov$art_i++) {
        var r = radioes[$art_igssov$art_i];
