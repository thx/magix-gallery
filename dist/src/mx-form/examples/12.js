...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izaquiuv$art_i = 0, $art_cozrpvys$art_c = radioes.length; $art_izaquiuv$art_i < $art_cozrpvys$art_c; $art_izaquiuv$art_i++) {    var r = radioes[$art_izaquiuv$art_i]%>';
    for (var $art_izaquiuv$art_i = 0, $art_cozrpvys$art_c = radioes.length; $art_izaquiuv$art_i < $art_cozrpvys$art_c; $art_izaquiuv$art_i++) {
        var r = radioes[$art_izaquiuv$art_i];
