...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixsgnnou$art_i = 0, $art_cymgcwsyrn$art_c = radioes.length; $art_ixsgnnou$art_i < $art_cymgcwsyrn$art_c; $art_ixsgnnou$art_i++) {    var r = radioes[$art_ixsgnnou$art_i]%>';
    for (var $art_ixsgnnou$art_i = 0, $art_cymgcwsyrn$art_c = radioes.length; $art_ixsgnnou$art_i < $art_cymgcwsyrn$art_c; $art_ixsgnnou$art_i++) {
        var r = radioes[$art_ixsgnnou$art_i];
