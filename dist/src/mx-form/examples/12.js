...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijwxypylt$art_i = 0, $art_cgxzgnmjh$art_c = radioes.length; $art_ijwxypylt$art_i < $art_cgxzgnmjh$art_c; $art_ijwxypylt$art_i++) {    var r = radioes[$art_ijwxypylt$art_i]%>';
    for (var $art_ijwxypylt$art_i = 0, $art_cgxzgnmjh$art_c = radioes.length; $art_ijwxypylt$art_i < $art_cgxzgnmjh$art_c; $art_ijwxypylt$art_i++) {
        var r = radioes[$art_ijwxypylt$art_i];
