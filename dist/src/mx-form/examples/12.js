...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itdhbi$art_i = 0, $art_ceqnalrjfs$art_c = radioes.length; $art_itdhbi$art_i < $art_ceqnalrjfs$art_c; $art_itdhbi$art_i++) {    var r = radioes[$art_itdhbi$art_i]%>';
    for (var $art_itdhbi$art_i = 0, $art_ceqnalrjfs$art_c = radioes.length; $art_itdhbi$art_i < $art_ceqnalrjfs$art_c; $art_itdhbi$art_i++) {
        var r = radioes[$art_itdhbi$art_i];
