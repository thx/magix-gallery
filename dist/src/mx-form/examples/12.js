...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifjjmjng$art_i = 0, $art_coiihwpfza$art_c = radioes.length; $art_ifjjmjng$art_i < $art_coiihwpfza$art_c; $art_ifjjmjng$art_i++) {    var r = radioes[$art_ifjjmjng$art_i]%>';
    for (var $art_ifjjmjng$art_i = 0, $art_coiihwpfza$art_c = radioes.length; $art_ifjjmjng$art_i < $art_coiihwpfza$art_c; $art_ifjjmjng$art_i++) {
        var r = radioes[$art_ifjjmjng$art_i];
