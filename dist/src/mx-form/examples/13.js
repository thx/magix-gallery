...
module.exports = Base.extend({
    ...
    $art = ':day{required:true}';
    ;
    $p += ($expr = '<%@day%>', $i($$ref, day)) + '"><i mxs="_zs_galleryco:a" value="1" class="none">1</i><i mxs="_zs_galleryco:b" value="2" class="none">2</i></div></div></div><div mxa="_zs_galleryco:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryco:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
