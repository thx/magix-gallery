...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivcbhjxokod$art_i = 0, $art_cvkcwbsj$art_c = list.length; $art_ivcbhjxokod$art_i < $art_cvkcwbsj$art_c; $art_ivcbhjxokod$art_i++) {    var item = list[$art_ivcbhjxokod$art_i]%>';
    for (var $art_ivcbhjxokod$art_i = 0, $art_cvkcwbsj$art_c = list.length; $art_ivcbhjxokod$art_i < $art_cvkcwbsj$art_c; $art_ivcbhjxokod$art_i++) {
        var item = list[$art_ivcbhjxokod$art_i];
        $p += '<div class="_zs_gallery_mx-preview___test___index_-demo" mx-view="mx-preview/index?type=image&url=';
        $line = 5;
        $art = '=item';
        ;
