...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiblofltbh$art_i = 0, $art_cqjmqpkuadc$art_c = list.length; $art_iiblofltbh$art_i < $art_cqjmqpkuadc$art_c; $art_iiblofltbh$art_i++) {    var item = list[$art_iiblofltbh$art_i]%>';
    for (var $art_iiblofltbh$art_i = 0, $art_cqjmqpkuadc$art_c = list.length; $art_iiblofltbh$art_i < $art_cqjmqpkuadc$art_c; $art_iiblofltbh$art_i++) {
        var item = list[$art_iiblofltbh$art_i];
