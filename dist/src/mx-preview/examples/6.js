...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipusaks$art_i = 0, $art_cyqjfgiri$art_c = list.length; $art_ipusaks$art_i < $art_cyqjfgiri$art_c; $art_ipusaks$art_i++) {    var item = list[$art_ipusaks$art_i]%>';
    for (var $art_ipusaks$art_i = 0, $art_cyqjfgiri$art_c = list.length; $art_ipusaks$art_i < $art_cyqjfgiri$art_c; $art_ipusaks$art_i++) {
        var item = list[$art_ipusaks$art_i];
