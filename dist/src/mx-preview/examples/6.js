...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikdgrovie$art_i = 0, $art_cjvqfkeqc$art_c = list.length; $art_ikdgrovie$art_i < $art_cjvqfkeqc$art_c; $art_ikdgrovie$art_i++) {    var item = list[$art_ikdgrovie$art_i]%>';
    for (var $art_ikdgrovie$art_i = 0, $art_cjvqfkeqc$art_c = list.length; $art_ikdgrovie$art_i < $art_cjvqfkeqc$art_c; $art_ikdgrovie$art_i++) {
        var item = list[$art_ikdgrovie$art_i];
