...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivivqqxoqzh$art_i = 0, $art_crlcromi$art_c = list.length; $art_ivivqqxoqzh$art_i < $art_crlcromi$art_c; $art_ivivqqxoqzh$art_i++) {    var item = list[$art_ivivqqxoqzh$art_i]%>';
    for (var $art_ivivqqxoqzh$art_i = 0, $art_crlcromi$art_c = list.length; $art_ivivqqxoqzh$art_i < $art_crlcromi$art_c; $art_ivivqqxoqzh$art_i++) {
        var item = list[$art_ivivqqxoqzh$art_i];
