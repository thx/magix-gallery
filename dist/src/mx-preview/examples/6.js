...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuzui$art_i = 0, $art_chhbctn$art_c = list.length; $art_iuzui$art_i < $art_chhbctn$art_c; $art_iuzui$art_i++) {    var item = list[$art_iuzui$art_i]%>';
    for (var $art_iuzui$art_i = 0, $art_chhbctn$art_c = list.length; $art_iuzui$art_i < $art_chhbctn$art_c; $art_iuzui$art_i++) {
        var item = list[$art_iuzui$art_i];
