...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iljiswhq$art_i = 0, $art_cltvteoys$art_c = list.length; $art_iljiswhq$art_i < $art_cltvteoys$art_c; $art_iljiswhq$art_i++) {    var item = list[$art_iljiswhq$art_i]%>';
    for (var $art_iljiswhq$art_i = 0, $art_cltvteoys$art_c = list.length; $art_iljiswhq$art_i < $art_cltvteoys$art_c; $art_iljiswhq$art_i++) {
        var item = list[$art_iljiswhq$art_i];
