...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihgeeupzzw$art_i = 0, $art_cyhsrvc$art_c = list.length; $art_ihgeeupzzw$art_i < $art_cyhsrvc$art_c; $art_ihgeeupzzw$art_i++) {    var item = list[$art_ihgeeupzzw$art_i]%>';
    for (var $art_ihgeeupzzw$art_i = 0, $art_cyhsrvc$art_c = list.length; $art_ihgeeupzzw$art_i < $art_cyhsrvc$art_c; $art_ihgeeupzzw$art_i++) {
        var item = list[$art_ihgeeupzzw$art_i];
