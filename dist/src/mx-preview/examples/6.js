...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izvnliwxxc$art_i = 0, $art_chmsxglobwg$art_c = list.length; $art_izvnliwxxc$art_i < $art_chmsxglobwg$art_c; $art_izvnliwxxc$art_i++) {    var item = list[$art_izvnliwxxc$art_i]%>';
    for (var $art_izvnliwxxc$art_i = 0, $art_chmsxglobwg$art_c = list.length; $art_izvnliwxxc$art_i < $art_chmsxglobwg$art_c; $art_izvnliwxxc$art_i++) {
        var item = list[$art_izvnliwxxc$art_i];
