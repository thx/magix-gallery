...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irkvzd$art_i = 0, $art_ciojlsmqpb$art_c = list.length; $art_irkvzd$art_i < $art_ciojlsmqpb$art_c; $art_irkvzd$art_i++) {    var item = list[$art_irkvzd$art_i]%>';
    for (var $art_irkvzd$art_i = 0, $art_ciojlsmqpb$art_c = list.length; $art_irkvzd$art_i < $art_ciojlsmqpb$art_c; $art_irkvzd$art_i++) {
        var item = list[$art_irkvzd$art_i];
