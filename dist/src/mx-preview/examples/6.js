...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuccok$art_i = 0, $art_cyxjzg$art_c = list.length; $art_iuccok$art_i < $art_cyxjzg$art_c; $art_iuccok$art_i++) {    var item = list[$art_iuccok$art_i]%>';
    for (var $art_iuccok$art_i = 0, $art_cyxjzg$art_c = list.length; $art_iuccok$art_i < $art_cyxjzg$art_c; $art_iuccok$art_i++) {
        var item = list[$art_iuccok$art_i];
