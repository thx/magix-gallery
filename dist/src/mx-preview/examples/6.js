...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijvmocyfhe$art_i = 0, $art_cabduzyiet$art_c = list.length; $art_ijvmocyfhe$art_i < $art_cabduzyiet$art_c; $art_ijvmocyfhe$art_i++) {    var item = list[$art_ijvmocyfhe$art_i]%>';
    for (var $art_ijvmocyfhe$art_i = 0, $art_cabduzyiet$art_c = list.length; $art_ijvmocyfhe$art_i < $art_cabduzyiet$art_c; $art_ijvmocyfhe$art_i++) {
        var item = list[$art_ijvmocyfhe$art_i];
