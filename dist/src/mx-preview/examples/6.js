...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihycvkpdg$art_i = 0, $art_cdkmghgnru$art_c = list.length; $art_ihycvkpdg$art_i < $art_cdkmghgnru$art_c; $art_ihycvkpdg$art_i++) {    var item = list[$art_ihycvkpdg$art_i]%>';
    for (var $art_ihycvkpdg$art_i = 0, $art_cdkmghgnru$art_c = list.length; $art_ihycvkpdg$art_i < $art_cdkmghgnru$art_c; $art_ihycvkpdg$art_i++) {
        var item = list[$art_ihycvkpdg$art_i];
