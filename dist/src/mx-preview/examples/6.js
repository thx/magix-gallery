...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivrdmofhgea$art_i = 0, $art_csntnab$art_c = list.length; $art_ivrdmofhgea$art_i < $art_csntnab$art_c; $art_ivrdmofhgea$art_i++) {    var item = list[$art_ivrdmofhgea$art_i]%>';
    for (var $art_ivrdmofhgea$art_i = 0, $art_csntnab$art_c = list.length; $art_ivrdmofhgea$art_i < $art_csntnab$art_c; $art_ivrdmofhgea$art_i++) {
        var item = list[$art_ivrdmofhgea$art_i];
