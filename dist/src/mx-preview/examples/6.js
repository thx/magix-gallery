...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuxhkns$art_i = 0, $art_cjasaal$art_c = list.length; $art_iuxhkns$art_i < $art_cjasaal$art_c; $art_iuxhkns$art_i++) {    var item = list[$art_iuxhkns$art_i]%>';
    for (var $art_iuxhkns$art_i = 0, $art_cjasaal$art_c = list.length; $art_iuxhkns$art_i < $art_cjasaal$art_c; $art_iuxhkns$art_i++) {
        var item = list[$art_iuxhkns$art_i];
