...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iakyzuefkg$art_i = 0, $art_cgspjcf$art_c = list.length; $art_iakyzuefkg$art_i < $art_cgspjcf$art_c; $art_iakyzuefkg$art_i++) {    var item = list[$art_iakyzuefkg$art_i]%>';
    for (var $art_iakyzuefkg$art_i = 0, $art_cgspjcf$art_c = list.length; $art_iakyzuefkg$art_i < $art_cgspjcf$art_c; $art_iakyzuefkg$art_i++) {
        var item = list[$art_iakyzuefkg$art_i];
