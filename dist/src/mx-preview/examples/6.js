...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilacdcxccek$art_i = 0, $art_cfkjfje$art_c = list.length; $art_ilacdcxccek$art_i < $art_cfkjfje$art_c; $art_ilacdcxccek$art_i++) {    var item = list[$art_ilacdcxccek$art_i]%>';
    for (var $art_ilacdcxccek$art_i = 0, $art_cfkjfje$art_c = list.length; $art_ilacdcxccek$art_i < $art_cfkjfje$art_c; $art_ilacdcxccek$art_i++) {
        var item = list[$art_ilacdcxccek$art_i];
