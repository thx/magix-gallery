...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiatbmgwrq$art_i = 0, $art_ccgwyje$art_c = list.length; $art_iiatbmgwrq$art_i < $art_ccgwyje$art_c; $art_iiatbmgwrq$art_i++) {    var item = list[$art_iiatbmgwrq$art_i]%>';
    for (var $art_iiatbmgwrq$art_i = 0, $art_ccgwyje$art_c = list.length; $art_iiatbmgwrq$art_i < $art_ccgwyje$art_c; $art_iiatbmgwrq$art_i++) {
        var item = list[$art_iiatbmgwrq$art_i];
