...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijibqxu$art_i = 0, $art_cajhztc$art_c = list.length; $art_ijibqxu$art_i < $art_cajhztc$art_c; $art_ijibqxu$art_i++) {    var item = list[$art_ijibqxu$art_i]%>';
    for (var $art_ijibqxu$art_i = 0, $art_cajhztc$art_c = list.length; $art_ijibqxu$art_i < $art_cajhztc$art_c; $art_ijibqxu$art_i++) {
        var item = list[$art_ijibqxu$art_i];
