...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivgeejxgka$art_i = 0, $art_cbokmkmcyv$art_c = list.length; $art_ivgeejxgka$art_i < $art_cbokmkmcyv$art_c; $art_ivgeejxgka$art_i++) {    var item = list[$art_ivgeejxgka$art_i]%>';
    for (var $art_ivgeejxgka$art_i = 0, $art_cbokmkmcyv$art_c = list.length; $art_ivgeejxgka$art_i < $art_cbokmkmcyv$art_c; $art_ivgeejxgka$art_i++) {
        var item = list[$art_ivgeejxgka$art_i];
