...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iczskka$art_i = 0, $art_cbjodasjtd$art_c = list.length; $art_iczskka$art_i < $art_cbjodasjtd$art_c; $art_iczskka$art_i++) {    var item = list[$art_iczskka$art_i]%>';
    for (var $art_iczskka$art_i = 0, $art_cbjodasjtd$art_c = list.length; $art_iczskka$art_i < $art_cbjodasjtd$art_c; $art_iczskka$art_i++) {
        var item = list[$art_iczskka$art_i];
