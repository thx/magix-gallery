...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilnncvj$art_i = 0, $art_ccbqrhazekv$art_c = list.length; $art_ilnncvj$art_i < $art_ccbqrhazekv$art_c; $art_ilnncvj$art_i++) {    var item = list[$art_ilnncvj$art_i]%>';
    for (var $art_ilnncvj$art_i = 0, $art_ccbqrhazekv$art_c = list.length; $art_ilnncvj$art_i < $art_ccbqrhazekv$art_c; $art_ilnncvj$art_i++) {
        var item = list[$art_ilnncvj$art_i];
