...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ityezvhfg$art_i = 0, $art_cpkrtgzskd$art_c = list.length; $art_ityezvhfg$art_i < $art_cpkrtgzskd$art_c; $art_ityezvhfg$art_i++) {    var item = list[$art_ityezvhfg$art_i]%>';
    for (var $art_ityezvhfg$art_i = 0, $art_cpkrtgzskd$art_c = list.length; $art_ityezvhfg$art_i < $art_cpkrtgzskd$art_c; $art_ityezvhfg$art_i++) {
        var item = list[$art_ityezvhfg$art_i];
