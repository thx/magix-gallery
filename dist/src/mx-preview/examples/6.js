...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itlrrrifdu$art_i = 0, $art_clrmhdn$art_c = list.length; $art_itlrrrifdu$art_i < $art_clrmhdn$art_c; $art_itlrrrifdu$art_i++) {    var item = list[$art_itlrrrifdu$art_i]%>';
    for (var $art_itlrrrifdu$art_i = 0, $art_clrmhdn$art_c = list.length; $art_itlrrrifdu$art_i < $art_clrmhdn$art_c; $art_itlrrrifdu$art_i++) {
        var item = list[$art_itlrrrifdu$art_i];
