...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iytsuhmtts$art_i = 0, $art_cmehoskw$art_c = list.length; $art_iytsuhmtts$art_i < $art_cmehoskw$art_c; $art_iytsuhmtts$art_i++) {    var item = list[$art_iytsuhmtts$art_i]%>';
    for (var $art_iytsuhmtts$art_i = 0, $art_cmehoskw$art_c = list.length; $art_iytsuhmtts$art_i < $art_cmehoskw$art_c; $art_iytsuhmtts$art_i++) {
        var item = list[$art_iytsuhmtts$art_i];
