...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipgmqdotv$art_i = 0, $art_ccvgtu$art_c = list.length; $art_ipgmqdotv$art_i < $art_ccvgtu$art_c; $art_ipgmqdotv$art_i++) {    var item = list[$art_ipgmqdotv$art_i]%>';
    for (var $art_ipgmqdotv$art_i = 0, $art_ccvgtu$art_c = list.length; $art_ipgmqdotv$art_i < $art_ccvgtu$art_c; $art_ipgmqdotv$art_i++) {
        var item = list[$art_ipgmqdotv$art_i];
