...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iovxijrjbgg$art_i = 0, $art_cqhbetrmu$art_c = list.length; $art_iovxijrjbgg$art_i < $art_cqhbetrmu$art_c; $art_iovxijrjbgg$art_i++) {    var item = list[$art_iovxijrjbgg$art_i]%>';
    for (var $art_iovxijrjbgg$art_i = 0, $art_cqhbetrmu$art_c = list.length; $art_iovxijrjbgg$art_i < $art_cqhbetrmu$art_c; $art_iovxijrjbgg$art_i++) {
        var item = list[$art_iovxijrjbgg$art_i];
