...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iffehjwmjl$art_i = 0, $art_celcsckek$art_c = list.length; $art_iffehjwmjl$art_i < $art_celcsckek$art_c; $art_iffehjwmjl$art_i++) {    var item = list[$art_iffehjwmjl$art_i]%>';
    for (var $art_iffehjwmjl$art_i = 0, $art_celcsckek$art_c = list.length; $art_iffehjwmjl$art_i < $art_celcsckek$art_c; $art_iffehjwmjl$art_i++) {
        var item = list[$art_iffehjwmjl$art_i];
