...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izefdjvv$art_i = 0, $art_cwnahege$art_c = list.length; $art_izefdjvv$art_i < $art_cwnahege$art_c; $art_izefdjvv$art_i++) {    var item = list[$art_izefdjvv$art_i]%>';
    for (var $art_izefdjvv$art_i = 0, $art_cwnahege$art_c = list.length; $art_izefdjvv$art_i < $art_cwnahege$art_c; $art_izefdjvv$art_i++) {
        var item = list[$art_izefdjvv$art_i];
