...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikmxrzdi$art_i = 0, $art_cucsywweaj$art_c = list.length; $art_ikmxrzdi$art_i < $art_cucsywweaj$art_c; $art_ikmxrzdi$art_i++) {    var item = list[$art_ikmxrzdi$art_i]%>';
    for (var $art_ikmxrzdi$art_i = 0, $art_cucsywweaj$art_c = list.length; $art_ikmxrzdi$art_i < $art_cucsywweaj$art_c; $art_ikmxrzdi$art_i++) {
        var item = list[$art_ikmxrzdi$art_i];
