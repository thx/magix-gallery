...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inelusb$art_i = 0, $art_cfflgqela$art_c = list.length; $art_inelusb$art_i < $art_cfflgqela$art_c; $art_inelusb$art_i++) {    var item = list[$art_inelusb$art_i]%>';
    for (var $art_inelusb$art_i = 0, $art_cfflgqela$art_c = list.length; $art_inelusb$art_i < $art_cfflgqela$art_c; $art_inelusb$art_i++) {
        var item = list[$art_inelusb$art_i];
