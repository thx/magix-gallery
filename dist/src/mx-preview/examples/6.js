...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isbzbphhdp$art_i = 0, $art_clcafxuv$art_c = list.length; $art_isbzbphhdp$art_i < $art_clcafxuv$art_c; $art_isbzbphhdp$art_i++) {    var item = list[$art_isbzbphhdp$art_i]%>';
    for (var $art_isbzbphhdp$art_i = 0, $art_clcafxuv$art_c = list.length; $art_isbzbphhdp$art_i < $art_clcafxuv$art_c; $art_isbzbphhdp$art_i++) {
        var item = list[$art_isbzbphhdp$art_i];
