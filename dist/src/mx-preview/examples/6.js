...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iskvlnznn$art_i = 0, $art_ccneqmh$art_c = list.length; $art_iskvlnznn$art_i < $art_ccneqmh$art_c; $art_iskvlnznn$art_i++) {    var item = list[$art_iskvlnznn$art_i]%>';
    for (var $art_iskvlnznn$art_i = 0, $art_ccneqmh$art_c = list.length; $art_iskvlnznn$art_i < $art_ccneqmh$art_c; $art_iskvlnznn$art_i++) {
        var item = list[$art_iskvlnznn$art_i];
