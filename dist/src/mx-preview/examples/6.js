...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itgvtihkiii$art_i = 0, $art_cxyszzvch$art_c = list.length; $art_itgvtihkiii$art_i < $art_cxyszzvch$art_c; $art_itgvtihkiii$art_i++) {    var item = list[$art_itgvtihkiii$art_i]%>';
    for (var $art_itgvtihkiii$art_i = 0, $art_cxyszzvch$art_c = list.length; $art_itgvtihkiii$art_i < $art_cxyszzvch$art_c; $art_itgvtihkiii$art_i++) {
        var item = list[$art_itgvtihkiii$art_i];
