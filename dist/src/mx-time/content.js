...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryfq:_" class="clearfix pr"><div mxs="_zs_galleryfq:_" class="clearfix _zs_gallery_mx-calendar_index_-sps"><div class="_zs_gallery_mx-calendar_index_-sp _zs_gallery_mx-calendar_index_-spa">:</div><div class="_zs_gallery_mx-calendar_index_-sp _zs_gallery_mx-calendar_index_-spb">:</div></div><div mxv mxa="_zs_galleryfq:a" class="_zs_gallery_mx-calendar_index_-groups"><div mxv mxa="_zs_galleryfq:b" class="_zs_gallery_mx-calendar_index_-group"><div mxv mxa="_zs_galleryfq:c" class="mb5"><input class="input _zs_gallery_mx-calendar_index_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 12;
    ...
    ;
    $p += '>&#xeb78;</i></div></div><div mxv mxa="_zs_galleryfq:d" class="_zs_gallery_mx-calendar_index_-group"><div mxv mxa="_zs_galleryfq:e" class="mb5"><input class="input _zs_gallery_mx-calendar_index_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 29;
    ...
    ;
    $p += '>&#xeb78;</i></div></div><div mxv mxa="_zs_galleryfq:f" class="_zs_gallery_mx-calendar_index_-group"><div mxv mxa="_zs_galleryfq:g" class="mb5"><input class="input _zs_gallery_mx-calendar_index_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 46;
