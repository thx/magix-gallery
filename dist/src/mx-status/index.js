...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ickgfykjff$art_i = 0, $art_cwfwsexnib$art_c = opers.length; $art_ickgfykjff$art_i < $art_cwfwsexnib$art_c; $art_ickgfykjff$art_i++) {        var item = opers[$art_ickgfykjff$art_i]%>';
        for (var $art_ickgfykjff$art_i = 0, $art_cwfwsexnib$art_c = opers.length; $art_ickgfykjff$art_i < $art_cwfwsexnib$art_c; $art_ickgfykjff$art_i++) {
            var item = opers[$art_ickgfykjff$art_i];
