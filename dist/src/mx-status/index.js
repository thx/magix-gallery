...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_imiuil$art_i = 0, $art_cjeysmdh$art_c = opers.length; $art_imiuil$art_i < $art_cjeysmdh$art_c; $art_imiuil$art_i++) {        var item = opers[$art_imiuil$art_i]%>';
        for (var $art_imiuil$art_i = 0, $art_cjeysmdh$art_c = opers.length; $art_imiuil$art_i < $art_cjeysmdh$art_c; $art_imiuil$art_i++) {
            var item = opers[$art_imiuil$art_i];
