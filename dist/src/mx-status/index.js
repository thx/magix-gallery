...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ijkibvjcw$art_i = 0, $art_caosfyoh$art_c = opers.length; $art_ijkibvjcw$art_i < $art_caosfyoh$art_c; $art_ijkibvjcw$art_i++) {        var item = opers[$art_ijkibvjcw$art_i]%>';
        for (var $art_ijkibvjcw$art_i = 0, $art_caosfyoh$art_c = opers.length; $art_ijkibvjcw$art_i < $art_caosfyoh$art_c; $art_ijkibvjcw$art_i++) {
            var item = opers[$art_ijkibvjcw$art_i];
