...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_isrkxnxcwoc$art_i = 0, $art_cdlkjpqhx$art_c = opers.length; $art_isrkxnxcwoc$art_i < $art_cdlkjpqhx$art_c; $art_isrkxnxcwoc$art_i++) {        var item = opers[$art_isrkxnxcwoc$art_i]%>';
        for (var $art_isrkxnxcwoc$art_i = 0, $art_cdlkjpqhx$art_c = opers.length; $art_isrkxnxcwoc$art_i < $art_cdlkjpqhx$art_c; $art_isrkxnxcwoc$art_i++) {
            var item = opers[$art_isrkxnxcwoc$art_i];
