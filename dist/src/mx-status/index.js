...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_inhlgyzjkc$art_i = 0, $art_czanq$art_c = opers.length; $art_inhlgyzjkc$art_i < $art_czanq$art_c; $art_inhlgyzjkc$art_i++) {        var item = opers[$art_inhlgyzjkc$art_i]%>';
        for (var $art_inhlgyzjkc$art_i = 0, $art_czanq$art_c = opers.length; $art_inhlgyzjkc$art_i < $art_czanq$art_c; $art_inhlgyzjkc$art_i++) {
            var item = opers[$art_inhlgyzjkc$art_i];
