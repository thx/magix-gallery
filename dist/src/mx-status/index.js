...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iekauzvg$art_i = 0, $art_cswyfq$art_c = opers.length; $art_iekauzvg$art_i < $art_cswyfq$art_c; $art_iekauzvg$art_i++) {        var item = opers[$art_iekauzvg$art_i]%>';
        for (var $art_iekauzvg$art_i = 0, $art_cswyfq$art_c = opers.length; $art_iekauzvg$art_i < $art_cswyfq$art_c; $art_iekauzvg$art_i++) {
            var item = opers[$art_iekauzvg$art_i];
