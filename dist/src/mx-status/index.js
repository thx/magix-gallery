...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ikglzxato$art_i = 0, $art_cqhvuwfluok$art_c = opers.length; $art_ikglzxato$art_i < $art_cqhvuwfluok$art_c; $art_ikglzxato$art_i++) {        var item = opers[$art_ikglzxato$art_i]%>';
        for (var $art_ikglzxato$art_i = 0, $art_cqhvuwfluok$art_c = opers.length; $art_ikglzxato$art_i < $art_cqhvuwfluok$art_c; $art_ikglzxato$art_i++) {
            var item = opers[$art_ikglzxato$art_i];
