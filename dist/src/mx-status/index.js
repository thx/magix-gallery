...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_izocvnzlcu$art_i = 0, $art_cxshmxqqj$art_c = opers.length; $art_izocvnzlcu$art_i < $art_cxshmxqqj$art_c; $art_izocvnzlcu$art_i++) {        var item = opers[$art_izocvnzlcu$art_i]%>';
        for (var $art_izocvnzlcu$art_i = 0, $art_cxshmxqqj$art_c = opers.length; $art_izocvnzlcu$art_i < $art_cxshmxqqj$art_c; $art_izocvnzlcu$art_i++) {
            var item = opers[$art_izocvnzlcu$art_i];
