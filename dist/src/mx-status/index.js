...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iorvvmqdab$art_i = 0, $art_cylhyxpwr$art_c = opers.length; $art_iorvvmqdab$art_i < $art_cylhyxpwr$art_c; $art_iorvvmqdab$art_i++) {        var item = opers[$art_iorvvmqdab$art_i]%>';
        for (var $art_iorvvmqdab$art_i = 0, $art_cylhyxpwr$art_c = opers.length; $art_iorvvmqdab$art_i < $art_cylhyxpwr$art_c; $art_iorvvmqdab$art_i++) {
            var item = opers[$art_iorvvmqdab$art_i];
