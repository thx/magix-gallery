...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_izlzphocafr$art_i = 0, $art_czebyga$art_c = opers.length; $art_izlzphocafr$art_i < $art_czebyga$art_c; $art_izlzphocafr$art_i++) {        var item = opers[$art_izlzphocafr$art_i]%>';
        for (var $art_izlzphocafr$art_i = 0, $art_czebyga$art_c = opers.length; $art_izlzphocafr$art_i < $art_czebyga$art_c; $art_izlzphocafr$art_i++) {
            var item = opers[$art_izlzphocafr$art_i];
