...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iaemeotk$art_i = 0, $art_cpvyybbzm$art_c = opers.length; $art_iaemeotk$art_i < $art_cpvyybbzm$art_c; $art_iaemeotk$art_i++) {        var item = opers[$art_iaemeotk$art_i]%>';
        for (var $art_iaemeotk$art_i = 0, $art_cpvyybbzm$art_c = opers.length; $art_iaemeotk$art_i < $art_cpvyybbzm$art_c; $art_iaemeotk$art_i++) {
            var item = opers[$art_iaemeotk$art_i];
