...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_icsgtccc$art_i = 0, $art_ccbxhzvvaaj$art_c = opers.length; $art_icsgtccc$art_i < $art_ccbxhzvvaaj$art_c; $art_icsgtccc$art_i++) {        var item = opers[$art_icsgtccc$art_i]%>';
        for (var $art_icsgtccc$art_i = 0, $art_ccbxhzvvaaj$art_c = opers.length; $art_icsgtccc$art_i < $art_ccbxhzvvaaj$art_c; $art_icsgtccc$art_i++) {
            var item = opers[$art_icsgtccc$art_i];
