...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ibnryvnjjk$art_i = 0, $art_cevumwecs$art_c = opers.length; $art_ibnryvnjjk$art_i < $art_cevumwecs$art_c; $art_ibnryvnjjk$art_i++) {        var item = opers[$art_ibnryvnjjk$art_i]%>';
        for (var $art_ibnryvnjjk$art_i = 0, $art_cevumwecs$art_c = opers.length; $art_ibnryvnjjk$art_i < $art_cevumwecs$art_c; $art_ibnryvnjjk$art_i++) {
            var item = opers[$art_ibnryvnjjk$art_i];
