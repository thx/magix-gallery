...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ipxhtffxwxjf$art_i = 0, $art_cctmnhcqo$art_c = opers.length; $art_ipxhtffxwxjf$art_i < $art_cctmnhcqo$art_c; $art_ipxhtffxwxjf$art_i++) {        var item = opers[$art_ipxhtffxwxjf$art_i]%>';
        for (var $art_ipxhtffxwxjf$art_i = 0, $art_cctmnhcqo$art_c = opers.length; $art_ipxhtffxwxjf$art_i < $art_cctmnhcqo$art_c; $art_ipxhtffxwxjf$art_i++) {
            var item = opers[$art_ipxhtffxwxjf$art_i];
