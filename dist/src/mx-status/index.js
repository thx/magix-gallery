...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ickqkgd$art_i = 0, $art_cosfckoko$art_c = opers.length; $art_ickqkgd$art_i < $art_cosfckoko$art_c; $art_ickqkgd$art_i++) {        var item = opers[$art_ickqkgd$art_i]%>';
        for (var $art_ickqkgd$art_i = 0, $art_cosfckoko$art_c = opers.length; $art_ickqkgd$art_i < $art_cosfckoko$art_c; $art_ickqkgd$art_i++) {
            var item = opers[$art_ickqkgd$art_i];
