...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iwvqcjmojo$art_i = 0, $art_cfbnldo$art_c = opers.length; $art_iwvqcjmojo$art_i < $art_cfbnldo$art_c; $art_iwvqcjmojo$art_i++) {        var item = opers[$art_iwvqcjmojo$art_i]%>';
        for (var $art_iwvqcjmojo$art_i = 0, $art_cfbnldo$art_c = opers.length; $art_iwvqcjmojo$art_i < $art_cfbnldo$art_c; $art_iwvqcjmojo$art_i++) {
            var item = opers[$art_iwvqcjmojo$art_i];
