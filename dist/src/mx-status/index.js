...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iexqafcg$art_i = 0, $art_cnkllflmawh$art_c = opers.length; $art_iexqafcg$art_i < $art_cnkllflmawh$art_c; $art_iexqafcg$art_i++) {        var item = opers[$art_iexqafcg$art_i]%>';
        for (var $art_iexqafcg$art_i = 0, $art_cnkllflmawh$art_c = opers.length; $art_iexqafcg$art_i < $art_cnkllflmawh$art_c; $art_iexqafcg$art_i++) {
            var item = opers[$art_iexqafcg$art_i];
