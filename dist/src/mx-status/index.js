...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iwpnqsfe$art_i = 0, $art_czkmvbmr$art_c = opers.length; $art_iwpnqsfe$art_i < $art_czkmvbmr$art_c; $art_iwpnqsfe$art_i++) {        var item = opers[$art_iwpnqsfe$art_i]%>';
        for (var $art_iwpnqsfe$art_i = 0, $art_czkmvbmr$art_c = opers.length; $art_iwpnqsfe$art_i < $art_czkmvbmr$art_c; $art_iwpnqsfe$art_i++) {
            var item = opers[$art_iwpnqsfe$art_i];
