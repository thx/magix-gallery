...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_izcaisjcg$art_i = 0, $art_csogojxryc$art_c = opers.length; $art_izcaisjcg$art_i < $art_csogojxryc$art_c; $art_izcaisjcg$art_i++) {        var item = opers[$art_izcaisjcg$art_i]%>';
        for (var $art_izcaisjcg$art_i = 0, $art_csogojxryc$art_c = opers.length; $art_izcaisjcg$art_i < $art_csogojxryc$art_c; $art_izcaisjcg$art_i++) {
            var item = opers[$art_izcaisjcg$art_i];
