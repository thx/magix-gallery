...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_igpstcjrc$art_i = 0, $art_caypssaju$art_c = opers.length; $art_igpstcjrc$art_i < $art_caypssaju$art_c; $art_igpstcjrc$art_i++) {        var item = opers[$art_igpstcjrc$art_i]%>';
        for (var $art_igpstcjrc$art_i = 0, $art_caypssaju$art_c = opers.length; $art_igpstcjrc$art_i < $art_caypssaju$art_c; $art_igpstcjrc$art_i++) {
            var item = opers[$art_igpstcjrc$art_i];
