...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iiskknlh$art_i = 0, $art_cxxdvcjf$art_c = opers.length; $art_iiskknlh$art_i < $art_cxxdvcjf$art_c; $art_iiskknlh$art_i++) {        var item = opers[$art_iiskknlh$art_i]%>';
        for (var $art_iiskknlh$art_i = 0, $art_cxxdvcjf$art_c = opers.length; $art_iiskknlh$art_i < $art_cxxdvcjf$art_c; $art_iiskknlh$art_i++) {
            var item = opers[$art_iiskknlh$art_i];
