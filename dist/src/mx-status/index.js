...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_idjcovruub$art_i = 0, $art_chiperh$art_c = opers.length; $art_idjcovruub$art_i < $art_chiperh$art_c; $art_idjcovruub$art_i++) {        var item = opers[$art_idjcovruub$art_i]%>';
        for (var $art_idjcovruub$art_i = 0, $art_chiperh$art_c = opers.length; $art_idjcovruub$art_i < $art_chiperh$art_c; $art_idjcovruub$art_i++) {
            var item = opers[$art_idjcovruub$art_i];
