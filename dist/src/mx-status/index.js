...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iufjixp$art_i = 0, $art_cqwkmkaqf$art_c = opers.length; $art_iufjixp$art_i < $art_cqwkmkaqf$art_c; $art_iufjixp$art_i++) {        var item = opers[$art_iufjixp$art_i]%>';
        for (var $art_iufjixp$art_i = 0, $art_cqwkmkaqf$art_c = opers.length; $art_iufjixp$art_i < $art_cqwkmkaqf$art_c; $art_iufjixp$art_i++) {
            var item = opers[$art_iufjixp$art_i];
