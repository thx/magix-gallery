...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_irvosgvmn$art_i = 0, $art_ccivaof$art_c = opers.length; $art_irvosgvmn$art_i < $art_ccivaof$art_c; $art_irvosgvmn$art_i++) {        var item = opers[$art_irvosgvmn$art_i]%>';
        for (var $art_irvosgvmn$art_i = 0, $art_ccivaof$art_c = opers.length; $art_irvosgvmn$art_i < $art_ccivaof$art_c; $art_irvosgvmn$art_i++) {
            var item = opers[$art_irvosgvmn$art_i];
