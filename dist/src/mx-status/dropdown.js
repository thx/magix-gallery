...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_inkevdgppg$art_i = 0, $art_cqrxbrufmt$art_c = opers.length; $art_inkevdgppg$art_i < $art_cqrxbrufmt$art_c; $art_inkevdgppg$art_i++) {            var item = opers[$art_inkevdgppg$art_i]%>';
            for (var $art_inkevdgppg$art_i = 0, $art_cqrxbrufmt$art_c = opers.length; $art_inkevdgppg$art_i < $art_cqrxbrufmt$art_c; $art_inkevdgppg$art_i++) {
                var item = opers[$art_inkevdgppg$art_i];
