...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ieawwx$art_i = 0, $art_cycufylrk$art_c = opers.length; $art_ieawwx$art_i < $art_cycufylrk$art_c; $art_ieawwx$art_i++) {            var item = opers[$art_ieawwx$art_i]%>';
            for (var $art_ieawwx$art_i = 0, $art_cycufylrk$art_c = opers.length; $art_ieawwx$art_i < $art_cycufylrk$art_c; $art_ieawwx$art_i++) {
                var item = opers[$art_ieawwx$art_i];
