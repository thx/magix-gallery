...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iwvgmchhh$art_i = 0, $art_czaenidt$art_c = opers.length; $art_iwvgmchhh$art_i < $art_czaenidt$art_c; $art_iwvgmchhh$art_i++) {            var item = opers[$art_iwvgmchhh$art_i]%>';
            for (var $art_iwvgmchhh$art_i = 0, $art_czaenidt$art_c = opers.length; $art_iwvgmchhh$art_i < $art_czaenidt$art_c; $art_iwvgmchhh$art_i++) {
                var item = opers[$art_iwvgmchhh$art_i];
