...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ibiksuhycsx$art_i = 0, $art_cpmpgee$art_c = opers.length; $art_ibiksuhycsx$art_i < $art_cpmpgee$art_c; $art_ibiksuhycsx$art_i++) {            var item = opers[$art_ibiksuhycsx$art_i]%>';
            for (var $art_ibiksuhycsx$art_i = 0, $art_cpmpgee$art_c = opers.length; $art_ibiksuhycsx$art_i < $art_cpmpgee$art_c; $art_ibiksuhycsx$art_i++) {
                var item = opers[$art_ibiksuhycsx$art_i];
