...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ispprh$art_i = 0, $art_cveolbccpe$art_c = opers.length; $art_ispprh$art_i < $art_cveolbccpe$art_c; $art_ispprh$art_i++) {            var item = opers[$art_ispprh$art_i]%>';
            for (var $art_ispprh$art_i = 0, $art_cveolbccpe$art_c = opers.length; $art_ispprh$art_i < $art_cveolbccpe$art_c; $art_ispprh$art_i++) {
                var item = opers[$art_ispprh$art_i];
