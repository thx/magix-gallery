...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iemmtgihr$art_i = 0, $art_cpvequmy$art_c = opers.length; $art_iemmtgihr$art_i < $art_cpvequmy$art_c; $art_iemmtgihr$art_i++) {            var item = opers[$art_iemmtgihr$art_i]%>';
            for (var $art_iemmtgihr$art_i = 0, $art_cpvequmy$art_c = opers.length; $art_iemmtgihr$art_i < $art_cpvequmy$art_c; $art_iemmtgihr$art_i++) {
                var item = opers[$art_iemmtgihr$art_i];
