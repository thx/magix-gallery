...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_isdluifgo$art_i = 0, $art_citobtjq$art_c = opers.length; $art_isdluifgo$art_i < $art_citobtjq$art_c; $art_isdluifgo$art_i++) {            var item = opers[$art_isdluifgo$art_i]%>';
            for (var $art_isdluifgo$art_i = 0, $art_citobtjq$art_c = opers.length; $art_isdluifgo$art_i < $art_citobtjq$art_c; $art_isdluifgo$art_i++) {
                var item = opers[$art_isdluifgo$art_i];
