...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ivunwlukq$art_i = 0, $art_chgueks$art_c = opers.length; $art_ivunwlukq$art_i < $art_chgueks$art_c; $art_ivunwlukq$art_i++) {            var item = opers[$art_ivunwlukq$art_i]%>';
            for (var $art_ivunwlukq$art_i = 0, $art_chgueks$art_c = opers.length; $art_ivunwlukq$art_i < $art_chgueks$art_c; $art_ivunwlukq$art_i++) {
                var item = opers[$art_ivunwlukq$art_i];
