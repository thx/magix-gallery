...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_inyngnoeo$art_i = 0, $art_csazwiq$art_c = opers.length; $art_inyngnoeo$art_i < $art_csazwiq$art_c; $art_inyngnoeo$art_i++) {            var item = opers[$art_inyngnoeo$art_i]%>';
            for (var $art_inyngnoeo$art_i = 0, $art_csazwiq$art_c = opers.length; $art_inyngnoeo$art_i < $art_csazwiq$art_c; $art_inyngnoeo$art_i++) {
                var item = opers[$art_inyngnoeo$art_i];
