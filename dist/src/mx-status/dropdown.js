...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ikxhqbr$art_i = 0, $art_cibdklob$art_c = opers.length; $art_ikxhqbr$art_i < $art_cibdklob$art_c; $art_ikxhqbr$art_i++) {            var item = opers[$art_ikxhqbr$art_i]%>';
            for (var $art_ikxhqbr$art_i = 0, $art_cibdklob$art_c = opers.length; $art_ikxhqbr$art_i < $art_cibdklob$art_c; $art_ikxhqbr$art_i++) {
                var item = opers[$art_ikxhqbr$art_i];
