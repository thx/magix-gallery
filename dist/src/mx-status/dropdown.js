...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_izvltzmknf$art_i = 0, $art_csowitkxr$art_c = opers.length; $art_izvltzmknf$art_i < $art_csowitkxr$art_c; $art_izvltzmknf$art_i++) {            var item = opers[$art_izvltzmknf$art_i]%>';
            for (var $art_izvltzmknf$art_i = 0, $art_csowitkxr$art_c = opers.length; $art_izvltzmknf$art_i < $art_csowitkxr$art_c; $art_izvltzmknf$art_i++) {
                var item = opers[$art_izvltzmknf$art_i];
