...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_idkxtsgqwhg$art_i = 0, $art_censmem$art_c = opers.length; $art_idkxtsgqwhg$art_i < $art_censmem$art_c; $art_idkxtsgqwhg$art_i++) {            var item = opers[$art_idkxtsgqwhg$art_i]%>';
            for (var $art_idkxtsgqwhg$art_i = 0, $art_censmem$art_c = opers.length; $art_idkxtsgqwhg$art_i < $art_censmem$art_c; $art_idkxtsgqwhg$art_i++) {
                var item = opers[$art_idkxtsgqwhg$art_i];
