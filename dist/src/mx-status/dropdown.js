...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iwrdvzvjl$art_i = 0, $art_cyznjpxfpap$art_c = opers.length; $art_iwrdvzvjl$art_i < $art_cyznjpxfpap$art_c; $art_iwrdvzvjl$art_i++) {            var item = opers[$art_iwrdvzvjl$art_i]%>';
            for (var $art_iwrdvzvjl$art_i = 0, $art_cyznjpxfpap$art_c = opers.length; $art_iwrdvzvjl$art_i < $art_cyznjpxfpap$art_c; $art_iwrdvzvjl$art_i++) {
                var item = opers[$art_iwrdvzvjl$art_i];
