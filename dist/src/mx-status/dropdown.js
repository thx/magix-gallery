...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iezgpem$art_i = 0, $art_cdndmnnnl$art_c = opers.length; $art_iezgpem$art_i < $art_cdndmnnnl$art_c; $art_iezgpem$art_i++) {            var item = opers[$art_iezgpem$art_i]%>';
            for (var $art_iezgpem$art_i = 0, $art_cdndmnnnl$art_c = opers.length; $art_iezgpem$art_i < $art_cdndmnnnl$art_c; $art_iezgpem$art_i++) {
                var item = opers[$art_iezgpem$art_i];
