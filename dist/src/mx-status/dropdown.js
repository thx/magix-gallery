...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_imyhxbbh$art_i = 0, $art_cncfvss$art_c = opers.length; $art_imyhxbbh$art_i < $art_cncfvss$art_c; $art_imyhxbbh$art_i++) {            var item = opers[$art_imyhxbbh$art_i]%>';
            for (var $art_imyhxbbh$art_i = 0, $art_cncfvss$art_c = opers.length; $art_imyhxbbh$art_i < $art_cncfvss$art_c; $art_imyhxbbh$art_i++) {
                var item = opers[$art_imyhxbbh$art_i];
