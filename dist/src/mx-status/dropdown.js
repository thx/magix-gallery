...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iefcqmmoa$art_i = 0, $art_cztzsgtwqy$art_c = opers.length; $art_iefcqmmoa$art_i < $art_cztzsgtwqy$art_c; $art_iefcqmmoa$art_i++) {            var item = opers[$art_iefcqmmoa$art_i]%>';
            for (var $art_iefcqmmoa$art_i = 0, $art_cztzsgtwqy$art_c = opers.length; $art_iefcqmmoa$art_i < $art_cztzsgtwqy$art_c; $art_iefcqmmoa$art_i++) {
                var item = opers[$art_iefcqmmoa$art_i];
