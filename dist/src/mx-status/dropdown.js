...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_imofvybaood$art_i = 0, $art_cvfbsl$art_c = opers.length; $art_imofvybaood$art_i < $art_cvfbsl$art_c; $art_imofvybaood$art_i++) {            var item = opers[$art_imofvybaood$art_i]%>';
            for (var $art_imofvybaood$art_i = 0, $art_cvfbsl$art_c = opers.length; $art_imofvybaood$art_i < $art_cvfbsl$art_c; $art_imofvybaood$art_i++) {
                var item = opers[$art_imofvybaood$art_i];
