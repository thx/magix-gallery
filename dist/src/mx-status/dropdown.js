...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iplbzey$art_i = 0, $art_cmcvrceio$art_c = opers.length; $art_iplbzey$art_i < $art_cmcvrceio$art_c; $art_iplbzey$art_i++) {            var item = opers[$art_iplbzey$art_i]%>';
            for (var $art_iplbzey$art_i = 0, $art_cmcvrceio$art_c = opers.length; $art_iplbzey$art_i < $art_cmcvrceio$art_c; $art_iplbzey$art_i++) {
                var item = opers[$art_iplbzey$art_i];
