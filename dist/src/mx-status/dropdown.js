...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ihcglb$art_i = 0, $art_crvyiwx$art_c = opers.length; $art_ihcglb$art_i < $art_crvyiwx$art_c; $art_ihcglb$art_i++) {            var item = opers[$art_ihcglb$art_i]%>';
            for (var $art_ihcglb$art_i = 0, $art_crvyiwx$art_c = opers.length; $art_ihcglb$art_i < $art_crvyiwx$art_c; $art_ihcglb$art_i++) {
                var item = opers[$art_ihcglb$art_i];
