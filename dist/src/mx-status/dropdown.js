...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ifohlkzp$art_i = 0, $art_capgqonqn$art_c = opers.length; $art_ifohlkzp$art_i < $art_capgqonqn$art_c; $art_ifohlkzp$art_i++) {            var item = opers[$art_ifohlkzp$art_i]%>';
            for (var $art_ifohlkzp$art_i = 0, $art_capgqonqn$art_c = opers.length; $art_ifohlkzp$art_i < $art_capgqonqn$art_c; $art_ifohlkzp$art_i++) {
                var item = opers[$art_ifohlkzp$art_i];
