...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_insurfpzyd$art_i = 0, $art_cbvgafiibr$art_c = opers.length; $art_insurfpzyd$art_i < $art_cbvgafiibr$art_c; $art_insurfpzyd$art_i++) {            var item = opers[$art_insurfpzyd$art_i]%>';
            for (var $art_insurfpzyd$art_i = 0, $art_cbvgafiibr$art_c = opers.length; $art_insurfpzyd$art_i < $art_cbvgafiibr$art_c; $art_insurfpzyd$art_i++) {
                var item = opers[$art_insurfpzyd$art_i];
