...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_igxsizkv$art_i = 0, $art_cnnpvdhhheh$art_c = opers.length; $art_igxsizkv$art_i < $art_cnnpvdhhheh$art_c; $art_igxsizkv$art_i++) {            var item = opers[$art_igxsizkv$art_i]%>';
            for (var $art_igxsizkv$art_i = 0, $art_cnnpvdhhheh$art_c = opers.length; $art_igxsizkv$art_i < $art_cnnpvdhhheh$art_c; $art_igxsizkv$art_i++) {
                var item = opers[$art_igxsizkv$art_i];
