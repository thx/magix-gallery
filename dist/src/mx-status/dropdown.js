...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ibcrepdv$art_i = 0, $art_cgttgvti$art_c = opers.length; $art_ibcrepdv$art_i < $art_cgttgvti$art_c; $art_ibcrepdv$art_i++) {            var item = opers[$art_ibcrepdv$art_i]%>';
            for (var $art_ibcrepdv$art_i = 0, $art_cgttgvti$art_c = opers.length; $art_ibcrepdv$art_i < $art_cgttgvti$art_c; $art_ibcrepdv$art_i++) {
                var item = opers[$art_ibcrepdv$art_i];
