...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ilorm$art_i = 0, $art_cpvxjpd$art_c = opers.length; $art_ilorm$art_i < $art_cpvxjpd$art_c; $art_ilorm$art_i++) {            var item = opers[$art_ilorm$art_i]%>';
            for (var $art_ilorm$art_i = 0, $art_cpvxjpd$art_c = opers.length; $art_ilorm$art_i < $art_cpvxjpd$art_c; $art_ilorm$art_i++) {
                var item = opers[$art_ilorm$art_i];
