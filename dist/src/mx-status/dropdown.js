...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_idlruyffmi$art_i = 0, $art_ccnjabou$art_c = opers.length; $art_idlruyffmi$art_i < $art_ccnjabou$art_c; $art_idlruyffmi$art_i++) {            var item = opers[$art_idlruyffmi$art_i]%>';
            for (var $art_idlruyffmi$art_i = 0, $art_ccnjabou$art_c = opers.length; $art_idlruyffmi$art_i < $art_ccnjabou$art_c; $art_idlruyffmi$art_i++) {
                var item = opers[$art_idlruyffmi$art_i];
