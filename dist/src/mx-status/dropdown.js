...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ibsjtbvw$art_i = 0, $art_chayacvk$art_c = opers.length; $art_ibsjtbvw$art_i < $art_chayacvk$art_c; $art_ibsjtbvw$art_i++) {            var item = opers[$art_ibsjtbvw$art_i]%>';
            for (var $art_ibsjtbvw$art_i = 0, $art_chayacvk$art_c = opers.length; $art_ibsjtbvw$art_i < $art_chayacvk$art_c; $art_ibsjtbvw$art_i++) {
                var item = opers[$art_ibsjtbvw$art_i];
