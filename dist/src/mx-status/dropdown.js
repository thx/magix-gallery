...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_icyafuz$art_i = 0, $art_chgqcfybw$art_c = opers.length; $art_icyafuz$art_i < $art_chgqcfybw$art_c; $art_icyafuz$art_i++) {            var item = opers[$art_icyafuz$art_i]%>';
            for (var $art_icyafuz$art_i = 0, $art_chgqcfybw$art_c = opers.length; $art_icyafuz$art_i < $art_chgqcfybw$art_c; $art_icyafuz$art_i++) {
                var item = opers[$art_icyafuz$art_i];
