...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iwqxxokc$art_i = 0, $art_cxhenhtz$art_c = opers.length; $art_iwqxxokc$art_i < $art_cxhenhtz$art_c; $art_iwqxxokc$art_i++) {            var item = opers[$art_iwqxxokc$art_i]%>';
            for (var $art_iwqxxokc$art_i = 0, $art_cxhenhtz$art_c = opers.length; $art_iwqxxokc$art_i < $art_cxhenhtz$art_c; $art_iwqxxokc$art_i++) {
                var item = opers[$art_iwqxxokc$art_i];
