...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerya_:_" class="_zs_gallery_mx-calendar_index_-wrapper unselectable" mx-contextmenu="' + $viewId + '@{prevent}()">';
    $expr = '<%if (types.day) {%>';
    if (types.day) {
        ;
        $p += '<div id="days_' + ($expr = '<%=id%>', $e(id)) + '" class="clearfix"><div mxa="_zs_gallerya_:a" class="_zs_gallery_mx-calendar_index_-header"><span mxs="_zs_gallerya_:_" class="mc-iconfont _zs_gallery_mx-calendar_index_-minus fl" mx-click="' + $viewId + '@{changeMonth}()">&#xe61e;</span><span class="_zs_gallery_mx-calendar_index_-title" mx-click="' + $viewId + '';
        $expr = '<%if (types.month) {%>';
        if (types.month) {
            ;
            $p += '@{showMonths}';
        ...
        ;
        $p += '()">' + ($expr = '<%=year%>', $e(year)) + '-' + ($expr = '<%=(\'0\' + month).slice(-2)%>', $e(('0' + month).slice(-2))) + '</span><span mxs="_zs_gallerya_:a" class="mc-iconfont _zs_gallery_mx-calendar_index_-plus fr" mx-click="' + $viewId + '@{changeMonth}({next:true})">&#xe61e;</span></div><div mxa="_zs_gallerya_:b" class="_zs_gallery_mx-calendar_index_-body"><div mxa="_zs_gallerya_:c" class="_zs_gallery_mx-calendar_index_-weeks clearfix">';
        $expr = '<%for (var i = 0; i < weekText.length; i++) {%>';
        for (var i = 0; i < weekText.length; i++) {
            ;
            $p += '<span mxa="_zs_gallerya_:d" class="_zs_gallery_mx-calendar_index_-week">' + ($expr = '<%=weekText[i]%>', $e(weekText[i])) + '</span>';
            $expr = '<%}%>';
        }
        ;
        $p += '</div><div mxa="_zs_gallerya_:e" class="_zs_gallery_mx-calendar_index_-days clearfix">';
        ...
        if (timeType) {
            ;
            $p += '<div class="clearfix _zs_gallery_mx-calendar_index_-time" mx-change="' + $viewId + '@{setTime}()" mx-view="mx-time/content?time=' + ($expr = '<%!$eu(timeValue)%>', $eu(timeValue)) + '&types=' + ($expr = '<%!$eu(timeType)%>', $eu(timeType)) + '"></div><div mxs="_zs_gallerya_:b" class="mx-output-footer"><button type="button" class="btn btn-small btn-brand" mx-click="' + $viewId + '@{hide}({enter:true})">确定</button><button type="button" class="btn btn-small ml10" mx-click="' + $viewId + '@{hide}()">取消</button></div>';
            $expr = '<%}%>';
        }
        ;
        $p += '</div>';
    ...
    if (types.month) {
        ...
        ;
        $p += '"><div mxa="_zs_gallerya_:f" class="_zs_gallery_mx-calendar_index_-header"><span mxs="_zs_gallerya_:c" class="mc-iconfont _zs_gallery_mx-calendar_index_-minus fl" mx-click="' + $viewId + '@{changeYear}()">&#xe61e;</span><span mxa="_zs_gallerya_:g" class="_zs_gallery_mx-calendar_index_-title" mx-click="' + $viewId + '@{showYears}()">' + ($expr = '<%=year%>', $e(year)) + '</span><span mxs="_zs_gallerya_:d" class="mc-iconfont _zs_gallery_mx-calendar_index_-plus fr" mx-click="' + $viewId + '@{changeYear}({next:true})">&#xe61e;</span></div><div mxa="_zs_gallerya_:h" class="_zs_gallery_mx-calendar_index_-body clearfix">';
    ...
    if (types.year) {
        ...
        ;
        $p += '"><div mxa="_zs_gallerya_:i" class="_zs_gallery_mx-calendar_index_-header"><span mxs="_zs_gallerya_:e" class="mc-iconfont _zs_gallery_mx-calendar_index_-minus fl" mx-click="' + $viewId + '@{changeYear}({range:true})">&#xe61e;</span><span mxa="_zs_gallerya_:j" class="_zs_gallery_mx-calendar_index_-title">' + ($expr = '<%=startYear%>', $e(startYear)) + '-' + ($expr = '<%=endYear%>', $e(endYear)) + '</span><span mxs="_zs_gallerya_:f" class="mc-iconfont _zs_gallery_mx-calendar_index_-plus fr" mx-click="' + $viewId + '@{changeYear}({range:true,next:true})">&#xe61e;</span></div><div mxa="_zs_gallerya_:k" class="_zs_gallery_mx-calendar_index_-body clearfix">';
