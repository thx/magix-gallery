...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iypkvxyghhg$art_i = 0, $art_csjgr$art_c = quickInfos.length; $art_iypkvxyghhg$art_i < $art_csjgr$art_c; $art_iypkvxyghhg$art_i++) {        var info = quickInfos[$art_iypkvxyghhg$art_i]%>';
        for (var $art_iypkvxyghhg$art_i = 0, $art_csjgr$art_c = quickInfos.length; $art_iypkvxyghhg$art_i < $art_csjgr$art_c; $art_iypkvxyghhg$art_i++) {
            var info = quickInfos[$art_iypkvxyghhg$art_i];
