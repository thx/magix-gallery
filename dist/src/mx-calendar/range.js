...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ilonuf$art_i = 0, $art_cnqntv$art_c = quickInfos.length; $art_ilonuf$art_i < $art_cnqntv$art_c; $art_ilonuf$art_i++) {        var info = quickInfos[$art_ilonuf$art_i]%>';
        for (var $art_ilonuf$art_i = 0, $art_cnqntv$art_c = quickInfos.length; $art_ilonuf$art_i < $art_cnqntv$art_c; $art_ilonuf$art_i++) {
            var info = quickInfos[$art_ilonuf$art_i];
