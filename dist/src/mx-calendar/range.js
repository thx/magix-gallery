...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_izfiuhpdfi$art_i = 0, $art_ceqwxrppnxt$art_c = quickInfos.length; $art_izfiuhpdfi$art_i < $art_ceqwxrppnxt$art_c; $art_izfiuhpdfi$art_i++) {        var info = quickInfos[$art_izfiuhpdfi$art_i]%>';
        for (var $art_izfiuhpdfi$art_i = 0, $art_ceqwxrppnxt$art_c = quickInfos.length; $art_izfiuhpdfi$art_i < $art_ceqwxrppnxt$art_c; $art_izfiuhpdfi$art_i++) {
            var info = quickInfos[$art_izfiuhpdfi$art_i];
