...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_idozycjaixi$art_i = 0, $art_cgrfqonl$art_c = quickInfos.length; $art_idozycjaixi$art_i < $art_cgrfqonl$art_c; $art_idozycjaixi$art_i++) {        var info = quickInfos[$art_idozycjaixi$art_i]%>';
        for (var $art_idozycjaixi$art_i = 0, $art_cgrfqonl$art_c = quickInfos.length; $art_idozycjaixi$art_i < $art_cgrfqonl$art_c; $art_idozycjaixi$art_i++) {
            var info = quickInfos[$art_idozycjaixi$art_i];
