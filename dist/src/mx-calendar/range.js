...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iwjwarso$art_i = 0, $art_cbilnhnrqb$art_c = quickInfos.length; $art_iwjwarso$art_i < $art_cbilnhnrqb$art_c; $art_iwjwarso$art_i++) {        var info = quickInfos[$art_iwjwarso$art_i]%>';
        for (var $art_iwjwarso$art_i = 0, $art_cbilnhnrqb$art_c = quickInfos.length; $art_iwjwarso$art_i < $art_cbilnhnrqb$art_c; $art_iwjwarso$art_i++) {
            var info = quickInfos[$art_iwjwarso$art_i];
