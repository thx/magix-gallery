...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ikeaiocj$art_i = 0, $art_cuonhzlkc$art_c = quickInfos.length; $art_ikeaiocj$art_i < $art_cuonhzlkc$art_c; $art_ikeaiocj$art_i++) {        var info = quickInfos[$art_ikeaiocj$art_i]%>';
        for (var $art_ikeaiocj$art_i = 0, $art_cuonhzlkc$art_c = quickInfos.length; $art_ikeaiocj$art_i < $art_cuonhzlkc$art_c; $art_ikeaiocj$art_i++) {
            var info = quickInfos[$art_ikeaiocj$art_i];
