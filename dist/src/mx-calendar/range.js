...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ivgpimido$art_i = 0, $art_ctbwpm$art_c = quickInfos.length; $art_ivgpimido$art_i < $art_ctbwpm$art_c; $art_ivgpimido$art_i++) {        var info = quickInfos[$art_ivgpimido$art_i]%>';
        for (var $art_ivgpimido$art_i = 0, $art_ctbwpm$art_c = quickInfos.length; $art_ivgpimido$art_i < $art_ctbwpm$art_c; $art_ivgpimido$art_i++) {
            var info = quickInfos[$art_ivgpimido$art_i];
