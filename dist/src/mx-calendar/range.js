...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ibbdfzi$art_i = 0, $art_cdttikvptgvr$art_c = quickInfos.length; $art_ibbdfzi$art_i < $art_cdttikvptgvr$art_c; $art_ibbdfzi$art_i++) {        var info = quickInfos[$art_ibbdfzi$art_i]%>';
        for (var $art_ibbdfzi$art_i = 0, $art_cdttikvptgvr$art_c = quickInfos.length; $art_ibbdfzi$art_i < $art_cdttikvptgvr$art_c; $art_ibbdfzi$art_i++) {
            var info = quickInfos[$art_ibbdfzi$art_i];
