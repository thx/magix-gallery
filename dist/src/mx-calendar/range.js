...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iogedww$art_i = 0, $art_ctebbumeo$art_c = quickInfos.length; $art_iogedww$art_i < $art_ctebbumeo$art_c; $art_iogedww$art_i++) {        var info = quickInfos[$art_iogedww$art_i]%>';
        for (var $art_iogedww$art_i = 0, $art_ctebbumeo$art_c = quickInfos.length; $art_iogedww$art_i < $art_ctebbumeo$art_c; $art_iogedww$art_i++) {
            var info = quickInfos[$art_iogedww$art_i];
