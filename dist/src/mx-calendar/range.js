...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ilavbm$art_i = 0, $art_crvyslp$art_c = quickInfos.length; $art_ilavbm$art_i < $art_crvyslp$art_c; $art_ilavbm$art_i++) {        var info = quickInfos[$art_ilavbm$art_i]%>';
        for (var $art_ilavbm$art_i = 0, $art_crvyslp$art_c = quickInfos.length; $art_ilavbm$art_i < $art_crvyslp$art_c; $art_ilavbm$art_i++) {
            var info = quickInfos[$art_ilavbm$art_i];
