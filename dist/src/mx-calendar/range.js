...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_icgqurhasgt$art_i = 0, $art_cvwmznhzr$art_c = quickInfos.length; $art_icgqurhasgt$art_i < $art_cvwmznhzr$art_c; $art_icgqurhasgt$art_i++) {        var info = quickInfos[$art_icgqurhasgt$art_i]%>';
        for (var $art_icgqurhasgt$art_i = 0, $art_cvwmznhzr$art_c = quickInfos.length; $art_icgqurhasgt$art_i < $art_cvwmznhzr$art_c; $art_icgqurhasgt$art_i++) {
            var info = quickInfos[$art_icgqurhasgt$art_i];
