...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ieugdrdqmlp$art_i = 0, $art_cnrlzpviik$art_c = quickInfos.length; $art_ieugdrdqmlp$art_i < $art_cnrlzpviik$art_c; $art_ieugdrdqmlp$art_i++) {        var info = quickInfos[$art_ieugdrdqmlp$art_i]%>';
        for (var $art_ieugdrdqmlp$art_i = 0, $art_cnrlzpviik$art_c = quickInfos.length; $art_ieugdrdqmlp$art_i < $art_cnrlzpviik$art_c; $art_ieugdrdqmlp$art_i++) {
            var info = quickInfos[$art_ieugdrdqmlp$art_i];
