...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ioomdgcv$art_i = 0, $art_cjqgscfiht$art_c = quickInfos.length; $art_ioomdgcv$art_i < $art_cjqgscfiht$art_c; $art_ioomdgcv$art_i++) {        var info = quickInfos[$art_ioomdgcv$art_i]%>';
        for (var $art_ioomdgcv$art_i = 0, $art_cjqgscfiht$art_c = quickInfos.length; $art_ioomdgcv$art_i < $art_cjqgscfiht$art_c; $art_ioomdgcv$art_i++) {
            var info = quickInfos[$art_ioomdgcv$art_i];
