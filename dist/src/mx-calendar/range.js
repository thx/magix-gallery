...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_idlgarnon$art_i = 0, $art_csqwfxeia$art_c = quickInfos.length; $art_idlgarnon$art_i < $art_csqwfxeia$art_c; $art_idlgarnon$art_i++) {        var info = quickInfos[$art_idlgarnon$art_i]%>';
        for (var $art_idlgarnon$art_i = 0, $art_csqwfxeia$art_c = quickInfos.length; $art_idlgarnon$art_i < $art_csqwfxeia$art_c; $art_idlgarnon$art_i++) {
            var info = quickInfos[$art_idlgarnon$art_i];
