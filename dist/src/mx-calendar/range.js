...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ixqmidhrn$art_i = 0, $art_cnlbqwva$art_c = quickInfos.length; $art_ixqmidhrn$art_i < $art_cnlbqwva$art_c; $art_ixqmidhrn$art_i++) {        var info = quickInfos[$art_ixqmidhrn$art_i]%>';
        for (var $art_ixqmidhrn$art_i = 0, $art_cnlbqwva$art_c = quickInfos.length; $art_ixqmidhrn$art_i < $art_cnlbqwva$art_c; $art_ixqmidhrn$art_i++) {
            var info = quickInfos[$art_ixqmidhrn$art_i];
