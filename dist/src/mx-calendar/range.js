...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ituipcoie$art_i = 0, $art_cbrfqm$art_c = quickInfos.length; $art_ituipcoie$art_i < $art_cbrfqm$art_c; $art_ituipcoie$art_i++) {        var info = quickInfos[$art_ituipcoie$art_i]%>';
        for (var $art_ituipcoie$art_i = 0, $art_cbrfqm$art_c = quickInfos.length; $art_ituipcoie$art_i < $art_cbrfqm$art_c; $art_ituipcoie$art_i++) {
            var info = quickInfos[$art_ituipcoie$art_i];
