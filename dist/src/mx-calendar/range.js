...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ivlniypctgf$art_i = 0, $art_cqudoossp$art_c = quickInfos.length; $art_ivlniypctgf$art_i < $art_cqudoossp$art_c; $art_ivlniypctgf$art_i++) {        var info = quickInfos[$art_ivlniypctgf$art_i]%>';
        for (var $art_ivlniypctgf$art_i = 0, $art_cqudoossp$art_c = quickInfos.length; $art_ivlniypctgf$art_i < $art_cqudoossp$art_c; $art_ivlniypctgf$art_i++) {
            var info = quickInfos[$art_ivlniypctgf$art_i];
