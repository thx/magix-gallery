...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ishrodotfk$art_i = 0, $art_czonsy$art_c = quickInfos.length; $art_ishrodotfk$art_i < $art_czonsy$art_c; $art_ishrodotfk$art_i++) {        var info = quickInfos[$art_ishrodotfk$art_i]%>';
        for (var $art_ishrodotfk$art_i = 0, $art_czonsy$art_c = quickInfos.length; $art_ishrodotfk$art_i < $art_czonsy$art_c; $art_ishrodotfk$art_i++) {
            var info = quickInfos[$art_ishrodotfk$art_i];
