...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ibpxrzoehy$art_i = 0, $art_cnhljqjtji$art_c = quickInfos.length; $art_ibpxrzoehy$art_i < $art_cnhljqjtji$art_c; $art_ibpxrzoehy$art_i++) {        var info = quickInfos[$art_ibpxrzoehy$art_i]%>';
        for (var $art_ibpxrzoehy$art_i = 0, $art_cnhljqjtji$art_c = quickInfos.length; $art_ibpxrzoehy$art_i < $art_cnhljqjtji$art_c; $art_ibpxrzoehy$art_i++) {
            var info = quickInfos[$art_ibpxrzoehy$art_i];
