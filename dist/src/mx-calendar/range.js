...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_imvpuadfdn$art_i = 0, $art_cxqbpxpcea$art_c = quickInfos.length; $art_imvpuadfdn$art_i < $art_cxqbpxpcea$art_c; $art_imvpuadfdn$art_i++) {        var info = quickInfos[$art_imvpuadfdn$art_i]%>';
        for (var $art_imvpuadfdn$art_i = 0, $art_cxqbpxpcea$art_c = quickInfos.length; $art_imvpuadfdn$art_i < $art_cxqbpxpcea$art_c; $art_imvpuadfdn$art_i++) {
            var info = quickInfos[$art_imvpuadfdn$art_i];
