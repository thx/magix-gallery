...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iwjrdbkg$art_i = 0, $art_couhtdvoae$art_c = quickInfos.length; $art_iwjrdbkg$art_i < $art_couhtdvoae$art_c; $art_iwjrdbkg$art_i++) {        var info = quickInfos[$art_iwjrdbkg$art_i]%>';
        for (var $art_iwjrdbkg$art_i = 0, $art_couhtdvoae$art_c = quickInfos.length; $art_iwjrdbkg$art_i < $art_couhtdvoae$art_c; $art_iwjrdbkg$art_i++) {
            var info = quickInfos[$art_iwjrdbkg$art_i];
