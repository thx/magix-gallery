...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqmgasdlr$art_i = 0, $art_csxhxssje$art_c = supportQuickDates.length; $art_iqmgasdlr$art_i < $art_csxhxssje$art_c; $art_iqmgasdlr$art_i++) {    var item = supportQuickDates[$art_iqmgasdlr$art_i]%>';
    for (var $art_iqmgasdlr$art_i = 0, $art_csxhxssje$art_c = supportQuickDates.length; $art_iqmgasdlr$art_i < $art_csxhxssje$art_c; $art_iqmgasdlr$art_i++) {
        var item = supportQuickDates[$art_iqmgasdlr$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
