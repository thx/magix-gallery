...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icjxoxj$art_i = 0, $art_cafgyygu$art_c = supportQuickDates.length; $art_icjxoxj$art_i < $art_cafgyygu$art_c; $art_icjxoxj$art_i++) {    var item = supportQuickDates[$art_icjxoxj$art_i]%>';
    for (var $art_icjxoxj$art_i = 0, $art_cafgyygu$art_c = supportQuickDates.length; $art_icjxoxj$art_i < $art_cafgyygu$art_c; $art_icjxoxj$art_i++) {
        var item = supportQuickDates[$art_icjxoxj$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
