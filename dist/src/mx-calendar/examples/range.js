...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iouvicd$art_i = 0, $art_cfcgpvdjif$art_c = supportQuickDates.length; $art_iouvicd$art_i < $art_cfcgpvdjif$art_c; $art_iouvicd$art_i++) {    var item = supportQuickDates[$art_iouvicd$art_i]%>';
    for (var $art_iouvicd$art_i = 0, $art_cfcgpvdjif$art_c = supportQuickDates.length; $art_iouvicd$art_i < $art_cfcgpvdjif$art_c; $art_iouvicd$art_i++) {
        var item = supportQuickDates[$art_iouvicd$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
