...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iixlyhdao$art_i = 0, $art_clwffhhfp$art_c = supportQuickDates.length; $art_iixlyhdao$art_i < $art_clwffhhfp$art_c; $art_iixlyhdao$art_i++) {    var item = supportQuickDates[$art_iixlyhdao$art_i]%>';
    for (var $art_iixlyhdao$art_i = 0, $art_clwffhhfp$art_c = supportQuickDates.length; $art_iixlyhdao$art_i < $art_clwffhhfp$art_c; $art_iixlyhdao$art_i++) {
        var item = supportQuickDates[$art_iixlyhdao$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
