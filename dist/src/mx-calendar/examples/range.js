...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallery~:a" class="clearfix mb20"><div mxa="_zs_gallery~:b" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-calendar/examples/6" id="';
    $line = 62;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo12"></div></div><div mxa="_zs_gallery~:c" class="_zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-calendar/examples/7" id="';
    $line = 67;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_quick" mx-view="mx-title/second?content=%E5%BF%AB%E6%8D%B7%E6%97%A5%E6%9C%9F%E5%A4%87%E9%80%89%E9%A1%B9"></div><div mxa="_zs_gallery~:d" class="pr20 mb40"><table mxa="_zs_gallery~:e" class="table _zs_gallery_Users_liyong_Documents_workspace_js_zs_gallery_tmpl___test___layout_-desc-table"><thead mxs="_zs_gallery~:_"><tr><th width="100">配置key值</th><th width="100">显示文案</th><th width="200">描述</th></tr></thead><tbody>';
    $line = 97;
    $art = 'each supportQuickDates as item';
    ;
    $expr = '<%for (var $art_iqnrvjxlw$art_i = 0, $art_clcyqqtbu$art_c = supportQuickDates.length; $art_iqnrvjxlw$art_i < $art_clcyqqtbu$art_c; $art_iqnrvjxlw$art_i++) {    var item = supportQuickDates[$art_iqnrvjxlw$art_i]%>';
    for (var $art_iqnrvjxlw$art_i = 0, $art_clcyqqtbu$art_c = supportQuickDates.length; $art_iqnrvjxlw$art_i < $art_clcyqqtbu$art_c; $art_iqnrvjxlw$art_i++) {
        var item = supportQuickDates[$art_iqnrvjxlw$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
