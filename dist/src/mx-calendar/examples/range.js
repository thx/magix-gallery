...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iauhztos$art_i = 0, $art_ctpufojtc$art_c = supportQuickDates.length; $art_iauhztos$art_i < $art_ctpufojtc$art_c; $art_iauhztos$art_i++) {    var item = supportQuickDates[$art_iauhztos$art_i]%>';
    for (var $art_iauhztos$art_i = 0, $art_ctpufojtc$art_c = supportQuickDates.length; $art_iauhztos$art_i < $art_ctpufojtc$art_c; $art_iauhztos$art_i++) {
        var item = supportQuickDates[$art_iauhztos$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
