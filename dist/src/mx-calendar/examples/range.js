...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifqojcspuuk$art_i = 0, $art_clldyzygya$art_c = supportQuickDates.length; $art_ifqojcspuuk$art_i < $art_clldyzygya$art_c; $art_ifqojcspuuk$art_i++) {    var item = supportQuickDates[$art_ifqojcspuuk$art_i]%>';
    for (var $art_ifqojcspuuk$art_i = 0, $art_clldyzygya$art_c = supportQuickDates.length; $art_ifqojcspuuk$art_i < $art_clldyzygya$art_c; $art_ifqojcspuuk$art_i++) {
        var item = supportQuickDates[$art_ifqojcspuuk$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
