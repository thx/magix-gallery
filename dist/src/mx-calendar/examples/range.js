...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idqqmejdju$art_i = 0, $art_cnimslmv$art_c = supportQuickDates.length; $art_idqqmejdju$art_i < $art_cnimslmv$art_c; $art_idqqmejdju$art_i++) {    var item = supportQuickDates[$art_idqqmejdju$art_i]%>';
    for (var $art_idqqmejdju$art_i = 0, $art_cnimslmv$art_c = supportQuickDates.length; $art_idqqmejdju$art_i < $art_cnimslmv$art_c; $art_idqqmejdju$art_i++) {
        var item = supportQuickDates[$art_idqqmejdju$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
