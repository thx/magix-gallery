...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipopdbsfbh$art_i = 0, $art_cwyohynzdjb$art_c = supportQuickDates.length; $art_ipopdbsfbh$art_i < $art_cwyohynzdjb$art_c; $art_ipopdbsfbh$art_i++) {    var item = supportQuickDates[$art_ipopdbsfbh$art_i]%>';
    for (var $art_ipopdbsfbh$art_i = 0, $art_cwyohynzdjb$art_c = supportQuickDates.length; $art_ipopdbsfbh$art_i < $art_cwyohynzdjb$art_c; $art_ipopdbsfbh$art_i++) {
        var item = supportQuickDates[$art_ipopdbsfbh$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
