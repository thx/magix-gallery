...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifhkbxchog$art_i = 0, $art_cwiiocxz$art_c = supportQuickDates.length; $art_ifhkbxchog$art_i < $art_cwiiocxz$art_c; $art_ifhkbxchog$art_i++) {    var item = supportQuickDates[$art_ifhkbxchog$art_i]%>';
    for (var $art_ifhkbxchog$art_i = 0, $art_cwiiocxz$art_c = supportQuickDates.length; $art_ifhkbxchog$art_i < $art_cwiiocxz$art_c; $art_ifhkbxchog$art_i++) {
        var item = supportQuickDates[$art_ifhkbxchog$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
