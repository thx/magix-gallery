...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iijjnfc$art_i = 0, $art_cekyhkofzrh$art_c = supportQuickDates.length; $art_iijjnfc$art_i < $art_cekyhkofzrh$art_c; $art_iijjnfc$art_i++) {    var item = supportQuickDates[$art_iijjnfc$art_i]%>';
    for (var $art_iijjnfc$art_i = 0, $art_cekyhkofzrh$art_c = supportQuickDates.length; $art_iijjnfc$art_i < $art_cekyhkofzrh$art_c; $art_iijjnfc$art_i++) {
        var item = supportQuickDates[$art_iijjnfc$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
