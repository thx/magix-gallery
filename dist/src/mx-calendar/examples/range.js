...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irerkv$art_i = 0, $art_cumfzs$art_c = supportQuickDates.length; $art_irerkv$art_i < $art_cumfzs$art_c; $art_irerkv$art_i++) {    var item = supportQuickDates[$art_irerkv$art_i]%>';
    for (var $art_irerkv$art_i = 0, $art_cumfzs$art_c = supportQuickDates.length; $art_irerkv$art_i < $art_cumfzs$art_c; $art_irerkv$art_i++) {
        var item = supportQuickDates[$art_irerkv$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
