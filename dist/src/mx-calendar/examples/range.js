...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixflvaj$art_i = 0, $art_cbbcskmtc$art_c = supportQuickDates.length; $art_ixflvaj$art_i < $art_cbbcskmtc$art_c; $art_ixflvaj$art_i++) {    var item = supportQuickDates[$art_ixflvaj$art_i]%>';
    for (var $art_ixflvaj$art_i = 0, $art_cbbcskmtc$art_c = supportQuickDates.length; $art_ixflvaj$art_i < $art_cbbcskmtc$art_c; $art_ixflvaj$art_i++) {
        var item = supportQuickDates[$art_ixflvaj$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
