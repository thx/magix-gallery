...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwrzdkm$art_i = 0, $art_cmwtwciqs$art_c = supportQuickDates.length; $art_iwrzdkm$art_i < $art_cmwtwciqs$art_c; $art_iwrzdkm$art_i++) {    var item = supportQuickDates[$art_iwrzdkm$art_i]%>';
    for (var $art_iwrzdkm$art_i = 0, $art_cmwtwciqs$art_c = supportQuickDates.length; $art_iwrzdkm$art_i < $art_cmwtwciqs$art_c; $art_iwrzdkm$art_i++) {
        var item = supportQuickDates[$art_iwrzdkm$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
