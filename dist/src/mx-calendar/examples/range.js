...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioakpoj$art_i = 0, $art_cvekhjbiubs$art_c = supportQuickDates.length; $art_ioakpoj$art_i < $art_cvekhjbiubs$art_c; $art_ioakpoj$art_i++) {    var item = supportQuickDates[$art_ioakpoj$art_i]%>';
    for (var $art_ioakpoj$art_i = 0, $art_cvekhjbiubs$art_c = supportQuickDates.length; $art_ioakpoj$art_i < $art_cvekhjbiubs$art_c; $art_ioakpoj$art_i++) {
        var item = supportQuickDates[$art_ioakpoj$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
