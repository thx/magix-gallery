...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izvybrgta$art_i = 0, $art_crygnkxb$art_c = supportQuickDates.length; $art_izvybrgta$art_i < $art_crygnkxb$art_c; $art_izvybrgta$art_i++) {    var item = supportQuickDates[$art_izvybrgta$art_i]%>';
    for (var $art_izvybrgta$art_i = 0, $art_crygnkxb$art_c = supportQuickDates.length; $art_izvybrgta$art_i < $art_crygnkxb$art_c; $art_izvybrgta$art_i++) {
        var item = supportQuickDates[$art_izvybrgta$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
