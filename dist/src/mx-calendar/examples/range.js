...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwzsgoyjyp$art_i = 0, $art_chmryavb$art_c = supportQuickDates.length; $art_iwzsgoyjyp$art_i < $art_chmryavb$art_c; $art_iwzsgoyjyp$art_i++) {    var item = supportQuickDates[$art_iwzsgoyjyp$art_i]%>';
    for (var $art_iwzsgoyjyp$art_i = 0, $art_chmryavb$art_c = supportQuickDates.length; $art_iwzsgoyjyp$art_i < $art_chmryavb$art_c; $art_iwzsgoyjyp$art_i++) {
        var item = supportQuickDates[$art_iwzsgoyjyp$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
