...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iowpfib$art_i = 0, $art_cjphoqzmo$art_c = supportQuickDates.length; $art_iowpfib$art_i < $art_cjphoqzmo$art_c; $art_iowpfib$art_i++) {    var item = supportQuickDates[$art_iowpfib$art_i]%>';
    for (var $art_iowpfib$art_i = 0, $art_cjphoqzmo$art_c = supportQuickDates.length; $art_iowpfib$art_i < $art_cjphoqzmo$art_c; $art_iowpfib$art_i++) {
        var item = supportQuickDates[$art_iowpfib$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
