...
module.exports = Magix.View.extend({
    ...
    if (result.endStr) {
        ;
        $p += '<span mxa="_zs_galleryab:_" class="_zs_gallery_mx-calendar_rangepicker_-co _zs_gallery_mx-calendar_rangepicker_-co-left">';
        $line = 5;
        $art = '=result.startStr';
        ;
        $p += ($expr = '<%=result.startStr%>', $e(result.startStr)) + '</span><span mxa="_zs_galleryab:a" class="_zs_gallery_mx-calendar_rangepicker_-center color-9">';
        $line = 6;
        $art = '=result.centetTip';
        ;
        $p += ($expr = '<%=result.centetTip%>', $e(result.centetTip)) + '</span><span mxa="_zs_galleryab:b" class="_zs_gallery_mx-calendar_rangepicker_-co _zs_gallery_mx-calendar_rangepicker_-co-right">';
        $line = 7;
        $art = '=result.endStr';
        ;
