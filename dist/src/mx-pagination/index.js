...
exports["default"] = View.extend({
    ...
    if (!simplify && !mini) {
        ;
        $p += '<div mxv mxa="_zs_gallerydv:a" class="_zs_gallery_mx-pagination_index_-infos"><span>';
        $line = 4;
        $art = '!tipOffset';
        ;
    ...
    if (!jump) {
        ;
        $p += '<div mxv mxa="_zs_gallerydv:b" class="_zs_gallery_mx-pagination_index_-quick"><span mxa="_zs_gallerydv:c" class="mr5">';
        $line = 26;
        $art = '=tipJumpTo';
        ;
        ...
        ;
        $p += '/><span mxa="_zs_gallerydv:d" class="mr10">';
        $line = 33;
        $art = '=tipJumpUnit';
        ;
    ...
    if (mini) {
        ;
        $p += '<li mxa="_zs_gallerydv:f" class="_zs_gallery_mx-pagination_index_-num-item">';
        $line = 47;
        $art = '=page';
        ;
        $p += ($expr = '<%=page%>', $e(page)) + ' / ';
        ...
        if (start > 1) {
            ;
            $p += '<li mxa="_zs_gallerydv:g" class="_zs_gallery_mx-pagination_index_-num-item"><a class="_zs_gallery_mx-pagination_index_-num-item-inner" href="#" mx-click="' + $viewId + '@{toPage}({page:1})" ';
            $line = 51;
            $art = 'if spm';
            ;
            $expr = '<%if (spm) {%>';
        ...
        if (start > 2) {
            ;
            $p += '<li mxs="_zs_gallerydv:_" class="_zs_gallery_mx-pagination_index_-num-item"><a class="_zs_gallery_mx-pagination_index_-num-item-inner _zs_gallery_mx-pagination_index_-notallowed" href="#" mx-click="' + $viewId + '@{prevent}()">...</a></li>';
            $line = 58;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        for (var i = start; i <= end; i++) {
            ;
            $p += '<li mxa="_zs_gallerydv:h" class="_zs_gallery_mx-pagination_index_-num-item"><a class="_zs_gallery_mx-pagination_index_-num-item-inner ';
            $line = 61;
            $art = 'if (i==page)';
            ;
            $expr = '<%if (i == page) {%>';
        ...
        if (end < pages) {
            ;
            $p += '<li mxa="_zs_gallerydv:i" class="_zs_gallery_mx-pagination_index_-num-item"><a class="_zs_gallery_mx-pagination_index_-num-item-inner" href="#" mx-click="' + $viewId + '@{toPage}({page:\'';
            $line = 71;
            $art = '=pages';
            ;
    ...
    ;
    $p += '<li mxa="_zs_gallerydv:j" class="_zs_gallery_mx-pagination_index_-num-item"><a class="mc-iconfont _zs_gallery_mx-pagination_index_-num-item-icon rotate180 ';
    $line = 78;
    $art = 'if (page==pages)';
    ;
    $expr = '<%if (page == pages) {%>';
    ...
    if (!hideTotal) {
        ;
        $p += '<li mxa="_zs_gallerydv:k" class="_zs_gallery_mx-pagination_index_-num-item ml10">';
        $line = 83;
        $art = '!tipTotal';
        ;
