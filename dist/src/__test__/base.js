...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inibexci$art_i = 0, $art_cqzwbnxm$art_c = headers.length; $art_inibexci$art_i < $art_cqzwbnxm$art_c; $art_inibexci$art_i++) {    var h = headers[$art_inibexci$art_i]%>';
    for (var $art_inibexci$art_i = 0, $art_cqzwbnxm$art_c = headers.length; $art_inibexci$art_i < $art_cqzwbnxm$art_c; $art_inibexci$art_i++) {
        var h = headers[$art_inibexci$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_idcqnha$art_i = 0, $art_cdcucbyu$art_c = list.length; $art_idcqnha$art_i < $art_cdcucbyu$art_c; $art_idcqnha$art_i++) {    var item = list[$art_idcqnha$art_i]%>';
    for (var $art_idcqnha$art_i = 0, $art_cdcucbyu$art_c = list.length; $art_idcqnha$art_i < $art_cdcucbyu$art_c; $art_idcqnha$art_i++) {
        var item = list[$art_idcqnha$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iizilblqg$art_i = 0, $art_objqgpodefg$art_obj = item.subs, $art_cvsdaf$art_c = $art_objqgpodefg$art_obj.length; $art_iizilblqg$art_i < $art_cvsdaf$art_c; $art_iizilblqg$art_i++) {        var sub = $art_objqgpodefg$art_obj[$art_iizilblqg$art_i]%>';
        for (var $art_iizilblqg$art_i = 0, $art_objqgpodefg$art_obj = item.subs, $art_cvsdaf$art_c = $art_objqgpodefg$art_obj.length; $art_iizilblqg$art_i < $art_cvsdaf$art_c; $art_iizilblqg$art_i++) {
            var sub = $art_objqgpodefg$art_obj[$art_iizilblqg$art_i];
