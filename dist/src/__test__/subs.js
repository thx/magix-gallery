...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idnbdpdnviq$art_i = 0, $art_ckzslnbplif$art_c = list.length; $art_idnbdpdnviq$art_i < $art_ckzslnbplif$art_c; $art_idnbdpdnviq$art_i++) {    var item = list[$art_idnbdpdnviq$art_i]%>';
    for (var $art_idnbdpdnviq$art_i = 0, $art_ckzslnbplif$art_c = list.length; $art_idnbdpdnviq$art_i < $art_ckzslnbplif$art_c; $art_idnbdpdnviq$art_i++) {
        var item = list[$art_idnbdpdnviq$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_iarmpto$art_i = 0, $art_objootqdhadz$art_obj = item.subs, $art_cjnlgwf$art_c = $art_objootqdhadz$art_obj.length; $art_iarmpto$art_i < $art_cjnlgwf$art_c; $art_iarmpto$art_i++) {            var sub = $art_objootqdhadz$art_obj[$art_iarmpto$art_i]%>';
            for (var $art_iarmpto$art_i = 0, $art_objootqdhadz$art_obj = item.subs, $art_cjnlgwf$art_c = $art_objootqdhadz$art_obj.length; $art_iarmpto$art_i < $art_cjnlgwf$art_c; $art_iarmpto$art_i++) {
                var sub = $art_objootqdhadz$art_obj[$art_iarmpto$art_i];
