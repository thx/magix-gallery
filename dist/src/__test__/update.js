...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icqicwdvc$art_i = 0, $art_cktvymaj$art_c = list.length; $art_icqicwdvc$art_i < $art_cktvymaj$art_c; $art_icqicwdvc$art_i++) {    var item = list[$art_icqicwdvc$art_i]%>';
    for (var $art_icqicwdvc$art_i = 0, $art_cktvymaj$art_c = list.length; $art_icqicwdvc$art_i < $art_cktvymaj$art_c; $art_icqicwdvc$art_i++) {
        var item = list[$art_icqicwdvc$art_i];
        ...
        ;
        $expr = '<%for (var $art_iusckknuuc$art_i = 0, $art_objnnzetrtt$art_obj = item.subs, $art_cetllgyzpn$art_c = $art_objnnzetrtt$art_obj.length; $art_iusckknuuc$art_i < $art_cetllgyzpn$art_c; $art_iusckknuuc$art_i++) {        var s = $art_objnnzetrtt$art_obj[$art_iusckknuuc$art_i]%>';
        for (var $art_iusckknuuc$art_i = 0, $art_objnnzetrtt$art_obj = item.subs, $art_cetllgyzpn$art_c = $art_objnnzetrtt$art_obj.length; $art_iusckknuuc$art_i < $art_cetllgyzpn$art_c; $art_iusckknuuc$art_i++) {
            var s = $art_objnnzetrtt$art_obj[$art_iusckknuuc$art_i];
            ...
            ;
            $expr = '<%for (var $art_ijofnoghe$art_i = 0, $art_objfnorip$art_obj = s.subs, $art_ceebbvgxb$art_c = $art_objfnorip$art_obj.length; $art_ijofnoghe$art_i < $art_ceebbvgxb$art_c; $art_ijofnoghe$art_i++) {            var ss = $art_objfnorip$art_obj[$art_ijofnoghe$art_i]%>';
            for (var $art_ijofnoghe$art_i = 0, $art_objfnorip$art_obj = s.subs, $art_ceebbvgxb$art_c = $art_objfnorip$art_obj.length; $art_ijofnoghe$art_i < $art_ceebbvgxb$art_c; $art_ijofnoghe$art_i++) {
                var ss = $art_objfnorip$art_obj[$art_ijofnoghe$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ixcupmemm$art_i = 0, $art_objvsigdm$art_obj = ss.subs, $art_chpzohv$art_c = $art_objvsigdm$art_obj.length; $art_ixcupmemm$art_i < $art_chpzohv$art_c; $art_ixcupmemm$art_i++) {                    var sss = $art_objvsigdm$art_obj[$art_ixcupmemm$art_i]%>';
                    for (var $art_ixcupmemm$art_i = 0, $art_objvsigdm$art_obj = ss.subs, $art_chpzohv$art_c = $art_objvsigdm$art_obj.length; $art_ixcupmemm$art_i < $art_chpzohv$art_c; $art_ixcupmemm$art_i++) {
                        var sss = $art_objvsigdm$art_obj[$art_ixcupmemm$art_i];
