...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwkvezv$art_i = 0, $art_covzkptgl$art_c = themes.length; $art_iwkvezv$art_i < $art_covzkptgl$art_c; $art_iwkvezv$art_i++) {    var t = themes[$art_iwkvezv$art_i]%>';
    for (var $art_iwkvezv$art_i = 0, $art_covzkptgl$art_c = themes.length; $art_iwkvezv$art_i < $art_covzkptgl$art_c; $art_iwkvezv$art_i++) {
        var t = themes[$art_iwkvezv$art_i];
