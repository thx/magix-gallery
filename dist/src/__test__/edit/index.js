...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_csdatjdag$art_c = themes.length; i < $art_csdatjdag$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_csdatjdag$art_c = themes.length; i < $art_csdatjdag$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iqlhnhlmmi$art_i = 0, $art_czirfvpo$art_c = list.length; $art_iqlhnhlmmi$art_i < $art_czirfvpo$art_c; $art_iqlhnhlmmi$art_i++) {    var group = list[$art_iqlhnhlmmi$art_i]%>';
    for (var $art_iqlhnhlmmi$art_i = 0, $art_czirfvpo$art_c = list.length; $art_iqlhnhlmmi$art_i < $art_czirfvpo$art_c; $art_iqlhnhlmmi$art_i++) {
        var group = list[$art_iqlhnhlmmi$art_i];
        ...
        ;
        $expr = '<%for (var $art_iguxbjke$art_i = 0, $art_objtfkdtwobgj$art_obj = group.subs, $art_cpokegwz$art_c = $art_objtfkdtwobgj$art_obj.length; $art_iguxbjke$art_i < $art_cpokegwz$art_c; $art_iguxbjke$art_i++) {        var item = $art_objtfkdtwobgj$art_obj[$art_iguxbjke$art_i]%>';
        for (var $art_iguxbjke$art_i = 0, $art_objtfkdtwobgj$art_obj = group.subs, $art_cpokegwz$art_c = $art_objtfkdtwobgj$art_obj.length; $art_iguxbjke$art_i < $art_cpokegwz$art_c; $art_iguxbjke$art_i++) {
            var item = $art_objtfkdtwobgj$art_obj[$art_iguxbjke$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iqlhnhlmmi$art_i%>', $e($art_iqlhnhlmmi$art_i)) + '_' + ($expr = '<%=$art_iguxbjke$art_i%>', $e($art_iguxbjke$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iqlhnhlmmi$art_i%>', $e($art_iqlhnhlmmi$art_i)) + '.subs.' + ($expr = '<%=$art_iguxbjke$art_i%>', $e($art_iguxbjke$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iqlhnhlmmi$art_i%>', $e($art_iqlhnhlmmi$art_i)) + '_' + ($expr = '<%=$art_iguxbjke$art_i%>', $e($art_iguxbjke$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iqlhnhlmmi$art_i%>', $e($art_iqlhnhlmmi$art_i)) + '.subs.' + ($expr = '<%=$art_iguxbjke$art_i%>', $e($art_iguxbjke$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
