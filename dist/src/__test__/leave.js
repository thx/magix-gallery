...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isavvy$art_i = 0, $art_cgwfqksnujh$art_c = checkboxes.length; $art_isavvy$art_i < $art_cgwfqksnujh$art_c; $art_isavvy$art_i++) {    var c = checkboxes[$art_isavvy$art_i]%>';
    for (var $art_isavvy$art_i = 0, $art_cgwfqksnujh$art_c = checkboxes.length; $art_isavvy$art_i < $art_cgwfqksnujh$art_c; $art_isavvy$art_i++) {
        var c = checkboxes[$art_isavvy$art_i];
    ...
    ;
    $expr = '<%for (var $art_iettrpnfev$art_i = 0, $art_ccgkdxysv$art_c = radioes.length; $art_iettrpnfev$art_i < $art_ccgkdxysv$art_c; $art_iettrpnfev$art_i++) {    var r = radioes[$art_iettrpnfev$art_i]%>';
    for (var $art_iettrpnfev$art_i = 0, $art_ccgkdxysv$art_c = radioes.length; $art_iettrpnfev$art_i < $art_ccgkdxysv$art_c; $art_iettrpnfev$art_i++) {
        var r = radioes[$art_iettrpnfev$art_i];
