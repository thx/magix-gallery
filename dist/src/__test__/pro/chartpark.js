...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_access" mx-view="mx-title/second?content=%E6%8E%A5%E5%85%A5%E6%B5%81%E7%A8%8B"></div><div mxs="_zs_galleryo:a" class="mb40"><div class="mb20">1. 新建项目</div><div class="pr20 pl15"><img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB18x7gunCWBKNjSZFtXXaC3FXa-2080-1006.jpg"/> <img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB1hT3btZIrBKNjSZK9XXagoVXa-2208-1006.jpg"/></div></div><div mxs="_zs_galleryo:b" class="mb40"><div class="mb20">2. 从官方demo选取需要的图表加入我的项目</div><div class="pr20 pl15"><img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB155spkhtnkeRjSZSgXXXAuXXa-2042-1480.jpg"/> <img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB1uiosumcqBKNjSZFgXXX_kXXa-2868-1290.jpg"/></div></div><div mxs="_zs_galleryo:c" class="mb40"><div class="mb20">3. chartpark平台增加或修改过图表，选择cdn，es，打包推送至cdn</div><div class="pr20 pl15"><img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB1kOEItWQoBKNjSZJnXXaw9VXa-2322-1554.jpg"/></div></div><div mxs="_zs_galleryo:d" class="mb40"><div class="mb20">4. 项目 package.json 配置 chartParkId，目前只能从地址栏看到ID</div><div class="pr20 pl15"><img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB1CrjTuiAnBKNjSZFvXXaTKXXa-2438-1144.jpg"/> <img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB18HUXt7ZmBKNjSZPiXXXFNVXa-2514-1660.jpg"/></div></div><div mxs="_zs_galleryo:e" class="mb40"><div class="mb20">5. 执行 mx chartpark 同步图表文件到本地（内容包含图表配置）</div></div><div id="';
    $line = 54;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo_id" mx-view="mx-title/second?content=%E7%9B%B4%E6%8E%A5%E4%BD%BF%E7%94%A8chart-id&tip=%E5%BD%93chartpark%E7%9A%84%E9%85%8D%E7%BD%AE%E5%B7%B2%E7%BB%8F%E6%BB%A1%E8%B6%B3%E9%9C%80%E6%B1%82%E7%9A%84%E6%97%B6%E5%80%99%EF%BC%8C%E5%8F%AF%E7%9B%B4%E6%8E%A5%E4%BD%BF%E7%94%A8%20chart-id%20%E6%B8%B2%E6%9F%93%E5%9B%BE%E8%A1%A8"></div><div mxs="_zs_galleryo:f" class="mb40"><div class="mb20">1. 获取chart-id</div><div class="pr20 pl15"><img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB13ZEFuiAnBKNjSZFvXXaTKXXa-2878-1552.jpg"/></div></div><div mxs="_zs_galleryo:g" class="clearfix mb40"><div class="mb20">2. 使用</div><div class="pl15" mx-view="__test__/pro/chartpark-id"></div></div><div id="';
    $line = 73;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo_custom" mx-view="mx-title/second?content=%E8%87%AA%E5%AE%9A%E4%B9%89chart-option&tip=%E9%80%9A%E8%BF%87%20chart-id%20%E8%8E%B7%E5%8F%96%E5%9F%BA%E7%A1%80%E9%85%8D%E7%BD%AE%EF%BC%8C%E5%86%8D%E8%BF%9B%E8%A1%8C%E6%89%A9%E5%B1%95%E5%AE%9A%E5%88%B6"></div><div mxs="_zs_galleryo:f" class="mb40"><div class="mb20">1. 获取chart-id</div><div class="pr20 pl15"><img class="_zs_gallery___test___pro_chartpark_-chart-img" src="https://img.alicdn.com/tfs/TB13ZEFuiAnBKNjSZFvXXaTKXXa-2878-1552.jpg"/></div></div><div mxs="_zs_galleryo:h" class="clearfix mb40"><div class="mb20">2. 使用</div><div class="pl15" mx-view="__test__/pro/chartpark-custom"></div></div></div>';
}
catch (ex) {
