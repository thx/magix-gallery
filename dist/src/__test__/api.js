...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iackmrmm$art_i = 0, $art_cmyjxnhnav$art_c = options.length; $art_iackmrmm$art_i < $art_cmyjxnhnav$art_c; $art_iackmrmm$art_i++) {    var option = options[$art_iackmrmm$art_i]%>';
    for (var $art_iackmrmm$art_i = 0, $art_cmyjxnhnav$art_c = options.length; $art_iackmrmm$art_i < $art_cmyjxnhnav$art_c; $art_iackmrmm$art_i++) {
        var option = options[$art_iackmrmm$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
