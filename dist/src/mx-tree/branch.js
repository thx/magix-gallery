...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_chmzol$art_c = list.length; index < $art_chmzol$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_chmzol$art_c = list.length; index < $art_chmzol$art_c; index++) {
        var item = list[index];
