...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryfD:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryfD:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryfD:_" class="mb10"><span class="color-9">使用场景：</span>切换页码的时候保留历史选中项，无需实时反馈选中结果</div><div mxa="_zs_galleryfD:b" class="mb20"><span mxs="_zs_galleryfD:a" class="color-9">当前选中单元：</span>';
    $line = 9;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</div><div mxv mxa="_zs_galleryfD:c" class="_zs_gallery_mx-tree_examples_index_-wrapper"><div mxv mxa="_zs_galleryfD:d" class="_zs_gallery_mx-tree_examples_index_-content"><div mxv="selected,list" id="';
    $line = 13;
    $art = '=viewId';
    ;
    ...
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '&needAll=true"></div></div><div mxs="_zs_galleryfD:b" class="table-pager-wrapper" mx-change="' + $viewId + 'changePager()" mx-view="mx-pagination/index?total=10&size=5&page=1&mini=true&jump=false"></div></div></div><div mxa="_zs_galleryfD:e" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryfD:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 29;
    $art = '=viewId';
    ;
