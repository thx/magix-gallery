...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryfe:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryfe:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryfe:_" class="mb10 clearfix"><div class="color-9 fl">使用场景：</div><div class="fl"><div>双向绑定，实时反馈选中结果，每次操作都响应事件</div><div>默认选中某些选项</div><div>可展开收起子选项</div></div></div><div mxa="_zs_galleryfe:b" class="mb20"><span mxs="_zs_galleryfe:a" class="color-9">当前已选中：</span><span>';
    $line = 13;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</span></div><div mxs="_zs_galleryfe:b" class="mb20"><span class="color-9">说明：</span><span class="color-brand mr10">修改数据时保留历史选中数据+展开收起状态</span><a href="javascript:;" mx-click="' + $viewId + 'changeData()" class="btn btn-brand">修改数据</a></div><div mxv mxa="_zs_galleryfe:c" class="_zs_gallery_mx-tree_examples_index_-wrapper"><div mxv mxa="_zs_galleryfe:d" class="_zs_gallery_mx-tree_examples_index_-content"><div mxv="list,selected" mxe="' + $viewId + '_0" mxc="[';
    $line = 26;
    ...
    $art = ':selected{refresh:true}';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '"></div></div></div></div><div mxa="_zs_galleryfe:e" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_galleryfe:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 32;
    $art = '=viewId';
    ;
