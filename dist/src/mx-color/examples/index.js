/*
    ...
    loader: cmd_es
 */
define("mx-color/examples/index",["magix","$","examples/subs","mx-title/second","./1","./3","./2","examples/api","examples/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaH:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'trigger+选择\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'显示选择值\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'对齐方式\',\n            key: viewId + \'_demo2\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryaH:a" class="clearfix mb20"><div mxa="_zs_galleryaH:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-color/examples/1" id="';
    $line = 26;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div></div><div mxa="_zs_galleryaH:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-color/examples/3" id="';
    $line = 29;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div><div mx-view="mx-color/examples/2" id="';
    $line = 30;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-color/examples/index.html';
    throw msg;
} return $p; },
    render: function () {
        var that = this;
