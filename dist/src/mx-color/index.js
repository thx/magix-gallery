...
module.exports = Magix.View.extend({
    ...
    $p += '<div id="scs_' + ($expr = '<%=id%>', $e(id)) + '"><ul mxa="_zs_galleryaK:_" class="_zs_gallery_mx-color_index_-shortcuts clearfix">';
    ...
    ;
    $p += '</ul></div><div mxa="_zs_galleryaK:a" class="_zs_gallery_mx-color_index_-cbd clearfix"><div class="_zs_gallery_mx-color_index_-cpicker" id="cz_' + ($expr = '<%=id%>', $e(id)) + '" mx-mousedown="' + $viewId + '@{color.zone.drag}()"><svg mxa="_zs_galleryaK:b" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%"><defs><lineargradient id="gb_' + ($expr = '<%=id%>', $e(id)) + '" x1="0%" y1="100%" x2="0%" y2="0%"><stop mxs="_zs_galleryaK:_" offset="0%" stop-color="#000000" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:a" offset="100%" stop-color="#CC9A81" stop-opacity="0"></stop></lineargradient><lineargradient id="gw_' + ($expr = '<%=id%>', $e(id)) + '" x1="0%" y1="100%" x2="100%" y2="100%"><stop mxs="_zs_galleryaK:b" offset="0%" stop-color="#FFFFFF" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:a" offset="100%" stop-color="#CC9A81" stop-opacity="0"></stop></lineargradient></defs><rect x="0" y="0" width="100%" height="100%" fill="url(#gw_' + ($expr = '<%=id%>', $e(id)) + ')"></rect><rect x="0" y="0" width="100%" height="100%" fill="url(#gb_' + ($expr = '<%=id%>', $e(id)) + ')"></rect></svg><div class="_zs_gallery_mx-color_index_-cpicker-indicator" id="ci_' + ($expr = '<%=id%>', $e(id)) + '"></div></div><div mxa="_zs_galleryaK:c" class="_zs_gallery_mx-color_index_-slide" mx-mousedown="' + $viewId + '@{slide.drag}()"><svg mxa="_zs_galleryaK:d" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%"><defs><lineargradient id="ghsv_' + ($expr = '<%=id%>', $e(id)) + '" x1="0%" y1="100%" x2="0%" y2="0%"><stop mxs="_zs_galleryaK:c" offset="0%" stop-color="#FF0000" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:d" offset="13%" stop-color="#FF00FF" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:e" offset="25%" stop-color="#8000FF" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:f" offset="38%" stop-color="#0040FF" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:g" offset="50%" stop-color="#00FFFF" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:h" offset="63%" stop-color="#00FF40" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:i" offset="75%" stop-color="#0BED00" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:j" offset="88%" stop-color="#FFFF00" stop-opacity="1"></stop><stop mxs="_zs_galleryaK:k" offset="100%" stop-color="#FF0000" stop-opacity="1"></stop></lineargradient></defs><rect x="0" y="0" width="100%" height="100%" fill="url(#ghsv_' + ($expr = '<%=id%>', $e(id)) + ')"></rect></svg><div class="_zs_gallery_mx-color_index_-slide-indicator" id="si_' + ($expr = '<%=id%>', $e(id)) + '"></div></div></div>';
    $expr = '<%if (alpha) {%>';
    if (alpha) {
        ;
        $p += '<div mxa="_zs_galleryaK:e" class="_zs_gallery_mx-color_index_-alpha pr"><div class="_zs_gallery_mx-color_index_-alpha-tracker" id="at_' + ($expr = '<%=id%>', $e(id)) + '" mx-mousedown="' + $viewId + '@{alpha.drag}()"><div class="_zs_gallery_mx-color_index_-alpha-indicator" id="ai_' + ($expr = '<%=id%>', $e(id)) + '"></div></div></div>';
        $expr = '<%}%>';
    }
    ;
    $p += '<div mxv mxa="_zs_galleryaK:f" class="_zs_gallery_mx-color_index_-foot clearfix"><span class="fl _zs_gallery_mx-color_index_-bg-color" id="bc_' + ($expr = '<%=id%>', $e(id)) + '"></span><input class="fl input _zs_gallery_mx-color_index_-color-value" id="v_' + ($expr = '<%=id%>', $e(id)) + '" mx-keyup="' + $viewId + '@{input.end}()" mx-paste="' + $viewId + '@{input.end}()" mx-change="' + $viewId + '@{stop}()" mx-focusin="' + $viewId + '@{stop}()" mx-focusout="' + $viewId + '@{stop}()"/>';
    $expr = '<%if (btns) {%>';
    if (btns) {
        ;
        $p += '<a mxs="_zs_galleryaK:l" href="javascript:;" class="fr btn btn-brand _zs_gallery_mx-color_index_-submit-btn" mx-click="' + $viewId + '@{enter}()">确定</a>';
        $expr = '<%}%>';
    }
    ;
    $p += '</div>';
