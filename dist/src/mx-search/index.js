...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itutyqo$art_i = 0, $art_ckwrqmxe$art_c = list.length; $art_itutyqo$art_i < $art_ckwrqmxe$art_c; $art_itutyqo$art_i++) {    var item = list[$art_itutyqo$art_i]%>';
    for (var $art_itutyqo$art_i = 0, $art_ckwrqmxe$art_c = list.length; $art_itutyqo$art_i < $art_ckwrqmxe$art_c; $art_itutyqo$art_i++) {
        var item = list[$art_itutyqo$art_i];
