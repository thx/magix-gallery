...
exports["default"] = View.extend({
    ...
    ;
    $expr = '<%for (var $art_irphtozja$art_i = 0, $art_cbauuzrhcr$art_c = list.length; $art_irphtozja$art_i < $art_cbauuzrhcr$art_c; $art_irphtozja$art_i++) {    var item = list[$art_irphtozja$art_i]%>';
    for (var $art_irphtozja$art_i = 0, $art_cbauuzrhcr$art_c = list.length; $art_irphtozja$art_i < $art_cbauuzrhcr$art_c; $art_irphtozja$art_i++) {
        var item = list[$art_irphtozja$art_i];
