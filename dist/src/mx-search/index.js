...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifofrttkr$art_i = 0, $art_cuoudmdq$art_c = list.length; $art_ifofrttkr$art_i < $art_cuoudmdq$art_c; $art_ifofrttkr$art_i++) {    var item = list[$art_ifofrttkr$art_i]%>';
    for (var $art_ifofrttkr$art_i = 0, $art_cuoudmdq$art_c = list.length; $art_ifofrttkr$art_i < $art_cuoudmdq$art_c; $art_ifofrttkr$art_i++) {
        var item = list[$art_ifofrttkr$art_i];
