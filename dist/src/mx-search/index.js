...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixrtukctcrn$art_i = 0, $art_cmvaxfzhyub$art_c = list.length; $art_ixrtukctcrn$art_i < $art_cmvaxfzhyub$art_c; $art_ixrtukctcrn$art_i++) {    var item = list[$art_ixrtukctcrn$art_i]%>';
    for (var $art_ixrtukctcrn$art_i = 0, $art_cmvaxfzhyub$art_c = list.length; $art_ixrtukctcrn$art_i < $art_cmvaxfzhyub$art_c; $art_ixrtukctcrn$art_i++) {
        var item = list[$art_ixrtukctcrn$art_i];
