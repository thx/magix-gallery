...
exports["default"] = View.extend({
    ...
    ;
    $expr = '<%for (var $art_iydiwec$art_i = 0, $art_cienfzrpgd$art_c = list.length; $art_iydiwec$art_i < $art_cienfzrpgd$art_c; $art_iydiwec$art_i++) {    var item = list[$art_iydiwec$art_i]%>';
    for (var $art_iydiwec$art_i = 0, $art_cienfzrpgd$art_c = list.length; $art_iydiwec$art_i < $art_cienfzrpgd$art_c; $art_iydiwec$art_i++) {
        var item = list[$art_iydiwec$art_i];
