...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iryoyofgysd$art_i = 0, $art_crqjzjyz$art_c = list.length; $art_iryoyofgysd$art_i < $art_crqjzjyz$art_c; $art_iryoyofgysd$art_i++) {    var item = list[$art_iryoyofgysd$art_i]%>';
    for (var $art_iryoyofgysd$art_i = 0, $art_crqjzjyz$art_c = list.length; $art_iryoyofgysd$art_i < $art_crqjzjyz$art_c; $art_iryoyofgysd$art_i++) {
        var item = list[$art_iryoyofgysd$art_i];
