...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqyayprs$art_i = 0, $art_csrfkh$art_c = list.length; $art_iqyayprs$art_i < $art_csrfkh$art_c; $art_iqyayprs$art_i++) {    var item = list[$art_iqyayprs$art_i]%>';
    for (var $art_iqyayprs$art_i = 0, $art_csrfkh$art_c = list.length; $art_iqyayprs$art_i < $art_csrfkh$art_c; $art_iqyayprs$art_i++) {
        var item = list[$art_iqyayprs$art_i];
