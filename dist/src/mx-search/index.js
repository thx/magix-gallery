...
exports["default"] = View.extend({
    ...
    ;
    $expr = '<%for (var $art_iroiscwr$art_i = 0, $art_cexfortv$art_c = list.length; $art_iroiscwr$art_i < $art_cexfortv$art_c; $art_iroiscwr$art_i++) {    var item = list[$art_iroiscwr$art_i]%>';
    for (var $art_iroiscwr$art_i = 0, $art_cexfortv$art_c = list.length; $art_iroiscwr$art_i < $art_cexfortv$art_c; $art_iroiscwr$art_i++) {
        var item = list[$art_iroiscwr$art_i];
