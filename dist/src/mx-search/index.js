...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iclxje$art_i = 0, $art_cnbbalxech$art_c = list.length; $art_iclxje$art_i < $art_cnbbalxech$art_c; $art_iclxje$art_i++) {    var item = list[$art_iclxje$art_i]%>';
    for (var $art_iclxje$art_i = 0, $art_cnbbalxech$art_c = list.length; $art_iclxje$art_i < $art_cnbbalxech$art_c; $art_iclxje$art_i++) {
        var item = list[$art_iclxje$art_i];
