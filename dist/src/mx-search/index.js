...
exports["default"] = View.extend({
    ...
    ;
    $expr = '<%for (var $art_ishhzkusk$art_i = 0, $art_cezamgodl$art_c = list.length; $art_ishhzkusk$art_i < $art_cezamgodl$art_c; $art_ishhzkusk$art_i++) {    var item = list[$art_ishhzkusk$art_i]%>';
    for (var $art_ishhzkusk$art_i = 0, $art_cezamgodl$art_c = list.length; $art_ishhzkusk$art_i < $art_cezamgodl$art_c; $art_ishhzkusk$art_i++) {
        var item = list[$art_ishhzkusk$art_i];
