...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iemvgagxa$art_i = 0, $art_cnvxiczpzb$art_c = list.length; $art_iemvgagxa$art_i < $art_cnvxiczpzb$art_c; $art_iemvgagxa$art_i++) {    var item = list[$art_iemvgagxa$art_i]%>';
    for (var $art_iemvgagxa$art_i = 0, $art_cnvxiczpzb$art_c = list.length; $art_iemvgagxa$art_i < $art_cnvxiczpzb$art_c; $art_iemvgagxa$art_i++) {
        var item = list[$art_iemvgagxa$art_i];
