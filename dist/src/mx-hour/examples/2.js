...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijypfqirh$art_i = 0, $art_cdpfidbyvo$art_c = selected.length; $art_ijypfqirh$art_i < $art_cdpfidbyvo$art_c; $art_ijypfqirh$art_i++) {    var s = selected[$art_ijypfqirh$art_i]%>';
    for (var $art_ijypfqirh$art_i = 0, $art_cdpfidbyvo$art_c = selected.length; $art_ijypfqirh$art_i < $art_cdpfidbyvo$art_c; $art_ijypfqirh$art_i++) {
        var s = selected[$art_ijypfqirh$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
