...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iodzevgba$art_i = 0, $art_czktxl$art_c = selected.length; $art_iodzevgba$art_i < $art_czktxl$art_c; $art_iodzevgba$art_i++) {    var s = selected[$art_iodzevgba$art_i]%>';
    for (var $art_iodzevgba$art_i = 0, $art_czktxl$art_c = selected.length; $art_iodzevgba$art_i < $art_czktxl$art_c; $art_iodzevgba$art_i++) {
        var s = selected[$art_iodzevgba$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
