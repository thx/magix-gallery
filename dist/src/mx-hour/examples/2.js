...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwahpqhaswg$art_i = 0, $art_cipjxfni$art_c = selected.length; $art_iwahpqhaswg$art_i < $art_cipjxfni$art_c; $art_iwahpqhaswg$art_i++) {    var s = selected[$art_iwahpqhaswg$art_i]%>';
    for (var $art_iwahpqhaswg$art_i = 0, $art_cipjxfni$art_c = selected.length; $art_iwahpqhaswg$art_i < $art_cipjxfni$art_c; $art_iwahpqhaswg$art_i++) {
        var s = selected[$art_iwahpqhaswg$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
