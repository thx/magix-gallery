...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igfjksyyk$art_i = 0, $art_cbawkizs$art_c = selected.length; $art_igfjksyyk$art_i < $art_cbawkizs$art_c; $art_igfjksyyk$art_i++) {    var s = selected[$art_igfjksyyk$art_i]%>';
    for (var $art_igfjksyyk$art_i = 0, $art_cbawkizs$art_c = selected.length; $art_igfjksyyk$art_i < $art_cbawkizs$art_c; $art_igfjksyyk$art_i++) {
        var s = selected[$art_igfjksyyk$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
