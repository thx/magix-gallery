...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc%:_" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-example"><div mxv mxa="_zs_galleryc%:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-content"><div mxs="_zs_galleryc%:_" class="clearfix lh22 mb15"><div class="fl color-9">以下示例：</div><div class="fl"><div>每日单独选择</div><div>提供快捷操作</div></div></div><div mxa="_zs_galleryc%:b" class="mb20 clearfix"><div mxs="_zs_galleryc%:a" class="fl mr10"><a href="javascript:;" class="btn btn-brand" mx-click="' + $viewId + 'get()">获取选中值</a></div><div mxa="_zs_galleryc%:c" class="fl">';
    $line = 16;
    $art = 'each selected as s';
    ;
    $expr = '<%for (var $art_idkuzijqam$art_i = 0, $art_clhnuepuni$art_c = selected.length; $art_idkuzijqam$art_i < $art_clhnuepuni$art_c; $art_idkuzijqam$art_i++) {    var s = selected[$art_idkuzijqam$art_i]%>';
    for (var $art_idkuzijqam$art_i = 0, $art_clhnuepuni$art_c = selected.length; $art_idkuzijqam$art_i < $art_clhnuepuni$art_c; $art_idkuzijqam$art_i++) {
        var s = selected[$art_idkuzijqam$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
