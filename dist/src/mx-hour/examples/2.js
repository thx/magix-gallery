...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iegicllqt$art_i = 0, $art_ctohfodg$art_c = selected.length; $art_iegicllqt$art_i < $art_ctohfodg$art_c; $art_iegicllqt$art_i++) {    var s = selected[$art_iegicllqt$art_i]%>';
    for (var $art_iegicllqt$art_i = 0, $art_ctohfodg$art_c = selected.length; $art_iegicllqt$art_i < $art_ctohfodg$art_c; $art_iegicllqt$art_i++) {
        var s = selected[$art_iegicllqt$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
    ...
    $art = '@selected';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '"></div></div><div mxa="_zs_gallerycS:d" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_gallerycS:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerycS:e" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-tip">';
    $line = 29;
    $art = '!text1';
    ;
