...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iopnynzmzna$art_i = 0, $art_chppjxlsuo$art_c = selected.length; $art_iopnynzmzna$art_i < $art_chppjxlsuo$art_c; $art_iopnynzmzna$art_i++) {    var s = selected[$art_iopnynzmzna$art_i]%>';
    for (var $art_iopnynzmzna$art_i = 0, $art_chppjxlsuo$art_c = selected.length; $art_iopnynzmzna$art_i < $art_chppjxlsuo$art_c; $art_iopnynzmzna$art_i++) {
        var s = selected[$art_iopnynzmzna$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
    ...
    $art = '@selected';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '"></div></div><div mxa="_zs_gallerycI:d" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-desc"><div mxs="_zs_gallerycI:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
