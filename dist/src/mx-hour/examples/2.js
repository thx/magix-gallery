...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icjwdwcgb$art_i = 0, $art_ckjdhod$art_c = selected.length; $art_icjwdwcgb$art_i < $art_ckjdhod$art_c; $art_icjwdwcgb$art_i++) {    var s = selected[$art_icjwdwcgb$art_i]%>';
    for (var $art_icjwdwcgb$art_i = 0, $art_ckjdhod$art_c = selected.length; $art_icjwdwcgb$art_i < $art_ckjdhod$art_c; $art_icjwdwcgb$art_i++) {
        var s = selected[$art_icjwdwcgb$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
