...
exports["default"] = View.extend({
    ...
    if (periods.length == 7) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_idpockzp$art_i = 0, $art_crzjmim$art_c = types.length; $art_idpockzp$art_i < $art_crzjmim$art_c; $art_idpockzp$art_i++) {        var t = types[$art_idpockzp$art_i]%>';
        for (var $art_idpockzp$art_i = 0, $art_crzjmim$art_c = types.length; $art_idpockzp$art_i < $art_crzjmim$art_c; $art_idpockzp$art_i++) {
            var t = types[$art_idpockzp$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ciqhfjd$art_c = periods.length; pIndex < $art_ciqhfjd$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ciqhfjd$art_c = periods.length; pIndex < $art_ciqhfjd$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipxqckocrh$art_i = 0, $art_objspkbg$art_obj = p.hours, $art_cjvkjft$art_c = $art_objspkbg$art_obj.length; $art_ipxqckocrh$art_i < $art_cjvkjft$art_c; $art_ipxqckocrh$art_i++) {        var h = $art_objspkbg$art_obj[$art_ipxqckocrh$art_i]%>';
        for (var $art_ipxqckocrh$art_i = 0, $art_objspkbg$art_obj = p.hours, $art_cjvkjft$art_c = $art_objspkbg$art_obj.length; $art_ipxqckocrh$art_i < $art_cjvkjft$art_c; $art_ipxqckocrh$art_i++) {
            var h = $art_objspkbg$art_obj[$art_ipxqckocrh$art_i];
