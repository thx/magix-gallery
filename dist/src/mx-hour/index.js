...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ilbksnum$art_i = 0, $art_cwolzyxmr$art_c = types.length; $art_ilbksnum$art_i < $art_cwolzyxmr$art_c; $art_ilbksnum$art_i++) {        var t = types[$art_ilbksnum$art_i]%>';
        for (var $art_ilbksnum$art_i = 0, $art_cwolzyxmr$art_c = types.length; $art_ilbksnum$art_i < $art_cwolzyxmr$art_c; $art_ilbksnum$art_i++) {
            var t = types[$art_ilbksnum$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_copcynqdnki$art_c = periods.length; pIndex < $art_copcynqdnki$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_copcynqdnki$art_c = periods.length; pIndex < $art_copcynqdnki$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilgeqfsecu$art_i = 0, $art_objummrepj$art_obj = p.hours, $art_cemhsnyjsv$art_c = $art_objummrepj$art_obj.length; $art_ilgeqfsecu$art_i < $art_cemhsnyjsv$art_c; $art_ilgeqfsecu$art_i++) {        var h = $art_objummrepj$art_obj[$art_ilgeqfsecu$art_i]%>';
        for (var $art_ilgeqfsecu$art_i = 0, $art_objummrepj$art_obj = p.hours, $art_cemhsnyjsv$art_c = $art_objummrepj$art_obj.length; $art_ilgeqfsecu$art_i < $art_cemhsnyjsv$art_c; $art_ilgeqfsecu$art_i++) {
            var h = $art_objummrepj$art_obj[$art_ilgeqfsecu$art_i];
