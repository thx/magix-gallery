...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_izxokdauh$art_i = 0, $art_ckarpasgjwo$art_c = types.length; $art_izxokdauh$art_i < $art_ckarpasgjwo$art_c; $art_izxokdauh$art_i++) {        var t = types[$art_izxokdauh$art_i]%>';
        for (var $art_izxokdauh$art_i = 0, $art_ckarpasgjwo$art_c = types.length; $art_izxokdauh$art_i < $art_ckarpasgjwo$art_c; $art_izxokdauh$art_i++) {
            var t = types[$art_izxokdauh$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_chahvkoxw$art_c = periods.length; pIndex < $art_chahvkoxw$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_chahvkoxw$art_c = periods.length; pIndex < $art_chahvkoxw$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iumovlplxti$art_i = 0, $art_objmfhglapcm$art_obj = p.hours, $art_cpbtbdskvt$art_c = $art_objmfhglapcm$art_obj.length; $art_iumovlplxti$art_i < $art_cpbtbdskvt$art_c; $art_iumovlplxti$art_i++) {        var h = $art_objmfhglapcm$art_obj[$art_iumovlplxti$art_i]%>';
        for (var $art_iumovlplxti$art_i = 0, $art_objmfhglapcm$art_obj = p.hours, $art_cpbtbdskvt$art_c = $art_objmfhglapcm$art_obj.length; $art_iumovlplxti$art_i < $art_cpbtbdskvt$art_c; $art_iumovlplxti$art_i++) {
            var h = $art_objmfhglapcm$art_obj[$art_iumovlplxti$art_i];
