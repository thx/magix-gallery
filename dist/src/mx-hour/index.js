...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_igzrbjcks$art_i = 0, $art_coktmulyzf$art_c = types.length; $art_igzrbjcks$art_i < $art_coktmulyzf$art_c; $art_igzrbjcks$art_i++) {        var t = types[$art_igzrbjcks$art_i]%>';
        for (var $art_igzrbjcks$art_i = 0, $art_coktmulyzf$art_c = types.length; $art_igzrbjcks$art_i < $art_coktmulyzf$art_c; $art_igzrbjcks$art_i++) {
            var t = types[$art_igzrbjcks$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ckscbzfew$art_c = periods.length; pIndex < $art_ckscbzfew$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ckscbzfew$art_c = periods.length; pIndex < $art_ckscbzfew$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iemjskzl$art_i = 0, $art_objymlet$art_obj = p.hours, $art_cgvabvckbwns$art_c = $art_objymlet$art_obj.length; $art_iemjskzl$art_i < $art_cgvabvckbwns$art_c; $art_iemjskzl$art_i++) {        var h = $art_objymlet$art_obj[$art_iemjskzl$art_i]%>';
        for (var $art_iemjskzl$art_i = 0, $art_objymlet$art_obj = p.hours, $art_cgvabvckbwns$art_c = $art_objymlet$art_obj.length; $art_iemjskzl$art_i < $art_cgvabvckbwns$art_c; $art_iemjskzl$art_i++) {
            var h = $art_objymlet$art_obj[$art_iemjskzl$art_i];
