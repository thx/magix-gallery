...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibwfcswh$art_i = 0, $art_cqbgxhox$art_c = types.length; $art_ibwfcswh$art_i < $art_cqbgxhox$art_c; $art_ibwfcswh$art_i++) {        var t = types[$art_ibwfcswh$art_i]%>';
        for (var $art_ibwfcswh$art_i = 0, $art_cqbgxhox$art_c = types.length; $art_ibwfcswh$art_i < $art_cqbgxhox$art_c; $art_ibwfcswh$art_i++) {
            var t = types[$art_ibwfcswh$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cyykmjwewfh$art_c = periods.length; pIndex < $art_cyykmjwewfh$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cyykmjwewfh$art_c = periods.length; pIndex < $art_cyykmjwewfh$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iajyeedpe$art_i = 0, $art_objjdsnaiuk$art_obj = p.hours, $art_cixxfvsiwxe$art_c = $art_objjdsnaiuk$art_obj.length; $art_iajyeedpe$art_i < $art_cixxfvsiwxe$art_c; $art_iajyeedpe$art_i++) {        var h = $art_objjdsnaiuk$art_obj[$art_iajyeedpe$art_i]%>';
        for (var $art_iajyeedpe$art_i = 0, $art_objjdsnaiuk$art_obj = p.hours, $art_cixxfvsiwxe$art_c = $art_objjdsnaiuk$art_obj.length; $art_iajyeedpe$art_i < $art_cixxfvsiwxe$art_c; $art_iajyeedpe$art_i++) {
            var h = $art_objjdsnaiuk$art_obj[$art_iajyeedpe$art_i];
