...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iqsnysu$art_i = 0, $art_cbogftjf$art_c = types.length; $art_iqsnysu$art_i < $art_cbogftjf$art_c; $art_iqsnysu$art_i++) {        var t = types[$art_iqsnysu$art_i]%>';
        for (var $art_iqsnysu$art_i = 0, $art_cbogftjf$art_c = types.length; $art_iqsnysu$art_i < $art_cbogftjf$art_c; $art_iqsnysu$art_i++) {
            var t = types[$art_iqsnysu$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cixyttwzj$art_c = periods.length; pIndex < $art_cixyttwzj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cixyttwzj$art_c = periods.length; pIndex < $art_cixyttwzj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivgnunbaw$art_i = 0, $art_objllnfbjwrl$art_obj = p.hours, $art_ctdazmvvkj$art_c = $art_objllnfbjwrl$art_obj.length; $art_ivgnunbaw$art_i < $art_ctdazmvvkj$art_c; $art_ivgnunbaw$art_i++) {        var h = $art_objllnfbjwrl$art_obj[$art_ivgnunbaw$art_i]%>';
        for (var $art_ivgnunbaw$art_i = 0, $art_objllnfbjwrl$art_obj = p.hours, $art_ctdazmvvkj$art_c = $art_objllnfbjwrl$art_obj.length; $art_ivgnunbaw$art_i < $art_ctdazmvvkj$art_c; $art_ivgnunbaw$art_i++) {
            var h = $art_objllnfbjwrl$art_obj[$art_ivgnunbaw$art_i];
