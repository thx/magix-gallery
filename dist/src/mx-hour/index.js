...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iyraa$art_i = 0, $art_cmkbsw$art_c = types.length; $art_iyraa$art_i < $art_cmkbsw$art_c; $art_iyraa$art_i++) {        var t = types[$art_iyraa$art_i]%>';
        for (var $art_iyraa$art_i = 0, $art_cmkbsw$art_c = types.length; $art_iyraa$art_i < $art_cmkbsw$art_c; $art_iyraa$art_i++) {
            var t = types[$art_iyraa$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ctqtclkj$art_c = periods.length; pIndex < $art_ctqtclkj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ctqtclkj$art_c = periods.length; pIndex < $art_ctqtclkj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieapmcq$art_i = 0, $art_objomjnpfao$art_obj = p.hours, $art_cgxbdnjski$art_c = $art_objomjnpfao$art_obj.length; $art_ieapmcq$art_i < $art_cgxbdnjski$art_c; $art_ieapmcq$art_i++) {        var h = $art_objomjnpfao$art_obj[$art_ieapmcq$art_i]%>';
        for (var $art_ieapmcq$art_i = 0, $art_objomjnpfao$art_obj = p.hours, $art_cgxbdnjski$art_c = $art_objomjnpfao$art_obj.length; $art_ieapmcq$art_i < $art_cgxbdnjski$art_c; $art_ieapmcq$art_i++) {
            var h = $art_objomjnpfao$art_obj[$art_ieapmcq$art_i];
