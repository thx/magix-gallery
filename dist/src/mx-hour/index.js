...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_imgvuhheqx$art_i = 0, $art_cormencenc$art_c = types.length; $art_imgvuhheqx$art_i < $art_cormencenc$art_c; $art_imgvuhheqx$art_i++) {        var t = types[$art_imgvuhheqx$art_i]%>';
        for (var $art_imgvuhheqx$art_i = 0, $art_cormencenc$art_c = types.length; $art_imgvuhheqx$art_i < $art_cormencenc$art_c; $art_imgvuhheqx$art_i++) {
            var t = types[$art_imgvuhheqx$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ctlddnwrn$art_c = periods.length; pIndex < $art_ctlddnwrn$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ctlddnwrn$art_c = periods.length; pIndex < $art_ctlddnwrn$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ishqjzakb$art_i = 0, $art_objnrapjooo$art_obj = p.hours, $art_cpfedhg$art_c = $art_objnrapjooo$art_obj.length; $art_ishqjzakb$art_i < $art_cpfedhg$art_c; $art_ishqjzakb$art_i++) {        var h = $art_objnrapjooo$art_obj[$art_ishqjzakb$art_i]%>';
        for (var $art_ishqjzakb$art_i = 0, $art_objnrapjooo$art_obj = p.hours, $art_cpfedhg$art_c = $art_objnrapjooo$art_obj.length; $art_ishqjzakb$art_i < $art_cpfedhg$art_c; $art_ishqjzakb$art_i++) {
            var h = $art_objnrapjooo$art_obj[$art_ishqjzakb$art_i];
