...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ihnepwsob$art_i = 0, $art_cmwpslhug$art_c = types.length; $art_ihnepwsob$art_i < $art_cmwpslhug$art_c; $art_ihnepwsob$art_i++) {        var t = types[$art_ihnepwsob$art_i]%>';
        for (var $art_ihnepwsob$art_i = 0, $art_cmwpslhug$art_c = types.length; $art_ihnepwsob$art_i < $art_cmwpslhug$art_c; $art_ihnepwsob$art_i++) {
            var t = types[$art_ihnepwsob$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cngecwvwvm$art_c = periods.length; pIndex < $art_cngecwvwvm$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cngecwvwvm$art_c = periods.length; pIndex < $art_cngecwvwvm$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igcmkzerdy$art_i = 0, $art_objigunlzs$art_obj = p.hours, $art_cmjcuuaod$art_c = $art_objigunlzs$art_obj.length; $art_igcmkzerdy$art_i < $art_cmjcuuaod$art_c; $art_igcmkzerdy$art_i++) {        var h = $art_objigunlzs$art_obj[$art_igcmkzerdy$art_i]%>';
        for (var $art_igcmkzerdy$art_i = 0, $art_objigunlzs$art_obj = p.hours, $art_cmjcuuaod$art_c = $art_objigunlzs$art_obj.length; $art_igcmkzerdy$art_i < $art_cmjcuuaod$art_c; $art_igcmkzerdy$art_i++) {
            var h = $art_objigunlzs$art_obj[$art_igcmkzerdy$art_i];
