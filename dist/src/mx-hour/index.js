...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_idpmevxq$art_i = 0, $art_cldktpfwfz$art_c = types.length; $art_idpmevxq$art_i < $art_cldktpfwfz$art_c; $art_idpmevxq$art_i++) {        var t = types[$art_idpmevxq$art_i]%>';
        for (var $art_idpmevxq$art_i = 0, $art_cldktpfwfz$art_c = types.length; $art_idpmevxq$art_i < $art_cldktpfwfz$art_c; $art_idpmevxq$art_i++) {
            var t = types[$art_idpmevxq$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_csgnrpmno$art_c = periods.length; pIndex < $art_csgnrpmno$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_csgnrpmno$art_c = periods.length; pIndex < $art_csgnrpmno$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_imcludyxed$art_i = 0, $art_objszyxswm$art_obj = p.hours, $art_cqabbxocva$art_c = $art_objszyxswm$art_obj.length; $art_imcludyxed$art_i < $art_cqabbxocva$art_c; $art_imcludyxed$art_i++) {        var h = $art_objszyxswm$art_obj[$art_imcludyxed$art_i]%>';
        for (var $art_imcludyxed$art_i = 0, $art_objszyxswm$art_obj = p.hours, $art_cqabbxocva$art_c = $art_objszyxswm$art_obj.length; $art_imcludyxed$art_i < $art_cqabbxocva$art_c; $art_imcludyxed$art_i++) {
            var h = $art_objszyxswm$art_obj[$art_imcludyxed$art_i];
