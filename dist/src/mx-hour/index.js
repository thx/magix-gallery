...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ihmremyc$art_i = 0, $art_cqapazrtxc$art_c = types.length; $art_ihmremyc$art_i < $art_cqapazrtxc$art_c; $art_ihmremyc$art_i++) {        var t = types[$art_ihmremyc$art_i]%>';
        for (var $art_ihmremyc$art_i = 0, $art_cqapazrtxc$art_c = types.length; $art_ihmremyc$art_i < $art_cqapazrtxc$art_c; $art_ihmremyc$art_i++) {
            var t = types[$art_ihmremyc$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_crfgtzthvn$art_c = periods.length; pIndex < $art_crfgtzthvn$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_crfgtzthvn$art_c = periods.length; pIndex < $art_crfgtzthvn$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iubglufd$art_i = 0, $art_objhtfzsldm$art_obj = p.hours, $art_cxgwzfrpp$art_c = $art_objhtfzsldm$art_obj.length; $art_iubglufd$art_i < $art_cxgwzfrpp$art_c; $art_iubglufd$art_i++) {        var h = $art_objhtfzsldm$art_obj[$art_iubglufd$art_i]%>';
        for (var $art_iubglufd$art_i = 0, $art_objhtfzsldm$art_obj = p.hours, $art_cxgwzfrpp$art_c = $art_objhtfzsldm$art_obj.length; $art_iubglufd$art_i < $art_cxgwzfrpp$art_c; $art_iubglufd$art_i++) {
            var h = $art_objhtfzsldm$art_obj[$art_iubglufd$art_i];
