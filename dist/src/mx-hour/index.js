...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ipiqqhvaim$art_i = 0, $art_cclfhbvgqlh$art_c = types.length; $art_ipiqqhvaim$art_i < $art_cclfhbvgqlh$art_c; $art_ipiqqhvaim$art_i++) {        var t = types[$art_ipiqqhvaim$art_i]%>';
        for (var $art_ipiqqhvaim$art_i = 0, $art_cclfhbvgqlh$art_c = types.length; $art_ipiqqhvaim$art_i < $art_cclfhbvgqlh$art_c; $art_ipiqqhvaim$art_i++) {
            var t = types[$art_ipiqqhvaim$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cghqlbjc$art_c = periods.length; pIndex < $art_cghqlbjc$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cghqlbjc$art_c = periods.length; pIndex < $art_cghqlbjc$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivzssqbt$art_i = 0, $art_objhzoqygv$art_obj = p.hours, $art_cykldqi$art_c = $art_objhzoqygv$art_obj.length; $art_ivzssqbt$art_i < $art_cykldqi$art_c; $art_ivzssqbt$art_i++) {        var h = $art_objhzoqygv$art_obj[$art_ivzssqbt$art_i]%>';
        for (var $art_ivzssqbt$art_i = 0, $art_objhzoqygv$art_obj = p.hours, $art_cykldqi$art_c = $art_objhzoqygv$art_obj.length; $art_ivzssqbt$art_i < $art_cykldqi$art_c; $art_ivzssqbt$art_i++) {
            var h = $art_objhzoqygv$art_obj[$art_ivzssqbt$art_i];
