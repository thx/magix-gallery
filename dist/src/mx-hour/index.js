...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iwmyfn$art_i = 0, $art_cmnyrfpia$art_c = types.length; $art_iwmyfn$art_i < $art_cmnyrfpia$art_c; $art_iwmyfn$art_i++) {        var t = types[$art_iwmyfn$art_i]%>';
        for (var $art_iwmyfn$art_i = 0, $art_cmnyrfpia$art_c = types.length; $art_iwmyfn$art_i < $art_cmnyrfpia$art_c; $art_iwmyfn$art_i++) {
            var t = types[$art_iwmyfn$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_crspplhlya$art_c = periods.length; pIndex < $art_crspplhlya$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_crspplhlya$art_c = periods.length; pIndex < $art_crspplhlya$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_izfzrg$art_i = 0, $art_objnxqihf$art_obj = p.hours, $art_cmekngn$art_c = $art_objnxqihf$art_obj.length; $art_izfzrg$art_i < $art_cmekngn$art_c; $art_izfzrg$art_i++) {        var h = $art_objnxqihf$art_obj[$art_izfzrg$art_i]%>';
        for (var $art_izfzrg$art_i = 0, $art_objnxqihf$art_obj = p.hours, $art_cmekngn$art_c = $art_objnxqihf$art_obj.length; $art_izfzrg$art_i < $art_cmekngn$art_c; $art_izfzrg$art_i++) {
            var h = $art_objnxqihf$art_obj[$art_izfzrg$art_i];
