...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iqdtjlmvou$art_i = 0, $art_cvseklaifw$art_c = types.length; $art_iqdtjlmvou$art_i < $art_cvseklaifw$art_c; $art_iqdtjlmvou$art_i++) {        var t = types[$art_iqdtjlmvou$art_i]%>';
        for (var $art_iqdtjlmvou$art_i = 0, $art_cvseklaifw$art_c = types.length; $art_iqdtjlmvou$art_i < $art_cvseklaifw$art_c; $art_iqdtjlmvou$art_i++) {
            var t = types[$art_iqdtjlmvou$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_csnmixowu$art_c = periods.length; pIndex < $art_csnmixowu$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_csnmixowu$art_c = periods.length; pIndex < $art_csnmixowu$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idonbxhve$art_i = 0, $art_objghrysxvw$art_obj = p.hours, $art_cyjnoqeng$art_c = $art_objghrysxvw$art_obj.length; $art_idonbxhve$art_i < $art_cyjnoqeng$art_c; $art_idonbxhve$art_i++) {        var h = $art_objghrysxvw$art_obj[$art_idonbxhve$art_i]%>';
        for (var $art_idonbxhve$art_i = 0, $art_objghrysxvw$art_obj = p.hours, $art_cyjnoqeng$art_c = $art_objghrysxvw$art_obj.length; $art_idonbxhve$art_i < $art_cyjnoqeng$art_c; $art_idonbxhve$art_i++) {
            var h = $art_objghrysxvw$art_obj[$art_idonbxhve$art_i];
