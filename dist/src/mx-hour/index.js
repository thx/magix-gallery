...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_izqkgagojl$art_i = 0, $art_ckzaeh$art_c = types.length; $art_izqkgagojl$art_i < $art_ckzaeh$art_c; $art_izqkgagojl$art_i++) {        var t = types[$art_izqkgagojl$art_i]%>';
        for (var $art_izqkgagojl$art_i = 0, $art_ckzaeh$art_c = types.length; $art_izqkgagojl$art_i < $art_ckzaeh$art_c; $art_izqkgagojl$art_i++) {
            var t = types[$art_izqkgagojl$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cyffzazgj$art_c = periods.length; pIndex < $art_cyffzazgj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cyffzazgj$art_c = periods.length; pIndex < $art_cyffzazgj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixjbuosyw$art_i = 0, $art_objroeuvblphp$art_obj = p.hours, $art_codmwamjc$art_c = $art_objroeuvblphp$art_obj.length; $art_ixjbuosyw$art_i < $art_codmwamjc$art_c; $art_ixjbuosyw$art_i++) {        var h = $art_objroeuvblphp$art_obj[$art_ixjbuosyw$art_i]%>';
        for (var $art_ixjbuosyw$art_i = 0, $art_objroeuvblphp$art_obj = p.hours, $art_codmwamjc$art_c = $art_objroeuvblphp$art_obj.length; $art_ixjbuosyw$art_i < $art_codmwamjc$art_c; $art_ixjbuosyw$art_i++) {
            var h = $art_objroeuvblphp$art_obj[$art_ixjbuosyw$art_i];
