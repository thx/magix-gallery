...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_irhsdwop$art_i = 0, $art_cmqbrubkzd$art_c = types.length; $art_irhsdwop$art_i < $art_cmqbrubkzd$art_c; $art_irhsdwop$art_i++) {        var t = types[$art_irhsdwop$art_i]%>';
        for (var $art_irhsdwop$art_i = 0, $art_cmqbrubkzd$art_c = types.length; $art_irhsdwop$art_i < $art_cmqbrubkzd$art_c; $art_irhsdwop$art_i++) {
            var t = types[$art_irhsdwop$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cfwymaonyxi$art_c = periods.length; pIndex < $art_cfwymaonyxi$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cfwymaonyxi$art_c = periods.length; pIndex < $art_cfwymaonyxi$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iajaidffyt$art_i = 0, $art_objuehoumza$art_obj = p.hours, $art_cyiscrmi$art_c = $art_objuehoumza$art_obj.length; $art_iajaidffyt$art_i < $art_cyiscrmi$art_c; $art_iajaidffyt$art_i++) {        var h = $art_objuehoumza$art_obj[$art_iajaidffyt$art_i]%>';
        for (var $art_iajaidffyt$art_i = 0, $art_objuehoumza$art_obj = p.hours, $art_cyiscrmi$art_c = $art_objuehoumza$art_obj.length; $art_iajaidffyt$art_i < $art_cyiscrmi$art_c; $art_iajaidffyt$art_i++) {
            var h = $art_objuehoumza$art_obj[$art_iajaidffyt$art_i];
