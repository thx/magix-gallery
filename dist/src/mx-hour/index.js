...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_icxmdvqqvrg$art_i = 0, $art_cilctsyy$art_c = types.length; $art_icxmdvqqvrg$art_i < $art_cilctsyy$art_c; $art_icxmdvqqvrg$art_i++) {        var t = types[$art_icxmdvqqvrg$art_i]%>';
        for (var $art_icxmdvqqvrg$art_i = 0, $art_cilctsyy$art_c = types.length; $art_icxmdvqqvrg$art_i < $art_cilctsyy$art_c; $art_icxmdvqqvrg$art_i++) {
            var t = types[$art_icxmdvqqvrg$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cchizvq$art_c = periods.length; pIndex < $art_cchizvq$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cchizvq$art_c = periods.length; pIndex < $art_cchizvq$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ifibakh$art_i = 0, $art_objnljtxl$art_obj = p.hours, $art_cphsolkwf$art_c = $art_objnljtxl$art_obj.length; $art_ifibakh$art_i < $art_cphsolkwf$art_c; $art_ifibakh$art_i++) {        var h = $art_objnljtxl$art_obj[$art_ifibakh$art_i]%>';
        for (var $art_ifibakh$art_i = 0, $art_objnljtxl$art_obj = p.hours, $art_cphsolkwf$art_c = $art_objnljtxl$art_obj.length; $art_ifibakh$art_i < $art_cphsolkwf$art_c; $art_ifibakh$art_i++) {
            var h = $art_objnljtxl$art_obj[$art_ifibakh$art_i];
