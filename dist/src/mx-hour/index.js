...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iutaeyx$art_i = 0, $art_ctmozd$art_c = types.length; $art_iutaeyx$art_i < $art_ctmozd$art_c; $art_iutaeyx$art_i++) {        var t = types[$art_iutaeyx$art_i]%>';
        for (var $art_iutaeyx$art_i = 0, $art_ctmozd$art_c = types.length; $art_iutaeyx$art_i < $art_ctmozd$art_c; $art_iutaeyx$art_i++) {
            var t = types[$art_iutaeyx$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cxjpmegbski$art_c = periods.length; pIndex < $art_cxjpmegbski$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cxjpmegbski$art_c = periods.length; pIndex < $art_cxjpmegbski$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ifkyptjrwds$art_i = 0, $art_objgnbzm$art_obj = p.hours, $art_cnwgrabmsl$art_c = $art_objgnbzm$art_obj.length; $art_ifkyptjrwds$art_i < $art_cnwgrabmsl$art_c; $art_ifkyptjrwds$art_i++) {        var h = $art_objgnbzm$art_obj[$art_ifkyptjrwds$art_i]%>';
        for (var $art_ifkyptjrwds$art_i = 0, $art_objgnbzm$art_obj = p.hours, $art_cnwgrabmsl$art_c = $art_objgnbzm$art_obj.length; $art_ifkyptjrwds$art_i < $art_cnwgrabmsl$art_c; $art_ifkyptjrwds$art_i++) {
            var h = $art_objgnbzm$art_obj[$art_ifkyptjrwds$art_i];
