...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibvlqlrg$art_i = 0, $art_chcnyzqkz$art_c = types.length; $art_ibvlqlrg$art_i < $art_chcnyzqkz$art_c; $art_ibvlqlrg$art_i++) {        var t = types[$art_ibvlqlrg$art_i]%>';
        for (var $art_ibvlqlrg$art_i = 0, $art_chcnyzqkz$art_c = types.length; $art_ibvlqlrg$art_i < $art_chcnyzqkz$art_c; $art_ibvlqlrg$art_i++) {
            var t = types[$art_ibvlqlrg$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cpheampnm$art_c = periods.length; pIndex < $art_cpheampnm$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cpheampnm$art_c = periods.length; pIndex < $art_cpheampnm$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieznmqxzn$art_i = 0, $art_objdcjwuftn$art_obj = p.hours, $art_ccoipynktl$art_c = $art_objdcjwuftn$art_obj.length; $art_ieznmqxzn$art_i < $art_ccoipynktl$art_c; $art_ieznmqxzn$art_i++) {        var h = $art_objdcjwuftn$art_obj[$art_ieznmqxzn$art_i]%>';
        for (var $art_ieznmqxzn$art_i = 0, $art_objdcjwuftn$art_obj = p.hours, $art_ccoipynktl$art_c = $art_objdcjwuftn$art_obj.length; $art_ieznmqxzn$art_i < $art_ccoipynktl$art_c; $art_ieznmqxzn$art_i++) {
            var h = $art_objdcjwuftn$art_obj[$art_ieznmqxzn$art_i];
