...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iktlco$art_i = 0, $art_cbavxau$art_c = types.length; $art_iktlco$art_i < $art_cbavxau$art_c; $art_iktlco$art_i++) {        var t = types[$art_iktlco$art_i]%>';
        for (var $art_iktlco$art_i = 0, $art_cbavxau$art_c = types.length; $art_iktlco$art_i < $art_cbavxau$art_c; $art_iktlco$art_i++) {
            var t = types[$art_iktlco$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ctrogyvf$art_c = periods.length; pIndex < $art_ctrogyvf$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ctrogyvf$art_c = periods.length; pIndex < $art_ctrogyvf$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iuuokadzpnw$art_i = 0, $art_objhxjgppzb$art_obj = p.hours, $art_cbxdjwche$art_c = $art_objhxjgppzb$art_obj.length; $art_iuuokadzpnw$art_i < $art_cbxdjwche$art_c; $art_iuuokadzpnw$art_i++) {        var h = $art_objhxjgppzb$art_obj[$art_iuuokadzpnw$art_i]%>';
        for (var $art_iuuokadzpnw$art_i = 0, $art_objhxjgppzb$art_obj = p.hours, $art_cbxdjwche$art_c = $art_objhxjgppzb$art_obj.length; $art_iuuokadzpnw$art_i < $art_cbxdjwche$art_c; $art_iuuokadzpnw$art_i++) {
            var h = $art_objhxjgppzb$art_obj[$art_iuuokadzpnw$art_i];
