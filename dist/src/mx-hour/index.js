...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_imquqjdzifj$art_i = 0, $art_cdxrjwzcg$art_c = types.length; $art_imquqjdzifj$art_i < $art_cdxrjwzcg$art_c; $art_imquqjdzifj$art_i++) {        var t = types[$art_imquqjdzifj$art_i]%>';
        for (var $art_imquqjdzifj$art_i = 0, $art_cdxrjwzcg$art_c = types.length; $art_imquqjdzifj$art_i < $art_cdxrjwzcg$art_c; $art_imquqjdzifj$art_i++) {
            var t = types[$art_imquqjdzifj$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cvspirmydpz$art_c = periods.length; pIndex < $art_cvspirmydpz$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cvspirmydpz$art_c = periods.length; pIndex < $art_cvspirmydpz$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idupsje$art_i = 0, $art_objhaxrfx$art_obj = p.hours, $art_cflukvidvkb$art_c = $art_objhaxrfx$art_obj.length; $art_idupsje$art_i < $art_cflukvidvkb$art_c; $art_idupsje$art_i++) {        var h = $art_objhaxrfx$art_obj[$art_idupsje$art_i]%>';
        for (var $art_idupsje$art_i = 0, $art_objhaxrfx$art_obj = p.hours, $art_cflukvidvkb$art_c = $art_objhaxrfx$art_obj.length; $art_idupsje$art_i < $art_cflukvidvkb$art_c; $art_idupsje$art_i++) {
            var h = $art_objhaxrfx$art_obj[$art_idupsje$art_i];
