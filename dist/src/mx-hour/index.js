...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ixofpodct$art_i = 0, $art_cnfdrhm$art_c = types.length; $art_ixofpodct$art_i < $art_cnfdrhm$art_c; $art_ixofpodct$art_i++) {        var t = types[$art_ixofpodct$art_i]%>';
        for (var $art_ixofpodct$art_i = 0, $art_cnfdrhm$art_c = types.length; $art_ixofpodct$art_i < $art_cnfdrhm$art_c; $art_ixofpodct$art_i++) {
            var t = types[$art_ixofpodct$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ceaoulfj$art_c = periods.length; pIndex < $art_ceaoulfj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ceaoulfj$art_c = periods.length; pIndex < $art_ceaoulfj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igekito$art_i = 0, $art_objtgtkzefvuf$art_obj = p.hours, $art_cmszzsa$art_c = $art_objtgtkzefvuf$art_obj.length; $art_igekito$art_i < $art_cmszzsa$art_c; $art_igekito$art_i++) {        var h = $art_objtgtkzefvuf$art_obj[$art_igekito$art_i]%>';
        for (var $art_igekito$art_i = 0, $art_objtgtkzefvuf$art_obj = p.hours, $art_cmszzsa$art_c = $art_objtgtkzefvuf$art_obj.length; $art_igekito$art_i < $art_cmszzsa$art_c; $art_igekito$art_i++) {
            var h = $art_objtgtkzefvuf$art_obj[$art_igekito$art_i];
