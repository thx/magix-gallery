...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ivtaxuamg$art_i = 0, $art_cwrxrpot$art_c = types.length; $art_ivtaxuamg$art_i < $art_cwrxrpot$art_c; $art_ivtaxuamg$art_i++) {        var t = types[$art_ivtaxuamg$art_i]%>';
        for (var $art_ivtaxuamg$art_i = 0, $art_cwrxrpot$art_c = types.length; $art_ivtaxuamg$art_i < $art_cwrxrpot$art_c; $art_ivtaxuamg$art_i++) {
            var t = types[$art_ivtaxuamg$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cltkvkrzjbi$art_c = periods.length; pIndex < $art_cltkvkrzjbi$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cltkvkrzjbi$art_c = periods.length; pIndex < $art_cltkvkrzjbi$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_itfvimmli$art_i = 0, $art_objfthmsqjp$art_obj = p.hours, $art_cxxud$art_c = $art_objfthmsqjp$art_obj.length; $art_itfvimmli$art_i < $art_cxxud$art_c; $art_itfvimmli$art_i++) {        var h = $art_objfthmsqjp$art_obj[$art_itfvimmli$art_i]%>';
        for (var $art_itfvimmli$art_i = 0, $art_objfthmsqjp$art_obj = p.hours, $art_cxxud$art_c = $art_objfthmsqjp$art_obj.length; $art_itfvimmli$art_i < $art_cxxud$art_c; $art_itfvimmli$art_i++) {
            var h = $art_objfthmsqjp$art_obj[$art_itfvimmli$art_i];
