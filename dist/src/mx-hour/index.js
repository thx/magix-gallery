...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_imyrqm$art_i = 0, $art_cgbhyhqit$art_c = types.length; $art_imyrqm$art_i < $art_cgbhyhqit$art_c; $art_imyrqm$art_i++) {        var t = types[$art_imyrqm$art_i]%>';
        for (var $art_imyrqm$art_i = 0, $art_cgbhyhqit$art_c = types.length; $art_imyrqm$art_i < $art_cgbhyhqit$art_c; $art_imyrqm$art_i++) {
            var t = types[$art_imyrqm$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cvvvkhzset$art_c = periods.length; pIndex < $art_cvvvkhzset$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cvvvkhzset$art_c = periods.length; pIndex < $art_cvvvkhzset$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iifkbdnl$art_i = 0, $art_objvaqyfjuvr$art_obj = p.hours, $art_conpjezgb$art_c = $art_objvaqyfjuvr$art_obj.length; $art_iifkbdnl$art_i < $art_conpjezgb$art_c; $art_iifkbdnl$art_i++) {        var h = $art_objvaqyfjuvr$art_obj[$art_iifkbdnl$art_i]%>';
        for (var $art_iifkbdnl$art_i = 0, $art_objvaqyfjuvr$art_obj = p.hours, $art_conpjezgb$art_c = $art_objvaqyfjuvr$art_obj.length; $art_iifkbdnl$art_i < $art_conpjezgb$art_c; $art_iifkbdnl$art_i++) {
            var h = $art_objvaqyfjuvr$art_obj[$art_iifkbdnl$art_i];
