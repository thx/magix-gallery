...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibbole$art_i = 0, $art_cmwtffzmbo$art_c = types.length; $art_ibbole$art_i < $art_cmwtffzmbo$art_c; $art_ibbole$art_i++) {        var t = types[$art_ibbole$art_i]%>';
        for (var $art_ibbole$art_i = 0, $art_cmwtffzmbo$art_c = types.length; $art_ibbole$art_i < $art_cmwtffzmbo$art_c; $art_ibbole$art_i++) {
            var t = types[$art_ibbole$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cvfmgltk$art_c = periods.length; pIndex < $art_cvfmgltk$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cvfmgltk$art_c = periods.length; pIndex < $art_cvfmgltk$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixypvdvorh$art_i = 0, $art_objksznmdc$art_obj = p.hours, $art_cuwayvyuf$art_c = $art_objksznmdc$art_obj.length; $art_ixypvdvorh$art_i < $art_cuwayvyuf$art_c; $art_ixypvdvorh$art_i++) {        var h = $art_objksznmdc$art_obj[$art_ixypvdvorh$art_i]%>';
        for (var $art_ixypvdvorh$art_i = 0, $art_objksznmdc$art_obj = p.hours, $art_cuwayvyuf$art_c = $art_objksznmdc$art_obj.length; $art_ixypvdvorh$art_i < $art_cuwayvyuf$art_c; $art_ixypvdvorh$art_i++) {
            var h = $art_objksznmdc$art_obj[$art_ixypvdvorh$art_i];
