...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ioozxqqn$art_i = 0, $art_cocrragrwl$art_c = types.length; $art_ioozxqqn$art_i < $art_cocrragrwl$art_c; $art_ioozxqqn$art_i++) {        var t = types[$art_ioozxqqn$art_i]%>';
        for (var $art_ioozxqqn$art_i = 0, $art_cocrragrwl$art_c = types.length; $art_ioozxqqn$art_i < $art_cocrragrwl$art_c; $art_ioozxqqn$art_i++) {
            var t = types[$art_ioozxqqn$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cvbmvidbt$art_c = periods.length; pIndex < $art_cvbmvidbt$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cvbmvidbt$art_c = periods.length; pIndex < $art_cvbmvidbt$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igcafuj$art_i = 0, $art_objklmleyf$art_obj = p.hours, $art_crqhudmowxs$art_c = $art_objklmleyf$art_obj.length; $art_igcafuj$art_i < $art_crqhudmowxs$art_c; $art_igcafuj$art_i++) {        var h = $art_objklmleyf$art_obj[$art_igcafuj$art_i]%>';
        for (var $art_igcafuj$art_i = 0, $art_objklmleyf$art_obj = p.hours, $art_crqhudmowxs$art_c = $art_objklmleyf$art_obj.length; $art_igcafuj$art_i < $art_crqhudmowxs$art_c; $art_igcafuj$art_i++) {
            var h = $art_objklmleyf$art_obj[$art_igcafuj$art_i];
