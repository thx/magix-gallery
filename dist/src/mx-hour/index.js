...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iducujvkpzn$art_i = 0, $art_corkmtdy$art_c = types.length; $art_iducujvkpzn$art_i < $art_corkmtdy$art_c; $art_iducujvkpzn$art_i++) {        var t = types[$art_iducujvkpzn$art_i]%>';
        for (var $art_iducujvkpzn$art_i = 0, $art_corkmtdy$art_c = types.length; $art_iducujvkpzn$art_i < $art_corkmtdy$art_c; $art_iducujvkpzn$art_i++) {
            var t = types[$art_iducujvkpzn$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cuspbovcp$art_c = periods.length; pIndex < $art_cuspbovcp$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cuspbovcp$art_c = periods.length; pIndex < $art_cuspbovcp$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iaarkoucv$art_i = 0, $art_objoeqvwmdqc$art_obj = p.hours, $art_cminssmoe$art_c = $art_objoeqvwmdqc$art_obj.length; $art_iaarkoucv$art_i < $art_cminssmoe$art_c; $art_iaarkoucv$art_i++) {        var h = $art_objoeqvwmdqc$art_obj[$art_iaarkoucv$art_i]%>';
        for (var $art_iaarkoucv$art_i = 0, $art_objoeqvwmdqc$art_obj = p.hours, $art_cminssmoe$art_c = $art_objoeqvwmdqc$art_obj.length; $art_iaarkoucv$art_i < $art_cminssmoe$art_c; $art_iaarkoucv$art_i++) {
            var h = $art_objoeqvwmdqc$art_obj[$art_iaarkoucv$art_i];
