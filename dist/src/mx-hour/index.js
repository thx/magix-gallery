...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_isfmmok$art_i = 0, $art_cbkfgvnc$art_c = types.length; $art_isfmmok$art_i < $art_cbkfgvnc$art_c; $art_isfmmok$art_i++) {        var t = types[$art_isfmmok$art_i]%>';
        for (var $art_isfmmok$art_i = 0, $art_cbkfgvnc$art_c = types.length; $art_isfmmok$art_i < $art_cbkfgvnc$art_c; $art_isfmmok$art_i++) {
            var t = types[$art_isfmmok$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cccnlyckn$art_c = periods.length; pIndex < $art_cccnlyckn$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cccnlyckn$art_c = periods.length; pIndex < $art_cccnlyckn$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ihrmqivfq$art_i = 0, $art_objdfviufc$art_obj = p.hours, $art_cigzqi$art_c = $art_objdfviufc$art_obj.length; $art_ihrmqivfq$art_i < $art_cigzqi$art_c; $art_ihrmqivfq$art_i++) {        var h = $art_objdfviufc$art_obj[$art_ihrmqivfq$art_i]%>';
        for (var $art_ihrmqivfq$art_i = 0, $art_objdfviufc$art_obj = p.hours, $art_cigzqi$art_c = $art_objdfviufc$art_obj.length; $art_ihrmqivfq$art_i < $art_cigzqi$art_c; $art_ihrmqivfq$art_i++) {
            var h = $art_objdfviufc$art_obj[$art_ihrmqivfq$art_i];
