...
module.exports = Magix.View.extend({
    ...
    if (closable) {
        ;
        $p += '<a mxs="_zs_gallerya7:_" href="javascript:;" mx-click="' + $viewId + '@{close}()" class="_zs_gallery_mx-dialog_index_-dialog-close"><i class="mc-iconfont _zs_gallery_mx-dialog_index_-iconfont-ext">&#xe603;</i></a>';
        $line = 5;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (full) {
        ...
        if (fullHeader.title) {
            ...
            $art = '=cntId';
            ;
            $p += ($expr = '<%=cntId%>', $e(cntId)) + '_header"><span mxa="_zs_gallerya7:_" class="header-name">';
            $line = 12;
            ...
            if (fullHeader.tip) {
                ;
                $p += '<span mxa="_zs_gallerya7:a" class="color-9 ml10">';
                $line = 21;
                $art = '!fullHeader.tip';
                ;
        ...
        $art = '=cntId';
        ;
        $p += ($expr = '<%=cntId%>', $e(cntId)) + '"><div mxs="_zs_gallerya7:a" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
        $line = 32;
        ...
        if (fullFooter.enter || fullFooter.cancel) {
            ...
            if (fullFooter.enter) {
                ;
                $p += '<a mxa="_zs_gallerya7:b" href="javascript:;" class="fl btn btn-brand min-width-60 mr10 _zs_gallery_mx-dialog_index_-btn-submit" mx-click="' + $viewId + '@{submit}()"><span mxa="_zs_gallerya7:c" class="_zs_gallery_mx-dialog_index_-submit-text">';
                $line = 36;
            ...
            if (fullFooter.cancel) {
                ;
                $p += '<a mxa="_zs_gallerya7:d" href="javascript:;" class="fl btn min-width-60 mr10" mx-click="' + $viewId + '@{close}()">';
                $line = 41;
