/*
    ...
    loader: cmd_es
 */
define("mx-taginput/examples/index",["magix","$","examples/subs","mx-title/second","./1","./3","./4","./2","./6","./7","./8","./5","examples/api","examples/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'一次性获取选中值\',\n            key: viewId + \'_demo1\'\n        }, {\n            name: \'动态单个选择\',\n            key: viewId + \'_demo7\'\n        }, {\n            name: \'动态连续选择\',\n            key: viewId + \'_demo5\'\n        }, {\n            name: \'实时获取选中值\',\n            key: viewId + \'_demo6\'\n        }, {\n            name: \'自定义key\',\n            key: viewId + \'_demo2\'\n        }, {\n            name: \'简单list\',\n            key: viewId + \'_demo3\'\n        }, {\n            name: \'选择上限\',\n            key: viewId + \'_demo8\'\n        }, {\n            name: \'禁用\',\n            key: viewId + \'_demo4\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }, {\n        name: \'Methods\',\n        key: viewId + \'_method\'\n    }]';
    ;
    $p += ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'一次性获取选中值\',                    key: viewId + \'_demo1\'                }, {                    name: \'动态单个选择\',                    key: viewId + \'_demo7\'                }, {                    name: \'动态连续选择\',                    key: viewId + \'_demo5\'                }, {                    name: \'实时获取选中值\',                    key: viewId + \'_demo6\'                }, {                    name: \'自定义key\',                    key: viewId + \'_demo2\'                }, {                    name: \'简单list\',                    key: viewId + \'_demo3\'                }, {                    name: \'选择上限\',                    key: viewId + \'_demo8\'                }, {                    name: \'禁用\',                    key: viewId + \'_demo4\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }, {            name: \'Event\',            key: viewId + \'_event\'        }, {            name: \'Methods\',            key: viewId + \'_method\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '一次性获取选中值', key: viewId + '_demo1' }, { name: '动态单个选择', key: viewId + '_demo7' }, { name: '动态连续选择', key: viewId + '_demo5' }, { name: '实时获取选中值', key: viewId + '_demo6' }, { name: '自定义key', key: viewId + '_demo2' }, { name: '简单list', key: viewId + '_demo3' }, { name: '选择上限', key: viewId + '_demo8' }, { name: '禁用', key: viewId + '_demo4' }] }, { name: 'API', key: viewId + '_api' }, { name: 'Event', key: viewId + '_event' }, { name: 'Methods', key: viewId + '_method' }])) + '"></div><div mxs="_zs_galleryfw:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div class="clearfix mb20" id="';
    $line = 43;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo"><div mxa="_zs_galleryfw:a" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-taginput/examples/1" id="';
    $line = 45;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mx-view="mx-taginput/examples/3" id="';
    $line = 46;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div><div mx-view="mx-taginput/examples/4" id="';
    $line = 47;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div><div mx-view="mx-taginput/examples/2" id="';
    $line = 48;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div><div mx-view="mx-taginput/examples/6" id="';
    $line = 49;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"></div></div><div mxa="_zs_galleryfw:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-taginput/examples/7" id="';
    $line = 52;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo7"></div><div mx-view="mx-taginput/examples/8" id="';
    $line = 53;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo8"></div><div mx-view="mx-taginput/examples/5" id="';
    $line = 54;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-taginput/examples/index.html';
    throw msg;
} return $p; },
    render: function () {
        var options = [{
