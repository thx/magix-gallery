...
module.exports = Base.extend({
    ...
    ;
    $p += '">trigger<i mxs="_zs_galleryer:a" class="mc-iconfont mx-trigger-arrow">&#xe692;</i></div><div class="mx-output mx-output-bottom ';
    $line = 9;
    $art = 'if open';
    ;
    $expr = '<%if (open) {%>';
