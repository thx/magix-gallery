...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydZ:_" class="pr pr120"><div mx-view="examples/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'下方\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'上方\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'左边\',\n            key: viewId + \'_demo7\'\n        },{\n            name: \'右边\',\n            key: viewId + \'_demo8\'\n        },{\n            name: \'自定义view\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'自定义tag\',\n            key: viewId + \'_demo4\'\n        },{\n            name: \'黑底白字\',\n            key: viewId + \'_demo9\'\n        },{\n            name: \'偏移量offset\',\n            key: viewId + \'_demo14\'\n        },{\n            name: \'默认展开\',\n            key: viewId + \'_demo10\'\n        },{\n            name: \'top + left\',\n            key: viewId + \'_demo15\'\n        },{\n            name: \'内容缩略显示\',\n            key: viewId + \'_demo5\'\n        },{\n            name: \'内容包含html\',\n            key: viewId + \'_demo6\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'异常情况说明\',\n        key: viewId + \'_error\',\n        subs: [{\n            name: \'滚动定位\',\n            key: viewId + \'_demo11\'\n        }, {\n            name: \'影响CSSOM\',\n            key: viewId + \'_demo12\'\n        }]\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerydZ:a" class="clearfix mb20"><div mxa="_zs_gallerydZ:b" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popover/examples/1" id="';
    $line = 65;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_gallerydZ:c" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popover/examples/3" id="';
    $line = 73;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_error" mx-view="mx-title/second?content=%E5%BC%82%E5%B8%B8%E6%83%85%E5%86%B5%E8%AF%B4%E6%98%8E"></div><div mxa="_zs_gallerydZ:d" class="clearfix mb20"><div mxa="_zs_gallerydZ:e" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popover/examples/11" id="';
    $line = 88;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo11"></div></div><div mxa="_zs_gallerydZ:f" class="_zs_gallery_Users_youjiaqi_work_zs_gallery_tmpl___test___layout_-half"><div mx-view="mx-popover/examples/12" id="';
    $line = 91;
    $art = '=viewId';
    ;
