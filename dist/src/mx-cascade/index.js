...
module.exports = Magix.View.extend({
    ...
    if (!disabled) {
        ...
        ;
        $expr = '<%for (var gIndex = 0, $art_cjdkwiwz$art_c = groups.length; gIndex < $art_cjdkwiwz$art_c; gIndex++) {        var list = groups[gIndex]%>';
        for (var gIndex = 0, $art_cjdkwiwz$art_c = groups.length; gIndex < $art_cjdkwiwz$art_c; gIndex++) {
            ...
            ;
            $expr = '<%for (var iIndex = 0, $art_camyikv$art_c = list.length; iIndex < $art_camyikv$art_c; iIndex++) {            var item = list[iIndex]%>';
            for (var iIndex = 0, $art_camyikv$art_c = list.length; iIndex < $art_camyikv$art_c; iIndex++) {
