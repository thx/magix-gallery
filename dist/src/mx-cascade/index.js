...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '><span mxa="_zs_galleryaj:_" class="mx-trigger-label">';
    $line = 3;
    $art = 'if name';
    ;
    $expr = '<%if (name) {%>';
    ...
    $art = '=selectedText';
    ;
    $p += ($expr = '<%=selectedText%>', $e(selectedText)) + '</span><span mxs="_zs_galleryaj:_" class="mc-iconfont mx-trigger-arrow">&#xe692;</span></div>';
    $line = 6;
    $art = 'if !disabled';
    ;
    $expr = '<%if (!disabled) {%>';
    if (!disabled) {
        ...
        ;
        $expr = '<%for (var gIndex = 0, $art_cosxcrph$art_c = groups.length; gIndex < $art_cosxcrph$art_c; gIndex++) {        var list = groups[gIndex]%>';
        for (var gIndex = 0, $art_cosxcrph$art_c = groups.length; gIndex < $art_cosxcrph$art_c; gIndex++) {
            ...
            ;
            $expr = '<%for (var iIndex = 0, $art_ckozkpqd$art_c = list.length; iIndex < $art_ckozkpqd$art_c; iIndex++) {            var item = list[iIndex]%>';
            for (var iIndex = 0, $art_ckozkpqd$art_c = list.length; iIndex < $art_ckozkpqd$art_c; iIndex++) {
                ...
                $art = '=iIndex';
                ;
                $p += ($expr = '<%=iIndex%>', $e(iIndex)) + '})"><span mxa="_zs_galleryaj:a" class="_zs_gallery_mx-cascade_index_-line-text">';
                $line = 12;
                $art = '=item[textKey]';
                ;
                ...
                if (item.children && item.children.length) {
                    ;
                    $p += '<span mxs="_zs_galleryaj:a" class="mc-iconfont _zs_gallery_mx-cascade_index_-line-arrow">&#xe692;</span>';
                    $line = 15;
                    $art = '/if';
                    ;
                    $expr = '<%}%>';
