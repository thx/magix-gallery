...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_idiqhkd$art_i=0;$art_idiqhkd$art_i<first.length;$art_idiqhkd$art_i++){var i=first[$art_idiqhkd$art_i]%>';
    for (var $art_idiqhkd$art_i = 0; $art_idiqhkd$art_i < first.length; $art_idiqhkd$art_i++) {
        var i = first[$art_idiqhkd$art_i];
        $p += '<i value="';
        $line = 22;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_izudsath$art_i=0;$art_izudsath$art_i<second.length;$art_izudsath$art_i++){var i=second[$art_izudsath$art_i]%>';
    for (var $art_izudsath$art_i = 0; $art_izudsath$art_i < second.length; $art_izudsath$art_i++) {
        var i = second[$art_izudsath$art_i];
        $p += '<i value="';
        $line = 26;
        $art = '=i';
        ;
