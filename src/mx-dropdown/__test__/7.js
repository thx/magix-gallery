...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_imjjsffop$art_i=0;$art_imjjsffop$art_i<first.length;$art_imjjsffop$art_i++){var i=first[$art_imjjsffop$art_i]%>';
    for (var $art_imjjsffop$art_i = 0; $art_imjjsffop$art_i < first.length; $art_imjjsffop$art_i++) {
        var i = first[$art_imjjsffop$art_i];
        $p += '<i value="';
        $line = 22;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iehrgrwt$art_i=0;$art_iehrgrwt$art_i<second.length;$art_iehrgrwt$art_i++){var i=second[$art_iehrgrwt$art_i]%>';
    for (var $art_iehrgrwt$art_i = 0; $art_iehrgrwt$art_i < second.length; $art_iehrgrwt$art_i++) {
        var i = second[$art_iehrgrwt$art_i];
        $p += '<i value="';
        $line = 26;
        $art = '=i';
        ;
