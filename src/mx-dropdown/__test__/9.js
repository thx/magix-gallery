...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery+:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_gallery+:a" class="_zs_gallery___test___base_-eg-content"><div class="w200" mx-view="mx-dropdown/multiple?list=';
    $line = 4;
    $art = '@[{id:1,name:\'选项1\'},{id:2,name:\'选项2\'}]';
    ;
    $p += '' + ($expr = '<%@[{id:1,name:\'选项1\'},{id:2,name:\'选项2\'}]%>', $i([{ id: 1, name: '选项1' }, { id: 2, name: '选项2' }])) + '&textKey=name&valueKey=id"></div></div><div mxa="_zs_gallery+:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallery+:_" class="_zs_gallery___test___base_-eg-title">自定义&nbsp;text-key&nbsp;和&nbsp;value-key</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
