...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_icvpoxrcmg$art_i=0;$art_icvpoxrcmg$art_i<first.length;$art_icvpoxrcmg$art_i++){var i=first[$art_icvpoxrcmg$art_i]%>';
    for (var $art_icvpoxrcmg$art_i = 0; $art_icvpoxrcmg$art_i < first.length; $art_icvpoxrcmg$art_i++) {
        var i = first[$art_icvpoxrcmg$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iwqlsukbcj$art_i=0;$art_iwqlsukbcj$art_i<second.length;$art_iwqlsukbcj$art_i++){var i=second[$art_iwqlsukbcj$art_i]%>';
    for (var $art_iwqlsukbcj$art_i = 0; $art_iwqlsukbcj$art_i < second.length; $art_iwqlsukbcj$art_i++) {
        var i = second[$art_iwqlsukbcj$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
