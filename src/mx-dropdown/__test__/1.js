...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ionkfsi$art_i=0;$art_ionkfsi$art_i<first.length;$art_ionkfsi$art_i++){var i=first[$art_ionkfsi$art_i]%>';
    for (var $art_ionkfsi$art_i = 0; $art_ionkfsi$art_i < first.length; $art_ionkfsi$art_i++) {
        var i = first[$art_ionkfsi$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ipxddro$art_i=0;$art_ipxddro$art_i<second.length;$art_ipxddro$art_i++){var i=second[$art_ipxddro$art_i]%>';
    for (var $art_ipxddro$art_i = 0; $art_ipxddro$art_i < second.length; $art_ipxddro$art_i++) {
        var i = second[$art_ipxddro$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
