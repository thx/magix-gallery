...
let Names = {"d1":"__mx-effect_dance_-d1","d2":"__mx-effect_dance_-d2","d3":"__mx-effect_dance_-d3","d4":"__mx-effect_dance_-d4","d5":"__mx-effect_dance_-d5","d6":"__mx-effect_dance_-d6","d7":"__mx-effect_dance_-d7","d8":"__mx-effect_dance_-d8","d9":"__mx-effect_dance_-d9","d10":"__mx-effect_dance_-d10","d11":"__mx-effect_dance_-d11"};
module.exports = Magix.View.extend({
    ...
    render() {
        ...
        let html = `<span class="__mx-effect_dance_-c">${words.join('</span><span class="__mx-effect_dance_-c">')}</span>`;
