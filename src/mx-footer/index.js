...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ifsbvumvh$art_i=0;$art_ifsbvumvh$art_i<products.length;$art_ifsbvumvh$art_i++){var p=products[$art_ifsbvumvh$art_i]%>';
        for (var $art_ifsbvumvh$art_i = 0; $art_ifsbvumvh$art_i < products.length; $art_ifsbvumvh$art_i++) {
            var p = products[$art_ifsbvumvh$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_ikshidxkl$art_i=0,$art_objrseltbsi$art_obj=p.thirds;$art_ikshidxkl$art_i<$art_objrseltbsi$art_obj.length;$art_ikshidxkl$art_i++){var t=$art_objrseltbsi$art_obj[$art_ikshidxkl$art_i]%>';
            for (var $art_ikshidxkl$art_i = 0, $art_objrseltbsi$art_obj = p.thirds; $art_ikshidxkl$art_i < $art_objrseltbsi$art_obj.length; $art_ikshidxkl$art_i++) {
                var t = $art_objrseltbsi$art_obj[$art_ikshidxkl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
