...
module.exports = Magix.View.extend({
    ...
    if ($$ref[k = $g + f] === v)
        return k; $$ref[k = $g + $$ref[$g]++] = v; return k; }, width = $$.width, list = $$.list, fixed = $$.fixed, styles = $$.styles, logo = $$.logo, navs = $$.navs, cur = $$.cur; var $expr, $art, $line; try {
    $p += '<div mxa="_zs_gallerya6:_" class="_zs_gallery_mx-header_index_-header"><div class="_zs_gallery_mx-header_index_-others clearfix" style="width: ';
    $line = 2;
    $art = '=width';
    ;
    $p += '' + ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_gallerya6:_" class="fl mr35"><a class="_zs_gallery_mx-header_index_-text _zs_gallery_mx-header_index_-text-h-brand" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
    $line = 6;
    ...
    for (var index = 0; index < list.length; index++) {
        ...
        $art = '=index';
        ;
        $p += '' + ($expr = '<%=index%>', $e(index)) + ',height:0})"><span mxa="_zs_gallerya6:a" class="_zs_gallery_mx-header_index_-text">';
        $line = 10;
        $art = '=item.title';
        ;
        $p += '' + ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_gallerya6:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links" style="height: ';
        $line = 12;
        $art = '=item.showHeight';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_icldmcpeoo$art_i=0,$art_objwotmnsjw$art_obj=item.seconds;$art_icldmcpeoo$art_i<$art_objwotmnsjw$art_obj.length;$art_icldmcpeoo$art_i++){var second=$art_objwotmnsjw$art_obj[$art_icldmcpeoo$art_i]%>';
        for (var $art_icldmcpeoo$art_i = 0, $art_objwotmnsjw$art_obj = item.seconds; $art_icldmcpeoo$art_i < $art_objwotmnsjw$art_obj.length; $art_icldmcpeoo$art_i++) {
            var second = $art_objwotmnsjw$art_obj[$art_icldmcpeoo$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_itjzxmdhm$art_i=0,$art_objnjiayzeoqg$art_obj=second.thirds;$art_itjzxmdhm$art_i<$art_objnjiayzeoqg$art_obj.length;$art_itjzxmdhm$art_i++){var third=$art_objnjiayzeoqg$art_obj[$art_itjzxmdhm$art_i]%>';
            for (var $art_itjzxmdhm$art_i = 0, $art_objnjiayzeoqg$art_obj = second.thirds; $art_itjzxmdhm$art_i < $art_objnjiayzeoqg$art_obj.length; $art_itjzxmdhm$art_i++) {
                var third = $art_objnjiayzeoqg$art_obj[$art_itjzxmdhm$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    $art = '=width';
    ;
    $p += '' + ($expr = '<%=width%>', $e(width)) + 'px;"><div mxa="_zs_gallerya6:b" class="_zs_gallery_mx-header_index_-logo"><img src="';
    $line = 30;
    $art = '=logo';
    ;
    $p += '' + ($expr = '<%=logo%>', $e(logo)) + '"/></div><div mxa="_zs_gallerya6:c" class="_zs_gallery_mx-header_index_-navs">';
    $line = 33;
    $art = 'each navs as nav';
    ;
    $p += '';
    $expr = '<%for(var $art_itkuawobsqs$art_i=0;$art_itkuawobsqs$art_i<navs.length;$art_itkuawobsqs$art_i++){var nav=navs[$art_itkuawobsqs$art_i]%>';
    for (var $art_itkuawobsqs$art_i = 0; $art_itkuawobsqs$art_i < navs.length; $art_itkuawobsqs$art_i++) {
        var nav = navs[$art_itkuawobsqs$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
