    ...
    if (list.length > 0) {
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var subIndex=0,$art_objepjjkpew$art_obj=item.subs;subIndex<$art_objepjjkpew$art_obj.length;subIndex++){var sub=$art_objepjjkpew$art_obj[subIndex]%>';
                for (var subIndex = 0, $art_objepjjkpew$art_obj = item.subs; subIndex < $art_objepjjkpew$art_obj.length; subIndex++) {
                    var sub = $art_objepjjkpew$art_obj[subIndex];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_iopjwidqrtg$art_i=0;$art_iopjwidqrtg$art_i<groups.length;$art_iopjwidqrtg$art_i++){var group=groups[$art_iopjwidqrtg$art_i]%>';
        for (var $art_iopjwidqrtg$art_i = 0; $art_iopjwidqrtg$art_i < groups.length; $art_iopjwidqrtg$art_i++) {
            var group = groups[$art_iopjwidqrtg$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ipyuzrh$art_i=0;$art_ipyuzrh$art_i<groups.length;$art_ipyuzrh$art_i++){var group=groups[$art_ipyuzrh$art_i]%>';
        for (var $art_ipyuzrh$art_i = 0; $art_ipyuzrh$art_i < groups.length; $art_ipyuzrh$art_i++) {
            var group = groups[$art_ipyuzrh$art_i];
            $p += ' ';
            $line = 82;
            $art = 'each group.fields as field';
            ;
            $p += '';
            $expr = '<%for(var $art_ixhfdvvhrg$art_i=0,$art_objnlpkrwuo$art_obj=group.fields;$art_ixhfdvvhrg$art_i<$art_objnlpkrwuo$art_obj.length;$art_ixhfdvvhrg$art_i++){var field=$art_objnlpkrwuo$art_obj[$art_ixhfdvvhrg$art_i]%>';
            for (var $art_ixhfdvvhrg$art_i = 0, $art_objnlpkrwuo$art_obj = group.fields; $art_ixhfdvvhrg$art_i < $art_objnlpkrwuo$art_obj.length; $art_ixhfdvvhrg$art_i++) {
                var field = $art_objnlpkrwuo$art_obj[$art_ixhfdvvhrg$art_i];
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_iawogyfbfesk$art_i=0;$art_iawogyfbfesk$art_i<groups.length;$art_iawogyfbfesk$art_i++){var group=groups[$art_iawogyfbfesk$art_i]%>';
            for (var $art_iawogyfbfesk$art_i = 0; $art_iawogyfbfesk$art_i < groups.length; $art_iawogyfbfesk$art_i++) {
                var group = groups[$art_iawogyfbfesk$art_i];
                $p += ' ';
                $line = 92;
                $art = 'each group.fields as field';
                ;
                $p += '';
                $expr = '<%for(var $art_igruglpjkm$art_i=0,$art_objimxghfef$art_obj=group.fields;$art_igruglpjkm$art_i<$art_objimxghfef$art_obj.length;$art_igruglpjkm$art_i++){var field=$art_objimxghfef$art_obj[$art_igruglpjkm$art_i]%>';
                for (var $art_igruglpjkm$art_i = 0, $art_objimxghfef$art_obj = group.fields; $art_igruglpjkm$art_i < $art_objimxghfef$art_obj.length; $art_igruglpjkm$art_i++) {
                    var field = $art_objimxghfef$art_obj[$art_igruglpjkm$art_i];
                    $p += '<td>';
                    $line = 93;
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_ihbbyvvksci$art_i=0;$art_ihbbyvvksci$art_i<groups.length;$art_ihbbyvvksci$art_i++){var group=groups[$art_ihbbyvvksci$art_i]%>';
                for (var $art_ihbbyvvksci$art_i = 0; $art_ihbbyvvksci$art_i < groups.length; $art_ihbbyvvksci$art_i++) {
                    var group = groups[$art_ihbbyvvksci$art_i];
                    $p += ' ';
                    $line = 104;
                    $art = 'each group.fields as field';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_izpuakqzr$art_i=0,$art_objfzthtgmf$art_obj=group.fields;$art_izpuakqzr$art_i<$art_objfzthtgmf$art_obj.length;$art_izpuakqzr$art_i++){var field=$art_objfzthtgmf$art_obj[$art_izpuakqzr$art_i]%>';
                    for (var $art_izpuakqzr$art_i = 0, $art_objfzthtgmf$art_obj = group.fields; $art_izpuakqzr$art_i < $art_objfzthtgmf$art_obj.length; $art_izpuakqzr$art_i++) {
                        var field = $art_objfzthtgmf$art_obj[$art_izpuakqzr$art_i];
                        $p += '<td>子表头滚动';
                        $line = 105;
                        $art = '=field';
                        ;
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_iikzomssnmm$art_i=0,$art_objwtahfwi$art_obj=item.subs;$art_iikzomssnmm$art_i<$art_objwtahfwi$art_obj.length;$art_iikzomssnmm$art_i++){var sub=$art_objwtahfwi$art_obj[$art_iikzomssnmm$art_i]%>';
                for (var $art_iikzomssnmm$art_i = 0, $art_objwtahfwi$art_obj = item.subs; $art_iikzomssnmm$art_i < $art_objwtahfwi$art_obj.length; $art_iikzomssnmm$art_i++) {
                    var sub = $art_objwtahfwi$art_obj[$art_iikzomssnmm$art_i];
                    $p += '<tr>';
                    $line = 111;
                    $art = 'each groups as group';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_igrzxwfrq$art_i=0;$art_igrzxwfrq$art_i<groups.length;$art_igrzxwfrq$art_i++){var group=groups[$art_igrzxwfrq$art_i]%>';
                    for (var $art_igrzxwfrq$art_i = 0; $art_igrzxwfrq$art_i < groups.length; $art_igrzxwfrq$art_i++) {
                        var group = groups[$art_igrzxwfrq$art_i];
                        $p += ' ';
                        $line = 112;
                        $art = 'each group.fields as field';
                        ;
                        $p += '';
                        $expr = '<%for(var $art_iqafnjfufu$art_i=0,$art_objmrhs$art_obj=group.fields;$art_iqafnjfufu$art_i<$art_objmrhs$art_obj.length;$art_iqafnjfufu$art_i++){var field=$art_objmrhs$art_obj[$art_iqafnjfufu$art_i]%>';
                        for (var $art_iqafnjfufu$art_i = 0, $art_objmrhs$art_obj = group.fields; $art_iqafnjfufu$art_i < $art_objmrhs$art_obj.length; $art_iqafnjfufu$art_i++) {
                            var field = $art_objmrhs$art_obj[$art_iqafnjfufu$art_i];
                            $p += '<td>';
                            $line = 113;
