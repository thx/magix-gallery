    ...
    if (list.length > 0) {
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var subIndex=0,$art_objpcqpfp$art_obj=item.subs;subIndex<$art_objpcqpfp$art_obj.length;subIndex++){var sub=$art_objpcqpfp$art_obj[subIndex]%>';
                for (var subIndex = 0, $art_objpcqpfp$art_obj = item.subs; subIndex < $art_objpcqpfp$art_obj.length; subIndex++) {
                    var sub = $art_objpcqpfp$art_obj[subIndex];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_inzsdeiub$art_i=0;$art_inzsdeiub$art_i<groups.length;$art_inzsdeiub$art_i++){var group=groups[$art_inzsdeiub$art_i]%>';
        for (var $art_inzsdeiub$art_i = 0; $art_inzsdeiub$art_i < groups.length; $art_inzsdeiub$art_i++) {
            var group = groups[$art_inzsdeiub$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_injhggsbul$art_i=0;$art_injhggsbul$art_i<groups.length;$art_injhggsbul$art_i++){var group=groups[$art_injhggsbul$art_i]%>';
        for (var $art_injhggsbul$art_i = 0; $art_injhggsbul$art_i < groups.length; $art_injhggsbul$art_i++) {
            var group = groups[$art_injhggsbul$art_i];
            $p += ' ';
            $line = 82;
            $art = 'each group.fields as field';
            ;
            $p += '';
            $expr = '<%for(var $art_ijnknaoen$art_i=0,$art_objpmaclnjfu$art_obj=group.fields;$art_ijnknaoen$art_i<$art_objpmaclnjfu$art_obj.length;$art_ijnknaoen$art_i++){var field=$art_objpmaclnjfu$art_obj[$art_ijnknaoen$art_i]%>';
            for (var $art_ijnknaoen$art_i = 0, $art_objpmaclnjfu$art_obj = group.fields; $art_ijnknaoen$art_i < $art_objpmaclnjfu$art_obj.length; $art_ijnknaoen$art_i++) {
                var field = $art_objpmaclnjfu$art_obj[$art_ijnknaoen$art_i];
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_ibgwipkt$art_i=0;$art_ibgwipkt$art_i<groups.length;$art_ibgwipkt$art_i++){var group=groups[$art_ibgwipkt$art_i]%>';
            for (var $art_ibgwipkt$art_i = 0; $art_ibgwipkt$art_i < groups.length; $art_ibgwipkt$art_i++) {
                var group = groups[$art_ibgwipkt$art_i];
                $p += ' ';
                $line = 92;
                $art = 'each group.fields as field';
                ;
                $p += '';
                $expr = '<%for(var $art_ialsarslqt$art_i=0,$art_objjtfpllqqr$art_obj=group.fields;$art_ialsarslqt$art_i<$art_objjtfpllqqr$art_obj.length;$art_ialsarslqt$art_i++){var field=$art_objjtfpllqqr$art_obj[$art_ialsarslqt$art_i]%>';
                for (var $art_ialsarslqt$art_i = 0, $art_objjtfpllqqr$art_obj = group.fields; $art_ialsarslqt$art_i < $art_objjtfpllqqr$art_obj.length; $art_ialsarslqt$art_i++) {
                    var field = $art_objjtfpllqqr$art_obj[$art_ialsarslqt$art_i];
                    $p += '<td>';
                    $line = 93;
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_ixynxbhk$art_i=0;$art_ixynxbhk$art_i<groups.length;$art_ixynxbhk$art_i++){var group=groups[$art_ixynxbhk$art_i]%>';
                for (var $art_ixynxbhk$art_i = 0; $art_ixynxbhk$art_i < groups.length; $art_ixynxbhk$art_i++) {
                    var group = groups[$art_ixynxbhk$art_i];
                    $p += ' ';
                    $line = 104;
                    $art = 'each group.fields as field';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_igzbrv$art_i=0,$art_objhpmxcaf$art_obj=group.fields;$art_igzbrv$art_i<$art_objhpmxcaf$art_obj.length;$art_igzbrv$art_i++){var field=$art_objhpmxcaf$art_obj[$art_igzbrv$art_i]%>';
                    for (var $art_igzbrv$art_i = 0, $art_objhpmxcaf$art_obj = group.fields; $art_igzbrv$art_i < $art_objhpmxcaf$art_obj.length; $art_igzbrv$art_i++) {
                        var field = $art_objhpmxcaf$art_obj[$art_igzbrv$art_i];
                        $p += '<td>子表头滚动';
                        $line = 105;
                        $art = '=field';
                        ;
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_iyfwqxov$art_i=0,$art_objxcvlycxhl$art_obj=item.subs;$art_iyfwqxov$art_i<$art_objxcvlycxhl$art_obj.length;$art_iyfwqxov$art_i++){var sub=$art_objxcvlycxhl$art_obj[$art_iyfwqxov$art_i]%>';
                for (var $art_iyfwqxov$art_i = 0, $art_objxcvlycxhl$art_obj = item.subs; $art_iyfwqxov$art_i < $art_objxcvlycxhl$art_obj.length; $art_iyfwqxov$art_i++) {
                    var sub = $art_objxcvlycxhl$art_obj[$art_iyfwqxov$art_i];
                    $p += '<tr>';
                    $line = 111;
                    $art = 'each groups as group';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_iwqc$art_i=0;$art_iwqc$art_i<groups.length;$art_iwqc$art_i++){var group=groups[$art_iwqc$art_i]%>';
                    for (var $art_iwqc$art_i = 0; $art_iwqc$art_i < groups.length; $art_iwqc$art_i++) {
                        var group = groups[$art_iwqc$art_i];
                        $p += ' ';
                        $line = 112;
                        $art = 'each group.fields as field';
                        ;
                        $p += '';
                        $expr = '<%for(var $art_ioftqvtyp$art_i=0,$art_objtogsdqmhab$art_obj=group.fields;$art_ioftqvtyp$art_i<$art_objtogsdqmhab$art_obj.length;$art_ioftqvtyp$art_i++){var field=$art_objtogsdqmhab$art_obj[$art_ioftqvtyp$art_i]%>';
                        for (var $art_ioftqvtyp$art_i = 0, $art_objtogsdqmhab$art_obj = group.fields; $art_ioftqvtyp$art_i < $art_objtogsdqmhab$art_obj.length; $art_ioftqvtyp$art_i++) {
                            var field = $art_objtogsdqmhab$art_obj[$art_ioftqvtyp$art_i];
                            $p += '<td>';
                            $line = 113;
