...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryA:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_galleryA:a" class="_zs_gallery___test___base_-eg-content"><div mxs="_zs_galleryA:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl"><div>只能选择到省份</div><div>宽度由容器宽度决定，自适应</div></div></div><div mxv mxa="_zs_galleryA:b" class="clearfix mb20"><div mxv mxa="_zs_galleryA:c" class="_zs_gallery_mx-area___test___index_-area-wrapper2 fl mr20"><div mxv="selected" id="';
    $line = 12;
    $art = '=viewId';
    ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iwohjdqawna$art_i=0;$art_iwohjdqawna$art_i<selected.length;$art_iwohjdqawna$art_i++){var item=selected[$art_iwohjdqawna$art_i]%>';
    for (var $art_iwohjdqawna$art_i = 0; $art_iwohjdqawna$art_i < selected.length; $art_iwohjdqawna$art_i++) {
        var item = selected[$art_iwohjdqawna$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
