...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ictwpwcyh$art_i=0;$art_ictwpwcyh$art_i<supportQuickDates.length;$art_ictwpwcyh$art_i++){var item=supportQuickDates[$art_ictwpwcyh$art_i]%>';
    for (var $art_ictwpwcyh$art_i = 0; $art_ictwpwcyh$art_i < supportQuickDates.length; $art_ictwpwcyh$art_i++) {
        var item = supportQuickDates[$art_ictwpwcyh$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=item.key';
        ;
