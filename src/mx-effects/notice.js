...
module.exports = Magix.View.extend({
    ...
    $art = '=styles';
    ;
    $p += '' + ($expr = '<%=styles%>', $e(styles)) + '"><span mxa="_zs_galleryaE:_" class="_zs_gallery_mx-effects_notice_-inner"><i mxs="_zs_galleryaE:_" class="mc-iconfont _zs_gallery_mx-effects_notice_-icon">&#xe6ad;</i>';
    $line = 3;
    $art = '=content';
    ;
