...
Magix.applyStyle("o",".cT,.cT:hover{border-color:#a62a22!important}.cU{display:none;position:absolute;white-space:nowrap;word-wrap:normal;pointer-events:none;color:#666;font-size:10px;top:1px;line-height:1}");
...
module.exports = {
    ...
    '_b<change>': function (e) {
        var me = this, node = $(e.eventTarget);
        var last = node.prop('_lt');
        var now = Date.now();
        if (last && (now - last) < 10)
            return;
        node.prop('_lt', now);
