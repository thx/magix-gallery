...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya4:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallerya4:_" class="_zs_gallery___test___base_-eg-content"><div mx-view="mx-footer/index"></div></div><div mxa="_zs_gallerya4:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerya4:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 7;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerya4:b" class="_zs_gallery___test___base_-desc-tip">';
    $line = 9;
    $art = '!text1';
    ;
