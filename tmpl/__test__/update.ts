        ...
        let list = [{
            ...
            subs: [{
                ...
                subs: [{
                    ...
                    title: 'mx-popmenu：支持配置disabled禁用，<a href="#!/popmenu/index?highlightId=mx_12_demo6" class="color-brand">点击查看</a>'
                }, {
            ...
            subs: [{
                ...
                type: 'bugfix',
                subs: [{
                    title: 'mx-indics.icon：根据上限截断默认值'
                }]
            }]
        }, {
            ver: '1.6.84 ~ 1.6.88',
            ...
            subs: [{
                type: 'bug',
                subs: [{
                    title: 'mx-style：group_qianniu 千牛变量修正'
                }]
            }]
        }, {
            ver: '1.6.72',
            ...
            subs: [{
                ...
                subs: [{
                    ...
                    title: '阶梯规则宽度定义：',
                    subs: [
                        '表格阶梯规则宽度定义，<a href="#!/stickytable/loading" class="color-brand">点击查看</a>',
                        '表单阶梯规则宽度定义，<a href="#!/form/style?highlightId=mx_12_demo29" class="color-brand">点击查看</a>'
                    ]
                }]
            }]
        }, {
            ...
            subs: [{
                type: 'add',
                subs: [{
                    title: 'mx-time：支持配置时分秒上下限，根据B类规范调整样式，<a href="#!/time/index" class="color-brand">点击查看</a>'
                }, {
            ...
            subs: [{
                ...
                subs: [{
                    ...
                    title: 'mx-tabs.box：新增disabledTip禁用提示原因，<a href="#!/tabs/box?highlightId=mx_12_demo21" class="color-brand">点击查看</a>'
                }, {
