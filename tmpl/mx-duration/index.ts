...
export default View.extend({
    ...
    assign(extra) {
        ...
        let colorMap = ColorMap[extra.bizCode] || {
            ...
            '[40,50)': `rgba(${r},${g},${b},0.1)`,
            '[50,60)': `rgba(${r},${g},${b},0.15)`,
            '[60,70)': `rgba(${r},${g},${b},0.2)`,
            '[70,80)': `rgba(${r},${g},${b},0.25)`,
            '[80,90)': `rgba(${r},${g},${b},0.3)`,
            '[90,100)': `rgba(${r},${g},${b},0.35)`,
            '[100,101)': `rgba(${r},${g},${b},0.4)`,
            '[101,110)': 'rgba(255,131,27,0.15)',
            '[110,120)': 'rgba(255,131,27,0.2)',
            '[120,130)': 'rgba(255,131,27,0.25)',
            '[130,140)': 'rgba(255,131,27,0.3)',
            '[140,150)': 'rgba(255,131,27,0.35)',
            '[150,160)': 'rgba(255,131,27,0.4)',
            '[160,170)': 'rgba(255,131,27,0.45)',
            '[170,180)': 'rgba(255,131,27,0.5)',
            '[180,190)': 'rgba(255,131,27,0.55)',
            '[190,200)': 'rgba(255,131,27,0.6)',
            '[200,210)': 'rgba(229,60,197,0.3)',
            '[210,220)': 'rgba(229,60,197,0.35)',
            '[220,230)': 'rgba(229,60,197,0.4)',
            '[230,240)': 'rgba(229,60,197,0.45)',
            '[240,250)': 'rgba(229,60,197,0.5)',
            '[250,251)': 'rgba(229,60,197,0.55)'
        };
