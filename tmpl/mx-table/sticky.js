...
module.exports = Magix.View.extend({
    ...
    '@{table.init}'() {
        ...
        if (leftTable) {
            ...
            wrapper.addClass('@sticky.less:wrapper');
            // outerWidth包含padding
            // width不包含padding
    ...
    '@{scroll.init}'() {
        ...
        if (leftWrapper && (leftWrapper.length > 0) && (leftWrapper.hasClass('@sticky.less:left-shadow'))) {
            me['@{need.scroll}'] = true;
            ...
            if (scrollbar && scrollbar.length) {
                ...
                scrollbar.find('.@sticky.less:bar').width(innerWidth);
            } else {
                let tmpl = `<div id="${viewId}_scrollbar" class="@sticky.less:scrollbar" style="width:${outerWidth}px;"><div class="@sticky.less:bar" style="width:${innerWidth}px;"><div><div>`
    ...
    '@{main.table.sync.width}'() {
        ...
        if (width > layoutWidth) {
            ...
            leftWrapper.addClass('@sticky.less:left-shadow');
        } else {
            table.css('width', layoutWidth);
            table.find('thead').css('width', layoutWidth);
            leftWrapper.removeClass('@sticky.less:left-shadow');
        }
    },
    ...
    '@{sync.scroll.pos.custom}'(node) {
        ...
        let bar = scrollbar.find('.@sticky.less:bar');
