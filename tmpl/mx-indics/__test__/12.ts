...
export default Base.extend({
    ...
    render() {
        let list = [{
            ...
            text: '展现量', value: 2, pValue: 1, default: true, disabled: true,
        }, {
            text: '点击量', value: 3, pValue: 1, default: true, disabled: true,
        }, {
            ...
            text: '成交笔数', value: 7, pValue: 2, disabled: true,
        }, {
            text: '平均停留时长', value: 8, pValue: 2, tip: '淘积木页面平均停留时长提示文案',
        }, {
            text: '投资回报率', value: 9, pValue: 2,
        }, {
            text: '访问页面数', value: 10, pValue: 2, disabled: true,
        }];
