...
module.exports = {
    'mx-im.ww'(i) {
        ...
        return `<a target="_blank" rel="noopener noreferrer" href="//awp.taobao.com/bs/wwlight.html?ver=3&touid=${a.viewAttrsMap.uid}&siteid=cntaobao&status=2&charset=utf-8" ${a.attrs}>
