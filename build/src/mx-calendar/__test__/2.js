...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery5:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery5:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery5:_" class="mb20"><span class="color-9">以下示例：</span>可选择小时，分秒不可选</div><div class="w200" mx-view="mx-calendar/datepicker?timeType=hour&selected=';
    $line = 9;
    $art = '=selected';
    ;
