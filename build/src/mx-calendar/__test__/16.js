...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryT:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryT:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryT:_" class="mb10 clearfix"><span class="color-9">以下示例：</span>限制只可选择到月份</div><div class="w200" mx-change="' + $viewId + 'select()" mx-view="mx-calendar/datepicker?min=2018-02&max=2018-10&dateType=year%2Cmonth&selected=';
    $line = 11;
    $art = '=selected';
    ;
    $p += '' + ($expr = '<%!$eu(selected)%>', $eu(selected)) + '"></div></div><div mxa="_zs_galleryT:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryT:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
