...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallery9:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallery9:a" class="clearfix mb20"><div mxa="_zs_gallery9:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-calendar/__test__/1" id="';
    $line = 29;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxs="_zs_gallery9:_" mx-view="mx-calendar/__test__/2"></div><div mx-view="mx-calendar/__test__/16" id="';
    $line = 31;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo16"></div></div><div mxa="_zs_gallery9:c" class="_zs_gallery___test___layout_-half"><div mxs="_zs_gallery9:a" mx-view="mx-calendar/__test__/3"></div><div mx-view="mx-calendar/__test__/4" id="';
    $line = 35;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo14"></div><div mxs="_zs_gallery9:b" mx-view="mx-calendar/__test__/5"></div></div></div><div id="';
    $line = 41;
    $art = '=viewId';
    ;
