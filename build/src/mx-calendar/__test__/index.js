/*
    ...
    loader: cmd_es
 */
define("mx-calendar/__test__/index",["magix","$","__test__/subs","mx-title/second","./1","./5","./14","./16","./4","./2","./3","./17","__test__/api","__test__/event","./implement"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    ;
    $p += ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'事件 + 前缀\',                    key: viewId + \'_demo1\'                }, {                    name: \'限制部分不可选\',                    key: viewId + \'_demo14\'                }, {                    name: \'只选择月份\',                    key: viewId + \'_demo16\'                }, {                    name: \'可选择时分秒\',                    key: viewId + \'_demo4\'                }, {                    name: \'可选择小时\',                    key: viewId + \'_demo2\'                }, {                    name: \'可选择时分\',                    key: viewId + \'_demo3\'                }, {                    name: \'范围修正\',                    key: viewId + \'_demo5\'                }, {                    name: \'自定义formatter\',                    key: viewId + \'_demo17\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }, {            name: \'Event\',            key: viewId + \'_event\'        }, {            name: \'关于实现方案\',            key: viewId + \'_implement\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '事件 + 前缀', key: viewId + '_demo1' }, { name: '限制部分不可选', key: viewId + '_demo14' }, { name: '只选择月份', key: viewId + '_demo16' }, { name: '可选择时分秒', key: viewId + '_demo4' }, { name: '可选择小时', key: viewId + '_demo2' }, { name: '可选择时分', key: viewId + '_demo3' }, { name: '范围修正', key: viewId + '_demo5' }, { name: '自定义formatter', key: viewId + '_demo17' }] }, { name: 'API', key: viewId + '_api' }, { name: 'Event', key: viewId + '_event' }, { name: '关于实现方案', key: viewId + '_implement' }])) + '"></div><div id="';
    $line = 41;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_gallery^:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-calendar/__test__/14" id="';
    $line = 48;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo17"></div></div></div><div id="';
    $line = 57;
    $art = '=viewId';
    ;
