...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ihjqkyutlg$art_i = 0, $art_cfxjtown$art_c = supportQuickDates.length; $art_ihjqkyutlg$art_i < $art_cfxjtown$art_c; $art_ihjqkyutlg$art_i++) {    var item = supportQuickDates[$art_ihjqkyutlg$art_i]%>';
    for (var $art_ihjqkyutlg$art_i = 0, $art_cfxjtown$art_c = supportQuickDates.length; $art_ihjqkyutlg$art_i < $art_cfxjtown$art_c; $art_ihjqkyutlg$art_i++) {
        var item = supportQuickDates[$art_ihjqkyutlg$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
