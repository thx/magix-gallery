...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iitvyugag$art_i = 0, $art_cstbliwe$art_c = supportQuickDates.length; $art_iitvyugag$art_i < $art_cstbliwe$art_c; $art_iitvyugag$art_i++) {    var item = supportQuickDates[$art_iitvyugag$art_i]%>';
    for (var $art_iitvyugag$art_i = 0, $art_cstbliwe$art_c = supportQuickDates.length; $art_iitvyugag$art_i < $art_cstbliwe$art_c; $art_iitvyugag$art_i++) {
        var item = supportQuickDates[$art_iitvyugag$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
