...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idotaoksmq$art_i = 0, $art_cfgcslieklsq$art_c = supportQuickDates.length; $art_idotaoksmq$art_i < $art_cfgcslieklsq$art_c; $art_idotaoksmq$art_i++) {    var item = supportQuickDates[$art_idotaoksmq$art_i]%>';
    for (var $art_idotaoksmq$art_i = 0, $art_cfgcslieklsq$art_c = supportQuickDates.length; $art_idotaoksmq$art_i < $art_cfgcslieklsq$art_c; $art_idotaoksmq$art_i++) {
        var item = supportQuickDates[$art_idotaoksmq$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
