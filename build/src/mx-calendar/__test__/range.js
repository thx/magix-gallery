...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwlqyv$art_i = 0, $art_ccnrmpfgiun$art_c = supportQuickDates.length; $art_iwlqyv$art_i < $art_ccnrmpfgiun$art_c; $art_iwlqyv$art_i++) {    var item = supportQuickDates[$art_iwlqyv$art_i]%>';
    for (var $art_iwlqyv$art_i = 0, $art_ccnrmpfgiun$art_c = supportQuickDates.length; $art_iwlqyv$art_i < $art_ccnrmpfgiun$art_c; $art_iwlqyv$art_i++) {
        var item = supportQuickDates[$art_iwlqyv$art_i];
        $p += '<tr><td>';
        $line = 87;
        $art = '=item.key';
        ;
