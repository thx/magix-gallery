...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaxkxylhq$art_i = 0, $art_cvrntfxh$art_c = supportQuickDates.length; $art_iaxkxylhq$art_i < $art_cvrntfxh$art_c; $art_iaxkxylhq$art_i++) {    var item = supportQuickDates[$art_iaxkxylhq$art_i]%>';
    for (var $art_iaxkxylhq$art_i = 0, $art_cvrntfxh$art_c = supportQuickDates.length; $art_iaxkxylhq$art_i < $art_cvrntfxh$art_c; $art_iaxkxylhq$art_i++) {
        var item = supportQuickDates[$art_iaxkxylhq$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
