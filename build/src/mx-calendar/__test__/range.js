...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iujtz$art_i = 0, $art_cirucnju$art_c = supportQuickDates.length; $art_iujtz$art_i < $art_cirucnju$art_c; $art_iujtz$art_i++) {    var item = supportQuickDates[$art_iujtz$art_i]%>';
    for (var $art_iujtz$art_i = 0, $art_cirucnju$art_c = supportQuickDates.length; $art_iujtz$art_i < $art_cirucnju$art_c; $art_iujtz$art_i++) {
        var item = supportQuickDates[$art_iujtz$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
