...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iognizpb$art_i = 0, $art_cqqjkapsm$art_c = supportQuickDates.length; $art_iognizpb$art_i < $art_cqqjkapsm$art_c; $art_iognizpb$art_i++) {    var item = supportQuickDates[$art_iognizpb$art_i]%>';
    for (var $art_iognizpb$art_i = 0, $art_cqqjkapsm$art_c = supportQuickDates.length; $art_iognizpb$art_i < $art_cqqjkapsm$art_c; $art_iognizpb$art_i++) {
        var item = supportQuickDates[$art_iognizpb$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
