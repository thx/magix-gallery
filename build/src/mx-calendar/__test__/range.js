...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyxaennkec$art_i = 0, $art_csfqgynzvgn$art_c = supportQuickDates.length; $art_iyxaennkec$art_i < $art_csfqgynzvgn$art_c; $art_iyxaennkec$art_i++) {    var item = supportQuickDates[$art_iyxaennkec$art_i]%>';
    for (var $art_iyxaennkec$art_i = 0, $art_csfqgynzvgn$art_c = supportQuickDates.length; $art_iyxaennkec$art_i < $art_csfqgynzvgn$art_c; $art_iyxaennkec$art_i++) {
        var item = supportQuickDates[$art_iyxaennkec$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
