...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_izttbahqbe$art_i = 0, $art_cdgsqrhxq$art_c = supportQuickDates.length; $art_izttbahqbe$art_i < $art_cdgsqrhxq$art_c; $art_izttbahqbe$art_i++) {    var item = supportQuickDates[$art_izttbahqbe$art_i]%>';
    for (var $art_izttbahqbe$art_i = 0, $art_cdgsqrhxq$art_c = supportQuickDates.length; $art_izttbahqbe$art_i < $art_cdgsqrhxq$art_c; $art_izttbahqbe$art_i++) {
        var item = supportQuickDates[$art_izttbahqbe$art_i];
        $p += '<tr><td>';
        $line = 47;
        $art = '=item.key';
        ;
