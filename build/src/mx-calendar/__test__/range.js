...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijhbluaif$art_i = 0, $art_cxyfsbpby$art_c = supportQuickDates.length; $art_ijhbluaif$art_i < $art_cxyfsbpby$art_c; $art_ijhbluaif$art_i++) {    var item = supportQuickDates[$art_ijhbluaif$art_i]%>';
    for (var $art_ijhbluaif$art_i = 0, $art_cxyfsbpby$art_c = supportQuickDates.length; $art_ijhbluaif$art_i < $art_cxyfsbpby$art_c; $art_ijhbluaif$art_i++) {
        var item = supportQuickDates[$art_ijhbluaif$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
