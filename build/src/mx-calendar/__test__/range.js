...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibmqalqgr$art_i = 0, $art_caxpsrrbfhk$art_c = supportQuickDates.length; $art_ibmqalqgr$art_i < $art_caxpsrrbfhk$art_c; $art_ibmqalqgr$art_i++) {    var item = supportQuickDates[$art_ibmqalqgr$art_i]%>';
    for (var $art_ibmqalqgr$art_i = 0, $art_caxpsrrbfhk$art_c = supportQuickDates.length; $art_ibmqalqgr$art_i < $art_caxpsrrbfhk$art_c; $art_ibmqalqgr$art_i++) {
        var item = supportQuickDates[$art_ibmqalqgr$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
