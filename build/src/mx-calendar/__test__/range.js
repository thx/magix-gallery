...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iurmqggj$art_i = 0, $art_cfqctgmv$art_c = supportQuickDates.length; $art_iurmqggj$art_i < $art_cfqctgmv$art_c; $art_iurmqggj$art_i++) {    var item = supportQuickDates[$art_iurmqggj$art_i]%>';
    for (var $art_iurmqggj$art_i = 0, $art_cfqctgmv$art_c = supportQuickDates.length; $art_iurmqggj$art_i < $art_cfqctgmv$art_c; $art_iurmqggj$art_i++) {
        var item = supportQuickDates[$art_iurmqggj$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
