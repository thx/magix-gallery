...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ibjtxjgbhr$art_i=0;$art_ibjtxjgbhr$art_i<supportQuickDates.length;$art_ibjtxjgbhr$art_i++){var item=supportQuickDates[$art_ibjtxjgbhr$art_i]%>';
    for (var $art_ibjtxjgbhr$art_i = 0; $art_ibjtxjgbhr$art_i < supportQuickDates.length; $art_ibjtxjgbhr$art_i++) {
        var item = supportQuickDates[$art_ibjtxjgbhr$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=item.key';
        ;
