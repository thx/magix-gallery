...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irxkduasslg$art_i = 0, $art_czmuatlqanj$art_c = supportQuickDates.length; $art_irxkduasslg$art_i < $art_czmuatlqanj$art_c; $art_irxkduasslg$art_i++) {    var item = supportQuickDates[$art_irxkduasslg$art_i]%>';
    for (var $art_irxkduasslg$art_i = 0, $art_czmuatlqanj$art_c = supportQuickDates.length; $art_irxkduasslg$art_i < $art_czmuatlqanj$art_c; $art_irxkduasslg$art_i++) {
        var item = supportQuickDates[$art_irxkduasslg$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
