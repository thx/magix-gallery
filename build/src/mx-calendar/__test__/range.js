...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icootroszm$art_i = 0, $art_cjpnnmog$art_c = supportQuickDates.length; $art_icootroszm$art_i < $art_cjpnnmog$art_c; $art_icootroszm$art_i++) {    var item = supportQuickDates[$art_icootroszm$art_i]%>';
    for (var $art_icootroszm$art_i = 0, $art_cjpnnmog$art_c = supportQuickDates.length; $art_icootroszm$art_i < $art_cjpnnmog$art_c; $art_icootroszm$art_i++) {
        var item = supportQuickDates[$art_icootroszm$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
