...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijjvjkuw$art_i = 0, $art_cvgosusnv$art_c = supportQuickDates.length; $art_ijjvjkuw$art_i < $art_cvgosusnv$art_c; $art_ijjvjkuw$art_i++) {    var item = supportQuickDates[$art_ijjvjkuw$art_i]%>';
    for (var $art_ijjvjkuw$art_i = 0, $art_cvgosusnv$art_c = supportQuickDates.length; $art_ijjvjkuw$art_i < $art_cvgosusnv$art_c; $art_ijjvjkuw$art_i++) {
        var item = supportQuickDates[$art_ijjvjkuw$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
