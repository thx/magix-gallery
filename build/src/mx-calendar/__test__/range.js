...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inohsjq$art_i = 0, $art_crlybnses$art_c = supportQuickDates.length; $art_inohsjq$art_i < $art_crlybnses$art_c; $art_inohsjq$art_i++) {    var item = supportQuickDates[$art_inohsjq$art_i]%>';
    for (var $art_inohsjq$art_i = 0, $art_crlybnses$art_c = supportQuickDates.length; $art_inohsjq$art_i < $art_crlybnses$art_c; $art_inohsjq$art_i++) {
        var item = supportQuickDates[$art_inohsjq$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
