...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyvkgyjmsod$art_i = 0, $art_cggegmnfys$art_c = supportQuickDates.length; $art_iyvkgyjmsod$art_i < $art_cggegmnfys$art_c; $art_iyvkgyjmsod$art_i++) {    var item = supportQuickDates[$art_iyvkgyjmsod$art_i]%>';
    for (var $art_iyvkgyjmsod$art_i = 0, $art_cggegmnfys$art_c = supportQuickDates.length; $art_iyvkgyjmsod$art_i < $art_cggegmnfys$art_c; $art_iyvkgyjmsod$art_i++) {
        var item = supportQuickDates[$art_iyvkgyjmsod$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
