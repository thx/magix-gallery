...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyopzckwdc$art_i = 0, $art_cifyeo$art_c = supportQuickDates.length; $art_iyopzckwdc$art_i < $art_cifyeo$art_c; $art_iyopzckwdc$art_i++) {    var item = supportQuickDates[$art_iyopzckwdc$art_i]%>';
    for (var $art_iyopzckwdc$art_i = 0, $art_cifyeo$art_c = supportQuickDates.length; $art_iyopzckwdc$art_i < $art_cifyeo$art_c; $art_iyopzckwdc$art_i++) {
        var item = supportQuickDates[$art_iyopzckwdc$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
