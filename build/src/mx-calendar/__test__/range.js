...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iivefsr$art_i = 0, $art_cftkesgxgn$art_c = supportQuickDates.length; $art_iivefsr$art_i < $art_cftkesgxgn$art_c; $art_iivefsr$art_i++) {    var item = supportQuickDates[$art_iivefsr$art_i]%>';
    for (var $art_iivefsr$art_i = 0, $art_cftkesgxgn$art_c = supportQuickDates.length; $art_iivefsr$art_i < $art_cftkesgxgn$art_c; $art_iivefsr$art_i++) {
        var item = supportQuickDates[$art_iivefsr$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
