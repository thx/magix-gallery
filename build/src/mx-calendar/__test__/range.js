...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iepntmbhf$art_i = 0, $art_cluikdguhirr$art_c = supportQuickDates.length; $art_iepntmbhf$art_i < $art_cluikdguhirr$art_c; $art_iepntmbhf$art_i++) {    var item = supportQuickDates[$art_iepntmbhf$art_i]%>';
    for (var $art_iepntmbhf$art_i = 0, $art_cluikdguhirr$art_c = supportQuickDates.length; $art_iepntmbhf$art_i < $art_cluikdguhirr$art_c; $art_iepntmbhf$art_i++) {
        var item = supportQuickDates[$art_iepntmbhf$art_i];
        $p += '<tr><td>';
        $line = 87;
        $art = '=item.key';
        ;
