...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imyafdwbd$art_i = 0, $art_cejkkhruj$art_c = supportQuickDates.length; $art_imyafdwbd$art_i < $art_cejkkhruj$art_c; $art_imyafdwbd$art_i++) {    var item = supportQuickDates[$art_imyafdwbd$art_i]%>';
    for (var $art_imyafdwbd$art_i = 0, $art_cejkkhruj$art_c = supportQuickDates.length; $art_imyafdwbd$art_i < $art_cejkkhruj$art_c; $art_imyafdwbd$art_i++) {
        var item = supportQuickDates[$art_imyafdwbd$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
