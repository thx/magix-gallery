...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iscnuyhfl$art_i = 0, $art_cdmkvybll$art_c = supportQuickDates.length; $art_iscnuyhfl$art_i < $art_cdmkvybll$art_c; $art_iscnuyhfl$art_i++) {    var item = supportQuickDates[$art_iscnuyhfl$art_i]%>';
    for (var $art_iscnuyhfl$art_i = 0, $art_cdmkvybll$art_c = supportQuickDates.length; $art_iscnuyhfl$art_i < $art_cdmkvybll$art_c; $art_iscnuyhfl$art_i++) {
        var item = supportQuickDates[$art_iscnuyhfl$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
