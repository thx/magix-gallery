...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_itrseaaakl$art_i = 0, $art_cdmkfkcqc$art_c = supportQuickDates.length; $art_itrseaaakl$art_i < $art_cdmkfkcqc$art_c; $art_itrseaaakl$art_i++) {    var item = supportQuickDates[$art_itrseaaakl$art_i]%>';
    for (var $art_itrseaaakl$art_i = 0, $art_cdmkfkcqc$art_c = supportQuickDates.length; $art_itrseaaakl$art_i < $art_cdmkfkcqc$art_c; $art_itrseaaakl$art_i++) {
        var item = supportQuickDates[$art_itrseaaakl$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
