...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo20"></div></div><div mxa="_zs_gallery):f" class="_zs_gallery___test___layout_-half"><div mx-view="mx-calendar/__test__/7" id="';
    $line = 61;
    $art = '=viewId';
    ;
    ...
    ;
    $expr = '<%for (var $art_inyrdwtiyd$art_i = 0, $art_cpubbqgpa$art_c = supportQuickDates.length; $art_inyrdwtiyd$art_i < $art_cpubbqgpa$art_c; $art_inyrdwtiyd$art_i++) {    var item = supportQuickDates[$art_inyrdwtiyd$art_i]%>';
    for (var $art_inyrdwtiyd$art_i = 0, $art_cpubbqgpa$art_c = supportQuickDates.length; $art_inyrdwtiyd$art_i < $art_cpubbqgpa$art_c; $art_inyrdwtiyd$art_i++) {
        var item = supportQuickDates[$art_inyrdwtiyd$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
