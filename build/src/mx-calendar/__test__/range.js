...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inzzqiip$art_i = 0, $art_cacqtdbs$art_c = supportQuickDates.length; $art_inzzqiip$art_i < $art_cacqtdbs$art_c; $art_inzzqiip$art_i++) {    var item = supportQuickDates[$art_inzzqiip$art_i]%>';
    for (var $art_inzzqiip$art_i = 0, $art_cacqtdbs$art_c = supportQuickDates.length; $art_inzzqiip$art_i < $art_cacqtdbs$art_c; $art_inzzqiip$art_i++) {
        var item = supportQuickDates[$art_inzzqiip$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
