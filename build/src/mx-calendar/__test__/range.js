...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibvwstjmh$art_i = 0, $art_cvabwzbng$art_c = supportQuickDates.length; $art_ibvwstjmh$art_i < $art_cvabwzbng$art_c; $art_ibvwstjmh$art_i++) {    var item = supportQuickDates[$art_ibvwstjmh$art_i]%>';
    for (var $art_ibvwstjmh$art_i = 0, $art_cvabwzbng$art_c = supportQuickDates.length; $art_ibvwstjmh$art_i < $art_cvabwzbng$art_c; $art_ibvwstjmh$art_i++) {
        var item = supportQuickDates[$art_ibvwstjmh$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
