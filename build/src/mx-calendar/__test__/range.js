...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ierixhyqq$art_i = 0, $art_cbhvqgxcpb$art_c = supportQuickDates.length; $art_ierixhyqq$art_i < $art_cbhvqgxcpb$art_c; $art_ierixhyqq$art_i++) {    var item = supportQuickDates[$art_ierixhyqq$art_i]%>';
    for (var $art_ierixhyqq$art_i = 0, $art_cbhvqgxcpb$art_c = supportQuickDates.length; $art_ierixhyqq$art_i < $art_cbhvqgxcpb$art_c; $art_ierixhyqq$art_i++) {
        var item = supportQuickDates[$art_ierixhyqq$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
