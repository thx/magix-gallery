...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ilfjkifxq$art_i = 0, $art_chbghse$art_c = supportQuickDates.length; $art_ilfjkifxq$art_i < $art_chbghse$art_c; $art_ilfjkifxq$art_i++) {    var item = supportQuickDates[$art_ilfjkifxq$art_i]%>';
    for (var $art_ilfjkifxq$art_i = 0, $art_chbghse$art_c = supportQuickDates.length; $art_ilfjkifxq$art_i < $art_chbghse$art_c; $art_ilfjkifxq$art_i++) {
        var item = supportQuickDates[$art_ilfjkifxq$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
