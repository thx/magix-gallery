...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iunfvzemp$art_i = 0, $art_crrtizfa$art_c = supportQuickDates.length; $art_iunfvzemp$art_i < $art_crrtizfa$art_c; $art_iunfvzemp$art_i++) {    var item = supportQuickDates[$art_iunfvzemp$art_i]%>';
    for (var $art_iunfvzemp$art_i = 0, $art_crrtizfa$art_c = supportQuickDates.length; $art_iunfvzemp$art_i < $art_crrtizfa$art_c; $art_iunfvzemp$art_i++) {
        var item = supportQuickDates[$art_iunfvzemp$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
