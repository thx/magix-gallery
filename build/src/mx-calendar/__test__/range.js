...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ibxwxzpc$art_i = 0, $art_cssxssmo$art_c = supportQuickDates.length; $art_ibxwxzpc$art_i < $art_cssxssmo$art_c; $art_ibxwxzpc$art_i++) {    var item = supportQuickDates[$art_ibxwxzpc$art_i]%>';
    for (var $art_ibxwxzpc$art_i = 0, $art_cssxssmo$art_c = supportQuickDates.length; $art_ibxwxzpc$art_i < $art_cssxssmo$art_c; $art_ibxwxzpc$art_i++) {
        var item = supportQuickDates[$art_ibxwxzpc$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
