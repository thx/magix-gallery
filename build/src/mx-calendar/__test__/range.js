...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iadnmb$art_i = 0, $art_cxhsmbwjhr$art_c = supportQuickDates.length; $art_iadnmb$art_i < $art_cxhsmbwjhr$art_c; $art_iadnmb$art_i++) {    var item = supportQuickDates[$art_iadnmb$art_i]%>';
    for (var $art_iadnmb$art_i = 0, $art_cxhsmbwjhr$art_c = supportQuickDates.length; $art_iadnmb$art_i < $art_cxhsmbwjhr$art_c; $art_iadnmb$art_i++) {
        var item = supportQuickDates[$art_iadnmb$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
