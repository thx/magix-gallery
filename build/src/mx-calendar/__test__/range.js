/*
    ...
    loader: cmd_es
 */
define("mx-calendar/__test__/range",["magix","$","mx-medusa/util","__test__/subs","mx-title/second","./6","./23","./12","./7","./8","./9","./11","./15","./22","./13","./10","./18","./20","__test__/api","__test__/event","./implement"],(require,exports,module)=>{
/*Magix,$,I18n*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"></div><div mx-view="mx-calendar/__test__/23" id="';
    $line = 63;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo23"></div><div mx-view="mx-calendar/__test__/12" id="';
    $line = 64;
    $art = '=viewId';
    ;
    ...
    ;
    $expr = '<%for (var $art_ieojwmosmeqb$art_i = 0, $art_chlyobmbjps$art_c = supportQuickDates.length; $art_ieojwmosmeqb$art_i < $art_chlyobmbjps$art_c; $art_ieojwmosmeqb$art_i++) {    var item = supportQuickDates[$art_ieojwmosmeqb$art_i]%>';
    for (var $art_ieojwmosmeqb$art_i = 0, $art_chlyobmbjps$art_c = supportQuickDates.length; $art_ieojwmosmeqb$art_i < $art_chlyobmbjps$art_c; $art_ieojwmosmeqb$art_i++) {
        var item = supportQuickDates[$art_ieojwmosmeqb$art_i];
        $p += '<tr><td>';
        $line = 99;
        $art = '=item.key';
        ;
