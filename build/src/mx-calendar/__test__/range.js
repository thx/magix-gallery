...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_immvxjxyvpv$art_i = 0, $art_cvyygowvc$art_c = supportQuickDates.length; $art_immvxjxyvpv$art_i < $art_cvyygowvc$art_c; $art_immvxjxyvpv$art_i++) {    var item = supportQuickDates[$art_immvxjxyvpv$art_i]%>';
    for (var $art_immvxjxyvpv$art_i = 0, $art_cvyygowvc$art_c = supportQuickDates.length; $art_immvxjxyvpv$art_i < $art_cvyygowvc$art_c; $art_immvxjxyvpv$art_i++) {
        var item = supportQuickDates[$art_immvxjxyvpv$art_i];
        $p += '<tr><td>';
        $line = 87;
        $art = '=item.key';
        ;
