...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itmpmjnzor$art_i = 0, $art_cpvaslli$art_c = supportQuickDates.length; $art_itmpmjnzor$art_i < $art_cpvaslli$art_c; $art_itmpmjnzor$art_i++) {    var item = supportQuickDates[$art_itmpmjnzor$art_i]%>';
    for (var $art_itmpmjnzor$art_i = 0, $art_cpvaslli$art_c = supportQuickDates.length; $art_itmpmjnzor$art_i < $art_cpvaslli$art_c; $art_itmpmjnzor$art_i++) {
        var item = supportQuickDates[$art_itmpmjnzor$art_i];
        $p += '<tr><td>';
        $line = 87;
        $art = '=item.key';
        ;
