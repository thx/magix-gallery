...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ialmex$art_i = 0, $art_ctxoxnolba$art_c = supportQuickDates.length; $art_ialmex$art_i < $art_ctxoxnolba$art_c; $art_ialmex$art_i++) {    var item = supportQuickDates[$art_ialmex$art_i]%>';
    for (var $art_ialmex$art_i = 0, $art_ctxoxnolba$art_c = supportQuickDates.length; $art_ialmex$art_i < $art_ctxoxnolba$art_c; $art_ialmex$art_i++) {
        var item = supportQuickDates[$art_ialmex$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
