...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inqyjngvr$art_i = 0, $art_cvxkvykqw$art_c = supportQuickDates.length; $art_inqyjngvr$art_i < $art_cvxkvykqw$art_c; $art_inqyjngvr$art_i++) {    var item = supportQuickDates[$art_inqyjngvr$art_i]%>';
    for (var $art_inqyjngvr$art_i = 0, $art_cvxkvykqw$art_c = supportQuickDates.length; $art_inqyjngvr$art_i < $art_cvxkvykqw$art_c; $art_inqyjngvr$art_i++) {
        var item = supportQuickDates[$art_inqyjngvr$art_i];
        $p += '<tr><td>';
        $line = 71;
        $art = '=item.key';
        ;
