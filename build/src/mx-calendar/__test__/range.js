/*
    ...
    loader: cmd_es
 */
define("mx-calendar/__test__/range",["magix","$","mx-medusa/util","__test__/subs","mx-title/second","./6","./12","./7","./8","./9","./11","./15","./13","./10","./18","__test__/api","__test__/event","./implement"],(require,exports,module)=>{
/*Magix,$,I18n*/
...
module.exports = Magix.View.extend({
    ...
    ;
    $p += ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'对比+时间段\',                    key: viewId + \'_demo6\'                }, {                    name: \'对比+单天\',                    key: viewId + \'_demo7\'                }, {                    name: \'选择时分秒\',                    key: viewId + \'_demo8\'                }, {                    name: \'自定义trigger\',                    key: viewId + \'_demo12\'                }, {                    name: \'动态快捷日期\',                    key: viewId + \'_demo9\'                }, {                    name: \'禁选开始或结束\',                    key: viewId + \'_demo11\'                }, {                    name: \'部分不可选\',                    key: viewId + \'_demo15\'                }, {                    name: \'历史选中修正\',                    key: viewId + \'_demo13\'                }, {                    name: \'范围修正\',                    key: viewId + \'_demo10\'                }, {                    name: \'自定义formatter\',                    key: viewId + \'_demo18\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }, {            name: \'Event\',            key: viewId + \'_event\'        }, {            name: \'快捷日期备选项\',            key: viewId + \'_quick\'        }, {            name: \'关于实现方案\',            key: viewId + \'_implement\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '对比+时间段', key: viewId + '_demo6' }, { name: '对比+单天', key: viewId + '_demo7' }, { name: '选择时分秒', key: viewId + '_demo8' }, { name: '自定义trigger', key: viewId + '_demo12' }, { name: '动态快捷日期', key: viewId + '_demo9' }, { name: '禁选开始或结束', key: viewId + '_demo11' }, { name: '部分不可选', key: viewId + '_demo15' }, { name: '历史选中修正', key: viewId + '_demo13' }, { name: '范围修正', key: viewId + '_demo10' }, { name: '自定义formatter', key: viewId + '_demo18' }] }, { name: 'API', key: viewId + '_api' }, { name: 'Event', key: viewId + '_event' }, { name: '快捷日期备选项', key: viewId + '_quick' }, { name: '关于实现方案', key: viewId + '_implement' }])) + '"></div><div id="';
    $line = 50;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_quick" mx-view="mx-title/second?content=%E5%BF%AB%E6%8D%B7%E6%97%A5%E6%9C%9F%E5%A4%87%E9%80%89%E9%A1%B9"></div><div mxa="_zs_gallery^:e" class="pr20 mb40"><table mxa="_zs_gallery^:f" class="table _zs_gallery___test___layout_-desc-table"><thead mxs="_zs_gallery^:b"><tr><th width="100">配置key值</th><th width="100">显示文案</th><th width="200">描述</th></tr></thead><tbody>';
    $line = 85;
    $art = 'each supportQuickDates as item';
    ;
    $expr = '<%for (var $art_ibgzkcrmve$art_i = 0, $art_cuqtvkxrej$art_c = supportQuickDates.length; $art_ibgzkcrmve$art_i < $art_cuqtvkxrej$art_c; $art_ibgzkcrmve$art_i++) {    var item = supportQuickDates[$art_ibgzkcrmve$art_i]%>';
    for (var $art_ibgzkcrmve$art_i = 0, $art_cuqtvkxrej$art_c = supportQuickDates.length; $art_ibgzkcrmve$art_i < $art_cuqtvkxrej$art_c; $art_ibgzkcrmve$art_i++) {
        var item = supportQuickDates[$art_ibgzkcrmve$art_i];
        $p += '<tr><td>';
        $line = 87;
        $art = '=item.key';
        ;
