...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijjiuugwg$art_i = 0, $art_ccohrcsfxys$art_c = supportQuickDates.length; $art_ijjiuugwg$art_i < $art_ccohrcsfxys$art_c; $art_ijjiuugwg$art_i++) {    var item = supportQuickDates[$art_ijjiuugwg$art_i]%>';
    for (var $art_ijjiuugwg$art_i = 0, $art_ccohrcsfxys$art_c = supportQuickDates.length; $art_ijjiuugwg$art_i < $art_ccohrcsfxys$art_c; $art_ijjiuugwg$art_i++) {
        var item = supportQuickDates[$art_ijjiuugwg$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
