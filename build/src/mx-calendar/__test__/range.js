...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibrmsivk$art_i = 0, $art_cwkmkyx$art_c = supportQuickDates.length; $art_ibrmsivk$art_i < $art_cwkmkyx$art_c; $art_ibrmsivk$art_i++) {    var item = supportQuickDates[$art_ibrmsivk$art_i]%>';
    for (var $art_ibrmsivk$art_i = 0, $art_cwkmkyx$art_c = supportQuickDates.length; $art_ibrmsivk$art_i < $art_cwkmkyx$art_c; $art_ibrmsivk$art_i++) {
        var item = supportQuickDates[$art_ibrmsivk$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
