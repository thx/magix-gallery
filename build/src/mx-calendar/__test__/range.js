...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iksdsky$art_i = 0, $art_ccmrvhaxw$art_c = supportQuickDates.length; $art_iksdsky$art_i < $art_ccmrvhaxw$art_c; $art_iksdsky$art_i++) {    var item = supportQuickDates[$art_iksdsky$art_i]%>';
    for (var $art_iksdsky$art_i = 0, $art_ccmrvhaxw$art_c = supportQuickDates.length; $art_iksdsky$art_i < $art_ccmrvhaxw$art_c; $art_iksdsky$art_i++) {
        var item = supportQuickDates[$art_iksdsky$art_i];
        $p += '<tr><td>';
        $line = 77;
        $art = '=item.key';
        ;
