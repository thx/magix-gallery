...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irbycqif$art_i = 0, $art_cihitpolg$art_c = supportQuickDates.length; $art_irbycqif$art_i < $art_cihitpolg$art_c; $art_irbycqif$art_i++) {    var item = supportQuickDates[$art_irbycqif$art_i]%>';
    for (var $art_irbycqif$art_i = 0, $art_cihitpolg$art_c = supportQuickDates.length; $art_irbycqif$art_i < $art_cihitpolg$art_c; $art_irbycqif$art_i++) {
        var item = supportQuickDates[$art_irbycqif$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
