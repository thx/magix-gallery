...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iosvjp$art_i = 0, $art_cmlcphbr$art_c = supportQuickDates.length; $art_iosvjp$art_i < $art_cmlcphbr$art_c; $art_iosvjp$art_i++) {    var item = supportQuickDates[$art_iosvjp$art_i]%>';
    for (var $art_iosvjp$art_i = 0, $art_cmlcphbr$art_c = supportQuickDates.length; $art_iosvjp$art_i < $art_cmlcphbr$art_c; $art_iosvjp$art_i++) {
        var item = supportQuickDates[$art_iosvjp$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
