...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iodruasmjm$art_i = 0, $art_cyfstidy$art_c = supportQuickDates.length; $art_iodruasmjm$art_i < $art_cyfstidy$art_c; $art_iodruasmjm$art_i++) {    var item = supportQuickDates[$art_iodruasmjm$art_i]%>';
    for (var $art_iodruasmjm$art_i = 0, $art_cyfstidy$art_c = supportQuickDates.length; $art_iodruasmjm$art_i < $art_cyfstidy$art_c; $art_iodruasmjm$art_i++) {
        var item = supportQuickDates[$art_iodruasmjm$art_i];
        $p += '<tr><td>';
        $line = 87;
        $art = '=item.key';
        ;
