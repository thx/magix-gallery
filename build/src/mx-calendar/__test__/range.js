...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idseryvc$art_i = 0, $art_caatmikrteuk$art_c = supportQuickDates.length; $art_idseryvc$art_i < $art_caatmikrteuk$art_c; $art_idseryvc$art_i++) {    var item = supportQuickDates[$art_idseryvc$art_i]%>';
    for (var $art_idseryvc$art_i = 0, $art_caatmikrteuk$art_c = supportQuickDates.length; $art_idseryvc$art_i < $art_caatmikrteuk$art_c; $art_idseryvc$art_i++) {
        var item = supportQuickDates[$art_idseryvc$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
