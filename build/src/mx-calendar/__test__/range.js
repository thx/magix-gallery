...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iekqccnbi$art_i = 0, $art_cakjbcxgp$art_c = supportQuickDates.length; $art_iekqccnbi$art_i < $art_cakjbcxgp$art_c; $art_iekqccnbi$art_i++) {    var item = supportQuickDates[$art_iekqccnbi$art_i]%>';
    for (var $art_iekqccnbi$art_i = 0, $art_cakjbcxgp$art_c = supportQuickDates.length; $art_iekqccnbi$art_i < $art_cakjbcxgp$art_c; $art_iekqccnbi$art_i++) {
        var item = supportQuickDates[$art_iekqccnbi$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
