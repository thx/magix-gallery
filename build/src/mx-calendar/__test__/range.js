...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikozfvjfgzf$art_i = 0, $art_crgfsdtgpr$art_c = supportQuickDates.length; $art_ikozfvjfgzf$art_i < $art_crgfsdtgpr$art_c; $art_ikozfvjfgzf$art_i++) {    var item = supportQuickDates[$art_ikozfvjfgzf$art_i]%>';
    for (var $art_ikozfvjfgzf$art_i = 0, $art_crgfsdtgpr$art_c = supportQuickDates.length; $art_ikozfvjfgzf$art_i < $art_crgfsdtgpr$art_c; $art_ikozfvjfgzf$art_i++) {
        var item = supportQuickDates[$art_ikozfvjfgzf$art_i];
        $p += '<tr><td>';
        $line = 91;
        $art = '=item.key';
        ;
