...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryT:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryT:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryT:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>限制周二到周四不可选</div></div></div><div class="w200" mx-view="mx-calendar/datepicker?min=2018-08-17&max=2018-08-28&selected=2018-08-20&disabledWeeks=';
    $line = 13;
    $art = '@[2,3,4]';
    ;
    $p += '' + ($expr = '<%@[2, 3, 4]%>', $i($$ref, [2, 3, 4])) + '"></div></div><div mxa="_zs_galleryT:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryT:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 17;
    $art = '=viewId';
    ;
