/*
    ...
    loader: cmd_es
 */
define("mx-calendar/__test__/22",["magix","__test__/example","moment","$","../rangepicker","mx-copy/index","__test__/hl"],(require,exports,module)=>{
/*Magix,Base,Moment,$*/
require("../rangepicker");
...
module.exports = Base.extend({
    ...
    $art = '@[\n                \'dynamicStart15\',\n                \'dynamicStart30\',\n                \'dynamicStart60\',\n                \'dynamicStart90\',\n                \'dynamicEndThisMonth\',\n                \'dynamicEndNextMonth\'\n            ]';
    ;
    $p += ($expr = '<%@[        \'dynamicStart15\',        \'dynamicStart30\',        \'dynamicStart60\',        \'dynamicStart90\',        \'dynamicEndThisMonth\',        \'dynamicEndNextMonth\'    ]%>', $i($$ref, ['dynamicStart15', 'dynamicStart30', 'dynamicStart60', 'dynamicStart90', 'dynamicEndThisMonth', 'dynamicEndNextMonth'])) + '"></div></div><div mxa="_zs_gallery*:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallery*:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 23;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-calendar/__test__/22.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest({
