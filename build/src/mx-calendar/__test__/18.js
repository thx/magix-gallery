...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery9:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery9:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery9:_" class="mb20"><span class="color-9">以下示例：</span><span>自定义formatter</span></div><div class="w220" mx-view="mx-calendar/rangepicker?shortcuts=false&formatter=YYYY%2FMM%2Fdd&start=';
    $line = 10;
    $art = '=start';
    ;
    ...
    $art = '=end';
    ;
    $p += ($expr = '<%!$eu(end)%>', $eu(end)) + '"></div></div><div mxa="_zs_gallery9:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallery9:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
