...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery1:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery1:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery1:_" class="mb20"><div class="mb5">禁止选择开始日期或者结束日期</div><div class="mb5">1. 开始日期禁止，结束日期最小可选为开始日期；快捷操作只支持根据开始日期动态计算的；</div><div>2. 结束日期禁止，开始日期最大可选为结束日期；快捷操作都禁止；</div></div><div mxa="_zs_gallery1:b" class="mb20"><div class="w200" mx-view="mx-calendar/rangepicker?shortkeys=';
    $line = 10;
