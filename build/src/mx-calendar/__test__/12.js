...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery2:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery2:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_gallery2:b" class="mb20"><span mxs="_zs_gallery2:_" class="color-9">当前结果：</span>';
    $line = 5;
    $art = 'if inlay.vs';
    ;
    $expr = '<%if (inlay.vs) {%>';
    if (inlay.vs) {
        ;
        $p += '<span mxa="_zs_gallery2:c" class="color-brand mr5">';
        $line = 6;
        ...
        ;
        $p += '<span mxa="_zs_gallery2:e" class="mr5">';
        $line = 10;
        $art = '=inlay.dates.startStr';
        ;
