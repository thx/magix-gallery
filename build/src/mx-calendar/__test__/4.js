...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery9:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery9:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery9:_" class="mb20"><span class="color-9">以下示例：</span>可选择时分秒，"all"="hour,minute,second"</div><div mxa="_zs_gallery9:b" class="mb20"><div class="w200" mx-view="mx-calendar/datepicker?timeType=all&selected=';
    $line = 12;
    $art = '=today';
    ;
