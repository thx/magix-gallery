...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery4:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery4:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery4:_" class="mb10 clearfix"><span class="color-9">以下示例：</span>限制周二到周四不可选</div><div class="w200" mx-view="mx-calendar/rangepicker?min=2018-08-01&max=2018-08-29&start=2018-08-06&end=2018-08-10&shortcuts=false&disabledWeeks=';
    $line = 13;
    $art = '@[2,3,4]';
    ;
    $p += ($expr = '<%@[2, 3, 4]%>', $i($$ref, [2, 3, 4])) + '"></div></div><div mxa="_zs_gallery4:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallery4:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 17;
    $art = '=viewId';
    ;
