...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryR:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_galleryR:_" class="_zs_gallery___test___base_-eg-content"><div class="mb20"><span class="color-9">以下示例：</span><span>关闭快捷选项 + 可选择时分秒</span></div><div class="w300" mx-view="mx-calendar/rangepicker?shortcuts=false&min=2018-03-02&max=2018-03-05&start=2018-03-03%2012%3A23%3A23&end=2018-03-04%2008%3A01%3A01&timeType=hour"></div></div><div mxa="_zs_galleryR:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryR:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 17;
    $art = '=viewId';
    ;
