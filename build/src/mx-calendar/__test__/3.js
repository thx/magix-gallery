...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryL:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_galleryL:a" class="_zs_gallery___test___base_-eg-content"><div class="w200" mx-view="mx-calendar/datepicker?timeType=hour%2Cminute&selected=';
    $line = 6;
    $art = '=today';
    ;
    $p += '' + ($expr = '<%!$eu(today)%>', $eu(today)) + '%2018%3A08%3A20"></div></div><div mxa="_zs_galleryL:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryL:_" class="_zs_gallery___test___base_-eg-title">可选择小时和分钟，秒数不可选</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
