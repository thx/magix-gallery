...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery2:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery2:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery2:_" class="mb20"><span class="color-9">以下示例：</span>可选择小时和分钟，秒数不可选</div><div class="w200" mx-view="mx-calendar/datepicker?timeType=hour%2Cminute&selected=';
    $line = 10;
    $art = '=today';
    ;
    $p += '' + ($expr = '<%!$eu(today)%>', $eu(today)) + '%2018%3A08%3A20"></div></div><div mxa="_zs_gallery2:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallery2:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
