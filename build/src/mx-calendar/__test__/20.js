...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery5:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery5:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery5:_" class="mb20"><span class="color-9">以下示例：</span><span>禁止选择</span></div><div mx-disabled mx-view="mx-calendar/rangepicker?shortcuts=false&start=';
    $line = 10;
    $art = '=start';
    ;
