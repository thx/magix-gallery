...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery9:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallery9:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallery9:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>不对比</div><div>快捷方式包含不限和动态计算的</div></div></div><div class="w200" mx-view="mx-calendar/rangepicker?start=2018-04-03&end=%E4%B8%8D%E9%99%90&shortkeys=';
    $line = 13;
    $art = '@[\n                \'dynamicStart15\',\n                \'dynamicStart30\',\n                \'dynamicStart60\',\n                \'dynamicStart90\',\n                \'dynamicEndThisMonth\',\n                \'dynamicEndNextMonth\',\n                \'forever\'\n            ]';
    ;
    $p += ($expr = '<%@[        \'dynamicStart15\',        \'dynamicStart30\',        \'dynamicStart60\',        \'dynamicStart90\',        \'dynamicEndThisMonth\',        \'dynamicEndNextMonth\',        \'forever\'    ]%>', $i($$ref, ['dynamicStart15', 'dynamicStart30', 'dynamicStart60', 'dynamicStart90', 'dynamicEndThisMonth', 'dynamicEndNextMonth', 'forever'])) + '"></div></div><div mxa="_zs_gallery9:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallery9:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
