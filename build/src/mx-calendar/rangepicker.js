...
var Rangepicker = Magix.View.extend({
    ...
    if (result.endStr) {
        ;
        $p += '<span mxa="_zs_galleryY:_" class="_zs_gallery_mx-calendar_rangepicker_-co _zs_gallery_mx-calendar_rangepicker_-co-left">';
        $line = 6;
        $art = '=result.startStr';
        ;
        $p += '' + ($expr = '<%=result.startStr%>', $e(result.startStr)) + '</span><span mxa="_zs_galleryY:a" class="_zs_gallery_mx-calendar_rangepicker_-center">';
        $line = 7;
        $art = '=result.centetTip';
        ;
        $p += '' + ($expr = '<%=result.centetTip%>', $e(result.centetTip)) + '</span><span mxa="_zs_galleryY:b" class="_zs_gallery_mx-calendar_rangepicker_-co _zs_gallery_mx-calendar_rangepicker_-co-right">';
        $line = 8;
        $art = '=result.endStr';
        ;
