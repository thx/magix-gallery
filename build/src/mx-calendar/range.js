...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ibrbxmlzyp$art_i = 0, $art_cegvavstf$art_c = quickInfos.length; $art_ibrbxmlzyp$art_i < $art_cegvavstf$art_c; $art_ibrbxmlzyp$art_i++) {        var info = quickInfos[$art_ibrbxmlzyp$art_i]%>';
        for (var $art_ibrbxmlzyp$art_i = 0, $art_cegvavstf$art_c = quickInfos.length; $art_ibrbxmlzyp$art_i < $art_cegvavstf$art_c; $art_ibrbxmlzyp$art_i++) {
            var info = quickInfos[$art_ibrbxmlzyp$art_i];
