...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_issixghzzm$art_i = 0, $art_cwzdvfc$art_c = quickInfos.length; $art_issixghzzm$art_i < $art_cwzdvfc$art_c; $art_issixghzzm$art_i++) {        var info = quickInfos[$art_issixghzzm$art_i]%>';
        for (var $art_issixghzzm$art_i = 0, $art_cwzdvfc$art_c = quickInfos.length; $art_issixghzzm$art_i < $art_cwzdvfc$art_c; $art_issixghzzm$art_i++) {
            var info = quickInfos[$art_issixghzzm$art_i];
