...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_inoiajk$art_i = 0, $art_ckuldal$art_c = quickInfos.length; $art_inoiajk$art_i < $art_ckuldal$art_c; $art_inoiajk$art_i++) {        var info = quickInfos[$art_inoiajk$art_i]%>';
        for (var $art_inoiajk$art_i = 0, $art_ckuldal$art_c = quickInfos.length; $art_inoiajk$art_i < $art_ckuldal$art_c; $art_inoiajk$art_i++) {
            var info = quickInfos[$art_inoiajk$art_i];
