...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iscsfkw$art_i = 0, $art_cotfkswwjq$art_c = quickInfos.length; $art_iscsfkw$art_i < $art_cotfkswwjq$art_c; $art_iscsfkw$art_i++) {        var info = quickInfos[$art_iscsfkw$art_i]%>';
        for (var $art_iscsfkw$art_i = 0, $art_cotfkswwjq$art_c = quickInfos.length; $art_iscsfkw$art_i < $art_cotfkswwjq$art_c; $art_iscsfkw$art_i++) {
            var info = quickInfos[$art_iscsfkw$art_i];
