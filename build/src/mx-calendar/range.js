...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_inziwkabpr$art_i = 0, $art_csffkkfie$art_c = quickInfos.length; $art_inziwkabpr$art_i < $art_csffkkfie$art_c; $art_inziwkabpr$art_i++) {        var info = quickInfos[$art_inziwkabpr$art_i]%>';
        for (var $art_inziwkabpr$art_i = 0, $art_csffkkfie$art_c = quickInfos.length; $art_inziwkabpr$art_i < $art_csffkkfie$art_c; $art_inziwkabpr$art_i++) {
            var info = quickInfos[$art_inziwkabpr$art_i];
