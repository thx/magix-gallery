...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_icfuwivqma$art_i = 0, $art_creitwre$art_c = quickInfos.length; $art_icfuwivqma$art_i < $art_creitwre$art_c; $art_icfuwivqma$art_i++) {        var info = quickInfos[$art_icfuwivqma$art_i]%>';
        for (var $art_icfuwivqma$art_i = 0, $art_creitwre$art_c = quickInfos.length; $art_icfuwivqma$art_i < $art_creitwre$art_c; $art_icfuwivqma$art_i++) {
            var info = quickInfos[$art_icfuwivqma$art_i];
