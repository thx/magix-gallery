...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iwyusqssn$art_i = 0, $art_czwgaoqrg$art_c = quickInfos.length; $art_iwyusqssn$art_i < $art_czwgaoqrg$art_c; $art_iwyusqssn$art_i++) {        var info = quickInfos[$art_iwyusqssn$art_i]%>';
        for (var $art_iwyusqssn$art_i = 0, $art_czwgaoqrg$art_c = quickInfos.length; $art_iwyusqssn$art_i < $art_czwgaoqrg$art_c; $art_iwyusqssn$art_i++) {
            var info = quickInfos[$art_iwyusqssn$art_i];
