...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ipvby$art_i = 0, $art_clzarkybf$art_c = quickInfos.length; $art_ipvby$art_i < $art_clzarkybf$art_c; $art_ipvby$art_i++) {        var info = quickInfos[$art_ipvby$art_i]%>';
        for (var $art_ipvby$art_i = 0, $art_clzarkybf$art_c = quickInfos.length; $art_ipvby$art_i < $art_clzarkybf$art_c; $art_ipvby$art_i++) {
            var info = quickInfos[$art_ipvby$art_i];
