...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ihwkpvsst$art_i = 0, $art_clhqhwapi$art_c = quickInfos.length; $art_ihwkpvsst$art_i < $art_clhqhwapi$art_c; $art_ihwkpvsst$art_i++) {        var info = quickInfos[$art_ihwkpvsst$art_i]%>';
        for (var $art_ihwkpvsst$art_i = 0, $art_clhqhwapi$art_c = quickInfos.length; $art_ihwkpvsst$art_i < $art_clhqhwapi$art_c; $art_ihwkpvsst$art_i++) {
            var info = quickInfos[$art_ihwkpvsst$art_i];
