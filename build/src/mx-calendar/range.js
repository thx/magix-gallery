...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ihgtzo$art_i = 0, $art_cpqvraovma$art_c = quickInfos.length; $art_ihgtzo$art_i < $art_cpqvraovma$art_c; $art_ihgtzo$art_i++) {        var info = quickInfos[$art_ihgtzo$art_i]%>';
        for (var $art_ihgtzo$art_i = 0, $art_cpqvraovma$art_c = quickInfos.length; $art_ihgtzo$art_i < $art_cpqvraovma$art_c; $art_ihgtzo$art_i++) {
            var info = quickInfos[$art_ihgtzo$art_i];
