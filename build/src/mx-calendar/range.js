...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ilfqwhnkre$art_i = 0, $art_cqdvwhkddut$art_c = quickInfos.length; $art_ilfqwhnkre$art_i < $art_cqdvwhkddut$art_c; $art_ilfqwhnkre$art_i++) {        var info = quickInfos[$art_ilfqwhnkre$art_i]%>';
        for (var $art_ilfqwhnkre$art_i = 0, $art_cqdvwhkddut$art_c = quickInfos.length; $art_ilfqwhnkre$art_i < $art_cqdvwhkddut$art_c; $art_ilfqwhnkre$art_i++) {
            var info = quickInfos[$art_ilfqwhnkre$art_i];
