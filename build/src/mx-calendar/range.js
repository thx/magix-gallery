...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_isytlvxdo$art_i = 0, $art_cpoxyjbm$art_c = quickInfos.length; $art_isytlvxdo$art_i < $art_cpoxyjbm$art_c; $art_isytlvxdo$art_i++) {        var info = quickInfos[$art_isytlvxdo$art_i]%>';
        for (var $art_isytlvxdo$art_i = 0, $art_cpoxyjbm$art_c = quickInfos.length; $art_isytlvxdo$art_i < $art_cpoxyjbm$art_c; $art_isytlvxdo$art_i++) {
            var info = quickInfos[$art_isytlvxdo$art_i];
