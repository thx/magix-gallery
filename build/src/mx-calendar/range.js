...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iycgujms$art_i = 0, $art_cxual$art_c = quickInfos.length; $art_iycgujms$art_i < $art_cxual$art_c; $art_iycgujms$art_i++) {        var info = quickInfos[$art_iycgujms$art_i]%>';
        for (var $art_iycgujms$art_i = 0, $art_cxual$art_c = quickInfos.length; $art_iycgujms$art_i < $art_cxual$art_c; $art_iycgujms$art_i++) {
            var info = quickInfos[$art_iycgujms$art_i];
