...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ihzffkafrdu$art_i = 0, $art_cuihdene$art_c = quickInfos.length; $art_ihzffkafrdu$art_i < $art_cuihdene$art_c; $art_ihzffkafrdu$art_i++) {        var info = quickInfos[$art_ihzffkafrdu$art_i]%>';
        for (var $art_ihzffkafrdu$art_i = 0, $art_cuihdene$art_c = quickInfos.length; $art_ihzffkafrdu$art_i < $art_cuihdene$art_c; $art_ihzffkafrdu$art_i++) {
            var info = quickInfos[$art_ihzffkafrdu$art_i];
