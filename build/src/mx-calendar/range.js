...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iybroiqf$art_i = 0, $art_cwhtc$art_c = quickInfos.length; $art_iybroiqf$art_i < $art_cwhtc$art_c; $art_iybroiqf$art_i++) {        var info = quickInfos[$art_iybroiqf$art_i]%>';
        for (var $art_iybroiqf$art_i = 0, $art_cwhtc$art_c = quickInfos.length; $art_iybroiqf$art_i < $art_cwhtc$art_c; $art_iybroiqf$art_i++) {
            var info = quickInfos[$art_iybroiqf$art_i];
