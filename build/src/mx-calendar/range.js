...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_idhsmne$art_i = 0, $art_ccomebaqd$art_c = quickInfos.length; $art_idhsmne$art_i < $art_ccomebaqd$art_c; $art_idhsmne$art_i++) {        var info = quickInfos[$art_idhsmne$art_i]%>';
        for (var $art_idhsmne$art_i = 0, $art_ccomebaqd$art_c = quickInfos.length; $art_idhsmne$art_i < $art_ccomebaqd$art_c; $art_idhsmne$art_i++) {
            var info = quickInfos[$art_idhsmne$art_i];
