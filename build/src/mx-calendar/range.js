...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ixwbqijuj$art_i = 0, $art_cjvbi$art_c = quickInfos.length; $art_ixwbqijuj$art_i < $art_cjvbi$art_c; $art_ixwbqijuj$art_i++) {        var info = quickInfos[$art_ixwbqijuj$art_i]%>';
        for (var $art_ixwbqijuj$art_i = 0, $art_cjvbi$art_c = quickInfos.length; $art_ixwbqijuj$art_i < $art_cjvbi$art_c; $art_ixwbqijuj$art_i++) {
            var info = quickInfos[$art_ixwbqijuj$art_i];
