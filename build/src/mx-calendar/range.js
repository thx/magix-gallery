...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iqummxytzvi$art_i = 0, $art_cksttzlui$art_c = quickInfos.length; $art_iqummxytzvi$art_i < $art_cksttzlui$art_c; $art_iqummxytzvi$art_i++) {        var info = quickInfos[$art_iqummxytzvi$art_i]%>';
        for (var $art_iqummxytzvi$art_i = 0, $art_cksttzlui$art_c = quickInfos.length; $art_iqummxytzvi$art_i < $art_cksttzlui$art_c; $art_iqummxytzvi$art_i++) {
            var info = quickInfos[$art_iqummxytzvi$art_i];
