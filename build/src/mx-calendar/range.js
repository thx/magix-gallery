...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iecffayqieki$art_i = 0, $art_cykfpjpu$art_c = quickInfos.length; $art_iecffayqieki$art_i < $art_cykfpjpu$art_c; $art_iecffayqieki$art_i++) {        var info = quickInfos[$art_iecffayqieki$art_i]%>';
        for (var $art_iecffayqieki$art_i = 0, $art_cykfpjpu$art_c = quickInfos.length; $art_iecffayqieki$art_i < $art_cykfpjpu$art_c; $art_iecffayqieki$art_i++) {
            var info = quickInfos[$art_iecffayqieki$art_i];
