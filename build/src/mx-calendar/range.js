...
var RangeDate = Magix.View.extend({
    ...
    $p += '<div mxv class="_zs_gallery_mx-calendar_range_-wrapper mx-shadow ';
    $line = 1;
    $art = 'if timeType';
    ;
    $expr = '<%if (timeType) {%>';
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ixtbitmzlkv$art_i = 0, $art_cjoaphpk$art_c = quickInfos.length; $art_ixtbitmzlkv$art_i < $art_cjoaphpk$art_c; $art_ixtbitmzlkv$art_i++) {        var info = quickInfos[$art_ixtbitmzlkv$art_i]%>';
        for (var $art_ixtbitmzlkv$art_i = 0, $art_cjoaphpk$art_c = quickInfos.length; $art_ixtbitmzlkv$art_i < $art_cjoaphpk$art_c; $art_ixtbitmzlkv$art_i++) {
            var info = quickInfos[$art_ixtbitmzlkv$art_i];
