...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_imuowysznf$art_i = 0, $art_crapsm$art_c = quickInfos.length; $art_imuowysznf$art_i < $art_crapsm$art_c; $art_imuowysznf$art_i++) {        var info = quickInfos[$art_imuowysznf$art_i]%>';
        for (var $art_imuowysznf$art_i = 0, $art_crapsm$art_c = quickInfos.length; $art_imuowysznf$art_i < $art_crapsm$art_c; $art_imuowysznf$art_i++) {
            var info = quickInfos[$art_imuowysznf$art_i];
