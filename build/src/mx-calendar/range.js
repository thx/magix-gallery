...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iiyyyglm$art_i = 0, $art_choudvbym$art_c = quickInfos.length; $art_iiyyyglm$art_i < $art_choudvbym$art_c; $art_iiyyyglm$art_i++) {        var info = quickInfos[$art_iiyyyglm$art_i]%>';
        for (var $art_iiyyyglm$art_i = 0, $art_choudvbym$art_c = quickInfos.length; $art_iiyyyglm$art_i < $art_choudvbym$art_c; $art_iiyyyglm$art_i++) {
            var info = quickInfos[$art_iiyyyglm$art_i];
