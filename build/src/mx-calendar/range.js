...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iykilbopin$art_i = 0, $art_cuqdjgw$art_c = quickInfos.length; $art_iykilbopin$art_i < $art_cuqdjgw$art_c; $art_iykilbopin$art_i++) {        var info = quickInfos[$art_iykilbopin$art_i]%>';
        for (var $art_iykilbopin$art_i = 0, $art_cuqdjgw$art_c = quickInfos.length; $art_iykilbopin$art_i < $art_cuqdjgw$art_c; $art_iykilbopin$art_i++) {
            var info = quickInfos[$art_iykilbopin$art_i];
