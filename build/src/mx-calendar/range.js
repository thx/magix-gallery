...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ipeuzzugi$art_i = 0, $art_cyxncmmhxmh$art_c = quickInfos.length; $art_ipeuzzugi$art_i < $art_cyxncmmhxmh$art_c; $art_ipeuzzugi$art_i++) {        var info = quickInfos[$art_ipeuzzugi$art_i]%>';
        for (var $art_ipeuzzugi$art_i = 0, $art_cyxncmmhxmh$art_c = quickInfos.length; $art_ipeuzzugi$art_i < $art_cyxncmmhxmh$art_c; $art_ipeuzzugi$art_i++) {
            var info = quickInfos[$art_ipeuzzugi$art_i];
