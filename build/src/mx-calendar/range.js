...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_inuiaxs$art_i = 0, $art_caujsija$art_c = quickInfos.length; $art_inuiaxs$art_i < $art_caujsija$art_c; $art_inuiaxs$art_i++) {        var info = quickInfos[$art_inuiaxs$art_i]%>';
        for (var $art_inuiaxs$art_i = 0, $art_caujsija$art_c = quickInfos.length; $art_inuiaxs$art_i < $art_caujsija$art_c; $art_inuiaxs$art_i++) {
            var info = quickInfos[$art_inuiaxs$art_i];
