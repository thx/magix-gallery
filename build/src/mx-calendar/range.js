...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ifzcmmbf$art_i = 0, $art_cbaaiccredb$art_c = quickInfos.length; $art_ifzcmmbf$art_i < $art_cbaaiccredb$art_c; $art_ifzcmmbf$art_i++) {        var info = quickInfos[$art_ifzcmmbf$art_i]%>';
        for (var $art_ifzcmmbf$art_i = 0, $art_cbaaiccredb$art_c = quickInfos.length; $art_ifzcmmbf$art_i < $art_cbaaiccredb$art_c; $art_ifzcmmbf$art_i++) {
            var info = quickInfos[$art_ifzcmmbf$art_i];
