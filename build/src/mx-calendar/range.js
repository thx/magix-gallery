...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_itujzlzws$art_i = 0, $art_cvxeepkafb$art_c = quickInfos.length; $art_itujzlzws$art_i < $art_cvxeepkafb$art_c; $art_itujzlzws$art_i++) {        var info = quickInfos[$art_itujzlzws$art_i]%>';
        for (var $art_itujzlzws$art_i = 0, $art_cvxeepkafb$art_c = quickInfos.length; $art_itujzlzws$art_i < $art_cvxeepkafb$art_c; $art_itujzlzws$art_i++) {
            var info = quickInfos[$art_itujzlzws$art_i];
