...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ilcxvtncr$art_i = 0, $art_czpqegxs$art_c = quickInfos.length; $art_ilcxvtncr$art_i < $art_czpqegxs$art_c; $art_ilcxvtncr$art_i++) {        var info = quickInfos[$art_ilcxvtncr$art_i]%>';
        for (var $art_ilcxvtncr$art_i = 0, $art_czpqegxs$art_c = quickInfos.length; $art_ilcxvtncr$art_i < $art_czpqegxs$art_c; $art_ilcxvtncr$art_i++) {
            var info = quickInfos[$art_ilcxvtncr$art_i];
