...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iuyvaymda$art_i = 0, $art_ckyysnpx$art_c = quickInfos.length; $art_iuyvaymda$art_i < $art_ckyysnpx$art_c; $art_iuyvaymda$art_i++) {        var info = quickInfos[$art_iuyvaymda$art_i]%>';
        for (var $art_iuyvaymda$art_i = 0, $art_ckyysnpx$art_c = quickInfos.length; $art_iuyvaymda$art_i < $art_ckyysnpx$art_c; $art_iuyvaymda$art_i++) {
            var info = quickInfos[$art_iuyvaymda$art_i];
