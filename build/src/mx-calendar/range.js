...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ihfmkcqgl$art_i = 0, $art_cdoktmirh$art_c = quickInfos.length; $art_ihfmkcqgl$art_i < $art_cdoktmirh$art_c; $art_ihfmkcqgl$art_i++) {        var info = quickInfos[$art_ihfmkcqgl$art_i]%>';
        for (var $art_ihfmkcqgl$art_i = 0, $art_cdoktmirh$art_c = quickInfos.length; $art_ihfmkcqgl$art_i < $art_cdoktmirh$art_c; $art_ihfmkcqgl$art_i++) {
            var info = quickInfos[$art_ihfmkcqgl$art_i];
