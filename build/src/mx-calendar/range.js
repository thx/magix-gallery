...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ivgsvt$art_i = 0, $art_ctuxekniif$art_c = quickInfos.length; $art_ivgsvt$art_i < $art_ctuxekniif$art_c; $art_ivgsvt$art_i++) {        var info = quickInfos[$art_ivgsvt$art_i]%>';
        for (var $art_ivgsvt$art_i = 0, $art_ctuxekniif$art_c = quickInfos.length; $art_ivgsvt$art_i < $art_ctuxekniif$art_c; $art_ivgsvt$art_i++) {
            var info = quickInfos[$art_ivgsvt$art_i];
