...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iapfnjdvh$art_i = 0, $art_ccmwfsqb$art_c = quickInfos.length; $art_iapfnjdvh$art_i < $art_ccmwfsqb$art_c; $art_iapfnjdvh$art_i++) {        var info = quickInfos[$art_iapfnjdvh$art_i]%>';
        for (var $art_iapfnjdvh$art_i = 0, $art_ccmwfsqb$art_c = quickInfos.length; $art_iapfnjdvh$art_i < $art_ccmwfsqb$art_c; $art_iapfnjdvh$art_i++) {
            var info = quickInfos[$art_iapfnjdvh$art_i];
