...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ickinmg$art_i = 0, $art_cyhpbhitq$art_c = quickInfos.length; $art_ickinmg$art_i < $art_cyhpbhitq$art_c; $art_ickinmg$art_i++) {        var info = quickInfos[$art_ickinmg$art_i]%>';
        for (var $art_ickinmg$art_i = 0, $art_cyhpbhitq$art_c = quickInfos.length; $art_ickinmg$art_i < $art_cyhpbhitq$art_c; $art_ickinmg$art_i++) {
            var info = quickInfos[$art_ickinmg$art_i];
