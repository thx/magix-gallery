...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_itxygqswokh$art_i = 0, $art_chmldiittvk$art_c = quickInfos.length; $art_itxygqswokh$art_i < $art_chmldiittvk$art_c; $art_itxygqswokh$art_i++) {        var info = quickInfos[$art_itxygqswokh$art_i]%>';
        for (var $art_itxygqswokh$art_i = 0, $art_chmldiittvk$art_c = quickInfos.length; $art_itxygqswokh$art_i < $art_chmldiittvk$art_c; $art_itxygqswokh$art_i++) {
            var info = quickInfos[$art_itxygqswokh$art_i];
