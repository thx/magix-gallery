...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_icczlnik$art_i = 0, $art_cljmfahmq$art_c = quickInfos.length; $art_icczlnik$art_i < $art_cljmfahmq$art_c; $art_icczlnik$art_i++) {        var info = quickInfos[$art_icczlnik$art_i]%>';
        for (var $art_icczlnik$art_i = 0, $art_cljmfahmq$art_c = quickInfos.length; $art_icczlnik$art_i < $art_cljmfahmq$art_c; $art_icczlnik$art_i++) {
            var info = quickInfos[$art_icczlnik$art_i];
