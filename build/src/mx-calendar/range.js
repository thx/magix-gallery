...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iwpeavnc$art_i = 0, $art_cxwgsnem$art_c = quickInfos.length; $art_iwpeavnc$art_i < $art_cxwgsnem$art_c; $art_iwpeavnc$art_i++) {        var info = quickInfos[$art_iwpeavnc$art_i]%>';
        for (var $art_iwpeavnc$art_i = 0, $art_cxwgsnem$art_c = quickInfos.length; $art_iwpeavnc$art_i < $art_cxwgsnem$art_c; $art_iwpeavnc$art_i++) {
            var info = quickInfos[$art_iwpeavnc$art_i];
