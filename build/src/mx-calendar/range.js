...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iincwxk$art_i = 0, $art_cftzant$art_c = quickInfos.length; $art_iincwxk$art_i < $art_cftzant$art_c; $art_iincwxk$art_i++) {        var info = quickInfos[$art_iincwxk$art_i]%>';
        for (var $art_iincwxk$art_i = 0, $art_cftzant$art_c = quickInfos.length; $art_iincwxk$art_i < $art_cftzant$art_c; $art_iincwxk$art_i++) {
            var info = quickInfos[$art_iincwxk$art_i];
