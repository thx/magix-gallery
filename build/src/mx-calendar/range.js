...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ismtjgixck$art_i = 0, $art_cgnipztr$art_c = quickInfos.length; $art_ismtjgixck$art_i < $art_cgnipztr$art_c; $art_ismtjgixck$art_i++) {        var info = quickInfos[$art_ismtjgixck$art_i]%>';
        for (var $art_ismtjgixck$art_i = 0, $art_cgnipztr$art_c = quickInfos.length; $art_ismtjgixck$art_i < $art_cgnipztr$art_c; $art_ismtjgixck$art_i++) {
            var info = quickInfos[$art_ismtjgixck$art_i];
