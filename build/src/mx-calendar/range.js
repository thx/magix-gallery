...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_isomn$art_i = 0, $art_cgnooxgqsd$art_c = quickInfos.length; $art_isomn$art_i < $art_cgnooxgqsd$art_c; $art_isomn$art_i++) {        var info = quickInfos[$art_isomn$art_i]%>';
        for (var $art_isomn$art_i = 0, $art_cgnooxgqsd$art_c = quickInfos.length; $art_isomn$art_i < $art_cgnooxgqsd$art_c; $art_isomn$art_i++) {
            var info = quickInfos[$art_isomn$art_i];
