...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_irntbxgszn$art_i = 0, $art_cvkcq$art_c = quickInfos.length; $art_irntbxgszn$art_i < $art_cvkcq$art_c; $art_irntbxgszn$art_i++) {        var info = quickInfos[$art_irntbxgszn$art_i]%>';
        for (var $art_irntbxgszn$art_i = 0, $art_cvkcq$art_c = quickInfos.length; $art_irntbxgszn$art_i < $art_cvkcq$art_c; $art_irntbxgszn$art_i++) {
            var info = quickInfos[$art_irntbxgszn$art_i];
