...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_igmlmmbduk$art_i = 0, $art_czyqfkrae$art_c = quickInfos.length; $art_igmlmmbduk$art_i < $art_czyqfkrae$art_c; $art_igmlmmbduk$art_i++) {        var info = quickInfos[$art_igmlmmbduk$art_i]%>';
        for (var $art_igmlmmbduk$art_i = 0, $art_czyqfkrae$art_c = quickInfos.length; $art_igmlmmbduk$art_i < $art_czyqfkrae$art_c; $art_igmlmmbduk$art_i++) {
            var info = quickInfos[$art_igmlmmbduk$art_i];
