...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_inugona$art_i = 0, $art_clkfbprlcn$art_c = quickInfos.length; $art_inugona$art_i < $art_clkfbprlcn$art_c; $art_inugona$art_i++) {        var info = quickInfos[$art_inugona$art_i]%>';
        for (var $art_inugona$art_i = 0, $art_clkfbprlcn$art_c = quickInfos.length; $art_inugona$art_i < $art_clkfbprlcn$art_c; $art_inugona$art_i++) {
            var info = quickInfos[$art_inugona$art_i];
