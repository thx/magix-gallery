...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ithxumjttss$art_i = 0, $art_cybjzr$art_c = quickInfos.length; $art_ithxumjttss$art_i < $art_cybjzr$art_c; $art_ithxumjttss$art_i++) {        var info = quickInfos[$art_ithxumjttss$art_i]%>';
        for (var $art_ithxumjttss$art_i = 0, $art_cybjzr$art_c = quickInfos.length; $art_ithxumjttss$art_i < $art_cybjzr$art_c; $art_ithxumjttss$art_i++) {
            var info = quickInfos[$art_ithxumjttss$art_i];
