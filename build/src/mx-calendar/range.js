...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iwhqrbkn$art_i = 0, $art_ccunfwizlo$art_c = quickInfos.length; $art_iwhqrbkn$art_i < $art_ccunfwizlo$art_c; $art_iwhqrbkn$art_i++) {        var info = quickInfos[$art_iwhqrbkn$art_i]%>';
        for (var $art_iwhqrbkn$art_i = 0, $art_ccunfwizlo$art_c = quickInfos.length; $art_iwhqrbkn$art_i < $art_ccunfwizlo$art_c; $art_iwhqrbkn$art_i++) {
            var info = quickInfos[$art_iwhqrbkn$art_i];
