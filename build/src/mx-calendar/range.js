...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ifuozhbai$art_i = 0, $art_civvxxnbrd$art_c = quickInfos.length; $art_ifuozhbai$art_i < $art_civvxxnbrd$art_c; $art_ifuozhbai$art_i++) {        var info = quickInfos[$art_ifuozhbai$art_i]%>';
        for (var $art_ifuozhbai$art_i = 0, $art_civvxxnbrd$art_c = quickInfos.length; $art_ifuozhbai$art_i < $art_civvxxnbrd$art_c; $art_ifuozhbai$art_i++) {
            var info = quickInfos[$art_ifuozhbai$art_i];
