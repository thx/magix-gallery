...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ifsfljilj$art_i = 0, $art_cetmguvxp$art_c = quickInfos.length; $art_ifsfljilj$art_i < $art_cetmguvxp$art_c; $art_ifsfljilj$art_i++) {        var info = quickInfos[$art_ifsfljilj$art_i]%>';
        for (var $art_ifsfljilj$art_i = 0, $art_cetmguvxp$art_c = quickInfos.length; $art_ifsfljilj$art_i < $art_cetmguvxp$art_c; $art_ifsfljilj$art_i++) {
            var info = quickInfos[$art_ifsfljilj$art_i];
