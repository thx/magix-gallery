...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ivhpwuhp$art_i = 0, $art_ccqfevcvf$art_c = quickInfos.length; $art_ivhpwuhp$art_i < $art_ccqfevcvf$art_c; $art_ivhpwuhp$art_i++) {        var info = quickInfos[$art_ivhpwuhp$art_i]%>';
        for (var $art_ivhpwuhp$art_i = 0, $art_ccqfevcvf$art_c = quickInfos.length; $art_ivhpwuhp$art_i < $art_ccqfevcvf$art_c; $art_ivhpwuhp$art_i++) {
            var info = quickInfos[$art_ivhpwuhp$art_i];
