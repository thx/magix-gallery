...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_izodnplh$art_i = 0, $art_ccwtvintmq$art_c = quickInfos.length; $art_izodnplh$art_i < $art_ccwtvintmq$art_c; $art_izodnplh$art_i++) {        var info = quickInfos[$art_izodnplh$art_i]%>';
        for (var $art_izodnplh$art_i = 0, $art_ccwtvintmq$art_c = quickInfos.length; $art_izodnplh$art_i < $art_ccwtvintmq$art_c; $art_izodnplh$art_i++) {
            var info = quickInfos[$art_izodnplh$art_i];
