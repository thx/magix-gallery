...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ixrnoqpw$art_i = 0, $art_cvvvmtnai$art_c = quickInfos.length; $art_ixrnoqpw$art_i < $art_cvvvmtnai$art_c; $art_ixrnoqpw$art_i++) {        var info = quickInfos[$art_ixrnoqpw$art_i]%>';
        for (var $art_ixrnoqpw$art_i = 0, $art_cvvvmtnai$art_c = quickInfos.length; $art_ixrnoqpw$art_i < $art_cvvvmtnai$art_c; $art_ixrnoqpw$art_i++) {
            var info = quickInfos[$art_ixrnoqpw$art_i];
