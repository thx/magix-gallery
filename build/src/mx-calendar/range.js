...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ilczlvmeak$art_i = 0, $art_cjuwmhkxg$art_c = quickInfos.length; $art_ilczlvmeak$art_i < $art_cjuwmhkxg$art_c; $art_ilczlvmeak$art_i++) {        var info = quickInfos[$art_ilczlvmeak$art_i]%>';
        for (var $art_ilczlvmeak$art_i = 0, $art_cjuwmhkxg$art_c = quickInfos.length; $art_ilczlvmeak$art_i < $art_cjuwmhkxg$art_c; $art_ilczlvmeak$art_i++) {
            var info = quickInfos[$art_ilczlvmeak$art_i];
