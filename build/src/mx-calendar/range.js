...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ijdksxdq$art_i = 0, $art_cjpunbrglb$art_c = quickInfos.length; $art_ijdksxdq$art_i < $art_cjpunbrglb$art_c; $art_ijdksxdq$art_i++) {        var info = quickInfos[$art_ijdksxdq$art_i]%>';
        for (var $art_ijdksxdq$art_i = 0, $art_cjpunbrglb$art_c = quickInfos.length; $art_ijdksxdq$art_i < $art_cjpunbrglb$art_c; $art_ijdksxdq$art_i++) {
            var info = quickInfos[$art_ijdksxdq$art_i];
