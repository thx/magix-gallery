...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iudaonkxe$art_i = 0, $art_curctayix$art_c = quickInfos.length; $art_iudaonkxe$art_i < $art_curctayix$art_c; $art_iudaonkxe$art_i++) {        var info = quickInfos[$art_iudaonkxe$art_i]%>';
        for (var $art_iudaonkxe$art_i = 0, $art_curctayix$art_c = quickInfos.length; $art_iudaonkxe$art_i < $art_curctayix$art_c; $art_iudaonkxe$art_i++) {
            var info = quickInfos[$art_iudaonkxe$art_i];
