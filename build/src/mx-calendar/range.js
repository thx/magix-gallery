...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ipontt$art_i = 0, $art_ckpiazfolk$art_c = quickInfos.length; $art_ipontt$art_i < $art_ckpiazfolk$art_c; $art_ipontt$art_i++) {        var info = quickInfos[$art_ipontt$art_i]%>';
        for (var $art_ipontt$art_i = 0, $art_ckpiazfolk$art_c = quickInfos.length; $art_ipontt$art_i < $art_ckpiazfolk$art_c; $art_ipontt$art_i++) {
            var info = quickInfos[$art_ipontt$art_i];
