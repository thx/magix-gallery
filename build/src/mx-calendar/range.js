...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_infnyumuukvr$art_i = 0, $art_ckvtxpibqh$art_c = quickInfos.length; $art_infnyumuukvr$art_i < $art_ckvtxpibqh$art_c; $art_infnyumuukvr$art_i++) {        var info = quickInfos[$art_infnyumuukvr$art_i]%>';
        for (var $art_infnyumuukvr$art_i = 0, $art_ckvtxpibqh$art_c = quickInfos.length; $art_infnyumuukvr$art_i < $art_ckvtxpibqh$art_c; $art_infnyumuukvr$art_i++) {
            var info = quickInfos[$art_infnyumuukvr$art_i];
