...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iisqcfkqxau$art_i = 0, $art_cdjocgwek$art_c = quickInfos.length; $art_iisqcfkqxau$art_i < $art_cdjocgwek$art_c; $art_iisqcfkqxau$art_i++) {        var info = quickInfos[$art_iisqcfkqxau$art_i]%>';
        for (var $art_iisqcfkqxau$art_i = 0, $art_cdjocgwek$art_c = quickInfos.length; $art_iisqcfkqxau$art_i < $art_cdjocgwek$art_c; $art_iisqcfkqxau$art_i++) {
            var info = quickInfos[$art_iisqcfkqxau$art_i];
    ...
    ;
    $p += '</div><div mxa="_zs_gallery[:j" class="mx-output-footer"><button mxa="_zs_gallery[:k" mx-click="' + $viewId + '@{date.picked}()" type="button" class="btn btn-small btn-brand mr10">';
    $line = 60;
    $art = '=submitText';
    ;
