...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iycmasse$art_i = 0, $art_czkulgoi$art_c = quickInfos.length; $art_iycmasse$art_i < $art_czkulgoi$art_c; $art_iycmasse$art_i++) {        var info = quickInfos[$art_iycmasse$art_i]%>';
        for (var $art_iycmasse$art_i = 0, $art_czkulgoi$art_c = quickInfos.length; $art_iycmasse$art_i < $art_czkulgoi$art_c; $art_iycmasse$art_i++) {
            var info = quickInfos[$art_iycmasse$art_i];
