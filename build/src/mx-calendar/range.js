...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_inxsdwnvmlj$art_i = 0, $art_conphetxe$art_c = quickInfos.length; $art_inxsdwnvmlj$art_i < $art_conphetxe$art_c; $art_inxsdwnvmlj$art_i++) {        var info = quickInfos[$art_inxsdwnvmlj$art_i]%>';
        for (var $art_inxsdwnvmlj$art_i = 0, $art_conphetxe$art_c = quickInfos.length; $art_inxsdwnvmlj$art_i < $art_conphetxe$art_c; $art_inxsdwnvmlj$art_i++) {
            var info = quickInfos[$art_inxsdwnvmlj$art_i];
