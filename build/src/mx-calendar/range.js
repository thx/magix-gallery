...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iilqbeorpjn$art_i = 0, $art_ccbatsnn$art_c = quickInfos.length; $art_iilqbeorpjn$art_i < $art_ccbatsnn$art_c; $art_iilqbeorpjn$art_i++) {        var info = quickInfos[$art_iilqbeorpjn$art_i]%>';
        for (var $art_iilqbeorpjn$art_i = 0, $art_ccbatsnn$art_c = quickInfos.length; $art_iilqbeorpjn$art_i < $art_ccbatsnn$art_c; $art_iilqbeorpjn$art_i++) {
            var info = quickInfos[$art_iilqbeorpjn$art_i];
