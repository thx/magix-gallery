...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iuqgieyk$art_i = 0, $art_cgcqw$art_c = quickInfos.length; $art_iuqgieyk$art_i < $art_cgcqw$art_c; $art_iuqgieyk$art_i++) {        var info = quickInfos[$art_iuqgieyk$art_i]%>';
        for (var $art_iuqgieyk$art_i = 0, $art_cgcqw$art_c = quickInfos.length; $art_iuqgieyk$art_i < $art_cgcqw$art_c; $art_iuqgieyk$art_i++) {
            var info = quickInfos[$art_iuqgieyk$art_i];
