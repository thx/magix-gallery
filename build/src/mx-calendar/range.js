...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ifotuz$art_i = 0, $art_cywmjxhms$art_c = quickInfos.length; $art_ifotuz$art_i < $art_cywmjxhms$art_c; $art_ifotuz$art_i++) {        var info = quickInfos[$art_ifotuz$art_i]%>';
        for (var $art_ifotuz$art_i = 0, $art_cywmjxhms$art_c = quickInfos.length; $art_ifotuz$art_i < $art_cywmjxhms$art_c; $art_ifotuz$art_i++) {
            var info = quickInfos[$art_ifotuz$art_i];
