...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iwjcmof$art_i = 0, $art_cqdjmylmd$art_c = quickInfos.length; $art_iwjcmof$art_i < $art_cqdjmylmd$art_c; $art_iwjcmof$art_i++) {        var info = quickInfos[$art_iwjcmof$art_i]%>';
        for (var $art_iwjcmof$art_i = 0, $art_cqdjmylmd$art_c = quickInfos.length; $art_iwjcmof$art_i < $art_cqdjmylmd$art_c; $art_iwjcmof$art_i++) {
            var info = quickInfos[$art_iwjcmof$art_i];
