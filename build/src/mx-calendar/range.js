...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_icbdgdbq$art_i = 0, $art_cqvsgqf$art_c = quickInfos.length; $art_icbdgdbq$art_i < $art_cqvsgqf$art_c; $art_icbdgdbq$art_i++) {        var info = quickInfos[$art_icbdgdbq$art_i]%>';
        for (var $art_icbdgdbq$art_i = 0, $art_cqvsgqf$art_c = quickInfos.length; $art_icbdgdbq$art_i < $art_cqvsgqf$art_c; $art_icbdgdbq$art_i++) {
            var info = quickInfos[$art_icbdgdbq$art_i];
