...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_irbmggxkyuj$art_i = 0, $art_cochuhluxm$art_c = quickInfos.length; $art_irbmggxkyuj$art_i < $art_cochuhluxm$art_c; $art_irbmggxkyuj$art_i++) {        var info = quickInfos[$art_irbmggxkyuj$art_i]%>';
        for (var $art_irbmggxkyuj$art_i = 0, $art_cochuhluxm$art_c = quickInfos.length; $art_irbmggxkyuj$art_i < $art_cochuhluxm$art_c; $art_irbmggxkyuj$art_i++) {
            var info = quickInfos[$art_irbmggxkyuj$art_i];
