...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_ivhjbqt$art_i = 0, $art_cfozybe$art_c = quickInfos.length; $art_ivhjbqt$art_i < $art_cfozybe$art_c; $art_ivhjbqt$art_i++) {        var info = quickInfos[$art_ivhjbqt$art_i]%>';
        for (var $art_ivhjbqt$art_i = 0, $art_cfozybe$art_c = quickInfos.length; $art_ivhjbqt$art_i < $art_cfozybe$art_c; $art_ivhjbqt$art_i++) {
            var info = quickInfos[$art_ivhjbqt$art_i];
