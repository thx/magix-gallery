...
var RangeDate = Magix.View.extend({
    ...
    if (quickInfos.length && !vs && !vsSingle) {
        ...
        ;
        $expr = '<%for (var $art_iehwzeemie$art_i = 0, $art_cxcswe$art_c = quickInfos.length; $art_iehwzeemie$art_i < $art_cxcswe$art_c; $art_iehwzeemie$art_i++) {        var info = quickInfos[$art_iehwzeemie$art_i]%>';
        for (var $art_iehwzeemie$art_i = 0, $art_cxcswe$art_c = quickInfos.length; $art_iehwzeemie$art_i < $art_cxcswe$art_c; $art_iehwzeemie$art_i++) {
            var info = quickInfos[$art_iehwzeemie$art_i];
