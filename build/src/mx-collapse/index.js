...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_coptnmnq$art_c = list.length; index < $art_coptnmnq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_coptnmnq$art_c = list.length; index < $art_coptnmnq$art_c; index++) {
        var item = list[index];
