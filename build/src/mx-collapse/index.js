...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_caknemud$art_c = list.length; index < $art_caknemud$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_caknemud$art_c = list.length; index < $art_caknemud$art_c; index++) {
        var item = list[index];
        ...
        ;
        $p += '><span mxa="_zs_galleryai:b" class="_zs_gallery_mx-collapse_index_-arrow">';
        $line = 5;
        $art = '!item.arrow';
        ;
        $p += ($expr = '<%!item.arrow%>', $n(item.arrow)) + '</span><span mxa="_zs_galleryai:a" class="_zs_gallery_mx-collapse_index_-text">';
        $line = 6;
        $art = '=item.title';
        ;
