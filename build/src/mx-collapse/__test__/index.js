...
module.exports = Magix.View.extend({
    ...
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'展开单个+事件\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'展开多个+禁用\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'内容自定义view\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'自定义icon\',\n            key: viewId + \'_demo4\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
    $p += ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'展开单个+事件\',                    key: viewId + \'_demo1\'                }, {                    name: \'展开多个+禁用\',                    key: viewId + \'_demo2\'                }, {                    name: \'内容自定义view\',                    key: viewId + \'_demo3\'                }, {                    name: \'自定义icon\',                    key: viewId + \'_demo4\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '展开单个+事件', key: viewId + '_demo1' }, { name: '展开多个+禁用', key: viewId + '_demo2' }, { name: '内容自定义view', key: viewId + '_demo3' }, { name: '自定义icon', key: viewId + '_demo4' }] }, { name: 'API', key: viewId + '_api' }])) + '"></div><div id="';
    $line = 22;
    $art = '=viewId';
    ;
