...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaf:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryaf:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaf:_" class="mb20"><span class="color-9">以下示例：</span><span>第二项的展示为自定义view，默认带入参数data=当前实体</span></div><div mxv="list" mx-view="mx-collapse/index?list=';
    $line = 8;
    $art = '@list';
    ;
