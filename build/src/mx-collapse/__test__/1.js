...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ctjrdbopwhos$art_c = list.length; index < $art_ctjrdbopwhos$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ctjrdbopwhos$art_c = list.length; index < $art_ctjrdbopwhos$art_c; index++) {
        var item = list[index];
        $p += '<div>第';
        $line = 14;
        $art = '=index';
