...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaf:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryaf:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaf:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div>默认展开非禁止操作的第一个 + 只展示一个 + 每次只打开一个tab</div><div>完整事件处理示例</div></div></div><div mxa="_zs_galleryaf:b" class="mb20 clearfix"><div mxs="_zs_galleryaf:a" class="fl color-9">模块展开收起状态：</div><div mxa="_zs_galleryaf:c" class="fl">';
    $line = 13;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cnurevzfdr$art_c = list.length; index < $art_cnurevzfdr$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cnurevzfdr$art_c = list.length; index < $art_cnurevzfdr$art_c; index++) {
        var item = list[index];
        $p += '<div>第';
        $line = 14;
        $art = '=index';
