...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryad:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryad:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryad:_" class="mb20"><span class="color-9">以下示例：</span><span>默认展开非禁止操作的第一个 + 只展示一个 + 每次只打开一个tab</span></div><div mxv="list" class="mb20" mx-view="mx-collapse/index?list=';
    $line = 8;
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '"></div></div><div mxa="_zs_galleryad:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryad:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
