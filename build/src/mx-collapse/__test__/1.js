...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryab:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryab:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryab:_" class="mb20"><span class="color-9">以下示例：</span><span>默认展开非禁止操作的第一个 + 只展示一个 + 每次只打开一个tab</span></div><div mxv="list" mx-view="mx-collapse/index?list=';
    $line = 8;
    $art = '@list';
    ;
