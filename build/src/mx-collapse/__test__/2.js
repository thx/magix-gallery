...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryar:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryar:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryar:_" class="mb20"><span class="color-9">以下示例：</span><span>可同时展开多个 + 默认展示两个 + 第一个和最后一个禁用</span></div><div mxv="list" mx-view="mx-collapse/index?onlyOne=false&list=';
    $line = 9;
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '"></div></div><div mxa="_zs_galleryar:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryar:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 13;
    $art = '=viewId';
    ;
