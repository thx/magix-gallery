...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydB:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerydB:_" class="_zs_gallery___test___layout_-eg-content"><span class="brand-solid-icon">品牌色实心打标</span><span class="grey-solid-icon">灰色实心打标</span><span class="brand-hollow-icon">品牌色空心打标</span><span class="grey-hollow-icon">灰色空心打标</span></div><div mxa="_zs_gallerydB:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydB:a" class="_zs_gallery___test___layout_-eg-title">打标</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
