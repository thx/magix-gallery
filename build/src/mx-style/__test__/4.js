...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb,:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb,:a" class="_zs_gallery___test___layout_-eg-content"><label mxv mxa="_zs_galleryb,:b" class="mr30"><input mxs="_zs_galleryb,:_" type="radio" value="1" name="magix" checked="true"/> 选中</label><label mxv mxa="_zs_galleryb,:c" class="mr30"><input mxs="_zs_galleryb,:a" type="radio" value="2" name="magix"/> 未选中</label><label mxv mxa="_zs_galleryb,:d" class="mr30"><input mxs="_zs_galleryb,:b" type="radio" value="3" name="magix" disabled="true"/> 未选中禁止选择</label></div><div mxa="_zs_galleryb,:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb,:c" class="_zs_gallery___test___layout_-eg-title">Radio</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
