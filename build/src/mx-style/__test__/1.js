...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycr:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerycr:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb20"><a href="javascript:;" class="btn btn-brand mr20">品牌色按钮</a><a href="javascript:;" class="btn mr20">普通按钮</a><a href="javascript:;" class="btn btn-disabled">按钮禁用</a></div><div class="mb20"><a href="javascript:;" class="btn btn-small btn-brand mr20">小号品牌色按钮</a><a href="javascript:;" class="btn btn-small mr20">小号普通按钮</a><a href="javascript:;" class="btn btn-small btn-disabled">小号按钮禁用</a></div></div><div mxa="_zs_gallerycr:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycr:a" class="_zs_gallery___test___layout_-eg-title">按钮</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
