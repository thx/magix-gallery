...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycj:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerycj:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerycj:b" class="mb20"><input mxs="_zs_gallerycj:_" placeholder="正常尺寸input"/></div><div mxv mxa="_zs_gallerycj:c" class="mb20"><input mxs="_zs_gallerycj:a" class="input-small" placeholder="小号input"/></div><div mxs="_zs_gallerycj:b" class="mb20 clearfix"><span class="color-9 fl lh32">只使用input样式：</span><span class="input w200 fl"></span></div></div><div mxa="_zs_gallerycj:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycj:c" class="_zs_gallery___test___layout_-eg-title">Input</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
