...
module.exports = Base.extend({
    ...
    if (success) {
        ;
        $p += '<span mxs="_zs_galleryax:_" class="color-green ml20">复制成功</span>';
        $line = 21;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">Magix棒棒的！</textarea></div><div mxa="_zs_galleryax:d" class="clearfix"><div mxa="_zs_galleryax:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryax:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 28;
    $art = '=viewId';
    ;
