...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybg:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybg:_" class="_zs_gallery___test___layout_-eg-content"><div class="_zs_gallery_mx-footer___test___index_-dark"><div mx-view="mx-footer/index?dark=true&products=true"></div></div></div><div mxa="_zs_gallerybg:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybg:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 9;
    $art = '=viewId';
    ;
