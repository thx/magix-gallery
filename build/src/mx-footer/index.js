...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_icntcv$art_i = 0, $art_ckzxueil$art_c = products.length; $art_icntcv$art_i < $art_ckzxueil$art_c; $art_icntcv$art_i++) {        var p = products[$art_icntcv$art_i]%>';
        for (var $art_icntcv$art_i = 0, $art_ckzxueil$art_c = products.length; $art_icntcv$art_i < $art_ckzxueil$art_c; $art_icntcv$art_i++) {
            var p = products[$art_icntcv$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_ixvwhsr$art_i = 0, $art_objtcmrfalyzd$art_obj = p.thirds, $art_cmyxmshg$art_c = $art_objtcmrfalyzd$art_obj.length; $art_ixvwhsr$art_i < $art_cmyxmshg$art_c; $art_ixvwhsr$art_i++) {            var t = $art_objtcmrfalyzd$art_obj[$art_ixvwhsr$art_i]%>';
            for (var $art_ixvwhsr$art_i = 0, $art_objtcmrfalyzd$art_obj = p.thirds, $art_cmyxmshg$art_c = $art_objtcmrfalyzd$art_obj.length; $art_ixvwhsr$art_i < $art_cmyxmshg$art_c; $art_ixvwhsr$art_i++) {
                var t = $art_objtcmrfalyzd$art_obj[$art_ixvwhsr$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
