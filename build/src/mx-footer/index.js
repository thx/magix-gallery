...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ifxyptkjefh$art_i = 0, $art_citbobopw$art_c = products.length; $art_ifxyptkjefh$art_i < $art_citbobopw$art_c; $art_ifxyptkjefh$art_i++) {        var p = products[$art_ifxyptkjefh$art_i]%>';
        for (var $art_ifxyptkjefh$art_i = 0, $art_citbobopw$art_c = products.length; $art_ifxyptkjefh$art_i < $art_citbobopw$art_c; $art_ifxyptkjefh$art_i++) {
            var p = products[$art_ifxyptkjefh$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iwxohdl$art_i = 0, $art_objbgcwmedbk$art_obj = p.thirds, $art_cnwzprcgp$art_c = $art_objbgcwmedbk$art_obj.length; $art_iwxohdl$art_i < $art_cnwzprcgp$art_c; $art_iwxohdl$art_i++) {            var t = $art_objbgcwmedbk$art_obj[$art_iwxohdl$art_i]%>';
            for (var $art_iwxohdl$art_i = 0, $art_objbgcwmedbk$art_obj = p.thirds, $art_cnwzprcgp$art_c = $art_objbgcwmedbk$art_obj.length; $art_iwxohdl$art_i < $art_cnwzprcgp$art_c; $art_iwxohdl$art_i++) {
                var t = $art_objbgcwmedbk$art_obj[$art_iwxohdl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
