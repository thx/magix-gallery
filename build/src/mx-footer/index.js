...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iajhxbtee$art_i = 0, $art_cvjewpnta$art_c = products.length; $art_iajhxbtee$art_i < $art_cvjewpnta$art_c; $art_iajhxbtee$art_i++) {        var p = products[$art_iajhxbtee$art_i]%>';
        for (var $art_iajhxbtee$art_i = 0, $art_cvjewpnta$art_c = products.length; $art_iajhxbtee$art_i < $art_cvjewpnta$art_c; $art_iajhxbtee$art_i++) {
            var p = products[$art_iajhxbtee$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqapupn$art_i = 0, $art_objivsmbckgc$art_obj = p.thirds, $art_cxlvrls$art_c = $art_objivsmbckgc$art_obj.length; $art_iqapupn$art_i < $art_cxlvrls$art_c; $art_iqapupn$art_i++) {            var t = $art_objivsmbckgc$art_obj[$art_iqapupn$art_i]%>';
            for (var $art_iqapupn$art_i = 0, $art_objivsmbckgc$art_obj = p.thirds, $art_cxlvrls$art_c = $art_objivsmbckgc$art_obj.length; $art_iqapupn$art_i < $art_cxlvrls$art_c; $art_iqapupn$art_i++) {
                var t = $art_objivsmbckgc$art_obj[$art_iqapupn$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
