...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iqnmjnjyoque$art_i = 0, $art_cxbwor$art_c = products.length; $art_iqnmjnjyoque$art_i < $art_cxbwor$art_c; $art_iqnmjnjyoque$art_i++) {        var p = products[$art_iqnmjnjyoque$art_i]%>';
        for (var $art_iqnmjnjyoque$art_i = 0, $art_cxbwor$art_c = products.length; $art_iqnmjnjyoque$art_i < $art_cxbwor$art_c; $art_iqnmjnjyoque$art_i++) {
            var p = products[$art_iqnmjnjyoque$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ibqyph$art_i = 0, $art_objyptychip$art_obj = p.thirds, $art_cbjmkvdktd$art_c = $art_objyptychip$art_obj.length; $art_ibqyph$art_i < $art_cbjmkvdktd$art_c; $art_ibqyph$art_i++) {            var t = $art_objyptychip$art_obj[$art_ibqyph$art_i]%>';
            for (var $art_ibqyph$art_i = 0, $art_objyptychip$art_obj = p.thirds, $art_cbjmkvdktd$art_c = $art_objyptychip$art_obj.length; $art_ibqyph$art_i < $art_cbjmkvdktd$art_c; $art_ibqyph$art_i++) {
                var t = $art_objyptychip$art_obj[$art_ibqyph$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
