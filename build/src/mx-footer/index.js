...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iqpjzqsg$art_i = 0, $art_ckiarxcvcrj$art_c = products.length; $art_iqpjzqsg$art_i < $art_ckiarxcvcrj$art_c; $art_iqpjzqsg$art_i++) {        var p = products[$art_iqpjzqsg$art_i]%>';
        for (var $art_iqpjzqsg$art_i = 0, $art_ckiarxcvcrj$art_c = products.length; $art_iqpjzqsg$art_i < $art_ckiarxcvcrj$art_c; $art_iqpjzqsg$art_i++) {
            var p = products[$art_iqpjzqsg$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iabwzkrhmq$art_i = 0, $art_objtirqpfbo$art_obj = p.thirds, $art_cqzjhodqk$art_c = $art_objtirqpfbo$art_obj.length; $art_iabwzkrhmq$art_i < $art_cqzjhodqk$art_c; $art_iabwzkrhmq$art_i++) {            var t = $art_objtirqpfbo$art_obj[$art_iabwzkrhmq$art_i]%>';
            for (var $art_iabwzkrhmq$art_i = 0, $art_objtirqpfbo$art_obj = p.thirds, $art_cqzjhodqk$art_c = $art_objtirqpfbo$art_obj.length; $art_iabwzkrhmq$art_i < $art_cqzjhodqk$art_c; $art_iabwzkrhmq$art_i++) {
                var t = $art_objtirqpfbo$art_obj[$art_iabwzkrhmq$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
