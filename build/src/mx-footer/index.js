...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ijfpmmp$art_i = 0, $art_cakmgr$art_c = products.length; $art_ijfpmmp$art_i < $art_cakmgr$art_c; $art_ijfpmmp$art_i++) {        var p = products[$art_ijfpmmp$art_i]%>';
        for (var $art_ijfpmmp$art_i = 0, $art_cakmgr$art_c = products.length; $art_ijfpmmp$art_i < $art_cakmgr$art_c; $art_ijfpmmp$art_i++) {
            var p = products[$art_ijfpmmp$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_irmcehtouq$art_i = 0, $art_objjwemfrafv$art_obj = p.thirds, $art_cpnalrtfnei$art_c = $art_objjwemfrafv$art_obj.length; $art_irmcehtouq$art_i < $art_cpnalrtfnei$art_c; $art_irmcehtouq$art_i++) {            var t = $art_objjwemfrafv$art_obj[$art_irmcehtouq$art_i]%>';
            for (var $art_irmcehtouq$art_i = 0, $art_objjwemfrafv$art_obj = p.thirds, $art_cpnalrtfnei$art_c = $art_objjwemfrafv$art_obj.length; $art_irmcehtouq$art_i < $art_cpnalrtfnei$art_c; $art_irmcehtouq$art_i++) {
                var t = $art_objjwemfrafv$art_obj[$art_irmcehtouq$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
