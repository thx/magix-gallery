...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_imqzzkiuk$art_i = 0, $art_cmvmsmfc$art_c = products.length; $art_imqzzkiuk$art_i < $art_cmvmsmfc$art_c; $art_imqzzkiuk$art_i++) {        var p = products[$art_imqzzkiuk$art_i]%>';
        for (var $art_imqzzkiuk$art_i = 0, $art_cmvmsmfc$art_c = products.length; $art_imqzzkiuk$art_i < $art_cmvmsmfc$art_c; $art_imqzzkiuk$art_i++) {
            var p = products[$art_imqzzkiuk$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilyglvjmc$art_i = 0, $art_objcusamvkc$art_obj = p.thirds, $art_cxrqch$art_c = $art_objcusamvkc$art_obj.length; $art_ilyglvjmc$art_i < $art_cxrqch$art_c; $art_ilyglvjmc$art_i++) {            var t = $art_objcusamvkc$art_obj[$art_ilyglvjmc$art_i]%>';
            for (var $art_ilyglvjmc$art_i = 0, $art_objcusamvkc$art_obj = p.thirds, $art_cxrqch$art_c = $art_objcusamvkc$art_obj.length; $art_ilyglvjmc$art_i < $art_cxrqch$art_c; $art_ilyglvjmc$art_i++) {
                var t = $art_objcusamvkc$art_obj[$art_ilyglvjmc$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
