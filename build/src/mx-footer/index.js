...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ipdvvvz$art_i = 0, $art_chgkpzwk$art_c = products.length; $art_ipdvvvz$art_i < $art_chgkpzwk$art_c; $art_ipdvvvz$art_i++) {        var p = products[$art_ipdvvvz$art_i]%>';
        for (var $art_ipdvvvz$art_i = 0, $art_chgkpzwk$art_c = products.length; $art_ipdvvvz$art_i < $art_chgkpzwk$art_c; $art_ipdvvvz$art_i++) {
            var p = products[$art_ipdvvvz$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iuzhytdxa$art_i = 0, $art_objnbkquxw$art_obj = p.thirds, $art_ckdueubyid$art_c = $art_objnbkquxw$art_obj.length; $art_iuzhytdxa$art_i < $art_ckdueubyid$art_c; $art_iuzhytdxa$art_i++) {            var t = $art_objnbkquxw$art_obj[$art_iuzhytdxa$art_i]%>';
            for (var $art_iuzhytdxa$art_i = 0, $art_objnbkquxw$art_obj = p.thirds, $art_ckdueubyid$art_c = $art_objnbkquxw$art_obj.length; $art_iuzhytdxa$art_i < $art_ckdueubyid$art_c; $art_iuzhytdxa$art_i++) {
                var t = $art_objnbkquxw$art_obj[$art_iuzhytdxa$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
