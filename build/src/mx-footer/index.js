...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ihjdhit$art_i = 0, $art_csiihbco$art_c = products.length; $art_ihjdhit$art_i < $art_csiihbco$art_c; $art_ihjdhit$art_i++) {        var p = products[$art_ihjdhit$art_i]%>';
        for (var $art_ihjdhit$art_i = 0, $art_csiihbco$art_c = products.length; $art_ihjdhit$art_i < $art_csiihbco$art_c; $art_ihjdhit$art_i++) {
            var p = products[$art_ihjdhit$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iyhanmhgi$art_i = 0, $art_objiqunqyeg$art_obj = p.thirds, $art_csduyutj$art_c = $art_objiqunqyeg$art_obj.length; $art_iyhanmhgi$art_i < $art_csduyutj$art_c; $art_iyhanmhgi$art_i++) {            var t = $art_objiqunqyeg$art_obj[$art_iyhanmhgi$art_i]%>';
            for (var $art_iyhanmhgi$art_i = 0, $art_objiqunqyeg$art_obj = p.thirds, $art_csduyutj$art_c = $art_objiqunqyeg$art_obj.length; $art_iyhanmhgi$art_i < $art_csduyutj$art_c; $art_iyhanmhgi$art_i++) {
                var t = $art_objiqunqyeg$art_obj[$art_iyhanmhgi$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
