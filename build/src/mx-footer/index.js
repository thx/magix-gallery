...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ipqujsh$art_i = 0, $art_capjnhedsst$art_c = products.length; $art_ipqujsh$art_i < $art_capjnhedsst$art_c; $art_ipqujsh$art_i++) {        var p = products[$art_ipqujsh$art_i]%>';
        for (var $art_ipqujsh$art_i = 0, $art_capjnhedsst$art_c = products.length; $art_ipqujsh$art_i < $art_capjnhedsst$art_c; $art_ipqujsh$art_i++) {
            var p = products[$art_ipqujsh$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ijgnlddd$art_i = 0, $art_objeswnfgbn$art_obj = p.thirds, $art_cflzxvujyce$art_c = $art_objeswnfgbn$art_obj.length; $art_ijgnlddd$art_i < $art_cflzxvujyce$art_c; $art_ijgnlddd$art_i++) {            var t = $art_objeswnfgbn$art_obj[$art_ijgnlddd$art_i]%>';
            for (var $art_ijgnlddd$art_i = 0, $art_objeswnfgbn$art_obj = p.thirds, $art_cflzxvujyce$art_c = $art_objeswnfgbn$art_obj.length; $art_ijgnlddd$art_i < $art_cflzxvujyce$art_c; $art_ijgnlddd$art_i++) {
                var t = $art_objeswnfgbn$art_obj[$art_ijgnlddd$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
