...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iqpygezl$art_i = 0, $art_cjlsftgpqx$art_c = products.length; $art_iqpygezl$art_i < $art_cjlsftgpqx$art_c; $art_iqpygezl$art_i++) {        var p = products[$art_iqpygezl$art_i]%>';
        for (var $art_iqpygezl$art_i = 0, $art_cjlsftgpqx$art_c = products.length; $art_iqpygezl$art_i < $art_cjlsftgpqx$art_c; $art_iqpygezl$art_i++) {
            var p = products[$art_iqpygezl$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_icblsjvcn$art_i = 0, $art_objzwptqpj$art_obj = p.thirds, $art_cxnelxpswqo$art_c = $art_objzwptqpj$art_obj.length; $art_icblsjvcn$art_i < $art_cxnelxpswqo$art_c; $art_icblsjvcn$art_i++) {            var t = $art_objzwptqpj$art_obj[$art_icblsjvcn$art_i]%>';
            for (var $art_icblsjvcn$art_i = 0, $art_objzwptqpj$art_obj = p.thirds, $art_cxnelxpswqo$art_c = $art_objzwptqpj$art_obj.length; $art_icblsjvcn$art_i < $art_cxnelxpswqo$art_c; $art_icblsjvcn$art_i++) {
                var t = $art_objzwptqpj$art_obj[$art_icblsjvcn$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
