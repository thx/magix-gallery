...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iexrpndyur$art_i = 0, $art_ckiikdjjnn$art_c = products.length; $art_iexrpndyur$art_i < $art_ckiikdjjnn$art_c; $art_iexrpndyur$art_i++) {        var p = products[$art_iexrpndyur$art_i]%>';
        for (var $art_iexrpndyur$art_i = 0, $art_ckiikdjjnn$art_c = products.length; $art_iexrpndyur$art_i < $art_ckiikdjjnn$art_c; $art_iexrpndyur$art_i++) {
            var p = products[$art_iexrpndyur$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_imnp$art_i = 0, $art_objfrwsxoabzuh$art_obj = p.thirds, $art_chuzbyyilqj$art_c = $art_objfrwsxoabzuh$art_obj.length; $art_imnp$art_i < $art_chuzbyyilqj$art_c; $art_imnp$art_i++) {            var t = $art_objfrwsxoabzuh$art_obj[$art_imnp$art_i]%>';
            for (var $art_imnp$art_i = 0, $art_objfrwsxoabzuh$art_obj = p.thirds, $art_chuzbyyilqj$art_c = $art_objfrwsxoabzuh$art_obj.length; $art_imnp$art_i < $art_chuzbyyilqj$art_c; $art_imnp$art_i++) {
                var t = $art_objfrwsxoabzuh$art_obj[$art_imnp$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
