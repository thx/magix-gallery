...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iczvrwaa$art_i = 0, $art_clkycwtcgp$art_c = products.length; $art_iczvrwaa$art_i < $art_clkycwtcgp$art_c; $art_iczvrwaa$art_i++) {        var p = products[$art_iczvrwaa$art_i]%>';
        for (var $art_iczvrwaa$art_i = 0, $art_clkycwtcgp$art_c = products.length; $art_iczvrwaa$art_i < $art_clkycwtcgp$art_c; $art_iczvrwaa$art_i++) {
            var p = products[$art_iczvrwaa$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_inirtlidk$art_i = 0, $art_objjnpjaagwbr$art_obj = p.thirds, $art_cpfghbuln$art_c = $art_objjnpjaagwbr$art_obj.length; $art_inirtlidk$art_i < $art_cpfghbuln$art_c; $art_inirtlidk$art_i++) {            var t = $art_objjnpjaagwbr$art_obj[$art_inirtlidk$art_i]%>';
            for (var $art_inirtlidk$art_i = 0, $art_objjnpjaagwbr$art_obj = p.thirds, $art_cpfghbuln$art_c = $art_objjnpjaagwbr$art_obj.length; $art_inirtlidk$art_i < $art_cpfghbuln$art_c; $art_inirtlidk$art_i++) {
                var t = $art_objjnpjaagwbr$art_obj[$art_inirtlidk$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
