...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ikcwdepkmgwj$art_i = 0, $art_clqfjx$art_c = products.length; $art_ikcwdepkmgwj$art_i < $art_clqfjx$art_c; $art_ikcwdepkmgwj$art_i++) {        var p = products[$art_ikcwdepkmgwj$art_i]%>';
        for (var $art_ikcwdepkmgwj$art_i = 0, $art_clqfjx$art_c = products.length; $art_ikcwdepkmgwj$art_i < $art_clqfjx$art_c; $art_ikcwdepkmgwj$art_i++) {
            var p = products[$art_ikcwdepkmgwj$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqfpencg$art_i = 0, $art_objqzadwomvpd$art_obj = p.thirds, $art_ccfvdrdd$art_c = $art_objqzadwomvpd$art_obj.length; $art_iqfpencg$art_i < $art_ccfvdrdd$art_c; $art_iqfpencg$art_i++) {            var t = $art_objqzadwomvpd$art_obj[$art_iqfpencg$art_i]%>';
            for (var $art_iqfpencg$art_i = 0, $art_objqzadwomvpd$art_obj = p.thirds, $art_ccfvdrdd$art_c = $art_objqzadwomvpd$art_obj.length; $art_iqfpencg$art_i < $art_ccfvdrdd$art_c; $art_iqfpencg$art_i++) {
                var t = $art_objqzadwomvpd$art_obj[$art_iqfpencg$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
