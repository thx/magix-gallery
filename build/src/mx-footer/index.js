...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_istdwiokb$art_i = 0, $art_cqduywana$art_c = products.length; $art_istdwiokb$art_i < $art_cqduywana$art_c; $art_istdwiokb$art_i++) {        var p = products[$art_istdwiokb$art_i]%>';
        for (var $art_istdwiokb$art_i = 0, $art_cqduywana$art_c = products.length; $art_istdwiokb$art_i < $art_cqduywana$art_c; $art_istdwiokb$art_i++) {
            var p = products[$art_istdwiokb$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqpopvc$art_i = 0, $art_objardvvlol$art_obj = p.thirds, $art_cdwebucn$art_c = $art_objardvvlol$art_obj.length; $art_iqpopvc$art_i < $art_cdwebucn$art_c; $art_iqpopvc$art_i++) {            var t = $art_objardvvlol$art_obj[$art_iqpopvc$art_i]%>';
            for (var $art_iqpopvc$art_i = 0, $art_objardvvlol$art_obj = p.thirds, $art_cdwebucn$art_c = $art_objardvvlol$art_obj.length; $art_iqpopvc$art_i < $art_cdwebucn$art_c; $art_iqpopvc$art_i++) {
                var t = $art_objardvvlol$art_obj[$art_iqpopvc$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
