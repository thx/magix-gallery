...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_imblkfqz$art_i = 0, $art_comsldkr$art_c = products.length; $art_imblkfqz$art_i < $art_comsldkr$art_c; $art_imblkfqz$art_i++) {        var p = products[$art_imblkfqz$art_i]%>';
        for (var $art_imblkfqz$art_i = 0, $art_comsldkr$art_c = products.length; $art_imblkfqz$art_i < $art_comsldkr$art_c; $art_imblkfqz$art_i++) {
            var p = products[$art_imblkfqz$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iaxkugbvm$art_i = 0, $art_objmlpyhn$art_obj = p.thirds, $art_colaphx$art_c = $art_objmlpyhn$art_obj.length; $art_iaxkugbvm$art_i < $art_colaphx$art_c; $art_iaxkugbvm$art_i++) {            var t = $art_objmlpyhn$art_obj[$art_iaxkugbvm$art_i]%>';
            for (var $art_iaxkugbvm$art_i = 0, $art_objmlpyhn$art_obj = p.thirds, $art_colaphx$art_c = $art_objmlpyhn$art_obj.length; $art_iaxkugbvm$art_i < $art_colaphx$art_c; $art_iaxkugbvm$art_i++) {
                var t = $art_objmlpyhn$art_obj[$art_iaxkugbvm$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
