...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ilmvpogerxcn$art_i = 0, $art_ciidord$art_c = products.length; $art_ilmvpogerxcn$art_i < $art_ciidord$art_c; $art_ilmvpogerxcn$art_i++) {        var p = products[$art_ilmvpogerxcn$art_i]%>';
        for (var $art_ilmvpogerxcn$art_i = 0, $art_ciidord$art_c = products.length; $art_ilmvpogerxcn$art_i < $art_ciidord$art_c; $art_ilmvpogerxcn$art_i++) {
            var p = products[$art_ilmvpogerxcn$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_ixnkyaxj$art_i = 0, $art_objbymzfsqo$art_obj = p.thirds, $art_cvbhtdsgb$art_c = $art_objbymzfsqo$art_obj.length; $art_ixnkyaxj$art_i < $art_cvbhtdsgb$art_c; $art_ixnkyaxj$art_i++) {            var t = $art_objbymzfsqo$art_obj[$art_ixnkyaxj$art_i]%>';
            for (var $art_ixnkyaxj$art_i = 0, $art_objbymzfsqo$art_obj = p.thirds, $art_cvbhtdsgb$art_c = $art_objbymzfsqo$art_obj.length; $art_ixnkyaxj$art_i < $art_cvbhtdsgb$art_c; $art_ixnkyaxj$art_i++) {
                var t = $art_objbymzfsqo$art_obj[$art_ixnkyaxj$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
