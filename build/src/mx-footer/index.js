...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iicrdntoie$art_i = 0, $art_cqpwuslucv$art_c = products.length; $art_iicrdntoie$art_i < $art_cqpwuslucv$art_c; $art_iicrdntoie$art_i++) {        var p = products[$art_iicrdntoie$art_i]%>';
        for (var $art_iicrdntoie$art_i = 0, $art_cqpwuslucv$art_c = products.length; $art_iicrdntoie$art_i < $art_cqpwuslucv$art_c; $art_iicrdntoie$art_i++) {
            var p = products[$art_iicrdntoie$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iwdcxl$art_i = 0, $art_objqacfokpalk$art_obj = p.thirds, $art_ccaxjcsnlp$art_c = $art_objqacfokpalk$art_obj.length; $art_iwdcxl$art_i < $art_ccaxjcsnlp$art_c; $art_iwdcxl$art_i++) {            var t = $art_objqacfokpalk$art_obj[$art_iwdcxl$art_i]%>';
            for (var $art_iwdcxl$art_i = 0, $art_objqacfokpalk$art_obj = p.thirds, $art_ccaxjcsnlp$art_c = $art_objqacfokpalk$art_obj.length; $art_iwdcxl$art_i < $art_ccaxjcsnlp$art_c; $art_iwdcxl$art_i++) {
                var t = $art_objqacfokpalk$art_obj[$art_iwdcxl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
