...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_isjnsahbzm$art_i = 0, $art_chusgilns$art_c = products.length; $art_isjnsahbzm$art_i < $art_chusgilns$art_c; $art_isjnsahbzm$art_i++) {        var p = products[$art_isjnsahbzm$art_i]%>';
        for (var $art_isjnsahbzm$art_i = 0, $art_chusgilns$art_c = products.length; $art_isjnsahbzm$art_i < $art_chusgilns$art_c; $art_isjnsahbzm$art_i++) {
            var p = products[$art_isjnsahbzm$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ijjivpl$art_i = 0, $art_objjnmbdnme$art_obj = p.thirds, $art_csesjoqz$art_c = $art_objjnmbdnme$art_obj.length; $art_ijjivpl$art_i < $art_csesjoqz$art_c; $art_ijjivpl$art_i++) {            var t = $art_objjnmbdnme$art_obj[$art_ijjivpl$art_i]%>';
            for (var $art_ijjivpl$art_i = 0, $art_objjnmbdnme$art_obj = p.thirds, $art_csesjoqz$art_c = $art_objjnmbdnme$art_obj.length; $art_ijjivpl$art_i < $art_csesjoqz$art_c; $art_ijjivpl$art_i++) {
                var t = $art_objjnmbdnme$art_obj[$art_ijjivpl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
