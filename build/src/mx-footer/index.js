...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ilfcfrkfxsxc$art_i = 0, $art_csxdcgtmxaf$art_c = products.length; $art_ilfcfrkfxsxc$art_i < $art_csxdcgtmxaf$art_c; $art_ilfcfrkfxsxc$art_i++) {        var p = products[$art_ilfcfrkfxsxc$art_i]%>';
        for (var $art_ilfcfrkfxsxc$art_i = 0, $art_csxdcgtmxaf$art_c = products.length; $art_ilfcfrkfxsxc$art_i < $art_csxdcgtmxaf$art_c; $art_ilfcfrkfxsxc$art_i++) {
            var p = products[$art_ilfcfrkfxsxc$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ighgtcfnho$art_i = 0, $art_objkcywvohn$art_obj = p.thirds, $art_cledodc$art_c = $art_objkcywvohn$art_obj.length; $art_ighgtcfnho$art_i < $art_cledodc$art_c; $art_ighgtcfnho$art_i++) {            var t = $art_objkcywvohn$art_obj[$art_ighgtcfnho$art_i]%>';
            for (var $art_ighgtcfnho$art_i = 0, $art_objkcywvohn$art_obj = p.thirds, $art_cledodc$art_c = $art_objkcywvohn$art_obj.length; $art_ighgtcfnho$art_i < $art_cledodc$art_c; $art_ighgtcfnho$art_i++) {
                var t = $art_objkcywvohn$art_obj[$art_ighgtcfnho$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
