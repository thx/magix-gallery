...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iwvcebkho$art_i = 0, $art_cazejjplp$art_c = products.length; $art_iwvcebkho$art_i < $art_cazejjplp$art_c; $art_iwvcebkho$art_i++) {        var p = products[$art_iwvcebkho$art_i]%>';
        for (var $art_iwvcebkho$art_i = 0, $art_cazejjplp$art_c = products.length; $art_iwvcebkho$art_i < $art_cazejjplp$art_c; $art_iwvcebkho$art_i++) {
            var p = products[$art_iwvcebkho$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iwqetacbz$art_i = 0, $art_objtgxhga$art_obj = p.thirds, $art_chzblzohrl$art_c = $art_objtgxhga$art_obj.length; $art_iwqetacbz$art_i < $art_chzblzohrl$art_c; $art_iwqetacbz$art_i++) {            var t = $art_objtgxhga$art_obj[$art_iwqetacbz$art_i]%>';
            for (var $art_iwqetacbz$art_i = 0, $art_objtgxhga$art_obj = p.thirds, $art_chzblzohrl$art_c = $art_objtgxhga$art_obj.length; $art_iwqetacbz$art_i < $art_chzblzohrl$art_c; $art_iwqetacbz$art_i++) {
                var t = $art_objtgxhga$art_obj[$art_iwqetacbz$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
