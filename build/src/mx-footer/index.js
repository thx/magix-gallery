...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_izbiuhhwsn$art_i = 0, $art_ccllsgajth$art_c = products.length; $art_izbiuhhwsn$art_i < $art_ccllsgajth$art_c; $art_izbiuhhwsn$art_i++) {        var p = products[$art_izbiuhhwsn$art_i]%>';
        for (var $art_izbiuhhwsn$art_i = 0, $art_ccllsgajth$art_c = products.length; $art_izbiuhhwsn$art_i < $art_ccllsgajth$art_c; $art_izbiuhhwsn$art_i++) {
            var p = products[$art_izbiuhhwsn$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iuaflxqsh$art_i = 0, $art_objuqwdotw$art_obj = p.thirds, $art_csmcsnor$art_c = $art_objuqwdotw$art_obj.length; $art_iuaflxqsh$art_i < $art_csmcsnor$art_c; $art_iuaflxqsh$art_i++) {            var t = $art_objuqwdotw$art_obj[$art_iuaflxqsh$art_i]%>';
            for (var $art_iuaflxqsh$art_i = 0, $art_objuqwdotw$art_obj = p.thirds, $art_csmcsnor$art_c = $art_objuqwdotw$art_obj.length; $art_iuaflxqsh$art_i < $art_csmcsnor$art_c; $art_iuaflxqsh$art_i++) {
                var t = $art_objuqwdotw$art_obj[$art_iuaflxqsh$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
