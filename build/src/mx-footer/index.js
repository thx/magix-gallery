...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_irgraruad$art_i = 0, $art_chpeecwnm$art_c = products.length; $art_irgraruad$art_i < $art_chpeecwnm$art_c; $art_irgraruad$art_i++) {        var p = products[$art_irgraruad$art_i]%>';
        for (var $art_irgraruad$art_i = 0, $art_chpeecwnm$art_c = products.length; $art_irgraruad$art_i < $art_chpeecwnm$art_c; $art_irgraruad$art_i++) {
            var p = products[$art_irgraruad$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_inetpqypk$art_i = 0, $art_objxyuqlsl$art_obj = p.thirds, $art_cskhchenqxi$art_c = $art_objxyuqlsl$art_obj.length; $art_inetpqypk$art_i < $art_cskhchenqxi$art_c; $art_inetpqypk$art_i++) {            var t = $art_objxyuqlsl$art_obj[$art_inetpqypk$art_i]%>';
            for (var $art_inetpqypk$art_i = 0, $art_objxyuqlsl$art_obj = p.thirds, $art_cskhchenqxi$art_c = $art_objxyuqlsl$art_obj.length; $art_inetpqypk$art_i < $art_cskhchenqxi$art_c; $art_inetpqypk$art_i++) {
                var t = $art_objxyuqlsl$art_obj[$art_inetpqypk$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
