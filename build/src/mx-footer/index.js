...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ihugnsr$art_i = 0, $art_cpeyrfdaqm$art_c = products.length; $art_ihugnsr$art_i < $art_cpeyrfdaqm$art_c; $art_ihugnsr$art_i++) {        var p = products[$art_ihugnsr$art_i]%>';
        for (var $art_ihugnsr$art_i = 0, $art_cpeyrfdaqm$art_c = products.length; $art_ihugnsr$art_i < $art_cpeyrfdaqm$art_c; $art_ihugnsr$art_i++) {
            var p = products[$art_ihugnsr$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifxiylsnngk$art_i = 0, $art_objdhriudv$art_obj = p.thirds, $art_cfimfhwo$art_c = $art_objdhriudv$art_obj.length; $art_ifxiylsnngk$art_i < $art_cfimfhwo$art_c; $art_ifxiylsnngk$art_i++) {            var t = $art_objdhriudv$art_obj[$art_ifxiylsnngk$art_i]%>';
            for (var $art_ifxiylsnngk$art_i = 0, $art_objdhriudv$art_obj = p.thirds, $art_cfimfhwo$art_c = $art_objdhriudv$art_obj.length; $art_ifxiylsnngk$art_i < $art_cfimfhwo$art_c; $art_ifxiylsnngk$art_i++) {
                var t = $art_objdhriudv$art_obj[$art_ifxiylsnngk$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
