...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iujcxp$art_i = 0, $art_ccqgsuv$art_c = products.length; $art_iujcxp$art_i < $art_ccqgsuv$art_c; $art_iujcxp$art_i++) {        var p = products[$art_iujcxp$art_i]%>';
        for (var $art_iujcxp$art_i = 0, $art_ccqgsuv$art_c = products.length; $art_iujcxp$art_i < $art_ccqgsuv$art_c; $art_iujcxp$art_i++) {
            var p = products[$art_iujcxp$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iiqcbxkqtl$art_i = 0, $art_objbwknets$art_obj = p.thirds, $art_cpzkwzsel$art_c = $art_objbwknets$art_obj.length; $art_iiqcbxkqtl$art_i < $art_cpzkwzsel$art_c; $art_iiqcbxkqtl$art_i++) {            var t = $art_objbwknets$art_obj[$art_iiqcbxkqtl$art_i]%>';
            for (var $art_iiqcbxkqtl$art_i = 0, $art_objbwknets$art_obj = p.thirds, $art_cpzkwzsel$art_c = $art_objbwknets$art_obj.length; $art_iiqcbxkqtl$art_i < $art_cpzkwzsel$art_c; $art_iiqcbxkqtl$art_i++) {
                var t = $art_objbwknets$art_obj[$art_iiqcbxkqtl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
