...
module.exports = Magix.View.extend({
    ...
    $$ref = $$; var $g = '', $_temp, $p = '', $em = { '&': 'amp', '<': 'lt', '>': 'gt', '"': '#34', '\'': '#39', '`': '#96' }, $er = /[&<>"'`]/g, $n = function (v) { return '' + (v == null ? '' : v); }, $ef = function (m) { return "&" + $em[m] + ";"; }, $e = function (v) { return $n(v).replace($er, $ef); }, $um = { '!': '%21', '\'': '%27', '(': '%28', ')': '%29', '*': '%2A' }, $uf = function (m) { return $um[m]; }, $uq = /[!')(*]/g, $eu = function (v) { return encodeURIComponent($n(v)).replace($uq, $uf); }, $qr = /[\\'"]/g, $eq = function (v) { return $n(v).replace($qr, '\\$&'); }, len = $$.len, dark = $$.dark, width = $$.width, products = $$.products, footerHtml = $$.footerHtml; var $expr, $art, $line; try {
    $p += '';
    $line = 1;
    $art = 'if len > 0';
    ;
    ...
    if (len > 0) {
        ...
        $art = '=width';
        ;
        $p += '' + ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_galleryaV:_" class="_zs_gallery_mx-footer_index_-logo"><img src="https://img.alicdn.com/tfs/TB1_j6sn0cnBKNjSZR0XXcFqFXa-182-185.png"><i class="mc-iconfont _zs_gallery_mx-footer_index_-mama-icon">&#xe601;</i></div><div mxa="_zs_galleryaV:_" class="clearfix">';
        $line = 8;
        $art = 'each products as p';
        ;
        $p += '';
        $expr = '<%for(var $art_inmjvzkiystr$art_i=0;$art_inmjvzkiystr$art_i<products.length;$art_inmjvzkiystr$art_i++){var p=products[$art_inmjvzkiystr$art_i]%>';
        for (var $art_inmjvzkiystr$art_i = 0; $art_inmjvzkiystr$art_i < products.length; $art_inmjvzkiystr$art_i++) {
            var p = products[$art_inmjvzkiystr$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_irlatbxjgl$art_i=0,$art_objroedpyjp$art_obj=p.thirds;$art_irlatbxjgl$art_i<$art_objroedpyjp$art_obj.length;$art_irlatbxjgl$art_i++){var t=$art_objroedpyjp$art_obj[$art_irlatbxjgl$art_i]%>';
            for (var $art_irlatbxjgl$art_i = 0, $art_objroedpyjp$art_obj = p.thirds; $art_irlatbxjgl$art_i < $art_objroedpyjp$art_obj.length; $art_irlatbxjgl$art_i++) {
                var t = $art_objroedpyjp$art_obj[$art_irlatbxjgl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
        ...
        ;
        $p += '</div><div mxs="_zs_galleryaV:a" class="_zs_gallery_mx-footer_index_-qrcode"><img src="//gw.alicdn.com/tfs/TB1C2cNrv1TBuNjy0FjXXajyXXa-300-300.png"><div>打开淘宝扫一扫</div><div>下载阿里妈妈APP</div></div></div>';
        $line = 25;
        $art = '/if';
        ;
        $p += '';
