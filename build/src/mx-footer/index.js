...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ijndtyfkp$art_i = 0, $art_cghdtcwe$art_c = products.length; $art_ijndtyfkp$art_i < $art_cghdtcwe$art_c; $art_ijndtyfkp$art_i++) {        var p = products[$art_ijndtyfkp$art_i]%>';
        for (var $art_ijndtyfkp$art_i = 0, $art_cghdtcwe$art_c = products.length; $art_ijndtyfkp$art_i < $art_cghdtcwe$art_c; $art_ijndtyfkp$art_i++) {
            var p = products[$art_ijndtyfkp$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_igyskhbjc$art_i = 0, $art_objldoaojzt$art_obj = p.thirds, $art_cwrnvcixp$art_c = $art_objldoaojzt$art_obj.length; $art_igyskhbjc$art_i < $art_cwrnvcixp$art_c; $art_igyskhbjc$art_i++) {            var t = $art_objldoaojzt$art_obj[$art_igyskhbjc$art_i]%>';
            for (var $art_igyskhbjc$art_i = 0, $art_objldoaojzt$art_obj = p.thirds, $art_cwrnvcixp$art_c = $art_objldoaojzt$art_obj.length; $art_igyskhbjc$art_i < $art_cwrnvcixp$art_c; $art_igyskhbjc$art_i++) {
                var t = $art_objldoaojzt$art_obj[$art_igyskhbjc$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
