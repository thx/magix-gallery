...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ihxfzyfd$art_i = 0, $art_cizgrser$art_c = products.length; $art_ihxfzyfd$art_i < $art_cizgrser$art_c; $art_ihxfzyfd$art_i++) {        var p = products[$art_ihxfzyfd$art_i]%>';
        for (var $art_ihxfzyfd$art_i = 0, $art_cizgrser$art_c = products.length; $art_ihxfzyfd$art_i < $art_cizgrser$art_c; $art_ihxfzyfd$art_i++) {
            var p = products[$art_ihxfzyfd$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifzdbusxl$art_i = 0, $art_objfnosiy$art_obj = p.thirds, $art_cpfjcpy$art_c = $art_objfnosiy$art_obj.length; $art_ifzdbusxl$art_i < $art_cpfjcpy$art_c; $art_ifzdbusxl$art_i++) {            var t = $art_objfnosiy$art_obj[$art_ifzdbusxl$art_i]%>';
            for (var $art_ifzdbusxl$art_i = 0, $art_objfnosiy$art_obj = p.thirds, $art_cpfjcpy$art_c = $art_objfnosiy$art_obj.length; $art_ifzdbusxl$art_i < $art_cpfjcpy$art_c; $art_ifzdbusxl$art_i++) {
                var t = $art_objfnosiy$art_obj[$art_ifzdbusxl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
