...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iwjrvqrtyen$art_i = 0, $art_coigpjhougd$art_c = products.length; $art_iwjrvqrtyen$art_i < $art_coigpjhougd$art_c; $art_iwjrvqrtyen$art_i++) {        var p = products[$art_iwjrvqrtyen$art_i]%>';
        for (var $art_iwjrvqrtyen$art_i = 0, $art_coigpjhougd$art_c = products.length; $art_iwjrvqrtyen$art_i < $art_coigpjhougd$art_c; $art_iwjrvqrtyen$art_i++) {
            var p = products[$art_iwjrvqrtyen$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_izrgsydcqsd$art_i = 0, $art_objgzjfwaps$art_obj = p.thirds, $art_cylayekgoj$art_c = $art_objgzjfwaps$art_obj.length; $art_izrgsydcqsd$art_i < $art_cylayekgoj$art_c; $art_izrgsydcqsd$art_i++) {            var t = $art_objgzjfwaps$art_obj[$art_izrgsydcqsd$art_i]%>';
            for (var $art_izrgsydcqsd$art_i = 0, $art_objgzjfwaps$art_obj = p.thirds, $art_cylayekgoj$art_c = $art_objgzjfwaps$art_obj.length; $art_izrgsydcqsd$art_i < $art_cylayekgoj$art_c; $art_izrgsydcqsd$art_i++) {
                var t = $art_objgzjfwaps$art_obj[$art_izrgsydcqsd$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
