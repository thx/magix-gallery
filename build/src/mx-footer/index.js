...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ihqcaa$art_i = 0, $art_ctsnnwuus$art_c = products.length; $art_ihqcaa$art_i < $art_ctsnnwuus$art_c; $art_ihqcaa$art_i++) {        var p = products[$art_ihqcaa$art_i]%>';
        for (var $art_ihqcaa$art_i = 0, $art_ctsnnwuus$art_c = products.length; $art_ihqcaa$art_i < $art_ctsnnwuus$art_c; $art_ihqcaa$art_i++) {
            var p = products[$art_ihqcaa$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_isqkxcmblc$art_i = 0, $art_objhdnrgoabblj$art_obj = p.thirds, $art_cnhtjioc$art_c = $art_objhdnrgoabblj$art_obj.length; $art_isqkxcmblc$art_i < $art_cnhtjioc$art_c; $art_isqkxcmblc$art_i++) {            var t = $art_objhdnrgoabblj$art_obj[$art_isqkxcmblc$art_i]%>';
            for (var $art_isqkxcmblc$art_i = 0, $art_objhdnrgoabblj$art_obj = p.thirds, $art_cnhtjioc$art_c = $art_objhdnrgoabblj$art_obj.length; $art_isqkxcmblc$art_i < $art_cnhtjioc$art_c; $art_isqkxcmblc$art_i++) {
                var t = $art_objhdnrgoabblj$art_obj[$art_isqkxcmblc$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
