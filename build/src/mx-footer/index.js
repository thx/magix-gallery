...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        $art = '=width';
        ;
        $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_gallerybS:_" class="_zs_gallery_mx-footer_index_-logo"><img src="//img.alicdn.com/tfs/TB14rObn7PoK1RjSZKbXXX1IXXa-191-191.png"><i class="mc-iconfont _zs_gallery_mx-footer_index_-mama-icon">&#xe601;</i></div><div mxa="_zs_gallerybS:_" class="clearfix">';
        $line = 8;
        $art = 'each products as p';
        ;
        $expr = '<%for (var $art_isvhrbtqa$art_i = 0, $art_cwgxaec$art_c = products.length; $art_isvhrbtqa$art_i < $art_cwgxaec$art_c; $art_isvhrbtqa$art_i++) {        var p = products[$art_isvhrbtqa$art_i]%>';
        for (var $art_isvhrbtqa$art_i = 0, $art_cwgxaec$art_c = products.length; $art_isvhrbtqa$art_i < $art_cwgxaec$art_c; $art_isvhrbtqa$art_i++) {
            var p = products[$art_isvhrbtqa$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ioxvnbozyg$art_i = 0, $art_objfzuxpeu$art_obj = p.thirds, $art_ckmpgficqf$art_c = $art_objfzuxpeu$art_obj.length; $art_ioxvnbozyg$art_i < $art_ckmpgficqf$art_c; $art_ioxvnbozyg$art_i++) {            var t = $art_objfzuxpeu$art_obj[$art_ioxvnbozyg$art_i]%>';
            for (var $art_ioxvnbozyg$art_i = 0, $art_objfzuxpeu$art_obj = p.thirds, $art_ckmpgficqf$art_c = $art_objfzuxpeu$art_obj.length; $art_ioxvnbozyg$art_i < $art_ckmpgficqf$art_c; $art_ioxvnbozyg$art_i++) {
                var t = $art_objfzuxpeu$art_obj[$art_ioxvnbozyg$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
        ...
        ;
        $p += '</div><div mxs="_zs_gallerybS:a" class="_zs_gallery_mx-footer_index_-qrcode"><img src="//gw.alicdn.com/tfs/TB1C2cNrv1TBuNjy0FjXXajyXXa-300-300.png"><div>打开淘宝扫一扫</div><div>下载阿里妈妈APP</div></div></div>';
        $line = 25;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '"><div mxa="_zs_gallerybS:a" class="_zs_gallery_mx-footer_index_-line"><a mxs="_zs_gallerybS:b" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//www.alimama.com/home/about-1.htm">联系客服</a><a mxs="_zs_gallerybS:c" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//open.taobao.com/">开放平台</a>';
    $line = 30;
    $art = 'if tanx';
    ;
    $expr = '<%if (tanx) {%>';
    if (tanx) {
        ;
        $p += '<a mxs="_zs_gallerybS:d" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//tanx.com/web/opt.html">隐私权保护</a>';
        $line = 32;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (taobao) {
        ;
        $p += '<a mxs="_zs_gallerybS:e" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="https://terms.alicdn.com/legal-agreement/terms/suit_bu1_ali_mama_division/suit_bu1_ali_mama_division201709111812_13128.html">法律声明</a>';
        $line = 35;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '<a mxs="_zs_gallerybS:f" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//www.alimama.com/home/about-4.htm">意见反馈</a><a mxs="_zs_gallerybS:g" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="//jubao.alibaba.com">廉正举报</a>';
    $line = 41;
    $art = 'if tanx';
    ;
    $expr = '<%if (tanx) {%>';
    if (tanx) {
        ;
        $p += '<span mxs="_zs_gallerybS:h" class="_zs_gallery_mx-footer_index_-line-text">Tanx.com版权所有</span><a mxs="_zs_gallerybS:i" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="http://www.miibeian.gov.cn">浙ICP备09109183号-10</a>';
        $line = 44;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (taobao) {
        ;
        $p += '<span mxa="_zs_gallerybS:b" class="_zs_gallery_mx-footer_index_-line-text">Taobao.com版权所有 2003-';
        $line = 46;
        $art = '=year';
        ;
        $p += ($expr = '<%=year%>', $e(year)) + '</span><a mxs="_zs_gallerybS:j" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="http://www.miibeian.gov.cn">ICP证：浙B2-20080224-1</a>';
        $line = 48;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (alimama) {
        ;
        $p += '<span mxa="_zs_gallerybS:c" class="_zs_gallery_mx-footer_index_-line-text">阿里妈妈版权所有 2007-';
        $line = 50;
        $art = '=year';
        ;
        $p += ($expr = '<%=year%>', $e(year)) + '</span><a mxs="_zs_gallerybS:k" class="_zs_gallery_mx-footer_index_-line-link" target="_blank" rel="noopener noreferrer" href="http://www.miibeian.gov.cn">ICP证：浙B2-20070195</a>';
        $line = 52;
        $art = '/if';
        ;
        $expr = '<%}%>';
