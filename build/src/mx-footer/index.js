...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_izbkxikj$art_i = 0, $art_cfhyrramjcc$art_c = products.length; $art_izbkxikj$art_i < $art_cfhyrramjcc$art_c; $art_izbkxikj$art_i++) {        var p = products[$art_izbkxikj$art_i]%>';
        for (var $art_izbkxikj$art_i = 0, $art_cfhyrramjcc$art_c = products.length; $art_izbkxikj$art_i < $art_cfhyrramjcc$art_c; $art_izbkxikj$art_i++) {
            var p = products[$art_izbkxikj$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_idrsroofd$art_i = 0, $art_objkzzykehg$art_obj = p.thirds, $art_cbrrwjmngs$art_c = $art_objkzzykehg$art_obj.length; $art_idrsroofd$art_i < $art_cbrrwjmngs$art_c; $art_idrsroofd$art_i++) {            var t = $art_objkzzykehg$art_obj[$art_idrsroofd$art_i]%>';
            for (var $art_idrsroofd$art_i = 0, $art_objkzzykehg$art_obj = p.thirds, $art_cbrrwjmngs$art_c = $art_objkzzykehg$art_obj.length; $art_idrsroofd$art_i < $art_cbrrwjmngs$art_c; $art_idrsroofd$art_i++) {
                var t = $art_objkzzykehg$art_obj[$art_idrsroofd$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
