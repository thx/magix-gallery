...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_inwnnsayrcb$art_i = 0, $art_cxdgbj$art_c = products.length; $art_inwnnsayrcb$art_i < $art_cxdgbj$art_c; $art_inwnnsayrcb$art_i++) {        var p = products[$art_inwnnsayrcb$art_i]%>';
        for (var $art_inwnnsayrcb$art_i = 0, $art_cxdgbj$art_c = products.length; $art_inwnnsayrcb$art_i < $art_cxdgbj$art_c; $art_inwnnsayrcb$art_i++) {
            var p = products[$art_inwnnsayrcb$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iwbgzlvmjqg$art_i = 0, $art_objfebmjzo$art_obj = p.thirds, $art_crgghzc$art_c = $art_objfebmjzo$art_obj.length; $art_iwbgzlvmjqg$art_i < $art_crgghzc$art_c; $art_iwbgzlvmjqg$art_i++) {            var t = $art_objfebmjzo$art_obj[$art_iwbgzlvmjqg$art_i]%>';
            for (var $art_iwbgzlvmjqg$art_i = 0, $art_objfebmjzo$art_obj = p.thirds, $art_crgghzc$art_c = $art_objfebmjzo$art_obj.length; $art_iwbgzlvmjqg$art_i < $art_crgghzc$art_c; $art_iwbgzlvmjqg$art_i++) {
                var t = $art_objfebmjzo$art_obj[$art_iwbgzlvmjqg$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
