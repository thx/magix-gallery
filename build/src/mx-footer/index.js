...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_izxaytw$art_i = 0, $art_ciqtxbi$art_c = products.length; $art_izxaytw$art_i < $art_ciqtxbi$art_c; $art_izxaytw$art_i++) {        var p = products[$art_izxaytw$art_i]%>';
        for (var $art_izxaytw$art_i = 0, $art_ciqtxbi$art_c = products.length; $art_izxaytw$art_i < $art_ciqtxbi$art_c; $art_izxaytw$art_i++) {
            var p = products[$art_izxaytw$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_igxnfirzlnua$art_i = 0, $art_objmpfpqux$art_obj = p.thirds, $art_cdvbwn$art_c = $art_objmpfpqux$art_obj.length; $art_igxnfirzlnua$art_i < $art_cdvbwn$art_c; $art_igxnfirzlnua$art_i++) {            var t = $art_objmpfpqux$art_obj[$art_igxnfirzlnua$art_i]%>';
            for (var $art_igxnfirzlnua$art_i = 0, $art_objmpfpqux$art_obj = p.thirds, $art_cdvbwn$art_c = $art_objmpfpqux$art_obj.length; $art_igxnfirzlnua$art_i < $art_cdvbwn$art_c; $art_igxnfirzlnua$art_i++) {
                var t = $art_objmpfpqux$art_obj[$art_igxnfirzlnua$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
