...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ilmxwbf$art_i = 0, $art_ccnehomyl$art_c = products.length; $art_ilmxwbf$art_i < $art_ccnehomyl$art_c; $art_ilmxwbf$art_i++) {        var p = products[$art_ilmxwbf$art_i]%>';
        for (var $art_ilmxwbf$art_i = 0, $art_ccnehomyl$art_c = products.length; $art_ilmxwbf$art_i < $art_ccnehomyl$art_c; $art_ilmxwbf$art_i++) {
            var p = products[$art_ilmxwbf$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iiykgky$art_i = 0, $art_objtbzczyj$art_obj = p.thirds, $art_cqtgzpjofr$art_c = $art_objtbzczyj$art_obj.length; $art_iiykgky$art_i < $art_cqtgzpjofr$art_c; $art_iiykgky$art_i++) {            var t = $art_objtbzczyj$art_obj[$art_iiykgky$art_i]%>';
            for (var $art_iiykgky$art_i = 0, $art_objtbzczyj$art_obj = p.thirds, $art_cqtgzpjofr$art_c = $art_objtbzczyj$art_obj.length; $art_iiykgky$art_i < $art_cqtgzpjofr$art_c; $art_iiykgky$art_i++) {
                var t = $art_objtbzczyj$art_obj[$art_iiykgky$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
