...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ixcgjxll$art_i=0;$art_ixcgjxll$art_i<products.length;$art_ixcgjxll$art_i++){var p=products[$art_ixcgjxll$art_i]%>';
        for (var $art_ixcgjxll$art_i = 0; $art_ixcgjxll$art_i < products.length; $art_ixcgjxll$art_i++) {
            var p = products[$art_ixcgjxll$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_irdboeqnio$art_i=0,$art_objjlahpxof$art_obj=p.thirds;$art_irdboeqnio$art_i<$art_objjlahpxof$art_obj.length;$art_irdboeqnio$art_i++){var t=$art_objjlahpxof$art_obj[$art_irdboeqnio$art_i]%>';
            for (var $art_irdboeqnio$art_i = 0, $art_objjlahpxof$art_obj = p.thirds; $art_irdboeqnio$art_i < $art_objjlahpxof$art_obj.length; $art_irdboeqnio$art_i++) {
                var t = $art_objjlahpxof$art_obj[$art_irdboeqnio$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
