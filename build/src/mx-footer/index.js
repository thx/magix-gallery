...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_ibfjclfto$art_i = 0, $art_ckueoptzy$art_c = products.length; $art_ibfjclfto$art_i < $art_ckueoptzy$art_c; $art_ibfjclfto$art_i++) {        var p = products[$art_ibfjclfto$art_i]%>';
        for (var $art_ibfjclfto$art_i = 0, $art_ckueoptzy$art_c = products.length; $art_ibfjclfto$art_i < $art_ckueoptzy$art_c; $art_ibfjclfto$art_i++) {
            var p = products[$art_ibfjclfto$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ixuwfmwai$art_i = 0, $art_objkndmkq$art_obj = p.thirds, $art_ckkzlrri$art_c = $art_objkndmkq$art_obj.length; $art_ixuwfmwai$art_i < $art_ckkzlrri$art_c; $art_ixuwfmwai$art_i++) {            var t = $art_objkndmkq$art_obj[$art_ixuwfmwai$art_i]%>';
            for (var $art_ixuwfmwai$art_i = 0, $art_objkndmkq$art_obj = p.thirds, $art_ckkzlrri$art_c = $art_objkndmkq$art_obj.length; $art_ixuwfmwai$art_i < $art_ckkzlrri$art_c; $art_ixuwfmwai$art_i++) {
                var t = $art_objkndmkq$art_obj[$art_ixuwfmwai$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
