...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_idmbckwg$art_i = 0, $art_cutnzz$art_c = products.length; $art_idmbckwg$art_i < $art_cutnzz$art_c; $art_idmbckwg$art_i++) {        var p = products[$art_idmbckwg$art_i]%>';
        for (var $art_idmbckwg$art_i = 0, $art_cutnzz$art_c = products.length; $art_idmbckwg$art_i < $art_cutnzz$art_c; $art_idmbckwg$art_i++) {
            var p = products[$art_idmbckwg$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifvakjxerc$art_i = 0, $art_objwqvijeqwf$art_obj = p.thirds, $art_caslvkvmn$art_c = $art_objwqvijeqwf$art_obj.length; $art_ifvakjxerc$art_i < $art_caslvkvmn$art_c; $art_ifvakjxerc$art_i++) {            var t = $art_objwqvijeqwf$art_obj[$art_ifvakjxerc$art_i]%>';
            for (var $art_ifvakjxerc$art_i = 0, $art_objwqvijeqwf$art_obj = p.thirds, $art_caslvkvmn$art_c = $art_objwqvijeqwf$art_obj.length; $art_ifvakjxerc$art_i < $art_caslvkvmn$art_c; $art_ifvakjxerc$art_i++) {
                var t = $art_objwqvijeqwf$art_obj[$art_ifvakjxerc$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
