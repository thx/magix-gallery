...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_imvjnfbifuk$art_i = 0, $art_czpfdypbh$art_c = products.length; $art_imvjnfbifuk$art_i < $art_czpfdypbh$art_c; $art_imvjnfbifuk$art_i++) {        var p = products[$art_imvjnfbifuk$art_i]%>';
        for (var $art_imvjnfbifuk$art_i = 0, $art_czpfdypbh$art_c = products.length; $art_imvjnfbifuk$art_i < $art_czpfdypbh$art_c; $art_imvjnfbifuk$art_i++) {
            var p = products[$art_imvjnfbifuk$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ioynpjld$art_i = 0, $art_objoqhfqgnb$art_obj = p.thirds, $art_cttemgyjwd$art_c = $art_objoqhfqgnb$art_obj.length; $art_ioynpjld$art_i < $art_cttemgyjwd$art_c; $art_ioynpjld$art_i++) {            var t = $art_objoqhfqgnb$art_obj[$art_ioynpjld$art_i]%>';
            for (var $art_ioynpjld$art_i = 0, $art_objoqhfqgnb$art_obj = p.thirds, $art_cttemgyjwd$art_c = $art_objoqhfqgnb$art_obj.length; $art_ioynpjld$art_i < $art_cttemgyjwd$art_c; $art_ioynpjld$art_i++) {
                var t = $art_objoqhfqgnb$art_obj[$art_ioynpjld$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
