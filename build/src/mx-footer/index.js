...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ivpwmv$art_i=0;$art_ivpwmv$art_i<products.length;$art_ivpwmv$art_i++){var p=products[$art_ivpwmv$art_i]%>';
        for (var $art_ivpwmv$art_i = 0; $art_ivpwmv$art_i < products.length; $art_ivpwmv$art_i++) {
            var p = products[$art_ivpwmv$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_ixgcnporgl$art_i=0,$art_objbtmtzsskm$art_obj=p.thirds;$art_ixgcnporgl$art_i<$art_objbtmtzsskm$art_obj.length;$art_ixgcnporgl$art_i++){var t=$art_objbtmtzsskm$art_obj[$art_ixgcnporgl$art_i]%>';
            for (var $art_ixgcnporgl$art_i = 0, $art_objbtmtzsskm$art_obj = p.thirds; $art_ixgcnporgl$art_i < $art_objbtmtzsskm$art_obj.length; $art_ixgcnporgl$art_i++) {
                var t = $art_objbtmtzsskm$art_obj[$art_ixgcnporgl$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
