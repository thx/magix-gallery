...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iiquanhb$art_i = 0, $art_cxequbskit$art_c = products.length; $art_iiquanhb$art_i < $art_cxequbskit$art_c; $art_iiquanhb$art_i++) {        var p = products[$art_iiquanhb$art_i]%>';
        for (var $art_iiquanhb$art_i = 0, $art_cxequbskit$art_c = products.length; $art_iiquanhb$art_i < $art_cxequbskit$art_c; $art_iiquanhb$art_i++) {
            var p = products[$art_iiquanhb$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_irkxvsv$art_i = 0, $art_objfcledxpii$art_obj = p.thirds, $art_ctyftlip$art_c = $art_objfcledxpii$art_obj.length; $art_irkxvsv$art_i < $art_ctyftlip$art_c; $art_irkxvsv$art_i++) {            var t = $art_objfcledxpii$art_obj[$art_irkxvsv$art_i]%>';
            for (var $art_irkxvsv$art_i = 0, $art_objfcledxpii$art_obj = p.thirds, $art_ctyftlip$art_c = $art_objfcledxpii$art_obj.length; $art_irkxvsv$art_i < $art_ctyftlip$art_c; $art_irkxvsv$art_i++) {
                var t = $art_objfcledxpii$art_obj[$art_irkxvsv$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
