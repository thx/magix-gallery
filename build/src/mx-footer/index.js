...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iltqtib$art_i = 0, $art_casgdzgfvyq$art_c = products.length; $art_iltqtib$art_i < $art_casgdzgfvyq$art_c; $art_iltqtib$art_i++) {        var p = products[$art_iltqtib$art_i]%>';
        for (var $art_iltqtib$art_i = 0, $art_casgdzgfvyq$art_c = products.length; $art_iltqtib$art_i < $art_casgdzgfvyq$art_c; $art_iltqtib$art_i++) {
            var p = products[$art_iltqtib$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilgqpaxe$art_i = 0, $art_objkriunlc$art_obj = p.thirds, $art_cpokwntl$art_c = $art_objkriunlc$art_obj.length; $art_ilgqpaxe$art_i < $art_cpokwntl$art_c; $art_ilgqpaxe$art_i++) {            var t = $art_objkriunlc$art_obj[$art_ilgqpaxe$art_i]%>';
            for (var $art_ilgqpaxe$art_i = 0, $art_objkriunlc$art_obj = p.thirds, $art_cpokwntl$art_c = $art_objkriunlc$art_obj.length; $art_ilgqpaxe$art_i < $art_cpokwntl$art_c; $art_ilgqpaxe$art_i++) {
                var t = $art_objkriunlc$art_obj[$art_ilgqpaxe$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
