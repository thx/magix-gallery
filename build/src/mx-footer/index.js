...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iwukeskc$art_i = 0, $art_cdxyeray$art_c = products.length; $art_iwukeskc$art_i < $art_cdxyeray$art_c; $art_iwukeskc$art_i++) {        var p = products[$art_iwukeskc$art_i]%>';
        for (var $art_iwukeskc$art_i = 0, $art_cdxyeray$art_c = products.length; $art_iwukeskc$art_i < $art_cdxyeray$art_c; $art_iwukeskc$art_i++) {
            var p = products[$art_iwukeskc$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifieunjnhg$art_i = 0, $art_objadgiyabnr$art_obj = p.thirds, $art_ctpbztg$art_c = $art_objadgiyabnr$art_obj.length; $art_ifieunjnhg$art_i < $art_ctpbztg$art_c; $art_ifieunjnhg$art_i++) {            var t = $art_objadgiyabnr$art_obj[$art_ifieunjnhg$art_i]%>';
            for (var $art_ifieunjnhg$art_i = 0, $art_objadgiyabnr$art_obj = p.thirds, $art_ctpbztg$art_c = $art_objadgiyabnr$art_obj.length; $art_ifieunjnhg$art_i < $art_ctpbztg$art_c; $art_ifieunjnhg$art_i++) {
                var t = $art_objadgiyabnr$art_obj[$art_ifieunjnhg$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
