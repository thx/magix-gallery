...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iuvbif$art_i = 0, $art_cemxqwrrmyj$art_c = products.length; $art_iuvbif$art_i < $art_cemxqwrrmyj$art_c; $art_iuvbif$art_i++) {        var p = products[$art_iuvbif$art_i]%>';
        for (var $art_iuvbif$art_i = 0, $art_cemxqwrrmyj$art_c = products.length; $art_iuvbif$art_i < $art_cemxqwrrmyj$art_c; $art_iuvbif$art_i++) {
            var p = products[$art_iuvbif$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iuttzxzcs$art_i = 0, $art_objssehcfqo$art_obj = p.thirds, $art_craawjn$art_c = $art_objssehcfqo$art_obj.length; $art_iuttzxzcs$art_i < $art_craawjn$art_c; $art_iuttzxzcs$art_i++) {            var t = $art_objssehcfqo$art_obj[$art_iuttzxzcs$art_i]%>';
            for (var $art_iuttzxzcs$art_i = 0, $art_objssehcfqo$art_obj = p.thirds, $art_craawjn$art_c = $art_objssehcfqo$art_obj.length; $art_iuttzxzcs$art_i < $art_craawjn$art_c; $art_iuttzxzcs$art_i++) {
                var t = $art_objssehcfqo$art_obj[$art_iuttzxzcs$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
