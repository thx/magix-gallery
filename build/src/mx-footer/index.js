...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_idllrecolod$art_i = 0, $art_cxctyazti$art_c = products.length; $art_idllrecolod$art_i < $art_cxctyazti$art_c; $art_idllrecolod$art_i++) {        var p = products[$art_idllrecolod$art_i]%>';
        for (var $art_idllrecolod$art_i = 0, $art_cxctyazti$art_c = products.length; $art_idllrecolod$art_i < $art_cxctyazti$art_c; $art_idllrecolod$art_i++) {
            var p = products[$art_idllrecolod$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_idbndexoj$art_i = 0, $art_objwhnqkd$art_obj = p.thirds, $art_cdzemdr$art_c = $art_objwhnqkd$art_obj.length; $art_idbndexoj$art_i < $art_cdzemdr$art_c; $art_idbndexoj$art_i++) {            var t = $art_objwhnqkd$art_obj[$art_idbndexoj$art_i]%>';
            for (var $art_idbndexoj$art_i = 0, $art_objwhnqkd$art_obj = p.thirds, $art_cdzemdr$art_c = $art_objwhnqkd$art_obj.length; $art_idbndexoj$art_i < $art_cdzemdr$art_c; $art_idbndexoj$art_i++) {
                var t = $art_objwhnqkd$art_obj[$art_idbndexoj$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
