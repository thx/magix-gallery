...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_idlwqnlows$art_i = 0, $art_czqfxzaieq$art_c = products.length; $art_idlwqnlows$art_i < $art_czqfxzaieq$art_c; $art_idlwqnlows$art_i++) {        var p = products[$art_idlwqnlows$art_i]%>';
        for (var $art_idlwqnlows$art_i = 0, $art_czqfxzaieq$art_c = products.length; $art_idlwqnlows$art_i < $art_czqfxzaieq$art_c; $art_idlwqnlows$art_i++) {
            var p = products[$art_idlwqnlows$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_invjgdf$art_i = 0, $art_objkfzkjglhu$art_obj = p.thirds, $art_cudkikwsjj$art_c = $art_objkfzkjglhu$art_obj.length; $art_invjgdf$art_i < $art_cudkikwsjj$art_c; $art_invjgdf$art_i++) {            var t = $art_objkfzkjglhu$art_obj[$art_invjgdf$art_i]%>';
            for (var $art_invjgdf$art_i = 0, $art_objkfzkjglhu$art_obj = p.thirds, $art_cudkikwsjj$art_c = $art_objkfzkjglhu$art_obj.length; $art_invjgdf$art_i < $art_cudkikwsjj$art_c; $art_invjgdf$art_i++) {
                var t = $art_objkfzkjglhu$art_obj[$art_invjgdf$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
