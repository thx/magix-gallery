...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_iwwmlaatn$art_i = 0, $art_cqxvoi$art_c = products.length; $art_iwwmlaatn$art_i < $art_cqxvoi$art_c; $art_iwwmlaatn$art_i++) {        var p = products[$art_iwwmlaatn$art_i]%>';
        for (var $art_iwwmlaatn$art_i = 0, $art_cqxvoi$art_c = products.length; $art_iwwmlaatn$art_i < $art_cqxvoi$art_c; $art_iwwmlaatn$art_i++) {
            var p = products[$art_iwwmlaatn$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqjndhrg$art_i = 0, $art_objxrcvbtq$art_obj = p.thirds, $art_cvuirlsu$art_c = $art_objxrcvbtq$art_obj.length; $art_iqjndhrg$art_i < $art_cvuirlsu$art_c; $art_iqjndhrg$art_i++) {            var t = $art_objxrcvbtq$art_obj[$art_iqjndhrg$art_i]%>';
            for (var $art_iqjndhrg$art_i = 0, $art_objxrcvbtq$art_obj = p.thirds, $art_cvuirlsu$art_c = $art_objxrcvbtq$art_obj.length; $art_iqjndhrg$art_i < $art_cvuirlsu$art_c; $art_iqjndhrg$art_i++) {
                var t = $art_objxrcvbtq$art_obj[$art_iqjndhrg$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
