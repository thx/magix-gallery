...
module.exports = Magix.View.extend({
    ...
    if (len > 0) {
        ...
        ;
        $expr = '<%for (var $art_icoald$art_i = 0, $art_cysximoxyctb$art_c = products.length; $art_icoald$art_i < $art_cysximoxyctb$art_c; $art_icoald$art_i++) {        var p = products[$art_icoald$art_i]%>';
        for (var $art_icoald$art_i = 0, $art_cysximoxyctb$art_c = products.length; $art_icoald$art_i < $art_cysximoxyctb$art_c; $art_icoald$art_i++) {
            var p = products[$art_icoald$art_i];
            $p += '<dl style="width: ';
            $line = 9;
            $art = '=(100 / len)';
            ;
            ...
            ;
            $expr = '<%for (var $art_irtikdmjqm$art_i = 0, $art_objbdgjziyqk$art_obj = p.thirds, $art_cgjvfyara$art_c = $art_objbdgjziyqk$art_obj.length; $art_irtikdmjqm$art_i < $art_cgjvfyara$art_c; $art_irtikdmjqm$art_i++) {            var t = $art_objbdgjziyqk$art_obj[$art_irtikdmjqm$art_i]%>';
            for (var $art_irtikdmjqm$art_i = 0, $art_objbdgjziyqk$art_obj = p.thirds, $art_cgjvfyara$art_c = $art_objbdgjziyqk$art_obj.length; $art_irtikdmjqm$art_i < $art_cgjvfyara$art_c; $art_irtikdmjqm$art_i++) {
                var t = $art_objbdgjziyqk$art_obj[$art_irtikdmjqm$art_i];
                $p += '<dd><a href="';
                $line = 13;
                $art = '=t.link';
                ;
