...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '>&#xe605;</i></div></div><div mxv mxa="_zs_galleryea:d" class="_zs_gallery_mx-time_content_-group" style="flex: 0 0 52px;"><div mxv mxa="_zs_galleryea:e" class="mb5"><input class="input _zs_gallery_mx-time_content_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 29;
    ...
    ;
    $p += '>&#xe605;</i></div></div><div mxv mxa="_zs_galleryea:f" class="_zs_gallery_mx-time_content_-group" style="flex: 0 0 52px;"><div mxv mxa="_zs_galleryea:g" class="mb5"><input class="input _zs_gallery_mx-time_content_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 46;
