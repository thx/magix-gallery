...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '>&#xe605;</i></div></div><div mxv mxa="_zs_galleryee:d" class="_zs_gallery_mx-time_content_-group" style="flex: 0 0 52px;"><div mxv mxa="_zs_galleryee:e" class="mb5"><input class="input _zs_gallery_mx-time_content_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 29;
    ...
    ;
    $p += '>&#xe605;</i></div></div><div mxv mxa="_zs_galleryee:f" class="_zs_gallery_mx-time_content_-group" style="flex: 0 0 52px;"><div mxv mxa="_zs_galleryee:g" class="mb5"><input class="input _zs_gallery_mx-time_content_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 46;
