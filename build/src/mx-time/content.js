...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeT:_" class="clearfix pr"><div mxs="_zs_galleryeT:_" class="clearfix _zs_gallery_mx-calendar_index_-sps"><div class="_zs_gallery_mx-calendar_index_-sp _zs_gallery_mx-calendar_index_-spa">:</div><div class="_zs_gallery_mx-calendar_index_-sp _zs_gallery_mx-calendar_index_-spb">:</div></div><div mxv mxa="_zs_galleryeT:a" class="_zs_gallery_mx-calendar_index_-groups"><div mxv mxa="_zs_galleryeT:b" class="_zs_gallery_mx-calendar_index_-group"><div mxv mxa="_zs_galleryeT:c" class="mb5"><input class="input _zs_gallery_mx-calendar_index_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 12;
    ...
    ;
    $p += '>&#xeb78;</i></div></div><div mxv mxa="_zs_galleryeT:d" class="_zs_gallery_mx-calendar_index_-group"><div mxv mxa="_zs_galleryeT:e" class="mb5"><input class="input _zs_gallery_mx-calendar_index_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 29;
    ...
    ;
    $p += '>&#xeb78;</i></div></div><div mxv mxa="_zs_galleryeT:f" class="_zs_gallery_mx-calendar_index_-group"><div mxv mxa="_zs_galleryeT:g" class="mb5"><input class="input _zs_gallery_mx-calendar_index_-ipt" maxlength="2" autocomplete="off" value="';
    $line = 46;
