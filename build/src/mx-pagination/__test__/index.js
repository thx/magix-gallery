...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybJ:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'完整示例\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'精简版\',\n            key: viewId + \'_demo2\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"><div mxa="_zs_gallerybJ:a" class="_zs_gallery___test___layout_-eg-content clearfix"><div mxa="_zs_gallerybJ:b" class="mb20"><span mxs="_zs_gallerybJ:_" class="color-9">当前页数：</span><span mxa="_zs_gallerybJ:c" class="mr20">';
    $line = 22;
    $art = '=page';
    ;
    $p += '' + ($expr = '<%=page%>', $e(page)) + '</span><span mxs="_zs_gallerybJ:a" class="color-9">每页展示：</span><span>';
    $line = 24;
    $art = '=size';
    ;
    ...
    $art = '=page';
    ;
    $p += '' + ($expr = '<%!$eu(page)%>', $eu(page)) + '"></div></div><div mxa="_zs_gallerybJ:d" class="clearfix"><div mxa="_zs_gallerybJ:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerybJ:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 38;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_text_2">\n    let Magix = require(\'magix\');\n    let $ = require(\'$\');\n    \n    module.exports = Magix.View.extend(&#123;\n        tmpl: \'@index.html\',\n        render() &#123;\n            this.updater.digest(&#123;\n                page: 1,\n                size: 40\n            &#125;);\n        &#125;,\n        \'change&lt;change&gt;\' (e) &#123;\n            // e.page 当前第几页\n            // e.size 每页多少条\n            this.updater.digest(&#123;\n                page: e.page,\n                size: e.size\n            &#125;)\n        &#125;\n    &#125;);</pre></div></div></div><div mxs="_zs_gallerybJ:e" mx-view="mx-pagination/__test__/1"></div><div class="clearfix mb20" id="';
    $line = 85;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"><div mxs="_zs_gallerybJ:f" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/2"></div><div mx-view="mx-pagination/__test__/4"></div></div><div mxs="_zs_gallerybJ:g" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/3"></div></div></div><div id="';
    $line = 95;
    $art = '=viewId';
    ;
