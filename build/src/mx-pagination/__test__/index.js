...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_2">\n    let Magix = require(\'magix\');\n    let $ = require(\'$\');\n    \n    module.exports = Magix.View.extend(&#123;\n        tmpl: \'@index.html\',\n        render() &#123;\n            this.updater.digest(&#123;\n                page: 1,\n                size: 40\n            &#125;);\n        &#125;,\n        \'change&lt;change&gt;\' (e) &#123;\n            // e.page 当前第几页\n            // e.size 每页多少条\n            this.updater.digest(&#123;\n                page: e.page,\n                size: e.size\n            &#125;)\n        &#125;\n    &#125;);</pre></div></div></div><div mxs="_zs_galleryb%:e" mx-view="mx-pagination/__test__/1"></div><div class="clearfix mb20" id="';
    $line = 85;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"><div mxs="_zs_galleryb%:f" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/2"></div><div mx-view="mx-pagination/__test__/4"></div></div><div mxs="_zs_galleryb%:g" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/3"></div></div></div><div id="';
    $line = 95;
    $art = '=viewId';
    ;
