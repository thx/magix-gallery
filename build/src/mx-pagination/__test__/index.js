...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"><div mxa="_zs_galleryc,:a" class="_zs_gallery___test___layout_-eg-content clearfix"><div mxa="_zs_galleryc,:b" class="mb20"><span mxs="_zs_galleryc,:_" class="color-9">当前页数：</span><span mxa="_zs_galleryc,:c" class="mr20">';
    $line = 37;
    $art = '=page';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxa="_zs_galleryc,:i" class="clearfix mb20"><div mxa="_zs_galleryc,:j" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/2" id="';
    $line = 103;
    $art = '=viewId';
    ;
