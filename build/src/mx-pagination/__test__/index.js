...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"><div mxa="_zs_gallerycH:a" class="_zs_gallery___test___layout_-eg-content clearfix"><div mxa="_zs_gallerycH:b" class="mb20"><span mxs="_zs_gallerycH:_" class="color-9">当前页数：</span><span mxa="_zs_gallerycH:c" class="mr20">';
    $line = 34;
    $art = '=page';
    ;
    $p += ($expr = '<%=page%>', $e(page)) + '</span><span mxs="_zs_gallerycH:a" class="color-9">每页展示：</span><span>';
    $line = 36;
    $art = '=size';
    ;
    ...
    $art = '=page';
    ;
    $p += ($expr = '<%!$eu(page)%>', $eu(page)) + '"></div></div><div mxa="_zs_gallerycH:d" class="clearfix"><div mxa="_zs_gallerycH:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerycH:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 50;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_2">\nlet Magix = require(\'magix\');\nlet $ = require(\'$\');\n\nmodule.exports = Magix.View.extend(&#123;\n    tmpl: \'@index.html\',\n    render() &#123;\n        this.updater.digest(&#123;\n            page: 1,\n            size: 40\n        &#125;);\n    &#125;,\n    \'change&lt;change&gt;\' (e) &#123;\n        // e.page 当前第几页\n        // e.size 每页多少条\n        // e.offset 偏移量\n        this.updater.digest(&#123;\n            page: e.page,\n            size: e.size\n        &#125;)\n    &#125;\n&#125;);\n                </pre></div></div></div><div mxs="_zs_gallerycH:e" mx-view="mx-pagination/__test__/1"></div><div mxa="_zs_gallerycH:i" class="clearfix mb20"><div mxa="_zs_gallerycH:j" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/2" id="';
    $line = 102;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_gallerycH:k" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/3" id="';
    $line = 106;
    $art = '=viewId';
    ;
