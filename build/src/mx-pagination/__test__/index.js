...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc3:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'完整示例\',\n            key: viewId + \'_demo6\'\n        },{\n            name: \'禁止修改页数\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'精简版\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'顺序翻页\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'居中显示\',\n            key: viewId + \'_demo4\'\n        },{\n            name: \'offset\',\n            key: viewId + \'_demo5\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"><div mxa="_zs_galleryc3:a" class="_zs_gallery___test___layout_-eg-content clearfix"><div mxa="_zs_galleryc3:b" class="mb20"><span mxs="_zs_galleryc3:_" class="color-9">当前页数：</span><span mxa="_zs_galleryc3:c" class="mr20">';
    $line = 37;
    $art = '=page';
    ;
    $p += ($expr = '<%=page%>', $e(page)) + '</span><span mxs="_zs_galleryc3:a" class="color-9">每页展示：</span><span>';
    $line = 39;
    $art = '=size';
    ;
    ...
    $art = '=page';
    ;
    $p += ($expr = '<%!$eu(page)%>', $eu(page)) + '"></div></div><div mxa="_zs_galleryc3:d" class="clearfix"><div mxa="_zs_galleryc3:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryc3:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 52;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxa="_zs_galleryc3:i" class="clearfix mb20"><div mxa="_zs_galleryc3:j" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/2" id="';
    $line = 103;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_galleryc3:k" class="_zs_gallery___test___layout_-half"><div mx-view="mx-pagination/__test__/3" id="';
    $line = 107;
    $art = '=viewId';
    ;
