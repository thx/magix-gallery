...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryeW:a" class="clearfix"><div mxa="_zs_galleryeW:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-title/__test__/2" id="';
    $line = 29;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_galleryeW:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-title/__test__/4" id="';
    $line = 33;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div></div></div><div mxa="_zs_galleryeW:d" class="mb20"><div mx-view="mx-title/__test__/1" id="';
    $line = 38;
    $art = '=viewId';
    ;
