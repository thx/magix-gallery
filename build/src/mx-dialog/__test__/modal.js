...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo9"></div><div mxa="_zs_galleryaM:a" class="clearfix mb20"><div mxa="_zs_galleryaM:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-dialog/__test__/10" id="';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo10"></div></div><div mxa="_zs_galleryaM:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-dialog/__test__/11" id="';
    $line = 30;
    $art = '=viewId';
    ;
