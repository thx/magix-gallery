...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaH:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaH:a" class="_zs_gallery___test___layout_-eg-content"><a href="javascript:;" class="btn btn-brand mr20" id="';
    $line = 4;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_test" mx-click="' + $viewId + 'open1()">当前节点下居中</a><a mxs="_zs_galleryaH:_" href="javascript:;" class="btn btn-brand mr20" mx-click="' + $viewId + 'open2()">当前节点下居中 + 偏移</a></div><div mxa="_zs_galleryaH:b" class="clearfix"><div mxa="_zs_galleryaH:c" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryaH:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 13;
    $art = '=viewId';
    ;
