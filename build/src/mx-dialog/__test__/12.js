...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaw:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaw:a" class="_zs_gallery___test___layout_-eg-content"><a href="javascript:;" class="btn btn-brand mr20" id="';
    $line = 4;
    $art = '=viewId';
    ;
