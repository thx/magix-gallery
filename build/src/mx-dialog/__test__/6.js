...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaL:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_galleryaL:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb20"><span class="color-9">展示优先级：</span>外部自定义属性 > 浮层内属性 > 默认属性</div><div><a href="javascript:;" mx-click="' + $viewId + 'open1()" class="btn btn-brand mr20">使用浮层内配置的属性</a><a href="javascript:;" mx-click="' + $viewId + 'open2()" class="btn btn-brand">自定义属性</a></div></div><div mxa="_zs_galleryaL:a" class="clearfix"><div mxa="_zs_galleryaL:b" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-left"><div mxs="_zs_galleryaL:a" class="_zs_gallery___test___layout_-eg-title">浮层本身写法</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:3})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_3"><span mxa="_zs_galleryaL:c" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 20;
    $art = '!text3';
    ;
    $p += ($expr = '<%!text3%>', $n(text3)) + '</span><i mxs="_zs_galleryaL:b" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 23;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_3">\nlet Magix = require(\'magix\');\n\nmodule.exports = Magix.View.extend(&#123;\n    tmpl: \'@inner.html\',\n    init(e) &#123;\n        this.viewOptions = e;\n    &#125;,\n    render() &#123;\n        this.updater.digest();\n    &#125;,\n    \'cancel&lt;click&gt;\'(event) &#123;\n        event.preventDefault();\n        let viewOptions = this.viewOptions;\n        if (viewOptions.dialog) &#123;\n            viewOptions.dialog.close();\n        &#125;\n    &#125;\n&#125;, &#123;\n    dialogOptions: &#123;\n        top: 0,\n        width: 800\n    &#125;\n&#125;);\n            </pre></div><div mxa="_zs_galleryaL:d" class="_zs_gallery___test___layout_-half"><div mxa="_zs_galleryaL:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaL:c" class="_zs_gallery___test___layout_-eg-title">使用浮层内配置的属性</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 52;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n\'open&lt;click&gt;\'(e) &#123;\n    this.mxDialog(\'@./inner\');\n&#125;\n                </pre></div><div mxa="_zs_galleryaL:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaL:d" class="_zs_gallery___test___layout_-eg-title">自定义属性</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 65;
    $art = '=viewId';
    ;
