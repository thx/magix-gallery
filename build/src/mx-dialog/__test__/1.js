...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery@:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallery@:_" class="_zs_gallery___test___base_-eg-content"><div class="color-9 mb20"><i class="mc-iconfont displacement-2 mr5">&#xe6ac;</i>提示浮层，默认无mask，宽度320，居中显示</div><div><a href="javascript:;" mx-click="' + $viewId + 'alert1()" class="btn btn-brand">默认alert</a><a href="javascript:;" mx-click="' + $viewId + 'alert2()" class="btn btn-brand ml20">自定义alert样式</a><a href="javascript:;" mx-click="' + $viewId + 'alert3()" class="btn btn-brand ml20">无关闭按钮</a></div></div><div mxa="_zs_gallery@:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallery@:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;a href="javascript:;" mx-click="alert1()" \n    class="btn btn-brand"&gt;默认alert&lt;/a&gt;\n\n&lt;a href="javascript:;" mx-click="alert2()" \n    class="btn btn-brand"&gt;自定义alert样式&lt;/a&gt;\n\n&lt;a href="javascript:;" mx-click="alert3()" \n    class="btn btn-brand"&gt;无关闭按钮&lt;/a&gt;</pre></div><div mxa="_zs_gallery@:c" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallery@:c" class="_zs_gallery___test___base_-eg-title">JS Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 37;
    $art = '=viewId';
    ;
