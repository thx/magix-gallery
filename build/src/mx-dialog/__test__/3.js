...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya_:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerya_:_" class="_zs_gallery___test___layout_-eg-content"><div class="color-9 mb20"><i class="mc-iconfont displacement-2 mr5">&#xe6ac;</i>将dialog的方法mixins到view上</div><div><a href="javascript:;" mx-click="' + $viewId + 'open()" class="btn btn-brand">可打开多个浮层</a></div></div><div mxa="_zs_gallerya_:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya_:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;a href="javascript:;" mx-click="open()" \n    class="btn btn-brand"&gt;可打开多个浮层&lt;/a&gt;</pre></div><div mxa="_zs_gallerya_:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya_:c" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
