...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery-:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallery-:_" class="_zs_gallery___test___layout_-eg-content"><div class="color-9 mb20"><i class="mc-iconfont displacement-2 mr5">&#xe6ac;</i>将dialog的方法mixins到view上</div><div><a href="javascript:;" mx-click="' + $viewId + 'open()" class="btn btn-brand mr20">可打开多个浮层</a><a href="javascript:;" class="btn btn-brand mr20">关闭所有浮层</a><a href="javascript:;" mx-click="' + $viewId + 'alert1()" class="btn btn-brand">mask=false的浮层，点击空白处自动关闭浮层</a></div></div><div mxa="_zs_gallery-:a" class="clearfix"><div mxa="_zs_gallery-:b" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallery-:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 21;
    $art = '=viewId';
    ;
