...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_galleryao:_" class="dialog-header"><span class="fontsize-16">多个带modal的浮层</span></div><div class="dialog-body" style="height:';
    $line = 4;
    $art = '=height';
    ;
    $p += ($expr = '<%=height%>', $e(height)) + 'px;"><div mxa="_zs_galleryao:_" class="mb20">浮层';
    $line = 5;
    $art = '=number';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '</div><div mxs="_zs_galleryao:a" class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'modal()" class="btn btn-brand">再开一个</a></div><div mxs="_zs_galleryao:b"><a href="javascript:;" mx-click="' + $viewId + 'closeAll()" class="btn btn-brand">关闭所有展开浮层</a></div></div><div mxs="_zs_galleryao:c" class="dialog-footer"><a href="javascript:;" class="btn mr10" mx-click="' + $viewId + 'cancel()">取消</a></div>';
}
catch (ex) {
