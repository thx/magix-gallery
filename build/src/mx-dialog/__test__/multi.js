...
module.exports = Magix.View.extend({
    ...
    $art = '=height';
    ;
    $p += '' + ($expr = '<%=height%>', $e(height)) + 'px;"><span mxa="_zs_galleryac:_" class="mr40">浮层';
    $line = 5;
    $art = '=number';
    ;
    $p += '' + ($expr = '<%=number%>', $e(number)) + '</span><a mxs="_zs_galleryac:a" href="javascript:;" mx-click="' + $viewId + 'modal()" class="btn btn-brand">再开一个</a></div><div mxs="_zs_galleryac:b" class="dialog-footer"><a href="javascript:;" class="btn mr10" mx-click="' + $viewId + 'cancel()">取消</a></div>';
}
catch (ex) {
