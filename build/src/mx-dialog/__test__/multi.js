...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_galleryaa:_" class="dialog-header"><span class="fontsize-16">多个带modal的浮层</span></div><div class="dialog-body" style="height:';
    $line = 4;
    $art = '=height';
    ;
    $p += '' + ($expr = '<%=height%>', $e(height)) + 'px;"><span mxa="_zs_galleryaa:_" class="mr40">浮层';
    $line = 5;
    $art = '=number';
    ;
    $p += '' + ($expr = '<%=number%>', $e(number)) + '</span><a mxs="_zs_galleryaa:a" href="javascript:;" mx-click="' + $viewId + 'modal()" class="btn btn-brand">再开一个</a></div><div mxs="_zs_galleryaa:b" class="dialog-footer"><a href="javascript:;" class="btn mr10" mx-click="' + $viewId + 'cancel()">取消</a></div>';
}
catch (ex) {
