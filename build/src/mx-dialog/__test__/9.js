...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;a href="javascript:;" mx-click="open()" \n    class="btn btn-brand"&gt;全屏右出浮层(头部+底部)&lt;/a&gt;  \n            </pre></div><div mxa="_zs_galleryaz:f" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-right"><div mxs="_zs_galleryaz:e" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 79;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_2">\nlet Magix = require(\'magix\');\nlet Dialog = require(\'@../index\'); //mixins dialog\nlet $ = require(\'$\');\n\nmodule.exports = Magix.View.extend(&#123;\n    tmpl: \'@index.html\',\n    mixins: [Dialog],\n    render() {\n        this.updater.digest();\n    },\n    \'open&lt;click&gt;\'(e) &#123;\n        // this.mxModal(viewPath[string], viewOptions[object], dialogOptions[object])\n        //      viewPath: \'dialog view路径\'\n        //      viewOptions: &#123;\n        //          传入dialog的数据，挂载当前dialog实体\n        //      &#125;\n        //      dialogOptions: &#123; //浮层样式覆盖\n        //          width:\'宽度，默认600\',\n        //          mask: \'true or false，是否有遮罩\',\n        //          closable: \'true or false，是否有右上角关闭按钮\'\n        //          header: &#123;\n        //              title: \'标题\',\n        //              tip: \'提示信息\',\n        //              iconTip: \'提示信息展示类型，=icon时小icon提示，否则直接展示\'\n        //          &#125;,\n        //          footer: &#123;\n        //              enter: \'true or false，是否需要确定按钮\',\n        //              enterText: \'确定按钮文案\',\n        //              cancel: \'true or false，是否需要取消按钮\',\n        //              cancelText: \'取消按钮文案\'\n        //          &#125;\n        // \n        //          ==========================================\n        //          无效参数：\n        //          height:\'高度固定全屏\',\n        //          left: \'固定为doc.width - width\',\n        //          top: \'固定为0\',\n        //          modal: \'固定为false，禁止滚动\',\n        //      &#125;\n        this.mxModal(\'@./full\', &#123;\n            callback: (data) =&gt; &#123;\n                that.updater.digest(&#123;\n                    text: data.name\n                &#125;)\n            &#125;\n        &#125;, &#123;\n            width: 800,\n            header: &#123;\n                title: \'全屏右出浮层\',\n                tip: \'提示信息\',\n                iconTip: \'icon提示\'\n            &#125;,\n            footer: &#123;\n                enterText: \'自定义确认\',\n                cancelText: \'自定义取消\'\n            &#125;\n        &#125;);\n    &#125;\n&#125;);</pre></div></div><div mxa="_zs_galleryaz:h" class="clearfix"><div mxa="_zs_galleryaz:i" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryaz:f" class="_zs_gallery___test___layout_-eg-title">浮层内HTML</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:4})" mx-view="mx-copy/index?copyNode=';
    $line = 149;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_4"><span mxa="_zs_galleryaz:j" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 151;
    $art = '!text4';
    ;
    $p += ($expr = '<%!text4%>', $n(text4)) + '</span><i mxs="_zs_galleryaz:d" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 154;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_4">\n&lt;form class="grid"&gt;\n    &lt;mx-grid.content&gt;\n        &lt;span class="color-9 mr10"&gt;必填项：&lt;/span&gt;\n        &lt;input class="input" placeholder="必填项" \n            value="&#123;&#123;:name&#123;required:true&#125;&#125;&#125;"/&gt;\n    &lt;/mx-grid.content&gt;\n&lt;/form&gt;\n            </pre></div><div mxa="_zs_galleryaz:k" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-right"><div mxs="_zs_galleryaz:g" class="_zs_gallery___test___layout_-eg-title">浮层内JS</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:5})" mx-view="mx-copy/index?copyNode=';
    $line = 166;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_5"><span mxa="_zs_galleryaz:l" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 168;
    $art = '!text5';
    ;
    $p += ($expr = '<%!text5%>', $n(text5)) + '</span><i mxs="_zs_galleryaz:d" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 171;
    $art = '=viewId';
    ;
