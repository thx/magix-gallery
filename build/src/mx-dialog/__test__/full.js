...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '<div mxa="_zs_galleryaO:b" class="clearfix grid mb16" style="padding: 16px 24px;"><div mxs="_zs_galleryaO:a" class="mb10">浮层HTML Code：</div>';
    $line = 13;
    $art = 'if readonly';
    ;
    $expr = '<%if (readonly) {%>';
    ...
    ;
    $p += '</div><div mxs="_zs_galleryaO:d" class="clearfix grid" style="padding: 16px 24px;"><div class="mb10">浮层JS Code：</div><pre class="tip-content">\nlet Magix = require(\'magix\');\n\nmodule.exports = Magix.View.extend(&#123;\n    tmpl: \'@index.html\',\n    render() &#123;\n        this.updater.digest();\n    &#125;,\n    check() &#123;\n        let that = this;\n        let ok = that.isValid();\n        let name = \'\';\n        if(ok)&#123;\n            name = that.updater.get(\'name\');\n        &#125;\n        return new Promise((resolve) =&gt; &#123;\n            setTimeout(() =&gt; &#123;\n                resolve(&#123;\n                    ok,\n                    data: &#123;\n                        name\n                    &#125;,\n                    msg: \'请按照要求填写完信息再提交\'\n                &#125;)\n            &#125;, 1000)\n        &#125;)\n    &#125;\n&#125;, &#123;\n    dialogOptions: &#123;\n        width: 1000\n    &#125;\n&#125;);\n    </pre></div>';
}
catch (ex) {
