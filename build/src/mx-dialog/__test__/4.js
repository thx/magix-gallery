...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryae:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_galleryae:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb20 clearfix"><div class="color-9 fl">内容分组：</div><div class="fl"><div>mixins到view上，this.mxDialogGroup()</div><div>默认mask，宽度800，高度500，居中显示</div></div></div><div><a href="javascript:;" mx-click="' + $viewId + 'showGroup()" class="btn btn-brand">内容分组显示的浮层</a></div></div><div mxa="_zs_galleryae:a" class="clearfix"><div mxa="_zs_galleryae:b" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_galleryae:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
