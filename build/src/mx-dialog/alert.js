...
module.exports = Magix.View.extend({
    ...
    if (hasBtns) {
        ;
        $p += '<div mxa="_zs_galleryam:c" class="dialog-footer"><a mxa="_zs_galleryam:d" href="javascript:;" class="btn btn-small btn-brand min-width-50" mx-click="' + $viewId + '@{enter}();">' + ($expr = '<%=enterText%>', $e(enterText)) + '</a></div>';
        $line = 9;
        $art = '/if';
        ;
        $expr = '<%}%>';
