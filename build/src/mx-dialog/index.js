...
module.exports = Magix.View.extend({
    ...
    if (full) {
        ...
        if (fullFooter.enter || fullFooter.cancel) {
            ...
            if (fullFooter.enter) {
                ;
                $p += '<a mxa="_zs_galleryaO:b" href="javascript:;" class="fl btn btn-brand min-width-60 mr10 _zs_gallery_mx-dialog_index_-btn-submit" mx-click="' + $viewId + '@{submit}()"><span mxa="_zs_galleryaO:c" class="_zs_gallery_mx-dialog_index_-submit-text">';
                $line = 36;
            ...
            if (fullFooter.cancel) {
                ;
                $p += '<a mxa="_zs_galleryaO:d" href="javascript:;" class="fl btn min-width-60 mr10" mx-click="' + $viewId + '@{close}()">';
                $line = 41;
