...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '<div class="_zs_gallery_mx-dialog_index_-dialog-content" id="cnt_' + ($expr = '<%=viewId%>', $e(viewId)) + '"><div mxs="_zs_galleryag:a" class="loading _zs_gallery_mx-dialog_index_-loading-ext"><span class="loading-anim"></span></div></div>';
}
catch (ex) {
