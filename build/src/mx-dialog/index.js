...
module.exports = Magix.View.extend({
    ...
    if (closable) {
        ;
        $p += '<a mxs="_zs_galleryaf:_" href="javascript:;" mx-click="' + $viewId + '@{close}()" class="_zs_gallery_mx-dialog_index_-dialog-close"><i class="mc-iconfont _zs_gallery_mx-dialog_index_-iconfont-ext">&#xe603;</i></a>';
        $line = 5;
        $art = '/if';
        ;
        $p += '';
    ...
    ;
    $p += '<div class="_zs_gallery_mx-dialog_index_-dialog-content" id="cnt_' + ($expr = '<%=viewId%>', $e(viewId)) + '"><div mxs="_zs_galleryaf:a" class="loading _zs_gallery_mx-dialog_index_-loading-ext"><span class="loading-anim"></span></div></div>';
}
catch (ex) {
