...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaL:_" class="_zs_gallery_mx-dialog_group_-help"><div mxa="_zs_galleryaL:a" class="_zs_gallery_mx-dialog_group_-help-navs">';
    $line = 3;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_caodfhuvfqq$art_c = list.length; index < $art_caodfhuvfqq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_caodfhuvfqq$art_c = list.length; index < $art_caodfhuvfqq$art_c; index++) {
        var item = list[index];
