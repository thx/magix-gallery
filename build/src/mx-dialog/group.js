...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryag:_" class="_zs_gallery_mx-dialog_group_-help"><div mxa="_zs_galleryag:a" class="_zs_gallery_mx-dialog_group_-help-navs">';
    $line = 3;
    $art = 'each list as item index';
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_cwnddbrwb$art_c = list.length; index < $art_cwnddbrwb$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cwnddbrwb$art_c = list.length; index < $art_cwnddbrwb$art_c; index++) {
        var item = list[index];
