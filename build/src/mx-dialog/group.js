...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cyfhuauq$art_c = list.length; index < $art_cyfhuauq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cyfhuauq$art_c = list.length; index < $art_cyfhuauq$art_c; index++) {
        var item = list[index];
