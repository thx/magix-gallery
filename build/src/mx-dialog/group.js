...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya_:_" class="_zs_gallery_mx-dialog_group_-help"><div mxa="_zs_gallerya_:a" class="_zs_gallery_mx-dialog_group_-help-navs">';
    $line = 3;
    $art = 'each list as item index';
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_ceyqmsyaektl$art_c = list.length; index < $art_ceyqmsyaektl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ceyqmsyaektl$art_c = list.length; index < $art_ceyqmsyaektl$art_c; index++) {
        var item = list[index];
