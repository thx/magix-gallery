...
var Tmpl = function ($$, $viewId, $$ref, $e, $n, $eu, $i, $eq) { if (!$$ref)
    ...
    $art = '=id';
    ;
    $p += '' + ($expr = '<%=id%>', $e(id)) + '" class="_zs_gallery_mx-loading_index_-full-loading"><div mxs="_zs_gallerybp:_" class="loading _zs_gallery_mx-loading_index_-loading-overwite"><span class="loading-anim"></span></div></div>';
}
catch (ex) {
