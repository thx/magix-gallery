...
module.exports = Magix.View.extend({
    ...
    if (mode == 'rectangle') {
        ;
        $p += '<div mxa="_zs_gallerybT:_" class="_zs_gallery_mx-loading_anim_-rectangle"><div class="_zs_gallery_mx-loading_anim_-rect rect1 ';
        $line = 11;
        $art = '=classNames';
        ;
        $p += ($expr = '<%=classNames%>', $e(classNames)) + '" style="';
    ...
    if (mode == 'dots') {
        ;
        $p += '<div mxa="_zs_gallerybT:a" class="_zs_gallery_mx-loading_anim_-dots"><div class="_zs_gallery_mx-loading_anim_-dot1 ';
        $line = 27;
        $art = '=classNames';
        ;
        $p += ($expr = '<%=classNames%>', $e(classNames)) + '" style="';
    ...
    if (mode == 'circle-spinner') {
        ;
        $p += '<div mxa="_zs_gallerybT:b" class="_zs_gallery_mx-loading_anim_-circle-spinner"><div mxa="_zs_gallerybT:c" class="_zs_gallery_mx-loading_anim_-spinner-container _zs_gallery_mx-loading_anim_-container1"><div class="_zs_gallery_mx-loading_anim_-spinner-circle _zs_gallery_mx-loading_anim_-circle1 ';
        $line = 39;
        $art = '=classNames';
        ;
        $p += ($expr = '<%=classNames%>', $e(classNames)) + '" style="';
        ...
        $art = '=styles';
        ;
        $p += ($expr = '<%=styles%>', $e(styles)) + '"></div></div><div mxa="_zs_gallerybT:d" class="_zs_gallery_mx-loading_anim_-spinner-container _zs_gallery_mx-loading_anim_-container2"><div class="_zs_gallery_mx-loading_anim_-spinner-circle _zs_gallery_mx-loading_anim_-circle1 ';
        $line = 45;
        $art = '=classNames';
        ;
        $p += ($expr = '<%=classNames%>', $e(classNames)) + '" style="';
        ...
        $art = '=styles';
        ;
        $p += ($expr = '<%=styles%>', $e(styles)) + '"></div></div><div mxa="_zs_gallerybT:e" class="_zs_gallery_mx-loading_anim_-spinner-container _zs_gallery_mx-loading_anim_-container3"><div class="_zs_gallery_mx-loading_anim_-spinner-circle _zs_gallery_mx-loading_anim_-circle1 ';
        $line = 51;
        $art = '=classNames';
        ;
        $p += ($expr = '<%=classNames%>', $e(classNames)) + '" style="';
