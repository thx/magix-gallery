...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycm:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerycm:_" class="_zs_gallery___test___layout_-eg-content clearfix"><div class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div><div class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div><div class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div><div class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div><div mxa="_zs_gallerycm:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycm:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
