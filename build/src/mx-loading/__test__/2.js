...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya,:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallerya,:_" class="_zs_gallery___test___base_-eg-content"><a href="javascript:;" mx-click="' + $viewId + 'show()" class="btn btn-brand mr20">打开</a><a href="javascript:;" mx-click="' + $viewId + 'hide()" class="btn">关闭</a></div><div mxa="_zs_gallerya,:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerya,:a" class="_zs_gallery___test___base_-eg-title">JS Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 8;
    $art = '=viewId';
    ;
