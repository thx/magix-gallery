...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybS:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'手动加载\',\n        key: viewId + \'_custom\',\n        subs: [{\n            name: \'非全屏自动关\',\n            key: viewId + \'_custom1\'\n        },{\n            name: \'全屏自动关\',\n            key: viewId + \'_custom2\'\n        },{\n            name: \'手动关闭\',\n            key: viewId + \'_custom3\'\n        }]\n    }, {\n        name: \'loading动画\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'circle-spinner\',\n            key: viewId + \'_demo11\'\n        },{\n            name: \'three-bounce\',\n            key: viewId + \'_demo10\'\n        },{\n            name: \'rectangle\',\n            key: viewId + \'_demo6\'\n        },{\n            name: \'double-bounce\',\n            key: viewId + \'_demo5\'\n        },{\n            name: \'square\',\n            key: viewId + \'_demo4\'\n        },{\n            name: \'cubes\',\n            key: viewId + \'_demo7\'\n        },{\n            name: \'pulse\',\n            key: viewId + \'_demo8\'\n        },{\n            name: \'dots\',\n            key: viewId + \'_demo9\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_custom" mx-view="mx-title/second?content=%E6%89%8B%E5%8A%A8%E5%8A%A0%E8%BD%BD"></div><div mxa="_zs_gallerybS:a" class="clearfix mb20"><div mxa="_zs_gallerybS:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/1" id="';
    $line = 51;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_custom2"></div></div><div mxa="_zs_gallerybS:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/3" id="';
    $line = 55;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=loading%E5%8A%A8%E7%94%BB"></div><div mxa="_zs_gallerybS:d" class="clearfix mb20"><div mxa="_zs_gallerybS:e" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/11" id="';
    $line = 62;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo8"></div></div><div mxa="_zs_gallerybS:f" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/10" id="';
    $line = 68;
    $art = '=viewId';
    ;
