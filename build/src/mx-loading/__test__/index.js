...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_custom" mx-view="mx-title/second?content=%E6%89%8B%E5%8A%A8%E5%8A%A0%E8%BD%BD"></div><div mxa="_zs_gallerybN:a" class="clearfix mb20"><div mxa="_zs_gallerybN:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/1" id="';
    $line = 51;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_custom2"></div></div><div mxa="_zs_gallerybN:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/3" id="';
    $line = 55;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=loading%E5%8A%A8%E7%94%BB"></div><div mxa="_zs_gallerybN:d" class="clearfix mb20"><div mxa="_zs_gallerybN:e" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/11" id="';
    $line = 62;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo8"></div></div><div mxa="_zs_gallerybN:f" class="_zs_gallery___test___layout_-half"><div mx-view="mx-loading/__test__/10" id="';
    $line = 68;
    $art = '=viewId';
    ;
