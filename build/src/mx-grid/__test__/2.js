...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybB:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybB:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb10">某一个固定宽度，最右侧固定为100px，剩余部分自适应</div><div style="display: flex;height: 100px;flex-direction: row;justify-content: flex-start;align-items: stretch;"><div flex="1" class="_zs_gallery_mx-grid___test___index_-grid1" style="flex: 1;margin-right:20px;"></div><div flex="1" class="_zs_gallery_mx-grid___test___index_-grid2" style="flex: 1;margin-right:20px;"></div><div class="_zs_gallery_mx-grid___test___index_-grid3" style="flex: 0 0 100px;"></div></div></div><div mxa="_zs_gallerybB:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybB:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
