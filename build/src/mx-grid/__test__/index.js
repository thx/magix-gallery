...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_grid" mx-view="mx-title/second?content=%E5%8D%95%E6%A0%BC%E6%A0%B7%E5%BC%8F"></div><div mxa="_zs_gallerybT:b" class="clearfix mb40"><div mx-view="mx-grid/__test__/7" id="';
    $line = 55;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E5%B8%83%E5%B1%80%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerybT:c" class="clearfix mb20"><div mxa="_zs_gallerybT:d" class="_zs_gallery___test___layout_-half"><div mx-view="mx-grid/__test__/1" id="';
    $line = 63;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div></div><div mxa="_zs_gallerybT:e" class="_zs_gallery___test___layout_-half"><div mx-view="mx-grid/__test__/6" id="';
    $line = 68;
    $art = '=viewId';
    ;
