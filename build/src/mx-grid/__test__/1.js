...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybA:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybA:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb10">1:1:1:1</div><div style="display: flex;height: 100px;flex-direction: row;justify-content: flex-start;align-items: stretch" height="100px" gutter="20px" class="mb40"><div style="flex: 1" class="_zs_gallery_mx-grid___test___index_-grid1"></div><div style="flex: 1" class="_zs_gallery_mx-grid___test___index_-grid2"></div><div style="flex: 1" class="_zs_gallery_mx-grid___test___index_-grid3"></div><div style="flex: 1" class="_zs_gallery_mx-grid___test___index_-grid4"></div></div><div class="mb10">1:3:1</div><div style="display: flex;height: 100px;flex-direction: row;justify-content: flex-start;align-items: stretch" height="100px" gutter="20px"><div style="flex: 1" flex="1" class="_zs_gallery_mx-grid___test___index_-grid1"></div><div style="flex: 3" flex="3" class="_zs_gallery_mx-grid___test___index_-grid2"></div><div style="flex: 1" flex="1" class="_zs_gallery_mx-grid___test___index_-grid3"></div></div></div><div mxa="_zs_gallerybA:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybA:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 21;
    $art = '=viewId';
    ;
