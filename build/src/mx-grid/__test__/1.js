...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybP:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerybP:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerybP:_" class="mb10">1:1:1:1等分，间隔为20px</div><div mxa="_zs_gallerybP:b" class="mb40" style="display: flex;height: 100px;flex-direction: row;justify-content: flex-start;align-items: stretch;--mx-grid-gutter: 20px;margin-left: calc(0px - var(--mx-grid-gutter) / 2);margin-right: calc(0px - var(--mx-grid-gutter) / 2);">';
    $line = 5;
    ...
    for (var i = 0; i < 4; i += 1) {
        ;
        $p += '<div mxs="_zs_gallerybP:a" class="_zs_gallery_mx-grid___test___index_-grid1" style="flex: 1;margin-left: calc(var(--mx-grid-gutter) / 2);margin-right: calc(var(--mx-grid-gutter) / 2);"></div>';
        $line = 7;
        $art = '/for';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '</div><div mxs="_zs_gallerybP:b" class="mb10">1:3:1，间隔为20px</div><div mxs="_zs_gallerybP:c" style="display: flex;height: 100px;flex-direction: row;justify-content: flex-start;align-items: stretch;--mx-grid-gutter: 20px;margin-left: calc(0px - var(--mx-grid-gutter) / 2);margin-right: calc(0px - var(--mx-grid-gutter) / 2);"><div flex="1" class="_zs_gallery_mx-grid___test___index_-grid1" style="flex: 1;margin-left: calc(var(--mx-grid-gutter) / 2);margin-right: calc(var(--mx-grid-gutter) / 2);"></div><div flex="3" class="_zs_gallery_mx-grid___test___index_-grid2" style="flex: 3;margin-left: calc(var(--mx-grid-gutter) / 2);margin-right: calc(var(--mx-grid-gutter) / 2);"></div><div flex="1" class="_zs_gallery_mx-grid___test___index_-grid3" style="flex: 1;margin-left: calc(var(--mx-grid-gutter) / 2);margin-right: calc(var(--mx-grid-gutter) / 2);"></div></div></div><div mxa="_zs_gallerybP:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybP:d" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
