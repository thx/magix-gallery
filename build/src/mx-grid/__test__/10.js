...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryca:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryca:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryca:_" class="mb10">完整组合使用示例：</div><div mxa="_zs_galleryca:b" class="_zs_gallery_mx-grid___test___index_-container"><div mxa="_zs_galleryca:c" style="display: flex;flex-direction: row;justify-content: flex-start;align-items: stretch;--mx-grid-gutter: 16px;margin-left: calc(0px - var(--mx-grid-gutter) / 2);margin-right: calc(0px - var(--mx-grid-gutter) / 2);"><div mxa="_zs_galleryca:d" flex="1" class="grid" style="flex: 1;margin-left: calc(var(--mx-grid-gutter) / 2);margin-right: calc(var(--mx-grid-gutter) / 2);"><div mxa="_zs_galleryca:e" class="clearfix" style="padding: 10px 24px;;border-bottom: 1px solid #e6e6e6;;"><div mxs="_zs_galleryca:a" style="float:left; height: 32px; line-height: 32px;"><span class="grid-title" style="margin-right: 16px;">标题</span><span style="margin-right: 16px; color: #999;">提示信息</span></div><div mxa="_zs_galleryca:f" class="fr"><div mxs="_zs_galleryca:b" class="w200 mr10" mx-view="mx-calendar/datepicker"></div><div class="w200" mx-view="mx-dropdown/index?list=';
    $line = 12;
    $art = '@[1,2,3]';
    ;
