...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybI:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybI:i" class="_zs_gallery___test___layout_-eg-content"><div class="_zs_gallery_mx-grid___test___index_-container"><div style="background: #fff; border-radius: 4px; box-shadow: 0 2px 4px rgba(51, 51, 51, 0.08);"><div mx-view="mx-grid/__test__/grid-body" style="padding: 20px;"></div></div></div></div><div mxa="_zs_gallerybI:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybI:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
