...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerych:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerych:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb10">内容区域支持指定一个view：</div><div class="_zs_gallery_mx-grid___test___index_-container"><div class="grid"><div mx-view="mx-grid/__test__/grid-body" class="clearfix" style="padding: 16px 24px;"></div></div></div></div><div mxa="_zs_gallerych:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerych:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
