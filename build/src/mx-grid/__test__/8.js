...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybI:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerybI:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerybI:_" class="mb10">只标题部分 + 筛选项（右浮动）：</div><div mxa="_zs_gallerybI:b" class="_zs_gallery_mx-grid___test___index_-container"><div mxa="_zs_gallerybI:c" class="grid"><div mxa="_zs_gallerybI:d" content="标题" class="clearfix" style="padding: 8px 24px;;"><div mxs="_zs_gallerybI:a" style="float:left; line-height: 32px;"><span style="font-size: 16px;">标题</span><span style="margin-left: 16px; color: #999;">提示信息</span></div><div mxa="_zs_gallerybI:e" style="float: right;"><div mxs="_zs_gallerybI:b" class="w200 mr10" mx-view="mx-calendar/datepicker"></div><div class="w200" mx-view="mx-dropdown/index?list=';
    $line = 10;
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div></div></div></div></div><div mxa="_zs_gallerybI:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybI:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 19;
    $art = '=viewId';
    ;
