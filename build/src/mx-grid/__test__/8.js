...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryco:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryco:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryco:_" class="mb10">只标题部分（支持自定义内容）：</div><div mxa="_zs_galleryco:b" class="_zs_gallery_mx-grid___test___index_-container"><div mxa="_zs_galleryco:c" class="grid mb20"><div mxa="_zs_galleryco:d" class="clearfix" style="padding: 10px 24px;;"><div mxa="_zs_galleryco:e" style="float:left; height: 32px; line-height: 32px;"><span mxa="_zs_galleryco:f" style="margin-right: 4px; color: #ccc;">';
    $line = 10;
    $art = '!icon';
    ;
    ...
    $art = '!img';
    ;
    $p += ($expr = '<%!img%>', $n(img)) + '</span></div></div></div></div></div><div mxa="_zs_galleryco:k" class="clearfix"><div mxa="_zs_galleryco:l" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_galleryco:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 23;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryco:m" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 25;
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryco:d" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 28;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-grid&gt;\n    &lt;mx-grid.title \n        border="none" \n        content="标题" \n        tip="提示信息" \n        icon="&#123;&#123;!icon&#125;&#125;"/&gt;\n&lt;/mx-grid&gt;\n\n&lt;mx-grid.title \n    border="none" \n    content="&#123;&#123;!img&#125;&#125;" /&gt;\n            </pre></div><div mxa="_zs_galleryco:n" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third2 _zs_gallery___test___layout_-half-right"><div mxs="_zs_galleryco:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 44;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryco:o" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 46;
    $art = '!text2';
    ;
