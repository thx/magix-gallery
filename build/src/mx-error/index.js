...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_galleryb5:_" class="_zs_gallery_mx-error_index_-error"><img class="_zs_gallery_mx-error_index_-bad-img" src="';
    $line = 2;
    $art = '=src';
    ;
    $p += ($expr = '<%=src%>', $e(src)) + '"/><div mxa="_zs_galleryb5:a" class="_zs_gallery_mx-error_index_-info mt40">';
    $line = 3;
    $art = '=tip';
    ;
    ...
    if (btns) {
        ;
        $p += '<div mxs="_zs_galleryb5:_" class="mt20"><a href="#!" class="btn btn-brand _zs_gallery_mx-error_index_-home-btn">回到首页</a><a href="javascript:;" class="btn _zs_gallery_mx-error_index_-back-btn" mx-click="' + $viewId + 'back()">返回上一页</a></div>';
        $line = 10;
        $art = '/if';
        ;
        $expr = '<%}%>';
