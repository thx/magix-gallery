...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerybu:_" class="_zs_gallery_mx-error_index_-error">';
    $line = 2;
    $art = 'if (type == \'404\')';
    ;
    $expr = '<%if (type == \'404\') {%>';
    if (type == '404') {
        ;
        $p += '<div mxs="_zs_gallerybu:_"><i class="mc-iconfont _zs_gallery_mx-error_index_-error-unfound">&#xe6c7;</i></div><div mxa="_zs_gallerybu:a" class="_zs_gallery_mx-error_index_-info">';
        $line = 4;
        $art = '=tip';
        ;
    ...
    if (type == '502' || type == '500') {
        ;
        $p += '<img mxs="_zs_gallerybu:a" class="_zs_gallery_mx-error_index_-error-bad-img" src="//img.alicdn.com/tfs/TB1gwinx9rqK1RjSZK9XXXyypXa-1122-678.png"/><span mxa="_zs_gallerybu:b" class="_zs_gallery_mx-error_index_-error-bad-num">';
        $line = 9;
        $art = '=type';
        ;
        $p += ($expr = '<%=type%>', $e(type)) + '</span><div mxa="_zs_gallerybu:c" class="_zs_gallery_mx-error_index_-info">';
        $line = 10;
        $art = '=tip';
        ;
        $p += ($expr = '<%=tip%>', $e(tip)) + '</div>';
    ...
    if (btns) {
        ;
        $p += '<div mxs="_zs_gallerybu:b"><a href="#!" class="btn btn-brand _zs_gallery_mx-error_index_-home-btn">回到首页</a><a href="javascript:;" class="btn _zs_gallery_mx-error_index_-back-btn" mx-click="' + $viewId + 'back()">返回上一页</a></div>';
        $line = 18;
        $art = '/if';
        ;
        $expr = '<%}%>';
