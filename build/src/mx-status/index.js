...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ieisuqsuch$art_i = 0, $art_cuwatlm$art_c = opers.length; $art_ieisuqsuch$art_i < $art_cuwatlm$art_c; $art_ieisuqsuch$art_i++) {        var item = opers[$art_ieisuqsuch$art_i]%>';
        for (var $art_ieisuqsuch$art_i = 0, $art_cuwatlm$art_c = opers.length; $art_ieisuqsuch$art_i < $art_cuwatlm$art_c; $art_ieisuqsuch$art_i++) {
            var item = opers[$art_ieisuqsuch$art_i];
