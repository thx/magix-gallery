...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ijelpnfm$art_i = 0, $art_ccheogwu$art_c = opers.length; $art_ijelpnfm$art_i < $art_ccheogwu$art_c; $art_ijelpnfm$art_i++) {        var item = opers[$art_ijelpnfm$art_i]%>';
        for (var $art_ijelpnfm$art_i = 0, $art_ccheogwu$art_c = opers.length; $art_ijelpnfm$art_i < $art_ccheogwu$art_c; $art_ijelpnfm$art_i++) {
            var item = opers[$art_ijelpnfm$art_i];
