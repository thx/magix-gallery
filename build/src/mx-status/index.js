...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ihaqpksl$art_i = 0, $art_cdrwbxnka$art_c = opers.length; $art_ihaqpksl$art_i < $art_cdrwbxnka$art_c; $art_ihaqpksl$art_i++) {        var item = opers[$art_ihaqpksl$art_i]%>';
        for (var $art_ihaqpksl$art_i = 0, $art_cdrwbxnka$art_c = opers.length; $art_ihaqpksl$art_i < $art_cdrwbxnka$art_c; $art_ihaqpksl$art_i++) {
            var item = opers[$art_ihaqpksl$art_i];
