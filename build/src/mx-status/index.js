...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ilkdhxru$art_i = 0, $art_cbybsicjgi$art_c = opers.length; $art_ilkdhxru$art_i < $art_cbybsicjgi$art_c; $art_ilkdhxru$art_i++) {        var item = opers[$art_ilkdhxru$art_i]%>';
        for (var $art_ilkdhxru$art_i = 0, $art_cbybsicjgi$art_c = opers.length; $art_ilkdhxru$art_i < $art_cbybsicjgi$art_c; $art_ilkdhxru$art_i++) {
            var item = opers[$art_ilkdhxru$art_i];
