...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_igcfkyrtc$art_i = 0, $art_cbbizpxzmc$art_c = opers.length; $art_igcfkyrtc$art_i < $art_cbbizpxzmc$art_c; $art_igcfkyrtc$art_i++) {        var item = opers[$art_igcfkyrtc$art_i]%>';
        for (var $art_igcfkyrtc$art_i = 0, $art_cbbizpxzmc$art_c = opers.length; $art_igcfkyrtc$art_i < $art_cbbizpxzmc$art_c; $art_igcfkyrtc$art_i++) {
            var item = opers[$art_igcfkyrtc$art_i];
