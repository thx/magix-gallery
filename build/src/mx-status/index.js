...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ixarevone$art_i = 0, $art_cvtfdutgql$art_c = opers.length; $art_ixarevone$art_i < $art_cvtfdutgql$art_c; $art_ixarevone$art_i++) {        var item = opers[$art_ixarevone$art_i]%>';
        for (var $art_ixarevone$art_i = 0, $art_cvtfdutgql$art_c = opers.length; $art_ixarevone$art_i < $art_cvtfdutgql$art_c; $art_ixarevone$art_i++) {
            var item = opers[$art_ixarevone$art_i];
