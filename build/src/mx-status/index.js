...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_inpgfboa$art_i = 0, $art_cwdtomzvi$art_c = opers.length; $art_inpgfboa$art_i < $art_cwdtomzvi$art_c; $art_inpgfboa$art_i++) {        var item = opers[$art_inpgfboa$art_i]%>';
        for (var $art_inpgfboa$art_i = 0, $art_cwdtomzvi$art_c = opers.length; $art_inpgfboa$art_i < $art_cwdtomzvi$art_c; $art_inpgfboa$art_i++) {
            var item = opers[$art_inpgfboa$art_i];
