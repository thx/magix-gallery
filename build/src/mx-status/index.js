...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iclpqzzxuac$art_i = 0, $art_cvyliovv$art_c = opers.length; $art_iclpqzzxuac$art_i < $art_cvyliovv$art_c; $art_iclpqzzxuac$art_i++) {        var item = opers[$art_iclpqzzxuac$art_i]%>';
        for (var $art_iclpqzzxuac$art_i = 0, $art_cvyliovv$art_c = opers.length; $art_iclpqzzxuac$art_i < $art_cvyliovv$art_c; $art_iclpqzzxuac$art_i++) {
            var item = opers[$art_iclpqzzxuac$art_i];
