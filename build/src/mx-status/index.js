...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_icxwfpmmw$art_i = 0, $art_cphqwandchas$art_c = opers.length; $art_icxwfpmmw$art_i < $art_cphqwandchas$art_c; $art_icxwfpmmw$art_i++) {        var item = opers[$art_icxwfpmmw$art_i]%>';
        for (var $art_icxwfpmmw$art_i = 0, $art_cphqwandchas$art_c = opers.length; $art_icxwfpmmw$art_i < $art_cphqwandchas$art_c; $art_icxwfpmmw$art_i++) {
            var item = opers[$art_icxwfpmmw$art_i];
