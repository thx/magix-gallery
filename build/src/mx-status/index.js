...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ihosbvl$art_i = 0, $art_cblexaovt$art_c = opers.length; $art_ihosbvl$art_i < $art_cblexaovt$art_c; $art_ihosbvl$art_i++) {        var item = opers[$art_ihosbvl$art_i]%>';
        for (var $art_ihosbvl$art_i = 0, $art_cblexaovt$art_c = opers.length; $art_ihosbvl$art_i < $art_cblexaovt$art_c; $art_ihosbvl$art_i++) {
            var item = opers[$art_ihosbvl$art_i];
