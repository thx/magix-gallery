...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iarnpwhxid$art_i = 0, $art_czteojeerhd$art_c = opers.length; $art_iarnpwhxid$art_i < $art_czteojeerhd$art_c; $art_iarnpwhxid$art_i++) {        var item = opers[$art_iarnpwhxid$art_i]%>';
        for (var $art_iarnpwhxid$art_i = 0, $art_czteojeerhd$art_c = opers.length; $art_iarnpwhxid$art_i < $art_czteojeerhd$art_c; $art_iarnpwhxid$art_i++) {
            var item = opers[$art_iarnpwhxid$art_i];
