...
module.exports = Base.extend({
    ...
    if (show) {
        ;
        $p += '<ul mxa="_zs_gallerydW:b" class="_zs_gallery_mx-status_base_-status-info">';
        $line = 18;
        $art = 'if showInfo';
        ;
        $expr = '<%if (showInfo) {%>';
        ...
        ;
        $expr = '<%for (var $art_ilohsdefxm$art_i = 0, $art_cvktnpja$art_c = opers.length; $art_ilohsdefxm$art_i < $art_cvktnpja$art_c; $art_ilohsdefxm$art_i++) {        var item = opers[$art_ilohsdefxm$art_i]%>';
        for (var $art_ilohsdefxm$art_i = 0, $art_cvktnpja$art_c = opers.length; $art_ilohsdefxm$art_i < $art_cvktnpja$art_c; $art_ilohsdefxm$art_i++) {
            var item = opers[$art_ilohsdefxm$art_i];
