...
module.exports = Base.extend({
    ...
    if (show) {
        ;
        $p += '<ul mxa="_zs_gallerydV:b" class="_zs_gallery_mx-status_base_-status-info">';
        $line = 18;
        $art = 'if showInfo';
        ;
        $expr = '<%if (showInfo) {%>';
        ...
        ;
        $expr = '<%for (var $art_iybpsovlv$art_i = 0, $art_cszjdndoxm$art_c = opers.length; $art_iybpsovlv$art_i < $art_cszjdndoxm$art_c; $art_iybpsovlv$art_i++) {        var item = opers[$art_iybpsovlv$art_i]%>';
        for (var $art_iybpsovlv$art_i = 0, $art_cszjdndoxm$art_c = opers.length; $art_iybpsovlv$art_i < $art_cszjdndoxm$art_c; $art_iybpsovlv$art_i++) {
            var item = opers[$art_iybpsovlv$art_i];
