...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ibujztmdh$art_i = 0, $art_clrojuorfs$art_c = opers.length; $art_ibujztmdh$art_i < $art_clrojuorfs$art_c; $art_ibujztmdh$art_i++) {        var item = opers[$art_ibujztmdh$art_i]%>';
        for (var $art_ibujztmdh$art_i = 0, $art_clrojuorfs$art_c = opers.length; $art_ibujztmdh$art_i < $art_clrojuorfs$art_c; $art_ibujztmdh$art_i++) {
            var item = opers[$art_ibujztmdh$art_i];
