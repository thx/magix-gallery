...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $expr = '<%for (var $art_ilhmmmsm$art_i = 0, $art_cbontimg$art_c = list.length; $art_ilhmmmsm$art_i < $art_cbontimg$art_c; $art_ilhmmmsm$art_i++) {            var item = list[$art_ilhmmmsm$art_i]%>';
            for (var $art_ilhmmmsm$art_i = 0, $art_cbontimg$art_c = list.length; $art_ilhmmmsm$art_i < $art_cbontimg$art_c; $art_ilhmmmsm$art_i++) {
                var item = list[$art_ilhmmmsm$art_i];
