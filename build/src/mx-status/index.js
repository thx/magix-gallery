...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iamnisvseh$art_i = 0, $art_cgmsogcl$art_c = list.length; $art_iamnisvseh$art_i < $art_cgmsogcl$art_c; $art_iamnisvseh$art_i++) {            var item = list[$art_iamnisvseh$art_i]%>';
            for (var $art_iamnisvseh$art_i = 0, $art_cgmsogcl$art_c = list.length; $art_iamnisvseh$art_i < $art_cgmsogcl$art_c; $art_iamnisvseh$art_i++) {
                var item = list[$art_iamnisvseh$art_i];
