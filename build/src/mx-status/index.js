...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_inlwkcbk$art_i = 0, $art_cueirm$art_c = opers.length; $art_inlwkcbk$art_i < $art_cueirm$art_c; $art_inlwkcbk$art_i++) {        var item = opers[$art_inlwkcbk$art_i]%>';
        for (var $art_inlwkcbk$art_i = 0, $art_cueirm$art_c = opers.length; $art_inlwkcbk$art_i < $art_cueirm$art_c; $art_inlwkcbk$art_i++) {
            var item = opers[$art_inlwkcbk$art_i];
