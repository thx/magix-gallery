...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iqvplifp$art_i = 0, $art_chigvtdrdl$art_c = opers.length; $art_iqvplifp$art_i < $art_chigvtdrdl$art_c; $art_iqvplifp$art_i++) {        var item = opers[$art_iqvplifp$art_i]%>';
        for (var $art_iqvplifp$art_i = 0, $art_chigvtdrdl$art_c = opers.length; $art_iqvplifp$art_i < $art_chigvtdrdl$art_c; $art_iqvplifp$art_i++) {
            var item = opers[$art_iqvplifp$art_i];
