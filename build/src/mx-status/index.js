...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_itntfmaasee$art_i = 0, $art_ckudaemr$art_c = opers.length; $art_itntfmaasee$art_i < $art_ckudaemr$art_c; $art_itntfmaasee$art_i++) {        var item = opers[$art_itntfmaasee$art_i]%>';
        for (var $art_itntfmaasee$art_i = 0, $art_ckudaemr$art_c = opers.length; $art_itntfmaasee$art_i < $art_ckudaemr$art_c; $art_itntfmaasee$art_i++) {
            var item = opers[$art_itntfmaasee$art_i];
