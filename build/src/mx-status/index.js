...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iojuhzjs$art_i = 0, $art_cysteaatq$art_c = opers.length; $art_iojuhzjs$art_i < $art_cysteaatq$art_c; $art_iojuhzjs$art_i++) {        var item = opers[$art_iojuhzjs$art_i]%>';
        for (var $art_iojuhzjs$art_i = 0, $art_cysteaatq$art_c = opers.length; $art_iojuhzjs$art_i < $art_cysteaatq$art_c; $art_iojuhzjs$art_i++) {
            var item = opers[$art_iojuhzjs$art_i];
