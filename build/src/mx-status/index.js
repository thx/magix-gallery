...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iuhcovct$art_i = 0, $art_czzgmobtur$art_c = opers.length; $art_iuhcovct$art_i < $art_czzgmobtur$art_c; $art_iuhcovct$art_i++) {        var item = opers[$art_iuhcovct$art_i]%>';
        for (var $art_iuhcovct$art_i = 0, $art_czzgmobtur$art_c = opers.length; $art_iuhcovct$art_i < $art_czzgmobtur$art_c; $art_iuhcovct$art_i++) {
            var item = opers[$art_iuhcovct$art_i];
