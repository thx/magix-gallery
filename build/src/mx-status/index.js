...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ilihpe$art_i = 0, $art_ccqiqy$art_c = opers.length; $art_ilihpe$art_i < $art_ccqiqy$art_c; $art_ilihpe$art_i++) {        var item = opers[$art_ilihpe$art_i]%>';
        for (var $art_ilihpe$art_i = 0, $art_ccqiqy$art_c = opers.length; $art_ilihpe$art_i < $art_ccqiqy$art_c; $art_ilihpe$art_i++) {
            var item = opers[$art_ilihpe$art_i];
