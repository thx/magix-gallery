...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ijdusybza$art_i = 0, $art_chqrozxdrs$art_c = opers.length; $art_ijdusybza$art_i < $art_chqrozxdrs$art_c; $art_ijdusybza$art_i++) {        var item = opers[$art_ijdusybza$art_i]%>';
        for (var $art_ijdusybza$art_i = 0, $art_chqrozxdrs$art_c = opers.length; $art_ijdusybza$art_i < $art_chqrozxdrs$art_c; $art_ijdusybza$art_i++) {
            var item = opers[$art_ijdusybza$art_i];
