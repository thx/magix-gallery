...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ipfcftf$art_i = 0, $art_czogtmumtje$art_c = opers.length; $art_ipfcftf$art_i < $art_czogtmumtje$art_c; $art_ipfcftf$art_i++) {        var item = opers[$art_ipfcftf$art_i]%>';
        for (var $art_ipfcftf$art_i = 0, $art_czogtmumtje$art_c = opers.length; $art_ipfcftf$art_i < $art_czogtmumtje$art_c; $art_ipfcftf$art_i++) {
            var item = opers[$art_ipfcftf$art_i];
