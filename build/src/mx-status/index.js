...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_invjdenwq$art_i = 0, $art_ctkdquxkn$art_c = opers.length; $art_invjdenwq$art_i < $art_ctkdquxkn$art_c; $art_invjdenwq$art_i++) {        var item = opers[$art_invjdenwq$art_i]%>';
        for (var $art_invjdenwq$art_i = 0, $art_ctkdquxkn$art_c = opers.length; $art_invjdenwq$art_i < $art_ctkdquxkn$art_c; $art_invjdenwq$art_i++) {
            var item = opers[$art_invjdenwq$art_i];
