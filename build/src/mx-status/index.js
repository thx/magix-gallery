...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ijyjpzpwxa$art_i = 0, $art_cbuclmsrlq$art_c = opers.length; $art_ijyjpzpwxa$art_i < $art_cbuclmsrlq$art_c; $art_ijyjpzpwxa$art_i++) {        var item = opers[$art_ijyjpzpwxa$art_i]%>';
        for (var $art_ijyjpzpwxa$art_i = 0, $art_cbuclmsrlq$art_c = opers.length; $art_ijyjpzpwxa$art_i < $art_cbuclmsrlq$art_c; $art_ijyjpzpwxa$art_i++) {
            var item = opers[$art_ijyjpzpwxa$art_i];
