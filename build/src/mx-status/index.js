...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_idqkddndu$art_i = 0, $art_clmwfjdsqk$art_c = opers.length; $art_idqkddndu$art_i < $art_clmwfjdsqk$art_c; $art_idqkddndu$art_i++) {        var item = opers[$art_idqkddndu$art_i]%>';
        for (var $art_idqkddndu$art_i = 0, $art_clmwfjdsqk$art_c = opers.length; $art_idqkddndu$art_i < $art_clmwfjdsqk$art_c; $art_idqkddndu$art_i++) {
            var item = opers[$art_idqkddndu$art_i];
