...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iabvwdzkz$art_i = 0, $art_ctykntubr$art_c = opers.length; $art_iabvwdzkz$art_i < $art_ctykntubr$art_c; $art_iabvwdzkz$art_i++) {        var item = opers[$art_iabvwdzkz$art_i]%>';
        for (var $art_iabvwdzkz$art_i = 0, $art_ctykntubr$art_c = opers.length; $art_iabvwdzkz$art_i < $art_ctykntubr$art_c; $art_iabvwdzkz$art_i++) {
            var item = opers[$art_iabvwdzkz$art_i];
