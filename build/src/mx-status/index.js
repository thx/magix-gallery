...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iasokgvusp$art_i = 0, $art_coyedytebff$art_c = list.length; $art_iasokgvusp$art_i < $art_coyedytebff$art_c; $art_iasokgvusp$art_i++) {            var item = list[$art_iasokgvusp$art_i]%>';
            for (var $art_iasokgvusp$art_i = 0, $art_coyedytebff$art_c = list.length; $art_iasokgvusp$art_i < $art_coyedytebff$art_c; $art_iasokgvusp$art_i++) {
                var item = list[$art_iasokgvusp$art_i];
