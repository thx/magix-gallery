...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ixyfigoao$art_i = 0, $art_cupxenp$art_c = opers.length; $art_ixyfigoao$art_i < $art_cupxenp$art_c; $art_ixyfigoao$art_i++) {        var item = opers[$art_ixyfigoao$art_i]%>';
        for (var $art_ixyfigoao$art_i = 0, $art_cupxenp$art_c = opers.length; $art_ixyfigoao$art_i < $art_cupxenp$art_c; $art_ixyfigoao$art_i++) {
            var item = opers[$art_ixyfigoao$art_i];
