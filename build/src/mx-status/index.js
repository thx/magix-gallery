...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ijabpnszsr$art_i = 0, $art_cwxozvrvb$art_c = opers.length; $art_ijabpnszsr$art_i < $art_cwxozvrvb$art_c; $art_ijabpnszsr$art_i++) {        var item = opers[$art_ijabpnszsr$art_i]%>';
        for (var $art_ijabpnszsr$art_i = 0, $art_cwxozvrvb$art_c = opers.length; $art_ijabpnszsr$art_i < $art_cwxozvrvb$art_c; $art_ijabpnszsr$art_i++) {
            var item = opers[$art_ijabpnszsr$art_i];
