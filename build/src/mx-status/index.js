...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ikcwkyme$art_i = 0, $art_cjzkxwjvu$art_c = opers.length; $art_ikcwkyme$art_i < $art_cjzkxwjvu$art_c; $art_ikcwkyme$art_i++) {        var item = opers[$art_ikcwkyme$art_i]%>';
        for (var $art_ikcwkyme$art_i = 0, $art_cjzkxwjvu$art_c = opers.length; $art_ikcwkyme$art_i < $art_cjzkxwjvu$art_c; $art_ikcwkyme$art_i++) {
            var item = opers[$art_ikcwkyme$art_i];
