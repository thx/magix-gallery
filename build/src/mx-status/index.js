...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_invufnrl$art_i = 0, $art_ctzrood$art_c = opers.length; $art_invufnrl$art_i < $art_ctzrood$art_c; $art_invufnrl$art_i++) {        var item = opers[$art_invufnrl$art_i]%>';
        for (var $art_invufnrl$art_i = 0, $art_ctzrood$art_c = opers.length; $art_invufnrl$art_i < $art_ctzrood$art_c; $art_invufnrl$art_i++) {
            var item = opers[$art_invufnrl$art_i];
