...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iohtfjdgn$art_i = 0, $art_crplaprx$art_c = opers.length; $art_iohtfjdgn$art_i < $art_crplaprx$art_c; $art_iohtfjdgn$art_i++) {        var item = opers[$art_iohtfjdgn$art_i]%>';
        for (var $art_iohtfjdgn$art_i = 0, $art_crplaprx$art_c = opers.length; $art_iohtfjdgn$art_i < $art_crplaprx$art_c; $art_iohtfjdgn$art_i++) {
            var item = opers[$art_iohtfjdgn$art_i];
