...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iomoyrmxa$art_i = 0, $art_crwjex$art_c = opers.length; $art_iomoyrmxa$art_i < $art_crwjex$art_c; $art_iomoyrmxa$art_i++) {        var item = opers[$art_iomoyrmxa$art_i]%>';
        for (var $art_iomoyrmxa$art_i = 0, $art_crwjex$art_c = opers.length; $art_iomoyrmxa$art_i < $art_crwjex$art_c; $art_iomoyrmxa$art_i++) {
            var item = opers[$art_iomoyrmxa$art_i];
