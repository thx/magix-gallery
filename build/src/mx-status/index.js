...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ihfqzprrtp$art_i = 0, $art_cxkxlvgs$art_c = opers.length; $art_ihfqzprrtp$art_i < $art_cxkxlvgs$art_c; $art_ihfqzprrtp$art_i++) {        var item = opers[$art_ihfqzprrtp$art_i]%>';
        for (var $art_ihfqzprrtp$art_i = 0, $art_cxkxlvgs$art_c = opers.length; $art_ihfqzprrtp$art_i < $art_cxkxlvgs$art_c; $art_ihfqzprrtp$art_i++) {
            var item = opers[$art_ihfqzprrtp$art_i];
