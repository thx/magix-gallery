...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iqpeaqrkw$art_i = 0, $art_csvaifn$art_c = opers.length; $art_iqpeaqrkw$art_i < $art_csvaifn$art_c; $art_iqpeaqrkw$art_i++) {        var item = opers[$art_iqpeaqrkw$art_i]%>';
        for (var $art_iqpeaqrkw$art_i = 0, $art_csvaifn$art_c = opers.length; $art_iqpeaqrkw$art_i < $art_csvaifn$art_c; $art_iqpeaqrkw$art_i++) {
            var item = opers[$art_iqpeaqrkw$art_i];
