...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (showInfo) {
            ;
            $p += '<li mxa="_zs_galleryd1:c" class="_zs_gallery_mx-status_base_-status-desc"><span class="_zs_gallery_mx-status_base_-status-icon" style="color: ';
            $line = 20;
            $art = '=info.color';
            ;
            $p += ($expr = '<%=info.color%>', $e(info.color)) + ';">';
        ...
        ;
        $expr = '<%for (var $art_ihsicmqv$art_i = 0, $art_czfiynws$art_c = opers.length; $art_ihsicmqv$art_i < $art_czfiynws$art_c; $art_ihsicmqv$art_i++) {        var item = opers[$art_ihsicmqv$art_i]%>';
        for (var $art_ihsicmqv$art_i = 0, $art_czfiynws$art_c = opers.length; $art_ihsicmqv$art_i < $art_czfiynws$art_c; $art_ihsicmqv$art_i++) {
            var item = opers[$art_ihsicmqv$art_i];
