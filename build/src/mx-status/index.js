...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ikxyvjxlww$art_i = 0, $art_cffrhpliwt$art_c = opers.length; $art_ikxyvjxlww$art_i < $art_cffrhpliwt$art_c; $art_ikxyvjxlww$art_i++) {        var item = opers[$art_ikxyvjxlww$art_i]%>';
        for (var $art_ikxyvjxlww$art_i = 0, $art_cffrhpliwt$art_c = opers.length; $art_ikxyvjxlww$art_i < $art_cffrhpliwt$art_c; $art_ikxyvjxlww$art_i++) {
            var item = opers[$art_ikxyvjxlww$art_i];
