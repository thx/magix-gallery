...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iwqkfnat$art_i = 0, $art_cdbugogto$art_c = opers.length; $art_iwqkfnat$art_i < $art_cdbugogto$art_c; $art_iwqkfnat$art_i++) {        var item = opers[$art_iwqkfnat$art_i]%>';
        for (var $art_iwqkfnat$art_i = 0, $art_cdbugogto$art_c = opers.length; $art_iwqkfnat$art_i < $art_cdbugogto$art_c; $art_iwqkfnat$art_i++) {
            var item = opers[$art_iwqkfnat$art_i];
