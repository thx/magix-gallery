...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_idjgwqdwt$art_i = 0, $art_ctpzdedlj$art_c = opers.length; $art_idjgwqdwt$art_i < $art_ctpzdedlj$art_c; $art_idjgwqdwt$art_i++) {        var item = opers[$art_idjgwqdwt$art_i]%>';
        for (var $art_idjgwqdwt$art_i = 0, $art_ctpzdedlj$art_c = opers.length; $art_idjgwqdwt$art_i < $art_ctpzdedlj$art_c; $art_idjgwqdwt$art_i++) {
            var item = opers[$art_idjgwqdwt$art_i];
