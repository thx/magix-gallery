...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_izcffeqfl$art_i = 0, $art_cwvikv$art_c = opers.length; $art_izcffeqfl$art_i < $art_cwvikv$art_c; $art_izcffeqfl$art_i++) {        var item = opers[$art_izcffeqfl$art_i]%>';
        for (var $art_izcffeqfl$art_i = 0, $art_cwvikv$art_c = opers.length; $art_izcffeqfl$art_i < $art_cwvikv$art_c; $art_izcffeqfl$art_i++) {
            var item = opers[$art_izcffeqfl$art_i];
