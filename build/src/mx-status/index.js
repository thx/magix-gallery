...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ivvdqbjuc$art_i = 0, $art_cnmtbxwtbk$art_c = opers.length; $art_ivvdqbjuc$art_i < $art_cnmtbxwtbk$art_c; $art_ivvdqbjuc$art_i++) {        var item = opers[$art_ivvdqbjuc$art_i]%>';
        for (var $art_ivvdqbjuc$art_i = 0, $art_cnmtbxwtbk$art_c = opers.length; $art_ivvdqbjuc$art_i < $art_cnmtbxwtbk$art_c; $art_ivvdqbjuc$art_i++) {
            var item = opers[$art_ivvdqbjuc$art_i];
