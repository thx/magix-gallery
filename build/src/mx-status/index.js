...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_idpaqqfxmn$art_i = 0, $art_cxzizlsnl$art_c = opers.length; $art_idpaqqfxmn$art_i < $art_cxzizlsnl$art_c; $art_idpaqqfxmn$art_i++) {        var item = opers[$art_idpaqqfxmn$art_i]%>';
        for (var $art_idpaqqfxmn$art_i = 0, $art_cxzizlsnl$art_c = opers.length; $art_idpaqqfxmn$art_i < $art_cxzizlsnl$art_c; $art_idpaqqfxmn$art_i++) {
            var item = opers[$art_idpaqqfxmn$art_i];
