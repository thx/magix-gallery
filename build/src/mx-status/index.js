...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_irfkmiemm$art_i = 0, $art_cahqvxvh$art_c = opers.length; $art_irfkmiemm$art_i < $art_cahqvxvh$art_c; $art_irfkmiemm$art_i++) {        var item = opers[$art_irfkmiemm$art_i]%>';
        for (var $art_irfkmiemm$art_i = 0, $art_cahqvxvh$art_c = opers.length; $art_irfkmiemm$art_i < $art_cahqvxvh$art_c; $art_irfkmiemm$art_i++) {
            var item = opers[$art_irfkmiemm$art_i];
