...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycs:_" class="_zs_gallery_mx-status_base_-status" mx-mouseout="' + $viewId + 'out()"><div mxa="_zs_gallerycs:a" class="_zs_gallery_mx-status_base_-status-handle-icon" mx-mouseover="' + $viewId + 'over()"><span class="_zs_gallery_mx-status_base_-status-icon" style="color: ';
    $line = 5;
    $art = '=cur.color';
    ;
    ...
    if (!readonly) {
        ;
        $p += '<i mxs="_zs_gallerycs:_" class="_zs_gallery_mx-status_base_-status-arrow"></i>';
        $line = 8;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (show) {
        ...
        if (readonly) {
            ;
            $p += '<ul mxa="_zs_gallerycs:b" class="_zs_gallery_mx-status_base_-status-info"><li mxa="_zs_gallerycs:c" class="_zs_gallery_mx-status_base_-status-desc"><span class="_zs_gallery_mx-status_base_-status-icon" style="color: ';
            $line = 16;
            $art = '=cur.color';
            ;
            $p += ($expr = '<%=cur.color%>', $e(cur.color)) + ';">';
            ...
            $art = '!cur.icon';
            ;
            $p += ($expr = '<%!cur.icon%>', $n(cur.icon)) + '</span><span mxa="_zs_gallerycs:d" class="_zs_gallery_mx-status_base_-status-name">';
            $line = 17;
            $art = '=cur.text';
            ;
            ...
            ;
            $p += '<ul mxa="_zs_gallerycs:f" class="_zs_gallery_mx-status_base_-status-info">';
            $line = 25;
            $art = 'each list as item';
            ;
            $expr = '<%for (var $art_imqsanortz$art_i = 0, $art_covbucycb$art_c = list.length; $art_imqsanortz$art_i < $art_covbucycb$art_c; $art_imqsanortz$art_i++) {            var item = list[$art_imqsanortz$art_i]%>';
            for (var $art_imqsanortz$art_i = 0, $art_covbucycb$art_c = list.length; $art_imqsanortz$art_i < $art_covbucycb$art_c; $art_imqsanortz$art_i++) {
                var item = list[$art_imqsanortz$art_i];
                ...
                $art = '!item.icon';
                ;
                $p += ($expr = '<%!item.icon%>', $n(item.icon)) + '</span><span mxa="_zs_gallerycs:g" class="_zs_gallery_mx-status_base_-status-name">';
                $line = 28;
                $art = '=item.text';
                ;
                $p += ($expr = '<%=item.text%>', $e(item.text)) + '</span><i mxs="_zs_gallerycs:a" class="mc-iconfont _zs_gallery_mx-status_base_-oper-icon">&#xe65d;</i></li>';
                $line = 31;
                $art = '/each';
                ;
                $expr = '<%}%>';
