...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iwwbbomn$art_i = 0, $art_cxfvotjmwrh$art_c = opers.length; $art_iwwbbomn$art_i < $art_cxfvotjmwrh$art_c; $art_iwwbbomn$art_i++) {        var item = opers[$art_iwwbbomn$art_i]%>';
        for (var $art_iwwbbomn$art_i = 0, $art_cxfvotjmwrh$art_c = opers.length; $art_iwwbbomn$art_i < $art_cxfvotjmwrh$art_c; $art_iwwbbomn$art_i++) {
            var item = opers[$art_iwwbbomn$art_i];
