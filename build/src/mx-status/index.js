...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ibrvlzjtip$art_i = 0, $art_cnimxyyvs$art_c = opers.length; $art_ibrvlzjtip$art_i < $art_cnimxyyvs$art_c; $art_ibrvlzjtip$art_i++) {        var item = opers[$art_ibrvlzjtip$art_i]%>';
        for (var $art_ibrvlzjtip$art_i = 0, $art_cnimxyyvs$art_c = opers.length; $art_ibrvlzjtip$art_i < $art_cnimxyyvs$art_c; $art_ibrvlzjtip$art_i++) {
            var item = opers[$art_ibrvlzjtip$art_i];
