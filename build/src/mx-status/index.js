...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_igwfqql$art_i = 0, $art_cvyciqzyq$art_c = opers.length; $art_igwfqql$art_i < $art_cvyciqzyq$art_c; $art_igwfqql$art_i++) {        var item = opers[$art_igwfqql$art_i]%>';
        for (var $art_igwfqql$art_i = 0, $art_cvyciqzyq$art_c = opers.length; $art_igwfqql$art_i < $art_cvyciqzyq$art_c; $art_igwfqql$art_i++) {
            var item = opers[$art_igwfqql$art_i];
