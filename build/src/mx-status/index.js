...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ilpqsxxn$art_i = 0, $art_cirgedrppl$art_c = opers.length; $art_ilpqsxxn$art_i < $art_cirgedrppl$art_c; $art_ilpqsxxn$art_i++) {        var item = opers[$art_ilpqsxxn$art_i]%>';
        for (var $art_ilpqsxxn$art_i = 0, $art_cirgedrppl$art_c = opers.length; $art_ilpqsxxn$art_i < $art_cirgedrppl$art_c; $art_ilpqsxxn$art_i++) {
            var item = opers[$art_ilpqsxxn$art_i];
