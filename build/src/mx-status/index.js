...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ioxwrrrig$art_i = 0, $art_cmohexfqnl$art_c = opers.length; $art_ioxwrrrig$art_i < $art_cmohexfqnl$art_c; $art_ioxwrrrig$art_i++) {        var item = opers[$art_ioxwrrrig$art_i]%>';
        for (var $art_ioxwrrrig$art_i = 0, $art_cmohexfqnl$art_c = opers.length; $art_ioxwrrrig$art_i < $art_cmohexfqnl$art_c; $art_ioxwrrrig$art_i++) {
            var item = opers[$art_ioxwrrrig$art_i];
