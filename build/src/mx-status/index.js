...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_ilvnocw$art_i = 0, $art_cjleoeqppxi$art_c = list.length; $art_ilvnocw$art_i < $art_cjleoeqppxi$art_c; $art_ilvnocw$art_i++) {            var item = list[$art_ilvnocw$art_i]%>';
            for (var $art_ilvnocw$art_i = 0, $art_cjleoeqppxi$art_c = list.length; $art_ilvnocw$art_i < $art_cjleoeqppxi$art_c; $art_ilvnocw$art_i++) {
                var item = list[$art_ilvnocw$art_i];
