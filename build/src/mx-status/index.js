...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iklvwiw$art_i = 0, $art_czsinfvvvs$art_c = opers.length; $art_iklvwiw$art_i < $art_czsinfvvvs$art_c; $art_iklvwiw$art_i++) {        var item = opers[$art_iklvwiw$art_i]%>';
        for (var $art_iklvwiw$art_i = 0, $art_czsinfvvvs$art_c = opers.length; $art_iklvwiw$art_i < $art_czsinfvvvs$art_c; $art_iklvwiw$art_i++) {
            var item = opers[$art_iklvwiw$art_i];
