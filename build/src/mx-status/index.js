...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycb:_" class="_zs_gallery_mx-status_base_-status" mx-mouseout="' + $viewId + 'out()"><div mxa="_zs_gallerycb:a" class="_zs_gallery_mx-status_base_-status-handle-icon" mx-mouseover="' + $viewId + 'over()"><span class="_zs_gallery_mx-status_base_-status-icon" style="color: ';
    $line = 5;
    $art = '=cur.color';
    ;
    ...
    if (!readonly) {
        ;
        $p += '<i mxs="_zs_gallerycb:_" class="_zs_gallery_mx-status_base_-status-arrow"></i>';
        $line = 8;
        $art = '/if';
        ;
        $p += '';
    ...
    if (show) {
        ...
        if (readonly) {
            ;
            $p += '<ul mxa="_zs_gallerycb:b" class="_zs_gallery_mx-status_base_-status-info"><li mxa="_zs_gallerycb:c" class="_zs_gallery_mx-status_base_-status-desc"><span class="_zs_gallery_mx-status_base_-status-icon" style="color: ';
            $line = 16;
            $art = '=cur.color';
            ;
            $p += '' + ($expr = '<%=cur.color%>', $e(cur.color)) + ';">';
            ...
            $art = '!cur.icon';
            ;
            $p += '' + ($expr = '<%!cur.icon%>', $n(cur.icon)) + '</span><span mxa="_zs_gallerycb:d" class="_zs_gallery_mx-status_base_-status-name">';
            $line = 17;
            $art = '=cur.text';
            ;
            ...
            if (cur.tip) {
                ;
                $p += '<li mxa="_zs_gallerycb:e" class="_zs_gallery_mx-status_base_-status-tip">';
                $line = 20;
                $art = '=cur.tip';
                ;
            ...
            ;
            $p += '<ul mxa="_zs_gallerycb:f" class="_zs_gallery_mx-status_base_-status-info">';
            $line = 25;
            $art = 'each list as item';
            ;
            $p += '';
            $expr = '<%for (var $art_ipqufrfte$art_i = 0, $art_cnvweaqvj$art_c = list.length; $art_ipqufrfte$art_i < $art_cnvweaqvj$art_c; $art_ipqufrfte$art_i++) {            var item = list[$art_ipqufrfte$art_i]%>';
            for (var $art_ipqufrfte$art_i = 0, $art_cnvweaqvj$art_c = list.length; $art_ipqufrfte$art_i < $art_cnvweaqvj$art_c; $art_ipqufrfte$art_i++) {
                var item = list[$art_ipqufrfte$art_i];
                ...
                $art = '!item.icon';
                ;
                $p += '' + ($expr = '<%!item.icon%>', $n(item.icon)) + '</span><span mxa="_zs_gallerycb:g" class="_zs_gallery_mx-status_base_-status-name">';
                $line = 28;
                $art = '=item.text';
                ;
                $p += '' + ($expr = '<%=item.text%>', $e(item.text)) + '</span><i mxs="_zs_gallerycb:a" class="mc-iconfont _zs_gallery_mx-status_base_-oper-icon">&#xe65d;</i></li>';
                $line = 31;
                $art = '/each';
                ;
                $p += '';
