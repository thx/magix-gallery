...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_isckvefsahy$art_i = 0, $art_cmksoufdsm$art_c = opers.length; $art_isckvefsahy$art_i < $art_cmksoufdsm$art_c; $art_isckvefsahy$art_i++) {        var item = opers[$art_isckvefsahy$art_i]%>';
        for (var $art_isckvefsahy$art_i = 0, $art_cmksoufdsm$art_c = opers.length; $art_isckvefsahy$art_i < $art_cmksoufdsm$art_c; $art_isckvefsahy$art_i++) {
            var item = opers[$art_isckvefsahy$art_i];
