...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_irpwjr$art_i = 0, $art_cnknjtljutm$art_c = opers.length; $art_irpwjr$art_i < $art_cnknjtljutm$art_c; $art_irpwjr$art_i++) {        var item = opers[$art_irpwjr$art_i]%>';
        for (var $art_irpwjr$art_i = 0, $art_cnknjtljutm$art_c = opers.length; $art_irpwjr$art_i < $art_cnknjtljutm$art_c; $art_irpwjr$art_i++) {
            var item = opers[$art_irpwjr$art_i];
