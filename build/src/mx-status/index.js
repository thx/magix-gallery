...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ipxdzftgi$art_i = 0, $art_cmtccqzwl$art_c = opers.length; $art_ipxdzftgi$art_i < $art_cmtccqzwl$art_c; $art_ipxdzftgi$art_i++) {        var item = opers[$art_ipxdzftgi$art_i]%>';
        for (var $art_ipxdzftgi$art_i = 0, $art_cmtccqzwl$art_c = opers.length; $art_ipxdzftgi$art_i < $art_cmtccqzwl$art_c; $art_ipxdzftgi$art_i++) {
            var item = opers[$art_ipxdzftgi$art_i];
