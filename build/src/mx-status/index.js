...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iaeaqajp$art_i = 0, $art_culaqkuew$art_c = opers.length; $art_iaeaqajp$art_i < $art_culaqkuew$art_c; $art_iaeaqajp$art_i++) {        var item = opers[$art_iaeaqajp$art_i]%>';
        for (var $art_iaeaqajp$art_i = 0, $art_culaqkuew$art_c = opers.length; $art_iaeaqajp$art_i < $art_culaqkuew$art_c; $art_iaeaqajp$art_i++) {
            var item = opers[$art_iaeaqajp$art_i];
