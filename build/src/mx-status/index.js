...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iudkohe$art_i = 0, $art_cqquryjhb$art_c = opers.length; $art_iudkohe$art_i < $art_cqquryjhb$art_c; $art_iudkohe$art_i++) {        var item = opers[$art_iudkohe$art_i]%>';
        for (var $art_iudkohe$art_i = 0, $art_cqquryjhb$art_c = opers.length; $art_iudkohe$art_i < $art_cqquryjhb$art_c; $art_iudkohe$art_i++) {
            var item = opers[$art_iudkohe$art_i];
