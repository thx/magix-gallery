...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ipjgpej$art_i = 0, $art_csnpxhvbd$art_c = opers.length; $art_ipjgpej$art_i < $art_csnpxhvbd$art_c; $art_ipjgpej$art_i++) {        var item = opers[$art_ipjgpej$art_i]%>';
        for (var $art_ipjgpej$art_i = 0, $art_csnpxhvbd$art_c = opers.length; $art_ipjgpej$art_i < $art_csnpxhvbd$art_c; $art_ipjgpej$art_i++) {
            var item = opers[$art_ipjgpej$art_i];
