...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ihaibuh$art_i = 0, $art_cbxmtttvj$art_c = opers.length; $art_ihaibuh$art_i < $art_cbxmtttvj$art_c; $art_ihaibuh$art_i++) {        var item = opers[$art_ihaibuh$art_i]%>';
        for (var $art_ihaibuh$art_i = 0, $art_cbxmtttvj$art_c = opers.length; $art_ihaibuh$art_i < $art_cbxmtttvj$art_c; $art_ihaibuh$art_i++) {
            var item = opers[$art_ihaibuh$art_i];
