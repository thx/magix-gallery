...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iodtlny$art_i = 0, $art_cogtnb$art_c = opers.length; $art_iodtlny$art_i < $art_cogtnb$art_c; $art_iodtlny$art_i++) {        var item = opers[$art_iodtlny$art_i]%>';
        for (var $art_iodtlny$art_i = 0, $art_cogtnb$art_c = opers.length; $art_iodtlny$art_i < $art_cogtnb$art_c; $art_iodtlny$art_i++) {
            var item = opers[$art_iodtlny$art_i];
