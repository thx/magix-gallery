...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ipsyqiwxna$art_i = 0, $art_czxkajey$art_c = opers.length; $art_ipsyqiwxna$art_i < $art_czxkajey$art_c; $art_ipsyqiwxna$art_i++) {        var item = opers[$art_ipsyqiwxna$art_i]%>';
        for (var $art_ipsyqiwxna$art_i = 0, $art_czxkajey$art_c = opers.length; $art_ipsyqiwxna$art_i < $art_czxkajey$art_c; $art_ipsyqiwxna$art_i++) {
            var item = opers[$art_ipsyqiwxna$art_i];
