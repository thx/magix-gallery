...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_ircayulio$art_i = 0, $art_cctvfrznu$art_c = list.length; $art_ircayulio$art_i < $art_cctvfrznu$art_c; $art_ircayulio$art_i++) {            var item = list[$art_ircayulio$art_i]%>';
            for (var $art_ircayulio$art_i = 0, $art_cctvfrznu$art_c = list.length; $art_ircayulio$art_i < $art_cctvfrznu$art_c; $art_ircayulio$art_i++) {
                var item = list[$art_ircayulio$art_i];
