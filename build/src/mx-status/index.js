...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iywbesjsw$art_i = 0, $art_cutyjwrj$art_c = list.length; $art_iywbesjsw$art_i < $art_cutyjwrj$art_c; $art_iywbesjsw$art_i++) {            var item = list[$art_iywbesjsw$art_i]%>';
            for (var $art_iywbesjsw$art_i = 0, $art_cutyjwrj$art_c = list.length; $art_iywbesjsw$art_i < $art_cutyjwrj$art_c; $art_iywbesjsw$art_i++) {
                var item = list[$art_iywbesjsw$art_i];
