...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_icrxrrvgo$art_i = 0, $art_ctusqki$art_c = opers.length; $art_icrxrrvgo$art_i < $art_ctusqki$art_c; $art_icrxrrvgo$art_i++) {        var item = opers[$art_icrxrrvgo$art_i]%>';
        for (var $art_icrxrrvgo$art_i = 0, $art_ctusqki$art_c = opers.length; $art_icrxrrvgo$art_i < $art_ctusqki$art_c; $art_icrxrrvgo$art_i++) {
            var item = opers[$art_icrxrrvgo$art_i];
