...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ioukdv$art_i = 0, $art_cuqcdfal$art_c = opers.length; $art_ioukdv$art_i < $art_cuqcdfal$art_c; $art_ioukdv$art_i++) {        var item = opers[$art_ioukdv$art_i]%>';
        for (var $art_ioukdv$art_i = 0, $art_cuqcdfal$art_c = opers.length; $art_ioukdv$art_i < $art_cuqcdfal$art_c; $art_ioukdv$art_i++) {
            var item = opers[$art_ioukdv$art_i];
