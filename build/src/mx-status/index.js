...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iqmvete$art_i = 0, $art_ctagvbti$art_c = opers.length; $art_iqmvete$art_i < $art_ctagvbti$art_c; $art_iqmvete$art_i++) {        var item = opers[$art_iqmvete$art_i]%>';
        for (var $art_iqmvete$art_i = 0, $art_ctagvbti$art_c = opers.length; $art_iqmvete$art_i < $art_ctagvbti$art_c; $art_iqmvete$art_i++) {
            var item = opers[$art_iqmvete$art_i];
