...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iqtdqrav$art_i = 0, $art_clrebj$art_c = opers.length; $art_iqtdqrav$art_i < $art_clrebj$art_c; $art_iqtdqrav$art_i++) {        var item = opers[$art_iqtdqrav$art_i]%>';
        for (var $art_iqtdqrav$art_i = 0, $art_clrebj$art_c = opers.length; $art_iqtdqrav$art_i < $art_clrebj$art_c; $art_iqtdqrav$art_i++) {
            var item = opers[$art_iqtdqrav$art_i];
