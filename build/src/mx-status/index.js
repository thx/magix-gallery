...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_igaquzlak$art_i = 0, $art_crwcnmcs$art_c = opers.length; $art_igaquzlak$art_i < $art_crwcnmcs$art_c; $art_igaquzlak$art_i++) {        var item = opers[$art_igaquzlak$art_i]%>';
        for (var $art_igaquzlak$art_i = 0, $art_crwcnmcs$art_c = opers.length; $art_igaquzlak$art_i < $art_crwcnmcs$art_c; $art_igaquzlak$art_i++) {
            var item = opers[$art_igaquzlak$art_i];
