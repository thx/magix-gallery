...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ihulcrgao$art_i = 0, $art_cxhgyzqzlo$art_c = opers.length; $art_ihulcrgao$art_i < $art_cxhgyzqzlo$art_c; $art_ihulcrgao$art_i++) {        var item = opers[$art_ihulcrgao$art_i]%>';
        for (var $art_ihulcrgao$art_i = 0, $art_cxhgyzqzlo$art_c = opers.length; $art_ihulcrgao$art_i < $art_cxhgyzqzlo$art_c; $art_ihulcrgao$art_i++) {
            var item = opers[$art_ihulcrgao$art_i];
