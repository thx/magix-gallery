...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iikjui$art_i = 0, $art_captgbuzp$art_c = opers.length; $art_iikjui$art_i < $art_captgbuzp$art_c; $art_iikjui$art_i++) {        var item = opers[$art_iikjui$art_i]%>';
        for (var $art_iikjui$art_i = 0, $art_captgbuzp$art_c = opers.length; $art_iikjui$art_i < $art_captgbuzp$art_c; $art_iikjui$art_i++) {
            var item = opers[$art_iikjui$art_i];
