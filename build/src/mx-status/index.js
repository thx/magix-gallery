...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iobqeagpn$art_i = 0, $art_camybcru$art_c = opers.length; $art_iobqeagpn$art_i < $art_camybcru$art_c; $art_iobqeagpn$art_i++) {        var item = opers[$art_iobqeagpn$art_i]%>';
        for (var $art_iobqeagpn$art_i = 0, $art_camybcru$art_c = opers.length; $art_iobqeagpn$art_i < $art_camybcru$art_c; $art_iobqeagpn$art_i++) {
            var item = opers[$art_iobqeagpn$art_i];
