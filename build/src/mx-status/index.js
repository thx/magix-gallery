...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ifvpauurbp$art_i = 0, $art_cffnkpcc$art_c = opers.length; $art_ifvpauurbp$art_i < $art_cffnkpcc$art_c; $art_ifvpauurbp$art_i++) {        var item = opers[$art_ifvpauurbp$art_i]%>';
        for (var $art_ifvpauurbp$art_i = 0, $art_cffnkpcc$art_c = opers.length; $art_ifvpauurbp$art_i < $art_cffnkpcc$art_c; $art_ifvpauurbp$art_i++) {
            var item = opers[$art_ifvpauurbp$art_i];
