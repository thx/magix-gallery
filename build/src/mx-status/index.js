...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ijthxvfrf$art_i = 0, $art_cyqlafhhw$art_c = opers.length; $art_ijthxvfrf$art_i < $art_cyqlafhhw$art_c; $art_ijthxvfrf$art_i++) {        var item = opers[$art_ijthxvfrf$art_i]%>';
        for (var $art_ijthxvfrf$art_i = 0, $art_cyqlafhhw$art_c = opers.length; $art_ijthxvfrf$art_i < $art_cyqlafhhw$art_c; $art_ijthxvfrf$art_i++) {
            var item = opers[$art_ijthxvfrf$art_i];
