...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_indnsdmua$art_i = 0, $art_conlkfyhf$art_c = opers.length; $art_indnsdmua$art_i < $art_conlkfyhf$art_c; $art_indnsdmua$art_i++) {        var item = opers[$art_indnsdmua$art_i]%>';
        for (var $art_indnsdmua$art_i = 0, $art_conlkfyhf$art_c = opers.length; $art_indnsdmua$art_i < $art_conlkfyhf$art_c; $art_indnsdmua$art_i++) {
            var item = opers[$art_indnsdmua$art_i];
