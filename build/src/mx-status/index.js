...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iysuzjtvtr$art_i = 0, $art_ciojjtfiy$art_c = opers.length; $art_iysuzjtvtr$art_i < $art_ciojjtfiy$art_c; $art_iysuzjtvtr$art_i++) {        var item = opers[$art_iysuzjtvtr$art_i]%>';
        for (var $art_iysuzjtvtr$art_i = 0, $art_ciojjtfiy$art_c = opers.length; $art_iysuzjtvtr$art_i < $art_ciojjtfiy$art_c; $art_iysuzjtvtr$art_i++) {
            var item = opers[$art_iysuzjtvtr$art_i];
