...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $expr = '<%for (var $art_ieklftflo$art_i = 0, $art_cvypfhk$art_c = list.length; $art_ieklftflo$art_i < $art_cvypfhk$art_c; $art_ieklftflo$art_i++) {            var item = list[$art_ieklftflo$art_i]%>';
            for (var $art_ieklftflo$art_i = 0, $art_cvypfhk$art_c = list.length; $art_ieklftflo$art_i < $art_cvypfhk$art_c; $art_ieklftflo$art_i++) {
                var item = list[$art_ieklftflo$art_i];
