...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ifaclvf$art_i = 0, $art_cxstdjuc$art_c = opers.length; $art_ifaclvf$art_i < $art_cxstdjuc$art_c; $art_ifaclvf$art_i++) {        var item = opers[$art_ifaclvf$art_i]%>';
        for (var $art_ifaclvf$art_i = 0, $art_cxstdjuc$art_c = opers.length; $art_ifaclvf$art_i < $art_cxstdjuc$art_c; $art_ifaclvf$art_i++) {
            var item = opers[$art_ifaclvf$art_i];
