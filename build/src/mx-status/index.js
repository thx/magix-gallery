...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_icekxvklu$art_i = 0, $art_cmxlehpa$art_c = opers.length; $art_icekxvklu$art_i < $art_cmxlehpa$art_c; $art_icekxvklu$art_i++) {        var item = opers[$art_icekxvklu$art_i]%>';
        for (var $art_icekxvklu$art_i = 0, $art_cmxlehpa$art_c = opers.length; $art_icekxvklu$art_i < $art_cmxlehpa$art_c; $art_icekxvklu$art_i++) {
            var item = opers[$art_icekxvklu$art_i];
