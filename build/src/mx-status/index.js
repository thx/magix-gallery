...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_igvkrjivpls$art_i = 0, $art_cpecggy$art_c = opers.length; $art_igvkrjivpls$art_i < $art_cpecggy$art_c; $art_igvkrjivpls$art_i++) {        var item = opers[$art_igvkrjivpls$art_i]%>';
        for (var $art_igvkrjivpls$art_i = 0, $art_cpecggy$art_c = opers.length; $art_igvkrjivpls$art_i < $art_cpecggy$art_c; $art_igvkrjivpls$art_i++) {
            var item = opers[$art_igvkrjivpls$art_i];
