...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $expr = '<%for (var $art_ichvkpstmyxd$art_i = 0, $art_cluxndbag$art_c = list.length; $art_ichvkpstmyxd$art_i < $art_cluxndbag$art_c; $art_ichvkpstmyxd$art_i++) {            var item = list[$art_ichvkpstmyxd$art_i]%>';
            for (var $art_ichvkpstmyxd$art_i = 0, $art_cluxndbag$art_c = list.length; $art_ichvkpstmyxd$art_i < $art_cluxndbag$art_c; $art_ichvkpstmyxd$art_i++) {
                var item = list[$art_ichvkpstmyxd$art_i];
