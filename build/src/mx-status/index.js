...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iwvchaclk$art_i = 0, $art_cwqwpwkr$art_c = list.length; $art_iwvchaclk$art_i < $art_cwqwpwkr$art_c; $art_iwvchaclk$art_i++) {            var item = list[$art_iwvchaclk$art_i]%>';
            for (var $art_iwvchaclk$art_i = 0, $art_cwqwpwkr$art_c = list.length; $art_iwvchaclk$art_i < $art_cwqwpwkr$art_c; $art_iwvchaclk$art_i++) {
                var item = list[$art_iwvchaclk$art_i];
