...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ifgehgpzte$art_i = 0, $art_cntloiq$art_c = opers.length; $art_ifgehgpzte$art_i < $art_cntloiq$art_c; $art_ifgehgpzte$art_i++) {        var item = opers[$art_ifgehgpzte$art_i]%>';
        for (var $art_ifgehgpzte$art_i = 0, $art_cntloiq$art_c = opers.length; $art_ifgehgpzte$art_i < $art_cntloiq$art_c; $art_ifgehgpzte$art_i++) {
            var item = opers[$art_ifgehgpzte$art_i];
