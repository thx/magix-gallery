...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ietzuuxrbg$art_i = 0, $art_cckdouji$art_c = opers.length; $art_ietzuuxrbg$art_i < $art_cckdouji$art_c; $art_ietzuuxrbg$art_i++) {        var item = opers[$art_ietzuuxrbg$art_i]%>';
        for (var $art_ietzuuxrbg$art_i = 0, $art_cckdouji$art_c = opers.length; $art_ietzuuxrbg$art_i < $art_cckdouji$art_c; $art_ietzuuxrbg$art_i++) {
            var item = opers[$art_ietzuuxrbg$art_i];
