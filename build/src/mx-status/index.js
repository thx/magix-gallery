...
module.exports = Base.extend({
    ...
    if (show) {
        ;
        $p += '<ul mxa="_zs_gallerycs:b" class="_zs_gallery_mx-status_base_-status-info">';
        $line = 18;
        $art = 'if showInfo';
        ;
        $expr = '<%if (showInfo) {%>';
        if (showInfo) {
            ;
            $p += '<li mxa="_zs_gallerycs:c" class="_zs_gallery_mx-status_base_-status-desc"><span class="_zs_gallery_mx-status_base_-status-icon" style="color: ';
            $line = 20;
            $art = '=info.color';
            ;
            $p += ($expr = '<%=info.color%>', $e(info.color)) + ';">';
            ...
            if (opers.length > 0) {
                ;
                $p += '<li mxs="_zs_gallerycs:a" class="_zs_gallery_mx-status_base_-status-line"></li>';
                $line = 28;
                $art = '/if';
                ;
                $expr = '<%}%>';
        ...
        ;
        $expr = '<%for (var $art_iaiibszrqf$art_i = 0, $art_csfdsmazkl$art_c = opers.length; $art_iaiibszrqf$art_i < $art_csfdsmazkl$art_c; $art_iaiibszrqf$art_i++) {        var item = opers[$art_iaiibszrqf$art_i]%>';
        for (var $art_iaiibszrqf$art_i = 0, $art_csfdsmazkl$art_c = opers.length; $art_iaiibszrqf$art_i < $art_csfdsmazkl$art_c; $art_iaiibszrqf$art_i++) {
            var item = opers[$art_iaiibszrqf$art_i];
