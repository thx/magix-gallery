...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_itfvgpqd$art_i = 0, $art_cvimhsswik$art_c = opers.length; $art_itfvgpqd$art_i < $art_cvimhsswik$art_c; $art_itfvgpqd$art_i++) {        var item = opers[$art_itfvgpqd$art_i]%>';
        for (var $art_itfvgpqd$art_i = 0, $art_cvimhsswik$art_c = opers.length; $art_itfvgpqd$art_i < $art_cvimhsswik$art_c; $art_itfvgpqd$art_i++) {
            var item = opers[$art_itfvgpqd$art_i];
