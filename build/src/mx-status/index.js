...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ivnopocgxg$art_i = 0, $art_ctjxytrg$art_c = opers.length; $art_ivnopocgxg$art_i < $art_ctjxytrg$art_c; $art_ivnopocgxg$art_i++) {        var item = opers[$art_ivnopocgxg$art_i]%>';
        for (var $art_ivnopocgxg$art_i = 0, $art_ctjxytrg$art_c = opers.length; $art_ivnopocgxg$art_i < $art_ctjxytrg$art_c; $art_ivnopocgxg$art_i++) {
            var item = opers[$art_ivnopocgxg$art_i];
