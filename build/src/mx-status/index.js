...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_incztpmsj$art_i = 0, $art_ckestvgmwii$art_c = opers.length; $art_incztpmsj$art_i < $art_ckestvgmwii$art_c; $art_incztpmsj$art_i++) {        var item = opers[$art_incztpmsj$art_i]%>';
        for (var $art_incztpmsj$art_i = 0, $art_ckestvgmwii$art_c = opers.length; $art_incztpmsj$art_i < $art_ckestvgmwii$art_c; $art_incztpmsj$art_i++) {
            var item = opers[$art_incztpmsj$art_i];
