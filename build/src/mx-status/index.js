...
module.exports = Base.extend({
    ...
    if (show) {
        ;
        $p += '<ul mxa="_zs_gallerydS:b" class="mx-shadow _zs_gallery_mx-status_base_-status-info">';
        $line = 18;
        $art = 'if showInfo';
        ;
        $expr = '<%if (showInfo) {%>';
        ...
        ;
        $expr = '<%for (var $art_iitqngcmd$art_i = 0, $art_cvvmkhua$art_c = opers.length; $art_iitqngcmd$art_i < $art_cvvmkhua$art_c; $art_iitqngcmd$art_i++) {        var item = opers[$art_iitqngcmd$art_i]%>';
        for (var $art_iitqngcmd$art_i = 0, $art_cvvmkhua$art_c = opers.length; $art_iitqngcmd$art_i < $art_cvvmkhua$art_c; $art_iitqngcmd$art_i++) {
            var item = opers[$art_iitqngcmd$art_i];
