...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_ilasdspef$art_i = 0, $art_cxuxjewhxa$art_c = opers.length; $art_ilasdspef$art_i < $art_cxuxjewhxa$art_c; $art_ilasdspef$art_i++) {        var item = opers[$art_ilasdspef$art_i]%>';
        for (var $art_ilasdspef$art_i = 0, $art_cxuxjewhxa$art_c = opers.length; $art_ilasdspef$art_i < $art_cxuxjewhxa$art_c; $art_ilasdspef$art_i++) {
            var item = opers[$art_ilasdspef$art_i];
