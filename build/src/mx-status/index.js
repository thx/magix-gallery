...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iodebfwshk$art_i = 0, $art_cadajnuyq$art_c = opers.length; $art_iodebfwshk$art_i < $art_cadajnuyq$art_c; $art_iodebfwshk$art_i++) {        var item = opers[$art_iodebfwshk$art_i]%>';
        for (var $art_iodebfwshk$art_i = 0, $art_cadajnuyq$art_c = opers.length; $art_iodebfwshk$art_i < $art_cadajnuyq$art_c; $art_iodebfwshk$art_i++) {
            var item = opers[$art_iodebfwshk$art_i];
