...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iunohiqnbn$art_i = 0, $art_ccbxqpghhu$art_c = opers.length; $art_iunohiqnbn$art_i < $art_ccbxqpghhu$art_c; $art_iunohiqnbn$art_i++) {        var item = opers[$art_iunohiqnbn$art_i]%>';
        for (var $art_iunohiqnbn$art_i = 0, $art_ccbxqpghhu$art_c = opers.length; $art_iunohiqnbn$art_i < $art_ccbxqpghhu$art_c; $art_iunohiqnbn$art_i++) {
            var item = opers[$art_iunohiqnbn$art_i];
