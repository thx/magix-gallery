...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iesqzgpov$art_i = 0, $art_caclfpj$art_c = opers.length; $art_iesqzgpov$art_i < $art_caclfpj$art_c; $art_iesqzgpov$art_i++) {        var item = opers[$art_iesqzgpov$art_i]%>';
        for (var $art_iesqzgpov$art_i = 0, $art_caclfpj$art_c = opers.length; $art_iesqzgpov$art_i < $art_caclfpj$art_c; $art_iesqzgpov$art_i++) {
            var item = opers[$art_iesqzgpov$art_i];
