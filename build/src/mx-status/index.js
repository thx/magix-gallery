...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_imjnxo$art_i = 0, $art_cqjueihnnt$art_c = opers.length; $art_imjnxo$art_i < $art_cqjueihnnt$art_c; $art_imjnxo$art_i++) {        var item = opers[$art_imjnxo$art_i]%>';
        for (var $art_imjnxo$art_i = 0, $art_cqjueihnnt$art_c = opers.length; $art_imjnxo$art_i < $art_cqjueihnnt$art_c; $art_imjnxo$art_i++) {
            var item = opers[$art_imjnxo$art_i];
