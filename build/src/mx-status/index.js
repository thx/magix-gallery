...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        ;
        $expr = '<%for (var $art_iyebbejun$art_i = 0, $art_chilyfv$art_c = opers.length; $art_iyebbejun$art_i < $art_chilyfv$art_c; $art_iyebbejun$art_i++) {        var item = opers[$art_iyebbejun$art_i]%>';
        for (var $art_iyebbejun$art_i = 0, $art_chilyfv$art_c = opers.length; $art_iyebbejun$art_i < $art_chilyfv$art_c; $art_iyebbejun$art_i++) {
            var item = opers[$art_iyebbejun$art_i];
