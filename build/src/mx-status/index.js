...
module.exports = Base.extend({
    ...
    if (show) {
        ...
        if (readonly) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iviwakvmc$art_i = 0, $art_cdxmtb$art_c = list.length; $art_iviwakvmc$art_i < $art_cdxmtb$art_c; $art_iviwakvmc$art_i++) {            var item = list[$art_iviwakvmc$art_i]%>';
            for (var $art_iviwakvmc$art_i = 0, $art_cdxmtb$art_c = list.length; $art_iviwakvmc$art_i < $art_cdxmtb$art_c; $art_iviwakvmc$art_i++) {
                var item = list[$art_iviwakvmc$art_i];
