...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_icogribs$art_i = 0, $art_czufjwm$art_c = options.length; $art_icogribs$art_i < $art_czufjwm$art_c; $art_icogribs$art_i++) {    var option = options[$art_icogribs$art_i]%>';
    for (var $art_icogribs$art_i = 0, $art_czufjwm$art_c = options.length; $art_icogribs$art_i < $art_czufjwm$art_c; $art_icogribs$art_i++) {
        var option = options[$art_icogribs$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=option.key';
        ;
