...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_izoqwls$art_i = 0, $art_cfsnklca$art_c = options.length; $art_izoqwls$art_i < $art_cfsnklca$art_c; $art_izoqwls$art_i++) {    var option = options[$art_izoqwls$art_i]%>';
    for (var $art_izoqwls$art_i = 0, $art_cfsnklca$art_c = options.length; $art_izoqwls$art_i < $art_cfsnklca$art_c; $art_izoqwls$art_i++) {
        var option = options[$art_izoqwls$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=option.key';
        ;
