...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ixjablgplp$art_i = 0, $art_cchxypaif$art_c = options.length; $art_ixjablgplp$art_i < $art_cchxypaif$art_c; $art_ixjablgplp$art_i++) {    var option = options[$art_ixjablgplp$art_i]%>';
    for (var $art_ixjablgplp$art_i = 0, $art_cchxypaif$art_c = options.length; $art_ixjablgplp$art_i < $art_cchxypaif$art_c; $art_ixjablgplp$art_i++) {
        var option = options[$art_ixjablgplp$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=option.key';
        ;
