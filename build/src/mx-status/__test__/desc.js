...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_irusnuwebb$art_i = 0, $art_cxdrzopsvabb$art_c = options.length; $art_irusnuwebb$art_i < $art_cxdrzopsvabb$art_c; $art_irusnuwebb$art_i++) {    var option = options[$art_irusnuwebb$art_i]%>';
    for (var $art_irusnuwebb$art_i = 0, $art_cxdrzopsvabb$art_c = options.length; $art_irusnuwebb$art_i < $art_cxdrzopsvabb$art_c; $art_irusnuwebb$art_i++) {
        var option = options[$art_irusnuwebb$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=option.key';
        ;
