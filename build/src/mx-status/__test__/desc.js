...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_inzyedpqkps$art_i = 0, $art_cguiifro$art_c = options.length; $art_inzyedpqkps$art_i < $art_cguiifro$art_c; $art_inzyedpqkps$art_i++) {    var option = options[$art_inzyedpqkps$art_i]%>';
    for (var $art_inzyedpqkps$art_i = 0, $art_cguiifro$art_c = options.length; $art_inzyedpqkps$art_i < $art_cguiifro$art_c; $art_inzyedpqkps$art_i++) {
        var option = options[$art_inzyedpqkps$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=option.key';
        ;
