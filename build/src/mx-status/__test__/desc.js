...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iqhibga$art_i = 0, $art_cenebqnw$art_c = options.length; $art_iqhibga$art_i < $art_cenebqnw$art_c; $art_iqhibga$art_i++) {    var option = options[$art_iqhibga$art_i]%>';
    for (var $art_iqhibga$art_i = 0, $art_cenebqnw$art_c = options.length; $art_iqhibga$art_i < $art_cenebqnw$art_c; $art_iqhibga$art_i++) {
        var option = options[$art_iqhibga$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=option.key';
        ;
