...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_igicaqjms$art_i = 0, $art_cdbrbni$art_c = options.length; $art_igicaqjms$art_i < $art_cdbrbni$art_c; $art_igicaqjms$art_i++) {    var option = options[$art_igicaqjms$art_i]%>';
    for (var $art_igicaqjms$art_i = 0, $art_cdbrbni$art_c = options.length; $art_igicaqjms$art_i < $art_cdbrbni$art_c; $art_igicaqjms$art_i++) {
        var option = options[$art_igicaqjms$art_i];
        $p += '<tr><td>';
        $line = 33;
        $art = '=option.key';
        ;
