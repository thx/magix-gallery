...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydQ:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydQ:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydQ:_" class="mb20 lh22 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div>纯提示信息，无操作项</div></div></div><div mx-view="mx-status/index?info=';
    $line = 10;
    $art = '@{\n                value: 1,\n                text: \'正在投放\',\n                icon: \'<i class=\\"mc-iconfont\\">&#xe683;</i>\',\n                tip: \'当前正在投放中<br/>换一行\'\n                color: \'#51a300\'\n            }';
    ;
    $p += ($expr = '<%@{        value: 1,        text: \'正在投放\',        icon: \'<i class=\\"mc-iconfont\\">&#xe683;</i>\',        tip: \'当前正在投放中<br/>换一行\',        color: \'#51a300\'    }%>', $i($$ref, { value: 1, text: '正在投放', icon: '<i class=\"mc-iconfont\">&#xe683;</i>', tip: '当前正在投放中<br/>换一行', color: '#51a300' })) + '"></div></div><div mxa="_zs_gallerydQ:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydQ:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
