...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryd@:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryd@:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryd@:_" class="mb20 lh22 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div>纯提示信息，无操作项</div></div></div><div mx-view="mx-status/index?info=';
    $line = 10;
