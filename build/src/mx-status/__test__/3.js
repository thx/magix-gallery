...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb9:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_galleryb9:a" class="_zs_gallery___test___base_-eg-content"><div mxs="_zs_galleryb9:_" class="mb20 lh22 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div>有多个可选项，配置成只读，依然显示为只读</div><div>可配置额外的说明文案</div></div></div><div mx-view="mx-status/index?list=';
    $line = 11;
    $art = '@[{\n                value: 1,\n                text: \'正在投放\',\n                icon: \'<i class=\\"mc-iconfont\\">&#xe683;</i>\',\n                tip: \'当前正在投放中\'\n                color: \'#51a300\'\n            }, {\n                value: 9,\n                text: \'结束投放\',\n                icon: \'<i class=\\"mc-iconfont\\">&#xe682;</i>\',\n                color: \'#999999\'\n            }]';
    ;
    $p += '' + ($expr = '<%@[{            value: 1,            text: \'正在投放\',            icon: \'<i class=\\"mc-iconfont\\">&#xe683;</i>\',            tip: \'当前正在投放中\',            color: \'#51a300\'        }, {            value: 9,            text: \'结束投放\',            icon: \'<i class=\\"mc-iconfont\\">&#xe682;</i>\',            color: \'#999999\'        }]%>', $i($$ref, [{ value: 1, text: '正在投放', icon: '<i class=\"mc-iconfont\">&#xe683;</i>', tip: '当前正在投放中', color: '#51a300' }, { value: 9, text: '结束投放', icon: '<i class=\"mc-iconfont\">&#xe682;</i>', color: '#999999' }])) + '&selected=9&readonly=true"></div></div><div mxa="_zs_galleryb9:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryb9:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 28;
    $art = '=viewId';
    ;
