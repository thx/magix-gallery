...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_gallerycp:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_gallerycp:d" class="clearfix mb20"><div class="clearfix"><div class="_zs_gallery___test___layout_-half"><div mx-view="mx-status/__test__/4"></div></div><div class="_zs_gallery___test___layout_-half"><div mx-view="mx-status/__test__/5"></div></div></div></div><div mxs="_zs_gallerycp:b" mx-view="mx-status/__test__/desc"></div>';
}
catch (ex) {
