...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerydG:a" class="clearfix mb20"><div mxa="_zs_gallerydG:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-status/__test__/4" id="';
    $line = 23;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_gallerydG:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-status/__test__/5" id="';
    $line = 26;
    $art = '=viewId';
    ;
