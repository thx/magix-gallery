...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc{:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryc{:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryc{:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div>纯操作项，hover显示操作项</div><div>当前选中项排在第一个</div></div></div><div mxv><span mxa="_zs_galleryc{:b" class="mr40"><span mxs="_zs_galleryc{:a" class="color-9">当前选中项：</span>';
    $line = 13;
    $art = '=cur.text';
    ;
    ...
    $art = '=cur.value';
    ;
    $p += ($expr = '<%!$eu(cur.value)%>', $eu(cur.value)) + '"></div></div></div><div mxa="_zs_galleryc{:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryc{:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 23;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-status.dropdown\n    opers="&#123;&#123;@opers&#125;&#125;" \n    selected="&#123;&#123;=cur.value&#125;&#125;"\n    mx-change="change()"/&gt;</pre></div><div mxa="_zs_galleryc{:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryc{:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
