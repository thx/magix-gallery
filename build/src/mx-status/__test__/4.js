...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb[:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb[:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryb[:b" class="mb20"><span mxs="_zs_galleryb[:_"><span class="color-9">以下示例：</span>当前选中项排在第一个</span><span mxa="_zs_galleryb[:c" class="ml40"><span mxs="_zs_galleryb[:a" class="color-9">当前选中项：</span>';
    $line = 10;
    $art = '=cur.text';
    ;
    ...
    $art = '=cur.value';
    ;
    $p += '' + ($expr = '<%!$eu(cur.value)%>', $eu(cur.value)) + '"></div></div><div mxa="_zs_galleryb[:d" class="clearfix"><div mxa="_zs_galleryb[:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_galleryb[:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 21;
    $art = '=viewId';
    ;
