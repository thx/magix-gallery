...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_icqqcweqwf$art_i = 0, $art_cztufvtmd$art_c = list.length; $art_icqqcweqwf$art_i < $art_cztufvtmd$art_c; $art_icqqcweqwf$art_i++) {        var item = list[$art_icqqcweqwf$art_i]%>';
        for (var $art_icqqcweqwf$art_i = 0, $art_cztufvtmd$art_c = list.length; $art_icqqcweqwf$art_i < $art_cztufvtmd$art_c; $art_icqqcweqwf$art_i++) {
            var item = list[$art_icqqcweqwf$art_i];
