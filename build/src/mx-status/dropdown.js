...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ihofiinwgn$art_i = 0, $art_ccinjpj$art_c = opers.length; $art_ihofiinwgn$art_i < $art_ccinjpj$art_c; $art_ihofiinwgn$art_i++) {            var item = opers[$art_ihofiinwgn$art_i]%>';
            for (var $art_ihofiinwgn$art_i = 0, $art_ccinjpj$art_c = opers.length; $art_ihofiinwgn$art_i < $art_ccinjpj$art_c; $art_ihofiinwgn$art_i++) {
                var item = opers[$art_ihofiinwgn$art_i];
