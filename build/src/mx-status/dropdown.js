...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_itnqrvkp$art_i = 0, $art_ceenpfnghvo$art_c = opers.length; $art_itnqrvkp$art_i < $art_ceenpfnghvo$art_c; $art_itnqrvkp$art_i++) {        var item = opers[$art_itnqrvkp$art_i]%>';
        for (var $art_itnqrvkp$art_i = 0, $art_ceenpfnghvo$art_c = opers.length; $art_itnqrvkp$art_i < $art_ceenpfnghvo$art_c; $art_itnqrvkp$art_i++) {
            var item = opers[$art_itnqrvkp$art_i];
