...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycr:_" class="_zs_gallery_mx-status_base_-status" mx-mouseout="' + $viewId + 'out()"><div mxa="_zs_gallerycr:a" class="_zs_gallery_mx-status_base_-status-handle-dd" mx-mouseover="' + $viewId + 'over()"><span class="input _zs_gallery_mx-status_base_-status-input ';
    $line = 5;
    $art = 'if readonly';
    ;
    $expr = '<%if (readonly) {%>';
    ...
    $art = '=cur.text';
    ;
    $p += ($expr = '<%=cur.text%>', $e(cur.text)) + '</span><i mxs="_zs_gallerycr:_" class="mc-iconfont _zs_gallery_mx-status_base_-status-arrow">&#xe692;</i></div>';
    $line = 10;
    ...
    if (show && !readonly) {
        ...
        ;
        $expr = '<%for (var $art_ijtgypfy$art_i = 0, $art_cgjaicyjonb$art_c = list.length; $art_ijtgypfy$art_i < $art_cgjaicyjonb$art_c; $art_ijtgypfy$art_i++) {        var item = list[$art_ijtgypfy$art_i]%>';
        for (var $art_ijtgypfy$art_i = 0, $art_cgjaicyjonb$art_c = list.length; $art_ijtgypfy$art_i < $art_cgjaicyjonb$art_c; $art_ijtgypfy$art_i++) {
            var item = list[$art_ijtgypfy$art_i];
