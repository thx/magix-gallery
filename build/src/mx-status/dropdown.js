...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_icnfquapp$art_i = 0, $art_cloardyvo$art_c = opers.length; $art_icnfquapp$art_i < $art_cloardyvo$art_c; $art_icnfquapp$art_i++) {        var item = opers[$art_icnfquapp$art_i]%>';
        for (var $art_icnfquapp$art_i = 0, $art_cloardyvo$art_c = opers.length; $art_icnfquapp$art_i < $art_cloardyvo$art_c; $art_icnfquapp$art_i++) {
            var item = opers[$art_icnfquapp$art_i];
