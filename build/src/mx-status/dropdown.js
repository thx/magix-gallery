...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iubvyjsno$art_i = 0, $art_cbumjtp$art_c = opers.length; $art_iubvyjsno$art_i < $art_cbumjtp$art_c; $art_iubvyjsno$art_i++) {        var item = opers[$art_iubvyjsno$art_i]%>';
        for (var $art_iubvyjsno$art_i = 0, $art_cbumjtp$art_c = opers.length; $art_iubvyjsno$art_i < $art_cbumjtp$art_c; $art_iubvyjsno$art_i++) {
            var item = opers[$art_iubvyjsno$art_i];
