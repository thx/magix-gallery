...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ishsrqkr$art_i = 0, $art_ckbgjueebet$art_c = opers.length; $art_ishsrqkr$art_i < $art_ckbgjueebet$art_c; $art_ishsrqkr$art_i++) {        var item = opers[$art_ishsrqkr$art_i]%>';
        for (var $art_ishsrqkr$art_i = 0, $art_ckbgjueebet$art_c = opers.length; $art_ishsrqkr$art_i < $art_ckbgjueebet$art_c; $art_ishsrqkr$art_i++) {
            var item = opers[$art_ishsrqkr$art_i];
