...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iowxryqs$art_i = 0, $art_coiprccyfac$art_c = opers.length; $art_iowxryqs$art_i < $art_coiprccyfac$art_c; $art_iowxryqs$art_i++) {            var item = opers[$art_iowxryqs$art_i]%>';
            for (var $art_iowxryqs$art_i = 0, $art_coiprccyfac$art_c = opers.length; $art_iowxryqs$art_i < $art_coiprccyfac$art_c; $art_iowxryqs$art_i++) {
                var item = opers[$art_iowxryqs$art_i];
