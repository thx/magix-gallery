...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $expr = '<%for (var $art_ibvnzleh$art_i = 0, $art_clogsedtav$art_c = list.length; $art_ibvnzleh$art_i < $art_clogsedtav$art_c; $art_ibvnzleh$art_i++) {        var item = list[$art_ibvnzleh$art_i]%>';
        for (var $art_ibvnzleh$art_i = 0, $art_clogsedtav$art_c = list.length; $art_ibvnzleh$art_i < $art_clogsedtav$art_c; $art_ibvnzleh$art_i++) {
            var item = list[$art_ibvnzleh$art_i];
