...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ivegnga$art_i = 0, $art_csfigmkhrpi$art_c = opers.length; $art_ivegnga$art_i < $art_csfigmkhrpi$art_c; $art_ivegnga$art_i++) {        var item = opers[$art_ivegnga$art_i]%>';
        for (var $art_ivegnga$art_i = 0, $art_csfigmkhrpi$art_c = opers.length; $art_ivegnga$art_i < $art_csfigmkhrpi$art_c; $art_ivegnga$art_i++) {
            var item = opers[$art_ivegnga$art_i];
