...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycb:_" class="_zs_gallery_mx-status_base_-status" mx-mouseout="' + $viewId + 'out()"><div mxa="_zs_gallerycb:a" class="_zs_gallery_mx-status_base_-status-handle-dd" mx-mouseover="' + $viewId + 'over()"><span class="input _zs_gallery_mx-status_base_-status-input ';
    $line = 5;
    $art = 'if readonly';
    ;
    $p += '';
    ...
    $art = '=cur.text';
    ;
    $p += '' + ($expr = '<%=cur.text%>', $e(cur.text)) + '</span><i mxs="_zs_gallerycb:_" class="mc-iconfont _zs_gallery_mx-status_base_-status-arrow">&#xe692;</i></div>';
    $line = 10;
    ...
    if (show && !readonly) {
        ;
        $p += '<ul mxa="_zs_gallerycb:b" class="_zs_gallery_mx-status_base_-status-info _zs_gallery_mx-status_base_-status-info-dd">';
        $line = 12;
        $art = 'each list as item';
        ;
        $p += '';
        $expr = '<%for (var $art_iblmyxbny$art_i = 0, $art_caufccnlci$art_c = list.length; $art_iblmyxbny$art_i < $art_caufccnlci$art_c; $art_iblmyxbny$art_i++) {        var item = list[$art_iblmyxbny$art_i]%>';
        for (var $art_iblmyxbny$art_i = 0, $art_caufccnlci$art_c = list.length; $art_iblmyxbny$art_i < $art_caufccnlci$art_c; $art_iblmyxbny$art_i++) {
            var item = list[$art_iblmyxbny$art_i];
            ...
            $art = '!item.icon';
            ;
            $p += '' + ($expr = '<%!item.icon%>', $n(item.icon)) + '</span><span mxa="_zs_gallerycb:c" class="_zs_gallery_mx-status_base_-status-name">';
            $line = 15;
            $art = '=item.text';
            ;
