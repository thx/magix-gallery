...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ihmtctjmw$art_i = 0, $art_clorkj$art_c = opers.length; $art_ihmtctjmw$art_i < $art_clorkj$art_c; $art_ihmtctjmw$art_i++) {        var item = opers[$art_ihmtctjmw$art_i]%>';
        for (var $art_ihmtctjmw$art_i = 0, $art_clorkj$art_c = opers.length; $art_ihmtctjmw$art_i < $art_clorkj$art_c; $art_ihmtctjmw$art_i++) {
            var item = opers[$art_ihmtctjmw$art_i];
