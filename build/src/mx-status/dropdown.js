...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ipaihytjh$art_i = 0, $art_cdomnawvr$art_c = list.length; $art_ipaihytjh$art_i < $art_cdomnawvr$art_c; $art_ipaihytjh$art_i++) {        var item = list[$art_ipaihytjh$art_i]%>';
        for (var $art_ipaihytjh$art_i = 0, $art_cdomnawvr$art_c = list.length; $art_ipaihytjh$art_i < $art_cdomnawvr$art_c; $art_ipaihytjh$art_i++) {
            var item = list[$art_ipaihytjh$art_i];
