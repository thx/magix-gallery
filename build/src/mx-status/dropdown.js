...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_izamvvgs$art_i = 0, $art_cvjcnkfaa$art_c = opers.length; $art_izamvvgs$art_i < $art_cvjcnkfaa$art_c; $art_izamvvgs$art_i++) {        var item = opers[$art_izamvvgs$art_i]%>';
        for (var $art_izamvvgs$art_i = 0, $art_cvjcnkfaa$art_c = opers.length; $art_izamvvgs$art_i < $art_cvjcnkfaa$art_c; $art_izamvvgs$art_i++) {
            var item = opers[$art_izamvvgs$art_i];
