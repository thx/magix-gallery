...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ixfjloadqc$art_i = 0, $art_cmrzgrjrx$art_c = opers.length; $art_ixfjloadqc$art_i < $art_cmrzgrjrx$art_c; $art_ixfjloadqc$art_i++) {            var item = opers[$art_ixfjloadqc$art_i]%>';
            for (var $art_ixfjloadqc$art_i = 0, $art_cmrzgrjrx$art_c = opers.length; $art_ixfjloadqc$art_i < $art_cmrzgrjrx$art_c; $art_ixfjloadqc$art_i++) {
                var item = opers[$art_ixfjloadqc$art_i];
