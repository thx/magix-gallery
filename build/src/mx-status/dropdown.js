...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iolibbkkke$art_i = 0, $art_cabhuarh$art_c = opers.length; $art_iolibbkkke$art_i < $art_cabhuarh$art_c; $art_iolibbkkke$art_i++) {            var item = opers[$art_iolibbkkke$art_i]%>';
            for (var $art_iolibbkkke$art_i = 0, $art_cabhuarh$art_c = opers.length; $art_iolibbkkke$art_i < $art_cabhuarh$art_c; $art_iolibbkkke$art_i++) {
                var item = opers[$art_iolibbkkke$art_i];
