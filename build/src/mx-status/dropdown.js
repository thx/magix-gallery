...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerych:_" class="_zs_gallery_mx-status_base_-status" mx-mouseout="' + $viewId + 'out()"><div mxa="_zs_gallerych:a" class="_zs_gallery_mx-status_base_-status-handle-dd" mx-mouseover="' + $viewId + 'over()"><span class="input _zs_gallery_mx-status_base_-status-input ';
    $line = 5;
    $art = 'if readonly';
    ;
    $p += '';
    ...
    $art = '=cur.text';
    ;
    $p += '' + ($expr = '<%=cur.text%>', $e(cur.text)) + '</span><i mxs="_zs_gallerych:_" class="mc-iconfont _zs_gallery_mx-status_base_-status-arrow">&#xe692;</i></div>';
    $line = 10;
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iewjfzgdr$art_i = 0, $art_ciggfcyvh$art_c = list.length; $art_iewjfzgdr$art_i < $art_ciggfcyvh$art_c; $art_iewjfzgdr$art_i++) {        var item = list[$art_iewjfzgdr$art_i]%>';
        for (var $art_iewjfzgdr$art_i = 0, $art_ciggfcyvh$art_c = list.length; $art_iewjfzgdr$art_i < $art_ciggfcyvh$art_c; $art_iewjfzgdr$art_i++) {
            var item = list[$art_iewjfzgdr$art_i];
