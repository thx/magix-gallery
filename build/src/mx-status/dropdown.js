...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $expr = '<%for (var $art_ibxjltqcxdu$art_i = 0, $art_cepnmejoq$art_c = list.length; $art_ibxjltqcxdu$art_i < $art_cepnmejoq$art_c; $art_ibxjltqcxdu$art_i++) {        var item = list[$art_ibxjltqcxdu$art_i]%>';
        for (var $art_ibxjltqcxdu$art_i = 0, $art_cepnmejoq$art_c = list.length; $art_ibxjltqcxdu$art_i < $art_cepnmejoq$art_c; $art_ibxjltqcxdu$art_i++) {
            var item = list[$art_ibxjltqcxdu$art_i];
