...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ixvzybywepq$art_i = 0, $art_cdjibx$art_c = opers.length; $art_ixvzybywepq$art_i < $art_cdjibx$art_c; $art_ixvzybywepq$art_i++) {        var item = opers[$art_ixvzybywepq$art_i]%>';
        for (var $art_ixvzybywepq$art_i = 0, $art_cdjibx$art_c = opers.length; $art_ixvzybywepq$art_i < $art_cdjibx$art_c; $art_ixvzybywepq$art_i++) {
            var item = opers[$art_ixvzybywepq$art_i];
