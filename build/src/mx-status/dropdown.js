...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iyapwy$art_i = 0, $art_cipgfszdd$art_c = opers.length; $art_iyapwy$art_i < $art_cipgfszdd$art_c; $art_iyapwy$art_i++) {        var item = opers[$art_iyapwy$art_i]%>';
        for (var $art_iyapwy$art_i = 0, $art_cipgfszdd$art_c = opers.length; $art_iyapwy$art_i < $art_cipgfszdd$art_c; $art_iyapwy$art_i++) {
            var item = opers[$art_iyapwy$art_i];
