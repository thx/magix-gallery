...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ipydoulr$art_i = 0, $art_cstcuksg$art_c = opers.length; $art_ipydoulr$art_i < $art_cstcuksg$art_c; $art_ipydoulr$art_i++) {            var item = opers[$art_ipydoulr$art_i]%>';
            for (var $art_ipydoulr$art_i = 0, $art_cstcuksg$art_c = opers.length; $art_ipydoulr$art_i < $art_cstcuksg$art_c; $art_ipydoulr$art_i++) {
                var item = opers[$art_ipydoulr$art_i];
