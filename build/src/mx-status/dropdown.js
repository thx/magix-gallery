...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ikgeyivdkvz$art_i = 0, $art_cxwkrcwi$art_c = opers.length; $art_ikgeyivdkvz$art_i < $art_cxwkrcwi$art_c; $art_ikgeyivdkvz$art_i++) {        var item = opers[$art_ikgeyivdkvz$art_i]%>';
        for (var $art_ikgeyivdkvz$art_i = 0, $art_cxwkrcwi$art_c = opers.length; $art_ikgeyivdkvz$art_i < $art_cxwkrcwi$art_c; $art_ikgeyivdkvz$art_i++) {
            var item = opers[$art_ikgeyivdkvz$art_i];
