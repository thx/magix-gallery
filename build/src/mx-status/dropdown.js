...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ijoyiaqqxv$art_i = 0, $art_czgyqwwli$art_c = opers.length; $art_ijoyiaqqxv$art_i < $art_czgyqwwli$art_c; $art_ijoyiaqqxv$art_i++) {            var item = opers[$art_ijoyiaqqxv$art_i]%>';
            for (var $art_ijoyiaqqxv$art_i = 0, $art_czgyqwwli$art_c = opers.length; $art_ijoyiaqqxv$art_i < $art_czgyqwwli$art_c; $art_ijoyiaqqxv$art_i++) {
                var item = opers[$art_ijoyiaqqxv$art_i];
