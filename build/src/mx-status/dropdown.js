...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iuiygrea$art_i = 0, $art_cefqxdtjafi$art_c = opers.length; $art_iuiygrea$art_i < $art_cefqxdtjafi$art_c; $art_iuiygrea$art_i++) {            var item = opers[$art_iuiygrea$art_i]%>';
            for (var $art_iuiygrea$art_i = 0, $art_cefqxdtjafi$art_c = opers.length; $art_iuiygrea$art_i < $art_cefqxdtjafi$art_c; $art_iuiygrea$art_i++) {
                var item = opers[$art_iuiygrea$art_i];
