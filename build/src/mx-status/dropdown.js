...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_inksrvvzgr$art_i = 0, $art_cbyeuhmq$art_c = opers.length; $art_inksrvvzgr$art_i < $art_cbyeuhmq$art_c; $art_inksrvvzgr$art_i++) {        var item = opers[$art_inksrvvzgr$art_i]%>';
        for (var $art_inksrvvzgr$art_i = 0, $art_cbyeuhmq$art_c = opers.length; $art_inksrvvzgr$art_i < $art_cbyeuhmq$art_c; $art_inksrvvzgr$art_i++) {
            var item = opers[$art_inksrvvzgr$art_i];
