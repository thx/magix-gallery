...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_inealokk$art_i = 0, $art_cqevyvlrcm$art_c = opers.length; $art_inealokk$art_i < $art_cqevyvlrcm$art_c; $art_inealokk$art_i++) {            var item = opers[$art_inealokk$art_i]%>';
            for (var $art_inealokk$art_i = 0, $art_cqevyvlrcm$art_c = opers.length; $art_inealokk$art_i < $art_cqevyvlrcm$art_c; $art_inealokk$art_i++) {
                var item = opers[$art_inealokk$art_i];
