...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iuvgk$art_i = 0, $art_cvqkcgdor$art_c = opers.length; $art_iuvgk$art_i < $art_cvqkcgdor$art_c; $art_iuvgk$art_i++) {            var item = opers[$art_iuvgk$art_i]%>';
            for (var $art_iuvgk$art_i = 0, $art_cvqkcgdor$art_c = opers.length; $art_iuvgk$art_i < $art_cvqkcgdor$art_c; $art_iuvgk$art_i++) {
                var item = opers[$art_iuvgk$art_i];
