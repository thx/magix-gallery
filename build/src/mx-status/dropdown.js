...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ;
        $p += '<ul mxa="_zs_gallerycr:d" class="_zs_gallery_mx-status_base_-status-info _zs_gallery_mx-status_base_-status-info-dd">';
        $line = 16;
        $art = 'each opers as item';
        ;
        $expr = '<%for (var $art_iphepusln$art_i = 0, $art_czzwlgxyhgo$art_c = opers.length; $art_iphepusln$art_i < $art_czzwlgxyhgo$art_c; $art_iphepusln$art_i++) {        var item = opers[$art_iphepusln$art_i]%>';
        for (var $art_iphepusln$art_i = 0, $art_czzwlgxyhgo$art_c = opers.length; $art_iphepusln$art_i < $art_czzwlgxyhgo$art_c; $art_iphepusln$art_i++) {
            var item = opers[$art_iphepusln$art_i];
            ...
            $art = '!item.icon';
            ;
            $p += ($expr = '<%!item.icon%>', $n(item.icon)) + '</span><span mxa="_zs_gallerycr:e" class="_zs_gallery_mx-status_base_-status-name">';
            $line = 19;
            $art = '=item.text';
            ;
