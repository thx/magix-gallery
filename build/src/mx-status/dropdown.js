...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ihcegrn$art_i = 0, $art_cgnogwt$art_c = opers.length; $art_ihcegrn$art_i < $art_cgnogwt$art_c; $art_ihcegrn$art_i++) {        var item = opers[$art_ihcegrn$art_i]%>';
        for (var $art_ihcegrn$art_i = 0, $art_cgnogwt$art_c = opers.length; $art_ihcegrn$art_i < $art_cgnogwt$art_c; $art_ihcegrn$art_i++) {
            var item = opers[$art_ihcegrn$art_i];
