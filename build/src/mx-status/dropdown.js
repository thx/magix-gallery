...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_igmtywqh$art_i = 0, $art_cevcxwds$art_c = opers.length; $art_igmtywqh$art_i < $art_cevcxwds$art_c; $art_igmtywqh$art_i++) {        var item = opers[$art_igmtywqh$art_i]%>';
        for (var $art_igmtywqh$art_i = 0, $art_cevcxwds$art_c = opers.length; $art_igmtywqh$art_i < $art_cevcxwds$art_c; $art_igmtywqh$art_i++) {
            var item = opers[$art_igmtywqh$art_i];
