...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iblerbzcuhh$art_i = 0, $art_ccntdyg$art_c = opers.length; $art_iblerbzcuhh$art_i < $art_ccntdyg$art_c; $art_iblerbzcuhh$art_i++) {        var item = opers[$art_iblerbzcuhh$art_i]%>';
        for (var $art_iblerbzcuhh$art_i = 0, $art_ccntdyg$art_c = opers.length; $art_iblerbzcuhh$art_i < $art_ccntdyg$art_c; $art_iblerbzcuhh$art_i++) {
            var item = opers[$art_iblerbzcuhh$art_i];
