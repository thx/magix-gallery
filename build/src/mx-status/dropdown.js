...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_icraghjxzm$art_i = 0, $art_cbyqzlzak$art_c = opers.length; $art_icraghjxzm$art_i < $art_cbyqzlzak$art_c; $art_icraghjxzm$art_i++) {        var item = opers[$art_icraghjxzm$art_i]%>';
        for (var $art_icraghjxzm$art_i = 0, $art_cbyqzlzak$art_c = opers.length; $art_icraghjxzm$art_i < $art_cbyqzlzak$art_c; $art_icraghjxzm$art_i++) {
            var item = opers[$art_icraghjxzm$art_i];
