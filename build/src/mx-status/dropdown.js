...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $expr = '<%for (var $art_ielpbibtg$art_i = 0, $art_cugbxli$art_c = list.length; $art_ielpbibtg$art_i < $art_cugbxli$art_c; $art_ielpbibtg$art_i++) {        var item = list[$art_ielpbibtg$art_i]%>';
        for (var $art_ielpbibtg$art_i = 0, $art_cugbxli$art_c = list.length; $art_ielpbibtg$art_i < $art_cugbxli$art_c; $art_ielpbibtg$art_i++) {
            var item = list[$art_ielpbibtg$art_i];
