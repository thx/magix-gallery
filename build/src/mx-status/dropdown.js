...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_inwsdfxdkp$art_i = 0, $art_cdtwqzsztf$art_c = opers.length; $art_inwsdfxdkp$art_i < $art_cdtwqzsztf$art_c; $art_inwsdfxdkp$art_i++) {        var item = opers[$art_inwsdfxdkp$art_i]%>';
        for (var $art_inwsdfxdkp$art_i = 0, $art_cdtwqzsztf$art_c = opers.length; $art_inwsdfxdkp$art_i < $art_cdtwqzsztf$art_c; $art_inwsdfxdkp$art_i++) {
            var item = opers[$art_inwsdfxdkp$art_i];
