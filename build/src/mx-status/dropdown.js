...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_innjyv$art_i = 0, $art_cggzppzk$art_c = list.length; $art_innjyv$art_i < $art_cggzppzk$art_c; $art_innjyv$art_i++) {        var item = list[$art_innjyv$art_i]%>';
        for (var $art_innjyv$art_i = 0, $art_cggzppzk$art_c = list.length; $art_innjyv$art_i < $art_cggzppzk$art_c; $art_innjyv$art_i++) {
            var item = list[$art_innjyv$art_i];
