...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_irljlsmjs$art_i=0;$art_irljlsmjs$art_i<list.length;$art_irljlsmjs$art_i++){var item=list[$art_irljlsmjs$art_i]%>';
        for (var $art_irljlsmjs$art_i = 0; $art_irljlsmjs$art_i < list.length; $art_irljlsmjs$art_i++) {
            var item = list[$art_irljlsmjs$art_i];
