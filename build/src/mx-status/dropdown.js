...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iwldfhiqxl$art_i = 0, $art_cjckurfl$art_c = opers.length; $art_iwldfhiqxl$art_i < $art_cjckurfl$art_c; $art_iwldfhiqxl$art_i++) {        var item = opers[$art_iwldfhiqxl$art_i]%>';
        for (var $art_iwldfhiqxl$art_i = 0, $art_cjckurfl$art_c = opers.length; $art_iwldfhiqxl$art_i < $art_cjckurfl$art_c; $art_iwldfhiqxl$art_i++) {
            var item = opers[$art_iwldfhiqxl$art_i];
