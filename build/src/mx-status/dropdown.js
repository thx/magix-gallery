...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ijssdvas$art_i = 0, $art_cqynkhhwsmc$art_c = opers.length; $art_ijssdvas$art_i < $art_cqynkhhwsmc$art_c; $art_ijssdvas$art_i++) {        var item = opers[$art_ijssdvas$art_i]%>';
        for (var $art_ijssdvas$art_i = 0, $art_cqynkhhwsmc$art_c = opers.length; $art_ijssdvas$art_i < $art_cqynkhhwsmc$art_c; $art_ijssdvas$art_i++) {
            var item = opers[$art_ijssdvas$art_i];
