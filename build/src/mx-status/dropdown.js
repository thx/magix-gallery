...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_itthqwfoxcp$art_i = 0, $art_cjmmhhznds$art_c = opers.length; $art_itthqwfoxcp$art_i < $art_cjmmhhznds$art_c; $art_itthqwfoxcp$art_i++) {        var item = opers[$art_itthqwfoxcp$art_i]%>';
        for (var $art_itthqwfoxcp$art_i = 0, $art_cjmmhhznds$art_c = opers.length; $art_itthqwfoxcp$art_i < $art_cjmmhhznds$art_c; $art_itthqwfoxcp$art_i++) {
            var item = opers[$art_itthqwfoxcp$art_i];
