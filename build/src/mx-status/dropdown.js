...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_isunhtipb$art_i = 0, $art_cieajsmd$art_c = opers.length; $art_isunhtipb$art_i < $art_cieajsmd$art_c; $art_isunhtipb$art_i++) {        var item = opers[$art_isunhtipb$art_i]%>';
        for (var $art_isunhtipb$art_i = 0, $art_cieajsmd$art_c = opers.length; $art_isunhtipb$art_i < $art_cieajsmd$art_c; $art_isunhtipb$art_i++) {
            var item = opers[$art_isunhtipb$art_i];
