...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_imuqjl$art_i = 0, $art_ciwcvcm$art_c = opers.length; $art_imuqjl$art_i < $art_ciwcvcm$art_c; $art_imuqjl$art_i++) {        var item = opers[$art_imuqjl$art_i]%>';
        for (var $art_imuqjl$art_i = 0, $art_ciwcvcm$art_c = opers.length; $art_imuqjl$art_i < $art_ciwcvcm$art_c; $art_imuqjl$art_i++) {
            var item = opers[$art_imuqjl$art_i];
