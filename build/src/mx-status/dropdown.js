...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ihkwmss$art_i = 0, $art_ckiabgxnl$art_c = opers.length; $art_ihkwmss$art_i < $art_ckiabgxnl$art_c; $art_ihkwmss$art_i++) {        var item = opers[$art_ihkwmss$art_i]%>';
        for (var $art_ihkwmss$art_i = 0, $art_ckiabgxnl$art_c = opers.length; $art_ihkwmss$art_i < $art_ckiabgxnl$art_c; $art_ihkwmss$art_i++) {
            var item = opers[$art_ihkwmss$art_i];
