...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ikfohxbwbfg$art_i = 0, $art_celbppyo$art_c = opers.length; $art_ikfohxbwbfg$art_i < $art_celbppyo$art_c; $art_ikfohxbwbfg$art_i++) {        var item = opers[$art_ikfohxbwbfg$art_i]%>';
        for (var $art_ikfohxbwbfg$art_i = 0, $art_celbppyo$art_c = opers.length; $art_ikfohxbwbfg$art_i < $art_celbppyo$art_c; $art_ikfohxbwbfg$art_i++) {
            var item = opers[$art_ikfohxbwbfg$art_i];
