...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_itgowpw$art_i = 0, $art_ckvkptje$art_c = opers.length; $art_itgowpw$art_i < $art_ckvkptje$art_c; $art_itgowpw$art_i++) {        var item = opers[$art_itgowpw$art_i]%>';
        for (var $art_itgowpw$art_i = 0, $art_ckvkptje$art_c = opers.length; $art_itgowpw$art_i < $art_ckvkptje$art_c; $art_itgowpw$art_i++) {
            var item = opers[$art_itgowpw$art_i];
