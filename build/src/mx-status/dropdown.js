...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ihmawrvfaq$art_i = 0, $art_cyiihbseo$art_c = opers.length; $art_ihmawrvfaq$art_i < $art_cyiihbseo$art_c; $art_ihmawrvfaq$art_i++) {        var item = opers[$art_ihmawrvfaq$art_i]%>';
        for (var $art_ihmawrvfaq$art_i = 0, $art_cyiihbseo$art_c = opers.length; $art_ihmawrvfaq$art_i < $art_cyiihbseo$art_c; $art_ihmawrvfaq$art_i++) {
            var item = opers[$art_ihmawrvfaq$art_i];
