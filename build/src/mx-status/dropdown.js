...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ipinzul$art_i = 0, $art_cwpxfclzg$art_c = opers.length; $art_ipinzul$art_i < $art_cwpxfclzg$art_c; $art_ipinzul$art_i++) {            var item = opers[$art_ipinzul$art_i]%>';
            for (var $art_ipinzul$art_i = 0, $art_cwpxfclzg$art_c = opers.length; $art_ipinzul$art_i < $art_cwpxfclzg$art_c; $art_ipinzul$art_i++) {
                var item = opers[$art_ipinzul$art_i];
