...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ixupiyk$art_i = 0, $art_cjhyefkiv$art_c = opers.length; $art_ixupiyk$art_i < $art_cjhyefkiv$art_c; $art_ixupiyk$art_i++) {        var item = opers[$art_ixupiyk$art_i]%>';
        for (var $art_ixupiyk$art_i = 0, $art_cjhyefkiv$art_c = opers.length; $art_ixupiyk$art_i < $art_cjhyefkiv$art_c; $art_ixupiyk$art_i++) {
            var item = opers[$art_ixupiyk$art_i];
