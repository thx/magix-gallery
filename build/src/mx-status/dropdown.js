...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ikqnlpuaa$art_i = 0, $art_cwdrxkpim$art_c = opers.length; $art_ikqnlpuaa$art_i < $art_cwdrxkpim$art_c; $art_ikqnlpuaa$art_i++) {            var item = opers[$art_ikqnlpuaa$art_i]%>';
            for (var $art_ikqnlpuaa$art_i = 0, $art_cwdrxkpim$art_c = opers.length; $art_ikqnlpuaa$art_i < $art_cwdrxkpim$art_c; $art_ikqnlpuaa$art_i++) {
                var item = opers[$art_ikqnlpuaa$art_i];
