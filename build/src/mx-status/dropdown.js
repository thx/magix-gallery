...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_izvlgexc$art_i = 0, $art_cdecamkx$art_c = opers.length; $art_izvlgexc$art_i < $art_cdecamkx$art_c; $art_izvlgexc$art_i++) {        var item = opers[$art_izvlgexc$art_i]%>';
        for (var $art_izvlgexc$art_i = 0, $art_cdecamkx$art_c = opers.length; $art_izvlgexc$art_i < $art_cdecamkx$art_c; $art_izvlgexc$art_i++) {
            var item = opers[$art_izvlgexc$art_i];
