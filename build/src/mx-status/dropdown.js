...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_izqdkwh$art_i = 0, $art_cvbdhwscfk$art_c = opers.length; $art_izqdkwh$art_i < $art_cvbdhwscfk$art_c; $art_izqdkwh$art_i++) {            var item = opers[$art_izqdkwh$art_i]%>';
            for (var $art_izqdkwh$art_i = 0, $art_cvbdhwscfk$art_c = opers.length; $art_izqdkwh$art_i < $art_cvbdhwscfk$art_c; $art_izqdkwh$art_i++) {
                var item = opers[$art_izqdkwh$art_i];
