...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ijauuhymg$art_i = 0, $art_cqdygfwu$art_c = opers.length; $art_ijauuhymg$art_i < $art_cqdygfwu$art_c; $art_ijauuhymg$art_i++) {        var item = opers[$art_ijauuhymg$art_i]%>';
        for (var $art_ijauuhymg$art_i = 0, $art_cqdygfwu$art_c = opers.length; $art_ijauuhymg$art_i < $art_cqdygfwu$art_c; $art_ijauuhymg$art_i++) {
            var item = opers[$art_ijauuhymg$art_i];
