...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ixdkbh$art_i = 0, $art_cpjcuwe$art_c = opers.length; $art_ixdkbh$art_i < $art_cpjcuwe$art_c; $art_ixdkbh$art_i++) {            var item = opers[$art_ixdkbh$art_i]%>';
            for (var $art_ixdkbh$art_i = 0, $art_cpjcuwe$art_c = opers.length; $art_ixdkbh$art_i < $art_cpjcuwe$art_c; $art_ixdkbh$art_i++) {
                var item = opers[$art_ixdkbh$art_i];
