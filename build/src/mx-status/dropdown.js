...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ietmthcs$art_i = 0, $art_csvlqhumw$art_c = opers.length; $art_ietmthcs$art_i < $art_csvlqhumw$art_c; $art_ietmthcs$art_i++) {            var item = opers[$art_ietmthcs$art_i]%>';
            for (var $art_ietmthcs$art_i = 0, $art_csvlqhumw$art_c = opers.length; $art_ietmthcs$art_i < $art_csvlqhumw$art_c; $art_ietmthcs$art_i++) {
                var item = opers[$art_ietmthcs$art_i];
