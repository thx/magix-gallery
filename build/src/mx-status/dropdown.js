...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iulwnuwj$art_i = 0, $art_cmzcrpl$art_c = opers.length; $art_iulwnuwj$art_i < $art_cmzcrpl$art_c; $art_iulwnuwj$art_i++) {        var item = opers[$art_iulwnuwj$art_i]%>';
        for (var $art_iulwnuwj$art_i = 0, $art_cmzcrpl$art_c = opers.length; $art_iulwnuwj$art_i < $art_cmzcrpl$art_c; $art_iulwnuwj$art_i++) {
            var item = opers[$art_iulwnuwj$art_i];
