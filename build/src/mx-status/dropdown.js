...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ibruwpvof$art_i = 0, $art_ceiujsdqhce$art_c = opers.length; $art_ibruwpvof$art_i < $art_ceiujsdqhce$art_c; $art_ibruwpvof$art_i++) {        var item = opers[$art_ibruwpvof$art_i]%>';
        for (var $art_ibruwpvof$art_i = 0, $art_ceiujsdqhce$art_c = opers.length; $art_ibruwpvof$art_i < $art_ceiujsdqhce$art_c; $art_ibruwpvof$art_i++) {
            var item = opers[$art_ibruwpvof$art_i];
