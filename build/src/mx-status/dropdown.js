...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_idaszgnt$art_i = 0, $art_cwrcsiaurk$art_c = opers.length; $art_idaszgnt$art_i < $art_cwrcsiaurk$art_c; $art_idaszgnt$art_i++) {        var item = opers[$art_idaszgnt$art_i]%>';
        for (var $art_idaszgnt$art_i = 0, $art_cwrcsiaurk$art_c = opers.length; $art_idaszgnt$art_i < $art_cwrcsiaurk$art_c; $art_idaszgnt$art_i++) {
            var item = opers[$art_idaszgnt$art_i];
