...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ibjymi$art_i = 0, $art_cyrjlmovo$art_c = list.length; $art_ibjymi$art_i < $art_cyrjlmovo$art_c; $art_ibjymi$art_i++) {        var item = list[$art_ibjymi$art_i]%>';
        for (var $art_ibjymi$art_i = 0, $art_cyrjlmovo$art_c = list.length; $art_ibjymi$art_i < $art_cyrjlmovo$art_c; $art_ibjymi$art_i++) {
            var item = list[$art_ibjymi$art_i];
