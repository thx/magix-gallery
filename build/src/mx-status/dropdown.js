...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ibsqpnmhce$art_i = 0, $art_clzwwralcp$art_c = list.length; $art_ibsqpnmhce$art_i < $art_clzwwralcp$art_c; $art_ibsqpnmhce$art_i++) {        var item = list[$art_ibsqpnmhce$art_i]%>';
        for (var $art_ibsqpnmhce$art_i = 0, $art_clzwwralcp$art_c = list.length; $art_ibsqpnmhce$art_i < $art_clzwwralcp$art_c; $art_ibsqpnmhce$art_i++) {
            var item = list[$art_ibsqpnmhce$art_i];
