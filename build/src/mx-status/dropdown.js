...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iuogadxgh$art_i = 0, $art_ccjdkwd$art_c = opers.length; $art_iuogadxgh$art_i < $art_ccjdkwd$art_c; $art_iuogadxgh$art_i++) {        var item = opers[$art_iuogadxgh$art_i]%>';
        for (var $art_iuogadxgh$art_i = 0, $art_ccjdkwd$art_c = opers.length; $art_iuogadxgh$art_i < $art_ccjdkwd$art_c; $art_iuogadxgh$art_i++) {
            var item = opers[$art_iuogadxgh$art_i];
