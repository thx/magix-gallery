...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iofpozbi$art_i = 0, $art_cmargdlugq$art_c = opers.length; $art_iofpozbi$art_i < $art_cmargdlugq$art_c; $art_iofpozbi$art_i++) {        var item = opers[$art_iofpozbi$art_i]%>';
        for (var $art_iofpozbi$art_i = 0, $art_cmargdlugq$art_c = opers.length; $art_iofpozbi$art_i < $art_cmargdlugq$art_c; $art_iofpozbi$art_i++) {
            var item = opers[$art_iofpozbi$art_i];
