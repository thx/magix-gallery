...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ipwapcrge$art_i = 0, $art_chqxwnda$art_c = opers.length; $art_ipwapcrge$art_i < $art_chqxwnda$art_c; $art_ipwapcrge$art_i++) {        var item = opers[$art_ipwapcrge$art_i]%>';
        for (var $art_ipwapcrge$art_i = 0, $art_chqxwnda$art_c = opers.length; $art_ipwapcrge$art_i < $art_chqxwnda$art_c; $art_ipwapcrge$art_i++) {
            var item = opers[$art_ipwapcrge$art_i];
