...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iinoibc$art_i = 0, $art_cafsab$art_c = list.length; $art_iinoibc$art_i < $art_cafsab$art_c; $art_iinoibc$art_i++) {        var item = list[$art_iinoibc$art_i]%>';
        for (var $art_iinoibc$art_i = 0, $art_cafsab$art_c = list.length; $art_iinoibc$art_i < $art_cafsab$art_c; $art_iinoibc$art_i++) {
            var item = list[$art_iinoibc$art_i];
