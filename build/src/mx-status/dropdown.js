...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_infpzmq$art_i = 0, $art_cdgonuxixv$art_c = opers.length; $art_infpzmq$art_i < $art_cdgonuxixv$art_c; $art_infpzmq$art_i++) {        var item = opers[$art_infpzmq$art_i]%>';
        for (var $art_infpzmq$art_i = 0, $art_cdgonuxixv$art_c = opers.length; $art_infpzmq$art_i < $art_cdgonuxixv$art_c; $art_infpzmq$art_i++) {
            var item = opers[$art_infpzmq$art_i];
