...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycf:_" class="_zs_gallery_mx-status_base_-status" mx-mouseout="' + $viewId + 'out()"><div mxa="_zs_gallerycf:a" class="_zs_gallery_mx-status_base_-status-handle-dd" mx-mouseover="' + $viewId + 'over()"><span class="input _zs_gallery_mx-status_base_-status-input ';
    $line = 5;
    $art = 'if readonly';
    ;
    $p += '';
    ...
    $art = '=cur.text';
    ;
    $p += '' + ($expr = '<%=cur.text%>', $e(cur.text)) + '</span><i mxs="_zs_gallerycf:_" class="mc-iconfont _zs_gallery_mx-status_base_-status-arrow">&#xe692;</i></div>';
    $line = 10;
    ...
    if (show && !readonly) {
        ;
        $p += '<ul mxa="_zs_gallerycf:b" class="_zs_gallery_mx-status_base_-status-info _zs_gallery_mx-status_base_-status-info-dd">';
        $line = 12;
        $art = 'each list as item';
        ;
        $p += '';
        $expr = '<%for (var $art_iuvnuoyo$art_i = 0, $art_cmnfrusddy$art_c = list.length; $art_iuvnuoyo$art_i < $art_cmnfrusddy$art_c; $art_iuvnuoyo$art_i++) {        var item = list[$art_iuvnuoyo$art_i]%>';
        for (var $art_iuvnuoyo$art_i = 0, $art_cmnfrusddy$art_c = list.length; $art_iuvnuoyo$art_i < $art_cmnfrusddy$art_c; $art_iuvnuoyo$art_i++) {
            var item = list[$art_iuvnuoyo$art_i];
            ...
            $art = '!item.icon';
            ;
            $p += '' + ($expr = '<%!item.icon%>', $n(item.icon)) + '</span><span mxa="_zs_gallerycf:c" class="_zs_gallery_mx-status_base_-status-name">';
            $line = 15;
            $art = '=item.text';
            ;
            $p += '' + ($expr = '<%=item.text%>', $e(item.text)) + '</span><i mxs="_zs_gallerycf:a" class="mc-iconfont _zs_gallery_mx-status_base_-oper-icon">&#xe65d;</i></li>';
            $line = 18;
            $art = '/each';
            ;
            $p += '';
