...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_inptaqf$art_i = 0, $art_cfcxtgrfyl$art_c = opers.length; $art_inptaqf$art_i < $art_cfcxtgrfyl$art_c; $art_inptaqf$art_i++) {            var item = opers[$art_inptaqf$art_i]%>';
            for (var $art_inptaqf$art_i = 0, $art_cfcxtgrfyl$art_c = opers.length; $art_inptaqf$art_i < $art_cfcxtgrfyl$art_c; $art_inptaqf$art_i++) {
                var item = opers[$art_inptaqf$art_i];
