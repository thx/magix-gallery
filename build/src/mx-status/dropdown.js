...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_imhxjrjd$art_i = 0, $art_ctbvepqm$art_c = opers.length; $art_imhxjrjd$art_i < $art_ctbvepqm$art_c; $art_imhxjrjd$art_i++) {        var item = opers[$art_imhxjrjd$art_i]%>';
        for (var $art_imhxjrjd$art_i = 0, $art_ctbvepqm$art_c = opers.length; $art_imhxjrjd$art_i < $art_ctbvepqm$art_c; $art_imhxjrjd$art_i++) {
            var item = opers[$art_imhxjrjd$art_i];
