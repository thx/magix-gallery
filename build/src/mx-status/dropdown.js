...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_igjhrpqliuv$art_i = 0, $art_cmfjfl$art_c = opers.length; $art_igjhrpqliuv$art_i < $art_cmfjfl$art_c; $art_igjhrpqliuv$art_i++) {        var item = opers[$art_igjhrpqliuv$art_i]%>';
        for (var $art_igjhrpqliuv$art_i = 0, $art_cmfjfl$art_c = opers.length; $art_igjhrpqliuv$art_i < $art_cmfjfl$art_c; $art_igjhrpqliuv$art_i++) {
            var item = opers[$art_igjhrpqliuv$art_i];
