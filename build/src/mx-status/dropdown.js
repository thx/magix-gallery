...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iejtcnsv$art_i = 0, $art_cqikdjjq$art_c = list.length; $art_iejtcnsv$art_i < $art_cqikdjjq$art_c; $art_iejtcnsv$art_i++) {        var item = list[$art_iejtcnsv$art_i]%>';
        for (var $art_iejtcnsv$art_i = 0, $art_cqikdjjq$art_c = list.length; $art_iejtcnsv$art_i < $art_cqikdjjq$art_c; $art_iejtcnsv$art_i++) {
            var item = list[$art_iejtcnsv$art_i];
