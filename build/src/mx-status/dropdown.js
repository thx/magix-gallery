...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ikipmavar$art_i = 0, $art_ccqrgvtog$art_c = opers.length; $art_ikipmavar$art_i < $art_ccqrgvtog$art_c; $art_ikipmavar$art_i++) {        var item = opers[$art_ikipmavar$art_i]%>';
        for (var $art_ikipmavar$art_i = 0, $art_ccqrgvtog$art_c = opers.length; $art_ikipmavar$art_i < $art_ccqrgvtog$art_c; $art_ikipmavar$art_i++) {
            var item = opers[$art_ikipmavar$art_i];
