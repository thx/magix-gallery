...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_iqeipcclk$art_i = 0, $art_catuenhs$art_c = opers.length; $art_iqeipcclk$art_i < $art_catuenhs$art_c; $art_iqeipcclk$art_i++) {            var item = opers[$art_iqeipcclk$art_i]%>';
            for (var $art_iqeipcclk$art_i = 0, $art_catuenhs$art_c = opers.length; $art_iqeipcclk$art_i < $art_catuenhs$art_c; $art_iqeipcclk$art_i++) {
                var item = opers[$art_iqeipcclk$art_i];
