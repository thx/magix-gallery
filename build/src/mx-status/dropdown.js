...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iygmxncu$art_i = 0, $art_cqgdrodhpk$art_c = opers.length; $art_iygmxncu$art_i < $art_cqgdrodhpk$art_c; $art_iygmxncu$art_i++) {        var item = opers[$art_iygmxncu$art_i]%>';
        for (var $art_iygmxncu$art_i = 0, $art_cqgdrodhpk$art_c = opers.length; $art_iygmxncu$art_i < $art_cqgdrodhpk$art_c; $art_iygmxncu$art_i++) {
            var item = opers[$art_iygmxncu$art_i];
