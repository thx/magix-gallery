...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_izsaffcva$art_i = 0, $art_cybkwkw$art_c = opers.length; $art_izsaffcva$art_i < $art_cybkwkw$art_c; $art_izsaffcva$art_i++) {        var item = opers[$art_izsaffcva$art_i]%>';
        for (var $art_izsaffcva$art_i = 0, $art_cybkwkw$art_c = opers.length; $art_izsaffcva$art_i < $art_cybkwkw$art_c; $art_izsaffcva$art_i++) {
            var item = opers[$art_izsaffcva$art_i];
