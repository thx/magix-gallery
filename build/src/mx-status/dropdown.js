...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ihamqvsmihn$art_i = 0, $art_cusnxdazz$art_c = opers.length; $art_ihamqvsmihn$art_i < $art_cusnxdazz$art_c; $art_ihamqvsmihn$art_i++) {            var item = opers[$art_ihamqvsmihn$art_i]%>';
            for (var $art_ihamqvsmihn$art_i = 0, $art_cusnxdazz$art_c = opers.length; $art_ihamqvsmihn$art_i < $art_cusnxdazz$art_c; $art_ihamqvsmihn$art_i++) {
                var item = opers[$art_ihamqvsmihn$art_i];
