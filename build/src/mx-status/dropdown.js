...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $expr = '<%for (var $art_irggrambj$art_i = 0, $art_cjgnnblzykb$art_c = list.length; $art_irggrambj$art_i < $art_cjgnnblzykb$art_c; $art_irggrambj$art_i++) {        var item = list[$art_irggrambj$art_i]%>';
        for (var $art_irggrambj$art_i = 0, $art_cjgnnblzykb$art_c = list.length; $art_irggrambj$art_i < $art_cjgnnblzykb$art_c; $art_irggrambj$art_i++) {
            var item = list[$art_irggrambj$art_i];
