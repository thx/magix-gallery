...
module.exports = Base.extend({
    ...
    if (showInfo) {
        ...
        if (show && (opers.length > 0)) {
            ...
            ;
            $expr = '<%for (var $art_ibmlmtr$art_i = 0, $art_curjdarhs$art_c = opers.length; $art_ibmlmtr$art_i < $art_curjdarhs$art_c; $art_ibmlmtr$art_i++) {            var item = opers[$art_ibmlmtr$art_i]%>';
            for (var $art_ibmlmtr$art_i = 0, $art_curjdarhs$art_c = opers.length; $art_ibmlmtr$art_i < $art_curjdarhs$art_c; $art_ibmlmtr$art_i++) {
                var item = opers[$art_ibmlmtr$art_i];
