...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_iigapbnxex$art_i = 0, $art_ckonlzzgs$art_c = opers.length; $art_iigapbnxex$art_i < $art_ckonlzzgs$art_c; $art_iigapbnxex$art_i++) {        var item = opers[$art_iigapbnxex$art_i]%>';
        for (var $art_iigapbnxex$art_i = 0, $art_ckonlzzgs$art_c = opers.length; $art_iigapbnxex$art_i < $art_ckonlzzgs$art_c; $art_iigapbnxex$art_i++) {
            var item = opers[$art_iigapbnxex$art_i];
