...
module.exports = Base.extend({
    ...
    if (show && !readonly) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ikcpbmbxwrs$art_i = 0, $art_cflrcgamo$art_c = list.length; $art_ikcpbmbxwrs$art_i < $art_cflrcgamo$art_c; $art_ikcpbmbxwrs$art_i++) {        var item = list[$art_ikcpbmbxwrs$art_i]%>';
        for (var $art_ikcpbmbxwrs$art_i = 0, $art_cflrcgamo$art_c = list.length; $art_ikcpbmbxwrs$art_i < $art_cflrcgamo$art_c; $art_ikcpbmbxwrs$art_i++) {
            var item = list[$art_ikcpbmbxwrs$art_i];
