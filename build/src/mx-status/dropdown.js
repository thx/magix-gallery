...
module.exports = Base.extend({
    ...
    if (show && !showInfo && (opers.length > 0)) {
        ...
        ;
        $expr = '<%for (var $art_ibjdjwgwv$art_i = 0, $art_cjurymflh$art_c = opers.length; $art_ibjdjwgwv$art_i < $art_cjurymflh$art_c; $art_ibjdjwgwv$art_i++) {        var item = opers[$art_ibjdjwgwv$art_i]%>';
        for (var $art_ibjdjwgwv$art_i = 0, $art_cjurymflh$art_c = opers.length; $art_ibjdjwgwv$art_i < $art_cjurymflh$art_c; $art_ibjdjwgwv$art_i++) {
            var item = opers[$art_ibjdjwgwv$art_i];
