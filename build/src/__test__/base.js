...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ismjywwhcb$art_i = 0, $art_cyxfgturyem$art_c = headers.length; $art_ismjywwhcb$art_i < $art_cyxfgturyem$art_c; $art_ismjywwhcb$art_i++) {    var h = headers[$art_ismjywwhcb$art_i]%>';
    for (var $art_ismjywwhcb$art_i = 0, $art_cyxfgturyem$art_c = headers.length; $art_ismjywwhcb$art_i < $art_cyxfgturyem$art_c; $art_ismjywwhcb$art_i++) {
        var h = headers[$art_ismjywwhcb$art_i];
        $p += '<a href="#!';
        $line = 19;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_icdlaytea$art_i = 0, $art_cosjjkiyp$art_c = list.length; $art_icdlaytea$art_i < $art_cosjjkiyp$art_c; $art_icdlaytea$art_i++) {    var item = list[$art_icdlaytea$art_i]%>';
    for (var $art_icdlaytea$art_i = 0, $art_cosjjkiyp$art_c = list.length; $art_icdlaytea$art_i < $art_cosjjkiyp$art_c; $art_icdlaytea$art_i++) {
        var item = list[$art_icdlaytea$art_i];
        $p += ' ';
        $line = 26;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ijyhppjwt$art_i = 0, $art_objhphryxw$art_obj = item.subs, $art_chhosvpshp$art_c = $art_objhphryxw$art_obj.length; $art_ijyhppjwt$art_i < $art_chhosvpshp$art_c; $art_ijyhppjwt$art_i++) {        var sub = $art_objhphryxw$art_obj[$art_ijyhppjwt$art_i]%>';
        for (var $art_ijyhppjwt$art_i = 0, $art_objhphryxw$art_obj = item.subs, $art_chhosvpshp$art_c = $art_objhphryxw$art_obj.length; $art_ijyhppjwt$art_i < $art_chhosvpshp$art_c; $art_ijyhppjwt$art_i++) {
            var sub = $art_objhphryxw$art_obj[$art_ijyhppjwt$art_i];
