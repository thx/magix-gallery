...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilziiwzj$art_i = 0, $art_cxfelvyga$art_c = headers.length; $art_ilziiwzj$art_i < $art_cxfelvyga$art_c; $art_ilziiwzj$art_i++) {    var h = headers[$art_ilziiwzj$art_i]%>';
    for (var $art_ilziiwzj$art_i = 0, $art_cxfelvyga$art_c = headers.length; $art_ilziiwzj$art_i < $art_cxfelvyga$art_c; $art_ilziiwzj$art_i++) {
        var h = headers[$art_ilziiwzj$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ieasahudxk$art_i = 0, $art_cgkrrkhuevvg$art_c = list.length; $art_ieasahudxk$art_i < $art_cgkrrkhuevvg$art_c; $art_ieasahudxk$art_i++) {    var item = list[$art_ieasahudxk$art_i]%>';
    for (var $art_ieasahudxk$art_i = 0, $art_cgkrrkhuevvg$art_c = list.length; $art_ieasahudxk$art_i < $art_cgkrrkhuevvg$art_c; $art_ieasahudxk$art_i++) {
        var item = list[$art_ieasahudxk$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ipvltneeuj$art_i = 0, $art_objvaagavyn$art_obj = item.subs, $art_cqmaedil$art_c = $art_objvaagavyn$art_obj.length; $art_ipvltneeuj$art_i < $art_cqmaedil$art_c; $art_ipvltneeuj$art_i++) {        var sub = $art_objvaagavyn$art_obj[$art_ipvltneeuj$art_i]%>';
        for (var $art_ipvltneeuj$art_i = 0, $art_objvaagavyn$art_obj = item.subs, $art_cqmaedil$art_c = $art_objvaagavyn$art_obj.length; $art_ipvltneeuj$art_i < $art_cqmaedil$art_c; $art_ipvltneeuj$art_i++) {
            var sub = $art_objvaagavyn$art_obj[$art_ipvltneeuj$art_i];
