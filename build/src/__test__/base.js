...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iclsgilhu$art_i = 0, $art_cerwnpi$art_c = headers.length; $art_iclsgilhu$art_i < $art_cerwnpi$art_c; $art_iclsgilhu$art_i++) {    var h = headers[$art_iclsgilhu$art_i]%>';
    for (var $art_iclsgilhu$art_i = 0, $art_cerwnpi$art_c = headers.length; $art_iclsgilhu$art_i < $art_cerwnpi$art_c; $art_iclsgilhu$art_i++) {
        var h = headers[$art_iclsgilhu$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ibqkfblj$art_i = 0, $art_chvdecz$art_c = list.length; $art_ibqkfblj$art_i < $art_chvdecz$art_c; $art_ibqkfblj$art_i++) {    var item = list[$art_ibqkfblj$art_i]%>';
    for (var $art_ibqkfblj$art_i = 0, $art_chvdecz$art_c = list.length; $art_ibqkfblj$art_i < $art_chvdecz$art_c; $art_ibqkfblj$art_i++) {
        var item = list[$art_ibqkfblj$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iveuasjstt$art_i = 0, $art_objritjvehvc$art_obj = item.subs, $art_chepfkzmsm$art_c = $art_objritjvehvc$art_obj.length; $art_iveuasjstt$art_i < $art_chepfkzmsm$art_c; $art_iveuasjstt$art_i++) {        var sub = $art_objritjvehvc$art_obj[$art_iveuasjstt$art_i]%>';
        for (var $art_iveuasjstt$art_i = 0, $art_objritjvehvc$art_obj = item.subs, $art_chepfkzmsm$art_c = $art_objritjvehvc$art_obj.length; $art_iveuasjstt$art_i < $art_chepfkzmsm$art_c; $art_iveuasjstt$art_i++) {
            var sub = $art_objritjvehvc$art_obj[$art_iveuasjstt$art_i];
