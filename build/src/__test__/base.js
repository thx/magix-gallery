...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itionbhya$art_i = 0, $art_cmmdrls$art_c = headers.length; $art_itionbhya$art_i < $art_cmmdrls$art_c; $art_itionbhya$art_i++) {    var h = headers[$art_itionbhya$art_i]%>';
    for (var $art_itionbhya$art_i = 0, $art_cmmdrls$art_c = headers.length; $art_itionbhya$art_i < $art_cmmdrls$art_c; $art_itionbhya$art_i++) {
        var h = headers[$art_itionbhya$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_imrjtpy$art_i = 0, $art_cmqhqmmpw$art_c = list.length; $art_imrjtpy$art_i < $art_cmqhqmmpw$art_c; $art_imrjtpy$art_i++) {    var item = list[$art_imrjtpy$art_i]%>';
    for (var $art_imrjtpy$art_i = 0, $art_cmqhqmmpw$art_c = list.length; $art_imrjtpy$art_i < $art_cmqhqmmpw$art_c; $art_imrjtpy$art_i++) {
        var item = list[$art_imrjtpy$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ifivemwc$art_i = 0, $art_objrxbdnwduls$art_obj = item.subs, $art_czwopwhrxxl$art_c = $art_objrxbdnwduls$art_obj.length; $art_ifivemwc$art_i < $art_czwopwhrxxl$art_c; $art_ifivemwc$art_i++) {        var sub = $art_objrxbdnwduls$art_obj[$art_ifivemwc$art_i]%>';
        for (var $art_ifivemwc$art_i = 0, $art_objrxbdnwduls$art_obj = item.subs, $art_czwopwhrxxl$art_c = $art_objrxbdnwduls$art_obj.length; $art_ifivemwc$art_i < $art_czwopwhrxxl$art_c; $art_ifivemwc$art_i++) {
            var sub = $art_objrxbdnwduls$art_obj[$art_ifivemwc$art_i];
