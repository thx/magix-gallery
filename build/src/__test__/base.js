...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iudtypawb$art_i = 0, $art_cpwnfimp$art_c = headers.length; $art_iudtypawb$art_i < $art_cpwnfimp$art_c; $art_iudtypawb$art_i++) {    var h = headers[$art_iudtypawb$art_i]%>';
    for (var $art_iudtypawb$art_i = 0, $art_cpwnfimp$art_c = headers.length; $art_iudtypawb$art_i < $art_cpwnfimp$art_c; $art_iudtypawb$art_i++) {
        var h = headers[$art_iudtypawb$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_isvfmwk$art_i = 0, $art_cbxikgckw$art_c = list.length; $art_isvfmwk$art_i < $art_cbxikgckw$art_c; $art_isvfmwk$art_i++) {    var item = list[$art_isvfmwk$art_i]%>';
    for (var $art_isvfmwk$art_i = 0, $art_cbxikgckw$art_c = list.length; $art_isvfmwk$art_i < $art_cbxikgckw$art_c; $art_isvfmwk$art_i++) {
        var item = list[$art_isvfmwk$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_itlshwbhv$art_i = 0, $art_objobltilrny$art_obj = item.subs, $art_cdzzvpq$art_c = $art_objobltilrny$art_obj.length; $art_itlshwbhv$art_i < $art_cdzzvpq$art_c; $art_itlshwbhv$art_i++) {        var sub = $art_objobltilrny$art_obj[$art_itlshwbhv$art_i]%>';
        for (var $art_itlshwbhv$art_i = 0, $art_objobltilrny$art_obj = item.subs, $art_cdzzvpq$art_c = $art_objobltilrny$art_obj.length; $art_itlshwbhv$art_i < $art_cdzzvpq$art_c; $art_itlshwbhv$art_i++) {
            var sub = $art_objobltilrny$art_obj[$art_itlshwbhv$art_i];
