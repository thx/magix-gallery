...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iagbxmns$art_i = 0, $art_chcjcfjr$art_c = headers.length; $art_iagbxmns$art_i < $art_chcjcfjr$art_c; $art_iagbxmns$art_i++) {    var h = headers[$art_iagbxmns$art_i]%>';
    for (var $art_iagbxmns$art_i = 0, $art_chcjcfjr$art_c = headers.length; $art_iagbxmns$art_i < $art_chcjcfjr$art_c; $art_iagbxmns$art_i++) {
        var h = headers[$art_iagbxmns$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_iiupuqxm$art_i = 0, $art_cgyknsrc$art_c = list.length; $art_iiupuqxm$art_i < $art_cgyknsrc$art_c; $art_iiupuqxm$art_i++) {    var item = list[$art_iiupuqxm$art_i]%>';
    for (var $art_iiupuqxm$art_i = 0, $art_cgyknsrc$art_c = list.length; $art_iiupuqxm$art_i < $art_cgyknsrc$art_c; $art_iiupuqxm$art_i++) {
        var item = list[$art_iiupuqxm$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_izfvvnpjx$art_i = 0, $art_objpbyqeo$art_obj = item.subs, $art_cwtivbaketc$art_c = $art_objpbyqeo$art_obj.length; $art_izfvvnpjx$art_i < $art_cwtivbaketc$art_c; $art_izfvvnpjx$art_i++) {        var sub = $art_objpbyqeo$art_obj[$art_izfvvnpjx$art_i]%>';
        for (var $art_izfvvnpjx$art_i = 0, $art_objpbyqeo$art_obj = item.subs, $art_cwtivbaketc$art_c = $art_objpbyqeo$art_obj.length; $art_izfvvnpjx$art_i < $art_cwtivbaketc$art_c; $art_izfvvnpjx$art_i++) {
            var sub = $art_objpbyqeo$art_obj[$art_izfvvnpjx$art_i];
