...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_islbpgoo$art_i = 0, $art_cohxpmzg$art_c = list.length; $art_islbpgoo$art_i < $art_cohxpmzg$art_c; $art_islbpgoo$art_i++) {    var item = list[$art_islbpgoo$art_i]%>';
    for (var $art_islbpgoo$art_i = 0, $art_cohxpmzg$art_c = list.length; $art_islbpgoo$art_i < $art_cohxpmzg$art_c; $art_islbpgoo$art_i++) {
        var item = list[$art_islbpgoo$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iiruincrfp$art_i = 0, $art_objwhhofff$art_obj = item.subs, $art_cntroijm$art_c = $art_objwhhofff$art_obj.length; $art_iiruincrfp$art_i < $art_cntroijm$art_c; $art_iiruincrfp$art_i++) {        var sub = $art_objwhhofff$art_obj[$art_iiruincrfp$art_i]%>';
        for (var $art_iiruincrfp$art_i = 0, $art_objwhhofff$art_obj = item.subs, $art_cntroijm$art_c = $art_objwhhofff$art_obj.length; $art_iiruincrfp$art_i < $art_cntroijm$art_c; $art_iiruincrfp$art_i++) {
            var sub = $art_objwhhofff$art_obj[$art_iiruincrfp$art_i];
