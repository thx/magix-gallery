...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itrybaxae$art_i = 0, $art_cskeulfz$art_c = headers.length; $art_itrybaxae$art_i < $art_cskeulfz$art_c; $art_itrybaxae$art_i++) {    var h = headers[$art_itrybaxae$art_i]%>';
    for (var $art_itrybaxae$art_i = 0, $art_cskeulfz$art_c = headers.length; $art_itrybaxae$art_i < $art_cskeulfz$art_c; $art_itrybaxae$art_i++) {
        var h = headers[$art_itrybaxae$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_itapdfpj$art_i = 0, $art_csfaezak$art_c = list.length; $art_itapdfpj$art_i < $art_csfaezak$art_c; $art_itapdfpj$art_i++) {    var item = list[$art_itapdfpj$art_i]%>';
    for (var $art_itapdfpj$art_i = 0, $art_csfaezak$art_c = list.length; $art_itapdfpj$art_i < $art_csfaezak$art_c; $art_itapdfpj$art_i++) {
        var item = list[$art_itapdfpj$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iiwqslom$art_i = 0, $art_objexclnw$art_obj = item.subs, $art_cgwzddnqaws$art_c = $art_objexclnw$art_obj.length; $art_iiwqslom$art_i < $art_cgwzddnqaws$art_c; $art_iiwqslom$art_i++) {        var sub = $art_objexclnw$art_obj[$art_iiwqslom$art_i]%>';
        for (var $art_iiwqslom$art_i = 0, $art_objexclnw$art_obj = item.subs, $art_cgwzddnqaws$art_c = $art_objexclnw$art_obj.length; $art_iiwqslom$art_i < $art_cgwzddnqaws$art_c; $art_iiwqslom$art_i++) {
            var sub = $art_objexclnw$art_obj[$art_iiwqslom$art_i];
