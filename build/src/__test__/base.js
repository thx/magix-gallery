...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iekdiwbzvr$art_i = 0, $art_cvoqquyl$art_c = headers.length; $art_iekdiwbzvr$art_i < $art_cvoqquyl$art_c; $art_iekdiwbzvr$art_i++) {    var h = headers[$art_iekdiwbzvr$art_i]%>';
    for (var $art_iekdiwbzvr$art_i = 0, $art_cvoqquyl$art_c = headers.length; $art_iekdiwbzvr$art_i < $art_cvoqquyl$art_c; $art_iekdiwbzvr$art_i++) {
        var h = headers[$art_iekdiwbzvr$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_inueoemlbb$art_i = 0, $art_cbgjkczaj$art_c = list.length; $art_inueoemlbb$art_i < $art_cbgjkczaj$art_c; $art_inueoemlbb$art_i++) {    var item = list[$art_inueoemlbb$art_i]%>';
    for (var $art_inueoemlbb$art_i = 0, $art_cbgjkczaj$art_c = list.length; $art_inueoemlbb$art_i < $art_cbgjkczaj$art_c; $art_inueoemlbb$art_i++) {
        var item = list[$art_inueoemlbb$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_inwhfpwqtub$art_i = 0, $art_objijxlfghv$art_obj = item.subs, $art_cjsrjzwjrj$art_c = $art_objijxlfghv$art_obj.length; $art_inwhfpwqtub$art_i < $art_cjsrjzwjrj$art_c; $art_inwhfpwqtub$art_i++) {        var sub = $art_objijxlfghv$art_obj[$art_inwhfpwqtub$art_i]%>';
        for (var $art_inwhfpwqtub$art_i = 0, $art_objijxlfghv$art_obj = item.subs, $art_cjsrjzwjrj$art_c = $art_objijxlfghv$art_obj.length; $art_inwhfpwqtub$art_i < $art_cjsrjzwjrj$art_c; $art_inwhfpwqtub$art_i++) {
            var sub = $art_objijxlfghv$art_obj[$art_inwhfpwqtub$art_i];
