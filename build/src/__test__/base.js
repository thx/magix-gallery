...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibzyztsd$art_i = 0, $art_cmgaretf$art_c = headers.length; $art_ibzyztsd$art_i < $art_cmgaretf$art_c; $art_ibzyztsd$art_i++) {    var h = headers[$art_ibzyztsd$art_i]%>';
    for (var $art_ibzyztsd$art_i = 0, $art_cmgaretf$art_c = headers.length; $art_ibzyztsd$art_i < $art_cmgaretf$art_c; $art_ibzyztsd$art_i++) {
        var h = headers[$art_ibzyztsd$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ijqlckhylr$art_i = 0, $art_clgezxud$art_c = list.length; $art_ijqlckhylr$art_i < $art_clgezxud$art_c; $art_ijqlckhylr$art_i++) {    var item = list[$art_ijqlckhylr$art_i]%>';
    for (var $art_ijqlckhylr$art_i = 0, $art_clgezxud$art_c = list.length; $art_ijqlckhylr$art_i < $art_clgezxud$art_c; $art_ijqlckhylr$art_i++) {
        var item = list[$art_ijqlckhylr$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iqcsyvqpic$art_i = 0, $art_objcsxlktxp$art_obj = item.subs, $art_ccpggguo$art_c = $art_objcsxlktxp$art_obj.length; $art_iqcsyvqpic$art_i < $art_ccpggguo$art_c; $art_iqcsyvqpic$art_i++) {        var sub = $art_objcsxlktxp$art_obj[$art_iqcsyvqpic$art_i]%>';
        for (var $art_iqcsyvqpic$art_i = 0, $art_objcsxlktxp$art_obj = item.subs, $art_ccpggguo$art_c = $art_objcsxlktxp$art_obj.length; $art_iqcsyvqpic$art_i < $art_ccpggguo$art_c; $art_iqcsyvqpic$art_i++) {
            var sub = $art_objcsxlktxp$art_obj[$art_iqcsyvqpic$art_i];
