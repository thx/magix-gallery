...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idjdquukp$art_i = 0, $art_cjgjdomx$art_c = headers.length; $art_idjdquukp$art_i < $art_cjgjdomx$art_c; $art_idjdquukp$art_i++) {    var h = headers[$art_idjdquukp$art_i]%>';
    for (var $art_idjdquukp$art_i = 0, $art_cjgjdomx$art_c = headers.length; $art_idjdquukp$art_i < $art_cjgjdomx$art_c; $art_idjdquukp$art_i++) {
        var h = headers[$art_idjdquukp$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ihgwrtutly$art_i = 0, $art_chqivazlhu$art_c = list.length; $art_ihgwrtutly$art_i < $art_chqivazlhu$art_c; $art_ihgwrtutly$art_i++) {    var item = list[$art_ihgwrtutly$art_i]%>';
    for (var $art_ihgwrtutly$art_i = 0, $art_chqivazlhu$art_c = list.length; $art_ihgwrtutly$art_i < $art_chqivazlhu$art_c; $art_ihgwrtutly$art_i++) {
        var item = list[$art_ihgwrtutly$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iarglxzfjb$art_i = 0, $art_objjouztnisen$art_obj = item.subs, $art_cmopidxgd$art_c = $art_objjouztnisen$art_obj.length; $art_iarglxzfjb$art_i < $art_cmopidxgd$art_c; $art_iarglxzfjb$art_i++) {        var sub = $art_objjouztnisen$art_obj[$art_iarglxzfjb$art_i]%>';
        for (var $art_iarglxzfjb$art_i = 0, $art_objjouztnisen$art_obj = item.subs, $art_cmopidxgd$art_c = $art_objjouztnisen$art_obj.length; $art_iarglxzfjb$art_i < $art_cmopidxgd$art_c; $art_iarglxzfjb$art_i++) {
            var sub = $art_objjouztnisen$art_obj[$art_iarglxzfjb$art_i];
