...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iihdafou$art_i = 0, $art_caadfghfyzj$art_c = headers.length; $art_iihdafou$art_i < $art_caadfghfyzj$art_c; $art_iihdafou$art_i++) {    var h = headers[$art_iihdafou$art_i]%>';
    for (var $art_iihdafou$art_i = 0, $art_caadfghfyzj$art_c = headers.length; $art_iihdafou$art_i < $art_caadfghfyzj$art_c; $art_iihdafou$art_i++) {
        var h = headers[$art_iihdafou$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_inijysxxcon$art_i = 0, $art_ccsvwhry$art_c = list.length; $art_inijysxxcon$art_i < $art_ccsvwhry$art_c; $art_inijysxxcon$art_i++) {    var item = list[$art_inijysxxcon$art_i]%>';
    for (var $art_inijysxxcon$art_i = 0, $art_ccsvwhry$art_c = list.length; $art_inijysxxcon$art_i < $art_ccsvwhry$art_c; $art_inijysxxcon$art_i++) {
        var item = list[$art_inijysxxcon$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_isprntzmr$art_i = 0, $art_objrydgmfm$art_obj = item.subs, $art_covmabjue$art_c = $art_objrydgmfm$art_obj.length; $art_isprntzmr$art_i < $art_covmabjue$art_c; $art_isprntzmr$art_i++) {        var sub = $art_objrydgmfm$art_obj[$art_isprntzmr$art_i]%>';
        for (var $art_isprntzmr$art_i = 0, $art_objrydgmfm$art_obj = item.subs, $art_covmabjue$art_c = $art_objrydgmfm$art_obj.length; $art_isprntzmr$art_i < $art_covmabjue$art_c; $art_isprntzmr$art_i++) {
            var sub = $art_objrydgmfm$art_obj[$art_isprntzmr$art_i];
