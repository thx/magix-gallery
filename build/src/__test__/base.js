...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iufoqlulvb$art_i = 0, $art_cqbkmctwy$art_c = list.length; $art_iufoqlulvb$art_i < $art_cqbkmctwy$art_c; $art_iufoqlulvb$art_i++) {    var item = list[$art_iufoqlulvb$art_i]%>';
    for (var $art_iufoqlulvb$art_i = 0, $art_cqbkmctwy$art_c = list.length; $art_iufoqlulvb$art_i < $art_cqbkmctwy$art_c; $art_iufoqlulvb$art_i++) {
        var item = list[$art_iufoqlulvb$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_imkiru$art_i = 0, $art_objuppysrzhx$art_obj = item.subs, $art_clupvudgl$art_c = $art_objuppysrzhx$art_obj.length; $art_imkiru$art_i < $art_clupvudgl$art_c; $art_imkiru$art_i++) {        var sub = $art_objuppysrzhx$art_obj[$art_imkiru$art_i]%>';
        for (var $art_imkiru$art_i = 0, $art_objuppysrzhx$art_obj = item.subs, $art_clupvudgl$art_c = $art_objuppysrzhx$art_obj.length; $art_imkiru$art_i < $art_clupvudgl$art_c; $art_imkiru$art_i++) {
            var sub = $art_objuppysrzhx$art_obj[$art_imkiru$art_i];
