...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iombllu$art_i = 0, $art_cujbvbv$art_c = headers.length; $art_iombllu$art_i < $art_cujbvbv$art_c; $art_iombllu$art_i++) {    var h = headers[$art_iombllu$art_i]%>';
    for (var $art_iombllu$art_i = 0, $art_cujbvbv$art_c = headers.length; $art_iombllu$art_i < $art_cujbvbv$art_c; $art_iombllu$art_i++) {
        var h = headers[$art_iombllu$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.outer';
        ;
    ...
    ;
    $expr = '<%for (var $art_ioefmpvhfs$art_i = 0, $art_cebsnhpo$art_c = list.length; $art_ioefmpvhfs$art_i < $art_cebsnhpo$art_c; $art_ioefmpvhfs$art_i++) {    var item = list[$art_ioefmpvhfs$art_i]%>';
    for (var $art_ioefmpvhfs$art_i = 0, $art_cebsnhpo$art_c = list.length; $art_ioefmpvhfs$art_i < $art_cebsnhpo$art_c; $art_ioefmpvhfs$art_i++) {
        var item = list[$art_ioefmpvhfs$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_izycbojaimg$art_i = 0, $art_objjggamnw$art_obj = item.subs, $art_cmlgcqtusj$art_c = $art_objjggamnw$art_obj.length; $art_izycbojaimg$art_i < $art_cmlgcqtusj$art_c; $art_izycbojaimg$art_i++) {        var sub = $art_objjggamnw$art_obj[$art_izycbojaimg$art_i]%>';
        for (var $art_izycbojaimg$art_i = 0, $art_objjggamnw$art_obj = item.subs, $art_cmlgcqtusj$art_c = $art_objjggamnw$art_obj.length; $art_izycbojaimg$art_i < $art_cmlgcqtusj$art_c; $art_izycbojaimg$art_i++) {
            var sub = $art_objjggamnw$art_obj[$art_izycbojaimg$art_i];
