...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izzchhceu$art_i = 0, $art_czpwabfmvi$art_c = headers.length; $art_izzchhceu$art_i < $art_czpwabfmvi$art_c; $art_izzchhceu$art_i++) {    var h = headers[$art_izzchhceu$art_i]%>';
    for (var $art_izzchhceu$art_i = 0, $art_czpwabfmvi$art_c = headers.length; $art_izzchhceu$art_i < $art_czpwabfmvi$art_c; $art_izzchhceu$art_i++) {
        var h = headers[$art_izzchhceu$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ividtsbf$art_i = 0, $art_cvhkvxkx$art_c = list.length; $art_ividtsbf$art_i < $art_cvhkvxkx$art_c; $art_ividtsbf$art_i++) {    var item = list[$art_ividtsbf$art_i]%>';
    for (var $art_ividtsbf$art_i = 0, $art_cvhkvxkx$art_c = list.length; $art_ividtsbf$art_i < $art_cvhkvxkx$art_c; $art_ividtsbf$art_i++) {
        var item = list[$art_ividtsbf$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iwfmemptg$art_i = 0, $art_objxjvtj$art_obj = item.subs, $art_cypkgtt$art_c = $art_objxjvtj$art_obj.length; $art_iwfmemptg$art_i < $art_cypkgtt$art_c; $art_iwfmemptg$art_i++) {        var sub = $art_objxjvtj$art_obj[$art_iwfmemptg$art_i]%>';
        for (var $art_iwfmemptg$art_i = 0, $art_objxjvtj$art_obj = item.subs, $art_cypkgtt$art_c = $art_objxjvtj$art_obj.length; $art_iwfmemptg$art_i < $art_cypkgtt$art_c; $art_iwfmemptg$art_i++) {
            var sub = $art_objxjvtj$art_obj[$art_iwfmemptg$art_i];
