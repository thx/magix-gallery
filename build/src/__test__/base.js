...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_irxtzpw$art_i = 0, $art_ctjcxgxles$art_c = list.length; $art_irxtzpw$art_i < $art_ctjcxgxles$art_c; $art_irxtzpw$art_i++) {    var item = list[$art_irxtzpw$art_i]%>';
    for (var $art_irxtzpw$art_i = 0, $art_ctjcxgxles$art_c = list.length; $art_irxtzpw$art_i < $art_ctjcxgxles$art_c; $art_irxtzpw$art_i++) {
        var item = list[$art_irxtzpw$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iyiaexuxgce$art_i = 0, $art_objtkuyzoj$art_obj = item.subs, $art_cfllzyronjq$art_c = $art_objtkuyzoj$art_obj.length; $art_iyiaexuxgce$art_i < $art_cfllzyronjq$art_c; $art_iyiaexuxgce$art_i++) {        var sub = $art_objtkuyzoj$art_obj[$art_iyiaexuxgce$art_i]%>';
        for (var $art_iyiaexuxgce$art_i = 0, $art_objtkuyzoj$art_obj = item.subs, $art_cfllzyronjq$art_c = $art_objtkuyzoj$art_obj.length; $art_iyiaexuxgce$art_i < $art_cfllzyronjq$art_c; $art_iyiaexuxgce$art_i++) {
            var sub = $art_objtkuyzoj$art_obj[$art_iyiaexuxgce$art_i];
