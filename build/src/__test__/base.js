...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iogbabyh$art_i = 0, $art_coxcihnilq$art_c = headers.length; $art_iogbabyh$art_i < $art_coxcihnilq$art_c; $art_iogbabyh$art_i++) {    var h = headers[$art_iogbabyh$art_i]%>';
    for (var $art_iogbabyh$art_i = 0, $art_coxcihnilq$art_c = headers.length; $art_iogbabyh$art_i < $art_coxcihnilq$art_c; $art_iogbabyh$art_i++) {
        var h = headers[$art_iogbabyh$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_inpefdrnnr$art_i = 0, $art_ciqjqmjeks$art_c = list.length; $art_inpefdrnnr$art_i < $art_ciqjqmjeks$art_c; $art_inpefdrnnr$art_i++) {    var item = list[$art_inpefdrnnr$art_i]%>';
    for (var $art_inpefdrnnr$art_i = 0, $art_ciqjqmjeks$art_c = list.length; $art_inpefdrnnr$art_i < $art_ciqjqmjeks$art_c; $art_inpefdrnnr$art_i++) {
        var item = list[$art_inpefdrnnr$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_idxdxpoye$art_i = 0, $art_objmltgkllo$art_obj = item.subs, $art_cmiorvrrw$art_c = $art_objmltgkllo$art_obj.length; $art_idxdxpoye$art_i < $art_cmiorvrrw$art_c; $art_idxdxpoye$art_i++) {        var sub = $art_objmltgkllo$art_obj[$art_idxdxpoye$art_i]%>';
        for (var $art_idxdxpoye$art_i = 0, $art_objmltgkllo$art_obj = item.subs, $art_cmiorvrrw$art_c = $art_objmltgkllo$art_obj.length; $art_idxdxpoye$art_i < $art_cmiorvrrw$art_c; $art_idxdxpoye$art_i++) {
            var sub = $art_objmltgkllo$art_obj[$art_idxdxpoye$art_i];
