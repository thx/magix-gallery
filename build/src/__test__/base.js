...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iereizd$art_i = 0, $art_cakhysmqvq$art_c = headers.length; $art_iereizd$art_i < $art_cakhysmqvq$art_c; $art_iereizd$art_i++) {    var h = headers[$art_iereizd$art_i]%>';
    for (var $art_iereizd$art_i = 0, $art_cakhysmqvq$art_c = headers.length; $art_iereizd$art_i < $art_cakhysmqvq$art_c; $art_iereizd$art_i++) {
        var h = headers[$art_iereizd$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ievulytn$art_i = 0, $art_czaeyfnmryy$art_c = list.length; $art_ievulytn$art_i < $art_czaeyfnmryy$art_c; $art_ievulytn$art_i++) {    var item = list[$art_ievulytn$art_i]%>';
    for (var $art_ievulytn$art_i = 0, $art_czaeyfnmryy$art_c = list.length; $art_ievulytn$art_i < $art_czaeyfnmryy$art_c; $art_ievulytn$art_i++) {
        var item = list[$art_ievulytn$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iiifoj$art_i = 0, $art_objaxobcvijr$art_obj = item.subs, $art_czldjdvbu$art_c = $art_objaxobcvijr$art_obj.length; $art_iiifoj$art_i < $art_czldjdvbu$art_c; $art_iiifoj$art_i++) {        var sub = $art_objaxobcvijr$art_obj[$art_iiifoj$art_i]%>';
        for (var $art_iiifoj$art_i = 0, $art_objaxobcvijr$art_obj = item.subs, $art_czldjdvbu$art_c = $art_objaxobcvijr$art_obj.length; $art_iiifoj$art_i < $art_czldjdvbu$art_c; $art_iiifoj$art_i++) {
            var sub = $art_objaxobcvijr$art_obj[$art_iiifoj$art_i];
