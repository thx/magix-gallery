...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icomqicd$art_i = 0, $art_csowarfpd$art_c = headers.length; $art_icomqicd$art_i < $art_csowarfpd$art_c; $art_icomqicd$art_i++) {    var h = headers[$art_icomqicd$art_i]%>';
    for (var $art_icomqicd$art_i = 0, $art_csowarfpd$art_c = headers.length; $art_icomqicd$art_i < $art_csowarfpd$art_c; $art_icomqicd$art_i++) {
        var h = headers[$art_icomqicd$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_isugwmit$art_i = 0, $art_cdweuopl$art_c = list.length; $art_isugwmit$art_i < $art_cdweuopl$art_c; $art_isugwmit$art_i++) {    var item = list[$art_isugwmit$art_i]%>';
    for (var $art_isugwmit$art_i = 0, $art_cdweuopl$art_c = list.length; $art_isugwmit$art_i < $art_cdweuopl$art_c; $art_isugwmit$art_i++) {
        var item = list[$art_isugwmit$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iauigjguo$art_i = 0, $art_objnpgbknsf$art_obj = item.subs, $art_cqxcyuxq$art_c = $art_objnpgbknsf$art_obj.length; $art_iauigjguo$art_i < $art_cqxcyuxq$art_c; $art_iauigjguo$art_i++) {        var sub = $art_objnpgbknsf$art_obj[$art_iauigjguo$art_i]%>';
        for (var $art_iauigjguo$art_i = 0, $art_objnpgbknsf$art_obj = item.subs, $art_cqxcyuxq$art_c = $art_objnpgbknsf$art_obj.length; $art_iauigjguo$art_i < $art_cqxcyuxq$art_c; $art_iauigjguo$art_i++) {
            var sub = $art_objnpgbknsf$art_obj[$art_iauigjguo$art_i];
