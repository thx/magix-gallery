...
module.exports = Magix.View.extend({
...
} ; var $g = '', $_temp, $p = '', fixed = $$.fixed, minHeight = $$.minHeight, list = $$.list, path = $$.path, cur = $$.cur, view = $$.view, prev = $$.prev, next = $$.next; var $expr, $art, $line; try {
    $p += '<div mxv mxa="_zs_gallerya:_" class="_zs_gallery___test___base_-base"><div class="_zs_gallery___test___base_-left ';
    $line = 2;
    $art = 'if fixed';
    ;
    $expr = '<%if (fixed) {%>';
    ...
    ;
    $expr = '<%for (var $art_iwksjnghmlnc$art_i = 0, $art_ceunhswd$art_c = list.length; $art_iwksjnghmlnc$art_i < $art_ceunhswd$art_c; $art_iwksjnghmlnc$art_i++) {    var item = list[$art_iwksjnghmlnc$art_i]%>';
    for (var $art_iwksjnghmlnc$art_i = 0, $art_ceunhswd$art_c = list.length; $art_iwksjnghmlnc$art_i < $art_ceunhswd$art_c; $art_iwksjnghmlnc$art_i++) {
        var item = list[$art_iwksjnghmlnc$art_i];
        $p += ' ';
        $line = 4;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iwqztodb$art_i = 0, $art_objkxkeqfaja$art_obj = item.subs, $art_covqylmfls$art_c = $art_objkxkeqfaja$art_obj.length; $art_iwqztodb$art_i < $art_covqylmfls$art_c; $art_iwqztodb$art_i++) {        var sub = $art_objkxkeqfaja$art_obj[$art_iwqztodb$art_i]%>';
        for (var $art_iwqztodb$art_i = 0, $art_objkxkeqfaja$art_obj = item.subs, $art_covqylmfls$art_c = $art_objkxkeqfaja$art_obj.length; $art_iwqztodb$art_i < $art_covqylmfls$art_c; $art_iwqztodb$art_i++) {
            var sub = $art_objkxkeqfaja$art_obj[$art_iwqztodb$art_i];
            ...
            $art = '=sub.path';
            ;
            $p += ($expr = '<%=sub.path%>', $e(sub.path)) + '"><i mxa="_zs_gallerya:a" class="mc-iconfont _zs_gallery___test___base_-sub-icon">';
            $line = 14;
            $art = '!sub.icon';
            ;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_gallerya:b" class="_zs_gallery___test___base_-main"><div mxv mxa="_zs_gallerya:c" class="_zs_gallery___test___base_-content"><div mxv="cur" ';
    $line = 23;
    $art = 'if cur.tip';
    ;
    $expr = '<%if (cur.tip) {%>';
    ...
    $art = '=view';
    ;
    $p += ($expr = '<%=view%>', $e(view)) + '"><div mxs="_zs_gallerya:a" class="loading"><span class="loading-anim"></span></div></div></div><div mxa="_zs_gallerya:d" class="_zs_gallery___test___base_-contexts clearfix">';
    $line = 30;
    $art = 'if prev.path';
    ;
    $expr = '<%if (prev.path) {%>';
