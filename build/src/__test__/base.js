...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iymjgvbd$art_i = 0, $art_cwdgyxqvb$art_c = headers.length; $art_iymjgvbd$art_i < $art_cwdgyxqvb$art_c; $art_iymjgvbd$art_i++) {    var h = headers[$art_iymjgvbd$art_i]%>';
    for (var $art_iymjgvbd$art_i = 0, $art_cwdgyxqvb$art_c = headers.length; $art_iymjgvbd$art_i < $art_cwdgyxqvb$art_c; $art_iymjgvbd$art_i++) {
        var h = headers[$art_iymjgvbd$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ijerkhdq$art_i = 0, $art_chkdycvob$art_c = list.length; $art_ijerkhdq$art_i < $art_chkdycvob$art_c; $art_ijerkhdq$art_i++) {    var item = list[$art_ijerkhdq$art_i]%>';
    for (var $art_ijerkhdq$art_i = 0, $art_chkdycvob$art_c = list.length; $art_ijerkhdq$art_i < $art_chkdycvob$art_c; $art_ijerkhdq$art_i++) {
        var item = list[$art_ijerkhdq$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_imnuobbh$art_i = 0, $art_objgbdmt$art_obj = item.subs, $art_cszkwhmpxt$art_c = $art_objgbdmt$art_obj.length; $art_imnuobbh$art_i < $art_cszkwhmpxt$art_c; $art_imnuobbh$art_i++) {        var sub = $art_objgbdmt$art_obj[$art_imnuobbh$art_i]%>';
        for (var $art_imnuobbh$art_i = 0, $art_objgbdmt$art_obj = item.subs, $art_cszkwhmpxt$art_c = $art_objgbdmt$art_obj.length; $art_imnuobbh$art_i < $art_cszkwhmpxt$art_c; $art_imnuobbh$art_i++) {
            var sub = $art_objgbdmt$art_obj[$art_imnuobbh$art_i];
