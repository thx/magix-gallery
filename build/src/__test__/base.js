...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igssvlmfo$art_i = 0, $art_cmnunjzeb$art_c = headers.length; $art_igssvlmfo$art_i < $art_cmnunjzeb$art_c; $art_igssvlmfo$art_i++) {    var h = headers[$art_igssvlmfo$art_i]%>';
    for (var $art_igssvlmfo$art_i = 0, $art_cmnunjzeb$art_c = headers.length; $art_igssvlmfo$art_i < $art_cmnunjzeb$art_c; $art_igssvlmfo$art_i++) {
        var h = headers[$art_igssvlmfo$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ipzgseoya$art_i = 0, $art_comghawn$art_c = list.length; $art_ipzgseoya$art_i < $art_comghawn$art_c; $art_ipzgseoya$art_i++) {    var item = list[$art_ipzgseoya$art_i]%>';
    for (var $art_ipzgseoya$art_i = 0, $art_comghawn$art_c = list.length; $art_ipzgseoya$art_i < $art_comghawn$art_c; $art_ipzgseoya$art_i++) {
        var item = list[$art_ipzgseoya$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_idsnadzdp$art_i = 0, $art_objuzfyjxdn$art_obj = item.subs, $art_capgvljt$art_c = $art_objuzfyjxdn$art_obj.length; $art_idsnadzdp$art_i < $art_capgvljt$art_c; $art_idsnadzdp$art_i++) {        var sub = $art_objuzfyjxdn$art_obj[$art_idsnadzdp$art_i]%>';
        for (var $art_idsnadzdp$art_i = 0, $art_objuzfyjxdn$art_obj = item.subs, $art_capgvljt$art_c = $art_objuzfyjxdn$art_obj.length; $art_idsnadzdp$art_i < $art_capgvljt$art_c; $art_idsnadzdp$art_i++) {
            var sub = $art_objuzfyjxdn$art_obj[$art_idsnadzdp$art_i];
