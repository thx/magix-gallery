...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqcnyejed$art_i = 0, $art_cghskse$art_c = headers.length; $art_iqcnyejed$art_i < $art_cghskse$art_c; $art_iqcnyejed$art_i++) {    var h = headers[$art_iqcnyejed$art_i]%>';
    for (var $art_iqcnyejed$art_i = 0, $art_cghskse$art_c = headers.length; $art_iqcnyejed$art_i < $art_cghskse$art_c; $art_iqcnyejed$art_i++) {
        var h = headers[$art_iqcnyejed$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_irhafxuhcl$art_i = 0, $art_ceifip$art_c = list.length; $art_irhafxuhcl$art_i < $art_ceifip$art_c; $art_irhafxuhcl$art_i++) {    var item = list[$art_irhafxuhcl$art_i]%>';
    for (var $art_irhafxuhcl$art_i = 0, $art_ceifip$art_c = list.length; $art_irhafxuhcl$art_i < $art_ceifip$art_c; $art_irhafxuhcl$art_i++) {
        var item = list[$art_irhafxuhcl$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_isnmvwxn$art_i = 0, $art_objezryyqs$art_obj = item.subs, $art_cuzsyrtrk$art_c = $art_objezryyqs$art_obj.length; $art_isnmvwxn$art_i < $art_cuzsyrtrk$art_c; $art_isnmvwxn$art_i++) {        var sub = $art_objezryyqs$art_obj[$art_isnmvwxn$art_i]%>';
        for (var $art_isnmvwxn$art_i = 0, $art_objezryyqs$art_obj = item.subs, $art_cuzsyrtrk$art_c = $art_objezryyqs$art_obj.length; $art_isnmvwxn$art_i < $art_cuzsyrtrk$art_c; $art_isnmvwxn$art_i++) {
            var sub = $art_objezryyqs$art_obj[$art_isnmvwxn$art_i];
