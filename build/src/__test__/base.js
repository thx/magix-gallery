...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iezugmg$art_i = 0, $art_cdgaguhhcd$art_c = headers.length; $art_iezugmg$art_i < $art_cdgaguhhcd$art_c; $art_iezugmg$art_i++) {    var h = headers[$art_iezugmg$art_i]%>';
    for (var $art_iezugmg$art_i = 0, $art_cdgaguhhcd$art_c = headers.length; $art_iezugmg$art_i < $art_cdgaguhhcd$art_c; $art_iezugmg$art_i++) {
        var h = headers[$art_iezugmg$art_i];
        $p += '<a href="#!';
        $line = 19;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ipntokdcik$art_i = 0, $art_ctjvbhw$art_c = list.length; $art_ipntokdcik$art_i < $art_ctjvbhw$art_c; $art_ipntokdcik$art_i++) {    var item = list[$art_ipntokdcik$art_i]%>';
    for (var $art_ipntokdcik$art_i = 0, $art_ctjvbhw$art_c = list.length; $art_ipntokdcik$art_i < $art_ctjvbhw$art_c; $art_ipntokdcik$art_i++) {
        var item = list[$art_ipntokdcik$art_i];
        $p += ' ';
        $line = 26;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_instfgpuq$art_i = 0, $art_objfbue$art_obj = item.subs, $art_coubbgmbe$art_c = $art_objfbue$art_obj.length; $art_instfgpuq$art_i < $art_coubbgmbe$art_c; $art_instfgpuq$art_i++) {        var sub = $art_objfbue$art_obj[$art_instfgpuq$art_i]%>';
        for (var $art_instfgpuq$art_i = 0, $art_objfbue$art_obj = item.subs, $art_coubbgmbe$art_c = $art_objfbue$art_obj.length; $art_instfgpuq$art_i < $art_coubbgmbe$art_c; $art_instfgpuq$art_i++) {
            var sub = $art_objfbue$art_obj[$art_instfgpuq$art_i];
