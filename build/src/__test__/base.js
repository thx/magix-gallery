...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irmacfjysrk$art_i = 0, $art_ccxweqluqa$art_c = headers.length; $art_irmacfjysrk$art_i < $art_ccxweqluqa$art_c; $art_irmacfjysrk$art_i++) {    var h = headers[$art_irmacfjysrk$art_i]%>';
    for (var $art_irmacfjysrk$art_i = 0, $art_ccxweqluqa$art_c = headers.length; $art_irmacfjysrk$art_i < $art_ccxweqluqa$art_c; $art_irmacfjysrk$art_i++) {
        var h = headers[$art_irmacfjysrk$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_icaibbwp$art_i = 0, $art_ccwtdovmsfe$art_c = list.length; $art_icaibbwp$art_i < $art_ccwtdovmsfe$art_c; $art_icaibbwp$art_i++) {    var item = list[$art_icaibbwp$art_i]%>';
    for (var $art_icaibbwp$art_i = 0, $art_ccwtdovmsfe$art_c = list.length; $art_icaibbwp$art_i < $art_ccwtdovmsfe$art_c; $art_icaibbwp$art_i++) {
        var item = list[$art_icaibbwp$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_irysfiziaoho$art_i = 0, $art_objdmcqdeb$art_obj = item.subs, $art_caeumeyv$art_c = $art_objdmcqdeb$art_obj.length; $art_irysfiziaoho$art_i < $art_caeumeyv$art_c; $art_irysfiziaoho$art_i++) {        var sub = $art_objdmcqdeb$art_obj[$art_irysfiziaoho$art_i]%>';
        for (var $art_irysfiziaoho$art_i = 0, $art_objdmcqdeb$art_obj = item.subs, $art_caeumeyv$art_c = $art_objdmcqdeb$art_obj.length; $art_irysfiziaoho$art_i < $art_caeumeyv$art_c; $art_irysfiziaoho$art_i++) {
            var sub = $art_objdmcqdeb$art_obj[$art_irysfiziaoho$art_i];
