...
module.exports = Magix.View.extend({
...
} ; var $g = '', $_temp, $p = '', fixed = $$.fixed, selectedValue = $$.selectedValue, all = $$.all, minHeight = $$.minHeight, list = $$.list, path = $$.path, cur = $$.cur, view = $$.view, prev = $$.prev, next = $$.next; var $expr, $art, $line; try {
    $p += '<div mxv mxa="_zs_gallerya:_" class="_zs_gallery___test___base_-base"><div mxv class="_zs_gallery___test___base_-left ';
    $line = 2;
    $art = 'if fixed';
    ;
    $expr = '<%if (fixed) {%>';
    ...
    ;
    $p += '"><div mxv mxa="_zs_gallerya:a" class="_zs_gallery___test___base_-left-search-wrapper"><div mxv="all" class="_zs_gallery___test___base_-left-search" mx-suggest="' + $viewId + 'suggest()" mx-view="mx-suggest/index?selected=';
    $line = 5;
    $art = '=selectedValue';
    ;
    ...
    $art = '@all';
    ;
    $p += ($expr = '<%@all%>', $i($$ref, all)) + '&listText=name&listValue=path&type=all"></div></div><div class="_zs_gallery___test___base_-left-inner" style="height: ';
    $line = 13;
    $art = '=minHeight - 30';
    ;
    $p += ($expr = '<%=minHeight - 30%>', $e(minHeight - 30)) + 'px;">';
    $line = 14;
    $art = 'each list as item';
    ;
    $expr = '<%for (var $art_irrjgwfbphp$art_i = 0, $art_cldauflei$art_c = list.length; $art_irrjgwfbphp$art_i < $art_cldauflei$art_c; $art_irrjgwfbphp$art_i++) {    var item = list[$art_irrjgwfbphp$art_i]%>';
    for (var $art_irrjgwfbphp$art_i = 0, $art_cldauflei$art_c = list.length; $art_irrjgwfbphp$art_i < $art_cldauflei$art_c; $art_irrjgwfbphp$art_i++) {
        var item = list[$art_irrjgwfbphp$art_i];
        $p += ' ';
        $line = 15;
        $art = 'if item.name';
        ;
        ...
        if (item.name) {
            ...
            $art = '!item.name';
            ;
            $p += ($expr = '<%!item.name%>', $n(item.name)) + '<i mxs="_zs_gallerya:_" class="mc-iconfont _zs_gallery___test___base_-title-icon">&#xe692;</i></span>';
            $line = 21;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        ;
        $expr = '<%for (var $art_ivqfqdkaa$art_i = 0, $art_objitennddrrr$art_obj = item.subs, $art_crwuyfdsa$art_c = $art_objitennddrrr$art_obj.length; $art_ivqfqdkaa$art_i < $art_crwuyfdsa$art_c; $art_ivqfqdkaa$art_i++) {        var sub = $art_objitennddrrr$art_obj[$art_ivqfqdkaa$art_i]%>';
        for (var $art_ivqfqdkaa$art_i = 0, $art_objitennddrrr$art_obj = item.subs, $art_crwuyfdsa$art_c = $art_objitennddrrr$art_obj.length; $art_ivqfqdkaa$art_i < $art_crwuyfdsa$art_c; $art_ivqfqdkaa$art_i++) {
            var sub = $art_objitennddrrr$art_obj[$art_ivqfqdkaa$art_i];
            ...
            $art = '=sub.path';
            ;
            $p += ($expr = '<%=sub.path%>', $e(sub.path)) + '"><i mxa="_zs_gallerya:b" class="mc-iconfont _zs_gallery___test___base_-sub-icon">';
            $line = 25;
            $art = '!sub.icon';
            ;
    ...
    ;
    $p += '</div></div><div mxv mxa="_zs_gallerya:c" class="_zs_gallery___test___base_-main"><div mxv mxa="_zs_gallerya:d" class="_zs_gallery___test___base_-content"><div mxv="cur" ';
    $line = 35;
    $art = 'if cur.tip';
    ;
    $expr = '<%if (cur.tip) {%>';
    ...
    $art = '=view';
    ;
    $p += ($expr = '<%=view%>', $e(view)) + '"><div mxs="_zs_gallerya:a" class="loading"><span class="loading-anim"></span></div></div></div><div mxa="_zs_gallerya:e" class="_zs_gallery___test___base_-contexts clearfix">';
    $line = 42;
    $art = 'if prev.path';
    ;
    $expr = '<%if (prev.path) {%>';
    if (prev.path) {
        ...
        $art = '=prev.path';
        ;
        $p += ($expr = '<%=prev.path%>', $e(prev.path)) + '" class="_zs_gallery___test___base_-prev link-brand"><i mxs="_zs_gallerya:b" class="mc-iconfont _zs_gallery___test___base_-context-icon">&#xe63a;</i>上一篇：';
        $line = 45;
        $art = '!prev.name';
        ;
    ...
    if (next.path) {
        ...
        $art = '=next.path';
        ;
        $p += ($expr = '<%=next.path%>', $e(next.path)) + '" class="_zs_gallery___test___base_-next link-brand"><i mxs="_zs_gallerya:b" class="mc-iconfont _zs_gallery___test___base_-context-icon">&#xe63a;</i>下一篇：';
        $line = 51;
        $art = '!next.name';
        ;
    ...
    ;
    $p += '</div></div></div><div mxs="_zs_gallerya:c" class="_zs_gallery___test___base_-fixes"><a href="https://aone.alibaba-inc.com/project/768817/req?akProjectId=768817&spm=a2o8d.rdc_projecthome.0.0.70b27a26750VTM" target="_blank" rel="noopener noreferrer" class="_zs_gallery___test___base_-fix"><i class="mc-iconfont _zs_gallery___test___base_-fix-icon">&#xe64f;</i><span class="_zs_gallery___test___base_-fix-tip">给我提需求</span></a><a href="https://aone.alibaba-inc.com/project/768817/issue?spm=a2o8d.corp_prod_req_list.0.0.3e646b88s8ezBH" target="_blank" rel="noopener noreferrer" class="_zs_gallery___test___base_-fix"><i class="mc-iconfont _zs_gallery___test___base_-fix-icon">&#xe63d;</i><span class="_zs_gallery___test___base_-fix-tip">帮我找bug</span></a><a href="dingtalk://dingtalkclient/action/sendmsg?dingtalk_id=t5z4z8s" class="_zs_gallery___test___base_-fix"><i class="mc-iconfont _zs_gallery___test___base_-fix-icon">&#xe677;</i><span class="_zs_gallery___test___base_-fix-tip">钉我一下</span></a></div>';
}
catch (ex) {
    ...
    '$win<scroll>': function (e) {
        ...
        var bodyNode = mainNode.find('._zs_gallery___test___base_-main');
