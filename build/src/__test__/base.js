...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipyvfyvcc$art_i = 0, $art_cemfombp$art_c = headers.length; $art_ipyvfyvcc$art_i < $art_cemfombp$art_c; $art_ipyvfyvcc$art_i++) {    var h = headers[$art_ipyvfyvcc$art_i]%>';
    for (var $art_ipyvfyvcc$art_i = 0, $art_cemfombp$art_c = headers.length; $art_ipyvfyvcc$art_i < $art_cemfombp$art_c; $art_ipyvfyvcc$art_i++) {
        var h = headers[$art_ipyvfyvcc$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ivkeigz$art_i = 0, $art_cvicwg$art_c = list.length; $art_ivkeigz$art_i < $art_cvicwg$art_c; $art_ivkeigz$art_i++) {    var item = list[$art_ivkeigz$art_i]%>';
    for (var $art_ivkeigz$art_i = 0, $art_cvicwg$art_c = list.length; $art_ivkeigz$art_i < $art_cvicwg$art_c; $art_ivkeigz$art_i++) {
        var item = list[$art_ivkeigz$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ibxqapoo$art_i = 0, $art_objydnunsg$art_obj = item.subs, $art_cyjipgpd$art_c = $art_objydnunsg$art_obj.length; $art_ibxqapoo$art_i < $art_cyjipgpd$art_c; $art_ibxqapoo$art_i++) {        var sub = $art_objydnunsg$art_obj[$art_ibxqapoo$art_i]%>';
        for (var $art_ibxqapoo$art_i = 0, $art_objydnunsg$art_obj = item.subs, $art_cyjipgpd$art_c = $art_objydnunsg$art_obj.length; $art_ibxqapoo$art_i < $art_cyjipgpd$art_c; $art_ibxqapoo$art_i++) {
            var sub = $art_objydnunsg$art_obj[$art_ibxqapoo$art_i];
