...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ituxypgg$art_i = 0, $art_cmarooyhef$art_c = headers.length; $art_ituxypgg$art_i < $art_cmarooyhef$art_c; $art_ituxypgg$art_i++) {    var h = headers[$art_ituxypgg$art_i]%>';
    for (var $art_ituxypgg$art_i = 0, $art_cmarooyhef$art_c = headers.length; $art_ituxypgg$art_i < $art_cmarooyhef$art_c; $art_ituxypgg$art_i++) {
        var h = headers[$art_ituxypgg$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iljsflzmucj$art_i = 0, $art_cduzzosbftn$art_c = list.length; $art_iljsflzmucj$art_i < $art_cduzzosbftn$art_c; $art_iljsflzmucj$art_i++) {    var item = list[$art_iljsflzmucj$art_i]%>';
    for (var $art_iljsflzmucj$art_i = 0, $art_cduzzosbftn$art_c = list.length; $art_iljsflzmucj$art_i < $art_cduzzosbftn$art_c; $art_iljsflzmucj$art_i++) {
        var item = list[$art_iljsflzmucj$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iteyijpwgvx$art_i = 0, $art_objwemtymzzi$art_obj = item.subs, $art_cytruqaexm$art_c = $art_objwemtymzzi$art_obj.length; $art_iteyijpwgvx$art_i < $art_cytruqaexm$art_c; $art_iteyijpwgvx$art_i++) {        var sub = $art_objwemtymzzi$art_obj[$art_iteyijpwgvx$art_i]%>';
        for (var $art_iteyijpwgvx$art_i = 0, $art_objwemtymzzi$art_obj = item.subs, $art_cytruqaexm$art_c = $art_objwemtymzzi$art_obj.length; $art_iteyijpwgvx$art_i < $art_cytruqaexm$art_c; $art_iteyijpwgvx$art_i++) {
            var sub = $art_objwemtymzzi$art_obj[$art_iteyijpwgvx$art_i];
