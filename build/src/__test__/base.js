...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iggfdvhkf$art_i = 0, $art_clntpi$art_c = list.length; $art_iggfdvhkf$art_i < $art_clntpi$art_c; $art_iggfdvhkf$art_i++) {    var item = list[$art_iggfdvhkf$art_i]%>';
    for (var $art_iggfdvhkf$art_i = 0, $art_clntpi$art_c = list.length; $art_iggfdvhkf$art_i < $art_clntpi$art_c; $art_iggfdvhkf$art_i++) {
        var item = list[$art_iggfdvhkf$art_i];
        $p += ' ';
        $line = 4;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iutmdk$art_i = 0, $art_objrxdasc$art_obj = item.subs, $art_cvjoclwc$art_c = $art_objrxdasc$art_obj.length; $art_iutmdk$art_i < $art_cvjoclwc$art_c; $art_iutmdk$art_i++) {        var sub = $art_objrxdasc$art_obj[$art_iutmdk$art_i]%>';
        for (var $art_iutmdk$art_i = 0, $art_objrxdasc$art_obj = item.subs, $art_cvjoclwc$art_c = $art_objrxdasc$art_obj.length; $art_iutmdk$art_i < $art_cvjoclwc$art_c; $art_iutmdk$art_i++) {
            var sub = $art_objrxdasc$art_obj[$art_iutmdk$art_i];
