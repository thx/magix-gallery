...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izsblkliuo$art_i = 0, $art_cbnsovvome$art_c = headers.length; $art_izsblkliuo$art_i < $art_cbnsovvome$art_c; $art_izsblkliuo$art_i++) {    var h = headers[$art_izsblkliuo$art_i]%>';
    for (var $art_izsblkliuo$art_i = 0, $art_cbnsovvome$art_c = headers.length; $art_izsblkliuo$art_i < $art_cbnsovvome$art_c; $art_izsblkliuo$art_i++) {
        var h = headers[$art_izsblkliuo$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_izyxossmxm$art_i = 0, $art_csozbjombi$art_c = list.length; $art_izyxossmxm$art_i < $art_csozbjombi$art_c; $art_izyxossmxm$art_i++) {    var item = list[$art_izyxossmxm$art_i]%>';
    for (var $art_izyxossmxm$art_i = 0, $art_csozbjombi$art_c = list.length; $art_izyxossmxm$art_i < $art_csozbjombi$art_c; $art_izyxossmxm$art_i++) {
        var item = list[$art_izyxossmxm$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iadgbhzq$art_i = 0, $art_objtmyenm$art_obj = item.subs, $art_cpylhed$art_c = $art_objtmyenm$art_obj.length; $art_iadgbhzq$art_i < $art_cpylhed$art_c; $art_iadgbhzq$art_i++) {        var sub = $art_objtmyenm$art_obj[$art_iadgbhzq$art_i]%>';
        for (var $art_iadgbhzq$art_i = 0, $art_objtmyenm$art_obj = item.subs, $art_cpylhed$art_c = $art_objtmyenm$art_obj.length; $art_iadgbhzq$art_i < $art_cpylhed$art_c; $art_iadgbhzq$art_i++) {
            var sub = $art_objtmyenm$art_obj[$art_iadgbhzq$art_i];
