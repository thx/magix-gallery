...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ielntgjrsgu$art_i = 0, $art_cohputcubm$art_c = headers.length; $art_ielntgjrsgu$art_i < $art_cohputcubm$art_c; $art_ielntgjrsgu$art_i++) {    var h = headers[$art_ielntgjrsgu$art_i]%>';
    for (var $art_ielntgjrsgu$art_i = 0, $art_cohputcubm$art_c = headers.length; $art_ielntgjrsgu$art_i < $art_cohputcubm$art_c; $art_ielntgjrsgu$art_i++) {
        var h = headers[$art_ielntgjrsgu$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ikcjkfebbi$art_i = 0, $art_cudrahtxbk$art_c = list.length; $art_ikcjkfebbi$art_i < $art_cudrahtxbk$art_c; $art_ikcjkfebbi$art_i++) {    var item = list[$art_ikcjkfebbi$art_i]%>';
    for (var $art_ikcjkfebbi$art_i = 0, $art_cudrahtxbk$art_c = list.length; $art_ikcjkfebbi$art_i < $art_cudrahtxbk$art_c; $art_ikcjkfebbi$art_i++) {
        var item = list[$art_ikcjkfebbi$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_irpvgpgx$art_i = 0, $art_objcnzqotn$art_obj = item.subs, $art_cjphzi$art_c = $art_objcnzqotn$art_obj.length; $art_irpvgpgx$art_i < $art_cjphzi$art_c; $art_irpvgpgx$art_i++) {        var sub = $art_objcnzqotn$art_obj[$art_irpvgpgx$art_i]%>';
        for (var $art_irpvgpgx$art_i = 0, $art_objcnzqotn$art_obj = item.subs, $art_cjphzi$art_c = $art_objcnzqotn$art_obj.length; $art_irpvgpgx$art_i < $art_cjphzi$art_c; $art_irpvgpgx$art_i++) {
            var sub = $art_objcnzqotn$art_obj[$art_irpvgpgx$art_i];
