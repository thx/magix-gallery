/*
    ...
    loader: cmd_es
 */
define("__test__/base",["magix","$","mx-popover/index","mx-suggest/index","mx-title/index"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_gallerya:h" class="_zs_gallery___test___base_-test2"></div><div mxv mxa="_zs_gallerya:t" class="_zs_gallery___test___base_-base-header"><div mxs="_zs_gallerya:_" class="_zs_gallery___test___base_-header-line"></div><div class="_zs_gallery___test___base_-base-logo" mx-view="mx-popover/index?view=__test__%2Fedit%2Ftheme&width=270&auto=';
    $line = 8;
    $art = '=theme';
    ;
    $p += ($expr = '<%!$eu(theme)%>', $eu(theme)) + '&placement=bottom&align=left&offset=';
    $line = 11;
    $art = '@{\n            left: 24\n        }';
    ;
    $p += ($expr = '<%@{        left: 24    }%>', $i($$ref, { left: 24 })) + '"><span mxs="_zs_gallerya:n" class="_zs_gallery___test___base_-logo-img"><img src="https://img.alicdn.com/tfs/TB1qRnywVzqK1RjSZFoXXbfcXXa-432-355.png"></span><span mxs="_zs_gallerya:o" class="_zs_gallery___test___base_-logo-name">Magix Galleries</span></div><div mxv mxa="_zs_gallerya:u" class="_zs_gallery___test___base_-base-search"><div mxv="suggests" class="w260" mx-suggest="' + $viewId + 'suggest()" mx-view="mx-suggest/index?placeholder=%E6%90%9C%E7%B4%A2&list=';
    $line = 22;
    $art = '@suggests';
    ;
    $p += ($expr = '<%@suggests%>', $i($$ref, suggests)) + '&type=all"></div></div><div mxa="_zs_gallerya:h" class="_zs_gallery___test___base_-header-tabs clearfix">';
    $line = 27;
    $art = 'each headers as h';
    ;
    $expr = '<%for (var $art_idoaknnchjf$art_i = 0, $art_czbxajf$art_c = headers.length; $art_idoaknnchjf$art_i < $art_czbxajf$art_c; $art_idoaknnchjf$art_i++) {    var h = headers[$art_idoaknnchjf$art_i]%>';
    for (var $art_idoaknnchjf$art_i = 0, $art_czbxajf$art_c = headers.length; $art_idoaknnchjf$art_i < $art_czbxajf$art_c; $art_idoaknnchjf$art_i++) {
        var h = headers[$art_idoaknnchjf$art_i];
        $p += '<a ';
        $line = 28;
        $art = 'if h.new';
        ;
        ...
        if (h["new"]) {
            ;
            $p += '<span class="_zs_gallery___test___base_-breath-light update" mx-view="mx-popover/index?content=';
            $line = 33;
            $art = '=h.new';
            ;
    ...
    ;
    $expr = '<%for (var $art_iexmjcblv$art_i = 0, $art_craldoehi$art_c = list.length; $art_iexmjcblv$art_i < $art_craldoehi$art_c; $art_iexmjcblv$art_i++) {    var item = list[$art_iexmjcblv$art_i]%>';
    for (var $art_iexmjcblv$art_i = 0, $art_craldoehi$art_c = list.length; $art_iexmjcblv$art_i < $art_craldoehi$art_c; $art_iexmjcblv$art_i++) {
        var item = list[$art_iexmjcblv$art_i];
        $p += ' ';
        $line = 43;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ivwmpswqk$art_i = 0, $art_objlroadxbuu$art_obj = item.subs, $art_cjkfcjmjxfg$art_c = $art_objlroadxbuu$art_obj.length; $art_ivwmpswqk$art_i < $art_cjkfcjmjxfg$art_c; $art_ivwmpswqk$art_i++) {        var sub = $art_objlroadxbuu$art_obj[$art_ivwmpswqk$art_i]%>';
        for (var $art_ivwmpswqk$art_i = 0, $art_objlroadxbuu$art_obj = item.subs, $art_cjkfcjmjxfg$art_c = $art_objlroadxbuu$art_obj.length; $art_ivwmpswqk$art_i < $art_cjkfcjmjxfg$art_c; $art_ivwmpswqk$art_i++) {
            var sub = $art_objlroadxbuu$art_obj[$art_ivwmpswqk$art_i];
    ...
    ;
    $p += '</div><div mxv mxa="_zs_gallerya:e" class="_zs_gallery___test___base_-base-main"><div mxv mxa="_zs_gallerya:j" class="_zs_gallery___test___base_-content"><div mxv="cur" ';
    $line = 62;
    $art = 'if cur.tip';
    ;
    $expr = '<%if (cur.tip) {%>';
    ...
    $art = '=view';
    ;
    $p += ($expr = '<%=view%>', $e(view)) + '"><div mxs="_zs_gallerya:c" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div></div>';
    $line = 68;
    $art = 'if count > 1';
    ;
    $expr = '<%if (count > 1) {%>';
    if (count > 1) {
        ;
        $p += '<div mxa="_zs_gallerya:s" class="_zs_gallery___test___base_-contexts clearfix">';
        $line = 70;
        $art = 'if prev.path';
        ;
        $expr = '<%if (prev.path) {%>';
