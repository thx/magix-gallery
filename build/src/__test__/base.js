...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ickdau$art_i = 0, $art_cegwrbssm$art_c = headers.length; $art_ickdau$art_i < $art_cegwrbssm$art_c; $art_ickdau$art_i++) {    var h = headers[$art_ickdau$art_i]%>';
    for (var $art_ickdau$art_i = 0, $art_cegwrbssm$art_c = headers.length; $art_ickdau$art_i < $art_cegwrbssm$art_c; $art_ickdau$art_i++) {
        var h = headers[$art_ickdau$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_iqdqyzkik$art_i = 0, $art_csqmiemf$art_c = list.length; $art_iqdqyzkik$art_i < $art_csqmiemf$art_c; $art_iqdqyzkik$art_i++) {    var item = list[$art_iqdqyzkik$art_i]%>';
    for (var $art_iqdqyzkik$art_i = 0, $art_csqmiemf$art_c = list.length; $art_iqdqyzkik$art_i < $art_csqmiemf$art_c; $art_iqdqyzkik$art_i++) {
        var item = list[$art_iqdqyzkik$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_itiezinjb$art_i = 0, $art_objzsgwpmghlr$art_obj = item.subs, $art_cuinwkuhb$art_c = $art_objzsgwpmghlr$art_obj.length; $art_itiezinjb$art_i < $art_cuinwkuhb$art_c; $art_itiezinjb$art_i++) {        var sub = $art_objzsgwpmghlr$art_obj[$art_itiezinjb$art_i]%>';
        for (var $art_itiezinjb$art_i = 0, $art_objzsgwpmghlr$art_obj = item.subs, $art_cuinwkuhb$art_c = $art_objzsgwpmghlr$art_obj.length; $art_itiezinjb$art_i < $art_cuinwkuhb$art_c; $art_itiezinjb$art_i++) {
            var sub = $art_objzsgwpmghlr$art_obj[$art_itiezinjb$art_i];
