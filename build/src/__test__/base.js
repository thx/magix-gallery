...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isgbcszll$art_i = 0, $art_cmdqnlmp$art_c = headers.length; $art_isgbcszll$art_i < $art_cmdqnlmp$art_c; $art_isgbcszll$art_i++) {    var h = headers[$art_isgbcszll$art_i]%>';
    for (var $art_isgbcszll$art_i = 0, $art_cmdqnlmp$art_c = headers.length; $art_isgbcszll$art_i < $art_cmdqnlmp$art_c; $art_isgbcszll$art_i++) {
        var h = headers[$art_isgbcszll$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iapdxmusw$art_i = 0, $art_cbtkqagesmi$art_c = list.length; $art_iapdxmusw$art_i < $art_cbtkqagesmi$art_c; $art_iapdxmusw$art_i++) {    var item = list[$art_iapdxmusw$art_i]%>';
    for (var $art_iapdxmusw$art_i = 0, $art_cbtkqagesmi$art_c = list.length; $art_iapdxmusw$art_i < $art_cbtkqagesmi$art_c; $art_iapdxmusw$art_i++) {
        var item = list[$art_iapdxmusw$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ikmcgwfzl$art_i = 0, $art_objehhhedq$art_obj = item.subs, $art_cplpsuvil$art_c = $art_objehhhedq$art_obj.length; $art_ikmcgwfzl$art_i < $art_cplpsuvil$art_c; $art_ikmcgwfzl$art_i++) {        var sub = $art_objehhhedq$art_obj[$art_ikmcgwfzl$art_i]%>';
        for (var $art_ikmcgwfzl$art_i = 0, $art_objehhhedq$art_obj = item.subs, $art_cplpsuvil$art_c = $art_objehhhedq$art_obj.length; $art_ikmcgwfzl$art_i < $art_cplpsuvil$art_c; $art_ikmcgwfzl$art_i++) {
            var sub = $art_objehhhedq$art_obj[$art_ikmcgwfzl$art_i];
