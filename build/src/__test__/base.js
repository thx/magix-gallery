...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imufzqyn$art_i = 0, $art_cbttlurqoi$art_c = headers.length; $art_imufzqyn$art_i < $art_cbttlurqoi$art_c; $art_imufzqyn$art_i++) {    var h = headers[$art_imufzqyn$art_i]%>';
    for (var $art_imufzqyn$art_i = 0, $art_cbttlurqoi$art_c = headers.length; $art_imufzqyn$art_i < $art_cbttlurqoi$art_c; $art_imufzqyn$art_i++) {
        var h = headers[$art_imufzqyn$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_imvwcmfoe$art_i = 0, $art_ctasyihsrp$art_c = list.length; $art_imvwcmfoe$art_i < $art_ctasyihsrp$art_c; $art_imvwcmfoe$art_i++) {    var item = list[$art_imvwcmfoe$art_i]%>';
    for (var $art_imvwcmfoe$art_i = 0, $art_ctasyihsrp$art_c = list.length; $art_imvwcmfoe$art_i < $art_ctasyihsrp$art_c; $art_imvwcmfoe$art_i++) {
        var item = list[$art_imvwcmfoe$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ifynspk$art_i = 0, $art_objgumdoacl$art_obj = item.subs, $art_cfmusak$art_c = $art_objgumdoacl$art_obj.length; $art_ifynspk$art_i < $art_cfmusak$art_c; $art_ifynspk$art_i++) {        var sub = $art_objgumdoacl$art_obj[$art_ifynspk$art_i]%>';
        for (var $art_ifynspk$art_i = 0, $art_objgumdoacl$art_obj = item.subs, $art_cfmusak$art_c = $art_objgumdoacl$art_obj.length; $art_ifynspk$art_i < $art_cfmusak$art_c; $art_ifynspk$art_i++) {
            var sub = $art_objgumdoacl$art_obj[$art_ifynspk$art_i];
