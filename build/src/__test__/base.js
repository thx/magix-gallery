...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijdqdlicj$art_i = 0, $art_cpzqntqkp$art_c = headers.length; $art_ijdqdlicj$art_i < $art_cpzqntqkp$art_c; $art_ijdqdlicj$art_i++) {    var h = headers[$art_ijdqdlicj$art_i]%>';
    for (var $art_ijdqdlicj$art_i = 0, $art_cpzqntqkp$art_c = headers.length; $art_ijdqdlicj$art_i < $art_cpzqntqkp$art_c; $art_ijdqdlicj$art_i++) {
        var h = headers[$art_ijdqdlicj$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_itqdghmwwo$art_i = 0, $art_crjfpsxgd$art_c = list.length; $art_itqdghmwwo$art_i < $art_crjfpsxgd$art_c; $art_itqdghmwwo$art_i++) {    var item = list[$art_itqdghmwwo$art_i]%>';
    for (var $art_itqdghmwwo$art_i = 0, $art_crjfpsxgd$art_c = list.length; $art_itqdghmwwo$art_i < $art_crjfpsxgd$art_c; $art_itqdghmwwo$art_i++) {
        var item = list[$art_itqdghmwwo$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_inixfpmuzx$art_i = 0, $art_objnojanmq$art_obj = item.subs, $art_cqyuxhcclgn$art_c = $art_objnojanmq$art_obj.length; $art_inixfpmuzx$art_i < $art_cqyuxhcclgn$art_c; $art_inixfpmuzx$art_i++) {        var sub = $art_objnojanmq$art_obj[$art_inixfpmuzx$art_i]%>';
        for (var $art_inixfpmuzx$art_i = 0, $art_objnojanmq$art_obj = item.subs, $art_cqyuxhcclgn$art_c = $art_objnojanmq$art_obj.length; $art_inixfpmuzx$art_i < $art_cqyuxhcclgn$art_c; $art_inixfpmuzx$art_i++) {
            var sub = $art_objnojanmq$art_obj[$art_inixfpmuzx$art_i];
