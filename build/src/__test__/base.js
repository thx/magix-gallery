...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izwhtt$art_i = 0, $art_cqidgknso$art_c = headers.length; $art_izwhtt$art_i < $art_cqidgknso$art_c; $art_izwhtt$art_i++) {    var h = headers[$art_izwhtt$art_i]%>';
    for (var $art_izwhtt$art_i = 0, $art_cqidgknso$art_c = headers.length; $art_izwhtt$art_i < $art_cqidgknso$art_c; $art_izwhtt$art_i++) {
        var h = headers[$art_izwhtt$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iegoejdq$art_i = 0, $art_crrznqhz$art_c = list.length; $art_iegoejdq$art_i < $art_crrznqhz$art_c; $art_iegoejdq$art_i++) {    var item = list[$art_iegoejdq$art_i]%>';
    for (var $art_iegoejdq$art_i = 0, $art_crrznqhz$art_c = list.length; $art_iegoejdq$art_i < $art_crrznqhz$art_c; $art_iegoejdq$art_i++) {
        var item = list[$art_iegoejdq$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ikptobv$art_i = 0, $art_objvebqwacaeg$art_obj = item.subs, $art_ccjnodzzkd$art_c = $art_objvebqwacaeg$art_obj.length; $art_ikptobv$art_i < $art_ccjnodzzkd$art_c; $art_ikptobv$art_i++) {        var sub = $art_objvebqwacaeg$art_obj[$art_ikptobv$art_i]%>';
        for (var $art_ikptobv$art_i = 0, $art_objvebqwacaeg$art_obj = item.subs, $art_ccjnodzzkd$art_c = $art_objvebqwacaeg$art_obj.length; $art_ikptobv$art_i < $art_ccjnodzzkd$art_c; $art_ikptobv$art_i++) {
            var sub = $art_objvebqwacaeg$art_obj[$art_ikptobv$art_i];
