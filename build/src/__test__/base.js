...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idfevbcbz$art_i = 0, $art_cidwdztzq$art_c = headers.length; $art_idfevbcbz$art_i < $art_cidwdztzq$art_c; $art_idfevbcbz$art_i++) {    var h = headers[$art_idfevbcbz$art_i]%>';
    for (var $art_idfevbcbz$art_i = 0, $art_cidwdztzq$art_c = headers.length; $art_idfevbcbz$art_i < $art_cidwdztzq$art_c; $art_idfevbcbz$art_i++) {
        var h = headers[$art_idfevbcbz$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_iyreuvrm$art_i = 0, $art_crpkycyk$art_c = list.length; $art_iyreuvrm$art_i < $art_crpkycyk$art_c; $art_iyreuvrm$art_i++) {    var item = list[$art_iyreuvrm$art_i]%>';
    for (var $art_iyreuvrm$art_i = 0, $art_crpkycyk$art_c = list.length; $art_iyreuvrm$art_i < $art_crpkycyk$art_c; $art_iyreuvrm$art_i++) {
        var item = list[$art_iyreuvrm$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_igvsngbcm$art_i = 0, $art_objvcwucbejt$art_obj = item.subs, $art_csuemyiviwr$art_c = $art_objvcwucbejt$art_obj.length; $art_igvsngbcm$art_i < $art_csuemyiviwr$art_c; $art_igvsngbcm$art_i++) {        var sub = $art_objvcwucbejt$art_obj[$art_igvsngbcm$art_i]%>';
        for (var $art_igvsngbcm$art_i = 0, $art_objvcwucbejt$art_obj = item.subs, $art_csuemyiviwr$art_c = $art_objvcwucbejt$art_obj.length; $art_igvsngbcm$art_i < $art_csuemyiviwr$art_c; $art_igvsngbcm$art_i++) {
            var sub = $art_objvcwucbejt$art_obj[$art_igvsngbcm$art_i];
