...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikzrbsbse$art_i = 0, $art_cvvsouxm$art_c = headers.length; $art_ikzrbsbse$art_i < $art_cvvsouxm$art_c; $art_ikzrbsbse$art_i++) {    var h = headers[$art_ikzrbsbse$art_i]%>';
    for (var $art_ikzrbsbse$art_i = 0, $art_cvvsouxm$art_c = headers.length; $art_ikzrbsbse$art_i < $art_cvvsouxm$art_c; $art_ikzrbsbse$art_i++) {
        var h = headers[$art_ikzrbsbse$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ipxprnss$art_i = 0, $art_cqfhutq$art_c = list.length; $art_ipxprnss$art_i < $art_cqfhutq$art_c; $art_ipxprnss$art_i++) {    var item = list[$art_ipxprnss$art_i]%>';
    for (var $art_ipxprnss$art_i = 0, $art_cqfhutq$art_c = list.length; $art_ipxprnss$art_i < $art_cqfhutq$art_c; $art_ipxprnss$art_i++) {
        var item = list[$art_ipxprnss$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ijkmqal$art_i = 0, $art_objloagluhju$art_obj = item.subs, $art_clssnukgr$art_c = $art_objloagluhju$art_obj.length; $art_ijkmqal$art_i < $art_clssnukgr$art_c; $art_ijkmqal$art_i++) {        var sub = $art_objloagluhju$art_obj[$art_ijkmqal$art_i]%>';
        for (var $art_ijkmqal$art_i = 0, $art_objloagluhju$art_obj = item.subs, $art_clssnukgr$art_c = $art_objloagluhju$art_obj.length; $art_ijkmqal$art_i < $art_clssnukgr$art_c; $art_ijkmqal$art_i++) {
            var sub = $art_objloagluhju$art_obj[$art_ijkmqal$art_i];
