...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irkueqbwj$art_i = 0, $art_clyydfwy$art_c = headers.length; $art_irkueqbwj$art_i < $art_clyydfwy$art_c; $art_irkueqbwj$art_i++) {    var h = headers[$art_irkueqbwj$art_i]%>';
    for (var $art_irkueqbwj$art_i = 0, $art_clyydfwy$art_c = headers.length; $art_irkueqbwj$art_i < $art_clyydfwy$art_c; $art_irkueqbwj$art_i++) {
        var h = headers[$art_irkueqbwj$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_inbfbgshnuc$art_i = 0, $art_cpdbgdkkz$art_c = list.length; $art_inbfbgshnuc$art_i < $art_cpdbgdkkz$art_c; $art_inbfbgshnuc$art_i++) {    var item = list[$art_inbfbgshnuc$art_i]%>';
    for (var $art_inbfbgshnuc$art_i = 0, $art_cpdbgdkkz$art_c = list.length; $art_inbfbgshnuc$art_i < $art_cpdbgdkkz$art_c; $art_inbfbgshnuc$art_i++) {
        var item = list[$art_inbfbgshnuc$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ijshdspx$art_i = 0, $art_objjtitpjlqf$art_obj = item.subs, $art_cuyxwku$art_c = $art_objjtitpjlqf$art_obj.length; $art_ijshdspx$art_i < $art_cuyxwku$art_c; $art_ijshdspx$art_i++) {        var sub = $art_objjtitpjlqf$art_obj[$art_ijshdspx$art_i]%>';
        for (var $art_ijshdspx$art_i = 0, $art_objjtitpjlqf$art_obj = item.subs, $art_cuyxwku$art_c = $art_objjtitpjlqf$art_obj.length; $art_ijshdspx$art_i < $art_cuyxwku$art_c; $art_ijshdspx$art_i++) {
            var sub = $art_objjtitpjlqf$art_obj[$art_ijshdspx$art_i];
