...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iryfrntkrpr$art_i = 0, $art_cfqsktysfr$art_c = headers.length; $art_iryfrntkrpr$art_i < $art_cfqsktysfr$art_c; $art_iryfrntkrpr$art_i++) {    var h = headers[$art_iryfrntkrpr$art_i]%>';
    for (var $art_iryfrntkrpr$art_i = 0, $art_cfqsktysfr$art_c = headers.length; $art_iryfrntkrpr$art_i < $art_cfqsktysfr$art_c; $art_iryfrntkrpr$art_i++) {
        var h = headers[$art_iryfrntkrpr$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_iscjqma$art_i = 0, $art_casiftrnxo$art_c = list.length; $art_iscjqma$art_i < $art_casiftrnxo$art_c; $art_iscjqma$art_i++) {    var item = list[$art_iscjqma$art_i]%>';
    for (var $art_iscjqma$art_i = 0, $art_casiftrnxo$art_c = list.length; $art_iscjqma$art_i < $art_casiftrnxo$art_c; $art_iscjqma$art_i++) {
        var item = list[$art_iscjqma$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iatjijqkb$art_i = 0, $art_objrcfegx$art_obj = item.subs, $art_cypllpmquf$art_c = $art_objrcfegx$art_obj.length; $art_iatjijqkb$art_i < $art_cypllpmquf$art_c; $art_iatjijqkb$art_i++) {        var sub = $art_objrcfegx$art_obj[$art_iatjijqkb$art_i]%>';
        for (var $art_iatjijqkb$art_i = 0, $art_objrcfegx$art_obj = item.subs, $art_cypllpmquf$art_c = $art_objrcfegx$art_obj.length; $art_iatjijqkb$art_i < $art_cypllpmquf$art_c; $art_iatjijqkb$art_i++) {
            var sub = $art_objrcfegx$art_obj[$art_iatjijqkb$art_i];
