...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iblsjuncgm$art_i = 0, $art_cgkml$art_c = headers.length; $art_iblsjuncgm$art_i < $art_cgkml$art_c; $art_iblsjuncgm$art_i++) {    var h = headers[$art_iblsjuncgm$art_i]%>';
    for (var $art_iblsjuncgm$art_i = 0, $art_cgkml$art_c = headers.length; $art_iblsjuncgm$art_i < $art_cgkml$art_c; $art_iblsjuncgm$art_i++) {
        var h = headers[$art_iblsjuncgm$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iqclskkjmj$art_i = 0, $art_cflwiynplagg$art_c = list.length; $art_iqclskkjmj$art_i < $art_cflwiynplagg$art_c; $art_iqclskkjmj$art_i++) {    var item = list[$art_iqclskkjmj$art_i]%>';
    for (var $art_iqclskkjmj$art_i = 0, $art_cflwiynplagg$art_c = list.length; $art_iqclskkjmj$art_i < $art_cflwiynplagg$art_c; $art_iqclskkjmj$art_i++) {
        var item = list[$art_iqclskkjmj$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iltigxvx$art_i = 0, $art_objankbimpvs$art_obj = item.subs, $art_cfdfgkwz$art_c = $art_objankbimpvs$art_obj.length; $art_iltigxvx$art_i < $art_cfdfgkwz$art_c; $art_iltigxvx$art_i++) {        var sub = $art_objankbimpvs$art_obj[$art_iltigxvx$art_i]%>';
        for (var $art_iltigxvx$art_i = 0, $art_objankbimpvs$art_obj = item.subs, $art_cfdfgkwz$art_c = $art_objankbimpvs$art_obj.length; $art_iltigxvx$art_i < $art_cfdfgkwz$art_c; $art_iltigxvx$art_i++) {
            var sub = $art_objankbimpvs$art_obj[$art_iltigxvx$art_i];
