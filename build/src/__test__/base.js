...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iymzdfs$art_i = 0, $art_clltfvgx$art_c = headers.length; $art_iymzdfs$art_i < $art_clltfvgx$art_c; $art_iymzdfs$art_i++) {    var h = headers[$art_iymzdfs$art_i]%>';
    for (var $art_iymzdfs$art_i = 0, $art_clltfvgx$art_c = headers.length; $art_iymzdfs$art_i < $art_clltfvgx$art_c; $art_iymzdfs$art_i++) {
        var h = headers[$art_iymzdfs$art_i];
        $p += '<a ';
        $line = 33;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ijiyuwhfo$art_i = 0, $art_cqcajfvi$art_c = list.length; $art_ijiyuwhfo$art_i < $art_cqcajfvi$art_c; $art_ijiyuwhfo$art_i++) {    var item = list[$art_ijiyuwhfo$art_i]%>';
    for (var $art_ijiyuwhfo$art_i = 0, $art_cqcajfvi$art_c = list.length; $art_ijiyuwhfo$art_i < $art_cqcajfvi$art_c; $art_ijiyuwhfo$art_i++) {
        var item = list[$art_ijiyuwhfo$art_i];
        $p += ' ';
        $line = 48;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_imarujlx$art_i = 0, $art_objvmhsch$art_obj = item.subs, $art_cbgqppjgfg$art_c = $art_objvmhsch$art_obj.length; $art_imarujlx$art_i < $art_cbgqppjgfg$art_c; $art_imarujlx$art_i++) {        var sub = $art_objvmhsch$art_obj[$art_imarujlx$art_i]%>';
        for (var $art_imarujlx$art_i = 0, $art_objvmhsch$art_obj = item.subs, $art_cbgqppjgfg$art_c = $art_objvmhsch$art_obj.length; $art_imarujlx$art_i < $art_cbgqppjgfg$art_c; $art_imarujlx$art_i++) {
            var sub = $art_objvmhsch$art_obj[$art_imarujlx$art_i];
