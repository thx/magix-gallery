...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiouiwsxjsn$art_i = 0, $art_caitmtd$art_c = list.length; $art_iiouiwsxjsn$art_i < $art_caitmtd$art_c; $art_iiouiwsxjsn$art_i++) {    var item = list[$art_iiouiwsxjsn$art_i]%>';
    for (var $art_iiouiwsxjsn$art_i = 0, $art_caitmtd$art_c = list.length; $art_iiouiwsxjsn$art_i < $art_caitmtd$art_c; $art_iiouiwsxjsn$art_i++) {
        var item = list[$art_iiouiwsxjsn$art_i];
        $p += ' ';
        $line = 4;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_imkrtvjzdb$art_i = 0, $art_objzgltqifac$art_obj = item.subs, $art_clndkbrs$art_c = $art_objzgltqifac$art_obj.length; $art_imkrtvjzdb$art_i < $art_clndkbrs$art_c; $art_imkrtvjzdb$art_i++) {        var sub = $art_objzgltqifac$art_obj[$art_imkrtvjzdb$art_i]%>';
        for (var $art_imkrtvjzdb$art_i = 0, $art_objzgltqifac$art_obj = item.subs, $art_clndkbrs$art_c = $art_objzgltqifac$art_obj.length; $art_imkrtvjzdb$art_i < $art_clndkbrs$art_c; $art_imkrtvjzdb$art_i++) {
            var sub = $art_objzgltqifac$art_obj[$art_imkrtvjzdb$art_i];
