...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilyfypgisws$art_i = 0, $art_cklthvhlgwf$art_c = headers.length; $art_ilyfypgisws$art_i < $art_cklthvhlgwf$art_c; $art_ilyfypgisws$art_i++) {    var h = headers[$art_ilyfypgisws$art_i]%>';
    for (var $art_ilyfypgisws$art_i = 0, $art_cklthvhlgwf$art_c = headers.length; $art_ilyfypgisws$art_i < $art_cklthvhlgwf$art_c; $art_ilyfypgisws$art_i++) {
        var h = headers[$art_ilyfypgisws$art_i];
        $p += '<a href="#!';
        $line = 19;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_igdokuvep$art_i = 0, $art_cjrseti$art_c = list.length; $art_igdokuvep$art_i < $art_cjrseti$art_c; $art_igdokuvep$art_i++) {    var item = list[$art_igdokuvep$art_i]%>';
    for (var $art_igdokuvep$art_i = 0, $art_cjrseti$art_c = list.length; $art_igdokuvep$art_i < $art_cjrseti$art_c; $art_igdokuvep$art_i++) {
        var item = list[$art_igdokuvep$art_i];
        $p += ' ';
        $line = 26;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iegjxdawr$art_i = 0, $art_objxkmseky$art_obj = item.subs, $art_cfannfgk$art_c = $art_objxkmseky$art_obj.length; $art_iegjxdawr$art_i < $art_cfannfgk$art_c; $art_iegjxdawr$art_i++) {        var sub = $art_objxkmseky$art_obj[$art_iegjxdawr$art_i]%>';
        for (var $art_iegjxdawr$art_i = 0, $art_objxkmseky$art_obj = item.subs, $art_cfannfgk$art_c = $art_objxkmseky$art_obj.length; $art_iegjxdawr$art_i < $art_cfannfgk$art_c; $art_iegjxdawr$art_i++) {
            var sub = $art_objxkmseky$art_obj[$art_iegjxdawr$art_i];
