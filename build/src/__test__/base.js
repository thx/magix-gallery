...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_izriryho$art_i = 0, $art_cptvacxxbpe$art_c = list.length; $art_izriryho$art_i < $art_cptvacxxbpe$art_c; $art_izriryho$art_i++) {    var item = list[$art_izriryho$art_i]%>';
    for (var $art_izriryho$art_i = 0, $art_cptvacxxbpe$art_c = list.length; $art_izriryho$art_i < $art_cptvacxxbpe$art_c; $art_izriryho$art_i++) {
        var item = list[$art_izriryho$art_i];
        $p += ' ';
        $line = 4;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iznfjgdcvdc$art_i = 0, $art_objtwvogp$art_obj = item.subs, $art_clsskdizdu$art_c = $art_objtwvogp$art_obj.length; $art_iznfjgdcvdc$art_i < $art_clsskdizdu$art_c; $art_iznfjgdcvdc$art_i++) {        var sub = $art_objtwvogp$art_obj[$art_iznfjgdcvdc$art_i]%>';
        for (var $art_iznfjgdcvdc$art_i = 0, $art_objtwvogp$art_obj = item.subs, $art_clsskdizdu$art_c = $art_objtwvogp$art_obj.length; $art_iznfjgdcvdc$art_i < $art_clsskdizdu$art_c; $art_iznfjgdcvdc$art_i++) {
            var sub = $art_objtwvogp$art_obj[$art_iznfjgdcvdc$art_i];
    ...
    ;
    $p += '</div></div></div><div mxs="_zs_gallerya:p" class="_zs_gallery___test___base_-fixes"><a href="https://aone.alibaba-inc.com/project/768817/req?akProjectId=768817&spm=a2o8d.rdc_projecthome.0.0.70b27a26750VTM" target="_blank" rel="noopener noreferrer" class="_zs_gallery___test___base_-fix"><i class="mc-iconfont _zs_gallery___test___base_-fix-icon">&#xe64f;</i><span class="_zs_gallery___test___base_-fix-tip">给我提需求</span></a><a href="https://aone.alibaba-inc.com/project/768817/issue?spm=a2o8d.corp_prod_req_list.0.0.3e646b88s8ezBH" target="_blank" rel="noopener noreferrer" class="_zs_gallery___test___base_-fix"><i class="mc-iconfont _zs_gallery___test___base_-fix-icon">&#xe63d;</i><span class="_zs_gallery___test___base_-fix-tip">帮我找bug</span></a><a href="dingtalk://dingtalkclient/action/sendmsg?dingtalk_id=t5z4z8s" class="_zs_gallery___test___base_-fix"><i class="mc-iconfont _zs_gallery___test___base_-fix-icon">&#xe677;</i><span class="_zs_gallery___test___base_-fix-tip">钉我一下</span></a></div>';
}
catch (ex) {
