...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iafgyoxyyr$art_i = 0, $art_cwtubapzih$art_c = headers.length; $art_iafgyoxyyr$art_i < $art_cwtubapzih$art_c; $art_iafgyoxyyr$art_i++) {    var h = headers[$art_iafgyoxyyr$art_i]%>';
    for (var $art_iafgyoxyyr$art_i = 0, $art_cwtubapzih$art_c = headers.length; $art_iafgyoxyyr$art_i < $art_cwtubapzih$art_c; $art_iafgyoxyyr$art_i++) {
        var h = headers[$art_iafgyoxyyr$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_iaxwh$art_i = 0, $art_cgieqjymapr$art_c = list.length; $art_iaxwh$art_i < $art_cgieqjymapr$art_c; $art_iaxwh$art_i++) {    var item = list[$art_iaxwh$art_i]%>';
    for (var $art_iaxwh$art_i = 0, $art_cgieqjymapr$art_c = list.length; $art_iaxwh$art_i < $art_cgieqjymapr$art_c; $art_iaxwh$art_i++) {
        var item = list[$art_iaxwh$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_izkagwrtb$art_i = 0, $art_objucmcabnk$art_obj = item.subs, $art_cskdkvqpcc$art_c = $art_objucmcabnk$art_obj.length; $art_izkagwrtb$art_i < $art_cskdkvqpcc$art_c; $art_izkagwrtb$art_i++) {        var sub = $art_objucmcabnk$art_obj[$art_izkagwrtb$art_i]%>';
        for (var $art_izkagwrtb$art_i = 0, $art_objucmcabnk$art_obj = item.subs, $art_cskdkvqpcc$art_c = $art_objucmcabnk$art_obj.length; $art_izkagwrtb$art_i < $art_cskdkvqpcc$art_c; $art_izkagwrtb$art_i++) {
            var sub = $art_objucmcabnk$art_obj[$art_izkagwrtb$art_i];
