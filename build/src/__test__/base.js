...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iehtkotcd$art_i = 0, $art_cyxshnbg$art_c = headers.length; $art_iehtkotcd$art_i < $art_cyxshnbg$art_c; $art_iehtkotcd$art_i++) {    var h = headers[$art_iehtkotcd$art_i]%>';
    for (var $art_iehtkotcd$art_i = 0, $art_cyxshnbg$art_c = headers.length; $art_iehtkotcd$art_i < $art_cyxshnbg$art_c; $art_iehtkotcd$art_i++) {
        var h = headers[$art_iehtkotcd$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ipfhqwzi$art_i = 0, $art_cngfhgtj$art_c = list.length; $art_ipfhqwzi$art_i < $art_cngfhgtj$art_c; $art_ipfhqwzi$art_i++) {    var item = list[$art_ipfhqwzi$art_i]%>';
    for (var $art_ipfhqwzi$art_i = 0, $art_cngfhgtj$art_c = list.length; $art_ipfhqwzi$art_i < $art_cngfhgtj$art_c; $art_ipfhqwzi$art_i++) {
        var item = list[$art_ipfhqwzi$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ieehvigzn$art_i = 0, $art_objrkyuixbc$art_obj = item.subs, $art_cnwqzydwnu$art_c = $art_objrkyuixbc$art_obj.length; $art_ieehvigzn$art_i < $art_cnwqzydwnu$art_c; $art_ieehvigzn$art_i++) {        var sub = $art_objrkyuixbc$art_obj[$art_ieehvigzn$art_i]%>';
        for (var $art_ieehvigzn$art_i = 0, $art_objrkyuixbc$art_obj = item.subs, $art_cnwqzydwnu$art_c = $art_objrkyuixbc$art_obj.length; $art_ieehvigzn$art_i < $art_cnwqzydwnu$art_c; $art_ieehvigzn$art_i++) {
            var sub = $art_objrkyuixbc$art_obj[$art_ieehvigzn$art_i];
