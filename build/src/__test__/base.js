...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipbhuoszl$art_i = 0, $art_csszxcne$art_c = headers.length; $art_ipbhuoszl$art_i < $art_csszxcne$art_c; $art_ipbhuoszl$art_i++) {    var h = headers[$art_ipbhuoszl$art_i]%>';
    for (var $art_ipbhuoszl$art_i = 0, $art_csszxcne$art_c = headers.length; $art_ipbhuoszl$art_i < $art_csszxcne$art_c; $art_ipbhuoszl$art_i++) {
        var h = headers[$art_ipbhuoszl$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ibpakohj$art_i = 0, $art_cpxwaxfzm$art_c = list.length; $art_ibpakohj$art_i < $art_cpxwaxfzm$art_c; $art_ibpakohj$art_i++) {    var item = list[$art_ibpakohj$art_i]%>';
    for (var $art_ibpakohj$art_i = 0, $art_cpxwaxfzm$art_c = list.length; $art_ibpakohj$art_i < $art_cpxwaxfzm$art_c; $art_ibpakohj$art_i++) {
        var item = list[$art_ibpakohj$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_izkbgimxxnwb$art_i = 0, $art_objftsltunh$art_obj = item.subs, $art_cxuitnjhc$art_c = $art_objftsltunh$art_obj.length; $art_izkbgimxxnwb$art_i < $art_cxuitnjhc$art_c; $art_izkbgimxxnwb$art_i++) {        var sub = $art_objftsltunh$art_obj[$art_izkbgimxxnwb$art_i]%>';
        for (var $art_izkbgimxxnwb$art_i = 0, $art_objftsltunh$art_obj = item.subs, $art_cxuitnjhc$art_c = $art_objftsltunh$art_obj.length; $art_izkbgimxxnwb$art_i < $art_cxuitnjhc$art_c; $art_izkbgimxxnwb$art_i++) {
            var sub = $art_objftsltunh$art_obj[$art_izkbgimxxnwb$art_i];
