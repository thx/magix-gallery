...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyehnmgow$art_i = 0, $art_cndnort$art_c = headers.length; $art_iyehnmgow$art_i < $art_cndnort$art_c; $art_iyehnmgow$art_i++) {    var h = headers[$art_iyehnmgow$art_i]%>';
    for (var $art_iyehnmgow$art_i = 0, $art_cndnort$art_c = headers.length; $art_iyehnmgow$art_i < $art_cndnort$art_c; $art_iyehnmgow$art_i++) {
        var h = headers[$art_iyehnmgow$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_iiuenstv$art_i = 0, $art_cwbwxleo$art_c = list.length; $art_iiuenstv$art_i < $art_cwbwxleo$art_c; $art_iiuenstv$art_i++) {    var item = list[$art_iiuenstv$art_i]%>';
    for (var $art_iiuenstv$art_i = 0, $art_cwbwxleo$art_c = list.length; $art_iiuenstv$art_i < $art_cwbwxleo$art_c; $art_iiuenstv$art_i++) {
        var item = list[$art_iiuenstv$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ikhvqyj$art_i = 0, $art_objcdgsyejb$art_obj = item.subs, $art_cloraatrct$art_c = $art_objcdgsyejb$art_obj.length; $art_ikhvqyj$art_i < $art_cloraatrct$art_c; $art_ikhvqyj$art_i++) {        var sub = $art_objcdgsyejb$art_obj[$art_ikhvqyj$art_i]%>';
        for (var $art_ikhvqyj$art_i = 0, $art_objcdgsyejb$art_obj = item.subs, $art_cloraatrct$art_c = $art_objcdgsyejb$art_obj.length; $art_ikhvqyj$art_i < $art_cloraatrct$art_c; $art_ikhvqyj$art_i++) {
            var sub = $art_objcdgsyejb$art_obj[$art_ikhvqyj$art_i];
