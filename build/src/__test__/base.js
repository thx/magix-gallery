...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixvauhfiuh$art_i = 0, $art_caqghibe$art_c = headers.length; $art_ixvauhfiuh$art_i < $art_caqghibe$art_c; $art_ixvauhfiuh$art_i++) {    var h = headers[$art_ixvauhfiuh$art_i]%>';
    for (var $art_ixvauhfiuh$art_i = 0, $art_caqghibe$art_c = headers.length; $art_ixvauhfiuh$art_i < $art_caqghibe$art_c; $art_ixvauhfiuh$art_i++) {
        var h = headers[$art_ixvauhfiuh$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ifpwctqdllm$art_i = 0, $art_cwkkehmz$art_c = list.length; $art_ifpwctqdllm$art_i < $art_cwkkehmz$art_c; $art_ifpwctqdllm$art_i++) {    var item = list[$art_ifpwctqdllm$art_i]%>';
    for (var $art_ifpwctqdllm$art_i = 0, $art_cwkkehmz$art_c = list.length; $art_ifpwctqdllm$art_i < $art_cwkkehmz$art_c; $art_ifpwctqdllm$art_i++) {
        var item = list[$art_ifpwctqdllm$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ihthcxssvs$art_i = 0, $art_objrzjncqmy$art_obj = item.subs, $art_csvckhjf$art_c = $art_objrzjncqmy$art_obj.length; $art_ihthcxssvs$art_i < $art_csvckhjf$art_c; $art_ihthcxssvs$art_i++) {        var sub = $art_objrzjncqmy$art_obj[$art_ihthcxssvs$art_i]%>';
        for (var $art_ihthcxssvs$art_i = 0, $art_objrzjncqmy$art_obj = item.subs, $art_csvckhjf$art_c = $art_objrzjncqmy$art_obj.length; $art_ihthcxssvs$art_i < $art_csvckhjf$art_c; $art_ihthcxssvs$art_i++) {
            var sub = $art_objrzjncqmy$art_obj[$art_ihthcxssvs$art_i];
