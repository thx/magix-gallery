...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya:_" class="_zs_gallery___test___base_-base-header"><div mxs="_zs_gallerya:_" class="_zs_gallery___test___base_-header-line"></div><div class="_zs_gallery___test___base_-base-logo" mx-view="mx-popover/index?view=__test__%2Fedit%2Ftheme&width=240&auto=';
    $line = 11;
    $art = '=theme';
    ;
    ...
    $art = '@{\n            left: 24\n        }';
    ;
    $p += ($expr = '<%@{        left: 24    }%>', $i($$ref, { left: 24 })) + '"><span mxs="_zs_gallerya:a" class="_zs_gallery___test___base_-logo-img"><img src="https://img.alicdn.com/tfs/TB1qRnywVzqK1RjSZFoXXbfcXXa-432-355.png"></span><span mxs="_zs_gallerya:b" class="_zs_gallery___test___base_-logo-name">Magix Galleries</span></div><div mxv mxa="_zs_gallerya:a" class="_zs_gallery___test___base_-base-search"><div mxv="suggests" class="w260" mx-suggest="' + $viewId + 'suggest()" mx-view="mx-suggest/index?placeholder=%E6%90%9C%E7%B4%A2&list=';
    $line = 25;
    $art = '@suggests';
    ;
    ...
    ;
    $expr = '<%for (var $art_iipfuzumxkn$art_i = 0, $art_cxnvrhl$art_c = headers.length; $art_iipfuzumxkn$art_i < $art_cxnvrhl$art_c; $art_iipfuzumxkn$art_i++) {    var h = headers[$art_iipfuzumxkn$art_i]%>';
    for (var $art_iipfuzumxkn$art_i = 0, $art_cxnvrhl$art_c = headers.length; $art_iipfuzumxkn$art_i < $art_cxnvrhl$art_c; $art_iipfuzumxkn$art_i++) {
        var h = headers[$art_iipfuzumxkn$art_i];
        $p += '<a ';
        $line = 31;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iwdhvish$art_i = 0, $art_csrfpvszb$art_c = list.length; $art_iwdhvish$art_i < $art_csrfpvszb$art_c; $art_iwdhvish$art_i++) {    var item = list[$art_iwdhvish$art_i]%>';
    for (var $art_iwdhvish$art_i = 0, $art_csrfpvszb$art_c = list.length; $art_iwdhvish$art_i < $art_csrfpvszb$art_c; $art_iwdhvish$art_i++) {
        var item = list[$art_iwdhvish$art_i];
        $p += ' ';
        $line = 46;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ikvfumqka$art_i = 0, $art_objwsaqkhnf$art_obj = item.subs, $art_cczvxxhyianl$art_c = $art_objwsaqkhnf$art_obj.length; $art_ikvfumqka$art_i < $art_cczvxxhyianl$art_c; $art_ikvfumqka$art_i++) {        var sub = $art_objwsaqkhnf$art_obj[$art_ikvfumqka$art_i]%>';
        for (var $art_ikvfumqka$art_i = 0, $art_objwsaqkhnf$art_obj = item.subs, $art_cczvxxhyianl$art_c = $art_objwsaqkhnf$art_obj.length; $art_ikvfumqka$art_i < $art_cczvxxhyianl$art_c; $art_ikvfumqka$art_i++) {
            var sub = $art_objwsaqkhnf$art_obj[$art_ikvfumqka$art_i];
            ...
            $art = '=sub.path';
            ;
            $p += ($expr = '<%=sub.path%>', $e(sub.path)) + '"><i mxa="_zs_gallerya:c" class="mc-iconfont _zs_gallery___test___base_-sub-icon">';
            $line = 56;
            $art = '!sub.icon';
            ;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_gallerya:d" class="_zs_gallery___test___base_-base-main"><div mxv mxa="_zs_gallerya:e" class="_zs_gallery___test___base_-content"><div mxv="cur" ';
    $line = 65;
    $art = 'if cur.tip';
    ;
    $expr = '<%if (cur.tip) {%>';
    ...
    if (count > 1) {
        ;
        $p += '<div mxa="_zs_gallerya:f" class="_zs_gallery___test___base_-contexts clearfix">';
        $line = 73;
        $art = 'if prev.path';
        ;
        $expr = '<%if (prev.path) {%>';
