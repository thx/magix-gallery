...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuwtdfnnn$art_i = 0, $art_cdzhuoleln$art_c = headers.length; $art_iuwtdfnnn$art_i < $art_cdzhuoleln$art_c; $art_iuwtdfnnn$art_i++) {    var h = headers[$art_iuwtdfnnn$art_i]%>';
    for (var $art_iuwtdfnnn$art_i = 0, $art_cdzhuoleln$art_c = headers.length; $art_iuwtdfnnn$art_i < $art_cdzhuoleln$art_c; $art_iuwtdfnnn$art_i++) {
        var h = headers[$art_iuwtdfnnn$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_innlgcdnfwl$art_i = 0, $art_ciixulb$art_c = list.length; $art_innlgcdnfwl$art_i < $art_ciixulb$art_c; $art_innlgcdnfwl$art_i++) {    var item = list[$art_innlgcdnfwl$art_i]%>';
    for (var $art_innlgcdnfwl$art_i = 0, $art_ciixulb$art_c = list.length; $art_innlgcdnfwl$art_i < $art_ciixulb$art_c; $art_innlgcdnfwl$art_i++) {
        var item = list[$art_innlgcdnfwl$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_itwkvkxyv$art_i = 0, $art_objclcyfjc$art_obj = item.subs, $art_cluvyksh$art_c = $art_objclcyfjc$art_obj.length; $art_itwkvkxyv$art_i < $art_cluvyksh$art_c; $art_itwkvkxyv$art_i++) {        var sub = $art_objclcyfjc$art_obj[$art_itwkvkxyv$art_i]%>';
        for (var $art_itwkvkxyv$art_i = 0, $art_objclcyfjc$art_obj = item.subs, $art_cluvyksh$art_c = $art_objclcyfjc$art_obj.length; $art_itwkvkxyv$art_i < $art_cluvyksh$art_c; $art_itwkvkxyv$art_i++) {
            var sub = $art_objclcyfjc$art_obj[$art_itwkvkxyv$art_i];
