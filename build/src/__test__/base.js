...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqlptuuov$art_i = 0, $art_crcxxbee$art_c = headers.length; $art_iqlptuuov$art_i < $art_crcxxbee$art_c; $art_iqlptuuov$art_i++) {    var h = headers[$art_iqlptuuov$art_i]%>';
    for (var $art_iqlptuuov$art_i = 0, $art_crcxxbee$art_c = headers.length; $art_iqlptuuov$art_i < $art_crcxxbee$art_c; $art_iqlptuuov$art_i++) {
        var h = headers[$art_iqlptuuov$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_itjdklcs$art_i = 0, $art_cnegnmv$art_c = list.length; $art_itjdklcs$art_i < $art_cnegnmv$art_c; $art_itjdklcs$art_i++) {    var item = list[$art_itjdklcs$art_i]%>';
    for (var $art_itjdklcs$art_i = 0, $art_cnegnmv$art_c = list.length; $art_itjdklcs$art_i < $art_cnegnmv$art_c; $art_itjdklcs$art_i++) {
        var item = list[$art_itjdklcs$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_isollqonje$art_i = 0, $art_objctqrfgp$art_obj = item.subs, $art_cpyossbpl$art_c = $art_objctqrfgp$art_obj.length; $art_isollqonje$art_i < $art_cpyossbpl$art_c; $art_isollqonje$art_i++) {        var sub = $art_objctqrfgp$art_obj[$art_isollqonje$art_i]%>';
        for (var $art_isollqonje$art_i = 0, $art_objctqrfgp$art_obj = item.subs, $art_cpyossbpl$art_c = $art_objctqrfgp$art_obj.length; $art_isollqonje$art_i < $art_cpyossbpl$art_c; $art_isollqonje$art_i++) {
            var sub = $art_objctqrfgp$art_obj[$art_isollqonje$art_i];
