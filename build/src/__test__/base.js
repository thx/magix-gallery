...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izuhtpu$art_i = 0, $art_csmtlzpv$art_c = headers.length; $art_izuhtpu$art_i < $art_csmtlzpv$art_c; $art_izuhtpu$art_i++) {    var h = headers[$art_izuhtpu$art_i]%>';
    for (var $art_izuhtpu$art_i = 0, $art_csmtlzpv$art_c = headers.length; $art_izuhtpu$art_i < $art_csmtlzpv$art_c; $art_izuhtpu$art_i++) {
        var h = headers[$art_izuhtpu$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_icaech$art_i = 0, $art_csapwwvwme$art_c = list.length; $art_icaech$art_i < $art_csapwwvwme$art_c; $art_icaech$art_i++) {    var item = list[$art_icaech$art_i]%>';
    for (var $art_icaech$art_i = 0, $art_csapwwvwme$art_c = list.length; $art_icaech$art_i < $art_csapwwvwme$art_c; $art_icaech$art_i++) {
        var item = list[$art_icaech$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ialgmnxlj$art_i = 0, $art_objzxehdh$art_obj = item.subs, $art_cffiqwt$art_c = $art_objzxehdh$art_obj.length; $art_ialgmnxlj$art_i < $art_cffiqwt$art_c; $art_ialgmnxlj$art_i++) {        var sub = $art_objzxehdh$art_obj[$art_ialgmnxlj$art_i]%>';
        for (var $art_ialgmnxlj$art_i = 0, $art_objzxehdh$art_obj = item.subs, $art_cffiqwt$art_c = $art_objzxehdh$art_obj.length; $art_ialgmnxlj$art_i < $art_cffiqwt$art_c; $art_ialgmnxlj$art_i++) {
            var sub = $art_objzxehdh$art_obj[$art_ialgmnxlj$art_i];
