...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivlnougo$art_i = 0, $art_chdczkeliaup$art_c = headers.length; $art_ivlnougo$art_i < $art_chdczkeliaup$art_c; $art_ivlnougo$art_i++) {    var h = headers[$art_ivlnougo$art_i]%>';
    for (var $art_ivlnougo$art_i = 0, $art_chdczkeliaup$art_c = headers.length; $art_ivlnougo$art_i < $art_chdczkeliaup$art_c; $art_ivlnougo$art_i++) {
        var h = headers[$art_ivlnougo$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ijapexng$art_i = 0, $art_ckembqbxe$art_c = list.length; $art_ijapexng$art_i < $art_ckembqbxe$art_c; $art_ijapexng$art_i++) {    var item = list[$art_ijapexng$art_i]%>';
    for (var $art_ijapexng$art_i = 0, $art_ckembqbxe$art_c = list.length; $art_ijapexng$art_i < $art_ckembqbxe$art_c; $art_ijapexng$art_i++) {
        var item = list[$art_ijapexng$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_izvpcwmh$art_i = 0, $art_objivpmlzbjh$art_obj = item.subs, $art_ctbvyab$art_c = $art_objivpmlzbjh$art_obj.length; $art_izvpcwmh$art_i < $art_ctbvyab$art_c; $art_izvpcwmh$art_i++) {        var sub = $art_objivpmlzbjh$art_obj[$art_izvpcwmh$art_i]%>';
        for (var $art_izvpcwmh$art_i = 0, $art_objivpmlzbjh$art_obj = item.subs, $art_ctbvyab$art_c = $art_objivpmlzbjh$art_obj.length; $art_izvpcwmh$art_i < $art_ctbvyab$art_c; $art_izvpcwmh$art_i++) {
            var sub = $art_objivpmlzbjh$art_obj[$art_izvpcwmh$art_i];
