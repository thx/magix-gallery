...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ibbvfegyzcl$art_i = 0, $art_ckabshsd$art_c = list.length; $art_ibbvfegyzcl$art_i < $art_ckabshsd$art_c; $art_ibbvfegyzcl$art_i++) {    var item = list[$art_ibbvfegyzcl$art_i]%>';
    for (var $art_ibbvfegyzcl$art_i = 0, $art_ckabshsd$art_c = list.length; $art_ibbvfegyzcl$art_i < $art_ckabshsd$art_c; $art_ibbvfegyzcl$art_i++) {
        var item = list[$art_ibbvfegyzcl$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ihglrqibbthi$art_i = 0, $art_objpggmzyn$art_obj = item.subs, $art_cjablajyfb$art_c = $art_objpggmzyn$art_obj.length; $art_ihglrqibbthi$art_i < $art_cjablajyfb$art_c; $art_ihglrqibbthi$art_i++) {        var sub = $art_objpggmzyn$art_obj[$art_ihglrqibbthi$art_i]%>';
        for (var $art_ihglrqibbthi$art_i = 0, $art_objpggmzyn$art_obj = item.subs, $art_cjablajyfb$art_c = $art_objpggmzyn$art_obj.length; $art_ihglrqibbthi$art_i < $art_cjablajyfb$art_c; $art_ihglrqibbthi$art_i++) {
            var sub = $art_objpggmzyn$art_obj[$art_ihglrqibbthi$art_i];
