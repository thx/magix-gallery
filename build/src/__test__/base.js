...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iurphhc$art_i = 0, $art_calskynbb$art_c = headers.length; $art_iurphhc$art_i < $art_calskynbb$art_c; $art_iurphhc$art_i++) {    var h = headers[$art_iurphhc$art_i]%>';
    for (var $art_iurphhc$art_i = 0, $art_calskynbb$art_c = headers.length; $art_iurphhc$art_i < $art_calskynbb$art_c; $art_iurphhc$art_i++) {
        var h = headers[$art_iurphhc$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iqlviatxq$art_i = 0, $art_cofsforon$art_c = list.length; $art_iqlviatxq$art_i < $art_cofsforon$art_c; $art_iqlviatxq$art_i++) {    var item = list[$art_iqlviatxq$art_i]%>';
    for (var $art_iqlviatxq$art_i = 0, $art_cofsforon$art_c = list.length; $art_iqlviatxq$art_i < $art_cofsforon$art_c; $art_iqlviatxq$art_i++) {
        var item = list[$art_iqlviatxq$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_inurkinsj$art_i = 0, $art_objhevkvuqi$art_obj = item.subs, $art_cnayuuesh$art_c = $art_objhevkvuqi$art_obj.length; $art_inurkinsj$art_i < $art_cnayuuesh$art_c; $art_inurkinsj$art_i++) {        var sub = $art_objhevkvuqi$art_obj[$art_inurkinsj$art_i]%>';
        for (var $art_inurkinsj$art_i = 0, $art_objhevkvuqi$art_obj = item.subs, $art_cnayuuesh$art_c = $art_objhevkvuqi$art_obj.length; $art_inurkinsj$art_i < $art_cnayuuesh$art_c; $art_inurkinsj$art_i++) {
            var sub = $art_objhevkvuqi$art_obj[$art_inurkinsj$art_i];
