...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilzbepfmlo$art_i = 0, $art_chvwsfkm$art_c = headers.length; $art_ilzbepfmlo$art_i < $art_chvwsfkm$art_c; $art_ilzbepfmlo$art_i++) {    var h = headers[$art_ilzbepfmlo$art_i]%>';
    for (var $art_ilzbepfmlo$art_i = 0, $art_chvwsfkm$art_c = headers.length; $art_ilzbepfmlo$art_i < $art_chvwsfkm$art_c; $art_ilzbepfmlo$art_i++) {
        var h = headers[$art_ilzbepfmlo$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ikoqxukrp$art_i = 0, $art_cnfwmpwzzh$art_c = list.length; $art_ikoqxukrp$art_i < $art_cnfwmpwzzh$art_c; $art_ikoqxukrp$art_i++) {    var item = list[$art_ikoqxukrp$art_i]%>';
    for (var $art_ikoqxukrp$art_i = 0, $art_cnfwmpwzzh$art_c = list.length; $art_ikoqxukrp$art_i < $art_cnfwmpwzzh$art_c; $art_ikoqxukrp$art_i++) {
        var item = list[$art_ikoqxukrp$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ikipbqbatl$art_i = 0, $art_objyqalie$art_obj = item.subs, $art_cjgfcrqj$art_c = $art_objyqalie$art_obj.length; $art_ikipbqbatl$art_i < $art_cjgfcrqj$art_c; $art_ikipbqbatl$art_i++) {        var sub = $art_objyqalie$art_obj[$art_ikipbqbatl$art_i]%>';
        for (var $art_ikipbqbatl$art_i = 0, $art_objyqalie$art_obj = item.subs, $art_cjgfcrqj$art_c = $art_objyqalie$art_obj.length; $art_ikipbqbatl$art_i < $art_cjgfcrqj$art_c; $art_ikipbqbatl$art_i++) {
            var sub = $art_objyqalie$art_obj[$art_ikipbqbatl$art_i];
