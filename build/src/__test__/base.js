...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilyfgmowvcx$art_i = 0, $art_cevljdxossu$art_c = headers.length; $art_ilyfgmowvcx$art_i < $art_cevljdxossu$art_c; $art_ilyfgmowvcx$art_i++) {    var h = headers[$art_ilyfgmowvcx$art_i]%>';
    for (var $art_ilyfgmowvcx$art_i = 0, $art_cevljdxossu$art_c = headers.length; $art_ilyfgmowvcx$art_i < $art_cevljdxossu$art_c; $art_ilyfgmowvcx$art_i++) {
        var h = headers[$art_ilyfgmowvcx$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_idzjxjit$art_i = 0, $art_cdzgdzjzavs$art_c = list.length; $art_idzjxjit$art_i < $art_cdzgdzjzavs$art_c; $art_idzjxjit$art_i++) {    var item = list[$art_idzjxjit$art_i]%>';
    for (var $art_idzjxjit$art_i = 0, $art_cdzgdzjzavs$art_c = list.length; $art_idzjxjit$art_i < $art_cdzgdzjzavs$art_c; $art_idzjxjit$art_i++) {
        var item = list[$art_idzjxjit$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_isvzase$art_i = 0, $art_objyxaptlo$art_obj = item.subs, $art_cmihetgbzj$art_c = $art_objyxaptlo$art_obj.length; $art_isvzase$art_i < $art_cmihetgbzj$art_c; $art_isvzase$art_i++) {        var sub = $art_objyxaptlo$art_obj[$art_isvzase$art_i]%>';
        for (var $art_isvzase$art_i = 0, $art_objyxaptlo$art_obj = item.subs, $art_cmihetgbzj$art_c = $art_objyxaptlo$art_obj.length; $art_isvzase$art_i < $art_cmihetgbzj$art_c; $art_isvzase$art_i++) {
            var sub = $art_objyxaptlo$art_obj[$art_isvzase$art_i];
