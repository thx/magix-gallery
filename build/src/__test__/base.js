...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iynaegfgnx$art_i = 0, $art_cczxhfmziq$art_c = headers.length; $art_iynaegfgnx$art_i < $art_cczxhfmziq$art_c; $art_iynaegfgnx$art_i++) {    var h = headers[$art_iynaegfgnx$art_i]%>';
    for (var $art_iynaegfgnx$art_i = 0, $art_cczxhfmziq$art_c = headers.length; $art_iynaegfgnx$art_i < $art_cczxhfmziq$art_c; $art_iynaegfgnx$art_i++) {
        var h = headers[$art_iynaegfgnx$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ivdxgqhcauc$art_i = 0, $art_cxtslunoxywj$art_c = list.length; $art_ivdxgqhcauc$art_i < $art_cxtslunoxywj$art_c; $art_ivdxgqhcauc$art_i++) {    var item = list[$art_ivdxgqhcauc$art_i]%>';
    for (var $art_ivdxgqhcauc$art_i = 0, $art_cxtslunoxywj$art_c = list.length; $art_ivdxgqhcauc$art_i < $art_cxtslunoxywj$art_c; $art_ivdxgqhcauc$art_i++) {
        var item = list[$art_ivdxgqhcauc$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ikrpyhjsrk$art_i = 0, $art_objizqmwjd$art_obj = item.subs, $art_cfvhkxrip$art_c = $art_objizqmwjd$art_obj.length; $art_ikrpyhjsrk$art_i < $art_cfvhkxrip$art_c; $art_ikrpyhjsrk$art_i++) {        var sub = $art_objizqmwjd$art_obj[$art_ikrpyhjsrk$art_i]%>';
        for (var $art_ikrpyhjsrk$art_i = 0, $art_objizqmwjd$art_obj = item.subs, $art_cfvhkxrip$art_c = $art_objizqmwjd$art_obj.length; $art_ikrpyhjsrk$art_i < $art_cfvhkxrip$art_c; $art_ikrpyhjsrk$art_i++) {
            var sub = $art_objizqmwjd$art_obj[$art_ikrpyhjsrk$art_i];
        ...
        var _loop_1 = function (i_1) {
            map[i_1].forEach(function (item) {
                ...
                subs.forEach(function (sub) {
                    sub.text = headers[i_1].name + ' - ' + sub.name;
                    sub.value = sub.path;
