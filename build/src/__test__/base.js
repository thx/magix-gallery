...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ittqjbak$art_i = 0, $art_cythjctsd$art_c = headers.length; $art_ittqjbak$art_i < $art_cythjctsd$art_c; $art_ittqjbak$art_i++) {    var h = headers[$art_ittqjbak$art_i]%>';
    for (var $art_ittqjbak$art_i = 0, $art_cythjctsd$art_c = headers.length; $art_ittqjbak$art_i < $art_cythjctsd$art_c; $art_ittqjbak$art_i++) {
        var h = headers[$art_ittqjbak$art_i];
        $p += '<a href="#!';
        $line = 19;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ixvjifjyy$art_i = 0, $art_cdsaepbyvj$art_c = list.length; $art_ixvjifjyy$art_i < $art_cdsaepbyvj$art_c; $art_ixvjifjyy$art_i++) {    var item = list[$art_ixvjifjyy$art_i]%>';
    for (var $art_ixvjifjyy$art_i = 0, $art_cdsaepbyvj$art_c = list.length; $art_ixvjifjyy$art_i < $art_cdsaepbyvj$art_c; $art_ixvjifjyy$art_i++) {
        var item = list[$art_ixvjifjyy$art_i];
        $p += ' ';
        $line = 26;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iromicxh$art_i = 0, $art_objnnqvdybcj$art_obj = item.subs, $art_caomvnxysxh$art_c = $art_objnnqvdybcj$art_obj.length; $art_iromicxh$art_i < $art_caomvnxysxh$art_c; $art_iromicxh$art_i++) {        var sub = $art_objnnqvdybcj$art_obj[$art_iromicxh$art_i]%>';
        for (var $art_iromicxh$art_i = 0, $art_objnnqvdybcj$art_obj = item.subs, $art_caomvnxysxh$art_c = $art_objnnqvdybcj$art_obj.length; $art_iromicxh$art_i < $art_caomvnxysxh$art_c; $art_iromicxh$art_i++) {
            var sub = $art_objnnqvdybcj$art_obj[$art_iromicxh$art_i];
