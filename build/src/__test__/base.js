...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iolwucyfj$art_i = 0, $art_cgrzybeeeg$art_c = headers.length; $art_iolwucyfj$art_i < $art_cgrzybeeeg$art_c; $art_iolwucyfj$art_i++) {    var h = headers[$art_iolwucyfj$art_i]%>';
    for (var $art_iolwucyfj$art_i = 0, $art_cgrzybeeeg$art_c = headers.length; $art_iolwucyfj$art_i < $art_cgrzybeeeg$art_c; $art_iolwucyfj$art_i++) {
        var h = headers[$art_iolwucyfj$art_i];
        $p += '<a href="#!';
        $line = 21;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_issgtazkwg$art_i = 0, $art_cgfyoq$art_c = list.length; $art_issgtazkwg$art_i < $art_cgfyoq$art_c; $art_issgtazkwg$art_i++) {    var item = list[$art_issgtazkwg$art_i]%>';
    for (var $art_issgtazkwg$art_i = 0, $art_cgfyoq$art_c = list.length; $art_issgtazkwg$art_i < $art_cgfyoq$art_c; $art_issgtazkwg$art_i++) {
        var item = list[$art_issgtazkwg$art_i];
        $p += ' ';
        $line = 28;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ieqyval$art_i = 0, $art_objuyphxkuqf$art_obj = item.subs, $art_csgwssge$art_c = $art_objuyphxkuqf$art_obj.length; $art_ieqyval$art_i < $art_csgwssge$art_c; $art_ieqyval$art_i++) {        var sub = $art_objuyphxkuqf$art_obj[$art_ieqyval$art_i]%>';
        for (var $art_ieqyval$art_i = 0, $art_objuyphxkuqf$art_obj = item.subs, $art_csgwssge$art_c = $art_objuyphxkuqf$art_obj.length; $art_ieqyval$art_i < $art_csgwssge$art_c; $art_ieqyval$art_i++) {
            var sub = $art_objuyphxkuqf$art_obj[$art_ieqyval$art_i];
