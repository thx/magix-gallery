...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijxmsbwmm$art_i = 0, $art_ctjozlfpo$art_c = headers.length; $art_ijxmsbwmm$art_i < $art_ctjozlfpo$art_c; $art_ijxmsbwmm$art_i++) {    var h = headers[$art_ijxmsbwmm$art_i]%>';
    for (var $art_ijxmsbwmm$art_i = 0, $art_ctjozlfpo$art_c = headers.length; $art_ijxmsbwmm$art_i < $art_ctjozlfpo$art_c; $art_ijxmsbwmm$art_i++) {
        var h = headers[$art_ijxmsbwmm$art_i];
        $p += '<a href="#!';
        $line = 19;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ipbewjkhzm$art_i = 0, $art_cflhohbzrg$art_c = list.length; $art_ipbewjkhzm$art_i < $art_cflhohbzrg$art_c; $art_ipbewjkhzm$art_i++) {    var item = list[$art_ipbewjkhzm$art_i]%>';
    for (var $art_ipbewjkhzm$art_i = 0, $art_cflhohbzrg$art_c = list.length; $art_ipbewjkhzm$art_i < $art_cflhohbzrg$art_c; $art_ipbewjkhzm$art_i++) {
        var item = list[$art_ipbewjkhzm$art_i];
        $p += ' ';
        $line = 26;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iumoprpjnd$art_i = 0, $art_objpskgoxrd$art_obj = item.subs, $art_cqmkfpxm$art_c = $art_objpskgoxrd$art_obj.length; $art_iumoprpjnd$art_i < $art_cqmkfpxm$art_c; $art_iumoprpjnd$art_i++) {        var sub = $art_objpskgoxrd$art_obj[$art_iumoprpjnd$art_i]%>';
        for (var $art_iumoprpjnd$art_i = 0, $art_objpskgoxrd$art_obj = item.subs, $art_cqmkfpxm$art_c = $art_objpskgoxrd$art_obj.length; $art_iumoprpjnd$art_i < $art_cqmkfpxm$art_c; $art_iumoprpjnd$art_i++) {
            var sub = $art_objpskgoxrd$art_obj[$art_iumoprpjnd$art_i];
