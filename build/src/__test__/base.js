...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imhdcvlngz$art_i = 0, $art_cfdaqzbwnr$art_c = headers.length; $art_imhdcvlngz$art_i < $art_cfdaqzbwnr$art_c; $art_imhdcvlngz$art_i++) {    var h = headers[$art_imhdcvlngz$art_i]%>';
    for (var $art_imhdcvlngz$art_i = 0, $art_cfdaqzbwnr$art_c = headers.length; $art_imhdcvlngz$art_i < $art_cfdaqzbwnr$art_c; $art_imhdcvlngz$art_i++) {
        var h = headers[$art_imhdcvlngz$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_isqrtwxlw$art_i = 0, $art_chgmhjs$art_c = list.length; $art_isqrtwxlw$art_i < $art_chgmhjs$art_c; $art_isqrtwxlw$art_i++) {    var item = list[$art_isqrtwxlw$art_i]%>';
    for (var $art_isqrtwxlw$art_i = 0, $art_chgmhjs$art_c = list.length; $art_isqrtwxlw$art_i < $art_chgmhjs$art_c; $art_isqrtwxlw$art_i++) {
        var item = list[$art_isqrtwxlw$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_idbttxg$art_i = 0, $art_objoapr$art_obj = item.subs, $art_cqxqqaaomh$art_c = $art_objoapr$art_obj.length; $art_idbttxg$art_i < $art_cqxqqaaomh$art_c; $art_idbttxg$art_i++) {        var sub = $art_objoapr$art_obj[$art_idbttxg$art_i]%>';
        for (var $art_idbttxg$art_i = 0, $art_objoapr$art_obj = item.subs, $art_cqxqqaaomh$art_c = $art_objoapr$art_obj.length; $art_idbttxg$art_i < $art_cqxqqaaomh$art_c; $art_idbttxg$art_i++) {
            var sub = $art_objoapr$art_obj[$art_idbttxg$art_i];
