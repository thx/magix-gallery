...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iurupfer$art_i = 0, $art_cigbyb$art_c = list.length; $art_iurupfer$art_i < $art_cigbyb$art_c; $art_iurupfer$art_i++) {    var item = list[$art_iurupfer$art_i]%>';
    for (var $art_iurupfer$art_i = 0, $art_cigbyb$art_c = list.length; $art_iurupfer$art_i < $art_cigbyb$art_c; $art_iurupfer$art_i++) {
        var item = list[$art_iurupfer$art_i];
        $p += ' ';
        $line = 4;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iicyrtynmqr$art_i = 0, $art_objtdsdmdzx$art_obj = item.subs, $art_ccocrhjtyuu$art_c = $art_objtdsdmdzx$art_obj.length; $art_iicyrtynmqr$art_i < $art_ccocrhjtyuu$art_c; $art_iicyrtynmqr$art_i++) {        var sub = $art_objtdsdmdzx$art_obj[$art_iicyrtynmqr$art_i]%>';
        for (var $art_iicyrtynmqr$art_i = 0, $art_objtdsdmdzx$art_obj = item.subs, $art_ccocrhjtyuu$art_c = $art_objtdsdmdzx$art_obj.length; $art_iicyrtynmqr$art_i < $art_ccocrhjtyuu$art_c; $art_iicyrtynmqr$art_i++) {
            var sub = $art_objtdsdmdzx$art_obj[$art_iicyrtynmqr$art_i];
