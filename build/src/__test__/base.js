...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inglzgssf$art_i = 0, $art_cbdglafq$art_c = headers.length; $art_inglzgssf$art_i < $art_cbdglafq$art_c; $art_inglzgssf$art_i++) {    var h = headers[$art_inglzgssf$art_i]%>';
    for (var $art_inglzgssf$art_i = 0, $art_cbdglafq$art_c = headers.length; $art_inglzgssf$art_i < $art_cbdglafq$art_c; $art_inglzgssf$art_i++) {
        var h = headers[$art_inglzgssf$art_i];
        $p += '<a href="#!';
        $line = 18;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ifrhwpypv$art_i = 0, $art_cyalokp$art_c = list.length; $art_ifrhwpypv$art_i < $art_cyalokp$art_c; $art_ifrhwpypv$art_i++) {    var item = list[$art_ifrhwpypv$art_i]%>';
    for (var $art_ifrhwpypv$art_i = 0, $art_cyalokp$art_c = list.length; $art_ifrhwpypv$art_i < $art_cyalokp$art_c; $art_ifrhwpypv$art_i++) {
        var item = list[$art_ifrhwpypv$art_i];
        $p += ' ';
        $line = 25;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iwomnbkw$art_i = 0, $art_objhsoefmhee$art_obj = item.subs, $art_cryaheo$art_c = $art_objhsoefmhee$art_obj.length; $art_iwomnbkw$art_i < $art_cryaheo$art_c; $art_iwomnbkw$art_i++) {        var sub = $art_objhsoefmhee$art_obj[$art_iwomnbkw$art_i]%>';
        for (var $art_iwomnbkw$art_i = 0, $art_objhsoefmhee$art_obj = item.subs, $art_cryaheo$art_c = $art_objhsoefmhee$art_obj.length; $art_iwomnbkw$art_i < $art_cryaheo$art_c; $art_iwomnbkw$art_i++) {
            var sub = $art_objhsoefmhee$art_obj[$art_iwomnbkw$art_i];
