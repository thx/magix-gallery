...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihehrifd$art_i = 0, $art_cnutpnddvm$art_c = headers.length; $art_ihehrifd$art_i < $art_cnutpnddvm$art_c; $art_ihehrifd$art_i++) {    var h = headers[$art_ihehrifd$art_i]%>';
    for (var $art_ihehrifd$art_i = 0, $art_cnutpnddvm$art_c = headers.length; $art_ihehrifd$art_i < $art_cnutpnddvm$art_c; $art_ihehrifd$art_i++) {
        var h = headers[$art_ihehrifd$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ikpjbzq$art_i = 0, $art_ctujkxx$art_c = list.length; $art_ikpjbzq$art_i < $art_ctujkxx$art_c; $art_ikpjbzq$art_i++) {    var item = list[$art_ikpjbzq$art_i]%>';
    for (var $art_ikpjbzq$art_i = 0, $art_ctujkxx$art_c = list.length; $art_ikpjbzq$art_i < $art_ctujkxx$art_c; $art_ikpjbzq$art_i++) {
        var item = list[$art_ikpjbzq$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_iqvxcaoxikj$art_i = 0, $art_objvrydlvj$art_obj = item.subs, $art_cbkkozfgyau$art_c = $art_objvrydlvj$art_obj.length; $art_iqvxcaoxikj$art_i < $art_cbkkozfgyau$art_c; $art_iqvxcaoxikj$art_i++) {        var sub = $art_objvrydlvj$art_obj[$art_iqvxcaoxikj$art_i]%>';
        for (var $art_iqvxcaoxikj$art_i = 0, $art_objvrydlvj$art_obj = item.subs, $art_cbkkozfgyau$art_c = $art_objvrydlvj$art_obj.length; $art_iqvxcaoxikj$art_i < $art_cbkkozfgyau$art_c; $art_iqvxcaoxikj$art_i++) {
            var sub = $art_objvrydlvj$art_obj[$art_iqvxcaoxikj$art_i];
