...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuanrtad$art_i = 0, $art_csecju$art_c = headers.length; $art_iuanrtad$art_i < $art_csecju$art_c; $art_iuanrtad$art_i++) {    var h = headers[$art_iuanrtad$art_i]%>';
    for (var $art_iuanrtad$art_i = 0, $art_csecju$art_c = headers.length; $art_iuanrtad$art_i < $art_csecju$art_c; $art_iuanrtad$art_i++) {
        var h = headers[$art_iuanrtad$art_i];
        $p += '<a ';
        $line = 18;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_iqamlhd$art_i = 0, $art_culeylzns$art_c = list.length; $art_iqamlhd$art_i < $art_culeylzns$art_c; $art_iqamlhd$art_i++) {    var item = list[$art_iqamlhd$art_i]%>';
    for (var $art_iqamlhd$art_i = 0, $art_culeylzns$art_c = list.length; $art_iqamlhd$art_i < $art_culeylzns$art_c; $art_iqamlhd$art_i++) {
        var item = list[$art_iqamlhd$art_i];
        $p += ' ';
        $line = 33;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_ikfboxclcp$art_i = 0, $art_objfusaoak$art_obj = item.subs, $art_cgbjphgwzo$art_c = $art_objfusaoak$art_obj.length; $art_ikfboxclcp$art_i < $art_cgbjphgwzo$art_c; $art_ikfboxclcp$art_i++) {        var sub = $art_objfusaoak$art_obj[$art_ikfboxclcp$art_i]%>';
        for (var $art_ikfboxclcp$art_i = 0, $art_objfusaoak$art_obj = item.subs, $art_cgbjphgwzo$art_c = $art_objfusaoak$art_obj.length; $art_ikfboxclcp$art_i < $art_cgbjphgwzo$art_c; $art_ikfboxclcp$art_i++) {
            var sub = $art_objfusaoak$art_obj[$art_ikfboxclcp$art_i];
