...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ircjrycjb$art_i = 0, $art_cphqwdusf$art_c = headers.length; $art_ircjrycjb$art_i < $art_cphqwdusf$art_c; $art_ircjrycjb$art_i++) {    var h = headers[$art_ircjrycjb$art_i]%>';
    for (var $art_ircjrycjb$art_i = 0, $art_cphqwdusf$art_c = headers.length; $art_ircjrycjb$art_i < $art_cphqwdusf$art_c; $art_ircjrycjb$art_i++) {
        var h = headers[$art_ircjrycjb$art_i];
        $p += '<a ';
        $line = 37;
        $art = 'if h.new';
        ;
    ...
    ;
    $expr = '<%for (var $art_ienmwub$art_i = 0, $art_cjivqom$art_c = list.length; $art_ienmwub$art_i < $art_cjivqom$art_c; $art_ienmwub$art_i++) {    var item = list[$art_ienmwub$art_i]%>';
    for (var $art_ienmwub$art_i = 0, $art_cjivqom$art_c = list.length; $art_ienmwub$art_i < $art_cjivqom$art_c; $art_ienmwub$art_i++) {
        var item = list[$art_ienmwub$art_i];
        $p += ' ';
        $line = 52;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_idlakyvijxf$art_i = 0, $art_objzihrel$art_obj = item.subs, $art_czlzjyrlzap$art_c = $art_objzihrel$art_obj.length; $art_idlakyvijxf$art_i < $art_czlzjyrlzap$art_c; $art_idlakyvijxf$art_i++) {        var sub = $art_objzihrel$art_obj[$art_idlakyvijxf$art_i]%>';
        for (var $art_idlakyvijxf$art_i = 0, $art_objzihrel$art_obj = item.subs, $art_czlzjyrlzap$art_c = $art_objzihrel$art_obj.length; $art_idlakyvijxf$art_i < $art_czlzjyrlzap$art_c; $art_idlakyvijxf$art_i++) {
            var sub = $art_objzihrel$art_obj[$art_idlakyvijxf$art_i];
