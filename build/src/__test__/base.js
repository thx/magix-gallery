...
module.exports = Magix.View.extend({
    ...
    $art = '@suggests';
    ;
    $p += ($expr = '<%@suggests%>', $i($$ref, suggests)) + '&listText=name&listValue=path&type=all"></div></div><div mxa="_zs_gallerya:b" class="_zs_gallery___test___base_-header-tabs clearfix">';
    $line = 18;
    $art = 'each headers as h';
    ;
    $expr = '<%for (var $art_izmqxfkp$art_i = 0, $art_cmtkiayl$art_c = headers.length; $art_izmqxfkp$art_i < $art_cmtkiayl$art_c; $art_izmqxfkp$art_i++) {    var h = headers[$art_izmqxfkp$art_i]%>';
    for (var $art_izmqxfkp$art_i = 0, $art_cmtkiayl$art_c = headers.length; $art_izmqxfkp$art_i < $art_cmtkiayl$art_c; $art_izmqxfkp$art_i++) {
        var h = headers[$art_izmqxfkp$art_i];
        $p += '<a href="#!';
        $line = 19;
        $art = '=h.path';
        ;
    ...
    ;
    $expr = '<%for (var $art_ifuknyafvtkv$art_i = 0, $art_czlupij$art_c = list.length; $art_ifuknyafvtkv$art_i < $art_czlupij$art_c; $art_ifuknyafvtkv$art_i++) {    var item = list[$art_ifuknyafvtkv$art_i]%>';
    for (var $art_ifuknyafvtkv$art_i = 0, $art_czlupij$art_c = list.length; $art_ifuknyafvtkv$art_i < $art_czlupij$art_c; $art_ifuknyafvtkv$art_i++) {
        var item = list[$art_ifuknyafvtkv$art_i];
        $p += ' ';
        $line = 26;
        $art = 'if item.name';
        ;
        ...
        ;
        $expr = '<%for (var $art_igmlsekhzt$art_i = 0, $art_objaxbmasra$art_obj = item.subs, $art_cwhgfnwzp$art_c = $art_objaxbmasra$art_obj.length; $art_igmlsekhzt$art_i < $art_cwhgfnwzp$art_c; $art_igmlsekhzt$art_i++) {        var sub = $art_objaxbmasra$art_obj[$art_igmlsekhzt$art_i]%>';
        for (var $art_igmlsekhzt$art_i = 0, $art_objaxbmasra$art_obj = item.subs, $art_cwhgfnwzp$art_c = $art_objaxbmasra$art_obj.length; $art_igmlsekhzt$art_i < $art_cwhgfnwzp$art_c; $art_igmlsekhzt$art_i++) {
            var sub = $art_objaxbmasra$art_obj[$art_igmlsekhzt$art_i];
