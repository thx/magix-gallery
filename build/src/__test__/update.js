...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilmycln$art_i = 0, $art_cjovbx$art_c = list.length; $art_ilmycln$art_i < $art_cjovbx$art_c; $art_ilmycln$art_i++) {    var item = list[$art_ilmycln$art_i]%>';
    for (var $art_ilmycln$art_i = 0, $art_cjovbx$art_c = list.length; $art_ilmycln$art_i < $art_cjovbx$art_c; $art_ilmycln$art_i++) {
        var item = list[$art_ilmycln$art_i];
        ...
        ;
        $expr = '<%for (var $art_ilddaau$art_i = 0, $art_objaajndrga$art_obj = item.subs, $art_cbbvubtv$art_c = $art_objaajndrga$art_obj.length; $art_ilddaau$art_i < $art_cbbvubtv$art_c; $art_ilddaau$art_i++) {        var s = $art_objaajndrga$art_obj[$art_ilddaau$art_i]%>';
        for (var $art_ilddaau$art_i = 0, $art_objaajndrga$art_obj = item.subs, $art_cbbvubtv$art_c = $art_objaajndrga$art_obj.length; $art_ilddaau$art_i < $art_cbbvubtv$art_c; $art_ilddaau$art_i++) {
            var s = $art_objaajndrga$art_obj[$art_ilddaau$art_i];
            ...
            ;
            $expr = '<%for (var $art_ilikyl$art_i = 0, $art_objlrriwx$art_obj = s.subs, $art_civaryzwy$art_c = $art_objlrriwx$art_obj.length; $art_ilikyl$art_i < $art_civaryzwy$art_c; $art_ilikyl$art_i++) {            var ss = $art_objlrriwx$art_obj[$art_ilikyl$art_i]%>';
            for (var $art_ilikyl$art_i = 0, $art_objlrriwx$art_obj = s.subs, $art_civaryzwy$art_c = $art_objlrriwx$art_obj.length; $art_ilikyl$art_i < $art_civaryzwy$art_c; $art_ilikyl$art_i++) {
                var ss = $art_objlrriwx$art_obj[$art_ilikyl$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_idhmdgk$art_i = 0, $art_objryrdxyyr$art_obj = ss.subs, $art_cwamts$art_c = $art_objryrdxyyr$art_obj.length; $art_idhmdgk$art_i < $art_cwamts$art_c; $art_idhmdgk$art_i++) {                    var sss = $art_objryrdxyyr$art_obj[$art_idhmdgk$art_i]%>';
                    for (var $art_idhmdgk$art_i = 0, $art_objryrdxyyr$art_obj = ss.subs, $art_cwamts$art_c = $art_objryrdxyyr$art_obj.length; $art_idhmdgk$art_i < $art_cwamts$art_c; $art_idhmdgk$art_i++) {
                        var sss = $art_objryrdxyyr$art_obj[$art_idhmdgk$art_i];
