...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irnejdc$art_i = 0, $art_cllhwyzm$art_c = list.length; $art_irnejdc$art_i < $art_cllhwyzm$art_c; $art_irnejdc$art_i++) {    var item = list[$art_irnejdc$art_i]%>';
    for (var $art_irnejdc$art_i = 0, $art_cllhwyzm$art_c = list.length; $art_irnejdc$art_i < $art_cllhwyzm$art_c; $art_irnejdc$art_i++) {
        var item = list[$art_irnejdc$art_i];
        ...
        ;
        $expr = '<%for (var $art_ikdhariuav$art_i = 0, $art_objyehopqbuih$art_obj = item.subs, $art_cmmckitjjb$art_c = $art_objyehopqbuih$art_obj.length; $art_ikdhariuav$art_i < $art_cmmckitjjb$art_c; $art_ikdhariuav$art_i++) {        var s = $art_objyehopqbuih$art_obj[$art_ikdhariuav$art_i]%>';
        for (var $art_ikdhariuav$art_i = 0, $art_objyehopqbuih$art_obj = item.subs, $art_cmmckitjjb$art_c = $art_objyehopqbuih$art_obj.length; $art_ikdhariuav$art_i < $art_cmmckitjjb$art_c; $art_ikdhariuav$art_i++) {
            var s = $art_objyehopqbuih$art_obj[$art_ikdhariuav$art_i];
            ...
            ;
            $expr = '<%for (var $art_iovvcmdkoo$art_i = 0, $art_objrzarsewcl$art_obj = s.subs, $art_ccsiownyr$art_c = $art_objrzarsewcl$art_obj.length; $art_iovvcmdkoo$art_i < $art_ccsiownyr$art_c; $art_iovvcmdkoo$art_i++) {            var ss = $art_objrzarsewcl$art_obj[$art_iovvcmdkoo$art_i]%>';
            for (var $art_iovvcmdkoo$art_i = 0, $art_objrzarsewcl$art_obj = s.subs, $art_ccsiownyr$art_c = $art_objrzarsewcl$art_obj.length; $art_iovvcmdkoo$art_i < $art_ccsiownyr$art_c; $art_iovvcmdkoo$art_i++) {
                var ss = $art_objrzarsewcl$art_obj[$art_iovvcmdkoo$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_idednggw$art_i = 0, $art_objdqur$art_obj = ss.subs, $art_ccgmxhbgxwh$art_c = $art_objdqur$art_obj.length; $art_idednggw$art_i < $art_ccgmxhbgxwh$art_c; $art_idednggw$art_i++) {                    var sss = $art_objdqur$art_obj[$art_idednggw$art_i]%>';
                    for (var $art_idednggw$art_i = 0, $art_objdqur$art_obj = ss.subs, $art_ccgmxhbgxwh$art_c = $art_objdqur$art_obj.length; $art_idednggw$art_i < $art_ccgmxhbgxwh$art_c; $art_idednggw$art_i++) {
                        var sss = $art_objdqur$art_obj[$art_idednggw$art_i];
