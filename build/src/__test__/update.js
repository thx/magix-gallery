...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iknttuubm$art_i = 0, $art_chvwjnkkiot$art_c = list.length; $art_iknttuubm$art_i < $art_chvwjnkkiot$art_c; $art_iknttuubm$art_i++) {    var item = list[$art_iknttuubm$art_i]%>';
    for (var $art_iknttuubm$art_i = 0, $art_chvwjnkkiot$art_c = list.length; $art_iknttuubm$art_i < $art_chvwjnkkiot$art_c; $art_iknttuubm$art_i++) {
        var item = list[$art_iknttuubm$art_i];
        ...
        ;
        $expr = '<%for (var $art_iekuxtl$art_i = 0, $art_objihnaafox$art_obj = item.subs, $art_cbsmeivbm$art_c = $art_objihnaafox$art_obj.length; $art_iekuxtl$art_i < $art_cbsmeivbm$art_c; $art_iekuxtl$art_i++) {        var s = $art_objihnaafox$art_obj[$art_iekuxtl$art_i]%>';
        for (var $art_iekuxtl$art_i = 0, $art_objihnaafox$art_obj = item.subs, $art_cbsmeivbm$art_c = $art_objihnaafox$art_obj.length; $art_iekuxtl$art_i < $art_cbsmeivbm$art_c; $art_iekuxtl$art_i++) {
            var s = $art_objihnaafox$art_obj[$art_iekuxtl$art_i];
            ...
            ;
            $expr = '<%for (var $art_ixluapyozr$art_i = 0, $art_objyftalznoo$art_obj = s.subs, $art_cbyltqrew$art_c = $art_objyftalznoo$art_obj.length; $art_ixluapyozr$art_i < $art_cbyltqrew$art_c; $art_ixluapyozr$art_i++) {            var ss = $art_objyftalznoo$art_obj[$art_ixluapyozr$art_i]%>';
            for (var $art_ixluapyozr$art_i = 0, $art_objyftalznoo$art_obj = s.subs, $art_cbyltqrew$art_c = $art_objyftalznoo$art_obj.length; $art_ixluapyozr$art_i < $art_cbyltqrew$art_c; $art_ixluapyozr$art_i++) {
                var ss = $art_objyftalznoo$art_obj[$art_ixluapyozr$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iczideuqzjb$art_i = 0, $art_objgzqwjys$art_obj = ss.subs, $art_cmxupqc$art_c = $art_objgzqwjys$art_obj.length; $art_iczideuqzjb$art_i < $art_cmxupqc$art_c; $art_iczideuqzjb$art_i++) {                    var sss = $art_objgzqwjys$art_obj[$art_iczideuqzjb$art_i]%>';
                    for (var $art_iczideuqzjb$art_i = 0, $art_objgzqwjys$art_obj = ss.subs, $art_cmxupqc$art_c = $art_objgzqwjys$art_obj.length; $art_iczideuqzjb$art_i < $art_cmxupqc$art_c; $art_iczideuqzjb$art_i++) {
                        var sss = $art_objgzqwjys$art_obj[$art_iczideuqzjb$art_i];
