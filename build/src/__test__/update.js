...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaahkilf$art_i = 0, $art_calqefay$art_c = list.length; $art_iaahkilf$art_i < $art_calqefay$art_c; $art_iaahkilf$art_i++) {    var item = list[$art_iaahkilf$art_i]%>';
    for (var $art_iaahkilf$art_i = 0, $art_calqefay$art_c = list.length; $art_iaahkilf$art_i < $art_calqefay$art_c; $art_iaahkilf$art_i++) {
        var item = list[$art_iaahkilf$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixlsumse$art_i = 0, $art_objbxfxtngp$art_obj = item.subs, $art_ciwwcenadq$art_c = $art_objbxfxtngp$art_obj.length; $art_ixlsumse$art_i < $art_ciwwcenadq$art_c; $art_ixlsumse$art_i++) {        var s = $art_objbxfxtngp$art_obj[$art_ixlsumse$art_i]%>';
        for (var $art_ixlsumse$art_i = 0, $art_objbxfxtngp$art_obj = item.subs, $art_ciwwcenadq$art_c = $art_objbxfxtngp$art_obj.length; $art_ixlsumse$art_i < $art_ciwwcenadq$art_c; $art_ixlsumse$art_i++) {
            var s = $art_objbxfxtngp$art_obj[$art_ixlsumse$art_i];
            ...
            ;
            $expr = '<%for (var $art_iyezgxr$art_i = 0, $art_objccuowiqq$art_obj = s.subs, $art_cslzrpolsf$art_c = $art_objccuowiqq$art_obj.length; $art_iyezgxr$art_i < $art_cslzrpolsf$art_c; $art_iyezgxr$art_i++) {            var ss = $art_objccuowiqq$art_obj[$art_iyezgxr$art_i]%>';
            for (var $art_iyezgxr$art_i = 0, $art_objccuowiqq$art_obj = s.subs, $art_cslzrpolsf$art_c = $art_objccuowiqq$art_obj.length; $art_iyezgxr$art_i < $art_cslzrpolsf$art_c; $art_iyezgxr$art_i++) {
                var ss = $art_objccuowiqq$art_obj[$art_iyezgxr$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iyohpngnc$art_i = 0, $art_objldgnwlcjb$art_obj = ss.subs, $art_cfqxbczpbl$art_c = $art_objldgnwlcjb$art_obj.length; $art_iyohpngnc$art_i < $art_cfqxbczpbl$art_c; $art_iyohpngnc$art_i++) {                    var sss = $art_objldgnwlcjb$art_obj[$art_iyohpngnc$art_i]%>';
                    for (var $art_iyohpngnc$art_i = 0, $art_objldgnwlcjb$art_obj = ss.subs, $art_cfqxbczpbl$art_c = $art_objldgnwlcjb$art_obj.length; $art_iyohpngnc$art_i < $art_cfqxbczpbl$art_c; $art_iyohpngnc$art_i++) {
                        var sss = $art_objldgnwlcjb$art_obj[$art_iyohpngnc$art_i];
