...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imjvsrmt$art_i = 0, $art_cyrakstt$art_c = list.length; $art_imjvsrmt$art_i < $art_cyrakstt$art_c; $art_imjvsrmt$art_i++) {    var item = list[$art_imjvsrmt$art_i]%>';
    for (var $art_imjvsrmt$art_i = 0, $art_cyrakstt$art_c = list.length; $art_imjvsrmt$art_i < $art_cyrakstt$art_c; $art_imjvsrmt$art_i++) {
        var item = list[$art_imjvsrmt$art_i];
        ...
        ;
        $expr = '<%for (var $art_iiszvieg$art_i = 0, $art_objzgf$art_obj = item.subs, $art_csksfl$art_c = $art_objzgf$art_obj.length; $art_iiszvieg$art_i < $art_csksfl$art_c; $art_iiszvieg$art_i++) {        var s = $art_objzgf$art_obj[$art_iiszvieg$art_i]%>';
        for (var $art_iiszvieg$art_i = 0, $art_objzgf$art_obj = item.subs, $art_csksfl$art_c = $art_objzgf$art_obj.length; $art_iiszvieg$art_i < $art_csksfl$art_c; $art_iiszvieg$art_i++) {
            var s = $art_objzgf$art_obj[$art_iiszvieg$art_i];
            ...
            ;
            $expr = '<%for (var $art_ieqiouoxf$art_i = 0, $art_objszqmjptjm$art_obj = s.subs, $art_cqtioxozyu$art_c = $art_objszqmjptjm$art_obj.length; $art_ieqiouoxf$art_i < $art_cqtioxozyu$art_c; $art_ieqiouoxf$art_i++) {            var ss = $art_objszqmjptjm$art_obj[$art_ieqiouoxf$art_i]%>';
            for (var $art_ieqiouoxf$art_i = 0, $art_objszqmjptjm$art_obj = s.subs, $art_cqtioxozyu$art_c = $art_objszqmjptjm$art_obj.length; $art_ieqiouoxf$art_i < $art_cqtioxozyu$art_c; $art_ieqiouoxf$art_i++) {
                var ss = $art_objszqmjptjm$art_obj[$art_ieqiouoxf$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iofjxjg$art_i = 0, $art_objyzwiags$art_obj = ss.subs, $art_cyypzklfzah$art_c = $art_objyzwiags$art_obj.length; $art_iofjxjg$art_i < $art_cyypzklfzah$art_c; $art_iofjxjg$art_i++) {                    var sss = $art_objyzwiags$art_obj[$art_iofjxjg$art_i]%>';
                    for (var $art_iofjxjg$art_i = 0, $art_objyzwiags$art_obj = ss.subs, $art_cyypzklfzah$art_c = $art_objyzwiags$art_obj.length; $art_iofjxjg$art_i < $art_cyypzklfzah$art_c; $art_iofjxjg$art_i++) {
                        var sss = $art_objyzwiags$art_obj[$art_iofjxjg$art_i];
