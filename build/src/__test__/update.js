...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqcwhxlmzsj$art_i = 0, $art_cbywbyc$art_c = list.length; $art_iqcwhxlmzsj$art_i < $art_cbywbyc$art_c; $art_iqcwhxlmzsj$art_i++) {    var item = list[$art_iqcwhxlmzsj$art_i]%>';
    for (var $art_iqcwhxlmzsj$art_i = 0, $art_cbywbyc$art_c = list.length; $art_iqcwhxlmzsj$art_i < $art_cbywbyc$art_c; $art_iqcwhxlmzsj$art_i++) {
        var item = list[$art_iqcwhxlmzsj$art_i];
        ...
        ;
        $expr = '<%for (var $art_iygeeuaknv$art_i = 0, $art_objnzhltknzh$art_obj = item.subs, $art_crxlcskb$art_c = $art_objnzhltknzh$art_obj.length; $art_iygeeuaknv$art_i < $art_crxlcskb$art_c; $art_iygeeuaknv$art_i++) {        var s = $art_objnzhltknzh$art_obj[$art_iygeeuaknv$art_i]%>';
        for (var $art_iygeeuaknv$art_i = 0, $art_objnzhltknzh$art_obj = item.subs, $art_crxlcskb$art_c = $art_objnzhltknzh$art_obj.length; $art_iygeeuaknv$art_i < $art_crxlcskb$art_c; $art_iygeeuaknv$art_i++) {
            var s = $art_objnzhltknzh$art_obj[$art_iygeeuaknv$art_i];
            ...
            ;
            $expr = '<%for (var $art_idzxtbjrdp$art_i = 0, $art_objkjegowl$art_obj = s.subs, $art_csjtcqonsh$art_c = $art_objkjegowl$art_obj.length; $art_idzxtbjrdp$art_i < $art_csjtcqonsh$art_c; $art_idzxtbjrdp$art_i++) {            var ss = $art_objkjegowl$art_obj[$art_idzxtbjrdp$art_i]%>';
            for (var $art_idzxtbjrdp$art_i = 0, $art_objkjegowl$art_obj = s.subs, $art_csjtcqonsh$art_c = $art_objkjegowl$art_obj.length; $art_idzxtbjrdp$art_i < $art_csjtcqonsh$art_c; $art_idzxtbjrdp$art_i++) {
                var ss = $art_objkjegowl$art_obj[$art_idzxtbjrdp$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iekxakfdb$art_i = 0, $art_objgmggvjyhpv$art_obj = ss.subs, $art_cussmwphsmf$art_c = $art_objgmggvjyhpv$art_obj.length; $art_iekxakfdb$art_i < $art_cussmwphsmf$art_c; $art_iekxakfdb$art_i++) {                    var sss = $art_objgmggvjyhpv$art_obj[$art_iekxakfdb$art_i]%>';
                    for (var $art_iekxakfdb$art_i = 0, $art_objgmggvjyhpv$art_obj = ss.subs, $art_cussmwphsmf$art_c = $art_objgmggvjyhpv$art_obj.length; $art_iekxakfdb$art_i < $art_cussmwphsmf$art_c; $art_iekxakfdb$art_i++) {
                        var sss = $art_objgmggvjyhpv$art_obj[$art_iekxakfdb$art_i];
