...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifxmelvx$art_i = 0, $art_ckptkuwk$art_c = list.length; $art_ifxmelvx$art_i < $art_ckptkuwk$art_c; $art_ifxmelvx$art_i++) {    var item = list[$art_ifxmelvx$art_i]%>';
    for (var $art_ifxmelvx$art_i = 0, $art_ckptkuwk$art_c = list.length; $art_ifxmelvx$art_i < $art_ckptkuwk$art_c; $art_ifxmelvx$art_i++) {
        var item = list[$art_ifxmelvx$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijyztvxdr$art_i = 0, $art_objizzbmie$art_obj = item.subs, $art_cofatqx$art_c = $art_objizzbmie$art_obj.length; $art_ijyztvxdr$art_i < $art_cofatqx$art_c; $art_ijyztvxdr$art_i++) {        var s = $art_objizzbmie$art_obj[$art_ijyztvxdr$art_i]%>';
        for (var $art_ijyztvxdr$art_i = 0, $art_objizzbmie$art_obj = item.subs, $art_cofatqx$art_c = $art_objizzbmie$art_obj.length; $art_ijyztvxdr$art_i < $art_cofatqx$art_c; $art_ijyztvxdr$art_i++) {
            var s = $art_objizzbmie$art_obj[$art_ijyztvxdr$art_i];
            ...
            ;
            $expr = '<%for (var $art_iptkxtvdk$art_i = 0, $art_objokkccnis$art_obj = s.subs, $art_czghljaiy$art_c = $art_objokkccnis$art_obj.length; $art_iptkxtvdk$art_i < $art_czghljaiy$art_c; $art_iptkxtvdk$art_i++) {            var ss = $art_objokkccnis$art_obj[$art_iptkxtvdk$art_i]%>';
            for (var $art_iptkxtvdk$art_i = 0, $art_objokkccnis$art_obj = s.subs, $art_czghljaiy$art_c = $art_objokkccnis$art_obj.length; $art_iptkxtvdk$art_i < $art_czghljaiy$art_c; $art_iptkxtvdk$art_i++) {
                var ss = $art_objokkccnis$art_obj[$art_iptkxtvdk$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ifoahwfqb$art_i = 0, $art_objybgamj$art_obj = ss.subs, $art_ckskxlodslp$art_c = $art_objybgamj$art_obj.length; $art_ifoahwfqb$art_i < $art_ckskxlodslp$art_c; $art_ifoahwfqb$art_i++) {                    var sss = $art_objybgamj$art_obj[$art_ifoahwfqb$art_i]%>';
                    for (var $art_ifoahwfqb$art_i = 0, $art_objybgamj$art_obj = ss.subs, $art_ckskxlodslp$art_c = $art_objybgamj$art_obj.length; $art_ifoahwfqb$art_i < $art_ckskxlodslp$art_c; $art_ifoahwfqb$art_i++) {
                        var sss = $art_objybgamj$art_obj[$art_ifoahwfqb$art_i];
