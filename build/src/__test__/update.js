...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixdpumx$art_i = 0, $art_cpojehcnf$art_c = list.length; $art_ixdpumx$art_i < $art_cpojehcnf$art_c; $art_ixdpumx$art_i++) {    var item = list[$art_ixdpumx$art_i]%>';
    for (var $art_ixdpumx$art_i = 0, $art_cpojehcnf$art_c = list.length; $art_ixdpumx$art_i < $art_cpojehcnf$art_c; $art_ixdpumx$art_i++) {
        var item = list[$art_ixdpumx$art_i];
        ...
        ;
        $expr = '<%for (var $art_itxmglioeoj$art_i = 0, $art_objxienkiwk$art_obj = item.subs, $art_cxcixfua$art_c = $art_objxienkiwk$art_obj.length; $art_itxmglioeoj$art_i < $art_cxcixfua$art_c; $art_itxmglioeoj$art_i++) {        var s = $art_objxienkiwk$art_obj[$art_itxmglioeoj$art_i]%>';
        for (var $art_itxmglioeoj$art_i = 0, $art_objxienkiwk$art_obj = item.subs, $art_cxcixfua$art_c = $art_objxienkiwk$art_obj.length; $art_itxmglioeoj$art_i < $art_cxcixfua$art_c; $art_itxmglioeoj$art_i++) {
            var s = $art_objxienkiwk$art_obj[$art_itxmglioeoj$art_i];
            ...
            ;
            $expr = '<%for (var $art_ishcrropmc$art_i = 0, $art_objyxxutyue$art_obj = s.subs, $art_cqbzyvxlm$art_c = $art_objyxxutyue$art_obj.length; $art_ishcrropmc$art_i < $art_cqbzyvxlm$art_c; $art_ishcrropmc$art_i++) {            var ss = $art_objyxxutyue$art_obj[$art_ishcrropmc$art_i]%>';
            for (var $art_ishcrropmc$art_i = 0, $art_objyxxutyue$art_obj = s.subs, $art_cqbzyvxlm$art_c = $art_objyxxutyue$art_obj.length; $art_ishcrropmc$art_i < $art_cqbzyvxlm$art_c; $art_ishcrropmc$art_i++) {
                var ss = $art_objyxxutyue$art_obj[$art_ishcrropmc$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_irsdoee$art_i = 0, $art_objasdqrubhu$art_obj = ss.subs, $art_cdleqfo$art_c = $art_objasdqrubhu$art_obj.length; $art_irsdoee$art_i < $art_cdleqfo$art_c; $art_irsdoee$art_i++) {                    var sss = $art_objasdqrubhu$art_obj[$art_irsdoee$art_i]%>';
                    for (var $art_irsdoee$art_i = 0, $art_objasdqrubhu$art_obj = ss.subs, $art_cdleqfo$art_c = $art_objasdqrubhu$art_obj.length; $art_irsdoee$art_i < $art_cdleqfo$art_c; $art_irsdoee$art_i++) {
                        var sss = $art_objasdqrubhu$art_obj[$art_irsdoee$art_i];
