...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihjyuupyk$art_i = 0, $art_cajgckvarb$art_c = list.length; $art_ihjyuupyk$art_i < $art_cajgckvarb$art_c; $art_ihjyuupyk$art_i++) {    var item = list[$art_ihjyuupyk$art_i]%>';
    for (var $art_ihjyuupyk$art_i = 0, $art_cajgckvarb$art_c = list.length; $art_ihjyuupyk$art_i < $art_cajgckvarb$art_c; $art_ihjyuupyk$art_i++) {
        var item = list[$art_ihjyuupyk$art_i];
        ...
        ;
        $expr = '<%for (var $art_iociucpch$art_i = 0, $art_objitumawvdq$art_obj = item.subs, $art_clesmrpba$art_c = $art_objitumawvdq$art_obj.length; $art_iociucpch$art_i < $art_clesmrpba$art_c; $art_iociucpch$art_i++) {        var s = $art_objitumawvdq$art_obj[$art_iociucpch$art_i]%>';
        for (var $art_iociucpch$art_i = 0, $art_objitumawvdq$art_obj = item.subs, $art_clesmrpba$art_c = $art_objitumawvdq$art_obj.length; $art_iociucpch$art_i < $art_clesmrpba$art_c; $art_iociucpch$art_i++) {
            var s = $art_objitumawvdq$art_obj[$art_iociucpch$art_i];
            ...
            ;
            $expr = '<%for (var $art_igtd$art_i = 0, $art_objiojhysuup$art_obj = s.subs, $art_cdoigxcziffn$art_c = $art_objiojhysuup$art_obj.length; $art_igtd$art_i < $art_cdoigxcziffn$art_c; $art_igtd$art_i++) {            var ss = $art_objiojhysuup$art_obj[$art_igtd$art_i]%>';
            for (var $art_igtd$art_i = 0, $art_objiojhysuup$art_obj = s.subs, $art_cdoigxcziffn$art_c = $art_objiojhysuup$art_obj.length; $art_igtd$art_i < $art_cdoigxcziffn$art_c; $art_igtd$art_i++) {
                var ss = $art_objiojhysuup$art_obj[$art_igtd$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iddbhdqocr$art_i = 0, $art_objvvwrjuvnx$art_obj = ss.subs, $art_cacsfjtxg$art_c = $art_objvvwrjuvnx$art_obj.length; $art_iddbhdqocr$art_i < $art_cacsfjtxg$art_c; $art_iddbhdqocr$art_i++) {                    var sss = $art_objvvwrjuvnx$art_obj[$art_iddbhdqocr$art_i]%>';
                    for (var $art_iddbhdqocr$art_i = 0, $art_objvvwrjuvnx$art_obj = ss.subs, $art_cacsfjtxg$art_c = $art_objvvwrjuvnx$art_obj.length; $art_iddbhdqocr$art_i < $art_cacsfjtxg$art_c; $art_iddbhdqocr$art_i++) {
                        var sss = $art_objvvwrjuvnx$art_obj[$art_iddbhdqocr$art_i];
