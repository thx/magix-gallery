...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itmbhpzge$art_i = 0, $art_cekuuvus$art_c = list.length; $art_itmbhpzge$art_i < $art_cekuuvus$art_c; $art_itmbhpzge$art_i++) {    var item = list[$art_itmbhpzge$art_i]%>';
    for (var $art_itmbhpzge$art_i = 0, $art_cekuuvus$art_c = list.length; $art_itmbhpzge$art_i < $art_cekuuvus$art_c; $art_itmbhpzge$art_i++) {
        var item = list[$art_itmbhpzge$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijjxfwsufa$art_i = 0, $art_objrfmrimdas$art_obj = item.subs, $art_cnxuqjnji$art_c = $art_objrfmrimdas$art_obj.length; $art_ijjxfwsufa$art_i < $art_cnxuqjnji$art_c; $art_ijjxfwsufa$art_i++) {        var s = $art_objrfmrimdas$art_obj[$art_ijjxfwsufa$art_i]%>';
        for (var $art_ijjxfwsufa$art_i = 0, $art_objrfmrimdas$art_obj = item.subs, $art_cnxuqjnji$art_c = $art_objrfmrimdas$art_obj.length; $art_ijjxfwsufa$art_i < $art_cnxuqjnji$art_c; $art_ijjxfwsufa$art_i++) {
            var s = $art_objrfmrimdas$art_obj[$art_ijjxfwsufa$art_i];
            ...
            ;
            $expr = '<%for (var $art_ismrhveba$art_i = 0, $art_objmrhxaq$art_obj = s.subs, $art_cdopiwgcud$art_c = $art_objmrhxaq$art_obj.length; $art_ismrhveba$art_i < $art_cdopiwgcud$art_c; $art_ismrhveba$art_i++) {            var ss = $art_objmrhxaq$art_obj[$art_ismrhveba$art_i]%>';
            for (var $art_ismrhveba$art_i = 0, $art_objmrhxaq$art_obj = s.subs, $art_cdopiwgcud$art_c = $art_objmrhxaq$art_obj.length; $art_ismrhveba$art_i < $art_cdopiwgcud$art_c; $art_ismrhveba$art_i++) {
                var ss = $art_objmrhxaq$art_obj[$art_ismrhveba$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iabfoxpy$art_i = 0, $art_objlhqddqdfgq$art_obj = ss.subs, $art_cgnavfimt$art_c = $art_objlhqddqdfgq$art_obj.length; $art_iabfoxpy$art_i < $art_cgnavfimt$art_c; $art_iabfoxpy$art_i++) {                    var sss = $art_objlhqddqdfgq$art_obj[$art_iabfoxpy$art_i]%>';
                    for (var $art_iabfoxpy$art_i = 0, $art_objlhqddqdfgq$art_obj = ss.subs, $art_cgnavfimt$art_c = $art_objlhqddqdfgq$art_obj.length; $art_iabfoxpy$art_i < $art_cgnavfimt$art_c; $art_iabfoxpy$art_i++) {
                        var sss = $art_objlhqddqdfgq$art_obj[$art_iabfoxpy$art_i];
