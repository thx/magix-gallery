...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipmcfuhlnk$art_i = 0, $art_certruoeymoh$art_c = list.length; $art_ipmcfuhlnk$art_i < $art_certruoeymoh$art_c; $art_ipmcfuhlnk$art_i++) {    var item = list[$art_ipmcfuhlnk$art_i]%>';
    for (var $art_ipmcfuhlnk$art_i = 0, $art_certruoeymoh$art_c = list.length; $art_ipmcfuhlnk$art_i < $art_certruoeymoh$art_c; $art_ipmcfuhlnk$art_i++) {
        var item = list[$art_ipmcfuhlnk$art_i];
        $p += '<div mxa="_zs_galleryP:_" class="_zs_gallery___test___update_-update"><div mxa="_zs_galleryP:a" class="_zs_gallery___test___update_-ver pl20"><span mxa="_zs_galleryP:b" class="_zs_gallery___test___update_-vt">';
        $line = 5;
        $art = '=item.ver';
        ;
        $p += ($expr = '<%=item.ver%>', $e(item.ver)) + '<span mxa="_zs_galleryP:c" class="_zs_gallery___test___update_-vi">';
        $line = 6;
        $art = '=item.time';
        ;
        ...
        ;
        $expr = '<%for (var $art_ivwombkis$art_i = 0, $art_objghwnubuhi$art_obj = item.subs, $art_cjgkgjckz$art_c = $art_objghwnubuhi$art_obj.length; $art_ivwombkis$art_i < $art_cjgkgjckz$art_c; $art_ivwombkis$art_i++) {        var s = $art_objghwnubuhi$art_obj[$art_ivwombkis$art_i]%>';
        for (var $art_ivwombkis$art_i = 0, $art_objghwnubuhi$art_obj = item.subs, $art_cjgkgjckz$art_c = $art_objghwnubuhi$art_obj.length; $art_ivwombkis$art_i < $art_cjgkgjckz$art_c; $art_ivwombkis$art_i++) {
            var s = $art_objghwnubuhi$art_obj[$art_ivwombkis$art_i];
            ...
            if (s.type == 'notice') {
                ;
                $p += '<div mxa="_zs_galleryP:f" class="_zs_gallery___test___update_-line"><i mxs="_zs_galleryP:_" class="mc-iconfont _zs_gallery___test___update_-line-icon color-warn">&#xe66f;</i><span mxa="_zs_galleryP:g" class="fontsize-14">';
                $line = 15;
            ...
            if (s.type == 'bug') {
                ;
                $p += '<div mxa="_zs_galleryP:h" class="_zs_gallery___test___update_-line"><i mxs="_zs_galleryP:a" class="mc-iconfont _zs_gallery___test___update_-line-icon color-red">&#xe63d;</i><span mxa="_zs_galleryP:i" class="fontsize-14">';
                $line = 22;
            ...
            if (s.type == 'add') {
                ;
                $p += '<div mxa="_zs_galleryP:j" class="_zs_gallery___test___update_-line"><i mxs="_zs_galleryP:b" class="mc-iconfont _zs_gallery___test___update_-line-icon color-green">&#xe616;</i><span mxa="_zs_galleryP:k" class="fontsize-14">';
                $line = 29;
            ...
            ;
            $expr = '<%for (var $art_ipdsjuzrkjom$art_i = 0, $art_objvhkgganp$art_obj = s.subs, $art_cfgjxdwnbc$art_c = $art_objvhkgganp$art_obj.length; $art_ipdsjuzrkjom$art_i < $art_cfgjxdwnbc$art_c; $art_ipdsjuzrkjom$art_i++) {            var ss = $art_objvhkgganp$art_obj[$art_ipdsjuzrkjom$art_i]%>';
            for (var $art_ipdsjuzrkjom$art_i = 0, $art_objvhkgganp$art_obj = s.subs, $art_cfgjxdwnbc$art_c = $art_objvhkgganp$art_obj.length; $art_ipdsjuzrkjom$art_i < $art_cfgjxdwnbc$art_c; $art_ipdsjuzrkjom$art_i++) {
                var ss = $art_objvhkgganp$art_obj[$art_ipdsjuzrkjom$art_i];
                $p += '<div mxa="_zs_galleryP:l" class="pl20"><div mxa="_zs_galleryP:m" class="_zs_gallery___test___update_-line _zs_gallery___test___update_-dot">';
                $line = 35;
                $art = '!ss.title';
                ;
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_inlrscgjnn$art_i = 0, $art_objqqgjatp$art_obj = ss.subs, $art_cpbuffumm$art_c = $art_objqqgjatp$art_obj.length; $art_inlrscgjnn$art_i < $art_cpbuffumm$art_c; $art_inlrscgjnn$art_i++) {                    var sss = $art_objqqgjatp$art_obj[$art_inlrscgjnn$art_i]%>';
                    for (var $art_inlrscgjnn$art_i = 0, $art_objqqgjatp$art_obj = ss.subs, $art_cpbuffumm$art_c = $art_objqqgjatp$art_obj.length; $art_inlrscgjnn$art_i < $art_cpbuffumm$art_c; $art_inlrscgjnn$art_i++) {
                        var sss = $art_objqqgjatp$art_obj[$art_inlrscgjnn$art_i];
                        $p += '<div mxa="_zs_galleryP:o" class="_zs_gallery___test___update_-line _zs_gallery___test___update_-dot">';
                        $line = 43;
                        $art = '!sss';
                        ;
    ...
    ;
    $p += '<div mxs="_zs_galleryP:c" class="_zs_gallery___test___update_-update"><div class="_zs_gallery___test___update_-ver pl20"><span class="_zs_gallery___test___update_-vt">历史版本<span class="_zs_gallery___test___update_-vi">···</span></span></div></div>';
}
catch (ex) {
