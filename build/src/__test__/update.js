...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iigvfehcie$art_i = 0, $art_ciomwhphxvut$art_c = list.length; $art_iigvfehcie$art_i < $art_ciomwhphxvut$art_c; $art_iigvfehcie$art_i++) {    var item = list[$art_iigvfehcie$art_i]%>';
    for (var $art_iigvfehcie$art_i = 0, $art_ciomwhphxvut$art_c = list.length; $art_iigvfehcie$art_i < $art_ciomwhphxvut$art_c; $art_iigvfehcie$art_i++) {
        var item = list[$art_iigvfehcie$art_i];
        ...
        ;
        $expr = '<%for (var $art_igqfl$art_i = 0, $art_objmqfazhw$art_obj = item.subs, $art_ckbfppeforv$art_c = $art_objmqfazhw$art_obj.length; $art_igqfl$art_i < $art_ckbfppeforv$art_c; $art_igqfl$art_i++) {        var s = $art_objmqfazhw$art_obj[$art_igqfl$art_i]%>';
        for (var $art_igqfl$art_i = 0, $art_objmqfazhw$art_obj = item.subs, $art_ckbfppeforv$art_c = $art_objmqfazhw$art_obj.length; $art_igqfl$art_i < $art_ckbfppeforv$art_c; $art_igqfl$art_i++) {
            var s = $art_objmqfazhw$art_obj[$art_igqfl$art_i];
            ...
            ;
            $expr = '<%for (var $art_izvjqtjci$art_i = 0, $art_objifoszvno$art_obj = s.subs, $art_copskcjua$art_c = $art_objifoszvno$art_obj.length; $art_izvjqtjci$art_i < $art_copskcjua$art_c; $art_izvjqtjci$art_i++) {            var ss = $art_objifoszvno$art_obj[$art_izvjqtjci$art_i]%>';
            for (var $art_izvjqtjci$art_i = 0, $art_objifoszvno$art_obj = s.subs, $art_copskcjua$art_c = $art_objifoszvno$art_obj.length; $art_izvjqtjci$art_i < $art_copskcjua$art_c; $art_izvjqtjci$art_i++) {
                var ss = $art_objifoszvno$art_obj[$art_izvjqtjci$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ixtpujnsl$art_i = 0, $art_objqhugnzudr$art_obj = ss.subs, $art_cnjuqukr$art_c = $art_objqhugnzudr$art_obj.length; $art_ixtpujnsl$art_i < $art_cnjuqukr$art_c; $art_ixtpujnsl$art_i++) {                    var sss = $art_objqhugnzudr$art_obj[$art_ixtpujnsl$art_i]%>';
                    for (var $art_ixtpujnsl$art_i = 0, $art_objqhugnzudr$art_obj = ss.subs, $art_cnjuqukr$art_c = $art_objqhugnzudr$art_obj.length; $art_ixtpujnsl$art_i < $art_cnjuqukr$art_c; $art_ixtpujnsl$art_i++) {
                        var sss = $art_objqhugnzudr$art_obj[$art_ixtpujnsl$art_i];
