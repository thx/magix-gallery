...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijtrifyk$art_i = 0, $art_cmlccigmj$art_c = list.length; $art_ijtrifyk$art_i < $art_cmlccigmj$art_c; $art_ijtrifyk$art_i++) {    var item = list[$art_ijtrifyk$art_i]%>';
    for (var $art_ijtrifyk$art_i = 0, $art_cmlccigmj$art_c = list.length; $art_ijtrifyk$art_i < $art_cmlccigmj$art_c; $art_ijtrifyk$art_i++) {
        var item = list[$art_ijtrifyk$art_i];
        ...
        ;
        $expr = '<%for (var $art_idkvzzcuy$art_i = 0, $art_objvspjypw$art_obj = item.subs, $art_coalgyo$art_c = $art_objvspjypw$art_obj.length; $art_idkvzzcuy$art_i < $art_coalgyo$art_c; $art_idkvzzcuy$art_i++) {        var s = $art_objvspjypw$art_obj[$art_idkvzzcuy$art_i]%>';
        for (var $art_idkvzzcuy$art_i = 0, $art_objvspjypw$art_obj = item.subs, $art_coalgyo$art_c = $art_objvspjypw$art_obj.length; $art_idkvzzcuy$art_i < $art_coalgyo$art_c; $art_idkvzzcuy$art_i++) {
            var s = $art_objvspjypw$art_obj[$art_idkvzzcuy$art_i];
            ...
            ;
            $expr = '<%for (var $art_iifyqxiesrg$art_i = 0, $art_objlxarttosi$art_obj = s.subs, $art_cxtvtuna$art_c = $art_objlxarttosi$art_obj.length; $art_iifyqxiesrg$art_i < $art_cxtvtuna$art_c; $art_iifyqxiesrg$art_i++) {            var ss = $art_objlxarttosi$art_obj[$art_iifyqxiesrg$art_i]%>';
            for (var $art_iifyqxiesrg$art_i = 0, $art_objlxarttosi$art_obj = s.subs, $art_cxtvtuna$art_c = $art_objlxarttosi$art_obj.length; $art_iifyqxiesrg$art_i < $art_cxtvtuna$art_c; $art_iifyqxiesrg$art_i++) {
                var ss = $art_objlxarttosi$art_obj[$art_iifyqxiesrg$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_illslgxda$art_i = 0, $art_objqytbih$art_obj = ss.subs, $art_cincvmezm$art_c = $art_objqytbih$art_obj.length; $art_illslgxda$art_i < $art_cincvmezm$art_c; $art_illslgxda$art_i++) {                    var sss = $art_objqytbih$art_obj[$art_illslgxda$art_i]%>';
                    for (var $art_illslgxda$art_i = 0, $art_objqytbih$art_obj = ss.subs, $art_cincvmezm$art_c = $art_objqytbih$art_obj.length; $art_illslgxda$art_i < $art_cincvmezm$art_c; $art_illslgxda$art_i++) {
                        var sss = $art_objqytbih$art_obj[$art_illslgxda$art_i];
