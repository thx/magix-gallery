...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iexieaxma$art_i = 0, $art_cdxjwehh$art_c = options.length; $art_iexieaxma$art_i < $art_cdxjwehh$art_c; $art_iexieaxma$art_i++) {    var option = options[$art_iexieaxma$art_i]%>';
    for (var $art_iexieaxma$art_i = 0, $art_cdxjwehh$art_c = options.length; $art_iexieaxma$art_i < $art_cdxjwehh$art_c; $art_iexieaxma$art_i++) {
        var option = options[$art_iexieaxma$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objhriohcvp$art_obj = option.params, $art_cenjlqpxrv$art_c = $art_objhriohcvp$art_obj.length; index < $art_cenjlqpxrv$art_c; index++) {        var param = $art_objhriohcvp$art_obj[index]%>';
        for (var index = 0, $art_objhriohcvp$art_obj = option.params, $art_cenjlqpxrv$art_c = $art_objhriohcvp$art_obj.length; index < $art_cenjlqpxrv$art_c; index++) {
            var param = $art_objhriohcvp$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
