...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idzvuevsc$art_i = 0, $art_cfhbscljqn$art_c = options.length; $art_idzvuevsc$art_i < $art_cfhbscljqn$art_c; $art_idzvuevsc$art_i++) {    var option = options[$art_idzvuevsc$art_i]%>';
    for (var $art_idzvuevsc$art_i = 0, $art_cfhbscljqn$art_c = options.length; $art_idzvuevsc$art_i < $art_cfhbscljqn$art_c; $art_idzvuevsc$art_i++) {
        var option = options[$art_idzvuevsc$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objdunik$art_obj = option.params, $art_clbdillidk$art_c = $art_objdunik$art_obj.length; index < $art_clbdillidk$art_c; index++) {        var param = $art_objdunik$art_obj[index]%>';
        for (var index = 0, $art_objdunik$art_obj = option.params, $art_clbdillidk$art_c = $art_objdunik$art_obj.length; index < $art_clbdillidk$art_c; index++) {
            var param = $art_objdunik$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
