...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iosdktna$art_i = 0, $art_csafw$art_c = options.length; $art_iosdktna$art_i < $art_csafw$art_c; $art_iosdktna$art_i++) {    var option = options[$art_iosdktna$art_i]%>';
    for (var $art_iosdktna$art_i = 0, $art_csafw$art_c = options.length; $art_iosdktna$art_i < $art_csafw$art_c; $art_iosdktna$art_i++) {
        var option = options[$art_iosdktna$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objhwjsrqwqhf$art_obj = option.params, $art_cnigwnrq$art_c = $art_objhwjsrqwqhf$art_obj.length; index < $art_cnigwnrq$art_c; index++) {        var param = $art_objhwjsrqwqhf$art_obj[index]%>';
        for (var index = 0, $art_objhwjsrqwqhf$art_obj = option.params, $art_cnigwnrq$art_c = $art_objhwjsrqwqhf$art_obj.length; index < $art_cnigwnrq$art_c; index++) {
            var param = $art_objhwjsrqwqhf$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
