...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iccitpw$art_i = 0, $art_cobpnhi$art_c = options.length; $art_iccitpw$art_i < $art_cobpnhi$art_c; $art_iccitpw$art_i++) {    var option = options[$art_iccitpw$art_i]%>';
    for (var $art_iccitpw$art_i = 0, $art_cobpnhi$art_c = options.length; $art_iccitpw$art_i < $art_cobpnhi$art_c; $art_iccitpw$art_i++) {
        var option = options[$art_iccitpw$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objbmaaqz$art_obj = option.params, $art_cvmtenc$art_c = $art_objbmaaqz$art_obj.length; index < $art_cvmtenc$art_c; index++) {        var param = $art_objbmaaqz$art_obj[index]%>';
        for (var index = 0, $art_objbmaaqz$art_obj = option.params, $art_cvmtenc$art_c = $art_objbmaaqz$art_obj.length; index < $art_cvmtenc$art_c; index++) {
            var param = $art_objbmaaqz$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
