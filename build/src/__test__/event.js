...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikxrjjimcip$art_i = 0, $art_ciyqufkjij$art_c = options.length; $art_ikxrjjimcip$art_i < $art_ciyqufkjij$art_c; $art_ikxrjjimcip$art_i++) {    var option = options[$art_ikxrjjimcip$art_i]%>';
    for (var $art_ikxrjjimcip$art_i = 0, $art_ciyqufkjij$art_c = options.length; $art_ikxrjjimcip$art_i < $art_ciyqufkjij$art_c; $art_ikxrjjimcip$art_i++) {
        var option = options[$art_ikxrjjimcip$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objusxwqdeo$art_obj = option.params, $art_crksteubg$art_c = $art_objusxwqdeo$art_obj.length; index < $art_crksteubg$art_c; index++) {        var param = $art_objusxwqdeo$art_obj[index]%>';
        for (var index = 0, $art_objusxwqdeo$art_obj = option.params, $art_crksteubg$art_c = $art_objusxwqdeo$art_obj.length; index < $art_crksteubg$art_c; index++) {
            var param = $art_objusxwqdeo$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
