...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inafsiqbgi$art_i = 0, $art_cbpcsrpymn$art_c = options.length; $art_inafsiqbgi$art_i < $art_cbpcsrpymn$art_c; $art_inafsiqbgi$art_i++) {    var option = options[$art_inafsiqbgi$art_i]%>';
    for (var $art_inafsiqbgi$art_i = 0, $art_cbpcsrpymn$art_c = options.length; $art_inafsiqbgi$art_i < $art_cbpcsrpymn$art_c; $art_inafsiqbgi$art_i++) {
        var option = options[$art_inafsiqbgi$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objloodxizwirn$art_obj = option.params, $art_ccypqc$art_c = $art_objloodxizwirn$art_obj.length; index < $art_ccypqc$art_c; index++) {        var param = $art_objloodxizwirn$art_obj[index]%>';
        for (var index = 0, $art_objloodxizwirn$art_obj = option.params, $art_ccypqc$art_c = $art_objloodxizwirn$art_obj.length; index < $art_ccypqc$art_c; index++) {
            var param = $art_objloodxizwirn$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
