...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaclpwrlrr$art_i = 0, $art_cujijfitxj$art_c = options.length; $art_iaclpwrlrr$art_i < $art_cujijfitxj$art_c; $art_iaclpwrlrr$art_i++) {    var option = options[$art_iaclpwrlrr$art_i]%>';
    for (var $art_iaclpwrlrr$art_i = 0, $art_cujijfitxj$art_c = options.length; $art_iaclpwrlrr$art_i < $art_cujijfitxj$art_c; $art_iaclpwrlrr$art_i++) {
        var option = options[$art_iaclpwrlrr$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objnextids$art_obj = option.params, $art_ctnxzbbsh$art_c = $art_objnextids$art_obj.length; index < $art_ctnxzbbsh$art_c; index++) {        var param = $art_objnextids$art_obj[index]%>';
        for (var index = 0, $art_objnextids$art_obj = option.params, $art_ctnxzbbsh$art_c = $art_objnextids$art_obj.length; index < $art_ctnxzbbsh$art_c; index++) {
            var param = $art_objnextids$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
