...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihnurflycj$art_i = 0, $art_cpitehnq$art_c = options.length; $art_ihnurflycj$art_i < $art_cpitehnq$art_c; $art_ihnurflycj$art_i++) {    var option = options[$art_ihnurflycj$art_i]%>';
    for (var $art_ihnurflycj$art_i = 0, $art_cpitehnq$art_c = options.length; $art_ihnurflycj$art_i < $art_cpitehnq$art_c; $art_ihnurflycj$art_i++) {
        var option = options[$art_ihnurflycj$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objmdpphmsd$art_obj = option.params, $art_cknvnazla$art_c = $art_objmdpphmsd$art_obj.length; index < $art_cknvnazla$art_c; index++) {        var param = $art_objmdpphmsd$art_obj[index]%>';
        for (var index = 0, $art_objmdpphmsd$art_obj = option.params, $art_cknvnazla$art_c = $art_objmdpphmsd$art_obj.length; index < $art_cknvnazla$art_c; index++) {
            var param = $art_objmdpphmsd$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
