...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuegcrilhl$art_i = 0, $art_cbneesnrywv$art_c = options.length; $art_iuegcrilhl$art_i < $art_cbneesnrywv$art_c; $art_iuegcrilhl$art_i++) {    var option = options[$art_iuegcrilhl$art_i]%>';
    for (var $art_iuegcrilhl$art_i = 0, $art_cbneesnrywv$art_c = options.length; $art_iuegcrilhl$art_i < $art_cbneesnrywv$art_c; $art_iuegcrilhl$art_i++) {
        var option = options[$art_iuegcrilhl$art_i];
        $p += ' ';
        $line = 14;
        $art = 'each option.params as param index';
        ;
        $expr = '<%for (var index = 0, $art_objdwhbpnbi$art_obj = option.params, $art_cgnrqwuyy$art_c = $art_objdwhbpnbi$art_obj.length; index < $art_cgnrqwuyy$art_c; index++) {        var param = $art_objdwhbpnbi$art_obj[index]%>';
        for (var index = 0, $art_objdwhbpnbi$art_obj = option.params, $art_cgnrqwuyy$art_c = $art_objdwhbpnbi$art_obj.length; index < $art_cgnrqwuyy$art_c; index++) {
            var param = $art_objdwhbpnbi$art_obj[index];
            $p += '<tr>';
            $line = 16;
            $art = 'if (index == 0)';
            ;
