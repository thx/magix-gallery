...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iizouw$art_i = 0, $art_ceqqmzouc$art_c = options.length; $art_iizouw$art_i < $art_ceqqmzouc$art_c; $art_iizouw$art_i++) {    var option = options[$art_iizouw$art_i]%>';
    for (var $art_iizouw$art_i = 0, $art_ceqqmzouc$art_c = options.length; $art_iizouw$art_i < $art_ceqqmzouc$art_c; $art_iizouw$art_i++) {
        var option = options[$art_iizouw$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
