...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyktsrtihl$art_i = 0, $art_cdvnzhwren$art_c = options.length; $art_iyktsrtihl$art_i < $art_cdvnzhwren$art_c; $art_iyktsrtihl$art_i++) {    var option = options[$art_iyktsrtihl$art_i]%>';
    for (var $art_iyktsrtihl$art_i = 0, $art_cdvnzhwren$art_c = options.length; $art_iyktsrtihl$art_i < $art_cdvnzhwren$art_c; $art_iyktsrtihl$art_i++) {
        var option = options[$art_iyktsrtihl$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
