...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iicfvznfmp$art_i = 0, $art_crgrocwkd$art_c = options.length; $art_iicfvznfmp$art_i < $art_crgrocwkd$art_c; $art_iicfvznfmp$art_i++) {    var option = options[$art_iicfvznfmp$art_i]%>';
    for (var $art_iicfvznfmp$art_i = 0, $art_crgrocwkd$art_c = options.length; $art_iicfvznfmp$art_i < $art_crgrocwkd$art_c; $art_iicfvznfmp$art_i++) {
        var option = options[$art_iicfvznfmp$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
