...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iimzctwva$art_i = 0, $art_cguxascctg$art_c = options.length; $art_iimzctwva$art_i < $art_cguxascctg$art_c; $art_iimzctwva$art_i++) {    var option = options[$art_iimzctwva$art_i]%>';
    for (var $art_iimzctwva$art_i = 0, $art_cguxascctg$art_c = options.length; $art_iimzctwva$art_i < $art_cguxascctg$art_c; $art_iimzctwva$art_i++) {
        var option = options[$art_iimzctwva$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
