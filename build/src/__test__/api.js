...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ielcxgysp$art_i = 0, $art_czasnnivrvs$art_c = options.length; $art_ielcxgysp$art_i < $art_czasnnivrvs$art_c; $art_ielcxgysp$art_i++) {    var option = options[$art_ielcxgysp$art_i]%>';
    for (var $art_ielcxgysp$art_i = 0, $art_czasnnivrvs$art_c = options.length; $art_ielcxgysp$art_i < $art_czasnnivrvs$art_c; $art_ielcxgysp$art_i++) {
        var option = options[$art_ielcxgysp$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
