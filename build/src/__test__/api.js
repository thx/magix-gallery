...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isjpguiobn$art_i = 0, $art_cplxmzondsg$art_c = options.length; $art_isjpguiobn$art_i < $art_cplxmzondsg$art_c; $art_isjpguiobn$art_i++) {    var option = options[$art_isjpguiobn$art_i]%>';
    for (var $art_isjpguiobn$art_i = 0, $art_cplxmzondsg$art_c = options.length; $art_isjpguiobn$art_i < $art_cplxmzondsg$art_c; $art_isjpguiobn$art_i++) {
        var option = options[$art_isjpguiobn$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
