...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifnmf$art_i = 0, $art_cbhrffn$art_c = options.length; $art_ifnmf$art_i < $art_cbhrffn$art_c; $art_ifnmf$art_i++) {    var option = options[$art_ifnmf$art_i]%>';
    for (var $art_ifnmf$art_i = 0, $art_cbhrffn$art_c = options.length; $art_ifnmf$art_i < $art_cbhrffn$art_c; $art_ifnmf$art_i++) {
        var option = options[$art_ifnmf$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
