...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuomwlxial$art_i = 0, $art_cjlceatqm$art_c = options.length; $art_iuomwlxial$art_i < $art_cjlceatqm$art_c; $art_iuomwlxial$art_i++) {    var option = options[$art_iuomwlxial$art_i]%>';
    for (var $art_iuomwlxial$art_i = 0, $art_cjlceatqm$art_c = options.length; $art_iuomwlxial$art_i < $art_cjlceatqm$art_c; $art_iuomwlxial$art_i++) {
        var option = options[$art_iuomwlxial$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
