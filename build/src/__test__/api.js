...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icgfvqgi$art_i = 0, $art_clowuzfr$art_c = options.length; $art_icgfvqgi$art_i < $art_clowuzfr$art_c; $art_icgfvqgi$art_i++) {    var option = options[$art_icgfvqgi$art_i]%>';
    for (var $art_icgfvqgi$art_i = 0, $art_clowuzfr$art_c = options.length; $art_icgfvqgi$art_i < $art_clowuzfr$art_c; $art_icgfvqgi$art_i++) {
        var option = options[$art_icgfvqgi$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
