...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuzgprebip$art_i = 0, $art_cmanhvtuyl$art_c = options.length; $art_iuzgprebip$art_i < $art_cmanhvtuyl$art_c; $art_iuzgprebip$art_i++) {    var option = options[$art_iuzgprebip$art_i]%>';
    for (var $art_iuzgprebip$art_i = 0, $art_cmanhvtuyl$art_c = options.length; $art_iuzgprebip$art_i < $art_cmanhvtuyl$art_c; $art_iuzgprebip$art_i++) {
        var option = options[$art_iuzgprebip$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
