...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilksaaxuc$art_i = 0, $art_cyxajni$art_c = options.length; $art_ilksaaxuc$art_i < $art_cyxajni$art_c; $art_ilksaaxuc$art_i++) {    var option = options[$art_ilksaaxuc$art_i]%>';
    for (var $art_ilksaaxuc$art_i = 0, $art_cyxajni$art_c = options.length; $art_ilksaaxuc$art_i < $art_cyxajni$art_c; $art_ilksaaxuc$art_i++) {
        var option = options[$art_ilksaaxuc$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
