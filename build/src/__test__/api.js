...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_idvmeovai$art_i = 0, $art_cjsymqfhl$art_c = options.length; $art_idvmeovai$art_i < $art_cjsymqfhl$art_c; $art_idvmeovai$art_i++) {    var option = options[$art_idvmeovai$art_i]%>';
    for (var $art_idvmeovai$art_i = 0, $art_cjsymqfhl$art_c = options.length; $art_idvmeovai$art_i < $art_cjsymqfhl$art_c; $art_idvmeovai$art_i++) {
        var option = options[$art_idvmeovai$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
