...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iztheaple$art_i = 0, $art_csudnuvsvn$art_c = options.length; $art_iztheaple$art_i < $art_csudnuvsvn$art_c; $art_iztheaple$art_i++) {    var option = options[$art_iztheaple$art_i]%>';
    for (var $art_iztheaple$art_i = 0, $art_csudnuvsvn$art_c = options.length; $art_iztheaple$art_i < $art_csudnuvsvn$art_c; $art_iztheaple$art_i++) {
        var option = options[$art_iztheaple$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
