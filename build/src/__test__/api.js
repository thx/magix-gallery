...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ifullhmnup$art_i=0;$art_ifullhmnup$art_i<options.length;$art_ifullhmnup$art_i++){var option=options[$art_ifullhmnup$art_i]%>';
    for (var $art_ifullhmnup$art_i = 0; $art_ifullhmnup$art_i < options.length; $art_ifullhmnup$art_i++) {
        var option = options[$art_ifullhmnup$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
