...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izkbwtvaj$art_i = 0, $art_ctpxnwscvq$art_c = options.length; $art_izkbwtvaj$art_i < $art_ctpxnwscvq$art_c; $art_izkbwtvaj$art_i++) {    var option = options[$art_izkbwtvaj$art_i]%>';
    for (var $art_izkbwtvaj$art_i = 0, $art_ctpxnwscvq$art_c = options.length; $art_izkbwtvaj$art_i < $art_ctpxnwscvq$art_c; $art_izkbwtvaj$art_i++) {
        var option = options[$art_izkbwtvaj$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
