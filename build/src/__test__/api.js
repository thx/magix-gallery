...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikucvrcn$art_i = 0, $art_cpnixezo$art_c = options.length; $art_ikucvrcn$art_i < $art_cpnixezo$art_c; $art_ikucvrcn$art_i++) {    var option = options[$art_ikucvrcn$art_i]%>';
    for (var $art_ikucvrcn$art_i = 0, $art_cpnixezo$art_c = options.length; $art_ikucvrcn$art_i < $art_cpnixezo$art_c; $art_ikucvrcn$art_i++) {
        var option = options[$art_ikucvrcn$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
