...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ishjho$art_i = 0, $art_cyydymds$art_c = options.length; $art_ishjho$art_i < $art_cyydymds$art_c; $art_ishjho$art_i++) {    var option = options[$art_ishjho$art_i]%>';
    for (var $art_ishjho$art_i = 0, $art_cyydymds$art_c = options.length; $art_ishjho$art_i < $art_cyydymds$art_c; $art_ishjho$art_i++) {
        var option = options[$art_ishjho$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
