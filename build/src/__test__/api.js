...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixtsjqskmt$art_i = 0, $art_cgukhuguoj$art_c = options.length; $art_ixtsjqskmt$art_i < $art_cgukhuguoj$art_c; $art_ixtsjqskmt$art_i++) {    var option = options[$art_ixtsjqskmt$art_i]%>';
    for (var $art_ixtsjqskmt$art_i = 0, $art_cgukhuguoj$art_c = options.length; $art_ixtsjqskmt$art_i < $art_cgukhuguoj$art_c; $art_ixtsjqskmt$art_i++) {
        var option = options[$art_ixtsjqskmt$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
