...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igqynj$art_i = 0, $art_ctwbqkis$art_c = options.length; $art_igqynj$art_i < $art_ctwbqkis$art_c; $art_igqynj$art_i++) {    var option = options[$art_igqynj$art_i]%>';
    for (var $art_igqynj$art_i = 0, $art_ctwbqkis$art_c = options.length; $art_igqynj$art_i < $art_ctwbqkis$art_c; $art_igqynj$art_i++) {
        var option = options[$art_igqynj$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
