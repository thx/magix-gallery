...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izteddanl$art_i = 0, $art_cwpnmcyksi$art_c = options.length; $art_izteddanl$art_i < $art_cwpnmcyksi$art_c; $art_izteddanl$art_i++) {    var option = options[$art_izteddanl$art_i]%>';
    for (var $art_izteddanl$art_i = 0, $art_cwpnmcyksi$art_c = options.length; $art_izteddanl$art_i < $art_cwpnmcyksi$art_c; $art_izteddanl$art_i++) {
        var option = options[$art_izteddanl$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
