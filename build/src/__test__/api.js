...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibbudmgdkl$art_i = 0, $art_cyvxwrydl$art_c = options.length; $art_ibbudmgdkl$art_i < $art_cyvxwrydl$art_c; $art_ibbudmgdkl$art_i++) {    var option = options[$art_ibbudmgdkl$art_i]%>';
    for (var $art_ibbudmgdkl$art_i = 0, $art_cyvxwrydl$art_c = options.length; $art_ibbudmgdkl$art_i < $art_cyvxwrydl$art_c; $art_ibbudmgdkl$art_i++) {
        var option = options[$art_ibbudmgdkl$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
