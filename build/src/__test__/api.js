...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixndvmkrhny$art_i = 0, $art_cudyszimcg$art_c = options.length; $art_ixndvmkrhny$art_i < $art_cudyszimcg$art_c; $art_ixndvmkrhny$art_i++) {    var option = options[$art_ixndvmkrhny$art_i]%>';
    for (var $art_ixndvmkrhny$art_i = 0, $art_cudyszimcg$art_c = options.length; $art_ixndvmkrhny$art_i < $art_cudyszimcg$art_c; $art_ixndvmkrhny$art_i++) {
        var option = options[$art_ixndvmkrhny$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
