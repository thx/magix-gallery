...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibvtztwjt$art_i = 0, $art_ccxqclcm$art_c = options.length; $art_ibvtztwjt$art_i < $art_ccxqclcm$art_c; $art_ibvtztwjt$art_i++) {    var option = options[$art_ibvtztwjt$art_i]%>';
    for (var $art_ibvtztwjt$art_i = 0, $art_ccxqclcm$art_c = options.length; $art_ibvtztwjt$art_i < $art_ccxqclcm$art_c; $art_ibvtztwjt$art_i++) {
        var option = options[$art_ibvtztwjt$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
