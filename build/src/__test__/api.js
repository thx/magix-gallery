...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibcpokyoi$art_i = 0, $art_causls$art_c = options.length; $art_ibcpokyoi$art_i < $art_causls$art_c; $art_ibcpokyoi$art_i++) {    var option = options[$art_ibcpokyoi$art_i]%>';
    for (var $art_ibcpokyoi$art_i = 0, $art_causls$art_c = options.length; $art_ibcpokyoi$art_i < $art_causls$art_c; $art_ibcpokyoi$art_i++) {
        var option = options[$art_ibcpokyoi$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
