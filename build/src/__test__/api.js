...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivqxenfto$art_i = 0, $art_cjmgnqs$art_c = options.length; $art_ivqxenfto$art_i < $art_cjmgnqs$art_c; $art_ivqxenfto$art_i++) {    var option = options[$art_ivqxenfto$art_i]%>';
    for (var $art_ivqxenfto$art_i = 0, $art_cjmgnqs$art_c = options.length; $art_ivqxenfto$art_i < $art_cjmgnqs$art_c; $art_ivqxenfto$art_i++) {
        var option = options[$art_ivqxenfto$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
