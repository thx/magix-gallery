...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icrcmelndhs$art_i = 0, $art_cwolghilv$art_c = options.length; $art_icrcmelndhs$art_i < $art_cwolghilv$art_c; $art_icrcmelndhs$art_i++) {    var option = options[$art_icrcmelndhs$art_i]%>';
    for (var $art_icrcmelndhs$art_i = 0, $art_cwolghilv$art_c = options.length; $art_icrcmelndhs$art_i < $art_cwolghilv$art_c; $art_icrcmelndhs$art_i++) {
        var option = options[$art_icrcmelndhs$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
