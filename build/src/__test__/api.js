...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irtnais$art_i = 0, $art_cgqjuc$art_c = options.length; $art_irtnais$art_i < $art_cgqjuc$art_c; $art_irtnais$art_i++) {    var option = options[$art_irtnais$art_i]%>';
    for (var $art_irtnais$art_i = 0, $art_cgqjuc$art_c = options.length; $art_irtnais$art_i < $art_cgqjuc$art_c; $art_irtnais$art_i++) {
        var option = options[$art_irtnais$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
