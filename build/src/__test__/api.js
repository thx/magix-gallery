...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_istqlzuvam$art_i = 0, $art_csaqbtq$art_c = options.length; $art_istqlzuvam$art_i < $art_csaqbtq$art_c; $art_istqlzuvam$art_i++) {    var option = options[$art_istqlzuvam$art_i]%>';
    for (var $art_istqlzuvam$art_i = 0, $art_csaqbtq$art_c = options.length; $art_istqlzuvam$art_i < $art_csaqbtq$art_c; $art_istqlzuvam$art_i++) {
        var option = options[$art_istqlzuvam$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
