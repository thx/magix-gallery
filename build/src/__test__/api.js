...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyrsqsbn$art_i = 0, $art_clkyblst$art_c = options.length; $art_iyrsqsbn$art_i < $art_clkyblst$art_c; $art_iyrsqsbn$art_i++) {    var option = options[$art_iyrsqsbn$art_i]%>';
    for (var $art_iyrsqsbn$art_i = 0, $art_clkyblst$art_c = options.length; $art_iyrsqsbn$art_i < $art_clkyblst$art_c; $art_iyrsqsbn$art_i++) {
        var option = options[$art_iyrsqsbn$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
