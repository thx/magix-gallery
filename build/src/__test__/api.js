...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izhzbybjsat$art_i = 0, $art_caaornhcv$art_c = options.length; $art_izhzbybjsat$art_i < $art_caaornhcv$art_c; $art_izhzbybjsat$art_i++) {    var option = options[$art_izhzbybjsat$art_i]%>';
    for (var $art_izhzbybjsat$art_i = 0, $art_caaornhcv$art_c = options.length; $art_izhzbybjsat$art_i < $art_caaornhcv$art_c; $art_izhzbybjsat$art_i++) {
        var option = options[$art_izhzbybjsat$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
