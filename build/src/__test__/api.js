...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaxymqksole$art_i = 0, $art_cmkultmns$art_c = options.length; $art_iaxymqksole$art_i < $art_cmkultmns$art_c; $art_iaxymqksole$art_i++) {    var option = options[$art_iaxymqksole$art_i]%>';
    for (var $art_iaxymqksole$art_i = 0, $art_cmkultmns$art_c = options.length; $art_iaxymqksole$art_i < $art_cmkultmns$art_c; $art_iaxymqksole$art_i++) {
        var option = options[$art_iaxymqksole$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
