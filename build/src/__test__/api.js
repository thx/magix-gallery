...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikpdspruvfm$art_i = 0, $art_caetwdrvq$art_c = options.length; $art_ikpdspruvfm$art_i < $art_caetwdrvq$art_c; $art_ikpdspruvfm$art_i++) {    var option = options[$art_ikpdspruvfm$art_i]%>';
    for (var $art_ikpdspruvfm$art_i = 0, $art_caetwdrvq$art_c = options.length; $art_ikpdspruvfm$art_i < $art_caetwdrvq$art_c; $art_ikpdspruvfm$art_i++) {
        var option = options[$art_ikpdspruvfm$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
