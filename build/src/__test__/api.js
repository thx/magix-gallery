...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izassfod$art_i = 0, $art_cjiqzthk$art_c = options.length; $art_izassfod$art_i < $art_cjiqzthk$art_c; $art_izassfod$art_i++) {    var option = options[$art_izassfod$art_i]%>';
    for (var $art_izassfod$art_i = 0, $art_cjiqzthk$art_c = options.length; $art_izassfod$art_i < $art_cjiqzthk$art_c; $art_izassfod$art_i++) {
        var option = options[$art_izassfod$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
