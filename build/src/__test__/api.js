...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifhrxe$art_i = 0, $art_ckwqxndwa$art_c = options.length; $art_ifhrxe$art_i < $art_ckwqxndwa$art_c; $art_ifhrxe$art_i++) {    var option = options[$art_ifhrxe$art_i]%>';
    for (var $art_ifhrxe$art_i = 0, $art_ckwqxndwa$art_c = options.length; $art_ifhrxe$art_i < $art_ckwqxndwa$art_c; $art_ifhrxe$art_i++) {
        var option = options[$art_ifhrxe$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
