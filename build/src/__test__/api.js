...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igmqkprovt$art_i = 0, $art_cjtijc$art_c = options.length; $art_igmqkprovt$art_i < $art_cjtijc$art_c; $art_igmqkprovt$art_i++) {    var option = options[$art_igmqkprovt$art_i]%>';
    for (var $art_igmqkprovt$art_i = 0, $art_cjtijc$art_c = options.length; $art_igmqkprovt$art_i < $art_cjtijc$art_c; $art_igmqkprovt$art_i++) {
        var option = options[$art_igmqkprovt$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
