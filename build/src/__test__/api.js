...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikulobidkx$art_i = 0, $art_cajprgu$art_c = options.length; $art_ikulobidkx$art_i < $art_cajprgu$art_c; $art_ikulobidkx$art_i++) {    var option = options[$art_ikulobidkx$art_i]%>';
    for (var $art_ikulobidkx$art_i = 0, $art_cajprgu$art_c = options.length; $art_ikulobidkx$art_i < $art_cajprgu$art_c; $art_ikulobidkx$art_i++) {
        var option = options[$art_ikulobidkx$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
