...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icducwjpgd$art_i = 0, $art_cnlpbosd$art_c = options.length; $art_icducwjpgd$art_i < $art_cnlpbosd$art_c; $art_icducwjpgd$art_i++) {    var option = options[$art_icducwjpgd$art_i]%>';
    for (var $art_icducwjpgd$art_i = 0, $art_cnlpbosd$art_c = options.length; $art_icducwjpgd$art_i < $art_cnlpbosd$art_c; $art_icducwjpgd$art_i++) {
        var option = options[$art_icducwjpgd$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
