...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izymjsvhmk$art_i = 0, $art_ccwqvgg$art_c = options.length; $art_izymjsvhmk$art_i < $art_ccwqvgg$art_c; $art_izymjsvhmk$art_i++) {    var option = options[$art_izymjsvhmk$art_i]%>';
    for (var $art_izymjsvhmk$art_i = 0, $art_ccwqvgg$art_c = options.length; $art_izymjsvhmk$art_i < $art_ccwqvgg$art_c; $art_izymjsvhmk$art_i++) {
        var option = options[$art_izymjsvhmk$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
