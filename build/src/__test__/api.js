...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iftmnjjhm$art_i = 0, $art_cixphefky$art_c = options.length; $art_iftmnjjhm$art_i < $art_cixphefky$art_c; $art_iftmnjjhm$art_i++) {    var option = options[$art_iftmnjjhm$art_i]%>';
    for (var $art_iftmnjjhm$art_i = 0, $art_cixphefky$art_c = options.length; $art_iftmnjjhm$art_i < $art_cixphefky$art_c; $art_iftmnjjhm$art_i++) {
        var option = options[$art_iftmnjjhm$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
