...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iglzmxoru$art_i = 0, $art_cqcqrxyyxd$art_c = options.length; $art_iglzmxoru$art_i < $art_cqcqrxyyxd$art_c; $art_iglzmxoru$art_i++) {    var option = options[$art_iglzmxoru$art_i]%>';
    for (var $art_iglzmxoru$art_i = 0, $art_cqcqrxyyxd$art_c = options.length; $art_iglzmxoru$art_i < $art_cqcqrxyyxd$art_c; $art_iglzmxoru$art_i++) {
        var option = options[$art_iglzmxoru$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
