...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilubcyqr$art_i = 0, $art_chanpjwta$art_c = options.length; $art_ilubcyqr$art_i < $art_chanpjwta$art_c; $art_ilubcyqr$art_i++) {    var option = options[$art_ilubcyqr$art_i]%>';
    for (var $art_ilubcyqr$art_i = 0, $art_chanpjwta$art_c = options.length; $art_ilubcyqr$art_i < $art_chanpjwta$art_c; $art_ilubcyqr$art_i++) {
        var option = options[$art_ilubcyqr$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
