...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icodpivvj$art_i = 0, $art_cizbctcdsih$art_c = options.length; $art_icodpivvj$art_i < $art_cizbctcdsih$art_c; $art_icodpivvj$art_i++) {    var option = options[$art_icodpivvj$art_i]%>';
    for (var $art_icodpivvj$art_i = 0, $art_cizbctcdsih$art_c = options.length; $art_icodpivvj$art_i < $art_cizbctcdsih$art_c; $art_icodpivvj$art_i++) {
        var option = options[$art_icodpivvj$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
