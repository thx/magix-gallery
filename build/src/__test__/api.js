...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iyorhyxtc$art_i=0;$art_iyorhyxtc$art_i<options.length;$art_iyorhyxtc$art_i++){var option=options[$art_iyorhyxtc$art_i]%>';
    for (var $art_iyorhyxtc$art_i = 0; $art_iyorhyxtc$art_i < options.length; $art_iyorhyxtc$art_i++) {
        var option = options[$art_iyorhyxtc$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
