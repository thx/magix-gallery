...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijuyhzgpxqva$art_i = 0, $art_cfryghvjk$art_c = options.length; $art_ijuyhzgpxqva$art_i < $art_cfryghvjk$art_c; $art_ijuyhzgpxqva$art_i++) {    var option = options[$art_ijuyhzgpxqva$art_i]%>';
    for (var $art_ijuyhzgpxqva$art_i = 0, $art_cfryghvjk$art_c = options.length; $art_ijuyhzgpxqva$art_i < $art_cfryghvjk$art_c; $art_ijuyhzgpxqva$art_i++) {
        var option = options[$art_ijuyhzgpxqva$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
