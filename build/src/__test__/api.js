...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuyatbbrr$art_i = 0, $art_casxxjstpt$art_c = options.length; $art_iuyatbbrr$art_i < $art_casxxjstpt$art_c; $art_iuyatbbrr$art_i++) {    var option = options[$art_iuyatbbrr$art_i]%>';
    for (var $art_iuyatbbrr$art_i = 0, $art_casxxjstpt$art_c = options.length; $art_iuyatbbrr$art_i < $art_casxxjstpt$art_c; $art_iuyatbbrr$art_i++) {
        var option = options[$art_iuyatbbrr$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
