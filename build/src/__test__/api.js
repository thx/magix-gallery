...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irhhj$art_i = 0, $art_ccqluxjsop$art_c = options.length; $art_irhhj$art_i < $art_ccqluxjsop$art_c; $art_irhhj$art_i++) {    var option = options[$art_irhhj$art_i]%>';
    for (var $art_irhhj$art_i = 0, $art_ccqluxjsop$art_c = options.length; $art_irhhj$art_i < $art_ccqluxjsop$art_c; $art_irhhj$art_i++) {
        var option = options[$art_irhhj$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
