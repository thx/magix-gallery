...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilte$art_i = 0, $art_cgddxxgk$art_c = options.length; $art_ilte$art_i < $art_cgddxxgk$art_c; $art_ilte$art_i++) {    var option = options[$art_ilte$art_i]%>';
    for (var $art_ilte$art_i = 0, $art_cgddxxgk$art_c = options.length; $art_ilte$art_i < $art_cgddxxgk$art_c; $art_ilte$art_i++) {
        var option = options[$art_ilte$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
