...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iflhsct$art_i=0;$art_iflhsct$art_i<options.length;$art_iflhsct$art_i++){var option=options[$art_iflhsct$art_i]%>';
    for (var $art_iflhsct$art_i = 0; $art_iflhsct$art_i < options.length; $art_iflhsct$art_i++) {
        var option = options[$art_iflhsct$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
