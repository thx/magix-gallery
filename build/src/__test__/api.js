...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibzuibjtzt$art_i = 0, $art_cnkskqzmwq$art_c = options.length; $art_ibzuibjtzt$art_i < $art_cnkskqzmwq$art_c; $art_ibzuibjtzt$art_i++) {    var option = options[$art_ibzuibjtzt$art_i]%>';
    for (var $art_ibzuibjtzt$art_i = 0, $art_cnkskqzmwq$art_c = options.length; $art_ibzuibjtzt$art_i < $art_cnkskqzmwq$art_c; $art_ibzuibjtzt$art_i++) {
        var option = options[$art_ibzuibjtzt$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
