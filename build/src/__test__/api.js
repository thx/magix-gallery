...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iphrsoopa$art_i = 0, $art_cqveuarvuyq$art_c = options.length; $art_iphrsoopa$art_i < $art_cqveuarvuyq$art_c; $art_iphrsoopa$art_i++) {    var option = options[$art_iphrsoopa$art_i]%>';
    for (var $art_iphrsoopa$art_i = 0, $art_cqveuarvuyq$art_c = options.length; $art_iphrsoopa$art_i < $art_cqveuarvuyq$art_c; $art_iphrsoopa$art_i++) {
        var option = options[$art_iphrsoopa$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
