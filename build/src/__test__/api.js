...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inzkehs$art_i = 0, $art_cbqbfj$art_c = options.length; $art_inzkehs$art_i < $art_cbqbfj$art_c; $art_inzkehs$art_i++) {    var option = options[$art_inzkehs$art_i]%>';
    for (var $art_inzkehs$art_i = 0, $art_cbqbfj$art_c = options.length; $art_inzkehs$art_i < $art_cbqbfj$art_c; $art_inzkehs$art_i++) {
        var option = options[$art_inzkehs$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
