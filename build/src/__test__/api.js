...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipthqwrc$art_i = 0, $art_cxmmdaclb$art_c = options.length; $art_ipthqwrc$art_i < $art_cxmmdaclb$art_c; $art_ipthqwrc$art_i++) {    var option = options[$art_ipthqwrc$art_i]%>';
    for (var $art_ipthqwrc$art_i = 0, $art_cxmmdaclb$art_c = options.length; $art_ipthqwrc$art_i < $art_cxmmdaclb$art_c; $art_ipthqwrc$art_i++) {
        var option = options[$art_ipthqwrc$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
