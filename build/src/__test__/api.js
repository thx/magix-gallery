...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iacidwak$art_i = 0, $art_cnmlogrl$art_c = options.length; $art_iacidwak$art_i < $art_cnmlogrl$art_c; $art_iacidwak$art_i++) {    var option = options[$art_iacidwak$art_i]%>';
    for (var $art_iacidwak$art_i = 0, $art_cnmlogrl$art_c = options.length; $art_iacidwak$art_i < $art_cnmlogrl$art_c; $art_iacidwak$art_i++) {
        var option = options[$art_iacidwak$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
