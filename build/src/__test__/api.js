...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_innmjqwwj$art_i = 0, $art_ceawechdr$art_c = options.length; $art_innmjqwwj$art_i < $art_ceawechdr$art_c; $art_innmjqwwj$art_i++) {    var option = options[$art_innmjqwwj$art_i]%>';
    for (var $art_innmjqwwj$art_i = 0, $art_ceawechdr$art_c = options.length; $art_innmjqwwj$art_i < $art_ceawechdr$art_c; $art_innmjqwwj$art_i++) {
        var option = options[$art_innmjqwwj$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
