...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ialrhoxvo$art_i = 0, $art_cnlpvyhlfre$art_c = options.length; $art_ialrhoxvo$art_i < $art_cnlpvyhlfre$art_c; $art_ialrhoxvo$art_i++) {    var option = options[$art_ialrhoxvo$art_i]%>';
    for (var $art_ialrhoxvo$art_i = 0, $art_cnlpvyhlfre$art_c = options.length; $art_ialrhoxvo$art_i < $art_cnlpvyhlfre$art_c; $art_ialrhoxvo$art_i++) {
        var option = options[$art_ialrhoxvo$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
