...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ieaqznplys$art_i = 0, $art_cqroxfbrr$art_c = options.length; $art_ieaqznplys$art_i < $art_cqroxfbrr$art_c; $art_ieaqznplys$art_i++) {    var option = options[$art_ieaqznplys$art_i]%>';
    for (var $art_ieaqznplys$art_i = 0, $art_cqroxfbrr$art_c = options.length; $art_ieaqznplys$art_i < $art_cqroxfbrr$art_c; $art_ieaqznplys$art_i++) {
        var option = options[$art_ieaqznplys$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
