...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iymhzwvz$art_i = 0, $art_cjcrnthtb$art_c = options.length; $art_iymhzwvz$art_i < $art_cjcrnthtb$art_c; $art_iymhzwvz$art_i++) {    var option = options[$art_iymhzwvz$art_i]%>';
    for (var $art_iymhzwvz$art_i = 0, $art_cjcrnthtb$art_c = options.length; $art_iymhzwvz$art_i < $art_cjcrnthtb$art_c; $art_iymhzwvz$art_i++) {
        var option = options[$art_iymhzwvz$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
