...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifkdetki$art_i = 0, $art_coxfyodwl$art_c = options.length; $art_ifkdetki$art_i < $art_coxfyodwl$art_c; $art_ifkdetki$art_i++) {    var option = options[$art_ifkdetki$art_i]%>';
    for (var $art_ifkdetki$art_i = 0, $art_coxfyodwl$art_c = options.length; $art_ifkdetki$art_i < $art_coxfyodwl$art_c; $art_ifkdetki$art_i++) {
        var option = options[$art_ifkdetki$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
