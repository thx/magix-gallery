...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivmuursa$art_i = 0, $art_cbyfxxlx$art_c = options.length; $art_ivmuursa$art_i < $art_cbyfxxlx$art_c; $art_ivmuursa$art_i++) {    var option = options[$art_ivmuursa$art_i]%>';
    for (var $art_ivmuursa$art_i = 0, $art_cbyfxxlx$art_c = options.length; $art_ivmuursa$art_i < $art_cbyfxxlx$art_c; $art_ivmuursa$art_i++) {
        var option = options[$art_ivmuursa$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
