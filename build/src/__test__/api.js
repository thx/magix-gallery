...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inxpxjoq$art_i = 0, $art_ciuizhxr$art_c = options.length; $art_inxpxjoq$art_i < $art_ciuizhxr$art_c; $art_inxpxjoq$art_i++) {    var option = options[$art_inxpxjoq$art_i]%>';
    for (var $art_inxpxjoq$art_i = 0, $art_ciuizhxr$art_c = options.length; $art_inxpxjoq$art_i < $art_ciuizhxr$art_c; $art_inxpxjoq$art_i++) {
        var option = options[$art_inxpxjoq$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
