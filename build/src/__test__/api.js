...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibrjmg$art_i = 0, $art_cigusgnl$art_c = options.length; $art_ibrjmg$art_i < $art_cigusgnl$art_c; $art_ibrjmg$art_i++) {    var option = options[$art_ibrjmg$art_i]%>';
    for (var $art_ibrjmg$art_i = 0, $art_cigusgnl$art_c = options.length; $art_ibrjmg$art_i < $art_cigusgnl$art_c; $art_ibrjmg$art_i++) {
        var option = options[$art_ibrjmg$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
