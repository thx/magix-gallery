...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iurzoqg$art_i = 0, $art_cedmjstgmt$art_c = options.length; $art_iurzoqg$art_i < $art_cedmjstgmt$art_c; $art_iurzoqg$art_i++) {    var option = options[$art_iurzoqg$art_i]%>';
    for (var $art_iurzoqg$art_i = 0, $art_cedmjstgmt$art_c = options.length; $art_iurzoqg$art_i < $art_cedmjstgmt$art_c; $art_iurzoqg$art_i++) {
        var option = options[$art_iurzoqg$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
