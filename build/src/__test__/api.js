...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivluxgcsd$art_i = 0, $art_clxaffkox$art_c = options.length; $art_ivluxgcsd$art_i < $art_clxaffkox$art_c; $art_ivluxgcsd$art_i++) {    var option = options[$art_ivluxgcsd$art_i]%>';
    for (var $art_ivluxgcsd$art_i = 0, $art_clxaffkox$art_c = options.length; $art_ivluxgcsd$art_i < $art_clxaffkox$art_c; $art_ivluxgcsd$art_i++) {
        var option = options[$art_ivluxgcsd$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
