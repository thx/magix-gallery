...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iahjqkkvhq$art_i = 0, $art_coiepkzmiq$art_c = options.length; $art_iahjqkkvhq$art_i < $art_coiepkzmiq$art_c; $art_iahjqkkvhq$art_i++) {    var option = options[$art_iahjqkkvhq$art_i]%>';
    for (var $art_iahjqkkvhq$art_i = 0, $art_coiepkzmiq$art_c = options.length; $art_iahjqkkvhq$art_i < $art_coiepkzmiq$art_c; $art_iahjqkkvhq$art_i++) {
        var option = options[$art_iahjqkkvhq$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
