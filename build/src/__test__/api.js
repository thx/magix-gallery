...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijhubhqy$art_i = 0, $art_cwamaaw$art_c = options.length; $art_ijhubhqy$art_i < $art_cwamaaw$art_c; $art_ijhubhqy$art_i++) {    var option = options[$art_ijhubhqy$art_i]%>';
    for (var $art_ijhubhqy$art_i = 0, $art_cwamaaw$art_c = options.length; $art_ijhubhqy$art_i < $art_cwamaaw$art_c; $art_ijhubhqy$art_i++) {
        var option = options[$art_ijhubhqy$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
