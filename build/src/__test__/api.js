...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irroihtol$art_i = 0, $art_csuuwnkukj$art_c = options.length; $art_irroihtol$art_i < $art_csuuwnkukj$art_c; $art_irroihtol$art_i++) {    var option = options[$art_irroihtol$art_i]%>';
    for (var $art_irroihtol$art_i = 0, $art_csuuwnkukj$art_c = options.length; $art_irroihtol$art_i < $art_csuuwnkukj$art_c; $art_irroihtol$art_i++) {
        var option = options[$art_irroihtol$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
