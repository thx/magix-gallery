...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikkfllbjvj$art_i = 0, $art_cujmydwe$art_c = options.length; $art_ikkfllbjvj$art_i < $art_cujmydwe$art_c; $art_ikkfllbjvj$art_i++) {    var option = options[$art_ikkfllbjvj$art_i]%>';
    for (var $art_ikkfllbjvj$art_i = 0, $art_cujmydwe$art_c = options.length; $art_ikkfllbjvj$art_i < $art_cujmydwe$art_c; $art_ikkfllbjvj$art_i++) {
        var option = options[$art_ikkfllbjvj$art_i];
        $p += '<tr><td>';
        $line = 14;
        $art = '=option.key';
        ;
