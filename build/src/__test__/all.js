...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iactouqml$art_i=0;$art_iactouqml$art_i<list.length;$art_iactouqml$art_i++){var item=list[$art_iactouqml$art_i]%>';
    for (var $art_iactouqml$art_i = 0; $art_iactouqml$art_i < list.length; $art_iactouqml$art_i++) {
        var item = list[$art_iactouqml$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_imgyuza$art_i=0,$art_objlqcnhs$art_obj=item.subs;$art_imgyuza$art_i<$art_objlqcnhs$art_obj.length;$art_imgyuza$art_i++){var sub=$art_objlqcnhs$art_obj[$art_imgyuza$art_i]%>';
        for (var $art_imgyuza$art_i = 0, $art_objlqcnhs$art_obj = item.subs; $art_imgyuza$art_i < $art_objlqcnhs$art_obj.length; $art_imgyuza$art_i++) {
            var sub = $art_objlqcnhs$art_obj[$art_imgyuza$art_i];
