...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iplroqb$art_i = 0, $art_cjtptkij$art_c = list.length; $art_iplroqb$art_i < $art_cjtptkij$art_c; $art_iplroqb$art_i++) {    var item = list[$art_iplroqb$art_i]%>';
    for (var $art_iplroqb$art_i = 0, $art_cjtptkij$art_c = list.length; $art_iplroqb$art_i < $art_cjtptkij$art_c; $art_iplroqb$art_i++) {
        var item = list[$art_iplroqb$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_itfgjsbgbqfm$art_i = 0, $art_objxwvr$art_obj = item.subs, $art_cmrbxbha$art_c = $art_objxwvr$art_obj.length; $art_itfgjsbgbqfm$art_i < $art_cmrbxbha$art_c; $art_itfgjsbgbqfm$art_i++) {        var sub = $art_objxwvr$art_obj[$art_itfgjsbgbqfm$art_i]%>';
        for (var $art_itfgjsbgbqfm$art_i = 0, $art_objxwvr$art_obj = item.subs, $art_cmrbxbha$art_c = $art_objxwvr$art_obj.length; $art_itfgjsbgbqfm$art_i < $art_cmrbxbha$art_c; $art_itfgjsbgbqfm$art_i++) {
            var sub = $art_objxwvr$art_obj[$art_itfgjsbgbqfm$art_i];
