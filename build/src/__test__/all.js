...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ijwdsfale$art_i = 0, $art_cdhergg$art_c = list.length; $art_ijwdsfale$art_i < $art_cdhergg$art_c; $art_ijwdsfale$art_i++) {    var item = list[$art_ijwdsfale$art_i]%>';
    for (var $art_ijwdsfale$art_i = 0, $art_cdhergg$art_c = list.length; $art_ijwdsfale$art_i < $art_cdhergg$art_c; $art_ijwdsfale$art_i++) {
        var item = list[$art_ijwdsfale$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_imdapjtlms$art_i = 0, $art_objcyqeztynnvw$art_obj = item.subs, $art_cxqnjwec$art_c = $art_objcyqeztynnvw$art_obj.length; $art_imdapjtlms$art_i < $art_cxqnjwec$art_c; $art_imdapjtlms$art_i++) {        var sub = $art_objcyqeztynnvw$art_obj[$art_imdapjtlms$art_i]%>';
        for (var $art_imdapjtlms$art_i = 0, $art_objcyqeztynnvw$art_obj = item.subs, $art_cxqnjwec$art_c = $art_objcyqeztynnvw$art_obj.length; $art_imdapjtlms$art_i < $art_cxqnjwec$art_c; $art_imdapjtlms$art_i++) {
            var sub = $art_objcyqeztynnvw$art_obj[$art_imdapjtlms$art_i];
