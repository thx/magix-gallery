...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_icymndxps$art_i=0;$art_icymndxps$art_i<list.length;$art_icymndxps$art_i++){var item=list[$art_icymndxps$art_i]%>';
    for (var $art_icymndxps$art_i = 0; $art_icymndxps$art_i < list.length; $art_icymndxps$art_i++) {
        var item = list[$art_icymndxps$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_iyidbozifx$art_i=0,$art_objzfxacbs$art_obj=item.subs;$art_iyidbozifx$art_i<$art_objzfxacbs$art_obj.length;$art_iyidbozifx$art_i++){var sub=$art_objzfxacbs$art_obj[$art_iyidbozifx$art_i]%>';
        for (var $art_iyidbozifx$art_i = 0, $art_objzfxacbs$art_obj = item.subs; $art_iyidbozifx$art_i < $art_objzfxacbs$art_obj.length; $art_iyidbozifx$art_i++) {
            var sub = $art_objzfxacbs$art_obj[$art_iyidbozifx$art_i];
