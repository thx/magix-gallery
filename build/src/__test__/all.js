...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iczioxojx$art_i=0;$art_iczioxojx$art_i<list.length;$art_iczioxojx$art_i++){var item=list[$art_iczioxojx$art_i]%>';
    for (var $art_iczioxojx$art_i = 0; $art_iczioxojx$art_i < list.length; $art_iczioxojx$art_i++) {
        var item = list[$art_iczioxojx$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ioyztbdjf$art_i=0,$art_objnjnri$art_obj=item.subs;$art_ioyztbdjf$art_i<$art_objnjnri$art_obj.length;$art_ioyztbdjf$art_i++){var sub=$art_objnjnri$art_obj[$art_ioyztbdjf$art_i]%>';
        for (var $art_ioyztbdjf$art_i = 0, $art_objnjnri$art_obj = item.subs; $art_ioyztbdjf$art_i < $art_objnjnri$art_obj.length; $art_ioyztbdjf$art_i++) {
            var sub = $art_objnjnri$art_obj[$art_ioyztbdjf$art_i];
