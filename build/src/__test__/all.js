...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallery_:_" class="_zs_gallery___test___all_-all"><div class="_zs_gallery___test___all_-left ';
    $line = 3;
    $art = 'if fixed';
    ;
    $p += '';
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iphucyyisg$art_i = 0, $art_cyioesdauwq$art_c = list.length; $art_iphucyyisg$art_i < $art_cyioesdauwq$art_c; $art_iphucyyisg$art_i++) {    var item = list[$art_iphucyyisg$art_i]%>';
    for (var $art_iphucyyisg$art_i = 0, $art_cyioesdauwq$art_c = list.length; $art_iphucyyisg$art_i < $art_cyioesdauwq$art_c; $art_iphucyyisg$art_i++) {
        var item = list[$art_iphucyyisg$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        if (item.name) {
            ...
            $art = '!item.name';
            ;
            $p += '' + ($expr = '<%!item.name%>', $n(item.name)) + '<i mxs="_zs_gallery_:_" class="mc-iconfont _zs_gallery___test___all_-title-icon">&#xe692;</i></span>';
            $line = 11;
            $art = '/if';
            ;
            $p += '';
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ihouwjbm$art_i = 0, $art_objxsqychfb$art_obj = item.subs, $art_cuiuxwjzpk$art_c = $art_objxsqychfb$art_obj.length; $art_ihouwjbm$art_i < $art_cuiuxwjzpk$art_c; $art_ihouwjbm$art_i++) {        var sub = $art_objxsqychfb$art_obj[$art_ihouwjbm$art_i]%>';
        for (var $art_ihouwjbm$art_i = 0, $art_objxsqychfb$art_obj = item.subs, $art_cuiuxwjzpk$art_c = $art_objxsqychfb$art_obj.length; $art_ihouwjbm$art_i < $art_cuiuxwjzpk$art_c; $art_ihouwjbm$art_i++) {
            var sub = $art_objxsqychfb$art_obj[$art_ihouwjbm$art_i];
            ...
            $art = '=sub.path';
            ;
            $p += '' + ($expr = '<%=sub.path%>', $e(sub.path)) + '"><i mxa="_zs_gallery_:a" class="mc-iconfont _zs_gallery___test___all_-sub-icon">';
            $line = 15;
            $art = '!sub.icon';
            ;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_gallery_:b" class="_zs_gallery___test___all_-main"><div mxv mxa="_zs_gallery_:c" class="_zs_gallery___test___all_-content"><div mxv="cur" ';
    $line = 24;
    $art = 'if cur.tip';
    ;
    $p += '';
    ...
    $art = '=view';
    ;
    $p += '' + ($expr = '<%=view%>', $e(view)) + '"><div mxs="_zs_gallery_:a" class="loading"><span class="loading-anim"></span></div></div></div><div mxa="_zs_gallery_:d" class="_zs_gallery___test___all_-contexts clearfix">';
    $line = 31;
    $art = 'if prev.path';
    ;
    $p += '';
    ...
    if (prev.path) {
        ...
        $art = '=prev.path';
        ;
        $p += '' + ($expr = '<%=prev.path%>', $e(prev.path)) + '" class="_zs_gallery___test___all_-prev link-brand"><i mxs="_zs_gallery_:b" class="mc-iconfont _zs_gallery___test___all_-context-icon">&#xe63a;</i>上一篇：';
        $line = 34;
        $art = '!prev.name';
        ;
    ...
    if (next.path) {
        ...
        $art = '=next.path';
        ;
        $p += '' + ($expr = '<%=next.path%>', $e(next.path)) + '" class="_zs_gallery___test___all_-next link-brand"><i mxs="_zs_gallery_:b" class="mc-iconfont _zs_gallery___test___all_-context-icon">&#xe63a;</i>下一篇：';
        $line = 40;
        $art = '!next.name';
        ;
