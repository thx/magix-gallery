...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_inxicfxce$art_i = 0, $art_cyyqiarjs$art_c = list.length; $art_inxicfxce$art_i < $art_cyyqiarjs$art_c; $art_inxicfxce$art_i++) {    var item = list[$art_inxicfxce$art_i]%>';
    for (var $art_inxicfxce$art_i = 0, $art_cyyqiarjs$art_c = list.length; $art_inxicfxce$art_i < $art_cyyqiarjs$art_c; $art_inxicfxce$art_i++) {
        var item = list[$art_inxicfxce$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_idmgjqvtys$art_i = 0, $art_objeobpldp$art_obj = item.subs, $art_cpntjvgpn$art_c = $art_objeobpldp$art_obj.length; $art_idmgjqvtys$art_i < $art_cpntjvgpn$art_c; $art_idmgjqvtys$art_i++) {        var sub = $art_objeobpldp$art_obj[$art_idmgjqvtys$art_i]%>';
        for (var $art_idmgjqvtys$art_i = 0, $art_objeobpldp$art_obj = item.subs, $art_cpntjvgpn$art_c = $art_objeobpldp$art_obj.length; $art_idmgjqvtys$art_i < $art_cpntjvgpn$art_c; $art_idmgjqvtys$art_i++) {
            var sub = $art_objeobpldp$art_obj[$art_idmgjqvtys$art_i];
