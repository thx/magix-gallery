...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iabsig$art_i=0;$art_iabsig$art_i<list.length;$art_iabsig$art_i++){var item=list[$art_iabsig$art_i]%>';
    for (var $art_iabsig$art_i = 0; $art_iabsig$art_i < list.length; $art_iabsig$art_i++) {
        var item = list[$art_iabsig$art_i];
        $p += ' ';
        $line = 5;
        $art = 'if item.name';
        ;
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_igexnqzfhhcd$art_i=0,$art_objdgrhudnlf$art_obj=item.subs;$art_igexnqzfhhcd$art_i<$art_objdgrhudnlf$art_obj.length;$art_igexnqzfhhcd$art_i++){var sub=$art_objdgrhudnlf$art_obj[$art_igexnqzfhhcd$art_i]%>';
        for (var $art_igexnqzfhhcd$art_i = 0, $art_objdgrhudnlf$art_obj = item.subs; $art_igexnqzfhhcd$art_i < $art_objdgrhudnlf$art_obj.length; $art_igexnqzfhhcd$art_i++) {
            var sub = $art_objdgrhudnlf$art_obj[$art_igexnqzfhhcd$art_i];
