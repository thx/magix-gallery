...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihkkukikp$art_i = 0, $art_csvyswigkr$art_c = list.length; $art_ihkkukikp$art_i < $art_csvyswigkr$art_c; $art_ihkkukikp$art_i++) {    var item = list[$art_ihkkukikp$art_i]%>';
    for (var $art_ihkkukikp$art_i = 0, $art_csvyswigkr$art_c = list.length; $art_ihkkukikp$art_i < $art_csvyswigkr$art_c; $art_ihkkukikp$art_i++) {
        var item = list[$art_ihkkukikp$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ifmaqjzaa$art_i = 0, $art_objpnymmildj$art_obj = item.subs, $art_cskkugvfqnh$art_c = $art_objpnymmildj$art_obj.length; $art_ifmaqjzaa$art_i < $art_cskkugvfqnh$art_c; $art_ifmaqjzaa$art_i++) {            var sub = $art_objpnymmildj$art_obj[$art_ifmaqjzaa$art_i]%>';
            for (var $art_ifmaqjzaa$art_i = 0, $art_objpnymmildj$art_obj = item.subs, $art_cskkugvfqnh$art_c = $art_objpnymmildj$art_obj.length; $art_ifmaqjzaa$art_i < $art_cskkugvfqnh$art_c; $art_ifmaqjzaa$art_i++) {
                var sub = $art_objpnymmildj$art_obj[$art_ifmaqjzaa$art_i];
