...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_itvnvbbhwn$art_i = 0, $art_cnqaxhbktl$art_c = list.length; $art_itvnvbbhwn$art_i < $art_cnqaxhbktl$art_c; $art_itvnvbbhwn$art_i++) {    var item = list[$art_itvnvbbhwn$art_i]%>';
    for (var $art_itvnvbbhwn$art_i = 0, $art_cnqaxhbktl$art_c = list.length; $art_itvnvbbhwn$art_i < $art_cnqaxhbktl$art_c; $art_itvnvbbhwn$art_i++) {
        var item = list[$art_itvnvbbhwn$art_i];
