...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifrdwcdhvt$art_i = 0, $art_cmwnjlb$art_c = list.length; $art_ifrdwcdhvt$art_i < $art_cmwnjlb$art_c; $art_ifrdwcdhvt$art_i++) {    var item = list[$art_ifrdwcdhvt$art_i]%>';
    for (var $art_ifrdwcdhvt$art_i = 0, $art_cmwnjlb$art_c = list.length; $art_ifrdwcdhvt$art_i < $art_cmwnjlb$art_c; $art_ifrdwcdhvt$art_i++) {
        var item = list[$art_ifrdwcdhvt$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_idfzkviiamq$art_i = 0, $art_objpuefinpo$art_obj = item.subs, $art_ckqmcz$art_c = $art_objpuefinpo$art_obj.length; $art_idfzkviiamq$art_i < $art_ckqmcz$art_c; $art_idfzkviiamq$art_i++) {            var sub = $art_objpuefinpo$art_obj[$art_idfzkviiamq$art_i]%>';
            for (var $art_idfzkviiamq$art_i = 0, $art_objpuefinpo$art_obj = item.subs, $art_ckqmcz$art_c = $art_objpuefinpo$art_obj.length; $art_idfzkviiamq$art_i < $art_ckqmcz$art_c; $art_idfzkviiamq$art_i++) {
                var sub = $art_objpuefinpo$art_obj[$art_idfzkviiamq$art_i];
