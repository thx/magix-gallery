...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irgklkel$art_i = 0, $art_ckjfuxj$art_c = list.length; $art_irgklkel$art_i < $art_ckjfuxj$art_c; $art_irgklkel$art_i++) {    var item = list[$art_irgklkel$art_i]%>';
    for (var $art_irgklkel$art_i = 0, $art_ckjfuxj$art_c = list.length; $art_irgklkel$art_i < $art_ckjfuxj$art_c; $art_irgklkel$art_i++) {
        var item = list[$art_irgklkel$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_irwwqfvlvs$art_i = 0, $art_objvomouf$art_obj = item.subs, $art_ctbhshp$art_c = $art_objvomouf$art_obj.length; $art_irwwqfvlvs$art_i < $art_ctbhshp$art_c; $art_irwwqfvlvs$art_i++) {            var sub = $art_objvomouf$art_obj[$art_irwwqfvlvs$art_i]%>';
            for (var $art_irwwqfvlvs$art_i = 0, $art_objvomouf$art_obj = item.subs, $art_ctbhshp$art_c = $art_objvomouf$art_obj.length; $art_irwwqfvlvs$art_i < $art_ctbhshp$art_c; $art_irwwqfvlvs$art_i++) {
                var sub = $art_objvomouf$art_obj[$art_irwwqfvlvs$art_i];
