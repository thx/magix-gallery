...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icringzna$art_i = 0, $art_cnztewc$art_c = list.length; $art_icringzna$art_i < $art_cnztewc$art_c; $art_icringzna$art_i++) {    var item = list[$art_icringzna$art_i]%>';
    for (var $art_icringzna$art_i = 0, $art_cnztewc$art_c = list.length; $art_icringzna$art_i < $art_cnztewc$art_c; $art_icringzna$art_i++) {
        var item = list[$art_icringzna$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ivkxe$art_i = 0, $art_objrdjyasc$art_obj = item.subs, $art_cbcckend$art_c = $art_objrdjyasc$art_obj.length; $art_ivkxe$art_i < $art_cbcckend$art_c; $art_ivkxe$art_i++) {            var sub = $art_objrdjyasc$art_obj[$art_ivkxe$art_i]%>';
            for (var $art_ivkxe$art_i = 0, $art_objrdjyasc$art_obj = item.subs, $art_cbcckend$art_c = $art_objrdjyasc$art_obj.length; $art_ivkxe$art_i < $art_cbcckend$art_c; $art_ivkxe$art_i++) {
                var sub = $art_objrdjyasc$art_obj[$art_ivkxe$art_i];
