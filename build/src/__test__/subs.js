...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixyihxql$art_i = 0, $art_caaqpczbg$art_c = list.length; $art_ixyihxql$art_i < $art_caaqpczbg$art_c; $art_ixyihxql$art_i++) {    var item = list[$art_ixyihxql$art_i]%>';
    for (var $art_ixyihxql$art_i = 0, $art_caaqpczbg$art_c = list.length; $art_ixyihxql$art_i < $art_caaqpczbg$art_c; $art_ixyihxql$art_i++) {
        var item = list[$art_ixyihxql$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ipugotpzb$art_i = 0, $art_objugrmqtg$art_obj = item.subs, $art_cfcqalksd$art_c = $art_objugrmqtg$art_obj.length; $art_ipugotpzb$art_i < $art_cfcqalksd$art_c; $art_ipugotpzb$art_i++) {            var sub = $art_objugrmqtg$art_obj[$art_ipugotpzb$art_i]%>';
            for (var $art_ipugotpzb$art_i = 0, $art_objugrmqtg$art_obj = item.subs, $art_cfcqalksd$art_c = $art_objugrmqtg$art_obj.length; $art_ipugotpzb$art_i < $art_cfcqalksd$art_c; $art_ipugotpzb$art_i++) {
                var sub = $art_objugrmqtg$art_obj[$art_ipugotpzb$art_i];
