...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irzxrssf$art_i = 0, $art_cmterzzsg$art_c = list.length; $art_irzxrssf$art_i < $art_cmterzzsg$art_c; $art_irzxrssf$art_i++) {    var item = list[$art_irzxrssf$art_i]%>';
    for (var $art_irzxrssf$art_i = 0, $art_cmterzzsg$art_c = list.length; $art_irzxrssf$art_i < $art_cmterzzsg$art_c; $art_irzxrssf$art_i++) {
        var item = list[$art_irzxrssf$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ibypkcf$art_i = 0, $art_objweiblhn$art_obj = item.subs, $art_cxzskbwwr$art_c = $art_objweiblhn$art_obj.length; $art_ibypkcf$art_i < $art_cxzskbwwr$art_c; $art_ibypkcf$art_i++) {            var sub = $art_objweiblhn$art_obj[$art_ibypkcf$art_i]%>';
            for (var $art_ibypkcf$art_i = 0, $art_objweiblhn$art_obj = item.subs, $art_cxzskbwwr$art_c = $art_objweiblhn$art_obj.length; $art_ibypkcf$art_i < $art_cxzskbwwr$art_c; $art_ibypkcf$art_i++) {
                var sub = $art_objweiblhn$art_obj[$art_ibypkcf$art_i];
