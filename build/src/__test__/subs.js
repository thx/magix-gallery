...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibkohkdytpa$art_i = 0, $art_cxqcnnjnlk$art_c = list.length; $art_ibkohkdytpa$art_i < $art_cxqcnnjnlk$art_c; $art_ibkohkdytpa$art_i++) {    var item = list[$art_ibkohkdytpa$art_i]%>';
    for (var $art_ibkohkdytpa$art_i = 0, $art_cxqcnnjnlk$art_c = list.length; $art_ibkohkdytpa$art_i < $art_cxqcnnjnlk$art_c; $art_ibkohkdytpa$art_i++) {
        var item = list[$art_ibkohkdytpa$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_izrtwhtibss$art_i = 0, $art_objeancwdzf$art_obj = item.subs, $art_cmrhbayhn$art_c = $art_objeancwdzf$art_obj.length; $art_izrtwhtibss$art_i < $art_cmrhbayhn$art_c; $art_izrtwhtibss$art_i++) {            var sub = $art_objeancwdzf$art_obj[$art_izrtwhtibss$art_i]%>';
            for (var $art_izrtwhtibss$art_i = 0, $art_objeancwdzf$art_obj = item.subs, $art_cmrhbayhn$art_c = $art_objeancwdzf$art_obj.length; $art_izrtwhtibss$art_i < $art_cmrhbayhn$art_c; $art_izrtwhtibss$art_i++) {
                var sub = $art_objeancwdzf$art_obj[$art_izrtwhtibss$art_i];
