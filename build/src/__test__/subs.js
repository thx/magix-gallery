...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iumaphppc$art_i = 0, $art_cesstimg$art_c = list.length; $art_iumaphppc$art_i < $art_cesstimg$art_c; $art_iumaphppc$art_i++) {    var item = list[$art_iumaphppc$art_i]%>';
    for (var $art_iumaphppc$art_i = 0, $art_cesstimg$art_c = list.length; $art_iumaphppc$art_i < $art_cesstimg$art_c; $art_iumaphppc$art_i++) {
        var item = list[$art_iumaphppc$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_irwuthfcthd$art_i = 0, $art_objftastdyv$art_obj = item.subs, $art_cunrobe$art_c = $art_objftastdyv$art_obj.length; $art_irwuthfcthd$art_i < $art_cunrobe$art_c; $art_irwuthfcthd$art_i++) {            var sub = $art_objftastdyv$art_obj[$art_irwuthfcthd$art_i]%>';
            for (var $art_irwuthfcthd$art_i = 0, $art_objftastdyv$art_obj = item.subs, $art_cunrobe$art_c = $art_objftastdyv$art_obj.length; $art_irwuthfcthd$art_i < $art_cunrobe$art_c; $art_irwuthfcthd$art_i++) {
                var sub = $art_objftastdyv$art_obj[$art_irwuthfcthd$art_i];
