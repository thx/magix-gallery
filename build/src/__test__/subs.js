...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iujewxuj$art_i = 0, $art_cezcclht$art_c = list.length; $art_iujewxuj$art_i < $art_cezcclht$art_c; $art_iujewxuj$art_i++) {    var item = list[$art_iujewxuj$art_i]%>';
    for (var $art_iujewxuj$art_i = 0, $art_cezcclht$art_c = list.length; $art_iujewxuj$art_i < $art_cezcclht$art_c; $art_iujewxuj$art_i++) {
        var item = list[$art_iujewxuj$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iekyzbryhae$art_i = 0, $art_objtykaczpp$art_obj = item.subs, $art_cclucnuwl$art_c = $art_objtykaczpp$art_obj.length; $art_iekyzbryhae$art_i < $art_cclucnuwl$art_c; $art_iekyzbryhae$art_i++) {            var sub = $art_objtykaczpp$art_obj[$art_iekyzbryhae$art_i]%>';
            for (var $art_iekyzbryhae$art_i = 0, $art_objtykaczpp$art_obj = item.subs, $art_cclucnuwl$art_c = $art_objtykaczpp$art_obj.length; $art_iekyzbryhae$art_i < $art_cclucnuwl$art_c; $art_iekyzbryhae$art_i++) {
                var sub = $art_objtykaczpp$art_obj[$art_iekyzbryhae$art_i];
