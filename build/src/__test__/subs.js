...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipzulkgemn$art_i = 0, $art_clzcrnma$art_c = list.length; $art_ipzulkgemn$art_i < $art_clzcrnma$art_c; $art_ipzulkgemn$art_i++) {    var item = list[$art_ipzulkgemn$art_i]%>';
    for (var $art_ipzulkgemn$art_i = 0, $art_clzcrnma$art_c = list.length; $art_ipzulkgemn$art_i < $art_clzcrnma$art_c; $art_ipzulkgemn$art_i++) {
        var item = list[$art_ipzulkgemn$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_isdijenvw$art_i = 0, $art_objeixubibi$art_obj = item.subs, $art_cksndizrvf$art_c = $art_objeixubibi$art_obj.length; $art_isdijenvw$art_i < $art_cksndizrvf$art_c; $art_isdijenvw$art_i++) {            var sub = $art_objeixubibi$art_obj[$art_isdijenvw$art_i]%>';
            for (var $art_isdijenvw$art_i = 0, $art_objeixubibi$art_obj = item.subs, $art_cksndizrvf$art_c = $art_objeixubibi$art_obj.length; $art_isdijenvw$art_i < $art_cksndizrvf$art_c; $art_isdijenvw$art_i++) {
                var sub = $art_objeixubibi$art_obj[$art_isdijenvw$art_i];
