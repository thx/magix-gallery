...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipulogrtwi$art_i = 0, $art_ccumguacm$art_c = list.length; $art_ipulogrtwi$art_i < $art_ccumguacm$art_c; $art_ipulogrtwi$art_i++) {    var item = list[$art_ipulogrtwi$art_i]%>';
    for (var $art_ipulogrtwi$art_i = 0, $art_ccumguacm$art_c = list.length; $art_ipulogrtwi$art_i < $art_ccumguacm$art_c; $art_ipulogrtwi$art_i++) {
        var item = list[$art_ipulogrtwi$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ivrpoha$art_i = 0, $art_objfgiaqykic$art_obj = item.subs, $art_cprabqpzitq$art_c = $art_objfgiaqykic$art_obj.length; $art_ivrpoha$art_i < $art_cprabqpzitq$art_c; $art_ivrpoha$art_i++) {            var sub = $art_objfgiaqykic$art_obj[$art_ivrpoha$art_i]%>';
            for (var $art_ivrpoha$art_i = 0, $art_objfgiaqykic$art_obj = item.subs, $art_cprabqpzitq$art_c = $art_objfgiaqykic$art_obj.length; $art_ivrpoha$art_i < $art_cprabqpzitq$art_c; $art_ivrpoha$art_i++) {
                var sub = $art_objfgiaqykic$art_obj[$art_ivrpoha$art_i];
