...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iihjgot$art_i = 0, $art_cwjxvds$art_c = list.length; $art_iihjgot$art_i < $art_cwjxvds$art_c; $art_iihjgot$art_i++) {    var item = list[$art_iihjgot$art_i]%>';
    for (var $art_iihjgot$art_i = 0, $art_cwjxvds$art_c = list.length; $art_iihjgot$art_i < $art_cwjxvds$art_c; $art_iihjgot$art_i++) {
        var item = list[$art_iihjgot$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_iuzkossaq$art_i = 0, $art_objiylfbxfwl$art_obj = item.subs, $art_cbnzftnus$art_c = $art_objiylfbxfwl$art_obj.length; $art_iuzkossaq$art_i < $art_cbnzftnus$art_c; $art_iuzkossaq$art_i++) {            var sub = $art_objiylfbxfwl$art_obj[$art_iuzkossaq$art_i]%>';
            for (var $art_iuzkossaq$art_i = 0, $art_objiylfbxfwl$art_obj = item.subs, $art_cbnzftnus$art_c = $art_objiylfbxfwl$art_obj.length; $art_iuzkossaq$art_i < $art_cbnzftnus$art_c; $art_iuzkossaq$art_i++) {
                var sub = $art_objiylfbxfwl$art_obj[$art_iuzkossaq$art_i];
