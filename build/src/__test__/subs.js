...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilbgbee$art_i = 0, $art_cptmgpljd$art_c = list.length; $art_ilbgbee$art_i < $art_cptmgpljd$art_c; $art_ilbgbee$art_i++) {    var item = list[$art_ilbgbee$art_i]%>';
    for (var $art_ilbgbee$art_i = 0, $art_cptmgpljd$art_c = list.length; $art_ilbgbee$art_i < $art_cptmgpljd$art_c; $art_ilbgbee$art_i++) {
        var item = list[$art_ilbgbee$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_idvlyvycoc$art_i = 0, $art_objnhlbawt$art_obj = item.subs, $art_cdvqatmab$art_c = $art_objnhlbawt$art_obj.length; $art_idvlyvycoc$art_i < $art_cdvqatmab$art_c; $art_idvlyvycoc$art_i++) {            var sub = $art_objnhlbawt$art_obj[$art_idvlyvycoc$art_i]%>';
            for (var $art_idvlyvycoc$art_i = 0, $art_objnhlbawt$art_obj = item.subs, $art_cdvqatmab$art_c = $art_objnhlbawt$art_obj.length; $art_idvlyvycoc$art_i < $art_cdvqatmab$art_c; $art_idvlyvycoc$art_i++) {
                var sub = $art_objnhlbawt$art_obj[$art_idvlyvycoc$art_i];
