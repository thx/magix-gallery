...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imgyutuxz$art_i = 0, $art_ciftwfgrbwf$art_c = list.length; $art_imgyutuxz$art_i < $art_ciftwfgrbwf$art_c; $art_imgyutuxz$art_i++) {    var item = list[$art_imgyutuxz$art_i]%>';
    for (var $art_imgyutuxz$art_i = 0, $art_ciftwfgrbwf$art_c = list.length; $art_imgyutuxz$art_i < $art_ciftwfgrbwf$art_c; $art_imgyutuxz$art_i++) {
        var item = list[$art_imgyutuxz$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ihvbguzih$art_i = 0, $art_objbpmxqta$art_obj = item.subs, $art_cloysh$art_c = $art_objbpmxqta$art_obj.length; $art_ihvbguzih$art_i < $art_cloysh$art_c; $art_ihvbguzih$art_i++) {            var sub = $art_objbpmxqta$art_obj[$art_ihvbguzih$art_i]%>';
            for (var $art_ihvbguzih$art_i = 0, $art_objbpmxqta$art_obj = item.subs, $art_cloysh$art_c = $art_objbpmxqta$art_obj.length; $art_ihvbguzih$art_i < $art_cloysh$art_c; $art_ihvbguzih$art_i++) {
                var sub = $art_objbpmxqta$art_obj[$art_ihvbguzih$art_i];
