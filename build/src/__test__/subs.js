...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iipjqomyewk$art_i = 0, $art_cqtlnilob$art_c = list.length; $art_iipjqomyewk$art_i < $art_cqtlnilob$art_c; $art_iipjqomyewk$art_i++) {    var item = list[$art_iipjqomyewk$art_i]%>';
    for (var $art_iipjqomyewk$art_i = 0, $art_cqtlnilob$art_c = list.length; $art_iipjqomyewk$art_i < $art_cqtlnilob$art_c; $art_iipjqomyewk$art_i++) {
        var item = list[$art_iipjqomyewk$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ilcvgqmh$art_i = 0, $art_objwsdbezzbq$art_obj = item.subs, $art_cmqzgigeufq$art_c = $art_objwsdbezzbq$art_obj.length; $art_ilcvgqmh$art_i < $art_cmqzgigeufq$art_c; $art_ilcvgqmh$art_i++) {            var sub = $art_objwsdbezzbq$art_obj[$art_ilcvgqmh$art_i]%>';
            for (var $art_ilcvgqmh$art_i = 0, $art_objwsdbezzbq$art_obj = item.subs, $art_cmqzgigeufq$art_c = $art_objwsdbezzbq$art_obj.length; $art_ilcvgqmh$art_i < $art_cmqzgigeufq$art_c; $art_ilcvgqmh$art_i++) {
                var sub = $art_objwsdbezzbq$art_obj[$art_ilcvgqmh$art_i];
