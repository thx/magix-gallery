...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izsceozsbob$art_i = 0, $art_cmnqwhom$art_c = list.length; $art_izsceozsbob$art_i < $art_cmnqwhom$art_c; $art_izsceozsbob$art_i++) {    var item = list[$art_izsceozsbob$art_i]%>';
    for (var $art_izsceozsbob$art_i = 0, $art_cmnqwhom$art_c = list.length; $art_izsceozsbob$art_i < $art_cmnqwhom$art_c; $art_izsceozsbob$art_i++) {
        var item = list[$art_izsceozsbob$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ixfvsnxvbh$art_i = 0, $art_objcpdvplolfmw$art_obj = item.subs, $art_cpfqguvpj$art_c = $art_objcpdvplolfmw$art_obj.length; $art_ixfvsnxvbh$art_i < $art_cpfqguvpj$art_c; $art_ixfvsnxvbh$art_i++) {            var sub = $art_objcpdvplolfmw$art_obj[$art_ixfvsnxvbh$art_i]%>';
            for (var $art_ixfvsnxvbh$art_i = 0, $art_objcpdvplolfmw$art_obj = item.subs, $art_cpfqguvpj$art_c = $art_objcpdvplolfmw$art_obj.length; $art_ixfvsnxvbh$art_i < $art_cpfqguvpj$art_c; $art_ixfvsnxvbh$art_i++) {
                var sub = $art_objcpdvplolfmw$art_obj[$art_ixfvsnxvbh$art_i];
