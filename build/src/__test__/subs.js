...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itzszgpj$art_i = 0, $art_cnqixxoun$art_c = list.length; $art_itzszgpj$art_i < $art_cnqixxoun$art_c; $art_itzszgpj$art_i++) {    var item = list[$art_itzszgpj$art_i]%>';
    for (var $art_itzszgpj$art_i = 0, $art_cnqixxoun$art_c = list.length; $art_itzszgpj$art_i < $art_cnqixxoun$art_c; $art_itzszgpj$art_i++) {
        var item = list[$art_itzszgpj$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_iravgjjy$art_i = 0, $art_objbltglqxc$art_obj = item.subs, $art_cvmcaqdv$art_c = $art_objbltglqxc$art_obj.length; $art_iravgjjy$art_i < $art_cvmcaqdv$art_c; $art_iravgjjy$art_i++) {            var sub = $art_objbltglqxc$art_obj[$art_iravgjjy$art_i]%>';
            for (var $art_iravgjjy$art_i = 0, $art_objbltglqxc$art_obj = item.subs, $art_cvmcaqdv$art_c = $art_objbltglqxc$art_obj.length; $art_iravgjjy$art_i < $art_cvmcaqdv$art_c; $art_iravgjjy$art_i++) {
                var sub = $art_objbltglqxc$art_obj[$art_iravgjjy$art_i];
