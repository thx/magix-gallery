...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iellnbr$art_i = 0, $art_ctxjlejp$art_c = list.length; $art_iellnbr$art_i < $art_ctxjlejp$art_c; $art_iellnbr$art_i++) {    var item = list[$art_iellnbr$art_i]%>';
    for (var $art_iellnbr$art_i = 0, $art_ctxjlejp$art_c = list.length; $art_iellnbr$art_i < $art_ctxjlejp$art_c; $art_iellnbr$art_i++) {
        var item = list[$art_iellnbr$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ixfgbxrkpx$art_i = 0, $art_objzyaaugm$art_obj = item.subs, $art_cdjhrbsq$art_c = $art_objzyaaugm$art_obj.length; $art_ixfgbxrkpx$art_i < $art_cdjhrbsq$art_c; $art_ixfgbxrkpx$art_i++) {            var sub = $art_objzyaaugm$art_obj[$art_ixfgbxrkpx$art_i]%>';
            for (var $art_ixfgbxrkpx$art_i = 0, $art_objzyaaugm$art_obj = item.subs, $art_cdjhrbsq$art_c = $art_objzyaaugm$art_obj.length; $art_ixfgbxrkpx$art_i < $art_cdjhrbsq$art_c; $art_ixfgbxrkpx$art_i++) {
                var sub = $art_objzyaaugm$art_obj[$art_ixfgbxrkpx$art_i];
