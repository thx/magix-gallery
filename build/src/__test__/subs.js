...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwwaxh$art_i = 0, $art_cyszbwdymg$art_c = list.length; $art_iwwaxh$art_i < $art_cyszbwdymg$art_c; $art_iwwaxh$art_i++) {    var item = list[$art_iwwaxh$art_i]%>';
    for (var $art_iwwaxh$art_i = 0, $art_cyszbwdymg$art_c = list.length; $art_iwwaxh$art_i < $art_cyszbwdymg$art_c; $art_iwwaxh$art_i++) {
        var item = list[$art_iwwaxh$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_isqobegsr$art_i = 0, $art_objnjfqamryk$art_obj = item.subs, $art_cnmbxsen$art_c = $art_objnjfqamryk$art_obj.length; $art_isqobegsr$art_i < $art_cnmbxsen$art_c; $art_isqobegsr$art_i++) {            var sub = $art_objnjfqamryk$art_obj[$art_isqobegsr$art_i]%>';
            for (var $art_isqobegsr$art_i = 0, $art_objnjfqamryk$art_obj = item.subs, $art_cnmbxsen$art_c = $art_objnjfqamryk$art_obj.length; $art_isqobegsr$art_i < $art_cnmbxsen$art_c; $art_isqobegsr$art_i++) {
                var sub = $art_objnjfqamryk$art_obj[$art_isqobegsr$art_i];
