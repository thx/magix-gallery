...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixawjiltzgd$art_i = 0, $art_clfyuvbszl$art_c = list.length; $art_ixawjiltzgd$art_i < $art_clfyuvbszl$art_c; $art_ixawjiltzgd$art_i++) {    var item = list[$art_ixawjiltzgd$art_i]%>';
    for (var $art_ixawjiltzgd$art_i = 0, $art_clfyuvbszl$art_c = list.length; $art_ixawjiltzgd$art_i < $art_clfyuvbszl$art_c; $art_ixawjiltzgd$art_i++) {
        var item = list[$art_ixawjiltzgd$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_iubnkwyhpcq$art_i = 0, $art_objtkjxlxf$art_obj = item.subs, $art_ccztxutqq$art_c = $art_objtkjxlxf$art_obj.length; $art_iubnkwyhpcq$art_i < $art_ccztxutqq$art_c; $art_iubnkwyhpcq$art_i++) {            var sub = $art_objtkjxlxf$art_obj[$art_iubnkwyhpcq$art_i]%>';
            for (var $art_iubnkwyhpcq$art_i = 0, $art_objtkjxlxf$art_obj = item.subs, $art_ccztxutqq$art_c = $art_objtkjxlxf$art_obj.length; $art_iubnkwyhpcq$art_i < $art_ccztxutqq$art_c; $art_iubnkwyhpcq$art_i++) {
                var sub = $art_objtkjxlxf$art_obj[$art_iubnkwyhpcq$art_i];
