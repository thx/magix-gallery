...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifvniipif$art_i = 0, $art_csazidzbpqq$art_c = list.length; $art_ifvniipif$art_i < $art_csazidzbpqq$art_c; $art_ifvniipif$art_i++) {    var item = list[$art_ifvniipif$art_i]%>';
    for (var $art_ifvniipif$art_i = 0, $art_csazidzbpqq$art_c = list.length; $art_ifvniipif$art_i < $art_csazidzbpqq$art_c; $art_ifvniipif$art_i++) {
        var item = list[$art_ifvniipif$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ivzunbd$art_i = 0, $art_objoddwhfitco$art_obj = item.subs, $art_cjbnfmlfdv$art_c = $art_objoddwhfitco$art_obj.length; $art_ivzunbd$art_i < $art_cjbnfmlfdv$art_c; $art_ivzunbd$art_i++) {            var sub = $art_objoddwhfitco$art_obj[$art_ivzunbd$art_i]%>';
            for (var $art_ivzunbd$art_i = 0, $art_objoddwhfitco$art_obj = item.subs, $art_cjbnfmlfdv$art_c = $art_objoddwhfitco$art_obj.length; $art_ivzunbd$art_i < $art_cjbnfmlfdv$art_c; $art_ivzunbd$art_i++) {
                var sub = $art_objoddwhfitco$art_obj[$art_ivzunbd$art_i];
