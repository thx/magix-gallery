...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ingwkxxtyx$art_i = 0, $art_chjtslqwex$art_c = list.length; $art_ingwkxxtyx$art_i < $art_chjtslqwex$art_c; $art_ingwkxxtyx$art_i++) {    var item = list[$art_ingwkxxtyx$art_i]%>';
    for (var $art_ingwkxxtyx$art_i = 0, $art_chjtslqwex$art_c = list.length; $art_ingwkxxtyx$art_i < $art_chjtslqwex$art_c; $art_ingwkxxtyx$art_i++) {
        var item = list[$art_ingwkxxtyx$art_i];
        $p += '<div mxa="_zs_galleryL:_" class="_zs_gallery___test___subs_-sub-link"><a href="javascript:;" mx-click="' + $viewId + 'to({key:\'';
        $line = 4;
        $art = '=item.key';
        ;
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_iiiauyvui$art_i = 0, $art_objgfphhp$art_obj = item.subs, $art_cmvzyucexrb$art_c = $art_objgfphhp$art_obj.length; $art_iiiauyvui$art_i < $art_cmvzyucexrb$art_c; $art_iiiauyvui$art_i++) {            var sub = $art_objgfphhp$art_obj[$art_iiiauyvui$art_i]%>';
            for (var $art_iiiauyvui$art_i = 0, $art_objgfphhp$art_obj = item.subs, $art_cmvzyucexrb$art_c = $art_objgfphhp$art_obj.length; $art_iiiauyvui$art_i < $art_cmvzyucexrb$art_c; $art_iiiauyvui$art_i++) {
                var sub = $art_objgfphhp$art_obj[$art_iiiauyvui$art_i];
                $p += '<div mxa="_zs_galleryL:a" class="_zs_gallery___test___subs_-sub-link pl10"><a href="javascript:;" mx-click="' + $viewId + 'to({key:\'';
                $line = 9;
                $art = '=sub.key';
                ;
