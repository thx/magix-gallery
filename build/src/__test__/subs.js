...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikfeqf$art_i = 0, $art_ctzbnlg$art_c = list.length; $art_ikfeqf$art_i < $art_ctzbnlg$art_c; $art_ikfeqf$art_i++) {    var item = list[$art_ikfeqf$art_i]%>';
    for (var $art_ikfeqf$art_i = 0, $art_ctzbnlg$art_c = list.length; $art_ikfeqf$art_i < $art_ctzbnlg$art_c; $art_ikfeqf$art_i++) {
        var item = list[$art_ikfeqf$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ivyxstree$art_i = 0, $art_objtjzibnrep$art_obj = item.subs, $art_cmqxzkhcnp$art_c = $art_objtjzibnrep$art_obj.length; $art_ivyxstree$art_i < $art_cmqxzkhcnp$art_c; $art_ivyxstree$art_i++) {            var sub = $art_objtjzibnrep$art_obj[$art_ivyxstree$art_i]%>';
            for (var $art_ivyxstree$art_i = 0, $art_objtjzibnrep$art_obj = item.subs, $art_cmqxzkhcnp$art_c = $art_objtjzibnrep$art_obj.length; $art_ivyxstree$art_i < $art_cmqxzkhcnp$art_c; $art_ivyxstree$art_i++) {
                var sub = $art_objtjzibnrep$art_obj[$art_ivyxstree$art_i];
