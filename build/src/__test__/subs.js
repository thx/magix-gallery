...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iramqapv$art_i = 0, $art_cvbbitz$art_c = list.length; $art_iramqapv$art_i < $art_cvbbitz$art_c; $art_iramqapv$art_i++) {    var item = list[$art_iramqapv$art_i]%>';
    for (var $art_iramqapv$art_i = 0, $art_cvbbitz$art_c = list.length; $art_iramqapv$art_i < $art_cvbbitz$art_c; $art_iramqapv$art_i++) {
        var item = list[$art_iramqapv$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ixufcceel$art_i = 0, $art_objbmyccsmmj$art_obj = item.subs, $art_cldxriumosjp$art_c = $art_objbmyccsmmj$art_obj.length; $art_ixufcceel$art_i < $art_cldxriumosjp$art_c; $art_ixufcceel$art_i++) {            var sub = $art_objbmyccsmmj$art_obj[$art_ixufcceel$art_i]%>';
            for (var $art_ixufcceel$art_i = 0, $art_objbmyccsmmj$art_obj = item.subs, $art_cldxriumosjp$art_c = $art_objbmyccsmmj$art_obj.length; $art_ixufcceel$art_i < $art_cldxriumosjp$art_c; $art_ixufcceel$art_i++) {
                var sub = $art_objbmyccsmmj$art_obj[$art_ixufcceel$art_i];
