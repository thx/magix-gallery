...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irhxpqwbwb$art_i = 0, $art_cgzkyvoyjdn$art_c = list.length; $art_irhxpqwbwb$art_i < $art_cgzkyvoyjdn$art_c; $art_irhxpqwbwb$art_i++) {    var item = list[$art_irhxpqwbwb$art_i]%>';
    for (var $art_irhxpqwbwb$art_i = 0, $art_cgzkyvoyjdn$art_c = list.length; $art_irhxpqwbwb$art_i < $art_cgzkyvoyjdn$art_c; $art_irhxpqwbwb$art_i++) {
        var item = list[$art_irhxpqwbwb$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ixxnrgik$art_i = 0, $art_objxwkwlkyqk$art_obj = item.subs, $art_cgckxtzzjt$art_c = $art_objxwkwlkyqk$art_obj.length; $art_ixxnrgik$art_i < $art_cgckxtzzjt$art_c; $art_ixxnrgik$art_i++) {            var sub = $art_objxwkwlkyqk$art_obj[$art_ixxnrgik$art_i]%>';
            for (var $art_ixxnrgik$art_i = 0, $art_objxwkwlkyqk$art_obj = item.subs, $art_cgckxtzzjt$art_c = $art_objxwkwlkyqk$art_obj.length; $art_ixxnrgik$art_i < $art_cgckxtzzjt$art_c; $art_ixxnrgik$art_i++) {
                var sub = $art_objxwkwlkyqk$art_obj[$art_ixxnrgik$art_i];
