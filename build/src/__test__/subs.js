...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iybxtubanm$art_i = 0, $art_cparvdjrr$art_c = list.length; $art_iybxtubanm$art_i < $art_cparvdjrr$art_c; $art_iybxtubanm$art_i++) {    var item = list[$art_iybxtubanm$art_i]%>';
    for (var $art_iybxtubanm$art_i = 0, $art_cparvdjrr$art_c = list.length; $art_iybxtubanm$art_i < $art_cparvdjrr$art_c; $art_iybxtubanm$art_i++) {
        var item = list[$art_iybxtubanm$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ieqaixoneu$art_i = 0, $art_objorvhxxp$art_obj = item.subs, $art_clwze$art_c = $art_objorvhxxp$art_obj.length; $art_ieqaixoneu$art_i < $art_clwze$art_c; $art_ieqaixoneu$art_i++) {            var sub = $art_objorvhxxp$art_obj[$art_ieqaixoneu$art_i]%>';
            for (var $art_ieqaixoneu$art_i = 0, $art_objorvhxxp$art_obj = item.subs, $art_clwze$art_c = $art_objorvhxxp$art_obj.length; $art_ieqaixoneu$art_i < $art_clwze$art_c; $art_ieqaixoneu$art_i++) {
                var sub = $art_objorvhxxp$art_obj[$art_ieqaixoneu$art_i];
