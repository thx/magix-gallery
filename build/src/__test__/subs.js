...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isbdunrn$art_i = 0, $art_czoxipoojqr$art_c = list.length; $art_isbdunrn$art_i < $art_czoxipoojqr$art_c; $art_isbdunrn$art_i++) {    var item = list[$art_isbdunrn$art_i]%>';
    for (var $art_isbdunrn$art_i = 0, $art_czoxipoojqr$art_c = list.length; $art_isbdunrn$art_i < $art_czoxipoojqr$art_c; $art_isbdunrn$art_i++) {
        var item = list[$art_isbdunrn$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_itkqzjemctk$art_i = 0, $art_objqmhyuks$art_obj = item.subs, $art_cvdtleknidn$art_c = $art_objqmhyuks$art_obj.length; $art_itkqzjemctk$art_i < $art_cvdtleknidn$art_c; $art_itkqzjemctk$art_i++) {            var sub = $art_objqmhyuks$art_obj[$art_itkqzjemctk$art_i]%>';
            for (var $art_itkqzjemctk$art_i = 0, $art_objqmhyuks$art_obj = item.subs, $art_cvdtleknidn$art_c = $art_objqmhyuks$art_obj.length; $art_itkqzjemctk$art_i < $art_cvdtleknidn$art_c; $art_itkqzjemctk$art_i++) {
                var sub = $art_objqmhyuks$art_obj[$art_itkqzjemctk$art_i];
