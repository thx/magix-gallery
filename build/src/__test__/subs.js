...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyvutht$art_i = 0, $art_cyeaftwjxf$art_c = list.length; $art_iyvutht$art_i < $art_cyeaftwjxf$art_c; $art_iyvutht$art_i++) {    var item = list[$art_iyvutht$art_i]%>';
    for (var $art_iyvutht$art_i = 0, $art_cyeaftwjxf$art_c = list.length; $art_iyvutht$art_i < $art_cyeaftwjxf$art_c; $art_iyvutht$art_i++) {
        var item = list[$art_iyvutht$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_itslrugbm$art_i = 0, $art_objjusvjh$art_obj = item.subs, $art_cohmqkvawoc$art_c = $art_objjusvjh$art_obj.length; $art_itslrugbm$art_i < $art_cohmqkvawoc$art_c; $art_itslrugbm$art_i++) {            var sub = $art_objjusvjh$art_obj[$art_itslrugbm$art_i]%>';
            for (var $art_itslrugbm$art_i = 0, $art_objjusvjh$art_obj = item.subs, $art_cohmqkvawoc$art_c = $art_objjusvjh$art_obj.length; $art_itslrugbm$art_i < $art_cohmqkvawoc$art_c; $art_itslrugbm$art_i++) {
                var sub = $art_objjusvjh$art_obj[$art_itslrugbm$art_i];
