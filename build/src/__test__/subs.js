...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imzfxezue$art_i = 0, $art_cakrfghcjaq$art_c = list.length; $art_imzfxezue$art_i < $art_cakrfghcjaq$art_c; $art_imzfxezue$art_i++) {    var item = list[$art_imzfxezue$art_i]%>';
    for (var $art_imzfxezue$art_i = 0, $art_cakrfghcjaq$art_c = list.length; $art_imzfxezue$art_i < $art_cakrfghcjaq$art_c; $art_imzfxezue$art_i++) {
        var item = list[$art_imzfxezue$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ibnqfbqq$art_i = 0, $art_objodjrtfb$art_obj = item.subs, $art_cvnfixgxx$art_c = $art_objodjrtfb$art_obj.length; $art_ibnqfbqq$art_i < $art_cvnfixgxx$art_c; $art_ibnqfbqq$art_i++) {            var sub = $art_objodjrtfb$art_obj[$art_ibnqfbqq$art_i]%>';
            for (var $art_ibnqfbqq$art_i = 0, $art_objodjrtfb$art_obj = item.subs, $art_cvnfixgxx$art_c = $art_objodjrtfb$art_obj.length; $art_ibnqfbqq$art_i < $art_cvnfixgxx$art_c; $art_ibnqfbqq$art_i++) {
                var sub = $art_objodjrtfb$art_obj[$art_ibnqfbqq$art_i];
