...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izmjudzdf$art_i = 0, $art_ceiawn$art_c = list.length; $art_izmjudzdf$art_i < $art_ceiawn$art_c; $art_izmjudzdf$art_i++) {    var item = list[$art_izmjudzdf$art_i]%>';
    for (var $art_izmjudzdf$art_i = 0, $art_ceiawn$art_c = list.length; $art_izmjudzdf$art_i < $art_ceiawn$art_c; $art_izmjudzdf$art_i++) {
        var item = list[$art_izmjudzdf$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_icufmb$art_i = 0, $art_objeoguceckom$art_obj = item.subs, $art_cnpflakvi$art_c = $art_objeoguceckom$art_obj.length; $art_icufmb$art_i < $art_cnpflakvi$art_c; $art_icufmb$art_i++) {            var sub = $art_objeoguceckom$art_obj[$art_icufmb$art_i]%>';
            for (var $art_icufmb$art_i = 0, $art_objeoguceckom$art_obj = item.subs, $art_cnpflakvi$art_c = $art_objeoguceckom$art_obj.length; $art_icufmb$art_i < $art_cnpflakvi$art_c; $art_icufmb$art_i++) {
                var sub = $art_objeoguceckom$art_obj[$art_icufmb$art_i];
