...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irbkqjptk$art_i = 0, $art_cdxjuyhh$art_c = list.length; $art_irbkqjptk$art_i < $art_cdxjuyhh$art_c; $art_irbkqjptk$art_i++) {    var item = list[$art_irbkqjptk$art_i]%>';
    for (var $art_irbkqjptk$art_i = 0, $art_cdxjuyhh$art_c = list.length; $art_irbkqjptk$art_i < $art_cdxjuyhh$art_c; $art_irbkqjptk$art_i++) {
        var item = list[$art_irbkqjptk$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_igswfa$art_i = 0, $art_objxtwmwef$art_obj = item.subs, $art_csrsortyx$art_c = $art_objxtwmwef$art_obj.length; $art_igswfa$art_i < $art_csrsortyx$art_c; $art_igswfa$art_i++) {            var sub = $art_objxtwmwef$art_obj[$art_igswfa$art_i]%>';
            for (var $art_igswfa$art_i = 0, $art_objxtwmwef$art_obj = item.subs, $art_csrsortyx$art_c = $art_objxtwmwef$art_obj.length; $art_igswfa$art_i < $art_csrsortyx$art_c; $art_igswfa$art_i++) {
                var sub = $art_objxtwmwef$art_obj[$art_igswfa$art_i];
