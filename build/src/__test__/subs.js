...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iacdojz$art_i = 0, $art_cisjop$art_c = list.length; $art_iacdojz$art_i < $art_cisjop$art_c; $art_iacdojz$art_i++) {    var item = list[$art_iacdojz$art_i]%>';
    for (var $art_iacdojz$art_i = 0, $art_cisjop$art_c = list.length; $art_iacdojz$art_i < $art_cisjop$art_c; $art_iacdojz$art_i++) {
        var item = list[$art_iacdojz$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_izfdgtmukt$art_i = 0, $art_objkuqbhnzv$art_obj = item.subs, $art_cjyeekoo$art_c = $art_objkuqbhnzv$art_obj.length; $art_izfdgtmukt$art_i < $art_cjyeekoo$art_c; $art_izfdgtmukt$art_i++) {            var sub = $art_objkuqbhnzv$art_obj[$art_izfdgtmukt$art_i]%>';
            for (var $art_izfdgtmukt$art_i = 0, $art_objkuqbhnzv$art_obj = item.subs, $art_cjyeekoo$art_c = $art_objkuqbhnzv$art_obj.length; $art_izfdgtmukt$art_i < $art_cjyeekoo$art_c; $art_izfdgtmukt$art_i++) {
                var sub = $art_objkuqbhnzv$art_obj[$art_izfdgtmukt$art_i];
