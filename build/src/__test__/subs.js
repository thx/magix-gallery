...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijzzrrmgxb$art_i = 0, $art_cutsxpig$art_c = list.length; $art_ijzzrrmgxb$art_i < $art_cutsxpig$art_c; $art_ijzzrrmgxb$art_i++) {    var item = list[$art_ijzzrrmgxb$art_i]%>';
    for (var $art_ijzzrrmgxb$art_i = 0, $art_cutsxpig$art_c = list.length; $art_ijzzrrmgxb$art_i < $art_cutsxpig$art_c; $art_ijzzrrmgxb$art_i++) {
        var item = list[$art_ijzzrrmgxb$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_icuczc$art_i = 0, $art_objivglkxiq$art_obj = item.subs, $art_cyxfufxspn$art_c = $art_objivglkxiq$art_obj.length; $art_icuczc$art_i < $art_cyxfufxspn$art_c; $art_icuczc$art_i++) {            var sub = $art_objivglkxiq$art_obj[$art_icuczc$art_i]%>';
            for (var $art_icuczc$art_i = 0, $art_objivglkxiq$art_obj = item.subs, $art_cyxfufxspn$art_c = $art_objivglkxiq$art_obj.length; $art_icuczc$art_i < $art_cyxfufxspn$art_c; $art_icuczc$art_i++) {
                var sub = $art_objivglkxiq$art_obj[$art_icuczc$art_i];
