...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyolstshf$art_i = 0, $art_cqousxdnmc$art_c = list.length; $art_iyolstshf$art_i < $art_cqousxdnmc$art_c; $art_iyolstshf$art_i++) {    var item = list[$art_iyolstshf$art_i]%>';
    for (var $art_iyolstshf$art_i = 0, $art_cqousxdnmc$art_c = list.length; $art_iyolstshf$art_i < $art_cqousxdnmc$art_c; $art_iyolstshf$art_i++) {
        var item = list[$art_iyolstshf$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ilnaespdai$art_i = 0, $art_objqrbnrbklk$art_obj = item.subs, $art_cvibulasw$art_c = $art_objqrbnrbklk$art_obj.length; $art_ilnaespdai$art_i < $art_cvibulasw$art_c; $art_ilnaespdai$art_i++) {            var sub = $art_objqrbnrbklk$art_obj[$art_ilnaespdai$art_i]%>';
            for (var $art_ilnaespdai$art_i = 0, $art_objqrbnrbklk$art_obj = item.subs, $art_cvibulasw$art_c = $art_objqrbnrbklk$art_obj.length; $art_ilnaespdai$art_i < $art_cvibulasw$art_c; $art_ilnaespdai$art_i++) {
                var sub = $art_objqrbnrbklk$art_obj[$art_ilnaespdai$art_i];
