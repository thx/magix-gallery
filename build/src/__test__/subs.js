...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixqupcb$art_i = 0, $art_ckgsffuzpgm$art_c = list.length; $art_ixqupcb$art_i < $art_ckgsffuzpgm$art_c; $art_ixqupcb$art_i++) {    var item = list[$art_ixqupcb$art_i]%>';
    for (var $art_ixqupcb$art_i = 0, $art_ckgsffuzpgm$art_c = list.length; $art_ixqupcb$art_i < $art_ckgsffuzpgm$art_c; $art_ixqupcb$art_i++) {
        var item = list[$art_ixqupcb$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ivurdbwo$art_i = 0, $art_objeypmyr$art_obj = item.subs, $art_cusjcisx$art_c = $art_objeypmyr$art_obj.length; $art_ivurdbwo$art_i < $art_cusjcisx$art_c; $art_ivurdbwo$art_i++) {            var sub = $art_objeypmyr$art_obj[$art_ivurdbwo$art_i]%>';
            for (var $art_ivurdbwo$art_i = 0, $art_objeypmyr$art_obj = item.subs, $art_cusjcisx$art_c = $art_objeypmyr$art_obj.length; $art_ivurdbwo$art_i < $art_cusjcisx$art_c; $art_ivurdbwo$art_i++) {
                var sub = $art_objeypmyr$art_obj[$art_ivurdbwo$art_i];
