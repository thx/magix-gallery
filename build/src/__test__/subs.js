...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irnebdlbur$art_i = 0, $art_cnykntpyzgo$art_c = list.length; $art_irnebdlbur$art_i < $art_cnykntpyzgo$art_c; $art_irnebdlbur$art_i++) {    var item = list[$art_irnebdlbur$art_i]%>';
    for (var $art_irnebdlbur$art_i = 0, $art_cnykntpyzgo$art_c = list.length; $art_irnebdlbur$art_i < $art_cnykntpyzgo$art_c; $art_irnebdlbur$art_i++) {
        var item = list[$art_irnebdlbur$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_itjuomhyyk$art_i = 0, $art_objejsmxgik$art_obj = item.subs, $art_ccnkvcgjbdt$art_c = $art_objejsmxgik$art_obj.length; $art_itjuomhyyk$art_i < $art_ccnkvcgjbdt$art_c; $art_itjuomhyyk$art_i++) {            var sub = $art_objejsmxgik$art_obj[$art_itjuomhyyk$art_i]%>';
            for (var $art_itjuomhyyk$art_i = 0, $art_objejsmxgik$art_obj = item.subs, $art_ccnkvcgjbdt$art_c = $art_objejsmxgik$art_obj.length; $art_itjuomhyyk$art_i < $art_ccnkvcgjbdt$art_c; $art_itjuomhyyk$art_i++) {
                var sub = $art_objejsmxgik$art_obj[$art_itjuomhyyk$art_i];
