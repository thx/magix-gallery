...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itgnsdbpth$art_i = 0, $art_clyrqficfq$art_c = list.length; $art_itgnsdbpth$art_i < $art_clyrqficfq$art_c; $art_itgnsdbpth$art_i++) {    var item = list[$art_itgnsdbpth$art_i]%>';
    for (var $art_itgnsdbpth$art_i = 0, $art_clyrqficfq$art_c = list.length; $art_itgnsdbpth$art_i < $art_clyrqficfq$art_c; $art_itgnsdbpth$art_i++) {
        var item = list[$art_itgnsdbpth$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_idqficbegbj$art_i = 0, $art_objqvtwezws$art_obj = item.subs, $art_ccxcrgyou$art_c = $art_objqvtwezws$art_obj.length; $art_idqficbegbj$art_i < $art_ccxcrgyou$art_c; $art_idqficbegbj$art_i++) {            var sub = $art_objqvtwezws$art_obj[$art_idqficbegbj$art_i]%>';
            for (var $art_idqficbegbj$art_i = 0, $art_objqvtwezws$art_obj = item.subs, $art_ccxcrgyou$art_c = $art_objqvtwezws$art_obj.length; $art_idqficbegbj$art_i < $art_ccxcrgyou$art_c; $art_idqficbegbj$art_i++) {
                var sub = $art_objqvtwezws$art_obj[$art_idqficbegbj$art_i];
