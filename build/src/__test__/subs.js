...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifejhobq$art_i = 0, $art_czaqowpfkp$art_c = list.length; $art_ifejhobq$art_i < $art_czaqowpfkp$art_c; $art_ifejhobq$art_i++) {    var item = list[$art_ifejhobq$art_i]%>';
    for (var $art_ifejhobq$art_i = 0, $art_czaqowpfkp$art_c = list.length; $art_ifejhobq$art_i < $art_czaqowpfkp$art_c; $art_ifejhobq$art_i++) {
        var item = list[$art_ifejhobq$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_iggnugfjo$art_i = 0, $art_objxxbmvxg$art_obj = item.subs, $art_cqskalynlei$art_c = $art_objxxbmvxg$art_obj.length; $art_iggnugfjo$art_i < $art_cqskalynlei$art_c; $art_iggnugfjo$art_i++) {            var sub = $art_objxxbmvxg$art_obj[$art_iggnugfjo$art_i]%>';
            for (var $art_iggnugfjo$art_i = 0, $art_objxxbmvxg$art_obj = item.subs, $art_cqskalynlei$art_c = $art_objxxbmvxg$art_obj.length; $art_iggnugfjo$art_i < $art_cqskalynlei$art_c; $art_iggnugfjo$art_i++) {
                var sub = $art_objxxbmvxg$art_obj[$art_iggnugfjo$art_i];
