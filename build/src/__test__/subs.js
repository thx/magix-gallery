...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihpttpocdo$art_i = 0, $art_cvmwpdpmvj$art_c = list.length; $art_ihpttpocdo$art_i < $art_cvmwpdpmvj$art_c; $art_ihpttpocdo$art_i++) {    var item = list[$art_ihpttpocdo$art_i]%>';
    for (var $art_ihpttpocdo$art_i = 0, $art_cvmwpdpmvj$art_c = list.length; $art_ihpttpocdo$art_i < $art_cvmwpdpmvj$art_c; $art_ihpttpocdo$art_i++) {
        var item = list[$art_ihpttpocdo$art_i];
        ...
        if (item.subs && item.subs.length) {
            ...
            ;
            $expr = '<%for (var $art_ijihmxe$art_i = 0, $art_objhbtapwbqze$art_obj = item.subs, $art_chzdawiwli$art_c = $art_objhbtapwbqze$art_obj.length; $art_ijihmxe$art_i < $art_chzdawiwli$art_c; $art_ijihmxe$art_i++) {            var sub = $art_objhbtapwbqze$art_obj[$art_ijihmxe$art_i]%>';
            for (var $art_ijihmxe$art_i = 0, $art_objhbtapwbqze$art_obj = item.subs, $art_chzdawiwli$art_c = $art_objhbtapwbqze$art_obj.length; $art_ijihmxe$art_i < $art_chzdawiwli$art_c; $art_ijihmxe$art_i++) {
                var sub = $art_objhbtapwbqze$art_obj[$art_ijihmxe$art_i];
