...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irpthmcbi$art_i = 0, $art_cekaak$art_c = checkboxes.length; $art_irpthmcbi$art_i < $art_cekaak$art_c; $art_irpthmcbi$art_i++) {    var c = checkboxes[$art_irpthmcbi$art_i]%>';
    for (var $art_irpthmcbi$art_i = 0, $art_cekaak$art_c = checkboxes.length; $art_irpthmcbi$art_i < $art_cekaak$art_c; $art_irpthmcbi$art_i++) {
        var c = checkboxes[$art_irpthmcbi$art_i];
    ...
    ;
    $expr = '<%for (var $art_iktsnnp$art_i = 0, $art_cyaadicw$art_c = radioes.length; $art_iktsnnp$art_i < $art_cyaadicw$art_c; $art_iktsnnp$art_i++) {    var r = radioes[$art_iktsnnp$art_i]%>';
    for (var $art_iktsnnp$art_i = 0, $art_cyaadicw$art_c = radioes.length; $art_iktsnnp$art_i < $art_cyaadicw$art_c; $art_iktsnnp$art_i++) {
        var r = radioes[$art_iktsnnp$art_i];
