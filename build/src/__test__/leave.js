...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imqfdhne$art_i = 0, $art_cxczarko$art_c = checkboxes.length; $art_imqfdhne$art_i < $art_cxczarko$art_c; $art_imqfdhne$art_i++) {    var c = checkboxes[$art_imqfdhne$art_i]%>';
    for (var $art_imqfdhne$art_i = 0, $art_cxczarko$art_c = checkboxes.length; $art_imqfdhne$art_i < $art_cxczarko$art_c; $art_imqfdhne$art_i++) {
        var c = checkboxes[$art_imqfdhne$art_i];
    ...
    ;
    $expr = '<%for (var $art_idoarctfhilq$art_i = 0, $art_cbowkvook$art_c = radioes.length; $art_idoarctfhilq$art_i < $art_cbowkvook$art_c; $art_idoarctfhilq$art_i++) {    var r = radioes[$art_idoarctfhilq$art_i]%>';
    for (var $art_idoarctfhilq$art_i = 0, $art_cbowkvook$art_c = radioes.length; $art_idoarctfhilq$art_i < $art_cbowkvook$art_c; $art_idoarctfhilq$art_i++) {
        var r = radioes[$art_idoarctfhilq$art_i];
