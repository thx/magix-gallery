...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iznacnxt$art_i = 0, $art_cyecqaxwbm$art_c = checkboxes.length; $art_iznacnxt$art_i < $art_cyecqaxwbm$art_c; $art_iznacnxt$art_i++) {    var c = checkboxes[$art_iznacnxt$art_i]%>';
    for (var $art_iznacnxt$art_i = 0, $art_cyecqaxwbm$art_c = checkboxes.length; $art_iznacnxt$art_i < $art_cyecqaxwbm$art_c; $art_iznacnxt$art_i++) {
        var c = checkboxes[$art_iznacnxt$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifgoni$art_i = 0, $art_cpypgcnc$art_c = radioes.length; $art_ifgoni$art_i < $art_cpypgcnc$art_c; $art_ifgoni$art_i++) {    var r = radioes[$art_ifgoni$art_i]%>';
    for (var $art_ifgoni$art_i = 0, $art_cpypgcnc$art_c = radioes.length; $art_ifgoni$art_i < $art_cpypgcnc$art_c; $art_ifgoni$art_i++) {
        var r = radioes[$art_ifgoni$art_i];
