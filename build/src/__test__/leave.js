...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icnmqp$art_i = 0, $art_cdmgjtvsk$art_c = checkboxes.length; $art_icnmqp$art_i < $art_cdmgjtvsk$art_c; $art_icnmqp$art_i++) {    var c = checkboxes[$art_icnmqp$art_i]%>';
    for (var $art_icnmqp$art_i = 0, $art_cdmgjtvsk$art_c = checkboxes.length; $art_icnmqp$art_i < $art_cdmgjtvsk$art_c; $art_icnmqp$art_i++) {
        var c = checkboxes[$art_icnmqp$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixsjtgyonh$art_i = 0, $art_cocvahyny$art_c = radioes.length; $art_ixsjtgyonh$art_i < $art_cocvahyny$art_c; $art_ixsjtgyonh$art_i++) {    var r = radioes[$art_ixsjtgyonh$art_i]%>';
    for (var $art_ixsjtgyonh$art_i = 0, $art_cocvahyny$art_c = radioes.length; $art_ixsjtgyonh$art_i < $art_cocvahyny$art_c; $art_ixsjtgyonh$art_i++) {
        var r = radioes[$art_ixsjtgyonh$art_i];
