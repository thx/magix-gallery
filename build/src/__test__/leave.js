...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izmkhjgxpl$art_i = 0, $art_crfwizerk$art_c = checkboxes.length; $art_izmkhjgxpl$art_i < $art_crfwizerk$art_c; $art_izmkhjgxpl$art_i++) {    var c = checkboxes[$art_izmkhjgxpl$art_i]%>';
    for (var $art_izmkhjgxpl$art_i = 0, $art_crfwizerk$art_c = checkboxes.length; $art_izmkhjgxpl$art_i < $art_crfwizerk$art_c; $art_izmkhjgxpl$art_i++) {
        var c = checkboxes[$art_izmkhjgxpl$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibbwxxuab$art_i = 0, $art_cfbinikdwb$art_c = radioes.length; $art_ibbwxxuab$art_i < $art_cfbinikdwb$art_c; $art_ibbwxxuab$art_i++) {    var r = radioes[$art_ibbwxxuab$art_i]%>';
    for (var $art_ibbwxxuab$art_i = 0, $art_cfbinikdwb$art_c = radioes.length; $art_ibbwxxuab$art_i < $art_cfbinikdwb$art_c; $art_ibbwxxuab$art_i++) {
        var r = radioes[$art_ibbwxxuab$art_i];
