...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilngpmwil$art_i = 0, $art_cxwyunxlnp$art_c = checkboxes.length; $art_ilngpmwil$art_i < $art_cxwyunxlnp$art_c; $art_ilngpmwil$art_i++) {    var c = checkboxes[$art_ilngpmwil$art_i]%>';
    for (var $art_ilngpmwil$art_i = 0, $art_cxwyunxlnp$art_c = checkboxes.length; $art_ilngpmwil$art_i < $art_cxwyunxlnp$art_c; $art_ilngpmwil$art_i++) {
        var c = checkboxes[$art_ilngpmwil$art_i];
    ...
    ;
    $expr = '<%for (var $art_iaxnsq$art_i = 0, $art_cnoruqyjeo$art_c = radioes.length; $art_iaxnsq$art_i < $art_cnoruqyjeo$art_c; $art_iaxnsq$art_i++) {    var r = radioes[$art_iaxnsq$art_i]%>';
    for (var $art_iaxnsq$art_i = 0, $art_cnoruqyjeo$art_c = radioes.length; $art_iaxnsq$art_i < $art_cnoruqyjeo$art_c; $art_iaxnsq$art_i++) {
        var r = radioes[$art_iaxnsq$art_i];
