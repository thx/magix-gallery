...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iftdkfhph$art_i = 0, $art_cbkdzuyopob$art_c = checkboxes.length; $art_iftdkfhph$art_i < $art_cbkdzuyopob$art_c; $art_iftdkfhph$art_i++) {    var c = checkboxes[$art_iftdkfhph$art_i]%>';
    for (var $art_iftdkfhph$art_i = 0, $art_cbkdzuyopob$art_c = checkboxes.length; $art_iftdkfhph$art_i < $art_cbkdzuyopob$art_c; $art_iftdkfhph$art_i++) {
        var c = checkboxes[$art_iftdkfhph$art_i];
    ...
    ;
    $expr = '<%for (var $art_ioqjabkdz$art_i = 0, $art_cdtpgvdts$art_c = radioes.length; $art_ioqjabkdz$art_i < $art_cdtpgvdts$art_c; $art_ioqjabkdz$art_i++) {    var r = radioes[$art_ioqjabkdz$art_i]%>';
    for (var $art_ioqjabkdz$art_i = 0, $art_cdtpgvdts$art_c = radioes.length; $art_ioqjabkdz$art_i < $art_cdtpgvdts$art_c; $art_ioqjabkdz$art_i++) {
        var r = radioes[$art_ioqjabkdz$art_i];
