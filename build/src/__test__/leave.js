...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iucyutvoh$art_i = 0, $art_cnwrwzgzsrm$art_c = checkboxes.length; $art_iucyutvoh$art_i < $art_cnwrwzgzsrm$art_c; $art_iucyutvoh$art_i++) {    var c = checkboxes[$art_iucyutvoh$art_i]%>';
    for (var $art_iucyutvoh$art_i = 0, $art_cnwrwzgzsrm$art_c = checkboxes.length; $art_iucyutvoh$art_i < $art_cnwrwzgzsrm$art_c; $art_iucyutvoh$art_i++) {
        var c = checkboxes[$art_iucyutvoh$art_i];
    ...
    ;
    $expr = '<%for (var $art_iujbijufq$art_i = 0, $art_cycabqspo$art_c = radioes.length; $art_iujbijufq$art_i < $art_cycabqspo$art_c; $art_iujbijufq$art_i++) {    var r = radioes[$art_iujbijufq$art_i]%>';
    for (var $art_iujbijufq$art_i = 0, $art_cycabqspo$art_c = radioes.length; $art_iujbijufq$art_i < $art_cycabqspo$art_c; $art_iujbijufq$art_i++) {
        var r = radioes[$art_iujbijufq$art_i];
