...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_coxugjjvn$art_c = themes.length; i < $art_coxugjjvn$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_coxugjjvn$art_c = themes.length; i < $art_coxugjjvn$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iarhki$art_i = 0, $art_cnfyhmwtla$art_c = list.length; $art_iarhki$art_i < $art_cnfyhmwtla$art_c; $art_iarhki$art_i++) {    var group = list[$art_iarhki$art_i]%>';
    for (var $art_iarhki$art_i = 0, $art_cnfyhmwtla$art_c = list.length; $art_iarhki$art_i < $art_cnfyhmwtla$art_c; $art_iarhki$art_i++) {
        var group = list[$art_iarhki$art_i];
        ...
        ;
        $expr = '<%for (var $art_ircpumanbxu$art_i = 0, $art_objoszlxhhfk$art_obj = group.subs, $art_cklkcbyu$art_c = $art_objoszlxhhfk$art_obj.length; $art_ircpumanbxu$art_i < $art_cklkcbyu$art_c; $art_ircpumanbxu$art_i++) {        var item = $art_objoszlxhhfk$art_obj[$art_ircpumanbxu$art_i]%>';
        for (var $art_ircpumanbxu$art_i = 0, $art_objoszlxhhfk$art_obj = group.subs, $art_cklkcbyu$art_c = $art_objoszlxhhfk$art_obj.length; $art_ircpumanbxu$art_i < $art_cklkcbyu$art_c; $art_ircpumanbxu$art_i++) {
            var item = $art_objoszlxhhfk$art_obj[$art_ircpumanbxu$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iarhki$art_i%>', $e($art_iarhki$art_i)) + '_' + ($expr = '<%=$art_ircpumanbxu$art_i%>', $e($art_ircpumanbxu$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iarhki$art_i%>', $e($art_iarhki$art_i)) + '.subs.' + ($expr = '<%=$art_ircpumanbxu$art_i%>', $e($art_ircpumanbxu$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iarhki$art_i%>', $e($art_iarhki$art_i)) + '_' + ($expr = '<%=$art_ircpumanbxu$art_i%>', $e($art_ircpumanbxu$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iarhki$art_i%>', $e($art_iarhki$art_i)) + '.subs.' + ($expr = '<%=$art_ircpumanbxu$art_i%>', $e($art_ircpumanbxu$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
