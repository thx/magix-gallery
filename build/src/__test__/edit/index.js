...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cawinm$art_c = themes.length; i < $art_cawinm$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cawinm$art_c = themes.length; i < $art_cawinm$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iapaqmbq$art_i = 0, $art_clntkha$art_c = list.length; $art_iapaqmbq$art_i < $art_clntkha$art_c; $art_iapaqmbq$art_i++) {    var item = list[$art_iapaqmbq$art_i]%>';
    for (var $art_iapaqmbq$art_i = 0, $art_clntkha$art_c = list.length; $art_iapaqmbq$art_i < $art_clntkha$art_c; $art_iapaqmbq$art_i++) {
        var item = list[$art_iapaqmbq$art_i];
        ...
        if (item.type == 'color') {
            ...
            $art = '=item.value';
            ;
            $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iapaqmbq$art_i%>', $e($art_iapaqmbq$art_i)) + '" mxc="[';
            $line = 47;
            $art = ':item.value';
            ;
            $p += '{p:\'list.' + ($expr = '<%=$art_iapaqmbq$art_i%>', $e($art_iapaqmbq$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
            $line = 48;
            $art = '=item.key';
            ;
        ...
        if (item.type == 'text') {
            ;
            $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iapaqmbq$art_i%>', $e($art_iapaqmbq$art_i)) + '" mxc="[';
            $line = 54;
            $art = ':item.value';
            ;
            $p += '{p:\'list.' + ($expr = '<%=$art_iapaqmbq$art_i%>', $e($art_iapaqmbq$art_i)) + '.value\'}]" class="w100" value="';
            $line = 54;
            $art = ':item.value';
            ;
