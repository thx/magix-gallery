...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cvgjkt$art_c = themes.length; i < $art_cvgjkt$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cvgjkt$art_c = themes.length; i < $art_cvgjkt$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iticvcjkdp$art_i = 0, $art_cufwxtp$art_c = list.length; $art_iticvcjkdp$art_i < $art_cufwxtp$art_c; $art_iticvcjkdp$art_i++) {    var group = list[$art_iticvcjkdp$art_i]%>';
    for (var $art_iticvcjkdp$art_i = 0, $art_cufwxtp$art_c = list.length; $art_iticvcjkdp$art_i < $art_cufwxtp$art_c; $art_iticvcjkdp$art_i++) {
        var group = list[$art_iticvcjkdp$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijlywzkss$art_i = 0, $art_objvbbrcrv$art_obj = group.subs, $art_cggkfsnt$art_c = $art_objvbbrcrv$art_obj.length; $art_ijlywzkss$art_i < $art_cggkfsnt$art_c; $art_ijlywzkss$art_i++) {        var item = $art_objvbbrcrv$art_obj[$art_ijlywzkss$art_i]%>';
        for (var $art_ijlywzkss$art_i = 0, $art_objvbbrcrv$art_obj = group.subs, $art_cggkfsnt$art_c = $art_objvbbrcrv$art_obj.length; $art_ijlywzkss$art_i < $art_cggkfsnt$art_c; $art_ijlywzkss$art_i++) {
            var item = $art_objvbbrcrv$art_obj[$art_ijlywzkss$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iticvcjkdp$art_i%>', $e($art_iticvcjkdp$art_i)) + '_' + ($expr = '<%=$art_ijlywzkss$art_i%>', $e($art_ijlywzkss$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iticvcjkdp$art_i%>', $e($art_iticvcjkdp$art_i)) + '.subs.' + ($expr = '<%=$art_ijlywzkss$art_i%>', $e($art_ijlywzkss$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iticvcjkdp$art_i%>', $e($art_iticvcjkdp$art_i)) + '_' + ($expr = '<%=$art_ijlywzkss$art_i%>', $e($art_ijlywzkss$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iticvcjkdp$art_i%>', $e($art_iticvcjkdp$art_i)) + '.subs.' + ($expr = '<%=$art_ijlywzkss$art_i%>', $e($art_ijlywzkss$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
