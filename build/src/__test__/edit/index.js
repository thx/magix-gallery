...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cyshivm$art_c = themes.length; i < $art_cyshivm$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cyshivm$art_c = themes.length; i < $art_cyshivm$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_indujsts$art_i = 0, $art_cigpjlkbci$art_c = list.length; $art_indujsts$art_i < $art_cigpjlkbci$art_c; $art_indujsts$art_i++) {    var group = list[$art_indujsts$art_i]%>';
    for (var $art_indujsts$art_i = 0, $art_cigpjlkbci$art_c = list.length; $art_indujsts$art_i < $art_cigpjlkbci$art_c; $art_indujsts$art_i++) {
        var group = list[$art_indujsts$art_i];
        ...
        ;
        $expr = '<%for (var $art_iavsnhmrljo$art_i = 0, $art_objxegluhc$art_obj = group.subs, $art_cuqpgbje$art_c = $art_objxegluhc$art_obj.length; $art_iavsnhmrljo$art_i < $art_cuqpgbje$art_c; $art_iavsnhmrljo$art_i++) {        var item = $art_objxegluhc$art_obj[$art_iavsnhmrljo$art_i]%>';
        for (var $art_iavsnhmrljo$art_i = 0, $art_objxegluhc$art_obj = group.subs, $art_cuqpgbje$art_c = $art_objxegluhc$art_obj.length; $art_iavsnhmrljo$art_i < $art_cuqpgbje$art_c; $art_iavsnhmrljo$art_i++) {
            var item = $art_objxegluhc$art_obj[$art_iavsnhmrljo$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_indujsts$art_i%>', $e($art_indujsts$art_i)) + '_' + ($expr = '<%=$art_iavsnhmrljo$art_i%>', $e($art_iavsnhmrljo$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_indujsts$art_i%>', $e($art_indujsts$art_i)) + '.subs.' + ($expr = '<%=$art_iavsnhmrljo$art_i%>', $e($art_iavsnhmrljo$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_indujsts$art_i%>', $e($art_indujsts$art_i)) + '_' + ($expr = '<%=$art_iavsnhmrljo$art_i%>', $e($art_iavsnhmrljo$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_indujsts$art_i%>', $e($art_indujsts$art_i)) + '.subs.' + ($expr = '<%=$art_iavsnhmrljo$art_i%>', $e($art_iavsnhmrljo$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
