...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cklgxzlyxno$art_c = themes.length; i < $art_cklgxzlyxno$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cklgxzlyxno$art_c = themes.length; i < $art_cklgxzlyxno$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_irdyllfgjp$art_i = 0, $art_cdjtjind$art_c = list.length; $art_irdyllfgjp$art_i < $art_cdjtjind$art_c; $art_irdyllfgjp$art_i++) {    var group = list[$art_irdyllfgjp$art_i]%>';
    for (var $art_irdyllfgjp$art_i = 0, $art_cdjtjind$art_c = list.length; $art_irdyllfgjp$art_i < $art_cdjtjind$art_c; $art_irdyllfgjp$art_i++) {
        var group = list[$art_irdyllfgjp$art_i];
        ...
        ;
        $expr = '<%for (var $art_ihyojesygp$art_i = 0, $art_objcwquxsogy$art_obj = group.subs, $art_cgzorstmo$art_c = $art_objcwquxsogy$art_obj.length; $art_ihyojesygp$art_i < $art_cgzorstmo$art_c; $art_ihyojesygp$art_i++) {        var item = $art_objcwquxsogy$art_obj[$art_ihyojesygp$art_i]%>';
        for (var $art_ihyojesygp$art_i = 0, $art_objcwquxsogy$art_obj = group.subs, $art_cgzorstmo$art_c = $art_objcwquxsogy$art_obj.length; $art_ihyojesygp$art_i < $art_cgzorstmo$art_c; $art_ihyojesygp$art_i++) {
            var item = $art_objcwquxsogy$art_obj[$art_ihyojesygp$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_irdyllfgjp$art_i%>', $e($art_irdyllfgjp$art_i)) + '_' + ($expr = '<%=$art_ihyojesygp$art_i%>', $e($art_ihyojesygp$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_irdyllfgjp$art_i%>', $e($art_irdyllfgjp$art_i)) + '.subs.' + ($expr = '<%=$art_ihyojesygp$art_i%>', $e($art_ihyojesygp$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_irdyllfgjp$art_i%>', $e($art_irdyllfgjp$art_i)) + '_' + ($expr = '<%=$art_ihyojesygp$art_i%>', $e($art_ihyojesygp$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_irdyllfgjp$art_i%>', $e($art_irdyllfgjp$art_i)) + '.subs.' + ($expr = '<%=$art_ihyojesygp$art_i%>', $e($art_ihyojesygp$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
