...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_czmdwtd$art_c = themes.length; i < $art_czmdwtd$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_czmdwtd$art_c = themes.length; i < $art_czmdwtd$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ipnvdfr$art_i = 0, $art_cvijbykcg$art_c = list.length; $art_ipnvdfr$art_i < $art_cvijbykcg$art_c; $art_ipnvdfr$art_i++) {    var group = list[$art_ipnvdfr$art_i]%>';
    for (var $art_ipnvdfr$art_i = 0, $art_cvijbykcg$art_c = list.length; $art_ipnvdfr$art_i < $art_cvijbykcg$art_c; $art_ipnvdfr$art_i++) {
        var group = list[$art_ipnvdfr$art_i];
        ...
        ;
        $expr = '<%for (var $art_iugtskyei$art_i = 0, $art_objhopyjqwu$art_obj = group.subs, $art_cqxqlsba$art_c = $art_objhopyjqwu$art_obj.length; $art_iugtskyei$art_i < $art_cqxqlsba$art_c; $art_iugtskyei$art_i++) {        var item = $art_objhopyjqwu$art_obj[$art_iugtskyei$art_i]%>';
        for (var $art_iugtskyei$art_i = 0, $art_objhopyjqwu$art_obj = group.subs, $art_cqxqlsba$art_c = $art_objhopyjqwu$art_obj.length; $art_iugtskyei$art_i < $art_cqxqlsba$art_c; $art_iugtskyei$art_i++) {
            var item = $art_objhopyjqwu$art_obj[$art_iugtskyei$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ipnvdfr$art_i%>', $e($art_ipnvdfr$art_i)) + '_' + ($expr = '<%=$art_iugtskyei$art_i%>', $e($art_iugtskyei$art_i)) + '" mxc="[';
                $line = 62;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ipnvdfr$art_i%>', $e($art_ipnvdfr$art_i)) + '.subs.' + ($expr = '<%=$art_iugtskyei$art_i%>', $e($art_iugtskyei$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 63;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ipnvdfr$art_i%>', $e($art_ipnvdfr$art_i)) + '_' + ($expr = '<%=$art_iugtskyei$art_i%>', $e($art_iugtskyei$art_i)) + '" mxc="[';
                $line = 69;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ipnvdfr$art_i%>', $e($art_ipnvdfr$art_i)) + '.subs.' + ($expr = '<%=$art_iugtskyei$art_i%>', $e($art_iugtskyei$art_i)) + '.value\'}]" class="w100" value="';
                $line = 69;
                $art = ':item.value';
                ;
