...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_casgzbpovjq$art_c = themes.length; i < $art_casgzbpovjq$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_casgzbpovjq$art_c = themes.length; i < $art_casgzbpovjq$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ifaredsfiu$art_i = 0, $art_cbryfsuktet$art_c = list.length; $art_ifaredsfiu$art_i < $art_cbryfsuktet$art_c; $art_ifaredsfiu$art_i++) {    var group = list[$art_ifaredsfiu$art_i]%>';
    for (var $art_ifaredsfiu$art_i = 0, $art_cbryfsuktet$art_c = list.length; $art_ifaredsfiu$art_i < $art_cbryfsuktet$art_c; $art_ifaredsfiu$art_i++) {
        var group = list[$art_ifaredsfiu$art_i];
        ...
        ;
        $expr = '<%for (var $art_ifjronw$art_i = 0, $art_objbbljguxm$art_obj = group.subs, $art_cfvpxckdqs$art_c = $art_objbbljguxm$art_obj.length; $art_ifjronw$art_i < $art_cfvpxckdqs$art_c; $art_ifjronw$art_i++) {        var item = $art_objbbljguxm$art_obj[$art_ifjronw$art_i]%>';
        for (var $art_ifjronw$art_i = 0, $art_objbbljguxm$art_obj = group.subs, $art_cfvpxckdqs$art_c = $art_objbbljguxm$art_obj.length; $art_ifjronw$art_i < $art_cfvpxckdqs$art_c; $art_ifjronw$art_i++) {
            var item = $art_objbbljguxm$art_obj[$art_ifjronw$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ifaredsfiu$art_i%>', $e($art_ifaredsfiu$art_i)) + '_' + ($expr = '<%=$art_ifjronw$art_i%>', $e($art_ifjronw$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ifaredsfiu$art_i%>', $e($art_ifaredsfiu$art_i)) + '.subs.' + ($expr = '<%=$art_ifjronw$art_i%>', $e($art_ifjronw$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ifaredsfiu$art_i%>', $e($art_ifaredsfiu$art_i)) + '_' + ($expr = '<%=$art_ifjronw$art_i%>', $e($art_ifjronw$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ifaredsfiu$art_i%>', $e($art_ifaredsfiu$art_i)) + '.subs.' + ($expr = '<%=$art_ifjronw$art_i%>', $e($art_ifjronw$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
