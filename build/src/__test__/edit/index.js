...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cojhkcgoko$art_c = themes.length; i < $art_cojhkcgoko$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cojhkcgoko$art_c = themes.length; i < $art_cojhkcgoko$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iclipejicdf$art_i = 0, $art_cbqymybvexnv$art_c = list.length; $art_iclipejicdf$art_i < $art_cbqymybvexnv$art_c; $art_iclipejicdf$art_i++) {    var group = list[$art_iclipejicdf$art_i]%>';
    for (var $art_iclipejicdf$art_i = 0, $art_cbqymybvexnv$art_c = list.length; $art_iclipejicdf$art_i < $art_cbqymybvexnv$art_c; $art_iclipejicdf$art_i++) {
        var group = list[$art_iclipejicdf$art_i];
        ...
        ;
        $expr = '<%for (var $art_izrifluv$art_i = 0, $art_objbzvrnqqas$art_obj = group.subs, $art_cltskbzjyb$art_c = $art_objbzvrnqqas$art_obj.length; $art_izrifluv$art_i < $art_cltskbzjyb$art_c; $art_izrifluv$art_i++) {        var item = $art_objbzvrnqqas$art_obj[$art_izrifluv$art_i]%>';
        for (var $art_izrifluv$art_i = 0, $art_objbzvrnqqas$art_obj = group.subs, $art_cltskbzjyb$art_c = $art_objbzvrnqqas$art_obj.length; $art_izrifluv$art_i < $art_cltskbzjyb$art_c; $art_izrifluv$art_i++) {
            var item = $art_objbzvrnqqas$art_obj[$art_izrifluv$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iclipejicdf$art_i%>', $e($art_iclipejicdf$art_i)) + '_' + ($expr = '<%=$art_izrifluv$art_i%>', $e($art_izrifluv$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iclipejicdf$art_i%>', $e($art_iclipejicdf$art_i)) + '.subs.' + ($expr = '<%=$art_izrifluv$art_i%>', $e($art_izrifluv$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iclipejicdf$art_i%>', $e($art_iclipejicdf$art_i)) + '_' + ($expr = '<%=$art_izrifluv$art_i%>', $e($art_izrifluv$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iclipejicdf$art_i%>', $e($art_iclipejicdf$art_i)) + '.subs.' + ($expr = '<%=$art_izrifluv$art_i%>', $e($art_izrifluv$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
