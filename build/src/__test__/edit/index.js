...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_csixmard$art_c = themes.length; i < $art_csixmard$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_csixmard$art_c = themes.length; i < $art_csixmard$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iwdnqystkwj$art_i = 0, $art_cogohiohdhm$art_c = list.length; $art_iwdnqystkwj$art_i < $art_cogohiohdhm$art_c; $art_iwdnqystkwj$art_i++) {    var item = list[$art_iwdnqystkwj$art_i]%>';
    for (var $art_iwdnqystkwj$art_i = 0, $art_cogohiohdhm$art_c = list.length; $art_iwdnqystkwj$art_i < $art_cogohiohdhm$art_c; $art_iwdnqystkwj$art_i++) {
        var item = list[$art_iwdnqystkwj$art_i];
