...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cpqstgpsux$art_c = themes.length; i < $art_cpqstgpsux$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cpqstgpsux$art_c = themes.length; i < $art_cpqstgpsux$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_issptdhrpz$art_i = 0, $art_chvlepbs$art_c = list.length; $art_issptdhrpz$art_i < $art_chvlepbs$art_c; $art_issptdhrpz$art_i++) {    var group = list[$art_issptdhrpz$art_i]%>';
    for (var $art_issptdhrpz$art_i = 0, $art_chvlepbs$art_c = list.length; $art_issptdhrpz$art_i < $art_chvlepbs$art_c; $art_issptdhrpz$art_i++) {
        var group = list[$art_issptdhrpz$art_i];
        ...
        ;
        $expr = '<%for (var $art_ittmvskll$art_i = 0, $art_objgqpjehtjm$art_obj = group.subs, $art_cdvwlgpmlxg$art_c = $art_objgqpjehtjm$art_obj.length; $art_ittmvskll$art_i < $art_cdvwlgpmlxg$art_c; $art_ittmvskll$art_i++) {        var item = $art_objgqpjehtjm$art_obj[$art_ittmvskll$art_i]%>';
        for (var $art_ittmvskll$art_i = 0, $art_objgqpjehtjm$art_obj = group.subs, $art_cdvwlgpmlxg$art_c = $art_objgqpjehtjm$art_obj.length; $art_ittmvskll$art_i < $art_cdvwlgpmlxg$art_c; $art_ittmvskll$art_i++) {
            var item = $art_objgqpjehtjm$art_obj[$art_ittmvskll$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_issptdhrpz$art_i%>', $e($art_issptdhrpz$art_i)) + '_' + ($expr = '<%=$art_ittmvskll$art_i%>', $e($art_ittmvskll$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_issptdhrpz$art_i%>', $e($art_issptdhrpz$art_i)) + '.subs.' + ($expr = '<%=$art_ittmvskll$art_i%>', $e($art_ittmvskll$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_issptdhrpz$art_i%>', $e($art_issptdhrpz$art_i)) + '_' + ($expr = '<%=$art_ittmvskll$art_i%>', $e($art_ittmvskll$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_issptdhrpz$art_i%>', $e($art_issptdhrpz$art_i)) + '.subs.' + ($expr = '<%=$art_ittmvskll$art_i%>', $e($art_ittmvskll$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
