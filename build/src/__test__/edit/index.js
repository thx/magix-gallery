...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cqpriwvyhtke$art_c = themes.length; i < $art_cqpriwvyhtke$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cqpriwvyhtke$art_c = themes.length; i < $art_cqpriwvyhtke$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iolkocec$art_i = 0, $art_cuecprmlnr$art_c = list.length; $art_iolkocec$art_i < $art_cuecprmlnr$art_c; $art_iolkocec$art_i++) {    var group = list[$art_iolkocec$art_i]%>';
    for (var $art_iolkocec$art_i = 0, $art_cuecprmlnr$art_c = list.length; $art_iolkocec$art_i < $art_cuecprmlnr$art_c; $art_iolkocec$art_i++) {
        var group = list[$art_iolkocec$art_i];
        ...
        ;
        $expr = '<%for (var $art_ikkyxnwuydt$art_i = 0, $art_objjnuwnnaud$art_obj = group.subs, $art_coooowcxga$art_c = $art_objjnuwnnaud$art_obj.length; $art_ikkyxnwuydt$art_i < $art_coooowcxga$art_c; $art_ikkyxnwuydt$art_i++) {        var item = $art_objjnuwnnaud$art_obj[$art_ikkyxnwuydt$art_i]%>';
        for (var $art_ikkyxnwuydt$art_i = 0, $art_objjnuwnnaud$art_obj = group.subs, $art_coooowcxga$art_c = $art_objjnuwnnaud$art_obj.length; $art_ikkyxnwuydt$art_i < $art_coooowcxga$art_c; $art_ikkyxnwuydt$art_i++) {
            var item = $art_objjnuwnnaud$art_obj[$art_ikkyxnwuydt$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iolkocec$art_i%>', $e($art_iolkocec$art_i)) + '_' + ($expr = '<%=$art_ikkyxnwuydt$art_i%>', $e($art_ikkyxnwuydt$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iolkocec$art_i%>', $e($art_iolkocec$art_i)) + '.subs.' + ($expr = '<%=$art_ikkyxnwuydt$art_i%>', $e($art_ikkyxnwuydt$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iolkocec$art_i%>', $e($art_iolkocec$art_i)) + '_' + ($expr = '<%=$art_ikkyxnwuydt$art_i%>', $e($art_ikkyxnwuydt$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iolkocec$art_i%>', $e($art_iolkocec$art_i)) + '.subs.' + ($expr = '<%=$art_ikkyxnwuydt$art_i%>', $e($art_ikkyxnwuydt$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
