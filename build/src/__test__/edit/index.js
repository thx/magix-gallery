...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_celcqeqbufw$art_c = themes.length; i < $art_celcqeqbufw$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_celcqeqbufw$art_c = themes.length; i < $art_celcqeqbufw$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_idriei$art_i = 0, $art_cwnvxbobci$art_c = list.length; $art_idriei$art_i < $art_cwnvxbobci$art_c; $art_idriei$art_i++) {    var group = list[$art_idriei$art_i]%>';
    for (var $art_idriei$art_i = 0, $art_cwnvxbobci$art_c = list.length; $art_idriei$art_i < $art_cwnvxbobci$art_c; $art_idriei$art_i++) {
        var group = list[$art_idriei$art_i];
        ...
        ;
        $expr = '<%for (var $art_ioikhjlyep$art_i = 0, $art_objgwjlmcddr$art_obj = group.subs, $art_czwsbcsau$art_c = $art_objgwjlmcddr$art_obj.length; $art_ioikhjlyep$art_i < $art_czwsbcsau$art_c; $art_ioikhjlyep$art_i++) {        var item = $art_objgwjlmcddr$art_obj[$art_ioikhjlyep$art_i]%>';
        for (var $art_ioikhjlyep$art_i = 0, $art_objgwjlmcddr$art_obj = group.subs, $art_czwsbcsau$art_c = $art_objgwjlmcddr$art_obj.length; $art_ioikhjlyep$art_i < $art_czwsbcsau$art_c; $art_ioikhjlyep$art_i++) {
            var item = $art_objgwjlmcddr$art_obj[$art_ioikhjlyep$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_idriei$art_i%>', $e($art_idriei$art_i)) + '_' + ($expr = '<%=$art_ioikhjlyep$art_i%>', $e($art_ioikhjlyep$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_idriei$art_i%>', $e($art_idriei$art_i)) + '.subs.' + ($expr = '<%=$art_ioikhjlyep$art_i%>', $e($art_ioikhjlyep$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_idriei$art_i%>', $e($art_idriei$art_i)) + '_' + ($expr = '<%=$art_ioikhjlyep$art_i%>', $e($art_ioikhjlyep$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_idriei$art_i%>', $e($art_idriei$art_i)) + '.subs.' + ($expr = '<%=$art_ioikhjlyep$art_i%>', $e($art_ioikhjlyep$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
