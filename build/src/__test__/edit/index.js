...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cwpbomxbtrwo$art_c = themes.length; i < $art_cwpbomxbtrwo$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cwpbomxbtrwo$art_c = themes.length; i < $art_cwpbomxbtrwo$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_iynpxdch$art_i = 0, $art_cwnle$art_c = list.length; $art_iynpxdch$art_i < $art_cwnle$art_c; $art_iynpxdch$art_i++) {    var group = list[$art_iynpxdch$art_i]%>';
    for (var $art_iynpxdch$art_i = 0, $art_cwnle$art_c = list.length; $art_iynpxdch$art_i < $art_cwnle$art_c; $art_iynpxdch$art_i++) {
        var group = list[$art_iynpxdch$art_i];
        ...
        ;
        $expr = '<%for (var $art_iivaoarje$art_i = 0, $art_objtyiitueh$art_obj = group.subs, $art_ccyjmbyy$art_c = $art_objtyiitueh$art_obj.length; $art_iivaoarje$art_i < $art_ccyjmbyy$art_c; $art_iivaoarje$art_i++) {        var item = $art_objtyiitueh$art_obj[$art_iivaoarje$art_i]%>';
        for (var $art_iivaoarje$art_i = 0, $art_objtyiitueh$art_obj = group.subs, $art_ccyjmbyy$art_c = $art_objtyiitueh$art_obj.length; $art_iivaoarje$art_i < $art_ccyjmbyy$art_c; $art_iivaoarje$art_i++) {
            var item = $art_objtyiitueh$art_obj[$art_iivaoarje$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_iynpxdch$art_i%>', $e($art_iynpxdch$art_i)) + '_' + ($expr = '<%=$art_iivaoarje$art_i%>', $e($art_iivaoarje$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iynpxdch$art_i%>', $e($art_iynpxdch$art_i)) + '.subs.' + ($expr = '<%=$art_iivaoarje$art_i%>', $e($art_iivaoarje$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_iynpxdch$art_i%>', $e($art_iynpxdch$art_i)) + '_' + ($expr = '<%=$art_iivaoarje$art_i%>', $e($art_iivaoarje$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_iynpxdch$art_i%>', $e($art_iynpxdch$art_i)) + '.subs.' + ($expr = '<%=$art_iivaoarje$art_i%>', $e($art_iivaoarje$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
