...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cnvajqatsdc$art_c = themes.length; i < $art_cnvajqatsdc$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cnvajqatsdc$art_c = themes.length; i < $art_cnvajqatsdc$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_ilxabxb$art_i = 0, $art_cbyzkcnq$art_c = list.length; $art_ilxabxb$art_i < $art_cbyzkcnq$art_c; $art_ilxabxb$art_i++) {    var group = list[$art_ilxabxb$art_i]%>';
    for (var $art_ilxabxb$art_i = 0, $art_cbyzkcnq$art_c = list.length; $art_ilxabxb$art_i < $art_cbyzkcnq$art_c; $art_ilxabxb$art_i++) {
        var group = list[$art_ilxabxb$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixjhyxvc$art_i = 0, $art_objhwnqmuux$art_obj = group.subs, $art_cmiqltyhmxsg$art_c = $art_objhwnqmuux$art_obj.length; $art_ixjhyxvc$art_i < $art_cmiqltyhmxsg$art_c; $art_ixjhyxvc$art_i++) {        var item = $art_objhwnqmuux$art_obj[$art_ixjhyxvc$art_i]%>';
        for (var $art_ixjhyxvc$art_i = 0, $art_objhwnqmuux$art_obj = group.subs, $art_cmiqltyhmxsg$art_c = $art_objhwnqmuux$art_obj.length; $art_ixjhyxvc$art_i < $art_cmiqltyhmxsg$art_c; $art_ixjhyxvc$art_i++) {
            var item = $art_objhwnqmuux$art_obj[$art_ixjhyxvc$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_ilxabxb$art_i%>', $e($art_ilxabxb$art_i)) + '_' + ($expr = '<%=$art_ixjhyxvc$art_i%>', $e($art_ixjhyxvc$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ilxabxb$art_i%>', $e($art_ilxabxb$art_i)) + '.subs.' + ($expr = '<%=$art_ixjhyxvc$art_i%>', $e($art_ixjhyxvc$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_ilxabxb$art_i%>', $e($art_ilxabxb$art_i)) + '_' + ($expr = '<%=$art_ixjhyxvc$art_i%>', $e($art_ixjhyxvc$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_ilxabxb$art_i%>', $e($art_ilxabxb$art_i)) + '.subs.' + ($expr = '<%=$art_ixjhyxvc$art_i%>', $e($art_ixjhyxvc$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
