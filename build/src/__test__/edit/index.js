...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var i = 0, $art_cjaddxmfh$art_c = themes.length; i < $art_cjaddxmfh$art_c; i++) {    var t = themes[i]%>';
    for (var i = 0, $art_cjaddxmfh$art_c = themes.length; i < $art_cjaddxmfh$art_c; i++) {
        var t = themes[i];
    ...
    ;
    $expr = '<%for (var $art_imlyzeuob$art_i = 0, $art_chxmuugaljr$art_c = list.length; $art_imlyzeuob$art_i < $art_chxmuugaljr$art_c; $art_imlyzeuob$art_i++) {    var group = list[$art_imlyzeuob$art_i]%>';
    for (var $art_imlyzeuob$art_i = 0, $art_chxmuugaljr$art_c = list.length; $art_imlyzeuob$art_i < $art_chxmuugaljr$art_c; $art_imlyzeuob$art_i++) {
        var group = list[$art_imlyzeuob$art_i];
        ...
        ;
        $expr = '<%for (var $art_idkjdpug$art_i = 0, $art_objmzph$art_obj = group.subs, $art_cbrsebbpkh$art_c = $art_objmzph$art_obj.length; $art_idkjdpug$art_i < $art_cbrsebbpkh$art_c; $art_idkjdpug$art_i++) {        var item = $art_objmzph$art_obj[$art_idkjdpug$art_i]%>';
        for (var $art_idkjdpug$art_i = 0, $art_objmzph$art_obj = group.subs, $art_cbrsebbpkh$art_c = $art_objmzph$art_obj.length; $art_idkjdpug$art_i < $art_cbrsebbpkh$art_c; $art_idkjdpug$art_i++) {
            var item = $art_objmzph$art_obj[$art_idkjdpug$art_i];
            ...
            if (item.type == 'color') {
                ...
                $art = '=item.value';
                ;
                $p += ($expr = '<%=item.value%>', $e(item.value)) + ';"><div mxv="list" mxe="' + $viewId + '_0_' + ($expr = '<%=$art_imlyzeuob$art_i%>', $e($art_imlyzeuob$art_i)) + '_' + ($expr = '<%=$art_idkjdpug$art_i%>', $e($art_idkjdpug$art_i)) + '" mxc="[';
                $line = 65;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imlyzeuob$art_i%>', $e($art_imlyzeuob$art_i)) + '.subs.' + ($expr = '<%=$art_idkjdpug$art_i%>', $e($art_idkjdpug$art_i)) + '.value\',a:\'color\'}]" mx-change="' + $viewId + 'sync({key:\'';
                $line = 66;
                $art = '=item.key';
                ;
            ...
            if (item.type == 'text') {
                ;
                $p += '<div mxv><input mxe="' + $viewId + '_1_' + ($expr = '<%=$art_imlyzeuob$art_i%>', $e($art_imlyzeuob$art_i)) + '_' + ($expr = '<%=$art_idkjdpug$art_i%>', $e($art_idkjdpug$art_i)) + '" mxc="[';
                $line = 72;
                $art = ':item.value';
                ;
                $p += '{p:\'list.' + ($expr = '<%=$art_imlyzeuob$art_i%>', $e($art_imlyzeuob$art_i)) + '.subs.' + ($expr = '<%=$art_idkjdpug$art_i%>', $e($art_idkjdpug$art_i)) + '.value\'}]" class="w100" value="';
                $line = 72;
                $art = ':item.value';
                ;
