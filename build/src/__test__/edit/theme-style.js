/*
    ...
    loader: cmd_es
 */
define("__test__/edit/theme-style",["magix","../example","$","mx-effects/notice","mx-switch/index","mx-copy/index","../hl"],(require,exports,module)=>{
/*Magix,Base,$*/
...
var $ = require("$");
Magix.applyStyle("_zs_gallery___test___edit_theme-style_","/* @dependent: ./index.less */\n/* 说明文档： https://thx.github.io/magix-gallery/#!/all/pro/theme */\n._zs_gallery___test___edit_theme-style_-mx-shadow {\n  box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.08);\n  border: 1px solid #f5f5f6;\n}\n/*用于覆盖bp的品牌色信息*/\n._zs_gallery___test___edit_theme-style_-outer ._zs_gallery_mx-switch_index_-switch {\n  height: 8px;\n  border-radius: 4px;\n}\n._zs_gallery___test___edit_theme-style_-outer ._zs_gallery_mx-switch_index_-switch._zs_gallery_mx-switch_index_-on {\n  background-color: #cbf3f4;\n}\n._zs_gallery___test___edit_theme-style_-outer ._zs_gallery_mx-switch_index_-switch._zs_gallery_mx-switch_index_-on ._zs_gallery_mx-switch_index_-switch-icon {\n  background-color: #14c9ce;\n}\n");
module.exports = Base.extend({
    ...
    msg += $expr + '\r\n\tat file:__test__/edit/theme-style.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
