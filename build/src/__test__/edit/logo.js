...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iknvqsvkb$art_i = 0, $art_cjedzui$art_c = themes.length; $art_iknvqsvkb$art_i < $art_cjedzui$art_c; $art_iknvqsvkb$art_i++) {    var t = themes[$art_iknvqsvkb$art_i]%>';
    for (var $art_iknvqsvkb$art_i = 0, $art_cjedzui$art_c = themes.length; $art_iknvqsvkb$art_i < $art_cjedzui$art_c; $art_iknvqsvkb$art_i++) {
        var t = themes[$art_iknvqsvkb$art_i];
