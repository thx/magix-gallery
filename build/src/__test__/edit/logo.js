...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izeqhrabk$art_i = 0, $art_ccszwxsx$art_c = themes.length; $art_izeqhrabk$art_i < $art_ccszwxsx$art_c; $art_izeqhrabk$art_i++) {    var t = themes[$art_izeqhrabk$art_i]%>';
    for (var $art_izeqhrabk$art_i = 0, $art_ccszwxsx$art_c = themes.length; $art_izeqhrabk$art_i < $art_ccszwxsx$art_c; $art_izeqhrabk$art_i++) {
        var t = themes[$art_izeqhrabk$art_i];
