...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ierjnuetykcu$art_i = 0, $art_cwyyuegbud$art_c = themes.length; $art_ierjnuetykcu$art_i < $art_cwyyuegbud$art_c; $art_ierjnuetykcu$art_i++) {    var t = themes[$art_ierjnuetykcu$art_i]%>';
    for (var $art_ierjnuetykcu$art_i = 0, $art_cwyyuegbud$art_c = themes.length; $art_ierjnuetykcu$art_i < $art_cwyyuegbud$art_c; $art_ierjnuetykcu$art_i++) {
        var t = themes[$art_ierjnuetykcu$art_i];
