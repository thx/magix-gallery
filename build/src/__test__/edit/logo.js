...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imrobavxy$art_i = 0, $art_caxtvjla$art_c = themes.length; $art_imrobavxy$art_i < $art_caxtvjla$art_c; $art_imrobavxy$art_i++) {    var t = themes[$art_imrobavxy$art_i]%>';
    for (var $art_imrobavxy$art_i = 0, $art_caxtvjla$art_c = themes.length; $art_imrobavxy$art_i < $art_caxtvjla$art_c; $art_imrobavxy$art_i++) {
        var t = themes[$art_imrobavxy$art_i];
