...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irtbpywvlk$art_i = 0, $art_cpezgcowl$art_c = themes.length; $art_irtbpywvlk$art_i < $art_cpezgcowl$art_c; $art_irtbpywvlk$art_i++) {    var t = themes[$art_irtbpywvlk$art_i]%>';
    for (var $art_irtbpywvlk$art_i = 0, $art_cpezgcowl$art_c = themes.length; $art_irtbpywvlk$art_i < $art_cpezgcowl$art_c; $art_irtbpywvlk$art_i++) {
        var t = themes[$art_irtbpywvlk$art_i];
