...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikxblsfc$art_i = 0, $art_cfhqltozs$art_c = themes.length; $art_ikxblsfc$art_i < $art_cfhqltozs$art_c; $art_ikxblsfc$art_i++) {    var t = themes[$art_ikxblsfc$art_i]%>';
    for (var $art_ikxblsfc$art_i = 0, $art_cfhqltozs$art_c = themes.length; $art_ikxblsfc$art_i < $art_cfhqltozs$art_c; $art_ikxblsfc$art_i++) {
        var t = themes[$art_ikxblsfc$art_i];
