...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixmkmemcng$art_i = 0, $art_ckxoaproph$art_c = themes.length; $art_ixmkmemcng$art_i < $art_ckxoaproph$art_c; $art_ixmkmemcng$art_i++) {    var t = themes[$art_ixmkmemcng$art_i]%>';
    for (var $art_ixmkmemcng$art_i = 0, $art_ckxoaproph$art_c = themes.length; $art_ixmkmemcng$art_i < $art_ckxoaproph$art_c; $art_ixmkmemcng$art_i++) {
        var t = themes[$art_ixmkmemcng$art_i];
