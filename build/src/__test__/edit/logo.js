...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iefosxsyu$art_i = 0, $art_cntnxxin$art_c = themes.length; $art_iefosxsyu$art_i < $art_cntnxxin$art_c; $art_iefosxsyu$art_i++) {    var t = themes[$art_iefosxsyu$art_i]%>';
    for (var $art_iefosxsyu$art_i = 0, $art_cntnxxin$art_c = themes.length; $art_iefosxsyu$art_i < $art_cntnxxin$art_c; $art_iefosxsyu$art_i++) {
        var t = themes[$art_iefosxsyu$art_i];
