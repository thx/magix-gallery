...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iknizfz$art_i = 0, $art_cyjpef$art_c = themes.length; $art_iknizfz$art_i < $art_cyjpef$art_c; $art_iknizfz$art_i++) {    var t = themes[$art_iknizfz$art_i]%>';
    for (var $art_iknizfz$art_i = 0, $art_cyjpef$art_c = themes.length; $art_iknizfz$art_i < $art_cyjpef$art_c; $art_iknizfz$art_i++) {
        var t = themes[$art_iknizfz$art_i];
