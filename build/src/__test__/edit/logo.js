...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijnwjpeyd$art_i = 0, $art_ckxvnufte$art_c = themes.length; $art_ijnwjpeyd$art_i < $art_ckxvnufte$art_c; $art_ijnwjpeyd$art_i++) {    var t = themes[$art_ijnwjpeyd$art_i]%>';
    for (var $art_ijnwjpeyd$art_i = 0, $art_ckxvnufte$art_c = themes.length; $art_ijnwjpeyd$art_i < $art_ckxvnufte$art_c; $art_ijnwjpeyd$art_i++) {
        var t = themes[$art_ijnwjpeyd$art_i];
