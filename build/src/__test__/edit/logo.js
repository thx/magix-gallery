...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioyovhyu$art_i = 0, $art_ctikrwyy$art_c = themes.length; $art_ioyovhyu$art_i < $art_ctikrwyy$art_c; $art_ioyovhyu$art_i++) {    var t = themes[$art_ioyovhyu$art_i]%>';
    for (var $art_ioyovhyu$art_i = 0, $art_ctikrwyy$art_c = themes.length; $art_ioyovhyu$art_i < $art_ctikrwyy$art_c; $art_ioyovhyu$art_i++) {
        var t = themes[$art_ioyovhyu$art_i];
