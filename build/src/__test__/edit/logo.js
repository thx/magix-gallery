...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivtqjnwuyi$art_i = 0, $art_cycvlrt$art_c = themes.length; $art_ivtqjnwuyi$art_i < $art_cycvlrt$art_c; $art_ivtqjnwuyi$art_i++) {    var t = themes[$art_ivtqjnwuyi$art_i]%>';
    for (var $art_ivtqjnwuyi$art_i = 0, $art_cycvlrt$art_c = themes.length; $art_ivtqjnwuyi$art_i < $art_cycvlrt$art_c; $art_ivtqjnwuyi$art_i++) {
        var t = themes[$art_ivtqjnwuyi$art_i];
