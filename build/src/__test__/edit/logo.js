...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izumbongds$art_i = 0, $art_cmozddsmn$art_c = themes.length; $art_izumbongds$art_i < $art_cmozddsmn$art_c; $art_izumbongds$art_i++) {    var t = themes[$art_izumbongds$art_i]%>';
    for (var $art_izumbongds$art_i = 0, $art_cmozddsmn$art_c = themes.length; $art_izumbongds$art_i < $art_cmozddsmn$art_c; $art_izumbongds$art_i++) {
        var t = themes[$art_izumbongds$art_i];
