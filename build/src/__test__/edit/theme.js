/*
    ...
    loader: cmd_es
 */
define("__test__/edit/theme",["magix","$","../../mx-color/util"],(require,exports,module)=>{
/*Magix,$,Util*/
...
module.exports = Magix.View.extend({
    ...
    '@{get.base}': function (base) {
        ...
        var rgb = Util.toRgb(brand);
        var r = rgb.r, g = rgb.g, b = rgb.b;
        var brandHover = base['--color-brand-hover'] || Util.shade(brand, 0.1), brandVs = base['--color-brand-vs'] || '#14c9ce', brandLight = base['--color-brand-light'] || "rgba(" + r + ", " + g + ", " + b + ", .2)", brandOpacity = base['--color-brand-opacity'] || "rgba(" + r + ", " + g + ", " + b + ", .1)";
