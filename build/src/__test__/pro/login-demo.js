...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryo:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryo:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryo:b" class="_zs_gallery___test___pro_login-demo_-demo"><div mxa="_zs_galleryo:c" class="_zs_gallery___test___pro_login-demo_-login-wrapper"><iframe src="';
    $line = 5;
    $art = '=src';
    ;
    $p += ($expr = '<%=src%>', $e(src)) + '" frameborder="0" width="100%" height="340" allowtransparency="true" scrolling="no" marginheight="0" marginwidth="0" border="0"></iframe></div></div></div><div mxa="_zs_galleryo:d" class="clearfix"><div mxa="_zs_galleryo:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_galleryo:_" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
