...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibfakxbods$art_i = 0, $art_cvorgnckop$art_c = checkboxes.length; $art_ibfakxbods$art_i < $art_cvorgnckop$art_c; $art_ibfakxbods$art_i++) {    var c = checkboxes[$art_ibfakxbods$art_i]%>';
    for (var $art_ibfakxbods$art_i = 0, $art_cvorgnckop$art_c = checkboxes.length; $art_ibfakxbods$art_i < $art_cvorgnckop$art_c; $art_ibfakxbods$art_i++) {
        var c = checkboxes[$art_ibfakxbods$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwqiepjroek$art_i = 0, $art_coreclhapo$art_c = radioes.length; $art_iwqiepjroek$art_i < $art_coreclhapo$art_c; $art_iwqiepjroek$art_i++) {    var r = radioes[$art_iwqiepjroek$art_i]%>';
    for (var $art_iwqiepjroek$art_i = 0, $art_coreclhapo$art_c = radioes.length; $art_iwqiepjroek$art_i < $art_coreclhapo$art_c; $art_iwqiepjroek$art_i++) {
        var r = radioes[$art_iwqiepjroek$art_i];
