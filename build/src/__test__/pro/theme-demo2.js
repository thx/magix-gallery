...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijmtflqyo$art_i = 0, $art_cvkktltor$art_c = checkboxes.length; $art_ijmtflqyo$art_i < $art_cvkktltor$art_c; $art_ijmtflqyo$art_i++) {    var c = checkboxes[$art_ijmtflqyo$art_i]%>';
    for (var $art_ijmtflqyo$art_i = 0, $art_cvkktltor$art_c = checkboxes.length; $art_ijmtflqyo$art_i < $art_cvkktltor$art_c; $art_ijmtflqyo$art_i++) {
        var c = checkboxes[$art_ijmtflqyo$art_i];
    ...
    ;
    $expr = '<%for (var $art_iyjewx$art_i = 0, $art_cwzbonmq$art_c = radioes.length; $art_iyjewx$art_i < $art_cwzbonmq$art_c; $art_iyjewx$art_i++) {    var r = radioes[$art_iyjewx$art_i]%>';
    for (var $art_iyjewx$art_i = 0, $art_cwzbonmq$art_c = radioes.length; $art_iyjewx$art_i < $art_cwzbonmq$art_c; $art_iyjewx$art_i++) {
        var r = radioes[$art_iyjewx$art_i];
