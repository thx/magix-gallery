...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivjzxhnb$art_i = 0, $art_cifyeevgo$art_c = checkboxes.length; $art_ivjzxhnb$art_i < $art_cifyeevgo$art_c; $art_ivjzxhnb$art_i++) {    var c = checkboxes[$art_ivjzxhnb$art_i]%>';
    for (var $art_ivjzxhnb$art_i = 0, $art_cifyeevgo$art_c = checkboxes.length; $art_ivjzxhnb$art_i < $art_cifyeevgo$art_c; $art_ivjzxhnb$art_i++) {
        var c = checkboxes[$art_ivjzxhnb$art_i];
    ...
    ;
    $expr = '<%for (var $art_ijamddz$art_i = 0, $art_cxnmvyi$art_c = radioes.length; $art_ijamddz$art_i < $art_cxnmvyi$art_c; $art_ijamddz$art_i++) {    var r = radioes[$art_ijamddz$art_i]%>';
    for (var $art_ijamddz$art_i = 0, $art_cxnmvyi$art_c = radioes.length; $art_ijamddz$art_i < $art_cxnmvyi$art_c; $art_ijamddz$art_i++) {
        var r = radioes[$art_ijamddz$art_i];
