...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuxhlzf$art_i = 0, $art_czupnlvgbh$art_c = checkboxes.length; $art_iuxhlzf$art_i < $art_czupnlvgbh$art_c; $art_iuxhlzf$art_i++) {    var c = checkboxes[$art_iuxhlzf$art_i]%>';
    for (var $art_iuxhlzf$art_i = 0, $art_czupnlvgbh$art_c = checkboxes.length; $art_iuxhlzf$art_i < $art_czupnlvgbh$art_c; $art_iuxhlzf$art_i++) {
        var c = checkboxes[$art_iuxhlzf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixjowtl$art_i = 0, $art_clkfffx$art_c = radioes.length; $art_ixjowtl$art_i < $art_clkfffx$art_c; $art_ixjowtl$art_i++) {    var r = radioes[$art_ixjowtl$art_i]%>';
    for (var $art_ixjowtl$art_i = 0, $art_clkfffx$art_c = radioes.length; $art_ixjowtl$art_i < $art_clkfffx$art_c; $art_ixjowtl$art_i++) {
        var r = radioes[$art_ixjowtl$art_i];
