...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwwwdtfmpqf$art_i = 0, $art_ckvsdqalnlq$art_c = checkboxes.length; $art_iwwwdtfmpqf$art_i < $art_ckvsdqalnlq$art_c; $art_iwwwdtfmpqf$art_i++) {    var c = checkboxes[$art_iwwwdtfmpqf$art_i]%>';
    for (var $art_iwwwdtfmpqf$art_i = 0, $art_ckvsdqalnlq$art_c = checkboxes.length; $art_iwwwdtfmpqf$art_i < $art_ckvsdqalnlq$art_c; $art_iwwwdtfmpqf$art_i++) {
        var c = checkboxes[$art_iwwwdtfmpqf$art_i];
    ...
    ;
    $expr = '<%for (var $art_iyigmwibpc$art_i = 0, $art_cuytea$art_c = radioes.length; $art_iyigmwibpc$art_i < $art_cuytea$art_c; $art_iyigmwibpc$art_i++) {    var r = radioes[$art_iyigmwibpc$art_i]%>';
    for (var $art_iyigmwibpc$art_i = 0, $art_cuytea$art_c = radioes.length; $art_iyigmwibpc$art_i < $art_cuytea$art_c; $art_iyigmwibpc$art_i++) {
        var r = radioes[$art_iyigmwibpc$art_i];
