...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibjfprim$art_i = 0, $art_cvpavyqlq$art_c = checkboxes.length; $art_ibjfprim$art_i < $art_cvpavyqlq$art_c; $art_ibjfprim$art_i++) {    var c = checkboxes[$art_ibjfprim$art_i]%>';
    for (var $art_ibjfprim$art_i = 0, $art_cvpavyqlq$art_c = checkboxes.length; $art_ibjfprim$art_i < $art_cvpavyqlq$art_c; $art_ibjfprim$art_i++) {
        var c = checkboxes[$art_ibjfprim$art_i];
    ...
    ;
    $expr = '<%for (var $art_illmiwng$art_i = 0, $art_cxystycugdf$art_c = radioes.length; $art_illmiwng$art_i < $art_cxystycugdf$art_c; $art_illmiwng$art_i++) {    var r = radioes[$art_illmiwng$art_i]%>';
    for (var $art_illmiwng$art_i = 0, $art_cxystycugdf$art_c = radioes.length; $art_illmiwng$art_i < $art_cxystycugdf$art_c; $art_illmiwng$art_i++) {
        var r = radioes[$art_illmiwng$art_i];
