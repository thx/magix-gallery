...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idqcnkszi$art_i = 0, $art_coheqnnrb$art_c = checkboxes.length; $art_idqcnkszi$art_i < $art_coheqnnrb$art_c; $art_idqcnkszi$art_i++) {    var c = checkboxes[$art_idqcnkszi$art_i]%>';
    for (var $art_idqcnkszi$art_i = 0, $art_coheqnnrb$art_c = checkboxes.length; $art_idqcnkszi$art_i < $art_coheqnnrb$art_c; $art_idqcnkszi$art_i++) {
        var c = checkboxes[$art_idqcnkszi$art_i];
    ...
    ;
    $expr = '<%for (var $art_icamtogm$art_i = 0, $art_cxmkixlcmhd$art_c = radioes.length; $art_icamtogm$art_i < $art_cxmkixlcmhd$art_c; $art_icamtogm$art_i++) {    var r = radioes[$art_icamtogm$art_i]%>';
    for (var $art_icamtogm$art_i = 0, $art_cxmkixlcmhd$art_c = radioes.length; $art_icamtogm$art_i < $art_cxmkixlcmhd$art_c; $art_icamtogm$art_i++) {
        var r = radioes[$art_icamtogm$art_i];
