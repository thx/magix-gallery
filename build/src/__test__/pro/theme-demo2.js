...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ibarkarxx$art_i = 0, $art_cfclbinwht$art_c = checkboxes.length; $art_ibarkarxx$art_i < $art_cfclbinwht$art_c; $art_ibarkarxx$art_i++) {    var c = checkboxes[$art_ibarkarxx$art_i]%>';
    for (var $art_ibarkarxx$art_i = 0, $art_cfclbinwht$art_c = checkboxes.length; $art_ibarkarxx$art_i < $art_cfclbinwht$art_c; $art_ibarkarxx$art_i++) {
        var c = checkboxes[$art_ibarkarxx$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iytpqckh$art_i = 0, $art_cotnhwrgsh$art_c = radioes.length; $art_iytpqckh$art_i < $art_cotnhwrgsh$art_c; $art_iytpqckh$art_i++) {    var r = radioes[$art_iytpqckh$art_i]%>';
    for (var $art_iytpqckh$art_i = 0, $art_cotnhwrgsh$art_c = radioes.length; $art_iytpqckh$art_i < $art_cotnhwrgsh$art_c; $art_iytpqckh$art_i++) {
        var r = radioes[$art_iytpqckh$art_i];
