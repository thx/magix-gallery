...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibciymo$art_i = 0, $art_ctrvwylb$art_c = checkboxes.length; $art_ibciymo$art_i < $art_ctrvwylb$art_c; $art_ibciymo$art_i++) {    var c = checkboxes[$art_ibciymo$art_i]%>';
    for (var $art_ibciymo$art_i = 0, $art_ctrvwylb$art_c = checkboxes.length; $art_ibciymo$art_i < $art_ctrvwylb$art_c; $art_ibciymo$art_i++) {
        var c = checkboxes[$art_ibciymo$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikssyrn$art_i = 0, $art_ciscsawofi$art_c = radioes.length; $art_ikssyrn$art_i < $art_ciscsawofi$art_c; $art_ikssyrn$art_i++) {    var r = radioes[$art_ikssyrn$art_i]%>';
    for (var $art_ikssyrn$art_i = 0, $art_ciscsawofi$art_c = radioes.length; $art_ikssyrn$art_i < $art_ciscsawofi$art_c; $art_ikssyrn$art_i++) {
        var r = radioes[$art_ikssyrn$art_i];
