...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iufcyoktf$art_i = 0, $art_csfojwmp$art_c = checkboxes.length; $art_iufcyoktf$art_i < $art_csfojwmp$art_c; $art_iufcyoktf$art_i++) {    var c = checkboxes[$art_iufcyoktf$art_i]%>';
    for (var $art_iufcyoktf$art_i = 0, $art_csfojwmp$art_c = checkboxes.length; $art_iufcyoktf$art_i < $art_csfojwmp$art_c; $art_iufcyoktf$art_i++) {
        var c = checkboxes[$art_iufcyoktf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivqyrnalz$art_i = 0, $art_cjjhdvwh$art_c = radioes.length; $art_ivqyrnalz$art_i < $art_cjjhdvwh$art_c; $art_ivqyrnalz$art_i++) {    var r = radioes[$art_ivqyrnalz$art_i]%>';
    for (var $art_ivqyrnalz$art_i = 0, $art_cjjhdvwh$art_c = radioes.length; $art_ivqyrnalz$art_i < $art_cjjhdvwh$art_c; $art_ivqyrnalz$art_i++) {
        var r = radioes[$art_ivqyrnalz$art_i];
