...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imvmiphy$art_i = 0, $art_cxfzmxvsj$art_c = checkboxes.length; $art_imvmiphy$art_i < $art_cxfzmxvsj$art_c; $art_imvmiphy$art_i++) {    var c = checkboxes[$art_imvmiphy$art_i]%>';
    for (var $art_imvmiphy$art_i = 0, $art_cxfzmxvsj$art_c = checkboxes.length; $art_imvmiphy$art_i < $art_cxfzmxvsj$art_c; $art_imvmiphy$art_i++) {
        var c = checkboxes[$art_imvmiphy$art_i];
    ...
    ;
    $expr = '<%for (var $art_iizcianlr$art_i = 0, $art_cfmudqkfr$art_c = radioes.length; $art_iizcianlr$art_i < $art_cfmudqkfr$art_c; $art_iizcianlr$art_i++) {    var r = radioes[$art_iizcianlr$art_i]%>';
    for (var $art_iizcianlr$art_i = 0, $art_cfmudqkfr$art_c = radioes.length; $art_iizcianlr$art_i < $art_cfmudqkfr$art_c; $art_iizcianlr$art_i++) {
        var r = radioes[$art_iizcianlr$art_i];
