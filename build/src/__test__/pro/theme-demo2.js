...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iknopubmdmh$art_i = 0, $art_ccihymxql$art_c = checkboxes.length; $art_iknopubmdmh$art_i < $art_ccihymxql$art_c; $art_iknopubmdmh$art_i++) {    var c = checkboxes[$art_iknopubmdmh$art_i]%>';
    for (var $art_iknopubmdmh$art_i = 0, $art_ccihymxql$art_c = checkboxes.length; $art_iknopubmdmh$art_i < $art_ccihymxql$art_c; $art_iknopubmdmh$art_i++) {
        var c = checkboxes[$art_iknopubmdmh$art_i];
    ...
    ;
    $expr = '<%for (var $art_igltfiiii$art_i = 0, $art_cgzajrpb$art_c = radioes.length; $art_igltfiiii$art_i < $art_cgzajrpb$art_c; $art_igltfiiii$art_i++) {    var r = radioes[$art_igltfiiii$art_i]%>';
    for (var $art_igltfiiii$art_i = 0, $art_cgzajrpb$art_c = radioes.length; $art_igltfiiii$art_i < $art_cgzajrpb$art_c; $art_igltfiiii$art_i++) {
        var r = radioes[$art_igltfiiii$art_i];
