...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iabbotklk$art_i = 0, $art_cmuynopix$art_c = checkboxes.length; $art_iabbotklk$art_i < $art_cmuynopix$art_c; $art_iabbotklk$art_i++) {    var c = checkboxes[$art_iabbotklk$art_i]%>';
    for (var $art_iabbotklk$art_i = 0, $art_cmuynopix$art_c = checkboxes.length; $art_iabbotklk$art_i < $art_cmuynopix$art_c; $art_iabbotklk$art_i++) {
        var c = checkboxes[$art_iabbotklk$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilbrgvcvr$art_i = 0, $art_cyrhzkodujk$art_c = radioes.length; $art_ilbrgvcvr$art_i < $art_cyrhzkodujk$art_c; $art_ilbrgvcvr$art_i++) {    var r = radioes[$art_ilbrgvcvr$art_i]%>';
    for (var $art_ilbrgvcvr$art_i = 0, $art_cyrhzkodujk$art_c = radioes.length; $art_ilbrgvcvr$art_i < $art_cyrhzkodujk$art_c; $art_ilbrgvcvr$art_i++) {
        var r = radioes[$art_ilbrgvcvr$art_i];
