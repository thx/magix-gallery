...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iggjukkjht$art_i = 0, $art_clcbxbfkv$art_c = checkboxes.length; $art_iggjukkjht$art_i < $art_clcbxbfkv$art_c; $art_iggjukkjht$art_i++) {    var c = checkboxes[$art_iggjukkjht$art_i]%>';
    for (var $art_iggjukkjht$art_i = 0, $art_clcbxbfkv$art_c = checkboxes.length; $art_iggjukkjht$art_i < $art_clcbxbfkv$art_c; $art_iggjukkjht$art_i++) {
        var c = checkboxes[$art_iggjukkjht$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwnpmlfedef$art_i = 0, $art_cpqmpqxf$art_c = radioes.length; $art_iwnpmlfedef$art_i < $art_cpqmpqxf$art_c; $art_iwnpmlfedef$art_i++) {    var r = radioes[$art_iwnpmlfedef$art_i]%>';
    for (var $art_iwnpmlfedef$art_i = 0, $art_cpqmpqxf$art_c = radioes.length; $art_iwnpmlfedef$art_i < $art_cpqmpqxf$art_c; $art_iwnpmlfedef$art_i++) {
        var r = radioes[$art_iwnpmlfedef$art_i];
