...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipzltese$art_i = 0, $art_cfbfboddtzu$art_c = checkboxes.length; $art_ipzltese$art_i < $art_cfbfboddtzu$art_c; $art_ipzltese$art_i++) {    var c = checkboxes[$art_ipzltese$art_i]%>';
    for (var $art_ipzltese$art_i = 0, $art_cfbfboddtzu$art_c = checkboxes.length; $art_ipzltese$art_i < $art_cfbfboddtzu$art_c; $art_ipzltese$art_i++) {
        var c = checkboxes[$art_ipzltese$art_i];
    ...
    ;
    $expr = '<%for (var $art_iiogitcqgc$art_i = 0, $art_cddmbnxqtkb$art_c = radioes.length; $art_iiogitcqgc$art_i < $art_cddmbnxqtkb$art_c; $art_iiogitcqgc$art_i++) {    var r = radioes[$art_iiogitcqgc$art_i]%>';
    for (var $art_iiogitcqgc$art_i = 0, $art_cddmbnxqtkb$art_c = radioes.length; $art_iiogitcqgc$art_i < $art_cddmbnxqtkb$art_c; $art_iiogitcqgc$art_i++) {
        var r = radioes[$art_iiogitcqgc$art_i];
