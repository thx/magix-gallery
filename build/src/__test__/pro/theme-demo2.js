...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igxtffma$art_i = 0, $art_ceeilvlkctu$art_c = checkboxes.length; $art_igxtffma$art_i < $art_ceeilvlkctu$art_c; $art_igxtffma$art_i++) {    var c = checkboxes[$art_igxtffma$art_i]%>';
    for (var $art_igxtffma$art_i = 0, $art_ceeilvlkctu$art_c = checkboxes.length; $art_igxtffma$art_i < $art_ceeilvlkctu$art_c; $art_igxtffma$art_i++) {
        var c = checkboxes[$art_igxtffma$art_i];
    ...
    ;
    $expr = '<%for (var $art_ijmbeob$art_i = 0, $art_ctkjzvihyji$art_c = radioes.length; $art_ijmbeob$art_i < $art_ctkjzvihyji$art_c; $art_ijmbeob$art_i++) {    var r = radioes[$art_ijmbeob$art_i]%>';
    for (var $art_ijmbeob$art_i = 0, $art_ctkjzvihyji$art_c = radioes.length; $art_ijmbeob$art_i < $art_ctkjzvihyji$art_c; $art_ijmbeob$art_i++) {
        var r = radioes[$art_ijmbeob$art_i];
