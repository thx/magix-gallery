...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izkfmhrvg$art_i = 0, $art_cmpwycuksf$art_c = checkboxes.length; $art_izkfmhrvg$art_i < $art_cmpwycuksf$art_c; $art_izkfmhrvg$art_i++) {    var c = checkboxes[$art_izkfmhrvg$art_i]%>';
    for (var $art_izkfmhrvg$art_i = 0, $art_cmpwycuksf$art_c = checkboxes.length; $art_izkfmhrvg$art_i < $art_cmpwycuksf$art_c; $art_izkfmhrvg$art_i++) {
        var c = checkboxes[$art_izkfmhrvg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikxwopm$art_i = 0, $art_cmtagmljsa$art_c = radioes.length; $art_ikxwopm$art_i < $art_cmtagmljsa$art_c; $art_ikxwopm$art_i++) {    var r = radioes[$art_ikxwopm$art_i]%>';
    for (var $art_ikxwopm$art_i = 0, $art_cmtagmljsa$art_c = radioes.length; $art_ikxwopm$art_i < $art_cmtagmljsa$art_c; $art_ikxwopm$art_i++) {
        var r = radioes[$art_ikxwopm$art_i];
