...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivbijt$art_i = 0, $art_cvjeugf$art_c = checkboxes.length; $art_ivbijt$art_i < $art_cvjeugf$art_c; $art_ivbijt$art_i++) {    var c = checkboxes[$art_ivbijt$art_i]%>';
    for (var $art_ivbijt$art_i = 0, $art_cvjeugf$art_c = checkboxes.length; $art_ivbijt$art_i < $art_cvjeugf$art_c; $art_ivbijt$art_i++) {
        var c = checkboxes[$art_ivbijt$art_i];
    ...
    ;
    $expr = '<%for (var $art_ionhzshe$art_i = 0, $art_cnxwxknhhwpg$art_c = radioes.length; $art_ionhzshe$art_i < $art_cnxwxknhhwpg$art_c; $art_ionhzshe$art_i++) {    var r = radioes[$art_ionhzshe$art_i]%>';
    for (var $art_ionhzshe$art_i = 0, $art_cnxwxknhhwpg$art_c = radioes.length; $art_ionhzshe$art_i < $art_cnxwxknhhwpg$art_c; $art_ionhzshe$art_i++) {
        var r = radioes[$art_ionhzshe$art_i];
