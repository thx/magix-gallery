...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iocbiclmmj$art_i = 0, $art_cndgvrr$art_c = checkboxes.length; $art_iocbiclmmj$art_i < $art_cndgvrr$art_c; $art_iocbiclmmj$art_i++) {    var c = checkboxes[$art_iocbiclmmj$art_i]%>';
    for (var $art_iocbiclmmj$art_i = 0, $art_cndgvrr$art_c = checkboxes.length; $art_iocbiclmmj$art_i < $art_cndgvrr$art_c; $art_iocbiclmmj$art_i++) {
        var c = checkboxes[$art_iocbiclmmj$art_i];
    ...
    ;
    $expr = '<%for (var $art_inchyxfq$art_i = 0, $art_caxclz$art_c = radioes.length; $art_inchyxfq$art_i < $art_caxclz$art_c; $art_inchyxfq$art_i++) {    var r = radioes[$art_inchyxfq$art_i]%>';
    for (var $art_inchyxfq$art_i = 0, $art_caxclz$art_c = radioes.length; $art_inchyxfq$art_i < $art_caxclz$art_c; $art_inchyxfq$art_i++) {
        var r = radioes[$art_inchyxfq$art_i];
