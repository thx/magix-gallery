...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itnhregz$art_i = 0, $art_cywyajbg$art_c = checkboxes.length; $art_itnhregz$art_i < $art_cywyajbg$art_c; $art_itnhregz$art_i++) {    var c = checkboxes[$art_itnhregz$art_i]%>';
    for (var $art_itnhregz$art_i = 0, $art_cywyajbg$art_c = checkboxes.length; $art_itnhregz$art_i < $art_cywyajbg$art_c; $art_itnhregz$art_i++) {
        var c = checkboxes[$art_itnhregz$art_i];
    ...
    ;
    $expr = '<%for (var $art_iauepejrxo$art_i = 0, $art_ciwepxneg$art_c = radioes.length; $art_iauepejrxo$art_i < $art_ciwepxneg$art_c; $art_iauepejrxo$art_i++) {    var r = radioes[$art_iauepejrxo$art_i]%>';
    for (var $art_iauepejrxo$art_i = 0, $art_ciwepxneg$art_c = radioes.length; $art_iauepejrxo$art_i < $art_ciwepxneg$art_c; $art_iauepejrxo$art_i++) {
        var r = radioes[$art_iauepejrxo$art_i];
