...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijwgazmq$art_i = 0, $art_coeufz$art_c = checkboxes.length; $art_ijwgazmq$art_i < $art_coeufz$art_c; $art_ijwgazmq$art_i++) {    var c = checkboxes[$art_ijwgazmq$art_i]%>';
    for (var $art_ijwgazmq$art_i = 0, $art_coeufz$art_c = checkboxes.length; $art_ijwgazmq$art_i < $art_coeufz$art_c; $art_ijwgazmq$art_i++) {
        var c = checkboxes[$art_ijwgazmq$art_i];
    ...
    ;
    $expr = '<%for (var $art_iphjxndg$art_i = 0, $art_ckslymqdd$art_c = radioes.length; $art_iphjxndg$art_i < $art_ckslymqdd$art_c; $art_iphjxndg$art_i++) {    var r = radioes[$art_iphjxndg$art_i]%>';
    for (var $art_iphjxndg$art_i = 0, $art_ckslymqdd$art_c = radioes.length; $art_iphjxndg$art_i < $art_ckslymqdd$art_c; $art_iphjxndg$art_i++) {
        var r = radioes[$art_iphjxndg$art_i];
