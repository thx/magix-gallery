...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iajvaadd$art_i = 0, $art_clucagopqb$art_c = checkboxes.length; $art_iajvaadd$art_i < $art_clucagopqb$art_c; $art_iajvaadd$art_i++) {    var c = checkboxes[$art_iajvaadd$art_i]%>';
    for (var $art_iajvaadd$art_i = 0, $art_clucagopqb$art_c = checkboxes.length; $art_iajvaadd$art_i < $art_clucagopqb$art_c; $art_iajvaadd$art_i++) {
        var c = checkboxes[$art_iajvaadd$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixjhqwac$art_i = 0, $art_cgwrxxtfes$art_c = radioes.length; $art_ixjhqwac$art_i < $art_cgwrxxtfes$art_c; $art_ixjhqwac$art_i++) {    var r = radioes[$art_ixjhqwac$art_i]%>';
    for (var $art_ixjhqwac$art_i = 0, $art_cgwrxxtfes$art_c = radioes.length; $art_ixjhqwac$art_i < $art_cgwrxxtfes$art_c; $art_ixjhqwac$art_i++) {
        var r = radioes[$art_ixjhqwac$art_i];
