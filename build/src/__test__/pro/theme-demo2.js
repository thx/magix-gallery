...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irukysn$art_i = 0, $art_cnutvpti$art_c = checkboxes.length; $art_irukysn$art_i < $art_cnutvpti$art_c; $art_irukysn$art_i++) {    var c = checkboxes[$art_irukysn$art_i]%>';
    for (var $art_irukysn$art_i = 0, $art_cnutvpti$art_c = checkboxes.length; $art_irukysn$art_i < $art_cnutvpti$art_c; $art_irukysn$art_i++) {
        var c = checkboxes[$art_irukysn$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibxlxqxiq$art_i = 0, $art_cflxedkllu$art_c = radioes.length; $art_ibxlxqxiq$art_i < $art_cflxedkllu$art_c; $art_ibxlxqxiq$art_i++) {    var r = radioes[$art_ibxlxqxiq$art_i]%>';
    for (var $art_ibxlxqxiq$art_i = 0, $art_cflxedkllu$art_c = radioes.length; $art_ibxlxqxiq$art_i < $art_cflxedkllu$art_c; $art_ibxlxqxiq$art_i++) {
        var r = radioes[$art_ibxlxqxiq$art_i];
