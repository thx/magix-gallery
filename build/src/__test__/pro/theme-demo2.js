...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyugdksatlvf$art_i = 0, $art_curxhl$art_c = checkboxes.length; $art_iyugdksatlvf$art_i < $art_curxhl$art_c; $art_iyugdksatlvf$art_i++) {    var c = checkboxes[$art_iyugdksatlvf$art_i]%>';
    for (var $art_iyugdksatlvf$art_i = 0, $art_curxhl$art_c = checkboxes.length; $art_iyugdksatlvf$art_i < $art_curxhl$art_c; $art_iyugdksatlvf$art_i++) {
        var c = checkboxes[$art_iyugdksatlvf$art_i];
    ...
    ;
    $expr = '<%for (var $art_icilbortqm$art_i = 0, $art_cmdqipdcrx$art_c = radioes.length; $art_icilbortqm$art_i < $art_cmdqipdcrx$art_c; $art_icilbortqm$art_i++) {    var r = radioes[$art_icilbortqm$art_i]%>';
    for (var $art_icilbortqm$art_i = 0, $art_cmdqipdcrx$art_c = radioes.length; $art_icilbortqm$art_i < $art_cmdqipdcrx$art_c; $art_icilbortqm$art_i++) {
        var r = radioes[$art_icilbortqm$art_i];
