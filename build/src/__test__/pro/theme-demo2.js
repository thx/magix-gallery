...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipopaoejjr$art_i = 0, $art_cfdhvky$art_c = checkboxes.length; $art_ipopaoejjr$art_i < $art_cfdhvky$art_c; $art_ipopaoejjr$art_i++) {    var c = checkboxes[$art_ipopaoejjr$art_i]%>';
    for (var $art_ipopaoejjr$art_i = 0, $art_cfdhvky$art_c = checkboxes.length; $art_ipopaoejjr$art_i < $art_cfdhvky$art_c; $art_ipopaoejjr$art_i++) {
        var c = checkboxes[$art_ipopaoejjr$art_i];
    ...
    ;
    $expr = '<%for (var $art_izfkhdzuknc$art_i = 0, $art_cwbbqekvz$art_c = radioes.length; $art_izfkhdzuknc$art_i < $art_cwbbqekvz$art_c; $art_izfkhdzuknc$art_i++) {    var r = radioes[$art_izfkhdzuknc$art_i]%>';
    for (var $art_izfkhdzuknc$art_i = 0, $art_cwbbqekvz$art_c = radioes.length; $art_izfkhdzuknc$art_i < $art_cwbbqekvz$art_c; $art_izfkhdzuknc$art_i++) {
        var r = radioes[$art_izfkhdzuknc$art_i];
