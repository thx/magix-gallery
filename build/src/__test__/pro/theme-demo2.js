...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyx$art_i = 0, $art_cyqngret$art_c = checkboxes.length; $art_iyx$art_i < $art_cyqngret$art_c; $art_iyx$art_i++) {    var c = checkboxes[$art_iyx$art_i]%>';
    for (var $art_iyx$art_i = 0, $art_cyqngret$art_c = checkboxes.length; $art_iyx$art_i < $art_cyqngret$art_c; $art_iyx$art_i++) {
        var c = checkboxes[$art_iyx$art_i];
    ...
    ;
    $expr = '<%for (var $art_iobcugryk$art_i = 0, $art_cltbnpryp$art_c = radioes.length; $art_iobcugryk$art_i < $art_cltbnpryp$art_c; $art_iobcugryk$art_i++) {    var r = radioes[$art_iobcugryk$art_i]%>';
    for (var $art_iobcugryk$art_i = 0, $art_cltbnpryp$art_c = radioes.length; $art_iobcugryk$art_i < $art_cltbnpryp$art_c; $art_iobcugryk$art_i++) {
        var r = radioes[$art_iobcugryk$art_i];
