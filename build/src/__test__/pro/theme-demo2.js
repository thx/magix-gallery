...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioslpct$art_i = 0, $art_cxandiqve$art_c = checkboxes.length; $art_ioslpct$art_i < $art_cxandiqve$art_c; $art_ioslpct$art_i++) {    var c = checkboxes[$art_ioslpct$art_i]%>';
    for (var $art_ioslpct$art_i = 0, $art_cxandiqve$art_c = checkboxes.length; $art_ioslpct$art_i < $art_cxandiqve$art_c; $art_ioslpct$art_i++) {
        var c = checkboxes[$art_ioslpct$art_i];
    ...
    ;
    $expr = '<%for (var $art_irqyakawca$art_i = 0, $art_cfsmopdtgd$art_c = radioes.length; $art_irqyakawca$art_i < $art_cfsmopdtgd$art_c; $art_irqyakawca$art_i++) {    var r = radioes[$art_irqyakawca$art_i]%>';
    for (var $art_irqyakawca$art_i = 0, $art_cfsmopdtgd$art_c = radioes.length; $art_irqyakawca$art_i < $art_cfsmopdtgd$art_c; $art_irqyakawca$art_i++) {
        var r = radioes[$art_irqyakawca$art_i];
