...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iitpohcfrh$art_i = 0, $art_ctaxnufqjc$art_c = checkboxes.length; $art_iitpohcfrh$art_i < $art_ctaxnufqjc$art_c; $art_iitpohcfrh$art_i++) {    var c = checkboxes[$art_iitpohcfrh$art_i]%>';
    for (var $art_iitpohcfrh$art_i = 0, $art_ctaxnufqjc$art_c = checkboxes.length; $art_iitpohcfrh$art_i < $art_ctaxnufqjc$art_c; $art_iitpohcfrh$art_i++) {
        var c = checkboxes[$art_iitpohcfrh$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihtwoimww$art_i = 0, $art_cbjhrfggah$art_c = radioes.length; $art_ihtwoimww$art_i < $art_cbjhrfggah$art_c; $art_ihtwoimww$art_i++) {    var r = radioes[$art_ihtwoimww$art_i]%>';
    for (var $art_ihtwoimww$art_i = 0, $art_cbjhrfggah$art_c = radioes.length; $art_ihtwoimww$art_i < $art_cbjhrfggah$art_c; $art_ihtwoimww$art_i++) {
        var r = radioes[$art_ihtwoimww$art_i];
