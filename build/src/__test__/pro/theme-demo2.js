...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwagcccup$art_i = 0, $art_cikkqimra$art_c = checkboxes.length; $art_iwagcccup$art_i < $art_cikkqimra$art_c; $art_iwagcccup$art_i++) {    var c = checkboxes[$art_iwagcccup$art_i]%>';
    for (var $art_iwagcccup$art_i = 0, $art_cikkqimra$art_c = checkboxes.length; $art_iwagcccup$art_i < $art_cikkqimra$art_c; $art_iwagcccup$art_i++) {
        var c = checkboxes[$art_iwagcccup$art_i];
    ...
    ;
    $expr = '<%for (var $art_inuoryiyb$art_i = 0, $art_cvbzqdxjh$art_c = radioes.length; $art_inuoryiyb$art_i < $art_cvbzqdxjh$art_c; $art_inuoryiyb$art_i++) {    var r = radioes[$art_inuoryiyb$art_i]%>';
    for (var $art_inuoryiyb$art_i = 0, $art_cvbzqdxjh$art_c = radioes.length; $art_inuoryiyb$art_i < $art_cvbzqdxjh$art_c; $art_inuoryiyb$art_i++) {
        var r = radioes[$art_inuoryiyb$art_i];
