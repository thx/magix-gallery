...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuyguqok$art_i = 0, $art_ckjbrcg$art_c = checkboxes.length; $art_iuyguqok$art_i < $art_ckjbrcg$art_c; $art_iuyguqok$art_i++) {    var c = checkboxes[$art_iuyguqok$art_i]%>';
    for (var $art_iuyguqok$art_i = 0, $art_ckjbrcg$art_c = checkboxes.length; $art_iuyguqok$art_i < $art_ckjbrcg$art_c; $art_iuyguqok$art_i++) {
        var c = checkboxes[$art_iuyguqok$art_i];
    ...
    ;
    $expr = '<%for (var $art_iafuvegaal$art_i = 0, $art_cdlybvgmqw$art_c = radioes.length; $art_iafuvegaal$art_i < $art_cdlybvgmqw$art_c; $art_iafuvegaal$art_i++) {    var r = radioes[$art_iafuvegaal$art_i]%>';
    for (var $art_iafuvegaal$art_i = 0, $art_cdlybvgmqw$art_c = radioes.length; $art_iafuvegaal$art_i < $art_cdlybvgmqw$art_c; $art_iafuvegaal$art_i++) {
        var r = radioes[$art_iafuvegaal$art_i];
