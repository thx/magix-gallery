...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iifxkexm$art_i = 0, $art_cskuxb$art_c = checkboxes.length; $art_iifxkexm$art_i < $art_cskuxb$art_c; $art_iifxkexm$art_i++) {    var c = checkboxes[$art_iifxkexm$art_i]%>';
    for (var $art_iifxkexm$art_i = 0, $art_cskuxb$art_c = checkboxes.length; $art_iifxkexm$art_i < $art_cskuxb$art_c; $art_iifxkexm$art_i++) {
        var c = checkboxes[$art_iifxkexm$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifkrpbtxy$art_i = 0, $art_copzkhkqq$art_c = radioes.length; $art_ifkrpbtxy$art_i < $art_copzkhkqq$art_c; $art_ifkrpbtxy$art_i++) {    var r = radioes[$art_ifkrpbtxy$art_i]%>';
    for (var $art_ifkrpbtxy$art_i = 0, $art_copzkhkqq$art_c = radioes.length; $art_ifkrpbtxy$art_i < $art_copzkhkqq$art_c; $art_ifkrpbtxy$art_i++) {
        var r = radioes[$art_ifkrpbtxy$art_i];
