...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ituiobja$art_i = 0, $art_cpxylahb$art_c = checkboxes.length; $art_ituiobja$art_i < $art_cpxylahb$art_c; $art_ituiobja$art_i++) {    var c = checkboxes[$art_ituiobja$art_i]%>';
    for (var $art_ituiobja$art_i = 0, $art_cpxylahb$art_c = checkboxes.length; $art_ituiobja$art_i < $art_cpxylahb$art_c; $art_ituiobja$art_i++) {
        var c = checkboxes[$art_ituiobja$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibkjwddvw$art_i = 0, $art_cmxyghquc$art_c = radioes.length; $art_ibkjwddvw$art_i < $art_cmxyghquc$art_c; $art_ibkjwddvw$art_i++) {    var r = radioes[$art_ibkjwddvw$art_i]%>';
    for (var $art_ibkjwddvw$art_i = 0, $art_cmxyghquc$art_c = radioes.length; $art_ibkjwddvw$art_i < $art_cmxyghquc$art_c; $art_ibkjwddvw$art_i++) {
        var r = radioes[$art_ibkjwddvw$art_i];
