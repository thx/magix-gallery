...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izwymkdilo$art_i = 0, $art_cuwtutwr$art_c = checkboxes.length; $art_izwymkdilo$art_i < $art_cuwtutwr$art_c; $art_izwymkdilo$art_i++) {    var c = checkboxes[$art_izwymkdilo$art_i]%>';
    for (var $art_izwymkdilo$art_i = 0, $art_cuwtutwr$art_c = checkboxes.length; $art_izwymkdilo$art_i < $art_cuwtutwr$art_c; $art_izwymkdilo$art_i++) {
        var c = checkboxes[$art_izwymkdilo$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikicaydkl$art_i = 0, $art_czvxcbrazm$art_c = radioes.length; $art_ikicaydkl$art_i < $art_czvxcbrazm$art_c; $art_ikicaydkl$art_i++) {    var r = radioes[$art_ikicaydkl$art_i]%>';
    for (var $art_ikicaydkl$art_i = 0, $art_czvxcbrazm$art_c = radioes.length; $art_ikicaydkl$art_i < $art_czvxcbrazm$art_c; $art_ikicaydkl$art_i++) {
        var r = radioes[$art_ikicaydkl$art_i];
