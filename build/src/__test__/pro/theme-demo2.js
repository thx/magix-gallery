...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itkjlspb$art_i = 0, $art_ctcduahqkp$art_c = checkboxes.length; $art_itkjlspb$art_i < $art_ctcduahqkp$art_c; $art_itkjlspb$art_i++) {    var c = checkboxes[$art_itkjlspb$art_i]%>';
    for (var $art_itkjlspb$art_i = 0, $art_ctcduahqkp$art_c = checkboxes.length; $art_itkjlspb$art_i < $art_ctcduahqkp$art_c; $art_itkjlspb$art_i++) {
        var c = checkboxes[$art_itkjlspb$art_i];
    ...
    ;
    $expr = '<%for (var $art_ijrza$art_i = 0, $art_cmzrfqtd$art_c = radioes.length; $art_ijrza$art_i < $art_cmzrfqtd$art_c; $art_ijrza$art_i++) {    var r = radioes[$art_ijrza$art_i]%>';
    for (var $art_ijrza$art_i = 0, $art_cmzrfqtd$art_c = radioes.length; $art_ijrza$art_i < $art_cmzrfqtd$art_c; $art_ijrza$art_i++) {
        var r = radioes[$art_ijrza$art_i];
