...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iieguibv$art_i = 0, $art_ccecqsq$art_c = checkboxes.length; $art_iieguibv$art_i < $art_ccecqsq$art_c; $art_iieguibv$art_i++) {    var c = checkboxes[$art_iieguibv$art_i]%>';
    for (var $art_iieguibv$art_i = 0, $art_ccecqsq$art_c = checkboxes.length; $art_iieguibv$art_i < $art_ccecqsq$art_c; $art_iieguibv$art_i++) {
        var c = checkboxes[$art_iieguibv$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilkvcdplpq$art_i = 0, $art_coliycjd$art_c = radioes.length; $art_ilkvcdplpq$art_i < $art_coliycjd$art_c; $art_ilkvcdplpq$art_i++) {    var r = radioes[$art_ilkvcdplpq$art_i]%>';
    for (var $art_ilkvcdplpq$art_i = 0, $art_coliycjd$art_c = radioes.length; $art_ilkvcdplpq$art_i < $art_coliycjd$art_c; $art_ilkvcdplpq$art_i++) {
        var r = radioes[$art_ilkvcdplpq$art_i];
