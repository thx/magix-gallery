...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iljlrqul$art_i = 0, $art_cpuoocnfr$art_c = checkboxes.length; $art_iljlrqul$art_i < $art_cpuoocnfr$art_c; $art_iljlrqul$art_i++) {    var c = checkboxes[$art_iljlrqul$art_i]%>';
    for (var $art_iljlrqul$art_i = 0, $art_cpuoocnfr$art_c = checkboxes.length; $art_iljlrqul$art_i < $art_cpuoocnfr$art_c; $art_iljlrqul$art_i++) {
        var c = checkboxes[$art_iljlrqul$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikjkxjrha$art_i = 0, $art_caoikh$art_c = radioes.length; $art_ikjkxjrha$art_i < $art_caoikh$art_c; $art_ikjkxjrha$art_i++) {    var r = radioes[$art_ikjkxjrha$art_i]%>';
    for (var $art_ikjkxjrha$art_i = 0, $art_caoikh$art_c = radioes.length; $art_ikjkxjrha$art_i < $art_caoikh$art_c; $art_ikjkxjrha$art_i++) {
        var r = radioes[$art_ikjkxjrha$art_i];
