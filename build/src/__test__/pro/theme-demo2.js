...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqrjdkkob$art_i = 0, $art_croanrias$art_c = checkboxes.length; $art_iqrjdkkob$art_i < $art_croanrias$art_c; $art_iqrjdkkob$art_i++) {    var c = checkboxes[$art_iqrjdkkob$art_i]%>';
    for (var $art_iqrjdkkob$art_i = 0, $art_croanrias$art_c = checkboxes.length; $art_iqrjdkkob$art_i < $art_croanrias$art_c; $art_iqrjdkkob$art_i++) {
        var c = checkboxes[$art_iqrjdkkob$art_i];
    ...
    ;
    $expr = '<%for (var $art_izkwxghkmq$art_i = 0, $art_cpijydchej$art_c = radioes.length; $art_izkwxghkmq$art_i < $art_cpijydchej$art_c; $art_izkwxghkmq$art_i++) {    var r = radioes[$art_izkwxghkmq$art_i]%>';
    for (var $art_izkwxghkmq$art_i = 0, $art_cpijydchej$art_c = radioes.length; $art_izkwxghkmq$art_i < $art_cpijydchej$art_c; $art_izkwxghkmq$art_i++) {
        var r = radioes[$art_izkwxghkmq$art_i];
