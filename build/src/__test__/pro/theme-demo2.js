...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inkxnjrv$art_i = 0, $art_cmamiskz$art_c = checkboxes.length; $art_inkxnjrv$art_i < $art_cmamiskz$art_c; $art_inkxnjrv$art_i++) {    var c = checkboxes[$art_inkxnjrv$art_i]%>';
    for (var $art_inkxnjrv$art_i = 0, $art_cmamiskz$art_c = checkboxes.length; $art_inkxnjrv$art_i < $art_cmamiskz$art_c; $art_inkxnjrv$art_i++) {
        var c = checkboxes[$art_inkxnjrv$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilwwxstpuak$art_i = 0, $art_cdqgpruou$art_c = radioes.length; $art_ilwwxstpuak$art_i < $art_cdqgpruou$art_c; $art_ilwwxstpuak$art_i++) {    var r = radioes[$art_ilwwxstpuak$art_i]%>';
    for (var $art_ilwwxstpuak$art_i = 0, $art_cdqgpruou$art_c = radioes.length; $art_ilwwxstpuak$art_i < $art_cdqgpruou$art_c; $art_ilwwxstpuak$art_i++) {
        var r = radioes[$art_ilwwxstpuak$art_i];
