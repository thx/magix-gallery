...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_itkqsedpblj$art_i = 0, $art_crzwufkks$art_c = checkboxes.length; $art_itkqsedpblj$art_i < $art_crzwufkks$art_c; $art_itkqsedpblj$art_i++) {    var c = checkboxes[$art_itkqsedpblj$art_i]%>';
    for (var $art_itkqsedpblj$art_i = 0, $art_crzwufkks$art_c = checkboxes.length; $art_itkqsedpblj$art_i < $art_crzwufkks$art_c; $art_itkqsedpblj$art_i++) {
        var c = checkboxes[$art_itkqsedpblj$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ibwiuo$art_i = 0, $art_chryclfur$art_c = radioes.length; $art_ibwiuo$art_i < $art_chryclfur$art_c; $art_ibwiuo$art_i++) {    var r = radioes[$art_ibwiuo$art_i]%>';
    for (var $art_ibwiuo$art_i = 0, $art_chryclfur$art_c = radioes.length; $art_ibwiuo$art_i < $art_chryclfur$art_c; $art_ibwiuo$art_i++) {
        var r = radioes[$art_ibwiuo$art_i];
