...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iplkowmq$art_i = 0, $art_cwlxtqpk$art_c = checkboxes.length; $art_iplkowmq$art_i < $art_cwlxtqpk$art_c; $art_iplkowmq$art_i++) {    var c = checkboxes[$art_iplkowmq$art_i]%>';
    for (var $art_iplkowmq$art_i = 0, $art_cwlxtqpk$art_c = checkboxes.length; $art_iplkowmq$art_i < $art_cwlxtqpk$art_c; $art_iplkowmq$art_i++) {
        var c = checkboxes[$art_iplkowmq$art_i];
    ...
    ;
    $expr = '<%for (var $art_idkrnyoyfbk$art_i = 0, $art_cfnauynii$art_c = radioes.length; $art_idkrnyoyfbk$art_i < $art_cfnauynii$art_c; $art_idkrnyoyfbk$art_i++) {    var r = radioes[$art_idkrnyoyfbk$art_i]%>';
    for (var $art_idkrnyoyfbk$art_i = 0, $art_cfnauynii$art_c = radioes.length; $art_idkrnyoyfbk$art_i < $art_cfnauynii$art_c; $art_idkrnyoyfbk$art_i++) {
        var r = radioes[$art_idkrnyoyfbk$art_i];
