...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioipwqhiy$art_i = 0, $art_cbttksffpv$art_c = checkboxes.length; $art_ioipwqhiy$art_i < $art_cbttksffpv$art_c; $art_ioipwqhiy$art_i++) {    var c = checkboxes[$art_ioipwqhiy$art_i]%>';
    for (var $art_ioipwqhiy$art_i = 0, $art_cbttksffpv$art_c = checkboxes.length; $art_ioipwqhiy$art_i < $art_cbttksffpv$art_c; $art_ioipwqhiy$art_i++) {
        var c = checkboxes[$art_ioipwqhiy$art_i];
    ...
    ;
    $expr = '<%for (var $art_imsvkmoey$art_i = 0, $art_cwitjwk$art_c = radioes.length; $art_imsvkmoey$art_i < $art_cwitjwk$art_c; $art_imsvkmoey$art_i++) {    var r = radioes[$art_imsvkmoey$art_i]%>';
    for (var $art_imsvkmoey$art_i = 0, $art_cwitjwk$art_c = radioes.length; $art_imsvkmoey$art_i < $art_cwitjwk$art_c; $art_imsvkmoey$art_i++) {
        var r = radioes[$art_imsvkmoey$art_i];
