...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuxohcrgy$art_i = 0, $art_cxqidutqzc$art_c = checkboxes.length; $art_iuxohcrgy$art_i < $art_cxqidutqzc$art_c; $art_iuxohcrgy$art_i++) {    var c = checkboxes[$art_iuxohcrgy$art_i]%>';
    for (var $art_iuxohcrgy$art_i = 0, $art_cxqidutqzc$art_c = checkboxes.length; $art_iuxohcrgy$art_i < $art_cxqidutqzc$art_c; $art_iuxohcrgy$art_i++) {
        var c = checkboxes[$art_iuxohcrgy$art_i];
    ...
    ;
    $expr = '<%for (var $art_icgxmjrow$art_i = 0, $art_crrxrqjiny$art_c = radioes.length; $art_icgxmjrow$art_i < $art_crrxrqjiny$art_c; $art_icgxmjrow$art_i++) {    var r = radioes[$art_icgxmjrow$art_i]%>';
    for (var $art_icgxmjrow$art_i = 0, $art_crrxrqjiny$art_c = radioes.length; $art_icgxmjrow$art_i < $art_crrxrqjiny$art_c; $art_icgxmjrow$art_i++) {
        var r = radioes[$art_icgxmjrow$art_i];
