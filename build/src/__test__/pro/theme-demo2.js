...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifqaycphsh$art_i = 0, $art_clucuvjwrnfs$art_c = checkboxes.length; $art_ifqaycphsh$art_i < $art_clucuvjwrnfs$art_c; $art_ifqaycphsh$art_i++) {    var c = checkboxes[$art_ifqaycphsh$art_i]%>';
    for (var $art_ifqaycphsh$art_i = 0, $art_clucuvjwrnfs$art_c = checkboxes.length; $art_ifqaycphsh$art_i < $art_clucuvjwrnfs$art_c; $art_ifqaycphsh$art_i++) {
        var c = checkboxes[$art_ifqaycphsh$art_i];
    ...
    ;
    $expr = '<%for (var $art_itlnzumsi$art_i = 0, $art_ctolndiy$art_c = radioes.length; $art_itlnzumsi$art_i < $art_ctolndiy$art_c; $art_itlnzumsi$art_i++) {    var r = radioes[$art_itlnzumsi$art_i]%>';
    for (var $art_itlnzumsi$art_i = 0, $art_ctolndiy$art_c = radioes.length; $art_itlnzumsi$art_i < $art_ctolndiy$art_c; $art_itlnzumsi$art_i++) {
        var r = radioes[$art_itlnzumsi$art_i];
    ...
    $art = ':selected.name';
    ;
    $p += ($expr = '<%=selected.name%>', $e(selected.name)) + '"/><a mxs="_zs_galleryL:f" rel="noopener noreferrer" href="https://thx.github.io/magix/" target="_blank" class="ml20 _zs_gallery___test___pro_theme-demo2_-demo-link">跳转链接</a></div></div><div mxa="_zs_galleryL:k" class="form-item"><div mxs="_zs_galleryL:g" class="form-label">日历</div><div mxa="_zs_galleryL:l" class="form-content"><div class="w220" mx-view="mx-calendar/datepicker?prefix=%E6%88%AA%E6%AD%A2%E8%87%B3&selected=';
    $line = 54;
    $art = '=selected.time';
    ;
    $p += ($expr = '<%!$eu(selected.time)%>', $eu(selected.time)) + '"></div></div></div><div mxa="_zs_galleryL:m" class="form-item"><div mxs="_zs_galleryL:h" class="form-label">开关</div><div mxa="_zs_galleryL:n" class="form-content"><span mxe="' + $viewId + '_4_' + ($expr = '<%="switch"%>', $e("switch")) + '" mxc="[';
    $line = 61;
    $art = ':selected.switch';
    ;
