...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyuskevug$art_i = 0, $art_cewwyge$art_c = checkboxes.length; $art_iyuskevug$art_i < $art_cewwyge$art_c; $art_iyuskevug$art_i++) {    var c = checkboxes[$art_iyuskevug$art_i]%>';
    for (var $art_iyuskevug$art_i = 0, $art_cewwyge$art_c = checkboxes.length; $art_iyuskevug$art_i < $art_cewwyge$art_c; $art_iyuskevug$art_i++) {
        var c = checkboxes[$art_iyuskevug$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifbqkgublt$art_i = 0, $art_cdfknvbnyc$art_c = radioes.length; $art_ifbqkgublt$art_i < $art_cdfknvbnyc$art_c; $art_ifbqkgublt$art_i++) {    var r = radioes[$art_ifbqkgublt$art_i]%>';
    for (var $art_ifbqkgublt$art_i = 0, $art_cdfknvbnyc$art_c = radioes.length; $art_ifbqkgublt$art_i < $art_cdfknvbnyc$art_c; $art_ifbqkgublt$art_i++) {
        var r = radioes[$art_ifbqkgublt$art_i];
