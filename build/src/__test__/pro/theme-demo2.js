...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ignvvmp$art_i = 0, $art_ctmzru$art_c = checkboxes.length; $art_ignvvmp$art_i < $art_ctmzru$art_c; $art_ignvvmp$art_i++) {    var c = checkboxes[$art_ignvvmp$art_i]%>';
    for (var $art_ignvvmp$art_i = 0, $art_ctmzru$art_c = checkboxes.length; $art_ignvvmp$art_i < $art_ctmzru$art_c; $art_ignvvmp$art_i++) {
        var c = checkboxes[$art_ignvvmp$art_i];
    ...
    ;
    $expr = '<%for (var $art_icxyhepl$art_i = 0, $art_cnlbqpjr$art_c = radioes.length; $art_icxyhepl$art_i < $art_cnlbqpjr$art_c; $art_icxyhepl$art_i++) {    var r = radioes[$art_icxyhepl$art_i]%>';
    for (var $art_icxyhepl$art_i = 0, $art_cnlbqpjr$art_c = radioes.length; $art_icxyhepl$art_i < $art_cnlbqpjr$art_c; $art_icxyhepl$art_i++) {
        var r = radioes[$art_icxyhepl$art_i];
