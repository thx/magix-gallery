...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixisgpdrrzy$art_i = 0, $art_cspoordoj$art_c = checkboxes.length; $art_ixisgpdrrzy$art_i < $art_cspoordoj$art_c; $art_ixisgpdrrzy$art_i++) {    var c = checkboxes[$art_ixisgpdrrzy$art_i]%>';
    for (var $art_ixisgpdrrzy$art_i = 0, $art_cspoordoj$art_c = checkboxes.length; $art_ixisgpdrrzy$art_i < $art_cspoordoj$art_c; $art_ixisgpdrrzy$art_i++) {
        var c = checkboxes[$art_ixisgpdrrzy$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivfxwieeksa$art_i = 0, $art_cdmwceir$art_c = radioes.length; $art_ivfxwieeksa$art_i < $art_cdmwceir$art_c; $art_ivfxwieeksa$art_i++) {    var r = radioes[$art_ivfxwieeksa$art_i]%>';
    for (var $art_ivfxwieeksa$art_i = 0, $art_cdmwceir$art_c = radioes.length; $art_ivfxwieeksa$art_i < $art_cdmwceir$art_c; $art_ivfxwieeksa$art_i++) {
        var r = radioes[$art_ivfxwieeksa$art_i];
