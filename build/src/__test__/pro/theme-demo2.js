...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioacgsopk$art_i = 0, $art_czemgotha$art_c = checkboxes.length; $art_ioacgsopk$art_i < $art_czemgotha$art_c; $art_ioacgsopk$art_i++) {    var c = checkboxes[$art_ioacgsopk$art_i]%>';
    for (var $art_ioacgsopk$art_i = 0, $art_czemgotha$art_c = checkboxes.length; $art_ioacgsopk$art_i < $art_czemgotha$art_c; $art_ioacgsopk$art_i++) {
        var c = checkboxes[$art_ioacgsopk$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihkpajcet$art_i = 0, $art_cupxnqkvl$art_c = radioes.length; $art_ihkpajcet$art_i < $art_cupxnqkvl$art_c; $art_ihkpajcet$art_i++) {    var r = radioes[$art_ihkpajcet$art_i]%>';
    for (var $art_ihkpajcet$art_i = 0, $art_cupxnqkvl$art_c = radioes.length; $art_ihkpajcet$art_i < $art_cupxnqkvl$art_c; $art_ihkpajcet$art_i++) {
        var r = radioes[$art_ihkpajcet$art_i];
