...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaotdzqwsyo$art_i = 0, $art_cswtbmq$art_c = checkboxes.length; $art_iaotdzqwsyo$art_i < $art_cswtbmq$art_c; $art_iaotdzqwsyo$art_i++) {    var c = checkboxes[$art_iaotdzqwsyo$art_i]%>';
    for (var $art_iaotdzqwsyo$art_i = 0, $art_cswtbmq$art_c = checkboxes.length; $art_iaotdzqwsyo$art_i < $art_cswtbmq$art_c; $art_iaotdzqwsyo$art_i++) {
        var c = checkboxes[$art_iaotdzqwsyo$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixrkddsq$art_i = 0, $art_cjldoyg$art_c = radioes.length; $art_ixrkddsq$art_i < $art_cjldoyg$art_c; $art_ixrkddsq$art_i++) {    var r = radioes[$art_ixrkddsq$art_i]%>';
    for (var $art_ixrkddsq$art_i = 0, $art_cjldoyg$art_c = radioes.length; $art_ixrkddsq$art_i < $art_cjldoyg$art_c; $art_ixrkddsq$art_i++) {
        var r = radioes[$art_ixrkddsq$art_i];
