...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijdwy$art_i = 0, $art_ckpbsbs$art_c = checkboxes.length; $art_ijdwy$art_i < $art_ckpbsbs$art_c; $art_ijdwy$art_i++) {    var c = checkboxes[$art_ijdwy$art_i]%>';
    for (var $art_ijdwy$art_i = 0, $art_ckpbsbs$art_c = checkboxes.length; $art_ijdwy$art_i < $art_ckpbsbs$art_c; $art_ijdwy$art_i++) {
        var c = checkboxes[$art_ijdwy$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuugkmbosci$art_i = 0, $art_crbbvlanvf$art_c = radioes.length; $art_iuugkmbosci$art_i < $art_crbbvlanvf$art_c; $art_iuugkmbosci$art_i++) {    var r = radioes[$art_iuugkmbosci$art_i]%>';
    for (var $art_iuugkmbosci$art_i = 0, $art_crbbvlanvf$art_c = radioes.length; $art_iuugkmbosci$art_i < $art_crbbvlanvf$art_c; $art_iuugkmbosci$art_i++) {
        var r = radioes[$art_iuugkmbosci$art_i];
