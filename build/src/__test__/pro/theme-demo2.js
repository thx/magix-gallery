...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irldpbvn$art_i = 0, $art_cvyktgnwe$art_c = checkboxes.length; $art_irldpbvn$art_i < $art_cvyktgnwe$art_c; $art_irldpbvn$art_i++) {    var c = checkboxes[$art_irldpbvn$art_i]%>';
    for (var $art_irldpbvn$art_i = 0, $art_cvyktgnwe$art_c = checkboxes.length; $art_irldpbvn$art_i < $art_cvyktgnwe$art_c; $art_irldpbvn$art_i++) {
        var c = checkboxes[$art_irldpbvn$art_i];
    ...
    ;
    $expr = '<%for (var $art_ieyvb$art_i = 0, $art_cbtimdbtdw$art_c = radioes.length; $art_ieyvb$art_i < $art_cbtimdbtdw$art_c; $art_ieyvb$art_i++) {    var r = radioes[$art_ieyvb$art_i]%>';
    for (var $art_ieyvb$art_i = 0, $art_cbtimdbtdw$art_c = radioes.length; $art_ieyvb$art_i < $art_cbtimdbtdw$art_c; $art_ieyvb$art_i++) {
        var r = radioes[$art_ieyvb$art_i];
