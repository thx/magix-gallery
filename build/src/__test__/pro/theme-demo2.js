...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iccbkyhleye$art_i = 0, $art_ceckijdv$art_c = checkboxes.length; $art_iccbkyhleye$art_i < $art_ceckijdv$art_c; $art_iccbkyhleye$art_i++) {    var c = checkboxes[$art_iccbkyhleye$art_i]%>';
    for (var $art_iccbkyhleye$art_i = 0, $art_ceckijdv$art_c = checkboxes.length; $art_iccbkyhleye$art_i < $art_ceckijdv$art_c; $art_iccbkyhleye$art_i++) {
        var c = checkboxes[$art_iccbkyhleye$art_i];
    ...
    ;
    $expr = '<%for (var $art_ielkngbmx$art_i = 0, $art_cyjsruvxzdg$art_c = radioes.length; $art_ielkngbmx$art_i < $art_cyjsruvxzdg$art_c; $art_ielkngbmx$art_i++) {    var r = radioes[$art_ielkngbmx$art_i]%>';
    for (var $art_ielkngbmx$art_i = 0, $art_cyjsruvxzdg$art_c = radioes.length; $art_ielkngbmx$art_i < $art_cyjsruvxzdg$art_c; $art_ielkngbmx$art_i++) {
        var r = radioes[$art_ielkngbmx$art_i];
