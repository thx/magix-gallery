...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilfqibmnw$art_i = 0, $art_clggduyd$art_c = checkboxes.length; $art_ilfqibmnw$art_i < $art_clggduyd$art_c; $art_ilfqibmnw$art_i++) {    var c = checkboxes[$art_ilfqibmnw$art_i]%>';
    for (var $art_ilfqibmnw$art_i = 0, $art_clggduyd$art_c = checkboxes.length; $art_ilfqibmnw$art_i < $art_clggduyd$art_c; $art_ilfqibmnw$art_i++) {
        var c = checkboxes[$art_ilfqibmnw$art_i];
    ...
    ;
    $expr = '<%for (var $art_iiauovuq$art_i = 0, $art_ckkqouz$art_c = radioes.length; $art_iiauovuq$art_i < $art_ckkqouz$art_c; $art_iiauovuq$art_i++) {    var r = radioes[$art_iiauovuq$art_i]%>';
    for (var $art_iiauovuq$art_i = 0, $art_ckkqouz$art_c = radioes.length; $art_iiauovuq$art_i < $art_ckkqouz$art_c; $art_iiauovuq$art_i++) {
        var r = radioes[$art_iiauovuq$art_i];
