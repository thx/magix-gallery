...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibjtvkixzpfe$art_i = 0, $art_cjvxcuiv$art_c = checkboxes.length; $art_ibjtvkixzpfe$art_i < $art_cjvxcuiv$art_c; $art_ibjtvkixzpfe$art_i++) {    var c = checkboxes[$art_ibjtvkixzpfe$art_i]%>';
    for (var $art_ibjtvkixzpfe$art_i = 0, $art_cjvxcuiv$art_c = checkboxes.length; $art_ibjtvkixzpfe$art_i < $art_cjvxcuiv$art_c; $art_ibjtvkixzpfe$art_i++) {
        var c = checkboxes[$art_ibjtvkixzpfe$art_i];
    ...
    ;
    $expr = '<%for (var $art_isieleayh$art_i = 0, $art_czlqryc$art_c = radioes.length; $art_isieleayh$art_i < $art_czlqryc$art_c; $art_isieleayh$art_i++) {    var r = radioes[$art_isieleayh$art_i]%>';
    for (var $art_isieleayh$art_i = 0, $art_czlqryc$art_c = radioes.length; $art_isieleayh$art_i < $art_czlqryc$art_c; $art_isieleayh$art_i++) {
        var r = radioes[$art_isieleayh$art_i];
