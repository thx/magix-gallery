...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_irkgmmwlg$art_i = 0, $art_cjsueugd$art_c = checkboxes.length; $art_irkgmmwlg$art_i < $art_cjsueugd$art_c; $art_irkgmmwlg$art_i++) {    var c = checkboxes[$art_irkgmmwlg$art_i]%>';
    for (var $art_irkgmmwlg$art_i = 0, $art_cjsueugd$art_c = checkboxes.length; $art_irkgmmwlg$art_i < $art_cjsueugd$art_c; $art_irkgmmwlg$art_i++) {
        var c = checkboxes[$art_irkgmmwlg$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iyfbxsfhuon$art_i = 0, $art_ckdiruofgn$art_c = radioes.length; $art_iyfbxsfhuon$art_i < $art_ckdiruofgn$art_c; $art_iyfbxsfhuon$art_i++) {    var r = radioes[$art_iyfbxsfhuon$art_i]%>';
    for (var $art_iyfbxsfhuon$art_i = 0, $art_ckdiruofgn$art_c = radioes.length; $art_iyfbxsfhuon$art_i < $art_ckdiruofgn$art_c; $art_iyfbxsfhuon$art_i++) {
        var r = radioes[$art_iyfbxsfhuon$art_i];
