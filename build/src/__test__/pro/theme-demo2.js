...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilysjwuei$art_i = 0, $art_ceibxrbpr$art_c = checkboxes.length; $art_ilysjwuei$art_i < $art_ceibxrbpr$art_c; $art_ilysjwuei$art_i++) {    var c = checkboxes[$art_ilysjwuei$art_i]%>';
    for (var $art_ilysjwuei$art_i = 0, $art_ceibxrbpr$art_c = checkboxes.length; $art_ilysjwuei$art_i < $art_ceibxrbpr$art_c; $art_ilysjwuei$art_i++) {
        var c = checkboxes[$art_ilysjwuei$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivvytcamgh$art_i = 0, $art_cldqddxfmlr$art_c = radioes.length; $art_ivvytcamgh$art_i < $art_cldqddxfmlr$art_c; $art_ivvytcamgh$art_i++) {    var r = radioes[$art_ivvytcamgh$art_i]%>';
    for (var $art_ivvytcamgh$art_i = 0, $art_cldqddxfmlr$art_c = radioes.length; $art_ivvytcamgh$art_i < $art_cldqddxfmlr$art_c; $art_ivvytcamgh$art_i++) {
        var r = radioes[$art_ivvytcamgh$art_i];
