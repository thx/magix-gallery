...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iubdckny$art_i = 0, $art_cknqjqlnzj$art_c = checkboxes.length; $art_iubdckny$art_i < $art_cknqjqlnzj$art_c; $art_iubdckny$art_i++) {    var c = checkboxes[$art_iubdckny$art_i]%>';
    for (var $art_iubdckny$art_i = 0, $art_cknqjqlnzj$art_c = checkboxes.length; $art_iubdckny$art_i < $art_cknqjqlnzj$art_c; $art_iubdckny$art_i++) {
        var c = checkboxes[$art_iubdckny$art_i];
    ...
    ;
    $expr = '<%for (var $art_iggaehmv$art_i = 0, $art_cmqewwjul$art_c = radioes.length; $art_iggaehmv$art_i < $art_cmqewwjul$art_c; $art_iggaehmv$art_i++) {    var r = radioes[$art_iggaehmv$art_i]%>';
    for (var $art_iggaehmv$art_i = 0, $art_cmqewwjul$art_c = radioes.length; $art_iggaehmv$art_i < $art_cmqewwjul$art_c; $art_iggaehmv$art_i++) {
        var r = radioes[$art_iggaehmv$art_i];
