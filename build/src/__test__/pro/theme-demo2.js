...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihyinez$art_i = 0, $art_cdyyognyo$art_c = checkboxes.length; $art_ihyinez$art_i < $art_cdyyognyo$art_c; $art_ihyinez$art_i++) {    var c = checkboxes[$art_ihyinez$art_i]%>';
    for (var $art_ihyinez$art_i = 0, $art_cdyyognyo$art_c = checkboxes.length; $art_ihyinez$art_i < $art_cdyyognyo$art_c; $art_ihyinez$art_i++) {
        var c = checkboxes[$art_ihyinez$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilfvrohnl$art_i = 0, $art_ccpymsm$art_c = radioes.length; $art_ilfvrohnl$art_i < $art_ccpymsm$art_c; $art_ilfvrohnl$art_i++) {    var r = radioes[$art_ilfvrohnl$art_i]%>';
    for (var $art_ilfvrohnl$art_i = 0, $art_ccpymsm$art_c = radioes.length; $art_ilfvrohnl$art_i < $art_ccpymsm$art_c; $art_ilfvrohnl$art_i++) {
        var r = radioes[$art_ilfvrohnl$art_i];
