...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itjnpkliy$art_i = 0, $art_ctwastwtmpu$art_c = checkboxes.length; $art_itjnpkliy$art_i < $art_ctwastwtmpu$art_c; $art_itjnpkliy$art_i++) {    var c = checkboxes[$art_itjnpkliy$art_i]%>';
    for (var $art_itjnpkliy$art_i = 0, $art_ctwastwtmpu$art_c = checkboxes.length; $art_itjnpkliy$art_i < $art_ctwastwtmpu$art_c; $art_itjnpkliy$art_i++) {
        var c = checkboxes[$art_itjnpkliy$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibzohpyxvw$art_i = 0, $art_convhqftg$art_c = radioes.length; $art_ibzohpyxvw$art_i < $art_convhqftg$art_c; $art_ibzohpyxvw$art_i++) {    var r = radioes[$art_ibzohpyxvw$art_i]%>';
    for (var $art_ibzohpyxvw$art_i = 0, $art_convhqftg$art_c = radioes.length; $art_ibzohpyxvw$art_i < $art_convhqftg$art_c; $art_ibzohpyxvw$art_i++) {
        var r = radioes[$art_ibzohpyxvw$art_i];
