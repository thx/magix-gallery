...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ignvqwb$art_i = 0, $art_caufvkzifa$art_c = checkboxes.length; $art_ignvqwb$art_i < $art_caufvkzifa$art_c; $art_ignvqwb$art_i++) {    var c = checkboxes[$art_ignvqwb$art_i]%>';
    for (var $art_ignvqwb$art_i = 0, $art_caufvkzifa$art_c = checkboxes.length; $art_ignvqwb$art_i < $art_caufvkzifa$art_c; $art_ignvqwb$art_i++) {
        var c = checkboxes[$art_ignvqwb$art_i];
    ...
    ;
    $expr = '<%for (var $art_ijforqphlp$art_i = 0, $art_cgjwleyrkai$art_c = radioes.length; $art_ijforqphlp$art_i < $art_cgjwleyrkai$art_c; $art_ijforqphlp$art_i++) {    var r = radioes[$art_ijforqphlp$art_i]%>';
    for (var $art_ijforqphlp$art_i = 0, $art_cgjwleyrkai$art_c = radioes.length; $art_ijforqphlp$art_i < $art_cgjwleyrkai$art_c; $art_ijforqphlp$art_i++) {
        var r = radioes[$art_ijforqphlp$art_i];
