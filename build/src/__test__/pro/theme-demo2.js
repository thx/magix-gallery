...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixsymhbjb$art_i = 0, $art_cxhtvbxl$art_c = checkboxes.length; $art_ixsymhbjb$art_i < $art_cxhtvbxl$art_c; $art_ixsymhbjb$art_i++) {    var c = checkboxes[$art_ixsymhbjb$art_i]%>';
    for (var $art_ixsymhbjb$art_i = 0, $art_cxhtvbxl$art_c = checkboxes.length; $art_ixsymhbjb$art_i < $art_cxhtvbxl$art_c; $art_ixsymhbjb$art_i++) {
        var c = checkboxes[$art_ixsymhbjb$art_i];
    ...
    ;
    $expr = '<%for (var $art_isxwjretss$art_i = 0, $art_cpndjjtzj$art_c = radioes.length; $art_isxwjretss$art_i < $art_cpndjjtzj$art_c; $art_isxwjretss$art_i++) {    var r = radioes[$art_isxwjretss$art_i]%>';
    for (var $art_isxwjretss$art_i = 0, $art_cpndjjtzj$art_c = radioes.length; $art_isxwjretss$art_i < $art_cpndjjtzj$art_c; $art_isxwjretss$art_i++) {
        var r = radioes[$art_isxwjretss$art_i];
