...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iujgevqgl$art_i = 0, $art_cebxmtzwdxlk$art_c = checkboxes.length; $art_iujgevqgl$art_i < $art_cebxmtzwdxlk$art_c; $art_iujgevqgl$art_i++) {    var c = checkboxes[$art_iujgevqgl$art_i]%>';
    for (var $art_iujgevqgl$art_i = 0, $art_cebxmtzwdxlk$art_c = checkboxes.length; $art_iujgevqgl$art_i < $art_cebxmtzwdxlk$art_c; $art_iujgevqgl$art_i++) {
        var c = checkboxes[$art_iujgevqgl$art_i];
    ...
    ;
    $expr = '<%for (var $art_iefazcoeb$art_i = 0, $art_cmshaxijbn$art_c = radioes.length; $art_iefazcoeb$art_i < $art_cmshaxijbn$art_c; $art_iefazcoeb$art_i++) {    var r = radioes[$art_iefazcoeb$art_i]%>';
    for (var $art_iefazcoeb$art_i = 0, $art_cmshaxijbn$art_c = radioes.length; $art_iefazcoeb$art_i < $art_cmshaxijbn$art_c; $art_iefazcoeb$art_i++) {
        var r = radioes[$art_iefazcoeb$art_i];
