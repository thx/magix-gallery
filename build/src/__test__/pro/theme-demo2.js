...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imjzxlhp$art_i = 0, $art_cevlsblowl$art_c = checkboxes.length; $art_imjzxlhp$art_i < $art_cevlsblowl$art_c; $art_imjzxlhp$art_i++) {    var c = checkboxes[$art_imjzxlhp$art_i]%>';
    for (var $art_imjzxlhp$art_i = 0, $art_cevlsblowl$art_c = checkboxes.length; $art_imjzxlhp$art_i < $art_cevlsblowl$art_c; $art_imjzxlhp$art_i++) {
        var c = checkboxes[$art_imjzxlhp$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixtgggimvz$art_i = 0, $art_cyhypgvf$art_c = radioes.length; $art_ixtgggimvz$art_i < $art_cyhypgvf$art_c; $art_ixtgggimvz$art_i++) {    var r = radioes[$art_ixtgggimvz$art_i]%>';
    for (var $art_ixtgggimvz$art_i = 0, $art_cyhypgvf$art_c = radioes.length; $art_ixtgggimvz$art_i < $art_cyhypgvf$art_c; $art_ixtgggimvz$art_i++) {
        var r = radioes[$art_ixtgggimvz$art_i];
