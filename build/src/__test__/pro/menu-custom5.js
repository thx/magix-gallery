/*
    ...
    loader: cmd_es
 */
define("__test__/pro/menu-custom5",["magix","../example","$","mx-copy/index","../hl"],(require,exports,module)=>{
/*Magix,Base,$*/
...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryG:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_galleryG:_" class="_zs_gallery___test___layout_-eg-content"><div class="_zs_gallery___test___pro_menu_-menu"><div class="_zs_gallery___test___pro_menu_-header clearfix"><div class="_zs_gallery___test___pro_menu_-logo">LOGO</div><div class="_zs_gallery___test___pro_menu_-name">一级标题</div></div><div class="clearfix pr"><div class="_zs_gallery___test___pro_menu_-navs"><img src="//img.alicdn.com/tfs/TB1A_l1oBsmBKNjSZFsXXaXSVXa-210-153.png"></div><div class="_zs_gallery___test___pro_menu_-inner"><div>view2：</div><div>映射到三级1这个页面</div><div>顶部显示与三级1完全一致，侧边内容自定义</div></div></div></div></div><div mxa="_zs_galleryG:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryG:a" class="_zs_gallery___test___layout_-eg-title">配置CustomPath</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 22;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:__test__/pro/menu-custom5.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
