/*
    ...
    loader: cmd_es
 */
define("__test__/pro/menu",["magix","$","mx-title/second","./menu1","./menu3","./menu2","./menu4"],(require,exports,module)=>{
/*Magix,$*/
