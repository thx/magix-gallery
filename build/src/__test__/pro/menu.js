...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_menu3"></div></div><div mxa="_zs_galleryA:c" class="_zs_gallery___test___layout_-half"><div mx-view="__test__/pro/menu2" id="';
    $line = 49;
    $art = '=viewId';
    ;
