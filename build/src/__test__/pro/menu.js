...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_galleryz:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'导航可见菜单\',\n        key: viewId + \'_menu\',\n        subs: [{\n            name: \'侧边二级\',\n            key: viewId + \'_menu1\',\n        },{\n            name: \'侧边三级\',\n            key: viewId + \'_menu2\',\n        },{\n            name: \'自定义侧边\',\n            key: viewId + \'_menu3\',\n        },{\n            name: \'无侧边深底\',\n            key: viewId + \'_menu4\',\n        },{\n            name: \'无侧边白底\',\n            key: viewId + \'_menu5\',\n        }]\n    }, {\n        name: \'自定义菜单\',\n        key: viewId + \'_custom\',\n        subs: [{\n            name: \'映射三级\',\n            key: viewId + \'_custom3\',\n        },{\n            name: \'一级+自定义侧边\',\n            key: viewId + \'_custom5\',\n        },{\n            name: \'一级+无侧边\',\n            key: viewId + \'_custom2\',\n        },{\n            name: \'自定义容器\',\n            key: viewId + \'_custom4\',\n        }]\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_menu3"></div></div><div mxa="_zs_galleryz:c" class="_zs_gallery___test___layout_-half"><div mx-view="__test__/pro/menu2" id="';
    $line = 49;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_menu2"></div><div mx-view="__test__/pro/menu5" id="';
    $line = 50;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_menu5"></div><div mx-view="__test__/pro/menu4" id="';
    $line = 51;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_custom" mx-view="mx-title/second?content=%E8%87%AA%E5%AE%9A%E4%B9%89%E8%8F%9C%E5%8D%95%E9%85%8D%E7%BD%AE&tip=%E5%85%A5%E5%8F%A3%E5%9C%A8%E4%B8%8D%E5%9C%A8%E5%AF%BC%E8%88%AA%E4%B8%8A%EF%BC%8C%E4%BB%8E%E5%85%B7%E4%BD%93%E7%9A%84%E6%9F%90%E4%B8%AA%E9%A1%B5%E9%9D%A2%E7%82%B9%E5%87%BB%E8%BF%9B%E5%85%A5%EF%BC%8C%E5%8F%AF%E8%83%BD%E9%9C%80%E8%A6%81%E6%98%A0%E5%B0%84%E5%88%B0%E5%AF%BC%E8%88%AA%E7%9A%84%E6%9F%90%E4%B8%AA%E4%BD%8D%E7%BD%AE%E4%B8%8A"></div><div mxs="_zs_galleryz:a" mx-view="__test__/pro/menu-custom-desc" class="mb20"></div><div mx-view="__test__/pro/menu-custom1?parentId=';
    $line = 59;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '" class="mb20"></div><div mx-view="__test__/pro/menu-custom3" id="';
    $line = 60;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_custom3"></div><div mx-view="__test__/pro/menu-custom5" id="';
    $line = 61;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_custom5"></div><div mx-view="__test__/pro/menu-custom2" id="';
    $line = 62;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_custom2"></div><div mx-view="__test__/pro/menu-custom4" id="';
    $line = 63;
    $art = '=viewId';
    ;
