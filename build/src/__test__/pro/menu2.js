...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryA:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_galleryA:_" class="_zs_gallery___test___layout_-eg-content"><div class="clearfix mb20"><div class="fl color-9">以下示例：</div><div class="fl">侧边分组（二级 + 三级混合），配置subs，无leftView</div></div><div class="_zs_gallery___test___pro_menu_-menu"><div class="_zs_gallery___test___pro_menu_-header clearfix"><div class="_zs_gallery___test___pro_menu_-logo">LOGO</div><div class="_zs_gallery___test___pro_menu_-name">一级标题</div></div><div class="clearfix"><div class="_zs_gallery___test___pro_menu_-navs"><div class="_zs_gallery___test___pro_menu_-nav-second _zs_gallery___test___pro_menu_-second-expand _zs_gallery___test___pro_menu_-second-on"><span>二级1</span><i class="mc-iconfont _zs_gallery___test___pro_menu_-second-icon">&#xe692;</i></div><div class="_zs_gallery___test___pro_menu_-nav-thirds _zs_gallery___test___pro_menu_-third-expand"><div><a href="javascript:;" class="_zs_gallery___test___pro_menu_-nav-third _zs_gallery___test___pro_menu_-third-on"><i class="mc-iconfont mr5">&#xe731;</i>三级1</a></div><div><a href="javascript:;" class="_zs_gallery___test___pro_menu_-nav-third"><i class="mc-iconfont mr5">&#xe609;</i>三级2</a></div><div><a href="javascript:;" class="_zs_gallery___test___pro_menu_-nav-third"><i class="mc-iconfont mr5">&#xe698;</i>三级3</a></div></div><div><a href="javascript:;" class="_zs_gallery___test___pro_menu_-nav-third">三级4</a></div></div></div></div></div><div mxa="_zs_galleryA:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryA:a" class="_zs_gallery___test___layout_-eg-title">配置Menus</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 47;
    $art = '=viewId';
    ;
