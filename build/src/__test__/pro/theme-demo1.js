...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipihzima$art_i = 0, $art_ceyougqphh$art_c = checkboxes.length; $art_ipihzima$art_i < $art_ceyougqphh$art_c; $art_ipihzima$art_i++) {    var c = checkboxes[$art_ipihzima$art_i]%>';
    for (var $art_ipihzima$art_i = 0, $art_ceyougqphh$art_c = checkboxes.length; $art_ipihzima$art_i < $art_ceyougqphh$art_c; $art_ipihzima$art_i++) {
        var c = checkboxes[$art_ipihzima$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwhdvuksdhg$art_i = 0, $art_cwvtym$art_c = radioes.length; $art_iwhdvuksdhg$art_i < $art_cwvtym$art_c; $art_iwhdvuksdhg$art_i++) {    var r = radioes[$art_iwhdvuksdhg$art_i]%>';
    for (var $art_iwhdvuksdhg$art_i = 0, $art_cwvtym$art_c = radioes.length; $art_iwhdvuksdhg$art_i < $art_cwvtym$art_c; $art_iwhdvuksdhg$art_i++) {
        var r = radioes[$art_iwhdvuksdhg$art_i];
