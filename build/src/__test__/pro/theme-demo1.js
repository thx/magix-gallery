...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuinwbfa$art_i = 0, $art_cndmmnkso$art_c = checkboxes.length; $art_iuinwbfa$art_i < $art_cndmmnkso$art_c; $art_iuinwbfa$art_i++) {    var c = checkboxes[$art_iuinwbfa$art_i]%>';
    for (var $art_iuinwbfa$art_i = 0, $art_cndmmnkso$art_c = checkboxes.length; $art_iuinwbfa$art_i < $art_cndmmnkso$art_c; $art_iuinwbfa$art_i++) {
        var c = checkboxes[$art_iuinwbfa$art_i];
    ...
    ;
    $expr = '<%for (var $art_iimcybtxo$art_i = 0, $art_cprtnqnyljk$art_c = radioes.length; $art_iimcybtxo$art_i < $art_cprtnqnyljk$art_c; $art_iimcybtxo$art_i++) {    var r = radioes[$art_iimcybtxo$art_i]%>';
    for (var $art_iimcybtxo$art_i = 0, $art_cprtnqnyljk$art_c = radioes.length; $art_iimcybtxo$art_i < $art_cprtnqnyljk$art_c; $art_iimcybtxo$art_i++) {
        var r = radioes[$art_iimcybtxo$art_i];
