...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ivshtybp$art_i = 0, $art_cfgvngames$art_c = checkboxes.length; $art_ivshtybp$art_i < $art_cfgvngames$art_c; $art_ivshtybp$art_i++) {    var c = checkboxes[$art_ivshtybp$art_i]%>';
    for (var $art_ivshtybp$art_i = 0, $art_cfgvngames$art_c = checkboxes.length; $art_ivshtybp$art_i < $art_cfgvngames$art_c; $art_ivshtybp$art_i++) {
        var c = checkboxes[$art_ivshtybp$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_irenyukzo$art_i = 0, $art_cgtfecwpq$art_c = radioes.length; $art_irenyukzo$art_i < $art_cgtfecwpq$art_c; $art_irenyukzo$art_i++) {    var r = radioes[$art_irenyukzo$art_i]%>';
    for (var $art_irenyukzo$art_i = 0, $art_cgtfecwpq$art_c = radioes.length; $art_irenyukzo$art_i < $art_cgtfecwpq$art_c; $art_irenyukzo$art_i++) {
        var r = radioes[$art_irenyukzo$art_i];
