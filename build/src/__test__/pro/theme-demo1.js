...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iliwowd$art_i = 0, $art_cxoujlnef$art_c = checkboxes.length; $art_iliwowd$art_i < $art_cxoujlnef$art_c; $art_iliwowd$art_i++) {    var c = checkboxes[$art_iliwowd$art_i]%>';
    for (var $art_iliwowd$art_i = 0, $art_cxoujlnef$art_c = checkboxes.length; $art_iliwowd$art_i < $art_cxoujlnef$art_c; $art_iliwowd$art_i++) {
        var c = checkboxes[$art_iliwowd$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilswuirqg$art_i = 0, $art_clansxlwrg$art_c = radioes.length; $art_ilswuirqg$art_i < $art_clansxlwrg$art_c; $art_ilswuirqg$art_i++) {    var r = radioes[$art_ilswuirqg$art_i]%>';
    for (var $art_ilswuirqg$art_i = 0, $art_clansxlwrg$art_c = radioes.length; $art_ilswuirqg$art_i < $art_clansxlwrg$art_c; $art_ilswuirqg$art_i++) {
        var r = radioes[$art_ilswuirqg$art_i];
