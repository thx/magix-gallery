...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_istevshqzg$art_i = 0, $art_cdvtwxea$art_c = checkboxes.length; $art_istevshqzg$art_i < $art_cdvtwxea$art_c; $art_istevshqzg$art_i++) {    var c = checkboxes[$art_istevshqzg$art_i]%>';
    for (var $art_istevshqzg$art_i = 0, $art_cdvtwxea$art_c = checkboxes.length; $art_istevshqzg$art_i < $art_cdvtwxea$art_c; $art_istevshqzg$art_i++) {
        var c = checkboxes[$art_istevshqzg$art_i];
    ...
    ;
    $expr = '<%for (var $art_iybmuool$art_i = 0, $art_cmhtgtpipn$art_c = radioes.length; $art_iybmuool$art_i < $art_cmhtgtpipn$art_c; $art_iybmuool$art_i++) {    var r = radioes[$art_iybmuool$art_i]%>';
    for (var $art_iybmuool$art_i = 0, $art_cmhtgtpipn$art_c = radioes.length; $art_iybmuool$art_i < $art_cmhtgtpipn$art_c; $art_iybmuool$art_i++) {
        var r = radioes[$art_iybmuool$art_i];
