...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iolktwu$art_i = 0, $art_cdnugngdf$art_c = checkboxes.length; $art_iolktwu$art_i < $art_cdnugngdf$art_c; $art_iolktwu$art_i++) {    var c = checkboxes[$art_iolktwu$art_i]%>';
    for (var $art_iolktwu$art_i = 0, $art_cdnugngdf$art_c = checkboxes.length; $art_iolktwu$art_i < $art_cdnugngdf$art_c; $art_iolktwu$art_i++) {
        var c = checkboxes[$art_iolktwu$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuckgrpc$art_i = 0, $art_cgkxntzgyg$art_c = radioes.length; $art_iuckgrpc$art_i < $art_cgkxntzgyg$art_c; $art_iuckgrpc$art_i++) {    var r = radioes[$art_iuckgrpc$art_i]%>';
    for (var $art_iuckgrpc$art_i = 0, $art_cgkxntzgyg$art_c = radioes.length; $art_iuckgrpc$art_i < $art_cgkxntzgyg$art_c; $art_iuckgrpc$art_i++) {
        var r = radioes[$art_iuckgrpc$art_i];
