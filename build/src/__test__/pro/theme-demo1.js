...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipdkzuxf$art_i = 0, $art_cczt$art_c = checkboxes.length; $art_ipdkzuxf$art_i < $art_cczt$art_c; $art_ipdkzuxf$art_i++) {    var c = checkboxes[$art_ipdkzuxf$art_i]%>';
    for (var $art_ipdkzuxf$art_i = 0, $art_cczt$art_c = checkboxes.length; $art_ipdkzuxf$art_i < $art_cczt$art_c; $art_ipdkzuxf$art_i++) {
        var c = checkboxes[$art_ipdkzuxf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilrytnhqy$art_i = 0, $art_criitol$art_c = radioes.length; $art_ilrytnhqy$art_i < $art_criitol$art_c; $art_ilrytnhqy$art_i++) {    var r = radioes[$art_ilrytnhqy$art_i]%>';
    for (var $art_ilrytnhqy$art_i = 0, $art_criitol$art_c = radioes.length; $art_ilrytnhqy$art_i < $art_criitol$art_c; $art_ilrytnhqy$art_i++) {
        var r = radioes[$art_ilrytnhqy$art_i];
