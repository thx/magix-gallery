...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyyqcqsoncb$art_i = 0, $art_cwzkcwmr$art_c = checkboxes.length; $art_iyyqcqsoncb$art_i < $art_cwzkcwmr$art_c; $art_iyyqcqsoncb$art_i++) {    var c = checkboxes[$art_iyyqcqsoncb$art_i]%>';
    for (var $art_iyyqcqsoncb$art_i = 0, $art_cwzkcwmr$art_c = checkboxes.length; $art_iyyqcqsoncb$art_i < $art_cwzkcwmr$art_c; $art_iyyqcqsoncb$art_i++) {
        var c = checkboxes[$art_iyyqcqsoncb$art_i];
    ...
    ;
    $expr = '<%for (var $art_idsjhftu$art_i = 0, $art_cbmlwygn$art_c = radioes.length; $art_idsjhftu$art_i < $art_cbmlwygn$art_c; $art_idsjhftu$art_i++) {    var r = radioes[$art_idsjhftu$art_i]%>';
    for (var $art_idsjhftu$art_i = 0, $art_cbmlwygn$art_c = radioes.length; $art_idsjhftu$art_i < $art_cbmlwygn$art_c; $art_idsjhftu$art_i++) {
        var r = radioes[$art_idsjhftu$art_i];
