...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixlcydicyr$art_i = 0, $art_cflwpj$art_c = checkboxes.length; $art_ixlcydicyr$art_i < $art_cflwpj$art_c; $art_ixlcydicyr$art_i++) {    var c = checkboxes[$art_ixlcydicyr$art_i]%>';
    for (var $art_ixlcydicyr$art_i = 0, $art_cflwpj$art_c = checkboxes.length; $art_ixlcydicyr$art_i < $art_cflwpj$art_c; $art_ixlcydicyr$art_i++) {
        var c = checkboxes[$art_ixlcydicyr$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihwnigcjrh$art_i = 0, $art_cfibieua$art_c = radioes.length; $art_ihwnigcjrh$art_i < $art_cfibieua$art_c; $art_ihwnigcjrh$art_i++) {    var r = radioes[$art_ihwnigcjrh$art_i]%>';
    for (var $art_ihwnigcjrh$art_i = 0, $art_cfibieua$art_c = radioes.length; $art_ihwnigcjrh$art_i < $art_cfibieua$art_c; $art_ihwnigcjrh$art_i++) {
        var r = radioes[$art_ihwnigcjrh$art_i];
