...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifjhwsjd$art_i = 0, $art_cslydemg$art_c = checkboxes.length; $art_ifjhwsjd$art_i < $art_cslydemg$art_c; $art_ifjhwsjd$art_i++) {    var c = checkboxes[$art_ifjhwsjd$art_i]%>';
    for (var $art_ifjhwsjd$art_i = 0, $art_cslydemg$art_c = checkboxes.length; $art_ifjhwsjd$art_i < $art_cslydemg$art_c; $art_ifjhwsjd$art_i++) {
        var c = checkboxes[$art_ifjhwsjd$art_i];
    ...
    ;
    $expr = '<%for (var $art_izjgkgsfvma$art_i = 0, $art_czkoaogn$art_c = radioes.length; $art_izjgkgsfvma$art_i < $art_czkoaogn$art_c; $art_izjgkgsfvma$art_i++) {    var r = radioes[$art_izjgkgsfvma$art_i]%>';
    for (var $art_izjgkgsfvma$art_i = 0, $art_czkoaogn$art_c = radioes.length; $art_izjgkgsfvma$art_i < $art_czkoaogn$art_c; $art_izjgkgsfvma$art_i++) {
        var r = radioes[$art_izjgkgsfvma$art_i];
