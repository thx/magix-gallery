...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixsfvnmn$art_i = 0, $art_cuthcmegn$art_c = checkboxes.length; $art_ixsfvnmn$art_i < $art_cuthcmegn$art_c; $art_ixsfvnmn$art_i++) {    var c = checkboxes[$art_ixsfvnmn$art_i]%>';
    for (var $art_ixsfvnmn$art_i = 0, $art_cuthcmegn$art_c = checkboxes.length; $art_ixsfvnmn$art_i < $art_cuthcmegn$art_c; $art_ixsfvnmn$art_i++) {
        var c = checkboxes[$art_ixsfvnmn$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixskokduil$art_i = 0, $art_cltbdwumvp$art_c = radioes.length; $art_ixskokduil$art_i < $art_cltbdwumvp$art_c; $art_ixskokduil$art_i++) {    var r = radioes[$art_ixskokduil$art_i]%>';
    for (var $art_ixskokduil$art_i = 0, $art_cltbdwumvp$art_c = radioes.length; $art_ixskokduil$art_i < $art_cltbdwumvp$art_c; $art_ixskokduil$art_i++) {
        var r = radioes[$art_ixskokduil$art_i];
