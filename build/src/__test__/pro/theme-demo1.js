...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifefasjqxa$art_i = 0, $art_cuderrarjh$art_c = checkboxes.length; $art_ifefasjqxa$art_i < $art_cuderrarjh$art_c; $art_ifefasjqxa$art_i++) {    var c = checkboxes[$art_ifefasjqxa$art_i]%>';
    for (var $art_ifefasjqxa$art_i = 0, $art_cuderrarjh$art_c = checkboxes.length; $art_ifefasjqxa$art_i < $art_cuderrarjh$art_c; $art_ifefasjqxa$art_i++) {
        var c = checkboxes[$art_ifefasjqxa$art_i];
    ...
    ;
    $expr = '<%for (var $art_iidzlll$art_i = 0, $art_cmrnwg$art_c = radioes.length; $art_iidzlll$art_i < $art_cmrnwg$art_c; $art_iidzlll$art_i++) {    var r = radioes[$art_iidzlll$art_i]%>';
    for (var $art_iidzlll$art_i = 0, $art_cmrnwg$art_c = radioes.length; $art_iidzlll$art_i < $art_cmrnwg$art_c; $art_iidzlll$art_i++) {
        var r = radioes[$art_iidzlll$art_i];
