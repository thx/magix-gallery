...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipasvotjd$art_i = 0, $art_cjwxfuzyal$art_c = checkboxes.length; $art_ipasvotjd$art_i < $art_cjwxfuzyal$art_c; $art_ipasvotjd$art_i++) {    var c = checkboxes[$art_ipasvotjd$art_i]%>';
    for (var $art_ipasvotjd$art_i = 0, $art_cjwxfuzyal$art_c = checkboxes.length; $art_ipasvotjd$art_i < $art_cjwxfuzyal$art_c; $art_ipasvotjd$art_i++) {
        var c = checkboxes[$art_ipasvotjd$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihnpjsj$art_i = 0, $art_cdqlwpfxhh$art_c = radioes.length; $art_ihnpjsj$art_i < $art_cdqlwpfxhh$art_c; $art_ihnpjsj$art_i++) {    var r = radioes[$art_ihnpjsj$art_i]%>';
    for (var $art_ihnpjsj$art_i = 0, $art_cdqlwpfxhh$art_c = radioes.length; $art_ihnpjsj$art_i < $art_cdqlwpfxhh$art_c; $art_ihnpjsj$art_i++) {
        var r = radioes[$art_ihnpjsj$art_i];
