...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikkxqipaahd$art_i = 0, $art_cybniyoi$art_c = checkboxes.length; $art_ikkxqipaahd$art_i < $art_cybniyoi$art_c; $art_ikkxqipaahd$art_i++) {    var c = checkboxes[$art_ikkxqipaahd$art_i]%>';
    for (var $art_ikkxqipaahd$art_i = 0, $art_cybniyoi$art_c = checkboxes.length; $art_ikkxqipaahd$art_i < $art_cybniyoi$art_c; $art_ikkxqipaahd$art_i++) {
        var c = checkboxes[$art_ikkxqipaahd$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilolsvotz$art_i = 0, $art_cmudslhulxp$art_c = radioes.length; $art_ilolsvotz$art_i < $art_cmudslhulxp$art_c; $art_ilolsvotz$art_i++) {    var r = radioes[$art_ilolsvotz$art_i]%>';
    for (var $art_ilolsvotz$art_i = 0, $art_cmudslhulxp$art_c = radioes.length; $art_ilolsvotz$art_i < $art_cmudslhulxp$art_c; $art_ilolsvotz$art_i++) {
        var r = radioes[$art_ilolsvotz$art_i];
