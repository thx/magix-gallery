...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itcbpikus$art_i = 0, $art_cbrtbkawe$art_c = checkboxes.length; $art_itcbpikus$art_i < $art_cbrtbkawe$art_c; $art_itcbpikus$art_i++) {    var c = checkboxes[$art_itcbpikus$art_i]%>';
    for (var $art_itcbpikus$art_i = 0, $art_cbrtbkawe$art_c = checkboxes.length; $art_itcbpikus$art_i < $art_cbrtbkawe$art_c; $art_itcbpikus$art_i++) {
        var c = checkboxes[$art_itcbpikus$art_i];
    ...
    ;
    $expr = '<%for (var $art_irkzdosrg$art_i = 0, $art_cpmcpwpgya$art_c = radioes.length; $art_irkzdosrg$art_i < $art_cpmcpwpgya$art_c; $art_irkzdosrg$art_i++) {    var r = radioes[$art_irkzdosrg$art_i]%>';
    for (var $art_irkzdosrg$art_i = 0, $art_cpmcpwpgya$art_c = radioes.length; $art_irkzdosrg$art_i < $art_cpmcpwpgya$art_c; $art_irkzdosrg$art_i++) {
        var r = radioes[$art_irkzdosrg$art_i];
