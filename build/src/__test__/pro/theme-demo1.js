...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwynyzqtm$art_i = 0, $art_cyvdkhba$art_c = checkboxes.length; $art_iwynyzqtm$art_i < $art_cyvdkhba$art_c; $art_iwynyzqtm$art_i++) {    var c = checkboxes[$art_iwynyzqtm$art_i]%>';
    for (var $art_iwynyzqtm$art_i = 0, $art_cyvdkhba$art_c = checkboxes.length; $art_iwynyzqtm$art_i < $art_cyvdkhba$art_c; $art_iwynyzqtm$art_i++) {
        var c = checkboxes[$art_iwynyzqtm$art_i];
    ...
    ;
    $expr = '<%for (var $art_igeqlmuoddi$art_i = 0, $art_cllbkdae$art_c = radioes.length; $art_igeqlmuoddi$art_i < $art_cllbkdae$art_c; $art_igeqlmuoddi$art_i++) {    var r = radioes[$art_igeqlmuoddi$art_i]%>';
    for (var $art_igeqlmuoddi$art_i = 0, $art_cllbkdae$art_c = radioes.length; $art_igeqlmuoddi$art_i < $art_cllbkdae$art_c; $art_igeqlmuoddi$art_i++) {
        var r = radioes[$art_igeqlmuoddi$art_i];
