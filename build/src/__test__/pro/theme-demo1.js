...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijbewknj$art_i = 0, $art_capdzrmkksv$art_c = checkboxes.length; $art_ijbewknj$art_i < $art_capdzrmkksv$art_c; $art_ijbewknj$art_i++) {    var c = checkboxes[$art_ijbewknj$art_i]%>';
    for (var $art_ijbewknj$art_i = 0, $art_capdzrmkksv$art_c = checkboxes.length; $art_ijbewknj$art_i < $art_capdzrmkksv$art_c; $art_ijbewknj$art_i++) {
        var c = checkboxes[$art_ijbewknj$art_i];
    ...
    ;
    $expr = '<%for (var $art_iaycyxv$art_i = 0, $art_cdydafq$art_c = radioes.length; $art_iaycyxv$art_i < $art_cdydafq$art_c; $art_iaycyxv$art_i++) {    var r = radioes[$art_iaycyxv$art_i]%>';
    for (var $art_iaycyxv$art_i = 0, $art_cdydafq$art_c = radioes.length; $art_iaycyxv$art_i < $art_cdydafq$art_c; $art_iaycyxv$art_i++) {
        var r = radioes[$art_iaycyxv$art_i];
