...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iurxmgwi$art_i = 0, $art_cuodzmtr$art_c = checkboxes.length; $art_iurxmgwi$art_i < $art_cuodzmtr$art_c; $art_iurxmgwi$art_i++) {    var c = checkboxes[$art_iurxmgwi$art_i]%>';
    for (var $art_iurxmgwi$art_i = 0, $art_cuodzmtr$art_c = checkboxes.length; $art_iurxmgwi$art_i < $art_cuodzmtr$art_c; $art_iurxmgwi$art_i++) {
        var c = checkboxes[$art_iurxmgwi$art_i];
    ...
    ;
    $expr = '<%for (var $art_imavfeacfg$art_i = 0, $art_cnlimrim$art_c = radioes.length; $art_imavfeacfg$art_i < $art_cnlimrim$art_c; $art_imavfeacfg$art_i++) {    var r = radioes[$art_imavfeacfg$art_i]%>';
    for (var $art_imavfeacfg$art_i = 0, $art_cnlimrim$art_c = radioes.length; $art_imavfeacfg$art_i < $art_cnlimrim$art_c; $art_imavfeacfg$art_i++) {
        var r = radioes[$art_imavfeacfg$art_i];
