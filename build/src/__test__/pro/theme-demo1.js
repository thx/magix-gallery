...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijdgzdpdl$art_i = 0, $art_ckrohcgvk$art_c = checkboxes.length; $art_ijdgzdpdl$art_i < $art_ckrohcgvk$art_c; $art_ijdgzdpdl$art_i++) {    var c = checkboxes[$art_ijdgzdpdl$art_i]%>';
    for (var $art_ijdgzdpdl$art_i = 0, $art_ckrohcgvk$art_c = checkboxes.length; $art_ijdgzdpdl$art_i < $art_ckrohcgvk$art_c; $art_ijdgzdpdl$art_i++) {
        var c = checkboxes[$art_ijdgzdpdl$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixbvnv$art_i = 0, $art_cxpazgej$art_c = radioes.length; $art_ixbvnv$art_i < $art_cxpazgej$art_c; $art_ixbvnv$art_i++) {    var r = radioes[$art_ixbvnv$art_i]%>';
    for (var $art_ixbvnv$art_i = 0, $art_cxpazgej$art_c = radioes.length; $art_ixbvnv$art_i < $art_cxpazgej$art_c; $art_ixbvnv$art_i++) {
        var r = radioes[$art_ixbvnv$art_i];
