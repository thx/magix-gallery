...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_initfbf$art_i = 0, $art_cdrvocunth$art_c = checkboxes.length; $art_initfbf$art_i < $art_cdrvocunth$art_c; $art_initfbf$art_i++) {    var c = checkboxes[$art_initfbf$art_i]%>';
    for (var $art_initfbf$art_i = 0, $art_cdrvocunth$art_c = checkboxes.length; $art_initfbf$art_i < $art_cdrvocunth$art_c; $art_initfbf$art_i++) {
        var c = checkboxes[$art_initfbf$art_i];
    ...
    ;
    $expr = '<%for (var $art_iibrgxnkufm$art_i = 0, $art_cqqftj$art_c = radioes.length; $art_iibrgxnkufm$art_i < $art_cqqftj$art_c; $art_iibrgxnkufm$art_i++) {    var r = radioes[$art_iibrgxnkufm$art_i]%>';
    for (var $art_iibrgxnkufm$art_i = 0, $art_cqqftj$art_c = radioes.length; $art_iibrgxnkufm$art_i < $art_cqqftj$art_c; $art_iibrgxnkufm$art_i++) {
        var r = radioes[$art_iibrgxnkufm$art_i];
