...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivcywjuksud$art_i = 0, $art_cgyxqtpebl$art_c = checkboxes.length; $art_ivcywjuksud$art_i < $art_cgyxqtpebl$art_c; $art_ivcywjuksud$art_i++) {    var c = checkboxes[$art_ivcywjuksud$art_i]%>';
    for (var $art_ivcywjuksud$art_i = 0, $art_cgyxqtpebl$art_c = checkboxes.length; $art_ivcywjuksud$art_i < $art_cgyxqtpebl$art_c; $art_ivcywjuksud$art_i++) {
        var c = checkboxes[$art_ivcywjuksud$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqfuomki$art_i = 0, $art_cfzzcioxn$art_c = radioes.length; $art_iqfuomki$art_i < $art_cfzzcioxn$art_c; $art_iqfuomki$art_i++) {    var r = radioes[$art_iqfuomki$art_i]%>';
    for (var $art_iqfuomki$art_i = 0, $art_cfzzcioxn$art_c = radioes.length; $art_iqfuomki$art_i < $art_cfzzcioxn$art_c; $art_iqfuomki$art_i++) {
        var r = radioes[$art_iqfuomki$art_i];
    ...
    $art = ':selected.name';
    ;
    $p += ($expr = '<%=selected.name%>', $e(selected.name)) + '"/><a mxs="_zs_galleryK:f" rel="noopener noreferrer" href="https://thx.github.io/magix/" target="_blank" class="ml20 link-brand">跳转链接</a></div></div><div mxa="_zs_galleryK:k" class="form-item"><div mxs="_zs_galleryK:g" class="form-label">日历</div><div mxa="_zs_galleryK:l" class="form-content"><div class="w220" mx-view="mx-calendar/datepicker?prefix=%E6%88%AA%E6%AD%A2%E8%87%B3&selected=';
    $line = 54;
    $art = '=selected.time';
    ;
    $p += ($expr = '<%!$eu(selected.time)%>', $eu(selected.time)) + '"></div></div></div><div mxa="_zs_galleryK:m" class="form-item"><div mxs="_zs_galleryK:h" class="form-label">开关</div><div mxa="_zs_galleryK:n" class="form-content"><span mxe="' + $viewId + '_4_' + ($expr = '<%="switch"%>', $e("switch")) + '" mxc="[';
    $line = 61;
    $art = ':selected.switch';
    ;
