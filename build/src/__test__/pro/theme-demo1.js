...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixfckmg$art_i = 0, $art_cnyqpgsmwy$art_c = checkboxes.length; $art_ixfckmg$art_i < $art_cnyqpgsmwy$art_c; $art_ixfckmg$art_i++) {    var c = checkboxes[$art_ixfckmg$art_i]%>';
    for (var $art_ixfckmg$art_i = 0, $art_cnyqpgsmwy$art_c = checkboxes.length; $art_ixfckmg$art_i < $art_cnyqpgsmwy$art_c; $art_ixfckmg$art_i++) {
        var c = checkboxes[$art_ixfckmg$art_i];
    ...
    ;
    $expr = '<%for (var $art_icfudxp$art_i = 0, $art_cfzmmfuvt$art_c = radioes.length; $art_icfudxp$art_i < $art_cfzmmfuvt$art_c; $art_icfudxp$art_i++) {    var r = radioes[$art_icfudxp$art_i]%>';
    for (var $art_icfudxp$art_i = 0, $art_cfzmmfuvt$art_c = radioes.length; $art_icfudxp$art_i < $art_cfzmmfuvt$art_c; $art_icfudxp$art_i++) {
        var r = radioes[$art_icfudxp$art_i];
