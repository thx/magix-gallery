...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_istrxztab$art_i = 0, $art_cgaideahq$art_c = checkboxes.length; $art_istrxztab$art_i < $art_cgaideahq$art_c; $art_istrxztab$art_i++) {    var c = checkboxes[$art_istrxztab$art_i]%>';
    for (var $art_istrxztab$art_i = 0, $art_cgaideahq$art_c = checkboxes.length; $art_istrxztab$art_i < $art_cgaideahq$art_c; $art_istrxztab$art_i++) {
        var c = checkboxes[$art_istrxztab$art_i];
    ...
    ;
    $expr = '<%for (var $art_imrmcp$art_i = 0, $art_cjszgdrnf$art_c = radioes.length; $art_imrmcp$art_i < $art_cjszgdrnf$art_c; $art_imrmcp$art_i++) {    var r = radioes[$art_imrmcp$art_i]%>';
    for (var $art_imrmcp$art_i = 0, $art_cjszgdrnf$art_c = radioes.length; $art_imrmcp$art_i < $art_cjszgdrnf$art_c; $art_imrmcp$art_i++) {
        var r = radioes[$art_imrmcp$art_i];
