...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyjmynkfwd$art_i = 0, $art_caiwguzldh$art_c = checkboxes.length; $art_iyjmynkfwd$art_i < $art_caiwguzldh$art_c; $art_iyjmynkfwd$art_i++) {    var c = checkboxes[$art_iyjmynkfwd$art_i]%>';
    for (var $art_iyjmynkfwd$art_i = 0, $art_caiwguzldh$art_c = checkboxes.length; $art_iyjmynkfwd$art_i < $art_caiwguzldh$art_c; $art_iyjmynkfwd$art_i++) {
        var c = checkboxes[$art_iyjmynkfwd$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipyudj$art_i = 0, $art_ctjszezh$art_c = radioes.length; $art_ipyudj$art_i < $art_ctjszezh$art_c; $art_ipyudj$art_i++) {    var r = radioes[$art_ipyudj$art_i]%>';
    for (var $art_ipyudj$art_i = 0, $art_ctjszezh$art_c = radioes.length; $art_ipyudj$art_i < $art_ctjszezh$art_c; $art_ipyudj$art_i++) {
        var r = radioes[$art_ipyudj$art_i];
