...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igfmexwfsg$art_i = 0, $art_cfpghgwwlp$art_c = checkboxes.length; $art_igfmexwfsg$art_i < $art_cfpghgwwlp$art_c; $art_igfmexwfsg$art_i++) {    var c = checkboxes[$art_igfmexwfsg$art_i]%>';
    for (var $art_igfmexwfsg$art_i = 0, $art_cfpghgwwlp$art_c = checkboxes.length; $art_igfmexwfsg$art_i < $art_cfpghgwwlp$art_c; $art_igfmexwfsg$art_i++) {
        var c = checkboxes[$art_igfmexwfsg$art_i];
    ...
    ;
    $expr = '<%for (var $art_iezlpya$art_i = 0, $art_crgnggoj$art_c = radioes.length; $art_iezlpya$art_i < $art_crgnggoj$art_c; $art_iezlpya$art_i++) {    var r = radioes[$art_iezlpya$art_i]%>';
    for (var $art_iezlpya$art_i = 0, $art_crgnggoj$art_c = radioes.length; $art_iezlpya$art_i < $art_crgnggoj$art_c; $art_iezlpya$art_i++) {
        var r = radioes[$art_iezlpya$art_i];
