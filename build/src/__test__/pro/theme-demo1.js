...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itaofycdl$art_i = 0, $art_cswqmbcmeld$art_c = checkboxes.length; $art_itaofycdl$art_i < $art_cswqmbcmeld$art_c; $art_itaofycdl$art_i++) {    var c = checkboxes[$art_itaofycdl$art_i]%>';
    for (var $art_itaofycdl$art_i = 0, $art_cswqmbcmeld$art_c = checkboxes.length; $art_itaofycdl$art_i < $art_cswqmbcmeld$art_c; $art_itaofycdl$art_i++) {
        var c = checkboxes[$art_itaofycdl$art_i];
    ...
    ;
    $expr = '<%for (var $art_igztvs$art_i = 0, $art_cyhqwe$art_c = radioes.length; $art_igztvs$art_i < $art_cyhqwe$art_c; $art_igztvs$art_i++) {    var r = radioes[$art_igztvs$art_i]%>';
    for (var $art_igztvs$art_i = 0, $art_cyhqwe$art_c = radioes.length; $art_igztvs$art_i < $art_cyhqwe$art_c; $art_igztvs$art_i++) {
        var r = radioes[$art_igztvs$art_i];
