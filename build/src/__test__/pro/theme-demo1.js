...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioyfwxleg$art_i = 0, $art_czgxbqlpzxn$art_c = checkboxes.length; $art_ioyfwxleg$art_i < $art_czgxbqlpzxn$art_c; $art_ioyfwxleg$art_i++) {    var c = checkboxes[$art_ioyfwxleg$art_i]%>';
    for (var $art_ioyfwxleg$art_i = 0, $art_czgxbqlpzxn$art_c = checkboxes.length; $art_ioyfwxleg$art_i < $art_czgxbqlpzxn$art_c; $art_ioyfwxleg$art_i++) {
        var c = checkboxes[$art_ioyfwxleg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifinvuxrc$art_i = 0, $art_cemaofcjr$art_c = radioes.length; $art_ifinvuxrc$art_i < $art_cemaofcjr$art_c; $art_ifinvuxrc$art_i++) {    var r = radioes[$art_ifinvuxrc$art_i]%>';
    for (var $art_ifinvuxrc$art_i = 0, $art_cemaofcjr$art_c = radioes.length; $art_ifinvuxrc$art_i < $art_cemaofcjr$art_c; $art_ifinvuxrc$art_i++) {
        var r = radioes[$art_ifinvuxrc$art_i];
