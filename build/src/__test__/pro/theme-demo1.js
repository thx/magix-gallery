...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iojwbqxuhd$art_i = 0, $art_csqplfcv$art_c = checkboxes.length; $art_iojwbqxuhd$art_i < $art_csqplfcv$art_c; $art_iojwbqxuhd$art_i++) {    var c = checkboxes[$art_iojwbqxuhd$art_i]%>';
    for (var $art_iojwbqxuhd$art_i = 0, $art_csqplfcv$art_c = checkboxes.length; $art_iojwbqxuhd$art_i < $art_csqplfcv$art_c; $art_iojwbqxuhd$art_i++) {
        var c = checkboxes[$art_iojwbqxuhd$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifpbfhvu$art_i = 0, $art_czemsyf$art_c = radioes.length; $art_ifpbfhvu$art_i < $art_czemsyf$art_c; $art_ifpbfhvu$art_i++) {    var r = radioes[$art_ifpbfhvu$art_i]%>';
    for (var $art_ifpbfhvu$art_i = 0, $art_czemsyf$art_c = radioes.length; $art_ifpbfhvu$art_i < $art_czemsyf$art_c; $art_ifpbfhvu$art_i++) {
        var r = radioes[$art_ifpbfhvu$art_i];
