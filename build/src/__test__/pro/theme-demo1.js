...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iewbvcaa$art_i = 0, $art_cubuyzcgbzxs$art_c = checkboxes.length; $art_iewbvcaa$art_i < $art_cubuyzcgbzxs$art_c; $art_iewbvcaa$art_i++) {    var c = checkboxes[$art_iewbvcaa$art_i]%>';
    for (var $art_iewbvcaa$art_i = 0, $art_cubuyzcgbzxs$art_c = checkboxes.length; $art_iewbvcaa$art_i < $art_cubuyzcgbzxs$art_c; $art_iewbvcaa$art_i++) {
        var c = checkboxes[$art_iewbvcaa$art_i];
    ...
    ;
    $expr = '<%for (var $art_iefrsmc$art_i = 0, $art_cabgyppjkoc$art_c = radioes.length; $art_iefrsmc$art_i < $art_cabgyppjkoc$art_c; $art_iefrsmc$art_i++) {    var r = radioes[$art_iefrsmc$art_i]%>';
    for (var $art_iefrsmc$art_i = 0, $art_cabgyppjkoc$art_c = radioes.length; $art_iefrsmc$art_i < $art_cabgyppjkoc$art_c; $art_iefrsmc$art_i++) {
        var r = radioes[$art_iefrsmc$art_i];
