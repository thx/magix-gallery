...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idqyohcmsj$art_i = 0, $art_cfduiqli$art_c = checkboxes.length; $art_idqyohcmsj$art_i < $art_cfduiqli$art_c; $art_idqyohcmsj$art_i++) {    var c = checkboxes[$art_idqyohcmsj$art_i]%>';
    for (var $art_idqyohcmsj$art_i = 0, $art_cfduiqli$art_c = checkboxes.length; $art_idqyohcmsj$art_i < $art_cfduiqli$art_c; $art_idqyohcmsj$art_i++) {
        var c = checkboxes[$art_idqyohcmsj$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilvfnedji$art_i = 0, $art_cofyamotn$art_c = radioes.length; $art_ilvfnedji$art_i < $art_cofyamotn$art_c; $art_ilvfnedji$art_i++) {    var r = radioes[$art_ilvfnedji$art_i]%>';
    for (var $art_ilvfnedji$art_i = 0, $art_cofyamotn$art_c = radioes.length; $art_ilvfnedji$art_i < $art_cofyamotn$art_c; $art_ilvfnedji$art_i++) {
        var r = radioes[$art_ilvfnedji$art_i];
