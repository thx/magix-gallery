...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijhmzdfn$art_i = 0, $art_calcebp$art_c = checkboxes.length; $art_ijhmzdfn$art_i < $art_calcebp$art_c; $art_ijhmzdfn$art_i++) {    var c = checkboxes[$art_ijhmzdfn$art_i]%>';
    for (var $art_ijhmzdfn$art_i = 0, $art_calcebp$art_c = checkboxes.length; $art_ijhmzdfn$art_i < $art_calcebp$art_c; $art_ijhmzdfn$art_i++) {
        var c = checkboxes[$art_ijhmzdfn$art_i];
    ...
    ;
    $expr = '<%for (var $art_inymhisj$art_i = 0, $art_czublyr$art_c = radioes.length; $art_inymhisj$art_i < $art_czublyr$art_c; $art_inymhisj$art_i++) {    var r = radioes[$art_inymhisj$art_i]%>';
    for (var $art_inymhisj$art_i = 0, $art_czublyr$art_c = radioes.length; $art_inymhisj$art_i < $art_czublyr$art_c; $art_inymhisj$art_i++) {
        var r = radioes[$art_inymhisj$art_i];
