...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isyflxhem$art_i = 0, $art_ckctryfon$art_c = checkboxes.length; $art_isyflxhem$art_i < $art_ckctryfon$art_c; $art_isyflxhem$art_i++) {    var c = checkboxes[$art_isyflxhem$art_i]%>';
    for (var $art_isyflxhem$art_i = 0, $art_ckctryfon$art_c = checkboxes.length; $art_isyflxhem$art_i < $art_ckctryfon$art_c; $art_isyflxhem$art_i++) {
        var c = checkboxes[$art_isyflxhem$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifgzrajsrxl$art_i = 0, $art_cpopbap$art_c = radioes.length; $art_ifgzrajsrxl$art_i < $art_cpopbap$art_c; $art_ifgzrajsrxl$art_i++) {    var r = radioes[$art_ifgzrajsrxl$art_i]%>';
    for (var $art_ifgzrajsrxl$art_i = 0, $art_cpopbap$art_c = radioes.length; $art_ifgzrajsrxl$art_i < $art_cpopbap$art_c; $art_ifgzrajsrxl$art_i++) {
        var r = radioes[$art_ifgzrajsrxl$art_i];
