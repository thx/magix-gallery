...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icvezposdoe$art_i = 0, $art_cenoulttxc$art_c = checkboxes.length; $art_icvezposdoe$art_i < $art_cenoulttxc$art_c; $art_icvezposdoe$art_i++) {    var c = checkboxes[$art_icvezposdoe$art_i]%>';
    for (var $art_icvezposdoe$art_i = 0, $art_cenoulttxc$art_c = checkboxes.length; $art_icvezposdoe$art_i < $art_cenoulttxc$art_c; $art_icvezposdoe$art_i++) {
        var c = checkboxes[$art_icvezposdoe$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipbeabvm$art_i = 0, $art_czrdzflmwk$art_c = radioes.length; $art_ipbeabvm$art_i < $art_czrdzflmwk$art_c; $art_ipbeabvm$art_i++) {    var r = radioes[$art_ipbeabvm$art_i]%>';
    for (var $art_ipbeabvm$art_i = 0, $art_czrdzflmwk$art_c = radioes.length; $art_ipbeabvm$art_i < $art_czrdzflmwk$art_c; $art_ipbeabvm$art_i++) {
        var r = radioes[$art_ipbeabvm$art_i];
