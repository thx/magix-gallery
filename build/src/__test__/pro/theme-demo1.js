...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izxgjwz$art_i = 0, $art_clobtzcblh$art_c = checkboxes.length; $art_izxgjwz$art_i < $art_clobtzcblh$art_c; $art_izxgjwz$art_i++) {    var c = checkboxes[$art_izxgjwz$art_i]%>';
    for (var $art_izxgjwz$art_i = 0, $art_clobtzcblh$art_c = checkboxes.length; $art_izxgjwz$art_i < $art_clobtzcblh$art_c; $art_izxgjwz$art_i++) {
        var c = checkboxes[$art_izxgjwz$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilswgol$art_i = 0, $art_cjtrhtmxv$art_c = radioes.length; $art_ilswgol$art_i < $art_cjtrhtmxv$art_c; $art_ilswgol$art_i++) {    var r = radioes[$art_ilswgol$art_i]%>';
    for (var $art_ilswgol$art_i = 0, $art_cjtrhtmxv$art_c = radioes.length; $art_ilswgol$art_i < $art_cjtrhtmxv$art_c; $art_ilswgol$art_i++) {
        var r = radioes[$art_ilswgol$art_i];
