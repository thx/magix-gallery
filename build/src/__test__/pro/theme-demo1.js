...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioqzlwm$art_i = 0, $art_cbvrylopqx$art_c = checkboxes.length; $art_ioqzlwm$art_i < $art_cbvrylopqx$art_c; $art_ioqzlwm$art_i++) {    var c = checkboxes[$art_ioqzlwm$art_i]%>';
    for (var $art_ioqzlwm$art_i = 0, $art_cbvrylopqx$art_c = checkboxes.length; $art_ioqzlwm$art_i < $art_cbvrylopqx$art_c; $art_ioqzlwm$art_i++) {
        var c = checkboxes[$art_ioqzlwm$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixjjtgqjwj$art_i = 0, $art_cmmyrispap$art_c = radioes.length; $art_ixjjtgqjwj$art_i < $art_cmmyrispap$art_c; $art_ixjjtgqjwj$art_i++) {    var r = radioes[$art_ixjjtgqjwj$art_i]%>';
    for (var $art_ixjjtgqjwj$art_i = 0, $art_cmmyrispap$art_c = radioes.length; $art_ixjjtgqjwj$art_i < $art_cmmyrispap$art_c; $art_ixjjtgqjwj$art_i++) {
        var r = radioes[$art_ixjjtgqjwj$art_i];
