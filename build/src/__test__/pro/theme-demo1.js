...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipizovhsy$art_i = 0, $art_csfrcocg$art_c = checkboxes.length; $art_ipizovhsy$art_i < $art_csfrcocg$art_c; $art_ipizovhsy$art_i++) {    var c = checkboxes[$art_ipizovhsy$art_i]%>';
    for (var $art_ipizovhsy$art_i = 0, $art_csfrcocg$art_c = checkboxes.length; $art_ipizovhsy$art_i < $art_csfrcocg$art_c; $art_ipizovhsy$art_i++) {
        var c = checkboxes[$art_ipizovhsy$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifiueuxi$art_i = 0, $art_cmmxestnui$art_c = radioes.length; $art_ifiueuxi$art_i < $art_cmmxestnui$art_c; $art_ifiueuxi$art_i++) {    var r = radioes[$art_ifiueuxi$art_i]%>';
    for (var $art_ifiueuxi$art_i = 0, $art_cmmxestnui$art_c = radioes.length; $art_ifiueuxi$art_i < $art_cmmxestnui$art_c; $art_ifiueuxi$art_i++) {
        var r = radioes[$art_ifiueuxi$art_i];
