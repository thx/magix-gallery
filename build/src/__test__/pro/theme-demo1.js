...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iketkohug$art_i = 0, $art_cqglkxxiedok$art_c = checkboxes.length; $art_iketkohug$art_i < $art_cqglkxxiedok$art_c; $art_iketkohug$art_i++) {    var c = checkboxes[$art_iketkohug$art_i]%>';
    for (var $art_iketkohug$art_i = 0, $art_cqglkxxiedok$art_c = checkboxes.length; $art_iketkohug$art_i < $art_cqglkxxiedok$art_c; $art_iketkohug$art_i++) {
        var c = checkboxes[$art_iketkohug$art_i];
    ...
    ;
    $expr = '<%for (var $art_inqvuft$art_i = 0, $art_cuzyxoeay$art_c = radioes.length; $art_inqvuft$art_i < $art_cuzyxoeay$art_c; $art_inqvuft$art_i++) {    var r = radioes[$art_inqvuft$art_i]%>';
    for (var $art_inqvuft$art_i = 0, $art_cuzyxoeay$art_c = radioes.length; $art_inqvuft$art_i < $art_cuzyxoeay$art_c; $art_inqvuft$art_i++) {
        var r = radioes[$art_inqvuft$art_i];
