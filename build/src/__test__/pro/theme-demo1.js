...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipzfeap$art_i = 0, $art_cnyxesiqa$art_c = checkboxes.length; $art_ipzfeap$art_i < $art_cnyxesiqa$art_c; $art_ipzfeap$art_i++) {    var c = checkboxes[$art_ipzfeap$art_i]%>';
    for (var $art_ipzfeap$art_i = 0, $art_cnyxesiqa$art_c = checkboxes.length; $art_ipzfeap$art_i < $art_cnyxesiqa$art_c; $art_ipzfeap$art_i++) {
        var c = checkboxes[$art_ipzfeap$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipqmvg$art_i = 0, $art_chmhxfscogu$art_c = radioes.length; $art_ipqmvg$art_i < $art_chmhxfscogu$art_c; $art_ipqmvg$art_i++) {    var r = radioes[$art_ipqmvg$art_i]%>';
    for (var $art_ipqmvg$art_i = 0, $art_chmhxfscogu$art_c = radioes.length; $art_ipqmvg$art_i < $art_chmhxfscogu$art_c; $art_ipqmvg$art_i++) {
        var r = radioes[$art_ipqmvg$art_i];
