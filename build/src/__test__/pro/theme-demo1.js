...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikztqizkia$art_i = 0, $art_cwootd$art_c = checkboxes.length; $art_ikztqizkia$art_i < $art_cwootd$art_c; $art_ikztqizkia$art_i++) {    var c = checkboxes[$art_ikztqizkia$art_i]%>';
    for (var $art_ikztqizkia$art_i = 0, $art_cwootd$art_c = checkboxes.length; $art_ikztqizkia$art_i < $art_cwootd$art_c; $art_ikztqizkia$art_i++) {
        var c = checkboxes[$art_ikztqizkia$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwlqujb$art_i = 0, $art_csqqswjb$art_c = radioes.length; $art_iwlqujb$art_i < $art_csqqswjb$art_c; $art_iwlqujb$art_i++) {    var r = radioes[$art_iwlqujb$art_i]%>';
    for (var $art_iwlqujb$art_i = 0, $art_csqqswjb$art_c = radioes.length; $art_iwlqujb$art_i < $art_csqqswjb$art_c; $art_iwlqujb$art_i++) {
        var r = radioes[$art_iwlqujb$art_i];
