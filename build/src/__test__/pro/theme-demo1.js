...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igthbxaalak$art_i = 0, $art_colwhrctayq$art_c = checkboxes.length; $art_igthbxaalak$art_i < $art_colwhrctayq$art_c; $art_igthbxaalak$art_i++) {    var c = checkboxes[$art_igthbxaalak$art_i]%>';
    for (var $art_igthbxaalak$art_i = 0, $art_colwhrctayq$art_c = checkboxes.length; $art_igthbxaalak$art_i < $art_colwhrctayq$art_c; $art_igthbxaalak$art_i++) {
        var c = checkboxes[$art_igthbxaalak$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibxmmieau$art_i = 0, $art_ceutcuxmdd$art_c = radioes.length; $art_ibxmmieau$art_i < $art_ceutcuxmdd$art_c; $art_ibxmmieau$art_i++) {    var r = radioes[$art_ibxmmieau$art_i]%>';
    for (var $art_ibxmmieau$art_i = 0, $art_ceutcuxmdd$art_c = radioes.length; $art_ibxmmieau$art_i < $art_ceutcuxmdd$art_c; $art_ibxmmieau$art_i++) {
        var r = radioes[$art_ibxmmieau$art_i];
