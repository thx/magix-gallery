...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifykmokr$art_i = 0, $art_ccqrttjnlre$art_c = checkboxes.length; $art_ifykmokr$art_i < $art_ccqrttjnlre$art_c; $art_ifykmokr$art_i++) {    var c = checkboxes[$art_ifykmokr$art_i]%>';
    for (var $art_ifykmokr$art_i = 0, $art_ccqrttjnlre$art_c = checkboxes.length; $art_ifykmokr$art_i < $art_ccqrttjnlre$art_c; $art_ifykmokr$art_i++) {
        var c = checkboxes[$art_ifykmokr$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivnsjrosi$art_i = 0, $art_cmfkqblgk$art_c = radioes.length; $art_ivnsjrosi$art_i < $art_cmfkqblgk$art_c; $art_ivnsjrosi$art_i++) {    var r = radioes[$art_ivnsjrosi$art_i]%>';
    for (var $art_ivnsjrosi$art_i = 0, $art_cmfkqblgk$art_c = radioes.length; $art_ivnsjrosi$art_i < $art_cmfkqblgk$art_c; $art_ivnsjrosi$art_i++) {
        var r = radioes[$art_ivnsjrosi$art_i];
