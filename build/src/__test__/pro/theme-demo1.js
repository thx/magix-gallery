...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibdigcg$art_i = 0, $art_cwupxnya$art_c = checkboxes.length; $art_ibdigcg$art_i < $art_cwupxnya$art_c; $art_ibdigcg$art_i++) {    var c = checkboxes[$art_ibdigcg$art_i]%>';
    for (var $art_ibdigcg$art_i = 0, $art_cwupxnya$art_c = checkboxes.length; $art_ibdigcg$art_i < $art_cwupxnya$art_c; $art_ibdigcg$art_i++) {
        var c = checkboxes[$art_ibdigcg$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqpqefy$art_i = 0, $art_ccvrubvdd$art_c = radioes.length; $art_iqpqefy$art_i < $art_ccvrubvdd$art_c; $art_iqpqefy$art_i++) {    var r = radioes[$art_iqpqefy$art_i]%>';
    for (var $art_iqpqefy$art_i = 0, $art_ccvrubvdd$art_c = radioes.length; $art_iqpqefy$art_i < $art_ccvrubvdd$art_c; $art_iqpqefy$art_i++) {
        var r = radioes[$art_iqpqefy$art_i];
