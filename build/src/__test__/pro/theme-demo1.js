...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikbykkgzx$art_i = 0, $art_czvobso$art_c = checkboxes.length; $art_ikbykkgzx$art_i < $art_czvobso$art_c; $art_ikbykkgzx$art_i++) {    var c = checkboxes[$art_ikbykkgzx$art_i]%>';
    for (var $art_ikbykkgzx$art_i = 0, $art_czvobso$art_c = checkboxes.length; $art_ikbykkgzx$art_i < $art_czvobso$art_c; $art_ikbykkgzx$art_i++) {
        var c = checkboxes[$art_ikbykkgzx$art_i];
    ...
    ;
    $expr = '<%for (var $art_iytbevje$art_i = 0, $art_cszxvubot$art_c = radioes.length; $art_iytbevje$art_i < $art_cszxvubot$art_c; $art_iytbevje$art_i++) {    var r = radioes[$art_iytbevje$art_i]%>';
    for (var $art_iytbevje$art_i = 0, $art_cszxvubot$art_c = radioes.length; $art_iytbevje$art_i < $art_cszxvubot$art_c; $art_iytbevje$art_i++) {
        var r = radioes[$art_iytbevje$art_i];
