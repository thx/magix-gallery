...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ignslhmdt$art_i = 0, $art_crbqytc$art_c = checkboxes.length; $art_ignslhmdt$art_i < $art_crbqytc$art_c; $art_ignslhmdt$art_i++) {    var c = checkboxes[$art_ignslhmdt$art_i]%>';
    for (var $art_ignslhmdt$art_i = 0, $art_crbqytc$art_c = checkboxes.length; $art_ignslhmdt$art_i < $art_crbqytc$art_c; $art_ignslhmdt$art_i++) {
        var c = checkboxes[$art_ignslhmdt$art_i];
    ...
    ;
    $expr = '<%for (var $art_iucdkckcak$art_i = 0, $art_cyiduzym$art_c = radioes.length; $art_iucdkckcak$art_i < $art_cyiduzym$art_c; $art_iucdkckcak$art_i++) {    var r = radioes[$art_iucdkckcak$art_i]%>';
    for (var $art_iucdkckcak$art_i = 0, $art_cyiduzym$art_c = radioes.length; $art_iucdkckcak$art_i < $art_cyiduzym$art_c; $art_iucdkckcak$art_i++) {
        var r = radioes[$art_iucdkckcak$art_i];
