...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_galleryD:a" class="clearfix"><div class="_zs_gallery___test___pro_theme-demo_-demo-wrapper fl"><div mx-view="__test__/pro/theme-demo1" class="fl"></div><div mx-view="__test__/pro/theme-demo2" class="fr"></div></div></div>';
}
catch (ex) {
