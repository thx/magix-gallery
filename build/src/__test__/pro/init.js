...
module.exports = Magix.View.extend({
    ...
    $art = '=contents';
    ;
    $p += ($expr = '<%!$eu(contents)%>', $eu(contents)) + '"></div><div mxa="_zs_galleryl:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 8;
    $art = '@[{\n        name: \'创建步骤\',\n        key: viewId + \'_steps\'\n    }, {\n        name: \'目录结构说明\',\n        key: viewId + \'_dir\'\n    }]';
    ;
