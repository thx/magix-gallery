...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryt:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryt:a" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-top-none"><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 3;
    $art = '=viewId';
    ;
    ...
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryt:_" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 8;
    $art = '=viewId';
    ;
