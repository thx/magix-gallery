...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycN:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_gallerycN:a" class="_zs_gallery___test___base_-eg-desc _zs_gallery___test___base_-top-none"><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 3;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerycN:b" class="_zs_gallery___test___base_-desc-tip">';
    $line = 5;
    $art = '!text1';
    ;
    $p += '' + ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_gallerycN:_" class="mc-iconfont _zs_gallery___test___base_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 8;
    $art = '=viewId';
    ;
