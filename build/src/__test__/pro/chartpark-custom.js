...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryd:a" class="_zs_gallery___test___layout_-eg-content"><div mxv="chartOptions,chartData" mx-view="__test__/pro/chartpark/demo?options=';
    $line = 3;
    $art = '@chartOptions';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryd:a" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 26;
    $art = '=viewId';
    ;
