/*
    ...
    loader: cmd_es
 */
define("__test__/pro/chartpark-custom",["magix","$"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_galleryc:_" class="_zs_gallery___test___layout_-example"><div class="_zs_gallery___test___layout_-eg-content">Todo</div></div>';
}
catch (ex) {
