...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryi:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryi:a" class="_zs_gallery___test___layout_-eg-content"><div mxv="chartOptions,chartData" mx-view="__test__/pro/chartpark/demo?options=';
    $line = 3;
    $art = '@chartOptions';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryi:f" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 23;
    $art = '!text2';
    ;
