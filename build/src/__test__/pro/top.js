...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inlqpux$art_i = 0, $art_camodzkwl$art_c = list.length; $art_inlqpux$art_i < $art_camodzkwl$art_c; $art_inlqpux$art_i++) {    var item = list[$art_inlqpux$art_i]%>';
    for (var $art_inlqpux$art_i = 0, $art_camodzkwl$art_c = list.length; $art_inlqpux$art_i < $art_camodzkwl$art_c; $art_inlqpux$art_i++) {
        var item = list[$art_inlqpux$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
