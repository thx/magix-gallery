...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isfgdasce$art_i = 0, $art_cwfzhodrr$art_c = list.length; $art_isfgdasce$art_i < $art_cwfzhodrr$art_c; $art_isfgdasce$art_i++) {    var item = list[$art_isfgdasce$art_i]%>';
    for (var $art_isfgdasce$art_i = 0, $art_cwfzhodrr$art_c = list.length; $art_isfgdasce$art_i < $art_cwfzhodrr$art_c; $art_isfgdasce$art_i++) {
        var item = list[$art_isfgdasce$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
