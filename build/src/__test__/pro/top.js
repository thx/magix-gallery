...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyidittlduj$art_i = 0, $art_ceuuamtye$art_c = list.length; $art_iyidittlduj$art_i < $art_ceuuamtye$art_c; $art_iyidittlduj$art_i++) {    var item = list[$art_iyidittlduj$art_i]%>';
    for (var $art_iyidittlduj$art_i = 0, $art_ceuuamtye$art_c = list.length; $art_iyidittlduj$art_i < $art_ceuuamtye$art_c; $art_iyidittlduj$art_i++) {
        var item = list[$art_iyidittlduj$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
