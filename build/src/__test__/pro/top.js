...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isyejwybxgp$art_i = 0, $art_cmsupivmvka$art_c = list.length; $art_isyejwybxgp$art_i < $art_cmsupivmvka$art_c; $art_isyejwybxgp$art_i++) {    var item = list[$art_isyejwybxgp$art_i]%>';
    for (var $art_isyejwybxgp$art_i = 0, $art_cmsupivmvka$art_c = list.length; $art_isyejwybxgp$art_i < $art_cmsupivmvka$art_c; $art_isyejwybxgp$art_i++) {
        var item = list[$art_isyejwybxgp$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
