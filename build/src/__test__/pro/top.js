...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikvofjslie$art_i = 0, $art_cmeddd$art_c = list.length; $art_ikvofjslie$art_i < $art_cmeddd$art_c; $art_ikvofjslie$art_i++) {    var item = list[$art_ikvofjslie$art_i]%>';
    for (var $art_ikvofjslie$art_i = 0, $art_cmeddd$art_c = list.length; $art_ikvofjslie$art_i < $art_cmeddd$art_c; $art_ikvofjslie$art_i++) {
        var item = list[$art_ikvofjslie$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
