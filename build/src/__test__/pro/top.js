...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipzherqi$art_i = 0, $art_cwihvubsqvx$art_c = list.length; $art_ipzherqi$art_i < $art_cwihvubsqvx$art_c; $art_ipzherqi$art_i++) {    var item = list[$art_ipzherqi$art_i]%>';
    for (var $art_ipzherqi$art_i = 0, $art_cwihvubsqvx$art_c = list.length; $art_ipzherqi$art_i < $art_cwihvubsqvx$art_c; $art_ipzherqi$art_i++) {
        var item = list[$art_ipzherqi$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
