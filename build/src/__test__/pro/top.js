...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqpeuhehguc$art_i = 0, $art_cplpcjvd$art_c = list.length; $art_iqpeuhehguc$art_i < $art_cplpcjvd$art_c; $art_iqpeuhehguc$art_i++) {    var item = list[$art_iqpeuhehguc$art_i]%>';
    for (var $art_iqpeuhehguc$art_i = 0, $art_cplpcjvd$art_c = list.length; $art_iqpeuhehguc$art_i < $art_cplpcjvd$art_c; $art_iqpeuhehguc$art_i++) {
        var item = list[$art_iqpeuhehguc$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
