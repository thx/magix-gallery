...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijchpkp$art_i = 0, $art_cqqhyozkli$art_c = list.length; $art_ijchpkp$art_i < $art_cqqhyozkli$art_c; $art_ijchpkp$art_i++) {    var item = list[$art_ijchpkp$art_i]%>';
    for (var $art_ijchpkp$art_i = 0, $art_cqqhyozkli$art_c = list.length; $art_ijchpkp$art_i < $art_cqqhyozkli$art_c; $art_ijchpkp$art_i++) {
        var item = list[$art_ijchpkp$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
