...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivsdugooqmk$art_i = 0, $art_cponrdqvq$art_c = list.length; $art_ivsdugooqmk$art_i < $art_cponrdqvq$art_c; $art_ivsdugooqmk$art_i++) {    var item = list[$art_ivsdugooqmk$art_i]%>';
    for (var $art_ivsdugooqmk$art_i = 0, $art_cponrdqvq$art_c = list.length; $art_ivsdugooqmk$art_i < $art_cponrdqvq$art_c; $art_ivsdugooqmk$art_i++) {
        var item = list[$art_ivsdugooqmk$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
