...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifjbnhzvj$art_i = 0, $art_czblvmkyto$art_c = list.length; $art_ifjbnhzvj$art_i < $art_czblvmkyto$art_c; $art_ifjbnhzvj$art_i++) {    var item = list[$art_ifjbnhzvj$art_i]%>';
    for (var $art_ifjbnhzvj$art_i = 0, $art_czblvmkyto$art_c = list.length; $art_ifjbnhzvj$art_i < $art_czblvmkyto$art_c; $art_ifjbnhzvj$art_i++) {
        var item = list[$art_ifjbnhzvj$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
