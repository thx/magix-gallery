...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iylygmpj$art_i = 0, $art_cdipiejws$art_c = list.length; $art_iylygmpj$art_i < $art_cdipiejws$art_c; $art_iylygmpj$art_i++) {    var item = list[$art_iylygmpj$art_i]%>';
    for (var $art_iylygmpj$art_i = 0, $art_cdipiejws$art_c = list.length; $art_iylygmpj$art_i < $art_cdipiejws$art_c; $art_iylygmpj$art_i++) {
        var item = list[$art_iylygmpj$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
