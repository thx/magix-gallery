...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikvufij$art_i = 0, $art_ctrfyfd$art_c = list.length; $art_ikvufij$art_i < $art_ctrfyfd$art_c; $art_ikvufij$art_i++) {    var item = list[$art_ikvufij$art_i]%>';
    for (var $art_ikvufij$art_i = 0, $art_ctrfyfd$art_c = list.length; $art_ikvufij$art_i < $art_ctrfyfd$art_c; $art_ikvufij$art_i++) {
        var item = list[$art_ikvufij$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
