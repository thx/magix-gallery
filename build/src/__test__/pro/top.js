...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itiymzbqdcwa$art_i = 0, $art_cssjzpt$art_c = list.length; $art_itiymzbqdcwa$art_i < $art_cssjzpt$art_c; $art_itiymzbqdcwa$art_i++) {    var item = list[$art_itiymzbqdcwa$art_i]%>';
    for (var $art_itiymzbqdcwa$art_i = 0, $art_cssjzpt$art_c = list.length; $art_itiymzbqdcwa$art_i < $art_cssjzpt$art_c; $art_itiymzbqdcwa$art_i++) {
        var item = list[$art_itiymzbqdcwa$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
