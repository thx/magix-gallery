...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihdtfiald$art_i = 0, $art_citzqxkce$art_c = list.length; $art_ihdtfiald$art_i < $art_citzqxkce$art_c; $art_ihdtfiald$art_i++) {    var item = list[$art_ihdtfiald$art_i]%>';
    for (var $art_ihdtfiald$art_i = 0, $art_citzqxkce$art_c = list.length; $art_ihdtfiald$art_i < $art_citzqxkce$art_c; $art_ihdtfiald$art_i++) {
        var item = list[$art_ihdtfiald$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
