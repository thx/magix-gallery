...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixasdzmtz$art_i = 0, $art_ckufezt$art_c = list.length; $art_ixasdzmtz$art_i < $art_ckufezt$art_c; $art_ixasdzmtz$art_i++) {    var item = list[$art_ixasdzmtz$art_i]%>';
    for (var $art_ixasdzmtz$art_i = 0, $art_ckufezt$art_c = list.length; $art_ixasdzmtz$art_i < $art_ckufezt$art_c; $art_ixasdzmtz$art_i++) {
        var item = list[$art_ixasdzmtz$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
