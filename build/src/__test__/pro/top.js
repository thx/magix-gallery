...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyobpoos$art_i = 0, $art_cgbgirvx$art_c = list.length; $art_iyobpoos$art_i < $art_cgbgirvx$art_c; $art_iyobpoos$art_i++) {    var item = list[$art_iyobpoos$art_i]%>';
    for (var $art_iyobpoos$art_i = 0, $art_cgbgirvx$art_c = list.length; $art_iyobpoos$art_i < $art_cgbgirvx$art_c; $art_iyobpoos$art_i++) {
        var item = list[$art_iyobpoos$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
