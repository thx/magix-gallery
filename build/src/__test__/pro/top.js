...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igfkpcxjy$art_i = 0, $art_cmbcmsam$art_c = list.length; $art_igfkpcxjy$art_i < $art_cmbcmsam$art_c; $art_igfkpcxjy$art_i++) {    var item = list[$art_igfkpcxjy$art_i]%>';
    for (var $art_igfkpcxjy$art_i = 0, $art_cmbcmsam$art_c = list.length; $art_igfkpcxjy$art_i < $art_cmbcmsam$art_c; $art_igfkpcxjy$art_i++) {
        var item = list[$art_igfkpcxjy$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
