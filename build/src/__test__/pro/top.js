...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijpqakiwxr$art_i = 0, $art_cxtqupjnioj$art_c = list.length; $art_ijpqakiwxr$art_i < $art_cxtqupjnioj$art_c; $art_ijpqakiwxr$art_i++) {    var item = list[$art_ijpqakiwxr$art_i]%>';
    for (var $art_ijpqakiwxr$art_i = 0, $art_cxtqupjnioj$art_c = list.length; $art_ijpqakiwxr$art_i < $art_cxtqupjnioj$art_c; $art_ijpqakiwxr$art_i++) {
        var item = list[$art_ijpqakiwxr$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
