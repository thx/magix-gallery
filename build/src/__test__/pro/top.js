...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieuxhcaxu$art_i = 0, $art_czdkzu$art_c = list.length; $art_ieuxhcaxu$art_i < $art_czdkzu$art_c; $art_ieuxhcaxu$art_i++) {    var item = list[$art_ieuxhcaxu$art_i]%>';
    for (var $art_ieuxhcaxu$art_i = 0, $art_czdkzu$art_c = list.length; $art_ieuxhcaxu$art_i < $art_czdkzu$art_c; $art_ieuxhcaxu$art_i++) {
        var item = list[$art_ieuxhcaxu$art_i];
        $p += '<tr><td>';
        $line = 24;
        $art = '=item.name';
        ;
