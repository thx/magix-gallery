...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihglqjze$art_i = 0, $art_cymkbnc$art_c = list.length; $art_ihglqjze$art_i < $art_cymkbnc$art_c; $art_ihglqjze$art_i++) {    var item = list[$art_ihglqjze$art_i]%>';
    for (var $art_ihglqjze$art_i = 0, $art_cymkbnc$art_c = list.length; $art_ihglqjze$art_i < $art_cymkbnc$art_c; $art_ihglqjze$art_i++) {
        var item = list[$art_ihglqjze$art_i];
        $p += '<tr><td>';
        $line = 23;
        $art = '=item.name';
        ;
