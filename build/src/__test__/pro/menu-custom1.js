...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryu:_" class="_zs_gallery___test___pro_menu_-menu mr20"><div mxs="_zs_galleryu:_" class="_zs_gallery___test___pro_menu_-header clearfix"><div class="_zs_gallery___test___pro_menu_-logo">LOGO</div><div class="_zs_gallery___test___pro_menu_-name">一级标题</div></div><div mxa="_zs_galleryu:a" class="clearfix pr"><div mxs="_zs_galleryu:a" class="_zs_gallery___test___pro_menu_-navs"><div><a href="javascript:;" class="_zs_gallery___test___pro_menu_-nav-third _zs_gallery___test___pro_menu_-third-on">三级1</a></div><div><a href="javascript:;" class="_zs_gallery___test___pro_menu_-nav-third">三级2</a></div><div><a href="javascript:;" class="_zs_gallery___test___pro_menu_-nav-third">三级3</a></div></div><div mxa="_zs_galleryu:b" class="_zs_gallery___test___pro_menu_-inner"><div mxs="_zs_galleryu:b" class="mb20">以下四种情况均为自定义页面，入口在导航上不可见，点击可查看配置：</div><div mxa="_zs_galleryu:c" class="mb20">1. 映射到三级1这个页面，顶部和侧边导航显示与三级1完全一致<a class="link-brand ml10" href="javascript:;" mx-click="' + $viewId + 'to({id:\'';
    $line = 20;
    $art = '=parentId';
    ;
