...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itrfhhb$art_i = 0, $art_cnmagyihjjr$art_c = list.length; $art_itrfhhb$art_i < $art_cnmagyihjjr$art_c; $art_itrfhhb$art_i++) {    var item = list[$art_itrfhhb$art_i]%>';
    for (var $art_itrfhhb$art_i = 0, $art_cnmagyihjjr$art_c = list.length; $art_itrfhhb$art_i < $art_cnmagyihjjr$art_c; $art_itrfhhb$art_i++) {
        var item = list[$art_itrfhhb$art_i];
        ...
        ;
        $expr = '<%for (var $art_iyqipdn$art_i = 0, $art_objsyulrny$art_obj = item.subs, $art_csvukxvuim$art_c = $art_objsyulrny$art_obj.length; $art_iyqipdn$art_i < $art_csvukxvuim$art_c; $art_iyqipdn$art_i++) {        var s = $art_objsyulrny$art_obj[$art_iyqipdn$art_i]%>';
        for (var $art_iyqipdn$art_i = 0, $art_objsyulrny$art_obj = item.subs, $art_csvukxvuim$art_c = $art_objsyulrny$art_obj.length; $art_iyqipdn$art_i < $art_csvukxvuim$art_c; $art_iyqipdn$art_i++) {
            var s = $art_objsyulrny$art_obj[$art_iyqipdn$art_i];
            ...
            ;
            $expr = '<%for (var $art_iaeosy$art_i = 0, $art_objnzuglnef$art_obj = s.subs, $art_czphxcdfu$art_c = $art_objnzuglnef$art_obj.length; $art_iaeosy$art_i < $art_czphxcdfu$art_c; $art_iaeosy$art_i++) {            var ss = $art_objnzuglnef$art_obj[$art_iaeosy$art_i]%>';
            for (var $art_iaeosy$art_i = 0, $art_objnzuglnef$art_obj = s.subs, $art_czphxcdfu$art_c = $art_objnzuglnef$art_obj.length; $art_iaeosy$art_i < $art_czphxcdfu$art_c; $art_iaeosy$art_i++) {
                var ss = $art_objnzuglnef$art_obj[$art_iaeosy$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ijkaeroq$art_i = 0, $art_objukwgdccek$art_obj = ss.subs, $art_cmlzpips$art_c = $art_objukwgdccek$art_obj.length; $art_ijkaeroq$art_i < $art_cmlzpips$art_c; $art_ijkaeroq$art_i++) {                    var sss = $art_objukwgdccek$art_obj[$art_ijkaeroq$art_i]%>';
                    for (var $art_ijkaeroq$art_i = 0, $art_objukwgdccek$art_obj = ss.subs, $art_cmlzpips$art_c = $art_objukwgdccek$art_obj.length; $art_ijkaeroq$art_i < $art_cmlzpips$art_c; $art_ijkaeroq$art_i++) {
                        var sss = $art_objukwgdccek$art_obj[$art_ijkaeroq$art_i];
