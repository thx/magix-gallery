...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilbrluj$art_i = 0, $art_crdfigfxji$art_c = list.length; $art_ilbrluj$art_i < $art_crdfigfxji$art_c; $art_ilbrluj$art_i++) {    var item = list[$art_ilbrluj$art_i]%>';
    for (var $art_ilbrluj$art_i = 0, $art_crdfigfxji$art_c = list.length; $art_ilbrluj$art_i < $art_crdfigfxji$art_c; $art_ilbrluj$art_i++) {
        var item = list[$art_ilbrluj$art_i];
        ...
        ;
        $expr = '<%for (var $art_iuhozwow$art_i = 0, $art_objpdsopsu$art_obj = item.subs, $art_ckwzopiodhs$art_c = $art_objpdsopsu$art_obj.length; $art_iuhozwow$art_i < $art_ckwzopiodhs$art_c; $art_iuhozwow$art_i++) {        var s = $art_objpdsopsu$art_obj[$art_iuhozwow$art_i]%>';
        for (var $art_iuhozwow$art_i = 0, $art_objpdsopsu$art_obj = item.subs, $art_ckwzopiodhs$art_c = $art_objpdsopsu$art_obj.length; $art_iuhozwow$art_i < $art_ckwzopiodhs$art_c; $art_iuhozwow$art_i++) {
            var s = $art_objpdsopsu$art_obj[$art_iuhozwow$art_i];
            ...
            ;
            $expr = '<%for (var $art_ikqxsodkjem$art_i = 0, $art_objteenwfwd$art_obj = s.subs, $art_cherzdhqba$art_c = $art_objteenwfwd$art_obj.length; $art_ikqxsodkjem$art_i < $art_cherzdhqba$art_c; $art_ikqxsodkjem$art_i++) {            var ss = $art_objteenwfwd$art_obj[$art_ikqxsodkjem$art_i]%>';
            for (var $art_ikqxsodkjem$art_i = 0, $art_objteenwfwd$art_obj = s.subs, $art_cherzdhqba$art_c = $art_objteenwfwd$art_obj.length; $art_ikqxsodkjem$art_i < $art_cherzdhqba$art_c; $art_ikqxsodkjem$art_i++) {
                var ss = $art_objteenwfwd$art_obj[$art_ikqxsodkjem$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ikyqqcadp$art_i = 0, $art_objnnpurjk$art_obj = ss.subs, $art_cdnuhtxdgr$art_c = $art_objnnpurjk$art_obj.length; $art_ikyqqcadp$art_i < $art_cdnuhtxdgr$art_c; $art_ikyqqcadp$art_i++) {                    var sss = $art_objnnpurjk$art_obj[$art_ikyqqcadp$art_i]%>';
                    for (var $art_ikyqqcadp$art_i = 0, $art_objnnpurjk$art_obj = ss.subs, $art_cdnuhtxdgr$art_c = $art_objnnpurjk$art_obj.length; $art_ikyqqcadp$art_i < $art_cdnuhtxdgr$art_c; $art_ikyqqcadp$art_i++) {
                        var sss = $art_objnnpurjk$art_obj[$art_ikyqqcadp$art_i];
