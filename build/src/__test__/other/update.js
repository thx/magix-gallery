...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igwlqyownyh$art_i = 0, $art_cxljtxant$art_c = list.length; $art_igwlqyownyh$art_i < $art_cxljtxant$art_c; $art_igwlqyownyh$art_i++) {    var item = list[$art_igwlqyownyh$art_i]%>';
    for (var $art_igwlqyownyh$art_i = 0, $art_cxljtxant$art_c = list.length; $art_igwlqyownyh$art_i < $art_cxljtxant$art_c; $art_igwlqyownyh$art_i++) {
        var item = list[$art_igwlqyownyh$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixlttlsmx$art_i = 0, $art_objvujdrtxzs$art_obj = item.subs, $art_cmhxskwz$art_c = $art_objvujdrtxzs$art_obj.length; $art_ixlttlsmx$art_i < $art_cmhxskwz$art_c; $art_ixlttlsmx$art_i++) {        var s = $art_objvujdrtxzs$art_obj[$art_ixlttlsmx$art_i]%>';
        for (var $art_ixlttlsmx$art_i = 0, $art_objvujdrtxzs$art_obj = item.subs, $art_cmhxskwz$art_c = $art_objvujdrtxzs$art_obj.length; $art_ixlttlsmx$art_i < $art_cmhxskwz$art_c; $art_ixlttlsmx$art_i++) {
            var s = $art_objvujdrtxzs$art_obj[$art_ixlttlsmx$art_i];
            ...
            ;
            $expr = '<%for (var $art_ijzcdqvarr$art_i = 0, $art_objlfrkttzir$art_obj = s.subs, $art_cofbmayl$art_c = $art_objlfrkttzir$art_obj.length; $art_ijzcdqvarr$art_i < $art_cofbmayl$art_c; $art_ijzcdqvarr$art_i++) {            var ss = $art_objlfrkttzir$art_obj[$art_ijzcdqvarr$art_i]%>';
            for (var $art_ijzcdqvarr$art_i = 0, $art_objlfrkttzir$art_obj = s.subs, $art_cofbmayl$art_c = $art_objlfrkttzir$art_obj.length; $art_ijzcdqvarr$art_i < $art_cofbmayl$art_c; $art_ijzcdqvarr$art_i++) {
                var ss = $art_objlfrkttzir$art_obj[$art_ijzcdqvarr$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ifqlyyfh$art_i = 0, $art_objmsvhygb$art_obj = ss.subs, $art_cjmjsbrro$art_c = $art_objmsvhygb$art_obj.length; $art_ifqlyyfh$art_i < $art_cjmjsbrro$art_c; $art_ifqlyyfh$art_i++) {                    var sss = $art_objmsvhygb$art_obj[$art_ifqlyyfh$art_i]%>';
                    for (var $art_ifqlyyfh$art_i = 0, $art_objmsvhygb$art_obj = ss.subs, $art_cjmjsbrro$art_c = $art_objmsvhygb$art_obj.length; $art_ifqlyyfh$art_i < $art_cjmjsbrro$art_c; $art_ifqlyyfh$art_i++) {
                        var sss = $art_objmsvhygb$art_obj[$art_ifqlyyfh$art_i];
