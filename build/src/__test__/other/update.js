...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipildlnqmpb$art_i = 0, $art_cdamisvnl$art_c = list.length; $art_ipildlnqmpb$art_i < $art_cdamisvnl$art_c; $art_ipildlnqmpb$art_i++) {    var item = list[$art_ipildlnqmpb$art_i]%>';
    for (var $art_ipildlnqmpb$art_i = 0, $art_cdamisvnl$art_c = list.length; $art_ipildlnqmpb$art_i < $art_cdamisvnl$art_c; $art_ipildlnqmpb$art_i++) {
        var item = list[$art_ipildlnqmpb$art_i];
        ...
        ;
        $expr = '<%for (var $art_iiwkwjycld$art_i = 0, $art_objuabqdjp$art_obj = item.subs, $art_cijseck$art_c = $art_objuabqdjp$art_obj.length; $art_iiwkwjycld$art_i < $art_cijseck$art_c; $art_iiwkwjycld$art_i++) {        var s = $art_objuabqdjp$art_obj[$art_iiwkwjycld$art_i]%>';
        for (var $art_iiwkwjycld$art_i = 0, $art_objuabqdjp$art_obj = item.subs, $art_cijseck$art_c = $art_objuabqdjp$art_obj.length; $art_iiwkwjycld$art_i < $art_cijseck$art_c; $art_iiwkwjycld$art_i++) {
            var s = $art_objuabqdjp$art_obj[$art_iiwkwjycld$art_i];
            ...
            ;
            $expr = '<%for (var $art_inbsxzeav$art_i = 0, $art_objknmphzxvmr$art_obj = s.subs, $art_ckhdwkj$art_c = $art_objknmphzxvmr$art_obj.length; $art_inbsxzeav$art_i < $art_ckhdwkj$art_c; $art_inbsxzeav$art_i++) {            var ss = $art_objknmphzxvmr$art_obj[$art_inbsxzeav$art_i]%>';
            for (var $art_inbsxzeav$art_i = 0, $art_objknmphzxvmr$art_obj = s.subs, $art_ckhdwkj$art_c = $art_objknmphzxvmr$art_obj.length; $art_inbsxzeav$art_i < $art_ckhdwkj$art_c; $art_inbsxzeav$art_i++) {
                var ss = $art_objknmphzxvmr$art_obj[$art_inbsxzeav$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iwqvblkq$art_i = 0, $art_objreosjko$art_obj = ss.subs, $art_clhqmqef$art_c = $art_objreosjko$art_obj.length; $art_iwqvblkq$art_i < $art_clhqmqef$art_c; $art_iwqvblkq$art_i++) {                    var sss = $art_objreosjko$art_obj[$art_iwqvblkq$art_i]%>';
                    for (var $art_iwqvblkq$art_i = 0, $art_objreosjko$art_obj = ss.subs, $art_clhqmqef$art_c = $art_objreosjko$art_obj.length; $art_iwqvblkq$art_i < $art_clhqmqef$art_c; $art_iwqvblkq$art_i++) {
                        var sss = $art_objreosjko$art_obj[$art_iwqvblkq$art_i];
