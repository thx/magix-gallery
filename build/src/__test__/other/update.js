...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqspdkzfjs$art_i = 0, $art_czbuzxwk$art_c = list.length; $art_iqspdkzfjs$art_i < $art_czbuzxwk$art_c; $art_iqspdkzfjs$art_i++) {    var item = list[$art_iqspdkzfjs$art_i]%>';
    for (var $art_iqspdkzfjs$art_i = 0, $art_czbuzxwk$art_c = list.length; $art_iqspdkzfjs$art_i < $art_czbuzxwk$art_c; $art_iqspdkzfjs$art_i++) {
        var item = list[$art_iqspdkzfjs$art_i];
        ...
        ;
        $expr = '<%for (var $art_ikwhbddiosr$art_i = 0, $art_objvllpn$art_obj = item.subs, $art_cbeksbees$art_c = $art_objvllpn$art_obj.length; $art_ikwhbddiosr$art_i < $art_cbeksbees$art_c; $art_ikwhbddiosr$art_i++) {        var s = $art_objvllpn$art_obj[$art_ikwhbddiosr$art_i]%>';
        for (var $art_ikwhbddiosr$art_i = 0, $art_objvllpn$art_obj = item.subs, $art_cbeksbees$art_c = $art_objvllpn$art_obj.length; $art_ikwhbddiosr$art_i < $art_cbeksbees$art_c; $art_ikwhbddiosr$art_i++) {
            var s = $art_objvllpn$art_obj[$art_ikwhbddiosr$art_i];
            ...
            ;
            $expr = '<%for (var $art_iaabkllpj$art_i = 0, $art_objzoptfemdp$art_obj = s.subs, $art_czffyhqmnxx$art_c = $art_objzoptfemdp$art_obj.length; $art_iaabkllpj$art_i < $art_czffyhqmnxx$art_c; $art_iaabkllpj$art_i++) {            var ss = $art_objzoptfemdp$art_obj[$art_iaabkllpj$art_i]%>';
            for (var $art_iaabkllpj$art_i = 0, $art_objzoptfemdp$art_obj = s.subs, $art_czffyhqmnxx$art_c = $art_objzoptfemdp$art_obj.length; $art_iaabkllpj$art_i < $art_czffyhqmnxx$art_c; $art_iaabkllpj$art_i++) {
                var ss = $art_objzoptfemdp$art_obj[$art_iaabkllpj$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_itwbzspm$art_i = 0, $art_objjdbdir$art_obj = ss.subs, $art_coxystlf$art_c = $art_objjdbdir$art_obj.length; $art_itwbzspm$art_i < $art_coxystlf$art_c; $art_itwbzspm$art_i++) {                    var sss = $art_objjdbdir$art_obj[$art_itwbzspm$art_i]%>';
                    for (var $art_itwbzspm$art_i = 0, $art_objjdbdir$art_obj = ss.subs, $art_coxystlf$art_c = $art_objjdbdir$art_obj.length; $art_itwbzspm$art_i < $art_coxystlf$art_c; $art_itwbzspm$art_i++) {
                        var sss = $art_objjdbdir$art_obj[$art_itwbzspm$art_i];
