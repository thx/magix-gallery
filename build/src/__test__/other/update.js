...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivwastawq$art_i = 0, $art_cwnflygawv$art_c = list.length; $art_ivwastawq$art_i < $art_cwnflygawv$art_c; $art_ivwastawq$art_i++) {    var item = list[$art_ivwastawq$art_i]%>';
    for (var $art_ivwastawq$art_i = 0, $art_cwnflygawv$art_c = list.length; $art_ivwastawq$art_i < $art_cwnflygawv$art_c; $art_ivwastawq$art_i++) {
        var item = list[$art_ivwastawq$art_i];
        ...
        ;
        $expr = '<%for (var $art_iepfmsnyi$art_i = 0, $art_objilwcxzqjmn$art_obj = item.subs, $art_cinxyak$art_c = $art_objilwcxzqjmn$art_obj.length; $art_iepfmsnyi$art_i < $art_cinxyak$art_c; $art_iepfmsnyi$art_i++) {        var s = $art_objilwcxzqjmn$art_obj[$art_iepfmsnyi$art_i]%>';
        for (var $art_iepfmsnyi$art_i = 0, $art_objilwcxzqjmn$art_obj = item.subs, $art_cinxyak$art_c = $art_objilwcxzqjmn$art_obj.length; $art_iepfmsnyi$art_i < $art_cinxyak$art_c; $art_iepfmsnyi$art_i++) {
            var s = $art_objilwcxzqjmn$art_obj[$art_iepfmsnyi$art_i];
            ...
            ;
            $expr = '<%for (var $art_ijudgsaa$art_i = 0, $art_objrajlmejq$art_obj = s.subs, $art_cflhdnvrn$art_c = $art_objrajlmejq$art_obj.length; $art_ijudgsaa$art_i < $art_cflhdnvrn$art_c; $art_ijudgsaa$art_i++) {            var ss = $art_objrajlmejq$art_obj[$art_ijudgsaa$art_i]%>';
            for (var $art_ijudgsaa$art_i = 0, $art_objrajlmejq$art_obj = s.subs, $art_cflhdnvrn$art_c = $art_objrajlmejq$art_obj.length; $art_ijudgsaa$art_i < $art_cflhdnvrn$art_c; $art_ijudgsaa$art_i++) {
                var ss = $art_objrajlmejq$art_obj[$art_ijudgsaa$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_icubfnuisdn$art_i = 0, $art_objpzzvmqrfej$art_obj = ss.subs, $art_cdgvqhehn$art_c = $art_objpzzvmqrfej$art_obj.length; $art_icubfnuisdn$art_i < $art_cdgvqhehn$art_c; $art_icubfnuisdn$art_i++) {                    var sss = $art_objpzzvmqrfej$art_obj[$art_icubfnuisdn$art_i]%>';
                    for (var $art_icubfnuisdn$art_i = 0, $art_objpzzvmqrfej$art_obj = ss.subs, $art_cdgvqhehn$art_c = $art_objpzzvmqrfej$art_obj.length; $art_icubfnuisdn$art_i < $art_cdgvqhehn$art_c; $art_icubfnuisdn$art_i++) {
                        var sss = $art_objpzzvmqrfej$art_obj[$art_icubfnuisdn$art_i];
