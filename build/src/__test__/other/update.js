...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irrxenp$art_i = 0, $art_ceybbapxb$art_c = list.length; $art_irrxenp$art_i < $art_ceybbapxb$art_c; $art_irrxenp$art_i++) {    var item = list[$art_irrxenp$art_i]%>';
    for (var $art_irrxenp$art_i = 0, $art_ceybbapxb$art_c = list.length; $art_irrxenp$art_i < $art_ceybbapxb$art_c; $art_irrxenp$art_i++) {
        var item = list[$art_irrxenp$art_i];
        ...
        ;
        $expr = '<%for (var $art_ivvjhbfqne$art_i = 0, $art_objogsvwsmm$art_obj = item.subs, $art_ckomwcayd$art_c = $art_objogsvwsmm$art_obj.length; $art_ivvjhbfqne$art_i < $art_ckomwcayd$art_c; $art_ivvjhbfqne$art_i++) {        var s = $art_objogsvwsmm$art_obj[$art_ivvjhbfqne$art_i]%>';
        for (var $art_ivvjhbfqne$art_i = 0, $art_objogsvwsmm$art_obj = item.subs, $art_ckomwcayd$art_c = $art_objogsvwsmm$art_obj.length; $art_ivvjhbfqne$art_i < $art_ckomwcayd$art_c; $art_ivvjhbfqne$art_i++) {
            var s = $art_objogsvwsmm$art_obj[$art_ivvjhbfqne$art_i];
            ...
            ;
            $expr = '<%for (var $art_iymewm$art_i = 0, $art_objpregvogfb$art_obj = s.subs, $art_cqpiixnyya$art_c = $art_objpregvogfb$art_obj.length; $art_iymewm$art_i < $art_cqpiixnyya$art_c; $art_iymewm$art_i++) {            var ss = $art_objpregvogfb$art_obj[$art_iymewm$art_i]%>';
            for (var $art_iymewm$art_i = 0, $art_objpregvogfb$art_obj = s.subs, $art_cqpiixnyya$art_c = $art_objpregvogfb$art_obj.length; $art_iymewm$art_i < $art_cqpiixnyya$art_c; $art_iymewm$art_i++) {
                var ss = $art_objpregvogfb$art_obj[$art_iymewm$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iellzbxt$art_i = 0, $art_objluwkvtnn$art_obj = ss.subs, $art_cndzdrpiq$art_c = $art_objluwkvtnn$art_obj.length; $art_iellzbxt$art_i < $art_cndzdrpiq$art_c; $art_iellzbxt$art_i++) {                    var sss = $art_objluwkvtnn$art_obj[$art_iellzbxt$art_i]%>';
                    for (var $art_iellzbxt$art_i = 0, $art_objluwkvtnn$art_obj = ss.subs, $art_cndzdrpiq$art_c = $art_objluwkvtnn$art_obj.length; $art_iellzbxt$art_i < $art_cndzdrpiq$art_c; $art_iellzbxt$art_i++) {
                        var sss = $art_objluwkvtnn$art_obj[$art_iellzbxt$art_i];
