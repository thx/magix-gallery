...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyhuwnxia$art_i = 0, $art_cxvlxgnsp$art_c = list.length; $art_iyhuwnxia$art_i < $art_cxvlxgnsp$art_c; $art_iyhuwnxia$art_i++) {    var item = list[$art_iyhuwnxia$art_i]%>';
    for (var $art_iyhuwnxia$art_i = 0, $art_cxvlxgnsp$art_c = list.length; $art_iyhuwnxia$art_i < $art_cxvlxgnsp$art_c; $art_iyhuwnxia$art_i++) {
        var item = list[$art_iyhuwnxia$art_i];
        ...
        ;
        $expr = '<%for (var $art_ikiyhcnq$art_i = 0, $art_objjnqfuxysr$art_obj = item.subs, $art_cxcjnl$art_c = $art_objjnqfuxysr$art_obj.length; $art_ikiyhcnq$art_i < $art_cxcjnl$art_c; $art_ikiyhcnq$art_i++) {        var s = $art_objjnqfuxysr$art_obj[$art_ikiyhcnq$art_i]%>';
        for (var $art_ikiyhcnq$art_i = 0, $art_objjnqfuxysr$art_obj = item.subs, $art_cxcjnl$art_c = $art_objjnqfuxysr$art_obj.length; $art_ikiyhcnq$art_i < $art_cxcjnl$art_c; $art_ikiyhcnq$art_i++) {
            var s = $art_objjnqfuxysr$art_obj[$art_ikiyhcnq$art_i];
            ...
            ;
            $expr = '<%for (var $art_iqqfzbqst$art_i = 0, $art_objfnvubv$art_obj = s.subs, $art_ckgvgdiy$art_c = $art_objfnvubv$art_obj.length; $art_iqqfzbqst$art_i < $art_ckgvgdiy$art_c; $art_iqqfzbqst$art_i++) {            var ss = $art_objfnvubv$art_obj[$art_iqqfzbqst$art_i]%>';
            for (var $art_iqqfzbqst$art_i = 0, $art_objfnvubv$art_obj = s.subs, $art_ckgvgdiy$art_c = $art_objfnvubv$art_obj.length; $art_iqqfzbqst$art_i < $art_ckgvgdiy$art_c; $art_iqqfzbqst$art_i++) {
                var ss = $art_objfnvubv$art_obj[$art_iqqfzbqst$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ikwyocge$art_i = 0, $art_objwbncswdxe$art_obj = ss.subs, $art_cusmrokhg$art_c = $art_objwbncswdxe$art_obj.length; $art_ikwyocge$art_i < $art_cusmrokhg$art_c; $art_ikwyocge$art_i++) {                    var sss = $art_objwbncswdxe$art_obj[$art_ikwyocge$art_i]%>';
                    for (var $art_ikwyocge$art_i = 0, $art_objwbncswdxe$art_obj = ss.subs, $art_cusmrokhg$art_c = $art_objwbncswdxe$art_obj.length; $art_ikwyocge$art_i < $art_cusmrokhg$art_c; $art_ikwyocge$art_i++) {
                        var sss = $art_objwbncswdxe$art_obj[$art_ikwyocge$art_i];
