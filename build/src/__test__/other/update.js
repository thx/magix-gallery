...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivzzcrzz$art_i = 0, $art_cstdaze$art_c = list.length; $art_ivzzcrzz$art_i < $art_cstdaze$art_c; $art_ivzzcrzz$art_i++) {    var item = list[$art_ivzzcrzz$art_i]%>';
    for (var $art_ivzzcrzz$art_i = 0, $art_cstdaze$art_c = list.length; $art_ivzzcrzz$art_i < $art_cstdaze$art_c; $art_ivzzcrzz$art_i++) {
        var item = list[$art_ivzzcrzz$art_i];
        ...
        ;
        $expr = '<%for (var $art_ienxqwgv$art_i = 0, $art_objlqnihqqrg$art_obj = item.subs, $art_ctuvanwui$art_c = $art_objlqnihqqrg$art_obj.length; $art_ienxqwgv$art_i < $art_ctuvanwui$art_c; $art_ienxqwgv$art_i++) {        var s = $art_objlqnihqqrg$art_obj[$art_ienxqwgv$art_i]%>';
        for (var $art_ienxqwgv$art_i = 0, $art_objlqnihqqrg$art_obj = item.subs, $art_ctuvanwui$art_c = $art_objlqnihqqrg$art_obj.length; $art_ienxqwgv$art_i < $art_ctuvanwui$art_c; $art_ienxqwgv$art_i++) {
            var s = $art_objlqnihqqrg$art_obj[$art_ienxqwgv$art_i];
            ...
            ;
            $expr = '<%for (var $art_ibddtdapepl$art_i = 0, $art_objjfealfxuk$art_obj = s.subs, $art_cldztupnf$art_c = $art_objjfealfxuk$art_obj.length; $art_ibddtdapepl$art_i < $art_cldztupnf$art_c; $art_ibddtdapepl$art_i++) {            var ss = $art_objjfealfxuk$art_obj[$art_ibddtdapepl$art_i]%>';
            for (var $art_ibddtdapepl$art_i = 0, $art_objjfealfxuk$art_obj = s.subs, $art_cldztupnf$art_c = $art_objjfealfxuk$art_obj.length; $art_ibddtdapepl$art_i < $art_cldztupnf$art_c; $art_ibddtdapepl$art_i++) {
                var ss = $art_objjfealfxuk$art_obj[$art_ibddtdapepl$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iqvykvctqgrk$art_i = 0, $art_objmmswcqztnjs$art_obj = ss.subs, $art_cvuhjysniur$art_c = $art_objmmswcqztnjs$art_obj.length; $art_iqvykvctqgrk$art_i < $art_cvuhjysniur$art_c; $art_iqvykvctqgrk$art_i++) {                    var sss = $art_objmmswcqztnjs$art_obj[$art_iqvykvctqgrk$art_i]%>';
                    for (var $art_iqvykvctqgrk$art_i = 0, $art_objmmswcqztnjs$art_obj = ss.subs, $art_cvuhjysniur$art_c = $art_objmmswcqztnjs$art_obj.length; $art_iqvykvctqgrk$art_i < $art_cvuhjysniur$art_c; $art_iqvykvctqgrk$art_i++) {
                        var sss = $art_objmmswcqztnjs$art_obj[$art_iqvykvctqgrk$art_i];
