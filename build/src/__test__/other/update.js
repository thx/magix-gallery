...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivmpstyl$art_i = 0, $art_crsguibifj$art_c = list.length; $art_ivmpstyl$art_i < $art_crsguibifj$art_c; $art_ivmpstyl$art_i++) {    var item = list[$art_ivmpstyl$art_i]%>';
    for (var $art_ivmpstyl$art_i = 0, $art_crsguibifj$art_c = list.length; $art_ivmpstyl$art_i < $art_crsguibifj$art_c; $art_ivmpstyl$art_i++) {
        var item = list[$art_ivmpstyl$art_i];
        ...
        ;
        $expr = '<%for (var $art_iuhhbofhi$art_i = 0, $art_objqqqaeje$art_obj = item.subs, $art_cnameyahmho$art_c = $art_objqqqaeje$art_obj.length; $art_iuhhbofhi$art_i < $art_cnameyahmho$art_c; $art_iuhhbofhi$art_i++) {        var s = $art_objqqqaeje$art_obj[$art_iuhhbofhi$art_i]%>';
        for (var $art_iuhhbofhi$art_i = 0, $art_objqqqaeje$art_obj = item.subs, $art_cnameyahmho$art_c = $art_objqqqaeje$art_obj.length; $art_iuhhbofhi$art_i < $art_cnameyahmho$art_c; $art_iuhhbofhi$art_i++) {
            var s = $art_objqqqaeje$art_obj[$art_iuhhbofhi$art_i];
            ...
            ;
            $expr = '<%for (var $art_inznellxxe$art_i = 0, $art_objbtrdqj$art_obj = s.subs, $art_cqhggbftn$art_c = $art_objbtrdqj$art_obj.length; $art_inznellxxe$art_i < $art_cqhggbftn$art_c; $art_inznellxxe$art_i++) {            var ss = $art_objbtrdqj$art_obj[$art_inznellxxe$art_i]%>';
            for (var $art_inznellxxe$art_i = 0, $art_objbtrdqj$art_obj = s.subs, $art_cqhggbftn$art_c = $art_objbtrdqj$art_obj.length; $art_inznellxxe$art_i < $art_cqhggbftn$art_c; $art_inznellxxe$art_i++) {
                var ss = $art_objbtrdqj$art_obj[$art_inznellxxe$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iatdiaqgkw$art_i = 0, $art_objhxcapdnd$art_obj = ss.subs, $art_clizlrlti$art_c = $art_objhxcapdnd$art_obj.length; $art_iatdiaqgkw$art_i < $art_clizlrlti$art_c; $art_iatdiaqgkw$art_i++) {                    var sss = $art_objhxcapdnd$art_obj[$art_iatdiaqgkw$art_i]%>';
                    for (var $art_iatdiaqgkw$art_i = 0, $art_objhxcapdnd$art_obj = ss.subs, $art_clizlrlti$art_c = $art_objhxcapdnd$art_obj.length; $art_iatdiaqgkw$art_i < $art_clizlrlti$art_c; $art_iatdiaqgkw$art_i++) {
                        var sss = $art_objhxcapdnd$art_obj[$art_iatdiaqgkw$art_i];
