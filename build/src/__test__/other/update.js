...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivrsmhsphhe$art_i = 0, $art_cfmhprbl$art_c = list.length; $art_ivrsmhsphhe$art_i < $art_cfmhprbl$art_c; $art_ivrsmhsphhe$art_i++) {    var item = list[$art_ivrsmhsphhe$art_i]%>';
    for (var $art_ivrsmhsphhe$art_i = 0, $art_cfmhprbl$art_c = list.length; $art_ivrsmhsphhe$art_i < $art_cfmhprbl$art_c; $art_ivrsmhsphhe$art_i++) {
        var item = list[$art_ivrsmhsphhe$art_i];
        ...
        ;
        $expr = '<%for (var $art_irxhgkstcvy$art_i = 0, $art_objqxtgpjx$art_obj = item.subs, $art_chdksjyho$art_c = $art_objqxtgpjx$art_obj.length; $art_irxhgkstcvy$art_i < $art_chdksjyho$art_c; $art_irxhgkstcvy$art_i++) {        var s = $art_objqxtgpjx$art_obj[$art_irxhgkstcvy$art_i]%>';
        for (var $art_irxhgkstcvy$art_i = 0, $art_objqxtgpjx$art_obj = item.subs, $art_chdksjyho$art_c = $art_objqxtgpjx$art_obj.length; $art_irxhgkstcvy$art_i < $art_chdksjyho$art_c; $art_irxhgkstcvy$art_i++) {
            var s = $art_objqxtgpjx$art_obj[$art_irxhgkstcvy$art_i];
            ...
            ;
            $expr = '<%for (var $art_icwqntbxsa$art_i = 0, $art_objydbcto$art_obj = s.subs, $art_cnzcszvb$art_c = $art_objydbcto$art_obj.length; $art_icwqntbxsa$art_i < $art_cnzcszvb$art_c; $art_icwqntbxsa$art_i++) {            var ss = $art_objydbcto$art_obj[$art_icwqntbxsa$art_i]%>';
            for (var $art_icwqntbxsa$art_i = 0, $art_objydbcto$art_obj = s.subs, $art_cnzcszvb$art_c = $art_objydbcto$art_obj.length; $art_icwqntbxsa$art_i < $art_cnzcszvb$art_c; $art_icwqntbxsa$art_i++) {
                var ss = $art_objydbcto$art_obj[$art_icwqntbxsa$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_irauosv$art_i = 0, $art_objqtodcbhy$art_obj = ss.subs, $art_cusixrfg$art_c = $art_objqtodcbhy$art_obj.length; $art_irauosv$art_i < $art_cusixrfg$art_c; $art_irauosv$art_i++) {                    var sss = $art_objqtodcbhy$art_obj[$art_irauosv$art_i]%>';
                    for (var $art_irauosv$art_i = 0, $art_objqtodcbhy$art_obj = ss.subs, $art_cusixrfg$art_c = $art_objqtodcbhy$art_obj.length; $art_irauosv$art_i < $art_cusixrfg$art_c; $art_irauosv$art_i++) {
                        var sss = $art_objqtodcbhy$art_obj[$art_irauosv$art_i];
