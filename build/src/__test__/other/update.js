...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iebmewydkv$art_i = 0, $art_csysczgnze$art_c = list.length; $art_iebmewydkv$art_i < $art_csysczgnze$art_c; $art_iebmewydkv$art_i++) {    var item = list[$art_iebmewydkv$art_i]%>';
    for (var $art_iebmewydkv$art_i = 0, $art_csysczgnze$art_c = list.length; $art_iebmewydkv$art_i < $art_csysczgnze$art_c; $art_iebmewydkv$art_i++) {
        var item = list[$art_iebmewydkv$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijsoxi$art_i = 0, $art_objdvafbl$art_obj = item.subs, $art_cbykobkinl$art_c = $art_objdvafbl$art_obj.length; $art_ijsoxi$art_i < $art_cbykobkinl$art_c; $art_ijsoxi$art_i++) {        var s = $art_objdvafbl$art_obj[$art_ijsoxi$art_i]%>';
        for (var $art_ijsoxi$art_i = 0, $art_objdvafbl$art_obj = item.subs, $art_cbykobkinl$art_c = $art_objdvafbl$art_obj.length; $art_ijsoxi$art_i < $art_cbykobkinl$art_c; $art_ijsoxi$art_i++) {
            var s = $art_objdvafbl$art_obj[$art_ijsoxi$art_i];
            ...
            ;
            $expr = '<%for (var $art_iyjtkmbwq$art_i = 0, $art_objrandfugkj$art_obj = s.subs, $art_cjaazbrhtme$art_c = $art_objrandfugkj$art_obj.length; $art_iyjtkmbwq$art_i < $art_cjaazbrhtme$art_c; $art_iyjtkmbwq$art_i++) {            var ss = $art_objrandfugkj$art_obj[$art_iyjtkmbwq$art_i]%>';
            for (var $art_iyjtkmbwq$art_i = 0, $art_objrandfugkj$art_obj = s.subs, $art_cjaazbrhtme$art_c = $art_objrandfugkj$art_obj.length; $art_iyjtkmbwq$art_i < $art_cjaazbrhtme$art_c; $art_iyjtkmbwq$art_i++) {
                var ss = $art_objrandfugkj$art_obj[$art_iyjtkmbwq$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ibvthxgrwn$art_i = 0, $art_objxxpbopied$art_obj = ss.subs, $art_ctobkkfvhf$art_c = $art_objxxpbopied$art_obj.length; $art_ibvthxgrwn$art_i < $art_ctobkkfvhf$art_c; $art_ibvthxgrwn$art_i++) {                    var sss = $art_objxxpbopied$art_obj[$art_ibvthxgrwn$art_i]%>';
                    for (var $art_ibvthxgrwn$art_i = 0, $art_objxxpbopied$art_obj = ss.subs, $art_ctobkkfvhf$art_c = $art_objxxpbopied$art_obj.length; $art_ibvthxgrwn$art_i < $art_ctobkkfvhf$art_c; $art_ibvthxgrwn$art_i++) {
                        var sss = $art_objxxpbopied$art_obj[$art_ibvthxgrwn$art_i];
