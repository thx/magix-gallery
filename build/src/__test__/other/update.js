...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iudjkass$art_i = 0, $art_cvaunyghu$art_c = list.length; $art_iudjkass$art_i < $art_cvaunyghu$art_c; $art_iudjkass$art_i++) {    var item = list[$art_iudjkass$art_i]%>';
    for (var $art_iudjkass$art_i = 0, $art_cvaunyghu$art_c = list.length; $art_iudjkass$art_i < $art_cvaunyghu$art_c; $art_iudjkass$art_i++) {
        var item = list[$art_iudjkass$art_i];
        ...
        ;
        $expr = '<%for (var $art_ilksfimmf$art_i = 0, $art_objlejkwjj$art_obj = item.subs, $art_ciphlvxuu$art_c = $art_objlejkwjj$art_obj.length; $art_ilksfimmf$art_i < $art_ciphlvxuu$art_c; $art_ilksfimmf$art_i++) {        var s = $art_objlejkwjj$art_obj[$art_ilksfimmf$art_i]%>';
        for (var $art_ilksfimmf$art_i = 0, $art_objlejkwjj$art_obj = item.subs, $art_ciphlvxuu$art_c = $art_objlejkwjj$art_obj.length; $art_ilksfimmf$art_i < $art_ciphlvxuu$art_c; $art_ilksfimmf$art_i++) {
            var s = $art_objlejkwjj$art_obj[$art_ilksfimmf$art_i];
            ...
            ;
            $expr = '<%for (var $art_iwclncahc$art_i = 0, $art_objinnrnyucfa$art_obj = s.subs, $art_cwwihrzqc$art_c = $art_objinnrnyucfa$art_obj.length; $art_iwclncahc$art_i < $art_cwwihrzqc$art_c; $art_iwclncahc$art_i++) {            var ss = $art_objinnrnyucfa$art_obj[$art_iwclncahc$art_i]%>';
            for (var $art_iwclncahc$art_i = 0, $art_objinnrnyucfa$art_obj = s.subs, $art_cwwihrzqc$art_c = $art_objinnrnyucfa$art_obj.length; $art_iwclncahc$art_i < $art_cwwihrzqc$art_c; $art_iwclncahc$art_i++) {
                var ss = $art_objinnrnyucfa$art_obj[$art_iwclncahc$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ipaglryhibg$art_i = 0, $art_objrsjwcst$art_obj = ss.subs, $art_czjptyyb$art_c = $art_objrsjwcst$art_obj.length; $art_ipaglryhibg$art_i < $art_czjptyyb$art_c; $art_ipaglryhibg$art_i++) {                    var sss = $art_objrsjwcst$art_obj[$art_ipaglryhibg$art_i]%>';
                    for (var $art_ipaglryhibg$art_i = 0, $art_objrsjwcst$art_obj = ss.subs, $art_czjptyyb$art_c = $art_objrsjwcst$art_obj.length; $art_ipaglryhibg$art_i < $art_czjptyyb$art_c; $art_ipaglryhibg$art_i++) {
                        var sss = $art_objrsjwcst$art_obj[$art_ipaglryhibg$art_i];
