...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqsnqhcsz$art_i = 0, $art_cjakpymi$art_c = list.length; $art_iqsnqhcsz$art_i < $art_cjakpymi$art_c; $art_iqsnqhcsz$art_i++) {    var item = list[$art_iqsnqhcsz$art_i]%>';
    for (var $art_iqsnqhcsz$art_i = 0, $art_cjakpymi$art_c = list.length; $art_iqsnqhcsz$art_i < $art_cjakpymi$art_c; $art_iqsnqhcsz$art_i++) {
        var item = list[$art_iqsnqhcsz$art_i];
        ...
        ;
        $expr = '<%for (var $art_ircajsyeby$art_i = 0, $art_objofuvljalw$art_obj = item.subs, $art_cgnpktpsxeb$art_c = $art_objofuvljalw$art_obj.length; $art_ircajsyeby$art_i < $art_cgnpktpsxeb$art_c; $art_ircajsyeby$art_i++) {        var s = $art_objofuvljalw$art_obj[$art_ircajsyeby$art_i]%>';
        for (var $art_ircajsyeby$art_i = 0, $art_objofuvljalw$art_obj = item.subs, $art_cgnpktpsxeb$art_c = $art_objofuvljalw$art_obj.length; $art_ircajsyeby$art_i < $art_cgnpktpsxeb$art_c; $art_ircajsyeby$art_i++) {
            var s = $art_objofuvljalw$art_obj[$art_ircajsyeby$art_i];
            ...
            ;
            $expr = '<%for (var $art_irkqmataos$art_i = 0, $art_objqavaybvd$art_obj = s.subs, $art_cuxyqzmhi$art_c = $art_objqavaybvd$art_obj.length; $art_irkqmataos$art_i < $art_cuxyqzmhi$art_c; $art_irkqmataos$art_i++) {            var ss = $art_objqavaybvd$art_obj[$art_irkqmataos$art_i]%>';
            for (var $art_irkqmataos$art_i = 0, $art_objqavaybvd$art_obj = s.subs, $art_cuxyqzmhi$art_c = $art_objqavaybvd$art_obj.length; $art_irkqmataos$art_i < $art_cuxyqzmhi$art_c; $art_irkqmataos$art_i++) {
                var ss = $art_objqavaybvd$art_obj[$art_irkqmataos$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iggtvnuyqi$art_i = 0, $art_objspxiocrz$art_obj = ss.subs, $art_cnikcbump$art_c = $art_objspxiocrz$art_obj.length; $art_iggtvnuyqi$art_i < $art_cnikcbump$art_c; $art_iggtvnuyqi$art_i++) {                    var sss = $art_objspxiocrz$art_obj[$art_iggtvnuyqi$art_i]%>';
                    for (var $art_iggtvnuyqi$art_i = 0, $art_objspxiocrz$art_obj = ss.subs, $art_cnikcbump$art_c = $art_objspxiocrz$art_obj.length; $art_iggtvnuyqi$art_i < $art_cnikcbump$art_c; $art_iggtvnuyqi$art_i++) {
                        var sss = $art_objspxiocrz$art_obj[$art_iggtvnuyqi$art_i];
