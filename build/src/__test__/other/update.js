...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itwihjakk$art_i = 0, $art_cpgsssefvu$art_c = list.length; $art_itwihjakk$art_i < $art_cpgsssefvu$art_c; $art_itwihjakk$art_i++) {    var item = list[$art_itwihjakk$art_i]%>';
    for (var $art_itwihjakk$art_i = 0, $art_cpgsssefvu$art_c = list.length; $art_itwihjakk$art_i < $art_cpgsssefvu$art_c; $art_itwihjakk$art_i++) {
        var item = list[$art_itwihjakk$art_i];
        ...
        ;
        $expr = '<%for (var $art_idivbocv$art_i = 0, $art_objxqdmqoio$art_obj = item.subs, $art_chwyqjnhjju$art_c = $art_objxqdmqoio$art_obj.length; $art_idivbocv$art_i < $art_chwyqjnhjju$art_c; $art_idivbocv$art_i++) {        var s = $art_objxqdmqoio$art_obj[$art_idivbocv$art_i]%>';
        for (var $art_idivbocv$art_i = 0, $art_objxqdmqoio$art_obj = item.subs, $art_chwyqjnhjju$art_c = $art_objxqdmqoio$art_obj.length; $art_idivbocv$art_i < $art_chwyqjnhjju$art_c; $art_idivbocv$art_i++) {
            var s = $art_objxqdmqoio$art_obj[$art_idivbocv$art_i];
            ...
            ;
            $expr = '<%for (var $art_isjjkssyfq$art_i = 0, $art_objdezigqd$art_obj = s.subs, $art_cgdcyygvjhu$art_c = $art_objdezigqd$art_obj.length; $art_isjjkssyfq$art_i < $art_cgdcyygvjhu$art_c; $art_isjjkssyfq$art_i++) {            var ss = $art_objdezigqd$art_obj[$art_isjjkssyfq$art_i]%>';
            for (var $art_isjjkssyfq$art_i = 0, $art_objdezigqd$art_obj = s.subs, $art_cgdcyygvjhu$art_c = $art_objdezigqd$art_obj.length; $art_isjjkssyfq$art_i < $art_cgdcyygvjhu$art_c; $art_isjjkssyfq$art_i++) {
                var ss = $art_objdezigqd$art_obj[$art_isjjkssyfq$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_ishqqaq$art_i = 0, $art_objqebarqdsbdp$art_obj = ss.subs, $art_cadqctzaaeq$art_c = $art_objqebarqdsbdp$art_obj.length; $art_ishqqaq$art_i < $art_cadqctzaaeq$art_c; $art_ishqqaq$art_i++) {                    var sss = $art_objqebarqdsbdp$art_obj[$art_ishqqaq$art_i]%>';
                    for (var $art_ishqqaq$art_i = 0, $art_objqebarqdsbdp$art_obj = ss.subs, $art_cadqctzaaeq$art_c = $art_objqebarqdsbdp$art_obj.length; $art_ishqqaq$art_i < $art_cadqctzaaeq$art_c; $art_ishqqaq$art_i++) {
                        var sss = $art_objqebarqdsbdp$art_obj[$art_ishqqaq$art_i];
