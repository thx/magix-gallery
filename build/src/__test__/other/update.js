...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyifaaxcx$art_i = 0, $art_covtqjkajo$art_c = list.length; $art_iyifaaxcx$art_i < $art_covtqjkajo$art_c; $art_iyifaaxcx$art_i++) {    var item = list[$art_iyifaaxcx$art_i]%>';
    for (var $art_iyifaaxcx$art_i = 0, $art_covtqjkajo$art_c = list.length; $art_iyifaaxcx$art_i < $art_covtqjkajo$art_c; $art_iyifaaxcx$art_i++) {
        var item = list[$art_iyifaaxcx$art_i];
        ...
        ;
        $expr = '<%for (var $art_iihdmaxun$art_i = 0, $art_objaroblpky$art_obj = item.subs, $art_cahnvqkprf$art_c = $art_objaroblpky$art_obj.length; $art_iihdmaxun$art_i < $art_cahnvqkprf$art_c; $art_iihdmaxun$art_i++) {        var s = $art_objaroblpky$art_obj[$art_iihdmaxun$art_i]%>';
        for (var $art_iihdmaxun$art_i = 0, $art_objaroblpky$art_obj = item.subs, $art_cahnvqkprf$art_c = $art_objaroblpky$art_obj.length; $art_iihdmaxun$art_i < $art_cahnvqkprf$art_c; $art_iihdmaxun$art_i++) {
            var s = $art_objaroblpky$art_obj[$art_iihdmaxun$art_i];
            ...
            ;
            $expr = '<%for (var $art_iztcmexm$art_i = 0, $art_objzxyghl$art_obj = s.subs, $art_csmywtrzws$art_c = $art_objzxyghl$art_obj.length; $art_iztcmexm$art_i < $art_csmywtrzws$art_c; $art_iztcmexm$art_i++) {            var ss = $art_objzxyghl$art_obj[$art_iztcmexm$art_i]%>';
            for (var $art_iztcmexm$art_i = 0, $art_objzxyghl$art_obj = s.subs, $art_csmywtrzws$art_c = $art_objzxyghl$art_obj.length; $art_iztcmexm$art_i < $art_csmywtrzws$art_c; $art_iztcmexm$art_i++) {
                var ss = $art_objzxyghl$art_obj[$art_iztcmexm$art_i];
                ...
                if (ss.subs && (ss.subs.length > 0)) {
                    ...
                    ;
                    $expr = '<%for (var $art_iwrljasnva$art_i = 0, $art_objopbdlwax$art_obj = ss.subs, $art_cozzovdc$art_c = $art_objopbdlwax$art_obj.length; $art_iwrljasnva$art_i < $art_cozzovdc$art_c; $art_iwrljasnva$art_i++) {                    var sss = $art_objopbdlwax$art_obj[$art_iwrljasnva$art_i]%>';
                    for (var $art_iwrljasnva$art_i = 0, $art_objopbdlwax$art_obj = ss.subs, $art_cozzovdc$art_c = $art_objopbdlwax$art_obj.length; $art_iwrljasnva$art_i < $art_cozzovdc$art_c; $art_iwrljasnva$art_i++) {
                        var sss = $art_objopbdlwax$art_obj[$art_iwrljasnva$art_i];
