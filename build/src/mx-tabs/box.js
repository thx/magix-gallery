...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_itgrtpecacq$art_i=0;$art_itgrtpecacq$art_i<list.length;$art_itgrtpecacq$art_i++){var item=list[$art_itgrtpecacq$art_i]%>';
    for (var $art_itgrtpecacq$art_i = 0; $art_itgrtpecacq$art_i < list.length; $art_itgrtpecacq$art_i++) {
        var item = list[$art_itgrtpecacq$art_i];
        $p += '<a href="javascript:;" ';
        $line = 3;
        $art = 'if !disabled';
        ;
