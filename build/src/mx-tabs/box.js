...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iiussuhf$art_i = 0, $art_cfcbylo$art_c = list.length; $art_iiussuhf$art_i < $art_cfcbylo$art_c; $art_iiussuhf$art_i++) {    var item = list[$art_iiussuhf$art_i]%>';
    for (var $art_iiussuhf$art_i = 0, $art_cfcbylo$art_c = list.length; $art_iiussuhf$art_i < $art_cfcbylo$art_c; $art_iiussuhf$art_i++) {
        var item = list[$art_iiussuhf$art_i];
        $p += '<a href="javascript:;" ';
        $line = 3;
        $art = 'if !disabled';
        ;
        ...
        if (item.tag) {
            ;
            $p += '<span mxa="_zs_galleryc5:_" class="_zs_gallery_mx-tabs_index_-tag">';
            $line = 6;
            $art = '=item.tag';
            ;
