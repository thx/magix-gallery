...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iqzlmewhk$art_i=0;$art_iqzlmewhk$art_i<list.length;$art_iqzlmewhk$art_i++){var item=list[$art_iqzlmewhk$art_i]%>';
    for (var $art_iqzlmewhk$art_i = 0; $art_iqzlmewhk$art_i < list.length; $art_iqzlmewhk$art_i++) {
        var item = list[$art_iqzlmewhk$art_i];
        $p += '<a href="javascript:;" ';
        $line = 3;
        $art = 'if !disabled';
        ;
