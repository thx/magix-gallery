...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipqkypdo$art_i = 0, $art_crevbomrm$art_c = list.length; $art_ipqkypdo$art_i < $art_crevbomrm$art_c; $art_ipqkypdo$art_i++) {    var item = list[$art_ipqkypdo$art_i]%>';
    for (var $art_ipqkypdo$art_i = 0, $art_crevbomrm$art_c = list.length; $art_ipqkypdo$art_i < $art_crevbomrm$art_c; $art_ipqkypdo$art_i++) {
        var item = list[$art_ipqkypdo$art_i];
        $p += '<a href="javascript:;" ';
        $line = 3;
        $art = 'if !disabled';
        ;
