...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_czoxlqvfs$art_c = list.length; index < $art_czoxlqvfs$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_czoxlqvfs$art_c = list.length; index < $art_czoxlqvfs$art_c; index++) {
        var item = list[index];
        $p += '<a href="javascript:;" ';
        $line = 3;
        $art = 'if !disabled';
