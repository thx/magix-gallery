...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iajxhjg$art_i = 0, $art_cxblaxh$art_c = list.length; $art_iajxhjg$art_i < $art_cxblaxh$art_c; $art_iajxhjg$art_i++) {    var item = list[$art_iajxhjg$art_i]%>';
    for (var $art_iajxhjg$art_i = 0, $art_cxblaxh$art_c = list.length; $art_iajxhjg$art_i < $art_cxblaxh$art_c; $art_iajxhjg$art_i++) {
        var item = list[$art_iajxhjg$art_i];
        $p += '<a href="javascript:;" ';
        $line = 3;
        $art = 'if !disabled';
        ;
