...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ;
        $p += '<div mxa="_zs_gallerye0:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
        $line = 3;
        $art = 'each list as item index';
        ;
        $expr = '<%for (var index = 0, $art_cpfsodxf$art_c = list.length; index < $art_cpfsodxf$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cpfsodxf$art_c = list.length; index < $art_cpfsodxf$art_c; index++) {
            var item = list[index];
            ...
            if (item.tag) {
                ...
                $art = '=item.color';
                ;
                $p += ($expr = '<%=item.color%>', $e(item.color)) + ';"></span><span mxa="_zs_gallerye0:a" class="mx-tag-name">';
                $line = 13;
                $art = '!item.tag';
                ;
        ...
        ;
        $expr = '<%for (var $art_iumrzzkoe$art_i = 0, $art_cexfymmcu$art_c = list.length; $art_iumrzzkoe$art_i < $art_cexfymmcu$art_c; $art_iumrzzkoe$art_i++) {        var item = list[$art_iumrzzkoe$art_i]%>';
        for (var $art_iumrzzkoe$art_i = 0, $art_cexfymmcu$art_c = list.length; $art_iumrzzkoe$art_i < $art_cexfymmcu$art_c; $art_iumrzzkoe$art_i++) {
            var item = list[$art_iumrzzkoe$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_gallerye0:b" class="_zs_gallery_mx-tabs_index_-tag">';
                $line = 33;
                $art = '=item.tag';
                ;
