...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var $art_icymdzul$art_i = 0, $art_cyppvqggxiz$art_c = list.length; $art_icymdzul$art_i < $art_cyppvqggxiz$art_c; $art_icymdzul$art_i++) {        var item = list[$art_icymdzul$art_i]%>';
        for (var $art_icymdzul$art_i = 0, $art_cyppvqggxiz$art_c = list.length; $art_icymdzul$art_i < $art_cyppvqggxiz$art_c; $art_icymdzul$art_i++) {
            var item = list[$art_icymdzul$art_i];
        ...
        $art = 'each list as item';
        ;
        $expr = '<%for (var $art_iqvocpym$art_i = 0, $art_cebdiqqxl$art_c = list.length; $art_iqvocpym$art_i < $art_cebdiqqxl$art_c; $art_iqvocpym$art_i++) {        var item = list[$art_iqvocpym$art_i]%>';
        for (var $art_iqvocpym$art_i = 0, $art_cebdiqqxl$art_c = list.length; $art_iqvocpym$art_i < $art_cebdiqqxl$art_c; $art_iqvocpym$art_i++) {
            var item = list[$art_iqvocpym$art_i];
            $p += '<a href="javascript:;" ';
            $line = 24;
            $art = 'if !disabled';
            ;
