...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cmhobbsexv$art_c = list.length; index < $art_cmhobbsexv$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cmhobbsexv$art_c = list.length; index < $art_cmhobbsexv$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_idmjivole$art_i = 0, $art_cknsgdlle$art_c = list.length; $art_idmjivole$art_i < $art_cknsgdlle$art_c; $art_idmjivole$art_i++) {        var item = list[$art_idmjivole$art_i]%>';
        for (var $art_idmjivole$art_i = 0, $art_cknsgdlle$art_c = list.length; $art_idmjivole$art_i < $art_cknsgdlle$art_c; $art_idmjivole$art_i++) {
            var item = list[$art_idmjivole$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
