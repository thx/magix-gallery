...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cuwcqezj$art_c = list.length; index < $art_cuwcqezj$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cuwcqezj$art_c = list.length; index < $art_cuwcqezj$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iktfvxas$art_i = 0, $art_ctmixeogned$art_c = list.length; $art_iktfvxas$art_i < $art_ctmixeogned$art_c; $art_iktfvxas$art_i++) {        var item = list[$art_iktfvxas$art_i]%>';
        for (var $art_iktfvxas$art_i = 0, $art_ctmixeogned$art_c = list.length; $art_iktfvxas$art_i < $art_ctmixeogned$art_c; $art_iktfvxas$art_i++) {
            var item = list[$art_iktfvxas$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
