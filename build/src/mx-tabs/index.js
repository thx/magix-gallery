...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ;
        $p += '<div mxa="_zs_gallerycI:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
        $line = 3;
        $art = 'each list as item';
        ;
        $p += '';
        $expr = '<%for (var $art_ikwjkbck$art_i = 0, $art_cyksywqgbel$art_c = list.length; $art_ikwjkbck$art_i < $art_cyksywqgbel$art_c; $art_ikwjkbck$art_i++) {        var item = list[$art_ikwjkbck$art_i]%>';
        for (var $art_ikwjkbck$art_i = 0, $art_cyksywqgbel$art_c = list.length; $art_ikwjkbck$art_i < $art_cyksywqgbel$art_c; $art_ikwjkbck$art_i++) {
            var item = list[$art_ikwjkbck$art_i];
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_gallerycI:a" class="_zs_gallery_mx-tabs_index_-tag"><span mxs="_zs_gallerycI:_" class="_zs_gallery_mx-tabs_index_-tag-arrow"></span><span mxa="_zs_gallerycI:b" class="_zs_gallery_mx-tabs_index_-tag-name">';
                $line = 9;
                $art = '=item.tag';
                ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ikfvrjglij$art_i = 0, $art_czmpebpi$art_c = list.length; $art_ikfvrjglij$art_i < $art_czmpebpi$art_c; $art_ikfvrjglij$art_i++) {        var item = list[$art_ikfvrjglij$art_i]%>';
        for (var $art_ikfvrjglij$art_i = 0, $art_czmpebpi$art_c = list.length; $art_ikfvrjglij$art_i < $art_czmpebpi$art_c; $art_ikfvrjglij$art_i++) {
            var item = list[$art_ikfvrjglij$art_i];
            $p += '<a href="javascript:;" ';
            $line = 19;
            $art = 'if !disabled';
            ;
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_gallerycI:c" class="_zs_gallery_mx-tabs_index_-tag">';
                $line = 22;
                $art = '=item.tag';
                ;
