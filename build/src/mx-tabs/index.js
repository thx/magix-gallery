...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cpghpis$art_c = list.length; index < $art_cpghpis$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cpghpis$art_c = list.length; index < $art_cpghpis$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iimchmrsvem$art_i = 0, $art_cynlpfgwr$art_c = list.length; $art_iimchmrsvem$art_i < $art_cynlpfgwr$art_c; $art_iimchmrsvem$art_i++) {        var item = list[$art_iimchmrsvem$art_i]%>';
        for (var $art_iimchmrsvem$art_i = 0, $art_cynlpfgwr$art_c = list.length; $art_iimchmrsvem$art_i < $art_cynlpfgwr$art_c; $art_iimchmrsvem$art_i++) {
            var item = list[$art_iimchmrsvem$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
