...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ccanudxzk$art_c = list.length; index < $art_ccanudxzk$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ccanudxzk$art_c = list.length; index < $art_ccanudxzk$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ilnoovuubb$art_i = 0, $art_csjvsefdug$art_c = list.length; $art_ilnoovuubb$art_i < $art_csjvsefdug$art_c; $art_ilnoovuubb$art_i++) {        var item = list[$art_ilnoovuubb$art_i]%>';
        for (var $art_ilnoovuubb$art_i = 0, $art_csjvsefdug$art_c = list.length; $art_ilnoovuubb$art_i < $art_csjvsefdug$art_c; $art_ilnoovuubb$art_i++) {
            var item = list[$art_ilnoovuubb$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
