...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cbaqavpu$art_c = list.length; index < $art_cbaqavpu$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cbaqavpu$art_c = list.length; index < $art_cbaqavpu$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_isaqjihete$art_i = 0, $art_ctunrtnzcv$art_c = list.length; $art_isaqjihete$art_i < $art_ctunrtnzcv$art_c; $art_isaqjihete$art_i++) {        var item = list[$art_isaqjihete$art_i]%>';
        for (var $art_isaqjihete$art_i = 0, $art_ctunrtnzcv$art_c = list.length; $art_isaqjihete$art_i < $art_ctunrtnzcv$art_c; $art_isaqjihete$art_i++) {
            var item = list[$art_isaqjihete$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
