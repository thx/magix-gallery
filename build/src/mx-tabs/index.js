...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ctopmvdwd$art_c = list.length; index < $art_ctopmvdwd$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ctopmvdwd$art_c = list.length; index < $art_ctopmvdwd$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ikehuqn$art_i = 0, $art_cbtwipme$art_c = list.length; $art_ikehuqn$art_i < $art_cbtwipme$art_c; $art_ikehuqn$art_i++) {        var item = list[$art_ikehuqn$art_i]%>';
        for (var $art_ikehuqn$art_i = 0, $art_cbtwipme$art_c = list.length; $art_ikehuqn$art_i < $art_cbtwipme$art_c; $art_ikehuqn$art_i++) {
            var item = list[$art_ikehuqn$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
