...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cbgmhua$art_c = list.length; index < $art_cbgmhua$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cbgmhua$art_c = list.length; index < $art_cbgmhua$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iiagswq$art_i = 0, $art_cwfvewbt$art_c = list.length; $art_iiagswq$art_i < $art_cwfvewbt$art_c; $art_iiagswq$art_i++) {        var item = list[$art_iiagswq$art_i]%>';
        for (var $art_iiagswq$art_i = 0, $art_cwfvewbt$art_c = list.length; $art_iiagswq$art_i < $art_cwfvewbt$art_c; $art_iiagswq$art_i++) {
            var item = list[$art_iiagswq$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
