...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cfusgpcfin$art_c = list.length; index < $art_cfusgpcfin$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cfusgpcfin$art_c = list.length; index < $art_cfusgpcfin$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iudnxxys$art_i = 0, $art_ctqoxluy$art_c = list.length; $art_iudnxxys$art_i < $art_ctqoxluy$art_c; $art_iudnxxys$art_i++) {        var item = list[$art_iudnxxys$art_i]%>';
        for (var $art_iudnxxys$art_i = 0, $art_ctqoxluy$art_c = list.length; $art_iudnxxys$art_i < $art_ctqoxluy$art_c; $art_iudnxxys$art_i++) {
            var item = list[$art_iudnxxys$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
