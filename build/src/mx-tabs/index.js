...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_coxzqggxc$art_c = list.length; index < $art_coxzqggxc$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_coxzqggxc$art_c = list.length; index < $art_coxzqggxc$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_imgmnvkwnq$art_i = 0, $art_cbsksdyuqx$art_c = list.length; $art_imgmnvkwnq$art_i < $art_cbsksdyuqx$art_c; $art_imgmnvkwnq$art_i++) {        var item = list[$art_imgmnvkwnq$art_i]%>';
        for (var $art_imgmnvkwnq$art_i = 0, $art_cbsksdyuqx$art_c = list.length; $art_imgmnvkwnq$art_i < $art_cbsksdyuqx$art_c; $art_imgmnvkwnq$art_i++) {
            var item = list[$art_imgmnvkwnq$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
