...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cvgvsxpg$art_c = list.length; index < $art_cvgvsxpg$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cvgvsxpg$art_c = list.length; index < $art_cvgvsxpg$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_imxbuiog$art_i = 0, $art_cpquacenwpue$art_c = list.length; $art_imxbuiog$art_i < $art_cpquacenwpue$art_c; $art_imxbuiog$art_i++) {        var item = list[$art_imxbuiog$art_i]%>';
        for (var $art_imxbuiog$art_i = 0, $art_cpquacenwpue$art_c = list.length; $art_imxbuiog$art_i < $art_cpquacenwpue$art_c; $art_imxbuiog$art_i++) {
            var item = list[$art_imxbuiog$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
