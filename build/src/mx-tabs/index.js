...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cnenljzyal$art_c = list.length; index < $art_cnenljzyal$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cnenljzyal$art_c = list.length; index < $art_cnenljzyal$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_igmrwmhskt$art_i = 0, $art_cmshxov$art_c = list.length; $art_igmrwmhskt$art_i < $art_cmshxov$art_c; $art_igmrwmhskt$art_i++) {        var item = list[$art_igmrwmhskt$art_i]%>';
        for (var $art_igmrwmhskt$art_i = 0, $art_cmshxov$art_c = list.length; $art_igmrwmhskt$art_i < $art_cmshxov$art_c; $art_igmrwmhskt$art_i++) {
            var item = list[$art_igmrwmhskt$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
