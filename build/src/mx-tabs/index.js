...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_csfsyswvvb$art_c = list.length; index < $art_csfsyswvvb$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_csfsyswvvb$art_c = list.length; index < $art_csfsyswvvb$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iamwqdufxpb$art_i = 0, $art_clqdbp$art_c = list.length; $art_iamwqdufxpb$art_i < $art_clqdbp$art_c; $art_iamwqdufxpb$art_i++) {        var item = list[$art_iamwqdufxpb$art_i]%>';
        for (var $art_iamwqdufxpb$art_i = 0, $art_clqdbp$art_c = list.length; $art_iamwqdufxpb$art_i < $art_clqdbp$art_c; $art_iamwqdufxpb$art_i++) {
            var item = list[$art_iamwqdufxpb$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
