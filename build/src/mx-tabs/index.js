...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ;
        $p += '<div mxa="_zs_galleryez:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
        $line = 3;
        $art = 'each list as item index';
        ;
        $expr = '<%for (var index = 0, $art_cdisvfab$art_c = list.length; index < $art_cdisvfab$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cdisvfab$art_c = list.length; index < $art_cdisvfab$art_c; index++) {
            var item = list[index];
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_galleryez:a" class="_zs_gallery_mx-tabs_index_-tag"><span mxs="_zs_galleryez:_" class="_zs_gallery_mx-tabs_index_-tag-arrow"></span><span mxa="_zs_galleryez:b" class="_zs_gallery_mx-tabs_index_-tag-name">';
                $line = 13;
                $art = '=item.tag';
                ;
        ...
        ;
        $expr = '<%for (var $art_iouktanqye$art_i = 0, $art_cmggwqrxis$art_c = list.length; $art_iouktanqye$art_i < $art_cmggwqrxis$art_c; $art_iouktanqye$art_i++) {        var item = list[$art_iouktanqye$art_i]%>';
        for (var $art_iouktanqye$art_i = 0, $art_cmggwqrxis$art_c = list.length; $art_iouktanqye$art_i < $art_cmggwqrxis$art_c; $art_iouktanqye$art_i++) {
            var item = list[$art_iouktanqye$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_galleryez:c" class="_zs_gallery_mx-tabs_index_-tag">';
                $line = 32;
                $art = '=item.tag';
                ;
