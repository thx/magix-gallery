...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_candirotn$art_c = list.length; index < $art_candirotn$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_candirotn$art_c = list.length; index < $art_candirotn$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ismsnqfxe$art_i = 0, $art_cmtjitgvwam$art_c = list.length; $art_ismsnqfxe$art_i < $art_cmtjitgvwam$art_c; $art_ismsnqfxe$art_i++) {        var item = list[$art_ismsnqfxe$art_i]%>';
        for (var $art_ismsnqfxe$art_i = 0, $art_cmtjitgvwam$art_c = list.length; $art_ismsnqfxe$art_i < $art_cmtjitgvwam$art_c; $art_ismsnqfxe$art_i++) {
            var item = list[$art_ismsnqfxe$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
