...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_coordjwid$art_c = list.length; index < $art_coordjwid$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_coordjwid$art_c = list.length; index < $art_coordjwid$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ibaukdqaoht$art_i = 0, $art_couuofop$art_c = list.length; $art_ibaukdqaoht$art_i < $art_couuofop$art_c; $art_ibaukdqaoht$art_i++) {        var item = list[$art_ibaukdqaoht$art_i]%>';
        for (var $art_ibaukdqaoht$art_i = 0, $art_couuofop$art_c = list.length; $art_ibaukdqaoht$art_i < $art_couuofop$art_c; $art_ibaukdqaoht$art_i++) {
            var item = list[$art_ibaukdqaoht$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
