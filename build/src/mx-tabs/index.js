...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cqrzxmzesgjd$art_c = list.length; index < $art_cqrzxmzesgjd$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cqrzxmzesgjd$art_c = list.length; index < $art_cqrzxmzesgjd$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ikzmgr$art_i = 0, $art_cczlmjuj$art_c = list.length; $art_ikzmgr$art_i < $art_cczlmjuj$art_c; $art_ikzmgr$art_i++) {        var item = list[$art_ikzmgr$art_i]%>';
        for (var $art_ikzmgr$art_i = 0, $art_cczlmjuj$art_c = list.length; $art_ikzmgr$art_i < $art_cczlmjuj$art_c; $art_ikzmgr$art_i++) {
            var item = list[$art_ikzmgr$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
