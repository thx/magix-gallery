...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cyvddmco$art_c = list.length; index < $art_cyvddmco$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cyvddmco$art_c = list.length; index < $art_cyvddmco$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ipovbu$art_i = 0, $art_csgzvmk$art_c = list.length; $art_ipovbu$art_i < $art_csgzvmk$art_c; $art_ipovbu$art_i++) {        var item = list[$art_ipovbu$art_i]%>';
        for (var $art_ipovbu$art_i = 0, $art_csgzvmk$art_c = list.length; $art_ipovbu$art_i < $art_csgzvmk$art_c; $art_ipovbu$art_i++) {
            var item = list[$art_ipovbu$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
