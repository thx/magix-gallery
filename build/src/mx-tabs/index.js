...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cpzhruabwt$art_c = list.length; index < $art_cpzhruabwt$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cpzhruabwt$art_c = list.length; index < $art_cpzhruabwt$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_imddiuzb$art_i = 0, $art_chyoplolo$art_c = list.length; $art_imddiuzb$art_i < $art_chyoplolo$art_c; $art_imddiuzb$art_i++) {        var item = list[$art_imddiuzb$art_i]%>';
        for (var $art_imddiuzb$art_i = 0, $art_chyoplolo$art_c = list.length; $art_imddiuzb$art_i < $art_chyoplolo$art_c; $art_imddiuzb$art_i++) {
            var item = list[$art_imddiuzb$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
