...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cbrdyttr$art_c = list.length; index < $art_cbrdyttr$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cbrdyttr$art_c = list.length; index < $art_cbrdyttr$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iaqbgtnt$art_i = 0, $art_clyahoi$art_c = list.length; $art_iaqbgtnt$art_i < $art_clyahoi$art_c; $art_iaqbgtnt$art_i++) {        var item = list[$art_iaqbgtnt$art_i]%>';
        for (var $art_iaqbgtnt$art_i = 0, $art_clyahoi$art_c = list.length; $art_iaqbgtnt$art_i < $art_clyahoi$art_c; $art_iaqbgtnt$art_i++) {
            var item = list[$art_iaqbgtnt$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
