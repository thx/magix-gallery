...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cuomlzhpi$art_c = list.length; index < $art_cuomlzhpi$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cuomlzhpi$art_c = list.length; index < $art_cuomlzhpi$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iyzytjswk$art_i = 0, $art_cscbqwnepf$art_c = list.length; $art_iyzytjswk$art_i < $art_cscbqwnepf$art_c; $art_iyzytjswk$art_i++) {        var item = list[$art_iyzytjswk$art_i]%>';
        for (var $art_iyzytjswk$art_i = 0, $art_cscbqwnepf$art_c = list.length; $art_iyzytjswk$art_i < $art_cscbqwnepf$art_c; $art_iyzytjswk$art_i++) {
            var item = list[$art_iyzytjswk$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
