...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ctwagge$art_c = list.length; index < $art_ctwagge$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ctwagge$art_c = list.length; index < $art_ctwagge$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_idnlmhcs$art_i = 0, $art_cizixtcb$art_c = list.length; $art_idnlmhcs$art_i < $art_cizixtcb$art_c; $art_idnlmhcs$art_i++) {        var item = list[$art_idnlmhcs$art_i]%>';
        for (var $art_idnlmhcs$art_i = 0, $art_cizixtcb$art_c = list.length; $art_idnlmhcs$art_i < $art_cizixtcb$art_c; $art_idnlmhcs$art_i++) {
            var item = list[$art_idnlmhcs$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
