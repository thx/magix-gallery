...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ctwwrvyi$art_c = list.length; index < $art_ctwwrvyi$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ctwwrvyi$art_c = list.length; index < $art_ctwwrvyi$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ihkftycfvhk$art_i = 0, $art_czdgftsqg$art_c = list.length; $art_ihkftycfvhk$art_i < $art_czdgftsqg$art_c; $art_ihkftycfvhk$art_i++) {        var item = list[$art_ihkftycfvhk$art_i]%>';
        for (var $art_ihkftycfvhk$art_i = 0, $art_czdgftsqg$art_c = list.length; $art_ihkftycfvhk$art_i < $art_czdgftsqg$art_c; $art_ihkftycfvhk$art_i++) {
            var item = list[$art_ihkftycfvhk$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
