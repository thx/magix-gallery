...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ;
        $p += '<div mxa="_zs_galleryeM:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
        $line = 3;
        $art = 'each list as item index';
        ;
        $expr = '<%for (var index = 0, $art_cpngk$art_c = list.length; index < $art_cpngk$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cpngk$art_c = list.length; index < $art_cpngk$art_c; index++) {
            var item = list[index];
            ...
            if (item.tag) {
                ...
                $art = '=item.color';
                ;
                $p += ($expr = '<%=item.color%>', $e(item.color)) + ';"></span><span mxa="_zs_galleryeM:a" class="mx-tag-name">';
                $line = 13;
                $art = '!item.tag';
                ;
        ...
        ;
        $expr = '<%for (var $art_izypsuldxym$art_i = 0, $art_cdccctv$art_c = list.length; $art_izypsuldxym$art_i < $art_cdccctv$art_c; $art_izypsuldxym$art_i++) {        var item = list[$art_izypsuldxym$art_i]%>';
        for (var $art_izypsuldxym$art_i = 0, $art_cdccctv$art_c = list.length; $art_izypsuldxym$art_i < $art_cdccctv$art_c; $art_izypsuldxym$art_i++) {
            var item = list[$art_izypsuldxym$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_galleryeM:b" class="_zs_gallery_mx-tabs_index_-tag">';
                $line = 33;
                $art = '=item.tag';
                ;
