...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cnuckobm$art_c = list.length; index < $art_cnuckobm$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cnuckobm$art_c = list.length; index < $art_cnuckobm$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_itxtxrgr$art_i = 0, $art_catliiiep$art_c = list.length; $art_itxtxrgr$art_i < $art_catliiiep$art_c; $art_itxtxrgr$art_i++) {        var item = list[$art_itxtxrgr$art_i]%>';
        for (var $art_itxtxrgr$art_i = 0, $art_catliiiep$art_c = list.length; $art_itxtxrgr$art_i < $art_catliiiep$art_c; $art_itxtxrgr$art_i++) {
            var item = list[$art_itxtxrgr$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
