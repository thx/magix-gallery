...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ctxmayfk$art_c = list.length; index < $art_ctxmayfk$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ctxmayfk$art_c = list.length; index < $art_ctxmayfk$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ilotbbs$art_i = 0, $art_cbdfplvjib$art_c = list.length; $art_ilotbbs$art_i < $art_cbdfplvjib$art_c; $art_ilotbbs$art_i++) {        var item = list[$art_ilotbbs$art_i]%>';
        for (var $art_ilotbbs$art_i = 0, $art_cbdfplvjib$art_c = list.length; $art_ilotbbs$art_i < $art_cbdfplvjib$art_c; $art_ilotbbs$art_i++) {
            var item = list[$art_ilotbbs$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
