...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cxtgtknojyb$art_c = list.length; index < $art_cxtgtknojyb$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cxtgtknojyb$art_c = list.length; index < $art_cxtgtknojyb$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_icnoaztsmu$art_i = 0, $art_cimhpxihbufe$art_c = list.length; $art_icnoaztsmu$art_i < $art_cimhpxihbufe$art_c; $art_icnoaztsmu$art_i++) {        var item = list[$art_icnoaztsmu$art_i]%>';
        for (var $art_icnoaztsmu$art_i = 0, $art_cimhpxihbufe$art_c = list.length; $art_icnoaztsmu$art_i < $art_cimhpxihbufe$art_c; $art_icnoaztsmu$art_i++) {
            var item = list[$art_icnoaztsmu$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
