...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cpaqxleh$art_c = list.length; index < $art_cpaqxleh$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cpaqxleh$art_c = list.length; index < $art_cpaqxleh$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iucdnmpbn$art_i = 0, $art_cwcambcmw$art_c = list.length; $art_iucdnmpbn$art_i < $art_cwcambcmw$art_c; $art_iucdnmpbn$art_i++) {        var item = list[$art_iucdnmpbn$art_i]%>';
        for (var $art_iucdnmpbn$art_i = 0, $art_cwcambcmw$art_c = list.length; $art_iucdnmpbn$art_i < $art_cwcambcmw$art_c; $art_iucdnmpbn$art_i++) {
            var item = list[$art_iucdnmpbn$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
