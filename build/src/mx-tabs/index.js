...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cvqxtbfmuc$art_c = list.length; index < $art_cvqxtbfmuc$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cvqxtbfmuc$art_c = list.length; index < $art_cvqxtbfmuc$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_izroubet$art_i = 0, $art_cdhpmenpj$art_c = list.length; $art_izroubet$art_i < $art_cdhpmenpj$art_c; $art_izroubet$art_i++) {        var item = list[$art_izroubet$art_i]%>';
        for (var $art_izroubet$art_i = 0, $art_cdhpmenpj$art_c = list.length; $art_izroubet$art_i < $art_cdhpmenpj$art_c; $art_izroubet$art_i++) {
            var item = list[$art_izroubet$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
