...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_csizswlxg$art_c = list.length; index < $art_csizswlxg$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_csizswlxg$art_c = list.length; index < $art_csizswlxg$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iuwvyblxg$art_i = 0, $art_cmrbahsh$art_c = list.length; $art_iuwvyblxg$art_i < $art_cmrbahsh$art_c; $art_iuwvyblxg$art_i++) {        var item = list[$art_iuwvyblxg$art_i]%>';
        for (var $art_iuwvyblxg$art_i = 0, $art_cmrbahsh$art_c = list.length; $art_iuwvyblxg$art_i < $art_cmrbahsh$art_c; $art_iuwvyblxg$art_i++) {
            var item = list[$art_iuwvyblxg$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
