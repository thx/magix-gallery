...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cuepaoie$art_c = list.length; index < $art_cuepaoie$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cuepaoie$art_c = list.length; index < $art_cuepaoie$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iugnrekrb$art_i = 0, $art_cxeeylebnb$art_c = list.length; $art_iugnrekrb$art_i < $art_cxeeylebnb$art_c; $art_iugnrekrb$art_i++) {        var item = list[$art_iugnrekrb$art_i]%>';
        for (var $art_iugnrekrb$art_i = 0, $art_cxeeylebnb$art_c = list.length; $art_iugnrekrb$art_i < $art_cxeeylebnb$art_c; $art_iugnrekrb$art_i++) {
            var item = list[$art_iugnrekrb$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
