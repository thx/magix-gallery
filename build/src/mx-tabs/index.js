...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_creqdqhfd$art_c = list.length; index < $art_creqdqhfd$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_creqdqhfd$art_c = list.length; index < $art_creqdqhfd$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ihcwqclg$art_i = 0, $art_cbnyystmiqz$art_c = list.length; $art_ihcwqclg$art_i < $art_cbnyystmiqz$art_c; $art_ihcwqclg$art_i++) {        var item = list[$art_ihcwqclg$art_i]%>';
        for (var $art_ihcwqclg$art_i = 0, $art_cbnyystmiqz$art_c = list.length; $art_ihcwqclg$art_i < $art_cbnyystmiqz$art_c; $art_ihcwqclg$art_i++) {
            var item = list[$art_ihcwqclg$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
