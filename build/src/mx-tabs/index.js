...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cvgqvb$art_c = list.length; index < $art_cvgqvb$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cvgqvb$art_c = list.length; index < $art_cvgqvb$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ijifdaqzf$art_i = 0, $art_cpdunjbkfcg$art_c = list.length; $art_ijifdaqzf$art_i < $art_cpdunjbkfcg$art_c; $art_ijifdaqzf$art_i++) {        var item = list[$art_ijifdaqzf$art_i]%>';
        for (var $art_ijifdaqzf$art_i = 0, $art_cpdunjbkfcg$art_c = list.length; $art_ijifdaqzf$art_i < $art_cpdunjbkfcg$art_c; $art_ijifdaqzf$art_i++) {
            var item = list[$art_ijifdaqzf$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
