...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cdqqryt$art_c = list.length; index < $art_cdqqryt$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cdqqryt$art_c = list.length; index < $art_cdqqryt$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iqqshauens$art_i = 0, $art_ctlytrfpf$art_c = list.length; $art_iqqshauens$art_i < $art_ctlytrfpf$art_c; $art_iqqshauens$art_i++) {        var item = list[$art_iqqshauens$art_i]%>';
        for (var $art_iqqshauens$art_i = 0, $art_ctlytrfpf$art_c = list.length; $art_iqqshauens$art_i < $art_ctlytrfpf$art_c; $art_iqqshauens$art_i++) {
            var item = list[$art_iqqshauens$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
