...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cagjxmh$art_c = list.length; index < $art_cagjxmh$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cagjxmh$art_c = list.length; index < $art_cagjxmh$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_inxruyge$art_i = 0, $art_cleegrwwumis$art_c = list.length; $art_inxruyge$art_i < $art_cleegrwwumis$art_c; $art_inxruyge$art_i++) {        var item = list[$art_inxruyge$art_i]%>';
        for (var $art_inxruyge$art_i = 0, $art_cleegrwwumis$art_c = list.length; $art_inxruyge$art_i < $art_cleegrwwumis$art_c; $art_inxruyge$art_i++) {
            var item = list[$art_inxruyge$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
