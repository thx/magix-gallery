...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cfkntlhfw$art_c = list.length; index < $art_cfkntlhfw$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cfkntlhfw$art_c = list.length; index < $art_cfkntlhfw$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ibkyyal$art_i = 0, $art_cxrffkhb$art_c = list.length; $art_ibkyyal$art_i < $art_cxrffkhb$art_c; $art_ibkyyal$art_i++) {        var item = list[$art_ibkyyal$art_i]%>';
        for (var $art_ibkyyal$art_i = 0, $art_cxrffkhb$art_c = list.length; $art_ibkyyal$art_i < $art_cxrffkhb$art_c; $art_ibkyyal$art_i++) {
            var item = list[$art_ibkyyal$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
