...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_coslqkiscg$art_c = list.length; index < $art_coslqkiscg$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_coslqkiscg$art_c = list.length; index < $art_coslqkiscg$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ieaqttukv$art_i = 0, $art_crqqkaboe$art_c = list.length; $art_ieaqttukv$art_i < $art_crqqkaboe$art_c; $art_ieaqttukv$art_i++) {        var item = list[$art_ieaqttukv$art_i]%>';
        for (var $art_ieaqttukv$art_i = 0, $art_crqqkaboe$art_c = list.length; $art_ieaqttukv$art_i < $art_crqqkaboe$art_c; $art_ieaqttukv$art_i++) {
            var item = list[$art_ieaqttukv$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
