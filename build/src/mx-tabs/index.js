...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_clqejsdfri$art_c = list.length; index < $art_clqejsdfri$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_clqejsdfri$art_c = list.length; index < $art_clqejsdfri$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iezjdgizmr$art_i = 0, $art_cjqiwwomo$art_c = list.length; $art_iezjdgizmr$art_i < $art_cjqiwwomo$art_c; $art_iezjdgizmr$art_i++) {        var item = list[$art_iezjdgizmr$art_i]%>';
        for (var $art_iezjdgizmr$art_i = 0, $art_cjqiwwomo$art_c = list.length; $art_iezjdgizmr$art_i < $art_cjqiwwomo$art_c; $art_iezjdgizmr$art_i++) {
            var item = list[$art_iezjdgizmr$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
