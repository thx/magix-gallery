...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ;
        $p += '<div mxa="_zs_gallerycO:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
        $line = 3;
        $art = 'each list as item';
        ;
        $p += '';
        $expr = '<%for (var $art_idlrptbl$art_i = 0, $art_ceshfsxx$art_c = list.length; $art_idlrptbl$art_i < $art_ceshfsxx$art_c; $art_idlrptbl$art_i++) {        var item = list[$art_idlrptbl$art_i]%>';
        for (var $art_idlrptbl$art_i = 0, $art_ceshfsxx$art_c = list.length; $art_idlrptbl$art_i < $art_ceshfsxx$art_c; $art_idlrptbl$art_i++) {
            var item = list[$art_idlrptbl$art_i];
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_gallerycO:a" class="_zs_gallery_mx-tabs_index_-tag"><span mxs="_zs_gallerycO:_" class="_zs_gallery_mx-tabs_index_-tag-arrow"></span><span mxa="_zs_gallerycO:b" class="_zs_gallery_mx-tabs_index_-tag-name">';
                $line = 9;
                $art = '=item.tag';
                ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_izolwchce$art_i = 0, $art_cpmtbpu$art_c = list.length; $art_izolwchce$art_i < $art_cpmtbpu$art_c; $art_izolwchce$art_i++) {        var item = list[$art_izolwchce$art_i]%>';
        for (var $art_izolwchce$art_i = 0, $art_cpmtbpu$art_c = list.length; $art_izolwchce$art_i < $art_cpmtbpu$art_c; $art_izolwchce$art_i++) {
            var item = list[$art_izolwchce$art_i];
            $p += '<a href="javascript:;" ';
            $line = 24;
            $art = 'if !disabled';
            ;
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_gallerycO:c" class="_zs_gallery_mx-tabs_index_-tag">';
                $line = 27;
                $art = '=item.tag';
                ;
