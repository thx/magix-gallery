...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cpxxlfxgjd$art_c = list.length; index < $art_cpxxlfxgjd$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cpxxlfxgjd$art_c = list.length; index < $art_cpxxlfxgjd$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_izihncopb$art_i = 0, $art_cwjwnhom$art_c = list.length; $art_izihncopb$art_i < $art_cwjwnhom$art_c; $art_izihncopb$art_i++) {        var item = list[$art_izihncopb$art_i]%>';
        for (var $art_izihncopb$art_i = 0, $art_cwjwnhom$art_c = list.length; $art_izihncopb$art_i < $art_cwjwnhom$art_c; $art_izihncopb$art_i++) {
            var item = list[$art_izihncopb$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
