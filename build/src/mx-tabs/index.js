...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cytitr$art_c = list.length; index < $art_cytitr$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cytitr$art_c = list.length; index < $art_cytitr$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iuheypwm$art_i = 0, $art_cxshrgdqp$art_c = list.length; $art_iuheypwm$art_i < $art_cxshrgdqp$art_c; $art_iuheypwm$art_i++) {        var item = list[$art_iuheypwm$art_i]%>';
        for (var $art_iuheypwm$art_i = 0, $art_cxshrgdqp$art_c = list.length; $art_iuheypwm$art_i < $art_cxshrgdqp$art_c; $art_iuheypwm$art_i++) {
            var item = list[$art_iuheypwm$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
