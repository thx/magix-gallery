...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ;
        $p += '<div mxa="_zs_galleryeG:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
        $line = 3;
        $art = 'each list as item index';
        ;
        $expr = '<%for (var index = 0, $art_cqskqcn$art_c = list.length; index < $art_cqskqcn$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cqskqcn$art_c = list.length; index < $art_cqskqcn$art_c; index++) {
            var item = list[index];
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_galleryeG:a" class="_zs_gallery_mx-tabs_index_-tag"><span mxs="_zs_galleryeG:_" class="_zs_gallery_mx-tabs_index_-tag-arrow"></span><span mxa="_zs_galleryeG:b" class="_zs_gallery_mx-tabs_index_-tag-name">';
                $line = 13;
                $art = '=item.tag';
                ;
        ...
        ;
        $expr = '<%for (var $art_ioxcqlziegi$art_i = 0, $art_cpfmxxbfxoz$art_c = list.length; $art_ioxcqlziegi$art_i < $art_cpfmxxbfxoz$art_c; $art_ioxcqlziegi$art_i++) {        var item = list[$art_ioxcqlziegi$art_i]%>';
        for (var $art_ioxcqlziegi$art_i = 0, $art_cpfmxxbfxoz$art_c = list.length; $art_ioxcqlziegi$art_i < $art_cpfmxxbfxoz$art_c; $art_ioxcqlziegi$art_i++) {
            var item = list[$art_ioxcqlziegi$art_i];
            $p += '<a href="javascript:;" ';
            $line = 29;
            $art = 'if !disabled';
            ;
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_galleryeG:c" class="_zs_gallery_mx-tabs_index_-tag">';
                $line = 33;
                $art = '=item.tag';
                ;
