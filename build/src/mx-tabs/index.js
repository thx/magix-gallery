...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cgbwla$art_c = list.length; index < $art_cgbwla$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cgbwla$art_c = list.length; index < $art_cgbwla$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ivizrlfpda$art_i = 0, $art_cjcyhog$art_c = list.length; $art_ivizrlfpda$art_i < $art_cjcyhog$art_c; $art_ivizrlfpda$art_i++) {        var item = list[$art_ivizrlfpda$art_i]%>';
        for (var $art_ivizrlfpda$art_i = 0, $art_cjcyhog$art_c = list.length; $art_ivizrlfpda$art_i < $art_cjcyhog$art_c; $art_ivizrlfpda$art_i++) {
            var item = list[$art_ivizrlfpda$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
