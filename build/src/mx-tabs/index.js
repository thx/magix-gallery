...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cdlpfwrwpr$art_c = list.length; index < $art_cdlpfwrwpr$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cdlpfwrwpr$art_c = list.length; index < $art_cdlpfwrwpr$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iyaatmj$art_i = 0, $art_cwleejr$art_c = list.length; $art_iyaatmj$art_i < $art_cwleejr$art_c; $art_iyaatmj$art_i++) {        var item = list[$art_iyaatmj$art_i]%>';
        for (var $art_iyaatmj$art_i = 0, $art_cwleejr$art_c = list.length; $art_iyaatmj$art_i < $art_cwleejr$art_c; $art_iyaatmj$art_i++) {
            var item = list[$art_iyaatmj$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
