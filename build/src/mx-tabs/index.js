...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cwikosnq$art_c = list.length; index < $art_cwikosnq$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cwikosnq$art_c = list.length; index < $art_cwikosnq$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ipeualgj$art_i = 0, $art_cictzc$art_c = list.length; $art_ipeualgj$art_i < $art_cictzc$art_c; $art_ipeualgj$art_i++) {        var item = list[$art_ipeualgj$art_i]%>';
        for (var $art_ipeualgj$art_i = 0, $art_cictzc$art_c = list.length; $art_ipeualgj$art_i < $art_cictzc$art_c; $art_ipeualgj$art_i++) {
            var item = list[$art_ipeualgj$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
