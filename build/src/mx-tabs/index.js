...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cltlg$art_c = list.length; index < $art_cltlg$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cltlg$art_c = list.length; index < $art_cltlg$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_itnegdksic$art_i = 0, $art_cxoxhfmkio$art_c = list.length; $art_itnegdksic$art_i < $art_cxoxhfmkio$art_c; $art_itnegdksic$art_i++) {        var item = list[$art_itnegdksic$art_i]%>';
        for (var $art_itnegdksic$art_i = 0, $art_cxoxhfmkio$art_c = list.length; $art_itnegdksic$art_i < $art_cxoxhfmkio$art_c; $art_itnegdksic$art_i++) {
            var item = list[$art_itnegdksic$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
