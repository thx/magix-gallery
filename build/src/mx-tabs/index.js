...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cduvzxlfir$art_c = list.length; index < $art_cduvzxlfir$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cduvzxlfir$art_c = list.length; index < $art_cduvzxlfir$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iggyxzoli$art_i = 0, $art_cgqbkevku$art_c = list.length; $art_iggyxzoli$art_i < $art_cgqbkevku$art_c; $art_iggyxzoli$art_i++) {        var item = list[$art_iggyxzoli$art_i]%>';
        for (var $art_iggyxzoli$art_i = 0, $art_cgqbkevku$art_c = list.length; $art_iggyxzoli$art_i < $art_cgqbkevku$art_c; $art_iggyxzoli$art_i++) {
            var item = list[$art_iggyxzoli$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
