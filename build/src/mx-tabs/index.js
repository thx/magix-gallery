...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cftbyscb$art_c = list.length; index < $art_cftbyscb$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cftbyscb$art_c = list.length; index < $art_cftbyscb$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iqnlokvah$art_i = 0, $art_czqihmaagug$art_c = list.length; $art_iqnlokvah$art_i < $art_czqihmaagug$art_c; $art_iqnlokvah$art_i++) {        var item = list[$art_iqnlokvah$art_i]%>';
        for (var $art_iqnlokvah$art_i = 0, $art_czqihmaagug$art_c = list.length; $art_iqnlokvah$art_i < $art_czqihmaagug$art_c; $art_iqnlokvah$art_i++) {
            var item = list[$art_iqnlokvah$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
