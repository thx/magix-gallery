...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_crpozacnr$art_c = list.length; index < $art_crpozacnr$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_crpozacnr$art_c = list.length; index < $art_crpozacnr$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ifgyub$art_i = 0, $art_ciuwkivjh$art_c = list.length; $art_ifgyub$art_i < $art_ciuwkivjh$art_c; $art_ifgyub$art_i++) {        var item = list[$art_ifgyub$art_i]%>';
        for (var $art_ifgyub$art_i = 0, $art_ciuwkivjh$art_c = list.length; $art_ifgyub$art_i < $art_ciuwkivjh$art_c; $art_ifgyub$art_i++) {
            var item = list[$art_ifgyub$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
