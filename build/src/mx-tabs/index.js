...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ccujlplqik$art_c = list.length; index < $art_ccujlplqik$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ccujlplqik$art_c = list.length; index < $art_ccujlplqik$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ivojtsie$art_i = 0, $art_ckrctwgtx$art_c = list.length; $art_ivojtsie$art_i < $art_ckrctwgtx$art_c; $art_ivojtsie$art_i++) {        var item = list[$art_ivojtsie$art_i]%>';
        for (var $art_ivojtsie$art_i = 0, $art_ckrctwgtx$art_c = list.length; $art_ivojtsie$art_i < $art_ckrctwgtx$art_c; $art_ivojtsie$art_i++) {
            var item = list[$art_ivojtsie$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
