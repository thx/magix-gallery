...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ceksjdvswwji$art_c = list.length; index < $art_ceksjdvswwji$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ceksjdvswwji$art_c = list.length; index < $art_ceksjdvswwji$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iseeeevw$art_i = 0, $art_ccjkdczvdja$art_c = list.length; $art_iseeeevw$art_i < $art_ccjkdczvdja$art_c; $art_iseeeevw$art_i++) {        var item = list[$art_iseeeevw$art_i]%>';
        for (var $art_iseeeevw$art_i = 0, $art_ccjkdczvdja$art_c = list.length; $art_iseeeevw$art_i < $art_ccjkdczvdja$art_c; $art_iseeeevw$art_i++) {
            var item = list[$art_iseeeevw$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
