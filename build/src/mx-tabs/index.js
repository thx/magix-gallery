...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cdjniwjigv$art_c = list.length; index < $art_cdjniwjigv$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cdjniwjigv$art_c = list.length; index < $art_cdjniwjigv$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_icpcbiosgg$art_i = 0, $art_csbobofsl$art_c = list.length; $art_icpcbiosgg$art_i < $art_csbobofsl$art_c; $art_icpcbiosgg$art_i++) {        var item = list[$art_icpcbiosgg$art_i]%>';
        for (var $art_icpcbiosgg$art_i = 0, $art_csbobofsl$art_c = list.length; $art_icpcbiosgg$art_i < $art_csbobofsl$art_c; $art_icpcbiosgg$art_i++) {
            var item = list[$art_icpcbiosgg$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
