...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ;
        $p += '<div mxa="_zs_gallerycw:_" class="_zs_gallery_mx-tabs_index_-border clearfix">';
        $line = 3;
        $art = 'each list as item';
        ;
        $p += '';
        $expr = '<%for (var $art_idyeuljjwm$art_i = 0, $art_ctqasxobfzgn$art_c = list.length; $art_idyeuljjwm$art_i < $art_ctqasxobfzgn$art_c; $art_idyeuljjwm$art_i++) {        var item = list[$art_idyeuljjwm$art_i]%>';
        for (var $art_idyeuljjwm$art_i = 0, $art_ctqasxobfzgn$art_c = list.length; $art_idyeuljjwm$art_i < $art_ctqasxobfzgn$art_c; $art_idyeuljjwm$art_i++) {
            var item = list[$art_idyeuljjwm$art_i];
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_gallerycw:a" class="_zs_gallery_mx-tabs_index_-tag"><span mxs="_zs_gallerycw:_" class="_zs_gallery_mx-tabs_index_-tag-arrow"></span><span mxa="_zs_gallerycw:b" class="_zs_gallery_mx-tabs_index_-tag-name">';
                $line = 9;
                $art = '=item.tag';
                ;
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_izirgqzrcgi$art_i = 0, $art_ciorosees$art_c = list.length; $art_izirgqzrcgi$art_i < $art_ciorosees$art_c; $art_izirgqzrcgi$art_i++) {        var item = list[$art_izirgqzrcgi$art_i]%>';
        for (var $art_izirgqzrcgi$art_i = 0, $art_ciorosees$art_c = list.length; $art_izirgqzrcgi$art_i < $art_ciorosees$art_c; $art_izirgqzrcgi$art_i++) {
            var item = list[$art_izirgqzrcgi$art_i];
            $p += '<a href="javascript:;" ';
            $line = 19;
            $art = 'if !disabled';
            ;
            ...
            if (item.tag) {
                ;
                $p += '<span mxa="_zs_gallerycw:c" class="_zs_gallery_mx-tabs_index_-tag">';
                $line = 22;
                $art = '=item.tag';
                ;
