...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cygmmeyewqjs$art_c = list.length; index < $art_cygmmeyewqjs$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cygmmeyewqjs$art_c = list.length; index < $art_cygmmeyewqjs$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_izmnmcyylf$art_i = 0, $art_czdhlrb$art_c = list.length; $art_izmnmcyylf$art_i < $art_czdhlrb$art_c; $art_izmnmcyylf$art_i++) {        var item = list[$art_izmnmcyylf$art_i]%>';
        for (var $art_izmnmcyylf$art_i = 0, $art_czdhlrb$art_c = list.length; $art_izmnmcyylf$art_i < $art_czdhlrb$art_c; $art_izmnmcyylf$art_i++) {
            var item = list[$art_izmnmcyylf$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
