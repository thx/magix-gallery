...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cistussxej$art_c = list.length; index < $art_cistussxej$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cistussxej$art_c = list.length; index < $art_cistussxej$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_icguwpex$art_i = 0, $art_cwkltluat$art_c = list.length; $art_icguwpex$art_i < $art_cwkltluat$art_c; $art_icguwpex$art_i++) {        var item = list[$art_icguwpex$art_i]%>';
        for (var $art_icguwpex$art_i = 0, $art_cwkltluat$art_c = list.length; $art_icguwpex$art_i < $art_cwkltluat$art_c; $art_icguwpex$art_i++) {
            var item = list[$art_icguwpex$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
