...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cgcaaavd$art_c = list.length; index < $art_cgcaaavd$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cgcaaavd$art_c = list.length; index < $art_cgcaaavd$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ifxlfjylo$art_i = 0, $art_cmihwt$art_c = list.length; $art_ifxlfjylo$art_i < $art_cmihwt$art_c; $art_ifxlfjylo$art_i++) {        var item = list[$art_ifxlfjylo$art_i]%>';
        for (var $art_ifxlfjylo$art_i = 0, $art_cmihwt$art_c = list.length; $art_ifxlfjylo$art_i < $art_cmihwt$art_c; $art_ifxlfjylo$art_i++) {
            var item = list[$art_ifxlfjylo$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
