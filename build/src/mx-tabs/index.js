...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ccbhodr$art_c = list.length; index < $art_ccbhodr$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ccbhodr$art_c = list.length; index < $art_ccbhodr$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iworrxbivcr$art_i = 0, $art_chnhtouwwm$art_c = list.length; $art_iworrxbivcr$art_i < $art_chnhtouwwm$art_c; $art_iworrxbivcr$art_i++) {        var item = list[$art_iworrxbivcr$art_i]%>';
        for (var $art_iworrxbivcr$art_i = 0, $art_chnhtouwwm$art_c = list.length; $art_iworrxbivcr$art_i < $art_chnhtouwwm$art_c; $art_iworrxbivcr$art_i++) {
            var item = list[$art_iworrxbivcr$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
