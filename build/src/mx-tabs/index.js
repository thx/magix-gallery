...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_ckfvokzl$art_c = list.length; index < $art_ckfvokzl$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_ckfvokzl$art_c = list.length; index < $art_ckfvokzl$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iekbrlzaxzc$art_i = 0, $art_cumqjlx$art_c = list.length; $art_iekbrlzaxzc$art_i < $art_cumqjlx$art_c; $art_iekbrlzaxzc$art_i++) {        var item = list[$art_iekbrlzaxzc$art_i]%>';
        for (var $art_iekbrlzaxzc$art_i = 0, $art_cumqjlx$art_c = list.length; $art_iekbrlzaxzc$art_i < $art_cumqjlx$art_c; $art_iekbrlzaxzc$art_i++) {
            var item = list[$art_iekbrlzaxzc$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
