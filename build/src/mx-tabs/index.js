...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cbpmsgwtqkub$art_c = list.length; index < $art_cbpmsgwtqkub$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cbpmsgwtqkub$art_c = list.length; index < $art_cbpmsgwtqkub$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ifhjkbq$art_i = 0, $art_cwfruiquz$art_c = list.length; $art_ifhjkbq$art_i < $art_cwfruiquz$art_c; $art_ifhjkbq$art_i++) {        var item = list[$art_ifhjkbq$art_i]%>';
        for (var $art_ifhjkbq$art_i = 0, $art_cwfruiquz$art_c = list.length; $art_ifhjkbq$art_i < $art_cwfruiquz$art_c; $art_ifhjkbq$art_i++) {
            var item = list[$art_ifhjkbq$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
