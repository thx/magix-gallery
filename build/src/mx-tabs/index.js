...
module.exports = Base.extend({
    ...
    if (type == 'border') {
        ...
        ;
        $expr = '<%for (var index = 0, $art_cgotviblqka$art_c = list.length; index < $art_cgotviblqka$art_c; index++) {        var item = list[index]%>';
        for (var index = 0, $art_cgotviblqka$art_c = list.length; index < $art_cgotviblqka$art_c; index++) {
            var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ilsjwld$art_i = 0, $art_cigwixhno$art_c = list.length; $art_ilsjwld$art_i < $art_cigwixhno$art_c; $art_ilsjwld$art_i++) {        var item = list[$art_ilsjwld$art_i]%>';
        for (var $art_ilsjwld$art_i = 0, $art_cigwixhno$art_c = list.length; $art_ilsjwld$art_i < $art_cigwixhno$art_c; $art_ilsjwld$art_i++) {
            var item = list[$art_ilsjwld$art_i];
            $p += '<a href="javascript:;" ';
            $line = 28;
            $art = 'if !disabled';
            ;
