...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycW:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycW:a" class="_zs_gallery___test___layout_-eg-content"><div mx-view="mx-tabs/index?list=';
    $line = 4;
    $art = '@[{\n                id: 1,\n                name: \'模块1\'\n            }, {\n                id: 2,\n                name: \'模块2\'\n            }]';
    ;
    $p += '' + ($expr = '<%@[{            id: 1,            name: \'模块1\'        }, {            id: 2,            name: \'模块2\'        }]%>', $i($$ref, [{ id: 1, name: '模块1' }, { id: 2, name: '模块2' }])) + '&valueKey=id&textKey=name"></div></div><div mxa="_zs_gallerycW:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycW:_" class="_zs_gallery___test___layout_-eg-title">自定义&nbsp;text-key&nbsp;和&nbsp;value-key</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
