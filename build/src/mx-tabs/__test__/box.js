/*
    ...
    loader: cmd_es
 */
define("mx-tabs/__test__/box",["magix","$","__test__/subs","mx-title/second","./3","./6","./5","./10","./9","./7","__test__/api","__test__/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"></div><div mx-view="mx-tabs/__test__/5" id="';
    $line = 37;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_galleryeU:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-tabs/__test__/10" id="';
    $line = 40;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo10"></div><div mx-view="mx-tabs/__test__/9" id="';
    $line = 41;
    $art = '=viewId';
    ;
