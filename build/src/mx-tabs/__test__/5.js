...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerych:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_gallerych:a" class="_zs_gallery___test___base_-eg-content"><div mx-view="mx-tabs/box?list=';
    $line = 4;
    $art = '@[{\n                name: \'模块1\',\n                id: 1\n            },{\n                name: \'模块2\',\n                id: 2\n            }]';
    ;
    $p += '' + ($expr = '<%@[{name:\'模块1\',id:1},{name:\'模块2\',id:2}]%>', $i([{ name: '模块1', id: 1 }, { name: '模块2', id: 2 }])) + '&valueKey=id&textKey=name"></div></div><div mxa="_zs_gallerych:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerych:_" class="_zs_gallery___test___base_-eg-title">自定义&nbsp;text-key&nbsp;和&nbsp;value-key</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
