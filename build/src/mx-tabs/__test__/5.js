...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycZ:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycZ:a" class="_zs_gallery___test___layout_-eg-content"><div mx-view="mx-tabs/box?list=';
    $line = 4;
    $art = '@[{\n                name: \'模块1\',\n                id: 1,\n                tips: \'提示信息\'\n            },{\n                name: \'模块2\',\n                id: 2\n            }]';
    ;
    $p += '' + ($expr = '<%@[{            name: \'模块1\',            id: 1,            tips: \'提示信息\'        }, {            name: \'模块2\',            id: 2        }]%>', $i($$ref, [{ name: '模块1', id: 1, tips: '提示信息' }, { name: '模块2', id: 2 }])) + '&valueKey=id&textKey=name"></div></div><div mxa="_zs_gallerycZ:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycZ:_" class="_zs_gallery___test___layout_-eg-title">自定义&nbsp;text-key&nbsp;和&nbsp;value-key</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 17;
    $art = '=viewId';
    ;
