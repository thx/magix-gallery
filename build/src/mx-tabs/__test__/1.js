...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc5:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryc5:a" class="_zs_gallery___test___layout_-eg-content"><div mxv="list" mx-change="' + $viewId + 'changeTab()" mx-view="mx-tabs/index?list=';
    $line = 4;
    $art = '@list';
    ;
    ...
    $art = '=selected';
    ;
    $p += '' + ($expr = '<%!$eu(selected)%>', $eu(selected)) + '"></div><div mxa="_zs_galleryc5:b" class="mt20"><a mxs="_zs_galleryc5:_" href="javascript:;" class="btn btn-brand" mx-click="' + $viewId + 'changeData()">改变数据</a><span mxs="_zs_galleryc5:a" class="ml20 color-9">当前选中：</span><span>';
    $line = 10;
    $art = '=selected';
    ;
    $p += '' + ($expr = '<%=selected%>', $e(selected)) + '</span></div></div><div mxa="_zs_galleryc5:c" class="clearfix"><div mxa="_zs_galleryc5:d" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryc5:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
