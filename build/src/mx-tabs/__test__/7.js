...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryeV:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryeV:a" class="_zs_gallery___test___layout_-eg-content"><div mx-view="mx-tabs/box?mode=hollow&list=';
    $line = 5;
    $art = '@[{\n                text: \'模块1\',\n                value: 1,\n                tips: \'提示信息\'\n            },{\n                text: \'模块2\',\n                value: 2\n            },{\n                text: \'模块3\',\n                value: 3\n            }]';
    ;
    $p += ($expr = '<%@[{            text: \'模块1\',            value: 1,            tips: \'提示信息\'        }, {            text: \'模块2\',            value: 2        }, {            text: \'模块3\',            value: 3        }]%>', $i($$ref, [{ text: '模块1', value: 1, tips: '提示信息' }, { text: '模块2', value: 2 }, { text: '模块3', value: 3 }])) + '"></div></div><div mxa="_zs_galleryeV:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryeV:_" class="_zs_gallery___test___layout_-eg-title">自定义&nbsp;text-key&nbsp;和&nbsp;value-key</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 19;
    $art = '=viewId';
    ;
