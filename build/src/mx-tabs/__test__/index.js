...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxa="_zs_galleryeL:a" class="clearfix mb20"><div mxa="_zs_galleryeL:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-tabs/__test__/8" id="';
    $line = 30;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo8"></div></div><div mxa="_zs_galleryeL:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-tabs/__test__/2" id="';
    $line = 33;
    $art = '=viewId';
    ;
