...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxa="_zs_galleryey:a" class="clearfix mb20"><div mxa="_zs_galleryey:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-tabs/__test__/2" id="';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div></div><div mxa="_zs_galleryey:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-tabs/__test__/4" id="';
    $line = 30;
    $art = '=viewId';
    ;
