...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya1:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallerya1:_" class="_zs_gallery___test___base_-eg-content"><div class="pt10 pb10"><a rel="noopener noreferrer" href="#!/header/all" class="link-brand" target="_blank">新页面打开完整示例</a></div></div><div mxa="_zs_gallerya1:a" class="clearfix"><div mxa="_zs_gallerya1:b" class="_zs_gallery___test___base_-eg-desc _zs_gallery___test___base_-half"><div mxs="_zs_gallerya1:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerya1:c" class="_zs_gallery___test___base_-desc-tip">';
    $line = 12;
    $art = '!text1';
    ;
