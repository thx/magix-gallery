...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybl:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerybl:a" class="_zs_gallery___test___layout_-eg-content"><div id="';
    $line = 3;
    $art = '=viewId';
    ;
