...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryby:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryby:a" class="_zs_gallery___test___layout_-eg-content"><div id="';
    $line = 3;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_test"></div><div mxs="_zs_galleryby:_" class="_zs_gallery_mx-header___test___index_-inner"></div></div></div><div mxa="_zs_galleryby:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryby:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 19;
    $art = '=viewId';
    ;
