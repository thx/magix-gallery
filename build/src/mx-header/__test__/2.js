...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycq:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycq:a" class="_zs_gallery___test___layout_-eg-content"><div id="';
    $line = 3;
    $art = '=viewId';
    ;
