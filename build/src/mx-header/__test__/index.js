...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerybn:a" class="clearfix mb20"><div mx-view="mx-header/__test__/1" id="';
    $line = 20;
    $art = '=viewId';
    ;
