...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_capzvdol$art_c = list.length; index < $art_capzvdol$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_capzvdol$art_c = list.length; index < $art_capzvdol$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_idvgocksi$art_i = 0, $art_objcwhtstu$art_obj = item.seconds, $art_clkeyt$art_c = $art_objcwhtstu$art_obj.length; $art_idvgocksi$art_i < $art_clkeyt$art_c; $art_idvgocksi$art_i++) {        var second = $art_objcwhtstu$art_obj[$art_idvgocksi$art_i]%>';
        for (var $art_idvgocksi$art_i = 0, $art_objcwhtstu$art_obj = item.seconds, $art_clkeyt$art_c = $art_objcwhtstu$art_obj.length; $art_idvgocksi$art_i < $art_clkeyt$art_c; $art_idvgocksi$art_i++) {
            var second = $art_objcwhtstu$art_obj[$art_idvgocksi$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilctyqa$art_i = 0, $art_objjabml$art_obj = second.thirds, $art_crjbmrstnur$art_c = $art_objjabml$art_obj.length; $art_ilctyqa$art_i < $art_crjbmrstnur$art_c; $art_ilctyqa$art_i++) {            var third = $art_objjabml$art_obj[$art_ilctyqa$art_i]%>';
            for (var $art_ilctyqa$art_i = 0, $art_objjabml$art_obj = second.thirds, $art_crjbmrstnur$art_c = $art_objjabml$art_obj.length; $art_ilctyqa$art_i < $art_crjbmrstnur$art_c; $art_ilctyqa$art_i++) {
                var third = $art_objjabml$art_obj[$art_ilctyqa$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_ihxikakwj$art_i = 0, $art_ccmgly$art_c = navs.length; $art_ihxikakwj$art_i < $art_ccmgly$art_c; $art_ihxikakwj$art_i++) {    var nav = navs[$art_ihxikakwj$art_i]%>';
    for (var $art_ihxikakwj$art_i = 0, $art_ccmgly$art_c = navs.length; $art_ihxikakwj$art_i < $art_ccmgly$art_c; $art_ihxikakwj$art_i++) {
        var nav = navs[$art_ihxikakwj$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
