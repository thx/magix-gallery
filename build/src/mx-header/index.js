...
module.exports = Magix.View.extend({
    ...
    for (var index = 0; index < list.length; index++) {
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_iogeqvphzh$art_i=0,$art_objyjuhpqwv$art_obj=item.seconds;$art_iogeqvphzh$art_i<$art_objyjuhpqwv$art_obj.length;$art_iogeqvphzh$art_i++){var second=$art_objyjuhpqwv$art_obj[$art_iogeqvphzh$art_i]%>';
        for (var $art_iogeqvphzh$art_i = 0, $art_objyjuhpqwv$art_obj = item.seconds; $art_iogeqvphzh$art_i < $art_objyjuhpqwv$art_obj.length; $art_iogeqvphzh$art_i++) {
            var second = $art_objyjuhpqwv$art_obj[$art_iogeqvphzh$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_ieitpzqbw$art_i=0,$art_objrwyqaex$art_obj=second.thirds;$art_ieitpzqbw$art_i<$art_objrwyqaex$art_obj.length;$art_ieitpzqbw$art_i++){var third=$art_objrwyqaex$art_obj[$art_ieitpzqbw$art_i]%>';
            for (var $art_ieitpzqbw$art_i = 0, $art_objrwyqaex$art_obj = second.thirds; $art_ieitpzqbw$art_i < $art_objrwyqaex$art_obj.length; $art_ieitpzqbw$art_i++) {
                var third = $art_objrwyqaex$art_obj[$art_ieitpzqbw$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_idkmjdilmbo$art_i=0;$art_idkmjdilmbo$art_i<navs.length;$art_idkmjdilmbo$art_i++){var nav=navs[$art_idkmjdilmbo$art_i]%>';
    for (var $art_idkmjdilmbo$art_i = 0; $art_idkmjdilmbo$art_i < navs.length; $art_idkmjdilmbo$art_i++) {
        var nav = navs[$art_idkmjdilmbo$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
