...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cpvslzyiv$art_c = list.length; index < $art_cpvslzyiv$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cpvslzyiv$art_c = list.length; index < $art_cpvslzyiv$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iuikgsem$art_i = 0, $art_objefjnxkpm$art_obj = item.seconds, $art_cipumes$art_c = $art_objefjnxkpm$art_obj.length; $art_iuikgsem$art_i < $art_cipumes$art_c; $art_iuikgsem$art_i++) {        var second = $art_objefjnxkpm$art_obj[$art_iuikgsem$art_i]%>';
        for (var $art_iuikgsem$art_i = 0, $art_objefjnxkpm$art_obj = item.seconds, $art_cipumes$art_c = $art_objefjnxkpm$art_obj.length; $art_iuikgsem$art_i < $art_cipumes$art_c; $art_iuikgsem$art_i++) {
            var second = $art_objefjnxkpm$art_obj[$art_iuikgsem$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_inekilaqt$art_i = 0, $art_objvfgxlvyi$art_obj = second.thirds, $art_cngjbjhyip$art_c = $art_objvfgxlvyi$art_obj.length; $art_inekilaqt$art_i < $art_cngjbjhyip$art_c; $art_inekilaqt$art_i++) {            var third = $art_objvfgxlvyi$art_obj[$art_inekilaqt$art_i]%>';
            for (var $art_inekilaqt$art_i = 0, $art_objvfgxlvyi$art_obj = second.thirds, $art_cngjbjhyip$art_c = $art_objvfgxlvyi$art_obj.length; $art_inekilaqt$art_i < $art_cngjbjhyip$art_c; $art_inekilaqt$art_i++) {
                var third = $art_objvfgxlvyi$art_obj[$art_inekilaqt$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iufaqmnpvjs$art_i = 0, $art_ctzaijyuc$art_c = navs.length; $art_iufaqmnpvjs$art_i < $art_ctzaijyuc$art_c; $art_iufaqmnpvjs$art_i++) {    var nav = navs[$art_iufaqmnpvjs$art_i]%>';
    for (var $art_iufaqmnpvjs$art_i = 0, $art_ctzaijyuc$art_c = navs.length; $art_iufaqmnpvjs$art_i < $art_ctzaijyuc$art_c; $art_iufaqmnpvjs$art_i++) {
        var nav = navs[$art_iufaqmnpvjs$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
