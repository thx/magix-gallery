...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cvkxagcqj$art_c = list.length; index < $art_cvkxagcqj$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cvkxagcqj$art_c = list.length; index < $art_cvkxagcqj$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iasmnpdxxi$art_i = 0, $art_objzdzjyzj$art_obj = item.seconds, $art_cgnupqjcl$art_c = $art_objzdzjyzj$art_obj.length; $art_iasmnpdxxi$art_i < $art_cgnupqjcl$art_c; $art_iasmnpdxxi$art_i++) {        var second = $art_objzdzjyzj$art_obj[$art_iasmnpdxxi$art_i]%>';
        for (var $art_iasmnpdxxi$art_i = 0, $art_objzdzjyzj$art_obj = item.seconds, $art_cgnupqjcl$art_c = $art_objzdzjyzj$art_obj.length; $art_iasmnpdxxi$art_i < $art_cgnupqjcl$art_c; $art_iasmnpdxxi$art_i++) {
            var second = $art_objzdzjyzj$art_obj[$art_iasmnpdxxi$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqawzlhvhjh$art_i = 0, $art_objjtnixvxe$art_obj = second.thirds, $art_ccjlrvlv$art_c = $art_objjtnixvxe$art_obj.length; $art_iqawzlhvhjh$art_i < $art_ccjlrvlv$art_c; $art_iqawzlhvhjh$art_i++) {            var third = $art_objjtnixvxe$art_obj[$art_iqawzlhvhjh$art_i]%>';
            for (var $art_iqawzlhvhjh$art_i = 0, $art_objjtnixvxe$art_obj = second.thirds, $art_ccjlrvlv$art_c = $art_objjtnixvxe$art_obj.length; $art_iqawzlhvhjh$art_i < $art_ccjlrvlv$art_c; $art_iqawzlhvhjh$art_i++) {
                var third = $art_objjtnixvxe$art_obj[$art_iqawzlhvhjh$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iinayarflj$art_i = 0, $art_ceiecqljqbn$art_c = navs.length; $art_iinayarflj$art_i < $art_ceiecqljqbn$art_c; $art_iinayarflj$art_i++) {    var nav = navs[$art_iinayarflj$art_i]%>';
    for (var $art_iinayarflj$art_i = 0, $art_ceiecqljqbn$art_c = navs.length; $art_iinayarflj$art_i < $art_ceiecqljqbn$art_c; $art_iinayarflj$art_i++) {
        var nav = navs[$art_iinayarflj$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
