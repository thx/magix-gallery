...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cnmavhh$art_c = list.length; index < $art_cnmavhh$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cnmavhh$art_c = list.length; index < $art_cnmavhh$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_igpiocsbcu$art_i = 0, $art_objsztaiszq$art_obj = item.seconds, $art_cuysitf$art_c = $art_objsztaiszq$art_obj.length; $art_igpiocsbcu$art_i < $art_cuysitf$art_c; $art_igpiocsbcu$art_i++) {        var second = $art_objsztaiszq$art_obj[$art_igpiocsbcu$art_i]%>';
        for (var $art_igpiocsbcu$art_i = 0, $art_objsztaiszq$art_obj = item.seconds, $art_cuysitf$art_c = $art_objsztaiszq$art_obj.length; $art_igpiocsbcu$art_i < $art_cuysitf$art_c; $art_igpiocsbcu$art_i++) {
            var second = $art_objsztaiszq$art_obj[$art_igpiocsbcu$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iuvazpqqzo$art_i = 0, $art_objyijzrgifo$art_obj = second.thirds, $art_ckordnemf$art_c = $art_objyijzrgifo$art_obj.length; $art_iuvazpqqzo$art_i < $art_ckordnemf$art_c; $art_iuvazpqqzo$art_i++) {            var third = $art_objyijzrgifo$art_obj[$art_iuvazpqqzo$art_i]%>';
            for (var $art_iuvazpqqzo$art_i = 0, $art_objyijzrgifo$art_obj = second.thirds, $art_ckordnemf$art_c = $art_objyijzrgifo$art_obj.length; $art_iuvazpqqzo$art_i < $art_ckordnemf$art_c; $art_iuvazpqqzo$art_i++) {
                var third = $art_objyijzrgifo$art_obj[$art_iuvazpqqzo$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ifkygwrpj$art_i = 0, $art_cqywpgrk$art_c = navs.length; $art_ifkygwrpj$art_i < $art_cqywpgrk$art_c; $art_ifkygwrpj$art_i++) {        var nav = navs[$art_ifkygwrpj$art_i]%>';
        for (var $art_ifkygwrpj$art_i = 0, $art_cqywpgrk$art_c = navs.length; $art_ifkygwrpj$art_i < $art_cqywpgrk$art_c; $art_ifkygwrpj$art_i++) {
            var nav = navs[$art_ifkygwrpj$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
