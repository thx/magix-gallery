...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cglizljqljh$art_c = list.length; index < $art_cglizljqljh$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cglizljqljh$art_c = list.length; index < $art_cglizljqljh$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_irtqsjypgc$art_i = 0, $art_objvpdyreske$art_obj = item.seconds, $art_cxsoivi$art_c = $art_objvpdyreske$art_obj.length; $art_irtqsjypgc$art_i < $art_cxsoivi$art_c; $art_irtqsjypgc$art_i++) {        var second = $art_objvpdyreske$art_obj[$art_irtqsjypgc$art_i]%>';
        for (var $art_irtqsjypgc$art_i = 0, $art_objvpdyreske$art_obj = item.seconds, $art_cxsoivi$art_c = $art_objvpdyreske$art_obj.length; $art_irtqsjypgc$art_i < $art_cxsoivi$art_c; $art_irtqsjypgc$art_i++) {
            var second = $art_objvpdyreske$art_obj[$art_irtqsjypgc$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilodarqyx$art_i = 0, $art_objfzvttsd$art_obj = second.thirds, $art_cthiwrdnkg$art_c = $art_objfzvttsd$art_obj.length; $art_ilodarqyx$art_i < $art_cthiwrdnkg$art_c; $art_ilodarqyx$art_i++) {            var third = $art_objfzvttsd$art_obj[$art_ilodarqyx$art_i]%>';
            for (var $art_ilodarqyx$art_i = 0, $art_objfzvttsd$art_obj = second.thirds, $art_cthiwrdnkg$art_c = $art_objfzvttsd$art_obj.length; $art_ilodarqyx$art_i < $art_cthiwrdnkg$art_c; $art_ilodarqyx$art_i++) {
                var third = $art_objfzvttsd$art_obj[$art_ilodarqyx$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iciqwixb$art_i = 0, $art_cqfharo$art_c = navs.length; $art_iciqwixb$art_i < $art_cqfharo$art_c; $art_iciqwixb$art_i++) {        var nav = navs[$art_iciqwixb$art_i]%>';
        for (var $art_iciqwixb$art_i = 0, $art_cqfharo$art_c = navs.length; $art_iciqwixb$art_i < $art_cqfharo$art_c; $art_iciqwixb$art_i++) {
            var nav = navs[$art_iciqwixb$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
