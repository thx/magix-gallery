...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_clfhtevq$art_c = list.length; index < $art_clfhtevq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_clfhtevq$art_c = list.length; index < $art_clfhtevq$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iasvacrlu$art_i = 0, $art_objyhwkmewq$art_obj = item.seconds, $art_cgevbzeaa$art_c = $art_objyhwkmewq$art_obj.length; $art_iasvacrlu$art_i < $art_cgevbzeaa$art_c; $art_iasvacrlu$art_i++) {        var second = $art_objyhwkmewq$art_obj[$art_iasvacrlu$art_i]%>';
        for (var $art_iasvacrlu$art_i = 0, $art_objyhwkmewq$art_obj = item.seconds, $art_cgevbzeaa$art_c = $art_objyhwkmewq$art_obj.length; $art_iasvacrlu$art_i < $art_cgevbzeaa$art_c; $art_iasvacrlu$art_i++) {
            var second = $art_objyhwkmewq$art_obj[$art_iasvacrlu$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_idkpmjoxv$art_i = 0, $art_objindrdkd$art_obj = second.thirds, $art_coijxcgqp$art_c = $art_objindrdkd$art_obj.length; $art_idkpmjoxv$art_i < $art_coijxcgqp$art_c; $art_idkpmjoxv$art_i++) {            var third = $art_objindrdkd$art_obj[$art_idkpmjoxv$art_i]%>';
            for (var $art_idkpmjoxv$art_i = 0, $art_objindrdkd$art_obj = second.thirds, $art_coijxcgqp$art_c = $art_objindrdkd$art_obj.length; $art_idkpmjoxv$art_i < $art_coijxcgqp$art_c; $art_idkpmjoxv$art_i++) {
                var third = $art_objindrdkd$art_obj[$art_idkpmjoxv$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iycyqvddop$art_i = 0, $art_ccwsvbvwul$art_c = navs.length; $art_iycyqvddop$art_i < $art_ccwsvbvwul$art_c; $art_iycyqvddop$art_i++) {    var nav = navs[$art_iycyqvddop$art_i]%>';
    for (var $art_iycyqvddop$art_i = 0, $art_ccwsvbvwul$art_c = navs.length; $art_iycyqvddop$art_i < $art_ccwsvbvwul$art_c; $art_iycyqvddop$art_i++) {
        var nav = navs[$art_iycyqvddop$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
