...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ciffrzt$art_c = list.length; index < $art_ciffrzt$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ciffrzt$art_c = list.length; index < $art_ciffrzt$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_irgglfie$art_i = 0, $art_objuroaefezk$art_obj = item.seconds, $art_cwausqgtpk$art_c = $art_objuroaefezk$art_obj.length; $art_irgglfie$art_i < $art_cwausqgtpk$art_c; $art_irgglfie$art_i++) {        var second = $art_objuroaefezk$art_obj[$art_irgglfie$art_i]%>';
        for (var $art_irgglfie$art_i = 0, $art_objuroaefezk$art_obj = item.seconds, $art_cwausqgtpk$art_c = $art_objuroaefezk$art_obj.length; $art_irgglfie$art_i < $art_cwausqgtpk$art_c; $art_irgglfie$art_i++) {
            var second = $art_objuroaefezk$art_obj[$art_irgglfie$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ixglltom$art_i = 0, $art_objubwdy$art_obj = second.thirds, $art_cipvmchp$art_c = $art_objubwdy$art_obj.length; $art_ixglltom$art_i < $art_cipvmchp$art_c; $art_ixglltom$art_i++) {            var third = $art_objubwdy$art_obj[$art_ixglltom$art_i]%>';
            for (var $art_ixglltom$art_i = 0, $art_objubwdy$art_obj = second.thirds, $art_cipvmchp$art_c = $art_objubwdy$art_obj.length; $art_ixglltom$art_i < $art_cipvmchp$art_c; $art_ixglltom$art_i++) {
                var third = $art_objubwdy$art_obj[$art_ixglltom$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iqvubboou$art_i = 0, $art_cmehkzqc$art_c = navs.length; $art_iqvubboou$art_i < $art_cmehkzqc$art_c; $art_iqvubboou$art_i++) {        var nav = navs[$art_iqvubboou$art_i]%>';
        for (var $art_iqvubboou$art_i = 0, $art_cmehkzqc$art_c = navs.length; $art_iqvubboou$art_i < $art_cmehkzqc$art_c; $art_iqvubboou$art_i++) {
            var nav = navs[$art_iqvubboou$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
