...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_crvwqqnrk$art_c = list.length; index < $art_crvwqqnrk$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_crvwqqnrk$art_c = list.length; index < $art_crvwqqnrk$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iryonxtj$art_i = 0, $art_objoblgbjhunr$art_obj = item.seconds, $art_clnxrnwv$art_c = $art_objoblgbjhunr$art_obj.length; $art_iryonxtj$art_i < $art_clnxrnwv$art_c; $art_iryonxtj$art_i++) {        var second = $art_objoblgbjhunr$art_obj[$art_iryonxtj$art_i]%>';
        for (var $art_iryonxtj$art_i = 0, $art_objoblgbjhunr$art_obj = item.seconds, $art_clnxrnwv$art_c = $art_objoblgbjhunr$art_obj.length; $art_iryonxtj$art_i < $art_clnxrnwv$art_c; $art_iryonxtj$art_i++) {
            var second = $art_objoblgbjhunr$art_obj[$art_iryonxtj$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iulkikiia$art_i = 0, $art_objzfhmvfu$art_obj = second.thirds, $art_ctkdf$art_c = $art_objzfhmvfu$art_obj.length; $art_iulkikiia$art_i < $art_ctkdf$art_c; $art_iulkikiia$art_i++) {            var third = $art_objzfhmvfu$art_obj[$art_iulkikiia$art_i]%>';
            for (var $art_iulkikiia$art_i = 0, $art_objzfhmvfu$art_obj = second.thirds, $art_ctkdf$art_c = $art_objzfhmvfu$art_obj.length; $art_iulkikiia$art_i < $art_ctkdf$art_c; $art_iulkikiia$art_i++) {
                var third = $art_objzfhmvfu$art_obj[$art_iulkikiia$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ilwamvyboe$art_i = 0, $art_cuxmxbogai$art_c = navs.length; $art_ilwamvyboe$art_i < $art_cuxmxbogai$art_c; $art_ilwamvyboe$art_i++) {        var nav = navs[$art_ilwamvyboe$art_i]%>';
        for (var $art_ilwamvyboe$art_i = 0, $art_cuxmxbogai$art_c = navs.length; $art_ilwamvyboe$art_i < $art_cuxmxbogai$art_c; $art_ilwamvyboe$art_i++) {
            var nav = navs[$art_ilwamvyboe$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
