...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerycB:_" class="_zs_gallery_mx-header_index_-header"><div class="_zs_gallery_mx-header_index_-others clearfix" style="width: ';
    $line = 2;
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_gallerycB:_" class="fl mr35"><a class="_zs_gallery_mx-header_index_-text _zs_gallery_mx-header_index_-text-h-brand" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
    $line = 6;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_chicilntus$art_c = list.length; index < $art_chicilntus$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_chicilntus$art_c = list.length; index < $art_chicilntus$art_c; index++) {
        var item = list[index];
        ...
        $art = '=index';
        ;
        $p += ($expr = '<%=index%>', $e(index)) + ',height:0})"><span mxa="_zs_gallerycB:a" class="_zs_gallery_mx-header_index_-text">';
        $line = 10;
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_gallerycB:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links ';
        $line = 12;
        ...
        ;
        $expr = '<%for (var $art_issxsdj$art_i = 0, $art_objqsrblfk$art_obj = item.seconds, $art_cwrviccjyl$art_c = $art_objqsrblfk$art_obj.length; $art_issxsdj$art_i < $art_cwrviccjyl$art_c; $art_issxsdj$art_i++) {        var second = $art_objqsrblfk$art_obj[$art_issxsdj$art_i]%>';
        for (var $art_issxsdj$art_i = 0, $art_objqsrblfk$art_obj = item.seconds, $art_cwrviccjyl$art_c = $art_objqsrblfk$art_obj.length; $art_issxsdj$art_i < $art_cwrviccjyl$art_c; $art_issxsdj$art_i++) {
            var second = $art_objqsrblfk$art_obj[$art_issxsdj$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iyjdypzlk$art_i = 0, $art_objvlyuymag$art_obj = second.thirds, $art_chjwfrdurjtn$art_c = $art_objvlyuymag$art_obj.length; $art_iyjdypzlk$art_i < $art_chjwfrdurjtn$art_c; $art_iyjdypzlk$art_i++) {            var third = $art_objvlyuymag$art_obj[$art_iyjdypzlk$art_i]%>';
            for (var $art_iyjdypzlk$art_i = 0, $art_objvlyuymag$art_obj = second.thirds, $art_chjwfrdurjtn$art_c = $art_objvlyuymag$art_obj.length; $art_iyjdypzlk$art_i < $art_chjwfrdurjtn$art_c; $art_iyjdypzlk$art_i++) {
                var third = $art_objvlyuymag$art_obj[$art_iyjdypzlk$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxa="_zs_gallerycB:b" class="_zs_gallery_mx-header_index_-logo"><img src="';
    $line = 30;
    $art = '=logo';
    ;
    ...
    if (navs.length > 0) {
        ;
        $p += '<div mxa="_zs_gallerycB:c" class="_zs_gallery_mx-header_index_-navs">';
        $line = 34;
        $art = 'each navs as nav';
        ;
        $expr = '<%for (var $art_ihhnimixqkxv$art_i = 0, $art_cjyivbpjwys$art_c = navs.length; $art_ihhnimixqkxv$art_i < $art_cjyivbpjwys$art_c; $art_ihhnimixqkxv$art_i++) {        var nav = navs[$art_ihhnimixqkxv$art_i]%>';
        for (var $art_ihhnimixqkxv$art_i = 0, $art_cjyivbpjwys$art_c = navs.length; $art_ihhnimixqkxv$art_i < $art_cjyivbpjwys$art_c; $art_ihhnimixqkxv$art_i++) {
            var nav = navs[$art_ihhnimixqkxv$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
