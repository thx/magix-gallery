...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cidsvuo$art_c = list.length; index < $art_cidsvuo$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cidsvuo$art_c = list.length; index < $art_cidsvuo$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_isdqstbsvp$art_i = 0, $art_objxpfqq$art_obj = item.seconds, $art_cwbddomls$art_c = $art_objxpfqq$art_obj.length; $art_isdqstbsvp$art_i < $art_cwbddomls$art_c; $art_isdqstbsvp$art_i++) {        var second = $art_objxpfqq$art_obj[$art_isdqstbsvp$art_i]%>';
        for (var $art_isdqstbsvp$art_i = 0, $art_objxpfqq$art_obj = item.seconds, $art_cwbddomls$art_c = $art_objxpfqq$art_obj.length; $art_isdqstbsvp$art_i < $art_cwbddomls$art_c; $art_isdqstbsvp$art_i++) {
            var second = $art_objxpfqq$art_obj[$art_isdqstbsvp$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_insxooxhgrl$art_i = 0, $art_objwspyqqt$art_obj = second.thirds, $art_cmmobfir$art_c = $art_objwspyqqt$art_obj.length; $art_insxooxhgrl$art_i < $art_cmmobfir$art_c; $art_insxooxhgrl$art_i++) {            var third = $art_objwspyqqt$art_obj[$art_insxooxhgrl$art_i]%>';
            for (var $art_insxooxhgrl$art_i = 0, $art_objwspyqqt$art_obj = second.thirds, $art_cmmobfir$art_c = $art_objwspyqqt$art_obj.length; $art_insxooxhgrl$art_i < $art_cmmobfir$art_c; $art_insxooxhgrl$art_i++) {
                var third = $art_objwspyqqt$art_obj[$art_insxooxhgrl$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_izsbtdsqg$art_i = 0, $art_caqvacjgkq$art_c = navs.length; $art_izsbtdsqg$art_i < $art_caqvacjgkq$art_c; $art_izsbtdsqg$art_i++) {    var nav = navs[$art_izsbtdsqg$art_i]%>';
    for (var $art_izsbtdsqg$art_i = 0, $art_caqvacjgkq$art_c = navs.length; $art_izsbtdsqg$art_i < $art_caqvacjgkq$art_c; $art_izsbtdsqg$art_i++) {
        var nav = navs[$art_izsbtdsqg$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
