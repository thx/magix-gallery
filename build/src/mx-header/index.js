...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_czvmslypz$art_c = list.length; index < $art_czvmslypz$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_czvmslypz$art_c = list.length; index < $art_czvmslypz$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ixwlwzahzy$art_i = 0, $art_objnsaqisv$art_obj = item.seconds, $art_cisftdne$art_c = $art_objnsaqisv$art_obj.length; $art_ixwlwzahzy$art_i < $art_cisftdne$art_c; $art_ixwlwzahzy$art_i++) {        var second = $art_objnsaqisv$art_obj[$art_ixwlwzahzy$art_i]%>';
        for (var $art_ixwlwzahzy$art_i = 0, $art_objnsaqisv$art_obj = item.seconds, $art_cisftdne$art_c = $art_objnsaqisv$art_obj.length; $art_ixwlwzahzy$art_i < $art_cisftdne$art_c; $art_ixwlwzahzy$art_i++) {
            var second = $art_objnsaqisv$art_obj[$art_ixwlwzahzy$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_irdhukioqak$art_i = 0, $art_objyblkfg$art_obj = second.thirds, $art_cbiyymey$art_c = $art_objyblkfg$art_obj.length; $art_irdhukioqak$art_i < $art_cbiyymey$art_c; $art_irdhukioqak$art_i++) {            var third = $art_objyblkfg$art_obj[$art_irdhukioqak$art_i]%>';
            for (var $art_irdhukioqak$art_i = 0, $art_objyblkfg$art_obj = second.thirds, $art_cbiyymey$art_c = $art_objyblkfg$art_obj.length; $art_irdhukioqak$art_i < $art_cbiyymey$art_c; $art_irdhukioqak$art_i++) {
                var third = $art_objyblkfg$art_obj[$art_irdhukioqak$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iwxssqpcs$art_i = 0, $art_cljjsjwwuv$art_c = navs.length; $art_iwxssqpcs$art_i < $art_cljjsjwwuv$art_c; $art_iwxssqpcs$art_i++) {    var nav = navs[$art_iwxssqpcs$art_i]%>';
    for (var $art_iwxssqpcs$art_i = 0, $art_cljjsjwwuv$art_c = navs.length; $art_iwxssqpcs$art_i < $art_cljjsjwwuv$art_c; $art_iwxssqpcs$art_i++) {
        var nav = navs[$art_iwxssqpcs$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
