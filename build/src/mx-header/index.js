...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cyjgo$art_c = list.length; index < $art_cyjgo$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cyjgo$art_c = list.length; index < $art_cyjgo$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iikkybbazr$art_i = 0, $art_objejyayzo$art_obj = item.seconds, $art_cgvgeqnef$art_c = $art_objejyayzo$art_obj.length; $art_iikkybbazr$art_i < $art_cgvgeqnef$art_c; $art_iikkybbazr$art_i++) {        var second = $art_objejyayzo$art_obj[$art_iikkybbazr$art_i]%>';
        for (var $art_iikkybbazr$art_i = 0, $art_objejyayzo$art_obj = item.seconds, $art_cgvgeqnef$art_c = $art_objejyayzo$art_obj.length; $art_iikkybbazr$art_i < $art_cgvgeqnef$art_c; $art_iikkybbazr$art_i++) {
            var second = $art_objejyayzo$art_obj[$art_iikkybbazr$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ihobjnfny$art_i = 0, $art_objmglghszl$art_obj = second.thirds, $art_cpydjzslq$art_c = $art_objmglghszl$art_obj.length; $art_ihobjnfny$art_i < $art_cpydjzslq$art_c; $art_ihobjnfny$art_i++) {            var third = $art_objmglghszl$art_obj[$art_ihobjnfny$art_i]%>';
            for (var $art_ihobjnfny$art_i = 0, $art_objmglghszl$art_obj = second.thirds, $art_cpydjzslq$art_c = $art_objmglghszl$art_obj.length; $art_ihobjnfny$art_i < $art_cpydjzslq$art_c; $art_ihobjnfny$art_i++) {
                var third = $art_objmglghszl$art_obj[$art_ihobjnfny$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iyjqhdzxic$art_i = 0, $art_cgggirqu$art_c = navs.length; $art_iyjqhdzxic$art_i < $art_cgggirqu$art_c; $art_iyjqhdzxic$art_i++) {        var nav = navs[$art_iyjqhdzxic$art_i]%>';
        for (var $art_iyjqhdzxic$art_i = 0, $art_cgggirqu$art_c = navs.length; $art_iyjqhdzxic$art_i < $art_cgggirqu$art_c; $art_iyjqhdzxic$art_i++) {
            var nav = navs[$art_iyjqhdzxic$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
