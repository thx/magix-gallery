...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cxnjithl$art_c = list.length; index < $art_cxnjithl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cxnjithl$art_c = list.length; index < $art_cxnjithl$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ihovmxyhj$art_i = 0, $art_objtitkpbhn$art_obj = item.seconds, $art_cxlptgxq$art_c = $art_objtitkpbhn$art_obj.length; $art_ihovmxyhj$art_i < $art_cxlptgxq$art_c; $art_ihovmxyhj$art_i++) {        var second = $art_objtitkpbhn$art_obj[$art_ihovmxyhj$art_i]%>';
        for (var $art_ihovmxyhj$art_i = 0, $art_objtitkpbhn$art_obj = item.seconds, $art_cxlptgxq$art_c = $art_objtitkpbhn$art_obj.length; $art_ihovmxyhj$art_i < $art_cxlptgxq$art_c; $art_ihovmxyhj$art_i++) {
            var second = $art_objtitkpbhn$art_obj[$art_ihovmxyhj$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqnmycqok$art_i = 0, $art_objcjyfcuj$art_obj = second.thirds, $art_cyhtfjf$art_c = $art_objcjyfcuj$art_obj.length; $art_iqnmycqok$art_i < $art_cyhtfjf$art_c; $art_iqnmycqok$art_i++) {            var third = $art_objcjyfcuj$art_obj[$art_iqnmycqok$art_i]%>';
            for (var $art_iqnmycqok$art_i = 0, $art_objcjyfcuj$art_obj = second.thirds, $art_cyhtfjf$art_c = $art_objcjyfcuj$art_obj.length; $art_iqnmycqok$art_i < $art_cyhtfjf$art_c; $art_iqnmycqok$art_i++) {
                var third = $art_objcjyfcuj$art_obj[$art_iqnmycqok$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ioefvlykb$art_i = 0, $art_cdrdirq$art_c = navs.length; $art_ioefvlykb$art_i < $art_cdrdirq$art_c; $art_ioefvlykb$art_i++) {        var nav = navs[$art_ioefvlykb$art_i]%>';
        for (var $art_ioefvlykb$art_i = 0, $art_cdrdirq$art_c = navs.length; $art_ioefvlykb$art_i < $art_cdrdirq$art_c; $art_ioefvlykb$art_i++) {
            var nav = navs[$art_ioefvlykb$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
