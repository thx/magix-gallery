...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_crysrenck$art_c = list.length; index < $art_crysrenck$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_crysrenck$art_c = list.length; index < $art_crysrenck$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iwultcioonim$art_i = 0, $art_objmwrkdrtgs$art_obj = item.seconds, $art_cymbdzpq$art_c = $art_objmwrkdrtgs$art_obj.length; $art_iwultcioonim$art_i < $art_cymbdzpq$art_c; $art_iwultcioonim$art_i++) {        var second = $art_objmwrkdrtgs$art_obj[$art_iwultcioonim$art_i]%>';
        for (var $art_iwultcioonim$art_i = 0, $art_objmwrkdrtgs$art_obj = item.seconds, $art_cymbdzpq$art_c = $art_objmwrkdrtgs$art_obj.length; $art_iwultcioonim$art_i < $art_cymbdzpq$art_c; $art_iwultcioonim$art_i++) {
            var second = $art_objmwrkdrtgs$art_obj[$art_iwultcioonim$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ivxysbyvj$art_i = 0, $art_objomwfbpyh$art_obj = second.thirds, $art_cthluoruo$art_c = $art_objomwfbpyh$art_obj.length; $art_ivxysbyvj$art_i < $art_cthluoruo$art_c; $art_ivxysbyvj$art_i++) {            var third = $art_objomwfbpyh$art_obj[$art_ivxysbyvj$art_i]%>';
            for (var $art_ivxysbyvj$art_i = 0, $art_objomwfbpyh$art_obj = second.thirds, $art_cthluoruo$art_c = $art_objomwfbpyh$art_obj.length; $art_ivxysbyvj$art_i < $art_cthluoruo$art_c; $art_ivxysbyvj$art_i++) {
                var third = $art_objomwfbpyh$art_obj[$art_ivxysbyvj$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iqsphyc$art_i = 0, $art_cgrpitj$art_c = navs.length; $art_iqsphyc$art_i < $art_cgrpitj$art_c; $art_iqsphyc$art_i++) {        var nav = navs[$art_iqsphyc$art_i]%>';
        for (var $art_iqsphyc$art_i = 0, $art_cgrpitj$art_c = navs.length; $art_iqsphyc$art_i < $art_cgrpitj$art_c; $art_iqsphyc$art_i++) {
            var nav = navs[$art_iqsphyc$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
