...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_choflcc$art_c = list.length; index < $art_choflcc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_choflcc$art_c = list.length; index < $art_choflcc$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_inydindnu$art_i = 0, $art_objfplefnr$art_obj = item.seconds, $art_crzqyhww$art_c = $art_objfplefnr$art_obj.length; $art_inydindnu$art_i < $art_crzqyhww$art_c; $art_inydindnu$art_i++) {        var second = $art_objfplefnr$art_obj[$art_inydindnu$art_i]%>';
        for (var $art_inydindnu$art_i = 0, $art_objfplefnr$art_obj = item.seconds, $art_crzqyhww$art_c = $art_objfplefnr$art_obj.length; $art_inydindnu$art_i < $art_crzqyhww$art_c; $art_inydindnu$art_i++) {
            var second = $art_objfplefnr$art_obj[$art_inydindnu$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iyxyjgkn$art_i = 0, $art_objbkmwzsj$art_obj = second.thirds, $art_cjvudm$art_c = $art_objbkmwzsj$art_obj.length; $art_iyxyjgkn$art_i < $art_cjvudm$art_c; $art_iyxyjgkn$art_i++) {            var third = $art_objbkmwzsj$art_obj[$art_iyxyjgkn$art_i]%>';
            for (var $art_iyxyjgkn$art_i = 0, $art_objbkmwzsj$art_obj = second.thirds, $art_cjvudm$art_c = $art_objbkmwzsj$art_obj.length; $art_iyxyjgkn$art_i < $art_cjvudm$art_c; $art_iyxyjgkn$art_i++) {
                var third = $art_objbkmwzsj$art_obj[$art_iyxyjgkn$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_imycurykm$art_i = 0, $art_cnaebubsr$art_c = navs.length; $art_imycurykm$art_i < $art_cnaebubsr$art_c; $art_imycurykm$art_i++) {    var nav = navs[$art_imycurykm$art_i]%>';
    for (var $art_imycurykm$art_i = 0, $art_cnaebubsr$art_c = navs.length; $art_imycurykm$art_i < $art_cnaebubsr$art_c; $art_imycurykm$art_i++) {
        var nav = navs[$art_imycurykm$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
