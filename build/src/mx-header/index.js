...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cakwstdlh$art_c = list.length; index < $art_cakwstdlh$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cakwstdlh$art_c = list.length; index < $art_cakwstdlh$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iqqdwbkq$art_i = 0, $art_objfnmrort$art_obj = item.seconds, $art_cdcnazzqtd$art_c = $art_objfnmrort$art_obj.length; $art_iqqdwbkq$art_i < $art_cdcnazzqtd$art_c; $art_iqqdwbkq$art_i++) {        var second = $art_objfnmrort$art_obj[$art_iqqdwbkq$art_i]%>';
        for (var $art_iqqdwbkq$art_i = 0, $art_objfnmrort$art_obj = item.seconds, $art_cdcnazzqtd$art_c = $art_objfnmrort$art_obj.length; $art_iqqdwbkq$art_i < $art_cdcnazzqtd$art_c; $art_iqqdwbkq$art_i++) {
            var second = $art_objfnmrort$art_obj[$art_iqqdwbkq$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilevmo$art_i = 0, $art_objjvyqgygdb$art_obj = second.thirds, $art_cwmwwa$art_c = $art_objjvyqgygdb$art_obj.length; $art_ilevmo$art_i < $art_cwmwwa$art_c; $art_ilevmo$art_i++) {            var third = $art_objjvyqgygdb$art_obj[$art_ilevmo$art_i]%>';
            for (var $art_ilevmo$art_i = 0, $art_objjvyqgygdb$art_obj = second.thirds, $art_cwmwwa$art_c = $art_objjvyqgygdb$art_obj.length; $art_ilevmo$art_i < $art_cwmwwa$art_c; $art_ilevmo$art_i++) {
                var third = $art_objjvyqgygdb$art_obj[$art_ilevmo$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iibhqelerg$art_i = 0, $art_ccwwhibb$art_c = navs.length; $art_iibhqelerg$art_i < $art_ccwwhibb$art_c; $art_iibhqelerg$art_i++) {        var nav = navs[$art_iibhqelerg$art_i]%>';
        for (var $art_iibhqelerg$art_i = 0, $art_ccwwhibb$art_c = navs.length; $art_iibhqelerg$art_i < $art_ccwwhibb$art_c; $art_iibhqelerg$art_i++) {
            var nav = navs[$art_iibhqelerg$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
