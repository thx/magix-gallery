...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cdxhwhtes$art_c = list.length; index < $art_cdxhwhtes$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cdxhwhtes$art_c = list.length; index < $art_cdxhwhtes$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_izdlvvk$art_i = 0, $art_objjbhrjfcd$art_obj = item.seconds, $art_cazihnitp$art_c = $art_objjbhrjfcd$art_obj.length; $art_izdlvvk$art_i < $art_cazihnitp$art_c; $art_izdlvvk$art_i++) {        var second = $art_objjbhrjfcd$art_obj[$art_izdlvvk$art_i]%>';
        for (var $art_izdlvvk$art_i = 0, $art_objjbhrjfcd$art_obj = item.seconds, $art_cazihnitp$art_c = $art_objjbhrjfcd$art_obj.length; $art_izdlvvk$art_i < $art_cazihnitp$art_c; $art_izdlvvk$art_i++) {
            var second = $art_objjbhrjfcd$art_obj[$art_izdlvvk$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_igsyujj$art_i = 0, $art_objhzuvumd$art_obj = second.thirds, $art_cwlqswdph$art_c = $art_objhzuvumd$art_obj.length; $art_igsyujj$art_i < $art_cwlqswdph$art_c; $art_igsyujj$art_i++) {            var third = $art_objhzuvumd$art_obj[$art_igsyujj$art_i]%>';
            for (var $art_igsyujj$art_i = 0, $art_objhzuvumd$art_obj = second.thirds, $art_cwlqswdph$art_c = $art_objhzuvumd$art_obj.length; $art_igsyujj$art_i < $art_cwlqswdph$art_c; $art_igsyujj$art_i++) {
                var third = $art_objhzuvumd$art_obj[$art_igsyujj$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ioimjktg$art_i = 0, $art_ctsrjmwmsmx$art_c = navs.length; $art_ioimjktg$art_i < $art_ctsrjmwmsmx$art_c; $art_ioimjktg$art_i++) {        var nav = navs[$art_ioimjktg$art_i]%>';
        for (var $art_ioimjktg$art_i = 0, $art_ctsrjmwmsmx$art_c = navs.length; $art_ioimjktg$art_i < $art_ctsrjmwmsmx$art_c; $art_ioimjktg$art_i++) {
            var nav = navs[$art_ioimjktg$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
