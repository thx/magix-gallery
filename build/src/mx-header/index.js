...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cppmntn$art_c = list.length; index < $art_cppmntn$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cppmntn$art_c = list.length; index < $art_cppmntn$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ijzmmrki$art_i = 0, $art_objqnzxsgxd$art_obj = item.seconds, $art_cpzyyv$art_c = $art_objqnzxsgxd$art_obj.length; $art_ijzmmrki$art_i < $art_cpzyyv$art_c; $art_ijzmmrki$art_i++) {        var second = $art_objqnzxsgxd$art_obj[$art_ijzmmrki$art_i]%>';
        for (var $art_ijzmmrki$art_i = 0, $art_objqnzxsgxd$art_obj = item.seconds, $art_cpzyyv$art_c = $art_objqnzxsgxd$art_obj.length; $art_ijzmmrki$art_i < $art_cpzyyv$art_c; $art_ijzmmrki$art_i++) {
            var second = $art_objqnzxsgxd$art_obj[$art_ijzmmrki$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iblxzrar$art_i = 0, $art_objrmwpmnj$art_obj = second.thirds, $art_cbcqtgz$art_c = $art_objrmwpmnj$art_obj.length; $art_iblxzrar$art_i < $art_cbcqtgz$art_c; $art_iblxzrar$art_i++) {            var third = $art_objrmwpmnj$art_obj[$art_iblxzrar$art_i]%>';
            for (var $art_iblxzrar$art_i = 0, $art_objrmwpmnj$art_obj = second.thirds, $art_cbcqtgz$art_c = $art_objrmwpmnj$art_obj.length; $art_iblxzrar$art_i < $art_cbcqtgz$art_c; $art_iblxzrar$art_i++) {
                var third = $art_objrmwpmnj$art_obj[$art_iblxzrar$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_irkrtmqhfic$art_i = 0, $art_cmebgoeouh$art_c = navs.length; $art_irkrtmqhfic$art_i < $art_cmebgoeouh$art_c; $art_irkrtmqhfic$art_i++) {    var nav = navs[$art_irkrtmqhfic$art_i]%>';
    for (var $art_irkrtmqhfic$art_i = 0, $art_cmebgoeouh$art_c = navs.length; $art_irkrtmqhfic$art_i < $art_cmebgoeouh$art_c; $art_irkrtmqhfic$art_i++) {
        var nav = navs[$art_irkrtmqhfic$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
