...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cktlrofe$art_c = list.length; index < $art_cktlrofe$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cktlrofe$art_c = list.length; index < $art_cktlrofe$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ignyuo$art_i = 0, $art_objtqwwlr$art_obj = item.seconds, $art_cfnqkucrimv$art_c = $art_objtqwwlr$art_obj.length; $art_ignyuo$art_i < $art_cfnqkucrimv$art_c; $art_ignyuo$art_i++) {        var second = $art_objtqwwlr$art_obj[$art_ignyuo$art_i]%>';
        for (var $art_ignyuo$art_i = 0, $art_objtqwwlr$art_obj = item.seconds, $art_cfnqkucrimv$art_c = $art_objtqwwlr$art_obj.length; $art_ignyuo$art_i < $art_cfnqkucrimv$art_c; $art_ignyuo$art_i++) {
            var second = $art_objtqwwlr$art_obj[$art_ignyuo$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ixjkkncouze$art_i = 0, $art_objmpdnlsvas$art_obj = second.thirds, $art_cpewizqjz$art_c = $art_objmpdnlsvas$art_obj.length; $art_ixjkkncouze$art_i < $art_cpewizqjz$art_c; $art_ixjkkncouze$art_i++) {            var third = $art_objmpdnlsvas$art_obj[$art_ixjkkncouze$art_i]%>';
            for (var $art_ixjkkncouze$art_i = 0, $art_objmpdnlsvas$art_obj = second.thirds, $art_cpewizqjz$art_c = $art_objmpdnlsvas$art_obj.length; $art_ixjkkncouze$art_i < $art_cpewizqjz$art_c; $art_ixjkkncouze$art_i++) {
                var third = $art_objmpdnlsvas$art_obj[$art_ixjkkncouze$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ieanrlec$art_i = 0, $art_cezduqprd$art_c = navs.length; $art_ieanrlec$art_i < $art_cezduqprd$art_c; $art_ieanrlec$art_i++) {        var nav = navs[$art_ieanrlec$art_i]%>';
        for (var $art_ieanrlec$art_i = 0, $art_cezduqprd$art_c = navs.length; $art_ieanrlec$art_i < $art_cezduqprd$art_c; $art_ieanrlec$art_i++) {
            var nav = navs[$art_ieanrlec$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
