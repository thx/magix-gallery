...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cipwfbhus$art_c = list.length; index < $art_cipwfbhus$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cipwfbhus$art_c = list.length; index < $art_cipwfbhus$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ilcvabpssi$art_i = 0, $art_objztijtgds$art_obj = item.seconds, $art_cldzzyngjgqa$art_c = $art_objztijtgds$art_obj.length; $art_ilcvabpssi$art_i < $art_cldzzyngjgqa$art_c; $art_ilcvabpssi$art_i++) {        var second = $art_objztijtgds$art_obj[$art_ilcvabpssi$art_i]%>';
        for (var $art_ilcvabpssi$art_i = 0, $art_objztijtgds$art_obj = item.seconds, $art_cldzzyngjgqa$art_c = $art_objztijtgds$art_obj.length; $art_ilcvabpssi$art_i < $art_cldzzyngjgqa$art_c; $art_ilcvabpssi$art_i++) {
            var second = $art_objztijtgds$art_obj[$art_ilcvabpssi$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iazosv$art_i = 0, $art_objxiipdwbze$art_obj = second.thirds, $art_cwtpvrwi$art_c = $art_objxiipdwbze$art_obj.length; $art_iazosv$art_i < $art_cwtpvrwi$art_c; $art_iazosv$art_i++) {            var third = $art_objxiipdwbze$art_obj[$art_iazosv$art_i]%>';
            for (var $art_iazosv$art_i = 0, $art_objxiipdwbze$art_obj = second.thirds, $art_cwtpvrwi$art_c = $art_objxiipdwbze$art_obj.length; $art_iazosv$art_i < $art_cwtpvrwi$art_c; $art_iazosv$art_i++) {
                var third = $art_objxiipdwbze$art_obj[$art_iazosv$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_imtsrbwuc$art_i = 0, $art_cciiiqvoyh$art_c = navs.length; $art_imtsrbwuc$art_i < $art_cciiiqvoyh$art_c; $art_imtsrbwuc$art_i++) {        var nav = navs[$art_imtsrbwuc$art_i]%>';
        for (var $art_imtsrbwuc$art_i = 0, $art_cciiiqvoyh$art_c = navs.length; $art_imtsrbwuc$art_i < $art_cciiiqvoyh$art_c; $art_imtsrbwuc$art_i++) {
            var nav = navs[$art_imtsrbwuc$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
