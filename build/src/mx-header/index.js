...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerybZ:_" class="_zs_gallery_mx-header_index_-header"><div class="_zs_gallery_mx-header_index_-others clearfix" style="width: ';
    $line = 2;
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_gallerybZ:_" class="fl mr35"><a class="_zs_gallery_mx-header_index_-text _zs_gallery_mx-header_index_-text-h-brand" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
    $line = 6;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_czhpnnouvk$art_c = list.length; index < $art_czhpnnouvk$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_czhpnnouvk$art_c = list.length; index < $art_czhpnnouvk$art_c; index++) {
        var item = list[index];
        ...
        $art = '=index';
        ;
        $p += ($expr = '<%=index%>', $e(index)) + ',height:0})"><span mxa="_zs_gallerybZ:a" class="_zs_gallery_mx-header_index_-text">';
        $line = 10;
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_gallerybZ:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links" style="height: ';
        $line = 12;
        $art = '=item.showHeight';
        ;
        ...
        ;
        $expr = '<%for (var $art_iccdlauch$art_i = 0, $art_objssdkdkylg$art_obj = item.seconds, $art_cmnhfnhil$art_c = $art_objssdkdkylg$art_obj.length; $art_iccdlauch$art_i < $art_cmnhfnhil$art_c; $art_iccdlauch$art_i++) {        var second = $art_objssdkdkylg$art_obj[$art_iccdlauch$art_i]%>';
        for (var $art_iccdlauch$art_i = 0, $art_objssdkdkylg$art_obj = item.seconds, $art_cmnhfnhil$art_c = $art_objssdkdkylg$art_obj.length; $art_iccdlauch$art_i < $art_cmnhfnhil$art_c; $art_iccdlauch$art_i++) {
            var second = $art_objssdkdkylg$art_obj[$art_iccdlauch$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqoaelimpo$art_i = 0, $art_objgqdigmhe$art_obj = second.thirds, $art_cvlalsia$art_c = $art_objgqdigmhe$art_obj.length; $art_iqoaelimpo$art_i < $art_cvlalsia$art_c; $art_iqoaelimpo$art_i++) {            var third = $art_objgqdigmhe$art_obj[$art_iqoaelimpo$art_i]%>';
            for (var $art_iqoaelimpo$art_i = 0, $art_objgqdigmhe$art_obj = second.thirds, $art_cvlalsia$art_c = $art_objgqdigmhe$art_obj.length; $art_iqoaelimpo$art_i < $art_cvlalsia$art_c; $art_iqoaelimpo$art_i++) {
                var third = $art_objgqdigmhe$art_obj[$art_iqoaelimpo$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxa="_zs_gallerybZ:b" class="_zs_gallery_mx-header_index_-logo"><img src="';
    $line = 30;
    $art = '=logo';
    ;
    $p += ($expr = '<%=logo%>', $e(logo)) + '"/></div><div mxa="_zs_gallerybZ:c" class="_zs_gallery_mx-header_index_-navs">';
    $line = 33;
    $art = 'each navs as nav';
    ;
    $expr = '<%for (var $art_idsiwoql$art_i = 0, $art_chekhsknti$art_c = navs.length; $art_idsiwoql$art_i < $art_chekhsknti$art_c; $art_idsiwoql$art_i++) {    var nav = navs[$art_idsiwoql$art_i]%>';
    for (var $art_idsiwoql$art_i = 0, $art_chekhsknti$art_c = navs.length; $art_idsiwoql$art_i < $art_chekhsknti$art_c; $art_idsiwoql$art_i++) {
        var nav = navs[$art_idsiwoql$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
