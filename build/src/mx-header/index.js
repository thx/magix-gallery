...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cvosbqls$art_c = list.length; index < $art_cvosbqls$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cvosbqls$art_c = list.length; index < $art_cvosbqls$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iqoqrlfmefsk$art_i = 0, $art_objzuavjnp$art_obj = item.seconds, $art_cuskcv$art_c = $art_objzuavjnp$art_obj.length; $art_iqoqrlfmefsk$art_i < $art_cuskcv$art_c; $art_iqoqrlfmefsk$art_i++) {        var second = $art_objzuavjnp$art_obj[$art_iqoqrlfmefsk$art_i]%>';
        for (var $art_iqoqrlfmefsk$art_i = 0, $art_objzuavjnp$art_obj = item.seconds, $art_cuskcv$art_c = $art_objzuavjnp$art_obj.length; $art_iqoqrlfmefsk$art_i < $art_cuskcv$art_c; $art_iqoqrlfmefsk$art_i++) {
            var second = $art_objzuavjnp$art_obj[$art_iqoqrlfmefsk$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifnbegec$art_i = 0, $art_objbrjhqbcuo$art_obj = second.thirds, $art_crjzvkvk$art_c = $art_objbrjhqbcuo$art_obj.length; $art_ifnbegec$art_i < $art_crjzvkvk$art_c; $art_ifnbegec$art_i++) {            var third = $art_objbrjhqbcuo$art_obj[$art_ifnbegec$art_i]%>';
            for (var $art_ifnbegec$art_i = 0, $art_objbrjhqbcuo$art_obj = second.thirds, $art_crjzvkvk$art_c = $art_objbrjhqbcuo$art_obj.length; $art_ifnbegec$art_i < $art_crjzvkvk$art_c; $art_ifnbegec$art_i++) {
                var third = $art_objbrjhqbcuo$art_obj[$art_ifnbegec$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iwplivd$art_i = 0, $art_cpetvdbcts$art_c = navs.length; $art_iwplivd$art_i < $art_cpetvdbcts$art_c; $art_iwplivd$art_i++) {    var nav = navs[$art_iwplivd$art_i]%>';
    for (var $art_iwplivd$art_i = 0, $art_cpetvdbcts$art_c = navs.length; $art_iwplivd$art_i < $art_cpetvdbcts$art_c; $art_iwplivd$art_i++) {
        var nav = navs[$art_iwplivd$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
