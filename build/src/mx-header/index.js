...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ctidfglnw$art_c = list.length; index < $art_ctidfglnw$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ctidfglnw$art_c = list.length; index < $art_ctidfglnw$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ifgfychfb$art_i = 0, $art_objqasjvyi$art_obj = item.seconds, $art_cmdyylqdd$art_c = $art_objqasjvyi$art_obj.length; $art_ifgfychfb$art_i < $art_cmdyylqdd$art_c; $art_ifgfychfb$art_i++) {        var second = $art_objqasjvyi$art_obj[$art_ifgfychfb$art_i]%>';
        for (var $art_ifgfychfb$art_i = 0, $art_objqasjvyi$art_obj = item.seconds, $art_cmdyylqdd$art_c = $art_objqasjvyi$art_obj.length; $art_ifgfychfb$art_i < $art_cmdyylqdd$art_c; $art_ifgfychfb$art_i++) {
            var second = $art_objqasjvyi$art_obj[$art_ifgfychfb$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilhfglzshsu$art_i = 0, $art_objpzruq$art_obj = second.thirds, $art_cwoeqjckc$art_c = $art_objpzruq$art_obj.length; $art_ilhfglzshsu$art_i < $art_cwoeqjckc$art_c; $art_ilhfglzshsu$art_i++) {            var third = $art_objpzruq$art_obj[$art_ilhfglzshsu$art_i]%>';
            for (var $art_ilhfglzshsu$art_i = 0, $art_objpzruq$art_obj = second.thirds, $art_cwoeqjckc$art_c = $art_objpzruq$art_obj.length; $art_ilhfglzshsu$art_i < $art_cwoeqjckc$art_c; $art_ilhfglzshsu$art_i++) {
                var third = $art_objpzruq$art_obj[$art_ilhfglzshsu$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iynyqluc$art_i = 0, $art_cvyerxrib$art_c = navs.length; $art_iynyqluc$art_i < $art_cvyerxrib$art_c; $art_iynyqluc$art_i++) {        var nav = navs[$art_iynyqluc$art_i]%>';
        for (var $art_iynyqluc$art_i = 0, $art_cvyerxrib$art_c = navs.length; $art_iynyqluc$art_i < $art_cvyerxrib$art_c; $art_iynyqluc$art_i++) {
            var nav = navs[$art_iynyqluc$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
