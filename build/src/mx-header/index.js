...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cyllwnfky$art_c = list.length; index < $art_cyllwnfky$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cyllwnfky$art_c = list.length; index < $art_cyllwnfky$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_inwidysnxo$art_i = 0, $art_objbgmdm$art_obj = item.seconds, $art_cijrifjha$art_c = $art_objbgmdm$art_obj.length; $art_inwidysnxo$art_i < $art_cijrifjha$art_c; $art_inwidysnxo$art_i++) {        var second = $art_objbgmdm$art_obj[$art_inwidysnxo$art_i]%>';
        for (var $art_inwidysnxo$art_i = 0, $art_objbgmdm$art_obj = item.seconds, $art_cijrifjha$art_c = $art_objbgmdm$art_obj.length; $art_inwidysnxo$art_i < $art_cijrifjha$art_c; $art_inwidysnxo$art_i++) {
            var second = $art_objbgmdm$art_obj[$art_inwidysnxo$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_izjycbtkp$art_i = 0, $art_objfdumwxfsyi$art_obj = second.thirds, $art_cvvvbdeoyu$art_c = $art_objfdumwxfsyi$art_obj.length; $art_izjycbtkp$art_i < $art_cvvvbdeoyu$art_c; $art_izjycbtkp$art_i++) {            var third = $art_objfdumwxfsyi$art_obj[$art_izjycbtkp$art_i]%>';
            for (var $art_izjycbtkp$art_i = 0, $art_objfdumwxfsyi$art_obj = second.thirds, $art_cvvvbdeoyu$art_c = $art_objfdumwxfsyi$art_obj.length; $art_izjycbtkp$art_i < $art_cvvvbdeoyu$art_c; $art_izjycbtkp$art_i++) {
                var third = $art_objfdumwxfsyi$art_obj[$art_izjycbtkp$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ickgmgnrn$art_i = 0, $art_cpprvmh$art_c = navs.length; $art_ickgmgnrn$art_i < $art_cpprvmh$art_c; $art_ickgmgnrn$art_i++) {        var nav = navs[$art_ickgmgnrn$art_i]%>';
        for (var $art_ickgmgnrn$art_i = 0, $art_cpprvmh$art_c = navs.length; $art_ickgmgnrn$art_i < $art_cpprvmh$art_c; $art_ickgmgnrn$art_i++) {
            var nav = navs[$art_ickgmgnrn$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
