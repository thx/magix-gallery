...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_celggjs$art_c = list.length; index < $art_celggjs$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_celggjs$art_c = list.length; index < $art_celggjs$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ijpvrg$art_i = 0, $art_objnqhmgnxriq$art_obj = item.seconds, $art_cfdbv$art_c = $art_objnqhmgnxriq$art_obj.length; $art_ijpvrg$art_i < $art_cfdbv$art_c; $art_ijpvrg$art_i++) {        var second = $art_objnqhmgnxriq$art_obj[$art_ijpvrg$art_i]%>';
        for (var $art_ijpvrg$art_i = 0, $art_objnqhmgnxriq$art_obj = item.seconds, $art_cfdbv$art_c = $art_objnqhmgnxriq$art_obj.length; $art_ijpvrg$art_i < $art_cfdbv$art_c; $art_ijpvrg$art_i++) {
            var second = $art_objnqhmgnxriq$art_obj[$art_ijpvrg$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ihjvyztf$art_i = 0, $art_objmafvimbv$art_obj = second.thirds, $art_ciwjwynw$art_c = $art_objmafvimbv$art_obj.length; $art_ihjvyztf$art_i < $art_ciwjwynw$art_c; $art_ihjvyztf$art_i++) {            var third = $art_objmafvimbv$art_obj[$art_ihjvyztf$art_i]%>';
            for (var $art_ihjvyztf$art_i = 0, $art_objmafvimbv$art_obj = second.thirds, $art_ciwjwynw$art_c = $art_objmafvimbv$art_obj.length; $art_ihjvyztf$art_i < $art_ciwjwynw$art_c; $art_ihjvyztf$art_i++) {
                var third = $art_objmafvimbv$art_obj[$art_ihjvyztf$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_inffmbif$art_i = 0, $art_czswyhrhtwk$art_c = navs.length; $art_inffmbif$art_i < $art_czswyhrhtwk$art_c; $art_inffmbif$art_i++) {    var nav = navs[$art_inffmbif$art_i]%>';
    for (var $art_inffmbif$art_i = 0, $art_czswyhrhtwk$art_c = navs.length; $art_inffmbif$art_i < $art_czswyhrhtwk$art_c; $art_inffmbif$art_i++) {
        var nav = navs[$art_inffmbif$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
