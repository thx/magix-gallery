...
module.exports = Magix.View.extend({
    ...
    for (var index = 0; index < list.length; index++) {
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ihadrkwx$art_i=0,$art_objewcgc$art_obj=item.seconds;$art_ihadrkwx$art_i<$art_objewcgc$art_obj.length;$art_ihadrkwx$art_i++){var second=$art_objewcgc$art_obj[$art_ihadrkwx$art_i]%>';
        for (var $art_ihadrkwx$art_i = 0, $art_objewcgc$art_obj = item.seconds; $art_ihadrkwx$art_i < $art_objewcgc$art_obj.length; $art_ihadrkwx$art_i++) {
            var second = $art_objewcgc$art_obj[$art_ihadrkwx$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_iphlhxmd$art_i=0,$art_objtjxyfnmkr$art_obj=second.thirds;$art_iphlhxmd$art_i<$art_objtjxyfnmkr$art_obj.length;$art_iphlhxmd$art_i++){var third=$art_objtjxyfnmkr$art_obj[$art_iphlhxmd$art_i]%>';
            for (var $art_iphlhxmd$art_i = 0, $art_objtjxyfnmkr$art_obj = second.thirds; $art_iphlhxmd$art_i < $art_objtjxyfnmkr$art_obj.length; $art_iphlhxmd$art_i++) {
                var third = $art_objtjxyfnmkr$art_obj[$art_iphlhxmd$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ijiwxmezcuf$art_i=0;$art_ijiwxmezcuf$art_i<navs.length;$art_ijiwxmezcuf$art_i++){var nav=navs[$art_ijiwxmezcuf$art_i]%>';
    for (var $art_ijiwxmezcuf$art_i = 0; $art_ijiwxmezcuf$art_i < navs.length; $art_ijiwxmezcuf$art_i++) {
        var nav = navs[$art_ijiwxmezcuf$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
