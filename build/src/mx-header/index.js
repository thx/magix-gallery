...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cqmmpjn$art_c = list.length; index < $art_cqmmpjn$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cqmmpjn$art_c = list.length; index < $art_cqmmpjn$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ibzbqdoe$art_i = 0, $art_objauzowjxfa$art_obj = item.seconds, $art_crcfjmwp$art_c = $art_objauzowjxfa$art_obj.length; $art_ibzbqdoe$art_i < $art_crcfjmwp$art_c; $art_ibzbqdoe$art_i++) {        var second = $art_objauzowjxfa$art_obj[$art_ibzbqdoe$art_i]%>';
        for (var $art_ibzbqdoe$art_i = 0, $art_objauzowjxfa$art_obj = item.seconds, $art_crcfjmwp$art_c = $art_objauzowjxfa$art_obj.length; $art_ibzbqdoe$art_i < $art_crcfjmwp$art_c; $art_ibzbqdoe$art_i++) {
            var second = $art_objauzowjxfa$art_obj[$art_ibzbqdoe$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iibuhjzq$art_i = 0, $art_objpllranaj$art_obj = second.thirds, $art_crulqegvfm$art_c = $art_objpllranaj$art_obj.length; $art_iibuhjzq$art_i < $art_crulqegvfm$art_c; $art_iibuhjzq$art_i++) {            var third = $art_objpllranaj$art_obj[$art_iibuhjzq$art_i]%>';
            for (var $art_iibuhjzq$art_i = 0, $art_objpllranaj$art_obj = second.thirds, $art_crulqegvfm$art_c = $art_objpllranaj$art_obj.length; $art_iibuhjzq$art_i < $art_crulqegvfm$art_c; $art_iibuhjzq$art_i++) {
                var third = $art_objpllranaj$art_obj[$art_iibuhjzq$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ikesnxcmyys$art_i = 0, $art_ctfeeuw$art_c = navs.length; $art_ikesnxcmyys$art_i < $art_ctfeeuw$art_c; $art_ikesnxcmyys$art_i++) {        var nav = navs[$art_ikesnxcmyys$art_i]%>';
        for (var $art_ikesnxcmyys$art_i = 0, $art_ctfeeuw$art_c = navs.length; $art_ikesnxcmyys$art_i < $art_ctfeeuw$art_c; $art_ikesnxcmyys$art_i++) {
            var nav = navs[$art_ikesnxcmyys$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
