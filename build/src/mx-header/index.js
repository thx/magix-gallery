...
module.exports = Magix.View.extend({
    ...
    for (var index = 0; index < list.length; index++) {
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_iwrghdjnkl$art_i=0,$art_objynpxjvuj$art_obj=item.seconds;$art_iwrghdjnkl$art_i<$art_objynpxjvuj$art_obj.length;$art_iwrghdjnkl$art_i++){var second=$art_objynpxjvuj$art_obj[$art_iwrghdjnkl$art_i]%>';
        for (var $art_iwrghdjnkl$art_i = 0, $art_objynpxjvuj$art_obj = item.seconds; $art_iwrghdjnkl$art_i < $art_objynpxjvuj$art_obj.length; $art_iwrghdjnkl$art_i++) {
            var second = $art_objynpxjvuj$art_obj[$art_iwrghdjnkl$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_ijtaqy$art_i=0,$art_objfxuoobuu$art_obj=second.thirds;$art_ijtaqy$art_i<$art_objfxuoobuu$art_obj.length;$art_ijtaqy$art_i++){var third=$art_objfxuoobuu$art_obj[$art_ijtaqy$art_i]%>';
            for (var $art_ijtaqy$art_i = 0, $art_objfxuoobuu$art_obj = second.thirds; $art_ijtaqy$art_i < $art_objfxuoobuu$art_obj.length; $art_ijtaqy$art_i++) {
                var third = $art_objfxuoobuu$art_obj[$art_ijtaqy$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_isitszjoub$art_i=0;$art_isitszjoub$art_i<navs.length;$art_isitszjoub$art_i++){var nav=navs[$art_isitszjoub$art_i]%>';
    for (var $art_isitszjoub$art_i = 0; $art_isitszjoub$art_i < navs.length; $art_isitszjoub$art_i++) {
        var nav = navs[$art_isitszjoub$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
