...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cgfzyhx$art_c = list.length; index < $art_cgfzyhx$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cgfzyhx$art_c = list.length; index < $art_cgfzyhx$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_isvdarutxd$art_i = 0, $art_objqfvdlsmro$art_obj = item.seconds, $art_czdzdost$art_c = $art_objqfvdlsmro$art_obj.length; $art_isvdarutxd$art_i < $art_czdzdost$art_c; $art_isvdarutxd$art_i++) {        var second = $art_objqfvdlsmro$art_obj[$art_isvdarutxd$art_i]%>';
        for (var $art_isvdarutxd$art_i = 0, $art_objqfvdlsmro$art_obj = item.seconds, $art_czdzdost$art_c = $art_objqfvdlsmro$art_obj.length; $art_isvdarutxd$art_i < $art_czdzdost$art_c; $art_isvdarutxd$art_i++) {
            var second = $art_objqfvdlsmro$art_obj[$art_isvdarutxd$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ipljnld$art_i = 0, $art_objrxwkvak$art_obj = second.thirds, $art_cdihlvhed$art_c = $art_objrxwkvak$art_obj.length; $art_ipljnld$art_i < $art_cdihlvhed$art_c; $art_ipljnld$art_i++) {            var third = $art_objrxwkvak$art_obj[$art_ipljnld$art_i]%>';
            for (var $art_ipljnld$art_i = 0, $art_objrxwkvak$art_obj = second.thirds, $art_cdihlvhed$art_c = $art_objrxwkvak$art_obj.length; $art_ipljnld$art_i < $art_cdihlvhed$art_c; $art_ipljnld$art_i++) {
                var third = $art_objrxwkvak$art_obj[$art_ipljnld$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iysdouhuig$art_i = 0, $art_cgajtoyfn$art_c = navs.length; $art_iysdouhuig$art_i < $art_cgajtoyfn$art_c; $art_iysdouhuig$art_i++) {    var nav = navs[$art_iysdouhuig$art_i]%>';
    for (var $art_iysdouhuig$art_i = 0, $art_cgajtoyfn$art_c = navs.length; $art_iysdouhuig$art_i < $art_cgajtoyfn$art_c; $art_iysdouhuig$art_i++) {
        var nav = navs[$art_iysdouhuig$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
