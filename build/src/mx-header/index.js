...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cgsdmuxtw$art_c = list.length; index < $art_cgsdmuxtw$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cgsdmuxtw$art_c = list.length; index < $art_cgsdmuxtw$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ihdxbxr$art_i = 0, $art_objqqafqrfh$art_obj = item.seconds, $art_czxhandfhg$art_c = $art_objqqafqrfh$art_obj.length; $art_ihdxbxr$art_i < $art_czxhandfhg$art_c; $art_ihdxbxr$art_i++) {        var second = $art_objqqafqrfh$art_obj[$art_ihdxbxr$art_i]%>';
        for (var $art_ihdxbxr$art_i = 0, $art_objqqafqrfh$art_obj = item.seconds, $art_czxhandfhg$art_c = $art_objqqafqrfh$art_obj.length; $art_ihdxbxr$art_i < $art_czxhandfhg$art_c; $art_ihdxbxr$art_i++) {
            var second = $art_objqqafqrfh$art_obj[$art_ihdxbxr$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iztjlemd$art_i = 0, $art_objhyalgugxe$art_obj = second.thirds, $art_clvllgwjg$art_c = $art_objhyalgugxe$art_obj.length; $art_iztjlemd$art_i < $art_clvllgwjg$art_c; $art_iztjlemd$art_i++) {            var third = $art_objhyalgugxe$art_obj[$art_iztjlemd$art_i]%>';
            for (var $art_iztjlemd$art_i = 0, $art_objhyalgugxe$art_obj = second.thirds, $art_clvllgwjg$art_c = $art_objhyalgugxe$art_obj.length; $art_iztjlemd$art_i < $art_clvllgwjg$art_c; $art_iztjlemd$art_i++) {
                var third = $art_objhyalgugxe$art_obj[$art_iztjlemd$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_imtqchzmtuf$art_i = 0, $art_cicclse$art_c = navs.length; $art_imtqchzmtuf$art_i < $art_cicclse$art_c; $art_imtqchzmtuf$art_i++) {        var nav = navs[$art_imtqchzmtuf$art_i]%>';
        for (var $art_imtqchzmtuf$art_i = 0, $art_cicclse$art_c = navs.length; $art_imtqchzmtuf$art_i < $art_cicclse$art_c; $art_imtqchzmtuf$art_i++) {
            var nav = navs[$art_imtqchzmtuf$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
