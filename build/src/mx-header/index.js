...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cdxqabycg$art_c = list.length; index < $art_cdxqabycg$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cdxqabycg$art_c = list.length; index < $art_cdxqabycg$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iljkdxespe$art_i = 0, $art_objtbbmfd$art_obj = item.seconds, $art_cfsntfgb$art_c = $art_objtbbmfd$art_obj.length; $art_iljkdxespe$art_i < $art_cfsntfgb$art_c; $art_iljkdxespe$art_i++) {        var second = $art_objtbbmfd$art_obj[$art_iljkdxespe$art_i]%>';
        for (var $art_iljkdxespe$art_i = 0, $art_objtbbmfd$art_obj = item.seconds, $art_cfsntfgb$art_c = $art_objtbbmfd$art_obj.length; $art_iljkdxespe$art_i < $art_cfsntfgb$art_c; $art_iljkdxespe$art_i++) {
            var second = $art_objtbbmfd$art_obj[$art_iljkdxespe$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iouufme$art_i = 0, $art_objrvmtw$art_obj = second.thirds, $art_ckgcoklnq$art_c = $art_objrvmtw$art_obj.length; $art_iouufme$art_i < $art_ckgcoklnq$art_c; $art_iouufme$art_i++) {            var third = $art_objrvmtw$art_obj[$art_iouufme$art_i]%>';
            for (var $art_iouufme$art_i = 0, $art_objrvmtw$art_obj = second.thirds, $art_ckgcoklnq$art_c = $art_objrvmtw$art_obj.length; $art_iouufme$art_i < $art_ckgcoklnq$art_c; $art_iouufme$art_i++) {
                var third = $art_objrvmtw$art_obj[$art_iouufme$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_irxiful$art_i = 0, $art_cnlqajhp$art_c = navs.length; $art_irxiful$art_i < $art_cnlqajhp$art_c; $art_irxiful$art_i++) {    var nav = navs[$art_irxiful$art_i]%>';
    for (var $art_irxiful$art_i = 0, $art_cnlqajhp$art_c = navs.length; $art_irxiful$art_i < $art_cnlqajhp$art_c; $art_irxiful$art_i++) {
        var nav = navs[$art_irxiful$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
