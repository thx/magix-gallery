...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cklcat$art_c = list.length; index < $art_cklcat$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cklcat$art_c = list.length; index < $art_cklcat$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iqsrsbchi$art_i = 0, $art_objguepsfzj$art_obj = item.seconds, $art_caabitcxq$art_c = $art_objguepsfzj$art_obj.length; $art_iqsrsbchi$art_i < $art_caabitcxq$art_c; $art_iqsrsbchi$art_i++) {        var second = $art_objguepsfzj$art_obj[$art_iqsrsbchi$art_i]%>';
        for (var $art_iqsrsbchi$art_i = 0, $art_objguepsfzj$art_obj = item.seconds, $art_caabitcxq$art_c = $art_objguepsfzj$art_obj.length; $art_iqsrsbchi$art_i < $art_caabitcxq$art_c; $art_iqsrsbchi$art_i++) {
            var second = $art_objguepsfzj$art_obj[$art_iqsrsbchi$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_isqtieurouo$art_i = 0, $art_objxcoojue$art_obj = second.thirds, $art_cdyveewnxgvw$art_c = $art_objxcoojue$art_obj.length; $art_isqtieurouo$art_i < $art_cdyveewnxgvw$art_c; $art_isqtieurouo$art_i++) {            var third = $art_objxcoojue$art_obj[$art_isqtieurouo$art_i]%>';
            for (var $art_isqtieurouo$art_i = 0, $art_objxcoojue$art_obj = second.thirds, $art_cdyveewnxgvw$art_c = $art_objxcoojue$art_obj.length; $art_isqtieurouo$art_i < $art_cdyveewnxgvw$art_c; $art_isqtieurouo$art_i++) {
                var third = $art_objxcoojue$art_obj[$art_isqtieurouo$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_imhupunaw$art_i = 0, $art_cxrtgsyc$art_c = navs.length; $art_imhupunaw$art_i < $art_cxrtgsyc$art_c; $art_imhupunaw$art_i++) {    var nav = navs[$art_imhupunaw$art_i]%>';
    for (var $art_imhupunaw$art_i = 0, $art_cxrtgsyc$art_c = navs.length; $art_imhupunaw$art_i < $art_cxrtgsyc$art_c; $art_imhupunaw$art_i++) {
        var nav = navs[$art_imhupunaw$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
