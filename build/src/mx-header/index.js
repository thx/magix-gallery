...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cmhwlwrqtb$art_c = list.length; index < $art_cmhwlwrqtb$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cmhwlwrqtb$art_c = list.length; index < $art_cmhwlwrqtb$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iglsszjhl$art_i = 0, $art_objzfttaaq$art_obj = item.seconds, $art_cyaked$art_c = $art_objzfttaaq$art_obj.length; $art_iglsszjhl$art_i < $art_cyaked$art_c; $art_iglsszjhl$art_i++) {        var second = $art_objzfttaaq$art_obj[$art_iglsszjhl$art_i]%>';
        for (var $art_iglsszjhl$art_i = 0, $art_objzfttaaq$art_obj = item.seconds, $art_cyaked$art_c = $art_objzfttaaq$art_obj.length; $art_iglsszjhl$art_i < $art_cyaked$art_c; $art_iglsszjhl$art_i++) {
            var second = $art_objzfttaaq$art_obj[$art_iglsszjhl$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_igpuhfkqh$art_i = 0, $art_objcgxanusq$art_obj = second.thirds, $art_cmjgehjzn$art_c = $art_objcgxanusq$art_obj.length; $art_igpuhfkqh$art_i < $art_cmjgehjzn$art_c; $art_igpuhfkqh$art_i++) {            var third = $art_objcgxanusq$art_obj[$art_igpuhfkqh$art_i]%>';
            for (var $art_igpuhfkqh$art_i = 0, $art_objcgxanusq$art_obj = second.thirds, $art_cmjgehjzn$art_c = $art_objcgxanusq$art_obj.length; $art_igpuhfkqh$art_i < $art_cmjgehjzn$art_c; $art_igpuhfkqh$art_i++) {
                var third = $art_objcgxanusq$art_obj[$art_igpuhfkqh$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_idnxxkv$art_i = 0, $art_cipbgngb$art_c = navs.length; $art_idnxxkv$art_i < $art_cipbgngb$art_c; $art_idnxxkv$art_i++) {        var nav = navs[$art_idnxxkv$art_i]%>';
        for (var $art_idnxxkv$art_i = 0, $art_cipbgngb$art_c = navs.length; $art_idnxxkv$art_i < $art_cipbgngb$art_c; $art_idnxxkv$art_i++) {
            var nav = navs[$art_idnxxkv$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
