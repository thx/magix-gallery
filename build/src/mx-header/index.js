...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_czoailkc$art_c = list.length; index < $art_czoailkc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_czoailkc$art_c = list.length; index < $art_czoailkc$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iompxdsqeai$art_i = 0, $art_objxdvptgm$art_obj = item.seconds, $art_cflyjm$art_c = $art_objxdvptgm$art_obj.length; $art_iompxdsqeai$art_i < $art_cflyjm$art_c; $art_iompxdsqeai$art_i++) {        var second = $art_objxdvptgm$art_obj[$art_iompxdsqeai$art_i]%>';
        for (var $art_iompxdsqeai$art_i = 0, $art_objxdvptgm$art_obj = item.seconds, $art_cflyjm$art_c = $art_objxdvptgm$art_obj.length; $art_iompxdsqeai$art_i < $art_cflyjm$art_c; $art_iompxdsqeai$art_i++) {
            var second = $art_objxdvptgm$art_obj[$art_iompxdsqeai$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iyyxqtmyj$art_i = 0, $art_objgenhjpmtcs$art_obj = second.thirds, $art_cypqsgtoht$art_c = $art_objgenhjpmtcs$art_obj.length; $art_iyyxqtmyj$art_i < $art_cypqsgtoht$art_c; $art_iyyxqtmyj$art_i++) {            var third = $art_objgenhjpmtcs$art_obj[$art_iyyxqtmyj$art_i]%>';
            for (var $art_iyyxqtmyj$art_i = 0, $art_objgenhjpmtcs$art_obj = second.thirds, $art_cypqsgtoht$art_c = $art_objgenhjpmtcs$art_obj.length; $art_iyyxqtmyj$art_i < $art_cypqsgtoht$art_c; $art_iyyxqtmyj$art_i++) {
                var third = $art_objgenhjpmtcs$art_obj[$art_iyyxqtmyj$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ittjpxryyws$art_i = 0, $art_ctfsvicl$art_c = navs.length; $art_ittjpxryyws$art_i < $art_ctfsvicl$art_c; $art_ittjpxryyws$art_i++) {        var nav = navs[$art_ittjpxryyws$art_i]%>';
        for (var $art_ittjpxryyws$art_i = 0, $art_ctfsvicl$art_c = navs.length; $art_ittjpxryyws$art_i < $art_ctfsvicl$art_c; $art_ittjpxryyws$art_i++) {
            var nav = navs[$art_ittjpxryyws$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
