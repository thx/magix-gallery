...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerycc:_" class="_zs_gallery_mx-header_index_-header"><div class="_zs_gallery_mx-header_index_-others clearfix" style="width: ';
    $line = 2;
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_gallerycc:_" class="fl mr35"><a class="_zs_gallery_mx-header_index_-text _zs_gallery_mx-header_index_-text-h-brand" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
    $line = 6;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cjekipger$art_c = list.length; index < $art_cjekipger$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cjekipger$art_c = list.length; index < $art_cjekipger$art_c; index++) {
        var item = list[index];
        ...
        $art = '=index';
        ;
        $p += ($expr = '<%=index%>', $e(index)) + ',height:0})"><span mxa="_zs_gallerycc:a" class="_zs_gallery_mx-header_index_-text">';
        $line = 10;
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_gallerycc:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links ';
        $line = 12;
        ...
        ;
        $expr = '<%for (var $art_iympkshffz$art_i = 0, $art_objpfguizhr$art_obj = item.seconds, $art_cwmavuagv$art_c = $art_objpfguizhr$art_obj.length; $art_iympkshffz$art_i < $art_cwmavuagv$art_c; $art_iympkshffz$art_i++) {        var second = $art_objpfguizhr$art_obj[$art_iympkshffz$art_i]%>';
        for (var $art_iympkshffz$art_i = 0, $art_objpfguizhr$art_obj = item.seconds, $art_cwmavuagv$art_c = $art_objpfguizhr$art_obj.length; $art_iympkshffz$art_i < $art_cwmavuagv$art_c; $art_iympkshffz$art_i++) {
            var second = $art_objpfguizhr$art_obj[$art_iympkshffz$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqtkpnpoyab$art_i = 0, $art_objesqvzpy$art_obj = second.thirds, $art_cggavsfbw$art_c = $art_objesqvzpy$art_obj.length; $art_iqtkpnpoyab$art_i < $art_cggavsfbw$art_c; $art_iqtkpnpoyab$art_i++) {            var third = $art_objesqvzpy$art_obj[$art_iqtkpnpoyab$art_i]%>';
            for (var $art_iqtkpnpoyab$art_i = 0, $art_objesqvzpy$art_obj = second.thirds, $art_cggavsfbw$art_c = $art_objesqvzpy$art_obj.length; $art_iqtkpnpoyab$art_i < $art_cggavsfbw$art_c; $art_iqtkpnpoyab$art_i++) {
                var third = $art_objesqvzpy$art_obj[$art_iqtkpnpoyab$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxa="_zs_gallerycc:b" class="_zs_gallery_mx-header_index_-logo"><img src="';
    $line = 30;
    $art = '=logo';
    ;
    ...
    if (navs.length > 0) {
        ;
        $p += '<div mxa="_zs_gallerycc:c" class="_zs_gallery_mx-header_index_-navs">';
        $line = 34;
        $art = 'each navs as nav';
        ;
        $expr = '<%for (var $art_iyydaizcu$art_i = 0, $art_cqjefvm$art_c = navs.length; $art_iyydaizcu$art_i < $art_cqjefvm$art_c; $art_iyydaizcu$art_i++) {        var nav = navs[$art_iyydaizcu$art_i]%>';
        for (var $art_iyydaizcu$art_i = 0, $art_cqjefvm$art_c = navs.length; $art_iyydaizcu$art_i < $art_cqjefvm$art_c; $art_iyydaizcu$art_i++) {
            var nav = navs[$art_iyydaizcu$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
