...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cxqxnxug$art_c = list.length; index < $art_cxqxnxug$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cxqxnxug$art_c = list.length; index < $art_cxqxnxug$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ikygwtdpjm$art_i = 0, $art_objayievlnjn$art_obj = item.seconds, $art_clvgbkcs$art_c = $art_objayievlnjn$art_obj.length; $art_ikygwtdpjm$art_i < $art_clvgbkcs$art_c; $art_ikygwtdpjm$art_i++) {        var second = $art_objayievlnjn$art_obj[$art_ikygwtdpjm$art_i]%>';
        for (var $art_ikygwtdpjm$art_i = 0, $art_objayievlnjn$art_obj = item.seconds, $art_clvgbkcs$art_c = $art_objayievlnjn$art_obj.length; $art_ikygwtdpjm$art_i < $art_clvgbkcs$art_c; $art_ikygwtdpjm$art_i++) {
            var second = $art_objayievlnjn$art_obj[$art_ikygwtdpjm$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ikhrfunft$art_i = 0, $art_objxpohpzfyl$art_obj = second.thirds, $art_cwpwladf$art_c = $art_objxpohpzfyl$art_obj.length; $art_ikhrfunft$art_i < $art_cwpwladf$art_c; $art_ikhrfunft$art_i++) {            var third = $art_objxpohpzfyl$art_obj[$art_ikhrfunft$art_i]%>';
            for (var $art_ikhrfunft$art_i = 0, $art_objxpohpzfyl$art_obj = second.thirds, $art_cwpwladf$art_c = $art_objxpohpzfyl$art_obj.length; $art_ikhrfunft$art_i < $art_cwpwladf$art_c; $art_ikhrfunft$art_i++) {
                var third = $art_objxpohpzfyl$art_obj[$art_ikhrfunft$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_idsvmgiwn$art_i = 0, $art_cnmyimztmzp$art_c = navs.length; $art_idsvmgiwn$art_i < $art_cnmyimztmzp$art_c; $art_idsvmgiwn$art_i++) {    var nav = navs[$art_idsvmgiwn$art_i]%>';
    for (var $art_idsvmgiwn$art_i = 0, $art_cnmyimztmzp$art_c = navs.length; $art_idsvmgiwn$art_i < $art_cnmyimztmzp$art_c; $art_idsvmgiwn$art_i++) {
        var nav = navs[$art_idsvmgiwn$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
