...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cpezkacvtl$art_c = list.length; index < $art_cpezkacvtl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cpezkacvtl$art_c = list.length; index < $art_cpezkacvtl$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ikjlcatju$art_i = 0, $art_objybwzvxtk$art_obj = item.seconds, $art_ctwsdepnl$art_c = $art_objybwzvxtk$art_obj.length; $art_ikjlcatju$art_i < $art_ctwsdepnl$art_c; $art_ikjlcatju$art_i++) {        var second = $art_objybwzvxtk$art_obj[$art_ikjlcatju$art_i]%>';
        for (var $art_ikjlcatju$art_i = 0, $art_objybwzvxtk$art_obj = item.seconds, $art_ctwsdepnl$art_c = $art_objybwzvxtk$art_obj.length; $art_ikjlcatju$art_i < $art_ctwsdepnl$art_c; $art_ikjlcatju$art_i++) {
            var second = $art_objybwzvxtk$art_obj[$art_ikjlcatju$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilxpoqdhgo$art_i = 0, $art_objtgmockqogr$art_obj = second.thirds, $art_crbtirvxqfg$art_c = $art_objtgmockqogr$art_obj.length; $art_ilxpoqdhgo$art_i < $art_crbtirvxqfg$art_c; $art_ilxpoqdhgo$art_i++) {            var third = $art_objtgmockqogr$art_obj[$art_ilxpoqdhgo$art_i]%>';
            for (var $art_ilxpoqdhgo$art_i = 0, $art_objtgmockqogr$art_obj = second.thirds, $art_crbtirvxqfg$art_c = $art_objtgmockqogr$art_obj.length; $art_ilxpoqdhgo$art_i < $art_crbtirvxqfg$art_c; $art_ilxpoqdhgo$art_i++) {
                var third = $art_objtgmockqogr$art_obj[$art_ilxpoqdhgo$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iznvibtzu$art_i = 0, $art_csudeksvix$art_c = navs.length; $art_iznvibtzu$art_i < $art_csudeksvix$art_c; $art_iznvibtzu$art_i++) {    var nav = navs[$art_iznvibtzu$art_i]%>';
    for (var $art_iznvibtzu$art_i = 0, $art_csudeksvix$art_c = navs.length; $art_iznvibtzu$art_i < $art_csudeksvix$art_c; $art_iznvibtzu$art_i++) {
        var nav = navs[$art_iznvibtzu$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
