...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_clucbgvc$art_c = list.length; index < $art_clucbgvc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_clucbgvc$art_c = list.length; index < $art_clucbgvc$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ioiraociisp$art_i = 0, $art_objugwodcdudq$art_obj = item.seconds, $art_curkcrlvr$art_c = $art_objugwodcdudq$art_obj.length; $art_ioiraociisp$art_i < $art_curkcrlvr$art_c; $art_ioiraociisp$art_i++) {        var second = $art_objugwodcdudq$art_obj[$art_ioiraociisp$art_i]%>';
        for (var $art_ioiraociisp$art_i = 0, $art_objugwodcdudq$art_obj = item.seconds, $art_curkcrlvr$art_c = $art_objugwodcdudq$art_obj.length; $art_ioiraociisp$art_i < $art_curkcrlvr$art_c; $art_ioiraociisp$art_i++) {
            var second = $art_objugwodcdudq$art_obj[$art_ioiraociisp$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_igzhpnlxow$art_i = 0, $art_objdwunfi$art_obj = second.thirds, $art_cyzccswcr$art_c = $art_objdwunfi$art_obj.length; $art_igzhpnlxow$art_i < $art_cyzccswcr$art_c; $art_igzhpnlxow$art_i++) {            var third = $art_objdwunfi$art_obj[$art_igzhpnlxow$art_i]%>';
            for (var $art_igzhpnlxow$art_i = 0, $art_objdwunfi$art_obj = second.thirds, $art_cyzccswcr$art_c = $art_objdwunfi$art_obj.length; $art_igzhpnlxow$art_i < $art_cyzccswcr$art_c; $art_igzhpnlxow$art_i++) {
                var third = $art_objdwunfi$art_obj[$art_igzhpnlxow$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_izrjrbmump$art_i = 0, $art_clejsvcqw$art_c = navs.length; $art_izrjrbmump$art_i < $art_clejsvcqw$art_c; $art_izrjrbmump$art_i++) {    var nav = navs[$art_izrjrbmump$art_i]%>';
    for (var $art_izrjrbmump$art_i = 0, $art_clejsvcqw$art_c = navs.length; $art_izrjrbmump$art_i < $art_clejsvcqw$art_c; $art_izrjrbmump$art_i++) {
        var nav = navs[$art_izrjrbmump$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
