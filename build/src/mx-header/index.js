...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_casjwpk$art_c = list.length; index < $art_casjwpk$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_casjwpk$art_c = list.length; index < $art_casjwpk$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ivoskuumvi$art_i = 0, $art_objjarajatqp$art_obj = item.seconds, $art_cauqbgmft$art_c = $art_objjarajatqp$art_obj.length; $art_ivoskuumvi$art_i < $art_cauqbgmft$art_c; $art_ivoskuumvi$art_i++) {        var second = $art_objjarajatqp$art_obj[$art_ivoskuumvi$art_i]%>';
        for (var $art_ivoskuumvi$art_i = 0, $art_objjarajatqp$art_obj = item.seconds, $art_cauqbgmft$art_c = $art_objjarajatqp$art_obj.length; $art_ivoskuumvi$art_i < $art_cauqbgmft$art_c; $art_ivoskuumvi$art_i++) {
            var second = $art_objjarajatqp$art_obj[$art_ivoskuumvi$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iddtvzo$art_i = 0, $art_objsqnjynsb$art_obj = second.thirds, $art_ctqcycencpl$art_c = $art_objsqnjynsb$art_obj.length; $art_iddtvzo$art_i < $art_ctqcycencpl$art_c; $art_iddtvzo$art_i++) {            var third = $art_objsqnjynsb$art_obj[$art_iddtvzo$art_i]%>';
            for (var $art_iddtvzo$art_i = 0, $art_objsqnjynsb$art_obj = second.thirds, $art_ctqcycencpl$art_c = $art_objsqnjynsb$art_obj.length; $art_iddtvzo$art_i < $art_ctqcycencpl$art_c; $art_iddtvzo$art_i++) {
                var third = $art_objsqnjynsb$art_obj[$art_iddtvzo$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_inlspyjad$art_i = 0, $art_cqwpntxvml$art_c = navs.length; $art_inlspyjad$art_i < $art_cqwpntxvml$art_c; $art_inlspyjad$art_i++) {    var nav = navs[$art_inlspyjad$art_i]%>';
    for (var $art_inlspyjad$art_i = 0, $art_cqwpntxvml$art_c = navs.length; $art_inlspyjad$art_i < $art_cqwpntxvml$art_c; $art_inlspyjad$art_i++) {
        var nav = navs[$art_inlspyjad$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
