...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_catszhotr$art_c = list.length; index < $art_catszhotr$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_catszhotr$art_c = list.length; index < $art_catszhotr$art_c; index++) {
        var item = list[index];
        ...
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_gallerycg:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links ';
        $line = 12;
        ...
        ;
        $expr = '<%for (var $art_irutpbtohv$art_i = 0, $art_objsemafjsr$art_obj = item.seconds, $art_cmpxwlhaxs$art_c = $art_objsemafjsr$art_obj.length; $art_irutpbtohv$art_i < $art_cmpxwlhaxs$art_c; $art_irutpbtohv$art_i++) {        var second = $art_objsemafjsr$art_obj[$art_irutpbtohv$art_i]%>';
        for (var $art_irutpbtohv$art_i = 0, $art_objsemafjsr$art_obj = item.seconds, $art_cmpxwlhaxs$art_c = $art_objsemafjsr$art_obj.length; $art_irutpbtohv$art_i < $art_cmpxwlhaxs$art_c; $art_irutpbtohv$art_i++) {
            var second = $art_objsemafjsr$art_obj[$art_irutpbtohv$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ivakblur$art_i = 0, $art_objjzbnmfmlr$art_obj = second.thirds, $art_ctubafeq$art_c = $art_objjzbnmfmlr$art_obj.length; $art_ivakblur$art_i < $art_ctubafeq$art_c; $art_ivakblur$art_i++) {            var third = $art_objjzbnmfmlr$art_obj[$art_ivakblur$art_i]%>';
            for (var $art_ivakblur$art_i = 0, $art_objjzbnmfmlr$art_obj = second.thirds, $art_ctubafeq$art_c = $art_objjzbnmfmlr$art_obj.length; $art_ivakblur$art_i < $art_ctubafeq$art_c; $art_ivakblur$art_i++) {
                var third = $art_objjzbnmfmlr$art_obj[$art_ivakblur$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iubtfrukuj$art_i = 0, $art_cbrvbyd$art_c = navs.length; $art_iubtfrukuj$art_i < $art_cbrvbyd$art_c; $art_iubtfrukuj$art_i++) {        var nav = navs[$art_iubtfrukuj$art_i]%>';
        for (var $art_iubtfrukuj$art_i = 0, $art_cbrvbyd$art_c = navs.length; $art_iubtfrukuj$art_i < $art_cbrvbyd$art_c; $art_iubtfrukuj$art_i++) {
            var nav = navs[$art_iubtfrukuj$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
