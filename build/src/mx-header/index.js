...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cwgfawiiqw$art_c = list.length; index < $art_cwgfawiiqw$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cwgfawiiqw$art_c = list.length; index < $art_cwgfawiiqw$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ityvxmop$art_i = 0, $art_objlthincnc$art_obj = item.seconds, $art_cbukrvzgjkli$art_c = $art_objlthincnc$art_obj.length; $art_ityvxmop$art_i < $art_cbukrvzgjkli$art_c; $art_ityvxmop$art_i++) {        var second = $art_objlthincnc$art_obj[$art_ityvxmop$art_i]%>';
        for (var $art_ityvxmop$art_i = 0, $art_objlthincnc$art_obj = item.seconds, $art_cbukrvzgjkli$art_c = $art_objlthincnc$art_obj.length; $art_ityvxmop$art_i < $art_cbukrvzgjkli$art_c; $art_ityvxmop$art_i++) {
            var second = $art_objlthincnc$art_obj[$art_ityvxmop$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iigwpvw$art_i = 0, $art_objqbkopb$art_obj = second.thirds, $art_cefpnflrjem$art_c = $art_objqbkopb$art_obj.length; $art_iigwpvw$art_i < $art_cefpnflrjem$art_c; $art_iigwpvw$art_i++) {            var third = $art_objqbkopb$art_obj[$art_iigwpvw$art_i]%>';
            for (var $art_iigwpvw$art_i = 0, $art_objqbkopb$art_obj = second.thirds, $art_cefpnflrjem$art_c = $art_objqbkopb$art_obj.length; $art_iigwpvw$art_i < $art_cefpnflrjem$art_c; $art_iigwpvw$art_i++) {
                var third = $art_objqbkopb$art_obj[$art_iigwpvw$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iugxzpesoi$art_i = 0, $art_czniftdans$art_c = navs.length; $art_iugxzpesoi$art_i < $art_czniftdans$art_c; $art_iugxzpesoi$art_i++) {        var nav = navs[$art_iugxzpesoi$art_i]%>';
        for (var $art_iugxzpesoi$art_i = 0, $art_czniftdans$art_c = navs.length; $art_iugxzpesoi$art_i < $art_czniftdans$art_c; $art_iugxzpesoi$art_i++) {
            var nav = navs[$art_iugxzpesoi$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
