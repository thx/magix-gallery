...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_czukkpeudl$art_c = list.length; index < $art_czukkpeudl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_czukkpeudl$art_c = list.length; index < $art_czukkpeudl$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iepbrfcmen$art_i = 0, $art_objtqvkecmv$art_obj = item.seconds, $art_cezxy$art_c = $art_objtqvkecmv$art_obj.length; $art_iepbrfcmen$art_i < $art_cezxy$art_c; $art_iepbrfcmen$art_i++) {        var second = $art_objtqvkecmv$art_obj[$art_iepbrfcmen$art_i]%>';
        for (var $art_iepbrfcmen$art_i = 0, $art_objtqvkecmv$art_obj = item.seconds, $art_cezxy$art_c = $art_objtqvkecmv$art_obj.length; $art_iepbrfcmen$art_i < $art_cezxy$art_c; $art_iepbrfcmen$art_i++) {
            var second = $art_objtqvkecmv$art_obj[$art_iepbrfcmen$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ithzclw$art_i = 0, $art_objjstvbonp$art_obj = second.thirds, $art_csntvftwir$art_c = $art_objjstvbonp$art_obj.length; $art_ithzclw$art_i < $art_csntvftwir$art_c; $art_ithzclw$art_i++) {            var third = $art_objjstvbonp$art_obj[$art_ithzclw$art_i]%>';
            for (var $art_ithzclw$art_i = 0, $art_objjstvbonp$art_obj = second.thirds, $art_csntvftwir$art_c = $art_objjstvbonp$art_obj.length; $art_ithzclw$art_i < $art_csntvftwir$art_c; $art_ithzclw$art_i++) {
                var third = $art_objjstvbonp$art_obj[$art_ithzclw$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ilyhfpk$art_i = 0, $art_cruzcgajsf$art_c = navs.length; $art_ilyhfpk$art_i < $art_cruzcgajsf$art_c; $art_ilyhfpk$art_i++) {        var nav = navs[$art_ilyhfpk$art_i]%>';
        for (var $art_ilyhfpk$art_i = 0, $art_cruzcgajsf$art_c = navs.length; $art_ilyhfpk$art_i < $art_cruzcgajsf$art_c; $art_ilyhfpk$art_i++) {
            var nav = navs[$art_ilyhfpk$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
