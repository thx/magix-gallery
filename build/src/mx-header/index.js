...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cxhspgfes$art_c = list.length; index < $art_cxhspgfes$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cxhspgfes$art_c = list.length; index < $art_cxhspgfes$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_icrtdsveo$art_i = 0, $art_objtmstdqdpu$art_obj = item.seconds, $art_ccihfnhj$art_c = $art_objtmstdqdpu$art_obj.length; $art_icrtdsveo$art_i < $art_ccihfnhj$art_c; $art_icrtdsveo$art_i++) {        var second = $art_objtmstdqdpu$art_obj[$art_icrtdsveo$art_i]%>';
        for (var $art_icrtdsveo$art_i = 0, $art_objtmstdqdpu$art_obj = item.seconds, $art_ccihfnhj$art_c = $art_objtmstdqdpu$art_obj.length; $art_icrtdsveo$art_i < $art_ccihfnhj$art_c; $art_icrtdsveo$art_i++) {
            var second = $art_objtmstdqdpu$art_obj[$art_icrtdsveo$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ilbgtaysm$art_i = 0, $art_objrdptem$art_obj = second.thirds, $art_chdvdamqe$art_c = $art_objrdptem$art_obj.length; $art_ilbgtaysm$art_i < $art_chdvdamqe$art_c; $art_ilbgtaysm$art_i++) {            var third = $art_objrdptem$art_obj[$art_ilbgtaysm$art_i]%>';
            for (var $art_ilbgtaysm$art_i = 0, $art_objrdptem$art_obj = second.thirds, $art_chdvdamqe$art_c = $art_objrdptem$art_obj.length; $art_ilbgtaysm$art_i < $art_chdvdamqe$art_c; $art_ilbgtaysm$art_i++) {
                var third = $art_objrdptem$art_obj[$art_ilbgtaysm$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_ifrmdlatml$art_i = 0, $art_cnkus$art_c = navs.length; $art_ifrmdlatml$art_i < $art_cnkus$art_c; $art_ifrmdlatml$art_i++) {    var nav = navs[$art_ifrmdlatml$art_i]%>';
    for (var $art_ifrmdlatml$art_i = 0, $art_cnkus$art_c = navs.length; $art_ifrmdlatml$art_i < $art_cnkus$art_c; $art_ifrmdlatml$art_i++) {
        var nav = navs[$art_ifrmdlatml$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
