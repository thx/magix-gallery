...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ceywqojohf$art_c = list.length; index < $art_ceywqojohf$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ceywqojohf$art_c = list.length; index < $art_ceywqojohf$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_izpzhupenl$art_i = 0, $art_objichohcmcl$art_obj = item.seconds, $art_cremwxqv$art_c = $art_objichohcmcl$art_obj.length; $art_izpzhupenl$art_i < $art_cremwxqv$art_c; $art_izpzhupenl$art_i++) {        var second = $art_objichohcmcl$art_obj[$art_izpzhupenl$art_i]%>';
        for (var $art_izpzhupenl$art_i = 0, $art_objichohcmcl$art_obj = item.seconds, $art_cremwxqv$art_c = $art_objichohcmcl$art_obj.length; $art_izpzhupenl$art_i < $art_cremwxqv$art_c; $art_izpzhupenl$art_i++) {
            var second = $art_objichohcmcl$art_obj[$art_izpzhupenl$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_irddlzddws$art_i = 0, $art_objvqiwylag$art_obj = second.thirds, $art_cxlquqt$art_c = $art_objvqiwylag$art_obj.length; $art_irddlzddws$art_i < $art_cxlquqt$art_c; $art_irddlzddws$art_i++) {            var third = $art_objvqiwylag$art_obj[$art_irddlzddws$art_i]%>';
            for (var $art_irddlzddws$art_i = 0, $art_objvqiwylag$art_obj = second.thirds, $art_cxlquqt$art_c = $art_objvqiwylag$art_obj.length; $art_irddlzddws$art_i < $art_cxlquqt$art_c; $art_irddlzddws$art_i++) {
                var third = $art_objvqiwylag$art_obj[$art_irddlzddws$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_icbqkjcip$art_i = 0, $art_cssiqquubmk$art_c = navs.length; $art_icbqkjcip$art_i < $art_cssiqquubmk$art_c; $art_icbqkjcip$art_i++) {    var nav = navs[$art_icbqkjcip$art_i]%>';
    for (var $art_icbqkjcip$art_i = 0, $art_cssiqquubmk$art_c = navs.length; $art_icbqkjcip$art_i < $art_cssiqquubmk$art_c; $art_icbqkjcip$art_i++) {
        var nav = navs[$art_icbqkjcip$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
