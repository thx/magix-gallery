...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cgrzcdefpunc$art_c = list.length; index < $art_cgrzcdefpunc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cgrzcdefpunc$art_c = list.length; index < $art_cgrzcdefpunc$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_icgzndvl$art_i = 0, $art_objdbjka$art_obj = item.seconds, $art_chxvbljm$art_c = $art_objdbjka$art_obj.length; $art_icgzndvl$art_i < $art_chxvbljm$art_c; $art_icgzndvl$art_i++) {        var second = $art_objdbjka$art_obj[$art_icgzndvl$art_i]%>';
        for (var $art_icgzndvl$art_i = 0, $art_objdbjka$art_obj = item.seconds, $art_chxvbljm$art_c = $art_objdbjka$art_obj.length; $art_icgzndvl$art_i < $art_chxvbljm$art_c; $art_icgzndvl$art_i++) {
            var second = $art_objdbjka$art_obj[$art_icgzndvl$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iylmevxtxac$art_i = 0, $art_objmrqlbdbvn$art_obj = second.thirds, $art_cknxrgjcq$art_c = $art_objmrqlbdbvn$art_obj.length; $art_iylmevxtxac$art_i < $art_cknxrgjcq$art_c; $art_iylmevxtxac$art_i++) {            var third = $art_objmrqlbdbvn$art_obj[$art_iylmevxtxac$art_i]%>';
            for (var $art_iylmevxtxac$art_i = 0, $art_objmrqlbdbvn$art_obj = second.thirds, $art_cknxrgjcq$art_c = $art_objmrqlbdbvn$art_obj.length; $art_iylmevxtxac$art_i < $art_cknxrgjcq$art_c; $art_iylmevxtxac$art_i++) {
                var third = $art_objmrqlbdbvn$art_obj[$art_iylmevxtxac$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ivhtqjyknj$art_i = 0, $art_ctctgnvc$art_c = navs.length; $art_ivhtqjyknj$art_i < $art_ctctgnvc$art_c; $art_ivhtqjyknj$art_i++) {        var nav = navs[$art_ivhtqjyknj$art_i]%>';
        for (var $art_ivhtqjyknj$art_i = 0, $art_ctctgnvc$art_c = navs.length; $art_ivhtqjyknj$art_i < $art_ctctgnvc$art_c; $art_ivhtqjyknj$art_i++) {
            var nav = navs[$art_ivhtqjyknj$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
