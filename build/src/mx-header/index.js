...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cwtoufzwgq$art_c = list.length; index < $art_cwtoufzwgq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cwtoufzwgq$art_c = list.length; index < $art_cwtoufzwgq$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_itzfh$art_i = 0, $art_objcqtpugaj$art_obj = item.seconds, $art_cprotxkq$art_c = $art_objcqtpugaj$art_obj.length; $art_itzfh$art_i < $art_cprotxkq$art_c; $art_itzfh$art_i++) {        var second = $art_objcqtpugaj$art_obj[$art_itzfh$art_i]%>';
        for (var $art_itzfh$art_i = 0, $art_objcqtpugaj$art_obj = item.seconds, $art_cprotxkq$art_c = $art_objcqtpugaj$art_obj.length; $art_itzfh$art_i < $art_cprotxkq$art_c; $art_itzfh$art_i++) {
            var second = $art_objcqtpugaj$art_obj[$art_itzfh$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ipagapyok$art_i = 0, $art_objdyqcsl$art_obj = second.thirds, $art_czbpkwx$art_c = $art_objdyqcsl$art_obj.length; $art_ipagapyok$art_i < $art_czbpkwx$art_c; $art_ipagapyok$art_i++) {            var third = $art_objdyqcsl$art_obj[$art_ipagapyok$art_i]%>';
            for (var $art_ipagapyok$art_i = 0, $art_objdyqcsl$art_obj = second.thirds, $art_czbpkwx$art_c = $art_objdyqcsl$art_obj.length; $art_ipagapyok$art_i < $art_czbpkwx$art_c; $art_ipagapyok$art_i++) {
                var third = $art_objdyqcsl$art_obj[$art_ipagapyok$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iodjwjjs$art_i = 0, $art_cuqroskuic$art_c = navs.length; $art_iodjwjjs$art_i < $art_cuqroskuic$art_c; $art_iodjwjjs$art_i++) {        var nav = navs[$art_iodjwjjs$art_i]%>';
        for (var $art_iodjwjjs$art_i = 0, $art_cuqroskuic$art_c = navs.length; $art_iodjwjjs$art_i < $art_cuqroskuic$art_c; $art_iodjwjjs$art_i++) {
            var nav = navs[$art_iodjwjjs$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
