...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_ckszaqhyzq$art_c = list.length; index < $art_ckszaqhyzq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ckszaqhyzq$art_c = list.length; index < $art_ckszaqhyzq$art_c; index++) {
        var item = list[index];
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ilnzbtfr$art_i = 0, $art_objitrodgxop$art_obj = item.seconds, $art_cdjfmr$art_c = $art_objitrodgxop$art_obj.length; $art_ilnzbtfr$art_i < $art_cdjfmr$art_c; $art_ilnzbtfr$art_i++) {        var second = $art_objitrodgxop$art_obj[$art_ilnzbtfr$art_i]%>';
        for (var $art_ilnzbtfr$art_i = 0, $art_objitrodgxop$art_obj = item.seconds, $art_cdjfmr$art_c = $art_objitrodgxop$art_obj.length; $art_ilnzbtfr$art_i < $art_cdjfmr$art_c; $art_ilnzbtfr$art_i++) {
            var second = $art_objitrodgxop$art_obj[$art_ilnzbtfr$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_iltbkbdwiqj$art_i = 0, $art_objgsom$art_obj = second.thirds, $art_cgmmtwdityk$art_c = $art_objgsom$art_obj.length; $art_iltbkbdwiqj$art_i < $art_cgmmtwdityk$art_c; $art_iltbkbdwiqj$art_i++) {            var third = $art_objgsom$art_obj[$art_iltbkbdwiqj$art_i]%>';
            for (var $art_iltbkbdwiqj$art_i = 0, $art_objgsom$art_obj = second.thirds, $art_cgmmtwdityk$art_c = $art_objgsom$art_obj.length; $art_iltbkbdwiqj$art_i < $art_cgmmtwdityk$art_c; $art_iltbkbdwiqj$art_i++) {
                var third = $art_objgsom$art_obj[$art_iltbkbdwiqj$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_igiyiueclyyf$art_i = 0, $art_cbikzzqwn$art_c = navs.length; $art_igiyiueclyyf$art_i < $art_cbikzzqwn$art_c; $art_igiyiueclyyf$art_i++) {    var nav = navs[$art_igiyiueclyyf$art_i]%>';
    for (var $art_igiyiueclyyf$art_i = 0, $art_cbikzzqwn$art_c = navs.length; $art_igiyiueclyyf$art_i < $art_cbikzzqwn$art_c; $art_igiyiueclyyf$art_i++) {
        var nav = navs[$art_igiyiueclyyf$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
