...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ceeuabtctof$art_c = list.length; index < $art_ceeuabtctof$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ceeuabtctof$art_c = list.length; index < $art_ceeuabtctof$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iqonfzekk$art_i = 0, $art_objbgaz$art_obj = item.seconds, $art_ctaklyqdvi$art_c = $art_objbgaz$art_obj.length; $art_iqonfzekk$art_i < $art_ctaklyqdvi$art_c; $art_iqonfzekk$art_i++) {        var second = $art_objbgaz$art_obj[$art_iqonfzekk$art_i]%>';
        for (var $art_iqonfzekk$art_i = 0, $art_objbgaz$art_obj = item.seconds, $art_ctaklyqdvi$art_c = $art_objbgaz$art_obj.length; $art_iqonfzekk$art_i < $art_ctaklyqdvi$art_c; $art_iqonfzekk$art_i++) {
            var second = $art_objbgaz$art_obj[$art_iqonfzekk$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_idswnrr$art_i = 0, $art_objuwxphos$art_obj = second.thirds, $art_ccvnivjk$art_c = $art_objuwxphos$art_obj.length; $art_idswnrr$art_i < $art_ccvnivjk$art_c; $art_idswnrr$art_i++) {            var third = $art_objuwxphos$art_obj[$art_idswnrr$art_i]%>';
            for (var $art_idswnrr$art_i = 0, $art_objuwxphos$art_obj = second.thirds, $art_ccvnivjk$art_c = $art_objuwxphos$art_obj.length; $art_idswnrr$art_i < $art_ccvnivjk$art_c; $art_idswnrr$art_i++) {
                var third = $art_objuwxphos$art_obj[$art_idswnrr$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_itkvtako$art_i = 0, $art_cwafusznin$art_c = navs.length; $art_itkvtako$art_i < $art_cwafusznin$art_c; $art_itkvtako$art_i++) {        var nav = navs[$art_itkvtako$art_i]%>';
        for (var $art_itkvtako$art_i = 0, $art_cwafusznin$art_c = navs.length; $art_itkvtako$art_i < $art_cwafusznin$art_c; $art_itkvtako$art_i++) {
            var nav = navs[$art_itkvtako$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
