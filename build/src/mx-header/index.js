...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerycs:_" class="_zs_gallery_mx-header_index_-header"><div class="_zs_gallery_mx-header_index_-others clearfix" style="width: ';
    $line = 2;
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_gallerycs:_" class="fl mr35"><a class="_zs_gallery_mx-header_index_-text _zs_gallery_mx-header_index_-text-h-brand" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
    $line = 6;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cctrjt$art_c = list.length; index < $art_cctrjt$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cctrjt$art_c = list.length; index < $art_cctrjt$art_c; index++) {
        var item = list[index];
        ...
        $art = '=index';
        ;
        $p += ($expr = '<%=index%>', $e(index)) + ',height:0})"><span mxa="_zs_gallerycs:a" class="_zs_gallery_mx-header_index_-text">';
        $line = 10;
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_gallerycs:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links ';
        $line = 12;
        $art = 'if (item.showHeight > 0)';
        ;
        $expr = '<%if (item.showHeight > 0) {%>';
        if (item.showHeight > 0) {
            ;
            $p += ' mx-shadow ';
            $line = 12;
            $art = '/if';
        ...
        ;
        $expr = '<%for (var $art_iihprlpjtr$art_i = 0, $art_objrdlcgnobxs$art_obj = item.seconds, $art_cuowcxuwvei$art_c = $art_objrdlcgnobxs$art_obj.length; $art_iihprlpjtr$art_i < $art_cuowcxuwvei$art_c; $art_iihprlpjtr$art_i++) {        var second = $art_objrdlcgnobxs$art_obj[$art_iihprlpjtr$art_i]%>';
        for (var $art_iihprlpjtr$art_i = 0, $art_objrdlcgnobxs$art_obj = item.seconds, $art_cuowcxuwvei$art_c = $art_objrdlcgnobxs$art_obj.length; $art_iihprlpjtr$art_i < $art_cuowcxuwvei$art_c; $art_iihprlpjtr$art_i++) {
            var second = $art_objrdlcgnobxs$art_obj[$art_iihprlpjtr$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ievetdkrppl$art_i = 0, $art_objayspethzu$art_obj = second.thirds, $art_cjetevogf$art_c = $art_objayspethzu$art_obj.length; $art_ievetdkrppl$art_i < $art_cjetevogf$art_c; $art_ievetdkrppl$art_i++) {            var third = $art_objayspethzu$art_obj[$art_ievetdkrppl$art_i]%>';
            for (var $art_ievetdkrppl$art_i = 0, $art_objayspethzu$art_obj = second.thirds, $art_cjetevogf$art_c = $art_objayspethzu$art_obj.length; $art_ievetdkrppl$art_i < $art_cjetevogf$art_c; $art_ievetdkrppl$art_i++) {
                var third = $art_objayspethzu$art_obj[$art_ievetdkrppl$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxa="_zs_gallerycs:b" class="_zs_gallery_mx-header_index_-logo"><img src="';
    $line = 30;
    $art = '=logo';
    ;
    ...
    if (navs.length > 0) {
        ;
        $p += '<div mxa="_zs_gallerycs:c" class="_zs_gallery_mx-header_index_-navs">';
        $line = 34;
        $art = 'each navs as nav';
        ;
        $expr = '<%for (var $art_izdysnpzkwpj$art_i = 0, $art_cefbadbxe$art_c = navs.length; $art_izdysnpzkwpj$art_i < $art_cefbadbxe$art_c; $art_izdysnpzkwpj$art_i++) {        var nav = navs[$art_izdysnpzkwpj$art_i]%>';
        for (var $art_izdysnpzkwpj$art_i = 0, $art_cefbadbxe$art_c = navs.length; $art_izdysnpzkwpj$art_i < $art_cefbadbxe$art_c; $art_izdysnpzkwpj$art_i++) {
            var nav = navs[$art_izdysnpzkwpj$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
