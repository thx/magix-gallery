...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cqufhqqvoas$art_c = list.length; index < $art_cqufhqqvoas$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cqufhqqvoas$art_c = list.length; index < $art_cqufhqqvoas$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_imrqpmpljqa$art_i = 0, $art_objygsdhawtc$art_obj = item.seconds, $art_ccprve$art_c = $art_objygsdhawtc$art_obj.length; $art_imrqpmpljqa$art_i < $art_ccprve$art_c; $art_imrqpmpljqa$art_i++) {        var second = $art_objygsdhawtc$art_obj[$art_imrqpmpljqa$art_i]%>';
        for (var $art_imrqpmpljqa$art_i = 0, $art_objygsdhawtc$art_obj = item.seconds, $art_ccprve$art_c = $art_objygsdhawtc$art_obj.length; $art_imrqpmpljqa$art_i < $art_ccprve$art_c; $art_imrqpmpljqa$art_i++) {
            var second = $art_objygsdhawtc$art_obj[$art_imrqpmpljqa$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_isulkfupg$art_i = 0, $art_objwyykrrhzb$art_obj = second.thirds, $art_cfkqewbil$art_c = $art_objwyykrrhzb$art_obj.length; $art_isulkfupg$art_i < $art_cfkqewbil$art_c; $art_isulkfupg$art_i++) {            var third = $art_objwyykrrhzb$art_obj[$art_isulkfupg$art_i]%>';
            for (var $art_isulkfupg$art_i = 0, $art_objwyykrrhzb$art_obj = second.thirds, $art_cfkqewbil$art_c = $art_objwyykrrhzb$art_obj.length; $art_isulkfupg$art_i < $art_cfkqewbil$art_c; $art_isulkfupg$art_i++) {
                var third = $art_objwyykrrhzb$art_obj[$art_isulkfupg$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ilfvdvfh$art_i = 0, $art_cmfrafiy$art_c = navs.length; $art_ilfvdvfh$art_i < $art_cmfrafiy$art_c; $art_ilfvdvfh$art_i++) {        var nav = navs[$art_ilfvdvfh$art_i]%>';
        for (var $art_ilfvdvfh$art_i = 0, $art_cmfrafiy$art_c = navs.length; $art_ilfvdvfh$art_i < $art_cmfrafiy$art_c; $art_ilfvdvfh$art_i++) {
            var nav = navs[$art_ilfvdvfh$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
