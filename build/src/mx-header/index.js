...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_clqhfgiphc$art_c = list.length; index < $art_clqhfgiphc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_clqhfgiphc$art_c = list.length; index < $art_clqhfgiphc$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ifujngxyhw$art_i = 0, $art_objmuawvbi$art_obj = item.seconds, $art_csfogjpg$art_c = $art_objmuawvbi$art_obj.length; $art_ifujngxyhw$art_i < $art_csfogjpg$art_c; $art_ifujngxyhw$art_i++) {        var second = $art_objmuawvbi$art_obj[$art_ifujngxyhw$art_i]%>';
        for (var $art_ifujngxyhw$art_i = 0, $art_objmuawvbi$art_obj = item.seconds, $art_csfogjpg$art_c = $art_objmuawvbi$art_obj.length; $art_ifujngxyhw$art_i < $art_csfogjpg$art_c; $art_ifujngxyhw$art_i++) {
            var second = $art_objmuawvbi$art_obj[$art_ifujngxyhw$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_izvtbuel$art_i = 0, $art_objnkesvmoxq$art_obj = second.thirds, $art_cxmmdrw$art_c = $art_objnkesvmoxq$art_obj.length; $art_izvtbuel$art_i < $art_cxmmdrw$art_c; $art_izvtbuel$art_i++) {            var third = $art_objnkesvmoxq$art_obj[$art_izvtbuel$art_i]%>';
            for (var $art_izvtbuel$art_i = 0, $art_objnkesvmoxq$art_obj = second.thirds, $art_cxmmdrw$art_c = $art_objnkesvmoxq$art_obj.length; $art_izvtbuel$art_i < $art_cxmmdrw$art_c; $art_izvtbuel$art_i++) {
                var third = $art_objnkesvmoxq$art_obj[$art_izvtbuel$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iumehvedc$art_i = 0, $art_cqiegykh$art_c = navs.length; $art_iumehvedc$art_i < $art_cqiegykh$art_c; $art_iumehvedc$art_i++) {        var nav = navs[$art_iumehvedc$art_i]%>';
        for (var $art_iumehvedc$art_i = 0, $art_cqiegykh$art_c = navs.length; $art_iumehvedc$art_i < $art_cqiegykh$art_c; $art_iumehvedc$art_i++) {
            var nav = navs[$art_iumehvedc$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
