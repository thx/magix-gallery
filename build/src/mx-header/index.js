...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cebvbscgbnf$art_c = list.length; index < $art_cebvbscgbnf$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cebvbscgbnf$art_c = list.length; index < $art_cebvbscgbnf$art_c; index++) {
        var item = list[index];
        ...
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_galleryci:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links" style="height: ';
        $line = 12;
        $art = '=item.showHeight';
        ;
        ...
        ;
        $expr = '<%for (var $art_iauxtzcz$art_i = 0, $art_objuvcuiyjc$art_obj = item.seconds, $art_cfeswaspansa$art_c = $art_objuvcuiyjc$art_obj.length; $art_iauxtzcz$art_i < $art_cfeswaspansa$art_c; $art_iauxtzcz$art_i++) {        var second = $art_objuvcuiyjc$art_obj[$art_iauxtzcz$art_i]%>';
        for (var $art_iauxtzcz$art_i = 0, $art_objuvcuiyjc$art_obj = item.seconds, $art_cfeswaspansa$art_c = $art_objuvcuiyjc$art_obj.length; $art_iauxtzcz$art_i < $art_cfeswaspansa$art_c; $art_iauxtzcz$art_i++) {
            var second = $art_objuvcuiyjc$art_obj[$art_iauxtzcz$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ifemrkiwdpi$art_i = 0, $art_objhkucwolo$art_obj = second.thirds, $art_cnzwvomvmhr$art_c = $art_objhkucwolo$art_obj.length; $art_ifemrkiwdpi$art_i < $art_cnzwvomvmhr$art_c; $art_ifemrkiwdpi$art_i++) {            var third = $art_objhkucwolo$art_obj[$art_ifemrkiwdpi$art_i]%>';
            for (var $art_ifemrkiwdpi$art_i = 0, $art_objhkucwolo$art_obj = second.thirds, $art_cnzwvomvmhr$art_c = $art_objhkucwolo$art_obj.length; $art_ifemrkiwdpi$art_i < $art_cnzwvomvmhr$art_c; $art_ifemrkiwdpi$art_i++) {
                var third = $art_objhkucwolo$art_obj[$art_ifemrkiwdpi$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ivxrerzyk$art_i = 0, $art_cfledtaq$art_c = navs.length; $art_ivxrerzyk$art_i < $art_cfledtaq$art_c; $art_ivxrerzyk$art_i++) {        var nav = navs[$art_ivxrerzyk$art_i]%>';
        for (var $art_ivxrerzyk$art_i = 0, $art_cfledtaq$art_c = navs.length; $art_ivxrerzyk$art_i < $art_cfledtaq$art_c; $art_ivxrerzyk$art_i++) {
            var nav = navs[$art_ivxrerzyk$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
