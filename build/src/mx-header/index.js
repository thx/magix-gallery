...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cvcbkuu$art_c = list.length; index < $art_cvcbkuu$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cvcbkuu$art_c = list.length; index < $art_cvcbkuu$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iedhpopmr$art_i = 0, $art_objyjiccbsq$art_obj = item.seconds, $art_cmohrwentphn$art_c = $art_objyjiccbsq$art_obj.length; $art_iedhpopmr$art_i < $art_cmohrwentphn$art_c; $art_iedhpopmr$art_i++) {        var second = $art_objyjiccbsq$art_obj[$art_iedhpopmr$art_i]%>';
        for (var $art_iedhpopmr$art_i = 0, $art_objyjiccbsq$art_obj = item.seconds, $art_cmohrwentphn$art_c = $art_objyjiccbsq$art_obj.length; $art_iedhpopmr$art_i < $art_cmohrwentphn$art_c; $art_iedhpopmr$art_i++) {
            var second = $art_objyjiccbsq$art_obj[$art_iedhpopmr$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_irlufkjyu$art_i = 0, $art_objwqkqpszzjk$art_obj = second.thirds, $art_cjhvvd$art_c = $art_objwqkqpszzjk$art_obj.length; $art_irlufkjyu$art_i < $art_cjhvvd$art_c; $art_irlufkjyu$art_i++) {            var third = $art_objwqkqpszzjk$art_obj[$art_irlufkjyu$art_i]%>';
            for (var $art_irlufkjyu$art_i = 0, $art_objwqkqpszzjk$art_obj = second.thirds, $art_cjhvvd$art_c = $art_objwqkqpszzjk$art_obj.length; $art_irlufkjyu$art_i < $art_cjhvvd$art_c; $art_irlufkjyu$art_i++) {
                var third = $art_objwqkqpszzjk$art_obj[$art_irlufkjyu$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_idnodnrekje$art_i = 0, $art_cjpckvgb$art_c = navs.length; $art_idnodnrekje$art_i < $art_cjpckvgb$art_c; $art_idnodnrekje$art_i++) {    var nav = navs[$art_idnodnrekje$art_i]%>';
    for (var $art_idnodnrekje$art_i = 0, $art_cjpckvgb$art_c = navs.length; $art_idnodnrekje$art_i < $art_cjpckvgb$art_c; $art_idnodnrekje$art_i++) {
        var nav = navs[$art_idnodnrekje$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
