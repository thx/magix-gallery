...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_csmuqe$art_c = list.length; index < $art_csmuqe$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_csmuqe$art_c = list.length; index < $art_csmuqe$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_ivjzfm$art_i = 0, $art_objohaullcx$art_obj = item.seconds, $art_csgzzhz$art_c = $art_objohaullcx$art_obj.length; $art_ivjzfm$art_i < $art_csgzzhz$art_c; $art_ivjzfm$art_i++) {        var second = $art_objohaullcx$art_obj[$art_ivjzfm$art_i]%>';
        for (var $art_ivjzfm$art_i = 0, $art_objohaullcx$art_obj = item.seconds, $art_csgzzhz$art_c = $art_objohaullcx$art_obj.length; $art_ivjzfm$art_i < $art_csgzzhz$art_c; $art_ivjzfm$art_i++) {
            var second = $art_objohaullcx$art_obj[$art_ivjzfm$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ivjyxfvq$art_i = 0, $art_objxkgpsazvz$art_obj = second.thirds, $art_cqyspzlts$art_c = $art_objxkgpsazvz$art_obj.length; $art_ivjyxfvq$art_i < $art_cqyspzlts$art_c; $art_ivjyxfvq$art_i++) {            var third = $art_objxkgpsazvz$art_obj[$art_ivjyxfvq$art_i]%>';
            for (var $art_ivjyxfvq$art_i = 0, $art_objxkgpsazvz$art_obj = second.thirds, $art_cqyspzlts$art_c = $art_objxkgpsazvz$art_obj.length; $art_ivjyxfvq$art_i < $art_cqyspzlts$art_c; $art_ivjyxfvq$art_i++) {
                var third = $art_objxkgpsazvz$art_obj[$art_ivjyxfvq$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_iztjia$art_i = 0, $art_czjvnbzj$art_c = navs.length; $art_iztjia$art_i < $art_czjvnbzj$art_c; $art_iztjia$art_i++) {    var nav = navs[$art_iztjia$art_i]%>';
    for (var $art_iztjia$art_i = 0, $art_czjvnbzj$art_c = navs.length; $art_iztjia$art_i < $art_czjvnbzj$art_c; $art_iztjia$art_i++) {
        var nav = navs[$art_iztjia$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
