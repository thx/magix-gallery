...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cmvzjosy$art_c = list.length; index < $art_cmvzjosy$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cmvzjosy$art_c = list.length; index < $art_cmvzjosy$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_intzrpweqxr$art_i = 0, $art_objycbkbesb$art_obj = item.seconds, $art_cuddkdvfg$art_c = $art_objycbkbesb$art_obj.length; $art_intzrpweqxr$art_i < $art_cuddkdvfg$art_c; $art_intzrpweqxr$art_i++) {        var second = $art_objycbkbesb$art_obj[$art_intzrpweqxr$art_i]%>';
        for (var $art_intzrpweqxr$art_i = 0, $art_objycbkbesb$art_obj = item.seconds, $art_cuddkdvfg$art_c = $art_objycbkbesb$art_obj.length; $art_intzrpweqxr$art_i < $art_cuddkdvfg$art_c; $art_intzrpweqxr$art_i++) {
            var second = $art_objycbkbesb$art_obj[$art_intzrpweqxr$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iimtulcm$art_i = 0, $art_objnlffpufe$art_obj = second.thirds, $art_cuiritna$art_c = $art_objnlffpufe$art_obj.length; $art_iimtulcm$art_i < $art_cuiritna$art_c; $art_iimtulcm$art_i++) {            var third = $art_objnlffpufe$art_obj[$art_iimtulcm$art_i]%>';
            for (var $art_iimtulcm$art_i = 0, $art_objnlffpufe$art_obj = second.thirds, $art_cuiritna$art_c = $art_objnlffpufe$art_obj.length; $art_iimtulcm$art_i < $art_cuiritna$art_c; $art_iimtulcm$art_i++) {
                var third = $art_objnlffpufe$art_obj[$art_iimtulcm$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ilwvpjaniud$art_i = 0, $art_cvnqmajsdg$art_c = navs.length; $art_ilwvpjaniud$art_i < $art_cvnqmajsdg$art_c; $art_ilwvpjaniud$art_i++) {        var nav = navs[$art_ilwvpjaniud$art_i]%>';
        for (var $art_ilwvpjaniud$art_i = 0, $art_cvnqmajsdg$art_c = navs.length; $art_ilwvpjaniud$art_i < $art_cvnqmajsdg$art_c; $art_ilwvpjaniud$art_i++) {
            var nav = navs[$art_ilwvpjaniud$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
