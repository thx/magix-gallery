...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cjzyxnun$art_c = list.length; index < $art_cjzyxnun$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cjzyxnun$art_c = list.length; index < $art_cjzyxnun$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_izviiydha$art_i = 0, $art_objjakzxoyx$art_obj = item.seconds, $art_cqeeovvgebj$art_c = $art_objjakzxoyx$art_obj.length; $art_izviiydha$art_i < $art_cqeeovvgebj$art_c; $art_izviiydha$art_i++) {        var second = $art_objjakzxoyx$art_obj[$art_izviiydha$art_i]%>';
        for (var $art_izviiydha$art_i = 0, $art_objjakzxoyx$art_obj = item.seconds, $art_cqeeovvgebj$art_c = $art_objjakzxoyx$art_obj.length; $art_izviiydha$art_i < $art_cqeeovvgebj$art_c; $art_izviiydha$art_i++) {
            var second = $art_objjakzxoyx$art_obj[$art_izviiydha$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ipywmpun$art_i = 0, $art_objdthnsjwfw$art_obj = second.thirds, $art_caksczouxk$art_c = $art_objdthnsjwfw$art_obj.length; $art_ipywmpun$art_i < $art_caksczouxk$art_c; $art_ipywmpun$art_i++) {            var third = $art_objdthnsjwfw$art_obj[$art_ipywmpun$art_i]%>';
            for (var $art_ipywmpun$art_i = 0, $art_objdthnsjwfw$art_obj = second.thirds, $art_caksczouxk$art_c = $art_objdthnsjwfw$art_obj.length; $art_ipywmpun$art_i < $art_caksczouxk$art_c; $art_ipywmpun$art_i++) {
                var third = $art_objdthnsjwfw$art_obj[$art_ipywmpun$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_ihqyolbxvna$art_i = 0, $art_cnuwtmavl$art_c = navs.length; $art_ihqyolbxvna$art_i < $art_cnuwtmavl$art_c; $art_ihqyolbxvna$art_i++) {    var nav = navs[$art_ihqyolbxvna$art_i]%>';
    for (var $art_ihqyolbxvna$art_i = 0, $art_cnuwtmavl$art_c = navs.length; $art_ihqyolbxvna$art_i < $art_cnuwtmavl$art_c; $art_ihqyolbxvna$art_i++) {
        var nav = navs[$art_ihqyolbxvna$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
