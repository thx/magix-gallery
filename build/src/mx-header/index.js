...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_chyblndwbugk$art_c = list.length; index < $art_chyblndwbugk$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_chyblndwbugk$art_c = list.length; index < $art_chyblndwbugk$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_iygvgywtyhm$art_i = 0, $art_objwtdhwvps$art_obj = item.seconds, $art_cuyulplidfd$art_c = $art_objwtdhwvps$art_obj.length; $art_iygvgywtyhm$art_i < $art_cuyulplidfd$art_c; $art_iygvgywtyhm$art_i++) {        var second = $art_objwtdhwvps$art_obj[$art_iygvgywtyhm$art_i]%>';
        for (var $art_iygvgywtyhm$art_i = 0, $art_objwtdhwvps$art_obj = item.seconds, $art_cuyulplidfd$art_c = $art_objwtdhwvps$art_obj.length; $art_iygvgywtyhm$art_i < $art_cuyulplidfd$art_c; $art_iygvgywtyhm$art_i++) {
            var second = $art_objwtdhwvps$art_obj[$art_iygvgywtyhm$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iraoq$art_i = 0, $art_objqfotxyh$art_obj = second.thirds, $art_cqgjvfoum$art_c = $art_objqfotxyh$art_obj.length; $art_iraoq$art_i < $art_cqgjvfoum$art_c; $art_iraoq$art_i++) {            var third = $art_objqfotxyh$art_obj[$art_iraoq$art_i]%>';
            for (var $art_iraoq$art_i = 0, $art_objqfotxyh$art_obj = second.thirds, $art_cqgjvfoum$art_c = $art_objqfotxyh$art_obj.length; $art_iraoq$art_i < $art_cqgjvfoum$art_c; $art_iraoq$art_i++) {
                var third = $art_objqfotxyh$art_obj[$art_iraoq$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_iupbrz$art_i = 0, $art_cxzpsrzzfr$art_c = navs.length; $art_iupbrz$art_i < $art_cxzpsrzzfr$art_c; $art_iupbrz$art_i++) {        var nav = navs[$art_iupbrz$art_i]%>';
        for (var $art_iupbrz$art_i = 0, $art_cxzpsrzzfr$art_c = navs.length; $art_iupbrz$art_i < $art_cxzpsrzzfr$art_c; $art_iupbrz$art_i++) {
            var nav = navs[$art_iupbrz$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
