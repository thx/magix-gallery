...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerycv:_" class="_zs_gallery_mx-header_index_-header"><div class="_zs_gallery_mx-header_index_-others clearfix" style="width: ';
    $line = 2;
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_gallerycv:_" class="fl mr35"><a class="_zs_gallery_mx-header_index_-text _zs_gallery_mx-header_index_-text-h-brand" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
    $line = 6;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_ceuplcej$art_c = list.length; index < $art_ceuplcej$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ceuplcej$art_c = list.length; index < $art_ceuplcej$art_c; index++) {
        var item = list[index];
        ...
        $art = '=index';
        ;
        $p += ($expr = '<%=index%>', $e(index)) + ',height:0})"><span mxa="_zs_gallerycv:a" class="_zs_gallery_mx-header_index_-text">';
        $line = 10;
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_gallerycv:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links ';
        $line = 12;
        ...
        ;
        $expr = '<%for (var $art_iexrgelstmn$art_i = 0, $art_objzaoqslz$art_obj = item.seconds, $art_cpescnwb$art_c = $art_objzaoqslz$art_obj.length; $art_iexrgelstmn$art_i < $art_cpescnwb$art_c; $art_iexrgelstmn$art_i++) {        var second = $art_objzaoqslz$art_obj[$art_iexrgelstmn$art_i]%>';
        for (var $art_iexrgelstmn$art_i = 0, $art_objzaoqslz$art_obj = item.seconds, $art_cpescnwb$art_c = $art_objzaoqslz$art_obj.length; $art_iexrgelstmn$art_i < $art_cpescnwb$art_c; $art_iexrgelstmn$art_i++) {
            var second = $art_objzaoqslz$art_obj[$art_iexrgelstmn$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ivwroaxbzj$art_i = 0, $art_objdxquaxeis$art_obj = second.thirds, $art_chspxktvt$art_c = $art_objdxquaxeis$art_obj.length; $art_ivwroaxbzj$art_i < $art_chspxktvt$art_c; $art_ivwroaxbzj$art_i++) {            var third = $art_objdxquaxeis$art_obj[$art_ivwroaxbzj$art_i]%>';
            for (var $art_ivwroaxbzj$art_i = 0, $art_objdxquaxeis$art_obj = second.thirds, $art_chspxktvt$art_c = $art_objdxquaxeis$art_obj.length; $art_ivwroaxbzj$art_i < $art_chspxktvt$art_c; $art_ivwroaxbzj$art_i++) {
                var third = $art_objdxquaxeis$art_obj[$art_ivwroaxbzj$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxa="_zs_gallerycv:b" class="_zs_gallery_mx-header_index_-logo"><img src="';
    $line = 30;
    $art = '=logo';
    ;
    ...
    if (navs.length > 0) {
        ;
        $p += '<div mxa="_zs_gallerycv:c" class="_zs_gallery_mx-header_index_-navs">';
        $line = 34;
        $art = 'each navs as nav';
        ;
        $expr = '<%for (var $art_ijsojemwna$art_i = 0, $art_cereclae$art_c = navs.length; $art_ijsojemwna$art_i < $art_cereclae$art_c; $art_ijsojemwna$art_i++) {        var nav = navs[$art_ijsojemwna$art_i]%>';
        for (var $art_ijsojemwna$art_i = 0, $art_cereclae$art_c = navs.length; $art_ijsojemwna$art_i < $art_cereclae$art_c; $art_ijsojemwna$art_i++) {
            var nav = navs[$art_ijsojemwna$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
