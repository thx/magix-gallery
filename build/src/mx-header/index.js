...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_clfibgylc$art_c = list.length; index < $art_clfibgylc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_clfibgylc$art_c = list.length; index < $art_clfibgylc$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_irbdixrqh$art_i = 0, $art_objcmucdedggf$art_obj = item.seconds, $art_cckvwbmd$art_c = $art_objcmucdedggf$art_obj.length; $art_irbdixrqh$art_i < $art_cckvwbmd$art_c; $art_irbdixrqh$art_i++) {        var second = $art_objcmucdedggf$art_obj[$art_irbdixrqh$art_i]%>';
        for (var $art_irbdixrqh$art_i = 0, $art_objcmucdedggf$art_obj = item.seconds, $art_cckvwbmd$art_c = $art_objcmucdedggf$art_obj.length; $art_irbdixrqh$art_i < $art_cckvwbmd$art_c; $art_irbdixrqh$art_i++) {
            var second = $art_objcmucdedggf$art_obj[$art_irbdixrqh$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_iqjewuod$art_i = 0, $art_objwkdvspoh$art_obj = second.thirds, $art_catbaol$art_c = $art_objwkdvspoh$art_obj.length; $art_iqjewuod$art_i < $art_catbaol$art_c; $art_iqjewuod$art_i++) {            var third = $art_objwkdvspoh$art_obj[$art_iqjewuod$art_i]%>';
            for (var $art_iqjewuod$art_i = 0, $art_objwkdvspoh$art_obj = second.thirds, $art_catbaol$art_c = $art_objwkdvspoh$art_obj.length; $art_iqjewuod$art_i < $art_catbaol$art_c; $art_iqjewuod$art_i++) {
                var third = $art_objwkdvspoh$art_obj[$art_iqjewuod$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $expr = '<%for (var $art_ikjreet$art_i = 0, $art_cazvqrzrg$art_c = navs.length; $art_ikjreet$art_i < $art_cazvqrzrg$art_c; $art_ikjreet$art_i++) {    var nav = navs[$art_ikjreet$art_i]%>';
    for (var $art_ikjreet$art_i = 0, $art_cazvqrzrg$art_c = navs.length; $art_ikjreet$art_i < $art_cazvqrzrg$art_c; $art_ikjreet$art_i++) {
        var nav = navs[$art_ikjreet$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
