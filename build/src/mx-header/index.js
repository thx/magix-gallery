...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_chointl$art_c = list.length; index < $art_chointl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_chointl$art_c = list.length; index < $art_chointl$art_c; index++) {
        var item = list[index];
        ...
        ;
        $expr = '<%for (var $art_imvtqec$art_i = 0, $art_objrqiltvj$art_obj = item.seconds, $art_czkkisyepvo$art_c = $art_objrqiltvj$art_obj.length; $art_imvtqec$art_i < $art_czkkisyepvo$art_c; $art_imvtqec$art_i++) {        var second = $art_objrqiltvj$art_obj[$art_imvtqec$art_i]%>';
        for (var $art_imvtqec$art_i = 0, $art_objrqiltvj$art_obj = item.seconds, $art_czkkisyepvo$art_c = $art_objrqiltvj$art_obj.length; $art_imvtqec$art_i < $art_czkkisyepvo$art_c; $art_imvtqec$art_i++) {
            var second = $art_objrqiltvj$art_obj[$art_imvtqec$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_imdbntkvmkk$art_i = 0, $art_objqzajwywgrd$art_obj = second.thirds, $art_cxxugmun$art_c = $art_objqzajwywgrd$art_obj.length; $art_imdbntkvmkk$art_i < $art_cxxugmun$art_c; $art_imdbntkvmkk$art_i++) {            var third = $art_objqzajwywgrd$art_obj[$art_imdbntkvmkk$art_i]%>';
            for (var $art_imdbntkvmkk$art_i = 0, $art_objqzajwywgrd$art_obj = second.thirds, $art_cxxugmun$art_c = $art_objqzajwywgrd$art_obj.length; $art_imdbntkvmkk$art_i < $art_cxxugmun$art_c; $art_imdbntkvmkk$art_i++) {
                var third = $art_objqzajwywgrd$art_obj[$art_imdbntkvmkk$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    if (navs.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_itypcnqk$art_i = 0, $art_cbvtrgeui$art_c = navs.length; $art_itypcnqk$art_i < $art_cbvtrgeui$art_c; $art_itypcnqk$art_i++) {        var nav = navs[$art_itypcnqk$art_i]%>';
        for (var $art_itypcnqk$art_i = 0, $art_cbvtrgeui$art_c = navs.length; $art_itypcnqk$art_i < $art_cbvtrgeui$art_c; $art_itypcnqk$art_i++) {
            var nav = navs[$art_itypcnqk$art_i];
            $p += '<a class="mr40 ';
            $line = 35;
