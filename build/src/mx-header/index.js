...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_cejqfkywk$art_c = list.length; index < $art_cejqfkywk$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cejqfkywk$art_c = list.length; index < $art_cejqfkywk$art_c; index++) {
        var item = list[index];
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_imwpktzkf$art_i = 0, $art_objgnyxdeq$art_obj = item.seconds, $art_cslkykbxpsc$art_c = $art_objgnyxdeq$art_obj.length; $art_imwpktzkf$art_i < $art_cslkykbxpsc$art_c; $art_imwpktzkf$art_i++) {        var second = $art_objgnyxdeq$art_obj[$art_imwpktzkf$art_i]%>';
        for (var $art_imwpktzkf$art_i = 0, $art_objgnyxdeq$art_obj = item.seconds, $art_cslkykbxpsc$art_c = $art_objgnyxdeq$art_obj.length; $art_imwpktzkf$art_i < $art_cslkykbxpsc$art_c; $art_imwpktzkf$art_i++) {
            var second = $art_objgnyxdeq$art_obj[$art_imwpktzkf$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_ihyepdt$art_i = 0, $art_objunsdtzir$art_obj = second.thirds, $art_cdmheegd$art_c = $art_objunsdtzir$art_obj.length; $art_ihyepdt$art_i < $art_cdmheegd$art_c; $art_ihyepdt$art_i++) {            var third = $art_objunsdtzir$art_obj[$art_ihyepdt$art_i]%>';
            for (var $art_ihyepdt$art_i = 0, $art_objunsdtzir$art_obj = second.thirds, $art_cdmheegd$art_c = $art_objunsdtzir$art_obj.length; $art_ihyepdt$art_i < $art_cdmheegd$art_c; $art_ihyepdt$art_i++) {
                var third = $art_objunsdtzir$art_obj[$art_ihyepdt$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iamcftofr$art_i = 0, $art_cneufkzums$art_c = navs.length; $art_iamcftofr$art_i < $art_cneufkzums$art_c; $art_iamcftofr$art_i++) {    var nav = navs[$art_iamcftofr$art_i]%>';
    for (var $art_iamcftofr$art_i = 0, $art_cneufkzums$art_c = navs.length; $art_iamcftofr$art_i < $art_cneufkzums$art_c; $art_iamcftofr$art_i++) {
        var nav = navs[$art_iamcftofr$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
