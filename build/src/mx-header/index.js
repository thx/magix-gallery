...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_galleryb3:_" class="_zs_gallery_mx-header_index_-header"><div class="_zs_gallery_mx-header_index_-others clearfix" style="width: ';
    $line = 2;
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxs="_zs_galleryb3:_" class="fl mr35"><a class="_zs_gallery_mx-header_index_-text _zs_gallery_mx-header_index_-text-h-brand" href="//www.alimama.com" target="_blank" rel="noopener noreferrer">阿里妈妈首页</a></div>';
    $line = 6;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_czyhhstbgfg$art_c = list.length; index < $art_czyhhstbgfg$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_czyhhstbgfg$art_c = list.length; index < $art_czyhhstbgfg$art_c; index++) {
        var item = list[index];
        ...
        $art = '=index';
        ;
        $p += ($expr = '<%=index%>', $e(index)) + ',height:0})"><span mxa="_zs_galleryb3:a" class="_zs_gallery_mx-header_index_-text">';
        $line = 10;
        $art = '=item.title';
        ;
        $p += ($expr = '<%=item.title%>', $e(item.title)) + '</span><span mxs="_zs_galleryb3:a" class="mc-iconfont ml5 _zs_gallery_mx-header_index_-arrow">&#xe692;</span><div class="_zs_gallery_mx-header_index_-links" style="height: ';
        $line = 12;
        $art = '=item.showHeight';
        ;
        ...
        ;
        $expr = '<%for (var $art_ibewgmtsb$art_i = 0, $art_objrrbbriavwl$art_obj = item.seconds, $art_cjibnncyrd$art_c = $art_objrrbbriavwl$art_obj.length; $art_ibewgmtsb$art_i < $art_cjibnncyrd$art_c; $art_ibewgmtsb$art_i++) {        var second = $art_objrrbbriavwl$art_obj[$art_ibewgmtsb$art_i]%>';
        for (var $art_ibewgmtsb$art_i = 0, $art_objrrbbriavwl$art_obj = item.seconds, $art_cjibnncyrd$art_c = $art_objrrbbriavwl$art_obj.length; $art_ibewgmtsb$art_i < $art_cjibnncyrd$art_c; $art_ibewgmtsb$art_i++) {
            var second = $art_objrrbbriavwl$art_obj[$art_ibewgmtsb$art_i];
            $p += '<dl>';
            $line = 15;
            $art = 'if second.title';
            ;
            ...
            ;
            $expr = '<%for (var $art_ichhwtgfv$art_i = 0, $art_objknxtqoiw$art_obj = second.thirds, $art_cwfjroprm$art_c = $art_objknxtqoiw$art_obj.length; $art_ichhwtgfv$art_i < $art_cwfjroprm$art_c; $art_ichhwtgfv$art_i++) {            var third = $art_objknxtqoiw$art_obj[$art_ichhwtgfv$art_i]%>';
            for (var $art_ichhwtgfv$art_i = 0, $art_objknxtqoiw$art_obj = second.thirds, $art_cwfjroprm$art_c = $art_objknxtqoiw$art_obj.length; $art_ichhwtgfv$art_i < $art_cwfjroprm$art_c; $art_ichhwtgfv$art_i++) {
                var third = $art_objknxtqoiw$art_obj[$art_ichhwtgfv$art_i];
                $p += '<dd><a href="';
                $line = 19;
                $art = '=third.link';
                ;
    ...
    $art = '=width';
    ;
    $p += ($expr = '<%=width%>', $e(width)) + 'px;"><div mxa="_zs_galleryb3:b" class="_zs_gallery_mx-header_index_-logo"><img src="';
    $line = 30;
    $art = '=logo';
    ;
    $p += ($expr = '<%=logo%>', $e(logo)) + '"/></div><div mxa="_zs_galleryb3:c" class="_zs_gallery_mx-header_index_-navs">';
    $line = 33;
    $art = 'each navs as nav';
    ;
    $expr = '<%for (var $art_iuzswdqtkd$art_i = 0, $art_ciozifeyfbng$art_c = navs.length; $art_iuzswdqtkd$art_i < $art_ciozifeyfbng$art_c; $art_iuzswdqtkd$art_i++) {    var nav = navs[$art_iuzswdqtkd$art_i]%>';
    for (var $art_iuzswdqtkd$art_i = 0, $art_ciozifeyfbng$art_c = navs.length; $art_iuzswdqtkd$art_i < $art_ciozifeyfbng$art_c; $art_iuzswdqtkd$art_i++) {
        var nav = navs[$art_iuzswdqtkd$art_i];
        $p += '<a class="mr40 ';
        $line = 34;
