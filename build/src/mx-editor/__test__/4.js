...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybg:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerybg:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerybg:_" class="mb10 clearfix"><div class="fl lh22 color-9">以下示例：</div><div class="fl lh22">最多显示两行，超出换行</div></div><div mxa="_zs_gallerybg:b" class="mb10 clearfix"><div mxs="_zs_gallerybg:a" class="fl lh22 color-9">当前内容：</div><div mxa="_zs_gallerybg:c" class="fl lh22 _zs_gallery_mx-editor___test___4_-con">';
    $line = 9;
    $art = '=content';
    ;
    $p += ($expr = '<%=content%>', $e(content)) + '</div></div><div mxa="_zs_gallerybg:d" class="mb20 clearfix"><div mxs="_zs_gallerybg:b" class="color-9 fl">实际显示：</div><div mxa="_zs_gallerybg:e" class="fl w140"><div mx-edit="' + $viewId + 'change()" mx-view="mx-editor/index?tmpl=';
    $line = 15;
    $art = '=tmpl';
    ;
    ...
    $art = '@{\n                        required: true\n                    }';
    ;
    $p += ($expr = '<%@{        required: true    }%>', $i($$ref, { required: true })) + '"></div></div></div></div><div mxa="_zs_gallerybg:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybg:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 26;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;div class="w140"&gt;\n    &lt;mx-editor\n        tmpl="&#123;&#123;=tmpl&#125;&#125;"\n        content="&#123;&#123;=content&#125;&#125;"\n        rules="&#123;&#123;@&#123;\n            required: true\n        &#125;&#125;&#125;"\n        mx-edit="change()"&gt;&lt;/mx-editor&gt;\n&lt;/div&gt;</pre></div><div mxa="_zs_gallerybg:h" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybg:e" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 44;
    $art = '=viewId';
    ;
