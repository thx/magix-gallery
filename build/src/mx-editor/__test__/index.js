...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerya6:a" class="clearfix mb20"><div mxa="_zs_gallerya6:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-editor/__test__/1" id="';
    $line = 29;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_gallerya6:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-editor/__test__/3" id="';
    $line = 33;
    $art = '=viewId';
    ;
