...
module.exports = Base.extend({
    ...
    $art = '@{min:[200,\'不能小于200\']}';
    ;
    $p += '' + ($expr = '<%@{ min: [200, \'不能小于200\'] }%>', $i($$ref, { min: [200, '不能小于200'] })) + '&small=true"></div></td></tr></tbody></table></div></div></div><div mxa="_zs_galleryan:d" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryan:e" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 39;
    $art = '=viewId';
    ;
