...
module.exports = Base.extend({
    ...
    $art = '@{\n                    required: true,\n                    min: [200, \'不小于200\']\n                }';
    ;
    $p += '' + ($expr = '<%@{        required: true,        min: [200, \'不小于200\']    }%>', $i($$ref, { required: true, min: [200, '不小于200'] })) + '"></div></div></div><div mxa="_zs_galleryak:d" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryak:b" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
