...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaD:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaD:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaD:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>纯文案编辑</div><div>输入框小尺寸 + 自定义宽度</div></div></div><div mxa="_zs_galleryaD:b" class="mb20"><span mxs="_zs_galleryaD:a" class="color-9">当前内容：</span><span>';
    $line = 12;
    $art = '=content';
    ;
    $p += '' + ($expr = '<%=content%>', $e(content)) + '（要求必填且不小于200）</span></div><div mxa="_zs_galleryaD:c" class="mb20"><div mx-view="mx-editor/index?width=200&small=true&content=';
    $line = 18;
    $art = '=content';
    ;
    ...
    $art = '@{\n                    required: true,\n                    min: [200, \'不小于200\']\n                }';
    ;
    $p += '' + ($expr = '<%@{        required: true,        min: [200, \'不小于200\']    }%>', $i($$ref, { required: true, min: [200, '不小于200'] })) + '"></div></div></div><div mxa="_zs_galleryaD:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaD:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
