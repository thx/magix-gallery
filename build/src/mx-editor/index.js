...
module.exports = Magix.View.extend({
    ...
    $art = '=content';
    ;
    $p += ($expr = '<%=content%>', $e(content)) + '" mx-keyup="' + $viewId + '@{out}()" mx-focusout="' + $viewId + '@{out}()"/><div mxa="_zs_gallerybo:_" class="_zs_gallery_mx-editor_index_-editor-content">';
    $line = 11;
    $art = '!dis';
    ;
    $p += ($expr = '<%!dis%>', $n(dis)) + '<i mxs="_zs_gallerybo:_" class="mc-iconfont operations _zs_gallery_mx-editor_index_-editor-oper" mx-click="' + $viewId + '@{show}()">&#xe698;</i></div></div>';
}
catch (ex) {
