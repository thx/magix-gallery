...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_galleryd]:_" mx-view="mx-uploader/__test__/1" class="mb40"></div><div id="';
    $line = 16;
    $art = '=viewId';
    ;
