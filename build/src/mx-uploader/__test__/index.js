...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_gallerycC:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_gallerycC:a" mx-view="mx-uploader/__test__/1" class="mb40"></div><div mxs="_zs_gallerycC:b" mx-view="mx-title/second?content=API"></div><div mxv="options" mx-view="__test__/api?options=';
    $line = 5;
    $art = '@options';
    ;
