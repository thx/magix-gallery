...
module.exports = Base.extend({
    ...
    $p += '<div mxs="_zs_galleryce:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryce:_" class="mb20 clearfix"><div mxa="_zs_galleryce:a" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryce:b" class="_zs_gallery___test___layout_-eg-content clearfix"><span class="fl mr20 mt5" mx-change="' + $viewId + 'toggle()" mx-view="mx-switch/index?state=';
    $line = 6;
    $art = '=state';
    ;
    $p += '' + ($expr = '<%!$eu(state)%>', $eu(state)) + '"></span><a mxs="_zs_galleryce:a" href="javascript:;" class="btn btn-brand fl mr20" mx-click="' + $viewId + 'change()">切换状态</a><span mxa="_zs_galleryce:c" class="lh32 fl">当前状态：';
    $line = 9;
    $art = '=state';
    ;
    $p += '' + ($expr = '<%=state%>', $e(state)) + '</span></div><div mxa="_zs_galleryce:d" class="clearfix"><div mxa="_zs_galleryce:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryce:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_text_2">\nlet Magix = require(\'magix\');\nlet $ = require(\'$\');\n\nmodule.exports = Magix.View.extend(&#123;\n    tmpl: \'@index.html\',\n    render() &#123;\n        this.updater.digest(&#123;\n            state: true\n        &#125;);\n    &#125;,\n    \'toggle&lt;change&gt;\' (event) &#123;\n        // event.state 当前开还是关\n        // true 开，false关\n        this.updater.digest(&#123;\n            state: event.state\n        &#125;);\n    &#125;,\n    \'change&lt;click&gt;\'(event)&#123;\n        let state = this.updater.get(\'state\');\n        this.updater.digest(&#123;\n            state: !state\n        &#125;);\n    &#125;\n&#125;);</pre></div></div></div></div><div mxs="_zs_galleryce:e" mx-view="mx-title/second?content=API"></div><div mxv="options" mx-view="__test__/api?options=';
    $line = 65;
    $art = '@options';
    ;
