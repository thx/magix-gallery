...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerydQ:a" class="mb20 clearfix"><div mxa="_zs_gallerydQ:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-switch/__test__/1" id="';
    $line = 29;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div></div><div mxa="_zs_gallerydQ:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-switch/__test__/4" id="';
    $line = 32;
    $art = '=viewId';
    ;
