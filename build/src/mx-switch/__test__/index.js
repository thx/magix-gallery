...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxa="_zs_gallerydd:a" class="mb20 clearfix"><div mxa="_zs_gallerydd:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-switch/__test__/2" id="';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div></div><div mxa="_zs_gallerydd:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-switch/__test__/3" id="';
    $line = 30;
    $art = '=viewId';
    ;
