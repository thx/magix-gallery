...
module.exports = Base.extend({
    ...
    $art = '=state';
    ;
    $p += ($expr = '<%!$eu(state)%>', $eu(state)) + '"></span><a mxs="_zs_galleryd(:a" href="javascript:;" class="btn btn-brand mr20" mx-click="' + $viewId + 'change()">切换状态</a><span>当前状态：';
    $line = 10;
    $art = '=state';
    ;
    $p += ($expr = '<%=state%>', $e(state)) + '</span></div><div mxa="_zs_galleryd(:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryd(:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-switch class="mr20"\n    state="&#123;&#123;=state&#125;&#125;"\n    mx-change="toggle()"/&gt;\n\n&lt;a href="javascript:;" class="btn btn-brand" \n    mx-click="change()"&gt;切换状态&lt;/a&gt;</pre></div><div mxa="_zs_galleryd(:i" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryd(:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 29;
    $art = '=viewId';
    ;
