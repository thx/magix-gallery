...
module.exports = Magix.View.extend({
    ...
    if (text) {
        ...
        ;
        $p += ($expr = '<%=disabled ? \'_zs_gallery_mx-switch_index_-disabled\' : \'\'%>', $e(disabled ? '_zs_gallery_mx-switch_index_-disabled' : '')) + '" mx-click="' + $viewId + '@{toggle}()"><span mxs="_zs_gallerydF:_" class="_zs_gallery_mx-switch_index_-text _zs_gallery_mx-switch_index_-close">关</span><span mxs="_zs_gallerydF:a" class="_zs_gallery_mx-switch_index_-text _zs_gallery_mx-switch_index_-open">开</span><span mxs="_zs_gallerydF:b" class="_zs_gallery_mx-switch_index_-switch-icon"></span></span>';
        $line = 8;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        $art = '= _zs_gallery_mx-switch_index_-disabled ? \'disabled\' : \'\'';
        ;
        $p += ($expr = '<%=disabled ? \'_zs_gallery_mx-switch_index_-disabled\' : \'\'%>', $e(disabled ? '_zs_gallery_mx-switch_index_-disabled' : '')) + '" mx-click="' + $viewId + '@{toggle}()"><span mxs="_zs_gallerydF:b" class="_zs_gallery_mx-switch_index_-switch-icon"></span></span>';
        $line = 12;
        $art = '/if';
        ;
        $expr = '<%}%>';
