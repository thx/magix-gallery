...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '' + ($expr = '<%=on ? \'_zs_gallery_mx-switch_index_-on\' : \'\'%>', $e(on ? '_zs_gallery_mx-switch_index_-on' : '')) + '" mx-click="' + $viewId + '@{toggle}()"><span mxs="_zs_gallerycg:_" class="_zs_gallery_mx-switch_index_-switch-icon"></span></span>';
}
catch (ex) {
