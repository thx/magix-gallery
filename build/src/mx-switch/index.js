...
module.exports = Magix.View.extend({
    ...
    ;
    $p += ($expr = '<%=disabled ? \'_zs_gallery_mx-switch_index_-disabled\' : \'\'%>', $e(disabled ? '_zs_gallery_mx-switch_index_-disabled' : '')) + '" mx-click="' + $viewId + '@{toggle}()"><span mxs="_zs_galleryc%:_" class="_zs_gallery_mx-switch_index_-switch-icon"></span></span>';
    $line = 4;
    $art = 'if (disabled && tip)';
    ;
