...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div><div mxa="_zs_gallerycR:a" class="clearfix mb20"><div mxa="_zs_gallerycR:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popconfirm/__test__/4" id="';
    $line = 27;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_gallerycR:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popconfirm/__test__/6" id="';
    $line = 30;
    $art = '=viewId';
    ;
