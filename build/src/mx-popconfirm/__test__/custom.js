...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ibkotnegb$art_i=0;$art_ibkotnegb$art_i<list.length;$art_ibkotnegb$art_i++){var item=list[$art_ibkotnegb$art_i]%>';
    for (var $art_ibkotnegb$art_i = 0; $art_ibkotnegb$art_i < list.length; $art_ibkotnegb$art_i++) {
        var item = list[$art_ibkotnegb$art_i];
