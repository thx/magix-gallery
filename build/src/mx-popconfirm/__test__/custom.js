...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ivzlmrsma$art_i=0;$art_ivzlmrsma$art_i<list.length;$art_ivzlmrsma$art_i++){var item=list[$art_ivzlmrsma$art_i]%>';
    for (var $art_ivzlmrsma$art_i = 0; $art_ivzlmrsma$art_i < list.length; $art_ivzlmrsma$art_i++) {
        var item = list[$art_ivzlmrsma$art_i];
