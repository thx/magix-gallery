...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerycw:_" class="_zs_gallery_mx-popover_index_-popover-content">';
    $line = 1;
    $art = '!content';
    ;
    $p += ($expr = '<%!content%>', $n(content)) + '</div><div mxs="_zs_gallerycw:_" class="pl10 pt10 pb10"><a href="javascript:;" class="btn btn-small btn-brand mr10" mx-click="' + $viewId + 'submit()">确定</a><a href="javascript:;" class="btn btn-small" mx-click="' + $viewId + 'cancel()">取消</a></div>';
}
catch (ex) {
