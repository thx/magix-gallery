...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iznqzqs$art_i = 0, $art_czwcvyuxvc$art_c = list.length; $art_iznqzqs$art_i < $art_czwcvyuxvc$art_c; $art_iznqzqs$art_i++) {    var item = list[$art_iznqzqs$art_i]%>';
    for (var $art_iznqzqs$art_i = 0, $art_czwcvyuxvc$art_c = list.length; $art_iznqzqs$art_i < $art_czwcvyuxvc$art_c; $art_iznqzqs$art_i++) {
        var item = list[$art_iznqzqs$art_i];
