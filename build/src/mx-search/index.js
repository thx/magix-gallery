...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_gallerydq:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    ;
    $p += ' _zs_gallery_mx-search_index_-search-menu"><ul mxa="_zs_gallerydq:_" class="mx-output-list">';
    $line = 14;
    $art = 'each list as item';
    ;
    $expr = '<%for (var $art_ijktttdyj$art_i = 0, $art_cgblznxyu$art_c = list.length; $art_ijktttdyj$art_i < $art_cgblznxyu$art_c; $art_ijktttdyj$art_i++) {    var item = list[$art_ijktttdyj$art_i]%>';
    for (var $art_ijktttdyj$art_i = 0, $art_cgblznxyu$art_c = list.length; $art_ijktttdyj$art_i < $art_cgblznxyu$art_c; $art_ijktttdyj$art_i++) {
        var item = list[$art_ijktttdyj$art_i];
        $p += '<li mxa="_zs_gallerydq:a" class="mx-output-item"><span class="mx-output-link ';
        $line = 16;
