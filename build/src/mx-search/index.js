...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifhuzowb$art_i = 0, $art_cqqfctpgw$art_c = list.length; $art_ifhuzowb$art_i < $art_cqqfctpgw$art_c; $art_ifhuzowb$art_i++) {    var item = list[$art_ifhuzowb$art_i]%>';
    for (var $art_ifhuzowb$art_i = 0, $art_cqqfctpgw$art_c = list.length; $art_ifhuzowb$art_i < $art_cqqfctpgw$art_c; $art_ifhuzowb$art_i++) {
        var item = list[$art_ifhuzowb$art_i];
