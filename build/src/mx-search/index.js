...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_galleryb5:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ihwhejmvl$art_i = 0, $art_cmshiihfy$art_c = list.length; $art_ihwhejmvl$art_i < $art_cmshiihfy$art_c; $art_ihwhejmvl$art_i++) {    var item = list[$art_ihwhejmvl$art_i]%>';
    for (var $art_ihwhejmvl$art_i = 0, $art_cmshiihfy$art_c = list.length; $art_ihwhejmvl$art_i < $art_cmshiihfy$art_c; $art_ihwhejmvl$art_i++) {
        var item = list[$art_ihwhejmvl$art_i];
