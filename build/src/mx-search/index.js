...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igdaulxjo$art_i = 0, $art_cgpwpbsfa$art_c = list.length; $art_igdaulxjo$art_i < $art_cgpwpbsfa$art_c; $art_igdaulxjo$art_i++) {    var item = list[$art_igdaulxjo$art_i]%>';
    for (var $art_igdaulxjo$art_i = 0, $art_cgpwpbsfa$art_c = list.length; $art_igdaulxjo$art_i < $art_cgpwpbsfa$art_c; $art_igdaulxjo$art_i++) {
        var item = list[$art_igdaulxjo$art_i];
