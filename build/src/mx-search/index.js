...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivxncfo$art_i = 0, $art_cnuqyxd$art_c = list.length; $art_ivxncfo$art_i < $art_cnuqyxd$art_c; $art_ivxncfo$art_i++) {    var item = list[$art_ivxncfo$art_i]%>';
    for (var $art_ivxncfo$art_i = 0, $art_cnuqyxd$art_c = list.length; $art_ivxncfo$art_i < $art_cnuqyxd$art_c; $art_ivxncfo$art_i++) {
        var item = list[$art_ivxncfo$art_i];
