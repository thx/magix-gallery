...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icoztwwgzd$art_i = 0, $art_cpjkdfpjbbp$art_c = list.length; $art_icoztwwgzd$art_i < $art_cpjkdfpjbbp$art_c; $art_icoztwwgzd$art_i++) {    var item = list[$art_icoztwwgzd$art_i]%>';
    for (var $art_icoztwwgzd$art_i = 0, $art_cpjkdfpjbbp$art_c = list.length; $art_icoztwwgzd$art_i < $art_cpjkdfpjbbp$art_c; $art_icoztwwgzd$art_i++) {
        var item = list[$art_icoztwwgzd$art_i];
