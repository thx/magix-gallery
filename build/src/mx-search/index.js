...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_gallerycw:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    ;
    $expr = '<%for (var $art_ipliutizf$art_i = 0, $art_cyfkkeeyf$art_c = list.length; $art_ipliutizf$art_i < $art_cyfkkeeyf$art_c; $art_ipliutizf$art_i++) {    var item = list[$art_ipliutizf$art_i]%>';
    for (var $art_ipliutizf$art_i = 0, $art_cyfkkeeyf$art_c = list.length; $art_ipliutizf$art_i < $art_cyfkkeeyf$art_c; $art_ipliutizf$art_i++) {
        var item = list[$art_ipliutizf$art_i];
