...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipwspacgq$art_i = 0, $art_crcreu$art_c = list.length; $art_ipwspacgq$art_i < $art_crcreu$art_c; $art_ipwspacgq$art_i++) {    var item = list[$art_ipwspacgq$art_i]%>';
    for (var $art_ipwspacgq$art_i = 0, $art_crcreu$art_c = list.length; $art_ipwspacgq$art_i < $art_crcreu$art_c; $art_ipwspacgq$art_i++) {
        var item = list[$art_ipwspacgq$art_i];
