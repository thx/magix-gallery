...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imcltfgwkmj$art_i = 0, $art_cjxuvup$art_c = list.length; $art_imcltfgwkmj$art_i < $art_cjxuvup$art_c; $art_imcltfgwkmj$art_i++) {    var item = list[$art_imcltfgwkmj$art_i]%>';
    for (var $art_imcltfgwkmj$art_i = 0, $art_cjxuvup$art_c = list.length; $art_imcltfgwkmj$art_i < $art_cjxuvup$art_c; $art_imcltfgwkmj$art_i++) {
        var item = list[$art_imcltfgwkmj$art_i];
