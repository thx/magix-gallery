...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivbfsv$art_i = 0, $art_ceiecmqfpo$art_c = list.length; $art_ivbfsv$art_i < $art_ceiecmqfpo$art_c; $art_ivbfsv$art_i++) {    var item = list[$art_ivbfsv$art_i]%>';
    for (var $art_ivbfsv$art_i = 0, $art_ceiecmqfpo$art_c = list.length; $art_ivbfsv$art_i < $art_ceiecmqfpo$art_c; $art_ivbfsv$art_i++) {
        var item = list[$art_ivbfsv$art_i];
