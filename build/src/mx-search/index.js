...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuowukgl$art_i = 0, $art_cpzvrqealhro$art_c = list.length; $art_iuowukgl$art_i < $art_cpzvrqealhro$art_c; $art_iuowukgl$art_i++) {    var item = list[$art_iuowukgl$art_i]%>';
    for (var $art_iuowukgl$art_i = 0, $art_cpzvrqealhro$art_c = list.length; $art_iuowukgl$art_i < $art_cpzvrqealhro$art_c; $art_iuowukgl$art_i++) {
        var item = list[$art_iuowukgl$art_i];
