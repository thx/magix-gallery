...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihfnaycph$art_i = 0, $art_cngspsx$art_c = list.length; $art_ihfnaycph$art_i < $art_cngspsx$art_c; $art_ihfnaycph$art_i++) {    var item = list[$art_ihfnaycph$art_i]%>';
    for (var $art_ihfnaycph$art_i = 0, $art_cngspsx$art_c = list.length; $art_ihfnaycph$art_i < $art_cngspsx$art_c; $art_ihfnaycph$art_i++) {
        var item = list[$art_ihfnaycph$art_i];
