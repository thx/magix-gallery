...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_inywihr$art_i=0;$art_inywihr$art_i<list.length;$art_inywihr$art_i++){var item=list[$art_inywihr$art_i]%>';
    for (var $art_inywihr$art_i = 0; $art_inywihr$art_i < list.length; $art_inywihr$art_i++) {
        var item = list[$art_inywihr$art_i];
