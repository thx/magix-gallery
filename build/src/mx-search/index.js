...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izirpbfc$art_i = 0, $art_cueqruejn$art_c = list.length; $art_izirpbfc$art_i < $art_cueqruejn$art_c; $art_izirpbfc$art_i++) {    var item = list[$art_izirpbfc$art_i]%>';
    for (var $art_izirpbfc$art_i = 0, $art_cueqruejn$art_c = list.length; $art_izirpbfc$art_i < $art_cueqruejn$art_c; $art_izirpbfc$art_i++) {
        var item = list[$art_izirpbfc$art_i];
