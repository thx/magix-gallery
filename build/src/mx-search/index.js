...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyvhpdnda$art_i = 0, $art_cnhzdiyb$art_c = list.length; $art_iyvhpdnda$art_i < $art_cnhzdiyb$art_c; $art_iyvhpdnda$art_i++) {    var item = list[$art_iyvhpdnda$art_i]%>';
    for (var $art_iyvhpdnda$art_i = 0, $art_cnhzdiyb$art_c = list.length; $art_iyvhpdnda$art_i < $art_cnhzdiyb$art_c; $art_iyvhpdnda$art_i++) {
        var item = list[$art_iyvhpdnda$art_i];
