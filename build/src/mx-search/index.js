...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikopdojur$art_i = 0, $art_casasjq$art_c = list.length; $art_ikopdojur$art_i < $art_casasjq$art_c; $art_ikopdojur$art_i++) {    var item = list[$art_ikopdojur$art_i]%>';
    for (var $art_ikopdojur$art_i = 0, $art_casasjq$art_c = list.length; $art_ikopdojur$art_i < $art_casasjq$art_c; $art_ikopdojur$art_i++) {
        var item = list[$art_ikopdojur$art_i];
