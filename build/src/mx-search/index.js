...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipwvofopvh$art_i = 0, $art_ckiniocln$art_c = list.length; $art_ipwvofopvh$art_i < $art_ckiniocln$art_c; $art_ipwvofopvh$art_i++) {    var item = list[$art_ipwvofopvh$art_i]%>';
    for (var $art_ipwvofopvh$art_i = 0, $art_ckiniocln$art_c = list.length; $art_ipwvofopvh$art_i < $art_ckiniocln$art_c; $art_ipwvofopvh$art_i++) {
        var item = list[$art_ipwvofopvh$art_i];
