...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_izednhgroa$art_i = 0, $art_crfypva$art_c = list.length; $art_izednhgroa$art_i < $art_crfypva$art_c; $art_izednhgroa$art_i++) {    var item = list[$art_izednhgroa$art_i]%>';
    for (var $art_izednhgroa$art_i = 0, $art_crfypva$art_c = list.length; $art_izednhgroa$art_i < $art_crfypva$art_c; $art_izednhgroa$art_i++) {
        var item = list[$art_izednhgroa$art_i];
