...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iortfbtdp$art_i = 0, $art_ccpxxcdgwa$art_c = list.length; $art_iortfbtdp$art_i < $art_ccpxxcdgwa$art_c; $art_iortfbtdp$art_i++) {    var item = list[$art_iortfbtdp$art_i]%>';
    for (var $art_iortfbtdp$art_i = 0, $art_ccpxxcdgwa$art_c = list.length; $art_iortfbtdp$art_i < $art_ccpxxcdgwa$art_c; $art_iortfbtdp$art_i++) {
        var item = list[$art_iortfbtdp$art_i];
