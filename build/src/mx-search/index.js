...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijvhhbfi$art_i = 0, $art_crdgtk$art_c = list.length; $art_ijvhhbfi$art_i < $art_crdgtk$art_c; $art_ijvhhbfi$art_i++) {    var item = list[$art_ijvhhbfi$art_i]%>';
    for (var $art_ijvhhbfi$art_i = 0, $art_crdgtk$art_c = list.length; $art_ijvhhbfi$art_i < $art_crdgtk$art_c; $art_ijvhhbfi$art_i++) {
        var item = list[$art_ijvhhbfi$art_i];
