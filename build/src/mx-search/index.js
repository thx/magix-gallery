...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iweqshpvtdno$art_i = 0, $art_chkxxgvj$art_c = list.length; $art_iweqshpvtdno$art_i < $art_chkxxgvj$art_c; $art_iweqshpvtdno$art_i++) {    var item = list[$art_iweqshpvtdno$art_i]%>';
    for (var $art_iweqshpvtdno$art_i = 0, $art_chkxxgvj$art_c = list.length; $art_iweqshpvtdno$art_i < $art_chkxxgvj$art_c; $art_iweqshpvtdno$art_i++) {
        var item = list[$art_iweqshpvtdno$art_i];
