...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioqjrlmc$art_i = 0, $art_cfbluaxkdj$art_c = list.length; $art_ioqjrlmc$art_i < $art_cfbluaxkdj$art_c; $art_ioqjrlmc$art_i++) {    var item = list[$art_ioqjrlmc$art_i]%>';
    for (var $art_ioqjrlmc$art_i = 0, $art_cfbluaxkdj$art_c = list.length; $art_ioqjrlmc$art_i < $art_cfbluaxkdj$art_c; $art_ioqjrlmc$art_i++) {
        var item = list[$art_ioqjrlmc$art_i];
