...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ilzeoudv$art_i = 0, $art_cnmfqbussl$art_c = list.length; $art_ilzeoudv$art_i < $art_cnmfqbussl$art_c; $art_ilzeoudv$art_i++) {    var item = list[$art_ilzeoudv$art_i]%>';
    for (var $art_ilzeoudv$art_i = 0, $art_cnmfqbussl$art_c = list.length; $art_ilzeoudv$art_i < $art_cnmfqbussl$art_c; $art_ilzeoudv$art_i++) {
        var item = list[$art_ilzeoudv$art_i];
