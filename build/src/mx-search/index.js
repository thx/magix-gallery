...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixqldoaqs$art_i = 0, $art_cekmknuk$art_c = list.length; $art_ixqldoaqs$art_i < $art_cekmknuk$art_c; $art_ixqldoaqs$art_i++) {    var item = list[$art_ixqldoaqs$art_i]%>';
    for (var $art_ixqldoaqs$art_i = 0, $art_cekmknuk$art_c = list.length; $art_ixqldoaqs$art_i < $art_cekmknuk$art_c; $art_ixqldoaqs$art_i++) {
        var item = list[$art_ixqldoaqs$art_i];
