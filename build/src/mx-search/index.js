...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixijydxqo$art_i = 0, $art_cwhotovh$art_c = list.length; $art_ixijydxqo$art_i < $art_cwhotovh$art_c; $art_ixijydxqo$art_i++) {    var item = list[$art_ixijydxqo$art_i]%>';
    for (var $art_ixijydxqo$art_i = 0, $art_cwhotovh$art_c = list.length; $art_ixijydxqo$art_i < $art_cwhotovh$art_c; $art_ixijydxqo$art_i++) {
        var item = list[$art_ixijydxqo$art_i];
