...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imemcdvxhg$art_i = 0, $art_cyizublszd$art_c = list.length; $art_imemcdvxhg$art_i < $art_cyizublszd$art_c; $art_imemcdvxhg$art_i++) {    var item = list[$art_imemcdvxhg$art_i]%>';
    for (var $art_imemcdvxhg$art_i = 0, $art_cyizublszd$art_c = list.length; $art_imemcdvxhg$art_i < $art_cyizublszd$art_c; $art_imemcdvxhg$art_i++) {
        var item = list[$art_imemcdvxhg$art_i];
