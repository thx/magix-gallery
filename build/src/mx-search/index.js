...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibkuvfafv$art_i = 0, $art_cuflhpwqi$art_c = list.length; $art_ibkuvfafv$art_i < $art_cuflhpwqi$art_c; $art_ibkuvfafv$art_i++) {    var item = list[$art_ibkuvfafv$art_i]%>';
    for (var $art_ibkuvfafv$art_i = 0, $art_cuflhpwqi$art_c = list.length; $art_ibkuvfafv$art_i < $art_cuflhpwqi$art_c; $art_ibkuvfafv$art_i++) {
        var item = list[$art_ibkuvfafv$art_i];
