...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_islmrx$art_i = 0, $art_ckiryulaqtf$art_c = list.length; $art_islmrx$art_i < $art_ckiryulaqtf$art_c; $art_islmrx$art_i++) {    var item = list[$art_islmrx$art_i]%>';
    for (var $art_islmrx$art_i = 0, $art_ckiryulaqtf$art_c = list.length; $art_islmrx$art_i < $art_ckiryulaqtf$art_c; $art_islmrx$art_i++) {
        var item = list[$art_islmrx$art_i];
