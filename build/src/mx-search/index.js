...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwtrqkyef$art_i = 0, $art_cxhxshig$art_c = list.length; $art_iwtrqkyef$art_i < $art_cxhxshig$art_c; $art_iwtrqkyef$art_i++) {    var item = list[$art_iwtrqkyef$art_i]%>';
    for (var $art_iwtrqkyef$art_i = 0, $art_cxhxshig$art_c = list.length; $art_iwtrqkyef$art_i < $art_cxhxshig$art_c; $art_iwtrqkyef$art_i++) {
        var item = list[$art_iwtrqkyef$art_i];
