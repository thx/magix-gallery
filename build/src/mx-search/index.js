...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iazhvis$art_i = 0, $art_cucerzswg$art_c = list.length; $art_iazhvis$art_i < $art_cucerzswg$art_c; $art_iazhvis$art_i++) {    var item = list[$art_iazhvis$art_i]%>';
    for (var $art_iazhvis$art_i = 0, $art_cucerzswg$art_c = list.length; $art_iazhvis$art_i < $art_cucerzswg$art_c; $art_iazhvis$art_i++) {
        var item = list[$art_iazhvis$art_i];
