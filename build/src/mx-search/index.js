...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iddivlvwdmb$art_i = 0, $art_cfxwxprzuj$art_c = list.length; $art_iddivlvwdmb$art_i < $art_cfxwxprzuj$art_c; $art_iddivlvwdmb$art_i++) {    var item = list[$art_iddivlvwdmb$art_i]%>';
    for (var $art_iddivlvwdmb$art_i = 0, $art_cfxwxprzuj$art_c = list.length; $art_iddivlvwdmb$art_i < $art_cfxwxprzuj$art_c; $art_iddivlvwdmb$art_i++) {
        var item = list[$art_iddivlvwdmb$art_i];
