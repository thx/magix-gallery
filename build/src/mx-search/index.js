...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iytbdgasgi$art_i = 0, $art_ccfehagt$art_c = list.length; $art_iytbdgasgi$art_i < $art_ccfehagt$art_c; $art_iytbdgasgi$art_i++) {    var item = list[$art_iytbdgasgi$art_i]%>';
    for (var $art_iytbdgasgi$art_i = 0, $art_ccfehagt$art_c = list.length; $art_iytbdgasgi$art_i < $art_ccfehagt$art_c; $art_iytbdgasgi$art_i++) {
        var item = list[$art_iytbdgasgi$art_i];
