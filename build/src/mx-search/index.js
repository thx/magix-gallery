...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijyvigub$art_i = 0, $art_cyigwqhuce$art_c = list.length; $art_ijyvigub$art_i < $art_cyigwqhuce$art_c; $art_ijyvigub$art_i++) {    var item = list[$art_ijyvigub$art_i]%>';
    for (var $art_ijyvigub$art_i = 0, $art_cyigwqhuce$art_c = list.length; $art_ijyvigub$art_i < $art_cyigwqhuce$art_c; $art_ijyvigub$art_i++) {
        var item = list[$art_ijyvigub$art_i];
