...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_izmyocutpn$art_i = 0, $art_cnbvbmaic$art_c = list.length; $art_izmyocutpn$art_i < $art_cnbvbmaic$art_c; $art_izmyocutpn$art_i++) {    var item = list[$art_izmyocutpn$art_i]%>';
    for (var $art_izmyocutpn$art_i = 0, $art_cnbvbmaic$art_c = list.length; $art_izmyocutpn$art_i < $art_cnbvbmaic$art_c; $art_izmyocutpn$art_i++) {
        var item = list[$art_izmyocutpn$art_i];
