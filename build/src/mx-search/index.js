...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_galleryc8:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    ;
    $expr = '<%for (var $art_isnrffmnr$art_i = 0, $art_civscdcgz$art_c = list.length; $art_isnrffmnr$art_i < $art_civscdcgz$art_c; $art_isnrffmnr$art_i++) {    var item = list[$art_isnrffmnr$art_i]%>';
    for (var $art_isnrffmnr$art_i = 0, $art_civscdcgz$art_c = list.length; $art_isnrffmnr$art_i < $art_civscdcgz$art_c; $art_isnrffmnr$art_i++) {
        var item = list[$art_isnrffmnr$art_i];
