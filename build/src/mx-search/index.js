...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idpbhfmje$art_i = 0, $art_csuftpthqy$art_c = list.length; $art_idpbhfmje$art_i < $art_csuftpthqy$art_c; $art_idpbhfmje$art_i++) {    var item = list[$art_idpbhfmje$art_i]%>';
    for (var $art_idpbhfmje$art_i = 0, $art_csuftpthqy$art_c = list.length; $art_idpbhfmje$art_i < $art_csuftpthqy$art_c; $art_idpbhfmje$art_i++) {
        var item = list[$art_idpbhfmje$art_i];
