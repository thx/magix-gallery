...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iypknk$art_i = 0, $art_clgdyqrxb$art_c = list.length; $art_iypknk$art_i < $art_clgdyqrxb$art_c; $art_iypknk$art_i++) {    var item = list[$art_iypknk$art_i]%>';
    for (var $art_iypknk$art_i = 0, $art_clgdyqrxb$art_c = list.length; $art_iypknk$art_i < $art_clgdyqrxb$art_c; $art_iypknk$art_i++) {
        var item = list[$art_iypknk$art_i];
