...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_gallerydw:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    ;
    $expr = '<%for (var $art_iyvolvptct$art_i = 0, $art_ckcyqdamnet$art_c = list.length; $art_iyvolvptct$art_i < $art_ckcyqdamnet$art_c; $art_iyvolvptct$art_i++) {    var item = list[$art_iyvolvptct$art_i]%>';
    for (var $art_iyvolvptct$art_i = 0, $art_ckcyqdamnet$art_c = list.length; $art_iyvolvptct$art_i < $art_ckcyqdamnet$art_c; $art_iyvolvptct$art_i++) {
        var item = list[$art_iyvolvptct$art_i];
