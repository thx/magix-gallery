...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilaqesndin$art_i = 0, $art_chjswbrbjem$art_c = list.length; $art_ilaqesndin$art_i < $art_chjswbrbjem$art_c; $art_ilaqesndin$art_i++) {    var item = list[$art_ilaqesndin$art_i]%>';
    for (var $art_ilaqesndin$art_i = 0, $art_chjswbrbjem$art_c = list.length; $art_ilaqesndin$art_i < $art_chjswbrbjem$art_c; $art_ilaqesndin$art_i++) {
        var item = list[$art_ilaqesndin$art_i];
