...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioocjzr$art_i = 0, $art_ckfraozpsa$art_c = list.length; $art_ioocjzr$art_i < $art_ckfraozpsa$art_c; $art_ioocjzr$art_i++) {    var item = list[$art_ioocjzr$art_i]%>';
    for (var $art_ioocjzr$art_i = 0, $art_ckfraozpsa$art_c = list.length; $art_ioocjzr$art_i < $art_ckfraozpsa$art_c; $art_ioocjzr$art_i++) {
        var item = list[$art_ioocjzr$art_i];
