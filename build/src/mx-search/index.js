...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipgzacfoe$art_i = 0, $art_cczvudxe$art_c = list.length; $art_ipgzacfoe$art_i < $art_cczvudxe$art_c; $art_ipgzacfoe$art_i++) {    var item = list[$art_ipgzacfoe$art_i]%>';
    for (var $art_ipgzacfoe$art_i = 0, $art_cczvudxe$art_c = list.length; $art_ipgzacfoe$art_i < $art_cczvudxe$art_c; $art_ipgzacfoe$art_i++) {
        var item = list[$art_ipgzacfoe$art_i];
