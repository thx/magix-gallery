...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibbdfstjhtj$art_i = 0, $art_cnvhxae$art_c = list.length; $art_ibbdfstjhtj$art_i < $art_cnvhxae$art_c; $art_ibbdfstjhtj$art_i++) {    var item = list[$art_ibbdfstjhtj$art_i]%>';
    for (var $art_ibbdfstjhtj$art_i = 0, $art_cnvhxae$art_c = list.length; $art_ibbdfstjhtj$art_i < $art_cnvhxae$art_c; $art_ibbdfstjhtj$art_i++) {
        var item = list[$art_ibbdfstjhtj$art_i];
