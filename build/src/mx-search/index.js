...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iekwcypt$art_i=0;$art_iekwcypt$art_i<list.length;$art_iekwcypt$art_i++){var item=list[$art_iekwcypt$art_i]%>';
    for (var $art_iekwcypt$art_i = 0; $art_iekwcypt$art_i < list.length; $art_iekwcypt$art_i++) {
        var item = list[$art_iekwcypt$art_i];
