...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iprnsenp$art_i = 0, $art_conyuolhe$art_c = list.length; $art_iprnsenp$art_i < $art_conyuolhe$art_c; $art_iprnsenp$art_i++) {    var item = list[$art_iprnsenp$art_i]%>';
    for (var $art_iprnsenp$art_i = 0, $art_conyuolhe$art_c = list.length; $art_iprnsenp$art_i < $art_conyuolhe$art_c; $art_iprnsenp$art_i++) {
        var item = list[$art_iprnsenp$art_i];
