...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iszmvrta$art_i = 0, $art_czezidkshx$art_c = list.length; $art_iszmvrta$art_i < $art_czezidkshx$art_c; $art_iszmvrta$art_i++) {    var item = list[$art_iszmvrta$art_i]%>';
    for (var $art_iszmvrta$art_i = 0, $art_czezidkshx$art_c = list.length; $art_iszmvrta$art_i < $art_czezidkshx$art_c; $art_iszmvrta$art_i++) {
        var item = list[$art_iszmvrta$art_i];
