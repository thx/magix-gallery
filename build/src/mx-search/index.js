...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixtlubq$art_i = 0, $art_ctkzlnogt$art_c = list.length; $art_ixtlubq$art_i < $art_ctkzlnogt$art_c; $art_ixtlubq$art_i++) {    var item = list[$art_ixtlubq$art_i]%>';
    for (var $art_ixtlubq$art_i = 0, $art_ctkzlnogt$art_c = list.length; $art_ixtlubq$art_i < $art_ctkzlnogt$art_c; $art_ixtlubq$art_i++) {
        var item = list[$art_ixtlubq$art_i];
