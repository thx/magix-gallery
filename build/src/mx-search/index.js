...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivjgdnzf$art_i = 0, $art_copppznncda$art_c = list.length; $art_ivjgdnzf$art_i < $art_copppznncda$art_c; $art_ivjgdnzf$art_i++) {    var item = list[$art_ivjgdnzf$art_i]%>';
    for (var $art_ivjgdnzf$art_i = 0, $art_copppznncda$art_c = list.length; $art_ivjgdnzf$art_i < $art_copppznncda$art_c; $art_ivjgdnzf$art_i++) {
        var item = list[$art_ivjgdnzf$art_i];
