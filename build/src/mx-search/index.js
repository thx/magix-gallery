...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioqgbkiisj$art_i = 0, $art_ccemhykojg$art_c = list.length; $art_ioqgbkiisj$art_i < $art_ccemhykojg$art_c; $art_ioqgbkiisj$art_i++) {    var item = list[$art_ioqgbkiisj$art_i]%>';
    for (var $art_ioqgbkiisj$art_i = 0, $art_ccemhykojg$art_c = list.length; $art_ioqgbkiisj$art_i < $art_ccemhykojg$art_c; $art_ioqgbkiisj$art_i++) {
        var item = list[$art_ioqgbkiisj$art_i];
