...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ixqqilwelp$art_i = 0, $art_cckmzpma$art_c = list.length; $art_ixqqilwelp$art_i < $art_cckmzpma$art_c; $art_ixqqilwelp$art_i++) {    var item = list[$art_ixqqilwelp$art_i]%>';
    for (var $art_ixqqilwelp$art_i = 0, $art_cckmzpma$art_c = list.length; $art_ixqqilwelp$art_i < $art_cckmzpma$art_c; $art_ixqqilwelp$art_i++) {
        var item = list[$art_ixqqilwelp$art_i];
