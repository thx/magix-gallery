...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iixfzx$art_i = 0, $art_chviwy$art_c = list.length; $art_iixfzx$art_i < $art_chviwy$art_c; $art_iixfzx$art_i++) {    var item = list[$art_iixfzx$art_i]%>';
    for (var $art_iixfzx$art_i = 0, $art_chviwy$art_c = list.length; $art_iixfzx$art_i < $art_chviwy$art_c; $art_iixfzx$art_i++) {
        var item = list[$art_iixfzx$art_i];
