...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iakdquwfev$art_i = 0, $art_cezzizmfth$art_c = list.length; $art_iakdquwfev$art_i < $art_cezzizmfth$art_c; $art_iakdquwfev$art_i++) {    var item = list[$art_iakdquwfev$art_i]%>';
    for (var $art_iakdquwfev$art_i = 0, $art_cezzizmfth$art_c = list.length; $art_iakdquwfev$art_i < $art_cezzizmfth$art_c; $art_iakdquwfev$art_i++) {
        var item = list[$art_iakdquwfev$art_i];
