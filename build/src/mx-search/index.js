...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irkoizime$art_i = 0, $art_cororsnuj$art_c = list.length; $art_irkoizime$art_i < $art_cororsnuj$art_c; $art_irkoizime$art_i++) {    var item = list[$art_irkoizime$art_i]%>';
    for (var $art_irkoizime$art_i = 0, $art_cororsnuj$art_c = list.length; $art_irkoizime$art_i < $art_cororsnuj$art_c; $art_irkoizime$art_i++) {
        var item = list[$art_irkoizime$art_i];
