...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijpefye$art_i = 0, $art_cbbuamsl$art_c = list.length; $art_ijpefye$art_i < $art_cbbuamsl$art_c; $art_ijpefye$art_i++) {    var item = list[$art_ijpefye$art_i]%>';
    for (var $art_ijpefye$art_i = 0, $art_cbbuamsl$art_c = list.length; $art_ijpefye$art_i < $art_cbbuamsl$art_c; $art_ijpefye$art_i++) {
        var item = list[$art_ijpefye$art_i];
