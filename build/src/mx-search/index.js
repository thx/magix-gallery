...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iijqxodzq$art_i = 0, $art_cusdpuusb$art_c = list.length; $art_iijqxodzq$art_i < $art_cusdpuusb$art_c; $art_iijqxodzq$art_i++) {    var item = list[$art_iijqxodzq$art_i]%>';
    for (var $art_iijqxodzq$art_i = 0, $art_cusdpuusb$art_c = list.length; $art_iijqxodzq$art_i < $art_cusdpuusb$art_c; $art_iijqxodzq$art_i++) {
        var item = list[$art_iijqxodzq$art_i];
