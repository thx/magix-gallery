...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iruoaopt$art_i = 0, $art_cfdcebzqio$art_c = list.length; $art_iruoaopt$art_i < $art_cfdcebzqio$art_c; $art_iruoaopt$art_i++) {    var item = list[$art_iruoaopt$art_i]%>';
    for (var $art_iruoaopt$art_i = 0, $art_cfdcebzqio$art_c = list.length; $art_iruoaopt$art_i < $art_cfdcebzqio$art_c; $art_iruoaopt$art_i++) {
        var item = list[$art_iruoaopt$art_i];
