...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydj:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydj:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydj:_" class="mb10 clearfix"><span class="color-9">以下示例：</span>自定义搜索列表文案</div><div><div class="w200" mx-view="mx-search/index?list=';
    $line = 9;
    $art = '@[{\n                    text: \'优惠券id\',\n                    value: \'id\',\n                    tmpl: \'搜索id含有“${content}”的优惠券\'\n                }, {\n                    text: \'优惠券名称\',\n                    value: \'name\',\n                    tmpl: \'搜索名称含有“${content}”的优惠券\'\n                }]';
    ;
    $p += ($expr = '<%@[{            text: \'优惠券id\',            value: \'id\',            tmpl: \'搜索id含有“${content}”的优惠券\'        }, {            text: \'优惠券名称\',            value: \'name\',            tmpl: \'搜索名称含有“${content}”的优惠券\'        }]%>', $i($$ref, [{ text: '优惠券id', value: 'id', tmpl: '搜索id含有“${content}”的优惠券' }, { text: '优惠券名称', value: 'name', tmpl: '搜索名称含有“${content}”的优惠券' }])) + '"></div></div></div><div mxa="_zs_gallerydj:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydj:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 22;
    $art = '=viewId';
    ;
