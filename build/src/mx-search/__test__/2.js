...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydr:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydr:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-search/index?list=';
    $line = 4;
    $art = '@[{\n                name: \'计划\',\n                id: \'campaignId\'\n            }, {\n                name: \'单元\',\n                id: \'adgroupId\'\n            }]';
    ;
    $p += ($expr = '<%@[{            name: \'计划\',            id: \'campaignId\'        }, {            name: \'单元\',            id: \'adgroupId\'        }]%>', $i($$ref, [{ name: '计划', id: 'campaignId' }, { name: '单元', id: 'adgroupId' }])) + '&listText=name&listValue=id"></div></div><div mxa="_zs_gallerydr:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydr:_" class="_zs_gallery___test___layout_-eg-title">自定义&nbsp;list-text&nbsp;和&nbsp;list-value</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
