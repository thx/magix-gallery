...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb}:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryb}:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryb}:b" class="mb20"><span mxs="_zs_galleryb}:_" class="color-9">回车搜索：</span><span>campaignId = ';
    $line = 6;
    $art = '=searchValue';
    ;
