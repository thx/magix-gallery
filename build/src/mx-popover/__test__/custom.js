...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwclfwij$art_i = 0, $art_cfkrolsub$art_c = list.length; $art_iwclfwij$art_i < $art_cfkrolsub$art_c; $art_iwclfwij$art_i++) {    var item = list[$art_iwclfwij$art_i]%>';
    for (var $art_iwclfwij$art_i = 0, $art_cfkrolsub$art_c = list.length; $art_iwclfwij$art_i < $art_cfkrolsub$art_c; $art_iwclfwij$art_i++) {
        var item = list[$art_iwclfwij$art_i];
