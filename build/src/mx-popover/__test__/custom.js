...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iokchk$art_i = 0, $art_clylzsjvsb$art_c = list.length; $art_iokchk$art_i < $art_clylzsjvsb$art_c; $art_iokchk$art_i++) {    var item = list[$art_iokchk$art_i]%>';
    for (var $art_iokchk$art_i = 0, $art_clylzsjvsb$art_c = list.length; $art_iokchk$art_i < $art_clylzsjvsb$art_c; $art_iokchk$art_i++) {
        var item = list[$art_iokchk$art_i];
