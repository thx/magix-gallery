...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ielsssoomvc$art_i = 0, $art_cnbbssl$art_c = list.length; $art_ielsssoomvc$art_i < $art_cnbbssl$art_c; $art_ielsssoomvc$art_i++) {    var item = list[$art_ielsssoomvc$art_i]%>';
    for (var $art_ielsssoomvc$art_i = 0, $art_cnbbssl$art_c = list.length; $art_ielsssoomvc$art_i < $art_cnbbssl$art_c; $art_ielsssoomvc$art_i++) {
        var item = list[$art_ielsssoomvc$art_i];
