...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikjuzpofee$art_i = 0, $art_cassfqbek$art_c = list.length; $art_ikjuzpofee$art_i < $art_cassfqbek$art_c; $art_ikjuzpofee$art_i++) {    var item = list[$art_ikjuzpofee$art_i]%>';
    for (var $art_ikjuzpofee$art_i = 0, $art_cassfqbek$art_c = list.length; $art_ikjuzpofee$art_i < $art_cassfqbek$art_c; $art_ikjuzpofee$art_i++) {
        var item = list[$art_ikjuzpofee$art_i];
