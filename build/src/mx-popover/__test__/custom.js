...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icnlabcaf$art_i = 0, $art_cebnjprmnjgh$art_c = list.length; $art_icnlabcaf$art_i < $art_cebnjprmnjgh$art_c; $art_icnlabcaf$art_i++) {    var item = list[$art_icnlabcaf$art_i]%>';
    for (var $art_icnlabcaf$art_i = 0, $art_cebnjprmnjgh$art_c = list.length; $art_icnlabcaf$art_i < $art_cebnjprmnjgh$art_c; $art_icnlabcaf$art_i++) {
        var item = list[$art_icnlabcaf$art_i];
