...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izlnntvxbf$art_i = 0, $art_czdcytrezwe$art_c = list.length; $art_izlnntvxbf$art_i < $art_czdcytrezwe$art_c; $art_izlnntvxbf$art_i++) {    var item = list[$art_izlnntvxbf$art_i]%>';
    for (var $art_izlnntvxbf$art_i = 0, $art_czdcytrezwe$art_c = list.length; $art_izlnntvxbf$art_i < $art_czdcytrezwe$art_c; $art_izlnntvxbf$art_i++) {
        var item = list[$art_izlnntvxbf$art_i];
