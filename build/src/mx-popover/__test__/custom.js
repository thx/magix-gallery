...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_imwyczxov$art_i=0;$art_imwyczxov$art_i<list.length;$art_imwyczxov$art_i++){var item=list[$art_imwyczxov$art_i]%>';
    for (var $art_imwyczxov$art_i = 0; $art_imwyczxov$art_i < list.length; $art_imwyczxov$art_i++) {
        var item = list[$art_imwyczxov$art_i];
