...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inpnmnfwpn$art_i = 0, $art_cgfnhgs$art_c = list.length; $art_inpnmnfwpn$art_i < $art_cgfnhgs$art_c; $art_inpnmnfwpn$art_i++) {    var item = list[$art_inpnmnfwpn$art_i]%>';
    for (var $art_inpnmnfwpn$art_i = 0, $art_cgfnhgs$art_c = list.length; $art_inpnmnfwpn$art_i < $art_cgfnhgs$art_c; $art_inpnmnfwpn$art_i++) {
        var item = list[$art_inpnmnfwpn$art_i];
