...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihdfbugow$art_i = 0, $art_chmflcs$art_c = list.length; $art_ihdfbugow$art_i < $art_chmflcs$art_c; $art_ihdfbugow$art_i++) {    var item = list[$art_ihdfbugow$art_i]%>';
    for (var $art_ihdfbugow$art_i = 0, $art_chmflcs$art_c = list.length; $art_ihdfbugow$art_i < $art_chmflcs$art_c; $art_ihdfbugow$art_i++) {
        var item = list[$art_ihdfbugow$art_i];
