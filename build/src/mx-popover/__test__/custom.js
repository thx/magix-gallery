...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilushrfnn$art_i = 0, $art_cvflvvlx$art_c = list.length; $art_ilushrfnn$art_i < $art_cvflvvlx$art_c; $art_ilushrfnn$art_i++) {    var item = list[$art_ilushrfnn$art_i]%>';
    for (var $art_ilushrfnn$art_i = 0, $art_cvflvvlx$art_c = list.length; $art_ilushrfnn$art_i < $art_cvflvvlx$art_c; $art_ilushrfnn$art_i++) {
        var item = list[$art_ilushrfnn$art_i];
