...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifavn$art_i = 0, $art_cjpgkhpda$art_c = list.length; $art_ifavn$art_i < $art_cjpgkhpda$art_c; $art_ifavn$art_i++) {    var item = list[$art_ifavn$art_i]%>';
    for (var $art_ifavn$art_i = 0, $art_cjpgkhpda$art_c = list.length; $art_ifavn$art_i < $art_cjpgkhpda$art_c; $art_ifavn$art_i++) {
        var item = list[$art_ifavn$art_i];
