...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igiehehwcs$art_i = 0, $art_cfjmxbo$art_c = list.length; $art_igiehehwcs$art_i < $art_cfjmxbo$art_c; $art_igiehehwcs$art_i++) {    var item = list[$art_igiehehwcs$art_i]%>';
    for (var $art_igiehehwcs$art_i = 0, $art_cfjmxbo$art_c = list.length; $art_igiehehwcs$art_i < $art_cfjmxbo$art_c; $art_igiehehwcs$art_i++) {
        var item = list[$art_igiehehwcs$art_i];
