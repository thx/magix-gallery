...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iizaix$art_i = 0, $art_ccwhzewjjk$art_c = list.length; $art_iizaix$art_i < $art_ccwhzewjjk$art_c; $art_iizaix$art_i++) {    var item = list[$art_iizaix$art_i]%>';
    for (var $art_iizaix$art_i = 0, $art_ccwhzewjjk$art_c = list.length; $art_iizaix$art_i < $art_ccwhzewjjk$art_c; $art_iizaix$art_i++) {
        var item = list[$art_iizaix$art_i];
