...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipwpazzjymq$art_i = 0, $art_cpwiqoph$art_c = list.length; $art_ipwpazzjymq$art_i < $art_cpwiqoph$art_c; $art_ipwpazzjymq$art_i++) {    var item = list[$art_ipwpazzjymq$art_i]%>';
    for (var $art_ipwpazzjymq$art_i = 0, $art_cpwiqoph$art_c = list.length; $art_ipwpazzjymq$art_i < $art_cpwiqoph$art_c; $art_ipwpazzjymq$art_i++) {
        var item = list[$art_ipwpazzjymq$art_i];
