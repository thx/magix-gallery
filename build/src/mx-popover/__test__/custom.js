...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iczeymtzplh$art_i = 0, $art_chlqpmea$art_c = list.length; $art_iczeymtzplh$art_i < $art_chlqpmea$art_c; $art_iczeymtzplh$art_i++) {    var item = list[$art_iczeymtzplh$art_i]%>';
    for (var $art_iczeymtzplh$art_i = 0, $art_chlqpmea$art_c = list.length; $art_iczeymtzplh$art_i < $art_chlqpmea$art_c; $art_iczeymtzplh$art_i++) {
        var item = list[$art_iczeymtzplh$art_i];
