...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izcpicjusse$art_i = 0, $art_chsufconp$art_c = list.length; $art_izcpicjusse$art_i < $art_chsufconp$art_c; $art_izcpicjusse$art_i++) {    var item = list[$art_izcpicjusse$art_i]%>';
    for (var $art_izcpicjusse$art_i = 0, $art_chsufconp$art_c = list.length; $art_izcpicjusse$art_i < $art_chsufconp$art_c; $art_izcpicjusse$art_i++) {
        var item = list[$art_izcpicjusse$art_i];
