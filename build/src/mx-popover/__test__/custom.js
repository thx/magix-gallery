...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibvcpf$art_i = 0, $art_cpfjahqx$art_c = list.length; $art_ibvcpf$art_i < $art_cpfjahqx$art_c; $art_ibvcpf$art_i++) {    var item = list[$art_ibvcpf$art_i]%>';
    for (var $art_ibvcpf$art_i = 0, $art_cpfjahqx$art_c = list.length; $art_ibvcpf$art_i < $art_cpfjahqx$art_c; $art_ibvcpf$art_i++) {
        var item = list[$art_ibvcpf$art_i];
