...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikijayrba$art_i = 0, $art_cekeypa$art_c = list.length; $art_ikijayrba$art_i < $art_cekeypa$art_c; $art_ikijayrba$art_i++) {    var item = list[$art_ikijayrba$art_i]%>';
    for (var $art_ikijayrba$art_i = 0, $art_cekeypa$art_c = list.length; $art_ikijayrba$art_i < $art_cekeypa$art_c; $art_ikijayrba$art_i++) {
        var item = list[$art_ikijayrba$art_i];
