...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwmgrnmoq$art_i = 0, $art_clwxumn$art_c = list.length; $art_iwmgrnmoq$art_i < $art_clwxumn$art_c; $art_iwmgrnmoq$art_i++) {    var item = list[$art_iwmgrnmoq$art_i]%>';
    for (var $art_iwmgrnmoq$art_i = 0, $art_clwxumn$art_c = list.length; $art_iwmgrnmoq$art_i < $art_clwxumn$art_c; $art_iwmgrnmoq$art_i++) {
        var item = list[$art_iwmgrnmoq$art_i];
