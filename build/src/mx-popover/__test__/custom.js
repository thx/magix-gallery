...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izkflmglm$art_i = 0, $art_ccygskfsd$art_c = list.length; $art_izkflmglm$art_i < $art_ccygskfsd$art_c; $art_izkflmglm$art_i++) {    var item = list[$art_izkflmglm$art_i]%>';
    for (var $art_izkflmglm$art_i = 0, $art_ccygskfsd$art_c = list.length; $art_izkflmglm$art_i < $art_ccygskfsd$art_c; $art_izkflmglm$art_i++) {
        var item = list[$art_izkflmglm$art_i];
