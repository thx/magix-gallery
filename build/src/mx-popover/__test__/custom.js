...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqvjqitre$art_i = 0, $art_cxrkfsjma$art_c = list.length; $art_iqvjqitre$art_i < $art_cxrkfsjma$art_c; $art_iqvjqitre$art_i++) {    var item = list[$art_iqvjqitre$art_i]%>';
    for (var $art_iqvjqitre$art_i = 0, $art_cxrkfsjma$art_c = list.length; $art_iqvjqitre$art_i < $art_cxrkfsjma$art_c; $art_iqvjqitre$art_i++) {
        var item = list[$art_iqvjqitre$art_i];
