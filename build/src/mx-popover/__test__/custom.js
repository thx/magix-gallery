...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_izfmlkz$art_i=0;$art_izfmlkz$art_i<list.length;$art_izfmlkz$art_i++){var item=list[$art_izfmlkz$art_i]%>';
    for (var $art_izfmlkz$art_i = 0; $art_izfmlkz$art_i < list.length; $art_izfmlkz$art_i++) {
        var item = list[$art_izfmlkz$art_i];
