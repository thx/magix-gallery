...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifrnmrkrg$art_i = 0, $art_cowtzjqd$art_c = list.length; $art_ifrnmrkrg$art_i < $art_cowtzjqd$art_c; $art_ifrnmrkrg$art_i++) {    var item = list[$art_ifrnmrkrg$art_i]%>';
    for (var $art_ifrnmrkrg$art_i = 0, $art_cowtzjqd$art_c = list.length; $art_ifrnmrkrg$art_i < $art_cowtzjqd$art_c; $art_ifrnmrkrg$art_i++) {
        var item = list[$art_ifrnmrkrg$art_i];
