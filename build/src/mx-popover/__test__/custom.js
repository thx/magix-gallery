...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irlysf$art_i = 0, $art_cbaktcv$art_c = list.length; $art_irlysf$art_i < $art_cbaktcv$art_c; $art_irlysf$art_i++) {    var item = list[$art_irlysf$art_i]%>';
    for (var $art_irlysf$art_i = 0, $art_cbaktcv$art_c = list.length; $art_irlysf$art_i < $art_cbaktcv$art_c; $art_irlysf$art_i++) {
        var item = list[$art_irlysf$art_i];
