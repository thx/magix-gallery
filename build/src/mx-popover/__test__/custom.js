...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imogenek$art_i = 0, $art_crkbzs$art_c = list.length; $art_imogenek$art_i < $art_crkbzs$art_c; $art_imogenek$art_i++) {    var item = list[$art_imogenek$art_i]%>';
    for (var $art_imogenek$art_i = 0, $art_crkbzs$art_c = list.length; $art_imogenek$art_i < $art_crkbzs$art_c; $art_imogenek$art_i++) {
        var item = list[$art_imogenek$art_i];
