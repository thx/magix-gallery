...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iatpuchk$art_i = 0, $art_clhoxqqov$art_c = list.length; $art_iatpuchk$art_i < $art_clhoxqqov$art_c; $art_iatpuchk$art_i++) {    var item = list[$art_iatpuchk$art_i]%>';
    for (var $art_iatpuchk$art_i = 0, $art_clhoxqqov$art_c = list.length; $art_iatpuchk$art_i < $art_clhoxqqov$art_c; $art_iatpuchk$art_i++) {
        var item = list[$art_iatpuchk$art_i];
