...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikebvispa$art_i = 0, $art_cyilmo$art_c = list.length; $art_ikebvispa$art_i < $art_cyilmo$art_c; $art_ikebvispa$art_i++) {    var item = list[$art_ikebvispa$art_i]%>';
    for (var $art_ikebvispa$art_i = 0, $art_cyilmo$art_c = list.length; $art_ikebvispa$art_i < $art_cyilmo$art_c; $art_ikebvispa$art_i++) {
        var item = list[$art_ikebvispa$art_i];
