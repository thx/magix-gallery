...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifmxekmno$art_i = 0, $art_cqymsnbgbca$art_c = list.length; $art_ifmxekmno$art_i < $art_cqymsnbgbca$art_c; $art_ifmxekmno$art_i++) {    var item = list[$art_ifmxekmno$art_i]%>';
    for (var $art_ifmxekmno$art_i = 0, $art_cqymsnbgbca$art_c = list.length; $art_ifmxekmno$art_i < $art_cqymsnbgbca$art_c; $art_ifmxekmno$art_i++) {
        var item = list[$art_ifmxekmno$art_i];
