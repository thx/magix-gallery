...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iavjypumu$art_i = 0, $art_cxbvrnfwf$art_c = list.length; $art_iavjypumu$art_i < $art_cxbvrnfwf$art_c; $art_iavjypumu$art_i++) {    var item = list[$art_iavjypumu$art_i]%>';
    for (var $art_iavjypumu$art_i = 0, $art_cxbvrnfwf$art_c = list.length; $art_iavjypumu$art_i < $art_cxbvrnfwf$art_c; $art_iavjypumu$art_i++) {
        var item = list[$art_iavjypumu$art_i];
