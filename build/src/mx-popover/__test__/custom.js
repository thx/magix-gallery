...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihalowmyi$art_i = 0, $art_cpctokoyjb$art_c = list.length; $art_ihalowmyi$art_i < $art_cpctokoyjb$art_c; $art_ihalowmyi$art_i++) {    var item = list[$art_ihalowmyi$art_i]%>';
    for (var $art_ihalowmyi$art_i = 0, $art_cpctokoyjb$art_c = list.length; $art_ihalowmyi$art_i < $art_cpctokoyjb$art_c; $art_ihalowmyi$art_i++) {
        var item = list[$art_ihalowmyi$art_i];
