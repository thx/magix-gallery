...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itcyapxboi$art_i = 0, $art_cvfrlqbzxg$art_c = list.length; $art_itcyapxboi$art_i < $art_cvfrlqbzxg$art_c; $art_itcyapxboi$art_i++) {    var item = list[$art_itcyapxboi$art_i]%>';
    for (var $art_itcyapxboi$art_i = 0, $art_cvfrlqbzxg$art_c = list.length; $art_itcyapxboi$art_i < $art_cvfrlqbzxg$art_c; $art_itcyapxboi$art_i++) {
        var item = list[$art_itcyapxboi$art_i];
