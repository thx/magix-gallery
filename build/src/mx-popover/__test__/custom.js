...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixeccahzc$art_i = 0, $art_ckucaoy$art_c = list.length; $art_ixeccahzc$art_i < $art_ckucaoy$art_c; $art_ixeccahzc$art_i++) {    var item = list[$art_ixeccahzc$art_i]%>';
    for (var $art_ixeccahzc$art_i = 0, $art_ckucaoy$art_c = list.length; $art_ixeccahzc$art_i < $art_ckucaoy$art_c; $art_ixeccahzc$art_i++) {
        var item = list[$art_ixeccahzc$art_i];
