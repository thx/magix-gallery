...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iukmeralv$art_i = 0, $art_cjcpjzx$art_c = list.length; $art_iukmeralv$art_i < $art_cjcpjzx$art_c; $art_iukmeralv$art_i++) {    var item = list[$art_iukmeralv$art_i]%>';
    for (var $art_iukmeralv$art_i = 0, $art_cjcpjzx$art_c = list.length; $art_iukmeralv$art_i < $art_cjcpjzx$art_c; $art_iukmeralv$art_i++) {
        var item = list[$art_iukmeralv$art_i];
