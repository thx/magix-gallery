...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irjnata$art_i = 0, $art_csgiqjede$art_c = list.length; $art_irjnata$art_i < $art_csgiqjede$art_c; $art_irjnata$art_i++) {    var item = list[$art_irjnata$art_i]%>';
    for (var $art_irjnata$art_i = 0, $art_csgiqjede$art_c = list.length; $art_irjnata$art_i < $art_csgiqjede$art_c; $art_irjnata$art_i++) {
        var item = list[$art_irjnata$art_i];
