...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivzgjbmwk$art_i = 0, $art_cvbileom$art_c = list.length; $art_ivzgjbmwk$art_i < $art_cvbileom$art_c; $art_ivzgjbmwk$art_i++) {    var item = list[$art_ivzgjbmwk$art_i]%>';
    for (var $art_ivzgjbmwk$art_i = 0, $art_cvbileom$art_c = list.length; $art_ivzgjbmwk$art_i < $art_cvbileom$art_c; $art_ivzgjbmwk$art_i++) {
        var item = list[$art_ivzgjbmwk$art_i];
