...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iftukdoq$art_i = 0, $art_cjpluvbrn$art_c = list.length; $art_iftukdoq$art_i < $art_cjpluvbrn$art_c; $art_iftukdoq$art_i++) {    var item = list[$art_iftukdoq$art_i]%>';
    for (var $art_iftukdoq$art_i = 0, $art_cjpluvbrn$art_c = list.length; $art_iftukdoq$art_i < $art_cjpluvbrn$art_c; $art_iftukdoq$art_i++) {
        var item = list[$art_iftukdoq$art_i];
