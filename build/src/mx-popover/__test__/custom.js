...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ijwnqwhzc$art_i = 0, $art_cncsvmtvwr$art_c = list.length; $art_ijwnqwhzc$art_i < $art_cncsvmtvwr$art_c; $art_ijwnqwhzc$art_i++) {    var item = list[$art_ijwnqwhzc$art_i]%>';
    for (var $art_ijwnqwhzc$art_i = 0, $art_cncsvmtvwr$art_c = list.length; $art_ijwnqwhzc$art_i < $art_cncsvmtvwr$art_c; $art_ijwnqwhzc$art_i++) {
        var item = list[$art_ijwnqwhzc$art_i];
