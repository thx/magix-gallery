...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybq:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallerybq:_" class="_zs_gallery___test___base_-eg-content"><span class="btn" mx-view="mx-popover/index?content=%E6%8F%90%E7%A4%BA%E5%86%85%E5%AE%B9&auto=true&placement=right&align=bottom">默认展开</span></div><div mxa="_zs_gallerybq:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerybq:a" class="_zs_gallery___test___base_-eg-title">默认展开</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
