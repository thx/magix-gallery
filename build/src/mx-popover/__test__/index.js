...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_gallerybO:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_gallerybO:a" class="clearfix mb20"><div class="_zs_gallery___test___layout_-half"><div mx-view="mx-popover/__test__/4"></div><div mx-view="mx-popover/__test__/9"></div><div mx-view="mx-popover/__test__/2"></div><div mx-view="mx-popover/__test__/7"></div><div mx-view="mx-popover/__test__/11"></div></div><div class="_zs_gallery___test___layout_-half"><div mx-view="mx-popover/__test__/3"></div><div mx-view="mx-popover/__test__/10"></div><div mx-view="mx-popover/__test__/1"></div><div mx-view="mx-popover/__test__/5"></div><div mx-view="mx-popover/__test__/6"></div><div mx-view="mx-popover/__test__/8"></div></div></div><div mxs="_zs_gallerybO:b" mx-view="mx-title/second?content=API"></div><div mxv="options" mx-view="__test__/api?options=';
    $line = 21;
    $art = '@options';
    ;
