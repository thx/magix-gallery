...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerydp:a" class="clearfix mb20"><div mxa="_zs_gallerydp:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popover/__test__/1" id="';
    $line = 65;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_gallerydp:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popover/__test__/3" id="';
    $line = 73;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_error" mx-view="mx-title/second?content=%E5%BC%82%E5%B8%B8%E6%83%85%E5%86%B5%E8%AF%B4%E6%98%8E"></div><div mxa="_zs_gallerydp:d" class="clearfix mb20"><div mxa="_zs_gallerydp:e" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popover/__test__/11" id="';
    $line = 88;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo11"></div></div><div mxa="_zs_gallerydp:f" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popover/__test__/12" id="';
    $line = 91;
    $art = '=viewId';
    ;
