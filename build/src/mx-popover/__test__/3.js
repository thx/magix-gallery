...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybG:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybG:a" class="_zs_gallery___test___layout_-eg-content"><span mxv="custom" class="btn" mx-view="mx-popover/index?width=420&view=mx-popover%2F__test__%2Fcustom&data=';
    $line = 6;
    $art = '@custom';
    ;
    $p += '' + ($expr = '<%@custom%>', $i($$ref, custom)) + '&placement=bottom">提示内容为自定义view</span></div><div mxa="_zs_gallerybG:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybG:_" class="_zs_gallery___test___layout_-eg-title">view自定义页面地址，data为传入view的数据</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
