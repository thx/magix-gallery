...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydc:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerydc:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydc:_" class="mb20"><span class="color-9">说明：</span>view自定义页面地址，data为传入view的数据</div><span mxv="custom" class="btn" mx-view="mx-popover/index?width=420&view=mx-popover%2F__test__%2Fcustom&data=';
    $line = 10;
    $art = '@custom';
    ;
