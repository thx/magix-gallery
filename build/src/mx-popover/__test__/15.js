...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryc.:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryc.:a" class="_zs_gallery___test___layout_-eg-content"><span class="btn" mx-mouseover="' + $viewId + 'enter()" mx-view="mx-popover/index?content=%E8%87%AA%E5%AE%9A%E4%B9%89left%20%2B%20top&top=';
    $line = 5;
    $art = '=top';
    ;
    ...
    $art = '=auto';
    ;
    $p += ($expr = '<%!$eu(auto)%>', $eu(auto)) + '">鼠标hover节点自定义更新left + top</span></div><div mxa="_zs_galleryc.:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryc.:_" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-popover class="btn"\n    content="自定义left + top"\n    top="&#123;&#123;=top&#125;&#125;"\n    left="&#123;&#123;=left&#125;&#125;"\n    auto="&#123;&#123;=auto&#125;&#125;"\n    mx-mouseover="enter()"&gt;鼠标hover节点自定义更新left + top&lt;/mx-popover&gt;</pre></div><div mxa="_zs_galleryc.:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryc.:b" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
