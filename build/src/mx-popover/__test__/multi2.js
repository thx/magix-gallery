...
module.exports = Magix.View.extend({
    ...
    $art = '@custom';
    ;
    $p += '' + ($expr = '<%@custom%>', $i($$ref, custom)) + '">提示内容为自定义view</span></div></div><div mxs="_zs_gallerybC:b" class="dialog-footer"><a href="javascript:;" class="btn mr10" mx-click="' + $viewId + 'cancel()">取消</a></div>';
}
catch (ex) {
