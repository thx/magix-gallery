...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybH:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybH:_" class="_zs_gallery___test___layout_-eg-content"><i class="mc-iconfont color-9 fontsize-18" mx-view="mx-popover/index?width=66&content=%E5%88%A0%E9%99%A4&type=dark&placement=top&alignText=center">&#xe68d;</i></div><div mxa="_zs_gallerybH:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybH:a" class="_zs_gallery___test___layout_-eg-title">黑底白字</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 13;
    $art = '=viewId';
    ;
