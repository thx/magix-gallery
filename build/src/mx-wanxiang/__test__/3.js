...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycG:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_gallerycG:a" class="_zs_gallery___test___base_-eg-content"><div class="w300" mx-view="mx-search/index?list=';
    $line = 4;
    $art = '@[{\n                text: \'宝贝\',\n                value: \'itemId\'\n            }, {\n                text: \'单元\',\n                value: \'adgroupId\'\n            }]';
    ;
    $p += '' + ($expr = '<%@[{text:\'宝贝\',value:\'itemId\'},{text:\'单元\',value:\'adgroupId\'}]%>', $i([{ text: '宝贝', value: 'itemId' }, { text: '单元', value: 'adgroupId' }])) + '&searchKey=adgroupId&searchValue=%E8%B6%85%E5%87%BA%E5%8F%B3%E5%AF%B9%E9%BD%90%EF%BC%8C%E6%90%9C%E7%B4%A2%E6%A1%86%E5%9C%A8%E9%A1%B5%E9%9D%A2%E5%8F%B3%E8%BE%B9%E7%BC%98%E6%97%B6%E9%80%82%E7%94%A8&align=right"></div></div><div mxa="_zs_gallerycG:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerycG:_" class="_zs_gallery___test___base_-eg-title">内容超出右对齐</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 17;
    $art = '=viewId';
    ;
