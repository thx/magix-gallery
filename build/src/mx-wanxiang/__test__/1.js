...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc8:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryc8:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryc8:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>回车默认搜索第一个</div><div>默认placeholder=list.map(item => {return item.text;})</div><div>事件处理</div></div></div><div mxa="_zs_galleryc8:b" class="mb20"><span mxs="_zs_galleryc8:a" class="color-9">当前搜索：</span><span>';
    $line = 13;
    $art = '=searchKey';
    ;
