...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerye8:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerye8:_" class="_zs_gallery___test___layout_-eg-content"><a href="#!/wanxiang/demo1" target="_blank" rel="noopener noreferrer" class="color-brand">新页面查看示例</a>，注意只在taobao域名下可用</div><div mxa="_zs_gallerye8:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerye8:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 8;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerye8:b" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 10;
    $art = '!text1';
    ;
