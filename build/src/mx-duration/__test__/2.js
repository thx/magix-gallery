...
module.exports = Base.extend({
    ...
    if (ok) {
        ...
        ;
        $p += '<span mxs="_zs_gallerybg:b" class="color-red">请至少选择一个时段</span>';
        $line = 17;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    $art = '=result';
    ;
    $p += ($expr = '<%!$eu(result)%>', $eu(result)) + '"></div></div><div mxa="_zs_gallerybg:c" class="clearfix"><div mxa="_zs_gallerybg:d" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_gallerybg:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
