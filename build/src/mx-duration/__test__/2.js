...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaw:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaw:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaw:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>可选时间间隔为1小时</div><div>宽度随容器自适应，最小780</div><div>清空时获取选中值，提示未选择内容不可提交</div></div></div><div mxa="_zs_galleryaw:b" class="mb20"><a mxs="_zs_galleryaw:a" href="javascript:;" mx-click="' + $viewId + 'get()" class="btn btn-brand mr20">获取当前选中值</a>';
    $line = 13;
    $art = 'if ok';
    ;
    $p += '';
    ...
    if (ok) {
        ...
        ;
        $p += '<span mxs="_zs_galleryaw:b" class="color-red">请至少选择一个时段</span>';
        $line = 17;
        $art = '/if';
        ;
        $p += '';
    ...
    $art = '=result';
    ;
    $p += '' + ($expr = '<%!$eu(result)%>', $eu(result)) + '"></div></div><div mxa="_zs_galleryaw:c" class="clearfix"><div mxa="_zs_galleryaw:d" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_galleryaw:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += '' + ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryaw:d" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 45;
    $art = '=viewId';
    ;
