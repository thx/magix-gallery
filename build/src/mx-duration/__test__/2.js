...
module.exports = Base.extend({
    ...
    if (ok) {
        ...
        ;
        $p += '<span mxs="_zs_gallerybh:b" class="color-red">请至少选择一个时段</span>';
        $line = 17;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    $art = '=result';
    ;
    $p += ($expr = '<%!$eu(result)%>', $eu(result)) + '"></div></div><div mxa="_zs_gallerybh:c" class="clearfix"><div mxa="_zs_gallerybh:d" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_gallerybh:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_gallerybh:d" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 45;
    $art = '=viewId';
    ;
