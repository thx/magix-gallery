...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya0:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'一小时\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'半小时\',\n            key: viewId + \'_demo2\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerya0:a" class="clearfix mb20"><div mx-view="mx-duration/__test__/1" id="';
    $line = 18;
    $art = '=viewId';
    ;
