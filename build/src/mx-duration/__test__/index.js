...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_galleryah:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_galleryah:a" class="clearfix mb20"><div mx-view="mx-duration/__test__/1"></div><div mx-view="mx-duration/__test__/2"></div></div><div mxs="_zs_galleryah:b" mx-view="mx-title/second?content=API"></div><div mxv="options" mx-view="__test__/api?options=';
    $line = 8;
    $art = '@options';
    ;
