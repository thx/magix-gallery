...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaksbssh$art_i = 0, $art_cyrdnzi$art_c = weeks.length; $art_iaksbssh$art_i < $art_cyrdnzi$art_c; $art_iaksbssh$art_i++) {    var week = weeks[$art_iaksbssh$art_i]%>';
    for (var $art_iaksbssh$art_i = 0, $art_cyrdnzi$art_c = weeks.length; $art_iaksbssh$art_i < $art_cyrdnzi$art_c; $art_iaksbssh$art_i++) {
        var week = weeks[$art_iaksbssh$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibpojcko$art_i = 0, $art_czviw$art_c = ranges.length; $art_ibpojcko$art_i < $art_czviw$art_c; $art_ibpojcko$art_i++) {    var range = ranges[$art_ibpojcko$art_i]%>';
    for (var $art_ibpojcko$art_i = 0, $art_czviw$art_c = ranges.length; $art_ibpojcko$art_i < $art_czviw$art_c; $art_ibpojcko$art_i++) {
        var range = ranges[$art_ibpojcko$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifpffb$art_i = 0, $art_cdohvccc$art_c = boxZones.length; $art_ifpffb$art_i < $art_cdohvccc$art_c; $art_ifpffb$art_i++) {    var zone = boxZones[$art_ifpffb$art_i]%>';
    for (var $art_ifpffb$art_i = 0, $art_cdohvccc$art_c = boxZones.length; $art_ifpffb$art_i < $art_cdohvccc$art_c; $art_ifpffb$art_i++) {
        var zone = boxZones[$art_ifpffb$art_i];
