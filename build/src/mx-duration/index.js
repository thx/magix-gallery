...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iggqorm$art_i = 0, $art_cnncfcapg$art_c = weeks.length; $art_iggqorm$art_i < $art_cnncfcapg$art_c; $art_iggqorm$art_i++) {    var week = weeks[$art_iggqorm$art_i]%>';
    for (var $art_iggqorm$art_i = 0, $art_cnncfcapg$art_c = weeks.length; $art_iggqorm$art_i < $art_cnncfcapg$art_c; $art_iggqorm$art_i++) {
        var week = weeks[$art_iggqorm$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihbgnhfaa$art_i = 0, $art_cjxzztjtj$art_c = ranges.length; $art_ihbgnhfaa$art_i < $art_cjxzztjtj$art_c; $art_ihbgnhfaa$art_i++) {    var range = ranges[$art_ihbgnhfaa$art_i]%>';
    for (var $art_ihbgnhfaa$art_i = 0, $art_cjxzztjtj$art_c = ranges.length; $art_ihbgnhfaa$art_i < $art_cjxzztjtj$art_c; $art_ihbgnhfaa$art_i++) {
        var range = ranges[$art_ihbgnhfaa$art_i];
    ...
    ;
    $expr = '<%for (var $art_itzrszt$art_i = 0, $art_chhlyxesk$art_c = boxZones.length; $art_itzrszt$art_i < $art_chhlyxesk$art_c; $art_itzrszt$art_i++) {    var zone = boxZones[$art_itzrszt$art_i]%>';
    for (var $art_itzrszt$art_i = 0, $art_chhlyxesk$art_c = boxZones.length; $art_itzrszt$art_i < $art_chhlyxesk$art_c; $art_itzrszt$art_i++) {
        var zone = boxZones[$art_itzrszt$art_i];
