...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imbcdwdn$art_i = 0, $art_cpjekyfy$art_c = weeks.length; $art_imbcdwdn$art_i < $art_cpjekyfy$art_c; $art_imbcdwdn$art_i++) {    var week = weeks[$art_imbcdwdn$art_i]%>';
    for (var $art_imbcdwdn$art_i = 0, $art_cpjekyfy$art_c = weeks.length; $art_imbcdwdn$art_i < $art_cpjekyfy$art_c; $art_imbcdwdn$art_i++) {
        var week = weeks[$art_imbcdwdn$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwstdvq$art_i = 0, $art_cbasjomvch$art_c = ranges.length; $art_iwstdvq$art_i < $art_cbasjomvch$art_c; $art_iwstdvq$art_i++) {    var range = ranges[$art_iwstdvq$art_i]%>';
    for (var $art_iwstdvq$art_i = 0, $art_cbasjomvch$art_c = ranges.length; $art_iwstdvq$art_i < $art_cbasjomvch$art_c; $art_iwstdvq$art_i++) {
        var range = ranges[$art_iwstdvq$art_i];
    ...
    ;
    $expr = '<%for (var $art_inmdoyldlp$art_i = 0, $art_coupiczg$art_c = boxZones.length; $art_inmdoyldlp$art_i < $art_coupiczg$art_c; $art_inmdoyldlp$art_i++) {    var zone = boxZones[$art_inmdoyldlp$art_i]%>';
    for (var $art_inmdoyldlp$art_i = 0, $art_coupiczg$art_c = boxZones.length; $art_inmdoyldlp$art_i < $art_coupiczg$art_c; $art_inmdoyldlp$art_i++) {
        var zone = boxZones[$art_inmdoyldlp$art_i];
