...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iblruurtor$art_i = 0, $art_ckbgmx$art_c = weeks.length; $art_iblruurtor$art_i < $art_ckbgmx$art_c; $art_iblruurtor$art_i++) {    var week = weeks[$art_iblruurtor$art_i]%>';
    for (var $art_iblruurtor$art_i = 0, $art_ckbgmx$art_c = weeks.length; $art_iblruurtor$art_i < $art_ckbgmx$art_c; $art_iblruurtor$art_i++) {
        var week = weeks[$art_iblruurtor$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilfziifmj$art_i = 0, $art_chlehqcvo$art_c = ranges.length; $art_ilfziifmj$art_i < $art_chlehqcvo$art_c; $art_ilfziifmj$art_i++) {    var range = ranges[$art_ilfziifmj$art_i]%>';
    for (var $art_ilfziifmj$art_i = 0, $art_chlehqcvo$art_c = ranges.length; $art_ilfziifmj$art_i < $art_chlehqcvo$art_c; $art_ilfziifmj$art_i++) {
        var range = ranges[$art_ilfziifmj$art_i];
    ...
    ;
    $expr = '<%for (var $art_iaehgyqylfa$art_i = 0, $art_cgcrlcvw$art_c = boxZones.length; $art_iaehgyqylfa$art_i < $art_cgcrlcvw$art_c; $art_iaehgyqylfa$art_i++) {    var zone = boxZones[$art_iaehgyqylfa$art_i]%>';
    for (var $art_iaehgyqylfa$art_i = 0, $art_cgcrlcvw$art_c = boxZones.length; $art_iaehgyqylfa$art_i < $art_cgcrlcvw$art_c; $art_iaehgyqylfa$art_i++) {
        var zone = boxZones[$art_iaehgyqylfa$art_i];
