...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iohafkepjx$art_i = 0, $art_ctdqxofqh$art_c = weeks.length; $art_iohafkepjx$art_i < $art_ctdqxofqh$art_c; $art_iohafkepjx$art_i++) {    var week = weeks[$art_iohafkepjx$art_i]%>';
    for (var $art_iohafkepjx$art_i = 0, $art_ctdqxofqh$art_c = weeks.length; $art_iohafkepjx$art_i < $art_ctdqxofqh$art_c; $art_iohafkepjx$art_i++) {
        var week = weeks[$art_iohafkepjx$art_i];
    ...
    ;
    $expr = '<%for (var $art_iakyanwhheo$art_i = 0, $art_civzwgmtb$art_c = ranges.length; $art_iakyanwhheo$art_i < $art_civzwgmtb$art_c; $art_iakyanwhheo$art_i++) {    var range = ranges[$art_iakyanwhheo$art_i]%>';
    for (var $art_iakyanwhheo$art_i = 0, $art_civzwgmtb$art_c = ranges.length; $art_iakyanwhheo$art_i < $art_civzwgmtb$art_c; $art_iakyanwhheo$art_i++) {
        var range = ranges[$art_iakyanwhheo$art_i];
    ...
    ;
    $expr = '<%for (var $art_igddpqdo$art_i = 0, $art_cysolnem$art_c = boxZones.length; $art_igddpqdo$art_i < $art_cysolnem$art_c; $art_igddpqdo$art_i++) {    var zone = boxZones[$art_igddpqdo$art_i]%>';
    for (var $art_igddpqdo$art_i = 0, $art_cysolnem$art_c = boxZones.length; $art_igddpqdo$art_i < $art_cysolnem$art_c; $art_igddpqdo$art_i++) {
        var zone = boxZones[$art_igddpqdo$art_i];
