...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyhzwwyjmue$art_i = 0, $art_cfkoqolcq$art_c = weeks.length; $art_iyhzwwyjmue$art_i < $art_cfkoqolcq$art_c; $art_iyhzwwyjmue$art_i++) {    var week = weeks[$art_iyhzwwyjmue$art_i]%>';
    for (var $art_iyhzwwyjmue$art_i = 0, $art_cfkoqolcq$art_c = weeks.length; $art_iyhzwwyjmue$art_i < $art_cfkoqolcq$art_c; $art_iyhzwwyjmue$art_i++) {
        var week = weeks[$art_iyhzwwyjmue$art_i];
    ...
    ;
    $expr = '<%for (var $art_icgtksuln$art_i = 0, $art_ctrsqqvubgi$art_c = ranges.length; $art_icgtksuln$art_i < $art_ctrsqqvubgi$art_c; $art_icgtksuln$art_i++) {    var range = ranges[$art_icgtksuln$art_i]%>';
    for (var $art_icgtksuln$art_i = 0, $art_ctrsqqvubgi$art_c = ranges.length; $art_icgtksuln$art_i < $art_ctrsqqvubgi$art_c; $art_icgtksuln$art_i++) {
        var range = ranges[$art_icgtksuln$art_i];
    ...
    ;
    $expr = '<%for (var $art_iucrhaun$art_i = 0, $art_czlsaors$art_c = boxZones.length; $art_iucrhaun$art_i < $art_czlsaors$art_c; $art_iucrhaun$art_i++) {    var zone = boxZones[$art_iucrhaun$art_i]%>';
    for (var $art_iucrhaun$art_i = 0, $art_czlsaors$art_c = boxZones.length; $art_iucrhaun$art_i < $art_czlsaors$art_c; $art_iucrhaun$art_i++) {
        var zone = boxZones[$art_iucrhaun$art_i];
