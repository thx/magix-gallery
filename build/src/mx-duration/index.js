...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_inkbqrfbk$art_i = 0, $art_ceueci$art_c = weeks.length; $art_inkbqrfbk$art_i < $art_ceueci$art_c; $art_inkbqrfbk$art_i++) {    var week = weeks[$art_inkbqrfbk$art_i]%>';
    for (var $art_inkbqrfbk$art_i = 0, $art_ceueci$art_c = weeks.length; $art_inkbqrfbk$art_i < $art_ceueci$art_c; $art_inkbqrfbk$art_i++) {
        var week = weeks[$art_inkbqrfbk$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iwccrfirf$art_i = 0, $art_ceqvsb$art_c = ranges.length; $art_iwccrfirf$art_i < $art_ceqvsb$art_c; $art_iwccrfirf$art_i++) {    var range = ranges[$art_iwccrfirf$art_i]%>';
    for (var $art_iwccrfirf$art_i = 0, $art_ceqvsb$art_c = ranges.length; $art_iwccrfirf$art_i < $art_ceqvsb$art_c; $art_iwccrfirf$art_i++) {
        var range = ranges[$art_iwccrfirf$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_irdouefls$art_i = 0, $art_cusbdqpm$art_c = boxZones.length; $art_irdouefls$art_i < $art_cusbdqpm$art_c; $art_irdouefls$art_i++) {    var zone = boxZones[$art_irdouefls$art_i]%>';
    for (var $art_irdouefls$art_i = 0, $art_cusbdqpm$art_c = boxZones.length; $art_irdouefls$art_i < $art_cusbdqpm$art_c; $art_irdouefls$art_i++) {
        var zone = boxZones[$art_irdouefls$art_i];
