...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuzgfjojcim$art_i = 0, $art_cqkvuxojmo$art_c = weeks.length; $art_iuzgfjojcim$art_i < $art_cqkvuxojmo$art_c; $art_iuzgfjojcim$art_i++) {    var week = weeks[$art_iuzgfjojcim$art_i]%>';
    for (var $art_iuzgfjojcim$art_i = 0, $art_cqkvuxojmo$art_c = weeks.length; $art_iuzgfjojcim$art_i < $art_cqkvuxojmo$art_c; $art_iuzgfjojcim$art_i++) {
        var week = weeks[$art_iuzgfjojcim$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifswyahov$art_i = 0, $art_ceeuljxeoi$art_c = ranges.length; $art_ifswyahov$art_i < $art_ceeuljxeoi$art_c; $art_ifswyahov$art_i++) {    var range = ranges[$art_ifswyahov$art_i]%>';
    for (var $art_ifswyahov$art_i = 0, $art_ceeuljxeoi$art_c = ranges.length; $art_ifswyahov$art_i < $art_ceeuljxeoi$art_c; $art_ifswyahov$art_i++) {
        var range = ranges[$art_ifswyahov$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuzenmqgdyn$art_i = 0, $art_cocy$art_c = boxZones.length; $art_iuzenmqgdyn$art_i < $art_cocy$art_c; $art_iuzenmqgdyn$art_i++) {    var zone = boxZones[$art_iuzenmqgdyn$art_i]%>';
    for (var $art_iuzenmqgdyn$art_i = 0, $art_cocy$art_c = boxZones.length; $art_iuzenmqgdyn$art_i < $art_cocy$art_c; $art_iuzenmqgdyn$art_i++) {
        var zone = boxZones[$art_iuzenmqgdyn$art_i];
