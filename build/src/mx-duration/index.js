...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idfpefp$art_i = 0, $art_cuuldldddi$art_c = weeks.length; $art_idfpefp$art_i < $art_cuuldldddi$art_c; $art_idfpefp$art_i++) {    var week = weeks[$art_idfpefp$art_i]%>';
    for (var $art_idfpefp$art_i = 0, $art_cuuldldddi$art_c = weeks.length; $art_idfpefp$art_i < $art_cuuldldddi$art_c; $art_idfpefp$art_i++) {
        var week = weeks[$art_idfpefp$art_i];
    ...
    ;
    $expr = '<%for (var $art_iymqqpacmb$art_i = 0, $art_ccoacr$art_c = ranges.length; $art_iymqqpacmb$art_i < $art_ccoacr$art_c; $art_iymqqpacmb$art_i++) {    var range = ranges[$art_iymqqpacmb$art_i]%>';
    for (var $art_iymqqpacmb$art_i = 0, $art_ccoacr$art_c = ranges.length; $art_iymqqpacmb$art_i < $art_ccoacr$art_c; $art_iymqqpacmb$art_i++) {
        var range = ranges[$art_iymqqpacmb$art_i];
    ...
    ;
    $expr = '<%for (var $art_iltmegxl$art_i = 0, $art_cwwdzvqs$art_c = boxZones.length; $art_iltmegxl$art_i < $art_cwwdzvqs$art_c; $art_iltmegxl$art_i++) {    var zone = boxZones[$art_iltmegxl$art_i]%>';
    for (var $art_iltmegxl$art_i = 0, $art_cwwdzvqs$art_c = boxZones.length; $art_iltmegxl$art_i < $art_cwwdzvqs$art_c; $art_iltmegxl$art_i++) {
        var zone = boxZones[$art_iltmegxl$art_i];
