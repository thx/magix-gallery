...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iymqycuf$art_i = 0, $art_cnfdsvahwg$art_c = weeks.length; $art_iymqycuf$art_i < $art_cnfdsvahwg$art_c; $art_iymqycuf$art_i++) {    var week = weeks[$art_iymqycuf$art_i]%>';
    for (var $art_iymqycuf$art_i = 0, $art_cnfdsvahwg$art_c = weeks.length; $art_iymqycuf$art_i < $art_cnfdsvahwg$art_c; $art_iymqycuf$art_i++) {
        var week = weeks[$art_iymqycuf$art_i];
    ...
    ;
    $expr = '<%for (var $art_iydqpuekc$art_i = 0, $art_copjwnx$art_c = ranges.length; $art_iydqpuekc$art_i < $art_copjwnx$art_c; $art_iydqpuekc$art_i++) {    var range = ranges[$art_iydqpuekc$art_i]%>';
    for (var $art_iydqpuekc$art_i = 0, $art_copjwnx$art_c = ranges.length; $art_iydqpuekc$art_i < $art_copjwnx$art_c; $art_iydqpuekc$art_i++) {
        var range = ranges[$art_iydqpuekc$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqaabgbkyi$art_i = 0, $art_cmawil$art_c = boxZones.length; $art_iqaabgbkyi$art_i < $art_cmawil$art_c; $art_iqaabgbkyi$art_i++) {    var zone = boxZones[$art_iqaabgbkyi$art_i]%>';
    for (var $art_iqaabgbkyi$art_i = 0, $art_cmawil$art_c = boxZones.length; $art_iqaabgbkyi$art_i < $art_cmawil$art_c; $art_iqaabgbkyi$art_i++) {
        var zone = boxZones[$art_iqaabgbkyi$art_i];
