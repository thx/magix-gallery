...
module.exports = Magix.View.extend({
    ...
    if (hoverInfo.show) {
        ...
        $art = '=hoverInfo.left';
        ;
        $p += ($expr = '<%=hoverInfo.left%>', $e(hoverInfo.left)) + 'px;" class="_zs_gallery_mx-duration_index_-discount-hover mx-shadow"><div mxa="_zs_gallerybc:_" class="mb5">';
        $line = 6;
        $art = '=hoverInfo.week';
        ;
        $p += ($expr = '<%=hoverInfo.week%>', $e(hoverInfo.week)) + '</div><div mxa="_zs_gallerybc:a" class="mb5"><strong>';
        $line = 7;
        $art = '=hoverInfo.time';
        ;
    ...
    if (settingInfo.show) {
        ...
        ;
        $p += ($expr = '<%=settingInfo.left%>', $e(settingInfo.left)) + 'px;" class="_zs_gallery_mx-duration_index_-discount-setting mx-shadow"><div mxv mxa="_zs_gallerybc:b" class="_zs_gallery_mx-duration_index_-setting-content"><div mxa="_zs_gallerybc:c" class="mb10"><span>';
        $line = 24;
        $art = '=settingInfo.week';
        ;
        $p += ($expr = '<%=settingInfo.week%>', $e(settingInfo.week)) + '</span>：<strong mxa="_zs_gallerybc:d" class="ml5">';
        $line = 25;
        $art = '=settingInfo.time';
        ;
        $p += ($expr = '<%=settingInfo.time%>', $e(settingInfo.time)) + '</strong></div><div mxv mxa="_zs_gallerybc:e" class="mb5"><label mxv><input type="radio" class="radio" name="settingType" value="1" mx-change="' + $viewId + 'changeSettingType({type:1})" ';
        $line = 31;
        ...
        ;
        $p += '<span mxs="_zs_gallerybc:_" class="ml5">%</span></div><div mxv mxa="_zs_gallerybc:f" class="mb10"><label mxv><input type="radio" name="settingType" class="radio" value="2" mx-change="' + $viewId + 'changeSettingType({type:2})" ';
        $line = 48;
        ...
        ;
        $p += '/>无折扣</label></div><div mxv mxa="_zs_gallerybc:g" class="mb10"><label mxv><input type="radio" name="settingType" class="radio" value="3" mx-change="' + $viewId + 'changeSettingType({type:3})" ';
        $line = 55;
    ...
    ;
    $expr = '<%for (var $art_ixwapmbjq$art_i = 0, $art_cjbfzz$art_c = weeks.length; $art_ixwapmbjq$art_i < $art_cjbfzz$art_c; $art_ixwapmbjq$art_i++) {    var week = weeks[$art_ixwapmbjq$art_i]%>';
    for (var $art_ixwapmbjq$art_i = 0, $art_cjbfzz$art_c = weeks.length; $art_ixwapmbjq$art_i < $art_cjbfzz$art_c; $art_ixwapmbjq$art_i++) {
        var week = weeks[$art_ixwapmbjq$art_i];
    ...
    $art = '=boxWidth*rowNum';
    ;
    $p += ($expr = '<%=boxWidth * rowNum%>', $e(boxWidth * rowNum)) + 'px;"><ul mxa="_zs_gallerybc:h" class="_zs_gallery_mx-duration_index_-range clearfix">';
    $line = 76;
    $art = 'each ranges as range';
    ;
    $expr = '<%for (var $art_ihekuvjtnmm$art_i = 0, $art_ckpbwzke$art_c = ranges.length; $art_ihekuvjtnmm$art_i < $art_ckpbwzke$art_c; $art_ihekuvjtnmm$art_i++) {    var range = ranges[$art_ihekuvjtnmm$art_i]%>';
    for (var $art_ihekuvjtnmm$art_i = 0, $art_ckpbwzke$art_c = ranges.length; $art_ihekuvjtnmm$art_i < $art_ckpbwzke$art_c; $art_ihekuvjtnmm$art_i++) {
        var range = ranges[$art_ihekuvjtnmm$art_i];
    ...
    ;
    $p += '</ul><ul mxa="_zs_gallerybc:i" class="_zs_gallery_mx-duration_index_-time clearfix">';
    $line = 81;
    ...
    ;
    $p += '</ul><ul mxa="_zs_gallerybc:j" class="_zs_gallery_mx-duration_index_-boxzone clearfix">';
    $line = 86;
    $art = 'each boxZones as zone';
    ;
    $expr = '<%for (var $art_ipbtwuwzzfg$art_i = 0, $art_clzzcwcp$art_c = boxZones.length; $art_ipbtwuwzzfg$art_i < $art_clzzcwcp$art_c; $art_ipbtwuwzzfg$art_i++) {    var zone = boxZones[$art_ipbtwuwzzfg$art_i]%>';
    for (var $art_ipbtwuwzzfg$art_i = 0, $art_clzzcwcp$art_c = boxZones.length; $art_ipbtwuwzzfg$art_i < $art_clzzcwcp$art_c; $art_ipbtwuwzzfg$art_i++) {
        var zone = boxZones[$art_ipbtwuwzzfg$art_i];
