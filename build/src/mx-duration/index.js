...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iathmtcsx$art_i = 0, $art_czyjgqii$art_c = weeks.length; $art_iathmtcsx$art_i < $art_czyjgqii$art_c; $art_iathmtcsx$art_i++) {    var week = weeks[$art_iathmtcsx$art_i]%>';
    for (var $art_iathmtcsx$art_i = 0, $art_czyjgqii$art_c = weeks.length; $art_iathmtcsx$art_i < $art_czyjgqii$art_c; $art_iathmtcsx$art_i++) {
        var week = weeks[$art_iathmtcsx$art_i];
    ...
    ;
    $expr = '<%for (var $art_icpmmymklj$art_i = 0, $art_ctmyxjdbf$art_c = ranges.length; $art_icpmmymklj$art_i < $art_ctmyxjdbf$art_c; $art_icpmmymklj$art_i++) {    var range = ranges[$art_icpmmymklj$art_i]%>';
    for (var $art_icpmmymklj$art_i = 0, $art_ctmyxjdbf$art_c = ranges.length; $art_icpmmymklj$art_i < $art_ctmyxjdbf$art_c; $art_icpmmymklj$art_i++) {
        var range = ranges[$art_icpmmymklj$art_i];
    ...
    ;
    $expr = '<%for (var $art_imyrshyso$art_i = 0, $art_ccgbfkruqi$art_c = boxZones.length; $art_imyrshyso$art_i < $art_ccgbfkruqi$art_c; $art_imyrshyso$art_i++) {    var zone = boxZones[$art_imyrshyso$art_i]%>';
    for (var $art_imyrshyso$art_i = 0, $art_ccgbfkruqi$art_c = boxZones.length; $art_imyrshyso$art_i < $art_ccgbfkruqi$art_c; $art_imyrshyso$art_i++) {
        var zone = boxZones[$art_imyrshyso$art_i];
