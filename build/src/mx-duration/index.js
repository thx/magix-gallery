...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inxppibv$art_i = 0, $art_cnddhtrp$art_c = weeks.length; $art_inxppibv$art_i < $art_cnddhtrp$art_c; $art_inxppibv$art_i++) {    var week = weeks[$art_inxppibv$art_i]%>';
    for (var $art_inxppibv$art_i = 0, $art_cnddhtrp$art_c = weeks.length; $art_inxppibv$art_i < $art_cnddhtrp$art_c; $art_inxppibv$art_i++) {
        var week = weeks[$art_inxppibv$art_i];
    ...
    ;
    $expr = '<%for (var $art_iehzryrj$art_i = 0, $art_cvwpewrrwrf$art_c = ranges.length; $art_iehzryrj$art_i < $art_cvwpewrrwrf$art_c; $art_iehzryrj$art_i++) {    var range = ranges[$art_iehzryrj$art_i]%>';
    for (var $art_iehzryrj$art_i = 0, $art_cvwpewrrwrf$art_c = ranges.length; $art_iehzryrj$art_i < $art_cvwpewrrwrf$art_c; $art_iehzryrj$art_i++) {
        var range = ranges[$art_iehzryrj$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwlkkivibg$art_i = 0, $art_cmbhwuzvi$art_c = boxZones.length; $art_iwlkkivibg$art_i < $art_cmbhwuzvi$art_c; $art_iwlkkivibg$art_i++) {    var zone = boxZones[$art_iwlkkivibg$art_i]%>';
    for (var $art_iwlkkivibg$art_i = 0, $art_cmbhwuzvi$art_c = boxZones.length; $art_iwlkkivibg$art_i < $art_cmbhwuzvi$art_c; $art_iwlkkivibg$art_i++) {
        var zone = boxZones[$art_iwlkkivibg$art_i];
