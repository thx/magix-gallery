...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ifchfwyxdwj$art_i = 0, $art_civuzmx$art_c = weeks.length; $art_ifchfwyxdwj$art_i < $art_civuzmx$art_c; $art_ifchfwyxdwj$art_i++) {    var week = weeks[$art_ifchfwyxdwj$art_i]%>';
    for (var $art_ifchfwyxdwj$art_i = 0, $art_civuzmx$art_c = weeks.length; $art_ifchfwyxdwj$art_i < $art_civuzmx$art_c; $art_ifchfwyxdwj$art_i++) {
        var week = weeks[$art_ifchfwyxdwj$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ikwesiyb$art_i = 0, $art_cmuvq$art_c = ranges.length; $art_ikwesiyb$art_i < $art_cmuvq$art_c; $art_ikwesiyb$art_i++) {    var range = ranges[$art_ikwesiyb$art_i]%>';
    for (var $art_ikwesiyb$art_i = 0, $art_cmuvq$art_c = ranges.length; $art_ikwesiyb$art_i < $art_cmuvq$art_c; $art_ikwesiyb$art_i++) {
        var range = ranges[$art_ikwesiyb$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iioclirjkw$art_i = 0, $art_curzdnnloxm$art_c = boxZones.length; $art_iioclirjkw$art_i < $art_curzdnnloxm$art_c; $art_iioclirjkw$art_i++) {    var zone = boxZones[$art_iioclirjkw$art_i]%>';
    for (var $art_iioclirjkw$art_i = 0, $art_curzdnnloxm$art_c = boxZones.length; $art_iioclirjkw$art_i < $art_curzdnnloxm$art_c; $art_iioclirjkw$art_i++) {
        var zone = boxZones[$art_iioclirjkw$art_i];
