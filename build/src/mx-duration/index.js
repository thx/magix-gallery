...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivgkyssvq$art_i = 0, $art_chzghdorkjpu$art_c = weeks.length; $art_ivgkyssvq$art_i < $art_chzghdorkjpu$art_c; $art_ivgkyssvq$art_i++) {    var week = weeks[$art_ivgkyssvq$art_i]%>';
    for (var $art_ivgkyssvq$art_i = 0, $art_chzghdorkjpu$art_c = weeks.length; $art_ivgkyssvq$art_i < $art_chzghdorkjpu$art_c; $art_ivgkyssvq$art_i++) {
        var week = weeks[$art_ivgkyssvq$art_i];
    ...
    ;
    $expr = '<%for (var $art_iaezoglio$art_i = 0, $art_cfzxvuvo$art_c = ranges.length; $art_iaezoglio$art_i < $art_cfzxvuvo$art_c; $art_iaezoglio$art_i++) {    var range = ranges[$art_iaezoglio$art_i]%>';
    for (var $art_iaezoglio$art_i = 0, $art_cfzxvuvo$art_c = ranges.length; $art_iaezoglio$art_i < $art_cfzxvuvo$art_c; $art_iaezoglio$art_i++) {
        var range = ranges[$art_iaezoglio$art_i];
    ...
    ;
    $expr = '<%for (var $art_idnvurma$art_i = 0, $art_cadkkgfiycf$art_c = boxZones.length; $art_idnvurma$art_i < $art_cadkkgfiycf$art_c; $art_idnvurma$art_i++) {    var zone = boxZones[$art_idnvurma$art_i]%>';
    for (var $art_idnvurma$art_i = 0, $art_cadkkgfiycf$art_c = boxZones.length; $art_idnvurma$art_i < $art_cadkkgfiycf$art_c; $art_idnvurma$art_i++) {
        var zone = boxZones[$art_idnvurma$art_i];
