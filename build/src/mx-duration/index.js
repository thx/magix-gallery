...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idizawn$art_i = 0, $art_crlwaeqol$art_c = weeks.length; $art_idizawn$art_i < $art_crlwaeqol$art_c; $art_idizawn$art_i++) {    var week = weeks[$art_idizawn$art_i]%>';
    for (var $art_idizawn$art_i = 0, $art_crlwaeqol$art_c = weeks.length; $art_idizawn$art_i < $art_crlwaeqol$art_c; $art_idizawn$art_i++) {
        var week = weeks[$art_idizawn$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihfbhb$art_i = 0, $art_ccniffzii$art_c = ranges.length; $art_ihfbhb$art_i < $art_ccniffzii$art_c; $art_ihfbhb$art_i++) {    var range = ranges[$art_ihfbhb$art_i]%>';
    for (var $art_ihfbhb$art_i = 0, $art_ccniffzii$art_c = ranges.length; $art_ihfbhb$art_i < $art_ccniffzii$art_c; $art_ihfbhb$art_i++) {
        var range = ranges[$art_ihfbhb$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipzsnipr$art_i = 0, $art_cqkmdmg$art_c = boxZones.length; $art_ipzsnipr$art_i < $art_cqkmdmg$art_c; $art_ipzsnipr$art_i++) {    var zone = boxZones[$art_ipzsnipr$art_i]%>';
    for (var $art_ipzsnipr$art_i = 0, $art_cqkmdmg$art_c = boxZones.length; $art_ipzsnipr$art_i < $art_cqkmdmg$art_c; $art_ipzsnipr$art_i++) {
        var zone = boxZones[$art_ipzsnipr$art_i];
