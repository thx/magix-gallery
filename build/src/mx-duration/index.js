...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibtnnyenkwsi$art_i = 0, $art_cctwrobgo$art_c = weeks.length; $art_ibtnnyenkwsi$art_i < $art_cctwrobgo$art_c; $art_ibtnnyenkwsi$art_i++) {    var week = weeks[$art_ibtnnyenkwsi$art_i]%>';
    for (var $art_ibtnnyenkwsi$art_i = 0, $art_cctwrobgo$art_c = weeks.length; $art_ibtnnyenkwsi$art_i < $art_cctwrobgo$art_c; $art_ibtnnyenkwsi$art_i++) {
        var week = weeks[$art_ibtnnyenkwsi$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuuswvlpm$art_i = 0, $art_cwxsxwsqm$art_c = ranges.length; $art_iuuswvlpm$art_i < $art_cwxsxwsqm$art_c; $art_iuuswvlpm$art_i++) {    var range = ranges[$art_iuuswvlpm$art_i]%>';
    for (var $art_iuuswvlpm$art_i = 0, $art_cwxsxwsqm$art_c = ranges.length; $art_iuuswvlpm$art_i < $art_cwxsxwsqm$art_c; $art_iuuswvlpm$art_i++) {
        var range = ranges[$art_iuuswvlpm$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuigkrg$art_i = 0, $art_cpknjec$art_c = boxZones.length; $art_iuigkrg$art_i < $art_cpknjec$art_c; $art_iuigkrg$art_i++) {    var zone = boxZones[$art_iuigkrg$art_i]%>';
    for (var $art_iuigkrg$art_i = 0, $art_cpknjec$art_c = boxZones.length; $art_iuigkrg$art_i < $art_cpknjec$art_c; $art_iuigkrg$art_i++) {
        var zone = boxZones[$art_iuigkrg$art_i];
