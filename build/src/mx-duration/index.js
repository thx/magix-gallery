...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iozewbokry$art_i = 0, $art_cocpqgrjif$art_c = weeks.length; $art_iozewbokry$art_i < $art_cocpqgrjif$art_c; $art_iozewbokry$art_i++) {    var week = weeks[$art_iozewbokry$art_i]%>';
    for (var $art_iozewbokry$art_i = 0, $art_cocpqgrjif$art_c = weeks.length; $art_iozewbokry$art_i < $art_cocpqgrjif$art_c; $art_iozewbokry$art_i++) {
        var week = weeks[$art_iozewbokry$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqphx$art_i = 0, $art_caosvne$art_c = ranges.length; $art_iqphx$art_i < $art_caosvne$art_c; $art_iqphx$art_i++) {    var range = ranges[$art_iqphx$art_i]%>';
    for (var $art_iqphx$art_i = 0, $art_caosvne$art_c = ranges.length; $art_iqphx$art_i < $art_caosvne$art_c; $art_iqphx$art_i++) {
        var range = ranges[$art_iqphx$art_i];
    ...
    ;
    $expr = '<%for (var $art_iyphogfm$art_i = 0, $art_czdtudnjrx$art_c = boxZones.length; $art_iyphogfm$art_i < $art_czdtudnjrx$art_c; $art_iyphogfm$art_i++) {    var zone = boxZones[$art_iyphogfm$art_i]%>';
    for (var $art_iyphogfm$art_i = 0, $art_czdtudnjrx$art_c = boxZones.length; $art_iyphogfm$art_i < $art_czdtudnjrx$art_c; $art_iyphogfm$art_i++) {
        var zone = boxZones[$art_iyphogfm$art_i];
