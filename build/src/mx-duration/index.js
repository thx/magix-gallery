...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwhngwvj$art_i = 0, $art_cdxfmnj$art_c = weeks.length; $art_iwhngwvj$art_i < $art_cdxfmnj$art_c; $art_iwhngwvj$art_i++) {    var week = weeks[$art_iwhngwvj$art_i]%>';
    for (var $art_iwhngwvj$art_i = 0, $art_cdxfmnj$art_c = weeks.length; $art_iwhngwvj$art_i < $art_cdxfmnj$art_c; $art_iwhngwvj$art_i++) {
        var week = weeks[$art_iwhngwvj$art_i];
    ...
    ;
    $expr = '<%for (var $art_icsabjzzue$art_i = 0, $art_cwifmao$art_c = ranges.length; $art_icsabjzzue$art_i < $art_cwifmao$art_c; $art_icsabjzzue$art_i++) {    var range = ranges[$art_icsabjzzue$art_i]%>';
    for (var $art_icsabjzzue$art_i = 0, $art_cwifmao$art_c = ranges.length; $art_icsabjzzue$art_i < $art_cwifmao$art_c; $art_icsabjzzue$art_i++) {
        var range = ranges[$art_icsabjzzue$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwqomotoce$art_i = 0, $art_cenjdpxrv$art_c = boxZones.length; $art_iwqomotoce$art_i < $art_cenjdpxrv$art_c; $art_iwqomotoce$art_i++) {    var zone = boxZones[$art_iwqomotoce$art_i]%>';
    for (var $art_iwqomotoce$art_i = 0, $art_cenjdpxrv$art_c = boxZones.length; $art_iwqomotoce$art_i < $art_cenjdpxrv$art_c; $art_iwqomotoce$art_i++) {
        var zone = boxZones[$art_iwqomotoce$art_i];
