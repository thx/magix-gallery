...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwkdhpxzr$art_i = 0, $art_cgral$art_c = weeks.length; $art_iwkdhpxzr$art_i < $art_cgral$art_c; $art_iwkdhpxzr$art_i++) {    var week = weeks[$art_iwkdhpxzr$art_i]%>';
    for (var $art_iwkdhpxzr$art_i = 0, $art_cgral$art_c = weeks.length; $art_iwkdhpxzr$art_i < $art_cgral$art_c; $art_iwkdhpxzr$art_i++) {
        var week = weeks[$art_iwkdhpxzr$art_i];
    ...
    ;
    $expr = '<%for (var $art_iredrqpuq$art_i = 0, $art_chovkwhjjjn$art_c = ranges.length; $art_iredrqpuq$art_i < $art_chovkwhjjjn$art_c; $art_iredrqpuq$art_i++) {    var range = ranges[$art_iredrqpuq$art_i]%>';
    for (var $art_iredrqpuq$art_i = 0, $art_chovkwhjjjn$art_c = ranges.length; $art_iredrqpuq$art_i < $art_chovkwhjjjn$art_c; $art_iredrqpuq$art_i++) {
        var range = ranges[$art_iredrqpuq$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqdzgypu$art_i = 0, $art_chslzupft$art_c = boxZones.length; $art_iqdzgypu$art_i < $art_chslzupft$art_c; $art_iqdzgypu$art_i++) {    var zone = boxZones[$art_iqdzgypu$art_i]%>';
    for (var $art_iqdzgypu$art_i = 0, $art_chslzupft$art_c = boxZones.length; $art_iqdzgypu$art_i < $art_chslzupft$art_c; $art_iqdzgypu$art_i++) {
        var zone = boxZones[$art_iqdzgypu$art_i];
