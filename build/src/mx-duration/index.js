...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivkh$art_i = 0, $art_cbsytmlnlfrr$art_c = weeks.length; $art_ivkh$art_i < $art_cbsytmlnlfrr$art_c; $art_ivkh$art_i++) {    var week = weeks[$art_ivkh$art_i]%>';
    for (var $art_ivkh$art_i = 0, $art_cbsytmlnlfrr$art_c = weeks.length; $art_ivkh$art_i < $art_cbsytmlnlfrr$art_c; $art_ivkh$art_i++) {
        var week = weeks[$art_ivkh$art_i];
    ...
    ;
    $expr = '<%for (var $art_idglgirqxo$art_i = 0, $art_cwlytum$art_c = ranges.length; $art_idglgirqxo$art_i < $art_cwlytum$art_c; $art_idglgirqxo$art_i++) {    var range = ranges[$art_idglgirqxo$art_i]%>';
    for (var $art_idglgirqxo$art_i = 0, $art_cwlytum$art_c = ranges.length; $art_idglgirqxo$art_i < $art_cwlytum$art_c; $art_idglgirqxo$art_i++) {
        var range = ranges[$art_idglgirqxo$art_i];
    ...
    ;
    $expr = '<%for (var $art_iutswxvxj$art_i = 0, $art_cixtkfjiyrq$art_c = boxZones.length; $art_iutswxvxj$art_i < $art_cixtkfjiyrq$art_c; $art_iutswxvxj$art_i++) {    var zone = boxZones[$art_iutswxvxj$art_i]%>';
    for (var $art_iutswxvxj$art_i = 0, $art_cixtkfjiyrq$art_c = boxZones.length; $art_iutswxvxj$art_i < $art_cixtkfjiyrq$art_c; $art_iutswxvxj$art_i++) {
        var zone = boxZones[$art_iutswxvxj$art_i];
