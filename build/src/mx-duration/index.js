...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifizhzti$art_i = 0, $art_cfpaqziqcko$art_c = weeks.length; $art_ifizhzti$art_i < $art_cfpaqziqcko$art_c; $art_ifizhzti$art_i++) {    var week = weeks[$art_ifizhzti$art_i]%>';
    for (var $art_ifizhzti$art_i = 0, $art_cfpaqziqcko$art_c = weeks.length; $art_ifizhzti$art_i < $art_cfpaqziqcko$art_c; $art_ifizhzti$art_i++) {
        var week = weeks[$art_ifizhzti$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwallmlf$art_i = 0, $art_chrgoqxl$art_c = ranges.length; $art_iwallmlf$art_i < $art_chrgoqxl$art_c; $art_iwallmlf$art_i++) {    var range = ranges[$art_iwallmlf$art_i]%>';
    for (var $art_iwallmlf$art_i = 0, $art_chrgoqxl$art_c = ranges.length; $art_iwallmlf$art_i < $art_chrgoqxl$art_c; $art_iwallmlf$art_i++) {
        var range = ranges[$art_iwallmlf$art_i];
    ...
    ;
    $expr = '<%for (var $art_iazsouitbq$art_i = 0, $art_cyduelvsbe$art_c = boxZones.length; $art_iazsouitbq$art_i < $art_cyduelvsbe$art_c; $art_iazsouitbq$art_i++) {    var zone = boxZones[$art_iazsouitbq$art_i]%>';
    for (var $art_iazsouitbq$art_i = 0, $art_cyduelvsbe$art_c = boxZones.length; $art_iazsouitbq$art_i < $art_cyduelvsbe$art_c; $art_iazsouitbq$art_i++) {
        var zone = boxZones[$art_iazsouitbq$art_i];
