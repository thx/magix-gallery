...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiuoghsza$art_i = 0, $art_cnrjxhaab$art_c = weeks.length; $art_iiuoghsza$art_i < $art_cnrjxhaab$art_c; $art_iiuoghsza$art_i++) {    var week = weeks[$art_iiuoghsza$art_i]%>';
    for (var $art_iiuoghsza$art_i = 0, $art_cnrjxhaab$art_c = weeks.length; $art_iiuoghsza$art_i < $art_cnrjxhaab$art_c; $art_iiuoghsza$art_i++) {
        var week = weeks[$art_iiuoghsza$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikjfrtux$art_i = 0, $art_ccvearbucb$art_c = ranges.length; $art_ikjfrtux$art_i < $art_ccvearbucb$art_c; $art_ikjfrtux$art_i++) {    var range = ranges[$art_ikjfrtux$art_i]%>';
    for (var $art_ikjfrtux$art_i = 0, $art_ccvearbucb$art_c = ranges.length; $art_ikjfrtux$art_i < $art_ccvearbucb$art_c; $art_ikjfrtux$art_i++) {
        var range = ranges[$art_ikjfrtux$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikuhzp$art_i = 0, $art_chlmgfdmvlbc$art_c = boxZones.length; $art_ikuhzp$art_i < $art_chlmgfdmvlbc$art_c; $art_ikuhzp$art_i++) {    var zone = boxZones[$art_ikuhzp$art_i]%>';
    for (var $art_ikuhzp$art_i = 0, $art_chlmgfdmvlbc$art_c = boxZones.length; $art_ikuhzp$art_i < $art_chlmgfdmvlbc$art_c; $art_ikuhzp$art_i++) {
        var zone = boxZones[$art_ikuhzp$art_i];
