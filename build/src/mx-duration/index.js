...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iyujqouefx$art_i=0;$art_iyujqouefx$art_i<weeks.length;$art_iyujqouefx$art_i++){var week=weeks[$art_iyujqouefx$art_i]%>';
    for (var $art_iyujqouefx$art_i = 0; $art_iyujqouefx$art_i < weeks.length; $art_iyujqouefx$art_i++) {
        var week = weeks[$art_iyujqouefx$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ikqvmkthjow$art_i=0;$art_ikqvmkthjow$art_i<ranges.length;$art_ikqvmkthjow$art_i++){var range=ranges[$art_ikqvmkthjow$art_i]%>';
    for (var $art_ikqvmkthjow$art_i = 0; $art_ikqvmkthjow$art_i < ranges.length; $art_ikqvmkthjow$art_i++) {
        var range = ranges[$art_ikqvmkthjow$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ibnwgeqkoaq$art_i=0;$art_ibnwgeqkoaq$art_i<boxZones.length;$art_ibnwgeqkoaq$art_i++){var zone=boxZones[$art_ibnwgeqkoaq$art_i]%>';
    for (var $art_ibnwgeqkoaq$art_i = 0; $art_ibnwgeqkoaq$art_i < boxZones.length; $art_ibnwgeqkoaq$art_i++) {
        var zone = boxZones[$art_ibnwgeqkoaq$art_i];
