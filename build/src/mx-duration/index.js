...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irgwdzgava$art_i = 0, $art_cecfbsefu$art_c = weeks.length; $art_irgwdzgava$art_i < $art_cecfbsefu$art_c; $art_irgwdzgava$art_i++) {    var week = weeks[$art_irgwdzgava$art_i]%>';
    for (var $art_irgwdzgava$art_i = 0, $art_cecfbsefu$art_c = weeks.length; $art_irgwdzgava$art_i < $art_cecfbsefu$art_c; $art_irgwdzgava$art_i++) {
        var week = weeks[$art_irgwdzgava$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivcpbrud$art_i = 0, $art_cdmzus$art_c = ranges.length; $art_ivcpbrud$art_i < $art_cdmzus$art_c; $art_ivcpbrud$art_i++) {    var range = ranges[$art_ivcpbrud$art_i]%>';
    for (var $art_ivcpbrud$art_i = 0, $art_cdmzus$art_c = ranges.length; $art_ivcpbrud$art_i < $art_cdmzus$art_c; $art_ivcpbrud$art_i++) {
        var range = ranges[$art_ivcpbrud$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikfhqenrf$art_i = 0, $art_clsyahafi$art_c = boxZones.length; $art_ikfhqenrf$art_i < $art_clsyahafi$art_c; $art_ikfhqenrf$art_i++) {    var zone = boxZones[$art_ikfhqenrf$art_i]%>';
    for (var $art_ikfhqenrf$art_i = 0, $art_clsyahafi$art_c = boxZones.length; $art_ikfhqenrf$art_i < $art_clsyahafi$art_c; $art_ikfhqenrf$art_i++) {
        var zone = boxZones[$art_ikfhqenrf$art_i];
