...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyjqyvih$art_i = 0, $art_cpsyvugsb$art_c = weeks.length; $art_iyjqyvih$art_i < $art_cpsyvugsb$art_c; $art_iyjqyvih$art_i++) {    var week = weeks[$art_iyjqyvih$art_i]%>';
    for (var $art_iyjqyvih$art_i = 0, $art_cpsyvugsb$art_c = weeks.length; $art_iyjqyvih$art_i < $art_cpsyvugsb$art_c; $art_iyjqyvih$art_i++) {
        var week = weeks[$art_iyjqyvih$art_i];
    ...
    ;
    $expr = '<%for (var $art_izzlhvh$art_i = 0, $art_ciypngfano$art_c = ranges.length; $art_izzlhvh$art_i < $art_ciypngfano$art_c; $art_izzlhvh$art_i++) {    var range = ranges[$art_izzlhvh$art_i]%>';
    for (var $art_izzlhvh$art_i = 0, $art_ciypngfano$art_c = ranges.length; $art_izzlhvh$art_i < $art_ciypngfano$art_c; $art_izzlhvh$art_i++) {
        var range = ranges[$art_izzlhvh$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwenbgifbi$art_i = 0, $art_cjvcilzzah$art_c = boxZones.length; $art_iwenbgifbi$art_i < $art_cjvcilzzah$art_c; $art_iwenbgifbi$art_i++) {    var zone = boxZones[$art_iwenbgifbi$art_i]%>';
    for (var $art_iwenbgifbi$art_i = 0, $art_cjvcilzzah$art_c = boxZones.length; $art_iwenbgifbi$art_i < $art_cjvcilzzah$art_c; $art_iwenbgifbi$art_i++) {
        var zone = boxZones[$art_iwenbgifbi$art_i];
