...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuvhkajqmh$art_i = 0, $art_cyvdguxi$art_c = weeks.length; $art_iuvhkajqmh$art_i < $art_cyvdguxi$art_c; $art_iuvhkajqmh$art_i++) {    var week = weeks[$art_iuvhkajqmh$art_i]%>';
    for (var $art_iuvhkajqmh$art_i = 0, $art_cyvdguxi$art_c = weeks.length; $art_iuvhkajqmh$art_i < $art_cyvdguxi$art_c; $art_iuvhkajqmh$art_i++) {
        var week = weeks[$art_iuvhkajqmh$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikrrcbbidk$art_i = 0, $art_cedszhiu$art_c = ranges.length; $art_ikrrcbbidk$art_i < $art_cedszhiu$art_c; $art_ikrrcbbidk$art_i++) {    var range = ranges[$art_ikrrcbbidk$art_i]%>';
    for (var $art_ikrrcbbidk$art_i = 0, $art_cedszhiu$art_c = ranges.length; $art_ikrrcbbidk$art_i < $art_cedszhiu$art_c; $art_ikrrcbbidk$art_i++) {
        var range = ranges[$art_ikrrcbbidk$art_i];
    ...
    ;
    $expr = '<%for (var $art_iymdipkp$art_i = 0, $art_cojrxjbtfq$art_c = boxZones.length; $art_iymdipkp$art_i < $art_cojrxjbtfq$art_c; $art_iymdipkp$art_i++) {    var zone = boxZones[$art_iymdipkp$art_i]%>';
    for (var $art_iymdipkp$art_i = 0, $art_cojrxjbtfq$art_c = boxZones.length; $art_iymdipkp$art_i < $art_cojrxjbtfq$art_c; $art_iymdipkp$art_i++) {
        var zone = boxZones[$art_iymdipkp$art_i];
