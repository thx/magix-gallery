...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijscnbkh$art_i = 0, $art_cbpxlnvvoa$art_c = weeks.length; $art_ijscnbkh$art_i < $art_cbpxlnvvoa$art_c; $art_ijscnbkh$art_i++) {    var week = weeks[$art_ijscnbkh$art_i]%>';
    for (var $art_ijscnbkh$art_i = 0, $art_cbpxlnvvoa$art_c = weeks.length; $art_ijscnbkh$art_i < $art_cbpxlnvvoa$art_c; $art_ijscnbkh$art_i++) {
        var week = weeks[$art_ijscnbkh$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwyvwuun$art_i = 0, $art_cdfphaveh$art_c = ranges.length; $art_iwyvwuun$art_i < $art_cdfphaveh$art_c; $art_iwyvwuun$art_i++) {    var range = ranges[$art_iwyvwuun$art_i]%>';
    for (var $art_iwyvwuun$art_i = 0, $art_cdfphaveh$art_c = ranges.length; $art_iwyvwuun$art_i < $art_cdfphaveh$art_c; $art_iwyvwuun$art_i++) {
        var range = ranges[$art_iwyvwuun$art_i];
    ...
    ;
    $expr = '<%for (var $art_isjxlcknvyoh$art_i = 0, $art_cbnvaqpxcspi$art_c = boxZones.length; $art_isjxlcknvyoh$art_i < $art_cbnvaqpxcspi$art_c; $art_isjxlcknvyoh$art_i++) {    var zone = boxZones[$art_isjxlcknvyoh$art_i]%>';
    for (var $art_isjxlcknvyoh$art_i = 0, $art_cbnvaqpxcspi$art_c = boxZones.length; $art_isjxlcknvyoh$art_i < $art_cbnvaqpxcspi$art_c; $art_isjxlcknvyoh$art_i++) {
        var zone = boxZones[$art_isjxlcknvyoh$art_i];
