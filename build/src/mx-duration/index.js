...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivacggple$art_i = 0, $art_cozcu$art_c = weeks.length; $art_ivacggple$art_i < $art_cozcu$art_c; $art_ivacggple$art_i++) {    var week = weeks[$art_ivacggple$art_i]%>';
    for (var $art_ivacggple$art_i = 0, $art_cozcu$art_c = weeks.length; $art_ivacggple$art_i < $art_cozcu$art_c; $art_ivacggple$art_i++) {
        var week = weeks[$art_ivacggple$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilejiufx$art_i = 0, $art_craodmngh$art_c = ranges.length; $art_ilejiufx$art_i < $art_craodmngh$art_c; $art_ilejiufx$art_i++) {    var range = ranges[$art_ilejiufx$art_i]%>';
    for (var $art_ilejiufx$art_i = 0, $art_craodmngh$art_c = ranges.length; $art_ilejiufx$art_i < $art_craodmngh$art_c; $art_ilejiufx$art_i++) {
        var range = ranges[$art_ilejiufx$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilmdf$art_i = 0, $art_cphclt$art_c = boxZones.length; $art_ilmdf$art_i < $art_cphclt$art_c; $art_ilmdf$art_i++) {    var zone = boxZones[$art_ilmdf$art_i]%>';
    for (var $art_ilmdf$art_i = 0, $art_cphclt$art_c = boxZones.length; $art_ilmdf$art_i < $art_cphclt$art_c; $art_ilmdf$art_i++) {
        var zone = boxZones[$art_ilmdf$art_i];
