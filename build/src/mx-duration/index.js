...
module.exports = Magix.View.extend({
    ...
    if (hoverInfo.show) {
        ...
        $art = '=hoverInfo.left';
        ;
        $p += ($expr = '<%=hoverInfo.left%>', $e(hoverInfo.left)) + 'px;" class="_zs_gallery_mx-duration_index_-discount-hover"><div mxa="_zs_gallerya;:_" class="mb5">';
        $line = 6;
        $art = '=hoverInfo.week';
        ;
    ...
    if (settingInfo.show) {
        ...
        ;
        $p += ($expr = '<%=settingInfo.left%>', $e(settingInfo.left)) + 'px;" class="_zs_gallery_mx-duration_index_-discount-setting"><div mxv mxa="_zs_gallerya;:b" class="_zs_gallery_mx-duration_index_-setting-content"><div mxa="_zs_gallerya;:c" class="mb20"><span>';
        $line = 24;
        ...
        ;
        $p += '/>不投放</label></div></div><div mxs="_zs_gallerya;:a" class="_zs_gallery_mx-duration_index_-setting-footer"><a class="btn btn-brand mr10 w60" href="javascript:;" mx-click="' + $viewId + 'submitSetting()">确定</a><a class="btn w60" href="javascript:;" mx-click="' + $viewId + 'cancelSetting()">取消</a></div></div>';
        $line = 64;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    ;
    $expr = '<%for (var $art_ikzzdbkmo$art_i = 0, $art_csipdshnr$art_c = weeks.length; $art_ikzzdbkmo$art_i < $art_csipdshnr$art_c; $art_ikzzdbkmo$art_i++) {    var week = weeks[$art_ikzzdbkmo$art_i]%>';
    for (var $art_ikzzdbkmo$art_i = 0, $art_csipdshnr$art_c = weeks.length; $art_ikzzdbkmo$art_i < $art_csipdshnr$art_c; $art_ikzzdbkmo$art_i++) {
        var week = weeks[$art_ikzzdbkmo$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipvcgxtjkwxg$art_i = 0, $art_cevztyvbdfk$art_c = ranges.length; $art_ipvcgxtjkwxg$art_i < $art_cevztyvbdfk$art_c; $art_ipvcgxtjkwxg$art_i++) {    var range = ranges[$art_ipvcgxtjkwxg$art_i]%>';
    for (var $art_ipvcgxtjkwxg$art_i = 0, $art_cevztyvbdfk$art_c = ranges.length; $art_ipvcgxtjkwxg$art_i < $art_cevztyvbdfk$art_c; $art_ipvcgxtjkwxg$art_i++) {
        var range = ranges[$art_ipvcgxtjkwxg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipgyfhsdsj$art_i = 0, $art_cgekamvueq$art_c = boxZones.length; $art_ipgyfhsdsj$art_i < $art_cgekamvueq$art_c; $art_ipgyfhsdsj$art_i++) {    var zone = boxZones[$art_ipgyfhsdsj$art_i]%>';
    for (var $art_ipgyfhsdsj$art_i = 0, $art_cgekamvueq$art_c = boxZones.length; $art_ipgyfhsdsj$art_i < $art_cgekamvueq$art_c; $art_ipgyfhsdsj$art_i++) {
        var zone = boxZones[$art_ipgyfhsdsj$art_i];
