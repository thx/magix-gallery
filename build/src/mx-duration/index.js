...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imybkenrid$art_i = 0, $art_cshysone$art_c = weeks.length; $art_imybkenrid$art_i < $art_cshysone$art_c; $art_imybkenrid$art_i++) {    var week = weeks[$art_imybkenrid$art_i]%>';
    for (var $art_imybkenrid$art_i = 0, $art_cshysone$art_c = weeks.length; $art_imybkenrid$art_i < $art_cshysone$art_c; $art_imybkenrid$art_i++) {
        var week = weeks[$art_imybkenrid$art_i];
    ...
    ;
    $expr = '<%for (var $art_immwtmz$art_i = 0, $art_cnehrclc$art_c = ranges.length; $art_immwtmz$art_i < $art_cnehrclc$art_c; $art_immwtmz$art_i++) {    var range = ranges[$art_immwtmz$art_i]%>';
    for (var $art_immwtmz$art_i = 0, $art_cnehrclc$art_c = ranges.length; $art_immwtmz$art_i < $art_cnehrclc$art_c; $art_immwtmz$art_i++) {
        var range = ranges[$art_immwtmz$art_i];
    ...
    ;
    $expr = '<%for (var $art_icrrdxfwhre$art_i = 0, $art_clipbszgx$art_c = boxZones.length; $art_icrrdxfwhre$art_i < $art_clipbszgx$art_c; $art_icrrdxfwhre$art_i++) {    var zone = boxZones[$art_icrrdxfwhre$art_i]%>';
    for (var $art_icrrdxfwhre$art_i = 0, $art_clipbszgx$art_c = boxZones.length; $art_icrrdxfwhre$art_i < $art_clipbszgx$art_c; $art_icrrdxfwhre$art_i++) {
        var zone = boxZones[$art_icrrdxfwhre$art_i];
