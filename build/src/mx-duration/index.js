...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivwbrgwe$art_i = 0, $art_ckimcaom$art_c = weeks.length; $art_ivwbrgwe$art_i < $art_ckimcaom$art_c; $art_ivwbrgwe$art_i++) {    var week = weeks[$art_ivwbrgwe$art_i]%>';
    for (var $art_ivwbrgwe$art_i = 0, $art_ckimcaom$art_c = weeks.length; $art_ivwbrgwe$art_i < $art_ckimcaom$art_c; $art_ivwbrgwe$art_i++) {
        var week = weeks[$art_ivwbrgwe$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihrfbwcv$art_i = 0, $art_czhyxnmll$art_c = ranges.length; $art_ihrfbwcv$art_i < $art_czhyxnmll$art_c; $art_ihrfbwcv$art_i++) {    var range = ranges[$art_ihrfbwcv$art_i]%>';
    for (var $art_ihrfbwcv$art_i = 0, $art_czhyxnmll$art_c = ranges.length; $art_ihrfbwcv$art_i < $art_czhyxnmll$art_c; $art_ihrfbwcv$art_i++) {
        var range = ranges[$art_ihrfbwcv$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixcbvaztud$art_i = 0, $art_cckilhjc$art_c = boxZones.length; $art_ixcbvaztud$art_i < $art_cckilhjc$art_c; $art_ixcbvaztud$art_i++) {    var zone = boxZones[$art_ixcbvaztud$art_i]%>';
    for (var $art_ixcbvaztud$art_i = 0, $art_cckilhjc$art_c = boxZones.length; $art_ixcbvaztud$art_i < $art_cckilhjc$art_c; $art_ixcbvaztud$art_i++) {
        var zone = boxZones[$art_ixcbvaztud$art_i];
