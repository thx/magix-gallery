...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irryusqybf$art_i = 0, $art_ckwtcyjgnh$art_c = weeks.length; $art_irryusqybf$art_i < $art_ckwtcyjgnh$art_c; $art_irryusqybf$art_i++) {    var week = weeks[$art_irryusqybf$art_i]%>';
    for (var $art_irryusqybf$art_i = 0, $art_ckwtcyjgnh$art_c = weeks.length; $art_irryusqybf$art_i < $art_ckwtcyjgnh$art_c; $art_irryusqybf$art_i++) {
        var week = weeks[$art_irryusqybf$art_i];
    ...
    ;
    $expr = '<%for (var $art_izwfitj$art_i = 0, $art_cyohfhbfia$art_c = ranges.length; $art_izwfitj$art_i < $art_cyohfhbfia$art_c; $art_izwfitj$art_i++) {    var range = ranges[$art_izwfitj$art_i]%>';
    for (var $art_izwfitj$art_i = 0, $art_cyohfhbfia$art_c = ranges.length; $art_izwfitj$art_i < $art_cyohfhbfia$art_c; $art_izwfitj$art_i++) {
        var range = ranges[$art_izwfitj$art_i];
    ...
    ;
    $expr = '<%for (var $art_ipdubpmkr$art_i = 0, $art_chkikounbm$art_c = boxZones.length; $art_ipdubpmkr$art_i < $art_chkikounbm$art_c; $art_ipdubpmkr$art_i++) {    var zone = boxZones[$art_ipdubpmkr$art_i]%>';
    for (var $art_ipdubpmkr$art_i = 0, $art_chkikounbm$art_c = boxZones.length; $art_ipdubpmkr$art_i < $art_chkikounbm$art_c; $art_ipdubpmkr$art_i++) {
        var zone = boxZones[$art_ipdubpmkr$art_i];
