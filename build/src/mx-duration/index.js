...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivsashnjs$art_i = 0, $art_cojwfrjv$art_c = weeks.length; $art_ivsashnjs$art_i < $art_cojwfrjv$art_c; $art_ivsashnjs$art_i++) {    var week = weeks[$art_ivsashnjs$art_i]%>';
    for (var $art_ivsashnjs$art_i = 0, $art_cojwfrjv$art_c = weeks.length; $art_ivsashnjs$art_i < $art_cojwfrjv$art_c; $art_ivsashnjs$art_i++) {
        var week = weeks[$art_ivsashnjs$art_i];
    ...
    ;
    $expr = '<%for (var $art_iepwjbfk$art_i = 0, $art_cejkpgy$art_c = ranges.length; $art_iepwjbfk$art_i < $art_cejkpgy$art_c; $art_iepwjbfk$art_i++) {    var range = ranges[$art_iepwjbfk$art_i]%>';
    for (var $art_iepwjbfk$art_i = 0, $art_cejkpgy$art_c = ranges.length; $art_iepwjbfk$art_i < $art_cejkpgy$art_c; $art_iepwjbfk$art_i++) {
        var range = ranges[$art_iepwjbfk$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqrchucisr$art_i = 0, $art_cfkkyyl$art_c = boxZones.length; $art_iqrchucisr$art_i < $art_cfkkyyl$art_c; $art_iqrchucisr$art_i++) {    var zone = boxZones[$art_iqrchucisr$art_i]%>';
    for (var $art_iqrchucisr$art_i = 0, $art_cfkkyyl$art_c = boxZones.length; $art_iqrchucisr$art_i < $art_cfkkyyl$art_c; $art_iqrchucisr$art_i++) {
        var zone = boxZones[$art_iqrchucisr$art_i];
