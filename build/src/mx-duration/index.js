...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilbqwhwro$art_i = 0, $art_cwobkjzsm$art_c = weeks.length; $art_ilbqwhwro$art_i < $art_cwobkjzsm$art_c; $art_ilbqwhwro$art_i++) {    var week = weeks[$art_ilbqwhwro$art_i]%>';
    for (var $art_ilbqwhwro$art_i = 0, $art_cwobkjzsm$art_c = weeks.length; $art_ilbqwhwro$art_i < $art_cwobkjzsm$art_c; $art_ilbqwhwro$art_i++) {
        var week = weeks[$art_ilbqwhwro$art_i];
    ...
    ;
    $expr = '<%for (var $art_iutnibueel$art_i = 0, $art_cwyngyi$art_c = ranges.length; $art_iutnibueel$art_i < $art_cwyngyi$art_c; $art_iutnibueel$art_i++) {    var range = ranges[$art_iutnibueel$art_i]%>';
    for (var $art_iutnibueel$art_i = 0, $art_cwyngyi$art_c = ranges.length; $art_iutnibueel$art_i < $art_cwyngyi$art_c; $art_iutnibueel$art_i++) {
        var range = ranges[$art_iutnibueel$art_i];
    ...
    ;
    $expr = '<%for (var $art_irxnlj$art_i = 0, $art_coffplo$art_c = boxZones.length; $art_irxnlj$art_i < $art_coffplo$art_c; $art_irxnlj$art_i++) {    var zone = boxZones[$art_irxnlj$art_i]%>';
    for (var $art_irxnlj$art_i = 0, $art_coffplo$art_c = boxZones.length; $art_irxnlj$art_i < $art_coffplo$art_c; $art_irxnlj$art_i++) {
        var zone = boxZones[$art_irxnlj$art_i];
