...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiwwdszmi$art_i = 0, $art_centmlobg$art_c = weeks.length; $art_iiwwdszmi$art_i < $art_centmlobg$art_c; $art_iiwwdszmi$art_i++) {    var week = weeks[$art_iiwwdszmi$art_i]%>';
    for (var $art_iiwwdszmi$art_i = 0, $art_centmlobg$art_c = weeks.length; $art_iiwwdszmi$art_i < $art_centmlobg$art_c; $art_iiwwdszmi$art_i++) {
        var week = weeks[$art_iiwwdszmi$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikatbkmbd$art_i = 0, $art_cwytsybq$art_c = ranges.length; $art_ikatbkmbd$art_i < $art_cwytsybq$art_c; $art_ikatbkmbd$art_i++) {    var range = ranges[$art_ikatbkmbd$art_i]%>';
    for (var $art_ikatbkmbd$art_i = 0, $art_cwytsybq$art_c = ranges.length; $art_ikatbkmbd$art_i < $art_cwytsybq$art_c; $art_ikatbkmbd$art_i++) {
        var range = ranges[$art_ikatbkmbd$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivglftmhtdm$art_i = 0, $art_cxcttcrratv$art_c = boxZones.length; $art_ivglftmhtdm$art_i < $art_cxcttcrratv$art_c; $art_ivglftmhtdm$art_i++) {    var zone = boxZones[$art_ivglftmhtdm$art_i]%>';
    for (var $art_ivglftmhtdm$art_i = 0, $art_cxcttcrratv$art_c = boxZones.length; $art_ivglftmhtdm$art_i < $art_cxcttcrratv$art_c; $art_ivglftmhtdm$art_i++) {
        var zone = boxZones[$art_ivglftmhtdm$art_i];
