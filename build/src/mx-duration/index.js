...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iezijjwo$art_i = 0, $art_clfphtcsgj$art_c = weeks.length; $art_iezijjwo$art_i < $art_clfphtcsgj$art_c; $art_iezijjwo$art_i++) {    var week = weeks[$art_iezijjwo$art_i]%>';
    for (var $art_iezijjwo$art_i = 0, $art_clfphtcsgj$art_c = weeks.length; $art_iezijjwo$art_i < $art_clfphtcsgj$art_c; $art_iezijjwo$art_i++) {
        var week = weeks[$art_iezijjwo$art_i];
    ...
    ;
    $expr = '<%for (var $art_igsyjqgw$art_i = 0, $art_cqzicdqtfknp$art_c = ranges.length; $art_igsyjqgw$art_i < $art_cqzicdqtfknp$art_c; $art_igsyjqgw$art_i++) {    var range = ranges[$art_igsyjqgw$art_i]%>';
    for (var $art_igsyjqgw$art_i = 0, $art_cqzicdqtfknp$art_c = ranges.length; $art_igsyjqgw$art_i < $art_cqzicdqtfknp$art_c; $art_igsyjqgw$art_i++) {
        var range = ranges[$art_igsyjqgw$art_i];
    ...
    ;
    $expr = '<%for (var $art_ilwome$art_i = 0, $art_ckapxrsxuk$art_c = boxZones.length; $art_ilwome$art_i < $art_ckapxrsxuk$art_c; $art_ilwome$art_i++) {    var zone = boxZones[$art_ilwome$art_i]%>';
    for (var $art_ilwome$art_i = 0, $art_ckapxrsxuk$art_c = boxZones.length; $art_ilwome$art_i < $art_ckapxrsxuk$art_c; $art_ilwome$art_i++) {
        var zone = boxZones[$art_ilwome$art_i];
