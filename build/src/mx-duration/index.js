...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ieglfrhp$art_i = 0, $art_cgmnaunzctbd$art_c = weeks.length; $art_ieglfrhp$art_i < $art_cgmnaunzctbd$art_c; $art_ieglfrhp$art_i++) {    var week = weeks[$art_ieglfrhp$art_i]%>';
    for (var $art_ieglfrhp$art_i = 0, $art_cgmnaunzctbd$art_c = weeks.length; $art_ieglfrhp$art_i < $art_cgmnaunzctbd$art_c; $art_ieglfrhp$art_i++) {
        var week = weeks[$art_ieglfrhp$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuunwlmp$art_i = 0, $art_chppgicvb$art_c = ranges.length; $art_iuunwlmp$art_i < $art_chppgicvb$art_c; $art_iuunwlmp$art_i++) {    var range = ranges[$art_iuunwlmp$art_i]%>';
    for (var $art_iuunwlmp$art_i = 0, $art_chppgicvb$art_c = ranges.length; $art_iuunwlmp$art_i < $art_chppgicvb$art_c; $art_iuunwlmp$art_i++) {
        var range = ranges[$art_iuunwlmp$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivqbuzh$art_i = 0, $art_ccscorwlp$art_c = boxZones.length; $art_ivqbuzh$art_i < $art_ccscorwlp$art_c; $art_ivqbuzh$art_i++) {    var zone = boxZones[$art_ivqbuzh$art_i]%>';
    for (var $art_ivqbuzh$art_i = 0, $art_ccscorwlp$art_c = boxZones.length; $art_ivqbuzh$art_i < $art_ccscorwlp$art_c; $art_ivqbuzh$art_i++) {
        var zone = boxZones[$art_ivqbuzh$art_i];
