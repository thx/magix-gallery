...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ikmblwkezq$art_i=0;$art_ikmblwkezq$art_i<weeks.length;$art_ikmblwkezq$art_i++){var week=weeks[$art_ikmblwkezq$art_i]%>';
    for (var $art_ikmblwkezq$art_i = 0; $art_ikmblwkezq$art_i < weeks.length; $art_ikmblwkezq$art_i++) {
        var week = weeks[$art_ikmblwkezq$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iykltuu$art_i=0;$art_iykltuu$art_i<ranges.length;$art_iykltuu$art_i++){var range=ranges[$art_iykltuu$art_i]%>';
    for (var $art_iykltuu$art_i = 0; $art_iykltuu$art_i < ranges.length; $art_iykltuu$art_i++) {
        var range = ranges[$art_iykltuu$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iouvddjk$art_i=0;$art_iouvddjk$art_i<boxZones.length;$art_iouvddjk$art_i++){var zone=boxZones[$art_iouvddjk$art_i]%>';
    for (var $art_iouvddjk$art_i = 0; $art_iouvddjk$art_i < boxZones.length; $art_iouvddjk$art_i++) {
        var zone = boxZones[$art_iouvddjk$art_i];
