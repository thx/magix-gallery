...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuuqkcftf$art_i = 0, $art_ckwynebqw$art_c = weeks.length; $art_iuuqkcftf$art_i < $art_ckwynebqw$art_c; $art_iuuqkcftf$art_i++) {    var week = weeks[$art_iuuqkcftf$art_i]%>';
    for (var $art_iuuqkcftf$art_i = 0, $art_ckwynebqw$art_c = weeks.length; $art_iuuqkcftf$art_i < $art_ckwynebqw$art_c; $art_iuuqkcftf$art_i++) {
        var week = weeks[$art_iuuqkcftf$art_i];
    ...
    ;
    $expr = '<%for (var $art_icuerdrl$art_i = 0, $art_cxzxpbnhl$art_c = ranges.length; $art_icuerdrl$art_i < $art_cxzxpbnhl$art_c; $art_icuerdrl$art_i++) {    var range = ranges[$art_icuerdrl$art_i]%>';
    for (var $art_icuerdrl$art_i = 0, $art_cxzxpbnhl$art_c = ranges.length; $art_icuerdrl$art_i < $art_cxzxpbnhl$art_c; $art_icuerdrl$art_i++) {
        var range = ranges[$art_icuerdrl$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivoqgvplga$art_i = 0, $art_cagsvzns$art_c = boxZones.length; $art_ivoqgvplga$art_i < $art_cagsvzns$art_c; $art_ivoqgvplga$art_i++) {    var zone = boxZones[$art_ivoqgvplga$art_i]%>';
    for (var $art_ivoqgvplga$art_i = 0, $art_cagsvzns$art_c = boxZones.length; $art_ivoqgvplga$art_i < $art_cagsvzns$art_c; $art_ivoqgvplga$art_i++) {
        var zone = boxZones[$art_ivoqgvplga$art_i];
