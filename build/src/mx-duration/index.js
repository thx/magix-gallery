...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iizasezczm$art_i = 0, $art_ccngafjds$art_c = weeks.length; $art_iizasezczm$art_i < $art_ccngafjds$art_c; $art_iizasezczm$art_i++) {    var week = weeks[$art_iizasezczm$art_i]%>';
    for (var $art_iizasezczm$art_i = 0, $art_ccngafjds$art_c = weeks.length; $art_iizasezczm$art_i < $art_ccngafjds$art_c; $art_iizasezczm$art_i++) {
        var week = weeks[$art_iizasezczm$art_i];
    ...
    ;
    $expr = '<%for (var $art_iogufuro$art_i = 0, $art_cgpjnjbutds$art_c = ranges.length; $art_iogufuro$art_i < $art_cgpjnjbutds$art_c; $art_iogufuro$art_i++) {    var range = ranges[$art_iogufuro$art_i]%>';
    for (var $art_iogufuro$art_i = 0, $art_cgpjnjbutds$art_c = ranges.length; $art_iogufuro$art_i < $art_cgpjnjbutds$art_c; $art_iogufuro$art_i++) {
        var range = ranges[$art_iogufuro$art_i];
    ...
    ;
    $expr = '<%for (var $art_iodazrrbp$art_i = 0, $art_cyffogckc$art_c = boxZones.length; $art_iodazrrbp$art_i < $art_cyffogckc$art_c; $art_iodazrrbp$art_i++) {    var zone = boxZones[$art_iodazrrbp$art_i]%>';
    for (var $art_iodazrrbp$art_i = 0, $art_cyffogckc$art_c = boxZones.length; $art_iodazrrbp$art_i < $art_cyffogckc$art_c; $art_iodazrrbp$art_i++) {
        var zone = boxZones[$art_iodazrrbp$art_i];
