...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isvawxg$art_i = 0, $art_culxbgvaa$art_c = weeks.length; $art_isvawxg$art_i < $art_culxbgvaa$art_c; $art_isvawxg$art_i++) {    var week = weeks[$art_isvawxg$art_i]%>';
    for (var $art_isvawxg$art_i = 0, $art_culxbgvaa$art_c = weeks.length; $art_isvawxg$art_i < $art_culxbgvaa$art_c; $art_isvawxg$art_i++) {
        var week = weeks[$art_isvawxg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ioajbbtymwp$art_i = 0, $art_cokemygk$art_c = ranges.length; $art_ioajbbtymwp$art_i < $art_cokemygk$art_c; $art_ioajbbtymwp$art_i++) {    var range = ranges[$art_ioajbbtymwp$art_i]%>';
    for (var $art_ioajbbtymwp$art_i = 0, $art_cokemygk$art_c = ranges.length; $art_ioajbbtymwp$art_i < $art_cokemygk$art_c; $art_ioajbbtymwp$art_i++) {
        var range = ranges[$art_ioajbbtymwp$art_i];
    ...
    ;
    $expr = '<%for (var $art_iskzmkotmk$art_i = 0, $art_ciimtfhswuh$art_c = boxZones.length; $art_iskzmkotmk$art_i < $art_ciimtfhswuh$art_c; $art_iskzmkotmk$art_i++) {    var zone = boxZones[$art_iskzmkotmk$art_i]%>';
    for (var $art_iskzmkotmk$art_i = 0, $art_ciimtfhswuh$art_c = boxZones.length; $art_iskzmkotmk$art_i < $art_ciimtfhswuh$art_c; $art_iskzmkotmk$art_i++) {
        var zone = boxZones[$art_iskzmkotmk$art_i];
