...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioioglz$art_i = 0, $art_csldqhzuzd$art_c = weeks.length; $art_ioioglz$art_i < $art_csldqhzuzd$art_c; $art_ioioglz$art_i++) {    var week = weeks[$art_ioioglz$art_i]%>';
    for (var $art_ioioglz$art_i = 0, $art_csldqhzuzd$art_c = weeks.length; $art_ioioglz$art_i < $art_csldqhzuzd$art_c; $art_ioioglz$art_i++) {
        var week = weeks[$art_ioioglz$art_i];
    ...
    ;
    $expr = '<%for (var $art_izyxjc$art_i = 0, $art_cbtmqhddlck$art_c = ranges.length; $art_izyxjc$art_i < $art_cbtmqhddlck$art_c; $art_izyxjc$art_i++) {    var range = ranges[$art_izyxjc$art_i]%>';
    for (var $art_izyxjc$art_i = 0, $art_cbtmqhddlck$art_c = ranges.length; $art_izyxjc$art_i < $art_cbtmqhddlck$art_c; $art_izyxjc$art_i++) {
        var range = ranges[$art_izyxjc$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibhifhta$art_i = 0, $art_cmaeigp$art_c = boxZones.length; $art_ibhifhta$art_i < $art_cmaeigp$art_c; $art_ibhifhta$art_i++) {    var zone = boxZones[$art_ibhifhta$art_i]%>';
    for (var $art_ibhifhta$art_i = 0, $art_cmaeigp$art_c = boxZones.length; $art_ibhifhta$art_i < $art_cmaeigp$art_c; $art_ibhifhta$art_i++) {
        var zone = boxZones[$art_ibhifhta$art_i];
