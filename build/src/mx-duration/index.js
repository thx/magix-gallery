...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyilggjrg$art_i = 0, $art_cavkzcgagf$art_c = weeks.length; $art_iyilggjrg$art_i < $art_cavkzcgagf$art_c; $art_iyilggjrg$art_i++) {    var week = weeks[$art_iyilggjrg$art_i]%>';
    for (var $art_iyilggjrg$art_i = 0, $art_cavkzcgagf$art_c = weeks.length; $art_iyilggjrg$art_i < $art_cavkzcgagf$art_c; $art_iyilggjrg$art_i++) {
        var week = weeks[$art_iyilggjrg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibrxcznpduv$art_i = 0, $art_cvftgdwbwq$art_c = ranges.length; $art_ibrxcznpduv$art_i < $art_cvftgdwbwq$art_c; $art_ibrxcznpduv$art_i++) {    var range = ranges[$art_ibrxcznpduv$art_i]%>';
    for (var $art_ibrxcznpduv$art_i = 0, $art_cvftgdwbwq$art_c = ranges.length; $art_ibrxcznpduv$art_i < $art_cvftgdwbwq$art_c; $art_ibrxcznpduv$art_i++) {
        var range = ranges[$art_ibrxcznpduv$art_i];
    ...
    ;
    $expr = '<%for (var $art_isnciqidv$art_i = 0, $art_czvluna$art_c = boxZones.length; $art_isnciqidv$art_i < $art_czvluna$art_c; $art_isnciqidv$art_i++) {    var zone = boxZones[$art_isnciqidv$art_i]%>';
    for (var $art_isnciqidv$art_i = 0, $art_czvluna$art_c = boxZones.length; $art_isnciqidv$art_i < $art_czvluna$art_c; $art_isnciqidv$art_i++) {
        var zone = boxZones[$art_isnciqidv$art_i];
