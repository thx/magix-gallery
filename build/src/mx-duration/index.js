...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igdlfurmom$art_i = 0, $art_cpnrzttah$art_c = weeks.length; $art_igdlfurmom$art_i < $art_cpnrzttah$art_c; $art_igdlfurmom$art_i++) {    var week = weeks[$art_igdlfurmom$art_i]%>';
    for (var $art_igdlfurmom$art_i = 0, $art_cpnrzttah$art_c = weeks.length; $art_igdlfurmom$art_i < $art_cpnrzttah$art_c; $art_igdlfurmom$art_i++) {
        var week = weeks[$art_igdlfurmom$art_i];
    ...
    ;
    $expr = '<%for (var $art_incppzpvli$art_i = 0, $art_cnyabyxmxpq$art_c = ranges.length; $art_incppzpvli$art_i < $art_cnyabyxmxpq$art_c; $art_incppzpvli$art_i++) {    var range = ranges[$art_incppzpvli$art_i]%>';
    for (var $art_incppzpvli$art_i = 0, $art_cnyabyxmxpq$art_c = ranges.length; $art_incppzpvli$art_i < $art_cnyabyxmxpq$art_c; $art_incppzpvli$art_i++) {
        var range = ranges[$art_incppzpvli$art_i];
    ...
    ;
    $expr = '<%for (var $art_inyavuuht$art_i = 0, $art_cpnluktg$art_c = boxZones.length; $art_inyavuuht$art_i < $art_cpnluktg$art_c; $art_inyavuuht$art_i++) {    var zone = boxZones[$art_inyavuuht$art_i]%>';
    for (var $art_inyavuuht$art_i = 0, $art_cpnluktg$art_c = boxZones.length; $art_inyavuuht$art_i < $art_cpnluktg$art_c; $art_inyavuuht$art_i++) {
        var zone = boxZones[$art_inyavuuht$art_i];
