...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igggedlqs$art_i = 0, $art_cziznpmz$art_c = weeks.length; $art_igggedlqs$art_i < $art_cziznpmz$art_c; $art_igggedlqs$art_i++) {    var week = weeks[$art_igggedlqs$art_i]%>';
    for (var $art_igggedlqs$art_i = 0, $art_cziznpmz$art_c = weeks.length; $art_igggedlqs$art_i < $art_cziznpmz$art_c; $art_igggedlqs$art_i++) {
        var week = weeks[$art_igggedlqs$art_i];
    ...
    ;
    $expr = '<%for (var $art_ikbcavtrbh$art_i = 0, $art_cbvlktel$art_c = ranges.length; $art_ikbcavtrbh$art_i < $art_cbvlktel$art_c; $art_ikbcavtrbh$art_i++) {    var range = ranges[$art_ikbcavtrbh$art_i]%>';
    for (var $art_ikbcavtrbh$art_i = 0, $art_cbvlktel$art_c = ranges.length; $art_ikbcavtrbh$art_i < $art_cbvlktel$art_c; $art_ikbcavtrbh$art_i++) {
        var range = ranges[$art_ikbcavtrbh$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqdpnmvngca$art_i = 0, $art_cwtywuai$art_c = boxZones.length; $art_iqdpnmvngca$art_i < $art_cwtywuai$art_c; $art_iqdpnmvngca$art_i++) {    var zone = boxZones[$art_iqdpnmvngca$art_i]%>';
    for (var $art_iqdpnmvngca$art_i = 0, $art_cwtywuai$art_c = boxZones.length; $art_iqdpnmvngca$art_i < $art_cwtywuai$art_c; $art_iqdpnmvngca$art_i++) {
        var zone = boxZones[$art_iqdpnmvngca$art_i];
