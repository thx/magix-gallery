...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivkswladzdc$art_i = 0, $art_cmwljjnnfp$art_c = items.length; $art_ivkswladzdc$art_i < $art_cmwljjnnfp$art_c; $art_ivkswladzdc$art_i++) {    var item = items[$art_ivkswladzdc$art_i]%>';
    for (var $art_ivkswladzdc$art_i = 0, $art_cmwljjnnfp$art_c = items.length; $art_ivkswladzdc$art_i < $art_cmwljjnnfp$art_c; $art_ivkswladzdc$art_i++) {
        var item = items[$art_ivkswladzdc$art_i];
    ...
    $art = 'each items as item';
    ;
    $expr = '<%for (var $art_iqpbzcuvm$art_i = 0, $art_cgmrnjuu$art_c = items.length; $art_iqpbzcuvm$art_i < $art_cgmrnjuu$art_c; $art_iqpbzcuvm$art_i++) {    var item = items[$art_iqpbzcuvm$art_i]%>';
    for (var $art_iqpbzcuvm$art_i = 0, $art_cgmrnjuu$art_c = items.length; $art_iqpbzcuvm$art_i < $art_cgmrnjuu$art_c; $art_iqpbzcuvm$art_i++) {
        var item = items[$art_iqpbzcuvm$art_i];
        $p += '<div>';
        $line = 15;
        $art = '=item';
        ;
