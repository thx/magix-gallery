...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuvfpfau$art_i = 0, $art_cnmkqxtqhf$art_c = items.length; $art_iuvfpfau$art_i < $art_cnmkqxtqhf$art_c; $art_iuvfpfau$art_i++) {    var item = items[$art_iuvfpfau$art_i]%>';
    for (var $art_iuvfpfau$art_i = 0, $art_cnmkqxtqhf$art_c = items.length; $art_iuvfpfau$art_i < $art_cnmkqxtqhf$art_c; $art_iuvfpfau$art_i++) {
        var item = items[$art_iuvfpfau$art_i];
    ...
    $art = 'each items as item';
    ;
    $expr = '<%for (var $art_ixmwaltyghj$art_i = 0, $art_cvkxemggo$art_c = items.length; $art_ixmwaltyghj$art_i < $art_cvkxemggo$art_c; $art_ixmwaltyghj$art_i++) {    var item = items[$art_ixmwaltyghj$art_i]%>';
    for (var $art_ixmwaltyghj$art_i = 0, $art_cvkxemggo$art_c = items.length; $art_ixmwaltyghj$art_i < $art_cvkxemggo$art_c; $art_ixmwaltyghj$art_i++) {
        var item = items[$art_ixmwaltyghj$art_i];
        $p += '<div>';
        $line = 15;
        $art = '=item';
        ;
