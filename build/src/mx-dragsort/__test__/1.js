...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ingahecw$art_i = 0, $art_cctpqanmp$art_c = items.length; $art_ingahecw$art_i < $art_cctpqanmp$art_c; $art_ingahecw$art_i++) {    var item = items[$art_ingahecw$art_i]%>';
    for (var $art_ingahecw$art_i = 0, $art_cctpqanmp$art_c = items.length; $art_ingahecw$art_i < $art_cctpqanmp$art_c; $art_ingahecw$art_i++) {
        var item = items[$art_ingahecw$art_i];
    ...
    $art = 'each items as item';
    ;
    $expr = '<%for (var $art_ikoivffgps$art_i = 0, $art_ckxipntd$art_c = items.length; $art_ikoivffgps$art_i < $art_ckxipntd$art_c; $art_ikoivffgps$art_i++) {    var item = items[$art_ikoivffgps$art_i]%>';
    for (var $art_ikoivffgps$art_i = 0, $art_ckxipntd$art_c = items.length; $art_ikoivffgps$art_i < $art_ckxipntd$art_c; $art_ikoivffgps$art_i++) {
        var item = items[$art_ikoivffgps$art_i];
        $p += '<div>';
        $line = 15;
        $art = '=item';
        ;
