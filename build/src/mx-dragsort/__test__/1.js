...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ighuedryted$art_i = 0, $art_csmvf$art_c = items.length; $art_ighuedryted$art_i < $art_csmvf$art_c; $art_ighuedryted$art_i++) {    var item = items[$art_ighuedryted$art_i]%>';
    for (var $art_ighuedryted$art_i = 0, $art_csmvf$art_c = items.length; $art_ighuedryted$art_i < $art_csmvf$art_c; $art_ighuedryted$art_i++) {
        var item = items[$art_ighuedryted$art_i];
    ...
    $art = 'each items as item';
    ;
    $expr = '<%for (var $art_iqhzxvn$art_i = 0, $art_ckvgqyqerjd$art_c = items.length; $art_iqhzxvn$art_i < $art_ckvgqyqerjd$art_c; $art_iqhzxvn$art_i++) {    var item = items[$art_iqhzxvn$art_i]%>';
    for (var $art_iqhzxvn$art_i = 0, $art_ckvgqyqerjd$art_c = items.length; $art_iqhzxvn$art_i < $art_ckvgqyqerjd$art_c; $art_iqhzxvn$art_i++) {
        var item = items[$art_iqhzxvn$art_i];
        $p += '<div>';
        $line = 15;
        $art = '=item';
        ;
