...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inwqpyryjas$art_i = 0, $art_cpxduovfpfpp$art_c = items.length; $art_inwqpyryjas$art_i < $art_cpxduovfpfpp$art_c; $art_inwqpyryjas$art_i++) {    var item = items[$art_inwqpyryjas$art_i]%>';
    for (var $art_inwqpyryjas$art_i = 0, $art_cpxduovfpfpp$art_c = items.length; $art_inwqpyryjas$art_i < $art_cpxduovfpfpp$art_c; $art_inwqpyryjas$art_i++) {
        var item = items[$art_inwqpyryjas$art_i];
    ...
    $art = 'each items as item';
    ;
    $expr = '<%for (var $art_ixxsynvluv$art_i = 0, $art_cjzwclpnm$art_c = items.length; $art_ixxsynvluv$art_i < $art_cjzwclpnm$art_c; $art_ixxsynvluv$art_i++) {    var item = items[$art_ixxsynvluv$art_i]%>';
    for (var $art_ixxsynvluv$art_i = 0, $art_cjzwclpnm$art_c = items.length; $art_ixxsynvluv$art_i < $art_cjzwclpnm$art_c; $art_ixxsynvluv$art_i++) {
        var item = items[$art_ixxsynvluv$art_i];
        $p += '<div>';
        $line = 15;
        $art = '=item';
        ;
