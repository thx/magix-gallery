...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwssjyvb$art_i = 0, $art_crehsdwrz$art_c = items.length; $art_iwssjyvb$art_i < $art_crehsdwrz$art_c; $art_iwssjyvb$art_i++) {    var item = items[$art_iwssjyvb$art_i]%>';
    for (var $art_iwssjyvb$art_i = 0, $art_crehsdwrz$art_c = items.length; $art_iwssjyvb$art_i < $art_crehsdwrz$art_c; $art_iwssjyvb$art_i++) {
        var item = items[$art_iwssjyvb$art_i];
    ...
    $art = 'each items as item';
    ;
    $expr = '<%for (var $art_ibdwfvniui$art_i = 0, $art_cslgnqx$art_c = items.length; $art_ibdwfvniui$art_i < $art_cslgnqx$art_c; $art_ibdwfvniui$art_i++) {    var item = items[$art_ibdwfvniui$art_i]%>';
    for (var $art_ibdwfvniui$art_i = 0, $art_cslgnqx$art_c = items.length; $art_ibdwfvniui$art_i < $art_cslgnqx$art_c; $art_ibdwfvniui$art_i++) {
        var item = items[$art_ibdwfvniui$art_i];
        $p += '<div>';
        $line = 15;
        $art = '=item';
        ;
