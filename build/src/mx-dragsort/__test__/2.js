...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipvacfdk$art_i = 0, $art_cisukdvrinn$art_c = items.length; $art_ipvacfdk$art_i < $art_cisukdvrinn$art_c; $art_ipvacfdk$art_i++) {    var item = items[$art_ipvacfdk$art_i]%>';
    for (var $art_ipvacfdk$art_i = 0, $art_cisukdvrinn$art_c = items.length; $art_ipvacfdk$art_i < $art_cisukdvrinn$art_c; $art_ipvacfdk$art_i++) {
        var item = items[$art_ipvacfdk$art_i];
