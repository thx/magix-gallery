...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imhppqixl$art_i = 0, $art_coqogaa$art_c = items.length; $art_imhppqixl$art_i < $art_coqogaa$art_c; $art_imhppqixl$art_i++) {    var item = items[$art_imhppqixl$art_i]%>';
    for (var $art_imhppqixl$art_i = 0, $art_coqogaa$art_c = items.length; $art_imhppqixl$art_i < $art_coqogaa$art_c; $art_imhppqixl$art_i++) {
        var item = items[$art_imhppqixl$art_i];
