...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaM:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaM:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaM:_" class="mb20"><span class="color-9">以下示例：</span>支持水平方向的排序</div><div mxa="_zs_galleryaM:b" class="clearfix"><div mxa="_zs_galleryaM:c" class="mb20"><span mxs="_zs_galleryaM:a" class="color-9 mr10">当前顺序：</span>';
    $line = 6;
    $art = '=items';
    ;
    $p += ($expr = '<%=items%>', $e(items)) + '</div><ul mxa="_zs_galleryaM:d" class="clearfix" mx-view="mx-dragsort/index?horizonal=true&vertical=false" mx-dragfinish="' + $viewId + 'drag()">';
    $line = 13;
    $art = 'each items as item';
    ;
    $expr = '<%for (var $art_iwaqmcdfwf$art_i = 0, $art_cslfzti$art_c = items.length; $art_iwaqmcdfwf$art_i < $art_cslfzti$art_c; $art_iwaqmcdfwf$art_i++) {    var item = items[$art_iwaqmcdfwf$art_i]%>';
    for (var $art_iwaqmcdfwf$art_i = 0, $art_cslfzti$art_c = items.length; $art_iwaqmcdfwf$art_i < $art_cslfzti$art_c; $art_iwaqmcdfwf$art_i++) {
        var item = items[$art_iwaqmcdfwf$art_i];
    ...
    ;
    $p += '</ul></div></div><div mxa="_zs_galleryaM:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaM:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 21;
    $art = '=viewId';
    ;
