...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_islqgcmce$art_i = 0, $art_cjvkegxtyh$art_c = items.length; $art_islqgcmce$art_i < $art_cjvkegxtyh$art_c; $art_islqgcmce$art_i++) {    var item = items[$art_islqgcmce$art_i]%>';
    for (var $art_islqgcmce$art_i = 0, $art_cjvkegxtyh$art_c = items.length; $art_islqgcmce$art_i < $art_cjvkegxtyh$art_c; $art_islqgcmce$art_i++) {
        var item = items[$art_islqgcmce$art_i];
