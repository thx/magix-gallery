...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iecklqapkf$art_i = 0, $art_clhxyqxdpcz$art_c = items.length; $art_iecklqapkf$art_i < $art_clhxyqxdpcz$art_c; $art_iecklqapkf$art_i++) {    var item = items[$art_iecklqapkf$art_i]%>';
    for (var $art_iecklqapkf$art_i = 0, $art_clhxyqxdpcz$art_c = items.length; $art_iecklqapkf$art_i < $art_clhxyqxdpcz$art_c; $art_iecklqapkf$art_i++) {
        var item = items[$art_iecklqapkf$art_i];
