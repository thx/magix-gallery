...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuohzsz$art_i = 0, $art_cgtrioxkg$art_c = items.length; $art_iuohzsz$art_i < $art_cgtrioxkg$art_c; $art_iuohzsz$art_i++) {    var item = items[$art_iuohzsz$art_i]%>';
    for (var $art_iuohzsz$art_i = 0, $art_cgtrioxkg$art_c = items.length; $art_iuohzsz$art_i < $art_cgtrioxkg$art_c; $art_iuohzsz$art_i++) {
        var item = items[$art_iuohzsz$art_i];
