...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ityxsnx$art_i = 0, $art_czcdsrnfqd$art_c = items.length; $art_ityxsnx$art_i < $art_czcdsrnfqd$art_c; $art_ityxsnx$art_i++) {    var item = items[$art_ityxsnx$art_i]%>';
    for (var $art_ityxsnx$art_i = 0, $art_czcdsrnfqd$art_c = items.length; $art_ityxsnx$art_i < $art_czcdsrnfqd$art_c; $art_ityxsnx$art_i++) {
        var item = items[$art_ityxsnx$art_i];
