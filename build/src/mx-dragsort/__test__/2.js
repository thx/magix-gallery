...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikabofrkpli$art_i = 0, $art_cawhennc$art_c = items.length; $art_ikabofrkpli$art_i < $art_cawhennc$art_c; $art_ikabofrkpli$art_i++) {    var item = items[$art_ikabofrkpli$art_i]%>';
    for (var $art_ikabofrkpli$art_i = 0, $art_cawhennc$art_c = items.length; $art_ikabofrkpli$art_i < $art_cawhennc$art_c; $art_ikabofrkpli$art_i++) {
        var item = items[$art_ikabofrkpli$art_i];
