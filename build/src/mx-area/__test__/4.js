...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuqrnl$art_i = 0, $art_cotrpdtm$art_c = arrs.length; $art_iuqrnl$art_i < $art_cotrpdtm$art_c; $art_iuqrnl$art_i++) {    var item = arrs[$art_iuqrnl$art_i]%>';
    for (var $art_iuqrnl$art_i = 0, $art_cotrpdtm$art_c = arrs.length; $art_iuqrnl$art_i < $art_cotrpdtm$art_c; $art_iuqrnl$art_i++) {
        var item = arrs[$art_iuqrnl$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
