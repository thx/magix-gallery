...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imjtycjeh$art_i = 0, $art_crqfmoxsxf$art_c = arrs.length; $art_imjtycjeh$art_i < $art_crqfmoxsxf$art_c; $art_imjtycjeh$art_i++) {    var item = arrs[$art_imjtycjeh$art_i]%>';
    for (var $art_imjtycjeh$art_i = 0, $art_crqfmoxsxf$art_c = arrs.length; $art_imjtycjeh$art_i < $art_crqfmoxsxf$art_c; $art_imjtycjeh$art_i++) {
        var item = arrs[$art_imjtycjeh$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
