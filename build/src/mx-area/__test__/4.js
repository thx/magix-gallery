...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihazwhxxr$art_i = 0, $art_cimcbydht$art_c = arrs.length; $art_ihazwhxxr$art_i < $art_cimcbydht$art_c; $art_ihazwhxxr$art_i++) {    var item = arrs[$art_ihazwhxxr$art_i]%>';
    for (var $art_ihazwhxxr$art_i = 0, $art_cimcbydht$art_c = arrs.length; $art_ihazwhxxr$art_i < $art_cimcbydht$art_c; $art_ihazwhxxr$art_i++) {
        var item = arrs[$art_ihazwhxxr$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
