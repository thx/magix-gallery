...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idwlvbtez$art_i = 0, $art_cmcnwktac$art_c = arrs.length; $art_idwlvbtez$art_i < $art_cmcnwktac$art_c; $art_idwlvbtez$art_i++) {    var item = arrs[$art_idwlvbtez$art_i]%>';
    for (var $art_idwlvbtez$art_i = 0, $art_cmcnwktac$art_c = arrs.length; $art_idwlvbtez$art_i < $art_cmcnwktac$art_c; $art_idwlvbtez$art_i++) {
        var item = arrs[$art_idwlvbtez$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
