...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihvfknvg$art_i = 0, $art_cbvyuwwk$art_c = arrs.length; $art_ihvfknvg$art_i < $art_cbvyuwwk$art_c; $art_ihvfknvg$art_i++) {    var item = arrs[$art_ihvfknvg$art_i]%>';
    for (var $art_ihvfknvg$art_i = 0, $art_cbvyuwwk$art_c = arrs.length; $art_ihvfknvg$art_i < $art_cbvyuwwk$art_c; $art_ihvfknvg$art_i++) {
        var item = arrs[$art_ihvfknvg$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
