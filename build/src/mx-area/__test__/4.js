...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_izvgtynxr$art_i=0;$art_izvgtynxr$art_i<arrs.length;$art_izvgtynxr$art_i++){var item=arrs[$art_izvgtynxr$art_i]%>';
    for (var $art_izvgtynxr$art_i = 0; $art_izvgtynxr$art_i < arrs.length; $art_izvgtynxr$art_i++) {
        var item = arrs[$art_izvgtynxr$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
    ...
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_galleryG:g" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryG:c" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryG:h" class="_zs_gallery___test___base_-desc-tip">';
    $line = 38;
    $art = '!text1';
    ;
