...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iffexmrcv$art_i = 0, $art_ctvkfmegk$art_c = arrs.length; $art_iffexmrcv$art_i < $art_ctvkfmegk$art_c; $art_iffexmrcv$art_i++) {    var item = arrs[$art_iffexmrcv$art_i]%>';
    for (var $art_iffexmrcv$art_i = 0, $art_ctvkfmegk$art_c = arrs.length; $art_iffexmrcv$art_i < $art_ctvkfmegk$art_c; $art_iffexmrcv$art_i++) {
        var item = arrs[$art_iffexmrcv$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
