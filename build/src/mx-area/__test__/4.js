...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itnoxqde$art_i = 0, $art_cvafsjow$art_c = arrs.length; $art_itnoxqde$art_i < $art_cvafsjow$art_c; $art_itnoxqde$art_i++) {    var item = arrs[$art_itnoxqde$art_i]%>';
    for (var $art_itnoxqde$art_i = 0, $art_cvafsjow$art_c = arrs.length; $art_itnoxqde$art_i < $art_cvafsjow$art_c; $art_itnoxqde$art_i++) {
        var item = arrs[$art_itnoxqde$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
