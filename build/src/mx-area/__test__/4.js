...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibpgadvb$art_i = 0, $art_crvvozqmg$art_c = arrs.length; $art_ibpgadvb$art_i < $art_crvvozqmg$art_c; $art_ibpgadvb$art_i++) {    var item = arrs[$art_ibpgadvb$art_i]%>';
    for (var $art_ibpgadvb$art_i = 0, $art_crvvozqmg$art_c = arrs.length; $art_ibpgadvb$art_i < $art_crvvozqmg$art_c; $art_ibpgadvb$art_i++) {
        var item = arrs[$art_ibpgadvb$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
