...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyholwjqa$art_i = 0, $art_cnebllfyfe$art_c = arrs.length; $art_iyholwjqa$art_i < $art_cnebllfyfe$art_c; $art_iyholwjqa$art_i++) {    var item = arrs[$art_iyholwjqa$art_i]%>';
    for (var $art_iyholwjqa$art_i = 0, $art_cnebllfyfe$art_c = arrs.length; $art_iyholwjqa$art_i < $art_cnebllfyfe$art_c; $art_iyholwjqa$art_i++) {
        var item = arrs[$art_iyholwjqa$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
