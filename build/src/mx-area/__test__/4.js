...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihqgskfqynv$art_i = 0, $art_cjudxmxuqu$art_c = arrs.length; $art_ihqgskfqynv$art_i < $art_cjudxmxuqu$art_c; $art_ihqgskfqynv$art_i++) {    var item = arrs[$art_ihqgskfqynv$art_i]%>';
    for (var $art_ihqgskfqynv$art_i = 0, $art_cjudxmxuqu$art_c = arrs.length; $art_ihqgskfqynv$art_i < $art_cjudxmxuqu$art_c; $art_ihqgskfqynv$art_i++) {
        var item = arrs[$art_ihqgskfqynv$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
    ...
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_galleryS:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryS:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryS:h" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 38;
    $art = '!text1';
    ;
