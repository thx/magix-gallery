...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivlxsvzt$art_i = 0, $art_cvozdbg$art_c = arrs.length; $art_ivlxsvzt$art_i < $art_cvozdbg$art_c; $art_ivlxsvzt$art_i++) {    var item = arrs[$art_ivlxsvzt$art_i]%>';
    for (var $art_ivlxsvzt$art_i = 0, $art_cvozdbg$art_c = arrs.length; $art_ivlxsvzt$art_i < $art_cvozdbg$art_c; $art_ivlxsvzt$art_i++) {
        var item = arrs[$art_ivlxsvzt$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
