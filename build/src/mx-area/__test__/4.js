...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iorrysug$art_i = 0, $art_cobem$art_c = arrs.length; $art_iorrysug$art_i < $art_cobem$art_c; $art_iorrysug$art_i++) {    var item = arrs[$art_iorrysug$art_i]%>';
    for (var $art_iorrysug$art_i = 0, $art_cobem$art_c = arrs.length; $art_iorrysug$art_i < $art_cobem$art_c; $art_iorrysug$art_i++) {
        var item = arrs[$art_iorrysug$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
