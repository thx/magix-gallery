...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilocxcvwy$art_i = 0, $art_cttogcum$art_c = arrs.length; $art_ilocxcvwy$art_i < $art_cttogcum$art_c; $art_ilocxcvwy$art_i++) {    var item = arrs[$art_ilocxcvwy$art_i]%>';
    for (var $art_ilocxcvwy$art_i = 0, $art_cttogcum$art_c = arrs.length; $art_ilocxcvwy$art_i < $art_cttogcum$art_c; $art_ilocxcvwy$art_i++) {
        var item = arrs[$art_ilocxcvwy$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
