...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_izmjremjdf$art_i = 0, $art_clqipdx$art_c = arrs.length; $art_izmjremjdf$art_i < $art_clqipdx$art_c; $art_izmjremjdf$art_i++) {    var item = arrs[$art_izmjremjdf$art_i]%>';
    for (var $art_izmjremjdf$art_i = 0, $art_clqipdx$art_c = arrs.length; $art_izmjremjdf$art_i < $art_clqipdx$art_c; $art_izmjremjdf$art_i++) {
        var item = arrs[$art_izmjremjdf$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
    ...
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_galleryP:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryP:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
