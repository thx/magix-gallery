...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixwaemxh$art_i = 0, $art_crlpvfzf$art_c = arrs.length; $art_ixwaemxh$art_i < $art_crlpvfzf$art_c; $art_ixwaemxh$art_i++) {    var item = arrs[$art_ixwaemxh$art_i]%>';
    for (var $art_ixwaemxh$art_i = 0, $art_crlpvfzf$art_c = arrs.length; $art_ixwaemxh$art_i < $art_crlpvfzf$art_c; $art_ixwaemxh$art_i++) {
        var item = arrs[$art_ixwaemxh$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
