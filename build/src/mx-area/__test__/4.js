...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibzluk$art_i = 0, $art_cqgmug$art_c = arrs.length; $art_ibzluk$art_i < $art_cqgmug$art_c; $art_ibzluk$art_i++) {    var item = arrs[$art_ibzluk$art_i]%>';
    for (var $art_ibzluk$art_i = 0, $art_cqgmug$art_c = arrs.length; $art_ibzluk$art_i < $art_cqgmug$art_c; $art_ibzluk$art_i++) {
        var item = arrs[$art_ibzluk$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
