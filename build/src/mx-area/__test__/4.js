...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixbujofxkij$art_i = 0, $art_cconrgmwc$art_c = arrs.length; $art_ixbujofxkij$art_i < $art_cconrgmwc$art_c; $art_ixbujofxkij$art_i++) {    var item = arrs[$art_ixbujofxkij$art_i]%>';
    for (var $art_ixbujofxkij$art_i = 0, $art_cconrgmwc$art_c = arrs.length; $art_ixbujofxkij$art_i < $art_cconrgmwc$art_c; $art_ixbujofxkij$art_i++) {
        var item = arrs[$art_ixbujofxkij$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
