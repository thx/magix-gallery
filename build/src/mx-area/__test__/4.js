...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icqwxtvt$art_i = 0, $art_cqyudkbc$art_c = arrs.length; $art_icqwxtvt$art_i < $art_cqyudkbc$art_c; $art_icqwxtvt$art_i++) {    var item = arrs[$art_icqwxtvt$art_i]%>';
    for (var $art_icqwxtvt$art_i = 0, $art_cqyudkbc$art_c = arrs.length; $art_icqwxtvt$art_i < $art_cqyudkbc$art_c; $art_icqwxtvt$art_i++) {
        var item = arrs[$art_icqwxtvt$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
