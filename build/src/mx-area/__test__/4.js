...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwvkscjysf$art_i = 0, $art_cauvwbmzg$art_c = arrs.length; $art_iwvkscjysf$art_i < $art_cauvwbmzg$art_c; $art_iwvkscjysf$art_i++) {    var item = arrs[$art_iwvkscjysf$art_i]%>';
    for (var $art_iwvkscjysf$art_i = 0, $art_cauvwbmzg$art_c = arrs.length; $art_iwvkscjysf$art_i < $art_cauvwbmzg$art_c; $art_iwvkscjysf$art_i++) {
        var item = arrs[$art_iwvkscjysf$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
