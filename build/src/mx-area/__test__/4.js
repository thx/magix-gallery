...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idxdqtlmg$art_i = 0, $art_cuqabhr$art_c = arrs.length; $art_idxdqtlmg$art_i < $art_cuqabhr$art_c; $art_idxdqtlmg$art_i++) {    var item = arrs[$art_idxdqtlmg$art_i]%>';
    for (var $art_idxdqtlmg$art_i = 0, $art_cuqabhr$art_c = arrs.length; $art_idxdqtlmg$art_i < $art_cuqabhr$art_c; $art_idxdqtlmg$art_i++) {
        var item = arrs[$art_idxdqtlmg$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
