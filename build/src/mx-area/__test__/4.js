...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izpnzsr$art_i = 0, $art_czouwntokf$art_c = arrs.length; $art_izpnzsr$art_i < $art_czouwntokf$art_c; $art_izpnzsr$art_i++) {    var item = arrs[$art_izpnzsr$art_i]%>';
    for (var $art_izpnzsr$art_i = 0, $art_czouwntokf$art_c = arrs.length; $art_izpnzsr$art_i < $art_czouwntokf$art_c; $art_izpnzsr$art_i++) {
        var item = arrs[$art_izpnzsr$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
