...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iiztcwce$art_i = 0, $art_cyodmfqjeoa$art_c = arrs.length; $art_iiztcwce$art_i < $art_cyodmfqjeoa$art_c; $art_iiztcwce$art_i++) {    var item = arrs[$art_iiztcwce$art_i]%>';
    for (var $art_iiztcwce$art_i = 0, $art_cyodmfqjeoa$art_c = arrs.length; $art_iiztcwce$art_i < $art_cyodmfqjeoa$art_c; $art_iiztcwce$art_i++) {
        var item = arrs[$art_iiztcwce$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
