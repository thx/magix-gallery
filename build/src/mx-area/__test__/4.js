...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyeckfpq$art_i = 0, $art_csliesm$art_c = arrs.length; $art_iyeckfpq$art_i < $art_csliesm$art_c; $art_iyeckfpq$art_i++) {    var item = arrs[$art_iyeckfpq$art_i]%>';
    for (var $art_iyeckfpq$art_i = 0, $art_csliesm$art_c = arrs.length; $art_iyeckfpq$art_i < $art_csliesm$art_c; $art_iyeckfpq$art_i++) {
        var item = arrs[$art_iyeckfpq$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
