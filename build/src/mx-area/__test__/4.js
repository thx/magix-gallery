...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irrahosybb$art_i = 0, $art_cwftvo$art_c = arrs.length; $art_irrahosybb$art_i < $art_cwftvo$art_c; $art_irrahosybb$art_i++) {    var item = arrs[$art_irrahosybb$art_i]%>';
    for (var $art_irrahosybb$art_i = 0, $art_cwftvo$art_c = arrs.length; $art_irrahosybb$art_i < $art_cwftvo$art_c; $art_irrahosybb$art_i++) {
        var item = arrs[$art_irrahosybb$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
