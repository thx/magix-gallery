...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwqlznqmh$art_i = 0, $art_cmeiozczwj$art_c = arrs.length; $art_iwqlznqmh$art_i < $art_cmeiozczwj$art_c; $art_iwqlznqmh$art_i++) {    var item = arrs[$art_iwqlznqmh$art_i]%>';
    for (var $art_iwqlznqmh$art_i = 0, $art_cmeiozczwj$art_c = arrs.length; $art_iwqlznqmh$art_i < $art_cmeiozczwj$art_c; $art_iwqlznqmh$art_i++) {
        var item = arrs[$art_iwqlznqmh$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
