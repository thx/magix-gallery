...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijomctqj$art_i = 0, $art_cfoxqstly$art_c = arrs.length; $art_ijomctqj$art_i < $art_cfoxqstly$art_c; $art_ijomctqj$art_i++) {    var item = arrs[$art_ijomctqj$art_i]%>';
    for (var $art_ijomctqj$art_i = 0, $art_cfoxqstly$art_c = arrs.length; $art_ijomctqj$art_i < $art_cfoxqstly$art_c; $art_ijomctqj$art_i++) {
        var item = arrs[$art_ijomctqj$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
