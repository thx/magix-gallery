...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioaqdyan$art_i = 0, $art_csvmeogvq$art_c = arrs.length; $art_ioaqdyan$art_i < $art_csvmeogvq$art_c; $art_ioaqdyan$art_i++) {    var item = arrs[$art_ioaqdyan$art_i]%>';
    for (var $art_ioaqdyan$art_i = 0, $art_csvmeogvq$art_c = arrs.length; $art_ioaqdyan$art_i < $art_csvmeogvq$art_c; $art_ioaqdyan$art_i++) {
        var item = arrs[$art_ioaqdyan$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
