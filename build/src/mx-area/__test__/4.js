...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilbzfvmosp$art_i = 0, $art_chrxeqkop$art_c = arrs.length; $art_ilbzfvmosp$art_i < $art_chrxeqkop$art_c; $art_ilbzfvmosp$art_i++) {    var item = arrs[$art_ilbzfvmosp$art_i]%>';
    for (var $art_ilbzfvmosp$art_i = 0, $art_chrxeqkop$art_c = arrs.length; $art_ilbzfvmosp$art_i < $art_chrxeqkop$art_c; $art_ilbzfvmosp$art_i++) {
        var item = arrs[$art_ilbzfvmosp$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
