...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icwhmcdou$art_i = 0, $art_clsng$art_c = arrs.length; $art_icwhmcdou$art_i < $art_clsng$art_c; $art_icwhmcdou$art_i++) {    var item = arrs[$art_icwhmcdou$art_i]%>';
    for (var $art_icwhmcdou$art_i = 0, $art_clsng$art_c = arrs.length; $art_icwhmcdou$art_i < $art_clsng$art_c; $art_icwhmcdou$art_i++) {
        var item = arrs[$art_icwhmcdou$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
