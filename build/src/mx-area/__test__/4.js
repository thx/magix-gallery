...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isavrpuwb$art_i = 0, $art_cfmuneb$art_c = arrs.length; $art_isavrpuwb$art_i < $art_cfmuneb$art_c; $art_isavrpuwb$art_i++) {    var item = arrs[$art_isavrpuwb$art_i]%>';
    for (var $art_isavrpuwb$art_i = 0, $art_cfmuneb$art_c = arrs.length; $art_isavrpuwb$art_i < $art_cfmuneb$art_c; $art_isavrpuwb$art_i++) {
        var item = arrs[$art_isavrpuwb$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
