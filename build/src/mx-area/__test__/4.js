...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwiinoawem$art_i = 0, $art_cpjlowpzm$art_c = arrs.length; $art_iwiinoawem$art_i < $art_cpjlowpzm$art_c; $art_iwiinoawem$art_i++) {    var item = arrs[$art_iwiinoawem$art_i]%>';
    for (var $art_iwiinoawem$art_i = 0, $art_cpjlowpzm$art_c = arrs.length; $art_iwiinoawem$art_i < $art_cpjlowpzm$art_c; $art_iwiinoawem$art_i++) {
        var item = arrs[$art_iwiinoawem$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
