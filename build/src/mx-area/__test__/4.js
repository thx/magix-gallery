...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivsvqidbe$art_i = 0, $art_cpxkwfhk$art_c = arrs.length; $art_ivsvqidbe$art_i < $art_cpxkwfhk$art_c; $art_ivsvqidbe$art_i++) {    var item = arrs[$art_ivsvqidbe$art_i]%>';
    for (var $art_ivsvqidbe$art_i = 0, $art_cpxkwfhk$art_c = arrs.length; $art_ivsvqidbe$art_i < $art_cpxkwfhk$art_c; $art_ivsvqidbe$art_i++) {
        var item = arrs[$art_ivsvqidbe$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
