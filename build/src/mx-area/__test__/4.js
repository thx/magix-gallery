...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imoyajyoyd$art_i = 0, $art_ctkxmkm$art_c = arrs.length; $art_imoyajyoyd$art_i < $art_ctkxmkm$art_c; $art_imoyajyoyd$art_i++) {    var item = arrs[$art_imoyajyoyd$art_i]%>';
    for (var $art_imoyajyoyd$art_i = 0, $art_ctkxmkm$art_c = arrs.length; $art_imoyajyoyd$art_i < $art_ctkxmkm$art_c; $art_imoyajyoyd$art_i++) {
        var item = arrs[$art_imoyajyoyd$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
