...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilptyb$art_i = 0, $art_cmzhhhsqen$art_c = arrs.length; $art_ilptyb$art_i < $art_cmzhhhsqen$art_c; $art_ilptyb$art_i++) {    var item = arrs[$art_ilptyb$art_i]%>';
    for (var $art_ilptyb$art_i = 0, $art_cmzhhhsqen$art_c = arrs.length; $art_ilptyb$art_i < $art_cmzhhhsqen$art_c; $art_ilptyb$art_i++) {
        var item = arrs[$art_ilptyb$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
