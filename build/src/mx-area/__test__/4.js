...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixpfeke$art_i = 0, $art_cwiozjlfw$art_c = arrs.length; $art_ixpfeke$art_i < $art_cwiozjlfw$art_c; $art_ixpfeke$art_i++) {    var item = arrs[$art_ixpfeke$art_i]%>';
    for (var $art_ixpfeke$art_i = 0, $art_cwiozjlfw$art_c = arrs.length; $art_ixpfeke$art_i < $art_cwiozjlfw$art_c; $art_ixpfeke$art_i++) {
        var item = arrs[$art_ixpfeke$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
