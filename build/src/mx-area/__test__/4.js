...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipwonkxyxk$art_i = 0, $art_cwzfyydxwoh$art_c = arrs.length; $art_ipwonkxyxk$art_i < $art_cwzfyydxwoh$art_c; $art_ipwonkxyxk$art_i++) {    var item = arrs[$art_ipwonkxyxk$art_i]%>';
    for (var $art_ipwonkxyxk$art_i = 0, $art_cwzfyydxwoh$art_c = arrs.length; $art_ipwonkxyxk$art_i < $art_cwzfyydxwoh$art_c; $art_ipwonkxyxk$art_i++) {
        var item = arrs[$art_ipwonkxyxk$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
