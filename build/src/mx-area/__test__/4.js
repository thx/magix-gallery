...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iptyiambk$art_i = 0, $art_crkllpeo$art_c = arrs.length; $art_iptyiambk$art_i < $art_crkllpeo$art_c; $art_iptyiambk$art_i++) {    var item = arrs[$art_iptyiambk$art_i]%>';
    for (var $art_iptyiambk$art_i = 0, $art_crkllpeo$art_c = arrs.length; $art_iptyiambk$art_i < $art_crkllpeo$art_c; $art_iptyiambk$art_i++) {
        var item = arrs[$art_iptyiambk$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
