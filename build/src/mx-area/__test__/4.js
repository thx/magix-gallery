...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irysqnowwxo$art_i = 0, $art_cvxkseygc$art_c = arrs.length; $art_irysqnowwxo$art_i < $art_cvxkseygc$art_c; $art_irysqnowwxo$art_i++) {    var item = arrs[$art_irysqnowwxo$art_i]%>';
    for (var $art_irysqnowwxo$art_i = 0, $art_cvxkseygc$art_c = arrs.length; $art_irysqnowwxo$art_i < $art_cvxkseygc$art_c; $art_irysqnowwxo$art_i++) {
        var item = arrs[$art_irysqnowwxo$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
