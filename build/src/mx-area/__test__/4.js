...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixonktea$art_i = 0, $art_cgigwkhgemq$art_c = arrs.length; $art_ixonktea$art_i < $art_cgigwkhgemq$art_c; $art_ixonktea$art_i++) {    var item = arrs[$art_ixonktea$art_i]%>';
    for (var $art_ixonktea$art_i = 0, $art_cgigwkhgemq$art_c = arrs.length; $art_ixonktea$art_i < $art_cgigwkhgemq$art_c; $art_ixonktea$art_i++) {
        var item = arrs[$art_ixonktea$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
