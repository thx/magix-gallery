...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inpaskrdpy$art_i = 0, $art_cidxobicj$art_c = arrs.length; $art_inpaskrdpy$art_i < $art_cidxobicj$art_c; $art_inpaskrdpy$art_i++) {    var item = arrs[$art_inpaskrdpy$art_i]%>';
    for (var $art_inpaskrdpy$art_i = 0, $art_cidxobicj$art_c = arrs.length; $art_inpaskrdpy$art_i < $art_cidxobicj$art_c; $art_inpaskrdpy$art_i++) {
        var item = arrs[$art_inpaskrdpy$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
