...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iafmx$art_i = 0, $art_caudjbqee$art_c = arrs.length; $art_iafmx$art_i < $art_caudjbqee$art_c; $art_iafmx$art_i++) {    var item = arrs[$art_iafmx$art_i]%>';
    for (var $art_iafmx$art_i = 0, $art_caudjbqee$art_c = arrs.length; $art_iafmx$art_i < $art_caudjbqee$art_c; $art_iafmx$art_i++) {
        var item = arrs[$art_iafmx$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
