...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igpgjqxi$art_i = 0, $art_cpqjvxmano$art_c = arrs.length; $art_igpgjqxi$art_i < $art_cpqjvxmano$art_c; $art_igpgjqxi$art_i++) {    var item = arrs[$art_igpgjqxi$art_i]%>';
    for (var $art_igpgjqxi$art_i = 0, $art_cpqjvxmano$art_c = arrs.length; $art_igpgjqxi$art_i < $art_cpqjvxmano$art_c; $art_igpgjqxi$art_i++) {
        var item = arrs[$art_igpgjqxi$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
