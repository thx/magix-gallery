...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikolbpphjga$art_i = 0, $art_ckfrndyim$art_c = arrs.length; $art_ikolbpphjga$art_i < $art_ckfrndyim$art_c; $art_ikolbpphjga$art_i++) {    var item = arrs[$art_ikolbpphjga$art_i]%>';
    for (var $art_ikolbpphjga$art_i = 0, $art_ckfrndyim$art_c = arrs.length; $art_ikolbpphjga$art_i < $art_ckfrndyim$art_c; $art_ikolbpphjga$art_i++) {
        var item = arrs[$art_ikolbpphjga$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
