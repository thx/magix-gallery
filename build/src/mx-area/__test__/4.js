...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iagjufosil$art_i = 0, $art_cpucwgyaj$art_c = arrs.length; $art_iagjufosil$art_i < $art_cpucwgyaj$art_c; $art_iagjufosil$art_i++) {    var item = arrs[$art_iagjufosil$art_i]%>';
    for (var $art_iagjufosil$art_i = 0, $art_cpucwgyaj$art_c = arrs.length; $art_iagjufosil$art_i < $art_cpucwgyaj$art_c; $art_iagjufosil$art_i++) {
        var item = arrs[$art_iagjufosil$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
