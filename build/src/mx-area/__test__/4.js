...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izgnecs$art_i = 0, $art_cnhltccd$art_c = arrs.length; $art_izgnecs$art_i < $art_cnhltccd$art_c; $art_izgnecs$art_i++) {    var item = arrs[$art_izgnecs$art_i]%>';
    for (var $art_izgnecs$art_i = 0, $art_cnhltccd$art_c = arrs.length; $art_izgnecs$art_i < $art_cnhltccd$art_c; $art_izgnecs$art_i++) {
        var item = arrs[$art_izgnecs$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
