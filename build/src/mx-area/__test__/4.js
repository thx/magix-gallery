...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iedupcfzg$art_i = 0, $art_chwxyerq$art_c = arrs.length; $art_iedupcfzg$art_i < $art_chwxyerq$art_c; $art_iedupcfzg$art_i++) {    var item = arrs[$art_iedupcfzg$art_i]%>';
    for (var $art_iedupcfzg$art_i = 0, $art_chwxyerq$art_c = arrs.length; $art_iedupcfzg$art_i < $art_chwxyerq$art_c; $art_iedupcfzg$art_i++) {
        var item = arrs[$art_iedupcfzg$art_i];
        $p += '<div>';
        $line = 27;
        $art = '=item.name';
        ;
