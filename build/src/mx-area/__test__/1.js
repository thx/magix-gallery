...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihzikhoame$art_i = 0, $art_coirzffzlr$art_c = selected.length; $art_ihzikhoame$art_i < $art_coirzffzlr$art_c; $art_ihzikhoame$art_i++) {    var item = selected[$art_ihzikhoame$art_i]%>';
    for (var $art_ihzikhoame$art_i = 0, $art_coirzffzlr$art_c = selected.length; $art_ihzikhoame$art_i < $art_coirzffzlr$art_c; $art_ihzikhoame$art_i++) {
        var item = selected[$art_ihzikhoame$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
