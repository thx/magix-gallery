...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryA:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_galleryA:a" class="_zs_gallery___test___base_-eg-content"><div mxs="_zs_galleryA:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl"><div>可以选择城市</div><div>每个省份和城市都有各自的id，若选择了省份，则获取选中值时只有省份的id（不包含该省份下所有城市id）</div><div>宽度由容器宽度决定，自适应</div></div></div><div mxv mxa="_zs_galleryA:b" class="clearfix mb20"><div mxv mxa="_zs_galleryA:c" class="_zs_gallery_mx-area___test___index_-area-wrapper1 fl mr20"><div mxv="selected" id="';
    $line = 13;
    $art = '=viewId';
    ;
    ...
    $art = '@selected';
    ;
    $p += '' + ($expr = '<%@selected%>', $i(selected)) + '"></div></div><div mxa="_zs_galleryA:d" class="fl"><div mxs="_zs_galleryA:a" class="mb10"><a href="javascript:;" class="btn btn-brand" mx-click="' + $viewId + 'get()">获取选中值</a></div><div mxa="_zs_galleryA:e" class="clearfix lh22"><div mxs="_zs_galleryA:b" class="fl color-9">当前选中值：</div><div mxa="_zs_galleryA:f" class="fl">';
    $line = 22;
    $art = 'each selected as item';
    ;
    $p += '';
    $expr = '<%for(var $art_iphfkxopkx$art_i=0;$art_iphfkxopkx$art_i<selected.length;$art_iphfkxopkx$art_i++){var item=selected[$art_iphfkxopkx$art_i]%>';
    for (var $art_iphfkxopkx$art_i = 0; $art_iphfkxopkx$art_i < selected.length; $art_iphfkxopkx$art_i++) {
        var item = selected[$art_iphfkxopkx$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
    ...
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_galleryA:g" class="clearfix"><div mxa="_zs_galleryA:h" class="_zs_gallery___test___base_-eg-desc _zs_gallery___test___base_-half"><div mxs="_zs_galleryA:c" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 33;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryA:i" class="_zs_gallery___test___base_-desc-tip">';
    $line = 35;
    $art = '!text1';
    ;
