...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irabits$art_i = 0, $art_czqkigrpizh$art_c = selected.length; $art_irabits$art_i < $art_czqkigrpizh$art_c; $art_irabits$art_i++) {    var item = selected[$art_irabits$art_i]%>';
    for (var $art_irabits$art_i = 0, $art_czqkigrpizh$art_c = selected.length; $art_irabits$art_i < $art_czqkigrpizh$art_c; $art_irabits$art_i++) {
        var item = selected[$art_irabits$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
