...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipzxioadxq$art_i = 0, $art_cmvbaxkwbqf$art_c = selected.length; $art_ipzxioadxq$art_i < $art_cmvbaxkwbqf$art_c; $art_ipzxioadxq$art_i++) {    var item = selected[$art_ipzxioadxq$art_i]%>';
    for (var $art_ipzxioadxq$art_i = 0, $art_cmvbaxkwbqf$art_c = selected.length; $art_ipzxioadxq$art_i < $art_cmvbaxkwbqf$art_c; $art_ipzxioadxq$art_i++) {
        var item = selected[$art_ipzxioadxq$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
