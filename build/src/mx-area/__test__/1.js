...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iorlqyt$art_i = 0, $art_cynvyjc$art_c = selected.length; $art_iorlqyt$art_i < $art_cynvyjc$art_c; $art_iorlqyt$art_i++) {    var item = selected[$art_iorlqyt$art_i]%>';
    for (var $art_iorlqyt$art_i = 0, $art_cynvyjc$art_c = selected.length; $art_iorlqyt$art_i < $art_cynvyjc$art_c; $art_iorlqyt$art_i++) {
        var item = selected[$art_iorlqyt$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
