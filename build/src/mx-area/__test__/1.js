...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iidnm$art_i = 0, $art_cmhnrvizyns$art_c = selected.length; $art_iidnm$art_i < $art_cmhnrvizyns$art_c; $art_iidnm$art_i++) {    var item = selected[$art_iidnm$art_i]%>';
    for (var $art_iidnm$art_i = 0, $art_cmhnrvizyns$art_c = selected.length; $art_iidnm$art_i < $art_cmhnrvizyns$art_c; $art_iidnm$art_i++) {
        var item = selected[$art_iidnm$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
