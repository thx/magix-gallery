...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izhjuuhicl$art_i = 0, $art_clwqegvdt$art_c = selected.length; $art_izhjuuhicl$art_i < $art_clwqegvdt$art_c; $art_izhjuuhicl$art_i++) {    var item = selected[$art_izhjuuhicl$art_i]%>';
    for (var $art_izhjuuhicl$art_i = 0, $art_clwqegvdt$art_c = selected.length; $art_izhjuuhicl$art_i < $art_clwqegvdt$art_c; $art_izhjuuhicl$art_i++) {
        var item = selected[$art_izhjuuhicl$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
