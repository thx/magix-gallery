...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iakgupdi$art_i = 0, $art_clcfaoqs$art_c = selected.length; $art_iakgupdi$art_i < $art_clcfaoqs$art_c; $art_iakgupdi$art_i++) {    var item = selected[$art_iakgupdi$art_i]%>';
    for (var $art_iakgupdi$art_i = 0, $art_clcfaoqs$art_c = selected.length; $art_iakgupdi$art_i < $art_clcfaoqs$art_c; $art_iakgupdi$art_i++) {
        var item = selected[$art_iakgupdi$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
