...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irjlvqudjmb$art_i = 0, $art_czbhgprhb$art_c = selected.length; $art_irjlvqudjmb$art_i < $art_czbhgprhb$art_c; $art_irjlvqudjmb$art_i++) {    var item = selected[$art_irjlvqudjmb$art_i]%>';
    for (var $art_irjlvqudjmb$art_i = 0, $art_czbhgprhb$art_c = selected.length; $art_irjlvqudjmb$art_i < $art_czbhgprhb$art_c; $art_irjlvqudjmb$art_i++) {
        var item = selected[$art_irjlvqudjmb$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
