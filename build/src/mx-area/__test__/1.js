...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izziuokbr$art_i = 0, $art_cwnfpjhgi$art_c = selected.length; $art_izziuokbr$art_i < $art_cwnfpjhgi$art_c; $art_izziuokbr$art_i++) {    var item = selected[$art_izziuokbr$art_i]%>';
    for (var $art_izziuokbr$art_i = 0, $art_cwnfpjhgi$art_c = selected.length; $art_izziuokbr$art_i < $art_cwnfpjhgi$art_c; $art_izziuokbr$art_i++) {
        var item = selected[$art_izziuokbr$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
