...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iywrgkuis$art_i = 0, $art_chqheokd$art_c = selected.length; $art_iywrgkuis$art_i < $art_chqheokd$art_c; $art_iywrgkuis$art_i++) {    var item = selected[$art_iywrgkuis$art_i]%>';
    for (var $art_iywrgkuis$art_i = 0, $art_chqheokd$art_c = selected.length; $art_iywrgkuis$art_i < $art_chqheokd$art_c; $art_iywrgkuis$art_i++) {
        var item = selected[$art_iywrgkuis$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
