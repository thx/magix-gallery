...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iscanvp$art_i=0;$art_iscanvp$art_i<selected.length;$art_iscanvp$art_i++){var item=selected[$art_iscanvp$art_i]%>';
    for (var $art_iscanvp$art_i = 0; $art_iscanvp$art_i < selected.length; $art_iscanvp$art_i++) {
        var item = selected[$art_iscanvp$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
