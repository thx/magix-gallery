...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieuatyt$art_i = 0, $art_cdbafoyfv$art_c = selected.length; $art_ieuatyt$art_i < $art_cdbafoyfv$art_c; $art_ieuatyt$art_i++) {    var item = selected[$art_ieuatyt$art_i]%>';
    for (var $art_ieuatyt$art_i = 0, $art_cdbafoyfv$art_c = selected.length; $art_ieuatyt$art_i < $art_cdbafoyfv$art_c; $art_ieuatyt$art_i++) {
        var item = selected[$art_ieuatyt$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
