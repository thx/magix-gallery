...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqllbtrr$art_i = 0, $art_cgbvfrij$art_c = selected.length; $art_iqllbtrr$art_i < $art_cgbvfrij$art_c; $art_iqllbtrr$art_i++) {    var item = selected[$art_iqllbtrr$art_i]%>';
    for (var $art_iqllbtrr$art_i = 0, $art_cgbvfrij$art_c = selected.length; $art_iqllbtrr$art_i < $art_cgbvfrij$art_c; $art_iqllbtrr$art_i++) {
        var item = selected[$art_iqllbtrr$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
