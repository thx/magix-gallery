...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryT:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryT:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryT:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl"><div>可以选择城市</div><div>每个省份和城市都有各自的id，若选择了省份，则获取选中值时只有省份的id（不包含该省份下所有城市id）</div><div>宽度由容器宽度决定，自适应</div></div></div><div mxv mxa="_zs_galleryT:b" class="clearfix mb20"><div mxv mxa="_zs_galleryT:c" class="_zs_gallery_mx-area___test___index_-area-wrapper1 fl mr20"><div mxv="selected" id="';
    $line = 13;
    $art = '=viewId';
    ;
    ...
    ;
    $expr = '<%for (var $art_ixlooblnvr$art_i = 0, $art_cxuamtzbazh$art_c = selected.length; $art_ixlooblnvr$art_i < $art_cxuamtzbazh$art_c; $art_ixlooblnvr$art_i++) {    var item = selected[$art_ixlooblnvr$art_i]%>';
    for (var $art_ixlooblnvr$art_i = 0, $art_cxuamtzbazh$art_c = selected.length; $art_ixlooblnvr$art_i < $art_cxuamtzbazh$art_c; $art_ixlooblnvr$art_i++) {
        var item = selected[$art_ixlooblnvr$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
    ...
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_galleryT:g" class="clearfix"><div mxa="_zs_galleryT:h" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryT:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 33;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryT:i" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 35;
    $art = '!text1';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-area id="&#123;&#123;=viewId&#125;&#125;_area"\n    city="true"\n    selected="&#123;&#123;@selected&#125;&#125;"/&gt;</pre></div><div mxa="_zs_galleryT:j" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-right"><div mxs="_zs_galleryT:e" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 45;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryT:k" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 47;
    $art = '!text2';
    ;
