...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iioezdxaa$art_i = 0, $art_cfufyqriyl$art_c = selected.length; $art_iioezdxaa$art_i < $art_cfufyqriyl$art_c; $art_iioezdxaa$art_i++) {    var item = selected[$art_iioezdxaa$art_i]%>';
    for (var $art_iioezdxaa$art_i = 0, $art_cfufyqriyl$art_c = selected.length; $art_iioezdxaa$art_i < $art_cfufyqriyl$art_c; $art_iioezdxaa$art_i++) {
        var item = selected[$art_iioezdxaa$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
