...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifqdncio$art_i = 0, $art_cachbdtnf$art_c = selected.length; $art_ifqdncio$art_i < $art_cachbdtnf$art_c; $art_ifqdncio$art_i++) {    var item = selected[$art_ifqdncio$art_i]%>';
    for (var $art_ifqdncio$art_i = 0, $art_cachbdtnf$art_c = selected.length; $art_ifqdncio$art_i < $art_cachbdtnf$art_c; $art_ifqdncio$art_i++) {
        var item = selected[$art_ifqdncio$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
