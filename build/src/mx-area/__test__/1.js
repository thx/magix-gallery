...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibakzzbxk$art_i = 0, $art_cfegvgbqi$art_c = selected.length; $art_ibakzzbxk$art_i < $art_cfegvgbqi$art_c; $art_ibakzzbxk$art_i++) {    var item = selected[$art_ibakzzbxk$art_i]%>';
    for (var $art_ibakzzbxk$art_i = 0, $art_cfegvgbqi$art_c = selected.length; $art_ibakzzbxk$art_i < $art_cfegvgbqi$art_c; $art_ibakzzbxk$art_i++) {
        var item = selected[$art_ibakzzbxk$art_i];
        $p += '<div>';
        $line = 23;
        $art = '=item';
        ;
