...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iccprvklr$art_i = 0, $art_cmfencwzn$art_c = selected.length; $art_iccprvklr$art_i < $art_cmfencwzn$art_c; $art_iccprvklr$art_i++) {    var item = selected[$art_iccprvklr$art_i]%>';
    for (var $art_iccprvklr$art_i = 0, $art_cmfencwzn$art_c = selected.length; $art_iccprvklr$art_i < $art_cmfencwzn$art_c; $art_iccprvklr$art_i++) {
        var item = selected[$art_iccprvklr$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
