...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icxerloio$art_i = 0, $art_ckujmmtzqp$art_c = selected.length; $art_icxerloio$art_i < $art_ckujmmtzqp$art_c; $art_icxerloio$art_i++) {    var item = selected[$art_icxerloio$art_i]%>';
    for (var $art_icxerloio$art_i = 0, $art_ckujmmtzqp$art_c = selected.length; $art_icxerloio$art_i < $art_ckujmmtzqp$art_c; $art_icxerloio$art_i++) {
        var item = selected[$art_icxerloio$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
