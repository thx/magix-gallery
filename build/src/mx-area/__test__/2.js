...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivhbyiyn$art_i = 0, $art_cxzy$art_c = selected.length; $art_ivhbyiyn$art_i < $art_cxzy$art_c; $art_ivhbyiyn$art_i++) {    var item = selected[$art_ivhbyiyn$art_i]%>';
    for (var $art_ivhbyiyn$art_i = 0, $art_cxzy$art_c = selected.length; $art_ivhbyiyn$art_i < $art_cxzy$art_c; $art_ivhbyiyn$art_i++) {
        var item = selected[$art_ivhbyiyn$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
