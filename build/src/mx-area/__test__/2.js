...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibtupibmm$art_i = 0, $art_cnwajaebkge$art_c = selected.length; $art_ibtupibmm$art_i < $art_cnwajaebkge$art_c; $art_ibtupibmm$art_i++) {    var item = selected[$art_ibtupibmm$art_i]%>';
    for (var $art_ibtupibmm$art_i = 0, $art_cnwajaebkge$art_c = selected.length; $art_ibtupibmm$art_i < $art_cnwajaebkge$art_c; $art_ibtupibmm$art_i++) {
        var item = selected[$art_ibtupibmm$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
