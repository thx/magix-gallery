...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imjknjujc$art_i = 0, $art_cotoethaos$art_c = selected.length; $art_imjknjujc$art_i < $art_cotoethaos$art_c; $art_imjknjujc$art_i++) {    var item = selected[$art_imjknjujc$art_i]%>';
    for (var $art_imjknjujc$art_i = 0, $art_cotoethaos$art_c = selected.length; $art_imjknjujc$art_i < $art_cotoethaos$art_c; $art_imjknjujc$art_i++) {
        var item = selected[$art_imjknjujc$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
