...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iphmpgtmj$art_i = 0, $art_cnoetlabmcl$art_c = selected.length; $art_iphmpgtmj$art_i < $art_cnoetlabmcl$art_c; $art_iphmpgtmj$art_i++) {    var item = selected[$art_iphmpgtmj$art_i]%>';
    for (var $art_iphmpgtmj$art_i = 0, $art_cnoetlabmcl$art_c = selected.length; $art_iphmpgtmj$art_i < $art_cnoetlabmcl$art_c; $art_iphmpgtmj$art_i++) {
        var item = selected[$art_iphmpgtmj$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
