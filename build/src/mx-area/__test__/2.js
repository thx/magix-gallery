...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihkmgile$art_i = 0, $art_cxopkmah$art_c = selected.length; $art_ihkmgile$art_i < $art_cxopkmah$art_c; $art_ihkmgile$art_i++) {    var item = selected[$art_ihkmgile$art_i]%>';
    for (var $art_ihkmgile$art_i = 0, $art_cxopkmah$art_c = selected.length; $art_ihkmgile$art_i < $art_cxopkmah$art_c; $art_ihkmgile$art_i++) {
        var item = selected[$art_ihkmgile$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
