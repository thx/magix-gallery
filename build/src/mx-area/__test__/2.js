...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipxudqb$art_i = 0, $art_cggqaoham$art_c = selected.length; $art_ipxudqb$art_i < $art_cggqaoham$art_c; $art_ipxudqb$art_i++) {    var item = selected[$art_ipxudqb$art_i]%>';
    for (var $art_ipxudqb$art_i = 0, $art_cggqaoham$art_c = selected.length; $art_ipxudqb$art_i < $art_cggqaoham$art_c; $art_ipxudqb$art_i++) {
        var item = selected[$art_ipxudqb$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
