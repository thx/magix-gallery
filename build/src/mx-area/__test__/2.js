...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idvoashdlzi$art_i = 0, $art_cpblooyky$art_c = selected.length; $art_idvoashdlzi$art_i < $art_cpblooyky$art_c; $art_idvoashdlzi$art_i++) {    var item = selected[$art_idvoashdlzi$art_i]%>';
    for (var $art_idvoashdlzi$art_i = 0, $art_cpblooyky$art_c = selected.length; $art_idvoashdlzi$art_i < $art_cpblooyky$art_c; $art_idvoashdlzi$art_i++) {
        var item = selected[$art_idvoashdlzi$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
