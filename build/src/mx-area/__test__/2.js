...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijhjtoxql$art_i = 0, $art_chwmdvgn$art_c = selected.length; $art_ijhjtoxql$art_i < $art_chwmdvgn$art_c; $art_ijhjtoxql$art_i++) {    var item = selected[$art_ijhjtoxql$art_i]%>';
    for (var $art_ijhjtoxql$art_i = 0, $art_chwmdvgn$art_c = selected.length; $art_ijhjtoxql$art_i < $art_chwmdvgn$art_c; $art_ijhjtoxql$art_i++) {
        var item = selected[$art_ijhjtoxql$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
