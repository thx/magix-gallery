...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iibkfbhpqhb$art_i = 0, $art_cqcbkrbrl$art_c = selected.length; $art_iibkfbhpqhb$art_i < $art_cqcbkrbrl$art_c; $art_iibkfbhpqhb$art_i++) {    var item = selected[$art_iibkfbhpqhb$art_i]%>';
    for (var $art_iibkfbhpqhb$art_i = 0, $art_cqcbkrbrl$art_c = selected.length; $art_iibkfbhpqhb$art_i < $art_cqcbkrbrl$art_c; $art_iibkfbhpqhb$art_i++) {
        var item = selected[$art_iibkfbhpqhb$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
