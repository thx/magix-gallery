...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifqhjlsee$art_i = 0, $art_cvxbinqsxf$art_c = selected.length; $art_ifqhjlsee$art_i < $art_cvxbinqsxf$art_c; $art_ifqhjlsee$art_i++) {    var item = selected[$art_ifqhjlsee$art_i]%>';
    for (var $art_ifqhjlsee$art_i = 0, $art_cvxbinqsxf$art_c = selected.length; $art_ifqhjlsee$art_i < $art_cvxbinqsxf$art_c; $art_ifqhjlsee$art_i++) {
        var item = selected[$art_ifqhjlsee$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
