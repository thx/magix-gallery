...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irbcae$art_i = 0, $art_cagtspqtlv$art_c = selected.length; $art_irbcae$art_i < $art_cagtspqtlv$art_c; $art_irbcae$art_i++) {    var item = selected[$art_irbcae$art_i]%>';
    for (var $art_irbcae$art_i = 0, $art_cagtspqtlv$art_c = selected.length; $art_irbcae$art_i < $art_cagtspqtlv$art_c; $art_irbcae$art_i++) {
        var item = selected[$art_irbcae$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
