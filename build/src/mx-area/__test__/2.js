...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idjxnbfmbvj$art_i = 0, $art_cvvcyqcon$art_c = selected.length; $art_idjxnbfmbvj$art_i < $art_cvvcyqcon$art_c; $art_idjxnbfmbvj$art_i++) {    var item = selected[$art_idjxnbfmbvj$art_i]%>';
    for (var $art_idjxnbfmbvj$art_i = 0, $art_cvvcyqcon$art_c = selected.length; $art_idjxnbfmbvj$art_i < $art_cvvcyqcon$art_c; $art_idjxnbfmbvj$art_i++) {
        var item = selected[$art_idjxnbfmbvj$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
