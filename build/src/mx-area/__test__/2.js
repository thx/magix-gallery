...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqkxymoxkn$art_i = 0, $art_cbfzfgnes$art_c = selected.length; $art_iqkxymoxkn$art_i < $art_cbfzfgnes$art_c; $art_iqkxymoxkn$art_i++) {    var item = selected[$art_iqkxymoxkn$art_i]%>';
    for (var $art_iqkxymoxkn$art_i = 0, $art_cbfzfgnes$art_c = selected.length; $art_iqkxymoxkn$art_i < $art_cbfzfgnes$art_c; $art_iqkxymoxkn$art_i++) {
        var item = selected[$art_iqkxymoxkn$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
