...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilotpms$art_i = 0, $art_cyxvyjeeo$art_c = selected.length; $art_ilotpms$art_i < $art_cyxvyjeeo$art_c; $art_ilotpms$art_i++) {    var item = selected[$art_ilotpms$art_i]%>';
    for (var $art_ilotpms$art_i = 0, $art_cyxvyjeeo$art_c = selected.length; $art_ilotpms$art_i < $art_cyxvyjeeo$art_c; $art_ilotpms$art_i++) {
        var item = selected[$art_ilotpms$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
