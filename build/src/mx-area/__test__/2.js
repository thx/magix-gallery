...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izzlfcsgw$art_i = 0, $art_cjxyraqvus$art_c = selected.length; $art_izzlfcsgw$art_i < $art_cjxyraqvus$art_c; $art_izzlfcsgw$art_i++) {    var item = selected[$art_izzlfcsgw$art_i]%>';
    for (var $art_izzlfcsgw$art_i = 0, $art_cjxyraqvus$art_c = selected.length; $art_izzlfcsgw$art_i < $art_cjxyraqvus$art_c; $art_izzlfcsgw$art_i++) {
        var item = selected[$art_izzlfcsgw$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
