...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihqhfqtj$art_i = 0, $art_cfmemsdx$art_c = selected.length; $art_ihqhfqtj$art_i < $art_cfmemsdx$art_c; $art_ihqhfqtj$art_i++) {    var item = selected[$art_ihqhfqtj$art_i]%>';
    for (var $art_ihqhfqtj$art_i = 0, $art_cfmemsdx$art_c = selected.length; $art_ihqhfqtj$art_i < $art_cfmemsdx$art_c; $art_ihqhfqtj$art_i++) {
        var item = selected[$art_ihqhfqtj$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
