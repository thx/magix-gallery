...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irulguvxq$art_i = 0, $art_csxukftxte$art_c = selected.length; $art_irulguvxq$art_i < $art_csxukftxte$art_c; $art_irulguvxq$art_i++) {    var item = selected[$art_irulguvxq$art_i]%>';
    for (var $art_irulguvxq$art_i = 0, $art_csxukftxte$art_c = selected.length; $art_irulguvxq$art_i < $art_csxukftxte$art_c; $art_irulguvxq$art_i++) {
        var item = selected[$art_irulguvxq$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
