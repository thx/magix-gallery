...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idsnhkcvdov$art_i = 0, $art_cjovr$art_c = selected.length; $art_idsnhkcvdov$art_i < $art_cjovr$art_c; $art_idsnhkcvdov$art_i++) {    var item = selected[$art_idsnhkcvdov$art_i]%>';
    for (var $art_idsnhkcvdov$art_i = 0, $art_cjovr$art_c = selected.length; $art_idsnhkcvdov$art_i < $art_cjovr$art_c; $art_idsnhkcvdov$art_i++) {
        var item = selected[$art_idsnhkcvdov$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
