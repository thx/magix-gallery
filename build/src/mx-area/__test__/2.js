...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itytgfmuy$art_i = 0, $art_ceomgttpfu$art_c = selected.length; $art_itytgfmuy$art_i < $art_ceomgttpfu$art_c; $art_itytgfmuy$art_i++) {    var item = selected[$art_itytgfmuy$art_i]%>';
    for (var $art_itytgfmuy$art_i = 0, $art_ceomgttpfu$art_c = selected.length; $art_itytgfmuy$art_i < $art_ceomgttpfu$art_c; $art_itytgfmuy$art_i++) {
        var item = selected[$art_itytgfmuy$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
