...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqzhsdfku$art_i = 0, $art_cynfrlko$art_c = selected.length; $art_iqzhsdfku$art_i < $art_cynfrlko$art_c; $art_iqzhsdfku$art_i++) {    var item = selected[$art_iqzhsdfku$art_i]%>';
    for (var $art_iqzhsdfku$art_i = 0, $art_cynfrlko$art_c = selected.length; $art_iqzhsdfku$art_i < $art_cynfrlko$art_c; $art_iqzhsdfku$art_i++) {
        var item = selected[$art_iqzhsdfku$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
