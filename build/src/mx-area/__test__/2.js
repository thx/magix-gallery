...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itsjcbvp$art_i = 0, $art_chilmov$art_c = selected.length; $art_itsjcbvp$art_i < $art_chilmov$art_c; $art_itsjcbvp$art_i++) {    var item = selected[$art_itsjcbvp$art_i]%>';
    for (var $art_itsjcbvp$art_i = 0, $art_chilmov$art_c = selected.length; $art_itsjcbvp$art_i < $art_chilmov$art_c; $art_itsjcbvp$art_i++) {
        var item = selected[$art_itsjcbvp$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
