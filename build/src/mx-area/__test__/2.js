...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipnerbshk$art_i = 0, $art_cpfzycsynhh$art_c = selected.length; $art_ipnerbshk$art_i < $art_cpfzycsynhh$art_c; $art_ipnerbshk$art_i++) {    var item = selected[$art_ipnerbshk$art_i]%>';
    for (var $art_ipnerbshk$art_i = 0, $art_cpfzycsynhh$art_c = selected.length; $art_ipnerbshk$art_i < $art_cpfzycsynhh$art_c; $art_ipnerbshk$art_i++) {
        var item = selected[$art_ipnerbshk$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
