...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifrjverq$art_i = 0, $art_clxgcyjiol$art_c = selected.length; $art_ifrjverq$art_i < $art_clxgcyjiol$art_c; $art_ifrjverq$art_i++) {    var item = selected[$art_ifrjverq$art_i]%>';
    for (var $art_ifrjverq$art_i = 0, $art_clxgcyjiol$art_c = selected.length; $art_ifrjverq$art_i < $art_clxgcyjiol$art_c; $art_ifrjverq$art_i++) {
        var item = selected[$art_ifrjverq$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
