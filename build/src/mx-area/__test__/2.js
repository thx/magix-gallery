...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iobdxxxgi$art_i = 0, $art_ctuqkomy$art_c = selected.length; $art_iobdxxxgi$art_i < $art_ctuqkomy$art_c; $art_iobdxxxgi$art_i++) {    var item = selected[$art_iobdxxxgi$art_i]%>';
    for (var $art_iobdxxxgi$art_i = 0, $art_ctuqkomy$art_c = selected.length; $art_iobdxxxgi$art_i < $art_ctuqkomy$art_c; $art_iobdxxxgi$art_i++) {
        var item = selected[$art_iobdxxxgi$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
