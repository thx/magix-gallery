...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iheidjiyhi$art_i = 0, $art_cswcop$art_c = selected.length; $art_iheidjiyhi$art_i < $art_cswcop$art_c; $art_iheidjiyhi$art_i++) {    var item = selected[$art_iheidjiyhi$art_i]%>';
    for (var $art_iheidjiyhi$art_i = 0, $art_cswcop$art_c = selected.length; $art_iheidjiyhi$art_i < $art_cswcop$art_c; $art_iheidjiyhi$art_i++) {
        var item = selected[$art_iheidjiyhi$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
