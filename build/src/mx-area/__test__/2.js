...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilbsbepmgod$art_i = 0, $art_cmovantyic$art_c = selected.length; $art_ilbsbepmgod$art_i < $art_cmovantyic$art_c; $art_ilbsbepmgod$art_i++) {    var item = selected[$art_ilbsbepmgod$art_i]%>';
    for (var $art_ilbsbepmgod$art_i = 0, $art_cmovantyic$art_c = selected.length; $art_ilbsbepmgod$art_i < $art_cmovantyic$art_c; $art_ilbsbepmgod$art_i++) {
        var item = selected[$art_ilbsbepmgod$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
