...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijzmvsvp$art_i = 0, $art_cupazolivg$art_c = selected.length; $art_ijzmvsvp$art_i < $art_cupazolivg$art_c; $art_ijzmvsvp$art_i++) {    var item = selected[$art_ijzmvsvp$art_i]%>';
    for (var $art_ijzmvsvp$art_i = 0, $art_cupazolivg$art_c = selected.length; $art_ijzmvsvp$art_i < $art_cupazolivg$art_c; $art_ijzmvsvp$art_i++) {
        var item = selected[$art_ijzmvsvp$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
