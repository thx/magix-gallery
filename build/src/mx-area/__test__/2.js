...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixoupzfcv$art_i = 0, $art_cwnzgherno$art_c = selected.length; $art_ixoupzfcv$art_i < $art_cwnzgherno$art_c; $art_ixoupzfcv$art_i++) {    var item = selected[$art_ixoupzfcv$art_i]%>';
    for (var $art_ixoupzfcv$art_i = 0, $art_cwnzgherno$art_c = selected.length; $art_ixoupzfcv$art_i < $art_cwnzgherno$art_c; $art_ixoupzfcv$art_i++) {
        var item = selected[$art_ixoupzfcv$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
