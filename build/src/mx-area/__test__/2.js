...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iutuqdv$art_i = 0, $art_ccabfvm$art_c = selected.length; $art_iutuqdv$art_i < $art_ccabfvm$art_c; $art_iutuqdv$art_i++) {    var item = selected[$art_iutuqdv$art_i]%>';
    for (var $art_iutuqdv$art_i = 0, $art_ccabfvm$art_c = selected.length; $art_iutuqdv$art_i < $art_ccabfvm$art_c; $art_iutuqdv$art_i++) {
        var item = selected[$art_iutuqdv$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
