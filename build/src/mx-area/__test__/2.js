...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqfifg$art_i = 0, $art_cngejkafd$art_c = selected.length; $art_iqfifg$art_i < $art_cngejkafd$art_c; $art_iqfifg$art_i++) {    var item = selected[$art_iqfifg$art_i]%>';
    for (var $art_iqfifg$art_i = 0, $art_cngejkafd$art_c = selected.length; $art_iqfifg$art_i < $art_cngejkafd$art_c; $art_iqfifg$art_i++) {
        var item = selected[$art_iqfifg$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
