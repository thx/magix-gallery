...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iijrdkge$art_i = 0, $art_cygxyhidu$art_c = selected.length; $art_iijrdkge$art_i < $art_cygxyhidu$art_c; $art_iijrdkge$art_i++) {    var item = selected[$art_iijrdkge$art_i]%>';
    for (var $art_iijrdkge$art_i = 0, $art_cygxyhidu$art_c = selected.length; $art_iijrdkge$art_i < $art_cygxyhidu$art_c; $art_iijrdkge$art_i++) {
        var item = selected[$art_iijrdkge$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
