...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijzxvoifr$art_i = 0, $art_cffzzdttkld$art_c = selected.length; $art_ijzxvoifr$art_i < $art_cffzzdttkld$art_c; $art_ijzxvoifr$art_i++) {    var item = selected[$art_ijzxvoifr$art_i]%>';
    for (var $art_ijzxvoifr$art_i = 0, $art_cffzzdttkld$art_c = selected.length; $art_ijzxvoifr$art_i < $art_cffzzdttkld$art_c; $art_ijzxvoifr$art_i++) {
        var item = selected[$art_ijzxvoifr$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
