...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imfklixmgxd$art_i = 0, $art_cmwjmvic$art_c = selected.length; $art_imfklixmgxd$art_i < $art_cmwjmvic$art_c; $art_imfklixmgxd$art_i++) {    var item = selected[$art_imfklixmgxd$art_i]%>';
    for (var $art_imfklixmgxd$art_i = 0, $art_cmwjmvic$art_c = selected.length; $art_imfklixmgxd$art_i < $art_cmwjmvic$art_c; $art_imfklixmgxd$art_i++) {
        var item = selected[$art_imfklixmgxd$art_i];
        $p += '<div>';
        $line = 21;
        $art = '=item';
        ;
