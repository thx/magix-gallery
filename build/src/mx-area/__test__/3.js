...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iahjyvlj$art_i = 0, $art_csjvyfgqx$art_c = arrs.length; $art_iahjyvlj$art_i < $art_csjvyfgqx$art_c; $art_iahjyvlj$art_i++) {    var item = arrs[$art_iahjyvlj$art_i]%>';
    for (var $art_iahjyvlj$art_i = 0, $art_csjvyfgqx$art_c = arrs.length; $art_iahjyvlj$art_i < $art_csjvyfgqx$art_c; $art_iahjyvlj$art_i++) {
        var item = arrs[$art_iahjyvlj$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
