...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iczxpadzwo$art_i = 0, $art_cssexlb$art_c = arrs.length; $art_iczxpadzwo$art_i < $art_cssexlb$art_c; $art_iczxpadzwo$art_i++) {    var item = arrs[$art_iczxpadzwo$art_i]%>';
    for (var $art_iczxpadzwo$art_i = 0, $art_cssexlb$art_c = arrs.length; $art_iczxpadzwo$art_i < $art_cssexlb$art_c; $art_iczxpadzwo$art_i++) {
        var item = arrs[$art_iczxpadzwo$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
