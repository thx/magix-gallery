...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iavvnxsayc$art_i = 0, $art_cijibkioi$art_c = arrs.length; $art_iavvnxsayc$art_i < $art_cijibkioi$art_c; $art_iavvnxsayc$art_i++) {    var item = arrs[$art_iavvnxsayc$art_i]%>';
    for (var $art_iavvnxsayc$art_i = 0, $art_cijibkioi$art_c = arrs.length; $art_iavvnxsayc$art_i < $art_cijibkioi$art_c; $art_iavvnxsayc$art_i++) {
        var item = arrs[$art_iavvnxsayc$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
