...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icvccwxr$art_i = 0, $art_ckdveqcrb$art_c = arrs.length; $art_icvccwxr$art_i < $art_ckdveqcrb$art_c; $art_icvccwxr$art_i++) {    var item = arrs[$art_icvccwxr$art_i]%>';
    for (var $art_icvccwxr$art_i = 0, $art_ckdveqcrb$art_c = arrs.length; $art_icvccwxr$art_i < $art_ckdveqcrb$art_c; $art_icvccwxr$art_i++) {
        var item = arrs[$art_icvccwxr$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
