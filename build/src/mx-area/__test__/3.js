...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwgncvatbfh$art_i = 0, $art_cpnjnmohwm$art_c = arrs.length; $art_iwgncvatbfh$art_i < $art_cpnjnmohwm$art_c; $art_iwgncvatbfh$art_i++) {    var item = arrs[$art_iwgncvatbfh$art_i]%>';
    for (var $art_iwgncvatbfh$art_i = 0, $art_cpnjnmohwm$art_c = arrs.length; $art_iwgncvatbfh$art_i < $art_cpnjnmohwm$art_c; $art_iwgncvatbfh$art_i++) {
        var item = arrs[$art_iwgncvatbfh$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
