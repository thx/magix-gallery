...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibaankzab$art_i = 0, $art_cmebsgtwnzi$art_c = arrs.length; $art_ibaankzab$art_i < $art_cmebsgtwnzi$art_c; $art_ibaankzab$art_i++) {    var item = arrs[$art_ibaankzab$art_i]%>';
    for (var $art_ibaankzab$art_i = 0, $art_cmebsgtwnzi$art_c = arrs.length; $art_ibaankzab$art_i < $art_cmebsgtwnzi$art_c; $art_ibaankzab$art_i++) {
        var item = arrs[$art_ibaankzab$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
