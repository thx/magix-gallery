...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idqvgpmwqvq$art_i = 0, $art_clrvdyfz$art_c = arrs.length; $art_idqvgpmwqvq$art_i < $art_clrvdyfz$art_c; $art_idqvgpmwqvq$art_i++) {    var item = arrs[$art_idqvgpmwqvq$art_i]%>';
    for (var $art_idqvgpmwqvq$art_i = 0, $art_clrvdyfz$art_c = arrs.length; $art_idqvgpmwqvq$art_i < $art_clrvdyfz$art_c; $art_idqvgpmwqvq$art_i++) {
        var item = arrs[$art_idqvgpmwqvq$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
