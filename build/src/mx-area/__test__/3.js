...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izpyfmgund$art_i = 0, $art_cqdgvgb$art_c = arrs.length; $art_izpyfmgund$art_i < $art_cqdgvgb$art_c; $art_izpyfmgund$art_i++) {    var item = arrs[$art_izpyfmgund$art_i]%>';
    for (var $art_izpyfmgund$art_i = 0, $art_cqdgvgb$art_c = arrs.length; $art_izpyfmgund$art_i < $art_cqdgvgb$art_c; $art_izpyfmgund$art_i++) {
        var item = arrs[$art_izpyfmgund$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
