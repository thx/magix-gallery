...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isabraxk$art_i = 0, $art_cppffmfg$art_c = arrs.length; $art_isabraxk$art_i < $art_cppffmfg$art_c; $art_isabraxk$art_i++) {    var item = arrs[$art_isabraxk$art_i]%>';
    for (var $art_isabraxk$art_i = 0, $art_cppffmfg$art_c = arrs.length; $art_isabraxk$art_i < $art_cppffmfg$art_c; $art_isabraxk$art_i++) {
        var item = arrs[$art_isabraxk$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
