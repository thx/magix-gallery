...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ielgfmvh$art_i = 0, $art_cwsztjf$art_c = arrs.length; $art_ielgfmvh$art_i < $art_cwsztjf$art_c; $art_ielgfmvh$art_i++) {    var item = arrs[$art_ielgfmvh$art_i]%>';
    for (var $art_ielgfmvh$art_i = 0, $art_cwsztjf$art_c = arrs.length; $art_ielgfmvh$art_i < $art_cwsztjf$art_c; $art_ielgfmvh$art_i++) {
        var item = arrs[$art_ielgfmvh$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
