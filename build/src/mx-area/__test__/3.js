...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieohluq$art_i = 0, $art_cacehcncqwi$art_c = arrs.length; $art_ieohluq$art_i < $art_cacehcncqwi$art_c; $art_ieohluq$art_i++) {    var item = arrs[$art_ieohluq$art_i]%>';
    for (var $art_ieohluq$art_i = 0, $art_cacehcncqwi$art_c = arrs.length; $art_ieohluq$art_i < $art_cacehcncqwi$art_c; $art_ieohluq$art_i++) {
        var item = arrs[$art_ieohluq$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
