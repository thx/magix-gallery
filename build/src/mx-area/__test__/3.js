...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isduzquef$art_i = 0, $art_cxacnvcp$art_c = arrs.length; $art_isduzquef$art_i < $art_cxacnvcp$art_c; $art_isduzquef$art_i++) {    var item = arrs[$art_isduzquef$art_i]%>';
    for (var $art_isduzquef$art_i = 0, $art_cxacnvcp$art_c = arrs.length; $art_isduzquef$art_i < $art_cxacnvcp$art_c; $art_isduzquef$art_i++) {
        var item = arrs[$art_isduzquef$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
