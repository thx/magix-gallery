...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iiffmmkwfg$art_i = 0, $art_ccyymqiqwql$art_c = arrs.length; $art_iiffmmkwfg$art_i < $art_ccyymqiqwql$art_c; $art_iiffmmkwfg$art_i++) {    var item = arrs[$art_iiffmmkwfg$art_i]%>';
    for (var $art_iiffmmkwfg$art_i = 0, $art_ccyymqiqwql$art_c = arrs.length; $art_iiffmmkwfg$art_i < $art_ccyymqiqwql$art_c; $art_iiffmmkwfg$art_i++) {
        var item = arrs[$art_iiffmmkwfg$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
    ...
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_galleryV:g" class="clearfix"><div mxa="_zs_galleryV:h" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryV:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
