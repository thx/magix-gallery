...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyedipionv$art_i = 0, $art_cctzyltqrc$art_c = arrs.length; $art_iyedipionv$art_i < $art_cctzyltqrc$art_c; $art_iyedipionv$art_i++) {    var item = arrs[$art_iyedipionv$art_i]%>';
    for (var $art_iyedipionv$art_i = 0, $art_cctzyltqrc$art_c = arrs.length; $art_iyedipionv$art_i < $art_cctzyltqrc$art_c; $art_iyedipionv$art_i++) {
        var item = arrs[$art_iyedipionv$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
