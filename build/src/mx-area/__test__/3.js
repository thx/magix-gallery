...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwjvtihu$art_i = 0, $art_cmbctla$art_c = arrs.length; $art_iwjvtihu$art_i < $art_cmbctla$art_c; $art_iwjvtihu$art_i++) {    var item = arrs[$art_iwjvtihu$art_i]%>';
    for (var $art_iwjvtihu$art_i = 0, $art_cmbctla$art_c = arrs.length; $art_iwjvtihu$art_i < $art_cmbctla$art_c; $art_iwjvtihu$art_i++) {
        var item = arrs[$art_iwjvtihu$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
