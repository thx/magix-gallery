...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyqznf$art_i = 0, $art_covcgtuxfl$art_c = arrs.length; $art_iyqznf$art_i < $art_covcgtuxfl$art_c; $art_iyqznf$art_i++) {    var item = arrs[$art_iyqznf$art_i]%>';
    for (var $art_iyqznf$art_i = 0, $art_covcgtuxfl$art_c = arrs.length; $art_iyqznf$art_i < $art_covcgtuxfl$art_c; $art_iyqznf$art_i++) {
        var item = arrs[$art_iyqznf$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
