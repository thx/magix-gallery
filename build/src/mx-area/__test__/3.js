...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irpiyoxkti$art_i = 0, $art_cocetkrckk$art_c = arrs.length; $art_irpiyoxkti$art_i < $art_cocetkrckk$art_c; $art_irpiyoxkti$art_i++) {    var item = arrs[$art_irpiyoxkti$art_i]%>';
    for (var $art_irpiyoxkti$art_i = 0, $art_cocetkrckk$art_c = arrs.length; $art_irpiyoxkti$art_i < $art_cocetkrckk$art_c; $art_irpiyoxkti$art_i++) {
        var item = arrs[$art_irpiyoxkti$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
