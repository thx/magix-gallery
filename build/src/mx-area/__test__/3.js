...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ietbyhocpe$art_i = 0, $art_cjbhspnkeul$art_c = arrs.length; $art_ietbyhocpe$art_i < $art_cjbhspnkeul$art_c; $art_ietbyhocpe$art_i++) {    var item = arrs[$art_ietbyhocpe$art_i]%>';
    for (var $art_ietbyhocpe$art_i = 0, $art_cjbhspnkeul$art_c = arrs.length; $art_ietbyhocpe$art_i < $art_cjbhspnkeul$art_c; $art_ietbyhocpe$art_i++) {
        var item = arrs[$art_ietbyhocpe$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
