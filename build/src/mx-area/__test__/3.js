...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwyaopuhl$art_i = 0, $art_ckswumrzi$art_c = arrs.length; $art_iwyaopuhl$art_i < $art_ckswumrzi$art_c; $art_iwyaopuhl$art_i++) {    var item = arrs[$art_iwyaopuhl$art_i]%>';
    for (var $art_iwyaopuhl$art_i = 0, $art_ckswumrzi$art_c = arrs.length; $art_iwyaopuhl$art_i < $art_ckswumrzi$art_c; $art_iwyaopuhl$art_i++) {
        var item = arrs[$art_iwyaopuhl$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
