...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iznrel$art_i = 0, $art_cpxiysdygtq$art_c = arrs.length; $art_iznrel$art_i < $art_cpxiysdygtq$art_c; $art_iznrel$art_i++) {    var item = arrs[$art_iznrel$art_i]%>';
    for (var $art_iznrel$art_i = 0, $art_cpxiysdygtq$art_c = arrs.length; $art_iznrel$art_i < $art_cpxiysdygtq$art_c; $art_iznrel$art_i++) {
        var item = arrs[$art_iznrel$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
