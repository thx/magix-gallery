...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_iveeklqnus$art_i=0;$art_iveeklqnus$art_i<arrs.length;$art_iveeklqnus$art_i++){var item=arrs[$art_iveeklqnus$art_i]%>';
    for (var $art_iveeklqnus$art_i = 0; $art_iveeklqnus$art_i < arrs.length; $art_iveeklqnus$art_i++) {
        var item = arrs[$art_iveeklqnus$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
