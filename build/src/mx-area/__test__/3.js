...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isloyjoem$art_i = 0, $art_ckditmgk$art_c = arrs.length; $art_isloyjoem$art_i < $art_ckditmgk$art_c; $art_isloyjoem$art_i++) {    var item = arrs[$art_isloyjoem$art_i]%>';
    for (var $art_isloyjoem$art_i = 0, $art_ckditmgk$art_c = arrs.length; $art_isloyjoem$art_i < $art_ckditmgk$art_c; $art_isloyjoem$art_i++) {
        var item = arrs[$art_isloyjoem$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
