...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifzjjnwen$art_i = 0, $art_cpjuwp$art_c = arrs.length; $art_ifzjjnwen$art_i < $art_cpjuwp$art_c; $art_ifzjjnwen$art_i++) {    var item = arrs[$art_ifzjjnwen$art_i]%>';
    for (var $art_ifzjjnwen$art_i = 0, $art_cpjuwp$art_c = arrs.length; $art_ifzjjnwen$art_i < $art_cpjuwp$art_c; $art_ifzjjnwen$art_i++) {
        var item = arrs[$art_ifzjjnwen$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
