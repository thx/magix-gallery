...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwjwnhps$art_i = 0, $art_cvftmul$art_c = arrs.length; $art_iwjwnhps$art_i < $art_cvftmul$art_c; $art_iwjwnhps$art_i++) {    var item = arrs[$art_iwjwnhps$art_i]%>';
    for (var $art_iwjwnhps$art_i = 0, $art_cvftmul$art_c = arrs.length; $art_iwjwnhps$art_i < $art_cvftmul$art_c; $art_iwjwnhps$art_i++) {
        var item = arrs[$art_iwjwnhps$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
