...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_issxqfd$art_i = 0, $art_cjstsyslrvl$art_c = arrs.length; $art_issxqfd$art_i < $art_cjstsyslrvl$art_c; $art_issxqfd$art_i++) {    var item = arrs[$art_issxqfd$art_i]%>';
    for (var $art_issxqfd$art_i = 0, $art_cjstsyslrvl$art_c = arrs.length; $art_issxqfd$art_i < $art_cjstsyslrvl$art_c; $art_issxqfd$art_i++) {
        var item = arrs[$art_issxqfd$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
