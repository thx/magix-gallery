...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijcpazid$art_i = 0, $art_cropai$art_c = arrs.length; $art_ijcpazid$art_i < $art_cropai$art_c; $art_ijcpazid$art_i++) {    var item = arrs[$art_ijcpazid$art_i]%>';
    for (var $art_ijcpazid$art_i = 0, $art_cropai$art_c = arrs.length; $art_ijcpazid$art_i < $art_cropai$art_c; $art_ijcpazid$art_i++) {
        var item = arrs[$art_ijcpazid$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
