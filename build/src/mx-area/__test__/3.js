...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ictzbchnn$art_i = 0, $art_crrjy$art_c = arrs.length; $art_ictzbchnn$art_i < $art_crrjy$art_c; $art_ictzbchnn$art_i++) {    var item = arrs[$art_ictzbchnn$art_i]%>';
    for (var $art_ictzbchnn$art_i = 0, $art_crrjy$art_c = arrs.length; $art_ictzbchnn$art_i < $art_crrjy$art_c; $art_ictzbchnn$art_i++) {
        var item = arrs[$art_ictzbchnn$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
