...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijldnhuwtfh$art_i = 0, $art_cssougwf$art_c = arrs.length; $art_ijldnhuwtfh$art_i < $art_cssougwf$art_c; $art_ijldnhuwtfh$art_i++) {    var item = arrs[$art_ijldnhuwtfh$art_i]%>';
    for (var $art_ijldnhuwtfh$art_i = 0, $art_cssougwf$art_c = arrs.length; $art_ijldnhuwtfh$art_i < $art_cssougwf$art_c; $art_ijldnhuwtfh$art_i++) {
        var item = arrs[$art_ijldnhuwtfh$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
