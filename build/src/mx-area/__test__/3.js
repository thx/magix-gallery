...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ighgjeody$art_i = 0, $art_cquwmbalp$art_c = arrs.length; $art_ighgjeody$art_i < $art_cquwmbalp$art_c; $art_ighgjeody$art_i++) {    var item = arrs[$art_ighgjeody$art_i]%>';
    for (var $art_ighgjeody$art_i = 0, $art_cquwmbalp$art_c = arrs.length; $art_ighgjeody$art_i < $art_cquwmbalp$art_c; $art_ighgjeody$art_i++) {
        var item = arrs[$art_ighgjeody$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
