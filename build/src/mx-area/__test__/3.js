...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izdfoknql$art_i = 0, $art_cfkpbh$art_c = arrs.length; $art_izdfoknql$art_i < $art_cfkpbh$art_c; $art_izdfoknql$art_i++) {    var item = arrs[$art_izdfoknql$art_i]%>';
    for (var $art_izdfoknql$art_i = 0, $art_cfkpbh$art_c = arrs.length; $art_izdfoknql$art_i < $art_cfkpbh$art_c; $art_izdfoknql$art_i++) {
        var item = arrs[$art_izdfoknql$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
