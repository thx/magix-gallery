...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imaxwqjbau$art_i = 0, $art_cektuiyrbvp$art_c = arrs.length; $art_imaxwqjbau$art_i < $art_cektuiyrbvp$art_c; $art_imaxwqjbau$art_i++) {    var item = arrs[$art_imaxwqjbau$art_i]%>';
    for (var $art_imaxwqjbau$art_i = 0, $art_cektuiyrbvp$art_c = arrs.length; $art_imaxwqjbau$art_i < $art_cektuiyrbvp$art_c; $art_imaxwqjbau$art_i++) {
        var item = arrs[$art_imaxwqjbau$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
