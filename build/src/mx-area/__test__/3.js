...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idbwlg$art_i = 0, $art_cuwoopgb$art_c = arrs.length; $art_idbwlg$art_i < $art_cuwoopgb$art_c; $art_idbwlg$art_i++) {    var item = arrs[$art_idbwlg$art_i]%>';
    for (var $art_idbwlg$art_i = 0, $art_cuwoopgb$art_c = arrs.length; $art_idbwlg$art_i < $art_cuwoopgb$art_c; $art_idbwlg$art_i++) {
        var item = arrs[$art_idbwlg$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
