...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijdfcddbkvp$art_i = 0, $art_cvfdydtkvaq$art_c = arrs.length; $art_ijdfcddbkvp$art_i < $art_cvfdydtkvaq$art_c; $art_ijdfcddbkvp$art_i++) {    var item = arrs[$art_ijdfcddbkvp$art_i]%>';
    for (var $art_ijdfcddbkvp$art_i = 0, $art_cvfdydtkvaq$art_c = arrs.length; $art_ijdfcddbkvp$art_i < $art_cvfdydtkvaq$art_c; $art_ijdfcddbkvp$art_i++) {
        var item = arrs[$art_ijdfcddbkvp$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
