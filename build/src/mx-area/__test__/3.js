...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iglzsztb$art_i = 0, $art_ckmpogfwnw$art_c = arrs.length; $art_iglzsztb$art_i < $art_ckmpogfwnw$art_c; $art_iglzsztb$art_i++) {    var item = arrs[$art_iglzsztb$art_i]%>';
    for (var $art_iglzsztb$art_i = 0, $art_ckmpogfwnw$art_c = arrs.length; $art_iglzsztb$art_i < $art_ckmpogfwnw$art_c; $art_iglzsztb$art_i++) {
        var item = arrs[$art_iglzsztb$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
