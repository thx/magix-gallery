...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikidmowna$art_i = 0, $art_cocmrtss$art_c = arrs.length; $art_ikidmowna$art_i < $art_cocmrtss$art_c; $art_ikidmowna$art_i++) {    var item = arrs[$art_ikidmowna$art_i]%>';
    for (var $art_ikidmowna$art_i = 0, $art_cocmrtss$art_c = arrs.length; $art_ikidmowna$art_i < $art_cocmrtss$art_c; $art_ikidmowna$art_i++) {
        var item = arrs[$art_ikidmowna$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
