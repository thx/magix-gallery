...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivdxtbrwbs$art_i = 0, $art_ccsvfvog$art_c = arrs.length; $art_ivdxtbrwbs$art_i < $art_ccsvfvog$art_c; $art_ivdxtbrwbs$art_i++) {    var item = arrs[$art_ivdxtbrwbs$art_i]%>';
    for (var $art_ivdxtbrwbs$art_i = 0, $art_ccsvfvog$art_c = arrs.length; $art_ivdxtbrwbs$art_i < $art_ccsvfvog$art_c; $art_ivdxtbrwbs$art_i++) {
        var item = arrs[$art_ivdxtbrwbs$art_i];
        $p += '<div>';
        $line = 26;
        $art = '=item.name';
        ;
