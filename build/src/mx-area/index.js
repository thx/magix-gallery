...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_czmckwu$art_c = types.length; typeIndex < $art_czmckwu$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_czmckwu$art_c = types.length; typeIndex < $art_czmckwu$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cifzzsu$art_c = types.length; typeIndex < $art_cifzzsu$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cifzzsu$art_c = types.length; typeIndex < $art_cifzzsu$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objfilnkvpn$art_obj = type.groups, $art_cghqgng$art_c = $art_objfilnkvpn$art_obj.length; groupIndex < $art_cghqgng$art_c; groupIndex++) {        var group = $art_objfilnkvpn$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objfilnkvpn$art_obj = type.groups, $art_cghqgng$art_c = $art_objfilnkvpn$art_obj.length; groupIndex < $art_cghqgng$art_c; groupIndex++) {
            var group = $art_objfilnkvpn$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_crqgdbcozx$art_c = group.length; areaIndex < $art_crqgdbcozx$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_crqgdbcozx$art_c = group.length; areaIndex < $art_crqgdbcozx$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_igqroeva$art_i = 0, $art_objfvcyrgv$art_obj = area.provinces, $art_cuhepzpwtcr$art_c = $art_objfvcyrgv$art_obj.length; $art_igqroeva$art_i < $art_cuhepzpwtcr$art_c; $art_igqroeva$art_i++) {                var province = $art_objfvcyrgv$art_obj[$art_igqroeva$art_i]%>';
                for (var $art_igqroeva$art_i = 0, $art_objfvcyrgv$art_obj = area.provinces, $art_cuhepzpwtcr$art_c = $art_objfvcyrgv$art_obj.length; $art_igqroeva$art_i < $art_cuhepzpwtcr$art_c; $art_igqroeva$art_i++) {
                    var province = $art_objfvcyrgv$art_obj[$art_igqroeva$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imhbyrqij$art_i = 0, $art_objwogyrtj$art_obj = province.cities, $art_crnbezfmms$art_c = $art_objwogyrtj$art_obj.length; $art_imhbyrqij$art_i < $art_crnbezfmms$art_c; $art_imhbyrqij$art_i++) {                    var city = $art_objwogyrtj$art_obj[$art_imhbyrqij$art_i]%>';
                    for (var $art_imhbyrqij$art_i = 0, $art_objwogyrtj$art_obj = province.cities, $art_crnbezfmms$art_c = $art_objwogyrtj$art_obj.length; $art_imhbyrqij$art_i < $art_crnbezfmms$art_c; $art_imhbyrqij$art_i++) {
                        var city = $art_objwogyrtj$art_obj[$art_imhbyrqij$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
