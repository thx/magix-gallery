...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ccfoozp$art_c = types.length; typeIndex < $art_ccfoozp$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ccfoozp$art_c = types.length; typeIndex < $art_ccfoozp$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cemsgucrl$art_c = types.length; typeIndex < $art_cemsgucrl$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cemsgucrl$art_c = types.length; typeIndex < $art_cemsgucrl$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objnsscql$art_obj = type.groups, $art_cchwxubfli$art_c = $art_objnsscql$art_obj.length; groupIndex < $art_cchwxubfli$art_c; groupIndex++) {        var group = $art_objnsscql$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objnsscql$art_obj = type.groups, $art_cchwxubfli$art_c = $art_objnsscql$art_obj.length; groupIndex < $art_cchwxubfli$art_c; groupIndex++) {
            var group = $art_objnsscql$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cymnbpnqd$art_c = group.length; areaIndex < $art_cymnbpnqd$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cymnbpnqd$art_c = group.length; areaIndex < $art_cymnbpnqd$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_itxvjpjgxe$art_i = 0, $art_objrsswsa$art_obj = area.provinces, $art_ciomqy$art_c = $art_objrsswsa$art_obj.length; $art_itxvjpjgxe$art_i < $art_ciomqy$art_c; $art_itxvjpjgxe$art_i++) {                var province = $art_objrsswsa$art_obj[$art_itxvjpjgxe$art_i]%>';
                for (var $art_itxvjpjgxe$art_i = 0, $art_objrsswsa$art_obj = area.provinces, $art_ciomqy$art_c = $art_objrsswsa$art_obj.length; $art_itxvjpjgxe$art_i < $art_ciomqy$art_c; $art_itxvjpjgxe$art_i++) {
                    var province = $art_objrsswsa$art_obj[$art_itxvjpjgxe$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_infiblvxy$art_i = 0, $art_objkbswwtd$art_obj = province.cities, $art_csupmxfebp$art_c = $art_objkbswwtd$art_obj.length; $art_infiblvxy$art_i < $art_csupmxfebp$art_c; $art_infiblvxy$art_i++) {                    var city = $art_objkbswwtd$art_obj[$art_infiblvxy$art_i]%>';
                    for (var $art_infiblvxy$art_i = 0, $art_objkbswwtd$art_obj = province.cities, $art_csupmxfebp$art_c = $art_objkbswwtd$art_obj.length; $art_infiblvxy$art_i < $art_csupmxfebp$art_c; $art_infiblvxy$art_i++) {
                        var city = $art_objkbswwtd$art_obj[$art_infiblvxy$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
