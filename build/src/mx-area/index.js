...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cecejrqru$art_c = types.length; typeIndex < $art_cecejrqru$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cecejrqru$art_c = types.length; typeIndex < $art_cecejrqru$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_crtpxpzu$art_c = types.length; typeIndex < $art_crtpxpzu$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_crtpxpzu$art_c = types.length; typeIndex < $art_crtpxpzu$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objgeevjdz$art_obj = type.groups, $art_cggadztb$art_c = $art_objgeevjdz$art_obj.length; groupIndex < $art_cggadztb$art_c; groupIndex++) {        var group = $art_objgeevjdz$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objgeevjdz$art_obj = type.groups, $art_cggadztb$art_c = $art_objgeevjdz$art_obj.length; groupIndex < $art_cggadztb$art_c; groupIndex++) {
            var group = $art_objgeevjdz$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ckkmhsoje$art_c = group.length; areaIndex < $art_ckkmhsoje$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ckkmhsoje$art_c = group.length; areaIndex < $art_ckkmhsoje$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilcwkahxnh$art_i = 0, $art_objcroyap$art_obj = area.provinces, $art_cnijmxjfj$art_c = $art_objcroyap$art_obj.length; $art_ilcwkahxnh$art_i < $art_cnijmxjfj$art_c; $art_ilcwkahxnh$art_i++) {                var province = $art_objcroyap$art_obj[$art_ilcwkahxnh$art_i]%>';
                for (var $art_ilcwkahxnh$art_i = 0, $art_objcroyap$art_obj = area.provinces, $art_cnijmxjfj$art_c = $art_objcroyap$art_obj.length; $art_ilcwkahxnh$art_i < $art_cnijmxjfj$art_c; $art_ilcwkahxnh$art_i++) {
                    var province = $art_objcroyap$art_obj[$art_ilcwkahxnh$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_idgnwy$art_i = 0, $art_objkdalpqe$art_obj = province.cities, $art_cwdwtds$art_c = $art_objkdalpqe$art_obj.length; $art_idgnwy$art_i < $art_cwdwtds$art_c; $art_idgnwy$art_i++) {                    var city = $art_objkdalpqe$art_obj[$art_idgnwy$art_i]%>';
                    for (var $art_idgnwy$art_i = 0, $art_objkdalpqe$art_obj = province.cities, $art_cwdwtds$art_c = $art_objkdalpqe$art_obj.length; $art_idgnwy$art_i < $art_cwdwtds$art_c; $art_idgnwy$art_i++) {
                        var city = $art_objkdalpqe$art_obj[$art_idgnwy$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
