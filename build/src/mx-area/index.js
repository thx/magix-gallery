...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cmspeaqgjy$art_c = types.length; typeIndex < $art_cmspeaqgjy$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cmspeaqgjy$art_c = types.length; typeIndex < $art_cmspeaqgjy$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ctthmfioh$art_c = types.length; typeIndex < $art_ctthmfioh$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ctthmfioh$art_c = types.length; typeIndex < $art_ctthmfioh$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objfbhciai$art_obj = type.groups, $art_cgcvlmocu$art_c = $art_objfbhciai$art_obj.length; groupIndex < $art_cgcvlmocu$art_c; groupIndex++) {        var group = $art_objfbhciai$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objfbhciai$art_obj = type.groups, $art_cgcvlmocu$art_c = $art_objfbhciai$art_obj.length; groupIndex < $art_cgcvlmocu$art_c; groupIndex++) {
            var group = $art_objfbhciai$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjriwqjp$art_c = group.length; areaIndex < $art_cjriwqjp$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjriwqjp$art_c = group.length; areaIndex < $art_cjriwqjp$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ifvfynbnl$art_i = 0, $art_objnqzfovafi$art_obj = area.provinces, $art_cpwltimswyqr$art_c = $art_objnqzfovafi$art_obj.length; $art_ifvfynbnl$art_i < $art_cpwltimswyqr$art_c; $art_ifvfynbnl$art_i++) {                var province = $art_objnqzfovafi$art_obj[$art_ifvfynbnl$art_i]%>';
                for (var $art_ifvfynbnl$art_i = 0, $art_objnqzfovafi$art_obj = area.provinces, $art_cpwltimswyqr$art_c = $art_objnqzfovafi$art_obj.length; $art_ifvfynbnl$art_i < $art_cpwltimswyqr$art_c; $art_ifvfynbnl$art_i++) {
                    var province = $art_objnqzfovafi$art_obj[$art_ifvfynbnl$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iigtngry$art_i = 0, $art_objrkbmenf$art_obj = province.cities, $art_cdkadxxtm$art_c = $art_objrkbmenf$art_obj.length; $art_iigtngry$art_i < $art_cdkadxxtm$art_c; $art_iigtngry$art_i++) {                    var city = $art_objrkbmenf$art_obj[$art_iigtngry$art_i]%>';
                    for (var $art_iigtngry$art_i = 0, $art_objrkbmenf$art_obj = province.cities, $art_cdkadxxtm$art_c = $art_objrkbmenf$art_obj.length; $art_iigtngry$art_i < $art_cdkadxxtm$art_c; $art_iigtngry$art_i++) {
                        var city = $art_objrkbmenf$art_obj[$art_iigtngry$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
