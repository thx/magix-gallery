...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cweiukkmj$art_c = types.length; typeIndex < $art_cweiukkmj$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cweiukkmj$art_c = types.length; typeIndex < $art_cweiukkmj$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cdisplpsmc$art_c = types.length; typeIndex < $art_cdisplpsmc$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cdisplpsmc$art_c = types.length; typeIndex < $art_cdisplpsmc$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objenkyciiqba$art_obj = type.groups, $art_cwivwcgwkk$art_c = $art_objenkyciiqba$art_obj.length; groupIndex < $art_cwivwcgwkk$art_c; groupIndex++) {        var group = $art_objenkyciiqba$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objenkyciiqba$art_obj = type.groups, $art_cwivwcgwkk$art_c = $art_objenkyciiqba$art_obj.length; groupIndex < $art_cwivwcgwkk$art_c; groupIndex++) {
            var group = $art_objenkyciiqba$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cyubouym$art_c = group.length; areaIndex < $art_cyubouym$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cyubouym$art_c = group.length; areaIndex < $art_cyubouym$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ieaedwwed$art_i = 0, $art_objstqqonq$art_obj = area.provinces, $art_clmbzzmol$art_c = $art_objstqqonq$art_obj.length; $art_ieaedwwed$art_i < $art_clmbzzmol$art_c; $art_ieaedwwed$art_i++) {                var province = $art_objstqqonq$art_obj[$art_ieaedwwed$art_i]%>';
                for (var $art_ieaedwwed$art_i = 0, $art_objstqqonq$art_obj = area.provinces, $art_clmbzzmol$art_c = $art_objstqqonq$art_obj.length; $art_ieaedwwed$art_i < $art_clmbzzmol$art_c; $art_ieaedwwed$art_i++) {
                    var province = $art_objstqqonq$art_obj[$art_ieaedwwed$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iqrrxdjji$art_i = 0, $art_objuczeeogco$art_obj = province.cities, $art_cftuvczvyr$art_c = $art_objuczeeogco$art_obj.length; $art_iqrrxdjji$art_i < $art_cftuvczvyr$art_c; $art_iqrrxdjji$art_i++) {                    var city = $art_objuczeeogco$art_obj[$art_iqrrxdjji$art_i]%>';
                    for (var $art_iqrrxdjji$art_i = 0, $art_objuczeeogco$art_obj = province.cities, $art_cftuvczvyr$art_c = $art_objuczeeogco$art_obj.length; $art_iqrrxdjji$art_i < $art_cftuvczvyr$art_c; $art_iqrrxdjji$art_i++) {
                        var city = $art_objuczeeogco$art_obj[$art_iqrrxdjji$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
