...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_canqohzows$art_c = types.length; typeIndex < $art_canqohzows$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_canqohzows$art_c = types.length; typeIndex < $art_canqohzows$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cpwmnmnnv$art_c = types.length; typeIndex < $art_cpwmnmnnv$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cpwmnmnnv$art_c = types.length; typeIndex < $art_cpwmnmnnv$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objrckzoewl$art_obj = type.groups, $art_chjqidzrnm$art_c = $art_objrckzoewl$art_obj.length; groupIndex < $art_chjqidzrnm$art_c; groupIndex++) {        var group = $art_objrckzoewl$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objrckzoewl$art_obj = type.groups, $art_chjqidzrnm$art_c = $art_objrckzoewl$art_obj.length; groupIndex < $art_chjqidzrnm$art_c; groupIndex++) {
            var group = $art_objrckzoewl$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cbwyyxdjlag$art_c = group.length; areaIndex < $art_cbwyyxdjlag$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cbwyyxdjlag$art_c = group.length; areaIndex < $art_cbwyyxdjlag$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ijhvfqqamh$art_i = 0, $art_objrfuafsgqfb$art_obj = area.provinces, $art_crefwfhh$art_c = $art_objrfuafsgqfb$art_obj.length; $art_ijhvfqqamh$art_i < $art_crefwfhh$art_c; $art_ijhvfqqamh$art_i++) {                var province = $art_objrfuafsgqfb$art_obj[$art_ijhvfqqamh$art_i]%>';
                for (var $art_ijhvfqqamh$art_i = 0, $art_objrfuafsgqfb$art_obj = area.provinces, $art_crefwfhh$art_c = $art_objrfuafsgqfb$art_obj.length; $art_ijhvfqqamh$art_i < $art_crefwfhh$art_c; $art_ijhvfqqamh$art_i++) {
                    var province = $art_objrfuafsgqfb$art_obj[$art_ijhvfqqamh$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ipggdzgpvck$art_i = 0, $art_objzbkvkitd$art_obj = province.cities, $art_ctxtywkyad$art_c = $art_objzbkvkitd$art_obj.length; $art_ipggdzgpvck$art_i < $art_ctxtywkyad$art_c; $art_ipggdzgpvck$art_i++) {                    var city = $art_objzbkvkitd$art_obj[$art_ipggdzgpvck$art_i]%>';
                    for (var $art_ipggdzgpvck$art_i = 0, $art_objzbkvkitd$art_obj = province.cities, $art_ctxtywkyad$art_c = $art_objzbkvkitd$art_obj.length; $art_ipggdzgpvck$art_i < $art_ctxtywkyad$art_c; $art_ipggdzgpvck$art_i++) {
                        var city = $art_objzbkvkitd$art_obj[$art_ipggdzgpvck$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
