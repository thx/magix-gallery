...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cgqqarezmw$art_c = types.length; typeIndex < $art_cgqqarezmw$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cgqqarezmw$art_c = types.length; typeIndex < $art_cgqqarezmw$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cyylghsjlfh$art_c = types.length; typeIndex < $art_cyylghsjlfh$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cyylghsjlfh$art_c = types.length; typeIndex < $art_cyylghsjlfh$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objgfezic$art_obj = type.groups, $art_cbihgjgqldl$art_c = $art_objgfezic$art_obj.length; groupIndex < $art_cbihgjgqldl$art_c; groupIndex++) {        var group = $art_objgfezic$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objgfezic$art_obj = type.groups, $art_cbihgjgqldl$art_c = $art_objgfezic$art_obj.length; groupIndex < $art_cbihgjgqldl$art_c; groupIndex++) {
            var group = $art_objgfezic$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cesjyvgpg$art_c = group.length; areaIndex < $art_cesjyvgpg$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cesjyvgpg$art_c = group.length; areaIndex < $art_cesjyvgpg$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilpuvyt$art_i = 0, $art_objckaquwluba$art_obj = area.provinces, $art_cyjmwnlon$art_c = $art_objckaquwluba$art_obj.length; $art_ilpuvyt$art_i < $art_cyjmwnlon$art_c; $art_ilpuvyt$art_i++) {                var province = $art_objckaquwluba$art_obj[$art_ilpuvyt$art_i]%>';
                for (var $art_ilpuvyt$art_i = 0, $art_objckaquwluba$art_obj = area.provinces, $art_cyjmwnlon$art_c = $art_objckaquwluba$art_obj.length; $art_ilpuvyt$art_i < $art_cyjmwnlon$art_c; $art_ilpuvyt$art_i++) {
                    var province = $art_objckaquwluba$art_obj[$art_ilpuvyt$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iadxknhsulp$art_i = 0, $art_objfcgnsia$art_obj = province.cities, $art_cutfkmbq$art_c = $art_objfcgnsia$art_obj.length; $art_iadxknhsulp$art_i < $art_cutfkmbq$art_c; $art_iadxknhsulp$art_i++) {                    var city = $art_objfcgnsia$art_obj[$art_iadxknhsulp$art_i]%>';
                    for (var $art_iadxknhsulp$art_i = 0, $art_objfcgnsia$art_obj = province.cities, $art_cutfkmbq$art_c = $art_objfcgnsia$art_obj.length; $art_iadxknhsulp$art_i < $art_cutfkmbq$art_c; $art_iadxknhsulp$art_i++) {
                        var city = $art_objfcgnsia$art_obj[$art_iadxknhsulp$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
