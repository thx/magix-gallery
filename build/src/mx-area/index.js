...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbzicctyg$art_c = types.length; typeIndex < $art_cbzicctyg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbzicctyg$art_c = types.length; typeIndex < $art_cbzicctyg$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cwszzecgwr$art_c = types.length; typeIndex < $art_cwszzecgwr$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cwszzecgwr$art_c = types.length; typeIndex < $art_cwszzecgwr$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objzizxskudc$art_obj = type.groups, $art_ckdqhsgunx$art_c = $art_objzizxskudc$art_obj.length; groupIndex < $art_ckdqhsgunx$art_c; groupIndex++) {        var group = $art_objzizxskudc$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objzizxskudc$art_obj = type.groups, $art_ckdqhsgunx$art_c = $art_objzizxskudc$art_obj.length; groupIndex < $art_ckdqhsgunx$art_c; groupIndex++) {
            var group = $art_objzizxskudc$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cbqvsk$art_c = group.length; areaIndex < $art_cbqvsk$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cbqvsk$art_c = group.length; areaIndex < $art_cbqvsk$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_icftuhviq$art_i = 0, $art_objrodmbbnoi$art_obj = area.provinces, $art_cfjdnybxri$art_c = $art_objrodmbbnoi$art_obj.length; $art_icftuhviq$art_i < $art_cfjdnybxri$art_c; $art_icftuhviq$art_i++) {                var province = $art_objrodmbbnoi$art_obj[$art_icftuhviq$art_i]%>';
                for (var $art_icftuhviq$art_i = 0, $art_objrodmbbnoi$art_obj = area.provinces, $art_cfjdnybxri$art_c = $art_objrodmbbnoi$art_obj.length; $art_icftuhviq$art_i < $art_cfjdnybxri$art_c; $art_icftuhviq$art_i++) {
                    var province = $art_objrodmbbnoi$art_obj[$art_icftuhviq$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ivnkglpp$art_i = 0, $art_objgbdyyrjqhr$art_obj = province.cities, $art_csjbncvs$art_c = $art_objgbdyyrjqhr$art_obj.length; $art_ivnkglpp$art_i < $art_csjbncvs$art_c; $art_ivnkglpp$art_i++) {                    var city = $art_objgbdyyrjqhr$art_obj[$art_ivnkglpp$art_i]%>';
                    for (var $art_ivnkglpp$art_i = 0, $art_objgbdyyrjqhr$art_obj = province.cities, $art_csjbncvs$art_c = $art_objgbdyyrjqhr$art_obj.length; $art_ivnkglpp$art_i < $art_csjbncvs$art_c; $art_ivnkglpp$art_i++) {
                        var city = $art_objgbdyyrjqhr$art_obj[$art_ivnkglpp$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
