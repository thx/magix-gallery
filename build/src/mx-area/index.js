...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cooepb$art_c = types.length; typeIndex < $art_cooepb$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cooepb$art_c = types.length; typeIndex < $art_cooepb$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cmhdpmne$art_c = types.length; typeIndex < $art_cmhdpmne$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cmhdpmne$art_c = types.length; typeIndex < $art_cmhdpmne$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objbptkgzt$art_obj = type.groups, $art_cptrbww$art_c = $art_objbptkgzt$art_obj.length; groupIndex < $art_cptrbww$art_c; groupIndex++) {        var group = $art_objbptkgzt$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objbptkgzt$art_obj = type.groups, $art_cptrbww$art_c = $art_objbptkgzt$art_obj.length; groupIndex < $art_cptrbww$art_c; groupIndex++) {
            var group = $art_objbptkgzt$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cmeveamtla$art_c = group.length; areaIndex < $art_cmeveamtla$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cmeveamtla$art_c = group.length; areaIndex < $art_cmeveamtla$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iupbczrce$art_i = 0, $art_objueluu$art_obj = area.provinces, $art_cdxqnwnwr$art_c = $art_objueluu$art_obj.length; $art_iupbczrce$art_i < $art_cdxqnwnwr$art_c; $art_iupbczrce$art_i++) {                var province = $art_objueluu$art_obj[$art_iupbczrce$art_i]%>';
                for (var $art_iupbczrce$art_i = 0, $art_objueluu$art_obj = area.provinces, $art_cdxqnwnwr$art_c = $art_objueluu$art_obj.length; $art_iupbczrce$art_i < $art_cdxqnwnwr$art_c; $art_iupbczrce$art_i++) {
                    var province = $art_objueluu$art_obj[$art_iupbczrce$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imdmilmf$art_i = 0, $art_objxyddemxis$art_obj = province.cities, $art_cndzwetk$art_c = $art_objxyddemxis$art_obj.length; $art_imdmilmf$art_i < $art_cndzwetk$art_c; $art_imdmilmf$art_i++) {                    var city = $art_objxyddemxis$art_obj[$art_imdmilmf$art_i]%>';
                    for (var $art_imdmilmf$art_i = 0, $art_objxyddemxis$art_obj = province.cities, $art_cndzwetk$art_c = $art_objxyddemxis$art_obj.length; $art_imdmilmf$art_i < $art_cndzwetk$art_c; $art_imdmilmf$art_i++) {
                        var city = $art_objxyddemxis$art_obj[$art_imdmilmf$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
