...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cdtmaz$art_c = types.length; typeIndex < $art_cdtmaz$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cdtmaz$art_c = types.length; typeIndex < $art_cdtmaz$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cnhfrfiqi$art_c = types.length; typeIndex < $art_cnhfrfiqi$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cnhfrfiqi$art_c = types.length; typeIndex < $art_cnhfrfiqi$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objydynbgcb$art_obj = type.groups, $art_cdiozzmp$art_c = $art_objydynbgcb$art_obj.length; groupIndex < $art_cdiozzmp$art_c; groupIndex++) {        var group = $art_objydynbgcb$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objydynbgcb$art_obj = type.groups, $art_cdiozzmp$art_c = $art_objydynbgcb$art_obj.length; groupIndex < $art_cdiozzmp$art_c; groupIndex++) {
            var group = $art_objydynbgcb$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_czfyzxvlih$art_c = group.length; areaIndex < $art_czfyzxvlih$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_czfyzxvlih$art_c = group.length; areaIndex < $art_czfyzxvlih$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iicraoerpg$art_i = 0, $art_objacils$art_obj = area.provinces, $art_ctildmotqo$art_c = $art_objacils$art_obj.length; $art_iicraoerpg$art_i < $art_ctildmotqo$art_c; $art_iicraoerpg$art_i++) {                var province = $art_objacils$art_obj[$art_iicraoerpg$art_i]%>';
                for (var $art_iicraoerpg$art_i = 0, $art_objacils$art_obj = area.provinces, $art_ctildmotqo$art_c = $art_objacils$art_obj.length; $art_iicraoerpg$art_i < $art_ctildmotqo$art_c; $art_iicraoerpg$art_i++) {
                    var province = $art_objacils$art_obj[$art_iicraoerpg$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imismkaqi$art_i = 0, $art_objoowygd$art_obj = province.cities, $art_cfldcinsh$art_c = $art_objoowygd$art_obj.length; $art_imismkaqi$art_i < $art_cfldcinsh$art_c; $art_imismkaqi$art_i++) {                    var city = $art_objoowygd$art_obj[$art_imismkaqi$art_i]%>';
                    for (var $art_imismkaqi$art_i = 0, $art_objoowygd$art_obj = province.cities, $art_cfldcinsh$art_c = $art_objoowygd$art_obj.length; $art_imismkaqi$art_i < $art_cfldcinsh$art_c; $art_imismkaqi$art_i++) {
                        var city = $art_objoowygd$art_obj[$art_imismkaqi$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
