...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cdgfeas$art_c = types.length; typeIndex < $art_cdgfeas$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cdgfeas$art_c = types.length; typeIndex < $art_cdgfeas$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cqvysbu$art_c = types.length; typeIndex < $art_cqvysbu$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cqvysbu$art_c = types.length; typeIndex < $art_cqvysbu$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objdgvvnut$art_obj = type.groups, $art_cmxffitrzs$art_c = $art_objdgvvnut$art_obj.length; groupIndex < $art_cmxffitrzs$art_c; groupIndex++) {        var group = $art_objdgvvnut$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objdgvvnut$art_obj = type.groups, $art_cmxffitrzs$art_c = $art_objdgvvnut$art_obj.length; groupIndex < $art_cmxffitrzs$art_c; groupIndex++) {
            var group = $art_objdgvvnut$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cqtvjtmq$art_c = group.length; areaIndex < $art_cqtvjtmq$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cqtvjtmq$art_c = group.length; areaIndex < $art_cqtvjtmq$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ijeououv$art_i = 0, $art_objbfoufnstt$art_obj = area.provinces, $art_ckalxhrrea$art_c = $art_objbfoufnstt$art_obj.length; $art_ijeououv$art_i < $art_ckalxhrrea$art_c; $art_ijeououv$art_i++) {                var province = $art_objbfoufnstt$art_obj[$art_ijeououv$art_i]%>';
                for (var $art_ijeououv$art_i = 0, $art_objbfoufnstt$art_obj = area.provinces, $art_ckalxhrrea$art_c = $art_objbfoufnstt$art_obj.length; $art_ijeououv$art_i < $art_ckalxhrrea$art_c; $art_ijeououv$art_i++) {
                    var province = $art_objbfoufnstt$art_obj[$art_ijeououv$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ivsisbazrq$art_i = 0, $art_objnodyoape$art_obj = province.cities, $art_cprgcinsz$art_c = $art_objnodyoape$art_obj.length; $art_ivsisbazrq$art_i < $art_cprgcinsz$art_c; $art_ivsisbazrq$art_i++) {                    var city = $art_objnodyoape$art_obj[$art_ivsisbazrq$art_i]%>';
                    for (var $art_ivsisbazrq$art_i = 0, $art_objnodyoape$art_obj = province.cities, $art_cprgcinsz$art_c = $art_objnodyoape$art_obj.length; $art_ivsisbazrq$art_i < $art_cprgcinsz$art_c; $art_ivsisbazrq$art_i++) {
                        var city = $art_objnodyoape$art_obj[$art_ivsisbazrq$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
