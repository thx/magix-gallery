...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_czmrzkocozam$art_c = types.length; typeIndex < $art_czmrzkocozam$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_czmrzkocozam$art_c = types.length; typeIndex < $art_czmrzkocozam$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ctqlq$art_c = types.length; typeIndex < $art_ctqlq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ctqlq$art_c = types.length; typeIndex < $art_ctqlq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objycqljdqkajq$art_obj = type.groups, $art_chgtuotvrjgo$art_c = $art_objycqljdqkajq$art_obj.length; groupIndex < $art_chgtuotvrjgo$art_c; groupIndex++) {        var group = $art_objycqljdqkajq$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objycqljdqkajq$art_obj = type.groups, $art_chgtuotvrjgo$art_c = $art_objycqljdqkajq$art_obj.length; groupIndex < $art_chgtuotvrjgo$art_c; groupIndex++) {
            var group = $art_objycqljdqkajq$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cgouuxl$art_c = group.length; areaIndex < $art_cgouuxl$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cgouuxl$art_c = group.length; areaIndex < $art_cgouuxl$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iwgkzempc$art_i = 0, $art_objayupnzi$art_obj = area.provinces, $art_chvxokzdg$art_c = $art_objayupnzi$art_obj.length; $art_iwgkzempc$art_i < $art_chvxokzdg$art_c; $art_iwgkzempc$art_i++) {                var province = $art_objayupnzi$art_obj[$art_iwgkzempc$art_i]%>';
                for (var $art_iwgkzempc$art_i = 0, $art_objayupnzi$art_obj = area.provinces, $art_chvxokzdg$art_c = $art_objayupnzi$art_obj.length; $art_iwgkzempc$art_i < $art_chvxokzdg$art_c; $art_iwgkzempc$art_i++) {
                    var province = $art_objayupnzi$art_obj[$art_iwgkzempc$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iiwolwxtles$art_i = 0, $art_objpscvaj$art_obj = province.cities, $art_cseivrs$art_c = $art_objpscvaj$art_obj.length; $art_iiwolwxtles$art_i < $art_cseivrs$art_c; $art_iiwolwxtles$art_i++) {                    var city = $art_objpscvaj$art_obj[$art_iiwolwxtles$art_i]%>';
                    for (var $art_iiwolwxtles$art_i = 0, $art_objpscvaj$art_obj = province.cities, $art_cseivrs$art_c = $art_objpscvaj$art_obj.length; $art_iiwolwxtles$art_i < $art_cseivrs$art_c; $art_iiwolwxtles$art_i++) {
                        var city = $art_objpscvaj$art_obj[$art_iiwolwxtles$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
