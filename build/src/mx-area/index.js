...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_crhvnbs$art_c = types.length; typeIndex < $art_crhvnbs$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_crhvnbs$art_c = types.length; typeIndex < $art_crhvnbs$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cairkz$art_c = types.length; typeIndex < $art_cairkz$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cairkz$art_c = types.length; typeIndex < $art_cairkz$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objtwtxtp$art_obj = type.groups, $art_ciwsajsa$art_c = $art_objtwtxtp$art_obj.length; groupIndex < $art_ciwsajsa$art_c; groupIndex++) {        var group = $art_objtwtxtp$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objtwtxtp$art_obj = type.groups, $art_ciwsajsa$art_c = $art_objtwtxtp$art_obj.length; groupIndex < $art_ciwsajsa$art_c; groupIndex++) {
            var group = $art_objtwtxtp$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cfxqipuhshe$art_c = group.length; areaIndex < $art_cfxqipuhshe$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cfxqipuhshe$art_c = group.length; areaIndex < $art_cfxqipuhshe$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_itqtghic$art_i = 0, $art_objyhtafez$art_obj = area.provinces, $art_cqwjegyq$art_c = $art_objyhtafez$art_obj.length; $art_itqtghic$art_i < $art_cqwjegyq$art_c; $art_itqtghic$art_i++) {                var province = $art_objyhtafez$art_obj[$art_itqtghic$art_i]%>';
                for (var $art_itqtghic$art_i = 0, $art_objyhtafez$art_obj = area.provinces, $art_cqwjegyq$art_c = $art_objyhtafez$art_obj.length; $art_itqtghic$art_i < $art_cqwjegyq$art_c; $art_itqtghic$art_i++) {
                    var province = $art_objyhtafez$art_obj[$art_itqtghic$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_idfkyvja$art_i = 0, $art_objyossg$art_obj = province.cities, $art_ckfpwroaerpe$art_c = $art_objyossg$art_obj.length; $art_idfkyvja$art_i < $art_ckfpwroaerpe$art_c; $art_idfkyvja$art_i++) {                    var city = $art_objyossg$art_obj[$art_idfkyvja$art_i]%>';
                    for (var $art_idfkyvja$art_i = 0, $art_objyossg$art_obj = province.cities, $art_ckfpwroaerpe$art_c = $art_objyossg$art_obj.length; $art_idfkyvja$art_i < $art_ckfpwroaerpe$art_c; $art_idfkyvja$art_i++) {
                        var city = $art_objyossg$art_obj[$art_idfkyvja$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
