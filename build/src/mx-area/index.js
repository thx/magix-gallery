...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ciuenvzdet$art_c = types.length; typeIndex < $art_ciuenvzdet$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ciuenvzdet$art_c = types.length; typeIndex < $art_ciuenvzdet$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cnhriecbi$art_c = types.length; typeIndex < $art_cnhriecbi$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cnhriecbi$art_c = types.length; typeIndex < $art_cnhriecbi$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objstpdexnh$art_obj = type.groups, $art_chfnzyydnlp$art_c = $art_objstpdexnh$art_obj.length; groupIndex < $art_chfnzyydnlp$art_c; groupIndex++) {        var group = $art_objstpdexnh$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objstpdexnh$art_obj = type.groups, $art_chfnzyydnlp$art_c = $art_objstpdexnh$art_obj.length; groupIndex < $art_chfnzyydnlp$art_c; groupIndex++) {
            var group = $art_objstpdexnh$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cnegmadmh$art_c = group.length; areaIndex < $art_cnegmadmh$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cnegmadmh$art_c = group.length; areaIndex < $art_cnegmadmh$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ifebqbimu$art_i = 0, $art_objuqcpheo$art_obj = area.provinces, $art_ctxrpngi$art_c = $art_objuqcpheo$art_obj.length; $art_ifebqbimu$art_i < $art_ctxrpngi$art_c; $art_ifebqbimu$art_i++) {                var province = $art_objuqcpheo$art_obj[$art_ifebqbimu$art_i]%>';
                for (var $art_ifebqbimu$art_i = 0, $art_objuqcpheo$art_obj = area.provinces, $art_ctxrpngi$art_c = $art_objuqcpheo$art_obj.length; $art_ifebqbimu$art_i < $art_ctxrpngi$art_c; $art_ifebqbimu$art_i++) {
                    var province = $art_objuqcpheo$art_obj[$art_ifebqbimu$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iattbkbp$art_i = 0, $art_objqxelzb$art_obj = province.cities, $art_cyemvywap$art_c = $art_objqxelzb$art_obj.length; $art_iattbkbp$art_i < $art_cyemvywap$art_c; $art_iattbkbp$art_i++) {                    var city = $art_objqxelzb$art_obj[$art_iattbkbp$art_i]%>';
                    for (var $art_iattbkbp$art_i = 0, $art_objqxelzb$art_obj = province.cities, $art_cyemvywap$art_c = $art_objqxelzb$art_obj.length; $art_iattbkbp$art_i < $art_cyemvywap$art_c; $art_iattbkbp$art_i++) {
                        var city = $art_objqxelzb$art_obj[$art_iattbkbp$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
