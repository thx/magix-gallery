...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_capfv$art_c = types.length; typeIndex < $art_capfv$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_capfv$art_c = types.length; typeIndex < $art_capfv$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_canctejid$art_c = types.length; typeIndex < $art_canctejid$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_canctejid$art_c = types.length; typeIndex < $art_canctejid$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objrnfvvdsfx$art_obj = type.groups, $art_ckngagfjhf$art_c = $art_objrnfvvdsfx$art_obj.length; groupIndex < $art_ckngagfjhf$art_c; groupIndex++) {        var group = $art_objrnfvvdsfx$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objrnfvvdsfx$art_obj = type.groups, $art_ckngagfjhf$art_c = $art_objrnfvvdsfx$art_obj.length; groupIndex < $art_ckngagfjhf$art_c; groupIndex++) {
            var group = $art_objrnfvvdsfx$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cmmidwoees$art_c = group.length; areaIndex < $art_cmmidwoees$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cmmidwoees$art_c = group.length; areaIndex < $art_cmmidwoees$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_isnnqip$art_i = 0, $art_objorvsdtmtf$art_obj = area.provinces, $art_cnldntdcg$art_c = $art_objorvsdtmtf$art_obj.length; $art_isnnqip$art_i < $art_cnldntdcg$art_c; $art_isnnqip$art_i++) {                var province = $art_objorvsdtmtf$art_obj[$art_isnnqip$art_i]%>';
                for (var $art_isnnqip$art_i = 0, $art_objorvsdtmtf$art_obj = area.provinces, $art_cnldntdcg$art_c = $art_objorvsdtmtf$art_obj.length; $art_isnnqip$art_i < $art_cnldntdcg$art_c; $art_isnnqip$art_i++) {
                    var province = $art_objorvsdtmtf$art_obj[$art_isnnqip$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imbpzxup$art_i = 0, $art_objyingceu$art_obj = province.cities, $art_cigpiftuvjs$art_c = $art_objyingceu$art_obj.length; $art_imbpzxup$art_i < $art_cigpiftuvjs$art_c; $art_imbpzxup$art_i++) {                    var city = $art_objyingceu$art_obj[$art_imbpzxup$art_i]%>';
                    for (var $art_imbpzxup$art_i = 0, $art_objyingceu$art_obj = province.cities, $art_cigpiftuvjs$art_c = $art_objyingceu$art_obj.length; $art_imbpzxup$art_i < $art_cigpiftuvjs$art_c; $art_imbpzxup$art_i++) {
                        var city = $art_objyingceu$art_obj[$art_imbpzxup$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
