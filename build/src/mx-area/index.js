...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ctkeaidfp$art_c = types.length; typeIndex < $art_ctkeaidfp$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ctkeaidfp$art_c = types.length; typeIndex < $art_ctkeaidfp$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cftpapxomo$art_c = types.length; typeIndex < $art_cftpapxomo$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cftpapxomo$art_c = types.length; typeIndex < $art_cftpapxomo$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objacwkwavxv$art_obj = type.groups, $art_ckobmmzkc$art_c = $art_objacwkwavxv$art_obj.length; groupIndex < $art_ckobmmzkc$art_c; groupIndex++) {        var group = $art_objacwkwavxv$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objacwkwavxv$art_obj = type.groups, $art_ckobmmzkc$art_c = $art_objacwkwavxv$art_obj.length; groupIndex < $art_ckobmmzkc$art_c; groupIndex++) {
            var group = $art_objacwkwavxv$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cfhzjfyc$art_c = group.length; areaIndex < $art_cfhzjfyc$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cfhzjfyc$art_c = group.length; areaIndex < $art_cfhzjfyc$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iqrgfqgypp$art_i = 0, $art_objuyijcurp$art_obj = area.provinces, $art_cgugvijj$art_c = $art_objuyijcurp$art_obj.length; $art_iqrgfqgypp$art_i < $art_cgugvijj$art_c; $art_iqrgfqgypp$art_i++) {                var province = $art_objuyijcurp$art_obj[$art_iqrgfqgypp$art_i]%>';
                for (var $art_iqrgfqgypp$art_i = 0, $art_objuyijcurp$art_obj = area.provinces, $art_cgugvijj$art_c = $art_objuyijcurp$art_obj.length; $art_iqrgfqgypp$art_i < $art_cgugvijj$art_c; $art_iqrgfqgypp$art_i++) {
                    var province = $art_objuyijcurp$art_obj[$art_iqrgfqgypp$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iceptipb$art_i = 0, $art_objjvbpf$art_obj = province.cities, $art_chmjugh$art_c = $art_objjvbpf$art_obj.length; $art_iceptipb$art_i < $art_chmjugh$art_c; $art_iceptipb$art_i++) {                    var city = $art_objjvbpf$art_obj[$art_iceptipb$art_i]%>';
                    for (var $art_iceptipb$art_i = 0, $art_objjvbpf$art_obj = province.cities, $art_chmjugh$art_c = $art_objjvbpf$art_obj.length; $art_iceptipb$art_i < $art_chmjugh$art_c; $art_iceptipb$art_i++) {
                        var city = $art_objjvbpf$art_obj[$art_iceptipb$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
