...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cyqgjhggsbq$art_c = types.length; typeIndex < $art_cyqgjhggsbq$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cyqgjhggsbq$art_c = types.length; typeIndex < $art_cyqgjhggsbq$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cgjiylqq$art_c = types.length; typeIndex < $art_cgjiylqq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cgjiylqq$art_c = types.length; typeIndex < $art_cgjiylqq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objuhlqhhwi$art_obj = type.groups, $art_cowmqyv$art_c = $art_objuhlqhhwi$art_obj.length; groupIndex < $art_cowmqyv$art_c; groupIndex++) {        var group = $art_objuhlqhhwi$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objuhlqhhwi$art_obj = type.groups, $art_cowmqyv$art_c = $art_objuhlqhhwi$art_obj.length; groupIndex < $art_cowmqyv$art_c; groupIndex++) {
            var group = $art_objuhlqhhwi$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cddguwiqpo$art_c = group.length; areaIndex < $art_cddguwiqpo$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cddguwiqpo$art_c = group.length; areaIndex < $art_cddguwiqpo$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ivsxyzbue$art_i = 0, $art_objivutspnhi$art_obj = area.provinces, $art_ceszwhhvph$art_c = $art_objivutspnhi$art_obj.length; $art_ivsxyzbue$art_i < $art_ceszwhhvph$art_c; $art_ivsxyzbue$art_i++) {                var province = $art_objivutspnhi$art_obj[$art_ivsxyzbue$art_i]%>';
                for (var $art_ivsxyzbue$art_i = 0, $art_objivutspnhi$art_obj = area.provinces, $art_ceszwhhvph$art_c = $art_objivutspnhi$art_obj.length; $art_ivsxyzbue$art_i < $art_ceszwhhvph$art_c; $art_ivsxyzbue$art_i++) {
                    var province = $art_objivutspnhi$art_obj[$art_ivsxyzbue$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ibkeetar$art_i = 0, $art_objammospsc$art_obj = province.cities, $art_ckhhewk$art_c = $art_objammospsc$art_obj.length; $art_ibkeetar$art_i < $art_ckhhewk$art_c; $art_ibkeetar$art_i++) {                    var city = $art_objammospsc$art_obj[$art_ibkeetar$art_i]%>';
                    for (var $art_ibkeetar$art_i = 0, $art_objammospsc$art_obj = province.cities, $art_ckhhewk$art_c = $art_objammospsc$art_obj.length; $art_ibkeetar$art_i < $art_ckhhewk$art_c; $art_ibkeetar$art_i++) {
                        var city = $art_objammospsc$art_obj[$art_ibkeetar$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
