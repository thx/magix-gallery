...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbiepcrehth$art_c = types.length; typeIndex < $art_cbiepcrehth$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbiepcrehth$art_c = types.length; typeIndex < $art_cbiepcrehth$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cwpkeqj$art_c = types.length; typeIndex < $art_cwpkeqj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cwpkeqj$art_c = types.length; typeIndex < $art_cwpkeqj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objhzqhfyt$art_obj = type.groups, $art_cdhsvrspi$art_c = $art_objhzqhfyt$art_obj.length; groupIndex < $art_cdhsvrspi$art_c; groupIndex++) {        var group = $art_objhzqhfyt$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objhzqhfyt$art_obj = type.groups, $art_cdhsvrspi$art_c = $art_objhzqhfyt$art_obj.length; groupIndex < $art_cdhsvrspi$art_c; groupIndex++) {
            var group = $art_objhzqhfyt$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cwyebvqja$art_c = group.length; areaIndex < $art_cwyebvqja$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cwyebvqja$art_c = group.length; areaIndex < $art_cwyebvqja$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilfuytkr$art_i = 0, $art_objgspuabtpc$art_obj = area.provinces, $art_cdfipfv$art_c = $art_objgspuabtpc$art_obj.length; $art_ilfuytkr$art_i < $art_cdfipfv$art_c; $art_ilfuytkr$art_i++) {                var province = $art_objgspuabtpc$art_obj[$art_ilfuytkr$art_i]%>';
                for (var $art_ilfuytkr$art_i = 0, $art_objgspuabtpc$art_obj = area.provinces, $art_cdfipfv$art_c = $art_objgspuabtpc$art_obj.length; $art_ilfuytkr$art_i < $art_cdfipfv$art_c; $art_ilfuytkr$art_i++) {
                    var province = $art_objgspuabtpc$art_obj[$art_ilfuytkr$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iziwbflmyn$art_i = 0, $art_objfghikivhgs$art_obj = province.cities, $art_cviwefozaa$art_c = $art_objfghikivhgs$art_obj.length; $art_iziwbflmyn$art_i < $art_cviwefozaa$art_c; $art_iziwbflmyn$art_i++) {                    var city = $art_objfghikivhgs$art_obj[$art_iziwbflmyn$art_i]%>';
                    for (var $art_iziwbflmyn$art_i = 0, $art_objfghikivhgs$art_obj = province.cities, $art_cviwefozaa$art_c = $art_objfghikivhgs$art_obj.length; $art_iziwbflmyn$art_i < $art_cviwefozaa$art_c; $art_iziwbflmyn$art_i++) {
                        var city = $art_objfghikivhgs$art_obj[$art_iziwbflmyn$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
