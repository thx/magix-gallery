...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cmbxmshnsicm$art_c = types.length; typeIndex < $art_cmbxmshnsicm$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cmbxmshnsicm$art_c = types.length; typeIndex < $art_cmbxmshnsicm$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_codwnpgez$art_c = types.length; typeIndex < $art_codwnpgez$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_codwnpgez$art_c = types.length; typeIndex < $art_codwnpgez$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objfadbggnh$art_obj = type.groups, $art_cktrcdpq$art_c = $art_objfadbggnh$art_obj.length; groupIndex < $art_cktrcdpq$art_c; groupIndex++) {        var group = $art_objfadbggnh$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objfadbggnh$art_obj = type.groups, $art_cktrcdpq$art_c = $art_objfadbggnh$art_obj.length; groupIndex < $art_cktrcdpq$art_c; groupIndex++) {
            var group = $art_objfadbggnh$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cqdekvwrga$art_c = group.length; areaIndex < $art_cqdekvwrga$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cqdekvwrga$art_c = group.length; areaIndex < $art_cqdekvwrga$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iwmupkxruxa$art_i = 0, $art_objtwmnccgo$art_obj = area.provinces, $art_cnuwrjt$art_c = $art_objtwmnccgo$art_obj.length; $art_iwmupkxruxa$art_i < $art_cnuwrjt$art_c; $art_iwmupkxruxa$art_i++) {                var province = $art_objtwmnccgo$art_obj[$art_iwmupkxruxa$art_i]%>';
                for (var $art_iwmupkxruxa$art_i = 0, $art_objtwmnccgo$art_obj = area.provinces, $art_cnuwrjt$art_c = $art_objtwmnccgo$art_obj.length; $art_iwmupkxruxa$art_i < $art_cnuwrjt$art_c; $art_iwmupkxruxa$art_i++) {
                    var province = $art_objtwmnccgo$art_obj[$art_iwmupkxruxa$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ineqzrvh$art_i = 0, $art_objnuiwyuq$art_obj = province.cities, $art_ccyeuxlngs$art_c = $art_objnuiwyuq$art_obj.length; $art_ineqzrvh$art_i < $art_ccyeuxlngs$art_c; $art_ineqzrvh$art_i++) {                    var city = $art_objnuiwyuq$art_obj[$art_ineqzrvh$art_i]%>';
                    for (var $art_ineqzrvh$art_i = 0, $art_objnuiwyuq$art_obj = province.cities, $art_ccyeuxlngs$art_c = $art_objnuiwyuq$art_obj.length; $art_ineqzrvh$art_i < $art_ccyeuxlngs$art_c; $art_ineqzrvh$art_i++) {
                        var city = $art_objnuiwyuq$art_obj[$art_ineqzrvh$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
