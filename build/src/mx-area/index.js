...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_caotdmnmcd$art_c = types.length; typeIndex < $art_caotdmnmcd$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_caotdmnmcd$art_c = types.length; typeIndex < $art_caotdmnmcd$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_csjpgfa$art_c = types.length; typeIndex < $art_csjpgfa$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_csjpgfa$art_c = types.length; typeIndex < $art_csjpgfa$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objkgwktfprvt$art_obj = type.groups, $art_cbpqjguvx$art_c = $art_objkgwktfprvt$art_obj.length; groupIndex < $art_cbpqjguvx$art_c; groupIndex++) {        var group = $art_objkgwktfprvt$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objkgwktfprvt$art_obj = type.groups, $art_cbpqjguvx$art_c = $art_objkgwktfprvt$art_obj.length; groupIndex < $art_cbpqjguvx$art_c; groupIndex++) {
            var group = $art_objkgwktfprvt$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ciwuz$art_c = group.length; areaIndex < $art_ciwuz$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ciwuz$art_c = group.length; areaIndex < $art_ciwuz$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilswcdkhp$art_i = 0, $art_objdnrbvcrni$art_obj = area.provinces, $art_cqjzvtigl$art_c = $art_objdnrbvcrni$art_obj.length; $art_ilswcdkhp$art_i < $art_cqjzvtigl$art_c; $art_ilswcdkhp$art_i++) {                var province = $art_objdnrbvcrni$art_obj[$art_ilswcdkhp$art_i]%>';
                for (var $art_ilswcdkhp$art_i = 0, $art_objdnrbvcrni$art_obj = area.provinces, $art_cqjzvtigl$art_c = $art_objdnrbvcrni$art_obj.length; $art_ilswcdkhp$art_i < $art_cqjzvtigl$art_c; $art_ilswcdkhp$art_i++) {
                    var province = $art_objdnrbvcrni$art_obj[$art_ilswcdkhp$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iekbvezjgri$art_i = 0, $art_objiinpjdrn$art_obj = province.cities, $art_cgbooajbac$art_c = $art_objiinpjdrn$art_obj.length; $art_iekbvezjgri$art_i < $art_cgbooajbac$art_c; $art_iekbvezjgri$art_i++) {                    var city = $art_objiinpjdrn$art_obj[$art_iekbvezjgri$art_i]%>';
                    for (var $art_iekbvezjgri$art_i = 0, $art_objiinpjdrn$art_obj = province.cities, $art_cgbooajbac$art_c = $art_objiinpjdrn$art_obj.length; $art_iekbvezjgri$art_i < $art_cgbooajbac$art_c; $art_iekbvezjgri$art_i++) {
                        var city = $art_objiinpjdrn$art_obj[$art_iekbvezjgri$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
