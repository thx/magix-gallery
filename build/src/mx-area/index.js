...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_galleryN:_" class="mc-iconfont search-icon">&#xe651;</i><input mx-keyup="' + $viewId + '@{search}()" class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (isTab) {
        ;
        $p += '<div mxv mxa="_zs_galleryN:_" class="_zs_gallery_mx-area_index_-tabs clearfix">';
        $line = 7;
        $art = 'each types as type typeIndex';
        ;
        $p += '';
        $expr = '<%for (var typeIndex = 0, $art_cqgycnkyti$art_c = types.length; typeIndex < $art_cqgycnkyti$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cqgycnkyti$art_c = types.length; typeIndex < $art_cqgycnkyti$art_c; typeIndex++) {
            ...
            ;
            $p += ' clearfix"><div mxv mxa="_zs_galleryN:a" class="_zs_gallery_mx-area_index_-tab-check"><input type="checkbox" mx-change="' + $viewId + '@{changeAll}({typeIndex:';
            $line = 11;
            $art = '=typeIndex';
            ;
    ...
    ;
    $p += '';
    $expr = '<%for (var typeIndex = 0, $art_cefnbfrhalj$art_c = types.length; typeIndex < $art_cefnbfrhalj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cefnbfrhalj$art_c = types.length; typeIndex < $art_cefnbfrhalj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        if (!isTab) {
            ;
            $p += '<div mxv mxa="_zs_galleryN:b" class="_zs_gallery_mx-area_index_-all"><label mxv for="';
            $line = 25;
            $art = '=viewId';
            ;
            ...
            ;
            $p += '/><span mxa="_zs_galleryN:c" class="ml5">全选 - ';
            $line = 27;
            $art = '=type.name';
            ;
        ...
        ;
        $p += '<div mxv mxa="_zs_galleryN:d" class="clearfix">';
        $line = 32;
        $art = 'each type.groups as group groupIndex';
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_objbafbhgrjxlf$art_obj = type.groups, $art_cfaqhrojv$art_c = $art_objbafbhgrjxlf$art_obj.length; groupIndex < $art_cfaqhrojv$art_c; groupIndex++) {        var group = $art_objbafbhgrjxlf$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objbafbhgrjxlf$art_obj = type.groups, $art_cfaqhrojv$art_c = $art_objbafbhgrjxlf$art_obj.length; groupIndex < $art_cfaqhrojv$art_c; groupIndex++) {
            var group = $art_objbafbhgrjxlf$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var areaIndex = 0, $art_csbkty$art_c = group.length; areaIndex < $art_csbkty$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_csbkty$art_c = group.length; areaIndex < $art_csbkty$art_c; areaIndex++) {
                ...
                if (area.name) {
                    ;
                    $p += '<div mxv mxa="_zs_galleryN:e" class="_zs_gallery_mx-area_index_-area"><div mxa="_zs_galleryN:f" class="_zs_gallery_mx-area_index_-area-name">';
                    $line = 37;
                    $art = '=area.name';
                    ;
                ...
                ;
                $p += '<div mxv mxa="_zs_galleryN:g" class="_zs_gallery_mx-area_index_-provinces clearfix">';
                $line = 40;
                $art = 'each area.provinces as province';
                ;
                $p += '';
                $expr = '<%for (var $art_ixjufdud$art_i = 0, $art_objrraoxz$art_obj = area.provinces, $art_cmiqmbmbr$art_c = $art_objrraoxz$art_obj.length; $art_ixjufdud$art_i < $art_cmiqmbmbr$art_c; $art_ixjufdud$art_i++) {                var province = $art_objrraoxz$art_obj[$art_ixjufdud$art_i]%>';
                for (var $art_ixjufdud$art_i = 0, $art_objrraoxz$art_obj = area.provinces, $art_cmiqmbmbr$art_c = $art_objrraoxz$art_obj.length; $art_ixjufdud$art_i < $art_cmiqmbmbr$art_c; $art_ixjufdud$art_i++) {
                    var province = $art_objrraoxz$art_obj[$art_ixjufdud$art_i];
                    ...
                    if (province.hasCity && (province.count > 0)) {
                        ;
                        $p += '<span mxa="_zs_galleryN:h" class="_zs_gallery_mx-area_index_-province-count">(';
                        $line = 47;
                        $art = '=province.count';
                        ;
                    ...
                    ;
                    $p += '';
                    $expr = '<%for (var $art_imkfhlp$art_i = 0, $art_objsrdztgmx$art_obj = province.cities, $art_cnlsurarqg$art_c = $art_objsrdztgmx$art_obj.length; $art_imkfhlp$art_i < $art_cnlsurarqg$art_c; $art_imkfhlp$art_i++) {                    var city = $art_objsrdztgmx$art_obj[$art_imkfhlp$art_i]%>';
                    for (var $art_imkfhlp$art_i = 0, $art_objsrdztgmx$art_obj = province.cities, $art_cnlsurarqg$art_c = $art_objsrdztgmx$art_obj.length; $art_imkfhlp$art_i < $art_cnlsurarqg$art_c; $art_imkfhlp$art_i++) {
                        var city = $art_objsrdztgmx$art_obj[$art_imkfhlp$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
