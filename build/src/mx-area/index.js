...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $p += '';
        $expr = '<%for (var typeIndex = 0, $art_cysbqshmi$art_c = types.length; typeIndex < $art_cysbqshmi$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cysbqshmi$art_c = types.length; typeIndex < $art_cysbqshmi$art_c; typeIndex++) {
    ...
    ;
    $p += '';
    $expr = '<%for (var typeIndex = 0, $art_ctcofxg$art_c = types.length; typeIndex < $art_ctcofxg$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ctcofxg$art_c = types.length; typeIndex < $art_ctcofxg$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_objtqyljyqscur$art_obj = type.groups, $art_cgxpmgk$art_c = $art_objtqyljyqscur$art_obj.length; groupIndex < $art_cgxpmgk$art_c; groupIndex++) {        var group = $art_objtqyljyqscur$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objtqyljyqscur$art_obj = type.groups, $art_cgxpmgk$art_c = $art_objtqyljyqscur$art_obj.length; groupIndex < $art_cgxpmgk$art_c; groupIndex++) {
            var group = $art_objtqyljyqscur$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var areaIndex = 0, $art_cbxtssd$art_c = group.length; areaIndex < $art_cbxtssd$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cbxtssd$art_c = group.length; areaIndex < $art_cbxtssd$art_c; areaIndex++) {
                ...
                ;
                $p += '';
                $expr = '<%for (var $art_ibuaufmhmg$art_i = 0, $art_objmuhjfvkvq$art_obj = area.provinces, $art_calbgzjajos$art_c = $art_objmuhjfvkvq$art_obj.length; $art_ibuaufmhmg$art_i < $art_calbgzjajos$art_c; $art_ibuaufmhmg$art_i++) {                var province = $art_objmuhjfvkvq$art_obj[$art_ibuaufmhmg$art_i]%>';
                for (var $art_ibuaufmhmg$art_i = 0, $art_objmuhjfvkvq$art_obj = area.provinces, $art_calbgzjajos$art_c = $art_objmuhjfvkvq$art_obj.length; $art_ibuaufmhmg$art_i < $art_calbgzjajos$art_c; $art_ibuaufmhmg$art_i++) {
                    var province = $art_objmuhjfvkvq$art_obj[$art_ibuaufmhmg$art_i];
                    ...
                    ;
                    $p += '';
                    $expr = '<%for (var $art_imiikpavefk$art_i = 0, $art_objociks$art_obj = province.cities, $art_chedlyxda$art_c = $art_objociks$art_obj.length; $art_imiikpavefk$art_i < $art_chedlyxda$art_c; $art_imiikpavefk$art_i++) {                    var city = $art_objociks$art_obj[$art_imiikpavefk$art_i]%>';
                    for (var $art_imiikpavefk$art_i = 0, $art_objociks$art_obj = province.cities, $art_chedlyxda$art_c = $art_objociks$art_obj.length; $art_imiikpavefk$art_i < $art_chedlyxda$art_c; $art_imiikpavefk$art_i++) {
                        var city = $art_objociks$art_obj[$art_imiikpavefk$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
