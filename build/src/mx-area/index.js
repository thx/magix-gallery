...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cabbxqrges$art_c = types.length; typeIndex < $art_cabbxqrges$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cabbxqrges$art_c = types.length; typeIndex < $art_cabbxqrges$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_chdwrnvzog$art_c = types.length; typeIndex < $art_chdwrnvzog$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_chdwrnvzog$art_c = types.length; typeIndex < $art_chdwrnvzog$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objgvzsmj$art_obj = type.groups, $art_cifnhbu$art_c = $art_objgvzsmj$art_obj.length; groupIndex < $art_cifnhbu$art_c; groupIndex++) {        var group = $art_objgvzsmj$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objgvzsmj$art_obj = type.groups, $art_cifnhbu$art_c = $art_objgvzsmj$art_obj.length; groupIndex < $art_cifnhbu$art_c; groupIndex++) {
            var group = $art_objgvzsmj$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ciuwzvlhqo$art_c = group.length; areaIndex < $art_ciuwzvlhqo$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ciuwzvlhqo$art_c = group.length; areaIndex < $art_ciuwzvlhqo$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iiiwuubbzk$art_i = 0, $art_objonjxnct$art_obj = area.provinces, $art_crqajbtqq$art_c = $art_objonjxnct$art_obj.length; $art_iiiwuubbzk$art_i < $art_crqajbtqq$art_c; $art_iiiwuubbzk$art_i++) {                var province = $art_objonjxnct$art_obj[$art_iiiwuubbzk$art_i]%>';
                for (var $art_iiiwuubbzk$art_i = 0, $art_objonjxnct$art_obj = area.provinces, $art_crqajbtqq$art_c = $art_objonjxnct$art_obj.length; $art_iiiwuubbzk$art_i < $art_crqajbtqq$art_c; $art_iiiwuubbzk$art_i++) {
                    var province = $art_objonjxnct$art_obj[$art_iiiwuubbzk$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_istmqwjq$art_i = 0, $art_objtnrynyxv$art_obj = province.cities, $art_cldppmmzyqh$art_c = $art_objtnrynyxv$art_obj.length; $art_istmqwjq$art_i < $art_cldppmmzyqh$art_c; $art_istmqwjq$art_i++) {                    var city = $art_objtnrynyxv$art_obj[$art_istmqwjq$art_i]%>';
                    for (var $art_istmqwjq$art_i = 0, $art_objtnrynyxv$art_obj = province.cities, $art_cldppmmzyqh$art_c = $art_objtnrynyxv$art_obj.length; $art_istmqwjq$art_i < $art_cldppmmzyqh$art_c; $art_istmqwjq$art_i++) {
                        var city = $art_objtnrynyxv$art_obj[$art_istmqwjq$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
