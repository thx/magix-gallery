...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_clbgepxull$art_c = types.length; typeIndex < $art_clbgepxull$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_clbgepxull$art_c = types.length; typeIndex < $art_clbgepxull$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cbjrtnsck$art_c = types.length; typeIndex < $art_cbjrtnsck$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cbjrtnsck$art_c = types.length; typeIndex < $art_cbjrtnsck$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objftzqsn$art_obj = type.groups, $art_cypuexknc$art_c = $art_objftzqsn$art_obj.length; groupIndex < $art_cypuexknc$art_c; groupIndex++) {        var group = $art_objftzqsn$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objftzqsn$art_obj = type.groups, $art_cypuexknc$art_c = $art_objftzqsn$art_obj.length; groupIndex < $art_cypuexknc$art_c; groupIndex++) {
            var group = $art_objftzqsn$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cusdcebwv$art_c = group.length; areaIndex < $art_cusdcebwv$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cusdcebwv$art_c = group.length; areaIndex < $art_cusdcebwv$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iefwfuhd$art_i = 0, $art_objnhmmpgco$art_obj = area.provinces, $art_cmmdzselpr$art_c = $art_objnhmmpgco$art_obj.length; $art_iefwfuhd$art_i < $art_cmmdzselpr$art_c; $art_iefwfuhd$art_i++) {                var province = $art_objnhmmpgco$art_obj[$art_iefwfuhd$art_i]%>';
                for (var $art_iefwfuhd$art_i = 0, $art_objnhmmpgco$art_obj = area.provinces, $art_cmmdzselpr$art_c = $art_objnhmmpgco$art_obj.length; $art_iefwfuhd$art_i < $art_cmmdzselpr$art_c; $art_iefwfuhd$art_i++) {
                    var province = $art_objnhmmpgco$art_obj[$art_iefwfuhd$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iwrzveowfss$art_i = 0, $art_objbhkcawc$art_obj = province.cities, $art_ceafuctfd$art_c = $art_objbhkcawc$art_obj.length; $art_iwrzveowfss$art_i < $art_ceafuctfd$art_c; $art_iwrzveowfss$art_i++) {                    var city = $art_objbhkcawc$art_obj[$art_iwrzveowfss$art_i]%>';
                    for (var $art_iwrzveowfss$art_i = 0, $art_objbhkcawc$art_obj = province.cities, $art_ceafuctfd$art_c = $art_objbhkcawc$art_obj.length; $art_iwrzveowfss$art_i < $art_ceafuctfd$art_c; $art_iwrzveowfss$art_i++) {
                        var city = $art_objbhkcawc$art_obj[$art_iwrzveowfss$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
