...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cixnauotjxpa$art_c = types.length; typeIndex < $art_cixnauotjxpa$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cixnauotjxpa$art_c = types.length; typeIndex < $art_cixnauotjxpa$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_crqmrmop$art_c = types.length; typeIndex < $art_crqmrmop$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_crqmrmop$art_c = types.length; typeIndex < $art_crqmrmop$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objsssjvz$art_obj = type.groups, $art_clricjwsb$art_c = $art_objsssjvz$art_obj.length; groupIndex < $art_clricjwsb$art_c; groupIndex++) {        var group = $art_objsssjvz$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objsssjvz$art_obj = type.groups, $art_clricjwsb$art_c = $art_objsssjvz$art_obj.length; groupIndex < $art_clricjwsb$art_c; groupIndex++) {
            var group = $art_objsssjvz$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cahgnt$art_c = group.length; areaIndex < $art_cahgnt$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cahgnt$art_c = group.length; areaIndex < $art_cahgnt$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_isgsjvizsh$art_i = 0, $art_objunyxf$art_obj = area.provinces, $art_cwhpmwff$art_c = $art_objunyxf$art_obj.length; $art_isgsjvizsh$art_i < $art_cwhpmwff$art_c; $art_isgsjvizsh$art_i++) {                var province = $art_objunyxf$art_obj[$art_isgsjvizsh$art_i]%>';
                for (var $art_isgsjvizsh$art_i = 0, $art_objunyxf$art_obj = area.provinces, $art_cwhpmwff$art_c = $art_objunyxf$art_obj.length; $art_isgsjvizsh$art_i < $art_cwhpmwff$art_c; $art_isgsjvizsh$art_i++) {
                    var province = $art_objunyxf$art_obj[$art_isgsjvizsh$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ikythxbakfr$art_i = 0, $art_objgyjxmkkd$art_obj = province.cities, $art_cwcsziiezkq$art_c = $art_objgyjxmkkd$art_obj.length; $art_ikythxbakfr$art_i < $art_cwcsziiezkq$art_c; $art_ikythxbakfr$art_i++) {                    var city = $art_objgyjxmkkd$art_obj[$art_ikythxbakfr$art_i]%>';
                    for (var $art_ikythxbakfr$art_i = 0, $art_objgyjxmkkd$art_obj = province.cities, $art_cwcsziiezkq$art_c = $art_objgyjxmkkd$art_obj.length; $art_ikythxbakfr$art_i < $art_cwcsziiezkq$art_c; $art_ikythxbakfr$art_i++) {
                        var city = $art_objgyjxmkkd$art_obj[$art_ikythxbakfr$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
