...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cwmlnhg$art_c = types.length; typeIndex < $art_cwmlnhg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cwmlnhg$art_c = types.length; typeIndex < $art_cwmlnhg$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ckhjizrvf$art_c = types.length; typeIndex < $art_ckhjizrvf$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ckhjizrvf$art_c = types.length; typeIndex < $art_ckhjizrvf$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objgrixrujpsuc$art_obj = type.groups, $art_ckkhtsyjta$art_c = $art_objgrixrujpsuc$art_obj.length; groupIndex < $art_ckkhtsyjta$art_c; groupIndex++) {        var group = $art_objgrixrujpsuc$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objgrixrujpsuc$art_obj = type.groups, $art_ckkhtsyjta$art_c = $art_objgrixrujpsuc$art_obj.length; groupIndex < $art_ckkhtsyjta$art_c; groupIndex++) {
            var group = $art_objgrixrujpsuc$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cngixhuv$art_c = group.length; areaIndex < $art_cngixhuv$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cngixhuv$art_c = group.length; areaIndex < $art_cngixhuv$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iczhzsuhfwdw$art_i = 0, $art_objlbenqbgf$art_obj = area.provinces, $art_cljeolmdo$art_c = $art_objlbenqbgf$art_obj.length; $art_iczhzsuhfwdw$art_i < $art_cljeolmdo$art_c; $art_iczhzsuhfwdw$art_i++) {                var province = $art_objlbenqbgf$art_obj[$art_iczhzsuhfwdw$art_i]%>';
                for (var $art_iczhzsuhfwdw$art_i = 0, $art_objlbenqbgf$art_obj = area.provinces, $art_cljeolmdo$art_c = $art_objlbenqbgf$art_obj.length; $art_iczhzsuhfwdw$art_i < $art_cljeolmdo$art_c; $art_iczhzsuhfwdw$art_i++) {
                    var province = $art_objlbenqbgf$art_obj[$art_iczhzsuhfwdw$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ibettygns$art_i = 0, $art_objeraflf$art_obj = province.cities, $art_cssrbwiegow$art_c = $art_objeraflf$art_obj.length; $art_ibettygns$art_i < $art_cssrbwiegow$art_c; $art_ibettygns$art_i++) {                    var city = $art_objeraflf$art_obj[$art_ibettygns$art_i]%>';
                    for (var $art_ibettygns$art_i = 0, $art_objeraflf$art_obj = province.cities, $art_cssrbwiegow$art_c = $art_objeraflf$art_obj.length; $art_ibettygns$art_i < $art_cssrbwiegow$art_c; $art_ibettygns$art_i++) {
                        var city = $art_objeraflf$art_obj[$art_ibettygns$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
