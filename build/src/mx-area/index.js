...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cznetnqdym$art_c = types.length; typeIndex < $art_cznetnqdym$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cznetnqdym$art_c = types.length; typeIndex < $art_cznetnqdym$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cpntftpj$art_c = types.length; typeIndex < $art_cpntftpj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cpntftpj$art_c = types.length; typeIndex < $art_cpntftpj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objgtsdjxnpe$art_obj = type.groups, $art_cqvipklq$art_c = $art_objgtsdjxnpe$art_obj.length; groupIndex < $art_cqvipklq$art_c; groupIndex++) {        var group = $art_objgtsdjxnpe$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objgtsdjxnpe$art_obj = type.groups, $art_cqvipklq$art_c = $art_objgtsdjxnpe$art_obj.length; groupIndex < $art_cqvipklq$art_c; groupIndex++) {
            var group = $art_objgtsdjxnpe$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cmxispkyha$art_c = group.length; areaIndex < $art_cmxispkyha$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cmxispkyha$art_c = group.length; areaIndex < $art_cmxispkyha$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iditmn$art_i = 0, $art_objghpooa$art_obj = area.provinces, $art_cnsiwusc$art_c = $art_objghpooa$art_obj.length; $art_iditmn$art_i < $art_cnsiwusc$art_c; $art_iditmn$art_i++) {                var province = $art_objghpooa$art_obj[$art_iditmn$art_i]%>';
                for (var $art_iditmn$art_i = 0, $art_objghpooa$art_obj = area.provinces, $art_cnsiwusc$art_c = $art_objghpooa$art_obj.length; $art_iditmn$art_i < $art_cnsiwusc$art_c; $art_iditmn$art_i++) {
                    var province = $art_objghpooa$art_obj[$art_iditmn$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ifxvhdbrtw$art_i = 0, $art_objmyaasgji$art_obj = province.cities, $art_csykyf$art_c = $art_objmyaasgji$art_obj.length; $art_ifxvhdbrtw$art_i < $art_csykyf$art_c; $art_ifxvhdbrtw$art_i++) {                    var city = $art_objmyaasgji$art_obj[$art_ifxvhdbrtw$art_i]%>';
                    for (var $art_ifxvhdbrtw$art_i = 0, $art_objmyaasgji$art_obj = province.cities, $art_csykyf$art_c = $art_objmyaasgji$art_obj.length; $art_ifxvhdbrtw$art_i < $art_csykyf$art_c; $art_ifxvhdbrtw$art_i++) {
                        var city = $art_objmyaasgji$art_obj[$art_ifxvhdbrtw$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
