...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cibbjqxry$art_c = types.length; typeIndex < $art_cibbjqxry$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cibbjqxry$art_c = types.length; typeIndex < $art_cibbjqxry$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_conmvvjrpt$art_c = types.length; typeIndex < $art_conmvvjrpt$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_conmvvjrpt$art_c = types.length; typeIndex < $art_conmvvjrpt$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objtvxmflmk$art_obj = type.groups, $art_csnffrxexe$art_c = $art_objtvxmflmk$art_obj.length; groupIndex < $art_csnffrxexe$art_c; groupIndex++) {        var group = $art_objtvxmflmk$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objtvxmflmk$art_obj = type.groups, $art_csnffrxexe$art_c = $art_objtvxmflmk$art_obj.length; groupIndex < $art_csnffrxexe$art_c; groupIndex++) {
            var group = $art_objtvxmflmk$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_czyymmdqw$art_c = group.length; areaIndex < $art_czyymmdqw$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_czyymmdqw$art_c = group.length; areaIndex < $art_czyymmdqw$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilujqkecltf$art_i = 0, $art_objaefbhq$art_obj = area.provinces, $art_cgvyklyvrw$art_c = $art_objaefbhq$art_obj.length; $art_ilujqkecltf$art_i < $art_cgvyklyvrw$art_c; $art_ilujqkecltf$art_i++) {                var province = $art_objaefbhq$art_obj[$art_ilujqkecltf$art_i]%>';
                for (var $art_ilujqkecltf$art_i = 0, $art_objaefbhq$art_obj = area.provinces, $art_cgvyklyvrw$art_c = $art_objaefbhq$art_obj.length; $art_ilujqkecltf$art_i < $art_cgvyklyvrw$art_c; $art_ilujqkecltf$art_i++) {
                    var province = $art_objaefbhq$art_obj[$art_ilujqkecltf$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ijimrjuo$art_i = 0, $art_objbznbwqvz$art_obj = province.cities, $art_covzoojjqvs$art_c = $art_objbznbwqvz$art_obj.length; $art_ijimrjuo$art_i < $art_covzoojjqvs$art_c; $art_ijimrjuo$art_i++) {                    var city = $art_objbznbwqvz$art_obj[$art_ijimrjuo$art_i]%>';
                    for (var $art_ijimrjuo$art_i = 0, $art_objbznbwqvz$art_obj = province.cities, $art_covzoojjqvs$art_c = $art_objbznbwqvz$art_obj.length; $art_ijimrjuo$art_i < $art_covzoojjqvs$art_c; $art_ijimrjuo$art_i++) {
                        var city = $art_objbznbwqvz$art_obj[$art_ijimrjuo$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
