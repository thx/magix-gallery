...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $p += '';
        $expr = '<%for (var typeIndex = 0, $art_cezdqhdym$art_c = types.length; typeIndex < $art_cezdqhdym$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cezdqhdym$art_c = types.length; typeIndex < $art_cezdqhdym$art_c; typeIndex++) {
    ...
    ;
    $p += '';
    $expr = '<%for (var typeIndex = 0, $art_csvomkdk$art_c = types.length; typeIndex < $art_csvomkdk$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_csvomkdk$art_c = types.length; typeIndex < $art_csvomkdk$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_objjbvxcwhcm$art_obj = type.groups, $art_clxnophhw$art_c = $art_objjbvxcwhcm$art_obj.length; groupIndex < $art_clxnophhw$art_c; groupIndex++) {        var group = $art_objjbvxcwhcm$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objjbvxcwhcm$art_obj = type.groups, $art_clxnophhw$art_c = $art_objjbvxcwhcm$art_obj.length; groupIndex < $art_clxnophhw$art_c; groupIndex++) {
            var group = $art_objjbvxcwhcm$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var areaIndex = 0, $art_cjnmxsi$art_c = group.length; areaIndex < $art_cjnmxsi$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjnmxsi$art_c = group.length; areaIndex < $art_cjnmxsi$art_c; areaIndex++) {
                ...
                ;
                $p += '';
                $expr = '<%for (var $art_ianfjicwfsj$art_i = 0, $art_objrzdcrl$art_obj = area.provinces, $art_celfle$art_c = $art_objrzdcrl$art_obj.length; $art_ianfjicwfsj$art_i < $art_celfle$art_c; $art_ianfjicwfsj$art_i++) {                var province = $art_objrzdcrl$art_obj[$art_ianfjicwfsj$art_i]%>';
                for (var $art_ianfjicwfsj$art_i = 0, $art_objrzdcrl$art_obj = area.provinces, $art_celfle$art_c = $art_objrzdcrl$art_obj.length; $art_ianfjicwfsj$art_i < $art_celfle$art_c; $art_ianfjicwfsj$art_i++) {
                    var province = $art_objrzdcrl$art_obj[$art_ianfjicwfsj$art_i];
                    ...
                    ;
                    $p += '';
                    $expr = '<%for (var $art_ilhzylegz$art_i = 0, $art_objxrkwrziyg$art_obj = province.cities, $art_ctonhsfswfi$art_c = $art_objxrkwrziyg$art_obj.length; $art_ilhzylegz$art_i < $art_ctonhsfswfi$art_c; $art_ilhzylegz$art_i++) {                    var city = $art_objxrkwrziyg$art_obj[$art_ilhzylegz$art_i]%>';
                    for (var $art_ilhzylegz$art_i = 0, $art_objxrkwrziyg$art_obj = province.cities, $art_ctonhsfswfi$art_c = $art_objxrkwrziyg$art_obj.length; $art_ilhzylegz$art_i < $art_ctonhsfswfi$art_c; $art_ilhzylegz$art_i++) {
                        var city = $art_objxrkwrziyg$art_obj[$art_ilhzylegz$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
