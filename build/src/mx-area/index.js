...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cqkgczg$art_c = types.length; typeIndex < $art_cqkgczg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cqkgczg$art_c = types.length; typeIndex < $art_cqkgczg$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cwswrzcowe$art_c = types.length; typeIndex < $art_cwswrzcowe$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cwswrzcowe$art_c = types.length; typeIndex < $art_cwswrzcowe$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objzdhu$art_obj = type.groups, $art_cjpqnwitl$art_c = $art_objzdhu$art_obj.length; groupIndex < $art_cjpqnwitl$art_c; groupIndex++) {        var group = $art_objzdhu$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objzdhu$art_obj = type.groups, $art_cjpqnwitl$art_c = $art_objzdhu$art_obj.length; groupIndex < $art_cjpqnwitl$art_c; groupIndex++) {
            var group = $art_objzdhu$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cbdvqoca$art_c = group.length; areaIndex < $art_cbdvqoca$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cbdvqoca$art_c = group.length; areaIndex < $art_cbdvqoca$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ivdwotonsp$art_i = 0, $art_objrfmrac$art_obj = area.provinces, $art_cdgrwkke$art_c = $art_objrfmrac$art_obj.length; $art_ivdwotonsp$art_i < $art_cdgrwkke$art_c; $art_ivdwotonsp$art_i++) {                var province = $art_objrfmrac$art_obj[$art_ivdwotonsp$art_i]%>';
                for (var $art_ivdwotonsp$art_i = 0, $art_objrfmrac$art_obj = area.provinces, $art_cdgrwkke$art_c = $art_objrfmrac$art_obj.length; $art_ivdwotonsp$art_i < $art_cdgrwkke$art_c; $art_ivdwotonsp$art_i++) {
                    var province = $art_objrfmrac$art_obj[$art_ivdwotonsp$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_idetxrfok$art_i = 0, $art_objlsayakrn$art_obj = province.cities, $art_cfqhmgh$art_c = $art_objlsayakrn$art_obj.length; $art_idetxrfok$art_i < $art_cfqhmgh$art_c; $art_idetxrfok$art_i++) {                    var city = $art_objlsayakrn$art_obj[$art_idetxrfok$art_i]%>';
                    for (var $art_idetxrfok$art_i = 0, $art_objlsayakrn$art_obj = province.cities, $art_cfqhmgh$art_c = $art_objlsayakrn$art_obj.length; $art_idetxrfok$art_i < $art_cfqhmgh$art_c; $art_idetxrfok$art_i++) {
                        var city = $art_objlsayakrn$art_obj[$art_idetxrfok$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
