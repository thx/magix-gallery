...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_crvvsbvah$art_c = types.length; typeIndex < $art_crvvsbvah$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_crvvsbvah$art_c = types.length; typeIndex < $art_crvvsbvah$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_chmikczien$art_c = types.length; typeIndex < $art_chmikczien$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_chmikczien$art_c = types.length; typeIndex < $art_chmikczien$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objjmcazhpjx$art_obj = type.groups, $art_cmxmfwirro$art_c = $art_objjmcazhpjx$art_obj.length; groupIndex < $art_cmxmfwirro$art_c; groupIndex++) {        var group = $art_objjmcazhpjx$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objjmcazhpjx$art_obj = type.groups, $art_cmxmfwirro$art_c = $art_objjmcazhpjx$art_obj.length; groupIndex < $art_cmxmfwirro$art_c; groupIndex++) {
            var group = $art_objjmcazhpjx$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ceuruwna$art_c = group.length; areaIndex < $art_ceuruwna$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ceuruwna$art_c = group.length; areaIndex < $art_ceuruwna$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ihzryahqy$art_i = 0, $art_objhffrgcgu$art_obj = area.provinces, $art_crkprhosjc$art_c = $art_objhffrgcgu$art_obj.length; $art_ihzryahqy$art_i < $art_crkprhosjc$art_c; $art_ihzryahqy$art_i++) {                var province = $art_objhffrgcgu$art_obj[$art_ihzryahqy$art_i]%>';
                for (var $art_ihzryahqy$art_i = 0, $art_objhffrgcgu$art_obj = area.provinces, $art_crkprhosjc$art_c = $art_objhffrgcgu$art_obj.length; $art_ihzryahqy$art_i < $art_crkprhosjc$art_c; $art_ihzryahqy$art_i++) {
                    var province = $art_objhffrgcgu$art_obj[$art_ihzryahqy$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iplcvxlka$art_i = 0, $art_objzzylafcwly$art_obj = province.cities, $art_cpmrryuzl$art_c = $art_objzzylafcwly$art_obj.length; $art_iplcvxlka$art_i < $art_cpmrryuzl$art_c; $art_iplcvxlka$art_i++) {                    var city = $art_objzzylafcwly$art_obj[$art_iplcvxlka$art_i]%>';
                    for (var $art_iplcvxlka$art_i = 0, $art_objzzylafcwly$art_obj = province.cities, $art_cpmrryuzl$art_c = $art_objzzylafcwly$art_obj.length; $art_iplcvxlka$art_i < $art_cpmrryuzl$art_c; $art_iplcvxlka$art_i++) {
                        var city = $art_objzzylafcwly$art_obj[$art_iplcvxlka$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
