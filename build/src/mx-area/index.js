...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cesfqeqg$art_c = types.length; typeIndex < $art_cesfqeqg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cesfqeqg$art_c = types.length; typeIndex < $art_cesfqeqg$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cbyctd$art_c = types.length; typeIndex < $art_cbyctd$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cbyctd$art_c = types.length; typeIndex < $art_cbyctd$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objdgzruqh$art_obj = type.groups, $art_cugmbqucd$art_c = $art_objdgzruqh$art_obj.length; groupIndex < $art_cugmbqucd$art_c; groupIndex++) {        var group = $art_objdgzruqh$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objdgzruqh$art_obj = type.groups, $art_cugmbqucd$art_c = $art_objdgzruqh$art_obj.length; groupIndex < $art_cugmbqucd$art_c; groupIndex++) {
            var group = $art_objdgzruqh$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cckiynpjfu$art_c = group.length; areaIndex < $art_cckiynpjfu$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cckiynpjfu$art_c = group.length; areaIndex < $art_cckiynpjfu$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iabdjdpqb$art_i = 0, $art_objhwipilia$art_obj = area.provinces, $art_cuqhpho$art_c = $art_objhwipilia$art_obj.length; $art_iabdjdpqb$art_i < $art_cuqhpho$art_c; $art_iabdjdpqb$art_i++) {                var province = $art_objhwipilia$art_obj[$art_iabdjdpqb$art_i]%>';
                for (var $art_iabdjdpqb$art_i = 0, $art_objhwipilia$art_obj = area.provinces, $art_cuqhpho$art_c = $art_objhwipilia$art_obj.length; $art_iabdjdpqb$art_i < $art_cuqhpho$art_c; $art_iabdjdpqb$art_i++) {
                    var province = $art_objhwipilia$art_obj[$art_iabdjdpqb$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_infatmxec$art_i = 0, $art_objyvyiele$art_obj = province.cities, $art_cvuvarrg$art_c = $art_objyvyiele$art_obj.length; $art_infatmxec$art_i < $art_cvuvarrg$art_c; $art_infatmxec$art_i++) {                    var city = $art_objyvyiele$art_obj[$art_infatmxec$art_i]%>';
                    for (var $art_infatmxec$art_i = 0, $art_objyvyiele$art_obj = province.cities, $art_cvuvarrg$art_c = $art_objyvyiele$art_obj.length; $art_infatmxec$art_i < $art_cvuvarrg$art_c; $art_infatmxec$art_i++) {
                        var city = $art_objyvyiele$art_obj[$art_infatmxec$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
