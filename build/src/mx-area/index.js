...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $p += '';
        $expr = '<%for (var typeIndex = 0, $art_cxdnjm$art_c = types.length; typeIndex < $art_cxdnjm$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cxdnjm$art_c = types.length; typeIndex < $art_cxdnjm$art_c; typeIndex++) {
    ...
    ;
    $p += '';
    $expr = '<%for (var typeIndex = 0, $art_czzamsfb$art_c = types.length; typeIndex < $art_czzamsfb$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_czzamsfb$art_c = types.length; typeIndex < $art_czzamsfb$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_objyeioyadu$art_obj = type.groups, $art_cpjddxvvc$art_c = $art_objyeioyadu$art_obj.length; groupIndex < $art_cpjddxvvc$art_c; groupIndex++) {        var group = $art_objyeioyadu$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objyeioyadu$art_obj = type.groups, $art_cpjddxvvc$art_c = $art_objyeioyadu$art_obj.length; groupIndex < $art_cpjddxvvc$art_c; groupIndex++) {
            var group = $art_objyeioyadu$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var areaIndex = 0, $art_cvbylkxh$art_c = group.length; areaIndex < $art_cvbylkxh$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cvbylkxh$art_c = group.length; areaIndex < $art_cvbylkxh$art_c; areaIndex++) {
                ...
                ;
                $p += '';
                $expr = '<%for (var $art_idpmqkbih$art_i = 0, $art_objmzloh$art_obj = area.provinces, $art_crflpptms$art_c = $art_objmzloh$art_obj.length; $art_idpmqkbih$art_i < $art_crflpptms$art_c; $art_idpmqkbih$art_i++) {                var province = $art_objmzloh$art_obj[$art_idpmqkbih$art_i]%>';
                for (var $art_idpmqkbih$art_i = 0, $art_objmzloh$art_obj = area.provinces, $art_crflpptms$art_c = $art_objmzloh$art_obj.length; $art_idpmqkbih$art_i < $art_crflpptms$art_c; $art_idpmqkbih$art_i++) {
                    var province = $art_objmzloh$art_obj[$art_idpmqkbih$art_i];
                    ...
                    ;
                    $p += '';
                    $expr = '<%for (var $art_iiklhoowfeo$art_i = 0, $art_objpgwtvl$art_obj = province.cities, $art_cdipedi$art_c = $art_objpgwtvl$art_obj.length; $art_iiklhoowfeo$art_i < $art_cdipedi$art_c; $art_iiklhoowfeo$art_i++) {                    var city = $art_objpgwtvl$art_obj[$art_iiklhoowfeo$art_i]%>';
                    for (var $art_iiklhoowfeo$art_i = 0, $art_objpgwtvl$art_obj = province.cities, $art_cdipedi$art_c = $art_objpgwtvl$art_obj.length; $art_iiklhoowfeo$art_i < $art_cdipedi$art_c; $art_iiklhoowfeo$art_i++) {
                        var city = $art_objpgwtvl$art_obj[$art_iiklhoowfeo$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
