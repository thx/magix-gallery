...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_crvzexqya$art_c = types.length; typeIndex < $art_crvzexqya$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_crvzexqya$art_c = types.length; typeIndex < $art_crvzexqya$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cmxcxmwzo$art_c = types.length; typeIndex < $art_cmxcxmwzo$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cmxcxmwzo$art_c = types.length; typeIndex < $art_cmxcxmwzo$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objwhckbjcwg$art_obj = type.groups, $art_cwzgama$art_c = $art_objwhckbjcwg$art_obj.length; groupIndex < $art_cwzgama$art_c; groupIndex++) {        var group = $art_objwhckbjcwg$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objwhckbjcwg$art_obj = type.groups, $art_cwzgama$art_c = $art_objwhckbjcwg$art_obj.length; groupIndex < $art_cwzgama$art_c; groupIndex++) {
            var group = $art_objwhckbjcwg$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cztlnptb$art_c = group.length; areaIndex < $art_cztlnptb$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cztlnptb$art_c = group.length; areaIndex < $art_cztlnptb$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iugshckq$art_i = 0, $art_objzlayufzm$art_obj = area.provinces, $art_cnfzuwzu$art_c = $art_objzlayufzm$art_obj.length; $art_iugshckq$art_i < $art_cnfzuwzu$art_c; $art_iugshckq$art_i++) {                var province = $art_objzlayufzm$art_obj[$art_iugshckq$art_i]%>';
                for (var $art_iugshckq$art_i = 0, $art_objzlayufzm$art_obj = area.provinces, $art_cnfzuwzu$art_c = $art_objzlayufzm$art_obj.length; $art_iugshckq$art_i < $art_cnfzuwzu$art_c; $art_iugshckq$art_i++) {
                    var province = $art_objzlayufzm$art_obj[$art_iugshckq$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_irnyndg$art_i = 0, $art_objkjzshfannd$art_obj = province.cities, $art_cjrswggwah$art_c = $art_objkjzshfannd$art_obj.length; $art_irnyndg$art_i < $art_cjrswggwah$art_c; $art_irnyndg$art_i++) {                    var city = $art_objkjzshfannd$art_obj[$art_irnyndg$art_i]%>';
                    for (var $art_irnyndg$art_i = 0, $art_objkjzshfannd$art_obj = province.cities, $art_cjrswggwah$art_c = $art_objkjzshfannd$art_obj.length; $art_irnyndg$art_i < $art_cjrswggwah$art_c; $art_irnyndg$art_i++) {
                        var city = $art_objkjzshfannd$art_obj[$art_irnyndg$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
