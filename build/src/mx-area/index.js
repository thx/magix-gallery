...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ctsgegmrbo$art_c = types.length; typeIndex < $art_ctsgegmrbo$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ctsgegmrbo$art_c = types.length; typeIndex < $art_ctsgegmrbo$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cckmuzqor$art_c = types.length; typeIndex < $art_cckmuzqor$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cckmuzqor$art_c = types.length; typeIndex < $art_cckmuzqor$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objbgykoit$art_obj = type.groups, $art_cyemqeh$art_c = $art_objbgykoit$art_obj.length; groupIndex < $art_cyemqeh$art_c; groupIndex++) {        var group = $art_objbgykoit$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objbgykoit$art_obj = type.groups, $art_cyemqeh$art_c = $art_objbgykoit$art_obj.length; groupIndex < $art_cyemqeh$art_c; groupIndex++) {
            var group = $art_objbgykoit$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_canfuede$art_c = group.length; areaIndex < $art_canfuede$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_canfuede$art_c = group.length; areaIndex < $art_canfuede$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iyrlqfswo$art_i = 0, $art_objddxnttjuz$art_obj = area.provinces, $art_cwhgwsvgwl$art_c = $art_objddxnttjuz$art_obj.length; $art_iyrlqfswo$art_i < $art_cwhgwsvgwl$art_c; $art_iyrlqfswo$art_i++) {                var province = $art_objddxnttjuz$art_obj[$art_iyrlqfswo$art_i]%>';
                for (var $art_iyrlqfswo$art_i = 0, $art_objddxnttjuz$art_obj = area.provinces, $art_cwhgwsvgwl$art_c = $art_objddxnttjuz$art_obj.length; $art_iyrlqfswo$art_i < $art_cwhgwsvgwl$art_c; $art_iyrlqfswo$art_i++) {
                    var province = $art_objddxnttjuz$art_obj[$art_iyrlqfswo$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ibucjtmfsw$art_i = 0, $art_objvwkklqwl$art_obj = province.cities, $art_cbqddsa$art_c = $art_objvwkklqwl$art_obj.length; $art_ibucjtmfsw$art_i < $art_cbqddsa$art_c; $art_ibucjtmfsw$art_i++) {                    var city = $art_objvwkklqwl$art_obj[$art_ibucjtmfsw$art_i]%>';
                    for (var $art_ibucjtmfsw$art_i = 0, $art_objvwkklqwl$art_obj = province.cities, $art_cbqddsa$art_c = $art_objvwkklqwl$art_obj.length; $art_ibucjtmfsw$art_i < $art_cbqddsa$art_c; $art_ibucjtmfsw$art_i++) {
                        var city = $art_objvwkklqwl$art_obj[$art_ibucjtmfsw$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
