...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ctiqodlcpvca$art_c = types.length; typeIndex < $art_ctiqodlcpvca$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ctiqodlcpvca$art_c = types.length; typeIndex < $art_ctiqodlcpvca$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cfmmwmnyjbf$art_c = types.length; typeIndex < $art_cfmmwmnyjbf$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cfmmwmnyjbf$art_c = types.length; typeIndex < $art_cfmmwmnyjbf$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objeallqjc$art_obj = type.groups, $art_cwzkpssafym$art_c = $art_objeallqjc$art_obj.length; groupIndex < $art_cwzkpssafym$art_c; groupIndex++) {        var group = $art_objeallqjc$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objeallqjc$art_obj = type.groups, $art_cwzkpssafym$art_c = $art_objeallqjc$art_obj.length; groupIndex < $art_cwzkpssafym$art_c; groupIndex++) {
            var group = $art_objeallqjc$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cxxlzchg$art_c = group.length; areaIndex < $art_cxxlzchg$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cxxlzchg$art_c = group.length; areaIndex < $art_cxxlzchg$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ivtmyncqbo$art_i = 0, $art_objciauhbe$art_obj = area.provinces, $art_cqeuwdcbskv$art_c = $art_objciauhbe$art_obj.length; $art_ivtmyncqbo$art_i < $art_cqeuwdcbskv$art_c; $art_ivtmyncqbo$art_i++) {                var province = $art_objciauhbe$art_obj[$art_ivtmyncqbo$art_i]%>';
                for (var $art_ivtmyncqbo$art_i = 0, $art_objciauhbe$art_obj = area.provinces, $art_cqeuwdcbskv$art_c = $art_objciauhbe$art_obj.length; $art_ivtmyncqbo$art_i < $art_cqeuwdcbskv$art_c; $art_ivtmyncqbo$art_i++) {
                    var province = $art_objciauhbe$art_obj[$art_ivtmyncqbo$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ixesxni$art_i = 0, $art_objvhczkgko$art_obj = province.cities, $art_czuquopnm$art_c = $art_objvhczkgko$art_obj.length; $art_ixesxni$art_i < $art_czuquopnm$art_c; $art_ixesxni$art_i++) {                    var city = $art_objvhczkgko$art_obj[$art_ixesxni$art_i]%>';
                    for (var $art_ixesxni$art_i = 0, $art_objvhczkgko$art_obj = province.cities, $art_czuquopnm$art_c = $art_objvhczkgko$art_obj.length; $art_ixesxni$art_i < $art_czuquopnm$art_c; $art_ixesxni$art_i++) {
                        var city = $art_objvhczkgko$art_obj[$art_ixesxni$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
