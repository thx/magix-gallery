...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cnihliq$art_c = types.length; typeIndex < $art_cnihliq$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cnihliq$art_c = types.length; typeIndex < $art_cnihliq$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cvgyfltd$art_c = types.length; typeIndex < $art_cvgyfltd$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cvgyfltd$art_c = types.length; typeIndex < $art_cvgyfltd$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objztlhteuvyj$art_obj = type.groups, $art_cweyhmuj$art_c = $art_objztlhteuvyj$art_obj.length; groupIndex < $art_cweyhmuj$art_c; groupIndex++) {        var group = $art_objztlhteuvyj$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objztlhteuvyj$art_obj = type.groups, $art_cweyhmuj$art_c = $art_objztlhteuvyj$art_obj.length; groupIndex < $art_cweyhmuj$art_c; groupIndex++) {
            var group = $art_objztlhteuvyj$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cludvsza$art_c = group.length; areaIndex < $art_cludvsza$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cludvsza$art_c = group.length; areaIndex < $art_cludvsza$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_itomlrhklg$art_i = 0, $art_objxvhmjaidnv$art_obj = area.provinces, $art_cxkzkndy$art_c = $art_objxvhmjaidnv$art_obj.length; $art_itomlrhklg$art_i < $art_cxkzkndy$art_c; $art_itomlrhklg$art_i++) {                var province = $art_objxvhmjaidnv$art_obj[$art_itomlrhklg$art_i]%>';
                for (var $art_itomlrhklg$art_i = 0, $art_objxvhmjaidnv$art_obj = area.provinces, $art_cxkzkndy$art_c = $art_objxvhmjaidnv$art_obj.length; $art_itomlrhklg$art_i < $art_cxkzkndy$art_c; $art_itomlrhklg$art_i++) {
                    var province = $art_objxvhmjaidnv$art_obj[$art_itomlrhklg$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ihioarlffztw$art_i = 0, $art_objjcxvuln$art_obj = province.cities, $art_cndgcdhapd$art_c = $art_objjcxvuln$art_obj.length; $art_ihioarlffztw$art_i < $art_cndgcdhapd$art_c; $art_ihioarlffztw$art_i++) {                    var city = $art_objjcxvuln$art_obj[$art_ihioarlffztw$art_i]%>';
                    for (var $art_ihioarlffztw$art_i = 0, $art_objjcxvuln$art_obj = province.cities, $art_cndgcdhapd$art_c = $art_objjcxvuln$art_obj.length; $art_ihioarlffztw$art_i < $art_cndgcdhapd$art_c; $art_ihioarlffztw$art_i++) {
                        var city = $art_objjcxvuln$art_obj[$art_ihioarlffztw$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
