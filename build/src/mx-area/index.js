...
module.exports = Magix.View.extend({
    ...
    $$ref = $$; var $g = '', $_temp, $p = '', $em = { '&': 'amp', '<': 'lt', '>': 'gt', '"': '#34', '\'': '#39', '`': '#96' }, $er = /[&<>"'`]/g, $n = function (v) { return '' + (v == null ? '' : v); }, $ef = function (m) { return "&" + $em[m] + ";"; }, $e = function (v) { return $n(v).replace($er, $ef); }, $um = { '!': '%21', '\'': '%27', '(': '%28', ')': '%29', '*': '%2A' }, $uf = function (m) { return $um[m]; }, $uq = /[!')(*]/g, $eu = function (v) { return encodeURIComponent($n(v)).replace($uq, $uf); }, $qr = /[\\'"]/g, $eq = function (v) { return $n(v).replace($qr, '\\$&'); }, isTab = $$.isTab, placeholder = $$.placeholder, types = $$.types, curTab = $$.curTab, viewId = $$.viewId, showProvinceId = $$.showProvinceId; var $expr, $art, $line; try {
    ...
    ;
    $p += '"><i mxs="_zs_galleryF:_" class="mc-iconfont search-icon">&#xe651;</i><input mx-keyup="' + $viewId + '@{search}()" class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (isTab) {
        ;
        $p += '<div mxv mxa="_zs_galleryF:_" class="_zs_gallery_mx-area_index_-tabs clearfix">';
        $line = 7;
        $art = 'each types as type typeIndex';
        ;
        $p += '';
        $expr = '<%for(var typeIndex=0;typeIndex<types.length;typeIndex++){var type=types[typeIndex]%>';
        for (var typeIndex = 0; typeIndex < types.length; typeIndex++) {
            ...
            ;
            $p += ' clearfix"><div mxv mxa="_zs_galleryF:a" class="_zs_gallery_mx-area_index_-tab-check"><input type="checkbox" mx-change="' + $viewId + '@{changeAll}({typeIndex:';
            $line = 11;
            $art = '=typeIndex';
            ;
    ...
    for (var typeIndex = 0; typeIndex < types.length; typeIndex++) {
        ...
        if (!isTab) {
            ;
            $p += '<div mxv mxa="_zs_galleryF:b" class="_zs_gallery_mx-area_index_-all"><label mxv for="';
            $line = 25;
            $art = '=viewId';
            ;
            ...
            ;
            $p += '/><span mxa="_zs_galleryF:c" class="ml5">全选 - ';
            $line = 27;
            $art = '=type.name';
            ;
        ...
        ;
        $p += '<div mxv mxa="_zs_galleryF:d" class="clearfix">';
        $line = 32;
        $art = 'each type.groups as group groupIndex';
        ;
        $p += '';
        $expr = '<%for(var groupIndex=0,$art_objvzuaduwe$art_obj=type.groups;groupIndex<$art_objvzuaduwe$art_obj.length;groupIndex++){var group=$art_objvzuaduwe$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objvzuaduwe$art_obj = type.groups; groupIndex < $art_objvzuaduwe$art_obj.length; groupIndex++) {
            var group = $art_objvzuaduwe$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for(var areaIndex=0;areaIndex<group.length;areaIndex++){var area=group[areaIndex]%>';
            for (var areaIndex = 0; areaIndex < group.length; areaIndex++) {
                ...
                if (area.name) {
                    ;
                    $p += '<div mxv mxa="_zs_galleryF:e" class="_zs_gallery_mx-area_index_-area"><div mxa="_zs_galleryF:f" class="_zs_gallery_mx-area_index_-area-name">';
                    $line = 37;
                    $art = '=area.name';
                    ;
                ...
                ;
                $p += '<div mxv mxa="_zs_galleryF:g" class="_zs_gallery_mx-area_index_-provinces clearfix">';
                $line = 40;
                $art = 'each area.provinces as province';
                ;
                $p += '';
                $expr = '<%for(var $art_igkqwvgiuqn$art_i=0,$art_objofybmuron$art_obj=area.provinces;$art_igkqwvgiuqn$art_i<$art_objofybmuron$art_obj.length;$art_igkqwvgiuqn$art_i++){var province=$art_objofybmuron$art_obj[$art_igkqwvgiuqn$art_i]%>';
                for (var $art_igkqwvgiuqn$art_i = 0, $art_objofybmuron$art_obj = area.provinces; $art_igkqwvgiuqn$art_i < $art_objofybmuron$art_obj.length; $art_igkqwvgiuqn$art_i++) {
                    var province = $art_objofybmuron$art_obj[$art_igkqwvgiuqn$art_i];
                    ...
                    if (province.hasCity && (province.count > 0)) {
                        ;
                        $p += '<span mxa="_zs_galleryF:h" class="bold font-tahoma">(';
                        $line = 46;
                        $art = '=province.count';
                        ;
                    ...
                    ;
                    $p += '';
                    $expr = '<%for(var $art_ihvcmwycwp$art_i=0,$art_objgkvmpza$art_obj=province.cities;$art_ihvcmwycwp$art_i<$art_objgkvmpza$art_obj.length;$art_ihvcmwycwp$art_i++){var city=$art_objgkvmpza$art_obj[$art_ihvcmwycwp$art_i]%>';
                    for (var $art_ihvcmwycwp$art_i = 0, $art_objgkvmpza$art_obj = province.cities; $art_ihvcmwycwp$art_i < $art_objgkvmpza$art_obj.length; $art_ihvcmwycwp$art_i++) {
                        var city = $art_objgkvmpza$art_obj[$art_ihvcmwycwp$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
