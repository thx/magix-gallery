...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_coimrfrtv$art_c = types.length; typeIndex < $art_coimrfrtv$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_coimrfrtv$art_c = types.length; typeIndex < $art_coimrfrtv$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ccnuke$art_c = types.length; typeIndex < $art_ccnuke$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ccnuke$art_c = types.length; typeIndex < $art_ccnuke$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objgzbttqon$art_obj = type.groups, $art_cdiisefd$art_c = $art_objgzbttqon$art_obj.length; groupIndex < $art_cdiisefd$art_c; groupIndex++) {        var group = $art_objgzbttqon$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objgzbttqon$art_obj = type.groups, $art_cdiisefd$art_c = $art_objgzbttqon$art_obj.length; groupIndex < $art_cdiisefd$art_c; groupIndex++) {
            var group = $art_objgzbttqon$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ckzwsnytn$art_c = group.length; areaIndex < $art_ckzwsnytn$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ckzwsnytn$art_c = group.length; areaIndex < $art_ckzwsnytn$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_imabsuxni$art_i = 0, $art_objqzjooyiws$art_obj = area.provinces, $art_cyhohgrmnbd$art_c = $art_objqzjooyiws$art_obj.length; $art_imabsuxni$art_i < $art_cyhohgrmnbd$art_c; $art_imabsuxni$art_i++) {                var province = $art_objqzjooyiws$art_obj[$art_imabsuxni$art_i]%>';
                for (var $art_imabsuxni$art_i = 0, $art_objqzjooyiws$art_obj = area.provinces, $art_cyhohgrmnbd$art_c = $art_objqzjooyiws$art_obj.length; $art_imabsuxni$art_i < $art_cyhohgrmnbd$art_c; $art_imabsuxni$art_i++) {
                    var province = $art_objqzjooyiws$art_obj[$art_imabsuxni$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_isjhuot$art_i = 0, $art_objzlxkwl$art_obj = province.cities, $art_crrjeiqydk$art_c = $art_objzlxkwl$art_obj.length; $art_isjhuot$art_i < $art_crrjeiqydk$art_c; $art_isjhuot$art_i++) {                    var city = $art_objzlxkwl$art_obj[$art_isjhuot$art_i]%>';
                    for (var $art_isjhuot$art_i = 0, $art_objzlxkwl$art_obj = province.cities, $art_crrjeiqydk$art_c = $art_objzlxkwl$art_obj.length; $art_isjhuot$art_i < $art_crrjeiqydk$art_c; $art_isjhuot$art_i++) {
                        var city = $art_objzlxkwl$art_obj[$art_isjhuot$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
