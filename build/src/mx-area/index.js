...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cuihpe$art_c = types.length; typeIndex < $art_cuihpe$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cuihpe$art_c = types.length; typeIndex < $art_cuihpe$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cseirluk$art_c = types.length; typeIndex < $art_cseirluk$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cseirluk$art_c = types.length; typeIndex < $art_cseirluk$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objaja$art_obj = type.groups, $art_cuvsvis$art_c = $art_objaja$art_obj.length; groupIndex < $art_cuvsvis$art_c; groupIndex++) {        var group = $art_objaja$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objaja$art_obj = type.groups, $art_cuvsvis$art_c = $art_objaja$art_obj.length; groupIndex < $art_cuvsvis$art_c; groupIndex++) {
            var group = $art_objaja$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjaibha$art_c = group.length; areaIndex < $art_cjaibha$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjaibha$art_c = group.length; areaIndex < $art_cjaibha$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_icsvnefj$art_i = 0, $art_objzbkkkmqx$art_obj = area.provinces, $art_cwadbwaegm$art_c = $art_objzbkkkmqx$art_obj.length; $art_icsvnefj$art_i < $art_cwadbwaegm$art_c; $art_icsvnefj$art_i++) {                var province = $art_objzbkkkmqx$art_obj[$art_icsvnefj$art_i]%>';
                for (var $art_icsvnefj$art_i = 0, $art_objzbkkkmqx$art_obj = area.provinces, $art_cwadbwaegm$art_c = $art_objzbkkkmqx$art_obj.length; $art_icsvnefj$art_i < $art_cwadbwaegm$art_c; $art_icsvnefj$art_i++) {
                    var province = $art_objzbkkkmqx$art_obj[$art_icsvnefj$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ibvvz$art_i = 0, $art_objzpgscx$art_obj = province.cities, $art_coixuvpi$art_c = $art_objzpgscx$art_obj.length; $art_ibvvz$art_i < $art_coixuvpi$art_c; $art_ibvvz$art_i++) {                    var city = $art_objzpgscx$art_obj[$art_ibvvz$art_i]%>';
                    for (var $art_ibvvz$art_i = 0, $art_objzpgscx$art_obj = province.cities, $art_coixuvpi$art_c = $art_objzpgscx$art_obj.length; $art_ibvvz$art_i < $art_coixuvpi$art_c; $art_ibvvz$art_i++) {
                        var city = $art_objzpgscx$art_obj[$art_ibvvz$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
