...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbyyfwpb$art_c = types.length; typeIndex < $art_cbyyfwpb$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbyyfwpb$art_c = types.length; typeIndex < $art_cbyyfwpb$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ceyzbhlpmv$art_c = types.length; typeIndex < $art_ceyzbhlpmv$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ceyzbhlpmv$art_c = types.length; typeIndex < $art_ceyzbhlpmv$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objtbqzki$art_obj = type.groups, $art_cubfmkvb$art_c = $art_objtbqzki$art_obj.length; groupIndex < $art_cubfmkvb$art_c; groupIndex++) {        var group = $art_objtbqzki$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objtbqzki$art_obj = type.groups, $art_cubfmkvb$art_c = $art_objtbqzki$art_obj.length; groupIndex < $art_cubfmkvb$art_c; groupIndex++) {
            var group = $art_objtbqzki$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjomrckcn$art_c = group.length; areaIndex < $art_cjomrckcn$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjomrckcn$art_c = group.length; areaIndex < $art_cjomrckcn$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_idsnkhebt$art_i = 0, $art_objazeudwn$art_obj = area.provinces, $art_cdotndlnie$art_c = $art_objazeudwn$art_obj.length; $art_idsnkhebt$art_i < $art_cdotndlnie$art_c; $art_idsnkhebt$art_i++) {                var province = $art_objazeudwn$art_obj[$art_idsnkhebt$art_i]%>';
                for (var $art_idsnkhebt$art_i = 0, $art_objazeudwn$art_obj = area.provinces, $art_cdotndlnie$art_c = $art_objazeudwn$art_obj.length; $art_idsnkhebt$art_i < $art_cdotndlnie$art_c; $art_idsnkhebt$art_i++) {
                    var province = $art_objazeudwn$art_obj[$art_idsnkhebt$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_isggxnpk$art_i = 0, $art_objehnoxaxju$art_obj = province.cities, $art_cmbpalprfk$art_c = $art_objehnoxaxju$art_obj.length; $art_isggxnpk$art_i < $art_cmbpalprfk$art_c; $art_isggxnpk$art_i++) {                    var city = $art_objehnoxaxju$art_obj[$art_isggxnpk$art_i]%>';
                    for (var $art_isggxnpk$art_i = 0, $art_objehnoxaxju$art_obj = province.cities, $art_cmbpalprfk$art_c = $art_objehnoxaxju$art_obj.length; $art_isggxnpk$art_i < $art_cmbpalprfk$art_c; $art_isggxnpk$art_i++) {
                        var city = $art_objehnoxaxju$art_obj[$art_isggxnpk$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
