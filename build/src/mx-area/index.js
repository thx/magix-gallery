...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cezqcgjf$art_c = types.length; typeIndex < $art_cezqcgjf$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cezqcgjf$art_c = types.length; typeIndex < $art_cezqcgjf$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_czzrwhbg$art_c = types.length; typeIndex < $art_czzrwhbg$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_czzrwhbg$art_c = types.length; typeIndex < $art_czzrwhbg$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objzriyeif$art_obj = type.groups, $art_cyfnnzipo$art_c = $art_objzriyeif$art_obj.length; groupIndex < $art_cyfnnzipo$art_c; groupIndex++) {        var group = $art_objzriyeif$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objzriyeif$art_obj = type.groups, $art_cyfnnzipo$art_c = $art_objzriyeif$art_obj.length; groupIndex < $art_cyfnnzipo$art_c; groupIndex++) {
            var group = $art_objzriyeif$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cigkjidyri$art_c = group.length; areaIndex < $art_cigkjidyri$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cigkjidyri$art_c = group.length; areaIndex < $art_cigkjidyri$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_idmrqywqgfh$art_i = 0, $art_objccqmii$art_obj = area.provinces, $art_cwklvdkvm$art_c = $art_objccqmii$art_obj.length; $art_idmrqywqgfh$art_i < $art_cwklvdkvm$art_c; $art_idmrqywqgfh$art_i++) {                var province = $art_objccqmii$art_obj[$art_idmrqywqgfh$art_i]%>';
                for (var $art_idmrqywqgfh$art_i = 0, $art_objccqmii$art_obj = area.provinces, $art_cwklvdkvm$art_c = $art_objccqmii$art_obj.length; $art_idmrqywqgfh$art_i < $art_cwklvdkvm$art_c; $art_idmrqywqgfh$art_i++) {
                    var province = $art_objccqmii$art_obj[$art_idmrqywqgfh$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_itnimczypn$art_i = 0, $art_objdzlsqgh$art_obj = province.cities, $art_chbqmr$art_c = $art_objdzlsqgh$art_obj.length; $art_itnimczypn$art_i < $art_chbqmr$art_c; $art_itnimczypn$art_i++) {                    var city = $art_objdzlsqgh$art_obj[$art_itnimczypn$art_i]%>';
                    for (var $art_itnimczypn$art_i = 0, $art_objdzlsqgh$art_obj = province.cities, $art_chbqmr$art_c = $art_objdzlsqgh$art_obj.length; $art_itnimczypn$art_i < $art_chbqmr$art_c; $art_itnimczypn$art_i++) {
                        var city = $art_objdzlsqgh$art_obj[$art_itnimczypn$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
