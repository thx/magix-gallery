...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cjxywygya$art_c = types.length; typeIndex < $art_cjxywygya$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cjxywygya$art_c = types.length; typeIndex < $art_cjxywygya$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cebgnigq$art_c = types.length; typeIndex < $art_cebgnigq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cebgnigq$art_c = types.length; typeIndex < $art_cebgnigq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objthhoyswsf$art_obj = type.groups, $art_ctxemlabrhy$art_c = $art_objthhoyswsf$art_obj.length; groupIndex < $art_ctxemlabrhy$art_c; groupIndex++) {        var group = $art_objthhoyswsf$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objthhoyswsf$art_obj = type.groups, $art_ctxemlabrhy$art_c = $art_objthhoyswsf$art_obj.length; groupIndex < $art_ctxemlabrhy$art_c; groupIndex++) {
            var group = $art_objthhoyswsf$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cindoeo$art_c = group.length; areaIndex < $art_cindoeo$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cindoeo$art_c = group.length; areaIndex < $art_cindoeo$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilcuhveeao$art_i = 0, $art_objxinfxa$art_obj = area.provinces, $art_crtnrnjye$art_c = $art_objxinfxa$art_obj.length; $art_ilcuhveeao$art_i < $art_crtnrnjye$art_c; $art_ilcuhveeao$art_i++) {                var province = $art_objxinfxa$art_obj[$art_ilcuhveeao$art_i]%>';
                for (var $art_ilcuhveeao$art_i = 0, $art_objxinfxa$art_obj = area.provinces, $art_crtnrnjye$art_c = $art_objxinfxa$art_obj.length; $art_ilcuhveeao$art_i < $art_crtnrnjye$art_c; $art_ilcuhveeao$art_i++) {
                    var province = $art_objxinfxa$art_obj[$art_ilcuhveeao$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iyvgeiavlq$art_i = 0, $art_objingbrwuhr$art_obj = province.cities, $art_crueljqyc$art_c = $art_objingbrwuhr$art_obj.length; $art_iyvgeiavlq$art_i < $art_crueljqyc$art_c; $art_iyvgeiavlq$art_i++) {                    var city = $art_objingbrwuhr$art_obj[$art_iyvgeiavlq$art_i]%>';
                    for (var $art_iyvgeiavlq$art_i = 0, $art_objingbrwuhr$art_obj = province.cities, $art_crueljqyc$art_c = $art_objingbrwuhr$art_obj.length; $art_iyvgeiavlq$art_i < $art_crueljqyc$art_c; $art_iyvgeiavlq$art_i++) {
                        var city = $art_objingbrwuhr$art_obj[$art_iyvgeiavlq$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
