...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbrehwvdrkv$art_c = types.length; typeIndex < $art_cbrehwvdrkv$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbrehwvdrkv$art_c = types.length; typeIndex < $art_cbrehwvdrkv$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cpucdzchc$art_c = types.length; typeIndex < $art_cpucdzchc$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cpucdzchc$art_c = types.length; typeIndex < $art_cpucdzchc$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objkonwsgftc$art_obj = type.groups, $art_cguykmkoxeb$art_c = $art_objkonwsgftc$art_obj.length; groupIndex < $art_cguykmkoxeb$art_c; groupIndex++) {        var group = $art_objkonwsgftc$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objkonwsgftc$art_obj = type.groups, $art_cguykmkoxeb$art_c = $art_objkonwsgftc$art_obj.length; groupIndex < $art_cguykmkoxeb$art_c; groupIndex++) {
            var group = $art_objkonwsgftc$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_czrzabubc$art_c = group.length; areaIndex < $art_czrzabubc$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_czrzabubc$art_c = group.length; areaIndex < $art_czrzabubc$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ivitwkj$art_i = 0, $art_objnsjtphhtl$art_obj = area.provinces, $art_corvibie$art_c = $art_objnsjtphhtl$art_obj.length; $art_ivitwkj$art_i < $art_corvibie$art_c; $art_ivitwkj$art_i++) {                var province = $art_objnsjtphhtl$art_obj[$art_ivitwkj$art_i]%>';
                for (var $art_ivitwkj$art_i = 0, $art_objnsjtphhtl$art_obj = area.provinces, $art_corvibie$art_c = $art_objnsjtphhtl$art_obj.length; $art_ivitwkj$art_i < $art_corvibie$art_c; $art_ivitwkj$art_i++) {
                    var province = $art_objnsjtphhtl$art_obj[$art_ivitwkj$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imtywjbnhy$art_i = 0, $art_objikkufekm$art_obj = province.cities, $art_ceeiswg$art_c = $art_objikkufekm$art_obj.length; $art_imtywjbnhy$art_i < $art_ceeiswg$art_c; $art_imtywjbnhy$art_i++) {                    var city = $art_objikkufekm$art_obj[$art_imtywjbnhy$art_i]%>';
                    for (var $art_imtywjbnhy$art_i = 0, $art_objikkufekm$art_obj = province.cities, $art_ceeiswg$art_c = $art_objikkufekm$art_obj.length; $art_imtywjbnhy$art_i < $art_ceeiswg$art_c; $art_imtywjbnhy$art_i++) {
                        var city = $art_objikkufekm$art_obj[$art_imtywjbnhy$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
