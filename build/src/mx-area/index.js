...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cuwqxvpf$art_c = types.length; typeIndex < $art_cuwqxvpf$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cuwqxvpf$art_c = types.length; typeIndex < $art_cuwqxvpf$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cqwnkmqnwh$art_c = types.length; typeIndex < $art_cqwnkmqnwh$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cqwnkmqnwh$art_c = types.length; typeIndex < $art_cqwnkmqnwh$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objuhtslyid$art_obj = type.groups, $art_cpcuxzvsd$art_c = $art_objuhtslyid$art_obj.length; groupIndex < $art_cpcuxzvsd$art_c; groupIndex++) {        var group = $art_objuhtslyid$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objuhtslyid$art_obj = type.groups, $art_cpcuxzvsd$art_c = $art_objuhtslyid$art_obj.length; groupIndex < $art_cpcuxzvsd$art_c; groupIndex++) {
            var group = $art_objuhtslyid$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ckpnqd$art_c = group.length; areaIndex < $art_ckpnqd$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ckpnqd$art_c = group.length; areaIndex < $art_ckpnqd$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ilftijyds$art_i = 0, $art_objestsokxyo$art_obj = area.provinces, $art_cxzfzyunq$art_c = $art_objestsokxyo$art_obj.length; $art_ilftijyds$art_i < $art_cxzfzyunq$art_c; $art_ilftijyds$art_i++) {                var province = $art_objestsokxyo$art_obj[$art_ilftijyds$art_i]%>';
                for (var $art_ilftijyds$art_i = 0, $art_objestsokxyo$art_obj = area.provinces, $art_cxzfzyunq$art_c = $art_objestsokxyo$art_obj.length; $art_ilftijyds$art_i < $art_cxzfzyunq$art_c; $art_ilftijyds$art_i++) {
                    var province = $art_objestsokxyo$art_obj[$art_ilftijyds$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imajltyl$art_i = 0, $art_objhmgsxif$art_obj = province.cities, $art_crabctrixro$art_c = $art_objhmgsxif$art_obj.length; $art_imajltyl$art_i < $art_crabctrixro$art_c; $art_imajltyl$art_i++) {                    var city = $art_objhmgsxif$art_obj[$art_imajltyl$art_i]%>';
                    for (var $art_imajltyl$art_i = 0, $art_objhmgsxif$art_obj = province.cities, $art_crabctrixro$art_c = $art_objhmgsxif$art_obj.length; $art_imajltyl$art_i < $art_crabctrixro$art_c; $art_imajltyl$art_i++) {
                        var city = $art_objhmgsxif$art_obj[$art_imajltyl$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
