...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_crmgmobv$art_c = types.length; typeIndex < $art_crmgmobv$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_crmgmobv$art_c = types.length; typeIndex < $art_crmgmobv$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cuqqksbq$art_c = types.length; typeIndex < $art_cuqqksbq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cuqqksbq$art_c = types.length; typeIndex < $art_cuqqksbq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objdxaxozxtzq$art_obj = type.groups, $art_cawgyfmsxoj$art_c = $art_objdxaxozxtzq$art_obj.length; groupIndex < $art_cawgyfmsxoj$art_c; groupIndex++) {        var group = $art_objdxaxozxtzq$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objdxaxozxtzq$art_obj = type.groups, $art_cawgyfmsxoj$art_c = $art_objdxaxozxtzq$art_obj.length; groupIndex < $art_cawgyfmsxoj$art_c; groupIndex++) {
            var group = $art_objdxaxozxtzq$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjdyrrydb$art_c = group.length; areaIndex < $art_cjdyrrydb$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjdyrrydb$art_c = group.length; areaIndex < $art_cjdyrrydb$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ijgqqog$art_i = 0, $art_objuqawygwu$art_obj = area.provinces, $art_cdtaarsrdo$art_c = $art_objuqawygwu$art_obj.length; $art_ijgqqog$art_i < $art_cdtaarsrdo$art_c; $art_ijgqqog$art_i++) {                var province = $art_objuqawygwu$art_obj[$art_ijgqqog$art_i]%>';
                for (var $art_ijgqqog$art_i = 0, $art_objuqawygwu$art_obj = area.provinces, $art_cdtaarsrdo$art_c = $art_objuqawygwu$art_obj.length; $art_ijgqqog$art_i < $art_cdtaarsrdo$art_c; $art_ijgqqog$art_i++) {
                    var province = $art_objuqawygwu$art_obj[$art_ijgqqog$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iqstltr$art_i = 0, $art_objiheccbq$art_obj = province.cities, $art_ckmlhbmtc$art_c = $art_objiheccbq$art_obj.length; $art_iqstltr$art_i < $art_ckmlhbmtc$art_c; $art_iqstltr$art_i++) {                    var city = $art_objiheccbq$art_obj[$art_iqstltr$art_i]%>';
                    for (var $art_iqstltr$art_i = 0, $art_objiheccbq$art_obj = province.cities, $art_ckmlhbmtc$art_c = $art_objiheccbq$art_obj.length; $art_iqstltr$art_i < $art_ckmlhbmtc$art_c; $art_iqstltr$art_i++) {
                        var city = $art_objiheccbq$art_obj[$art_iqstltr$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
