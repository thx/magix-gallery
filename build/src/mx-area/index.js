...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cxosp$art_c = types.length; typeIndex < $art_cxosp$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cxosp$art_c = types.length; typeIndex < $art_cxosp$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ctfbtglm$art_c = types.length; typeIndex < $art_ctfbtglm$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ctfbtglm$art_c = types.length; typeIndex < $art_ctfbtglm$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objfguxwucu$art_obj = type.groups, $art_cqawlcf$art_c = $art_objfguxwucu$art_obj.length; groupIndex < $art_cqawlcf$art_c; groupIndex++) {        var group = $art_objfguxwucu$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objfguxwucu$art_obj = type.groups, $art_cqawlcf$art_c = $art_objfguxwucu$art_obj.length; groupIndex < $art_cqawlcf$art_c; groupIndex++) {
            var group = $art_objfguxwucu$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cdrkoq$art_c = group.length; areaIndex < $art_cdrkoq$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cdrkoq$art_c = group.length; areaIndex < $art_cdrkoq$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ivqldnnrya$art_i = 0, $art_objzcvgtnw$art_obj = area.provinces, $art_cxiujphy$art_c = $art_objzcvgtnw$art_obj.length; $art_ivqldnnrya$art_i < $art_cxiujphy$art_c; $art_ivqldnnrya$art_i++) {                var province = $art_objzcvgtnw$art_obj[$art_ivqldnnrya$art_i]%>';
                for (var $art_ivqldnnrya$art_i = 0, $art_objzcvgtnw$art_obj = area.provinces, $art_cxiujphy$art_c = $art_objzcvgtnw$art_obj.length; $art_ivqldnnrya$art_i < $art_cxiujphy$art_c; $art_ivqldnnrya$art_i++) {
                    var province = $art_objzcvgtnw$art_obj[$art_ivqldnnrya$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ircehauj$art_i = 0, $art_objocveggkrrj$art_obj = province.cities, $art_cgnsmypmb$art_c = $art_objocveggkrrj$art_obj.length; $art_ircehauj$art_i < $art_cgnsmypmb$art_c; $art_ircehauj$art_i++) {                    var city = $art_objocveggkrrj$art_obj[$art_ircehauj$art_i]%>';
                    for (var $art_ircehauj$art_i = 0, $art_objocveggkrrj$art_obj = province.cities, $art_cgnsmypmb$art_c = $art_objocveggkrrj$art_obj.length; $art_ircehauj$art_i < $art_cgnsmypmb$art_c; $art_ircehauj$art_i++) {
                        var city = $art_objocveggkrrj$art_obj[$art_ircehauj$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
