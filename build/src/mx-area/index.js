...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cnyjjshuh$art_c = types.length; typeIndex < $art_cnyjjshuh$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cnyjjshuh$art_c = types.length; typeIndex < $art_cnyjjshuh$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cdblahds$art_c = types.length; typeIndex < $art_cdblahds$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cdblahds$art_c = types.length; typeIndex < $art_cdblahds$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objoigvmbnzkfa$art_obj = type.groups, $art_cahlszki$art_c = $art_objoigvmbnzkfa$art_obj.length; groupIndex < $art_cahlszki$art_c; groupIndex++) {        var group = $art_objoigvmbnzkfa$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objoigvmbnzkfa$art_obj = type.groups, $art_cahlszki$art_c = $art_objoigvmbnzkfa$art_obj.length; groupIndex < $art_cahlszki$art_c; groupIndex++) {
            var group = $art_objoigvmbnzkfa$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_conpdabefk$art_c = group.length; areaIndex < $art_conpdabefk$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_conpdabefk$art_c = group.length; areaIndex < $art_conpdabefk$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iwugwqzn$art_i = 0, $art_objceqvjghaws$art_obj = area.provinces, $art_cbcom$art_c = $art_objceqvjghaws$art_obj.length; $art_iwugwqzn$art_i < $art_cbcom$art_c; $art_iwugwqzn$art_i++) {                var province = $art_objceqvjghaws$art_obj[$art_iwugwqzn$art_i]%>';
                for (var $art_iwugwqzn$art_i = 0, $art_objceqvjghaws$art_obj = area.provinces, $art_cbcom$art_c = $art_objceqvjghaws$art_obj.length; $art_iwugwqzn$art_i < $art_cbcom$art_c; $art_iwugwqzn$art_i++) {
                    var province = $art_objceqvjghaws$art_obj[$art_iwugwqzn$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_isupxlys$art_i = 0, $art_objhlkzjmwjdb$art_obj = province.cities, $art_cpwcmubbqfm$art_c = $art_objhlkzjmwjdb$art_obj.length; $art_isupxlys$art_i < $art_cpwcmubbqfm$art_c; $art_isupxlys$art_i++) {                    var city = $art_objhlkzjmwjdb$art_obj[$art_isupxlys$art_i]%>';
                    for (var $art_isupxlys$art_i = 0, $art_objhlkzjmwjdb$art_obj = province.cities, $art_cpwcmubbqfm$art_c = $art_objhlkzjmwjdb$art_obj.length; $art_isupxlys$art_i < $art_cpwcmubbqfm$art_c; $art_isupxlys$art_i++) {
                        var city = $art_objhlkzjmwjdb$art_obj[$art_isupxlys$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
