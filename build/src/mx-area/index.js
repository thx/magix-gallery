...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_chrxrbvkl$art_c = types.length; typeIndex < $art_chrxrbvkl$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_chrxrbvkl$art_c = types.length; typeIndex < $art_chrxrbvkl$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cdcydarp$art_c = types.length; typeIndex < $art_cdcydarp$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cdcydarp$art_c = types.length; typeIndex < $art_cdcydarp$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objyevixgn$art_obj = type.groups, $art_cbqajzowbbn$art_c = $art_objyevixgn$art_obj.length; groupIndex < $art_cbqajzowbbn$art_c; groupIndex++) {        var group = $art_objyevixgn$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objyevixgn$art_obj = type.groups, $art_cbqajzowbbn$art_c = $art_objyevixgn$art_obj.length; groupIndex < $art_cbqajzowbbn$art_c; groupIndex++) {
            var group = $art_objyevixgn$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cduwcnjuwv$art_c = group.length; areaIndex < $art_cduwcnjuwv$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cduwcnjuwv$art_c = group.length; areaIndex < $art_cduwcnjuwv$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ifzweptmiq$art_i = 0, $art_objhqpns$art_obj = area.provinces, $art_crrlhamuwb$art_c = $art_objhqpns$art_obj.length; $art_ifzweptmiq$art_i < $art_crrlhamuwb$art_c; $art_ifzweptmiq$art_i++) {                var province = $art_objhqpns$art_obj[$art_ifzweptmiq$art_i]%>';
                for (var $art_ifzweptmiq$art_i = 0, $art_objhqpns$art_obj = area.provinces, $art_crrlhamuwb$art_c = $art_objhqpns$art_obj.length; $art_ifzweptmiq$art_i < $art_crrlhamuwb$art_c; $art_ifzweptmiq$art_i++) {
                    var province = $art_objhqpns$art_obj[$art_ifzweptmiq$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_icdrhbuw$art_i = 0, $art_objgbodewce$art_obj = province.cities, $art_cvurtdx$art_c = $art_objgbodewce$art_obj.length; $art_icdrhbuw$art_i < $art_cvurtdx$art_c; $art_icdrhbuw$art_i++) {                    var city = $art_objgbodewce$art_obj[$art_icdrhbuw$art_i]%>';
                    for (var $art_icdrhbuw$art_i = 0, $art_objgbodewce$art_obj = province.cities, $art_cvurtdx$art_c = $art_objgbodewce$art_obj.length; $art_icdrhbuw$art_i < $art_cvurtdx$art_c; $art_icdrhbuw$art_i++) {
                        var city = $art_objgbodewce$art_obj[$art_icdrhbuw$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
