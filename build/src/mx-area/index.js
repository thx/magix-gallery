...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cdrhdvv$art_c = types.length; typeIndex < $art_cdrhdvv$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cdrhdvv$art_c = types.length; typeIndex < $art_cdrhdvv$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cxwixd$art_c = types.length; typeIndex < $art_cxwixd$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cxwixd$art_c = types.length; typeIndex < $art_cxwixd$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objmmhosb$art_obj = type.groups, $art_csteecyqjd$art_c = $art_objmmhosb$art_obj.length; groupIndex < $art_csteecyqjd$art_c; groupIndex++) {        var group = $art_objmmhosb$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objmmhosb$art_obj = type.groups, $art_csteecyqjd$art_c = $art_objmmhosb$art_obj.length; groupIndex < $art_csteecyqjd$art_c; groupIndex++) {
            var group = $art_objmmhosb$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cocndendvwo$art_c = group.length; areaIndex < $art_cocndendvwo$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cocndendvwo$art_c = group.length; areaIndex < $art_cocndendvwo$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iuvoat$art_i = 0, $art_objxrlqwig$art_obj = area.provinces, $art_czgnpjeh$art_c = $art_objxrlqwig$art_obj.length; $art_iuvoat$art_i < $art_czgnpjeh$art_c; $art_iuvoat$art_i++) {                var province = $art_objxrlqwig$art_obj[$art_iuvoat$art_i]%>';
                for (var $art_iuvoat$art_i = 0, $art_objxrlqwig$art_obj = area.provinces, $art_czgnpjeh$art_c = $art_objxrlqwig$art_obj.length; $art_iuvoat$art_i < $art_czgnpjeh$art_c; $art_iuvoat$art_i++) {
                    var province = $art_objxrlqwig$art_obj[$art_iuvoat$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_icicxz$art_i = 0, $art_objwcjfzdmb$art_obj = province.cities, $art_cdptqiczrd$art_c = $art_objwcjfzdmb$art_obj.length; $art_icicxz$art_i < $art_cdptqiczrd$art_c; $art_icicxz$art_i++) {                    var city = $art_objwcjfzdmb$art_obj[$art_icicxz$art_i]%>';
                    for (var $art_icicxz$art_i = 0, $art_objwcjfzdmb$art_obj = province.cities, $art_cdptqiczrd$art_c = $art_objwcjfzdmb$art_obj.length; $art_icicxz$art_i < $art_cdptqiczrd$art_c; $art_icicxz$art_i++) {
                        var city = $art_objwcjfzdmb$art_obj[$art_icicxz$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
