...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbhqfggstcn$art_c = types.length; typeIndex < $art_cbhqfggstcn$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbhqfggstcn$art_c = types.length; typeIndex < $art_cbhqfggstcn$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ctgycvi$art_c = types.length; typeIndex < $art_ctgycvi$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ctgycvi$art_c = types.length; typeIndex < $art_ctgycvi$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objllrpiitg$art_obj = type.groups, $art_cjizdp$art_c = $art_objllrpiitg$art_obj.length; groupIndex < $art_cjizdp$art_c; groupIndex++) {        var group = $art_objllrpiitg$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objllrpiitg$art_obj = type.groups, $art_cjizdp$art_c = $art_objllrpiitg$art_obj.length; groupIndex < $art_cjizdp$art_c; groupIndex++) {
            var group = $art_objllrpiitg$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ctisjsdton$art_c = group.length; areaIndex < $art_ctisjsdton$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ctisjsdton$art_c = group.length; areaIndex < $art_ctisjsdton$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iqhtdaacqd$art_i = 0, $art_objlaqhoke$art_obj = area.provinces, $art_cnlvkwco$art_c = $art_objlaqhoke$art_obj.length; $art_iqhtdaacqd$art_i < $art_cnlvkwco$art_c; $art_iqhtdaacqd$art_i++) {                var province = $art_objlaqhoke$art_obj[$art_iqhtdaacqd$art_i]%>';
                for (var $art_iqhtdaacqd$art_i = 0, $art_objlaqhoke$art_obj = area.provinces, $art_cnlvkwco$art_c = $art_objlaqhoke$art_obj.length; $art_iqhtdaacqd$art_i < $art_cnlvkwco$art_c; $art_iqhtdaacqd$art_i++) {
                    var province = $art_objlaqhoke$art_obj[$art_iqhtdaacqd$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_imahvwxnbk$art_i = 0, $art_objbtcailkvlp$art_obj = province.cities, $art_clkisuityvg$art_c = $art_objbtcailkvlp$art_obj.length; $art_imahvwxnbk$art_i < $art_clkisuityvg$art_c; $art_imahvwxnbk$art_i++) {                    var city = $art_objbtcailkvlp$art_obj[$art_imahvwxnbk$art_i]%>';
                    for (var $art_imahvwxnbk$art_i = 0, $art_objbtcailkvlp$art_obj = province.cities, $art_clkisuityvg$art_c = $art_objbtcailkvlp$art_obj.length; $art_imahvwxnbk$art_i < $art_clkisuityvg$art_c; $art_imahvwxnbk$art_i++) {
                        var city = $art_objbtcailkvlp$art_obj[$art_imahvwxnbk$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
