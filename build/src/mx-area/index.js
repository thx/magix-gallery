...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cnbsv$art_c = types.length; typeIndex < $art_cnbsv$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cnbsv$art_c = types.length; typeIndex < $art_cnbsv$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cemoxjhkwuq$art_c = types.length; typeIndex < $art_cemoxjhkwuq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cemoxjhkwuq$art_c = types.length; typeIndex < $art_cemoxjhkwuq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objbjjcojf$art_obj = type.groups, $art_cyynhzud$art_c = $art_objbjjcojf$art_obj.length; groupIndex < $art_cyynhzud$art_c; groupIndex++) {        var group = $art_objbjjcojf$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objbjjcojf$art_obj = type.groups, $art_cyynhzud$art_c = $art_objbjjcojf$art_obj.length; groupIndex < $art_cyynhzud$art_c; groupIndex++) {
            var group = $art_objbjjcojf$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cwndjwylrli$art_c = group.length; areaIndex < $art_cwndjwylrli$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cwndjwylrli$art_c = group.length; areaIndex < $art_cwndjwylrli$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ixjfjiif$art_i = 0, $art_objifqxce$art_obj = area.provinces, $art_cjvxrngz$art_c = $art_objifqxce$art_obj.length; $art_ixjfjiif$art_i < $art_cjvxrngz$art_c; $art_ixjfjiif$art_i++) {                var province = $art_objifqxce$art_obj[$art_ixjfjiif$art_i]%>';
                for (var $art_ixjfjiif$art_i = 0, $art_objifqxce$art_obj = area.provinces, $art_cjvxrngz$art_c = $art_objifqxce$art_obj.length; $art_ixjfjiif$art_i < $art_cjvxrngz$art_c; $art_ixjfjiif$art_i++) {
                    var province = $art_objifqxce$art_obj[$art_ixjfjiif$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ixbqto$art_i = 0, $art_objxlrdagzj$art_obj = province.cities, $art_caovgvq$art_c = $art_objxlrdagzj$art_obj.length; $art_ixbqto$art_i < $art_caovgvq$art_c; $art_ixbqto$art_i++) {                    var city = $art_objxlrdagzj$art_obj[$art_ixbqto$art_i]%>';
                    for (var $art_ixbqto$art_i = 0, $art_objxlrdagzj$art_obj = province.cities, $art_caovgvq$art_c = $art_objxlrdagzj$art_obj.length; $art_ixbqto$art_i < $art_caovgvq$art_c; $art_ixbqto$art_i++) {
                        var city = $art_objxlrdagzj$art_obj[$art_ixbqto$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
