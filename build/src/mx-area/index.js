...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cradjdxcgm$art_c = types.length; typeIndex < $art_cradjdxcgm$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cradjdxcgm$art_c = types.length; typeIndex < $art_cradjdxcgm$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_crkssql$art_c = types.length; typeIndex < $art_crkssql$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_crkssql$art_c = types.length; typeIndex < $art_crkssql$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objevzdt$art_obj = type.groups, $art_ccuakdqyzmyf$art_c = $art_objevzdt$art_obj.length; groupIndex < $art_ccuakdqyzmyf$art_c; groupIndex++) {        var group = $art_objevzdt$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objevzdt$art_obj = type.groups, $art_ccuakdqyzmyf$art_c = $art_objevzdt$art_obj.length; groupIndex < $art_ccuakdqyzmyf$art_c; groupIndex++) {
            var group = $art_objevzdt$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cuzztfzccl$art_c = group.length; areaIndex < $art_cuzztfzccl$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cuzztfzccl$art_c = group.length; areaIndex < $art_cuzztfzccl$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iiqaauyr$art_i = 0, $art_objwzqnnqmqeep$art_obj = area.provinces, $art_cozeedaus$art_c = $art_objwzqnnqmqeep$art_obj.length; $art_iiqaauyr$art_i < $art_cozeedaus$art_c; $art_iiqaauyr$art_i++) {                var province = $art_objwzqnnqmqeep$art_obj[$art_iiqaauyr$art_i]%>';
                for (var $art_iiqaauyr$art_i = 0, $art_objwzqnnqmqeep$art_obj = area.provinces, $art_cozeedaus$art_c = $art_objwzqnnqmqeep$art_obj.length; $art_iiqaauyr$art_i < $art_cozeedaus$art_c; $art_iiqaauyr$art_i++) {
                    var province = $art_objwzqnnqmqeep$art_obj[$art_iiqaauyr$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iiddpowlsub$art_i = 0, $art_objswqbpzqy$art_obj = province.cities, $art_cltvtsbasr$art_c = $art_objswqbpzqy$art_obj.length; $art_iiddpowlsub$art_i < $art_cltvtsbasr$art_c; $art_iiddpowlsub$art_i++) {                    var city = $art_objswqbpzqy$art_obj[$art_iiddpowlsub$art_i]%>';
                    for (var $art_iiddpowlsub$art_i = 0, $art_objswqbpzqy$art_obj = province.cities, $art_cltvtsbasr$art_c = $art_objswqbpzqy$art_obj.length; $art_iiddpowlsub$art_i < $art_cltvtsbasr$art_c; $art_iiddpowlsub$art_i++) {
                        var city = $art_objswqbpzqy$art_obj[$art_iiddpowlsub$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
