...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_crpxteolwk$art_c = types.length; typeIndex < $art_crpxteolwk$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_crpxteolwk$art_c = types.length; typeIndex < $art_crpxteolwk$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cyfehtrif$art_c = types.length; typeIndex < $art_cyfehtrif$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cyfehtrif$art_c = types.length; typeIndex < $art_cyfehtrif$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objefqivolz$art_obj = type.groups, $art_crbsazpwwed$art_c = $art_objefqivolz$art_obj.length; groupIndex < $art_crbsazpwwed$art_c; groupIndex++) {        var group = $art_objefqivolz$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objefqivolz$art_obj = type.groups, $art_crbsazpwwed$art_c = $art_objefqivolz$art_obj.length; groupIndex < $art_crbsazpwwed$art_c; groupIndex++) {
            var group = $art_objefqivolz$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cqxlrffgaog$art_c = group.length; areaIndex < $art_cqxlrffgaog$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cqxlrffgaog$art_c = group.length; areaIndex < $art_cqxlrffgaog$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iyotrbmmlyla$art_i = 0, $art_objtfkmo$art_obj = area.provinces, $art_ccgdlmlln$art_c = $art_objtfkmo$art_obj.length; $art_iyotrbmmlyla$art_i < $art_ccgdlmlln$art_c; $art_iyotrbmmlyla$art_i++) {                var province = $art_objtfkmo$art_obj[$art_iyotrbmmlyla$art_i]%>';
                for (var $art_iyotrbmmlyla$art_i = 0, $art_objtfkmo$art_obj = area.provinces, $art_ccgdlmlln$art_c = $art_objtfkmo$art_obj.length; $art_iyotrbmmlyla$art_i < $art_ccgdlmlln$art_c; $art_iyotrbmmlyla$art_i++) {
                    var province = $art_objtfkmo$art_obj[$art_iyotrbmmlyla$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iwfcqukwv$art_i = 0, $art_objtmklrx$art_obj = province.cities, $art_cjnekuavkv$art_c = $art_objtmklrx$art_obj.length; $art_iwfcqukwv$art_i < $art_cjnekuavkv$art_c; $art_iwfcqukwv$art_i++) {                    var city = $art_objtmklrx$art_obj[$art_iwfcqukwv$art_i]%>';
                    for (var $art_iwfcqukwv$art_i = 0, $art_objtmklrx$art_obj = province.cities, $art_cjnekuavkv$art_c = $art_objtmklrx$art_obj.length; $art_iwfcqukwv$art_i < $art_cjnekuavkv$art_c; $art_iwfcqukwv$art_i++) {
                        var city = $art_objtmklrx$art_obj[$art_iwfcqukwv$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
