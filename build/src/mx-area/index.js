...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cbbhbaqw$art_c = types.length; typeIndex < $art_cbbhbaqw$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cbbhbaqw$art_c = types.length; typeIndex < $art_cbbhbaqw$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cgkafhm$art_c = types.length; typeIndex < $art_cgkafhm$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cgkafhm$art_c = types.length; typeIndex < $art_cgkafhm$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objkfygozyatns$art_obj = type.groups, $art_cczxugadn$art_c = $art_objkfygozyatns$art_obj.length; groupIndex < $art_cczxugadn$art_c; groupIndex++) {        var group = $art_objkfygozyatns$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objkfygozyatns$art_obj = type.groups, $art_cczxugadn$art_c = $art_objkfygozyatns$art_obj.length; groupIndex < $art_cczxugadn$art_c; groupIndex++) {
            var group = $art_objkfygozyatns$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_clisoepr$art_c = group.length; areaIndex < $art_clisoepr$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_clisoepr$art_c = group.length; areaIndex < $art_clisoepr$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ihjuufkqivb$art_i = 0, $art_objsubeodmwyi$art_obj = area.provinces, $art_cojvgwgvy$art_c = $art_objsubeodmwyi$art_obj.length; $art_ihjuufkqivb$art_i < $art_cojvgwgvy$art_c; $art_ihjuufkqivb$art_i++) {                var province = $art_objsubeodmwyi$art_obj[$art_ihjuufkqivb$art_i]%>';
                for (var $art_ihjuufkqivb$art_i = 0, $art_objsubeodmwyi$art_obj = area.provinces, $art_cojvgwgvy$art_c = $art_objsubeodmwyi$art_obj.length; $art_ihjuufkqivb$art_i < $art_cojvgwgvy$art_c; $art_ihjuufkqivb$art_i++) {
                    var province = $art_objsubeodmwyi$art_obj[$art_ihjuufkqivb$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iwhsrg$art_i = 0, $art_objwezopmas$art_obj = province.cities, $art_crfadub$art_c = $art_objwezopmas$art_obj.length; $art_iwhsrg$art_i < $art_crfadub$art_c; $art_iwhsrg$art_i++) {                    var city = $art_objwezopmas$art_obj[$art_iwhsrg$art_i]%>';
                    for (var $art_iwhsrg$art_i = 0, $art_objwezopmas$art_obj = province.cities, $art_crfadub$art_c = $art_objwezopmas$art_obj.length; $art_iwhsrg$art_i < $art_crfadub$art_c; $art_iwhsrg$art_i++) {
                        var city = $art_objwezopmas$art_obj[$art_iwhsrg$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
