...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cnjsishng$art_c = types.length; typeIndex < $art_cnjsishng$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cnjsishng$art_c = types.length; typeIndex < $art_cnjsishng$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cgafuywek$art_c = types.length; typeIndex < $art_cgafuywek$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cgafuywek$art_c = types.length; typeIndex < $art_cgafuywek$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objoqcimmom$art_obj = type.groups, $art_cmfpaph$art_c = $art_objoqcimmom$art_obj.length; groupIndex < $art_cmfpaph$art_c; groupIndex++) {        var group = $art_objoqcimmom$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objoqcimmom$art_obj = type.groups, $art_cmfpaph$art_c = $art_objoqcimmom$art_obj.length; groupIndex < $art_cmfpaph$art_c; groupIndex++) {
            var group = $art_objoqcimmom$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cxqrnmcqns$art_c = group.length; areaIndex < $art_cxqrnmcqns$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cxqrnmcqns$art_c = group.length; areaIndex < $art_cxqrnmcqns$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iuqozmrxe$art_i = 0, $art_objmubkwhfu$art_obj = area.provinces, $art_cnpsievvx$art_c = $art_objmubkwhfu$art_obj.length; $art_iuqozmrxe$art_i < $art_cnpsievvx$art_c; $art_iuqozmrxe$art_i++) {                var province = $art_objmubkwhfu$art_obj[$art_iuqozmrxe$art_i]%>';
                for (var $art_iuqozmrxe$art_i = 0, $art_objmubkwhfu$art_obj = area.provinces, $art_cnpsievvx$art_c = $art_objmubkwhfu$art_obj.length; $art_iuqozmrxe$art_i < $art_cnpsievvx$art_c; $art_iuqozmrxe$art_i++) {
                    var province = $art_objmubkwhfu$art_obj[$art_iuqozmrxe$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ikjhyt$art_i = 0, $art_objgagkjnm$art_obj = province.cities, $art_cevhpimgme$art_c = $art_objgagkjnm$art_obj.length; $art_ikjhyt$art_i < $art_cevhpimgme$art_c; $art_ikjhyt$art_i++) {                    var city = $art_objgagkjnm$art_obj[$art_ikjhyt$art_i]%>';
                    for (var $art_ikjhyt$art_i = 0, $art_objgagkjnm$art_obj = province.cities, $art_cevhpimgme$art_c = $art_objgagkjnm$art_obj.length; $art_ikjhyt$art_i < $art_cevhpimgme$art_c; $art_ikjhyt$art_i++) {
                        var city = $art_objgagkjnm$art_obj[$art_ikjhyt$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
