...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_catofoy$art_c = types.length; typeIndex < $art_catofoy$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_catofoy$art_c = types.length; typeIndex < $art_catofoy$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_clciuoffo$art_c = types.length; typeIndex < $art_clciuoffo$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_clciuoffo$art_c = types.length; typeIndex < $art_clciuoffo$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objfvbe$art_obj = type.groups, $art_cyltxtk$art_c = $art_objfvbe$art_obj.length; groupIndex < $art_cyltxtk$art_c; groupIndex++) {        var group = $art_objfvbe$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objfvbe$art_obj = type.groups, $art_cyltxtk$art_c = $art_objfvbe$art_obj.length; groupIndex < $art_cyltxtk$art_c; groupIndex++) {
            var group = $art_objfvbe$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_clegbbefh$art_c = group.length; areaIndex < $art_clegbbefh$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_clegbbefh$art_c = group.length; areaIndex < $art_clegbbefh$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_isdikl$art_i = 0, $art_objirzayjcgn$art_obj = area.provinces, $art_cmkyfobvqkn$art_c = $art_objirzayjcgn$art_obj.length; $art_isdikl$art_i < $art_cmkyfobvqkn$art_c; $art_isdikl$art_i++) {                var province = $art_objirzayjcgn$art_obj[$art_isdikl$art_i]%>';
                for (var $art_isdikl$art_i = 0, $art_objirzayjcgn$art_obj = area.provinces, $art_cmkyfobvqkn$art_c = $art_objirzayjcgn$art_obj.length; $art_isdikl$art_i < $art_cmkyfobvqkn$art_c; $art_isdikl$art_i++) {
                    var province = $art_objirzayjcgn$art_obj[$art_isdikl$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iiawpwyt$art_i = 0, $art_objdvlgny$art_obj = province.cities, $art_clynwzxht$art_c = $art_objdvlgny$art_obj.length; $art_iiawpwyt$art_i < $art_clynwzxht$art_c; $art_iiawpwyt$art_i++) {                    var city = $art_objdvlgny$art_obj[$art_iiawpwyt$art_i]%>';
                    for (var $art_iiawpwyt$art_i = 0, $art_objdvlgny$art_obj = province.cities, $art_clynwzxht$art_c = $art_objdvlgny$art_obj.length; $art_iiawpwyt$art_i < $art_clynwzxht$art_c; $art_iiawpwyt$art_i++) {
                        var city = $art_objdvlgny$art_obj[$art_iiawpwyt$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
