...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cdchwerat$art_c = types.length; typeIndex < $art_cdchwerat$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cdchwerat$art_c = types.length; typeIndex < $art_cdchwerat$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cvocazaqd$art_c = types.length; typeIndex < $art_cvocazaqd$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cvocazaqd$art_c = types.length; typeIndex < $art_cvocazaqd$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objuzmfgvrm$art_obj = type.groups, $art_ctfvuekmbp$art_c = $art_objuzmfgvrm$art_obj.length; groupIndex < $art_ctfvuekmbp$art_c; groupIndex++) {        var group = $art_objuzmfgvrm$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objuzmfgvrm$art_obj = type.groups, $art_ctfvuekmbp$art_c = $art_objuzmfgvrm$art_obj.length; groupIndex < $art_ctfvuekmbp$art_c; groupIndex++) {
            var group = $art_objuzmfgvrm$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_caybljbuxd$art_c = group.length; areaIndex < $art_caybljbuxd$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_caybljbuxd$art_c = group.length; areaIndex < $art_caybljbuxd$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_itzppo$art_i = 0, $art_objksiuzmnzm$art_obj = area.provinces, $art_cufuisjjc$art_c = $art_objksiuzmnzm$art_obj.length; $art_itzppo$art_i < $art_cufuisjjc$art_c; $art_itzppo$art_i++) {                var province = $art_objksiuzmnzm$art_obj[$art_itzppo$art_i]%>';
                for (var $art_itzppo$art_i = 0, $art_objksiuzmnzm$art_obj = area.provinces, $art_cufuisjjc$art_c = $art_objksiuzmnzm$art_obj.length; $art_itzppo$art_i < $art_cufuisjjc$art_c; $art_itzppo$art_i++) {
                    var province = $art_objksiuzmnzm$art_obj[$art_itzppo$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ilmgjlm$art_i = 0, $art_objainc$art_obj = province.cities, $art_casruldx$art_c = $art_objainc$art_obj.length; $art_ilmgjlm$art_i < $art_casruldx$art_c; $art_ilmgjlm$art_i++) {                    var city = $art_objainc$art_obj[$art_ilmgjlm$art_i]%>';
                    for (var $art_ilmgjlm$art_i = 0, $art_objainc$art_obj = province.cities, $art_casruldx$art_c = $art_objainc$art_obj.length; $art_ilmgjlm$art_i < $art_casruldx$art_c; $art_ilmgjlm$art_i++) {
                        var city = $art_objainc$art_obj[$art_ilmgjlm$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
