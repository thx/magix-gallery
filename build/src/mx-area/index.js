...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_claesbgyr$art_c = types.length; typeIndex < $art_claesbgyr$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_claesbgyr$art_c = types.length; typeIndex < $art_claesbgyr$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cmmdsbdj$art_c = types.length; typeIndex < $art_cmmdsbdj$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cmmdsbdj$art_c = types.length; typeIndex < $art_cmmdsbdj$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objdetkhyj$art_obj = type.groups, $art_cmgeqctot$art_c = $art_objdetkhyj$art_obj.length; groupIndex < $art_cmgeqctot$art_c; groupIndex++) {        var group = $art_objdetkhyj$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objdetkhyj$art_obj = type.groups, $art_cmgeqctot$art_c = $art_objdetkhyj$art_obj.length; groupIndex < $art_cmgeqctot$art_c; groupIndex++) {
            var group = $art_objdetkhyj$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ccrpckhgsz$art_c = group.length; areaIndex < $art_ccrpckhgsz$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ccrpckhgsz$art_c = group.length; areaIndex < $art_ccrpckhgsz$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ibflbjjkv$art_i = 0, $art_objxoavdcakl$art_obj = area.provinces, $art_czjqdixuo$art_c = $art_objxoavdcakl$art_obj.length; $art_ibflbjjkv$art_i < $art_czjqdixuo$art_c; $art_ibflbjjkv$art_i++) {                var province = $art_objxoavdcakl$art_obj[$art_ibflbjjkv$art_i]%>';
                for (var $art_ibflbjjkv$art_i = 0, $art_objxoavdcakl$art_obj = area.provinces, $art_czjqdixuo$art_c = $art_objxoavdcakl$art_obj.length; $art_ibflbjjkv$art_i < $art_czjqdixuo$art_c; $art_ibflbjjkv$art_i++) {
                    var province = $art_objxoavdcakl$art_obj[$art_ibflbjjkv$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iexlnpfe$art_i = 0, $art_objfbbnzhbsw$art_obj = province.cities, $art_cxqxzxullkj$art_c = $art_objfbbnzhbsw$art_obj.length; $art_iexlnpfe$art_i < $art_cxqxzxullkj$art_c; $art_iexlnpfe$art_i++) {                    var city = $art_objfbbnzhbsw$art_obj[$art_iexlnpfe$art_i]%>';
                    for (var $art_iexlnpfe$art_i = 0, $art_objfbbnzhbsw$art_obj = province.cities, $art_cxqxzxullkj$art_c = $art_objfbbnzhbsw$art_obj.length; $art_iexlnpfe$art_i < $art_cxqxzxullkj$art_c; $art_iexlnpfe$art_i++) {
                        var city = $art_objfbbnzhbsw$art_obj[$art_iexlnpfe$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
