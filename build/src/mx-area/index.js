...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cfntpdae$art_c = types.length; typeIndex < $art_cfntpdae$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cfntpdae$art_c = types.length; typeIndex < $art_cfntpdae$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cwygtos$art_c = types.length; typeIndex < $art_cwygtos$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cwygtos$art_c = types.length; typeIndex < $art_cwygtos$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objrylxhtn$art_obj = type.groups, $art_cpjbuncpa$art_c = $art_objrylxhtn$art_obj.length; groupIndex < $art_cpjbuncpa$art_c; groupIndex++) {        var group = $art_objrylxhtn$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objrylxhtn$art_obj = type.groups, $art_cpjbuncpa$art_c = $art_objrylxhtn$art_obj.length; groupIndex < $art_cpjbuncpa$art_c; groupIndex++) {
            var group = $art_objrylxhtn$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_czkmiwxjg$art_c = group.length; areaIndex < $art_czkmiwxjg$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_czkmiwxjg$art_c = group.length; areaIndex < $art_czkmiwxjg$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iwflsttyn$art_i = 0, $art_objzkgvgwfynp$art_obj = area.provinces, $art_cdmwzgunvao$art_c = $art_objzkgvgwfynp$art_obj.length; $art_iwflsttyn$art_i < $art_cdmwzgunvao$art_c; $art_iwflsttyn$art_i++) {                var province = $art_objzkgvgwfynp$art_obj[$art_iwflsttyn$art_i]%>';
                for (var $art_iwflsttyn$art_i = 0, $art_objzkgvgwfynp$art_obj = area.provinces, $art_cdmwzgunvao$art_c = $art_objzkgvgwfynp$art_obj.length; $art_iwflsttyn$art_i < $art_cdmwzgunvao$art_c; $art_iwflsttyn$art_i++) {
                    var province = $art_objzkgvgwfynp$art_obj[$art_iwflsttyn$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ithmumwhcg$art_i = 0, $art_objoqmxizoe$art_obj = province.cities, $art_cmafuoagwj$art_c = $art_objoqmxizoe$art_obj.length; $art_ithmumwhcg$art_i < $art_cmafuoagwj$art_c; $art_ithmumwhcg$art_i++) {                    var city = $art_objoqmxizoe$art_obj[$art_ithmumwhcg$art_i]%>';
                    for (var $art_ithmumwhcg$art_i = 0, $art_objoqmxizoe$art_obj = province.cities, $art_cmafuoagwj$art_c = $art_objoqmxizoe$art_obj.length; $art_ithmumwhcg$art_i < $art_cmafuoagwj$art_c; $art_ithmumwhcg$art_i++) {
                        var city = $art_objoqmxizoe$art_obj[$art_ithmumwhcg$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
