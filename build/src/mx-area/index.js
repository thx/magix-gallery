...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $p += '';
        $expr = '<%for (var typeIndex = 0, $art_cfltct$art_c = types.length; typeIndex < $art_cfltct$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cfltct$art_c = types.length; typeIndex < $art_cfltct$art_c; typeIndex++) {
    ...
    ;
    $p += '';
    $expr = '<%for (var typeIndex = 0, $art_ciqxgyyrdxv$art_c = types.length; typeIndex < $art_ciqxgyyrdxv$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ciqxgyyrdxv$art_c = types.length; typeIndex < $art_ciqxgyyrdxv$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_objcgqswktyc$art_obj = type.groups, $art_cdabddwzwt$art_c = $art_objcgqswktyc$art_obj.length; groupIndex < $art_cdabddwzwt$art_c; groupIndex++) {        var group = $art_objcgqswktyc$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objcgqswktyc$art_obj = type.groups, $art_cdabddwzwt$art_c = $art_objcgqswktyc$art_obj.length; groupIndex < $art_cdabddwzwt$art_c; groupIndex++) {
            var group = $art_objcgqswktyc$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var areaIndex = 0, $art_cvqpreawvsdf$art_c = group.length; areaIndex < $art_cvqpreawvsdf$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cvqpreawvsdf$art_c = group.length; areaIndex < $art_cvqpreawvsdf$art_c; areaIndex++) {
                ...
                ;
                $p += '';
                $expr = '<%for (var $art_ijutbhg$art_i = 0, $art_objrtbwufoej$art_obj = area.provinces, $art_choahucen$art_c = $art_objrtbwufoej$art_obj.length; $art_ijutbhg$art_i < $art_choahucen$art_c; $art_ijutbhg$art_i++) {                var province = $art_objrtbwufoej$art_obj[$art_ijutbhg$art_i]%>';
                for (var $art_ijutbhg$art_i = 0, $art_objrtbwufoej$art_obj = area.provinces, $art_choahucen$art_c = $art_objrtbwufoej$art_obj.length; $art_ijutbhg$art_i < $art_choahucen$art_c; $art_ijutbhg$art_i++) {
                    var province = $art_objrtbwufoej$art_obj[$art_ijutbhg$art_i];
                    ...
                    ;
                    $p += '';
                    $expr = '<%for (var $art_idlhlnsymyh$art_i = 0, $art_objkbpxvrbt$art_obj = province.cities, $art_ccbzjqffht$art_c = $art_objkbpxvrbt$art_obj.length; $art_idlhlnsymyh$art_i < $art_ccbzjqffht$art_c; $art_idlhlnsymyh$art_i++) {                    var city = $art_objkbpxvrbt$art_obj[$art_idlhlnsymyh$art_i]%>';
                    for (var $art_idlhlnsymyh$art_i = 0, $art_objkbpxvrbt$art_obj = province.cities, $art_ccbzjqffht$art_c = $art_objkbpxvrbt$art_obj.length; $art_idlhlnsymyh$art_i < $art_ccbzjqffht$art_c; $art_idlhlnsymyh$art_i++) {
                        var city = $art_objkbpxvrbt$art_obj[$art_idlhlnsymyh$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
