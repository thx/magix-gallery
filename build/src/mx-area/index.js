...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cwvylzwxx$art_c = types.length; typeIndex < $art_cwvylzwxx$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cwvylzwxx$art_c = types.length; typeIndex < $art_cwvylzwxx$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ctsiwuept$art_c = types.length; typeIndex < $art_ctsiwuept$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ctsiwuept$art_c = types.length; typeIndex < $art_ctsiwuept$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objswwatjj$art_obj = type.groups, $art_cjyjkrzfbu$art_c = $art_objswwatjj$art_obj.length; groupIndex < $art_cjyjkrzfbu$art_c; groupIndex++) {        var group = $art_objswwatjj$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objswwatjj$art_obj = type.groups, $art_cjyjkrzfbu$art_c = $art_objswwatjj$art_obj.length; groupIndex < $art_cjyjkrzfbu$art_c; groupIndex++) {
            var group = $art_objswwatjj$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_ctbrmxmtj$art_c = group.length; areaIndex < $art_ctbrmxmtj$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_ctbrmxmtj$art_c = group.length; areaIndex < $art_ctbrmxmtj$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_igdasydyoqm$art_i = 0, $art_objeaxrofe$art_obj = area.provinces, $art_csscss$art_c = $art_objeaxrofe$art_obj.length; $art_igdasydyoqm$art_i < $art_csscss$art_c; $art_igdasydyoqm$art_i++) {                var province = $art_objeaxrofe$art_obj[$art_igdasydyoqm$art_i]%>';
                for (var $art_igdasydyoqm$art_i = 0, $art_objeaxrofe$art_obj = area.provinces, $art_csscss$art_c = $art_objeaxrofe$art_obj.length; $art_igdasydyoqm$art_i < $art_csscss$art_c; $art_igdasydyoqm$art_i++) {
                    var province = $art_objeaxrofe$art_obj[$art_igdasydyoqm$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iiqivwlhj$art_i = 0, $art_objjwpxutlom$art_obj = province.cities, $art_ciuyicfsp$art_c = $art_objjwpxutlom$art_obj.length; $art_iiqivwlhj$art_i < $art_ciuyicfsp$art_c; $art_iiqivwlhj$art_i++) {                    var city = $art_objjwpxutlom$art_obj[$art_iiqivwlhj$art_i]%>';
                    for (var $art_iiqivwlhj$art_i = 0, $art_objjwpxutlom$art_obj = province.cities, $art_ciuyicfsp$art_c = $art_objjwpxutlom$art_obj.length; $art_iiqivwlhj$art_i < $art_ciuyicfsp$art_c; $art_iiqivwlhj$art_i++) {
                        var city = $art_objjwpxutlom$art_obj[$art_iiqivwlhj$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
