...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cpirgbtz$art_c = types.length; typeIndex < $art_cpirgbtz$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cpirgbtz$art_c = types.length; typeIndex < $art_cpirgbtz$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cclhovs$art_c = types.length; typeIndex < $art_cclhovs$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cclhovs$art_c = types.length; typeIndex < $art_cclhovs$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objefaurap$art_obj = type.groups, $art_ctyiolwc$art_c = $art_objefaurap$art_obj.length; groupIndex < $art_ctyiolwc$art_c; groupIndex++) {        var group = $art_objefaurap$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objefaurap$art_obj = type.groups, $art_ctyiolwc$art_c = $art_objefaurap$art_obj.length; groupIndex < $art_ctyiolwc$art_c; groupIndex++) {
            var group = $art_objefaurap$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cghnoyj$art_c = group.length; areaIndex < $art_cghnoyj$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cghnoyj$art_c = group.length; areaIndex < $art_cghnoyj$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_imajfzae$art_i = 0, $art_objnzlpwjtmxpg$art_obj = area.provinces, $art_cdswqijhut$art_c = $art_objnzlpwjtmxpg$art_obj.length; $art_imajfzae$art_i < $art_cdswqijhut$art_c; $art_imajfzae$art_i++) {                var province = $art_objnzlpwjtmxpg$art_obj[$art_imajfzae$art_i]%>';
                for (var $art_imajfzae$art_i = 0, $art_objnzlpwjtmxpg$art_obj = area.provinces, $art_cdswqijhut$art_c = $art_objnzlpwjtmxpg$art_obj.length; $art_imajfzae$art_i < $art_cdswqijhut$art_c; $art_imajfzae$art_i++) {
                    var province = $art_objnzlpwjtmxpg$art_obj[$art_imajfzae$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iegskexu$art_i = 0, $art_objzbcnpq$art_obj = province.cities, $art_cwsjbowu$art_c = $art_objzbcnpq$art_obj.length; $art_iegskexu$art_i < $art_cwsjbowu$art_c; $art_iegskexu$art_i++) {                    var city = $art_objzbcnpq$art_obj[$art_iegskexu$art_i]%>';
                    for (var $art_iegskexu$art_i = 0, $art_objzbcnpq$art_obj = province.cities, $art_cwsjbowu$art_c = $art_objzbcnpq$art_obj.length; $art_iegskexu$art_i < $art_cwsjbowu$art_c; $art_iegskexu$art_i++) {
                        var city = $art_objzbcnpq$art_obj[$art_iegskexu$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
