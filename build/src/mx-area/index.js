...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_ckpneqg$art_c = types.length; typeIndex < $art_ckpneqg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_ckpneqg$art_c = types.length; typeIndex < $art_ckpneqg$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cuarzapgq$art_c = types.length; typeIndex < $art_cuarzapgq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cuarzapgq$art_c = types.length; typeIndex < $art_cuarzapgq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objwwrqrzoh$art_obj = type.groups, $art_cmkjbzhkfg$art_c = $art_objwwrqrzoh$art_obj.length; groupIndex < $art_cmkjbzhkfg$art_c; groupIndex++) {        var group = $art_objwwrqrzoh$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objwwrqrzoh$art_obj = type.groups, $art_cmkjbzhkfg$art_c = $art_objwwrqrzoh$art_obj.length; groupIndex < $art_cmkjbzhkfg$art_c; groupIndex++) {
            var group = $art_objwwrqrzoh$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cmprtfqksas$art_c = group.length; areaIndex < $art_cmprtfqksas$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cmprtfqksas$art_c = group.length; areaIndex < $art_cmprtfqksas$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ivlurgmp$art_i = 0, $art_objtxibun$art_obj = area.provinces, $art_ckxizzbmro$art_c = $art_objtxibun$art_obj.length; $art_ivlurgmp$art_i < $art_ckxizzbmro$art_c; $art_ivlurgmp$art_i++) {                var province = $art_objtxibun$art_obj[$art_ivlurgmp$art_i]%>';
                for (var $art_ivlurgmp$art_i = 0, $art_objtxibun$art_obj = area.provinces, $art_ckxizzbmro$art_c = $art_objtxibun$art_obj.length; $art_ivlurgmp$art_i < $art_ckxizzbmro$art_c; $art_ivlurgmp$art_i++) {
                    var province = $art_objtxibun$art_obj[$art_ivlurgmp$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_inxirdbyk$art_i = 0, $art_objmeybmdln$art_obj = province.cities, $art_chfqpql$art_c = $art_objmeybmdln$art_obj.length; $art_inxirdbyk$art_i < $art_chfqpql$art_c; $art_inxirdbyk$art_i++) {                    var city = $art_objmeybmdln$art_obj[$art_inxirdbyk$art_i]%>';
                    for (var $art_inxirdbyk$art_i = 0, $art_objmeybmdln$art_obj = province.cities, $art_chfqpql$art_c = $art_objmeybmdln$art_obj.length; $art_inxirdbyk$art_i < $art_chfqpql$art_c; $art_inxirdbyk$art_i++) {
                        var city = $art_objmeybmdln$art_obj[$art_inxirdbyk$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
