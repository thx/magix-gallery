...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_galleryJ:_" class="mc-iconfont search-icon">&#xe651;</i><input mx-keyup="' + $viewId + '@{search}()" class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (isTab) {
        ;
        $p += '<div mxv mxa="_zs_galleryJ:_" class="_zs_gallery_mx-area_index_-tabs clearfix">';
        $line = 7;
        $art = 'each types as type typeIndex';
        ;
        $p += '';
        $expr = '<%for (var typeIndex = 0, $art_cprigapn$art_c = types.length; typeIndex < $art_cprigapn$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cprigapn$art_c = types.length; typeIndex < $art_cprigapn$art_c; typeIndex++) {
            ...
            ;
            $p += ' clearfix"><div mxv mxa="_zs_galleryJ:a" class="_zs_gallery_mx-area_index_-tab-check"><input type="checkbox" mx-change="' + $viewId + '@{changeAll}({typeIndex:';
            $line = 11;
            $art = '=typeIndex';
            ;
    ...
    ;
    $p += '';
    $expr = '<%for (var typeIndex = 0, $art_czblfxikxse$art_c = types.length; typeIndex < $art_czblfxikxse$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_czblfxikxse$art_c = types.length; typeIndex < $art_czblfxikxse$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        if (!isTab) {
            ;
            $p += '<div mxv mxa="_zs_galleryJ:b" class="_zs_gallery_mx-area_index_-all"><label mxv for="';
            $line = 25;
            $art = '=viewId';
            ;
            ...
            ;
            $p += '/><span mxa="_zs_galleryJ:c" class="ml5">全选 - ';
            $line = 27;
            $art = '=type.name';
            ;
        ...
        ;
        $p += '<div mxv mxa="_zs_galleryJ:d" class="clearfix">';
        $line = 32;
        $art = 'each type.groups as group groupIndex';
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_objlsdvboqm$art_obj = type.groups, $art_crnoxpmooj$art_c = $art_objlsdvboqm$art_obj.length; groupIndex < $art_crnoxpmooj$art_c; groupIndex++) {        var group = $art_objlsdvboqm$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objlsdvboqm$art_obj = type.groups, $art_crnoxpmooj$art_c = $art_objlsdvboqm$art_obj.length; groupIndex < $art_crnoxpmooj$art_c; groupIndex++) {
            var group = $art_objlsdvboqm$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var areaIndex = 0, $art_czlnwvyr$art_c = group.length; areaIndex < $art_czlnwvyr$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_czlnwvyr$art_c = group.length; areaIndex < $art_czlnwvyr$art_c; areaIndex++) {
                ...
                if (area.name) {
                    ;
                    $p += '<div mxv mxa="_zs_galleryJ:e" class="_zs_gallery_mx-area_index_-area"><div mxa="_zs_galleryJ:f" class="_zs_gallery_mx-area_index_-area-name">';
                    $line = 37;
                    $art = '=area.name';
                    ;
                ...
                ;
                $p += '<div mxv mxa="_zs_galleryJ:g" class="_zs_gallery_mx-area_index_-provinces clearfix">';
                $line = 40;
                $art = 'each area.provinces as province';
                ;
                $p += '';
                $expr = '<%for (var $art_ietzcqnymxed$art_i = 0, $art_objlifvd$art_obj = area.provinces, $art_cjlwmzkw$art_c = $art_objlifvd$art_obj.length; $art_ietzcqnymxed$art_i < $art_cjlwmzkw$art_c; $art_ietzcqnymxed$art_i++) {                var province = $art_objlifvd$art_obj[$art_ietzcqnymxed$art_i]%>';
                for (var $art_ietzcqnymxed$art_i = 0, $art_objlifvd$art_obj = area.provinces, $art_cjlwmzkw$art_c = $art_objlifvd$art_obj.length; $art_ietzcqnymxed$art_i < $art_cjlwmzkw$art_c; $art_ietzcqnymxed$art_i++) {
                    var province = $art_objlifvd$art_obj[$art_ietzcqnymxed$art_i];
                    ...
                    if (province.hasCity && (province.count > 0)) {
                        ;
                        $p += '<span mxa="_zs_galleryJ:h" class="_zs_gallery_mx-area_index_-province-count">(';
                        $line = 47;
                        $art = '=province.count';
                        ;
                    ...
                    ;
                    $p += '';
                    $expr = '<%for (var $art_ijlvsdxaqgn$art_i = 0, $art_objgnvwsgjtsm$art_obj = province.cities, $art_cvbxbgmzqhn$art_c = $art_objgnvwsgjtsm$art_obj.length; $art_ijlvsdxaqgn$art_i < $art_cvbxbgmzqhn$art_c; $art_ijlvsdxaqgn$art_i++) {                    var city = $art_objgnvwsgjtsm$art_obj[$art_ijlvsdxaqgn$art_i]%>';
                    for (var $art_ijlvsdxaqgn$art_i = 0, $art_objgnvwsgjtsm$art_obj = province.cities, $art_cvbxbgmzqhn$art_c = $art_objgnvwsgjtsm$art_obj.length; $art_ijlvsdxaqgn$art_i < $art_cvbxbgmzqhn$art_c; $art_ijlvsdxaqgn$art_i++) {
                        var city = $art_objgnvwsgjtsm$art_obj[$art_ijlvsdxaqgn$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
