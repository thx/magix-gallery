...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cgnfuxduuq$art_c = types.length; typeIndex < $art_cgnfuxduuq$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cgnfuxduuq$art_c = types.length; typeIndex < $art_cgnfuxduuq$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cxtlrkiz$art_c = types.length; typeIndex < $art_cxtlrkiz$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cxtlrkiz$art_c = types.length; typeIndex < $art_cxtlrkiz$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objehszbz$art_obj = type.groups, $art_cmidemjfbn$art_c = $art_objehszbz$art_obj.length; groupIndex < $art_cmidemjfbn$art_c; groupIndex++) {        var group = $art_objehszbz$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objehszbz$art_obj = type.groups, $art_cmidemjfbn$art_c = $art_objehszbz$art_obj.length; groupIndex < $art_cmidemjfbn$art_c; groupIndex++) {
            var group = $art_objehszbz$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cnytmdbnf$art_c = group.length; areaIndex < $art_cnytmdbnf$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cnytmdbnf$art_c = group.length; areaIndex < $art_cnytmdbnf$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_irscmp$art_i = 0, $art_objkzxugagfc$art_obj = area.provinces, $art_cuomaorcvwf$art_c = $art_objkzxugagfc$art_obj.length; $art_irscmp$art_i < $art_cuomaorcvwf$art_c; $art_irscmp$art_i++) {                var province = $art_objkzxugagfc$art_obj[$art_irscmp$art_i]%>';
                for (var $art_irscmp$art_i = 0, $art_objkzxugagfc$art_obj = area.provinces, $art_cuomaorcvwf$art_c = $art_objkzxugagfc$art_obj.length; $art_irscmp$art_i < $art_cuomaorcvwf$art_c; $art_irscmp$art_i++) {
                    var province = $art_objkzxugagfc$art_obj[$art_irscmp$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iefxlssw$art_i = 0, $art_objmcdkdgzkjb$art_obj = province.cities, $art_cgyksxcsoet$art_c = $art_objmcdkdgzkjb$art_obj.length; $art_iefxlssw$art_i < $art_cgyksxcsoet$art_c; $art_iefxlssw$art_i++) {                    var city = $art_objmcdkdgzkjb$art_obj[$art_iefxlssw$art_i]%>';
                    for (var $art_iefxlssw$art_i = 0, $art_objmcdkdgzkjb$art_obj = province.cities, $art_cgyksxcsoet$art_c = $art_objmcdkdgzkjb$art_obj.length; $art_iefxlssw$art_i < $art_cgyksxcsoet$art_c; $art_iefxlssw$art_i++) {
                        var city = $art_objmcdkdgzkjb$art_obj[$art_iefxlssw$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
