...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cuizpfrgj$art_c = types.length; typeIndex < $art_cuizpfrgj$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cuizpfrgj$art_c = types.length; typeIndex < $art_cuizpfrgj$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cargyq$art_c = types.length; typeIndex < $art_cargyq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cargyq$art_c = types.length; typeIndex < $art_cargyq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objdddmxtps$art_obj = type.groups, $art_cofarcllf$art_c = $art_objdddmxtps$art_obj.length; groupIndex < $art_cofarcllf$art_c; groupIndex++) {        var group = $art_objdddmxtps$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objdddmxtps$art_obj = type.groups, $art_cofarcllf$art_c = $art_objdddmxtps$art_obj.length; groupIndex < $art_cofarcllf$art_c; groupIndex++) {
            var group = $art_objdddmxtps$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_csiwbcqw$art_c = group.length; areaIndex < $art_csiwbcqw$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_csiwbcqw$art_c = group.length; areaIndex < $art_csiwbcqw$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ifviykwxcm$art_i = 0, $art_objbrrybwseo$art_obj = area.provinces, $art_cowkgqivuoc$art_c = $art_objbrrybwseo$art_obj.length; $art_ifviykwxcm$art_i < $art_cowkgqivuoc$art_c; $art_ifviykwxcm$art_i++) {                var province = $art_objbrrybwseo$art_obj[$art_ifviykwxcm$art_i]%>';
                for (var $art_ifviykwxcm$art_i = 0, $art_objbrrybwseo$art_obj = area.provinces, $art_cowkgqivuoc$art_c = $art_objbrrybwseo$art_obj.length; $art_ifviykwxcm$art_i < $art_cowkgqivuoc$art_c; $art_ifviykwxcm$art_i++) {
                    var province = $art_objbrrybwseo$art_obj[$art_ifviykwxcm$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iwgfmavj$art_i = 0, $art_objgvhwlw$art_obj = province.cities, $art_chkdqwqcad$art_c = $art_objgvhwlw$art_obj.length; $art_iwgfmavj$art_i < $art_chkdqwqcad$art_c; $art_iwgfmavj$art_i++) {                    var city = $art_objgvhwlw$art_obj[$art_iwgfmavj$art_i]%>';
                    for (var $art_iwgfmavj$art_i = 0, $art_objgvhwlw$art_obj = province.cities, $art_chkdqwqcad$art_c = $art_objgvhwlw$art_obj.length; $art_iwgfmavj$art_i < $art_chkdqwqcad$art_c; $art_iwgfmavj$art_i++) {
                        var city = $art_objgvhwlw$art_obj[$art_iwgfmavj$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
