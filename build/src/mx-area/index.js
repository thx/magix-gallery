...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cntuydz$art_c = types.length; typeIndex < $art_cntuydz$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cntuydz$art_c = types.length; typeIndex < $art_cntuydz$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cevasqg$art_c = types.length; typeIndex < $art_cevasqg$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cevasqg$art_c = types.length; typeIndex < $art_cevasqg$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objdbpvxnti$art_obj = type.groups, $art_cshgaeehhi$art_c = $art_objdbpvxnti$art_obj.length; groupIndex < $art_cshgaeehhi$art_c; groupIndex++) {        var group = $art_objdbpvxnti$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objdbpvxnti$art_obj = type.groups, $art_cshgaeehhi$art_c = $art_objdbpvxnti$art_obj.length; groupIndex < $art_cshgaeehhi$art_c; groupIndex++) {
            var group = $art_objdbpvxnti$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjvdfsawbpb$art_c = group.length; areaIndex < $art_cjvdfsawbpb$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjvdfsawbpb$art_c = group.length; areaIndex < $art_cjvdfsawbpb$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iswmqnkp$art_i = 0, $art_objfoazpedw$art_obj = area.provinces, $art_cojrej$art_c = $art_objfoazpedw$art_obj.length; $art_iswmqnkp$art_i < $art_cojrej$art_c; $art_iswmqnkp$art_i++) {                var province = $art_objfoazpedw$art_obj[$art_iswmqnkp$art_i]%>';
                for (var $art_iswmqnkp$art_i = 0, $art_objfoazpedw$art_obj = area.provinces, $art_cojrej$art_c = $art_objfoazpedw$art_obj.length; $art_iswmqnkp$art_i < $art_cojrej$art_c; $art_iswmqnkp$art_i++) {
                    var province = $art_objfoazpedw$art_obj[$art_iswmqnkp$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iuvculmiw$art_i = 0, $art_objcleojho$art_obj = province.cities, $art_cawsqulxck$art_c = $art_objcleojho$art_obj.length; $art_iuvculmiw$art_i < $art_cawsqulxck$art_c; $art_iuvculmiw$art_i++) {                    var city = $art_objcleojho$art_obj[$art_iuvculmiw$art_i]%>';
                    for (var $art_iuvculmiw$art_i = 0, $art_objcleojho$art_obj = province.cities, $art_cawsqulxck$art_c = $art_objcleojho$art_obj.length; $art_iuvculmiw$art_i < $art_cawsqulxck$art_c; $art_iuvculmiw$art_i++) {
                        var city = $art_objcleojho$art_obj[$art_iuvculmiw$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
