...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cxgfczj$art_c = types.length; typeIndex < $art_cxgfczj$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cxgfczj$art_c = types.length; typeIndex < $art_cxgfczj$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cfejmgsw$art_c = types.length; typeIndex < $art_cfejmgsw$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cfejmgsw$art_c = types.length; typeIndex < $art_cfejmgsw$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objyhtfscremi$art_obj = type.groups, $art_cabnyewwa$art_c = $art_objyhtfscremi$art_obj.length; groupIndex < $art_cabnyewwa$art_c; groupIndex++) {        var group = $art_objyhtfscremi$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objyhtfscremi$art_obj = type.groups, $art_cabnyewwa$art_c = $art_objyhtfscremi$art_obj.length; groupIndex < $art_cabnyewwa$art_c; groupIndex++) {
            var group = $art_objyhtfscremi$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cjtbrucwaz$art_c = group.length; areaIndex < $art_cjtbrucwaz$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cjtbrucwaz$art_c = group.length; areaIndex < $art_cjtbrucwaz$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ifmtxe$art_i = 0, $art_objfmkxwdsss$art_obj = area.provinces, $art_cfofhoduil$art_c = $art_objfmkxwdsss$art_obj.length; $art_ifmtxe$art_i < $art_cfofhoduil$art_c; $art_ifmtxe$art_i++) {                var province = $art_objfmkxwdsss$art_obj[$art_ifmtxe$art_i]%>';
                for (var $art_ifmtxe$art_i = 0, $art_objfmkxwdsss$art_obj = area.provinces, $art_cfofhoduil$art_c = $art_objfmkxwdsss$art_obj.length; $art_ifmtxe$art_i < $art_cfofhoduil$art_c; $art_ifmtxe$art_i++) {
                    var province = $art_objfmkxwdsss$art_obj[$art_ifmtxe$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ipslxbtwb$art_i = 0, $art_objkdjhvuoy$art_obj = province.cities, $art_chcdmacxpb$art_c = $art_objkdjhvuoy$art_obj.length; $art_ipslxbtwb$art_i < $art_chcdmacxpb$art_c; $art_ipslxbtwb$art_i++) {                    var city = $art_objkdjhvuoy$art_obj[$art_ipslxbtwb$art_i]%>';
                    for (var $art_ipslxbtwb$art_i = 0, $art_objkdjhvuoy$art_obj = province.cities, $art_chcdmacxpb$art_c = $art_objkdjhvuoy$art_obj.length; $art_ipslxbtwb$art_i < $art_chcdmacxpb$art_c; $art_ipslxbtwb$art_i++) {
                        var city = $art_objkdjhvuoy$art_obj[$art_ipslxbtwb$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
