...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cydbzbiml$art_c = types.length; typeIndex < $art_cydbzbiml$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cydbzbiml$art_c = types.length; typeIndex < $art_cydbzbiml$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_crpljel$art_c = types.length; typeIndex < $art_crpljel$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_crpljel$art_c = types.length; typeIndex < $art_crpljel$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objisejzxocfn$art_obj = type.groups, $art_ctbpsme$art_c = $art_objisejzxocfn$art_obj.length; groupIndex < $art_ctbpsme$art_c; groupIndex++) {        var group = $art_objisejzxocfn$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objisejzxocfn$art_obj = type.groups, $art_ctbpsme$art_c = $art_objisejzxocfn$art_obj.length; groupIndex < $art_ctbpsme$art_c; groupIndex++) {
            var group = $art_objisejzxocfn$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cpjeanbpndb$art_c = group.length; areaIndex < $art_cpjeanbpndb$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cpjeanbpndb$art_c = group.length; areaIndex < $art_cpjeanbpndb$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_icgloiggwrr$art_i = 0, $art_objtvluewp$art_obj = area.provinces, $art_cfqdpnkukb$art_c = $art_objtvluewp$art_obj.length; $art_icgloiggwrr$art_i < $art_cfqdpnkukb$art_c; $art_icgloiggwrr$art_i++) {                var province = $art_objtvluewp$art_obj[$art_icgloiggwrr$art_i]%>';
                for (var $art_icgloiggwrr$art_i = 0, $art_objtvluewp$art_obj = area.provinces, $art_cfqdpnkukb$art_c = $art_objtvluewp$art_obj.length; $art_icgloiggwrr$art_i < $art_cfqdpnkukb$art_c; $art_icgloiggwrr$art_i++) {
                    var province = $art_objtvluewp$art_obj[$art_icgloiggwrr$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iflvjpmuxv$art_i = 0, $art_objwvmstxoi$art_obj = province.cities, $art_cvokzfo$art_c = $art_objwvmstxoi$art_obj.length; $art_iflvjpmuxv$art_i < $art_cvokzfo$art_c; $art_iflvjpmuxv$art_i++) {                    var city = $art_objwvmstxoi$art_obj[$art_iflvjpmuxv$art_i]%>';
                    for (var $art_iflvjpmuxv$art_i = 0, $art_objwvmstxoi$art_obj = province.cities, $art_cvokzfo$art_c = $art_objwvmstxoi$art_obj.length; $art_iflvjpmuxv$art_i < $art_cvokzfo$art_c; $art_iflvjpmuxv$art_i++) {
                        var city = $art_objwvmstxoi$art_obj[$art_iflvjpmuxv$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
