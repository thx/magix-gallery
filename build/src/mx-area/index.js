...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cavwbrxoj$art_c = types.length; typeIndex < $art_cavwbrxoj$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cavwbrxoj$art_c = types.length; typeIndex < $art_cavwbrxoj$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cnvfwplicip$art_c = types.length; typeIndex < $art_cnvfwplicip$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cnvfwplicip$art_c = types.length; typeIndex < $art_cnvfwplicip$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objjstccip$art_obj = type.groups, $art_cbvvwlyaj$art_c = $art_objjstccip$art_obj.length; groupIndex < $art_cbvvwlyaj$art_c; groupIndex++) {        var group = $art_objjstccip$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objjstccip$art_obj = type.groups, $art_cbvvwlyaj$art_c = $art_objjstccip$art_obj.length; groupIndex < $art_cbvvwlyaj$art_c; groupIndex++) {
            var group = $art_objjstccip$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_csxuakvmwp$art_c = group.length; areaIndex < $art_csxuakvmwp$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_csxuakvmwp$art_c = group.length; areaIndex < $art_csxuakvmwp$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ihwrvgpdd$art_i = 0, $art_objgxixkyw$art_obj = area.provinces, $art_cbntisehfkab$art_c = $art_objgxixkyw$art_obj.length; $art_ihwrvgpdd$art_i < $art_cbntisehfkab$art_c; $art_ihwrvgpdd$art_i++) {                var province = $art_objgxixkyw$art_obj[$art_ihwrvgpdd$art_i]%>';
                for (var $art_ihwrvgpdd$art_i = 0, $art_objgxixkyw$art_obj = area.provinces, $art_cbntisehfkab$art_c = $art_objgxixkyw$art_obj.length; $art_ihwrvgpdd$art_i < $art_cbntisehfkab$art_c; $art_ihwrvgpdd$art_i++) {
                    var province = $art_objgxixkyw$art_obj[$art_ihwrvgpdd$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_ioqbhgqgd$art_i = 0, $art_objqbzyetw$art_obj = province.cities, $art_czzxfknvp$art_c = $art_objqbzyetw$art_obj.length; $art_ioqbhgqgd$art_i < $art_czzxfknvp$art_c; $art_ioqbhgqgd$art_i++) {                    var city = $art_objqbzyetw$art_obj[$art_ioqbhgqgd$art_i]%>';
                    for (var $art_ioqbhgqgd$art_i = 0, $art_objqbzyetw$art_obj = province.cities, $art_czzxfknvp$art_c = $art_objqbzyetw$art_obj.length; $art_ioqbhgqgd$art_i < $art_czzxfknvp$art_c; $art_ioqbhgqgd$art_i++) {
                        var city = $art_objqbzyetw$art_obj[$art_ioqbhgqgd$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
