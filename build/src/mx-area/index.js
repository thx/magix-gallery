...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $p += '';
        $expr = '<%for (var typeIndex = 0, $art_chwszgcpuyg$art_c = types.length; typeIndex < $art_chwszgcpuyg$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_chwszgcpuyg$art_c = types.length; typeIndex < $art_chwszgcpuyg$art_c; typeIndex++) {
    ...
    ;
    $p += '';
    $expr = '<%for (var typeIndex = 0, $art_cgqbsbnb$art_c = types.length; typeIndex < $art_cgqbsbnb$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cgqbsbnb$art_c = types.length; typeIndex < $art_cgqbsbnb$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_objrngrt$art_obj = type.groups, $art_cqyubsejk$art_c = $art_objrngrt$art_obj.length; groupIndex < $art_cqyubsejk$art_c; groupIndex++) {        var group = $art_objrngrt$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objrngrt$art_obj = type.groups, $art_cqyubsejk$art_c = $art_objrngrt$art_obj.length; groupIndex < $art_cqyubsejk$art_c; groupIndex++) {
            var group = $art_objrngrt$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $p += '';
            $expr = '<%for (var areaIndex = 0, $art_cevydhuyu$art_c = group.length; areaIndex < $art_cevydhuyu$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cevydhuyu$art_c = group.length; areaIndex < $art_cevydhuyu$art_c; areaIndex++) {
                ...
                ;
                $p += '';
                $expr = '<%for (var $art_irmavxibvs$art_i = 0, $art_objkyriolykg$art_obj = area.provinces, $art_csasdeg$art_c = $art_objkyriolykg$art_obj.length; $art_irmavxibvs$art_i < $art_csasdeg$art_c; $art_irmavxibvs$art_i++) {                var province = $art_objkyriolykg$art_obj[$art_irmavxibvs$art_i]%>';
                for (var $art_irmavxibvs$art_i = 0, $art_objkyriolykg$art_obj = area.provinces, $art_csasdeg$art_c = $art_objkyriolykg$art_obj.length; $art_irmavxibvs$art_i < $art_csasdeg$art_c; $art_irmavxibvs$art_i++) {
                    var province = $art_objkyriolykg$art_obj[$art_irmavxibvs$art_i];
                    ...
                    ;
                    $p += '';
                    $expr = '<%for (var $art_ifjvfkbc$art_i = 0, $art_objdzdobbqorfn$art_obj = province.cities, $art_czmeqaqjth$art_c = $art_objdzdobbqorfn$art_obj.length; $art_ifjvfkbc$art_i < $art_czmeqaqjth$art_c; $art_ifjvfkbc$art_i++) {                    var city = $art_objdzdobbqorfn$art_obj[$art_ifjvfkbc$art_i]%>';
                    for (var $art_ifjvfkbc$art_i = 0, $art_objdzdobbqorfn$art_obj = province.cities, $art_czmeqaqjth$art_c = $art_objdzdobbqorfn$art_obj.length; $art_ifjvfkbc$art_i < $art_czmeqaqjth$art_c; $art_ifjvfkbc$art_i++) {
                        var city = $art_objdzdobbqorfn$art_obj[$art_ifjvfkbc$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
