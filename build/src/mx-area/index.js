...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cnpuvsoyf$art_c = types.length; typeIndex < $art_cnpuvsoyf$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cnpuvsoyf$art_c = types.length; typeIndex < $art_cnpuvsoyf$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_ctkurfovy$art_c = types.length; typeIndex < $art_ctkurfovy$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_ctkurfovy$art_c = types.length; typeIndex < $art_ctkurfovy$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objlttfxqkxeu$art_obj = type.groups, $art_cxibnrfnpc$art_c = $art_objlttfxqkxeu$art_obj.length; groupIndex < $art_cxibnrfnpc$art_c; groupIndex++) {        var group = $art_objlttfxqkxeu$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objlttfxqkxeu$art_obj = type.groups, $art_cxibnrfnpc$art_c = $art_objlttfxqkxeu$art_obj.length; groupIndex < $art_cxibnrfnpc$art_c; groupIndex++) {
            var group = $art_objlttfxqkxeu$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_coowoseayqo$art_c = group.length; areaIndex < $art_coowoseayqo$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_coowoseayqo$art_c = group.length; areaIndex < $art_coowoseayqo$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ijdvbkciwq$art_i = 0, $art_objnmucfi$art_obj = area.provinces, $art_cpwandntb$art_c = $art_objnmucfi$art_obj.length; $art_ijdvbkciwq$art_i < $art_cpwandntb$art_c; $art_ijdvbkciwq$art_i++) {                var province = $art_objnmucfi$art_obj[$art_ijdvbkciwq$art_i]%>';
                for (var $art_ijdvbkciwq$art_i = 0, $art_objnmucfi$art_obj = area.provinces, $art_cpwandntb$art_c = $art_objnmucfi$art_obj.length; $art_ijdvbkciwq$art_i < $art_cpwandntb$art_c; $art_ijdvbkciwq$art_i++) {
                    var province = $art_objnmucfi$art_obj[$art_ijdvbkciwq$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_itwrvxjxqk$art_i = 0, $art_objiyahmbwgwq$art_obj = province.cities, $art_cwtkqazae$art_c = $art_objiyahmbwgwq$art_obj.length; $art_itwrvxjxqk$art_i < $art_cwtkqazae$art_c; $art_itwrvxjxqk$art_i++) {                    var city = $art_objiyahmbwgwq$art_obj[$art_itwrvxjxqk$art_i]%>';
                    for (var $art_itwrvxjxqk$art_i = 0, $art_objiyahmbwgwq$art_obj = province.cities, $art_cwtkqazae$art_c = $art_objiyahmbwgwq$art_obj.length; $art_itwrvxjxqk$art_i < $art_cwtkqazae$art_c; $art_itwrvxjxqk$art_i++) {
                        var city = $art_objiyahmbwgwq$art_obj[$art_itwrvxjxqk$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
