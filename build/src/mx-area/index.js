...
module.exports = Magix.View.extend({
    ...
    if (isTab) {
        ...
        ;
        $expr = '<%for (var typeIndex = 0, $art_cqrhb$art_c = types.length; typeIndex < $art_cqrhb$art_c; typeIndex++) {        var type = types[typeIndex]%>';
        for (var typeIndex = 0, $art_cqrhb$art_c = types.length; typeIndex < $art_cqrhb$art_c; typeIndex++) {
    ...
    $art = 'each types as type typeIndex';
    ;
    $expr = '<%for (var typeIndex = 0, $art_cdkhhynjpq$art_c = types.length; typeIndex < $art_cdkhhynjpq$art_c; typeIndex++) {    var type = types[typeIndex]%>';
    for (var typeIndex = 0, $art_cdkhhynjpq$art_c = types.length; typeIndex < $art_cdkhhynjpq$art_c; typeIndex++) {
        var type = types[typeIndex];
        $p += '<div mxv class="';
        $line = 22;
        $art = 'if isTab';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_objhstootua$art_obj = type.groups, $art_cigjya$art_c = $art_objhstootua$art_obj.length; groupIndex < $art_cigjya$art_c; groupIndex++) {        var group = $art_objhstootua$art_obj[groupIndex]%>';
        for (var groupIndex = 0, $art_objhstootua$art_obj = type.groups, $art_cigjya$art_c = $art_objhstootua$art_obj.length; groupIndex < $art_cigjya$art_c; groupIndex++) {
            var group = $art_objhstootua$art_obj[groupIndex];
            $p += '<div mxv ';
            $line = 33;
            $art = 'if type.half';
            ;
            ...
            ;
            $expr = '<%for (var areaIndex = 0, $art_cibuwjhvpzo$art_c = group.length; areaIndex < $art_cibuwjhvpzo$art_c; areaIndex++) {            var area = group[areaIndex]%>';
            for (var areaIndex = 0, $art_cibuwjhvpzo$art_c = group.length; areaIndex < $art_cibuwjhvpzo$art_c; areaIndex++) {
                ...
                ;
                $expr = '<%for (var $art_icnzgbmfpra$art_i = 0, $art_objcfhkigpuid$art_obj = area.provinces, $art_cjsfkgyzr$art_c = $art_objcfhkigpuid$art_obj.length; $art_icnzgbmfpra$art_i < $art_cjsfkgyzr$art_c; $art_icnzgbmfpra$art_i++) {                var province = $art_objcfhkigpuid$art_obj[$art_icnzgbmfpra$art_i]%>';
                for (var $art_icnzgbmfpra$art_i = 0, $art_objcfhkigpuid$art_obj = area.provinces, $art_cjsfkgyzr$art_c = $art_objcfhkigpuid$art_obj.length; $art_icnzgbmfpra$art_i < $art_cjsfkgyzr$art_c; $art_icnzgbmfpra$art_i++) {
                    var province = $art_objcfhkigpuid$art_obj[$art_icnzgbmfpra$art_i];
                    ...
                    ;
                    $expr = '<%for (var $art_iudmxfszji$art_i = 0, $art_objvkjxkki$art_obj = province.cities, $art_cbdhfjotn$art_c = $art_objvkjxkki$art_obj.length; $art_iudmxfszji$art_i < $art_cbdhfjotn$art_c; $art_iudmxfszji$art_i++) {                    var city = $art_objvkjxkki$art_obj[$art_iudmxfszji$art_i]%>';
                    for (var $art_iudmxfszji$art_i = 0, $art_objvkjxkki$art_obj = province.cities, $art_cbdhfjotn$art_c = $art_objvkjxkki$art_obj.length; $art_iudmxfszji$art_i < $art_cbdhfjotn$art_c; $art_iudmxfszji$art_i++) {
                        var city = $art_objvkjxkki$art_obj[$art_iudmxfszji$art_i];
                        $p += '<label mxv for="';
                        $line = 54;
                        $art = '=viewId';
                        ;
