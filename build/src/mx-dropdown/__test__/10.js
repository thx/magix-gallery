...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaB:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaB:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryaB:b" class="mb20"><div class="w200" mx-view="mx-dropdown/multiple?needAll=false&list=';
    $line = 6;
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div><div mxs="_zs_galleryaB:_" class="w200" mx-view="mx-dropdown/multiple?needAll=false"><i value="1" class="none">1</i><i value="2" class="none">2</i><i value="3" class="none">3</i></div></div><div mxa="_zs_galleryaB:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaB:a" class="_zs_gallery___test___layout_-eg-title">显示文案和前后端传递值一致</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
