...
module.exports = Base.extend({
    ...
    $art = '@[1,2,3]';
    ;
    $p += '' + ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div><div mxs="_zs_gallery,:_" class="w200" mx-view="mx-dropdown/multiple"><i value="1" class="none">1</i><i value="2" class="none">2</i><i value="3" class="none">3</i></div></div><div mxa="_zs_gallery,:c" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallery,:a" class="_zs_gallery___test___base_-eg-title">显示文案和前后端传递值一致</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
