...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya.:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerya.:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerya.:e" class="mb20 clearfix lh22"><div class="fl color-9">说明：</div><div class="fl"><div>选项支持html片段</div><div>选中项传入支持传入数组或者逗号分隔</div><div>以下两个下拉框选中项保持一致</div></div></div><div mxv mxa="_zs_gallerya.:h" class="mb20"><div mxv="list,selectedArr" class="w200" mx-change="' + $viewId + 'select()" mx-view="mx-dropdown/multiple?list=';
    $line = 13;
    $art = '@list';
    ;
    ...
    $art = '@selectedArr';
    ;
    $p += ($expr = '<%@selectedArr%>', $i($$ref, selectedArr)) + '"></div></div><div mxv mxa="_zs_gallerya.:i" class="mb20"><div mxv="list,selectedStr" class="w200" mx-change="' + $viewId + 'select()" mx-view="mx-dropdown/multiple?list=';
    $line = 19;
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '&selected=';
    ...
    $art = '=selectedArr';
    ;
    $p += ($expr = '<%=selectedArr%>', $e(selectedArr)) + '</span></div></div><div mxa="_zs_gallerya.:j" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya.:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 30;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-dropdown.multiple class="w200"\n    list="&#123;&#123;@list&#125;&#125;"\n    selected="&#123;&#123;@selectedArr&#125;&#125;"\n    mx-change="select()"/&gt;\n\n&lt;mx-dropdown.multiple class="w200"\n    list="&#123;&#123;@list&#125;&#125;"\n    selected="&#123;&#123;@selectedStr&#125;&#125;"\n    mx-change="select()"/&gt;</pre></div><div mxa="_zs_gallerya.:l" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya.:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 48;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_gallerya.:m" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 50;
    $art = '!text2';
    ;
