...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryav:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryav:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryav:_" class="color-9 mb20 clearfix"><div class="fl"><i class="mc-iconfont displacement-2 mr5">&#xe6ac;</i></div><div class="fl lh22"><div>选中项传入支持传入数组或者逗号分隔</div><div>以下两个下拉框选中项保持一致</div></div></div><div mxv mxa="_zs_galleryav:b" class="mb20"><div mxv="list,selectedArr" class="w200" mx-change="' + $viewId + 'select()" mx-view="mx-dropdown/multiple?list=';
    $line = 14;
    $art = '@list';
    ;
    ...
    $art = '@selectedArr';
    ;
    $p += '' + ($expr = '<%@selectedArr%>', $i($$ref, selectedArr)) + '"></div></div><div mxv mxa="_zs_galleryav:c" class="mb20"><div mxv="list,selectedStr" class="w200" mx-change="' + $viewId + 'select()" mx-view="mx-dropdown/multiple?list=';
    $line = 20;
    $art = '@list';
    ;
    $p += '' + ($expr = '<%@list%>', $i($$ref, list)) + '&selected=';
    ...
    $art = '@selectedStr';
    ;
    $p += '' + ($expr = '<%@selectedStr%>', $i($$ref, selectedStr)) + '"></div></div><div><span mxs="_zs_galleryav:a" class="color-9">当前选中值：</span><span>';
    $line = 26;
    $art = '=selectedArr';
    ;
    $p += '' + ($expr = '<%=selectedArr%>', $e(selectedArr)) + '</span></div></div><div mxa="_zs_galleryav:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryav:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 31;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-dropdown.multiple class="w200"\n    list="&#123;&#123;@list&#125;&#125;"\n    selected="&#123;&#123;@selectedArr&#125;&#125;"\n    mx-change="select()"/&gt;\n\n&lt;mx-dropdown.multiple class="w200"\n    list="&#123;&#123;@list&#125;&#125;"\n    selected="&#123;&#123;@selectedStr&#125;&#125;"\n    mx-change="select()"/&gt;</pre></div><div mxa="_zs_galleryav:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryav:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 49;
    $art = '=viewId';
    ;
