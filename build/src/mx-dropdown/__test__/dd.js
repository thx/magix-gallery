...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_bd" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryaF:a" class="clearfix mb20"><div mxa="_zs_galleryaF:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-dropdown/__test__/19" id="';
    $line = 23;
    $art = '=viewId';
    ;
