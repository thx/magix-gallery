...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaF:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaF:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/multiple?list=';
    $line = 4;
