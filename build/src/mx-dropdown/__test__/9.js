...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryax:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryax:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/multiple?list=';
    $line = 4;
    $art = '@[{id:1,name:\'选项1\'},{id:2,name:\'选项2\'}]';
    ;
    $p += ($expr = '<%@[{ id: 1, name: \'选项1\' }, { id: 2, name: \'选项2\' }]%>', $i($$ref, [{ id: 1, name: '选项1' }, { id: 2, name: '选项2' }])) + '&textKey=name&valueKey=id"></div></div><div mxa="_zs_galleryax:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryax:_" class="_zs_gallery___test___layout_-eg-title">自定义&nbsp;text-key&nbsp;和&nbsp;value-key</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
