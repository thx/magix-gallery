...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya3:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerya3:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerya3:_" class="clearfix mb20"><div class="fl color-9">以下示例：</div><div class="fl">下拉框带名称</div></div><div class="w200" mx-view="mx-dropdown/index?name=%E6%95%B0%E5%AD%97&list=';
    $line = 9;
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div><div mxa="_zs_gallerya3:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya3:a" class="_zs_gallery___test___layout_-eg-title">选择为空时的提示文案定制</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
