...
module.exports = Base.extend({
    ...
    $art = '@[1,2,3]';
    ;
    $p += '' + ($expr = '<%@[1,2,3]%>', $i([1, 2, 3])) + '"></div></div><div mxa="_zs_gallery,:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallery,:_" class="_zs_gallery___test___base_-eg-title">选择为空时的提示文案定制</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
