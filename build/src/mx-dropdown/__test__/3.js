...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryam:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryam:a" class="_zs_gallery___test___layout_-eg-content"><div mxv="list" class="w200" mx-view="mx-dropdown/index?textKey=name&valueKey=id&list=';
    $line = 6;
    $art = '@list';
    ;
