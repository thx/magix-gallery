...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya%:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerya%:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/index?textKey=name&valueKey=id&list=';
    $line = 6;
    $art = '@[{id:1,name:\'选择1\'},{id:2,name:\'选择2\'}]';
    ;
    $p += ($expr = '<%@[{ id: 1, name: \'选择1\' }, { id: 2, name: \'选择2\' }]%>', $i($$ref, [{ id: 1, name: '选择1' }, { id: 2, name: '选择2' }])) + '"></div></div><div mxa="_zs_gallerya%:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya%:_" class="_zs_gallery___test___layout_-eg-title">自定义&nbsp;text-key&nbsp;和&nbsp;value-key</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
