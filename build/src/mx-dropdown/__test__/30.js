/*
    ...
    loader: cmd_es
 */
define("mx-dropdown/__test__/30",["magix","__test__/example","$","../index","mx-copy/index","__test__/hl"],(require,exports,module)=>{
/*Magix,Base,$*/
require("../index");
...
module.exports = Base.extend({
    ...
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div><div mxa="_zs_gallerya%:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya%:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-dropdown/__test__/30.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
