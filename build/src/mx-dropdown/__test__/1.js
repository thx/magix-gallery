...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_imnioowvmf$art_i = 0, $art_coopkki$art_c = first.length; $art_imnioowvmf$art_i < $art_coopkki$art_c; $art_imnioowvmf$art_i++) {    var i = first[$art_imnioowvmf$art_i]%>';
    for (var $art_imnioowvmf$art_i = 0, $art_coopkki$art_c = first.length; $art_imnioowvmf$art_i < $art_coopkki$art_c; $art_imnioowvmf$art_i++) {
        var i = first[$art_imnioowvmf$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_iniiovpge$art_i = 0, $art_cssqeqlp$art_c = second.length; $art_iniiovpge$art_i < $art_cssqeqlp$art_c; $art_iniiovpge$art_i++) {    var i = second[$art_iniiovpge$art_i]%>';
    for (var $art_iniiovpge$art_i = 0, $art_cssqeqlp$art_c = second.length; $art_iniiovpge$art_i < $art_cssqeqlp$art_c; $art_iniiovpge$art_i++) {
        var i = second[$art_iniiovpge$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
