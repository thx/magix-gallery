...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_itxrvm$art_i=0;$art_itxrvm$art_i<first.length;$art_itxrvm$art_i++){var i=first[$art_itxrvm$art_i]%>';
    for (var $art_itxrvm$art_i = 0; $art_itxrvm$art_i < first.length; $art_itxrvm$art_i++) {
        var i = first[$art_itxrvm$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ifudopemipm$art_i=0;$art_ifudopemipm$art_i<second.length;$art_ifudopemipm$art_i++){var i=second[$art_ifudopemipm$art_i]%>';
    for (var $art_ifudopemipm$art_i = 0; $art_ifudopemipm$art_i < second.length; $art_ifudopemipm$art_i++) {
        var i = second[$art_ifudopemipm$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
