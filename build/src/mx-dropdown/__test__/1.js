...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryas:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryas:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryas:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div>带分组的只能用mx-dropdown.item节点实现</div><div>点击展开下拉选项</div></div></div><div mxa="_zs_galleryas:b" class="clearfix"><div class="w200 fl" mx-view="mx-dropdown/index?selected=';
    $line = 12;
    $art = '=selected';
    ;
    $p += ($expr = '<%!$eu(selected)%>', $eu(selected)) + '"><i mxs="_zs_galleryas:a" group="true" class="none">第一组</i>';
    $line = 14;
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_ibcngzjaju$art_i = 0, $art_chbgpvmenoc$art_c = first.length; $art_ibcngzjaju$art_i < $art_chbgpvmenoc$art_c; $art_ibcngzjaju$art_i++) {    var i = first[$art_ibcngzjaju$art_i]%>';
    for (var $art_ibcngzjaju$art_i = 0, $art_chbgpvmenoc$art_c = first.length; $art_ibcngzjaju$art_i < $art_chbgpvmenoc$art_c; $art_ibcngzjaju$art_i++) {
        var i = first[$art_ibcngzjaju$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '<i mxs="_zs_galleryas:b" group="true" class="none">第二组</i>';
    $line = 18;
    $art = 'each second as i';
    ;
    $expr = '<%for (var $art_iupnxmghlf$art_i = 0, $art_clweujloep$art_c = second.length; $art_iupnxmghlf$art_i < $art_clweujloep$art_c; $art_iupnxmghlf$art_i++) {    var i = second[$art_iupnxmghlf$art_i]%>';
    for (var $art_iupnxmghlf$art_i = 0, $art_clweujloep$art_c = second.length; $art_iupnxmghlf$art_i < $art_clweujloep$art_c; $art_iupnxmghlf$art_i++) {
        var i = second[$art_iupnxmghlf$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
