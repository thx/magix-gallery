...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_imxozqe$art_i=0;$art_imxozqe$art_i<first.length;$art_imxozqe$art_i++){var i=first[$art_imxozqe$art_i]%>';
    for (var $art_imxozqe$art_i = 0; $art_imxozqe$art_i < first.length; $art_imxozqe$art_i++) {
        var i = first[$art_imxozqe$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ifnwvxik$art_i=0;$art_ifnwvxik$art_i<second.length;$art_ifnwvxik$art_i++){var i=second[$art_ifnwvxik$art_i]%>';
    for (var $art_ifnwvxik$art_i = 0; $art_ifnwvxik$art_i < second.length; $art_ifnwvxik$art_i++) {
        var i = second[$art_ifnwvxik$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
