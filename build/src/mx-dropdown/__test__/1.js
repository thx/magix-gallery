...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_inkmbzhf$art_i = 0, $art_ctlbxkrt$art_c = first.length; $art_inkmbzhf$art_i < $art_ctlbxkrt$art_c; $art_inkmbzhf$art_i++) {    var i = first[$art_inkmbzhf$art_i]%>';
    for (var $art_inkmbzhf$art_i = 0, $art_ctlbxkrt$art_c = first.length; $art_inkmbzhf$art_i < $art_ctlbxkrt$art_c; $art_inkmbzhf$art_i++) {
        var i = first[$art_inkmbzhf$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_igxnxbbibj$art_i = 0, $art_cbxhymwmbl$art_c = second.length; $art_igxnxbbibj$art_i < $art_cbxhymwmbl$art_c; $art_igxnxbbibj$art_i++) {    var i = second[$art_igxnxbbibj$art_i]%>';
    for (var $art_igxnxbbibj$art_i = 0, $art_cbxhymwmbl$art_c = second.length; $art_igxnxbbibj$art_i < $art_cbxhymwmbl$art_c; $art_igxnxbbibj$art_i++) {
        var i = second[$art_igxnxbbibj$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
