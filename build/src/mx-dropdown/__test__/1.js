...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ijrgzsize$art_i=0;$art_ijrgzsize$art_i<first.length;$art_ijrgzsize$art_i++){var i=first[$art_ijrgzsize$art_i]%>';
    for (var $art_ijrgzsize$art_i = 0; $art_ijrgzsize$art_i < first.length; $art_ijrgzsize$art_i++) {
        var i = first[$art_ijrgzsize$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ihuxfdjbev$art_i=0;$art_ihuxfdjbev$art_i<second.length;$art_ihuxfdjbev$art_i++){var i=second[$art_ihuxfdjbev$art_i]%>';
    for (var $art_ihuxfdjbev$art_i = 0; $art_ihuxfdjbev$art_i < second.length; $art_ihuxfdjbev$art_i++) {
        var i = second[$art_ihuxfdjbev$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
