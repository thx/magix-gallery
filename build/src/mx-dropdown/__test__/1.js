...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_ilhzlxvs$art_i = 0, $art_cjetnllqgk$art_c = first.length; $art_ilhzlxvs$art_i < $art_cjetnllqgk$art_c; $art_ilhzlxvs$art_i++) {    var i = first[$art_ilhzlxvs$art_i]%>';
    for (var $art_ilhzlxvs$art_i = 0, $art_cjetnllqgk$art_c = first.length; $art_ilhzlxvs$art_i < $art_cjetnllqgk$art_c; $art_ilhzlxvs$art_i++) {
        var i = first[$art_ilhzlxvs$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_icfcuhzxmx$art_i = 0, $art_cxjpyujd$art_c = second.length; $art_icfcuhzxmx$art_i < $art_cxjpyujd$art_c; $art_icfcuhzxmx$art_i++) {    var i = second[$art_icfcuhzxmx$art_i]%>';
    for (var $art_icfcuhzxmx$art_i = 0, $art_cxjpyujd$art_c = second.length; $art_icfcuhzxmx$art_i < $art_cxjpyujd$art_c; $art_icfcuhzxmx$art_i++) {
        var i = second[$art_icfcuhzxmx$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
