...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_isdwmkqqute$art_i = 0, $art_chrwerqkr$art_c = first.length; $art_isdwmkqqute$art_i < $art_chrwerqkr$art_c; $art_isdwmkqqute$art_i++) {    var i = first[$art_isdwmkqqute$art_i]%>';
    for (var $art_isdwmkqqute$art_i = 0, $art_chrwerqkr$art_c = first.length; $art_isdwmkqqute$art_i < $art_chrwerqkr$art_c; $art_isdwmkqqute$art_i++) {
        var i = first[$art_isdwmkqqute$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_invzpibzyd$art_i = 0, $art_cuvhpgayq$art_c = second.length; $art_invzpibzyd$art_i < $art_cuvhpgayq$art_c; $art_invzpibzyd$art_i++) {    var i = second[$art_invzpibzyd$art_i]%>';
    for (var $art_invzpibzyd$art_i = 0, $art_cuvhpgayq$art_c = second.length; $art_invzpibzyd$art_i < $art_cuvhpgayq$art_c; $art_invzpibzyd$art_i++) {
        var i = second[$art_invzpibzyd$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
