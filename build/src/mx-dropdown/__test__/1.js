...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_itkikttzcl$art_i = 0, $art_cikxlddas$art_c = first.length; $art_itkikttzcl$art_i < $art_cikxlddas$art_c; $art_itkikttzcl$art_i++) {    var i = first[$art_itkikttzcl$art_i]%>';
    for (var $art_itkikttzcl$art_i = 0, $art_cikxlddas$art_c = first.length; $art_itkikttzcl$art_i < $art_cikxlddas$art_c; $art_itkikttzcl$art_i++) {
        var i = first[$art_itkikttzcl$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ikffsnh$art_i = 0, $art_cuclrubj$art_c = second.length; $art_ikffsnh$art_i < $art_cuclrubj$art_c; $art_ikffsnh$art_i++) {    var i = second[$art_ikffsnh$art_i]%>';
    for (var $art_ikffsnh$art_i = 0, $art_cuclrubj$art_c = second.length; $art_ikffsnh$art_i < $art_cuclrubj$art_c; $art_ikffsnh$art_i++) {
        var i = second[$art_ikffsnh$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
