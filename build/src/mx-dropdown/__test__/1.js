...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_ijlikwiaezl$art_i = 0, $art_czomlqaxc$art_c = first.length; $art_ijlikwiaezl$art_i < $art_czomlqaxc$art_c; $art_ijlikwiaezl$art_i++) {    var i = first[$art_ijlikwiaezl$art_i]%>';
    for (var $art_ijlikwiaezl$art_i = 0, $art_czomlqaxc$art_c = first.length; $art_ijlikwiaezl$art_i < $art_czomlqaxc$art_c; $art_ijlikwiaezl$art_i++) {
        var i = first[$art_ijlikwiaezl$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_ixbhbj$art_i = 0, $art_cyazac$art_c = second.length; $art_ixbhbj$art_i < $art_cyazac$art_c; $art_ixbhbj$art_i++) {    var i = second[$art_ixbhbj$art_i]%>';
    for (var $art_ixbhbj$art_i = 0, $art_cyazac$art_c = second.length; $art_ixbhbj$art_i < $art_cyazac$art_c; $art_ixbhbj$art_i++) {
        var i = second[$art_ixbhbj$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
