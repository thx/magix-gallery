...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iemlbgkngv$art_i = 0, $art_cdsjstny$art_c = first.length; $art_iemlbgkngv$art_i < $art_cdsjstny$art_c; $art_iemlbgkngv$art_i++) {    var i = first[$art_iemlbgkngv$art_i]%>';
    for (var $art_iemlbgkngv$art_i = 0, $art_cdsjstny$art_c = first.length; $art_iemlbgkngv$art_i < $art_cdsjstny$art_c; $art_iemlbgkngv$art_i++) {
        var i = first[$art_iemlbgkngv$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ibshapyen$art_i = 0, $art_cvjujzgsf$art_c = second.length; $art_ibshapyen$art_i < $art_cvjujzgsf$art_c; $art_ibshapyen$art_i++) {    var i = second[$art_ibshapyen$art_i]%>';
    for (var $art_ibshapyen$art_i = 0, $art_cvjujzgsf$art_c = second.length; $art_ibshapyen$art_i < $art_cvjujzgsf$art_c; $art_ibshapyen$art_i++) {
        var i = second[$art_ibshapyen$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
    ...
    ;
    $p += '</div><a mxs="_zs_gallery~:c" href="javascript:;" class="btn btn-brand ml20 fl" mx-click="' + $viewId + 'changeData()">修改数据</a></div></div><div mxa="_zs_gallery~:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallery~:d" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;div class="clearfix"&gt;\n    &lt;mx-dropdown class="w200 mr20 fl"\n        selected="&#123;&#123;=selected&#125;&#125;"&gt;\n        &lt;mx-dropdown.item group="true"&gt;第一组&lt;/mx-dropdown.item&gt;\n        &#123;&#123;each first as i&#125;&#125;\n        &lt;mx-dropdown.item value="&#123;&#123;=i&#125;&#125;"&gt;&#123;&#123;=i&#125;&#125;&lt;/mx-dropdown.item&gt;\n        &#123;&#123;/each&#125;&#125;\n        &lt;mx-dropdown.item group="true"&gt;第二组&lt;/mx-dropdown.item&gt;\n        &#123;&#123;each second as i&#125;&#125;\n        &lt;mx-dropdown.item value="&#123;&#123;=i&#125;&#125;"&gt;&#123;&#123;=i&#125;&#125;&lt;/mx-dropdown.item&gt;\n        &#123;&#123;/each&#125;&#125;\n    &lt;/mx-dropdown&gt;\n    &lt;a class="btn btn-brand fl" href="javascript:;" \n        mx-click="changeData()"&gt;修改数据&lt;/a&gt;\n&lt;/div&gt;</pre></div><div mxa="_zs_gallery~:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallery~:f" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 51;
    $art = '=viewId';
    ;
