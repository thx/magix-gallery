...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ihjztcoh$art_i=0;$art_ihjztcoh$art_i<first.length;$art_ihjztcoh$art_i++){var i=first[$art_ihjztcoh$art_i]%>';
    for (var $art_ihjztcoh$art_i = 0; $art_ihjztcoh$art_i < first.length; $art_ihjztcoh$art_i++) {
        var i = first[$art_ihjztcoh$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ixrsslliiqd$art_i=0;$art_ixrsslliiqd$art_i<second.length;$art_ixrsslliiqd$art_i++){var i=second[$art_ixrsslliiqd$art_i]%>';
    for (var $art_ixrsslliiqd$art_i = 0; $art_ixrsslliiqd$art_i < second.length; $art_ixrsslliiqd$art_i++) {
        var i = second[$art_ixrsslliiqd$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
