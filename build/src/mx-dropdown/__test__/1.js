...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_iqraaijr$art_i = 0, $art_chgulgvy$art_c = first.length; $art_iqraaijr$art_i < $art_chgulgvy$art_c; $art_iqraaijr$art_i++) {    var i = first[$art_iqraaijr$art_i]%>';
    for (var $art_iqraaijr$art_i = 0, $art_chgulgvy$art_c = first.length; $art_iqraaijr$art_i < $art_chgulgvy$art_c; $art_iqraaijr$art_i++) {
        var i = first[$art_iqraaijr$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_ioaroajthti$art_i = 0, $art_cpvbjwxt$art_c = second.length; $art_ioaroajthti$art_i < $art_cpvbjwxt$art_c; $art_ioaroajthti$art_i++) {    var i = second[$art_ioaroajthti$art_i]%>';
    for (var $art_ioaroajthti$art_i = 0, $art_cpvbjwxt$art_c = second.length; $art_ioaroajthti$art_i < $art_cpvbjwxt$art_c; $art_ioaroajthti$art_i++) {
        var i = second[$art_ioaroajthti$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
