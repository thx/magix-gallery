...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_itmnjbshja$art_i = 0, $art_ckksjlruo$art_c = first.length; $art_itmnjbshja$art_i < $art_ckksjlruo$art_c; $art_itmnjbshja$art_i++) {    var i = first[$art_itmnjbshja$art_i]%>';
    for (var $art_itmnjbshja$art_i = 0, $art_ckksjlruo$art_c = first.length; $art_itmnjbshja$art_i < $art_ckksjlruo$art_c; $art_itmnjbshja$art_i++) {
        var i = first[$art_itmnjbshja$art_i];
        $p += '<i value="';
        $line = 15;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ieyfbsih$art_i = 0, $art_chcaqkmsj$art_c = second.length; $art_ieyfbsih$art_i < $art_chcaqkmsj$art_c; $art_ieyfbsih$art_i++) {    var i = second[$art_ieyfbsih$art_i]%>';
    for (var $art_ieyfbsih$art_i = 0, $art_chcaqkmsj$art_c = second.length; $art_ieyfbsih$art_i < $art_chcaqkmsj$art_c; $art_ieyfbsih$art_i++) {
        var i = second[$art_ieyfbsih$art_i];
        $p += '<i value="';
        $line = 19;
        $art = '=i';
        ;
