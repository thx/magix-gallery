...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaG:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaG:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/multiple?placement=top&list=';
    $line = 5;
    $art = '@[{\n                value: 1,\n                text: \'向上1\'\n            },{\n                value: 2,\n                text: \'向上2\'\n            }]';
    ;
