...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div></div><div mxa="_zs_galleryay:c" class="_zs_gallery___test___layout_-half"><div mxs="_zs_galleryay:a" mx-view="mx-dropdown/__test__/15"></div><div mx-view="mx-dropdown/__test__/12" id="';
    $line = 36;
    $art = '=viewId';
    ;
