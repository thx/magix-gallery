...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaK:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaK:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaK:_" class="mb20 clearfix lh22"><div class="fl color-9">以下示例：</div><div class="fl"><div>简单分组</div><div>选中上限max=5，此时全选为选择top max</div></div></div><div mxa="_zs_galleryaK:b" class="w200" mx-view="mx-dropdown/multiple?max=5&searchbox=true&height=250"><i mxs="_zs_galleryaK:a" group="true" class="none">第一组</i>';
    $line = 15;
    ...
    ;
    $p += '<i mxs="_zs_galleryaK:b" group="true" class="none">第二组</i>';
    $line = 19;
    ...
    ;
    $p += '</div></div><div mxa="_zs_galleryaK:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaK:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 26;
    $art = '=viewId';
    ;
