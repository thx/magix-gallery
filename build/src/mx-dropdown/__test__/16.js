...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryam:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryam:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/multiple?searchbox=true&list=';
    $line = 5;
    $art = '@[{\n                value: 1,\n                text: \'测试Logo\'\n            },{\n                value: 2,\n                text: \'logo\'\n            },{\n                value: 3,\n                text: \'123456\'\n            }]';
    ;
    $p += '' + ($expr = '<%@[{            value: 1,            text: \'测试Logo\'        }, {            value: 2,            text: \'logo\'        }, {            value: 3,            text: \'123456\'        }]%>', $i($$ref, [{ value: 1, text: '测试Logo' }, { value: 2, text: 'logo' }, { value: 3, text: '123456' }])) + '"></div></div><div mxa="_zs_galleryam:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryam:_" class="_zs_gallery___test___layout_-eg-title">搜索不区分大小写</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
