...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya9:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerya9:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerya9:_" class="mb20"><span class="color-9">以下示例：</span>分组 + 多选</div><div class="w200" mx-view="mx-dropdown/bd?multiple=true&parents=';
    $line = 9;
    $art = '@[{\n                value:1,\n                text:\'第一组\'\n            },{\n                value:2,\n                text:\'第二组\'\n            }]';
    ;
