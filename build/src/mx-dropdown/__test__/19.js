...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaZ:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaZ:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaZ:_" class="mb20"><span class="color-9">以下示例：</span>单选，支持搜索，搜索不区分大小写</div><div class="w200" mx-change="' + $viewId + 'change()" mx-view="mx-dropdown/bd?searchbox=true&selected=2&list=';
    $line = 10;
    $art = '@[{\n                value:1,\n                text:\'test\'\n            },{\n                value:2,\n                text:\'TestABC\'\n            },{\n                value:3,\n                text:\'Another\'\n            }]';
    ;
    $p += ($expr = '<%@[{            value: 1,            text: \'test\'        }, {            value: 2,            text: \'TestABC\'        }, {            value: 3,            text: \'Another\'        }]%>', $i($$ref, [{ value: 1, text: 'test' }, { value: 2, text: 'TestABC' }, { value: 3, text: 'Another' }])) + '"></div></div><div mxa="_zs_galleryaZ:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaZ:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-dropdown.bd class="w200" \n    searchbox="true"\n    selected="2"\n    list="&#123;&#123;@[&#123;\n        value:1,\n        text:\'test\'\n    &#125;,&#123;\n        value:2,\n        text:\'TestABC\'\n    &#125;,&#123;\n        value:3,\n        text:\'Another\'\n    &#125;]&#125;&#125;"\n    mx-change="change()"&gt;\n&lt;/mx-dropdown.bd&gt;\n        </pre></div><div mxa="_zs_galleryaZ:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryaZ:c" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 50;
    $art = '=viewId';
    ;
