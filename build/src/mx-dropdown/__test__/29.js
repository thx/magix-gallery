...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya@:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerya@:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/bd?multiple=true&searchbox=true&parents=';
    $line = 6;
    $art = '@[{\n                value:1,\n                text:\'第一组\'\n            },{\n                value:2,\n                text:\'第二组\'\n            }]';
    ;
