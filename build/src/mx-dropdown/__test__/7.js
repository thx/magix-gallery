...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_iexxiynl$art_i = 0, $art_culhkudxb$art_c = first.length; $art_iexxiynl$art_i < $art_culhkudxb$art_c; $art_iexxiynl$art_i++) {    var i = first[$art_iexxiynl$art_i]%>';
    for (var $art_iexxiynl$art_i = 0, $art_culhkudxb$art_c = first.length; $art_iexxiynl$art_i < $art_culhkudxb$art_c; $art_iexxiynl$art_i++) {
        var i = first[$art_iexxiynl$art_i];
        $p += '<i value="';
        $line = 21;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_itxtdokz$art_i = 0, $art_chkaaggdrh$art_c = second.length; $art_itxtdokz$art_i < $art_chkaaggdrh$art_c; $art_itxtdokz$art_i++) {    var i = second[$art_itxtdokz$art_i]%>';
    for (var $art_itxtdokz$art_i = 0, $art_chkaaggdrh$art_c = second.length; $art_itxtdokz$art_i < $art_chkaaggdrh$art_c; $art_itxtdokz$art_i++) {
        var i = second[$art_itxtdokz$art_i];
        $p += '<i value="';
        $line = 25;
        $art = '=i';
        ;
