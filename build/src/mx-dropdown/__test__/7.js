...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ibhzyal$art_i=0;$art_ibhzyal$art_i<first.length;$art_ibhzyal$art_i++){var i=first[$art_ibhzyal$art_i]%>';
    for (var $art_ibhzyal$art_i = 0; $art_ibhzyal$art_i < first.length; $art_ibhzyal$art_i++) {
        var i = first[$art_ibhzyal$art_i];
        $p += '<i value="';
        $line = 22;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_inawkuuek$art_i=0;$art_inawkuuek$art_i<second.length;$art_inawkuuek$art_i++){var i=second[$art_inawkuuek$art_i]%>';
    for (var $art_inawkuuek$art_i = 0; $art_inawkuuek$art_i < second.length; $art_inawkuuek$art_i++) {
        var i = second[$art_inawkuuek$art_i];
        $p += '<i value="';
        $line = 26;
        $art = '=i';
        ;
