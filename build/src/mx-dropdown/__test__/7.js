...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_igbiugvha$art_i=0;$art_igbiugvha$art_i<first.length;$art_igbiugvha$art_i++){var i=first[$art_igbiugvha$art_i]%>';
    for (var $art_igbiugvha$art_i = 0; $art_igbiugvha$art_i < first.length; $art_igbiugvha$art_i++) {
        var i = first[$art_igbiugvha$art_i];
        $p += '<i value="';
        $line = 22;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_igcndnoae$art_i=0;$art_igcndnoae$art_i<second.length;$art_igcndnoae$art_i++){var i=second[$art_igcndnoae$art_i]%>';
    for (var $art_igcndnoae$art_i = 0; $art_igcndnoae$art_i < second.length; $art_igcndnoae$art_i++) {
        var i = second[$art_igcndnoae$art_i];
        $p += '<i value="';
        $line = 26;
        $art = '=i';
        ;
