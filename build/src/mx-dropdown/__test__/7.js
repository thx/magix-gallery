...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryaq:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryaq:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryaq:_" class="color-9 mb20 clearfix"><div class="fl"><i class="mc-iconfont displacement-2 mr5">&#xe6ac;</i></div><div class="fl lh22"><div>带分组的只能用mx-dropdown.item节点实现</div><div>不需要全选功能，配置need-all="false"</div><div>组上面需要全选功能在mx-dropdown.item上配置all="true"</div></div></div><div mxa="_zs_galleryaq:b" class="clearfix"><div class="w200 fl" mx-view="mx-dropdown/multiple?needAll=false&searchbox=true&name=%E6%95%B0%E5%AD%97&emptyText=%E8%AF%B7%E9%80%89%E6%8B%A9%E6%95%B0%E5%AD%97&selected=';
    $line = 19;
    $art = '=selected';
    ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_igvlofwfu$art_i = 0, $art_cmokcpfpnhg$art_c = first.length; $art_igvlofwfu$art_i < $art_cmokcpfpnhg$art_c; $art_igvlofwfu$art_i++) {    var i = first[$art_igvlofwfu$art_i]%>';
    for (var $art_igvlofwfu$art_i = 0, $art_cmokcpfpnhg$art_c = first.length; $art_igvlofwfu$art_i < $art_cmokcpfpnhg$art_c; $art_igvlofwfu$art_i++) {
        var i = first[$art_igvlofwfu$art_i];
        $p += '<i value="';
        $line = 22;
        $art = '=i';
        ;
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_icassspcph$art_i = 0, $art_cgwkovswp$art_c = second.length; $art_icassspcph$art_i < $art_cgwkovswp$art_c; $art_icassspcph$art_i++) {    var i = second[$art_icassspcph$art_i]%>';
    for (var $art_icassspcph$art_i = 0, $art_cgwkovswp$art_c = second.length; $art_icassspcph$art_i < $art_cgwkovswp$art_c; $art_icassspcph$art_i++) {
        var i = second[$art_icassspcph$art_i];
        $p += '<i value="';
        $line = 26;
        $art = '=i';
        ;
