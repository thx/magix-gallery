...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_iarxtkrtqoe$art_i = 0, $art_cfnfcyom$art_c = first.length; $art_iarxtkrtqoe$art_i < $art_cfnfcyom$art_c; $art_iarxtkrtqoe$art_i++) {    var i = first[$art_iarxtkrtqoe$art_i]%>';
    for (var $art_iarxtkrtqoe$art_i = 0, $art_cfnfcyom$art_c = first.length; $art_iarxtkrtqoe$art_i < $art_cfnfcyom$art_c; $art_iarxtkrtqoe$art_i++) {
        var i = first[$art_iarxtkrtqoe$art_i];
        $p += '<i value="';
        $line = 21;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_ievrvhlqm$art_i = 0, $art_cgacglpi$art_c = second.length; $art_ievrvhlqm$art_i < $art_cgacglpi$art_c; $art_ievrvhlqm$art_i++) {    var i = second[$art_ievrvhlqm$art_i]%>';
    for (var $art_ievrvhlqm$art_i = 0, $art_cgacglpi$art_c = second.length; $art_ievrvhlqm$art_i < $art_cgacglpi$art_c; $art_ievrvhlqm$art_i++) {
        var i = second[$art_ievrvhlqm$art_i];
        $p += '<i value="';
        $line = 25;
        $art = '=i';
        ;
