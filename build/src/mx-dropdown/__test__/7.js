...
module.exports = Base.extend({
    ...
    $art = 'each first as i';
    ;
    $expr = '<%for (var $art_iaipxhns$art_i = 0, $art_cdjypjqzjt$art_c = first.length; $art_iaipxhns$art_i < $art_cdjypjqzjt$art_c; $art_iaipxhns$art_i++) {    var i = first[$art_iaipxhns$art_i]%>';
    for (var $art_iaipxhns$art_i = 0, $art_cdjypjqzjt$art_c = first.length; $art_iaipxhns$art_i < $art_cdjypjqzjt$art_c; $art_iaipxhns$art_i++) {
        var i = first[$art_iaipxhns$art_i];
        $p += '<i value="';
        $line = 21;
        $art = '=i';
        ;
    ...
    ;
    $expr = '<%for (var $art_iclywsqvv$art_i = 0, $art_ckkamlwsase$art_c = second.length; $art_iclywsqvv$art_i < $art_ckkamlwsase$art_c; $art_iclywsqvv$art_i++) {    var i = second[$art_iclywsqvv$art_i]%>';
    for (var $art_iclywsqvv$art_i = 0, $art_ckkamlwsase$art_c = second.length; $art_iclywsqvv$art_i < $art_ckkamlwsase$art_c; $art_iclywsqvv$art_i++) {
        var i = second[$art_iclywsqvv$art_i];
        $p += '<i value="';
        $line = 25;
        $art = '=i';
        ;
