...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaT:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryaT:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_galleryaT:b" class="mb20"><div mxv="list" class="w200" mx-change="' + $viewId + 'select()" mx-view="mx-dropdown/index?searchbox=true&keyword=';
    $line = 6;
    $art = '=keyword';
    ;
