...
module.exports = Base.extend({
    ...
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '"></div></div><div><span mxs="_zs_gallerya#:_" class="color-9">当前选中名：</span><span mxa="_zs_gallerya#:o" class="mr20">';
    $line = 17;
    $art = '!selectedText';
    ;
    $p += ($expr = '<%!selectedText%>', $n(selectedText)) + '</span><span mxs="_zs_gallerya#:a" class="color-9">当前选中值：</span><span>';
    $line = 19;
    $art = '=selectedValue';
    ;
    $p += ($expr = '<%=selectedValue%>', $e(selectedValue)) + '</span></div></div><div mxa="_zs_gallerya#:p" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya#:b" class="_zs_gallery___test___layout_-eg-title">搜索不区分大小写</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 24;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerya#:q" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 26;
    $art = '!text1';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-dropdown class="w200" \n    searchbox="true" \n    selected="&#123;&#123;=selectedValue&#125;&#125;"\n    list="&#123;&#123;@list&#125;&#125;"\n    mx-change="select()"&gt;\n&lt;/mx-dropdown&gt;</pre></div><div mxa="_zs_gallerya#:r" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya#:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 39;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_gallerya#:s" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 41;
    $art = '!text2';
    ;
