...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryal:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryal:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/multiple?triggerType=hover&list=';
    $line = 5;
    $art = '@[{\n                value: 1,\n                text: \'hover展开1\'\n            },{\n                value: 2,\n                text: \'hover展开2\'\n            }]';
    ;
