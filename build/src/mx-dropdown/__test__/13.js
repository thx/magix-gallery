...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerya!:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerya!:a" class="_zs_gallery___test___layout_-eg-content"><div class="w200" mx-view="mx-dropdown/multiple?triggerType=hover&list=';
    $line = 5;
    $art = '@[{\n                value: 1,\n                text: \'hover展开1\'\n            },{\n                value: 2,\n                text: \'hover展开2\'\n            }]';
    ;
    $p += ($expr = '<%@[{            value: 1,            text: \'hover展开1\'        }, {            value: 2,            text: \'hover展开2\'        }]%>', $i($$ref, [{ value: 1, text: 'hover展开1' }, { value: 2, text: 'hover展开2' }])) + '"></div></div><div mxa="_zs_gallerya!:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya!:_" class="_zs_gallery___test___layout_-eg-title">hover展开下拉选项</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
