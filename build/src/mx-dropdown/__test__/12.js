...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryai:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryai:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryai:_" class="clearfix mb20"><div class="fl color-9">以下示例：</div><div class="fl">hover展开下拉选项</div></div><div class="w200" mx-view="mx-dropdown/index?triggerType=hover&list=';
    $line = 9;
    $art = '@[{\n                value: 1,\n                text: \'hover展开1\'\n            },{\n                value: 2,\n                text: \'hover展开2\'\n            }]';
    ;
