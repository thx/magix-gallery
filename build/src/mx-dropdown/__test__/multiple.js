...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo9"></div></div><div mxa="_zs_galleryal:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-dropdown/__test__/13" id="';
    $line = 34;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo8"></div><div mxs="_zs_galleryal:_" mx-view="mx-dropdown/__test__/10"></div></div></div><div id="';
    $line = 40;
    $art = '=viewId';
    ;
