...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cfkpicu$art_c = parents.length; parentIndex < $art_cfkpicu$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cfkpicu$art_c = parents.length; parentIndex < $art_cfkpicu$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objfcluljgn$art_obj = parent.list, $art_crdxbecq$art_c = $art_objfcluljgn$art_obj.length; itemIndex < $art_crdxbecq$art_c; itemIndex++) {                var item = $art_objfcluljgn$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objfcluljgn$art_obj = parent.list, $art_crdxbecq$art_c = $art_objfcluljgn$art_obj.length; itemIndex < $art_crdxbecq$art_c; itemIndex++) {
                    var item = $art_objfcluljgn$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
        ...
        ;
        $p += '<div mxa="_zs_gallerya|:e" class="text-center color-9 pt20 pb20">';
        $line = 55;
        $art = '=text.empty';
        ;
    ...
    if (multiple) {
        ;
        $p += '<div mxa="_zs_gallerya|:f" class="_zs_gallery_mx-dropdown_index_-footer-wrapper"><a mxa="_zs_gallerya|:g" href="javascript:;" class="btn btn-small btn-brand mr10" mx-click="' + $viewId + '@{submit}()">';
        $line = 59;
        $art = '=text.submit';
        ;
        $p += ($expr = '<%=text.submit%>', $e(text.submit)) + '</a><a mxa="_zs_gallerya|:h" href="javascript:;" class="btn btn-small" mx-click="' + $viewId + '@{cancel}()">';
        $line = 60;
        $art = '=text.cancel';
        ;
