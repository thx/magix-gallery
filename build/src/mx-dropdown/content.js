...
module.exports = Magix.View.extend({
    ...
    if (searchbox) {
        ;
        $p += '<div mxv mxa="_zs_gallerybd:_" class="mx-output-search"><div mxv mxa="_zs_gallerybd:a" class="search-box" style="width: 100%;"><i mxs="_zs_gallerybd:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
        $line = 6;
        $art = '=text.search';
        ;
    ...
    if (multiple) {
        ;
        $p += '<div mxa="_zs_gallerybd:b" class="_zs_gallery_mx-dropdown_index_-oper-wrapper _zs_gallery_mx-dropdown_index_-has-group clearfix"><a class="_zs_gallery_mx-dropdown_index_-oper" href="javascript:;" mx-click="' + $viewId + '@{checkAll}({checked:true})" data-spm-click="';
        $line = 18;
        $art = '=spm';
        ;
        $p += ($expr = '<%=spm%>', $e(spm)) + 'a">';
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_ciciqycq$art_c = parents.length; parentIndex < $art_ciciqycq$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_ciciqycq$art_c = parents.length; parentIndex < $art_ciciqycq$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objqoiwkdxow$art_obj = parent.list, $art_cwdzdjko$art_c = $art_objqoiwkdxow$art_obj.length; itemIndex < $art_cwdzdjko$art_c; itemIndex++) {                var item = $art_objqoiwkdxow$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objqoiwkdxow$art_obj = parent.list, $art_cwdzdjko$art_c = $art_objqoiwkdxow$art_obj.length; itemIndex < $art_cwdzdjko$art_c; itemIndex++) {
                    var item = $art_objqoiwkdxow$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
        ...
        ;
        $p += '<div mxa="_zs_gallerybd:c" class="text-center color-9 pt20 pb20">';
        $line = 55;
        $art = '=text.empty';
        ;
    ...
    if (multiple) {
        ;
        $p += '<div mxa="_zs_gallerybd:d" class="mx-output-footer"><a mxa="_zs_gallerybd:e" href="javascript:;" class="btn btn-small btn-brand mr10" mx-click="' + $viewId + '@{submit}()">';
        $line = 59;
        $art = '=text.submit';
        ;
        $p += ($expr = '<%=text.submit%>', $e(text.submit)) + '</a><a mxa="_zs_gallerybd:f" href="javascript:;" class="btn btn-small" mx-click="' + $viewId + '@{cancel}()">';
        $line = 60;
        $art = '=text.cancel';
        ;
