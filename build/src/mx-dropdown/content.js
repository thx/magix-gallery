...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cybryjtm$art_c = parents.length; parentIndex < $art_cybryjtm$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cybryjtm$art_c = parents.length; parentIndex < $art_cybryjtm$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objjzscaxa$art_obj = parent.list, $art_cuzfdplrq$art_c = $art_objjzscaxa$art_obj.length; itemIndex < $art_cuzfdplrq$art_c; itemIndex++) {                var item = $art_objjzscaxa$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objjzscaxa$art_obj = parent.list, $art_cuzfdplrq$art_c = $art_objjzscaxa$art_obj.length; itemIndex < $art_cuzfdplrq$art_c; itemIndex++) {
                    var item = $art_objjzscaxa$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
