...
module.exports = Magix.View.extend({
    ...
    if (!allHide) {
        ...
        ;
        $expr = '<%for (var parentIndex = 0, $art_cgsqppwyz$art_c = parents.length; parentIndex < $art_cgsqppwyz$art_c; parentIndex++) {        var parent = parents[parentIndex]%>';
        for (var parentIndex = 0, $art_cgsqppwyz$art_c = parents.length; parentIndex < $art_cgsqppwyz$art_c; parentIndex++) {
            ...
            if (!parent.hide) {
                ...
                ;
                $expr = '<%for (var itemIndex = 0, $art_objnuwuznv$art_obj = parent.list, $art_ctvpqtgs$art_c = $art_objnuwuznv$art_obj.length; itemIndex < $art_ctvpqtgs$art_c; itemIndex++) {                var item = $art_objnuwuznv$art_obj[itemIndex]%>';
                for (var itemIndex = 0, $art_objnuwuznv$art_obj = parent.list, $art_ctvpqtgs$art_c = $art_objnuwuznv$art_obj.length; itemIndex < $art_ctvpqtgs$art_c; itemIndex++) {
                    var item = $art_objnuwuznv$art_obj[itemIndex];
                    $p += ' ';
                    $line = 30;
                    $art = 'if !item.hide';
                    ;
