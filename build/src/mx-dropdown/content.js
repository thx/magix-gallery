...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itouvqmz$art_i = 0, $art_cvcvixddr$art_c = list.length; $art_itouvqmz$art_i < $art_cvcvixddr$art_c; $art_itouvqmz$art_i++) {    var item = list[$art_itouvqmz$art_i]%>';
    for (var $art_itouvqmz$art_i = 0, $art_cvcvixddr$art_c = list.length; $art_itouvqmz$art_i < $art_cvcvixddr$art_c; $art_itouvqmz$art_i++) {
        var item = list[$art_itouvqmz$art_i];
        $p += '<li title="';
        $line = 3;
        $art = '=item.text';
        ;
