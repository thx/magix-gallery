...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cqfcfflfrrir$art_c = groups.length; groupIndex < $art_cqfcfflfrrir$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cqfcfflfrrir$art_c = groups.length; groupIndex < $art_cqfcfflfrrir$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_imbsdagft$art_i = 0, $art_objyspnhuxqy$art_obj = group.list, $art_cynrorvq$art_c = $art_objyspnhuxqy$art_obj.length; $art_imbsdagft$art_i < $art_cynrorvq$art_c; $art_imbsdagft$art_i++) {                var item = $art_objyspnhuxqy$art_obj[$art_imbsdagft$art_i]%>';
                for (var $art_imbsdagft$art_i = 0, $art_objyspnhuxqy$art_obj = group.list, $art_cynrorvq$art_c = $art_objyspnhuxqy$art_obj.length; $art_imbsdagft$art_i < $art_cynrorvq$art_c; $art_imbsdagft$art_i++) {
                    var item = $art_objyspnhuxqy$art_obj[$art_imbsdagft$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
