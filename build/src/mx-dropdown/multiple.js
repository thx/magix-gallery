...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cqqrynjq$art_c = groups.length; groupIndex < $art_cqqrynjq$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cqqrynjq$art_c = groups.length; groupIndex < $art_cqqrynjq$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ibypfzap$art_i = 0, $art_objpaiocsql$art_obj = group.list, $art_cbdresnmi$art_c = $art_objpaiocsql$art_obj.length; $art_ibypfzap$art_i < $art_cbdresnmi$art_c; $art_ibypfzap$art_i++) {                var item = $art_objpaiocsql$art_obj[$art_ibypfzap$art_i]%>';
                for (var $art_ibypfzap$art_i = 0, $art_objpaiocsql$art_obj = group.list, $art_cbdresnmi$art_c = $art_objpaiocsql$art_obj.length; $art_ibypfzap$art_i < $art_cbdresnmi$art_c; $art_ibypfzap$art_i++) {
                    var item = $art_objpaiocsql$art_obj[$art_ibypfzap$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
