...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_crqeqcqukd$art_c = groups.length; groupIndex < $art_crqeqcqukd$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_crqeqcqukd$art_c = groups.length; groupIndex < $art_crqeqcqukd$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ihohpxazo$art_i = 0, $art_objctanzpf$art_obj = group.list, $art_ccjezpjize$art_c = $art_objctanzpf$art_obj.length; $art_ihohpxazo$art_i < $art_ccjezpjize$art_c; $art_ihohpxazo$art_i++) {            var item = $art_objctanzpf$art_obj[$art_ihohpxazo$art_i]%>';
            for (var $art_ihohpxazo$art_i = 0, $art_objctanzpf$art_obj = group.list, $art_ccjezpjize$art_c = $art_objctanzpf$art_obj.length; $art_ihohpxazo$art_i < $art_ccjezpjize$art_c; $art_ihohpxazo$art_i++) {
                var item = $art_objctanzpf$art_obj[$art_ihohpxazo$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
