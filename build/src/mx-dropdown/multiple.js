...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_caulztzgo$art_c = groups.length; groupIndex < $art_caulztzgo$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_caulztzgo$art_c = groups.length; groupIndex < $art_caulztzgo$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ihndszsnws$art_i = 0, $art_objytxqbk$art_obj = group.list, $art_ccrhjmtwgf$art_c = $art_objytxqbk$art_obj.length; $art_ihndszsnws$art_i < $art_ccrhjmtwgf$art_c; $art_ihndszsnws$art_i++) {            var item = $art_objytxqbk$art_obj[$art_ihndszsnws$art_i]%>';
            for (var $art_ihndszsnws$art_i = 0, $art_objytxqbk$art_obj = group.list, $art_ccrhjmtwgf$art_c = $art_objytxqbk$art_obj.length; $art_ihndszsnws$art_i < $art_ccrhjmtwgf$art_c; $art_ihndszsnws$art_i++) {
                var item = $art_objytxqbk$art_obj[$art_ihndszsnws$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
