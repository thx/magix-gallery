...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cizbzij$art_c = groups.length; groupIndex < $art_cizbzij$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cizbzij$art_c = groups.length; groupIndex < $art_cizbzij$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iuvujcehda$art_i = 0, $art_objjsllrnriz$art_obj = group.list, $art_cupgmcn$art_c = $art_objjsllrnriz$art_obj.length; $art_iuvujcehda$art_i < $art_cupgmcn$art_c; $art_iuvujcehda$art_i++) {                var item = $art_objjsllrnriz$art_obj[$art_iuvujcehda$art_i]%>';
                for (var $art_iuvujcehda$art_i = 0, $art_objjsllrnriz$art_obj = group.list, $art_cupgmcn$art_c = $art_objjsllrnriz$art_obj.length; $art_iuvujcehda$art_i < $art_cupgmcn$art_c; $art_iuvujcehda$art_i++) {
                    var item = $art_objjsllrnriz$art_obj[$art_iuvujcehda$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
