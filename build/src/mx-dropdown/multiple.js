...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cnhcnzaaqe$art_c = groups.length; groupIndex < $art_cnhcnzaaqe$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cnhcnzaaqe$art_c = groups.length; groupIndex < $art_cnhcnzaaqe$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iilwel$art_i = 0, $art_objgmqtlimj$art_obj = group.list, $art_cxhfrdkesm$art_c = $art_objgmqtlimj$art_obj.length; $art_iilwel$art_i < $art_cxhfrdkesm$art_c; $art_iilwel$art_i++) {                var item = $art_objgmqtlimj$art_obj[$art_iilwel$art_i]%>';
                for (var $art_iilwel$art_i = 0, $art_objgmqtlimj$art_obj = group.list, $art_cxhfrdkesm$art_c = $art_objgmqtlimj$art_obj.length; $art_iilwel$art_i < $art_cxhfrdkesm$art_c; $art_iilwel$art_i++) {
                    var item = $art_objgmqtlimj$art_obj[$art_iilwel$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
