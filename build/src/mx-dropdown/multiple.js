...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_chfqxnmmf$art_c = groups.length; groupIndex < $art_chfqxnmmf$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_chfqxnmmf$art_c = groups.length; groupIndex < $art_chfqxnmmf$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iaplpgpbfb$art_i = 0, $art_objghzqaelgw$art_obj = group.list, $art_ctzcd$art_c = $art_objghzqaelgw$art_obj.length; $art_iaplpgpbfb$art_i < $art_ctzcd$art_c; $art_iaplpgpbfb$art_i++) {                var item = $art_objghzqaelgw$art_obj[$art_iaplpgpbfb$art_i]%>';
                for (var $art_iaplpgpbfb$art_i = 0, $art_objghzqaelgw$art_obj = group.list, $art_ctzcd$art_c = $art_objghzqaelgw$art_obj.length; $art_iaplpgpbfb$art_i < $art_ctzcd$art_c; $art_iaplpgpbfb$art_i++) {
                    var item = $art_objghzqaelgw$art_obj[$art_iaplpgpbfb$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
