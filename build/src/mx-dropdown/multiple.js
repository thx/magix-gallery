...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cdirzsck$art_c = groups.length; groupIndex < $art_cdirzsck$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cdirzsck$art_c = groups.length; groupIndex < $art_cdirzsck$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ikwbknduj$art_i = 0, $art_objtwktbs$art_obj = group.list, $art_cuvfpnddlrj$art_c = $art_objtwktbs$art_obj.length; $art_ikwbknduj$art_i < $art_cuvfpnddlrj$art_c; $art_ikwbknduj$art_i++) {            var item = $art_objtwktbs$art_obj[$art_ikwbknduj$art_i]%>';
            for (var $art_ikwbknduj$art_i = 0, $art_objtwktbs$art_obj = group.list, $art_cuvfpnddlrj$art_c = $art_objtwktbs$art_obj.length; $art_ikwbknduj$art_i < $art_cuvfpnddlrj$art_c; $art_ikwbknduj$art_i++) {
                var item = $art_objtwktbs$art_obj[$art_ikwbknduj$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
