...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cvafgbvj$art_c = groups.length; groupIndex < $art_cvafgbvj$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cvafgbvj$art_c = groups.length; groupIndex < $art_cvafgbvj$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ibfygzvg$art_i = 0, $art_objxfptidry$art_obj = group.list, $art_cvpvuqwctpaf$art_c = $art_objxfptidry$art_obj.length; $art_ibfygzvg$art_i < $art_cvpvuqwctpaf$art_c; $art_ibfygzvg$art_i++) {                var item = $art_objxfptidry$art_obj[$art_ibfygzvg$art_i]%>';
                for (var $art_ibfygzvg$art_i = 0, $art_objxfptidry$art_obj = group.list, $art_cvpvuqwctpaf$art_c = $art_objxfptidry$art_obj.length; $art_ibfygzvg$art_i < $art_cvpvuqwctpaf$art_c; $art_ibfygzvg$art_i++) {
                    var item = $art_objxfptidry$art_obj[$art_ibfygzvg$art_i];
                    $p += ' ';
                    $line = 66;
                    $art = 'if !item.hide';
                    ;
