...
module.exports = Magix.View.extend({
    ...
    $art = '=selectedText';
    ;
    $p += ($expr = '<%=selectedText%>', $e(selectedText)) + '</span><span mxs="_zs_galleryaB:_" class="mc-iconfont _zs_gallery_mx-dropdown_index_-arrow">&#xe692;</span></div><div mxv class="_zs_gallery_mx-dropdown_index_-dropdown-menu-wrapper _zs_gallery_mx-dropdown_index_-bottom ';
    $line = 5;
    $art = 'if expand';
    ;
    $expr = '<%if (expand) {%>';
    ...
    if (rList) {
        ...
        if (searchbox) {
            ;
            $p += '<div mxv mxa="_zs_galleryaB:_" class="_zs_gallery_mx-dropdown_index_-search-wrapper"><div mxv mxa="_zs_galleryaB:a" class="search-box"><i mxs="_zs_galleryaB:a" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
            $line = 13;
            $art = '=text.search';
            ;
        ...
        if (!needAll) {
            ;
            $p += '<div mxa="_zs_galleryaB:b" class="_zs_gallery_mx-dropdown_index_-oper-wrapper"><a class="_zs_gallery_mx-dropdown_index_-oper" href="javascript:;" mx-click="' + $viewId + '@{checkAll}({checked:true})" data-spm-click="';
            $line = 25;
            $art = '=spm';
            ;
            $p += ($expr = '<%=spm%>', $e(spm)) + '">';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cjfcoxno$art_c = groups.length; groupIndex < $art_cjfcoxno$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cjfcoxno$art_c = groups.length; groupIndex < $art_cjfcoxno$art_c; groupIndex++) {
            ...
            ;
            $p += '<div mxv mxa="_zs_galleryaB:c" class="clearfix _zs_gallery_mx-dropdown_index_-group-wrapper">';
            $line = 48;
            $art = 'each group.list as item';
            ;
            $expr = '<%for (var $art_isomhrjjp$art_i = 0, $art_objokgtqomf$art_obj = group.list, $art_crzhgmiwc$art_c = $art_objokgtqomf$art_obj.length; $art_isomhrjjp$art_i < $art_crzhgmiwc$art_c; $art_isomhrjjp$art_i++) {            var item = $art_objokgtqomf$art_obj[$art_isomhrjjp$art_i]%>';
            for (var $art_isomhrjjp$art_i = 0, $art_objokgtqomf$art_obj = group.list, $art_crzhgmiwc$art_c = $art_objokgtqomf$art_obj.length; $art_isomhrjjp$art_i < $art_crzhgmiwc$art_c; $art_isomhrjjp$art_i++) {
                var item = $art_objokgtqomf$art_obj[$art_isomhrjjp$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
        ...
        ;
        $p += '</div><div mxa="_zs_galleryaB:d" class="_zs_gallery_mx-dropdown_index_-footer-wrapper"><button mxa="_zs_galleryaB:e" type="button" class="btn btn-small btn-brand mr10" mx-click="' + $viewId + '@{submit}({enter:true})">';
        $line = 66;
        $art = '=text.submit';
        ;
        $p += ($expr = '<%=text.submit%>', $e(text.submit)) + '</button><button mxa="_zs_galleryaB:f" type="button" class="btn btn-small" mx-click="' + $viewId + '@{hide}()">';
        $line = 67;
        $art = '=text.cancel';
        ;
