...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cddnmr$art_c = groups.length; groupIndex < $art_cddnmr$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cddnmr$art_c = groups.length; groupIndex < $art_cddnmr$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iccxoxzbap$art_i = 0, $art_objhpptxmpo$art_obj = group.list, $art_cjwekym$art_c = $art_objhpptxmpo$art_obj.length; $art_iccxoxzbap$art_i < $art_cjwekym$art_c; $art_iccxoxzbap$art_i++) {                var item = $art_objhpptxmpo$art_obj[$art_iccxoxzbap$art_i]%>';
                for (var $art_iccxoxzbap$art_i = 0, $art_objhpptxmpo$art_obj = group.list, $art_cjwekym$art_c = $art_objhpptxmpo$art_obj.length; $art_iccxoxzbap$art_i < $art_cjwekym$art_c; $art_iccxoxzbap$art_i++) {
                    var item = $art_objhpptxmpo$art_obj[$art_iccxoxzbap$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
