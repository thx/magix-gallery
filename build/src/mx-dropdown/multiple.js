...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_ciwsrwmwb$art_c = groups.length; groupIndex < $art_ciwsrwmwb$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_ciwsrwmwb$art_c = groups.length; groupIndex < $art_ciwsrwmwb$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ijkzkyhf$art_i = 0, $art_objviekwqtefg$art_obj = group.list, $art_cbzikwax$art_c = $art_objviekwqtefg$art_obj.length; $art_ijkzkyhf$art_i < $art_cbzikwax$art_c; $art_ijkzkyhf$art_i++) {            var item = $art_objviekwqtefg$art_obj[$art_ijkzkyhf$art_i]%>';
            for (var $art_ijkzkyhf$art_i = 0, $art_objviekwqtefg$art_obj = group.list, $art_cbzikwax$art_c = $art_objviekwqtefg$art_obj.length; $art_ijkzkyhf$art_i < $art_cbzikwax$art_c; $art_ijkzkyhf$art_i++) {
                var item = $art_objviekwqtefg$art_obj[$art_ijkzkyhf$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
