...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cbegvuw$art_c = groups.length; groupIndex < $art_cbegvuw$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cbegvuw$art_c = groups.length; groupIndex < $art_cbegvuw$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iebqlflwum$art_i = 0, $art_objacdlcp$art_obj = group.list, $art_czervhhyyq$art_c = $art_objacdlcp$art_obj.length; $art_iebqlflwum$art_i < $art_czervhhyyq$art_c; $art_iebqlflwum$art_i++) {                var item = $art_objacdlcp$art_obj[$art_iebqlflwum$art_i]%>';
                for (var $art_iebqlflwum$art_i = 0, $art_objacdlcp$art_obj = group.list, $art_czervhhyyq$art_c = $art_objacdlcp$art_obj.length; $art_iebqlflwum$art_i < $art_czervhhyyq$art_c; $art_iebqlflwum$art_i++) {
                    var item = $art_objacdlcp$art_obj[$art_iebqlflwum$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
