...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_casnrwi$art_c = groups.length; groupIndex < $art_casnrwi$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_casnrwi$art_c = groups.length; groupIndex < $art_casnrwi$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_itihxec$art_i = 0, $art_objidyxom$art_obj = group.list, $art_cmpiydwwvzj$art_c = $art_objidyxom$art_obj.length; $art_itihxec$art_i < $art_cmpiydwwvzj$art_c; $art_itihxec$art_i++) {            var item = $art_objidyxom$art_obj[$art_itihxec$art_i]%>';
            for (var $art_itihxec$art_i = 0, $art_objidyxom$art_obj = group.list, $art_cmpiydwwvzj$art_c = $art_objidyxom$art_obj.length; $art_itihxec$art_i < $art_cmpiydwwvzj$art_c; $art_itihxec$art_i++) {
                var item = $art_objidyxom$art_obj[$art_itihxec$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
