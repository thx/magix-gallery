...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cqhrhwoqc$art_c = groups.length; groupIndex < $art_cqhrhwoqc$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cqhrhwoqc$art_c = groups.length; groupIndex < $art_cqhrhwoqc$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_izbltfkz$art_i = 0, $art_objykndyie$art_obj = group.list, $art_ckzvrrh$art_c = $art_objykndyie$art_obj.length; $art_izbltfkz$art_i < $art_ckzvrrh$art_c; $art_izbltfkz$art_i++) {            var item = $art_objykndyie$art_obj[$art_izbltfkz$art_i]%>';
            for (var $art_izbltfkz$art_i = 0, $art_objykndyie$art_obj = group.list, $art_ckzvrrh$art_c = $art_objykndyie$art_obj.length; $art_izbltfkz$art_i < $art_ckzvrrh$art_c; $art_izbltfkz$art_i++) {
                var item = $art_objykndyie$art_obj[$art_izbltfkz$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
        ...
        if (errMsg) {
            ;
            $p += '<span mxa="_zs_galleryaZ:j" class="_zs_gallery_mx-dropdown_index_-msg-wrapper color-red ml10"><i mxs="_zs_galleryaZ:e" class="mc-iconfont displacement-2">&#xe6ad;</i><span mxa="_zs_galleryaZ:k" class="_zs_gallery_mx-dropdown_index_-msg">';
            $line = 88;
            $art = '!errMsg';
            ;
