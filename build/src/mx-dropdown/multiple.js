...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_crnahyq$art_c = groups.length; groupIndex < $art_crnahyq$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_crnahyq$art_c = groups.length; groupIndex < $art_crnahyq$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_iruhlce$art_i = 0, $art_objbxdapyaeu$art_obj = group.list, $art_cxmfvhcx$art_c = $art_objbxdapyaeu$art_obj.length; $art_iruhlce$art_i < $art_cxmfvhcx$art_c; $art_iruhlce$art_i++) {            var item = $art_objbxdapyaeu$art_obj[$art_iruhlce$art_i]%>';
            for (var $art_iruhlce$art_i = 0, $art_objbxdapyaeu$art_obj = group.list, $art_cxmfvhcx$art_c = $art_objbxdapyaeu$art_obj.length; $art_iruhlce$art_i < $art_cxmfvhcx$art_c; $art_iruhlce$art_i++) {
                var item = $art_objbxdapyaeu$art_obj[$art_iruhlce$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
