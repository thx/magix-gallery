...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cnvlzvuhyf$art_c = groups.length; groupIndex < $art_cnvlzvuhyf$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cnvlzvuhyf$art_c = groups.length; groupIndex < $art_cnvlzvuhyf$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_irateuzwpy$art_i = 0, $art_objdoqwdo$art_obj = group.list, $art_cqtryxsdv$art_c = $art_objdoqwdo$art_obj.length; $art_irateuzwpy$art_i < $art_cqtryxsdv$art_c; $art_irateuzwpy$art_i++) {                var item = $art_objdoqwdo$art_obj[$art_irateuzwpy$art_i]%>';
                for (var $art_irateuzwpy$art_i = 0, $art_objdoqwdo$art_obj = group.list, $art_cqtryxsdv$art_c = $art_objdoqwdo$art_obj.length; $art_irateuzwpy$art_i < $art_cqtryxsdv$art_c; $art_irateuzwpy$art_i++) {
                    var item = $art_objdoqwdo$art_obj[$art_irateuzwpy$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
