...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cekvquls$art_c = groups.length; groupIndex < $art_cekvquls$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cekvquls$art_c = groups.length; groupIndex < $art_cekvquls$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_igufgsusc$art_i = 0, $art_objwmbgijs$art_obj = group.list, $art_cfbfcx$art_c = $art_objwmbgijs$art_obj.length; $art_igufgsusc$art_i < $art_cfbfcx$art_c; $art_igufgsusc$art_i++) {            var item = $art_objwmbgijs$art_obj[$art_igufgsusc$art_i]%>';
            for (var $art_igufgsusc$art_i = 0, $art_objwmbgijs$art_obj = group.list, $art_cfbfcx$art_c = $art_objwmbgijs$art_obj.length; $art_igufgsusc$art_i < $art_cfbfcx$art_c; $art_igufgsusc$art_i++) {
                var item = $art_objwmbgijs$art_obj[$art_igufgsusc$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
