...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cvvunlj$art_c = groups.length; groupIndex < $art_cvvunlj$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cvvunlj$art_c = groups.length; groupIndex < $art_cvvunlj$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_iushqirqk$art_i = 0, $art_objjbpfde$art_obj = group.list, $art_caevzcbe$art_c = $art_objjbpfde$art_obj.length; $art_iushqirqk$art_i < $art_caevzcbe$art_c; $art_iushqirqk$art_i++) {            var item = $art_objjbpfde$art_obj[$art_iushqirqk$art_i]%>';
            for (var $art_iushqirqk$art_i = 0, $art_objjbpfde$art_obj = group.list, $art_caevzcbe$art_c = $art_objjbpfde$art_obj.length; $art_iushqirqk$art_i < $art_caevzcbe$art_c; $art_iushqirqk$art_i++) {
                var item = $art_objjbpfde$art_obj[$art_iushqirqk$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
