...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cldiqtjlyc$art_c = groups.length; groupIndex < $art_cldiqtjlyc$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cldiqtjlyc$art_c = groups.length; groupIndex < $art_cldiqtjlyc$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iwfofmuhqsp$art_i = 0, $art_objrlubzmftgi$art_obj = group.list, $art_cawejhkf$art_c = $art_objrlubzmftgi$art_obj.length; $art_iwfofmuhqsp$art_i < $art_cawejhkf$art_c; $art_iwfofmuhqsp$art_i++) {                var item = $art_objrlubzmftgi$art_obj[$art_iwfofmuhqsp$art_i]%>';
                for (var $art_iwfofmuhqsp$art_i = 0, $art_objrlubzmftgi$art_obj = group.list, $art_cawejhkf$art_c = $art_objrlubzmftgi$art_obj.length; $art_iwfofmuhqsp$art_i < $art_cawejhkf$art_c; $art_iwfofmuhqsp$art_i++) {
                    var item = $art_objrlubzmftgi$art_obj[$art_iwfofmuhqsp$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
