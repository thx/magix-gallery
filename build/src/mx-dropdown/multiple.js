...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_colsvlegffb$art_c = groups.length; groupIndex < $art_colsvlegffb$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_colsvlegffb$art_c = groups.length; groupIndex < $art_colsvlegffb$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ibcascq$art_i = 0, $art_objhvuhbss$art_obj = group.list, $art_cwehergji$art_c = $art_objhvuhbss$art_obj.length; $art_ibcascq$art_i < $art_cwehergji$art_c; $art_ibcascq$art_i++) {                var item = $art_objhvuhbss$art_obj[$art_ibcascq$art_i]%>';
                for (var $art_ibcascq$art_i = 0, $art_objhvuhbss$art_obj = group.list, $art_cwehergji$art_c = $art_objhvuhbss$art_obj.length; $art_ibcascq$art_i < $art_cwehergji$art_c; $art_ibcascq$art_i++) {
                    var item = $art_objhvuhbss$art_obj[$art_ibcascq$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
