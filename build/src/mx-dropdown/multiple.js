...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cahjkixuunk$art_c = groups.length; groupIndex < $art_cahjkixuunk$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cahjkixuunk$art_c = groups.length; groupIndex < $art_cahjkixuunk$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_izymdcjff$art_i = 0, $art_objxqrklff$art_obj = group.list, $art_cqjxzn$art_c = $art_objxqrklff$art_obj.length; $art_izymdcjff$art_i < $art_cqjxzn$art_c; $art_izymdcjff$art_i++) {                var item = $art_objxqrklff$art_obj[$art_izymdcjff$art_i]%>';
                for (var $art_izymdcjff$art_i = 0, $art_objxqrklff$art_obj = group.list, $art_cqjxzn$art_c = $art_objxqrklff$art_obj.length; $art_izymdcjff$art_i < $art_cqjxzn$art_c; $art_izymdcjff$art_i++) {
                    var item = $art_objxqrklff$art_obj[$art_izymdcjff$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
