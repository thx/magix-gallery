...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cvkgrfvo$art_c = groups.length; groupIndex < $art_cvkgrfvo$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cvkgrfvo$art_c = groups.length; groupIndex < $art_cvkgrfvo$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_iexkdzfkdcc$art_i = 0, $art_objnamklxau$art_obj = group.list, $art_cwpxjjpssnn$art_c = $art_objnamklxau$art_obj.length; $art_iexkdzfkdcc$art_i < $art_cwpxjjpssnn$art_c; $art_iexkdzfkdcc$art_i++) {            var item = $art_objnamklxau$art_obj[$art_iexkdzfkdcc$art_i]%>';
            for (var $art_iexkdzfkdcc$art_i = 0, $art_objnamklxau$art_obj = group.list, $art_cwpxjjpssnn$art_c = $art_objnamklxau$art_obj.length; $art_iexkdzfkdcc$art_i < $art_cwpxjjpssnn$art_c; $art_iexkdzfkdcc$art_i++) {
                var item = $art_objnamklxau$art_obj[$art_iexkdzfkdcc$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
