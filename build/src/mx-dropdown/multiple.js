...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cedkauqrqr$art_c = groups.length; groupIndex < $art_cedkauqrqr$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cedkauqrqr$art_c = groups.length; groupIndex < $art_cedkauqrqr$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_iactajzcg$art_i = 0, $art_objqdooapl$art_obj = group.list, $art_cwmgzqbovp$art_c = $art_objqdooapl$art_obj.length; $art_iactajzcg$art_i < $art_cwmgzqbovp$art_c; $art_iactajzcg$art_i++) {            var item = $art_objqdooapl$art_obj[$art_iactajzcg$art_i]%>';
            for (var $art_iactajzcg$art_i = 0, $art_objqdooapl$art_obj = group.list, $art_cwmgzqbovp$art_c = $art_objqdooapl$art_obj.length; $art_iactajzcg$art_i < $art_cwmgzqbovp$art_c; $art_iactajzcg$art_i++) {
                var item = $art_objqdooapl$art_obj[$art_iactajzcg$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
