...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cubzxksl$art_c = groups.length; groupIndex < $art_cubzxksl$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cubzxksl$art_c = groups.length; groupIndex < $art_cubzxksl$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_igerjinm$art_i = 0, $art_objrizfjx$art_obj = group.list, $art_cebbbspoa$art_c = $art_objrizfjx$art_obj.length; $art_igerjinm$art_i < $art_cebbbspoa$art_c; $art_igerjinm$art_i++) {                var item = $art_objrizfjx$art_obj[$art_igerjinm$art_i]%>';
                for (var $art_igerjinm$art_i = 0, $art_objrizfjx$art_obj = group.list, $art_cebbbspoa$art_c = $art_objrizfjx$art_obj.length; $art_igerjinm$art_i < $art_cebbbspoa$art_c; $art_igerjinm$art_i++) {
                    var item = $art_objrizfjx$art_obj[$art_igerjinm$art_i];
                    $p += ' ';
                    $line = 66;
                    $art = 'if !item.hide';
                    ;
