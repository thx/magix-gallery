...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cwdf$art_c = groups.length; groupIndex < $art_cwdf$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cwdf$art_c = groups.length; groupIndex < $art_cwdf$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ioncfeuux$art_i = 0, $art_objothgklz$art_obj = group.list, $art_cpeqfyjxf$art_c = $art_objothgklz$art_obj.length; $art_ioncfeuux$art_i < $art_cpeqfyjxf$art_c; $art_ioncfeuux$art_i++) {                var item = $art_objothgklz$art_obj[$art_ioncfeuux$art_i]%>';
                for (var $art_ioncfeuux$art_i = 0, $art_objothgklz$art_obj = group.list, $art_cpeqfyjxf$art_c = $art_objothgklz$art_obj.length; $art_ioncfeuux$art_i < $art_cpeqfyjxf$art_c; $art_ioncfeuux$art_i++) {
                    var item = $art_objothgklz$art_obj[$art_ioncfeuux$art_i];
                    $p += ' ';
                    $line = 66;
                    $art = 'if !item.hide';
                    ;
