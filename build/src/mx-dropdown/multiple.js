...
module.exports = Magix.View.extend({
    ...
    $art = '=selectedText';
    ;
    $p += ($expr = '<%=selectedText%>', $e(selectedText)) + '</span><span mxs="_zs_gallerya0:_" class="mc-iconfont _zs_gallery_mx-dropdown_index_-arrow">&#xe692;</span></div><div mxv class="_zs_gallery_mx-dropdown_index_-dropdown-menu-wrapper ';
    $line = 5;
    $art = '=placementClass';
    ;
    ...
    if (rList) {
        ...
        if (searchbox) {
            ;
            $p += '<div mxv mxa="_zs_gallerya0:_" class="_zs_gallery_mx-dropdown_index_-search-wrapper"><div mxv mxa="_zs_gallerya0:a" class="search-box _zs_gallery_mx-dropdown_index_-dropdown-search-box"><i mxs="_zs_gallerya0:a" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
            $line = 13;
            $art = '=text.search';
            ;
            ...
            if (max > 0 && over) {
                ;
                $p += '<span mxa="_zs_gallerya0:b" class="ml10"><span mxs="_zs_gallerya0:b" class="color-9">已选：</span><span mxa="_zs_gallerya0:c" class="font-tahoma bold">';
                $line = 24;
                $art = '=imme.length';
                ;
        ...
        if (!needAll || (max > 0 && !over)) {
            ...
            if (max > 0 && !over) {
                ...
                ;
                $p += '><span mxs="_zs_gallerya0:b" class="color-9">已选：</span><span mxa="_zs_gallerya0:d" class="font-tahoma bold">';
                $line = 39;
                $art = '=imme.length';
                ;
                $p += ($expr = '<%=imme.length%>', $e(imme.length)) + ' / ';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_ciyhqxwkzyc$art_c = groups.length; groupIndex < $art_ciyhqxwkzyc$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_ciyhqxwkzyc$art_c = groups.length; groupIndex < $art_ciyhqxwkzyc$art_c; groupIndex++) {
            ...
            if (group.text && !group.hide) {
                ...
                if (group.all) {
                    ...
                    $art = '=group.text';
                    ;
                    $p += ($expr = '<%=group.text%>', $e(group.text)) + '" class="_zs_gallery_mx-dropdown_index_-dropdown-item _zs_gallery_mx-dropdown_index_-dropdown-header-item"><label mxa="_zs_gallerya0:e" class="_zs_gallery_mx-dropdown_index_-item-link ellipsis"><span mx-focusout="' + $viewId + '@{stop}()" mx-change="' + $viewId + '@{checkGroup}({groupIndex:\'';
                    $line = 55;
                    $art = '=groupIndex';
                    ;
            ...
            ;
            $p += '<div mxv mxa="_zs_gallerya0:f" class="clearfix _zs_gallery_mx-dropdown_index_-group-wrapper">';
            $line = 64;
            $art = 'each group.list as item';
            ;
            $expr = '<%for (var $art_ihdliubuqh$art_i = 0, $art_objtnmdhdajw$art_obj = group.list, $art_cbwqlistw$art_c = $art_objtnmdhdajw$art_obj.length; $art_ihdliubuqh$art_i < $art_cbwqlistw$art_c; $art_ihdliubuqh$art_i++) {            var item = $art_objtnmdhdajw$art_obj[$art_ihdliubuqh$art_i]%>';
            for (var $art_ihdliubuqh$art_i = 0, $art_objtnmdhdajw$art_obj = group.list, $art_cbwqlistw$art_c = $art_objtnmdhdajw$art_obj.length; $art_ihdliubuqh$art_i < $art_cbwqlistw$art_c; $art_ihdliubuqh$art_i++) {
                var item = $art_objtnmdhdajw$art_obj[$art_ihdliubuqh$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
        ...
        ;
        $p += '</div><div mxa="_zs_gallerya0:g" class="_zs_gallery_mx-dropdown_index_-footer-wrapper"><a mxa="_zs_gallerya0:h" href="javascript:;" class="btn btn-small btn-brand mr10" mx-click="' + $viewId + '@{submit}({enter:true})">';
        $line = 83;
        $art = '=text.submit';
        ;
        $p += ($expr = '<%=text.submit%>', $e(text.submit)) + '</a><a mxa="_zs_gallerya0:i" href="javascript:;" class="btn btn-small" mx-click="' + $viewId + '@{hide}()">';
        $line = 84;
        $art = '=text.cancel';
        ;
        ...
        if (errMsg) {
            ;
            $p += '<span mxa="_zs_gallerya0:j" class="_zs_gallery_mx-dropdown_index_-msg-wrapper color-red ml10"><i mxs="_zs_gallerya0:c" class="mc-iconfont displacement-2">&#xe6ad;</i><span mxa="_zs_gallerya0:k" class="_zs_gallery_mx-dropdown_index_-msg">';
            $line = 88;
            $art = '!errMsg';
            ;
