...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_czhciqub$art_c = groups.length; groupIndex < $art_czhciqub$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_czhciqub$art_c = groups.length; groupIndex < $art_czhciqub$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_izwnrqtnip$art_i = 0, $art_objpafzrgxch$art_obj = group.list, $art_cjbfbway$art_c = $art_objpafzrgxch$art_obj.length; $art_izwnrqtnip$art_i < $art_cjbfbway$art_c; $art_izwnrqtnip$art_i++) {            var item = $art_objpafzrgxch$art_obj[$art_izwnrqtnip$art_i]%>';
            for (var $art_izwnrqtnip$art_i = 0, $art_objpafzrgxch$art_obj = group.list, $art_cjbfbway$art_c = $art_objpafzrgxch$art_obj.length; $art_izwnrqtnip$art_i < $art_cjbfbway$art_c; $art_izwnrqtnip$art_i++) {
                var item = $art_objpafzrgxch$art_obj[$art_izwnrqtnip$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
