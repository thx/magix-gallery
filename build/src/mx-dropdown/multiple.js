...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cvpqbnf$art_c = groups.length; groupIndex < $art_cvpqbnf$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cvpqbnf$art_c = groups.length; groupIndex < $art_cvpqbnf$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ichdrtoct$art_i = 0, $art_objpxrquo$art_obj = group.list, $art_cyfmwjlm$art_c = $art_objpxrquo$art_obj.length; $art_ichdrtoct$art_i < $art_cyfmwjlm$art_c; $art_ichdrtoct$art_i++) {            var item = $art_objpxrquo$art_obj[$art_ichdrtoct$art_i]%>';
            for (var $art_ichdrtoct$art_i = 0, $art_objpxrquo$art_obj = group.list, $art_cyfmwjlm$art_c = $art_objpxrquo$art_obj.length; $art_ichdrtoct$art_i < $art_cyfmwjlm$art_c; $art_ichdrtoct$art_i++) {
                var item = $art_objpxrquo$art_obj[$art_ichdrtoct$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
