...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cwxblbo$art_c = groups.length; groupIndex < $art_cwxblbo$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cwxblbo$art_c = groups.length; groupIndex < $art_cwxblbo$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ivvxuppggw$art_i = 0, $art_objtmjcgmmx$art_obj = group.list, $art_cggdyisbk$art_c = $art_objtmjcgmmx$art_obj.length; $art_ivvxuppggw$art_i < $art_cggdyisbk$art_c; $art_ivvxuppggw$art_i++) {            var item = $art_objtmjcgmmx$art_obj[$art_ivvxuppggw$art_i]%>';
            for (var $art_ivvxuppggw$art_i = 0, $art_objtmjcgmmx$art_obj = group.list, $art_cggdyisbk$art_c = $art_objtmjcgmmx$art_obj.length; $art_ivvxuppggw$art_i < $art_cggdyisbk$art_c; $art_ivvxuppggw$art_i++) {
                var item = $art_objtmjcgmmx$art_obj[$art_ivvxuppggw$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
