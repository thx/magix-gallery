...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cqvngtgcqdmb$art_c = groups.length; groupIndex < $art_cqvngtgcqdmb$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cqvngtgcqdmb$art_c = groups.length; groupIndex < $art_cqvngtgcqdmb$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ivkvvard$art_i = 0, $art_objdkrtgbjjmn$art_obj = group.list, $art_cxlghmip$art_c = $art_objdkrtgbjjmn$art_obj.length; $art_ivkvvard$art_i < $art_cxlghmip$art_c; $art_ivkvvard$art_i++) {            var item = $art_objdkrtgbjjmn$art_obj[$art_ivkvvard$art_i]%>';
            for (var $art_ivkvvard$art_i = 0, $art_objdkrtgbjjmn$art_obj = group.list, $art_cxlghmip$art_c = $art_objdkrtgbjjmn$art_obj.length; $art_ivkvvard$art_i < $art_cxlghmip$art_c; $art_ivkvvard$art_i++) {
                var item = $art_objdkrtgbjjmn$art_obj[$art_ivkvvard$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
