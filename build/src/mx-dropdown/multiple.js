...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (searchbox) {
            ;
            $p += '<div mxv mxa="_zs_galleryaz:_" class="_zs_gallery_mx-dropdown_index_-search-wrapper"><div mxv mxa="_zs_galleryaz:a" class="search-box"><i mxs="_zs_galleryaz:a" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
            $line = 13;
            $art = '=text.search';
            ;
        ...
        if (!needAll) {
            ;
            $p += '<div mxa="_zs_galleryaz:b" class="_zs_gallery_mx-dropdown_index_-oper-wrapper"><a class="_zs_gallery_mx-dropdown_index_-oper" href="javascript:;" mx-click="' + $viewId + '@{checkAll}({checked:true})" data-spm-click="';
            $line = 25;
            $art = '=spm';
            ;
            $p += '' + ($expr = '<%=spm%>', $e(spm)) + '">';
        ...
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_clsfcrmu$art_c = groups.length; groupIndex < $art_clsfcrmu$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_clsfcrmu$art_c = groups.length; groupIndex < $art_clsfcrmu$art_c; groupIndex++) {
            ...
            ;
            $p += '<div mxv mxa="_zs_galleryaz:c" class="clearfix _zs_gallery_mx-dropdown_index_-group-wrapper">';
            $line = 48;
            $art = 'each group.list as item';
            ;
            $p += '';
            $expr = '<%for (var $art_ivtvodmrkg$art_i = 0, $art_objtbtvpvl$art_obj = group.list, $art_cbkcdemtgkm$art_c = $art_objtbtvpvl$art_obj.length; $art_ivtvodmrkg$art_i < $art_cbkcdemtgkm$art_c; $art_ivtvodmrkg$art_i++) {            var item = $art_objtbtvpvl$art_obj[$art_ivtvodmrkg$art_i]%>';
            for (var $art_ivtvodmrkg$art_i = 0, $art_objtbtvpvl$art_obj = group.list, $art_cbkcdemtgkm$art_c = $art_objtbtvpvl$art_obj.length; $art_ivtvodmrkg$art_i < $art_cbkcdemtgkm$art_c; $art_ivtvodmrkg$art_i++) {
                var item = $art_objtbtvpvl$art_obj[$art_ivtvodmrkg$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
        ...
        ;
        $p += '</div><div mxa="_zs_galleryaz:d" class="_zs_gallery_mx-dropdown_index_-footer-wrapper"><button mxa="_zs_galleryaz:e" type="button" class="btn btn-small btn-brand mr10" mx-click="' + $viewId + '@{submit}({enter:true})">';
        $line = 66;
        $art = '=text.submit';
        ;
        $p += '' + ($expr = '<%=text.submit%>', $e(text.submit)) + '</button><button mxa="_zs_galleryaz:f" type="button" class="btn btn-small" mx-click="' + $viewId + '@{hide}()">';
        $line = 67;
        $art = '=text.cancel';
        ;
