...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_csbxuckb$art_c = groups.length; groupIndex < $art_csbxuckb$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_csbxuckb$art_c = groups.length; groupIndex < $art_csbxuckb$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ijiznyggr$art_i = 0, $art_objjeyevxngq$art_obj = group.list, $art_cxhejwtab$art_c = $art_objjeyevxngq$art_obj.length; $art_ijiznyggr$art_i < $art_cxhejwtab$art_c; $art_ijiznyggr$art_i++) {            var item = $art_objjeyevxngq$art_obj[$art_ijiznyggr$art_i]%>';
            for (var $art_ijiznyggr$art_i = 0, $art_objjeyevxngq$art_obj = group.list, $art_cxhejwtab$art_c = $art_objjeyevxngq$art_obj.length; $art_ijiznyggr$art_i < $art_cxhejwtab$art_c; $art_ijiznyggr$art_i++) {
                var item = $art_objjeyevxngq$art_obj[$art_ijiznyggr$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
