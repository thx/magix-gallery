...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cnhlu$art_c = groups.length; groupIndex < $art_cnhlu$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cnhlu$art_c = groups.length; groupIndex < $art_cnhlu$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ivwechxfk$art_i = 0, $art_objnztlide$art_obj = group.list, $art_cmebesbgvr$art_c = $art_objnztlide$art_obj.length; $art_ivwechxfk$art_i < $art_cmebesbgvr$art_c; $art_ivwechxfk$art_i++) {            var item = $art_objnztlide$art_obj[$art_ivwechxfk$art_i]%>';
            for (var $art_ivwechxfk$art_i = 0, $art_objnztlide$art_obj = group.list, $art_cmebesbgvr$art_c = $art_objnztlide$art_obj.length; $art_ivwechxfk$art_i < $art_cmebesbgvr$art_c; $art_ivwechxfk$art_i++) {
                var item = $art_objnztlide$art_obj[$art_ivwechxfk$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
