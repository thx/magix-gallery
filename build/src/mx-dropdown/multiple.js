...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_czwcromcpm$art_c = groups.length; groupIndex < $art_czwcromcpm$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_czwcromcpm$art_c = groups.length; groupIndex < $art_czwcromcpm$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iotcmjttg$art_i = 0, $art_objrqaihddk$art_obj = group.list, $art_czajojffk$art_c = $art_objrqaihddk$art_obj.length; $art_iotcmjttg$art_i < $art_czajojffk$art_c; $art_iotcmjttg$art_i++) {                var item = $art_objrqaihddk$art_obj[$art_iotcmjttg$art_i]%>';
                for (var $art_iotcmjttg$art_i = 0, $art_objrqaihddk$art_obj = group.list, $art_czajojffk$art_c = $art_objrqaihddk$art_obj.length; $art_iotcmjttg$art_i < $art_czajojffk$art_c; $art_iotcmjttg$art_i++) {
                    var item = $art_objrqaihddk$art_obj[$art_iotcmjttg$art_i];
                    $p += ' ';
                    $line = 66;
                    $art = 'if !item.hide';
                    ;
