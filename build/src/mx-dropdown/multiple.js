...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_crfymgpfpul$art_c = groups.length; groupIndex < $art_crfymgpfpul$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_crfymgpfpul$art_c = groups.length; groupIndex < $art_crfymgpfpul$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_iyhrvxql$art_i = 0, $art_objzrvjubbf$art_obj = group.list, $art_cikfrapppq$art_c = $art_objzrvjubbf$art_obj.length; $art_iyhrvxql$art_i < $art_cikfrapppq$art_c; $art_iyhrvxql$art_i++) {            var item = $art_objzrvjubbf$art_obj[$art_iyhrvxql$art_i]%>';
            for (var $art_iyhrvxql$art_i = 0, $art_objzrvjubbf$art_obj = group.list, $art_cikfrapppq$art_c = $art_objzrvjubbf$art_obj.length; $art_iyhrvxql$art_i < $art_cikfrapppq$art_c; $art_iyhrvxql$art_i++) {
                var item = $art_objzrvjubbf$art_obj[$art_iyhrvxql$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
