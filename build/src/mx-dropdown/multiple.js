...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_czwhtjuvgohg$art_c = groups.length; groupIndex < $art_czwhtjuvgohg$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_czwhtjuvgohg$art_c = groups.length; groupIndex < $art_czwhtjuvgohg$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ifuuomdvord$art_i = 0, $art_objtuupj$art_obj = group.list, $art_cipksbvwt$art_c = $art_objtuupj$art_obj.length; $art_ifuuomdvord$art_i < $art_cipksbvwt$art_c; $art_ifuuomdvord$art_i++) {                var item = $art_objtuupj$art_obj[$art_ifuuomdvord$art_i]%>';
                for (var $art_ifuuomdvord$art_i = 0, $art_objtuupj$art_obj = group.list, $art_cipksbvwt$art_c = $art_objtuupj$art_obj.length; $art_ifuuomdvord$art_i < $art_cipksbvwt$art_c; $art_ifuuomdvord$art_i++) {
                    var item = $art_objtuupj$art_obj[$art_ifuuomdvord$art_i];
                    $p += ' ';
                    $line = 66;
                    $art = 'if !item.hide';
                    ;
        ...
        if (errMsg) {
            ;
            $p += '<span mxa="_zs_gallerya,:l" class="_zs_gallery_mx-dropdown_index_-msg-wrapper color-red ml10"><i mxs="_zs_gallerya,:c" class="mc-iconfont displacement-2">&#xe6ad;</i><span mxa="_zs_gallerya,:m" class="_zs_gallery_mx-dropdown_index_-msg">';
            $line = 92;
            $art = '!errMsg';
            ;
