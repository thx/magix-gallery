...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $p += '';
        $expr = '<%for (var groupIndex = 0, $art_cqgdyxki$art_c = groups.length; groupIndex < $art_cqgdyxki$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cqgdyxki$art_c = groups.length; groupIndex < $art_cqgdyxki$art_c; groupIndex++) {
            ...
            ;
            $p += '';
            $expr = '<%for (var $art_ilppppnbais$art_i = 0, $art_objtijiehs$art_obj = group.list, $art_cppsydub$art_c = $art_objtijiehs$art_obj.length; $art_ilppppnbais$art_i < $art_cppsydub$art_c; $art_ilppppnbais$art_i++) {            var item = $art_objtijiehs$art_obj[$art_ilppppnbais$art_i]%>';
            for (var $art_ilppppnbais$art_i = 0, $art_objtijiehs$art_obj = group.list, $art_cppsydub$art_c = $art_objtijiehs$art_obj.length; $art_ilppppnbais$art_i < $art_cppsydub$art_c; $art_ilppppnbais$art_i++) {
                var item = $art_objtijiehs$art_obj[$art_ilppppnbais$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
