...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_chxdix$art_c = groups.length; groupIndex < $art_chxdix$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_chxdix$art_c = groups.length; groupIndex < $art_chxdix$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ipyxrkylld$art_i = 0, $art_objveartjpq$art_obj = group.list, $art_csiecpjedi$art_c = $art_objveartjpq$art_obj.length; $art_ipyxrkylld$art_i < $art_csiecpjedi$art_c; $art_ipyxrkylld$art_i++) {            var item = $art_objveartjpq$art_obj[$art_ipyxrkylld$art_i]%>';
            for (var $art_ipyxrkylld$art_i = 0, $art_objveartjpq$art_obj = group.list, $art_csiecpjedi$art_c = $art_objveartjpq$art_obj.length; $art_ipyxrkylld$art_i < $art_csiecpjedi$art_c; $art_ipyxrkylld$art_i++) {
                var item = $art_objveartjpq$art_obj[$art_ipyxrkylld$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
