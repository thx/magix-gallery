...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cttutkcoj$art_c = groups.length; groupIndex < $art_cttutkcoj$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cttutkcoj$art_c = groups.length; groupIndex < $art_cttutkcoj$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ivwco$art_i = 0, $art_objnfndzod$art_obj = group.list, $art_cohcorfkg$art_c = $art_objnfndzod$art_obj.length; $art_ivwco$art_i < $art_cohcorfkg$art_c; $art_ivwco$art_i++) {            var item = $art_objnfndzod$art_obj[$art_ivwco$art_i]%>';
            for (var $art_ivwco$art_i = 0, $art_objnfndzod$art_obj = group.list, $art_cohcorfkg$art_c = $art_objnfndzod$art_obj.length; $art_ivwco$art_i < $art_cohcorfkg$art_c; $art_ivwco$art_i++) {
                var item = $art_objnfndzod$art_obj[$art_ivwco$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
