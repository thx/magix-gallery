...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_ccgxzteuk$art_c = groups.length; groupIndex < $art_ccgxzteuk$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_ccgxzteuk$art_c = groups.length; groupIndex < $art_ccgxzteuk$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ioniizoc$art_i = 0, $art_objujwaomv$art_obj = group.list, $art_coaibnx$art_c = $art_objujwaomv$art_obj.length; $art_ioniizoc$art_i < $art_coaibnx$art_c; $art_ioniizoc$art_i++) {                var item = $art_objujwaomv$art_obj[$art_ioniizoc$art_i]%>';
                for (var $art_ioniizoc$art_i = 0, $art_objujwaomv$art_obj = group.list, $art_coaibnx$art_c = $art_objujwaomv$art_obj.length; $art_ioniizoc$art_i < $art_coaibnx$art_c; $art_ioniizoc$art_i++) {
                    var item = $art_objujwaomv$art_obj[$art_ioniizoc$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
