...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cycde$art_c = groups.length; groupIndex < $art_cycde$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cycde$art_c = groups.length; groupIndex < $art_cycde$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_infaqg$art_i = 0, $art_objakdhdasgj$art_obj = group.list, $art_cqxfnpyiqa$art_c = $art_objakdhdasgj$art_obj.length; $art_infaqg$art_i < $art_cqxfnpyiqa$art_c; $art_infaqg$art_i++) {            var item = $art_objakdhdasgj$art_obj[$art_infaqg$art_i]%>';
            for (var $art_infaqg$art_i = 0, $art_objakdhdasgj$art_obj = group.list, $art_cqxfnpyiqa$art_c = $art_objakdhdasgj$art_obj.length; $art_infaqg$art_i < $art_cqxfnpyiqa$art_c; $art_infaqg$art_i++) {
                var item = $art_objakdhdasgj$art_obj[$art_infaqg$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
