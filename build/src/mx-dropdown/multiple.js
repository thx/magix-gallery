...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_chfkvazp$art_c = groups.length; groupIndex < $art_chfkvazp$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_chfkvazp$art_c = groups.length; groupIndex < $art_chfkvazp$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_irjczflyou$art_i = 0, $art_objezxzbmzpk$art_obj = group.list, $art_coexyjvqf$art_c = $art_objezxzbmzpk$art_obj.length; $art_irjczflyou$art_i < $art_coexyjvqf$art_c; $art_irjczflyou$art_i++) {            var item = $art_objezxzbmzpk$art_obj[$art_irjczflyou$art_i]%>';
            for (var $art_irjczflyou$art_i = 0, $art_objezxzbmzpk$art_obj = group.list, $art_coexyjvqf$art_c = $art_objezxzbmzpk$art_obj.length; $art_irjczflyou$art_i < $art_coexyjvqf$art_c; $art_irjczflyou$art_i++) {
                var item = $art_objezxzbmzpk$art_obj[$art_irjczflyou$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
