...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_crxllcqj$art_c = groups.length; groupIndex < $art_crxllcqj$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_crxllcqj$art_c = groups.length; groupIndex < $art_crxllcqj$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ihmqfycr$art_i = 0, $art_objyhzzrhd$art_obj = group.list, $art_cihbjxvttt$art_c = $art_objyhzzrhd$art_obj.length; $art_ihmqfycr$art_i < $art_cihbjxvttt$art_c; $art_ihmqfycr$art_i++) {            var item = $art_objyhzzrhd$art_obj[$art_ihmqfycr$art_i]%>';
            for (var $art_ihmqfycr$art_i = 0, $art_objyhzzrhd$art_obj = group.list, $art_cihbjxvttt$art_c = $art_objyhzzrhd$art_obj.length; $art_ihmqfycr$art_i < $art_cihbjxvttt$art_c; $art_ihmqfycr$art_i++) {
                var item = $art_objyhzzrhd$art_obj[$art_ihmqfycr$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
