...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cuamgvulqs$art_c = groups.length; groupIndex < $art_cuamgvulqs$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cuamgvulqs$art_c = groups.length; groupIndex < $art_cuamgvulqs$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ipctlyu$art_i = 0, $art_objegvqqwym$art_obj = group.list, $art_cxsjnirwl$art_c = $art_objegvqqwym$art_obj.length; $art_ipctlyu$art_i < $art_cxsjnirwl$art_c; $art_ipctlyu$art_i++) {            var item = $art_objegvqqwym$art_obj[$art_ipctlyu$art_i]%>';
            for (var $art_ipctlyu$art_i = 0, $art_objegvqqwym$art_obj = group.list, $art_cxsjnirwl$art_c = $art_objegvqqwym$art_obj.length; $art_ipctlyu$art_i < $art_cxsjnirwl$art_c; $art_ipctlyu$art_i++) {
                var item = $art_objegvqqwym$art_obj[$art_ipctlyu$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
