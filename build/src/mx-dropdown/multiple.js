...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cawmbrfj$art_c = groups.length; groupIndex < $art_cawmbrfj$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cawmbrfj$art_c = groups.length; groupIndex < $art_cawmbrfj$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ittbwknvqzr$art_i = 0, $art_objvsptybwnvn$art_obj = group.list, $art_colutwhuk$art_c = $art_objvsptybwnvn$art_obj.length; $art_ittbwknvqzr$art_i < $art_colutwhuk$art_c; $art_ittbwknvqzr$art_i++) {            var item = $art_objvsptybwnvn$art_obj[$art_ittbwknvqzr$art_i]%>';
            for (var $art_ittbwknvqzr$art_i = 0, $art_objvsptybwnvn$art_obj = group.list, $art_colutwhuk$art_c = $art_objvsptybwnvn$art_obj.length; $art_ittbwknvqzr$art_i < $art_colutwhuk$art_c; $art_ittbwknvqzr$art_i++) {
                var item = $art_objvsptybwnvn$art_obj[$art_ittbwknvqzr$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
