...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cgpkwpmux$art_c = groups.length; groupIndex < $art_cgpkwpmux$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cgpkwpmux$art_c = groups.length; groupIndex < $art_cgpkwpmux$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_izidraz$art_i = 0, $art_objlbbgap$art_obj = group.list, $art_csfyifqxbk$art_c = $art_objlbbgap$art_obj.length; $art_izidraz$art_i < $art_csfyifqxbk$art_c; $art_izidraz$art_i++) {                var item = $art_objlbbgap$art_obj[$art_izidraz$art_i]%>';
                for (var $art_izidraz$art_i = 0, $art_objlbbgap$art_obj = group.list, $art_csfyifqxbk$art_c = $art_objlbbgap$art_obj.length; $art_izidraz$art_i < $art_csfyifqxbk$art_c; $art_izidraz$art_i++) {
                    var item = $art_objlbbgap$art_obj[$art_izidraz$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
