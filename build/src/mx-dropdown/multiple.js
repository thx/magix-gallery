...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cyjwrfk$art_c = groups.length; groupIndex < $art_cyjwrfk$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cyjwrfk$art_c = groups.length; groupIndex < $art_cyjwrfk$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_imwwphpqb$art_i = 0, $art_objcxrzvxek$art_obj = group.list, $art_cdbjaapwjz$art_c = $art_objcxrzvxek$art_obj.length; $art_imwwphpqb$art_i < $art_cdbjaapwjz$art_c; $art_imwwphpqb$art_i++) {            var item = $art_objcxrzvxek$art_obj[$art_imwwphpqb$art_i]%>';
            for (var $art_imwwphpqb$art_i = 0, $art_objcxrzvxek$art_obj = group.list, $art_cdbjaapwjz$art_c = $art_objcxrzvxek$art_obj.length; $art_imwwphpqb$art_i < $art_cdbjaapwjz$art_c; $art_imwwphpqb$art_i++) {
                var item = $art_objcxrzvxek$art_obj[$art_imwwphpqb$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
