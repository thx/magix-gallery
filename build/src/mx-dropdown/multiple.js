...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_czmlrdilkw$art_c = groups.length; groupIndex < $art_czmlrdilkw$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_czmlrdilkw$art_c = groups.length; groupIndex < $art_czmlrdilkw$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iybrvvhuor$art_i = 0, $art_objgvkwkq$art_obj = group.list, $art_civtutvrh$art_c = $art_objgvkwkq$art_obj.length; $art_iybrvvhuor$art_i < $art_civtutvrh$art_c; $art_iybrvvhuor$art_i++) {                var item = $art_objgvkwkq$art_obj[$art_iybrvvhuor$art_i]%>';
                for (var $art_iybrvvhuor$art_i = 0, $art_objgvkwkq$art_obj = group.list, $art_civtutvrh$art_c = $art_objgvkwkq$art_obj.length; $art_iybrvvhuor$art_i < $art_civtutvrh$art_c; $art_iybrvvhuor$art_i++) {
                    var item = $art_objgvkwkq$art_obj[$art_iybrvvhuor$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
