...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_csuqowuwgj$art_c = groups.length; groupIndex < $art_csuqowuwgj$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_csuqowuwgj$art_c = groups.length; groupIndex < $art_csuqowuwgj$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ixylub$art_i = 0, $art_objbrnzmnwe$art_obj = group.list, $art_clyidwuir$art_c = $art_objbrnzmnwe$art_obj.length; $art_ixylub$art_i < $art_clyidwuir$art_c; $art_ixylub$art_i++) {                var item = $art_objbrnzmnwe$art_obj[$art_ixylub$art_i]%>';
                for (var $art_ixylub$art_i = 0, $art_objbrnzmnwe$art_obj = group.list, $art_clyidwuir$art_c = $art_objbrnzmnwe$art_obj.length; $art_ixylub$art_i < $art_clyidwuir$art_c; $art_ixylub$art_i++) {
                    var item = $art_objbrnzmnwe$art_obj[$art_ixylub$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
