...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cmhzda$art_c = groups.length; groupIndex < $art_cmhzda$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cmhzda$art_c = groups.length; groupIndex < $art_cmhzda$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ifccaaxctf$art_i = 0, $art_objensypccy$art_obj = group.list, $art_crboealb$art_c = $art_objensypccy$art_obj.length; $art_ifccaaxctf$art_i < $art_crboealb$art_c; $art_ifccaaxctf$art_i++) {            var item = $art_objensypccy$art_obj[$art_ifccaaxctf$art_i]%>';
            for (var $art_ifccaaxctf$art_i = 0, $art_objensypccy$art_obj = group.list, $art_crboealb$art_c = $art_objensypccy$art_obj.length; $art_ifccaaxctf$art_i < $art_crboealb$art_c; $art_ifccaaxctf$art_i++) {
                var item = $art_objensypccy$art_obj[$art_ifccaaxctf$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
