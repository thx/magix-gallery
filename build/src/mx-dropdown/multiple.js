...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cuewfahdplf$art_c = groups.length; groupIndex < $art_cuewfahdplf$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cuewfahdplf$art_c = groups.length; groupIndex < $art_cuewfahdplf$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ijeekrqbbw$art_i = 0, $art_objjdnnbhkx$art_obj = group.list, $art_cvrrrivg$art_c = $art_objjdnnbhkx$art_obj.length; $art_ijeekrqbbw$art_i < $art_cvrrrivg$art_c; $art_ijeekrqbbw$art_i++) {            var item = $art_objjdnnbhkx$art_obj[$art_ijeekrqbbw$art_i]%>';
            for (var $art_ijeekrqbbw$art_i = 0, $art_objjdnnbhkx$art_obj = group.list, $art_cvrrrivg$art_c = $art_objjdnnbhkx$art_obj.length; $art_ijeekrqbbw$art_i < $art_cvrrrivg$art_c; $art_ijeekrqbbw$art_i++) {
                var item = $art_objjdnnbhkx$art_obj[$art_ijeekrqbbw$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
