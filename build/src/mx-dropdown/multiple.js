...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cczvvqtljq$art_c = groups.length; groupIndex < $art_cczvvqtljq$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cczvvqtljq$art_c = groups.length; groupIndex < $art_cczvvqtljq$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_irwczz$art_i = 0, $art_objiohhmqhbbrp$art_obj = group.list, $art_cqizmiymj$art_c = $art_objiohhmqhbbrp$art_obj.length; $art_irwczz$art_i < $art_cqizmiymj$art_c; $art_irwczz$art_i++) {            var item = $art_objiohhmqhbbrp$art_obj[$art_irwczz$art_i]%>';
            for (var $art_irwczz$art_i = 0, $art_objiohhmqhbbrp$art_obj = group.list, $art_cqizmiymj$art_c = $art_objiohhmqhbbrp$art_obj.length; $art_irwczz$art_i < $art_cqizmiymj$art_c; $art_irwczz$art_i++) {
                var item = $art_objiohhmqhbbrp$art_obj[$art_irwczz$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
