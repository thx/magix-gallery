...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cpevjxdii$art_c = groups.length; groupIndex < $art_cpevjxdii$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cpevjxdii$art_c = groups.length; groupIndex < $art_cpevjxdii$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_itwdxgipy$art_i = 0, $art_objbgejig$art_obj = group.list, $art_cvnecgcpnka$art_c = $art_objbgejig$art_obj.length; $art_itwdxgipy$art_i < $art_cvnecgcpnka$art_c; $art_itwdxgipy$art_i++) {                var item = $art_objbgejig$art_obj[$art_itwdxgipy$art_i]%>';
                for (var $art_itwdxgipy$art_i = 0, $art_objbgejig$art_obj = group.list, $art_cvnecgcpnka$art_c = $art_objbgejig$art_obj.length; $art_itwdxgipy$art_i < $art_cvnecgcpnka$art_c; $art_itwdxgipy$art_i++) {
                    var item = $art_objbgejig$art_obj[$art_itwdxgipy$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
