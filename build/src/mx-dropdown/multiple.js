...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_ccwkvvzpzfw$art_c = groups.length; groupIndex < $art_ccwkvvzpzfw$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_ccwkvvzpzfw$art_c = groups.length; groupIndex < $art_ccwkvvzpzfw$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iynjhfrmnq$art_i = 0, $art_objtqdtwsjv$art_obj = group.list, $art_ccavsklia$art_c = $art_objtqdtwsjv$art_obj.length; $art_iynjhfrmnq$art_i < $art_ccavsklia$art_c; $art_iynjhfrmnq$art_i++) {                var item = $art_objtqdtwsjv$art_obj[$art_iynjhfrmnq$art_i]%>';
                for (var $art_iynjhfrmnq$art_i = 0, $art_objtqdtwsjv$art_obj = group.list, $art_ccavsklia$art_c = $art_objtqdtwsjv$art_obj.length; $art_iynjhfrmnq$art_i < $art_ccavsklia$art_c; $art_iynjhfrmnq$art_i++) {
                    var item = $art_objtqdtwsjv$art_obj[$art_iynjhfrmnq$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
