...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_cswplmbgsmi$art_c = groups.length; groupIndex < $art_cswplmbgsmi$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_cswplmbgsmi$art_c = groups.length; groupIndex < $art_cswplmbgsmi$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ioukeqdtgb$art_i = 0, $art_objxrdgxe$art_obj = group.list, $art_cgwbyezur$art_c = $art_objxrdgxe$art_obj.length; $art_ioukeqdtgb$art_i < $art_cgwbyezur$art_c; $art_ioukeqdtgb$art_i++) {            var item = $art_objxrdgxe$art_obj[$art_ioukeqdtgb$art_i]%>';
            for (var $art_ioukeqdtgb$art_i = 0, $art_objxrdgxe$art_obj = group.list, $art_cgwbyezur$art_c = $art_objxrdgxe$art_obj.length; $art_ioukeqdtgb$art_i < $art_cgwbyezur$art_c; $art_ioukeqdtgb$art_i++) {
                var item = $art_objxrdgxe$art_obj[$art_ioukeqdtgb$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
