...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_czlbofgq$art_c = groups.length; groupIndex < $art_czlbofgq$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_czlbofgq$art_c = groups.length; groupIndex < $art_czlbofgq$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_iyyurll$art_i = 0, $art_objchdirhzbz$art_obj = group.list, $art_cmspodqgo$art_c = $art_objchdirhzbz$art_obj.length; $art_iyyurll$art_i < $art_cmspodqgo$art_c; $art_iyyurll$art_i++) {                var item = $art_objchdirhzbz$art_obj[$art_iyyurll$art_i]%>';
                for (var $art_iyyurll$art_i = 0, $art_objchdirhzbz$art_obj = group.list, $art_cmspodqgo$art_c = $art_objchdirhzbz$art_obj.length; $art_iyyurll$art_i < $art_cmspodqgo$art_c; $art_iyyurll$art_i++) {
                    var item = $art_objchdirhzbz$art_obj[$art_iyyurll$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
