...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cdknaol$art_c = groups.length; groupIndex < $art_cdknaol$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cdknaol$art_c = groups.length; groupIndex < $art_cdknaol$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ithomipi$art_i = 0, $art_objcrapro$art_obj = group.list, $art_cfiiqzu$art_c = $art_objcrapro$art_obj.length; $art_ithomipi$art_i < $art_cfiiqzu$art_c; $art_ithomipi$art_i++) {                var item = $art_objcrapro$art_obj[$art_ithomipi$art_i]%>';
                for (var $art_ithomipi$art_i = 0, $art_objcrapro$art_obj = group.list, $art_cfiiqzu$art_c = $art_objcrapro$art_obj.length; $art_ithomipi$art_i < $art_cfiiqzu$art_c; $art_ithomipi$art_i++) {
                    var item = $art_objcrapro$art_obj[$art_ithomipi$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
