...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cwcwoejomr$art_c = groups.length; groupIndex < $art_cwcwoejomr$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cwcwoejomr$art_c = groups.length; groupIndex < $art_cwcwoejomr$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_ismzickug$art_i = 0, $art_objbtubcrwcyk$art_obj = group.list, $art_cnrogbs$art_c = $art_objbtubcrwcyk$art_obj.length; $art_ismzickug$art_i < $art_cnrogbs$art_c; $art_ismzickug$art_i++) {                var item = $art_objbtubcrwcyk$art_obj[$art_ismzickug$art_i]%>';
                for (var $art_ismzickug$art_i = 0, $art_objbtubcrwcyk$art_obj = group.list, $art_cnrogbs$art_c = $art_objbtubcrwcyk$art_obj.length; $art_ismzickug$art_i < $art_cnrogbs$art_c; $art_ismzickug$art_i++) {
                    var item = $art_objbtubcrwcyk$art_obj[$art_ismzickug$art_i];
                    $p += ' ';
                    $line = 68;
                    $art = 'if !item.hide';
                    ;
