...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (searchbox) {
            ;
            $p += '<div mxv mxa="_zs_galleryaD:_" class="_zs_gallery_mx-dropdown_index_-search-wrapper"><div mxv mxa="_zs_galleryaD:a" class="search-box"><i mxs="_zs_galleryaD:a" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
            $line = 13;
            $art = '=text.search';
            ;
        ...
        if (!needAll) {
            ;
            $p += '<div mxa="_zs_galleryaD:b" class="_zs_gallery_mx-dropdown_index_-oper-wrapper"><a class="_zs_gallery_mx-dropdown_index_-oper" href="javascript:;" mx-click="' + $viewId + '@{checkAll}({checked:true})" data-spm-click="';
            $line = 25;
            $art = '=spm';
            ;
            $p += ($expr = '<%=spm%>', $e(spm)) + '">';
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_czpoauser$art_c = groups.length; groupIndex < $art_czpoauser$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_czpoauser$art_c = groups.length; groupIndex < $art_czpoauser$art_c; groupIndex++) {
            ...
            ;
            $p += '<div mxv mxa="_zs_galleryaD:c" class="clearfix _zs_gallery_mx-dropdown_index_-group-wrapper">';
            $line = 48;
            $art = 'each group.list as item';
            ;
            $expr = '<%for (var $art_istoxlkoud$art_i = 0, $art_objtsvreiijre$art_obj = group.list, $art_crbfpnyexhp$art_c = $art_objtsvreiijre$art_obj.length; $art_istoxlkoud$art_i < $art_crbfpnyexhp$art_c; $art_istoxlkoud$art_i++) {            var item = $art_objtsvreiijre$art_obj[$art_istoxlkoud$art_i]%>';
            for (var $art_istoxlkoud$art_i = 0, $art_objtsvreiijre$art_obj = group.list, $art_crbfpnyexhp$art_c = $art_objtsvreiijre$art_obj.length; $art_istoxlkoud$art_i < $art_crbfpnyexhp$art_c; $art_istoxlkoud$art_i++) {
                var item = $art_objtsvreiijre$art_obj[$art_istoxlkoud$art_i];
                $p += ' ';
                $line = 49;
                $art = 'if !item.hide';
                ;
        ...
        ;
        $p += '</div><div mxa="_zs_galleryaD:d" class="_zs_gallery_mx-dropdown_index_-footer-wrapper"><button mxa="_zs_galleryaD:e" type="button" class="btn btn-small btn-brand mr10" mx-click="' + $viewId + '@{submit}({enter:true})">';
        $line = 66;
        $art = '=text.submit';
        ;
        $p += ($expr = '<%=text.submit%>', $e(text.submit)) + '</button><button mxa="_zs_galleryaD:f" type="button" class="btn btn-small" mx-click="' + $viewId + '@{hide}()">';
        $line = 67;
        $art = '=text.cancel';
        ;
