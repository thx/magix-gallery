...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        ;
        $expr = '<%for (var groupIndex = 0, $art_ccfkerilns$art_c = groups.length; groupIndex < $art_ccfkerilns$art_c; groupIndex++) {        var group = groups[groupIndex]%>';
        for (var groupIndex = 0, $art_ccfkerilns$art_c = groups.length; groupIndex < $art_ccfkerilns$art_c; groupIndex++) {
            ...
            ;
            $expr = '<%for (var $art_ippagqkvhkj$art_i = 0, $art_objnswdil$art_obj = group.list, $art_cemjldni$art_c = $art_objnswdil$art_obj.length; $art_ippagqkvhkj$art_i < $art_cemjldni$art_c; $art_ippagqkvhkj$art_i++) {            var item = $art_objnswdil$art_obj[$art_ippagqkvhkj$art_i]%>';
            for (var $art_ippagqkvhkj$art_i = 0, $art_objnswdil$art_obj = group.list, $art_cemjldni$art_c = $art_objnswdil$art_obj.length; $art_ippagqkvhkj$art_i < $art_cemjldni$art_c; $art_ippagqkvhkj$art_i++) {
                var item = $art_objnswdil$art_obj[$art_ippagqkvhkj$art_i];
                $p += ' ';
                $line = 65;
                $art = 'if !item.hide';
                ;
