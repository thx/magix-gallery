...
module.exports = Magix.View.extend({
    ...
    if (rList) {
        ...
        if (!allHide) {
            ...
            ;
            $expr = '<%for (var groupIndex = 0, $art_cwdsfqcjxe$art_c = groups.length; groupIndex < $art_cwdsfqcjxe$art_c; groupIndex++) {            var group = groups[groupIndex]%>';
            for (var groupIndex = 0, $art_cwdsfqcjxe$art_c = groups.length; groupIndex < $art_cwdsfqcjxe$art_c; groupIndex++) {
                ...
                ;
                $expr = '<%for (var $art_idgdqzxo$art_i = 0, $art_objyayhmclm$art_obj = group.list, $art_cijwjowbc$art_c = $art_objyayhmclm$art_obj.length; $art_idgdqzxo$art_i < $art_cijwjowbc$art_c; $art_idgdqzxo$art_i++) {                var item = $art_objyayhmclm$art_obj[$art_idgdqzxo$art_i]%>';
                for (var $art_idgdqzxo$art_i = 0, $art_objyayhmclm$art_obj = group.list, $art_cijwjowbc$art_c = $art_objyayhmclm$art_obj.length; $art_idgdqzxo$art_i < $art_cijwjowbc$art_c; $art_idgdqzxo$art_i++) {
                    var item = $art_objyayhmclm$art_obj[$art_idgdqzxo$art_i];
                    $p += ' ';
                    $line = 66;
                    $art = 'if !item.hide';
                    ;
