...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div><div mxa="_zs_gallerydb:a" class="clearfix mb20"><div mxa="_zs_gallerydb:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popmenu/__test__/4" id="';
    $line = 31;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div></div><div mxa="_zs_gallerydb:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-popmenu/__test__/3" id="';
    $line = 34;
    $art = '=viewId';
    ;
