...
module.exports = Base.extend({
    ...
    $art = '@[{\n                    value: 1,\n                    text: \'操作1\'\n                }, {\n                    value: 2,\n                    text: \'操作2\'\n                }, {\n                    value: 3,\n                    text: \'操作3\'\n                }]';
    ;
    $p += ($expr = '<%@[{            value: 1,            text: \'操作1\'        }, {            value: 2,            text: \'操作2\'        }, {            value: 3,            text: \'操作3\'        }]%>', $i($$ref, [{ value: 1, text: '操作1' }, { value: 2, text: '操作2' }, { value: 3, text: '操作3' }])) + '&triggerType=contextmenu">右键显示菜单</span><span mxs="_zs_galleryde:a" class="color-9 ml40">当前选中：</span><span>';
    $line = 20;
    $art = 'if selected';
    ;
    $expr = '<%if (selected) {%>';
    ...
    ;
    $p += '</span></div></div><div mxa="_zs_galleryde:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryde:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
