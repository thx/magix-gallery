...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryc(:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryc(:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryc(:b" class="mb20"><span mxs="_zs_galleryc(:_" class="color-9">trigger：</span><span class="color-brand" mx-change="' + $viewId + 'select()" mx-view="mx-popmenu/index?menus=';
    $line = 6;
    $art = '@[{\n                    value: 1,\n                    text: \'操作1\'\n                }, {\n                    value: 2,\n                    text: \'操作2\'\n                }, {\n                    value: 3,\n                    text: \'操作3\'\n                }]';
    ;
    $p += ($expr = '<%@[{            value: 1,            text: \'操作1\'        }, {            value: 2,            text: \'操作2\'        }, {            value: 3,            text: \'操作3\'        }]%>', $i($$ref, [{ value: 1, text: '操作1' }, { value: 2, text: '操作2' }, { value: 3, text: '操作3' }])) + '&triggerType=contextmenu">右键显示菜单</span><span mxs="_zs_galleryc(:a" class="color-9 ml40">当前选中：</span><span>';
    $line = 20;
    $art = 'if selected';
    ;
    $expr = '<%if (selected) {%>';
