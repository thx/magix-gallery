...
module.exports = Base.extend({
    ...
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&place=br">下右对齐（br）</span></div></div><div mxv mxa="_zs_gallerycC:i" class="fl _zs_gallery_mx-popmenu___test___index_-right"><div mxv mxa="_zs_gallerycC:j" class="mb20"><span mxv="menus" class="btn w100" mx-change="' + $viewId + 'select({text:\'右上对齐（rt）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 71;
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&place=rt">右上对齐（rt）</span></div><div mxv mxa="_zs_gallerycC:k" class="mb20"><span mxv="menus" class="btn w100" mx-change="' + $viewId + 'select({text:\'右中对齐（rc）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 78;
    $art = '@menus';
    ;
    ...
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&place=rb">右下对齐（rb）</span></div></div></div><div mxa="_zs_gallerycC:l" class="clearfix"><div mxa="_zs_gallerycC:m" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-left"><div mxs="_zs_gallerycC:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 94;
    $art = '=viewId';
    ;
