...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc_:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryc_:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryc_:_" class="mb20"><span class="color-9">以下示例：</span>hover显示菜单</div><div mxv mxa="_zs_galleryc_:b" class="clearfix mb20"><div mxv mxa="_zs_galleryc_:c" class="fl _zs_gallery_mx-popmenu___test___index_-left"><div mxv mxa="_zs_galleryc_:d" class="mb20"><span mxv="menus" class="btn w100" mx-change="' + $viewId + 'select({text:\'左上对齐（lt）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 11;
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&place=lt">左上对齐（lt）</span></div><div mxv mxa="_zs_galleryc_:e" class="mb20"><span mxv="menus" class="btn w100" mx-change="' + $viewId + 'select({text:\'左中对齐（lc）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 18;
    $art = '@menus';
    ;
    ...
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&place=br">下右对齐（br）</span></div></div><div mxv mxa="_zs_galleryc_:i" class="fl _zs_gallery_mx-popmenu___test___index_-right"><div mxv mxa="_zs_galleryc_:j" class="mb20"><span mxv="menus" class="btn w100" mx-change="' + $viewId + 'select({text:\'右上对齐（rt）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 71;
    $art = '@menus';
    ;
    $p += ($expr = '<%@menus%>', $i($$ref, menus)) + '&width=100&place=rt">右上对齐（rt）</span></div><div mxv mxa="_zs_galleryc_:k" class="mb20"><span mxv="menus" class="btn w100" mx-change="' + $viewId + 'select({text:\'右中对齐（rc）\'})" mx-view="mx-popmenu/index?menus=';
    $line = 78;
    $art = '@menus';
    ;
