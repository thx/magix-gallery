...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb::_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryb::a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryb::b" class="mb20"><span mxs="_zs_galleryb::_" class="color-9">trigger：</span><span class="_zs_gallery_mx-popmenu___test___3_-icon mc-iconfont" mx-change="' + $viewId + 'select()" mx-view="mx-popmenu/index?menus=';
    $line = 6;
    $art = '@[{\n                    value: 1,\n                    text: \'操作1\'\n                }, {\n                    value: 2,\n                    text: \'操作2\'\n                }, {\n                    value: 3,\n                    text: \'操作3\'\n                }]';
    ;
    $p += ($expr = '<%@[{            value: 1,            text: \'操作1\'        }, {            value: 2,            text: \'操作2\'        }, {            value: 3,            text: \'操作3\'        }]%>', $i($$ref, [{ value: 1, text: '操作1' }, { value: 2, text: '操作2' }, { value: 3, text: '操作3' }])) + '">&#xe7be;</span><span mxs="_zs_galleryb::a" class="color-9 ml40">当前选中：</span><span>';
    $line = 19;
    $art = 'if selected';
    ;
    $expr = '<%if (selected) {%>';
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-popmenu \n    class="icon mc-iconfont"\n    menus="&#123;&#123;@[&#123;\n        value: 1,\n        text: \'操作1\'\n    &#125;, &#123;\n        value: 2,\n        text: \'操作2\'\n    &#125;, &#123;\n        value: 3,\n        text: \'操作3\'\n    &#125;]&#125;&#125;"&gt;&#38;&#35;xe7be;&lt;/mx-popmenu&gt;\n        </pre></div><div mxa="_zs_galleryb::e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb::d" class="_zs_gallery___test___layout_-eg-title">CSS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 46;
    $art = '=viewId';
    ;
