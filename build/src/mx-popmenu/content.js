...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_impjviu$art_i = 0, $art_cvqsbnsijem$art_c = menus.length; $art_impjviu$art_i < $art_cvqsbnsijem$art_c; $art_impjviu$art_i++) {    var item = menus[$art_impjviu$art_i]%>';
    for (var $art_impjviu$art_i = 0, $art_cvqsbnsijem$art_c = menus.length; $art_impjviu$art_i < $art_cvqsbnsijem$art_c; $art_impjviu$art_i++) {
        var item = menus[$art_impjviu$art_i];
