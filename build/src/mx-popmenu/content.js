...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerycd:_" class="_zs_gallery_mx-popmenu_content_-menu">';
    $line = 2;
    $art = 'each menus as item';
    ;
    $expr = '<%for (var $art_idpmtcqoqqm$art_i = 0, $art_ctilogribj$art_c = menus.length; $art_idpmtcqoqqm$art_i < $art_ctilogribj$art_c; $art_idpmtcqoqqm$art_i++) {    var item = menus[$art_idpmtcqoqqm$art_i]%>';
    for (var $art_idpmtcqoqqm$art_i = 0, $art_ctilogribj$art_c = menus.length; $art_idpmtcqoqqm$art_i < $art_ctilogribj$art_c; $art_idpmtcqoqqm$art_i++) {
        var item = menus[$art_idpmtcqoqqm$art_i];
