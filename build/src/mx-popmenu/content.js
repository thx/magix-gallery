...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikshmqwj$art_i = 0, $art_cujhsjn$art_c = menus.length; $art_ikshmqwj$art_i < $art_cujhsjn$art_c; $art_ikshmqwj$art_i++) {    var item = menus[$art_ikshmqwj$art_i]%>';
    for (var $art_ikshmqwj$art_i = 0, $art_cujhsjn$art_c = menus.length; $art_ikshmqwj$art_i < $art_cujhsjn$art_c; $art_ikshmqwj$art_i++) {
        var item = menus[$art_ikshmqwj$art_i];
