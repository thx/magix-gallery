...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ippopazp$art_i = 0, $art_cvefipo$art_c = menus.length; $art_ippopazp$art_i < $art_cvefipo$art_c; $art_ippopazp$art_i++) {    var item = menus[$art_ippopazp$art_i]%>';
    for (var $art_ippopazp$art_i = 0, $art_cvefipo$art_c = menus.length; $art_ippopazp$art_i < $art_cvefipo$art_c; $art_ippopazp$art_i++) {
        var item = menus[$art_ippopazp$art_i];
