...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibwacdbhsdg$art_i = 0, $art_cweudhjqd$art_c = menus.length; $art_ibwacdbhsdg$art_i < $art_cweudhjqd$art_c; $art_ibwacdbhsdg$art_i++) {    var item = menus[$art_ibwacdbhsdg$art_i]%>';
    for (var $art_ibwacdbhsdg$art_i = 0, $art_cweudhjqd$art_c = menus.length; $art_ibwacdbhsdg$art_i < $art_cweudhjqd$art_c; $art_ibwacdbhsdg$art_i++) {
        var item = menus[$art_ibwacdbhsdg$art_i];
