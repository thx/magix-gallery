...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iacdeyn$art_i = 0, $art_cehhoxkis$art_c = menus.length; $art_iacdeyn$art_i < $art_cehhoxkis$art_c; $art_iacdeyn$art_i++) {    var item = menus[$art_iacdeyn$art_i]%>';
    for (var $art_iacdeyn$art_i = 0, $art_cehhoxkis$art_c = menus.length; $art_iacdeyn$art_i < $art_cehhoxkis$art_c; $art_iacdeyn$art_i++) {
        var item = menus[$art_iacdeyn$art_i];
