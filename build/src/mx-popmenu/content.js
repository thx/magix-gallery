...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irwsqkjervab$art_i = 0, $art_clqjolir$art_c = menus.length; $art_irwsqkjervab$art_i < $art_clqjolir$art_c; $art_irwsqkjervab$art_i++) {    var item = menus[$art_irwsqkjervab$art_i]%>';
    for (var $art_irwsqkjervab$art_i = 0, $art_clqjolir$art_c = menus.length; $art_irwsqkjervab$art_i < $art_clqjolir$art_c; $art_irwsqkjervab$art_i++) {
        var item = menus[$art_irwsqkjervab$art_i];
