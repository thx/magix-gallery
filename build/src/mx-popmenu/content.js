...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irsdvupv$art_i = 0, $art_ckrlfwzujb$art_c = menus.length; $art_irsdvupv$art_i < $art_ckrlfwzujb$art_c; $art_irsdvupv$art_i++) {    var item = menus[$art_irsdvupv$art_i]%>';
    for (var $art_irsdvupv$art_i = 0, $art_ckrlfwzujb$art_c = menus.length; $art_irsdvupv$art_i < $art_ckrlfwzujb$art_c; $art_irsdvupv$art_i++) {
        var item = menus[$art_irsdvupv$art_i];
