...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iygdsfhzd$art_i = 0, $art_cscjdtisyvr$art_c = menus.length; $art_iygdsfhzd$art_i < $art_cscjdtisyvr$art_c; $art_iygdsfhzd$art_i++) {    var item = menus[$art_iygdsfhzd$art_i]%>';
    for (var $art_iygdsfhzd$art_i = 0, $art_cscjdtisyvr$art_c = menus.length; $art_iygdsfhzd$art_i < $art_cscjdtisyvr$art_c; $art_iygdsfhzd$art_i++) {
        var item = menus[$art_iygdsfhzd$art_i];
