...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibdbqkabdw$art_i = 0, $art_cecyfk$art_c = menus.length; $art_ibdbqkabdw$art_i < $art_cecyfk$art_c; $art_ibdbqkabdw$art_i++) {    var item = menus[$art_ibdbqkabdw$art_i]%>';
    for (var $art_ibdbqkabdw$art_i = 0, $art_cecyfk$art_c = menus.length; $art_ibdbqkabdw$art_i < $art_cecyfk$art_c; $art_ibdbqkabdw$art_i++) {
        var item = menus[$art_ibdbqkabdw$art_i];
