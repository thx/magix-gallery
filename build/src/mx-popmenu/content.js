...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyabtket$art_i = 0, $art_cbdmvchub$art_c = menus.length; $art_iyabtket$art_i < $art_cbdmvchub$art_c; $art_iyabtket$art_i++) {    var item = menus[$art_iyabtket$art_i]%>';
    for (var $art_iyabtket$art_i = 0, $art_cbdmvchub$art_c = menus.length; $art_iyabtket$art_i < $art_cbdmvchub$art_c; $art_iyabtket$art_i++) {
        var item = menus[$art_iyabtket$art_i];
