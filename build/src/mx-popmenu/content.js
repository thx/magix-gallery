...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihkaggyt$art_i = 0, $art_ckxfltjwi$art_c = menus.length; $art_ihkaggyt$art_i < $art_ckxfltjwi$art_c; $art_ihkaggyt$art_i++) {    var item = menus[$art_ihkaggyt$art_i]%>';
    for (var $art_ihkaggyt$art_i = 0, $art_ckxfltjwi$art_c = menus.length; $art_ihkaggyt$art_i < $art_ckxfltjwi$art_c; $art_ihkaggyt$art_i++) {
        var item = menus[$art_ihkaggyt$art_i];
