...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iefdysjpx$art_i = 0, $art_ctjrakkorup$art_c = menus.length; $art_iefdysjpx$art_i < $art_ctjrakkorup$art_c; $art_iefdysjpx$art_i++) {    var item = menus[$art_iefdysjpx$art_i]%>';
    for (var $art_iefdysjpx$art_i = 0, $art_ctjrakkorup$art_c = menus.length; $art_iefdysjpx$art_i < $art_ctjrakkorup$art_c; $art_iefdysjpx$art_i++) {
        var item = menus[$art_iefdysjpx$art_i];
