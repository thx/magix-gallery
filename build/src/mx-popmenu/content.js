...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihaoxdnvk$art_i = 0, $art_cxdbwutr$art_c = menus.length; $art_ihaoxdnvk$art_i < $art_cxdbwutr$art_c; $art_ihaoxdnvk$art_i++) {    var item = menus[$art_ihaoxdnvk$art_i]%>';
    for (var $art_ihaoxdnvk$art_i = 0, $art_cxdbwutr$art_c = menus.length; $art_ihaoxdnvk$art_i < $art_cxdbwutr$art_c; $art_ihaoxdnvk$art_i++) {
        var item = menus[$art_ihaoxdnvk$art_i];
