...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iizkjgdd$art_i = 0, $art_clbvrbbxkn$art_c = menus.length; $art_iizkjgdd$art_i < $art_clbvrbbxkn$art_c; $art_iizkjgdd$art_i++) {    var item = menus[$art_iizkjgdd$art_i]%>';
    for (var $art_iizkjgdd$art_i = 0, $art_clbvrbbxkn$art_c = menus.length; $art_iizkjgdd$art_i < $art_clbvrbbxkn$art_c; $art_iizkjgdd$art_i++) {
        var item = menus[$art_iizkjgdd$art_i];
