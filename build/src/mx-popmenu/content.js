...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igufkbtebps$art_i = 0, $art_cahuwfwcmf$art_c = menus.length; $art_igufkbtebps$art_i < $art_cahuwfwcmf$art_c; $art_igufkbtebps$art_i++) {    var item = menus[$art_igufkbtebps$art_i]%>';
    for (var $art_igufkbtebps$art_i = 0, $art_cahuwfwcmf$art_c = menus.length; $art_igufkbtebps$art_i < $art_cahuwfwcmf$art_c; $art_igufkbtebps$art_i++) {
        var item = menus[$art_igufkbtebps$art_i];
