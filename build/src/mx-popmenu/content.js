...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iccjqdd$art_i = 0, $art_cfdgwkd$art_c = menus.length; $art_iccjqdd$art_i < $art_cfdgwkd$art_c; $art_iccjqdd$art_i++) {    var item = menus[$art_iccjqdd$art_i]%>';
    for (var $art_iccjqdd$art_i = 0, $art_cfdgwkd$art_c = menus.length; $art_iccjqdd$art_i < $art_cfdgwkd$art_c; $art_iccjqdd$art_i++) {
        var item = menus[$art_iccjqdd$art_i];
