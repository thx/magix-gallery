...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icnnaladodd$art_i = 0, $art_clkevfq$art_c = menus.length; $art_icnnaladodd$art_i < $art_clkevfq$art_c; $art_icnnaladodd$art_i++) {    var item = menus[$art_icnnaladodd$art_i]%>';
    for (var $art_icnnaladodd$art_i = 0, $art_clkevfq$art_c = menus.length; $art_icnnaladodd$art_i < $art_clkevfq$art_c; $art_icnnaladodd$art_i++) {
        var item = menus[$art_icnnaladodd$art_i];
