...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ieqdezu$art_i = 0, $art_cwvppykhk$art_c = menus.length; $art_ieqdezu$art_i < $art_cwvppykhk$art_c; $art_ieqdezu$art_i++) {    var item = menus[$art_ieqdezu$art_i]%>';
    for (var $art_ieqdezu$art_i = 0, $art_cwvppykhk$art_c = menus.length; $art_ieqdezu$art_i < $art_cwvppykhk$art_c; $art_ieqdezu$art_i++) {
        var item = menus[$art_ieqdezu$art_i];
