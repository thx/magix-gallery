...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irnmyppfbscf$art_i = 0, $art_cdqenjjqf$art_c = menus.length; $art_irnmyppfbscf$art_i < $art_cdqenjjqf$art_c; $art_irnmyppfbscf$art_i++) {    var item = menus[$art_irnmyppfbscf$art_i]%>';
    for (var $art_irnmyppfbscf$art_i = 0, $art_cdqenjjqf$art_c = menus.length; $art_irnmyppfbscf$art_i < $art_cdqenjjqf$art_c; $art_irnmyppfbscf$art_i++) {
        var item = menus[$art_irnmyppfbscf$art_i];
