...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irnqchplqy$art_i = 0, $art_cletedfnp$art_c = menus.length; $art_irnqchplqy$art_i < $art_cletedfnp$art_c; $art_irnqchplqy$art_i++) {    var item = menus[$art_irnqchplqy$art_i]%>';
    for (var $art_irnqchplqy$art_i = 0, $art_cletedfnp$art_c = menus.length; $art_irnqchplqy$art_i < $art_cletedfnp$art_c; $art_irnqchplqy$art_i++) {
        var item = menus[$art_irnqchplqy$art_i];
