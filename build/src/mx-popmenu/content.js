...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikcuvvrnv$art_i = 0, $art_cvjcgckr$art_c = menus.length; $art_ikcuvvrnv$art_i < $art_cvjcgckr$art_c; $art_ikcuvvrnv$art_i++) {    var item = menus[$art_ikcuvvrnv$art_i]%>';
    for (var $art_ikcuvvrnv$art_i = 0, $art_cvjcgckr$art_c = menus.length; $art_ikcuvvrnv$art_i < $art_cvjcgckr$art_c; $art_ikcuvvrnv$art_i++) {
        var item = menus[$art_ikcuvvrnv$art_i];
