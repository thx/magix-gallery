...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idpadgmwh$art_i = 0, $art_cnqzurm$art_c = menus.length; $art_idpadgmwh$art_i < $art_cnqzurm$art_c; $art_idpadgmwh$art_i++) {    var item = menus[$art_idpadgmwh$art_i]%>';
    for (var $art_idpadgmwh$art_i = 0, $art_cnqzurm$art_c = menus.length; $art_idpadgmwh$art_i < $art_cnqzurm$art_c; $art_idpadgmwh$art_i++) {
        var item = menus[$art_idpadgmwh$art_i];
