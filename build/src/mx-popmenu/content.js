...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikkihnwh$art_i = 0, $art_ctvtteddahpd$art_c = menus.length; $art_ikkihnwh$art_i < $art_ctvtteddahpd$art_c; $art_ikkihnwh$art_i++) {    var item = menus[$art_ikkihnwh$art_i]%>';
    for (var $art_ikkihnwh$art_i = 0, $art_ctvtteddahpd$art_c = menus.length; $art_ikkihnwh$art_i < $art_ctvtteddahpd$art_c; $art_ikkihnwh$art_i++) {
        var item = menus[$art_ikkihnwh$art_i];
