...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imykvqj$art_i = 0, $art_czxqgnzssz$art_c = menus.length; $art_imykvqj$art_i < $art_czxqgnzssz$art_c; $art_imykvqj$art_i++) {    var item = menus[$art_imykvqj$art_i]%>';
    for (var $art_imykvqj$art_i = 0, $art_czxqgnzssz$art_c = menus.length; $art_imykvqj$art_i < $art_czxqgnzssz$art_c; $art_imykvqj$art_i++) {
        var item = menus[$art_imykvqj$art_i];
