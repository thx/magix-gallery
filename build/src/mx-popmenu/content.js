...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_istmbubeue$art_i = 0, $art_cxlbhsbvo$art_c = menus.length; $art_istmbubeue$art_i < $art_cxlbhsbvo$art_c; $art_istmbubeue$art_i++) {    var item = menus[$art_istmbubeue$art_i]%>';
    for (var $art_istmbubeue$art_i = 0, $art_cxlbhsbvo$art_c = menus.length; $art_istmbubeue$art_i < $art_cxlbhsbvo$art_c; $art_istmbubeue$art_i++) {
        var item = menus[$art_istmbubeue$art_i];
