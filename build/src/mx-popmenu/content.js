...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiqwdpc$art_i = 0, $art_cynuwrdrcdd$art_c = menus.length; $art_iiqwdpc$art_i < $art_cynuwrdrcdd$art_c; $art_iiqwdpc$art_i++) {    var item = menus[$art_iiqwdpc$art_i]%>';
    for (var $art_iiqwdpc$art_i = 0, $art_cynuwrdrcdd$art_c = menus.length; $art_iiqwdpc$art_i < $art_cynuwrdrcdd$art_c; $art_iiqwdpc$art_i++) {
        var item = menus[$art_iiqwdpc$art_i];
