...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idyoaeka$art_i = 0, $art_clcomgryer$art_c = menus.length; $art_idyoaeka$art_i < $art_clcomgryer$art_c; $art_idyoaeka$art_i++) {    var item = menus[$art_idyoaeka$art_i]%>';
    for (var $art_idyoaeka$art_i = 0, $art_clcomgryer$art_c = menus.length; $art_idyoaeka$art_i < $art_clcomgryer$art_c; $art_idyoaeka$art_i++) {
        var item = menus[$art_idyoaeka$art_i];
