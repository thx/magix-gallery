...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioabfczgswyq$art_i = 0, $art_cesmuwpod$art_c = menus.length; $art_ioabfczgswyq$art_i < $art_cesmuwpod$art_c; $art_ioabfczgswyq$art_i++) {    var item = menus[$art_ioabfczgswyq$art_i]%>';
    for (var $art_ioabfczgswyq$art_i = 0, $art_cesmuwpod$art_c = menus.length; $art_ioabfczgswyq$art_i < $art_cesmuwpod$art_c; $art_ioabfczgswyq$art_i++) {
        var item = menus[$art_ioabfczgswyq$art_i];
