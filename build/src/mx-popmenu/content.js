...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwpyvkmsc$art_i = 0, $art_cwfwytnpb$art_c = menus.length; $art_iwpyvkmsc$art_i < $art_cwfwytnpb$art_c; $art_iwpyvkmsc$art_i++) {    var item = menus[$art_iwpyvkmsc$art_i]%>';
    for (var $art_iwpyvkmsc$art_i = 0, $art_cwfwytnpb$art_c = menus.length; $art_iwpyvkmsc$art_i < $art_cwfwytnpb$art_c; $art_iwpyvkmsc$art_i++) {
        var item = menus[$art_iwpyvkmsc$art_i];
