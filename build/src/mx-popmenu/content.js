...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iypzusn$art_i = 0, $art_cxzqwtw$art_c = menus.length; $art_iypzusn$art_i < $art_cxzqwtw$art_c; $art_iypzusn$art_i++) {    var item = menus[$art_iypzusn$art_i]%>';
    for (var $art_iypzusn$art_i = 0, $art_cxzqwtw$art_c = menus.length; $art_iypzusn$art_i < $art_cxzqwtw$art_c; $art_iypzusn$art_i++) {
        var item = menus[$art_iypzusn$art_i];
