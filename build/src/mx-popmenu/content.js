...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isjigdgc$art_i = 0, $art_cccmpkywghe$art_c = menus.length; $art_isjigdgc$art_i < $art_cccmpkywghe$art_c; $art_isjigdgc$art_i++) {    var item = menus[$art_isjigdgc$art_i]%>';
    for (var $art_isjigdgc$art_i = 0, $art_cccmpkywghe$art_c = menus.length; $art_isjigdgc$art_i < $art_cccmpkywghe$art_c; $art_isjigdgc$art_i++) {
        var item = menus[$art_isjigdgc$art_i];
