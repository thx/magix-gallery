...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iouimbm$art_i = 0, $art_chbegtp$art_c = menus.length; $art_iouimbm$art_i < $art_chbegtp$art_c; $art_iouimbm$art_i++) {    var item = menus[$art_iouimbm$art_i]%>';
    for (var $art_iouimbm$art_i = 0, $art_chbegtp$art_c = menus.length; $art_iouimbm$art_i < $art_chbegtp$art_c; $art_iouimbm$art_i++) {
        var item = menus[$art_iouimbm$art_i];
