...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaigtkhxwtw$art_i = 0, $art_cqgojwnaa$art_c = menus.length; $art_iaigtkhxwtw$art_i < $art_cqgojwnaa$art_c; $art_iaigtkhxwtw$art_i++) {    var item = menus[$art_iaigtkhxwtw$art_i]%>';
    for (var $art_iaigtkhxwtw$art_i = 0, $art_cqgojwnaa$art_c = menus.length; $art_iaigtkhxwtw$art_i < $art_cqgojwnaa$art_c; $art_iaigtkhxwtw$art_i++) {
        var item = menus[$art_iaigtkhxwtw$art_i];
