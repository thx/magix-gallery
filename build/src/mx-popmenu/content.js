...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivavtdcltb$art_i = 0, $art_ckwwmgh$art_c = menus.length; $art_ivavtdcltb$art_i < $art_ckwwmgh$art_c; $art_ivavtdcltb$art_i++) {    var item = menus[$art_ivavtdcltb$art_i]%>';
    for (var $art_ivavtdcltb$art_i = 0, $art_ckwwmgh$art_c = menus.length; $art_ivavtdcltb$art_i < $art_ckwwmgh$art_c; $art_ivavtdcltb$art_i++) {
        var item = menus[$art_ivavtdcltb$art_i];
