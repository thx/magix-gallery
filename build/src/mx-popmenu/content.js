...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iidsnjxhqwh$art_i = 0, $art_cdkhavsxx$art_c = menus.length; $art_iidsnjxhqwh$art_i < $art_cdkhavsxx$art_c; $art_iidsnjxhqwh$art_i++) {    var item = menus[$art_iidsnjxhqwh$art_i]%>';
    for (var $art_iidsnjxhqwh$art_i = 0, $art_cdkhavsxx$art_c = menus.length; $art_iidsnjxhqwh$art_i < $art_cdkhavsxx$art_c; $art_iidsnjxhqwh$art_i++) {
        var item = menus[$art_iidsnjxhqwh$art_i];
