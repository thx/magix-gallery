...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifjcfxrrqo$art_i = 0, $art_ccmrkcftam$art_c = menus.length; $art_ifjcfxrrqo$art_i < $art_ccmrkcftam$art_c; $art_ifjcfxrrqo$art_i++) {    var item = menus[$art_ifjcfxrrqo$art_i]%>';
    for (var $art_ifjcfxrrqo$art_i = 0, $art_ccmrkcftam$art_c = menus.length; $art_ifjcfxrrqo$art_i < $art_ccmrkcftam$art_c; $art_ifjcfxrrqo$art_i++) {
        var item = menus[$art_ifjcfxrrqo$art_i];
