...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivulzdjn$art_i = 0, $art_clrwgtar$art_c = menus.length; $art_ivulzdjn$art_i < $art_clrwgtar$art_c; $art_ivulzdjn$art_i++) {    var item = menus[$art_ivulzdjn$art_i]%>';
    for (var $art_ivulzdjn$art_i = 0, $art_clrwgtar$art_c = menus.length; $art_ivulzdjn$art_i < $art_clrwgtar$art_c; $art_ivulzdjn$art_i++) {
        var item = menus[$art_ivulzdjn$art_i];
