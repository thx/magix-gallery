...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icltijxlna$art_i = 0, $art_cixnkoju$art_c = menus.length; $art_icltijxlna$art_i < $art_cixnkoju$art_c; $art_icltijxlna$art_i++) {    var item = menus[$art_icltijxlna$art_i]%>';
    for (var $art_icltijxlna$art_i = 0, $art_cixnkoju$art_c = menus.length; $art_icltijxlna$art_i < $art_cixnkoju$art_c; $art_icltijxlna$art_i++) {
        var item = menus[$art_icltijxlna$art_i];
