...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idozvsuhl$art_i = 0, $art_cbackwcnh$art_c = menus.length; $art_idozvsuhl$art_i < $art_cbackwcnh$art_c; $art_idozvsuhl$art_i++) {    var item = menus[$art_idozvsuhl$art_i]%>';
    for (var $art_idozvsuhl$art_i = 0, $art_cbackwcnh$art_c = menus.length; $art_idozvsuhl$art_i < $art_cbackwcnh$art_c; $art_idozvsuhl$art_i++) {
        var item = menus[$art_idozvsuhl$art_i];
