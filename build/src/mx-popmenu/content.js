...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqnjypb$art_i = 0, $art_cgspuqmqrlg$art_c = menus.length; $art_iqnjypb$art_i < $art_cgspuqmqrlg$art_c; $art_iqnjypb$art_i++) {    var item = menus[$art_iqnjypb$art_i]%>';
    for (var $art_iqnjypb$art_i = 0, $art_cgspuqmqrlg$art_c = menus.length; $art_iqnjypb$art_i < $art_cgspuqmqrlg$art_c; $art_iqnjypb$art_i++) {
        var item = menus[$art_iqnjypb$art_i];
