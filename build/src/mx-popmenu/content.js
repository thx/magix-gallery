...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idkctqc$art_i = 0, $art_clssnnelvv$art_c = menus.length; $art_idkctqc$art_i < $art_clssnnelvv$art_c; $art_idkctqc$art_i++) {    var item = menus[$art_idkctqc$art_i]%>';
    for (var $art_idkctqc$art_i = 0, $art_clssnnelvv$art_c = menus.length; $art_idkctqc$art_i < $art_clssnnelvv$art_c; $art_idkctqc$art_i++) {
        var item = menus[$art_idkctqc$art_i];
