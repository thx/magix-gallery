...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqazrgyid$art_i = 0, $art_cmbonexlrr$art_c = menus.length; $art_iqazrgyid$art_i < $art_cmbonexlrr$art_c; $art_iqazrgyid$art_i++) {    var item = menus[$art_iqazrgyid$art_i]%>';
    for (var $art_iqazrgyid$art_i = 0, $art_cmbonexlrr$art_c = menus.length; $art_iqazrgyid$art_i < $art_cmbonexlrr$art_c; $art_iqazrgyid$art_i++) {
        var item = menus[$art_iqazrgyid$art_i];
