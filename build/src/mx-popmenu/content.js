...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ietblkyyre$art_i = 0, $art_ccfruumy$art_c = menus.length; $art_ietblkyyre$art_i < $art_ccfruumy$art_c; $art_ietblkyyre$art_i++) {    var item = menus[$art_ietblkyyre$art_i]%>';
    for (var $art_ietblkyyre$art_i = 0, $art_ccfruumy$art_c = menus.length; $art_ietblkyyre$art_i < $art_ccfruumy$art_c; $art_ietblkyyre$art_i++) {
        var item = menus[$art_ietblkyyre$art_i];
