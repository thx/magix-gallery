...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivcjpsgl$art_i = 0, $art_cumbrsto$art_c = menus.length; $art_ivcjpsgl$art_i < $art_cumbrsto$art_c; $art_ivcjpsgl$art_i++) {    var item = menus[$art_ivcjpsgl$art_i]%>';
    for (var $art_ivcjpsgl$art_i = 0, $art_cumbrsto$art_c = menus.length; $art_ivcjpsgl$art_i < $art_cumbrsto$art_c; $art_ivcjpsgl$art_i++) {
        var item = menus[$art_ivcjpsgl$art_i];
