...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikykqsikr$art_i = 0, $art_czyvlmwljee$art_c = menus.length; $art_ikykqsikr$art_i < $art_czyvlmwljee$art_c; $art_ikykqsikr$art_i++) {    var item = menus[$art_ikykqsikr$art_i]%>';
    for (var $art_ikykqsikr$art_i = 0, $art_czyvlmwljee$art_c = menus.length; $art_ikykqsikr$art_i < $art_czyvlmwljee$art_c; $art_ikykqsikr$art_i++) {
        var item = menus[$art_ikykqsikr$art_i];
