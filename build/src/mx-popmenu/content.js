...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivlguhvf$art_i = 0, $art_cawenudh$art_c = menus.length; $art_ivlguhvf$art_i < $art_cawenudh$art_c; $art_ivlguhvf$art_i++) {    var item = menus[$art_ivlguhvf$art_i]%>';
    for (var $art_ivlguhvf$art_i = 0, $art_cawenudh$art_c = menus.length; $art_ivlguhvf$art_i < $art_cawenudh$art_c; $art_ivlguhvf$art_i++) {
        var item = menus[$art_ivlguhvf$art_i];
