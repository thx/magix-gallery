...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuhkkwmip$art_i = 0, $art_crfxczjnc$art_c = menus.length; $art_iuhkkwmip$art_i < $art_crfxczjnc$art_c; $art_iuhkkwmip$art_i++) {    var item = menus[$art_iuhkkwmip$art_i]%>';
    for (var $art_iuhkkwmip$art_i = 0, $art_crfxczjnc$art_c = menus.length; $art_iuhkkwmip$art_i < $art_crfxczjnc$art_c; $art_iuhkkwmip$art_i++) {
        var item = menus[$art_iuhkkwmip$art_i];
