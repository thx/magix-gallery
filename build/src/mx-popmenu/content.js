...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikswfem$art_i = 0, $art_cllzpyy$art_c = menus.length; $art_ikswfem$art_i < $art_cllzpyy$art_c; $art_ikswfem$art_i++) {    var item = menus[$art_ikswfem$art_i]%>';
    for (var $art_ikswfem$art_i = 0, $art_cllzpyy$art_c = menus.length; $art_ikswfem$art_i < $art_cllzpyy$art_c; $art_ikswfem$art_i++) {
        var item = menus[$art_ikswfem$art_i];
