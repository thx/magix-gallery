...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixfqndvhs$art_i = 0, $art_cdfjumrcir$art_c = stepInfos.length; $art_ixfqndvhs$art_i < $art_cdfjumrcir$art_c; $art_ixfqndvhs$art_i++) {    var step = stepInfos[$art_ixfqndvhs$art_i]%>';
    for (var $art_ixfqndvhs$art_i = 0, $art_cdfjumrcir$art_c = stepInfos.length; $art_ixfqndvhs$art_i < $art_cdfjumrcir$art_c; $art_ixfqndvhs$art_i++) {
        var step = stepInfos[$art_ixfqndvhs$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_idtgugk$art_i = 0, $art_objqeixwzd$art_obj = step.subs, $art_cuxdfwme$art_c = $art_objqeixwzd$art_obj.length; $art_idtgugk$art_i < $art_cuxdfwme$art_c; $art_idtgugk$art_i++) {            var sub = $art_objqeixwzd$art_obj[$art_idtgugk$art_i]%>';
            for (var $art_idtgugk$art_i = 0, $art_objqeixwzd$art_obj = step.subs, $art_cuxdfwme$art_c = $art_objqeixwzd$art_obj.length; $art_idtgugk$art_i < $art_cuxdfwme$art_c; $art_idtgugk$art_i++) {
                var sub = $art_objqeixwzd$art_obj[$art_idtgugk$art_i];
    ...
    ;
    $expr = '<%for (var $art_iurolxyga$art_i = 0, $art_objtqwqvv$art_obj = curStepInfo.subs, $art_cziwfjaw$art_c = $art_objtqwqvv$art_obj.length; $art_iurolxyga$art_i < $art_cziwfjaw$art_c; $art_iurolxyga$art_i++) {    var sub = $art_objtqwqvv$art_obj[$art_iurolxyga$art_i]%>';
    for (var $art_iurolxyga$art_i = 0, $art_objtqwqvv$art_obj = curStepInfo.subs, $art_cziwfjaw$art_c = $art_objtqwqvv$art_obj.length; $art_iurolxyga$art_i < $art_cziwfjaw$art_c; $art_iurolxyga$art_i++) {
        var sub = $art_objtqwqvv$art_obj[$art_iurolxyga$art_i];
