...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isnzsgljxm$art_i = 0, $art_cwsruzqh$art_c = stepInfos.length; $art_isnzsgljxm$art_i < $art_cwsruzqh$art_c; $art_isnzsgljxm$art_i++) {    var step = stepInfos[$art_isnzsgljxm$art_i]%>';
    for (var $art_isnzsgljxm$art_i = 0, $art_cwsruzqh$art_c = stepInfos.length; $art_isnzsgljxm$art_i < $art_cwsruzqh$art_c; $art_isnzsgljxm$art_i++) {
        var step = stepInfos[$art_isnzsgljxm$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iimqontn$art_i = 0, $art_objqviaqx$art_obj = step.subs, $art_ckymtjye$art_c = $art_objqviaqx$art_obj.length; $art_iimqontn$art_i < $art_ckymtjye$art_c; $art_iimqontn$art_i++) {            var sub = $art_objqviaqx$art_obj[$art_iimqontn$art_i]%>';
            for (var $art_iimqontn$art_i = 0, $art_objqviaqx$art_obj = step.subs, $art_ckymtjye$art_c = $art_objqviaqx$art_obj.length; $art_iimqontn$art_i < $art_ckymtjye$art_c; $art_iimqontn$art_i++) {
                var sub = $art_objqviaqx$art_obj[$art_iimqontn$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibfluyfwfe$art_i = 0, $art_objzfyilsb$art_obj = curStepInfo.subs, $art_cqhocobpf$art_c = $art_objzfyilsb$art_obj.length; $art_ibfluyfwfe$art_i < $art_cqhocobpf$art_c; $art_ibfluyfwfe$art_i++) {    var sub = $art_objzfyilsb$art_obj[$art_ibfluyfwfe$art_i]%>';
    for (var $art_ibfluyfwfe$art_i = 0, $art_objzfyilsb$art_obj = curStepInfo.subs, $art_cqhocobpf$art_c = $art_objzfyilsb$art_obj.length; $art_ibfluyfwfe$art_i < $art_cqhocobpf$art_c; $art_ibfluyfwfe$art_i++) {
        var sub = $art_objzfyilsb$art_obj[$art_ibfluyfwfe$art_i];
