...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iegsaxar$art_i = 0, $art_cqbycm$art_c = stepInfos.length; $art_iegsaxar$art_i < $art_cqbycm$art_c; $art_iegsaxar$art_i++) {    var step = stepInfos[$art_iegsaxar$art_i]%>';
    for (var $art_iegsaxar$art_i = 0, $art_cqbycm$art_c = stepInfos.length; $art_iegsaxar$art_i < $art_cqbycm$art_c; $art_iegsaxar$art_i++) {
        var step = stepInfos[$art_iegsaxar$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ihrxkzkh$art_i = 0, $art_objtnwhydp$art_obj = step.subs, $art_ciyuukc$art_c = $art_objtnwhydp$art_obj.length; $art_ihrxkzkh$art_i < $art_ciyuukc$art_c; $art_ihrxkzkh$art_i++) {            var sub = $art_objtnwhydp$art_obj[$art_ihrxkzkh$art_i]%>';
            for (var $art_ihrxkzkh$art_i = 0, $art_objtnwhydp$art_obj = step.subs, $art_ciyuukc$art_c = $art_objtnwhydp$art_obj.length; $art_ihrxkzkh$art_i < $art_ciyuukc$art_c; $art_ihrxkzkh$art_i++) {
                var sub = $art_objtnwhydp$art_obj[$art_ihrxkzkh$art_i];
    ...
    ;
    $expr = '<%for (var $art_icxpeauzmk$art_i = 0, $art_objjhxwxevwv$art_obj = curStepInfo.subs, $art_cbgrtrpl$art_c = $art_objjhxwxevwv$art_obj.length; $art_icxpeauzmk$art_i < $art_cbgrtrpl$art_c; $art_icxpeauzmk$art_i++) {    var sub = $art_objjhxwxevwv$art_obj[$art_icxpeauzmk$art_i]%>';
    for (var $art_icxpeauzmk$art_i = 0, $art_objjhxwxevwv$art_obj = curStepInfo.subs, $art_cbgrtrpl$art_c = $art_objjhxwxevwv$art_obj.length; $art_icxpeauzmk$art_i < $art_cbgrtrpl$art_c; $art_icxpeauzmk$art_i++) {
        var sub = $art_objjhxwxevwv$art_obj[$art_icxpeauzmk$art_i];
