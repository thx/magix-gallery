...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqudeaoyar$art_i = 0, $art_cefkmsmzl$art_c = stepInfos.length; $art_iqudeaoyar$art_i < $art_cefkmsmzl$art_c; $art_iqudeaoyar$art_i++) {    var step = stepInfos[$art_iqudeaoyar$art_i]%>';
    for (var $art_iqudeaoyar$art_i = 0, $art_cefkmsmzl$art_c = stepInfos.length; $art_iqudeaoyar$art_i < $art_cefkmsmzl$art_c; $art_iqudeaoyar$art_i++) {
        var step = stepInfos[$art_iqudeaoyar$art_i];
        ...
        ;
        $p += '"><div mxa="_zs_gallerycz:_" class="_zs_gallery_mx-main_index_-step-over"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link _zs_gallery_mx-main_index_-step-over clearfix ';
        $line = 6;
        ...
        if (step.icon) {
            ;
            $p += '<span mxa="_zs_gallerycz:a" class="_zs_gallery_mx-main_index_-over-icon fl">';
            $line = 10;
            $art = '!step.icon';
            ;
        ...
        ;
        $p += '<span mxa="_zs_gallerycz:b" class="fl">';
        $line = 12;
        $art = '=step.label';
        ;
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_itpffwxdrqf$art_i = 0, $art_objhzqbmduizs$art_obj = step.subs, $art_ciljcfce$art_c = $art_objhzqbmduizs$art_obj.length; $art_itpffwxdrqf$art_i < $art_ciljcfce$art_c; $art_itpffwxdrqf$art_i++) {            var sub = $art_objhzqbmduizs$art_obj[$art_itpffwxdrqf$art_i]%>';
            for (var $art_itpffwxdrqf$art_i = 0, $art_objhzqbmduizs$art_obj = step.subs, $art_ciljcfce$art_c = $art_objhzqbmduizs$art_obj.length; $art_itpffwxdrqf$art_i < $art_ciljcfce$art_c; $art_itpffwxdrqf$art_i++) {
                var sub = $art_objhzqbmduizs$art_obj[$art_itpffwxdrqf$art_i];
                $p += '<div mxa="_zs_gallerycz:c" class="_zs_gallery_mx-main_index_-step-sub"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link ';
                $line = 19;
        ...
        if (step.index == curStepIndex) {
            ;
            $p += '<i mxs="_zs_gallerycz:_" class="mc-iconfont _zs_gallery_mx-main_index_-arrow-icon">&#xe602;</i>';
            $line = 30;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        if (step.locked) {
            ;
            $p += '<i mxs="_zs_gallerycz:a" class="mc-iconfont _zs_gallery_mx-main_index_-locked-icon">&#xe759;</i>';
            $line = 33;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    $art = '=leftWidth';
    ;
    $p += ($expr = '<%=leftWidth%>', $e(leftWidth)) + 'px;"><div mxa="_zs_gallerycz:d" class="_zs_gallery_mx-main_index_-content-title">';
    $line = 38;
    $art = '=curStepInfo.label';
    ;
    $p += ($expr = '<%=curStepInfo.label%>', $e(curStepInfo.label)) + '</div><div mxv mxa="_zs_gallerycz:e" class="_zs_gallery_mx-main_index_-content-body"><div mxv>';
    $line = 42;
    $art = 'each curStepInfo.subs as sub';
    ;
    $expr = '<%for (var $art_iglxzxzyf$art_i = 0, $art_objrneenm$art_obj = curStepInfo.subs, $art_clsjnaifi$art_c = $art_objrneenm$art_obj.length; $art_iglxzxzyf$art_i < $art_clsjnaifi$art_c; $art_iglxzxzyf$art_i++) {    var sub = $art_objrneenm$art_obj[$art_iglxzxzyf$art_i]%>';
    for (var $art_iglxzxzyf$art_i = 0, $art_objrneenm$art_obj = curStepInfo.subs, $art_clsjnaifi$art_c = $art_objrneenm$art_obj.length; $art_iglxzxzyf$art_i < $art_clsjnaifi$art_c; $art_iglxzxzyf$art_i++) {
        var sub = $art_objrneenm$art_obj[$art_iglxzxzyf$art_i];
        ...
        $art = '=sub.index';
        ;
        $p += ($expr = '<%=sub.index%>', $e(sub.index)) + '"><div mxs="_zs_gallerycz:b" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
        $line = 49;
        ...
        if (sub.sideWrapper) {
            ...
            ;
            $p += ($expr = '<%=curStepInfo.rightWidth%>', $e(curStepInfo.rightWidth)) + 'px;"><div mxs="_zs_gallerycz:b" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
            $line = 54;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    if (!curStepInfo.customTrigger) {
        ;
        $p += '<div mxa="_zs_gallerycz:f" class="_zs_gallery_mx-main_index_-content-footer"><div>';
        $line = 69;
        ...
        if (curStepInfo.prevTip) {
            ;
            $p += '<a mxa="_zs_gallerycz:g" href="javascript:;" class="btn min-width-100 mr20" mx-click="' + $viewId + 'prev()">';
            $line = 71;
        ...
        if (curStepInfo.nextTip) {
            ;
            $p += '<a mxa="_zs_gallerycz:h" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
            $line = 76;
