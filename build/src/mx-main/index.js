...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igiiytsju$art_i = 0, $art_cnfxcexia$art_c = stepInfos.length; $art_igiiytsju$art_i < $art_cnfxcexia$art_c; $art_igiiytsju$art_i++) {    var step = stepInfos[$art_igiiytsju$art_i]%>';
    for (var $art_igiiytsju$art_i = 0, $art_cnfxcexia$art_c = stepInfos.length; $art_igiiytsju$art_i < $art_cnfxcexia$art_c; $art_igiiytsju$art_i++) {
        var step = stepInfos[$art_igiiytsju$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ihspf$art_i = 0, $art_objbigtflqiaw$art_obj = step.subs, $art_cszykryipx$art_c = $art_objbigtflqiaw$art_obj.length; $art_ihspf$art_i < $art_cszykryipx$art_c; $art_ihspf$art_i++) {            var sub = $art_objbigtflqiaw$art_obj[$art_ihspf$art_i]%>';
            for (var $art_ihspf$art_i = 0, $art_objbigtflqiaw$art_obj = step.subs, $art_cszykryipx$art_c = $art_objbigtflqiaw$art_obj.length; $art_ihspf$art_i < $art_cszykryipx$art_c; $art_ihspf$art_i++) {
                var sub = $art_objbigtflqiaw$art_obj[$art_ihspf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifglssvnonyc$art_i = 0, $art_objersnsqcrk$art_obj = curStepInfo.subs, $art_crhepvuzo$art_c = $art_objersnsqcrk$art_obj.length; $art_ifglssvnonyc$art_i < $art_crhepvuzo$art_c; $art_ifglssvnonyc$art_i++) {    var sub = $art_objersnsqcrk$art_obj[$art_ifglssvnonyc$art_i]%>';
    for (var $art_ifglssvnonyc$art_i = 0, $art_objersnsqcrk$art_obj = curStepInfo.subs, $art_crhepvuzo$art_c = $art_objersnsqcrk$art_obj.length; $art_ifglssvnonyc$art_i < $art_crhepvuzo$art_c; $art_ifglssvnonyc$art_i++) {
        var sub = $art_objersnsqcrk$art_obj[$art_ifglssvnonyc$art_i];
