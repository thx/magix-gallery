...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idrammmfj$art_i = 0, $art_cbjfdgviz$art_c = stepInfos.length; $art_idrammmfj$art_i < $art_cbjfdgviz$art_c; $art_idrammmfj$art_i++) {    var step = stepInfos[$art_idrammmfj$art_i]%>';
    for (var $art_idrammmfj$art_i = 0, $art_cbjfdgviz$art_c = stepInfos.length; $art_idrammmfj$art_i < $art_cbjfdgviz$art_c; $art_idrammmfj$art_i++) {
        var step = stepInfos[$art_idrammmfj$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iljudyhlsbr$art_i = 0, $art_objyeuwokdis$art_obj = step.subs, $art_cquozizol$art_c = $art_objyeuwokdis$art_obj.length; $art_iljudyhlsbr$art_i < $art_cquozizol$art_c; $art_iljudyhlsbr$art_i++) {            var sub = $art_objyeuwokdis$art_obj[$art_iljudyhlsbr$art_i]%>';
            for (var $art_iljudyhlsbr$art_i = 0, $art_objyeuwokdis$art_obj = step.subs, $art_cquozizol$art_c = $art_objyeuwokdis$art_obj.length; $art_iljudyhlsbr$art_i < $art_cquozizol$art_c; $art_iljudyhlsbr$art_i++) {
                var sub = $art_objyeuwokdis$art_obj[$art_iljudyhlsbr$art_i];
    ...
    ;
    $expr = '<%for (var $art_iobzowejdiq$art_i = 0, $art_objggohsmgi$art_obj = curStepInfo.subs, $art_chljybhaksw$art_c = $art_objggohsmgi$art_obj.length; $art_iobzowejdiq$art_i < $art_chljybhaksw$art_c; $art_iobzowejdiq$art_i++) {    var sub = $art_objggohsmgi$art_obj[$art_iobzowejdiq$art_i]%>';
    for (var $art_iobzowejdiq$art_i = 0, $art_objggohsmgi$art_obj = curStepInfo.subs, $art_chljybhaksw$art_c = $art_objggohsmgi$art_obj.length; $art_iobzowejdiq$art_i < $art_chljybhaksw$art_c; $art_iobzowejdiq$art_i++) {
        var sub = $art_objggohsmgi$art_obj[$art_iobzowejdiq$art_i];
