...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izfowvoiho$art_i = 0, $art_cltynghli$art_c = stepInfos.length; $art_izfowvoiho$art_i < $art_cltynghli$art_c; $art_izfowvoiho$art_i++) {    var step = stepInfos[$art_izfowvoiho$art_i]%>';
    for (var $art_izfowvoiho$art_i = 0, $art_cltynghli$art_c = stepInfos.length; $art_izfowvoiho$art_i < $art_cltynghli$art_c; $art_izfowvoiho$art_i++) {
        var step = stepInfos[$art_izfowvoiho$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_igaqzfglrrk$art_i = 0, $art_objffapqd$art_obj = step.subs, $art_cjnxgqfqyua$art_c = $art_objffapqd$art_obj.length; $art_igaqzfglrrk$art_i < $art_cjnxgqfqyua$art_c; $art_igaqzfglrrk$art_i++) {            var sub = $art_objffapqd$art_obj[$art_igaqzfglrrk$art_i]%>';
            for (var $art_igaqzfglrrk$art_i = 0, $art_objffapqd$art_obj = step.subs, $art_cjnxgqfqyua$art_c = $art_objffapqd$art_obj.length; $art_igaqzfglrrk$art_i < $art_cjnxgqfqyua$art_c; $art_igaqzfglrrk$art_i++) {
                var sub = $art_objffapqd$art_obj[$art_igaqzfglrrk$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivjnoytx$art_i = 0, $art_objobyzhro$art_obj = curStepInfo.subs, $art_cecrtcrc$art_c = $art_objobyzhro$art_obj.length; $art_ivjnoytx$art_i < $art_cecrtcrc$art_c; $art_ivjnoytx$art_i++) {    var sub = $art_objobyzhro$art_obj[$art_ivjnoytx$art_i]%>';
    for (var $art_ivjnoytx$art_i = 0, $art_objobyzhro$art_obj = curStepInfo.subs, $art_cecrtcrc$art_c = $art_objobyzhro$art_obj.length; $art_ivjnoytx$art_i < $art_cecrtcrc$art_c; $art_ivjnoytx$art_i++) {
        var sub = $art_objobyzhro$art_obj[$art_ivjnoytx$art_i];
