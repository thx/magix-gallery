...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itywvlh$art_i = 0, $art_ctxkfdit$art_c = stepInfos.length; $art_itywvlh$art_i < $art_ctxkfdit$art_c; $art_itywvlh$art_i++) {    var step = stepInfos[$art_itywvlh$art_i]%>';
    for (var $art_itywvlh$art_i = 0, $art_ctxkfdit$art_c = stepInfos.length; $art_itywvlh$art_i < $art_ctxkfdit$art_c; $art_itywvlh$art_i++) {
        var step = stepInfos[$art_itywvlh$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_indcmymdvi$art_i = 0, $art_objyhuovudvpm$art_obj = step.subs, $art_cffjrr$art_c = $art_objyhuovudvpm$art_obj.length; $art_indcmymdvi$art_i < $art_cffjrr$art_c; $art_indcmymdvi$art_i++) {            var sub = $art_objyhuovudvpm$art_obj[$art_indcmymdvi$art_i]%>';
            for (var $art_indcmymdvi$art_i = 0, $art_objyhuovudvpm$art_obj = step.subs, $art_cffjrr$art_c = $art_objyhuovudvpm$art_obj.length; $art_indcmymdvi$art_i < $art_cffjrr$art_c; $art_indcmymdvi$art_i++) {
                var sub = $art_objyhuovudvpm$art_obj[$art_indcmymdvi$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifknqqbm$art_i = 0, $art_objajwmeavwdn$art_obj = curStepInfo.subs, $art_cvotuowqu$art_c = $art_objajwmeavwdn$art_obj.length; $art_ifknqqbm$art_i < $art_cvotuowqu$art_c; $art_ifknqqbm$art_i++) {    var sub = $art_objajwmeavwdn$art_obj[$art_ifknqqbm$art_i]%>';
    for (var $art_ifknqqbm$art_i = 0, $art_objajwmeavwdn$art_obj = curStepInfo.subs, $art_cvotuowqu$art_c = $art_objajwmeavwdn$art_obj.length; $art_ifknqqbm$art_i < $art_cvotuowqu$art_c; $art_ifknqqbm$art_i++) {
        var sub = $art_objajwmeavwdn$art_obj[$art_ifknqqbm$art_i];
