...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifwtbqd$art_i = 0, $art_cvjdyvfw$art_c = stepInfos.length; $art_ifwtbqd$art_i < $art_cvjdyvfw$art_c; $art_ifwtbqd$art_i++) {    var step = stepInfos[$art_ifwtbqd$art_i]%>';
    for (var $art_ifwtbqd$art_i = 0, $art_cvjdyvfw$art_c = stepInfos.length; $art_ifwtbqd$art_i < $art_cvjdyvfw$art_c; $art_ifwtbqd$art_i++) {
        var step = stepInfos[$art_ifwtbqd$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_isnxadsxub$art_i = 0, $art_objlcypyzjgr$art_obj = step.subs, $art_caiemuxo$art_c = $art_objlcypyzjgr$art_obj.length; $art_isnxadsxub$art_i < $art_caiemuxo$art_c; $art_isnxadsxub$art_i++) {            var sub = $art_objlcypyzjgr$art_obj[$art_isnxadsxub$art_i]%>';
            for (var $art_isnxadsxub$art_i = 0, $art_objlcypyzjgr$art_obj = step.subs, $art_caiemuxo$art_c = $art_objlcypyzjgr$art_obj.length; $art_isnxadsxub$art_i < $art_caiemuxo$art_c; $art_isnxadsxub$art_i++) {
                var sub = $art_objlcypyzjgr$art_obj[$art_isnxadsxub$art_i];
    ...
    ;
    $expr = '<%for (var $art_iakwbsgu$art_i = 0, $art_objrhheeooef$art_obj = curStepInfo.subs, $art_cbnmwukkd$art_c = $art_objrhheeooef$art_obj.length; $art_iakwbsgu$art_i < $art_cbnmwukkd$art_c; $art_iakwbsgu$art_i++) {    var sub = $art_objrhheeooef$art_obj[$art_iakwbsgu$art_i]%>';
    for (var $art_iakwbsgu$art_i = 0, $art_objrhheeooef$art_obj = curStepInfo.subs, $art_cbnmwukkd$art_c = $art_objrhheeooef$art_obj.length; $art_iakwbsgu$art_i < $art_cbnmwukkd$art_c; $art_iakwbsgu$art_i++) {
        var sub = $art_objrhheeooef$art_obj[$art_iakwbsgu$art_i];
