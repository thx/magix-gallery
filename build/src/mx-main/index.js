...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icwijyg$art_i = 0, $art_cajwjbqmu$art_c = stepInfos.length; $art_icwijyg$art_i < $art_cajwjbqmu$art_c; $art_icwijyg$art_i++) {    var step = stepInfos[$art_icwijyg$art_i]%>';
    for (var $art_icwijyg$art_i = 0, $art_cajwjbqmu$art_c = stepInfos.length; $art_icwijyg$art_i < $art_cajwjbqmu$art_c; $art_icwijyg$art_i++) {
        var step = stepInfos[$art_icwijyg$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iucwxnwl$art_i = 0, $art_objsumgatfj$art_obj = step.subs, $art_crjldpis$art_c = $art_objsumgatfj$art_obj.length; $art_iucwxnwl$art_i < $art_crjldpis$art_c; $art_iucwxnwl$art_i++) {            var sub = $art_objsumgatfj$art_obj[$art_iucwxnwl$art_i]%>';
            for (var $art_iucwxnwl$art_i = 0, $art_objsumgatfj$art_obj = step.subs, $art_crjldpis$art_c = $art_objsumgatfj$art_obj.length; $art_iucwxnwl$art_i < $art_crjldpis$art_c; $art_iucwxnwl$art_i++) {
                var sub = $art_objsumgatfj$art_obj[$art_iucwxnwl$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifgcsts$art_i = 0, $art_objrtjegvo$art_obj = curStepInfo.subs, $art_ccwxfq$art_c = $art_objrtjegvo$art_obj.length; $art_ifgcsts$art_i < $art_ccwxfq$art_c; $art_ifgcsts$art_i++) {    var sub = $art_objrtjegvo$art_obj[$art_ifgcsts$art_i]%>';
    for (var $art_ifgcsts$art_i = 0, $art_objrtjegvo$art_obj = curStepInfo.subs, $art_ccwxfq$art_c = $art_objrtjegvo$art_obj.length; $art_ifgcsts$art_i < $art_ccwxfq$art_c; $art_ifgcsts$art_i++) {
        var sub = $art_objrtjegvo$art_obj[$art_ifgcsts$art_i];
