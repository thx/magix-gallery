...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iazoyixyi$art_i = 0, $art_cupwyffj$art_c = stepInfos.length; $art_iazoyixyi$art_i < $art_cupwyffj$art_c; $art_iazoyixyi$art_i++) {    var step = stepInfos[$art_iazoyixyi$art_i]%>';
    for (var $art_iazoyixyi$art_i = 0, $art_cupwyffj$art_c = stepInfos.length; $art_iazoyixyi$art_i < $art_cupwyffj$art_c; $art_iazoyixyi$art_i++) {
        var step = stepInfos[$art_iazoyixyi$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_idrmtpw$art_i = 0, $art_objagoudarm$art_obj = step.subs, $art_ctfhhooy$art_c = $art_objagoudarm$art_obj.length; $art_idrmtpw$art_i < $art_ctfhhooy$art_c; $art_idrmtpw$art_i++) {            var sub = $art_objagoudarm$art_obj[$art_idrmtpw$art_i]%>';
            for (var $art_idrmtpw$art_i = 0, $art_objagoudarm$art_obj = step.subs, $art_ctfhhooy$art_c = $art_objagoudarm$art_obj.length; $art_idrmtpw$art_i < $art_ctfhhooy$art_c; $art_idrmtpw$art_i++) {
                var sub = $art_objagoudarm$art_obj[$art_idrmtpw$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifipbietxa$art_i = 0, $art_objydjkas$art_obj = curStepInfo.subs, $art_cemktyxzjg$art_c = $art_objydjkas$art_obj.length; $art_ifipbietxa$art_i < $art_cemktyxzjg$art_c; $art_ifipbietxa$art_i++) {    var sub = $art_objydjkas$art_obj[$art_ifipbietxa$art_i]%>';
    for (var $art_ifipbietxa$art_i = 0, $art_objydjkas$art_obj = curStepInfo.subs, $art_cemktyxzjg$art_c = $art_objydjkas$art_obj.length; $art_ifipbietxa$art_i < $art_cemktyxzjg$art_c; $art_ifipbietxa$art_i++) {
        var sub = $art_objydjkas$art_obj[$art_ifipbietxa$art_i];
