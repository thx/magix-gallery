...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifuz$art_i = 0, $art_cenfrewq$art_c = stepInfos.length; $art_ifuz$art_i < $art_cenfrewq$art_c; $art_ifuz$art_i++) {    var step = stepInfos[$art_ifuz$art_i]%>';
    for (var $art_ifuz$art_i = 0, $art_cenfrewq$art_c = stepInfos.length; $art_ifuz$art_i < $art_cenfrewq$art_c; $art_ifuz$art_i++) {
        var step = stepInfos[$art_ifuz$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ilcpkxvmb$art_i = 0, $art_objshjvfuwn$art_obj = step.subs, $art_cuelasfg$art_c = $art_objshjvfuwn$art_obj.length; $art_ilcpkxvmb$art_i < $art_cuelasfg$art_c; $art_ilcpkxvmb$art_i++) {            var sub = $art_objshjvfuwn$art_obj[$art_ilcpkxvmb$art_i]%>';
            for (var $art_ilcpkxvmb$art_i = 0, $art_objshjvfuwn$art_obj = step.subs, $art_cuelasfg$art_c = $art_objshjvfuwn$art_obj.length; $art_ilcpkxvmb$art_i < $art_cuelasfg$art_c; $art_ilcpkxvmb$art_i++) {
                var sub = $art_objshjvfuwn$art_obj[$art_ilcpkxvmb$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqllhywyc$art_i = 0, $art_objqvlxjtz$art_obj = curStepInfo.subs, $art_czfchctvgi$art_c = $art_objqvlxjtz$art_obj.length; $art_iqllhywyc$art_i < $art_czfchctvgi$art_c; $art_iqllhywyc$art_i++) {    var sub = $art_objqvlxjtz$art_obj[$art_iqllhywyc$art_i]%>';
    for (var $art_iqllhywyc$art_i = 0, $art_objqvlxjtz$art_obj = curStepInfo.subs, $art_czfchctvgi$art_c = $art_objqvlxjtz$art_obj.length; $art_iqllhywyc$art_i < $art_czfchctvgi$art_c; $art_iqllhywyc$art_i++) {
        var sub = $art_objqvlxjtz$art_obj[$art_iqllhywyc$art_i];
