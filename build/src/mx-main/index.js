...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imwncvnwkk$art_i = 0, $art_cklrxnrm$art_c = stepInfos.length; $art_imwncvnwkk$art_i < $art_cklrxnrm$art_c; $art_imwncvnwkk$art_i++) {    var step = stepInfos[$art_imwncvnwkk$art_i]%>';
    for (var $art_imwncvnwkk$art_i = 0, $art_cklrxnrm$art_c = stepInfos.length; $art_imwncvnwkk$art_i < $art_cklrxnrm$art_c; $art_imwncvnwkk$art_i++) {
        var step = stepInfos[$art_imwncvnwkk$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ipmyoezeo$art_i = 0, $art_objkdzqsafe$art_obj = step.subs, $art_cltdewjrf$art_c = $art_objkdzqsafe$art_obj.length; $art_ipmyoezeo$art_i < $art_cltdewjrf$art_c; $art_ipmyoezeo$art_i++) {            var sub = $art_objkdzqsafe$art_obj[$art_ipmyoezeo$art_i]%>';
            for (var $art_ipmyoezeo$art_i = 0, $art_objkdzqsafe$art_obj = step.subs, $art_cltdewjrf$art_c = $art_objkdzqsafe$art_obj.length; $art_ipmyoezeo$art_i < $art_cltdewjrf$art_c; $art_ipmyoezeo$art_i++) {
                var sub = $art_objkdzqsafe$art_obj[$art_ipmyoezeo$art_i];
    ...
    ;
    $expr = '<%for (var $art_ijqqjba$art_i = 0, $art_objichdmrfq$art_obj = curStepInfo.subs, $art_cfbbphjt$art_c = $art_objichdmrfq$art_obj.length; $art_ijqqjba$art_i < $art_cfbbphjt$art_c; $art_ijqqjba$art_i++) {    var sub = $art_objichdmrfq$art_obj[$art_ijqqjba$art_i]%>';
    for (var $art_ijqqjba$art_i = 0, $art_objichdmrfq$art_obj = curStepInfo.subs, $art_cfbbphjt$art_c = $art_objichdmrfq$art_obj.length; $art_ijqqjba$art_i < $art_cfbbphjt$art_c; $art_ijqqjba$art_i++) {
        var sub = $art_objichdmrfq$art_obj[$art_ijqqjba$art_i];
