...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifukwl$art_i = 0, $art_criclsztok$art_c = stepInfos.length; $art_ifukwl$art_i < $art_criclsztok$art_c; $art_ifukwl$art_i++) {    var step = stepInfos[$art_ifukwl$art_i]%>';
    for (var $art_ifukwl$art_i = 0, $art_criclsztok$art_c = stepInfos.length; $art_ifukwl$art_i < $art_criclsztok$art_c; $art_ifukwl$art_i++) {
        var step = stepInfos[$art_ifukwl$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iyucfvxco$art_i = 0, $art_objyalaxyjo$art_obj = step.subs, $art_cfefiqfjnt$art_c = $art_objyalaxyjo$art_obj.length; $art_iyucfvxco$art_i < $art_cfefiqfjnt$art_c; $art_iyucfvxco$art_i++) {            var sub = $art_objyalaxyjo$art_obj[$art_iyucfvxco$art_i]%>';
            for (var $art_iyucfvxco$art_i = 0, $art_objyalaxyjo$art_obj = step.subs, $art_cfefiqfjnt$art_c = $art_objyalaxyjo$art_obj.length; $art_iyucfvxco$art_i < $art_cfefiqfjnt$art_c; $art_iyucfvxco$art_i++) {
                var sub = $art_objyalaxyjo$art_obj[$art_iyucfvxco$art_i];
    ...
    ;
    $expr = '<%for (var $art_isvgbnbnvj$art_i = 0, $art_objgnzdzv$art_obj = curStepInfo.subs, $art_ccquinlh$art_c = $art_objgnzdzv$art_obj.length; $art_isvgbnbnvj$art_i < $art_ccquinlh$art_c; $art_isvgbnbnvj$art_i++) {    var sub = $art_objgnzdzv$art_obj[$art_isvgbnbnvj$art_i]%>';
    for (var $art_isvgbnbnvj$art_i = 0, $art_objgnzdzv$art_obj = curStepInfo.subs, $art_ccquinlh$art_c = $art_objgnzdzv$art_obj.length; $art_isvgbnbnvj$art_i < $art_ccquinlh$art_c; $art_isvgbnbnvj$art_i++) {
        var sub = $art_objgnzdzv$art_obj[$art_isvgbnbnvj$art_i];
