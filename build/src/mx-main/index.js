...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igrgssdqaw$art_i = 0, $art_ceewivmb$art_c = stepInfos.length; $art_igrgssdqaw$art_i < $art_ceewivmb$art_c; $art_igrgssdqaw$art_i++) {    var step = stepInfos[$art_igrgssdqaw$art_i]%>';
    for (var $art_igrgssdqaw$art_i = 0, $art_ceewivmb$art_c = stepInfos.length; $art_igrgssdqaw$art_i < $art_ceewivmb$art_c; $art_igrgssdqaw$art_i++) {
        var step = stepInfos[$art_igrgssdqaw$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ibypvkbm$art_i = 0, $art_objhzkrbrsw$art_obj = step.subs, $art_crcdmaq$art_c = $art_objhzkrbrsw$art_obj.length; $art_ibypvkbm$art_i < $art_crcdmaq$art_c; $art_ibypvkbm$art_i++) {            var sub = $art_objhzkrbrsw$art_obj[$art_ibypvkbm$art_i]%>';
            for (var $art_ibypvkbm$art_i = 0, $art_objhzkrbrsw$art_obj = step.subs, $art_crcdmaq$art_c = $art_objhzkrbrsw$art_obj.length; $art_ibypvkbm$art_i < $art_crcdmaq$art_c; $art_ibypvkbm$art_i++) {
                var sub = $art_objhzkrbrsw$art_obj[$art_ibypvkbm$art_i];
    ...
    ;
    $expr = '<%for (var $art_isanylflnbj$art_i = 0, $art_objwtjchbbo$art_obj = curStepInfo.subs, $art_ckkhdgwhox$art_c = $art_objwtjchbbo$art_obj.length; $art_isanylflnbj$art_i < $art_ckkhdgwhox$art_c; $art_isanylflnbj$art_i++) {    var sub = $art_objwtjchbbo$art_obj[$art_isanylflnbj$art_i]%>';
    for (var $art_isanylflnbj$art_i = 0, $art_objwtjchbbo$art_obj = curStepInfo.subs, $art_ckkhdgwhox$art_c = $art_objwtjchbbo$art_obj.length; $art_isanylflnbj$art_i < $art_ckkhdgwhox$art_c; $art_isanylflnbj$art_i++) {
        var sub = $art_objwtjchbbo$art_obj[$art_isanylflnbj$art_i];
