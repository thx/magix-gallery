...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyfdtdvek$art_i = 0, $art_cnccqumbev$art_c = stepInfos.length; $art_iyfdtdvek$art_i < $art_cnccqumbev$art_c; $art_iyfdtdvek$art_i++) {    var step = stepInfos[$art_iyfdtdvek$art_i]%>';
    for (var $art_iyfdtdvek$art_i = 0, $art_cnccqumbev$art_c = stepInfos.length; $art_iyfdtdvek$art_i < $art_cnccqumbev$art_c; $art_iyfdtdvek$art_i++) {
        var step = stepInfos[$art_iyfdtdvek$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_irvwokzev$art_i = 0, $art_objttuzsxe$art_obj = step.subs, $art_cerhwyd$art_c = $art_objttuzsxe$art_obj.length; $art_irvwokzev$art_i < $art_cerhwyd$art_c; $art_irvwokzev$art_i++) {            var sub = $art_objttuzsxe$art_obj[$art_irvwokzev$art_i]%>';
            for (var $art_irvwokzev$art_i = 0, $art_objttuzsxe$art_obj = step.subs, $art_cerhwyd$art_c = $art_objttuzsxe$art_obj.length; $art_irvwokzev$art_i < $art_cerhwyd$art_c; $art_irvwokzev$art_i++) {
                var sub = $art_objttuzsxe$art_obj[$art_irvwokzev$art_i];
    ...
    ;
    $expr = '<%for (var $art_ieccyes$art_i = 0, $art_objasmzdhe$art_obj = curStepInfo.subs, $art_czocevgcw$art_c = $art_objasmzdhe$art_obj.length; $art_ieccyes$art_i < $art_czocevgcw$art_c; $art_ieccyes$art_i++) {    var sub = $art_objasmzdhe$art_obj[$art_ieccyes$art_i]%>';
    for (var $art_ieccyes$art_i = 0, $art_objasmzdhe$art_obj = curStepInfo.subs, $art_czocevgcw$art_c = $art_objasmzdhe$art_obj.length; $art_ieccyes$art_i < $art_czocevgcw$art_c; $art_ieccyes$art_i++) {
        var sub = $art_objasmzdhe$art_obj[$art_ieccyes$art_i];
