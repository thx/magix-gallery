...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iajobebhet$art_i = 0, $art_ckzypbec$art_c = stepInfos.length; $art_iajobebhet$art_i < $art_ckzypbec$art_c; $art_iajobebhet$art_i++) {    var step = stepInfos[$art_iajobebhet$art_i]%>';
    for (var $art_iajobebhet$art_i = 0, $art_ckzypbec$art_c = stepInfos.length; $art_iajobebhet$art_i < $art_ckzypbec$art_c; $art_iajobebhet$art_i++) {
        var step = stepInfos[$art_iajobebhet$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iemdzqoj$art_i = 0, $art_objpdjzrctkp$art_obj = step.subs, $art_cakbctlx$art_c = $art_objpdjzrctkp$art_obj.length; $art_iemdzqoj$art_i < $art_cakbctlx$art_c; $art_iemdzqoj$art_i++) {            var sub = $art_objpdjzrctkp$art_obj[$art_iemdzqoj$art_i]%>';
            for (var $art_iemdzqoj$art_i = 0, $art_objpdjzrctkp$art_obj = step.subs, $art_cakbctlx$art_c = $art_objpdjzrctkp$art_obj.length; $art_iemdzqoj$art_i < $art_cakbctlx$art_c; $art_iemdzqoj$art_i++) {
                var sub = $art_objpdjzrctkp$art_obj[$art_iemdzqoj$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibuigessn$art_i = 0, $art_objntwjknvkcs$art_obj = curStepInfo.subs, $art_cotsdadf$art_c = $art_objntwjknvkcs$art_obj.length; $art_ibuigessn$art_i < $art_cotsdadf$art_c; $art_ibuigessn$art_i++) {    var sub = $art_objntwjknvkcs$art_obj[$art_ibuigessn$art_i]%>';
    for (var $art_ibuigessn$art_i = 0, $art_objntwjknvkcs$art_obj = curStepInfo.subs, $art_cotsdadf$art_c = $art_objntwjknvkcs$art_obj.length; $art_ibuigessn$art_i < $art_cotsdadf$art_c; $art_ibuigessn$art_i++) {
        var sub = $art_objntwjknvkcs$art_obj[$art_ibuigessn$art_i];
