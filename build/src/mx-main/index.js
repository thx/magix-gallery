...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqgrdtyjxod$art_i = 0, $art_cmncbnggywh$art_c = stepInfos.length; $art_iqgrdtyjxod$art_i < $art_cmncbnggywh$art_c; $art_iqgrdtyjxod$art_i++) {    var step = stepInfos[$art_iqgrdtyjxod$art_i]%>';
    for (var $art_iqgrdtyjxod$art_i = 0, $art_cmncbnggywh$art_c = stepInfos.length; $art_iqgrdtyjxod$art_i < $art_cmncbnggywh$art_c; $art_iqgrdtyjxod$art_i++) {
        var step = stepInfos[$art_iqgrdtyjxod$art_i];
        ...
        ;
        $p += '"><div mxa="_zs_galleryc9:_" class="_zs_gallery_mx-main_index_-step-over"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link _zs_gallery_mx-main_index_-step-over clearfix ';
        $line = 6;
        ...
        if (step.icon) {
            ;
            $p += '<span mxa="_zs_galleryc9:a" class="_zs_gallery_mx-main_index_-over-icon fl">';
            $line = 10;
            $art = '!step.icon';
            ;
        ...
        ;
        $p += '<span mxa="_zs_galleryc9:b" class="fl">';
        $line = 12;
        $art = '=step.label';
        ;
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ixyltfam$art_i = 0, $art_objnemrzoawp$art_obj = step.subs, $art_cylolebs$art_c = $art_objnemrzoawp$art_obj.length; $art_ixyltfam$art_i < $art_cylolebs$art_c; $art_ixyltfam$art_i++) {            var sub = $art_objnemrzoawp$art_obj[$art_ixyltfam$art_i]%>';
            for (var $art_ixyltfam$art_i = 0, $art_objnemrzoawp$art_obj = step.subs, $art_cylolebs$art_c = $art_objnemrzoawp$art_obj.length; $art_ixyltfam$art_i < $art_cylolebs$art_c; $art_ixyltfam$art_i++) {
                var sub = $art_objnemrzoawp$art_obj[$art_ixyltfam$art_i];
                $p += '<div mxa="_zs_galleryc9:c" class="_zs_gallery_mx-main_index_-step-sub"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link ';
                $line = 19;
        ...
        if (step.index == curStepIndex) {
            ;
            $p += '<i mxs="_zs_galleryc9:_" class="mc-iconfont _zs_gallery_mx-main_index_-arrow-icon">&#xe602;</i>';
            $line = 30;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        if (step.locked) {
            ;
            $p += '<i mxs="_zs_galleryc9:a" class="mc-iconfont _zs_gallery_mx-main_index_-locked-icon">&#xe759;</i>';
            $line = 33;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    $art = '=leftWidth';
    ;
    $p += ($expr = '<%=leftWidth%>', $e(leftWidth)) + 'px;"><div mxa="_zs_galleryc9:d" class="_zs_gallery_mx-main_index_-content-title">';
    $line = 38;
    $art = '=curStepInfo.label';
    ;
    $p += ($expr = '<%=curStepInfo.label%>', $e(curStepInfo.label)) + '</div><div mxv mxa="_zs_galleryc9:e" class="_zs_gallery_mx-main_index_-content-body"><div mxv>';
    $line = 42;
    $art = 'each curStepInfo.subs as sub';
    ;
    $expr = '<%for (var $art_ibchwdqu$art_i = 0, $art_objjxgraomxo$art_obj = curStepInfo.subs, $art_cgzrzbwcewp$art_c = $art_objjxgraomxo$art_obj.length; $art_ibchwdqu$art_i < $art_cgzrzbwcewp$art_c; $art_ibchwdqu$art_i++) {    var sub = $art_objjxgraomxo$art_obj[$art_ibchwdqu$art_i]%>';
    for (var $art_ibchwdqu$art_i = 0, $art_objjxgraomxo$art_obj = curStepInfo.subs, $art_cgzrzbwcewp$art_c = $art_objjxgraomxo$art_obj.length; $art_ibchwdqu$art_i < $art_cgzrzbwcewp$art_c; $art_ibchwdqu$art_i++) {
        var sub = $art_objjxgraomxo$art_obj[$art_ibchwdqu$art_i];
        ...
        $art = '=sub.index';
        ;
        $p += ($expr = '<%=sub.index%>', $e(sub.index)) + '"><div mxs="_zs_galleryc9:b" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
        $line = 49;
        ...
        if (sub.sideWrapper) {
            ...
            ;
            $p += ($expr = '<%=curStepInfo.rightWidth%>', $e(curStepInfo.rightWidth)) + 'px;"><div mxs="_zs_galleryc9:b" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
            $line = 54;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    if (!curStepInfo.customTrigger) {
        ;
        $p += '<div mxa="_zs_galleryc9:f" class="_zs_gallery_mx-main_index_-content-footer"><div>';
        $line = 69;
        ...
        if (curStepInfo.prevTip) {
            ;
            $p += '<a mxa="_zs_galleryc9:g" href="javascript:;" class="btn min-width-100 mr20" mx-click="' + $viewId + 'prev()">';
            $line = 71;
        ...
        if (curStepInfo.nextTip) {
            ;
            $p += '<a mxa="_zs_galleryc9:h" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
            $line = 76;
