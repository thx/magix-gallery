...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijf$art_i = 0, $art_cslhod$art_c = stepInfos.length; $art_ijf$art_i < $art_cslhod$art_c; $art_ijf$art_i++) {    var step = stepInfos[$art_ijf$art_i]%>';
    for (var $art_ijf$art_i = 0, $art_cslhod$art_c = stepInfos.length; $art_ijf$art_i < $art_cslhod$art_c; $art_ijf$art_i++) {
        var step = stepInfos[$art_ijf$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ikotsykpoe$art_i = 0, $art_objyntqqq$art_obj = step.subs, $art_cpsvbva$art_c = $art_objyntqqq$art_obj.length; $art_ikotsykpoe$art_i < $art_cpsvbva$art_c; $art_ikotsykpoe$art_i++) {            var sub = $art_objyntqqq$art_obj[$art_ikotsykpoe$art_i]%>';
            for (var $art_ikotsykpoe$art_i = 0, $art_objyntqqq$art_obj = step.subs, $art_cpsvbva$art_c = $art_objyntqqq$art_obj.length; $art_ikotsykpoe$art_i < $art_cpsvbva$art_c; $art_ikotsykpoe$art_i++) {
                var sub = $art_objyntqqq$art_obj[$art_ikotsykpoe$art_i];
    ...
    ;
    $expr = '<%for (var $art_icrriudvbe$art_i = 0, $art_objuzdhyrz$art_obj = curStepInfo.subs, $art_cppyqkkyn$art_c = $art_objuzdhyrz$art_obj.length; $art_icrriudvbe$art_i < $art_cppyqkkyn$art_c; $art_icrriudvbe$art_i++) {    var sub = $art_objuzdhyrz$art_obj[$art_icrriudvbe$art_i]%>';
    for (var $art_icrriudvbe$art_i = 0, $art_objuzdhyrz$art_obj = curStepInfo.subs, $art_cppyqkkyn$art_c = $art_objuzdhyrz$art_obj.length; $art_icrriudvbe$art_i < $art_cppyqkkyn$art_c; $art_icrriudvbe$art_i++) {
        var sub = $art_objuzdhyrz$art_obj[$art_icrriudvbe$art_i];
