...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iifjzbizal$art_i = 0, $art_cblslndbg$art_c = stepInfos.length; $art_iifjzbizal$art_i < $art_cblslndbg$art_c; $art_iifjzbizal$art_i++) {    var step = stepInfos[$art_iifjzbizal$art_i]%>';
    for (var $art_iifjzbizal$art_i = 0, $art_cblslndbg$art_c = stepInfos.length; $art_iifjzbizal$art_i < $art_cblslndbg$art_c; $art_iifjzbizal$art_i++) {
        var step = stepInfos[$art_iifjzbizal$art_i];
        ...
        ;
        $p += '"><div mxa="_zs_gallerybI:_" class="_zs_gallery_mx-main_index_-step-over"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link _zs_gallery_mx-main_index_-step-over clearfix ';
        $line = 6;
        ...
        if (step.icon) {
            ;
            $p += '<span mxa="_zs_gallerybI:a" class="_zs_gallery_mx-main_index_-over-icon fl">';
            $line = 10;
            $art = '!step.icon';
            ;
        ...
        ;
        $p += '<span mxa="_zs_gallerybI:b" class="fl">';
        $line = 12;
        $art = '=step.label';
        ;
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ilpietydry$art_i = 0, $art_objuupqizya$art_obj = step.subs, $art_cbrowseu$art_c = $art_objuupqizya$art_obj.length; $art_ilpietydry$art_i < $art_cbrowseu$art_c; $art_ilpietydry$art_i++) {            var sub = $art_objuupqizya$art_obj[$art_ilpietydry$art_i]%>';
            for (var $art_ilpietydry$art_i = 0, $art_objuupqizya$art_obj = step.subs, $art_cbrowseu$art_c = $art_objuupqizya$art_obj.length; $art_ilpietydry$art_i < $art_cbrowseu$art_c; $art_ilpietydry$art_i++) {
                var sub = $art_objuupqizya$art_obj[$art_ilpietydry$art_i];
                $p += '<div mxa="_zs_gallerybI:c" class="_zs_gallery_mx-main_index_-step-sub"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link ';
                $line = 19;
        ...
        if (step.index == curStepIndex) {
            ;
            $p += '<i mxs="_zs_gallerybI:_" class="mc-iconfont _zs_gallery_mx-main_index_-arrow-icon">&#xe602;</i>';
            $line = 30;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        if (step.locked) {
            ;
            $p += '<i mxs="_zs_gallerybI:a" class="mc-iconfont _zs_gallery_mx-main_index_-locked-icon">&#xe759;</i>';
            $line = 33;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    $art = '=leftWidth';
    ;
    $p += ($expr = '<%=leftWidth%>', $e(leftWidth)) + 'px;"><div mxa="_zs_gallerybI:d" class="_zs_gallery_mx-main_index_-content-title">';
    $line = 38;
    $art = '=curStepInfo.label';
    ;
    $p += ($expr = '<%=curStepInfo.label%>', $e(curStepInfo.label)) + '</div><div mxv mxa="_zs_gallerybI:e" class="_zs_gallery_mx-main_index_-content-body"><div mxv>';
    $line = 42;
    $art = 'each curStepInfo.subs as sub';
    ;
    $expr = '<%for (var $art_iosigzbhor$art_i = 0, $art_objwxbohlns$art_obj = curStepInfo.subs, $art_calbokag$art_c = $art_objwxbohlns$art_obj.length; $art_iosigzbhor$art_i < $art_calbokag$art_c; $art_iosigzbhor$art_i++) {    var sub = $art_objwxbohlns$art_obj[$art_iosigzbhor$art_i]%>';
    for (var $art_iosigzbhor$art_i = 0, $art_objwxbohlns$art_obj = curStepInfo.subs, $art_calbokag$art_c = $art_objwxbohlns$art_obj.length; $art_iosigzbhor$art_i < $art_calbokag$art_c; $art_iosigzbhor$art_i++) {
        var sub = $art_objwxbohlns$art_obj[$art_iosigzbhor$art_i];
        ...
        $art = '=sub.index';
        ;
        $p += ($expr = '<%=sub.index%>', $e(sub.index)) + '"><div mxs="_zs_gallerybI:b" class="loading"><span class="loading-anim"></span></div></div>';
        $line = 49;
        ...
        if (sub.sideWrapper) {
            ...
            ;
            $p += ($expr = '<%=curStepInfo.rightWidth%>', $e(curStepInfo.rightWidth)) + 'px;"><div mxs="_zs_gallerybI:b" class="loading"><span class="loading-anim"></span></div></div>';
            $line = 54;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    if (!curStepInfo.customTrigger) {
        ;
        $p += '<div mxa="_zs_gallerybI:f" class="_zs_gallery_mx-main_index_-content-footer"><div>';
        $line = 69;
        ...
        if (curStepInfo.prevTip) {
            ;
            $p += '<a mxa="_zs_gallerybI:g" href="javascript:;" class="btn min-width-100 mr20" mx-click="' + $viewId + 'prev()">';
            $line = 71;
        ...
        if (curStepInfo.nextTip) {
            ;
            $p += '<a mxa="_zs_gallerybI:h" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
            $line = 76;
