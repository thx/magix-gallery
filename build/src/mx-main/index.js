...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioqtrpbnqd$art_i = 0, $art_cuhoiutdrl$art_c = stepInfos.length; $art_ioqtrpbnqd$art_i < $art_cuhoiutdrl$art_c; $art_ioqtrpbnqd$art_i++) {    var step = stepInfos[$art_ioqtrpbnqd$art_i]%>';
    for (var $art_ioqtrpbnqd$art_i = 0, $art_cuhoiutdrl$art_c = stepInfos.length; $art_ioqtrpbnqd$art_i < $art_cuhoiutdrl$art_c; $art_ioqtrpbnqd$art_i++) {
        var step = stepInfos[$art_ioqtrpbnqd$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_invonnj$art_i = 0, $art_objaysbsy$art_obj = step.subs, $art_cepyxakjxyb$art_c = $art_objaysbsy$art_obj.length; $art_invonnj$art_i < $art_cepyxakjxyb$art_c; $art_invonnj$art_i++) {            var sub = $art_objaysbsy$art_obj[$art_invonnj$art_i]%>';
            for (var $art_invonnj$art_i = 0, $art_objaysbsy$art_obj = step.subs, $art_cepyxakjxyb$art_c = $art_objaysbsy$art_obj.length; $art_invonnj$art_i < $art_cepyxakjxyb$art_c; $art_invonnj$art_i++) {
                var sub = $art_objaysbsy$art_obj[$art_invonnj$art_i];
    ...
    ;
    $expr = '<%for (var $art_isqstoohfdw$art_i = 0, $art_objazbartum$art_obj = curStepInfo.subs, $art_cdorswanb$art_c = $art_objazbartum$art_obj.length; $art_isqstoohfdw$art_i < $art_cdorswanb$art_c; $art_isqstoohfdw$art_i++) {    var sub = $art_objazbartum$art_obj[$art_isqstoohfdw$art_i]%>';
    for (var $art_isqstoohfdw$art_i = 0, $art_objazbartum$art_obj = curStepInfo.subs, $art_cdorswanb$art_c = $art_objazbartum$art_obj.length; $art_isqstoohfdw$art_i < $art_cdorswanb$art_c; $art_isqstoohfdw$art_i++) {
        var sub = $art_objazbartum$art_obj[$art_isqstoohfdw$art_i];
