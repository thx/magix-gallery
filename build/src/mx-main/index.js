...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibiuheend$art_i = 0, $art_cwwnao$art_c = stepInfos.length; $art_ibiuheend$art_i < $art_cwwnao$art_c; $art_ibiuheend$art_i++) {    var step = stepInfos[$art_ibiuheend$art_i]%>';
    for (var $art_ibiuheend$art_i = 0, $art_cwwnao$art_c = stepInfos.length; $art_ibiuheend$art_i < $art_cwwnao$art_c; $art_ibiuheend$art_i++) {
        var step = stepInfos[$art_ibiuheend$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iniwxmnlq$art_i = 0, $art_objpjsviinjov$art_obj = step.subs, $art_ccwkjhc$art_c = $art_objpjsviinjov$art_obj.length; $art_iniwxmnlq$art_i < $art_ccwkjhc$art_c; $art_iniwxmnlq$art_i++) {            var sub = $art_objpjsviinjov$art_obj[$art_iniwxmnlq$art_i]%>';
            for (var $art_iniwxmnlq$art_i = 0, $art_objpjsviinjov$art_obj = step.subs, $art_ccwkjhc$art_c = $art_objpjsviinjov$art_obj.length; $art_iniwxmnlq$art_i < $art_ccwkjhc$art_c; $art_iniwxmnlq$art_i++) {
                var sub = $art_objpjsviinjov$art_obj[$art_iniwxmnlq$art_i];
    ...
    ;
    $expr = '<%for (var $art_ildsaumcl$art_i = 0, $art_objprvopipe$art_obj = curStepInfo.subs, $art_cgyrcyk$art_c = $art_objprvopipe$art_obj.length; $art_ildsaumcl$art_i < $art_cgyrcyk$art_c; $art_ildsaumcl$art_i++) {    var sub = $art_objprvopipe$art_obj[$art_ildsaumcl$art_i]%>';
    for (var $art_ildsaumcl$art_i = 0, $art_objprvopipe$art_obj = curStepInfo.subs, $art_cgyrcyk$art_c = $art_objprvopipe$art_obj.length; $art_ildsaumcl$art_i < $art_cgyrcyk$art_c; $art_ildsaumcl$art_i++) {
        var sub = $art_objprvopipe$art_obj[$art_ildsaumcl$art_i];
