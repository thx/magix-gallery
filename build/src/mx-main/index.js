...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_islgpmhme$art_i = 0, $art_ckjdozezg$art_c = stepInfos.length; $art_islgpmhme$art_i < $art_ckjdozezg$art_c; $art_islgpmhme$art_i++) {    var step = stepInfos[$art_islgpmhme$art_i]%>';
    for (var $art_islgpmhme$art_i = 0, $art_ckjdozezg$art_c = stepInfos.length; $art_islgpmhme$art_i < $art_ckjdozezg$art_c; $art_islgpmhme$art_i++) {
        var step = stepInfos[$art_islgpmhme$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ipbigzclyj$art_i = 0, $art_objbpxmwnrwm$art_obj = step.subs, $art_cflhkxi$art_c = $art_objbpxmwnrwm$art_obj.length; $art_ipbigzclyj$art_i < $art_cflhkxi$art_c; $art_ipbigzclyj$art_i++) {            var sub = $art_objbpxmwnrwm$art_obj[$art_ipbigzclyj$art_i]%>';
            for (var $art_ipbigzclyj$art_i = 0, $art_objbpxmwnrwm$art_obj = step.subs, $art_cflhkxi$art_c = $art_objbpxmwnrwm$art_obj.length; $art_ipbigzclyj$art_i < $art_cflhkxi$art_c; $art_ipbigzclyj$art_i++) {
                var sub = $art_objbpxmwnrwm$art_obj[$art_ipbigzclyj$art_i];
    ...
    ;
    $expr = '<%for (var $art_iiegvml$art_i = 0, $art_objuepauwl$art_obj = curStepInfo.subs, $art_clydnsym$art_c = $art_objuepauwl$art_obj.length; $art_iiegvml$art_i < $art_clydnsym$art_c; $art_iiegvml$art_i++) {    var sub = $art_objuepauwl$art_obj[$art_iiegvml$art_i]%>';
    for (var $art_iiegvml$art_i = 0, $art_objuepauwl$art_obj = curStepInfo.subs, $art_clydnsym$art_c = $art_objuepauwl$art_obj.length; $art_iiegvml$art_i < $art_clydnsym$art_c; $art_iiegvml$art_i++) {
        var sub = $art_objuepauwl$art_obj[$art_iiegvml$art_i];
