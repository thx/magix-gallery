...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igzhmpjp$art_i = 0, $art_cbiymsjx$art_c = stepInfos.length; $art_igzhmpjp$art_i < $art_cbiymsjx$art_c; $art_igzhmpjp$art_i++) {    var step = stepInfos[$art_igzhmpjp$art_i]%>';
    for (var $art_igzhmpjp$art_i = 0, $art_cbiymsjx$art_c = stepInfos.length; $art_igzhmpjp$art_i < $art_cbiymsjx$art_c; $art_igzhmpjp$art_i++) {
        var step = stepInfos[$art_igzhmpjp$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_isemxm$art_i = 0, $art_objdjrcwheb$art_obj = step.subs, $art_ctilixqj$art_c = $art_objdjrcwheb$art_obj.length; $art_isemxm$art_i < $art_ctilixqj$art_c; $art_isemxm$art_i++) {            var sub = $art_objdjrcwheb$art_obj[$art_isemxm$art_i]%>';
            for (var $art_isemxm$art_i = 0, $art_objdjrcwheb$art_obj = step.subs, $art_ctilixqj$art_c = $art_objdjrcwheb$art_obj.length; $art_isemxm$art_i < $art_ctilixqj$art_c; $art_isemxm$art_i++) {
                var sub = $art_objdjrcwheb$art_obj[$art_isemxm$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibibzwxrd$art_i = 0, $art_objqpxepzfbgp$art_obj = curStepInfo.subs, $art_cqgcazay$art_c = $art_objqpxepzfbgp$art_obj.length; $art_ibibzwxrd$art_i < $art_cqgcazay$art_c; $art_ibibzwxrd$art_i++) {    var sub = $art_objqpxepzfbgp$art_obj[$art_ibibzwxrd$art_i]%>';
    for (var $art_ibibzwxrd$art_i = 0, $art_objqpxepzfbgp$art_obj = curStepInfo.subs, $art_cqgcazay$art_c = $art_objqpxepzfbgp$art_obj.length; $art_ibibzwxrd$art_i < $art_cqgcazay$art_c; $art_ibibzwxrd$art_i++) {
        var sub = $art_objqpxepzfbgp$art_obj[$art_ibibzwxrd$art_i];
