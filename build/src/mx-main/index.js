...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itpworwaevj$art_i = 0, $art_cesyyzxe$art_c = stepInfos.length; $art_itpworwaevj$art_i < $art_cesyyzxe$art_c; $art_itpworwaevj$art_i++) {    var step = stepInfos[$art_itpworwaevj$art_i]%>';
    for (var $art_itpworwaevj$art_i = 0, $art_cesyyzxe$art_c = stepInfos.length; $art_itpworwaevj$art_i < $art_cesyyzxe$art_c; $art_itpworwaevj$art_i++) {
        var step = stepInfos[$art_itpworwaevj$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_idefcwvnw$art_i = 0, $art_objnkswflr$art_obj = step.subs, $art_csprzlqfqo$art_c = $art_objnkswflr$art_obj.length; $art_idefcwvnw$art_i < $art_csprzlqfqo$art_c; $art_idefcwvnw$art_i++) {            var sub = $art_objnkswflr$art_obj[$art_idefcwvnw$art_i]%>';
            for (var $art_idefcwvnw$art_i = 0, $art_objnkswflr$art_obj = step.subs, $art_csprzlqfqo$art_c = $art_objnkswflr$art_obj.length; $art_idefcwvnw$art_i < $art_csprzlqfqo$art_c; $art_idefcwvnw$art_i++) {
                var sub = $art_objnkswflr$art_obj[$art_idefcwvnw$art_i];
    ...
    ;
    $expr = '<%for (var $art_irnzcklcw$art_i = 0, $art_objmmovvlb$art_obj = curStepInfo.subs, $art_cvvhfftnp$art_c = $art_objmmovvlb$art_obj.length; $art_irnzcklcw$art_i < $art_cvvhfftnp$art_c; $art_irnzcklcw$art_i++) {    var sub = $art_objmmovvlb$art_obj[$art_irnzcklcw$art_i]%>';
    for (var $art_irnzcklcw$art_i = 0, $art_objmmovvlb$art_obj = curStepInfo.subs, $art_cvvhfftnp$art_c = $art_objmmovvlb$art_obj.length; $art_irnzcklcw$art_i < $art_cvvhfftnp$art_c; $art_irnzcklcw$art_i++) {
        var sub = $art_objmmovvlb$art_obj[$art_irnzcklcw$art_i];
