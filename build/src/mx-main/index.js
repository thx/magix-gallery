...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iadgrnmyf$art_i = 0, $art_ccrbtoshn$art_c = stepInfos.length; $art_iadgrnmyf$art_i < $art_ccrbtoshn$art_c; $art_iadgrnmyf$art_i++) {    var step = stepInfos[$art_iadgrnmyf$art_i]%>';
    for (var $art_iadgrnmyf$art_i = 0, $art_ccrbtoshn$art_c = stepInfos.length; $art_iadgrnmyf$art_i < $art_ccrbtoshn$art_c; $art_iadgrnmyf$art_i++) {
        var step = stepInfos[$art_iadgrnmyf$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_inkvbidl$art_i = 0, $art_objsmyhqw$art_obj = step.subs, $art_ciyvcaida$art_c = $art_objsmyhqw$art_obj.length; $art_inkvbidl$art_i < $art_ciyvcaida$art_c; $art_inkvbidl$art_i++) {            var sub = $art_objsmyhqw$art_obj[$art_inkvbidl$art_i]%>';
            for (var $art_inkvbidl$art_i = 0, $art_objsmyhqw$art_obj = step.subs, $art_ciyvcaida$art_c = $art_objsmyhqw$art_obj.length; $art_inkvbidl$art_i < $art_ciyvcaida$art_c; $art_inkvbidl$art_i++) {
                var sub = $art_objsmyhqw$art_obj[$art_inkvbidl$art_i];
    ...
    ;
    $expr = '<%for (var $art_iypqqzv$art_i = 0, $art_objnmutub$art_obj = curStepInfo.subs, $art_cpvitlmx$art_c = $art_objnmutub$art_obj.length; $art_iypqqzv$art_i < $art_cpvitlmx$art_c; $art_iypqqzv$art_i++) {    var sub = $art_objnmutub$art_obj[$art_iypqqzv$art_i]%>';
    for (var $art_iypqqzv$art_i = 0, $art_objnmutub$art_obj = curStepInfo.subs, $art_cpvitlmx$art_c = $art_objnmutub$art_obj.length; $art_iypqqzv$art_i < $art_cpvitlmx$art_c; $art_iypqqzv$art_i++) {
        var sub = $art_objnmutub$art_obj[$art_iypqqzv$art_i];
