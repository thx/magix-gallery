...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isadcdttxm$art_i = 0, $art_cazpufomgb$art_c = stepInfos.length; $art_isadcdttxm$art_i < $art_cazpufomgb$art_c; $art_isadcdttxm$art_i++) {    var step = stepInfos[$art_isadcdttxm$art_i]%>';
    for (var $art_isadcdttxm$art_i = 0, $art_cazpufomgb$art_c = stepInfos.length; $art_isadcdttxm$art_i < $art_cazpufomgb$art_c; $art_isadcdttxm$art_i++) {
        var step = stepInfos[$art_isadcdttxm$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ilkus$art_i = 0, $art_objwzsapncxco$art_obj = step.subs, $art_cbfblik$art_c = $art_objwzsapncxco$art_obj.length; $art_ilkus$art_i < $art_cbfblik$art_c; $art_ilkus$art_i++) {            var sub = $art_objwzsapncxco$art_obj[$art_ilkus$art_i]%>';
            for (var $art_ilkus$art_i = 0, $art_objwzsapncxco$art_obj = step.subs, $art_cbfblik$art_c = $art_objwzsapncxco$art_obj.length; $art_ilkus$art_i < $art_cbfblik$art_c; $art_ilkus$art_i++) {
                var sub = $art_objwzsapncxco$art_obj[$art_ilkus$art_i];
    ...
    ;
    $expr = '<%for (var $art_irpucpzhr$art_i = 0, $art_objonmcfrs$art_obj = curStepInfo.subs, $art_cisqeerw$art_c = $art_objonmcfrs$art_obj.length; $art_irpucpzhr$art_i < $art_cisqeerw$art_c; $art_irpucpzhr$art_i++) {    var sub = $art_objonmcfrs$art_obj[$art_irpucpzhr$art_i]%>';
    for (var $art_irpucpzhr$art_i = 0, $art_objonmcfrs$art_obj = curStepInfo.subs, $art_cisqeerw$art_c = $art_objonmcfrs$art_obj.length; $art_irpucpzhr$art_i < $art_cisqeerw$art_c; $art_irpucpzhr$art_i++) {
        var sub = $art_objonmcfrs$art_obj[$art_irpucpzhr$art_i];
