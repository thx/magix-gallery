...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijvkhiblpg$art_i = 0, $art_cigaowmgs$art_c = stepInfos.length; $art_ijvkhiblpg$art_i < $art_cigaowmgs$art_c; $art_ijvkhiblpg$art_i++) {    var step = stepInfos[$art_ijvkhiblpg$art_i]%>';
    for (var $art_ijvkhiblpg$art_i = 0, $art_cigaowmgs$art_c = stepInfos.length; $art_ijvkhiblpg$art_i < $art_cigaowmgs$art_c; $art_ijvkhiblpg$art_i++) {
        var step = stepInfos[$art_ijvkhiblpg$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ipzgsitw$art_i = 0, $art_objqvrkdgq$art_obj = step.subs, $art_crotmsztg$art_c = $art_objqvrkdgq$art_obj.length; $art_ipzgsitw$art_i < $art_crotmsztg$art_c; $art_ipzgsitw$art_i++) {            var sub = $art_objqvrkdgq$art_obj[$art_ipzgsitw$art_i]%>';
            for (var $art_ipzgsitw$art_i = 0, $art_objqvrkdgq$art_obj = step.subs, $art_crotmsztg$art_c = $art_objqvrkdgq$art_obj.length; $art_ipzgsitw$art_i < $art_crotmsztg$art_c; $art_ipzgsitw$art_i++) {
                var sub = $art_objqvrkdgq$art_obj[$art_ipzgsitw$art_i];
    ...
    ;
    $expr = '<%for (var $art_ixplzrngym$art_i = 0, $art_objpuhbyiwi$art_obj = curStepInfo.subs, $art_ctbxlmyy$art_c = $art_objpuhbyiwi$art_obj.length; $art_ixplzrngym$art_i < $art_ctbxlmyy$art_c; $art_ixplzrngym$art_i++) {    var sub = $art_objpuhbyiwi$art_obj[$art_ixplzrngym$art_i]%>';
    for (var $art_ixplzrngym$art_i = 0, $art_objpuhbyiwi$art_obj = curStepInfo.subs, $art_ctbxlmyy$art_c = $art_objpuhbyiwi$art_obj.length; $art_ixplzrngym$art_i < $art_ctbxlmyy$art_c; $art_ixplzrngym$art_i++) {
        var sub = $art_objpuhbyiwi$art_obj[$art_ixplzrngym$art_i];
