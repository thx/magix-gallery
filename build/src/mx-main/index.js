...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iafikhnssj$art_i = 0, $art_cikuwyuim$art_c = stepInfos.length; $art_iafikhnssj$art_i < $art_cikuwyuim$art_c; $art_iafikhnssj$art_i++) {    var step = stepInfos[$art_iafikhnssj$art_i]%>';
    for (var $art_iafikhnssj$art_i = 0, $art_cikuwyuim$art_c = stepInfos.length; $art_iafikhnssj$art_i < $art_cikuwyuim$art_c; $art_iafikhnssj$art_i++) {
        var step = stepInfos[$art_iafikhnssj$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ietjcds$art_i = 0, $art_objkhopnyh$art_obj = step.subs, $art_cuxkxzjrirtb$art_c = $art_objkhopnyh$art_obj.length; $art_ietjcds$art_i < $art_cuxkxzjrirtb$art_c; $art_ietjcds$art_i++) {            var sub = $art_objkhopnyh$art_obj[$art_ietjcds$art_i]%>';
            for (var $art_ietjcds$art_i = 0, $art_objkhopnyh$art_obj = step.subs, $art_cuxkxzjrirtb$art_c = $art_objkhopnyh$art_obj.length; $art_ietjcds$art_i < $art_cuxkxzjrirtb$art_c; $art_ietjcds$art_i++) {
                var sub = $art_objkhopnyh$art_obj[$art_ietjcds$art_i];
    ...
    ;
    $expr = '<%for (var $art_ifeqitjl$art_i = 0, $art_objfonhhc$art_obj = curStepInfo.subs, $art_cahjjpkrw$art_c = $art_objfonhhc$art_obj.length; $art_ifeqitjl$art_i < $art_cahjjpkrw$art_c; $art_ifeqitjl$art_i++) {    var sub = $art_objfonhhc$art_obj[$art_ifeqitjl$art_i]%>';
    for (var $art_ifeqitjl$art_i = 0, $art_objfonhhc$art_obj = curStepInfo.subs, $art_cahjjpkrw$art_c = $art_objfonhhc$art_obj.length; $art_ifeqitjl$art_i < $art_cahjjpkrw$art_c; $art_ifeqitjl$art_i++) {
        var sub = $art_objfonhhc$art_obj[$art_ifeqitjl$art_i];
