...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibbpfidcdj$art_i = 0, $art_cgfoirsgcn$art_c = stepInfos.length; $art_ibbpfidcdj$art_i < $art_cgfoirsgcn$art_c; $art_ibbpfidcdj$art_i++) {    var step = stepInfos[$art_ibbpfidcdj$art_i]%>';
    for (var $art_ibbpfidcdj$art_i = 0, $art_cgfoirsgcn$art_c = stepInfos.length; $art_ibbpfidcdj$art_i < $art_cgfoirsgcn$art_c; $art_ibbpfidcdj$art_i++) {
        var step = stepInfos[$art_ibbpfidcdj$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ihyivrwl$art_i = 0, $art_objglyqmsqi$art_obj = step.subs, $art_cnzbsotr$art_c = $art_objglyqmsqi$art_obj.length; $art_ihyivrwl$art_i < $art_cnzbsotr$art_c; $art_ihyivrwl$art_i++) {            var sub = $art_objglyqmsqi$art_obj[$art_ihyivrwl$art_i]%>';
            for (var $art_ihyivrwl$art_i = 0, $art_objglyqmsqi$art_obj = step.subs, $art_cnzbsotr$art_c = $art_objglyqmsqi$art_obj.length; $art_ihyivrwl$art_i < $art_cnzbsotr$art_c; $art_ihyivrwl$art_i++) {
                var sub = $art_objglyqmsqi$art_obj[$art_ihyivrwl$art_i];
    ...
    ;
    $expr = '<%for (var $art_itgrhnee$art_i = 0, $art_objkrvafyl$art_obj = curStepInfo.subs, $art_csifxg$art_c = $art_objkrvafyl$art_obj.length; $art_itgrhnee$art_i < $art_csifxg$art_c; $art_itgrhnee$art_i++) {    var sub = $art_objkrvafyl$art_obj[$art_itgrhnee$art_i]%>';
    for (var $art_itgrhnee$art_i = 0, $art_objkrvafyl$art_obj = curStepInfo.subs, $art_csifxg$art_c = $art_objkrvafyl$art_obj.length; $art_itgrhnee$art_i < $art_csifxg$art_c; $art_itgrhnee$art_i++) {
        var sub = $art_objkrvafyl$art_obj[$art_itgrhnee$art_i];
