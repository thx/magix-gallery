...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idjdlylpqms$art_i = 0, $art_cknaprkph$art_c = stepInfos.length; $art_idjdlylpqms$art_i < $art_cknaprkph$art_c; $art_idjdlylpqms$art_i++) {    var step = stepInfos[$art_idjdlylpqms$art_i]%>';
    for (var $art_idjdlylpqms$art_i = 0, $art_cknaprkph$art_c = stepInfos.length; $art_idjdlylpqms$art_i < $art_cknaprkph$art_c; $art_idjdlylpqms$art_i++) {
        var step = stepInfos[$art_idjdlylpqms$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iiyjflhf$art_i = 0, $art_objmwaihey$art_obj = step.subs, $art_cklgakjzkh$art_c = $art_objmwaihey$art_obj.length; $art_iiyjflhf$art_i < $art_cklgakjzkh$art_c; $art_iiyjflhf$art_i++) {            var sub = $art_objmwaihey$art_obj[$art_iiyjflhf$art_i]%>';
            for (var $art_iiyjflhf$art_i = 0, $art_objmwaihey$art_obj = step.subs, $art_cklgakjzkh$art_c = $art_objmwaihey$art_obj.length; $art_iiyjflhf$art_i < $art_cklgakjzkh$art_c; $art_iiyjflhf$art_i++) {
                var sub = $art_objmwaihey$art_obj[$art_iiyjflhf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ibpgvsjyf$art_i = 0, $art_objcvjuly$art_obj = curStepInfo.subs, $art_cryideto$art_c = $art_objcvjuly$art_obj.length; $art_ibpgvsjyf$art_i < $art_cryideto$art_c; $art_ibpgvsjyf$art_i++) {    var sub = $art_objcvjuly$art_obj[$art_ibpgvsjyf$art_i]%>';
    for (var $art_ibpgvsjyf$art_i = 0, $art_objcvjuly$art_obj = curStepInfo.subs, $art_cryideto$art_c = $art_objcvjuly$art_obj.length; $art_ibpgvsjyf$art_i < $art_cryideto$art_c; $art_ibpgvsjyf$art_i++) {
        var sub = $art_objcvjuly$art_obj[$art_ibpgvsjyf$art_i];
