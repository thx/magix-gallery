...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifwfvxuvwsy$art_i = 0, $art_cjbtkeck$art_c = stepInfos.length; $art_ifwfvxuvwsy$art_i < $art_cjbtkeck$art_c; $art_ifwfvxuvwsy$art_i++) {    var step = stepInfos[$art_ifwfvxuvwsy$art_i]%>';
    for (var $art_ifwfvxuvwsy$art_i = 0, $art_cjbtkeck$art_c = stepInfos.length; $art_ifwfvxuvwsy$art_i < $art_cjbtkeck$art_c; $art_ifwfvxuvwsy$art_i++) {
        var step = stepInfos[$art_ifwfvxuvwsy$art_i];
        ...
        ;
        $p += '"><div mxa="_zs_galleryb,:_" class="_zs_gallery_mx-main_index_-step-over"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link _zs_gallery_mx-main_index_-step-over clearfix ';
        $line = 6;
        ...
        if (step.icon) {
            ;
            $p += '<span mxa="_zs_galleryb,:a" class="_zs_gallery_mx-main_index_-over-icon fl">';
            $line = 10;
            $art = '!step.icon';
            ;
        ...
        ;
        $p += '<span mxa="_zs_galleryb,:b" class="fl">';
        $line = 12;
        $art = '=step.label';
        ;
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ijszazhme$art_i = 0, $art_objzvpsukfqj$art_obj = step.subs, $art_cmhhcsxns$art_c = $art_objzvpsukfqj$art_obj.length; $art_ijszazhme$art_i < $art_cmhhcsxns$art_c; $art_ijszazhme$art_i++) {            var sub = $art_objzvpsukfqj$art_obj[$art_ijszazhme$art_i]%>';
            for (var $art_ijszazhme$art_i = 0, $art_objzvpsukfqj$art_obj = step.subs, $art_cmhhcsxns$art_c = $art_objzvpsukfqj$art_obj.length; $art_ijszazhme$art_i < $art_cmhhcsxns$art_c; $art_ijszazhme$art_i++) {
                var sub = $art_objzvpsukfqj$art_obj[$art_ijszazhme$art_i];
        ...
        if (step.index == curStepIndex) {
            ;
            $p += '<i mxs="_zs_galleryb,:_" class="mc-iconfont _zs_gallery_mx-main_index_-arrow-icon">&#xe602;</i>';
            $line = 30;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        if (step.locked) {
            ;
            $p += '<i mxs="_zs_galleryb,:a" class="mc-iconfont _zs_gallery_mx-main_index_-locked-icon">&#xe759;</i>';
            $line = 33;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    $art = '=leftWidth';
    ;
    $p += ($expr = '<%=leftWidth%>', $e(leftWidth)) + 'px;"><div mxa="_zs_galleryb,:d" class="_zs_gallery_mx-main_index_-content-title">';
    $line = 38;
    $art = '=curStepInfo.label';
    ;
    $p += ($expr = '<%=curStepInfo.label%>', $e(curStepInfo.label)) + '</div><div mxv mxa="_zs_galleryb,:e" class="_zs_gallery_mx-main_index_-content-body"><div mxv>';
    $line = 42;
    $art = 'each curStepInfo.subs as sub';
    ;
    $expr = '<%for (var $art_iwftgbamcvm$art_i = 0, $art_objggwacgpa$art_obj = curStepInfo.subs, $art_chwkofwbho$art_c = $art_objggwacgpa$art_obj.length; $art_iwftgbamcvm$art_i < $art_chwkofwbho$art_c; $art_iwftgbamcvm$art_i++) {    var sub = $art_objggwacgpa$art_obj[$art_iwftgbamcvm$art_i]%>';
    for (var $art_iwftgbamcvm$art_i = 0, $art_objggwacgpa$art_obj = curStepInfo.subs, $art_chwkofwbho$art_c = $art_objggwacgpa$art_obj.length; $art_iwftgbamcvm$art_i < $art_chwkofwbho$art_c; $art_iwftgbamcvm$art_i++) {
        var sub = $art_objggwacgpa$art_obj[$art_iwftgbamcvm$art_i];
        ...
        $art = '=sub.index';
        ;
        $p += ($expr = '<%=sub.index%>', $e(sub.index)) + '"><div mxs="_zs_galleryb,:b" class="loading"><span class="loading-anim"></span></div></div>';
        $line = 49;
        ...
        if (sub.sideWrapper) {
            ...
            ;
            $p += ($expr = '<%=curStepInfo.rightWidth%>', $e(curStepInfo.rightWidth)) + 'px;"><div mxs="_zs_galleryb,:b" class="loading"><span class="loading-anim"></span></div></div>';
            $line = 54;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    if (!curStepInfo.customTrigger) {
        ;
        $p += '<div mxa="_zs_galleryb,:f" class="_zs_gallery_mx-main_index_-content-footer"><div>';
        $line = 69;
        ...
        if (curStepInfo.prevTip) {
            ;
            $p += '<a mxa="_zs_galleryb,:g" href="javascript:;" class="btn min-width-100 mr20" mx-click="' + $viewId + 'prev()">';
            $line = 71;
