...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijxnznihnr$art_i = 0, $art_cgqxjarza$art_c = stepInfos.length; $art_ijxnznihnr$art_i < $art_cgqxjarza$art_c; $art_ijxnznihnr$art_i++) {    var step = stepInfos[$art_ijxnznihnr$art_i]%>';
    for (var $art_ijxnznihnr$art_i = 0, $art_cgqxjarza$art_c = stepInfos.length; $art_ijxnznihnr$art_i < $art_cgqxjarza$art_c; $art_ijxnznihnr$art_i++) {
        var step = stepInfos[$art_ijxnznihnr$art_i];
        ...
        ;
        $p += '"><div mxa="_zs_gallerycE:_" class="_zs_gallery_mx-main_index_-step-over"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link _zs_gallery_mx-main_index_-step-over clearfix ';
        $line = 6;
        ...
        if (step.icon) {
            ;
            $p += '<span mxa="_zs_gallerycE:a" class="_zs_gallery_mx-main_index_-over-icon fl">';
            $line = 10;
            $art = '!step.icon';
            ;
        ...
        ;
        $p += '<span mxa="_zs_gallerycE:b" class="fl">';
        $line = 12;
        $art = '=step.label';
        ;
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iqtdempz$art_i = 0, $art_objzhwlixk$art_obj = step.subs, $art_cryhlehyv$art_c = $art_objzhwlixk$art_obj.length; $art_iqtdempz$art_i < $art_cryhlehyv$art_c; $art_iqtdempz$art_i++) {            var sub = $art_objzhwlixk$art_obj[$art_iqtdempz$art_i]%>';
            for (var $art_iqtdempz$art_i = 0, $art_objzhwlixk$art_obj = step.subs, $art_cryhlehyv$art_c = $art_objzhwlixk$art_obj.length; $art_iqtdempz$art_i < $art_cryhlehyv$art_c; $art_iqtdempz$art_i++) {
                var sub = $art_objzhwlixk$art_obj[$art_iqtdempz$art_i];
                $p += '<div mxa="_zs_gallerycE:c" class="_zs_gallery_mx-main_index_-step-sub"><a href="javascript:;" class="_zs_gallery_mx-main_index_-link ';
                $line = 19;
        ...
        if (step.index == curStepIndex) {
            ;
            $p += '<i mxs="_zs_gallerycE:_" class="mc-iconfont _zs_gallery_mx-main_index_-arrow-icon">&#xe602;</i>';
            $line = 30;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        if (step.locked) {
            ;
            $p += '<i mxs="_zs_gallerycE:a" class="mc-iconfont _zs_gallery_mx-main_index_-locked-icon">&#xe759;</i>';
            $line = 33;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    $art = '=leftWidth';
    ;
    $p += ($expr = '<%=leftWidth%>', $e(leftWidth)) + 'px;"><div mxa="_zs_gallerycE:d" class="_zs_gallery_mx-main_index_-content-title">';
    $line = 38;
    $art = '=curStepInfo.label';
    ;
    $p += ($expr = '<%=curStepInfo.label%>', $e(curStepInfo.label)) + '</div><div mxv mxa="_zs_gallerycE:e" class="_zs_gallery_mx-main_index_-content-body"><div mxv>';
    $line = 42;
    $art = 'each curStepInfo.subs as sub';
    ;
    $expr = '<%for (var $art_iyujiqwik$art_i = 0, $art_objfwfbbape$art_obj = curStepInfo.subs, $art_czaexqtc$art_c = $art_objfwfbbape$art_obj.length; $art_iyujiqwik$art_i < $art_czaexqtc$art_c; $art_iyujiqwik$art_i++) {    var sub = $art_objfwfbbape$art_obj[$art_iyujiqwik$art_i]%>';
    for (var $art_iyujiqwik$art_i = 0, $art_objfwfbbape$art_obj = curStepInfo.subs, $art_czaexqtc$art_c = $art_objfwfbbape$art_obj.length; $art_iyujiqwik$art_i < $art_czaexqtc$art_c; $art_iyujiqwik$art_i++) {
        var sub = $art_objfwfbbape$art_obj[$art_iyujiqwik$art_i];
        ...
        $art = '=sub.index';
        ;
        $p += ($expr = '<%=sub.index%>', $e(sub.index)) + '"><div mxs="_zs_gallerycE:b" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
        $line = 49;
        ...
        if (sub.sideWrapper) {
            ...
            ;
            $p += ($expr = '<%=curStepInfo.rightWidth%>', $e(curStepInfo.rightWidth)) + 'px;"><div mxs="_zs_gallerycE:b" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
            $line = 54;
            $art = '/if';
            ;
            $expr = '<%}%>';
    ...
    if (!curStepInfo.customTrigger) {
        ;
        $p += '<div mxa="_zs_gallerycE:f" class="_zs_gallery_mx-main_index_-content-footer"><div>';
        $line = 69;
        ...
        if (curStepInfo.prevTip) {
            ;
            $p += '<a mxa="_zs_gallerycE:g" href="javascript:;" class="btn min-width-100 mr20" mx-click="' + $viewId + 'prev()">';
            $line = 71;
        ...
        if (curStepInfo.nextTip) {
            ;
            $p += '<a mxa="_zs_gallerycE:h" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
            $line = 76;
