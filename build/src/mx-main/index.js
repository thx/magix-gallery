...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idcjehbw$art_i = 0, $art_crtqyoctw$art_c = stepInfos.length; $art_idcjehbw$art_i < $art_crtqyoctw$art_c; $art_idcjehbw$art_i++) {    var step = stepInfos[$art_idcjehbw$art_i]%>';
    for (var $art_idcjehbw$art_i = 0, $art_crtqyoctw$art_c = stepInfos.length; $art_idcjehbw$art_i < $art_crtqyoctw$art_c; $art_idcjehbw$art_i++) {
        var step = stepInfos[$art_idcjehbw$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ialvpmowta$art_i = 0, $art_objuvidob$art_obj = step.subs, $art_cgejuf$art_c = $art_objuvidob$art_obj.length; $art_ialvpmowta$art_i < $art_cgejuf$art_c; $art_ialvpmowta$art_i++) {            var sub = $art_objuvidob$art_obj[$art_ialvpmowta$art_i]%>';
            for (var $art_ialvpmowta$art_i = 0, $art_objuvidob$art_obj = step.subs, $art_cgejuf$art_c = $art_objuvidob$art_obj.length; $art_ialvpmowta$art_i < $art_cgejuf$art_c; $art_ialvpmowta$art_i++) {
                var sub = $art_objuvidob$art_obj[$art_ialvpmowta$art_i];
    ...
    ;
    $expr = '<%for (var $art_igulvckvwp$art_i = 0, $art_objfklqygqef$art_obj = curStepInfo.subs, $art_cefzqrttcbmi$art_c = $art_objfklqygqef$art_obj.length; $art_igulvckvwp$art_i < $art_cefzqrttcbmi$art_c; $art_igulvckvwp$art_i++) {    var sub = $art_objfklqygqef$art_obj[$art_igulvckvwp$art_i]%>';
    for (var $art_igulvckvwp$art_i = 0, $art_objfklqygqef$art_obj = curStepInfo.subs, $art_cefzqrttcbmi$art_c = $art_objfklqygqef$art_obj.length; $art_igulvckvwp$art_i < $art_cefzqrttcbmi$art_c; $art_igulvckvwp$art_i++) {
        var sub = $art_objfklqygqef$art_obj[$art_igulvckvwp$art_i];
