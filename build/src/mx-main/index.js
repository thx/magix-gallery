...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itynlqhbqr$art_i = 0, $art_cxupnbjsyk$art_c = stepInfos.length; $art_itynlqhbqr$art_i < $art_cxupnbjsyk$art_c; $art_itynlqhbqr$art_i++) {    var step = stepInfos[$art_itynlqhbqr$art_i]%>';
    for (var $art_itynlqhbqr$art_i = 0, $art_cxupnbjsyk$art_c = stepInfos.length; $art_itynlqhbqr$art_i < $art_cxupnbjsyk$art_c; $art_itynlqhbqr$art_i++) {
        var step = stepInfos[$art_itynlqhbqr$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_iftffsi$art_i = 0, $art_objdkvtxvrsb$art_obj = step.subs, $art_cdzxbdib$art_c = $art_objdkvtxvrsb$art_obj.length; $art_iftffsi$art_i < $art_cdzxbdib$art_c; $art_iftffsi$art_i++) {            var sub = $art_objdkvtxvrsb$art_obj[$art_iftffsi$art_i]%>';
            for (var $art_iftffsi$art_i = 0, $art_objdkvtxvrsb$art_obj = step.subs, $art_cdzxbdib$art_c = $art_objdkvtxvrsb$art_obj.length; $art_iftffsi$art_i < $art_cdzxbdib$art_c; $art_iftffsi$art_i++) {
                var sub = $art_objdkvtxvrsb$art_obj[$art_iftffsi$art_i];
    ...
    ;
    $expr = '<%for (var $art_izyhmnparaj$art_i = 0, $art_objksanqokee$art_obj = curStepInfo.subs, $art_cljdjzuxdj$art_c = $art_objksanqokee$art_obj.length; $art_izyhmnparaj$art_i < $art_cljdjzuxdj$art_c; $art_izyhmnparaj$art_i++) {    var sub = $art_objksanqokee$art_obj[$art_izyhmnparaj$art_i]%>';
    for (var $art_izyhmnparaj$art_i = 0, $art_objksanqokee$art_obj = curStepInfo.subs, $art_cljdjzuxdj$art_c = $art_objksanqokee$art_obj.length; $art_izyhmnparaj$art_i < $art_cljdjzuxdj$art_c; $art_izyhmnparaj$art_i++) {
        var sub = $art_objksanqokee$art_obj[$art_izyhmnparaj$art_i];
