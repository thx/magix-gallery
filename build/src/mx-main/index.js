...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaziejoe$art_i = 0, $art_cgoltjwcdv$art_c = stepInfos.length; $art_iaziejoe$art_i < $art_cgoltjwcdv$art_c; $art_iaziejoe$art_i++) {    var step = stepInfos[$art_iaziejoe$art_i]%>';
    for (var $art_iaziejoe$art_i = 0, $art_cgoltjwcdv$art_c = stepInfos.length; $art_iaziejoe$art_i < $art_cgoltjwcdv$art_c; $art_iaziejoe$art_i++) {
        var step = stepInfos[$art_iaziejoe$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_ibvysxwrai$art_i = 0, $art_objfgupufd$art_obj = step.subs, $art_cxmbshenh$art_c = $art_objfgupufd$art_obj.length; $art_ibvysxwrai$art_i < $art_cxmbshenh$art_c; $art_ibvysxwrai$art_i++) {            var sub = $art_objfgupufd$art_obj[$art_ibvysxwrai$art_i]%>';
            for (var $art_ibvysxwrai$art_i = 0, $art_objfgupufd$art_obj = step.subs, $art_cxmbshenh$art_c = $art_objfgupufd$art_obj.length; $art_ibvysxwrai$art_i < $art_cxmbshenh$art_c; $art_ibvysxwrai$art_i++) {
                var sub = $art_objfgupufd$art_obj[$art_ibvysxwrai$art_i];
    ...
    ;
    $expr = '<%for (var $art_iencfartyl$art_i = 0, $art_objogqniqgx$art_obj = curStepInfo.subs, $art_cliupdi$art_c = $art_objogqniqgx$art_obj.length; $art_iencfartyl$art_i < $art_cliupdi$art_c; $art_iencfartyl$art_i++) {    var sub = $art_objogqniqgx$art_obj[$art_iencfartyl$art_i]%>';
    for (var $art_iencfartyl$art_i = 0, $art_objogqniqgx$art_obj = curStepInfo.subs, $art_cliupdi$art_c = $art_objogqniqgx$art_obj.length; $art_iencfartyl$art_i < $art_cliupdi$art_c; $art_iencfartyl$art_i++) {
        var sub = $art_objogqniqgx$art_obj[$art_iencfartyl$art_i];
