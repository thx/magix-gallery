...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqfqast$art_i = 0, $art_ccdkjgsfic$art_c = stepInfos.length; $art_iqfqast$art_i < $art_ccdkjgsfic$art_c; $art_iqfqast$art_i++) {    var step = stepInfos[$art_iqfqast$art_i]%>';
    for (var $art_iqfqast$art_i = 0, $art_ccdkjgsfic$art_c = stepInfos.length; $art_iqfqast$art_i < $art_ccdkjgsfic$art_c; $art_iqfqast$art_i++) {
        var step = stepInfos[$art_iqfqast$art_i];
        ...
        if (!step.locked && step.subs.length > 1) {
            ...
            ;
            $expr = '<%for (var $art_irnsxwea$art_i = 0, $art_objqmkusypndg$art_obj = step.subs, $art_cevijawqlkd$art_c = $art_objqmkusypndg$art_obj.length; $art_irnsxwea$art_i < $art_cevijawqlkd$art_c; $art_irnsxwea$art_i++) {            var sub = $art_objqmkusypndg$art_obj[$art_irnsxwea$art_i]%>';
            for (var $art_irnsxwea$art_i = 0, $art_objqmkusypndg$art_obj = step.subs, $art_cevijawqlkd$art_c = $art_objqmkusypndg$art_obj.length; $art_irnsxwea$art_i < $art_cevijawqlkd$art_c; $art_irnsxwea$art_i++) {
                var sub = $art_objqmkusypndg$art_obj[$art_irnsxwea$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqnfgfxm$art_i = 0, $art_objcdetu$art_obj = curStepInfo.subs, $art_cciywdupne$art_c = $art_objcdetu$art_obj.length; $art_iqnfgfxm$art_i < $art_cciywdupne$art_c; $art_iqnfgfxm$art_i++) {    var sub = $art_objcdetu$art_obj[$art_iqnfgfxm$art_i]%>';
    for (var $art_iqnfgfxm$art_i = 0, $art_objcdetu$art_obj = curStepInfo.subs, $art_cciywdupne$art_c = $art_objcdetu$art_obj.length; $art_iqnfgfxm$art_i < $art_cciywdupne$art_c; $art_iqnfgfxm$art_i++) {
        var sub = $art_objcdetu$art_obj[$art_iqnfgfxm$art_i];
