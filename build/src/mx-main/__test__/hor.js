...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_gallerybZ:_" class="clearfix"><div mx-view="mx-main/__test__/hor-demo"></div></div><div mxs="_zs_gallerybZ:a" mx-view="mx-main/__test__/steps"></div></div>';
}
catch (ex) {
