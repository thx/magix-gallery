...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerycc:a" class="clearfix"><div mxa="_zs_gallerycc:b" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerycc:_" class="_zs_gallery___test___layout_-eg-content"><a href="#!/main/demo" target="_blank" rel="noopener noreferrer" class="color-brand">新页面查看示例</a></div><div mxa="_zs_gallerycc:c" class="clearfix"><div mxa="_zs_gallerycc:d" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_gallerycc:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 29;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_step" mx-view="mx-title/second?content=step-infos%E9%85%8D%E7%BD%AE%E8%AF%B4%E6%98%8E"></div><div mxa="_zs_gallerycc:i" class="mb40"><div class="mb10" id="';
    $line = 156;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_step1">1. step-infos数组所有可配参数说明</div><div mxs="_zs_gallerycc:d" class="pl15 mb20"><pre class="tip-content">\n[{\n    label: \'必填，一级标题文案\',\n    prevTip: \'可选，自定义返回上一步文案，默认返回上一步\'\n    nextTip: \'可选，自定义下一步文案，默认返回下一步\',\n    icon: \'可选，标题icon\',\n    sideTip: \'可选，所有子view公用一个侧边提示，使用默认样式\',\n    sideView: \'可选，所有子view公用一个侧边提示，自定义view\',\n    subs: [{\n        label: \'必填，二级标题文案，当只有一个二级标题时，不显示二级标题\',\n        icon: \'可选，二级标题icon\',\n        view: \'必填，二级标题对应的view，该view必须实现check方法\',\n        sideTip: \'可选，二级view对应的自己单独的侧标提示，使用默认样式\',\n        sideView: \'可选，二级view对应的自己单独的侧标提示，自定义view\',\n    }, {\n        label: \'必填，二级标题文案\',\n        icon: \'可选，二级标题icon\',\n        view: \'必填，二级标题对应的view，该view必须实现check方法\'\n    }],\n    nextFn: (remains, next) => {\n        // remains 当前所有子步骤保留的信息交集，便于提交接口处理等\n        // next(remainParams:object) 保存在路由上的参数\n        next({\n            example: 1\n        })\n    }\n}]\n                </pre></div><div class="mb10" id="';
    $line = 187;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_step2">2. 子view必须实现的check方法说明，返回一个Promise</div><div mxs="_zs_gallerycc:e" class="pl15"><pre class="tip-content">\ncheck() {\n    let ok = true,\n        remain = {};\n\n    return new Promise((resolve) => {\n        // 此处返回promise，防止有接口提交校验等\n        resolve({\n            ok,  // 是否校验通过，false的时候不提交\n            msg: \'错误信息提示\',\n            remain: {} // 当前步骤保留的参数，所有子view交集\n        })\n    })\n}\n                </pre></div></div></div></div>';
}
catch (ex) {
