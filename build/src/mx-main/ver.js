...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itarwwubl$art_i = 0, $art_ccjbbodrbe$art_c = stepInfos.length; $art_itarwwubl$art_i < $art_ccjbbodrbe$art_c; $art_itarwwubl$art_i++) {    var step = stepInfos[$art_itarwwubl$art_i]%>';
    for (var $art_itarwwubl$art_i = 0, $art_ccjbbodrbe$art_c = stepInfos.length; $art_itarwwubl$art_i < $art_ccjbbodrbe$art_c; $art_itarwwubl$art_i++) {
        var step = stepInfos[$art_itarwwubl$art_i];
