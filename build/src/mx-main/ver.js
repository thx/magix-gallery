...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaqlpqqmkaj$art_i = 0, $art_cvbrrliur$art_c = stepInfos.length; $art_iaqlpqqmkaj$art_i < $art_cvbrrliur$art_c; $art_iaqlpqqmkaj$art_i++) {    var step = stepInfos[$art_iaqlpqqmkaj$art_i]%>';
    for (var $art_iaqlpqqmkaj$art_i = 0, $art_cvbrrliur$art_c = stepInfos.length; $art_iaqlpqqmkaj$art_i < $art_cvbrrliur$art_c; $art_iaqlpqqmkaj$art_i++) {
        var step = stepInfos[$art_iaqlpqqmkaj$art_i];
        $p += '<div mxv mxa="_zs_gallerycS:_" class="clearfix _zs_gallery_mx-main_ver_-step"><div mxa="_zs_gallerycS:a" class="_zs_gallery_mx-main_ver_-circle">';
        $line = 3;
        $art = '!step.icon';
        ;
        ...
        if (step.index < stepInfos.length) {
            ;
            $p += '<div mxs="_zs_gallerycS:_" class="_zs_gallery_mx-main_ver_-line"></div>';
            $line = 6;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        ;
        $p += '<div mxv mxa="_zs_gallerycS:b" class="_zs_gallery_mx-main_ver_-content"><div mxa="_zs_gallerycS:c" class="_zs_gallery_mx-main_ver_-title"><span mxa="_zs_gallerycS:d" class="fontsize-16">';
        $line = 9;
        $art = '=step.label';
        ;
        ...
        if (step.current) {
            ;
            $p += '<div mxv mxa="_zs_gallerycS:e" class="_zs_gallery_mx-main_ver_-inner"><div mxv="curStepInfo" mx-view="';
            $line = 17;
            ...
            $art = '=viewId';
            ;
            $p += ($expr = '<%=viewId%>', $e(viewId)) + '_cur_content"><div mxs="_zs_gallerycS:a" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div><div mxa="_zs_gallerycS:f" class="pt20">';
            $line = 22;
            ...
            if (curStepInfo.prevTip) {
                ;
                $p += '<a mxa="_zs_gallerycS:g" href="javascript:;" class="btn min-width-100 mr15" mx-click="' + $viewId + 'prev()">';
                $line = 24;
