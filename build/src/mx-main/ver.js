...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilezketwxk$art_i = 0, $art_czlkhtortq$art_c = stepInfos.length; $art_ilezketwxk$art_i < $art_czlkhtortq$art_c; $art_ilezketwxk$art_i++) {    var step = stepInfos[$art_ilezketwxk$art_i]%>';
    for (var $art_ilezketwxk$art_i = 0, $art_czlkhtortq$art_c = stepInfos.length; $art_ilezketwxk$art_i < $art_czlkhtortq$art_c; $art_ilezketwxk$art_i++) {
        var step = stepInfos[$art_ilezketwxk$art_i];
        $p += '<div mxv mxa="_zs_gallerycX:_" class="clearfix _zs_gallery_mx-main_ver_-step"><div mxa="_zs_gallerycX:a" class="_zs_gallery_mx-main_ver_-circle">';
        $line = 3;
        $art = '!step.icon';
        ;
        ...
        if (step.index < stepInfos.length) {
            ;
            $p += '<div mxs="_zs_gallerycX:_" class="_zs_gallery_mx-main_ver_-line"></div>';
            $line = 6;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        ;
        $p += '<div mxv mxa="_zs_gallerycX:b" class="grid"><div content="';
        $line = 9;
        $art = '=step.label';
        ;
        $p += ($expr = '<%=step.label%>', $e(step.label)) + '" class="clearfix" style="padding: 10px 24px;;"><div mxa="_zs_gallerycX:c" style="float:left; height: 32px; line-height: 32px;"><span mxa="_zs_gallerycX:d" style="font-size: 16px; margin-right: 16px;">';
        $line = 9;
        $art = '=step.label';
        ;
        ...
        if (step.current) {
            ;
            $p += '<div mxv mxa="_zs_gallerycX:e" class="clearfix bt-e6" style="padding: 16px 24px;"><div mxv="curStepInfo" mx-view="';
            $line = 18;
            ...
            $art = '=viewId';
            ;
            $p += ($expr = '<%=viewId%>', $e(viewId)) + '_cur_content"><div mxs="_zs_gallerycX:a" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div><div mxa="_zs_gallerycX:f" class="pt20">';
            $line = 23;
            ...
            if (curStepInfo.prevTip) {
                ;
                $p += '<a mxa="_zs_gallerycX:g" href="javascript:;" class="btn min-width-100 mr15" mx-click="' + $viewId + 'prev()">';
                $line = 25;
