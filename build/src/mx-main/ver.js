...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iykopnjff$art_i = 0, $art_cubzjmlips$art_c = stepInfos.length; $art_iykopnjff$art_i < $art_cubzjmlips$art_c; $art_iykopnjff$art_i++) {    var step = stepInfos[$art_iykopnjff$art_i]%>';
    for (var $art_iykopnjff$art_i = 0, $art_cubzjmlips$art_c = stepInfos.length; $art_iykopnjff$art_i < $art_cubzjmlips$art_c; $art_iykopnjff$art_i++) {
        var step = stepInfos[$art_iykopnjff$art_i];
