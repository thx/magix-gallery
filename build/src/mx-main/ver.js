...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imgk$art_i = 0, $art_cjwtfqghoq$art_c = stepInfos.length; $art_imgk$art_i < $art_cjwtfqghoq$art_c; $art_imgk$art_i++) {    var step = stepInfos[$art_imgk$art_i]%>';
    for (var $art_imgk$art_i = 0, $art_cjwtfqghoq$art_c = stepInfos.length; $art_imgk$art_i < $art_cjwtfqghoq$art_c; $art_imgk$art_i++) {
        var step = stepInfos[$art_imgk$art_i];
