...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqqwtzugr$art_i = 0, $art_cjnftn$art_c = stepInfos.length; $art_iqqwtzugr$art_i < $art_cjnftn$art_c; $art_iqqwtzugr$art_i++) {    var step = stepInfos[$art_iqqwtzugr$art_i]%>';
    for (var $art_iqqwtzugr$art_i = 0, $art_cjnftn$art_c = stepInfos.length; $art_iqqwtzugr$art_i < $art_cjnftn$art_c; $art_iqqwtzugr$art_i++) {
        var step = stepInfos[$art_iqqwtzugr$art_i];
