...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipjmaakfa$art_i = 0, $art_cumjecuyqlxa$art_c = stepInfos.length; $art_ipjmaakfa$art_i < $art_cumjecuyqlxa$art_c; $art_ipjmaakfa$art_i++) {    var step = stepInfos[$art_ipjmaakfa$art_i]%>';
    for (var $art_ipjmaakfa$art_i = 0, $art_cumjecuyqlxa$art_c = stepInfos.length; $art_ipjmaakfa$art_i < $art_cumjecuyqlxa$art_c; $art_ipjmaakfa$art_i++) {
        var step = stepInfos[$art_ipjmaakfa$art_i];
