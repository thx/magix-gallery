...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iclxolfflp$art_i = 0, $art_cpxhbiim$art_c = stepInfos.length; $art_iclxolfflp$art_i < $art_cpxhbiim$art_c; $art_iclxolfflp$art_i++) {    var step = stepInfos[$art_iclxolfflp$art_i]%>';
    for (var $art_iclxolfflp$art_i = 0, $art_cpxhbiim$art_c = stepInfos.length; $art_iclxolfflp$art_i < $art_cpxhbiim$art_c; $art_iclxolfflp$art_i++) {
        var step = stepInfos[$art_iclxolfflp$art_i];
