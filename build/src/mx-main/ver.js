...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itgubud$art_i = 0, $art_cecyiiluj$art_c = stepInfos.length; $art_itgubud$art_i < $art_cecyiiluj$art_c; $art_itgubud$art_i++) {    var step = stepInfos[$art_itgubud$art_i]%>';
    for (var $art_itgubud$art_i = 0, $art_cecyiiluj$art_c = stepInfos.length; $art_itgubud$art_i < $art_cecyiiluj$art_c; $art_itgubud$art_i++) {
        var step = stepInfos[$art_itgubud$art_i];
