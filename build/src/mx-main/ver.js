...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikyxzoj$art_i = 0, $art_cfginlwsae$art_c = stepInfos.length; $art_ikyxzoj$art_i < $art_cfginlwsae$art_c; $art_ikyxzoj$art_i++) {    var step = stepInfos[$art_ikyxzoj$art_i]%>';
    for (var $art_ikyxzoj$art_i = 0, $art_cfginlwsae$art_c = stepInfos.length; $art_ikyxzoj$art_i < $art_cfginlwsae$art_c; $art_ikyxzoj$art_i++) {
        var step = stepInfos[$art_ikyxzoj$art_i];
