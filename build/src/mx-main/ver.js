...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihqinsrd$art_i = 0, $art_cujbvpxg$art_c = stepInfos.length; $art_ihqinsrd$art_i < $art_cujbvpxg$art_c; $art_ihqinsrd$art_i++) {    var step = stepInfos[$art_ihqinsrd$art_i]%>';
    for (var $art_ihqinsrd$art_i = 0, $art_cujbvpxg$art_c = stepInfos.length; $art_ihqinsrd$art_i < $art_cujbvpxg$art_c; $art_ihqinsrd$art_i++) {
        var step = stepInfos[$art_ihqinsrd$art_i];
