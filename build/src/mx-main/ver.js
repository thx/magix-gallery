...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifurumslxb$art_i = 0, $art_cjscxeeirv$art_c = stepInfos.length; $art_ifurumslxb$art_i < $art_cjscxeeirv$art_c; $art_ifurumslxb$art_i++) {    var step = stepInfos[$art_ifurumslxb$art_i]%>';
    for (var $art_ifurumslxb$art_i = 0, $art_cjscxeeirv$art_c = stepInfos.length; $art_ifurumslxb$art_i < $art_cjscxeeirv$art_c; $art_ifurumslxb$art_i++) {
        var step = stepInfos[$art_ifurumslxb$art_i];
