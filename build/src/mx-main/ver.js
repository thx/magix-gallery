...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itrhdfmj$art_i = 0, $art_cwrdzkwlpf$art_c = stepInfos.length; $art_itrhdfmj$art_i < $art_cwrdzkwlpf$art_c; $art_itrhdfmj$art_i++) {    var step = stepInfos[$art_itrhdfmj$art_i]%>';
    for (var $art_itrhdfmj$art_i = 0, $art_cwrdzkwlpf$art_c = stepInfos.length; $art_itrhdfmj$art_i < $art_cwrdzkwlpf$art_c; $art_itrhdfmj$art_i++) {
        var step = stepInfos[$art_itrhdfmj$art_i];
