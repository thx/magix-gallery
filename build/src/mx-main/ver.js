...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idoygpsvnr$art_i = 0, $art_cjnyhbu$art_c = stepInfos.length; $art_idoygpsvnr$art_i < $art_cjnyhbu$art_c; $art_idoygpsvnr$art_i++) {    var step = stepInfos[$art_idoygpsvnr$art_i]%>';
    for (var $art_idoygpsvnr$art_i = 0, $art_cjnyhbu$art_c = stepInfos.length; $art_idoygpsvnr$art_i < $art_cjnyhbu$art_c; $art_idoygpsvnr$art_i++) {
        var step = stepInfos[$art_idoygpsvnr$art_i];
