...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iehcznjp$art_i = 0, $art_carqeoqyzki$art_c = stepInfos.length; $art_iehcznjp$art_i < $art_carqeoqyzki$art_c; $art_iehcznjp$art_i++) {    var step = stepInfos[$art_iehcznjp$art_i]%>';
    for (var $art_iehcznjp$art_i = 0, $art_carqeoqyzki$art_c = stepInfos.length; $art_iehcznjp$art_i < $art_carqeoqyzki$art_c; $art_iehcznjp$art_i++) {
        var step = stepInfos[$art_iehcznjp$art_i];
