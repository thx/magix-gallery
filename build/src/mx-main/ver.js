...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icpaixjm$art_i = 0, $art_ckuzglrzn$art_c = stepInfos.length; $art_icpaixjm$art_i < $art_ckuzglrzn$art_c; $art_icpaixjm$art_i++) {    var step = stepInfos[$art_icpaixjm$art_i]%>';
    for (var $art_icpaixjm$art_i = 0, $art_ckuzglrzn$art_c = stepInfos.length; $art_icpaixjm$art_i < $art_ckuzglrzn$art_c; $art_icpaixjm$art_i++) {
        var step = stepInfos[$art_icpaixjm$art_i];
