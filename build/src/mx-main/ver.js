...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieezqvnyzq$art_i = 0, $art_ctinkcoqp$art_c = stepInfos.length; $art_ieezqvnyzq$art_i < $art_ctinkcoqp$art_c; $art_ieezqvnyzq$art_i++) {    var step = stepInfos[$art_ieezqvnyzq$art_i]%>';
    for (var $art_ieezqvnyzq$art_i = 0, $art_ctinkcoqp$art_c = stepInfos.length; $art_ieezqvnyzq$art_i < $art_ctinkcoqp$art_c; $art_ieezqvnyzq$art_i++) {
        var step = stepInfos[$art_ieezqvnyzq$art_i];
