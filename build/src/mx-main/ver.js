...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwzquzmgrd$art_i = 0, $art_cttjwugv$art_c = stepInfos.length; $art_iwzquzmgrd$art_i < $art_cttjwugv$art_c; $art_iwzquzmgrd$art_i++) {    var step = stepInfos[$art_iwzquzmgrd$art_i]%>';
    for (var $art_iwzquzmgrd$art_i = 0, $art_cttjwugv$art_c = stepInfos.length; $art_iwzquzmgrd$art_i < $art_cttjwugv$art_c; $art_iwzquzmgrd$art_i++) {
        var step = stepInfos[$art_iwzquzmgrd$art_i];
