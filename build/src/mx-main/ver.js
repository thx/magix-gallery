...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iekemcntn$art_i = 0, $art_cnhywsyzij$art_c = stepInfos.length; $art_iekemcntn$art_i < $art_cnhywsyzij$art_c; $art_iekemcntn$art_i++) {    var step = stepInfos[$art_iekemcntn$art_i]%>';
    for (var $art_iekemcntn$art_i = 0, $art_cnhywsyzij$art_c = stepInfos.length; $art_iekemcntn$art_i < $art_cnhywsyzij$art_c; $art_iekemcntn$art_i++) {
        var step = stepInfos[$art_iekemcntn$art_i];
