...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilxmhnvbfm$art_i = 0, $art_cwallcmuoj$art_c = stepInfos.length; $art_ilxmhnvbfm$art_i < $art_cwallcmuoj$art_c; $art_ilxmhnvbfm$art_i++) {    var step = stepInfos[$art_ilxmhnvbfm$art_i]%>';
    for (var $art_ilxmhnvbfm$art_i = 0, $art_cwallcmuoj$art_c = stepInfos.length; $art_ilxmhnvbfm$art_i < $art_cwallcmuoj$art_c; $art_ilxmhnvbfm$art_i++) {
        var step = stepInfos[$art_ilxmhnvbfm$art_i];
