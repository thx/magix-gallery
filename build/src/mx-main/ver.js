...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irjqtlxapgm$art_i = 0, $art_ciitga$art_c = stepInfos.length; $art_irjqtlxapgm$art_i < $art_ciitga$art_c; $art_irjqtlxapgm$art_i++) {    var step = stepInfos[$art_irjqtlxapgm$art_i]%>';
    for (var $art_irjqtlxapgm$art_i = 0, $art_ciitga$art_c = stepInfos.length; $art_irjqtlxapgm$art_i < $art_ciitga$art_c; $art_irjqtlxapgm$art_i++) {
        var step = stepInfos[$art_irjqtlxapgm$art_i];
