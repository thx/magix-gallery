...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inlunukw$art_i = 0, $art_csklicpkr$art_c = stepInfos.length; $art_inlunukw$art_i < $art_csklicpkr$art_c; $art_inlunukw$art_i++) {    var step = stepInfos[$art_inlunukw$art_i]%>';
    for (var $art_inlunukw$art_i = 0, $art_csklicpkr$art_c = stepInfos.length; $art_inlunukw$art_i < $art_csklicpkr$art_c; $art_inlunukw$art_i++) {
        var step = stepInfos[$art_inlunukw$art_i];
