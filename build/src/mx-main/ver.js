...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijzjldtwle$art_i = 0, $art_cqbxjdqn$art_c = stepInfos.length; $art_ijzjldtwle$art_i < $art_cqbxjdqn$art_c; $art_ijzjldtwle$art_i++) {    var step = stepInfos[$art_ijzjldtwle$art_i]%>';
    for (var $art_ijzjldtwle$art_i = 0, $art_cqbxjdqn$art_c = stepInfos.length; $art_ijzjldtwle$art_i < $art_cqbxjdqn$art_c; $art_ijzjldtwle$art_i++) {
        var step = stepInfos[$art_ijzjldtwle$art_i];
