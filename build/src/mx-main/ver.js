...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ippplrseo$art_i = 0, $art_cogxrc$art_c = stepInfos.length; $art_ippplrseo$art_i < $art_cogxrc$art_c; $art_ippplrseo$art_i++) {    var step = stepInfos[$art_ippplrseo$art_i]%>';
    for (var $art_ippplrseo$art_i = 0, $art_cogxrc$art_c = stepInfos.length; $art_ippplrseo$art_i < $art_cogxrc$art_c; $art_ippplrseo$art_i++) {
        var step = stepInfos[$art_ippplrseo$art_i];
