...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilmtdnzw$art_i = 0, $art_cxxlmvmzs$art_c = stepInfos.length; $art_ilmtdnzw$art_i < $art_cxxlmvmzs$art_c; $art_ilmtdnzw$art_i++) {    var step = stepInfos[$art_ilmtdnzw$art_i]%>';
    for (var $art_ilmtdnzw$art_i = 0, $art_cxxlmvmzs$art_c = stepInfos.length; $art_ilmtdnzw$art_i < $art_cxxlmvmzs$art_c; $art_ilmtdnzw$art_i++) {
        var step = stepInfos[$art_ilmtdnzw$art_i];
