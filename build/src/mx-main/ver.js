...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imnahonper$art_i = 0, $art_cteswnyyg$art_c = stepInfos.length; $art_imnahonper$art_i < $art_cteswnyyg$art_c; $art_imnahonper$art_i++) {    var step = stepInfos[$art_imnahonper$art_i]%>';
    for (var $art_imnahonper$art_i = 0, $art_cteswnyyg$art_c = stepInfos.length; $art_imnahonper$art_i < $art_cteswnyyg$art_c; $art_imnahonper$art_i++) {
        var step = stepInfos[$art_imnahonper$art_i];
        ...
        ;
        $p += '<div mxv mxa="_zs_galleryc4:b" class="_zs_gallery_mx-main_ver_-content"><div mxa="_zs_galleryc4:c" class="_zs_gallery_mx-main_ver_-title"><span mxa="_zs_galleryc4:d" class="fontsize-16">';
        $line = 9;
        $art = '=step.label';
        ;
        ...
        if (step.current) {
            ;
            $p += '<div mxv mxa="_zs_galleryc4:e" class="_zs_gallery_mx-main_ver_-inner"><div mxv="curStepInfo" mx-view="';
            $line = 17;
