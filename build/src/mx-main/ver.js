...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iubckjaob$art_i = 0, $art_cnsezcnzyc$art_c = stepInfos.length; $art_iubckjaob$art_i < $art_cnsezcnzyc$art_c; $art_iubckjaob$art_i++) {    var step = stepInfos[$art_iubckjaob$art_i]%>';
    for (var $art_iubckjaob$art_i = 0, $art_cnsezcnzyc$art_c = stepInfos.length; $art_iubckjaob$art_i < $art_cnsezcnzyc$art_c; $art_iubckjaob$art_i++) {
        var step = stepInfos[$art_iubckjaob$art_i];
