...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irqbovup$art_i = 0, $art_cupczxbf$art_c = stepInfos.length; $art_irqbovup$art_i < $art_cupczxbf$art_c; $art_irqbovup$art_i++) {    var step = stepInfos[$art_irqbovup$art_i]%>';
    for (var $art_irqbovup$art_i = 0, $art_cupczxbf$art_c = stepInfos.length; $art_irqbovup$art_i < $art_cupczxbf$art_c; $art_irqbovup$art_i++) {
        var step = stepInfos[$art_irqbovup$art_i];
