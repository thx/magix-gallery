...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikqtxxcphzp$art_i = 0, $art_cnwetvzks$art_c = stepInfos.length; $art_ikqtxxcphzp$art_i < $art_cnwetvzks$art_c; $art_ikqtxxcphzp$art_i++) {    var step = stepInfos[$art_ikqtxxcphzp$art_i]%>';
    for (var $art_ikqtxxcphzp$art_i = 0, $art_cnwetvzks$art_c = stepInfos.length; $art_ikqtxxcphzp$art_i < $art_cnwetvzks$art_c; $art_ikqtxxcphzp$art_i++) {
        var step = stepInfos[$art_ikqtxxcphzp$art_i];
