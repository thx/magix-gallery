...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idkdtrauo$art_i = 0, $art_cubvrzzrq$art_c = stepInfos.length; $art_idkdtrauo$art_i < $art_cubvrzzrq$art_c; $art_idkdtrauo$art_i++) {    var step = stepInfos[$art_idkdtrauo$art_i]%>';
    for (var $art_idkdtrauo$art_i = 0, $art_cubvrzzrq$art_c = stepInfos.length; $art_idkdtrauo$art_i < $art_cubvrzzrq$art_c; $art_idkdtrauo$art_i++) {
        var step = stepInfos[$art_idkdtrauo$art_i];
