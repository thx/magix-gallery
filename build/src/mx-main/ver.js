...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irzkweixgw$art_i = 0, $art_cyswptfbct$art_c = stepInfos.length; $art_irzkweixgw$art_i < $art_cyswptfbct$art_c; $art_irzkweixgw$art_i++) {    var step = stepInfos[$art_irzkweixgw$art_i]%>';
    for (var $art_irzkweixgw$art_i = 0, $art_cyswptfbct$art_c = stepInfos.length; $art_irzkweixgw$art_i < $art_cyswptfbct$art_c; $art_irzkweixgw$art_i++) {
        var step = stepInfos[$art_irzkweixgw$art_i];
