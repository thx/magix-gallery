...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivrnvcxbhf$art_i = 0, $art_cbdkodth$art_c = stepInfos.length; $art_ivrnvcxbhf$art_i < $art_cbdkodth$art_c; $art_ivrnvcxbhf$art_i++) {    var step = stepInfos[$art_ivrnvcxbhf$art_i]%>';
    for (var $art_ivrnvcxbhf$art_i = 0, $art_cbdkodth$art_c = stepInfos.length; $art_ivrnvcxbhf$art_i < $art_cbdkodth$art_c; $art_ivrnvcxbhf$art_i++) {
        var step = stepInfos[$art_ivrnvcxbhf$art_i];
