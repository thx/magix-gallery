...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irbovswkmwp$art_i = 0, $art_cqpooqnili$art_c = stepInfos.length; $art_irbovswkmwp$art_i < $art_cqpooqnili$art_c; $art_irbovswkmwp$art_i++) {    var step = stepInfos[$art_irbovswkmwp$art_i]%>';
    for (var $art_irbovswkmwp$art_i = 0, $art_cqpooqnili$art_c = stepInfos.length; $art_irbovswkmwp$art_i < $art_cqpooqnili$art_c; $art_irbovswkmwp$art_i++) {
        var step = stepInfos[$art_irbovswkmwp$art_i];
        ...
        if (step.index < stepInfos.length) {
            ;
            $p += '<div mxs="_zs_galleryc_:_" class="_zs_gallery_mx-main_ver_-line"></div>';
            $line = 6;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        ;
        $p += '<div mxv mxa="_zs_galleryc_:b" class="_zs_gallery_mx-main_ver_-content"><div mxa="_zs_galleryc_:c" class="_zs_gallery_mx-main_ver_-title"><span mxa="_zs_galleryc_:d" class="fontsize-16">';
        $line = 9;
        $art = '=step.label';
        ;
        ...
        if (step.current) {
            ;
            $p += '<div mxv mxa="_zs_galleryc_:e" class="_zs_gallery_mx-main_ver_-inner"><div mxv="curStepInfo" mx-view="';
            $line = 17;
            ...
            $art = '=viewId';
            ;
            $p += ($expr = '<%=viewId%>', $e(viewId)) + '_cur_content"><div mxs="_zs_galleryc_:a" class="loading"><span class="loading-anim"></span></div></div><div mxa="_zs_galleryc_:f" class="pt20">';
            $line = 22;
            ...
            if (curStepInfo.prevTip) {
                ;
                $p += '<a mxa="_zs_galleryc_:g" href="javascript:;" class="btn min-width-100 mr15" mx-click="' + $viewId + 'prev()">';
                $line = 24;
            ...
            if (curStepInfo.nextTip) {
                ;
                $p += '<a mxa="_zs_galleryc_:h" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
                $line = 29;
