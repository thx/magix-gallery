...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itlccpenj$art_i = 0, $art_cyarmugan$art_c = stepInfos.length; $art_itlccpenj$art_i < $art_cyarmugan$art_c; $art_itlccpenj$art_i++) {    var step = stepInfos[$art_itlccpenj$art_i]%>';
    for (var $art_itlccpenj$art_i = 0, $art_cyarmugan$art_c = stepInfos.length; $art_itlccpenj$art_i < $art_cyarmugan$art_c; $art_itlccpenj$art_i++) {
        var step = stepInfos[$art_itlccpenj$art_i];
