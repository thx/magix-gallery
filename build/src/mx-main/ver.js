...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iszpmmbra$art_i = 0, $art_chljjyufakhd$art_c = stepInfos.length; $art_iszpmmbra$art_i < $art_chljjyufakhd$art_c; $art_iszpmmbra$art_i++) {    var step = stepInfos[$art_iszpmmbra$art_i]%>';
    for (var $art_iszpmmbra$art_i = 0, $art_chljjyufakhd$art_c = stepInfos.length; $art_iszpmmbra$art_i < $art_chljjyufakhd$art_c; $art_iszpmmbra$art_i++) {
        var step = stepInfos[$art_iszpmmbra$art_i];
