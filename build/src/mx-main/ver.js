...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaxyclafigt$art_i = 0, $art_cyilejke$art_c = stepInfos.length; $art_iaxyclafigt$art_i < $art_cyilejke$art_c; $art_iaxyclafigt$art_i++) {    var step = stepInfos[$art_iaxyclafigt$art_i]%>';
    for (var $art_iaxyclafigt$art_i = 0, $art_cyilejke$art_c = stepInfos.length; $art_iaxyclafigt$art_i < $art_cyilejke$art_c; $art_iaxyclafigt$art_i++) {
        var step = stepInfos[$art_iaxyclafigt$art_i];
