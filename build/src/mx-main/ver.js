...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_immtnnxbi$art_i = 0, $art_cbtxxemfc$art_c = stepInfos.length; $art_immtnnxbi$art_i < $art_cbtxxemfc$art_c; $art_immtnnxbi$art_i++) {    var step = stepInfos[$art_immtnnxbi$art_i]%>';
    for (var $art_immtnnxbi$art_i = 0, $art_cbtxxemfc$art_c = stepInfos.length; $art_immtnnxbi$art_i < $art_cbtxxemfc$art_c; $art_immtnnxbi$art_i++) {
        var step = stepInfos[$art_immtnnxbi$art_i];
