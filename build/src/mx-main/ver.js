...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieaqtwabk$art_i = 0, $art_cuqkxpkv$art_c = stepInfos.length; $art_ieaqtwabk$art_i < $art_cuqkxpkv$art_c; $art_ieaqtwabk$art_i++) {    var step = stepInfos[$art_ieaqtwabk$art_i]%>';
    for (var $art_ieaqtwabk$art_i = 0, $art_cuqkxpkv$art_c = stepInfos.length; $art_ieaqtwabk$art_i < $art_cuqkxpkv$art_c; $art_ieaqtwabk$art_i++) {
        var step = stepInfos[$art_ieaqtwabk$art_i];
