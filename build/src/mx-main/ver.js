...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iszqalvzr$art_i = 0, $art_cbgpinxcqh$art_c = stepInfos.length; $art_iszqalvzr$art_i < $art_cbgpinxcqh$art_c; $art_iszqalvzr$art_i++) {    var step = stepInfos[$art_iszqalvzr$art_i]%>';
    for (var $art_iszqalvzr$art_i = 0, $art_cbgpinxcqh$art_c = stepInfos.length; $art_iszqalvzr$art_i < $art_cbgpinxcqh$art_c; $art_iszqalvzr$art_i++) {
        var step = stepInfos[$art_iszqalvzr$art_i];
