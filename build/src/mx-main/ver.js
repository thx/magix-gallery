...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibrmnbomr$art_i = 0, $art_cmthueqx$art_c = stepInfos.length; $art_ibrmnbomr$art_i < $art_cmthueqx$art_c; $art_ibrmnbomr$art_i++) {    var step = stepInfos[$art_ibrmnbomr$art_i]%>';
    for (var $art_ibrmnbomr$art_i = 0, $art_cmthueqx$art_c = stepInfos.length; $art_ibrmnbomr$art_i < $art_cmthueqx$art_c; $art_ibrmnbomr$art_i++) {
        var step = stepInfos[$art_ibrmnbomr$art_i];
