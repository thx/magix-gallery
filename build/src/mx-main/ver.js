...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaiajpw$art_i = 0, $art_czolyxalp$art_c = stepInfos.length; $art_iaiajpw$art_i < $art_czolyxalp$art_c; $art_iaiajpw$art_i++) {    var step = stepInfos[$art_iaiajpw$art_i]%>';
    for (var $art_iaiajpw$art_i = 0, $art_czolyxalp$art_c = stepInfos.length; $art_iaiajpw$art_i < $art_czolyxalp$art_c; $art_iaiajpw$art_i++) {
        var step = stepInfos[$art_iaiajpw$art_i];
