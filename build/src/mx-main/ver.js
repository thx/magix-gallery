...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixigwqbt$art_i = 0, $art_cknvphtga$art_c = stepInfos.length; $art_ixigwqbt$art_i < $art_cknvphtga$art_c; $art_ixigwqbt$art_i++) {    var step = stepInfos[$art_ixigwqbt$art_i]%>';
    for (var $art_ixigwqbt$art_i = 0, $art_cknvphtga$art_c = stepInfos.length; $art_ixigwqbt$art_i < $art_cknvphtga$art_c; $art_ixigwqbt$art_i++) {
        var step = stepInfos[$art_ixigwqbt$art_i];
