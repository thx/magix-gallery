...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwjctmh$art_i = 0, $art_curbfz$art_c = stepInfos.length; $art_iwjctmh$art_i < $art_curbfz$art_c; $art_iwjctmh$art_i++) {    var step = stepInfos[$art_iwjctmh$art_i]%>';
    for (var $art_iwjctmh$art_i = 0, $art_curbfz$art_c = stepInfos.length; $art_iwjctmh$art_i < $art_curbfz$art_c; $art_iwjctmh$art_i++) {
        var step = stepInfos[$art_iwjctmh$art_i];
