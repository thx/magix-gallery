...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieangloyoa$art_i = 0, $art_cpsantoa$art_c = stepInfos.length; $art_ieangloyoa$art_i < $art_cpsantoa$art_c; $art_ieangloyoa$art_i++) {    var step = stepInfos[$art_ieangloyoa$art_i]%>';
    for (var $art_ieangloyoa$art_i = 0, $art_cpsantoa$art_c = stepInfos.length; $art_ieangloyoa$art_i < $art_cpsantoa$art_c; $art_ieangloyoa$art_i++) {
        var step = stepInfos[$art_ieangloyoa$art_i];
