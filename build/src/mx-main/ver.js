...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibrnoo$art_i = 0, $art_crjswxoh$art_c = stepInfos.length; $art_ibrnoo$art_i < $art_crjswxoh$art_c; $art_ibrnoo$art_i++) {    var step = stepInfos[$art_ibrnoo$art_i]%>';
    for (var $art_ibrnoo$art_i = 0, $art_crjswxoh$art_c = stepInfos.length; $art_ibrnoo$art_i < $art_crjswxoh$art_c; $art_ibrnoo$art_i++) {
        var step = stepInfos[$art_ibrnoo$art_i];
