...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icffwdog$art_i = 0, $art_cbplvhf$art_c = stepInfos.length; $art_icffwdog$art_i < $art_cbplvhf$art_c; $art_icffwdog$art_i++) {    var step = stepInfos[$art_icffwdog$art_i]%>';
    for (var $art_icffwdog$art_i = 0, $art_cbplvhf$art_c = stepInfos.length; $art_icffwdog$art_i < $art_cbplvhf$art_c; $art_icffwdog$art_i++) {
        var step = stepInfos[$art_icffwdog$art_i];
