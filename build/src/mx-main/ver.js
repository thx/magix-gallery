...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igqhpnnoqq$art_i = 0, $art_cuegcclqa$art_c = stepInfos.length; $art_igqhpnnoqq$art_i < $art_cuegcclqa$art_c; $art_igqhpnnoqq$art_i++) {    var step = stepInfos[$art_igqhpnnoqq$art_i]%>';
    for (var $art_igqhpnnoqq$art_i = 0, $art_cuegcclqa$art_c = stepInfos.length; $art_igqhpnnoqq$art_i < $art_cuegcclqa$art_c; $art_igqhpnnoqq$art_i++) {
        var step = stepInfos[$art_igqhpnnoqq$art_i];
