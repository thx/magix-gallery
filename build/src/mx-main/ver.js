...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilwtsknlvp$art_i = 0, $art_colij$art_c = stepInfos.length; $art_ilwtsknlvp$art_i < $art_colij$art_c; $art_ilwtsknlvp$art_i++) {    var step = stepInfos[$art_ilwtsknlvp$art_i]%>';
    for (var $art_ilwtsknlvp$art_i = 0, $art_colij$art_c = stepInfos.length; $art_ilwtsknlvp$art_i < $art_colij$art_c; $art_ilwtsknlvp$art_i++) {
        var step = stepInfos[$art_ilwtsknlvp$art_i];
