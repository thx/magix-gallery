...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izilakak$art_i = 0, $art_ccjszkhnkp$art_c = stepInfos.length; $art_izilakak$art_i < $art_ccjszkhnkp$art_c; $art_izilakak$art_i++) {    var step = stepInfos[$art_izilakak$art_i]%>';
    for (var $art_izilakak$art_i = 0, $art_ccjszkhnkp$art_c = stepInfos.length; $art_izilakak$art_i < $art_ccjszkhnkp$art_c; $art_izilakak$art_i++) {
        var step = stepInfos[$art_izilakak$art_i];
