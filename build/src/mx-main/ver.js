...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isbwtdrceo$art_i = 0, $art_colcfgf$art_c = stepInfos.length; $art_isbwtdrceo$art_i < $art_colcfgf$art_c; $art_isbwtdrceo$art_i++) {    var step = stepInfos[$art_isbwtdrceo$art_i]%>';
    for (var $art_isbwtdrceo$art_i = 0, $art_colcfgf$art_c = stepInfos.length; $art_isbwtdrceo$art_i < $art_colcfgf$art_c; $art_isbwtdrceo$art_i++) {
        var step = stepInfos[$art_isbwtdrceo$art_i];
