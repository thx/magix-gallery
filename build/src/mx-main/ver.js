...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqyeowcca$art_i = 0, $art_cgkofolcxr$art_c = stepInfos.length; $art_iqyeowcca$art_i < $art_cgkofolcxr$art_c; $art_iqyeowcca$art_i++) {    var step = stepInfos[$art_iqyeowcca$art_i]%>';
    for (var $art_iqyeowcca$art_i = 0, $art_cgkofolcxr$art_c = stepInfos.length; $art_iqyeowcca$art_i < $art_cgkofolcxr$art_c; $art_iqyeowcca$art_i++) {
        var step = stepInfos[$art_iqyeowcca$art_i];
        $p += '<div mxv mxa="_zs_galleryc3:_" class="clearfix _zs_gallery_mx-main_ver_-step"><div mxa="_zs_galleryc3:a" class="_zs_gallery_mx-main_ver_-circle">';
        $line = 3;
        $art = '!step.icon';
        ;
        ...
        if (step.index < stepInfos.length) {
            ;
            $p += '<div mxs="_zs_galleryc3:_" class="_zs_gallery_mx-main_ver_-line"></div>';
            $line = 6;
            $art = '/if';
            ;
            $expr = '<%}%>';
        ...
        ;
        $p += '<div mxv mxa="_zs_galleryc3:b" class="_zs_gallery_mx-main_ver_-content"><div mxa="_zs_galleryc3:c" class="_zs_gallery_mx-main_ver_-title"><span mxa="_zs_galleryc3:d" class="fontsize-16">';
        $line = 9;
        $art = '=step.label';
        ;
        ...
        if (step.current) {
            ;
            $p += '<div mxv mxa="_zs_galleryc3:e" class="_zs_gallery_mx-main_ver_-inner"><div mxv="curStepInfo" mx-view="';
            $line = 17;
            ...
            $art = '=viewId';
            ;
            $p += ($expr = '<%=viewId%>', $e(viewId)) + '_cur_content"><div mxs="_zs_galleryc3:a" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div><div mxa="_zs_galleryc3:f" class="pt20">';
            $line = 22;
            ...
            if (curStepInfo.prevTip) {
                ;
                $p += '<a mxa="_zs_galleryc3:g" href="javascript:;" class="btn min-width-100 mr15" mx-click="' + $viewId + 'prev()">';
                $line = 24;
            ...
            if (curStepInfo.nextTip) {
                ;
                $p += '<a mxa="_zs_galleryc3:h" href="javascript:;" class="btn min-width-100 btn-brand" mx-click="' + $viewId + 'next()">';
                $line = 29;
