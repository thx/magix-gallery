...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irvlf$art_i = 0, $art_cpmcvizvzq$art_c = stepInfos.length; $art_irvlf$art_i < $art_cpmcvizvzq$art_c; $art_irvlf$art_i++) {    var step = stepInfos[$art_irvlf$art_i]%>';
    for (var $art_irvlf$art_i = 0, $art_cpmcvizvzq$art_c = stepInfos.length; $art_irvlf$art_i < $art_cpmcvizvzq$art_c; $art_irvlf$art_i++) {
        var step = stepInfos[$art_irvlf$art_i];
