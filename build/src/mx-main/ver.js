...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixwcrdpon$art_i = 0, $art_cwkema$art_c = stepInfos.length; $art_ixwcrdpon$art_i < $art_cwkema$art_c; $art_ixwcrdpon$art_i++) {    var step = stepInfos[$art_ixwcrdpon$art_i]%>';
    for (var $art_ixwcrdpon$art_i = 0, $art_cwkema$art_c = stepInfos.length; $art_ixwcrdpon$art_i < $art_cwkema$art_c; $art_ixwcrdpon$art_i++) {
        var step = stepInfos[$art_ixwcrdpon$art_i];
