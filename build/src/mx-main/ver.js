...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwgixbup$art_i = 0, $art_cyjvcrkuwq$art_c = stepInfos.length; $art_iwgixbup$art_i < $art_cyjvcrkuwq$art_c; $art_iwgixbup$art_i++) {    var step = stepInfos[$art_iwgixbup$art_i]%>';
    for (var $art_iwgixbup$art_i = 0, $art_cyjvcrkuwq$art_c = stepInfos.length; $art_iwgixbup$art_i < $art_cyjvcrkuwq$art_c; $art_iwgixbup$art_i++) {
        var step = stepInfos[$art_iwgixbup$art_i];
