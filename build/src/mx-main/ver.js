...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irqcwlqtq$art_i = 0, $art_cbezywnglbag$art_c = stepInfos.length; $art_irqcwlqtq$art_i < $art_cbezywnglbag$art_c; $art_irqcwlqtq$art_i++) {    var step = stepInfos[$art_irqcwlqtq$art_i]%>';
    for (var $art_irqcwlqtq$art_i = 0, $art_cbezywnglbag$art_c = stepInfos.length; $art_irqcwlqtq$art_i < $art_cbezywnglbag$art_c; $art_irqcwlqtq$art_i++) {
        var step = stepInfos[$art_irqcwlqtq$art_i];
