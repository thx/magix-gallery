...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iagmjrjcg$art_i = 0, $art_chclyvcdh$art_c = stepInfos.length; $art_iagmjrjcg$art_i < $art_chclyvcdh$art_c; $art_iagmjrjcg$art_i++) {    var step = stepInfos[$art_iagmjrjcg$art_i]%>';
    for (var $art_iagmjrjcg$art_i = 0, $art_chclyvcdh$art_c = stepInfos.length; $art_iagmjrjcg$art_i < $art_chclyvcdh$art_c; $art_iagmjrjcg$art_i++) {
        var step = stepInfos[$art_iagmjrjcg$art_i];
