...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ispmuadfts$art_i = 0, $art_carjyqds$art_c = stepInfos.length; $art_ispmuadfts$art_i < $art_carjyqds$art_c; $art_ispmuadfts$art_i++) {    var step = stepInfos[$art_ispmuadfts$art_i]%>';
    for (var $art_ispmuadfts$art_i = 0, $art_carjyqds$art_c = stepInfos.length; $art_ispmuadfts$art_i < $art_carjyqds$art_c; $art_ispmuadfts$art_i++) {
        var step = stepInfos[$art_ispmuadfts$art_i];
