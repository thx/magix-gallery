...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iazugafxo$art_i = 0, $art_ccegvxivb$art_c = stepInfos.length; $art_iazugafxo$art_i < $art_ccegvxivb$art_c; $art_iazugafxo$art_i++) {    var step = stepInfos[$art_iazugafxo$art_i]%>';
    for (var $art_iazugafxo$art_i = 0, $art_ccegvxivb$art_c = stepInfos.length; $art_iazugafxo$art_i < $art_ccegvxivb$art_c; $art_iazugafxo$art_i++) {
        var step = stepInfos[$art_iazugafxo$art_i];
