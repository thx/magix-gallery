...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixzlbzcik$art_i = 0, $art_cinvzwih$art_c = stepInfos.length; $art_ixzlbzcik$art_i < $art_cinvzwih$art_c; $art_ixzlbzcik$art_i++) {    var step = stepInfos[$art_ixzlbzcik$art_i]%>';
    for (var $art_ixzlbzcik$art_i = 0, $art_cinvzwih$art_c = stepInfos.length; $art_ixzlbzcik$art_i < $art_cinvzwih$art_c; $art_ixzlbzcik$art_i++) {
        var step = stepInfos[$art_ixzlbzcik$art_i];
