...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikkiaavndn$art_i = 0, $art_cjaskin$art_c = stepInfos.length; $art_ikkiaavndn$art_i < $art_cjaskin$art_c; $art_ikkiaavndn$art_i++) {    var step = stepInfos[$art_ikkiaavndn$art_i]%>';
    for (var $art_ikkiaavndn$art_i = 0, $art_cjaskin$art_c = stepInfos.length; $art_ikkiaavndn$art_i < $art_cjaskin$art_c; $art_ikkiaavndn$art_i++) {
        var step = stepInfos[$art_ikkiaavndn$art_i];
