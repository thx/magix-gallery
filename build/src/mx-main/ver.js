...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioovuzm$art_i = 0, $art_cizonpppmjp$art_c = stepInfos.length; $art_ioovuzm$art_i < $art_cizonpppmjp$art_c; $art_ioovuzm$art_i++) {    var step = stepInfos[$art_ioovuzm$art_i]%>';
    for (var $art_ioovuzm$art_i = 0, $art_cizonpppmjp$art_c = stepInfos.length; $art_ioovuzm$art_i < $art_cizonpppmjp$art_c; $art_ioovuzm$art_i++) {
        var step = stepInfos[$art_ioovuzm$art_i];
