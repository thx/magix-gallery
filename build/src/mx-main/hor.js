...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igvahrsga$art_i = 0, $art_cmyiyowb$art_c = stepInfos.length; $art_igvahrsga$art_i < $art_cmyiyowb$art_c; $art_igvahrsga$art_i++) {    var step = stepInfos[$art_igvahrsga$art_i]%>';
    for (var $art_igvahrsga$art_i = 0, $art_cmyiyowb$art_c = stepInfos.length; $art_igvahrsga$art_i < $art_cmyiyowb$art_c; $art_igvahrsga$art_i++) {
        var step = stepInfos[$art_igvahrsga$art_i];
