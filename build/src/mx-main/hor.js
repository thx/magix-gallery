...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inwcwrak$art_i = 0, $art_caqsphycq$art_c = stepInfos.length; $art_inwcwrak$art_i < $art_caqsphycq$art_c; $art_inwcwrak$art_i++) {    var step = stepInfos[$art_inwcwrak$art_i]%>';
    for (var $art_inwcwrak$art_i = 0, $art_caqsphycq$art_c = stepInfos.length; $art_inwcwrak$art_i < $art_caqsphycq$art_c; $art_inwcwrak$art_i++) {
        var step = stepInfos[$art_inwcwrak$art_i];
