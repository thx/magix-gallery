...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iukoynugeoq$art_i = 0, $art_cwgduskpv$art_c = stepInfos.length; $art_iukoynugeoq$art_i < $art_cwgduskpv$art_c; $art_iukoynugeoq$art_i++) {    var step = stepInfos[$art_iukoynugeoq$art_i]%>';
    for (var $art_iukoynugeoq$art_i = 0, $art_cwgduskpv$art_c = stepInfos.length; $art_iukoynugeoq$art_i < $art_cwgduskpv$art_c; $art_iukoynugeoq$art_i++) {
        var step = stepInfos[$art_iukoynugeoq$art_i];
