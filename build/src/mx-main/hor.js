...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imgzffxcrl$art_i = 0, $art_cdovaqjr$art_c = stepInfos.length; $art_imgzffxcrl$art_i < $art_cdovaqjr$art_c; $art_imgzffxcrl$art_i++) {    var step = stepInfos[$art_imgzffxcrl$art_i]%>';
    for (var $art_imgzffxcrl$art_i = 0, $art_cdovaqjr$art_c = stepInfos.length; $art_imgzffxcrl$art_i < $art_cdovaqjr$art_c; $art_imgzffxcrl$art_i++) {
        var step = stepInfos[$art_imgzffxcrl$art_i];
