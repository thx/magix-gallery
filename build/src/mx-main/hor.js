...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izttfhf$art_i = 0, $art_cgjrphgyh$art_c = stepInfos.length; $art_izttfhf$art_i < $art_cgjrphgyh$art_c; $art_izttfhf$art_i++) {    var step = stepInfos[$art_izttfhf$art_i]%>';
    for (var $art_izttfhf$art_i = 0, $art_cgjrphgyh$art_c = stepInfos.length; $art_izttfhf$art_i < $art_cgjrphgyh$art_c; $art_izttfhf$art_i++) {
        var step = stepInfos[$art_izttfhf$art_i];
