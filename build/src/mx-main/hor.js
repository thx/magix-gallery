...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icyqevuzxki$art_i = 0, $art_cwoumwsj$art_c = stepInfos.length; $art_icyqevuzxki$art_i < $art_cwoumwsj$art_c; $art_icyqevuzxki$art_i++) {    var step = stepInfos[$art_icyqevuzxki$art_i]%>';
    for (var $art_icyqevuzxki$art_i = 0, $art_cwoumwsj$art_c = stepInfos.length; $art_icyqevuzxki$art_i < $art_cwoumwsj$art_c; $art_icyqevuzxki$art_i++) {
        var step = stepInfos[$art_icyqevuzxki$art_i];
