...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iglhnhbs$art_i = 0, $art_clcwygqudvyk$art_c = stepInfos.length; $art_iglhnhbs$art_i < $art_clcwygqudvyk$art_c; $art_iglhnhbs$art_i++) {    var step = stepInfos[$art_iglhnhbs$art_i]%>';
    for (var $art_iglhnhbs$art_i = 0, $art_clcwygqudvyk$art_c = stepInfos.length; $art_iglhnhbs$art_i < $art_clcwygqudvyk$art_c; $art_iglhnhbs$art_i++) {
        var step = stepInfos[$art_iglhnhbs$art_i];
