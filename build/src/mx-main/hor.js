...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikvxrrab$art_i = 0, $art_ctfdbkfu$art_c = stepInfos.length; $art_ikvxrrab$art_i < $art_ctfdbkfu$art_c; $art_ikvxrrab$art_i++) {    var step = stepInfos[$art_ikvxrrab$art_i]%>';
    for (var $art_ikvxrrab$art_i = 0, $art_ctfdbkfu$art_c = stepInfos.length; $art_ikvxrrab$art_i < $art_ctfdbkfu$art_c; $art_ikvxrrab$art_i++) {
        var step = stepInfos[$art_ikvxrrab$art_i];
