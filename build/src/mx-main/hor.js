...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipmglfj$art_i = 0, $art_cerpltrf$art_c = stepInfos.length; $art_ipmglfj$art_i < $art_cerpltrf$art_c; $art_ipmglfj$art_i++) {    var step = stepInfos[$art_ipmglfj$art_i]%>';
    for (var $art_ipmglfj$art_i = 0, $art_cerpltrf$art_c = stepInfos.length; $art_ipmglfj$art_i < $art_cerpltrf$art_c; $art_ipmglfj$art_i++) {
        var step = stepInfos[$art_ipmglfj$art_i];
