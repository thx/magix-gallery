...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iobnkmoj$art_i = 0, $art_cuwbybpcfqf$art_c = stepInfos.length; $art_iobnkmoj$art_i < $art_cuwbybpcfqf$art_c; $art_iobnkmoj$art_i++) {    var step = stepInfos[$art_iobnkmoj$art_i]%>';
    for (var $art_iobnkmoj$art_i = 0, $art_cuwbybpcfqf$art_c = stepInfos.length; $art_iobnkmoj$art_i < $art_cuwbybpcfqf$art_c; $art_iobnkmoj$art_i++) {
        var step = stepInfos[$art_iobnkmoj$art_i];
