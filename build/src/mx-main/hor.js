...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icnvilr$art_i = 0, $art_ckdfdsboyrgh$art_c = stepInfos.length; $art_icnvilr$art_i < $art_ckdfdsboyrgh$art_c; $art_icnvilr$art_i++) {    var step = stepInfos[$art_icnvilr$art_i]%>';
    for (var $art_icnvilr$art_i = 0, $art_ckdfdsboyrgh$art_c = stepInfos.length; $art_icnvilr$art_i < $art_ckdfdsboyrgh$art_c; $art_icnvilr$art_i++) {
        var step = stepInfos[$art_icnvilr$art_i];
