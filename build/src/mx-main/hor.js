...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idbaixrin$art_i = 0, $art_cvynhqrhd$art_c = stepInfos.length; $art_idbaixrin$art_i < $art_cvynhqrhd$art_c; $art_idbaixrin$art_i++) {    var step = stepInfos[$art_idbaixrin$art_i]%>';
    for (var $art_idbaixrin$art_i = 0, $art_cvynhqrhd$art_c = stepInfos.length; $art_idbaixrin$art_i < $art_cvynhqrhd$art_c; $art_idbaixrin$art_i++) {
        var step = stepInfos[$art_idbaixrin$art_i];
