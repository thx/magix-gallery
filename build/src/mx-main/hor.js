...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imjudyio$art_i = 0, $art_chitkyvbjb$art_c = stepInfos.length; $art_imjudyio$art_i < $art_chitkyvbjb$art_c; $art_imjudyio$art_i++) {    var step = stepInfos[$art_imjudyio$art_i]%>';
    for (var $art_imjudyio$art_i = 0, $art_chitkyvbjb$art_c = stepInfos.length; $art_imjudyio$art_i < $art_chitkyvbjb$art_c; $art_imjudyio$art_i++) {
        var step = stepInfos[$art_imjudyio$art_i];
