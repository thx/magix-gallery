...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivktivxbt$art_i = 0, $art_cxaflsq$art_c = stepInfos.length; $art_ivktivxbt$art_i < $art_cxaflsq$art_c; $art_ivktivxbt$art_i++) {    var step = stepInfos[$art_ivktivxbt$art_i]%>';
    for (var $art_ivktivxbt$art_i = 0, $art_cxaflsq$art_c = stepInfos.length; $art_ivktivxbt$art_i < $art_cxaflsq$art_c; $art_ivktivxbt$art_i++) {
        var step = stepInfos[$art_ivktivxbt$art_i];
