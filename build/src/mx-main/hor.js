...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikkisovsf$art_i = 0, $art_cpheuno$art_c = stepInfos.length; $art_ikkisovsf$art_i < $art_cpheuno$art_c; $art_ikkisovsf$art_i++) {    var step = stepInfos[$art_ikkisovsf$art_i]%>';
    for (var $art_ikkisovsf$art_i = 0, $art_cpheuno$art_c = stepInfos.length; $art_ikkisovsf$art_i < $art_cpheuno$art_c; $art_ikkisovsf$art_i++) {
        var step = stepInfos[$art_ikkisovsf$art_i];
