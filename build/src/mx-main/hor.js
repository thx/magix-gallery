...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieghhqwi$art_i = 0, $art_cfsgqfu$art_c = stepInfos.length; $art_ieghhqwi$art_i < $art_cfsgqfu$art_c; $art_ieghhqwi$art_i++) {    var step = stepInfos[$art_ieghhqwi$art_i]%>';
    for (var $art_ieghhqwi$art_i = 0, $art_cfsgqfu$art_c = stepInfos.length; $art_ieghhqwi$art_i < $art_cfsgqfu$art_c; $art_ieghhqwi$art_i++) {
        var step = stepInfos[$art_ieghhqwi$art_i];
