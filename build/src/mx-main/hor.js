...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ishxmjwq$art_i = 0, $art_cmhhbo$art_c = stepInfos.length; $art_ishxmjwq$art_i < $art_cmhhbo$art_c; $art_ishxmjwq$art_i++) {    var step = stepInfos[$art_ishxmjwq$art_i]%>';
    for (var $art_ishxmjwq$art_i = 0, $art_cmhhbo$art_c = stepInfos.length; $art_ishxmjwq$art_i < $art_cmhhbo$art_c; $art_ishxmjwq$art_i++) {
        var step = stepInfos[$art_ishxmjwq$art_i];
