...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilsetcmqm$art_i = 0, $art_ctgfpq$art_c = stepInfos.length; $art_ilsetcmqm$art_i < $art_ctgfpq$art_c; $art_ilsetcmqm$art_i++) {    var step = stepInfos[$art_ilsetcmqm$art_i]%>';
    for (var $art_ilsetcmqm$art_i = 0, $art_ctgfpq$art_c = stepInfos.length; $art_ilsetcmqm$art_i < $art_ctgfpq$art_c; $art_ilsetcmqm$art_i++) {
        var step = stepInfos[$art_ilsetcmqm$art_i];
