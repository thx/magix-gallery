...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuzlrtthkk$art_i = 0, $art_cthwrwenl$art_c = stepInfos.length; $art_iuzlrtthkk$art_i < $art_cthwrwenl$art_c; $art_iuzlrtthkk$art_i++) {    var step = stepInfos[$art_iuzlrtthkk$art_i]%>';
    for (var $art_iuzlrtthkk$art_i = 0, $art_cthwrwenl$art_c = stepInfos.length; $art_iuzlrtthkk$art_i < $art_cthwrwenl$art_c; $art_iuzlrtthkk$art_i++) {
        var step = stepInfos[$art_iuzlrtthkk$art_i];
