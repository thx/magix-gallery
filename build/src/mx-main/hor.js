...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikfsfqtke$art_i = 0, $art_cyyukywrwa$art_c = stepInfos.length; $art_ikfsfqtke$art_i < $art_cyyukywrwa$art_c; $art_ikfsfqtke$art_i++) {    var step = stepInfos[$art_ikfsfqtke$art_i]%>';
    for (var $art_ikfsfqtke$art_i = 0, $art_cyyukywrwa$art_c = stepInfos.length; $art_ikfsfqtke$art_i < $art_cyyukywrwa$art_c; $art_ikfsfqtke$art_i++) {
        var step = stepInfos[$art_ikfsfqtke$art_i];
