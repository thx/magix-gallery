...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icrdvdrlc$art_i = 0, $art_cituvqtpb$art_c = stepInfos.length; $art_icrdvdrlc$art_i < $art_cituvqtpb$art_c; $art_icrdvdrlc$art_i++) {    var step = stepInfos[$art_icrdvdrlc$art_i]%>';
    for (var $art_icrdvdrlc$art_i = 0, $art_cituvqtpb$art_c = stepInfos.length; $art_icrdvdrlc$art_i < $art_cituvqtpb$art_c; $art_icrdvdrlc$art_i++) {
        var step = stepInfos[$art_icrdvdrlc$art_i];
