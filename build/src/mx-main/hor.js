...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqtgal$art_i = 0, $art_cvgeikyuje$art_c = stepInfos.length; $art_iqtgal$art_i < $art_cvgeikyuje$art_c; $art_iqtgal$art_i++) {    var step = stepInfos[$art_iqtgal$art_i]%>';
    for (var $art_iqtgal$art_i = 0, $art_cvgeikyuje$art_c = stepInfos.length; $art_iqtgal$art_i < $art_cvgeikyuje$art_c; $art_iqtgal$art_i++) {
        var step = stepInfos[$art_iqtgal$art_i];
