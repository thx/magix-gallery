...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixwpzbistl$art_i = 0, $art_czkowv$art_c = stepInfos.length; $art_ixwpzbistl$art_i < $art_czkowv$art_c; $art_ixwpzbistl$art_i++) {    var step = stepInfos[$art_ixwpzbistl$art_i]%>';
    for (var $art_ixwpzbistl$art_i = 0, $art_czkowv$art_c = stepInfos.length; $art_ixwpzbistl$art_i < $art_czkowv$art_c; $art_ixwpzbistl$art_i++) {
        var step = stepInfos[$art_ixwpzbistl$art_i];
