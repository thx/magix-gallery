...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iafpgmmik$art_i = 0, $art_cbvetq$art_c = stepInfos.length; $art_iafpgmmik$art_i < $art_cbvetq$art_c; $art_iafpgmmik$art_i++) {    var step = stepInfos[$art_iafpgmmik$art_i]%>';
    for (var $art_iafpgmmik$art_i = 0, $art_cbvetq$art_c = stepInfos.length; $art_iafpgmmik$art_i < $art_cbvetq$art_c; $art_iafpgmmik$art_i++) {
        var step = stepInfos[$art_iafpgmmik$art_i];
