...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqnye$art_i = 0, $art_caddfzssqqie$art_c = stepInfos.length; $art_iqnye$art_i < $art_caddfzssqqie$art_c; $art_iqnye$art_i++) {    var step = stepInfos[$art_iqnye$art_i]%>';
    for (var $art_iqnye$art_i = 0, $art_caddfzssqqie$art_c = stepInfos.length; $art_iqnye$art_i < $art_caddfzssqqie$art_c; $art_iqnye$art_i++) {
        var step = stepInfos[$art_iqnye$art_i];
