...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuhivexnf$art_i = 0, $art_cnzobdnab$art_c = stepInfos.length; $art_iuhivexnf$art_i < $art_cnzobdnab$art_c; $art_iuhivexnf$art_i++) {    var step = stepInfos[$art_iuhivexnf$art_i]%>';
    for (var $art_iuhivexnf$art_i = 0, $art_cnzobdnab$art_c = stepInfos.length; $art_iuhivexnf$art_i < $art_cnzobdnab$art_c; $art_iuhivexnf$art_i++) {
        var step = stepInfos[$art_iuhivexnf$art_i];
