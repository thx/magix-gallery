...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihbijxhl$art_i = 0, $art_crjdtmw$art_c = stepInfos.length; $art_ihbijxhl$art_i < $art_crjdtmw$art_c; $art_ihbijxhl$art_i++) {    var step = stepInfos[$art_ihbijxhl$art_i]%>';
    for (var $art_ihbijxhl$art_i = 0, $art_crjdtmw$art_c = stepInfos.length; $art_ihbijxhl$art_i < $art_crjdtmw$art_c; $art_ihbijxhl$art_i++) {
        var step = stepInfos[$art_ihbijxhl$art_i];
