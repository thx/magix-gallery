...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixdmdjpuc$art_i = 0, $art_cidilqrekj$art_c = stepInfos.length; $art_ixdmdjpuc$art_i < $art_cidilqrekj$art_c; $art_ixdmdjpuc$art_i++) {    var step = stepInfos[$art_ixdmdjpuc$art_i]%>';
    for (var $art_ixdmdjpuc$art_i = 0, $art_cidilqrekj$art_c = stepInfos.length; $art_ixdmdjpuc$art_i < $art_cidilqrekj$art_c; $art_ixdmdjpuc$art_i++) {
        var step = stepInfos[$art_ixdmdjpuc$art_i];
