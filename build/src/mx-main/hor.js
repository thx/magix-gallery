...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijoonm$art_i = 0, $art_cnbdpdv$art_c = stepInfos.length; $art_ijoonm$art_i < $art_cnbdpdv$art_c; $art_ijoonm$art_i++) {    var step = stepInfos[$art_ijoonm$art_i]%>';
    for (var $art_ijoonm$art_i = 0, $art_cnbdpdv$art_c = stepInfos.length; $art_ijoonm$art_i < $art_cnbdpdv$art_c; $art_ijoonm$art_i++) {
        var step = stepInfos[$art_ijoonm$art_i];
