...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihbqfnusj$art_i = 0, $art_cfqutmgtog$art_c = stepInfos.length; $art_ihbqfnusj$art_i < $art_cfqutmgtog$art_c; $art_ihbqfnusj$art_i++) {    var step = stepInfos[$art_ihbqfnusj$art_i]%>';
    for (var $art_ihbqfnusj$art_i = 0, $art_cfqutmgtog$art_c = stepInfos.length; $art_ihbqfnusj$art_i < $art_cfqutmgtog$art_c; $art_ihbqfnusj$art_i++) {
        var step = stepInfos[$art_ihbqfnusj$art_i];
