...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irflunngr$art_i = 0, $art_cqhethvh$art_c = stepInfos.length; $art_irflunngr$art_i < $art_cqhethvh$art_c; $art_irflunngr$art_i++) {    var step = stepInfos[$art_irflunngr$art_i]%>';
    for (var $art_irflunngr$art_i = 0, $art_cqhethvh$art_c = stepInfos.length; $art_irflunngr$art_i < $art_cqhethvh$art_c; $art_irflunngr$art_i++) {
        var step = stepInfos[$art_irflunngr$art_i];
