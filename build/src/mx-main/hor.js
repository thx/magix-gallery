...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icune$art_i = 0, $art_chosms$art_c = stepInfos.length; $art_icune$art_i < $art_chosms$art_c; $art_icune$art_i++) {    var step = stepInfos[$art_icune$art_i]%>';
    for (var $art_icune$art_i = 0, $art_chosms$art_c = stepInfos.length; $art_icune$art_i < $art_chosms$art_c; $art_icune$art_i++) {
        var step = stepInfos[$art_icune$art_i];
