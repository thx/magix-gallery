...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifbmxatzjph$art_i = 0, $art_cvuycroreuj$art_c = stepInfos.length; $art_ifbmxatzjph$art_i < $art_cvuycroreuj$art_c; $art_ifbmxatzjph$art_i++) {    var step = stepInfos[$art_ifbmxatzjph$art_i]%>';
    for (var $art_ifbmxatzjph$art_i = 0, $art_cvuycroreuj$art_c = stepInfos.length; $art_ifbmxatzjph$art_i < $art_cvuycroreuj$art_c; $art_ifbmxatzjph$art_i++) {
        var step = stepInfos[$art_ifbmxatzjph$art_i];
