...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilekaeyam$art_i = 0, $art_cvyzrsevmhc$art_c = stepInfos.length; $art_ilekaeyam$art_i < $art_cvyzrsevmhc$art_c; $art_ilekaeyam$art_i++) {    var step = stepInfos[$art_ilekaeyam$art_i]%>';
    for (var $art_ilekaeyam$art_i = 0, $art_cvyzrsevmhc$art_c = stepInfos.length; $art_ilekaeyam$art_i < $art_cvyzrsevmhc$art_c; $art_ilekaeyam$art_i++) {
        var step = stepInfos[$art_ilekaeyam$art_i];
