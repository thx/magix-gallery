...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iibzyplv$art_i = 0, $art_cundunmwop$art_c = stepInfos.length; $art_iibzyplv$art_i < $art_cundunmwop$art_c; $art_iibzyplv$art_i++) {    var step = stepInfos[$art_iibzyplv$art_i]%>';
    for (var $art_iibzyplv$art_i = 0, $art_cundunmwop$art_c = stepInfos.length; $art_iibzyplv$art_i < $art_cundunmwop$art_c; $art_iibzyplv$art_i++) {
        var step = stepInfos[$art_iibzyplv$art_i];
