...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilshranp$art_i = 0, $art_czoxhuciteln$art_c = stepInfos.length; $art_ilshranp$art_i < $art_czoxhuciteln$art_c; $art_ilshranp$art_i++) {    var step = stepInfos[$art_ilshranp$art_i]%>';
    for (var $art_ilshranp$art_i = 0, $art_czoxhuciteln$art_c = stepInfos.length; $art_ilshranp$art_i < $art_czoxhuciteln$art_c; $art_ilshranp$art_i++) {
        var step = stepInfos[$art_ilshranp$art_i];
