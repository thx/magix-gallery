...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaegmjzog$art_i = 0, $art_cltgbpde$art_c = stepInfos.length; $art_iaegmjzog$art_i < $art_cltgbpde$art_c; $art_iaegmjzog$art_i++) {    var step = stepInfos[$art_iaegmjzog$art_i]%>';
    for (var $art_iaegmjzog$art_i = 0, $art_cltgbpde$art_c = stepInfos.length; $art_iaegmjzog$art_i < $art_cltgbpde$art_c; $art_iaegmjzog$art_i++) {
        var step = stepInfos[$art_iaegmjzog$art_i];
