...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iozeiqfg$art_i = 0, $art_cnwatdjvg$art_c = stepInfos.length; $art_iozeiqfg$art_i < $art_cnwatdjvg$art_c; $art_iozeiqfg$art_i++) {    var step = stepInfos[$art_iozeiqfg$art_i]%>';
    for (var $art_iozeiqfg$art_i = 0, $art_cnwatdjvg$art_c = stepInfos.length; $art_iozeiqfg$art_i < $art_cnwatdjvg$art_c; $art_iozeiqfg$art_i++) {
        var step = stepInfos[$art_iozeiqfg$art_i];
