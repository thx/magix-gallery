...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilatysjprjtc$art_i = 0, $art_cpbtbxtru$art_c = stepInfos.length; $art_ilatysjprjtc$art_i < $art_cpbtbxtru$art_c; $art_ilatysjprjtc$art_i++) {    var step = stepInfos[$art_ilatysjprjtc$art_i]%>';
    for (var $art_ilatysjprjtc$art_i = 0, $art_cpbtbxtru$art_c = stepInfos.length; $art_ilatysjprjtc$art_i < $art_cpbtbxtru$art_c; $art_ilatysjprjtc$art_i++) {
        var step = stepInfos[$art_ilatysjprjtc$art_i];
