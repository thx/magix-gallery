...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iotdsijxk$art_i = 0, $art_cycqdjartfs$art_c = stepInfos.length; $art_iotdsijxk$art_i < $art_cycqdjartfs$art_c; $art_iotdsijxk$art_i++) {    var step = stepInfos[$art_iotdsijxk$art_i]%>';
    for (var $art_iotdsijxk$art_i = 0, $art_cycqdjartfs$art_c = stepInfos.length; $art_iotdsijxk$art_i < $art_cycqdjartfs$art_c; $art_iotdsijxk$art_i++) {
        var step = stepInfos[$art_iotdsijxk$art_i];
