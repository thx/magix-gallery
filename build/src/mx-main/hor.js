...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itnhtwi$art_i = 0, $art_codyanaabot$art_c = stepInfos.length; $art_itnhtwi$art_i < $art_codyanaabot$art_c; $art_itnhtwi$art_i++) {    var step = stepInfos[$art_itnhtwi$art_i]%>';
    for (var $art_itnhtwi$art_i = 0, $art_codyanaabot$art_c = stepInfos.length; $art_itnhtwi$art_i < $art_codyanaabot$art_c; $art_itnhtwi$art_i++) {
        var step = stepInfos[$art_itnhtwi$art_i];
