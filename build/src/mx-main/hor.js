...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieycmvqvi$art_i = 0, $art_cedvhfmhfp$art_c = stepInfos.length; $art_ieycmvqvi$art_i < $art_cedvhfmhfp$art_c; $art_ieycmvqvi$art_i++) {    var step = stepInfos[$art_ieycmvqvi$art_i]%>';
    for (var $art_ieycmvqvi$art_i = 0, $art_cedvhfmhfp$art_c = stepInfos.length; $art_ieycmvqvi$art_i < $art_cedvhfmhfp$art_c; $art_ieycmvqvi$art_i++) {
        var step = stepInfos[$art_ieycmvqvi$art_i];
