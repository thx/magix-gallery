...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqneldehte$art_i = 0, $art_cqymvro$art_c = stepInfos.length; $art_iqneldehte$art_i < $art_cqymvro$art_c; $art_iqneldehte$art_i++) {    var step = stepInfos[$art_iqneldehte$art_i]%>';
    for (var $art_iqneldehte$art_i = 0, $art_cqymvro$art_c = stepInfos.length; $art_iqneldehte$art_i < $art_cqymvro$art_c; $art_iqneldehte$art_i++) {
        var step = stepInfos[$art_iqneldehte$art_i];
