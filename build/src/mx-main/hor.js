...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idswctkbfj$art_i = 0, $art_cjujuvudc$art_c = stepInfos.length; $art_idswctkbfj$art_i < $art_cjujuvudc$art_c; $art_idswctkbfj$art_i++) {    var step = stepInfos[$art_idswctkbfj$art_i]%>';
    for (var $art_idswctkbfj$art_i = 0, $art_cjujuvudc$art_c = stepInfos.length; $art_idswctkbfj$art_i < $art_cjujuvudc$art_c; $art_idswctkbfj$art_i++) {
        var step = stepInfos[$art_idswctkbfj$art_i];
