...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijytgmxzl$art_i = 0, $art_cqsnlsafp$art_c = stepInfos.length; $art_ijytgmxzl$art_i < $art_cqsnlsafp$art_c; $art_ijytgmxzl$art_i++) {    var step = stepInfos[$art_ijytgmxzl$art_i]%>';
    for (var $art_ijytgmxzl$art_i = 0, $art_cqsnlsafp$art_c = stepInfos.length; $art_ijytgmxzl$art_i < $art_cqsnlsafp$art_c; $art_ijytgmxzl$art_i++) {
        var step = stepInfos[$art_ijytgmxzl$art_i];
