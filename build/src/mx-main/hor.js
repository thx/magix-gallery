...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imctwdwf$art_i = 0, $art_cpdloc$art_c = stepInfos.length; $art_imctwdwf$art_i < $art_cpdloc$art_c; $art_imctwdwf$art_i++) {    var step = stepInfos[$art_imctwdwf$art_i]%>';
    for (var $art_imctwdwf$art_i = 0, $art_cpdloc$art_c = stepInfos.length; $art_imctwdwf$art_i < $art_cpdloc$art_c; $art_imctwdwf$art_i++) {
        var step = stepInfos[$art_imctwdwf$art_i];
