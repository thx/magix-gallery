...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iikmauk$art_i = 0, $art_cjyuhmf$art_c = stepInfos.length; $art_iikmauk$art_i < $art_cjyuhmf$art_c; $art_iikmauk$art_i++) {    var step = stepInfos[$art_iikmauk$art_i]%>';
    for (var $art_iikmauk$art_i = 0, $art_cjyuhmf$art_c = stepInfos.length; $art_iikmauk$art_i < $art_cjyuhmf$art_c; $art_iikmauk$art_i++) {
        var step = stepInfos[$art_iikmauk$art_i];
