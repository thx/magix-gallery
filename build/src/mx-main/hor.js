...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwbahqy$art_i = 0, $art_chmesmji$art_c = stepInfos.length; $art_iwbahqy$art_i < $art_chmesmji$art_c; $art_iwbahqy$art_i++) {    var step = stepInfos[$art_iwbahqy$art_i]%>';
    for (var $art_iwbahqy$art_i = 0, $art_chmesmji$art_c = stepInfos.length; $art_iwbahqy$art_i < $art_chmesmji$art_c; $art_iwbahqy$art_i++) {
        var step = stepInfos[$art_iwbahqy$art_i];
