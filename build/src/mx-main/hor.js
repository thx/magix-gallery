...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iiwufiyuek$art_i = 0, $art_cudnbosrck$art_c = stepInfos.length; $art_iiwufiyuek$art_i < $art_cudnbosrck$art_c; $art_iiwufiyuek$art_i++) {    var step = stepInfos[$art_iiwufiyuek$art_i]%>';
    for (var $art_iiwufiyuek$art_i = 0, $art_cudnbosrck$art_c = stepInfos.length; $art_iiwufiyuek$art_i < $art_cudnbosrck$art_c; $art_iiwufiyuek$art_i++) {
        var step = stepInfos[$art_iiwufiyuek$art_i];
