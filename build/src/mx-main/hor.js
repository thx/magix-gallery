...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikdbbxv$art_i = 0, $art_cyoctes$art_c = stepInfos.length; $art_ikdbbxv$art_i < $art_cyoctes$art_c; $art_ikdbbxv$art_i++) {    var step = stepInfos[$art_ikdbbxv$art_i]%>';
    for (var $art_ikdbbxv$art_i = 0, $art_cyoctes$art_c = stepInfos.length; $art_ikdbbxv$art_i < $art_cyoctes$art_c; $art_ikdbbxv$art_i++) {
        var step = stepInfos[$art_ikdbbxv$art_i];
