...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imulksazaj$art_i = 0, $art_cuytrpjhwg$art_c = stepInfos.length; $art_imulksazaj$art_i < $art_cuytrpjhwg$art_c; $art_imulksazaj$art_i++) {    var step = stepInfos[$art_imulksazaj$art_i]%>';
    for (var $art_imulksazaj$art_i = 0, $art_cuytrpjhwg$art_c = stepInfos.length; $art_imulksazaj$art_i < $art_cuytrpjhwg$art_c; $art_imulksazaj$art_i++) {
        var step = stepInfos[$art_imulksazaj$art_i];
