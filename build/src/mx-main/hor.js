...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ighaimzsb$art_i = 0, $art_cvayceq$art_c = stepInfos.length; $art_ighaimzsb$art_i < $art_cvayceq$art_c; $art_ighaimzsb$art_i++) {    var step = stepInfos[$art_ighaimzsb$art_i]%>';
    for (var $art_ighaimzsb$art_i = 0, $art_cvayceq$art_c = stepInfos.length; $art_ighaimzsb$art_i < $art_cvayceq$art_c; $art_ighaimzsb$art_i++) {
        var step = stepInfos[$art_ighaimzsb$art_i];
