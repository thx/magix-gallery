...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikrqecye$art_i = 0, $art_czhownywqf$art_c = stepInfos.length; $art_ikrqecye$art_i < $art_czhownywqf$art_c; $art_ikrqecye$art_i++) {    var step = stepInfos[$art_ikrqecye$art_i]%>';
    for (var $art_ikrqecye$art_i = 0, $art_czhownywqf$art_c = stepInfos.length; $art_ikrqecye$art_i < $art_czhownywqf$art_c; $art_ikrqecye$art_i++) {
        var step = stepInfos[$art_ikrqecye$art_i];
