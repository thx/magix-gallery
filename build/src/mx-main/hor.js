...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuqfluzgv$art_i = 0, $art_cnfodbd$art_c = stepInfos.length; $art_iuqfluzgv$art_i < $art_cnfodbd$art_c; $art_iuqfluzgv$art_i++) {    var step = stepInfos[$art_iuqfluzgv$art_i]%>';
    for (var $art_iuqfluzgv$art_i = 0, $art_cnfodbd$art_c = stepInfos.length; $art_iuqfluzgv$art_i < $art_cnfodbd$art_c; $art_iuqfluzgv$art_i++) {
        var step = stepInfos[$art_iuqfluzgv$art_i];
