...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isjfojr$art_i = 0, $art_cmiaivxars$art_c = stepInfos.length; $art_isjfojr$art_i < $art_cmiaivxars$art_c; $art_isjfojr$art_i++) {    var step = stepInfos[$art_isjfojr$art_i]%>';
    for (var $art_isjfojr$art_i = 0, $art_cmiaivxars$art_c = stepInfos.length; $art_isjfojr$art_i < $art_cmiaivxars$art_c; $art_isjfojr$art_i++) {
        var step = stepInfos[$art_isjfojr$art_i];
