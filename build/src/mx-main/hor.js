...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaowalvzszd$art_i = 0, $art_cdlmipbtjb$art_c = stepInfos.length; $art_iaowalvzszd$art_i < $art_cdlmipbtjb$art_c; $art_iaowalvzszd$art_i++) {    var step = stepInfos[$art_iaowalvzszd$art_i]%>';
    for (var $art_iaowalvzszd$art_i = 0, $art_cdlmipbtjb$art_c = stepInfos.length; $art_iaowalvzszd$art_i < $art_cdlmipbtjb$art_c; $art_iaowalvzszd$art_i++) {
        var step = stepInfos[$art_iaowalvzszd$art_i];
