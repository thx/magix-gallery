...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imkyovkh$art_i = 0, $art_czkucvvi$art_c = stepInfos.length; $art_imkyovkh$art_i < $art_czkucvvi$art_c; $art_imkyovkh$art_i++) {    var step = stepInfos[$art_imkyovkh$art_i]%>';
    for (var $art_imkyovkh$art_i = 0, $art_czkucvvi$art_c = stepInfos.length; $art_imkyovkh$art_i < $art_czkucvvi$art_c; $art_imkyovkh$art_i++) {
        var step = stepInfos[$art_imkyovkh$art_i];
