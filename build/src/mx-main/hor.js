...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isqsviheqk$art_i = 0, $art_ckymnjycm$art_c = stepInfos.length; $art_isqsviheqk$art_i < $art_ckymnjycm$art_c; $art_isqsviheqk$art_i++) {    var step = stepInfos[$art_isqsviheqk$art_i]%>';
    for (var $art_isqsviheqk$art_i = 0, $art_ckymnjycm$art_c = stepInfos.length; $art_isqsviheqk$art_i < $art_ckymnjycm$art_c; $art_isqsviheqk$art_i++) {
        var step = stepInfos[$art_isqsviheqk$art_i];
