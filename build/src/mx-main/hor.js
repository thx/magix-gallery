...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibapvuhgc$art_i = 0, $art_cdvifsk$art_c = stepInfos.length; $art_ibapvuhgc$art_i < $art_cdvifsk$art_c; $art_ibapvuhgc$art_i++) {    var step = stepInfos[$art_ibapvuhgc$art_i]%>';
    for (var $art_ibapvuhgc$art_i = 0, $art_cdvifsk$art_c = stepInfos.length; $art_ibapvuhgc$art_i < $art_cdvifsk$art_c; $art_ibapvuhgc$art_i++) {
        var step = stepInfos[$art_ibapvuhgc$art_i];
