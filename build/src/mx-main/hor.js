...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieszxlcf$art_i = 0, $art_czgqmgzic$art_c = stepInfos.length; $art_ieszxlcf$art_i < $art_czgqmgzic$art_c; $art_ieszxlcf$art_i++) {    var step = stepInfos[$art_ieszxlcf$art_i]%>';
    for (var $art_ieszxlcf$art_i = 0, $art_czgqmgzic$art_c = stepInfos.length; $art_ieszxlcf$art_i < $art_czgqmgzic$art_c; $art_ieszxlcf$art_i++) {
        var step = stepInfos[$art_ieszxlcf$art_i];
