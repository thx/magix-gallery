...
module.exports = Magix.View.extend({
    ...
    if (view) {
        ...
        $art = '=view';
        ;
        $p += ($expr = '<%=view%>', $e(view)) + '"><div mxs="_zs_galleryc8:_" class="loading" style="padding: 150px 0;"><span class="loading-anim"></span></div></div>';
        $line = 6;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        ;
        $p += '<div mxa="_zs_galleryc8:_" class="_zs_gallery_mx-main_tip_-side-tip"><i mxs="_zs_galleryc8:a" class="mc-iconfont _zs_gallery_mx-main_tip_-side-light">&#xe654;</i><div mxa="_zs_galleryc8:a" class="_zs_gallery_mx-main_tip_-side-content">';
        $line = 9;
        $art = '!content';
        ;
