...
module.exports = Magix.View.extend({
    ...
    if (view) {
        ...
        ;
        $p += '<div mxa="_zs_galleryc^:_" class="_zs_gallery_mx-main_tip_-side-tip"><i mxs="_zs_galleryc^:a" class="mc-iconfont _zs_gallery_mx-main_tip_-side-light">&#xe654;</i><div mxa="_zs_galleryc^:a" class="_zs_gallery_mx-main_tip_-side-content">';
        $line = 9;
        $art = '!content';
        ;
