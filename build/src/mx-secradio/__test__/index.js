...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div></div><div mxa="_zs_galleryc3:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-secradio/__test__/2" id="';
    $line = 30;
    $art = '=viewId';
    ;
