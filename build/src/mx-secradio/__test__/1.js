...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb`:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb`:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryb`:_" class="clearfix lh22"><div class="color-9 fl">以下示例：</div><div class="fl"><div>mx-change实时获取选中值</div><div>支持展开收起功能</div><div>父节点，子节点都有前缀</div></div></div><div mxa="_zs_galleryb`:b" class="mb15 lh22"><span mxs="_zs_galleryb`:a" class="color-9">当前选择：</span>';
    $line = 11;
    $art = '=selected';
    ;
    ...
    $art = '=selected';
    ;
    $p += ($expr = '<%!$eu(selected)%>', $eu(selected)) + '&parentPrefix=%E8%AE%A1%E5%88%92&prefix=%E5%8D%95%E5%85%83"></div></div><div mxa="_zs_galleryb`:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb`:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 21;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-secradio \n    list="&#123;&#123;@list&#125;&#125;"\n    selected="&#123;&#123;=selected&#125;&#125;"\n    parent-prefix="计划"\n    prefix="单元"\n    mx-change="select()"/&gt;</pre></div><div mxa="_zs_galleryb`:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb`:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
