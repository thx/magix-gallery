...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cwgtzseiqabg$art_c = list.length; itemIndex < $art_cwgtzseiqabg$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cwgtzseiqabg$art_c = list.length; itemIndex < $art_cwgtzseiqabg$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idtenhcw$art_i = 0, $art_objucactrhfqa$art_obj = item.subs, $art_cnhsxau$art_c = $art_objucactrhfqa$art_obj.length; $art_idtenhcw$art_i < $art_cnhsxau$art_c; $art_idtenhcw$art_i++) {        var sub = $art_objucactrhfqa$art_obj[$art_idtenhcw$art_i]%>';
        for (var $art_idtenhcw$art_i = 0, $art_objucactrhfqa$art_obj = item.subs, $art_cnhsxau$art_c = $art_objucactrhfqa$art_obj.length; $art_idtenhcw$art_i < $art_cnhsxau$art_c; $art_idtenhcw$art_i++) {
            var sub = $art_objucactrhfqa$art_obj[$art_idtenhcw$art_i];
