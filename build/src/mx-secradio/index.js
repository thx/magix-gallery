...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cteavhwvbe$art_c = list.length; itemIndex < $art_cteavhwvbe$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cteavhwvbe$art_c = list.length; itemIndex < $art_cteavhwvbe$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipjmsimcok$art_i = 0, $art_objimlvshp$art_obj = item.subs, $art_cskccql$art_c = $art_objimlvshp$art_obj.length; $art_ipjmsimcok$art_i < $art_cskccql$art_c; $art_ipjmsimcok$art_i++) {        var sub = $art_objimlvshp$art_obj[$art_ipjmsimcok$art_i]%>';
        for (var $art_ipjmsimcok$art_i = 0, $art_objimlvshp$art_obj = item.subs, $art_cskccql$art_c = $art_objimlvshp$art_obj.length; $art_ipjmsimcok$art_i < $art_cskccql$art_c; $art_ipjmsimcok$art_i++) {
            var sub = $art_objimlvshp$art_obj[$art_ipjmsimcok$art_i];
