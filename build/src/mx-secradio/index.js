...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cwwyzoqlzq$art_c = list.length; itemIndex < $art_cwwyzoqlzq$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cwwyzoqlzq$art_c = list.length; itemIndex < $art_cwwyzoqlzq$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixxzmnguo$art_i = 0, $art_objdjcitolkq$art_obj = item.subs, $art_cykhtmzdom$art_c = $art_objdjcitolkq$art_obj.length; $art_ixxzmnguo$art_i < $art_cykhtmzdom$art_c; $art_ixxzmnguo$art_i++) {        var sub = $art_objdjcitolkq$art_obj[$art_ixxzmnguo$art_i]%>';
        for (var $art_ixxzmnguo$art_i = 0, $art_objdjcitolkq$art_obj = item.subs, $art_cykhtmzdom$art_c = $art_objdjcitolkq$art_obj.length; $art_ixxzmnguo$art_i < $art_cykhtmzdom$art_c; $art_ixxzmnguo$art_i++) {
            var sub = $art_objdjcitolkq$art_obj[$art_ixxzmnguo$art_i];
