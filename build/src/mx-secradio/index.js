...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cbzohhzzxs$art_c = list.length; itemIndex < $art_cbzohhzzxs$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cbzohhzzxs$art_c = list.length; itemIndex < $art_cbzohhzzxs$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iidbthoafqb$art_i = 0, $art_objfpjtgoyj$art_obj = item.subs, $art_cycfhmyzu$art_c = $art_objfpjtgoyj$art_obj.length; $art_iidbthoafqb$art_i < $art_cycfhmyzu$art_c; $art_iidbthoafqb$art_i++) {        var sub = $art_objfpjtgoyj$art_obj[$art_iidbthoafqb$art_i]%>';
        for (var $art_iidbthoafqb$art_i = 0, $art_objfpjtgoyj$art_obj = item.subs, $art_cycfhmyzu$art_c = $art_objfpjtgoyj$art_obj.length; $art_iidbthoafqb$art_i < $art_cycfhmyzu$art_c; $art_iidbthoafqb$art_i++) {
            var sub = $art_objfpjtgoyj$art_obj[$art_iidbthoafqb$art_i];
