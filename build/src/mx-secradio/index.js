...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cyzlhwdlp$art_c = list.length; itemIndex < $art_cyzlhwdlp$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cyzlhwdlp$art_c = list.length; itemIndex < $art_cyzlhwdlp$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iznkcbitsntj$art_i = 0, $art_objgpetvvf$art_obj = item.subs, $art_cpgaxnwe$art_c = $art_objgpetvvf$art_obj.length; $art_iznkcbitsntj$art_i < $art_cpgaxnwe$art_c; $art_iznkcbitsntj$art_i++) {        var sub = $art_objgpetvvf$art_obj[$art_iznkcbitsntj$art_i]%>';
        for (var $art_iznkcbitsntj$art_i = 0, $art_objgpetvvf$art_obj = item.subs, $art_cpgaxnwe$art_c = $art_objgpetvvf$art_obj.length; $art_iznkcbitsntj$art_i < $art_cpgaxnwe$art_c; $art_iznkcbitsntj$art_i++) {
            var sub = $art_objgpetvvf$art_obj[$art_iznkcbitsntj$art_i];
