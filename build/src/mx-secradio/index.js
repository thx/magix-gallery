...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ccwo$art_c = list.length; itemIndex < $art_ccwo$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ccwo$art_c = list.length; itemIndex < $art_ccwo$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iqffvkic$art_i = 0, $art_objwmoenm$art_obj = item.subs, $art_cpludsxi$art_c = $art_objwmoenm$art_obj.length; $art_iqffvkic$art_i < $art_cpludsxi$art_c; $art_iqffvkic$art_i++) {        var sub = $art_objwmoenm$art_obj[$art_iqffvkic$art_i]%>';
        for (var $art_iqffvkic$art_i = 0, $art_objwmoenm$art_obj = item.subs, $art_cpludsxi$art_c = $art_objwmoenm$art_obj.length; $art_iqffvkic$art_i < $art_cpludsxi$art_c; $art_iqffvkic$art_i++) {
            var sub = $art_objwmoenm$art_obj[$art_iqffvkic$art_i];
