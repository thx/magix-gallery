...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cknml$art_c = list.length; itemIndex < $art_cknml$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cknml$art_c = list.length; itemIndex < $art_cknml$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipkihwmj$art_i = 0, $art_objqejpfw$art_obj = item.subs, $art_cqkeqyfp$art_c = $art_objqejpfw$art_obj.length; $art_ipkihwmj$art_i < $art_cqkeqyfp$art_c; $art_ipkihwmj$art_i++) {        var sub = $art_objqejpfw$art_obj[$art_ipkihwmj$art_i]%>';
        for (var $art_ipkihwmj$art_i = 0, $art_objqejpfw$art_obj = item.subs, $art_cqkeqyfp$art_c = $art_objqejpfw$art_obj.length; $art_ipkihwmj$art_i < $art_cqkeqyfp$art_c; $art_ipkihwmj$art_i++) {
            var sub = $art_objqejpfw$art_obj[$art_ipkihwmj$art_i];
