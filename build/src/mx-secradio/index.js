...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_czdpnlpfm$art_c = list.length; itemIndex < $art_czdpnlpfm$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_czdpnlpfm$art_c = list.length; itemIndex < $art_czdpnlpfm$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idrhlolpwrtv$art_i = 0, $art_objngkwid$art_obj = item.subs, $art_cmshcoptn$art_c = $art_objngkwid$art_obj.length; $art_idrhlolpwrtv$art_i < $art_cmshcoptn$art_c; $art_idrhlolpwrtv$art_i++) {        var sub = $art_objngkwid$art_obj[$art_idrhlolpwrtv$art_i]%>';
        for (var $art_idrhlolpwrtv$art_i = 0, $art_objngkwid$art_obj = item.subs, $art_cmshcoptn$art_c = $art_objngkwid$art_obj.length; $art_idrhlolpwrtv$art_i < $art_cmshcoptn$art_c; $art_idrhlolpwrtv$art_i++) {
            var sub = $art_objngkwid$art_obj[$art_idrhlolpwrtv$art_i];
