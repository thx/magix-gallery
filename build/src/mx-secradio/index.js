...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_chjomazdkka$art_c = list.length; itemIndex < $art_chjomazdkka$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_chjomazdkka$art_c = list.length; itemIndex < $art_chjomazdkka$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ihmckznxw$art_i = 0, $art_objivdabnem$art_obj = item.subs, $art_cnuigsix$art_c = $art_objivdabnem$art_obj.length; $art_ihmckznxw$art_i < $art_cnuigsix$art_c; $art_ihmckznxw$art_i++) {        var sub = $art_objivdabnem$art_obj[$art_ihmckznxw$art_i]%>';
        for (var $art_ihmckznxw$art_i = 0, $art_objivdabnem$art_obj = item.subs, $art_cnuigsix$art_c = $art_objivdabnem$art_obj.length; $art_ihmckznxw$art_i < $art_cnuigsix$art_c; $art_ihmckznxw$art_i++) {
            var sub = $art_objivdabnem$art_obj[$art_ihmckznxw$art_i];
