...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqgtnpsbj$art_c = list.length; itemIndex < $art_cqgtnpsbj$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqgtnpsbj$art_c = list.length; itemIndex < $art_cqgtnpsbj$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_izkgdnj$art_i = 0, $art_objxmubmwify$art_obj = item.subs, $art_ciseilp$art_c = $art_objxmubmwify$art_obj.length; $art_izkgdnj$art_i < $art_ciseilp$art_c; $art_izkgdnj$art_i++) {        var sub = $art_objxmubmwify$art_obj[$art_izkgdnj$art_i]%>';
        for (var $art_izkgdnj$art_i = 0, $art_objxmubmwify$art_obj = item.subs, $art_ciseilp$art_c = $art_objxmubmwify$art_obj.length; $art_izkgdnj$art_i < $art_ciseilp$art_c; $art_izkgdnj$art_i++) {
            var sub = $art_objxmubmwify$art_obj[$art_izkgdnj$art_i];
