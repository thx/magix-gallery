...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_clquhd$art_c = list.length; itemIndex < $art_clquhd$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_clquhd$art_c = list.length; itemIndex < $art_clquhd$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibimphhv$art_i = 0, $art_objbxhvaxzse$art_obj = item.subs, $art_cmcvskpv$art_c = $art_objbxhvaxzse$art_obj.length; $art_ibimphhv$art_i < $art_cmcvskpv$art_c; $art_ibimphhv$art_i++) {        var sub = $art_objbxhvaxzse$art_obj[$art_ibimphhv$art_i]%>';
        for (var $art_ibimphhv$art_i = 0, $art_objbxhvaxzse$art_obj = item.subs, $art_cmcvskpv$art_c = $art_objbxhvaxzse$art_obj.length; $art_ibimphhv$art_i < $art_cmcvskpv$art_c; $art_ibimphhv$art_i++) {
            var sub = $art_objbxhvaxzse$art_obj[$art_ibimphhv$art_i];
