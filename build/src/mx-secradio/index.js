...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_clgcuycrk$art_c = list.length; itemIndex < $art_clgcuycrk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_clgcuycrk$art_c = list.length; itemIndex < $art_clgcuycrk$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixdqepyjr$art_i = 0, $art_objtybkts$art_obj = item.subs, $art_cmvemori$art_c = $art_objtybkts$art_obj.length; $art_ixdqepyjr$art_i < $art_cmvemori$art_c; $art_ixdqepyjr$art_i++) {        var sub = $art_objtybkts$art_obj[$art_ixdqepyjr$art_i]%>';
        for (var $art_ixdqepyjr$art_i = 0, $art_objtybkts$art_obj = item.subs, $art_cmvemori$art_c = $art_objtybkts$art_obj.length; $art_ixdqepyjr$art_i < $art_cmvemori$art_c; $art_ixdqepyjr$art_i++) {
            var sub = $art_objtybkts$art_obj[$art_ixdqepyjr$art_i];
