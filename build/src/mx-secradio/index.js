...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cbxkizndpkt$art_c = list.length; itemIndex < $art_cbxkizndpkt$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cbxkizndpkt$art_c = list.length; itemIndex < $art_cbxkizndpkt$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iluujkg$art_i = 0, $art_objboxzj$art_obj = item.subs, $art_cqlbppqkigt$art_c = $art_objboxzj$art_obj.length; $art_iluujkg$art_i < $art_cqlbppqkigt$art_c; $art_iluujkg$art_i++) {        var sub = $art_objboxzj$art_obj[$art_iluujkg$art_i]%>';
        for (var $art_iluujkg$art_i = 0, $art_objboxzj$art_obj = item.subs, $art_cqlbppqkigt$art_c = $art_objboxzj$art_obj.length; $art_iluujkg$art_i < $art_cqlbppqkigt$art_c; $art_iluujkg$art_i++) {
            var sub = $art_objboxzj$art_obj[$art_iluujkg$art_i];
