...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cozbcsllp$art_c = list.length; itemIndex < $art_cozbcsllp$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cozbcsllp$art_c = list.length; itemIndex < $art_cozbcsllp$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilradetspsc$art_i = 0, $art_objlsqockn$art_obj = item.subs, $art_cxohxogsun$art_c = $art_objlsqockn$art_obj.length; $art_ilradetspsc$art_i < $art_cxohxogsun$art_c; $art_ilradetspsc$art_i++) {        var sub = $art_objlsqockn$art_obj[$art_ilradetspsc$art_i]%>';
        for (var $art_ilradetspsc$art_i = 0, $art_objlsqockn$art_obj = item.subs, $art_cxohxogsun$art_c = $art_objlsqockn$art_obj.length; $art_ilradetspsc$art_i < $art_cxohxogsun$art_c; $art_ilradetspsc$art_i++) {
            var sub = $art_objlsqockn$art_obj[$art_ilradetspsc$art_i];
