...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_czbaytdno$art_c = list.length; itemIndex < $art_czbaytdno$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_czbaytdno$art_c = list.length; itemIndex < $art_czbaytdno$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ifgqbwvb$art_i = 0, $art_objjvrtzvuf$art_obj = item.subs, $art_chrufvurymu$art_c = $art_objjvrtzvuf$art_obj.length; $art_ifgqbwvb$art_i < $art_chrufvurymu$art_c; $art_ifgqbwvb$art_i++) {        var sub = $art_objjvrtzvuf$art_obj[$art_ifgqbwvb$art_i]%>';
        for (var $art_ifgqbwvb$art_i = 0, $art_objjvrtzvuf$art_obj = item.subs, $art_chrufvurymu$art_c = $art_objjvrtzvuf$art_obj.length; $art_ifgqbwvb$art_i < $art_chrufvurymu$art_c; $art_ifgqbwvb$art_i++) {
            var sub = $art_objjvrtzvuf$art_obj[$art_ifgqbwvb$art_i];
