...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cedkyklj$art_c = list.length; itemIndex < $art_cedkyklj$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cedkyklj$art_c = list.length; itemIndex < $art_cedkyklj$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iurntdrvtgj$art_i = 0, $art_objjeoybd$art_obj = item.subs, $art_ctxeurmknb$art_c = $art_objjeoybd$art_obj.length; $art_iurntdrvtgj$art_i < $art_ctxeurmknb$art_c; $art_iurntdrvtgj$art_i++) {        var sub = $art_objjeoybd$art_obj[$art_iurntdrvtgj$art_i]%>';
        for (var $art_iurntdrvtgj$art_i = 0, $art_objjeoybd$art_obj = item.subs, $art_ctxeurmknb$art_c = $art_objjeoybd$art_obj.length; $art_iurntdrvtgj$art_i < $art_ctxeurmknb$art_c; $art_iurntdrvtgj$art_i++) {
            var sub = $art_objjeoybd$art_obj[$art_iurntdrvtgj$art_i];
