...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cxmplnl$art_c = list.length; itemIndex < $art_cxmplnl$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cxmplnl$art_c = list.length; itemIndex < $art_cxmplnl$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ikeaksbdos$art_i = 0, $art_objuuretjap$art_obj = item.subs, $art_crasapl$art_c = $art_objuuretjap$art_obj.length; $art_ikeaksbdos$art_i < $art_crasapl$art_c; $art_ikeaksbdos$art_i++) {        var sub = $art_objuuretjap$art_obj[$art_ikeaksbdos$art_i]%>';
        for (var $art_ikeaksbdos$art_i = 0, $art_objuuretjap$art_obj = item.subs, $art_crasapl$art_c = $art_objuuretjap$art_obj.length; $art_ikeaksbdos$art_i < $art_crasapl$art_c; $art_ikeaksbdos$art_i++) {
            var sub = $art_objuuretjap$art_obj[$art_ikeaksbdos$art_i];
