...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cfnvjiarvuq$art_c = list.length; itemIndex < $art_cfnvjiarvuq$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cfnvjiarvuq$art_c = list.length; itemIndex < $art_cfnvjiarvuq$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_isnkqdwzk$art_i = 0, $art_objfslcdmgdou$art_obj = item.subs, $art_cpaujmmfcdgb$art_c = $art_objfslcdmgdou$art_obj.length; $art_isnkqdwzk$art_i < $art_cpaujmmfcdgb$art_c; $art_isnkqdwzk$art_i++) {        var sub = $art_objfslcdmgdou$art_obj[$art_isnkqdwzk$art_i]%>';
        for (var $art_isnkqdwzk$art_i = 0, $art_objfslcdmgdou$art_obj = item.subs, $art_cpaujmmfcdgb$art_c = $art_objfslcdmgdou$art_obj.length; $art_isnkqdwzk$art_i < $art_cpaujmmfcdgb$art_c; $art_isnkqdwzk$art_i++) {
            var sub = $art_objfslcdmgdou$art_obj[$art_isnkqdwzk$art_i];
