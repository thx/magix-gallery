...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cwzbctxd$art_c = list.length; itemIndex < $art_cwzbctxd$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cwzbctxd$art_c = list.length; itemIndex < $art_cwzbctxd$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_imgyvjfnl$art_i = 0, $art_objaaqjlp$art_obj = item.subs, $art_cytjxayxjg$art_c = $art_objaaqjlp$art_obj.length; $art_imgyvjfnl$art_i < $art_cytjxayxjg$art_c; $art_imgyvjfnl$art_i++) {        var sub = $art_objaaqjlp$art_obj[$art_imgyvjfnl$art_i]%>';
        for (var $art_imgyvjfnl$art_i = 0, $art_objaaqjlp$art_obj = item.subs, $art_cytjxayxjg$art_c = $art_objaaqjlp$art_obj.length; $art_imgyvjfnl$art_i < $art_cytjxayxjg$art_c; $art_imgyvjfnl$art_i++) {
            var sub = $art_objaaqjlp$art_obj[$art_imgyvjfnl$art_i];
