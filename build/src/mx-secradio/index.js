...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cmugnhq$art_c = list.length; itemIndex < $art_cmugnhq$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cmugnhq$art_c = list.length; itemIndex < $art_cmugnhq$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iiycxggyzr$art_i = 0, $art_objywdlytzfn$art_obj = item.subs, $art_caprajos$art_c = $art_objywdlytzfn$art_obj.length; $art_iiycxggyzr$art_i < $art_caprajos$art_c; $art_iiycxggyzr$art_i++) {        var sub = $art_objywdlytzfn$art_obj[$art_iiycxggyzr$art_i]%>';
        for (var $art_iiycxggyzr$art_i = 0, $art_objywdlytzfn$art_obj = item.subs, $art_caprajos$art_c = $art_objywdlytzfn$art_obj.length; $art_iiycxggyzr$art_i < $art_caprajos$art_c; $art_iiycxggyzr$art_i++) {
            var sub = $art_objywdlytzfn$art_obj[$art_iiycxggyzr$art_i];
