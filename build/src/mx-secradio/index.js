...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqzdkobxtduq$art_c = list.length; itemIndex < $art_cqzdkobxtduq$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqzdkobxtduq$art_c = list.length; itemIndex < $art_cqzdkobxtduq$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_inagcwvb$art_i = 0, $art_objxgtnzyt$art_obj = item.subs, $art_cnklyjnvtq$art_c = $art_objxgtnzyt$art_obj.length; $art_inagcwvb$art_i < $art_cnklyjnvtq$art_c; $art_inagcwvb$art_i++) {        var sub = $art_objxgtnzyt$art_obj[$art_inagcwvb$art_i]%>';
        for (var $art_inagcwvb$art_i = 0, $art_objxgtnzyt$art_obj = item.subs, $art_cnklyjnvtq$art_c = $art_objxgtnzyt$art_obj.length; $art_inagcwvb$art_i < $art_cnklyjnvtq$art_c; $art_inagcwvb$art_i++) {
            var sub = $art_objxgtnzyt$art_obj[$art_inagcwvb$art_i];
