...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cmifgwdhl$art_c = list.length; itemIndex < $art_cmifgwdhl$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cmifgwdhl$art_c = list.length; itemIndex < $art_cmifgwdhl$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipphi$art_i = 0, $art_objoxebihdqbi$art_obj = item.subs, $art_crvxiyav$art_c = $art_objoxebihdqbi$art_obj.length; $art_ipphi$art_i < $art_crvxiyav$art_c; $art_ipphi$art_i++) {        var sub = $art_objoxebihdqbi$art_obj[$art_ipphi$art_i]%>';
        for (var $art_ipphi$art_i = 0, $art_objoxebihdqbi$art_obj = item.subs, $art_crvxiyav$art_c = $art_objoxebihdqbi$art_obj.length; $art_ipphi$art_i < $art_crvxiyav$art_c; $art_ipphi$art_i++) {
            var sub = $art_objoxebihdqbi$art_obj[$art_ipphi$art_i];
