...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cceonwup$art_c = list.length; itemIndex < $art_cceonwup$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cceonwup$art_c = list.length; itemIndex < $art_cceonwup$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igvapwcyo$art_i = 0, $art_objurkelxd$art_obj = item.subs, $art_cayegdyvz$art_c = $art_objurkelxd$art_obj.length; $art_igvapwcyo$art_i < $art_cayegdyvz$art_c; $art_igvapwcyo$art_i++) {        var sub = $art_objurkelxd$art_obj[$art_igvapwcyo$art_i]%>';
        for (var $art_igvapwcyo$art_i = 0, $art_objurkelxd$art_obj = item.subs, $art_cayegdyvz$art_c = $art_objurkelxd$art_obj.length; $art_igvapwcyo$art_i < $art_cayegdyvz$art_c; $art_igvapwcyo$art_i++) {
            var sub = $art_objurkelxd$art_obj[$art_igvapwcyo$art_i];
