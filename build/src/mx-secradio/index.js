...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_crflzsftbsun$art_c = list.length; itemIndex < $art_crflzsftbsun$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_crflzsftbsun$art_c = list.length; itemIndex < $art_crflzsftbsun$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ifpoipr$art_i = 0, $art_objnedrllfjy$art_obj = item.subs, $art_caqckluzi$art_c = $art_objnedrllfjy$art_obj.length; $art_ifpoipr$art_i < $art_caqckluzi$art_c; $art_ifpoipr$art_i++) {        var sub = $art_objnedrllfjy$art_obj[$art_ifpoipr$art_i]%>';
        for (var $art_ifpoipr$art_i = 0, $art_objnedrllfjy$art_obj = item.subs, $art_caqckluzi$art_c = $art_objnedrllfjy$art_obj.length; $art_ifpoipr$art_i < $art_caqckluzi$art_c; $art_ifpoipr$art_i++) {
            var sub = $art_objnedrllfjy$art_obj[$art_ifpoipr$art_i];
