...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cuznzkql$art_c = list.length; itemIndex < $art_cuznzkql$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cuznzkql$art_c = list.length; itemIndex < $art_cuznzkql$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iinvqdwfn$art_i = 0, $art_objgkduer$art_obj = item.subs, $art_cenfqrpdssf$art_c = $art_objgkduer$art_obj.length; $art_iinvqdwfn$art_i < $art_cenfqrpdssf$art_c; $art_iinvqdwfn$art_i++) {        var sub = $art_objgkduer$art_obj[$art_iinvqdwfn$art_i]%>';
        for (var $art_iinvqdwfn$art_i = 0, $art_objgkduer$art_obj = item.subs, $art_cenfqrpdssf$art_c = $art_objgkduer$art_obj.length; $art_iinvqdwfn$art_i < $art_cenfqrpdssf$art_c; $art_iinvqdwfn$art_i++) {
            var sub = $art_objgkduer$art_obj[$art_iinvqdwfn$art_i];
