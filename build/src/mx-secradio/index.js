...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cmpjffapk$art_c = list.length; itemIndex < $art_cmpjffapk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cmpjffapk$art_c = list.length; itemIndex < $art_cmpjffapk$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilokehxpdlf$art_i = 0, $art_objlajasanp$art_obj = item.subs, $art_cmbpbec$art_c = $art_objlajasanp$art_obj.length; $art_ilokehxpdlf$art_i < $art_cmbpbec$art_c; $art_ilokehxpdlf$art_i++) {        var sub = $art_objlajasanp$art_obj[$art_ilokehxpdlf$art_i]%>';
        for (var $art_ilokehxpdlf$art_i = 0, $art_objlajasanp$art_obj = item.subs, $art_cmbpbec$art_c = $art_objlajasanp$art_obj.length; $art_ilokehxpdlf$art_i < $art_cmbpbec$art_c; $art_ilokehxpdlf$art_i++) {
            var sub = $art_objlajasanp$art_obj[$art_ilokehxpdlf$art_i];
