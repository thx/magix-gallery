...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cjoukxsih$art_c = list.length; itemIndex < $art_cjoukxsih$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cjoukxsih$art_c = list.length; itemIndex < $art_cjoukxsih$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iappml$art_i = 0, $art_objnfjlmknh$art_obj = item.subs, $art_ckvfvat$art_c = $art_objnfjlmknh$art_obj.length; $art_iappml$art_i < $art_ckvfvat$art_c; $art_iappml$art_i++) {        var sub = $art_objnfjlmknh$art_obj[$art_iappml$art_i]%>';
        for (var $art_iappml$art_i = 0, $art_objnfjlmknh$art_obj = item.subs, $art_ckvfvat$art_c = $art_objnfjlmknh$art_obj.length; $art_iappml$art_i < $art_ckvfvat$art_c; $art_iappml$art_i++) {
            var sub = $art_objnfjlmknh$art_obj[$art_iappml$art_i];
