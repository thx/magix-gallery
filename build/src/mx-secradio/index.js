...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cycsvnmc$art_c = list.length; itemIndex < $art_cycsvnmc$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cycsvnmc$art_c = list.length; itemIndex < $art_cycsvnmc$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibpdosxxo$art_i = 0, $art_objayhfehm$art_obj = item.subs, $art_cxhdaucuux$art_c = $art_objayhfehm$art_obj.length; $art_ibpdosxxo$art_i < $art_cxhdaucuux$art_c; $art_ibpdosxxo$art_i++) {        var sub = $art_objayhfehm$art_obj[$art_ibpdosxxo$art_i]%>';
        for (var $art_ibpdosxxo$art_i = 0, $art_objayhfehm$art_obj = item.subs, $art_cxhdaucuux$art_c = $art_objayhfehm$art_obj.length; $art_ibpdosxxo$art_i < $art_cxhdaucuux$art_c; $art_ibpdosxxo$art_i++) {
            var sub = $art_objayhfehm$art_obj[$art_ibpdosxxo$art_i];
