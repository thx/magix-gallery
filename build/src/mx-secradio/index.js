...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqjcuxykx$art_c = list.length; itemIndex < $art_cqjcuxykx$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqjcuxykx$art_c = list.length; itemIndex < $art_cqjcuxykx$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_inbyjxjzudym$art_i = 0, $art_objralt$art_obj = item.subs, $art_cxwwnphh$art_c = $art_objralt$art_obj.length; $art_inbyjxjzudym$art_i < $art_cxwwnphh$art_c; $art_inbyjxjzudym$art_i++) {        var sub = $art_objralt$art_obj[$art_inbyjxjzudym$art_i]%>';
        for (var $art_inbyjxjzudym$art_i = 0, $art_objralt$art_obj = item.subs, $art_cxwwnphh$art_c = $art_objralt$art_obj.length; $art_inbyjxjzudym$art_i < $art_cxwwnphh$art_c; $art_inbyjxjzudym$art_i++) {
            var sub = $art_objralt$art_obj[$art_inbyjxjzudym$art_i];
