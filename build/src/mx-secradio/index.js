...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ccmfnwd$art_c = list.length; itemIndex < $art_ccmfnwd$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ccmfnwd$art_c = list.length; itemIndex < $art_ccmfnwd$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iegtjoerqgfo$art_i = 0, $art_objrtpbqsks$art_obj = item.subs, $art_cnidwduqnd$art_c = $art_objrtpbqsks$art_obj.length; $art_iegtjoerqgfo$art_i < $art_cnidwduqnd$art_c; $art_iegtjoerqgfo$art_i++) {        var sub = $art_objrtpbqsks$art_obj[$art_iegtjoerqgfo$art_i]%>';
        for (var $art_iegtjoerqgfo$art_i = 0, $art_objrtpbqsks$art_obj = item.subs, $art_cnidwduqnd$art_c = $art_objrtpbqsks$art_obj.length; $art_iegtjoerqgfo$art_i < $art_cnidwduqnd$art_c; $art_iegtjoerqgfo$art_i++) {
            var sub = $art_objrtpbqsks$art_obj[$art_iegtjoerqgfo$art_i];
