...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cfufgphtgsf$art_c = list.length; itemIndex < $art_cfufgphtgsf$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cfufgphtgsf$art_c = list.length; itemIndex < $art_cfufgphtgsf$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipdgionig$art_i = 0, $art_objhjdlmhip$art_obj = item.subs, $art_cqlqvjilch$art_c = $art_objhjdlmhip$art_obj.length; $art_ipdgionig$art_i < $art_cqlqvjilch$art_c; $art_ipdgionig$art_i++) {        var sub = $art_objhjdlmhip$art_obj[$art_ipdgionig$art_i]%>';
        for (var $art_ipdgionig$art_i = 0, $art_objhjdlmhip$art_obj = item.subs, $art_cqlqvjilch$art_c = $art_objhjdlmhip$art_obj.length; $art_ipdgionig$art_i < $art_cqlqvjilch$art_c; $art_ipdgionig$art_i++) {
            var sub = $art_objhjdlmhip$art_obj[$art_ipdgionig$art_i];
