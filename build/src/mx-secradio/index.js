...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cwcogoob$art_c = list.length; itemIndex < $art_cwcogoob$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cwcogoob$art_c = list.length; itemIndex < $art_cwcogoob$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_incughfws$art_i = 0, $art_objvghiutrf$art_obj = item.subs, $art_clyxpgnpt$art_c = $art_objvghiutrf$art_obj.length; $art_incughfws$art_i < $art_clyxpgnpt$art_c; $art_incughfws$art_i++) {        var sub = $art_objvghiutrf$art_obj[$art_incughfws$art_i]%>';
        for (var $art_incughfws$art_i = 0, $art_objvghiutrf$art_obj = item.subs, $art_clyxpgnpt$art_c = $art_objvghiutrf$art_obj.length; $art_incughfws$art_i < $art_clyxpgnpt$art_c; $art_incughfws$art_i++) {
            var sub = $art_objvghiutrf$art_obj[$art_incughfws$art_i];
