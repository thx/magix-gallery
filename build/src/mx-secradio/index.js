...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_csrbhpioi$art_c = list.length; itemIndex < $art_csrbhpioi$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_csrbhpioi$art_c = list.length; itemIndex < $art_csrbhpioi$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_inijots$art_i = 0, $art_objikgqzbfg$art_obj = item.subs, $art_cxqmcan$art_c = $art_objikgqzbfg$art_obj.length; $art_inijots$art_i < $art_cxqmcan$art_c; $art_inijots$art_i++) {        var sub = $art_objikgqzbfg$art_obj[$art_inijots$art_i]%>';
        for (var $art_inijots$art_i = 0, $art_objikgqzbfg$art_obj = item.subs, $art_cxqmcan$art_c = $art_objikgqzbfg$art_obj.length; $art_inijots$art_i < $art_cxqmcan$art_c; $art_inijots$art_i++) {
            var sub = $art_objikgqzbfg$art_obj[$art_inijots$art_i];
