...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ckizblxsyn$art_c = list.length; itemIndex < $art_ckizblxsyn$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ckizblxsyn$art_c = list.length; itemIndex < $art_ckizblxsyn$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibobekqggg$art_i = 0, $art_objcjmzo$art_obj = item.subs, $art_cwjnkwgop$art_c = $art_objcjmzo$art_obj.length; $art_ibobekqggg$art_i < $art_cwjnkwgop$art_c; $art_ibobekqggg$art_i++) {        var sub = $art_objcjmzo$art_obj[$art_ibobekqggg$art_i]%>';
        for (var $art_ibobekqggg$art_i = 0, $art_objcjmzo$art_obj = item.subs, $art_cwjnkwgop$art_c = $art_objcjmzo$art_obj.length; $art_ibobekqggg$art_i < $art_cwjnkwgop$art_c; $art_ibobekqggg$art_i++) {
            var sub = $art_objcjmzo$art_obj[$art_ibobekqggg$art_i];
