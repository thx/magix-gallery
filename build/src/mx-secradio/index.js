...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cyoqhu$art_c = list.length; itemIndex < $art_cyoqhu$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cyoqhu$art_c = list.length; itemIndex < $art_cyoqhu$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivcijtxod$art_i = 0, $art_objpzsnydzf$art_obj = item.subs, $art_cryyrhujrz$art_c = $art_objpzsnydzf$art_obj.length; $art_ivcijtxod$art_i < $art_cryyrhujrz$art_c; $art_ivcijtxod$art_i++) {        var sub = $art_objpzsnydzf$art_obj[$art_ivcijtxod$art_i]%>';
        for (var $art_ivcijtxod$art_i = 0, $art_objpzsnydzf$art_obj = item.subs, $art_cryyrhujrz$art_c = $art_objpzsnydzf$art_obj.length; $art_ivcijtxod$art_i < $art_cryyrhujrz$art_c; $art_ivcijtxod$art_i++) {
            var sub = $art_objpzsnydzf$art_obj[$art_ivcijtxod$art_i];
