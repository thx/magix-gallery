...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_clrvfnmisyf$art_c = list.length; itemIndex < $art_clrvfnmisyf$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_clrvfnmisyf$art_c = list.length; itemIndex < $art_clrvfnmisyf$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iapgxo$art_i = 0, $art_objetglpep$art_obj = item.subs, $art_cwvkrsaq$art_c = $art_objetglpep$art_obj.length; $art_iapgxo$art_i < $art_cwvkrsaq$art_c; $art_iapgxo$art_i++) {        var sub = $art_objetglpep$art_obj[$art_iapgxo$art_i]%>';
        for (var $art_iapgxo$art_i = 0, $art_objetglpep$art_obj = item.subs, $art_cwvkrsaq$art_c = $art_objetglpep$art_obj.length; $art_iapgxo$art_i < $art_cwvkrsaq$art_c; $art_iapgxo$art_i++) {
            var sub = $art_objetglpep$art_obj[$art_iapgxo$art_i];
