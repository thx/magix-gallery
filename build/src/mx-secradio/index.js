...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_clyxwqod$art_c = list.length; itemIndex < $art_clyxwqod$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_clyxwqod$art_c = list.length; itemIndex < $art_clyxwqod$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieobvytb$art_i = 0, $art_objmngskrjqy$art_obj = item.subs, $art_coblybvty$art_c = $art_objmngskrjqy$art_obj.length; $art_ieobvytb$art_i < $art_coblybvty$art_c; $art_ieobvytb$art_i++) {        var sub = $art_objmngskrjqy$art_obj[$art_ieobvytb$art_i]%>';
        for (var $art_ieobvytb$art_i = 0, $art_objmngskrjqy$art_obj = item.subs, $art_coblybvty$art_c = $art_objmngskrjqy$art_obj.length; $art_ieobvytb$art_i < $art_coblybvty$art_c; $art_ieobvytb$art_i++) {
            var sub = $art_objmngskrjqy$art_obj[$art_ieobvytb$art_i];
