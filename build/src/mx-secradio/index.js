...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cdlayctp$art_c = list.length; itemIndex < $art_cdlayctp$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cdlayctp$art_c = list.length; itemIndex < $art_cdlayctp$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixvlcruca$art_i = 0, $art_objhmgjcqdo$art_obj = item.subs, $art_crkjrvqtay$art_c = $art_objhmgjcqdo$art_obj.length; $art_ixvlcruca$art_i < $art_crkjrvqtay$art_c; $art_ixvlcruca$art_i++) {        var sub = $art_objhmgjcqdo$art_obj[$art_ixvlcruca$art_i]%>';
        for (var $art_ixvlcruca$art_i = 0, $art_objhmgjcqdo$art_obj = item.subs, $art_crkjrvqtay$art_c = $art_objhmgjcqdo$art_obj.length; $art_ixvlcruca$art_i < $art_crkjrvqtay$art_c; $art_ixvlcruca$art_i++) {
            var sub = $art_objhmgjcqdo$art_obj[$art_ixvlcruca$art_i];
