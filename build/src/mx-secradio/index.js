...
module.exports = Magix.View.extend({
    ...
    if (needExpand) {
        ;
        $p += '<div mxa="_zs_gallerycm:_" class="_zs_gallery_mx-secradio_index_-line _zs_gallery_mx-secradio_index_-all" mx-click="' + $viewId + '@{toggleAll}()">一键';
        $line = 3;
        $art = 'if close';
        ;
        $expr = '<%if (close) {%>';
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ccfmwdmk$art_c = list.length; itemIndex < $art_ccfmwdmk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ccfmwdmk$art_c = list.length; itemIndex < $art_ccfmwdmk$art_c; itemIndex++) {
        var item = list[itemIndex];
        $p += '<div mxa="_zs_gallerycm:a" class="_zs_gallery_mx-secradio_index_-line"><label mx-click="' + $viewId + '@{toggleOne}({index:';
        $line = 9;
        $art = '=itemIndex';
        ;
        ...
        if (needExpand) {
            ;
            $p += '<i mxa="_zs_gallerycm:b" class="mc-iconfont _zs_gallery_mx-secradio_index_-oper">';
            $line = 12;
            $art = 'if item.close';
            ;
            $expr = '<%if (item.close) {%>';
        ...
        ;
        $expr = '<%for (var $art_iqpcgeajzk$art_i = 0, $art_objjefzamzr$art_obj = item.subs, $art_cbdjluiz$art_c = $art_objjefzamzr$art_obj.length; $art_iqpcgeajzk$art_i < $art_cbdjluiz$art_c; $art_iqpcgeajzk$art_i++) {        var sub = $art_objjefzamzr$art_obj[$art_iqpcgeajzk$art_i]%>';
        for (var $art_iqpcgeajzk$art_i = 0, $art_objjefzamzr$art_obj = item.subs, $art_cbdjluiz$art_c = $art_objjefzamzr$art_obj.length; $art_iqpcgeajzk$art_i < $art_cbdjluiz$art_c; $art_iqpcgeajzk$art_i++) {
            var sub = $art_objjefzamzr$art_obj[$art_iqpcgeajzk$art_i];
