...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cxevijq$art_c = list.length; itemIndex < $art_cxevijq$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cxevijq$art_c = list.length; itemIndex < $art_cxevijq$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ikypizzcdr$art_i = 0, $art_objiutqoxzmbh$art_obj = item.subs, $art_csbfqlvq$art_c = $art_objiutqoxzmbh$art_obj.length; $art_ikypizzcdr$art_i < $art_csbfqlvq$art_c; $art_ikypizzcdr$art_i++) {        var sub = $art_objiutqoxzmbh$art_obj[$art_ikypizzcdr$art_i]%>';
        for (var $art_ikypizzcdr$art_i = 0, $art_objiutqoxzmbh$art_obj = item.subs, $art_csbfqlvq$art_c = $art_objiutqoxzmbh$art_obj.length; $art_ikypizzcdr$art_i < $art_csbfqlvq$art_c; $art_ikypizzcdr$art_i++) {
            var sub = $art_objiutqoxzmbh$art_obj[$art_ikypizzcdr$art_i];
