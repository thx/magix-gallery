...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ckntayoqxfk$art_c = list.length; itemIndex < $art_ckntayoqxfk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ckntayoqxfk$art_c = list.length; itemIndex < $art_ckntayoqxfk$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibgozbit$art_i = 0, $art_objtszaebvv$art_obj = item.subs, $art_ctlqbytuc$art_c = $art_objtszaebvv$art_obj.length; $art_ibgozbit$art_i < $art_ctlqbytuc$art_c; $art_ibgozbit$art_i++) {        var sub = $art_objtszaebvv$art_obj[$art_ibgozbit$art_i]%>';
        for (var $art_ibgozbit$art_i = 0, $art_objtszaebvv$art_obj = item.subs, $art_ctlqbytuc$art_c = $art_objtszaebvv$art_obj.length; $art_ibgozbit$art_i < $art_ctlqbytuc$art_c; $art_ibgozbit$art_i++) {
            var sub = $art_objtszaebvv$art_obj[$art_ibgozbit$art_i];
