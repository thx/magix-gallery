...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ctinhzk$art_c = list.length; itemIndex < $art_ctinhzk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ctinhzk$art_c = list.length; itemIndex < $art_ctinhzk$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ihlhdmzh$art_i = 0, $art_objwzcqrybky$art_obj = item.subs, $art_cvrccwec$art_c = $art_objwzcqrybky$art_obj.length; $art_ihlhdmzh$art_i < $art_cvrccwec$art_c; $art_ihlhdmzh$art_i++) {        var sub = $art_objwzcqrybky$art_obj[$art_ihlhdmzh$art_i]%>';
        for (var $art_ihlhdmzh$art_i = 0, $art_objwzcqrybky$art_obj = item.subs, $art_cvrccwec$art_c = $art_objwzcqrybky$art_obj.length; $art_ihlhdmzh$art_i < $art_cvrccwec$art_c; $art_ihlhdmzh$art_i++) {
            var sub = $art_objwzcqrybky$art_obj[$art_ihlhdmzh$art_i];
