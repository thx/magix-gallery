...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cyekdboinw$art_c = list.length; itemIndex < $art_cyekdboinw$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cyekdboinw$art_c = list.length; itemIndex < $art_cyekdboinw$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivezdpwal$art_i = 0, $art_objyzbwucrrd$art_obj = item.subs, $art_cqvxwaz$art_c = $art_objyzbwucrrd$art_obj.length; $art_ivezdpwal$art_i < $art_cqvxwaz$art_c; $art_ivezdpwal$art_i++) {        var sub = $art_objyzbwucrrd$art_obj[$art_ivezdpwal$art_i]%>';
        for (var $art_ivezdpwal$art_i = 0, $art_objyzbwucrrd$art_obj = item.subs, $art_cqvxwaz$art_c = $art_objyzbwucrrd$art_obj.length; $art_ivezdpwal$art_i < $art_cqvxwaz$art_c; $art_ivezdpwal$art_i++) {
            var sub = $art_objyzbwucrrd$art_obj[$art_ivezdpwal$art_i];
