...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cnnagokxxhs$art_c = list.length; itemIndex < $art_cnnagokxxhs$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cnnagokxxhs$art_c = list.length; itemIndex < $art_cnnagokxxhs$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iincnfgq$art_i = 0, $art_objpgjespbl$art_obj = item.subs, $art_ctcarctgwr$art_c = $art_objpgjespbl$art_obj.length; $art_iincnfgq$art_i < $art_ctcarctgwr$art_c; $art_iincnfgq$art_i++) {        var sub = $art_objpgjespbl$art_obj[$art_iincnfgq$art_i]%>';
        for (var $art_iincnfgq$art_i = 0, $art_objpgjespbl$art_obj = item.subs, $art_ctcarctgwr$art_c = $art_objpgjespbl$art_obj.length; $art_iincnfgq$art_i < $art_ctcarctgwr$art_c; $art_iincnfgq$art_i++) {
            var sub = $art_objpgjespbl$art_obj[$art_iincnfgq$art_i];
