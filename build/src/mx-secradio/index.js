...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqbnpac$art_c = list.length; itemIndex < $art_cqbnpac$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqbnpac$art_c = list.length; itemIndex < $art_cqbnpac$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibahfczq$art_i = 0, $art_objckqkxek$art_obj = item.subs, $art_cjgtboadq$art_c = $art_objckqkxek$art_obj.length; $art_ibahfczq$art_i < $art_cjgtboadq$art_c; $art_ibahfczq$art_i++) {        var sub = $art_objckqkxek$art_obj[$art_ibahfczq$art_i]%>';
        for (var $art_ibahfczq$art_i = 0, $art_objckqkxek$art_obj = item.subs, $art_cjgtboadq$art_c = $art_objckqkxek$art_obj.length; $art_ibahfczq$art_i < $art_cjgtboadq$art_c; $art_ibahfczq$art_i++) {
            var sub = $art_objckqkxek$art_obj[$art_ibahfczq$art_i];
