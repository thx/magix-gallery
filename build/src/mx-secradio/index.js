...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_csijetqwpf$art_c = list.length; itemIndex < $art_csijetqwpf$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_csijetqwpf$art_c = list.length; itemIndex < $art_csijetqwpf$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idfhelc$art_i = 0, $art_objmnauko$art_obj = item.subs, $art_clrvvqoumc$art_c = $art_objmnauko$art_obj.length; $art_idfhelc$art_i < $art_clrvvqoumc$art_c; $art_idfhelc$art_i++) {        var sub = $art_objmnauko$art_obj[$art_idfhelc$art_i]%>';
        for (var $art_idfhelc$art_i = 0, $art_objmnauko$art_obj = item.subs, $art_clrvvqoumc$art_c = $art_objmnauko$art_obj.length; $art_idfhelc$art_i < $art_clrvvqoumc$art_c; $art_idfhelc$art_i++) {
            var sub = $art_objmnauko$art_obj[$art_idfhelc$art_i];
