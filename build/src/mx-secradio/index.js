...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cbmtcgeyeqk$art_c = list.length; itemIndex < $art_cbmtcgeyeqk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cbmtcgeyeqk$art_c = list.length; itemIndex < $art_cbmtcgeyeqk$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iymiuse$art_i = 0, $art_objybycdzakg$art_obj = item.subs, $art_cyzyvcoxt$art_c = $art_objybycdzakg$art_obj.length; $art_iymiuse$art_i < $art_cyzyvcoxt$art_c; $art_iymiuse$art_i++) {        var sub = $art_objybycdzakg$art_obj[$art_iymiuse$art_i]%>';
        for (var $art_iymiuse$art_i = 0, $art_objybycdzakg$art_obj = item.subs, $art_cyzyvcoxt$art_c = $art_objybycdzakg$art_obj.length; $art_iymiuse$art_i < $art_cyzyvcoxt$art_c; $art_iymiuse$art_i++) {
            var sub = $art_objybycdzakg$art_obj[$art_iymiuse$art_i];
