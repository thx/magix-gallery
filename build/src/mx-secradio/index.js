...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ckxmlbeato$art_c = list.length; itemIndex < $art_ckxmlbeato$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ckxmlbeato$art_c = list.length; itemIndex < $art_ckxmlbeato$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iusecaevyh$art_i = 0, $art_objznrscpfug$art_obj = item.subs, $art_cjrszklub$art_c = $art_objznrscpfug$art_obj.length; $art_iusecaevyh$art_i < $art_cjrszklub$art_c; $art_iusecaevyh$art_i++) {        var sub = $art_objznrscpfug$art_obj[$art_iusecaevyh$art_i]%>';
        for (var $art_iusecaevyh$art_i = 0, $art_objznrscpfug$art_obj = item.subs, $art_cjrszklub$art_c = $art_objznrscpfug$art_obj.length; $art_iusecaevyh$art_i < $art_cjrszklub$art_c; $art_iusecaevyh$art_i++) {
            var sub = $art_objznrscpfug$art_obj[$art_iusecaevyh$art_i];
