...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_czdprgr$art_c = list.length; itemIndex < $art_czdprgr$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_czdprgr$art_c = list.length; itemIndex < $art_czdprgr$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_imvdjvgzau$art_i = 0, $art_objynmtmo$art_obj = item.subs, $art_ciqzqjhg$art_c = $art_objynmtmo$art_obj.length; $art_imvdjvgzau$art_i < $art_ciqzqjhg$art_c; $art_imvdjvgzau$art_i++) {        var sub = $art_objynmtmo$art_obj[$art_imvdjvgzau$art_i]%>';
        for (var $art_imvdjvgzau$art_i = 0, $art_objynmtmo$art_obj = item.subs, $art_ciqzqjhg$art_c = $art_objynmtmo$art_obj.length; $art_imvdjvgzau$art_i < $art_ciqzqjhg$art_c; $art_imvdjvgzau$art_i++) {
            var sub = $art_objynmtmo$art_obj[$art_imvdjvgzau$art_i];
