...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_coezsutvf$art_c = list.length; itemIndex < $art_coezsutvf$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_coezsutvf$art_c = list.length; itemIndex < $art_coezsutvf$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipanvzckejm$art_i = 0, $art_objcuvxymgwr$art_obj = item.subs, $art_cjgsmnjo$art_c = $art_objcuvxymgwr$art_obj.length; $art_ipanvzckejm$art_i < $art_cjgsmnjo$art_c; $art_ipanvzckejm$art_i++) {        var sub = $art_objcuvxymgwr$art_obj[$art_ipanvzckejm$art_i]%>';
        for (var $art_ipanvzckejm$art_i = 0, $art_objcuvxymgwr$art_obj = item.subs, $art_cjgsmnjo$art_c = $art_objcuvxymgwr$art_obj.length; $art_ipanvzckejm$art_i < $art_cjgsmnjo$art_c; $art_ipanvzckejm$art_i++) {
            var sub = $art_objcuvxymgwr$art_obj[$art_ipanvzckejm$art_i];
