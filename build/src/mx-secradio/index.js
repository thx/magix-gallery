...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cjfjfxo$art_c = list.length; itemIndex < $art_cjfjfxo$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cjfjfxo$art_c = list.length; itemIndex < $art_cjfjfxo$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iagkfrmmtgjj$art_i = 0, $art_objzdwnwtg$art_obj = item.subs, $art_cccwdqql$art_c = $art_objzdwnwtg$art_obj.length; $art_iagkfrmmtgjj$art_i < $art_cccwdqql$art_c; $art_iagkfrmmtgjj$art_i++) {        var sub = $art_objzdwnwtg$art_obj[$art_iagkfrmmtgjj$art_i]%>';
        for (var $art_iagkfrmmtgjj$art_i = 0, $art_objzdwnwtg$art_obj = item.subs, $art_cccwdqql$art_c = $art_objzdwnwtg$art_obj.length; $art_iagkfrmmtgjj$art_i < $art_cccwdqql$art_c; $art_iagkfrmmtgjj$art_i++) {
            var sub = $art_objzdwnwtg$art_obj[$art_iagkfrmmtgjj$art_i];
