...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cgcbkhgm$art_c = list.length; itemIndex < $art_cgcbkhgm$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cgcbkhgm$art_c = list.length; itemIndex < $art_cgcbkhgm$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieupbijb$art_i = 0, $art_objfynt$art_obj = item.subs, $art_croebfo$art_c = $art_objfynt$art_obj.length; $art_ieupbijb$art_i < $art_croebfo$art_c; $art_ieupbijb$art_i++) {        var sub = $art_objfynt$art_obj[$art_ieupbijb$art_i]%>';
        for (var $art_ieupbijb$art_i = 0, $art_objfynt$art_obj = item.subs, $art_croebfo$art_c = $art_objfynt$art_obj.length; $art_ieupbijb$art_i < $art_croebfo$art_c; $art_ieupbijb$art_i++) {
            var sub = $art_objfynt$art_obj[$art_ieupbijb$art_i];
