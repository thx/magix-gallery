...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_crnsewwff$art_c = list.length; itemIndex < $art_crnsewwff$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_crnsewwff$art_c = list.length; itemIndex < $art_crnsewwff$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iyjeheenj$art_i = 0, $art_objisnrofm$art_obj = item.subs, $art_czrgezth$art_c = $art_objisnrofm$art_obj.length; $art_iyjeheenj$art_i < $art_czrgezth$art_c; $art_iyjeheenj$art_i++) {        var sub = $art_objisnrofm$art_obj[$art_iyjeheenj$art_i]%>';
        for (var $art_iyjeheenj$art_i = 0, $art_objisnrofm$art_obj = item.subs, $art_czrgezth$art_c = $art_objisnrofm$art_obj.length; $art_iyjeheenj$art_i < $art_czrgezth$art_c; $art_iyjeheenj$art_i++) {
            var sub = $art_objisnrofm$art_obj[$art_iyjeheenj$art_i];
