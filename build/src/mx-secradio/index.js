...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cgiwtkxg$art_c = list.length; itemIndex < $art_cgiwtkxg$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cgiwtkxg$art_c = list.length; itemIndex < $art_cgiwtkxg$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iuterykiye$art_i = 0, $art_objxvmenqhzf$art_obj = item.subs, $art_cykcuujhu$art_c = $art_objxvmenqhzf$art_obj.length; $art_iuterykiye$art_i < $art_cykcuujhu$art_c; $art_iuterykiye$art_i++) {        var sub = $art_objxvmenqhzf$art_obj[$art_iuterykiye$art_i]%>';
        for (var $art_iuterykiye$art_i = 0, $art_objxvmenqhzf$art_obj = item.subs, $art_cykcuujhu$art_c = $art_objxvmenqhzf$art_obj.length; $art_iuterykiye$art_i < $art_cykcuujhu$art_c; $art_iuterykiye$art_i++) {
            var sub = $art_objxvmenqhzf$art_obj[$art_iuterykiye$art_i];
