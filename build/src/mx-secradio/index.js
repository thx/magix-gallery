...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cixjdvdh$art_c = list.length; itemIndex < $art_cixjdvdh$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cixjdvdh$art_c = list.length; itemIndex < $art_cixjdvdh$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_inycqcelmh$art_i = 0, $art_objtrkymxq$art_obj = item.subs, $art_ckcllhod$art_c = $art_objtrkymxq$art_obj.length; $art_inycqcelmh$art_i < $art_ckcllhod$art_c; $art_inycqcelmh$art_i++) {        var sub = $art_objtrkymxq$art_obj[$art_inycqcelmh$art_i]%>';
        for (var $art_inycqcelmh$art_i = 0, $art_objtrkymxq$art_obj = item.subs, $art_ckcllhod$art_c = $art_objtrkymxq$art_obj.length; $art_inycqcelmh$art_i < $art_ckcllhod$art_c; $art_inycqcelmh$art_i++) {
            var sub = $art_objtrkymxq$art_obj[$art_inycqcelmh$art_i];
