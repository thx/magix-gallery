...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cifntdc$art_c = list.length; itemIndex < $art_cifntdc$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cifntdc$art_c = list.length; itemIndex < $art_cifntdc$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ievtsqtgwos$art_i = 0, $art_objpdtagfske$art_obj = item.subs, $art_chnfieldw$art_c = $art_objpdtagfske$art_obj.length; $art_ievtsqtgwos$art_i < $art_chnfieldw$art_c; $art_ievtsqtgwos$art_i++) {        var sub = $art_objpdtagfske$art_obj[$art_ievtsqtgwos$art_i]%>';
        for (var $art_ievtsqtgwos$art_i = 0, $art_objpdtagfske$art_obj = item.subs, $art_chnfieldw$art_c = $art_objpdtagfske$art_obj.length; $art_ievtsqtgwos$art_i < $art_chnfieldw$art_c; $art_ievtsqtgwos$art_i++) {
            var sub = $art_objpdtagfske$art_obj[$art_ievtsqtgwos$art_i];
