...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cjaynjx$art_c = list.length; itemIndex < $art_cjaynjx$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cjaynjx$art_c = list.length; itemIndex < $art_cjaynjx$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iwdsoepj$art_i = 0, $art_objnkuwwfzb$art_obj = item.subs, $art_cxtqrotlytp$art_c = $art_objnkuwwfzb$art_obj.length; $art_iwdsoepj$art_i < $art_cxtqrotlytp$art_c; $art_iwdsoepj$art_i++) {        var sub = $art_objnkuwwfzb$art_obj[$art_iwdsoepj$art_i]%>';
        for (var $art_iwdsoepj$art_i = 0, $art_objnkuwwfzb$art_obj = item.subs, $art_cxtqrotlytp$art_c = $art_objnkuwwfzb$art_obj.length; $art_iwdsoepj$art_i < $art_cxtqrotlytp$art_c; $art_iwdsoepj$art_i++) {
            var sub = $art_objnkuwwfzb$art_obj[$art_iwdsoepj$art_i];
