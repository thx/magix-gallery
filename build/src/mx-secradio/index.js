...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cclgfspxut$art_c = list.length; itemIndex < $art_cclgfspxut$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cclgfspxut$art_c = list.length; itemIndex < $art_cclgfspxut$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipmdkeqtt$art_i = 0, $art_objlwvjdzcf$art_obj = item.subs, $art_czihtqgf$art_c = $art_objlwvjdzcf$art_obj.length; $art_ipmdkeqtt$art_i < $art_czihtqgf$art_c; $art_ipmdkeqtt$art_i++) {        var sub = $art_objlwvjdzcf$art_obj[$art_ipmdkeqtt$art_i]%>';
        for (var $art_ipmdkeqtt$art_i = 0, $art_objlwvjdzcf$art_obj = item.subs, $art_czihtqgf$art_c = $art_objlwvjdzcf$art_obj.length; $art_ipmdkeqtt$art_i < $art_czihtqgf$art_c; $art_ipmdkeqtt$art_i++) {
            var sub = $art_objlwvjdzcf$art_obj[$art_ipmdkeqtt$art_i];
