...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_czbrbtyx$art_c = list.length; itemIndex < $art_czbrbtyx$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_czbrbtyx$art_c = list.length; itemIndex < $art_czbrbtyx$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iskkpv$art_i = 0, $art_objfhyodcusf$art_obj = item.subs, $art_cqbvoykaj$art_c = $art_objfhyodcusf$art_obj.length; $art_iskkpv$art_i < $art_cqbvoykaj$art_c; $art_iskkpv$art_i++) {        var sub = $art_objfhyodcusf$art_obj[$art_iskkpv$art_i]%>';
        for (var $art_iskkpv$art_i = 0, $art_objfhyodcusf$art_obj = item.subs, $art_cqbvoykaj$art_c = $art_objfhyodcusf$art_obj.length; $art_iskkpv$art_i < $art_cqbvoykaj$art_c; $art_iskkpv$art_i++) {
            var sub = $art_objfhyodcusf$art_obj[$art_iskkpv$art_i];
