...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_czimtlpitti$art_c = list.length; itemIndex < $art_czimtlpitti$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_czimtlpitti$art_c = list.length; itemIndex < $art_czimtlpitti$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_izeicrmgo$art_i = 0, $art_objctjbniwk$art_obj = item.subs, $art_cpxbvzgdi$art_c = $art_objctjbniwk$art_obj.length; $art_izeicrmgo$art_i < $art_cpxbvzgdi$art_c; $art_izeicrmgo$art_i++) {        var sub = $art_objctjbniwk$art_obj[$art_izeicrmgo$art_i]%>';
        for (var $art_izeicrmgo$art_i = 0, $art_objctjbniwk$art_obj = item.subs, $art_cpxbvzgdi$art_c = $art_objctjbniwk$art_obj.length; $art_izeicrmgo$art_i < $art_cpxbvzgdi$art_c; $art_izeicrmgo$art_i++) {
            var sub = $art_objctjbniwk$art_obj[$art_izeicrmgo$art_i];
