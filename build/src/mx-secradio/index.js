...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ccketmez$art_c = list.length; itemIndex < $art_ccketmez$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ccketmez$art_c = list.length; itemIndex < $art_ccketmez$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ikfxjhrpzi$art_i = 0, $art_objrftqbvtef$art_obj = item.subs, $art_csyeedvg$art_c = $art_objrftqbvtef$art_obj.length; $art_ikfxjhrpzi$art_i < $art_csyeedvg$art_c; $art_ikfxjhrpzi$art_i++) {        var sub = $art_objrftqbvtef$art_obj[$art_ikfxjhrpzi$art_i]%>';
        for (var $art_ikfxjhrpzi$art_i = 0, $art_objrftqbvtef$art_obj = item.subs, $art_csyeedvg$art_c = $art_objrftqbvtef$art_obj.length; $art_ikfxjhrpzi$art_i < $art_csyeedvg$art_c; $art_ikfxjhrpzi$art_i++) {
            var sub = $art_objrftqbvtef$art_obj[$art_ikfxjhrpzi$art_i];
