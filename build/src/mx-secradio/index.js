...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cuicfhayhn$art_c = list.length; itemIndex < $art_cuicfhayhn$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cuicfhayhn$art_c = list.length; itemIndex < $art_cuicfhayhn$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipncfx$art_i = 0, $art_objkiqdfonwh$art_obj = item.subs, $art_czdrdubk$art_c = $art_objkiqdfonwh$art_obj.length; $art_ipncfx$art_i < $art_czdrdubk$art_c; $art_ipncfx$art_i++) {        var sub = $art_objkiqdfonwh$art_obj[$art_ipncfx$art_i]%>';
        for (var $art_ipncfx$art_i = 0, $art_objkiqdfonwh$art_obj = item.subs, $art_czdrdubk$art_c = $art_objkiqdfonwh$art_obj.length; $art_ipncfx$art_i < $art_czdrdubk$art_c; $art_ipncfx$art_i++) {
            var sub = $art_objkiqdfonwh$art_obj[$art_ipncfx$art_i];
