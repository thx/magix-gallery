...
module.exports = Magix.View.extend({
    ...
    if (needExpand) {
        ;
        $p += '<div mxa="_zs_gallerycX:_" class="_zs_gallery_mx-secradio_index_-line _zs_gallery_mx-secradio_index_-all" mx-click="' + $viewId + '@{toggleAll}()">';
        $line = 3;
        $art = 'if close';
        ;
        $expr = '<%if (close) {%>';
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cznflgvdfo$art_c = list.length; itemIndex < $art_cznflgvdfo$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cznflgvdfo$art_c = list.length; itemIndex < $art_cznflgvdfo$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_irrqbgqj$art_i = 0, $art_objajifrlq$art_obj = item.subs, $art_cugqxic$art_c = $art_objajifrlq$art_obj.length; $art_irrqbgqj$art_i < $art_cugqxic$art_c; $art_irrqbgqj$art_i++) {        var sub = $art_objajifrlq$art_obj[$art_irrqbgqj$art_i]%>';
        for (var $art_irrqbgqj$art_i = 0, $art_objajifrlq$art_obj = item.subs, $art_cugqxic$art_c = $art_objajifrlq$art_obj.length; $art_irrqbgqj$art_i < $art_cugqxic$art_c; $art_irrqbgqj$art_i++) {
            var sub = $art_objajifrlq$art_obj[$art_irrqbgqj$art_i];
