...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cukrkyqpf$art_c = list.length; itemIndex < $art_cukrkyqpf$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cukrkyqpf$art_c = list.length; itemIndex < $art_cukrkyqpf$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ildsgkyyh$art_i = 0, $art_objjdfibezp$art_obj = item.subs, $art_cdgctwnb$art_c = $art_objjdfibezp$art_obj.length; $art_ildsgkyyh$art_i < $art_cdgctwnb$art_c; $art_ildsgkyyh$art_i++) {        var sub = $art_objjdfibezp$art_obj[$art_ildsgkyyh$art_i]%>';
        for (var $art_ildsgkyyh$art_i = 0, $art_objjdfibezp$art_obj = item.subs, $art_cdgctwnb$art_c = $art_objjdfibezp$art_obj.length; $art_ildsgkyyh$art_i < $art_cdgctwnb$art_c; $art_ildsgkyyh$art_i++) {
            var sub = $art_objjdfibezp$art_obj[$art_ildsgkyyh$art_i];
