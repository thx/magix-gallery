...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cszwwfb$art_c = list.length; itemIndex < $art_cszwwfb$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cszwwfb$art_c = list.length; itemIndex < $art_cszwwfb$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibfjyfduqp$art_i = 0, $art_objmirxrish$art_obj = item.subs, $art_clbllmunzef$art_c = $art_objmirxrish$art_obj.length; $art_ibfjyfduqp$art_i < $art_clbllmunzef$art_c; $art_ibfjyfduqp$art_i++) {        var sub = $art_objmirxrish$art_obj[$art_ibfjyfduqp$art_i]%>';
        for (var $art_ibfjyfduqp$art_i = 0, $art_objmirxrish$art_obj = item.subs, $art_clbllmunzef$art_c = $art_objmirxrish$art_obj.length; $art_ibfjyfduqp$art_i < $art_clbllmunzef$art_c; $art_ibfjyfduqp$art_i++) {
            var sub = $art_objmirxrish$art_obj[$art_ibfjyfduqp$art_i];
