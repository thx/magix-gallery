...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ctxwzvnk$art_c = list.length; itemIndex < $art_ctxwzvnk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ctxwzvnk$art_c = list.length; itemIndex < $art_ctxwzvnk$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_imruzoooh$art_i = 0, $art_objhzojzaixh$art_obj = item.subs, $art_cexrjuupaa$art_c = $art_objhzojzaixh$art_obj.length; $art_imruzoooh$art_i < $art_cexrjuupaa$art_c; $art_imruzoooh$art_i++) {        var sub = $art_objhzojzaixh$art_obj[$art_imruzoooh$art_i]%>';
        for (var $art_imruzoooh$art_i = 0, $art_objhzojzaixh$art_obj = item.subs, $art_cexrjuupaa$art_c = $art_objhzojzaixh$art_obj.length; $art_imruzoooh$art_i < $art_cexrjuupaa$art_c; $art_imruzoooh$art_i++) {
            var sub = $art_objhzojzaixh$art_obj[$art_imruzoooh$art_i];
