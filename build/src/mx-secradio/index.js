...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cahjwjik$art_c = list.length; itemIndex < $art_cahjwjik$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cahjwjik$art_c = list.length; itemIndex < $art_cahjwjik$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iawhuwbuph$art_i = 0, $art_objesvxgch$art_obj = item.subs, $art_celrjryfe$art_c = $art_objesvxgch$art_obj.length; $art_iawhuwbuph$art_i < $art_celrjryfe$art_c; $art_iawhuwbuph$art_i++) {        var sub = $art_objesvxgch$art_obj[$art_iawhuwbuph$art_i]%>';
        for (var $art_iawhuwbuph$art_i = 0, $art_objesvxgch$art_obj = item.subs, $art_celrjryfe$art_c = $art_objesvxgch$art_obj.length; $art_iawhuwbuph$art_i < $art_celrjryfe$art_c; $art_iawhuwbuph$art_i++) {
            var sub = $art_objesvxgch$art_obj[$art_iawhuwbuph$art_i];
