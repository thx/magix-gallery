...
module.exports = Magix.View.extend({
    ...
    if (needExpand) {
        ;
        $p += '<div mxa="_zs_gallerycV:_" class="_zs_gallery_mx-secradio_index_-line _zs_gallery_mx-secradio_index_-all" mx-click="' + $viewId + '@{toggleAll}()">';
        $line = 3;
        $art = 'if close';
        ;
        $expr = '<%if (close) {%>';
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_clgvnxweo$art_c = list.length; itemIndex < $art_clgvnxweo$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_clgvnxweo$art_c = list.length; itemIndex < $art_clgvnxweo$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ieoulvnvi$art_i = 0, $art_objkqhdaw$art_obj = item.subs, $art_cgksikqnxqds$art_c = $art_objkqhdaw$art_obj.length; $art_ieoulvnvi$art_i < $art_cgksikqnxqds$art_c; $art_ieoulvnvi$art_i++) {        var sub = $art_objkqhdaw$art_obj[$art_ieoulvnvi$art_i]%>';
        for (var $art_ieoulvnvi$art_i = 0, $art_objkqhdaw$art_obj = item.subs, $art_cgksikqnxqds$art_c = $art_objkqhdaw$art_obj.length; $art_ieoulvnvi$art_i < $art_cgksikqnxqds$art_c; $art_ieoulvnvi$art_i++) {
            var sub = $art_objkqhdaw$art_obj[$art_ieoulvnvi$art_i];
