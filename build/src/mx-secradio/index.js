...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cmrdfk$art_c = list.length; itemIndex < $art_cmrdfk$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cmrdfk$art_c = list.length; itemIndex < $art_cmrdfk$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_injdqlsra$art_i = 0, $art_objtmdrrm$art_obj = item.subs, $art_cdatjssr$art_c = $art_objtmdrrm$art_obj.length; $art_injdqlsra$art_i < $art_cdatjssr$art_c; $art_injdqlsra$art_i++) {        var sub = $art_objtmdrrm$art_obj[$art_injdqlsra$art_i]%>';
        for (var $art_injdqlsra$art_i = 0, $art_objtmdrrm$art_obj = item.subs, $art_cdatjssr$art_c = $art_objtmdrrm$art_obj.length; $art_injdqlsra$art_i < $art_cdatjssr$art_c; $art_injdqlsra$art_i++) {
            var sub = $art_objtmdrrm$art_obj[$art_injdqlsra$art_i];
