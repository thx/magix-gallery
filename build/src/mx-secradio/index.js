...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ctirfbo$art_c = list.length; itemIndex < $art_ctirfbo$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ctirfbo$art_c = list.length; itemIndex < $art_ctirfbo$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idyzaazc$art_i = 0, $art_objbzoelsei$art_obj = item.subs, $art_cgiyojaubg$art_c = $art_objbzoelsei$art_obj.length; $art_idyzaazc$art_i < $art_cgiyojaubg$art_c; $art_idyzaazc$art_i++) {        var sub = $art_objbzoelsei$art_obj[$art_idyzaazc$art_i]%>';
        for (var $art_idyzaazc$art_i = 0, $art_objbzoelsei$art_obj = item.subs, $art_cgiyojaubg$art_c = $art_objbzoelsei$art_obj.length; $art_idyzaazc$art_i < $art_cgiyojaubg$art_c; $art_idyzaazc$art_i++) {
            var sub = $art_objbzoelsei$art_obj[$art_idyzaazc$art_i];
