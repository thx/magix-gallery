...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_coilfbuy$art_c = list.length; itemIndex < $art_coilfbuy$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_coilfbuy$art_c = list.length; itemIndex < $art_coilfbuy$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ictbiiy$art_i = 0, $art_objhhptspmtia$art_obj = item.subs, $art_cjeaepnnzd$art_c = $art_objhhptspmtia$art_obj.length; $art_ictbiiy$art_i < $art_cjeaepnnzd$art_c; $art_ictbiiy$art_i++) {        var sub = $art_objhhptspmtia$art_obj[$art_ictbiiy$art_i]%>';
        for (var $art_ictbiiy$art_i = 0, $art_objhhptspmtia$art_obj = item.subs, $art_cjeaepnnzd$art_c = $art_objhhptspmtia$art_obj.length; $art_ictbiiy$art_i < $art_cjeaepnnzd$art_c; $art_ictbiiy$art_i++) {
            var sub = $art_objhhptspmtia$art_obj[$art_ictbiiy$art_i];
