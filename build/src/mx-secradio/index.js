...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_ccbxjfgwc$art_c = list.length; itemIndex < $art_ccbxjfgwc$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_ccbxjfgwc$art_c = list.length; itemIndex < $art_ccbxjfgwc$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivacwajzff$art_i = 0, $art_objmlcuqpksm$art_obj = item.subs, $art_cgovmklg$art_c = $art_objmlcuqpksm$art_obj.length; $art_ivacwajzff$art_i < $art_cgovmklg$art_c; $art_ivacwajzff$art_i++) {        var sub = $art_objmlcuqpksm$art_obj[$art_ivacwajzff$art_i]%>';
        for (var $art_ivacwajzff$art_i = 0, $art_objmlcuqpksm$art_obj = item.subs, $art_cgovmklg$art_c = $art_objmlcuqpksm$art_obj.length; $art_ivacwajzff$art_i < $art_cgovmklg$art_c; $art_ivacwajzff$art_i++) {
            var sub = $art_objmlcuqpksm$art_obj[$art_ivacwajzff$art_i];
