...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqrnvle$art_c = list.length; itemIndex < $art_cqrnvle$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqrnvle$art_c = list.length; itemIndex < $art_cqrnvle$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivdamjqyhr$art_i = 0, $art_objngbkkfelvr$art_obj = item.subs, $art_cvhblxzvdt$art_c = $art_objngbkkfelvr$art_obj.length; $art_ivdamjqyhr$art_i < $art_cvhblxzvdt$art_c; $art_ivdamjqyhr$art_i++) {        var sub = $art_objngbkkfelvr$art_obj[$art_ivdamjqyhr$art_i]%>';
        for (var $art_ivdamjqyhr$art_i = 0, $art_objngbkkfelvr$art_obj = item.subs, $art_cvhblxzvdt$art_c = $art_objngbkkfelvr$art_obj.length; $art_ivdamjqyhr$art_i < $art_cvhblxzvdt$art_c; $art_ivdamjqyhr$art_i++) {
            var sub = $art_objngbkkfelvr$art_obj[$art_ivdamjqyhr$art_i];
