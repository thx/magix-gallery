...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cqalugkb$art_c = list.length; itemIndex < $art_cqalugkb$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cqalugkb$art_c = list.length; itemIndex < $art_cqalugkb$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idssnytyn$art_i = 0, $art_objbmjeqydbq$art_obj = item.subs, $art_clnrvkpcaxhn$art_c = $art_objbmjeqydbq$art_obj.length; $art_idssnytyn$art_i < $art_clnrvkpcaxhn$art_c; $art_idssnytyn$art_i++) {        var sub = $art_objbmjeqydbq$art_obj[$art_idssnytyn$art_i]%>';
        for (var $art_idssnytyn$art_i = 0, $art_objbmjeqydbq$art_obj = item.subs, $art_clnrvkpcaxhn$art_c = $art_objbmjeqydbq$art_obj.length; $art_idssnytyn$art_i < $art_clnrvkpcaxhn$art_c; $art_idssnytyn$art_i++) {
            var sub = $art_objbmjeqydbq$art_obj[$art_idssnytyn$art_i];
