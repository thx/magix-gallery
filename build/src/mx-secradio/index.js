...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cchecvbjcrki$art_c = list.length; itemIndex < $art_cchecvbjcrki$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cchecvbjcrki$art_c = list.length; itemIndex < $art_cchecvbjcrki$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ipjfsdns$art_i = 0, $art_objnzftczgr$art_obj = item.subs, $art_ciwrp$art_c = $art_objnzftczgr$art_obj.length; $art_ipjfsdns$art_i < $art_ciwrp$art_c; $art_ipjfsdns$art_i++) {        var sub = $art_objnzftczgr$art_obj[$art_ipjfsdns$art_i]%>';
        for (var $art_ipjfsdns$art_i = 0, $art_objnzftczgr$art_obj = item.subs, $art_ciwrp$art_c = $art_objnzftczgr$art_obj.length; $art_ipjfsdns$art_i < $art_ciwrp$art_c; $art_ipjfsdns$art_i++) {
            var sub = $art_objnzftczgr$art_obj[$art_ipjfsdns$art_i];
