...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var itemIndex = 0, $art_cziogdkjd$art_c = list.length; itemIndex < $art_cziogdkjd$art_c; itemIndex++) {    var item = list[itemIndex]%>';
    for (var itemIndex = 0, $art_cziogdkjd$art_c = list.length; itemIndex < $art_cziogdkjd$art_c; itemIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibpybqbat$art_i = 0, $art_objzaaniwm$art_obj = item.subs, $art_cfeyxqwvr$art_c = $art_objzaaniwm$art_obj.length; $art_ibpybqbat$art_i < $art_cfeyxqwvr$art_c; $art_ibpybqbat$art_i++) {        var sub = $art_objzaaniwm$art_obj[$art_ibpybqbat$art_i]%>';
        for (var $art_ibpybqbat$art_i = 0, $art_objzaaniwm$art_obj = item.subs, $art_cfeyxqwvr$art_c = $art_objzaaniwm$art_obj.length; $art_ibpybqbat$art_i < $art_cfeyxqwvr$art_c; $art_ibpybqbat$art_i++) {
            var sub = $art_objzaaniwm$art_obj[$art_ibpybqbat$art_i];
