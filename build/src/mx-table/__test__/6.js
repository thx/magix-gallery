    ...
    if (list.length > 0) {
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var subIndex=0,$art_objjinyb$art_obj=item.subs;subIndex<$art_objjinyb$art_obj.length;subIndex++){var sub=$art_objjinyb$art_obj[subIndex]%>';
                for (var subIndex = 0, $art_objjinyb$art_obj = item.subs; subIndex < $art_objjinyb$art_obj.length; subIndex++) {
                    var sub = $art_objjinyb$art_obj[subIndex];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_inzlvayjzzc$art_i=0;$art_inzlvayjzzc$art_i<groups.length;$art_inzlvayjzzc$art_i++){var group=groups[$art_inzlvayjzzc$art_i]%>';
        for (var $art_inzlvayjzzc$art_i = 0; $art_inzlvayjzzc$art_i < groups.length; $art_inzlvayjzzc$art_i++) {
            var group = groups[$art_inzlvayjzzc$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_iqcpxipl$art_i=0;$art_iqcpxipl$art_i<groups.length;$art_iqcpxipl$art_i++){var group=groups[$art_iqcpxipl$art_i]%>';
        for (var $art_iqcpxipl$art_i = 0; $art_iqcpxipl$art_i < groups.length; $art_iqcpxipl$art_i++) {
            var group = groups[$art_iqcpxipl$art_i];
            $p += ' ';
            $line = 82;
            $art = 'each group.fields as field';
            ;
            $p += '';
            $expr = '<%for(var $art_igsetlmwl$art_i=0,$art_objyjvgux$art_obj=group.fields;$art_igsetlmwl$art_i<$art_objyjvgux$art_obj.length;$art_igsetlmwl$art_i++){var field=$art_objyjvgux$art_obj[$art_igsetlmwl$art_i]%>';
            for (var $art_igsetlmwl$art_i = 0, $art_objyjvgux$art_obj = group.fields; $art_igsetlmwl$art_i < $art_objyjvgux$art_obj.length; $art_igsetlmwl$art_i++) {
                var field = $art_objyjvgux$art_obj[$art_igsetlmwl$art_i];
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_ioppfwbji$art_i=0;$art_ioppfwbji$art_i<groups.length;$art_ioppfwbji$art_i++){var group=groups[$art_ioppfwbji$art_i]%>';
            for (var $art_ioppfwbji$art_i = 0; $art_ioppfwbji$art_i < groups.length; $art_ioppfwbji$art_i++) {
                var group = groups[$art_ioppfwbji$art_i];
                $p += ' ';
                $line = 92;
                $art = 'each group.fields as field';
                ;
                $p += '';
                $expr = '<%for(var $art_ioqpqji$art_i=0,$art_objimjcnpzfn$art_obj=group.fields;$art_ioqpqji$art_i<$art_objimjcnpzfn$art_obj.length;$art_ioqpqji$art_i++){var field=$art_objimjcnpzfn$art_obj[$art_ioqpqji$art_i]%>';
                for (var $art_ioqpqji$art_i = 0, $art_objimjcnpzfn$art_obj = group.fields; $art_ioqpqji$art_i < $art_objimjcnpzfn$art_obj.length; $art_ioqpqji$art_i++) {
                    var field = $art_objimjcnpzfn$art_obj[$art_ioqpqji$art_i];
                    $p += '<td>';
                    $line = 93;
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_iwuvnmnfkeh$art_i=0;$art_iwuvnmnfkeh$art_i<groups.length;$art_iwuvnmnfkeh$art_i++){var group=groups[$art_iwuvnmnfkeh$art_i]%>';
                for (var $art_iwuvnmnfkeh$art_i = 0; $art_iwuvnmnfkeh$art_i < groups.length; $art_iwuvnmnfkeh$art_i++) {
                    var group = groups[$art_iwuvnmnfkeh$art_i];
                    $p += ' ';
                    $line = 104;
                    $art = 'each group.fields as field';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_ihhriwkasx$art_i=0,$art_objwgsfmhak$art_obj=group.fields;$art_ihhriwkasx$art_i<$art_objwgsfmhak$art_obj.length;$art_ihhriwkasx$art_i++){var field=$art_objwgsfmhak$art_obj[$art_ihhriwkasx$art_i]%>';
                    for (var $art_ihhriwkasx$art_i = 0, $art_objwgsfmhak$art_obj = group.fields; $art_ihhriwkasx$art_i < $art_objwgsfmhak$art_obj.length; $art_ihhriwkasx$art_i++) {
                        var field = $art_objwgsfmhak$art_obj[$art_ihhriwkasx$art_i];
                        $p += '<td>子表头滚动';
                        $line = 105;
                        $art = '=field';
                        ;
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_iafknkoup$art_i=0,$art_objgottesk$art_obj=item.subs;$art_iafknkoup$art_i<$art_objgottesk$art_obj.length;$art_iafknkoup$art_i++){var sub=$art_objgottesk$art_obj[$art_iafknkoup$art_i]%>';
                for (var $art_iafknkoup$art_i = 0, $art_objgottesk$art_obj = item.subs; $art_iafknkoup$art_i < $art_objgottesk$art_obj.length; $art_iafknkoup$art_i++) {
                    var sub = $art_objgottesk$art_obj[$art_iafknkoup$art_i];
                    $p += '<tr>';
                    $line = 111;
                    $art = 'each groups as group';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_iukgsgviec$art_i=0;$art_iukgsgviec$art_i<groups.length;$art_iukgsgviec$art_i++){var group=groups[$art_iukgsgviec$art_i]%>';
                    for (var $art_iukgsgviec$art_i = 0; $art_iukgsgviec$art_i < groups.length; $art_iukgsgviec$art_i++) {
                        var group = groups[$art_iukgsgviec$art_i];
                        $p += ' ';
                        $line = 112;
                        $art = 'each group.fields as field';
                        ;
                        $p += '';
                        $expr = '<%for(var $art_ieqmhgantd$art_i=0,$art_objnmzxrm$art_obj=group.fields;$art_ieqmhgantd$art_i<$art_objnmzxrm$art_obj.length;$art_ieqmhgantd$art_i++){var field=$art_objnmzxrm$art_obj[$art_ieqmhgantd$art_i]%>';
                        for (var $art_ieqmhgantd$art_i = 0, $art_objnmzxrm$art_obj = group.fields; $art_ieqmhgantd$art_i < $art_objnmzxrm$art_obj.length; $art_ieqmhgantd$art_i++) {
                            var field = $art_objnmzxrm$art_obj[$art_ieqmhgantd$art_i];
                            $p += '<td>';
                            $line = 113;
