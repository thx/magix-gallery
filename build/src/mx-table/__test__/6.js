    ...
    if (list.length > 0) {
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var subIndex=0,$art_objufhwrzjrql$art_obj=item.subs;subIndex<$art_objufhwrzjrql$art_obj.length;subIndex++){var sub=$art_objufhwrzjrql$art_obj[subIndex]%>';
                for (var subIndex = 0, $art_objufhwrzjrql$art_obj = item.subs; subIndex < $art_objufhwrzjrql$art_obj.length; subIndex++) {
                    var sub = $art_objufhwrzjrql$art_obj[subIndex];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_igwidiu$art_i=0;$art_igwidiu$art_i<groups.length;$art_igwidiu$art_i++){var group=groups[$art_igwidiu$art_i]%>';
        for (var $art_igwidiu$art_i = 0; $art_igwidiu$art_i < groups.length; $art_igwidiu$art_i++) {
            var group = groups[$art_igwidiu$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ihtjduap$art_i=0;$art_ihtjduap$art_i<groups.length;$art_ihtjduap$art_i++){var group=groups[$art_ihtjduap$art_i]%>';
        for (var $art_ihtjduap$art_i = 0; $art_ihtjduap$art_i < groups.length; $art_ihtjduap$art_i++) {
            var group = groups[$art_ihtjduap$art_i];
            $p += ' ';
            $line = 82;
            $art = 'each group.fields as field';
            ;
            $p += '';
            $expr = '<%for(var $art_ilpfohbv$art_i=0,$art_objklgywos$art_obj=group.fields;$art_ilpfohbv$art_i<$art_objklgywos$art_obj.length;$art_ilpfohbv$art_i++){var field=$art_objklgywos$art_obj[$art_ilpfohbv$art_i]%>';
            for (var $art_ilpfohbv$art_i = 0, $art_objklgywos$art_obj = group.fields; $art_ilpfohbv$art_i < $art_objklgywos$art_obj.length; $art_ilpfohbv$art_i++) {
                var field = $art_objklgywos$art_obj[$art_ilpfohbv$art_i];
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_idtvqfltyr$art_i=0;$art_idtvqfltyr$art_i<groups.length;$art_idtvqfltyr$art_i++){var group=groups[$art_idtvqfltyr$art_i]%>';
            for (var $art_idtvqfltyr$art_i = 0; $art_idtvqfltyr$art_i < groups.length; $art_idtvqfltyr$art_i++) {
                var group = groups[$art_idtvqfltyr$art_i];
                $p += ' ';
                $line = 92;
                $art = 'each group.fields as field';
                ;
                $p += '';
                $expr = '<%for(var $art_ipsfuhqo$art_i=0,$art_objxjrrmyu$art_obj=group.fields;$art_ipsfuhqo$art_i<$art_objxjrrmyu$art_obj.length;$art_ipsfuhqo$art_i++){var field=$art_objxjrrmyu$art_obj[$art_ipsfuhqo$art_i]%>';
                for (var $art_ipsfuhqo$art_i = 0, $art_objxjrrmyu$art_obj = group.fields; $art_ipsfuhqo$art_i < $art_objxjrrmyu$art_obj.length; $art_ipsfuhqo$art_i++) {
                    var field = $art_objxjrrmyu$art_obj[$art_ipsfuhqo$art_i];
                    $p += '<td>';
                    $line = 93;
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_iejrvmbja$art_i=0;$art_iejrvmbja$art_i<groups.length;$art_iejrvmbja$art_i++){var group=groups[$art_iejrvmbja$art_i]%>';
                for (var $art_iejrvmbja$art_i = 0; $art_iejrvmbja$art_i < groups.length; $art_iejrvmbja$art_i++) {
                    var group = groups[$art_iejrvmbja$art_i];
                    $p += ' ';
                    $line = 104;
                    $art = 'each group.fields as field';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_iuwddidslkb$art_i=0,$art_objcakndnxsl$art_obj=group.fields;$art_iuwddidslkb$art_i<$art_objcakndnxsl$art_obj.length;$art_iuwddidslkb$art_i++){var field=$art_objcakndnxsl$art_obj[$art_iuwddidslkb$art_i]%>';
                    for (var $art_iuwddidslkb$art_i = 0, $art_objcakndnxsl$art_obj = group.fields; $art_iuwddidslkb$art_i < $art_objcakndnxsl$art_obj.length; $art_iuwddidslkb$art_i++) {
                        var field = $art_objcakndnxsl$art_obj[$art_iuwddidslkb$art_i];
                        $p += '<td>子表头滚动';
                        $line = 105;
                        $art = '=field';
                        ;
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_iksrzvqwek$art_i=0,$art_objzolozejw$art_obj=item.subs;$art_iksrzvqwek$art_i<$art_objzolozejw$art_obj.length;$art_iksrzvqwek$art_i++){var sub=$art_objzolozejw$art_obj[$art_iksrzvqwek$art_i]%>';
                for (var $art_iksrzvqwek$art_i = 0, $art_objzolozejw$art_obj = item.subs; $art_iksrzvqwek$art_i < $art_objzolozejw$art_obj.length; $art_iksrzvqwek$art_i++) {
                    var sub = $art_objzolozejw$art_obj[$art_iksrzvqwek$art_i];
                    $p += '<tr>';
                    $line = 111;
                    $art = 'each groups as group';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_irtznlfxj$art_i=0;$art_irtznlfxj$art_i<groups.length;$art_irtznlfxj$art_i++){var group=groups[$art_irtznlfxj$art_i]%>';
                    for (var $art_irtznlfxj$art_i = 0; $art_irtznlfxj$art_i < groups.length; $art_irtznlfxj$art_i++) {
                        var group = groups[$art_irtznlfxj$art_i];
                        $p += ' ';
                        $line = 112;
                        $art = 'each group.fields as field';
                        ;
                        $p += '';
                        $expr = '<%for(var $art_irdyrtgr$art_i=0,$art_objbnrxtumpu$art_obj=group.fields;$art_irdyrtgr$art_i<$art_objbnrxtumpu$art_obj.length;$art_irdyrtgr$art_i++){var field=$art_objbnrxtumpu$art_obj[$art_irdyrtgr$art_i]%>';
                        for (var $art_irdyrtgr$art_i = 0, $art_objbnrxtumpu$art_obj = group.fields; $art_irdyrtgr$art_i < $art_objbnrxtumpu$art_obj.length; $art_irdyrtgr$art_i++) {
                            var field = $art_objbnrxtumpu$art_obj[$art_irdyrtgr$art_i];
                            $p += '<td>';
                            $line = 113;
