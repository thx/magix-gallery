    ...
    if (list.length > 0) {
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var subIndex=0,$art_objbzaxfdzabl$art_obj=item.subs;subIndex<$art_objbzaxfdzabl$art_obj.length;subIndex++){var sub=$art_objbzaxfdzabl$art_obj[subIndex]%>';
                for (var subIndex = 0, $art_objbzaxfdzabl$art_obj = item.subs; subIndex < $art_objbzaxfdzabl$art_obj.length; subIndex++) {
                    var sub = $art_objbzaxfdzabl$art_obj[subIndex];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ingxvaf$art_i=0;$art_ingxvaf$art_i<groups.length;$art_ingxvaf$art_i++){var group=groups[$art_ingxvaf$art_i]%>';
        for (var $art_ingxvaf$art_i = 0; $art_ingxvaf$art_i < groups.length; $art_ingxvaf$art_i++) {
            var group = groups[$art_ingxvaf$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_irirnqtquq$art_i=0;$art_irirnqtquq$art_i<groups.length;$art_irirnqtquq$art_i++){var group=groups[$art_irirnqtquq$art_i]%>';
        for (var $art_irirnqtquq$art_i = 0; $art_irirnqtquq$art_i < groups.length; $art_irirnqtquq$art_i++) {
            var group = groups[$art_irirnqtquq$art_i];
            $p += ' ';
            $line = 82;
            $art = 'each group.fields as field';
            ;
            $p += '';
            $expr = '<%for(var $art_iapnkst$art_i=0,$art_objawqrpx$art_obj=group.fields;$art_iapnkst$art_i<$art_objawqrpx$art_obj.length;$art_iapnkst$art_i++){var field=$art_objawqrpx$art_obj[$art_iapnkst$art_i]%>';
            for (var $art_iapnkst$art_i = 0, $art_objawqrpx$art_obj = group.fields; $art_iapnkst$art_i < $art_objawqrpx$art_obj.length; $art_iapnkst$art_i++) {
                var field = $art_objawqrpx$art_obj[$art_iapnkst$art_i];
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_iutbgckjbs$art_i=0;$art_iutbgckjbs$art_i<groups.length;$art_iutbgckjbs$art_i++){var group=groups[$art_iutbgckjbs$art_i]%>';
            for (var $art_iutbgckjbs$art_i = 0; $art_iutbgckjbs$art_i < groups.length; $art_iutbgckjbs$art_i++) {
                var group = groups[$art_iutbgckjbs$art_i];
                $p += ' ';
                $line = 92;
                $art = 'each group.fields as field';
                ;
                $p += '';
                $expr = '<%for(var $art_igkyae$art_i=0,$art_objzwlpsgj$art_obj=group.fields;$art_igkyae$art_i<$art_objzwlpsgj$art_obj.length;$art_igkyae$art_i++){var field=$art_objzwlpsgj$art_obj[$art_igkyae$art_i]%>';
                for (var $art_igkyae$art_i = 0, $art_objzwlpsgj$art_obj = group.fields; $art_igkyae$art_i < $art_objzwlpsgj$art_obj.length; $art_igkyae$art_i++) {
                    var field = $art_objzwlpsgj$art_obj[$art_igkyae$art_i];
                    $p += '<td>';
                    $line = 93;
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_ibcgqe$art_i=0;$art_ibcgqe$art_i<groups.length;$art_ibcgqe$art_i++){var group=groups[$art_ibcgqe$art_i]%>';
                for (var $art_ibcgqe$art_i = 0; $art_ibcgqe$art_i < groups.length; $art_ibcgqe$art_i++) {
                    var group = groups[$art_ibcgqe$art_i];
                    $p += ' ';
                    $line = 104;
                    $art = 'each group.fields as field';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_iiazcfzql$art_i=0,$art_objuxekrrvjxqc$art_obj=group.fields;$art_iiazcfzql$art_i<$art_objuxekrrvjxqc$art_obj.length;$art_iiazcfzql$art_i++){var field=$art_objuxekrrvjxqc$art_obj[$art_iiazcfzql$art_i]%>';
                    for (var $art_iiazcfzql$art_i = 0, $art_objuxekrrvjxqc$art_obj = group.fields; $art_iiazcfzql$art_i < $art_objuxekrrvjxqc$art_obj.length; $art_iiazcfzql$art_i++) {
                        var field = $art_objuxekrrvjxqc$art_obj[$art_iiazcfzql$art_i];
                        $p += '<td>子表头滚动';
                        $line = 105;
                        $art = '=field';
                        ;
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_ioiulzq$art_i=0,$art_objlxzmyxvf$art_obj=item.subs;$art_ioiulzq$art_i<$art_objlxzmyxvf$art_obj.length;$art_ioiulzq$art_i++){var sub=$art_objlxzmyxvf$art_obj[$art_ioiulzq$art_i]%>';
                for (var $art_ioiulzq$art_i = 0, $art_objlxzmyxvf$art_obj = item.subs; $art_ioiulzq$art_i < $art_objlxzmyxvf$art_obj.length; $art_ioiulzq$art_i++) {
                    var sub = $art_objlxzmyxvf$art_obj[$art_ioiulzq$art_i];
                    $p += '<tr>';
                    $line = 111;
                    $art = 'each groups as group';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_isjovftxh$art_i=0;$art_isjovftxh$art_i<groups.length;$art_isjovftxh$art_i++){var group=groups[$art_isjovftxh$art_i]%>';
                    for (var $art_isjovftxh$art_i = 0; $art_isjovftxh$art_i < groups.length; $art_isjovftxh$art_i++) {
                        var group = groups[$art_isjovftxh$art_i];
                        $p += ' ';
                        $line = 112;
                        $art = 'each group.fields as field';
                        ;
                        $p += '';
                        $expr = '<%for(var $art_irljxhljesd$art_i=0,$art_objgsqdunecch$art_obj=group.fields;$art_irljxhljesd$art_i<$art_objgsqdunecch$art_obj.length;$art_irljxhljesd$art_i++){var field=$art_objgsqdunecch$art_obj[$art_irljxhljesd$art_i]%>';
                        for (var $art_irljxhljesd$art_i = 0, $art_objgsqdunecch$art_obj = group.fields; $art_irljxhljesd$art_i < $art_objgsqdunecch$art_obj.length; $art_irljxhljesd$art_i++) {
                            var field = $art_objgsqdunecch$art_obj[$art_irljxhljesd$art_i];
                            $p += '<td>';
                            $line = 113;
