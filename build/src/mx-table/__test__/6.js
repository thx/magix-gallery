    ...
    if (list.length > 0) {
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var subIndex=0,$art_objfnhavbyq$art_obj=item.subs;subIndex<$art_objfnhavbyq$art_obj.length;subIndex++){var sub=$art_objfnhavbyq$art_obj[subIndex]%>';
                for (var subIndex = 0, $art_objfnhavbyq$art_obj = item.subs; subIndex < $art_objfnhavbyq$art_obj.length; subIndex++) {
                    var sub = $art_objfnhavbyq$art_obj[subIndex];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ittgqslxxujn$art_i=0;$art_ittgqslxxujn$art_i<groups.length;$art_ittgqslxxujn$art_i++){var group=groups[$art_ittgqslxxujn$art_i]%>';
        for (var $art_ittgqslxxujn$art_i = 0; $art_ittgqslxxujn$art_i < groups.length; $art_ittgqslxxujn$art_i++) {
            var group = groups[$art_ittgqslxxujn$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_izxngoppjp$art_i=0;$art_izxngoppjp$art_i<groups.length;$art_izxngoppjp$art_i++){var group=groups[$art_izxngoppjp$art_i]%>';
        for (var $art_izxngoppjp$art_i = 0; $art_izxngoppjp$art_i < groups.length; $art_izxngoppjp$art_i++) {
            var group = groups[$art_izxngoppjp$art_i];
            $p += ' ';
            $line = 82;
            $art = 'each group.fields as field';
            ;
            $p += '';
            $expr = '<%for(var $art_idepxcoheq$art_i=0,$art_objarcnxl$art_obj=group.fields;$art_idepxcoheq$art_i<$art_objarcnxl$art_obj.length;$art_idepxcoheq$art_i++){var field=$art_objarcnxl$art_obj[$art_idepxcoheq$art_i]%>';
            for (var $art_idepxcoheq$art_i = 0, $art_objarcnxl$art_obj = group.fields; $art_idepxcoheq$art_i < $art_objarcnxl$art_obj.length; $art_idepxcoheq$art_i++) {
                var field = $art_objarcnxl$art_obj[$art_idepxcoheq$art_i];
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_ijibhqj$art_i=0;$art_ijibhqj$art_i<groups.length;$art_ijibhqj$art_i++){var group=groups[$art_ijibhqj$art_i]%>';
            for (var $art_ijibhqj$art_i = 0; $art_ijibhqj$art_i < groups.length; $art_ijibhqj$art_i++) {
                var group = groups[$art_ijibhqj$art_i];
                $p += ' ';
                $line = 92;
                $art = 'each group.fields as field';
                ;
                $p += '';
                $expr = '<%for(var $art_iglxymwt$art_i=0,$art_objunxdnbu$art_obj=group.fields;$art_iglxymwt$art_i<$art_objunxdnbu$art_obj.length;$art_iglxymwt$art_i++){var field=$art_objunxdnbu$art_obj[$art_iglxymwt$art_i]%>';
                for (var $art_iglxymwt$art_i = 0, $art_objunxdnbu$art_obj = group.fields; $art_iglxymwt$art_i < $art_objunxdnbu$art_obj.length; $art_iglxymwt$art_i++) {
                    var field = $art_objunxdnbu$art_obj[$art_iglxymwt$art_i];
                    $p += '<td>';
                    $line = 93;
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_invrxapxjgo$art_i=0;$art_invrxapxjgo$art_i<groups.length;$art_invrxapxjgo$art_i++){var group=groups[$art_invrxapxjgo$art_i]%>';
                for (var $art_invrxapxjgo$art_i = 0; $art_invrxapxjgo$art_i < groups.length; $art_invrxapxjgo$art_i++) {
                    var group = groups[$art_invrxapxjgo$art_i];
                    $p += ' ';
                    $line = 104;
                    $art = 'each group.fields as field';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_ipptzqoz$art_i=0,$art_objjfxqcti$art_obj=group.fields;$art_ipptzqoz$art_i<$art_objjfxqcti$art_obj.length;$art_ipptzqoz$art_i++){var field=$art_objjfxqcti$art_obj[$art_ipptzqoz$art_i]%>';
                    for (var $art_ipptzqoz$art_i = 0, $art_objjfxqcti$art_obj = group.fields; $art_ipptzqoz$art_i < $art_objjfxqcti$art_obj.length; $art_ipptzqoz$art_i++) {
                        var field = $art_objjfxqcti$art_obj[$art_ipptzqoz$art_i];
                        $p += '<td>子表头滚动';
                        $line = 105;
                        $art = '=field';
                        ;
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_ijerrdjcon$art_i=0,$art_objihsvtutowt$art_obj=item.subs;$art_ijerrdjcon$art_i<$art_objihsvtutowt$art_obj.length;$art_ijerrdjcon$art_i++){var sub=$art_objihsvtutowt$art_obj[$art_ijerrdjcon$art_i]%>';
                for (var $art_ijerrdjcon$art_i = 0, $art_objihsvtutowt$art_obj = item.subs; $art_ijerrdjcon$art_i < $art_objihsvtutowt$art_obj.length; $art_ijerrdjcon$art_i++) {
                    var sub = $art_objihsvtutowt$art_obj[$art_ijerrdjcon$art_i];
                    $p += '<tr>';
                    $line = 111;
                    $art = 'each groups as group';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_iskeahzlh$art_i=0;$art_iskeahzlh$art_i<groups.length;$art_iskeahzlh$art_i++){var group=groups[$art_iskeahzlh$art_i]%>';
                    for (var $art_iskeahzlh$art_i = 0; $art_iskeahzlh$art_i < groups.length; $art_iskeahzlh$art_i++) {
                        var group = groups[$art_iskeahzlh$art_i];
                        $p += ' ';
                        $line = 112;
                        $art = 'each group.fields as field';
                        ;
                        $p += '';
                        $expr = '<%for(var $art_isvcpyfdpo$art_i=0,$art_objvtfojwt$art_obj=group.fields;$art_isvcpyfdpo$art_i<$art_objvtfojwt$art_obj.length;$art_isvcpyfdpo$art_i++){var field=$art_objvtfojwt$art_obj[$art_isvcpyfdpo$art_i]%>';
                        for (var $art_isvcpyfdpo$art_i = 0, $art_objvtfojwt$art_obj = group.fields; $art_isvcpyfdpo$art_i < $art_objvtfojwt$art_obj.length; $art_isvcpyfdpo$art_i++) {
                            var field = $art_objvtfojwt$art_obj[$art_isvcpyfdpo$art_i];
                            $p += '<td>';
                            $line = 113;
