    ...
    if (list.length > 0) {
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var subIndex=0,$art_objzgenwnufl$art_obj=item.subs;subIndex<$art_objzgenwnufl$art_obj.length;subIndex++){var sub=$art_objzgenwnufl$art_obj[subIndex]%>';
                for (var subIndex = 0, $art_objzgenwnufl$art_obj = item.subs; subIndex < $art_objzgenwnufl$art_obj.length; subIndex++) {
                    var sub = $art_objzgenwnufl$art_obj[subIndex];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ihoaulnsq$art_i=0;$art_ihoaulnsq$art_i<groups.length;$art_ihoaulnsq$art_i++){var group=groups[$art_ihoaulnsq$art_i]%>';
        for (var $art_ihoaulnsq$art_i = 0; $art_ihoaulnsq$art_i < groups.length; $art_ihoaulnsq$art_i++) {
            var group = groups[$art_ihoaulnsq$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for(var $art_ivjenk$art_i=0;$art_ivjenk$art_i<groups.length;$art_ivjenk$art_i++){var group=groups[$art_ivjenk$art_i]%>';
        for (var $art_ivjenk$art_i = 0; $art_ivjenk$art_i < groups.length; $art_ivjenk$art_i++) {
            var group = groups[$art_ivjenk$art_i];
            $p += ' ';
            $line = 82;
            $art = 'each group.fields as field';
            ;
            $p += '';
            $expr = '<%for(var $art_ikwcinvt$art_i=0,$art_objfpndwxrg$art_obj=group.fields;$art_ikwcinvt$art_i<$art_objfpndwxrg$art_obj.length;$art_ikwcinvt$art_i++){var field=$art_objfpndwxrg$art_obj[$art_ikwcinvt$art_i]%>';
            for (var $art_ikwcinvt$art_i = 0, $art_objfpndwxrg$art_obj = group.fields; $art_ikwcinvt$art_i < $art_objfpndwxrg$art_obj.length; $art_ikwcinvt$art_i++) {
                var field = $art_objfpndwxrg$art_obj[$art_ikwcinvt$art_i];
        ...
        for (var index = 0; index < list.length; index++) {
            ...
            ;
            $p += '';
            $expr = '<%for(var $art_iwrfaqry$art_i=0;$art_iwrfaqry$art_i<groups.length;$art_iwrfaqry$art_i++){var group=groups[$art_iwrfaqry$art_i]%>';
            for (var $art_iwrfaqry$art_i = 0; $art_iwrfaqry$art_i < groups.length; $art_iwrfaqry$art_i++) {
                var group = groups[$art_iwrfaqry$art_i];
                $p += ' ';
                $line = 92;
                $art = 'each group.fields as field';
                ;
                $p += '';
                $expr = '<%for(var $art_iuobcxoxkg$art_i=0,$art_objdvfhuag$art_obj=group.fields;$art_iuobcxoxkg$art_i<$art_objdvfhuag$art_obj.length;$art_iuobcxoxkg$art_i++){var field=$art_objdvfhuag$art_obj[$art_iuobcxoxkg$art_i]%>';
                for (var $art_iuobcxoxkg$art_i = 0, $art_objdvfhuag$art_obj = group.fields; $art_iuobcxoxkg$art_i < $art_objdvfhuag$art_obj.length; $art_iuobcxoxkg$art_i++) {
                    var field = $art_objdvfhuag$art_obj[$art_iuobcxoxkg$art_i];
                    $p += '<td>';
                    $line = 93;
            ...
            if (item.expand) {
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_ikrkleixwn$art_i=0;$art_ikrkleixwn$art_i<groups.length;$art_ikrkleixwn$art_i++){var group=groups[$art_ikrkleixwn$art_i]%>';
                for (var $art_ikrkleixwn$art_i = 0; $art_ikrkleixwn$art_i < groups.length; $art_ikrkleixwn$art_i++) {
                    var group = groups[$art_ikrkleixwn$art_i];
                    $p += ' ';
                    $line = 104;
                    $art = 'each group.fields as field';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_ibrvwsn$art_i=0,$art_objaqbyxnrv$art_obj=group.fields;$art_ibrvwsn$art_i<$art_objaqbyxnrv$art_obj.length;$art_ibrvwsn$art_i++){var field=$art_objaqbyxnrv$art_obj[$art_ibrvwsn$art_i]%>';
                    for (var $art_ibrvwsn$art_i = 0, $art_objaqbyxnrv$art_obj = group.fields; $art_ibrvwsn$art_i < $art_objaqbyxnrv$art_obj.length; $art_ibrvwsn$art_i++) {
                        var field = $art_objaqbyxnrv$art_obj[$art_ibrvwsn$art_i];
                        $p += '<td>子表头滚动';
                        $line = 105;
                        $art = '=field';
                        ;
                ...
                ;
                $p += '';
                $expr = '<%for(var $art_iojjpdwxyt$art_i=0,$art_objtqjddqkw$art_obj=item.subs;$art_iojjpdwxyt$art_i<$art_objtqjddqkw$art_obj.length;$art_iojjpdwxyt$art_i++){var sub=$art_objtqjddqkw$art_obj[$art_iojjpdwxyt$art_i]%>';
                for (var $art_iojjpdwxyt$art_i = 0, $art_objtqjddqkw$art_obj = item.subs; $art_iojjpdwxyt$art_i < $art_objtqjddqkw$art_obj.length; $art_iojjpdwxyt$art_i++) {
                    var sub = $art_objtqjddqkw$art_obj[$art_iojjpdwxyt$art_i];
                    $p += '<tr>';
                    $line = 111;
                    $art = 'each groups as group';
                    ;
                    $p += '';
                    $expr = '<%for(var $art_iducp$art_i=0;$art_iducp$art_i<groups.length;$art_iducp$art_i++){var group=groups[$art_iducp$art_i]%>';
                    for (var $art_iducp$art_i = 0; $art_iducp$art_i < groups.length; $art_iducp$art_i++) {
                        var group = groups[$art_iducp$art_i];
                        $p += ' ';
                        $line = 112;
                        $art = 'each group.fields as field';
                        ;
                        $p += '';
                        $expr = '<%for(var $art_ijzsjnezr$art_i=0,$art_objeyrbttbqqgi$art_obj=group.fields;$art_ijzsjnezr$art_i<$art_objeyrbttbqqgi$art_obj.length;$art_ijzsjnezr$art_i++){var field=$art_objeyrbttbqqgi$art_obj[$art_ijzsjnezr$art_i]%>';
                        for (var $art_ijzsjnezr$art_i = 0, $art_objeyrbttbqqgi$art_obj = group.fields; $art_ijzsjnezr$art_i < $art_objeyrbttbqqgi$art_obj.length; $art_ijzsjnezr$art_i++) {
                            var field = $art_objeyrbttbqqgi$art_obj[$art_ijzsjnezr$art_i];
                            $p += '<td>';
                            $line = 113;
