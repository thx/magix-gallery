...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydP:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydP:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydP:_" class="mb20"><div class="mb5">1. 默认使用 “指标field1” + “升序” 进行排序：sort-field（当前排序字段）；sort-orderby（当前排序方式）</div><div class="mb5 pl15"><pre class="tip-content">\n&lt;th class="field-item"&gt;\n    指标&#123;&#123;=field&#125;&#125;\n    &lt;span sort-trigger="&#123;&#123;=field&#125;&#125;"\n        sort-field="&#123;&#123;=sortField&#125;&#125;"\n        sort-orderby="&#123;&#123;=sortBy&#125;&#125;"&gt;&lt;/span&gt;\n&lt;/th&gt;\n                </pre></div><div class="mb5">2. 自定义路由参数：当前页面有两个表格，都需要排序，如果都用默认的路由参数（orderField 和 orderBy）会存在冲突，需要自定义路由参数</div><div class="mb5 pl15"><pre class="tip-content mb5">\n&lt;th class="field-item"&gt;\n指标&#123;&#123;=field&#125;&#125;\n&lt;span sort-trigger="&#123;&#123;=field&#125;&#125;"\n    order-field-key="&#123;&#123;=orderFieldKey&#125;&#125;"\n    order-by-key="&#123;&#123;=orderByKey&#125;&#125;"&gt;&lt;/span&gt;\n&lt;/th&gt;\n                </pre><div class="mb5">最终路由上显示为：</div><pre class="tip-content">\n{\n    [order-field-key]: sort-trigger,\n    [order-by-key]: desc or asc\n}\n                </pre></div></div><div mxa="_zs_gallerydP:b" mx-view="mx-table/index?sticky=true" class="mb40"><div><table mxa="_zs_gallerydP:c" class="table" left="true" width="400"><thead mxs="_zs_gallerydP:a"><tr><th>固定1</th><th>固定2</th><th>固定3</th></tr></thead><tbody>';
    $line = 45;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cxqbhzmi$art_c = list.length; index < $art_cxqbhzmi$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cxqbhzmi$art_c = list.length; index < $art_cxqbhzmi$art_c; index++) {
        var item = list[index];
        $p += '<tr><td>';
        $line = 47;
        $art = '=item.fixed1';
    ...
    ;
    $expr = '<%for (var $art_ifjsfkrht$art_i = 0, $art_cssjafsnlh$art_c = groups.length; $art_ifjsfkrht$art_i < $art_cssjafsnlh$art_c; $art_ifjsfkrht$art_i++) {    var group = groups[$art_ifjsfkrht$art_i]%>';
    for (var $art_ifjsfkrht$art_i = 0, $art_cssjafsnlh$art_c = groups.length; $art_ifjsfkrht$art_i < $art_cssjafsnlh$art_c; $art_ifjsfkrht$art_i++) {
        var group = groups[$art_ifjsfkrht$art_i];
    ...
    $art = 'each groups as group';
    ;
    $expr = '<%for (var $art_inycevlesghb$art_i = 0, $art_cpbnihuttlo$art_c = groups.length; $art_inycevlesghb$art_i < $art_cpbnihuttlo$art_c; $art_inycevlesghb$art_i++) {    var group = groups[$art_inycevlesghb$art_i]%>';
    for (var $art_inycevlesghb$art_i = 0, $art_cpbnihuttlo$art_c = groups.length; $art_inycevlesghb$art_i < $art_cpbnihuttlo$art_c; $art_inycevlesghb$art_i++) {
        var group = groups[$art_inycevlesghb$art_i];
        $p += ' ';
        $line = 66;
        $art = 'each group.fields as field';
        ;
        $expr = '<%for (var $art_iciuzghaak$art_i = 0, $art_objnfdwjbdi$art_obj = group.fields, $art_clqvcdskn$art_c = $art_objnfdwjbdi$art_obj.length; $art_iciuzghaak$art_i < $art_clqvcdskn$art_c; $art_iciuzghaak$art_i++) {        var field = $art_objnfdwjbdi$art_obj[$art_iciuzghaak$art_i]%>';
        for (var $art_iciuzghaak$art_i = 0, $art_objnfdwjbdi$art_obj = group.fields, $art_clqvcdskn$art_c = $art_objnfdwjbdi$art_obj.length; $art_iciuzghaak$art_i < $art_clqvcdskn$art_c; $art_iciuzghaak$art_i++) {
            var field = $art_objnfdwjbdi$art_obj[$art_iciuzghaak$art_i];
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_crimfqydhg$art_c = list.length; index < $art_crimfqydhg$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_crimfqydhg$art_c = list.length; index < $art_crimfqydhg$art_c; index++) {
        var item = list[index];
        $p += '<tr class="';
        $line = 81;
        ...
        $art = 'each groups as group';
        ;
        $expr = '<%for (var $art_iffuuql$art_i = 0, $art_czsjcsfi$art_c = groups.length; $art_iffuuql$art_i < $art_czsjcsfi$art_c; $art_iffuuql$art_i++) {        var group = groups[$art_iffuuql$art_i]%>';
        for (var $art_iffuuql$art_i = 0, $art_czsjcsfi$art_c = groups.length; $art_iffuuql$art_i < $art_czsjcsfi$art_c; $art_iffuuql$art_i++) {
            var group = groups[$art_iffuuql$art_i];
            $p += ' ';
            $line = 83;
            $art = 'each group.fields as field';
            ;
            $expr = '<%for (var $art_iqkuevins$art_i = 0, $art_objlmxulothc$art_obj = group.fields, $art_cxapwjtzf$art_c = $art_objlmxulothc$art_obj.length; $art_iqkuevins$art_i < $art_cxapwjtzf$art_c; $art_iqkuevins$art_i++) {            var field = $art_objlmxulothc$art_obj[$art_iqkuevins$art_i]%>';
            for (var $art_iqkuevins$art_i = 0, $art_objlmxulothc$art_obj = group.fields, $art_cxapwjtzf$art_c = $art_objlmxulothc$art_obj.length; $art_iqkuevins$art_i < $art_cxapwjtzf$art_c; $art_iqkuevins$art_i++) {
                var field = $art_objlmxulothc$art_obj[$art_iqkuevins$art_i];
                $p += '<td>';
                $line = 84;
