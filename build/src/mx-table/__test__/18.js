...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cixhmobce$art_c = list.length; index < $art_cixhmobce$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cixhmobce$art_c = list.length; index < $art_cixhmobce$art_c; index++) {
        var item = list[index];
        $p += '<tr><td>';
        $line = 47;
        $art = '=item.fixed1';
    ...
    ;
    $expr = '<%for (var $art_iwnpgufmbzj$art_i = 0, $art_cjglhxjeo$art_c = groups.length; $art_iwnpgufmbzj$art_i < $art_cjglhxjeo$art_c; $art_iwnpgufmbzj$art_i++) {    var group = groups[$art_iwnpgufmbzj$art_i]%>';
    for (var $art_iwnpgufmbzj$art_i = 0, $art_cjglhxjeo$art_c = groups.length; $art_iwnpgufmbzj$art_i < $art_cjglhxjeo$art_c; $art_iwnpgufmbzj$art_i++) {
        var group = groups[$art_iwnpgufmbzj$art_i];
    ...
    $art = 'each groups as group';
    ;
    $expr = '<%for (var $art_iebxlosgy$art_i = 0, $art_cebmzyyun$art_c = groups.length; $art_iebxlosgy$art_i < $art_cebmzyyun$art_c; $art_iebxlosgy$art_i++) {    var group = groups[$art_iebxlosgy$art_i]%>';
    for (var $art_iebxlosgy$art_i = 0, $art_cebmzyyun$art_c = groups.length; $art_iebxlosgy$art_i < $art_cebmzyyun$art_c; $art_iebxlosgy$art_i++) {
        var group = groups[$art_iebxlosgy$art_i];
        $p += ' ';
        $line = 66;
        $art = 'each group.fields as field';
        ;
        $expr = '<%for (var $art_iydznamqdj$art_i = 0, $art_objygxiqk$art_obj = group.fields, $art_clepnhiwj$art_c = $art_objygxiqk$art_obj.length; $art_iydznamqdj$art_i < $art_clepnhiwj$art_c; $art_iydznamqdj$art_i++) {        var field = $art_objygxiqk$art_obj[$art_iydznamqdj$art_i]%>';
        for (var $art_iydznamqdj$art_i = 0, $art_objygxiqk$art_obj = group.fields, $art_clepnhiwj$art_c = $art_objygxiqk$art_obj.length; $art_iydznamqdj$art_i < $art_clepnhiwj$art_c; $art_iydznamqdj$art_i++) {
            var field = $art_objygxiqk$art_obj[$art_iydznamqdj$art_i];
    ...
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cqantbnbl$art_c = list.length; index < $art_cqantbnbl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cqantbnbl$art_c = list.length; index < $art_cqantbnbl$art_c; index++) {
        var item = list[index];
        $p += '<tr class="';
        $line = 81;
        ...
        $art = 'each groups as group';
        ;
        $expr = '<%for (var $art_ipdfvmdkf$art_i = 0, $art_cwmysyzb$art_c = groups.length; $art_ipdfvmdkf$art_i < $art_cwmysyzb$art_c; $art_ipdfvmdkf$art_i++) {        var group = groups[$art_ipdfvmdkf$art_i]%>';
        for (var $art_ipdfvmdkf$art_i = 0, $art_cwmysyzb$art_c = groups.length; $art_ipdfvmdkf$art_i < $art_cwmysyzb$art_c; $art_ipdfvmdkf$art_i++) {
            var group = groups[$art_ipdfvmdkf$art_i];
            $p += ' ';
            $line = 83;
            $art = 'each group.fields as field';
            ;
            $expr = '<%for (var $art_ifyqqqdh$art_i = 0, $art_objnpfotkcv$art_obj = group.fields, $art_cvpymfbrj$art_c = $art_objnpfotkcv$art_obj.length; $art_ifyqqqdh$art_i < $art_cvpymfbrj$art_c; $art_ifyqqqdh$art_i++) {            var field = $art_objnpfotkcv$art_obj[$art_ifyqqqdh$art_i]%>';
            for (var $art_ifyqqqdh$art_i = 0, $art_objnpfotkcv$art_obj = group.fields, $art_cvpymfbrj$art_c = $art_objnpfotkcv$art_obj.length; $art_ifyqqqdh$art_i < $art_cvpymfbrj$art_c; $art_ifyqqqdh$art_i++) {
                var field = $art_objnpfotkcv$art_obj[$art_ifyqqqdh$art_i];
                $p += '<td>';
                $line = 84;
