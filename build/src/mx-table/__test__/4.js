...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycr:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycr:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycr:_" class="mb20 clearfix"><div class="fl color-9 lh22">该示例：</div><div class="fl lh22"><div>分栏会根据屏幕可视范围控制是否需要显示分栏，宽段配置在th上</div><div>模拟滚动条一直在可视范围内，windows下鼠标无法左右滚动，可直接操作模拟滚动条滚动</div></div></div><div mxs="_zs_gallerycr:a" class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'change()" class="btn btn-brand">切换宽度</a></div><div class="mb40" style="width: ';
    $line = 13;
    $art = '=width';
    ;
    $p += '' + ($expr = '<%=width%>', $e(width)) + '%;"><div mxa="_zs_gallerycr:b" mx-view="mx-table/index?sticky=true"><div><table mxa="_zs_gallerycr:c" class="table" left="true"><thead><tr>';
    $line = 19;
    ...
    for (var j = 0; j < 10; j++) {
        ...
        ;
        $p += '</tr><tr mxs="_zs_gallerycr:b" class="operation-tr"><td colspan="4"><a href="javascript:;" class="btn btn-small mr10">操作</a><a href="javascript:;" class="btn btn-small">操作</a></td></tr>';
        $line = 37;
        $art = '/for';
        ;
        $p += '';
    ...
    for (var j = 0; j < 10; j++) {
        ...
        ;
        $p += '</tr><tr mxs="_zs_gallerycr:c" class="operation-tr"><td colspan="4"></td></tr>';
        $line = 60;
        $art = '/for';
        ;
        $p += '';
    ...
    ;
    $p += '</tbody></table></div></div></div></div><div mxa="_zs_gallerycr:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycr:d" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 68;
    $art = '=viewId';
    ;
