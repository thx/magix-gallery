...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryc_:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryc_:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryc_:_" class="mb20"><span class="color-9">该示例：</span>默认选中第一行 + 选中行展示操作项</div><div mxa="_zs_galleryc_:b" mx-view="mx-table/index"><div><table mxa="_zs_galleryc_:c" class="table"><thead><tr>';
    $line = 11;
    ...
    ;
    $p += '</tbody></table></div></div></div><div mxa="_zs_galleryc_:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryc_:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
