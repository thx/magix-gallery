...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydJ:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydJ:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydJ:_" class="mb20"><span class="color-9">该示例：</span>默认选中第一行 + 选中行展示操作项</div><div mxa="_zs_gallerydJ:b" mx-view="mx-table/index"><div><table mxa="_zs_gallerydJ:c" class="table"><thead><tr>';
    $line = 11;
    ...
    for (var j = 0; j < 3; j++) {
        ...
        ;
        $p += '<td mxs="_zs_gallerydJ:b"><div class="operations"><a href="javascript:;" class="btn btn-small">操作</a></div></td></tr>';
        $line = 29;
        $art = '/for';
        ;
        $expr = '<%}%>';
