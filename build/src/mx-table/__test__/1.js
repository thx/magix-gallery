...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb&:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_galleryb&:a" class="_zs_gallery___test___base_-eg-content"><div mxs="_zs_galleryb&:_" class="mb20"><span class="color-9">该示例：</span>默认选中第一行 + 选中行展示操作项</div><div mxa="_zs_galleryb&:b" mx-view="mx-table/index"><div><table mxa="_zs_galleryb&:c" class="table"><thead><tr>';
    $line = 11;
    ...
    ;
    $p += '</tbody></table></div></div></div><div mxa="_zs_galleryb&:d" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryb&:c" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
