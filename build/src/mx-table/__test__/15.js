...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc_:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_galleryc_:a" class="_zs_gallery___test___base_-eg-content"><div mxs="_zs_galleryc_:_" class="mb20"><span class="color-9">以下示例：</span>实时反馈当前选中项</div><div mxa="_zs_galleryc_:b" class="mb20"><a mxs="_zs_galleryc_:a" href="javascript:;" mx-click="' + $viewId + 'get()" class="btn btn-brand mr20">获取选中值</a>';
    $line = 9;
    ...
    if (selected.length > 0) {
        ;
        $p += '<span mxs="_zs_galleryc_:b" class="color-9">当前选中：</span>';
        $line = 10;
        $art = '=selected';
        ;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_galleryc_:c" mx-view="mx-table/index?sticky=true"><div mxv><table mxv mxa="_zs_galleryc_:d" class="table"><thead mxv><tr mxv><th mxv mxa="_zs_galleryc_:e" width="50"><input mxs="_zs_galleryc_:c" type="checkbox" class="checkbox" linkage="example" mx-change="' + $viewId + 'get()"/></th><th mxs="_zs_galleryc_:d" width="200">列1</th><th mxs="_zs_galleryc_:e" width="200">列2</th><th mxs="_zs_galleryc_:f" width="200">列3</th></tr></thead><tbody mxv>';
    $line = 26;
    $art = 'each list as item index';
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_cppnqrrrn$art_c = list.length; index < $art_cppnqrrrn$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cppnqrrrn$art_c = list.length; index < $art_cppnqrrrn$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 27;
    ...
    ;
    $p += '</tbody></table></div></div><div mxa="_zs_galleryc_:f" class="table-pager-wrapper"><div mx-change="' + $viewId + 'changePager()" mx-view="mx-pagination/index?total=';
    $line = 43;
    $art = '=total';
    ;
    ...
    $art = '=page';
    ;
    $p += '' + ($expr = '<%!$eu(page)%>', $eu(page)) + '"></div></div></div><div mxa="_zs_galleryc_:g" class="clearfix"><div mxa="_zs_galleryc_:h" class="_zs_gallery___test___base_-eg-desc _zs_gallery___test___base_-half"><div mxs="_zs_galleryc_:g" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 52;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += '' + ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryc_:h" class="mc-iconfont _zs_gallery___test___base_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 107;
    $art = '=viewId';
    ;
