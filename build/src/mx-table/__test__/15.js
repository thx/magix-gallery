...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycQ:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerycQ:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycQ:_" class="mb20"><span class="color-9">以下示例：</span>实时反馈当前选中项</div><div mxa="_zs_gallerycQ:b" class="mb20"><span mxs="_zs_gallerycQ:a" class="color-9">当前选中：</span>';
    $line = 8;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</div><div mxv mxa="_zs_gallerycQ:c" mx-view="mx-table/index?sticky=true"><div mxv><table mxv mxa="_zs_gallerycQ:d" class="table"><thead mxv><tr mxv><th mxv mxa="_zs_gallerycQ:e" width="50"><input mxs="_zs_gallerycQ:b" type="checkbox" class="checkbox" linkage="example" mx-change="' + $viewId + 'get()"/></th><th mxs="_zs_gallerycQ:c" width="200">列1</th><th mxs="_zs_gallerycQ:d" width="200">列2</th><th mxs="_zs_gallerycQ:e" width="200">列3</th></tr></thead><tbody mxv>';
    $line = 23;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_csyytuknrp$art_c = list.length; index < $art_csyytuknrp$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_csyytuknrp$art_c = list.length; index < $art_csyytuknrp$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 24;
