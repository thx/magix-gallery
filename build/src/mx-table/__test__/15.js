...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cmfejnerujc$art_c = list.length; index < $art_cmfejnerujc$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cmfejnerujc$art_c = list.length; index < $art_cmfejnerujc$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 25;
    ...
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_gallerydI:h" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 55;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_gallerydI:h" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 105;
    $art = '=viewId';
    ;
