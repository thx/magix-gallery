...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycE:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerycE:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycE:_" class="mb20"><span class="color-9">以下示例：</span>实时反馈当前选中项</div><div mxa="_zs_gallerycE:b" class="mb20"><a mxs="_zs_gallerycE:a" href="javascript:;" mx-click="' + $viewId + 'get()" class="btn btn-brand mr20">获取选中值</a>';
    $line = 9;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_gallerycE:c" mx-view="mx-table/index?sticky=true"><div mxv><table mxv mxa="_zs_gallerycE:d" class="table"><thead mxv><tr mxv><th mxv mxa="_zs_gallerycE:e" width="50"><input mxs="_zs_gallerycE:c" type="checkbox" class="checkbox" linkage="example" mx-change="' + $viewId + 'get()"/></th><th mxs="_zs_gallerycE:d" width="200">列1</th><th mxs="_zs_gallerycE:e" width="200">列2</th><th mxs="_zs_gallerycE:f" width="200">列3</th></tr></thead><tbody mxv>';
    $line = 26;
    $art = 'each list as item index';
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_cngkehaxzj$art_c = list.length; index < $art_cngkehaxzj$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cngkehaxzj$art_c = list.length; index < $art_cngkehaxzj$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 27;
