...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_chsyceh$art_c = list.length; index < $art_chsyceh$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_chsyceh$art_c = list.length; index < $art_chsyceh$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 25;
