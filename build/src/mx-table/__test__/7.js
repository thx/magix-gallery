...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryca:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_galleryca:a" class="_zs_gallery___test___base_-eg-content"><div mxs="_zs_galleryca:_" class="mb20"><span class="color-9">该示例：</span>吸顶 + 表头分组</div><div mxa="_zs_galleryca:b" mx-view="mx-table/index?sticky=true"><div><table mxa="_zs_galleryca:c" class="table"><thead mxs="_zs_galleryca:a"><tr><th rowspan="2">单个1</th><th rowspan="2">单个2</th><th class="field-group" colspan="2"><div class="group-name">组1</div></th><th class="field-group" colspan="3"><div class="group-name">组2</div></th></tr><tr><th class="field-item">组1-1</th><th class="field-item">组1-2</th><th class="field-item">组2-1</th><th class="field-item">组2-2</th><th class="field-item">组2-3</th></tr></thead><tbody>';
    $line = 30;
