...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_galleryc8:_" class="mb20 clearfix"><div mx-view="mx-table/__test__/8"></div></div><div mxv class="mb40" id="';
    $line = 18;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_router"><div mxs="_zs_galleryc8:a" mx-view="mx-title/second?content=%E8%B7%AF%E7%94%B1%E5%8F%82%E6%95%B0"></div><div mxv="options" mx-view="__test__/api?options=';
    $line = 20;
    $art = '@options';
    ;
