...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryem:a" class="mb20 clearfix"><div mx-view="mx-table/__test__/8" id="';
    $line = 25;
    $art = '=viewId';
    ;
