...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydP:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydP:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydP:_" class="mb20"><span class="color-9">该示例：</span>表头吸顶 + 左右分栏 + 默认展开第一行下方操作项 + 选中行展示操作项</div><div mxa="_zs_gallerydP:b" mx-view="mx-table/index?sticky=true" class="mb40"><div><table mxa="_zs_gallerydP:c" class="table" left="true" width="500"><thead><tr>';
    $line = 12;
    ...
    ;
    $p += '</tbody></table></div><div><table mxa="_zs_gallerydP:d" class="table" center="true" width="1000"><thead><tr>';
    $line = 37;
    ...
    ;
    $p += '</tbody></table></div></div></div><div mxa="_zs_gallerydP:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydP:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 60;
    $art = '=viewId';
    ;
