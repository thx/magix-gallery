...
module.exports = Base.extend({
    ...
    ;
    $p += '</tbody></table></div><div><table mxa="_zs_galleryed:d" class="table" center="true" width="1000"><thead><tr>';
    $line = 37;
    ...
    ;
    $p += '</tbody></table></div></div></div><div mxa="_zs_galleryed:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryed:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 60;
    $art = '=viewId';
    ;
