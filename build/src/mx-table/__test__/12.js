...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqfotao$art_i = 0, $art_cafxczhkgw$art_c = list.length; $art_iqfotao$art_i < $art_cafxczhkgw$art_c; $art_iqfotao$art_i++) {    var item = list[$art_iqfotao$art_i]%>';
    for (var $art_iqfotao$art_i = 0, $art_cafxczhkgw$art_c = list.length; $art_iqfotao$art_i < $art_cafxczhkgw$art_c; $art_iqfotao$art_i++) {
        var item = list[$art_iqfotao$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objvnfuewd$art_obj = item.subs, $art_crwxbczbgf$art_c = $art_objvnfuewd$art_obj.length; subIndex < $art_crwxbczbgf$art_c; subIndex++) {        var sub = $art_objvnfuewd$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objvnfuewd$art_obj = item.subs, $art_crwxbczbgf$art_c = $art_objvnfuewd$art_obj.length; subIndex < $art_crwxbczbgf$art_c; subIndex++) {
            var sub = $art_objvnfuewd$art_obj[subIndex];
