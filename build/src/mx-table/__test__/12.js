...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijrprhczev$art_i = 0, $art_cayyzvxhsj$art_c = list.length; $art_ijrprhczev$art_i < $art_cayyzvxhsj$art_c; $art_ijrprhczev$art_i++) {    var item = list[$art_ijrprhczev$art_i]%>';
    for (var $art_ijrprhczev$art_i = 0, $art_cayyzvxhsj$art_c = list.length; $art_ijrprhczev$art_i < $art_cayyzvxhsj$art_c; $art_ijrprhczev$art_i++) {
        var item = list[$art_ijrprhczev$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objjycaty$art_obj = item.subs, $art_cctnxtzl$art_c = $art_objjycaty$art_obj.length; subIndex < $art_cctnxtzl$art_c; subIndex++) {        var sub = $art_objjycaty$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objjycaty$art_obj = item.subs, $art_cctnxtzl$art_c = $art_objjycaty$art_obj.length; subIndex < $art_cctnxtzl$art_c; subIndex++) {
            var sub = $art_objjycaty$art_obj[subIndex];
