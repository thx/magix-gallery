...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iemqgth$art_i = 0, $art_czigiymzlxu$art_c = list.length; $art_iemqgth$art_i < $art_czigiymzlxu$art_c; $art_iemqgth$art_i++) {    var item = list[$art_iemqgth$art_i]%>';
    for (var $art_iemqgth$art_i = 0, $art_czigiymzlxu$art_c = list.length; $art_iemqgth$art_i < $art_czigiymzlxu$art_c; $art_iemqgth$art_i++) {
        var item = list[$art_iemqgth$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objraxuxjxmt$art_obj = item.subs, $art_cubkkvoob$art_c = $art_objraxuxjxmt$art_obj.length; subIndex < $art_cubkkvoob$art_c; subIndex++) {        var sub = $art_objraxuxjxmt$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objraxuxjxmt$art_obj = item.subs, $art_cubkkvoob$art_c = $art_objraxuxjxmt$art_obj.length; subIndex < $art_cubkkvoob$art_c; subIndex++) {
            var sub = $art_objraxuxjxmt$art_obj[subIndex];
