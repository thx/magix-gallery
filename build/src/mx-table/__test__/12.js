...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwtrsrtvzg$art_i = 0, $art_cjeszhiafm$art_c = list.length; $art_iwtrsrtvzg$art_i < $art_cjeszhiafm$art_c; $art_iwtrsrtvzg$art_i++) {    var item = list[$art_iwtrsrtvzg$art_i]%>';
    for (var $art_iwtrsrtvzg$art_i = 0, $art_cjeszhiafm$art_c = list.length; $art_iwtrsrtvzg$art_i < $art_cjeszhiafm$art_c; $art_iwtrsrtvzg$art_i++) {
        var item = list[$art_iwtrsrtvzg$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objvlkfubo$art_obj = item.subs, $art_cjyeqdhmrge$art_c = $art_objvlkfubo$art_obj.length; subIndex < $art_cjyeqdhmrge$art_c; subIndex++) {        var sub = $art_objvlkfubo$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objvlkfubo$art_obj = item.subs, $art_cjyeqdhmrge$art_c = $art_objvlkfubo$art_obj.length; subIndex < $art_cjyeqdhmrge$art_c; subIndex++) {
            var sub = $art_objvlkfubo$art_obj[subIndex];
