...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ikvbltyq$art_i = 0, $art_cdjqboq$art_c = list.length; $art_ikvbltyq$art_i < $art_cdjqboq$art_c; $art_ikvbltyq$art_i++) {    var item = list[$art_ikvbltyq$art_i]%>';
    for (var $art_ikvbltyq$art_i = 0, $art_cdjqboq$art_c = list.length; $art_ikvbltyq$art_i < $art_cdjqboq$art_c; $art_ikvbltyq$art_i++) {
        var item = list[$art_ikvbltyq$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for (var subIndex = 0, $art_objmeusofb$art_obj = item.subs, $art_cmpxxsdfbyt$art_c = $art_objmeusofb$art_obj.length; subIndex < $art_cmpxxsdfbyt$art_c; subIndex++) {        var sub = $art_objmeusofb$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objmeusofb$art_obj = item.subs, $art_cmpxxsdfbyt$art_c = $art_objmeusofb$art_obj.length; subIndex < $art_cmpxxsdfbyt$art_c; subIndex++) {
            var sub = $art_objmeusofb$art_obj[subIndex];
