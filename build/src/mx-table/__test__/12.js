...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijthoiq$art_i = 0, $art_czlvikuhr$art_c = list.length; $art_ijthoiq$art_i < $art_czlvikuhr$art_c; $art_ijthoiq$art_i++) {    var item = list[$art_ijthoiq$art_i]%>';
    for (var $art_ijthoiq$art_i = 0, $art_czlvikuhr$art_c = list.length; $art_ijthoiq$art_i < $art_czlvikuhr$art_c; $art_ijthoiq$art_i++) {
        var item = list[$art_ijthoiq$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objyqefhwey$art_obj = item.subs, $art_ccgmoixzdu$art_c = $art_objyqefhwey$art_obj.length; subIndex < $art_ccgmoixzdu$art_c; subIndex++) {        var sub = $art_objyqefhwey$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objyqefhwey$art_obj = item.subs, $art_ccgmoixzdu$art_c = $art_objyqefhwey$art_obj.length; subIndex < $art_ccgmoixzdu$art_c; subIndex++) {
            var sub = $art_objyqefhwey$art_obj[subIndex];
