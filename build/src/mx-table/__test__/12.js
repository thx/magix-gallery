...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inublekf$art_i = 0, $art_cxtogvttxee$art_c = list.length; $art_inublekf$art_i < $art_cxtogvttxee$art_c; $art_inublekf$art_i++) {    var item = list[$art_inublekf$art_i]%>';
    for (var $art_inublekf$art_i = 0, $art_cxtogvttxee$art_c = list.length; $art_inublekf$art_i < $art_cxtogvttxee$art_c; $art_inublekf$art_i++) {
        var item = list[$art_inublekf$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objsqfrlbnyg$art_obj = item.subs, $art_cyhilhsrwbi$art_c = $art_objsqfrlbnyg$art_obj.length; subIndex < $art_cyhilhsrwbi$art_c; subIndex++) {        var sub = $art_objsqfrlbnyg$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objsqfrlbnyg$art_obj = item.subs, $art_cyhilhsrwbi$art_c = $art_objsqfrlbnyg$art_obj.length; subIndex < $art_cyhilhsrwbi$art_c; subIndex++) {
            var sub = $art_objsqfrlbnyg$art_obj[subIndex];
