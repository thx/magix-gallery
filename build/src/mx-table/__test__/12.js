...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibpnkdbd$art_i = 0, $art_chyypr$art_c = list.length; $art_ibpnkdbd$art_i < $art_chyypr$art_c; $art_ibpnkdbd$art_i++) {    var item = list[$art_ibpnkdbd$art_i]%>';
    for (var $art_ibpnkdbd$art_i = 0, $art_chyypr$art_c = list.length; $art_ibpnkdbd$art_i < $art_chyypr$art_c; $art_ibpnkdbd$art_i++) {
        var item = list[$art_ibpnkdbd$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objtbkegwivwi$art_obj = item.subs, $art_cizprnvefc$art_c = $art_objtbkegwivwi$art_obj.length; subIndex < $art_cizprnvefc$art_c; subIndex++) {        var sub = $art_objtbkegwivwi$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objtbkegwivwi$art_obj = item.subs, $art_cizprnvefc$art_c = $art_objtbkegwivwi$art_obj.length; subIndex < $art_cizprnvefc$art_c; subIndex++) {
            var sub = $art_objtbkegwivwi$art_obj[subIndex];
