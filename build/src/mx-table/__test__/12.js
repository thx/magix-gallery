...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibplbjfm$art_i = 0, $art_cyynfjfzy$art_c = list.length; $art_ibplbjfm$art_i < $art_cyynfjfzy$art_c; $art_ibplbjfm$art_i++) {    var item = list[$art_ibplbjfm$art_i]%>';
    for (var $art_ibplbjfm$art_i = 0, $art_cyynfjfzy$art_c = list.length; $art_ibplbjfm$art_i < $art_cyynfjfzy$art_c; $art_ibplbjfm$art_i++) {
        var item = list[$art_ibplbjfm$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objlocayrjld$art_obj = item.subs, $art_cdgrob$art_c = $art_objlocayrjld$art_obj.length; subIndex < $art_cdgrob$art_c; subIndex++) {        var sub = $art_objlocayrjld$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objlocayrjld$art_obj = item.subs, $art_cdgrob$art_c = $art_objlocayrjld$art_obj.length; subIndex < $art_cdgrob$art_c; subIndex++) {
            var sub = $art_objlocayrjld$art_obj[subIndex];
