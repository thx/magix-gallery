...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihhatdchh$art_i = 0, $art_cysjxjlbl$art_c = list.length; $art_ihhatdchh$art_i < $art_cysjxjlbl$art_c; $art_ihhatdchh$art_i++) {    var item = list[$art_ihhatdchh$art_i]%>';
    for (var $art_ihhatdchh$art_i = 0, $art_cysjxjlbl$art_c = list.length; $art_ihhatdchh$art_i < $art_cysjxjlbl$art_c; $art_ihhatdchh$art_i++) {
        var item = list[$art_ihhatdchh$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objrexrwx$art_obj = item.subs, $art_couxgrrsefh$art_c = $art_objrexrwx$art_obj.length; subIndex < $art_couxgrrsefh$art_c; subIndex++) {        var sub = $art_objrexrwx$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objrexrwx$art_obj = item.subs, $art_couxgrrsefh$art_c = $art_objrexrwx$art_obj.length; subIndex < $art_couxgrrsefh$art_c; subIndex++) {
            var sub = $art_objrexrwx$art_obj[subIndex];
