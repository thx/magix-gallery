...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibdsqpxa$art_i = 0, $art_cxnlse$art_c = list.length; $art_ibdsqpxa$art_i < $art_cxnlse$art_c; $art_ibdsqpxa$art_i++) {    var item = list[$art_ibdsqpxa$art_i]%>';
    for (var $art_ibdsqpxa$art_i = 0, $art_cxnlse$art_c = list.length; $art_ibdsqpxa$art_i < $art_cxnlse$art_c; $art_ibdsqpxa$art_i++) {
        var item = list[$art_ibdsqpxa$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objzkkqmvtb$art_obj = item.subs, $art_ciukqc$art_c = $art_objzkkqmvtb$art_obj.length; subIndex < $art_ciukqc$art_c; subIndex++) {        var sub = $art_objzkkqmvtb$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objzkkqmvtb$art_obj = item.subs, $art_ciukqc$art_c = $art_objzkkqmvtb$art_obj.length; subIndex < $art_ciukqc$art_c; subIndex++) {
            var sub = $art_objzkkqmvtb$art_obj[subIndex];
