...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijkgjstgwn$art_i = 0, $art_cngjaod$art_c = list.length; $art_ijkgjstgwn$art_i < $art_cngjaod$art_c; $art_ijkgjstgwn$art_i++) {    var item = list[$art_ijkgjstgwn$art_i]%>';
    for (var $art_ijkgjstgwn$art_i = 0, $art_cngjaod$art_c = list.length; $art_ijkgjstgwn$art_i < $art_cngjaod$art_c; $art_ijkgjstgwn$art_i++) {
        var item = list[$art_ijkgjstgwn$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objexewpzoa$art_obj = item.subs, $art_ccpvvkdzk$art_c = $art_objexewpzoa$art_obj.length; subIndex < $art_ccpvvkdzk$art_c; subIndex++) {        var sub = $art_objexewpzoa$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objexewpzoa$art_obj = item.subs, $art_ccpvvkdzk$art_c = $art_objexewpzoa$art_obj.length; subIndex < $art_ccpvvkdzk$art_c; subIndex++) {
            var sub = $art_objexewpzoa$art_obj[subIndex];
