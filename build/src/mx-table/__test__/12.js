...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icejvhzd$art_i = 0, $art_cwgtkgdu$art_c = list.length; $art_icejvhzd$art_i < $art_cwgtkgdu$art_c; $art_icejvhzd$art_i++) {    var item = list[$art_icejvhzd$art_i]%>';
    for (var $art_icejvhzd$art_i = 0, $art_cwgtkgdu$art_c = list.length; $art_icejvhzd$art_i < $art_cwgtkgdu$art_c; $art_icejvhzd$art_i++) {
        var item = list[$art_icejvhzd$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objefopnrj$art_obj = item.subs, $art_chthzzvo$art_c = $art_objefopnrj$art_obj.length; subIndex < $art_chthzzvo$art_c; subIndex++) {        var sub = $art_objefopnrj$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objefopnrj$art_obj = item.subs, $art_chthzzvo$art_c = $art_objefopnrj$art_obj.length; subIndex < $art_chthzzvo$art_c; subIndex++) {
            var sub = $art_objefopnrj$art_obj[subIndex];
