...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iouxmno$art_i = 0, $art_cejaxcsdgee$art_c = list.length; $art_iouxmno$art_i < $art_cejaxcsdgee$art_c; $art_iouxmno$art_i++) {    var item = list[$art_iouxmno$art_i]%>';
    for (var $art_iouxmno$art_i = 0, $art_cejaxcsdgee$art_c = list.length; $art_iouxmno$art_i < $art_cejaxcsdgee$art_c; $art_iouxmno$art_i++) {
        var item = list[$art_iouxmno$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objzzylwwryprk$art_obj = item.subs, $art_cgwwjotcbk$art_c = $art_objzzylwwryprk$art_obj.length; subIndex < $art_cgwwjotcbk$art_c; subIndex++) {        var sub = $art_objzzylwwryprk$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objzzylwwryprk$art_obj = item.subs, $art_cgwwjotcbk$art_c = $art_objzzylwwryprk$art_obj.length; subIndex < $art_cgwwjotcbk$art_c; subIndex++) {
            var sub = $art_objzzylwwryprk$art_obj[subIndex];
