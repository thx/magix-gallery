...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ievalvgh$art_i = 0, $art_crhbrhgrjj$art_c = list.length; $art_ievalvgh$art_i < $art_crhbrhgrjj$art_c; $art_ievalvgh$art_i++) {    var item = list[$art_ievalvgh$art_i]%>';
    for (var $art_ievalvgh$art_i = 0, $art_crhbrhgrjj$art_c = list.length; $art_ievalvgh$art_i < $art_crhbrhgrjj$art_c; $art_ievalvgh$art_i++) {
        var item = list[$art_ievalvgh$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objpofwuefup$art_obj = item.subs, $art_crdhvkkbyl$art_c = $art_objpofwuefup$art_obj.length; subIndex < $art_crdhvkkbyl$art_c; subIndex++) {        var sub = $art_objpofwuefup$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objpofwuefup$art_obj = item.subs, $art_crdhvkkbyl$art_c = $art_objpofwuefup$art_obj.length; subIndex < $art_crdhvkkbyl$art_c; subIndex++) {
            var sub = $art_objpofwuefup$art_obj[subIndex];
