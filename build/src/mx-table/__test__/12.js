...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyuahsvc$art_i = 0, $art_cntrwgzep$art_c = list.length; $art_iyuahsvc$art_i < $art_cntrwgzep$art_c; $art_iyuahsvc$art_i++) {    var item = list[$art_iyuahsvc$art_i]%>';
    for (var $art_iyuahsvc$art_i = 0, $art_cntrwgzep$art_c = list.length; $art_iyuahsvc$art_i < $art_cntrwgzep$art_c; $art_iyuahsvc$art_i++) {
        var item = list[$art_iyuahsvc$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objscdsna$art_obj = item.subs, $art_cjqwbyen$art_c = $art_objscdsna$art_obj.length; subIndex < $art_cjqwbyen$art_c; subIndex++) {        var sub = $art_objscdsna$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objscdsna$art_obj = item.subs, $art_cjqwbyen$art_c = $art_objscdsna$art_obj.length; subIndex < $art_cjqwbyen$art_c; subIndex++) {
            var sub = $art_objscdsna$art_obj[subIndex];
