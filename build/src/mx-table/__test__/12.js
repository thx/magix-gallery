...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icujztbp$art_i = 0, $art_cvyuzqunrxn$art_c = list.length; $art_icujztbp$art_i < $art_cvyuzqunrxn$art_c; $art_icujztbp$art_i++) {    var item = list[$art_icujztbp$art_i]%>';
    for (var $art_icujztbp$art_i = 0, $art_cvyuzqunrxn$art_c = list.length; $art_icujztbp$art_i < $art_cvyuzqunrxn$art_c; $art_icujztbp$art_i++) {
        var item = list[$art_icujztbp$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objxvlveouhulg$art_obj = item.subs, $art_cferssno$art_c = $art_objxvlveouhulg$art_obj.length; subIndex < $art_cferssno$art_c; subIndex++) {        var sub = $art_objxvlveouhulg$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objxvlveouhulg$art_obj = item.subs, $art_cferssno$art_c = $art_objxvlveouhulg$art_obj.length; subIndex < $art_cferssno$art_c; subIndex++) {
            var sub = $art_objxvlveouhulg$art_obj[subIndex];
