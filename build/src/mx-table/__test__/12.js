...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imhbjbb$art_i = 0, $art_cwqyohnx$art_c = list.length; $art_imhbjbb$art_i < $art_cwqyohnx$art_c; $art_imhbjbb$art_i++) {    var item = list[$art_imhbjbb$art_i]%>';
    for (var $art_imhbjbb$art_i = 0, $art_cwqyohnx$art_c = list.length; $art_imhbjbb$art_i < $art_cwqyohnx$art_c; $art_imhbjbb$art_i++) {
        var item = list[$art_imhbjbb$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objjhgusfog$art_obj = item.subs, $art_ctozvhpkc$art_c = $art_objjhgusfog$art_obj.length; subIndex < $art_ctozvhpkc$art_c; subIndex++) {        var sub = $art_objjhgusfog$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objjhgusfog$art_obj = item.subs, $art_ctozvhpkc$art_c = $art_objjhgusfog$art_obj.length; subIndex < $art_ctozvhpkc$art_c; subIndex++) {
            var sub = $art_objjhgusfog$art_obj[subIndex];
