...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iuzatpokgr$art_i = 0, $art_cuaebbx$art_c = list.length; $art_iuzatpokgr$art_i < $art_cuaebbx$art_c; $art_iuzatpokgr$art_i++) {    var item = list[$art_iuzatpokgr$art_i]%>';
    for (var $art_iuzatpokgr$art_i = 0, $art_cuaebbx$art_c = list.length; $art_iuzatpokgr$art_i < $art_cuaebbx$art_c; $art_iuzatpokgr$art_i++) {
        var item = list[$art_iuzatpokgr$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for (var subIndex = 0, $art_objirktiajx$art_obj = item.subs, $art_ccvurbewpsg$art_c = $art_objirktiajx$art_obj.length; subIndex < $art_ccvurbewpsg$art_c; subIndex++) {        var sub = $art_objirktiajx$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objirktiajx$art_obj = item.subs, $art_ccvurbewpsg$art_c = $art_objirktiajx$art_obj.length; subIndex < $art_ccvurbewpsg$art_c; subIndex++) {
            var sub = $art_objirktiajx$art_obj[subIndex];
