...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_inahyqnrk$art_i = 0, $art_ctbbfmu$art_c = list.length; $art_inahyqnrk$art_i < $art_ctbbfmu$art_c; $art_inahyqnrk$art_i++) {    var item = list[$art_inahyqnrk$art_i]%>';
    for (var $art_inahyqnrk$art_i = 0, $art_ctbbfmu$art_c = list.length; $art_inahyqnrk$art_i < $art_ctbbfmu$art_c; $art_inahyqnrk$art_i++) {
        var item = list[$art_inahyqnrk$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for (var subIndex = 0, $art_objjqnivcymf$art_obj = item.subs, $art_ciioduolj$art_c = $art_objjqnivcymf$art_obj.length; subIndex < $art_ciioduolj$art_c; subIndex++) {        var sub = $art_objjqnivcymf$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objjqnivcymf$art_obj = item.subs, $art_ciioduolj$art_c = $art_objjqnivcymf$art_obj.length; subIndex < $art_ciioduolj$art_c; subIndex++) {
            var sub = $art_objjqnivcymf$art_obj[subIndex];
    ...
    $art = '=page';
    ;
    $p += '' + ($expr = '<%!$eu(page)%>', $eu(page)) + '"></div></div></div></div><div mxa="_zs_galleryb?:h" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryb?:c" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 80;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += '' + ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryb?:d" class="mc-iconfont _zs_gallery___test___base_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 154;
    $art = '=viewId';
    ;
