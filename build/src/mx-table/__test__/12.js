...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihexzthlo$art_i = 0, $art_coecuzhryjb$art_c = list.length; $art_ihexzthlo$art_i < $art_coecuzhryjb$art_c; $art_ihexzthlo$art_i++) {    var item = list[$art_ihexzthlo$art_i]%>';
    for (var $art_ihexzthlo$art_i = 0, $art_coecuzhryjb$art_c = list.length; $art_ihexzthlo$art_i < $art_coecuzhryjb$art_c; $art_ihexzthlo$art_i++) {
        var item = list[$art_ihexzthlo$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objehfvsqfji$art_obj = item.subs, $art_cqktyczmdag$art_c = $art_objehfvsqfji$art_obj.length; subIndex < $art_cqktyczmdag$art_c; subIndex++) {        var sub = $art_objehfvsqfji$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objehfvsqfji$art_obj = item.subs, $art_cqktyczmdag$art_c = $art_objehfvsqfji$art_obj.length; subIndex < $art_cqktyczmdag$art_c; subIndex++) {
            var sub = $art_objehfvsqfji$art_obj[subIndex];
