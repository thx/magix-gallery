...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iamkwqgymw$art_i = 0, $art_chpyxrxh$art_c = list.length; $art_iamkwqgymw$art_i < $art_chpyxrxh$art_c; $art_iamkwqgymw$art_i++) {    var item = list[$art_iamkwqgymw$art_i]%>';
    for (var $art_iamkwqgymw$art_i = 0, $art_chpyxrxh$art_c = list.length; $art_iamkwqgymw$art_i < $art_chpyxrxh$art_c; $art_iamkwqgymw$art_i++) {
        var item = list[$art_iamkwqgymw$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objadhczeq$art_obj = item.subs, $art_csloxlnrl$art_c = $art_objadhczeq$art_obj.length; subIndex < $art_csloxlnrl$art_c; subIndex++) {        var sub = $art_objadhczeq$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objadhczeq$art_obj = item.subs, $art_csloxlnrl$art_c = $art_objadhczeq$art_obj.length; subIndex < $art_csloxlnrl$art_c; subIndex++) {
            var sub = $art_objadhczeq$art_obj[subIndex];
