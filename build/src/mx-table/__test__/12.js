...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilbxsjvx$art_i = 0, $art_cxakndyr$art_c = list.length; $art_ilbxsjvx$art_i < $art_cxakndyr$art_c; $art_ilbxsjvx$art_i++) {    var item = list[$art_ilbxsjvx$art_i]%>';
    for (var $art_ilbxsjvx$art_i = 0, $art_cxakndyr$art_c = list.length; $art_ilbxsjvx$art_i < $art_cxakndyr$art_c; $art_ilbxsjvx$art_i++) {
        var item = list[$art_ilbxsjvx$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objsizchkbx$art_obj = item.subs, $art_cqmnkdfln$art_c = $art_objsizchkbx$art_obj.length; subIndex < $art_cqmnkdfln$art_c; subIndex++) {        var sub = $art_objsizchkbx$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objsizchkbx$art_obj = item.subs, $art_cqmnkdfln$art_c = $art_objsizchkbx$art_obj.length; subIndex < $art_cqmnkdfln$art_c; subIndex++) {
            var sub = $art_objsizchkbx$art_obj[subIndex];
