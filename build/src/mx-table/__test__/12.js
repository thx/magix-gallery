...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imvkomues$art_i = 0, $art_cmcjs$art_c = list.length; $art_imvkomues$art_i < $art_cmcjs$art_c; $art_imvkomues$art_i++) {    var item = list[$art_imvkomues$art_i]%>';
    for (var $art_imvkomues$art_i = 0, $art_cmcjs$art_c = list.length; $art_imvkomues$art_i < $art_cmcjs$art_c; $art_imvkomues$art_i++) {
        var item = list[$art_imvkomues$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objsxruzsgia$art_obj = item.subs, $art_ckprtrvqmm$art_c = $art_objsxruzsgia$art_obj.length; subIndex < $art_ckprtrvqmm$art_c; subIndex++) {        var sub = $art_objsxruzsgia$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objsxruzsgia$art_obj = item.subs, $art_ckprtrvqmm$art_c = $art_objsxruzsgia$art_obj.length; subIndex < $art_ckprtrvqmm$art_c; subIndex++) {
            var sub = $art_objsxruzsgia$art_obj[subIndex];
