...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irfhlokgzi$art_i = 0, $art_czvgufxa$art_c = list.length; $art_irfhlokgzi$art_i < $art_czvgufxa$art_c; $art_irfhlokgzi$art_i++) {    var item = list[$art_irfhlokgzi$art_i]%>';
    for (var $art_irfhlokgzi$art_i = 0, $art_czvgufxa$art_c = list.length; $art_irfhlokgzi$art_i < $art_czvgufxa$art_c; $art_irfhlokgzi$art_i++) {
        var item = list[$art_irfhlokgzi$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objjmvqage$art_obj = item.subs, $art_ccyepxil$art_c = $art_objjmvqage$art_obj.length; subIndex < $art_ccyepxil$art_c; subIndex++) {        var sub = $art_objjmvqage$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objjmvqage$art_obj = item.subs, $art_ccyepxil$art_c = $art_objjmvqage$art_obj.length; subIndex < $art_ccyepxil$art_c; subIndex++) {
            var sub = $art_objjmvqage$art_obj[subIndex];
