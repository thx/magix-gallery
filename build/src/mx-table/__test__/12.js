...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isbhcphaw$art_i = 0, $art_cylwrbk$art_c = list.length; $art_isbhcphaw$art_i < $art_cylwrbk$art_c; $art_isbhcphaw$art_i++) {    var item = list[$art_isbhcphaw$art_i]%>';
    for (var $art_isbhcphaw$art_i = 0, $art_cylwrbk$art_c = list.length; $art_isbhcphaw$art_i < $art_cylwrbk$art_c; $art_isbhcphaw$art_i++) {
        var item = list[$art_isbhcphaw$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objoanjygwbi$art_obj = item.subs, $art_cwtpgpjh$art_c = $art_objoanjygwbi$art_obj.length; subIndex < $art_cwtpgpjh$art_c; subIndex++) {        var sub = $art_objoanjygwbi$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objoanjygwbi$art_obj = item.subs, $art_cwtpgpjh$art_c = $art_objoanjygwbi$art_obj.length; subIndex < $art_cwtpgpjh$art_c; subIndex++) {
            var sub = $art_objoanjygwbi$art_obj[subIndex];
