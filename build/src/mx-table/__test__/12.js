...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijltjipb$art_i = 0, $art_cifoxxmoykc$art_c = list.length; $art_ijltjipb$art_i < $art_cifoxxmoykc$art_c; $art_ijltjipb$art_i++) {    var item = list[$art_ijltjipb$art_i]%>';
    for (var $art_ijltjipb$art_i = 0, $art_cifoxxmoykc$art_c = list.length; $art_ijltjipb$art_i < $art_cifoxxmoykc$art_c; $art_ijltjipb$art_i++) {
        var item = list[$art_ijltjipb$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objrzlete$art_obj = item.subs, $art_cqbcymml$art_c = $art_objrzlete$art_obj.length; subIndex < $art_cqbcymml$art_c; subIndex++) {        var sub = $art_objrzlete$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objrzlete$art_obj = item.subs, $art_cqbcymml$art_c = $art_objrzlete$art_obj.length; subIndex < $art_cqbcymml$art_c; subIndex++) {
            var sub = $art_objrzlete$art_obj[subIndex];
