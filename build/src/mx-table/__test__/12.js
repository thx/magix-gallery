...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iszyqocdtep$art_i = 0, $art_cotlurpzi$art_c = list.length; $art_iszyqocdtep$art_i < $art_cotlurpzi$art_c; $art_iszyqocdtep$art_i++) {    var item = list[$art_iszyqocdtep$art_i]%>';
    for (var $art_iszyqocdtep$art_i = 0, $art_cotlurpzi$art_c = list.length; $art_iszyqocdtep$art_i < $art_cotlurpzi$art_c; $art_iszyqocdtep$art_i++) {
        var item = list[$art_iszyqocdtep$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objtafqfjie$art_obj = item.subs, $art_cczfvvv$art_c = $art_objtafqfjie$art_obj.length; subIndex < $art_cczfvvv$art_c; subIndex++) {        var sub = $art_objtafqfjie$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objtafqfjie$art_obj = item.subs, $art_cczfvvv$art_c = $art_objtafqfjie$art_obj.length; subIndex < $art_cczfvvv$art_c; subIndex++) {
            var sub = $art_objtafqfjie$art_obj[subIndex];
