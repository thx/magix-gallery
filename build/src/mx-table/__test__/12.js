...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ielxansnk$art_i = 0, $art_ckwfmgsmr$art_c = list.length; $art_ielxansnk$art_i < $art_ckwfmgsmr$art_c; $art_ielxansnk$art_i++) {    var item = list[$art_ielxansnk$art_i]%>';
    for (var $art_ielxansnk$art_i = 0, $art_ckwfmgsmr$art_c = list.length; $art_ielxansnk$art_i < $art_ckwfmgsmr$art_c; $art_ielxansnk$art_i++) {
        var item = list[$art_ielxansnk$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objsjahhdq$art_obj = item.subs, $art_cdhmaaamt$art_c = $art_objsjahhdq$art_obj.length; subIndex < $art_cdhmaaamt$art_c; subIndex++) {        var sub = $art_objsjahhdq$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objsjahhdq$art_obj = item.subs, $art_cdhmaaamt$art_c = $art_objsjahhdq$art_obj.length; subIndex < $art_cdhmaaamt$art_c; subIndex++) {
            var sub = $art_objsjahhdq$art_obj[subIndex];
