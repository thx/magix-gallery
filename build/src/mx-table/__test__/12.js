...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipsrrygxlnk$art_i = 0, $art_cebporgglfr$art_c = list.length; $art_ipsrrygxlnk$art_i < $art_cebporgglfr$art_c; $art_ipsrrygxlnk$art_i++) {    var item = list[$art_ipsrrygxlnk$art_i]%>';
    for (var $art_ipsrrygxlnk$art_i = 0, $art_cebporgglfr$art_c = list.length; $art_ipsrrygxlnk$art_i < $art_cebporgglfr$art_c; $art_ipsrrygxlnk$art_i++) {
        var item = list[$art_ipsrrygxlnk$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objievora$art_obj = item.subs, $art_cwkwdnaxkp$art_c = $art_objievora$art_obj.length; subIndex < $art_cwkwdnaxkp$art_c; subIndex++) {        var sub = $art_objievora$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objievora$art_obj = item.subs, $art_cwkwdnaxkp$art_c = $art_objievora$art_obj.length; subIndex < $art_cwkwdnaxkp$art_c; subIndex++) {
            var sub = $art_objievora$art_obj[subIndex];
