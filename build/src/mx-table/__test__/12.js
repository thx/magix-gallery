...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijdclqocw$art_i = 0, $art_cesdleivyu$art_c = list.length; $art_ijdclqocw$art_i < $art_cesdleivyu$art_c; $art_ijdclqocw$art_i++) {    var item = list[$art_ijdclqocw$art_i]%>';
    for (var $art_ijdclqocw$art_i = 0, $art_cesdleivyu$art_c = list.length; $art_ijdclqocw$art_i < $art_cesdleivyu$art_c; $art_ijdclqocw$art_i++) {
        var item = list[$art_ijdclqocw$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objnrwhbjbrg$art_obj = item.subs, $art_cwdqbeohi$art_c = $art_objnrwhbjbrg$art_obj.length; subIndex < $art_cwdqbeohi$art_c; subIndex++) {        var sub = $art_objnrwhbjbrg$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objnrwhbjbrg$art_obj = item.subs, $art_cwdqbeohi$art_c = $art_objnrwhbjbrg$art_obj.length; subIndex < $art_cwdqbeohi$art_c; subIndex++) {
            var sub = $art_objnrwhbjbrg$art_obj[subIndex];
