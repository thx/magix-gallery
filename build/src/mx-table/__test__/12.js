...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixivqyp$art_i = 0, $art_cqkpwjf$art_c = list.length; $art_ixivqyp$art_i < $art_cqkpwjf$art_c; $art_ixivqyp$art_i++) {    var item = list[$art_ixivqyp$art_i]%>';
    for (var $art_ixivqyp$art_i = 0, $art_cqkpwjf$art_c = list.length; $art_ixivqyp$art_i < $art_cqkpwjf$art_c; $art_ixivqyp$art_i++) {
        var item = list[$art_ixivqyp$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objqylnqzuff$art_obj = item.subs, $art_ctvzrgrn$art_c = $art_objqylnqzuff$art_obj.length; subIndex < $art_ctvzrgrn$art_c; subIndex++) {        var sub = $art_objqylnqzuff$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objqylnqzuff$art_obj = item.subs, $art_ctvzrgrn$art_c = $art_objqylnqzuff$art_obj.length; subIndex < $art_ctvzrgrn$art_c; subIndex++) {
            var sub = $art_objqylnqzuff$art_obj[subIndex];
