...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iszfhxqwh$art_i = 0, $art_cpfrnvgfus$art_c = list.length; $art_iszfhxqwh$art_i < $art_cpfrnvgfus$art_c; $art_iszfhxqwh$art_i++) {    var item = list[$art_iszfhxqwh$art_i]%>';
    for (var $art_iszfhxqwh$art_i = 0, $art_cpfrnvgfus$art_c = list.length; $art_iszfhxqwh$art_i < $art_cpfrnvgfus$art_c; $art_iszfhxqwh$art_i++) {
        var item = list[$art_iszfhxqwh$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objuktqbmlup$art_obj = item.subs, $art_cjysfnk$art_c = $art_objuktqbmlup$art_obj.length; subIndex < $art_cjysfnk$art_c; subIndex++) {        var sub = $art_objuktqbmlup$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objuktqbmlup$art_obj = item.subs, $art_cjysfnk$art_c = $art_objuktqbmlup$art_obj.length; subIndex < $art_cjysfnk$art_c; subIndex++) {
            var sub = $art_objuktqbmlup$art_obj[subIndex];
