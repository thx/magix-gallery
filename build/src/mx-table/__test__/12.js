...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqryokwa$art_i = 0, $art_cacpqfltgcb$art_c = list.length; $art_iqryokwa$art_i < $art_cacpqfltgcb$art_c; $art_iqryokwa$art_i++) {    var item = list[$art_iqryokwa$art_i]%>';
    for (var $art_iqryokwa$art_i = 0, $art_cacpqfltgcb$art_c = list.length; $art_iqryokwa$art_i < $art_cacpqfltgcb$art_c; $art_iqryokwa$art_i++) {
        var item = list[$art_iqryokwa$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objtdditn$art_obj = item.subs, $art_chtsdkopj$art_c = $art_objtdditn$art_obj.length; subIndex < $art_chtsdkopj$art_c; subIndex++) {        var sub = $art_objtdditn$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objtdditn$art_obj = item.subs, $art_chtsdkopj$art_c = $art_objtdditn$art_obj.length; subIndex < $art_chtsdkopj$art_c; subIndex++) {
            var sub = $art_objtdditn$art_obj[subIndex];
