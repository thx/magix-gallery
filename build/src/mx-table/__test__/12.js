...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixqtvqao$art_i = 0, $art_cbqhcipvj$art_c = list.length; $art_ixqtvqao$art_i < $art_cbqhcipvj$art_c; $art_ixqtvqao$art_i++) {    var item = list[$art_ixqtvqao$art_i]%>';
    for (var $art_ixqtvqao$art_i = 0, $art_cbqhcipvj$art_c = list.length; $art_ixqtvqao$art_i < $art_cbqhcipvj$art_c; $art_ixqtvqao$art_i++) {
        var item = list[$art_ixqtvqao$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objixmrxwn$art_obj = item.subs, $art_cydrvsuf$art_c = $art_objixmrxwn$art_obj.length; subIndex < $art_cydrvsuf$art_c; subIndex++) {        var sub = $art_objixmrxwn$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objixmrxwn$art_obj = item.subs, $art_cydrvsuf$art_c = $art_objixmrxwn$art_obj.length; subIndex < $art_cydrvsuf$art_c; subIndex++) {
            var sub = $art_objixmrxwn$art_obj[subIndex];
