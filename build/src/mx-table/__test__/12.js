...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ialbbomti$art_i = 0, $art_clufveaym$art_c = list.length; $art_ialbbomti$art_i < $art_clufveaym$art_c; $art_ialbbomti$art_i++) {    var item = list[$art_ialbbomti$art_i]%>';
    for (var $art_ialbbomti$art_i = 0, $art_clufveaym$art_c = list.length; $art_ialbbomti$art_i < $art_clufveaym$art_c; $art_ialbbomti$art_i++) {
        var item = list[$art_ialbbomti$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objuezfykqf$art_obj = item.subs, $art_cxtgijfrb$art_c = $art_objuezfykqf$art_obj.length; subIndex < $art_cxtgijfrb$art_c; subIndex++) {        var sub = $art_objuezfykqf$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objuezfykqf$art_obj = item.subs, $art_cxtgijfrb$art_c = $art_objuezfykqf$art_obj.length; subIndex < $art_cxtgijfrb$art_c; subIndex++) {
            var sub = $art_objuezfykqf$art_obj[subIndex];
