...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwrbmljpn$art_i = 0, $art_chyslfxuoji$art_c = list.length; $art_iwrbmljpn$art_i < $art_chyslfxuoji$art_c; $art_iwrbmljpn$art_i++) {    var item = list[$art_iwrbmljpn$art_i]%>';
    for (var $art_iwrbmljpn$art_i = 0, $art_chyslfxuoji$art_c = list.length; $art_iwrbmljpn$art_i < $art_chyslfxuoji$art_c; $art_iwrbmljpn$art_i++) {
        var item = list[$art_iwrbmljpn$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objenkeohhpkt$art_obj = item.subs, $art_csfkykk$art_c = $art_objenkeohhpkt$art_obj.length; subIndex < $art_csfkykk$art_c; subIndex++) {        var sub = $art_objenkeohhpkt$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objenkeohhpkt$art_obj = item.subs, $art_csfkykk$art_c = $art_objenkeohhpkt$art_obj.length; subIndex < $art_csfkykk$art_c; subIndex++) {
            var sub = $art_objenkeohhpkt$art_obj[subIndex];
