...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idzaxgfynfq$art_i = 0, $art_carwjyjfsd$art_c = list.length; $art_idzaxgfynfq$art_i < $art_carwjyjfsd$art_c; $art_idzaxgfynfq$art_i++) {    var item = list[$art_idzaxgfynfq$art_i]%>';
    for (var $art_idzaxgfynfq$art_i = 0, $art_carwjyjfsd$art_c = list.length; $art_idzaxgfynfq$art_i < $art_carwjyjfsd$art_c; $art_idzaxgfynfq$art_i++) {
        var item = list[$art_idzaxgfynfq$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objfxkotytag$art_obj = item.subs, $art_clrlfhhtr$art_c = $art_objfxkotytag$art_obj.length; subIndex < $art_clrlfhhtr$art_c; subIndex++) {        var sub = $art_objfxkotytag$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objfxkotytag$art_obj = item.subs, $art_clrlfhhtr$art_c = $art_objfxkotytag$art_obj.length; subIndex < $art_clrlfhhtr$art_c; subIndex++) {
            var sub = $art_objfxkotytag$art_obj[subIndex];
