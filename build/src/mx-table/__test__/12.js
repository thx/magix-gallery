...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikdjbqzxcb$art_i = 0, $art_cnhbbjqw$art_c = list.length; $art_ikdjbqzxcb$art_i < $art_cnhbbjqw$art_c; $art_ikdjbqzxcb$art_i++) {    var item = list[$art_ikdjbqzxcb$art_i]%>';
    for (var $art_ikdjbqzxcb$art_i = 0, $art_cnhbbjqw$art_c = list.length; $art_ikdjbqzxcb$art_i < $art_cnhbbjqw$art_c; $art_ikdjbqzxcb$art_i++) {
        var item = list[$art_ikdjbqzxcb$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objobjvozftr$art_obj = item.subs, $art_crqfzsblsjl$art_c = $art_objobjvozftr$art_obj.length; subIndex < $art_crqfzsblsjl$art_c; subIndex++) {        var sub = $art_objobjvozftr$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objobjvozftr$art_obj = item.subs, $art_crqfzsblsjl$art_c = $art_objobjvozftr$art_obj.length; subIndex < $art_crqfzsblsjl$art_c; subIndex++) {
            var sub = $art_objobjvozftr$art_obj[subIndex];
