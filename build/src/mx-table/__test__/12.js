...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imzkd$art_i = 0, $art_ceqmqliic$art_c = list.length; $art_imzkd$art_i < $art_ceqmqliic$art_c; $art_imzkd$art_i++) {    var item = list[$art_imzkd$art_i]%>';
    for (var $art_imzkd$art_i = 0, $art_ceqmqliic$art_c = list.length; $art_imzkd$art_i < $art_ceqmqliic$art_c; $art_imzkd$art_i++) {
        var item = list[$art_imzkd$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objnuaomqmi$art_obj = item.subs, $art_cytjuvxkzmp$art_c = $art_objnuaomqmi$art_obj.length; subIndex < $art_cytjuvxkzmp$art_c; subIndex++) {        var sub = $art_objnuaomqmi$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objnuaomqmi$art_obj = item.subs, $art_cytjuvxkzmp$art_c = $art_objnuaomqmi$art_obj.length; subIndex < $art_cytjuvxkzmp$art_c; subIndex++) {
            var sub = $art_objnuaomqmi$art_obj[subIndex];
