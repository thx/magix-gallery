...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuaqigxnvq$art_i = 0, $art_ccxicjvnc$art_c = list.length; $art_iuaqigxnvq$art_i < $art_ccxicjvnc$art_c; $art_iuaqigxnvq$art_i++) {    var item = list[$art_iuaqigxnvq$art_i]%>';
    for (var $art_iuaqigxnvq$art_i = 0, $art_ccxicjvnc$art_c = list.length; $art_iuaqigxnvq$art_i < $art_ccxicjvnc$art_c; $art_iuaqigxnvq$art_i++) {
        var item = list[$art_iuaqigxnvq$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objzyelqbq$art_obj = item.subs, $art_cmwbafmy$art_c = $art_objzyelqbq$art_obj.length; subIndex < $art_cmwbafmy$art_c; subIndex++) {        var sub = $art_objzyelqbq$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objzyelqbq$art_obj = item.subs, $art_cmwbafmy$art_c = $art_objzyelqbq$art_obj.length; subIndex < $art_cmwbafmy$art_c; subIndex++) {
            var sub = $art_objzyelqbq$art_obj[subIndex];
