...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuarnumq$art_i = 0, $art_cpdiwfcet$art_c = list.length; $art_iuarnumq$art_i < $art_cpdiwfcet$art_c; $art_iuarnumq$art_i++) {    var item = list[$art_iuarnumq$art_i]%>';
    for (var $art_iuarnumq$art_i = 0, $art_cpdiwfcet$art_c = list.length; $art_iuarnumq$art_i < $art_cpdiwfcet$art_c; $art_iuarnumq$art_i++) {
        var item = list[$art_iuarnumq$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objfcmqbkvt$art_obj = item.subs, $art_ctmdpvg$art_c = $art_objfcmqbkvt$art_obj.length; subIndex < $art_ctmdpvg$art_c; subIndex++) {        var sub = $art_objfcmqbkvt$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objfcmqbkvt$art_obj = item.subs, $art_ctmdpvg$art_c = $art_objfcmqbkvt$art_obj.length; subIndex < $art_ctmdpvg$art_c; subIndex++) {
            var sub = $art_objfcmqbkvt$art_obj[subIndex];
