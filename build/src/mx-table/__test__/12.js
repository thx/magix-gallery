...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixhokwr$art_i = 0, $art_cxnuvtiwyjd$art_c = list.length; $art_ixhokwr$art_i < $art_cxnuvtiwyjd$art_c; $art_ixhokwr$art_i++) {    var item = list[$art_ixhokwr$art_i]%>';
    for (var $art_ixhokwr$art_i = 0, $art_cxnuvtiwyjd$art_c = list.length; $art_ixhokwr$art_i < $art_cxnuvtiwyjd$art_c; $art_ixhokwr$art_i++) {
        var item = list[$art_ixhokwr$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objnohrku$art_obj = item.subs, $art_cwsnkcdnr$art_c = $art_objnohrku$art_obj.length; subIndex < $art_cwsnkcdnr$art_c; subIndex++) {        var sub = $art_objnohrku$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objnohrku$art_obj = item.subs, $art_cwsnkcdnr$art_c = $art_objnohrku$art_obj.length; subIndex < $art_cwsnkcdnr$art_c; subIndex++) {
            var sub = $art_objnohrku$art_obj[subIndex];
