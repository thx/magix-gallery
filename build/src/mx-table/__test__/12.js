...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikpykq$art_i = 0, $art_cqikzvne$art_c = list.length; $art_ikpykq$art_i < $art_cqikzvne$art_c; $art_ikpykq$art_i++) {    var item = list[$art_ikpykq$art_i]%>';
    for (var $art_ikpykq$art_i = 0, $art_cqikzvne$art_c = list.length; $art_ikpykq$art_i < $art_cqikzvne$art_c; $art_ikpykq$art_i++) {
        var item = list[$art_ikpykq$art_i];
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objidevwpdh$art_obj = item.subs, $art_cyxzzaiai$art_c = $art_objidevwpdh$art_obj.length; subIndex < $art_cyxzzaiai$art_c; subIndex++) {        var sub = $art_objidevwpdh$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objidevwpdh$art_obj = item.subs, $art_cyxzzaiai$art_c = $art_objidevwpdh$art_obj.length; subIndex < $art_cyxzzaiai$art_c; subIndex++) {
            var sub = $art_objidevwpdh$art_obj[subIndex];
