...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryd,:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryd,:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryd,:_" class="mb10 lh22 clearfix"><div class="fl color-9">该示例：</div><div class="fl"><div>筛选项同表头一起吸顶</div><div>表头的吸顶逻辑是表格可见时吸顶，筛选项的吸顶逻辑同表头，筛选项吸顶时注意预留筛选项的占位符</div><div>筛选项的吸顶功能请自行控制，表格上设置&nbsp;<span class="color-brand">sticky-interval</span>&nbsp;预留吸顶空白</div><div>sticky-interval 只在 sticky == true && scroll-wrapper == window时生效</div></div></div><div id="';
    $line = 12;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_table"><div><table mxa="_zs_galleryd,:b" class="table" left="true"><thead><tr>';
    $line = 28;
    ...
    for (var j = 0; j < (page * 5); j++) {
        ...
        ;
        $p += '</tr><tr mxs="_zs_galleryd,:a" class="operation-tr"><td colspan="4"><a href="javascript:;" class="btn btn-white btn-small mr10">操作</a><a href="javascript:;" class="btn btn-white btn-small">操作</a></td></tr>';
        $line = 46;
        $art = '/for';
        ;
        $expr = '<%}%>';
    ...
    for (var j = 0; j < (page * 5); j++) {
        ...
        ;
        $p += '</tr><tr mxs="_zs_galleryd,:b" class="operation-tr"><td colspan="10"></td></tr>';
        $line = 67;
        $art = '/for';
        ;
        $expr = '<%}%>';
