...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryed:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryed:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryed:_" class="mb10 lh22 clearfix"><div class="fl color-9">该示例：</div><div class="fl"><div>筛选项同表头一起吸顶</div><div>表头的吸顶逻辑是表格可见时吸顶，筛选项的吸顶逻辑同表头，筛选项吸顶时注意预留筛选项的占位符</div><div>筛选项的吸顶功能请自行控制，表格上设置&nbsp;<span class="color-brand">sticky-interval</span>&nbsp;预留吸顶空白</div><div>sticky-interval 只在 sticky == true && scroll-wrapper == window时生效</div></div></div><div id="';
    $line = 12;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_table"><div><table mxa="_zs_galleryed:b" class="table" left="true"><thead><tr>';
    $line = 28;
    ...
    for (var i = 0; i < 4; i++) {
        ;
        $p += '<th mxa="_zs_galleryed:c" width="120">固定字段';
        $line = 29;
        $art = '=i';
        ;
        $p += ($expr = '<%=i%>', $e(i)) + '</th>';
    ...
    ;
    $p += '</tbody></table></div><div><table mxa="_zs_galleryed:d" class="table" center="true"><thead><tr>';
    $line = 52;
    ...
    for (var i = 0; i < 10; i++) {
        ;
        $p += '<th mxa="_zs_galleryed:e" width="120">滚动';
        $line = 53;
        $art = '=i';
        ;
        $p += ($expr = '<%=i%>', $e(i)) + '</th>';
