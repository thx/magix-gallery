...
module.exports = Base.extend({
    ...
    for (var j = 0; j < (page * 5); j++) {
        ...
        ;
        $p += '</tr><tr mxs="_zs_gallerydf:a" class="operation-tr"><td colspan="4"><a href="javascript:;" class="btn btn-small mr10">操作</a><a href="javascript:;" class="btn btn-small">操作</a></td></tr>';
        $line = 46;
        $art = '/for';
        ;
        $expr = '<%}%>';
