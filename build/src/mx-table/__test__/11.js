...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydJ:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydJ:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydJ:_" class="mb20 clearfix lh22"><span class="color-9">普通表格：</span><span>加class="table"，样式与组件一致，没有默认选中逻辑</span></div><div mxa="_zs_gallerydJ:b" class="mb20"><table mxa="_zs_gallerydJ:c" class="table"><thead><tr>';
    $line = 11;
    ...
    ;
    $p += '</tbody></table></div></div><div mxa="_zs_gallerydJ:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydJ:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 36;
    $art = '=viewId';
    ;
