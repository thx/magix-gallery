...
module.exports = Magix.View.extend({
    ...
    $art = '@[{\n        name: \'自定义吸顶容器\',\n        key: viewId + \'_1\'\n    }, {\n        name: \'相对于window吸顶\',\n        key: viewId + \'_2\'\n    }]';
    ;
    $p += ($expr = '<%@[{            name: \'自定义吸顶容器\',            key: viewId + \'_1\'        }, {            name: \'相对于window吸顶\',            key: viewId + \'_2\'        }]%>', $i($$ref, [{ name: '自定义吸顶容器', key: viewId + '_1' }, { name: '相对于window吸顶', key: viewId + '_2' }])) + '"></div><div mxs="_zs_galleryd6:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mx-view="mx-table/__test__/13" id="';
    $line = 11;
    $art = '=viewId';
    ;
