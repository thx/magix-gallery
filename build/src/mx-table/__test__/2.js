...
module.exports = Base.extend({
    ...
    for (var j = 0; j < 3; j++) {
        ...
        ;
        $p += '</tr><tr mxs="_zs_galleryer:a" class="operation-tr"><td colspan="5"><a href="javascript:;" class="btn btn-white btn-small mr10">操作</a><a href="javascript:;" class="btn btn-white btn-small mr10">操作</a><a href="javascript:;" class="btn btn-white btn-small">操作</a></td></tr>';
        $line = 30;
        $art = '/for';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '</tbody></table></div></div></div><div mxa="_zs_galleryer:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryer:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 37;
    $art = '=viewId';
    ;
