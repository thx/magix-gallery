...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycs:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycs:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycs:_" class="mb20"><span class="color-9">该示例：</span>默认展开第一行下方操作项 + 选中行展示操作项</div><div mxa="_zs_gallerycs:b" mx-view="mx-table/index" class="mb20"><div><table mxa="_zs_gallerycs:c" class="table"><thead><tr>';
    $line = 11;
    ...
    for (var j = 0; j < 3; j++) {
        ...
        ;
        $p += '</tr><tr mxs="_zs_gallerycs:a" class="operation-tr"><td colspan="5"><a href="javascript:;" class="btn btn-small mr10">操作</a><a href="javascript:;" class="btn btn-small mr10">操作</a><a href="javascript:;" class="btn btn-small">操作</a></td></tr>';
        $line = 30;
        $art = '/for';
        ;
        $p += '';
    ...
    ;
    $p += '</tbody></table></div></div></div><div mxa="_zs_gallerycs:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycs:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 37;
    $art = '=viewId';
    ;
