...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydT:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydT:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydT:_" class="mb20 clearfix lh22"><div class="color-9 fl">以下示例：</div><div class="fl"><div>设置5列一页</div><div>开头固定2列，结尾固定2列</div><div>默认在第二页</div></div></div><div mxa="_zs_gallerydT:b" class="mb20"><div mxa="_zs_gallerydT:c" mx-view="mx-table/rwd?rwdRange=2%2C-2&rwdLimit=5&rwdCurrent=2"><table mxa="_zs_gallerydT:d" class="table"><thead><tr>';
    $line = 16;
