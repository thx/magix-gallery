...
module.exports = Base.extend({
    ...
    ;
    $p += '</tbody></table></div></div><div mxs="_zs_gallerycQ:c" class="table-pager-wrapper mb40"><div mx-view="mx-pagination/index?total=100&size=40&page=1"></div></div></div><div mxa="_zs_gallerycQ:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycQ:d" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 66;
    $art = '=viewId';
    ;
