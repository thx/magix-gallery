...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycV:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycV:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycV:_" class="mb20"><span class="color-9">该示例：</span>分栏 + 吸顶 + 宽度配置在th上 + 分页（单独写，不需要关心colspan）</div><div mxa="_zs_gallerycV:b" mx-view="mx-table/index?sticky=true"><div><table mxa="_zs_gallerycV:c" class="table" left="true"><thead><tr>';
    $line = 12;
    ...
    ;
    $p += '</tbody></table></div></div><div mxs="_zs_gallerycV:c" class="table-pager-wrapper mb40"><div mx-view="mx-pagination/index?total=100&size=40&page=1"></div></div></div><div mxa="_zs_gallerycV:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycV:d" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 66;
    $art = '=viewId';
    ;
