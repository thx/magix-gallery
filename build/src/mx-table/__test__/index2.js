...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxs="_zs_galleryb+:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_galleryb+:a" mx-view="mx-table/__test__/7"></div><div mxs="_zs_galleryb+:b" mx-view="mx-table/__test__/6"></div>';
}
catch (ex) {
