...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iidbwdjs$art_i = 0, $art_cjcfcxlh$art_c = rows.length; $art_iidbwdjs$art_i < $art_cjcfcxlh$art_c; $art_iidbwdjs$art_i++) {    var row = rows[$art_iidbwdjs$art_i]%>';
    for (var $art_iidbwdjs$art_i = 0, $art_cjcfcxlh$art_c = rows.length; $art_iidbwdjs$art_i < $art_cjcfcxlh$art_c; $art_iidbwdjs$art_i++) {
        var row = rows[$art_iidbwdjs$art_i];
        $p += ' ';
        $line = 152;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_iiqwjaed$art_i = 0, $art_csvowhbzsx$art_c = row.length; $art_iiqwjaed$art_i < $art_csvowhbzsx$art_c; $art_iiqwjaed$art_i++) {        var cell = row[$art_iiqwjaed$art_i]%>';
        for (var $art_iiqwjaed$art_i = 0, $art_csvowhbzsx$art_c = row.length; $art_iiqwjaed$art_i < $art_csvowhbzsx$art_c; $art_iiqwjaed$art_i++) {
            var cell = row[$art_iiqwjaed$art_i];
