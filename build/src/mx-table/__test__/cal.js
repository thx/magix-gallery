...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwwxjugvsq$art_i = 0, $art_czaziyiam$art_c = rows.length; $art_iwwxjugvsq$art_i < $art_czaziyiam$art_c; $art_iwwxjugvsq$art_i++) {    var row = rows[$art_iwwxjugvsq$art_i]%>';
    for (var $art_iwwxjugvsq$art_i = 0, $art_czaziyiam$art_c = rows.length; $art_iwwxjugvsq$art_i < $art_czaziyiam$art_c; $art_iwwxjugvsq$art_i++) {
        var row = rows[$art_iwwxjugvsq$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_iqxceacr$art_i = 0, $art_cemexzzgkf$art_c = row.length; $art_iqxceacr$art_i < $art_cemexzzgkf$art_c; $art_iqxceacr$art_i++) {        var cell = row[$art_iqxceacr$art_i]%>';
        for (var $art_iqxceacr$art_i = 0, $art_cemexzzgkf$art_c = row.length; $art_iqxceacr$art_i < $art_cemexzzgkf$art_c; $art_iqxceacr$art_i++) {
            var cell = row[$art_iqxceacr$art_i];
