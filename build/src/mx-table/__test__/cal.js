...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izuyngzxk$art_i = 0, $art_cplqkowxic$art_c = rows.length; $art_izuyngzxk$art_i < $art_cplqkowxic$art_c; $art_izuyngzxk$art_i++) {    var row = rows[$art_izuyngzxk$art_i]%>';
    for (var $art_izuyngzxk$art_i = 0, $art_cplqkowxic$art_c = rows.length; $art_izuyngzxk$art_i < $art_cplqkowxic$art_c; $art_izuyngzxk$art_i++) {
        var row = rows[$art_izuyngzxk$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_icllemipha$art_i = 0, $art_calqwfxdut$art_c = row.length; $art_icllemipha$art_i < $art_calqwfxdut$art_c; $art_icllemipha$art_i++) {        var cell = row[$art_icllemipha$art_i]%>';
        for (var $art_icllemipha$art_i = 0, $art_calqwfxdut$art_c = row.length; $art_icllemipha$art_i < $art_calqwfxdut$art_c; $art_icllemipha$art_i++) {
            var cell = row[$art_icllemipha$art_i];
