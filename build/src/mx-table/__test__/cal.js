...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itihvg$art_i = 0, $art_cwmncwlz$art_c = rows.length; $art_itihvg$art_i < $art_cwmncwlz$art_c; $art_itihvg$art_i++) {    var row = rows[$art_itihvg$art_i]%>';
    for (var $art_itihvg$art_i = 0, $art_cwmncwlz$art_c = rows.length; $art_itihvg$art_i < $art_cwmncwlz$art_c; $art_itihvg$art_i++) {
        var row = rows[$art_itihvg$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_idwqxmeb$art_i = 0, $art_cnddbsruw$art_c = row.length; $art_idwqxmeb$art_i < $art_cnddbsruw$art_c; $art_idwqxmeb$art_i++) {        var cell = row[$art_idwqxmeb$art_i]%>';
        for (var $art_idwqxmeb$art_i = 0, $art_cnddbsruw$art_c = row.length; $art_idwqxmeb$art_i < $art_cnddbsruw$art_c; $art_idwqxmeb$art_i++) {
            var cell = row[$art_idwqxmeb$art_i];
