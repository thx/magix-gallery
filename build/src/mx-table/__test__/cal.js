...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irwsazzod$art_i = 0, $art_cnhlkqetwi$art_c = rows.length; $art_irwsazzod$art_i < $art_cnhlkqetwi$art_c; $art_irwsazzod$art_i++) {    var row = rows[$art_irwsazzod$art_i]%>';
    for (var $art_irwsazzod$art_i = 0, $art_cnhlkqetwi$art_c = rows.length; $art_irwsazzod$art_i < $art_cnhlkqetwi$art_c; $art_irwsazzod$art_i++) {
        var row = rows[$art_irwsazzod$art_i];
        $p += ' ';
        $line = 152;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_ityeidhilkk$art_i = 0, $art_cekfhlb$art_c = row.length; $art_ityeidhilkk$art_i < $art_cekfhlb$art_c; $art_ityeidhilkk$art_i++) {        var cell = row[$art_ityeidhilkk$art_i]%>';
        for (var $art_ityeidhilkk$art_i = 0, $art_cekfhlb$art_c = row.length; $art_ityeidhilkk$art_i < $art_cekfhlb$art_c; $art_ityeidhilkk$art_i++) {
            var cell = row[$art_ityeidhilkk$art_i];
