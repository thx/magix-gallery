...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inzcttuiqfm$art_i = 0, $art_cfekudf$art_c = rows.length; $art_inzcttuiqfm$art_i < $art_cfekudf$art_c; $art_inzcttuiqfm$art_i++) {    var row = rows[$art_inzcttuiqfm$art_i]%>';
    for (var $art_inzcttuiqfm$art_i = 0, $art_cfekudf$art_c = rows.length; $art_inzcttuiqfm$art_i < $art_cfekudf$art_c; $art_inzcttuiqfm$art_i++) {
        var row = rows[$art_inzcttuiqfm$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_iuxhzj$art_i = 0, $art_cvzahapqi$art_c = row.length; $art_iuxhzj$art_i < $art_cvzahapqi$art_c; $art_iuxhzj$art_i++) {        var cell = row[$art_iuxhzj$art_i]%>';
        for (var $art_iuxhzj$art_i = 0, $art_cvzahapqi$art_c = row.length; $art_iuxhzj$art_i < $art_cvzahapqi$art_c; $art_iuxhzj$art_i++) {
            var cell = row[$art_iuxhzj$art_i];
