...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwedfaeanxe$art_i = 0, $art_cubyfnpe$art_c = rows.length; $art_iwedfaeanxe$art_i < $art_cubyfnpe$art_c; $art_iwedfaeanxe$art_i++) {    var row = rows[$art_iwedfaeanxe$art_i]%>';
    for (var $art_iwedfaeanxe$art_i = 0, $art_cubyfnpe$art_c = rows.length; $art_iwedfaeanxe$art_i < $art_cubyfnpe$art_c; $art_iwedfaeanxe$art_i++) {
        var row = rows[$art_iwedfaeanxe$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_igvvrwfzh$art_i = 0, $art_cwktqmmgerj$art_c = row.length; $art_igvvrwfzh$art_i < $art_cwktqmmgerj$art_c; $art_igvvrwfzh$art_i++) {        var cell = row[$art_igvvrwfzh$art_i]%>';
        for (var $art_igvvrwfzh$art_i = 0, $art_cwktqmmgerj$art_c = row.length; $art_igvvrwfzh$art_i < $art_cwktqmmgerj$art_c; $art_igvvrwfzh$art_i++) {
            var cell = row[$art_igvvrwfzh$art_i];
