...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iazkersafl$art_i = 0, $art_cfacngfpzs$art_c = rows.length; $art_iazkersafl$art_i < $art_cfacngfpzs$art_c; $art_iazkersafl$art_i++) {    var row = rows[$art_iazkersafl$art_i]%>';
    for (var $art_iazkersafl$art_i = 0, $art_cfacngfpzs$art_c = rows.length; $art_iazkersafl$art_i < $art_cfacngfpzs$art_c; $art_iazkersafl$art_i++) {
        var row = rows[$art_iazkersafl$art_i];
        $p += ' ';
        $line = 152;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_ijiwgxrs$art_i = 0, $art_cssuoslyiai$art_c = row.length; $art_ijiwgxrs$art_i < $art_cssuoslyiai$art_c; $art_ijiwgxrs$art_i++) {        var cell = row[$art_ijiwgxrs$art_i]%>';
        for (var $art_ijiwgxrs$art_i = 0, $art_cssuoslyiai$art_c = row.length; $art_ijiwgxrs$art_i < $art_cssuoslyiai$art_c; $art_ijiwgxrs$art_i++) {
            var cell = row[$art_ijiwgxrs$art_i];
