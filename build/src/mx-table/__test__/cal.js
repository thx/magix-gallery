...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iuuiewyfwgf$art_i = 0, $art_czknmpekp$art_c = rows.length; $art_iuuiewyfwgf$art_i < $art_czknmpekp$art_c; $art_iuuiewyfwgf$art_i++) {    var row = rows[$art_iuuiewyfwgf$art_i]%>';
    for (var $art_iuuiewyfwgf$art_i = 0, $art_czknmpekp$art_c = rows.length; $art_iuuiewyfwgf$art_i < $art_czknmpekp$art_c; $art_iuuiewyfwgf$art_i++) {
        var row = rows[$art_iuuiewyfwgf$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_irlhoql$art_i = 0, $art_cioumaiv$art_c = row.length; $art_irlhoql$art_i < $art_cioumaiv$art_c; $art_irlhoql$art_i++) {        var cell = row[$art_irlhoql$art_i]%>';
        for (var $art_irlhoql$art_i = 0, $art_cioumaiv$art_c = row.length; $art_irlhoql$art_i < $art_cioumaiv$art_c; $art_irlhoql$art_i++) {
            var cell = row[$art_irlhoql$art_i];
