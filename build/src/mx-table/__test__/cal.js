...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imqkolje$art_i = 0, $art_cdwaqhjb$art_c = rows.length; $art_imqkolje$art_i < $art_cdwaqhjb$art_c; $art_imqkolje$art_i++) {    var row = rows[$art_imqkolje$art_i]%>';
    for (var $art_imqkolje$art_i = 0, $art_cdwaqhjb$art_c = rows.length; $art_imqkolje$art_i < $art_cdwaqhjb$art_c; $art_imqkolje$art_i++) {
        var row = rows[$art_imqkolje$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_iiaqnjxa$art_i = 0, $art_cbcfghlign$art_c = row.length; $art_iiaqnjxa$art_i < $art_cbcfghlign$art_c; $art_iiaqnjxa$art_i++) {        var cell = row[$art_iiaqnjxa$art_i]%>';
        for (var $art_iiaqnjxa$art_i = 0, $art_cbcfghlign$art_c = row.length; $art_iiaqnjxa$art_i < $art_cbcfghlign$art_c; $art_iiaqnjxa$art_i++) {
            var cell = row[$art_iiaqnjxa$art_i];
