...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igspomaaue$art_i = 0, $art_cscnfaveyk$art_c = rows.length; $art_igspomaaue$art_i < $art_cscnfaveyk$art_c; $art_igspomaaue$art_i++) {    var row = rows[$art_igspomaaue$art_i]%>';
    for (var $art_igspomaaue$art_i = 0, $art_cscnfaveyk$art_c = rows.length; $art_igspomaaue$art_i < $art_cscnfaveyk$art_c; $art_igspomaaue$art_i++) {
        var row = rows[$art_igspomaaue$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_ihqdugofmrv$art_i = 0, $art_cbvdmlfu$art_c = row.length; $art_ihqdugofmrv$art_i < $art_cbvdmlfu$art_c; $art_ihqdugofmrv$art_i++) {        var cell = row[$art_ihqdugofmrv$art_i]%>';
        for (var $art_ihqdugofmrv$art_i = 0, $art_cbvdmlfu$art_c = row.length; $art_ihqdugofmrv$art_i < $art_cbvdmlfu$art_c; $art_ihqdugofmrv$art_i++) {
            var cell = row[$art_ihqdugofmrv$art_i];
