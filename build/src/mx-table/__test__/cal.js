...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itjqvwhfc$art_i = 0, $art_ceigkvet$art_c = rows.length; $art_itjqvwhfc$art_i < $art_ceigkvet$art_c; $art_itjqvwhfc$art_i++) {    var row = rows[$art_itjqvwhfc$art_i]%>';
    for (var $art_itjqvwhfc$art_i = 0, $art_ceigkvet$art_c = rows.length; $art_itjqvwhfc$art_i < $art_ceigkvet$art_c; $art_itjqvwhfc$art_i++) {
        var row = rows[$art_itjqvwhfc$art_i];
        $p += ' ';
        $line = 152;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_izopltm$art_i = 0, $art_cmxpzycm$art_c = row.length; $art_izopltm$art_i < $art_cmxpzycm$art_c; $art_izopltm$art_i++) {        var cell = row[$art_izopltm$art_i]%>';
        for (var $art_izopltm$art_i = 0, $art_cmxpzycm$art_c = row.length; $art_izopltm$art_i < $art_cmxpzycm$art_c; $art_izopltm$art_i++) {
            var cell = row[$art_izopltm$art_i];
