...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iufwmngzu$art_i = 0, $art_cxadaldv$art_c = rows.length; $art_iufwmngzu$art_i < $art_cxadaldv$art_c; $art_iufwmngzu$art_i++) {    var row = rows[$art_iufwmngzu$art_i]%>';
    for (var $art_iufwmngzu$art_i = 0, $art_cxadaldv$art_c = rows.length; $art_iufwmngzu$art_i < $art_cxadaldv$art_c; $art_iufwmngzu$art_i++) {
        var row = rows[$art_iufwmngzu$art_i];
        $p += ' ';
        $line = 151;
        $art = 'each row as cell';
        ;
        $expr = '<%for (var $art_ieeamdris$art_i = 0, $art_cpsrffmhn$art_c = row.length; $art_ieeamdris$art_i < $art_cpsrffmhn$art_c; $art_ieeamdris$art_i++) {        var cell = row[$art_ieeamdris$art_i]%>';
        for (var $art_ieeamdris$art_i = 0, $art_cpsrffmhn$art_c = row.length; $art_ieeamdris$art_i < $art_cpsrffmhn$art_c; $art_ieeamdris$art_i++) {
            var cell = row[$art_ieeamdris$art_i];
