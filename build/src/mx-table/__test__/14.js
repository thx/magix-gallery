...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_czmvdb$art_c = list.length; index < $art_czmvdb$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_czmvdb$art_c = list.length; index < $art_czmvdb$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 31;
