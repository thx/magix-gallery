...
module.exports = Base.extend({
    ...
    if (selected.length > 0) {
        ;
        $p += '<span mxs="_zs_galleryc9:b" class="color-9">当前选中：</span>';
        $line = 14;
        $art = '=selected';
        ;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_galleryc9:c" mx-view="mx-table/index?sticky=true"><div mxv><table mxv mxa="_zs_galleryc9:d" class="table"><thead mxv><tr mxv><th mxv mxa="_zs_galleryc9:e" width="50"><input mxs="_zs_galleryc9:c" type="checkbox" class="checkbox" linkage="example"/></th><th mxs="_zs_galleryc9:d" width="200">列1</th><th mxs="_zs_galleryc9:e" width="200">列2</th><th mxs="_zs_galleryc9:f" width="200">列3</th></tr></thead><tbody mxv>';
    $line = 30;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cawgqraafqe$art_c = list.length; index < $art_cawgqraafqe$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cawgqraafqe$art_c = list.length; index < $art_cawgqraafqe$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 31;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryc9:h" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 113;
    $art = '=viewId';
    ;
