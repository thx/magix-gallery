...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycS:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerycS:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycS:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl"><div>mixins[mx-checkbox/storestate]和[mx-checkbox/linkage]</div><div>部分禁止选择，翻页保存选中值</div><div>需要的时候调用this.getStoreState获取选中值</div></div></div><div mxa="_zs_gallerycS:b" class="mb20"><a mxs="_zs_gallerycS:a" href="javascript:;" mx-click="' + $viewId + 'get()" class="btn btn-brand mr20">获取选中值</a>';
    $line = 13;
    ...
    if (selected.length > 0) {
        ;
        $p += '<span mxs="_zs_gallerycS:b" class="color-9">当前选中：</span>';
        $line = 14;
        $art = '=selected';
        ;
    ...
    ;
    $p += '</div><div mxv mxa="_zs_gallerycS:c" mx-view="mx-table/index?sticky=true"><div mxv><table mxv mxa="_zs_gallerycS:d" class="table"><thead mxv><tr mxv><th mxv mxa="_zs_gallerycS:e" width="50"><input mxs="_zs_gallerycS:c" type="checkbox" class="checkbox" linkage="example"/></th><th mxs="_zs_gallerycS:d" width="200">列1</th><th mxs="_zs_gallerycS:e" width="200">列2</th><th mxs="_zs_gallerycS:f" width="200">列3</th></tr></thead><tbody mxv>';
    $line = 30;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cfkpdaoyl$art_c = list.length; index < $art_cfkpdaoyl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cfkpdaoyl$art_c = list.length; index < $art_cfkpdaoyl$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv class="';
        $line = 31;
    ...
    ;
    $p += '</tbody></table></div></div><div mxa="_zs_gallerycS:f" class="table-pager-wrapper"><div mx-change="' + $viewId + 'changePager()" mx-view="mx-pagination/index?total=';
    $line = 48;
    $art = '=total';
    ;
    ...
    $art = '=page';
    ;
    $p += ($expr = '<%!$eu(page)%>', $eu(page)) + '"></div></div></div><div mxa="_zs_gallerycS:g" class="clearfix"><div mxa="_zs_gallerycS:h" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerycS:g" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 57;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_gallerycS:h" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 113;
    $art = '=viewId';
    ;
