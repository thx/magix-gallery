...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_ctrsgvenq$art_c = list.length; index < $art_ctrsgvenq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_ctrsgvenq$art_c = list.length; index < $art_ctrsgvenq$art_c; index++) {
        var item = list[index];
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryec:i" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 112;
    $art = '=viewId';
    ;
