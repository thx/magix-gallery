...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_galleryeo:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryeo:a" class="clearfix mb20"><div mx-view="mx-table/__test__/14" id="';
    $line = 26;
    $art = '=viewId';
    ;
