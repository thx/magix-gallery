...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_wrapper"><div><table mxa="_zs_gallerydI:b" class="table" left="true"><thead><tr>';
    $line = 16;
    ...
    for (var i = 0; i < 4; i++) {
        ;
        $p += '<th mxa="_zs_gallerydI:c" width="120">固定字段';
        $line = 17;
        $art = '=i';
        ;
        $p += ($expr = '<%=i%>', $e(i)) + '</th>';
    ...
    ;
    $p += '</tbody></table></div><div><table mxa="_zs_gallerydI:d" class="table" center="true"><thead><tr>';
    $line = 35;
    ...
    for (var i = 0; i < 10; i++) {
        ;
        $p += '<th mxa="_zs_gallerydI:e" width="120">滚动';
        $line = 36;
        $art = '=i';
        ;
        $p += ($expr = '<%=i%>', $e(i)) + '</th>';
    ...
    ;
    $p += '</tbody></table></div></div></div></div><div mxa="_zs_gallerydI:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydI:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 55;
    $art = '=viewId';
    ;
