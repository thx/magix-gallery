...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydO:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydO:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydO:_" class="mb20 lh22 clearfix"><div class="color-9 fl">以下示例：</div><div class="fl"><div>配置自定义吸顶相对的容器 scroll-wrapper="{=id}}"</div><div>适用场景：浮层内表头固定</div><div>父容器宽高度限定</div></div></div><div id="';
    $line = 11;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_wrapper"><div><table mxa="_zs_gallerydO:b" class="table" left="true"><thead><tr>';
    $line = 16;
    ...
    ;
    $p += '</tbody></table></div></div></div></div><div mxa="_zs_gallerydO:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydO:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 55;
    $art = '=viewId';
    ;
