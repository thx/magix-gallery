...
module.exports = Base.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_wrapper"><div><table mxa="_zs_gallerydh:b" class="table" left="true"><thead><tr>';
    $line = 16;
    ...
    ;
    $p += '</tbody></table></div></div></div></div><div mxa="_zs_gallerydh:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydh:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 55;
    $art = '=viewId';
    ;
