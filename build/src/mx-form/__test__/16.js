...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybj:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybj:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybj:b" class="clearfix mb20"><span mxs="_zs_gallerybj:_" class="color-9 mr20">节点1：</span><input class="input w240 mr20" placeholder="节点1" id="';
    $line = 5;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_1" value="1"/><span mxs="_zs_gallerybj:a" class="color-9 mr20">节点2：</span><input class="input w240" placeholder="节点2" id="';
    $line = 7;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_2" value="2"/></div><div mxv mxa="_zs_gallerybj:c" class="mb20"><span mxs="_zs_gallerybj:b" class="color-9 mr20" style="opacity: 0;">节点3：</span><input mxe="' + $viewId + '_0" mxc="[';
    $line = 12;
    ...
    $art = ':name{unequalto:viewId + \'_1,\' + viewId + \'_2\'}';
    ;
    $p += ($expr = '<%=name%>', $e(name)) + '"/><span mxs="_zs_gallerybj:c" class="color-9 mr20" style="opacity: 0;">节点4：</span><input mxe="' + $viewId + '_1" mxc="[';
    $line = 15;
