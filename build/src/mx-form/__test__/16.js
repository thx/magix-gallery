...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybv:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybv:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybv:b" class="clearfix mb20"><span mxs="_zs_gallerybv:_" class="color-9 mr20">节点1：</span><input class="input w240 mr20" placeholder="节点1" id="';
    $line = 5;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_1" value="1"/><span mxs="_zs_gallerybv:a" class="color-9 mr20">节点2：</span><input class="input w240" placeholder="节点2" id="';
    $line = 7;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_2" value="2"/></div><div mxv mxa="_zs_gallerybv:c" class="mb20"><span mxs="_zs_gallerybv:b" class="color-9 mr20" style="opacity: 0;">节点3：</span><input mxe="' + $viewId + '_0" mxc="[';
    $line = 12;
    ...
    $art = ':name{unequalto:viewId + \'_1,\' + viewId + \'_2\'}';
    ;
    $p += ($expr = '<%=name%>', $e(name)) + '"/><span mxs="_zs_gallerybv:c" class="color-9 mr20" style="opacity: 0;">节点4：</span><input mxe="' + $viewId + '_1" mxc="[';
    $line = 15;
    ...
    $art = ':name{unequalto:[viewId + \'_1,\' + viewId + \'_2\',\'不要输入重复的内容\']}';
    ;
    $p += ($expr = '<%=name%>', $e(name)) + '"/></div></div><div mxa="_zs_gallerybv:d" class="clearfix"><div mxa="_zs_gallerybv:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerybv:d" class="_zs_gallery___test___layout_-eg-title">与某个节点的结果不重复</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 21;
    $art = '=viewId';
    ;
