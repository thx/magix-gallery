...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya,:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerya,:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerya,:b" class="mb20"><span mxs="_zs_gallerya,:_" class="color-9 mr20">dropdown必选（请选择为空状态提示）：</span><div mxv="day" mxe="' + $viewId + '_0" mxc="[';
    $line = 7;
