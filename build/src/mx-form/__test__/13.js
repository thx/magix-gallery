...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb9:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb9:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_galleryb9:b" class="mb20"><span mxs="_zs_galleryb9:_" class="color-9 mr20">dropdown必选（请选择为空状态提示）：</span><div mxv="day" mxe="' + $viewId + '_0" mxc="[';
    $line = 7;
    ...
    $art = ':day{required:true}';
    ;
    $p += ($expr = '<%@day%>', $i($$ref, day)) + '"><i mxs="_zs_galleryb9:a" value="1" class="none">1</i><i mxs="_zs_galleryb9:b" value="2" class="none">2</i></div></div></div><div mxa="_zs_galleryb9:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb9:c" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
