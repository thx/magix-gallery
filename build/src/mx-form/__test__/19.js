...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybL:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybL:a" class="_zs_gallery___test___layout_-eg-content clearfix"><div mxs="_zs_gallerybL:_" class="mb10 lh22"><div>class：small-form（margin-bottom:20px）；align-right（文字右对齐）</div></div><form mxv mxa="_zs_gallerybL:b" class="form small-form align-right"><div mxv mxa="_zs_gallerybL:c" class="form-item"><div mxs="_zs_gallerybL:a" class="form-label">请输入</div><div mxv mxa="_zs_gallerybL:d" class="form-content"><input mxs="_zs_gallerybL:b" class="input w200"/></div></div><div mxv mxa="_zs_gallerybL:e" class="form-item"><div mxs="_zs_gallerybL:c" class="form-label">右对齐输入框</div><div mxv mxa="_zs_gallerybL:f" class="form-content"><input mxs="_zs_gallerybL:b" class="input w200"/></div></div><div mxs="_zs_gallerybL:d" class="form-footer"><a href="javascript:;" class="btn w80 btn-brand mr20" mx-click="' + $viewId + 'confirm()">确定</a><a href="javascript:;" class="btn w80">取消</a></div></form></div><div mxa="_zs_gallerybL:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybL:e" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 28;
    $art = '=viewId';
    ;
