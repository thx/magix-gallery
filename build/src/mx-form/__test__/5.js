...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybo:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybo:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybo:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':number{maxlength:[3,\'自定义提示，最多三个字\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div></div><div mxa="_zs_gallerybo:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybo:_" class="_zs_gallery___test___layout_-eg-title">字个数</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
