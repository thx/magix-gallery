...
module.exports = Base.extend({
    ...
    $art = ':number{maxlength:[3,\'自定义提示，最多三个字\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div></div><div mxa="_zs_gallerybz:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybz:_" class="_zs_gallery___test___layout_-eg-title">字个数</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
