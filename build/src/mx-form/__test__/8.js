...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb9:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb9:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_galleryb9:b" class="clearfix"><input class="input mr20 mb20" placeholder="节点1" id="';
    $line = 4;
    $art = '=id';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryb9:a" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 35;
    $art = '=viewId';
    ;
