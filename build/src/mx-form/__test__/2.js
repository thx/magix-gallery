...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybM:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybM:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybM:b" class="mb20"><span mxs="_zs_gallerybM:_" class="color-9 mr20">必填项：</span><input mxe="' + $viewId + '_0" mxc="[';
    $line = 5;
