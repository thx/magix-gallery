...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya3:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya3:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya3:b" class="mb20"><span mxs="_zs_gallerya3:_" class="color-9 mr20">必填项：</span><input mxe="' + $viewId + '_0" mxc="[';
    $line = 5;
    ...
    $art = ':name{placement:\'left\',required:true}';
    ;
    $p += '' + ($expr = '<%=name%>', $e(name)) + '"/></div></div><div mxa="_zs_gallerya3:c" class="clearfix"><div mxa="_zs_gallerya3:d" class="_zs_gallery___test___base_-eg-desc _zs_gallery___test___base_-half"><div mxs="_zs_gallerya3:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 13;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerya3:e" class="_zs_gallery___test___base_-desc-tip">';
    $line = 15;
    $art = '!text1';
    ;
