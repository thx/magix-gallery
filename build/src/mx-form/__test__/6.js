...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybg:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybg:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybg:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':number{bmaxlength:3}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div></div><div mxa="_zs_gallerybg:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybg:_" class="_zs_gallery___test___layout_-eg-title">字符个数（一个汉字两个字符）</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
