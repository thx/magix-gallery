...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaZ:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_galleryaZ:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_galleryaZ:b" class="mb20"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    $art = ':url{url:true}';
    ;
    ...
    $art = ':chinese{chinese:true}';
    ;
    $p += '' + ($expr = '<%=chinese%>', $e(chinese)) + '"/></div><div mxv mxa="_zs_galleryaZ:c" class="mb20"><input mxe="' + $viewId + '_3" mxc="[';
    $line = 9;
    ...
    $art = ':currency{currency:true}';
    ;
    $p += '' + ($expr = '<%=currency%>', $e(currency)) + '"/></div></div><div mxa="_zs_galleryaZ:d" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryaZ:_" class="_zs_gallery___test___base_-eg-title">字个数</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryaZ:e" class="_zs_gallery___test___base_-desc-tip">';
    $line = 17;
    $art = '!text1';
    ;
    $p += '' + ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryaZ:a" class="mc-iconfont _zs_gallery___test___base_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 20;
    $art = '=viewId';
    ;
