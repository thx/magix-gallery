...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaW:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_galleryaW:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_galleryaW:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    $art = ':url{url:true}';
    ;
    ...
    $art = ':currency{currency:true}';
    ;
    $p += '' + ($expr = '<%=currency%>', $e(currency)) + '"/></div></div><div mxa="_zs_galleryaW:c" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryaW:_" class="_zs_gallery___test___base_-eg-title">常用校验</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 13;
    $art = '=viewId';
    ;
