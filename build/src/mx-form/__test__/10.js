...
module.exports = Base.extend({
    ...
    $art = ':currency{currency:true}';
    ;
    $p += ($expr = '<%=currency%>', $e(currency)) + '"/></div></div><div mxa="_zs_galleryb_:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb_:_" class="_zs_gallery___test___layout_-eg-title">常用校验</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 13;
    $art = '=viewId';
    ;
