...
module.exports = Base.extend({
    ...
    $art = ':email{email:[true, \'只支持qq邮箱\', [\'qq.com\']]}';
    ;
    $p += ($expr = '<%=email%>', $e(email)) + '"/></div></div><div mxa="_zs_gallerybW:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybW:_" class="_zs_gallery___test___layout_-eg-title">常用校验</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
