...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryaZ:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_galleryaZ:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_galleryaZ:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    $art = ':url{url:true}';
    ;
