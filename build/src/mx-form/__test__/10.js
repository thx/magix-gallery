...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybV:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybV:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybV:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    $art = ':url{url:true}';
    ;
    ...
    $art = ':email{email:[true, \'只支持qq邮箱\', [\'qq.com\']]}';
    ;
    $p += ($expr = '<%=email%>', $e(email)) + '"/></div></div><div mxa="_zs_gallerybV:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybV:_" class="_zs_gallery___test___layout_-eg-title">常用校验</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
