...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iawci$art_i = 0, $art_cvrdpreaj$art_c = checkboxes.length; $art_iawci$art_i < $art_cvrdpreaj$art_c; $art_iawci$art_i++) {    var c = checkboxes[$art_iawci$art_i]%>';
    for (var $art_iawci$art_i = 0, $art_cvrdpreaj$art_c = checkboxes.length; $art_iawci$art_i < $art_cvrdpreaj$art_c; $art_iawci$art_i++) {
        var c = checkboxes[$art_iawci$art_i];
