...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifimvwze$art_i = 0, $art_cqjtnunmf$art_c = checkboxes.length; $art_ifimvwze$art_i < $art_cqjtnunmf$art_c; $art_ifimvwze$art_i++) {    var c = checkboxes[$art_ifimvwze$art_i]%>';
    for (var $art_ifimvwze$art_i = 0, $art_cqjtnunmf$art_c = checkboxes.length; $art_ifimvwze$art_i < $art_cqjtnunmf$art_c; $art_ifimvwze$art_i++) {
        var c = checkboxes[$art_ifimvwze$art_i];
