...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ionmwyadzg$art_i = 0, $art_ckgzfcmovr$art_c = checkboxes.length; $art_ionmwyadzg$art_i < $art_ckgzfcmovr$art_c; $art_ionmwyadzg$art_i++) {    var c = checkboxes[$art_ionmwyadzg$art_i]%>';
    for (var $art_ionmwyadzg$art_i = 0, $art_ckgzfcmovr$art_c = checkboxes.length; $art_ionmwyadzg$art_i < $art_ckgzfcmovr$art_c; $art_ionmwyadzg$art_i++) {
        var c = checkboxes[$art_ionmwyadzg$art_i];
