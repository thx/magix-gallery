...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ikooqwjf$art_i = 0, $art_cqpodpxztp$art_c = checkboxes.length; $art_ikooqwjf$art_i < $art_cqpodpxztp$art_c; $art_ikooqwjf$art_i++) {    var c = checkboxes[$art_ikooqwjf$art_i]%>';
    for (var $art_ikooqwjf$art_i = 0, $art_cqpodpxztp$art_c = checkboxes.length; $art_ikooqwjf$art_i < $art_cqpodpxztp$art_c; $art_ikooqwjf$art_i++) {
        var c = checkboxes[$art_ikooqwjf$art_i];
