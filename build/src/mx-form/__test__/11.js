...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ionzekfrou$art_i = 0, $art_cgnqkiroxh$art_c = checkboxes.length; $art_ionzekfrou$art_i < $art_cgnqkiroxh$art_c; $art_ionzekfrou$art_i++) {    var c = checkboxes[$art_ionzekfrou$art_i]%>';
    for (var $art_ionzekfrou$art_i = 0, $art_cgnqkiroxh$art_c = checkboxes.length; $art_ionzekfrou$art_i < $art_cgnqkiroxh$art_c; $art_ionzekfrou$art_i++) {
        var c = checkboxes[$art_ionzekfrou$art_i];
