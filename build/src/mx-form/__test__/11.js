...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imyfqrxeggp$art_i = 0, $art_ckdelrx$art_c = checkboxes.length; $art_imyfqrxeggp$art_i < $art_ckdelrx$art_c; $art_imyfqrxeggp$art_i++) {    var c = checkboxes[$art_imyfqrxeggp$art_i]%>';
    for (var $art_imyfqrxeggp$art_i = 0, $art_ckdelrx$art_c = checkboxes.length; $art_imyfqrxeggp$art_i < $art_ckdelrx$art_c; $art_imyfqrxeggp$art_i++) {
        var c = checkboxes[$art_imyfqrxeggp$art_i];
