...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iiovjbgc$art_i = 0, $art_cwtztzkqv$art_c = checkboxes.length; $art_iiovjbgc$art_i < $art_cwtztzkqv$art_c; $art_iiovjbgc$art_i++) {    var c = checkboxes[$art_iiovjbgc$art_i]%>';
    for (var $art_iiovjbgc$art_i = 0, $art_cwtztzkqv$art_c = checkboxes.length; $art_iiovjbgc$art_i < $art_cwtztzkqv$art_c; $art_iiovjbgc$art_i++) {
        var c = checkboxes[$art_iiovjbgc$art_i];
