...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iuyxrmdsaeg$art_i = 0, $art_cdsjzjyflx$art_c = checkboxes.length; $art_iuyxrmdsaeg$art_i < $art_cdsjzjyflx$art_c; $art_iuyxrmdsaeg$art_i++) {    var c = checkboxes[$art_iuyxrmdsaeg$art_i]%>';
    for (var $art_iuyxrmdsaeg$art_i = 0, $art_cdsjzjyflx$art_c = checkboxes.length; $art_iuyxrmdsaeg$art_i < $art_cdsjzjyflx$art_c; $art_iuyxrmdsaeg$art_i++) {
        var c = checkboxes[$art_iuyxrmdsaeg$art_i];
