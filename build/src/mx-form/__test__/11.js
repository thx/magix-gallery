...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iankiqditf$art_i = 0, $art_cjbfcpur$art_c = checkboxes.length; $art_iankiqditf$art_i < $art_cjbfcpur$art_c; $art_iankiqditf$art_i++) {    var c = checkboxes[$art_iankiqditf$art_i]%>';
    for (var $art_iankiqditf$art_i = 0, $art_cjbfcpur$art_c = checkboxes.length; $art_iankiqditf$art_i < $art_cjbfcpur$art_c; $art_iankiqditf$art_i++) {
        var c = checkboxes[$art_iankiqditf$art_i];
