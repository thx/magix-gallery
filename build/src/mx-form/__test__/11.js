...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iolinilw$art_i = 0, $art_csgphgt$art_c = checkboxes.length; $art_iolinilw$art_i < $art_csgphgt$art_c; $art_iolinilw$art_i++) {    var c = checkboxes[$art_iolinilw$art_i]%>';
    for (var $art_iolinilw$art_i = 0, $art_csgphgt$art_c = checkboxes.length; $art_iolinilw$art_i < $art_csgphgt$art_c; $art_iolinilw$art_i++) {
        var c = checkboxes[$art_iolinilw$art_i];
