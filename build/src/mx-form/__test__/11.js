...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_izufyqj$art_i = 0, $art_cfahwyuvg$art_c = checkboxes.length; $art_izufyqj$art_i < $art_cfahwyuvg$art_c; $art_izufyqj$art_i++) {    var c = checkboxes[$art_izufyqj$art_i]%>';
    for (var $art_izufyqj$art_i = 0, $art_cfahwyuvg$art_c = checkboxes.length; $art_izufyqj$art_i < $art_cfahwyuvg$art_c; $art_izufyqj$art_i++) {
        var c = checkboxes[$art_izufyqj$art_i];
