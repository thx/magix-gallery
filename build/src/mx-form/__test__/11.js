...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieyvinq$art_i = 0, $art_czthwwdllek$art_c = checkboxes.length; $art_ieyvinq$art_i < $art_czthwwdllek$art_c; $art_ieyvinq$art_i++) {    var c = checkboxes[$art_ieyvinq$art_i]%>';
    for (var $art_ieyvinq$art_i = 0, $art_czthwwdllek$art_c = checkboxes.length; $art_ieyvinq$art_i < $art_czthwwdllek$art_c; $art_ieyvinq$art_i++) {
        var c = checkboxes[$art_ieyvinq$art_i];
