...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iwkfo$art_i = 0, $art_cjzqdfauxfn$art_c = checkboxes.length; $art_iwkfo$art_i < $art_cjzqdfauxfn$art_c; $art_iwkfo$art_i++) {    var c = checkboxes[$art_iwkfo$art_i]%>';
    for (var $art_iwkfo$art_i = 0, $art_cjzqdfauxfn$art_c = checkboxes.length; $art_iwkfo$art_i < $art_cjzqdfauxfn$art_c; $art_iwkfo$art_i++) {
        var c = checkboxes[$art_iwkfo$art_i];
