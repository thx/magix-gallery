...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixuqouozdoi$art_i = 0, $art_cebiigsvj$art_c = checkboxes.length; $art_ixuqouozdoi$art_i < $art_cebiigsvj$art_c; $art_ixuqouozdoi$art_i++) {    var c = checkboxes[$art_ixuqouozdoi$art_i]%>';
    for (var $art_ixuqouozdoi$art_i = 0, $art_cebiigsvj$art_c = checkboxes.length; $art_ixuqouozdoi$art_i < $art_cebiigsvj$art_c; $art_ixuqouozdoi$art_i++) {
        var c = checkboxes[$art_ixuqouozdoi$art_i];
