...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibyvamcgxi$art_i = 0, $art_cowhpxgvem$art_c = checkboxes.length; $art_ibyvamcgxi$art_i < $art_cowhpxgvem$art_c; $art_ibyvamcgxi$art_i++) {    var c = checkboxes[$art_ibyvamcgxi$art_i]%>';
    for (var $art_ibyvamcgxi$art_i = 0, $art_cowhpxgvem$art_c = checkboxes.length; $art_ibyvamcgxi$art_i < $art_cowhpxgvem$art_c; $art_ibyvamcgxi$art_i++) {
        var c = checkboxes[$art_ibyvamcgxi$art_i];
