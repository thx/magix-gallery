...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipuquc$art_i = 0, $art_ccpzjfyg$art_c = checkboxes.length; $art_ipuquc$art_i < $art_ccpzjfyg$art_c; $art_ipuquc$art_i++) {    var c = checkboxes[$art_ipuquc$art_i]%>';
    for (var $art_ipuquc$art_i = 0, $art_ccpzjfyg$art_c = checkboxes.length; $art_ipuquc$art_i < $art_ccpzjfyg$art_c; $art_ipuquc$art_i++) {
        var c = checkboxes[$art_ipuquc$art_i];
