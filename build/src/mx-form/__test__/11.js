...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixlmohunod$art_i = 0, $art_cyukltbhql$art_c = checkboxes.length; $art_ixlmohunod$art_i < $art_cyukltbhql$art_c; $art_ixlmohunod$art_i++) {    var c = checkboxes[$art_ixlmohunod$art_i]%>';
    for (var $art_ixlmohunod$art_i = 0, $art_cyukltbhql$art_c = checkboxes.length; $art_ixlmohunod$art_i < $art_cyukltbhql$art_c; $art_ixlmohunod$art_i++) {
        var c = checkboxes[$art_ixlmohunod$art_i];
