...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_itogypecug$art_i = 0, $art_cwksnllc$art_c = checkboxes.length; $art_itogypecug$art_i < $art_cwksnllc$art_c; $art_itogypecug$art_i++) {    var c = checkboxes[$art_itogypecug$art_i]%>';
    for (var $art_itogypecug$art_i = 0, $art_cwksnllc$art_c = checkboxes.length; $art_itogypecug$art_i < $art_cwksnllc$art_c; $art_itogypecug$art_i++) {
        var c = checkboxes[$art_itogypecug$art_i];
