...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya4:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya4:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya4:b" class="mb20"><span mxs="_zs_gallerya4:_" class="color-9 mr20">checkbox至少选择一个：</span>';
    $line = 5;
    $art = 'each checkboxes as c';
    ;
    $p += '';
    $expr = '<%for (var $art_ioqnqgnqzud$art_i = 0, $art_caocvoi$art_c = checkboxes.length; $art_ioqnqgnqzud$art_i < $art_caocvoi$art_c; $art_ioqnqgnqzud$art_i++) {    var c = checkboxes[$art_ioqnqgnqzud$art_i]%>';
    for (var $art_ioqnqgnqzud$art_i = 0, $art_caocvoi$art_c = checkboxes.length; $art_ioqnqgnqzud$art_i < $art_caocvoi$art_c; $art_ioqnqgnqzud$art_i++) {
        var c = checkboxes[$art_ioqnqgnqzud$art_i];
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerya4:f" class="_zs_gallery___test___base_-desc-tip">';
    $line = 19;
    $art = '!text1';
    ;
