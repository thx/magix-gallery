...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imcgqf$art_i = 0, $art_ciukcxjrzdf$art_c = checkboxes.length; $art_imcgqf$art_i < $art_ciukcxjrzdf$art_c; $art_imcgqf$art_i++) {    var c = checkboxes[$art_imcgqf$art_i]%>';
    for (var $art_imcgqf$art_i = 0, $art_ciukcxjrzdf$art_c = checkboxes.length; $art_imcgqf$art_i < $art_ciukcxjrzdf$art_c; $art_imcgqf$art_i++) {
        var c = checkboxes[$art_imcgqf$art_i];
