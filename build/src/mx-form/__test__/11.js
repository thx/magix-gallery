...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikcgpwoob$art_i = 0, $art_codlnsg$art_c = checkboxes.length; $art_ikcgpwoob$art_i < $art_codlnsg$art_c; $art_ikcgpwoob$art_i++) {    var c = checkboxes[$art_ikcgpwoob$art_i]%>';
    for (var $art_ikcgpwoob$art_i = 0, $art_codlnsg$art_c = checkboxes.length; $art_ikcgpwoob$art_i < $art_codlnsg$art_c; $art_ikcgpwoob$art_i++) {
        var c = checkboxes[$art_ikcgpwoob$art_i];
