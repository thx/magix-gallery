...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inklzkitwk$art_i = 0, $art_ccwzneszymw$art_c = checkboxes.length; $art_inklzkitwk$art_i < $art_ccwzneszymw$art_c; $art_inklzkitwk$art_i++) {    var c = checkboxes[$art_inklzkitwk$art_i]%>';
    for (var $art_inklzkitwk$art_i = 0, $art_ccwzneszymw$art_c = checkboxes.length; $art_inklzkitwk$art_i < $art_ccwzneszymw$art_c; $art_inklzkitwk$art_i++) {
        var c = checkboxes[$art_inklzkitwk$art_i];
