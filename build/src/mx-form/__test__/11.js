...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iumgxacpvc$art_i = 0, $art_cifzhmhn$art_c = checkboxes.length; $art_iumgxacpvc$art_i < $art_cifzhmhn$art_c; $art_iumgxacpvc$art_i++) {    var c = checkboxes[$art_iumgxacpvc$art_i]%>';
    for (var $art_iumgxacpvc$art_i = 0, $art_cifzhmhn$art_c = checkboxes.length; $art_iumgxacpvc$art_i < $art_cifzhmhn$art_c; $art_iumgxacpvc$art_i++) {
        var c = checkboxes[$art_iumgxacpvc$art_i];
