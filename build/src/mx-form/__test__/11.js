...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijxcmdu$art_i = 0, $art_csmaqxmmto$art_c = checkboxes.length; $art_ijxcmdu$art_i < $art_csmaqxmmto$art_c; $art_ijxcmdu$art_i++) {    var c = checkboxes[$art_ijxcmdu$art_i]%>';
    for (var $art_ijxcmdu$art_i = 0, $art_csmaqxmmto$art_c = checkboxes.length; $art_ijxcmdu$art_i < $art_csmaqxmmto$art_c; $art_ijxcmdu$art_i++) {
        var c = checkboxes[$art_ijxcmdu$art_i];
