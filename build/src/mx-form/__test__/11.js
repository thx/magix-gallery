...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijkqhsfaqd$art_i = 0, $art_cbbnzwfuphi$art_c = checkboxes.length; $art_ijkqhsfaqd$art_i < $art_cbbnzwfuphi$art_c; $art_ijkqhsfaqd$art_i++) {    var c = checkboxes[$art_ijkqhsfaqd$art_i]%>';
    for (var $art_ijkqhsfaqd$art_i = 0, $art_cbbnzwfuphi$art_c = checkboxes.length; $art_ijkqhsfaqd$art_i < $art_cbbnzwfuphi$art_c; $art_ijkqhsfaqd$art_i++) {
        var c = checkboxes[$art_ijkqhsfaqd$art_i];
