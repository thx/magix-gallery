...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iqlmpneixd$art_i = 0, $art_clufxwzvdq$art_c = checkboxes.length; $art_iqlmpneixd$art_i < $art_clufxwzvdq$art_c; $art_iqlmpneixd$art_i++) {    var c = checkboxes[$art_iqlmpneixd$art_i]%>';
    for (var $art_iqlmpneixd$art_i = 0, $art_clufxwzvdq$art_c = checkboxes.length; $art_iqlmpneixd$art_i < $art_clufxwzvdq$art_c; $art_iqlmpneixd$art_i++) {
        var c = checkboxes[$art_iqlmpneixd$art_i];
