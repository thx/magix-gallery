...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iamfulgwxx$art_i = 0, $art_cqcjbrjb$art_c = checkboxes.length; $art_iamfulgwxx$art_i < $art_cqcjbrjb$art_c; $art_iamfulgwxx$art_i++) {    var c = checkboxes[$art_iamfulgwxx$art_i]%>';
    for (var $art_iamfulgwxx$art_i = 0, $art_cqcjbrjb$art_c = checkboxes.length; $art_iamfulgwxx$art_i < $art_cqcjbrjb$art_c; $art_iamfulgwxx$art_i++) {
        var c = checkboxes[$art_iamfulgwxx$art_i];
