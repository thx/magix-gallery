...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqrhkm$art_i = 0, $art_cobbkfat$art_c = checkboxes.length; $art_iqrhkm$art_i < $art_cobbkfat$art_c; $art_iqrhkm$art_i++) {    var c = checkboxes[$art_iqrhkm$art_i]%>';
    for (var $art_iqrhkm$art_i = 0, $art_cobbkfat$art_c = checkboxes.length; $art_iqrhkm$art_i < $art_cobbkfat$art_c; $art_iqrhkm$art_i++) {
        var c = checkboxes[$art_iqrhkm$art_i];
