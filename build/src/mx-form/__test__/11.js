...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioiaxxjgmm$art_i = 0, $art_cfylyus$art_c = checkboxes.length; $art_ioiaxxjgmm$art_i < $art_cfylyus$art_c; $art_ioiaxxjgmm$art_i++) {    var c = checkboxes[$art_ioiaxxjgmm$art_i]%>';
    for (var $art_ioiaxxjgmm$art_i = 0, $art_cfylyus$art_c = checkboxes.length; $art_ioiaxxjgmm$art_i < $art_cfylyus$art_c; $art_ioiaxxjgmm$art_i++) {
        var c = checkboxes[$art_ioiaxxjgmm$art_i];
