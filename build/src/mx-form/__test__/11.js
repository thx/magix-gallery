...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb!:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb!:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_galleryb!:b" class="mb20"><span mxs="_zs_galleryb!:_" class="color-9 mr20">checkbox至少选择一个：</span>';
    $line = 5;
    $art = 'each checkboxes as c';
    ;
    $expr = '<%for (var $art_ibpgsddxrq$art_i = 0, $art_cxysktvcevee$art_c = checkboxes.length; $art_ibpgsddxrq$art_i < $art_cxysktvcevee$art_c; $art_ibpgsddxrq$art_i++) {    var c = checkboxes[$art_ibpgsddxrq$art_i]%>';
    for (var $art_ibpgsddxrq$art_i = 0, $art_cxysktvcevee$art_c = checkboxes.length; $art_ibpgsddxrq$art_i < $art_cxysktvcevee$art_c; $art_ibpgsddxrq$art_i++) {
        var c = checkboxes[$art_ibpgsddxrq$art_i];
