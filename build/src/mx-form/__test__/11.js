...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izegsuvoup$art_i = 0, $art_cuorgotita$art_c = checkboxes.length; $art_izegsuvoup$art_i < $art_cuorgotita$art_c; $art_izegsuvoup$art_i++) {    var c = checkboxes[$art_izegsuvoup$art_i]%>';
    for (var $art_izegsuvoup$art_i = 0, $art_cuorgotita$art_c = checkboxes.length; $art_izegsuvoup$art_i < $art_cuorgotita$art_c; $art_izegsuvoup$art_i++) {
        var c = checkboxes[$art_izegsuvoup$art_i];
