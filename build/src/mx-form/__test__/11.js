...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ircgzecgi$art_i = 0, $art_ccvfohgjj$art_c = checkboxes.length; $art_ircgzecgi$art_i < $art_ccvfohgjj$art_c; $art_ircgzecgi$art_i++) {    var c = checkboxes[$art_ircgzecgi$art_i]%>';
    for (var $art_ircgzecgi$art_i = 0, $art_ccvfohgjj$art_c = checkboxes.length; $art_ircgzecgi$art_i < $art_ccvfohgjj$art_c; $art_ircgzecgi$art_i++) {
        var c = checkboxes[$art_ircgzecgi$art_i];
