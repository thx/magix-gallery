...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iatrcxotq$art_i = 0, $art_ctnjnf$art_c = checkboxes.length; $art_iatrcxotq$art_i < $art_ctnjnf$art_c; $art_iatrcxotq$art_i++) {    var c = checkboxes[$art_iatrcxotq$art_i]%>';
    for (var $art_iatrcxotq$art_i = 0, $art_ctnjnf$art_c = checkboxes.length; $art_iatrcxotq$art_i < $art_ctnjnf$art_c; $art_iatrcxotq$art_i++) {
        var c = checkboxes[$art_iatrcxotq$art_i];
