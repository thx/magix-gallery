...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idnrolafrb$art_i = 0, $art_cqjjacmrt$art_c = checkboxes.length; $art_idnrolafrb$art_i < $art_cqjjacmrt$art_c; $art_idnrolafrb$art_i++) {    var c = checkboxes[$art_idnrolafrb$art_i]%>';
    for (var $art_idnrolafrb$art_i = 0, $art_cqjjacmrt$art_c = checkboxes.length; $art_idnrolafrb$art_i < $art_cqjjacmrt$art_c; $art_idnrolafrb$art_i++) {
        var c = checkboxes[$art_idnrolafrb$art_i];
