...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqzmjawjer$art_i = 0, $art_cdbamdlf$art_c = checkboxes.length; $art_iqzmjawjer$art_i < $art_cdbamdlf$art_c; $art_iqzmjawjer$art_i++) {    var c = checkboxes[$art_iqzmjawjer$art_i]%>';
    for (var $art_iqzmjawjer$art_i = 0, $art_cdbamdlf$art_c = checkboxes.length; $art_iqzmjawjer$art_i < $art_cdbamdlf$art_c; $art_iqzmjawjer$art_i++) {
        var c = checkboxes[$art_iqzmjawjer$art_i];
