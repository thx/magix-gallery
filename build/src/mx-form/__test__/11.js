...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqaifjardf$art_i = 0, $art_clqujcnp$art_c = checkboxes.length; $art_iqaifjardf$art_i < $art_clqujcnp$art_c; $art_iqaifjardf$art_i++) {    var c = checkboxes[$art_iqaifjardf$art_i]%>';
    for (var $art_iqaifjardf$art_i = 0, $art_clqujcnp$art_c = checkboxes.length; $art_iqaifjardf$art_i < $art_clqujcnp$art_c; $art_iqaifjardf$art_i++) {
        var c = checkboxes[$art_iqaifjardf$art_i];
