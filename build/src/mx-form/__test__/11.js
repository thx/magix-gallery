...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izcdabkzub$art_i = 0, $art_cvhgaz$art_c = checkboxes.length; $art_izcdabkzub$art_i < $art_cvhgaz$art_c; $art_izcdabkzub$art_i++) {    var c = checkboxes[$art_izcdabkzub$art_i]%>';
    for (var $art_izcdabkzub$art_i = 0, $art_cvhgaz$art_c = checkboxes.length; $art_izcdabkzub$art_i < $art_cvhgaz$art_c; $art_izcdabkzub$art_i++) {
        var c = checkboxes[$art_izcdabkzub$art_i];
