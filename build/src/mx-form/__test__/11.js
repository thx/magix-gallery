...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iijnpbvps$art_i = 0, $art_cfekzds$art_c = checkboxes.length; $art_iijnpbvps$art_i < $art_cfekzds$art_c; $art_iijnpbvps$art_i++) {    var c = checkboxes[$art_iijnpbvps$art_i]%>';
    for (var $art_iijnpbvps$art_i = 0, $art_cfekzds$art_c = checkboxes.length; $art_iijnpbvps$art_i < $art_cfekzds$art_c; $art_iijnpbvps$art_i++) {
        var c = checkboxes[$art_iijnpbvps$art_i];
