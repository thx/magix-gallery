...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_ifftecwle$art_i=0;$art_ifftecwle$art_i<checkboxes.length;$art_ifftecwle$art_i++){var c=checkboxes[$art_ifftecwle$art_i]%>';
    for (var $art_ifftecwle$art_i = 0; $art_ifftecwle$art_i < checkboxes.length; $art_ifftecwle$art_i++) {
        var c = checkboxes[$art_ifftecwle$art_i];
