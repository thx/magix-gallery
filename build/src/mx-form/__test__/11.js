...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iydjylvnw$art_i = 0, $art_cxodmcjx$art_c = checkboxes.length; $art_iydjylvnw$art_i < $art_cxodmcjx$art_c; $art_iydjylvnw$art_i++) {    var c = checkboxes[$art_iydjylvnw$art_i]%>';
    for (var $art_iydjylvnw$art_i = 0, $art_cxodmcjx$art_c = checkboxes.length; $art_iydjylvnw$art_i < $art_cxodmcjx$art_c; $art_iydjylvnw$art_i++) {
        var c = checkboxes[$art_iydjylvnw$art_i];
