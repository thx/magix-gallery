...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ififmophjt$art_i = 0, $art_crsxqsvlggb$art_c = checkboxes.length; $art_ififmophjt$art_i < $art_crsxqsvlggb$art_c; $art_ififmophjt$art_i++) {    var c = checkboxes[$art_ififmophjt$art_i]%>';
    for (var $art_ififmophjt$art_i = 0, $art_crsxqsvlggb$art_c = checkboxes.length; $art_ififmophjt$art_i < $art_crsxqsvlggb$art_c; $art_ififmophjt$art_i++) {
        var c = checkboxes[$art_ififmophjt$art_i];
