...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idudtoayq$art_i = 0, $art_cbkvepoirwu$art_c = checkboxes.length; $art_idudtoayq$art_i < $art_cbkvepoirwu$art_c; $art_idudtoayq$art_i++) {    var c = checkboxes[$art_idudtoayq$art_i]%>';
    for (var $art_idudtoayq$art_i = 0, $art_cbkvepoirwu$art_c = checkboxes.length; $art_idudtoayq$art_i < $art_cbkvepoirwu$art_c; $art_idudtoayq$art_i++) {
        var c = checkboxes[$art_idudtoayq$art_i];
