...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_irbmoxgovb$art_i = 0, $art_csglfuasj$art_c = checkboxes.length; $art_irbmoxgovb$art_i < $art_csglfuasj$art_c; $art_irbmoxgovb$art_i++) {    var c = checkboxes[$art_irbmoxgovb$art_i]%>';
    for (var $art_irbmoxgovb$art_i = 0, $art_csglfuasj$art_c = checkboxes.length; $art_irbmoxgovb$art_i < $art_csglfuasj$art_c; $art_irbmoxgovb$art_i++) {
        var c = checkboxes[$art_irbmoxgovb$art_i];
