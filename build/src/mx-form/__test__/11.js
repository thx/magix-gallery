...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihiunwssh$art_i = 0, $art_chnwkbxs$art_c = checkboxes.length; $art_ihiunwssh$art_i < $art_chnwkbxs$art_c; $art_ihiunwssh$art_i++) {    var c = checkboxes[$art_ihiunwssh$art_i]%>';
    for (var $art_ihiunwssh$art_i = 0, $art_chnwkbxs$art_c = checkboxes.length; $art_ihiunwssh$art_i < $art_chnwkbxs$art_c; $art_ihiunwssh$art_i++) {
        var c = checkboxes[$art_ihiunwssh$art_i];
