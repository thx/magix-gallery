...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwrurmohy$art_i = 0, $art_czxsidwjj$art_c = checkboxes.length; $art_iwrurmohy$art_i < $art_czxsidwjj$art_c; $art_iwrurmohy$art_i++) {    var c = checkboxes[$art_iwrurmohy$art_i]%>';
    for (var $art_iwrurmohy$art_i = 0, $art_czxsidwjj$art_c = checkboxes.length; $art_iwrurmohy$art_i < $art_czxsidwjj$art_c; $art_iwrurmohy$art_i++) {
        var c = checkboxes[$art_iwrurmohy$art_i];
