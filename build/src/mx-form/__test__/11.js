...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iznwfqzt$art_i = 0, $art_ciiutwljn$art_c = checkboxes.length; $art_iznwfqzt$art_i < $art_ciiutwljn$art_c; $art_iznwfqzt$art_i++) {    var c = checkboxes[$art_iznwfqzt$art_i]%>';
    for (var $art_iznwfqzt$art_i = 0, $art_ciiutwljn$art_c = checkboxes.length; $art_iznwfqzt$art_i < $art_ciiutwljn$art_c; $art_iznwfqzt$art_i++) {
        var c = checkboxes[$art_iznwfqzt$art_i];
