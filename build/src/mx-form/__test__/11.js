...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ihqfraco$art_i = 0, $art_cwxclrolporg$art_c = checkboxes.length; $art_ihqfraco$art_i < $art_cwxclrolporg$art_c; $art_ihqfraco$art_i++) {    var c = checkboxes[$art_ihqfraco$art_i]%>';
    for (var $art_ihqfraco$art_i = 0, $art_cwxclrolporg$art_c = checkboxes.length; $art_ihqfraco$art_i < $art_cwxclrolporg$art_c; $art_ihqfraco$art_i++) {
        var c = checkboxes[$art_ihqfraco$art_i];
