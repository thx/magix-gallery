...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijueuorx$art_i = 0, $art_crijrmvoki$art_c = checkboxes.length; $art_ijueuorx$art_i < $art_crijrmvoki$art_c; $art_ijueuorx$art_i++) {    var c = checkboxes[$art_ijueuorx$art_i]%>';
    for (var $art_ijueuorx$art_i = 0, $art_crijrmvoki$art_c = checkboxes.length; $art_ijueuorx$art_i < $art_crijrmvoki$art_c; $art_ijueuorx$art_i++) {
        var c = checkboxes[$art_ijueuorx$art_i];
