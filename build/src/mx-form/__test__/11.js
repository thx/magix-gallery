...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ithprpbjvdn$art_i = 0, $art_cjogvdfdrt$art_c = checkboxes.length; $art_ithprpbjvdn$art_i < $art_cjogvdfdrt$art_c; $art_ithprpbjvdn$art_i++) {    var c = checkboxes[$art_ithprpbjvdn$art_i]%>';
    for (var $art_ithprpbjvdn$art_i = 0, $art_cjogvdfdrt$art_c = checkboxes.length; $art_ithprpbjvdn$art_i < $art_cjogvdfdrt$art_c; $art_ithprpbjvdn$art_i++) {
        var c = checkboxes[$art_ithprpbjvdn$art_i];
