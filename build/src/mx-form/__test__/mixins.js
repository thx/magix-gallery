/*
    ...
    loader: cmd_es
 */
define("mx-form/__test__/mixins",["magix","__test__/subs","mx-title/second","./2","./11","./12","./13","./9","./14","./3","./4","./5","./6","./7","./16","./8","./15","./10"],(require,exports,module)=>{
/*Magix*/
...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_gallerybf:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'必填\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'checkbox\',\n            key: viewId + \'_demo11\'\n        },{\n            name: \'radio\',\n            key: viewId + \'_demo12\'\n        },{\n            name: \'dropdown必选\',\n            key: viewId + \'_demo13\'\n        },{\n            name: \'refresh\',\n            key: viewId + \'_demo9\'\n        },{\n            name: \'动态添加\',\n            key: viewId + \'_demo14\'\n        },{\n            name: \'正则\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'数字\',\n            key: viewId + \'_demo4\'\n        },{\n            name: \'字个数\',\n            key: viewId + \'_demo5\'\n        },{\n            name: \'字符个数\',\n            key: viewId + \'_demo6\'\n        },{\n            name: \'范围\',\n            key: viewId + \'_demo7\'\n        },{\n            name: \'节点不重复\',\n            key: viewId + \'_demo16\'\n        },{\n            name: \'节点一致\',\n            key: viewId + \'_demo8\'\n        },{\n            name: \'taginput\',\n            key: viewId + \'_demo15\'\n        },{\n            name: \'其他常用\',\n            key: viewId + \'_demo10\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
    $p += '' + ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'必填\',                    key: viewId + \'_demo2\'                }, {                    name: \'checkbox\',                    key: viewId + \'_demo11\'                }, {                    name: \'radio\',                    key: viewId + \'_demo12\'                }, {                    name: \'dropdown必选\',                    key: viewId + \'_demo13\'                }, {                    name: \'refresh\',                    key: viewId + \'_demo9\'                }, {                    name: \'动态添加\',                    key: viewId + \'_demo14\'                }, {                    name: \'正则\',                    key: viewId + \'_demo3\'                }, {                    name: \'数字\',                    key: viewId + \'_demo4\'                }, {                    name: \'字个数\',                    key: viewId + \'_demo5\'                }, {                    name: \'字符个数\',                    key: viewId + \'_demo6\'                }, {                    name: \'范围\',                    key: viewId + \'_demo7\'                }, {                    name: \'节点不重复\',                    key: viewId + \'_demo16\'                }, {                    name: \'节点一致\',                    key: viewId + \'_demo8\'                }, {                    name: \'taginput\',                    key: viewId + \'_demo15\'                }, {                    name: \'其他常用\',                    key: viewId + \'_demo10\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '必填', key: viewId + '_demo2' }, { name: 'checkbox', key: viewId + '_demo11' }, { name: 'radio', key: viewId + '_demo12' }, { name: 'dropdown必选', key: viewId + '_demo13' }, { name: 'refresh', key: viewId + '_demo9' }, { name: '动态添加', key: viewId + '_demo14' }, { name: '正则', key: viewId + '_demo3' }, { name: '数字', key: viewId + '_demo4' }, { name: '字个数', key: viewId + '_demo5' }, { name: '字符个数', key: viewId + '_demo6' }, { name: '范围', key: viewId + '_demo7' }, { name: '节点不重复', key: viewId + '_demo16' }, { name: '节点一致', key: viewId + '_demo8' }, { name: 'taginput', key: viewId + '_demo15' }, { name: '其他常用', key: viewId + '_demo10' }] }, { name: 'API', key: viewId + '_api' }])) + '"></div><div id="';
    $line = 56;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerybf:a" class="clearfix mb20"><div mx-view="mx-form/__test__/2" id="';
    $line = 58;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div><div mx-view="mx-form/__test__/4" id="';
    $line = 65;
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo4"></div><div mx-view="mx-form/__test__/5" id="';
    $line = 66;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"></div><div mx-view="mx-form/__test__/7" id="';
    $line = 68;
    $art = '=viewId';
    ;
