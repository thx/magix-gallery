...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_rules" mx-view="mx-title/second?content=%E6%A3%80%E9%AA%8C%E9%A1%B9%E7%A4%BA%E4%BE%8B"></div><div mxs="_zs_gallerya$:b" class="clearfix mb20"><div mx-view="mx-form/__test__/2"></div><div mx-view="mx-form/__test__/10"></div><div mx-view="mx-form/__test__/11"></div><div mx-view="mx-form/__test__/12"></div><div mx-view="mx-form/__test__/13"></div><div mx-view="mx-form/__test__/9"></div><div mx-view="mx-form/__test__/14"></div><div mx-view="mx-form/__test__/3"></div><div mx-view="mx-form/__test__/4"></div><div mx-view="mx-form/__test__/5"></div><div mx-view="mx-form/__test__/6"></div><div mx-view="mx-form/__test__/7"></div><div mx-view="mx-form/__test__/8"></div></div><div id="';
    $line = 38;
    $art = '=viewId';
    ;
