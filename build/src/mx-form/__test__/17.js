...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inscwltorh$art_i = 0, $art_ccrahvb$art_c = checkboxes.length; $art_inscwltorh$art_i < $art_ccrahvb$art_c; $art_inscwltorh$art_i++) {    var c = checkboxes[$art_inscwltorh$art_i]%>';
    for (var $art_inscwltorh$art_i = 0, $art_ccrahvb$art_c = checkboxes.length; $art_inscwltorh$art_i < $art_ccrahvb$art_c; $art_inscwltorh$art_i++) {
        var c = checkboxes[$art_inscwltorh$art_i];
    ...
    ;
    $expr = '<%for (var $art_inlcekrrob$art_i = 0, $art_cigzrmomb$art_c = radioes.length; $art_inlcekrrob$art_i < $art_cigzrmomb$art_c; $art_inlcekrrob$art_i++) {    var r = radioes[$art_inlcekrrob$art_i]%>';
    for (var $art_inlcekrrob$art_i = 0, $art_cigzrmomb$art_c = radioes.length; $art_inlcekrrob$art_i < $art_cigzrmomb$art_c; $art_inlcekrrob$art_i++) {
        var r = radioes[$art_inlcekrrob$art_i];
