...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqgmbnlk$art_i = 0, $art_curddhjsp$art_c = checkboxes.length; $art_iqgmbnlk$art_i < $art_curddhjsp$art_c; $art_iqgmbnlk$art_i++) {    var c = checkboxes[$art_iqgmbnlk$art_i]%>';
    for (var $art_iqgmbnlk$art_i = 0, $art_curddhjsp$art_c = checkboxes.length; $art_iqgmbnlk$art_i < $art_curddhjsp$art_c; $art_iqgmbnlk$art_i++) {
        var c = checkboxes[$art_iqgmbnlk$art_i];
    ...
    ;
    $expr = '<%for (var $art_imkpivnjui$art_i = 0, $art_cimcqysxsrl$art_c = radioes.length; $art_imkpivnjui$art_i < $art_cimcqysxsrl$art_c; $art_imkpivnjui$art_i++) {    var r = radioes[$art_imkpivnjui$art_i]%>';
    for (var $art_imkpivnjui$art_i = 0, $art_cimcqysxsrl$art_c = radioes.length; $art_imkpivnjui$art_i < $art_cimcqysxsrl$art_c; $art_imkpivnjui$art_i++) {
        var r = radioes[$art_imkpivnjui$art_i];
