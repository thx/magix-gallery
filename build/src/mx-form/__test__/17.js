...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilxjqfhk$art_i = 0, $art_cdknzuahg$art_c = checkboxes.length; $art_ilxjqfhk$art_i < $art_cdknzuahg$art_c; $art_ilxjqfhk$art_i++) {    var c = checkboxes[$art_ilxjqfhk$art_i]%>';
    for (var $art_ilxjqfhk$art_i = 0, $art_cdknzuahg$art_c = checkboxes.length; $art_ilxjqfhk$art_i < $art_cdknzuahg$art_c; $art_ilxjqfhk$art_i++) {
        var c = checkboxes[$art_ilxjqfhk$art_i];
    ...
    ;
    $expr = '<%for (var $art_iwngbzi$art_i = 0, $art_czsvdcijm$art_c = radioes.length; $art_iwngbzi$art_i < $art_czsvdcijm$art_c; $art_iwngbzi$art_i++) {    var r = radioes[$art_iwngbzi$art_i]%>';
    for (var $art_iwngbzi$art_i = 0, $art_czsvdcijm$art_c = radioes.length; $art_iwngbzi$art_i < $art_czsvdcijm$art_c; $art_iwngbzi$art_i++) {
        var r = radioes[$art_iwngbzi$art_i];
