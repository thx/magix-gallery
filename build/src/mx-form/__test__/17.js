...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itzijbwv$art_i = 0, $art_cstdoiliql$art_c = checkboxes.length; $art_itzijbwv$art_i < $art_cstdoiliql$art_c; $art_itzijbwv$art_i++) {    var c = checkboxes[$art_itzijbwv$art_i]%>';
    for (var $art_itzijbwv$art_i = 0, $art_cstdoiliql$art_c = checkboxes.length; $art_itzijbwv$art_i < $art_cstdoiliql$art_c; $art_itzijbwv$art_i++) {
        var c = checkboxes[$art_itzijbwv$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuytyqsyow$art_i = 0, $art_csyzgsytn$art_c = radioes.length; $art_iuytyqsyow$art_i < $art_csyzgsytn$art_c; $art_iuytyqsyow$art_i++) {    var r = radioes[$art_iuytyqsyow$art_i]%>';
    for (var $art_iuytyqsyow$art_i = 0, $art_csyzgsytn$art_c = radioes.length; $art_iuytyqsyow$art_i < $art_csyzgsytn$art_c; $art_iuytyqsyow$art_i++) {
        var r = radioes[$art_iuytyqsyow$art_i];
