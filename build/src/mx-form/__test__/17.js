...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifgqtzcipxl$art_i = 0, $art_cehlk$art_c = checkboxes.length; $art_ifgqtzcipxl$art_i < $art_cehlk$art_c; $art_ifgqtzcipxl$art_i++) {    var c = checkboxes[$art_ifgqtzcipxl$art_i]%>';
    for (var $art_ifgqtzcipxl$art_i = 0, $art_cehlk$art_c = checkboxes.length; $art_ifgqtzcipxl$art_i < $art_cehlk$art_c; $art_ifgqtzcipxl$art_i++) {
        var c = checkboxes[$art_ifgqtzcipxl$art_i];
    ...
    ;
    $expr = '<%for (var $art_irioaxfxy$art_i = 0, $art_cjkfjrjh$art_c = radioes.length; $art_irioaxfxy$art_i < $art_cjkfjrjh$art_c; $art_irioaxfxy$art_i++) {    var r = radioes[$art_irioaxfxy$art_i]%>';
    for (var $art_irioaxfxy$art_i = 0, $art_cjkfjrjh$art_c = radioes.length; $art_irioaxfxy$art_i < $art_cjkfjrjh$art_c; $art_irioaxfxy$art_i++) {
        var r = radioes[$art_irioaxfxy$art_i];
