...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieihbemrjg$art_i = 0, $art_ctfgeji$art_c = checkboxes.length; $art_ieihbemrjg$art_i < $art_ctfgeji$art_c; $art_ieihbemrjg$art_i++) {    var c = checkboxes[$art_ieihbemrjg$art_i]%>';
    for (var $art_ieihbemrjg$art_i = 0, $art_ctfgeji$art_c = checkboxes.length; $art_ieihbemrjg$art_i < $art_ctfgeji$art_c; $art_ieihbemrjg$art_i++) {
        var c = checkboxes[$art_ieihbemrjg$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihleidi$art_i = 0, $art_crutufhjaap$art_c = radioes.length; $art_ihleidi$art_i < $art_crutufhjaap$art_c; $art_ihleidi$art_i++) {    var r = radioes[$art_ihleidi$art_i]%>';
    for (var $art_ihleidi$art_i = 0, $art_crutufhjaap$art_c = radioes.length; $art_ihleidi$art_i < $art_crutufhjaap$art_c; $art_ihleidi$art_i++) {
        var r = radioes[$art_ihleidi$art_i];
