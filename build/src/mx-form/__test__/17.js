...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isgwlspkf$art_i = 0, $art_cnosxvghogyp$art_c = checkboxes.length; $art_isgwlspkf$art_i < $art_cnosxvghogyp$art_c; $art_isgwlspkf$art_i++) {    var c = checkboxes[$art_isgwlspkf$art_i]%>';
    for (var $art_isgwlspkf$art_i = 0, $art_cnosxvghogyp$art_c = checkboxes.length; $art_isgwlspkf$art_i < $art_cnosxvghogyp$art_c; $art_isgwlspkf$art_i++) {
        var c = checkboxes[$art_isgwlspkf$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqglhbi$art_i = 0, $art_cstjhaglc$art_c = radioes.length; $art_iqglhbi$art_i < $art_cstjhaglc$art_c; $art_iqglhbi$art_i++) {    var r = radioes[$art_iqglhbi$art_i]%>';
    for (var $art_iqglhbi$art_i = 0, $art_cstjhaglc$art_c = radioes.length; $art_iqglhbi$art_i < $art_cstjhaglc$art_c; $art_iqglhbi$art_i++) {
        var r = radioes[$art_iqglhbi$art_i];
