...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iulmtros$art_i = 0, $art_ccbzyqnjh$art_c = checkboxes.length; $art_iulmtros$art_i < $art_ccbzyqnjh$art_c; $art_iulmtros$art_i++) {    var c = checkboxes[$art_iulmtros$art_i]%>';
    for (var $art_iulmtros$art_i = 0, $art_ccbzyqnjh$art_c = checkboxes.length; $art_iulmtros$art_i < $art_ccbzyqnjh$art_c; $art_iulmtros$art_i++) {
        var c = checkboxes[$art_iulmtros$art_i];
    ...
    ;
    $expr = '<%for (var $art_iuawscih$art_i = 0, $art_cuwednqblfq$art_c = radioes.length; $art_iuawscih$art_i < $art_cuwednqblfq$art_c; $art_iuawscih$art_i++) {    var r = radioes[$art_iuawscih$art_i]%>';
    for (var $art_iuawscih$art_i = 0, $art_cuwednqblfq$art_c = radioes.length; $art_iuawscih$art_i < $art_cuwednqblfq$art_c; $art_iuawscih$art_i++) {
        var r = radioes[$art_iuawscih$art_i];
