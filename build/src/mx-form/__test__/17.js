...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixfnnc$art_i = 0, $art_cmnbinifo$art_c = checkboxes.length; $art_ixfnnc$art_i < $art_cmnbinifo$art_c; $art_ixfnnc$art_i++) {    var c = checkboxes[$art_ixfnnc$art_i]%>';
    for (var $art_ixfnnc$art_i = 0, $art_cmnbinifo$art_c = checkboxes.length; $art_ixfnnc$art_i < $art_cmnbinifo$art_c; $art_ixfnnc$art_i++) {
        var c = checkboxes[$art_ixfnnc$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivxjzcclqs$art_i = 0, $art_cjysavwuco$art_c = radioes.length; $art_ivxjzcclqs$art_i < $art_cjysavwuco$art_c; $art_ivxjzcclqs$art_i++) {    var r = radioes[$art_ivxjzcclqs$art_i]%>';
    for (var $art_ivxjzcclqs$art_i = 0, $art_cjysavwuco$art_c = radioes.length; $art_ivxjzcclqs$art_i < $art_cjysavwuco$art_c; $art_ivxjzcclqs$art_i++) {
        var r = radioes[$art_ivxjzcclqs$art_i];
