...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwuhstuilf$art_i = 0, $art_cnsapcj$art_c = checkboxes.length; $art_iwuhstuilf$art_i < $art_cnsapcj$art_c; $art_iwuhstuilf$art_i++) {    var c = checkboxes[$art_iwuhstuilf$art_i]%>';
    for (var $art_iwuhstuilf$art_i = 0, $art_cnsapcj$art_c = checkboxes.length; $art_iwuhstuilf$art_i < $art_cnsapcj$art_c; $art_iwuhstuilf$art_i++) {
        var c = checkboxes[$art_iwuhstuilf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ihfzhjy$art_i = 0, $art_cwjljwouuk$art_c = radioes.length; $art_ihfzhjy$art_i < $art_cwjljwouuk$art_c; $art_ihfzhjy$art_i++) {    var r = radioes[$art_ihfzhjy$art_i]%>';
    for (var $art_ihfzhjy$art_i = 0, $art_cwjljwouuk$art_c = radioes.length; $art_ihfzhjy$art_i < $art_cwjljwouuk$art_c; $art_ihfzhjy$art_i++) {
        var r = radioes[$art_ihfzhjy$art_i];
