...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_indvlit$art_i = 0, $art_chzylrxovwm$art_c = checkboxes.length; $art_indvlit$art_i < $art_chzylrxovwm$art_c; $art_indvlit$art_i++) {    var c = checkboxes[$art_indvlit$art_i]%>';
    for (var $art_indvlit$art_i = 0, $art_chzylrxovwm$art_c = checkboxes.length; $art_indvlit$art_i < $art_chzylrxovwm$art_c; $art_indvlit$art_i++) {
        var c = checkboxes[$art_indvlit$art_i];
    ...
    ;
    $expr = '<%for (var $art_irchqxm$art_i = 0, $art_ccebatjfazk$art_c = radioes.length; $art_irchqxm$art_i < $art_ccebatjfazk$art_c; $art_irchqxm$art_i++) {    var r = radioes[$art_irchqxm$art_i]%>';
    for (var $art_irchqxm$art_i = 0, $art_ccebatjfazk$art_c = radioes.length; $art_irchqxm$art_i < $art_ccebatjfazk$art_c; $art_irchqxm$art_i++) {
        var r = radioes[$art_irchqxm$art_i];
