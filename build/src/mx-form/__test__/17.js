...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iezshmds$art_i = 0, $art_codajiglmkk$art_c = checkboxes.length; $art_iezshmds$art_i < $art_codajiglmkk$art_c; $art_iezshmds$art_i++) {    var c = checkboxes[$art_iezshmds$art_i]%>';
    for (var $art_iezshmds$art_i = 0, $art_codajiglmkk$art_c = checkboxes.length; $art_iezshmds$art_i < $art_codajiglmkk$art_c; $art_iezshmds$art_i++) {
        var c = checkboxes[$art_iezshmds$art_i];
    ...
    ;
    $expr = '<%for (var $art_iudfnucgg$art_i = 0, $art_cbskbxhpi$art_c = radioes.length; $art_iudfnucgg$art_i < $art_cbskbxhpi$art_c; $art_iudfnucgg$art_i++) {    var r = radioes[$art_iudfnucgg$art_i]%>';
    for (var $art_iudfnucgg$art_i = 0, $art_cbskbxhpi$art_c = radioes.length; $art_iudfnucgg$art_i < $art_cbskbxhpi$art_c; $art_iudfnucgg$art_i++) {
        var r = radioes[$art_iudfnucgg$art_i];
