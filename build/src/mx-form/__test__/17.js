...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icbocpctau$art_i = 0, $art_cuzxbcb$art_c = checkboxes.length; $art_icbocpctau$art_i < $art_cuzxbcb$art_c; $art_icbocpctau$art_i++) {    var c = checkboxes[$art_icbocpctau$art_i]%>';
    for (var $art_icbocpctau$art_i = 0, $art_cuzxbcb$art_c = checkboxes.length; $art_icbocpctau$art_i < $art_cuzxbcb$art_c; $art_icbocpctau$art_i++) {
        var c = checkboxes[$art_icbocpctau$art_i];
    ...
    ;
    $expr = '<%for (var $art_isafgshg$art_i = 0, $art_cfvjqrwoks$art_c = radioes.length; $art_isafgshg$art_i < $art_cfvjqrwoks$art_c; $art_isafgshg$art_i++) {    var r = radioes[$art_isafgshg$art_i]%>';
    for (var $art_isafgshg$art_i = 0, $art_cfvjqrwoks$art_c = radioes.length; $art_isafgshg$art_i < $art_cfvjqrwoks$art_c; $art_isafgshg$art_i++) {
        var r = radioes[$art_isafgshg$art_i];
