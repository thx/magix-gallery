...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iydzrxcdpf$art_i = 0, $art_chocaymhok$art_c = checkboxes.length; $art_iydzrxcdpf$art_i < $art_chocaymhok$art_c; $art_iydzrxcdpf$art_i++) {    var c = checkboxes[$art_iydzrxcdpf$art_i]%>';
    for (var $art_iydzrxcdpf$art_i = 0, $art_chocaymhok$art_c = checkboxes.length; $art_iydzrxcdpf$art_i < $art_chocaymhok$art_c; $art_iydzrxcdpf$art_i++) {
        var c = checkboxes[$art_iydzrxcdpf$art_i];
    ...
    ;
    $expr = '<%for (var $art_ivvmmhmfwod$art_i = 0, $art_czodfvomug$art_c = radioes.length; $art_ivvmmhmfwod$art_i < $art_czodfvomug$art_c; $art_ivvmmhmfwod$art_i++) {    var r = radioes[$art_ivvmmhmfwod$art_i]%>';
    for (var $art_ivvmmhmfwod$art_i = 0, $art_czodfvomug$art_c = radioes.length; $art_ivvmmhmfwod$art_i < $art_czodfvomug$art_c; $art_ivvmmhmfwod$art_i++) {
        var r = radioes[$art_ivvmmhmfwod$art_i];
