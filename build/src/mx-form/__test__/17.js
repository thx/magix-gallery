...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ikabjrwj$art_i = 0, $art_czuvtdv$art_c = checkboxes.length; $art_ikabjrwj$art_i < $art_czuvtdv$art_c; $art_ikabjrwj$art_i++) {    var c = checkboxes[$art_ikabjrwj$art_i]%>';
    for (var $art_ikabjrwj$art_i = 0, $art_czuvtdv$art_c = checkboxes.length; $art_ikabjrwj$art_i < $art_czuvtdv$art_c; $art_ikabjrwj$art_i++) {
        var c = checkboxes[$art_ikabjrwj$art_i];
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ishkqog$art_i = 0, $art_cnuiiqhey$art_c = radioes.length; $art_ishkqog$art_i < $art_cnuiiqhey$art_c; $art_ishkqog$art_i++) {    var r = radioes[$art_ishkqog$art_i]%>';
    for (var $art_ishkqog$art_i = 0, $art_cnuiiqhey$art_c = radioes.length; $art_ishkqog$art_i < $art_cnuiiqhey$art_c; $art_ishkqog$art_i++) {
        var r = radioes[$art_ishkqog$art_i];
