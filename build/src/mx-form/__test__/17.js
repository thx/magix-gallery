...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ideaqkkng$art_i = 0, $art_crlwyngrvd$art_c = checkboxes.length; $art_ideaqkkng$art_i < $art_crlwyngrvd$art_c; $art_ideaqkkng$art_i++) {    var c = checkboxes[$art_ideaqkkng$art_i]%>';
    for (var $art_ideaqkkng$art_i = 0, $art_crlwyngrvd$art_c = checkboxes.length; $art_ideaqkkng$art_i < $art_crlwyngrvd$art_c; $art_ideaqkkng$art_i++) {
        var c = checkboxes[$art_ideaqkkng$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqahrmgi$art_i = 0, $art_cuclcxsbh$art_c = radioes.length; $art_iqahrmgi$art_i < $art_cuclcxsbh$art_c; $art_iqahrmgi$art_i++) {    var r = radioes[$art_iqahrmgi$art_i]%>';
    for (var $art_iqahrmgi$art_i = 0, $art_cuclcxsbh$art_c = radioes.length; $art_iqahrmgi$art_i < $art_cuclcxsbh$art_c; $art_iqahrmgi$art_i++) {
        var r = radioes[$art_iqahrmgi$art_i];
