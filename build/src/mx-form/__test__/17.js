...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idnbqoubrt$art_i = 0, $art_clamcgftpi$art_c = checkboxes.length; $art_idnbqoubrt$art_i < $art_clamcgftpi$art_c; $art_idnbqoubrt$art_i++) {    var c = checkboxes[$art_idnbqoubrt$art_i]%>';
    for (var $art_idnbqoubrt$art_i = 0, $art_clamcgftpi$art_c = checkboxes.length; $art_idnbqoubrt$art_i < $art_clamcgftpi$art_c; $art_idnbqoubrt$art_i++) {
        var c = checkboxes[$art_idnbqoubrt$art_i];
    ...
    ;
    $expr = '<%for (var $art_iskadyfajex$art_i = 0, $art_cklgequyjp$art_c = radioes.length; $art_iskadyfajex$art_i < $art_cklgequyjp$art_c; $art_iskadyfajex$art_i++) {    var r = radioes[$art_iskadyfajex$art_i]%>';
    for (var $art_iskadyfajex$art_i = 0, $art_cklgequyjp$art_c = radioes.length; $art_iskadyfajex$art_i < $art_cklgequyjp$art_c; $art_iskadyfajex$art_i++) {
        var r = radioes[$art_iskadyfajex$art_i];
