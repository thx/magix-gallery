...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilrxppyxqj$art_i = 0, $art_cliuzetryq$art_c = checkboxes.length; $art_ilrxppyxqj$art_i < $art_cliuzetryq$art_c; $art_ilrxppyxqj$art_i++) {    var c = checkboxes[$art_ilrxppyxqj$art_i]%>';
    for (var $art_ilrxppyxqj$art_i = 0, $art_cliuzetryq$art_c = checkboxes.length; $art_ilrxppyxqj$art_i < $art_cliuzetryq$art_c; $art_ilrxppyxqj$art_i++) {
        var c = checkboxes[$art_ilrxppyxqj$art_i];
    ...
    ;
    $expr = '<%for (var $art_izrgagxf$art_i = 0, $art_capzgteazzc$art_c = radioes.length; $art_izrgagxf$art_i < $art_capzgteazzc$art_c; $art_izrgagxf$art_i++) {    var r = radioes[$art_izrgagxf$art_i]%>';
    for (var $art_izrgagxf$art_i = 0, $art_capzgteazzc$art_c = radioes.length; $art_izrgagxf$art_i < $art_capzgteazzc$art_c; $art_izrgagxf$art_i++) {
        var r = radioes[$art_izrgagxf$art_i];
