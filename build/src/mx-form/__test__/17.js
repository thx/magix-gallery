...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixbvsrbypm$art_i = 0, $art_ccfucbo$art_c = checkboxes.length; $art_ixbvsrbypm$art_i < $art_ccfucbo$art_c; $art_ixbvsrbypm$art_i++) {    var c = checkboxes[$art_ixbvsrbypm$art_i]%>';
    for (var $art_ixbvsrbypm$art_i = 0, $art_ccfucbo$art_c = checkboxes.length; $art_ixbvsrbypm$art_i < $art_ccfucbo$art_c; $art_ixbvsrbypm$art_i++) {
        var c = checkboxes[$art_ixbvsrbypm$art_i];
    ...
    ;
    $expr = '<%for (var $art_iemqwsmiube$art_i = 0, $art_cemujae$art_c = radioes.length; $art_iemqwsmiube$art_i < $art_cemujae$art_c; $art_iemqwsmiube$art_i++) {    var r = radioes[$art_iemqwsmiube$art_i]%>';
    for (var $art_iemqwsmiube$art_i = 0, $art_cemujae$art_c = radioes.length; $art_iemqwsmiube$art_i < $art_cemujae$art_c; $art_iemqwsmiube$art_i++) {
        var r = radioes[$art_iemqwsmiube$art_i];
