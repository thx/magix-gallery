...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isrirepda$art_i = 0, $art_chbcqnbzu$art_c = checkboxes.length; $art_isrirepda$art_i < $art_chbcqnbzu$art_c; $art_isrirepda$art_i++) {    var c = checkboxes[$art_isrirepda$art_i]%>';
    for (var $art_isrirepda$art_i = 0, $art_chbcqnbzu$art_c = checkboxes.length; $art_isrirepda$art_i < $art_chbcqnbzu$art_c; $art_isrirepda$art_i++) {
        var c = checkboxes[$art_isrirepda$art_i];
    ...
    ;
    $expr = '<%for (var $art_ioxjrue$art_i = 0, $art_cfnytko$art_c = radioes.length; $art_ioxjrue$art_i < $art_cfnytko$art_c; $art_ioxjrue$art_i++) {    var r = radioes[$art_ioxjrue$art_i]%>';
    for (var $art_ioxjrue$art_i = 0, $art_cfnytko$art_c = radioes.length; $art_ioxjrue$art_i < $art_cfnytko$art_c; $art_ioxjrue$art_i++) {
        var r = radioes[$art_ioxjrue$art_i];
