...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_izuvwxijt$art_i = 0, $art_csbnlslqeb$art_c = checkboxes.length; $art_izuvwxijt$art_i < $art_csbnlslqeb$art_c; $art_izuvwxijt$art_i++) {    var c = checkboxes[$art_izuvwxijt$art_i]%>';
    for (var $art_izuvwxijt$art_i = 0, $art_csbnlslqeb$art_c = checkboxes.length; $art_izuvwxijt$art_i < $art_csbnlslqeb$art_c; $art_izuvwxijt$art_i++) {
        var c = checkboxes[$art_izuvwxijt$art_i];
    ...
    ;
    $expr = '<%for (var $art_iqzkvwk$art_i = 0, $art_capyalt$art_c = radioes.length; $art_iqzkvwk$art_i < $art_capyalt$art_c; $art_iqzkvwk$art_i++) {    var r = radioes[$art_iqzkvwk$art_i]%>';
    for (var $art_iqzkvwk$art_i = 0, $art_capyalt$art_c = radioes.length; $art_iqzkvwk$art_i < $art_capyalt$art_c; $art_iqzkvwk$art_i++) {
        var r = radioes[$art_iqzkvwk$art_i];
