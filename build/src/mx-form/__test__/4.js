...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya4:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya4:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya4:b" class="mb20"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    $art = ':number{number:true}';
    ;
    $p += '{p:\'number\',f:{number:true}}]" class="input mr60" placeholder="数字" value="';
    $line = 4;
    $art = ':number{number:true}';
    ;
    ...
    $art = ':int{int:true}';
    ;
    $p += '{p:\'int\',f:{int:true}}]" class="input mr60" placeholder="整数" value="';
    $line = 5;
    $art = ':int{int:true}';
    ;
    ...
    ;
    $p += '{p:\'posint\',f:{posint:[true,\'自定义提示输入正整数\']}}]" class="input mr60" placeholder="正整数" value="';
    $line = 6;
    $art = ':posint{posint:[true,\'自定义提示输入正整数\']}';
    ;
    ...
    ;
    $p += '{p:\'negint\',f:{negint:[true,\'自定义提示输入负整数\']}}]" class="input mr60" placeholder="负整数" value="';
    $line = 7;
    $art = ':negint{negint:[true,\'自定义提示输入负整数\']}';
    ;
    $p += '' + ($expr = '<%=negint%>', $e(negint)) + '"/></div></div><div mxa="_zs_gallerya4:c" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerya4:_" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
