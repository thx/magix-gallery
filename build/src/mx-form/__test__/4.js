...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya5:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya5:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya5:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':negint{negint:[true,\'自定义提示输入负整数\']}';
    ;
    $p += '' + ($expr = '<%=negint%>', $e(negint)) + '"/></div></div><div mxa="_zs_gallerya5:c" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerya5:_" class="_zs_gallery___test___base_-eg-title">整数</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
