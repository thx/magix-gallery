...
module.exports = Base.extend({
    ...
    $art = ':negint{negint:[true,\'自定义提示输入负整数\']}';
    ;
    $p += ($expr = '<%=negint%>', $e(negint)) + '"/></div></div><div mxa="_zs_gallerybo:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybo:_" class="_zs_gallery___test___layout_-eg-title">整数</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
