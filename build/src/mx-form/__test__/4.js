...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya6:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya6:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya6:b" class="mb20"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':negint{negint:[true,\'自定义提示输入负整数\']}';
    ;
    $p += '' + ($expr = '<%=negint%>', $e(negint)) + '"/></div></div><div mxa="_zs_gallerya6:c" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerya6:_" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
