...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifodetf$art_i = 0, $art_cnudsju$art_c = list.length; $art_ifodetf$art_i < $art_cnudsju$art_c; $art_ifodetf$art_i++) {    var item = list[$art_ifodetf$art_i]%>';
    for (var $art_ifodetf$art_i = 0, $art_cnudsju$art_c = list.length; $art_ifodetf$art_i < $art_cnudsju$art_c; $art_ifodetf$art_i++) {
        var item = list[$art_ifodetf$art_i];
