...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idsyljra$art_i = 0, $art_cnsub$art_c = list.length; $art_idsyljra$art_i < $art_cnsub$art_c; $art_idsyljra$art_i++) {    var item = list[$art_idsyljra$art_i]%>';
    for (var $art_idsyljra$art_i = 0, $art_cnsub$art_c = list.length; $art_idsyljra$art_i < $art_cnsub$art_c; $art_idsyljra$art_i++) {
        var item = list[$art_idsyljra$art_i];
