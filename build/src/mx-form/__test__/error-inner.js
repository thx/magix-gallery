...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibbxal$art_i = 0, $art_cnwcvds$art_c = list.length; $art_ibbxal$art_i < $art_cnwcvds$art_c; $art_ibbxal$art_i++) {    var item = list[$art_ibbxal$art_i]%>';
    for (var $art_ibbxal$art_i = 0, $art_cnwcvds$art_c = list.length; $art_ibbxal$art_i < $art_cnwcvds$art_c; $art_ibbxal$art_i++) {
        var item = list[$art_ibbxal$art_i];
