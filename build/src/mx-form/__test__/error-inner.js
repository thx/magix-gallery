...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irtirctd$art_i = 0, $art_cupuict$art_c = list.length; $art_irtirctd$art_i < $art_cupuict$art_c; $art_irtirctd$art_i++) {    var item = list[$art_irtirctd$art_i]%>';
    for (var $art_irtirctd$art_i = 0, $art_cupuict$art_c = list.length; $art_irtirctd$art_i < $art_cupuict$art_c; $art_irtirctd$art_i++) {
        var item = list[$art_irtirctd$art_i];
