...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifoju$art_i = 0, $art_cxuqhubj$art_c = list.length; $art_ifoju$art_i < $art_cxuqhubj$art_c; $art_ifoju$art_i++) {    var item = list[$art_ifoju$art_i]%>';
    for (var $art_ifoju$art_i = 0, $art_cxuqhubj$art_c = list.length; $art_ifoju$art_i < $art_cxuqhubj$art_c; $art_ifoju$art_i++) {
        var item = list[$art_ifoju$art_i];
