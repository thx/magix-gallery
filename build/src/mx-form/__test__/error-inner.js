...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iujifycrnss$art_i = 0, $art_cdmcjfh$art_c = list.length; $art_iujifycrnss$art_i < $art_cdmcjfh$art_c; $art_iujifycrnss$art_i++) {    var item = list[$art_iujifycrnss$art_i]%>';
    for (var $art_iujifycrnss$art_i = 0, $art_cdmcjfh$art_c = list.length; $art_iujifycrnss$art_i < $art_cdmcjfh$art_c; $art_iujifycrnss$art_i++) {
        var item = list[$art_iujifycrnss$art_i];
