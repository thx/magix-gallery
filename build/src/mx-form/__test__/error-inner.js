...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_intvgrxzb$art_i = 0, $art_cuttnwucftq$art_c = list.length; $art_intvgrxzb$art_i < $art_cuttnwucftq$art_c; $art_intvgrxzb$art_i++) {    var item = list[$art_intvgrxzb$art_i]%>';
    for (var $art_intvgrxzb$art_i = 0, $art_cuttnwucftq$art_c = list.length; $art_intvgrxzb$art_i < $art_cuttnwucftq$art_c; $art_intvgrxzb$art_i++) {
        var item = list[$art_intvgrxzb$art_i];
