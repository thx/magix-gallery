...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivxhvshljm$art_i = 0, $art_cuusonitz$art_c = list.length; $art_ivxhvshljm$art_i < $art_cuusonitz$art_c; $art_ivxhvshljm$art_i++) {    var item = list[$art_ivxhvshljm$art_i]%>';
    for (var $art_ivxhvshljm$art_i = 0, $art_cuusonitz$art_c = list.length; $art_ivxhvshljm$art_i < $art_cuusonitz$art_c; $art_ivxhvshljm$art_i++) {
        var item = list[$art_ivxhvshljm$art_i];
        $p += '<label mxv mxa="_zs_galleryb6:_" class="mr30"><input mxe="' + $viewId + '_0" mxc="[';
        $line = 6;
