...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijoosvww$art_i = 0, $art_cuuxzslst$art_c = list.length; $art_ijoosvww$art_i < $art_cuuxzslst$art_c; $art_ijoosvww$art_i++) {    var item = list[$art_ijoosvww$art_i]%>';
    for (var $art_ijoosvww$art_i = 0, $art_cuuxzslst$art_c = list.length; $art_ijoosvww$art_i < $art_cuuxzslst$art_c; $art_ijoosvww$art_i++) {
        var item = list[$art_ijoosvww$art_i];
        $p += '<label mxv mxa="_zs_gallerycb:_" class="mr30"><input mxe="' + $viewId + '_0" mxc="[';
        $line = 6;
