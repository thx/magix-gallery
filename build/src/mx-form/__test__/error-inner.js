...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iznrudbxhj$art_i = 0, $art_chcqsr$art_c = list.length; $art_iznrudbxhj$art_i < $art_chcqsr$art_c; $art_iznrudbxhj$art_i++) {    var item = list[$art_iznrudbxhj$art_i]%>';
    for (var $art_iznrudbxhj$art_i = 0, $art_chcqsr$art_c = list.length; $art_iznrudbxhj$art_i < $art_chcqsr$art_c; $art_iznrudbxhj$art_i++) {
        var item = list[$art_iznrudbxhj$art_i];
        $p += '<label mxv mxa="_zs_galleryex:a" class="mr30"><input mxe="' + $viewId + '_0" mxc="[';
        $line = 6;
