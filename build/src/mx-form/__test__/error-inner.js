...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihoumfnjxr$art_i = 0, $art_czpldnbgk$art_c = list.length; $art_ihoumfnjxr$art_i < $art_czpldnbgk$art_c; $art_ihoumfnjxr$art_i++) {    var item = list[$art_ihoumfnjxr$art_i]%>';
    for (var $art_ihoumfnjxr$art_i = 0, $art_czpldnbgk$art_c = list.length; $art_ihoumfnjxr$art_i < $art_czpldnbgk$art_c; $art_ihoumfnjxr$art_i++) {
        var item = list[$art_ihoumfnjxr$art_i];
