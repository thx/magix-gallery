...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icfnxdrf$art_i = 0, $art_czensmwkg$art_c = list.length; $art_icfnxdrf$art_i < $art_czensmwkg$art_c; $art_icfnxdrf$art_i++) {    var item = list[$art_icfnxdrf$art_i]%>';
    for (var $art_icfnxdrf$art_i = 0, $art_czensmwkg$art_c = list.length; $art_icfnxdrf$art_i < $art_czensmwkg$art_c; $art_icfnxdrf$art_i++) {
        var item = list[$art_icfnxdrf$art_i];
