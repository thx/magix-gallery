...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibfwfun$art_i = 0, $art_cerdei$art_c = list.length; $art_ibfwfun$art_i < $art_cerdei$art_c; $art_ibfwfun$art_i++) {    var item = list[$art_ibfwfun$art_i]%>';
    for (var $art_ibfwfun$art_i = 0, $art_cerdei$art_c = list.length; $art_ibfwfun$art_i < $art_cerdei$art_c; $art_ibfwfun$art_i++) {
        var item = list[$art_ibfwfun$art_i];
