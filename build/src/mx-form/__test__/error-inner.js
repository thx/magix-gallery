...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijxazpe$art_i = 0, $art_csypznmlwu$art_c = list.length; $art_ijxazpe$art_i < $art_csypznmlwu$art_c; $art_ijxazpe$art_i++) {    var item = list[$art_ijxazpe$art_i]%>';
    for (var $art_ijxazpe$art_i = 0, $art_csypznmlwu$art_c = list.length; $art_ijxazpe$art_i < $art_csypznmlwu$art_c; $art_ijxazpe$art_i++) {
        var item = list[$art_ijxazpe$art_i];
