...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifrntyili$art_i = 0, $art_cvsyakhfj$art_c = list.length; $art_ifrntyili$art_i < $art_cvsyakhfj$art_c; $art_ifrntyili$art_i++) {    var item = list[$art_ifrntyili$art_i]%>';
    for (var $art_ifrntyili$art_i = 0, $art_cvsyakhfj$art_c = list.length; $art_ifrntyili$art_i < $art_cvsyakhfj$art_c; $art_ifrntyili$art_i++) {
        var item = list[$art_ifrntyili$art_i];
