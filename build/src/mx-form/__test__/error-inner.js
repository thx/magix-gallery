...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igfgkag$art_i = 0, $art_cylevk$art_c = list.length; $art_igfgkag$art_i < $art_cylevk$art_c; $art_igfgkag$art_i++) {    var item = list[$art_igfgkag$art_i]%>';
    for (var $art_igfgkag$art_i = 0, $art_cylevk$art_c = list.length; $art_igfgkag$art_i < $art_cylevk$art_c; $art_igfgkag$art_i++) {
        var item = list[$art_igfgkag$art_i];
