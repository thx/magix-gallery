...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipefdjygh$art_i = 0, $art_cnzlqxg$art_c = list.length; $art_ipefdjygh$art_i < $art_cnzlqxg$art_c; $art_ipefdjygh$art_i++) {    var item = list[$art_ipefdjygh$art_i]%>';
    for (var $art_ipefdjygh$art_i = 0, $art_cnzlqxg$art_c = list.length; $art_ipefdjygh$art_i < $art_cnzlqxg$art_c; $art_ipefdjygh$art_i++) {
        var item = list[$art_ipefdjygh$art_i];
