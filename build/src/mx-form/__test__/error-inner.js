...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivkdqreg$art_i = 0, $art_cvtwvjdyyc$art_c = list.length; $art_ivkdqreg$art_i < $art_cvtwvjdyyc$art_c; $art_ivkdqreg$art_i++) {    var item = list[$art_ivkdqreg$art_i]%>';
    for (var $art_ivkdqreg$art_i = 0, $art_cvtwvjdyyc$art_c = list.length; $art_ivkdqreg$art_i < $art_cvtwvjdyyc$art_c; $art_ivkdqreg$art_i++) {
        var item = list[$art_ivkdqreg$art_i];
