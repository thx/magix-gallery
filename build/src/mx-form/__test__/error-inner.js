...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipdhapdjj$art_i = 0, $art_cczbsouearte$art_c = list.length; $art_ipdhapdjj$art_i < $art_cczbsouearte$art_c; $art_ipdhapdjj$art_i++) {    var item = list[$art_ipdhapdjj$art_i]%>';
    for (var $art_ipdhapdjj$art_i = 0, $art_cczbsouearte$art_c = list.length; $art_ipdhapdjj$art_i < $art_cczbsouearte$art_c; $art_ipdhapdjj$art_i++) {
        var item = list[$art_ipdhapdjj$art_i];
