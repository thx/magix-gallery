...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imxkolibar$art_i = 0, $art_cgeatwks$art_c = list.length; $art_imxkolibar$art_i < $art_cgeatwks$art_c; $art_imxkolibar$art_i++) {    var item = list[$art_imxkolibar$art_i]%>';
    for (var $art_imxkolibar$art_i = 0, $art_cgeatwks$art_c = list.length; $art_imxkolibar$art_i < $art_cgeatwks$art_c; $art_imxkolibar$art_i++) {
        var item = list[$art_imxkolibar$art_i];
