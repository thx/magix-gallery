...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihaajjsd$art_i = 0, $art_ckaciyjjm$art_c = list.length; $art_ihaajjsd$art_i < $art_ckaciyjjm$art_c; $art_ihaajjsd$art_i++) {    var item = list[$art_ihaajjsd$art_i]%>';
    for (var $art_ihaajjsd$art_i = 0, $art_ckaciyjjm$art_c = list.length; $art_ihaajjsd$art_i < $art_ckaciyjjm$art_c; $art_ihaajjsd$art_i++) {
        var item = list[$art_ihaajjsd$art_i];
