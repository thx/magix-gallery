...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inbeiuas$art_i = 0, $art_ckubvvkeqk$art_c = list.length; $art_inbeiuas$art_i < $art_ckubvvkeqk$art_c; $art_inbeiuas$art_i++) {    var item = list[$art_inbeiuas$art_i]%>';
    for (var $art_inbeiuas$art_i = 0, $art_ckubvvkeqk$art_c = list.length; $art_inbeiuas$art_i < $art_ckubvvkeqk$art_c; $art_inbeiuas$art_i++) {
        var item = list[$art_inbeiuas$art_i];
