...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivucxwltd$art_i = 0, $art_ckwmffvfhw$art_c = list.length; $art_ivucxwltd$art_i < $art_ckwmffvfhw$art_c; $art_ivucxwltd$art_i++) {    var item = list[$art_ivucxwltd$art_i]%>';
    for (var $art_ivucxwltd$art_i = 0, $art_ckwmffvfhw$art_c = list.length; $art_ivucxwltd$art_i < $art_ckwmffvfhw$art_c; $art_ivucxwltd$art_i++) {
        var item = list[$art_ivucxwltd$art_i];
