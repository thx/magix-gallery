...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwirhvbha$art_i = 0, $art_chznljssk$art_c = list.length; $art_iwirhvbha$art_i < $art_chznljssk$art_c; $art_iwirhvbha$art_i++) {    var item = list[$art_iwirhvbha$art_i]%>';
    for (var $art_iwirhvbha$art_i = 0, $art_chznljssk$art_c = list.length; $art_iwirhvbha$art_i < $art_chznljssk$art_c; $art_iwirhvbha$art_i++) {
        var item = list[$art_iwirhvbha$art_i];
