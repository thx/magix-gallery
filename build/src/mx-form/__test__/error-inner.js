...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itoiubm$art_i = 0, $art_cxyvuev$art_c = list.length; $art_itoiubm$art_i < $art_cxyvuev$art_c; $art_itoiubm$art_i++) {    var item = list[$art_itoiubm$art_i]%>';
    for (var $art_itoiubm$art_i = 0, $art_cxyvuev$art_c = list.length; $art_itoiubm$art_i < $art_cxyvuev$art_c; $art_itoiubm$art_i++) {
        var item = list[$art_itoiubm$art_i];
