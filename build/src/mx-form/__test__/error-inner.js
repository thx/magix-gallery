...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihmcjut$art_i = 0, $art_caeatuujxfdk$art_c = list.length; $art_ihmcjut$art_i < $art_caeatuujxfdk$art_c; $art_ihmcjut$art_i++) {    var item = list[$art_ihmcjut$art_i]%>';
    for (var $art_ihmcjut$art_i = 0, $art_caeatuujxfdk$art_c = list.length; $art_ihmcjut$art_i < $art_caeatuujxfdk$art_c; $art_ihmcjut$art_i++) {
        var item = list[$art_ihmcjut$art_i];
