...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iapsggeqiook$art_i = 0, $art_cbquwqrs$art_c = list.length; $art_iapsggeqiook$art_i < $art_cbquwqrs$art_c; $art_iapsggeqiook$art_i++) {    var item = list[$art_iapsggeqiook$art_i]%>';
    for (var $art_iapsggeqiook$art_i = 0, $art_cbquwqrs$art_c = list.length; $art_iapsggeqiook$art_i < $art_cbquwqrs$art_c; $art_iapsggeqiook$art_i++) {
        var item = list[$art_iapsggeqiook$art_i];
