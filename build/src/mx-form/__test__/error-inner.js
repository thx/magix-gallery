...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igwccua$art_i = 0, $art_cweojsug$art_c = list.length; $art_igwccua$art_i < $art_cweojsug$art_c; $art_igwccua$art_i++) {    var item = list[$art_igwccua$art_i]%>';
    for (var $art_igwccua$art_i = 0, $art_cweojsug$art_c = list.length; $art_igwccua$art_i < $art_cweojsug$art_c; $art_igwccua$art_i++) {
        var item = list[$art_igwccua$art_i];
