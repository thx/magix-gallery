...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isfmlizm$art_i = 0, $art_cyomgqmj$art_c = list.length; $art_isfmlizm$art_i < $art_cyomgqmj$art_c; $art_isfmlizm$art_i++) {    var item = list[$art_isfmlizm$art_i]%>';
    for (var $art_isfmlizm$art_i = 0, $art_cyomgqmj$art_c = list.length; $art_isfmlizm$art_i < $art_cyomgqmj$art_c; $art_isfmlizm$art_i++) {
        var item = list[$art_isfmlizm$art_i];
