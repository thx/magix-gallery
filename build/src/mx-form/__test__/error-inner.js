...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifzgeqzpka$art_i = 0, $art_clsofkltp$art_c = list.length; $art_ifzgeqzpka$art_i < $art_clsofkltp$art_c; $art_ifzgeqzpka$art_i++) {    var item = list[$art_ifzgeqzpka$art_i]%>';
    for (var $art_ifzgeqzpka$art_i = 0, $art_clsofkltp$art_c = list.length; $art_ifzgeqzpka$art_i < $art_clsofkltp$art_c; $art_ifzgeqzpka$art_i++) {
        var item = list[$art_ifzgeqzpka$art_i];
        $p += '<label mxv mxa="_zs_galleryb1:_" class="mr30"><input mxe="' + $viewId + '_0" mxc="[';
        $line = 6;
