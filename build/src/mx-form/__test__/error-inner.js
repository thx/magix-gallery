...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ictwrvqh$art_i = 0, $art_cbkljmeqnt$art_c = list.length; $art_ictwrvqh$art_i < $art_cbkljmeqnt$art_c; $art_ictwrvqh$art_i++) {    var item = list[$art_ictwrvqh$art_i]%>';
    for (var $art_ictwrvqh$art_i = 0, $art_cbkljmeqnt$art_c = list.length; $art_ictwrvqh$art_i < $art_cbkljmeqnt$art_c; $art_ictwrvqh$art_i++) {
        var item = list[$art_ictwrvqh$art_i];
