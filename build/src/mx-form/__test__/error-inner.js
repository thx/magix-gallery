...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwculbp$art_i = 0, $art_cquvktgb$art_c = list.length; $art_iwculbp$art_i < $art_cquvktgb$art_c; $art_iwculbp$art_i++) {    var item = list[$art_iwculbp$art_i]%>';
    for (var $art_iwculbp$art_i = 0, $art_cquvktgb$art_c = list.length; $art_iwculbp$art_i < $art_cquvktgb$art_c; $art_iwculbp$art_i++) {
        var item = list[$art_iwculbp$art_i];
