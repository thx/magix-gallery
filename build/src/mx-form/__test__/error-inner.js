...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijhihobmx$art_i = 0, $art_cfcuxcvs$art_c = list.length; $art_ijhihobmx$art_i < $art_cfcuxcvs$art_c; $art_ijhihobmx$art_i++) {    var item = list[$art_ijhihobmx$art_i]%>';
    for (var $art_ijhihobmx$art_i = 0, $art_cfcuxcvs$art_c = list.length; $art_ijhihobmx$art_i < $art_cfcuxcvs$art_c; $art_ijhihobmx$art_i++) {
        var item = list[$art_ijhihobmx$art_i];
