...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_isnxiqdj$art_i = 0, $art_cfakljvdm$art_c = list.length; $art_isnxiqdj$art_i < $art_cfakljvdm$art_c; $art_isnxiqdj$art_i++) {    var item = list[$art_isnxiqdj$art_i]%>';
    for (var $art_isnxiqdj$art_i = 0, $art_cfakljvdm$art_c = list.length; $art_isnxiqdj$art_i < $art_cfakljvdm$art_c; $art_isnxiqdj$art_i++) {
        var item = list[$art_isnxiqdj$art_i];
