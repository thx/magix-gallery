...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibgpchaldhi$art_i = 0, $art_chtmugjnvw$art_c = list.length; $art_ibgpchaldhi$art_i < $art_chtmugjnvw$art_c; $art_ibgpchaldhi$art_i++) {    var item = list[$art_ibgpchaldhi$art_i]%>';
    for (var $art_ibgpchaldhi$art_i = 0, $art_chtmugjnvw$art_c = list.length; $art_ibgpchaldhi$art_i < $art_chtmugjnvw$art_c; $art_ibgpchaldhi$art_i++) {
        var item = list[$art_ibgpchaldhi$art_i];
