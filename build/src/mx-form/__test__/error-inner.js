...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izqsmmjgexf$art_i = 0, $art_cldgomfrlmj$art_c = list.length; $art_izqsmmjgexf$art_i < $art_cldgomfrlmj$art_c; $art_izqsmmjgexf$art_i++) {    var item = list[$art_izqsmmjgexf$art_i]%>';
    for (var $art_izqsmmjgexf$art_i = 0, $art_cldgomfrlmj$art_c = list.length; $art_izqsmmjgexf$art_i < $art_cldgomfrlmj$art_c; $art_izqsmmjgexf$art_i++) {
        var item = list[$art_izqsmmjgexf$art_i];
