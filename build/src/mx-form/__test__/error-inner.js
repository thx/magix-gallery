...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itblpsxhk$art_i = 0, $art_coziyoldpb$art_c = list.length; $art_itblpsxhk$art_i < $art_coziyoldpb$art_c; $art_itblpsxhk$art_i++) {    var item = list[$art_itblpsxhk$art_i]%>';
    for (var $art_itblpsxhk$art_i = 0, $art_coziyoldpb$art_c = list.length; $art_itblpsxhk$art_i < $art_coziyoldpb$art_c; $art_itblpsxhk$art_i++) {
        var item = list[$art_itblpsxhk$art_i];
