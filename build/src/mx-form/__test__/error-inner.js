...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_inpngak$art_i = 0, $art_cpexpkbw$art_c = list.length; $art_inpngak$art_i < $art_cpexpkbw$art_c; $art_inpngak$art_i++) {    var item = list[$art_inpngak$art_i]%>';
    for (var $art_inpngak$art_i = 0, $art_cpexpkbw$art_c = list.length; $art_inpngak$art_i < $art_cpexpkbw$art_c; $art_inpngak$art_i++) {
        var item = list[$art_inpngak$art_i];
