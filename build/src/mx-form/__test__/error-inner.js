...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixvfolutg$art_i = 0, $art_cfdzfit$art_c = list.length; $art_ixvfolutg$art_i < $art_cfdzfit$art_c; $art_ixvfolutg$art_i++) {    var item = list[$art_ixvfolutg$art_i]%>';
    for (var $art_ixvfolutg$art_i = 0, $art_cfdzfit$art_c = list.length; $art_ixvfolutg$art_i < $art_cfdzfit$art_c; $art_ixvfolutg$art_i++) {
        var item = list[$art_ixvfolutg$art_i];
