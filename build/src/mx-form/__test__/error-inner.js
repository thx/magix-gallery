...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijfyekjmca$art_i = 0, $art_cmyrcbqquzsh$art_c = list.length; $art_ijfyekjmca$art_i < $art_cmyrcbqquzsh$art_c; $art_ijfyekjmca$art_i++) {    var item = list[$art_ijfyekjmca$art_i]%>';
    for (var $art_ijfyekjmca$art_i = 0, $art_cmyrcbqquzsh$art_c = list.length; $art_ijfyekjmca$art_i < $art_cmyrcbqquzsh$art_c; $art_ijfyekjmca$art_i++) {
        var item = list[$art_ijfyekjmca$art_i];
        $p += '<label mxv mxa="_zs_galleryb8:_" class="mr30"><input mxe="' + $viewId + '_0" mxc="[';
        $line = 6;
