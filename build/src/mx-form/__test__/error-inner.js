...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izsgcsqzq$art_i = 0, $art_cijbrauoz$art_c = list.length; $art_izsgcsqzq$art_i < $art_cijbrauoz$art_c; $art_izsgcsqzq$art_i++) {    var item = list[$art_izsgcsqzq$art_i]%>';
    for (var $art_izsgcsqzq$art_i = 0, $art_cijbrauoz$art_c = list.length; $art_izsgcsqzq$art_i < $art_cijbrauoz$art_c; $art_izsgcsqzq$art_i++) {
        var item = list[$art_izsgcsqzq$art_i];
        $p += '<label mxv mxa="_zs_gallerybI:_" class="mr30"><input mxe="' + $viewId + '_0" mxc="[';
        $line = 6;
