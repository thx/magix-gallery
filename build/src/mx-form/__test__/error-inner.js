...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipgufcabj$art_i = 0, $art_ckysjnh$art_c = list.length; $art_ipgufcabj$art_i < $art_ckysjnh$art_c; $art_ipgufcabj$art_i++) {    var item = list[$art_ipgufcabj$art_i]%>';
    for (var $art_ipgufcabj$art_i = 0, $art_ckysjnh$art_c = list.length; $art_ipgufcabj$art_i < $art_ckysjnh$art_c; $art_ipgufcabj$art_i++) {
        var item = list[$art_ipgufcabj$art_i];
