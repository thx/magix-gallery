...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iptacbz$art_i = 0, $art_crahcoiay$art_c = list.length; $art_iptacbz$art_i < $art_crahcoiay$art_c; $art_iptacbz$art_i++) {    var item = list[$art_iptacbz$art_i]%>';
    for (var $art_iptacbz$art_i = 0, $art_crahcoiay$art_c = list.length; $art_iptacbz$art_i < $art_crahcoiay$art_c; $art_iptacbz$art_i++) {
        var item = list[$art_iptacbz$art_i];
