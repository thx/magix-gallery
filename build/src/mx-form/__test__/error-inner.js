...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_istgjwmrpj$art_i = 0, $art_ckhzjgc$art_c = list.length; $art_istgjwmrpj$art_i < $art_ckhzjgc$art_c; $art_istgjwmrpj$art_i++) {    var item = list[$art_istgjwmrpj$art_i]%>';
    for (var $art_istgjwmrpj$art_i = 0, $art_ckhzjgc$art_c = list.length; $art_istgjwmrpj$art_i < $art_ckhzjgc$art_c; $art_istgjwmrpj$art_i++) {
        var item = list[$art_istgjwmrpj$art_i];
