...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwsbsnabpa$art_i = 0, $art_cmgecffudk$art_c = list.length; $art_iwsbsnabpa$art_i < $art_cmgecffudk$art_c; $art_iwsbsnabpa$art_i++) {    var item = list[$art_iwsbsnabpa$art_i]%>';
    for (var $art_iwsbsnabpa$art_i = 0, $art_cmgecffudk$art_c = list.length; $art_iwsbsnabpa$art_i < $art_cmgecffudk$art_c; $art_iwsbsnabpa$art_i++) {
        var item = list[$art_iwsbsnabpa$art_i];
