...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izjjvdflhgp$art_i = 0, $art_cstcuygea$art_c = list.length; $art_izjjvdflhgp$art_i < $art_cstcuygea$art_c; $art_izjjvdflhgp$art_i++) {    var item = list[$art_izjjvdflhgp$art_i]%>';
    for (var $art_izjjvdflhgp$art_i = 0, $art_cstcuygea$art_c = list.length; $art_izjjvdflhgp$art_i < $art_cstcuygea$art_c; $art_izjjvdflhgp$art_i++) {
        var item = list[$art_izjjvdflhgp$art_i];
