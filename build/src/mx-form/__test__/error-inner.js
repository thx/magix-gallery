...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijyvuefrxykq$art_i = 0, $art_cmrtnwz$art_c = list.length; $art_ijyvuefrxykq$art_i < $art_cmrtnwz$art_c; $art_ijyvuefrxykq$art_i++) {    var item = list[$art_ijyvuefrxykq$art_i]%>';
    for (var $art_ijyvuefrxykq$art_i = 0, $art_cmrtnwz$art_c = list.length; $art_ijyvuefrxykq$art_i < $art_cmrtnwz$art_c; $art_ijyvuefrxykq$art_i++) {
        var item = list[$art_ijyvuefrxykq$art_i];
