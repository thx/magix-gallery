...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixbafozpks$art_i = 0, $art_cywwdpsse$art_c = list.length; $art_ixbafozpks$art_i < $art_cywwdpsse$art_c; $art_ixbafozpks$art_i++) {    var item = list[$art_ixbafozpks$art_i]%>';
    for (var $art_ixbafozpks$art_i = 0, $art_cywwdpsse$art_c = list.length; $art_ixbafozpks$art_i < $art_cywwdpsse$art_c; $art_ixbafozpks$art_i++) {
        var item = list[$art_ixbafozpks$art_i];
