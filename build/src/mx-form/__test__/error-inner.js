...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ineuruec$art_i = 0, $art_crgauoxf$art_c = list.length; $art_ineuruec$art_i < $art_crgauoxf$art_c; $art_ineuruec$art_i++) {    var item = list[$art_ineuruec$art_i]%>';
    for (var $art_ineuruec$art_i = 0, $art_crgauoxf$art_c = list.length; $art_ineuruec$art_i < $art_crgauoxf$art_c; $art_ineuruec$art_i++) {
        var item = list[$art_ineuruec$art_i];
