...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilgpllrndi$art_i = 0, $art_cpfzqckkiqq$art_c = list.length; $art_ilgpllrndi$art_i < $art_cpfzqckkiqq$art_c; $art_ilgpllrndi$art_i++) {    var item = list[$art_ilgpllrndi$art_i]%>';
    for (var $art_ilgpllrndi$art_i = 0, $art_cpfzqckkiqq$art_c = list.length; $art_ilgpllrndi$art_i < $art_cpfzqckkiqq$art_c; $art_ilgpllrndi$art_i++) {
        var item = list[$art_ilgpllrndi$art_i];
