...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya8:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya8:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya8:b" class="mb20 clearfix"><span mxs="_zs_gallerya8:_" class="color-9 mr20 fl lh32">taginput必选：</span><div mxv="list,tags" mxe="' + $viewId + '_0" mxc="[';
    $line = 8;
