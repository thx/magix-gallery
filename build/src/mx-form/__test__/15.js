...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybl:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybl:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybl:b" class="mb20 clearfix"><span mxs="_zs_gallerybl:_" class="color-9 mr20 fl lh32">taginput必选：</span><div mxv="list,tags" mxe="' + $viewId + '_0" mxc="[';
    $line = 8;
