...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb9:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb9:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryb9:_" class="clearfix mb20 lh22"><div class="fl color-9">以下示例：</div><div class="fl"><div>填写1-300的整数，小于50给警告提示</div><div>双向绑定可以用&传递完整对象&#123;&#123;:value&rules&#125;&#125;，rules：object</div></div></div><div mxv mxa="_zs_galleryb9:b" class="_zs_gallery_mx-form___test___1_-table-wrapper"><table mxv mxa="_zs_galleryb9:c" class="table"><thead mxv mxa="_zs_galleryb9:d" class="_zs_gallery_mx-form___test___1_-fixed-head"><tr mxs="_zs_galleryb9:a"><th>name</th><th width="200">出价</th><th width="200">link</th><th width="200">value</th></tr><tr mxv mxa="_zs_galleryb9:e" class="_zs_gallery_mx-form___test___1_-batch-oper"><th mxs="_zs_galleryb9:b"></th><th mxv mxa="_zs_galleryb9:f" colspan="4"><div mxv mxa="_zs_galleryb9:g" class="_zs_gallery_mx-form___test___1_-batch-input"><span mxs="_zs_galleryb9:c" class="_zs_gallery_mx-form___test___1_-batch-input-text">批量出价</span><input mxe="' + $viewId + '_0" mxc="[';
    $line = 26;
    ...
    $art = ':batchDiscount&batRules';
    ;
    $p += ($expr = '<%=batchDiscount%>', $e(batchDiscount)) + '" mx-focusout="' + $viewId + 'batch()"/><a mxs="_zs_galleryb9:d" href="javascript:;" class="btn btn-small ml10" mx-click="' + $viewId + 'batch()">应用</a></div></th></tr></thead><tbody mxv>';
    $line = 34;
    $art = 'each list as item index';
    ;
    $expr = '<%for (var index = 0, $art_cahczjeedl$art_c = list.length; index < $art_cahczjeedl$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cahczjeedl$art_c = list.length; index < $art_cahczjeedl$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv><td>';
        $line = 36;
        $art = '=item.name';
    ...
    ;
    $p += '</tbody></table></div></div><div mxa="_zs_galleryb9:h" class="clearfix"><div mxa="_zs_galleryb9:i" class="_zs_gallery___test___layout_-half"><div mxa="_zs_galleryb9:j" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb9:e" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 53;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryb9:k" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 55;
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_galleryb9:f" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 58;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;table class="table"&gt;\n    &lt;thead class="fixed-head"&gt;\n        &lt;tr&gt;\n            &lt;th&gt;name&lt;/th&gt;\n            &lt;th width="200"&gt;出价&lt;/th&gt;\n            &lt;th width="200"&gt;link&lt;/th&gt;\n            &lt;th width="200"&gt;value&lt;/th&gt;\n        &lt;/tr&gt;\n        &lt;tr class="batch-oper"&gt;\n            &lt;th&gt;&lt;/th&gt;\n            &lt;th colspan="4"&gt;\n                &lt;div class="batch-input"&gt;\n                    &lt;span class="batch-input-text"&gt;批量出价&lt;/span&gt;\n                    &lt;input type="text" class="input input-small w80"\n                        id="&#123;&#123;=viewId&#125;&#125;_batch_input" \n                        value="&#123;&#123;:batchDiscount&batRules&#125;&#125;"\n                        mx-focusout="batch()"/&gt;\n                    &lt;a href="javascript:;" class="btn btn-small ml10" mx-click="batch()"&gt;应用&lt;/a&gt;\n                &lt;/div&gt;\n            &lt;/th&gt;\n        &lt;/tr&gt;\n    &lt;/thead&gt;\n    &lt;tbody&gt;\n        &#123;&#123;each list as item index&#125;&#125;\n            &lt;tr&gt;\n                &lt;td&gt;&#123;&#123;=item.name&#125;&#125;&lt;/td&gt;\n                &lt;td&gt;\n                    &lt;input type="text" class="input input-small w80"\n                        value="&#123;&#123;:item.discount&rules&#125;&#125;"/&gt;\n                &lt;/td&gt;\n                &lt;td&gt;&#123;&#123;=item.link&#125;&#125;&lt;/td&gt;\n                &lt;td&gt;&#123;&#123;=item.value&#125;&#125;&lt;/td&gt;\n            &lt;/tr&gt;\n        &#123;&#123;/each&#125;&#125;\n    &lt;/tbody&gt;\n&lt;/table&gt;</pre></div><div mxa="_zs_galleryb9:l" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb9:g" class="_zs_gallery___test___layout_-eg-title">CSS</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:3})" mx-view="mx-copy/index?copyNode=';
    $line = 98;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_3"><span mxa="_zs_galleryb9:m" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 100;
    $art = '!text3';
    ;
    $p += ($expr = '<%!text3%>', $n(text3)) + '</span><i mxs="_zs_galleryb9:f" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 103;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_3">\n.fixed-head &#123;\n    tr.batch-oper &#123;\n        th &#123;\n            height: 68px;\n            background-color: #fff;\n            border-bottom: 1px solid #e6e6e6;\n\n            .batch-input &#123;\n                position: relative;\n\n                .batch-input-text &#123;\n                    position: absolute;\n                    top: 0;\n                    left: -80px;\n                    width: 70px;\n                    height: 28px;\n                    line-height: 28px;\n                    text-align: right;\n                &#125;\n            &#125;\n        &#125;\n    &#125;\n&#125;</pre></div></div><div mxa="_zs_galleryb9:n" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-right"><div mxs="_zs_galleryb9:h" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 131;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryb9:f" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 136;
    $art = '=viewId';
    ;
