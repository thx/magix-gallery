...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya?:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerya?:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerya?:_" class="clearfix mb20 lh22"><div class="fl color-9">以下示例：</div><div class="fl"><div>填写1-300的整数，小于50给警告提示</div><div>双向绑定可以用&传递完整对象&#123;&#123;:value&rules&#125;&#125;，rules：object</div></div></div><div mxv mxa="_zs_gallerya?:b" class="_zs_gallery_mx-form___test___1_-table-wrapper"><table mxv mxa="_zs_gallerya?:c" class="table"><thead mxv mxa="_zs_gallerya?:d" class="_zs_gallery_mx-form___test___1_-fixed-head"><tr mxs="_zs_gallerya?:a"><th>name</th><th width="200">出价</th><th width="200">link</th><th width="200">value</th></tr><tr mxv mxa="_zs_gallerya?:e" class="_zs_gallery_mx-form___test___1_-batch-oper"><th mxs="_zs_gallerya?:b"></th><th mxv mxa="_zs_gallerya?:f" colspan="4"><div mxv mxa="_zs_gallerya?:g" class="_zs_gallery_mx-form___test___1_-batch-input"><span mxs="_zs_gallerya?:c" class="_zs_gallery_mx-form___test___1_-batch-input-text">批量出价</span><input mxe="' + $viewId + '_0" mxc="[';
    $line = 26;
    ...
    ;
    $expr = '<%for (var index = 0, $art_codsrtjnmcol$art_c = list.length; index < $art_codsrtjnmcol$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_codsrtjnmcol$art_c = list.length; index < $art_codsrtjnmcol$art_c; index++) {
        var item = list[index];
        $p += '<tr mxv><td>';
        $line = 36;
        $art = '=item.name';
    ...
    ;
    $p += '</tbody></table></div></div><div mxa="_zs_gallerya?:h" class="clearfix"><div mxa="_zs_gallerya?:i" class="_zs_gallery___test___layout_-half"><div mxa="_zs_gallerya?:j" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerya?:e" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 53;
    $art = '=viewId';
    ;
