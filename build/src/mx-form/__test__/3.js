...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybi:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybi:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybi:b" class="mb20"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':name{pattern:[\'^[a-zA-Z0-9_\\u4e00-\\u9fa5]+$\', \'只支持汉字、字母、数字、下划线\']}';
    ;
    $p += ($expr = '<%=name%>', $e(name)) + '"/></div></div><div mxa="_zs_gallerybi:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybi:_" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
