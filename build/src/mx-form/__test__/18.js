...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybQ:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybQ:a" class="_zs_gallery___test___layout_-eg-content clearfix"><div mxs="_zs_gallerybQ:_" class="mb10 lh22"><div>默认左侧文字提示预留8个字的位置，margin-bottom:30px</div><div>class：form form-item form-label form-content</div></div><form mxv mxa="_zs_gallerybQ:b" class="form"><div mxv mxa="_zs_gallerybQ:c" class="form-item"><div mxs="_zs_gallerybQ:a" class="form-label">输入框</div><div mxv mxa="_zs_gallerybQ:d" class="form-content"><input mxs="_zs_gallerybQ:b" class="input w200"/></div></div><div mxv mxa="_zs_gallerybQ:e" class="form-item"><div mxs="_zs_gallerybQ:a" class="form-label">输入框</div><div mxv mxa="_zs_gallerybQ:f" class="form-content"><input mxs="_zs_gallerybQ:b" class="input w200"/></div></div><div mxs="_zs_gallerybQ:c" class="form-footer"><a href="javascript:;" class="btn w80 btn-brand mr20" mx-click="' + $viewId + 'confirm()">确定</a><a href="javascript:;" class="btn w80">取消</a></div></form></div><div mxa="_zs_gallerybQ:g" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybQ:d" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 29;
    $art = '=viewId';
    ;
