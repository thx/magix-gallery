...
module.exports = Base.extend({
    ...
    if (bool) {
        ;
        $p += '<input mxs="_zs_gallerybj:a" class="fl input"/>';
        $line = 15;
        $art = '/if';
        ;
        $expr = '<%}%>';
