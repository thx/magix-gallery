...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycc:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerycc:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycc:_" class="mb20"><span class="color-9">以下示例：</span>配置refresh:true，数据改变的时候，刷新view</div><div mxv mxa="_zs_gallerycc:b" class="clearfix mb20"><label mxv mxa="_zs_gallerycc:c" class="fl mr20 lh32"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 10;
    ...
    if (bool) {
        ;
        $p += '<input mxs="_zs_gallerycc:a" class="fl input"/>';
        $line = 15;
        $art = '/if';
        ;
        $expr = '<%}%>';
