...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycb:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerycb:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerycb:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':number{max:[30, \'自定义提示：数字不能大于30\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div></div><div mxa="_zs_gallerycb:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycb:_" class="_zs_gallery___test___layout_-eg-title">数字范围</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
