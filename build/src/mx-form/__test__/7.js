...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybh:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerybh:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerybh:b" class="clearfix"><input mxe="' + $viewId + '_0" mxc="[';
    $line = 4;
    ...
    $art = ':number{range:[4, 8, \'自定义提示：4~8中间的数字\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerybh:c" class="clearfix"><input mxe="' + $viewId + '_2" mxc="[';
    $line = 8;
    $art = ':number{min:20}';
    ;
    ...
    $art = ':number{min:[20, \'自定义提示：数字不能小于20\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div><div mxv mxa="_zs_gallerybh:d" class="clearfix"><input mxe="' + $viewId + '_4" mxc="[';
    $line = 12;
    $art = ':number{max:30}';
    ;
    ...
    $art = ':number{max:[30, \'自定义提示：数字不能大于30\']}';
    ;
    $p += ($expr = '<%=number%>', $e(number)) + '"/></div></div><div mxa="_zs_gallerybh:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybh:_" class="_zs_gallery___test___layout_-eg-title">数字范围</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
