...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_idixburxgc$art_i = 0, $art_cfztsopm$art_c = list.length; $art_idixburxgc$art_i < $art_cfztsopm$art_c; $art_idixburxgc$art_i++) {    var item = list[$art_idixburxgc$art_i]%>';
    for (var $art_idixburxgc$art_i = 0, $art_cfztsopm$art_c = list.length; $art_idixburxgc$art_i < $art_cfztsopm$art_c; $art_idixburxgc$art_i++) {
        var item = list[$art_idixburxgc$art_i];
        $p += '<input mxe="' + $viewId + '_0_' + ($expr = '<%=$art_idixburxgc$art_i%>', $e($art_idixburxgc$art_i)) + '" mxc="[';
        $line = 11;
        $art = ':item.value{required:true,blength:[2,4]}';
        ;
        $p += '{p:\'list.' + ($expr = '<%=$art_idixburxgc$art_i%>', $e($art_idixburxgc$art_i)) + '.value\',f:{required:true,blength:[2,4]}}]" class="input mr20 mb20 w120" placeholder="请填写" value="';
        $line = 11;
        $art = ':item.value{required:true,blength:[2,4]}';
        ;
