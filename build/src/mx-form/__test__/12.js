...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyokwwoyws$art_i = 0, $art_cqhhzjk$art_c = radioes.length; $art_iyokwwoyws$art_i < $art_cqhhzjk$art_c; $art_iyokwwoyws$art_i++) {    var r = radioes[$art_iyokwwoyws$art_i]%>';
    for (var $art_iyokwwoyws$art_i = 0, $art_cqhhzjk$art_c = radioes.length; $art_iyokwwoyws$art_i < $art_cqhhzjk$art_c; $art_iyokwwoyws$art_i++) {
        var r = radioes[$art_iyokwwoyws$art_i];
