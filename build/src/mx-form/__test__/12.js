...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifcjcrqm$art_i = 0, $art_cpnvhnvifvh$art_c = radioes.length; $art_ifcjcrqm$art_i < $art_cpnvhnvifvh$art_c; $art_ifcjcrqm$art_i++) {    var r = radioes[$art_ifcjcrqm$art_i]%>';
    for (var $art_ifcjcrqm$art_i = 0, $art_cpnvhnvifvh$art_c = radioes.length; $art_ifcjcrqm$art_i < $art_cpnvhnvifvh$art_c; $art_ifcjcrqm$art_i++) {
        var r = radioes[$art_ifcjcrqm$art_i];
