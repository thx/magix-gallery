...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itsbygr$art_i = 0, $art_clghjkqpk$art_c = radioes.length; $art_itsbygr$art_i < $art_clghjkqpk$art_c; $art_itsbygr$art_i++) {    var r = radioes[$art_itsbygr$art_i]%>';
    for (var $art_itsbygr$art_i = 0, $art_clghjkqpk$art_c = radioes.length; $art_itsbygr$art_i < $art_clghjkqpk$art_c; $art_itsbygr$art_i++) {
        var r = radioes[$art_itsbygr$art_i];
