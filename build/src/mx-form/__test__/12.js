...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itjl$art_i = 0, $art_czlfqggewf$art_c = radioes.length; $art_itjl$art_i < $art_czlfqggewf$art_c; $art_itjl$art_i++) {    var r = radioes[$art_itjl$art_i]%>';
    for (var $art_itjl$art_i = 0, $art_czlfqggewf$art_c = radioes.length; $art_itjl$art_i < $art_czlfqggewf$art_c; $art_itjl$art_i++) {
        var r = radioes[$art_itjl$art_i];
