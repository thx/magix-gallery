...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igwawcjcep$art_i = 0, $art_cjauoikbo$art_c = radioes.length; $art_igwawcjcep$art_i < $art_cjauoikbo$art_c; $art_igwawcjcep$art_i++) {    var r = radioes[$art_igwawcjcep$art_i]%>';
    for (var $art_igwawcjcep$art_i = 0, $art_cjauoikbo$art_c = radioes.length; $art_igwawcjcep$art_i < $art_cjauoikbo$art_c; $art_igwawcjcep$art_i++) {
        var r = radioes[$art_igwawcjcep$art_i];
