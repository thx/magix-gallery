...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_idfjuwimtq$art_i = 0, $art_cmgpsmqqe$art_c = radioes.length; $art_idfjuwimtq$art_i < $art_cmgpsmqqe$art_c; $art_idfjuwimtq$art_i++) {    var r = radioes[$art_idfjuwimtq$art_i]%>';
    for (var $art_idfjuwimtq$art_i = 0, $art_cmgpsmqqe$art_c = radioes.length; $art_idfjuwimtq$art_i < $art_cmgpsmqqe$art_c; $art_idfjuwimtq$art_i++) {
        var r = radioes[$art_idfjuwimtq$art_i];
