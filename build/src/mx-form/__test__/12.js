...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqaogpy$art_i = 0, $art_csdsmcx$art_c = radioes.length; $art_iqaogpy$art_i < $art_csdsmcx$art_c; $art_iqaogpy$art_i++) {    var r = radioes[$art_iqaogpy$art_i]%>';
    for (var $art_iqaogpy$art_i = 0, $art_csdsmcx$art_c = radioes.length; $art_iqaogpy$art_i < $art_csdsmcx$art_c; $art_iqaogpy$art_i++) {
        var r = radioes[$art_iqaogpy$art_i];
