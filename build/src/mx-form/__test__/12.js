...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iixrrwl$art_i = 0, $art_cxftcmkws$art_c = radioes.length; $art_iixrrwl$art_i < $art_cxftcmkws$art_c; $art_iixrrwl$art_i++) {    var r = radioes[$art_iixrrwl$art_i]%>';
    for (var $art_iixrrwl$art_i = 0, $art_cxftcmkws$art_c = radioes.length; $art_iixrrwl$art_i < $art_cxftcmkws$art_c; $art_iixrrwl$art_i++) {
        var r = radioes[$art_iixrrwl$art_i];
