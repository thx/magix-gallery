...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icgkgapmgjw$art_i = 0, $art_crrtjpugbbx$art_c = radioes.length; $art_icgkgapmgjw$art_i < $art_crrtjpugbbx$art_c; $art_icgkgapmgjw$art_i++) {    var r = radioes[$art_icgkgapmgjw$art_i]%>';
    for (var $art_icgkgapmgjw$art_i = 0, $art_crrtjpugbbx$art_c = radioes.length; $art_icgkgapmgjw$art_i < $art_crrtjpugbbx$art_c; $art_icgkgapmgjw$art_i++) {
        var r = radioes[$art_icgkgapmgjw$art_i];
