...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ikuxdv$art_i = 0, $art_czwubet$art_c = radioes.length; $art_ikuxdv$art_i < $art_czwubet$art_c; $art_ikuxdv$art_i++) {    var r = radioes[$art_ikuxdv$art_i]%>';
    for (var $art_ikuxdv$art_i = 0, $art_czwubet$art_c = radioes.length; $art_ikuxdv$art_i < $art_czwubet$art_c; $art_ikuxdv$art_i++) {
        var r = radioes[$art_ikuxdv$art_i];
