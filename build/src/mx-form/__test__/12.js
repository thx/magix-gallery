...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ijemwshg$art_i = 0, $art_cnlemgftqs$art_c = radioes.length; $art_ijemwshg$art_i < $art_cnlemgftqs$art_c; $art_ijemwshg$art_i++) {    var r = radioes[$art_ijemwshg$art_i]%>';
    for (var $art_ijemwshg$art_i = 0, $art_cnlemgftqs$art_c = radioes.length; $art_ijemwshg$art_i < $art_cnlemgftqs$art_c; $art_ijemwshg$art_i++) {
        var r = radioes[$art_ijemwshg$art_i];
