...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixyusfrho$art_i = 0, $art_crtgxvo$art_c = radioes.length; $art_ixyusfrho$art_i < $art_crtgxvo$art_c; $art_ixyusfrho$art_i++) {    var r = radioes[$art_ixyusfrho$art_i]%>';
    for (var $art_ixyusfrho$art_i = 0, $art_crtgxvo$art_c = radioes.length; $art_ixyusfrho$art_i < $art_crtgxvo$art_c; $art_ixyusfrho$art_i++) {
        var r = radioes[$art_ixyusfrho$art_i];
