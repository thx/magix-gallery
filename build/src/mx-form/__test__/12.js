...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieeljpuc$art_i = 0, $art_cshcjhf$art_c = radioes.length; $art_ieeljpuc$art_i < $art_cshcjhf$art_c; $art_ieeljpuc$art_i++) {    var r = radioes[$art_ieeljpuc$art_i]%>';
    for (var $art_ieeljpuc$art_i = 0, $art_cshcjhf$art_c = radioes.length; $art_ieeljpuc$art_i < $art_cshcjhf$art_c; $art_ieeljpuc$art_i++) {
        var r = radioes[$art_ieeljpuc$art_i];
