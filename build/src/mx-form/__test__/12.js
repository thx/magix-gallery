...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iiblere$art_i = 0, $art_cfsfsjnm$art_c = radioes.length; $art_iiblere$art_i < $art_cfsfsjnm$art_c; $art_iiblere$art_i++) {    var r = radioes[$art_iiblere$art_i]%>';
    for (var $art_iiblere$art_i = 0, $art_cfsfsjnm$art_c = radioes.length; $art_iiblere$art_i < $art_cfsfsjnm$art_c; $art_iiblere$art_i++) {
        var r = radioes[$art_iiblere$art_i];
