...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imdymheqhy$art_i = 0, $art_cwmkksd$art_c = radioes.length; $art_imdymheqhy$art_i < $art_cwmkksd$art_c; $art_imdymheqhy$art_i++) {    var r = radioes[$art_imdymheqhy$art_i]%>';
    for (var $art_imdymheqhy$art_i = 0, $art_cwmkksd$art_c = radioes.length; $art_imdymheqhy$art_i < $art_cwmkksd$art_c; $art_imdymheqhy$art_i++) {
        var r = radioes[$art_imdymheqhy$art_i];
