...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for(var $art_igwycwabxwf$art_i=0;$art_igwycwabxwf$art_i<radioes.length;$art_igwycwabxwf$art_i++){var r=radioes[$art_igwycwabxwf$art_i]%>';
    for (var $art_igwycwabxwf$art_i = 0; $art_igwycwabxwf$art_i < radioes.length; $art_igwycwabxwf$art_i++) {
        var r = radioes[$art_igwycwabxwf$art_i];
