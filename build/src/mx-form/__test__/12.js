...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_icagclikid$art_i = 0, $art_cwgjfzgwq$art_c = radioes.length; $art_icagclikid$art_i < $art_cwgjfzgwq$art_c; $art_icagclikid$art_i++) {    var r = radioes[$art_icagclikid$art_i]%>';
    for (var $art_icagclikid$art_i = 0, $art_cwgjfzgwq$art_c = radioes.length; $art_icagclikid$art_i < $art_cwgjfzgwq$art_c; $art_icagclikid$art_i++) {
        var r = radioes[$art_icagclikid$art_i];
