...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iidwinobd$art_i = 0, $art_ckplebaefsqh$art_c = radioes.length; $art_iidwinobd$art_i < $art_ckplebaefsqh$art_c; $art_iidwinobd$art_i++) {    var r = radioes[$art_iidwinobd$art_i]%>';
    for (var $art_iidwinobd$art_i = 0, $art_ckplebaefsqh$art_c = radioes.length; $art_iidwinobd$art_i < $art_ckplebaefsqh$art_c; $art_iidwinobd$art_i++) {
        var r = radioes[$art_iidwinobd$art_i];
