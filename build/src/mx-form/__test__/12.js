...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ishbxpgf$art_i = 0, $art_cgqamociq$art_c = radioes.length; $art_ishbxpgf$art_i < $art_cgqamociq$art_c; $art_ishbxpgf$art_i++) {    var r = radioes[$art_ishbxpgf$art_i]%>';
    for (var $art_ishbxpgf$art_i = 0, $art_cgqamociq$art_c = radioes.length; $art_ishbxpgf$art_i < $art_cgqamociq$art_c; $art_ishbxpgf$art_i++) {
        var r = radioes[$art_ishbxpgf$art_i];
