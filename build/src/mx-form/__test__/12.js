...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioqueyugak$art_i = 0, $art_czzilxlv$art_c = radioes.length; $art_ioqueyugak$art_i < $art_czzilxlv$art_c; $art_ioqueyugak$art_i++) {    var r = radioes[$art_ioqueyugak$art_i]%>';
    for (var $art_ioqueyugak$art_i = 0, $art_czzilxlv$art_c = radioes.length; $art_ioqueyugak$art_i < $art_czzilxlv$art_c; $art_ioqueyugak$art_i++) {
        var r = radioes[$art_ioqueyugak$art_i];
