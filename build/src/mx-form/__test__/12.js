...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igekydx$art_i = 0, $art_cewgyiyfdf$art_c = radioes.length; $art_igekydx$art_i < $art_cewgyiyfdf$art_c; $art_igekydx$art_i++) {    var r = radioes[$art_igekydx$art_i]%>';
    for (var $art_igekydx$art_i = 0, $art_cewgyiyfdf$art_c = radioes.length; $art_igekydx$art_i < $art_cewgyiyfdf$art_c; $art_igekydx$art_i++) {
        var r = radioes[$art_igekydx$art_i];
