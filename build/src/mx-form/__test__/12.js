...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iwmthslrc$art_i = 0, $art_cgxvivli$art_c = radioes.length; $art_iwmthslrc$art_i < $art_cgxvivli$art_c; $art_iwmthslrc$art_i++) {    var r = radioes[$art_iwmthslrc$art_i]%>';
    for (var $art_iwmthslrc$art_i = 0, $art_cgxvivli$art_c = radioes.length; $art_iwmthslrc$art_i < $art_cgxvivli$art_c; $art_iwmthslrc$art_i++) {
        var r = radioes[$art_iwmthslrc$art_i];
