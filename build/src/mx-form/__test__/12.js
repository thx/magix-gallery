...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_igxcxk$art_i = 0, $art_ccunbnmn$art_c = radioes.length; $art_igxcxk$art_i < $art_ccunbnmn$art_c; $art_igxcxk$art_i++) {    var r = radioes[$art_igxcxk$art_i]%>';
    for (var $art_igxcxk$art_i = 0, $art_ccunbnmn$art_c = radioes.length; $art_igxcxk$art_i < $art_ccunbnmn$art_c; $art_igxcxk$art_i++) {
        var r = radioes[$art_igxcxk$art_i];
