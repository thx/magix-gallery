...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icgripbg$art_i = 0, $art_cqusmrrss$art_c = radioes.length; $art_icgripbg$art_i < $art_cqusmrrss$art_c; $art_icgripbg$art_i++) {    var r = radioes[$art_icgripbg$art_i]%>';
    for (var $art_icgripbg$art_i = 0, $art_cqusmrrss$art_c = radioes.length; $art_icgripbg$art_i < $art_cqusmrrss$art_c; $art_icgripbg$art_i++) {
        var r = radioes[$art_icgripbg$art_i];
