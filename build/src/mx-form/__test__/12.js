...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivihtqfzk$art_i = 0, $art_czwngazted$art_c = radioes.length; $art_ivihtqfzk$art_i < $art_czwngazted$art_c; $art_ivihtqfzk$art_i++) {    var r = radioes[$art_ivihtqfzk$art_i]%>';
    for (var $art_ivihtqfzk$art_i = 0, $art_czwngazted$art_c = radioes.length; $art_ivihtqfzk$art_i < $art_czwngazted$art_c; $art_ivihtqfzk$art_i++) {
        var r = radioes[$art_ivihtqfzk$art_i];
