...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibfwvydwke$art_i = 0, $art_ckkxdzxbj$art_c = radioes.length; $art_ibfwvydwke$art_i < $art_ckkxdzxbj$art_c; $art_ibfwvydwke$art_i++) {    var r = radioes[$art_ibfwvydwke$art_i]%>';
    for (var $art_ibfwvydwke$art_i = 0, $art_ckkxdzxbj$art_c = radioes.length; $art_ibfwvydwke$art_i < $art_ckkxdzxbj$art_c; $art_ibfwvydwke$art_i++) {
        var r = radioes[$art_ibfwvydwke$art_i];
