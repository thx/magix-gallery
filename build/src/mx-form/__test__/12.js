...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_icsmzcy$art_i = 0, $art_ctsopptsqe$art_c = radioes.length; $art_icsmzcy$art_i < $art_ctsopptsqe$art_c; $art_icsmzcy$art_i++) {    var r = radioes[$art_icsmzcy$art_i]%>';
    for (var $art_icsmzcy$art_i = 0, $art_ctsopptsqe$art_c = radioes.length; $art_icsmzcy$art_i < $art_ctsopptsqe$art_c; $art_icsmzcy$art_i++) {
        var r = radioes[$art_icsmzcy$art_i];
