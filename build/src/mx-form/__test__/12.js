...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioytcuyag$art_i = 0, $art_chfxajonsaf$art_c = radioes.length; $art_ioytcuyag$art_i < $art_chfxajonsaf$art_c; $art_ioytcuyag$art_i++) {    var r = radioes[$art_ioytcuyag$art_i]%>';
    for (var $art_ioytcuyag$art_i = 0, $art_chfxajonsaf$art_c = radioes.length; $art_ioytcuyag$art_i < $art_chfxajonsaf$art_c; $art_ioytcuyag$art_i++) {
        var r = radioes[$art_ioytcuyag$art_i];
