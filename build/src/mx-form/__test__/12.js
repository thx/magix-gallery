...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqnncrtqyhg$art_i = 0, $art_caplcp$art_c = radioes.length; $art_iqnncrtqyhg$art_i < $art_caplcp$art_c; $art_iqnncrtqyhg$art_i++) {    var r = radioes[$art_iqnncrtqyhg$art_i]%>';
    for (var $art_iqnncrtqyhg$art_i = 0, $art_caplcp$art_c = radioes.length; $art_iqnncrtqyhg$art_i < $art_caplcp$art_c; $art_iqnncrtqyhg$art_i++) {
        var r = radioes[$art_iqnncrtqyhg$art_i];
