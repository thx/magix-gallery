...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixyhulpog$art_i = 0, $art_cbvzrhpr$art_c = radioes.length; $art_ixyhulpog$art_i < $art_cbvzrhpr$art_c; $art_ixyhulpog$art_i++) {    var r = radioes[$art_ixyhulpog$art_i]%>';
    for (var $art_ixyhulpog$art_i = 0, $art_cbvzrhpr$art_c = radioes.length; $art_ixyhulpog$art_i < $art_cbvzrhpr$art_c; $art_ixyhulpog$art_i++) {
        var r = radioes[$art_ixyhulpog$art_i];
