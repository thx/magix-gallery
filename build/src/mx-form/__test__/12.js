...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb^:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb^:a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_galleryb^:b" class="mb20"><span mxs="_zs_galleryb^:_" class="color-9 mr20">radio：</span>';
    $line = 5;
    $art = 'each radioes as r';
    ;
    $expr = '<%for (var $art_ikihzefkvslm$art_i = 0, $art_cfhlvifvfa$art_c = radioes.length; $art_ikihzefkvslm$art_i < $art_cfhlvifvfa$art_c; $art_ikihzefkvslm$art_i++) {    var r = radioes[$art_ikihzefkvslm$art_i]%>';
    for (var $art_ikihzefkvslm$art_i = 0, $art_cfhlvifvfa$art_c = radioes.length; $art_ikihzefkvslm$art_i < $art_cfhlvifvfa$art_c; $art_ikihzefkvslm$art_i++) {
        var r = radioes[$art_ikihzefkvslm$art_i];
