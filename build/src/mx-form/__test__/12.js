...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihqyakziux$art_i = 0, $art_cdvhabds$art_c = radioes.length; $art_ihqyakziux$art_i < $art_cdvhabds$art_c; $art_ihqyakziux$art_i++) {    var r = radioes[$art_ihqyakziux$art_i]%>';
    for (var $art_ihqyakziux$art_i = 0, $art_cdvhabds$art_c = radioes.length; $art_ihqyakziux$art_i < $art_cdvhabds$art_c; $art_ihqyakziux$art_i++) {
        var r = radioes[$art_ihqyakziux$art_i];
