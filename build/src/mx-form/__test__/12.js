...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibxgqehbg$art_i = 0, $art_cudrivzpz$art_c = radioes.length; $art_ibxgqehbg$art_i < $art_cudrivzpz$art_c; $art_ibxgqehbg$art_i++) {    var r = radioes[$art_ibxgqehbg$art_i]%>';
    for (var $art_ibxgqehbg$art_i = 0, $art_cudrivzpz$art_c = radioes.length; $art_ibxgqehbg$art_i < $art_cudrivzpz$art_c; $art_ibxgqehbg$art_i++) {
        var r = radioes[$art_ibxgqehbg$art_i];
