...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itxodpr$art_i = 0, $art_cnnbgdbzr$art_c = radioes.length; $art_itxodpr$art_i < $art_cnnbgdbzr$art_c; $art_itxodpr$art_i++) {    var r = radioes[$art_itxodpr$art_i]%>';
    for (var $art_itxodpr$art_i = 0, $art_cnnbgdbzr$art_c = radioes.length; $art_itxodpr$art_i < $art_cnnbgdbzr$art_c; $art_itxodpr$art_i++) {
        var r = radioes[$art_itxodpr$art_i];
