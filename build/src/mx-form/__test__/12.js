...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ixzppriac$art_i = 0, $art_crawhzssw$art_c = radioes.length; $art_ixzppriac$art_i < $art_crawhzssw$art_c; $art_ixzppriac$art_i++) {    var r = radioes[$art_ixzppriac$art_i]%>';
    for (var $art_ixzppriac$art_i = 0, $art_crawhzssw$art_c = radioes.length; $art_ixzppriac$art_i < $art_crawhzssw$art_c; $art_ixzppriac$art_i++) {
        var r = radioes[$art_ixzppriac$art_i];
