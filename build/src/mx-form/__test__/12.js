...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ixjpwtuy$art_i = 0, $art_cukorio$art_c = radioes.length; $art_ixjpwtuy$art_i < $art_cukorio$art_c; $art_ixjpwtuy$art_i++) {    var r = radioes[$art_ixjpwtuy$art_i]%>';
    for (var $art_ixjpwtuy$art_i = 0, $art_cukorio$art_c = radioes.length; $art_ixjpwtuy$art_i < $art_cukorio$art_c; $art_ixjpwtuy$art_i++) {
        var r = radioes[$art_ixjpwtuy$art_i];
