...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya):_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerya):a" class="_zs_gallery___test___layout_-eg-content"><div mxv mxa="_zs_gallerya):b" class="mb20"><span mxs="_zs_gallerya):_" class="color-9 mr20">radio：</span>';
    $line = 5;
    $art = 'each radioes as r';
    ;
    $p += '';
    $expr = '<%for (var $art_iochglmveuoh$art_i = 0, $art_cjenbqvtbpy$art_c = radioes.length; $art_iochglmveuoh$art_i < $art_cjenbqvtbpy$art_c; $art_iochglmveuoh$art_i++) {    var r = radioes[$art_iochglmveuoh$art_i]%>';
    for (var $art_iochglmveuoh$art_i = 0, $art_cjenbqvtbpy$art_c = radioes.length; $art_iochglmveuoh$art_i < $art_cjenbqvtbpy$art_c; $art_iochglmveuoh$art_i++) {
        var r = radioes[$art_iochglmveuoh$art_i];
