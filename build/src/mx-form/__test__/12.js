...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iemxtzqn$art_i = 0, $art_cardudq$art_c = radioes.length; $art_iemxtzqn$art_i < $art_cardudq$art_c; $art_iemxtzqn$art_i++) {    var r = radioes[$art_iemxtzqn$art_i]%>';
    for (var $art_iemxtzqn$art_i = 0, $art_cardudq$art_c = radioes.length; $art_iemxtzqn$art_i < $art_cardudq$art_c; $art_iemxtzqn$art_i++) {
        var r = radioes[$art_iemxtzqn$art_i];
