...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya0:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya0:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya0:b" class="mb20"><span mxs="_zs_gallerya0:_" class="color-9 mr20">radio：</span>';
    $line = 5;
    $art = 'each radioes as r';
    ;
    $p += '';
    $expr = '<%for(var $art_idkpljuf$art_i=0;$art_idkpljuf$art_i<radioes.length;$art_idkpljuf$art_i++){var r=radioes[$art_idkpljuf$art_i]%>';
    for (var $art_idkpljuf$art_i = 0; $art_idkpljuf$art_i < radioes.length; $art_idkpljuf$art_i++) {
        var r = radioes[$art_idkpljuf$art_i];
