...
module.exports = Base.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_ifwfbirsv$art_i = 0, $art_coiqjbqqc$art_c = radioes.length; $art_ifwfbirsv$art_i < $art_coiqjbqqc$art_c; $art_ifwfbirsv$art_i++) {    var r = radioes[$art_ifwfbirsv$art_i]%>';
    for (var $art_ifwfbirsv$art_i = 0, $art_coiqjbqqc$art_c = radioes.length; $art_ifwfbirsv$art_i < $art_coiqjbqqc$art_c; $art_ifwfbirsv$art_i++) {
        var r = radioes[$art_ifwfbirsv$art_i];
