...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imlqneus$art_i = 0, $art_cpckglfn$art_c = radioes.length; $art_imlqneus$art_i < $art_cpckglfn$art_c; $art_imlqneus$art_i++) {    var r = radioes[$art_imlqneus$art_i]%>';
    for (var $art_imlqneus$art_i = 0, $art_cpckglfn$art_c = radioes.length; $art_imlqneus$art_i < $art_cpckglfn$art_c; $art_imlqneus$art_i++) {
        var r = radioes[$art_imlqneus$art_i];
