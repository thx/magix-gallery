...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iimviosei$art_i = 0, $art_cloxafaxq$art_c = radioes.length; $art_iimviosei$art_i < $art_cloxafaxq$art_c; $art_iimviosei$art_i++) {    var r = radioes[$art_iimviosei$art_i]%>';
    for (var $art_iimviosei$art_i = 0, $art_cloxafaxq$art_c = radioes.length; $art_iimviosei$art_i < $art_cloxafaxq$art_c; $art_iimviosei$art_i++) {
        var r = radioes[$art_iimviosei$art_i];
