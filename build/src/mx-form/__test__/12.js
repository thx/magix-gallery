...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itfitorsaa$art_i = 0, $art_cdhteqg$art_c = radioes.length; $art_itfitorsaa$art_i < $art_cdhteqg$art_c; $art_itfitorsaa$art_i++) {    var r = radioes[$art_itfitorsaa$art_i]%>';
    for (var $art_itfitorsaa$art_i = 0, $art_cdhteqg$art_c = radioes.length; $art_itfitorsaa$art_i < $art_cdhteqg$art_c; $art_itfitorsaa$art_i++) {
        var r = radioes[$art_itfitorsaa$art_i];
