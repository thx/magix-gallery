...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipkwdqfgx$art_i = 0, $art_cepwlxhoi$art_c = radioes.length; $art_ipkwdqfgx$art_i < $art_cepwlxhoi$art_c; $art_ipkwdqfgx$art_i++) {    var r = radioes[$art_ipkwdqfgx$art_i]%>';
    for (var $art_ipkwdqfgx$art_i = 0, $art_cepwlxhoi$art_c = radioes.length; $art_ipkwdqfgx$art_i < $art_cepwlxhoi$art_c; $art_ipkwdqfgx$art_i++) {
        var r = radioes[$art_ipkwdqfgx$art_i];
