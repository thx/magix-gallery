...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itohas$art_i = 0, $art_chujhbtgg$art_c = radioes.length; $art_itohas$art_i < $art_chujhbtgg$art_c; $art_itohas$art_i++) {    var r = radioes[$art_itohas$art_i]%>';
    for (var $art_itohas$art_i = 0, $art_chujhbtgg$art_c = radioes.length; $art_itohas$art_i < $art_chujhbtgg$art_c; $art_itohas$art_i++) {
        var r = radioes[$art_itohas$art_i];
