...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ivkbejc$art_i = 0, $art_cqjzgz$art_c = radioes.length; $art_ivkbejc$art_i < $art_cqjzgz$art_c; $art_ivkbejc$art_i++) {    var r = radioes[$art_ivkbejc$art_i]%>';
    for (var $art_ivkbejc$art_i = 0, $art_cqjzgz$art_c = radioes.length; $art_ivkbejc$art_i < $art_cqjzgz$art_c; $art_ivkbejc$art_i++) {
        var r = radioes[$art_ivkbejc$art_i];
