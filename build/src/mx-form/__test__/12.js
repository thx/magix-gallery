...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipydqrqhn$art_i = 0, $art_cujpwjdqta$art_c = radioes.length; $art_ipydqrqhn$art_i < $art_cujpwjdqta$art_c; $art_ipydqrqhn$art_i++) {    var r = radioes[$art_ipydqrqhn$art_i]%>';
    for (var $art_ipydqrqhn$art_i = 0, $art_cujpwjdqta$art_c = radioes.length; $art_ipydqrqhn$art_i < $art_cujpwjdqta$art_c; $art_ipydqrqhn$art_i++) {
        var r = radioes[$art_ipydqrqhn$art_i];
