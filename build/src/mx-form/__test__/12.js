...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itvjnlwfc$art_i = 0, $art_ccxwsdo$art_c = radioes.length; $art_itvjnlwfc$art_i < $art_ccxwsdo$art_c; $art_itvjnlwfc$art_i++) {    var r = radioes[$art_itvjnlwfc$art_i]%>';
    for (var $art_itvjnlwfc$art_i = 0, $art_ccxwsdo$art_c = radioes.length; $art_itvjnlwfc$art_i < $art_ccxwsdo$art_c; $art_itvjnlwfc$art_i++) {
        var r = radioes[$art_itvjnlwfc$art_i];
