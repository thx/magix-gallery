...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igxksfsn$art_i = 0, $art_cdvbkins$art_c = radioes.length; $art_igxksfsn$art_i < $art_cdvbkins$art_c; $art_igxksfsn$art_i++) {    var r = radioes[$art_igxksfsn$art_i]%>';
    for (var $art_igxksfsn$art_i = 0, $art_cdvbkins$art_c = radioes.length; $art_igxksfsn$art_i < $art_cdvbkins$art_c; $art_igxksfsn$art_i++) {
        var r = radioes[$art_igxksfsn$art_i];
