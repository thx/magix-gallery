...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ianfpclemmz$art_i = 0, $art_cpwaxl$art_c = radioes.length; $art_ianfpclemmz$art_i < $art_cpwaxl$art_c; $art_ianfpclemmz$art_i++) {    var r = radioes[$art_ianfpclemmz$art_i]%>';
    for (var $art_ianfpclemmz$art_i = 0, $art_cpwaxl$art_c = radioes.length; $art_ianfpclemmz$art_i < $art_cpwaxl$art_c; $art_ianfpclemmz$art_i++) {
        var r = radioes[$art_ianfpclemmz$art_i];
