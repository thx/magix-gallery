...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifftff$art_i = 0, $art_cpjzupddxew$art_c = radioes.length; $art_ifftff$art_i < $art_cpjzupddxew$art_c; $art_ifftff$art_i++) {    var r = radioes[$art_ifftff$art_i]%>';
    for (var $art_ifftff$art_i = 0, $art_cpjzupddxew$art_c = radioes.length; $art_ifftff$art_i < $art_cpjzupddxew$art_c; $art_ifftff$art_i++) {
        var r = radioes[$art_ifftff$art_i];
