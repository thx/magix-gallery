...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqqudgbabxn$art_i = 0, $art_cmmtrldj$art_c = radioes.length; $art_iqqudgbabxn$art_i < $art_cmmtrldj$art_c; $art_iqqudgbabxn$art_i++) {    var r = radioes[$art_iqqudgbabxn$art_i]%>';
    for (var $art_iqqudgbabxn$art_i = 0, $art_cmmtrldj$art_c = radioes.length; $art_iqqudgbabxn$art_i < $art_cmmtrldj$art_c; $art_iqqudgbabxn$art_i++) {
        var r = radioes[$art_iqqudgbabxn$art_i];
