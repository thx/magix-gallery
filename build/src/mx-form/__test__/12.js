...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilwuuvful$art_i = 0, $art_cgsvecuvy$art_c = radioes.length; $art_ilwuuvful$art_i < $art_cgsvecuvy$art_c; $art_ilwuuvful$art_i++) {    var r = radioes[$art_ilwuuvful$art_i]%>';
    for (var $art_ilwuuvful$art_i = 0, $art_cgsvecuvy$art_c = radioes.length; $art_ilwuuvful$art_i < $art_cgsvecuvy$art_c; $art_ilwuuvful$art_i++) {
        var r = radioes[$art_ilwuuvful$art_i];
