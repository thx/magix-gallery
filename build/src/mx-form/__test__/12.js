...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerya0:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerya0:a" class="_zs_gallery___test___base_-eg-content"><div mxv mxa="_zs_gallerya0:b" class="mb20">';
    $line = 4;
    $art = 'each radioes as r';
    ;
    $p += '';
    $expr = '<%for(var $art_iucacalas$art_i=0;$art_iucacalas$art_i<radioes.length;$art_iucacalas$art_i++){var r=radioes[$art_iucacalas$art_i]%>';
    for (var $art_iucacalas$art_i = 0; $art_iucacalas$art_i < radioes.length; $art_iucacalas$art_i++) {
        var r = radioes[$art_iucacalas$art_i];
    ...
    ;
    $p += '</div></div><div mxa="_zs_gallerya0:d" class="clearfix"><div mxa="_zs_gallerya0:e" class="_zs_gallery___test___base_-eg-desc _zs_gallery___test___base_-half"><div mxs="_zs_gallerya0:_" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 17;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += '' + ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;div class="mb20"&gt;\n    &#123;&#123;each radioes as r&#125;&#125;\n    &lt;label class="mr30"&gt;\n        &lt;input type="radio" class="radio" \n            name="magix" \n            value="&#123;&#123;=r&#125;&#125;" \n            &#123;&#123;if(radio==r)&#125;&#125; checked="true" &#123;&#123;/if&#125;&#125;\n            &#123;&#123;:selected&#125;&#125; /&gt;\n        &#123;&#123;=r&#125;&#125;\n    &lt;/label&gt;\n    &#123;&#123;/each&#125;&#125;\n&lt;/div&gt;</pre></div><div mxa="_zs_gallerya0:g" class="_zs_gallery___test___base_-eg-desc _zs_gallery___test___base_-half _zs_gallery___test___base_-half-right"><div mxs="_zs_gallerya0:b" class="_zs_gallery___test___base_-eg-title">JS Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 38;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += '' + ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_gallerya0:a" class="mc-iconfont _zs_gallery___test___base_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 43;
    $art = '=viewId';
    ;
