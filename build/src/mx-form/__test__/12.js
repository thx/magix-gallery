...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iskwgbssa$art_i = 0, $art_cvfmmgnfej$art_c = radioes.length; $art_iskwgbssa$art_i < $art_cvfmmgnfej$art_c; $art_iskwgbssa$art_i++) {    var r = radioes[$art_iskwgbssa$art_i]%>';
    for (var $art_iskwgbssa$art_i = 0, $art_cvfmmgnfej$art_c = radioes.length; $art_iskwgbssa$art_i < $art_cvfmmgnfej$art_c; $art_iskwgbssa$art_i++) {
        var r = radioes[$art_iskwgbssa$art_i];
