...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryd^:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryd^:a" class="_zs_gallery___test___layout_-eg-content"><div class="w300" mx-view="mx-taginput/index?list=';
    $line = 4;
    $art = '@[{\n                name: \'test1\',\n                id: 1\n            }, {\n                name: \'test2\',\n                id: 2\n            }, {\n                name: \'test3\',\n                id: 3\n            }]';
    ;
