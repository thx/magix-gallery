...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycs:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_gallerycs:a" class="_zs_gallery___test___base_-eg-content"><div mx-view="mx-taginput/index?list=';
    $line = 4;
    $art = '@[{\n                name: \'test1\',\n                id: 1\n            }, {\n                name: \'test2\',\n                id: 2\n            }, {\n                name: \'test3\',\n                id: 3\n            }]';
    ;
    $p += '' + ($expr = '<%@[{name:\'test1\',id:1},{name:\'test2\',id:2},{name:\'test3\',id:3}]%>', $i([{ name: 'test1', id: 1 }, { name: 'test2', id: 2 }, { name: 'test3', id: 3 }])) + '&selected=1&textKey=name&valueKey=id"></div></div><div mxa="_zs_gallerycs:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerycs:_" class="_zs_gallery___test___base_-eg-title">自定义&nbsp;list-text=&nbsp;和&nbsp;list-value</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
