...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div></div><div mxa="_zs_gallerydU:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-taginput/__test__/5" id="';
    $line = 45;
    $art = '=viewId';
    ;
