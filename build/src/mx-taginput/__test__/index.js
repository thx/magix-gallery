...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"></div></div><div mxa="_zs_galleryeF:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-taginput/__test__/7" id="';
    $line = 52;
    $art = '=viewId';
    ;
