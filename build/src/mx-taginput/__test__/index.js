/*
    ...
    loader: cmd_es
 */
define("mx-taginput/__test__/index",["magix","$","__test__/subs","mx-title/second","./1","./3","./4","./2","./6","./7","./5","__test__/api","__test__/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd8:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'一次性获取选中值\',\n            key: viewId + \'_demo1\'\n        }, {\n            name: \'动态单个选择\',\n            key: viewId + \'_demo7\'\n        }, {\n            name: \'动态连续选择\',\n            key: viewId + \'_demo5\'\n        }, {\n            name: \'实时获取选中值\',\n            key: viewId + \'_demo6\'\n        }, {\n            name: \'自定义key\',\n            key: viewId + \'_demo2\'\n        }, {\n            name: \'简单list\',\n            key: viewId + \'_demo3\'\n        }, {\n            name: \'禁用\',\n            key: viewId + \'_demo4\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }, {\n        name: \'Methods\',\n        key: viewId + \'_method\'\n    }]';
    ;
    $p += ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'一次性获取选中值\',                    key: viewId + \'_demo1\'                }, {                    name: \'动态单个选择\',                    key: viewId + \'_demo7\'                }, {                    name: \'动态连续选择\',                    key: viewId + \'_demo5\'                }, {                    name: \'实时获取选中值\',                    key: viewId + \'_demo6\'                }, {                    name: \'自定义key\',                    key: viewId + \'_demo2\'                }, {                    name: \'简单list\',                    key: viewId + \'_demo3\'                }, {                    name: \'禁用\',                    key: viewId + \'_demo4\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }, {            name: \'Event\',            key: viewId + \'_event\'        }, {            name: \'Methods\',            key: viewId + \'_method\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '一次性获取选中值', key: viewId + '_demo1' }, { name: '动态单个选择', key: viewId + '_demo7' }, { name: '动态连续选择', key: viewId + '_demo5' }, { name: '实时获取选中值', key: viewId + '_demo6' }, { name: '自定义key', key: viewId + '_demo2' }, { name: '简单list', key: viewId + '_demo3' }, { name: '禁用', key: viewId + '_demo4' }] }, { name: 'API', key: viewId + '_api' }, { name: 'Event', key: viewId + '_event' }, { name: 'Methods', key: viewId + '_method' }])) + '"></div><div mxs="_zs_galleryd8:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div class="clearfix mb20" id="';
    $line = 40;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo"><div mxa="_zs_galleryd8:a" class="_zs_gallery___test___layout_-half"><div mx-view="mx-taginput/__test__/1" id="';
    $line = 42;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo6"></div></div><div mxa="_zs_galleryd8:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-taginput/__test__/7" id="';
    $line = 49;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo7"></div><div mx-view="mx-taginput/__test__/5" id="';
    $line = 50;
    $art = '=viewId';
    ;
