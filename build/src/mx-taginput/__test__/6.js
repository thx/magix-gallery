...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd(:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryd(:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryd(:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22">实时获取当前选择数据</div></div><div mxa="_zs_galleryd(:b" class="mb20"><span mxs="_zs_galleryd(:a" class="color-9">当前选择：</span><span>';
    $line = 9;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</span></div><div mxv mxa="_zs_galleryd(:c" class="mb20"><div mxv="list" class="w280" mx-change="' + $viewId + 'select()" mx-view="mx-taginput/index?list=';
    $line = 13;
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '"></div></div></div><div mxa="_zs_galleryd(:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryd(:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 19;
    $art = '=viewId';
    ;
