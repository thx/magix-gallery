...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydG:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydG:a" class="_zs_gallery___test___layout_-eg-content"><div class="mb20" mx-view="mx-taginput/index?list=';
    $line = 4;
