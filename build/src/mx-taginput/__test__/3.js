...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerych:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_gallerych:a" class="_zs_gallery___test___base_-eg-content"><div class="mb20" mx-view="mx-taginput/index?list=';
    $line = 4;
