...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycj:_" class="_zs_gallery___test___base_-example"><div mxa="_zs_gallerycj:a" class="_zs_gallery___test___base_-eg-content"><div class="mb20" mx-view="mx-taginput/index?list=';
    $line = 4;
    ...
    $art = '@[\'test1\',\'test2\',\'test3\',\'test4\']';
    ;
    $p += '' + ($expr = '<%@[\'test1\',\'test2\',\'test3\',\'test4\']%>', $i(['test1', 'test2', 'test3', 'test4'])) + '"></div></div><div mxa="_zs_gallerycj:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerycj:_" class="_zs_gallery___test___base_-eg-title">简单list</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 12;
    $art = '=viewId';
    ;
