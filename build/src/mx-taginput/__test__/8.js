...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd{:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryd{:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryd{:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22">限制选择上限</div></div><div mxa="_zs_galleryd{:b" class="mb20"><span mxs="_zs_galleryd{:a" class="color-9">当前已选中：</span><span>';
    $line = 9;
    $art = '=items.length';
    ;
