...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryel:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryel:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryel:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22">限制选择上限</div></div><div mxa="_zs_galleryel:b" class="mb20"><span mxs="_zs_galleryel:a" class="color-9">当前已选中：</span><span>';
    $line = 9;
    $art = '=items.length';
    ;
    ...
    $art = '=max';
    ;
    $p += ($expr = '<%=max%>', $e(max)) + '</span></div><div mxv mxa="_zs_galleryel:c" class="mb20"><div mxv="list" class="w280" mx-change="' + $viewId + 'select()" mx-view="mx-taginput/index?list=';
    $line = 13;
    $art = '@list';
    ;
    ...
    $art = '=max';
    ;
    $p += ($expr = '<%!$eu(max)%>', $eu(max)) + '"></div></div></div><div mxa="_zs_galleryel:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryel:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
