...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeG:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryeG:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryeG:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>双向绑定，node.val()可以获取数据</div><div>支持上下键切换，回车选择</div><div>支持键盘delete键删除</div><div>支持输入关键词搜索</div></div></div><div mxa="_zs_galleryeG:b" class="mb20"><a mxs="_zs_galleryeG:a" href="javascript:;" class="btn btn-brand mr20" mx-click="' + $viewId + 'get()">获取选中值</a><span mxs="_zs_galleryeG:b" class="color-9">当前选择：</span><span>';
    $line = 15;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</span></div><div mxv mxa="_zs_galleryeG:c" class="mb20"><div mxv="list" class="w280" id="';
    $line = 19;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;a href="javascript:;" class="btn btn-brand" \n    mx-click="get()"&gt;获取选中值&lt;/a&gt;\n\n&lt;mx-taginput class="w280"\n    id="&#123;&#123;=viewId&#125;&#125;_taginput"\n    list="&#123;&#123;@list&#125;&#125;"\n    selected="&#123;&#123;=selected&#125;&#125;"\n    placeholder="请选择需要的值"/&gt;</pre></div><div mxa="_zs_galleryeG:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryeG:e" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 44;
    $art = '=viewId';
    ;
