...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryd?:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryd?:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryd?:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>用户输入关键词，动态更新提示数据</div><div>动态刷的列表可连续选择</div><div>请求数据有延时，可加loading</div></div></div><div mxa="_zs_galleryd?:b" class="mb20"><a mxs="_zs_galleryd?:a" href="javascript:;" class="btn btn-brand mr20" mx-click="' + $viewId + 'get()">获取选中值</a><span mxs="_zs_galleryd?:b" class="color-9">当前选择：</span><span>';
    $line = 14;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</span></div><div mxa="_zs_galleryd?:c" class="mb20"><div class="w280" id="';
    $line = 18;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;a href="javascript:;" class="btn btn-brand" \n    mx-click="get()"&gt;获取选中值&lt;/a&gt;\n\n&lt;mx-taginput class="w280"\n    id="&#123;&#123;=viewId&#125;&#125;_taginput"\n    placeholder="请选择需要的值"\n    mx-show="update()"/&gt;</pre></div><div mxa="_zs_galleryd?:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryd?:e" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 41;
    $art = '=viewId';
    ;
