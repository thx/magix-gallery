...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydR:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydR:a" class="_zs_gallery___test___layout_-eg-content"><div class="w250" mx-disabled mx-view="mx-taginput/index?list=';
    $line = 5;
    $art = '@[\'test1\',\'test2\',\'test3\',\'test4\']';
    ;
    $p += ($expr = '<%@[\'test1\', \'test2\', \'test3\', \'test4\']%>', $i($$ref, ['test1', 'test2', 'test3', 'test4'])) + '&selected=test1%2Ctest2"></div></div><div mxa="_zs_gallerydR:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydR:_" class="_zs_gallery___test___layout_-eg-title">禁止操作</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
