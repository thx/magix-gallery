...
module.exports = Magix.View.extend({
    ...
    if (list && list.length) {
        ...
        ;
        $expr = '<%for (var idx = 0, $art_cqoeqm$art_c = list.length; idx < $art_cqoeqm$art_c; idx++) {        var one = list[idx]%>';
        for (var idx = 0, $art_cqoeqm$art_c = list.length; idx < $art_cqoeqm$art_c; idx++) {
            var one = list[idx];
