...
module.exports = Magix.View.extend({
    ...
    if (list && list.length) {
        ...
        ;
        $expr = '<%for (var idx = 0, $art_cvckmatqkl$art_c = list.length; idx < $art_cvckmatqkl$art_c; idx++) {        var one = list[idx]%>';
        for (var idx = 0, $art_cvckmatqkl$art_c = list.length; idx < $art_cvckmatqkl$art_c; idx++) {
            var one = list[idx];
