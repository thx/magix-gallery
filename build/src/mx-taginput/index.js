...
module.exports = Magix.View.extend({
    ...
    if (items.length) {
        ...
        ;
        $p += '';
        $expr = '<%for (var idx = 0, $art_cbyscjcxm$art_c = items.length; idx < $art_cbyscjcxm$art_c; idx++) {        var one = items[idx]%>';
        for (var idx = 0, $art_cbyscjcxm$art_c = items.length; idx < $art_cbyscjcxm$art_c; idx++) {
            var one = items[idx];
