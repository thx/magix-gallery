...
module.exports = Magix.View.extend({
    ...
    if (items.length) {
        ...
        ;
        $expr = '<%for (var idx = 0, $art_cbalunjgexn$art_c = items.length; idx < $art_cbalunjgexn$art_c; idx++) {        var one = items[idx]%>';
        for (var idx = 0, $art_cbalunjgexn$art_c = items.length; idx < $art_cbalunjgexn$art_c; idx++) {
            var one = items[idx];
    ...
    if (!disabled) {
        ...
        if (loading) {
            ...
            if (suggest && suggest.length) {
                ...
                ;
                $expr = '<%for (var idx = 0, $art_clxyxurvh$art_c = suggest.length; idx < $art_clxyxurvh$art_c; idx++) {                var item = suggest[idx]%>';
                for (var idx = 0, $art_clxyxurvh$art_c = suggest.length; idx < $art_clxyxurvh$art_c; idx++) {
                ...
                ;
                $p += '<li mxa="_zs_galleryeQ:b" class="text-center color-9">';
                $line = 51;
                $art = '=emptyText';
                ;
