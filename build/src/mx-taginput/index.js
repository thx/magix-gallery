...
module.exports = Magix.View.extend({
    ...
    if (items.length) {
        ...
        ;
        $expr = '<%for (var idx = 0, $art_ccszzqouo$art_c = items.length; idx < $art_ccszzqouo$art_c; idx++) {        var one = items[idx]%>';
        for (var idx = 0, $art_ccszzqouo$art_c = items.length; idx < $art_ccszzqouo$art_c; idx++) {
            var one = items[idx];
