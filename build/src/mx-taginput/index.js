...
module.exports = Magix.View.extend({
    ...
    if (items.length) {
        ...
        ;
        $expr = '<%for (var idx = 0, $art_cqlcsca$art_c = items.length; idx < $art_cqlcsca$art_c; idx++) {        var one = items[idx]%>';
        for (var idx = 0, $art_cqlcsca$art_c = items.length; idx < $art_cqlcsca$art_c; idx++) {
            var one = items[idx];
