...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo_static" mx-view="mx-title/second?content=%E9%9D%99%E6%80%81%E6%95%B0%E6%8D%AE%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerydy:a" class="clearfix mb20"><div mxa="_zs_gallerydy:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-suggest/__test__/2" id="';
    $line = 45;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo2"></div></div><div mxa="_zs_gallerydy:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-suggest/__test__/4" id="';
    $line = 48;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo_dync" mx-view="mx-title/second?content=%E5%8A%A8%E6%80%81%E6%95%B0%E6%8D%AE%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerydy:d" class="clearfix mb20"><div mx-view="mx-suggest/__test__/6" id="';
    $line = 56;
    $art = '=viewId';
    ;
