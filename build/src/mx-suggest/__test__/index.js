/*
    ...
    loader: cmd_es
 */
define("mx-suggest/__test__/index",["magix","$","__test__/subs","mx-title/second","./2","./4","./5","./3","./6","./8","./7","./1","__test__/api","__test__/event"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    ;
    $p += ($expr = '<%@[{            name: \'静态数据示例\',            key: viewId + \'_demo_static\',            subs: [{                    name: \'事件处理\',                    key: viewId + \'_demo2\'                }, {                    name: \'自定义字段\',                    key: viewId + \'_demo4\'                }, {                    name: \'搜索value和text\',                    key: viewId + \'_demo5\'                }, {                    name: \'简单数组\',                    key: viewId + \'_demo3\'                }]        }, {            name: \'动态数据示例\',            key: viewId + \'_demo_dync\',            subs: [{                    name: \'动态 + loading\',                    key: viewId + \'_demo6\'                }, {                    name: \'回车直接关键词\',                    key: viewId + \'_demo8\'                }, {                    name: \'初始化选中\',                    key: viewId + \'_demo7\'                }, {                    name: \'直接更新数据\',                    key: viewId + \'_demo1\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }, {            name: \'Event\',            key: viewId + \'_event\'        }, {            name: \'Methods\',            key: viewId + \'_method\'        }]%>', $i($$ref, [{ name: '静态数据示例', key: viewId + '_demo_static', subs: [{ name: '事件处理', key: viewId + '_demo2' }, { name: '自定义字段', key: viewId + '_demo4' }, { name: '搜索value和text', key: viewId + '_demo5' }, { name: '简单数组', key: viewId + '_demo3' }] }, { name: '动态数据示例', key: viewId + '_demo_dync', subs: [{ name: '动态 + loading', key: viewId + '_demo6' }, { name: '回车直接关键词', key: viewId + '_demo8' }, { name: '初始化选中', key: viewId + '_demo7' }, { name: '直接更新数据', key: viewId + '_demo1' }] }, { name: 'API', key: viewId + '_api' }, { name: 'Event', key: viewId + '_event' }, { name: 'Methods', key: viewId + '_method' }])) + '"></div><div id="';
    $line = 45;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo8"></div><div mx-view="mx-suggest/__test__/7" id="';
    $line = 61;
    $art = '=viewId';
    ;
