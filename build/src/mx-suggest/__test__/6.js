...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd\\:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryd\\:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryd\\:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><div class="color-brand">支持双向绑定</div><div>输入关键词动态获取提示数据；请求数据有延时，加loading</div><div>回车默认选中第一个</div></div></div><div mxa="_zs_galleryd\\:b" class="mb10"><span mxs="_zs_galleryd\\:a" class="color-9">当前选中：</span>';
    $line = 12;
    $art = '=selected';
    ;
