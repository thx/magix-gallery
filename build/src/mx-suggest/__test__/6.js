...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydI:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_gallerydI:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydI:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><span class="color-brand">支持双向绑定</span>；动态更新提示数据；请求数据有延时，加loading</div></div><div mxa="_zs_gallerydI:b" class="mb10"><span mxs="_zs_gallerydI:a" class="color-9">当前选中：</span>';
    $line = 11;
    $art = '=selected';
    ;
    $p += ($expr = '<%=selected%>', $e(selected)) + '</div><div mxv mxa="_zs_gallerydI:c" class="mb20"><div mxv="selected" mxe="' + $viewId + '_0" mxc="[';
    $line = 16;
    ...
    $art = ':selected{required:true,refresh:true}';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '"></div><a mxs="_zs_gallerydI:b" href="javascript:;" class="btn ml10" mx-click="' + $viewId + 'check()">校验选择项</a>';
    $line = 21;
    $art = 'if msg';
    ;
    $expr = '<%if (msg) {%>';
    if (msg) {
        ;
        $p += '<span mxa="_zs_gallerydI:d" class="ml10">';
        $line = 22;
        $art = '!msg';
        ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_gallerydI:i" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 45;
    $art = '!text2';
    ;
