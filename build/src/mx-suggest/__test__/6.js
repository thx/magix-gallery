...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd{:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryd{:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryd{:_" class="mb20 clearfix"><div class="fl color-9">以下示例：</div><div class="fl"><span class="color-brand">支持双向绑定</span>；输入关键词动态获取提示数据；请求数据有延时，加loading</div></div><div mxa="_zs_galleryd{:b" class="mb10"><span mxs="_zs_galleryd{:a" class="color-9">当前选中：</span>';
    $line = 11;
    $art = '=selected';
    ;
