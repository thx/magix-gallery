...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycz:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycz:a" class="_zs_gallery___test___layout_-eg-content"><div mx-view="mx-suggest/index?list=';
    $line = 4;
    $art = '@[{\n                name: \'test1\',\n                id: 1\n            }, {\n                name: \'test12\',\n                id: 2\n            }, {\n                name: \'abc1\',\n                id: 3\n            }, {\n                name: \'abc2\',\n                id: 4\n            }]';
    ;
    $p += ($expr = '<%@[{            name: \'test1\',            id: 1        }, {            name: \'test12\',            id: 2        }, {            name: \'abc1\',            id: 3        }, {            name: \'abc2\',            id: 4        }]%>', $i($$ref, [{ name: 'test1', id: 1 }, { name: 'test12', id: 2 }, { name: 'abc1', id: 3 }, { name: 'abc2', id: 4 }])) + '&listText=name&listValue=id"></div></div><div mxa="_zs_gallerycz:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycz:_" class="_zs_gallery___test___layout_-eg-title">自定义&nbsp;list-text&nbsp;和&nbsp;list-value</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 22;
    $art = '=viewId';
    ;
