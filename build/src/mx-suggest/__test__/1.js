...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydo:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydo:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydo:_" class="mb20"><span class="color-9">以下示例：</span>动态更新提示数据</div><div id="';
    $line = 8;
    $art = '=viewId';
    ;
