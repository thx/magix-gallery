...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycu:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycu:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerycu:_" class="mb20"><span class="color-9">以下示例：</span>动态更新提示数据</div><div id="';
    $line = 8;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_test" mx-show="' + $viewId + 'update()" mx-view="mx-suggest/index"></div></div><div mxa="_zs_gallerycu:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycu:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 13;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-suggest \n    id="&#123;&#123;=viewId&#125;&#125;_test"\n    mx-show="update()"/&gt;</pre></div><div mxa="_zs_gallerycu:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycu:c" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
