...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydv:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydv:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydv:_" class="mb20"><span class="color-9">以下示例：</span>直接更新提示数据</div><div id="';
    $line = 8;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_test" mx-show="' + $viewId + 'update()" mx-view="mx-suggest/index"></div></div><div mxa="_zs_gallerydv:b" class="clearfix"><div mxa="_zs_gallerydv:c" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerydv:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
