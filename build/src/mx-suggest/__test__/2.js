...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydt:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydt:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydt:_" class="mb20 lh22 clearfix"><div class="color-9 fl">以下示例：</div><div class="fl"><div>支持上下键切换选择项</div><div>模糊检索不区分大小写</div><div>回车默认选中第一个</div></div></div><div mxa="_zs_gallerydt:b" class="mb20"><span mxs="_zs_gallerydt:a" class="color-9">当前选中：</span>';
    $line = 13;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-suggest class="w250"\n    selected="&#123;&#123;=selectedValue&#125;&#125;"\n    placeholder="输入关键词搜索"\n    list="&#123;&#123;@[&#123;\n        text: \'test1\',\n        value: 1\n    &#125;, &#123;\n        text: \'test12\',\n        value: 2\n    &#125;, &#123;\n        text: \'abc1\',\n        value: 3\n    &#125;, &#123;\n        text: \'abc2\',\n        value: 4\n    &#125;]&#125;&#125;"\n    mx-suggest="suggest()"/&gt;</pre></div><div mxa="_zs_gallerydt:e" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydt:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 63;
    $art = '=viewId';
    ;
