...
module.exports = Magix.View.extend({
    ...
    if (list.length > 0) {
        ...
        ;
        $expr = '<%for (var $art_ifgkrqtwg$art_i = 0, $art_cpqbjiqpmd$art_c = list.length; $art_ifgkrqtwg$art_i < $art_cpqbjiqpmd$art_c; $art_ifgkrqtwg$art_i++) {        var item = list[$art_ifgkrqtwg$art_i]%>';
        for (var $art_ifgkrqtwg$art_i = 0, $art_cpqbjiqpmd$art_c = list.length; $art_ifgkrqtwg$art_i < $art_cpqbjiqpmd$art_c; $art_ifgkrqtwg$art_i++) {
            var item = list[$art_ifgkrqtwg$art_i];
