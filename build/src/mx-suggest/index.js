...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryds:_" class="search-box"><i mxs="_zs_galleryds:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (loading) {
        ;
        $p += '<li mxs="_zs_galleryds:a"><div class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></li>';
        $line = 17;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iyxupirrs$art_i = 0, $art_cspjnvzdvf$art_c = list.length; $art_iyxupirrs$art_i < $art_cspjnvzdvf$art_c; $art_iyxupirrs$art_i++) {            var item = list[$art_iyxupirrs$art_i]%>';
            for (var $art_iyxupirrs$art_i = 0, $art_cspjnvzdvf$art_c = list.length; $art_iyxupirrs$art_i < $art_cspjnvzdvf$art_c; $art_iyxupirrs$art_i++) {
                var item = list[$art_iyxupirrs$art_i];
            ...
            ;
            $p += '<li mxa="_zs_galleryds:a" class="text-center color-9">';
            $line = 26;
            $art = '=emptyText';
            ;
