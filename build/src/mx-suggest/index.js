...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iktxhzsk$art_i = 0, $art_cvabbwmenh$art_c = list.length; $art_iktxhzsk$art_i < $art_cvabbwmenh$art_c; $art_iktxhzsk$art_i++) {            var item = list[$art_iktxhzsk$art_i]%>';
            for (var $art_iktxhzsk$art_i = 0, $art_cvabbwmenh$art_c = list.length; $art_iktxhzsk$art_i < $art_cvabbwmenh$art_c; $art_iktxhzsk$art_i++) {
                var item = list[$art_iktxhzsk$art_i];
