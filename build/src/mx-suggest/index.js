...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iktqeddrvq$art_i = 0, $art_cxqpoocuw$art_c = list.length; $art_iktqeddrvq$art_i < $art_cxqpoocuw$art_c; $art_iktqeddrvq$art_i++) {            var item = list[$art_iktqeddrvq$art_i]%>';
            for (var $art_iktqeddrvq$art_i = 0, $art_cxqpoocuw$art_c = list.length; $art_iktqeddrvq$art_i < $art_cxqpoocuw$art_c; $art_iktqeddrvq$art_i++) {
                var item = list[$art_iktqeddrvq$art_i];
