...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd3:_" class="search-box"><i mxs="_zs_galleryd3:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 4;
    $art = '=placeholder';
    ;
    ...
    if (loading) {
        ;
        $p += '<li mxs="_zs_galleryd3:a"><div class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></li>';
        $line = 19;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iqaulmdrpka$art_i = 0, $art_cykhnrjgju$art_c = list.length; $art_iqaulmdrpka$art_i < $art_cykhnrjgju$art_c; $art_iqaulmdrpka$art_i++) {            var item = list[$art_iqaulmdrpka$art_i]%>';
            for (var $art_iqaulmdrpka$art_i = 0, $art_cykhnrjgju$art_c = list.length; $art_iqaulmdrpka$art_i < $art_cykhnrjgju$art_c; $art_iqaulmdrpka$art_i++) {
                var item = list[$art_iqaulmdrpka$art_i];
            ...
            ;
            $p += '<li mxa="_zs_galleryd3:a" class="text-center color-9">';
            $line = 28;
            $art = '=emptyText';
            ;
