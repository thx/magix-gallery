...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ieagp$art_i = 0, $art_cffccqm$art_c = list.length; $art_ieagp$art_i < $art_cffccqm$art_c; $art_ieagp$art_i++) {            var item = list[$art_ieagp$art_i]%>';
            for (var $art_ieagp$art_i = 0, $art_cffccqm$art_c = list.length; $art_ieagp$art_i < $art_cffccqm$art_c; $art_ieagp$art_i++) {
                var item = list[$art_ieagp$art_i];
