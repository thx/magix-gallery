...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iinplij$art_i = 0, $art_cowwfeehfk$art_c = list.length; $art_iinplij$art_i < $art_cowwfeehfk$art_c; $art_iinplij$art_i++) {            var item = list[$art_iinplij$art_i]%>';
            for (var $art_iinplij$art_i = 0, $art_cowwfeehfk$art_c = list.length; $art_iinplij$art_i < $art_cowwfeehfk$art_c; $art_iinplij$art_i++) {
                var item = list[$art_iinplij$art_i];
