...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iyuzchij$art_i = 0, $art_cgeqjzs$art_c = list.length; $art_iyuzchij$art_i < $art_cgeqjzs$art_c; $art_iyuzchij$art_i++) {            var item = list[$art_iyuzchij$art_i]%>';
            for (var $art_iyuzchij$art_i = 0, $art_cgeqjzs$art_c = list.length; $art_iyuzchij$art_i < $art_cgeqjzs$art_c; $art_iyuzchij$art_i++) {
                var item = list[$art_iyuzchij$art_i];
