...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iljptfasll$art_i = 0, $art_cidkklbe$art_c = list.length; $art_iljptfasll$art_i < $art_cidkklbe$art_c; $art_iljptfasll$art_i++) {            var item = list[$art_iljptfasll$art_i]%>';
            for (var $art_iljptfasll$art_i = 0, $art_cidkklbe$art_c = list.length; $art_iljptfasll$art_i < $art_cidkklbe$art_c; $art_iljptfasll$art_i++) {
                var item = list[$art_iljptfasll$art_i];
