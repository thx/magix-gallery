...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_illiv$art_i = 0, $art_cgximzwmtfkr$art_c = list.length; $art_illiv$art_i < $art_cgximzwmtfkr$art_c; $art_illiv$art_i++) {            var item = list[$art_illiv$art_i]%>';
            for (var $art_illiv$art_i = 0, $art_cgximzwmtfkr$art_c = list.length; $art_illiv$art_i < $art_cgximzwmtfkr$art_c; $art_illiv$art_i++) {
                var item = list[$art_illiv$art_i];
