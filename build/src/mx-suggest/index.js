...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iisoyrzpj$art_i = 0, $art_ckebumd$art_c = list.length; $art_iisoyrzpj$art_i < $art_ckebumd$art_c; $art_iisoyrzpj$art_i++) {            var item = list[$art_iisoyrzpj$art_i]%>';
            for (var $art_iisoyrzpj$art_i = 0, $art_ckebumd$art_c = list.length; $art_iisoyrzpj$art_i < $art_ckebumd$art_c; $art_iisoyrzpj$art_i++) {
                var item = list[$art_iisoyrzpj$art_i];
