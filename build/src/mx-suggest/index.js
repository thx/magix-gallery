...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydq:_" class="search-box"><i mxs="_zs_gallerydq:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (loading) {
        ;
        $p += '<li mxs="_zs_gallerydq:a"><div class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></li>';
        $line = 17;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_igzyvxdkime$art_i = 0, $art_cnpusbaewejp$art_c = list.length; $art_igzyvxdkime$art_i < $art_cnpusbaewejp$art_c; $art_igzyvxdkime$art_i++) {            var item = list[$art_igzyvxdkime$art_i]%>';
            for (var $art_igzyvxdkime$art_i = 0, $art_cnpusbaewejp$art_c = list.length; $art_igzyvxdkime$art_i < $art_cnpusbaewejp$art_c; $art_igzyvxdkime$art_i++) {
                var item = list[$art_igzyvxdkime$art_i];
            ...
            ;
            $p += '<li mxa="_zs_gallerydq:a" class="text-center color-9">';
            $line = 26;
            $art = '=emptyText';
            ;
