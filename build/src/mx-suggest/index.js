...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iukcvszj$art_i = 0, $art_cxpken$art_c = list.length; $art_iukcvszj$art_i < $art_cxpken$art_c; $art_iukcvszj$art_i++) {            var item = list[$art_iukcvszj$art_i]%>';
            for (var $art_iukcvszj$art_i = 0, $art_cxpken$art_c = list.length; $art_iukcvszj$art_i < $art_cxpken$art_c; $art_iukcvszj$art_i++) {
                var item = list[$art_iukcvszj$art_i];
