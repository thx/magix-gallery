...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydr:_" class="search-box"><i mxs="_zs_gallerydr:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (loading) {
        ;
        $p += '<li mxs="_zs_gallerydr:a"><div class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></li>';
        $line = 17;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_izazvpfkl$art_i = 0, $art_cxkeomzm$art_c = list.length; $art_izazvpfkl$art_i < $art_cxkeomzm$art_c; $art_izazvpfkl$art_i++) {            var item = list[$art_izazvpfkl$art_i]%>';
            for (var $art_izazvpfkl$art_i = 0, $art_cxkeomzm$art_c = list.length; $art_izazvpfkl$art_i < $art_cxkeomzm$art_c; $art_izazvpfkl$art_i++) {
                var item = list[$art_izazvpfkl$art_i];
            ...
            ;
            $p += '<li mxa="_zs_gallerydr:a" class="text-center color-9">';
            $line = 26;
            $art = '=emptyText';
            ;
