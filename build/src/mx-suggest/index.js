...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_imywimev$art_i = 0, $art_caouzbpkq$art_c = list.length; $art_imywimev$art_i < $art_caouzbpkq$art_c; $art_imywimev$art_i++) {            var item = list[$art_imywimev$art_i]%>';
            for (var $art_imywimev$art_i = 0, $art_caouzbpkq$art_c = list.length; $art_imywimev$art_i < $art_caouzbpkq$art_c; $art_imywimev$art_i++) {
                var item = list[$art_imywimev$art_i];
