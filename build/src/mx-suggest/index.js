...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iavxqdxqr$art_i = 0, $art_cdyanhv$art_c = list.length; $art_iavxqdxqr$art_i < $art_cdyanhv$art_c; $art_iavxqdxqr$art_i++) {            var item = list[$art_iavxqdxqr$art_i]%>';
            for (var $art_iavxqdxqr$art_i = 0, $art_cdyanhv$art_c = list.length; $art_iavxqdxqr$art_i < $art_cdyanhv$art_c; $art_iavxqdxqr$art_i++) {
                var item = list[$art_iavxqdxqr$art_i];
