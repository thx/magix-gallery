...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryc?:_" class="search-box"><i mxs="_zs_galleryc?:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (loading) {
        ;
        $p += '<li mxs="_zs_galleryc?:a" class="loading loading-ext _zs_gallery_mx-suggest_index_-loading-small"><span class="loading-anim"></span></li>';
        $line = 17;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ixuvuplnb$art_i = 0, $art_cirrwnwzf$art_c = list.length; $art_ixuvuplnb$art_i < $art_cirrwnwzf$art_c; $art_ixuvuplnb$art_i++) {            var item = list[$art_ixuvuplnb$art_i]%>';
            for (var $art_ixuvuplnb$art_i = 0, $art_cirrwnwzf$art_c = list.length; $art_ixuvuplnb$art_i < $art_cirrwnwzf$art_c; $art_ixuvuplnb$art_i++) {
                var item = list[$art_ixuvuplnb$art_i];
            ...
            ;
            $p += '<li mxa="_zs_galleryc?:a" class="text-center color-9">';
            $line = 26;
            $art = '=emptyText';
            ;
