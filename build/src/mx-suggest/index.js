...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iwdbtkudnwo$art_i = 0, $art_czcwvnhubuq$art_c = list.length; $art_iwdbtkudnwo$art_i < $art_czcwvnhubuq$art_c; $art_iwdbtkudnwo$art_i++) {            var item = list[$art_iwdbtkudnwo$art_i]%>';
            for (var $art_iwdbtkudnwo$art_i = 0, $art_czcwvnhubuq$art_c = list.length; $art_iwdbtkudnwo$art_i < $art_czcwvnhubuq$art_c; $art_iwdbtkudnwo$art_i++) {
                var item = list[$art_iwdbtkudnwo$art_i];
