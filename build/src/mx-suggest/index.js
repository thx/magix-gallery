...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_irikolnxx$art_i = 0, $art_clvpmcgg$art_c = list.length; $art_irikolnxx$art_i < $art_clvpmcgg$art_c; $art_irikolnxx$art_i++) {            var item = list[$art_irikolnxx$art_i]%>';
            for (var $art_irikolnxx$art_i = 0, $art_clvpmcgg$art_c = list.length; $art_irikolnxx$art_i < $art_clvpmcgg$art_c; $art_irikolnxx$art_i++) {
                var item = list[$art_irikolnxx$art_i];
