...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ifkyskrd$art_i = 0, $art_caefcrxj$art_c = list.length; $art_ifkyskrd$art_i < $art_caefcrxj$art_c; $art_ifkyskrd$art_i++) {            var item = list[$art_ifkyskrd$art_i]%>';
            for (var $art_ifkyskrd$art_i = 0, $art_caefcrxj$art_c = list.length; $art_ifkyskrd$art_i < $art_caefcrxj$art_c; $art_ifkyskrd$art_i++) {
                var item = list[$art_ifkyskrd$art_i];
