...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iwldeonjsrj$art_i = 0, $art_ccmwokszh$art_c = list.length; $art_iwldeonjsrj$art_i < $art_ccmwokszh$art_c; $art_iwldeonjsrj$art_i++) {            var item = list[$art_iwldeonjsrj$art_i]%>';
            for (var $art_iwldeonjsrj$art_i = 0, $art_ccmwokszh$art_c = list.length; $art_iwldeonjsrj$art_i < $art_ccmwokszh$art_c; $art_iwldeonjsrj$art_i++) {
                var item = list[$art_iwldeonjsrj$art_i];
