...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iliypoala$art_i = 0, $art_cjtzzhd$art_c = list.length; $art_iliypoala$art_i < $art_cjtzzhd$art_c; $art_iliypoala$art_i++) {            var item = list[$art_iliypoala$art_i]%>';
            for (var $art_iliypoala$art_i = 0, $art_cjtzzhd$art_c = list.length; $art_iliypoala$art_i < $art_cjtzzhd$art_c; $art_iliypoala$art_i++) {
                var item = list[$art_iliypoala$art_i];
