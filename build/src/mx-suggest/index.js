...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iqaug$art_i = 0, $art_cfpiiga$art_c = list.length; $art_iqaug$art_i < $art_cfpiiga$art_c; $art_iqaug$art_i++) {            var item = list[$art_iqaug$art_i]%>';
            for (var $art_iqaug$art_i = 0, $art_cfpiiga$art_c = list.length; $art_iqaug$art_i < $art_cfpiiga$art_c; $art_iqaug$art_i++) {
                var item = list[$art_iqaug$art_i];
