...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iywxhvyhn$art_i = 0, $art_cizvkcejfk$art_c = list.length; $art_iywxhvyhn$art_i < $art_cizvkcejfk$art_c; $art_iywxhvyhn$art_i++) {            var item = list[$art_iywxhvyhn$art_i]%>';
            for (var $art_iywxhvyhn$art_i = 0, $art_cizvkcejfk$art_c = list.length; $art_iywxhvyhn$art_i < $art_cizvkcejfk$art_c; $art_iywxhvyhn$art_i++) {
                var item = list[$art_iywxhvyhn$art_i];
