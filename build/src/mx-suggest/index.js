...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iywqnsly$art_i = 0, $art_cgbvtgqmpqg$art_c = list.length; $art_iywqnsly$art_i < $art_cgbvtgqmpqg$art_c; $art_iywqnsly$art_i++) {            var item = list[$art_iywqnsly$art_i]%>';
            for (var $art_iywqnsly$art_i = 0, $art_cgbvtgqmpqg$art_c = list.length; $art_iywqnsly$art_i < $art_cgbvtgqmpqg$art_c; $art_iywqnsly$art_i++) {
                var item = list[$art_iywqnsly$art_i];
