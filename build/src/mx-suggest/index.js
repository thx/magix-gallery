...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iwgdlh$art_i = 0, $art_cgzdjgqes$art_c = list.length; $art_iwgdlh$art_i < $art_cgzdjgqes$art_c; $art_iwgdlh$art_i++) {            var item = list[$art_iwgdlh$art_i]%>';
            for (var $art_iwgdlh$art_i = 0, $art_cgzdjgqes$art_c = list.length; $art_iwgdlh$art_i < $art_cgzdjgqes$art_c; $art_iwgdlh$art_i++) {
                var item = list[$art_iwgdlh$art_i];
