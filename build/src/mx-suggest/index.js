...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ilixfwwpdzd$art_i = 0, $art_cbcgjitl$art_c = list.length; $art_ilixfwwpdzd$art_i < $art_cbcgjitl$art_c; $art_ilixfwwpdzd$art_i++) {            var item = list[$art_ilixfwwpdzd$art_i]%>';
            for (var $art_ilixfwwpdzd$art_i = 0, $art_cbcgjitl$art_c = list.length; $art_ilixfwwpdzd$art_i < $art_cbcgjitl$art_c; $art_ilixfwwpdzd$art_i++) {
                var item = list[$art_ilixfwwpdzd$art_i];
