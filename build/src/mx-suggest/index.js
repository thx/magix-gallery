...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ijecus$art_i = 0, $art_cknssq$art_c = list.length; $art_ijecus$art_i < $art_cknssq$art_c; $art_ijecus$art_i++) {            var item = list[$art_ijecus$art_i]%>';
            for (var $art_ijecus$art_i = 0, $art_cknssq$art_c = list.length; $art_ijecus$art_i < $art_cknssq$art_c; $art_ijecus$art_i++) {
                var item = list[$art_ijecus$art_i];
