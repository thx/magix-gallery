...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ixfjrhrek$art_i = 0, $art_cfrwuoluc$art_c = list.length; $art_ixfjrhrek$art_i < $art_cfrwuoluc$art_c; $art_ixfjrhrek$art_i++) {            var item = list[$art_ixfjrhrek$art_i]%>';
            for (var $art_ixfjrhrek$art_i = 0, $art_cfrwuoluc$art_c = list.length; $art_ixfjrhrek$art_i < $art_cfrwuoluc$art_c; $art_ixfjrhrek$art_i++) {
                var item = list[$art_ixfjrhrek$art_i];
