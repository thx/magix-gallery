...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iiwpvyjzg$art_i = 0, $art_coodgutr$art_c = list.length; $art_iiwpvyjzg$art_i < $art_coodgutr$art_c; $art_iiwpvyjzg$art_i++) {            var item = list[$art_iiwpvyjzg$art_i]%>';
            for (var $art_iiwpvyjzg$art_i = 0, $art_coodgutr$art_c = list.length; $art_iiwpvyjzg$art_i < $art_coodgutr$art_c; $art_iiwpvyjzg$art_i++) {
                var item = list[$art_iiwpvyjzg$art_i];
