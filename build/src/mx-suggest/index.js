...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ikcrhyaql$art_i = 0, $art_cczomjwmxn$art_c = list.length; $art_ikcrhyaql$art_i < $art_cczomjwmxn$art_c; $art_ikcrhyaql$art_i++) {            var item = list[$art_ikcrhyaql$art_i]%>';
            for (var $art_ikcrhyaql$art_i = 0, $art_cczomjwmxn$art_c = list.length; $art_ikcrhyaql$art_i < $art_cczomjwmxn$art_c; $art_ikcrhyaql$art_i++) {
                var item = list[$art_ikcrhyaql$art_i];
