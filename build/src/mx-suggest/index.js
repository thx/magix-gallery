...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '"><i mxs="_zs_gallerycK:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 3;
    $art = '=placeholder';
    ;
    ...
    if (loading) {
        ;
        $p += '<div mxs="_zs_gallerycK:a" class="loading loading-ext _zs_gallery_mx-suggest_index_-loading-small"><span class="loading-anim"></span></div>';
        $line = 17;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iundcakhhus$art_i = 0, $art_chycqgzb$art_c = list.length; $art_iundcakhhus$art_i < $art_chycqgzb$art_c; $art_iundcakhhus$art_i++) {            var item = list[$art_iundcakhhus$art_i]%>';
            for (var $art_iundcakhhus$art_i = 0, $art_chycqgzb$art_c = list.length; $art_iundcakhhus$art_i < $art_chycqgzb$art_c; $art_iundcakhhus$art_i++) {
                var item = list[$art_iundcakhhus$art_i];
            ...
            ;
            $p += '<li mxs="_zs_gallerycK:b" class="text-center color-9">无匹配选项</li>';
            $line = 27;
            $art = '/if';
            ;
            $expr = '<%}%>';
