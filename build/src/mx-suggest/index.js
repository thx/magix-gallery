...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ihoknxy$art_i = 0, $art_ckzitprin$art_c = list.length; $art_ihoknxy$art_i < $art_ckzitprin$art_c; $art_ihoknxy$art_i++) {            var item = list[$art_ihoknxy$art_i]%>';
            for (var $art_ihoknxy$art_i = 0, $art_ckzitprin$art_c = list.length; $art_ihoknxy$art_i < $art_ckzitprin$art_c; $art_ihoknxy$art_i++) {
                var item = list[$art_ihoknxy$art_i];
