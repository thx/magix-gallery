...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ildecigwfm$art_i = 0, $art_cigxffmrf$art_c = list.length; $art_ildecigwfm$art_i < $art_cigxffmrf$art_c; $art_ildecigwfm$art_i++) {            var item = list[$art_ildecigwfm$art_i]%>';
            for (var $art_ildecigwfm$art_i = 0, $art_cigxffmrf$art_c = list.length; $art_ildecigwfm$art_i < $art_cigxffmrf$art_c; $art_ildecigwfm$art_i++) {
                var item = list[$art_ildecigwfm$art_i];
