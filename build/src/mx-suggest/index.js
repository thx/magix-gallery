...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_itqdbnv$art_i = 0, $art_cwzcqhqpg$art_c = list.length; $art_itqdbnv$art_i < $art_cwzcqhqpg$art_c; $art_itqdbnv$art_i++) {            var item = list[$art_itqdbnv$art_i]%>';
            for (var $art_itqdbnv$art_i = 0, $art_cwzcqhqpg$art_c = list.length; $art_itqdbnv$art_i < $art_cwzcqhqpg$art_c; $art_itqdbnv$art_i++) {
                var item = list[$art_itqdbnv$art_i];
