...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ifzgimlnp$art_i = 0, $art_catrfooa$art_c = list.length; $art_ifzgimlnp$art_i < $art_catrfooa$art_c; $art_ifzgimlnp$art_i++) {            var item = list[$art_ifzgimlnp$art_i]%>';
            for (var $art_ifzgimlnp$art_i = 0, $art_catrfooa$art_c = list.length; $art_ifzgimlnp$art_i < $art_catrfooa$art_c; $art_ifzgimlnp$art_i++) {
                var item = list[$art_ifzgimlnp$art_i];
