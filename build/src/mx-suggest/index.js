...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ;
        $p += '<li mxs="_zs_gallerydp:b"><div class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></li>';
        $line = 17;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iojpnlce$art_i = 0, $art_cyeqvzevm$art_c = list.length; $art_iojpnlce$art_i < $art_cyeqvzevm$art_c; $art_iojpnlce$art_i++) {            var item = list[$art_iojpnlce$art_i]%>';
            for (var $art_iojpnlce$art_i = 0, $art_cyeqvzevm$art_c = list.length; $art_iojpnlce$art_i < $art_cyeqvzevm$art_c; $art_iojpnlce$art_i++) {
                var item = list[$art_iojpnlce$art_i];
            ...
            ;
            $p += '<li mxa="_zs_gallerydp:b" class="text-center color-9">';
            $line = 26;
            $art = '=emptyText';
            ;
