...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ixtivbnh$art_i = 0, $art_ckaoavauv$art_c = list.length; $art_ixtivbnh$art_i < $art_ckaoavauv$art_c; $art_ixtivbnh$art_i++) {            var item = list[$art_ixtivbnh$art_i]%>';
            for (var $art_ixtivbnh$art_i = 0, $art_ckaoavauv$art_c = list.length; $art_ixtivbnh$art_i < $art_ckaoavauv$art_c; $art_ixtivbnh$art_i++) {
                var item = list[$art_ixtivbnh$art_i];
