...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_izlqesjakcb$art_i = 0, $art_cjduyt$art_c = list.length; $art_izlqesjakcb$art_i < $art_cjduyt$art_c; $art_izlqesjakcb$art_i++) {            var item = list[$art_izlqesjakcb$art_i]%>';
            for (var $art_izlqesjakcb$art_i = 0, $art_cjduyt$art_c = list.length; $art_izlqesjakcb$art_i < $art_cjduyt$art_c; $art_izlqesjakcb$art_i++) {
                var item = list[$art_izlqesjakcb$art_i];
