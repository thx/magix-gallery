...
module.exports = Magix.View.extend({
    ...
    if (selectedText) {
        ;
        $p += '<i mxs="_zs_galleryd`:c" class="mc-iconfont _zs_gallery_mx-suggest_index_-delete-icon" mx-click="' + $viewId + '@{clear}()">&#xe6f8;</i>';
        $line = 15;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_irfiryzh$art_i = 0, $art_cwmcqepvn$art_c = list.length; $art_irfiryzh$art_i < $art_cwmcqepvn$art_c; $art_irfiryzh$art_i++) {            var item = list[$art_irfiryzh$art_i]%>';
            for (var $art_irfiryzh$art_i = 0, $art_cwmcqepvn$art_c = list.length; $art_irfiryzh$art_i < $art_cwmcqepvn$art_c; $art_irfiryzh$art_i++) {
                var item = list[$art_irfiryzh$art_i];
