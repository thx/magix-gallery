...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ioedifb$art_i = 0, $art_cupfemlere$art_c = list.length; $art_ioedifb$art_i < $art_cupfemlere$art_c; $art_ioedifb$art_i++) {            var item = list[$art_ioedifb$art_i]%>';
            for (var $art_ioedifb$art_i = 0, $art_cupfemlere$art_c = list.length; $art_ioedifb$art_i < $art_cupfemlere$art_c; $art_ioedifb$art_i++) {
                var item = list[$art_ioedifb$art_i];
