...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iwvlpshd$art_i = 0, $art_coijymm$art_c = list.length; $art_iwvlpshd$art_i < $art_coijymm$art_c; $art_iwvlpshd$art_i++) {            var item = list[$art_iwvlpshd$art_i]%>';
            for (var $art_iwvlpshd$art_i = 0, $art_coijymm$art_c = list.length; $art_iwvlpshd$art_i < $art_coijymm$art_c; $art_iwvlpshd$art_i++) {
                var item = list[$art_iwvlpshd$art_i];
