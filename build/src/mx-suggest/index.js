...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ikaazff$art_i = 0, $art_cchwdcph$art_c = list.length; $art_ikaazff$art_i < $art_cchwdcph$art_c; $art_ikaazff$art_i++) {            var item = list[$art_ikaazff$art_i]%>';
            for (var $art_ikaazff$art_i = 0, $art_cchwdcph$art_c = list.length; $art_ikaazff$art_i < $art_cchwdcph$art_c; $art_ikaazff$art_i++) {
                var item = list[$art_ikaazff$art_i];
