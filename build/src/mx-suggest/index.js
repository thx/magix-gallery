...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iybyyie$art_i = 0, $art_cajeoujpli$art_c = list.length; $art_iybyyie$art_i < $art_cajeoujpli$art_c; $art_iybyyie$art_i++) {            var item = list[$art_iybyyie$art_i]%>';
            for (var $art_iybyyie$art_i = 0, $art_cajeoujpli$art_c = list.length; $art_iybyyie$art_i < $art_cajeoujpli$art_c; $art_iybyyie$art_i++) {
                var item = list[$art_iybyyie$art_i];
