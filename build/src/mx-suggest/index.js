...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ivnaglgwz$art_i = 0, $art_clfiifrhfx$art_c = list.length; $art_ivnaglgwz$art_i < $art_clfiifrhfx$art_c; $art_ivnaglgwz$art_i++) {            var item = list[$art_ivnaglgwz$art_i]%>';
            for (var $art_ivnaglgwz$art_i = 0, $art_clfiifrhfx$art_c = list.length; $art_ivnaglgwz$art_i < $art_clfiifrhfx$art_c; $art_ivnaglgwz$art_i++) {
                var item = list[$art_ivnaglgwz$art_i];
