...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ijbaeftna$art_i = 0, $art_cogfjr$art_c = list.length; $art_ijbaeftna$art_i < $art_cogfjr$art_c; $art_ijbaeftna$art_i++) {            var item = list[$art_ijbaeftna$art_i]%>';
            for (var $art_ijbaeftna$art_i = 0, $art_cogfjr$art_c = list.length; $art_ijbaeftna$art_i < $art_cogfjr$art_c; $art_ijbaeftna$art_i++) {
                var item = list[$art_ijbaeftna$art_i];
