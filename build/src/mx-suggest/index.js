...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ikeusujxms$art_i = 0, $art_cpsepzjb$art_c = list.length; $art_ikeusujxms$art_i < $art_cpsepzjb$art_c; $art_ikeusujxms$art_i++) {            var item = list[$art_ikeusujxms$art_i]%>';
            for (var $art_ikeusujxms$art_i = 0, $art_cpsepzjb$art_c = list.length; $art_ikeusujxms$art_i < $art_cpsepzjb$art_c; $art_ikeusujxms$art_i++) {
                var item = list[$art_ikeusujxms$art_i];
