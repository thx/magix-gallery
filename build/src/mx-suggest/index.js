...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ivxitsi$art_i = 0, $art_cwtlpcauss$art_c = list.length; $art_ivxitsi$art_i < $art_cwtlpcauss$art_c; $art_ivxitsi$art_i++) {            var item = list[$art_ivxitsi$art_i]%>';
            for (var $art_ivxitsi$art_i = 0, $art_cwtlpcauss$art_c = list.length; $art_ivxitsi$art_i < $art_cwtlpcauss$art_c; $art_ivxitsi$art_i++) {
                var item = list[$art_ivxitsi$art_i];
