...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iycxsiklh$art_i = 0, $art_crdwomwmx$art_c = list.length; $art_iycxsiklh$art_i < $art_crdwomwmx$art_c; $art_iycxsiklh$art_i++) {            var item = list[$art_iycxsiklh$art_i]%>';
            for (var $art_iycxsiklh$art_i = 0, $art_crdwomwmx$art_c = list.length; $art_iycxsiklh$art_i < $art_crdwomwmx$art_c; $art_iycxsiklh$art_i++) {
                var item = list[$art_iycxsiklh$art_i];
