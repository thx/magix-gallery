...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryd6:_" class="search-box"><i mxs="_zs_galleryd6:_" class="mc-iconfont search-icon">&#xe651;</i><input class="input search-input" placeholder="';
    $line = 4;
    $art = '=placeholder';
    ;
    ...
    ;
    $p += '"><ul mxa="_zs_galleryd6:a" class="mx-output-list">';
    $line = 16;
    $art = 'if loading';
    ;
    $expr = '<%if (loading) {%>';
    if (loading) {
        ;
        $p += '<li mxs="_zs_galleryd6:a"><div class="loading" style="padding: 40px 0;"><span class="loading-anim"></span></div></li>';
        $line = 18;
        $art = 'else';
        ;
        $expr = '<%}else {%>';
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ijcepztpbyl$art_i = 0, $art_cnsttjygkhe$art_c = list.length; $art_ijcepztpbyl$art_i < $art_cnsttjygkhe$art_c; $art_ijcepztpbyl$art_i++) {            var item = list[$art_ijcepztpbyl$art_i]%>';
            for (var $art_ijcepztpbyl$art_i = 0, $art_cnsttjygkhe$art_c = list.length; $art_ijcepztpbyl$art_i < $art_cnsttjygkhe$art_c; $art_ijcepztpbyl$art_i++) {
                var item = list[$art_ijcepztpbyl$art_i];
                $p += '<li mxa="_zs_galleryd6:b" class="mx-output-item"><span class="mx-output-link ';
                $line = 22;
            ...
            ;
            $p += '<li mxa="_zs_galleryd6:c" class="text-center color-9">';
            $line = 30;
            $art = '=emptyText';
            ;
