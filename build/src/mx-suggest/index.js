...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_imxkvjq$art_i = 0, $art_cgfoeiuy$art_c = list.length; $art_imxkvjq$art_i < $art_cgfoeiuy$art_c; $art_imxkvjq$art_i++) {            var item = list[$art_imxkvjq$art_i]%>';
            for (var $art_imxkvjq$art_i = 0, $art_cgfoeiuy$art_c = list.length; $art_imxkvjq$art_i < $art_cgfoeiuy$art_c; $art_imxkvjq$art_i++) {
                var item = list[$art_imxkvjq$art_i];
