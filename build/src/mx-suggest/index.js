...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_inggeihlndp$art_i = 0, $art_cdtgwch$art_c = list.length; $art_inggeihlndp$art_i < $art_cdtgwch$art_c; $art_inggeihlndp$art_i++) {            var item = list[$art_inggeihlndp$art_i]%>';
            for (var $art_inggeihlndp$art_i = 0, $art_cdtgwch$art_c = list.length; $art_inggeihlndp$art_i < $art_cdtgwch$art_c; $art_inggeihlndp$art_i++) {
                var item = list[$art_inggeihlndp$art_i];
