...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_icac$art_i = 0, $art_clrrwnv$art_c = list.length; $art_icac$art_i < $art_clrrwnv$art_c; $art_icac$art_i++) {            var item = list[$art_icac$art_i]%>';
            for (var $art_icac$art_i = 0, $art_clrrwnv$art_c = list.length; $art_icac$art_i < $art_clrrwnv$art_c; $art_icac$art_i++) {
                var item = list[$art_icac$art_i];
