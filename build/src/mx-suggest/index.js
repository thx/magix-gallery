...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_ihgjlnxk$art_i = 0, $art_cotgcvlhe$art_c = list.length; $art_ihgjlnxk$art_i < $art_cotgcvlhe$art_c; $art_ihgjlnxk$art_i++) {            var item = list[$art_ihgjlnxk$art_i]%>';
            for (var $art_ihgjlnxk$art_i = 0, $art_cotgcvlhe$art_c = list.length; $art_ihgjlnxk$art_i < $art_cotgcvlhe$art_c; $art_ihgjlnxk$art_i++) {
                var item = list[$art_ihgjlnxk$art_i];
