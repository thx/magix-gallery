...
module.exports = Magix.View.extend({
    ...
    if (loading) {
        ...
        if (list.length > 0) {
            ...
            ;
            $expr = '<%for (var $art_iinfyfnf$art_i = 0, $art_cupogfjez$art_c = list.length; $art_iinfyfnf$art_i < $art_cupogfjez$art_c; $art_iinfyfnf$art_i++) {            var item = list[$art_iinfyfnf$art_i]%>';
            for (var $art_iinfyfnf$art_i = 0, $art_cupogfjez$art_c = list.length; $art_iinfyfnf$art_i < $art_cupogfjez$art_c; $art_iinfyfnf$art_i++) {
                var item = list[$art_iinfyfnf$art_i];
