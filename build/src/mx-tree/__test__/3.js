...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryeZ:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryeZ:a" class="_zs_gallery___test___layout_-eg-content"><div mxv="list" id="';
    $line = 3;
    $art = '=viewId';
    ;
    ...
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '"></div></div><div mxa="_zs_galleryeZ:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryeZ:_" class="_zs_gallery___test___layout_-eg-title">只读 + 可展开收起 + 默认展开 + 有连接线</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
