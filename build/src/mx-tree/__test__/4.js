...
module.exports = Base.extend({
    ...
    $art = '@list';
    ;
    $p += '' + ($expr = '<%@list%>', $i(list)) + '"></div></div><div mxa="_zs_gallerycN:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerycN:_" class="_zs_gallery___test___base_-eg-title">可展开收起 + 默认收起</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
