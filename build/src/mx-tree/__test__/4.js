...
module.exports = Base.extend({
    ...
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '"></div></div><div mxa="_zs_gallerydb:b" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydb:_" class="_zs_gallery___test___layout_-eg-title">可展开收起 + 默认收起</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
