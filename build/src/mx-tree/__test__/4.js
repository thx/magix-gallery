...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerycN:_" class="_zs_gallery___test___base_-example"><div mxv mxa="_zs_gallerycN:a" class="_zs_gallery___test___base_-eg-content"><div mxv="list" id="';
    $line = 3;
    $art = '=viewId';
    ;
    ...
    $art = '@list';
    ;
    $p += '' + ($expr = '<%@list%>', $i($$ref, list)) + '"></div></div><div mxa="_zs_gallerycN:b" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerycN:_" class="_zs_gallery___test___base_-eg-title">可展开收起 + 默认收起</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 11;
    $art = '=viewId';
    ;
