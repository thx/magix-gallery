...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerye3:a" class="clearfix mb20"><div mxa="_zs_gallerye3:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-tree/__test__/2" id="';
    $line = 42;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div></div><div mxa="_zs_gallerye3:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-tree/__test__/1" id="';
    $line = 47;
    $art = '=viewId';
    ;
