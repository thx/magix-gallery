...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipluwqbzk$art_i = 0, $art_cgkpcizikhu$art_c = selectedItems.length; $art_ipluwqbzk$art_i < $art_cgkpcizikhu$art_c; $art_ipluwqbzk$art_i++) {    var item = selectedItems[$art_ipluwqbzk$art_i]%>';
    for (var $art_ipluwqbzk$art_i = 0, $art_cgkpcizikhu$art_c = selectedItems.length; $art_ipluwqbzk$art_i < $art_cgkpcizikhu$art_c; $art_ipluwqbzk$art_i++) {
        var item = selectedItems[$art_ipluwqbzk$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
