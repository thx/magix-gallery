...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iaqwbx$art_i = 0, $art_ctzusuebm$art_c = selectedItems.length; $art_iaqwbx$art_i < $art_ctzusuebm$art_c; $art_iaqwbx$art_i++) {    var item = selectedItems[$art_iaqwbx$art_i]%>';
    for (var $art_iaqwbx$art_i = 0, $art_ctzusuebm$art_c = selectedItems.length; $art_iaqwbx$art_i < $art_ctzusuebm$art_c; $art_iaqwbx$art_i++) {
        var item = selectedItems[$art_iaqwbx$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
