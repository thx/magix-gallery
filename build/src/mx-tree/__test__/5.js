...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ipbuimvi$art_i = 0, $art_cnayhcgp$art_c = selectedItems.length; $art_ipbuimvi$art_i < $art_cnayhcgp$art_c; $art_ipbuimvi$art_i++) {    var item = selectedItems[$art_ipbuimvi$art_i]%>';
    for (var $art_ipbuimvi$art_i = 0, $art_cnayhcgp$art_c = selectedItems.length; $art_ipbuimvi$art_i < $art_cnayhcgp$art_c; $art_ipbuimvi$art_i++) {
        var item = selectedItems[$art_ipbuimvi$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
