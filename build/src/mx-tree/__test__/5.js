...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imezezpdw$art_i = 0, $art_ccgnbts$art_c = selectedItems.length; $art_imezezpdw$art_i < $art_ccgnbts$art_c; $art_imezezpdw$art_i++) {    var item = selectedItems[$art_imezezpdw$art_i]%>';
    for (var $art_imezezpdw$art_i = 0, $art_ccgnbts$art_c = selectedItems.length; $art_imezezpdw$art_i < $art_ccgnbts$art_c; $art_imezezpdw$art_i++) {
        var item = selectedItems[$art_imezezpdw$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
