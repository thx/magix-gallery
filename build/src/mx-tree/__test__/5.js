...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_imfaqzo$art_i = 0, $art_cpcthtksp$art_c = selectedItems.length; $art_imfaqzo$art_i < $art_cpcthtksp$art_c; $art_imfaqzo$art_i++) {    var item = selectedItems[$art_imfaqzo$art_i]%>';
    for (var $art_imfaqzo$art_i = 0, $art_cpcthtksp$art_c = selectedItems.length; $art_imfaqzo$art_i < $art_cpcthtksp$art_c; $art_imfaqzo$art_i++) {
        var item = selectedItems[$art_imfaqzo$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
