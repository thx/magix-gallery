...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igwothd$art_i = 0, $art_chcegngqi$art_c = selectedItems.length; $art_igwothd$art_i < $art_chcegngqi$art_c; $art_igwothd$art_i++) {    var item = selectedItems[$art_igwothd$art_i]%>';
    for (var $art_igwothd$art_i = 0, $art_chcegngqi$art_c = selectedItems.length; $art_igwothd$art_i < $art_chcegngqi$art_c; $art_igwothd$art_i++) {
        var item = selectedItems[$art_igwothd$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
