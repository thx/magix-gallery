...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqpnphzp$art_i = 0, $art_ckbprizc$art_c = selectedItems.length; $art_iqpnphzp$art_i < $art_ckbprizc$art_c; $art_iqpnphzp$art_i++) {    var item = selectedItems[$art_iqpnphzp$art_i]%>';
    for (var $art_iqpnphzp$art_i = 0, $art_ckbprizc$art_c = selectedItems.length; $art_iqpnphzp$art_i < $art_ckbprizc$art_c; $art_iqpnphzp$art_i++) {
        var item = selectedItems[$art_iqpnphzp$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
