...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqnywryv$art_i = 0, $art_cmvyjwxhry$art_c = selectedItems.length; $art_iqnywryv$art_i < $art_cmvyjwxhry$art_c; $art_iqnywryv$art_i++) {    var item = selectedItems[$art_iqnywryv$art_i]%>';
    for (var $art_iqnywryv$art_i = 0, $art_cmvyjwxhry$art_c = selectedItems.length; $art_iqnywryv$art_i < $art_cmvyjwxhry$art_c; $art_iqnywryv$art_i++) {
        var item = selectedItems[$art_iqnywryv$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
