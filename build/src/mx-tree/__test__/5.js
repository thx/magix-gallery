...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igeixpcq$art_i = 0, $art_cemicglk$art_c = selectedItems.length; $art_igeixpcq$art_i < $art_cemicglk$art_c; $art_igeixpcq$art_i++) {    var item = selectedItems[$art_igeixpcq$art_i]%>';
    for (var $art_igeixpcq$art_i = 0, $art_cemicglk$art_c = selectedItems.length; $art_igeixpcq$art_i < $art_cemicglk$art_c; $art_igeixpcq$art_i++) {
        var item = selectedItems[$art_igeixpcq$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
