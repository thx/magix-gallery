...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixnruap$art_i = 0, $art_cqarqorpbq$art_c = selectedItems.length; $art_ixnruap$art_i < $art_cqarqorpbq$art_c; $art_ixnruap$art_i++) {    var item = selectedItems[$art_ixnruap$art_i]%>';
    for (var $art_ixnruap$art_i = 0, $art_cqarqorpbq$art_c = selectedItems.length; $art_ixnruap$art_i < $art_cqarqorpbq$art_c; $art_ixnruap$art_i++) {
        var item = selectedItems[$art_ixnruap$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
