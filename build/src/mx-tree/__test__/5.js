...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igaihdn$art_i = 0, $art_cjegthleyns$art_c = selectedItems.length; $art_igaihdn$art_i < $art_cjegthleyns$art_c; $art_igaihdn$art_i++) {    var item = selectedItems[$art_igaihdn$art_i]%>';
    for (var $art_igaihdn$art_i = 0, $art_cjegthleyns$art_c = selectedItems.length; $art_igaihdn$art_i < $art_cjegthleyns$art_c; $art_igaihdn$art_i++) {
        var item = selectedItems[$art_igaihdn$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
