...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iulrjjqw$art_i = 0, $art_cnbeejwg$art_c = selectedItems.length; $art_iulrjjqw$art_i < $art_cnbeejwg$art_c; $art_iulrjjqw$art_i++) {    var item = selectedItems[$art_iulrjjqw$art_i]%>';
    for (var $art_iulrjjqw$art_i = 0, $art_cnbeejwg$art_c = selectedItems.length; $art_iulrjjqw$art_i < $art_cnbeejwg$art_c; $art_iulrjjqw$art_i++) {
        var item = selectedItems[$art_iulrjjqw$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
