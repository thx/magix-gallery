...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryel:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryel:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryel:_" class="mb20"><a href="javascript:;" mx-click="' + $viewId + 'get()" class="btn btn-brand">获取当前选中单元完整信息</a></div><div mxa="_zs_galleryel:b" class="mb20 clearfix"><div mxs="_zs_galleryel:a" class="color-9 fl">选中单元：</div><div mxa="_zs_galleryel:c" class="fl">';
    $line = 9;
    $art = 'each selectedItems as item';
    ;
    $expr = '<%for (var $art_ijzfzfupnho$art_i = 0, $art_cvxfmegne$art_c = selectedItems.length; $art_ijzfzfupnho$art_i < $art_cvxfmegne$art_c; $art_ijzfzfupnho$art_i++) {    var item = selectedItems[$art_ijzfzfupnho$art_i]%>';
    for (var $art_ijzfzfupnho$art_i = 0, $art_cvxfmegne$art_c = selectedItems.length; $art_ijzfzfupnho$art_i < $art_cvxfmegne$art_c; $art_ijzfzfupnho$art_i++) {
        var item = selectedItems[$art_ijzfzfupnho$art_i];
        $p += '<div>';
        $line = 10;
        $art = '=item.text';
        ;
    ...
    $art = '@list';
    ;
    $p += ($expr = '<%@list%>', $i($$ref, list)) + '&needAll=true"></div></div><div mxa="_zs_galleryel:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryel:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 21;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-tree id="&#123;&#123;=viewId&#125;&#125;_tree"\n    bottom-values="&#123;&#123;@selectedValues&#125;&#125;"\n    list="&#123;&#123;@list&#125;&#125;"\n    need-all="true"&gt;&lt;/mx-tree&gt;</pre></div><div mxa="_zs_galleryel:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryel:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 34;
    $art = '=viewId';
    ;
