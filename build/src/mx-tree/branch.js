...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var index = 0, $art_cvzojscv$art_c = list.length; index < $art_cvzojscv$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cvzojscv$art_c = list.length; index < $art_cvzojscv$art_c; index++) {
        var item = list[index];
