...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_coegxqzelwq$art_c = list.length; index < $art_coegxqzelwq$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_coegxqzelwq$art_c = list.length; index < $art_coegxqzelwq$art_c; index++) {
        var item = list[index];
