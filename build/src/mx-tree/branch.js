...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var index = 0, $art_cowxjzdij$art_c = list.length; index < $art_cowxjzdij$art_c; index++) {    var item = list[index]%>';
    for (var index = 0, $art_cowxjzdij$art_c = list.length; index < $art_cowxjzdij$art_c; index++) {
        var item = list[index];
