...
module.exports = Base.extend({
    ...
    ;
    $p += '</div></div><div mxa="_zs_gallerybN:k" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybN:d" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 41;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerybN:l" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 43;
    $art = '!text1';
    ;
