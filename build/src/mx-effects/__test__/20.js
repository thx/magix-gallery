...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybb:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybb:_" class="_zs_gallery___test___layout_-eg-content"><div class="mt20"><div class="mr20" mx-view="mx-effects/progress?type=gradient&num=20.22"></div></div><div class="mt20"><div class="mr20" mx-view="mx-effects/progress?type=gradient&num=60&color=%23ffb400"></div></div><div class="mt20"><div mx-view="mx-effects/progress?type=gradient&num=80&color=rgb%2881%2C%20163%2C%200%29"></div></div></div><div mxa="_zs_gallerybb:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybb:a" class="_zs_gallery___test___layout_-eg-title">渐变型，精度与传入数值保持一致</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 23;
    $art = '=viewId';
    ;
