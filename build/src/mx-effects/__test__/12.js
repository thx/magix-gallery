...
module.exports = Base.extend({
    ...
    for (var i = 0; i < 5; i++) {
        ;
        $p += '<span mxs="_zs_gallerybe:a" class="mx-star-item" style="color:#ffb400"><i class="mc-iconfont">&#xe60f;</i></span>';
        $expr = '<%}%>';
    }
    ;
    ...
    for (var i = 0; i < 5; i++) {
        ;
        $p += '<span mxs="_zs_gallerybe:b" class="mx-star-item" style="color:rgb(81, 163, 0)"><i class="mc-iconfont">&#xe60f;</i></span>';
        $expr = '<%}%>';
    }
    ;
    $p += '</div></div></div></div></div><div mxa="_zs_gallerybe:l" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybe:c" class="_zs_gallery___test___layout_-eg-title">自定义颜色</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
    ...
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_gallerybe:d" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 19;
    $art = '=viewId';
    ;
