...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybk:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybk:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb20"><div class="mr20" mx-view="mx-effects/progress?type=degree&num=60"></div><div class="mr20" mx-view="mx-effects/progress?type=degree&num=20.22"></div><div mx-view="mx-effects/progress?type=degree&num=100"></div></div></div><div mxa="_zs_gallerybk:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybk:a" class="_zs_gallery___test___layout_-eg-title">刻度型展示值取整</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 19;
    $art = '=viewId';
    ;
