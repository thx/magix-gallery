/*
    ...
    loader: cmd_es
 */
define("mx-effects/__test__/4",["magix","__test__/example","$","mx-copy/index","__test__/hl"],(require,exports,module)=>{
/*Magix,Base,$*/
...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybt:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybt:_" class="_zs_gallery___test___layout_-eg-content"><div class="mx-notice mx-notice-error mb20" style="text-align: left"><div class="mx-notice-inner mx-notice-inner-with"><i class="mc-iconfont mx-notice-icon">&#xe6ad;</i>错误提示</div></div><div text-align="center" class="mx-notice mx-notice-error mb20" style="text-align: center"><div class="mx-notice-inner mx-notice-inner-with"><i class="mc-iconfont mx-notice-icon">&#xe6ad;</i>错误居中提示</div></div><div text-align="center" class="mx-notice mx-notice-border mx-notice-error mb20" style="text-align: center"><div class="mx-notice-inner mx-notice-inner-with"><i class="mc-iconfont mx-notice-icon">&#xe6ad;</i>带边框的错误居中提示</div></div></div><div mxa="_zs_gallerybt:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybt:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 9;
    $art = '=viewId';
    ;
