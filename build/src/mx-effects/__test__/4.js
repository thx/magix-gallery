...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybG:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybG:d" class="_zs_gallery___test___layout_-eg-content"><div class="mb20" mx-view="mx-effects/notice?type=error&content=%E7%BA%A2%E8%89%B2%E9%94%99%E8%AF%AF%E6%8F%90%E7%A4%BA"></div></div><div mxa="_zs_gallerybG:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybG:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 7;
    $art = '=viewId';
    ;
