/*
    ...
    loader: cmd_es
 */
define("mx-effects/__test__/progress",["magix","$","__test__/subs","mx-title/second","./8","./9","./10","__test__/api"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'条形\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'刻度型\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'动态修改\',\n            key: viewId + \'_demo2\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }]';
    ;
    $p += ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'条形\',                    key: viewId + \'_demo1\'                }, {                    name: \'刻度型\',                    key: viewId + \'_demo3\'                }, {                    name: \'动态修改\',                    key: viewId + \'_demo2\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '条形', key: viewId + '_demo1' }, { name: '刻度型', key: viewId + '_demo3' }, { name: '动态修改', key: viewId + '_demo2' }] }, { name: 'API', key: viewId + '_api' }])) + '"></div><div id="';
    $line = 19;
    $art = '=viewId';
    ;
