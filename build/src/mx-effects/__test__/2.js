...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybt:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybt:_" class="_zs_gallery___test___layout_-eg-content"><div bg="white" class="empty-white"><div class="empty-inner"><div><i class="mc-iconfont no-data">&#xe685;</i></div><div><div class="fontsize-14">暂无可选内容</div><div class="fontsize-14">您暂时没有可以添加的内容，请使用本地上传！</div></div></div></div></div><div mxa="_zs_gallerybt:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybt:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 10;
    $art = '=viewId';
    ;
