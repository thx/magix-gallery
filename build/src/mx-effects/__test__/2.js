...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryar:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_galleryar:_" class="_zs_gallery___test___base_-eg-content"><div mx-view="mx-effects/empty?bg=white&content=%E6%9A%82%E6%97%A0%E7%9B%B8%E5%85%B3%E8%AE%B0%E5%BD%95"></div></div><div mxa="_zs_galleryar:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_galleryar:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 8;
    $art = '=viewId';
    ;
