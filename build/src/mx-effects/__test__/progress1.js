/*
    ...
    loader: cmd_es
 */
define("mx-effects/__test__/progress1",["magix","$","__test__/subs","mx-title/second","./8","./9","./29","./22","./21","./23","./20","__test__/api"],(require,exports,module)=>{
/*Magix,$*/
...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerybZ:a" class="clearfix mb20"><div mxa="_zs_gallerybZ:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/8" id="';
    $line = 34;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo9"></div></div><div mxa="_zs_gallerybZ:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/29" id="';
    $line = 38;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo29"></div><div mx-view="mx-effects/__test__/22" id="';
    $line = 39;
    $art = '=viewId';
    ;
