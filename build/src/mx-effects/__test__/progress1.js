...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryeZ:a" class="clearfix mb20"><div mxa="_zs_galleryeZ:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/8" id="';
    $line = 31;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo9"></div></div><div mxa="_zs_galleryeZ:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/22" id="';
    $line = 35;
    $art = '=viewId';
    ;
