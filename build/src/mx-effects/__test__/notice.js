...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerybT:a" class="clearfix mb20"><div mxa="_zs_gallerybT:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/7" id="';
    $line = 35;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo3"></div></div><div mxa="_zs_gallerybT:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/31" id="';
    $line = 40;
    $art = '=viewId';
    ;
