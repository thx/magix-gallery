...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerybI:a" class="clearfix mb20"><div mxa="_zs_gallerybI:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/10" id="';
    $line = 19;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo10"></div></div><div mxa="_zs_gallerybI:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-effects/__test__/24" id="';
    $line = 22;
    $art = '=viewId';
    ;
