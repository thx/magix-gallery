...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybv:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerybv:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb20"><div class="mr20" mx-view="mx-effects/progress?type=degree&num=60&color=%23ffb400"></div><div mx-view="mx-effects/progress?type=degree&num=80&color=rgb%2881%2C%20163%2C%200%29"></div></div></div><div mxa="_zs_gallerybv:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerybv:a" class="_zs_gallery___test___layout_-eg-title">自定义颜色</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 17;
    $art = '=viewId';
    ;
