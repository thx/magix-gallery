...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryby:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryby:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryby:b" class="mb10"><div mx-view="mx-effects/star?num=2.5&icon=';
    $line = 5;
    ...
    $art = '=\'<i class=\\"mc-iconfont\\">&#xe60c;</i>\'';
    ;
    $p += ($expr = '<%!$eu(\'<i class=\\"mc-iconfont\\">&#xe60c;</i>\')%>', $eu('<i class=\"mc-iconfont\">&#xe60c;</i>')) + '&color=rgb%2881%2C%20163%2C%200%29"></div></div></div><div mxa="_zs_galleryby:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryby:_" class="_zs_gallery___test___layout_-eg-title">自定义icon + 颜色</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 16;
    $art = '=viewId';
    ;
