...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxa="_zs_galleryb2:_" class="_zs_gallery_mx-effects_star_-star-bg">';
    $line = 2;
    ...
    for (var i = 0; i < 5; i += 1) {
        ;
        $p += '<span mxa="_zs_galleryb2:a" class="_zs_gallery_mx-effects_star_-star">';
        $line = 4;
        $art = 'if icon';
        ;
        $expr = '<%if (icon) {%>';
        if (icon) {
            ...
            ;
            $p += '<i mxs="_zs_galleryb2:_" class="mc-iconfont">&#xe60f;</i>';
            $line = 8;
            $art = '/if';
            ;
            $expr = '<%}%>';
