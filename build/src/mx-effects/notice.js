...
module.exports = Magix.View.extend({
    ...
    if (show) {
        ...
        if (icon) {
            ;
            $p += '<div mxa="_zs_galleryb8:_" class="_zs_gallery_mx-effects_notice_-inner"><i class="mc-iconfont _zs_gallery_mx-effects_notice_-icon" style="color: ';
            $line = 5;
            $art = '=colorIcon';
            ;
        ...
        if (closable) {
            ;
            $p += '<i mxs="_zs_galleryb8:_" class="mc-iconfont _zs_gallery_mx-effects_notice_-close" mx-click="' + $viewId + 'close()">&#xe603;</i>';
            $line = 14;
            $art = '/if';
            ;
            $expr = '<%}%>';
