/*
    ...
    loader: cmd_es
 */
define("mx-effects/notice",["magix","$","mx-util/color"],(require,exports,module)=>{
/*Magix,$,Util*/
...
module.exports = Magix.View.extend({
    ...
    if (icon) {
        ;
        $p += '<div mxa="_zs_gallerybP:_" class="_zs_gallery_mx-effects_notice_-inner"><i mxs="_zs_gallerybP:_" class="mc-iconfont _zs_gallery_mx-effects_notice_-icon">&#xe6ad;</i>';
        $line = 5;
        $art = '!content';
        ;
