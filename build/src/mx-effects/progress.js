...
module.exports = Magix.View.extend({
    ...
    if (type == 'degree') {
        ;
        $p += '<div mxa="_zs_gallerybW:a" class="_zs_gallery_mx-effects_progress_-degree-wrapper"><div mxa="_zs_gallerybW:b" class="_zs_gallery_mx-effects_progress_-degree-bg">';
        $line = 30;
        ...
        ;
        $p += '</div><div mxa="_zs_gallerybW:c" class="_zs_gallery_mx-effects_progress_-degree-on">';
        $line = 35;
