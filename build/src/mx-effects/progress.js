...
module.exports = Magix.View.extend({
    ...
    if (type == 'degree') {
        ;
        $p += '<div mxa="_zs_gallerybx:a" class="_zs_gallery_mx-effects_progress_-degree-wrapper"><div mxa="_zs_gallerybx:b" class="_zs_gallery_mx-effects_progress_-degree-bg">';
        $line = 26;
        ...
        ;
        $p += '</div><div mxa="_zs_gallerybx:c" class="_zs_gallery_mx-effects_progress_-degree-on">';
        $line = 31;
