...
module.exports = Magix.View.extend({
    ...
    if (type == 'line') {
        ;
        $p += '<div mxa="_zs_galleryaZ:_" class="_zs_gallery_mx-effects_progress_-line"><div class="_zs_gallery_mx-effects_progress_-on" style="width: ';
        $line = 3;
        $art = '=num';
        ;
        $p += '' + ($expr = '<%=num%>', $e(num)) + '; ';
    ...
    if (type == 'degree') {
        ;
        $p += '<div mxa="_zs_galleryaZ:a" class="_zs_gallery_mx-effects_progress_-degree-bg">';
        $line = 10;
        ...
        for (var i = 0; i < 10; i += 1) {
            ;
            $p += '<span mxs="_zs_galleryaZ:_" class="_zs_gallery_mx-effects_progress_-degree"></span>';
            $line = 12;
            $art = '/for';
            ;
            $p += '';
        ...
        ;
        $p += '</div><div mxa="_zs_galleryaZ:b" class="_zs_gallery_mx-effects_progress_-degree-on">';
        $line = 15;
