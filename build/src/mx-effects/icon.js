...
module.exports = Base.extend({
    ...
    if (tip) {
        ...
        $art = '=tip';
        ;
        $p += ($expr = '<%!$eu(tip)%>', $eu(tip)) + '"><span mxa="_zs_gallerybC:_" class="_zs_gallery_mx-effects_icon_-text">';
        $line = 4;
        $art = '=content';
        ;
        ...
        $art = '=styles';
        ;
        $p += ($expr = '<%=styles%>', $e(styles)) + '"><span mxa="_zs_gallerybC:a" class="_zs_gallery_mx-effects_icon_-text">';
        $line = 8;
        $art = '=content';
        ;
        $p += ($expr = '<%=content%>', $e(content)) + '</span></span>';
