...
module.exports = Magix.View.extend({
    ...
    if (tip) {
        ...
        $art = '=tip';
        ;
        $p += ($expr = '<%!$eu(tip)%>', $eu(tip)) + '"><span mxa="_zs_gallerybZ:_" class="_zs_gallery_mx-effects_icon_-text">';
        $line = 4;
        $art = '!content';
        ;
        ...
        $art = '=styles';
        ;
        $p += ($expr = '<%=styles%>', $e(styles)) + '"><span mxa="_zs_gallerybZ:a" class="_zs_gallery_mx-effects_icon_-text">';
        $line = 8;
        $art = '!content';
        ;
        $p += ($expr = '<%!content%>', $n(content)) + '</span></span>';
