...
module.exports = Magix.View.extend({
    ...
    'preview<mouseover>': function (e) {
        ...
        if (!Magix.inside(e.relatedTarget, e.eventTarget)) {
            ...
            var type_1 = data_1.type, url_1 = data_1.url;
            ...
            var next_1 = function (width, height) {
                ...
                switch (type_1) {
                    case 'image':
                        ...
                        break;
                    case 'taotu':// 套图 
                        inner = $("<div class=\"clearfix\">\n                            <img src=\"" + url_1 + "\" class=\"fl\"/>    \n                            <img src=\"" + data_1.datuUrl + "\" class=\"fr\"/>\n                        </div>");
                        break;
                    case 'video':
            ...
            if (type_1 == 'taotu') {
                ...
                var img = new Image();
                img.onload = function () {
                    var width = data_1.width + 10 + this.width + 20;
                    var height = Math.max(data_1.height, this.height) + 20;
                    next_1(width, height);
                };
                img.src = data_1.datuUrl;
            }
            else {
                if (data_1.width && data_1.height) {
                    // 预留间隔
                    next_1(data_1.width + 20, data_1.height + 20);
                }
                else {
                    // 只有图片和文案类型可不配置，其余必填
                    // 没有配置预览宽高
                    if (type_1 == 'text') {
                        ...
                        var img = new Image();
                        img.onload = function () {
                            next_1(this.width + 20, this.height + 20);
                        };
                        img.src = url_1;
                    }
                }
