...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybL:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallerybL:_" class="_zs_gallery___test___base_-eg-content"><div class="mb10">1. 文字预览：支持内容包含可执行脚本，以文字展示</div><div class="_zs_gallery_mx-preview___test___index_-demo mb20 ml15" mx-view="mx-preview/index?format=5&url=%3Cscript%3Ealert%281%29%3C%2Fscript%3E&maxWidth=100&maxHeight=100"></div><div class="mb10">2. 文字预览：可配置文字上的跳转链接click-url</div><div class="_zs_gallery_mx-preview___test___index_-demo ml15" mx-view="mx-preview/index?format=5&url=%E6%96%87%E5%AD%97%E9%93%BE%E5%86%85%E5%AE%B9%E5%B1%95%E7%A4%BA&clickUrl=%2F%2Fwww.taobao.com%2F&maxWidth=100&maxHeight=100"></div></div><div mxa="_zs_gallerybL:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerybL:a" class="_zs_gallery___test___base_-eg-title">文字预览</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
