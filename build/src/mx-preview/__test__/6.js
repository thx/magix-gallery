...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibcjtswdr$art_i = 0, $art_cibxhfdj$art_c = list.length; $art_ibcjtswdr$art_i < $art_cibxhfdj$art_c; $art_ibcjtswdr$art_i++) {    var item = list[$art_ibcjtswdr$art_i]%>';
    for (var $art_ibcjtswdr$art_i = 0, $art_cibxhfdj$art_c = list.length; $art_ibcjtswdr$art_i < $art_cibxhfdj$art_c; $art_ibcjtswdr$art_i++) {
        var item = list[$art_ibcjtswdr$art_i];
