...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijqangbuzm$art_i = 0, $art_cgiwsl$art_c = list.length; $art_ijqangbuzm$art_i < $art_cgiwsl$art_c; $art_ijqangbuzm$art_i++) {    var item = list[$art_ijqangbuzm$art_i]%>';
    for (var $art_ijqangbuzm$art_i = 0, $art_cgiwsl$art_c = list.length; $art_ijqangbuzm$art_i < $art_cgiwsl$art_c; $art_ijqangbuzm$art_i++) {
        var item = list[$art_ijqangbuzm$art_i];
