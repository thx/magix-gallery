...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihuguiytdi$art_i = 0, $art_cdnsocfklso$art_c = list.length; $art_ihuguiytdi$art_i < $art_cdnsocfklso$art_c; $art_ihuguiytdi$art_i++) {    var item = list[$art_ihuguiytdi$art_i]%>';
    for (var $art_ihuguiytdi$art_i = 0, $art_cdnsocfklso$art_c = list.length; $art_ihuguiytdi$art_i < $art_cdnsocfklso$art_c; $art_ihuguiytdi$art_i++) {
        var item = list[$art_ihuguiytdi$art_i];
