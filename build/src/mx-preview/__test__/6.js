...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iscwnzcom$art_i = 0, $art_cpdfnc$art_c = list.length; $art_iscwnzcom$art_i < $art_cpdfnc$art_c; $art_iscwnzcom$art_i++) {    var item = list[$art_iscwnzcom$art_i]%>';
    for (var $art_iscwnzcom$art_i = 0, $art_cpdfnc$art_c = list.length; $art_iscwnzcom$art_i < $art_cpdfnc$art_c; $art_iscwnzcom$art_i++) {
        var item = list[$art_iscwnzcom$art_i];
