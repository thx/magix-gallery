...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icphswc$art_i = 0, $art_cwvuuullnn$art_c = list.length; $art_icphswc$art_i < $art_cwvuuullnn$art_c; $art_icphswc$art_i++) {    var item = list[$art_icphswc$art_i]%>';
    for (var $art_icphswc$art_i = 0, $art_cwvuuullnn$art_c = list.length; $art_icphswc$art_i < $art_cwvuuullnn$art_c; $art_icphswc$art_i++) {
        var item = list[$art_icphswc$art_i];
