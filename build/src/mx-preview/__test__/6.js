...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imdoxsczj$art_i = 0, $art_cpdwnciff$art_c = list.length; $art_imdoxsczj$art_i < $art_cpdwnciff$art_c; $art_imdoxsczj$art_i++) {    var item = list[$art_imdoxsczj$art_i]%>';
    for (var $art_imdoxsczj$art_i = 0, $art_cpdwnciff$art_c = list.length; $art_imdoxsczj$art_i < $art_cpdwnciff$art_c; $art_imdoxsczj$art_i++) {
        var item = list[$art_imdoxsczj$art_i];
