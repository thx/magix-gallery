...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ithzigrcbr$art_i = 0, $art_crosnrunuen$art_c = list.length; $art_ithzigrcbr$art_i < $art_crosnrunuen$art_c; $art_ithzigrcbr$art_i++) {    var item = list[$art_ithzigrcbr$art_i]%>';
    for (var $art_ithzigrcbr$art_i = 0, $art_crosnrunuen$art_c = list.length; $art_ithzigrcbr$art_i < $art_crosnrunuen$art_c; $art_ithzigrcbr$art_i++) {
        var item = list[$art_ithzigrcbr$art_i];
