...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyfvlfpkq$art_i = 0, $art_cyuwvuxgax$art_c = list.length; $art_iyfvlfpkq$art_i < $art_cyuwvuxgax$art_c; $art_iyfvlfpkq$art_i++) {    var item = list[$art_iyfvlfpkq$art_i]%>';
    for (var $art_iyfvlfpkq$art_i = 0, $art_cyuwvuxgax$art_c = list.length; $art_iyfvlfpkq$art_i < $art_cyuwvuxgax$art_c; $art_iyfvlfpkq$art_i++) {
        var item = list[$art_iyfvlfpkq$art_i];
