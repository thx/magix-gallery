...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuwmcvcibn$art_i = 0, $art_cmdmesfvbk$art_c = list.length; $art_iuwmcvcibn$art_i < $art_cmdmesfvbk$art_c; $art_iuwmcvcibn$art_i++) {    var item = list[$art_iuwmcvcibn$art_i]%>';
    for (var $art_iuwmcvcibn$art_i = 0, $art_cmdmesfvbk$art_c = list.length; $art_iuwmcvcibn$art_i < $art_cmdmesfvbk$art_c; $art_iuwmcvcibn$art_i++) {
        var item = list[$art_iuwmcvcibn$art_i];
