...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivmrfvq$art_i = 0, $art_cfyamlh$art_c = list.length; $art_ivmrfvq$art_i < $art_cfyamlh$art_c; $art_ivmrfvq$art_i++) {    var item = list[$art_ivmrfvq$art_i]%>';
    for (var $art_ivmrfvq$art_i = 0, $art_cfyamlh$art_c = list.length; $art_ivmrfvq$art_i < $art_cfyamlh$art_c; $art_ivmrfvq$art_i++) {
        var item = list[$art_ivmrfvq$art_i];
