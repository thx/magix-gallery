...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igqvczh$art_i = 0, $art_coexczawrm$art_c = list.length; $art_igqvczh$art_i < $art_coexczawrm$art_c; $art_igqvczh$art_i++) {    var item = list[$art_igqvczh$art_i]%>';
    for (var $art_igqvczh$art_i = 0, $art_coexczawrm$art_c = list.length; $art_igqvczh$art_i < $art_coexczawrm$art_c; $art_igqvczh$art_i++) {
        var item = list[$art_igqvczh$art_i];
