...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imymeboel$art_i = 0, $art_cfvbco$art_c = list.length; $art_imymeboel$art_i < $art_cfvbco$art_c; $art_imymeboel$art_i++) {    var item = list[$art_imymeboel$art_i]%>';
    for (var $art_imymeboel$art_i = 0, $art_cfvbco$art_c = list.length; $art_imymeboel$art_i < $art_cfvbco$art_c; $art_imymeboel$art_i++) {
        var item = list[$art_imymeboel$art_i];
