...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igafkrlfe$art_i = 0, $art_ckzdxwilm$art_c = list.length; $art_igafkrlfe$art_i < $art_ckzdxwilm$art_c; $art_igafkrlfe$art_i++) {    var item = list[$art_igafkrlfe$art_i]%>';
    for (var $art_igafkrlfe$art_i = 0, $art_ckzdxwilm$art_c = list.length; $art_igafkrlfe$art_i < $art_ckzdxwilm$art_c; $art_igafkrlfe$art_i++) {
        var item = list[$art_igafkrlfe$art_i];
