...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idzhbref$art_i = 0, $art_cmkhpljb$art_c = list.length; $art_idzhbref$art_i < $art_cmkhpljb$art_c; $art_idzhbref$art_i++) {    var item = list[$art_idzhbref$art_i]%>';
    for (var $art_idzhbref$art_i = 0, $art_cmkhpljb$art_c = list.length; $art_idzhbref$art_i < $art_cmkhpljb$art_c; $art_idzhbref$art_i++) {
        var item = list[$art_idzhbref$art_i];
