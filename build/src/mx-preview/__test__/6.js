...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iudncquar$art_i = 0, $art_cmxqeealbw$art_c = list.length; $art_iudncquar$art_i < $art_cmxqeealbw$art_c; $art_iudncquar$art_i++) {    var item = list[$art_iudncquar$art_i]%>';
    for (var $art_iudncquar$art_i = 0, $art_cmxqeealbw$art_c = list.length; $art_iudncquar$art_i < $art_cmxqeealbw$art_c; $art_iudncquar$art_i++) {
        var item = list[$art_iudncquar$art_i];
