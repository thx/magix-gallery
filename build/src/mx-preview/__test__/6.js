...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igvafxnnj$art_i = 0, $art_cggxvwnek$art_c = list.length; $art_igvafxnnj$art_i < $art_cggxvwnek$art_c; $art_igvafxnnj$art_i++) {    var item = list[$art_igvafxnnj$art_i]%>';
    for (var $art_igvafxnnj$art_i = 0, $art_cggxvwnek$art_c = list.length; $art_igvafxnnj$art_i < $art_cggxvwnek$art_c; $art_igvafxnnj$art_i++) {
        var item = list[$art_igvafxnnj$art_i];
