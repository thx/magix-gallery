...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixkujysq$art_i = 0, $art_cqdiquuu$art_c = list.length; $art_ixkujysq$art_i < $art_cqdiquuu$art_c; $art_ixkujysq$art_i++) {    var item = list[$art_ixkujysq$art_i]%>';
    for (var $art_ixkujysq$art_i = 0, $art_cqdiquuu$art_c = list.length; $art_ixkujysq$art_i < $art_cqdiquuu$art_c; $art_ixkujysq$art_i++) {
        var item = list[$art_ixkujysq$art_i];
