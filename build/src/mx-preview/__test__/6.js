...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ioevezzxxg$art_i = 0, $art_cqramgowlw$art_c = list.length; $art_ioevezzxxg$art_i < $art_cqramgowlw$art_c; $art_ioevezzxxg$art_i++) {    var item = list[$art_ioevezzxxg$art_i]%>';
    for (var $art_ioevezzxxg$art_i = 0, $art_cqramgowlw$art_c = list.length; $art_ioevezzxxg$art_i < $art_cqramgowlw$art_c; $art_ioevezzxxg$art_i++) {
        var item = list[$art_ioevezzxxg$art_i];
