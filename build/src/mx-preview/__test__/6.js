...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iszjrsvjyus$art_i = 0, $art_cmgtvzwcvxof$art_c = list.length; $art_iszjrsvjyus$art_i < $art_cmgtvzwcvxof$art_c; $art_iszjrsvjyus$art_i++) {    var item = list[$art_iszjrsvjyus$art_i]%>';
    for (var $art_iszjrsvjyus$art_i = 0, $art_cmgtvzwcvxof$art_c = list.length; $art_iszjrsvjyus$art_i < $art_cmgtvzwcvxof$art_c; $art_iszjrsvjyus$art_i++) {
        var item = list[$art_iszjrsvjyus$art_i];
