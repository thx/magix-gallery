...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iaxdibfct$art_i = 0, $art_cvzabmgmsf$art_c = list.length; $art_iaxdibfct$art_i < $art_cvzabmgmsf$art_c; $art_iaxdibfct$art_i++) {    var item = list[$art_iaxdibfct$art_i]%>';
    for (var $art_iaxdibfct$art_i = 0, $art_cvzabmgmsf$art_c = list.length; $art_iaxdibfct$art_i < $art_cvzabmgmsf$art_c; $art_iaxdibfct$art_i++) {
        var item = list[$art_iaxdibfct$art_i];
