...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itpwyhgaxek$art_i = 0, $art_cvoucgxei$art_c = list.length; $art_itpwyhgaxek$art_i < $art_cvoucgxei$art_c; $art_itpwyhgaxek$art_i++) {    var item = list[$art_itpwyhgaxek$art_i]%>';
    for (var $art_itpwyhgaxek$art_i = 0, $art_cvoucgxei$art_c = list.length; $art_itpwyhgaxek$art_i < $art_cvoucgxei$art_c; $art_itpwyhgaxek$art_i++) {
        var item = list[$art_itpwyhgaxek$art_i];
