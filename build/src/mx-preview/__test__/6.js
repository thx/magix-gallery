...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iokcvpedkp$art_i = 0, $art_cqdarbaik$art_c = list.length; $art_iokcvpedkp$art_i < $art_cqdarbaik$art_c; $art_iokcvpedkp$art_i++) {    var item = list[$art_iokcvpedkp$art_i]%>';
    for (var $art_iokcvpedkp$art_i = 0, $art_cqdarbaik$art_c = list.length; $art_iokcvpedkp$art_i < $art_cqdarbaik$art_c; $art_iokcvpedkp$art_i++) {
        var item = list[$art_iokcvpedkp$art_i];
