...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iitnnvucu$art_i = 0, $art_cfhniyzkl$art_c = list.length; $art_iitnnvucu$art_i < $art_cfhniyzkl$art_c; $art_iitnnvucu$art_i++) {    var item = list[$art_iitnnvucu$art_i]%>';
    for (var $art_iitnnvucu$art_i = 0, $art_cfhniyzkl$art_c = list.length; $art_iitnnvucu$art_i < $art_cfhniyzkl$art_c; $art_iitnnvucu$art_i++) {
        var item = list[$art_iitnnvucu$art_i];
