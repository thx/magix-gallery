...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifcksqbig$art_i = 0, $art_cilohbjvvdi$art_c = list.length; $art_ifcksqbig$art_i < $art_cilohbjvvdi$art_c; $art_ifcksqbig$art_i++) {    var item = list[$art_ifcksqbig$art_i]%>';
    for (var $art_ifcksqbig$art_i = 0, $art_cilohbjvvdi$art_c = list.length; $art_ifcksqbig$art_i < $art_cilohbjvvdi$art_c; $art_ifcksqbig$art_i++) {
        var item = list[$art_ifcksqbig$art_i];
