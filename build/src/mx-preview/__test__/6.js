...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijbobezk$art_i = 0, $art_cdeyeaq$art_c = list.length; $art_ijbobezk$art_i < $art_cdeyeaq$art_c; $art_ijbobezk$art_i++) {    var item = list[$art_ijbobezk$art_i]%>';
    for (var $art_ijbobezk$art_i = 0, $art_cdeyeaq$art_c = list.length; $art_ijbobezk$art_i < $art_cdeyeaq$art_c; $art_ijbobezk$art_i++) {
        var item = list[$art_ijbobezk$art_i];
