...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijjqrixyj$art_i = 0, $art_cxuznftj$art_c = list.length; $art_ijjqrixyj$art_i < $art_cxuznftj$art_c; $art_ijjqrixyj$art_i++) {    var item = list[$art_ijjqrixyj$art_i]%>';
    for (var $art_ijjqrixyj$art_i = 0, $art_cxuznftj$art_c = list.length; $art_ijjqrixyj$art_i < $art_cxuznftj$art_c; $art_ijjqrixyj$art_i++) {
        var item = list[$art_ijjqrixyj$art_i];
