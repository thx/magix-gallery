...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iwxoamwone$art_i = 0, $art_casjzqfgch$art_c = list.length; $art_iwxoamwone$art_i < $art_casjzqfgch$art_c; $art_iwxoamwone$art_i++) {    var item = list[$art_iwxoamwone$art_i]%>';
    for (var $art_iwxoamwone$art_i = 0, $art_casjzqfgch$art_c = list.length; $art_iwxoamwone$art_i < $art_casjzqfgch$art_c; $art_iwxoamwone$art_i++) {
        var item = list[$art_iwxoamwone$art_i];
