...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifpxsdbxizv$art_i = 0, $art_csmqolbqzn$art_c = list.length; $art_ifpxsdbxizv$art_i < $art_csmqolbqzn$art_c; $art_ifpxsdbxizv$art_i++) {    var item = list[$art_ifpxsdbxizv$art_i]%>';
    for (var $art_ifpxsdbxizv$art_i = 0, $art_csmqolbqzn$art_c = list.length; $art_ifpxsdbxizv$art_i < $art_csmqolbqzn$art_c; $art_ifpxsdbxizv$art_i++) {
        var item = list[$art_ifpxsdbxizv$art_i];
