...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijopsjdrrgi$art_i = 0, $art_cfilcftd$art_c = list.length; $art_ijopsjdrrgi$art_i < $art_cfilcftd$art_c; $art_ijopsjdrrgi$art_i++) {    var item = list[$art_ijopsjdrrgi$art_i]%>';
    for (var $art_ijopsjdrrgi$art_i = 0, $art_cfilcftd$art_c = list.length; $art_ijopsjdrrgi$art_i < $art_cfilcftd$art_c; $art_ijopsjdrrgi$art_i++) {
        var item = list[$art_ijopsjdrrgi$art_i];
