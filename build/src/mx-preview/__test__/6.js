...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iafmbgpz$art_i = 0, $art_cujwhht$art_c = list.length; $art_iafmbgpz$art_i < $art_cujwhht$art_c; $art_iafmbgpz$art_i++) {    var item = list[$art_iafmbgpz$art_i]%>';
    for (var $art_iafmbgpz$art_i = 0, $art_cujwhht$art_c = list.length; $art_iafmbgpz$art_i < $art_cujwhht$art_c; $art_iafmbgpz$art_i++) {
        var item = list[$art_iafmbgpz$art_i];
