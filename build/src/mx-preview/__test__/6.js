...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilnoevab$art_i = 0, $art_cbzdrycqhpi$art_c = list.length; $art_ilnoevab$art_i < $art_cbzdrycqhpi$art_c; $art_ilnoevab$art_i++) {    var item = list[$art_ilnoevab$art_i]%>';
    for (var $art_ilnoevab$art_i = 0, $art_cbzdrycqhpi$art_c = list.length; $art_ilnoevab$art_i < $art_cbzdrycqhpi$art_c; $art_ilnoevab$art_i++) {
        var item = list[$art_ilnoevab$art_i];
