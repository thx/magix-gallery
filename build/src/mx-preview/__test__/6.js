...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyhajgkrk$art_i = 0, $art_cnjporthk$art_c = list.length; $art_iyhajgkrk$art_i < $art_cnjporthk$art_c; $art_iyhajgkrk$art_i++) {    var item = list[$art_iyhajgkrk$art_i]%>';
    for (var $art_iyhajgkrk$art_i = 0, $art_cnjporthk$art_c = list.length; $art_iyhajgkrk$art_i < $art_cnjporthk$art_c; $art_iyhajgkrk$art_i++) {
        var item = list[$art_iyhajgkrk$art_i];
