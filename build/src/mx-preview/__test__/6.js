...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itrkdwp$art_i = 0, $art_cnfxvktm$art_c = list.length; $art_itrkdwp$art_i < $art_cnfxvktm$art_c; $art_itrkdwp$art_i++) {    var item = list[$art_itrkdwp$art_i]%>';
    for (var $art_itrkdwp$art_i = 0, $art_cnfxvktm$art_c = list.length; $art_itrkdwp$art_i < $art_cnfxvktm$art_c; $art_itrkdwp$art_i++) {
        var item = list[$art_itrkdwp$art_i];
