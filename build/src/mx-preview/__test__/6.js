...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixkhpbame$art_i = 0, $art_cuxqhwd$art_c = list.length; $art_ixkhpbame$art_i < $art_cuxqhwd$art_c; $art_ixkhpbame$art_i++) {    var item = list[$art_ixkhpbame$art_i]%>';
    for (var $art_ixkhpbame$art_i = 0, $art_cuxqhwd$art_c = list.length; $art_ixkhpbame$art_i < $art_cuxqhwd$art_c; $art_ixkhpbame$art_i++) {
        var item = list[$art_ixkhpbame$art_i];
