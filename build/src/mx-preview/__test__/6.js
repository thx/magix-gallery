...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iflqhtqmyc$art_i = 0, $art_cyahxzwoh$art_c = list.length; $art_iflqhtqmyc$art_i < $art_cyahxzwoh$art_c; $art_iflqhtqmyc$art_i++) {    var item = list[$art_iflqhtqmyc$art_i]%>';
    for (var $art_iflqhtqmyc$art_i = 0, $art_cyahxzwoh$art_c = list.length; $art_iflqhtqmyc$art_i < $art_cyahxzwoh$art_c; $art_iflqhtqmyc$art_i++) {
        var item = list[$art_iflqhtqmyc$art_i];
