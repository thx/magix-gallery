...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irzwqrvm$art_i = 0, $art_crpjvuxv$art_c = list.length; $art_irzwqrvm$art_i < $art_crpjvuxv$art_c; $art_irzwqrvm$art_i++) {    var item = list[$art_irzwqrvm$art_i]%>';
    for (var $art_irzwqrvm$art_i = 0, $art_crpjvuxv$art_c = list.length; $art_irzwqrvm$art_i < $art_crpjvuxv$art_c; $art_irzwqrvm$art_i++) {
        var item = list[$art_irzwqrvm$art_i];
