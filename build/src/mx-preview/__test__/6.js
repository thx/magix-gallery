...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icqqzlpqjk$art_i = 0, $art_cukgdog$art_c = list.length; $art_icqqzlpqjk$art_i < $art_cukgdog$art_c; $art_icqqzlpqjk$art_i++) {    var item = list[$art_icqqzlpqjk$art_i]%>';
    for (var $art_icqqzlpqjk$art_i = 0, $art_cukgdog$art_c = list.length; $art_icqqzlpqjk$art_i < $art_cukgdog$art_c; $art_icqqzlpqjk$art_i++) {
        var item = list[$art_icqqzlpqjk$art_i];
