...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igjgisjrpc$art_i = 0, $art_cgeessui$art_c = list.length; $art_igjgisjrpc$art_i < $art_cgeessui$art_c; $art_igjgisjrpc$art_i++) {    var item = list[$art_igjgisjrpc$art_i]%>';
    for (var $art_igjgisjrpc$art_i = 0, $art_cgeessui$art_c = list.length; $art_igjgisjrpc$art_i < $art_cgeessui$art_c; $art_igjgisjrpc$art_i++) {
        var item = list[$art_igjgisjrpc$art_i];
