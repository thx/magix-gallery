...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_izjgiekqd$art_i = 0, $art_ckyxyswp$art_c = list.length; $art_izjgiekqd$art_i < $art_ckyxyswp$art_c; $art_izjgiekqd$art_i++) {    var item = list[$art_izjgiekqd$art_i]%>';
    for (var $art_izjgiekqd$art_i = 0, $art_ckyxyswp$art_c = list.length; $art_izjgiekqd$art_i < $art_ckyxyswp$art_c; $art_izjgiekqd$art_i++) {
        var item = list[$art_izjgiekqd$art_i];
