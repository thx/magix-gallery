...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivcklpxsq$art_i = 0, $art_cxiwiq$art_c = list.length; $art_ivcklpxsq$art_i < $art_cxiwiq$art_c; $art_ivcklpxsq$art_i++) {    var item = list[$art_ivcklpxsq$art_i]%>';
    for (var $art_ivcklpxsq$art_i = 0, $art_cxiwiq$art_c = list.length; $art_ivcklpxsq$art_i < $art_cxiwiq$art_c; $art_ivcklpxsq$art_i++) {
        var item = list[$art_ivcklpxsq$art_i];
