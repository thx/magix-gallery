...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iieukrz$art_i = 0, $art_cwpvztp$art_c = list.length; $art_iieukrz$art_i < $art_cwpvztp$art_c; $art_iieukrz$art_i++) {    var item = list[$art_iieukrz$art_i]%>';
    for (var $art_iieukrz$art_i = 0, $art_cwpvztp$art_c = list.length; $art_iieukrz$art_i < $art_cwpvztp$art_c; $art_iieukrz$art_i++) {
        var item = list[$art_iieukrz$art_i];
