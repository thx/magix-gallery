...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ieghdxjll$art_i = 0, $art_cghoejn$art_c = list.length; $art_ieghdxjll$art_i < $art_cghoejn$art_c; $art_ieghdxjll$art_i++) {    var item = list[$art_ieghdxjll$art_i]%>';
    for (var $art_ieghdxjll$art_i = 0, $art_cghoejn$art_c = list.length; $art_ieghdxjll$art_i < $art_cghoejn$art_c; $art_ieghdxjll$art_i++) {
        var item = list[$art_ieghdxjll$art_i];
