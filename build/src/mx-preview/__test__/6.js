...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icesnktmq$art_i = 0, $art_cgtptuqecg$art_c = list.length; $art_icesnktmq$art_i < $art_cgtptuqecg$art_c; $art_icesnktmq$art_i++) {    var item = list[$art_icesnktmq$art_i]%>';
    for (var $art_icesnktmq$art_i = 0, $art_cgtptuqecg$art_c = list.length; $art_icesnktmq$art_i < $art_cgtptuqecg$art_c; $art_icesnktmq$art_i++) {
        var item = list[$art_icesnktmq$art_i];
