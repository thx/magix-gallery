...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_icarmqyguh$art_i = 0, $art_cbscqhrfl$art_c = list.length; $art_icarmqyguh$art_i < $art_cbscqhrfl$art_c; $art_icarmqyguh$art_i++) {    var item = list[$art_icarmqyguh$art_i]%>';
    for (var $art_icarmqyguh$art_i = 0, $art_cbscqhrfl$art_c = list.length; $art_icarmqyguh$art_i < $art_cbscqhrfl$art_c; $art_icarmqyguh$art_i++) {
        var item = list[$art_icarmqyguh$art_i];
