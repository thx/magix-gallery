...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idrzbniby$art_i = 0, $art_cnvnts$art_c = list.length; $art_idrzbniby$art_i < $art_cnvnts$art_c; $art_idrzbniby$art_i++) {    var item = list[$art_idrzbniby$art_i]%>';
    for (var $art_idrzbniby$art_i = 0, $art_cnvnts$art_c = list.length; $art_idrzbniby$art_i < $art_cnvnts$art_c; $art_idrzbniby$art_i++) {
        var item = list[$art_idrzbniby$art_i];
