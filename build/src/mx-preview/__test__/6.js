...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itowrldg$art_i = 0, $art_cxjkvwn$art_c = list.length; $art_itowrldg$art_i < $art_cxjkvwn$art_c; $art_itowrldg$art_i++) {    var item = list[$art_itowrldg$art_i]%>';
    for (var $art_itowrldg$art_i = 0, $art_cxjkvwn$art_c = list.length; $art_itowrldg$art_i < $art_cxjkvwn$art_c; $art_itowrldg$art_i++) {
        var item = list[$art_itowrldg$art_i];
