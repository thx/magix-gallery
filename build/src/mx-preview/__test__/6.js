...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixrouly$art_i = 0, $art_cdjwlzpoof$art_c = list.length; $art_ixrouly$art_i < $art_cdjwlzpoof$art_c; $art_ixrouly$art_i++) {    var item = list[$art_ixrouly$art_i]%>';
    for (var $art_ixrouly$art_i = 0, $art_cdjwlzpoof$art_c = list.length; $art_ixrouly$art_i < $art_cdjwlzpoof$art_c; $art_ixrouly$art_i++) {
        var item = list[$art_ixrouly$art_i];
