...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifluxxzzhr$art_i = 0, $art_cklscnffb$art_c = list.length; $art_ifluxxzzhr$art_i < $art_cklscnffb$art_c; $art_ifluxxzzhr$art_i++) {    var item = list[$art_ifluxxzzhr$art_i]%>';
    for (var $art_ifluxxzzhr$art_i = 0, $art_cklscnffb$art_c = list.length; $art_ifluxxzzhr$art_i < $art_cklscnffb$art_c; $art_ifluxxzzhr$art_i++) {
        var item = list[$art_ifluxxzzhr$art_i];
