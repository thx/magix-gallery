...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imigopzh$art_i = 0, $art_cppfbarftp$art_c = list.length; $art_imigopzh$art_i < $art_cppfbarftp$art_c; $art_imigopzh$art_i++) {    var item = list[$art_imigopzh$art_i]%>';
    for (var $art_imigopzh$art_i = 0, $art_cppfbarftp$art_c = list.length; $art_imigopzh$art_i < $art_cppfbarftp$art_c; $art_imigopzh$art_i++) {
        var item = list[$art_imigopzh$art_i];
