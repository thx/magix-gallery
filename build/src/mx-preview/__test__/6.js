...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irfmwlkko$art_i = 0, $art_cubnzpuai$art_c = list.length; $art_irfmwlkko$art_i < $art_cubnzpuai$art_c; $art_irfmwlkko$art_i++) {    var item = list[$art_irfmwlkko$art_i]%>';
    for (var $art_irfmwlkko$art_i = 0, $art_cubnzpuai$art_c = list.length; $art_irfmwlkko$art_i < $art_cubnzpuai$art_c; $art_irfmwlkko$art_i++) {
        var item = list[$art_irfmwlkko$art_i];
