...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibjeagzhim$art_i = 0, $art_cxdkjeyoorg$art_c = list.length; $art_ibjeagzhim$art_i < $art_cxdkjeyoorg$art_c; $art_ibjeagzhim$art_i++) {    var item = list[$art_ibjeagzhim$art_i]%>';
    for (var $art_ibjeagzhim$art_i = 0, $art_cxdkjeyoorg$art_c = list.length; $art_ibjeagzhim$art_i < $art_cxdkjeyoorg$art_c; $art_ibjeagzhim$art_i++) {
        var item = list[$art_ibjeagzhim$art_i];
