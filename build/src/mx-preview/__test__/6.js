...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikwcnggv$art_i = 0, $art_cfdezyooy$art_c = list.length; $art_ikwcnggv$art_i < $art_cfdezyooy$art_c; $art_ikwcnggv$art_i++) {    var item = list[$art_ikwcnggv$art_i]%>';
    for (var $art_ikwcnggv$art_i = 0, $art_cfdezyooy$art_c = list.length; $art_ikwcnggv$art_i < $art_cfdezyooy$art_c; $art_ikwcnggv$art_i++) {
        var item = list[$art_ikwcnggv$art_i];
