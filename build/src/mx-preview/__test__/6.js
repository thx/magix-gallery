...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixdemzlnbs$art_i = 0, $art_cpgabzgr$art_c = list.length; $art_ixdemzlnbs$art_i < $art_cpgabzgr$art_c; $art_ixdemzlnbs$art_i++) {    var item = list[$art_ixdemzlnbs$art_i]%>';
    for (var $art_ixdemzlnbs$art_i = 0, $art_cpgabzgr$art_c = list.length; $art_ixdemzlnbs$art_i < $art_cpgabzgr$art_c; $art_ixdemzlnbs$art_i++) {
        var item = list[$art_ixdemzlnbs$art_i];
