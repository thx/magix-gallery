...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iotkfi$art_i = 0, $art_cctcjdhqdmd$art_c = list.length; $art_iotkfi$art_i < $art_cctcjdhqdmd$art_c; $art_iotkfi$art_i++) {    var item = list[$art_iotkfi$art_i]%>';
    for (var $art_iotkfi$art_i = 0, $art_cctcjdhqdmd$art_c = list.length; $art_iotkfi$art_i < $art_cctcjdhqdmd$art_c; $art_iotkfi$art_i++) {
        var item = list[$art_iotkfi$art_i];
