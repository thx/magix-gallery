...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibbcibbfch$art_i = 0, $art_cykcogmoq$art_c = list.length; $art_ibbcibbfch$art_i < $art_cykcogmoq$art_c; $art_ibbcibbfch$art_i++) {    var item = list[$art_ibbcibbfch$art_i]%>';
    for (var $art_ibbcibbfch$art_i = 0, $art_cykcogmoq$art_c = list.length; $art_ibbcibbfch$art_i < $art_cykcogmoq$art_c; $art_ibbcibbfch$art_i++) {
        var item = list[$art_ibbcibbfch$art_i];
