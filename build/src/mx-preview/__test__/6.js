...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixovevsole$art_i = 0, $art_cewzevnmh$art_c = list.length; $art_ixovevsole$art_i < $art_cewzevnmh$art_c; $art_ixovevsole$art_i++) {    var item = list[$art_ixovevsole$art_i]%>';
    for (var $art_ixovevsole$art_i = 0, $art_cewzevnmh$art_c = list.length; $art_ixovevsole$art_i < $art_cewzevnmh$art_c; $art_ixovevsole$art_i++) {
        var item = list[$art_ixovevsole$art_i];
