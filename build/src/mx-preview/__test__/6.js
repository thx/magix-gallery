...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iapxm$art_i = 0, $art_cgnxpgvzw$art_c = list.length; $art_iapxm$art_i < $art_cgnxpgvzw$art_c; $art_iapxm$art_i++) {    var item = list[$art_iapxm$art_i]%>';
    for (var $art_iapxm$art_i = 0, $art_cgnxpgvzw$art_c = list.length; $art_iapxm$art_i < $art_cgnxpgvzw$art_c; $art_iapxm$art_i++) {
        var item = list[$art_iapxm$art_i];
