...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iuxjnqchbab$art_i = 0, $art_cmvycrulad$art_c = list.length; $art_iuxjnqchbab$art_i < $art_cmvycrulad$art_c; $art_iuxjnqchbab$art_i++) {    var item = list[$art_iuxjnqchbab$art_i]%>';
    for (var $art_iuxjnqchbab$art_i = 0, $art_cmvycrulad$art_c = list.length; $art_iuxjnqchbab$art_i < $art_cmvycrulad$art_c; $art_iuxjnqchbab$art_i++) {
        var item = list[$art_iuxjnqchbab$art_i];
