...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixbnxjcfj$art_i = 0, $art_cwoprdrqxm$art_c = list.length; $art_ixbnxjcfj$art_i < $art_cwoprdrqxm$art_c; $art_ixbnxjcfj$art_i++) {    var item = list[$art_ixbnxjcfj$art_i]%>';
    for (var $art_ixbnxjcfj$art_i = 0, $art_cwoprdrqxm$art_c = list.length; $art_ixbnxjcfj$art_i < $art_cwoprdrqxm$art_c; $art_ixbnxjcfj$art_i++) {
        var item = list[$art_ixbnxjcfj$art_i];
