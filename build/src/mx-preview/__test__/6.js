...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idfbhytq$art_i = 0, $art_cjsovtt$art_c = list.length; $art_idfbhytq$art_i < $art_cjsovtt$art_c; $art_idfbhytq$art_i++) {    var item = list[$art_idfbhytq$art_i]%>';
    for (var $art_idfbhytq$art_i = 0, $art_cjsovtt$art_c = list.length; $art_idfbhytq$art_i < $art_cjsovtt$art_c; $art_idfbhytq$art_i++) {
        var item = list[$art_idfbhytq$art_i];
