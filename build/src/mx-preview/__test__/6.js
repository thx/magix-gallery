...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixhkpmctvv$art_i = 0, $art_ciiovrjsra$art_c = list.length; $art_ixhkpmctvv$art_i < $art_ciiovrjsra$art_c; $art_ixhkpmctvv$art_i++) {    var item = list[$art_ixhkpmctvv$art_i]%>';
    for (var $art_ixhkpmctvv$art_i = 0, $art_ciiovrjsra$art_c = list.length; $art_ixhkpmctvv$art_i < $art_ciiovrjsra$art_c; $art_ixhkpmctvv$art_i++) {
        var item = list[$art_ixhkpmctvv$art_i];
