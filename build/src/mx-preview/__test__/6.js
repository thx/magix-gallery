...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imhtbeg$art_i = 0, $art_chctpxmx$art_c = list.length; $art_imhtbeg$art_i < $art_chctpxmx$art_c; $art_imhtbeg$art_i++) {    var item = list[$art_imhtbeg$art_i]%>';
    for (var $art_imhtbeg$art_i = 0, $art_chctpxmx$art_c = list.length; $art_imhtbeg$art_i < $art_chctpxmx$art_c; $art_imhtbeg$art_i++) {
        var item = list[$art_imhtbeg$art_i];
