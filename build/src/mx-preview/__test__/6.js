...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igbkctswf$art_i = 0, $art_cpzmnab$art_c = list.length; $art_igbkctswf$art_i < $art_cpzmnab$art_c; $art_igbkctswf$art_i++) {    var item = list[$art_igbkctswf$art_i]%>';
    for (var $art_igbkctswf$art_i = 0, $art_cpzmnab$art_c = list.length; $art_igbkctswf$art_i < $art_cpzmnab$art_c; $art_igbkctswf$art_i++) {
        var item = list[$art_igbkctswf$art_i];
