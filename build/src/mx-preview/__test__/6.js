...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_irznnmlc$art_i = 0, $art_cdaadvhkpk$art_c = list.length; $art_irznnmlc$art_i < $art_cdaadvhkpk$art_c; $art_irznnmlc$art_i++) {    var item = list[$art_irznnmlc$art_i]%>';
    for (var $art_irznnmlc$art_i = 0, $art_cdaadvhkpk$art_c = list.length; $art_irznnmlc$art_i < $art_cdaadvhkpk$art_c; $art_irznnmlc$art_i++) {
        var item = list[$art_irznnmlc$art_i];
