...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixvzpkuwgbf$art_i = 0, $art_cprpiqh$art_c = list.length; $art_ixvzpkuwgbf$art_i < $art_cprpiqh$art_c; $art_ixvzpkuwgbf$art_i++) {    var item = list[$art_ixvzpkuwgbf$art_i]%>';
    for (var $art_ixvzpkuwgbf$art_i = 0, $art_cprpiqh$art_c = list.length; $art_ixvzpkuwgbf$art_i < $art_cprpiqh$art_c; $art_ixvzpkuwgbf$art_i++) {
        var item = list[$art_ixvzpkuwgbf$art_i];
