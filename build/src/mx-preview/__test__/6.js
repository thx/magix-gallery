...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igxjqksh$art_i = 0, $art_ccehyjgkee$art_c = list.length; $art_igxjqksh$art_i < $art_ccehyjgkee$art_c; $art_igxjqksh$art_i++) {    var item = list[$art_igxjqksh$art_i]%>';
    for (var $art_igxjqksh$art_i = 0, $art_ccehyjgkee$art_c = list.length; $art_igxjqksh$art_i < $art_ccehyjgkee$art_c; $art_igxjqksh$art_i++) {
        var item = list[$art_igxjqksh$art_i];
