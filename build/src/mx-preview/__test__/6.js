...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iibredj$art_i = 0, $art_cxnoqynbkur$art_c = list.length; $art_iibredj$art_i < $art_cxnoqynbkur$art_c; $art_iibredj$art_i++) {    var item = list[$art_iibredj$art_i]%>';
    for (var $art_iibredj$art_i = 0, $art_cxnoqynbkur$art_c = list.length; $art_iibredj$art_i < $art_cxnoqynbkur$art_c; $art_iibredj$art_i++) {
        var item = list[$art_iibredj$art_i];
