...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipkjogrtj$art_i = 0, $art_czgtanhctj$art_c = list.length; $art_ipkjogrtj$art_i < $art_czgtanhctj$art_c; $art_ipkjogrtj$art_i++) {    var item = list[$art_ipkjogrtj$art_i]%>';
    for (var $art_ipkjogrtj$art_i = 0, $art_czgtanhctj$art_c = list.length; $art_ipkjogrtj$art_i < $art_czgtanhctj$art_c; $art_ipkjogrtj$art_i++) {
        var item = list[$art_ipkjogrtj$art_i];
