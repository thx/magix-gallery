...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iskuvbzj$art_i = 0, $art_csqdki$art_c = list.length; $art_iskuvbzj$art_i < $art_csqdki$art_c; $art_iskuvbzj$art_i++) {    var item = list[$art_iskuvbzj$art_i]%>';
    for (var $art_iskuvbzj$art_i = 0, $art_csqdki$art_c = list.length; $art_iskuvbzj$art_i < $art_csqdki$art_c; $art_iskuvbzj$art_i++) {
        var item = list[$art_iskuvbzj$art_i];
