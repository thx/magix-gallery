...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijtiriqqhws$art_i = 0, $art_cmhzhscopk$art_c = list.length; $art_ijtiriqqhws$art_i < $art_cmhzhscopk$art_c; $art_ijtiriqqhws$art_i++) {    var item = list[$art_ijtiriqqhws$art_i]%>';
    for (var $art_ijtiriqqhws$art_i = 0, $art_cmhzhscopk$art_c = list.length; $art_ijtiriqqhws$art_i < $art_cmhzhscopk$art_c; $art_ijtiriqqhws$art_i++) {
        var item = list[$art_ijtiriqqhws$art_i];
