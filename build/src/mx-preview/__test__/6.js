...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iegrfjduoq$art_i = 0, $art_cikpnrrzhad$art_c = list.length; $art_iegrfjduoq$art_i < $art_cikpnrrzhad$art_c; $art_iegrfjduoq$art_i++) {    var item = list[$art_iegrfjduoq$art_i]%>';
    for (var $art_iegrfjduoq$art_i = 0, $art_cikpnrrzhad$art_c = list.length; $art_iegrfjduoq$art_i < $art_cikpnrrzhad$art_c; $art_iegrfjduoq$art_i++) {
        var item = list[$art_iegrfjduoq$art_i];
