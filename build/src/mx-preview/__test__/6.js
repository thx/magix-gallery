...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ivnzskmwai$art_i = 0, $art_cvulvkebox$art_c = list.length; $art_ivnzskmwai$art_i < $art_cvulvkebox$art_c; $art_ivnzskmwai$art_i++) {    var item = list[$art_ivnzskmwai$art_i]%>';
    for (var $art_ivnzskmwai$art_i = 0, $art_cvulvkebox$art_c = list.length; $art_ivnzskmwai$art_i < $art_cvulvkebox$art_c; $art_ivnzskmwai$art_i++) {
        var item = list[$art_ivnzskmwai$art_i];
