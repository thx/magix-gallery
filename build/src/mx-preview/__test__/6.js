...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqpvsadkccjl$art_i = 0, $art_cbbcjhrmqrin$art_c = list.length; $art_iqpvsadkccjl$art_i < $art_cbbcjhrmqrin$art_c; $art_iqpvsadkccjl$art_i++) {    var item = list[$art_iqpvsadkccjl$art_i]%>';
    for (var $art_iqpvsadkccjl$art_i = 0, $art_cbbcjhrmqrin$art_c = list.length; $art_iqpvsadkccjl$art_i < $art_cbbcjhrmqrin$art_c; $art_iqpvsadkccjl$art_i++) {
        var item = list[$art_iqpvsadkccjl$art_i];
