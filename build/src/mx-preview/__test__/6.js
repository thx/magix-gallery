...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imamhcoy$art_i = 0, $art_cqgxciurq$art_c = list.length; $art_imamhcoy$art_i < $art_cqgxciurq$art_c; $art_imamhcoy$art_i++) {    var item = list[$art_imamhcoy$art_i]%>';
    for (var $art_imamhcoy$art_i = 0, $art_cqgxciurq$art_c = list.length; $art_imamhcoy$art_i < $art_cqgxciurq$art_c; $art_imamhcoy$art_i++) {
        var item = list[$art_imamhcoy$art_i];
