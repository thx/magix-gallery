...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ilpbwxvqqh$art_i = 0, $art_cjwzhbbx$art_c = list.length; $art_ilpbwxvqqh$art_i < $art_cjwzhbbx$art_c; $art_ilpbwxvqqh$art_i++) {    var item = list[$art_ilpbwxvqqh$art_i]%>';
    for (var $art_ilpbwxvqqh$art_i = 0, $art_cjwzhbbx$art_c = list.length; $art_ilpbwxvqqh$art_i < $art_cjwzhbbx$art_c; $art_ilpbwxvqqh$art_i++) {
        var item = list[$art_ilpbwxvqqh$art_i];
