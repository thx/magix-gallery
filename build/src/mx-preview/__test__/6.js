...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyuuydknz$art_i = 0, $art_cemdswxco$art_c = list.length; $art_iyuuydknz$art_i < $art_cemdswxco$art_c; $art_iyuuydknz$art_i++) {    var item = list[$art_iyuuydknz$art_i]%>';
    for (var $art_iyuuydknz$art_i = 0, $art_cemdswxco$art_c = list.length; $art_iyuuydknz$art_i < $art_cemdswxco$art_c; $art_iyuuydknz$art_i++) {
        var item = list[$art_iyuuydknz$art_i];
