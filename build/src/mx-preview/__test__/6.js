...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iputxybol$art_i = 0, $art_cxvkwdaadqrr$art_c = list.length; $art_iputxybol$art_i < $art_cxvkwdaadqrr$art_c; $art_iputxybol$art_i++) {    var item = list[$art_iputxybol$art_i]%>';
    for (var $art_iputxybol$art_i = 0, $art_cxvkwdaadqrr$art_c = list.length; $art_iputxybol$art_i < $art_cxvkwdaadqrr$art_c; $art_iputxybol$art_i++) {
        var item = list[$art_iputxybol$art_i];
