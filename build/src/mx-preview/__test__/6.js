...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijgphmjcjjk$art_i = 0, $art_ckslopaya$art_c = list.length; $art_ijgphmjcjjk$art_i < $art_ckslopaya$art_c; $art_ijgphmjcjjk$art_i++) {    var item = list[$art_ijgphmjcjjk$art_i]%>';
    for (var $art_ijgphmjcjjk$art_i = 0, $art_ckslopaya$art_c = list.length; $art_ijgphmjcjjk$art_i < $art_ckslopaya$art_c; $art_ijgphmjcjjk$art_i++) {
        var item = list[$art_ijgphmjcjjk$art_i];
