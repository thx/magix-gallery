...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iacvxqey$art_i = 0, $art_cfhuyslqrdm$art_c = list.length; $art_iacvxqey$art_i < $art_cfhuyslqrdm$art_c; $art_iacvxqey$art_i++) {    var item = list[$art_iacvxqey$art_i]%>';
    for (var $art_iacvxqey$art_i = 0, $art_cfhuyslqrdm$art_c = list.length; $art_iacvxqey$art_i < $art_cfhuyslqrdm$art_c; $art_iacvxqey$art_i++) {
        var item = list[$art_iacvxqey$art_i];
