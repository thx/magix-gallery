...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifkhayje$art_i = 0, $art_cnazblcjxi$art_c = list.length; $art_ifkhayje$art_i < $art_cnazblcjxi$art_c; $art_ifkhayje$art_i++) {    var item = list[$art_ifkhayje$art_i]%>';
    for (var $art_ifkhayje$art_i = 0, $art_cnazblcjxi$art_c = list.length; $art_ifkhayje$art_i < $art_cnazblcjxi$art_c; $art_ifkhayje$art_i++) {
        var item = list[$art_ifkhayje$art_i];
