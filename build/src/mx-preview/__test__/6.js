...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iswwvylsi$art_i = 0, $art_cprzpq$art_c = list.length; $art_iswwvylsi$art_i < $art_cprzpq$art_c; $art_iswwvylsi$art_i++) {    var item = list[$art_iswwvylsi$art_i]%>';
    for (var $art_iswwvylsi$art_i = 0, $art_cprzpq$art_c = list.length; $art_iswwvylsi$art_i < $art_cprzpq$art_c; $art_iswwvylsi$art_i++) {
        var item = list[$art_iswwvylsi$art_i];
