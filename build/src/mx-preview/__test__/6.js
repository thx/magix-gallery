...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itqdlhvmqf$art_i = 0, $art_citbkxllk$art_c = list.length; $art_itqdlhvmqf$art_i < $art_citbkxllk$art_c; $art_itqdlhvmqf$art_i++) {    var item = list[$art_itqdlhvmqf$art_i]%>';
    for (var $art_itqdlhvmqf$art_i = 0, $art_citbkxllk$art_c = list.length; $art_itqdlhvmqf$art_i < $art_citbkxllk$art_c; $art_itqdlhvmqf$art_i++) {
        var item = list[$art_itqdlhvmqf$art_i];
