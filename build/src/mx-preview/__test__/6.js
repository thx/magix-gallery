...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ikgvgtkcm$art_i = 0, $art_czelpdnh$art_c = list.length; $art_ikgvgtkcm$art_i < $art_czelpdnh$art_c; $art_ikgvgtkcm$art_i++) {    var item = list[$art_ikgvgtkcm$art_i]%>';
    for (var $art_ikgvgtkcm$art_i = 0, $art_czelpdnh$art_c = list.length; $art_ikgvgtkcm$art_i < $art_czelpdnh$art_c; $art_ikgvgtkcm$art_i++) {
        var item = list[$art_ikgvgtkcm$art_i];
