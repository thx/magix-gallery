...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igptlycrxa$art_i = 0, $art_cccqwidwdif$art_c = list.length; $art_igptlycrxa$art_i < $art_cccqwidwdif$art_c; $art_igptlycrxa$art_i++) {    var item = list[$art_igptlycrxa$art_i]%>';
    for (var $art_igptlycrxa$art_i = 0, $art_cccqwidwdif$art_c = list.length; $art_igptlycrxa$art_i < $art_cccqwidwdif$art_c; $art_igptlycrxa$art_i++) {
        var item = list[$art_igptlycrxa$art_i];
