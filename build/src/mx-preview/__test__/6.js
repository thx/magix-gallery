...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifixecyobpl$art_i = 0, $art_cwozfewc$art_c = list.length; $art_ifixecyobpl$art_i < $art_cwozfewc$art_c; $art_ifixecyobpl$art_i++) {    var item = list[$art_ifixecyobpl$art_i]%>';
    for (var $art_ifixecyobpl$art_i = 0, $art_cwozfewc$art_c = list.length; $art_ifixecyobpl$art_i < $art_cwozfewc$art_c; $art_ifixecyobpl$art_i++) {
        var item = list[$art_ifixecyobpl$art_i];
