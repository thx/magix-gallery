...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itsgvimje$art_i = 0, $art_cqdibcqlvo$art_c = list.length; $art_itsgvimje$art_i < $art_cqdibcqlvo$art_c; $art_itsgvimje$art_i++) {    var item = list[$art_itsgvimje$art_i]%>';
    for (var $art_itsgvimje$art_i = 0, $art_cqdibcqlvo$art_c = list.length; $art_itsgvimje$art_i < $art_cqdibcqlvo$art_c; $art_itsgvimje$art_i++) {
        var item = list[$art_itsgvimje$art_i];
