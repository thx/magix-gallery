...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipsbibldbm$art_i = 0, $art_cpajkcxgyg$art_c = list.length; $art_ipsbibldbm$art_i < $art_cpajkcxgyg$art_c; $art_ipsbibldbm$art_i++) {    var item = list[$art_ipsbibldbm$art_i]%>';
    for (var $art_ipsbibldbm$art_i = 0, $art_cpajkcxgyg$art_c = list.length; $art_ipsbibldbm$art_i < $art_cpajkcxgyg$art_c; $art_ipsbibldbm$art_i++) {
        var item = list[$art_ipsbibldbm$art_i];
