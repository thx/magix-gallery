...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixivwquo$art_i = 0, $art_chkksjjly$art_c = list.length; $art_ixivwquo$art_i < $art_chkksjjly$art_c; $art_ixivwquo$art_i++) {    var item = list[$art_ixivwquo$art_i]%>';
    for (var $art_ixivwquo$art_i = 0, $art_chkksjjly$art_c = list.length; $art_ixivwquo$art_i < $art_chkksjjly$art_c; $art_ixivwquo$art_i++) {
        var item = list[$art_ixivwquo$art_i];
