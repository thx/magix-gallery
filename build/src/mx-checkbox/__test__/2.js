...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cibmbpzmdh$art_c = list.length; groupIndex < $art_cibmbpzmdh$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cibmbpzmdh$art_c = list.length; groupIndex < $art_cibmbpzmdh$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objjbyqudyt$art_obj = group.subs, $art_caqbgglzsm$art_c = $art_objjbyqudyt$art_obj.length; subIndex < $art_caqbgglzsm$art_c; subIndex++) {        var sub = $art_objjbyqudyt$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objjbyqudyt$art_obj = group.subs, $art_caqbgglzsm$art_c = $art_objjbyqudyt$art_obj.length; subIndex < $art_caqbgglzsm$art_c; subIndex++) {
            var sub = $art_objjbyqudyt$art_obj[subIndex];
