...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cqcjsfmsa$art_c = list.length; groupIndex < $art_cqcjsfmsa$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cqcjsfmsa$art_c = list.length; groupIndex < $art_cqcjsfmsa$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objiizrygn$art_obj = group.subs, $art_cnlzlgnisqb$art_c = $art_objiizrygn$art_obj.length; subIndex < $art_cnlzlgnisqb$art_c; subIndex++) {        var sub = $art_objiizrygn$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objiizrygn$art_obj = group.subs, $art_cnlzlgnisqb$art_c = $art_objiizrygn$art_obj.length; subIndex < $art_cnlzlgnisqb$art_c; subIndex++) {
            var sub = $art_objiizrygn$art_obj[subIndex];
