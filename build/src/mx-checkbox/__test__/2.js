...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cpvpxaepk$art_c = list.length; groupIndex < $art_cpvpxaepk$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cpvpxaepk$art_c = list.length; groupIndex < $art_cpvpxaepk$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objpbfebwek$art_obj = group.subs, $art_cssrubjp$art_c = $art_objpbfebwek$art_obj.length; subIndex < $art_cssrubjp$art_c; subIndex++) {        var sub = $art_objpbfebwek$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objpbfebwek$art_obj = group.subs, $art_cssrubjp$art_c = $art_objpbfebwek$art_obj.length; subIndex < $art_cssrubjp$art_c; subIndex++) {
            var sub = $art_objpbfebwek$art_obj[subIndex];
