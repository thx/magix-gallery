...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_clfiruthm$art_c = list.length; groupIndex < $art_clfiruthm$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_clfiruthm$art_c = list.length; groupIndex < $art_clfiruthm$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objgtrjfuzsvf$art_obj = group.subs, $art_czrjbvehg$art_c = $art_objgtrjfuzsvf$art_obj.length; subIndex < $art_czrjbvehg$art_c; subIndex++) {        var sub = $art_objgtrjfuzsvf$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objgtrjfuzsvf$art_obj = group.subs, $art_czrjbvehg$art_c = $art_objgtrjfuzsvf$art_obj.length; subIndex < $art_czrjbvehg$art_c; subIndex++) {
            var sub = $art_objgtrjfuzsvf$art_obj[subIndex];
