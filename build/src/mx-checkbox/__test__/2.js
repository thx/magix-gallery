...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cwcejpvn$art_c = list.length; groupIndex < $art_cwcejpvn$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cwcejpvn$art_c = list.length; groupIndex < $art_cwcejpvn$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objdmarzdddr$art_obj = group.subs, $art_cgasuybazv$art_c = $art_objdmarzdddr$art_obj.length; subIndex < $art_cgasuybazv$art_c; subIndex++) {        var sub = $art_objdmarzdddr$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objdmarzdddr$art_obj = group.subs, $art_cgasuybazv$art_c = $art_objdmarzdddr$art_obj.length; subIndex < $art_cgasuybazv$art_c; subIndex++) {
            var sub = $art_objdmarzdddr$art_obj[subIndex];
