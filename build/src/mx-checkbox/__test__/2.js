...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cjkxehc$art_c = list.length; groupIndex < $art_cjkxehc$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cjkxehc$art_c = list.length; groupIndex < $art_cjkxehc$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objgxumy$art_obj = group.subs, $art_ccvvzldc$art_c = $art_objgxumy$art_obj.length; subIndex < $art_ccvvzldc$art_c; subIndex++) {        var sub = $art_objgxumy$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objgxumy$art_obj = group.subs, $art_ccvvzldc$art_c = $art_objgxumy$art_obj.length; subIndex < $art_ccvvzldc$art_c; subIndex++) {
            var sub = $art_objgxumy$art_obj[subIndex];
