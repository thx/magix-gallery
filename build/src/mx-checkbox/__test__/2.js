...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ciwfunfie$art_c = list.length; groupIndex < $art_ciwfunfie$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ciwfunfie$art_c = list.length; groupIndex < $art_ciwfunfie$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objjjlaylxvn$art_obj = group.subs, $art_cyncenfau$art_c = $art_objjjlaylxvn$art_obj.length; subIndex < $art_cyncenfau$art_c; subIndex++) {        var sub = $art_objjjlaylxvn$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objjjlaylxvn$art_obj = group.subs, $art_cyncenfau$art_c = $art_objjjlaylxvn$art_obj.length; subIndex < $art_cyncenfau$art_c; subIndex++) {
            var sub = $art_objjjlaylxvn$art_obj[subIndex];
