...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cbrewoyet$art_c = list.length; groupIndex < $art_cbrewoyet$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cbrewoyet$art_c = list.length; groupIndex < $art_cbrewoyet$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objoduaaa$art_obj = group.subs, $art_ckvraxzfwis$art_c = $art_objoduaaa$art_obj.length; subIndex < $art_ckvraxzfwis$art_c; subIndex++) {        var sub = $art_objoduaaa$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objoduaaa$art_obj = group.subs, $art_ckvraxzfwis$art_c = $art_objoduaaa$art_obj.length; subIndex < $art_ckvraxzfwis$art_c; subIndex++) {
            var sub = $art_objoduaaa$art_obj[subIndex];
