...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cvmfrmndais$art_c = list.length; groupIndex < $art_cvmfrmndais$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cvmfrmndais$art_c = list.length; groupIndex < $art_cvmfrmndais$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objpztvkzmlt$art_obj = group.subs, $art_cgiunpnvh$art_c = $art_objpztvkzmlt$art_obj.length; subIndex < $art_cgiunpnvh$art_c; subIndex++) {        var sub = $art_objpztvkzmlt$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objpztvkzmlt$art_obj = group.subs, $art_cgiunpnvh$art_c = $art_objpztvkzmlt$art_obj.length; subIndex < $art_cgiunpnvh$art_c; subIndex++) {
            var sub = $art_objpztvkzmlt$art_obj[subIndex];
