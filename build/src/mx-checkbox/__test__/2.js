...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cokjkdlayv$art_c = list.length; groupIndex < $art_cokjkdlayv$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cokjkdlayv$art_c = list.length; groupIndex < $art_cokjkdlayv$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objbszsc$art_obj = group.subs, $art_ccadefbhjl$art_c = $art_objbszsc$art_obj.length; subIndex < $art_ccadefbhjl$art_c; subIndex++) {        var sub = $art_objbszsc$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objbszsc$art_obj = group.subs, $art_ccadefbhjl$art_c = $art_objbszsc$art_obj.length; subIndex < $art_ccadefbhjl$art_c; subIndex++) {
            var sub = $art_objbszsc$art_obj[subIndex];
