...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cvubpcgv$art_c = list.length; groupIndex < $art_cvubpcgv$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cvubpcgv$art_c = list.length; groupIndex < $art_cvubpcgv$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objgjtev$art_obj = group.subs, $art_ctcmdqgjlk$art_c = $art_objgjtev$art_obj.length; subIndex < $art_ctcmdqgjlk$art_c; subIndex++) {        var sub = $art_objgjtev$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objgjtev$art_obj = group.subs, $art_ctcmdqgjlk$art_c = $art_objgjtev$art_obj.length; subIndex < $art_ctcmdqgjlk$art_c; subIndex++) {
            var sub = $art_objgjtev$art_obj[subIndex];
