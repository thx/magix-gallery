...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cpqul$art_c = list.length; groupIndex < $art_cpqul$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cpqul$art_c = list.length; groupIndex < $art_cpqul$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objmxoiyn$art_obj = group.subs, $art_cskebifjge$art_c = $art_objmxoiyn$art_obj.length; subIndex < $art_cskebifjge$art_c; subIndex++) {        var sub = $art_objmxoiyn$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objmxoiyn$art_obj = group.subs, $art_cskebifjge$art_c = $art_objmxoiyn$art_obj.length; subIndex < $art_cskebifjge$art_c; subIndex++) {
            var sub = $art_objmxoiyn$art_obj[subIndex];
