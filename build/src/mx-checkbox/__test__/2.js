...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ckxuhuqd$art_c = list.length; groupIndex < $art_ckxuhuqd$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ckxuhuqd$art_c = list.length; groupIndex < $art_ckxuhuqd$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objlhrviadqz$art_obj = group.subs, $art_cuxanvorry$art_c = $art_objlhrviadqz$art_obj.length; subIndex < $art_cuxanvorry$art_c; subIndex++) {        var sub = $art_objlhrviadqz$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objlhrviadqz$art_obj = group.subs, $art_cuxanvorry$art_c = $art_objlhrviadqz$art_obj.length; subIndex < $art_cuxanvorry$art_c; subIndex++) {
            var sub = $art_objlhrviadqz$art_obj[subIndex];
