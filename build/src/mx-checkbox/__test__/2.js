...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cmxsyc$art_c = list.length; groupIndex < $art_cmxsyc$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cmxsyc$art_c = list.length; groupIndex < $art_cmxsyc$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objpfohqrc$art_obj = group.subs, $art_cmxxnizyy$art_c = $art_objpfohqrc$art_obj.length; subIndex < $art_cmxxnizyy$art_c; subIndex++) {        var sub = $art_objpfohqrc$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objpfohqrc$art_obj = group.subs, $art_cmxxnizyy$art_c = $art_objpfohqrc$art_obj.length; subIndex < $art_cmxxnizyy$art_c; subIndex++) {
            var sub = $art_objpfohqrc$art_obj[subIndex];
