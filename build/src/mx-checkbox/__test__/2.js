...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cvaeapygf$art_c = list.length; groupIndex < $art_cvaeapygf$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cvaeapygf$art_c = list.length; groupIndex < $art_cvaeapygf$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objboggwzyhm$art_obj = group.subs, $art_cmxsfhy$art_c = $art_objboggwzyhm$art_obj.length; subIndex < $art_cmxsfhy$art_c; subIndex++) {        var sub = $art_objboggwzyhm$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objboggwzyhm$art_obj = group.subs, $art_cmxsfhy$art_c = $art_objboggwzyhm$art_obj.length; subIndex < $art_cmxsfhy$art_c; subIndex++) {
            var sub = $art_objboggwzyhm$art_obj[subIndex];
