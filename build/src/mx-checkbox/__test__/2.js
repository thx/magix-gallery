...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cuxaadpir$art_c = list.length; groupIndex < $art_cuxaadpir$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cuxaadpir$art_c = list.length; groupIndex < $art_cuxaadpir$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objmpbiml$art_obj = group.subs, $art_czzmrzmlab$art_c = $art_objmpbiml$art_obj.length; subIndex < $art_czzmrzmlab$art_c; subIndex++) {        var sub = $art_objmpbiml$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objmpbiml$art_obj = group.subs, $art_czzmrzmlab$art_c = $art_objmpbiml$art_obj.length; subIndex < $art_czzmrzmlab$art_c; subIndex++) {
            var sub = $art_objmpbiml$art_obj[subIndex];
