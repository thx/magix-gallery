...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryai:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryai:a" class="_zs_gallery___test___layout_-eg-content">';
    $line = 3;
    $art = 'each list as group groupIndex';
    ;
    $expr = '<%for (var groupIndex = 0, $art_caapcwrdc$art_c = list.length; groupIndex < $art_caapcwrdc$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_caapcwrdc$art_c = list.length; groupIndex < $art_caapcwrdc$art_c; groupIndex++) {
        var group = list[groupIndex];
        $p += '<div><label mxa="_zs_galleryai:b" class="mr20 mb20"><span mx-change="' + $viewId + 'toggle({groupIndex:';
        $line = 9;
        $art = '=groupIndex';
        ;
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objpzlumevn$art_obj = group.subs, $art_cpxjvchezf$art_c = $art_objpzlumevn$art_obj.length; subIndex < $art_cpxjvchezf$art_c; subIndex++) {        var sub = $art_objpzlumevn$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objpzlumevn$art_obj = group.subs, $art_cpxjvchezf$art_c = $art_objpzlumevn$art_obj.length; subIndex < $art_cpxjvchezf$art_c; subIndex++) {
            var sub = $art_objpzlumevn$art_obj[subIndex];
            $p += '<label mxa="_zs_galleryai:c" class="mr20 mb20"><span mx-change="' + $viewId + 'toggle({groupIndex:';
            $line = 17;
            $art = '=groupIndex';
            ;
    ...
    ;
    $p += '</div><div mxa="_zs_galleryai:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryai:_" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
    ...
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryai:a" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 59;
    $art = '=viewId';
    ;
