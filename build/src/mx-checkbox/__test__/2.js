...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cqfvagwqu$art_c = list.length; groupIndex < $art_cqfvagwqu$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cqfvagwqu$art_c = list.length; groupIndex < $art_cqfvagwqu$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objghmajskjlm$art_obj = group.subs, $art_cnvnaggehk$art_c = $art_objghmajskjlm$art_obj.length; subIndex < $art_cnvnaggehk$art_c; subIndex++) {        var sub = $art_objghmajskjlm$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objghmajskjlm$art_obj = group.subs, $art_cnvnaggehk$art_c = $art_objghmajskjlm$art_obj.length; subIndex < $art_cnvnaggehk$art_c; subIndex++) {
            var sub = $art_objghmajskjlm$art_obj[subIndex];
