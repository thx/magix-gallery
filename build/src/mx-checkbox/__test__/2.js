...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_chpkboi$art_c = list.length; groupIndex < $art_chpkboi$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_chpkboi$art_c = list.length; groupIndex < $art_chpkboi$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objlfdojwdfh$art_obj = group.subs, $art_cnhntrwjkb$art_c = $art_objlfdojwdfh$art_obj.length; subIndex < $art_cnhntrwjkb$art_c; subIndex++) {        var sub = $art_objlfdojwdfh$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objlfdojwdfh$art_obj = group.subs, $art_cnhntrwjkb$art_c = $art_objlfdojwdfh$art_obj.length; subIndex < $art_cnhntrwjkb$art_c; subIndex++) {
            var sub = $art_objlfdojwdfh$art_obj[subIndex];
