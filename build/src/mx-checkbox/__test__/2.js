...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cdpgeovud$art_c = list.length; groupIndex < $art_cdpgeovud$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cdpgeovud$art_c = list.length; groupIndex < $art_cdpgeovud$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objdlhbgcoxdn$art_obj = group.subs, $art_ckatxjgtp$art_c = $art_objdlhbgcoxdn$art_obj.length; subIndex < $art_ckatxjgtp$art_c; subIndex++) {        var sub = $art_objdlhbgcoxdn$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objdlhbgcoxdn$art_obj = group.subs, $art_ckatxjgtp$art_c = $art_objdlhbgcoxdn$art_obj.length; subIndex < $art_ckatxjgtp$art_c; subIndex++) {
            var sub = $art_objdlhbgcoxdn$art_obj[subIndex];
