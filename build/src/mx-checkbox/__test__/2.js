...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_czuzopdutvh$art_c = list.length; groupIndex < $art_czuzopdutvh$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_czuzopdutvh$art_c = list.length; groupIndex < $art_czuzopdutvh$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objkfombhdy$art_obj = group.subs, $art_covsfbaul$art_c = $art_objkfombhdy$art_obj.length; subIndex < $art_covsfbaul$art_c; subIndex++) {        var sub = $art_objkfombhdy$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objkfombhdy$art_obj = group.subs, $art_covsfbaul$art_c = $art_objkfombhdy$art_obj.length; subIndex < $art_covsfbaul$art_c; subIndex++) {
            var sub = $art_objkfombhdy$art_obj[subIndex];
