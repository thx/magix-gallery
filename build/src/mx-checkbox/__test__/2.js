...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryad:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryad:a" class="_zs_gallery___test___layout_-eg-content">';
    $line = 3;
    $art = 'each list as group groupIndex';
    ;
    $expr = '<%for (var groupIndex = 0, $art_cjnifobuajm$art_c = list.length; groupIndex < $art_cjnifobuajm$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cjnifobuajm$art_c = list.length; groupIndex < $art_cjnifobuajm$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objrkpqskvi$art_obj = group.subs, $art_cbzksclihtgr$art_c = $art_objrkpqskvi$art_obj.length; subIndex < $art_cbzksclihtgr$art_c; subIndex++) {        var sub = $art_objrkpqskvi$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objrkpqskvi$art_obj = group.subs, $art_cbzksclihtgr$art_c = $art_objrkpqskvi$art_obj.length; subIndex < $art_cbzksclihtgr$art_c; subIndex++) {
            var sub = $art_objrkpqskvi$art_obj[subIndex];
    ...
    ;
    $p += '</div><div mxa="_zs_galleryad:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryad:_" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 25;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&#123;&#123;each list as group groupIndex&#125;&#125;\n&lt;div&gt;\n    &lt;label class="mr20 mb20"&gt;\n        &lt;mx-checkbox value="&#123;&#123;=group.value&#125;&#125;"\n            checked="&#123;&#123;=(group.type==3)&#125;&#125;" \n            indeterminate="&#123;&#123;=(group.type==2)&#125;&#125;" \n            mx-change="toggle(&#123;groupIndex:&#123;&#123;=groupIndex&#125;&#125;,subIndex:\'all\'&#125;)"/&gt;组&#123;&#123;=group.value&#125;&#125;\n    &lt;/label&gt;\n&lt;/div&gt;\n&lt;div&gt;\n    &#123;&#123;each group.subs as sub subIndex&#125;&#125;\n    &lt;label class="mr20 mb20"&gt;\n        &lt;mx-checkbox value="&#123;&#123;=sub.value&#125;&#125;"\n            checked="&#123;&#123;=sub.checked&#125;&#125;" \n            mx-change="toggle(&#123;groupIndex:&#123;&#123;=groupIndex&#125;&#125;,subIndex:&#123;&#123;=subIndex&#125;&#125;&#125;)"/&gt;&#123;&#123;=sub.value&#125;&#125;\n    &lt;/label&gt;\n    &#123;&#123;/each&#125;&#125;\n&lt;/div&gt;\n&#123;&#123;/each&#125;&#125;\n        </pre></div><div mxa="_zs_galleryad:f" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryad:b" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 54;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryad:g" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 56;
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryad:a" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 59;
    $art = '=viewId';
    ;
