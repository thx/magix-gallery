...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cadezdi$art_c = list.length; groupIndex < $art_cadezdi$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cadezdi$art_c = list.length; groupIndex < $art_cadezdi$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objtrtfww$art_obj = group.subs, $art_cctulhbopat$art_c = $art_objtrtfww$art_obj.length; subIndex < $art_cctulhbopat$art_c; subIndex++) {        var sub = $art_objtrtfww$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objtrtfww$art_obj = group.subs, $art_cctulhbopat$art_c = $art_objtrtfww$art_obj.length; subIndex < $art_cctulhbopat$art_c; subIndex++) {
            var sub = $art_objtrtfww$art_obj[subIndex];
