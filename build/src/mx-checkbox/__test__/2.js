...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cjtmqazh$art_c = list.length; groupIndex < $art_cjtmqazh$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cjtmqazh$art_c = list.length; groupIndex < $art_cjtmqazh$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objujthjyq$art_obj = group.subs, $art_caybgfnmbs$art_c = $art_objujthjyq$art_obj.length; subIndex < $art_caybgfnmbs$art_c; subIndex++) {        var sub = $art_objujthjyq$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objujthjyq$art_obj = group.subs, $art_caybgfnmbs$art_c = $art_objujthjyq$art_obj.length; subIndex < $art_caybgfnmbs$art_c; subIndex++) {
            var sub = $art_objujthjyq$art_obj[subIndex];
