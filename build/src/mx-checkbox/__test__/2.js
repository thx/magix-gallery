...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cdxvgss$art_c = list.length; groupIndex < $art_cdxvgss$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cdxvgss$art_c = list.length; groupIndex < $art_cdxvgss$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objczebwcjg$art_obj = group.subs, $art_cvgnmotdpa$art_c = $art_objczebwcjg$art_obj.length; subIndex < $art_cvgnmotdpa$art_c; subIndex++) {        var sub = $art_objczebwcjg$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objczebwcjg$art_obj = group.subs, $art_cvgnmotdpa$art_c = $art_objczebwcjg$art_obj.length; subIndex < $art_cvgnmotdpa$art_c; subIndex++) {
            var sub = $art_objczebwcjg$art_obj[subIndex];
