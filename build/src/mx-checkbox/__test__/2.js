...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cdplikix$art_c = list.length; groupIndex < $art_cdplikix$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cdplikix$art_c = list.length; groupIndex < $art_cdplikix$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objszbcch$art_obj = group.subs, $art_cjlnwbcts$art_c = $art_objszbcch$art_obj.length; subIndex < $art_cjlnwbcts$art_c; subIndex++) {        var sub = $art_objszbcch$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objszbcch$art_obj = group.subs, $art_cjlnwbcts$art_c = $art_objszbcch$art_obj.length; subIndex < $art_cjlnwbcts$art_c; subIndex++) {
            var sub = $art_objszbcch$art_obj[subIndex];
