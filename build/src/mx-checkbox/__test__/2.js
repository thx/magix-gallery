...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cpnenqd$art_c = list.length; groupIndex < $art_cpnenqd$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cpnenqd$art_c = list.length; groupIndex < $art_cpnenqd$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objxkgwsai$art_obj = group.subs, $art_clkwsar$art_c = $art_objxkgwsai$art_obj.length; subIndex < $art_clkwsar$art_c; subIndex++) {        var sub = $art_objxkgwsai$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objxkgwsai$art_obj = group.subs, $art_clkwsar$art_c = $art_objxkgwsai$art_obj.length; subIndex < $art_clkwsar$art_c; subIndex++) {
            var sub = $art_objxkgwsai$art_obj[subIndex];
