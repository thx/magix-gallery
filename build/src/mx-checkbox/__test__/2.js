...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_chybqagz$art_c = list.length; groupIndex < $art_chybqagz$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_chybqagz$art_c = list.length; groupIndex < $art_chybqagz$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objdxsbkpc$art_obj = group.subs, $art_cgriqzyhff$art_c = $art_objdxsbkpc$art_obj.length; subIndex < $art_cgriqzyhff$art_c; subIndex++) {        var sub = $art_objdxsbkpc$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objdxsbkpc$art_obj = group.subs, $art_cgriqzyhff$art_c = $art_objdxsbkpc$art_obj.length; subIndex < $art_cgriqzyhff$art_c; subIndex++) {
            var sub = $art_objdxsbkpc$art_obj[subIndex];
