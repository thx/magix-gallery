...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_cjtdmxg$art_c = list.length; groupIndex < $art_cjtdmxg$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_cjtdmxg$art_c = list.length; groupIndex < $art_cjtdmxg$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objvgmoewirig$art_obj = group.subs, $art_cciyacwfxwm$art_c = $art_objvgmoewirig$art_obj.length; subIndex < $art_cciyacwfxwm$art_c; subIndex++) {        var sub = $art_objvgmoewirig$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objvgmoewirig$art_obj = group.subs, $art_cciyacwfxwm$art_c = $art_objvgmoewirig$art_obj.length; subIndex < $art_cciyacwfxwm$art_c; subIndex++) {
            var sub = $art_objvgmoewirig$art_obj[subIndex];
