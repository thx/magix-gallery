...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_ccgiawhj$art_c = list.length; groupIndex < $art_ccgiawhj$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_ccgiawhj$art_c = list.length; groupIndex < $art_ccgiawhj$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objxyvnfrrgj$art_obj = group.subs, $art_cbddlupj$art_c = $art_objxyvnfrrgj$art_obj.length; subIndex < $art_cbddlupj$art_c; subIndex++) {        var sub = $art_objxyvnfrrgj$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objxyvnfrrgj$art_obj = group.subs, $art_cbddlupj$art_c = $art_objxyvnfrrgj$art_obj.length; subIndex < $art_cbddlupj$art_c; subIndex++) {
            var sub = $art_objxyvnfrrgj$art_obj[subIndex];
