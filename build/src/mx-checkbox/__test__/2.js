...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var groupIndex = 0, $art_clivfiq$art_c = list.length; groupIndex < $art_clivfiq$art_c; groupIndex++) {    var group = list[groupIndex]%>';
    for (var groupIndex = 0, $art_clivfiq$art_c = list.length; groupIndex < $art_clivfiq$art_c; groupIndex++) {
        ...
        ;
        $expr = '<%for (var subIndex = 0, $art_objkzejffaba$art_obj = group.subs, $art_cdzyuntfur$art_c = $art_objkzejffaba$art_obj.length; subIndex < $art_cdzyuntfur$art_c; subIndex++) {        var sub = $art_objkzejffaba$art_obj[subIndex]%>';
        for (var subIndex = 0, $art_objkzejffaba$art_obj = group.subs, $art_cdzyuntfur$art_c = $art_objkzejffaba$art_obj.length; subIndex < $art_cdzyuntfur$art_c; subIndex++) {
            var sub = $art_objkzejffaba$art_obj[subIndex];
