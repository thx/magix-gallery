...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerydU:_" class="pr pr120"><div mx-view="__test__/subs?list=';
    $line = 2;
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'输入框+单位\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'刻度\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'禁用\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'垂直\',\n            key: viewId + \'_demo4\'\n        },{\n            name: \'范围修正\',\n            key: viewId + \'_demo5\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }]';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerydU:a" class="clearfix mb20"><div mxa="_zs_gallerydU:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-slider/__test__/1" id="';
    $line = 32;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_gallerydU:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-slider/__test__/2" id="';
    $line = 36;
    $art = '=viewId';
    ;
