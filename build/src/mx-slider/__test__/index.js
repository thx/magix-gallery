...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryd9:a" class="clearfix mb20"><div mxa="_zs_galleryd9:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-slider/__test__/1" id="';
    $line = 32;
    $art = '=viewId';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo5"></div></div><div mxa="_zs_galleryd9:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-slider/__test__/2" id="';
    $line = 36;
    $art = '=viewId';
    ;
