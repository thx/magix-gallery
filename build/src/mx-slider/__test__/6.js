...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydd:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_gallerydd:_" class="_zs_gallery___test___layout_-eg-content"><div class="mb40"><div mx-view="mx-slider/range?max=200&min=100&step=1"></div></div><div class="mb20"><div mx-view="mx-slider/range?max=200&min=100&step=0.5"></div></div></div><div mxa="_zs_gallerydd:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerydd:a" class="_zs_gallery___test___layout_-eg-title">step决定滑轴刻度</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 18;
    $art = '=viewId';
    ;
