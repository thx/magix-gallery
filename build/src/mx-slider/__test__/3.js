...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb`:_" class="_zs_gallery___test___layout_-example"><div mxs="_zs_galleryb`:c" class="_zs_gallery___test___layout_-eg-content"><div class="pt20 pb20"><div mx-disabled mx-view="mx-slider/index?max=200&min=100&value=120&needInput=true"></div></div></div><div mxa="_zs_galleryb`:a" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb`:a" class="_zs_gallery___test___layout_-eg-title">禁止选择</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 14;
    $art = '=viewId';
    ;
