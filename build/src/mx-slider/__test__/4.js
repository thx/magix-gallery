...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybU:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallerybU:_" class="_zs_gallery___test___base_-eg-content"><div class="pl40"><div mx-view="mx-slider/index?max=200&min=100&value=130&step=0.5&vertical=true&height=200"></div></div></div><div mxa="_zs_gallerybU:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallerybU:a" class="_zs_gallery___test___base_-eg-title">纵向滑块 + 自定义高度</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 15;
    $art = '=viewId';
    ;
