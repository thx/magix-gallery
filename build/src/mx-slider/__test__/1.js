...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb;:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryb;:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryb;:_" class="mb10 clearfix"><div class="color-9 fl lh22">以下示例：</div><div class="fl lh22"><div>包含输入框</div><div>输入框与滑动轴联动</div><div>step几位小数，其他数值同step保持一致</div><div>结果带提示文案</div></div></div><div mxa="_zs_galleryb;:b" class="mb20"><span mxs="_zs_galleryb;:a" class="color-9">当前值：</span><span>';
    $line = 14;
    $art = '=cur';
    ;
    ...
    $art = '=cur';
    ;
    $p += ($expr = '<%!$eu(cur)%>', $eu(cur)) + '&step=0.05&tip=%E5%85%83"></div></div></div><div mxa="_zs_galleryb;:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb;:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 30;
    $art = '=viewId';
    ;
