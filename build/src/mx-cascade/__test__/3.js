...
module.exports = Base.extend({
    ...
    $art = '!text1';
    ;
    $p += ($expr = '<%!text1%>', $n(text1)) + '</span><i mxs="_zs_gallerydV:a" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 105;
    $art = '=viewId';
    ;
    ...
    msg += $expr + '\r\n\tat file:mx-cascade/__test__/3.html';
    throw msg;
} return $p; },
    render: function () {
        this.updater.digest();
