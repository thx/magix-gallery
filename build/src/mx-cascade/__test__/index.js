...
module.exports = Magix.View.extend({
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_galleryad:a" class="clearfix mb20"><div mxa="_zs_galleryad:b" class="_zs_gallery___test___layout_-half"><div mx-view="mx-cascade/__test__/1" id="';
    $line = 26;
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_demo1"></div></div><div mxa="_zs_galleryad:c" class="_zs_gallery___test___layout_-half"><div mx-view="mx-cascade/__test__/2" id="';
    $line = 29;
    $art = '=viewId';
    ;
