...
module.exports = Magix.View.extend({
    ...
    if (!disabled) {
        ...
        ;
        $expr = '<%for (var gIndex = 0, $art_cfcyfivcg$art_c = groups.length; gIndex < $art_cfcyfivcg$art_c; gIndex++) {        var list = groups[gIndex]%>';
        for (var gIndex = 0, $art_cfcyfivcg$art_c = groups.length; gIndex < $art_cfcyfivcg$art_c; gIndex++) {
            ...
            ;
            $expr = '<%for (var iIndex = 0, $art_comuswbd$art_c = list.length; iIndex < $art_comuswbd$art_c; iIndex++) {            var item = list[iIndex]%>';
            for (var iIndex = 0, $art_comuswbd$art_c = list.length; iIndex < $art_comuswbd$art_c; iIndex++) {
