...
module.exports = Magix.View.extend({
    ...
    if (!disabled) {
        ...
        ;
        $expr = '<%for (var gIndex = 0, $art_ckosydemho$art_c = groups.length; gIndex < $art_ckosydemho$art_c; gIndex++) {        var list = groups[gIndex]%>';
        for (var gIndex = 0, $art_ckosydemho$art_c = groups.length; gIndex < $art_ckosydemho$art_c; gIndex++) {
            ...
            ;
            $expr = '<%for (var iIndex = 0, $art_cvhhbcxgcpq$art_c = list.length; iIndex < $art_cvhhbcxgcpq$art_c; iIndex++) {            var item = list[iIndex]%>';
            for (var iIndex = 0, $art_cvhhbcxgcpq$art_c = list.length; iIndex < $art_cvhhbcxgcpq$art_c; iIndex++) {
