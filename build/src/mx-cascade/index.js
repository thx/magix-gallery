...
module.exports = Magix.View.extend({
...
} ; var $g = '', $_temp, $p = '', expand = $$.expand, disabled = $$.disabled, selectedValue = $$.selectedValue, name = $$.name, selectedText = $$.selectedText, groups = $$.groups, viewId = $$.viewId, textKey = $$.textKey; var $expr, $art, $line; try {
    ...
    ;
    $p += '><span class="_zs_gallery_mx-cascade_index_-cascade-label ';
    $line = 3;
    ...
    if (selectedValue === '') {
        ;
        $p += ' _zs_gallery_mx-cascade_index_-cascade-label-ph ';
        $line = 3;
        $art = '/if';
        ;
        $expr = '<%}%>';
    ...
    if (!disabled) {
        ...
        ;
        $expr = '<%for (var gIndex = 0, $art_ciyiognufgh$art_c = groups.length; gIndex < $art_ciyiognufgh$art_c; gIndex++) {        var list = groups[gIndex]%>';
        for (var gIndex = 0, $art_ciyiognufgh$art_c = groups.length; gIndex < $art_ciyiognufgh$art_c; gIndex++) {
            ...
            ;
            $expr = '<%for (var iIndex = 0, $art_cfkjsxjeizcv$art_c = list.length; iIndex < $art_cfkjsxjeizcv$art_c; iIndex++) {            var item = list[iIndex]%>';
            for (var iIndex = 0, $art_cfkjsxjeizcv$art_c = list.length; iIndex < $art_cfkjsxjeizcv$art_c; iIndex++) {
