...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iavwfmkysi$art_i = 0, $art_chbibkmaeh$art_c = groups.length; $art_iavwfmkysi$art_i < $art_chbibkmaeh$art_c; $art_iavwfmkysi$art_i++) {    var group = groups[$art_iavwfmkysi$art_i]%>';
    for (var $art_iavwfmkysi$art_i = 0, $art_chbibkmaeh$art_c = groups.length; $art_iavwfmkysi$art_i < $art_chbibkmaeh$art_c; $art_iavwfmkysi$art_i++) {
        var group = groups[$art_iavwfmkysi$art_i];
        $p += '<div mxv mxa="_zs_gallerybv:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 23;
        $art = 'each group as field';
        ;
        $expr = '<%for (var $art_ioznvpxtdfv$art_i = 0, $art_caaskvbpx$art_c = group.length; $art_ioznvpxtdfv$art_i < $art_caaskvbpx$art_c; $art_ioznvpxtdfv$art_i++) {        var field = group[$art_ioznvpxtdfv$art_i]%>';
        for (var $art_ioznvpxtdfv$art_i = 0, $art_caaskvbpx$art_c = group.length; $art_ioznvpxtdfv$art_i < $art_caaskvbpx$art_c; $art_ioznvpxtdfv$art_i++) {
            var field = group[$art_ioznvpxtdfv$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_izcxvqduo$art_i = 0, $art_cprfxzw$art_c = selectedItems.length; $art_izcxvqduo$art_i < $art_cprfxzw$art_c; $art_izcxvqduo$art_i++) {        var s = selectedItems[$art_izcxvqduo$art_i]%>';
        for (var $art_izcxvqduo$art_i = 0, $art_cprfxzw$art_c = selectedItems.length; $art_izcxvqduo$art_i < $art_cprfxzw$art_c; $art_izcxvqduo$art_i++) {
            var s = selectedItems[$art_izcxvqduo$art_i];
