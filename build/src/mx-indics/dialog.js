...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iexcltfksw$art_i = 0, $art_cawxabm$art_c = groups.length; $art_iexcltfksw$art_i < $art_cawxabm$art_c; $art_iexcltfksw$art_i++) {    var group = groups[$art_iexcltfksw$art_i]%>';
    for (var $art_iexcltfksw$art_i = 0, $art_cawxabm$art_c = groups.length; $art_iexcltfksw$art_i < $art_cawxabm$art_c; $art_iexcltfksw$art_i++) {
        var group = groups[$art_iexcltfksw$art_i];
        ...
        ;
        $expr = '<%for (var $art_ifaqas$art_i = 0, $art_objmpppymsn$art_obj = group.fields, $art_ciwvlzowli$art_c = $art_objmpppymsn$art_obj.length; $art_ifaqas$art_i < $art_ciwvlzowli$art_c; $art_ifaqas$art_i++) {        var field = $art_objmpppymsn$art_obj[$art_ifaqas$art_i]%>';
        for (var $art_ifaqas$art_i = 0, $art_objmpppymsn$art_obj = group.fields, $art_ciwvlzowli$art_c = $art_objmpppymsn$art_obj.length; $art_ifaqas$art_i < $art_ciwvlzowli$art_c; $art_ifaqas$art_i++) {
            var field = $art_objmpppymsn$art_obj[$art_ifaqas$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_iqswdizhj$art_i = 0, $art_ciwrupv$art_c = selectedItems.length; $art_iqswdizhj$art_i < $art_ciwrupv$art_c; $art_iqswdizhj$art_i++) {        var s = selectedItems[$art_iqswdizhj$art_i]%>';
        for (var $art_iqswdizhj$art_i = 0, $art_ciwrupv$art_c = selectedItems.length; $art_iqswdizhj$art_i < $art_ciwrupv$art_c; $art_iqswdizhj$art_i++) {
            var s = selectedItems[$art_iqswdizhj$art_i];
