...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iqhtzm$art_i = 0, $art_cqtup$art_c = groups.length; $art_iqhtzm$art_i < $art_cqtup$art_c; $art_iqhtzm$art_i++) {    var group = groups[$art_iqhtzm$art_i]%>';
    for (var $art_iqhtzm$art_i = 0, $art_cqtup$art_c = groups.length; $art_iqhtzm$art_i < $art_cqtup$art_c; $art_iqhtzm$art_i++) {
        var group = groups[$art_iqhtzm$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixruaj$art_i = 0, $art_objovrhcibvzg$art_obj = group.fields, $art_cpgyhjozelza$art_c = $art_objovrhcibvzg$art_obj.length; $art_ixruaj$art_i < $art_cpgyhjozelza$art_c; $art_ixruaj$art_i++) {        var field = $art_objovrhcibvzg$art_obj[$art_ixruaj$art_i]%>';
        for (var $art_ixruaj$art_i = 0, $art_objovrhcibvzg$art_obj = group.fields, $art_cpgyhjozelza$art_c = $art_objovrhcibvzg$art_obj.length; $art_ixruaj$art_i < $art_cpgyhjozelza$art_c; $art_ixruaj$art_i++) {
            var field = $art_objovrhcibvzg$art_obj[$art_ixruaj$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ikvquljn$art_i = 0, $art_cdmsgrd$art_c = selectedItems.length; $art_ikvquljn$art_i < $art_cdmsgrd$art_c; $art_ikvquljn$art_i++) {        var s = selectedItems[$art_ikvquljn$art_i]%>';
        for (var $art_ikvquljn$art_i = 0, $art_cdmsgrd$art_c = selectedItems.length; $art_ikvquljn$art_i < $art_cdmsgrd$art_c; $art_ikvquljn$art_i++) {
            var s = selectedItems[$art_ikvquljn$art_i];
