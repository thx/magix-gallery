...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ifqoxih$art_i = 0, $art_caalpzxhd$art_c = groups.length; $art_ifqoxih$art_i < $art_caalpzxhd$art_c; $art_ifqoxih$art_i++) {    var group = groups[$art_ifqoxih$art_i]%>';
    for (var $art_ifqoxih$art_i = 0, $art_caalpzxhd$art_c = groups.length; $art_ifqoxih$art_i < $art_caalpzxhd$art_c; $art_ifqoxih$art_i++) {
        var group = groups[$art_ifqoxih$art_i];
        ...
        ;
        $expr = '<%for (var $art_imdvwdsmpr$art_i = 0, $art_objrcblzzut$art_obj = group.fields, $art_cvqmaqjq$art_c = $art_objrcblzzut$art_obj.length; $art_imdvwdsmpr$art_i < $art_cvqmaqjq$art_c; $art_imdvwdsmpr$art_i++) {        var field = $art_objrcblzzut$art_obj[$art_imdvwdsmpr$art_i]%>';
        for (var $art_imdvwdsmpr$art_i = 0, $art_objrcblzzut$art_obj = group.fields, $art_cvqmaqjq$art_c = $art_objrcblzzut$art_obj.length; $art_imdvwdsmpr$art_i < $art_cvqmaqjq$art_c; $art_imdvwdsmpr$art_i++) {
            var field = $art_objrcblzzut$art_obj[$art_imdvwdsmpr$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ioikscpvyvx$art_i = 0, $art_cauhxf$art_c = selectedItems.length; $art_ioikscpvyvx$art_i < $art_cauhxf$art_c; $art_ioikscpvyvx$art_i++) {        var s = selectedItems[$art_ioikscpvyvx$art_i]%>';
        for (var $art_ioikscpvyvx$art_i = 0, $art_cauhxf$art_c = selectedItems.length; $art_ioikscpvyvx$art_i < $art_cauhxf$art_c; $art_ioikscpvyvx$art_i++) {
            var s = selectedItems[$art_ioikscpvyvx$art_i];
