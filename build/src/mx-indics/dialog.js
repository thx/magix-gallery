...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_itlwwcwtb$art_i = 0, $art_cbfeeumavr$art_c = groups.length; $art_itlwwcwtb$art_i < $art_cbfeeumavr$art_c; $art_itlwwcwtb$art_i++) {    var group = groups[$art_itlwwcwtb$art_i]%>';
    for (var $art_itlwwcwtb$art_i = 0, $art_cbfeeumavr$art_c = groups.length; $art_itlwwcwtb$art_i < $art_cbfeeumavr$art_c; $art_itlwwcwtb$art_i++) {
        var group = groups[$art_itlwwcwtb$art_i];
        $p += '<div mxv mxa="_zs_galleryb1:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 23;
        $art = 'each group as field';
        ;
        $expr = '<%for (var $art_ilxaqujip$art_i = 0, $art_chphognhoi$art_c = group.length; $art_ilxaqujip$art_i < $art_chphognhoi$art_c; $art_ilxaqujip$art_i++) {        var field = group[$art_ilxaqujip$art_i]%>';
        for (var $art_ilxaqujip$art_i = 0, $art_chphognhoi$art_c = group.length; $art_ilxaqujip$art_i < $art_chphognhoi$art_c; $art_ilxaqujip$art_i++) {
            var field = group[$art_ilxaqujip$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_izqjrwrv$art_i = 0, $art_cvzazjfzs$art_c = selectedItems.length; $art_izqjrwrv$art_i < $art_cvzazjfzs$art_c; $art_izqjrwrv$art_i++) {        var s = selectedItems[$art_izqjrwrv$art_i]%>';
        for (var $art_izqjrwrv$art_i = 0, $art_cvzazjfzs$art_c = selectedItems.length; $art_izqjrwrv$art_i < $art_cvzazjfzs$art_c; $art_izqjrwrv$art_i++) {
            var s = selectedItems[$art_izqjrwrv$art_i];
