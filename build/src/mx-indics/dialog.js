...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iezqgafs$art_i = 0, $art_ctmytbwma$art_c = groups.length; $art_iezqgafs$art_i < $art_ctmytbwma$art_c; $art_iezqgafs$art_i++) {    var group = groups[$art_iezqgafs$art_i]%>';
    for (var $art_iezqgafs$art_i = 0, $art_ctmytbwma$art_c = groups.length; $art_iezqgafs$art_i < $art_ctmytbwma$art_c; $art_iezqgafs$art_i++) {
        var group = groups[$art_iezqgafs$art_i];
        $p += '<div mxv mxa="_zs_gallerybt:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 23;
        $art = 'each group as field';
        ;
        $p += '';
        $expr = '<%for (var $art_iehbpdqs$art_i = 0, $art_ctsrl$art_c = group.length; $art_iehbpdqs$art_i < $art_ctsrl$art_c; $art_iehbpdqs$art_i++) {        var field = group[$art_iehbpdqs$art_i]%>';
        for (var $art_iehbpdqs$art_i = 0, $art_ctsrl$art_c = group.length; $art_iehbpdqs$art_i < $art_ctsrl$art_c; $art_iehbpdqs$art_i++) {
            var field = group[$art_iehbpdqs$art_i];
    ...
    if (sortable) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_intpcjvtxbj$art_i = 0, $art_cttpdwo$art_c = selectedItems.length; $art_intpcjvtxbj$art_i < $art_cttpdwo$art_c; $art_intpcjvtxbj$art_i++) {        var s = selectedItems[$art_intpcjvtxbj$art_i]%>';
        for (var $art_intpcjvtxbj$art_i = 0, $art_cttpdwo$art_c = selectedItems.length; $art_intpcjvtxbj$art_i < $art_cttpdwo$art_c; $art_intpcjvtxbj$art_i++) {
            var s = selectedItems[$art_intpcjvtxbj$art_i];
