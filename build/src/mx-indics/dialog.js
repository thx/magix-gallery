...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_imjzhzj$art_i = 0, $art_chkngkznal$art_c = groups.length; $art_imjzhzj$art_i < $art_chkngkznal$art_c; $art_imjzhzj$art_i++) {    var group = groups[$art_imjzhzj$art_i]%>';
    for (var $art_imjzhzj$art_i = 0, $art_chkngkznal$art_c = groups.length; $art_imjzhzj$art_i < $art_chkngkznal$art_c; $art_imjzhzj$art_i++) {
        var group = groups[$art_imjzhzj$art_i];
        ...
        ;
        $expr = '<%for (var $art_igxhmoi$art_i = 0, $art_objapwjvolbp$art_obj = group.fields, $art_cryetsc$art_c = $art_objapwjvolbp$art_obj.length; $art_igxhmoi$art_i < $art_cryetsc$art_c; $art_igxhmoi$art_i++) {        var field = $art_objapwjvolbp$art_obj[$art_igxhmoi$art_i]%>';
        for (var $art_igxhmoi$art_i = 0, $art_objapwjvolbp$art_obj = group.fields, $art_cryetsc$art_c = $art_objapwjvolbp$art_obj.length; $art_igxhmoi$art_i < $art_cryetsc$art_c; $art_igxhmoi$art_i++) {
            var field = $art_objapwjvolbp$art_obj[$art_igxhmoi$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_isqyiixq$art_i = 0, $art_cqdbg$art_c = selectedItems.length; $art_isqyiixq$art_i < $art_cqdbg$art_c; $art_isqyiixq$art_i++) {        var s = selectedItems[$art_isqyiixq$art_i]%>';
        for (var $art_isqyiixq$art_i = 0, $art_cqdbg$art_c = selectedItems.length; $art_isqyiixq$art_i < $art_cqdbg$art_c; $art_isqyiixq$art_i++) {
            var s = selectedItems[$art_isqyiixq$art_i];
