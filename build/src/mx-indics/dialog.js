...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipzwwcbf$art_i = 0, $art_cniqwdsg$art_c = groups.length; $art_ipzwwcbf$art_i < $art_cniqwdsg$art_c; $art_ipzwwcbf$art_i++) {    var group = groups[$art_ipzwwcbf$art_i]%>';
    for (var $art_ipzwwcbf$art_i = 0, $art_cniqwdsg$art_c = groups.length; $art_ipzwwcbf$art_i < $art_cniqwdsg$art_c; $art_ipzwwcbf$art_i++) {
        var group = groups[$art_ipzwwcbf$art_i];
        ...
        ;
        $expr = '<%for (var $art_ibtscfg$art_i = 0, $art_objlgtciblcm$art_obj = group.fields, $art_cokom$art_c = $art_objlgtciblcm$art_obj.length; $art_ibtscfg$art_i < $art_cokom$art_c; $art_ibtscfg$art_i++) {        var field = $art_objlgtciblcm$art_obj[$art_ibtscfg$art_i]%>';
        for (var $art_ibtscfg$art_i = 0, $art_objlgtciblcm$art_obj = group.fields, $art_cokom$art_c = $art_objlgtciblcm$art_obj.length; $art_ibtscfg$art_i < $art_cokom$art_c; $art_ibtscfg$art_i++) {
            var field = $art_objlgtciblcm$art_obj[$art_ibtscfg$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_igcohnmkmq$art_i = 0, $art_cfieerd$art_c = selectedItems.length; $art_igcohnmkmq$art_i < $art_cfieerd$art_c; $art_igcohnmkmq$art_i++) {        var s = selectedItems[$art_igcohnmkmq$art_i]%>';
        for (var $art_igcohnmkmq$art_i = 0, $art_cfieerd$art_c = selectedItems.length; $art_igcohnmkmq$art_i < $art_cfieerd$art_c; $art_igcohnmkmq$art_i++) {
            var s = selectedItems[$art_igcohnmkmq$art_i];
