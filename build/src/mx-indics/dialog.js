...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_idkhtejlrvd$art_i = 0, $art_cfluzfnxm$art_c = groups.length; $art_idkhtejlrvd$art_i < $art_cfluzfnxm$art_c; $art_idkhtejlrvd$art_i++) {    var group = groups[$art_idkhtejlrvd$art_i]%>';
    for (var $art_idkhtejlrvd$art_i = 0, $art_cfluzfnxm$art_c = groups.length; $art_idkhtejlrvd$art_i < $art_cfluzfnxm$art_c; $art_idkhtejlrvd$art_i++) {
        var group = groups[$art_idkhtejlrvd$art_i];
        ...
        ;
        $expr = '<%for (var $art_idvkacepf$art_i = 0, $art_objthkqda$art_obj = group.fields, $art_cphezmfvj$art_c = $art_objthkqda$art_obj.length; $art_idvkacepf$art_i < $art_cphezmfvj$art_c; $art_idvkacepf$art_i++) {        var field = $art_objthkqda$art_obj[$art_idvkacepf$art_i]%>';
        for (var $art_idvkacepf$art_i = 0, $art_objthkqda$art_obj = group.fields, $art_cphezmfvj$art_c = $art_objthkqda$art_obj.length; $art_idvkacepf$art_i < $art_cphezmfvj$art_c; $art_idvkacepf$art_i++) {
            var field = $art_objthkqda$art_obj[$art_idvkacepf$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_izccqql$art_i = 0, $art_cjqueinayym$art_c = selectedItems.length; $art_izccqql$art_i < $art_cjqueinayym$art_c; $art_izccqql$art_i++) {        var s = selectedItems[$art_izccqql$art_i]%>';
        for (var $art_izccqql$art_i = 0, $art_cjqueinayym$art_c = selectedItems.length; $art_izccqql$art_i < $art_cjqueinayym$art_c; $art_izccqql$art_i++) {
            var s = selectedItems[$art_izccqql$art_i];
