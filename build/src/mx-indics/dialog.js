...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iseann$art_i = 0, $art_cnbjcvqvdvhe$art_c = groups.length; $art_iseann$art_i < $art_cnbjcvqvdvhe$art_c; $art_iseann$art_i++) {    var group = groups[$art_iseann$art_i]%>';
    for (var $art_iseann$art_i = 0, $art_cnbjcvqvdvhe$art_c = groups.length; $art_iseann$art_i < $art_cnbjcvqvdvhe$art_c; $art_iseann$art_i++) {
        var group = groups[$art_iseann$art_i];
        ...
        ;
        $expr = '<%for (var $art_irzcelsv$art_i = 0, $art_objewstsis$art_obj = group.fields, $art_cxnmt$art_c = $art_objewstsis$art_obj.length; $art_irzcelsv$art_i < $art_cxnmt$art_c; $art_irzcelsv$art_i++) {        var field = $art_objewstsis$art_obj[$art_irzcelsv$art_i]%>';
        for (var $art_irzcelsv$art_i = 0, $art_objewstsis$art_obj = group.fields, $art_cxnmt$art_c = $art_objewstsis$art_obj.length; $art_irzcelsv$art_i < $art_cxnmt$art_c; $art_irzcelsv$art_i++) {
            var field = $art_objewstsis$art_obj[$art_irzcelsv$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_immgzkvgc$art_i = 0, $art_cflbdfbc$art_c = selectedItems.length; $art_immgzkvgc$art_i < $art_cflbdfbc$art_c; $art_immgzkvgc$art_i++) {        var s = selectedItems[$art_immgzkvgc$art_i]%>';
        for (var $art_immgzkvgc$art_i = 0, $art_cflbdfbc$art_c = selectedItems.length; $art_immgzkvgc$art_i < $art_cflbdfbc$art_c; $art_immgzkvgc$art_i++) {
            var s = selectedItems[$art_immgzkvgc$art_i];
