...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixshdqbighj$art_i = 0, $art_ckzribfqa$art_c = groups.length; $art_ixshdqbighj$art_i < $art_ckzribfqa$art_c; $art_ixshdqbighj$art_i++) {    var group = groups[$art_ixshdqbighj$art_i]%>';
    for (var $art_ixshdqbighj$art_i = 0, $art_ckzribfqa$art_c = groups.length; $art_ixshdqbighj$art_i < $art_ckzribfqa$art_c; $art_ixshdqbighj$art_i++) {
        var group = groups[$art_ixshdqbighj$art_i];
        ...
        ;
        $expr = '<%for (var $art_iqkricnmz$art_i = 0, $art_objbcfgpl$art_obj = group.fields, $art_corpzq$art_c = $art_objbcfgpl$art_obj.length; $art_iqkricnmz$art_i < $art_corpzq$art_c; $art_iqkricnmz$art_i++) {        var field = $art_objbcfgpl$art_obj[$art_iqkricnmz$art_i]%>';
        for (var $art_iqkricnmz$art_i = 0, $art_objbcfgpl$art_obj = group.fields, $art_corpzq$art_c = $art_objbcfgpl$art_obj.length; $art_iqkricnmz$art_i < $art_corpzq$art_c; $art_iqkricnmz$art_i++) {
            var field = $art_objbcfgpl$art_obj[$art_iqkricnmz$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_itnseeqqmi$art_i = 0, $art_cauydvqghu$art_c = selectedItems.length; $art_itnseeqqmi$art_i < $art_cauydvqghu$art_c; $art_itnseeqqmi$art_i++) {        var s = selectedItems[$art_itnseeqqmi$art_i]%>';
        for (var $art_itnseeqqmi$art_i = 0, $art_cauydvqghu$art_c = selectedItems.length; $art_itnseeqqmi$art_i < $art_cauydvqghu$art_c; $art_itnseeqqmi$art_i++) {
            var s = selectedItems[$art_itnseeqqmi$art_i];
