...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igdgfaum$art_i = 0, $art_ctkbzjnmwf$art_c = groups.length; $art_igdgfaum$art_i < $art_ctkbzjnmwf$art_c; $art_igdgfaum$art_i++) {    var group = groups[$art_igdgfaum$art_i]%>';
    for (var $art_igdgfaum$art_i = 0, $art_ctkbzjnmwf$art_c = groups.length; $art_igdgfaum$art_i < $art_ctkbzjnmwf$art_c; $art_igdgfaum$art_i++) {
        var group = groups[$art_igdgfaum$art_i];
        ...
        ;
        $expr = '<%for (var $art_ird$art_i = 0, $art_objplmlyrr$art_obj = group.fields, $art_ccxrixle$art_c = $art_objplmlyrr$art_obj.length; $art_ird$art_i < $art_ccxrixle$art_c; $art_ird$art_i++) {        var field = $art_objplmlyrr$art_obj[$art_ird$art_i]%>';
        for (var $art_ird$art_i = 0, $art_objplmlyrr$art_obj = group.fields, $art_ccxrixle$art_c = $art_objplmlyrr$art_obj.length; $art_ird$art_i < $art_ccxrixle$art_c; $art_ird$art_i++) {
            var field = $art_objplmlyrr$art_obj[$art_ird$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ixttanbfoh$art_i = 0, $art_cqahabeoh$art_c = selectedItems.length; $art_ixttanbfoh$art_i < $art_cqahabeoh$art_c; $art_ixttanbfoh$art_i++) {        var s = selectedItems[$art_ixttanbfoh$art_i]%>';
        for (var $art_ixttanbfoh$art_i = 0, $art_cqahabeoh$art_c = selectedItems.length; $art_ixttanbfoh$art_i < $art_cqahabeoh$art_c; $art_ixttanbfoh$art_i++) {
            var s = selectedItems[$art_ixttanbfoh$art_i];
