...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_igevocpsjlr$art_i = 0, $art_cynsjzz$art_c = groups.length; $art_igevocpsjlr$art_i < $art_cynsjzz$art_c; $art_igevocpsjlr$art_i++) {    var group = groups[$art_igevocpsjlr$art_i]%>';
    for (var $art_igevocpsjlr$art_i = 0, $art_cynsjzz$art_c = groups.length; $art_igevocpsjlr$art_i < $art_cynsjzz$art_c; $art_igevocpsjlr$art_i++) {
        var group = groups[$art_igevocpsjlr$art_i];
        $p += '<div mxv mxa="_zs_gallerybz:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 23;
        $art = 'each group as field';
        ;
        $expr = '<%for (var $art_iqxhipkl$art_i = 0, $art_cahzluqc$art_c = group.length; $art_iqxhipkl$art_i < $art_cahzluqc$art_c; $art_iqxhipkl$art_i++) {        var field = group[$art_iqxhipkl$art_i]%>';
        for (var $art_iqxhipkl$art_i = 0, $art_cahzluqc$art_c = group.length; $art_iqxhipkl$art_i < $art_cahzluqc$art_c; $art_iqxhipkl$art_i++) {
            var field = group[$art_iqxhipkl$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_iczbdc$art_i = 0, $art_chqgwdmn$art_c = selectedItems.length; $art_iczbdc$art_i < $art_chqgwdmn$art_c; $art_iczbdc$art_i++) {        var s = selectedItems[$art_iczbdc$art_i]%>';
        for (var $art_iczbdc$art_i = 0, $art_chqgwdmn$art_c = selectedItems.length; $art_iczbdc$art_i < $art_chqgwdmn$art_c; $art_iczbdc$art_i++) {
            var s = selectedItems[$art_iczbdc$art_i];
