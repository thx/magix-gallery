...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijoehp$art_i = 0, $art_cfkwnphq$art_c = groups.length; $art_ijoehp$art_i < $art_cfkwnphq$art_c; $art_ijoehp$art_i++) {    var group = groups[$art_ijoehp$art_i]%>';
    for (var $art_ijoehp$art_i = 0, $art_cfkwnphq$art_c = groups.length; $art_ijoehp$art_i < $art_cfkwnphq$art_c; $art_ijoehp$art_i++) {
        var group = groups[$art_ijoehp$art_i];
        ...
        ;
        $expr = '<%for (var $art_icqidanlo$art_i = 0, $art_objguijgvsgp$art_obj = group.fields, $art_cynqujp$art_c = $art_objguijgvsgp$art_obj.length; $art_icqidanlo$art_i < $art_cynqujp$art_c; $art_icqidanlo$art_i++) {        var field = $art_objguijgvsgp$art_obj[$art_icqidanlo$art_i]%>';
        for (var $art_icqidanlo$art_i = 0, $art_objguijgvsgp$art_obj = group.fields, $art_cynqujp$art_c = $art_objguijgvsgp$art_obj.length; $art_icqidanlo$art_i < $art_cynqujp$art_c; $art_icqidanlo$art_i++) {
            var field = $art_objguijgvsgp$art_obj[$art_icqidanlo$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ixignrfii$art_i = 0, $art_cxephiusb$art_c = selectedItems.length; $art_ixignrfii$art_i < $art_cxephiusb$art_c; $art_ixignrfii$art_i++) {        var s = selectedItems[$art_ixignrfii$art_i]%>';
        for (var $art_ixignrfii$art_i = 0, $art_cxephiusb$art_c = selectedItems.length; $art_ixignrfii$art_i < $art_cxephiusb$art_c; $art_ixignrfii$art_i++) {
            var s = selectedItems[$art_ixignrfii$art_i];
