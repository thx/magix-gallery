...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ismhdhzhql$art_i = 0, $art_ctuqjmem$art_c = groups.length; $art_ismhdhzhql$art_i < $art_ctuqjmem$art_c; $art_ismhdhzhql$art_i++) {    var group = groups[$art_ismhdhzhql$art_i]%>';
    for (var $art_ismhdhzhql$art_i = 0, $art_ctuqjmem$art_c = groups.length; $art_ismhdhzhql$art_i < $art_ctuqjmem$art_c; $art_ismhdhzhql$art_i++) {
        var group = groups[$art_ismhdhzhql$art_i];
        ...
        ;
        $expr = '<%for (var $art_iaudjluqfn$art_i = 0, $art_objdiatxoqu$art_obj = group.fields, $art_carmhlqi$art_c = $art_objdiatxoqu$art_obj.length; $art_iaudjluqfn$art_i < $art_carmhlqi$art_c; $art_iaudjluqfn$art_i++) {        var field = $art_objdiatxoqu$art_obj[$art_iaudjluqfn$art_i]%>';
        for (var $art_iaudjluqfn$art_i = 0, $art_objdiatxoqu$art_obj = group.fields, $art_carmhlqi$art_c = $art_objdiatxoqu$art_obj.length; $art_iaudjluqfn$art_i < $art_carmhlqi$art_c; $art_iaudjluqfn$art_i++) {
            var field = $art_objdiatxoqu$art_obj[$art_iaudjluqfn$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_itwqdfhrdcl$art_i = 0, $art_cxtnjabffei$art_c = selectedItems.length; $art_itwqdfhrdcl$art_i < $art_cxtnjabffei$art_c; $art_itwqdfhrdcl$art_i++) {        var s = selectedItems[$art_itwqdfhrdcl$art_i]%>';
        for (var $art_itwqdfhrdcl$art_i = 0, $art_cxtnjabffei$art_c = selectedItems.length; $art_itwqdfhrdcl$art_i < $art_cxtnjabffei$art_c; $art_itwqdfhrdcl$art_i++) {
            var s = selectedItems[$art_itwqdfhrdcl$art_i];
