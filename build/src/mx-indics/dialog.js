...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iyvrceeoy$art_i = 0, $art_cuezpigbp$art_c = groups.length; $art_iyvrceeoy$art_i < $art_cuezpigbp$art_c; $art_iyvrceeoy$art_i++) {    var group = groups[$art_iyvrceeoy$art_i]%>';
    for (var $art_iyvrceeoy$art_i = 0, $art_cuezpigbp$art_c = groups.length; $art_iyvrceeoy$art_i < $art_cuezpigbp$art_c; $art_iyvrceeoy$art_i++) {
        var group = groups[$art_iyvrceeoy$art_i];
        ...
        ;
        $expr = '<%for (var $art_irfcrgdah$art_i = 0, $art_objkgkfqiy$art_obj = group.fields, $art_cyhvrvcgq$art_c = $art_objkgkfqiy$art_obj.length; $art_irfcrgdah$art_i < $art_cyhvrvcgq$art_c; $art_irfcrgdah$art_i++) {        var field = $art_objkgkfqiy$art_obj[$art_irfcrgdah$art_i]%>';
        for (var $art_irfcrgdah$art_i = 0, $art_objkgkfqiy$art_obj = group.fields, $art_cyhvrvcgq$art_c = $art_objkgkfqiy$art_obj.length; $art_irfcrgdah$art_i < $art_cyhvrvcgq$art_c; $art_irfcrgdah$art_i++) {
            var field = $art_objkgkfqiy$art_obj[$art_irfcrgdah$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_idgzls$art_i = 0, $art_ccfpgqbzasog$art_c = selectedItems.length; $art_idgzls$art_i < $art_ccfpgqbzasog$art_c; $art_idgzls$art_i++) {        var s = selectedItems[$art_idgzls$art_i]%>';
        for (var $art_idgzls$art_i = 0, $art_ccfpgqbzasog$art_c = selectedItems.length; $art_idgzls$art_i < $art_ccfpgqbzasog$art_c; $art_idgzls$art_i++) {
            var s = selectedItems[$art_idgzls$art_i];
