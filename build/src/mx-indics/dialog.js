...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ijjedxrxdhe$art_i = 0, $art_ctphbdesu$art_c = groups.length; $art_ijjedxrxdhe$art_i < $art_ctphbdesu$art_c; $art_ijjedxrxdhe$art_i++) {    var group = groups[$art_ijjedxrxdhe$art_i]%>';
    for (var $art_ijjedxrxdhe$art_i = 0, $art_ctphbdesu$art_c = groups.length; $art_ijjedxrxdhe$art_i < $art_ctphbdesu$art_c; $art_ijjedxrxdhe$art_i++) {
        var group = groups[$art_ijjedxrxdhe$art_i];
        ...
        ;
        $expr = '<%for (var $art_ikvdruxurfk$art_i = 0, $art_objscoqqokt$art_obj = group.fields, $art_cahswgreb$art_c = $art_objscoqqokt$art_obj.length; $art_ikvdruxurfk$art_i < $art_cahswgreb$art_c; $art_ikvdruxurfk$art_i++) {        var field = $art_objscoqqokt$art_obj[$art_ikvdruxurfk$art_i]%>';
        for (var $art_ikvdruxurfk$art_i = 0, $art_objscoqqokt$art_obj = group.fields, $art_cahswgreb$art_c = $art_objscoqqokt$art_obj.length; $art_ikvdruxurfk$art_i < $art_cahswgreb$art_c; $art_ikvdruxurfk$art_i++) {
            var field = $art_objscoqqokt$art_obj[$art_ikvdruxurfk$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_igqjocbtf$art_i = 0, $art_cjvfbztc$art_c = selectedItems.length; $art_igqjocbtf$art_i < $art_cjvfbztc$art_c; $art_igqjocbtf$art_i++) {        var s = selectedItems[$art_igqjocbtf$art_i]%>';
        for (var $art_igqjocbtf$art_i = 0, $art_cjvfbztc$art_c = selectedItems.length; $art_igqjocbtf$art_i < $art_cjvfbztc$art_c; $art_igqjocbtf$art_i++) {
            var s = selectedItems[$art_igqjocbtf$art_i];
