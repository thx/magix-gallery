...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ixgxefom$art_i = 0, $art_cqtbwlj$art_c = groups.length; $art_ixgxefom$art_i < $art_cqtbwlj$art_c; $art_ixgxefom$art_i++) {    var group = groups[$art_ixgxefom$art_i]%>';
    for (var $art_ixgxefom$art_i = 0, $art_cqtbwlj$art_c = groups.length; $art_ixgxefom$art_i < $art_cqtbwlj$art_c; $art_ixgxefom$art_i++) {
        var group = groups[$art_ixgxefom$art_i];
        ...
        ;
        $expr = '<%for (var $art_idxvckxork$art_i = 0, $art_objbguozm$art_obj = group.fields, $art_ccbmfcoyob$art_c = $art_objbguozm$art_obj.length; $art_idxvckxork$art_i < $art_ccbmfcoyob$art_c; $art_idxvckxork$art_i++) {        var field = $art_objbguozm$art_obj[$art_idxvckxork$art_i]%>';
        for (var $art_idxvckxork$art_i = 0, $art_objbguozm$art_obj = group.fields, $art_ccbmfcoyob$art_c = $art_objbguozm$art_obj.length; $art_idxvckxork$art_i < $art_ccbmfcoyob$art_c; $art_idxvckxork$art_i++) {
            var field = $art_objbguozm$art_obj[$art_idxvckxork$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ijduhghlva$art_i = 0, $art_cvmxvejtlh$art_c = selectedItems.length; $art_ijduhghlva$art_i < $art_cvmxvejtlh$art_c; $art_ijduhghlva$art_i++) {        var s = selectedItems[$art_ijduhghlva$art_i]%>';
        for (var $art_ijduhghlva$art_i = 0, $art_cvmxvejtlh$art_c = selectedItems.length; $art_ijduhghlva$art_i < $art_cvmxvejtlh$art_c; $art_ijduhghlva$art_i++) {
            var s = selectedItems[$art_ijduhghlva$art_i];
