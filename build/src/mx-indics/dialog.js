...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihhdelxo$art_i = 0, $art_cwdejn$art_c = groups.length; $art_ihhdelxo$art_i < $art_cwdejn$art_c; $art_ihhdelxo$art_i++) {    var group = groups[$art_ihhdelxo$art_i]%>';
    for (var $art_ihhdelxo$art_i = 0, $art_cwdejn$art_c = groups.length; $art_ihhdelxo$art_i < $art_cwdejn$art_c; $art_ihhdelxo$art_i++) {
        var group = groups[$art_ihhdelxo$art_i];
        ...
        ;
        $expr = '<%for (var $art_ifewwurq$art_i = 0, $art_objcwgckrlbg$art_obj = group.fields, $art_cjrwdqg$art_c = $art_objcwgckrlbg$art_obj.length; $art_ifewwurq$art_i < $art_cjrwdqg$art_c; $art_ifewwurq$art_i++) {        var field = $art_objcwgckrlbg$art_obj[$art_ifewwurq$art_i]%>';
        for (var $art_ifewwurq$art_i = 0, $art_objcwgckrlbg$art_obj = group.fields, $art_cjrwdqg$art_c = $art_objcwgckrlbg$art_obj.length; $art_ifewwurq$art_i < $art_cjrwdqg$art_c; $art_ifewwurq$art_i++) {
            var field = $art_objcwgckrlbg$art_obj[$art_ifewwurq$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_iwouynihi$art_i = 0, $art_cfzuhmfv$art_c = selectedItems.length; $art_iwouynihi$art_i < $art_cfzuhmfv$art_c; $art_iwouynihi$art_i++) {        var s = selectedItems[$art_iwouynihi$art_i]%>';
        for (var $art_iwouynihi$art_i = 0, $art_cfzuhmfv$art_c = selectedItems.length; $art_iwouynihi$art_i < $art_cfzuhmfv$art_c; $art_iwouynihi$art_i++) {
            var s = selectedItems[$art_iwouynihi$art_i];
