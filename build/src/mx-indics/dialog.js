...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iubinggh$art_i = 0, $art_chitctaqzn$art_c = groups.length; $art_iubinggh$art_i < $art_chitctaqzn$art_c; $art_iubinggh$art_i++) {    var group = groups[$art_iubinggh$art_i]%>';
    for (var $art_iubinggh$art_i = 0, $art_chitctaqzn$art_c = groups.length; $art_iubinggh$art_i < $art_chitctaqzn$art_c; $art_iubinggh$art_i++) {
        var group = groups[$art_iubinggh$art_i];
        $p += '<div mxv mxa="_zs_gallerybt:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 23;
        $art = 'each group as field';
        ;
        $expr = '<%for (var $art_iymueqtdpt$art_i = 0, $art_cuuluwaszlpj$art_c = group.length; $art_iymueqtdpt$art_i < $art_cuuluwaszlpj$art_c; $art_iymueqtdpt$art_i++) {        var field = group[$art_iymueqtdpt$art_i]%>';
        for (var $art_iymueqtdpt$art_i = 0, $art_cuuluwaszlpj$art_c = group.length; $art_iymueqtdpt$art_i < $art_cuuluwaszlpj$art_c; $art_iymueqtdpt$art_i++) {
            var field = group[$art_iymueqtdpt$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ijgbybwgwq$art_i = 0, $art_czudewmim$art_c = selectedItems.length; $art_ijgbybwgwq$art_i < $art_czudewmim$art_c; $art_ijgbybwgwq$art_i++) {        var s = selectedItems[$art_ijgbybwgwq$art_i]%>';
        for (var $art_ijgbybwgwq$art_i = 0, $art_czudewmim$art_c = selectedItems.length; $art_ijgbybwgwq$art_i < $art_czudewmim$art_c; $art_ijgbybwgwq$art_i++) {
            var s = selectedItems[$art_ijgbybwgwq$art_i];
