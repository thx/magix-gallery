...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ipjfrau$art_i = 0, $art_cwmdtjhyea$art_c = groups.length; $art_ipjfrau$art_i < $art_cwmdtjhyea$art_c; $art_ipjfrau$art_i++) {    var group = groups[$art_ipjfrau$art_i]%>';
    for (var $art_ipjfrau$art_i = 0, $art_cwmdtjhyea$art_c = groups.length; $art_ipjfrau$art_i < $art_cwmdtjhyea$art_c; $art_ipjfrau$art_i++) {
        var group = groups[$art_ipjfrau$art_i];
        ...
        ;
        $expr = '<%for (var $art_ieuasyr$art_i = 0, $art_objobsgsehl$art_obj = group.fields, $art_cfuncrrmlb$art_c = $art_objobsgsehl$art_obj.length; $art_ieuasyr$art_i < $art_cfuncrrmlb$art_c; $art_ieuasyr$art_i++) {        var field = $art_objobsgsehl$art_obj[$art_ieuasyr$art_i]%>';
        for (var $art_ieuasyr$art_i = 0, $art_objobsgsehl$art_obj = group.fields, $art_cfuncrrmlb$art_c = $art_objobsgsehl$art_obj.length; $art_ieuasyr$art_i < $art_cfuncrrmlb$art_c; $art_ieuasyr$art_i++) {
            var field = $art_objobsgsehl$art_obj[$art_ieuasyr$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ickkkfejre$art_i = 0, $art_cstbwwitp$art_c = selectedItems.length; $art_ickkkfejre$art_i < $art_cstbwwitp$art_c; $art_ickkkfejre$art_i++) {        var s = selectedItems[$art_ickkkfejre$art_i]%>';
        for (var $art_ickkkfejre$art_i = 0, $art_cstbwwitp$art_c = selectedItems.length; $art_ickkkfejre$art_i < $art_cstbwwitp$art_c; $art_ickkkfejre$art_i++) {
            var s = selectedItems[$art_ickkkfejre$art_i];
