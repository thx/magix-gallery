...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibtgocxqpn$art_i = 0, $art_cgavqbzsmc$art_c = groups.length; $art_ibtgocxqpn$art_i < $art_cgavqbzsmc$art_c; $art_ibtgocxqpn$art_i++) {    var group = groups[$art_ibtgocxqpn$art_i]%>';
    for (var $art_ibtgocxqpn$art_i = 0, $art_cgavqbzsmc$art_c = groups.length; $art_ibtgocxqpn$art_i < $art_cgavqbzsmc$art_c; $art_ibtgocxqpn$art_i++) {
        var group = groups[$art_ibtgocxqpn$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixmwgj$art_i = 0, $art_objycqxjt$art_obj = group.fields, $art_cszzdyz$art_c = $art_objycqxjt$art_obj.length; $art_ixmwgj$art_i < $art_cszzdyz$art_c; $art_ixmwgj$art_i++) {        var field = $art_objycqxjt$art_obj[$art_ixmwgj$art_i]%>';
        for (var $art_ixmwgj$art_i = 0, $art_objycqxjt$art_obj = group.fields, $art_cszzdyz$art_c = $art_objycqxjt$art_obj.length; $art_ixmwgj$art_i < $art_cszzdyz$art_c; $art_ixmwgj$art_i++) {
            var field = $art_objycqxjt$art_obj[$art_ixmwgj$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ipozsnmsr$art_i = 0, $art_coyzziltf$art_c = selectedItems.length; $art_ipozsnmsr$art_i < $art_coyzziltf$art_c; $art_ipozsnmsr$art_i++) {        var s = selectedItems[$art_ipozsnmsr$art_i]%>';
        for (var $art_ipozsnmsr$art_i = 0, $art_coyzziltf$art_c = selectedItems.length; $art_ipozsnmsr$art_i < $art_coyzziltf$art_c; $art_ipozsnmsr$art_i++) {
            var s = selectedItems[$art_ipozsnmsr$art_i];
