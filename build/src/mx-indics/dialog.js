...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ihweudgrdb$art_i = 0, $art_cetdokn$art_c = groups.length; $art_ihweudgrdb$art_i < $art_cetdokn$art_c; $art_ihweudgrdb$art_i++) {    var group = groups[$art_ihweudgrdb$art_i]%>';
    for (var $art_ihweudgrdb$art_i = 0, $art_cetdokn$art_c = groups.length; $art_ihweudgrdb$art_i < $art_cetdokn$art_c; $art_ihweudgrdb$art_i++) {
        var group = groups[$art_ihweudgrdb$art_i];
        ...
        ;
        $expr = '<%for (var $art_itoexwr$art_i = 0, $art_objvqjkwsrm$art_obj = group.fields, $art_cykkfmkniq$art_c = $art_objvqjkwsrm$art_obj.length; $art_itoexwr$art_i < $art_cykkfmkniq$art_c; $art_itoexwr$art_i++) {        var field = $art_objvqjkwsrm$art_obj[$art_itoexwr$art_i]%>';
        for (var $art_itoexwr$art_i = 0, $art_objvqjkwsrm$art_obj = group.fields, $art_cykkfmkniq$art_c = $art_objvqjkwsrm$art_obj.length; $art_itoexwr$art_i < $art_cykkfmkniq$art_c; $art_itoexwr$art_i++) {
            var field = $art_objvqjkwsrm$art_obj[$art_itoexwr$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ikydfe$art_i = 0, $art_chzlwgyyb$art_c = selectedItems.length; $art_ikydfe$art_i < $art_chzlwgyyb$art_c; $art_ikydfe$art_i++) {        var s = selectedItems[$art_ikydfe$art_i]%>';
        for (var $art_ikydfe$art_i = 0, $art_chzlwgyyb$art_c = selectedItems.length; $art_ikydfe$art_i < $art_chzlwgyyb$art_c; $art_ikydfe$art_i++) {
            var s = selectedItems[$art_ikydfe$art_i];
