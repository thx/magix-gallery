...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iasgqyp$art_i = 0, $art_cotiqzgh$art_c = groups.length; $art_iasgqyp$art_i < $art_cotiqzgh$art_c; $art_iasgqyp$art_i++) {    var group = groups[$art_iasgqyp$art_i]%>';
    for (var $art_iasgqyp$art_i = 0, $art_cotiqzgh$art_c = groups.length; $art_iasgqyp$art_i < $art_cotiqzgh$art_c; $art_iasgqyp$art_i++) {
        var group = groups[$art_iasgqyp$art_i];
        ...
        ;
        $expr = '<%for (var $art_inoqhliff$art_i = 0, $art_objpppuie$art_obj = group.fields, $art_cquxrtksf$art_c = $art_objpppuie$art_obj.length; $art_inoqhliff$art_i < $art_cquxrtksf$art_c; $art_inoqhliff$art_i++) {        var field = $art_objpppuie$art_obj[$art_inoqhliff$art_i]%>';
        for (var $art_inoqhliff$art_i = 0, $art_objpppuie$art_obj = group.fields, $art_cquxrtksf$art_c = $art_objpppuie$art_obj.length; $art_inoqhliff$art_i < $art_cquxrtksf$art_c; $art_inoqhliff$art_i++) {
            var field = $art_objpppuie$art_obj[$art_inoqhliff$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ixzqhpeoql$art_i = 0, $art_chwtxdjugh$art_c = selectedItems.length; $art_ixzqhpeoql$art_i < $art_chwtxdjugh$art_c; $art_ixzqhpeoql$art_i++) {        var s = selectedItems[$art_ixzqhpeoql$art_i]%>';
        for (var $art_ixzqhpeoql$art_i = 0, $art_chwtxdjugh$art_c = selectedItems.length; $art_ixzqhpeoql$art_i < $art_chwtxdjugh$art_c; $art_ixzqhpeoql$art_i++) {
            var s = selectedItems[$art_ixzqhpeoql$art_i];
