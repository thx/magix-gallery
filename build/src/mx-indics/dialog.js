...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_ibazctyty$art_i = 0, $art_cpqxlvlyxj$art_c = groups.length; $art_ibazctyty$art_i < $art_cpqxlvlyxj$art_c; $art_ibazctyty$art_i++) {    var group = groups[$art_ibazctyty$art_i]%>';
    for (var $art_ibazctyty$art_i = 0, $art_cpqxlvlyxj$art_c = groups.length; $art_ibazctyty$art_i < $art_cpqxlvlyxj$art_c; $art_ibazctyty$art_i++) {
        var group = groups[$art_ibazctyty$art_i];
        ...
        ;
        $expr = '<%for (var $art_igffurhm$art_i = 0, $art_objxltar$art_obj = group.fields, $art_cksfjqwadjf$art_c = $art_objxltar$art_obj.length; $art_igffurhm$art_i < $art_cksfjqwadjf$art_c; $art_igffurhm$art_i++) {        var field = $art_objxltar$art_obj[$art_igffurhm$art_i]%>';
        for (var $art_igffurhm$art_i = 0, $art_objxltar$art_obj = group.fields, $art_cksfjqwadjf$art_c = $art_objxltar$art_obj.length; $art_igffurhm$art_i < $art_cksfjqwadjf$art_c; $art_igffurhm$art_i++) {
            var field = $art_objxltar$art_obj[$art_igffurhm$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ifijovkq$art_i = 0, $art_cqygumaun$art_c = selectedItems.length; $art_ifijovkq$art_i < $art_cqygumaun$art_c; $art_ifijovkq$art_i++) {        var s = selectedItems[$art_ifijovkq$art_i]%>';
        for (var $art_ifijovkq$art_i = 0, $art_cqygumaun$art_c = selectedItems.length; $art_ifijovkq$art_i < $art_cqygumaun$art_c; $art_ifijovkq$art_i++) {
            var s = selectedItems[$art_ifijovkq$art_i];
