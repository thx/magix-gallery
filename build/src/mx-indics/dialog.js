...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iauxlrysum$art_i = 0, $art_cnlzezldn$art_c = groups.length; $art_iauxlrysum$art_i < $art_cnlzezldn$art_c; $art_iauxlrysum$art_i++) {    var group = groups[$art_iauxlrysum$art_i]%>';
    for (var $art_iauxlrysum$art_i = 0, $art_cnlzezldn$art_c = groups.length; $art_iauxlrysum$art_i < $art_cnlzezldn$art_c; $art_iauxlrysum$art_i++) {
        var group = groups[$art_iauxlrysum$art_i];
        $p += '<div mxv mxa="_zs_gallerybs:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 23;
        $art = 'each group as field';
        ;
        $expr = '<%for (var $art_iplbfhup$art_i = 0, $art_ckqpgoku$art_c = group.length; $art_iplbfhup$art_i < $art_ckqpgoku$art_c; $art_iplbfhup$art_i++) {        var field = group[$art_iplbfhup$art_i]%>';
        for (var $art_iplbfhup$art_i = 0, $art_ckqpgoku$art_c = group.length; $art_iplbfhup$art_i < $art_ckqpgoku$art_c; $art_iplbfhup$art_i++) {
            var field = group[$art_iplbfhup$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_ijifupucg$art_i = 0, $art_clglkjtlhc$art_c = selectedItems.length; $art_ijifupucg$art_i < $art_clglkjtlhc$art_c; $art_ijifupucg$art_i++) {        var s = selectedItems[$art_ijifupucg$art_i]%>';
        for (var $art_ijifupucg$art_i = 0, $art_clglkjtlhc$art_c = selectedItems.length; $art_ijifupucg$art_i < $art_clglkjtlhc$art_c; $art_ijifupucg$art_i++) {
            var s = selectedItems[$art_ijifupucg$art_i];
