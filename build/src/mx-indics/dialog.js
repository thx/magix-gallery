...
module.exports = Magix.View.extend({
    ...
    ;
    $p += '';
    $expr = '<%for (var $art_iaimwjyl$art_i = 0, $art_cyaiucvss$art_c = groups.length; $art_iaimwjyl$art_i < $art_cyaiucvss$art_c; $art_iaimwjyl$art_i++) {    var group = groups[$art_iaimwjyl$art_i]%>';
    for (var $art_iaimwjyl$art_i = 0, $art_cyaiucvss$art_c = groups.length; $art_iaimwjyl$art_i < $art_cyaiucvss$art_c; $art_iaimwjyl$art_i++) {
        var group = groups[$art_iaimwjyl$art_i];
        $p += '<div mxv mxa="_zs_gallerybu:c" class="_zs_gallery_mx-indics_index_-line clearfix">';
        $line = 23;
        $art = 'each group as field';
        ;
        $p += '';
        $expr = '<%for (var $art_ibcaatkjnm$art_i = 0, $art_chdovul$art_c = group.length; $art_ibcaatkjnm$art_i < $art_chdovul$art_c; $art_ibcaatkjnm$art_i++) {        var field = group[$art_ibcaatkjnm$art_i]%>';
        for (var $art_ibcaatkjnm$art_i = 0, $art_chdovul$art_c = group.length; $art_ibcaatkjnm$art_i < $art_chdovul$art_c; $art_ibcaatkjnm$art_i++) {
            var field = group[$art_ibcaatkjnm$art_i];
    ...
    if (sortable) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ilgfavnkqcp$art_i = 0, $art_cypsgfos$art_c = selectedItems.length; $art_ilgfavnkqcp$art_i < $art_cypsgfos$art_c; $art_ilgfavnkqcp$art_i++) {        var s = selectedItems[$art_ilgfavnkqcp$art_i]%>';
        for (var $art_ilgfavnkqcp$art_i = 0, $art_cypsgfos$art_c = selectedItems.length; $art_ilgfavnkqcp$art_i < $art_cypsgfos$art_c; $art_ilgfavnkqcp$art_i++) {
            var s = selectedItems[$art_ilgfavnkqcp$art_i];
