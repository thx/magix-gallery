...
module.exports = Magix.View.extend({
    ...
    ;
    $expr = '<%for (var $art_iiyecyqnse$art_i = 0, $art_cqrbnujw$art_c = groups.length; $art_iiyecyqnse$art_i < $art_cqrbnujw$art_c; $art_iiyecyqnse$art_i++) {    var group = groups[$art_iiyecyqnse$art_i]%>';
    for (var $art_iiyecyqnse$art_i = 0, $art_cqrbnujw$art_c = groups.length; $art_iiyecyqnse$art_i < $art_cqrbnujw$art_c; $art_iiyecyqnse$art_i++) {
        var group = groups[$art_iiyecyqnse$art_i];
        ...
        ;
        $expr = '<%for (var $art_ipjigmo$art_i = 0, $art_objjcmdhuayr$art_obj = group.fields, $art_ctpsocmruum$art_c = $art_objjcmdhuayr$art_obj.length; $art_ipjigmo$art_i < $art_ctpsocmruum$art_c; $art_ipjigmo$art_i++) {        var field = $art_objjcmdhuayr$art_obj[$art_ipjigmo$art_i]%>';
        for (var $art_ipjigmo$art_i = 0, $art_objjcmdhuayr$art_obj = group.fields, $art_ctpsocmruum$art_c = $art_objjcmdhuayr$art_obj.length; $art_ipjigmo$art_i < $art_ctpsocmruum$art_c; $art_ipjigmo$art_i++) {
            var field = $art_objjcmdhuayr$art_obj[$art_ipjigmo$art_i];
    ...
    if (sortable) {
        ...
        ;
        $expr = '<%for (var $art_imvzg$art_i = 0, $art_cquyidv$art_c = selectedItems.length; $art_imvzg$art_i < $art_cquyidv$art_c; $art_imvzg$art_i++) {        var s = selectedItems[$art_imvzg$art_i]%>';
        for (var $art_imvzg$art_i = 0, $art_cquyidv$art_c = selectedItems.length; $art_imvzg$art_i < $art_cquyidv$art_c; $art_imvzg$art_i++) {
            var s = selectedItems[$art_imvzg$art_i];
