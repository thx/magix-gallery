...
module.exports = Base.extend({
    ...
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div><div mxa="_zs_gallerycJ:d" class="_zs_gallery___test___layout_-half"><div mxs="_zs_gallerycJ:a" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">不限制可选择个数 + 指标不需排序 + 有分组</div></div><div mx-view="mx-indics/index?parents=';
    $line = 40;
    $art = '@[{\n                        value: 1, text: \'组1\'\n                    }, {\n                        value: 2, text: \'组2\'\n                    }]';
    ;
