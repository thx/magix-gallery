...
module.exports = Base.extend({
    ...
    if (custom1) {
        ...
        ;
        $expr = '<%for (var $art_invaamipq$art_i = 0, $art_clowrryth$art_c = customs1.length; $art_invaamipq$art_i < $art_clowrryth$art_c; $art_invaamipq$art_i++) {        var key = customs1[$art_invaamipq$art_i]%>';
        for (var $art_invaamipq$art_i = 0, $art_clowrryth$art_c = customs1.length; $art_invaamipq$art_i < $art_clowrryth$art_c; $art_invaamipq$art_i++) {
            var key = customs1[$art_invaamipq$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijhswcm$art_i = 0, $art_cahvkjrqtdr$art_c = defaults.length; $art_ijhswcm$art_i < $art_cahvkjrqtdr$art_c; $art_ijhswcm$art_i++) {        var key = defaults[$art_ijhswcm$art_i]%>';
        for (var $art_ijhswcm$art_i = 0, $art_cahvkjrqtdr$art_c = defaults.length; $art_ijhswcm$art_i < $art_cahvkjrqtdr$art_c; $art_ijhswcm$art_i++) {
            var key = defaults[$art_ijhswcm$art_i];
