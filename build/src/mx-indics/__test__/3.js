...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_iaepljxpye$art_i = 0, $art_cgqdzlrhurj$art_c = customs.length; $art_iaepljxpye$art_i < $art_cgqdzlrhurj$art_c; $art_iaepljxpye$art_i++) {        var key = customs[$art_iaepljxpye$art_i]%>';
        for (var $art_iaepljxpye$art_i = 0, $art_cgqdzlrhurj$art_c = customs.length; $art_iaepljxpye$art_i < $art_cgqdzlrhurj$art_c; $art_iaepljxpye$art_i++) {
            var key = customs[$art_iaepljxpye$art_i];
        ...
        ;
        $expr = '<%for (var $art_igegojqrfjk$art_i = 0, $art_cjstatgexp$art_c = defaults.length; $art_igegojqrfjk$art_i < $art_cjstatgexp$art_c; $art_igegojqrfjk$art_i++) {        var key = defaults[$art_igegojqrfjk$art_i]%>';
        for (var $art_igegojqrfjk$art_i = 0, $art_cjstatgexp$art_c = defaults.length; $art_igegojqrfjk$art_i < $art_cjstatgexp$art_c; $art_igegojqrfjk$art_i++) {
            var key = defaults[$art_igegojqrfjk$art_i];
