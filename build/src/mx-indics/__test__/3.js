...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_ivmtbifyec$art_i = 0, $art_cdypecxmcn$art_c = customs.length; $art_ivmtbifyec$art_i < $art_cdypecxmcn$art_c; $art_ivmtbifyec$art_i++) {        var key = customs[$art_ivmtbifyec$art_i]%>';
        for (var $art_ivmtbifyec$art_i = 0, $art_cdypecxmcn$art_c = customs.length; $art_ivmtbifyec$art_i < $art_cdypecxmcn$art_c; $art_ivmtbifyec$art_i++) {
            var key = customs[$art_ivmtbifyec$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iajonlll$art_i = 0, $art_ccgkxwxg$art_c = defaults.length; $art_iajonlll$art_i < $art_ccgkxwxg$art_c; $art_iajonlll$art_i++) {        var key = defaults[$art_iajonlll$art_i]%>';
        for (var $art_iajonlll$art_i = 0, $art_ccgkxwxg$art_c = defaults.length; $art_iajonlll$art_i < $art_ccgkxwxg$art_c; $art_iajonlll$art_i++) {
            var key = defaults[$art_iajonlll$art_i];
