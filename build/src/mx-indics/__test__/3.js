...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerybS:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerybS:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerybS:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">不限制可选择个数 + 不排序</div></div><div mxa="_zs_gallerybS:b" class="mb20"><div mx-change="' + $viewId + 'change()" mx-view="mx-indics/index?fields=';
    $line = 9;
    ...
    if (custom1) {
        ...
        ;
        $expr = '<%for (var $art_iqkymxkxpc$art_i = 0, $art_ckxk$art_c = customs1.length; $art_iqkymxkxpc$art_i < $art_ckxk$art_c; $art_iqkymxkxpc$art_i++) {        var key = customs1[$art_iqkymxkxpc$art_i]%>';
        for (var $art_iqkymxkxpc$art_i = 0, $art_ckxk$art_c = customs1.length; $art_iqkymxkxpc$art_i < $art_ckxk$art_c; $art_iqkymxkxpc$art_i++) {
            var key = customs1[$art_iqkymxkxpc$art_i];
        ...
        ;
        $expr = '<%for (var $art_ikfpkbyqep$art_i = 0, $art_cwbzrtpzj$art_c = defaults.length; $art_ikfpkbyqep$art_i < $art_cwbzrtpzj$art_c; $art_ikfpkbyqep$art_i++) {        var key = defaults[$art_ikfpkbyqep$art_i]%>';
        for (var $art_ikfpkbyqep$art_i = 0, $art_cwbzrtpzj$art_c = defaults.length; $art_ikfpkbyqep$art_i < $art_cwbzrtpzj$art_c; $art_ikfpkbyqep$art_i++) {
            var key = defaults[$art_ikfpkbyqep$art_i];
