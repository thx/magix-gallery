...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerycC:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerycC:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_gallerycC:b" class="clearfix mb20"><div mxa="_zs_gallerycC:c" class="_zs_gallery___test___layout_-half"><div mxs="_zs_gallerycC:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">自定义key + 无分组</div></div><div mx-view="mx-indics/index?fields=';
    $line = 10;
    $art = '@[{\n                        id: 1, name: \'消耗\'\n                    }, {\n                        id: 2, name: \'展现量\'\n                    }, {\n                        id: 3, name: \'点击量\'\n                    }, {\n                        id: 4, name: \'点击率\'\n                    }, {\n                        id: 5, name: \'平均点击单价\'\n                    }, {\n                        id: 6, name: \'点击转化率\'\n                    }]';
    ;
    ...
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div><div mxa="_zs_gallerycC:d" class="_zs_gallery___test___layout_-half"><div mxs="_zs_gallerycC:a" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">自定义key + 有分组（parents的key，value跟fields保持一致）</div></div><div mx-view="mx-indics/index?parents=';
    $line = 34;
    $art = '@[{\n                        id: 1, name: \'组1\'\n                    }, {\n                        id: 2, name: \'组2\'\n                    }]';
    ;
    ...
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div></div></div><div mxa="_zs_gallerycC:e" class="clearfix"><div mxa="_zs_gallerycC:f" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerycC:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 62;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_gallerycC:g" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 64;
    $art = '!text1';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-indics \n    fields="&#123;&#123;@[&#123;\n        id: 1, name: \'消耗\'\n    &#125;, &#123;\n        id: 2, name: \'展现量\'\n    &#125;, &#123;\n        id: 3, name: \'点击量\'\n    &#125;, &#123;\n        id: 4, name: \'点击率\'\n    &#125;, &#123;\n        id: 5, name: \'平均点击单价\'\n    &#125;, &#123;\n        id: 6, name: \'点击转化率\'\n    &#125;]&#125;&#125;" \n    value-key="id"\n    text-key="name"\n    defaults="&#123;&#123;@[1,2,3]&#125;&#125;"/&gt;\n            </pre></div><div mxa="_zs_gallerycC:h" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-right"><div mxs="_zs_gallerycC:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 89;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_gallerycC:i" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 91;
    $art = '!text2';
    ;
