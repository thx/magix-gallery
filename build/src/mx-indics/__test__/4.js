...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb/:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryb/:a" class="_zs_gallery___test___layout_-eg-content"><div mxa="_zs_galleryb/:b" class="clearfix mb20"><div mxa="_zs_galleryb/:c" class="_zs_gallery___test___layout_-half"><div mxs="_zs_galleryb/:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">自定义key + 无分组</div></div><div mx-view="mx-indics/index?fields=';
    $line = 10;
    $art = '@[{\n                        id: 1, name: \'消耗\'\n                    }, {\n                        id: 2, name: \'展现量\'\n                    }, {\n                        id: 3, name: \'点击量\'\n                    }, {\n                        id: 4, name: \'点击率\'\n                    }, {\n                        id: 5, name: \'平均点击单价\'\n                    }, {\n                        id: 6, name: \'点击转化率\'\n                    }]';
    ;
    ...
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div><div mxa="_zs_galleryb/:d" class="_zs_gallery___test___layout_-half"><div mxs="_zs_galleryb/:a" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">自定义key + 有分组（parents的key，value跟fields保持一致）</div></div><div mx-view="mx-indics/index?parents=';
    $line = 34;
    $art = '@[{\n                        id: 1, name: \'组1\'\n                    }, {\n                        id: 2, name: \'组2\'\n                    }]';
    ;
    ...
    $art = '@[1,2,3]';
    ;
    $p += ($expr = '<%@[1, 2, 3]%>', $i($$ref, [1, 2, 3])) + '"></div></div></div></div><div mxa="_zs_galleryb/:e" class="clearfix"><div mxa="_zs_galleryb/:f" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryb/:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 62;
    $art = '=viewId';
    ;
