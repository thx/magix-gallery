...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_idbujffze$art_i = 0, $art_cszqxzeng$art_c = customs.length; $art_idbujffze$art_i < $art_cszqxzeng$art_c; $art_idbujffze$art_i++) {        var key = customs[$art_idbujffze$art_i]%>';
        for (var $art_idbujffze$art_i = 0, $art_cszqxzeng$art_c = customs.length; $art_idbujffze$art_i < $art_cszqxzeng$art_c; $art_idbujffze$art_i++) {
            var key = customs[$art_idbujffze$art_i];
        ...
        ;
        $expr = '<%for (var $art_ibwxxnhrwi$art_i = 0, $art_codheckda$art_c = defaults.length; $art_ibwxxnhrwi$art_i < $art_codheckda$art_c; $art_ibwxxnhrwi$art_i++) {        var key = defaults[$art_ibwxxnhrwi$art_i]%>';
        for (var $art_ibwxxnhrwi$art_i = 0, $art_codheckda$art_c = defaults.length; $art_ibwxxnhrwi$art_i < $art_codheckda$art_c; $art_ibwxxnhrwi$art_i++) {
            var key = defaults[$art_ibwxxnhrwi$art_i];
