...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_ilekizd$art_i = 0, $art_cdwcsryf$art_c = customs.length; $art_ilekizd$art_i < $art_cdwcsryf$art_c; $art_ilekizd$art_i++) {        var key = customs[$art_ilekizd$art_i]%>';
        for (var $art_ilekizd$art_i = 0, $art_cdwcsryf$art_c = customs.length; $art_ilekizd$art_i < $art_cdwcsryf$art_c; $art_ilekizd$art_i++) {
            var key = customs[$art_ilekizd$art_i];
        ...
        ;
        $expr = '<%for (var $art_imflhfldy$art_i = 0, $art_comsvnbk$art_c = defaults.length; $art_imflhfldy$art_i < $art_comsvnbk$art_c; $art_imflhfldy$art_i++) {        var key = defaults[$art_imflhfldy$art_i]%>';
        for (var $art_imflhfldy$art_i = 0, $art_comsvnbk$art_c = defaults.length; $art_imflhfldy$art_i < $art_comsvnbk$art_c; $art_imflhfldy$art_i++) {
            var key = defaults[$art_imflhfldy$art_i];
