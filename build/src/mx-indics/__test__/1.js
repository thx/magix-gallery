...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_iomasmz$art_i = 0, $art_cbfjtolw$art_c = customs.length; $art_iomasmz$art_i < $art_cbfjtolw$art_c; $art_iomasmz$art_i++) {        var key = customs[$art_iomasmz$art_i]%>';
        for (var $art_iomasmz$art_i = 0, $art_cbfjtolw$art_c = customs.length; $art_iomasmz$art_i < $art_cbfjtolw$art_c; $art_iomasmz$art_i++) {
            var key = customs[$art_iomasmz$art_i];
        ...
        ;
        $expr = '<%for (var $art_ityceircs$art_i = 0, $art_crjhpibn$art_c = defaults.length; $art_ityceircs$art_i < $art_crjhpibn$art_c; $art_ityceircs$art_i++) {        var key = defaults[$art_ityceircs$art_i]%>';
        for (var $art_ityceircs$art_i = 0, $art_crjhpibn$art_c = defaults.length; $art_ityceircs$art_i < $art_crjhpibn$art_c; $art_ityceircs$art_i++) {
            var key = defaults[$art_ityceircs$art_i];
