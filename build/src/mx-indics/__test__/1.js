...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_itzurwolhj$art_i = 0, $art_cjutipufbl$art_c = customs.length; $art_itzurwolhj$art_i < $art_cjutipufbl$art_c; $art_itzurwolhj$art_i++) {        var key = customs[$art_itzurwolhj$art_i]%>';
        for (var $art_itzurwolhj$art_i = 0, $art_cjutipufbl$art_c = customs.length; $art_itzurwolhj$art_i < $art_cjutipufbl$art_c; $art_itzurwolhj$art_i++) {
            var key = customs[$art_itzurwolhj$art_i];
        ...
        ;
        $expr = '<%for (var $art_ikeuqtvumf$art_i = 0, $art_cyrtvjtj$art_c = defaults.length; $art_ikeuqtvumf$art_i < $art_cyrtvjtj$art_c; $art_ikeuqtvumf$art_i++) {        var key = defaults[$art_ikeuqtvumf$art_i]%>';
        for (var $art_ikeuqtvumf$art_i = 0, $art_cyrtvjtj$art_c = defaults.length; $art_ikeuqtvumf$art_i < $art_cyrtvjtj$art_c; $art_ikeuqtvumf$art_i++) {
            var key = defaults[$art_ikeuqtvumf$art_i];
    ...
    ;
    $p += '</div></div></div></div><div mxa="_zs_galleryco:j" class="clearfix"><div mxa="_zs_galleryco:k" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third1"><div mxs="_zs_galleryco:f" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 52;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_1"><span mxa="_zs_galleryco:l" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 54;
    $art = '!text1';
    ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;mx-indics \n    parents="&#123;&#123;@parents&#125;&#125;" \n    fields="&#123;&#123;@fields&#125;&#125;" \n    defaults="&#123;&#123;@defaults&#125;&#125;"\n    custom="&#123;&#123;=custom&#125;&#125;"\n    customs="&#123;&#123;@customs&#125;&#125;"\n    sortable="true" \n    limit="4"\n    mx-change="change()"/&gt;</pre></div><div mxa="_zs_galleryco:m" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-third2 _zs_gallery___test___layout_-half-right"><div mxs="_zs_galleryco:h" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 70;
    $art = '=viewId';
    ;
    $p += ($expr = '<%!$eu(viewId)%>', $eu(viewId)) + '_text_2"><span mxa="_zs_galleryco:n" class="_zs_gallery___test___layout_-desc-tip">';
    $line = 72;
    $art = '!text2';
    ;
    $p += ($expr = '<%!text2%>', $n(text2)) + '</span><i mxs="_zs_galleryco:g" class="mc-iconfont _zs_gallery___test___layout_-desc-icon">&#xe610;</i></div><pre mx-view="__test__/hl" id="';
    $line = 75;
    $art = '=viewId';
    ;
