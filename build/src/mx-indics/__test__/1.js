...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_igmchvqapm$art_i = 0, $art_cxoawbhtmc$art_c = customs.length; $art_igmchvqapm$art_i < $art_cxoawbhtmc$art_c; $art_igmchvqapm$art_i++) {        var key = customs[$art_igmchvqapm$art_i]%>';
        for (var $art_igmchvqapm$art_i = 0, $art_cxoawbhtmc$art_c = customs.length; $art_igmchvqapm$art_i < $art_cxoawbhtmc$art_c; $art_igmchvqapm$art_i++) {
            var key = customs[$art_igmchvqapm$art_i];
        ...
        ;
        $expr = '<%for (var $art_ilmeaalps$art_i = 0, $art_cjrkjhdc$art_c = defaults.length; $art_ilmeaalps$art_i < $art_cjrkjhdc$art_c; $art_ilmeaalps$art_i++) {        var key = defaults[$art_ilmeaalps$art_i]%>';
        for (var $art_ilmeaalps$art_i = 0, $art_cjrkjhdc$art_c = defaults.length; $art_ilmeaalps$art_i < $art_cjrkjhdc$art_c; $art_ilmeaalps$art_i++) {
            var key = defaults[$art_ilmeaalps$art_i];
