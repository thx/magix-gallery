...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_iinqtqhmh$art_i = 0, $art_cslepjnobs$art_c = customs.length; $art_iinqtqhmh$art_i < $art_cslepjnobs$art_c; $art_iinqtqhmh$art_i++) {        var key = customs[$art_iinqtqhmh$art_i]%>';
        for (var $art_iinqtqhmh$art_i = 0, $art_cslepjnobs$art_c = customs.length; $art_iinqtqhmh$art_i < $art_cslepjnobs$art_c; $art_iinqtqhmh$art_i++) {
            var key = customs[$art_iinqtqhmh$art_i];
        ...
        ;
        $expr = '<%for (var $art_ijvuvzcoa$art_i = 0, $art_ccmwozu$art_c = defaults.length; $art_ijvuvzcoa$art_i < $art_ccmwozu$art_c; $art_ijvuvzcoa$art_i++) {        var key = defaults[$art_ijvuvzcoa$art_i]%>';
        for (var $art_ijvuvzcoa$art_i = 0, $art_ccmwozu$art_c = defaults.length; $art_ijvuvzcoa$art_i < $art_ccmwozu$art_c; $art_ijvuvzcoa$art_i++) {
            var key = defaults[$art_ijvuvzcoa$art_i];
