...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_iwnkdcfqlq$art_i = 0, $art_clumeg$art_c = customs.length; $art_iwnkdcfqlq$art_i < $art_clumeg$art_c; $art_iwnkdcfqlq$art_i++) {        var key = customs[$art_iwnkdcfqlq$art_i]%>';
        for (var $art_iwnkdcfqlq$art_i = 0, $art_clumeg$art_c = customs.length; $art_iwnkdcfqlq$art_i < $art_clumeg$art_c; $art_iwnkdcfqlq$art_i++) {
            var key = customs[$art_iwnkdcfqlq$art_i];
        ...
        ;
        $expr = '<%for (var $art_icyxnnuwb$art_i = 0, $art_cioucdohg$art_c = defaults.length; $art_icyxnnuwb$art_i < $art_cioucdohg$art_c; $art_icyxnnuwb$art_i++) {        var key = defaults[$art_icyxnnuwb$art_i]%>';
        for (var $art_icyxnnuwb$art_i = 0, $art_cioucdohg$art_c = defaults.length; $art_icyxnnuwb$art_i < $art_cioucdohg$art_c; $art_icyxnnuwb$art_i++) {
            var key = defaults[$art_icyxnnuwb$art_i];
