...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_ieusibrln$art_i = 0, $art_caorjmzp$art_c = customs.length; $art_ieusibrln$art_i < $art_caorjmzp$art_c; $art_ieusibrln$art_i++) {        var key = customs[$art_ieusibrln$art_i]%>';
        for (var $art_ieusibrln$art_i = 0, $art_caorjmzp$art_c = customs.length; $art_ieusibrln$art_i < $art_caorjmzp$art_c; $art_ieusibrln$art_i++) {
            var key = customs[$art_ieusibrln$art_i];
        ...
        ;
        $expr = '<%for (var $art_ixephmybt$art_i = 0, $art_cgustacceri$art_c = defaults.length; $art_ixephmybt$art_i < $art_cgustacceri$art_c; $art_ixephmybt$art_i++) {        var key = defaults[$art_ixephmybt$art_i]%>';
        for (var $art_ixephmybt$art_i = 0, $art_cgustacceri$art_c = defaults.length; $art_ixephmybt$art_i < $art_cgustacceri$art_c; $art_ixephmybt$art_i++) {
            var key = defaults[$art_ixephmybt$art_i];
