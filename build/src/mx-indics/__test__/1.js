...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_icwzemycryw$art_i = 0, $art_ccrutswuewu$art_c = customs.length; $art_icwzemycryw$art_i < $art_ccrutswuewu$art_c; $art_icwzemycryw$art_i++) {        var key = customs[$art_icwzemycryw$art_i]%>';
        for (var $art_icwzemycryw$art_i = 0, $art_ccrutswuewu$art_c = customs.length; $art_icwzemycryw$art_i < $art_ccrutswuewu$art_c; $art_icwzemycryw$art_i++) {
            var key = customs[$art_icwzemycryw$art_i];
        ...
        ;
        $expr = '<%for (var $art_izrxtgbtn$art_i = 0, $art_cnzbuouct$art_c = defaults.length; $art_izrxtgbtn$art_i < $art_cnzbuouct$art_c; $art_izrxtgbtn$art_i++) {        var key = defaults[$art_izrxtgbtn$art_i]%>';
        for (var $art_izrxtgbtn$art_i = 0, $art_cnzbuouct$art_c = defaults.length; $art_izrxtgbtn$art_i < $art_cnzbuouct$art_c; $art_izrxtgbtn$art_i++) {
            var key = defaults[$art_izrxtgbtn$art_i];
