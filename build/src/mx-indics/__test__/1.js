...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_inzivfng$art_i = 0, $art_cefelshs$art_c = customs.length; $art_inzivfng$art_i < $art_cefelshs$art_c; $art_inzivfng$art_i++) {        var key = customs[$art_inzivfng$art_i]%>';
        for (var $art_inzivfng$art_i = 0, $art_cefelshs$art_c = customs.length; $art_inzivfng$art_i < $art_cefelshs$art_c; $art_inzivfng$art_i++) {
            var key = customs[$art_inzivfng$art_i];
        ...
        ;
        $expr = '<%for (var $art_iiljjdhqwx$art_i = 0, $art_cuydvnfnlc$art_c = defaults.length; $art_iiljjdhqwx$art_i < $art_cuydvnfnlc$art_c; $art_iiljjdhqwx$art_i++) {        var key = defaults[$art_iiljjdhqwx$art_i]%>';
        for (var $art_iiljjdhqwx$art_i = 0, $art_cuydvnfnlc$art_c = defaults.length; $art_iiljjdhqwx$art_i < $art_cuydvnfnlc$art_c; $art_iiljjdhqwx$art_i++) {
            var key = defaults[$art_iiljjdhqwx$art_i];
