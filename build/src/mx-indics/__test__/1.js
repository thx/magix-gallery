...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_iuyjwwya$art_i = 0, $art_cyrzrwgwrv$art_c = customs.length; $art_iuyjwwya$art_i < $art_cyrzrwgwrv$art_c; $art_iuyjwwya$art_i++) {        var key = customs[$art_iuyjwwya$art_i]%>';
        for (var $art_iuyjwwya$art_i = 0, $art_cyrzrwgwrv$art_c = customs.length; $art_iuyjwwya$art_i < $art_cyrzrwgwrv$art_c; $art_iuyjwwya$art_i++) {
            var key = customs[$art_iuyjwwya$art_i];
        ...
        ;
        $expr = '<%for (var $art_ibhybhdd$art_i = 0, $art_chokfbdkt$art_c = defaults.length; $art_ibhybhdd$art_i < $art_chokfbdkt$art_c; $art_ibhybhdd$art_i++) {        var key = defaults[$art_ibhybhdd$art_i]%>';
        for (var $art_ibhybhdd$art_i = 0, $art_chokfbdkt$art_c = defaults.length; $art_ibhybhdd$art_i < $art_chokfbdkt$art_c; $art_ibhybhdd$art_i++) {
            var key = defaults[$art_ibhybhdd$art_i];
