...
module.exports = Magix.View.extend({
    ...
    $art = '@[{\n        name: \'使用示例\',\n        key: viewId + \'_demo\',\n        subs: [{\n            name: \'上限+排序+分组\',\n            key: viewId + \'_demo1\'\n        },{\n            name: \'不限制+不排序\',\n            key: viewId + \'_demo3\'\n        },{\n            name: \'不限制+排序\',\n            key: viewId + \'_demo2\'\n        },{\n            name: \'自定义key\',\n            key: viewId + \'_demo4\'\n        }]\n    }, {\n        name: \'API\',\n        key: viewId + \'_api\'\n    }, {\n        name: \'Event\',\n        key: viewId + \'_event\'\n    }]';
    ;
    $p += ($expr = '<%@[{            name: \'使用示例\',            key: viewId + \'_demo\',            subs: [{                    name: \'上限+排序+分组\',                    key: viewId + \'_demo1\'                }, {                    name: \'不限制+不排序\',                    key: viewId + \'_demo3\'                }, {                    name: \'不限制+排序\',                    key: viewId + \'_demo2\'                }, {                    name: \'自定义key\',                    key: viewId + \'_demo4\'                }]        }, {            name: \'API\',            key: viewId + \'_api\'        }, {            name: \'Event\',            key: viewId + \'_event\'        }]%>', $i($$ref, [{ name: '使用示例', key: viewId + '_demo', subs: [{ name: '上限+排序+分组', key: viewId + '_demo1' }, { name: '不限制+不排序', key: viewId + '_demo3' }, { name: '不限制+排序', key: viewId + '_demo2' }, { name: '自定义key', key: viewId + '_demo4' }] }, { name: 'API', key: viewId + '_api' }, { name: 'Event', key: viewId + '_event' }])) + '"></div><div mxs="_zs_gallerycC:_" mx-view="mx-title/second?content=%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B"></div><div mxa="_zs_gallerycC:a" class="clearfix mb20"><div mx-view="mx-indics/__test__/1" id="';
    $line = 27;
    $art = '=viewId';
    ;
