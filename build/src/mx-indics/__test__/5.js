...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_galleryb8:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_galleryb8:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryb8:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">不限制可选择个数 + 不排序</div></div><div mxa="_zs_galleryb8:b" class="mb20"><div mx-view="mx-indics/index?fields=';
    $line = 9;
    ...
    $art = '@[\'click\', \'coverage\']';
    ;
    $p += ($expr = '<%@[\'click\', \'coverage\']%>', $i($$ref, ['click', 'coverage'])) + '"></div></div></div><div mxa="_zs_galleryb8:c" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb8:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 33;
    $art = '=viewId';
    ;
