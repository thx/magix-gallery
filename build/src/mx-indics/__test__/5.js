...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallerydI:_" class="_zs_gallery___test___layout_-example"><div mxa="_zs_gallerydI:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_gallerydI:_" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">不限制可选择个数 + 不排序</div></div><div mxa="_zs_gallerydI:b" class="mb20"><div mx-view="mx-indics/index?fields=';
    $line = 9;
