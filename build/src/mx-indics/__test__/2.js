...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $expr = '<%for (var $art_ifjmeuxquf$art_i = 0, $art_chqfohfpv$art_c = customs.length; $art_ifjmeuxquf$art_i < $art_chqfohfpv$art_c; $art_ifjmeuxquf$art_i++) {        var key = customs[$art_ifjmeuxquf$art_i]%>';
        for (var $art_ifjmeuxquf$art_i = 0, $art_chqfohfpv$art_c = customs.length; $art_ifjmeuxquf$art_i < $art_chqfohfpv$art_c; $art_ifjmeuxquf$art_i++) {
            var key = customs[$art_ifjmeuxquf$art_i];
        ...
        ;
        $expr = '<%for (var $art_iipougsos$art_i = 0, $art_cmuqmdrovtg$art_c = defaults.length; $art_iipougsos$art_i < $art_cmuqmdrovtg$art_c; $art_iipougsos$art_i++) {        var key = defaults[$art_iipougsos$art_i]%>';
        for (var $art_iipougsos$art_i = 0, $art_cmuqmdrovtg$art_c = defaults.length; $art_iipougsos$art_i < $art_cmuqmdrovtg$art_c; $art_iipougsos$art_i++) {
            var key = defaults[$art_iipougsos$art_i];
