...
module.exports = Base.extend({
    ...
    $art = '@[2,3,4,5,6]';
    ;
    $p += ($expr = '<%@[2, 3, 4, 5, 6]%>', $i($$ref, [2, 3, 4, 5, 6])) + '&sortable=true"></div></div><div mxa="_zs_gallerycd:d" class="_zs_gallery___test___layout_-half"><div mxs="_zs_gallerycd:a" class="clearfix lh22 mb20"><div class="fl color-9">以下示例：</div><div class="fl">不限制可选择个数 + 指标可排序 + 有分组</div></div><div mx-view="mx-indics/index?parents=';
    $line = 43;
    $art = '@[{\n                        value: 1, text: \'组1\'\n                    }, {\n                        value: 2, text: \'组2\'\n                    }]';
    ;
    ...
    $art = '@[2,3,4,5,6]';
    ;
    $p += ($expr = '<%@[2, 3, 4, 5, 6]%>', $i($$ref, [2, 3, 4, 5, 6])) + '&sortable=true"></div></div></div></div><div mxa="_zs_gallerycd:e" class="clearfix"><div mxa="_zs_gallerycd:f" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_gallerycd:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 79;
    $art = '=viewId';
    ;
