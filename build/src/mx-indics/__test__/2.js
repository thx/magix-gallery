...
module.exports = Base.extend({
    ...
    if (custom) {
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_izwdhsgrjf$art_i = 0, $art_ctupkaaz$art_c = customs.length; $art_izwdhsgrjf$art_i < $art_ctupkaaz$art_c; $art_izwdhsgrjf$art_i++) {        var key = customs[$art_izwdhsgrjf$art_i]%>';
        for (var $art_izwdhsgrjf$art_i = 0, $art_ctupkaaz$art_c = customs.length; $art_izwdhsgrjf$art_i < $art_ctupkaaz$art_c; $art_izwdhsgrjf$art_i++) {
            var key = customs[$art_izwdhsgrjf$art_i];
        ...
        ;
        $p += '';
        $expr = '<%for (var $art_iasilllsmw$art_i = 0, $art_csnyzly$art_c = defaults.length; $art_iasilllsmw$art_i < $art_csnyzly$art_c; $art_iasilllsmw$art_i++) {        var key = defaults[$art_iasilllsmw$art_i]%>';
        for (var $art_iasilllsmw$art_i = 0, $art_csnyzly$art_c = defaults.length; $art_iasilllsmw$art_i < $art_csnyzly$art_c; $art_iasilllsmw$art_i++) {
            var key = defaults[$art_iasilllsmw$art_i];
