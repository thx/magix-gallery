...
module.exports = Magix.View.extend({
    ...
    $art = '=height';
    ;
    $p += '' + ($expr = '<%=height%>', $e(height)) + 'px;"><div mxa="_zs_gallery6:_" class="_zs_gallery_mx-carousel_index_-inner" mx-mouseover="' + $viewId + '@{stop}()" mx-mouseout="' + $viewId + '@{start}()">';
    $line = 5;
    $art = '!content';
    ;
    ...
    if (dots) {
        ...
        for (var i = 0; i < len; i += 1) {
            ;
            $p += '<li mxa="_zs_gallery6:a" class="_zs_gallery_mx-carousel_index_-dot-cnt"><i class="_zs_gallery_mx-carousel_index_-dot" mx-click="' + $viewId + '@{active}({idx:';
            $line = 13;
            $art = '=i';
            ;
            $p += '' + ($expr = '<%=i%>', $e(i)) + '})"></i></li>';
