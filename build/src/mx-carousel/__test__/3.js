...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery6:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallery6:_" class="_zs_gallery___test___base_-eg-content"><div class="mb20 clearfix"><div class="color-9 fl">以下示例：</div><div class="fl"><div>垂直方向切换</div><div>自动播放</div><div>显示面板指示点</div></div></div><div class="clearfix mb10"><div mx-view="mx-carousel/index?height=100&vertical=true&autoplay=true"><div style="position: absolute;" class="carousel-panel"><div class="_zs_gallery_mx-carousel___test___2_-bg">1</div></div><div style="position: absolute;" class="carousel-panel"><div class="_zs_gallery_mx-carousel___test___2_-bg">2</div></div><div style="position: absolute;" class="carousel-panel"><div class="_zs_gallery_mx-carousel___test___2_-bg">3</div></div></div></div></div><div mxa="_zs_gallery6:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallery6:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 28;
    $art = '=viewId';
    ;
