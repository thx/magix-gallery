...
module.exports = Base.extend({
    ...
    $p += '<div mxs="_zs_gallerya_:_" class="_zs_gallery_mx-carousel___test___demo_-wrapper"><div mx-view="mx-carousel/index?height=350&autoplay=true&mode=fade"><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___demo_-bg _zs_gallery_mx-carousel___test___demo_-bg1"></div></div><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___demo_-bg _zs_gallery_mx-carousel___test___demo_-bg2"></div></div><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___demo_-bg _zs_gallery_mx-carousel___test___demo_-bg3"></div></div></div><div class="_zs_gallery_mx-carousel___test___demo_-login"></div></div><div mxa="_zs_gallerya_:_" class="_zs_gallery___test___layout_-example clearfix ml20"><div mxa="_zs_gallerya_:a" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-top-none _zs_gallery___test___layout_-half"><div mxs="_zs_gallerya_:a" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 20;
    $art = '=viewId';
    ;
