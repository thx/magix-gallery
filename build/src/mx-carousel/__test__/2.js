...
module.exports = Base.extend({
    ...
    $p += '<div mxa="_zs_gallery6:_" class="_zs_gallery___test___base_-example"><div mxs="_zs_gallery6:_" class="_zs_gallery___test___base_-eg-content"><div class="mb20 clearfix"><div class="color-9 fl">以下示例：</div><div class="fl"><div>左右切换</div><div>自动播放，hover时停止自动播放，移出恢复自动播放</div><div>默认第二帧（active="1"，从0开始）</div><div>显示面板指示点</div></div></div><div class="clearfix mb10"><div mx-view="mx-carousel/index?height=100&autoplay=true&active=1"><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___2_-bg">1</div></div><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___2_-bg">2</div></div><div data-carousel="true"><div class="_zs_gallery_mx-carousel___test___2_-bg">3</div></div></div></div></div><div mxa="_zs_gallery6:a" class="_zs_gallery___test___base_-eg-desc"><div mxs="_zs_gallery6:a" class="_zs_gallery___test___base_-eg-title">HTML Code</div><div class="_zs_gallery___test___base_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 29;
    $art = '=viewId';
    ;
