...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iudfqgsvrsh$art_i = 0, $art_ccaiolvcb$art_c = selected.length; $art_iudfqgsvrsh$art_i < $art_ccaiolvcb$art_c; $art_iudfqgsvrsh$art_i++) {    var s = selected[$art_iudfqgsvrsh$art_i]%>';
    for (var $art_iudfqgsvrsh$art_i = 0, $art_ccaiolvcb$art_c = selected.length; $art_iudfqgsvrsh$art_i < $art_ccaiolvcb$art_c; $art_iudfqgsvrsh$art_i++) {
        var s = selected[$art_iudfqgsvrsh$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
