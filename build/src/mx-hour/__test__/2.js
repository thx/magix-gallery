...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibdtnjujwd$art_i = 0, $art_cppwkbpxd$art_c = selected.length; $art_ibdtnjujwd$art_i < $art_cppwkbpxd$art_c; $art_ibdtnjujwd$art_i++) {    var s = selected[$art_ibdtnjujwd$art_i]%>';
    for (var $art_ibdtnjujwd$art_i = 0, $art_cppwkbpxd$art_c = selected.length; $art_ibdtnjujwd$art_i < $art_cppwkbpxd$art_c; $art_ibdtnjujwd$art_i++) {
        var s = selected[$art_ibdtnjujwd$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
