...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ihggmjj$art_i = 0, $art_cnakvgyj$art_c = selected.length; $art_ihggmjj$art_i < $art_cnakvgyj$art_c; $art_ihggmjj$art_i++) {    var s = selected[$art_ihggmjj$art_i]%>';
    for (var $art_ihggmjj$art_i = 0, $art_cnakvgyj$art_c = selected.length; $art_ihggmjj$art_i < $art_cnakvgyj$art_c; $art_ihggmjj$art_i++) {
        var s = selected[$art_ihggmjj$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
