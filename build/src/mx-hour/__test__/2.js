...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibtxaptcrocv$art_i = 0, $art_ceafrpwl$art_c = selected.length; $art_ibtxaptcrocv$art_i < $art_ceafrpwl$art_c; $art_ibtxaptcrocv$art_i++) {    var s = selected[$art_ibtxaptcrocv$art_i]%>';
    for (var $art_ibtxaptcrocv$art_i = 0, $art_ceafrpwl$art_c = selected.length; $art_ibtxaptcrocv$art_i < $art_ceafrpwl$art_c; $art_ibtxaptcrocv$art_i++) {
        var s = selected[$art_ibtxaptcrocv$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
    ...
    $art = '@selected';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '"></div></div><div mxa="_zs_gallerycj:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_gallerycj:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
