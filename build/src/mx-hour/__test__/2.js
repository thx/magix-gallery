...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iglooosgq$art_i = 0, $art_cottltmyyb$art_c = selected.length; $art_iglooosgq$art_i < $art_cottltmyyb$art_c; $art_iglooosgq$art_i++) {    var s = selected[$art_iglooosgq$art_i]%>';
    for (var $art_iglooosgq$art_i = 0, $art_cottltmyyb$art_c = selected.length; $art_iglooosgq$art_i < $art_cottltmyyb$art_c; $art_iglooosgq$art_i++) {
        var s = selected[$art_iglooosgq$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
