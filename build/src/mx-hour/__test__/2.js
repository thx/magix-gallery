...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iocudnfi$art_i = 0, $art_comyhlmeon$art_c = selected.length; $art_iocudnfi$art_i < $art_comyhlmeon$art_c; $art_iocudnfi$art_i++) {    var s = selected[$art_iocudnfi$art_i]%>';
    for (var $art_iocudnfi$art_i = 0, $art_comyhlmeon$art_c = selected.length; $art_iocudnfi$art_i < $art_comyhlmeon$art_c; $art_iocudnfi$art_i++) {
        var s = selected[$art_iocudnfi$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
