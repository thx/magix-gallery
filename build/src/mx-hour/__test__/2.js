...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_isgkjsb$art_i = 0, $art_crdgrok$art_c = selected.length; $art_isgkjsb$art_i < $art_crdgrok$art_c; $art_isgkjsb$art_i++) {    var s = selected[$art_isgkjsb$art_i]%>';
    for (var $art_isgkjsb$art_i = 0, $art_crdgrok$art_c = selected.length; $art_isgkjsb$art_i < $art_crdgrok$art_c; $art_isgkjsb$art_i++) {
        var s = selected[$art_isgkjsb$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
