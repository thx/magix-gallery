...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb`:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb`:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryb`:_" class="clearfix lh22 mb15"><div class="fl color-9">以下示例：</div><div class="fl"><div>每日单独选择</div><div>提供快捷操作</div></div></div><div mxa="_zs_galleryb`:b" class="mb20 clearfix"><div mxs="_zs_galleryb`:a" class="fl mr10"><a href="javascript:;" class="btn btn-brand" mx-click="' + $viewId + 'get()">获取选中值</a></div><div mxa="_zs_galleryb`:c" class="fl">';
    $line = 16;
    $art = 'each selected as s';
    ;
    $expr = '<%for (var $art_inepghtautad$art_i = 0, $art_cngulmxj$art_c = selected.length; $art_inepghtautad$art_i < $art_cngulmxj$art_c; $art_inepghtautad$art_i++) {    var s = selected[$art_inepghtautad$art_i]%>';
    for (var $art_inepghtautad$art_i = 0, $art_cngulmxj$art_c = selected.length; $art_inepghtautad$art_i < $art_cngulmxj$art_c; $art_inepghtautad$art_i++) {
        var s = selected[$art_inepghtautad$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
    ...
    $art = '@selected';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '"></div></div><div mxa="_zs_galleryb`:d" class="_zs_gallery___test___layout_-eg-desc"><div mxs="_zs_galleryb`:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 27;
    $art = '=viewId';
    ;
