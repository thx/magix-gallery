...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ifiedyqot$art_i = 0, $art_ckmnzfxx$art_c = selected.length; $art_ifiedyqot$art_i < $art_ckmnzfxx$art_c; $art_ifiedyqot$art_i++) {    var s = selected[$art_ifiedyqot$art_i]%>';
    for (var $art_ifiedyqot$art_i = 0, $art_ckmnzfxx$art_c = selected.length; $art_ifiedyqot$art_i < $art_ckmnzfxx$art_c; $art_ifiedyqot$art_i++) {
        var s = selected[$art_ifiedyqot$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
