...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioarjtblh$art_i = 0, $art_cfkafgo$art_c = selected.length; $art_ioarjtblh$art_i < $art_cfkafgo$art_c; $art_ioarjtblh$art_i++) {    var s = selected[$art_ioarjtblh$art_i]%>';
    for (var $art_ioarjtblh$art_i = 0, $art_cfkafgo$art_c = selected.length; $art_ioarjtblh$art_i < $art_cfkafgo$art_c; $art_ioarjtblh$art_i++) {
        var s = selected[$art_ioarjtblh$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
