...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilbhzbxls$art_i = 0, $art_crlhqjbkdpg$art_c = selected.length; $art_ilbhzbxls$art_i < $art_crlhqjbkdpg$art_c; $art_ilbhzbxls$art_i++) {    var s = selected[$art_ilbhzbxls$art_i]%>';
    for (var $art_ilbhzbxls$art_i = 0, $art_crlhqjbkdpg$art_c = selected.length; $art_ilbhzbxls$art_i < $art_crlhqjbkdpg$art_c; $art_ilbhzbxls$art_i++) {
        var s = selected[$art_ilbhzbxls$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
