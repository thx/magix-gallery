...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ibtpwwxii$art_i = 0, $art_ccbpjjidnr$art_c = selected.length; $art_ibtpwwxii$art_i < $art_ccbpjjidnr$art_c; $art_ibtpwwxii$art_i++) {    var s = selected[$art_ibtpwwxii$art_i]%>';
    for (var $art_ibtpwwxii$art_i = 0, $art_ccbpjjidnr$art_c = selected.length; $art_ibtpwwxii$art_i < $art_ccbpjjidnr$art_c; $art_ibtpwwxii$art_i++) {
        var s = selected[$art_ibtpwwxii$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
