...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iukwkzdo$art_i = 0, $art_ccpkvibax$art_c = selected.length; $art_iukwkzdo$art_i < $art_ccpkvibax$art_c; $art_iukwkzdo$art_i++) {    var s = selected[$art_iukwkzdo$art_i]%>';
    for (var $art_iukwkzdo$art_i = 0, $art_ccpkvibax$art_c = selected.length; $art_iukwkzdo$art_i < $art_ccpkvibax$art_c; $art_iukwkzdo$art_i++) {
        var s = selected[$art_iukwkzdo$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
