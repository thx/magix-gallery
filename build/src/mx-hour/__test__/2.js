...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igwzmmjov$art_i = 0, $art_cqcorch$art_c = selected.length; $art_igwzmmjov$art_i < $art_cqcorch$art_c; $art_igwzmmjov$art_i++) {    var s = selected[$art_igwzmmjov$art_i]%>';
    for (var $art_igwzmmjov$art_i = 0, $art_cqcorch$art_c = selected.length; $art_igwzmmjov$art_i < $art_cqcorch$art_c; $art_igwzmmjov$art_i++) {
        var s = selected[$art_igwzmmjov$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
