...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ioncfdqw$art_i = 0, $art_czyglkkxka$art_c = selected.length; $art_ioncfdqw$art_i < $art_czyglkkxka$art_c; $art_ioncfdqw$art_i++) {    var s = selected[$art_ioncfdqw$art_i]%>';
    for (var $art_ioncfdqw$art_i = 0, $art_czyglkkxka$art_c = selected.length; $art_ioncfdqw$art_i < $art_czyglkkxka$art_c; $art_ioncfdqw$art_i++) {
        var s = selected[$art_ioncfdqw$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
