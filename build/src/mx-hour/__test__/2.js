...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_igoxzzjvl$art_i = 0, $art_casysdbuyk$art_c = selected.length; $art_igoxzzjvl$art_i < $art_casysdbuyk$art_c; $art_igoxzzjvl$art_i++) {    var s = selected[$art_igoxzzjvl$art_i]%>';
    for (var $art_igoxzzjvl$art_i = 0, $art_casysdbuyk$art_c = selected.length; $art_igoxzzjvl$art_i < $art_casysdbuyk$art_c; $art_igoxzzjvl$art_i++) {
        var s = selected[$art_igoxzzjvl$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
