...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyuhkvmjno$art_i = 0, $art_cochstcmin$art_c = selected.length; $art_iyuhkvmjno$art_i < $art_cochstcmin$art_c; $art_iyuhkvmjno$art_i++) {    var s = selected[$art_iyuhkvmjno$art_i]%>';
    for (var $art_iyuhkvmjno$art_i = 0, $art_cochstcmin$art_c = selected.length; $art_iyuhkvmjno$art_i < $art_cochstcmin$art_c; $art_iyuhkvmjno$art_i++) {
        var s = selected[$art_iyuhkvmjno$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
