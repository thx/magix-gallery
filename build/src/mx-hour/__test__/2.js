...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iyfvxgasiqi$art_i = 0, $art_culhgwjb$art_c = selected.length; $art_iyfvxgasiqi$art_i < $art_culhgwjb$art_c; $art_iyfvxgasiqi$art_i++) {    var s = selected[$art_iyfvxgasiqi$art_i]%>';
    for (var $art_iyfvxgasiqi$art_i = 0, $art_culhgwjb$art_c = selected.length; $art_iyfvxgasiqi$art_i < $art_culhgwjb$art_c; $art_iyfvxgasiqi$art_i++) {
        var s = selected[$art_iyfvxgasiqi$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
