...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iduryudn$art_i = 0, $art_cxrirsbnpc$art_c = selected.length; $art_iduryudn$art_i < $art_cxrirsbnpc$art_c; $art_iduryudn$art_i++) {    var s = selected[$art_iduryudn$art_i]%>';
    for (var $art_iduryudn$art_i = 0, $art_cxrirsbnpc$art_c = selected.length; $art_iduryudn$art_i < $art_cxrirsbnpc$art_c; $art_iduryudn$art_i++) {
        var s = selected[$art_iduryudn$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
