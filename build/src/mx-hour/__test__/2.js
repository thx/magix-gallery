...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ilyodhvsy$art_i = 0, $art_cshykpzz$art_c = selected.length; $art_ilyodhvsy$art_i < $art_cshykpzz$art_c; $art_ilyodhvsy$art_i++) {    var s = selected[$art_ilyodhvsy$art_i]%>';
    for (var $art_ilyodhvsy$art_i = 0, $art_cshykpzz$art_c = selected.length; $art_ilyodhvsy$art_i < $art_cshykpzz$art_c; $art_ilyodhvsy$art_i++) {
        var s = selected[$art_ilyodhvsy$art_i];
        $p += '<div>';
        $line = 17;
        $art = '=s.name';
        ;
