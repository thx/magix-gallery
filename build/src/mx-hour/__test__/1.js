...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixuaupldrg$art_i = 0, $art_cxoximnu$art_c = selected.length; $art_ixuaupldrg$art_i < $art_cxoximnu$art_c; $art_ixuaupldrg$art_i++) {    var s = selected[$art_ixuaupldrg$art_i]%>';
    for (var $art_ixuaupldrg$art_i = 0, $art_cxoximnu$art_c = selected.length; $art_ixuaupldrg$art_i < $art_cxoximnu$art_c; $art_ixuaupldrg$art_i++) {
        var s = selected[$art_ixuaupldrg$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
