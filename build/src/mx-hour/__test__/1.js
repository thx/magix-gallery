...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_inztnid$art_i = 0, $art_cgueqoio$art_c = selected.length; $art_inztnid$art_i < $art_cgueqoio$art_c; $art_inztnid$art_i++) {    var s = selected[$art_inztnid$art_i]%>';
    for (var $art_inztnid$art_i = 0, $art_cgueqoio$art_c = selected.length; $art_inztnid$art_i < $art_cgueqoio$art_c; $art_inztnid$art_i++) {
        var s = selected[$art_inztnid$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
