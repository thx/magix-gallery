...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itpiolezcbs$art_i = 0, $art_cfytebjvie$art_c = selected.length; $art_itpiolezcbs$art_i < $art_cfytebjvie$art_c; $art_itpiolezcbs$art_i++) {    var s = selected[$art_itpiolezcbs$art_i]%>';
    for (var $art_itpiolezcbs$art_i = 0, $art_cfytebjvie$art_c = selected.length; $art_itpiolezcbs$art_i < $art_cfytebjvie$art_c; $art_itpiolezcbs$art_i++) {
        var s = selected[$art_itpiolezcbs$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
