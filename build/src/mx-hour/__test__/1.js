...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb9:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb9:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryb9:_" class="clearfix lh22 mb15"><div class="fl color-9">以下示例：</div><div class="fl"><div>极简模式（只区分工作日和双休日）</div><div>时间段btn快捷全选或反选</div><div>拖动连续选择</div><div>宽度随容器自适应，可配置提示信息</div></div></div><div mxa="_zs_galleryb9:b" class="mb20 clearfix"><div mxs="_zs_galleryb9:a" class="fl mr10"><a href="javascript:;" class="btn btn-brand" mx-click="' + $viewId + 'get()">获取选中值</a></div><div mxa="_zs_galleryb9:c" class="fl">';
    $line = 18;
    $art = 'each selected as s';
    ;
    $expr = '<%for (var $art_isdyoygisbg$art_i = 0, $art_cdzjrqqhvljv$art_c = selected.length; $art_isdyoygisbg$art_i < $art_cdzjrqqhvljv$art_c; $art_isdyoygisbg$art_i++) {    var s = selected[$art_isdyoygisbg$art_i]%>';
    for (var $art_isdyoygisbg$art_i = 0, $art_cdzjrqqhvljv$art_c = selected.length; $art_isdyoygisbg$art_i < $art_cdzjrqqhvljv$art_c; $art_isdyoygisbg$art_i++) {
        var s = selected[$art_isdyoygisbg$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
    ...
    $art = '=viewId';
    ;
    $p += ($expr = '<%=viewId%>', $e(viewId)) + '_text_1">\n&lt;div&gt;\n    &lt;a href="javascript:;" class="btn btn-brand"\n        mx-click="get()"&gt;获取选中值&lt;/a&gt;\n&lt;/div&gt;\n\n&lt;mx-hour id="&#123;&#123;=viewId&#125;&#125;_hour"\n    selected="&#123;&#123;@selected&#125;&#125;" \n    tip="蓝色为已选投放时段"/&gt;</pre></div><div mxa="_zs_galleryb9:g" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half _zs_gallery___test___layout_-half-right"><div mxs="_zs_galleryb9:d" class="_zs_gallery___test___layout_-eg-title">JS Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:2})" mx-view="mx-copy/index?copyNode=';
    $line = 47;
    $art = '=viewId';
    ;
