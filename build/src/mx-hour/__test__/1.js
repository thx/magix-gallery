...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ixkujriwk$art_i = 0, $art_casddde$art_c = selected.length; $art_ixkujriwk$art_i < $art_casddde$art_c; $art_ixkujriwk$art_i++) {    var s = selected[$art_ixkujriwk$art_i]%>';
    for (var $art_ixkujriwk$art_i = 0, $art_casddde$art_c = selected.length; $art_ixkujriwk$art_i < $art_casddde$art_c; $art_ixkujriwk$art_i++) {
        var s = selected[$art_ixkujriwk$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
