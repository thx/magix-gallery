...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ismbcpks$art_i = 0, $art_ccmfvdqyg$art_c = selected.length; $art_ismbcpks$art_i < $art_ccmfvdqyg$art_c; $art_ismbcpks$art_i++) {    var s = selected[$art_ismbcpks$art_i]%>';
    for (var $art_ismbcpks$art_i = 0, $art_ccmfvdqyg$art_c = selected.length; $art_ismbcpks$art_i < $art_ccmfvdqyg$art_c; $art_ismbcpks$art_i++) {
        var s = selected[$art_ismbcpks$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
