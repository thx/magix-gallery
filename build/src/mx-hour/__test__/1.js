...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iejaxiv$art_i = 0, $art_cohcyte$art_c = selected.length; $art_iejaxiv$art_i < $art_cohcyte$art_c; $art_iejaxiv$art_i++) {    var s = selected[$art_iejaxiv$art_i]%>';
    for (var $art_iejaxiv$art_i = 0, $art_cohcyte$art_c = selected.length; $art_iejaxiv$art_i < $art_cohcyte$art_c; $art_iejaxiv$art_i++) {
        var s = selected[$art_iejaxiv$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
