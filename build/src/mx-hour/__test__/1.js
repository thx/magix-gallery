...
module.exports = Base.extend({
    ...
    $p += '<div mxv mxa="_zs_galleryb?:_" class="_zs_gallery___test___layout_-example"><div mxv mxa="_zs_galleryb?:a" class="_zs_gallery___test___layout_-eg-content"><div mxs="_zs_galleryb?:_" class="clearfix lh22 mb15"><div class="fl color-9">以下示例：</div><div class="fl"><div>极简模式（只区分工作日和双休日）</div><div>时间段btn快捷全选或反选</div><div>拖动连续选择</div><div>宽度随容器自适应，可配置提示信息</div></div></div><div mxa="_zs_galleryb?:b" class="mb20 clearfix"><div mxs="_zs_galleryb?:a" class="fl mr10"><a href="javascript:;" class="btn btn-brand" mx-click="' + $viewId + 'get()">获取选中值</a></div><div mxa="_zs_galleryb?:c" class="fl">';
    $line = 18;
    $art = 'each selected as s';
    ;
    $expr = '<%for (var $art_ijgiirxqsrin$art_i = 0, $art_cqnbkbsnm$art_c = selected.length; $art_ijgiirxqsrin$art_i < $art_cqnbkbsnm$art_c; $art_ijgiirxqsrin$art_i++) {    var s = selected[$art_ijgiirxqsrin$art_i]%>';
    for (var $art_ijgiirxqsrin$art_i = 0, $art_cqnbkbsnm$art_c = selected.length; $art_ijgiirxqsrin$art_i < $art_cqnbkbsnm$art_c; $art_ijgiirxqsrin$art_i++) {
        var s = selected[$art_ijgiirxqsrin$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
    ...
    $art = '@selected';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '&tip=%E8%93%9D%E8%89%B2%E4%B8%BA%E5%B7%B2%E9%80%89%E6%8A%95%E6%94%BE%E6%97%B6%E6%AE%B5"></div></div><div mxa="_zs_galleryb?:d" class="clearfix"><div mxa="_zs_galleryb?:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryb?:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 30;
    $art = '=viewId';
    ;
