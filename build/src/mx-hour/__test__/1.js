...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ireljpnpvq$art_i = 0, $art_clblgyjgp$art_c = selected.length; $art_ireljpnpvq$art_i < $art_clblgyjgp$art_c; $art_ireljpnpvq$art_i++) {    var s = selected[$art_ireljpnpvq$art_i]%>';
    for (var $art_ireljpnpvq$art_i = 0, $art_clblgyjgp$art_c = selected.length; $art_ireljpnpvq$art_i < $art_clblgyjgp$art_c; $art_ireljpnpvq$art_i++) {
        var s = selected[$art_ireljpnpvq$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
