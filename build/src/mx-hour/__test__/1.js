...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iarpgoegd$art_i = 0, $art_csjxfpkpe$art_c = selected.length; $art_iarpgoegd$art_i < $art_csjxfpkpe$art_c; $art_iarpgoegd$art_i++) {    var s = selected[$art_iarpgoegd$art_i]%>';
    for (var $art_iarpgoegd$art_i = 0, $art_csjxfpkpe$art_c = selected.length; $art_iarpgoegd$art_i < $art_csjxfpkpe$art_c; $art_iarpgoegd$art_i++) {
        var s = selected[$art_iarpgoegd$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
