...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iqadvavnbb$art_i = 0, $art_cqxkuz$art_c = selected.length; $art_iqadvavnbb$art_i < $art_cqxkuz$art_c; $art_iqadvavnbb$art_i++) {    var s = selected[$art_iqadvavnbb$art_i]%>';
    for (var $art_iqadvavnbb$art_i = 0, $art_cqxkuz$art_c = selected.length; $art_iqadvavnbb$art_i < $art_cqxkuz$art_c; $art_iqadvavnbb$art_i++) {
        var s = selected[$art_iqadvavnbb$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
