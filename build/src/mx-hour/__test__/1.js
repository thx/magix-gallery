...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iepqfkog$art_i = 0, $art_csfbraikfang$art_c = selected.length; $art_iepqfkog$art_i < $art_csfbraikfang$art_c; $art_iepqfkog$art_i++) {    var s = selected[$art_iepqfkog$art_i]%>';
    for (var $art_iepqfkog$art_i = 0, $art_csfbraikfang$art_c = selected.length; $art_iepqfkog$art_i < $art_csfbraikfang$art_c; $art_iepqfkog$art_i++) {
        var s = selected[$art_iepqfkog$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
