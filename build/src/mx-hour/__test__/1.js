...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ieypihicn$art_i = 0, $art_cxmufxay$art_c = selected.length; $art_ieypihicn$art_i < $art_cxmufxay$art_c; $art_ieypihicn$art_i++) {    var s = selected[$art_ieypihicn$art_i]%>';
    for (var $art_ieypihicn$art_i = 0, $art_cxmufxay$art_c = selected.length; $art_ieypihicn$art_i < $art_cxmufxay$art_c; $art_ieypihicn$art_i++) {
        var s = selected[$art_ieypihicn$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
