...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iirczxlyp$art_i = 0, $art_cbasqdmfo$art_c = selected.length; $art_iirczxlyp$art_i < $art_cbasqdmfo$art_c; $art_iirczxlyp$art_i++) {    var s = selected[$art_iirczxlyp$art_i]%>';
    for (var $art_iirczxlyp$art_i = 0, $art_cbasqdmfo$art_c = selected.length; $art_iirczxlyp$art_i < $art_cbasqdmfo$art_c; $art_iirczxlyp$art_i++) {
        var s = selected[$art_iirczxlyp$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
