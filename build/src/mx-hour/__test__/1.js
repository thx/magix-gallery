...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_ianbbjzml$art_i = 0, $art_cpojohuncf$art_c = selected.length; $art_ianbbjzml$art_i < $art_cpojohuncf$art_c; $art_ianbbjzml$art_i++) {    var s = selected[$art_ianbbjzml$art_i]%>';
    for (var $art_ianbbjzml$art_i = 0, $art_cpojohuncf$art_c = selected.length; $art_ianbbjzml$art_i < $art_cpojohuncf$art_c; $art_ianbbjzml$art_i++) {
        var s = selected[$art_ianbbjzml$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
