...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_iwltgfjar$art_i = 0, $art_cqeubny$art_c = selected.length; $art_iwltgfjar$art_i < $art_cqeubny$art_c; $art_iwltgfjar$art_i++) {    var s = selected[$art_iwltgfjar$art_i]%>';
    for (var $art_iwltgfjar$art_i = 0, $art_cqeubny$art_c = selected.length; $art_iwltgfjar$art_i < $art_cqeubny$art_c; $art_iwltgfjar$art_i++) {
        var s = selected[$art_iwltgfjar$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
