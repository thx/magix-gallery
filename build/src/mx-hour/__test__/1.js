...
module.exports = Base.extend({
    ...
    ;
    $expr = '<%for (var $art_itauzitixmt$art_i = 0, $art_ciuhgzlyfhg$art_c = selected.length; $art_itauzitixmt$art_i < $art_ciuhgzlyfhg$art_c; $art_itauzitixmt$art_i++) {    var s = selected[$art_itauzitixmt$art_i]%>';
    for (var $art_itauzitixmt$art_i = 0, $art_ciuhgzlyfhg$art_c = selected.length; $art_itauzitixmt$art_i < $art_ciuhgzlyfhg$art_c; $art_itauzitixmt$art_i++) {
        var s = selected[$art_itauzitixmt$art_i];
        $p += '<div>';
        $line = 19;
        $art = '=s.name';
        ;
    ...
    $art = '@selected';
    ;
    $p += ($expr = '<%@selected%>', $i($$ref, selected)) + '&tip=%E8%93%9D%E8%89%B2%E4%B8%BA%E5%B7%B2%E9%80%89%E6%8A%95%E6%94%BE%E6%97%B6%E6%AE%B5"></div></div><div mxa="_zs_galleryci:d" class="clearfix"><div mxa="_zs_galleryci:e" class="_zs_gallery___test___layout_-eg-desc _zs_gallery___test___layout_-half"><div mxs="_zs_galleryci:b" class="_zs_gallery___test___layout_-eg-title">HTML Code</div><div class="_zs_gallery___test___layout_-desc-oper" mx-success="' + $viewId + 'done({id:1})" mx-view="mx-copy/index?copyNode=';
    $line = 30;
    $art = '=viewId';
    ;
