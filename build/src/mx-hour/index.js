...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iaeizshigh$art_i = 0, $art_ckckhfacqk$art_c = types.length; $art_iaeizshigh$art_i < $art_ckckhfacqk$art_c; $art_iaeizshigh$art_i++) {        var t = types[$art_iaeizshigh$art_i]%>';
        for (var $art_iaeizshigh$art_i = 0, $art_ckckhfacqk$art_c = types.length; $art_iaeizshigh$art_i < $art_ckckhfacqk$art_c; $art_iaeizshigh$art_i++) {
            var t = types[$art_iaeizshigh$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_czvgyxrk$art_c = periods.length; pIndex < $art_czvgyxrk$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_czvgyxrk$art_c = periods.length; pIndex < $art_czvgyxrk$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_izeqsuwgmzs$art_i = 0, $art_objvbihmliurjb$art_obj = p.hours, $art_ceavwitfef$art_c = $art_objvbihmliurjb$art_obj.length; $art_izeqsuwgmzs$art_i < $art_ceavwitfef$art_c; $art_izeqsuwgmzs$art_i++) {        var h = $art_objvbihmliurjb$art_obj[$art_izeqsuwgmzs$art_i]%>';
        for (var $art_izeqsuwgmzs$art_i = 0, $art_objvbihmliurjb$art_obj = p.hours, $art_ceavwitfef$art_c = $art_objvbihmliurjb$art_obj.length; $art_izeqsuwgmzs$art_i < $art_ceavwitfef$art_c; $art_izeqsuwgmzs$art_i++) {
            var h = $art_objvbihmliurjb$art_obj[$art_izeqsuwgmzs$art_i];
