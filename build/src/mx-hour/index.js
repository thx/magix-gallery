...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibkcmrxj$art_i = 0, $art_crzvpwxnxi$art_c = types.length; $art_ibkcmrxj$art_i < $art_crzvpwxnxi$art_c; $art_ibkcmrxj$art_i++) {        var t = types[$art_ibkcmrxj$art_i]%>';
        for (var $art_ibkcmrxj$art_i = 0, $art_crzvpwxnxi$art_c = types.length; $art_ibkcmrxj$art_i < $art_crzvpwxnxi$art_c; $art_ibkcmrxj$art_i++) {
            var t = types[$art_ibkcmrxj$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cxrlmmkj$art_c = periods.length; pIndex < $art_cxrlmmkj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cxrlmmkj$art_c = periods.length; pIndex < $art_cxrlmmkj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iagmyfiow$art_i = 0, $art_objnrgzspgeh$art_obj = p.hours, $art_comcteqfx$art_c = $art_objnrgzspgeh$art_obj.length; $art_iagmyfiow$art_i < $art_comcteqfx$art_c; $art_iagmyfiow$art_i++) {        var h = $art_objnrgzspgeh$art_obj[$art_iagmyfiow$art_i]%>';
        for (var $art_iagmyfiow$art_i = 0, $art_objnrgzspgeh$art_obj = p.hours, $art_comcteqfx$art_c = $art_objnrgzspgeh$art_obj.length; $art_iagmyfiow$art_i < $art_comcteqfx$art_c; $art_iagmyfiow$art_i++) {
            var h = $art_objnrgzspgeh$art_obj[$art_iagmyfiow$art_i];
