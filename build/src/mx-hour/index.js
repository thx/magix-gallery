...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_istwzxkhlb$art_i = 0, $art_cdcpts$art_c = types.length; $art_istwzxkhlb$art_i < $art_cdcpts$art_c; $art_istwzxkhlb$art_i++) {        var t = types[$art_istwzxkhlb$art_i]%>';
        for (var $art_istwzxkhlb$art_i = 0, $art_cdcpts$art_c = types.length; $art_istwzxkhlb$art_i < $art_cdcpts$art_c; $art_istwzxkhlb$art_i++) {
            var t = types[$art_istwzxkhlb$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cactdjsjz$art_c = periods.length; pIndex < $art_cactdjsjz$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cactdjsjz$art_c = periods.length; pIndex < $art_cactdjsjz$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ihvfphiiq$art_i = 0, $art_objszirglesr$art_obj = p.hours, $art_cbtkwwdco$art_c = $art_objszirglesr$art_obj.length; $art_ihvfphiiq$art_i < $art_cbtkwwdco$art_c; $art_ihvfphiiq$art_i++) {        var h = $art_objszirglesr$art_obj[$art_ihvfphiiq$art_i]%>';
        for (var $art_ihvfphiiq$art_i = 0, $art_objszirglesr$art_obj = p.hours, $art_cbtkwwdco$art_c = $art_objszirglesr$art_obj.length; $art_ihvfphiiq$art_i < $art_cbtkwwdco$art_c; $art_ihvfphiiq$art_i++) {
            var h = $art_objszirglesr$art_obj[$art_ihvfphiiq$art_i];
