...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iatanisah$art_i = 0, $art_crmsfddj$art_c = types.length; $art_iatanisah$art_i < $art_crmsfddj$art_c; $art_iatanisah$art_i++) {        var t = types[$art_iatanisah$art_i]%>';
        for (var $art_iatanisah$art_i = 0, $art_crmsfddj$art_c = types.length; $art_iatanisah$art_i < $art_crmsfddj$art_c; $art_iatanisah$art_i++) {
            var t = types[$art_iatanisah$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cwoqyiwamm$art_c = periods.length; pIndex < $art_cwoqyiwamm$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cwoqyiwamm$art_c = periods.length; pIndex < $art_cwoqyiwamm$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iizboxkik$art_i = 0, $art_objujhgjura$art_obj = p.hours, $art_cgzibk$art_c = $art_objujhgjura$art_obj.length; $art_iizboxkik$art_i < $art_cgzibk$art_c; $art_iizboxkik$art_i++) {        var h = $art_objujhgjura$art_obj[$art_iizboxkik$art_i]%>';
        for (var $art_iizboxkik$art_i = 0, $art_objujhgjura$art_obj = p.hours, $art_cgzibk$art_c = $art_objujhgjura$art_obj.length; $art_iizboxkik$art_i < $art_cgzibk$art_c; $art_iizboxkik$art_i++) {
            var h = $art_objujhgjura$art_obj[$art_iizboxkik$art_i];
