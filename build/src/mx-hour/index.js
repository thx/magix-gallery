...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ifpkidrff$art_i = 0, $art_cngyhcxe$art_c = types.length; $art_ifpkidrff$art_i < $art_cngyhcxe$art_c; $art_ifpkidrff$art_i++) {        var t = types[$art_ifpkidrff$art_i]%>';
        for (var $art_ifpkidrff$art_i = 0, $art_cngyhcxe$art_c = types.length; $art_ifpkidrff$art_i < $art_cngyhcxe$art_c; $art_ifpkidrff$art_i++) {
            var t = types[$art_ifpkidrff$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cvzvttmhzl$art_c = periods.length; pIndex < $art_cvzvttmhzl$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cvzvttmhzl$art_c = periods.length; pIndex < $art_cvzvttmhzl$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_izlszhnq$art_i = 0, $art_objeurowo$art_obj = p.hours, $art_cpqlu$art_c = $art_objeurowo$art_obj.length; $art_izlszhnq$art_i < $art_cpqlu$art_c; $art_izlszhnq$art_i++) {        var h = $art_objeurowo$art_obj[$art_izlszhnq$art_i]%>';
        for (var $art_izlszhnq$art_i = 0, $art_objeurowo$art_obj = p.hours, $art_cpqlu$art_c = $art_objeurowo$art_obj.length; $art_izlszhnq$art_i < $art_cpqlu$art_c; $art_izlszhnq$art_i++) {
            var h = $art_objeurowo$art_obj[$art_izlszhnq$art_i];
