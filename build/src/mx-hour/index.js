...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iypahuk$art_i = 0, $art_cbscyu$art_c = types.length; $art_iypahuk$art_i < $art_cbscyu$art_c; $art_iypahuk$art_i++) {        var t = types[$art_iypahuk$art_i]%>';
        for (var $art_iypahuk$art_i = 0, $art_cbscyu$art_c = types.length; $art_iypahuk$art_i < $art_cbscyu$art_c; $art_iypahuk$art_i++) {
            var t = types[$art_iypahuk$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cvhvghhensb$art_c = periods.length; pIndex < $art_cvhvghhensb$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cvhvghhensb$art_c = periods.length; pIndex < $art_cvhvghhensb$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixjffacsg$art_i = 0, $art_objxyvnsmmpv$art_obj = p.hours, $art_cmhvucttl$art_c = $art_objxyvnsmmpv$art_obj.length; $art_ixjffacsg$art_i < $art_cmhvucttl$art_c; $art_ixjffacsg$art_i++) {        var h = $art_objxyvnsmmpv$art_obj[$art_ixjffacsg$art_i]%>';
        for (var $art_ixjffacsg$art_i = 0, $art_objxyvnsmmpv$art_obj = p.hours, $art_cmhvucttl$art_c = $art_objxyvnsmmpv$art_obj.length; $art_ixjffacsg$art_i < $art_cmhvucttl$art_c; $art_ixjffacsg$art_i++) {
            var h = $art_objxyvnsmmpv$art_obj[$art_ixjffacsg$art_i];
