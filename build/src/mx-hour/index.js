...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_icenhop$art_i = 0, $art_cgddojk$art_c = types.length; $art_icenhop$art_i < $art_cgddojk$art_c; $art_icenhop$art_i++) {        var t = types[$art_icenhop$art_i]%>';
        for (var $art_icenhop$art_i = 0, $art_cgddojk$art_c = types.length; $art_icenhop$art_i < $art_cgddojk$art_c; $art_icenhop$art_i++) {
            var t = types[$art_icenhop$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_civasacfqc$art_c = periods.length; pIndex < $art_civasacfqc$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_civasacfqc$art_c = periods.length; pIndex < $art_civasacfqc$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igapcedy$art_i = 0, $art_objphhugxo$art_obj = p.hours, $art_cnlwmrxbsii$art_c = $art_objphhugxo$art_obj.length; $art_igapcedy$art_i < $art_cnlwmrxbsii$art_c; $art_igapcedy$art_i++) {        var h = $art_objphhugxo$art_obj[$art_igapcedy$art_i]%>';
        for (var $art_igapcedy$art_i = 0, $art_objphhugxo$art_obj = p.hours, $art_cnlwmrxbsii$art_c = $art_objphhugxo$art_obj.length; $art_igapcedy$art_i < $art_cnlwmrxbsii$art_c; $art_igapcedy$art_i++) {
            var h = $art_objphhugxo$art_obj[$art_igapcedy$art_i];
