...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ileyawgc$art_i = 0, $art_cghlqamh$art_c = types.length; $art_ileyawgc$art_i < $art_cghlqamh$art_c; $art_ileyawgc$art_i++) {        var t = types[$art_ileyawgc$art_i]%>';
        for (var $art_ileyawgc$art_i = 0, $art_cghlqamh$art_c = types.length; $art_ileyawgc$art_i < $art_cghlqamh$art_c; $art_ileyawgc$art_i++) {
            var t = types[$art_ileyawgc$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cbvpxhfqv$art_c = periods.length; pIndex < $art_cbvpxhfqv$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cbvpxhfqv$art_c = periods.length; pIndex < $art_cbvpxhfqv$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ioqlvmtbyx$art_i = 0, $art_objdlmthah$art_obj = p.hours, $art_curgrxiiun$art_c = $art_objdlmthah$art_obj.length; $art_ioqlvmtbyx$art_i < $art_curgrxiiun$art_c; $art_ioqlvmtbyx$art_i++) {        var h = $art_objdlmthah$art_obj[$art_ioqlvmtbyx$art_i]%>';
        for (var $art_ioqlvmtbyx$art_i = 0, $art_objdlmthah$art_obj = p.hours, $art_curgrxiiun$art_c = $art_objdlmthah$art_obj.length; $art_ioqlvmtbyx$art_i < $art_curgrxiiun$art_c; $art_ioqlvmtbyx$art_i++) {
            var h = $art_objdlmthah$art_obj[$art_ioqlvmtbyx$art_i];
