...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibnbgjbxeo$art_i = 0, $art_ctktic$art_c = types.length; $art_ibnbgjbxeo$art_i < $art_ctktic$art_c; $art_ibnbgjbxeo$art_i++) {        var t = types[$art_ibnbgjbxeo$art_i]%>';
        for (var $art_ibnbgjbxeo$art_i = 0, $art_ctktic$art_c = types.length; $art_ibnbgjbxeo$art_i < $art_ctktic$art_c; $art_ibnbgjbxeo$art_i++) {
            var t = types[$art_ibnbgjbxeo$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cjogsodnmb$art_c = periods.length; pIndex < $art_cjogsodnmb$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cjogsodnmb$art_c = periods.length; pIndex < $art_cjogsodnmb$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixgzliwzhe$art_i = 0, $art_objquuwbemqe$art_obj = p.hours, $art_ccesnzqi$art_c = $art_objquuwbemqe$art_obj.length; $art_ixgzliwzhe$art_i < $art_ccesnzqi$art_c; $art_ixgzliwzhe$art_i++) {        var h = $art_objquuwbemqe$art_obj[$art_ixgzliwzhe$art_i]%>';
        for (var $art_ixgzliwzhe$art_i = 0, $art_objquuwbemqe$art_obj = p.hours, $art_ccesnzqi$art_c = $art_objquuwbemqe$art_obj.length; $art_ixgzliwzhe$art_i < $art_ccesnzqi$art_c; $art_ixgzliwzhe$art_i++) {
            var h = $art_objquuwbemqe$art_obj[$art_ixgzliwzhe$art_i];
