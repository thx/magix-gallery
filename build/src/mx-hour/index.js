...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ilgdopsayp$art_i = 0, $art_csmyqjya$art_c = types.length; $art_ilgdopsayp$art_i < $art_csmyqjya$art_c; $art_ilgdopsayp$art_i++) {        var t = types[$art_ilgdopsayp$art_i]%>';
        for (var $art_ilgdopsayp$art_i = 0, $art_csmyqjya$art_c = types.length; $art_ilgdopsayp$art_i < $art_csmyqjya$art_c; $art_ilgdopsayp$art_i++) {
            var t = types[$art_ilgdopsayp$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cmvudsermk$art_c = periods.length; pIndex < $art_cmvudsermk$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cmvudsermk$art_c = periods.length; pIndex < $art_cmvudsermk$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivnyhqbpjp$art_i = 0, $art_objyweoas$art_obj = p.hours, $art_cfebof$art_c = $art_objyweoas$art_obj.length; $art_ivnyhqbpjp$art_i < $art_cfebof$art_c; $art_ivnyhqbpjp$art_i++) {        var h = $art_objyweoas$art_obj[$art_ivnyhqbpjp$art_i]%>';
        for (var $art_ivnyhqbpjp$art_i = 0, $art_objyweoas$art_obj = p.hours, $art_cfebof$art_c = $art_objyweoas$art_obj.length; $art_ivnyhqbpjp$art_i < $art_cfebof$art_c; $art_ivnyhqbpjp$art_i++) {
            var h = $art_objyweoas$art_obj[$art_ivnyhqbpjp$art_i];
