...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ioeafayiw$art_i = 0, $art_cnkwdogwwk$art_c = types.length; $art_ioeafayiw$art_i < $art_cnkwdogwwk$art_c; $art_ioeafayiw$art_i++) {        var t = types[$art_ioeafayiw$art_i]%>';
        for (var $art_ioeafayiw$art_i = 0, $art_cnkwdogwwk$art_c = types.length; $art_ioeafayiw$art_i < $art_cnkwdogwwk$art_c; $art_ioeafayiw$art_i++) {
            var t = types[$art_ioeafayiw$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_camsqwxvep$art_c = periods.length; pIndex < $art_camsqwxvep$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_camsqwxvep$art_c = periods.length; pIndex < $art_camsqwxvep$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibwdhagqoy$art_i = 0, $art_objgseabnuj$art_obj = p.hours, $art_cieadrtoakg$art_c = $art_objgseabnuj$art_obj.length; $art_ibwdhagqoy$art_i < $art_cieadrtoakg$art_c; $art_ibwdhagqoy$art_i++) {        var h = $art_objgseabnuj$art_obj[$art_ibwdhagqoy$art_i]%>';
        for (var $art_ibwdhagqoy$art_i = 0, $art_objgseabnuj$art_obj = p.hours, $art_cieadrtoakg$art_c = $art_objgseabnuj$art_obj.length; $art_ibwdhagqoy$art_i < $art_cieadrtoakg$art_c; $art_ibwdhagqoy$art_i++) {
            var h = $art_objgseabnuj$art_obj[$art_ibwdhagqoy$art_i];
