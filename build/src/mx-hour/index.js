...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iptitmfon$art_i = 0, $art_cnmhyhrtlc$art_c = types.length; $art_iptitmfon$art_i < $art_cnmhyhrtlc$art_c; $art_iptitmfon$art_i++) {        var t = types[$art_iptitmfon$art_i]%>';
        for (var $art_iptitmfon$art_i = 0, $art_cnmhyhrtlc$art_c = types.length; $art_iptitmfon$art_i < $art_cnmhyhrtlc$art_c; $art_iptitmfon$art_i++) {
            var t = types[$art_iptitmfon$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cdelnlksk$art_c = periods.length; pIndex < $art_cdelnlksk$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cdelnlksk$art_c = periods.length; pIndex < $art_cdelnlksk$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_inxolkmex$art_i = 0, $art_objcdylgxu$art_obj = p.hours, $art_crlowmaes$art_c = $art_objcdylgxu$art_obj.length; $art_inxolkmex$art_i < $art_crlowmaes$art_c; $art_inxolkmex$art_i++) {        var h = $art_objcdylgxu$art_obj[$art_inxolkmex$art_i]%>';
        for (var $art_inxolkmex$art_i = 0, $art_objcdylgxu$art_obj = p.hours, $art_crlowmaes$art_c = $art_objcdylgxu$art_obj.length; $art_inxolkmex$art_i < $art_crlowmaes$art_c; $art_inxolkmex$art_i++) {
            var h = $art_objcdylgxu$art_obj[$art_inxolkmex$art_i];
