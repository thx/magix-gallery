...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ishbor$art_i = 0, $art_cgkcpebim$art_c = types.length; $art_ishbor$art_i < $art_cgkcpebim$art_c; $art_ishbor$art_i++) {        var t = types[$art_ishbor$art_i]%>';
        for (var $art_ishbor$art_i = 0, $art_cgkcpebim$art_c = types.length; $art_ishbor$art_i < $art_cgkcpebim$art_c; $art_ishbor$art_i++) {
            var t = types[$art_ishbor$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_capjjaqnqu$art_c = periods.length; pIndex < $art_capjjaqnqu$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_capjjaqnqu$art_c = periods.length; pIndex < $art_capjjaqnqu$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ikwkigqcoj$art_i = 0, $art_objrtswsth$art_obj = p.hours, $art_ctwxcxvhrj$art_c = $art_objrtswsth$art_obj.length; $art_ikwkigqcoj$art_i < $art_ctwxcxvhrj$art_c; $art_ikwkigqcoj$art_i++) {        var h = $art_objrtswsth$art_obj[$art_ikwkigqcoj$art_i]%>';
        for (var $art_ikwkigqcoj$art_i = 0, $art_objrtswsth$art_obj = p.hours, $art_ctwxcxvhrj$art_c = $art_objrtswsth$art_obj.length; $art_ikwkigqcoj$art_i < $art_ctwxcxvhrj$art_c; $art_ikwkigqcoj$art_i++) {
            var h = $art_objrtswsth$art_obj[$art_ikwkigqcoj$art_i];
