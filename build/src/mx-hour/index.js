...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_icwmuxpjw$art_i = 0, $art_crddsaabmp$art_c = types.length; $art_icwmuxpjw$art_i < $art_crddsaabmp$art_c; $art_icwmuxpjw$art_i++) {        var t = types[$art_icwmuxpjw$art_i]%>';
        for (var $art_icwmuxpjw$art_i = 0, $art_crddsaabmp$art_c = types.length; $art_icwmuxpjw$art_i < $art_crddsaabmp$art_c; $art_icwmuxpjw$art_i++) {
            var t = types[$art_icwmuxpjw$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cwmidhhsni$art_c = periods.length; pIndex < $art_cwmidhhsni$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cwmidhhsni$art_c = periods.length; pIndex < $art_cwmidhhsni$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_itlazyzb$art_i = 0, $art_objtjisuen$art_obj = p.hours, $art_cnhrymbze$art_c = $art_objtjisuen$art_obj.length; $art_itlazyzb$art_i < $art_cnhrymbze$art_c; $art_itlazyzb$art_i++) {        var h = $art_objtjisuen$art_obj[$art_itlazyzb$art_i]%>';
        for (var $art_itlazyzb$art_i = 0, $art_objtjisuen$art_obj = p.hours, $art_cnhrymbze$art_c = $art_objtjisuen$art_obj.length; $art_itlazyzb$art_i < $art_cnhrymbze$art_c; $art_itlazyzb$art_i++) {
            var h = $art_objtjisuen$art_obj[$art_itlazyzb$art_i];
