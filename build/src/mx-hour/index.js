...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iywhewdip$art_i = 0, $art_cafsm$art_c = types.length; $art_iywhewdip$art_i < $art_cafsm$art_c; $art_iywhewdip$art_i++) {        var t = types[$art_iywhewdip$art_i]%>';
        for (var $art_iywhewdip$art_i = 0, $art_cafsm$art_c = types.length; $art_iywhewdip$art_i < $art_cafsm$art_c; $art_iywhewdip$art_i++) {
            var t = types[$art_iywhewdip$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cyqzfbpwlul$art_c = periods.length; pIndex < $art_cyqzfbpwlul$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cyqzfbpwlul$art_c = periods.length; pIndex < $art_cyqzfbpwlul$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivfetelsj$art_i = 0, $art_objugdqwei$art_obj = p.hours, $art_cnwknwe$art_c = $art_objugdqwei$art_obj.length; $art_ivfetelsj$art_i < $art_cnwknwe$art_c; $art_ivfetelsj$art_i++) {        var h = $art_objugdqwei$art_obj[$art_ivfetelsj$art_i]%>';
        for (var $art_ivfetelsj$art_i = 0, $art_objugdqwei$art_obj = p.hours, $art_cnwknwe$art_c = $art_objugdqwei$art_obj.length; $art_ivfetelsj$art_i < $art_cnwknwe$art_c; $art_ivfetelsj$art_i++) {
            var h = $art_objugdqwei$art_obj[$art_ivfetelsj$art_i];
