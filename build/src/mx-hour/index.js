...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibgvjnaq$art_i = 0, $art_cxogbyru$art_c = types.length; $art_ibgvjnaq$art_i < $art_cxogbyru$art_c; $art_ibgvjnaq$art_i++) {        var t = types[$art_ibgvjnaq$art_i]%>';
        for (var $art_ibgvjnaq$art_i = 0, $art_cxogbyru$art_c = types.length; $art_ibgvjnaq$art_i < $art_cxogbyru$art_c; $art_ibgvjnaq$art_i++) {
            var t = types[$art_ibgvjnaq$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_charkqyvd$art_c = periods.length; pIndex < $art_charkqyvd$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_charkqyvd$art_c = periods.length; pIndex < $art_charkqyvd$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_inkhkvpq$art_i = 0, $art_objjdegvg$art_obj = p.hours, $art_cmjdjhdqdim$art_c = $art_objjdegvg$art_obj.length; $art_inkhkvpq$art_i < $art_cmjdjhdqdim$art_c; $art_inkhkvpq$art_i++) {        var h = $art_objjdegvg$art_obj[$art_inkhkvpq$art_i]%>';
        for (var $art_inkhkvpq$art_i = 0, $art_objjdegvg$art_obj = p.hours, $art_cmjdjhdqdim$art_c = $art_objjdegvg$art_obj.length; $art_inkhkvpq$art_i < $art_cmjdjhdqdim$art_c; $art_inkhkvpq$art_i++) {
            var h = $art_objjdegvg$art_obj[$art_inkhkvpq$art_i];
