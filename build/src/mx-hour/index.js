...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_itdpqhwogal$art_i = 0, $art_ciopbxhk$art_c = types.length; $art_itdpqhwogal$art_i < $art_ciopbxhk$art_c; $art_itdpqhwogal$art_i++) {        var t = types[$art_itdpqhwogal$art_i]%>';
        for (var $art_itdpqhwogal$art_i = 0, $art_ciopbxhk$art_c = types.length; $art_itdpqhwogal$art_i < $art_ciopbxhk$art_c; $art_itdpqhwogal$art_i++) {
            var t = types[$art_itdpqhwogal$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cxgxtxwm$art_c = periods.length; pIndex < $art_cxgxtxwm$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cxgxtxwm$art_c = periods.length; pIndex < $art_cxgxtxwm$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iqpnxtmzzi$art_i = 0, $art_objcrjzmd$art_obj = p.hours, $art_calhrupjyt$art_c = $art_objcrjzmd$art_obj.length; $art_iqpnxtmzzi$art_i < $art_calhrupjyt$art_c; $art_iqpnxtmzzi$art_i++) {        var h = $art_objcrjzmd$art_obj[$art_iqpnxtmzzi$art_i]%>';
        for (var $art_iqpnxtmzzi$art_i = 0, $art_objcrjzmd$art_obj = p.hours, $art_calhrupjyt$art_c = $art_objcrjzmd$art_obj.length; $art_iqpnxtmzzi$art_i < $art_calhrupjyt$art_c; $art_iqpnxtmzzi$art_i++) {
            var h = $art_objcrjzmd$art_obj[$art_iqpnxtmzzi$art_i];
