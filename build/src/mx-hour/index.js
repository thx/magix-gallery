...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_imtljomqxr$art_i = 0, $art_clvtxh$art_c = types.length; $art_imtljomqxr$art_i < $art_clvtxh$art_c; $art_imtljomqxr$art_i++) {        var t = types[$art_imtljomqxr$art_i]%>';
        for (var $art_imtljomqxr$art_i = 0, $art_clvtxh$art_c = types.length; $art_imtljomqxr$art_i < $art_clvtxh$art_c; $art_imtljomqxr$art_i++) {
            var t = types[$art_imtljomqxr$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cyzcyfhyf$art_c = periods.length; pIndex < $art_cyzcyfhyf$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cyzcyfhyf$art_c = periods.length; pIndex < $art_cyzcyfhyf$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iiuskkih$art_i = 0, $art_objxgwjgvq$art_obj = p.hours, $art_cotfxtey$art_c = $art_objxgwjgvq$art_obj.length; $art_iiuskkih$art_i < $art_cotfxtey$art_c; $art_iiuskkih$art_i++) {        var h = $art_objxgwjgvq$art_obj[$art_iiuskkih$art_i]%>';
        for (var $art_iiuskkih$art_i = 0, $art_objxgwjgvq$art_obj = p.hours, $art_cotfxtey$art_c = $art_objxgwjgvq$art_obj.length; $art_iiuskkih$art_i < $art_cotfxtey$art_c; $art_iiuskkih$art_i++) {
            var h = $art_objxgwjgvq$art_obj[$art_iiuskkih$art_i];
