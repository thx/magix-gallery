...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_idwjgcq$art_i = 0, $art_cmkswcxygi$art_c = types.length; $art_idwjgcq$art_i < $art_cmkswcxygi$art_c; $art_idwjgcq$art_i++) {        var t = types[$art_idwjgcq$art_i]%>';
        for (var $art_idwjgcq$art_i = 0, $art_cmkswcxygi$art_c = types.length; $art_idwjgcq$art_i < $art_cmkswcxygi$art_c; $art_idwjgcq$art_i++) {
            var t = types[$art_idwjgcq$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cithbnwgc$art_c = periods.length; pIndex < $art_cithbnwgc$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cithbnwgc$art_c = periods.length; pIndex < $art_cithbnwgc$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ifqqeta$art_i = 0, $art_objepygtf$art_obj = p.hours, $art_cfbamzvctl$art_c = $art_objepygtf$art_obj.length; $art_ifqqeta$art_i < $art_cfbamzvctl$art_c; $art_ifqqeta$art_i++) {        var h = $art_objepygtf$art_obj[$art_ifqqeta$art_i]%>';
        for (var $art_ifqqeta$art_i = 0, $art_objepygtf$art_obj = p.hours, $art_cfbamzvctl$art_c = $art_objepygtf$art_obj.length; $art_ifqqeta$art_i < $art_cfbamzvctl$art_c; $art_ifqqeta$art_i++) {
            var h = $art_objepygtf$art_obj[$art_ifqqeta$art_i];
