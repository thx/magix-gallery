...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibkdixmss$art_i = 0, $art_chfyug$art_c = types.length; $art_ibkdixmss$art_i < $art_chfyug$art_c; $art_ibkdixmss$art_i++) {        var t = types[$art_ibkdixmss$art_i]%>';
        for (var $art_ibkdixmss$art_i = 0, $art_chfyug$art_c = types.length; $art_ibkdixmss$art_i < $art_chfyug$art_c; $art_ibkdixmss$art_i++) {
            var t = types[$art_ibkdixmss$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_csdgugbus$art_c = periods.length; pIndex < $art_csdgugbus$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_csdgugbus$art_c = periods.length; pIndex < $art_csdgugbus$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_irlgqudnb$art_i = 0, $art_objpwjhecpmf$art_obj = p.hours, $art_cozunjaemlm$art_c = $art_objpwjhecpmf$art_obj.length; $art_irlgqudnb$art_i < $art_cozunjaemlm$art_c; $art_irlgqudnb$art_i++) {        var h = $art_objpwjhecpmf$art_obj[$art_irlgqudnb$art_i]%>';
        for (var $art_irlgqudnb$art_i = 0, $art_objpwjhecpmf$art_obj = p.hours, $art_cozunjaemlm$art_c = $art_objpwjhecpmf$art_obj.length; $art_irlgqudnb$art_i < $art_cozunjaemlm$art_c; $art_irlgqudnb$art_i++) {
            var h = $art_objpwjhecpmf$art_obj[$art_irlgqudnb$art_i];
