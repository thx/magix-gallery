...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iirburws$art_i = 0, $art_cnvskul$art_c = types.length; $art_iirburws$art_i < $art_cnvskul$art_c; $art_iirburws$art_i++) {        var t = types[$art_iirburws$art_i]%>';
        for (var $art_iirburws$art_i = 0, $art_cnvskul$art_c = types.length; $art_iirburws$art_i < $art_cnvskul$art_c; $art_iirburws$art_i++) {
            var t = types[$art_iirburws$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cvfsfxbbj$art_c = periods.length; pIndex < $art_cvfsfxbbj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cvfsfxbbj$art_c = periods.length; pIndex < $art_cvfsfxbbj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_isqnkjqkt$art_i = 0, $art_objbrsfqlh$art_obj = p.hours, $art_cpixdnixo$art_c = $art_objbrsfqlh$art_obj.length; $art_isqnkjqkt$art_i < $art_cpixdnixo$art_c; $art_isqnkjqkt$art_i++) {        var h = $art_objbrsfqlh$art_obj[$art_isqnkjqkt$art_i]%>';
        for (var $art_isqnkjqkt$art_i = 0, $art_objbrsfqlh$art_obj = p.hours, $art_cpixdnixo$art_c = $art_objbrsfqlh$art_obj.length; $art_isqnkjqkt$art_i < $art_cpixdnixo$art_c; $art_isqnkjqkt$art_i++) {
            var h = $art_objbrsfqlh$art_obj[$art_isqnkjqkt$art_i];
