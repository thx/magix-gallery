...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iqsxkjts$art_i = 0, $art_cplhckgm$art_c = types.length; $art_iqsxkjts$art_i < $art_cplhckgm$art_c; $art_iqsxkjts$art_i++) {        var t = types[$art_iqsxkjts$art_i]%>';
        for (var $art_iqsxkjts$art_i = 0, $art_cplhckgm$art_c = types.length; $art_iqsxkjts$art_i < $art_cplhckgm$art_c; $art_iqsxkjts$art_i++) {
            var t = types[$art_iqsxkjts$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cgjpxlwu$art_c = periods.length; pIndex < $art_cgjpxlwu$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cgjpxlwu$art_c = periods.length; pIndex < $art_cgjpxlwu$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iggczzto$art_i = 0, $art_objqxmsvitc$art_obj = p.hours, $art_cgikwcpqq$art_c = $art_objqxmsvitc$art_obj.length; $art_iggczzto$art_i < $art_cgikwcpqq$art_c; $art_iggczzto$art_i++) {        var h = $art_objqxmsvitc$art_obj[$art_iggczzto$art_i]%>';
        for (var $art_iggczzto$art_i = 0, $art_objqxmsvitc$art_obj = p.hours, $art_cgikwcpqq$art_c = $art_objqxmsvitc$art_obj.length; $art_iggczzto$art_i < $art_cgikwcpqq$art_c; $art_iggczzto$art_i++) {
            var h = $art_objqxmsvitc$art_obj[$art_iggczzto$art_i];
