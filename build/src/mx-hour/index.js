...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iwihdpe$art_i = 0, $art_crkkqggqcux$art_c = types.length; $art_iwihdpe$art_i < $art_crkkqggqcux$art_c; $art_iwihdpe$art_i++) {        var t = types[$art_iwihdpe$art_i]%>';
        for (var $art_iwihdpe$art_i = 0, $art_crkkqggqcux$art_c = types.length; $art_iwihdpe$art_i < $art_crkkqggqcux$art_c; $art_iwihdpe$art_i++) {
            var t = types[$art_iwihdpe$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cqirbcf$art_c = periods.length; pIndex < $art_cqirbcf$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cqirbcf$art_c = periods.length; pIndex < $art_cqirbcf$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilyvhmckwbc$art_i = 0, $art_objxzpemrv$art_obj = p.hours, $art_cndrmqnmiuf$art_c = $art_objxzpemrv$art_obj.length; $art_ilyvhmckwbc$art_i < $art_cndrmqnmiuf$art_c; $art_ilyvhmckwbc$art_i++) {        var h = $art_objxzpemrv$art_obj[$art_ilyvhmckwbc$art_i]%>';
        for (var $art_ilyvhmckwbc$art_i = 0, $art_objxzpemrv$art_obj = p.hours, $art_cndrmqnmiuf$art_c = $art_objxzpemrv$art_obj.length; $art_ilyvhmckwbc$art_i < $art_cndrmqnmiuf$art_c; $art_ilyvhmckwbc$art_i++) {
            var h = $art_objxzpemrv$art_obj[$art_ilyvhmckwbc$art_i];
