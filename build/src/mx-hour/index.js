...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iyavngyhbta$art_i = 0, $art_cugcpmqs$art_c = types.length; $art_iyavngyhbta$art_i < $art_cugcpmqs$art_c; $art_iyavngyhbta$art_i++) {        var t = types[$art_iyavngyhbta$art_i]%>';
        for (var $art_iyavngyhbta$art_i = 0, $art_cugcpmqs$art_c = types.length; $art_iyavngyhbta$art_i < $art_cugcpmqs$art_c; $art_iyavngyhbta$art_i++) {
            var t = types[$art_iyavngyhbta$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cbfryardyj$art_c = periods.length; pIndex < $art_cbfryardyj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cbfryardyj$art_c = periods.length; pIndex < $art_cbfryardyj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ikabvxy$art_i = 0, $art_objeprjkwz$art_obj = p.hours, $art_cksrpfv$art_c = $art_objeprjkwz$art_obj.length; $art_ikabvxy$art_i < $art_cksrpfv$art_c; $art_ikabvxy$art_i++) {        var h = $art_objeprjkwz$art_obj[$art_ikabvxy$art_i]%>';
        for (var $art_ikabvxy$art_i = 0, $art_objeprjkwz$art_obj = p.hours, $art_cksrpfv$art_c = $art_objeprjkwz$art_obj.length; $art_ikabvxy$art_i < $art_cksrpfv$art_c; $art_ikabvxy$art_i++) {
            var h = $art_objeprjkwz$art_obj[$art_ikabvxy$art_i];
