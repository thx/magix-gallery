...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ipphjbwfeb$art_i = 0, $art_cjmxpnrj$art_c = types.length; $art_ipphjbwfeb$art_i < $art_cjmxpnrj$art_c; $art_ipphjbwfeb$art_i++) {        var t = types[$art_ipphjbwfeb$art_i]%>';
        for (var $art_ipphjbwfeb$art_i = 0, $art_cjmxpnrj$art_c = types.length; $art_ipphjbwfeb$art_i < $art_cjmxpnrj$art_c; $art_ipphjbwfeb$art_i++) {
            var t = types[$art_ipphjbwfeb$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cyvtxsgymry$art_c = periods.length; pIndex < $art_cyvtxsgymry$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cyvtxsgymry$art_c = periods.length; pIndex < $art_cyvtxsgymry$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igjbenpqq$art_i = 0, $art_objknfkily$art_obj = p.hours, $art_cxxgsvwoo$art_c = $art_objknfkily$art_obj.length; $art_igjbenpqq$art_i < $art_cxxgsvwoo$art_c; $art_igjbenpqq$art_i++) {        var h = $art_objknfkily$art_obj[$art_igjbenpqq$art_i]%>';
        for (var $art_igjbenpqq$art_i = 0, $art_objknfkily$art_obj = p.hours, $art_cxxgsvwoo$art_c = $art_objknfkily$art_obj.length; $art_igjbenpqq$art_i < $art_cxxgsvwoo$art_c; $art_igjbenpqq$art_i++) {
            var h = $art_objknfkily$art_obj[$art_igjbenpqq$art_i];
