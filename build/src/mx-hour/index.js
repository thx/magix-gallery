...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ilwvwiil$art_i = 0, $art_ctcgoiurcy$art_c = types.length; $art_ilwvwiil$art_i < $art_ctcgoiurcy$art_c; $art_ilwvwiil$art_i++) {        var t = types[$art_ilwvwiil$art_i]%>';
        for (var $art_ilwvwiil$art_i = 0, $art_ctcgoiurcy$art_c = types.length; $art_ilwvwiil$art_i < $art_ctcgoiurcy$art_c; $art_ilwvwiil$art_i++) {
            var t = types[$art_ilwvwiil$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cqfscsyhep$art_c = periods.length; pIndex < $art_cqfscsyhep$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cqfscsyhep$art_c = periods.length; pIndex < $art_cqfscsyhep$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_isekxbm$art_i = 0, $art_objykomhjysb$art_obj = p.hours, $art_cimrdyiuo$art_c = $art_objykomhjysb$art_obj.length; $art_isekxbm$art_i < $art_cimrdyiuo$art_c; $art_isekxbm$art_i++) {        var h = $art_objykomhjysb$art_obj[$art_isekxbm$art_i]%>';
        for (var $art_isekxbm$art_i = 0, $art_objykomhjysb$art_obj = p.hours, $art_cimrdyiuo$art_c = $art_objykomhjysb$art_obj.length; $art_isekxbm$art_i < $art_cimrdyiuo$art_c; $art_isekxbm$art_i++) {
            var h = $art_objykomhjysb$art_obj[$art_isekxbm$art_i];
