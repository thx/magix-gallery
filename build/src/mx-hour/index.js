...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_itmjgal$art_i = 0, $art_clitknvob$art_c = types.length; $art_itmjgal$art_i < $art_clitknvob$art_c; $art_itmjgal$art_i++) {        var t = types[$art_itmjgal$art_i]%>';
        for (var $art_itmjgal$art_i = 0, $art_clitknvob$art_c = types.length; $art_itmjgal$art_i < $art_clitknvob$art_c; $art_itmjgal$art_i++) {
            var t = types[$art_itmjgal$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cichrxmfwk$art_c = periods.length; pIndex < $art_cichrxmfwk$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cichrxmfwk$art_c = periods.length; pIndex < $art_cichrxmfwk$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iohpukefas$art_i = 0, $art_objjiqncdymd$art_obj = p.hours, $art_cgjdxyvqn$art_c = $art_objjiqncdymd$art_obj.length; $art_iohpukefas$art_i < $art_cgjdxyvqn$art_c; $art_iohpukefas$art_i++) {        var h = $art_objjiqncdymd$art_obj[$art_iohpukefas$art_i]%>';
        for (var $art_iohpukefas$art_i = 0, $art_objjiqncdymd$art_obj = p.hours, $art_cgjdxyvqn$art_c = $art_objjiqncdymd$art_obj.length; $art_iohpukefas$art_i < $art_cgjdxyvqn$art_c; $art_iohpukefas$art_i++) {
            var h = $art_objjiqncdymd$art_obj[$art_iohpukefas$art_i];
