...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iwyvnauj$art_i = 0, $art_cigzetouqo$art_c = types.length; $art_iwyvnauj$art_i < $art_cigzetouqo$art_c; $art_iwyvnauj$art_i++) {        var t = types[$art_iwyvnauj$art_i]%>';
        for (var $art_iwyvnauj$art_i = 0, $art_cigzetouqo$art_c = types.length; $art_iwyvnauj$art_i < $art_cigzetouqo$art_c; $art_iwyvnauj$art_i++) {
            var t = types[$art_iwyvnauj$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cdyscjyraam$art_c = periods.length; pIndex < $art_cdyscjyraam$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cdyscjyraam$art_c = periods.length; pIndex < $art_cdyscjyraam$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilqmiuj$art_i = 0, $art_objjyzbqaj$art_obj = p.hours, $art_cggizifir$art_c = $art_objjyzbqaj$art_obj.length; $art_ilqmiuj$art_i < $art_cggizifir$art_c; $art_ilqmiuj$art_i++) {        var h = $art_objjyzbqaj$art_obj[$art_ilqmiuj$art_i]%>';
        for (var $art_ilqmiuj$art_i = 0, $art_objjyzbqaj$art_obj = p.hours, $art_cggizifir$art_c = $art_objjyzbqaj$art_obj.length; $art_ilqmiuj$art_i < $art_cggizifir$art_c; $art_ilqmiuj$art_i++) {
            var h = $art_objjyzbqaj$art_obj[$art_ilqmiuj$art_i];
