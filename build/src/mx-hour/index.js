...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ivoqrqgj$art_i = 0, $art_clvotpprua$art_c = types.length; $art_ivoqrqgj$art_i < $art_clvotpprua$art_c; $art_ivoqrqgj$art_i++) {        var t = types[$art_ivoqrqgj$art_i]%>';
        for (var $art_ivoqrqgj$art_i = 0, $art_clvotpprua$art_c = types.length; $art_ivoqrqgj$art_i < $art_clvotpprua$art_c; $art_ivoqrqgj$art_i++) {
            var t = types[$art_ivoqrqgj$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cqbmon$art_c = periods.length; pIndex < $art_cqbmon$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cqbmon$art_c = periods.length; pIndex < $art_cqbmon$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_itrfkzweq$art_i = 0, $art_objpsvxihi$art_obj = p.hours, $art_csnmkrn$art_c = $art_objpsvxihi$art_obj.length; $art_itrfkzweq$art_i < $art_csnmkrn$art_c; $art_itrfkzweq$art_i++) {        var h = $art_objpsvxihi$art_obj[$art_itrfkzweq$art_i]%>';
        for (var $art_itrfkzweq$art_i = 0, $art_objpsvxihi$art_obj = p.hours, $art_csnmkrn$art_c = $art_objpsvxihi$art_obj.length; $art_itrfkzweq$art_i < $art_csnmkrn$art_c; $art_itrfkzweq$art_i++) {
            var h = $art_objpsvxihi$art_obj[$art_itrfkzweq$art_i];
