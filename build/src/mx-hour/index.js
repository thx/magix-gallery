...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ieauzuoi$art_i = 0, $art_csttph$art_c = types.length; $art_ieauzuoi$art_i < $art_csttph$art_c; $art_ieauzuoi$art_i++) {        var t = types[$art_ieauzuoi$art_i]%>';
        for (var $art_ieauzuoi$art_i = 0, $art_csttph$art_c = types.length; $art_ieauzuoi$art_i < $art_csttph$art_c; $art_ieauzuoi$art_i++) {
            var t = types[$art_ieauzuoi$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_chzrqfkkew$art_c = periods.length; pIndex < $art_chzrqfkkew$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_chzrqfkkew$art_c = periods.length; pIndex < $art_chzrqfkkew$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idvfcpfd$art_i = 0, $art_objjnnwloja$art_obj = p.hours, $art_cflwvrmqwi$art_c = $art_objjnnwloja$art_obj.length; $art_idvfcpfd$art_i < $art_cflwvrmqwi$art_c; $art_idvfcpfd$art_i++) {        var h = $art_objjnnwloja$art_obj[$art_idvfcpfd$art_i]%>';
        for (var $art_idvfcpfd$art_i = 0, $art_objjnnwloja$art_obj = p.hours, $art_cflwvrmqwi$art_c = $art_objjnnwloja$art_obj.length; $art_idvfcpfd$art_i < $art_cflwvrmqwi$art_c; $art_idvfcpfd$art_i++) {
            var h = $art_objjnnwloja$art_obj[$art_idvfcpfd$art_i];
