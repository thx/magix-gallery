...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iikdumisc$art_i = 0, $art_chpwhxov$art_c = types.length; $art_iikdumisc$art_i < $art_chpwhxov$art_c; $art_iikdumisc$art_i++) {        var t = types[$art_iikdumisc$art_i]%>';
        for (var $art_iikdumisc$art_i = 0, $art_chpwhxov$art_c = types.length; $art_iikdumisc$art_i < $art_chpwhxov$art_c; $art_iikdumisc$art_i++) {
            var t = types[$art_iikdumisc$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cmquor$art_c = periods.length; pIndex < $art_cmquor$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cmquor$art_c = periods.length; pIndex < $art_cmquor$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ifantzl$art_i = 0, $art_objantbxksn$art_obj = p.hours, $art_cydbsjooxd$art_c = $art_objantbxksn$art_obj.length; $art_ifantzl$art_i < $art_cydbsjooxd$art_c; $art_ifantzl$art_i++) {        var h = $art_objantbxksn$art_obj[$art_ifantzl$art_i]%>';
        for (var $art_ifantzl$art_i = 0, $art_objantbxksn$art_obj = p.hours, $art_cydbsjooxd$art_c = $art_objantbxksn$art_obj.length; $art_ifantzl$art_i < $art_cydbsjooxd$art_c; $art_ifantzl$art_i++) {
            var h = $art_objantbxksn$art_obj[$art_ifantzl$art_i];
