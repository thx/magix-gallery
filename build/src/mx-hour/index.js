...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ivdlhccut$art_i = 0, $art_csnicolyg$art_c = types.length; $art_ivdlhccut$art_i < $art_csnicolyg$art_c; $art_ivdlhccut$art_i++) {        var t = types[$art_ivdlhccut$art_i]%>';
        for (var $art_ivdlhccut$art_i = 0, $art_csnicolyg$art_c = types.length; $art_ivdlhccut$art_i < $art_csnicolyg$art_c; $art_ivdlhccut$art_i++) {
            var t = types[$art_ivdlhccut$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cxraczjv$art_c = periods.length; pIndex < $art_cxraczjv$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cxraczjv$art_c = periods.length; pIndex < $art_cxraczjv$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ijegzvams$art_i = 0, $art_objjqndsgovj$art_obj = p.hours, $art_csrhmyaws$art_c = $art_objjqndsgovj$art_obj.length; $art_ijegzvams$art_i < $art_csrhmyaws$art_c; $art_ijegzvams$art_i++) {        var h = $art_objjqndsgovj$art_obj[$art_ijegzvams$art_i]%>';
        for (var $art_ijegzvams$art_i = 0, $art_objjqndsgovj$art_obj = p.hours, $art_csrhmyaws$art_c = $art_objjqndsgovj$art_obj.length; $art_ijegzvams$art_i < $art_csrhmyaws$art_c; $art_ijegzvams$art_i++) {
            var h = $art_objjqndsgovj$art_obj[$art_ijegzvams$art_i];
