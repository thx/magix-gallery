...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ijjpjcbzi$art_i = 0, $art_cikgvgfrj$art_c = types.length; $art_ijjpjcbzi$art_i < $art_cikgvgfrj$art_c; $art_ijjpjcbzi$art_i++) {        var t = types[$art_ijjpjcbzi$art_i]%>';
        for (var $art_ijjpjcbzi$art_i = 0, $art_cikgvgfrj$art_c = types.length; $art_ijjpjcbzi$art_i < $art_cikgvgfrj$art_c; $art_ijjpjcbzi$art_i++) {
            var t = types[$art_ijjpjcbzi$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ccmvgw$art_c = periods.length; pIndex < $art_ccmvgw$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ccmvgw$art_c = periods.length; pIndex < $art_ccmvgw$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_itkqil$art_i = 0, $art_objdqrulagb$art_obj = p.hours, $art_cbyaxyruqa$art_c = $art_objdqrulagb$art_obj.length; $art_itkqil$art_i < $art_cbyaxyruqa$art_c; $art_itkqil$art_i++) {        var h = $art_objdqrulagb$art_obj[$art_itkqil$art_i]%>';
        for (var $art_itkqil$art_i = 0, $art_objdqrulagb$art_obj = p.hours, $art_cbyaxyruqa$art_c = $art_objdqrulagb$art_obj.length; $art_itkqil$art_i < $art_cbyaxyruqa$art_c; $art_itkqil$art_i++) {
            var h = $art_objdqrulagb$art_obj[$art_itkqil$art_i];
