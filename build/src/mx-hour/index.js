...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iyejix$art_i = 0, $art_crnqcf$art_c = types.length; $art_iyejix$art_i < $art_crnqcf$art_c; $art_iyejix$art_i++) {        var t = types[$art_iyejix$art_i]%>';
        for (var $art_iyejix$art_i = 0, $art_crnqcf$art_c = types.length; $art_iyejix$art_i < $art_crnqcf$art_c; $art_iyejix$art_i++) {
            var t = types[$art_iyejix$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cmwgezfnowf$art_c = periods.length; pIndex < $art_cmwgezfnowf$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cmwgezfnowf$art_c = periods.length; pIndex < $art_cmwgezfnowf$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilcbwtybq$art_i = 0, $art_objszvsrhvc$art_obj = p.hours, $art_clrwhlrr$art_c = $art_objszvsrhvc$art_obj.length; $art_ilcbwtybq$art_i < $art_clrwhlrr$art_c; $art_ilcbwtybq$art_i++) {        var h = $art_objszvsrhvc$art_obj[$art_ilcbwtybq$art_i]%>';
        for (var $art_ilcbwtybq$art_i = 0, $art_objszvsrhvc$art_obj = p.hours, $art_clrwhlrr$art_c = $art_objszvsrhvc$art_obj.length; $art_ilcbwtybq$art_i < $art_clrwhlrr$art_c; $art_ilcbwtybq$art_i++) {
            var h = $art_objszvsrhvc$art_obj[$art_ilcbwtybq$art_i];
    ...
    ;
    $p += '</div><div mxa="_zs_gallerycf:h" class="clearfix _zs_gallery_mx-hour_index_-opers-wrapper"><a mxs="_zs_gallerycf:d" mx-click="' + $viewId + 'clearAll()" href="javascript:;" class="btn btn-small _zs_gallery_mx-hour_index_-btn-clear"><i class="mc-iconfont displacement-2 mr5 color-9">&#xe72e;</i>清空</a><span mxa="_zs_gallerycf:i" class="fr lh28">';
    $line = 50;
    $art = '=tip';
    ;
