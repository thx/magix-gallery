...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ikfvlla$art_i = 0, $art_czeiblk$art_c = types.length; $art_ikfvlla$art_i < $art_czeiblk$art_c; $art_ikfvlla$art_i++) {        var t = types[$art_ikfvlla$art_i]%>';
        for (var $art_ikfvlla$art_i = 0, $art_czeiblk$art_c = types.length; $art_ikfvlla$art_i < $art_czeiblk$art_c; $art_ikfvlla$art_i++) {
            var t = types[$art_ikfvlla$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ctcjgjmvgxd$art_c = periods.length; pIndex < $art_ctcjgjmvgxd$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ctcjgjmvgxd$art_c = periods.length; pIndex < $art_ctcjgjmvgxd$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ikanshgeil$art_i = 0, $art_objuoaucepo$art_obj = p.hours, $art_cjfckilgr$art_c = $art_objuoaucepo$art_obj.length; $art_ikanshgeil$art_i < $art_cjfckilgr$art_c; $art_ikanshgeil$art_i++) {        var h = $art_objuoaucepo$art_obj[$art_ikanshgeil$art_i]%>';
        for (var $art_ikanshgeil$art_i = 0, $art_objuoaucepo$art_obj = p.hours, $art_cjfckilgr$art_c = $art_objuoaucepo$art_obj.length; $art_ikanshgeil$art_i < $art_cjfckilgr$art_c; $art_ikanshgeil$art_i++) {
            var h = $art_objuoaucepo$art_obj[$art_ikanshgeil$art_i];
