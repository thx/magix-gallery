...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iupqydbcx$art_i = 0, $art_csfcvifk$art_c = types.length; $art_iupqydbcx$art_i < $art_csfcvifk$art_c; $art_iupqydbcx$art_i++) {        var t = types[$art_iupqydbcx$art_i]%>';
        for (var $art_iupqydbcx$art_i = 0, $art_csfcvifk$art_c = types.length; $art_iupqydbcx$art_i < $art_csfcvifk$art_c; $art_iupqydbcx$art_i++) {
            var t = types[$art_iupqydbcx$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cfnzcam$art_c = periods.length; pIndex < $art_cfnzcam$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cfnzcam$art_c = periods.length; pIndex < $art_cfnzcam$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iwuujjzmk$art_i = 0, $art_objzkoxgqa$art_obj = p.hours, $art_ckmfah$art_c = $art_objzkoxgqa$art_obj.length; $art_iwuujjzmk$art_i < $art_ckmfah$art_c; $art_iwuujjzmk$art_i++) {        var h = $art_objzkoxgqa$art_obj[$art_iwuujjzmk$art_i]%>';
        for (var $art_iwuujjzmk$art_i = 0, $art_objzkoxgqa$art_obj = p.hours, $art_ckmfah$art_c = $art_objzkoxgqa$art_obj.length; $art_iwuujjzmk$art_i < $art_ckmfah$art_c; $art_iwuujjzmk$art_i++) {
            var h = $art_objzkoxgqa$art_obj[$art_iwuujjzmk$art_i];
