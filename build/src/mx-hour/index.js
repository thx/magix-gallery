...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iursvdkef$art_i = 0, $art_cdhzjhcdhz$art_c = types.length; $art_iursvdkef$art_i < $art_cdhzjhcdhz$art_c; $art_iursvdkef$art_i++) {        var t = types[$art_iursvdkef$art_i]%>';
        for (var $art_iursvdkef$art_i = 0, $art_cdhzjhcdhz$art_c = types.length; $art_iursvdkef$art_i < $art_cdhzjhcdhz$art_c; $art_iursvdkef$art_i++) {
            var t = types[$art_iursvdkef$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cfrpmsxcmj$art_c = periods.length; pIndex < $art_cfrpmsxcmj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cfrpmsxcmj$art_c = periods.length; pIndex < $art_cfrpmsxcmj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iudqudcg$art_i = 0, $art_objkhbaeh$art_obj = p.hours, $art_ckxhtmnjol$art_c = $art_objkhbaeh$art_obj.length; $art_iudqudcg$art_i < $art_ckxhtmnjol$art_c; $art_iudqudcg$art_i++) {        var h = $art_objkhbaeh$art_obj[$art_iudqudcg$art_i]%>';
        for (var $art_iudqudcg$art_i = 0, $art_objkhbaeh$art_obj = p.hours, $art_ckxhtmnjol$art_c = $art_objkhbaeh$art_obj.length; $art_iudqudcg$art_i < $art_ckxhtmnjol$art_c; $art_iudqudcg$art_i++) {
            var h = $art_objkhbaeh$art_obj[$art_iudqudcg$art_i];
