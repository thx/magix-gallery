...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ixfbpdybj$art_i = 0, $art_cwlstqqdevl$art_c = types.length; $art_ixfbpdybj$art_i < $art_cwlstqqdevl$art_c; $art_ixfbpdybj$art_i++) {        var t = types[$art_ixfbpdybj$art_i]%>';
        for (var $art_ixfbpdybj$art_i = 0, $art_cwlstqqdevl$art_c = types.length; $art_ixfbpdybj$art_i < $art_cwlstqqdevl$art_c; $art_ixfbpdybj$art_i++) {
            var t = types[$art_ixfbpdybj$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_capyvdmzpj$art_c = periods.length; pIndex < $art_capyvdmzpj$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_capyvdmzpj$art_c = periods.length; pIndex < $art_capyvdmzpj$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iooyojgqn$art_i = 0, $art_objwkreaogmk$art_obj = p.hours, $art_ciqihxwd$art_c = $art_objwkreaogmk$art_obj.length; $art_iooyojgqn$art_i < $art_ciqihxwd$art_c; $art_iooyojgqn$art_i++) {        var h = $art_objwkreaogmk$art_obj[$art_iooyojgqn$art_i]%>';
        for (var $art_iooyojgqn$art_i = 0, $art_objwkreaogmk$art_obj = p.hours, $art_ciqihxwd$art_c = $art_objwkreaogmk$art_obj.length; $art_iooyojgqn$art_i < $art_ciqihxwd$art_c; $art_iooyojgqn$art_i++) {
            var h = $art_objwkreaogmk$art_obj[$art_iooyojgqn$art_i];
