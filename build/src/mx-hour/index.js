...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iqhefjrm$art_i = 0, $art_cpuuxvmec$art_c = types.length; $art_iqhefjrm$art_i < $art_cpuuxvmec$art_c; $art_iqhefjrm$art_i++) {        var t = types[$art_iqhefjrm$art_i]%>';
        for (var $art_iqhefjrm$art_i = 0, $art_cpuuxvmec$art_c = types.length; $art_iqhefjrm$art_i < $art_cpuuxvmec$art_c; $art_iqhefjrm$art_i++) {
            var t = types[$art_iqhefjrm$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_ckbmvzbi$art_c = periods.length; pIndex < $art_ckbmvzbi$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_ckbmvzbi$art_c = periods.length; pIndex < $art_ckbmvzbi$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ijspgypql$art_i = 0, $art_objzdaihopu$art_obj = p.hours, $art_cvufouol$art_c = $art_objzdaihopu$art_obj.length; $art_ijspgypql$art_i < $art_cvufouol$art_c; $art_ijspgypql$art_i++) {        var h = $art_objzdaihopu$art_obj[$art_ijspgypql$art_i]%>';
        for (var $art_ijspgypql$art_i = 0, $art_objzdaihopu$art_obj = p.hours, $art_cvufouol$art_c = $art_objzdaihopu$art_obj.length; $art_ijspgypql$art_i < $art_cvufouol$art_c; $art_ijspgypql$art_i++) {
            var h = $art_objzdaihopu$art_obj[$art_ijspgypql$art_i];
