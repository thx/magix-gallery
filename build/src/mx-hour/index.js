...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ibaklzhbyzr$art_i = 0, $art_czcxyazxm$art_c = types.length; $art_ibaklzhbyzr$art_i < $art_czcxyazxm$art_c; $art_ibaklzhbyzr$art_i++) {        var t = types[$art_ibaklzhbyzr$art_i]%>';
        for (var $art_ibaklzhbyzr$art_i = 0, $art_czcxyazxm$art_c = types.length; $art_ibaklzhbyzr$art_i < $art_czcxyazxm$art_c; $art_ibaklzhbyzr$art_i++) {
            var t = types[$art_ibaklzhbyzr$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_crpxawffk$art_c = periods.length; pIndex < $art_crpxawffk$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_crpxawffk$art_c = periods.length; pIndex < $art_crpxawffk$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ibzebctvd$art_i = 0, $art_objqqdrn$art_obj = p.hours, $art_ctfkisia$art_c = $art_objqqdrn$art_obj.length; $art_ibzebctvd$art_i < $art_ctfkisia$art_c; $art_ibzebctvd$art_i++) {        var h = $art_objqqdrn$art_obj[$art_ibzebctvd$art_i]%>';
        for (var $art_ibzebctvd$art_i = 0, $art_objqqdrn$art_obj = p.hours, $art_ctfkisia$art_c = $art_objqqdrn$art_obj.length; $art_ibzebctvd$art_i < $art_ctfkisia$art_c; $art_ibzebctvd$art_i++) {
            var h = $art_objqqdrn$art_obj[$art_ibzebctvd$art_i];
