...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_igemqtsc$art_i = 0, $art_cpylvb$art_c = types.length; $art_igemqtsc$art_i < $art_cpylvb$art_c; $art_igemqtsc$art_i++) {        var t = types[$art_igemqtsc$art_i]%>';
        for (var $art_igemqtsc$art_i = 0, $art_cpylvb$art_c = types.length; $art_igemqtsc$art_i < $art_cpylvb$art_c; $art_igemqtsc$art_i++) {
            var t = types[$art_igemqtsc$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_crivdgwdja$art_c = periods.length; pIndex < $art_crivdgwdja$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_crivdgwdja$art_c = periods.length; pIndex < $art_crivdgwdja$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iuskkaybne$art_i = 0, $art_objyqeqcbh$art_obj = p.hours, $art_ccqhbaoiow$art_c = $art_objyqeqcbh$art_obj.length; $art_iuskkaybne$art_i < $art_ccqhbaoiow$art_c; $art_iuskkaybne$art_i++) {        var h = $art_objyqeqcbh$art_obj[$art_iuskkaybne$art_i]%>';
        for (var $art_iuskkaybne$art_i = 0, $art_objyqeqcbh$art_obj = p.hours, $art_ccqhbaoiow$art_c = $art_objyqeqcbh$art_obj.length; $art_iuskkaybne$art_i < $art_ccqhbaoiow$art_c; $art_iuskkaybne$art_i++) {
            var h = $art_objyqeqcbh$art_obj[$art_iuskkaybne$art_i];
