...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ixsvlvegwt$art_i = 0, $art_clpagzjrr$art_c = types.length; $art_ixsvlvegwt$art_i < $art_clpagzjrr$art_c; $art_ixsvlvegwt$art_i++) {        var t = types[$art_ixsvlvegwt$art_i]%>';
        for (var $art_ixsvlvegwt$art_i = 0, $art_clpagzjrr$art_c = types.length; $art_ixsvlvegwt$art_i < $art_clpagzjrr$art_c; $art_ixsvlvegwt$art_i++) {
            var t = types[$art_ixsvlvegwt$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cxqcnlp$art_c = periods.length; pIndex < $art_cxqcnlp$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cxqcnlp$art_c = periods.length; pIndex < $art_cxqcnlp$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixfwxfyw$art_i = 0, $art_objtjpwsij$art_obj = p.hours, $art_ckphggs$art_c = $art_objtjpwsij$art_obj.length; $art_ixfwxfyw$art_i < $art_ckphggs$art_c; $art_ixfwxfyw$art_i++) {        var h = $art_objtjpwsij$art_obj[$art_ixfwxfyw$art_i]%>';
        for (var $art_ixfwxfyw$art_i = 0, $art_objtjpwsij$art_obj = p.hours, $art_ckphggs$art_c = $art_objtjpwsij$art_obj.length; $art_ixfwxfyw$art_i < $art_ckphggs$art_c; $art_ixfwxfyw$art_i++) {
            var h = $art_objtjpwsij$art_obj[$art_ixfwxfyw$art_i];
