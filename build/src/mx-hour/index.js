...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ifcuaamam$art_i = 0, $art_cbpwomps$art_c = types.length; $art_ifcuaamam$art_i < $art_cbpwomps$art_c; $art_ifcuaamam$art_i++) {        var t = types[$art_ifcuaamam$art_i]%>';
        for (var $art_ifcuaamam$art_i = 0, $art_cbpwomps$art_c = types.length; $art_ifcuaamam$art_i < $art_cbpwomps$art_c; $art_ifcuaamam$art_i++) {
            var t = types[$art_ifcuaamam$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cdfsrfwquu$art_c = periods.length; pIndex < $art_cdfsrfwquu$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cdfsrfwquu$art_c = periods.length; pIndex < $art_cdfsrfwquu$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iojrgvhdzr$art_i = 0, $art_objtktuenpk$art_obj = p.hours, $art_cmjrldrju$art_c = $art_objtktuenpk$art_obj.length; $art_iojrgvhdzr$art_i < $art_cmjrldrju$art_c; $art_iojrgvhdzr$art_i++) {        var h = $art_objtktuenpk$art_obj[$art_iojrgvhdzr$art_i]%>';
        for (var $art_iojrgvhdzr$art_i = 0, $art_objtktuenpk$art_obj = p.hours, $art_cmjrldrju$art_c = $art_objtktuenpk$art_obj.length; $art_iojrgvhdzr$art_i < $art_cmjrldrju$art_c; $art_iojrgvhdzr$art_i++) {
            var h = $art_objtktuenpk$art_obj[$art_iojrgvhdzr$art_i];
