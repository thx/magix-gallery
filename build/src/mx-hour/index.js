...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ihjzgaaqhn$art_i = 0, $art_cqbqzfbgyxp$art_c = types.length; $art_ihjzgaaqhn$art_i < $art_cqbqzfbgyxp$art_c; $art_ihjzgaaqhn$art_i++) {        var t = types[$art_ihjzgaaqhn$art_i]%>';
        for (var $art_ihjzgaaqhn$art_i = 0, $art_cqbqzfbgyxp$art_c = types.length; $art_ihjzgaaqhn$art_i < $art_cqbqzfbgyxp$art_c; $art_ihjzgaaqhn$art_i++) {
            var t = types[$art_ihjzgaaqhn$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cpjeadvdq$art_c = periods.length; pIndex < $art_cpjeadvdq$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cpjeadvdq$art_c = periods.length; pIndex < $art_cpjeadvdq$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ixqrbidkm$art_i = 0, $art_objvxcldpb$art_obj = p.hours, $art_cdmilvou$art_c = $art_objvxcldpb$art_obj.length; $art_ixqrbidkm$art_i < $art_cdmilvou$art_c; $art_ixqrbidkm$art_i++) {        var h = $art_objvxcldpb$art_obj[$art_ixqrbidkm$art_i]%>';
        for (var $art_ixqrbidkm$art_i = 0, $art_objvxcldpb$art_obj = p.hours, $art_cdmilvou$art_c = $art_objvxcldpb$art_obj.length; $art_ixqrbidkm$art_i < $art_cdmilvou$art_c; $art_ixqrbidkm$art_i++) {
            var h = $art_objvxcldpb$art_obj[$art_ixqrbidkm$art_i];
