...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iqhpvse$art_i = 0, $art_cqwinlkm$art_c = types.length; $art_iqhpvse$art_i < $art_cqwinlkm$art_c; $art_iqhpvse$art_i++) {        var t = types[$art_iqhpvse$art_i]%>';
        for (var $art_iqhpvse$art_i = 0, $art_cqwinlkm$art_c = types.length; $art_iqhpvse$art_i < $art_cqwinlkm$art_c; $art_iqhpvse$art_i++) {
            var t = types[$art_iqhpvse$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_claftgfm$art_c = periods.length; pIndex < $art_claftgfm$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_claftgfm$art_c = periods.length; pIndex < $art_claftgfm$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iotqqcnh$art_i = 0, $art_objaidwmika$art_obj = p.hours, $art_cmddtnyv$art_c = $art_objaidwmika$art_obj.length; $art_iotqqcnh$art_i < $art_cmddtnyv$art_c; $art_iotqqcnh$art_i++) {        var h = $art_objaidwmika$art_obj[$art_iotqqcnh$art_i]%>';
        for (var $art_iotqqcnh$art_i = 0, $art_objaidwmika$art_obj = p.hours, $art_cmddtnyv$art_c = $art_objaidwmika$art_obj.length; $art_iotqqcnh$art_i < $art_cmddtnyv$art_c; $art_iotqqcnh$art_i++) {
            var h = $art_objaidwmika$art_obj[$art_iotqqcnh$art_i];
