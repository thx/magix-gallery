...
module.exports = Magix.View.extend({
    ...
    $p += '<div mxv mxa="_zs_gallerybs:_" class="_zs_gallery_mx-hour_index_-period">';
    $line = 2;
    $art = 'if !simple';
    ;
    $expr = '<%if (!simple) {%>';
    if (!simple) {
        ;
        $p += '<div mxv mxa="_zs_gallerybs:a" class="_zs_gallery_mx-hour_index_-opers"><span mxs="_zs_gallerybs:_" class="color-9 mr10">快捷操作：</span>';
        $line = 5;
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_igdsqpzzr$art_i = 0, $art_chnalrocrb$art_c = types.length; $art_igdsqpzzr$art_i < $art_chnalrocrb$art_c; $art_igdsqpzzr$art_i++) {        var t = types[$art_igdsqpzzr$art_i]%>';
        for (var $art_igdsqpzzr$art_i = 0, $art_chnalrocrb$art_c = types.length; $art_igdsqpzzr$art_i < $art_chnalrocrb$art_c; $art_igdsqpzzr$art_i++) {
            var t = types[$art_igdsqpzzr$art_i];
            $p += '<label mxv mxa="_zs_gallerybs:b" class="mr40"><input type="radio" name="';
            $line = 7;
            $art = '=viewId';
            ;
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_czlbdkekd$art_c = periods.length; pIndex < $art_czlbdkekd$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_czlbdkekd$art_c = periods.length; pIndex < $art_czlbdkekd$art_c; pIndex++) {
        var p = periods[pIndex];
        $p += '<ul mxa="_zs_gallerybs:c" class="_zs_gallery_mx-hour_index_-hours clearfix"><li mxa="_zs_gallerybs:d" class="_zs_gallery_mx-hour_index_-all"><span mxs="_zs_gallerybs:a" class="_zs_gallery_mx-hour_index_-all-tip">时间段</span><a href="javascript:;" class="btn btn-small _zs_gallery_mx-hour_index_-all-btn ';
        $line = 19;
        $art = 'if p.selected';
        ;
        $expr = '<%if (p.selected) {%>';
        ...
        ;
        $expr = '<%for (var $art_inchyambwvd$art_i = 0, $art_objxlbhnsub$art_obj = p.hours, $art_ctrreqw$art_c = $art_objxlbhnsub$art_obj.length; $art_inchyambwvd$art_i < $art_ctrreqw$art_c; $art_inchyambwvd$art_i++) {        var h = $art_objxlbhnsub$art_obj[$art_inchyambwvd$art_i]%>';
        for (var $art_inchyambwvd$art_i = 0, $art_objxlbhnsub$art_obj = p.hours, $art_ctrreqw$art_c = $art_objxlbhnsub$art_obj.length; $art_inchyambwvd$art_i < $art_ctrreqw$art_c; $art_inchyambwvd$art_i++) {
            var h = $art_objxlbhnsub$art_obj[$art_inchyambwvd$art_i];
            ...
            $art = '=h.index';
            ;
            $p += ($expr = '<%=h.index%>', $e(h.index)) + '"><div mxs="_zs_gallerybs:b" class="_zs_gallery_mx-hour_index_-hour-inner"></div><div class="_zs_gallery_mx-hour_index_-line-start ';
            $line = 27;
            ...
            $art = '=h.zIndex';
            ;
            $p += ($expr = '<%=h.zIndex%>', $e(h.zIndex)) + ';"><span mxa="_zs_gallerybs:e" class="_zs_gallery_mx-hour_index_-line-info">';
            $line = 28;
            $art = '=h.index';
            ;
            ...
            $art = '=h.zIndex';
            ;
            $p += ($expr = '<%=h.zIndex%>', $e(h.zIndex)) + '"><span mxa="_zs_gallerybs:f" class="_zs_gallery_mx-hour_index_-line-info">';
            $line = 31;
            $art = '=h.indexNext';
            ;
            $p += ($expr = '<%=h.indexNext%>', $e(h.indexNext)) + '</span></div><div mxa="_zs_gallerybs:g" class="_zs_gallery_mx-hour_index_-hour-line"><span mxa="_zs_gallerybs:h" class="_zs_gallery_mx-hour_index_-hour-info">';
            $line = 34;
            $art = '=h.index';
            ;
        ...
        ;
        $p += '<li mxs="_zs_gallerybs:c" class="_zs_gallery_mx-hour_index_-hour _zs_gallery_mx-hour_index_-milestone _zs_gallery_mx-hour_index_-hour-last"><span class="_zs_gallery_mx-hour_index_-hour-line"><span class="_zs_gallery_mx-hour_index_-hour-info">24</span></span></li></ul>';
        $line = 44;
        $art = '/each';
        ;
        $expr = '<%}%>';
    ...
    ;
    $p += '</div><div mxa="_zs_gallerybs:i" class="clearfix _zs_gallery_mx-hour_index_-opers-wrapper"><a mxs="_zs_gallerybs:d" mx-click="' + $viewId + 'clearAll()" href="javascript:;" class="btn btn-small _zs_gallery_mx-hour_index_-btn-clear"><i class="mc-iconfont displacement-2 mr5 color-9">&#xe72e;</i>清空</a><span mxa="_zs_gallerybs:j" class="fr lh32">';
    $line = 50;
    $art = '=tip';
    ;
