...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ilzhupld$art_i = 0, $art_czuivqlfki$art_c = types.length; $art_ilzhupld$art_i < $art_czuivqlfki$art_c; $art_ilzhupld$art_i++) {        var t = types[$art_ilzhupld$art_i]%>';
        for (var $art_ilzhupld$art_i = 0, $art_czuivqlfki$art_c = types.length; $art_ilzhupld$art_i < $art_czuivqlfki$art_c; $art_ilzhupld$art_i++) {
            var t = types[$art_ilzhupld$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cuiemnuuuf$art_c = periods.length; pIndex < $art_cuiemnuuuf$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cuiemnuuuf$art_c = periods.length; pIndex < $art_cuiemnuuuf$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ilwhprkfw$art_i = 0, $art_objfqlmog$art_obj = p.hours, $art_cjhfjybewr$art_c = $art_objfqlmog$art_obj.length; $art_ilwhprkfw$art_i < $art_cjhfjybewr$art_c; $art_ilwhprkfw$art_i++) {        var h = $art_objfqlmog$art_obj[$art_ilwhprkfw$art_i]%>';
        for (var $art_ilwhprkfw$art_i = 0, $art_objfqlmog$art_obj = p.hours, $art_cjhfjybewr$art_c = $art_objfqlmog$art_obj.length; $art_ilwhprkfw$art_i < $art_cjhfjybewr$art_c; $art_ilwhprkfw$art_i++) {
            var h = $art_objfqlmog$art_obj[$art_ilwhprkfw$art_i];
