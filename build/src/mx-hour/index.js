...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_imdhdvqollq$art_i = 0, $art_cwfmbmskxk$art_c = types.length; $art_imdhdvqollq$art_i < $art_cwfmbmskxk$art_c; $art_imdhdvqollq$art_i++) {        var t = types[$art_imdhdvqollq$art_i]%>';
        for (var $art_imdhdvqollq$art_i = 0, $art_cwfmbmskxk$art_c = types.length; $art_imdhdvqollq$art_i < $art_cwfmbmskxk$art_c; $art_imdhdvqollq$art_i++) {
            var t = types[$art_imdhdvqollq$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cupdis$art_c = periods.length; pIndex < $art_cupdis$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cupdis$art_c = periods.length; pIndex < $art_cupdis$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_itfygffy$art_i = 0, $art_objohjfomyc$art_obj = p.hours, $art_cxqmafibzo$art_c = $art_objohjfomyc$art_obj.length; $art_itfygffy$art_i < $art_cxqmafibzo$art_c; $art_itfygffy$art_i++) {        var h = $art_objohjfomyc$art_obj[$art_itfygffy$art_i]%>';
        for (var $art_itfygffy$art_i = 0, $art_objohjfomyc$art_obj = p.hours, $art_cxqmafibzo$art_c = $art_objohjfomyc$art_obj.length; $art_itfygffy$art_i < $art_cxqmafibzo$art_c; $art_itfygffy$art_i++) {
            var h = $art_objohjfomyc$art_obj[$art_itfygffy$art_i];
