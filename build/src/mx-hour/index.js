...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ifkjvjoxqtu$art_i = 0, $art_cczyjdpvduul$art_c = types.length; $art_ifkjvjoxqtu$art_i < $art_cczyjdpvduul$art_c; $art_ifkjvjoxqtu$art_i++) {        var t = types[$art_ifkjvjoxqtu$art_i]%>';
        for (var $art_ifkjvjoxqtu$art_i = 0, $art_cczyjdpvduul$art_c = types.length; $art_ifkjvjoxqtu$art_i < $art_cczyjdpvduul$art_c; $art_ifkjvjoxqtu$art_i++) {
            var t = types[$art_ifkjvjoxqtu$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cyofgovhw$art_c = periods.length; pIndex < $art_cyofgovhw$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cyofgovhw$art_c = periods.length; pIndex < $art_cyofgovhw$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_iibzcohvan$art_i = 0, $art_objaaalawp$art_obj = p.hours, $art_codposnhz$art_c = $art_objaaalawp$art_obj.length; $art_iibzcohvan$art_i < $art_codposnhz$art_c; $art_iibzcohvan$art_i++) {        var h = $art_objaaalawp$art_obj[$art_iibzcohvan$art_i]%>';
        for (var $art_iibzcohvan$art_i = 0, $art_objaaalawp$art_obj = p.hours, $art_codposnhz$art_c = $art_objaaalawp$art_obj.length; $art_iibzcohvan$art_i < $art_codposnhz$art_c; $art_iibzcohvan$art_i++) {
            var h = $art_objaaalawp$art_obj[$art_iibzcohvan$art_i];
