...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ivlltjajkri$art_i = 0, $art_cznvbdu$art_c = types.length; $art_ivlltjajkri$art_i < $art_cznvbdu$art_c; $art_ivlltjajkri$art_i++) {        var t = types[$art_ivlltjajkri$art_i]%>';
        for (var $art_ivlltjajkri$art_i = 0, $art_cznvbdu$art_c = types.length; $art_ivlltjajkri$art_i < $art_cznvbdu$art_c; $art_ivlltjajkri$art_i++) {
            var t = types[$art_ivlltjajkri$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cmmbsppmfme$art_c = periods.length; pIndex < $art_cmmbsppmfme$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cmmbsppmfme$art_c = periods.length; pIndex < $art_cmmbsppmfme$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_idzpsna$art_i = 0, $art_objyrlqro$art_obj = p.hours, $art_cabaxu$art_c = $art_objyrlqro$art_obj.length; $art_idzpsna$art_i < $art_cabaxu$art_c; $art_idzpsna$art_i++) {        var h = $art_objyrlqro$art_obj[$art_idzpsna$art_i]%>';
        for (var $art_idzpsna$art_i = 0, $art_objyrlqro$art_obj = p.hours, $art_cabaxu$art_c = $art_objyrlqro$art_obj.length; $art_idzpsna$art_i < $art_cabaxu$art_c; $art_idzpsna$art_i++) {
            var h = $art_objyrlqro$art_obj[$art_idzpsna$art_i];
