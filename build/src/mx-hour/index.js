...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iczxoxtrw$art_i = 0, $art_clqdfqdd$art_c = types.length; $art_iczxoxtrw$art_i < $art_clqdfqdd$art_c; $art_iczxoxtrw$art_i++) {        var t = types[$art_iczxoxtrw$art_i]%>';
        for (var $art_iczxoxtrw$art_i = 0, $art_clqdfqdd$art_c = types.length; $art_iczxoxtrw$art_i < $art_clqdfqdd$art_c; $art_iczxoxtrw$art_i++) {
            var t = types[$art_iczxoxtrw$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_csjpmeyi$art_c = periods.length; pIndex < $art_csjpmeyi$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_csjpmeyi$art_c = periods.length; pIndex < $art_csjpmeyi$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_irymrm$art_i = 0, $art_objdnjappfm$art_obj = p.hours, $art_cpjbibeuq$art_c = $art_objdnjappfm$art_obj.length; $art_irymrm$art_i < $art_cpjbibeuq$art_c; $art_irymrm$art_i++) {        var h = $art_objdnjappfm$art_obj[$art_irymrm$art_i]%>';
        for (var $art_irymrm$art_i = 0, $art_objdnjappfm$art_obj = p.hours, $art_cpjbibeuq$art_c = $art_objdnjappfm$art_obj.length; $art_irymrm$art_i < $art_cpjbibeuq$art_c; $art_irymrm$art_i++) {
            var h = $art_objdnjappfm$art_obj[$art_irymrm$art_i];
