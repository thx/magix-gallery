...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iayszxcgnsv$art_i = 0, $art_cxjvhcc$art_c = types.length; $art_iayszxcgnsv$art_i < $art_cxjvhcc$art_c; $art_iayszxcgnsv$art_i++) {        var t = types[$art_iayszxcgnsv$art_i]%>';
        for (var $art_iayszxcgnsv$art_i = 0, $art_cxjvhcc$art_c = types.length; $art_iayszxcgnsv$art_i < $art_cxjvhcc$art_c; $art_iayszxcgnsv$art_i++) {
            var t = types[$art_iayszxcgnsv$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_czedweta$art_c = periods.length; pIndex < $art_czedweta$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_czedweta$art_c = periods.length; pIndex < $art_czedweta$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ihjvynpkay$art_i = 0, $art_objtvrxjojqwr$art_obj = p.hours, $art_cbcuzwem$art_c = $art_objtvrxjojqwr$art_obj.length; $art_ihjvynpkay$art_i < $art_cbcuzwem$art_c; $art_ihjvynpkay$art_i++) {        var h = $art_objtvrxjojqwr$art_obj[$art_ihjvynpkay$art_i]%>';
        for (var $art_ihjvynpkay$art_i = 0, $art_objtvrxjojqwr$art_obj = p.hours, $art_cbcuzwem$art_c = $art_objtvrxjojqwr$art_obj.length; $art_ihjvynpkay$art_i < $art_cbcuzwem$art_c; $art_ihjvynpkay$art_i++) {
            var h = $art_objtvrxjojqwr$art_obj[$art_ihjvynpkay$art_i];
