...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_igcibgleu$art_i = 0, $art_cudusnkp$art_c = types.length; $art_igcibgleu$art_i < $art_cudusnkp$art_c; $art_igcibgleu$art_i++) {        var t = types[$art_igcibgleu$art_i]%>';
        for (var $art_igcibgleu$art_i = 0, $art_cudusnkp$art_c = types.length; $art_igcibgleu$art_i < $art_cudusnkp$art_c; $art_igcibgleu$art_i++) {
            var t = types[$art_igcibgleu$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_crijiumo$art_c = periods.length; pIndex < $art_crijiumo$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_crijiumo$art_c = periods.length; pIndex < $art_crijiumo$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_icefhapsl$art_i = 0, $art_objnndinzr$art_obj = p.hours, $art_cknlerqm$art_c = $art_objnndinzr$art_obj.length; $art_icefhapsl$art_i < $art_cknlerqm$art_c; $art_icefhapsl$art_i++) {        var h = $art_objnndinzr$art_obj[$art_icefhapsl$art_i]%>';
        for (var $art_icefhapsl$art_i = 0, $art_objnndinzr$art_obj = p.hours, $art_cknlerqm$art_c = $art_objnndinzr$art_obj.length; $art_icefhapsl$art_i < $art_cknlerqm$art_c; $art_icefhapsl$art_i++) {
            var h = $art_objnndinzr$art_obj[$art_icefhapsl$art_i];
