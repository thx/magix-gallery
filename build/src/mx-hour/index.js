...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iidqffyuj$art_i = 0, $art_cgqayonc$art_c = types.length; $art_iidqffyuj$art_i < $art_cgqayonc$art_c; $art_iidqffyuj$art_i++) {        var t = types[$art_iidqffyuj$art_i]%>';
        for (var $art_iidqffyuj$art_i = 0, $art_cgqayonc$art_c = types.length; $art_iidqffyuj$art_i < $art_cgqayonc$art_c; $art_iidqffyuj$art_i++) {
            var t = types[$art_iidqffyuj$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cbaozucnlf$art_c = periods.length; pIndex < $art_cbaozucnlf$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cbaozucnlf$art_c = periods.length; pIndex < $art_cbaozucnlf$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_imzqbjfjf$art_i = 0, $art_objfwxkpyd$art_obj = p.hours, $art_cwhgsnquoa$art_c = $art_objfwxkpyd$art_obj.length; $art_imzqbjfjf$art_i < $art_cwhgsnquoa$art_c; $art_imzqbjfjf$art_i++) {        var h = $art_objfwxkpyd$art_obj[$art_imzqbjfjf$art_i]%>';
        for (var $art_imzqbjfjf$art_i = 0, $art_objfwxkpyd$art_obj = p.hours, $art_cwhgsnquoa$art_c = $art_objfwxkpyd$art_obj.length; $art_imzqbjfjf$art_i < $art_cwhgsnquoa$art_c; $art_imzqbjfjf$art_i++) {
            var h = $art_objfwxkpyd$art_obj[$art_imzqbjfjf$art_i];
