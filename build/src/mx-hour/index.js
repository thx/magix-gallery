...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ieivayezfq$art_i = 0, $art_culhieclso$art_c = types.length; $art_ieivayezfq$art_i < $art_culhieclso$art_c; $art_ieivayezfq$art_i++) {        var t = types[$art_ieivayezfq$art_i]%>';
        for (var $art_ieivayezfq$art_i = 0, $art_culhieclso$art_c = types.length; $art_ieivayezfq$art_i < $art_culhieclso$art_c; $art_ieivayezfq$art_i++) {
            var t = types[$art_ieivayezfq$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_csaxktbem$art_c = periods.length; pIndex < $art_csaxktbem$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_csaxktbem$art_c = periods.length; pIndex < $art_csaxktbem$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_icdmqvvsv$art_i = 0, $art_objbynsxwndif$art_obj = p.hours, $art_covmbpldpnzo$art_c = $art_objbynsxwndif$art_obj.length; $art_icdmqvvsv$art_i < $art_covmbpldpnzo$art_c; $art_icdmqvvsv$art_i++) {        var h = $art_objbynsxwndif$art_obj[$art_icdmqvvsv$art_i]%>';
        for (var $art_icdmqvvsv$art_i = 0, $art_objbynsxwndif$art_obj = p.hours, $art_covmbpldpnzo$art_c = $art_objbynsxwndif$art_obj.length; $art_icdmqvvsv$art_i < $art_covmbpldpnzo$art_c; $art_icdmqvvsv$art_i++) {
            var h = $art_objbynsxwndif$art_obj[$art_icdmqvvsv$art_i];
