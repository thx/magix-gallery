...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ilvzpyk$art_i = 0, $art_cjdfgge$art_c = types.length; $art_ilvzpyk$art_i < $art_cjdfgge$art_c; $art_ilvzpyk$art_i++) {        var t = types[$art_ilvzpyk$art_i]%>';
        for (var $art_ilvzpyk$art_i = 0, $art_cjdfgge$art_c = types.length; $art_ilvzpyk$art_i < $art_cjdfgge$art_c; $art_ilvzpyk$art_i++) {
            var t = types[$art_ilvzpyk$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cgmnlnpf$art_c = periods.length; pIndex < $art_cgmnlnpf$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cgmnlnpf$art_c = periods.length; pIndex < $art_cgmnlnpf$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_igrgoogl$art_i = 0, $art_objlhpnsfa$art_obj = p.hours, $art_cbuksavcwh$art_c = $art_objlhpnsfa$art_obj.length; $art_igrgoogl$art_i < $art_cbuksavcwh$art_c; $art_igrgoogl$art_i++) {        var h = $art_objlhpnsfa$art_obj[$art_igrgoogl$art_i]%>';
        for (var $art_igrgoogl$art_i = 0, $art_objlhpnsfa$art_obj = p.hours, $art_cbuksavcwh$art_c = $art_objlhpnsfa$art_obj.length; $art_igrgoogl$art_i < $art_cbuksavcwh$art_c; $art_igrgoogl$art_i++) {
            var h = $art_objlhpnsfa$art_obj[$art_igrgoogl$art_i];
