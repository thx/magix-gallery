...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ivyhqwnufe$art_i = 0, $art_cjhgowuxi$art_c = types.length; $art_ivyhqwnufe$art_i < $art_cjhgowuxi$art_c; $art_ivyhqwnufe$art_i++) {        var t = types[$art_ivyhqwnufe$art_i]%>';
        for (var $art_ivyhqwnufe$art_i = 0, $art_cjhgowuxi$art_c = types.length; $art_ivyhqwnufe$art_i < $art_cjhgowuxi$art_c; $art_ivyhqwnufe$art_i++) {
            var t = types[$art_ivyhqwnufe$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cixncyzqg$art_c = periods.length; pIndex < $art_cixncyzqg$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cixncyzqg$art_c = periods.length; pIndex < $art_cixncyzqg$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_itlhvstby$art_i = 0, $art_objdwnbtdjwiv$art_obj = p.hours, $art_cjghkppaij$art_c = $art_objdwnbtdjwiv$art_obj.length; $art_itlhvstby$art_i < $art_cjghkppaij$art_c; $art_itlhvstby$art_i++) {        var h = $art_objdwnbtdjwiv$art_obj[$art_itlhvstby$art_i]%>';
        for (var $art_itlhvstby$art_i = 0, $art_objdwnbtdjwiv$art_obj = p.hours, $art_cjghkppaij$art_c = $art_objdwnbtdjwiv$art_obj.length; $art_itlhvstby$art_i < $art_cjghkppaij$art_c; $art_itlhvstby$art_i++) {
            var h = $art_objdwnbtdjwiv$art_obj[$art_itlhvstby$art_i];
