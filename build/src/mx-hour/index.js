...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iapoldsrrip$art_i = 0, $art_cffkhao$art_c = types.length; $art_iapoldsrrip$art_i < $art_cffkhao$art_c; $art_iapoldsrrip$art_i++) {        var t = types[$art_iapoldsrrip$art_i]%>';
        for (var $art_iapoldsrrip$art_i = 0, $art_cffkhao$art_c = types.length; $art_iapoldsrrip$art_i < $art_cffkhao$art_c; $art_iapoldsrrip$art_i++) {
            var t = types[$art_iapoldsrrip$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_crpbkww$art_c = periods.length; pIndex < $art_crpbkww$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_crpbkww$art_c = periods.length; pIndex < $art_crpbkww$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_inhfpppjw$art_i = 0, $art_objrkflr$art_obj = p.hours, $art_cxaydddz$art_c = $art_objrkflr$art_obj.length; $art_inhfpppjw$art_i < $art_cxaydddz$art_c; $art_inhfpppjw$art_i++) {        var h = $art_objrkflr$art_obj[$art_inhfpppjw$art_i]%>';
        for (var $art_inhfpppjw$art_i = 0, $art_objrkflr$art_obj = p.hours, $art_cxaydddz$art_c = $art_objrkflr$art_obj.length; $art_inhfpppjw$art_i < $art_cxaydddz$art_c; $art_inhfpppjw$art_i++) {
            var h = $art_objrkflr$art_obj[$art_inhfpppjw$art_i];
