...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_ioqezww$art_i = 0, $art_cjxdklvqwb$art_c = types.length; $art_ioqezww$art_i < $art_cjxdklvqwb$art_c; $art_ioqezww$art_i++) {        var t = types[$art_ioqezww$art_i]%>';
        for (var $art_ioqezww$art_i = 0, $art_cjxdklvqwb$art_c = types.length; $art_ioqezww$art_i < $art_cjxdklvqwb$art_c; $art_ioqezww$art_i++) {
            var t = types[$art_ioqezww$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_clqkimmu$art_c = periods.length; pIndex < $art_clqkimmu$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_clqkimmu$art_c = periods.length; pIndex < $art_clqkimmu$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ivnqxeris$art_i = 0, $art_objmxstjxii$art_obj = p.hours, $art_contjrxqc$art_c = $art_objmxstjxii$art_obj.length; $art_ivnqxeris$art_i < $art_contjrxqc$art_c; $art_ivnqxeris$art_i++) {        var h = $art_objmxstjxii$art_obj[$art_ivnqxeris$art_i]%>';
        for (var $art_ivnqxeris$art_i = 0, $art_objmxstjxii$art_obj = p.hours, $art_contjrxqc$art_c = $art_objmxstjxii$art_obj.length; $art_ivnqxeris$art_i < $art_contjrxqc$art_c; $art_ivnqxeris$art_i++) {
            var h = $art_objmxstjxii$art_obj[$art_ivnqxeris$art_i];
