...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iwjvwieeux$art_i = 0, $art_cejxmqxubi$art_c = types.length; $art_iwjvwieeux$art_i < $art_cejxmqxubi$art_c; $art_iwjvwieeux$art_i++) {        var t = types[$art_iwjvwieeux$art_i]%>';
        for (var $art_iwjvwieeux$art_i = 0, $art_cejxmqxubi$art_c = types.length; $art_iwjvwieeux$art_i < $art_cejxmqxubi$art_c; $art_iwjvwieeux$art_i++) {
            var t = types[$art_iwjvwieeux$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_czcksxy$art_c = periods.length; pIndex < $art_czcksxy$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_czcksxy$art_c = periods.length; pIndex < $art_czcksxy$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_isfgimqrk$art_i = 0, $art_objvcrdgtrf$art_obj = p.hours, $art_copgbqhzp$art_c = $art_objvcrdgtrf$art_obj.length; $art_isfgimqrk$art_i < $art_copgbqhzp$art_c; $art_isfgimqrk$art_i++) {        var h = $art_objvcrdgtrf$art_obj[$art_isfgimqrk$art_i]%>';
        for (var $art_isfgimqrk$art_i = 0, $art_objvcrdgtrf$art_obj = p.hours, $art_copgbqhzp$art_c = $art_objvcrdgtrf$art_obj.length; $art_isfgimqrk$art_i < $art_copgbqhzp$art_c; $art_isfgimqrk$art_i++) {
            var h = $art_objvcrdgtrf$art_obj[$art_isfgimqrk$art_i];
