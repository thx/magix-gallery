...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iwvlszggf$art_i = 0, $art_cegetfcjiq$art_c = types.length; $art_iwvlszggf$art_i < $art_cegetfcjiq$art_c; $art_iwvlszggf$art_i++) {        var t = types[$art_iwvlszggf$art_i]%>';
        for (var $art_iwvlszggf$art_i = 0, $art_cegetfcjiq$art_c = types.length; $art_iwvlszggf$art_i < $art_cegetfcjiq$art_c; $art_iwvlszggf$art_i++) {
            var t = types[$art_iwvlszggf$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_czujdpdyms$art_c = periods.length; pIndex < $art_czujdpdyms$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_czujdpdyms$art_c = periods.length; pIndex < $art_czujdpdyms$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ihsfiimwoh$art_i = 0, $art_objpeekkgxg$art_obj = p.hours, $art_cuvhbghis$art_c = $art_objpeekkgxg$art_obj.length; $art_ihsfiimwoh$art_i < $art_cuvhbghis$art_c; $art_ihsfiimwoh$art_i++) {        var h = $art_objpeekkgxg$art_obj[$art_ihsfiimwoh$art_i]%>';
        for (var $art_ihsfiimwoh$art_i = 0, $art_objpeekkgxg$art_obj = p.hours, $art_cuvhbghis$art_c = $art_objpeekkgxg$art_obj.length; $art_ihsfiimwoh$art_i < $art_cuvhbghis$art_c; $art_ihsfiimwoh$art_i++) {
            var h = $art_objpeekkgxg$art_obj[$art_ihsfiimwoh$art_i];
    ...
    ;
    $p += '</div><div mxa="_zs_gallerycD:h" class="clearfix _zs_gallery_mx-hour_index_-opers-wrapper"><a mxs="_zs_gallerycD:d" mx-click="' + $viewId + 'clearAll()" href="javascript:;" class="btn btn-small _zs_gallery_mx-hour_index_-clear-btn"><i class="mc-iconfont displacement-2 mr5 color-9">&#xe72e;</i>清空</a><span mxa="_zs_gallerycD:i" class="fr _zs_gallery_mx-hour_index_-oper-tip">';
    $line = 50;
    $art = '=tip';
    ;
