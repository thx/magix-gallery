...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iviprkoqb$art_i = 0, $art_csxebmygerf$art_c = types.length; $art_iviprkoqb$art_i < $art_csxebmygerf$art_c; $art_iviprkoqb$art_i++) {        var t = types[$art_iviprkoqb$art_i]%>';
        for (var $art_iviprkoqb$art_i = 0, $art_csxebmygerf$art_c = types.length; $art_iviprkoqb$art_i < $art_csxebmygerf$art_c; $art_iviprkoqb$art_i++) {
            var t = types[$art_iviprkoqb$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cdngmvinoz$art_c = periods.length; pIndex < $art_cdngmvinoz$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cdngmvinoz$art_c = periods.length; pIndex < $art_cdngmvinoz$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ijsdtdczc$art_i = 0, $art_objzojszrcoyy$art_obj = p.hours, $art_coqjjveh$art_c = $art_objzojszrcoyy$art_obj.length; $art_ijsdtdczc$art_i < $art_coqjjveh$art_c; $art_ijsdtdczc$art_i++) {        var h = $art_objzojszrcoyy$art_obj[$art_ijsdtdczc$art_i]%>';
        for (var $art_ijsdtdczc$art_i = 0, $art_objzojszrcoyy$art_obj = p.hours, $art_coqjjveh$art_c = $art_objzojszrcoyy$art_obj.length; $art_ijsdtdczc$art_i < $art_coqjjveh$art_c; $art_ijsdtdczc$art_i++) {
            var h = $art_objzojszrcoyy$art_obj[$art_ijsdtdczc$art_i];
