...
module.exports = Magix.View.extend({
    ...
    if (!simple) {
        ...
        $art = 'each types as t';
        ;
        $expr = '<%for (var $art_iaxctzmznq$art_i = 0, $art_cnypraqy$art_c = types.length; $art_iaxctzmznq$art_i < $art_cnypraqy$art_c; $art_iaxctzmznq$art_i++) {        var t = types[$art_iaxctzmznq$art_i]%>';
        for (var $art_iaxctzmznq$art_i = 0, $art_cnypraqy$art_c = types.length; $art_iaxctzmznq$art_i < $art_cnypraqy$art_c; $art_iaxctzmznq$art_i++) {
            var t = types[$art_iaxctzmznq$art_i];
    ...
    ;
    $expr = '<%for (var pIndex = 0, $art_cnwohctrm$art_c = periods.length; pIndex < $art_cnwohctrm$art_c; pIndex++) {    var p = periods[pIndex]%>';
    for (var pIndex = 0, $art_cnwohctrm$art_c = periods.length; pIndex < $art_cnwohctrm$art_c; pIndex++) {
        ...
        ;
        $expr = '<%for (var $art_ianmenkz$art_i = 0, $art_objlzpwipbuq$art_obj = p.hours, $art_czwbjvyqdjq$art_c = $art_objlzpwipbuq$art_obj.length; $art_ianmenkz$art_i < $art_czwbjvyqdjq$art_c; $art_ianmenkz$art_i++) {        var h = $art_objlzpwipbuq$art_obj[$art_ianmenkz$art_i]%>';
        for (var $art_ianmenkz$art_i = 0, $art_objlzpwipbuq$art_obj = p.hours, $art_czwbjvyqdjq$art_c = $art_objlzpwipbuq$art_obj.length; $art_ianmenkz$art_i < $art_czwbjvyqdjq$art_c; $art_ianmenkz$art_i++) {
            var h = $art_objlzpwipbuq$art_obj[$art_ianmenkz$art_i];
